...
import typingsSlinky.imap.imapMod.AppendOptions
import typingsSlinky.imap.imapMod.FetchOptions
import typingsSlinky.imap.imapMod.MailBoxes
import typingsSlinky.imap.imapMod.^
