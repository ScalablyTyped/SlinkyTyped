...
object AnonCreate {
  @scala.inline
  def apply[OptionsType, OverlayType](create: OptionsType => js.Promise[OverlayType]): AnonCreate[OptionsType, OverlayType] = {
    val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create))
    __obj.asInstanceOf[AnonCreate[OptionsType, OverlayType]]
  }
  @scala.inline
  implicit class AnonCreateOps[Self[optionstype, overlaytype] <: AnonCreate[optionstype, overlaytype], OptionsType, OverlayType] (val x: Self[OptionsType, OverlayType]) extends AnyVal {
    @scala.inline
