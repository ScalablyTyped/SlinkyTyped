...
object IonContentPickHTMLAttribu {
  ...
  def apply(
    ...
    key: Key = null,
    lang: String = null,
    onAbort: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonContentElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonContentElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonContentElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonContentElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonContentElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonContentElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonContentElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonContentElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonContentElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonContentElement] => Unit = null,
