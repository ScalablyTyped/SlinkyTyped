package typingsSlinky.ionicReact.routerDirectionMod
...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.ionicReact.ionicReactStrings.forward
  - typingsSlinky.ionicReact.ionicReactStrings.back
  - typingsSlinky.ionicReact.ionicReactStrings.root
  - typingsSlinky.ionicReact.ionicReactStrings.none
*/
