...
object IonTogglePickHTMLAttribut {
  ...
  def apply(
    ...
    mode: ios | md = null,
    name: String = null,
    onAbort: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonToggleElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonToggleElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonToggleElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonToggleElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonToggleElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonToggleElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonToggleElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonToggleElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonToggleElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonToggleElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonToggleElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonToggleElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonToggleElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonToggleElement, Event_] => Unit = null,
    onIonBlur: /* event */ CustomEvent => Unit = null,
    onIonChange: /* event */ CustomEvent => Unit = null,
    onIonFocus: /* event */ CustomEvent => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonToggleElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonToggleElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonToggleElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonToggleElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonToggleElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonToggleElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonToggleElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonToggleElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonToggleElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonToggleElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonToggleElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonToggleElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonToggleElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonToggleElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonToggleElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonToggleElement] => Unit = null,
