...
object IonSelectPickHTMLAttribut {
  ...
  def apply(
    ...
    name: String = null,
    okText: String = null,
    onAbort: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonSelectElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonSelectElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonSelectElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonSelectElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonSelectElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonSelectElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonSelectElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonSelectElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonSelectElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonSelectElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonSelectElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonSelectElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonSelectElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonSelectElement, Event_] => Unit = null,
    ...
    onKeyDown: SyntheticKeyboardEvent[HTMLIonSelectElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonSelectElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonSelectElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonSelectElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonSelectElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonSelectElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonSelectElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonSelectElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonSelectElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonSelectElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonSelectElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonSelectElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonSelectElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonSelectElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonSelectElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonSelectElement] => Unit = null,
