...
object PickHTMLAttributesunknown {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickHTMLAttributesunknown]
  }
  @scala.inline
  implicit class PickHTMLAttributesunknownOps[Self <: PickHTMLAttributesunknown] (val x: Self) extends AnyVal {
    @scala.inline
