...
object IonSlidePickHTMLAttribute {
  ...
  def apply(
    ...
    key: Key = null,
    lang: String = null,
    onAbort: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonSlideElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonSlideElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonSlideElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonSlideElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonSlideElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonSlideElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonSlideElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonSlideElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonSlideElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonSlideElement] => Unit = null,
