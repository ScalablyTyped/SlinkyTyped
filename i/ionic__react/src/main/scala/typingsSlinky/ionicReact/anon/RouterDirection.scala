...
trait RouterDirection extends js.Object {
  var routerDirection: js.UndefOr[typingsSlinky.ionicReact.hrefpropsMod.RouterDirection] = js.undefined
...
object RouterDirection {
  @scala.inline
  def apply(
    routerDirection: typingsSlinky.ionicReact.hrefpropsMod.RouterDirection = null,
