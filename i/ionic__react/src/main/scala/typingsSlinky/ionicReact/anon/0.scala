...
object `0` {
  @scala.inline
  def apply[/* <: typingsSlinky.ionicReact.createOverlayComponentMod.OverlayElement */ OverlayType](create: js.Any => js.Promise[OverlayType]): `0`[OverlayType] = {
    val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create))
    __obj.asInstanceOf[`0`[OverlayType]]
  }
  @scala.inline
  implicit class `0Ops`[Self <: `0`[_], /* <: typingsSlinky.ionicReact.createOverlayComponentMod.OverlayElement */ OverlayType] (val x: Self with `0`[OverlayType]) extends AnyVal {
    @scala.inline
