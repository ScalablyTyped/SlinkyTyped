...
object `1` {
  @scala.inline
  def apply[/* <: typingsSlinky.ionicReact.createOverlayComponentMod.OverlayElement */ OverlayType](): `1`[OverlayType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`1`[OverlayType]]
  }
  @scala.inline
  implicit class `1Ops`[Self <: `1`[_], /* <: typingsSlinky.ionicReact.createOverlayComponentMod.OverlayElement */ OverlayType] (val x: Self with `1`[OverlayType]) extends AnyVal {
    @scala.inline
