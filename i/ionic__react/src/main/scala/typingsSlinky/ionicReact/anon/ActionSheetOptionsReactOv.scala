...
object ActionSheetOptionsReactOv {
  ...
  implicit class ActionSheetOptionsReactOvOps[Self <: ActionSheetOptionsReactOv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonActionSheetElement]): Self = this.set("forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonActionSheetElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
