...
object ActionSheetOptionsReactOv {
  ...
  implicit class ActionSheetOptionsReactOvMutableBuilder[Self <: ActionSheetOptionsReactOv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonActionSheetElement]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonActionSheetElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
