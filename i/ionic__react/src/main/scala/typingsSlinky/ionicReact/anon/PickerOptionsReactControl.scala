...
object PickerOptionsReactControl {
  ...
  implicit class PickerOptionsReactControlMutableBuilder[Self <: PickerOptionsReactControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonPickerElement]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonPickerElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
