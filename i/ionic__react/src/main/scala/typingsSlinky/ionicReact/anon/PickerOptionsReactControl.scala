...
object PickerOptionsReactControl {
  ...
  implicit class PickerOptionsReactControlOps[Self <: PickerOptionsReactControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonPickerElement]): Self = this.set("forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonPickerElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
