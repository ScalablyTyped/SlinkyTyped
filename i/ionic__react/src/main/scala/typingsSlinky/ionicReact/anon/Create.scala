...
object Create {
  @scala.inline
  def apply[/* <: js.Object */ OptionsType, /* <: typingsSlinky.ionicReact.createControllerComponentMod.OverlayBase */ OverlayType](create: OptionsType => js.Promise[OverlayType]): Create[OptionsType, OverlayType] = {
    val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create))
    __obj.asInstanceOf[Create[OptionsType, OverlayType]]
  }
  @scala.inline
  implicit class CreateOps[Self <: Create[_, _], /* <: js.Object */ OptionsType, /* <: typingsSlinky.ionicReact.createControllerComponentMod.OverlayBase */ OverlayType] (val x: Self with (Create[OptionsType, OverlayType])) extends AnyVal {
    @scala.inline
