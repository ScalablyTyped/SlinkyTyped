...
trait ToastOptionsReactControll extends js.Object {
  ...
  var forwardedRef: js.UndefOr[ReactRef[HTMLIonToastElement]] = js.native
...
object ToastOptionsReactControll {
  ...
  implicit class ToastOptionsReactControllOps[Self <: ToastOptionsReactControll] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForwardedRef(value: ReactRef[HTMLIonToastElement]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRefRefObject(value: ReactRef[HTMLIonToastElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRefFunction1(value: /* instance */ HTMLIonToastElement | Null => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRef(value: Ref[HTMLIonToastElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
