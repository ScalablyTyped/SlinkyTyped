...
object ToastOptionsReactControll {
  ...
  implicit class ToastOptionsReactControllMutableBuilder[Self <: ToastOptionsReactControll] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonToastElement]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonToastElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
