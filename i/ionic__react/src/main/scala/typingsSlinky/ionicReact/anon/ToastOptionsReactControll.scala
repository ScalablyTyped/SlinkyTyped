...
object ToastOptionsReactControll {
  ...
  implicit class ToastOptionsReactControllOps[Self <: ToastOptionsReactControll] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonToastElement]): Self = this.set("forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonToastElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
