...
object childrenReactNodeforwardeAnimated {
  ...
  implicit class childrenReactNodeforwardeAnimatedMutableBuilder[Self <: childrenReactNodeforwardeAnimated] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonPopoverElement]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonPopoverElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
