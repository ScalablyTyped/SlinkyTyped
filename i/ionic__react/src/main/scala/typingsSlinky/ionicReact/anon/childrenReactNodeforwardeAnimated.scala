...
object childrenReactNodeforwardeAnimated {
  ...
  implicit class childrenReactNodeforwardeAnimatedOps[Self <: childrenReactNodeforwardeAnimated] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonPopoverElement]): Self = this.set("forwardedRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonPopoverElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
