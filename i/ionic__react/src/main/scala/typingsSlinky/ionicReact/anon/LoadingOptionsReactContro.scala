...
object LoadingOptionsReactContro {
  ...
  implicit class LoadingOptionsReactControMutableBuilder[Self <: LoadingOptionsReactContro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonLoadingElement]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonLoadingElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
