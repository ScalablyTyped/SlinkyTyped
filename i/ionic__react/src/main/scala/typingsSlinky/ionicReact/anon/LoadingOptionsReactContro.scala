...
object LoadingOptionsReactContro {
  ...
  implicit class LoadingOptionsReactControOps[Self <: LoadingOptionsReactContro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: ReactRef[HTMLIonLoadingElement]): Self = this.set("forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLIonLoadingElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
