...
trait Dur extends StObject {
  ...
  var playTo: js.UndefOr[
    typingsSlinky.ionicReact.ionicReactNumbers.`0` | typingsSlinky.ionicReact.ionicReactNumbers.`1`
  ] = js.native
...
object Dur {
  ...
  implicit class DurMutableBuilder[Self <: Dur] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlayTo(
      value: typingsSlinky.ionicReact.ionicReactNumbers.`0` | typingsSlinky.ionicReact.ionicReactNumbers.`1`
    ): Self = StObject.set(x, "playTo", value.asInstanceOf[js.Any])
