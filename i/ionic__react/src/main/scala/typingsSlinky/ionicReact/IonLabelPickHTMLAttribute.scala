...
trait IonLabelPickHTMLAttribute extends js.Object {
  ...
  var onAbort: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onAbortCapture: js.Any
  var onAnimationEnd: js.UndefOr[AnimationEventHandler[HTMLIonLabelElement]] = js.undefined
  var onAnimationEndCapture: js.Any
  var onAnimationIteration: js.UndefOr[AnimationEventHandler[HTMLIonLabelElement]] = js.undefined
  var onAnimationIterationCapture: js.Any
  var onAnimationStart: js.UndefOr[AnimationEventHandler[HTMLIonLabelElement]] = js.undefined
  var onAnimationStartCapture: js.Any
  var onAuxClick: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onAuxClickCapture: js.Any
  var onBeforeInput: js.UndefOr[FormEventHandler[HTMLIonLabelElement]] = js.undefined
  var onBeforeInputCapture: js.Any
  var onBlur: js.UndefOr[FocusEventHandler[HTMLIonLabelElement]] = js.undefined
  var onBlurCapture: js.Any
  var onCanPlay: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onCanPlayCapture: js.Any
  var onCanPlayThrough: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onCanPlayThroughCapture: js.Any
  var onChange: js.UndefOr[FormEventHandler[HTMLIonLabelElement]] = js.undefined
  var onChangeCapture: js.Any
  var onClick: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onClickCapture: js.Any
  var onCompositionEnd: js.UndefOr[CompositionEventHandler[HTMLIonLabelElement]] = js.undefined
  var onCompositionEndCapture: js.Any
  var onCompositionStart: js.UndefOr[CompositionEventHandler[HTMLIonLabelElement]] = js.undefined
  var onCompositionStartCapture: js.Any
  var onCompositionUpdate: js.UndefOr[CompositionEventHandler[HTMLIonLabelElement]] = js.undefined
  var onCompositionUpdateCapture: js.Any
  var onContextMenu: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onContextMenuCapture: js.Any
  var onCopy: js.UndefOr[ClipboardEventHandler[HTMLIonLabelElement]] = js.undefined
  var onCopyCapture: js.Any
  var onCut: js.UndefOr[ClipboardEventHandler[HTMLIonLabelElement]] = js.undefined
  var onCutCapture: js.Any
  var onDoubleClick: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDoubleClickCapture: js.Any
  var onDrag: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDragCapture: js.Any
  var onDragEnd: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDragEndCapture: js.Any
  var onDragEnter: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDragEnterCapture: js.Any
  var onDragExit: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDragExitCapture: js.Any
  var onDragLeave: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDragLeaveCapture: js.Any
  var onDragOver: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDragOverCapture: js.Any
  var onDragStart: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDragStartCapture: js.Any
  var onDrop: js.UndefOr[DragEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDropCapture: js.Any
  var onDurationChange: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onDurationChangeCapture: js.Any
  var onEmptied: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onEmptiedCapture: js.Any
  var onEncrypted: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onEncryptedCapture: js.Any
  var onEnded: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onEndedCapture: js.Any
  var onError: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onErrorCapture: js.Any
  var onFocus: js.UndefOr[FocusEventHandler[HTMLIonLabelElement]] = js.undefined
  var onFocusCapture: js.Any
  var onGotPointerCapture: js.Any
  var onGotPointerCaptureCapture: js.Any
  var onInput: js.UndefOr[FormEventHandler[HTMLIonLabelElement]] = js.undefined
  var onInputCapture: js.Any
  var onInvalid: js.UndefOr[FormEventHandler[HTMLIonLabelElement]] = js.undefined
  var onInvalidCapture: js.Any
  var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLIonLabelElement]] = js.undefined
  var onKeyDownCapture: js.Any
  var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLIonLabelElement]] = js.undefined
  var onKeyPressCapture: js.Any
  var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLIonLabelElement]] = js.undefined
  var onKeyUpCapture: js.Any
  var onLoad: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onLoadCapture: js.Any
  var onLoadStart: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onLoadStartCapture: js.Any
  var onLoadedData: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onLoadedDataCapture: js.Any
  var onLoadedMetadata: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onLoadedMetadataCapture: js.Any
  var onLostPointerCapture: js.Any
  var onLostPointerCaptureCapture: js.Any
  var onMouseDown: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onMouseDownCapture: js.Any
  var onMouseEnter: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onMouseLeave: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onMouseMove: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onMouseMoveCapture: js.Any
  var onMouseOut: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onMouseOutCapture: js.Any
  var onMouseOver: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onMouseOverCapture: js.Any
  var onMouseUp: js.UndefOr[MouseEventHandler[HTMLIonLabelElement]] = js.undefined
  var onMouseUpCapture: js.Any
  var onPaste: js.UndefOr[ClipboardEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPasteCapture: js.Any
  var onPause: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPauseCapture: js.Any
  var onPlay: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPlayCapture: js.Any
  var onPlaying: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPlayingCapture: js.Any
  var onPointerCancel: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerCancelCapture: js.Any
  var onPointerDown: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerDownCapture: js.Any
  var onPointerEnter: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerEnterCapture: js.Any
  var onPointerLeave: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerLeaveCapture: js.Any
  var onPointerMove: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerMoveCapture: js.Any
  var onPointerOut: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerOutCapture: js.Any
  var onPointerOver: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerOverCapture: js.Any
  var onPointerUp: js.UndefOr[PointerEventHandler[HTMLIonLabelElement]] = js.undefined
  var onPointerUpCapture: js.Any
  var onProgress: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onProgressCapture: js.Any
  var onRateChange: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onRateChangeCapture: js.Any
  var onReset: js.UndefOr[FormEventHandler[HTMLIonLabelElement]] = js.undefined
  var onResetCapture: js.Any
  var onScroll: js.UndefOr[UIEventHandler[HTMLIonLabelElement]] = js.undefined
  var onScrollCapture: js.Any
  var onSeeked: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onSeekedCapture: js.Any
  var onSeeking: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onSeekingCapture: js.Any
  var onSelect: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onSelectCapture: js.Any
  var onStalled: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onStalledCapture: js.Any
  var onSubmit: js.UndefOr[FormEventHandler[HTMLIonLabelElement]] = js.undefined
  var onSubmitCapture: js.Any
  var onSuspend: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onSuspendCapture: js.Any
  var onTimeUpdate: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onTimeUpdateCapture: js.Any
  var onTouchCancel: js.UndefOr[TouchEventHandler[HTMLIonLabelElement]] = js.undefined
  var onTouchCancelCapture: js.Any
  var onTouchEnd: js.UndefOr[TouchEventHandler[HTMLIonLabelElement]] = js.undefined
  var onTouchEndCapture: js.Any
  var onTouchMove: js.UndefOr[TouchEventHandler[HTMLIonLabelElement]] = js.undefined
  var onTouchMoveCapture: js.Any
  var onTouchStart: js.UndefOr[TouchEventHandler[HTMLIonLabelElement]] = js.undefined
  var onTouchStartCapture: js.Any
  var onTransitionEnd: js.UndefOr[TransitionEventHandler[HTMLIonLabelElement]] = js.undefined
  var onTransitionEndCapture: js.Any
  var onVolumeChange: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onVolumeChangeCapture: js.Any
  var onWaiting: js.UndefOr[ReactEventHandler[HTMLIonLabelElement]] = js.undefined
  var onWaitingCapture: js.Any
  var onWheel: js.UndefOr[WheelEventHandler[HTMLIonLabelElement]] = js.undefined
  ...
  var ref: js.UndefOr[Ref[HTMLIonLabelElement]] = js.undefined
...
object IonLabelPickHTMLAttribute {
  ...
  def apply(
    ...
    lang: String = null,
    mode: ios | md = null,
    onAbort: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonLabelElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonLabelElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonLabelElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonLabelElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonLabelElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonLabelElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonLabelElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonLabelElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonLabelElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonLabelElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonLabelElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onDrag: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDrop: DragEvent[HTMLIonLabelElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonLabelElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonLabelElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonLabelElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonLabelElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonLabelElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonLabelElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonLabelElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonLabelElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonLabelElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonLabelElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonLabelElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonLabelElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonLabelElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonLabelElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonLabelElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonLabelElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonLabelElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonLabelElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonLabelElement] => Unit = null,
    placeholder: String = null,
    position: fixed | stacked | floating = null,
    prefix: String = null,
    property: String = null,
    radioGroup: String = null,
    ref: Ref[HTMLIonLabelElement] = null,
