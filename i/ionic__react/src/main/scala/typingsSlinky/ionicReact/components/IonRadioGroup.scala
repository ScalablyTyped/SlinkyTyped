...
object IonRadioGroup {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, HTMLIonRadioGroupElement] {
    ...
    @scala.inline
    def allowEmptySelection(value: Boolean): this.type = set("allowEmptySelection", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onMouseLeave(value: SyntheticMouseEvent[HTMLIonRadioGroupElement] => Unit): this.type = set("onMouseLeave", js.Any.fromFunction1(value))
