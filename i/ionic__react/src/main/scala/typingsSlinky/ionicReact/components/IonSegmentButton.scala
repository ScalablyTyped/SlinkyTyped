...
object IonSegmentButton
  ...
  /* The following DOM/SVG props were specified: checked, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, placeholder, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
  ...
  type Props = IonSegmentButtonPickHTMLA
}
