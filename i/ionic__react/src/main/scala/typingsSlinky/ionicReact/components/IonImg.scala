...
object IonImg
  ...
  /* The following DOM/SVG props were specified: alt, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, hidden, id, lang, placeholder, spellCheck, src, suppressContentEditableWarning, tabIndex, title */
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonImgElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonImgElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonImgElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonImgElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonImgElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonImgElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonImgElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonImgElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonImgElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonImgElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonImgElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onDrag: DragEvent[HTMLIonImgElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonImgElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonImgElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonImgElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonImgElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonImgElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonImgElement] => Unit = null,
    onDrop: DragEvent[HTMLIonImgElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonImgElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonImgElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonImgElement, Event_] => Unit = null,
    onIonError: /* event */ CustomEvent => Unit = null,
    onIonImgDidLoad: /* event */ CustomEvent => Unit = null,
    onIonImgWillLoad: /* event */ CustomEvent => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonImgElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonImgElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonImgElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonImgElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonImgElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonImgElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonImgElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonImgElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonImgElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonImgElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonImgElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonImgElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonImgElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonImgElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonImgElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonImgElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = IonImgPickHTMLAttributesH
}
