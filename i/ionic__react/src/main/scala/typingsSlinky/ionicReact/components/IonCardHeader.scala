...
object IonCardHeader
  ...
  def apply(
    ...
    mode: ios | md = null,
    onAbort: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonCardHeaderElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonCardHeaderElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonCardHeaderElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonCardHeaderElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonCardHeaderElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonCardHeaderElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonCardHeaderElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonCardHeaderElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonCardHeaderElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonCardHeaderElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDrag: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDrop: DragEvent[HTMLIonCardHeaderElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonCardHeaderElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonCardHeaderElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonCardHeaderElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonCardHeaderElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonCardHeaderElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonCardHeaderElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonCardHeaderElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonCardHeaderElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonCardHeaderElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonCardHeaderElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonCardHeaderElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonCardHeaderElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonCardHeaderElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonCardHeaderElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonCardHeaderElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonCardHeaderElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonCardHeaderElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = IonCardHeaderPickHTMLAttr
}
