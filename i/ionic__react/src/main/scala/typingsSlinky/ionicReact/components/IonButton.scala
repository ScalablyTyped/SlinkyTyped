...
object IonButton
  ...
  def apply(
    ...
    mode: ios | md = null,
    onAbort: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonButtonElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonButtonElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonButtonElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonButtonElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonButtonElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonButtonElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonButtonElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonButtonElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonButtonElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonButtonElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonButtonElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonButtonElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonButtonElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonButtonElement, Event_] => Unit = null,
    onIonBlur: /* event */ CustomEvent => Unit = null,
    onIonFocus: /* event */ CustomEvent => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonButtonElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonButtonElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonButtonElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonButtonElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonButtonElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonButtonElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonButtonElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonButtonElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonButtonElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonButtonElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonButtonElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonButtonElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonButtonElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonButtonElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonButtonElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonButtonElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = PickIonButtondisabledstro
}
