...
object IonInfiniteScrollContent
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollContentElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollContentElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollContentElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollContentElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollContentElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollContentElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonInfiniteScrollContentElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonInfiniteScrollContentElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = IonInfiniteScrollContentP
}
