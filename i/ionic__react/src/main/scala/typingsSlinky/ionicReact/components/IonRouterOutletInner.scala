...
import typingsSlinky.ionicReact.IonRouterOutletPickHTMLAt
...
object IonRouterOutletInner {
  ...
  def withProps(p: IonRouterOutletPickHTMLAt): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[IonRouterOutletPickHTMLAt]))
  }
}
