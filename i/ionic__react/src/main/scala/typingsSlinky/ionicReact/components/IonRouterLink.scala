...
object IonRouterLink
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, hidden, href, id, lang, placeholder, rel, spellCheck, suppressContentEditableWarning, tabIndex, target, title */
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonRouterLinkElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonRouterLinkElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonRouterLinkElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonRouterLinkElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonRouterLinkElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonRouterLinkElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonRouterLinkElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonRouterLinkElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonRouterLinkElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonRouterLinkElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonRouterLinkElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonRouterLinkElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonRouterLinkElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonRouterLinkElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonRouterLinkElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonRouterLinkElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonRouterLinkElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonRouterLinkElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonRouterLinkElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonRouterLinkElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonRouterLinkElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonRouterLinkElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonRouterLinkElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonRouterLinkElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonRouterLinkElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonRouterLinkElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonRouterLinkElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonRouterLinkElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = PickIonRouterLinkcolorhre
}
