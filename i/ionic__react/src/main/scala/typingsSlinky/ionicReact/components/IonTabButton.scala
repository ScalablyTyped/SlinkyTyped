...
object IonTabButton
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, href, id, lang, placeholder, rel, selected, spellCheck, suppressContentEditableWarning, tabIndex, target, title */
  def apply(
  ...
  type Props = IonTabButtonPickHTMLAttri
}
