...
object IonDatetime
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, name, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonDatetimeElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonDatetimeElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonDatetimeElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonDatetimeElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonDatetimeElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonDatetimeElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonDatetimeElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonDatetimeElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonDatetimeElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonDatetimeElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonDatetimeElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonDatetimeElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonDatetimeElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonDatetimeElement, Event_] => Unit = null,
    ...
    onKeyDown: SyntheticKeyboardEvent[HTMLIonDatetimeElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonDatetimeElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonDatetimeElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonDatetimeElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonDatetimeElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonDatetimeElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonDatetimeElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonDatetimeElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonDatetimeElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonDatetimeElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonDatetimeElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonDatetimeElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonDatetimeElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonDatetimeElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonDatetimeElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonDatetimeElement] => Unit = null,
  ...
  type Props = IonDatetimePickHTMLAttrib
}
