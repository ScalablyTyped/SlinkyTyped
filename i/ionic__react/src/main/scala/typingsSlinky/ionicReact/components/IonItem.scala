...
object IonItem
  ...
  def apply(
    ...
    mode: ios | md = null,
    onAbort: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonItemElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonItemElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonItemElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonItemElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonItemElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonItemElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonItemElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonItemElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonItemElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonItemElement] => Unit = null,
  ...
  type Props = PickIonItemdisabledbutton
}
