...
object IonMenu
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, placeholder, spellCheck, suppressContentEditableWarning, tabIndex, title, type */
  def apply(
    ...
    menuId: String = null,
    onAbort: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonMenuElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonMenuElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonMenuElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonMenuElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonMenuElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonMenuElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonMenuElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonMenuElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonMenuElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonMenuElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonMenuElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onDrag: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDrop: DragEvent[HTMLIonMenuElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonMenuElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonMenuElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonMenuElement, Event_] => Unit = null,
    ...
    onKeyDown: SyntheticKeyboardEvent[HTMLIonMenuElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonMenuElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonMenuElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonMenuElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonMenuElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonMenuElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonMenuElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonMenuElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonMenuElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonMenuElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonMenuElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonMenuElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonMenuElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonMenuElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonMenuElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonMenuElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = IonMenuPickHTMLAttributes
}
