...
object IonSelectOption
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, placeholder, selected, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
  ...
  type Props = IonSelectOptionPickHTMLAt
}
