...
object IonIcon
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, hidden, id, lang, name, placeholder, spellCheck, src, suppressContentEditableWarning, tabIndex, title */
  def apply(
    ...
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonIconElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonIconElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonIconElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonIconElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonIconElement] => Unit = null,
    ...
    onChange: SyntheticEvent[EventTarget with HTMLIonIconElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonIconElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonIconElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonIconElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonIconElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonIconElement] => Unit = null,
    ...
    onError: SyntheticEvent[Event_, HTMLIonIconElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonIconElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonIconElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonIconElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonIconElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonIconElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonIconElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonIconElement] => Unit = null,
    ...
    onMouseDown: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonIconElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonIconElement] => Unit = null,
    ...
    onPointerCancel: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonIconElement] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with HTMLIonIconElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonIconElement] => Unit = null,
    ...
    onSubmit: SyntheticEvent[EventTarget with HTMLIonIconElement, Event_] => Unit = null,
    ...
    onTouchCancel: SyntheticTouchEvent[HTMLIonIconElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonIconElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonIconElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonIconElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonIconElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonIconElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonIconElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonIconElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = IonIconPropsIonicReactPro
}
