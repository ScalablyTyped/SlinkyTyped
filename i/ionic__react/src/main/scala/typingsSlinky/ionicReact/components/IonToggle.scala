...
object IonToggle
  ...
  /* The following DOM/SVG props were specified: checked, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, name, placeholder, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
  ...
  type Props = IonTogglePickHTMLAttribut
}
