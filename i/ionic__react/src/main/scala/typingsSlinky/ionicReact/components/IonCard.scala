...
object IonCard
  ...
  def apply(
    ...
    mode: ios | md = null,
    onAbort: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonCardElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonCardElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonCardElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonCardElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonCardElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonCardElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonCardElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonCardElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonCardElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonCardElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonCardElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonCardElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonCardElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonCardElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonCardElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonCardElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonCardElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonCardElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonCardElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonCardElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonCardElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonCardElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonCardElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonCardElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonCardElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonCardElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonCardElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonCardElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonCardElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonCardElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = PickIonCarddisabledbutton
}
