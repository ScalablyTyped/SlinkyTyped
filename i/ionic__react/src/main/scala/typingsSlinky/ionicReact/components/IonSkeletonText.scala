...
object IonSkeletonText
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonSkeletonTextElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonSkeletonTextElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonSkeletonTextElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonSkeletonTextElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonSkeletonTextElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonSkeletonTextElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonSkeletonTextElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonSkeletonTextElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonSkeletonTextElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = IonSkeletonTextPickHTMLAt
}
