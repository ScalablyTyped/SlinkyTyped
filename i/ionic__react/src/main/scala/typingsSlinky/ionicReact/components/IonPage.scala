...
object IonPage {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onChange(value: SyntheticEvent[EventTarget, Event] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
  ...
  implicit def make(companion: IonPage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
