...
object IonInput
  ...
  /* The following DOM/SVG props were specified: accept, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, multiple, name, pattern, required, size, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
    ...
    mode: ios | md = null,
    onAbort: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonInputElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonInputElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonInputElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonInputElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonInputElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonInputElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonInputElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonInputElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonInputElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonInputElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonInputElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onDrag: DragEvent[HTMLIonInputElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonInputElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonInputElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonInputElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonInputElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonInputElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonInputElement] => Unit = null,
    onDrop: DragEvent[HTMLIonInputElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonInputElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonInputElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonInputElement, Event_] => Unit = null,
    ...
    onKeyDown: SyntheticKeyboardEvent[HTMLIonInputElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonInputElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonInputElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonInputElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonInputElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonInputElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonInputElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonInputElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonInputElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonInputElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonInputElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonInputElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonInputElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonInputElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonInputElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonInputElement] => Unit = null,
  ...
  type Props = IonInputPickHTMLAttribute
}
