...
object IonFabButton
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, href, id, lang, placeholder, rel, spellCheck, suppressContentEditableWarning, tabIndex, target, title */
  def apply(
    ...
    mode: ios | md = null,
    onAbort: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonFabButtonElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonFabButtonElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonFabButtonElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonFabButtonElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonFabButtonElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonFabButtonElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonFabButtonElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonFabButtonElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonFabButtonElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonFabButtonElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonFabButtonElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onDrag: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDrop: DragEvent[HTMLIonFabButtonElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonFabButtonElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonFabButtonElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonFabButtonElement, Event_] => Unit = null,
    onIonBlur: /* event */ CustomEvent => Unit = null,
    onIonFocus: /* event */ CustomEvent => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonFabButtonElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonFabButtonElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonFabButtonElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonFabButtonElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonFabButtonElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonFabButtonElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonFabButtonElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonFabButtonElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonFabButtonElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonFabButtonElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonFabButtonElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonFabButtonElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonFabButtonElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonFabButtonElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonFabButtonElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonFabButtonElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = PickIonFabButtonshowdisab
}
