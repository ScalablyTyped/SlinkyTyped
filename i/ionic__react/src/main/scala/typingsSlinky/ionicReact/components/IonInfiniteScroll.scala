...
object IonInfiniteScroll
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, placeholder, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDrag: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDrop: DragEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollElement, Event_] => Unit = null,
    onIonInfinite: /* event */ CustomEvent => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonInfiniteScrollElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonInfiniteScrollElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonInfiniteScrollElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonInfiniteScrollElement] => Unit = null,
  ...
  type Props = IonInfiniteScrollPickHTML
}
