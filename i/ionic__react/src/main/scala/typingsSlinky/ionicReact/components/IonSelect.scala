...
object IonSelect
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, multiple, name, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
  ...
  type Props = IonSelectPickHTMLAttribut
}
