...
object IonItemSliding
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonItemSlidingElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonItemSlidingElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonItemSlidingElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonItemSlidingElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonItemSlidingElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonItemSlidingElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonItemSlidingElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonItemSlidingElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonItemSlidingElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonItemSlidingElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonItemSlidingElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonItemSlidingElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonItemSlidingElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonItemSlidingElement, Event_] => Unit = null,
    onIonDrag: /* event */ CustomEvent => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonItemSlidingElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonItemSlidingElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonItemSlidingElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonItemSlidingElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonItemSlidingElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonItemSlidingElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonItemSlidingElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonItemSlidingElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonItemSlidingElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonItemSlidingElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonItemSlidingElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonItemSlidingElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonItemSlidingElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonItemSlidingElement] => Unit = null,
    prefix: String = null,
  ...
  type Props = IonItemSlidingPickHTMLAtt
}
