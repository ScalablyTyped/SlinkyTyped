...
object IonSpinner
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, hidden, id, lang, name, placeholder, spellCheck, suppressContentEditableWarning, tabIndex, title */
  def apply(
  ...
  type Props = IonSpinnerPickHTMLAttribu
}
