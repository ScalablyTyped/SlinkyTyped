package typingsSlinky.ionicReact.ionTabButtonMod
...
trait Props extends js.Object {
  ...
  var ref: js.UndefOr[ReactRef[HTMLIonTabButtonElement]] = js.native
  /**
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: ReactRef[HTMLIonTabButtonElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
