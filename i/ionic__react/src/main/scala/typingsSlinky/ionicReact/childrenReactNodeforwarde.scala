...
object childrenReactNodeforwarde {
  ...
  implicit class childrenReactNodeforwardeOps[Self <: childrenReactNodeforwarde] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForwardedRef(value: ReactRef[HTMLIonModalElement]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRefRefObject(value: ReactRef[HTMLIonModalElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRefFunction1(value: /* instance */ HTMLIonModalElement | Null => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRef(value: Ref[HTMLIonModalElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
