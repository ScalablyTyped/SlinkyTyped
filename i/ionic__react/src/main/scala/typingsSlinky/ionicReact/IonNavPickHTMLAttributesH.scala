...
trait IonNavPickHTMLAttributesH extends js.Object {
  ...
  var onAbort: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onAbortCapture: js.Any
  var onAnimationEnd: js.UndefOr[AnimationEventHandler[HTMLIonNavElement]] = js.undefined
  var onAnimationEndCapture: js.Any
  var onAnimationIteration: js.UndefOr[AnimationEventHandler[HTMLIonNavElement]] = js.undefined
  var onAnimationIterationCapture: js.Any
  var onAnimationStart: js.UndefOr[AnimationEventHandler[HTMLIonNavElement]] = js.undefined
  var onAnimationStartCapture: js.Any
  var onAuxClick: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onAuxClickCapture: js.Any
  var onBeforeInput: js.UndefOr[FormEventHandler[HTMLIonNavElement]] = js.undefined
  var onBeforeInputCapture: js.Any
  var onBlur: js.UndefOr[FocusEventHandler[HTMLIonNavElement]] = js.undefined
  var onBlurCapture: js.Any
  var onCanPlay: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onCanPlayCapture: js.Any
  var onCanPlayThrough: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onCanPlayThroughCapture: js.Any
  var onChange: js.UndefOr[FormEventHandler[HTMLIonNavElement]] = js.undefined
  var onChangeCapture: js.Any
  var onClick: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onClickCapture: js.Any
  var onCompositionEnd: js.UndefOr[CompositionEventHandler[HTMLIonNavElement]] = js.undefined
  var onCompositionEndCapture: js.Any
  var onCompositionStart: js.UndefOr[CompositionEventHandler[HTMLIonNavElement]] = js.undefined
  var onCompositionStartCapture: js.Any
  var onCompositionUpdate: js.UndefOr[CompositionEventHandler[HTMLIonNavElement]] = js.undefined
  var onCompositionUpdateCapture: js.Any
  var onContextMenu: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onContextMenuCapture: js.Any
  var onCopy: js.UndefOr[ClipboardEventHandler[HTMLIonNavElement]] = js.undefined
  var onCopyCapture: js.Any
  var onCut: js.UndefOr[ClipboardEventHandler[HTMLIonNavElement]] = js.undefined
  var onCutCapture: js.Any
  var onDoubleClick: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onDoubleClickCapture: js.Any
  var onDrag: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDragCapture: js.Any
  var onDragEnd: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDragEndCapture: js.Any
  var onDragEnter: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDragEnterCapture: js.Any
  var onDragExit: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDragExitCapture: js.Any
  var onDragLeave: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDragLeaveCapture: js.Any
  var onDragOver: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDragOverCapture: js.Any
  var onDragStart: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDragStartCapture: js.Any
  var onDrop: js.UndefOr[DragEventHandler[HTMLIonNavElement]] = js.undefined
  var onDropCapture: js.Any
  var onDurationChange: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onDurationChangeCapture: js.Any
  var onEmptied: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onEmptiedCapture: js.Any
  var onEncrypted: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onEncryptedCapture: js.Any
  var onEnded: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onEndedCapture: js.Any
  var onError: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onErrorCapture: js.Any
  var onFocus: js.UndefOr[FocusEventHandler[HTMLIonNavElement]] = js.undefined
  var onFocusCapture: js.Any
  var onGotPointerCapture: js.Any
  var onGotPointerCaptureCapture: js.Any
  var onInput: js.UndefOr[FormEventHandler[HTMLIonNavElement]] = js.undefined
  var onInputCapture: js.Any
  var onInvalid: js.UndefOr[FormEventHandler[HTMLIonNavElement]] = js.undefined
  ...
  var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLIonNavElement]] = js.undefined
  var onKeyDownCapture: js.Any
  var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLIonNavElement]] = js.undefined
  var onKeyPressCapture: js.Any
  var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLIonNavElement]] = js.undefined
  var onKeyUpCapture: js.Any
  var onLoad: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onLoadCapture: js.Any
  var onLoadStart: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onLoadStartCapture: js.Any
  var onLoadedData: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onLoadedDataCapture: js.Any
  var onLoadedMetadata: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onLoadedMetadataCapture: js.Any
  var onLostPointerCapture: js.Any
  var onLostPointerCaptureCapture: js.Any
  var onMouseDown: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onMouseDownCapture: js.Any
  var onMouseEnter: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onMouseLeave: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onMouseMove: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onMouseMoveCapture: js.Any
  var onMouseOut: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onMouseOutCapture: js.Any
  var onMouseOver: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onMouseOverCapture: js.Any
  var onMouseUp: js.UndefOr[MouseEventHandler[HTMLIonNavElement]] = js.undefined
  var onMouseUpCapture: js.Any
  var onPaste: js.UndefOr[ClipboardEventHandler[HTMLIonNavElement]] = js.undefined
  var onPasteCapture: js.Any
  var onPause: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onPauseCapture: js.Any
  var onPlay: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onPlayCapture: js.Any
  var onPlaying: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onPlayingCapture: js.Any
  var onPointerCancel: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerCancelCapture: js.Any
  var onPointerDown: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerDownCapture: js.Any
  var onPointerEnter: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerEnterCapture: js.Any
  var onPointerLeave: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerLeaveCapture: js.Any
  var onPointerMove: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerMoveCapture: js.Any
  var onPointerOut: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerOutCapture: js.Any
  var onPointerOver: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerOverCapture: js.Any
  var onPointerUp: js.UndefOr[PointerEventHandler[HTMLIonNavElement]] = js.undefined
  var onPointerUpCapture: js.Any
  var onProgress: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onProgressCapture: js.Any
  var onRateChange: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onRateChangeCapture: js.Any
  var onReset: js.UndefOr[FormEventHandler[HTMLIonNavElement]] = js.undefined
  var onResetCapture: js.Any
  var onScroll: js.UndefOr[UIEventHandler[HTMLIonNavElement]] = js.undefined
  var onScrollCapture: js.Any
  var onSeeked: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onSeekedCapture: js.Any
  var onSeeking: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onSeekingCapture: js.Any
  var onSelect: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onSelectCapture: js.Any
  var onStalled: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onStalledCapture: js.Any
  var onSubmit: js.UndefOr[FormEventHandler[HTMLIonNavElement]] = js.undefined
  var onSubmitCapture: js.Any
  var onSuspend: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onSuspendCapture: js.Any
  var onTimeUpdate: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onTimeUpdateCapture: js.Any
  var onTouchCancel: js.UndefOr[TouchEventHandler[HTMLIonNavElement]] = js.undefined
  var onTouchCancelCapture: js.Any
  var onTouchEnd: js.UndefOr[TouchEventHandler[HTMLIonNavElement]] = js.undefined
  var onTouchEndCapture: js.Any
  var onTouchMove: js.UndefOr[TouchEventHandler[HTMLIonNavElement]] = js.undefined
  var onTouchMoveCapture: js.Any
  var onTouchStart: js.UndefOr[TouchEventHandler[HTMLIonNavElement]] = js.undefined
  var onTouchStartCapture: js.Any
  var onTransitionEnd: js.UndefOr[TransitionEventHandler[HTMLIonNavElement]] = js.undefined
  var onTransitionEndCapture: js.Any
  var onVolumeChange: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onVolumeChangeCapture: js.Any
  var onWaiting: js.UndefOr[ReactEventHandler[HTMLIonNavElement]] = js.undefined
  var onWaitingCapture: js.Any
  var onWheel: js.UndefOr[WheelEventHandler[HTMLIonNavElement]] = js.undefined
  var onWheelCapture: js.Any
  var placeholder: js.UndefOr[String] = js.undefined
  var prefix: js.UndefOr[String] = js.undefined
  var property: js.UndefOr[String] = js.undefined
  var radioGroup: js.UndefOr[String] = js.undefined
  var ref: js.UndefOr[Ref[HTMLIonNavElement]] = js.undefined
...
object IonNavPickHTMLAttributesH {
  ...
  def apply(
    ...
    key: Key = null,
    lang: String = null,
    onAbort: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLIonNavElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLIonNavElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLIonNavElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIonNavElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLIonNavElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLIonNavElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLIonNavElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLIonNavElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLIonNavElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLIonNavElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLIonNavElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onDrag: DragEvent[HTMLIonNavElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonNavElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonNavElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonNavElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonNavElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonNavElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonNavElement] => Unit = null,
    onDrop: DragEvent[HTMLIonNavElement] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLIonNavElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLIonNavElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLIonNavElement, Event_] => Unit = null,
    onIonNavDidChange: /* event */ CustomEvent => Unit = null,
    onIonNavWillChange: /* event */ CustomEvent => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLIonNavElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLIonNavElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLIonNavElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLIonNavElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLIonNavElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLIonNavElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIonNavElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLIonNavElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLIonNavElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLIonNavElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLIonNavElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLIonNavElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLIonNavElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLIonNavElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLIonNavElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLIonNavElement] => Unit = null,
    placeholder: String = null,
    prefix: String = null,
    property: String = null,
    radioGroup: String = null,
    ref: Ref[HTMLIonNavElement] = null,
