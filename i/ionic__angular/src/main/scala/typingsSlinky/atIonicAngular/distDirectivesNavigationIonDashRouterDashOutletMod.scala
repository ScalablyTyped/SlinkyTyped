...
import typingsSlinky.atAngularCore.atAngularCoreMod.OnInit
import typingsSlinky.atAngularCore.atAngularCoreMod.ViewContainerRef
import typingsSlinky.atAngularRouter.atAngularRouterMod.ActivatedRoute
import typingsSlinky.atAngularRouter.atAngularRouterMod.ChildrenOutletContexts
import typingsSlinky.atAngularRouter.atAngularRouterMod.OutletContext
import typingsSlinky.atAngularRouter.atAngularRouterMod.Router
import typingsSlinky.atIonicAngular.distDirectivesNavigationIonDashRouterDashOutletMod.IonRouterOutlet
import typingsSlinky.atIonicAngular.distProvidersConfigMod.Config
...
@js.native
object distDirectivesNavigationIonDashRouterDashOutletMod extends js.Object {
  @js.native
