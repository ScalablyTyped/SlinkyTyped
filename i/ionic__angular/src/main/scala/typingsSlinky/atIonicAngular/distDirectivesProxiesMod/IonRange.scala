...
import typingsSlinky.atIonicCore.distTypesComponentsRangeRangeDashInterfaceMod.RangeValue
...
class IonRange protected ()
  extends typingsSlinky.atIonicCore.distTypesComponentsMod.Components.IonRange {
