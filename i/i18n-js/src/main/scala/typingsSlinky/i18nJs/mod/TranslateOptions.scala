...
object TranslateOptions {
  ...
  implicit class TranslateOptionsOps[Self <: TranslateOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultsVarargs(value: (Message | typingsSlinky.i18nJs.anon.Scope)*): Self = this.set("defaults", js.Array(value :_*))
    
    @scala.inline
    def setDefaults(value: js.Array[Message | typingsSlinky.i18nJs.anon.Scope]): Self = this.set("defaults", value.asInstanceOf[js.Any])
