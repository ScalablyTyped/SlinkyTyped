...
object IdyllDocumentProps {
  ...
  implicit class IdyllDocumentPropsOps[Self <: IdyllDocumentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorComponentFunctionComponent(value: ReactComponentClass[Children]): Self = this.set("errorComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setErrorComponentComponentClass(value: ReactComponentClass[Children]): Self = this.set("errorComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnError(value: /* err */ js.Error => Unit): Self = this.set("onError", js.Any.fromFunction1(value))
