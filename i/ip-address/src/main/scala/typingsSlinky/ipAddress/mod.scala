...
import typingsSlinky.ipAddress.anon.Address
import typingsSlinky.ipAddress.anon.Error
import typingsSlinky.ipAddress.anon.Typeofhelpers
...
object mod {
  ...
  class Address4 protected ()
    extends typingsSlinky.ipAddress.ipv4Mod.Address4 {
  ...
  object Address4 {
    ...
    @js.native
    def fromBigInteger(bigInteger: BigInteger): typingsSlinky.ipAddress.ipv4Mod.Address4 = js.native
    ...
    @js.native
    def fromHex(hex: String): typingsSlinky.ipAddress.ipv4Mod.Address4 = js.native
    ...
    @js.native
    def fromInteger(integer: Double): typingsSlinky.ipAddress.ipv4Mod.Address4 = js.native
  ...
  class Address6 protected ()
    extends typingsSlinky.ipAddress.ipv6Mod.Address6 {
    def this(address: String) = this()
  ...
  object Address6 {
    ...
    @js.native
    def fromAddress4(address: String): typingsSlinky.ipAddress.ipv6Mod.Address6 = js.native
    ...
    @js.native
    def fromArpa(arpaFormAddress: String): typingsSlinky.ipAddress.ipv6Mod.Address6 = js.native
    ...
    @js.native
    def fromBigInteger(bigInteger: BigInteger): typingsSlinky.ipAddress.ipv6Mod.Address6 = js.native
    ...
    @js.native
    def fromByteArray(bytes: js.Array[_]): typingsSlinky.ipAddress.ipv6Mod.Address6 = js.native
    ...
    @js.native
    def fromUnsignedByteArray(bytes: js.Array[_]): typingsSlinky.ipAddress.ipv6Mod.Address6 = js.native
