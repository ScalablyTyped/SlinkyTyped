...
class Address6 protected () extends js.Object {
  ...
  def regularExpression(substring: String): js.RegExp = js.native
  def regularExpressionString(): js.RegExp = js.native
...
object Address6 extends js.Object {
  var RE_BAD_ADDRESS: js.RegExp = js.native
  var RE_BAD_CHARACTERS: js.RegExp = js.native
  var RE_SUBNET_STRING: js.RegExp = js.native
  var RE_ZONE_STRING: js.RegExp = js.native
