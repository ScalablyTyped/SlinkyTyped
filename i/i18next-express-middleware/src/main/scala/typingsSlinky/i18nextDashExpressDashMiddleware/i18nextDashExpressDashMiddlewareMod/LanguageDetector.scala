...
import typingsSlinky.i18next.i18nextMod.Module
...
class LanguageDetector () extends Module {
  ...
  @JSName("type")
  var type_LanguageDetector: typingsSlinky.i18nextDashExpressDashMiddleware.i18nextDashExpressDashMiddlewareStrings.languageDetector = js.native
