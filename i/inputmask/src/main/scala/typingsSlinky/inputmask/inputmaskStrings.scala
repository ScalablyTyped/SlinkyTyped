...
import typingsSlinky.inputmask.inputmaskMod.Casing
import typingsSlinky.inputmask.inputmaskMod.InputMode
import typingsSlinky.inputmask.inputmaskMod.PositionCaretOnClick
