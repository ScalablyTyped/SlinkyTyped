package typingsSlinky.imagemagick
...
object mod {
  ...
  @js.native
  def crop(options: Options, callback: js.Function2[/* err */ js.Error, /* result */ js.Any, Unit]): ChildProcess = js.native
  ...
  @js.native
  def readMetadata(path: String, callback: js.Function2[/* err */ js.Error, /* result */ js.Any, Unit]): ChildProcess = js.native
  
  @JSImport("imagemagick", "resize")
  @js.native
  def resize(options: Options, callback: js.Function2[/* err */ js.Error, /* result */ js.Any, Unit]): ChildProcess = js.native
