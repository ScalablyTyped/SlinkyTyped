...
import typingsSlinky.ipfsHttpServer.anon.MethodOptions
...
@js.native
object routesFilesRegularMod extends TopLevel[/* n */ NumberDictionary[Path | MethodOptions]] {
  ...
  var iterator: js.Function0[IterableIterator[Path | MethodOptions]] = js.native
