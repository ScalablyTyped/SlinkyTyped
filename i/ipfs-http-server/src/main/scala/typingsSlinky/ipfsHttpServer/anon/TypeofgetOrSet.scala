...
@js.native
trait TypeofgetOrSet extends js.Object {
...
object TypeofgetOrSet {
  ...
  @scala.inline
  implicit class TypeofgetOrSetOps[Self <: TypeofgetOrSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions(value: TypeofoptionsPayload): Self = this.set("options", value.asInstanceOf[js.Any])
  }
}
