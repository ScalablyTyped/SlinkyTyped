...
@js.native
trait TypeofvalidateOptions1 extends StObject {
...
object TypeofvalidateOptions1 {
  ...
  @scala.inline
  implicit class TypeofvalidateOptions1MutableBuilder[Self <: TypeofvalidateOptions1] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setOptions_1(value: js.Any): Self = StObject.set(x, "options_1", value.asInstanceOf[js.Any])
  }
}
