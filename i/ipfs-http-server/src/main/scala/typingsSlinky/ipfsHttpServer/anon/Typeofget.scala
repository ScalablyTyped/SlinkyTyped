...
@js.native
trait Typeofget extends js.Object {
...
object Typeofget {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[_], options_2: Typeofoptions2): Typeofget = {
  ...
  @scala.inline
  implicit class TypeofgetOps[Self <: Typeofget] (val x: Self) extends AnyVal {
