...
@js.native
trait TypeofpatchRmLink extends js.Object {
...
object TypeofpatchRmLink {
  ...
  @scala.inline
  implicit class TypeofpatchRmLinkOps[Self <: TypeofpatchRmLink] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions_18(value: Typeofoptions18): Self = this.set("options_18", value.asInstanceOf[js.Any])
  }
}
