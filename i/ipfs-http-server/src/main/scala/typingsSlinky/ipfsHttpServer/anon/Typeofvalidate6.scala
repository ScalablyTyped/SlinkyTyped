...
@js.native
trait Typeofvalidate6 extends StObject {
...
object Typeofvalidate6 {
  ...
  @scala.inline
  implicit class Typeofvalidate6MutableBuilder[Self <: Typeofvalidate6] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setOptions_13(value: Typeofoptions13): Self = StObject.set(x, "options_13", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setQuery_6(value: js.Any): Self = StObject.set(x, "query_6", value.asInstanceOf[js.Any])
  }
}
