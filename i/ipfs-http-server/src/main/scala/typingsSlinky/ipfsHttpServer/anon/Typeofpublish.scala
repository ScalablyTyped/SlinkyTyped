...
@js.native
trait Typeofpublish extends js.Object {
...
object Typeofpublish {
  ...
  @scala.inline
  implicit class TypeofpublishOps[Self <: Typeofpublish] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions_2(value: Typeofoptions2Payload): Self = this.set("options_2", value.asInstanceOf[js.Any])
  }
}
