...
@js.native
trait TypeofpatchAppendData extends js.Object {
...
object TypeofpatchAppendData {
  ...
  @scala.inline
  implicit class TypeofpatchAppendDataOps[Self <: TypeofpatchAppendData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions_12(value: Typeofoptions12): Self = this.set("options_12", value.asInstanceOf[js.Any])
  }
}
