...
object routesPubsubMod {
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "length")
  @js.native
  def length: Double = js.native
  @scala.inline
  def length_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("length")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pubsub", "values")
  @js.native
