...
import typingsSlinky.ipfsHttpServer.anon.Path
...
object routesBitswapMod {
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "length")
  @js.native
  def length: Double = js.native
  @scala.inline
  def length_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("length")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bitswap", "values")
  @js.native
