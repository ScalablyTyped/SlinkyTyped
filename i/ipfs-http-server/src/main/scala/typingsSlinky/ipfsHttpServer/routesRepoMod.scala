...
object routesRepoMod {
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "length")
  @js.native
  def length: Double = js.native
  @scala.inline
  def length_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("length")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/repo", "values")
  @js.native
