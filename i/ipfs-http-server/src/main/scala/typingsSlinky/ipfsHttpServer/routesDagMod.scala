...
object routesDagMod {
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "length")
  @js.native
  def length: Double = js.native
  @scala.inline
  def length_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("length")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/dag", "values")
  @js.native
