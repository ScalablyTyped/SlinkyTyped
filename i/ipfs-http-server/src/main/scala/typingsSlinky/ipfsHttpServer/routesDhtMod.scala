...
import typingsSlinky.ipfsHttpServer.anon.HandlerMethod
...
@js.native
object routesDhtMod extends TopLevel[/* n */ NumberDictionary[HandlerMethod]] {
  ...
  var iterator: js.Function0[IterableIterator[HandlerMethod]] = js.native
