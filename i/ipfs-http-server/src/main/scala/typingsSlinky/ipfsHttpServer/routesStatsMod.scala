...
object routesStatsMod {
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/stats", "values")
  @js.native
