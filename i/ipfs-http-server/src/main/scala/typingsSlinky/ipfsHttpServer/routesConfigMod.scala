...
object routesConfigMod {
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "length")
  @js.native
  def length: Double = js.native
  @scala.inline
  def length_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("length")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/config", "values")
  @js.native
