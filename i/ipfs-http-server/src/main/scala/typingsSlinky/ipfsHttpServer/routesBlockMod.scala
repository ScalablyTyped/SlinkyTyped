...
object routesBlockMod {
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/block", "values")
  @js.native
