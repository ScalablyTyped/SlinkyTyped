...
import typingsSlinky.ignoreDashWalk.Anon_Follow
import typingsSlinky.ignoreDashWalk.ignoreDashWalkStrings.done
import typingsSlinky.ignoreDashWalk.ignoreDashWalkStrings.error
...
class Walker () extends EventEmitter {
  ...
  def walkerOpt(entry: String): Anon_Follow = js.native
}
