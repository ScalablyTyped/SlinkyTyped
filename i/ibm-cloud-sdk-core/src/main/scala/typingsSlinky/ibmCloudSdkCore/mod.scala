...
import typingsSlinky.ibmCloudSdkCore.v1Mod.Options
...
object mod {
  ...
  class BaseService protected ()
    extends typingsSlinky.ibmCloudSdkCore.baseServiceMod.BaseService {
    /**
  ...
  class IamTokenManagerV1 protected ()
    extends typingsSlinky.ibmCloudSdkCore.v1Mod.IamTokenManagerV1 {
    /**
  ...
  @JSImport("ibm-cloud-sdk-core", "getContentType")
  @js.native
  def getContentType(inputData: typingsSlinky.node.NodeJS.ReadableStream): String = js.native
