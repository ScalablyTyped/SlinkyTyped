...
import typingsSlinky.ibmDashCloudDashSdkDashCore.libBaseUnderscoreServiceMod.UserOptions
import typingsSlinky.ibmDashCloudDashSdkDashCore.libHelperMod.FileObject
import typingsSlinky.ibmDashCloudDashSdkDashCore.libHelperMod.FileParamAttributes
...
object ibmDashCloudDashSdkDashCoreMod extends js.Object {
  ...
  class BaseService protected ()
    extends typingsSlinky.ibmDashCloudDashSdkDashCore.libBaseUnderscoreServiceMod.BaseService {
    /**
  ...
  class IamTokenManagerV1 protected ()
    extends typingsSlinky.ibmDashCloudDashSdkDashCore.iamDashTokenDashManagerV1Mod.IamTokenManagerV1 {
    /**
