...
object Added {
  ...
  implicit class AddedOps[Self <: Added] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddedVarargs(value: typingsSlinky.inboxsdk.mod.Common.Contact*): Self = this.set("added", js.Array(value :_*))
    
    @scala.inline
    def setAdded(value: js.Array[typingsSlinky.inboxsdk.mod.Common.Contact]): Self = this.set("added", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRemovedVarargs(value: typingsSlinky.inboxsdk.mod.Common.Contact*): Self = this.set("removed", js.Array(value :_*))
    
    @scala.inline
    def setRemoved(value: js.Array[typingsSlinky.inboxsdk.mod.Common.Contact]): Self = this.set("removed", value.asInstanceOf[js.Any])
  }
}
