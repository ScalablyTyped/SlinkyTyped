...
trait AnonAdded extends js.Object {
  var added: js.Array[Contact] = js.native
  var removed: js.Array[Contact] = js.native
}
...
object AnonAdded {
  ...
  implicit class AnonAddedOps[Self <: AnonAdded] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdded(value: js.Array[Contact]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("added")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRemoved(value: js.Array[Contact]): Self = {
        val ret = this.duplicate
