...
object KeyboardInstance {
  ...
  implicit class KeyboardInstanceOps[Self <: KeyboardInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateShortcutHandle(value: KeyboardShortcutDescriptor => KeyboardShortcutHandle): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createShortcutHandle")(js.Any.fromFunction1(value))
        ret
    }
  }
