...
object NavMenu {
  ...
  */
  ...
  object NavItemDescriptor {
    ...
    @scala.inline
    def NavItemIconHtmlDescriptor(name: String): typingsSlinky.inboxsdk.mod.NavMenu.NavItemIconHtmlDescriptor = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.inboxsdk.mod.NavMenu.NavItemIconHtmlDescriptor]
    }
    
    @scala.inline
    def NavItemIconUrlDescriptor(name: String): typingsSlinky.inboxsdk.mod.NavMenu.NavItemIconUrlDescriptor = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.inboxsdk.mod.NavMenu.NavItemIconUrlDescriptor]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.inboxsdk.inboxsdkStrings.LINK
    - typingsSlinky.inboxsdk.inboxsdkStrings.NAVIGATION
  */
  trait NavItemTypes extends StObject
  object NavItemTypes {
    
    @scala.inline
    def LINK: typingsSlinky.inboxsdk.inboxsdkStrings.LINK = "LINK".asInstanceOf[typingsSlinky.inboxsdk.inboxsdkStrings.LINK]
    
    @scala.inline
    def NAVIGATION: typingsSlinky.inboxsdk.inboxsdkStrings.NAVIGATION = "NAVIGATION".asInstanceOf[typingsSlinky.inboxsdk.inboxsdkStrings.NAVIGATION]
  }
