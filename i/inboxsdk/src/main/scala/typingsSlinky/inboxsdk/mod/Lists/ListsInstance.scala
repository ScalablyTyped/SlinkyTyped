...
object ListsInstance {
  ...
  implicit class ListsInstanceOps[Self <: ListsInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetSelectedThreadRowViews(value: () => js.Array[ThreadRowView]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSelectedThreadRowViews")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRegisterThreadRowViewHandler(value: js.Function1[/* threadRowView */ ThreadRowView, _] => js.Function0[Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("registerThreadRowViewHandler")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRegisterThreadRowViewSelectionHandler(value: js.Function0[_] => js.Function0[Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("registerThreadRowViewSelectionHandler")(js.Any.fromFunction1(value))
        ret
    }
  }
