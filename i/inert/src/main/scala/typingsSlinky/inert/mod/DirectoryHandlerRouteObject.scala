...
object DirectoryHandlerRouteObject {
  ...
  implicit class DirectoryHandlerRouteObjectOps[Self <: DirectoryHandlerRouteObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPathFunction1(value: /* request */ Request => String | js.Array[String] | js.Error): Self = this.set("path", js.Any.fromFunction1(value))
    @scala.inline
    def setPath(value: String | js.Array[String] | (RequestHandler[String | js.Array[String] | js.Error])): Self = this.set("path", value.asInstanceOf[js.Any])
    @scala.inline
