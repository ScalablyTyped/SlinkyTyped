...
object AccountSettings {
  ...
  implicit class AccountSettingsOps[Self <: AccountSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAccepted_gallery_terms(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accepted_gallery_terms")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withActive_emails(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("active_emails")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAlbum_privacy(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("album_privacy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBlocked_users(value: js.Array[BlockedUser]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("blocked_users")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withHigh_quality(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("high_quality")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMessaging_enabled(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("messaging_enabled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPublic_images(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("public_images")(value.asInstanceOf[js.Any])
        ret
    }
  }
