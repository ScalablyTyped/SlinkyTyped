...
object themeMod {
  ...
  @JSImport("@ionic/core/dist/types/utils/theme", "createColorClasses")
  @js.native
  ...
  @JSImport("@ionic/core/dist/types/utils/theme", "getClassList")
  @js.native
  ...
  @JSImport("@ionic/core/dist/types/utils/theme", "getClassMap")
  @js.native
  ...
  @JSImport("@ionic/core/dist/types/utils/theme", "hostContext")
  @js.native
  def hostContext(selector: String, el: HTMLElement): Boolean = js.native
  
  @JSImport("@ionic/core/dist/types/utils/theme", "openURL")
  @js.native
