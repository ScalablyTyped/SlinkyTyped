...
trait AlertInput extends js.Object {
  ...
  var handler: js.UndefOr[js.Function1[/* input */ AlertInput, Unit]] = js.native
  ...
  var `type`: js.UndefOr[TextFieldTypes | checkbox | radio] = js.native
...
object AlertInput {
  ...
  implicit class AlertInputOps[Self <: AlertInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHandler(value: /* input */ AlertInput => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: TextFieldTypes | checkbox | radio): Self = {
        val ret = this.duplicate
