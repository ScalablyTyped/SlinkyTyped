...
trait TransitionResult extends js.Object {
  var animation: js.UndefOr[Animation | typingsSlinky.ionicCore.animationInterfaceMod.Animation] = js.undefined
...
object TransitionResult {
  ...
  def apply(
    ...
    animation: Animation | typingsSlinky.ionicCore.animationInterfaceMod.Animation = null
  ): TransitionResult = {
