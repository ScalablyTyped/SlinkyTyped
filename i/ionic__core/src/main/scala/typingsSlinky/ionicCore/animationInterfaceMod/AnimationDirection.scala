...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.ionicCore.ionicCoreStrings.normal
  - typingsSlinky.ionicCore.ionicCoreStrings.reverse
  - typingsSlinky.ionicCore.ionicCoreStrings.alternate
  - typingsSlinky.ionicCore.ionicCoreStrings.`alternate-reverse`
*/
