...
package object mod {
  type BackButtonEvent = org.scalajs.dom.raw.CustomEvent
  type Color = typingsSlinky.ionicCore.mod.PredefinedColors | java.lang.String
  type ComponentProps[T] = org.scalablytyped.runtime.StringDictionary[js.Any]
  type ComponentRef = js.Function | org.scalajs.dom.raw.HTMLElement | java.lang.String | scala.Null
