...
trait CustomElementsDefineOptions extends StObject {
  ...
  var ce: js.UndefOr[js.Function2[/* eventName */ String, /* opts */ js.UndefOr[js.Any], CustomEvent]] = js.native
...
object CustomElementsDefineOptions {
  ...
  implicit class CustomElementsDefineOptionsMutableBuilder[Self <: CustomElementsDefineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCe(value: (/* eventName */ String, /* opts */ js.UndefOr[js.Any]) => CustomEvent): Self = StObject.set(x, "ce", js.Any.fromFunction2(value))
