package typingsSlinky.ionicCore.modalInterfaceMod
...
object ModalOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.ionicCore.mod.ComponentRef */ T](component: T): ModalOptions[T] = {
    val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any])
    __obj.asInstanceOf[ModalOptions[T]]
  }
  @scala.inline
  implicit class ModalOptionsOps[Self <: ModalOptions[_], /* <: typingsSlinky.ionicCore.mod.ComponentRef */ T] (val x: Self with ModalOptions[T]) extends AnyVal {
    @scala.inline
