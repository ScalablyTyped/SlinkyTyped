...
object IonNav {
  ...
  implicit class IonNavOps[Self <: IonNav] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonNavDidChange(value: /* event */ CustomEvent => Unit): Self = this.set("onIonNavDidChange", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonNavDidChange: Self = this.set("onIonNavDidChange", js.undefined)
    @scala.inline
    def setOnIonNavWillChange(value: /* event */ CustomEvent => Unit): Self = this.set("onIonNavWillChange", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonNavWillChange: Self = this.set("onIonNavWillChange", js.undefined)
    @scala.inline
    def setRootHTMLElement(value: HTMLElement): Self = this.set("root", value.asInstanceOf[js.Any])
    @scala.inline
