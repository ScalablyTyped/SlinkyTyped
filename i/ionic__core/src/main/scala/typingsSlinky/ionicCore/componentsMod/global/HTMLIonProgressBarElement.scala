...
import typingsSlinky.ionicCore.componentsMod.Components.IonProgressBar
...
@js.native
object HTMLIonProgressBarElement extends Instantiable0[HTMLIonProgressBarElement]
