...
trait IonRouteRedirect extends js.Object {
  ...
  /**
    ...
    */
  var onIonRouteRedirectChanged: js.UndefOr[js.Function1[/* event */ CustomEvent, Unit]] = js.undefined
  /**
...
object IonRouteRedirect {
  @scala.inline
  def apply(from: String, onIonRouteRedirectChanged: /* event */ CustomEvent => Unit = null, to: String = null): IonRouteRedirect = {
