...
object IonRoute {
  ...
  implicit class IonRouteOps[Self <: IonRoute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnIonRouteDataChanged(value: /* event */ CustomEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onIonRouteDataChanged")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutOnIonRouteDataChanged: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onIonRouteDataChanged")(js.undefined)
        ret
    }
    @scala.inline
