...
object IonLoading {
  ...
  implicit class IonLoadingOps[Self <: IonLoading] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonLoadingDidDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonLoadingDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonLoadingDidDismiss: Self = this.set("onIonLoadingDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonLoadingDidPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonLoadingDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonLoadingDidPresent: Self = this.set("onIonLoadingDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonLoadingWillDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonLoadingWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonLoadingWillDismiss: Self = this.set("onIonLoadingWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonLoadingWillPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonLoadingWillPresent", js.Any.fromFunction1(value))
