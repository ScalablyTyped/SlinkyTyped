...
object IonRouter {
  ...
  implicit class IonRouterMutableBuilder[Self <: IonRouter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonRouteDidChange(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonRouteDidChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonRouteDidChangeUndefined: Self = StObject.set(x, "onIonRouteDidChange", js.undefined)
    
    @scala.inline
    def setOnIonRouteWillChange(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonRouteWillChange", js.Any.fromFunction1(value))
