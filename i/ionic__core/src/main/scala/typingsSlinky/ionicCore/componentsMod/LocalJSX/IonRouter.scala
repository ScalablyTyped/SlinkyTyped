...
object IonRouter {
  ...
  implicit class IonRouterOps[Self <: IonRouter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonRouteDidChange(value: /* event */ CustomEvent => Unit): Self = this.set("onIonRouteDidChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonRouteDidChange: Self = this.set("onIonRouteDidChange", js.undefined)
    
    @scala.inline
    def setOnIonRouteWillChange(value: /* event */ CustomEvent => Unit): Self = this.set("onIonRouteWillChange", js.Any.fromFunction1(value))
