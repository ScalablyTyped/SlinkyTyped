...
object IonPicker {
  ...
  implicit class IonPickerOps[Self <: IonPicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonPickerDidDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPickerDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonPickerDidDismiss: Self = this.set("onIonPickerDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonPickerDidPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPickerDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonPickerDidPresent: Self = this.set("onIonPickerDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonPickerWillDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPickerWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonPickerWillDismiss: Self = this.set("onIonPickerWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonPickerWillPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPickerWillPresent", js.Any.fromFunction1(value))
