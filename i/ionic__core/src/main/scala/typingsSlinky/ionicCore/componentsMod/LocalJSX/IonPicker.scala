...
object IonPicker {
  ...
  implicit class IonPickerMutableBuilder[Self <: IonPicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonPickerDidDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPickerDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonPickerDidDismissUndefined: Self = StObject.set(x, "onIonPickerDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonPickerDidPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPickerDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonPickerDidPresentUndefined: Self = StObject.set(x, "onIonPickerDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonPickerWillDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPickerWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonPickerWillDismissUndefined: Self = StObject.set(x, "onIonPickerWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonPickerWillPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPickerWillPresent", js.Any.fromFunction1(value))
