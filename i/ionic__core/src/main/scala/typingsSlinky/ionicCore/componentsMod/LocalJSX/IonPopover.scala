...
object IonPopover {
  ...
  implicit class IonPopoverOps[Self <: IonPopover] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonPopoverDidDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPopoverDidDismiss", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonPopoverDidDismiss: Self = this.set("onIonPopoverDidDismiss", js.undefined)
    @scala.inline
    def setOnIonPopoverDidPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPopoverDidPresent", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonPopoverDidPresent: Self = this.set("onIonPopoverDidPresent", js.undefined)
    @scala.inline
    def setOnIonPopoverWillDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPopoverWillDismiss", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonPopoverWillDismiss: Self = this.set("onIonPopoverWillDismiss", js.undefined)
    @scala.inline
    def setOnIonPopoverWillPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonPopoverWillPresent", js.Any.fromFunction1(value))
    @scala.inline
