...
object IonPopover {
  ...
  implicit class IonPopoverMutableBuilder[Self <: IonPopover] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonPopoverDidDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPopoverDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonPopoverDidDismissUndefined: Self = StObject.set(x, "onIonPopoverDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonPopoverDidPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPopoverDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonPopoverDidPresentUndefined: Self = StObject.set(x, "onIonPopoverDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonPopoverWillDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPopoverWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonPopoverWillDismissUndefined: Self = StObject.set(x, "onIonPopoverWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonPopoverWillPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonPopoverWillPresent", js.Any.fromFunction1(value))
