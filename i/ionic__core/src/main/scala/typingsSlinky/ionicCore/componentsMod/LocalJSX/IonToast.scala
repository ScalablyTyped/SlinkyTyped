...
object IonToast {
  ...
  implicit class IonToastMutableBuilder[Self <: IonToast] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonToastDidDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonToastDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonToastDidDismissUndefined: Self = StObject.set(x, "onIonToastDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonToastDidPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonToastDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonToastDidPresentUndefined: Self = StObject.set(x, "onIonToastDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonToastWillDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonToastWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonToastWillDismissUndefined: Self = StObject.set(x, "onIonToastWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonToastWillPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonToastWillPresent", js.Any.fromFunction1(value))
