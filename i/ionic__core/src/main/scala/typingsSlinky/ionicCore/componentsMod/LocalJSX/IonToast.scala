...
object IonToast {
  ...
  implicit class IonToastOps[Self <: IonToast] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonToastDidDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonToastDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonToastDidDismiss: Self = this.set("onIonToastDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonToastDidPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonToastDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonToastDidPresent: Self = this.set("onIonToastDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonToastWillDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonToastWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonToastWillDismiss: Self = this.set("onIonToastWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonToastWillPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonToastWillPresent", js.Any.fromFunction1(value))
