...
object IonAlert {
  ...
  implicit class IonAlertOps[Self <: IonAlert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonAlertDidDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonAlertDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonAlertDidDismiss: Self = this.set("onIonAlertDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonAlertDidPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonAlertDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonAlertDidPresent: Self = this.set("onIonAlertDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonAlertWillDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonAlertWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIonAlertWillDismiss: Self = this.set("onIonAlertWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonAlertWillPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonAlertWillPresent", js.Any.fromFunction1(value))
