...
object IonAlert {
  ...
  implicit class IonAlertMutableBuilder[Self <: IonAlert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonAlertDidDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonAlertDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonAlertDidDismissUndefined: Self = StObject.set(x, "onIonAlertDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonAlertDidPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonAlertDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonAlertDidPresentUndefined: Self = StObject.set(x, "onIonAlertDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonAlertWillDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonAlertWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonAlertWillDismissUndefined: Self = StObject.set(x, "onIonAlertWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonAlertWillPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonAlertWillPresent", js.Any.fromFunction1(value))
