...
object IonActionSheet {
  ...
  implicit class IonActionSheetOps[Self <: IonActionSheet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonActionSheetDidDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonActionSheetDidDismiss", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonActionSheetDidDismiss: Self = this.set("onIonActionSheetDidDismiss", js.undefined)
    @scala.inline
    def setOnIonActionSheetDidPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonActionSheetDidPresent", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonActionSheetDidPresent: Self = this.set("onIonActionSheetDidPresent", js.undefined)
    @scala.inline
    def setOnIonActionSheetWillDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonActionSheetWillDismiss", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonActionSheetWillDismiss: Self = this.set("onIonActionSheetWillDismiss", js.undefined)
    @scala.inline
    def setOnIonActionSheetWillPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonActionSheetWillPresent", js.Any.fromFunction1(value))
    @scala.inline
