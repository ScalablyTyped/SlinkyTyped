...
object IonActionSheet {
  ...
  implicit class IonActionSheetMutableBuilder[Self <: IonActionSheet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonActionSheetDidDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonActionSheetDidDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonActionSheetDidDismissUndefined: Self = StObject.set(x, "onIonActionSheetDidDismiss", js.undefined)
    
    @scala.inline
    def setOnIonActionSheetDidPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonActionSheetDidPresent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonActionSheetDidPresentUndefined: Self = StObject.set(x, "onIonActionSheetDidPresent", js.undefined)
    
    @scala.inline
    def setOnIonActionSheetWillDismiss(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonActionSheetWillDismiss", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnIonActionSheetWillDismissUndefined: Self = StObject.set(x, "onIonActionSheetWillDismiss", js.undefined)
    
    @scala.inline
    def setOnIonActionSheetWillPresent(value: /* event */ CustomEvent => Unit): Self = StObject.set(x, "onIonActionSheetWillPresent", js.Any.fromFunction1(value))
