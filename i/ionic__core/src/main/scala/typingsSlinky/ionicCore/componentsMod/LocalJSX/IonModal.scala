...
object IonModal {
  ...
  implicit class IonModalOps[Self <: IonModal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonModalDidDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonModalDidDismiss", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonModalDidDismiss: Self = this.set("onIonModalDidDismiss", js.undefined)
    @scala.inline
    def setOnIonModalDidPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonModalDidPresent", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonModalDidPresent: Self = this.set("onIonModalDidPresent", js.undefined)
    @scala.inline
    def setOnIonModalWillDismiss(value: /* event */ CustomEvent => Unit): Self = this.set("onIonModalWillDismiss", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnIonModalWillDismiss: Self = this.set("onIonModalWillDismiss", js.undefined)
    @scala.inline
    def setOnIonModalWillPresent(value: /* event */ CustomEvent => Unit): Self = this.set("onIonModalWillPresent", js.Any.fromFunction1(value))
    @scala.inline
