...
object IonModal {
  ...
  def apply(
    ...
    mode: ios | md = null,
    onIonModalDidDismiss: /* event */ CustomEvent => Unit = null,
    onIonModalDidPresent: /* event */ CustomEvent => Unit = null,
    onIonModalWillDismiss: /* event */ CustomEvent => Unit = null,
    onIonModalWillPresent: /* event */ CustomEvent => Unit = null,
