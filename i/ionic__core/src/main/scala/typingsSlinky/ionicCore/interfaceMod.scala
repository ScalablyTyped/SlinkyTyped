...
object interfaceMod {
  ...
  trait RouteID extends StObject {
    ...
    var element: js.UndefOr[org.scalajs.dom.raw.HTMLElement] = js.native
  ...
  object RouteID {
    ...
    implicit class RouteIDMutableBuilder[Self <: RouteID] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setElement(value: org.scalajs.dom.raw.HTMLElement): Self = StObject.set(x, "element", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object RouterDirection {
    ...
    @scala.inline
    def root: typingsSlinky.ionicCore.ionicCoreStrings.root = "root".asInstanceOf[typingsSlinky.ionicCore.ionicCoreStrings.root]
  }
