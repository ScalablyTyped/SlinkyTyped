...
trait AnonCircles extends js.Object {
  ...
  def fn(dur: Double, index: Double, total: Double): AnonR = js.native
}
...
object AnonCircles {
  ...
  @scala.inline
  implicit class AnonCirclesOps[Self <: AnonCircles] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFn(value: (Double, Double, Double) => AnonR): Self = {
        val ret = this.duplicate
