...
trait AnonCirclesDur extends js.Object {
  ...
  def fn(_underscore: Double, index: Double): AnonRNumber = js.native
}
...
object AnonCirclesDur {
  ...
  @scala.inline
  implicit class AnonCirclesDurOps[Self <: AnonCirclesDur] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFn(value: (Double, Double) => AnonRNumber): Self = {
        val ret = this.duplicate
