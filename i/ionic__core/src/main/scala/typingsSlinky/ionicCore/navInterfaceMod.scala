...
object navInterfaceMod {
  ...
  class ViewController protected ()
    extends typingsSlinky.ionicCore.viewControllerMod.ViewController {
    def this(component: js.Any) = this()
    def this(component: js.Any, params: ComponentProps[Null]) = this()
  }
  
  type NavComponent = ComponentRef | typingsSlinky.ionicCore.viewControllerMod.ViewController
  ...
  */
  ...
  object NavResult {
    ...
    implicit class NavResultMutableBuilder[Self <: NavResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEnteringView(value: typingsSlinky.ionicCore.viewControllerMod.ViewController): Self = StObject.set(x, "enteringView", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLeavingView(value: typingsSlinky.ionicCore.viewControllerMod.ViewController): Self = StObject.set(x, "leavingView", value.asInstanceOf[js.Any])
  ...
  object TransitionInstruction {
    ...
    implicit class TransitionInstructionMutableBuilder[Self <: TransitionInstruction] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRemoveView(value: typingsSlinky.ionicCore.viewControllerMod.ViewController): Self = StObject.set(x, "removeView", value.asInstanceOf[js.Any])
