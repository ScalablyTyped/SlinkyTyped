...
object PopoverOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.ionicCore.mod.ComponentRef */ T](component: T): PopoverOptions[T] = {
    val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any])
    __obj.asInstanceOf[PopoverOptions[T]]
  }
  @scala.inline
  implicit class PopoverOptionsOps[Self <: PopoverOptions[_], /* <: typingsSlinky.ionicCore.mod.ComponentRef */ T] (val x: Self with PopoverOptions[T]) extends AnyVal {
    @scala.inline
