package typingsSlinky.ionicCore.searchbarInterfaceMod
...
object SearchbarChangeEventDetail {
  ...
  @scala.inline
  implicit class SearchbarChangeEventDetailOps[Self <: SearchbarChangeEventDetail] (val x: Self) extends AnyVal {
    @scala.inline
