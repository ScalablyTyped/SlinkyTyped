...
trait TransitionInstruction extends js.Object {
  ...
  var removeView: js.UndefOr[typingsSlinky.ionicCore.viewControllerMod.ViewController] = js.undefined
...
object TransitionInstruction {
  @scala.inline
  def apply(
    done: (/* hasCompleted */ Boolean, /* requiresTransition */ Boolean, /* enteringView */ js.UndefOr[typingsSlinky.ionicCore.viewControllerMod.ViewController], /* leavingView */ js.UndefOr[typingsSlinky.ionicCore.viewControllerMod.ViewController], /* direction */ js.UndefOr[String]) => Unit = null,
    ...
    removeView: typingsSlinky.ionicCore.viewControllerMod.ViewController = null,
