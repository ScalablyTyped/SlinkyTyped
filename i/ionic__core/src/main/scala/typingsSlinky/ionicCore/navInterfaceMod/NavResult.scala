...
object NavResult {
  ...
  implicit class NavResultOps[Self <: NavResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnteringView(value: typingsSlinky.ionicCore.viewControllerMod.ViewController): Self = this.set("enteringView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEnteringView: Self = this.set("enteringView", js.undefined)
    
    @scala.inline
    def setLeavingView(value: typingsSlinky.ionicCore.viewControllerMod.ViewController): Self = this.set("leavingView", value.asInstanceOf[js.Any])
