...
trait NavResult extends js.Object {
  ...
  var enteringView: js.UndefOr[typingsSlinky.ionicCore.viewControllerMod.ViewController] = js.undefined
  var hasCompleted: Boolean
  var leavingView: js.UndefOr[typingsSlinky.ionicCore.viewControllerMod.ViewController] = js.undefined
...
object NavResult {
  ...
  def apply(
    ...
    enteringView: typingsSlinky.ionicCore.viewControllerMod.ViewController = null,
    leavingView: typingsSlinky.ionicCore.viewControllerMod.ViewController = null
  ): NavResult = {
