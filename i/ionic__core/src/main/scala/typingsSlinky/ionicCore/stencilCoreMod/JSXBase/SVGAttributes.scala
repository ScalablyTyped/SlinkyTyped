...
import typingsSlinky.ionicCore.ionicCoreStrings.`after-edge`
import typingsSlinky.ionicCore.ionicCoreStrings.`before-edge`
import typingsSlinky.ionicCore.ionicCoreStrings.`text-after-edge`
import typingsSlinky.ionicCore.ionicCoreStrings.`text-before-edge`
import typingsSlinky.ionicCore.ionicCoreStrings.alphabetic
import typingsSlinky.ionicCore.ionicCoreStrings.auto
import typingsSlinky.ionicCore.ionicCoreStrings.baseline
import typingsSlinky.ionicCore.ionicCoreStrings.bevel
import typingsSlinky.ionicCore.ionicCoreStrings.butt
import typingsSlinky.ionicCore.ionicCoreStrings.central
import typingsSlinky.ionicCore.ionicCoreStrings.evenodd
import typingsSlinky.ionicCore.ionicCoreStrings.hanging
import typingsSlinky.ionicCore.ionicCoreStrings.ideographic
import typingsSlinky.ionicCore.ionicCoreStrings.inherit
import typingsSlinky.ionicCore.ionicCoreStrings.initial
import typingsSlinky.ionicCore.ionicCoreStrings.isolated
import typingsSlinky.ionicCore.ionicCoreStrings.linearRGB
import typingsSlinky.ionicCore.ionicCoreStrings.mathematical
import typingsSlinky.ionicCore.ionicCoreStrings.medial
import typingsSlinky.ionicCore.ionicCoreStrings.middle
import typingsSlinky.ionicCore.ionicCoreStrings.miter
import typingsSlinky.ionicCore.ionicCoreStrings.no
import typingsSlinky.ionicCore.ionicCoreStrings.none
import typingsSlinky.ionicCore.ionicCoreStrings.nonzero
import typingsSlinky.ionicCore.ionicCoreStrings.replace
import typingsSlinky.ionicCore.ionicCoreStrings.round
import typingsSlinky.ionicCore.ionicCoreStrings.sRGB
import typingsSlinky.ionicCore.ionicCoreStrings.square
import typingsSlinky.ionicCore.ionicCoreStrings.sum
import typingsSlinky.ionicCore.ionicCoreStrings.terminal
import typingsSlinky.ionicCore.ionicCoreStrings.yes
...
object SVGAttributes {
  ...
  implicit class SVGAttributesOps[Self[t] <: SVGAttributes[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withStrokeMiterlimit(value: String): Self[T] = {
        val ret = this.duplicate
