...
@JSImport("@ionic/core/dist/types/components/alert/animations/md.enter", JSImport.Namespace)
@js.native
object distTypesComponentsAlertAnimationsMdDotEnterMod extends js.Object {
