...
@js.native
object distTypesUtilsHapticMod extends js.Object {
  def hapticAvailable(): Boolean = js.native
  def hapticImpact(options: Anon_Heavy): Unit = js.native
  def hapticNotification(options: Anon_Error): Unit = js.native
