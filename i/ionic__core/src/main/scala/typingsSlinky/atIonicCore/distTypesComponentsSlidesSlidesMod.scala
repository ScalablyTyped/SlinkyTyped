...
import typingsSlinky.atIonicCore.distTypesComponentsMod._Global_.HTMLIonSlidesElement
...
@js.native
object distTypesComponentsSlidesSlidesMod extends js.Object {
  @js.native
  class Slides () extends ComponentInterface {
    ...
    var paginationEl: js.UndefOr[js.Any] = js.native
