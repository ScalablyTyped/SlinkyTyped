...
@JSImport("@ionic/core/dist/types/components/action-sheet/animations/ios.leave", JSImport.Namespace)
@js.native
object distTypesComponentsActionDashSheetAnimationsIosDotLeaveMod extends js.Object {
