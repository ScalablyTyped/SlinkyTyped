...
import typingsSlinky.atIonicCore.distTypesComponentsMenuMenuDashInterfaceMod.MenuChangeEventDetail
...
@js.native
object distTypesComponentsMenuMenuMod extends js.Object {
  @js.native
  class Menu ()
