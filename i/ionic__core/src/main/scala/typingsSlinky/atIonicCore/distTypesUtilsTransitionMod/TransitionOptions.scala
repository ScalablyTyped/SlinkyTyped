...
trait TransitionOptions extends NavOptions {
  ...
  var progressCallback: js.UndefOr[
    js.Function1[
      /* ani */ js.UndefOr[
        Animation | typingsSlinky.atIonicCore.distTypesUtilsAnimationOldDashAnimationAnimationDashInterfaceMod.Animation
      ], 
      Unit
    ]
  ] = js.undefined
...
object TransitionOptions {
  ...
  def apply(
    ...
    animationBuilder: (/* Animation */ typingsSlinky.atIonicCore.distTypesUtilsAnimationOldDashAnimationAnimationDashInterfaceMod.Animation, /* baseEl */ js.Any, /* opts */ js.UndefOr[js.Any]) => js.Promise[
      typingsSlinky.atIonicCore.distTypesUtilsAnimationOldDashAnimationAnimationDashInterfaceMod.Animation
    ] = null,
