...
trait IonRouter extends js.Object {
  /**
    ...
    */
  var onIonRouteDidChange: js.UndefOr[js.Function1[/* event */ CustomEvent, Unit]] = js.undefined
  /**
    * Event emitted when the route is about to change
    */
  var onIonRouteWillChange: js.UndefOr[js.Function1[/* event */ CustomEvent, Unit]] = js.undefined
  /**
...
object IonRouter {
  @scala.inline
  def apply(
    onIonRouteDidChange: /* event */ CustomEvent => Unit = null,
    onIonRouteWillChange: /* event */ CustomEvent => Unit = null,
    root: String = null,
