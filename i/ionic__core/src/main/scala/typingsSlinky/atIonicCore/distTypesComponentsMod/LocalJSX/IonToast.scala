...
import typingsSlinky.atIonicCore.atIonicCoreStrings.middle
import typingsSlinky.atIonicCore.atIonicCoreStrings.top
import typingsSlinky.atIonicCore.distTypesComponentsToastToastDashInterfaceMod.ToastButton
...
object IonToast {
  ...
  def apply(
    ...
    message: String = null,
    mode: ios | md = null,
    onIonToastDidDismiss: /* event */ CustomEvent => Unit = null,
    onIonToastDidPresent: /* event */ CustomEvent => Unit = null,
    onIonToastWillDismiss: /* event */ CustomEvent => Unit = null,
    onIonToastWillPresent: /* event */ CustomEvent => Unit = null,
