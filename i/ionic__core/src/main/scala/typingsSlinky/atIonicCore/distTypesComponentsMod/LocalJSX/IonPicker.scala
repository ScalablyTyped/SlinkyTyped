...
import typingsSlinky.atIonicCore.distTypesComponentsPickerPickerDashInterfaceMod.PickerButton
import typingsSlinky.atIonicCore.distTypesComponentsPickerPickerDashInterfaceMod.PickerColumn
...
object IonPicker {
  ...
  def apply(
    ...
    mode: ios | md = null,
    onIonPickerDidDismiss: /* event */ CustomEvent => Unit = null,
    onIonPickerDidPresent: /* event */ CustomEvent => Unit = null,
    onIonPickerWillDismiss: /* event */ CustomEvent => Unit = null,
    onIonPickerWillPresent: /* event */ CustomEvent => Unit = null,
