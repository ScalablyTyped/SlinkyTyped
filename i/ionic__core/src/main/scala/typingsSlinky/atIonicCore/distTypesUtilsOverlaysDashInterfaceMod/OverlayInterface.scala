package typingsSlinky.atIonicCore.distTypesUtilsOverlaysDashInterfaceMod

import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.atIonicCore.atIonicCoreMod.Mode
...
trait OverlayInterface extends js.Object {
  ...
  var animation: js.UndefOr[
    Animation | typingsSlinky.atIonicCore.distTypesUtilsAnimationAnimationDashInterfaceMod.Animation
  ] = js.native
