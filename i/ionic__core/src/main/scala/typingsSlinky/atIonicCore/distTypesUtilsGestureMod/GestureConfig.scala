package typingsSlinky.atIonicCore.distTypesUtilsGestureMod

import org.scalajs.dom.raw.Node
import typingsSlinky.atIonicCore.atIonicCoreStrings.x
import typingsSlinky.atIonicCore.atIonicCoreStrings.y
