package typingsSlinky.atIonicCore.distTypesComponentsNavNavDashInterfaceMod
...
object NavResult {
  ...
  def apply(
    ...
    enteringView: typingsSlinky.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController = null,
    leavingView: typingsSlinky.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController = null
  ): NavResult = {
