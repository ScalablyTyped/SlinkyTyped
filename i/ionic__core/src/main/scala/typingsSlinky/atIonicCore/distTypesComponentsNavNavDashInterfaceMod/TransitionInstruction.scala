...
object TransitionInstruction {
  @scala.inline
  def apply(
    done: (/* hasCompleted */ Boolean, /* requiresTransition */ Boolean, /* enteringView */ js.UndefOr[
      typingsSlinky.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController
    ], /* leavingView */ js.UndefOr[
      typingsSlinky.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController
    ], /* direction */ js.UndefOr[String]) => Unit = null,
    ...
    removeView: typingsSlinky.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController = null,
