package typingsSlinky.atIonicCore.distTypesComponentsContentContentDashInterfaceMod

import org.scalajs.dom.raw.UIEvent
import typingsSlinky.atIonicCore.distTypesUtilsGestureMod.GestureDetail
