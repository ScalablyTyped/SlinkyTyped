package typingsSlinky.atIonicCore.distTypesComponentsHeaderHeaderDotUtilsMod

import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.atIonicCore.distTypesComponentsMod._Global_.HTMLIonTitleElement
