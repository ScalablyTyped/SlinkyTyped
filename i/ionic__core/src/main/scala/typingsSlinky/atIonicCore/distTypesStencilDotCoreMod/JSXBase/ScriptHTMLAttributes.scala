package typingsSlinky.atIonicCore.distTypesStencilDotCoreMod.JSXBase
...
import typingsSlinky.atIonicCore.atIonicCoreStrings.auto
import typingsSlinky.atIonicCore.atIonicCoreStrings.high
import typingsSlinky.atIonicCore.atIonicCoreStrings.low
