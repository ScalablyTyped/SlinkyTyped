...
import typingsSlinky.intlRelativeformat.typesMod.DATA_FIELD
...
object intlRelativeformatStrings {
  ...
  @js.native
  sealed trait numeric extends STYLE
  
  @js.native
  sealed trait quarter extends DATA_FIELD
  
  @js.native
  sealed trait `quarter-narrow` extends DATA_FIELD
  
  @js.native
  sealed trait `quarter-short` extends DATA_FIELD
