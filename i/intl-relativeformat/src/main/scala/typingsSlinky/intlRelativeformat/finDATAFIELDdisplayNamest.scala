...
trait finDATAFIELDdisplayNamest extends js.Object {
  ...
  var hour: AnonDisplayName
  var `hour-narrow`: AnonDisplayName
  var `hour-short`: AnonDisplayName
  var minute: AnonDisplayName
  var `minute-narrow`: AnonDisplayName
  var `minute-short`: AnonDisplayName
  ...
  var second: AnonDisplayName
  var `second-narrow`: AnonDisplayName
  var `second-short`: AnonDisplayName
  var week: AnonDisplayName
  var `week-narrow`: AnonDisplayName
  var `week-short`: AnonDisplayName
  var year: AnonDisplayName
  var `year-narrow`: AnonDisplayName
  var `year-short`: AnonDisplayName
}
