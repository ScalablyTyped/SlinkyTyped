...
object Visitor {
  @scala.inline
  def apply[/* <: typingsSlinky.istanbulLibReport.mod.Node */ N](
  ...
  @scala.inline
  implicit class VisitorOps[Self <: Visitor[_], /* <: typingsSlinky.istanbulLibReport.mod.Node */ N] (val x: Self with Visitor[N]) extends AnyVal {
    @scala.inline
