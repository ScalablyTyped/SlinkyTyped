...
object Tree {
  @scala.inline
  def apply[/* <: typingsSlinky.istanbulLibReport.mod.Node */ N](getRoot: () => N, visit: (Partial[Visitor[N]], js.Any) => Unit): Tree[N] = {
  ...
  @scala.inline
  implicit class TreeOps[Self <: Tree[_], /* <: typingsSlinky.istanbulLibReport.mod.Node */ N] (val x: Self with Tree[N]) extends AnyVal {
    @scala.inline
