...
@js.native
trait AnonBackendTraceId extends js.Object {
...
object AnonBackendTraceId {
  @scala.inline
  def apply(): AnonBackendTraceId = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBackendTraceId]
  }
  @scala.inline
  implicit class AnonBackendTraceIdOps[Self <: AnonBackendTraceId] (val x: Self) extends AnyVal {
    @scala.inline
