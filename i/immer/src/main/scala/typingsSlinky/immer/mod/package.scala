...
package object mod {
  type ArrayMethod = typingsSlinky.std.Exclude[java.lang.String, scala.Double]
  ...
  {-readonly [ P in keyof T ]: / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias immer.immer.Draft<T[P]> * / object}
    */ typingsSlinky.immer.immerStrings.Draft with js.Any) | typingsSlinky.immer.mod.DraftTuple[T] | typingsSlinky.immer.mod.DraftArray[T]
  ...
  type Indices[T] = typingsSlinky.std.Exclude[java.lang.String, typingsSlinky.immer.mod.ArrayMethod]
