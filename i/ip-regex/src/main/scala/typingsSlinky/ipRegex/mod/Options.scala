...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeBoundaries(value: Boolean): Self = this.set("includeBoundaries", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIncludeBoundaries: Self = this.set("includeBoundaries", js.undefined)
  }
}
