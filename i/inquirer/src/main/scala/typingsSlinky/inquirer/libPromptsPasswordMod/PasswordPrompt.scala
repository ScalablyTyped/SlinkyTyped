package typingsSlinky.inquirer.libPromptsPasswordMod

import typingsSlinky.inquirer.inquirerMod.prompts.FailedPromptStateData
import typingsSlinky.inquirer.inquirerMod.prompts.SuccessfulPromptStateData
...
trait PasswordPrompt[TQuestion /* <: Question */]
  extends typingsSlinky.inquirer.libPromptsBaseMod.^[TQuestion] {
  /**
