...
object PasswordQuestionOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): PasswordQuestionOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PasswordQuestionOptions[T]]
  }
  @scala.inline
  implicit class PasswordQuestionOptionsOps[Self <: PasswordQuestionOptions[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with PasswordQuestionOptions[T]) extends AnyVal {
    @scala.inline
