...
object Question {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): Question[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Question[T]]
  }
  @scala.inline
  implicit class QuestionOps[Self <: Question[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with Question[T]) extends AnyVal {
    @scala.inline
