...
object InputQuestion {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): InputQuestion[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputQuestion[T]]
  }
  @scala.inline
  implicit class InputQuestionOps[Self <: InputQuestion[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with InputQuestion[T]) extends AnyVal {
    @scala.inline
