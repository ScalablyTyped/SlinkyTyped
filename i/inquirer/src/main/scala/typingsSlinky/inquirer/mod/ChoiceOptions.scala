...
object ChoiceOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): ChoiceOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChoiceOptions[T]]
  }
  @scala.inline
  implicit class ChoiceOptionsOps[Self <: ChoiceOptions[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with ChoiceOptions[T]) extends AnyVal {
    @scala.inline
