...
object PasswordQuestion {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](`type`: password): PasswordQuestion[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[PasswordQuestion[T]]
  }
  @scala.inline
  implicit class PasswordQuestionOps[Self <: PasswordQuestion[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with PasswordQuestion[T]) extends AnyVal {
    @scala.inline
