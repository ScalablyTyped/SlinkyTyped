...
object CheckboxQuestion {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](`type`: checkbox): CheckboxQuestion[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[CheckboxQuestion[T]]
  }
  @scala.inline
  implicit class CheckboxQuestionOps[Self <: CheckboxQuestion[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with CheckboxQuestion[T]) extends AnyVal {
    @scala.inline
