...
object EditorQuestion {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](`type`: editor): EditorQuestion[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[EditorQuestion[T]]
  }
  @scala.inline
  implicit class EditorQuestionOps[Self <: EditorQuestion[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with EditorQuestion[T]) extends AnyVal {
    @scala.inline
