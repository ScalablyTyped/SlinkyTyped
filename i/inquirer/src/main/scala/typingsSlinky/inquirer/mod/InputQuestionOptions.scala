...
object InputQuestionOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): InputQuestionOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputQuestionOptions[T]]
  }
  @scala.inline
  implicit class InputQuestionOptionsOps[Self <: InputQuestionOptions[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with InputQuestionOptions[T]) extends AnyVal {
    @scala.inline
