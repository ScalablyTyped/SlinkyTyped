...
object ListQuestionOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): ListQuestionOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListQuestionOptions[T]]
  }
  @scala.inline
  implicit class ListQuestionOptionsOps[Self <: ListQuestionOptions[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with ListQuestionOptions[T]) extends AnyVal {
    @scala.inline
