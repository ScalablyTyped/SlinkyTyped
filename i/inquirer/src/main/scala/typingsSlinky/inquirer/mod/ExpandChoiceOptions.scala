...
object ExpandChoiceOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): ExpandChoiceOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExpandChoiceOptions[T]]
  }
  @scala.inline
  implicit class ExpandChoiceOptionsOps[Self <: ExpandChoiceOptions[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with ExpandChoiceOptions[T]) extends AnyVal {
    @scala.inline
