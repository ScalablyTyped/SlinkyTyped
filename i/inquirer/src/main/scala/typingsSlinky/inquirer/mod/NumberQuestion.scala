...
object NumberQuestion {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](`type`: number): NumberQuestion[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[NumberQuestion[T]]
  }
  @scala.inline
  implicit class NumberQuestionOps[Self <: NumberQuestion[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with NumberQuestion[T]) extends AnyVal {
    @scala.inline
