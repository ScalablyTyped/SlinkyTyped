...
object ListChoiceOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](): ListChoiceOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListChoiceOptions[T]]
  }
  @scala.inline
  implicit class ListChoiceOptionsOps[Self <: ListChoiceOptions[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with ListChoiceOptions[T]) extends AnyVal {
    @scala.inline
