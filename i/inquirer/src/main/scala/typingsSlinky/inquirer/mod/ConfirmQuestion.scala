...
object ConfirmQuestion {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](`type`: confirm): ConfirmQuestion[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ConfirmQuestion[T]]
  }
  @scala.inline
  implicit class ConfirmQuestionOps[Self <: ConfirmQuestion[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with ConfirmQuestion[T]) extends AnyVal {
    @scala.inline
