...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.inquirer.mod.EditorQuestion[T]
  - typingsSlinky.inquirer.mod.ExpandQuestion[T]
  - typingsSlinky.inquirer.mod.RawListQuestion[T]
  - typingsSlinky.inquirer.mod.NumberQuestion[T]
  - typingsSlinky.inquirer.mod.ConfirmQuestion[T]
  - typingsSlinky.inquirer.mod.ListQuestion[T]
  - typingsSlinky.inquirer.mod.CheckboxQuestion[T]
  - typingsSlinky.inquirer.mod.PasswordQuestion[T]
  - typingsSlinky.inquirer.mod.InputQuestion[T]
*/
