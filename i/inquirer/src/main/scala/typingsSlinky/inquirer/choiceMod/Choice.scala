...
- typingsSlinky.inquirer.mod.ExpandChoiceOptions because var conflicts: extra, name, short, `type`, value. Inlined key */ trait Choice[T /* <: Answers */] extends CheckboxChoiceOptions[T] {
  /**
    * @inheritdoc
    */
  @JSName("disabled")
...
object Choice {
  @scala.inline
  def apply[/* <: typingsSlinky.inquirer.mod.Answers */ T](disabled: Boolean, name: String, short: String): Choice[T] = {
  ...
  @scala.inline
  implicit class ChoiceOps[Self <: Choice[_], /* <: typingsSlinky.inquirer.mod.Answers */ T] (val x: Self with Choice[T]) extends AnyVal {
    @scala.inline
