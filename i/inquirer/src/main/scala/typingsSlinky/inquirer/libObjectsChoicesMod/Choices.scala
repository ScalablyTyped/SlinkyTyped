package typingsSlinky.inquirer.libObjectsChoicesMod
...
trait Choices[T /* <: Answers */] extends js.Object {
  ...
  /**
    ...
    */
  def filter[TElement /* <: typingsSlinky.inquirer.libObjectsChoiceMod.^[T] | typingsSlinky.inquirer.libObjectsSeparatorMod.^  */](
    callbackfn: js.Function3[
      /* value */ typingsSlinky.inquirer.libObjectsChoiceMod.^[T] | typingsSlinky.inquirer.libObjectsSeparatorMod.^ , 
      /* index */ Double, 
      /* array */ js.Array[
        typingsSlinky.inquirer.libObjectsChoiceMod.^[T] | typingsSlinky.inquirer.libObjectsSeparatorMod.^ 
      ], 
      /* is TElement */ Boolean
    ]
  ...
  ): typingsSlinky.inquirer.libObjectsChoiceMod.^[T] | typingsSlinky.inquirer.libObjectsSeparatorMod.^  = js.native
  def find(
    predicate: js.Function3[
      /* value */ typingsSlinky.inquirer.libObjectsChoiceMod.^[T] | typingsSlinky.inquirer.libObjectsSeparatorMod.^ , 
      /* index */ Double, 
  ...
  /**
    ...
    */
  def indexOf(searchElement: typingsSlinky.inquirer.libObjectsChoiceMod.^[T]): Double = js.native
  def indexOf(searchElement: typingsSlinky.inquirer.libObjectsChoiceMod.^[T], fromIndex: Double): Double = js.native
  def indexOf(searchElement: typingsSlinky.inquirer.libObjectsSeparatorMod.^): Double = js.native
  def indexOf(searchElement: typingsSlinky.inquirer.libObjectsSeparatorMod.^, fromIndex: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def push(
    items: (typingsSlinky.inquirer.libObjectsChoiceMod.^[T] | typingsSlinky.inquirer.libObjectsSeparatorMod.^ )*
  ): Double = js.native
  /**
