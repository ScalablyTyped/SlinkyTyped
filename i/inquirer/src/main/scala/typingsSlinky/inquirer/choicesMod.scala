...
import typingsSlinky.inquirer.anon.Type
...
object choicesMod {
  ...
  trait Choices[T /* <: Answers */] extends StObject {
    ...
    /**
      ...
      */
    def filter[TElement /* <: typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^ */](
      callbackfn: js.Function3[
          /* value */ typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^, 
          /* index */ Double, 
          /* array */ js.Array[typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^], 
          /* is TElement */ Boolean
        ]
    ...
    def find(
      predicate: js.Function3[
          /* value */ typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^, 
          /* index */ Double, 
          /* obj */ js.Array[typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^], 
          Boolean
        ]
    ): typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^ = js.native
    def find(
      predicate: js.Function3[
          /* value */ typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^, 
          /* index */ Double, 
    ...
    /**
      ...
      */
    def indexOf(searchElement: typingsSlinky.inquirer.choiceMod.^[T]): Double = js.native
    def indexOf(searchElement: typingsSlinky.inquirer.choiceMod.^[T], fromIndex: Double): Double = js.native
    def indexOf(searchElement: typingsSlinky.inquirer.separatorMod.^): Double = js.native
    def indexOf(searchElement: typingsSlinky.inquirer.separatorMod.^, fromIndex: Double): Double = js.native
    ...
    /**
      ...
      */
    def push(items: (typingsSlinky.inquirer.choiceMod.^[T] | typingsSlinky.inquirer.separatorMod.^)*): Double = js.native
