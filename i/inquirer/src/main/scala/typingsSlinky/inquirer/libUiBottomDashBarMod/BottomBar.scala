package typingsSlinky.inquirer.libUiBottomDashBarMod

import typingsSlinky.through.throughMod.ThroughStream
...
@js.native
trait BottomBar
  extends typingsSlinky.inquirer.libUiBaseUIMod.^ {
  /**
