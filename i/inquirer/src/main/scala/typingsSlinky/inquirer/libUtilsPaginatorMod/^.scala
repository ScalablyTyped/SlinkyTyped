package typingsSlinky.inquirer.libUtilsPaginatorMod
...
class ^ protected () extends Paginator {
  /**
    ...
    */
  def this(screenManager: typingsSlinky.inquirer.libUtilsScreenDashManagerMod.^) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var screen: typingsSlinky.inquirer.libUtilsScreenDashManagerMod.^ = js.native
  /**
