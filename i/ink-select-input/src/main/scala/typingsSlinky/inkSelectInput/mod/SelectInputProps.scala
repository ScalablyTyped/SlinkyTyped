...
object SelectInputProps {
  ...
  implicit class SelectInputPropsOps[Self <: SelectInputProps[_], T /* <: ItemOfSelectInput */] (val x: Self with SelectInputProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setIndicatorComponent(value: ReactComponentClass[js.Object]): Self = this.set("indicatorComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemComponent(value: ReactComponentClass[js.Object]): Self = this.set("itemComponent", value.asInstanceOf[js.Any])
