...
trait InkSelectInputProps extends js.Object {
  ...
  /**
  	 ...
  	 */
  var indicatorComponent: js.UndefOr[ReactComponentClass[IndicatorProps]] = js.native
  ...
  /**
  	 ...
  	 */
  var itemComponent: js.UndefOr[ReactComponentClass[ItemProps]] = js.native
...
object InkSelectInputProps {
  ...
  implicit class InkSelectInputPropsOps[Self <: InkSelectInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIndicatorComponentFunctionComponent(value: ReactComponentClass[IndicatorProps]): Self = this.set("indicatorComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIndicatorComponentComponentClass(value: ReactComponentClass[IndicatorProps]): Self = this.set("indicatorComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIndicatorComponent(value: ReactComponentClass[IndicatorProps]): Self = this.set("indicatorComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemComponentFunctionComponent(value: ReactComponentClass[ItemProps]): Self = this.set("itemComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemComponentComponentClass(value: ReactComponentClass[ItemProps]): Self = this.set("itemComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemComponent(value: ReactComponentClass[ItemProps]): Self = this.set("itemComponent", value.asInstanceOf[js.Any])
