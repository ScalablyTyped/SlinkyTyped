...
object ClusterOptions {
  ...
  implicit class ClusterOptionsMutableBuilder[Self <: ClusterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClusterRetryStrategy(value: (/* times */ Double, /* reason */ js.UndefOr[js.Error]) => Double | Null): Self = StObject.set(x, "clusterRetryStrategy", js.Any.fromFunction2(value))
