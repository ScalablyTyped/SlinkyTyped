...
import typingsSlinky.ioredis.ioredisNumbers.`0`
...
trait Cluster
  ...
  def expire(
    key: KeyType,
    seconds: Double,
    callback: js.Function2[/* err */ js.Error, /* res */ `0` | `1`, Unit]
  ): Unit = js.native
  ...
  def setnx(key: KeyType, value: js.Any, callback: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]): Unit = js.native
  ...
  def zrange(
    ...
    start: Double,
    stop: Double,
    callback: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]
  ): Unit = js.native
  @JSName("zrange")
