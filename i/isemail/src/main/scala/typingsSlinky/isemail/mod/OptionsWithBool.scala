...
import typingsSlinky.isemail.isemailBooleans.`false`
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined isemail.isemail.BaseOptions & {  errorLevel :false | undefined} */
@js.native
trait OptionsWithBool extends js.Object {
  
  var allowUnicode: js.UndefOr[Boolean] = js.native
  
  var errorLevel: js.UndefOr[`false`] = js.native
...
object OptionsWithBool {
  
  @scala.inline
  def apply(): OptionsWithBool = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OptionsWithBool]
  }
  
  @scala.inline
  implicit class OptionsWithBoolOps[Self <: OptionsWithBool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorLevel(value: `false`): Self = this.set("errorLevel", value.asInstanceOf[js.Any])
