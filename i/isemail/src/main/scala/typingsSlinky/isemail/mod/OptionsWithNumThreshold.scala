...
import typingsSlinky.isemail.isemailBooleans.`true`
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined isemail.isemail.BaseOptions & {  errorLevel :true | number | undefined} */
@js.native
trait OptionsWithNumThreshold extends js.Object {
  
  var allowUnicode: js.UndefOr[Boolean] = js.native
  
  var errorLevel: js.UndefOr[`true` | Double] = js.native
...
object OptionsWithNumThreshold {
  
  @scala.inline
  def apply(): OptionsWithNumThreshold = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OptionsWithNumThreshold]
  }
  
  @scala.inline
  implicit class OptionsWithNumThresholdOps[Self <: OptionsWithNumThreshold] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorLevel(value: `true` | Double): Self = this.set("errorLevel", value.asInstanceOf[js.Any])
