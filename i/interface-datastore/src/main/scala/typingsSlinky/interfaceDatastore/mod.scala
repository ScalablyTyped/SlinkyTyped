package typingsSlinky.interfaceDatastore

import org.scalajs.dom.experimental.AbortSignal
import typingsSlinky.interfaceDatastore.mod.Query.Filter
import typingsSlinky.interfaceDatastore.mod.Query.Order
...
object mod {
  ...
  abstract class Adapter[Value] () extends StObject {
    ...
    def deleteMany(source: js.Iterable[Key]): AsyncIterableIterator[Key] = js.native
    def deleteMany(source: js.Iterable[Key], options: Options): AsyncIterableIterator[Key] = js.native
    /**
    ...
    def getMany(source: js.Iterable[Key]): AsyncIterableIterator[Value] = js.native
    def getMany(source: js.Iterable[Key], options: Options): AsyncIterableIterator[Value] = js.native
    /**
    ...
    def putMany(source: js.Iterable[Pair[Value]]): AsyncIterableIterator[Pair[Value]] = js.native
    def putMany(source: js.Iterable[Pair[Value]], options: Options): AsyncIterableIterator[Pair[Value]] = js.native
    /**
