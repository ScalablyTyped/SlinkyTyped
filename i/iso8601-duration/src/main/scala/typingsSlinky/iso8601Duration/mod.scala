package typingsSlinky.iso8601Duration
...
object mod {
  ...
  object default {
    ...
    @js.native
    def end: js.Function2[/* duration */ Duration, /* startDate */ js.UndefOr[js.Date], js.Date] = js.native
    @JSImport("iso8601-duration", "default.end")
    @js.native
    ...
    @scala.inline
    def end_=(x: js.Function2[/* duration */ Duration, /* startDate */ js.UndefOr[js.Date], js.Date]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("end")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def pattern_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("pattern")(x.asInstanceOf[js.Any])
    
    @JSImport("iso8601-duration", "default.toSeconds")
    @js.native
    def toSeconds: js.Function2[/* duration */ Duration, /* startDate */ js.UndefOr[js.Date], Double] = js.native
    @JSImport("iso8601-duration", "default.toSeconds")
    @js.native
    ...
    @scala.inline
    def toSeconds_=(x: js.Function2[/* duration */ Duration, /* startDate */ js.UndefOr[js.Date], Double]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("toSeconds")(x.asInstanceOf[js.Any])
  }
