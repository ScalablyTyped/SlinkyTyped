...
trait TypeofbabelTypes extends js.Object {
  ...
  def TSCallSignatureDeclaration(typeParameters: js.UndefOr[scala.Nothing], parameters: js.Array[Identifier_ | RestElement_]): typingsSlinky.babelTypes.mod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(
    typeParameters: js.UndefOr[scala.Nothing],
  ...
  def TSConstructorType(typeParameters: js.UndefOr[scala.Nothing], typeAnnotation: TSTypeAnnotation): typingsSlinky.babelTypes.mod.TSConstructorType = js.native
  ...
  def TSDeclareMethod(decorators: Null, key: Expression, typeParameters: Null, params: js.Array[LVal], returnType: Noop_): typingsSlinky.babelTypes.mod.TSDeclareMethod = js.native
  def TSDeclareMethod(
    decorators: Null,
    key: Expression,
    typeParameters: Null,
  ...
  def TSFunctionType(typeParameters: js.UndefOr[scala.Nothing], typeAnnotation: TSTypeAnnotation): typingsSlinky.babelTypes.mod.TSFunctionType = js.native
  ...
  def TSPropertySignature(key: Expression, typeAnnotation: js.UndefOr[scala.Nothing], initializer: Expression): typingsSlinky.babelTypes.mod.TSPropertySignature = js.native
  ...
  def TSTypeParameter(constraint: js.UndefOr[scala.Nothing], default_ : TSType): typingsSlinky.babelTypes.mod.TSTypeParameter = js.native
