package typingsSlinky.instagramDashPrivateDashApi.distResponsesMediaDotUpdatedDashMediaDotResponseMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait MediaUpdatedMediaResponsePoll_sticker extends js.Object {
...
object MediaUpdatedMediaResponsePoll_sticker {
  @scala.inline
  def apply(
    finished: Boolean,
    id: String,
    ...
    viewer_vote: Double
  ): MediaUpdatedMediaResponsePoll_sticker = {
    ...
    __obj.asInstanceOf[MediaUpdatedMediaResponsePoll_sticker]
  }
}
