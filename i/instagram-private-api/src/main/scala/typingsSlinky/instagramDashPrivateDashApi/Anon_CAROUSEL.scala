...
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.CAROUSEL
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.PHOTO
