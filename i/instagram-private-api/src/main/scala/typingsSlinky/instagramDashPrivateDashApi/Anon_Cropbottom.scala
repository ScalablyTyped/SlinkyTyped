...
trait Anon_Cropbottom extends js.Object {
...
object Anon_Cropbottom {
  @scala.inline
  def apply(crop_bottom: Double, crop_left: Double, crop_right: Double, crop_top: Double): Anon_Cropbottom = {
    ...
    __obj.asInstanceOf[Anon_Cropbottom]
  }
}
