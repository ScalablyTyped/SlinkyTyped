...
trait IgtvChannelFeedResponseFriendship_status extends js.Object {
...
object IgtvChannelFeedResponseFriendship_status {
  @scala.inline
  def apply(
    following: Boolean,
    is_bestie: Boolean,
    ...
    __obj.asInstanceOf[IgtvChannelFeedResponseFriendship_status]
  }
}
