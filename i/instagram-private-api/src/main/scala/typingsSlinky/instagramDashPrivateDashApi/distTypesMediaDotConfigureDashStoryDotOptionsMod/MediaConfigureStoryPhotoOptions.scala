...
import typingsSlinky.instagramDashPrivateDashApi.Anon_CropcenterCroporiginalsize
import typingsSlinky.instagramDashPrivateDashApi.Anon_Sourceheight
import typingsSlinky.instagramDashPrivateDashApi.distTypesMediaDotConfigureDotOptionsMod.MediaConfigureOptions
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.NOT_PROMPTED
...
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.besties
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.chat_sticker_id
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.countdown_sticker_time
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.once
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.polling_sticker
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.question_sticker_ma
...
- typings.instagramDashPrivateDashApi.distTypesMediaDotConfigureDashStoryDotOptionsMod.MediaConfigureStoryBaseOptions because var conflicts: geotag_enabled, media_latitude, media_longitude, posting_latitude, posting_longitude. Inlined story_media_creation_date, client_shared_at, audience, configure_mode, camera_position, allow_multi_configures, thread_ids, recipient_users, client_context, view_mode, reply_type, caption, mas_opt_in, story_sticker_ids, story_hashtags, story_locations, reel_mentions, story_polls, internal_features, story_sliders, story_questions, story_countdowns, attached_media, story_chats, story_quizs, story_cta */ trait MediaConfigureStoryPhotoOptions extends MediaConfigureOptions {
