package typingsSlinky.instagramDashPrivateDashApi.distResponsesDirectDashInboxDotFeedDotResponseMod
...
class DirectInboxFeedResponseThreadsItem () extends js.Object {
  ...
  var inviter: DirectInboxFeedResponseInviter = js.native
  var is_group: Boolean = js.native
  var is_pin: Boolean = js.native
  var is_spam: Boolean = js.native
  var items: js.Array[DirectInboxFeedResponseItemsItem] = js.native
  var last_activity_at: String = js.native
  var last_permanent_item: DirectInboxFeedResponseLastPermanentItem = js.native
  ...
  var users: js.Array[DirectInboxFeedResponseUsersItem] = js.native
