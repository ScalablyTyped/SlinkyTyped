...
trait ListReelMediaViewerFeedResponseCharity extends js.Object {
...
object ListReelMediaViewerFeedResponseCharity {
  @scala.inline
  def apply(
    full_name: String,
    is_private: Boolean,
    ...
    __obj.asInstanceOf[ListReelMediaViewerFeedResponseCharity]
  }
}
