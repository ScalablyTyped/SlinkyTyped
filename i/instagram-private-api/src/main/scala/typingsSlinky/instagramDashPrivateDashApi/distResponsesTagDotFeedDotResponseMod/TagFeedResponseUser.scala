package typingsSlinky.instagramDashPrivateDashApi.distResponsesTagDotFeedDotResponseMod
...
trait TagFeedResponseUser extends js.Object {
  var friendship_status: js.UndefOr[TagFeedResponseFriendship_status] = js.undefined
...
object TagFeedResponseUser {
  ...
  def apply(
    ...
    username: String,
    friendship_status: TagFeedResponseFriendship_status = null,
