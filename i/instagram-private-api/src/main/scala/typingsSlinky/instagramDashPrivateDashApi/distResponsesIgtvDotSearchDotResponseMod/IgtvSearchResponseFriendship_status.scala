...
trait IgtvSearchResponseFriendship_status extends js.Object {
...
object IgtvSearchResponseFriendship_status {
  @scala.inline
  def apply(
    following: Boolean,
  ...
  ): IgtvSearchResponseFriendship_status = {
    ...
    __obj.asInstanceOf[IgtvSearchResponseFriendship_status]
  }
}
