package typingsSlinky.instagramDashPrivateDashApi.distTypesPostingDotIgtvDotOptionsMod

import typingsSlinky.instagramDashPrivateDashApi.Anon_Bottom
import typingsSlinky.instagramDashPrivateDashApi.PartialMediaConfigureToIgtvOptions
import typingsSlinky.instagramDashPrivateDashApi.PartialUploadVideoOptions
...
trait PostingIgtvOptions extends js.Object {
  ...
  var feedPreviewCrop: js.UndefOr[Anon_Bottom] = js.undefined
...
object PostingIgtvOptions {
  ...
  def apply(
    ...
    feedPreviewCrop: Anon_Bottom = null,
