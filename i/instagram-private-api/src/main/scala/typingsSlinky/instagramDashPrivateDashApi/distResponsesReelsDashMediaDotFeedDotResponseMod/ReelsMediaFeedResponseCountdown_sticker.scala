...
trait ReelsMediaFeedResponseCountdown_sticker extends js.Object {
...
object ReelsMediaFeedResponseCountdown_sticker {
  @scala.inline
  def apply(
    attribution: Null,
    countdown_id: Double,
    ...
    __obj.asInstanceOf[ReelsMediaFeedResponseCountdown_sticker]
  }
}
