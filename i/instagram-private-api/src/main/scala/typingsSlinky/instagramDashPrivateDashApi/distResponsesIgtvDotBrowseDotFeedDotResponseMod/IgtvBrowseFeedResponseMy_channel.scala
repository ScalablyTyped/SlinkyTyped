...
trait IgtvBrowseFeedResponseMy_channel extends js.Object {
  ...
  var title: String
  var `type`: String
  var user_dict: IgtvBrowseFeedResponseUser_dict
}

object IgtvBrowseFeedResponseMy_channel {
  @scala.inline
  def apply(
  ...
  ): IgtvBrowseFeedResponseMy_channel = {
    ...
    __obj.asInstanceOf[IgtvBrowseFeedResponseMy_channel]
  }
}
