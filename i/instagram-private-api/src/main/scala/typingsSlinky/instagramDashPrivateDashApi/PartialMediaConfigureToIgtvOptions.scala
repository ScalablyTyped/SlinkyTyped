...
import typingsSlinky.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.`4`
...
trait PartialMediaConfigureToIgtvOptions extends js.Object {
...
object PartialMediaConfigureToIgtvOptions {
  @scala.inline
  def apply(
  ...
  ): PartialMediaConfigureToIgtvOptions = {
    ...
    __obj.asInstanceOf[PartialMediaConfigureToIgtvOptions]
  }
}
