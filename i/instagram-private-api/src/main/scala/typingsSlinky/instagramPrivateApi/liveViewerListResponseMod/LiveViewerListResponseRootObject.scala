...
object LiveViewerListResponseRootObject {
  ...
  implicit class LiveViewerListResponseRootObjectOps[Self <: LiveViewerListResponseRootObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUsersVarargs(value: LiveViewerListResponseUsersItem*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[LiveViewerListResponseUsersItem]): Self = this.set("users", value.asInstanceOf[js.Any])
  }
}
