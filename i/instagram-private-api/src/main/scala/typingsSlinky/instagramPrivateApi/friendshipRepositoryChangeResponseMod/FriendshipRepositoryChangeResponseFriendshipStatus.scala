...
object FriendshipRepositoryChangeResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class FriendshipRepositoryChangeResponseFriendshipStatusOps[Self <: FriendshipRepositoryChangeResponseFriendshipStatus] (val x: Self) extends AnyVal {
