...
object DirectThreadRepositoryUpdateTitleResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryUpdateTitleResponseFriendshipStatusOps[Self <: DirectThreadRepositoryUpdateTitleResponseFriendshipStatus] (val x: Self) extends AnyVal {
