...
object DirectThreadRepositoryUpdateTitleResponseThread {
  ...
  implicit class DirectThreadRepositoryUpdateTitleResponseThreadOps[Self <: DirectThreadRepositoryUpdateTitleResponseThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInviter(value: DirectThreadRepositoryUpdateTitleResponseInviter): Self = this.set("inviter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: DirectThreadRepositoryUpdateTitleResponseItemsItem*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[DirectThreadRepositoryUpdateTitleResponseItemsItem]): Self = this.set("items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLast_activity_at(value: String): Self = this.set("last_activity_at", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLast_permanent_item(value: DirectThreadRepositoryUpdateTitleResponseLastPermanentItem): Self = this.set("last_permanent_item", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUsersVarargs(value: DirectThreadRepositoryUpdateTitleResponseUsersItem*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[DirectThreadRepositoryUpdateTitleResponseUsersItem]): Self = this.set("users", value.asInstanceOf[js.Any])
