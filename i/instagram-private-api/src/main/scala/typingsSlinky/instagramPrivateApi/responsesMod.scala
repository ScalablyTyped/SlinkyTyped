...
object responsesMod extends js.Object {
  ...
  class BlockedUsersFeedResponseBlockedListItem ()
    extends typingsSlinky.instagramPrivateApi.blockedUsersFeedResponseMod.BlockedUsersFeedResponseBlockedListItem
  
  @js.native
  class DirectInboxFeedResponseThreadsItem ()
    extends typingsSlinky.instagramPrivateApi.directInboxFeedResponseMod.DirectInboxFeedResponseThreadsItem
  
  @js.native
  class DiscoverFeedResponseUser ()
    extends typingsSlinky.instagramPrivateApi.discoverFeedResponseMod.DiscoverFeedResponseUser
  
  @js.native
  class NewsFeedResponseStoriesItem ()
    extends typingsSlinky.instagramPrivateApi.newsFeedResponseMod.NewsFeedResponseStoriesItem
