...
object TagsFeedResponseLayoutContent {
  ...
  implicit class TagsFeedResponseLayoutContentOps[Self <: TagsFeedResponseLayoutContent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMediasVarargs(value: TagsFeedResponseMediasItem*): Self = this.set("medias", js.Array(value :_*))
    
    @scala.inline
    def setMedias(value: js.Array[TagsFeedResponseMediasItem]): Self = this.set("medias", value.asInstanceOf[js.Any])
  }
}
