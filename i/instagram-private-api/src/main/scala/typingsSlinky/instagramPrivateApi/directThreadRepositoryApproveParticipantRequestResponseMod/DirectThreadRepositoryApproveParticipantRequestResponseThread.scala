...
object DirectThreadRepositoryApproveParticipantRequestResponseThread {
  ...
  implicit class DirectThreadRepositoryApproveParticipantRequestResponseThreadOps[Self <: DirectThreadRepositoryApproveParticipantRequestResponseThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInviter(value: DirectThreadRepositoryApproveParticipantRequestResponseInviter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItems(value: js.Array[DirectThreadRepositoryApproveParticipantRequestResponseItemsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast_permanent_item(value: DirectThreadRepositoryApproveParticipantRequestResponseLastPermanentItem): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("last_permanent_item")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLast_seen_at(value: DirectThreadRepositoryApproveParticipantRequestResponseLastSeenAt): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUsers(value: js.Array[DirectThreadRepositoryApproveParticipantRequestResponseUsersItem]): Self = {
        val ret = this.duplicate
