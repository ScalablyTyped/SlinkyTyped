...
@js.native
trait DirectThreadRepositoryApproveParticipantRequestResponseUsersItem extends js.Object {
...
object DirectThreadRepositoryApproveParticipantRequestResponseUsersItem {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryApproveParticipantRequestResponseUsersItemOps[Self <: DirectThreadRepositoryApproveParticipantRequestResponseUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withFriendship_status(value: DirectThreadRepositoryApproveParticipantRequestResponseFriendshipStatus): Self = {
    ...
    @scala.inline
    def withIs_directapp_installed(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_directapp_installed")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIs_using_unified_inbox_for_direct(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_using_unified_inbox_for_direct")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
