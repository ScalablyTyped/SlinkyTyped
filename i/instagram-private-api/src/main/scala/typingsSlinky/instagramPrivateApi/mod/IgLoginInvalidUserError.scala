...
@JSImport("instagram-private-api", "IgLoginInvalidUserError")
@js.native
class IgLoginInvalidUserError ()
  extends typingsSlinky.instagramPrivateApi.igResponseErrorMod.IgResponseError[AccountRepositoryLoginErrorResponse]
