...
object ListReelMediaViewerFeedResponseUsersItem {
  ...
  @scala.inline
  implicit class ListReelMediaViewerFeedResponseUsersItemMutableBuilder[Self <: ListReelMediaViewerFeedResponseUsersItem] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFriendship_status(value: ListReelMediaViewerFeedResponseFriendshipStatus): Self = StObject.set(x, "friendship_status", value.asInstanceOf[js.Any])
