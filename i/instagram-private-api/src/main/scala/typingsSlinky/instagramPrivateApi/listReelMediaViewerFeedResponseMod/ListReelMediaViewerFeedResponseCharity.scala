...
@js.native
trait ListReelMediaViewerFeedResponseCharity extends StObject {
...
object ListReelMediaViewerFeedResponseCharity {
  ...
  @scala.inline
  implicit class ListReelMediaViewerFeedResponseCharityMutableBuilder[Self <: ListReelMediaViewerFeedResponseCharity] (val x: Self) extends AnyVal {
