...
object ListReelMediaViewerFeedResponseStoryHashtagsItem {
  ...
  @scala.inline
  implicit class ListReelMediaViewerFeedResponseStoryHashtagsItemOps[Self <: ListReelMediaViewerFeedResponseStoryHashtagsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHashtag(value: ListReelMediaViewerFeedResponseHashtag): Self = this.set("hashtag", value.asInstanceOf[js.Any])
