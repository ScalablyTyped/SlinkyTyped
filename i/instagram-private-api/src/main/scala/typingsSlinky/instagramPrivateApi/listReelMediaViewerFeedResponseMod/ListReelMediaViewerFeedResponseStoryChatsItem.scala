...
trait ListReelMediaViewerFeedResponseStoryChatsItem extends js.Object {
  var chat_sticker: ListReelMediaViewerFeedResponseChatSticker = js.native
...
object ListReelMediaViewerFeedResponseStoryChatsItem {
  ...
  @scala.inline
  implicit class ListReelMediaViewerFeedResponseStoryChatsItemOps[Self <: ListReelMediaViewerFeedResponseStoryChatsItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withChat_sticker(value: ListReelMediaViewerFeedResponseChatSticker): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("chat_sticker")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
