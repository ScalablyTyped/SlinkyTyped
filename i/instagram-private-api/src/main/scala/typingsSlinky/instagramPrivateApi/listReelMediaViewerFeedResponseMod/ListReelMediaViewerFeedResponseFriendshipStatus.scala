...
@js.native
trait ListReelMediaViewerFeedResponseFriendshipStatus extends js.Object {
...
object ListReelMediaViewerFeedResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class ListReelMediaViewerFeedResponseFriendshipStatusOps[Self <: ListReelMediaViewerFeedResponseFriendshipStatus] (val x: Self) extends AnyVal {
    @scala.inline
