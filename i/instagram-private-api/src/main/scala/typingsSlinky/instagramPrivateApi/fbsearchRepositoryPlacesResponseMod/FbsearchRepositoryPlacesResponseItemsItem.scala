...
object FbsearchRepositoryPlacesResponseItemsItem {
  ...
  implicit class FbsearchRepositoryPlacesResponseItemsItemOps[Self <: FbsearchRepositoryPlacesResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeader_media(value: FbsearchRepositoryPlacesResponseHeaderMedia): Self = this.set("header_media", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLocation(value: FbsearchRepositoryPlacesResponseLocation): Self = this.set("location", value.asInstanceOf[js.Any])
