...
object LikedFeedResponseImageVersions2 {
  ...
  implicit class LikedFeedResponseImageVersions2Ops[Self <: LikedFeedResponseImageVersions2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCandidatesVarargs(value: LikedFeedResponseCandidatesItem*): Self = this.set("candidates", js.Array(value :_*))
    
    @scala.inline
    def setCandidates(value: js.Array[LikedFeedResponseCandidatesItem]): Self = this.set("candidates", value.asInstanceOf[js.Any])
  }
}
