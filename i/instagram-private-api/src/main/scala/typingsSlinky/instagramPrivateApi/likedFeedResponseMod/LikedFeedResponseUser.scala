...
object LikedFeedResponseUser {
  ...
  def apply(
    ...
    if (!js.isUndefined(can_see_primary_country_in_settings)) __obj.updateDynamic("can_see_primary_country_in_settings")(can_see_primary_country_in_settings.get.asInstanceOf[js.Any])
