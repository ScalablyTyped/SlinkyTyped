...
object PartialAttachmentSticker {
  ...
  def apply(
    ...
    bottom: () => PartialAttachmentSticker = null,
    center: () => PartialAttachmentSticker = null,
    height: Int | Double = null,
    id: () => String = null,
    isSticker: js.UndefOr[Boolean] = js.undefined,
    key: () => String = null,
    left: () => PartialAttachmentSticker = null,
    mediaId: String = null,
    mediaOwnerId: String = null,
    moveBackwards: /* layers */ js.UndefOr[Double] => PartialAttachmentSticker = null,
    moveForward: /* layers */ js.UndefOr[Double] => PartialAttachmentSticker = null,
    right: () => PartialAttachmentSticker = null,
    rotateDeg: /* deg */ Double => PartialAttachmentSticker = null,
    rotation: Int | Double = null,
    scale: /* factor */ Double => PartialAttachmentSticker = null,
    toJSON: () => _ = null,
    top: () => PartialAttachmentSticker = null,
