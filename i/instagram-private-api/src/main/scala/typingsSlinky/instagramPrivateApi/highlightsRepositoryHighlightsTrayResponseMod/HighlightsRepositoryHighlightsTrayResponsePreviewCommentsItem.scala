...
@js.native
trait HighlightsRepositoryHighlightsTrayResponsePreviewCommentsItem extends js.Object {
...
object HighlightsRepositoryHighlightsTrayResponsePreviewCommentsItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponsePreviewCommentsItemOps[Self <: HighlightsRepositoryHighlightsTrayResponsePreviewCommentsItem] (val x: Self) extends AnyVal {
    @scala.inline
