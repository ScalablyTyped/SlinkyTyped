...
object HighlightsRepositoryHighlightsTrayResponseCandidatesItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseCandidatesItemMutableBuilder[Self <: HighlightsRepositoryHighlightsTrayResponseCandidatesItem] (val x: Self) extends AnyVal {
