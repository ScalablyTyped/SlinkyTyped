...
object HighlightsRepositoryHighlightsTrayResponseCandidatesItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseCandidatesItemOps[Self <: HighlightsRepositoryHighlightsTrayResponseCandidatesItem] (val x: Self) extends AnyVal {
    @scala.inline
