...
object HighlightsRepositoryHighlightsTrayResponseItemsItem {
  ...
  implicit class HighlightsRepositoryHighlightsTrayResponseItemsItemOps[Self <: HighlightsRepositoryHighlightsTrayResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCaption(value: HighlightsRepositoryHighlightsTrayResponseCaption): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImage_versions2(value: HighlightsRepositoryHighlightsTrayResponseImageVersions2): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMedia_cropping_info(value: HighlightsRepositoryHighlightsTrayResponseMediaCroppingInfo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreview_comments(value: js.Array[HighlightsRepositoryHighlightsTrayResponsePreviewCommentsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withThumbnails(value: HighlightsRepositoryHighlightsTrayResponseThumbnails): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVideo_versions(value: js.Array[HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem]): Self = {
        val ret = this.duplicate
