...
object HighlightsRepositoryHighlightsTrayResponseItemsItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseItemsItemOps[Self <: HighlightsRepositoryHighlightsTrayResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCaption(value: HighlightsRepositoryHighlightsTrayResponseCaption): Self = this.set("caption", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setImage_versions2(value: HighlightsRepositoryHighlightsTrayResponseImageVersions2): Self = this.set("image_versions2", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMedia_cropping_info(value: HighlightsRepositoryHighlightsTrayResponseMediaCroppingInfo): Self = this.set("media_cropping_info", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPreview_commentsVarargs(value: HighlightsRepositoryHighlightsTrayResponsePreviewCommentsItem*): Self = this.set("preview_comments", js.Array(value :_*))
    
    @scala.inline
    def setPreview_comments(value: js.Array[HighlightsRepositoryHighlightsTrayResponsePreviewCommentsItem]): Self = this.set("preview_comments", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setThumbnails(value: HighlightsRepositoryHighlightsTrayResponseThumbnails): Self = this.set("thumbnails", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVideo_versionsVarargs(value: HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem*): Self = this.set("video_versions", js.Array(value :_*))
    
    @scala.inline
    def setVideo_versions(value: js.Array[HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem]): Self = this.set("video_versions", value.asInstanceOf[js.Any])
