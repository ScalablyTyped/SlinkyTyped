...
@js.native
trait HighlightsRepositoryHighlightsTrayResponseUserDict extends StObject {
...
object HighlightsRepositoryHighlightsTrayResponseUserDict {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseUserDictMutableBuilder[Self <: HighlightsRepositoryHighlightsTrayResponseUserDict] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBiography(value: String): Self = StObject.set(x, "biography", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBiography_with_entities(value: HighlightsRepositoryHighlightsTrayResponseBiographyWithEntities): Self = StObject.set(x, "biography_with_entities", value.asInstanceOf[js.Any])
