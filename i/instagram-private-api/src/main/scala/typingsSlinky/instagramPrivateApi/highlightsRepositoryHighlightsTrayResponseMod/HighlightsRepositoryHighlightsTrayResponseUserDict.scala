...
trait HighlightsRepositoryHighlightsTrayResponseUserDict extends js.Object {
  ...
  var biography_with_entities: HighlightsRepositoryHighlightsTrayResponseBiographyWithEntities
  var external_lynx_url: String
  var external_url: String
  var follower_count: Double
  var following_count: Double
  var following_tag_count: Double
  var friendship_status: HighlightsRepositoryHighlightsTrayResponseFriendshipStatus
