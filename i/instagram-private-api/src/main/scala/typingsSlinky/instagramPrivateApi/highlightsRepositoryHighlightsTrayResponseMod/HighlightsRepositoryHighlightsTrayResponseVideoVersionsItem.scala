...
@js.native
trait HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem extends StObject {
...
object HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseVideoVersionsItemMutableBuilder[Self <: HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem] (val x: Self) extends AnyVal {
