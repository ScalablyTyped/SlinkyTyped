...
object HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseVideoVersionsItemOps[Self <: HighlightsRepositoryHighlightsTrayResponseVideoVersionsItem] (val x: Self) extends AnyVal {
