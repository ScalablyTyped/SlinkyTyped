...
@js.native
trait StorySliderVotersFeedResponseResponseUser extends js.Object {
...
object StorySliderVotersFeedResponseResponseUser {
  ...
  @scala.inline
  implicit class StorySliderVotersFeedResponseResponseUserOps[Self <: StorySliderVotersFeedResponseResponseUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: StorySliderVotersFeedResponseResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
