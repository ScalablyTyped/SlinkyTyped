...
object StorySliderVotersFeedResponseResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class StorySliderVotersFeedResponseResponseFriendshipStatusOps[Self <: StorySliderVotersFeedResponseResponseFriendshipStatus] (val x: Self) extends AnyVal {
