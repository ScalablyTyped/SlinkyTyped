...
object ReelsMediaFeedResponseStoryCountdownsItem {
  ...
  implicit class ReelsMediaFeedResponseStoryCountdownsItemOps[Self <: ReelsMediaFeedResponseStoryCountdownsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCountdown_sticker(value: ReelsMediaFeedResponseCountdownSticker): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("countdown_sticker")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
