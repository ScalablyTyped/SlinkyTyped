...
object ReelsMediaFeedResponseStoryPollsItem {
  ...
  @scala.inline
  implicit class ReelsMediaFeedResponseStoryPollsItemOps[Self <: ReelsMediaFeedResponseStoryPollsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPoll_sticker(value: ReelsMediaFeedResponsePollSticker): Self = this.set("poll_sticker", value.asInstanceOf[js.Any])
