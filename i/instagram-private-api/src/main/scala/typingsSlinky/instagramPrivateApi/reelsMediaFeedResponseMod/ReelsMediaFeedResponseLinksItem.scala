...
object ReelsMediaFeedResponseLinksItem {
  ...
  implicit class ReelsMediaFeedResponseLinksItemOps[Self <: ReelsMediaFeedResponseLinksItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgUserId(value: String): Self = this.set("igUserId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLeadGenFormId(value: String): Self = this.set("leadGenFormId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLinkType(value: Double): Self = this.set("linkType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRedirectUri(value: Null): Self = this.set("redirectUri", value.asInstanceOf[js.Any])
