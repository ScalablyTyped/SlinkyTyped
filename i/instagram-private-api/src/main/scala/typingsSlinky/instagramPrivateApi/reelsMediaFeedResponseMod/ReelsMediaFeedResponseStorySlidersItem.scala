...
object ReelsMediaFeedResponseStorySlidersItem {
  ...
  implicit class ReelsMediaFeedResponseStorySlidersItemOps[Self <: ReelsMediaFeedResponseStorySlidersItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSlider_sticker(value: ReelsMediaFeedResponseSliderSticker): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("slider_sticker")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
