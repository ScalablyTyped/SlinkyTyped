...
@js.native
trait ReelsTrayFeedResponseVideoVersionsItem extends StObject {
...
object ReelsTrayFeedResponseVideoVersionsItem {
  ...
  @scala.inline
  implicit class ReelsTrayFeedResponseVideoVersionsItemMutableBuilder[Self <: ReelsTrayFeedResponseVideoVersionsItem] (val x: Self) extends AnyVal {
