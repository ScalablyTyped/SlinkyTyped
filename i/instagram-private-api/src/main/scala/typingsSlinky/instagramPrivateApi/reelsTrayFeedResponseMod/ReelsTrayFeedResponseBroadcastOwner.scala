...
object ReelsTrayFeedResponseBroadcastOwner {
  ...
  implicit class ReelsTrayFeedResponseBroadcastOwnerOps[Self <: ReelsTrayFeedResponseBroadcastOwner] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFriendship_status(value: ReelsTrayFeedResponseFriendshipStatus): Self = {
    ...
    @scala.inline
    def withLive_subscription_status(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("live_subscription_status")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
