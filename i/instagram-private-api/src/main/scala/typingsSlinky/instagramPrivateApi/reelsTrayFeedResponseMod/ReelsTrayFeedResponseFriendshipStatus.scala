...
object ReelsTrayFeedResponseFriendshipStatus {
  ...
  implicit class ReelsTrayFeedResponseFriendshipStatusOps[Self <: ReelsTrayFeedResponseFriendshipStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutIs_bestie: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_bestie")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withoutIs_restricted: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_restricted")(js.undefined)
        ret
    }
  }
