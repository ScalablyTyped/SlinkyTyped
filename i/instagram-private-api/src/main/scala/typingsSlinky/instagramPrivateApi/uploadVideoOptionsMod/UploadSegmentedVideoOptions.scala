...
object UploadSegmentedVideoOptions {
  ...
  implicit class UploadSegmentedVideoOptionsOps[Self <: UploadSegmentedVideoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSegmentDivider(value: /* options */ typingsSlinky.instagramPrivateApi.anon.Buffer => js.Array[Buffer]): Self = this.set("segmentDivider", js.Any.fromFunction1(value))
