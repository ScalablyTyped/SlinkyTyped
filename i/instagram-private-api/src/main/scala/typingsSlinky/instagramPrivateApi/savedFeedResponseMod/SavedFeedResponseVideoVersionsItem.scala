...
@js.native
trait SavedFeedResponseVideoVersionsItem extends StObject {
...
object SavedFeedResponseVideoVersionsItem {
  ...
  @scala.inline
  implicit class SavedFeedResponseVideoVersionsItemMutableBuilder[Self <: SavedFeedResponseVideoVersionsItem] (val x: Self) extends AnyVal {
