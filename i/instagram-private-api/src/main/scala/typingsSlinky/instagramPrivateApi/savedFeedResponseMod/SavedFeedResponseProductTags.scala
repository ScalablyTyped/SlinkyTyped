...
@js.native
trait SavedFeedResponseProductTags extends js.Object {
...
object SavedFeedResponseProductTags {
  ...
  @scala.inline
  implicit class SavedFeedResponseProductTagsOps[Self <: SavedFeedResponseProductTags] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withIn(value: js.Array[SavedFeedResponseInItem]): Self = {
