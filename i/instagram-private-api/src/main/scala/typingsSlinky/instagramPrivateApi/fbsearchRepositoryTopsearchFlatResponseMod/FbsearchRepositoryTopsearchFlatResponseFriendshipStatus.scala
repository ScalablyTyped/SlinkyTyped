...
object FbsearchRepositoryTopsearchFlatResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class FbsearchRepositoryTopsearchFlatResponseFriendshipStatusOps[Self <: FbsearchRepositoryTopsearchFlatResponseFriendshipStatus] (val x: Self) extends AnyVal {
