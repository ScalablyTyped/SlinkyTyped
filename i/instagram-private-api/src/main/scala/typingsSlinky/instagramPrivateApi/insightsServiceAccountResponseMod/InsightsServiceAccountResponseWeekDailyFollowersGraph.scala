...
@js.native
trait InsightsServiceAccountResponseWeekDailyFollowersGraph extends js.Object {
...
object InsightsServiceAccountResponseWeekDailyFollowersGraph {
  ...
  @scala.inline
  implicit class InsightsServiceAccountResponseWeekDailyFollowersGraphOps[Self <: InsightsServiceAccountResponseWeekDailyFollowersGraph] (val x: Self) extends AnyVal {
