...
object DirectRepositoryCreateGroupThreadResponseUsersItem {
  ...
  @scala.inline
  implicit class DirectRepositoryCreateGroupThreadResponseUsersItemOps[Self <: DirectRepositoryCreateGroupThreadResponseUsersItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: DirectRepositoryCreateGroupThreadResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
