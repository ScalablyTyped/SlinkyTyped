...
object DirectRepositoryCreateGroupThreadResponseRootObject {
  ...
  implicit class DirectRepositoryCreateGroupThreadResponseRootObjectOps[Self <: DirectRepositoryCreateGroupThreadResponseRootObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInviter(value: DirectRepositoryCreateGroupThreadResponseInviter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast_activity_at(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPending_score(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUsers(value: js.Array[DirectRepositoryCreateGroupThreadResponseUsersItem]): Self = {
        val ret = this.duplicate
