...
@js.native
trait TagFeedResponseCandidatesItem extends StObject {
...
object TagFeedResponseCandidatesItem {
  ...
  @scala.inline
  implicit class TagFeedResponseCandidatesItemMutableBuilder[Self <: TagFeedResponseCandidatesItem] (val x: Self) extends AnyVal {
