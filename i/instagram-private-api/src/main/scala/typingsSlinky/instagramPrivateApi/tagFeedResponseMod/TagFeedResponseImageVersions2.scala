...
object TagFeedResponseImageVersions2 {
  ...
  implicit class TagFeedResponseImageVersions2Ops[Self <: TagFeedResponseImageVersions2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCandidatesVarargs(value: TagFeedResponseCandidatesItem*): Self = this.set("candidates", js.Array(value :_*))
    
    @scala.inline
    def setCandidates(value: js.Array[TagFeedResponseCandidatesItem]): Self = this.set("candidates", value.asInstanceOf[js.Any])
  }
}
