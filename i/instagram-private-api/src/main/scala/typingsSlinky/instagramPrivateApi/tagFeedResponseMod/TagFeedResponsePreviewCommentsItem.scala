...
@js.native
trait TagFeedResponsePreviewCommentsItem extends StObject {
...
object TagFeedResponsePreviewCommentsItem {
  ...
  @scala.inline
  implicit class TagFeedResponsePreviewCommentsItemMutableBuilder[Self <: TagFeedResponsePreviewCommentsItem] (val x: Self) extends AnyVal {
