...
object TagFeedResponseLocation {
  ...
  @scala.inline
  implicit class TagFeedResponseLocationOps[Self <: TagFeedResponseLocation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFacebook_places_id(value: String | Double): Self = this.set("facebook_places_id", value.asInstanceOf[js.Any])
