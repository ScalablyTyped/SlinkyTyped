...
object IgtvChannelFeedResponseRootObject {
  ...
  @scala.inline
  implicit class IgtvChannelFeedResponseRootObjectOps[Self <: IgtvChannelFeedResponseRootObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: IgtvChannelFeedResponseItemsItem*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[IgtvChannelFeedResponseItemsItem]): Self = this.set("items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSeen_state(value: IgtvChannelFeedResponseSeenState): Self = this.set("seen_state", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUser_dict(value: IgtvChannelFeedResponseUserDict): Self = this.set("user_dict", value.asInstanceOf[js.Any])
  }
}
