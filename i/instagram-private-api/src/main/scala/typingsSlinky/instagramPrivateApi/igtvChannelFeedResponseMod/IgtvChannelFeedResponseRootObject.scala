...
object IgtvChannelFeedResponseRootObject {
  ...
  implicit class IgtvChannelFeedResponseRootObjectOps[Self <: IgtvChannelFeedResponseRootObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[IgtvChannelFeedResponseItemsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSeen_state(value: IgtvChannelFeedResponseSeenState): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser_dict(value: IgtvChannelFeedResponseUserDict): Self = {
        val ret = this.duplicate
