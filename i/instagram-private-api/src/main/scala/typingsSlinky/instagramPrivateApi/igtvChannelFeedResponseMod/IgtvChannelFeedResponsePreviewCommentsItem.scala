...
@js.native
trait IgtvChannelFeedResponsePreviewCommentsItem extends StObject {
...
object IgtvChannelFeedResponsePreviewCommentsItem {
  ...
  @scala.inline
  implicit class IgtvChannelFeedResponsePreviewCommentsItemMutableBuilder[Self <: IgtvChannelFeedResponsePreviewCommentsItem] (val x: Self) extends AnyVal {
