...
object UserRepositorySearchResponseUsersItem {
  ...
  implicit class UserRepositorySearchResponseUsersItemOps[Self <: UserRepositorySearchResponseUsersItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: UserRepositorySearchResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteUnseen_count: Self = this.set("unseen_count", js.undefined)
  }
}
