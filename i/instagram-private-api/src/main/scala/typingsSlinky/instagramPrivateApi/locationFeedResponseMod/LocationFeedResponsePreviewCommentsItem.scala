...
@js.native
trait LocationFeedResponsePreviewCommentsItem extends StObject {
...
object LocationFeedResponsePreviewCommentsItem {
  ...
  @scala.inline
  implicit class LocationFeedResponsePreviewCommentsItemMutableBuilder[Self <: LocationFeedResponsePreviewCommentsItem] (val x: Self) extends AnyVal {
