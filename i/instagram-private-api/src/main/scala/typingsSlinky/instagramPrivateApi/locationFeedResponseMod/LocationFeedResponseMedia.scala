...
object LocationFeedResponseMedia {
  ...
  implicit class LocationFeedResponseMediaOps[Self <: LocationFeedResponseMedia] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLocation(value: LocationFeedResponseLocation): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreview_comments(value: js.Array[LocationFeedResponsePreviewCommentsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: LocationFeedResponseUser): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCaption(value: LocationFeedResponseCaption): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCarousel_media(value: js.Array[LocationFeedResponseCarouselMediaItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImage_versions2(value: LocationFeedResponseImageVersions2): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUsertags(value: LocationFeedResponseUsertags): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVideo_versions(value: js.Array[LocationFeedResponseVideoVersionsItem]): Self = {
        val ret = this.duplicate
