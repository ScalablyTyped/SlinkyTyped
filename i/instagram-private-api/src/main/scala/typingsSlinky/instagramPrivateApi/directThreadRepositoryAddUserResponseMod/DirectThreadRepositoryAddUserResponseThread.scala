...
object DirectThreadRepositoryAddUserResponseThread {
  ...
  implicit class DirectThreadRepositoryAddUserResponseThreadOps[Self <: DirectThreadRepositoryAddUserResponseThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInviter(value: DirectThreadRepositoryAddUserResponseInviter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast_permanent_item(value: DirectThreadRepositoryAddUserResponseLastPermanentItem): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUsers(value: js.Array[DirectThreadRepositoryAddUserResponseUsersItem]): Self = {
        val ret = this.duplicate
