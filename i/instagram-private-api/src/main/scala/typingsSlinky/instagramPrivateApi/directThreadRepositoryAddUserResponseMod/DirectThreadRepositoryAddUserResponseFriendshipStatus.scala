...
object DirectThreadRepositoryAddUserResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryAddUserResponseFriendshipStatusOps[Self <: DirectThreadRepositoryAddUserResponseFriendshipStatus] (val x: Self) extends AnyVal {
