...
@js.native
trait TopicalExploreFeedResponseIgtvFirstFrame extends js.Object {
...
object TopicalExploreFeedResponseIgtvFirstFrame {
  ...
  @scala.inline
  implicit class TopicalExploreFeedResponseIgtvFirstFrameOps[Self <: TopicalExploreFeedResponseIgtvFirstFrame] (val x: Self) extends AnyVal {
