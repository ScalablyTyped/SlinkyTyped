...
@js.native
trait TopicalExploreFeedResponseMainImage extends js.Object {
...
object TopicalExploreFeedResponseMainImage {
  ...
  @scala.inline
  implicit class TopicalExploreFeedResponseMainImageOps[Self <: TopicalExploreFeedResponseMainImage] (val x: Self) extends AnyVal {
