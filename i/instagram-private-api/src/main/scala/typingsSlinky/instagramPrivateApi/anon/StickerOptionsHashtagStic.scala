...
object StickerOptionsHashtagStic {
  ...
  def apply(
    ...
    bottom: () => StickerOptionsHashtagStic = null,
    center: () => StickerOptionsHashtagStic = null,
    height: js.UndefOr[Double] = js.undefined,
    id: () => String = null,
    isSticker: js.UndefOr[Boolean] = js.undefined,
    key: () => String = null,
    left: () => StickerOptionsHashtagStic = null,
    moveBackwards: /* layers */ js.UndefOr[Double] => StickerOptionsHashtagStic = null,
    moveForward: /* layers */ js.UndefOr[Double] => StickerOptionsHashtagStic = null,
    right: () => StickerOptionsHashtagStic = null,
    rotateDeg: /* deg */ Double => StickerOptionsHashtagStic = null,
    rotation: js.UndefOr[Double] = js.undefined,
    scale: /* factor */ Double => StickerOptionsHashtagStic = null,
    toJSON: () => _ = null,
    top: () => StickerOptionsHashtagStic = null,
    width: js.UndefOr[Double] = js.undefined,
    x: js.UndefOr[Double] = js.undefined,
    y: js.UndefOr[Double] = js.undefined,
    z: js.UndefOr[Double] = js.undefined
  ): StickerOptionsHashtagStic = {
