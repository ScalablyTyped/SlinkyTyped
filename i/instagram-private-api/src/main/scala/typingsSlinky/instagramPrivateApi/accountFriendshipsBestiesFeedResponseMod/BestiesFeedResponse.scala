package typingsSlinky.instagramPrivateApi.accountFriendshipsBestiesFeedResponseMod
...
@js.native
trait BestiesFeedResponse extends js.Object {
  ...
  var users: js.Array[BestiesFeedResponseUsersItem] = js.native
}
object BestiesFeedResponse {
  ...
  @scala.inline
  implicit class BestiesFeedResponseOps[Self <: BestiesFeedResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUsersVarargs(value: BestiesFeedResponseUsersItem*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[BestiesFeedResponseUsersItem]): Self = this.set("users", value.asInstanceOf[js.Any])
  }
}
