...
import typingsSlinky.instagramPrivateApi.anon.StorystickeridsAny
...
import typingsSlinky.instagramPrivateApi.postingOptionsMod.PostingStoryLocationSticker
