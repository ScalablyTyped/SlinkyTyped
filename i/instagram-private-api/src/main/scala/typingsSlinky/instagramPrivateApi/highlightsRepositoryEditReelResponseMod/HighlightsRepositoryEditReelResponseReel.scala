...
object HighlightsRepositoryEditReelResponseReel {
  ...
  implicit class HighlightsRepositoryEditReelResponseReelOps[Self <: HighlightsRepositoryEditReelResponseReel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCover_media(value: HighlightsRepositoryEditReelResponseCoverMedia): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItems(value: js.Array[HighlightsRepositoryEditReelResponseItemsItem]): Self = {
        val ret = this.duplicate
