...
@js.native
trait HighlightsRepositoryEditReelResponseFullImageVersion extends js.Object {
...
object HighlightsRepositoryEditReelResponseFullImageVersion {
  ...
  @scala.inline
  implicit class HighlightsRepositoryEditReelResponseFullImageVersionOps[Self <: HighlightsRepositoryEditReelResponseFullImageVersion] (val x: Self) extends AnyVal {
