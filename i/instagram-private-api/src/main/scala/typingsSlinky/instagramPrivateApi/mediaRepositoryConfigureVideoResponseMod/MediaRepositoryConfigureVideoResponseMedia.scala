...
object MediaRepositoryConfigureVideoResponseMedia {
  ...
  implicit class MediaRepositoryConfigureVideoResponseMediaOps[Self <: MediaRepositoryConfigureVideoResponseMedia] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFb_user_tags(value: MediaRepositoryConfigureVideoResponseFbUserTags): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImage_versions2(value: MediaRepositoryConfigureVideoResponseImageVersions2): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: MediaRepositoryConfigureVideoResponseUser): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("user")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUsertags(value: MediaRepositoryConfigureVideoResponseUsertags): Self = {
        val ret = this.duplicate
