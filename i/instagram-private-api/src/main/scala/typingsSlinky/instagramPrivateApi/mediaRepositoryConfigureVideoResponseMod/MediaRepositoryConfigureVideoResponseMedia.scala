...
object MediaRepositoryConfigureVideoResponseMedia {
  ...
  @scala.inline
  implicit class MediaRepositoryConfigureVideoResponseMediaOps[Self <: MediaRepositoryConfigureVideoResponseMedia] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFb_user_tags(value: MediaRepositoryConfigureVideoResponseFbUserTags): Self = this.set("fb_user_tags", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setImage_versions2(value: MediaRepositoryConfigureVideoResponseImageVersions2): Self = this.set("image_versions2", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUsertags(value: MediaRepositoryConfigureVideoResponseUsertags): Self = this.set("usertags", value.asInstanceOf[js.Any])
  }
}
