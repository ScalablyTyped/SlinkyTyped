...
@js.native
trait DirectInboxFeedResponseProfile extends StObject {
...
object DirectInboxFeedResponseProfile {
  ...
  @scala.inline
  implicit class DirectInboxFeedResponseProfileMutableBuilder[Self <: DirectInboxFeedResponseProfile] (val x: Self) extends AnyVal {
