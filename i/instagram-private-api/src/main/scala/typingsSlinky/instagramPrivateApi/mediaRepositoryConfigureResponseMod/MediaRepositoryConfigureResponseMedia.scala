...
object MediaRepositoryConfigureResponseMedia {
  ...
  @scala.inline
  implicit class MediaRepositoryConfigureResponseMediaOps[Self <: MediaRepositoryConfigureResponseMedia] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFb_user_tags(value: MediaRepositoryConfigureResponseFbUserTags): Self = this.set("fb_user_tags", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setImage_versions2(value: MediaRepositoryConfigureResponseImageVersions2): Self = this.set("image_versions2", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUser(value: MediaRepositoryConfigureResponseUser): Self = this.set("user", value.asInstanceOf[js.Any])
  }
}
