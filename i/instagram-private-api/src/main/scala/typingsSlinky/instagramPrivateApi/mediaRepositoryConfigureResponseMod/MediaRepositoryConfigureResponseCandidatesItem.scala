...
@js.native
trait MediaRepositoryConfigureResponseCandidatesItem extends js.Object {
...
object MediaRepositoryConfigureResponseCandidatesItem {
  ...
  @scala.inline
  implicit class MediaRepositoryConfigureResponseCandidatesItemOps[Self <: MediaRepositoryConfigureResponseCandidatesItem] (val x: Self) extends AnyVal {
