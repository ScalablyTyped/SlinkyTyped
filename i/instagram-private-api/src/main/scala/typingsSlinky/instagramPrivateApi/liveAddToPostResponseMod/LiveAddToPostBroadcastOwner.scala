...
object LiveAddToPostBroadcastOwner {
  ...
  @scala.inline
  implicit class LiveAddToPostBroadcastOwnerOps[Self <: LiveAddToPostBroadcastOwner] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: LiveAddToPostFriendshipstatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
