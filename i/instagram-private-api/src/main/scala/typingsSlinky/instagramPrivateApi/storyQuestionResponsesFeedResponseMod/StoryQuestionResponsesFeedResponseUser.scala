...
@js.native
trait StoryQuestionResponsesFeedResponseUser extends js.Object {
...
object StoryQuestionResponsesFeedResponseUser {
  ...
  @scala.inline
  implicit class StoryQuestionResponsesFeedResponseUserOps[Self <: StoryQuestionResponsesFeedResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
