...
object UsertagsFeedResponseItemsItem {
  ...
  implicit class UsertagsFeedResponseItemsItemOps[Self <: UsertagsFeedResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCaption(value: UsertagsFeedResponseCaption): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImage_versions2(value: UsertagsFeedResponseImageVersions2): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreview_comments(value: js.Array[UsertagsFeedResponsePreviewCommentsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUsertags(value: UsertagsFeedResponseUsertags): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLocation(value: UsertagsFeedResponseLocation): Self = {
        val ret = this.duplicate
