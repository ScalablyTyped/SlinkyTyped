...
object UsertagsFeedResponseItemsItem {
  ...
  @scala.inline
  implicit class UsertagsFeedResponseItemsItemOps[Self <: UsertagsFeedResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCaption(value: UsertagsFeedResponseCaption): Self = this.set("caption", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setImage_versions2(value: UsertagsFeedResponseImageVersions2): Self = this.set("image_versions2", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPreview_commentsVarargs(value: UsertagsFeedResponsePreviewCommentsItem*): Self = this.set("preview_comments", js.Array(value :_*))
    
    @scala.inline
    def setPreview_comments(value: js.Array[UsertagsFeedResponsePreviewCommentsItem]): Self = this.set("preview_comments", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUsertags(value: UsertagsFeedResponseUsertags): Self = this.set("usertags", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLocation(value: UsertagsFeedResponseLocation): Self = this.set("location", value.asInstanceOf[js.Any])
