...
import typingsSlinky.instagramPrivateApi.mediaConfigureVideoOptionsMod.MediaConfigureVideoOptions
...
object MediaConfigureStoryVideoOptions {
  ...
  @scala.inline
  implicit class MediaConfigureStoryVideoOptionsOps[Self <: MediaConfigureStoryVideoOptions] (val x: Self) extends AnyVal {
