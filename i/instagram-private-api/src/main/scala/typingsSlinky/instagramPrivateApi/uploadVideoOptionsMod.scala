...
import typingsSlinky.instagramPrivateApi.anon.Buffer
...
object uploadVideoOptionsMod {
  ...
  type SegmentDivider = js.Function1[/* options */ Buffer, js.Array[typingsSlinky.node.Buffer]]
  ...
  trait UploadSegmentedVideoOptions extends UploadVideoOptions {
    ...
    var segments: js.UndefOr[js.Array[typingsSlinky.node.Buffer]] = js.native
  }
  object UploadSegmentedVideoOptions {
    
    @scala.inline
    def apply(duration: Double, video: typingsSlinky.node.Buffer): UploadSegmentedVideoOptions = {
    ...
    implicit class UploadSegmentedVideoOptionsMutableBuilder[Self <: UploadSegmentedVideoOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSegmentDivider(value: /* options */ Buffer => js.Array[typingsSlinky.node.Buffer]): Self = StObject.set(x, "segmentDivider", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSegmentDividerUndefined: Self = StObject.set(x, "segmentDivider", js.undefined)
      
      @scala.inline
      def setSegments(value: js.Array[typingsSlinky.node.Buffer]): Self = StObject.set(x, "segments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSegmentsUndefined: Self = StObject.set(x, "segments", js.undefined)
      
      @scala.inline
      def setSegmentsVarargs(value: typingsSlinky.node.Buffer*): Self = StObject.set(x, "segments", js.Array(value :_*))
    }
  }
  ...
  trait UploadVideoOptions extends StObject {
    ...
    var video: typingsSlinky.node.Buffer = js.native
  ...
  object UploadVideoOptions {
    ...
    @scala.inline
    def apply(duration: Double, video: typingsSlinky.node.Buffer): UploadVideoOptions = {
      val __obj = js.Dynamic.literal(duration = duration.asInstanceOf[js.Any], video = video.asInstanceOf[js.Any])
  ...
  trait UploadVideoSegmentTransferOptions extends StObject {
    ...
    var segment: typingsSlinky.node.Buffer = js.native
  ...
  object UploadVideoSegmentTransferOptions {
    ...
    def apply(
      ruploadParams: js.Any,
      segment: typingsSlinky.node.Buffer,
      startOffset: Double,
      streamId: String,
      transferId: String,
      waterfallId: String
    ...
    implicit class UploadVideoSegmentTransferOptionsMutableBuilder[Self <: UploadVideoSegmentTransferOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSegment(value: typingsSlinky.node.Buffer): Self = StObject.set(x, "segment", value.asInstanceOf[js.Any])
