...
object TimelineFeedResponseLocation {
  ...
  @scala.inline
  implicit class TimelineFeedResponseLocationOps[Self <: TimelineFeedResponseLocation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFacebook_places_id(value: Double | String): Self = this.set("facebook_places_id", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPk(value: Double | String): Self = this.set("pk", value.asInstanceOf[js.Any])
