...
object HighlightsRepositoryCreateReelResponseItemsItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryCreateReelResponseItemsItemOps[Self <: HighlightsRepositoryCreateReelResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImage_versions2(value: HighlightsRepositoryCreateReelResponseImageVersions2): Self = this.set("image_versions2", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUser(value: HighlightsRepositoryCreateReelResponseUser): Self = this.set("user", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVideo_versionsVarargs(value: HighlightsRepositoryCreateReelResponseVideoVersionsItem*): Self = this.set("video_versions", js.Array(value :_*))
    
    @scala.inline
    def setVideo_versions(value: js.Array[HighlightsRepositoryCreateReelResponseVideoVersionsItem]): Self = this.set("video_versions", value.asInstanceOf[js.Any])
