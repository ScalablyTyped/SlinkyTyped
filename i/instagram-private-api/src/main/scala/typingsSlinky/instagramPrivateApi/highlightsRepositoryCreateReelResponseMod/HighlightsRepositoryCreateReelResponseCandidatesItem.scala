...
object HighlightsRepositoryCreateReelResponseCandidatesItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryCreateReelResponseCandidatesItemOps[Self <: HighlightsRepositoryCreateReelResponseCandidatesItem] (val x: Self) extends AnyVal {
    @scala.inline
