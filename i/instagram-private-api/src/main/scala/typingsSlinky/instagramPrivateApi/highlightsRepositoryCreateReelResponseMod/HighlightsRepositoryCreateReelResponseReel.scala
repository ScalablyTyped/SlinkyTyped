...
object HighlightsRepositoryCreateReelResponseReel {
  ...
  implicit class HighlightsRepositoryCreateReelResponseReelOps[Self <: HighlightsRepositoryCreateReelResponseReel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCover_media(value: HighlightsRepositoryCreateReelResponseCoverMedia): Self = this.set("cover_media", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: HighlightsRepositoryCreateReelResponseItemsItem*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[HighlightsRepositoryCreateReelResponseItemsItem]): Self = this.set("items", value.asInstanceOf[js.Any])
