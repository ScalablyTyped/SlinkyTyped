...
object HighlightsRepositoryCreateReelResponseFullImageVersion {
  ...
  @scala.inline
  implicit class HighlightsRepositoryCreateReelResponseFullImageVersionOps[Self <: HighlightsRepositoryCreateReelResponseFullImageVersion] (val x: Self) extends AnyVal {
