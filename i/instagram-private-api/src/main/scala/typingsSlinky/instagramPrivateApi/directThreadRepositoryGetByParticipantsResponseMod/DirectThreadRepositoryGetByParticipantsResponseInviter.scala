...
@js.native
trait DirectThreadRepositoryGetByParticipantsResponseInviter extends js.Object {
...
object DirectThreadRepositoryGetByParticipantsResponseInviter {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryGetByParticipantsResponseInviterOps[Self <: DirectThreadRepositoryGetByParticipantsResponseInviter] (val x: Self) extends AnyVal {
