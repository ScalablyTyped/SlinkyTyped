...
@js.native
trait DirectThreadRepositoryGetByParticipantsResponseThread extends js.Object {
...
object DirectThreadRepositoryGetByParticipantsResponseThread {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryGetByParticipantsResponseThreadOps[Self <: DirectThreadRepositoryGetByParticipantsResponseThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInviter(value: DirectThreadRepositoryGetByParticipantsResponseInviter): Self = this.set("inviter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: DirectThreadRepositoryGetByParticipantsResponseItemsItem*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[DirectThreadRepositoryGetByParticipantsResponseItemsItem]): Self = this.set("items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLast_activity_at(value: String): Self = this.set("last_activity_at", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLast_permanent_item(value: DirectThreadRepositoryGetByParticipantsResponseLastPermanentItem): Self = this.set("last_permanent_item", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLast_seen_at(value: js.Any): Self = this.set("last_seen_at", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUsersVarargs(value: DirectThreadRepositoryGetByParticipantsResponseUsersItem*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[DirectThreadRepositoryGetByParticipantsResponseUsersItem]): Self = this.set("users", value.asInstanceOf[js.Any])
