...
object DirectThreadRepositoryGetByParticipantsResponseThread {
  ...
  implicit class DirectThreadRepositoryGetByParticipantsResponseThreadOps[Self <: DirectThreadRepositoryGetByParticipantsResponseThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInviter(value: DirectThreadRepositoryGetByParticipantsResponseInviter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItems(value: js.Array[DirectThreadRepositoryGetByParticipantsResponseItemsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast_permanent_item(value: DirectThreadRepositoryGetByParticipantsResponseLastPermanentItem): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUsers(value: js.Array[DirectThreadRepositoryGetByParticipantsResponseUsersItem]): Self = {
        val ret = this.duplicate
