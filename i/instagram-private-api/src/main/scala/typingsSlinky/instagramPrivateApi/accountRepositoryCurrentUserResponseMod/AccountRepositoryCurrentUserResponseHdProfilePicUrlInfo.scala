...
@js.native
trait AccountRepositoryCurrentUserResponseHdProfilePicUrlInfo extends js.Object {
...
object AccountRepositoryCurrentUserResponseHdProfilePicUrlInfo {
  ...
  @scala.inline
  implicit class AccountRepositoryCurrentUserResponseHdProfilePicUrlInfoOps[Self <: AccountRepositoryCurrentUserResponseHdProfilePicUrlInfo] (val x: Self) extends AnyVal {
    @scala.inline
