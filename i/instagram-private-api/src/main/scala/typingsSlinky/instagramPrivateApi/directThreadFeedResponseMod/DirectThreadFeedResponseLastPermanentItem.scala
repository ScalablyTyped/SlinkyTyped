...
@js.native
trait DirectThreadFeedResponseLastPermanentItem extends js.Object {
...
object DirectThreadFeedResponseLastPermanentItem {
  ...
  @scala.inline
  implicit class DirectThreadFeedResponseLastPermanentItemOps[Self <: DirectThreadFeedResponseLastPermanentItem] (val x: Self) extends AnyVal {
    @scala.inline
