...
@js.native
trait LocationRepositoryStoryResponseHashtag extends js.Object {
...
object LocationRepositoryStoryResponseHashtag {
  ...
  @scala.inline
  implicit class LocationRepositoryStoryResponseHashtagOps[Self <: LocationRepositoryStoryResponseHashtag] (val x: Self) extends AnyVal {
