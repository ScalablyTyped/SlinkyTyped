...
object LocationRepositoryStoryResponseItemsItem {
  ...
  implicit class LocationRepositoryStoryResponseItemsItemOps[Self <: LocationRepositoryStoryResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImage_versions2(value: LocationRepositoryStoryResponseImageVersions2): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStory_locations(value: js.Array[LocationRepositoryStoryResponseStoryLocationsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReel_mentions(value: js.Array[LocationRepositoryStoryResponseReelMentionsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStory_hashtags(value: js.Array[LocationRepositoryStoryResponseStoryHashtagsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVideo_versions(value: js.Array[LocationRepositoryStoryResponseVideoVersionsItem]): Self = {
        val ret = this.duplicate
