...
object MusicSearchFeedResponseItemsItem {
  ...
  @scala.inline
  implicit class MusicSearchFeedResponseItemsItemOps[Self <: MusicSearchFeedResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTrack(value: MusicSearchFeedResponseTrack): Self = this.set("track", value.asInstanceOf[js.Any])
  }
}
