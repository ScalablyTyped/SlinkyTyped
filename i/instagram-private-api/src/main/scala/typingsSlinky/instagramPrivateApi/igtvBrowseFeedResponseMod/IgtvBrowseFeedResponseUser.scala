...
@js.native
trait IgtvBrowseFeedResponseUser extends js.Object {
...
object IgtvBrowseFeedResponseUser {
  ...
  @scala.inline
  implicit class IgtvBrowseFeedResponseUserOps[Self <: IgtvBrowseFeedResponseUser] (val x: Self) extends AnyVal {
