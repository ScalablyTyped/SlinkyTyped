...
object IgtvBrowseFeedResponseMyChannel {
  ...
  @scala.inline
  implicit class IgtvBrowseFeedResponseMyChannelMutableBuilder[Self <: IgtvBrowseFeedResponseMyChannel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUser_dict(value: IgtvBrowseFeedResponseUserDict): Self = StObject.set(x, "user_dict", value.asInstanceOf[js.Any])
  }
}
