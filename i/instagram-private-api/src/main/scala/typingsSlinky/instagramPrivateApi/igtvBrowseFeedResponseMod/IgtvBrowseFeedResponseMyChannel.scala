...
@js.native
trait IgtvBrowseFeedResponseMyChannel extends js.Object {
  ...
  var user_dict: IgtvBrowseFeedResponseUserDict = js.native
}
object IgtvBrowseFeedResponseMyChannel {
  ...
  @scala.inline
  implicit class IgtvBrowseFeedResponseMyChannelOps[Self <: IgtvBrowseFeedResponseMyChannel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUser_dict(value: IgtvBrowseFeedResponseUserDict): Self = this.set("user_dict", value.asInstanceOf[js.Any])
  }
}
