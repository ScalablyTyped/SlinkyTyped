...
object IgtvBrowseFeedResponseItem {
  ...
  implicit class IgtvBrowseFeedResponseItemOps[Self <: IgtvBrowseFeedResponseItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCaption(value: IgtvBrowseFeedResponseCaption): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withExplore(value: IgtvBrowseFeedResponseExplore): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImage_versions2(value: IgtvBrowseFeedResponseImageVersions2): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMedia_cropping_info(value: IgtvBrowseFeedResponseMediaCroppingInfo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMezql_token(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mezql_token")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withThumbnails(value: IgtvBrowseFeedResponseThumbnails): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVideo_versions(value: js.Array[IgtvBrowseFeedResponseVideoVersionsItem]): Self = {
        val ret = this.duplicate
