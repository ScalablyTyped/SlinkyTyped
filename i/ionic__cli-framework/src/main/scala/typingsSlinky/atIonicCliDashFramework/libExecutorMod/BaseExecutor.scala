...
import typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.`operation-rpc`
...
import typingsSlinky.atIonicCliDashFramework.utilsIpcMod.RPCProcess
