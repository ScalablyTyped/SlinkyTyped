...
import typingsSlinky.atIonicCliDashFramework.libCompletionMod.CompletionFormatterDeps
...
abstract class CompletionFormatter[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] protected ()
  extends typingsSlinky.atIonicCliDashFramework.libCompletionMod.CompletionFormatter[C, N, M, I, O] {
