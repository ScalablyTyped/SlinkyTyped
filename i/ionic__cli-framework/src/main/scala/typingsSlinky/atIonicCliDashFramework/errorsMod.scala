...
import typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.ERR_ICF_COMMAND_NOT_FOUND
import typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.ERR_ICF_INPUT_VALIDATION
...
object errorsMod extends js.Object {
  ...
  class CommandNotFoundError protected () extends BaseError {
    ...
    @JSName("name")
    val name_CommandNotFoundError: typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.CommandNotFoundError = js.native
  }
  
  @js.native
  class IPCError () extends BaseError {
    @JSName("name")
    val name_IPCError: typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.IPCError = js.native
  }
  ...
  class InputValidationError protected () extends BaseError {
    ...
    @JSName("name")
    val name_InputValidationError: typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.InputValidationError = js.native
  }
