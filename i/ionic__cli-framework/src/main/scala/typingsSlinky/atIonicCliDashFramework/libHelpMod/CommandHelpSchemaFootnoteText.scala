...
import typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.text
...
trait CommandHelpSchemaFootnoteText extends CommandHelpSchemaFootnote {
  ...
  val text: String
  val `type`: typingsSlinky.atIonicCliDashFramework.atIonicCliDashFrameworkStrings.text
}
