...
import typingsSlinky.atIonicCliDashFramework.definitionsMod.MetadataGroup
import typingsSlinky.atIonicCliDashFramework.libLoggerMod.LoggerLevel
...
object atIonicCliDashFrameworkStrings {
  ...
  @js.native
  sealed trait `rpc-response` extends js.Object
