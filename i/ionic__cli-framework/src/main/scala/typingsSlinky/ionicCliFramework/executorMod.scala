...
import typingsSlinky.ionicCliFramework.helpMod.NamespaceHelpSchema
import typingsSlinky.ionicCliFramework.ionicCliFrameworkStrings.`operation-rpc`
import typingsSlinky.ionicCliFramework.ionicCliFrameworkStrings.help
...
import typingsSlinky.ionicCliFramework.ipcMod.RPC
