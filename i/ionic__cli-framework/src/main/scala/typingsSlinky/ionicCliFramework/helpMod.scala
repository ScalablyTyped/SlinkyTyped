...
object helpMod {
  ...
  trait CommandHelpFormatterDeps[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] extends StObject {
    ...
    val colors: js.UndefOr[typingsSlinky.ionicCliFramework.colorsMod.Colors] = js.native
  ...
  */
  ...
  object CommandHelpSchemaFootnote {
    ...
    @scala.inline
    def CommandHelpSchemaFootnoteLink(id: String | Double, `type`: link, url: String): typingsSlinky.ionicCliFramework.helpMod.CommandHelpSchemaFootnoteLink = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.ionicCliFramework.helpMod.CommandHelpSchemaFootnoteLink]
    }
    
    @scala.inline
    def CommandHelpSchemaFootnoteText(id: String | Double, text: String, `type`: text): typingsSlinky.ionicCliFramework.helpMod.CommandHelpSchemaFootnoteText = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.ionicCliFramework.helpMod.CommandHelpSchemaFootnoteText]
    }
  }
