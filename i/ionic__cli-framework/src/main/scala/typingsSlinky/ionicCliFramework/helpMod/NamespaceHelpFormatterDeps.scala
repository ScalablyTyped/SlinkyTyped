...
object NamespaceHelpFormatterDeps {
  ...
  @scala.inline
  implicit class NamespaceHelpFormatterDepsOps[Self <: NamespaceHelpFormatterDeps[_, _, _, _, _], /* <: typingsSlinky.ionicCliFramework.definitionsMod.ICommand[C, N, M, I, O] */ C, /* <: typingsSlinky.ionicCliFramework.definitionsMod.INamespace[C, N, M, I, O] */ N, /* <: typingsSlinky.ionicCliFramework.definitionsMod.CommandMetadata[I, O] */ M, /* <: typingsSlinky.ionicCliFramework.definitionsMod.CommandMetadataInput */ I, /* <: typingsSlinky.ionicCliFramework.definitionsMod.CommandMetadataOption */ O] (val x: Self with (NamespaceHelpFormatterDeps[C, N, M, I, O])) extends AnyVal {
    @scala.inline
