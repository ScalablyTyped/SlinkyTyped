...
object AnonCommands {
  @scala.inline
  def apply[C, N, M, I, O](commands: js.Array[HydratedCommandMetadata[C, N, M, I, O]]): AnonCommands[C, N, M, I, O] = {
    val __obj = js.Dynamic.literal(commands = commands.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommands[C, N, M, I, O]]
  }
  @scala.inline
  implicit class AnonCommandsOps[Self[c, n, m, i, o] <: AnonCommands[c, n, m, i, o], C, N, M, I, O] (val x: Self[C, N, M, I, O]) extends AnyVal {
    @scala.inline
