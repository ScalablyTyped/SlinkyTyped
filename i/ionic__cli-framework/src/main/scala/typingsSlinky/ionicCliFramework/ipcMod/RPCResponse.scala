...
object RPCResponse {
  @scala.inline
  def apply[/* <: typingsSlinky.ionicCliFramework.ipcMod.RPCRequest[_, _] */ R, /* <: js.Object */ D](
    data: D,
    id: String,
  ...
  @scala.inline
  implicit class RPCResponseOps[Self <: RPCResponse[_, _], /* <: typingsSlinky.ionicCliFramework.ipcMod.RPCRequest[_, _] */ R, /* <: js.Object */ D] (val x: Self with (RPCResponse[R, D])) extends AnyVal {
    @scala.inline
