...
object AnonArgv {
  @scala.inline
  def apply[N, C, M, I, O](argv: js.Array[String], env: ProcessEnv, namespace: N): AnonArgv[N, C, M, I, O] = {
  ...
  @scala.inline
  implicit class AnonArgvOps[Self[n, c, m, i, o] <: AnonArgv[n, c, m, i, o], N, C, M, I, O] (val x: Self[N, C, M, I, O]) extends AnyVal {
    @scala.inline
