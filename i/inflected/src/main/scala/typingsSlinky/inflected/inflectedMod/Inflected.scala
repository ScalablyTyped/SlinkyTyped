package typingsSlinky.inflected.inflectedMod

import typingsSlinky.inflected.inflectedMod.Options.Humanize
import typingsSlinky.inflected.inflectedMod.Options.Parameterize
import typingsSlinky.inflected.inflectedMod.Options.Transliterate
