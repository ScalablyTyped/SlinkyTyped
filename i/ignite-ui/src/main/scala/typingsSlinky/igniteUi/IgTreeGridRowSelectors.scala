...
object IgTreeGridRowSelectors {
  ...
  implicit class IgTreeGridRowSelectorsOps[Self <: IgTreeGridRowSelectors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRowSelectorNumberingMode(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowSelectorNumberingMode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRowSelectorNumberingMode: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowSelectorNumberingMode")(js.undefined)
        ret
    }
    @scala.inline
