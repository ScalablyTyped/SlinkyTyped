...
object IgTreeGridRowSelectors {
  ...
  @scala.inline
  implicit class IgTreeGridRowSelectorsMutableBuilder[Self <: IgTreeGridRowSelectors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRowSelectorNumberingMode(value: String): Self = StObject.set(x, "rowSelectorNumberingMode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowSelectorNumberingModeUndefined: Self = StObject.set(x, "rowSelectorNumberingMode", js.undefined)
