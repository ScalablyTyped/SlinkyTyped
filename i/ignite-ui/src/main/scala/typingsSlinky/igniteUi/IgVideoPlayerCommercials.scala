...
object IgVideoPlayerCommercials {
  ...
  def apply(
    ...
    if (!js.isUndefined(alwaysPlayCommercials)) __obj.updateDynamic("alwaysPlayCommercials")(alwaysPlayCommercials.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showBookmarks)) __obj.updateDynamic("showBookmarks")(showBookmarks.get.asInstanceOf[js.Any])
