...
object IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchie {
  ...
  @scala.inline
  implicit class IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchieOps[Self <: IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchie] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLevelsVarargs(value: IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchieLevel*): Self = this.set("levels", js.Array(value :_*))
    
    @scala.inline
    def setLevels(value: js.Array[IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchieLevel]): Self = this.set("levels", value.asInstanceOf[js.Any])
