...
object RESTDataSourceSettingsRestSettingsUpdate {
  ...
  @scala.inline
  def apply(): RESTDataSourceSettingsRestSettingsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RESTDataSourceSettingsRestSettingsUpdate]
  }
  
  @scala.inline
  implicit class RESTDataSourceSettingsRestSettingsUpdateMutableBuilder[Self <: RESTDataSourceSettingsRestSettingsUpdate] (val x: Self) extends AnyVal {
