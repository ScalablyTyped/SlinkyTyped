...
object IgHierarchicalGridRestSettingsRemove {
  ...
  @scala.inline
  def apply(): IgHierarchicalGridRestSettingsRemove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IgHierarchicalGridRestSettingsRemove]
  }
  
  @scala.inline
  implicit class IgHierarchicalGridRestSettingsRemoveMutableBuilder[Self <: IgHierarchicalGridRestSettingsRemove] (val x: Self) extends AnyVal {
