...
object IgRadialGaugeMethods {
  ...
  implicit class IgRadialGaugeMethodsOps[Self <: IgRadialGaugeMethods] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClearRanges(value: () => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetPointForValue(value: (js.Object, js.Object) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPointForValue")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNeedleContainsPoint(value: (js.Object, js.Object) => Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScaleValue(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUnscaleValue(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unscaleValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
