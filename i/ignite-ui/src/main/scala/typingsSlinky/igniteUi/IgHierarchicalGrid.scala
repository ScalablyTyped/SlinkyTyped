...
object IgHierarchicalGrid {
  ...
  implicit class IgHierarchicalGridOps[Self <: IgHierarchicalGrid] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutoGenerateLayouts(value: Boolean): Self = this.set("autoGenerateLayouts", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAutoGenerateLayouts: Self = this.set("autoGenerateLayouts", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setChildGridCreated(value: (/* event */ Event, /* ui */ ChildGridCreatedEventUIParam) => Unit): Self = this.set("childGridCreated", js.Any.fromFunction2(value))
    @scala.inline
    def deleteChildGridCreated: Self = this.set("childGridCreated", js.undefined)
    @scala.inline
    def setChildGridCreating(value: (/* event */ Event, /* ui */ ChildGridCreatingEventUIParam) => Unit): Self = this.set("childGridCreating", js.Any.fromFunction2(value))
    @scala.inline
    def deleteChildGridCreating: Self = this.set("childGridCreating", js.undefined)
    @scala.inline
    def setChildGridRendered(value: (/* event */ Event, /* ui */ ChildGridRenderedEventUIParam) => Unit): Self = this.set("childGridRendered", js.Any.fromFunction2(value))
    @scala.inline
    def deleteChildGridRendered: Self = this.set("childGridRendered", js.undefined)
    @scala.inline
    def setChildrenPopulated(value: (/* event */ Event, /* ui */ ChildrenPopulatedEventUIParam) => Unit): Self = this.set("childrenPopulated", js.Any.fromFunction2(value))
    @scala.inline
    def deleteChildrenPopulated: Self = this.set("childrenPopulated", js.undefined)
    @scala.inline
    def setChildrenPopulating(value: (/* event */ Event, /* ui */ ChildrenPopulatingEventUIParam) => Unit): Self = this.set("childrenPopulating", js.Any.fromFunction2(value))
    @scala.inline
    def deleteChildrenPopulating: Self = this.set("childrenPopulating", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setColumnLayoutsVarargs(value: IgHierarchicalGridColumnLayout*): Self = this.set("columnLayouts", js.Array(value :_*))
    @scala.inline
    def setColumnLayouts(value: js.Array[IgHierarchicalGridColumnLayout]): Self = this.set("columnLayouts", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteColumnLayouts: Self = this.set("columnLayouts", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setColumnsVarargs(value: IgHierarchicalGridColumn*): Self = this.set("columns", js.Array(value :_*))
    @scala.inline
    def setColumns(value: js.Array[IgHierarchicalGridColumn]): Self = this.set("columns", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDataSource(value: String | js.Array[_] | js.Object): Self = this.set("dataSource", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setExpandColWidth(value: Double): Self = this.set("expandColWidth", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteExpandColWidth: Self = this.set("expandColWidth", js.undefined)
    @scala.inline
    def setExpandCollapseAnimations(value: Boolean): Self = this.set("expandCollapseAnimations", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteExpandCollapseAnimations: Self = this.set("expandCollapseAnimations", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setFeaturesVarargs(value: IgHierarchicalGridFeature*): Self = this.set("features", js.Array(value :_*))
    @scala.inline
    def setFeatures(value: js.Array[IgHierarchicalGridFeature]): Self = this.set("features", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLocale(value: IgHierarchicalGridLocale): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRestSettings(value: IgHierarchicalGridRestSettings): Self = this.set("restSettings", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setScrollSettings(value: IgHierarchicalGridScrollSettings): Self = this.set("scrollSettings", value.asInstanceOf[js.Any])
    @scala.inline
