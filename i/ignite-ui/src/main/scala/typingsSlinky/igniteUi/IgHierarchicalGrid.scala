...
object IgHierarchicalGrid {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    childGridCreated: (/* event */ Event_, /* ui */ ChildGridCreatedEventUIParam) => Unit = null,
    childGridCreating: (/* event */ Event_, /* ui */ ChildGridCreatingEventUIParam) => Unit = null,
    childGridRendered: (/* event */ Event_, /* ui */ ChildGridRenderedEventUIParam) => Unit = null,
    childrenPopulated: (/* event */ Event_, /* ui */ ChildrenPopulatedEventUIParam) => Unit = null,
    childrenPopulating: (/* event */ Event_, /* ui */ ChildrenPopulatingEventUIParam) => Unit = null,
    ...
    if (!js.isUndefined(autoGenerateLayouts)) __obj.updateDynamic("autoGenerateLayouts")(autoGenerateLayouts.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(expandCollapseAnimations)) __obj.updateDynamic("expandCollapseAnimations")(expandCollapseAnimations.asInstanceOf[js.Any])
