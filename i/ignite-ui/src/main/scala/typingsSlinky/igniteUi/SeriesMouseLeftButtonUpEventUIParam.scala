...
@js.native
trait SeriesMouseLeftButtonUpEventUIParam extends StObject {
...
object SeriesMouseLeftButtonUpEventUIParam {
  
  @scala.inline
  def apply(): SeriesMouseLeftButtonUpEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMouseLeftButtonUpEventUIParam]
  }
  
  @scala.inline
  implicit class SeriesMouseLeftButtonUpEventUIParamMutableBuilder[Self <: SeriesMouseLeftButtonUpEventUIParam] (val x: Self) extends AnyVal {
