...
object AgendaRangeChangingEventUIParam {
  ...
  implicit class AgendaRangeChangingEventUIParamOps[Self <: AgendaRangeChangingEventUIParam] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentAgendaRangeStartDate(value: js.Any): Self = this.set("currentAgendaRangeStartDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCurrentAgendaRangeStartDate: Self = this.set("currentAgendaRangeStartDate", js.undefined)
