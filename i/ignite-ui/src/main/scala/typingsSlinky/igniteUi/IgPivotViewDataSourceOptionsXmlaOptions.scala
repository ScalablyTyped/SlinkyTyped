...
object IgPivotViewDataSourceOptionsXmlaOptions {
  ...
  implicit class IgPivotViewDataSourceOptionsXmlaOptionsOps[Self <: IgPivotViewDataSourceOptionsXmlaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMdxSettings(value: IgPivotViewDataSourceOptionsXmlaOptionsMdxSettings): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRequestOptions(value: IgPivotViewDataSourceOptionsXmlaOptionsRequestOptions): Self = {
        val ret = this.duplicate
