...
@js.native
trait SeriesMouseEnterEventUIParam extends StObject {
...
object SeriesMouseEnterEventUIParam {
  ...
  @scala.inline
  def apply(): SeriesMouseEnterEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMouseEnterEventUIParam]
  }
  
  @scala.inline
  implicit class SeriesMouseEnterEventUIParamMutableBuilder[Self <: SeriesMouseEnterEventUIParam] (val x: Self) extends AnyVal {
