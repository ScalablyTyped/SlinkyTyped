...
@js.native
trait SelectedCellsCollection extends js.Object {
...
object SelectedCellsCollection {
  ...
  @scala.inline
  implicit class SelectedCellsCollectionOps[Self <: SelectedCellsCollection] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withActiveCell(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activeCell")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withAtLeastOneSelected(value: (js.Object, js.Object) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("atLeastOneSelected")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
