...
object OlapXmlaDataSource {
  ...
  implicit class OlapXmlaDataSourceOps[Self <: OlapXmlaDataSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatalog(value: () => js.Object): Self = this.set("catalog", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCatalogs(value: () => js.Array[_]): Self = this.set("catalogs", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setMeasureGroup(value: () => js.Object): Self = this.set("measureGroup", js.Any.fromFunction0(value))
    
    @scala.inline
    def setMeasureGroups(value: () => js.Array[_]): Self = this.set("measureGroups", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetCatalog(value: String => js.Object): Self = this.set("setCatalog", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetCube(value: String => js.Object): Self = this.set("setCube", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetMeasureGroup(value: String => js.Object): Self = this.set("setMeasureGroup", js.Any.fromFunction1(value))
