...
@js.native
trait IgValidatorBaseRule extends js.Object {
  /**
...
object IgValidatorBaseRule {
  ...
  @scala.inline
  implicit class IgValidatorBaseRuleOps[Self <: IgValidatorBaseRule] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withIsValid(value: (js.Object, js.Object) => Boolean): Self = {
        val ret = this.duplicate
