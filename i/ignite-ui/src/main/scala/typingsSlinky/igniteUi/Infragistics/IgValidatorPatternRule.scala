...
@js.native
trait IgValidatorPatternRule extends StObject {
...
object IgValidatorPatternRule {
  ...
  @scala.inline
  implicit class IgValidatorPatternRuleMutableBuilder[Self <: IgValidatorPatternRule] (val x: Self) extends AnyVal {
