...
@js.native
trait ErrorHidingEventUIParam extends StObject {
...
object ErrorHidingEventUIParam {
  ...
  @scala.inline
  implicit class ErrorHidingEventUIParamMutableBuilder[Self <: ErrorHidingEventUIParam] (val x: Self) extends AnyVal {
