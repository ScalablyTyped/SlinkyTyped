...
object DropDownListOpeningEventUIParam {
  ...
  @scala.inline
  def apply(): DropDownListOpeningEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DropDownListOpeningEventUIParam]
  }
  
  @scala.inline
  implicit class DropDownListOpeningEventUIParamMutableBuilder[Self <: DropDownListOpeningEventUIParam] (val x: Self) extends AnyVal {
