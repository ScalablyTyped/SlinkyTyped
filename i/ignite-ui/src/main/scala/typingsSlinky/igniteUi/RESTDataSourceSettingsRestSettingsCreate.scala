...
object RESTDataSourceSettingsRestSettingsCreate {
  ...
  @scala.inline
  def apply(): RESTDataSourceSettingsRestSettingsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RESTDataSourceSettingsRestSettingsCreate]
  }
  
  @scala.inline
  implicit class RESTDataSourceSettingsRestSettingsCreateMutableBuilder[Self <: RESTDataSourceSettingsRestSettingsCreate] (val x: Self) extends AnyVal {
