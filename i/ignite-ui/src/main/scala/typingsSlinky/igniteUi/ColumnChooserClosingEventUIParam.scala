...
@js.native
trait ColumnChooserClosingEventUIParam extends js.Object {
  /**
...
object ColumnChooserClosingEventUIParam {
  @scala.inline
  def apply(): ColumnChooserClosingEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColumnChooserClosingEventUIParam]
  }
  @scala.inline
  implicit class ColumnChooserClosingEventUIParamOps[Self <: ColumnChooserClosingEventUIParam] (val x: Self) extends AnyVal {
    @scala.inline
