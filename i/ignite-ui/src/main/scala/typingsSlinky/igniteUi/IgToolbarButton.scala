...
object IgToolbarButton {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    activated: (/* event */ Event_, /* ui */ ActivatedEventUIParam) => Unit = null,
    activating: (/* event */ Event_, /* ui */ ActivatingEventUIParam) => Unit = null,
    allowToggling: js.UndefOr[Boolean] = js.undefined,
    deactivated: (/* event */ Event_, /* ui */ DeactivatedEventUIParam) => Unit = null,
    deactivating: (/* event */ Event_, /* ui */ DeactivatingEventUIParam) => Unit = null,
