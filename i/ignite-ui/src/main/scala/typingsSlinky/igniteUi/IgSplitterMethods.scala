...
object IgSplitterMethods {
  ...
  implicit class IgSplitterMethodsOps[Self <: IgSplitterMethods] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCollapseAt(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapseAt")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withExpandAt(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expandAt")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFirstPanel(value: () => js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("firstPanel")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRefreshLayout(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("refreshLayout")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSecondPanel(value: () => js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("secondPanel")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetFirstPanelSize(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setFirstPanelSize")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetSecondPanelSize(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setSecondPanelSize")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
