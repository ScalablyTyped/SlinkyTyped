...
object IgTreeGridUpdating {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    dataDirty: (/* event */ Event_, /* ui */ DataDirtyEventUIParam) => Unit = null,
    deleteRowLabel: String = null,
    deleteRowTooltip: String = null,
    dialogWidget: String = null,
    doneLabel: String = null,
    doneTooltip: String = null,
    editCellEnded: (/* event */ Event_, /* ui */ EditCellEndedEventUIParam) => Unit = null,
    editCellEnding: (/* event */ Event_, /* ui */ EditCellEndingEventUIParam) => Unit = null,
    editCellStarted: (/* event */ Event_, /* ui */ EditCellStartedEventUIParam) => Unit = null,
    editCellStarting: (/* event */ Event_, /* ui */ EditCellStartingEventUIParam) => Unit = null,
    editMode: String = null,
    editRowEnded: (/* event */ Event_, /* ui */ EditRowEndedEventUIParam) => Unit = null,
    editRowEnding: (/* event */ Event_, /* ui */ EditRowEndingEventUIParam) => Unit = null,
    editRowStarted: (/* event */ Event_, /* ui */ EditRowStartedEventUIParam) => Unit = null,
    editRowStarting: (/* event */ Event_, /* ui */ EditRowStartingEventUIParam) => Unit = null,
    ...
    generatePrimaryKeyValue: (/* event */ Event_, /* ui */ GeneratePrimaryKeyValueEventUIParam) => Unit = null,
    horizontalMoveOnEnter: js.UndefOr[Boolean] = js.undefined,
    inherit: js.UndefOr[Boolean] = js.undefined,
    locale: IgTreeGridUpdatingLocale = null,
    rowAdded: (/* event */ Event_, /* ui */ RowAddedEventUIParam) => Unit = null,
    rowAdding: (/* event */ Event_, /* ui */ RowAddingEventUIParam) => Unit = null,
    rowDeleted: (/* event */ Event_, /* ui */ RowDeletedEventUIParam) => Unit = null,
    rowDeleting: (/* event */ Event_, /* ui */ RowDeletingEventUIParam) => Unit = null,
    rowEditDialogAfterClose: (/* event */ Event_, /* ui */ RowEditDialogAfterCloseEventUIParam) => Unit = null,
    rowEditDialogAfterOpen: (/* event */ Event_, /* ui */ RowEditDialogAfterOpenEventUIParam) => Unit = null,
    rowEditDialogBeforeClose: (/* event */ Event_, /* ui */ RowEditDialogBeforeCloseEventUIParam) => Unit = null,
    rowEditDialogBeforeOpen: (/* event */ Event_, /* ui */ RowEditDialogBeforeOpenEventUIParam) => Unit = null,
    rowEditDialogContentsRendered: (/* event */ Event_, /* ui */ RowEditDialogContentsRenderedEventUIParam) => Unit = null,
