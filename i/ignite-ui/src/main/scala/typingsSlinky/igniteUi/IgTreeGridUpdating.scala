...
object IgTreeGridUpdating {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableAddChild)) __obj.updateDynamic("enableAddChild")(enableAddChild.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableAddRow)) __obj.updateDynamic("enableAddRow")(enableAddRow.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDataDirtyException)) __obj.updateDynamic("enableDataDirtyException")(enableDataDirtyException.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDeleteRow)) __obj.updateDynamic("enableDeleteRow")(enableDeleteRow.get.asInstanceOf[js.Any])
    if (!js.isUndefined(excelNavigationMode)) __obj.updateDynamic("excelNavigationMode")(excelNavigationMode.get.asInstanceOf[js.Any])
    if (generatePrimaryKeyValue != null) __obj.updateDynamic("generatePrimaryKeyValue")(js.Any.fromFunction2(generatePrimaryKeyValue))
    if (!js.isUndefined(horizontalMoveOnEnter)) __obj.updateDynamic("horizontalMoveOnEnter")(horizontalMoveOnEnter.get.asInstanceOf[js.Any])
