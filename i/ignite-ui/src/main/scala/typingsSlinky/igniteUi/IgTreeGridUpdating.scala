...
object IgTreeGridUpdating {
  ...
  implicit class IgTreeGridUpdatingOps[Self <: IgTreeGridUpdating] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnableAddChild(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enableAddChild")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEnableAddChild: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enableAddChild")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLocale(value: IgTreeGridUpdatingLocale): Self = {
        val ret = this.duplicate
