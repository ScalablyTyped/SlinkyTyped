...
object IgGridSummaries {
  ...
  def apply(
    ...
    dropDownDialogAnimationDuration: js.UndefOr[Double] = js.undefined,
    dropDownHeight: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(dropDownDialogAnimationDuration)) __obj.updateDynamic("dropDownDialogAnimationDuration")(dropDownDialogAnimationDuration.get.asInstanceOf[js.Any])
    if (!js.isUndefined(dropDownHeight)) __obj.updateDynamic("dropDownHeight")(dropDownHeight.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showSummariesButton)) __obj.updateDynamic("showSummariesButton")(showSummariesButton.get.asInstanceOf[js.Any])
