...
object IgPercentEditor {
  ...
  def apply(
    ...
    displayFactor: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(displayFactor)) __obj.updateDynamic("displayFactor")(displayFactor.get.asInstanceOf[js.Any])
    ...
    if (percentSymbol != null) __obj.updateDynamic("percentSymbol")(percentSymbol.asInstanceOf[js.Any])
