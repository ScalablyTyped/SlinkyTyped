...
object AppointmentDeletedEventUIParam {
  ...
  implicit class AppointmentDeletedEventUIParamOps[Self <: AppointmentDeletedEventUIParam] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppointmentId(value: js.Any): Self = this.set("appointmentId", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAppointmentId: Self = this.set("appointmentId", js.undefined)
    @scala.inline
