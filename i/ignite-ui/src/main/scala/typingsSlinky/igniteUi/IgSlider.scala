...
object IgSlider {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    bookmarkClick: (/* event */ Event_, /* ui */ BookmarkClickEventUIParam) => Unit = null,
    bookmarkHit: (/* event */ Event_, /* ui */ BookmarkHitEventUIParam) => Unit = null,
    ...
    slide: (/* event */ Event_, /* ui */ SlideEventUIParam) => Unit = null,
    start: (/* event */ Event_, /* ui */ StartEventUIParam) => Unit = null,
    step: Int | Double = null,
    stop: (/* event */ Event_, /* ui */ StopEventUIParam) => Unit = null,
