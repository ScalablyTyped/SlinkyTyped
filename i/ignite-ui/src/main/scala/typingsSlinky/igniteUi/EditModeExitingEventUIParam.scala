...
object EditModeExitingEventUIParam {
  ...
  def apply(
    ...
    if (!js.isUndefined(acceptChanges)) __obj.updateDynamic("acceptChanges")(acceptChanges.get.asInstanceOf[js.Any])
    if (!js.isUndefined(canCancel)) __obj.updateDynamic("canCancel")(canCancel.get.asInstanceOf[js.Any])
