...
object SeriesMouseLeftButtonDownEventUIParam {
  ...
  @scala.inline
  def apply(): SeriesMouseLeftButtonDownEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMouseLeftButtonDownEventUIParam]
  }
  
  @scala.inline
  implicit class SeriesMouseLeftButtonDownEventUIParamMutableBuilder[Self <: SeriesMouseLeftButtonDownEventUIParam] (val x: Self) extends AnyVal {
