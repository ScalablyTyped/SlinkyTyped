...
class OlapXmlaDataSource protected ()
  extends typingsSlinky.igniteUi.Infragistics.OlapXmlaDataSource {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def catalogs(): js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def measureGroups(): js.Array[_] = js.native
  /**
