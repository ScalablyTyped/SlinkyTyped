...
object IgPivotViewDataSourceOptionsXmlaOptionsMdxSettings {
  ...
  @scala.inline
  implicit class IgPivotViewDataSourceOptionsXmlaOptionsMdxSettingsOps[Self <: IgPivotViewDataSourceOptionsXmlaOptionsMdxSettings] (val x: Self) extends AnyVal {
