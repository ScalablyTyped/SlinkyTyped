...
@js.native
trait EditCellEndingEventUIParam extends js.Object {
...
object EditCellEndingEventUIParam {
  ...
  @scala.inline
  implicit class EditCellEndingEventUIParamOps[Self <: EditCellEndingEventUIParam] (val x: Self) extends AnyVal {
