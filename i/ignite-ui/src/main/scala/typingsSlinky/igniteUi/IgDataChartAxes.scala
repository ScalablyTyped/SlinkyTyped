...
object IgDataChartAxes {
  ...
  implicit class IgDataChartAxesMutableBuilder[Self <: IgDataChartAxes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaximumValue(value: Double | js.Date): Self = StObject.set(x, "maximumValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaximumValueDate(value: js.Date): Self = StObject.set(x, "maximumValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaximumValueUndefined: Self = StObject.set(x, "maximumValue", js.undefined)
    
    @scala.inline
    def setMinimumValue(value: Double | js.Date): Self = StObject.set(x, "minimumValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinimumValueDate(value: js.Date): Self = StObject.set(x, "minimumValue", value.asInstanceOf[js.Any])
