...
object IgDataChartAxes {
  ...
  implicit class IgDataChartAxesOps[Self <: IgDataChartAxes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaximumValueDate(value: js.Date): Self = this.set("maximumValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaximumValue(value: Double | js.Date): Self = this.set("maximumValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaximumValue: Self = this.set("maximumValue", js.undefined)
    
    @scala.inline
    def setMinimumValueDate(value: js.Date): Self = this.set("minimumValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinimumValue(value: Double | js.Date): Self = this.set("minimumValue", value.asInstanceOf[js.Any])
