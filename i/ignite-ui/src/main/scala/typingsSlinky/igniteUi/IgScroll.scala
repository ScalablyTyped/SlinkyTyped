...
object IgScroll {
  ...
  def apply(
    ...
    bigIncrementStep: js.UndefOr[Double] = js.undefined,
    inertiaDeltaX: js.UndefOr[Double] = js.undefined,
    inertiaDeltaY: js.UndefOr[Double] = js.undefined,
    ...
    smallIncrementStep: js.UndefOr[Double] = js.undefined,
    ...
    swipeToleranceX: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(bigIncrementStep)) __obj.updateDynamic("bigIncrementStep")(bigIncrementStep.get.asInstanceOf[js.Any])
    if (!js.isUndefined(inertiaDeltaX)) __obj.updateDynamic("inertiaDeltaX")(inertiaDeltaX.get.asInstanceOf[js.Any])
    if (!js.isUndefined(inertiaDeltaY)) __obj.updateDynamic("inertiaDeltaY")(inertiaDeltaY.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(modifyDOM)) __obj.updateDynamic("modifyDOM")(modifyDOM.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(scrollOnlyHBar)) __obj.updateDynamic("scrollOnlyHBar")(scrollOnlyHBar.get.asInstanceOf[js.Any])
    if (!js.isUndefined(scrollOnlyVBar)) __obj.updateDynamic("scrollOnlyVBar")(scrollOnlyVBar.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(smallIncrementStep)) __obj.updateDynamic("smallIncrementStep")(smallIncrementStep.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(swipeToleranceX)) __obj.updateDynamic("swipeToleranceX")(swipeToleranceX.get.asInstanceOf[js.Any])
