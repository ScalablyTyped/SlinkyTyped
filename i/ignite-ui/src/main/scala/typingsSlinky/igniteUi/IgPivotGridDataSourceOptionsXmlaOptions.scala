...
object IgPivotGridDataSourceOptionsXmlaOptions {
  ...
  implicit class IgPivotGridDataSourceOptionsXmlaOptionsOps[Self <: IgPivotGridDataSourceOptionsXmlaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMdxSettings(value: IgPivotGridDataSourceOptionsXmlaOptionsMdxSettings): Self = this.set("mdxSettings", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestOptions(value: IgPivotGridDataSourceOptionsXmlaOptionsRequestOptions): Self = this.set("requestOptions", value.asInstanceOf[js.Any])
