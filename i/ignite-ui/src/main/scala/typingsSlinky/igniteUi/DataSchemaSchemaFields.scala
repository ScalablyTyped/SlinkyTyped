...
object DataSchemaSchemaFields {
  ...
  implicit class DataSchemaSchemaFieldsMutableBuilder[Self <: DataSchemaSchemaFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | Double | Boolean | js.Date | js.Object): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTypeDate(value: js.Date): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
