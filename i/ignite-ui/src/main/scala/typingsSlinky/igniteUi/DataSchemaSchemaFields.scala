...
object DataSchemaSchemaFields {
  ...
  implicit class DataSchemaSchemaFieldsOps[Self <: DataSchemaSchemaFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeDate(value: js.Date): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setType(value: String | Double | Boolean | js.Date | js.Object): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
