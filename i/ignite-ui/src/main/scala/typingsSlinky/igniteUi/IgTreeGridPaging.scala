...
object IgTreeGridPaging {
  ...
  implicit class IgTreeGridPagingOps[Self <: IgTreeGridPaging] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBreadcrumbDelimiter(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("breadcrumbDelimiter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBreadcrumbDelimiter: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("breadcrumbDelimiter")(js.undefined)
        ret
    }
    @scala.inline
    def withBreadcrumbKey(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("breadcrumbKey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBreadcrumbKey: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("breadcrumbKey")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withContextRowRendered(value: (/* event */ Event_, /* ui */ ContextRowRenderedEventUIParam) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contextRowRendered")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutContextRowRendered: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contextRowRendered")(js.undefined)
        ret
    }
    @scala.inline
    def withContextRowRendering(value: (/* event */ Event_, /* ui */ ContextRowRenderingEventUIParam) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contextRowRendering")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutContextRowRendering: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contextRowRendering")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLocale(value: IgTreeGridPagingLocale): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRenderContextRowFunc(value: js.Function | String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renderContextRowFunc")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRenderContextRowFunc: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renderContextRowFunc")(js.undefined)
        ret
    }
    @scala.inline
