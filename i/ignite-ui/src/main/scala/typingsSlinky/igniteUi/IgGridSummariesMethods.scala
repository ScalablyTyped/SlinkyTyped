...
object IgGridSummariesMethods {
  ...
  implicit class IgGridSummariesMethodsOps[Self <: IgGridSummariesMethods] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCalculateSummaries(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("calculateSummaries")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCalculateSummaryColumn(value: (String, js.Array[_], js.Object, js.Object) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("calculateSummaryColumn")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withChangeRegional(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changeRegional")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withClearAllFooterIcons(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearAllFooterIcons")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsSummariesRowsHidden(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isSummariesRowsHidden")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSelectCheckBox(value: (js.Object, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectCheckBox")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withShowHideDialog(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showHideDialog")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSummariesFor(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("summariesFor")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSummaryCollection(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("summaryCollection")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withToggleCheckstate(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("toggleCheckstate")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withToggleDropDown(value: (String, js.Object) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("toggleDropDown")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withToggleSummariesRows(value: (Boolean, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("toggleSummariesRows")(js.Any.fromFunction2(value))
        ret
    }
  }
