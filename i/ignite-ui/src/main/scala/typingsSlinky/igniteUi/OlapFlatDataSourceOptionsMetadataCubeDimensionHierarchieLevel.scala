...
object OlapFlatDataSourceOptionsMetadataCubeDimensionHierarchieLevel {
  ...
  @scala.inline
  implicit class OlapFlatDataSourceOptionsMetadataCubeDimensionHierarchieLevelOps[Self <: OlapFlatDataSourceOptionsMetadataCubeDimensionHierarchieLevel] (val x: Self) extends AnyVal {
    @scala.inline
