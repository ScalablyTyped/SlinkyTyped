...
object IgPivotViewDataSourceOptions {
  ...
  @scala.inline
  implicit class IgPivotViewDataSourceOptionsOps[Self <: IgPivotViewDataSourceOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFlatDataOptions(value: IgPivotViewDataSourceOptionsFlatDataOptions): Self = this.set("flatDataOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setXmlaOptions(value: IgPivotViewDataSourceOptionsXmlaOptions): Self = this.set("xmlaOptions", value.asInstanceOf[js.Any])
