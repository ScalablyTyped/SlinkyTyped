...
object IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCube {
  ...
  implicit class IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeOps[Self <: IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCube] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDimensions(value: js.Array[IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimension]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMeasuresDimension(value: IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeMeasuresDimension): Self = {
        val ret = this.duplicate
