...
@js.native
trait SeriesMouseLeaveEventUIParam extends js.Object {
  /**
...
object SeriesMouseLeaveEventUIParam {
  @scala.inline
  def apply(): SeriesMouseLeaveEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMouseLeaveEventUIParam]
  }
  @scala.inline
  implicit class SeriesMouseLeaveEventUIParamOps[Self <: SeriesMouseLeaveEventUIParam] (val x: Self) extends AnyVal {
    @scala.inline
