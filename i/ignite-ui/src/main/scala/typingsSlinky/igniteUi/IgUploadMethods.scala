...
object IgUploadMethods {
  ...
  implicit class IgUploadMethodsOps[Self <: IgUploadMethods] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddDataField(value: (js.Object, js.Object) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addDataField")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withAddDataFields(value: (js.Object, js.Array[_]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addDataFields")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withCancelUpload(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cancelUpload")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetFileInfo(value: Double => js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFileInfo")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetFileInfoData(value: () => js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFileInfoData")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withStartUpload(value: Double => Unit): Self = {
        val ret = this.duplicate
