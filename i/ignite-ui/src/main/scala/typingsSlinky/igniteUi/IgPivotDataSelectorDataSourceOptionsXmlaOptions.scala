...
/* optionName */ StringDictionary[js.Any] {
  ...
  /**
  	 ...
  	 */
  var mdxSettings: js.UndefOr[IgPivotDataSelectorDataSourceOptionsXmlaOptionsMdxSettings] = js.native
  /**
  ...
  /**
  	 ...
  	 */
  var requestOptions: js.UndefOr[IgPivotDataSelectorDataSourceOptionsXmlaOptionsRequestOptions] = js.native
  /**
...
object IgPivotDataSelectorDataSourceOptionsXmlaOptions {
  @scala.inline
  def apply(): IgPivotDataSelectorDataSourceOptionsXmlaOptions = {
  ...
  implicit class IgPivotDataSelectorDataSourceOptionsXmlaOptionsOps[Self <: IgPivotDataSelectorDataSourceOptionsXmlaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMdxSettings(value: IgPivotDataSelectorDataSourceOptionsXmlaOptionsMdxSettings): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRequestOptions(value: IgPivotDataSelectorDataSourceOptionsXmlaOptionsRequestOptions): Self = {
        val ret = this.duplicate
