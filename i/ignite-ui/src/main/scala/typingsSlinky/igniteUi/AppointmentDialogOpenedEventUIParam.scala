...
object AppointmentDialogOpenedEventUIParam {
  @scala.inline
  def apply(element: js.Any = null, isAppointmentNew: js.UndefOr[Boolean] = js.undefined, owner: js.Any = null): AppointmentDialogOpenedEventUIParam = {
    val __obj = js.Dynamic.literal()
    if (element != null) __obj.updateDynamic("element")(element.asInstanceOf[js.Any])
    if (!js.isUndefined(isAppointmentNew)) __obj.updateDynamic("isAppointmentNew")(isAppointmentNew.get.asInstanceOf[js.Any])
