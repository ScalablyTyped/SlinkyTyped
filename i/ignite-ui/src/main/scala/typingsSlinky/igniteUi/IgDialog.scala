...
object IgDialog {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableHeaderFocus)) __obj.updateDynamic("enableHeaderFocus")(enableHeaderFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(pinOnMinimized)) __obj.updateDynamic("pinOnMinimized")(pinOnMinimized.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showMaximizeButton)) __obj.updateDynamic("showMaximizeButton")(showMaximizeButton.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showMinimizeButton)) __obj.updateDynamic("showMinimizeButton")(showMinimizeButton.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showPinButton)) __obj.updateDynamic("showPinButton")(showPinButton.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(trackFocus)) __obj.updateDynamic("trackFocus")(trackFocus.get.asInstanceOf[js.Any])
