...
object IgPieChart {
  ...
  def apply(
    ...
    explodedRadius: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(explodedRadius)) __obj.updateDynamic("explodedRadius")(explodedRadius.get.asInstanceOf[js.Any])
