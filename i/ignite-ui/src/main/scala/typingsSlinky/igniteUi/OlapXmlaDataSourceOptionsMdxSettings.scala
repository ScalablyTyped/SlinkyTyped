...
object OlapXmlaDataSourceOptionsMdxSettings {
  ...
  @scala.inline
  def apply(): OlapXmlaDataSourceOptionsMdxSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OlapXmlaDataSourceOptionsMdxSettings]
  }
  
  @scala.inline
  implicit class OlapXmlaDataSourceOptionsMdxSettingsMutableBuilder[Self <: OlapXmlaDataSourceOptionsMdxSettings] (val x: Self) extends AnyVal {
