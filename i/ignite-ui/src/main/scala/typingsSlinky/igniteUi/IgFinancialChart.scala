...
object IgFinancialChart {
  ...
  def apply(
    ...
    indicatorLongPeriod: js.UndefOr[Double] = js.undefined,
    indicatorMenuTemplate: js.Any = null,
    indicatorMultiplier: js.UndefOr[Double] = js.undefined,
    indicatorNegativeBrushes: js.Any = null,
    indicatorPeriod: js.UndefOr[Double] = js.undefined,
    indicatorShortPeriod: js.UndefOr[Double] = js.undefined,
    indicatorSignalPeriod: js.UndefOr[Double] = js.undefined,
    indicatorSmoothingPeriod: js.UndefOr[Double] = js.undefined,
    indicatorThickness: js.UndefOr[Double] = js.undefined,
    ...
    overlayThickness: js.UndefOr[Double] = js.undefined,
    ...
    toolbarHeight: js.UndefOr[Double] = js.undefined,
    ...
    volumeThickness: js.UndefOr[Double] = js.undefined,
    ...
    zoomSliderXAxisMajorStrokeThickness: js.UndefOr[Double] = js.undefined
  ): IgFinancialChart = {
    ...
    if (!js.isUndefined(indicatorLongPeriod)) __obj.updateDynamic("indicatorLongPeriod")(indicatorLongPeriod.get.asInstanceOf[js.Any])
    if (indicatorMenuTemplate != null) __obj.updateDynamic("indicatorMenuTemplate")(indicatorMenuTemplate.asInstanceOf[js.Any])
    if (!js.isUndefined(indicatorMultiplier)) __obj.updateDynamic("indicatorMultiplier")(indicatorMultiplier.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(indicatorPeriod)) __obj.updateDynamic("indicatorPeriod")(indicatorPeriod.get.asInstanceOf[js.Any])
    if (!js.isUndefined(indicatorShortPeriod)) __obj.updateDynamic("indicatorShortPeriod")(indicatorShortPeriod.get.asInstanceOf[js.Any])
    if (!js.isUndefined(indicatorSignalPeriod)) __obj.updateDynamic("indicatorSignalPeriod")(indicatorSignalPeriod.get.asInstanceOf[js.Any])
    if (!js.isUndefined(indicatorSmoothingPeriod)) __obj.updateDynamic("indicatorSmoothingPeriod")(indicatorSmoothingPeriod.get.asInstanceOf[js.Any])
    if (!js.isUndefined(indicatorThickness)) __obj.updateDynamic("indicatorThickness")(indicatorThickness.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isLegendVisible)) __obj.updateDynamic("isLegendVisible")(isLegendVisible.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isToolbarVisible)) __obj.updateDynamic("isToolbarVisible")(isToolbarVisible.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isWindowSyncedToVisibleRange)) __obj.updateDynamic("isWindowSyncedToVisibleRange")(isWindowSyncedToVisibleRange.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(overlayThickness)) __obj.updateDynamic("overlayThickness")(overlayThickness.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(toolbarHeight)) __obj.updateDynamic("toolbarHeight")(toolbarHeight.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(volumeThickness)) __obj.updateDynamic("volumeThickness")(volumeThickness.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(zoomSliderXAxisMajorStrokeThickness)) __obj.updateDynamic("zoomSliderXAxisMajorStrokeThickness")(zoomSliderXAxisMajorStrokeThickness.get.asInstanceOf[js.Any])
