...
object IgTree {
  ...
  def apply(
    ...
    if (!js.isUndefined(hotTracking)) __obj.updateDynamic("hotTracking")(hotTracking.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(singleBranchExpand)) __obj.updateDynamic("singleBranchExpand")(singleBranchExpand.get.asInstanceOf[js.Any])
