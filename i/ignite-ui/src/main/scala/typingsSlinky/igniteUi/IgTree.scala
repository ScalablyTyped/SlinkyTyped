...
object IgTree {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    locale: js.Any = null,
    nodeCheckstateChanged: (/* event */ Event_, /* ui */ NodeCheckstateChangedEventUIParam) => Unit = null,
    nodeCheckstateChanging: (/* event */ Event_, /* ui */ NodeCheckstateChangingEventUIParam) => Unit = null,
    nodeClick: (/* event */ Event_, /* ui */ NodeClickEventUIParam) => Unit = null,
    nodeCollapsed: (/* event */ Event_, /* ui */ NodeCollapsedEventUIParam) => Unit = null,
    nodeCollapsing: (/* event */ Event_, /* ui */ NodeCollapsingEventUIParam) => Unit = null,
    nodeDoubleClick: (/* event */ Event_, /* ui */ NodeDoubleClickEventUIParam) => Unit = null,
    nodeDropped: (/* event */ Event_, /* ui */ NodeDroppedEventUIParam) => Unit = null,
    nodeDropping: (/* event */ Event_, /* ui */ NodeDroppingEventUIParam) => Unit = null,
    nodeExpanded: (/* event */ Event_, /* ui */ NodeExpandedEventUIParam) => Unit = null,
    nodeExpanding: (/* event */ Event_, /* ui */ NodeExpandingEventUIParam) => Unit = null,
    nodePopulated: (/* event */ Event_, /* ui */ NodePopulatedEventUIParam) => Unit = null,
    nodePopulating: (/* event */ Event_, /* ui */ NodePopulatingEventUIParam) => Unit = null,
    ...
    selectionChanged: (/* event */ Event_, /* ui */ IgTreeSelectionChangedEventUIParam) => Unit = null,
