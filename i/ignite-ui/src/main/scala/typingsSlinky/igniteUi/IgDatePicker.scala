...
object IgDatePicker {
  ...
  implicit class IgDatePickerOps[Self <: IgDatePicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxValue(value: js.Date): Self = this.set("maxValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaxValue: Self = this.set("maxValue", js.undefined)
    
    @scala.inline
    def setMinValue(value: js.Date): Self = this.set("minValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMinValue: Self = this.set("minValue", js.undefined)
    
    @scala.inline
    def setNullValueDate(value: js.Date): Self = this.set("nullValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNullValue(value: String | Double | js.Date): Self = this.set("nullValue", value.asInstanceOf[js.Any])
