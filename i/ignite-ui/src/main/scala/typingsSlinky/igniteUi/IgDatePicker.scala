...
object IgDatePicker {
  ...
  def apply(
    ...
    itemSelected: (/* event */ Event, /* ui */ ItemSelectedEventUIParam) => Unit = null,
    ...
    maxValue: js.Date = null,
    minValue: js.Date = null,
    nullValue: String | Double | js.Date = null,
    padChar: String = null,
    ...
    yearShift: js.UndefOr[Double] = js.undefined
  ): IgDatePicker = {
    ...
    if (datepickerOptions != null) __obj.updateDynamic("datepickerOptions")(datepickerOptions.asInstanceOf[js.Any])
    ...
    if (itemSelected != null) __obj.updateDynamic("itemSelected")(js.Any.fromFunction2(itemSelected))
    ...
    if (!js.isUndefined(yearShift)) __obj.updateDynamic("yearShift")(yearShift.get.asInstanceOf[js.Any])
