...
object IgDatePicker {
  ...
  implicit class IgDatePickerOps[Self <: IgDatePicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDatepickerOptions(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("datepickerOptions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDatepickerOptions: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("datepickerOptions")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withItemSelected(value: (/* event */ Event_, /* ui */ ItemSelectedEventUIParam) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("itemSelected")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
