...
object IgTimePicker {
  ...
  @scala.inline
  implicit class IgTimePickerMutableBuilder[Self <: IgTimePicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateDisplayFormat(value: js.Any): Self = StObject.set(x, "dateDisplayFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDateDisplayFormatUndefined: Self = StObject.set(x, "dateDisplayFormat", js.undefined)
    
    @scala.inline
    def setDateInputFormat(value: js.Any): Self = StObject.set(x, "dateInputFormat", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsDelta(value: IgTimePickerItemsDelta): Self = StObject.set(x, "itemsDelta", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsDeltaUndefined: Self = StObject.set(x, "itemsDelta", js.undefined)
    ...
    @scala.inline
    def setSpinDelta(value: js.Any): Self = StObject.set(x, "spinDelta", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTimeInputFormat(value: String): Self = StObject.set(x, "timeInputFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTimeInputFormatUndefined: Self = StObject.set(x, "timeInputFormat", js.undefined)
    ...
    @scala.inline
    def setYearShift(value: js.Any): Self = StObject.set(x, "yearShift", value.asInstanceOf[js.Any])
