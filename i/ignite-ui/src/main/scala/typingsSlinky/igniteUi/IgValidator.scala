...
object IgValidator {
  ...
  def apply(
    ...
    if (!js.isUndefined(executeAllRules)) __obj.updateDynamic("executeAllRules")(executeAllRules.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(onblur)) __obj.updateDynamic("onblur")(onblur.get.asInstanceOf[js.Any])
    if (!js.isUndefined(onchange)) __obj.updateDynamic("onchange")(onchange.get.asInstanceOf[js.Any])
    if (!js.isUndefined(onsubmit)) __obj.updateDynamic("onsubmit")(onsubmit.get.asInstanceOf[js.Any])
    if (!js.isUndefined(optionalIndication)) __obj.updateDynamic("optionalIndication")(optionalIndication.get.asInstanceOf[js.Any])
    if (pattern != null) __obj.updateDynamic("pattern")(pattern.asInstanceOf[js.Any])
    if (regional != null) __obj.updateDynamic("regional")(regional.asInstanceOf[js.Any])
    if (required != null) __obj.updateDynamic("required")(required.asInstanceOf[js.Any])
    if (!js.isUndefined(requiredIndication)) __obj.updateDynamic("requiredIndication")(requiredIndication.get.asInstanceOf[js.Any])
