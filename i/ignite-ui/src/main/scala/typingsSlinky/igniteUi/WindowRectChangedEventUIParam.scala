...
object WindowRectChangedEventUIParam {
  ...
  @scala.inline
  def apply(): WindowRectChangedEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WindowRectChangedEventUIParam]
  }
  
  @scala.inline
  implicit class WindowRectChangedEventUIParamMutableBuilder[Self <: WindowRectChangedEventUIParam] (val x: Self) extends AnyVal {
