...
trait SuccessHiddenEventUIParam extends js.Object {
  /**
...
object SuccessHiddenEventUIParam {
  @scala.inline
  def apply(fieldOptions: js.Any = null, message: String = null, owner: js.Any = null, target: String = null): SuccessHiddenEventUIParam = {
