...
trait Anon_DayMonth extends js.Object {
  var day: String
  var month: String
  var weekday: String
  var year: String
...
object Anon_DayMonth {
  @scala.inline
  def apply(day: String, month: String, weekday: String, year: String): Anon_DayMonth = {
    ...
    __obj.asInstanceOf[Anon_DayMonth]
  }
}
