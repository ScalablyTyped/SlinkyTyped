...
trait AnonDate extends js.Object {
  var date: AnonFull = js.native
  var number: AnonCurrency = js.native
  var time: AnonLong = js.native
}
...
object AnonDate {
  ...
  implicit class AnonDateOps[Self <: AnonDate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDate(value: AnonFull): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("date")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNumber(value: AnonCurrency): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("number")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTime(value: AnonLong): Self = {
        val ret = this.duplicate
