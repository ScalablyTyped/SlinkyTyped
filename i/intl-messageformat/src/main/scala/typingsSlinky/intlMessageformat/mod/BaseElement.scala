...
object BaseElement {
  @scala.inline
  def apply[/* <: typingsSlinky.intlMessageformat.mod.TYPE */ T](`type`: T, value: String): BaseElement[T] = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[BaseElement[T]]
  }
  @scala.inline
  implicit class BaseElementOps[Self <: BaseElement[_], /* <: typingsSlinky.intlMessageformat.mod.TYPE */ T] (val x: Self with BaseElement[T]) extends AnyVal {
    @scala.inline
