...
import typingsSlinky.intlMessageformat.anon.TypeofDateTimeFormat
import typingsSlinky.intlMessageformat.anon.TypeofNumberFormat
import typingsSlinky.intlMessageformat.anon.TypeofPluralRules
...
object srcFormattersMod {
  ...
  */
  ...
  object MessageFormatPart {
    ...
    @scala.inline
    def LiteralPart(`type`: `0`, value: String): typingsSlinky.intlMessageformat.srcFormattersMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.intlMessageformat.srcFormattersMod.LiteralPart]
    }
    
    @scala.inline
    def ObjectPart[T](`type`: `1`, value: T): typingsSlinky.intlMessageformat.srcFormattersMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.intlMessageformat.srcFormattersMod.ObjectPart[T]]
    }
  }
