...
object formattersMod {
  ...
  */
  ...
  object MessageFormatPart {
    ...
    @scala.inline
    def LiteralPart(`type`: `0`, value: String): typingsSlinky.intlMessageformat.formattersMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.intlMessageformat.formattersMod.LiteralPart]
    }
    
    @scala.inline
    def ObjectPart[T](`type`: `1`, value: T): typingsSlinky.intlMessageformat.formattersMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.intlMessageformat.formattersMod.ObjectPart[T]]
    }
  }
