...
import typingsSlinky.inversifyDashExpressDashUtils.Anon_AuthProvider
import typingsSlinky.inversifyDashExpressDashUtils.dtsInterfacesMod.interfaces.RoutingConfig
...
class InversifyExpressServer protected ()
  extends typingsSlinky.inversifyDashExpressDashUtils.dtsServerMod.InversifyExpressServer {
  /**
