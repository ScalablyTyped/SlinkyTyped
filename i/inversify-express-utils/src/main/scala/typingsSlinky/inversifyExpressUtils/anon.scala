...
import typingsSlinky.inversifyExpressUtils.interfacesMod.interfaces.AuthProvider
...
object anon {
  ...
  object ControllerMetadata {
    ...
    implicit class ControllerMetadataMutableBuilder[Self <: ControllerMetadata] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setControllerMetadata(value: typingsSlinky.inversifyExpressUtils.interfacesMod.interfaces.ControllerMetadata): Self = StObject.set(x, "controllerMetadata", value.asInstanceOf[js.Any])
