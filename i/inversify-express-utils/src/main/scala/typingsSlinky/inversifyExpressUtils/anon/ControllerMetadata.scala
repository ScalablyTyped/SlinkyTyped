...
object ControllerMetadata {
  ...
  implicit class ControllerMetadataOps[Self <: ControllerMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setControllerMetadata(value: typingsSlinky.inversifyExpressUtils.interfacesMod.interfaces.ControllerMetadata): Self = this.set("controllerMetadata", value.asInstanceOf[js.Any])
