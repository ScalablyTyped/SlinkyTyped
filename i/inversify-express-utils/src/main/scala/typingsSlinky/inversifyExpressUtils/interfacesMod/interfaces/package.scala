...
package object interfaces {
  ...
  type Middleware = typingsSlinky.inversify.interfacesMod.interfaces.ServiceIdentifier[js.Any] | typingsSlinky.express.mod.RequestHandler[typingsSlinky.expressServeStaticCore.mod.ParamsDictionary]
}
