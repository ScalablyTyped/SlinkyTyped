...
object constantsMod {
  ...
  object PARAMETER_TYPE extends StObject {
    ...
    /* 4 */ val BODY: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.BODY with Double = js.native
    
    @js.native
    sealed trait COOKIES extends PARAMETER_TYPE
    /* 6 */ val COOKIES: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.COOKIES with Double = js.native
    
    @js.native
    sealed trait HEADERS extends PARAMETER_TYPE
    /* 5 */ val HEADERS: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.HEADERS with Double = js.native
    
    @js.native
    sealed trait NEXT extends PARAMETER_TYPE
    /* 7 */ val NEXT: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.NEXT with Double = js.native
    
    @js.native
    sealed trait PARAMS extends PARAMETER_TYPE
    /* 2 */ val PARAMS: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.PARAMS with Double = js.native
    
    @js.native
    sealed trait PRINCIPAL extends PARAMETER_TYPE
    /* 8 */ val PRINCIPAL: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.PRINCIPAL with Double = js.native
    
    @js.native
    sealed trait QUERY extends PARAMETER_TYPE
    /* 3 */ val QUERY: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.QUERY with Double = js.native
    
    @js.native
    sealed trait REQUEST extends PARAMETER_TYPE
    /* 0 */ val REQUEST: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.REQUEST with Double = js.native
    
    @js.native
    sealed trait RESPONSE extends PARAMETER_TYPE
    /* 1 */ val RESPONSE: typingsSlinky.inversifyExpressUtils.constantsMod.PARAMETER_TYPE.RESPONSE with Double = js.native
  }
