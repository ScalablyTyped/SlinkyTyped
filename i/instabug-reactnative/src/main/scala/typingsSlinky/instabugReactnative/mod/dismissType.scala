...
object dismissType extends StObject {
  ...
  /* 2 */ val addAttachment: typingsSlinky.instabugReactnative.mod.dismissType.addAttachment with Double = js.native
  
  @js.native
  sealed trait cancel extends dismissType
  /* 1 */ val cancel: typingsSlinky.instabugReactnative.mod.dismissType.cancel with Double = js.native
  
  @js.native
  sealed trait submit extends dismissType
  /* 0 */ val submit: typingsSlinky.instabugReactnative.mod.dismissType.submit with Double = js.native
}
