...
object reproStepsMode extends StObject {
  ...
  /* 1 */ val disabled: typingsSlinky.instabugReactnative.mod.reproStepsMode.disabled with Double = js.native
  
  @js.native
  sealed trait enabled extends reproStepsMode
  /* 0 */ val enabled: typingsSlinky.instabugReactnative.mod.reproStepsMode.enabled with Double = js.native
  
  @js.native
  sealed trait enabledWithNoScreenshots extends reproStepsMode
  /* 2 */ val enabledWithNoScreenshots: typingsSlinky.instabugReactnative.mod.reproStepsMode.enabledWithNoScreenshots with Double = js.native
}
