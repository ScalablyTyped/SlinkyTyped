...
object floatingButtonEdge extends StObject {
  ...
  /* 0 */ val left: typingsSlinky.instabugReactnative.mod.floatingButtonEdge.left with Double = js.native
  
  @js.native
  sealed trait right extends floatingButtonEdge
  /* 1 */ val right: typingsSlinky.instabugReactnative.mod.floatingButtonEdge.right with Double = js.native
}
