...
object IScrollOptions {
  ...
  implicit class IScrollOptionsOps[Self <: IScrollOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreventDefaultExceptionVarargs(value: js.RegExp*): Self = this.set("preventDefaultException", js.Array(value :_*))
    @scala.inline
    def setPreventDefaultException(value: js.Array[js.RegExp] | js.Object): Self = this.set("preventDefaultException", value.asInstanceOf[js.Any])
    @scala.inline
