...
trait PostLoadHook extends js.Object {
  var postLoadHook: js.UndefOr[typingsSlinky.istanbulMiddleware.mod.PostLoadHook] = js.undefined
...
object PostLoadHook {
  @scala.inline
  def apply(
    postLoadHook: (/* matcherfn */ typingsSlinky.istanbulMiddleware.mod.Matcher, /* transformer */ js.Any, /* verbose */ Boolean) => PostLoadHookFn = null,
