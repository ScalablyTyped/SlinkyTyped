...
import typingsSlinky.iobroker.iobrokerStrings.metaDotfolder
import typingsSlinky.iobroker.iobrokerStrings.metaDotuser
...
@js.native
trait PartialMetaCommon extends js.Object {
...
object PartialMetaCommon {
  ...
  @scala.inline
  implicit class PartialMetaCommonOps[Self <: PartialMetaCommon] (val x: Self) extends AnyVal {
