...
object Acl {
  @scala.inline
  def apply[/* <: typingsSlinky.iobroker.mod.global.ioBroker.AnyObject */ T](): Acl[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Acl[T]]
  }
  @scala.inline
  implicit class AclOps[Self <: Acl[_], /* <: typingsSlinky.iobroker.mod.global.ioBroker.AnyObject */ T] (val x: Self with Acl[T]) extends AnyVal {
    @scala.inline
