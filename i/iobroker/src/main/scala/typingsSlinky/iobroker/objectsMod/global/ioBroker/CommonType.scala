...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.iobroker.iobrokerStrings.number
  - typingsSlinky.iobroker.iobrokerStrings.string
  - typingsSlinky.iobroker.iobrokerStrings.boolean
  - typingsSlinky.iobroker.iobrokerStrings.array
  - typingsSlinky.iobroker.iobrokerStrings.`object`
  - typingsSlinky.iobroker.iobrokerStrings.mixed
  - typingsSlinky.iobroker.iobrokerStrings.file
*/
