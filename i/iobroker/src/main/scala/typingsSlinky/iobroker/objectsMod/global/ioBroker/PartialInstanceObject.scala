...
import typingsSlinky.iobroker.anon.PartialInstanceCommon
...
object PartialInstanceObject {
  ...
  @scala.inline
  implicit class PartialInstanceObjectOps[Self <: PartialInstanceObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialInstanceCommon): Self = this.set("common", value.asInstanceOf[js.Any])
