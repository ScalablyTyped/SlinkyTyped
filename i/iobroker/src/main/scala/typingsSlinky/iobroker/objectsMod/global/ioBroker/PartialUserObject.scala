...
import typingsSlinky.iobroker.anon.PartialUserCommon
...
/* Inlined parent std.Partial<std.Omit<iobroker.iobroker/objects.<global>.ioBroker.UserObject, 'common'>> */
@js.native
trait PartialUserObject extends PartialObject {
  
  var _id: js.UndefOr[String] = js.native
  
  var acl: js.UndefOr[ObjectACL] = js.native
  
  var common: js.UndefOr[PartialUserCommon] = js.native
  ...
  var `type`: js.UndefOr[user] = js.native
  
  var user: js.UndefOr[String] = js.native
}
object PartialUserObject {
  
  @scala.inline
  def apply(): PartialUserObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialUserObject]
  }
  
  @scala.inline
  implicit class PartialUserObjectMutableBuilder[Self <: PartialUserObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialUserCommon): Self = StObject.set(x, "common", value.asInstanceOf[js.Any])
