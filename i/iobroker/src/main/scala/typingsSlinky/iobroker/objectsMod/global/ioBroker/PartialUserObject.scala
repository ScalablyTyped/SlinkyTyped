...
object PartialUserObject {
  ...
  @scala.inline
  implicit class PartialUserObjectOps[Self <: PartialUserObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialUserCommon): Self = this.set("common", value.asInstanceOf[js.Any])
