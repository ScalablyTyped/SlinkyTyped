...
import typingsSlinky.iobroker.mod._Global_.ioBroker.ObjectACL
import typingsSlinky.iobroker.mod._Global_.ioBroker.ObjectField
import typingsSlinky.iobroker.mod._Global_.ioBroker.OtherCommon
...
/* Inlined iobroker.iobroker._Global_.ioBroker.SettableObjectWorker<iobroker.iobroker._Global_.ioBroker.OtherObject> */
@js.native
