...
import typingsSlinky.iobroker.mod._Global_.ioBroker.DeviceCommon
...
/* Inlined iobroker.iobroker._Global_.ioBroker.SettableObjectWorker<iobroker.iobroker._Global_.ioBroker.DeviceObject> */
@js.native
