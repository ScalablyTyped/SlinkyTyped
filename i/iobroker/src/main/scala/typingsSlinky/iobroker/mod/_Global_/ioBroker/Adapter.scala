...
trait Adapter extends js.Object {
  ...
  /**
    ...
    */
  def chmodFile(adapter: String, path: String, options: AnonMode, callback: ChownFileCallback): Unit = js.native
  def chmodFile(adapter: String, path: String, options: Record[String, _], callback: ChownFileCallback): Unit = js.native
  def chmodFile(adapter: Null, path: String, options: AnonMode, callback: ChownFileCallback): Unit = js.native
  def chmodFile(adapter: Null, path: String, options: Record[String, _], callback: ChownFileCallback): Unit = js.native
  def chmodFileAsync(adapter: String, path: String, options: AnonMode): js.Promise[AnonEntries] = js.native
  def chmodFileAsync(adapter: String, path: String, options: Record[String, _]): js.Promise[AnonEntries] = js.native
  def chmodFileAsync(adapter: Null, path: String, options: AnonMode): js.Promise[AnonEntries] = js.native
  def chmodFileAsync(adapter: Null, path: String, options: Record[String, _]): js.Promise[AnonEntries] = js.native
  ...
  def createDeviceAsync(deviceName: String, common: PartialObjectCommon): js.Promise[NonNullCallbackReturnTypeOf[SetObjectCallback]] = js.native
  def createDeviceAsync(deviceName: String, common: PartialObjectCommon, native: Record[String, _]): js.Promise[NonNullCallbackReturnTypeOf[SetObjectCallback]] = js.native
  def createDeviceAsync(deviceName: String, common: PartialObjectCommon, native: Record[String, _], options: js.Any): js.Promise[NonNullCallbackReturnTypeOf[SetObjectCallback]] = js.native
  /**
  ...
  /** Returns the enum tree, filtered by the optional enum name */
  def getEnumAsync(name: String): js.Promise[AnonRequestEnum] = js.native
  def getEnumAsync(name: String, options: js.Any): js.Promise[AnonRequestEnum] = js.native
  /** Returns the enum tree, filtered by the optional enum name */
  ...
  def idToDCS(id: String): AnonChannel = js.native
  ...
  def readFileAsync(adapterName: String, path: String): js.Promise[AnonFile] = js.native
  def readFileAsync(adapterName: String, path: String, options: js.Any): js.Promise[AnonFile] = js.native
  def readFileAsync(adapterName: Null, path: String): js.Promise[AnonFile] = js.native
  def readFileAsync(adapterName: Null, path: String, options: js.Any): js.Promise[AnonFile] = js.native
