...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.iobroker.SettableObjectWorkerState
  - typingsSlinky.iobroker.SettableObjectWorkerChann
  - typingsSlinky.iobroker.SettableObjectWorkerDevic
  - typingsSlinky.iobroker.SettableObjectWorkerFolde
  - typingsSlinky.iobroker.SettableObjectWorkerOther
*/
