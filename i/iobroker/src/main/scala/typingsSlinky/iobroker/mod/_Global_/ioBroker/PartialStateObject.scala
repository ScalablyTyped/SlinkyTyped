...
/* Inlined parent std.Partial<std.Omit<iobroker.iobroker._Global_.ioBroker.StateObject, 'common' | 'acl'>> */
@js.native
...
object PartialStateObject {
  ...
  implicit class PartialStateObjectOps[Self <: PartialStateObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAcl(value: PartialStateACL): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCommon(value: PartialStateCommon): Self = {
        val ret = this.duplicate
