...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.iobroker.mod._Global_.ioBroker.StateObject
  - typingsSlinky.iobroker.mod._Global_.ioBroker.ChannelObject
  - typingsSlinky.iobroker.mod._Global_.ioBroker.DeviceObject
  - typingsSlinky.iobroker.mod._Global_.ioBroker.FolderObject
  - typingsSlinky.iobroker.mod._Global_.ioBroker.OtherObject
*/
