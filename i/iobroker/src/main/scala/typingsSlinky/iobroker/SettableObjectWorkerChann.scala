...
import typingsSlinky.iobroker.mod._Global_.ioBroker.ChannelCommon
...
/* Inlined iobroker.iobroker._Global_.ioBroker.SettableObjectWorker<iobroker.iobroker._Global_.ioBroker.ChannelObject> */
@js.native
