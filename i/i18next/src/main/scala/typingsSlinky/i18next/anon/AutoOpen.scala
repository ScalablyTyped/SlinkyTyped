...
object AutoOpen {
  ...
  def apply(
    ...
    if (!js.isUndefined(lngOverride)) __obj.updateDynamic("lngOverride")(lngOverride.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(toggleKeyCode)) __obj.updateDynamic("toggleKeyCode")(toggleKeyCode.get.asInstanceOf[js.Any])
