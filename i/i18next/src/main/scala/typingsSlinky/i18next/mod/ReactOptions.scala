...
trait ReactOptions extends StObject {
  ...
  /**
    ...
    * @default 'default'
    */
  var nsMode: js.UndefOr[typingsSlinky.i18next.i18nextStrings.default | fallback] = js.native
...
object ReactOptions {
  ...
  implicit class ReactOptionsMutableBuilder[Self <: ReactOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNsMode(value: typingsSlinky.i18next.i18nextStrings.default | fallback): Self = StObject.set(x, "nsMode", value.asInstanceOf[js.Any])
