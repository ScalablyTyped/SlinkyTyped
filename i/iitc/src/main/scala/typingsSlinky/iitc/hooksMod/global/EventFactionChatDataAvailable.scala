...
@js.native
trait EventFactionChatDataAvailable extends js.Object {
...
object EventFactionChatDataAvailable {
  ...
  @scala.inline
  implicit class EventFactionChatDataAvailableOps[Self <: EventFactionChatDataAvailable] (val x: Self) extends AnyVal {
