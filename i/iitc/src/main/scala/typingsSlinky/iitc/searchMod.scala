    ...
    */
    ...
    object SearchResult {
      ...
      def SearchResultBounds(
        ...
        __obj.asInstanceOf[typingsSlinky.iitc.searchMod.global.SearchResultBounds]
      }
      ...
      def SearchResultPosition(
        ...
        __obj.asInstanceOf[typingsSlinky.iitc.searchMod.global.SearchResultPosition]
      }
    }
    ...
    object SearchResultBase {
      ...
      implicit class SearchResultBaseMutableBuilder[Self <: SearchResultBase] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setDescriptionElement(value: Element): Self = StObject.set(x, "description", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setDescriptionText(value: Text): Self = StObject.set(x, "description", value.asInstanceOf[js.Any])
