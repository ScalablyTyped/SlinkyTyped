...
import typingsSlinky.iabVpaid.iab.vpaid.EventsNames
import typingsSlinky.iabVpaid.iab.vpaid.SimpleEvents
import typingsSlinky.iabVpaid.iab.vpaid.ViewMode
