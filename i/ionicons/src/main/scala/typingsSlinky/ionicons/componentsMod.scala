...
import typingsSlinky.ionicons.stencilPublicRuntimeMod.HTMLStencilElement
...
object componentsMod {
  ...
  object LocalJSX {
    ...
    trait IntrinsicElements extends StObject {
      ...
      var `ion-icon`: typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon = js.native
    }
    object IntrinsicElements {
      
      @scala.inline
      def apply(`ion-icon`: typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon): IntrinsicElements = {
        val __obj = js.Dynamic.literal()
        __obj.updateDynamic("ion-icon")(`ion-icon`.asInstanceOf[js.Any])
      ...
      implicit class IntrinsicElementsMutableBuilder[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def `setIon-icon`(value: typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon): Self = StObject.set(x, "ion-icon", value.asInstanceOf[js.Any])
      }
    }
    ...
    object IonIcon {
      ...
      @scala.inline
      def apply(): typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon]
      }
      
      @scala.inline
      implicit class IonIconMutableBuilder[Self <: typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon] (val x: Self) extends AnyVal {
  ...
  object stencilCoreAugmentingMod {
    ...
    object JSX {
      ...
      trait IntrinsicElements extends StObject {
        ...
        var `ion-icon`: typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon with HTMLAttributes[HTMLIonIconElement] = js.native
      }
      object IntrinsicElements {
        
        @scala.inline
        def apply(
          `ion-icon`: typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon with HTMLAttributes[HTMLIonIconElement]
        ): IntrinsicElements = {
          val __obj = js.Dynamic.literal()
          __obj.updateDynamic("ion-icon")(`ion-icon`.asInstanceOf[js.Any])
          __obj.asInstanceOf[IntrinsicElements]
        ...
        implicit class IntrinsicElementsMutableBuilder[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def `setIon-icon`(
            value: typingsSlinky.ionicons.componentsMod.LocalJSX.IonIcon with HTMLAttributes[HTMLIonIconElement]
          ): Self = StObject.set(x, "ion-icon", value.asInstanceOf[js.Any])
        }
      }
    }
  }
