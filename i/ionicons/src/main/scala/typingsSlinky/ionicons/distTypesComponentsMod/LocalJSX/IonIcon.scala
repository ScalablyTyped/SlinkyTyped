package typingsSlinky.ionicons.distTypesComponentsMod.LocalJSX
...
import typingsSlinky.ionicons.distTypesComponentsMod._Global_.HTMLIonIconElement
import typingsSlinky.ionicons.distTypesStencilDotCoreMod.JSXBase.HTMLAttributes
