...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreVarargs(value: (String | js.RegExp)*): Self = this.set("ignore", js.Array(value :_*))
    
    @scala.inline
    def setIgnoreRegExp(value: js.RegExp): Self = this.set("ignore", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIgnore(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = this.set("ignore", value.asInstanceOf[js.Any])
