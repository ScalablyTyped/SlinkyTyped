...
import typingsSlinky.ionic.anon.OriginalValue
import typingsSlinky.ionic.anon.Property
...
object configBaseMod {
  ...
  */
  ...
  object ConfigContext {
    ...
    @scala.inline
    def GlobalConfigContext(config: IConfig, force: Boolean, global: `true`, json: Boolean, root: Boolean): typingsSlinky.ionic.configBaseMod.GlobalConfigContext = {
      ...
      __obj.asInstanceOf[typingsSlinky.ionic.configBaseMod.GlobalConfigContext]
    }
    
    @scala.inline
    def ProjectConfigContext(config: BaseConfig[IProjectConfig], force: Boolean, global: `false`, json: Boolean, root: Boolean): typingsSlinky.ionic.configBaseMod.ProjectConfigContext = {
      val __obj = js.Dynamic.literal(config = config.asInstanceOf[js.Any], force = force.asInstanceOf[js.Any], global = global.asInstanceOf[js.Any], json = json.asInstanceOf[js.Any], root = root.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.ionic.configBaseMod.ProjectConfigContext]
    }
  }
