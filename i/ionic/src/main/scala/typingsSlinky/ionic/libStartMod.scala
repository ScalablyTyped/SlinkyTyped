...
import typingsSlinky.ionic.anon.Log
...
import typingsSlinky.ionic.definitionsMod.StarterTemplate
...
object libStartMod {
  ...
  */
  ...
  object AppSchema {
    ...
    @scala.inline
    def ClonedAppSchema(cloned: `true`, projectDir: String, projectId: String, url: String): typingsSlinky.ionic.libStartMod.ClonedAppSchema = {
      ...
      __obj.asInstanceOf[typingsSlinky.ionic.libStartMod.ClonedAppSchema]
    }
    ...
    def NewAppSchema(
      ...
      __obj.asInstanceOf[typingsSlinky.ionic.libStartMod.NewAppSchema]
    }
  }
