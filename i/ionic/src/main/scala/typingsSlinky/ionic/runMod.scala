...
object runMod {
  ...
  - typingsSlinky.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/capacitor/run", "RunCommand")
  @js.native
  class RunCommand protected () extends CapacitorCommand {
