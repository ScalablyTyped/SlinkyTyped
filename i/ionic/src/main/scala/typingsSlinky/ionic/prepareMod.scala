...
object prepareMod {
  ...
  - typingsSlinky.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/cordova/prepare", "PrepareCommand")
  @js.native
