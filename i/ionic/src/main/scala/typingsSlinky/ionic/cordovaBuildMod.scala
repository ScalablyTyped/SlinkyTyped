...
object cordovaBuildMod {
  ...
  - typingsSlinky.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/cordova/build", "BuildCommand")
  @js.native
  class BuildCommand protected () extends CordovaCommand {
