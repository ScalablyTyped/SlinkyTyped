...
import typingsSlinky.tar.Anon_Sync
import typingsSlinky.tar.tarMod.CreateOptions
import typingsSlinky.tar.tarMod.ExtractOptions
import typingsSlinky.tar.tarMod.FileOptions
import typingsSlinky.tar.tarMod.HeaderProperties
import typingsSlinky.tar.tarMod.ListOptions
import typingsSlinky.tar.tarMod.PackStream
import typingsSlinky.tar.tarMod.ParseStream
import typingsSlinky.tar.tarMod.ReplaceOptions
