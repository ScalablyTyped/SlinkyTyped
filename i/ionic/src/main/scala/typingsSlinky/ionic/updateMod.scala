...
object updateMod {
  ...
  - typingsSlinky.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/capacitor/update", "UpdateCommand")
  @js.native
