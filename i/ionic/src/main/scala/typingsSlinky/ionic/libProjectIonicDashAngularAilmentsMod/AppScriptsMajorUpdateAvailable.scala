...
import typingsSlinky.ionic.ionicStrings.`app-scripts-major-update-available`
...
class AppScriptsMajorUpdateAvailable () extends IonicAngularAilment {
  ...
  @JSName("id")
  val id_AppScriptsMajorUpdateAvailable: `app-scripts-major-update-available` = js.native
