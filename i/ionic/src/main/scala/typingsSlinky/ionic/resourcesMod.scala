...
object resourcesMod extends js.Object {
  ...
  class ResourcesCommand () extends CordovaCommand {
    ...
    def runCordovaRes(platform: js.UndefOr[String], options: CommandLineOptions): js.Promise[Unit] = js.native
    def runResourceServer(platform: js.UndefOr[String], options: CommandLineOptions): js.Promise[Unit] = js.native
  }
