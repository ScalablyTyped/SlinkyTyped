...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.ionic.ionicStrings.ionic
  - typingsSlinky.ionic.ionicStrings.capacitor
  - typingsSlinky.ionic.ionicStrings.cordova
  - typingsSlinky.ionic.ionicStrings.utility
  - typingsSlinky.ionic.ionicStrings.system
  - typingsSlinky.ionic.ionicStrings.environment
*/
