...
object PaginatorDeps {
  @scala.inline
  def apply[/* <: typingsSlinky.ionic.definitionsMod.Response[js.Array[js.Object]] */ T, S](client: IClient, guard: APIResponseSuccess => /* is T */ Boolean, reqgen: () => js.Promise[Req]): PaginatorDeps[T, S] = {
  ...
  @scala.inline
  implicit class PaginatorDepsOps[Self <: PaginatorDeps[_, _], /* <: typingsSlinky.ionic.definitionsMod.Response[js.Array[js.Object]] */ T, S] (val x: Self with (PaginatorDeps[T, S])) extends AnyVal {
    @scala.inline
