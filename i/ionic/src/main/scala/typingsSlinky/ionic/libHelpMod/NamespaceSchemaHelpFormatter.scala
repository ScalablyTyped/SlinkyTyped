...
class NamespaceSchemaHelpFormatter ()
  extends typingsSlinky.ionicCliFramework.helpMod.NamespaceSchemaHelpFormatter[ICommand, INamespace, CommandMetadata, CommandMetadataInput, CommandMetadataOption]
