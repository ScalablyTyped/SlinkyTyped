...
class CommandStringHelpFormatter protected ()
  extends typingsSlinky.ionicCliFramework.helpMod.CommandStringHelpFormatter[ICommand, INamespace, CommandMetadata, CommandMetadataInput, CommandMetadataOption] {
