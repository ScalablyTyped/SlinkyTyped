package typingsSlinky.atIonicDiscover
...
object atIonicDiscoverMod extends js.Object {
  ...
  class CommServer protected ()
    extends typingsSlinky.atIonicDiscover.distCommMod.CommServer {
    def this(
      namespace: String,
      /**
  ...
  class Publisher protected ()
    extends typingsSlinky.atIonicDiscover.distPublisherMod.Publisher {
  ...
  def newSilentPublisher(namespace: String, name: String, port: Double): typingsSlinky.atIonicDiscover.distPublisherMod.Publisher = js.native
}
