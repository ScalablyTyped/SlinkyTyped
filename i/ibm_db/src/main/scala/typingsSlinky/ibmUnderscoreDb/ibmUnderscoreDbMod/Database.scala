package typingsSlinky.ibmUnderscoreDb.ibmUnderscoreDbMod

import typingsSlinky.ibmUnderscoreDb.Anon_Params
...
class Database () extends Options {
  ...
  def beginTransaction(cb: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]): Unit = js.native
  def beginTransactionSync(): Database = js.native
  def close(): js.Promise[Unit] = js.native
  def close(cb: js.Function2[/* err */ js.Error, /* db */ this.type, _]): Unit = js.native
  ...
  def columns(
    ...
    table: String,
    column: String,
    cb: js.Function2[/* error */ js.Error, /* res */ js.Array[_], Unit]
  ): Unit = js.native
  def columns(
    catalog: String,
    schema: String,
  ...
  def commitTransaction(cb: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]): Unit = js.native
  def commitTransactionSync(): Database = js.native
  def describe(obj: DescribeObject, cb: js.Function2[/* error */ js.Error, /* res */ js.Array[_], Unit]): Unit = js.native
