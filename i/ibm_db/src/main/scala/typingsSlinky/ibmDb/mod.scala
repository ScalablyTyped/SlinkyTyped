...
import typingsSlinky.ibmDb.anon.Outparams
...
object mod {
  ...
  @JSImport("ibm_db", "open")
  @js.native
  def open(connStr: String, options: Options, cb: js.Function2[/* err */ js.Error, /* db */ Database, Unit]): Unit = js.native
  @JSImport("ibm_db", "open")
  @js.native
  def open(connStr: ConnStr): js.Promise[Database] = js.native
  @JSImport("ibm_db", "open")
  @js.native
  def open(connStr: ConnStr, cb: js.Function2[/* err */ js.Error, /* db */ Database, Unit]): Unit = js.native
  @JSImport("ibm_db", "open")
  @js.native
  def open(connStr: ConnStr, options: Options): js.Promise[Database] = js.native
  @JSImport("ibm_db", "open")
  @js.native
  def open(connStr: ConnStr, options: Options, cb: js.Function2[/* err */ js.Error, /* db */ Database, Unit]): Unit = js.native
