...
@js.native
trait AnonRequestedattributes extends js.Object {
...
object AnonRequestedattributes {
  @scala.inline
  def apply(): AnonRequestedattributes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonRequestedattributes]
  }
  @scala.inline
  implicit class AnonRequestedattributesOps[Self <: AnonRequestedattributes] (val x: Self) extends AnyVal {
    @scala.inline
