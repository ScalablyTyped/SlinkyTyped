...
@js.native
trait AnonDocumentformat extends js.Object {
...
object AnonDocumentformat {
  @scala.inline
  def apply(`document-uri`: String, `requesting-user-name`: String): AnonDocumentformat = {
    ...
    __obj.asInstanceOf[AnonDocumentformat]
  }
  @scala.inline
  implicit class AnonDocumentformatOps[Self <: AnonDocumentformat] (val x: Self) extends AnyVal {
    @scala.inline
