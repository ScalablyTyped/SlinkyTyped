...
@js.native
trait AnonDocumentnaturallanguage extends js.Object {
...
object AnonDocumentnaturallanguage {
  @scala.inline
  def apply(`last-document`: Boolean, `requesting-user-name`: String): AnonDocumentnaturallanguage = {
    ...
    __obj.asInstanceOf[AnonDocumentnaturallanguage]
  }
  @scala.inline
  implicit class AnonDocumentnaturallanguageOps[Self <: AnonDocumentnaturallanguage] (val x: Self) extends AnyVal {
    @scala.inline
