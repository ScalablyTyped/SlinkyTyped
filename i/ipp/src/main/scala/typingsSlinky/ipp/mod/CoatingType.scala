...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.ipp.ippStrings.`archival-glossy`
  - typingsSlinky.ipp.ippStrings.`archival-matte`
  - typingsSlinky.ipp.ippStrings.`archival-semi-gloss`
  ...
  - typingsSlinky.ipp.ippStrings.silicone
