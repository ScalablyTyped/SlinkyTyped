...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.ipp.ippStrings.available
  - typingsSlinky.ipp.ippStrings.installed
...
object ResourceState {
  ...
  @scala.inline
  def available: typingsSlinky.ipp.ippStrings.available = "available".asInstanceOf[typingsSlinky.ipp.ippStrings.available]
  
  @scala.inline
  def canceled: typingsSlinky.ipp.ippStrings.canceled = "canceled".asInstanceOf[typingsSlinky.ipp.ippStrings.canceled]
  
  @scala.inline
  def installed: typingsSlinky.ipp.ippStrings.installed = "installed".asInstanceOf[typingsSlinky.ipp.ippStrings.installed]
