...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.ipp.ippStrings.`not-completed`
  ...
  - typingsSlinky.ipp.ippStrings.saved
*/
...
object WhichJobs {
  ...
  @scala.inline
  def `not-completed`: typingsSlinky.ipp.ippStrings.`not-completed` = "not-completed".asInstanceOf[typingsSlinky.ipp.ippStrings.`not-completed`]
  ...
  @scala.inline
  def `proof-print`: typingsSlinky.ipp.ippStrings.`proof-print` = "proof-print".asInstanceOf[typingsSlinky.ipp.ippStrings.`proof-print`]
  
  @scala.inline
  def saved: typingsSlinky.ipp.ippStrings.saved = "saved".asInstanceOf[typingsSlinky.ipp.ippStrings.saved]
}
