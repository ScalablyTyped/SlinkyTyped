...
object FullResponse {
  ...
  implicit class FullResponseOps[Self <: FullResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `withJob-attributes-tag`(value: js.Object): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withPrinter-attributes-tag`(value: PrinterDescription): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("printer-attributes-tag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutPrinter-attributes-tag`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("printer-attributes-tag")(js.undefined)
        ret
    }
    @scala.inline
