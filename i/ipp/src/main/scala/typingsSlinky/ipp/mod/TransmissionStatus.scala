...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.ipp.ippStrings.`pending-retry`
...
object TransmissionStatus {
  ...
  @scala.inline
  def `pending-retry`: typingsSlinky.ipp.ippStrings.`pending-retry` = "pending-retry".asInstanceOf[typingsSlinky.ipp.ippStrings.`pending-retry`]
