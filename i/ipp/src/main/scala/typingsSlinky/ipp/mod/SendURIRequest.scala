...
import typingsSlinky.ipp.AnonDocumenturi
...
trait SendURIRequest extends js.Object {
  var `operation-attributes-tag`: AnonDocumenturi = js.native
}

object SendURIRequest {
  @scala.inline
  def apply(`operation-attributes-tag`: AnonDocumenturi): SendURIRequest = {
  ...
  implicit class SendURIRequestOps[Self <: SendURIRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `withOperation-attributes-tag`(value: AnonDocumenturi): Self = {
