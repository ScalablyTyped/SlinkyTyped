...
import typingsSlinky.ipp.AnonJobholduntil
...
trait HoldRestartJobRequest extends js.Object {
  var `operation-attributes-tag`: AnonJobholduntil = js.native
}

object HoldRestartJobRequest {
  @scala.inline
  def apply(`operation-attributes-tag`: AnonJobholduntil): HoldRestartJobRequest = {
  ...
  implicit class HoldRestartJobRequestOps[Self <: HoldRestartJobRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `withOperation-attributes-tag`(value: AnonJobholduntil): Self = {
