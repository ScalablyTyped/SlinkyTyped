...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.ipp.ippStrings.comb
  - typingsSlinky.ipp.ippStrings.flat
  - typingsSlinky.ipp.ippStrings.padding
  - typingsSlinky.ipp.ippStrings.perfect
  - typingsSlinky.ipp.ippStrings.spiral
  - typingsSlinky.ipp.ippStrings.tape
