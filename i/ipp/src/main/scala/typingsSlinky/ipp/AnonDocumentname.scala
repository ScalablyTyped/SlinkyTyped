...
@js.native
trait AnonDocumentname extends js.Object {
...
object AnonDocumentname {
  @scala.inline
  def apply(`requesting-user-name`: String): AnonDocumentname = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("requesting-user-name")(`requesting-user-name`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDocumentname]
  }
  @scala.inline
  implicit class AnonDocumentnameOps[Self <: AnonDocumentname] (val x: Self) extends AnyVal {
    @scala.inline
