...
@js.native
trait AnonJobholduntil extends js.Object {
...
object AnonJobholduntil {
  @scala.inline
  def apply(`requesting-user-name`: String): AnonJobholduntil = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("requesting-user-name")(`requesting-user-name`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonJobholduntil]
  }
  @scala.inline
  implicit class AnonJobholduntilOps[Self <: AnonJobholduntil] (val x: Self) extends AnyVal {
    @scala.inline
