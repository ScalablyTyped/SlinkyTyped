package typingsSlinky.i18nextFsBackend
...
object mod {
  ...
  object i18next {
    ...
    object InitOptions {
      ...
      @scala.inline
      def apply(): typingsSlinky.i18nextFsBackend.mod.i18next.InitOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.i18nextFsBackend.mod.i18next.InitOptions]
      }
      
      @scala.inline
      implicit class InitOptionsMutableBuilder[Self <: typingsSlinky.i18nextFsBackend.mod.i18next.InitOptions] (val x: Self) extends AnyVal {
