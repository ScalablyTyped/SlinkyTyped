package typingsSlinky.ink.renderMod
...
trait Instance extends js.Object {
  /**
    ...
    */
  var rerender: js.Function1[/* node */ ReactElement, Unit] = js.native
  /**
    * Manually unmount the whole Ink app.
    */
  var unmount: js.Function1[/* error */ js.UndefOr[js.Error | Double | Null], Unit] = js.native
  /**
...
object Instance {
  ...
  def apply(
    cleanup: () => Unit,
    clear: () => Unit,
    rerender: /* node */ ReactElement => Unit,
  ...
  implicit class InstanceOps[Self <: Instance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRerender(value: /* node */ ReactElement => Unit): Self = this.set("rerender", js.Any.fromFunction1(value))
    @scala.inline
    def setUnmount(value: /* error */ js.UndefOr[js.Error | Double | Null] => Unit): Self = this.set("unmount", js.Any.fromFunction1(value))
    @scala.inline
