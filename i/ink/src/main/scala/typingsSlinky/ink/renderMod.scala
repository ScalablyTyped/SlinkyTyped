...
object renderMod extends Shortcut {
  ...
  object Instance {
    ...
    implicit class InstanceMutableBuilder[Self <: Instance] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRerender(value: /* node */ ReactElement => Unit): Self = StObject.set(x, "rerender", js.Any.fromFunction1(value))
      
      @scala.inline
      def setUnmount(value: /* error */ js.UndefOr[js.Error | Double | Null] => Unit): Self = StObject.set(x, "unmount", js.Any.fromFunction1(value))
