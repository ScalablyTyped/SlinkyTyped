...
import typingsSlinky.ink.inkStrings.Numbersigntext
  ...
  */
  ...
  object DOMNode {
    ...
    def DOMElement(
      ...
      val __obj = js.Dynamic.literal(attributes = attributes.asInstanceOf[js.Any], childNodes = childNodes.asInstanceOf[js.Any], nodeName = nodeName.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.ink.domMod.DOMElement]
    }
    
    @scala.inline
    def TextNode(nodeName: TextName, nodeValue: String, style: Styles): typingsSlinky.ink.domMod.TextNode = {
      ...
      __obj.asInstanceOf[typingsSlinky.ink.domMod.TextNode]
    }
  }
