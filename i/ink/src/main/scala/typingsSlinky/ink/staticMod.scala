...
object staticMod {
  ...
  trait Props[T] extends Styles {
    ...
    /**
      ...
      */
    def children(item: T, index: Double): ReactElement = js.native
  ...
  object Props {
    ...
    @scala.inline
    def apply[T](children: (T, Double) => ReactElement, items: js.Array[T]): Props[T] = {
    ...
    implicit class PropsMutableBuilder[Self <: Props[_], T] (val x: Self with Props[T]) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (T, Double) => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
