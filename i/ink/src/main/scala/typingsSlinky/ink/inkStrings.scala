...
import typingsSlinky.ink.colorizeMod.ColorType
import typingsSlinky.ink.domMod.ElementNames
...
object inkStrings {
  ...
  @scala.inline
  def ChalkFunctionProps: ChalkFunctionProps = "ChalkFunctionProps".asInstanceOf[ChalkFunctionProps]
