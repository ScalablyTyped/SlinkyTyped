...
object MessageFunctions {
  ...
  implicit class MessageFunctionsOps[Self <: MessageFunctions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddFlags(value: (js.Any, js.Any, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("addFlags", js.Any.fromFunction3(value))
    
    @scala.inline
    def setAddKeywords(value: (js.Any, js.Any, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("addKeywords", js.Any.fromFunction3(value))
    
    @scala.inline
    def setCopy(value: (js.Any, String, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("copy", js.Any.fromFunction3(value))
    
    @scala.inline
    def setDelFlags(value: (js.Any, js.Any, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("delFlags", js.Any.fromFunction3(value))
    
    @scala.inline
    def setDelKeywords(value: (js.Any, js.Any, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("delKeywords", js.Any.fromFunction3(value))
    
    @scala.inline
    def setFetch(value: (js.Any, FetchOptions) => ImapFetch): Self = this.set("fetch", js.Any.fromFunction2(value))
    
    @scala.inline
    def setMove(value: (js.Any, String, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("move", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setSetFlags(value: (js.Any, js.Any, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("setFlags", js.Any.fromFunction3(value))
    
    @scala.inline
    def setSetKeywords(value: (js.Any, js.Any, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("setKeywords", js.Any.fromFunction3(value))
  }
}
