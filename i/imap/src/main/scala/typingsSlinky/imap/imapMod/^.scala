...
class ^ protected () extends Connection {
  ...
  /* CompleteClass */
  override def addFlags(source: js.Any, flags: js.Any, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  /** Adds keyword(s) to message(s). keywords is either a single keyword or an array of keywords. */
  /* CompleteClass */
  override def addKeywords(source: js.Any, keywords: js.Any, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  /** Copies message(s) in the currently open mailbox to another mailbox. */
  /* CompleteClass */
  override def copy(source: js.Any, mailboxName: String, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  /** Removes flag(s) from message(s). */
  /* CompleteClass */
  override def delFlags(source: js.Any, flags: js.Any, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  /** Removes keyword(s) from message(s). keywords is either a single keyword or an array of keywords. */
  /* CompleteClass */
  override def delKeywords(source: js.Any, keywords: js.Any, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  ...
  /* CompleteClass */
  override def move(source: js.Any, mailboxName: String, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  ...
  /* CompleteClass */
  override def setFlags(source: js.Any, flags: js.Any, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  /** Sets keyword(s) for message(s). keywords is either a single keyword or an array of keywords. */
  /* CompleteClass */
  override def setKeywords(source: js.Any, keywords: js.Any, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
}
