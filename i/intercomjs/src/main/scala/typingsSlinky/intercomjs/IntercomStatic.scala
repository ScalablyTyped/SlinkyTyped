...
trait IntercomStatic extends js.Object {
  ...
  /**
    ...
    */
  def getInstance(): typingsSlinky.intercomjs.intercom.Intercom
}

object IntercomStatic {
  @scala.inline
  def apply(destroy: () => Unit, getInstance: () => typingsSlinky.intercomjs.intercom.Intercom): IntercomStatic = {
