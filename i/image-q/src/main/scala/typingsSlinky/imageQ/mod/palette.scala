...
object palette {
  ...
  class ColorHistogram protected ()
    extends typingsSlinky.imageQ.paletteMod.ColorHistogram {
  ...
  class NeuQuant protected ()
    extends typingsSlinky.imageQ.paletteMod.NeuQuant {
  ...
  class NeuQuantFloat protected ()
    extends typingsSlinky.imageQ.paletteMod.NeuQuantFloat {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
  }
  /* static members */
  ...
  class RGBQuant protected ()
    extends typingsSlinky.imageQ.paletteMod.RGBQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
    def this(
  ...
  @js.native
  class WuColorCube ()
    extends typingsSlinky.imageQ.paletteMod.WuColorCube
  
  @JSImport("image-q", "palette.WuQuant")
  @js.native
  class WuQuant protected ()
    extends typingsSlinky.imageQ.paletteMod.WuQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
    def this(
      colorDistanceCalculator: AbstractDistanceCalculator,
  ...
  object WuQuant {
    ...
    @JSImport("image-q", "palette.WuQuant.alpha")
    @js.native
    val alpha: js.Any = js.native
    
    @JSImport("image-q", "palette.WuQuant.blue")
    @js.native
    val blue: js.Any = js.native
    
    @JSImport("image-q", "palette.WuQuant.green")
    @js.native
    val green: js.Any = js.native
    
    @JSImport("image-q", "palette.WuQuant.red")
    @js.native
