...
object image extends js.Object {
  ...
  class ErrorDiffusionArray protected ()
    extends typingsSlinky.imageQ.imageMod.ErrorDiffusionArray {
  ...
  class ErrorDiffusionRiemersma protected ()
    extends typingsSlinky.imageQ.imageMod.ErrorDiffusionRiemersma {
  ...
  class NearestColor protected ()
    extends typingsSlinky.imageQ.imageMod.NearestColor {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
  }
