...
import typingsSlinky.interceptDashStdout.interceptDashStdoutMod.hookFunction
import typingsSlinky.interceptDashStdout.interceptDashStdoutMod.unhookFunction
