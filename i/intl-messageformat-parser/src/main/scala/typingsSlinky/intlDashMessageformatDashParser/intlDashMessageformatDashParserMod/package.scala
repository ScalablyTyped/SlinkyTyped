...
package object intlDashMessageformatDashParserMod {
  import typingsSlinky.intlDashMessageformatDashParser.intlDashMessageformatDashParserMod.TYPE.argument
  import typingsSlinky.intlDashMessageformatDashParser.intlDashMessageformatDashParserMod.TYPE.date
  import typingsSlinky.intlDashMessageformatDashParser.intlDashMessageformatDashParserMod.TYPE.literal
  import typingsSlinky.intlDashMessageformatDashParser.intlDashMessageformatDashParserMod.TYPE.number
  import typingsSlinky.intlDashMessageformatDashParser.intlDashMessageformatDashParserMod.TYPE.time
