...
object Skeleton {
  ...
  @scala.inline
  def DateTimeSkeleton(parsedOptions: DateTimeFormatOptions, pattern: String, `type`: `1`): typingsSlinky.intlMessageformatParser.srcTypesMod.DateTimeSkeleton = {
    ...
    __obj.asInstanceOf[typingsSlinky.intlMessageformatParser.srcTypesMod.DateTimeSkeleton]
  }
  
  @scala.inline
  def NumberSkeleton(parsedOptions: NumberFormatOptions, tokens: js.Array[NumberSkeletonToken], `type`: `0`): typingsSlinky.intlMessageformatParser.srcTypesMod.NumberSkeleton = {
    val __obj = js.Dynamic.literal(parsedOptions = parsedOptions.asInstanceOf[js.Any], tokens = tokens.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.intlMessageformatParser.srcTypesMod.NumberSkeleton]
  }
}
