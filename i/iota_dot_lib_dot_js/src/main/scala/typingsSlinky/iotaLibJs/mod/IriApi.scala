...
object IriApi {
  ...
  implicit class IriApiOps[Self <: IriApi] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("broadcastTransactions", js.Any.fromFunction2(value))
    @scala.inline
    def setFindTransactions(
      value: (Addresses, js.Function2[/* error */ js.Error, /* hashes */ js.Array[String], Unit]) => Unit
    ): Self = this.set("findTransactions", js.Any.fromFunction2(value))
    @scala.inline
    def setGetBalances(
    ...
    @scala.inline
    def setGetNeighbors(value: js.Function2[/* error */ js.Error, /* neighbors */ js.Array[Neighbor], Unit] => Unit): Self = this.set("getNeighbors", js.Any.fromFunction1(value))
    @scala.inline
    def setGetNodeInfo(value: js.Function2[/* error */ js.Error, /* info */ NodeInfo, Unit] => Unit): Self = this.set("getNodeInfo", js.Any.fromFunction1(value))
    @scala.inline
    def setGetTips(value: js.Function2[/* error */ js.Error, /* hashes */ js.Array[String], Unit] => Unit): Self = this.set("getTips", js.Any.fromFunction1(value))
    @scala.inline
    def setGetTransactionsToApprove(
      value: (Double, js.Function2[/* error */ js.Error, /* response */ BranchTransaction, Unit]) => Unit
    ): Self = this.set("getTransactionsToApprove", js.Any.fromFunction2(value))
    @scala.inline
    def setGetTrytes(
    ...
    @scala.inline
    def setInterruptAttachingToTangle(value: js.Function2[/* error */ js.Error, /* response */ js.Object, Unit] => Unit): Self = this.set("interruptAttachingToTangle", js.Any.fromFunction1(value))
    @scala.inline
    ...
    def setStoreTransactions(
      value: (js.Array[String], js.Function2[/* error */ js.Error, /* response */ js.Object, Unit]) => Unit
    ): Self = this.set("storeTransactions", js.Any.fromFunction2(value))
  }
