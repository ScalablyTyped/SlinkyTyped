...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.iotaLibJs.iotaLibJsStrings.i
    - typingsSlinky.iotaLibJs.iotaLibJsStrings.Ki
    - typingsSlinky.iotaLibJs.iotaLibJsStrings.Mi
    - typingsSlinky.iotaLibJs.iotaLibJsStrings.Gi
    - typingsSlinky.iotaLibJs.iotaLibJsStrings.Ti
    - typingsSlinky.iotaLibJs.iotaLibJsStrings.Pi
  */
  ...
  object IriApi {
    ...
    implicit class IriApiMutableBuilder[Self <: IriApi] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetNeighbors(value: js.Function2[/* error */ js.Error, /* neighbors */ js.Array[Neighbor], Unit] => Unit): Self = StObject.set(x, "getNeighbors", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGetNodeInfo(value: js.Function2[/* error */ js.Error, /* info */ NodeInfo, Unit] => Unit): Self = StObject.set(x, "getNodeInfo", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGetTips(value: js.Function2[/* error */ js.Error, /* hashes */ js.Array[String], Unit] => Unit): Self = StObject.set(x, "getTips", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGetTransactionsToApprove(
      ...
      @scala.inline
      def setInterruptAttachingToTangle(value: js.Function2[/* error */ js.Error, /* response */ js.Object, Unit] => Unit): Self = StObject.set(x, "interruptAttachingToTangle", js.Any.fromFunction1(value))
