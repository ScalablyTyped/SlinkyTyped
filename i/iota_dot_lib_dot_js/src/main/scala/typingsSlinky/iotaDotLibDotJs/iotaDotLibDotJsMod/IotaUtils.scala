...
import typingsSlinky.iotaDotLibDotJs.Anon_Received
...
trait IotaUtils extends js.Object {
  ...
  def categorizeTransfers(transfers: js.Array[TransactionObject], addresses: js.Array[String]): Anon_Received = js.native
