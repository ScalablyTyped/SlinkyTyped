...
import typingsSlinky.iotaDotLibDotJs.Anon_Balances
import typingsSlinky.iotaDotLibDotJs.Anon_BranchTransaction
...
trait IriApi extends js.Object {
  ...
  def getBalances(
    ...
    treshold: Double,
    callback: js.Function2[/* error */ js.Error, /* response */ Anon_Balances, Unit]
  ): Unit
  ...
  def getTransactionsToApprove(
    depth: Double,
    callback: js.Function2[/* error */ js.Error, /* response */ Anon_BranchTransaction, Unit]
  ): Unit
  def getTrytes(
...
object IriApi {
  ...
  def apply(
    ...
    findTransactions: (Anon_Addresses, js.Function2[/* error */ js.Error, /* hashes */ js.Array[String], Unit]) => Unit,
    getBalances: (js.Array[String], Double, js.Function2[/* error */ js.Error, /* response */ Anon_Balances, Unit]) => Unit,
    ...
    getTransactionsToApprove: (Double, js.Function2[/* error */ js.Error, /* response */ Anon_BranchTransaction, Unit]) => Unit,
