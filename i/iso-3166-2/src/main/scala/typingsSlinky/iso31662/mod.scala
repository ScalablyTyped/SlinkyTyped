package typingsSlinky.iso31662

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.iso31662.mod.CountryInfo.Full
...
object mod {
  ...
  object CountryInfo {
    ...
    object Partial {
      ...
      implicit class PartialMutableBuilder[Self <: Partial] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setSub(value: typingsSlinky.iso31662.mod.SubdivisionInfo.Map): Self = StObject.set(x, "sub", value.asInstanceOf[js.Any])
      }
    }
  }
  ...
  object SubdivisionInfo {
    ...
    object Full {
      ...
      def apply(
        ...
        regionCode: String,
        `type`: String
      ): typingsSlinky.iso31662.mod.SubdivisionInfo.Full = {
        ...
        __obj.asInstanceOf[typingsSlinky.iso31662.mod.SubdivisionInfo.Full]
      }
      
      @scala.inline
      implicit class FullMutableBuilder[Self <: typingsSlinky.iso31662.mod.SubdivisionInfo.Full] (val x: Self) extends AnyVal {
    ...
    StringDictionary[typingsSlinky.iso31662.mod.SubdivisionInfo.Full | Partial]
  ...
  type SubdivisionInfo = typingsSlinky.iso31662.mod.SubdivisionInfo.Full
}
