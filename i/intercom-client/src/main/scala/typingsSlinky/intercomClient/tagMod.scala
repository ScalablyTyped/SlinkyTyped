...
object tagMod {
  ...
  */
  ...
  object TagOper {
    ...
    @scala.inline
    def TagCompanies(name: String, users: js.Array[Id]): typingsSlinky.intercomClient.tagMod.TagCompanies = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], users = users.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.intercomClient.tagMod.TagCompanies]
    }
    
    @scala.inline
    def TagUsers(name: String, users: js.Array[UserIdentifier]): typingsSlinky.intercomClient.tagMod.TagUsers = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], users = users.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.intercomClient.tagMod.TagUsers]
    }
  }
