...
object userMod {
  ...
  */
  ...
  object UserIdentifier {
    ...
    @scala.inline
    def UserEmailIdentifier(email: String): typingsSlinky.intercomClient.userMod.UserEmailIdentifier = {
      val __obj = js.Dynamic.literal(email = email.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.intercomClient.userMod.UserEmailIdentifier]
    }
