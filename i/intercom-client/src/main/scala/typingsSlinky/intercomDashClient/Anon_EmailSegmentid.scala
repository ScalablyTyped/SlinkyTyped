...
trait Anon_EmailSegmentid extends js.Object {
  var email: js.UndefOr[String] = js.undefined
  var segment_id: js.UndefOr[String] = js.undefined
  var tag_id: js.UndefOr[String] = js.undefined
}

object Anon_EmailSegmentid {
  @scala.inline
  def apply(email: String = null, segment_id: String = null, tag_id: String = null): Anon_EmailSegmentid = {
    ...
    __obj.asInstanceOf[Anon_EmailSegmentid]
  }
}
