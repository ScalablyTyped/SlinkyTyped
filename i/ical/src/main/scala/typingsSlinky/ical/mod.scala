...
object mod {
  ...
  object CalendarComponent {
    ...
    implicit class CalendarComponentMutableBuilder[Self <: CalendarComponent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDtstamp(value: js.Date): Self = StObject.set(x, "dtstamp", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setExdate(value: StringDictionary[js.Date]): Self = StObject.set(x, "exdate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRecurrenceid(value: js.Date): Self = StObject.set(x, "recurrenceid", value.asInstanceOf[js.Any])
