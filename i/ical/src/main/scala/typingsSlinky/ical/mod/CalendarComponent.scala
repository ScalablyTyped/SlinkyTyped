...
object CalendarComponent {
  ...
  implicit class CalendarComponentOps[Self <: CalendarComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDtstamp(value: js.Date): Self = this.set("dtstamp", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setExdate(value: StringDictionary[js.Date]): Self = this.set("exdate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRecurrenceid(value: js.Date): Self = this.set("recurrenceid", value.asInstanceOf[js.Any])
    @scala.inline
