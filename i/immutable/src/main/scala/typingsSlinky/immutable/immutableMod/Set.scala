...
@js.native
trait Set[T]
  extends typingsSlinky.immutable.Immutable.Collection.Set[T] {
  /**
...
object set extends js.Object {
  ...
  def apply[K, V, C /* <: typingsSlinky.immutable.Immutable.Collection[K, V] */](collection: C, key: K, value: V): C = js.native
}
