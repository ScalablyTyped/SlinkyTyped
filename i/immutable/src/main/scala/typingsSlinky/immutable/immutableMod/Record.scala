...
trait Record[TProps /* <: js.Object */] extends js.Object {
  ...
  {[ K in keyof TProps ]: any}
    */ typingsSlinky.immutable.immutableStrings.Record with js.Any = js.native
  /**
...
object Record extends js.Object {
  ...
  trait Factory[TProps /* <: js.Object */]
    ...
    def apply(values: Iterable[js.Tuple2[String, _]]): typingsSlinky.immutable.Immutable.Record[TProps] with TProps = js.native
