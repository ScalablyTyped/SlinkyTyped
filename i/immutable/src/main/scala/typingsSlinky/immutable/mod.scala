...
object mod {
  ...
  trait Collection[K, V]
    extends typingsSlinky.immutable.Immutable.ValueObject {
    ...
    /**
      ...
      * have the same key.
      */
    def concat(valuesOrCollections: js.Any*): typingsSlinky.immutable.Immutable.Collection[_, _] = js.native
    ...
    /**
      ...
      */
    def countBy[G](grouper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, G]): typingsSlinky.immutable.Immutable.Map[G, Double] = js.native
    def countBy[G](grouper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, G], context: js.Any): typingsSlinky.immutable.Immutable.Map[G, Double] = js.native
    ...
    /**
      ...
      */
    @JSName("filter")
    def filter_F_V_Collection[F /* <: V */](predicate: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, /* is F */ Boolean]): typingsSlinky.immutable.Immutable.Collection[K, F] = js.native
    @JSName("filter")
    def filter_F_V_Collection[F /* <: V */](
      predicate: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, /* is F */ Boolean],
      context: js.Any
    ): typingsSlinky.immutable.Immutable.Collection[K, F] = js.native
    ...
    /**
      ...
      */
    def flatMap[M](mapper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, js.Iterable[M]]): typingsSlinky.immutable.Immutable.Collection[K, M] = js.native
    def flatMap[M](
      mapper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, js.Iterable[M]],
      context: js.Any
    ): typingsSlinky.immutable.Immutable.Collection[K, M] = js.native
    /**
      * Flat-maps the Collection, returning a Collection of the same type.
      *
      * Similar to `collection.map(...).flatten(true)`.
    ...
    ): typingsSlinky.immutable.Immutable.Collection[KM, VM] = js.native
    @JSName("flatMap")
    def flatMap_KMVM[KM, VM](
      mapper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, js.Iterable[js.Tuple2[KM, VM]]],
      context: js.Any
    ...
    /**
      ...
      */
    def flatten(): typingsSlinky.immutable.Immutable.Collection[_, _] = js.native
    def flatten(depth: Double): typingsSlinky.immutable.Immutable.Collection[_, _] = js.native
    def flatten(shallow: Boolean): typingsSlinky.immutable.Immutable.Collection[_, _] = js.native
    ...
    /**
      ...
      * ```
      */
    def groupBy[G](grouper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, G]): /*Map*/ Keyed[G, /*this*/ typingsSlinky.immutable.Immutable.Collection[K, V]] = js.native
    def groupBy[G](grouper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, G], context: js.Any): /*Map*/ Keyed[G, /*this*/ typingsSlinky.immutable.Immutable.Collection[K, V]] = js.native
    ...
    /**
      ...
      * value at every step.
      */
    def map[M](mapper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, M]): typingsSlinky.immutable.Immutable.Collection[K, M] = js.native
    def map[M](mapper: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, M], context: js.Any): typingsSlinky.immutable.Immutable.Collection[K, M] = js.native
    ...
    /**
      ...
      * ```
      */
    def toList(): typingsSlinky.immutable.Immutable.List[V] = js.native
    ...
    /**
      ...
      */
    def toMap(): typingsSlinky.immutable.Immutable.Map[K, V] = js.native
    ...
    /**
      ...
      */
    def toOrderedMap(): typingsSlinky.immutable.Immutable.OrderedMap[K, V] = js.native
    ...
    /**
      ...
      * for convenience and to allow for chained expressions.
      */
    def toOrderedSet(): typingsSlinky.immutable.Immutable.OrderedSet[V] = js.native
    ...
    /**
      ...
      * keyed, or set).
      */
    def toSeq(): typingsSlinky.immutable.Immutable.Seq[K, V] = js.native
    ...
    /**
      ...
      * chained expressions.
      */
    def toStack(): typingsSlinky.immutable.Immutable.Stack[V] = js.native
  ...
  object Collection {
    ...
    trait Indexed[T]
      ...
      /**
        ...
        */
      def interleave(collections: (typingsSlinky.immutable.Immutable.Collection[_, T])*): this.type = js.native
      ...
      def zip(collections: (typingsSlinky.immutable.Immutable.Collection[_, _])*): typingsSlinky.immutable.Immutable.Collection.Indexed[_] = js.native
      /**
        ...
        * ```
        */
      def zip[U](other: typingsSlinky.immutable.Immutable.Collection[_, U]): typingsSlinky.immutable.Immutable.Collection.Indexed[js.Tuple2[T, U]] = js.native
      def zip[U, V](
        other: typingsSlinky.immutable.Immutable.Collection[_, U],
        other2: typingsSlinky.immutable.Immutable.Collection[_, V]
      ): typingsSlinky.immutable.Immutable.Collection.Indexed[js.Tuple3[T, U, V]] = js.native
      
      def zipAll(collections: (typingsSlinky.immutable.Immutable.Collection[_, _])*): typingsSlinky.immutable.Immutable.Collection.Indexed[_] = js.native
      /**
        ...
        * ```
        */
      def zipAll[U](other: typingsSlinky.immutable.Immutable.Collection[_, U]): typingsSlinky.immutable.Immutable.Collection.Indexed[js.Tuple2[T, U]] = js.native
      def zipAll[U, V](
        other: typingsSlinky.immutable.Immutable.Collection[_, U],
        other2: typingsSlinky.immutable.Immutable.Collection[_, V]
      ): typingsSlinky.immutable.Immutable.Collection.Indexed[js.Tuple3[T, U, V]] = js.native
  ...
  object Record {
    ...
    trait Factory[TProps /* <: js.Object */]
      extends Instantiable0[typingsSlinky.immutable.Immutable.Record[TProps] with TProps]
         with Instantiable1[
              (/* values */ js.Iterable[js.Tuple2[String, js.Any]]) | (/* values */ Partial[TProps]), 
              typingsSlinky.immutable.Immutable.Record[TProps] with TProps
            ] {
      
      def apply(): typingsSlinky.immutable.Immutable.Record[TProps] with TProps = js.native
      def apply(values: js.Iterable[js.Tuple2[String, _]]): typingsSlinky.immutable.Immutable.Record[TProps] with TProps = js.native
      def apply(values: Partial[TProps]): typingsSlinky.immutable.Immutable.Record[TProps] with TProps = js.native
  ...
  def fromJS(
    ...
    reviver: js.Function3[
      Double | String, 
      typingsSlinky.immutable.Immutable.Collection.Indexed[_] | (typingsSlinky.immutable.Immutable.Collection.Keyed[String, _]), 
  ...
  @JSImport("immutable", "update")
  @js.native
  def update_KVC_CollectionKVNSV[K, V, C /* <: typingsSlinky.immutable.Immutable.Collection[K, V] */, NSV](collection: C, key: K, notSetValue: NSV, updater: js.Function1[NSV | V, V]): C = js.native
  @JSImport("immutable", "update")
  @js.native
