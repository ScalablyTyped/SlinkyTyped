...
trait Set_[T] extends Set[T] {
  ...
  /**
    ...
    */
  @JSName("filter")
  def filter_F_T_Set_[F /* <: T */](predicate: js.Function3[/* value */ T, /* key */ T, /* iter */ this.type, /* is F */ Boolean]): typingsSlinky.immutable.Immutable.Set_[F] = js.native
  @JSName("filter")
  def filter_F_T_Set_[F /* <: T */](
    predicate: js.Function3[/* value */ T, /* key */ T, /* iter */ this.type, /* is F */ Boolean],
    context: js.Any
  ): typingsSlinky.immutable.Immutable.Set_[F] = js.native
  /**
  ...
  def merge[C](collections: js.Iterable[C]*): typingsSlinky.immutable.Immutable.Set_[T | C] = js.native
  ...
  /**
    ...
    * @alias concat
    */
  def union[C](collections: js.Iterable[C]*): typingsSlinky.immutable.Immutable.Set_[T | C] = js.native
  /**
    * @see `Map#wasAltered`
    */
