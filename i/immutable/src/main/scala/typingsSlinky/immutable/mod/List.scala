...
trait List[T] extends Indexed[T] {
  ...
  /**
    ...
    */
  def clear(): typingsSlinky.immutable.Immutable.List[T] = js.native
  ...
  /**
    ...
    * @alias remove
    */
  def delete(index: Double): typingsSlinky.immutable.Immutable.List[T] = js.native
  ...
  ): typingsSlinky.immutable.Immutable.List[F] = js.native
  @JSName("filter")
  def filter_F_T_List[F /* <: T */](
    predicate: js.Function3[/* value */ T, /* index */ Double, /* iter */ this.type, /* is F */ Boolean],
    context: js.Any
  ...
  /**
    ...
    */
  def insert(index: Double, value: T): typingsSlinky.immutable.Immutable.List[T] = js.native
  
  def merge[C](collections: js.Iterable[C]*): typingsSlinky.immutable.Immutable.List[T | C] = js.native
  ...
  /**
    ...
    */
  def pop(): typingsSlinky.immutable.Immutable.List[T] = js.native
  ...
  /**
    ...
    */
  def push(values: T*): typingsSlinky.immutable.Immutable.List[T] = js.native
  
  def remove(index: Double): typingsSlinky.immutable.Immutable.List[T] = js.native
  ...
  /**
    ...
    */
  def set(index: Double, value: T): typingsSlinky.immutable.Immutable.List[T] = js.native
  ...
  /**
    ...
    */
  def setSize(size: Double): typingsSlinky.immutable.Immutable.List[T] = js.native
  ...
  /**
    ...
    */
  def shift(): typingsSlinky.immutable.Immutable.List[T] = js.native
  ...
  /**
    ...
    */
  def unshift(values: T*): typingsSlinky.immutable.Immutable.List[T] = js.native
