...
import typingsSlinky.invityApi.invityApiStrings.hex
import typingsSlinky.invityApi.invityApiStrings.number
import typingsSlinky.invityApi.invityApiStrings.text
