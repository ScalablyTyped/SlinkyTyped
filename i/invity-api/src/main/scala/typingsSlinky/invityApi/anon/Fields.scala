package typingsSlinky.invityApi.anon

import typingsSlinky.invityApi.invityApiStrings.GET
import typingsSlinky.invityApi.invityApiStrings.IFRAME
import typingsSlinky.invityApi.invityApiStrings.POST
import typingsSlinky.invityApi.mod.StringMap
