...
import typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.Clonable
...
object dtsContainerLookupMod extends js.Object {
  ...
  class Lookup[T /* <: Clonable[T] */] ()
    extends typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.Lookup[T] {
