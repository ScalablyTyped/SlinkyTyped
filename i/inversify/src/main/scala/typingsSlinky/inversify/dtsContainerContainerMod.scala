...
import typingsSlinky.inversify.dtsContainerContainerMod.Container
...
@js.native
object dtsContainerContainerMod extends js.Object {
  @js.native
  class Container ()
    extends typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.Container {
