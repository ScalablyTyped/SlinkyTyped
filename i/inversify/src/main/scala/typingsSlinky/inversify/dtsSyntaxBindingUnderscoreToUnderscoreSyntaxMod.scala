...
import typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.BindingInWhenOnSyntax
import typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.BindingWhenOnSyntax
import typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.Context
import typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.FactoryCreator
import typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.Newable
import typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.ProviderCreator
...
object dtsSyntaxBindingUnderscoreToUnderscoreSyntaxMod extends js.Object {
  ...
  class BindingToSyntax[T] protected ()
    extends typingsSlinky.inversify.dtsInterfacesInterfacesMod.interfaces.BindingToSyntax[T] {
