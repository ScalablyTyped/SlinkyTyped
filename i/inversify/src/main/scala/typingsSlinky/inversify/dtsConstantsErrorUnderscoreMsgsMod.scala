...
import typingsSlinky.inversify.inversifyStrings.`Ambiguous match found for serviceIdentifier:`
...
import typingsSlinky.inversify.inversifyStrings.`Circular dependency found:`
import typingsSlinky.inversify.inversifyStrings.`Could not unbind serviceIdentifier:`
import typingsSlinky.inversify.inversifyStrings.`Invalid binding type:`
import typingsSlinky.inversify.inversifyStrings.`Invalid return type in middlewareDOT Middleware must return!`
...
import typingsSlinky.inversify.inversifyStrings.`Metadata key was used more than once in a parameter:`
import typingsSlinky.inversify.inversifyStrings.`Missing required @inject or @multiInject annotation in:`
import typingsSlinky.inversify.inversifyStrings.`Missing required @injectable annotation in:`
import typingsSlinky.inversify.inversifyStrings.`NULL argument`
import typingsSlinky.inversify.inversifyStrings.`No matching bindings found for serviceIdentifier:`
import typingsSlinky.inversify.inversifyStrings.`No snapshot available to restoreDOT`
import typingsSlinky.inversify.inversifyStrings.`Sorry, this feature is not fully implemented yetDOT`
import typingsSlinky.inversify.inversifyStrings.`Value provided to function binding must be a function!`
