...
trait InitOptions extends js.Object {
  ...
  /**
    ...
    */
  var privateKey: js.UndefOr[String | typingsSlinky.peerId.mod.^ ] = js.native
...
object InitOptions {
  ...
  implicit class InitOptionsOps[Self <: InitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrivateKey(value: String | typingsSlinky.peerId.mod.^ ): Self = this.set("privateKey", value.asInstanceOf[js.Any])
