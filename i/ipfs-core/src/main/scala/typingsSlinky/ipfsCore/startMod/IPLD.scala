...
import typingsSlinky.ipfsCore.anon.Bootstrap
import typingsSlinky.ipfsCore.anon.Cat
import typingsSlinky.ipfsCore.anon.FindProvs
import typingsSlinky.ipfsCore.anon.Format
...
import typingsSlinky.ipfsCore.anon.Profiles
...
import typingsSlinky.ipfsCore.anon.Typeofbitswap
import typingsSlinky.ipfsCore.anon.Typeofblock
import typingsSlinky.ipfsCore.anon.Typeofbootstrap
import typingsSlinky.ipfsCore.anon.Typeofdag
import typingsSlinky.ipfsCore.anon.Typeofkey
import typingsSlinky.ipfsCore.anon.Typeofname
import typingsSlinky.ipfsCore.anon.Typeofobject
import typingsSlinky.ipfsCore.anon.Typeofpin
import typingsSlinky.ipfsCore.anon.Typeofrepo
import typingsSlinky.ipfsCore.anon.Typeofstats
import typingsSlinky.ipfsCore.anon.Typeofswarm
...
trait IPLD extends js.Object {
  ...
  def addAll(hasBlockGcLockPreloadPinOptions: typingsSlinky.ipfsCore.anon.Preload): js.Function2[
  ...
  def libp2p(hasOptionsPeerIdMultiaddrsRepoKeychainConfigConfig: typingsSlinky.ipfsCore.anon.Config): js.Any = js.native
  @JSName("libp2p")
  var libp2p_Original: js.Function1[
    /* hasOptionsPeerIdMultiaddrsRepoKeychainConfigConfig */ typingsSlinky.ipfsCore.anon.Config, 
    _
  ] = js.native
  ...
  def start(
    hasApiManagerOptionsBlockServiceGcLockInitOptionsIpldKeychainPeerIdPinManagerPreloadPrintRepo: typingsSlinky.ipfsCore.anon.InitOptions
