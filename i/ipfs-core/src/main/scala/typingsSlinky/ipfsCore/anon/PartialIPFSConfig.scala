...
trait PartialIPFSConfig extends js.Object {
  ...
  var Keychain: js.UndefOr[typingsSlinky.ipfsCore.configMod.KeychainConfig] = js.native
...
object PartialIPFSConfig {
  ...
  implicit class PartialIPFSConfigOps[Self <: PartialIPFSConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeychain(value: typingsSlinky.ipfsCore.configMod.KeychainConfig): Self = this.set("Keychain", value.asInstanceOf[js.Any])
