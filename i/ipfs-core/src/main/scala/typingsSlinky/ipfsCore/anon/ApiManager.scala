...
trait ApiManager extends js.Object {
  ...
  var options: ConstructorOptions[Boolean | typingsSlinky.ipfsCore.initMod.InitOptions, Boolean] = js.native
...
object ApiManager {
  ...
  def apply(
    apiManager: ^,
    options: ConstructorOptions[Boolean | typingsSlinky.ipfsCore.initMod.InitOptions, Boolean],
  ...
  implicit class ApiManagerOps[Self <: ApiManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions(value: ConstructorOptions[Boolean | typingsSlinky.ipfsCore.initMod.InitOptions, Boolean]): Self = this.set("options", value.asInstanceOf[js.Any])
