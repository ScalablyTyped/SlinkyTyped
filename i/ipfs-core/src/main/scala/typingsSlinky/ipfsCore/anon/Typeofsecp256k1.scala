...
import typingsSlinky.libp2pCrypto.mod.keys.supportedKeys.secp256k1.Secp256k1PublicKey
...
trait Typeofsecp256k1 extends js.Object {
  ...
  var Secp256k1PrivateKey: Instantiable2[
    ...
    typingsSlinky.libp2pCrypto.mod.keys.supportedKeys.secp256k1.Secp256k1PrivateKey
  ] = js.native
  
  var Secp256k1PublicKey: Instantiable1[
    /* key */ js.typedarray.Uint8Array, 
    typingsSlinky.libp2pCrypto.mod.keys.supportedKeys.secp256k1.Secp256k1PublicKey
  ] = js.native
...
object Typeofsecp256k1 {
  ...
  def apply(
    ...
    unmarshalSecp256k1PrivateKey: js.typedarray.Uint8Array => js.Promise[Secp256k1PrivateKey],
  ...
  implicit class Typeofsecp256k1Ops[Self <: Typeofsecp256k1] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSecp256k1PrivateKey(
      value: Instantiable2[
          /* key */ js.typedarray.Uint8Array, 
          /* publicKey */ js.typedarray.Uint8Array, 
          Secp256k1PrivateKey
        ]
    ): Self = this.set("Secp256k1PrivateKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSecp256k1PublicKey(value: Instantiable1[/* key */ js.typedarray.Uint8Array, Secp256k1PublicKey]): Self = this.set("Secp256k1PublicKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGenerateKeyPair(value: () => js.Promise[Secp256k1PrivateKey]): Self = this.set("generateKeyPair", js.Any.fromFunction0(value))
    
    @scala.inline
    def setUnmarshalSecp256k1PrivateKey(value: js.typedarray.Uint8Array => js.Promise[Secp256k1PrivateKey]): Self = this.set("unmarshalSecp256k1PrivateKey", js.Any.fromFunction1(value))
    
    @scala.inline
    def setUnmarshalSecp256k1PublicKey(value: js.typedarray.Uint8Array => Secp256k1PublicKey): Self = this.set("unmarshalSecp256k1PublicKey", js.Any.fromFunction1(value))
  }
}
