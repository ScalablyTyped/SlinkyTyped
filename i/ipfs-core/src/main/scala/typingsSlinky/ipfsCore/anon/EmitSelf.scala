...
object EmitSelf {
  ...
  @scala.inline
  def apply(emitSelf: Boolean, enabled: Boolean): EmitSelf = {
    val __obj = js.Dynamic.literal(emitSelf = emitSelf.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any])
