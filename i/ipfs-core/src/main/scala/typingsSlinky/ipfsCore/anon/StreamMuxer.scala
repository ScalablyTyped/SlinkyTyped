...
import typingsSlinky.libp2pNoise.libp2pNoiseMod.Noise
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait StreamMuxer extends js.Object {
  
  var connEncryption: js.Array[Noise] = js.native
  
  var dht: js.Any = js.native
  
  var peerDiscovery: js.Array[_] = js.native
...
object StreamMuxer {
  ...
  def apply(
    ...
    __obj.asInstanceOf[StreamMuxer]
  }
  
  @scala.inline
  implicit class StreamMuxerOps[Self <: StreamMuxer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPeerDiscoveryVarargs(value: js.Any*): Self = this.set("peerDiscovery", js.Array(value :_*))
    
    @scala.inline
    def setPeerDiscovery(value: js.Array[_]): Self = this.set("peerDiscovery", value.asInstanceOf[js.Any])
