...
trait AddrsArray extends js.Object {
  ...
  var id: typingsSlinky.cids.mod.^ = js.native
}
object AddrsArray {
  
  @scala.inline
  def apply(addrs: js.Array[^], id: typingsSlinky.cids.mod.^): AddrsArray = {
  ...
  implicit class AddrsArrayOps[Self <: AddrsArray] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setId(value: typingsSlinky.cids.mod.^): Self = this.set("id", value.asInstanceOf[js.Any])
  }
}
