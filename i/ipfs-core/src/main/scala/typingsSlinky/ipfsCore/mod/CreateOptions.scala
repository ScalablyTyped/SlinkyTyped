...
@js.native
trait CreateOptions[Init /* <: Boolean | typingsSlinky.ipfsCore.initMod.InitOptions */, Start /* <: Boolean */] extends js.Object {
...
object CreateOptions {
  ...
  @scala.inline
  def apply[Init /* <: Boolean | typingsSlinky.ipfsCore.initMod.InitOptions */, Start /* <: Boolean */](): CreateOptions[Init, Start] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateOptions[Init, Start]]
  }
  
  @scala.inline
  implicit class CreateOptionsOps[Self <: CreateOptions[_, _], Init /* <: Boolean | typingsSlinky.ipfsCore.initMod.InitOptions */, Start /* <: Boolean */] (val x: Self with (CreateOptions[Init, Start])) extends AnyVal {
