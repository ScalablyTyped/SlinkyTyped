package typingsSlinky.ipfsCore.idMod
...
trait PeerId extends js.Object {
  ...
  /**
    ...
    */
  var addresses: js.Array[typingsSlinky.multiaddr.mod.^] = js.native
...
object PeerId {
  ...
  @scala.inline
  def apply(
    addresses: js.Array[typingsSlinky.multiaddr.mod.^],
    agentVersion: String,
    id: String,
  ...
  implicit class PeerIdOps[Self <: PeerId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddressesVarargs(value: typingsSlinky.multiaddr.mod.^ *): Self = this.set("addresses", js.Array(value :_*))
    
    @scala.inline
    def setAddresses(value: js.Array[typingsSlinky.multiaddr.mod.^]): Self = this.set("addresses", value.asInstanceOf[js.Any])
