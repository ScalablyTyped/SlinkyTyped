...
trait UnixFSeExt extends js.Object {
  ...
  def content(): AsyncIterable[js.typedarray.Uint8Array] = js.native
...
object UnixFSeExt {
  ...
  @scala.inline
  def apply(content: () => AsyncIterable[js.typedarray.Uint8Array], unixfs: UnixFS): UnixFSeExt = {
  ...
  implicit class UnixFSeExtOps[Self <: UnixFSeExt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContent(value: () => AsyncIterable[js.typedarray.Uint8Array]): Self = this.set("content", js.Any.fromFunction0(value))
