...
trait MkdirOptions extends js.Object {
  ...
  /**
    ...
    */
  var mtime: js.UndefOr[js.Date | typingsSlinky.ipfsCore.srcUtilsMod.Mtime | (js.Tuple2[Double, Double])] = js.native
...
object MkdirOptions {
  ...
  implicit class MkdirOptionsOps[Self <: MkdirOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMtime(value: js.Date | typingsSlinky.ipfsCore.srcUtilsMod.Mtime | (js.Tuple2[Double, Double])): Self = this.set("mtime", value.asInstanceOf[js.Any])
