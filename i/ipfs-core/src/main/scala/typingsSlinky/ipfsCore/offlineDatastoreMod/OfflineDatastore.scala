package typingsSlinky.ipfsCore.offlineDatastoreMod
...
object OfflineDatastore {
  ...
  def apply(
    ...
    get: js.typedarray.Uint8Array => js.Promise[js.typedarray.Uint8Array],
    put: (js.typedarray.Uint8Array, js.typedarray.Uint8Array) => js.Promise[Unit]
  ): OfflineDatastore = {
  ...
  implicit class OfflineDatastoreOps[Self <: OfflineDatastore] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGet(value: js.typedarray.Uint8Array => js.Promise[js.typedarray.Uint8Array]): Self = this.set("get", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPut(value: (js.typedarray.Uint8Array, js.typedarray.Uint8Array) => js.Promise[Unit]): Self = this.set("put", js.Any.fromFunction2(value))
  }
}
