...
@js.native
trait ConstructorOptions[Init /* <: Boolean | InitOptions */, Start /* <: Boolean */] extends js.Object {
...
object ConstructorOptions {
  ...
  @scala.inline
  def apply[Init /* <: Boolean | InitOptions */, Start /* <: Boolean */](): ConstructorOptions[Init, Start] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConstructorOptions[Init, Start]]
  }
  
  @scala.inline
  implicit class ConstructorOptionsOps[Self <: ConstructorOptions[_, _], Init /* <: Boolean | InitOptions */, Start /* <: Boolean */] (val x: Self with (ConstructorOptions[Init, Start])) extends AnyVal {
