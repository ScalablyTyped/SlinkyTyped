...
trait InitOptions extends js.Object {
  ...
  var config: js.UndefOr[typingsSlinky.ipfsCore.configMod.IPFSConfig] = js.native
...
object InitOptions {
  ...
  implicit class InitOptionsOps[Self <: InitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConfig(value: typingsSlinky.ipfsCore.configMod.IPFSConfig): Self = this.set("config", value.asInstanceOf[js.Any])
