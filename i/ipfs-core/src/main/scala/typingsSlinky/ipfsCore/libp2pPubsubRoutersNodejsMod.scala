...
@JSImport("ipfs-core/dist/src/runtime/libp2p-pubsub-routers-nodejs", JSImport.Namespace)
@js.native
object libp2pPubsubRoutersNodejsMod extends js.Object {
  
  val floodsub: js.Any = js.native
