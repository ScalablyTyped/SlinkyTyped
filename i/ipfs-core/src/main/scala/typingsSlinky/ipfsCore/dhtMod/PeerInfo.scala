...
object PeerInfo {
  ...
  @scala.inline
  def apply(addrs: js.Array[Multiaddr], id: typingsSlinky.peerId.mod.^): PeerInfo = {
  ...
  implicit class PeerInfoOps[Self <: PeerInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setId(value: typingsSlinky.peerId.mod.^): Self = this.set("id", value.asInstanceOf[js.Any])
  }
}
