...
import typingsSlinky.ipfsCore.configMod.PubSubRouter
import typingsSlinky.ipfsCore.initMod.KeyType
import typingsSlinky.ipfsCore.lsMod.FileType
import typingsSlinky.ipfsCore.pinManagerMod.PinQueryType
import typingsSlinky.ipfsCore.pinManagerMod.PinType
...
object ipfsCoreStrings {
  ...
  sealed trait all
    extends PinQueryType
       with typingsSlinky.ipfsCore.pinLsMod.PinQueryType
  ...
  sealed trait direct
    extends PinQueryType
       with typingsSlinky.ipfsCore.pinLsMod.PinQueryType
       with PinType
       with typingsSlinky.ipfsCore.pinLsMod.PinType
