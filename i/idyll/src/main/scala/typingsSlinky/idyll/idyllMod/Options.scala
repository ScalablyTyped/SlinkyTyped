...
import typingsSlinky.idyll.Anon_Compiler
...
trait Options extends js.Object {
  /**
    * Compiler options
    */
  var compiler: js.UndefOr[typingsSlinky.idyllDashCompiler.idyllDashCompilerMod.Options] = js.undefined
  /**
...
object Options {
  @scala.inline
  def apply(
    compiler: typingsSlinky.idyllDashCompiler.idyllDashCompilerMod.Options = null,
