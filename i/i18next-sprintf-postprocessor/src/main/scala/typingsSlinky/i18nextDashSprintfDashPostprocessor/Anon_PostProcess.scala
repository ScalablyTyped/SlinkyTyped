package typingsSlinky.i18nextDashSprintfDashPostprocessor

import typingsSlinky.i18nextDashSprintfDashPostprocessor.i18nextDashSprintfDashPostprocessorStrings.sprintf
