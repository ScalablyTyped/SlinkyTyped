package typingsSlinky.identiconDotJs.identiconDotJsMod

import typingsSlinky.identiconDotJs.identiconDotJsStrings.png
import typingsSlinky.identiconDotJs.identiconDotJsStrings.svg
