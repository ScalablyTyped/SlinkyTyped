...
object Svg {
  ...
  implicit class SvgOps[Self <: Svg] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRectanglesVarargs(value: typingsSlinky.identiconJs.anon.Color*): Self = this.set("rectangles", js.Array(value :_*))
    
    @scala.inline
    def setRectangles(value: js.Array[typingsSlinky.identiconJs.anon.Color]): Self = this.set("rectangles", value.asInstanceOf[js.Any])
