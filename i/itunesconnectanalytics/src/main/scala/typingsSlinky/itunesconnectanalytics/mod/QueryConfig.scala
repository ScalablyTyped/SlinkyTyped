...
trait QueryConfig extends js.Object {
  ...
  var frequency: js.UndefOr[typingsSlinky.itunesconnectanalytics.mod.frequency] = js.native
  var group: js.UndefOr[QueryGroup] = js.native
  var measures: js.UndefOr[
    typingsSlinky.itunesconnectanalytics.mod.measures | js.Array[typingsSlinky.itunesconnectanalytics.mod.measures]
  ] = js.native
