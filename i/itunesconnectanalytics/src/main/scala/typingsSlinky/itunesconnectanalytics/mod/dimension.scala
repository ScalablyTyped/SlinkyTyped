...
object dimension extends js.Object {
  ...
  /* "region" */ @js.native
  object region
    extends TopLevel[typingsSlinky.itunesconnectanalytics.mod.dimension.region with String]
  ...
  object territory
    extends TopLevel[typingsSlinky.itunesconnectanalytics.mod.dimension.territory with String]
