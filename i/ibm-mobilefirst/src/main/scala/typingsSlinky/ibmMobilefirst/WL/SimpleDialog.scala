...
object SimpleDialog {
  ...
  object Options {
    ...
    @scala.inline
    def apply(text: String, title: String): typingsSlinky.ibmMobilefirst.WL.SimpleDialog.Options = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.ibmMobilefirst.WL.SimpleDialog.Options]
    }
    
    @scala.inline
    implicit class OptionsMutableBuilder[Self <: typingsSlinky.ibmMobilefirst.WL.SimpleDialog.Options] (val x: Self) extends AnyVal {
