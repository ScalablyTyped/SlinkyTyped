...
import typingsSlinky.ibmMobilefirst.WL.TabBar.ItemOptions
...
object TabBar extends js.Object {
  ...
  def addItem(id: String, callback: js.Function, title: String, options: ItemOptions): typingsSlinky.ibmMobilefirst.WL.TabBarItem = js.native
