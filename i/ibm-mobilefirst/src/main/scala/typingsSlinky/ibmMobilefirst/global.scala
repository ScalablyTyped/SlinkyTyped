...
import typingsSlinky.ibmMobilefirst.WL.Device.NetworkInfo
...
import typingsSlinky.ibmMobilefirst.WL.SimpleDialog.Button
...
object global {
  ...
  object WL {
    ...
    object JSONStore {
      ...
      @JSGlobal("WL.JSONStore.init")
      @js.native
      def init(collections: js.Any, options: typingsSlinky.ibmMobilefirst.WL.JSONStore.InitOptions): JQueryDeferred[_] = js.native
      ...
      @JSGlobal("WL.JSONStore.initCollection")
      @js.native
      def initCollection(name: String, searchFields: js.Any, options: typingsSlinky.ibmMobilefirst.WL.JSONStore.InitOptions): typingsSlinky.ibmMobilefirst.WL.JSONStore.JSONStoreInstance = js.native
    ...
    @JSGlobal("WL.Logger")
    @js.native
    def Logger: typingsSlinky.ibmMobilefirst.WL.LoggerObject = js.native
    ...
    @js.native
    class LoggerObject ()
      extends typingsSlinky.ibmMobilefirst.WL.LoggerObject
    
    @scala.inline
    def Logger_=(x: typingsSlinky.ibmMobilefirst.WL.LoggerObject): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Logger")(x.asInstanceOf[js.Any])
    ...
    object SimpleDialog {
      ...
      def show(
        ...
        options: typingsSlinky.ibmMobilefirst.WL.SimpleDialog.Options
      ): Unit = js.native
    }
  ...
  class WLResourceRequest protected ()
    extends typingsSlinky.ibmMobilefirst.WLResourceRequest {
