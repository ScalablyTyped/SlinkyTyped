package typingsSlinky.imagemapster.mod._Global_

import typingsSlinky.imagemapster.mod._Global_.ImageMapster.AreaRenderingOptions
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Deselect
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Get
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.GetOptions
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Highlight
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Keys
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Options
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Rebind
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.RenderingOptions
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Resize
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Select
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Set
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.SetOptions
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Snapshot
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Tooltip
import typingsSlinky.imagemapster.mod._Global_.ImageMapster.Unbind
