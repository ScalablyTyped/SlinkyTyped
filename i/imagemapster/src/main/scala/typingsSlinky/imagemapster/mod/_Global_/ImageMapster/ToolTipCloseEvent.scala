...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.imagemapster.imagemapsterStrings.`area-mouseout`
  - typingsSlinky.imagemapster.imagemapsterStrings.`area-click`
  - typingsSlinky.imagemapster.imagemapsterStrings.`tooltip-click`
  - typingsSlinky.imagemapster.imagemapsterStrings.`image-mouseout`
*/
trait ToolTipCloseEvent extends js.Object
