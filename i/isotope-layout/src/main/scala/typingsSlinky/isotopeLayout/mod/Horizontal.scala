...
object Horizontal {
  ...
  implicit class HorizontalOps[Self <: Horizontal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withVerticalAligment(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("verticalAligment")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutVerticalAligment: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("verticalAligment")(js.undefined)
        ret
    }
  }
