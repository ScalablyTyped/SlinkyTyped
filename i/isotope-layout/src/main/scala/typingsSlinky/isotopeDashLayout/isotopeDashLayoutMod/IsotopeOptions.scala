...
object IsotopeOptions {
  ...
  def apply(
    ...
    if (cellsByRow != null) __obj.updateDynamic("cellsByRow")(cellsByRow.asInstanceOf[js.Any])
    if (containerStyle != null) __obj.updateDynamic("containerStyle")(containerStyle.asInstanceOf[js.Any])
    if (filter != null) __obj.updateDynamic("filter")(filter.asInstanceOf[js.Any])
    if (fitRows != null) __obj.updateDynamic("fitRows")(fitRows.asInstanceOf[js.Any])
    if (getSortData != null) __obj.updateDynamic("getSortData")(getSortData.asInstanceOf[js.Any])
    if (hiddenStyle != null) __obj.updateDynamic("hiddenStyle")(hiddenStyle.asInstanceOf[js.Any])
    if (horiz != null) __obj.updateDynamic("horiz")(horiz.asInstanceOf[js.Any])
    ...
    if (masontryHorizontal != null) __obj.updateDynamic("masontryHorizontal")(masontryHorizontal.asInstanceOf[js.Any])
    ...
    if (packery != null) __obj.updateDynamic("packery")(packery.asInstanceOf[js.Any])
