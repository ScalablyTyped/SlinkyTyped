...
object global {
  ...
  object intlTelInputUtils {
    ...
    object numberFormat extends StObject {
      ...
      /* 0 */ val E164: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberFormat.E164 with Double = js.native
      
      @js.native
      sealed trait INTERNATIONAL extends numberFormat
      /* 1 */ val INTERNATIONAL: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberFormat.INTERNATIONAL with Double = js.native
      
      @js.native
      sealed trait NATIONAL extends numberFormat
      /* 2 */ val NATIONAL: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberFormat.NATIONAL with Double = js.native
      
      @js.native
      sealed trait RFC3966 extends numberFormat
      /* 3 */ val RFC3966: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberFormat.RFC3966 with Double = js.native
    }
    ...
    object numberType extends StObject {
      ...
      /* 0 */ val FIXED_LINE: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.FIXED_LINE with Double = js.native
      
      @js.native
      sealed trait FIXED_LINE_OR_MOBILE extends numberType
      /* 2 */ val FIXED_LINE_OR_MOBILE: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.FIXED_LINE_OR_MOBILE with Double = js.native
      
      @js.native
      sealed trait MOBILE extends numberType
      /* 1 */ val MOBILE: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.MOBILE with Double = js.native
      
      @js.native
      sealed trait PAGER extends numberType
      /* 8 */ val PAGER: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.PAGER with Double = js.native
      
      @js.native
      sealed trait PERSONAL_NUMBER extends numberType
      /* 7 */ val PERSONAL_NUMBER: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.PERSONAL_NUMBER with Double = js.native
      
      @js.native
      sealed trait PREMIUM_RATE extends numberType
      /* 4 */ val PREMIUM_RATE: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.PREMIUM_RATE with Double = js.native
      
      @js.native
      sealed trait SHARED_COST extends numberType
      /* 5 */ val SHARED_COST: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.SHARED_COST with Double = js.native
      
      @js.native
      sealed trait TOLL_FREE extends numberType
      /* 3 */ val TOLL_FREE: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.TOLL_FREE with Double = js.native
      
      @js.native
      sealed trait UAN extends numberType
      /* 9 */ val UAN: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.UAN with Double = js.native
      
      @js.native
      sealed trait UNKNOWN extends numberType
      /* -1 */ val UNKNOWN: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.UNKNOWN with Double = js.native
      
      @js.native
      sealed trait VOICEMAIL extends numberType
      /* 10 */ val VOICEMAIL: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.VOICEMAIL with Double = js.native
      
      @js.native
      sealed trait VOIP extends numberType
      /* 6 */ val VOIP: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.numberType.VOIP with Double = js.native
    }
    ...
    object validationError extends StObject {
      ...
      /* 1 */ val INVALID_COUNTRY_CODE: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.validationError.INVALID_COUNTRY_CODE with Double = js.native
      
      @js.native
      sealed trait IS_POSSIBLE extends validationError
      /* 0 */ val IS_POSSIBLE: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.validationError.IS_POSSIBLE with Double = js.native
      
      @js.native
      sealed trait NOT_A_NUMBER extends validationError
      /* 4 */ val NOT_A_NUMBER: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.validationError.NOT_A_NUMBER with Double = js.native
      
      @js.native
      sealed trait TOO_LONG extends validationError
      /* 3 */ val TOO_LONG: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.validationError.TOO_LONG with Double = js.native
      
      @js.native
      sealed trait TOO_SHORT extends validationError
      /* 2 */ val TOO_SHORT: typingsSlinky.intlTelInput.mod.global.intlTelInputUtils.validationError.TOO_SHORT with Double = js.native
    }
  }
