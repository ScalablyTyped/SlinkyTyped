...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDoneButtonComponent(value: ReactComponentClass[DoneButtonProps]): Self = this.set("DoneButtonComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDoneButtonComponent: Self = this.set("DoneButtonComponent", js.undefined)
    
    @scala.inline
    def setDotComponent(value: ReactComponentClass[DotProps]): Self = this.set("DotComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDotComponent: Self = this.set("DotComponent", js.undefined)
    
    @scala.inline
    def setNextButtonComponent(value: ReactComponentClass[NextButtonProps]): Self = this.set("NextButtonComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNextButtonComponent: Self = this.set("NextButtonComponent", js.undefined)
    
    @scala.inline
    def setSkipButtonComponent(value: ReactComponentClass[SkipButtonProps]): Self = this.set("SkipButtonComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNextLabel(value: String | ReactElement): Self = this.set("nextLabel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSkipLabelReactElement(value: ReactElement): Self = this.set("skipLabel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSkipLabel(value: String | ReactElement): Self = this.set("skipLabel", value.asInstanceOf[js.Any])
