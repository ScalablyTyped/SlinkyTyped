...
object anon {
  ...
  @js.native
  trait PickBaseSheetPropshiddenv extends StObject {
  ...
  object PickBaseSheetPropshiddenv {
    ...
    @scala.inline
    implicit class PickBaseSheetPropshiddenvMutableBuilder[Self <: PickBaseSheetPropshiddenv] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait PickBaseSheetPropshiddenvAbout extends StObject {
  ...
  object PickBaseSheetPropshiddenvAbout {
    ...
    @scala.inline
    implicit class PickBaseSheetPropshiddenvAboutMutableBuilder[Self <: PickBaseSheetPropshiddenvAbout] (val x: Self) extends AnyVal {
