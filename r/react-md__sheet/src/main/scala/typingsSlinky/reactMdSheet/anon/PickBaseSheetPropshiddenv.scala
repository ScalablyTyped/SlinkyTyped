...
object PickBaseSheetPropshiddenv {
  ...
  @scala.inline
  def apply(`aria-label`: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseSheetPropshiddenv = {
    ...
    __obj.asInstanceOf[PickBaseSheetPropshiddenv]
  }
  
  @scala.inline
  implicit class PickBaseSheetPropshiddenvOps[Self <: PickBaseSheetPropshiddenv] (val x: Self) extends AnyVal {
