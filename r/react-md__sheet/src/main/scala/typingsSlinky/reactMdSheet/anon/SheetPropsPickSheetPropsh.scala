package typingsSlinky.reactMdSheet.anon
...
object SheetPropsPickSheetPropsh {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SheetPropsPickSheetPropsh]
  }
  
  @scala.inline
  implicit class SheetPropsPickSheetPropshOps[Self <: SheetPropsPickSheetPropsh] (val x: Self) extends AnyVal {
