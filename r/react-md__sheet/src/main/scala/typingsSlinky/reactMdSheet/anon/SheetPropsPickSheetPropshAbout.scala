...
object SheetPropsPickSheetPropshAbout {
  ...
  def apply(
    ...
    onRequestClose: () => Unit,
    visible: Boolean
  ): SheetPropsPickSheetPropshAbout = {
    ...
    __obj.asInstanceOf[SheetPropsPickSheetPropshAbout]
  }
  @scala.inline
  implicit class SheetPropsPickSheetPropshAboutOps[Self <: SheetPropsPickSheetPropshAbout] (val x: Self) extends AnyVal {
    @scala.inline
