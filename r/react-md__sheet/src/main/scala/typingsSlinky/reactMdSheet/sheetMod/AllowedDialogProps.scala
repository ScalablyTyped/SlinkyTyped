...
object AllowedDialogProps {
  @scala.inline
  def apply(id: String, onRequestClose: () => Unit, visible: Boolean): AllowedDialogProps = {
  ...
  @scala.inline
  implicit class AllowedDialogPropsOps[Self <: AllowedDialogProps] (val x: Self) extends AnyVal {
    @scala.inline
