...
object Box {
  ...
  implicit def make(companion: Box.type): SharedBuilder_PropsWithChildren920194122[HTMLDivElement] = new SharedBuilder_PropsWithChildren920194122[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
}
