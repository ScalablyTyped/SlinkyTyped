...
object Flex {
  ...
  implicit def make(companion: Flex.type): SharedBuilder_PropsWithChildren_246298044[HTMLDivElement] = new SharedBuilder_PropsWithChildren_246298044[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
}
