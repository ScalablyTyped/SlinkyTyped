...
object Flex {
  ...
  implicit def make(companion: Flex.type): SharedBuilder_DetailedHTMLPropsOmit0_272721071[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsOmit0_272721071[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
