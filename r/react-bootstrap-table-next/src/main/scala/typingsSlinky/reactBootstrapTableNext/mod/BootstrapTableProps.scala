...
object BootstrapTableProps {
  ...
  implicit class BootstrapTablePropsMutableBuilder[Self <: BootstrapTableProps[_, _], T /* <: js.Object */, K] (val x: Self with (BootstrapTableProps[T, K])) extends AnyVal {
    ...
    @scala.inline
    def setCaption(value: ReactElement | String): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCaptionReactElement(value: ReactElement): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNoDataIndication(value: (js.Function0[ReactElement | String]) | ReactElement | String): Self = StObject.set(x, "noDataIndication", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNoDataIndicationFunction0(value: () => ReactElement | String): Self = StObject.set(x, "noDataIndication", js.Any.fromFunction0(value))
    
    @scala.inline
    def setNoDataIndicationReactElement(value: ReactElement): Self = StObject.set(x, "noDataIndication", value.asInstanceOf[js.Any])
