...
trait BootstrapTableProps[T /* <: js.Object */] extends js.Object {
  ...
  /**
    ...
    */
  var caption: js.UndefOr[ReactElement | String] = js.undefined
  ...
  /**
    ...
    */
  var keyField: String
  var noDataIndication: js.UndefOr[js.Function0[ReactElement | String]] = js.undefined
  /**
...
object BootstrapTableProps {
  ...
  def apply[T](
    ...
    caption: ReactElement | String = null,
    ...
    id: String = null,
    noDataIndication: () => ReactElement | String = null,
