...
object PaginationOptions {
  ...
  implicit class PaginationOptionsMutableBuilder[Self <: PaginationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPageButtonRenderer(value: /* options */ PageButtonRendererOptions => ReactElement): Self = StObject.set(x, "pageButtonRenderer", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPageButtonRendererUndefined: Self = StObject.set(x, "pageButtonRenderer", js.undefined)
    
    @scala.inline
    def setPageListRenderer(value: /* options */ PageListRendererOptions => ReactElement): Self = StObject.set(x, "pageListRenderer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPaginationTotalRenderer(value: (/* from */ Double, /* to */ Double, /* size */ Double) => ReactElement): Self = StObject.set(x, "paginationTotalRenderer", js.Any.fromFunction3(value))
    
    @scala.inline
    def setPaginationTotalRendererUndefined: Self = StObject.set(x, "paginationTotalRenderer", js.undefined)
    
    @scala.inline
    def setPrePageText(value: String | ReactElement): Self = StObject.set(x, "prePageText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPrePageTextReactElement(value: ReactElement): Self = StObject.set(x, "prePageText", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSizePerPageOptionRenderer(value: /* options */ SizePerPageOptionRendererOptions => ReactElement): Self = StObject.set(x, "sizePerPageOptionRenderer", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSizePerPageOptionRendererUndefined: Self = StObject.set(x, "sizePerPageOptionRenderer", js.undefined)
    
    @scala.inline
    def setSizePerPageRenderer(value: /* options */ SizePerPageRendererOptions => ReactElement): Self = StObject.set(x, "sizePerPageRenderer", js.Any.fromFunction1(value))
