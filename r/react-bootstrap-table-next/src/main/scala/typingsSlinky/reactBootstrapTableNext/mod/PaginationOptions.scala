...
trait PaginationOptions extends js.Object {
  ...
  var prePageText: js.UndefOr[String | ReactElement] = js.native
...
object PaginationOptions {
  ...
  implicit class PaginationOptionsOps[Self <: PaginationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstPageTextReactElement(value: ReactElement): Self = this.set("firstPageText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastPageTextReactElement(value: ReactElement): Self = this.set("lastPageText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNextPageTextReactElement(value: ReactElement): Self = this.set("nextPageText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPageButtonRenderer(value: /* options */ PageButtonRendererOptions => ReactElement): Self = this.set("pageButtonRenderer", js.Any.fromFunction1(value))
    @scala.inline
    def deletePageButtonRenderer: Self = this.set("pageButtonRenderer", js.undefined)
    @scala.inline
    def setPageListRenderer(value: /* options */ PageListRendererOptions => ReactElement): Self = this.set("pageListRenderer", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setPaginationTotalRenderer(value: (/* from */ Double, /* to */ Double, /* size */ Double) => ReactElement): Self = this.set("paginationTotalRenderer", js.Any.fromFunction3(value))
    @scala.inline
    def deletePaginationTotalRenderer: Self = this.set("paginationTotalRenderer", js.undefined)
    @scala.inline
    def setPrePageTextReactElement(value: ReactElement): Self = this.set("prePageText", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrePageText(value: String | ReactElement): Self = this.set("prePageText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSizePerPageOptionRenderer(value: /* options */ SizePerPageOptionRendererOptions => ReactElement): Self = this.set("sizePerPageOptionRenderer", js.Any.fromFunction1(value))
    @scala.inline
    def deleteSizePerPageOptionRenderer: Self = this.set("sizePerPageOptionRenderer", js.undefined)
    @scala.inline
    def setSizePerPageRenderer(value: /* options */ SizePerPageRendererOptions => ReactElement): Self = this.set("sizePerPageRenderer", js.Any.fromFunction1(value))
    @scala.inline
