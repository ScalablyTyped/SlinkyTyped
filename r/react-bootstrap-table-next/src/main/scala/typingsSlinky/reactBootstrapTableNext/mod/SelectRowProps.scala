...
object SelectRowProps {
  ...
  implicit class SelectRowPropsOps[Self <: SelectRowProps[_], T] (val x: Self with SelectRowProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setSelectionHeaderRenderer(value: /* options */ Indeterminate => ReactElement): Self = this.set("selectionHeaderRenderer", js.Any.fromFunction1(value))
    @scala.inline
    def deleteSelectionHeaderRenderer: Self = this.set("selectionHeaderRenderer", js.undefined)
    @scala.inline
    def setSelectionRenderer(value: /* options */ Checked => ReactElement): Self = this.set("selectionRenderer", js.Any.fromFunction1(value))
    @scala.inline
