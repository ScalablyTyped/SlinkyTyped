...
object ColumnDescription {
  ...
  implicit class ColumnDescriptionMutableBuilder[Self <: ColumnDescription[_, _], T /* <: js.Object */, E] (val x: Self with (ColumnDescription[T, E])) extends AnyVal {
    ...
    @scala.inline
    def setCsvFormatter(value: (_, T, /* rowIndex */ Double, E) => ReactElement | String | Boolean | ReactText): Self = StObject.set(x, "csvFormatter", js.Any.fromFunction4(value))
    ...
    @scala.inline
    def setFormatter(value: (_, T, /* rowIndex */ Double, E) => ReactElement | String | Boolean | ReactText): Self = StObject.set(x, "formatter", js.Any.fromFunction4(value))
