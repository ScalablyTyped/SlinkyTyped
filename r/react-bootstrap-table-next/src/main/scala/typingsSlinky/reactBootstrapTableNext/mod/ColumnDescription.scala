...
object ColumnDescription {
  ...
  def apply[T, E](
    ...
    csvFormatter: (_, T, /* rowIndex */ Double, E) => ReactElement | String | Boolean | ReactText = null,
    csvText: String = null,
    ...
    formatter: (_, T, /* rowIndex */ Double, E) => ReactElement | String | Boolean | ReactText = null,
    headerAlign: CellAlignment = null,
    headerFormatter: (/* column */ ColumnDescription[T, js.Any], /* colIndex */ Double, /* components */ FilterElement) => ReactElement | String | Double | ReactText = null,
