...
object RowEventHandlerProps {
  @scala.inline
  def apply[T](
    onClick: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit = null,
    onContextMenu: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit = null,
    onDoubleClick: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit = null,
    onMouseEnter: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit = null,
    onMouseLeave: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit = null
