...
object RowEventHandlerProps {
  ...
  implicit class RowEventHandlerPropsOps[Self <: RowEventHandlerProps[_], T] (val x: Self with RowEventHandlerProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit): Self = this.set("onClick", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    
    @scala.inline
    def setOnContextMenu(value: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit): Self = this.set("onContextMenu", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteOnContextMenu: Self = this.set("onContextMenu", js.undefined)
    
    @scala.inline
    def setOnDoubleClick(value: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit): Self = this.set("onDoubleClick", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteOnDoubleClick: Self = this.set("onDoubleClick", js.undefined)
    
    @scala.inline
    def setOnMouseEnter(value: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: (/* e */ SyntheticEvent[Event, Element], T, /* rowIndex */ Double) => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction3(value))
