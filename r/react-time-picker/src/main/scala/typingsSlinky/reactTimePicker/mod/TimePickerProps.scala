...
import typingsSlinky.reactTimePicker.reactTimePickerStrings.hour
import typingsSlinky.reactTimePicker.reactTimePickerStrings.minute
import typingsSlinky.reactTimePicker.reactTimePickerStrings.second
