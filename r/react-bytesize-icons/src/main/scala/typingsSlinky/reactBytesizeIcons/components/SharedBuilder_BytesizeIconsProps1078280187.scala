...
@scala.inline
class SharedBuilder_BytesizeIconsProps1078280187[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def strokeLinejoin(value: StrokeLinejoin): this.type = set("strokeLinejoin", value.asInstanceOf[js.Any])
