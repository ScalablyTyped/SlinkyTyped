...
object Lib {
  @JSImport("rc-rate/lib", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Lib.type): SharedBuilder_RateProps_1786259366[default] = new SharedBuilder_RateProps_1786259366[default](js.Array(this.component, js.Dictionary.empty))()
}
