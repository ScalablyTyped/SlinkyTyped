...
version := "1.7-dt-20200326Z-d5d95f"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "express-rate-limit" % "5.0-dt-20200219Z-c060e2",
  "org.scalablytyped.slinky" %%% "express-serve-static-core" % "4.17-dt-20200415Z-f286fc",
  "org.scalablytyped.slinky" %%% "ioredis" % "4.16-dt-20200427Z-5b31b8",
  ...
  "org.scalablytyped.slinky" %%% "redis" % "2.8-dt-20200417Z-6d0b45",
