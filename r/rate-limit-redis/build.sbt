...
version := "1.7-dt-20200326Z-db65fe"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "express-rate-limit" % "5.0-dt-20200515Z-451d5b",
  "org.scalablytyped.slinky" %%% "express-serve-static-core" % "4.17-dt-20200722Z-f4d568",
  "org.scalablytyped.slinky" %%% "ioredis" % "4.17-dt-20200710Z-28172d",
  ...
  "org.scalablytyped.slinky" %%% "redis" % "2.8-dt-20200710Z-d55fd2",
