...
version := "1.7-dt-20200326Z-5f3194"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "express-rate-limit" % "5.1-dt-20200821Z-ee729e",
  "org.scalablytyped.slinky" %%% "express-serve-static-core" % "4.17-dt-20200921Z-935502",
  "org.scalablytyped.slinky" %%% "ioredis" % "4.17-dt-20201115Z-b93ec4",
  ...
  "org.scalablytyped.slinky" %%% "redis" % "2.8-dt-20201013Z-deff3f",
