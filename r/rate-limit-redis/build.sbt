...
version := "1.7-dt-20200326Z-318d19"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "express-rate-limit" % "5.0-dt-20200515Z-f200da",
  ...
  "org.scalablytyped.slinky" %%% "redis" % "2.8-dt-20200515Z-673315",
