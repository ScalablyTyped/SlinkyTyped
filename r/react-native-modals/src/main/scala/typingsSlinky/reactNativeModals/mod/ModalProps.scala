...
trait ModalProps extends StObject {
  ...
  var modalTitle: js.UndefOr[ReactElement] = js.native
...
object ModalProps {
  ...
  implicit class ModalPropsMutableBuilder[Self <: ModalProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModalTitle(value: ReactElement): Self = StObject.set(x, "modalTitle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setModalTitleReactElement(value: ReactElement): Self = StObject.set(x, "modalTitle", value.asInstanceOf[js.Any])
