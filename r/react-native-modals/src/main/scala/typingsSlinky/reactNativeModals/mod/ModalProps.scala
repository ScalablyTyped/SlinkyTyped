...
object ModalProps {
  ...
  implicit class ModalPropsOps[Self <: ModalProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModalTitleReactElement(value: ReactElement): Self = this.set("modalTitle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setModalTitle(value: ReactElement): Self = this.set("modalTitle", value.asInstanceOf[js.Any])
