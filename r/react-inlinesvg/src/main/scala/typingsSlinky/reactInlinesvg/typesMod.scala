...
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.assertive
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.both
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.copy
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.date
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.decimal
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.descending
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.dialog
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.email
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.execute
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.grammar
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.grid
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.horizontal
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.inherit
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.link
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.list
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.listbox
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.location
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.menu
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.mixed
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.move
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.no
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.none
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.numeric
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.off
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.on
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.other
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.page
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.polite
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.popup
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.removals
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.search
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.spelling
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.step
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.tel
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.text
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.time
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.tree
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.url
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.vertical
import typingsSlinky.reactInlinesvg.reactInlinesvgStrings.yes
...
object typesMod {
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLoaderReactElement(value: ReactElement): Self = StObject.set(x, "loader", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnError(value: /* error */ js.Error | FetchError => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction1(value))
