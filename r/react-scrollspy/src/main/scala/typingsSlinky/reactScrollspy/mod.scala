...
object mod {
  ...
  object ScrollspyProps {
    ...
    implicit class ScrollspyPropsMutableBuilder[Self <: ScrollspyProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentTag(value: String | ReactComponentClass[js.Object]): Self = StObject.set(x, "componentTag", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentTagComponentClass(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "componentTag", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentTagFunctionComponent(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "componentTag", value.asInstanceOf[js.Any])
