...
object ScrollspyProps {
  ...
  implicit class ScrollspyPropsOps[Self <: ScrollspyProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentTagFunctionComponent(value: ReactComponentClass[js.Object]): Self = this.set("componentTag", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentTagComponentClass(value: ReactComponentClass[js.Object]): Self = this.set("componentTag", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentTag(value: String | ReactComponentClass[js.Object]): Self = this.set("componentTag", value.asInstanceOf[js.Any])
    @scala.inline
