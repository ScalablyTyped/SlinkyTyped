package typingsSlinky.reactNativeCommunityMaskedView.components
...
import typingsSlinky.reactNativeCommunityMaskedView.mod.MaskedViewProps
import typingsSlinky.reactNativeCommunityMaskedView.mod.default
...
object MaskedView {
  ...
  def withProps(p: MaskedViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(maskElement: ReactElement): Builder = {
    val __props = js.Dynamic.literal(maskElement = maskElement.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MaskedViewProps]))
  }
}
