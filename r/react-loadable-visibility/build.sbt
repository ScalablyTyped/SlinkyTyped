...
version := "3.0-dt-20191126Z-83c879"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "loadable__component" % "5.10-dt-20190711Z-7c849a",
  ...
  "org.scalablytyped.slinky" %%% "react-loadable" % "5.5-dt-20191126Z-9146df",
