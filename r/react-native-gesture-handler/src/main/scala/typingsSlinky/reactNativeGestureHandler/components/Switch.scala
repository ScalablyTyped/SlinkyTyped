...
object Switch {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.Switch] {
    @scala.inline
    ...
    @scala.inline
    def onValueChange(value: /* value */ Boolean => Unit): this.type = set("onValueChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def trackColor(value: AnonFalse): this.type = set("trackColor", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: NativeViewGestureHandlerProperties with SwitchProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
