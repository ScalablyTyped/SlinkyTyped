...
object DrawerLayoutAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeGestureHandler.mod.DrawerLayoutAndroid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.DrawerLayoutAndroid] = {
