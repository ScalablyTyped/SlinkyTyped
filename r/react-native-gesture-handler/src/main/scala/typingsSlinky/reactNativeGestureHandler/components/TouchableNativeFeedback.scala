...
import typingsSlinky.reactNative.mod.TouchableNativeFeedbackProperties
...
object TouchableNativeFeedback
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeGestureHandler.mod.TouchableNativeFeedback] {
  ...
  def TouchableNativeFeedbackProps(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.TouchableNativeFeedback] = {
  ...
  /* The following DOM/SVG props were specified: disabled */
  def ContainedTouchableProperties(containerStyle: StyleProp[ViewStyle] = null, _overrides: StringDictionary[js.Any] = null): BuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.TouchableNativeFeedback] = {
    val __obj = js.Dynamic.literal()
    if (containerStyle != null) __obj.updateDynamic("containerStyle")(containerStyle.asInstanceOf[js.Any])
    if (_overrides != null) js.Dynamic.global.Object.assign(__obj, _overrides)
    super.apply(__obj.asInstanceOf[Props])
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.TouchableNativeFeedback] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeGestureHandler.mod.TouchableNativeFeedback](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
