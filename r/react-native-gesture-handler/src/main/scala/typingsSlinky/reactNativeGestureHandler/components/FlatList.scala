...
object FlatList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeGestureHandler.mod.FlatList[js.Any]] {
  ...
  def apply[ItemT](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.FlatList[js.Any]] = {
    ...
    if (ListFooterComponentStyle != null) __obj.updateDynamic("ListFooterComponentStyle")(ListFooterComponentStyle.asInstanceOf[js.Any])
    if (ListHeaderComponent != null) __obj.updateDynamic("ListHeaderComponent")(ListHeaderComponent.asInstanceOf[js.Any])
    if (ListHeaderComponentStyle != null) __obj.updateDynamic("ListHeaderComponentStyle")(ListHeaderComponentStyle.asInstanceOf[js.Any])
  ...
  typingsSlinky.reactNativeGestureHandler.mod.FlatList[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.FlatList[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeGestureHandler.mod.FlatList[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = NativeViewGestureHandlerProperties with FlatListProperties[js.Any]
}
