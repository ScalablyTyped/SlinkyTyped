...
object RawButton {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.RawButton] {
  ...
  def withProps(p: RawButtonProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: RawButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
