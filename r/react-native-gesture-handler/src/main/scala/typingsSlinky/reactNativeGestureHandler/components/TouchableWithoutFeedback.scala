...
object TouchableWithoutFeedback {
  object TouchableWithoutFeedbackProps {
    ...
    class Builder (val args: js.Array[js.Any])
      extends AnyVal
         with StBuildingComponent[tag.type, typingsSlinky.reactNativeGestureHandler.mod.TouchableWithoutFeedback] {
      @scala.inline
    ...
    def withProps(p: typingsSlinky.reactNative.mod.TouchableWithoutFeedbackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    implicit def make(companion: TouchableWithoutFeedbackProps.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  }
