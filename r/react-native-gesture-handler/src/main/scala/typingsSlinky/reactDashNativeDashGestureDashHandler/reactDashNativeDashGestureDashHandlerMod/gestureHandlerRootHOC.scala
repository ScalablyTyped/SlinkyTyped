...
object gestureHandlerRootHOC extends js.Object {
  def apply(Component: ComponentType[_]): ReactComponentClass[_] = js.native
  def apply(Component: ComponentType[_], containerStyles: StyleProp[ViewStyle]): ReactComponentClass[_] = js.native
}
