...
object TouchableHighlight
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.TouchableHighlight].asInstanceOf[String | js.Object]
  def apply(
