...
object Props {
  ...
  def apply[HolderProps](
    ...
    positionRecheckInterval: js.UndefOr[Double] = js.undefined,
    prefix: String = null,
    ...
    if (!js.isUndefined(hideOnBoundaryHit)) __obj.updateDynamic("hideOnBoundaryHit")(hideOnBoundaryHit.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(positionRecheckInterval)) __obj.updateDynamic("positionRecheckInterval")(positionRecheckInterval.get.asInstanceOf[js.Any])
