package typingsSlinky.reactStickyEl.components
...
object ReactStickyEl {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def boundaryElement(value: String): this.type = set("boundaryElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def hideOnBoundaryHit(value: Boolean): this.type = set("hideOnBoundaryHit", value.asInstanceOf[js.Any])
    @scala.inline
    def holderCmp(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 118 */ js.Any): this.type = set("holderCmp", value.asInstanceOf[js.Any])
    @scala.inline
    def holderProps(value: js.Object): this.type = set("holderProps", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def mode(value: top | bottom): this.type = set("mode", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onFixedToggle(value: /* fixed */ Boolean => Unit): this.type = set("onFixedToggle", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def positionRecheckInterval(value: Double): this.type = set("positionRecheckInterval", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def scrollElement(value: String): this.type = set("scrollElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stickyStyle(value: CSSProperties): this.type = set("stickyStyle", value.asInstanceOf[js.Any])
    @scala.inline
