package typingsSlinky.reactDashInstantsearchDashNative.components

import org.scalablytyped.runtime.StringDictionary
import slinky.core.BuildingComponent
import slinky.core.ExternalComponentWithAttributesWithRefType
import slinky.web.html.`*`.tag
import typingsSlinky.reactDashInstantsearchDashNative.Anon_Args
import typingsSlinky.reactDashInstantsearchDashNative.reactDashInstantsearchDashNativeMod.InstantSearchProps
...
object InstantSearch
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashInstantsearchDashNative.reactDashInstantsearchDashNativeMod.InstantSearch
    ] {
