...
object InstantSearch
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactInstantsearchNative.mod.InstantSearch] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactInstantsearchNative.mod.InstantSearch] = {
