...
object BreadcrumbsProps {
  ...
  implicit class BreadcrumbsPropsOps[Self <: BreadcrumbsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFinalItemElement(value: Element): Self = this.set("finalItem", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSeparatorElement(value: Element): Self = this.set("separator", value.asInstanceOf[js.Any])
    @scala.inline
