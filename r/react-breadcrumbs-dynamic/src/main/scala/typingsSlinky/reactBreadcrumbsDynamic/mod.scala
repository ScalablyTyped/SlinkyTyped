package typingsSlinky.reactBreadcrumbsDynamic
...
object mod {
  ...
  object BreadcrumbsProps {
    ...
    implicit class BreadcrumbsPropsMutableBuilder[Self <: BreadcrumbsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFinalItemElement(value: Element): Self = StObject.set(x, "finalItem", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSeparatorElement(value: Element): Self = StObject.set(x, "separator", value.asInstanceOf[js.Any])
