...
object Breadcrumbs
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBreadcrumbsDynamic.mod.Breadcrumbs] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBreadcrumbsDynamic.mod.Breadcrumbs] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactBreadcrumbsDynamic.mod.Breadcrumbs] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactBreadcrumbsDynamic.mod.Breadcrumbs](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
