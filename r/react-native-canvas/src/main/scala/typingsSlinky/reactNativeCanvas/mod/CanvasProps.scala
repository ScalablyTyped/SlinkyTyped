...
object CanvasProps {
  ...
  implicit class CanvasPropsOps[Self <: CanvasProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[Canvas]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* canvas */ Canvas => _): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: (js.Function1[/* canvas */ Canvas, _]) | ReactRef[Canvas]): Self = this.set("ref", value.asInstanceOf[js.Any])
