package typingsSlinky.reactNativeCanvas
...
object mod {
  ...
  object CanvasProps {
    ...
    implicit class CanvasPropsMutableBuilder[Self <: CanvasProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: (js.Function1[/* canvas */ Canvas, _]) | ReactRef[Canvas]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* canvas */ Canvas => _): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRefRefObject(value: ReactRef[Canvas]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
