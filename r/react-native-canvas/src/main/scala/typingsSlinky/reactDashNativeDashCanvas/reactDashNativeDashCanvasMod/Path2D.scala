package typingsSlinky.reactDashNativeDashCanvas.reactDashNativeDashCanvasMod

import typingsSlinky.reactDashNativeDashCanvas.Anon_A
...
class Path2D protected () extends js.Object {
  ...
  def addPath(path: Path2D, transform: Anon_A): Unit = js.native
}
