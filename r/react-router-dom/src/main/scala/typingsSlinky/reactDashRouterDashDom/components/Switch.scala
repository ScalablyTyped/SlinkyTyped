...
object Switch
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashRouterDashDom.reactDashRouterDashDomMod.Switch].asInstanceOf[String | js.Object]
