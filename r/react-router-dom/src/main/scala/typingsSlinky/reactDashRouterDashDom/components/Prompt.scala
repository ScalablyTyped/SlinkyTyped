...
object Prompt
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashRouterDashDom.reactDashRouterDashDomMod.Prompt].asInstanceOf[String | js.Object]
  def apply(
