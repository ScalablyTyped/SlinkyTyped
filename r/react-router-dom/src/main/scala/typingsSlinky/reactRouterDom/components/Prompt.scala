...
object Prompt
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterDom.mod.Prompt] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterDom.mod.Prompt] = {
