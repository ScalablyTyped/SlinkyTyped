...
object NavLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterDom.mod.NavLink[js.Any]] {
  ...
  def apply[S](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterDom.mod.NavLink[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.reactRouterDom.mod.NavLink[js.Any]]]
  }
