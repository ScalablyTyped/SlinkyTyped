...
object BrowserRouter
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterDom.mod.BrowserRouter] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterDom.mod.BrowserRouter] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactRouterDom.mod.BrowserRouter] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactRouterDom.mod.BrowserRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
