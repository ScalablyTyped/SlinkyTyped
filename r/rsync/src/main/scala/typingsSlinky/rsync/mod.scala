...
object mod extends Shortcut {
  ...
  trait Rsync extends StObject {
    ...
    def execute(callback: js.Function3[/* err */ js.Error, /* code */ Double, /* cmd */ String, Unit]): ChildProcess = js.native
    def execute(
      callback: js.Function3[/* err */ js.Error, /* code */ Double, /* cmd */ String, Unit],
