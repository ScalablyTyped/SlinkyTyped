...
import typingsSlinky.popperDotJs.popperDotJsMod.Popper.Modifiers
...
abstract class SharedApply_TooltipTriggerProps_377610778[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
