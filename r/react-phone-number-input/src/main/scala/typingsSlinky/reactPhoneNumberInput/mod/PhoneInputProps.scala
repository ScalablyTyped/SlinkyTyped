...
trait PhoneInputProps extends js.Object {
  ...
  var countrySelectComponent: js.UndefOr[ReactComponentClass[CountrySelectComponentProps]] = js.undefined
  /**
  ...
  var flagComponent: js.UndefOr[ReactComponentClass[Country]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var internationalIcon: js.UndefOr[ReactComponentClass[js.Object]] = js.undefined
...
object PhoneInputProps {
  ...
  def apply(
    ...
    countrySelectProps: js.UndefOr[Double] = js.undefined,
    ...
    error: String = null,
    flagComponent: ReactComponentClass[Country] = null,
    flagUrl: String = null,
    flags: FlagsMap = null,
    form: String = null,
    ...
    onAbort: SyntheticEvent[Event, String] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with String, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[String] => Unit = null,
    onCanPlay: SyntheticEvent[Event, String] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, String] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, String] => Unit = null,
    onEmptied: SyntheticEvent[Event, String] => Unit = null,
    onEncrypted: SyntheticEvent[Event, String] => Unit = null,
    onEnded: SyntheticEvent[Event, String] => Unit = null,
    onError: SyntheticEvent[Event, String] => Unit = null,
    onFocus: SyntheticFocusEvent[String] => Unit = null,
    onInput: SyntheticEvent[EventTarget with String, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with String, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, String] => Unit = null,
    onLoadStart: SyntheticEvent[Event, String] => Unit = null,
    onLoadedData: SyntheticEvent[Event, String] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, String] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, String] => Unit = null,
    onPlay: SyntheticEvent[Event, String] => Unit = null,
    onPlaying: SyntheticEvent[Event, String] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, String] => Unit = null,
    onRateChange: SyntheticEvent[Event, String] => Unit = null,
    onReset: SyntheticEvent[EventTarget with String, Event] => Unit = null,
    onScroll: SyntheticUIEvent[String] => Unit = null,
    onSeeked: SyntheticEvent[Event, String] => Unit = null,
    onSeeking: SyntheticEvent[Event, String] => Unit = null,
    onSelect: SyntheticEvent[Event, String] => Unit = null,
    onStalled: SyntheticEvent[Event, String] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with String, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, String] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, String] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, String] => Unit = null,
    onWaiting: SyntheticEvent[Event, String] => Unit = null,
    ...
    if (!js.isUndefined(addInternationalOption)) __obj.updateDynamic("addInternationalOption")(addInternationalOption.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(countrySelectProps)) __obj.updateDynamic("countrySelectProps")(countrySelectProps.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(displayInitialValueAsLocalNumber)) __obj.updateDynamic("displayInitialValueAsLocalNumber")(displayInitialValueAsLocalNumber.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(international)) __obj.updateDynamic("international")(international.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(limitMaxLength)) __obj.updateDynamic("limitMaxLength")(limitMaxLength.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showCountrySelect)) __obj.updateDynamic("showCountrySelect")(showCountrySelect.get.asInstanceOf[js.Any])
    if (!js.isUndefined(size)) __obj.updateDynamic("size")(size.get.asInstanceOf[js.Any])
    if (slot != null) __obj.updateDynamic("slot")(slot.asInstanceOf[js.Any])
    if (!js.isUndefined(smartCaret)) __obj.updateDynamic("smartCaret")(smartCaret.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useNationalFormatForDefaultCountryValue)) __obj.updateDynamic("useNationalFormatForDefaultCountryValue")(useNationalFormatForDefaultCountryValue.get.asInstanceOf[js.Any])
