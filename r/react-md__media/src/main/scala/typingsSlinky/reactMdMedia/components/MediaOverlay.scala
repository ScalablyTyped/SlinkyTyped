package typingsSlinky.reactMdMedia.components
...
object MediaOverlay {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def position(value: MediaOverlayPosition): this.type = set("position", value.asInstanceOf[js.Any])
  ...
  def withProps(p: MediaOverlayProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
