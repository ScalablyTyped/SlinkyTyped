package typingsSlinky.reactSideEffect.anon
...
object Peek {
  ...
  @scala.inline
  implicit class PeekOps[Self[tpeek, trewind] <: Peek[tpeek, trewind], TPeek, TRewind] (val x: Self[TPeek, TRewind]) extends AnyVal {
    @scala.inline
