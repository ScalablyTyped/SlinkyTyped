...
object RowProps {
  ...
  implicit class RowPropsOps[Self <: RowProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLg(value: Double | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMd(value: Double | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNoGutters(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noGutters")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNoGutters: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noGutters")(js.undefined)
        ret
    }
    @scala.inline
