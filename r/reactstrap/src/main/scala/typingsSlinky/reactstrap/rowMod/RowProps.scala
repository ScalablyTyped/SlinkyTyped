package typingsSlinky.reactstrap.rowMod
...
/* Inlined parent reactstrap.reactstrap/es/Row.Omit<react.react.HTMLAttributes<std.HTMLElement>, 'form'> */
@js.native
trait RowProps
...
object RowProps {
  ...
  implicit class RowPropsOps[Self <: RowProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLg(value: Double | String): Self = this.set("lg", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLg: Self = this.set("lg", js.undefined)
    
    @scala.inline
    def setMd(value: Double | String): Self = this.set("md", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMd: Self = this.set("md", js.undefined)
    
    @scala.inline
    def setNoGutters(value: Boolean): Self = this.set("noGutters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNoGutters: Self = this.set("noGutters", js.undefined)
    ...
    @scala.inline
    def setSm(value: Double | String): Self = this.set("sm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setXl(value: Double | String): Self = this.set("xl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteXl: Self = this.set("xl", js.undefined)
    
    @scala.inline
    def setXs(value: Double | String): Self = this.set("xs", value.asInstanceOf[js.Any])
