...
import typingsSlinky.reactstrap.libCardImgOverlayMod.CardImgOverlayProps
import typingsSlinky.reactstrap.libCardImgOverlayMod.default
...
object CardImgOverlay
  ...
  typingsSlinky.reactstrap.libCardImgOverlayMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardImgOverlayMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CardImgOverlayProps
}
