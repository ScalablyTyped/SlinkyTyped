...
import typingsSlinky.reactstrap.libFormMod.FormProps
import typingsSlinky.reactstrap.libFormMod.default
...
object Form
  ...
  def apply[T](
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.form.tag.type, typingsSlinky.reactstrap.libFormMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[slinky.web.html.form.tag.type, typingsSlinky.reactstrap.libFormMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
