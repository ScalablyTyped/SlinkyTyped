...
import typingsSlinky.reactstrap.libButtonToolbarMod.ButtonToolbarProps
import typingsSlinky.reactstrap.libButtonToolbarMod.default
...
object ButtonToolbar
  ...
  typingsSlinky.reactstrap.libButtonToolbarMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libButtonToolbarMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
