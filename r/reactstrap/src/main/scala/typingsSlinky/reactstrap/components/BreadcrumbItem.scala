...
import typingsSlinky.reactstrap.libBreadcrumbItemMod.BreadcrumbItemProps
import typingsSlinky.reactstrap.libBreadcrumbItemMod.default
...
object BreadcrumbItem
  ...
  typingsSlinky.reactstrap.libBreadcrumbItemMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libBreadcrumbItemMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
