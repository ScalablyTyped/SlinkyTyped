...
object CarouselIndicators {
  ...
  def withProps[T](p: CarouselIndicatorsProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](activeIndex: Double, items: js.Array[js.Object], onClickHandler: Double => Unit): Builder[T] = {
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[CarouselIndicatorsProps]))
  }
}
