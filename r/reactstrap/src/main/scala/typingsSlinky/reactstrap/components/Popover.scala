...
object Popover {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactstrap.mod.Popover[T]] {
  ...
  def withProps[T](p: PopoverProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  ...
  def apply[T](target: String | HTMLElement | ReactRef[HTMLElement]): Builder[T] = {
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[PopoverProps]))
  }
}
