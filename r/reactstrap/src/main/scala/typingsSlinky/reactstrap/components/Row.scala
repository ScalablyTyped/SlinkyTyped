...
object Row {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.Row[T]] {
    ...
    @scala.inline
    def form(value: Boolean): this.type = set("form", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def lg(value: Double | String): this.type = set("lg", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def md(value: Double | String): this.type = set("md", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def noGutters(value: Boolean): this.type = set("noGutters", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def sm(value: Double | String): this.type = set("sm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def xl(value: Double | String): this.type = set("xl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def xs(value: Double | String): this.type = set("xs", value.asInstanceOf[js.Any])
  }
  
  def withProps[T](p: RowProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[RowProps]))
  }
  
  implicit def make[T](companion: Row.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
