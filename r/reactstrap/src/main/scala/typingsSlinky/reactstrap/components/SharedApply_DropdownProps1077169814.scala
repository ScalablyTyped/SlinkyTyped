...
import typingsSlinky.reactstrap.libDropdownMod.DropdownProps
...
abstract class SharedApply_DropdownProps1077169814[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
