...
object Carousel {
  ...
  def withProps[T](p: CarouselProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](next: () => Unit, previous: () => Unit): Builder[T] = {
    val __props = js.Dynamic.literal(next = js.Any.fromFunction0(next), previous = js.Any.fromFunction0(previous))
    new Builder[T](js.Array(this.component, __props.asInstanceOf[CarouselProps]))
  }
}
