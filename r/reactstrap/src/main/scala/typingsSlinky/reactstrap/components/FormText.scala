...
import typingsSlinky.reactstrap.libFormTextMod.FormTextProps
import typingsSlinky.reactstrap.libFormTextMod.default
...
object FormText
  ...
  typingsSlinky.reactstrap.libFormTextMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libFormTextMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
