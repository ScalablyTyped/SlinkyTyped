...
import typingsSlinky.reactstrap.libAlertMod.UncontrolledAlertProps
...
object UncontrolledAlert
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledAlert[js.Any]] {
  ...
  def apply[T](
    ...
    typingsSlinky.reactstrap.reactstrapMod.UncontrolledAlert[js.Any]
  ] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledAlert[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.reactstrapMod.UncontrolledAlert[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = UncontrolledAlertProps
}
