...
object UncontrolledAlert {
  ...
  @JSImport("reactstrap/lib", "UncontrolledAlert")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.UncontrolledAlert] {
    ...
    @scala.inline
    def closeClassName(value: String): this.type = set("closeClassName", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: UncontrolledAlert.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UncontrolledAlertProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
