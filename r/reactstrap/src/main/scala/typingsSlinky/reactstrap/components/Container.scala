...
object Container {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.Container[T]] {
    ...
    @scala.inline
    def fluid(value: Boolean | String): this.type = set("fluid", value.asInstanceOf[js.Any])
