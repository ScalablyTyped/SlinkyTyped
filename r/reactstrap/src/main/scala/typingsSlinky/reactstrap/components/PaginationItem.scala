...
import typingsSlinky.reactstrap.paginationItemMod.PaginationItemProps
...
object PaginationItem {
  ...
  @JSImport("reactstrap", "PaginationItem")
  @js.native
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.PaginationItem[T]] {
  ...
  def withProps[T](p: PaginationItemProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[PaginationItemProps]))
  }
  
  implicit def make[T](companion: PaginationItem.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
