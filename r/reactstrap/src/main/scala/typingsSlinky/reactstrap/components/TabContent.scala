...
import typingsSlinky.reactstrap.tabContentMod.TabContentProps
...
object TabContent {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.TabContent[T]] {
    ...
    @scala.inline
    def activeTab(value: Double | String): this.type = set("activeTab", value.asInstanceOf[js.Any])
  ...
  def withProps[T](p: TabContentProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[TabContentProps]))
  }
  
  implicit def make[T](companion: TabContent.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
