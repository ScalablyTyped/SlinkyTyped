...
import typingsSlinky.reactstrap.libTabContentMod.TabContentProps
import typingsSlinky.reactstrap.libTabContentMod.default
...
object TabContent
  ...
  typingsSlinky.reactstrap.libTabContentMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libTabContentMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
