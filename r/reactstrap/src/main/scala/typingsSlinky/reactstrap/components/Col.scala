...
import typingsSlinky.reactstrap.libColMod.ColProps
import typingsSlinky.reactstrap.libColMod.ColumnProps
import typingsSlinky.reactstrap.libColMod.default
...
object Col
  ...
  def apply[T](
  ...
  ): BuildingComponent[slinky.web.html.div.tag.type, default[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactstrap.libColMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactstrap.libColMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ColProps
}
