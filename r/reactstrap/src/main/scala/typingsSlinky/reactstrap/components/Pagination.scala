...
object Pagination {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.Pagination[T]] {
    ...
    @scala.inline
    def listTag(value: ReactType[_]): this.type = set("listTag", value.asInstanceOf[js.Any])
