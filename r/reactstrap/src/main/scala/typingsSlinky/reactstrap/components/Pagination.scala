...
import typingsSlinky.reactstrap.libPaginationMod.PaginationProps
import typingsSlinky.reactstrap.libPaginationMod.default
...
object Pagination
  ...
  typingsSlinky.reactstrap.libPaginationMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libPaginationMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
