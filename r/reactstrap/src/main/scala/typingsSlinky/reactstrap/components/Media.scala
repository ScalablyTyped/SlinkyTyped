...
object Media {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def body(value: Boolean): this.type = set("body", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def heading(value: Boolean): this.type = set("heading", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def list(value: Boolean): this.type = set("list", value.asInstanceOf[js.Any])
    @scala.inline
    def middle(value: Boolean): this.type = set("middle", value.asInstanceOf[js.Any])
    @scala.inline
    def `object`(value: Boolean): this.type = set("object", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps[T](p: MediaProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make[T](companion: Media.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
