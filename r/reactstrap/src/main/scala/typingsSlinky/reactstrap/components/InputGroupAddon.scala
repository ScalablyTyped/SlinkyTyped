...
import typingsSlinky.reactstrap.inputGroupAddonMod.InputGroupAddonProps
import typingsSlinky.reactstrap.inputGroupAddonMod.default
...
object InputGroupAddon {
  ...
  def withProps[T](p: InputGroupAddonProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](addonType: prepend | append): Builder[T] = {
    val __props = js.Dynamic.literal(addonType = addonType.asInstanceOf[js.Any])
    new Builder[T](js.Array(this.component, __props.asInstanceOf[InputGroupAddonProps]))
  }
}
