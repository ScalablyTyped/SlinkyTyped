...
@scala.inline
class SharedBuilder_UncontrolledDropdownProps1809112045[R <: js.Object, T] (val args: js.Array[js.Any])
  extends AnyVal
     with StBuildingComponent[slinky.web.html.`*`.tag.type, R] {
  @scala.inline
  ...
  @scala.inline
  def addonType(value: Boolean | prepend | append): this.type = set("addonType", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def group(value: Boolean): this.type = set("group", value.asInstanceOf[js.Any])
  @scala.inline
  def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
  @scala.inline
  def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
  @scala.inline
  def inNavbar(value: Boolean): this.type = set("inNavbar", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  ): this.type = set("onToggle", js.Any.fromFunction2(value))
  @scala.inline
  ...
  @scala.inline
  def setActiveFromChild(value: Boolean): this.type = set("setActiveFromChild", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def toggle(value: SyntheticKeyboardEvent[_] | SyntheticMouseEvent[_] => Unit): this.type = set("toggle", js.Any.fromFunction1(value))
  @scala.inline
