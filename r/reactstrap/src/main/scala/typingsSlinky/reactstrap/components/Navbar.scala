...
import typingsSlinky.reactstrap.navbarMod.NavbarProps
import typingsSlinky.reactstrap.navbarMod.default
...
object Navbar {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def expand(value: Boolean | String): this.type = set("expand", value.asInstanceOf[js.Any])
    @scala.inline
    def fixed(value: String): this.type = set("fixed", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def sticky(value: String): this.type = set("sticky", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps[T](p: NavbarProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make[T](companion: Navbar.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
