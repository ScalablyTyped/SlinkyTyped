...
import typingsSlinky.reactstrap.libCardLinkMod.CardLinkProps
import typingsSlinky.reactstrap.libCardLinkMod.default
...
object CardLink
  ...
  typingsSlinky.reactstrap.libCardLinkMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardLinkMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
