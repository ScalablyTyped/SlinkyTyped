...
object CardLink
  ...
  /* The following DOM/SVG props were specified: className, contentEditable, dangerouslySetInnerHTML, dir, draggable, hidden, href, id, lang, spellCheck, style, suppressContentEditableWarning, tabIndex, title */
  def apply[T](
    about: String = null,
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.reactstrap.cardLinkMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.reactstrap.cardLinkMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CardLinkProps
}
