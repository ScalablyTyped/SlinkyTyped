...
import typingsSlinky.reactstrap.libDropdownMod.Direction
import typingsSlinky.reactstrap.libDropdownMod.UncontrolledDropdownProps
...
abstract class SharedApply_UncontrolledDropdownProps_450759047[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply[T](
    ...
    onToggle: (/* event */ SyntheticKeyboardEvent[org.scalajs.dom.raw.Element] | SyntheticMouseEvent[org.scalajs.dom.raw.Element], /* isOpen */ Boolean) => Unit = null,
    prefix: String = null,
  ...
  ): BuildingComponent[slinky.web.html.`*`.tag.type, ComponentRef] = {
  ...
  type Props = UncontrolledDropdownProps
}
