...
import typingsSlinky.reactstrap.libPaginationLinkMod.PaginationLinkProps
import typingsSlinky.reactstrap.libPaginationLinkMod.default
...
object PaginationLink
  ...
  typingsSlinky.reactstrap.libPaginationLinkMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.a.tag.type, 
  typingsSlinky.reactstrap.libPaginationLinkMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
