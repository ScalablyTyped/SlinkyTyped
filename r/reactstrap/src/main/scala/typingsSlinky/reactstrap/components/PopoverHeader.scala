...
import typingsSlinky.reactstrap.popoverHeaderMod.PopoverHeaderProps
...
object PopoverHeader {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.PopoverHeader[T]] {
    @scala.inline
  ...
  def withProps[T](p: PopoverHeaderProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[PopoverHeaderProps]))
  }
  implicit def make[T](companion: PopoverHeader.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
