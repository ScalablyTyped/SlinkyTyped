...
object PopoverHeader {
  ...
  @JSImport("reactstrap/lib", "PopoverHeader")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.PopoverHeader] {
  ...
  implicit def make(companion: PopoverHeader.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PopoverHeaderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
