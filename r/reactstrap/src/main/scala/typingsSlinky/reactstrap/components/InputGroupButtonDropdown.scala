...
object InputGroupButtonDropdown {
  ...
  def withProps[T](p: InputGroupButtonDropdownProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](addonType: prepend | append): Builder[T] = {
    val __props = js.Dynamic.literal(addonType = addonType.asInstanceOf[js.Any])
    new Builder[T](js.Array(this.component, __props.asInstanceOf[InputGroupButtonDropdownProps]))
  }
}
