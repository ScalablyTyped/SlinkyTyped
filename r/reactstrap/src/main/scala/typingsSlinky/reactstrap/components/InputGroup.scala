...
import typingsSlinky.reactstrap.inputGroupMod.InputGroupProps
...
object InputGroup {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.InputGroup[T]] {
  ...
  def withProps[T](p: InputGroupProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[InputGroupProps]))
  }
  
  implicit def make[T](companion: InputGroup.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
