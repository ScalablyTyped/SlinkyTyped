...
import typingsSlinky.reactstrap.fadeMod.default
...
object Fade {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def baseClassIn(value: String): this.type = set("baseClassIn", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onEnter(value: () => Unit): this.type = set("onEnter", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def onLeave(value: () => Unit): this.type = set("onLeave", js.Any.fromFunction0(value))
    @scala.inline
