...
import typingsSlinky.reactstrap.libNavbarBrandMod.NavbarBrandProps
import typingsSlinky.reactstrap.libNavbarBrandMod.default
...
object NavbarBrand
  ...
  typingsSlinky.reactstrap.libNavbarBrandMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.a.tag.type, 
  typingsSlinky.reactstrap.libNavbarBrandMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
