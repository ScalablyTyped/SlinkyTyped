...
import typingsSlinky.reactstrap.listGroupMod.ListGroupProps
import typingsSlinky.reactstrap.listGroupMod.default
...
object ListGroup {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def flush(value: Boolean): this.type = set("flush", value.asInstanceOf[js.Any])
    @scala.inline
    def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    @scala.inline
    def horizontal(value: Boolean | String): this.type = set("horizontal", value.asInstanceOf[js.Any])
    @scala.inline
