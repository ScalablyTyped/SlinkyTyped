...
object ListGroup {
  ...
  @JSImport("reactstrap/es", "ListGroup")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.ListGroup] {
  ...
  def withProps(p: ListGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ListGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
