...
import typingsSlinky.reactstrap.libListGroupMod.ListGroupProps
import typingsSlinky.reactstrap.libListGroupMod.default
...
object ListGroup
  ...
  typingsSlinky.reactstrap.libListGroupMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libListGroupMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
