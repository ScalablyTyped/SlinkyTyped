...
object UncontrolledCarousel
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledCarousel[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledCarousel[js.Any]] = {
  ...
  typingsSlinky.reactstrap.reactstrapMod.UncontrolledCarousel[js.Any]]]
  }
  type Props = UncontrolledCarouselProps
}
