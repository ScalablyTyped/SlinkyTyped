...
object UncontrolledCarousel {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactstrap.mod.UncontrolledCarousel[js.Any]] {
    @scala.inline
    ...
    @scala.inline
    def enableTouch(value: Boolean): this.type = set("enableTouch", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def indicators(value: Boolean): this.type = set("indicators", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def interval(value: Double | String | Boolean): this.type = set("interval", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def mouseEnter(value: () => Unit): this.type = set("mouseEnter", js.Any.fromFunction0(value))
    @scala.inline
    def mouseExit(value: () => Unit): this.type = set("mouseExit", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def pause(value: hover | `false`): this.type = set("pause", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def ride(value: carousel): this.type = set("ride", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def slide(value: Boolean): this.type = set("slide", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps[T](p: UncontrolledCarouselProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](items: js.Array[_]): Builder[T] = {
    val __props = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    new Builder[T](js.Array(this.component, __props.asInstanceOf[UncontrolledCarouselProps]))
  }
}
