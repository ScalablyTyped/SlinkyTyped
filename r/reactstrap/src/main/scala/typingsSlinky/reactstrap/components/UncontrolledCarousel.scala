...
object UncontrolledCarousel
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.mod.UncontrolledCarousel[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactstrap.mod.UncontrolledCarousel[js.Any]] = {
  ...
  typingsSlinky.reactstrap.mod.UncontrolledCarousel[js.Any]]]
  }
