...
object Button
  ...
  ): BuildingComponent[slinky.web.html.button.tag.type, default[js.Any]] = {
  ...
  typingsSlinky.reactstrap.buttonMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.button.tag.type, 
  typingsSlinky.reactstrap.buttonMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
