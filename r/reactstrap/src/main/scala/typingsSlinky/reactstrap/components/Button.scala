...
object Button {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.button.tag.type, default[js.Any]] {
    @scala.inline
    ...
    @scala.inline
    def innerRefRefObject(value: ReactRef[HTMLButtonElement]): this.type = set("innerRef", value.asInstanceOf[js.Any])
    @scala.inline
    def innerRefFunction1(value: /* instance */ HTMLButtonElement | Null => Unit): this.type = set("innerRef", js.Any.fromFunction1(value))
    @scala.inline
    def innerRef(value: Ref[HTMLButtonElement]): this.type = set("innerRef", value.asInstanceOf[js.Any])
    @scala.inline
