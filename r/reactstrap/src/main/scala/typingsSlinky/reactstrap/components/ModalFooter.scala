...
import typingsSlinky.reactstrap.modalFooterMod.ModalFooterProps
import typingsSlinky.reactstrap.modalFooterMod.default
...
object ModalFooter
  ...
  typingsSlinky.reactstrap.modalFooterMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.modalFooterMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
