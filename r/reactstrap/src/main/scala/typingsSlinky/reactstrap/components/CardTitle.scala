...
import typingsSlinky.reactstrap.libCardTitleMod.CardTitleProps
import typingsSlinky.reactstrap.libCardTitleMod.default
...
object CardTitle
  ...
  typingsSlinky.reactstrap.libCardTitleMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardTitleMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
