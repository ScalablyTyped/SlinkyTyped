...
import typingsSlinky.reactstrap.libPopoverMod.UncontrolledPopoverProps
...
object UncontrolledPopover
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledPopover[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledPopover[js.Any]] = {
  ...
  typingsSlinky.reactstrap.reactstrapMod.UncontrolledPopover[js.Any]]]
  }
