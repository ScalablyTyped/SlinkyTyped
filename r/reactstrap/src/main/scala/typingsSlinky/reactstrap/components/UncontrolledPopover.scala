...
object UncontrolledPopover
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.mod.UncontrolledPopover[js.Any]] {
  ...
  def apply[T](
    ...
    boundariesElement: Boundary | org.scalajs.dom.raw.Element = null,
    color: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactstrap.mod.UncontrolledPopover[js.Any]] = {
  ...
  typingsSlinky.reactstrap.mod.UncontrolledPopover[js.Any]]]
  }
  type Props = UncontrolledPopoverProps
}
