...
import typingsSlinky.reactstrap.libCardImgMod.CardImgProps
import typingsSlinky.reactstrap.libCardImgMod.default
...
object CardImg
  ...
  typingsSlinky.reactstrap.libCardImgMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardImgMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CardImgProps
}
