...
import typingsSlinky.reactstrap.libBreadcrumbMod.BreadcrumbProps
import typingsSlinky.reactstrap.libBreadcrumbMod.default
...
object Breadcrumb
  ...
  typingsSlinky.reactstrap.libBreadcrumbMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libBreadcrumbMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
