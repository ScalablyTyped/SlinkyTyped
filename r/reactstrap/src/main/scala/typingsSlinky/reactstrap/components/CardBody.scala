...
import typingsSlinky.reactstrap.libCardBodyMod.CardBodyProps
import typingsSlinky.reactstrap.libCardBodyMod.default
...
object CardBody
  ...
  typingsSlinky.reactstrap.libCardBodyMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardBodyMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
