...
object Collapse {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classNames(value: String): this.type = set("classNames", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def delay(value: AnonHide): this.type = set("delay", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def navbar(value: Boolean): this.type = set("navbar", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onEntered(value: () => Unit): this.type = set("onEntered", js.Any.fromFunction0(value))
    @scala.inline
    def onEntering(value: () => Unit): this.type = set("onEntering", js.Any.fromFunction0(value))
    @scala.inline
    def onError(value: SyntheticEvent[Event_, HTMLElement] => Unit): this.type = set("onError", js.Any.fromFunction1(value))
    @scala.inline
    def onExit(value: () => Unit): this.type = set("onExit", js.Any.fromFunction0(value))
    @scala.inline
    def onExited(value: () => Unit): this.type = set("onExited", js.Any.fromFunction0(value))
    @scala.inline
    def onExiting(value: () => Unit): this.type = set("onExiting", js.Any.fromFunction0(value))
    @scala.inline
