...
import typingsSlinky.reactstrap.libNavMod.NavProps
import typingsSlinky.reactstrap.libNavMod.default
...
object Nav
  ...
  def apply[T](
  ...
  ): BuildingComponent[slinky.web.html.ul.tag.type, default[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.ul.tag.type, typingsSlinky.reactstrap.libNavMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[slinky.web.html.ul.tag.type, typingsSlinky.reactstrap.libNavMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = NavProps
}
