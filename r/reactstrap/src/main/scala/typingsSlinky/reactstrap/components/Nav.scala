...
import typingsSlinky.reactstrap.navMod.NavProps
import typingsSlinky.reactstrap.navMod.default
...
object Nav {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.ul.tag.type, default[js.Any]] {
    @scala.inline
    ...
    @scala.inline
    def card(value: Boolean): this.type = set("card", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def horizontal(value: String): this.type = set("horizontal", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def pills(value: Boolean): this.type = set("pills", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def tabs(value: Boolean): this.type = set("tabs", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def vertical(value: Boolean | String): this.type = set("vertical", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps[T](p: NavProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[NavProps]))
  }
  implicit def make[T](companion: Nav.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
