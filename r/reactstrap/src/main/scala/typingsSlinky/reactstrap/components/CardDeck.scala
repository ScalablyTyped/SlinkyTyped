...
object CardDeck {
  ...
  @JSImport("reactstrap/es", "CardDeck")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.CardDeck] {
  ...
  def withProps(p: CardDeckProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CardDeck.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
