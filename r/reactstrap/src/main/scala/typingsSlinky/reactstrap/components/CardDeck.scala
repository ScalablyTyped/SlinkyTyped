...
import typingsSlinky.reactstrap.libCardDeckMod.CardDeckProps
import typingsSlinky.reactstrap.libCardDeckMod.default
...
object CardDeck
  ...
  typingsSlinky.reactstrap.libCardDeckMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardDeckMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
