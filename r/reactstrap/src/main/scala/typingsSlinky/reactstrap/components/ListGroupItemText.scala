...
object ListGroupItemText {
  ...
  @JSImport("reactstrap/es", "ListGroupItemText")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.ListGroupItemText] {
  ...
  def withProps(p: ListGroupItemTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ListGroupItemText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
