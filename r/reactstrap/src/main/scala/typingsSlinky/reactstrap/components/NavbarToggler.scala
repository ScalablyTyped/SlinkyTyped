...
import typingsSlinky.reactstrap.libNavbarTogglerMod.NavbarTogglerProps
import typingsSlinky.reactstrap.libNavbarTogglerMod.default
...
object NavbarToggler
  ...
  typingsSlinky.reactstrap.libNavbarTogglerMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.a.tag.type, 
  typingsSlinky.reactstrap.libNavbarTogglerMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
