...
object NavbarToggler
  ...
  ): BuildingComponent[slinky.web.html.a.tag.type, default[js.Any]] = {
  ...
  typingsSlinky.reactstrap.navbarTogglerMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.a.tag.type, 
  typingsSlinky.reactstrap.navbarTogglerMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = NavbarTogglerProps
}
