...
object NavbarToggler {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.button.tag.type, typingsSlinky.reactstrap.mod.NavbarToggler] {
  ...
  implicit def make(companion: NavbarToggler.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NavbarTogglerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
