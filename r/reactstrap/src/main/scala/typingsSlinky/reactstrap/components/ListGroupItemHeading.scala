...
object ListGroupItemHeading {
  ...
  @JSImport("reactstrap/es", "ListGroupItemHeading")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.ListGroupItemHeading] {
  ...
  def withProps(p: ListGroupItemHeadingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ListGroupItemHeading.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
