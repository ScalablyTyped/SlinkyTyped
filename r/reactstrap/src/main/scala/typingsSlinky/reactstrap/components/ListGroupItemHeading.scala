...
import typingsSlinky.reactstrap.listGroupItemHeadingMod.ListGroupItemHeadingProps
...
object ListGroupItemHeading {
  ...
  @JSImport("reactstrap", "ListGroupItemHeading")
  @js.native
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.ListGroupItemHeading[T]] {
  ...
  def withProps[T](p: ListGroupItemHeadingProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[ListGroupItemHeadingProps]))
  }
  
  implicit def make[T](companion: ListGroupItemHeading.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
