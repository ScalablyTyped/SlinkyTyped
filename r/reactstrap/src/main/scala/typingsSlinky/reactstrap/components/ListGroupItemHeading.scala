...
import typingsSlinky.reactstrap.libListGroupItemHeadingMod.ListGroupItemHeadingProps
import typingsSlinky.reactstrap.libListGroupItemHeadingMod.default
...
object ListGroupItemHeading
  ...
  typingsSlinky.reactstrap.libListGroupItemHeadingMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libListGroupItemHeadingMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ListGroupItemHeadingProps
}
