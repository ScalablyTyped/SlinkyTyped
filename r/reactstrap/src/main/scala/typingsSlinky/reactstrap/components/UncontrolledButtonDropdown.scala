...
object UncontrolledButtonDropdown {
  ...
  @scala.inline
  def apply[T](): SharedBuilder_UncontrolledDropdownProps1809112045[typingsSlinky.reactstrap.mod.UncontrolledButtonDropdown[js.Any], T] = {
    val __props = js.Dynamic.literal()
    new SharedBuilder_UncontrolledDropdownProps1809112045[typingsSlinky.reactstrap.mod.UncontrolledButtonDropdown[js.Any], T](js.Array(this.component, __props.asInstanceOf[UncontrolledDropdownProps]))
  }
