...
import typingsSlinky.reactstrap.libListGroupItemMod.ListGroupItemProps
import typingsSlinky.reactstrap.libListGroupItemMod.default
...
object ListGroupItem
  ...
  typingsSlinky.reactstrap.libListGroupItemMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libListGroupItemMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
