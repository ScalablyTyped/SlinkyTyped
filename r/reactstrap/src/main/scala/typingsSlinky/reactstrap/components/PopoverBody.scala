...
import typingsSlinky.reactstrap.libPopoverBodyMod.PopoverBodyProps
import typingsSlinky.reactstrap.libPopoverBodyMod.default
...
object PopoverBody
  ...
  typingsSlinky.reactstrap.libPopoverBodyMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libPopoverBodyMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
