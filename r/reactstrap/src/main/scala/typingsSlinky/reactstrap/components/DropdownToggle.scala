...
object DropdownToggle {
  ...
  @JSImport("reactstrap/es", "DropdownToggle")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.DropdownToggle] {
    ...
    @scala.inline
    def `aria-haspopup`(value: Boolean): this.type = set("aria-haspopup", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def caret(value: Boolean): this.type = set("caret", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `data-toggle`(value: String): this.type = set("data-toggle", value.asInstanceOf[js.Any])
