...
import typingsSlinky.reactstrap.libDropdownToggleMod.DropdownToggleProps
import typingsSlinky.reactstrap.libDropdownToggleMod.default
...
object DropdownToggle
  ...
  typingsSlinky.reactstrap.libDropdownToggleMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libDropdownToggleMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
