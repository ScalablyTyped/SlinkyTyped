...
import typingsSlinky.reactstrap.libCardColumnsMod.CardColumnsProps
import typingsSlinky.reactstrap.libCardColumnsMod.default
...
object CardColumns
  ...
  typingsSlinky.reactstrap.libCardColumnsMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardColumnsMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CardColumnsProps
}
