...
object CardColumns {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.CardColumns] {
  ...
  def withProps(p: CardColumnsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CardColumns.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
