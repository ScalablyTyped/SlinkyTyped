...
import typingsSlinky.reactstrap.libTabPaneMod.TabPaneProps
import typingsSlinky.reactstrap.libTabPaneMod.default
...
object TabPane
  ...
  typingsSlinky.reactstrap.libTabPaneMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libTabPaneMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
