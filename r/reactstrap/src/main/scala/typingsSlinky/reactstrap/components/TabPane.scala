...
object TabPane {
  ...
  @JSImport("reactstrap/es", "TabPane")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.TabPane] {
    ...
    @scala.inline
    def tabId(value: Double | String): this.type = set("tabId", value.asInstanceOf[js.Any])
