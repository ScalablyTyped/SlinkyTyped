...
object ToastHeader {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.ToastHeader] {
    ...
    @scala.inline
    def charCode(value: String | Double): this.type = set("charCode", value.asInstanceOf[js.Any])
