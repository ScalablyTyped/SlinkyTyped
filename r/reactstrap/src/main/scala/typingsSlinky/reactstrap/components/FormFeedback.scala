...
import typingsSlinky.reactstrap.libFormFeedbackMod.FormFeedbackProps
import typingsSlinky.reactstrap.libFormFeedbackMod.default
...
object FormFeedback
  ...
  typingsSlinky.reactstrap.libFormFeedbackMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libFormFeedbackMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = FormFeedbackProps
}
