...
import typingsSlinky.reactstrap.libCardHeaderMod.CardHeaderProps
import typingsSlinky.reactstrap.libCardHeaderMod.default
...
object CardHeader
  ...
  typingsSlinky.reactstrap.libCardHeaderMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardHeaderMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
