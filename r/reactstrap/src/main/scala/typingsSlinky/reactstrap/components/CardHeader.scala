...
import typingsSlinky.reactstrap.cardHeaderMod.CardHeaderProps
...
object CardHeader {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.CardHeader[T]] {
    @scala.inline
  ...
  def withProps[T](p: CardHeaderProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](): Builder[T] = {
    val __props = js.Dynamic.literal()
    new Builder[T](js.Array(this.component, __props.asInstanceOf[CardHeaderProps]))
  }
  implicit def make[T](companion: CardHeader.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
}
