...
import typingsSlinky.reactstrap.libCollapseMod.UncontrolledCollapseProps
...
object UncontrolledCollapse
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledCollapse[js.Any]] {
  ...
  def apply[T](
    ...
    typingsSlinky.reactstrap.reactstrapMod.UncontrolledCollapse[js.Any]
  ] = {
  ...
  type Props = UncontrolledCollapseProps
}
