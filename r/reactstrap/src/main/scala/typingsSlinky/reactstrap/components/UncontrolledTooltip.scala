...
object UncontrolledTooltip {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def delay(value: Double | AnonHide): this.type = set("delay", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def innerClassName(value: String): this.type = set("innerClassName", value.asInstanceOf[js.Any])
    @scala.inline
