...
import typingsSlinky.reactstrap.Anon_Hide
import typingsSlinky.reactstrap.libTooltipMod.UncontrolledTooltipProps
...
object UncontrolledTooltip
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledTooltip[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactstrap.reactstrapMod.UncontrolledTooltip[js.Any]] = {
  ...
  typingsSlinky.reactstrap.reactstrapMod.UncontrolledTooltip[js.Any]]]
  }
  type Props = UncontrolledTooltipProps
}
