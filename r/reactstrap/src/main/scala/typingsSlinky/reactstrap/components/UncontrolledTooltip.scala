...
object UncontrolledTooltip
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactstrap.mod.UncontrolledTooltip[js.Any]] {
  ...
  def apply[T](
    target: String | HTMLElement | ReactRef[HTMLElement],
    about: String = null,
    ...
    color: String = null,
    container: String | HTMLElement | ReactRef[HTMLElement] = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactstrap.mod.UncontrolledTooltip[js.Any]] = {
  ...
  typingsSlinky.reactstrap.mod.UncontrolledTooltip[js.Any]]]
  }
