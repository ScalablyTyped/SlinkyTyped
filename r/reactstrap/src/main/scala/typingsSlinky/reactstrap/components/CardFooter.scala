...
import typingsSlinky.reactstrap.cardFooterMod.CardFooterProps
import typingsSlinky.reactstrap.cardFooterMod.default
...
object CardFooter
  ...
  typingsSlinky.reactstrap.cardFooterMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.cardFooterMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
