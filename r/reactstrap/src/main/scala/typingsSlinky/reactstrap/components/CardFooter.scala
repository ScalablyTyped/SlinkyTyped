...
import typingsSlinky.reactstrap.libCardFooterMod.CardFooterProps
import typingsSlinky.reactstrap.libCardFooterMod.default
...
object CardFooter
  ...
  typingsSlinky.reactstrap.libCardFooterMod.default[js.Any]]]
  }
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default[js.Any]] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactstrap.libCardFooterMod.default[js.Any]](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
