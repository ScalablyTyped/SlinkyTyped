...
object CarouselCaption {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactstrap.mod.CarouselCaption[T]] {
    ...
    @scala.inline
    def captionHeader(value: String): this.type = set("captionHeader", value.asInstanceOf[js.Any])
  ...
  def withProps[T](p: CarouselCaptionProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply[T](captionText: String): Builder[T] = {
    val __props = js.Dynamic.literal(captionText = captionText.asInstanceOf[js.Any])
    new Builder[T](js.Array(this.component, __props.asInstanceOf[CarouselCaptionProps]))
  }
}
