...
object InputGroupText {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactstrap.mod.InputGroupText] {
  ...
  implicit def make(companion: InputGroupText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InputGroupTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
