...
import typingsSlinky.reactstrap.libCarouselControlMod.CarouselControlProps
import typingsSlinky.reactstrap.libCarouselControlMod.default
...
object CarouselControl
  ...
  typingsSlinky.reactstrap.libCarouselControlMod.default[js.Any]]]
  }
  type Props = CarouselControlProps
}
