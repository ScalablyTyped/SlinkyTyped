...
import typingsSlinky.reactstrap.carouselControlMod.CarouselControlProps
...
object CarouselControl {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactstrap.mod.CarouselControl[T]] {
    @scala.inline
  ...
  def withProps[T](p: CarouselControlProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[T](direction: prev | next, directionText: String, onClickHandler: () => Unit): Builder[T] = {
    val __props = js.Dynamic.literal(direction = direction.asInstanceOf[js.Any], directionText = directionText.asInstanceOf[js.Any], onClickHandler = js.Any.fromFunction0(onClickHandler))
    new Builder[T](js.Array(this.component, __props.asInstanceOf[CarouselControlProps]))
  }
}
