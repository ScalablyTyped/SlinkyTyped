...
object CarouselControl {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactstrap.mod.CarouselControl] {
    ...
    @scala.inline
    def directionText(value: String): this.type = set("directionText", value.asInstanceOf[js.Any])
