...
object tableMod {
  ...
  object TableProps {
    ...
    implicit class TablePropsMutableBuilder[Self <: TableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInnerRefRefObject(value: ReactRef[HTMLTableElement]): Self = StObject.set(x, "innerRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setResponsiveTag(value: ReactElement): Self = StObject.set(x, "responsiveTag", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResponsiveTagComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "responsiveTag", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResponsiveTagFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "responsiveTag", value.asInstanceOf[js.Any])
