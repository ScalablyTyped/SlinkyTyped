...
object customInputMod {
  ...
  type CustomInput = ReactComponentClass[CustomInputProps]
  
  /* Inlined parent reactstrap.reactstrap/lib/CustomInput.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, 'id'> */
  @js.native
  trait CustomInputProps
    ...
    var `type`: CustomInputType = js.native
  ...
  object CustomInputProps {
    ...
    @scala.inline
    def apply(id: String | Double, `type`: CustomInputType): CustomInputProps = {
    ...
    @scala.inline
    implicit class CustomInputPropsMutableBuilder[Self <: CustomInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: CustomInputType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.reactstrap.reactstrapStrings.switch
    - typingsSlinky.reactstrap.reactstrapStrings.range
  */
  trait CustomInputType extends StObject
