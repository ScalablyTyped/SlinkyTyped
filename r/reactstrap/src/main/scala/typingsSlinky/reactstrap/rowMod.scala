...
object rowMod {
  ...
  type Row = ReactComponentClass[RowProps]
  
  /* Inlined parent reactstrap.reactstrap/lib/Row.Omit<react.react.HTMLAttributes<std.HTMLElement>, 'form'> */
  @js.native
  trait RowProps
    ...
    var lg: js.UndefOr[Double | String] = js.native
    
    var md: js.UndefOr[Double | String] = js.native
    
    var noGutters: js.UndefOr[Boolean] = js.native
    ...
    var sm: js.UndefOr[Double | String] = js.native
    ...
    var xl: js.UndefOr[Double | String] = js.native
    
    var xs: js.UndefOr[Double | String] = js.native
  }
  object RowProps {
    ...
    implicit class RowPropsMutableBuilder[Self <: RowProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLg(value: Double | String): Self = StObject.set(x, "lg", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLgUndefined: Self = StObject.set(x, "lg", js.undefined)
      
      @scala.inline
      def setMd(value: Double | String): Self = StObject.set(x, "md", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMdUndefined: Self = StObject.set(x, "md", js.undefined)
      
      @scala.inline
      def setNoGutters(value: Boolean): Self = StObject.set(x, "noGutters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNoGuttersUndefined: Self = StObject.set(x, "noGutters", js.undefined)
      ...
      @scala.inline
      def setSm(value: Double | String): Self = StObject.set(x, "sm", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setXl(value: Double | String): Self = StObject.set(x, "xl", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setXlUndefined: Self = StObject.set(x, "xl", js.undefined)
      
      @scala.inline
      def setXs(value: Double | String): Self = StObject.set(x, "xs", value.asInstanceOf[js.Any])
