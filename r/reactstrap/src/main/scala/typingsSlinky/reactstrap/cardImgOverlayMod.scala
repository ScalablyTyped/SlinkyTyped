...
object cardImgOverlayMod {
  ...
  @JSImport("reactstrap/lib/CardImgOverlay", JSImport.Default)
  @js.native
  class default ()
    extends Component[CardImgOverlayProps, js.Object, js.Any]
  
  type CardImgOverlay = ReactComponentClass[CardImgOverlayProps]
  ...
  object CardImgOverlayProps {
    ...
    @scala.inline
    def apply(): CardImgOverlayProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CardImgOverlayProps]
    }
    
    @scala.inline
    implicit class CardImgOverlayPropsMutableBuilder[Self <: CardImgOverlayProps] (val x: Self) extends AnyVal {
