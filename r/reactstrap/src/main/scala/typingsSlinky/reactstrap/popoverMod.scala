...
object popoverMod {
  ...
  type PopoverChildren = (js.Function1[/* props */ PopoverChildrenRenderProps, ReactElement]) | ReactElement
  ...
  object PopoverProps {
    ...
    implicit class PopoverPropsMutableBuilder[Self <: PopoverProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBoundariesElementElement(value: Element): Self = StObject.set(x, "boundariesElement", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setChildrenFunction1(value: /* props */ PopoverChildrenRenderProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTarget(value: String | HTMLElement | ReactRef[HTMLElement]): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setToggleFunction1(value: SyntheticMouseEvent[_] => Unit): Self = StObject.set(x, "toggle", js.Any.fromFunction1(value))
