...
object ModalProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(returnFocusAfterClose)) __obj.updateDynamic("returnFocusAfterClose")(returnFocusAfterClose.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(unmountOnClose)) __obj.updateDynamic("unmountOnClose")(unmountOnClose.get.asInstanceOf[js.Any])
