package typingsSlinky.reactstrap.listGroupItemHeadingMod
...
object ListGroupItemHeadingProps {
  ...
  @scala.inline
  implicit class ListGroupItemHeadingPropsOps[Self <: ListGroupItemHeadingProps] (val x: Self) extends AnyVal {
    @scala.inline
