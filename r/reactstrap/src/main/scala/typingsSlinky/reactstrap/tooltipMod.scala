...
object tooltipMod {
  ...
  type TooltipChildren = (js.Function1[/* props */ TooltipChildrenRenderProps, ReactElement]) | ReactElement
  ...
  object UncontrolledTooltipProps {
    ...
    implicit class UncontrolledTooltipPropsMutableBuilder[Self <: UncontrolledTooltipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildrenFunction1(value: /* props */ TooltipChildrenRenderProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
