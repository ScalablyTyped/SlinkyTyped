package typingsSlinky.reactMdDialog.anon
...
@js.native
trait PickBaseDialogPropshiddenAbout extends js.Object {
...
object PickBaseDialogPropshiddenAbout {
  ...
  @scala.inline
  implicit class PickBaseDialogPropshiddenAboutOps[Self <: PickBaseDialogPropshiddenAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUnmountFocusFallbackHTMLElement(value: HTMLElement): Self = this.set("unmountFocusFallback", value.asInstanceOf[js.Any])
