...
import typingsSlinky.reactMdDialog.reactMdDialogStrings.ascending
import typingsSlinky.reactMdDialog.reactMdDialogStrings.assertive
import typingsSlinky.reactMdDialog.reactMdDialogStrings.both
import typingsSlinky.reactMdDialog.reactMdDialogStrings.centered
import typingsSlinky.reactMdDialog.reactMdDialogStrings.copy
import typingsSlinky.reactMdDialog.reactMdDialogStrings.custom
import typingsSlinky.reactMdDialog.reactMdDialogStrings.date
import typingsSlinky.reactMdDialog.reactMdDialogStrings.decimal
import typingsSlinky.reactMdDialog.reactMdDialogStrings.descending
...
import typingsSlinky.reactMdDialog.reactMdDialogStrings.email
import typingsSlinky.reactMdDialog.reactMdDialogStrings.execute
import typingsSlinky.reactMdDialog.reactMdDialogStrings.first
import typingsSlinky.reactMdDialog.reactMdDialogStrings.grammar
import typingsSlinky.reactMdDialog.reactMdDialogStrings.grid
import typingsSlinky.reactMdDialog.reactMdDialogStrings.horizontal
import typingsSlinky.reactMdDialog.reactMdDialogStrings.inherit
import typingsSlinky.reactMdDialog.reactMdDialogStrings.last
import typingsSlinky.reactMdDialog.reactMdDialogStrings.link
import typingsSlinky.reactMdDialog.reactMdDialogStrings.list
import typingsSlinky.reactMdDialog.reactMdDialogStrings.listbox
import typingsSlinky.reactMdDialog.reactMdDialogStrings.location
import typingsSlinky.reactMdDialog.reactMdDialogStrings.menu
import typingsSlinky.reactMdDialog.reactMdDialogStrings.mixed
import typingsSlinky.reactMdDialog.reactMdDialogStrings.move
import typingsSlinky.reactMdDialog.reactMdDialogStrings.nav
import typingsSlinky.reactMdDialog.reactMdDialogStrings.no
import typingsSlinky.reactMdDialog.reactMdDialogStrings.none
import typingsSlinky.reactMdDialog.reactMdDialogStrings.numeric
import typingsSlinky.reactMdDialog.reactMdDialogStrings.off
import typingsSlinky.reactMdDialog.reactMdDialogStrings.on
import typingsSlinky.reactMdDialog.reactMdDialogStrings.other
import typingsSlinky.reactMdDialog.reactMdDialogStrings.page
import typingsSlinky.reactMdDialog.reactMdDialogStrings.polite
import typingsSlinky.reactMdDialog.reactMdDialogStrings.popup
import typingsSlinky.reactMdDialog.reactMdDialogStrings.removals
import typingsSlinky.reactMdDialog.reactMdDialogStrings.search
import typingsSlinky.reactMdDialog.reactMdDialogStrings.spelling
import typingsSlinky.reactMdDialog.reactMdDialogStrings.step
import typingsSlinky.reactMdDialog.reactMdDialogStrings.tel
import typingsSlinky.reactMdDialog.reactMdDialogStrings.text
import typingsSlinky.reactMdDialog.reactMdDialogStrings.time
import typingsSlinky.reactMdDialog.reactMdDialogStrings.tree
import typingsSlinky.reactMdDialog.reactMdDialogStrings.url
import typingsSlinky.reactMdDialog.reactMdDialogStrings.vertical
import typingsSlinky.reactMdDialog.reactMdDialogStrings.yes
...
import typingsSlinky.reactMdTransition.useFixedPositioningMod.FixedTo
import typingsSlinky.reactMdTransition.useFixedPositioningMod.GetFixedPositionOptions
...
object anon {
  ...
  object PickBaseDialogPropshidden {
    ...
    @scala.inline
    def apply(`aria-label`: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseDialogPropshidden = {
      ...
      __obj.asInstanceOf[PickBaseDialogPropshidden]
    }
    
    @scala.inline
    implicit class PickBaseDialogPropshiddenMutableBuilder[Self <: PickBaseDialogPropshidden] (val x: Self) extends AnyVal {
  ...
  /* Inlined std.Pick<@react-md/dialog.@react-md/dialog/types/Dialog.BaseDialogProps, 'hidden' | 'visible' | 'color' | 'overlay' | 'style' | 'translate' | 'prefix' | 'slot' | 'title' | 'children' | 'portal' | 'portalInto' | 'portalIntoId' | 'timeout' | 'in' | 'mountOnEnter' | 'unmountOnExit' | 'onEnter' | 'onEntering' | 'onEntered' | 'onExit' | 'onExiting' | 'onExited' | 'classNames' | 'appear' | 'enter' | 'exit' | 'className' | 'onScroll' | 'onChange' | 'onKeyDown' | 'defaultChecked' | 'defaultValue' | 'suppressContentEditableWarning' | 'suppressHydrationWarning' | 'accessKey' | 'contentEditable' | 'contextMenu' | 'dir' | 'draggable' | 'id' | 'lang' | 'placeholder' | 'spellCheck' | 'tabIndex' | 'radioGroup' | 'role' | 'about' | 'datatype' | 'inlist' | 'property' | 'resource' | 'typeof' | 'vocab' | 'autoCapitalize' | 'autoCorrect' | 'autoSave' | 'itemProp' | 'itemScope' | 'itemType' | 'itemID' | 'itemRef' | 'results' | 'security' | 'unselectable' | 'inputMode' | 'is' | 'aria-activedescendant' | 'aria-atomic' | 'aria-autocomplete' | 'aria-busy' | 'aria-checked' | 'aria-colcount' | 'aria-colindex' | 'aria-colspan' | 'aria-controls' | 'aria-current' | 'aria-describedby' | 'aria-details' | 'aria-disabled' | 'aria-dropeffect' | 'aria-errormessage' | 'aria-expanded' | 'aria-flowto' | 'aria-grabbed' | 'aria-haspopup' | 'aria-hidden' | 'aria-invalid' | 'aria-keyshortcuts' | 'aria-level' | 'aria-live' | 'aria-modal' | 'aria-multiline' | 'aria-multiselectable' | 'aria-orientation' | 'aria-owns' | 'aria-placeholder' | 'aria-posinset' | 'aria-pressed' | 'aria-readonly' | 'aria-relevant' | 'aria-required' | 'aria-roledescription' | 'aria-rowcount' | 'aria-rowindex' | 'aria-rowspan' | 'aria-selected' | 'aria-setsize' | 'aria-sort' | 'aria-valuemax' | 'aria-valuemin' | 'aria-valuenow' | 'aria-valuetext' | 'dangerouslySetInnerHTML' | 'onCopy' | 'onCopyCapture' | 'onCut' | 'onCutCapture' | 'onPaste' | 'onPasteCapture' | 'onCompositionEnd' | 'onCompositionEndCapture' | 'onCompositionStart' | 'onCompositionStartCapture' | 'onCompositionUpdate' | 'onCompositionUpdateCapture' | 'onFocus' | 'onFocusCapture' | 'onBlur' | 'onBlurCapture' | 'onChangeCapture' | 'onBeforeInput' | 'onBeforeInputCapture' | 'onInput' | 'onInputCapture' | 'onReset' | 'onResetCapture' | 'onSubmit' | 'onSubmitCapture' | 'onInvalid' | 'onInvalidCapture' | 'onLoad' | 'onLoadCapture' | 'onError' | 'onErrorCapture' | 'onKeyDownCapture' | 'onKeyPress' | 'onKeyPressCapture' | 'onKeyUp' | 'onKeyUpCapture' | 'onAbort' | 'onAbortCapture' | 'onCanPlay' | 'onCanPlayCapture' | 'onCanPlayThrough' | 'onCanPlayThroughCapture' | 'onDurationChange' | 'onDurationChangeCapture' | 'onEmptied' | 'onEmptiedCapture' | 'onEncrypted' | 'onEncryptedCapture' | 'onEnded' | 'onEndedCapture' | 'onLoadedData' | 'onLoadedDataCapture' | 'onLoadedMetadata' | 'onLoadedMetadataCapture' | 'onLoadStart' | 'onLoadStartCapture' | 'onPause' | 'onPauseCapture' | 'onPlay' | 'onPlayCapture' | 'onPlaying' | 'onPlayingCapture' | 'onProgress' | 'onProgressCapture' | 'onRateChange' | 'onRateChangeCapture' | 'onSeeked' | 'onSeekedCapture' | 'onSeeking' | 'onSeekingCapture' | 'onStalled' | 'onStalledCapture' | 'onSuspend' | 'onSuspendCapture' | 'onTimeUpdate' | 'onTimeUpdateCapture' | 'onVolumeChange' | 'onVolumeChangeCapture' | 'onWaiting' | 'onWaitingCapture' | 'onAuxClick' | 'onAuxClickCapture' | 'onClick' | 'onClickCapture' | 'onContextMenu' | 'onContextMenuCapture' | 'onDoubleClick' | 'onDoubleClickCapture' | 'onDrag' | 'onDragCapture' | 'onDragEnd' | 'onDragEndCapture' | 'onDragEnter' | 'onDragEnterCapture' | 'onDragExit' | 'onDragExitCapture' | 'onDragLeave' | 'onDragLeaveCapture' | 'onDragOver' | 'onDragOverCapture' | 'onDragStart' | 'onDragStartCapture' | 'onDrop' | 'onDropCapture' | 'onMouseDown' | 'onMouseDownCapture' | 'onMouseEnter' | 'onMouseLeave' | 'onMouseMove' | 'onMouseMoveCapture' | 'onMouseOut' | 'onMouseOutCapture' | 'onMouseOver' | 'onMouseOverCapture' | 'onMouseUp' | 'onMouseUpCapture' | 'onSelect' | 'onSelectCapture' | 'onTouchCancel' | 'onTouchCancelCapture' | 'onTouchEnd' | 'onTouchEndCapture' | 'onTouchMove' | 'onTouchMoveCapture' | 'onTouchStart' | 'onTouchStartCapture' | 'onPointerDown' | 'onPointerDownCapture' | 'onPointerMove' | 'onPointerMoveCapture' | 'onPointerUp' | 'onPointerUpCapture' | 'onPointerCancel' | 'onPointerCancelCapture' | 'onPointerEnter' | 'onPointerEnterCapture' | 'onPointerLeave' | 'onPointerLeaveCapture' | 'onPointerOver' | 'onPointerOverCapture' | 'onPointerOut' | 'onPointerOutCapture' | 'onGotPointerCapture' | 'onGotPointerCaptureCapture' | 'onLostPointerCapture' | 'onLostPointerCaptureCapture' | 'onScrollCapture' | 'onWheel' | 'onWheelCapture' | 'onAnimationStart' | 'onAnimationStartCapture' | 'onAnimationEnd' | 'onAnimationEndCapture' | 'onAnimationIteration' | 'onAnimationIterationCapture' | 'onTransitionEnd' | 'onTransitionEndCapture' | 'component' | 'disableEscapeClose' | 'onRequestClose' | 'overlayStyle' | 'overlayClassName' | 'overlayHidden' | 'containerStyle' | 'containerClassName' | 'forceContainer' | 'modal' | 'type' | 'defaultFocus' | 'disableScrollLock' | 'disableFocusContainer' | 'disableNestedDialogFixes' | 'disableTransition' | 'disableFocusCache' | 'disableFocusOnMount' | 'disableTabFocusWrap' | 'disableFocusOnMountScroll' | 'disableFocusOnUnmount' | 'unmountFocusFallback'> & std.Required<std.Pick<@react-md/dialog.@react-md/dialog/types/Dialog.BaseDialogProps, 'aria-labelledby'>> & std.Partial<std.Pick<@react-md/dialog.@react-md/dialog/types/Dialog.BaseDialogProps, 'aria-label'>> & react.react.RefAttributes<std.HTMLDivElement> */
  @js.native
  trait PickBaseDialogPropshiddenAbout extends StObject {
  ...
  object PickBaseDialogPropshiddenAbout {
    ...
    @scala.inline
    def apply(`aria-labelledby`: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseDialogPropshiddenAbout = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onRequestClose = js.Any.fromFunction0(onRequestClose), visible = visible.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-labelledby")(`aria-labelledby`.asInstanceOf[js.Any])
      __obj.asInstanceOf[PickBaseDialogPropshiddenAbout]
    }
    
    @scala.inline
    implicit class PickBaseDialogPropshiddenAboutMutableBuilder[Self <: PickBaseDialogPropshiddenAbout] (val x: Self) extends AnyVal {
  ...
  /* Inlined std.Pick<@react-md/dialog.@react-md/dialog/types/FixedDialog.BaseFixedDialogProps, 'hidden' | 'visible' | 'color' | 'overlay' | 'style' | 'translate' | 'prefix' | 'anchor' | 'slot' | 'title' | 'children' | 'portal' | 'portalInto' | 'portalIntoId' | 'timeout' | 'in' | 'mountOnEnter' | 'unmountOnExit' | 'onEnter' | 'onEntering' | 'onEntered' | 'onExit' | 'onExiting' | 'onExited' | 'classNames' | 'appear' | 'enter' | 'exit' | 'className' | 'onScroll' | 'onChange' | 'onKeyDown' | 'defaultChecked' | 'defaultValue' | 'suppressContentEditableWarning' | 'suppressHydrationWarning' | 'accessKey' | 'contentEditable' | 'contextMenu' | 'dir' | 'draggable' | 'id' | 'lang' | 'placeholder' | 'spellCheck' | 'tabIndex' | 'radioGroup' | 'role' | 'about' | 'datatype' | 'inlist' | 'property' | 'resource' | 'typeof' | 'vocab' | 'autoCapitalize' | 'autoCorrect' | 'autoSave' | 'itemProp' | 'itemScope' | 'itemType' | 'itemID' | 'itemRef' | 'results' | 'security' | 'unselectable' | 'inputMode' | 'is' | 'aria-activedescendant' | 'aria-atomic' | 'aria-autocomplete' | 'aria-busy' | 'aria-checked' | 'aria-colcount' | 'aria-colindex' | 'aria-colspan' | 'aria-controls' | 'aria-current' | 'aria-describedby' | 'aria-details' | 'aria-disabled' | 'aria-dropeffect' | 'aria-errormessage' | 'aria-expanded' | 'aria-flowto' | 'aria-grabbed' | 'aria-haspopup' | 'aria-hidden' | 'aria-invalid' | 'aria-keyshortcuts' | 'aria-level' | 'aria-live' | 'aria-modal' | 'aria-multiline' | 'aria-multiselectable' | 'aria-orientation' | 'aria-owns' | 'aria-placeholder' | 'aria-posinset' | 'aria-pressed' | 'aria-readonly' | 'aria-relevant' | 'aria-required' | 'aria-roledescription' | 'aria-rowcount' | 'aria-rowindex' | 'aria-rowspan' | 'aria-selected' | 'aria-setsize' | 'aria-sort' | 'aria-valuemax' | 'aria-valuemin' | 'aria-valuenow' | 'aria-valuetext' | 'dangerouslySetInnerHTML' | 'onCopy' | 'onCopyCapture' | 'onCut' | 'onCutCapture' | 'onPaste' | 'onPasteCapture' | 'onCompositionEnd' | 'onCompositionEndCapture' | 'onCompositionStart' | 'onCompositionStartCapture' | 'onCompositionUpdate' | 'onCompositionUpdateCapture' | 'onFocus' | 'onFocusCapture' | 'onBlur' | 'onBlurCapture' | 'onChangeCapture' | 'onBeforeInput' | 'onBeforeInputCapture' | 'onInput' | 'onInputCapture' | 'onReset' | 'onResetCapture' | 'onSubmit' | 'onSubmitCapture' | 'onInvalid' | 'onInvalidCapture' | 'onLoad' | 'onLoadCapture' | 'onError' | 'onErrorCapture' | 'onKeyDownCapture' | 'onKeyPress' | 'onKeyPressCapture' | 'onKeyUp' | 'onKeyUpCapture' | 'onAbort' | 'onAbortCapture' | 'onCanPlay' | 'onCanPlayCapture' | 'onCanPlayThrough' | 'onCanPlayThroughCapture' | 'onDurationChange' | 'onDurationChangeCapture' | 'onEmptied' | 'onEmptiedCapture' | 'onEncrypted' | 'onEncryptedCapture' | 'onEnded' | 'onEndedCapture' | 'onLoadedData' | 'onLoadedDataCapture' | 'onLoadedMetadata' | 'onLoadedMetadataCapture' | 'onLoadStart' | 'onLoadStartCapture' | 'onPause' | 'onPauseCapture' | 'onPlay' | 'onPlayCapture' | 'onPlaying' | 'onPlayingCapture' | 'onProgress' | 'onProgressCapture' | 'onRateChange' | 'onRateChangeCapture' | 'onSeeked' | 'onSeekedCapture' | 'onSeeking' | 'onSeekingCapture' | 'onStalled' | 'onStalledCapture' | 'onSuspend' | 'onSuspendCapture' | 'onTimeUpdate' | 'onTimeUpdateCapture' | 'onVolumeChange' | 'onVolumeChangeCapture' | 'onWaiting' | 'onWaitingCapture' | 'onAuxClick' | 'onAuxClickCapture' | 'onClick' | 'onClickCapture' | 'onContextMenu' | 'onContextMenuCapture' | 'onDoubleClick' | 'onDoubleClickCapture' | 'onDrag' | 'onDragCapture' | 'onDragEnd' | 'onDragEndCapture' | 'onDragEnter' | 'onDragEnterCapture' | 'onDragExit' | 'onDragExitCapture' | 'onDragLeave' | 'onDragLeaveCapture' | 'onDragOver' | 'onDragOverCapture' | 'onDragStart' | 'onDragStartCapture' | 'onDrop' | 'onDropCapture' | 'onMouseDown' | 'onMouseDownCapture' | 'onMouseEnter' | 'onMouseLeave' | 'onMouseMove' | 'onMouseMoveCapture' | 'onMouseOut' | 'onMouseOutCapture' | 'onMouseOver' | 'onMouseOverCapture' | 'onMouseUp' | 'onMouseUpCapture' | 'onSelect' | 'onSelectCapture' | 'onTouchCancel' | 'onTouchCancelCapture' | 'onTouchEnd' | 'onTouchEndCapture' | 'onTouchMove' | 'onTouchMoveCapture' | 'onTouchStart' | 'onTouchStartCapture' | 'onPointerDown' | 'onPointerDownCapture' | 'onPointerMove' | 'onPointerMoveCapture' | 'onPointerUp' | 'onPointerUpCapture' | 'onPointerCancel' | 'onPointerCancelCapture' | 'onPointerEnter' | 'onPointerEnterCapture' | 'onPointerLeave' | 'onPointerLeaveCapture' | 'onPointerOver' | 'onPointerOverCapture' | 'onPointerOut' | 'onPointerOutCapture' | 'onGotPointerCapture' | 'onGotPointerCaptureCapture' | 'onLostPointerCapture' | 'onLostPointerCaptureCapture' | 'onScrollCapture' | 'onWheel' | 'onWheelCapture' | 'onAnimationStart' | 'onAnimationStartCapture' | 'onAnimationEnd' | 'onAnimationEndCapture' | 'onAnimationIteration' | 'onAnimationIterationCapture' | 'onTransitionEnd' | 'onTransitionEndCapture' | 'options' | 'component' | 'fixedTo' | 'getOptions' | 'disableEscapeClose' | 'onRequestClose' | 'overlayStyle' | 'overlayClassName' | 'overlayHidden' | 'containerStyle' | 'containerClassName' | 'forceContainer' | 'modal' | 'defaultFocus' | 'disableScrollLock' | 'disableFocusContainer' | 'disableNestedDialogFixes' | 'disableTransition' | 'disableFocusCache' | 'disableFocusOnMount' | 'disableTabFocusWrap' | 'disableFocusOnMountScroll' | 'disableFocusOnUnmount' | 'unmountFocusFallback'> & std.Required<std.Pick<@react-md/dialog.@react-md/dialog/types/FixedDialog.BaseFixedDialogProps, 'aria-label'>> & std.Partial<std.Pick<@react-md/dialog.@react-md/dialog/types/FixedDialog.BaseFixedDialogProps, 'aria-labelledby'>> & react.react.RefAttributes<std.HTMLDivElement> */
  @js.native
  trait PickBaseFixedDialogPropsh extends StObject {
  ...
  object PickBaseFixedDialogPropsh {
    ...
    @scala.inline
    def apply(`aria-label`: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseFixedDialogPropsh = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onRequestClose = js.Any.fromFunction0(onRequestClose), visible = visible.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-label")(`aria-label`.asInstanceOf[js.Any])
      __obj.asInstanceOf[PickBaseFixedDialogPropsh]
    }
    
    @scala.inline
    implicit class PickBaseFixedDialogPropshMutableBuilder[Self <: PickBaseFixedDialogPropsh] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFixedToHTMLElement(value: HTMLElement): Self = StObject.set(x, "fixedTo", value.asInstanceOf[js.Any])
  ...
  /* Inlined std.Pick<@react-md/dialog.@react-md/dialog/types/FixedDialog.BaseFixedDialogProps, 'hidden' | 'visible' | 'color' | 'overlay' | 'style' | 'translate' | 'prefix' | 'anchor' | 'slot' | 'title' | 'children' | 'portal' | 'portalInto' | 'portalIntoId' | 'timeout' | 'in' | 'mountOnEnter' | 'unmountOnExit' | 'onEnter' | 'onEntering' | 'onEntered' | 'onExit' | 'onExiting' | 'onExited' | 'classNames' | 'appear' | 'enter' | 'exit' | 'className' | 'onScroll' | 'onChange' | 'onKeyDown' | 'defaultChecked' | 'defaultValue' | 'suppressContentEditableWarning' | 'suppressHydrationWarning' | 'accessKey' | 'contentEditable' | 'contextMenu' | 'dir' | 'draggable' | 'id' | 'lang' | 'placeholder' | 'spellCheck' | 'tabIndex' | 'radioGroup' | 'role' | 'about' | 'datatype' | 'inlist' | 'property' | 'resource' | 'typeof' | 'vocab' | 'autoCapitalize' | 'autoCorrect' | 'autoSave' | 'itemProp' | 'itemScope' | 'itemType' | 'itemID' | 'itemRef' | 'results' | 'security' | 'unselectable' | 'inputMode' | 'is' | 'aria-activedescendant' | 'aria-atomic' | 'aria-autocomplete' | 'aria-busy' | 'aria-checked' | 'aria-colcount' | 'aria-colindex' | 'aria-colspan' | 'aria-controls' | 'aria-current' | 'aria-describedby' | 'aria-details' | 'aria-disabled' | 'aria-dropeffect' | 'aria-errormessage' | 'aria-expanded' | 'aria-flowto' | 'aria-grabbed' | 'aria-haspopup' | 'aria-hidden' | 'aria-invalid' | 'aria-keyshortcuts' | 'aria-level' | 'aria-live' | 'aria-modal' | 'aria-multiline' | 'aria-multiselectable' | 'aria-orientation' | 'aria-owns' | 'aria-placeholder' | 'aria-posinset' | 'aria-pressed' | 'aria-readonly' | 'aria-relevant' | 'aria-required' | 'aria-roledescription' | 'aria-rowcount' | 'aria-rowindex' | 'aria-rowspan' | 'aria-selected' | 'aria-setsize' | 'aria-sort' | 'aria-valuemax' | 'aria-valuemin' | 'aria-valuenow' | 'aria-valuetext' | 'dangerouslySetInnerHTML' | 'onCopy' | 'onCopyCapture' | 'onCut' | 'onCutCapture' | 'onPaste' | 'onPasteCapture' | 'onCompositionEnd' | 'onCompositionEndCapture' | 'onCompositionStart' | 'onCompositionStartCapture' | 'onCompositionUpdate' | 'onCompositionUpdateCapture' | 'onFocus' | 'onFocusCapture' | 'onBlur' | 'onBlurCapture' | 'onChangeCapture' | 'onBeforeInput' | 'onBeforeInputCapture' | 'onInput' | 'onInputCapture' | 'onReset' | 'onResetCapture' | 'onSubmit' | 'onSubmitCapture' | 'onInvalid' | 'onInvalidCapture' | 'onLoad' | 'onLoadCapture' | 'onError' | 'onErrorCapture' | 'onKeyDownCapture' | 'onKeyPress' | 'onKeyPressCapture' | 'onKeyUp' | 'onKeyUpCapture' | 'onAbort' | 'onAbortCapture' | 'onCanPlay' | 'onCanPlayCapture' | 'onCanPlayThrough' | 'onCanPlayThroughCapture' | 'onDurationChange' | 'onDurationChangeCapture' | 'onEmptied' | 'onEmptiedCapture' | 'onEncrypted' | 'onEncryptedCapture' | 'onEnded' | 'onEndedCapture' | 'onLoadedData' | 'onLoadedDataCapture' | 'onLoadedMetadata' | 'onLoadedMetadataCapture' | 'onLoadStart' | 'onLoadStartCapture' | 'onPause' | 'onPauseCapture' | 'onPlay' | 'onPlayCapture' | 'onPlaying' | 'onPlayingCapture' | 'onProgress' | 'onProgressCapture' | 'onRateChange' | 'onRateChangeCapture' | 'onSeeked' | 'onSeekedCapture' | 'onSeeking' | 'onSeekingCapture' | 'onStalled' | 'onStalledCapture' | 'onSuspend' | 'onSuspendCapture' | 'onTimeUpdate' | 'onTimeUpdateCapture' | 'onVolumeChange' | 'onVolumeChangeCapture' | 'onWaiting' | 'onWaitingCapture' | 'onAuxClick' | 'onAuxClickCapture' | 'onClick' | 'onClickCapture' | 'onContextMenu' | 'onContextMenuCapture' | 'onDoubleClick' | 'onDoubleClickCapture' | 'onDrag' | 'onDragCapture' | 'onDragEnd' | 'onDragEndCapture' | 'onDragEnter' | 'onDragEnterCapture' | 'onDragExit' | 'onDragExitCapture' | 'onDragLeave' | 'onDragLeaveCapture' | 'onDragOver' | 'onDragOverCapture' | 'onDragStart' | 'onDragStartCapture' | 'onDrop' | 'onDropCapture' | 'onMouseDown' | 'onMouseDownCapture' | 'onMouseEnter' | 'onMouseLeave' | 'onMouseMove' | 'onMouseMoveCapture' | 'onMouseOut' | 'onMouseOutCapture' | 'onMouseOver' | 'onMouseOverCapture' | 'onMouseUp' | 'onMouseUpCapture' | 'onSelect' | 'onSelectCapture' | 'onTouchCancel' | 'onTouchCancelCapture' | 'onTouchEnd' | 'onTouchEndCapture' | 'onTouchMove' | 'onTouchMoveCapture' | 'onTouchStart' | 'onTouchStartCapture' | 'onPointerDown' | 'onPointerDownCapture' | 'onPointerMove' | 'onPointerMoveCapture' | 'onPointerUp' | 'onPointerUpCapture' | 'onPointerCancel' | 'onPointerCancelCapture' | 'onPointerEnter' | 'onPointerEnterCapture' | 'onPointerLeave' | 'onPointerLeaveCapture' | 'onPointerOver' | 'onPointerOverCapture' | 'onPointerOut' | 'onPointerOutCapture' | 'onGotPointerCapture' | 'onGotPointerCaptureCapture' | 'onLostPointerCapture' | 'onLostPointerCaptureCapture' | 'onScrollCapture' | 'onWheel' | 'onWheelCapture' | 'onAnimationStart' | 'onAnimationStartCapture' | 'onAnimationEnd' | 'onAnimationEndCapture' | 'onAnimationIteration' | 'onAnimationIterationCapture' | 'onTransitionEnd' | 'onTransitionEndCapture' | 'options' | 'component' | 'fixedTo' | 'getOptions' | 'disableEscapeClose' | 'onRequestClose' | 'overlayStyle' | 'overlayClassName' | 'overlayHidden' | 'containerStyle' | 'containerClassName' | 'forceContainer' | 'modal' | 'defaultFocus' | 'disableScrollLock' | 'disableFocusContainer' | 'disableNestedDialogFixes' | 'disableTransition' | 'disableFocusCache' | 'disableFocusOnMount' | 'disableTabFocusWrap' | 'disableFocusOnMountScroll' | 'disableFocusOnUnmount' | 'unmountFocusFallback'> & std.Required<std.Pick<@react-md/dialog.@react-md/dialog/types/FixedDialog.BaseFixedDialogProps, 'aria-labelledby'>> & std.Partial<std.Pick<@react-md/dialog.@react-md/dialog/types/FixedDialog.BaseFixedDialogProps, 'aria-label'>> & react.react.RefAttributes<std.HTMLDivElement> */
  @js.native
  trait PickBaseFixedDialogPropshAbout extends StObject {
  ...
  object PickBaseFixedDialogPropshAbout {
    ...
    @scala.inline
    def apply(`aria-labelledby`: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseFixedDialogPropshAbout = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onRequestClose = js.Any.fromFunction0(onRequestClose), visible = visible.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-labelledby")(`aria-labelledby`.asInstanceOf[js.Any])
      __obj.asInstanceOf[PickBaseFixedDialogPropshAbout]
    }
    
    @scala.inline
    implicit class PickBaseFixedDialogPropshAboutMutableBuilder[Self <: PickBaseFixedDialogPropshAbout] (val x: Self) extends AnyVal {
