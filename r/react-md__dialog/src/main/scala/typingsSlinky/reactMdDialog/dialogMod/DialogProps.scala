package typingsSlinky.reactMdDialog.dialogMod
...
trait DialogProps
  ...
  /**
    ...
    */
  @JSName("defaultFocus")
  var defaultFocus_DialogProps: js.UndefOr[first | last | String] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("id")
  var id_DialogProps: String = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("role")
  var role_DialogProps: js.UndefOr[dialog | alertdialog | menu | none] = js.native
  /**
...
object DialogProps {
  @scala.inline
  def apply(id: String, onRequestClose: () => Unit, visible: Boolean): DialogProps = {
