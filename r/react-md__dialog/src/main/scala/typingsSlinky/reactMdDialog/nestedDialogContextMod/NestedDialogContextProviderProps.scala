...
@js.native
trait NestedDialogContextProviderProps extends js.Object {
...
object NestedDialogContextProviderProps {
  ...
  @scala.inline
  implicit class NestedDialogContextProviderPropsOps[Self <: NestedDialogContextProviderProps] (val x: Self) extends AnyVal {
