package typingsSlinky.reactMdDialog.components
...
object FixedDialog {
  ...
  object PickBaseFixedDialogPropsh {
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def forceContainer(value: Boolean): this.type = set("forceContainer", value.asInstanceOf[js.Any])
      
      @scala.inline
      def getOptions(value: /* node */ HTMLElement => OptionalFixedPositionOptions): this.type = set("getOptions", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def options(value: OptionalFixedPositionOptions): this.type = set("options", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def role(value: dialog | alertdialog | menu | none): this.type = set("role", value.asInstanceOf[js.Any])
