...
object DialogFooter {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def align(value: none | start | end | between | `stacked-start` | `stacked-end`): this.type = set("align", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DialogFooterProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
