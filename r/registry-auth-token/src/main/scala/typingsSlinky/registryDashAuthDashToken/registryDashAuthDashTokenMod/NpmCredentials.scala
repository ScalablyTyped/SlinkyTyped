...
import typingsSlinky.registryDashAuthDashToken.registryDashAuthDashTokenStrings.Basic
import typingsSlinky.registryDashAuthDashToken.registryDashAuthDashTokenStrings.Bearer
