...
trait SearchBoxProps extends CommonWidgetProps {
  ...
  var onChange: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLInputElement], _]] = js.undefined
  var onReset: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLFormElement], _]] = js.undefined
  var onSubmit: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLFormElement], _]] = js.undefined
...
object SearchBoxProps {
  ...
  def apply(
    ...
    onChange: /* event */ SyntheticEvent[Event, HTMLInputElement] => _ = null,
    onReset: /* event */ SyntheticEvent[Event, HTMLFormElement] => _ = null,
    onSubmit: /* event */ SyntheticEvent[Event, HTMLFormElement] => _ = null,
    reset: Element = null,
