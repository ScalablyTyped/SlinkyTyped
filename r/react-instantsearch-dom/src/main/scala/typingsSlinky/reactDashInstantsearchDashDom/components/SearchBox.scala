...
object SearchBox
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashInstantsearchDashDom.reactDashInstantsearchDashDomMod.SearchBox
    ] {
  ...
  slinky.web.html.form.tag.type, 
  typingsSlinky.reactDashInstantsearchDashDom.reactDashInstantsearchDashDomMod.SearchBox](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
