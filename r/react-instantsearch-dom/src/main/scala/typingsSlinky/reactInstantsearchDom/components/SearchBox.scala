...
object SearchBox
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactInstantsearchDom.mod.SearchBox] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactInstantsearchDom.mod.SearchBox] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactInstantsearchDom.mod.SearchBox] = new slinky.core.BuildingComponent[slinky.web.html.form.tag.type, typingsSlinky.reactInstantsearchDom.mod.SearchBox](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
