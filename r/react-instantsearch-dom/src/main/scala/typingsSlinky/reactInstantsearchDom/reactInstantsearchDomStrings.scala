...
import typingsSlinky.reactInstantsearchDom.mod.Status
...
object reactInstantsearchDomStrings {
  ...
  @js.native
  sealed trait `audio-capture` extends StObject
  @scala.inline
  def `audio-capture`: `audio-capture` = "audio-capture".asInstanceOf[`audio-capture`]
  
  @js.native
  sealed trait `bad-grammar` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `language-not-supported` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `no-speech` extends StObject
  @scala.inline
  def `no-speech`: `no-speech` = "no-speech".asInstanceOf[`no-speech`]
  
  @js.native
  sealed trait `not-allowed` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `service-not-allowed` extends StObject
  @scala.inline
