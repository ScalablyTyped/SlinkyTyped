...
trait SearchBoxProps extends CommonWidgetProps {
  ...
  var onChange: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event_, HTMLInputElement], _]] = js.undefined
  var onReset: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event_, HTMLFormElement], _]] = js.undefined
  var onSubmit: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event_, HTMLFormElement], _]] = js.undefined
  var reset: js.UndefOr[ReactElement] = js.undefined
  var searchAsYouType: js.UndefOr[Boolean] = js.undefined
  var showLoadingIndicator: js.UndefOr[Boolean] = js.undefined
  var submit: js.UndefOr[ReactElement] = js.undefined
}
