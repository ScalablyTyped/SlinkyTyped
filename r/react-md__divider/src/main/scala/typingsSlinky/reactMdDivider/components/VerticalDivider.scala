package typingsSlinky.reactMdDivider.components
...
object VerticalDivider {
  ...
  def withProps(p: VerticalDividerProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: VerticalDivider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
