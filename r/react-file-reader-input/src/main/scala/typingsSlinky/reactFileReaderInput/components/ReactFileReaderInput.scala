...
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.assertive
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.both
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.copy
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.date
...
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.inherit
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.link
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.list
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.listbox
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.location
...
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.off
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.on
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.other
...
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.text
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.time
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.tree
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.url
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.vertical
import typingsSlinky.reactFileReaderInput.reactFileReaderInputStrings.yes
...
object ReactFileReaderInput {
  ...
  @scala.inline
  def apply(onChange: (ChangeEvent[HTMLInputElement], js.Array[Result]) => Unit): Builder = {
