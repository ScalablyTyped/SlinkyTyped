...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  def onChange(event: SyntheticEvent[Event_, _], results: js.Array[Result]): Unit
}

object Props {
  @scala.inline
  def apply(onChange: (SyntheticEvent[Event_, _], js.Array[Result]) => Unit, as: Format = null): Props = {
