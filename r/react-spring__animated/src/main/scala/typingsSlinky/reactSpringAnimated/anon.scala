package typingsSlinky.reactSpringAnimated

import typingsSlinky.reactSpringAnimated.indexCjsMod.WithAnimated
...
object anon {
  ...
  trait AnimatedWithAnimated extends StObject {
    ...
    var animated: typingsSlinky.reactSpringAnimated.mod.WithAnimated = js.native
  }
  object AnimatedWithAnimated {
    
    @scala.inline
    def apply(animated: typingsSlinky.reactSpringAnimated.mod.WithAnimated): AnimatedWithAnimated = {
      val __obj = js.Dynamic.literal(animated = animated.asInstanceOf[js.Any])
    ...
    implicit class AnimatedWithAnimatedMutableBuilder[Self <: AnimatedWithAnimated] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAnimated(value: typingsSlinky.reactSpringAnimated.mod.WithAnimated): Self = StObject.set(x, "animated", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait PartialHostConfig extends StObject {
    ...
    var createAnimatedStyle: js.UndefOr[
        js.Function1[
          ...
          typingsSlinky.reactSpringAnimated.indexCjsMod.Animated[_]
        ]
      ] = js.native
  ...
  object PartialHostConfig {
    ...
    implicit class PartialHostConfigMutableBuilder[Self <: PartialHostConfig] (val x: Self) extends AnyVal {
      ...
      def setCreateAnimatedStyle(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Lookup */ /* style */ js.Any => typingsSlinky.reactSpringAnimated.indexCjsMod.Animated[_]
  ...
  trait PartialHostConfigApplyAnimatedValues extends StObject {
    ...
    var createAnimatedStyle: js.UndefOr[
        js.Function1[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Lookup */ /* style */ js.Any, 
          typingsSlinky.reactSpringAnimated.mod.Animated[_]
        ]
      ] = js.native
  ...
  object PartialHostConfigApplyAnimatedValues {
    ...
    implicit class PartialHostConfigApplyAnimatedValuesMutableBuilder[Self <: PartialHostConfigApplyAnimatedValues] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCreateAnimatedStyle(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Lookup */ /* style */ js.Any => typingsSlinky.reactSpringAnimated.mod.Animated[_]
      ): Self = StObject.set(x, "createAnimatedStyle", js.Any.fromFunction1(value))
