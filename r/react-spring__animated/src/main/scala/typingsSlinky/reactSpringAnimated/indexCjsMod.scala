...
import typingsSlinky.reactSpringAnimated.anon.PartialHostConfig
import typingsSlinky.reactSpringAnimated.anon.Style
...
object indexCjsMod {
  ...
  @js.native
  def createHost(components: js.Array[AnimatableComponent]): typingsSlinky.reactSpringAnimated.anon.Animated = js.native
  @JSImport("@react-spring/animated/index.cjs", "createHost")
  @js.native
  def createHost(
    components: js.Array[AnimatableComponent],
    hasApplyAnimatedValuesCreateAnimatedStyleGetComponentProps: PartialHostConfig
  ): typingsSlinky.reactSpringAnimated.anon.Animated = js.native
  @JSImport("@react-spring/animated/index.cjs", "createHost")
  @js.native
  def createHost(components: StringDictionary[AnimatableComponent]): typingsSlinky.reactSpringAnimated.anon.Animated = js.native
  @JSImport("@react-spring/animated/index.cjs", "createHost")
  @js.native
  def createHost(
