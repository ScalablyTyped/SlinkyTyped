...
object lineMod {
  ...
  type Line = ReactComponentClass[LineProps]
  ...
  object LineProps {
    ...
    implicit class LinePropsMutableBuilder[Self <: LineProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnLineNumberClick(value: SyntheticMouseEvent[HTMLAnchorElement] => Unit): Self = StObject.set(x, "onLineNumberClick", js.Any.fromFunction1(value))
