...
object ChangesOptions {
  ...
  implicit class ChangesOptionsOps[Self <: ChangesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChangefeedQueueSize(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changefeedQueueSize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIncludeInitial(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeInitial")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIncludeOffsets(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeOffsets")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIncludeStates(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeStates")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIncludeTypes(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSquash(value: Boolean | Double): Self = {
        val ret = this.duplicate
