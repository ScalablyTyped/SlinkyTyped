...
object CircleOptions {
  ...
  implicit class CircleOptionsOps[Self <: CircleOptions] (val x: Self) extends AnyVal {
    ...
    def withNumVertices(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("numVertices")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNumVertices: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("numVertices")(js.undefined)
        ret
    }
  }
