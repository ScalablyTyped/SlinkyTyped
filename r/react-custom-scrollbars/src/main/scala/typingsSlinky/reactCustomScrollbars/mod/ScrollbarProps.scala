...
object ScrollbarProps {
  ...
  implicit class ScrollbarPropsOps[Self <: ScrollbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderThumbHorizontal(value: ReactComponentClass[_]): Self = this.set("renderThumbHorizontal", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRenderThumbHorizontal: Self = this.set("renderThumbHorizontal", js.undefined)
    @scala.inline
    def setRenderThumbVertical(value: ReactComponentClass[_]): Self = this.set("renderThumbVertical", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRenderThumbVertical: Self = this.set("renderThumbVertical", js.undefined)
    @scala.inline
    def setRenderTrackHorizontal(value: ReactComponentClass[_]): Self = this.set("renderTrackHorizontal", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRenderTrackHorizontal: Self = this.set("renderTrackHorizontal", js.undefined)
    @scala.inline
    def setRenderTrackVertical(value: ReactComponentClass[_]): Self = this.set("renderTrackVertical", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRenderTrackVertical: Self = this.set("renderTrackVertical", js.undefined)
    @scala.inline
    def setRenderView(value: ReactComponentClass[_]): Self = this.set("renderView", value.asInstanceOf[js.Any])
    @scala.inline
