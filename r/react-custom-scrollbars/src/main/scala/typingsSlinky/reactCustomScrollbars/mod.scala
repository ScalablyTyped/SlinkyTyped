package typingsSlinky.reactCustomScrollbars
...
object mod {
  ...
  object ScrollbarProps {
    ...
    implicit class ScrollbarPropsMutableBuilder[Self <: ScrollbarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderThumbHorizontal(value: ReactComponentClass[_]): Self = StObject.set(x, "renderThumbHorizontal", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderThumbHorizontalUndefined: Self = StObject.set(x, "renderThumbHorizontal", js.undefined)
      
      @scala.inline
      def setRenderThumbVertical(value: ReactComponentClass[_]): Self = StObject.set(x, "renderThumbVertical", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderThumbVerticalUndefined: Self = StObject.set(x, "renderThumbVertical", js.undefined)
      
      @scala.inline
      def setRenderTrackHorizontal(value: ReactComponentClass[_]): Self = StObject.set(x, "renderTrackHorizontal", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderTrackHorizontalUndefined: Self = StObject.set(x, "renderTrackHorizontal", js.undefined)
      
      @scala.inline
      def setRenderTrackVertical(value: ReactComponentClass[_]): Self = StObject.set(x, "renderTrackVertical", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderTrackVerticalUndefined: Self = StObject.set(x, "renderTrackVertical", js.undefined)
      
      @scala.inline
      def setRenderView(value: ReactComponentClass[_]): Self = StObject.set(x, "renderView", value.asInstanceOf[js.Any])
