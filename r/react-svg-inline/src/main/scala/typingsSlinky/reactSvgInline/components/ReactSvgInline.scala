...
object ReactSvgInline {
  ...
  object ReactSvgInline {
    ...
    @scala.inline
    def apply(svg: String): typingsSlinky.reactSvgInline.components.ReactSvgInline.ReactSvgInline.Builder = {
      val __props = js.Dynamic.literal(svg = svg.asInstanceOf[js.Any])
      new typingsSlinky.reactSvgInline.components.ReactSvgInline.ReactSvgInline.Builder(js.Array(this.component, __props.asInstanceOf[SVGInlineProps]))
    }
    ...
    def withProps(p: SVGInlineProps): typingsSlinky.reactSvgInline.components.ReactSvgInline.ReactSvgInline.Builder = new typingsSlinky.reactSvgInline.components.ReactSvgInline.ReactSvgInline.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
