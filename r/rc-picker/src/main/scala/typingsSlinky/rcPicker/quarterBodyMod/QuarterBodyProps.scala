package typingsSlinky.rcPicker.quarterBodyMod
...
object QuarterBodyProps {
  ...
  @scala.inline
  implicit class QuarterBodyPropsOps[Self <: QuarterBodyProps[_], DateType] (val x: Self with QuarterBodyProps[DateType]) extends AnyVal {
    @scala.inline
