...
/* Inlined parent rc-picker.rc-picker/lib/Picker.OmitPanelProps<rc-picker.rc-picker/lib/PickerPanel.PickerPanelBaseProps<DateType>> */
...
object PickerBaseProps {
  ...
  @scala.inline
  implicit class PickerBasePropsOps[Self <: PickerBaseProps[_], DateType] (val x: Self with PickerBaseProps[DateType]) extends AnyVal {
    @scala.inline
