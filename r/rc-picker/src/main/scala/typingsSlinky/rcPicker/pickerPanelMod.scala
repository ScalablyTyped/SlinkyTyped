...
object pickerPanelMod {
  ...
  @js.native
  def default[DateType](props: PickerPanelProps[DateType]): ReactElement = js.native
  ...
  */
  ...
  object PickerPanelProps {
    ...
    @scala.inline
    def PickerPanelBaseProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale, picker: Exclude[PickerMode, date | time]): typingsSlinky.rcPicker.pickerPanelMod.PickerPanelBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any], picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rcPicker.pickerPanelMod.PickerPanelBaseProps[DateType]]
    }
    
    @scala.inline
    def PickerPanelDateProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): typingsSlinky.rcPicker.pickerPanelMod.PickerPanelDateProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rcPicker.pickerPanelMod.PickerPanelDateProps[DateType]]
    }
    
    @scala.inline
    def PickerPanelTimeProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale, picker: time): typingsSlinky.rcPicker.pickerPanelMod.PickerPanelTimeProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any], picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rcPicker.pickerPanelMod.PickerPanelTimeProps[DateType]]
    }
  }
