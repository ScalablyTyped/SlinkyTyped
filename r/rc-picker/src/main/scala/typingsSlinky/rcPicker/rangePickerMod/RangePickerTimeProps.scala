...
object RangePickerTimeProps {
  ...
  @scala.inline
  implicit class RangePickerTimePropsOps[Self[datetype] <: RangePickerTimeProps[datetype], DateType] (val x: Self[DateType]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDefaultOpenValue(value: DateType): Self[DateType] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defaultOpenValue")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDefaultOpenValue: Self[DateType] = {
        val ret = this.duplicate
