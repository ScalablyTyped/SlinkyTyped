...
/* Inlined parent rc-picker.rc-picker/lib/RangePicker.OmitPickerProps<rc-picker.rc-picker/lib/Picker.PickerBaseProps<DateType>> */
@js.native
...
object RangePickerBaseProps {
  ...
  @scala.inline
  implicit class RangePickerBasePropsOps[Self[datetype] <: RangePickerBaseProps[datetype], DateType] (val x: Self[DateType]) extends AnyVal {
    @scala.inline
