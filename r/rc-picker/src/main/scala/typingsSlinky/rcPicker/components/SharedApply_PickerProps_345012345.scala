...
import typingsSlinky.rcPicker.pickerMod.PickerProps
...
abstract class SharedApply_PickerProps_345012345[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def PickerBaseProps[DateType](
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.div.tag.type, ComponentRef]]
  }
  /* The following DOM/SVG props were specified: className, onClick, onContextMenu, onMouseDown, onMouseEnter, onMouseLeave, onMouseUp, style, tabIndex */
