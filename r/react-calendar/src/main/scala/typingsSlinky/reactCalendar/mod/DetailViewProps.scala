...
object DetailViewProps {
  ...
  implicit class DetailViewPropsOps[Self <: DetailViewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHover(value: js.Date): Self = this.set("hover", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnClick(value: /* date */ js.Date => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    @scala.inline
    def setOnMouseOver(value: /* date */ js.Date => Unit): Self = this.set("onMouseOver", js.Any.fromFunction1(value))
    @scala.inline
