...
trait HTMLAttributesidclassNamestyleonCancelvoidisOpenboAnimation extends js.Object {
...
object HTMLAttributesidclassNamestyleonCancelvoidisOpenboAnimation {
  @scala.inline
  def apply(
    ...
    title: String = null
  ): HTMLAttributesidclassNamestyleonCancelvoidisOpenboAnimation = {
    ...
    __obj.asInstanceOf[HTMLAttributesidclassNamestyleonCancelvoidisOpenboAnimation]
  }
}
