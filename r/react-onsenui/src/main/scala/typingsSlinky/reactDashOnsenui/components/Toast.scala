...
import typingsSlinky.reactDashOnsenui.HTMLAttributesidclassNamestyleisOpenbooleananimati
...
object Toast
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashOnsenui.reactDashOnsenuiMod.Toast] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashOnsenui.reactDashOnsenuiMod.Toast] = {
  ...
  type Props = HTMLAttributesidclassNamestyleisOpenbooleananimati
}
