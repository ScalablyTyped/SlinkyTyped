...
@js.native
trait HTMLAttributesidclassNameIsCancelable extends js.Object {
...
object HTMLAttributesidclassNameIsCancelable {
  @scala.inline
  def apply(): HTMLAttributesidclassNameIsCancelable = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributesidclassNameIsCancelable]
  }
  @scala.inline
  implicit class HTMLAttributesidclassNameIsCancelableOps[Self <: HTMLAttributesidclassNameIsCancelable] (val x: Self) extends AnyVal {
    @scala.inline
