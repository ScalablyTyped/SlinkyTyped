...
object HTMLAttributesidclassNameDisabled {
  @scala.inline
  def apply(): HTMLAttributesidclassNameDisabled = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributesidclassNameDisabled]
  }
  @scala.inline
  implicit class HTMLAttributesidclassNameDisabledOps[Self <: HTMLAttributesidclassNameDisabled] (val x: Self) extends AnyVal {
    @scala.inline
