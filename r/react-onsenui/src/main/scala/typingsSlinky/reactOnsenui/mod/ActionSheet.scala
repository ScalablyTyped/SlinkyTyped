...
import typingsSlinky.reactOnsenui.anon.IsDisabled
...
class ActionSheet protected ()
  ...
  def this(props: HTMLAttributesidclassName with IsDisabled) = this()
  /**
    * @deprecated
    * @see https://reactjs.org/docs/legacy-context.html
    */
  def this(props: HTMLAttributesidclassName with IsDisabled, context: js.Any) = this()
}
