...
import typingsSlinky.reactOnsenui.anon.ContentStyle
...
object Page {
  ...
  def withProps(p: HTMLAttributesidclassName with ContentStyle): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
