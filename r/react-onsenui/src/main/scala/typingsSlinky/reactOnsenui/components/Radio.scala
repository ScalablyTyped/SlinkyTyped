...
object Radio {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactOnsenui.mod.Radio] {
  ...
  def withProps(p: HTMLAttributesidclassName with Checked): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
