...
object Range {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactOnsenui.mod.Range] {
  ...
  def withProps(p: HTMLAttributesidclassName with OnChange): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
