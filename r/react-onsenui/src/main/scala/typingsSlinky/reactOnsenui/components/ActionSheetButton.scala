...
import typingsSlinky.reactOnsenui.anon.HTMLAttributesidclassNameIcon
...
object ActionSheetButton {
  ...
  def withProps(p: HTMLAttributesidclassNameIcon): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
