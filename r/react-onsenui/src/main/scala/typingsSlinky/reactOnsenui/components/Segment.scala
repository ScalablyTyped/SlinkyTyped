...
import typingsSlinky.reactOnsenui.anon.Index
...
object Segment {
  ...
  def withProps(p: HTMLAttributesidclassName with Index): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
