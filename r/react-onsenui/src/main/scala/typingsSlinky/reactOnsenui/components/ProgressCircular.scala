...
import typingsSlinky.reactOnsenui.anon.SecondaryValue
...
object ProgressCircular {
  ...
  def withProps(p: HTMLAttributesidclassName with SecondaryValue): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
