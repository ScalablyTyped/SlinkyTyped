...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactOnsenui.mod.Button] {
  ...
  def withProps(p: HTMLAttributesidclassName with typingsSlinky.reactOnsenui.anon.Ripple): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
