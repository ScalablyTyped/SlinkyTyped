...
import typingsSlinky.reactOnsenui.anon.Name
...
object Fab {
  ...
  def withProps(p: HTMLAttributesidclassName with Name): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
