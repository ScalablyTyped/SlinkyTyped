...
object HTMLAttributesidclassNameInputId {
  @scala.inline
  def apply(): HTMLAttributesidclassNameInputId = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributesidclassNameInputId]
  }
  @scala.inline
  implicit class HTMLAttributesidclassNameInputIdOps[Self <: HTMLAttributesidclassNameInputId] (val x: Self) extends AnyVal {
    @scala.inline
