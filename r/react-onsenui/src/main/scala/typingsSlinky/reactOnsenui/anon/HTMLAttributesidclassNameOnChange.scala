...
/* Inlined react-onsenui.react-onsenui.HTMLAttributes<'id' | 'className' | 'style'> & {  modifier :string | undefined,   onChange :(e : std.Event): void | undefined,   value :number | undefined,   disabled :boolean | undefined} */
@js.native
