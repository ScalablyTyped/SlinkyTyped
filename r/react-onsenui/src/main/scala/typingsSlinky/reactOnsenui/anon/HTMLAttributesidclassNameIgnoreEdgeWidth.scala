...
object HTMLAttributesidclassNameIgnoreEdgeWidth {
  ...
  def apply(
    ...
    id: String = null,
    ignoreEdgeWidth: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(ignoreEdgeWidth)) __obj.updateDynamic("ignoreEdgeWidth")(ignoreEdgeWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(tabBorder)) __obj.updateDynamic("tabBorder")(tabBorder.get.asInstanceOf[js.Any])
