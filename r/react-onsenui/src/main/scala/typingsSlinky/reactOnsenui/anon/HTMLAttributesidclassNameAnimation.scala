...
object HTMLAttributesidclassNameAnimation {
  ...
  implicit class HTMLAttributesidclassNameAnimationOps[Self <: HTMLAttributesidclassNameAnimation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnClose(value: /* e */ js.UndefOr[Event] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnModeChange(value: /* e */ js.UndefOr[Event] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnOpen(value: /* e */ js.UndefOr[Event] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnPreClose(value: /* e */ js.UndefOr[Event] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnPreOpen(value: /* e */ js.UndefOr[Event] => Unit): Self = {
        val ret = this.duplicate
