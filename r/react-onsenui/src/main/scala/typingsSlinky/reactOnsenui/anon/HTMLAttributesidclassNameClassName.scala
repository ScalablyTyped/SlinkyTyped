...
object HTMLAttributesidclassNameClassName {
  @scala.inline
  def apply(): HTMLAttributesidclassNameClassName = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributesidclassNameClassName]
  }
  @scala.inline
  implicit class HTMLAttributesidclassNameClassNameOps[Self <: HTMLAttributesidclassNameClassName] (val x: Self) extends AnyVal {
    @scala.inline
