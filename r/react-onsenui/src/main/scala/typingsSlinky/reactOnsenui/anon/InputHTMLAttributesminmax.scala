...
object InputHTMLAttributesminmax {
  ...
  implicit class InputHTMLAttributesminmaxMutableBuilder[Self <: InputHTMLAttributesminmax] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBlur(value: /* e */ SyntheticFocusEvent[_] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnFocus(value: /* e */ SyntheticFocusEvent[_] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
