...
trait IgnoreEdgeWidth extends StObject {
  ...
  var onSwipe: js.UndefOr[
    js.Function2[
      /* index */ Double, 
      /* animationOptions */ typingsSlinky.reactOnsenui.mod.AnimationOptions, 
      Unit
    ]
  ] = js.native
...
object IgnoreEdgeWidth {
  ...
  implicit class IgnoreEdgeWidthMutableBuilder[Self <: IgnoreEdgeWidth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnSwipe(
      value: (/* index */ Double, /* animationOptions */ typingsSlinky.reactOnsenui.mod.AnimationOptions) => Unit
