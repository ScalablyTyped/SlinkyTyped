...
/* Inlined react-onsenui.react-onsenui.HTMLAttributes<'id' | 'className' | 'style'> & {  modifier :string | undefined,   disabled :boolean | undefined,   onClick :(e : react.react.MouseEvent<std.HTMLElement, react.react.NativeMouseEvent> | undefined): void | undefined} */
@js.native
