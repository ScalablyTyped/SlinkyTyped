...
object DataSource {
  ...
  implicit class DataSourceOps[Self <: DataSource[_], T] (val x: Self with DataSource[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderFooter(value: () => js.UndefOr[ReactElement]): Self = this.set("renderFooter", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteRenderFooter: Self = this.set("renderFooter", js.undefined)
    
    @scala.inline
    def setRenderHeader(value: () => js.UndefOr[ReactElement]): Self = this.set("renderHeader", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteRenderHeader: Self = this.set("renderHeader", js.undefined)
    
    @scala.inline
    def setRenderRow(value: (/* row */ T, /* index */ js.UndefOr[Double]) => js.UndefOr[ReactElement]): Self = this.set("renderRow", js.Any.fromFunction2(value))
