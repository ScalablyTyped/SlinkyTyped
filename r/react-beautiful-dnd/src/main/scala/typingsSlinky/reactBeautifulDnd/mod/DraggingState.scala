...
object DraggingState {
  ...
  @scala.inline
  implicit class DraggingStateMutableBuilder[Self <: DraggingState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPhase(value: DRAGGING): Self = StObject.set(x, "phase", value.asInstanceOf[js.Any])
