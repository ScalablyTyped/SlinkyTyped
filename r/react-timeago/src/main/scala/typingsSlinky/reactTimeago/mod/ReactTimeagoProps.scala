...
object ReactTimeagoProps {
  @scala.inline
  def apply[/* <: typingsSlinky.react.mod.ComponentType[js.Object] */ T](date: String | Double | js.Date): ReactTimeagoProps[T] = {
    val __obj = js.Dynamic.literal(date = date.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReactTimeagoProps[T]]
  }
  @scala.inline
  implicit class ReactTimeagoPropsOps[Self <: ReactTimeagoProps[_], /* <: typingsSlinky.react.mod.ComponentType[js.Object] */ T] (val x: Self with ReactTimeagoProps[T]) extends AnyVal {
    @scala.inline
