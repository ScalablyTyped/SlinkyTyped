package typingsSlinky.reactMdExpansionPanel.expansionPanelMod
...
object ExpansionPanelProps {
  ...
  implicit class ExpansionPanelPropsOps[Self <: ExpansionPanelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnExpandClick(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("onExpandClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setCustomHeaderReactElement(value: ReactElement): Self = this.set("customHeader", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomHeader(value: ReactElement): Self = this.set("customHeader", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHeaderRefRefObject(value: ReactRef[HTMLButtonElement]): Self = this.set("headerRef", value.asInstanceOf[js.Any])
    @scala.inline
