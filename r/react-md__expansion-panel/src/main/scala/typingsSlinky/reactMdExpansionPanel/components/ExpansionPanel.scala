...
object ExpansionPanel {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def marginTop(value: Boolean): this.type = set("marginTop", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def raiseable(value: Boolean): this.type = set("raiseable", value.asInstanceOf[js.Any])
