package typingsSlinky.reactMdExpansionPanel.components
...
object ExpansionPanelHeader {
  
  @scala.inline
  def apply(expanded: Boolean, id: String, onClick: SyntheticMouseEvent[HTMLButtonElement] => Unit): Builder = {
    val __props = js.Dynamic.literal(expanded = expanded.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onClick = js.Any.fromFunction1(onClick))
    new Builder(js.Array(this.component, __props.asInstanceOf[ExpansionPanelHeaderProps with RefAttributes[HTMLButtonElement]]))
  }
  ...
  def withProps(p: ExpansionPanelHeaderProps with RefAttributes[HTMLButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
