...
import typingsSlinky.rdflib.rdflibStrings.include
import typingsSlinky.rdflib.rdflibStrings.omit
...
object AutoInitOptions {
  ...
  def apply(
    ...
    data: String = null,
    fetch: (/* input */ RequestInfo, /* init */ js.UndefOr[org.scalajs.dom.experimental.RequestInit]) => js.Promise[ExtendedResponse] = null,
