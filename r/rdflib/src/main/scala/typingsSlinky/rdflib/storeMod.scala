...
object storeMod extends js.Object {
  ...
  trait IndexedFormula
    ...
    def add(subj: typingsSlinky.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]): (typingsSlinky.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    def add(
      subj: typingsSlinky.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType],
      pred: QuadPredicate
    ...
    def query(
      myQuery: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Query */ js.Any,
      callback: js.Function1[/* bindings */ Bindings, Unit],
      dummy: typingsSlinky.rdflib.fetcherMod.default
    ): Unit = js.native
    def query(
      myQuery: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Query */ js.Any,
      callback: js.Function1[/* bindings */ Bindings, Unit],
