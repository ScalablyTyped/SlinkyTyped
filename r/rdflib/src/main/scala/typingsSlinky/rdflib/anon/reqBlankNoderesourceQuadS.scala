...
import typingsSlinky.rdflib.fetcherMod.Fetch
...
@js.native
trait reqBlankNoderesourceQuadS extends js.Object {
  ...
  var resource: QuadSubject with js.UndefOr[QuadSubject] = js.native
...
object reqBlankNoderesourceQuadS {
  ...
  @scala.inline
  def apply(req: BlankNode with js.UndefOr[BlankNode], resource: QuadSubject with js.UndefOr[QuadSubject]): reqBlankNoderesourceQuadS = {
  ...
  @scala.inline
  implicit class reqBlankNoderesourceQuadSOps[Self <: reqBlankNoderesourceQuadS] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: QuadSubject with js.UndefOr[QuadSubject]): Self = this.set("resource", value.asInstanceOf[js.Any])
