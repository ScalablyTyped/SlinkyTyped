...
@js.native
trait reqQuadSubjectoriginalQua extends js.Object {
  ...
  var req: QuadSubject with js.UndefOr[BlankNode] = js.native
...
object reqQuadSubjectoriginalQua {
  ...
  @scala.inline
  def apply(original: QuadSubject with js.UndefOr[NamedNode], req: QuadSubject with js.UndefOr[BlankNode]): reqQuadSubjectoriginalQua = {
  ...
  @scala.inline
  implicit class reqQuadSubjectoriginalQuaOps[Self <: reqQuadSubjectoriginalQua] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReq(value: QuadSubject with js.UndefOr[BlankNode]): Self = this.set("req", value.asInstanceOf[js.Any])
