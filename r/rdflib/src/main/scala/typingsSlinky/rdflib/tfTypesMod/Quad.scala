...
object Quad {
  @scala.inline
  def apply[/* <: typingsSlinky.rdflib.tfTypesMod.Term */ S, /* <: typingsSlinky.rdflib.tfTypesMod.Term */ P, /* <: typingsSlinky.rdflib.tfTypesMod.Term */ O, /* <: typingsSlinky.rdflib.tfTypesMod.Term */ G](equals: BaseQuad => Boolean, graph: G, `object`: O, predicate: P, subject: S): Quad[S, P, O, G] = {
  ...
  @scala.inline
  implicit class QuadOps[Self <: Quad[_, _, _, _], /* <: typingsSlinky.rdflib.tfTypesMod.Term */ S, /* <: typingsSlinky.rdflib.tfTypesMod.Term */ P, /* <: typingsSlinky.rdflib.tfTypesMod.Term */ O, /* <: typingsSlinky.rdflib.tfTypesMod.Term */ G] (val x: Self with (Quad[S, P, O, G])) extends AnyVal {
    @scala.inline
