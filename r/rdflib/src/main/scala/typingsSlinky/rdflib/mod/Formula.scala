...
class Formula protected () extends Node {
  ...
  /**
    ...
    */
  def add(s: Node, p: NamedNode_, o: Node, g: NamedNode_): Double = js.native
  /**
    * Adds all the statements to this formula
    * @param statements A collection of statements
    */
  def addAll(statements: js.Iterable[Statement]): Unit = js.native
  /**
    * Adds a statement to this formula
  ...
  /**
    ...
    */
  def bnode(id: String): BlankNode_ = js.native
  /**
    ...
    */
  def bottomTypeURIs(types: StringDictionary[String | NamedNode_]): StringDictionary[String | NamedNode_] = js.native
  /**
  ...
  /**
    ...
    */
  def list(values: js.Iterable[ValueType]): Collection = js.native
  /**
    * Gets a literal node
    ...
    */
  def literal(`val`: String, lang: String, dt: NamedNode_): Literal_ = js.native
  /**
    * Gets a namespace for the specified namespace's URI
    * @param nsuri The URI for the namespace
    */
  def ns(nsuri: String): js.Function1[/* ln */ String, NamedNode_] = js.native
  /**
  ...
  /**
    ...
    * @param uri The URI
    */
  def sym(uri: String): NamedNode_ = js.native
  def sym(uri: NamedNode_): NamedNode_ = js.native
  /**
  ...
  /**
    ...
    */
  def topTypeURIs(types: StringDictionary[String | NamedNode_]): StringDictionary[String | NamedNode_] = js.native
  /**
    * RDFS Inference
