package typingsSlinky.requestDashStats.requestDashStatsMod
...
object ^ extends js.Object {
  ...
  def apply(server: typingsSlinky.node.httpsMod.Server): StatsEmitter = js.native
  def apply(server: typingsSlinky.node.httpsMod.Server, statsCallback: StatsCallback): StatsEmitter = js.native
}
