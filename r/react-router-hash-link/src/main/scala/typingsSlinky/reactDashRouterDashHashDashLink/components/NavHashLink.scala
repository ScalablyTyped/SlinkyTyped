...
import typingsSlinky.reactDashRouterDashHashDashLink.reactDashRouterDashHashDashLinkMod.NavHashLinkProps
...
object NavHashLink
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashRouterDashHashDashLink.reactDashRouterDashHashDashLinkMod.NavHashLink
    ] {
