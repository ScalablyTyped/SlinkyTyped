...
object HashLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterHashLink.mod.HashLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterHashLink.mod.HashLink] = {
