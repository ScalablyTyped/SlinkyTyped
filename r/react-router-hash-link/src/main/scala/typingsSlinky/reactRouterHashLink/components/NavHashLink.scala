...
object NavHashLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterHashLink.mod.NavHashLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterHashLink.mod.NavHashLink] = {
