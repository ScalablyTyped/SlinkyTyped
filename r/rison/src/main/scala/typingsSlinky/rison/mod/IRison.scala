...
object IRison {
  ...
  implicit class IRisonOps[Self <: IRison] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDecode_array(value: String => js.Array[js.Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("decode_array")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDecode_object(value: String => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("decode_object")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withEncode_array(value: js.Array[js.Any] => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("encode_array")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withEncode_object(value: js.Any => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("encode_object")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withEncode_uri(value: js.Any => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("encode_uri")(js.Any.fromFunction1(value))
        ret
    }
  }
