...
trait TimePickerProps extends js.Object {
  ...
  var clearIcon: ReactElement = js.native
  ...
  var inputIcon: ReactElement = js.native
...
object TimePickerProps {
  ...
  implicit class TimePickerPropsOps[Self <: TimePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddon(value: TimePicker => ReactElement): Self = this.set("addon", js.Any.fromFunction1(value))
