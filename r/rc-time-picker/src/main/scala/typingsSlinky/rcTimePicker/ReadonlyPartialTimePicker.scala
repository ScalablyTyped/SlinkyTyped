...
trait ReadonlyPartialTimePicker extends js.Object {
  val addon: js.UndefOr[js.Function1[/* timepicker */ TimePicker, ReactElement]] = js.undefined
  val allowEmpty: js.UndefOr[Boolean] = js.undefined
  val className: js.UndefOr[String] = js.undefined
  val clearIcon: js.UndefOr[TagMod[Any]] = js.undefined
  ...
  val inputIcon: js.UndefOr[TagMod[Any]] = js.undefined
...
object ReadonlyPartialTimePicker {
  @scala.inline
  def apply(
    addon: /* timepicker */ TimePicker => ReactElement = null,
