...
object mod {
  ...
  object TimePickerProps {
    ...
    implicit class TimePickerPropsMutableBuilder[Self <: TimePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddon(value: TimePicker => ReactElement): Self = StObject.set(x, "addon", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setInputIcon(value: ReactElement): Self = StObject.set(x, "inputIcon", value.asInstanceOf[js.Any])
