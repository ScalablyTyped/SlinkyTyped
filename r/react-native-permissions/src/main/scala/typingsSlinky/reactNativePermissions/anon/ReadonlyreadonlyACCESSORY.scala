...
@js.native
trait ReadonlyreadonlyACCESSORY extends js.Object {
...
object ReadonlyreadonlyACCESSORY {
  ...
  @scala.inline
  implicit class ReadonlyreadonlyACCESSORYOps[Self <: ReadonlyreadonlyACCESSORY] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setACCESSORY_MANAGER(value: windowsDotpermissionDotaccessoryManager): Self = this.set("ACCESSORY_MANAGER", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setACTIVITY(value: windowsDotpermissionDotactivity): Self = this.set("ACTIVITY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setALLOW_ELEVATION(value: windowsDotpermissionDotallowElevation): Self = this.set("ALLOW_ELEVATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setALL_APP_MODS(value: windowsDotpermissionDotallAppMods): Self = this.set("ALL_APP_MODS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setALL_JOYN(value: windowsDotpermissionDotallJoyn): Self = this.set("ALL_JOYN", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAPPOINTMENTS(value: windowsDotpermissionDotappointments): Self = this.set("APPOINTMENTS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAPPOINTMENTS_SYSTEM(value: windowsDotpermissionDotappointmentsSystem): Self = this.set("APPOINTMENTS_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAPP_BROADCAST_SERVICES(value: windowsDotpermissionDotappBroadcastServices): Self = this.set("APP_BROADCAST_SERVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAPP_CAPTURE_SERVICES(value: windowsDotpermissionDotappCaptureServices): Self = this.set("APP_CAPTURE_SERVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAPP_CAPTURE_SETTINGS(value: windowsDotpermissionDotappCaptureSettings): Self = this.set("APP_CAPTURE_SETTINGS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAPP_DIAGNOSTICS(value: windowsDotpermissionDotappDiagnostics): Self = this.set("APP_DIAGNOSTICS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAPP_LICENSING(value: windowsDotpermissionDotappLicensing): Self = this.set("APP_LICENSING", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAUDIO_DEVICE_CONFIGURATION(value: windowsDotpermissionDotaudioDeviceConfiguration): Self = this.set("AUDIO_DEVICE_CONFIGURATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBACKGROUND_MEDIA_PLAYBACK(value: windowsDotpermissionDotbackgroundMediaPlayback): Self = this.set("BACKGROUND_MEDIA_PLAYBACK", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBACKGROUND_MEDIA_RECORDING(value: windowsDotpermissionDotbackgroundMediaRecording): Self = this.set("BACKGROUND_MEDIA_RECORDING", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBACKGROUND_SPATIAL_PERCEPTION(value: windowsDotpermissionDotbackgroundSpatialPerception): Self = this.set("BACKGROUND_SPATIAL_PERCEPTION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBACKGROUND_VOIP(value: windowsDotpermissionDotbackgroundVoIP): Self = this.set("BACKGROUND_VOIP", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBLOCKED_CHAT_MESSAGES(value: windowsDotpermissionDotblockedChatMessages): Self = this.set("BLOCKED_CHAT_MESSAGES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBLUETOOTH(value: windowsDotpermissionDotbluetooth): Self = this.set("BLUETOOTH", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBROAD_FILE_SYSTEM_ACCESS(value: windowsDotpermissionDotbroadFileSystemAccess): Self = this.set("BROAD_FILE_SYSTEM_ACCESS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCAMERA_PROCESSING_EXTENSION(value: windowsDotpermissionDotcameraProcessingExtension): Self = this.set("CAMERA_PROCESSING_EXTENSION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCELLULAR_DEVICE_CONTROL(value: windowsDotpermissionDotcellularDeviceControl): Self = this.set("CELLULAR_DEVICE_CONTROL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCELLULAR_DEVICE_IDENTITY(value: windowsDotpermissionDotcellularDeviceIdentity): Self = this.set("CELLULAR_DEVICE_IDENTITY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCELLULAR_MESSAGING(value: windowsDotpermissionDotcellularMessaging): Self = this.set("CELLULAR_MESSAGING", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCHAT_SYSTEM(value: windowsDotpermissionDotchatSystem): Self = this.set("CHAT_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCODE_GENERATION(value: windowsDotpermissionDotcodeGeneration): Self = this.set("CODE_GENERATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCONFIRM_APP_CLOSE(value: windowsDotpermissionDotconfirmAppClose): Self = this.set("CONFIRM_APP_CLOSE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCONTACTS(value: windowsDotpermissionDotcontacts): Self = this.set("CONTACTS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCONTACTS_SYSTEM(value: windowsDotpermissionDotcontactsSystem): Self = this.set("CONTACTS_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCORTANA_PERMISSIONS(value: windowsDotpermissionDotcortanaPermissions): Self = this.set("CORTANA_PERMISSIONS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCORTANA_SPEECH_ACCESSORY(value: windowsDotpermissionDotcortanaSpeechAccessory): Self = this.set("CORTANA_SPEECH_ACCESSORY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCUSTOM_INSTALL_ACTIONS(value: windowsDotpermissionDotcustomInstallActions): Self = this.set("CUSTOM_INSTALL_ACTIONS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDEVELOPMENT_MODE_NETWORK(value: windowsDotpermissionDotdevelopmentModeNetwork): Self = this.set("DEVELOPMENT_MODE_NETWORK", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDEVICE_MANAGEMENT_DM_ACCOUNT(value: windowsDotpermissionDotdeviceManagementDmAccount): Self = this.set("DEVICE_MANAGEMENT_DM_ACCOUNT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDEVICE_MANAGEMENT_EMAIL_ACCOUNT(value: windowsDotpermissionDotdeviceManagementEmailAccount): Self = this.set("DEVICE_MANAGEMENT_EMAIL_ACCOUNT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDEVICE_MANAGEMENT_FOUNDATION(value: windowsDotpermissionDotdeviceManagementFoundation): Self = this.set("DEVICE_MANAGEMENT_FOUNDATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDEVICE_MANAGEMENT_WAP_SECURITY_POLICIES(value: windowsDotpermissionDotdeviceManagementWapSecurityPolicies): Self = this.set("DEVICE_MANAGEMENT_WAP_SECURITY_POLICIES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDEVICE_PORTAL_PROVIDER(value: windowsDotpermissionDotdevicePortalProvider): Self = this.set("DEVICE_PORTAL_PROVIDER", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDEVICE_UNLOCK(value: windowsDotpermissionDotdeviceUnlock): Self = this.set("DEVICE_UNLOCK", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDOCUMENTS_LIBRARY(value: windowsDotpermissionDotdocumentsLibrary): Self = this.set("DOCUMENTS_LIBRARY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDUAL_SIM_TILES(value: windowsDotpermissionDotdualSimTiles): Self = this.set("DUAL_SIM_TILES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEMAIL(value: windowsDotpermissionDotemail): Self = this.set("EMAIL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEMAIL_SYSTEM(value: windowsDotpermissionDotemailSystem): Self = this.set("EMAIL_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setENTERPRISE_AUTHENTICATION(value: windowsDotpermissionDotenterpriseAuthentication): Self = this.set("ENTERPRISE_AUTHENTICATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setENTERPRISE_CLOUD_S_S_O(value: windowsDotpermissionDotenterpriseCloudSSO): Self = this.set("ENTERPRISE_CLOUD_S_S_O", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setENTERPRISE_DATA_POLICY(value: windowsDotpermissionDotenterpriseDataPolicy): Self = this.set("ENTERPRISE_DATA_POLICY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setENTERPRISE_DEVICE_LOCKDOWN(value: windowsDotpermissionDotenterpriseDeviceLockdown): Self = this.set("ENTERPRISE_DEVICE_LOCKDOWN", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEXPANDED_RESOURCES(value: windowsDotpermissionDotexpandedResources): Self = this.set("EXPANDED_RESOURCES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEXTENDED_BACKGROUND_TASK_TIME(value: windowsDotpermissionDotextendedBackgroundTaskTime): Self = this.set("EXTENDED_BACKGROUND_TASK_TIME", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEXTENDED_EXECUTION_BACKGROUND_AUDIO(value: windowsDotpermissionDotextendedExecutionBackgroundAudio): Self = this.set("EXTENDED_EXECUTION_BACKGROUND_AUDIO", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEXTENDED_EXECUTION_CRITICAL(value: windowsDotpermissionDotextendedExecutionCritical): Self = this.set("EXTENDED_EXECUTION_CRITICAL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEXTENDED_EXECUTION_UNCONSTRAINED(value: windowsDotpermissionDotextendedExecutionUnconstrained): Self = this.set("EXTENDED_EXECUTION_UNCONSTRAINED", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFIRST_SIGN_IN_SETTINGS(value: windowsDotpermissionDotfirstSignInSettings): Self = this.set("FIRST_SIGN_IN_SETTINGS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGAME_BAR_SERVICES(value: windowsDotpermissionDotgameBarServices): Self = this.set("GAME_BAR_SERVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGAME_LIST(value: windowsDotpermissionDotgameList): Self = this.set("GAME_LIST", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGAME_MONITOR(value: windowsDotpermissionDotgameMonitor): Self = this.set("GAME_MONITOR", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGAZE_INPUT(value: windowsDotpermissionDotgazeInput): Self = this.set("GAZE_INPUT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGLOBAL_MEDIA_CONTROL(value: windowsDotpermissionDotglobalMediaControl): Self = this.set("GLOBAL_MEDIA_CONTROL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHUMANINTERFACEDEVICE(value: windowsDotpermissionDothumaninterfacedevice): Self = this.set("HUMANINTERFACEDEVICE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setINPUT_FOREGROUND_OBSERVATION(value: windowsDotpermissionDotinputForegroundObservation): Self = this.set("INPUT_FOREGROUND_OBSERVATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setINPUT_INJECTION_BROKERED(value: windowsDotpermissionDotinputInjectionBrokered): Self = this.set("INPUT_INJECTION_BROKERED", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setINPUT_OBSERVATION(value: windowsDotpermissionDotinputObservation): Self = this.set("INPUT_OBSERVATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setINPUT_SUPPRESSION(value: windowsDotpermissionDotinputSuppression): Self = this.set("INPUT_SUPPRESSION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setINTERNET_CLIENT(value: windowsDotpermissionDotinternetClient): Self = this.set("INTERNET_CLIENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setINTERNET_CLIENT_SERVER(value: windowsDotpermissionDotinternetClientServer): Self = this.set("INTERNET_CLIENT_SERVER", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setINTEROP_SERVICES(value: windowsDotpermissionDotinteropServices): Self = this.set("INTEROP_SERVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIOT(value: windowsDotpermissionDotiot): Self = this.set("IOT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLOCAL_SYSTEM_SERVICES(value: windowsDotpermissionDotlocalSystemServices): Self = this.set("LOCAL_SYSTEM_SERVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLOCATION(value: windowsDotpermissionDotlocation): Self = this.set("LOCATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLOCATION_HISTORY(value: windowsDotpermissionDotlocationHistory): Self = this.set("LOCATION_HISTORY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLOCATION_SYSTEM(value: windowsDotpermissionDotlocationSystem): Self = this.set("LOCATION_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLOW_LEVEL(value: windowsDotpermissionDotlowLevel): Self = this.set("LOW_LEVEL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLOW_LEVEL_DEVICES(value: windowsDotpermissionDotlowLevelDevices): Self = this.set("LOW_LEVEL_DEVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMICROPHONE(value: windowsDotpermissionDotmicrophone): Self = this.set("MICROPHONE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMOBILE(value: windowsDotpermissionDotmobile): Self = this.set("MOBILE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMODIFIABLE_APP(value: windowsDotpermissionDotmodifiableApp): Self = this.set("MODIFIABLE_APP", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMUSIC_LIBRARY(value: windowsDotpermissionDotmusicLibrary): Self = this.set("MUSIC_LIBRARY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNETWORKING_VPN_PROVIDER(value: windowsDotpermissionDotnetworkingVpnProvider): Self = this.set("NETWORKING_VPN_PROVIDER", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNETWORK_CONNECTION_MANAGER_PROVISIONING(value: windowsDotpermissionDotnetworkConnectionManagerProvisioning): Self = this.set("NETWORK_CONNECTION_MANAGER_PROVISIONING", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNETWORK_DATA_PLAN_PROVISIONING(value: windowsDotpermissionDotnetworkDataPlanProvisioning): Self = this.set("NETWORK_DATA_PLAN_PROVISIONING", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNETWORK_DATA_USAGE_MANAGEMENT(value: windowsDotpermissionDotnetworkDataUsageManagement): Self = this.set("NETWORK_DATA_USAGE_MANAGEMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOEM_DEPLOYMENT(value: windowsDotpermissionDotoemDeployment): Self = this.set("OEM_DEPLOYMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOEM_PUBLIC_DIRECTORY(value: windowsDotpermissionDotoemPublicDirectory): Self = this.set("OEM_PUBLIC_DIRECTORY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setONE_PROCESS_VOIP(value: windowsDotpermissionDotoneProcessVoIP): Self = this.set("ONE_PROCESS_VOIP", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOPTICAL(value: windowsDotpermissionDotoptical): Self = this.set("OPTICAL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPACKAGED_SERVICES(value: windowsDotpermissionDotpackagedServices): Self = this.set("PACKAGED_SERVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPACKAGES_SERVICES(value: windowsDotpermissionDotpackagesServices): Self = this.set("PACKAGES_SERVICES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPACKAGE_MANAGEMENT(value: windowsDotpermissionDotpackageManagement): Self = this.set("PACKAGE_MANAGEMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPACKAGE_POLICY_SYSTEM(value: windowsDotpermissionDotpackagePolicySystem): Self = this.set("PACKAGE_POLICY_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPACKAGE_QUERY(value: windowsDotpermissionDotpackageQuery): Self = this.set("PACKAGE_QUERY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPACKAGE_WRITE_REDIRECTION_COMPATIBILITY_SHIM(value: windowsDotpermissionDotpackageWriteRedirectionCompatibilityShim): Self = this.set("PACKAGE_WRITE_REDIRECTION_COMPATIBILITY_SHIM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPHONE_CALL(value: windowsDotpermissionDotphoneCall): Self = this.set("PHONE_CALL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPHONE_CALL_HISTORY(value: windowsDotpermissionDotphoneCallHistory): Self = this.set("PHONE_CALL_HISTORY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPHONE_CALL_HISTORY_SYSTEM(value: windowsDotpermissionDotphoneCallHistorySystem): Self = this.set("PHONE_CALL_HISTORY_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPHONE_LINE_TRANSPORT_MANAGEMENT(value: windowsDotpermissionDotphoneLineTransportManagement): Self = this.set("PHONE_LINE_TRANSPORT_MANAGEMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPICTURES_LIBRARY(value: windowsDotpermissionDotpicturesLibrary): Self = this.set("PICTURES_LIBRARY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPOINT_OF_SERVICE(value: windowsDotpermissionDotpointOfService): Self = this.set("POINT_OF_SERVICE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPREVIEW_INK_WORKSPACE(value: windowsDotpermissionDotpreviewInkWorkspace): Self = this.set("PREVIEW_INK_WORKSPACE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPREVIEW_PEN_WORKSPACE(value: windowsDotpermissionDotpreviewPenWorkspace): Self = this.set("PREVIEW_PEN_WORKSPACE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPREVIEW_STORE(value: windowsDotpermissionDotpreviewStore): Self = this.set("PREVIEW_STORE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPREVIEW_UI_COMPOSITION(value: windowsDotpermissionDotpreviewUiComposition): Self = this.set("PREVIEW_UI_COMPOSITION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPRIVATE_NETWORK_CLIENT_SERVER(value: windowsDotpermissionDotprivateNetworkClientServer): Self = this.set("PRIVATE_NETWORK_CLIENT_SERVER", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPROTECTED_APP(value: windowsDotpermissionDotprotectedApp): Self = this.set("PROTECTED_APP", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPROXIMITY(value: windowsDotpermissionDotproximity): Self = this.set("PROXIMITY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRADIOS(value: windowsDotpermissionDotradios): Self = this.set("RADIOS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRECORDED_CALLS_FOLDER(value: windowsDotpermissionDotrecordedCallsFolder): Self = this.set("RECORDED_CALLS_FOLDER", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREMOTE_PASSPORT_AUTHENTICATION(value: windowsDotpermissionDotremotePassportAuthentication): Self = this.set("REMOTE_PASSPORT_AUTHENTICATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREMOTE_SYSTEM(value: windowsDotpermissionDotremoteSystem): Self = this.set("REMOTE_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREMOVABLE_STORAGE(value: windowsDotpermissionDotremovableStorage): Self = this.set("REMOVABLE_STORAGE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRESCAP(value: windowsDotpermissionDotrescap): Self = this.set("RESCAP", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRUN_FULL_TRUST(value: windowsDotpermissionDotrunFullTrust): Self = this.set("RUN_FULL_TRUST", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSCREEN_DUPLICATION(value: windowsDotpermissionDotscreenDuplication): Self = this.set("SCREEN_DUPLICATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSECONDARY_AUTHENTICATION_FACTOR(value: windowsDotpermissionDotsecondaryAuthenticationFactor): Self = this.set("SECONDARY_AUTHENTICATION_FACTOR", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSECURE_ASSESSMENT(value: windowsDotpermissionDotsecureAssessment): Self = this.set("SECURE_ASSESSMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSERIALCOMMUNICATION(value: windowsDotpermissionDotserialcommunication): Self = this.set("SERIALCOMMUNICATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSHARED_USER_CERTIFICATES(value: windowsDotpermissionDotsharedUserCertificates): Self = this.set("SHARED_USER_CERTIFICATES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSLAPI_QUERY_LICENSE_VALUE(value: windowsDotpermissionDotslapiQueryLicenseValue): Self = this.set("SLAPI_QUERY_LICENSE_VALUE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSMBIOS(value: windowsDotpermissionDotsmbios): Self = this.set("SMBIOS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSMS_SEND(value: windowsDotpermissionDotsmsSend): Self = this.set("SMS_SEND", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSPATIAL_PERCEPTION(value: windowsDotpermissionDotspatialPerception): Self = this.set("SPATIAL_PERCEPTION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSTART_SCREEN_MANAGEMENT(value: windowsDotpermissionDotstartScreenManagement): Self = this.set("START_SCREEN_MANAGEMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSTORE_LICENSE_MANAGEMENT(value: windowsDotpermissionDotstoreLicenseManagement): Self = this.set("STORE_LICENSE_MANAGEMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSYSTEM_MANAGEMENT(value: windowsDotpermissionDotsystemManagement): Self = this.set("SYSTEM_MANAGEMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTARGETED_CONTENT(value: windowsDotpermissionDottargetedContent): Self = this.set("TARGETED_CONTENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTEAM_EDITION_DEVICE_CREDENTIAL(value: windowsDotpermissionDotteamEditionDeviceCredential): Self = this.set("TEAM_EDITION_DEVICE_CREDENTIAL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTEAM_EDITION_EXPERIENCE(value: windowsDotpermissionDotteamEditionExperience): Self = this.set("TEAM_EDITION_EXPERIENCE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTEAM_EDITION_VIEW(value: windowsDotpermissionDotteamEditionView): Self = this.set("TEAM_EDITION_VIEW", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUAP(value: windowsDotpermissionDotuap): Self = this.set("UAP", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUI_AUTOMATION(value: windowsDotpermissionDotuiAutomation): Self = this.set("UI_AUTOMATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUNVIRTUALIZED_RESOURCES(value: windowsDotpermissionDotunvirtualizedResources): Self = this.set("UNVIRTUALIZED_RESOURCES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUSB(value: windowsDotpermissionDotusb): Self = this.set("USB", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUSER_ACCOUNT_INFORMATION(value: windowsDotpermissionDotuserAccountInformation): Self = this.set("USER_ACCOUNT_INFORMATION", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUSER_DATA_ACCOUNTS_PROVIDER(value: windowsDotpermissionDotuserDataAccountsProvider): Self = this.set("USER_DATA_ACCOUNTS_PROVIDER", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUSER_DATA_SYSTEM(value: windowsDotpermissionDotuserDataSystem): Self = this.set("USER_DATA_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUSER_PRINCIPAL_NAME(value: windowsDotpermissionDotuserPrincipalName): Self = this.set("USER_PRINCIPAL_NAME", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUSER_SYSTEM_ID(value: windowsDotpermissionDotuserSystemId): Self = this.set("USER_SYSTEM_ID", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVIDEOS_LIBRARY(value: windowsDotpermissionDotvideosLibrary): Self = this.set("VIDEOS_LIBRARY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVOIP_CALL(value: windowsDotpermissionDotvoipCall): Self = this.set("VOIP_CALL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWALLET_SYSTEM(value: windowsDotpermissionDotwalletSystem): Self = this.set("WALLET_SYSTEM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWEBCAM(value: windowsDotpermissionDotwebcam): Self = this.set("WEBCAM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWIFI_CONTROL(value: windowsDotpermissionDotwiFiControl): Self = this.set("WIFI_CONTROL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setXBOX_ACCESSORY_MANAGEMENT(value: windowsDotpermissionDotxboxAccessoryManagement): Self = this.set("XBOX_ACCESSORY_MANAGEMENT", value.asInstanceOf[js.Any])
  }
}
