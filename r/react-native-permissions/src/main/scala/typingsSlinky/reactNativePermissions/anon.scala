...
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotACCEPT_HANDOVER
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotACCESS_BACKGROUND_LOCATION
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotACCESS_COARSE_LOCATION
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotACCESS_FINE_LOCATION
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotACTIVITY_RECOGNITION
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotANSWER_PHONE_CALLS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotBODY_SENSORS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotCALL_PHONE
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotCAMERA
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotGET_ACCOUNTS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotPROCESS_OUTGOING_CALLS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotREAD_CALENDAR
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotREAD_CALL_LOG
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotREAD_CONTACTS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotREAD_EXTERNAL_STORAGE
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotREAD_PHONE_NUMBERS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotREAD_PHONE_STATE
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotREAD_SMS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotRECEIVE_MMS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotRECEIVE_SMS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotRECEIVE_WAP_PUSH
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotRECORD_AUDIO
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotSEND_SMS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotUSE_SIP
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotWRITE_CALENDAR
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotWRITE_CALL_LOG
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotWRITE_CONTACTS
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.androidDotpermissionDotWRITE_EXTERNAL_STORAGE
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.blocked
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.comDotandroidDotvoicemailDotpermissionDotADD_VOICEMAIL
...
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.iosDotpermissionDotAPP_TRACKING_TRANSPARENCY
...
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.iosDotpermissionDotPHOTO_LIBRARY_ADD_ONLY
...
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotaccessoryManager
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotactivity
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotallAppMods
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotallJoyn
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotallowElevation
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotappBroadcastServices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotappCaptureServices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotappCaptureSettings
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotappDiagnostics
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotappLicensing
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotappointments
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotappointmentsSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotaudioDeviceConfiguration
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotbackgroundMediaPlayback
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotbackgroundMediaRecording
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotbackgroundSpatialPerception
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotbackgroundVoIP
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotblockedChatMessages
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotbluetooth
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotbroadFileSystemAccess
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcameraProcessingExtension
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcellularDeviceControl
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcellularDeviceIdentity
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcellularMessaging
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotchatSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcodeGeneration
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotconfirmAppClose
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcontacts
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcontactsSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcortanaPermissions
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcortanaSpeechAccessory
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotcustomInstallActions
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdevelopmentModeNetwork
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdeviceManagementDmAccount
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdeviceManagementEmailAccount
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdeviceManagementFoundation
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdeviceManagementWapSecurityPolicies
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdevicePortalProvider
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdeviceUnlock
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdocumentsLibrary
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotdualSimTiles
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotemail
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotemailSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotenterpriseAuthentication
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotenterpriseCloudSSO
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotenterpriseDataPolicy
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotenterpriseDeviceLockdown
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotexpandedResources
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotextendedBackgroundTaskTime
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotextendedExecutionBackgroundAudio
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotextendedExecutionCritical
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotextendedExecutionUnconstrained
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotfirstSignInSettings
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotgameBarServices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotgameList
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotgameMonitor
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotgazeInput
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotglobalMediaControl
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDothumaninterfacedevice
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotinputForegroundObservation
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotinputInjectionBrokered
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotinputObservation
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotinputSuppression
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotinternetClient
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotinternetClientServer
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotinteropServices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotiot
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotlocalSystemServices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotlocation
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotlocationHistory
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotlocationSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotlowLevel
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotlowLevelDevices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotmicrophone
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotmobile
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotmodifiableApp
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotmusicLibrary
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotnetworkConnectionManagerProvisioning
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotnetworkDataPlanProvisioning
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotnetworkDataUsageManagement
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotnetworkingVpnProvider
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotoemDeployment
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotoemPublicDirectory
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotoneProcessVoIP
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotoptical
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpackageManagement
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpackagePolicySystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpackageQuery
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpackageWriteRedirectionCompatibilityShim
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpackagedServices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpackagesServices
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotphoneCall
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotphoneCallHistory
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotphoneCallHistorySystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotphoneLineTransportManagement
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpicturesLibrary
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpointOfService
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpreviewInkWorkspace
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpreviewPenWorkspace
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpreviewStore
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotpreviewUiComposition
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotprivateNetworkClientServer
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotprotectedApp
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotproximity
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotradios
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotrecordedCallsFolder
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotremotePassportAuthentication
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotremoteSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotremovableStorage
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotrescap
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotrunFullTrust
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotscreenDuplication
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotsecondaryAuthenticationFactor
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotsecureAssessment
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotserialcommunication
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotsharedUserCertificates
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotslapiQueryLicenseValue
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotsmbios
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotsmsSend
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotspatialPerception
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotstartScreenManagement
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotstoreLicenseManagement
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotsystemManagement
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDottargetedContent
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotteamEditionDeviceCredential
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotteamEditionExperience
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotteamEditionView
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotuap
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotuiAutomation
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotunvirtualizedResources
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotusb
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotuserAccountInformation
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotuserDataAccountsProvider
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotuserDataSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotuserPrincipalName
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotuserSystemId
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotvideosLibrary
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotvoipCall
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotwalletSystem
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotwebcam
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotwiFiControl
import typingsSlinky.reactNativePermissions.reactNativePermissionsStrings.windowsDotpermissionDotxboxAccessoryManagement
...
object anon {
  ...
  @js.native
  trait ReadonlyreadonlyACCEPTHAN extends StObject {
  ...
  object ReadonlyreadonlyACCEPTHAN {
    ...
    @scala.inline
    implicit class ReadonlyreadonlyACCEPTHANMutableBuilder[Self <: ReadonlyreadonlyACCEPTHAN] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ReadonlyreadonlyACCESSORY extends StObject {
  ...
  object ReadonlyreadonlyACCESSORY {
    ...
    @scala.inline
    implicit class ReadonlyreadonlyACCESSORYMutableBuilder[Self <: ReadonlyreadonlyACCESSORY] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setACCESSORY_MANAGER(value: windowsDotpermissionDotaccessoryManager): Self = StObject.set(x, "ACCESSORY_MANAGER", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setACTIVITY(value: windowsDotpermissionDotactivity): Self = StObject.set(x, "ACTIVITY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setALLOW_ELEVATION(value: windowsDotpermissionDotallowElevation): Self = StObject.set(x, "ALLOW_ELEVATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setALL_APP_MODS(value: windowsDotpermissionDotallAppMods): Self = StObject.set(x, "ALL_APP_MODS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setALL_JOYN(value: windowsDotpermissionDotallJoyn): Self = StObject.set(x, "ALL_JOYN", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAPPOINTMENTS(value: windowsDotpermissionDotappointments): Self = StObject.set(x, "APPOINTMENTS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAPPOINTMENTS_SYSTEM(value: windowsDotpermissionDotappointmentsSystem): Self = StObject.set(x, "APPOINTMENTS_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAPP_BROADCAST_SERVICES(value: windowsDotpermissionDotappBroadcastServices): Self = StObject.set(x, "APP_BROADCAST_SERVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAPP_CAPTURE_SERVICES(value: windowsDotpermissionDotappCaptureServices): Self = StObject.set(x, "APP_CAPTURE_SERVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAPP_CAPTURE_SETTINGS(value: windowsDotpermissionDotappCaptureSettings): Self = StObject.set(x, "APP_CAPTURE_SETTINGS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAPP_DIAGNOSTICS(value: windowsDotpermissionDotappDiagnostics): Self = StObject.set(x, "APP_DIAGNOSTICS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAPP_LICENSING(value: windowsDotpermissionDotappLicensing): Self = StObject.set(x, "APP_LICENSING", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAUDIO_DEVICE_CONFIGURATION(value: windowsDotpermissionDotaudioDeviceConfiguration): Self = StObject.set(x, "AUDIO_DEVICE_CONFIGURATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBACKGROUND_MEDIA_PLAYBACK(value: windowsDotpermissionDotbackgroundMediaPlayback): Self = StObject.set(x, "BACKGROUND_MEDIA_PLAYBACK", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBACKGROUND_MEDIA_RECORDING(value: windowsDotpermissionDotbackgroundMediaRecording): Self = StObject.set(x, "BACKGROUND_MEDIA_RECORDING", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBACKGROUND_SPATIAL_PERCEPTION(value: windowsDotpermissionDotbackgroundSpatialPerception): Self = StObject.set(x, "BACKGROUND_SPATIAL_PERCEPTION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBACKGROUND_VOIP(value: windowsDotpermissionDotbackgroundVoIP): Self = StObject.set(x, "BACKGROUND_VOIP", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBLOCKED_CHAT_MESSAGES(value: windowsDotpermissionDotblockedChatMessages): Self = StObject.set(x, "BLOCKED_CHAT_MESSAGES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBLUETOOTH(value: windowsDotpermissionDotbluetooth): Self = StObject.set(x, "BLUETOOTH", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBROAD_FILE_SYSTEM_ACCESS(value: windowsDotpermissionDotbroadFileSystemAccess): Self = StObject.set(x, "BROAD_FILE_SYSTEM_ACCESS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCAMERA_PROCESSING_EXTENSION(value: windowsDotpermissionDotcameraProcessingExtension): Self = StObject.set(x, "CAMERA_PROCESSING_EXTENSION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCELLULAR_DEVICE_CONTROL(value: windowsDotpermissionDotcellularDeviceControl): Self = StObject.set(x, "CELLULAR_DEVICE_CONTROL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCELLULAR_DEVICE_IDENTITY(value: windowsDotpermissionDotcellularDeviceIdentity): Self = StObject.set(x, "CELLULAR_DEVICE_IDENTITY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCELLULAR_MESSAGING(value: windowsDotpermissionDotcellularMessaging): Self = StObject.set(x, "CELLULAR_MESSAGING", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCHAT_SYSTEM(value: windowsDotpermissionDotchatSystem): Self = StObject.set(x, "CHAT_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCODE_GENERATION(value: windowsDotpermissionDotcodeGeneration): Self = StObject.set(x, "CODE_GENERATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCONFIRM_APP_CLOSE(value: windowsDotpermissionDotconfirmAppClose): Self = StObject.set(x, "CONFIRM_APP_CLOSE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCONTACTS(value: windowsDotpermissionDotcontacts): Self = StObject.set(x, "CONTACTS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCONTACTS_SYSTEM(value: windowsDotpermissionDotcontactsSystem): Self = StObject.set(x, "CONTACTS_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCORTANA_PERMISSIONS(value: windowsDotpermissionDotcortanaPermissions): Self = StObject.set(x, "CORTANA_PERMISSIONS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCORTANA_SPEECH_ACCESSORY(value: windowsDotpermissionDotcortanaSpeechAccessory): Self = StObject.set(x, "CORTANA_SPEECH_ACCESSORY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCUSTOM_INSTALL_ACTIONS(value: windowsDotpermissionDotcustomInstallActions): Self = StObject.set(x, "CUSTOM_INSTALL_ACTIONS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDEVELOPMENT_MODE_NETWORK(value: windowsDotpermissionDotdevelopmentModeNetwork): Self = StObject.set(x, "DEVELOPMENT_MODE_NETWORK", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDEVICE_MANAGEMENT_DM_ACCOUNT(value: windowsDotpermissionDotdeviceManagementDmAccount): Self = StObject.set(x, "DEVICE_MANAGEMENT_DM_ACCOUNT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDEVICE_MANAGEMENT_EMAIL_ACCOUNT(value: windowsDotpermissionDotdeviceManagementEmailAccount): Self = StObject.set(x, "DEVICE_MANAGEMENT_EMAIL_ACCOUNT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDEVICE_MANAGEMENT_FOUNDATION(value: windowsDotpermissionDotdeviceManagementFoundation): Self = StObject.set(x, "DEVICE_MANAGEMENT_FOUNDATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDEVICE_MANAGEMENT_WAP_SECURITY_POLICIES(value: windowsDotpermissionDotdeviceManagementWapSecurityPolicies): Self = StObject.set(x, "DEVICE_MANAGEMENT_WAP_SECURITY_POLICIES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDEVICE_PORTAL_PROVIDER(value: windowsDotpermissionDotdevicePortalProvider): Self = StObject.set(x, "DEVICE_PORTAL_PROVIDER", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDEVICE_UNLOCK(value: windowsDotpermissionDotdeviceUnlock): Self = StObject.set(x, "DEVICE_UNLOCK", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDOCUMENTS_LIBRARY(value: windowsDotpermissionDotdocumentsLibrary): Self = StObject.set(x, "DOCUMENTS_LIBRARY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDUAL_SIM_TILES(value: windowsDotpermissionDotdualSimTiles): Self = StObject.set(x, "DUAL_SIM_TILES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEMAIL(value: windowsDotpermissionDotemail): Self = StObject.set(x, "EMAIL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEMAIL_SYSTEM(value: windowsDotpermissionDotemailSystem): Self = StObject.set(x, "EMAIL_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setENTERPRISE_AUTHENTICATION(value: windowsDotpermissionDotenterpriseAuthentication): Self = StObject.set(x, "ENTERPRISE_AUTHENTICATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setENTERPRISE_CLOUD_S_S_O(value: windowsDotpermissionDotenterpriseCloudSSO): Self = StObject.set(x, "ENTERPRISE_CLOUD_S_S_O", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setENTERPRISE_DATA_POLICY(value: windowsDotpermissionDotenterpriseDataPolicy): Self = StObject.set(x, "ENTERPRISE_DATA_POLICY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setENTERPRISE_DEVICE_LOCKDOWN(value: windowsDotpermissionDotenterpriseDeviceLockdown): Self = StObject.set(x, "ENTERPRISE_DEVICE_LOCKDOWN", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEXPANDED_RESOURCES(value: windowsDotpermissionDotexpandedResources): Self = StObject.set(x, "EXPANDED_RESOURCES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEXTENDED_BACKGROUND_TASK_TIME(value: windowsDotpermissionDotextendedBackgroundTaskTime): Self = StObject.set(x, "EXTENDED_BACKGROUND_TASK_TIME", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEXTENDED_EXECUTION_BACKGROUND_AUDIO(value: windowsDotpermissionDotextendedExecutionBackgroundAudio): Self = StObject.set(x, "EXTENDED_EXECUTION_BACKGROUND_AUDIO", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEXTENDED_EXECUTION_CRITICAL(value: windowsDotpermissionDotextendedExecutionCritical): Self = StObject.set(x, "EXTENDED_EXECUTION_CRITICAL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEXTENDED_EXECUTION_UNCONSTRAINED(value: windowsDotpermissionDotextendedExecutionUnconstrained): Self = StObject.set(x, "EXTENDED_EXECUTION_UNCONSTRAINED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFIRST_SIGN_IN_SETTINGS(value: windowsDotpermissionDotfirstSignInSettings): Self = StObject.set(x, "FIRST_SIGN_IN_SETTINGS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGAME_BAR_SERVICES(value: windowsDotpermissionDotgameBarServices): Self = StObject.set(x, "GAME_BAR_SERVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGAME_LIST(value: windowsDotpermissionDotgameList): Self = StObject.set(x, "GAME_LIST", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGAME_MONITOR(value: windowsDotpermissionDotgameMonitor): Self = StObject.set(x, "GAME_MONITOR", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGAZE_INPUT(value: windowsDotpermissionDotgazeInput): Self = StObject.set(x, "GAZE_INPUT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGLOBAL_MEDIA_CONTROL(value: windowsDotpermissionDotglobalMediaControl): Self = StObject.set(x, "GLOBAL_MEDIA_CONTROL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHUMANINTERFACEDEVICE(value: windowsDotpermissionDothumaninterfacedevice): Self = StObject.set(x, "HUMANINTERFACEDEVICE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINPUT_FOREGROUND_OBSERVATION(value: windowsDotpermissionDotinputForegroundObservation): Self = StObject.set(x, "INPUT_FOREGROUND_OBSERVATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINPUT_INJECTION_BROKERED(value: windowsDotpermissionDotinputInjectionBrokered): Self = StObject.set(x, "INPUT_INJECTION_BROKERED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINPUT_OBSERVATION(value: windowsDotpermissionDotinputObservation): Self = StObject.set(x, "INPUT_OBSERVATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINPUT_SUPPRESSION(value: windowsDotpermissionDotinputSuppression): Self = StObject.set(x, "INPUT_SUPPRESSION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINTERNET_CLIENT(value: windowsDotpermissionDotinternetClient): Self = StObject.set(x, "INTERNET_CLIENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINTERNET_CLIENT_SERVER(value: windowsDotpermissionDotinternetClientServer): Self = StObject.set(x, "INTERNET_CLIENT_SERVER", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINTEROP_SERVICES(value: windowsDotpermissionDotinteropServices): Self = StObject.set(x, "INTEROP_SERVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIOT(value: windowsDotpermissionDotiot): Self = StObject.set(x, "IOT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLOCAL_SYSTEM_SERVICES(value: windowsDotpermissionDotlocalSystemServices): Self = StObject.set(x, "LOCAL_SYSTEM_SERVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLOCATION(value: windowsDotpermissionDotlocation): Self = StObject.set(x, "LOCATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLOCATION_HISTORY(value: windowsDotpermissionDotlocationHistory): Self = StObject.set(x, "LOCATION_HISTORY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLOCATION_SYSTEM(value: windowsDotpermissionDotlocationSystem): Self = StObject.set(x, "LOCATION_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLOW_LEVEL(value: windowsDotpermissionDotlowLevel): Self = StObject.set(x, "LOW_LEVEL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLOW_LEVEL_DEVICES(value: windowsDotpermissionDotlowLevelDevices): Self = StObject.set(x, "LOW_LEVEL_DEVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMICROPHONE(value: windowsDotpermissionDotmicrophone): Self = StObject.set(x, "MICROPHONE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMOBILE(value: windowsDotpermissionDotmobile): Self = StObject.set(x, "MOBILE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMODIFIABLE_APP(value: windowsDotpermissionDotmodifiableApp): Self = StObject.set(x, "MODIFIABLE_APP", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMUSIC_LIBRARY(value: windowsDotpermissionDotmusicLibrary): Self = StObject.set(x, "MUSIC_LIBRARY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNETWORKING_VPN_PROVIDER(value: windowsDotpermissionDotnetworkingVpnProvider): Self = StObject.set(x, "NETWORKING_VPN_PROVIDER", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNETWORK_CONNECTION_MANAGER_PROVISIONING(value: windowsDotpermissionDotnetworkConnectionManagerProvisioning): Self = StObject.set(x, "NETWORK_CONNECTION_MANAGER_PROVISIONING", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNETWORK_DATA_PLAN_PROVISIONING(value: windowsDotpermissionDotnetworkDataPlanProvisioning): Self = StObject.set(x, "NETWORK_DATA_PLAN_PROVISIONING", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNETWORK_DATA_USAGE_MANAGEMENT(value: windowsDotpermissionDotnetworkDataUsageManagement): Self = StObject.set(x, "NETWORK_DATA_USAGE_MANAGEMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOEM_DEPLOYMENT(value: windowsDotpermissionDotoemDeployment): Self = StObject.set(x, "OEM_DEPLOYMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOEM_PUBLIC_DIRECTORY(value: windowsDotpermissionDotoemPublicDirectory): Self = StObject.set(x, "OEM_PUBLIC_DIRECTORY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setONE_PROCESS_VOIP(value: windowsDotpermissionDotoneProcessVoIP): Self = StObject.set(x, "ONE_PROCESS_VOIP", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOPTICAL(value: windowsDotpermissionDotoptical): Self = StObject.set(x, "OPTICAL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPACKAGED_SERVICES(value: windowsDotpermissionDotpackagedServices): Self = StObject.set(x, "PACKAGED_SERVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPACKAGES_SERVICES(value: windowsDotpermissionDotpackagesServices): Self = StObject.set(x, "PACKAGES_SERVICES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPACKAGE_MANAGEMENT(value: windowsDotpermissionDotpackageManagement): Self = StObject.set(x, "PACKAGE_MANAGEMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPACKAGE_POLICY_SYSTEM(value: windowsDotpermissionDotpackagePolicySystem): Self = StObject.set(x, "PACKAGE_POLICY_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPACKAGE_QUERY(value: windowsDotpermissionDotpackageQuery): Self = StObject.set(x, "PACKAGE_QUERY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPACKAGE_WRITE_REDIRECTION_COMPATIBILITY_SHIM(value: windowsDotpermissionDotpackageWriteRedirectionCompatibilityShim): Self = StObject.set(x, "PACKAGE_WRITE_REDIRECTION_COMPATIBILITY_SHIM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPHONE_CALL(value: windowsDotpermissionDotphoneCall): Self = StObject.set(x, "PHONE_CALL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPHONE_CALL_HISTORY(value: windowsDotpermissionDotphoneCallHistory): Self = StObject.set(x, "PHONE_CALL_HISTORY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPHONE_CALL_HISTORY_SYSTEM(value: windowsDotpermissionDotphoneCallHistorySystem): Self = StObject.set(x, "PHONE_CALL_HISTORY_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPHONE_LINE_TRANSPORT_MANAGEMENT(value: windowsDotpermissionDotphoneLineTransportManagement): Self = StObject.set(x, "PHONE_LINE_TRANSPORT_MANAGEMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPICTURES_LIBRARY(value: windowsDotpermissionDotpicturesLibrary): Self = StObject.set(x, "PICTURES_LIBRARY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPOINT_OF_SERVICE(value: windowsDotpermissionDotpointOfService): Self = StObject.set(x, "POINT_OF_SERVICE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPREVIEW_INK_WORKSPACE(value: windowsDotpermissionDotpreviewInkWorkspace): Self = StObject.set(x, "PREVIEW_INK_WORKSPACE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPREVIEW_PEN_WORKSPACE(value: windowsDotpermissionDotpreviewPenWorkspace): Self = StObject.set(x, "PREVIEW_PEN_WORKSPACE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPREVIEW_STORE(value: windowsDotpermissionDotpreviewStore): Self = StObject.set(x, "PREVIEW_STORE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPREVIEW_UI_COMPOSITION(value: windowsDotpermissionDotpreviewUiComposition): Self = StObject.set(x, "PREVIEW_UI_COMPOSITION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPRIVATE_NETWORK_CLIENT_SERVER(value: windowsDotpermissionDotprivateNetworkClientServer): Self = StObject.set(x, "PRIVATE_NETWORK_CLIENT_SERVER", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPROTECTED_APP(value: windowsDotpermissionDotprotectedApp): Self = StObject.set(x, "PROTECTED_APP", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPROXIMITY(value: windowsDotpermissionDotproximity): Self = StObject.set(x, "PROXIMITY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRADIOS(value: windowsDotpermissionDotradios): Self = StObject.set(x, "RADIOS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRECORDED_CALLS_FOLDER(value: windowsDotpermissionDotrecordedCallsFolder): Self = StObject.set(x, "RECORDED_CALLS_FOLDER", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREMOTE_PASSPORT_AUTHENTICATION(value: windowsDotpermissionDotremotePassportAuthentication): Self = StObject.set(x, "REMOTE_PASSPORT_AUTHENTICATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREMOTE_SYSTEM(value: windowsDotpermissionDotremoteSystem): Self = StObject.set(x, "REMOTE_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREMOVABLE_STORAGE(value: windowsDotpermissionDotremovableStorage): Self = StObject.set(x, "REMOVABLE_STORAGE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRESCAP(value: windowsDotpermissionDotrescap): Self = StObject.set(x, "RESCAP", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRUN_FULL_TRUST(value: windowsDotpermissionDotrunFullTrust): Self = StObject.set(x, "RUN_FULL_TRUST", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSCREEN_DUPLICATION(value: windowsDotpermissionDotscreenDuplication): Self = StObject.set(x, "SCREEN_DUPLICATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSECONDARY_AUTHENTICATION_FACTOR(value: windowsDotpermissionDotsecondaryAuthenticationFactor): Self = StObject.set(x, "SECONDARY_AUTHENTICATION_FACTOR", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSECURE_ASSESSMENT(value: windowsDotpermissionDotsecureAssessment): Self = StObject.set(x, "SECURE_ASSESSMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSERIALCOMMUNICATION(value: windowsDotpermissionDotserialcommunication): Self = StObject.set(x, "SERIALCOMMUNICATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSHARED_USER_CERTIFICATES(value: windowsDotpermissionDotsharedUserCertificates): Self = StObject.set(x, "SHARED_USER_CERTIFICATES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSLAPI_QUERY_LICENSE_VALUE(value: windowsDotpermissionDotslapiQueryLicenseValue): Self = StObject.set(x, "SLAPI_QUERY_LICENSE_VALUE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSMBIOS(value: windowsDotpermissionDotsmbios): Self = StObject.set(x, "SMBIOS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSMS_SEND(value: windowsDotpermissionDotsmsSend): Self = StObject.set(x, "SMS_SEND", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSPATIAL_PERCEPTION(value: windowsDotpermissionDotspatialPerception): Self = StObject.set(x, "SPATIAL_PERCEPTION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSTART_SCREEN_MANAGEMENT(value: windowsDotpermissionDotstartScreenManagement): Self = StObject.set(x, "START_SCREEN_MANAGEMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSTORE_LICENSE_MANAGEMENT(value: windowsDotpermissionDotstoreLicenseManagement): Self = StObject.set(x, "STORE_LICENSE_MANAGEMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSYSTEM_MANAGEMENT(value: windowsDotpermissionDotsystemManagement): Self = StObject.set(x, "SYSTEM_MANAGEMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTARGETED_CONTENT(value: windowsDotpermissionDottargetedContent): Self = StObject.set(x, "TARGETED_CONTENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTEAM_EDITION_DEVICE_CREDENTIAL(value: windowsDotpermissionDotteamEditionDeviceCredential): Self = StObject.set(x, "TEAM_EDITION_DEVICE_CREDENTIAL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTEAM_EDITION_EXPERIENCE(value: windowsDotpermissionDotteamEditionExperience): Self = StObject.set(x, "TEAM_EDITION_EXPERIENCE", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTEAM_EDITION_VIEW(value: windowsDotpermissionDotteamEditionView): Self = StObject.set(x, "TEAM_EDITION_VIEW", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUAP(value: windowsDotpermissionDotuap): Self = StObject.set(x, "UAP", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUI_AUTOMATION(value: windowsDotpermissionDotuiAutomation): Self = StObject.set(x, "UI_AUTOMATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUNVIRTUALIZED_RESOURCES(value: windowsDotpermissionDotunvirtualizedResources): Self = StObject.set(x, "UNVIRTUALIZED_RESOURCES", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUSB(value: windowsDotpermissionDotusb): Self = StObject.set(x, "USB", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUSER_ACCOUNT_INFORMATION(value: windowsDotpermissionDotuserAccountInformation): Self = StObject.set(x, "USER_ACCOUNT_INFORMATION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUSER_DATA_ACCOUNTS_PROVIDER(value: windowsDotpermissionDotuserDataAccountsProvider): Self = StObject.set(x, "USER_DATA_ACCOUNTS_PROVIDER", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUSER_DATA_SYSTEM(value: windowsDotpermissionDotuserDataSystem): Self = StObject.set(x, "USER_DATA_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUSER_PRINCIPAL_NAME(value: windowsDotpermissionDotuserPrincipalName): Self = StObject.set(x, "USER_PRINCIPAL_NAME", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUSER_SYSTEM_ID(value: windowsDotpermissionDotuserSystemId): Self = StObject.set(x, "USER_SYSTEM_ID", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVIDEOS_LIBRARY(value: windowsDotpermissionDotvideosLibrary): Self = StObject.set(x, "VIDEOS_LIBRARY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVOIP_CALL(value: windowsDotpermissionDotvoipCall): Self = StObject.set(x, "VOIP_CALL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWALLET_SYSTEM(value: windowsDotpermissionDotwalletSystem): Self = StObject.set(x, "WALLET_SYSTEM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWEBCAM(value: windowsDotpermissionDotwebcam): Self = StObject.set(x, "WEBCAM", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWIFI_CONTROL(value: windowsDotpermissionDotwiFiControl): Self = StObject.set(x, "WIFI_CONTROL", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setXBOX_ACCESSORY_MANAGEMENT(value: windowsDotpermissionDotxboxAccessoryManagement): Self = StObject.set(x, "XBOX_ACCESSORY_MANAGEMENT", value.asInstanceOf[js.Any])
    }
  }
  ...
  @js.native
  trait ReadonlyreadonlyANDROIDRe extends StObject {
  ...
  object ReadonlyreadonlyANDROIDRe {
    
    @scala.inline
    def apply(
      ANDROID: ReadonlyreadonlyACCEPTHAN,
      IOS: ReadonlyreadonlyAPPTRACKI,
      WINDOWS: ReadonlyreadonlyACCESSORY
    ): ReadonlyreadonlyANDROIDRe = {
    ...
    @scala.inline
    implicit class ReadonlyreadonlyANDROIDReMutableBuilder[Self <: ReadonlyreadonlyANDROIDRe] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setANDROID(value: ReadonlyreadonlyACCEPTHAN): Self = StObject.set(x, "ANDROID", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIOS(value: ReadonlyreadonlyAPPTRACKI): Self = StObject.set(x, "IOS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWINDOWS(value: ReadonlyreadonlyACCESSORY): Self = StObject.set(x, "WINDOWS", value.asInstanceOf[js.Any])
    }
  }
  
  /* Inlined std.Readonly<{ readonly APP_TRACKING_TRANSPARENCY :'ios.permission.APP_TRACKING_TRANSPARENCY',  readonly BLUETOOTH_PERIPHERAL :'ios.permission.BLUETOOTH_PERIPHERAL',  readonly CALENDARS :'ios.permission.CALENDARS',  readonly CAMERA :'ios.permission.CAMERA',  readonly CONTACTS :'ios.permission.CONTACTS',  readonly FACE_ID :'ios.permission.FACE_ID',  readonly LOCATION_ALWAYS :'ios.permission.LOCATION_ALWAYS',  readonly LOCATION_WHEN_IN_USE :'ios.permission.LOCATION_WHEN_IN_USE',  readonly MEDIA_LIBRARY :'ios.permission.MEDIA_LIBRARY',  readonly MICROPHONE :'ios.permission.MICROPHONE',  readonly MOTION :'ios.permission.MOTION',  readonly PHOTO_LIBRARY :'ios.permission.PHOTO_LIBRARY',  readonly PHOTO_LIBRARY_ADD_ONLY :'ios.permission.PHOTO_LIBRARY_ADD_ONLY',  readonly REMINDERS :'ios.permission.REMINDERS',  readonly SIRI :'ios.permission.SIRI',  readonly SPEECH_RECOGNITION :'ios.permission.SPEECH_RECOGNITION',  readonly STOREKIT :'ios.permission.STOREKIT'}> */
  @js.native
  trait ReadonlyreadonlyAPPTRACKI extends StObject {
  ...
  object ReadonlyreadonlyAPPTRACKI {
    ...
    @scala.inline
    implicit class ReadonlyreadonlyAPPTRACKIMutableBuilder[Self <: ReadonlyreadonlyAPPTRACKI] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ReadonlyreadonlyUNAVAILAB extends StObject {
  ...
  object ReadonlyreadonlyUNAVAILAB {
    
    @scala.inline
    def apply(BLOCKED: blocked, DENIED: denied, GRANTED: granted, LIMITED: limited, UNAVAILABLE: unavailable): ReadonlyreadonlyUNAVAILAB = {
    ...
    @scala.inline
    implicit class ReadonlyreadonlyUNAVAILABMutableBuilder[Self <: ReadonlyreadonlyUNAVAILAB] (val x: Self) extends AnyVal {
