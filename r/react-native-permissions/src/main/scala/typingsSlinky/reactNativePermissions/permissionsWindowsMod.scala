...
object permissionsWindowsMod {
  ...
  object PERMISSIONS {
    ...
    @JSImport("react-native-permissions/dist/typescript/permissions.windows", "PERMISSIONS.ANDROID")
    @js.native
    val ANDROID: ReadonlyreadonlyACCEPTHAN = js.native
    
    @JSImport("react-native-permissions/dist/typescript/permissions.windows", "PERMISSIONS.IOS")
    @js.native
    val IOS: ReadonlyreadonlyAPPTRACKI = js.native
    
    @JSImport("react-native-permissions/dist/typescript/permissions.windows", "PERMISSIONS.WINDOWS")
    @js.native
  ...
  object WindowsPermissionMap {
    ...
    @scala.inline
    implicit class WindowsPermissionMapMutableBuilder[Self <: WindowsPermissionMap] (val x: Self) extends AnyVal {
