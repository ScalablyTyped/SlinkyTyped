package typingsSlinky.reactNativePermissions.permissionsWindowsMod
...
@js.native
trait WindowsPermissionMap extends js.Object {
...
object WindowsPermissionMap {
  ...
  @scala.inline
  implicit class WindowsPermissionMapOps[Self <: WindowsPermissionMap] (val x: Self) extends AnyVal {
