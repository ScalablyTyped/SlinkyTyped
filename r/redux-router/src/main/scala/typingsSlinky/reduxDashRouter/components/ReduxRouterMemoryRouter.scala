...
object ReduxRouterMemoryRouter
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, MemoryRouter] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reduxDashRouter.libReduxRouterMod.default.MemoryRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
