...
object ReduxRouterRouter {
  ...
  def withProps(p: RouterProps): Default[tag.type, Router] = new Default[tag.type, Router](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(history: History[LocationState]): Default[tag.type, Router] = {
    val __props = js.Dynamic.literal(history = history.asInstanceOf[js.Any])
    new Default[tag.type, Router](js.Array(this.component, __props.asInstanceOf[RouterProps]))
  }
}
