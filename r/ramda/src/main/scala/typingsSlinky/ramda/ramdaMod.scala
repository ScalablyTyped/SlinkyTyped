...
import typingsSlinky.ramda.ramdaNumbers.`2`
import typingsSlinky.ramda.ramdaNumbers.`3`
import typingsSlinky.ramda.ramdaNumbers.`4`
import typingsSlinky.ramda.ramdaNumbers.`5`
import typingsSlinky.ramda.ramdaNumbers.`6`
import typingsSlinky.ramda.ramdaNumbers.`7`
import typingsSlinky.ramda.ramdaNumbers.`8`
import typingsSlinky.ramda.ramdaNumbers.`9`
import typingsSlinky.ramda.ramdaStrings.Array
...
import typingsSlinky.ramda.toolsMod.ComposeWithFns
...
import typingsSlinky.ramda.toolsMod.MergeAll
import typingsSlinky.ramda.toolsMod.ObjPred
import typingsSlinky.ramda.toolsMod.Ord
...
@js.native
object ramdaMod extends js.Object {
  ...
  def and[T /* <: Anon_A */](fn1: T): js.Function1[/* val2 */ js.Any, Boolean] = js.native
  def and[T /* <: Anon_A */](fn1: T, val2: js.Any): Boolean = js.native
  ...
  def construct[A /* <: js.Array[_] */, T](constructor: Anon_AT[A, T]): js.Function1[/* a */ A, T] = js.native
  def constructN[A /* <: js.Array[_] */, T](n: Double, constructor: js.Function1[/* a */ A, T]): js.Function1[/* a */ Partial[A], T] = js.native
  def constructN[A /* <: js.Array[_] */, T](n: Double, constructor: Anon_AT[A, T]): js.Function1[/* a */ Partial[A], T] = js.native
  ...
  def lensProp(str: String): Anon_Obj = js.native
  ...
  def `match`(regexp: js.RegExp): js.Function1[/* str */ String, js.Array[String]] = js.native
  def `match`(regexp: js.RegExp, str: String): js.Array[String] = js.native
  ...
  def move(from: Double): Fn_List = js.native
  ...
  def o[T2, R](f: js.Function1[/* x */ T2, R]): Fn_G[T2, R] = js.native
  ...
  @JSName("or")
  def or_T_Anon_AOr[T /* <: Anon_AOr */](fn1: T): js.Function1[/* val2 */ js.Any, T | _] = js.native
  @JSName("or")
  def or_T_Anon_AOrU[T /* <: Anon_AOr */, U](fn1: T, val2: U): T | U = js.native
  ...
  def propEq(name: String): Fn_Obj = js.native
  def propEq(name: Double): Fn_Obj = js.native
  ...
  def propIs(`type`: js.Any): Fn_Name = js.native
  ...
  def slice(a: Double): Fn_B = js.native
  def slice(a: Double, b: Double): Fn_ListArray = js.native
  ...
  def splitAt(index: Double): Fn_ListArrayString = js.native
  ...
  def splitEvery(a: Double): Fn_ListArrayStringT = js.native
