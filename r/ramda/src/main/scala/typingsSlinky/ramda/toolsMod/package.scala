...
package object toolsMod {
  ...
  type Placeholder = (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify A.x */ js.Any) with typingsSlinky.ramda.AnonFunctionalplaceholder
