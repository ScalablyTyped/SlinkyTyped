...
@scala.inline
class SharedBuilder_MaterialPickerProps_1955371684[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def styles(value: PartialClassesMaterialPic): this.type = set("styles", value.asInstanceOf[js.Any])
}
