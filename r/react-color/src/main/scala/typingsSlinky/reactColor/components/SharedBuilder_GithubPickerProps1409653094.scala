...
@scala.inline
class SharedBuilder_GithubPickerProps1409653094[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def styles(value: PartialClassesGithubPicke): this.type = set("styles", value.asInstanceOf[js.Any])
  @scala.inline
