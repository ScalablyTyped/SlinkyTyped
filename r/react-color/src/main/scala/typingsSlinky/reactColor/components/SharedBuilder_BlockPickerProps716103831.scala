...
@scala.inline
class SharedBuilder_BlockPickerProps716103831[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def styles(value: PartialClassesBlockPicker): this.type = set("styles", value.asInstanceOf[js.Any])
  @scala.inline
  def triangle(value: hide | top): this.type = set("triangle", value.asInstanceOf[js.Any])
  @scala.inline
