...
import typingsSlinky.reactDashColor.libComponentsAlphaAlphaMod.AlphaPickerProps
...
abstract class SharedApply_AlphaPickerProps2004301033[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
