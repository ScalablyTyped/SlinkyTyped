...
import typingsSlinky.reactDashColor.libComponentsGithubGithubMod.GithubPickerProps
...
abstract class SharedApply_GithubPickerProps_623162025[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
