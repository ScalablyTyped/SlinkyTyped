...
import typingsSlinky.reactDashColor.libComponentsCompactCompactMod.CompactPickerProps
...
abstract class SharedApply_CompactPickerProps734668531[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
