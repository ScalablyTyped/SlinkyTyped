...
import typingsSlinky.reduxForm.anon.ReduxForm
...
import typingsSlinky.reduxForm.reducerMod.FieldState
...
object reduxFormMod {
  ...
  trait FormInstance[FormData, P]
    ...
    var registeredFields: js.Array[typingsSlinky.reduxForm.mod.RegisteredFieldState] = js.native
