...
object immutableMod {
  ...
  class Field[P /* <: GenericFieldHTMLAttributes | BaseFieldProps[js.Object] */] protected ()
    extends typingsSlinky.reduxForm.mod.Field[P] {
  ...
  class FieldArray[P, FieldValue] protected ()
    extends typingsSlinky.reduxForm.mod.FieldArray[P, FieldValue] {
  ...
  class Fields[P] protected ()
    extends typingsSlinky.reduxForm.mod.Fields[P] {
  ...
  class Form[FormData, P, ErrorType] protected ()
    extends typingsSlinky.reduxForm.mod.Form[FormData, P, ErrorType] {
  ...
  class FormSection[P] protected ()
    extends typingsSlinky.reduxForm.mod.FormSection[P] {
