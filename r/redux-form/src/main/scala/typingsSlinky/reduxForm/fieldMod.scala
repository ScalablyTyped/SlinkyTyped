...
object fieldMod {
  ...
  object BaseFieldProps {
    ...
    implicit class BaseFieldPropsMutableBuilder[Self <: BaseFieldProps[_], P] (val x: Self with BaseFieldProps[P]) extends AnyVal {
      ...
      @scala.inline
      def setComponent(value: (ReactComponentClass[WrappedFieldProps with P]) | input | select | textarea): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[WrappedFieldProps with P]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[WrappedFieldProps with P]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnFocus(value: (SyntheticFocusEvent[_], /* name */ js.UndefOr[String]) => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction2(value))
  ...
  object WrappedFieldInputProps {
    ...
    implicit class WrappedFieldInputPropsMutableBuilder[Self <: WrappedFieldInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBlur(value: EventOrValueHandler[SyntheticFocusEvent[_]]): Self = StObject.set(x, "onBlur", value.asInstanceOf[js.Any])
