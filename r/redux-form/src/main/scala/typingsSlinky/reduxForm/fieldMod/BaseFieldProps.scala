...
object BaseFieldProps {
  ...
  implicit class BaseFieldPropsOps[Self <: BaseFieldProps[_], P] (val x: Self with BaseFieldProps[P]) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[WrappedFieldProps with P]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[WrappedFieldProps with P]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponent(value: (ReactComponentClass[WrappedFieldProps with P]) | input | select | textarea): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnFocus(value: (SyntheticFocusEvent[_], /* name */ js.UndefOr[String]) => Unit): Self = this.set("onFocus", js.Any.fromFunction2(value))
    @scala.inline
