...
trait BaseFieldProps[P] extends js.Object {
  ...
  var onBlur: js.UndefOr[EventWithDataHandler[SyntheticFocusEvent[_]]] = js.undefined
  ...
  var onFocus: js.UndefOr[EventHandler[SyntheticFocusEvent[_]]] = js.undefined
...
object BaseFieldProps {
  ...
  def apply[P](
    ...
    onBlur: (/* event */ js.UndefOr[SyntheticFocusEvent[_]], /* newValue */ js.UndefOr[js.Any], /* previousValue */ js.UndefOr[js.Any], /* name */ js.UndefOr[String]) => Unit = null,
    ...
    onFocus: (SyntheticFocusEvent[_], /* name */ js.UndefOr[String]) => Unit = null,
