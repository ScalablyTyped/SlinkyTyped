...
import typingsSlinky.reduxDashForm.reduxDashFormStrings.input
import typingsSlinky.reduxDashForm.reduxDashFormStrings.select
import typingsSlinky.reduxDashForm.reduxDashFormStrings.textarea
...
- Dropped {[ P in keyof redux-form.redux-form/lib/Field.CommonFieldProps ]:? redux-form.redux-form/lib/Field.CommonFieldProps[P]} */ trait BaseFieldProps[P] extends js.Object {
  var component: js.UndefOr[(ReactComponentClass[WrappedFieldProps with P]) | input | select | textarea] = js.undefined
...
object BaseFieldProps {
  ...
  def apply[P](
    name: String,
    component: (ReactComponentClass[WrappedFieldProps with P]) | input | select | textarea = null,
