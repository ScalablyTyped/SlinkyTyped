package typingsSlinky.reduxDashForm.libFieldArrayMod
...
trait _BaseFieldArrayProps[P, FieldValue] extends js.Object {
  var component: ReactComponentClass[WrappedFieldArrayProps[FieldValue] with P]
  var name: String
...
object _BaseFieldArrayProps {
  ...
  def apply[P, FieldValue](
    component: ReactComponentClass[WrappedFieldArrayProps[FieldValue] with P],
    name: String,
