...
import typingsSlinky.reactSpringShared.esmColorsMod.ColorName
...
object reactSpringSharedStrings {
  ...
  sealed trait aliceblue
    extends ColorName
       with typingsSlinky.reactSpringShared.colorsMod.ColorName
  @scala.inline
  ...
  @js.native
  sealed trait clamp
    extends ExtrapolateType
       with typingsSlinky.reactSpringShared.esmTypesMod.ExtrapolateType
  @scala.inline
