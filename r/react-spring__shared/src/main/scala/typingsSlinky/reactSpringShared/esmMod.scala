...
import typingsSlinky.reactSpringShared.esmFrameLoopMod.OpaqueAnimation
import typingsSlinky.reactSpringShared.esmFrameLoopMod.RequestFrameFn
import typingsSlinky.reactSpringShared.esmGlobalsMod.AnimatedGlobals
import typingsSlinky.reactSpringShared.esmHelpersMod.InferKey
import typingsSlinky.reactSpringShared.esmHelpersMod.InferValue
import typingsSlinky.reactSpringShared.esmHelpersMod.IsArray
import typingsSlinky.reactSpringShared.esmHooksMod.UseOnce_
import typingsSlinky.reactSpringShared.esmTypesMod.InterpolatorArgs
import typingsSlinky.reactSpringShared.esmTypesMod.InterpolatorConfig
...
object esmMod {
  ...
  @js.native
  class Any ()
    extends typingsSlinky.reactSpringShared.typesDotutilMod.Any
  ...
  @js.native
  class FrameLoop ()
    extends typingsSlinky.reactSpringShared.esmFrameLoopMod.FrameLoop {
  ...
  object Globals {
    ...
    @js.native
    def frameLoop: typingsSlinky.reactSpringShared.esmFrameLoopMod.FrameLoop = js.native
    @scala.inline
    def frameLoop_=(x: typingsSlinky.reactSpringShared.esmFrameLoopMod.FrameLoop): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("frameLoop")(x.asInstanceOf[js.Any])
