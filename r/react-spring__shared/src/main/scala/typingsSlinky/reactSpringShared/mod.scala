...
object mod {
  ...
  @js.native
  class Any ()
    extends typingsSlinky.reactSpringShared.typesUtilMod.Any
  ...
  object Globals {
    ...
    @js.native
    def frameLoop: typingsSlinky.reactSpringShared.frameLoopMod.FrameLoop = js.native
    @scala.inline
    def frameLoop_=(x: typingsSlinky.reactSpringShared.frameLoopMod.FrameLoop): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("frameLoop")(x.asInstanceOf[js.Any])
