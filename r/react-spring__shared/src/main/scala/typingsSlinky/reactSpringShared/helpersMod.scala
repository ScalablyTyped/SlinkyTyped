...
object helpersMod {
  ...
  @JSImport("@react-spring/shared/cjs/helpers", "defineHidden")
  @js.native
  def defineHidden(obj: js.Any, key: js.Any, value: js.Any): js.Any = js.native
  
  @JSImport("@react-spring/shared/cjs/helpers", "each")
  @js.native
  ...
  @JSImport("@react-spring/shared/cjs/helpers", "flush")
  @js.native
  ...
  object is {
    ...
    @JSImport("@react-spring/shared/cjs/helpers", "is.fun")
    @js.native
    def fun(a: js.Any): /* is std.Function */ Boolean = js.native
    
    @JSImport("@react-spring/shared/cjs/helpers", "is.num")
    @js.native
    def num(a: js.Any): /* is number */ Boolean = js.native
    
    @JSImport("@react-spring/shared/cjs/helpers", "is.obj")
    @js.native
    def obj[T /* <: js.Any */](a: T): /* is std.Exclude<T & @alloc/types.@alloc/types.Lookup<any>, std.Function | std.Array<any>> */ Boolean = js.native
    
    @JSImport("@react-spring/shared/cjs/helpers", "is.str")
    @js.native
    def str(a: js.Any): /* is string */ Boolean = js.native
    
    @JSImport("@react-spring/shared/cjs/helpers", "is.und")
    @js.native
    def und(a: js.Any): /* is undefined */ Boolean = js.native
  }
  
  @JSImport("@react-spring/shared/cjs/helpers", "isAnimatedString")
  @js.native
  def isAnimatedString(value: js.Any): /* is string */ Boolean = js.native
  
  @JSImport("@react-spring/shared/cjs/helpers", "isEqual")
  @js.native
  def isEqual(a: js.Any, b: js.Any): Boolean = js.native
  
  @JSImport("@react-spring/shared/cjs/helpers", "noop")
  @js.native
  def noop(): Unit = js.native
  
  @JSImport("@react-spring/shared/cjs/helpers", "toArray")
  @js.native
