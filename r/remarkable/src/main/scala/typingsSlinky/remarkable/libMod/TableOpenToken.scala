...
object TableOpenToken {
  ...
  @scala.inline
  implicit class TableOpenTokenOps[Self <: TableOpenToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: table_open): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
