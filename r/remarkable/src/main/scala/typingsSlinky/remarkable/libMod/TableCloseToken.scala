...
object TableCloseToken {
  ...
  @scala.inline
  implicit class TableCloseTokenOps[Self <: TableCloseToken] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: table_close): Self = this.set("type", value.asInstanceOf[js.Any])
  }
