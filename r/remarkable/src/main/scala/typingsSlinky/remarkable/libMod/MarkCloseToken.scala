...
object MarkCloseToken {
  ...
  @scala.inline
  implicit class MarkCloseTokenOps[Self <: MarkCloseToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: mark_close): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
