...
object THeadCloseToken {
  ...
  @scala.inline
  implicit class THeadCloseTokenOps[Self <: THeadCloseToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: thead_close): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
