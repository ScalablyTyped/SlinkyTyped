package typingsSlinky.restifyCorsMiddleware
...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOrigins(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "origins", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOriginsVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "origins", js.Array(value :_*))
