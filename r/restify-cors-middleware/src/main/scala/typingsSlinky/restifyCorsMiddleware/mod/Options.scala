...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginsVarargs(value: (String | js.RegExp)*): Self = this.set("origins", js.Array(value :_*))
    @scala.inline
    def setOrigins(value: js.Array[String | js.RegExp]): Self = this.set("origins", value.asInstanceOf[js.Any])
    @scala.inline
