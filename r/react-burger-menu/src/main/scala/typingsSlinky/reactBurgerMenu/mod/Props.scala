...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomBurgerIconReactElement(value: ReactElement): Self = this.set("customBurgerIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomBurgerIcon(value: ReactElement | `false`): Self = this.set("customBurgerIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCustomBurgerIcon: Self = this.set("customBurgerIcon", js.undefined)
    @scala.inline
    def setCustomCrossIconReactElement(value: ReactElement): Self = this.set("customCrossIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomCrossIcon(value: ReactElement | `false`): Self = this.set("customCrossIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCustomCrossIcon: Self = this.set("customCrossIcon", js.undefined)
    @scala.inline
    def setCustomOnKeyDown(value: /* event */ SyntheticKeyboardEvent[Element] => Unit): Self = this.set("customOnKeyDown", js.Any.fromFunction1(value))
    @scala.inline
