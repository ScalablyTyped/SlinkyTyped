...
import typingsSlinky.reactBurgerMenu.anon.PartialCSSStyleDeclaratio
...
object mod {
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomBurgerIcon(value: ReactElement | `false`): Self = StObject.set(x, "customBurgerIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomBurgerIconReactElement(value: ReactElement): Self = StObject.set(x, "customBurgerIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomBurgerIconUndefined: Self = StObject.set(x, "customBurgerIcon", js.undefined)
      
      @scala.inline
      def setCustomCrossIcon(value: ReactElement | `false`): Self = StObject.set(x, "customCrossIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomCrossIconReactElement(value: ReactElement): Self = StObject.set(x, "customCrossIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomCrossIconUndefined: Self = StObject.set(x, "customCrossIcon", js.undefined)
      
      @scala.inline
      def setCustomOnKeyDown(value: /* event */ SyntheticKeyboardEvent[Element] => Unit): Self = StObject.set(x, "customOnKeyDown", js.Any.fromFunction1(value))
