package typingsSlinky.reactDashBurgerDashMenu.components
...
import typingsSlinky.reactDashBurgerDashMenu.reactDashBurgerDashMenuMod.State
import typingsSlinky.reactDashBurgerDashMenu.reactDashBurgerDashMenuMod.Styles
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_Props1167272165[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    customBurgerIcon: typingsSlinky.react.reactMod._Global_.JSX.Element | `false` = null,
    customCrossIcon: typingsSlinky.react.reactMod._Global_.JSX.Element | `false` = null,
  ...
  type Props = typingsSlinky.reactDashBurgerDashMenu.reactDashBurgerDashMenuMod.Props
}
