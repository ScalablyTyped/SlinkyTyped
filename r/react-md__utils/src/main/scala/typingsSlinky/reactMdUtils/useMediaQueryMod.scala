...
object useMediaQueryMod extends js.Object {
  ...
  def default(query: String, defaultValue: js.UndefOr[scala.Nothing], disabled: Boolean): Boolean = js.native
  def default(
    query: String,
    defaultValue: js.UndefOr[scala.Nothing],
    disabled: Boolean,
  ...
  def default(query: String, defaultValue: Boolean): Boolean = js.native
  def default(
    query: String,
