package typingsSlinky.reactMdUtils.useCloseOnOutsideClickMod
...
object CloseOnOutsideClickOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](
    enabled: Boolean,
  ...
  @scala.inline
  implicit class CloseOnOutsideClickOptionsOps[Self <: CloseOnOutsideClickOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with CloseOnOutsideClickOptions[E]) extends AnyVal {
    @scala.inline
