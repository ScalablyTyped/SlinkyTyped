...
object ResizeObserverOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](onResize: /* event */ ObservedResizeData => Unit): ResizeObserverOptions[E] = {
    val __obj = js.Dynamic.literal(onResize = js.Any.fromFunction1(onResize))
    __obj.asInstanceOf[ResizeObserverOptions[E]]
  }
  @scala.inline
  implicit class ResizeObserverOptionsOps[Self <: ResizeObserverOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with ResizeObserverOptions[E]) extends AnyVal {
    @scala.inline
