...
import typingsSlinky.reactMdUtils.gridCellMod.GridCSSProperties
...
object GridCell {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def colEnd(value: Double | String): this.type = set("colEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def colSpan(value: Double): this.type = set("colSpan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def colStart(value: Double | String): this.type = set("colStart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def desktop(value: GridCSSProperties): this.type = set("desktop", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def largeDesktop(value: GridCSSProperties): this.type = set("largeDesktop", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def phone(value: GridCSSProperties): this.type = set("phone", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def rowEnd(value: Double | String): this.type = set("rowEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def rowSpan(value: Double): this.type = set("rowSpan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def rowStart(value: Double | String): this.type = set("rowStart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def tablet(value: GridCSSProperties): this.type = set("tablet", value.asInstanceOf[js.Any])
  ...
  def withProps(p: GridCellProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: GridCell.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
