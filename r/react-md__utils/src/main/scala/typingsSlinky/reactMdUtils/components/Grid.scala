...
object Grid {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def cloneStyles(value: Boolean): this.type = set("cloneStyles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def desktopColumns(value: Double): this.type = set("desktopColumns", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def largeDesktopColumns(value: Double): this.type = set("largeDesktopColumns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def minCellWidth(value: `min-content` | `max-content` | auto | String): this.type = set("minCellWidth", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def phoneColumns(value: Double): this.type = set("phoneColumns", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def tabletColumns(value: Double): this.type = set("tabletColumns", value.asInstanceOf[js.Any])
  ...
  def withProps(p: GridProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
