...
object GridListCell {
  ...
  def withProps(p: GridListCellProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: GridListCell.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
