...
object KeyboardMovementOptions {
  ...
  @scala.inline
  implicit class KeyboardMovementOptionsOps[Self <: KeyboardMovementOptions[_, _, _], D, /* <: typingsSlinky.std.HTMLElement */ CE, /* <: typingsSlinky.std.HTMLElement */ IE] (val x: Self with (KeyboardMovementOptions[D, CE, IE])) extends AnyVal {
    @scala.inline
