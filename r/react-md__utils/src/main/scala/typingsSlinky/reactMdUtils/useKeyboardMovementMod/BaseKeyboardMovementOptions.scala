package typingsSlinky.reactMdUtils.useKeyboardMovementMod
...
object BaseKeyboardMovementOptions {
  ...
  @scala.inline
  implicit class BaseKeyboardMovementOptionsOps[Self <: BaseKeyboardMovementOptions[_, _, _], D, /* <: typingsSlinky.std.HTMLElement */ CE, /* <: typingsSlinky.std.HTMLElement */ IE] (val x: Self with (BaseKeyboardMovementOptions[D, CE, IE])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnKeyDown(value: SyntheticKeyboardEvent[CE] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    @scala.inline
