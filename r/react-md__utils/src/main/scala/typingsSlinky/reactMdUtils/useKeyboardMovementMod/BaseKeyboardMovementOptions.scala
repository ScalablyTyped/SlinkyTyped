...
object BaseKeyboardMovementOptions {
  ...
  @scala.inline
  implicit class BaseKeyboardMovementOptionsOps[Self <: BaseKeyboardMovementOptions[_, _, _], D, CE /* <: HTMLElement */, IE /* <: HTMLElement */] (val x: Self with (BaseKeyboardMovementOptions[D, CE, IE])) extends AnyVal {
