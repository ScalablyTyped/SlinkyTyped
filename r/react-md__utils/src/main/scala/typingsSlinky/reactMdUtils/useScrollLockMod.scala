...
object useScrollLockMod {
  ...
  @JSImport("@react-md/utils/types/wia-aria/useScrollLock", "disable")
  @js.native
  def disable(element: HTMLElement): Unit = js.native
  
  @JSImport("@react-md/utils/types/wia-aria/useScrollLock", "enable")
  @js.native
  def enable(element: HTMLElement): Unit = js.native
  
  @JSImport("@react-md/utils/types/wia-aria/useScrollLock", "useScrollLock")
  @js.native
