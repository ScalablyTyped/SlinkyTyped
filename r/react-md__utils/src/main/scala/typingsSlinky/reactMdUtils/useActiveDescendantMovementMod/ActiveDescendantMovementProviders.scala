...
object ActiveDescendantMovementProviders {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ CE, /* <: typingsSlinky.std.HTMLElement */ IE](
  ...
  @scala.inline
  implicit class ActiveDescendantMovementProvidersOps[Self <: ActiveDescendantMovementProviders[_, _], /* <: typingsSlinky.std.HTMLElement */ CE, /* <: typingsSlinky.std.HTMLElement */ IE] (val x: Self with (ActiveDescendantMovementProviders[CE, IE])) extends AnyVal {
    @scala.inline
