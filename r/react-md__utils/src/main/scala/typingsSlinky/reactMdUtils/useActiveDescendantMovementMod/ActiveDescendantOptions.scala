...
object ActiveDescendantOptions {
  ...
  @scala.inline
  implicit class ActiveDescendantOptionsOps[Self <: ActiveDescendantOptions[_, _, _], D, /* <: typingsSlinky.std.HTMLElement */ CE, /* <: typingsSlinky.std.HTMLElement */ IE] (val x: Self with (ActiveDescendantOptions[D, CE, IE])) extends AnyVal {
    @scala.inline
