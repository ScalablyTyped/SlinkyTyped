...
object KeyboardSearchOptions {
  @scala.inline
  def apply[D, /* <: typingsSlinky.std.HTMLElement */ E](items: js.Array[D], onChange: /* data */ SearchData[D, E] => Unit, searchIndex: Double): KeyboardSearchOptions[D, E] = {
  ...
  @scala.inline
  implicit class KeyboardSearchOptionsOps[Self <: KeyboardSearchOptions[_, _], D, /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with (KeyboardSearchOptions[D, E])) extends AnyVal {
    @scala.inline
