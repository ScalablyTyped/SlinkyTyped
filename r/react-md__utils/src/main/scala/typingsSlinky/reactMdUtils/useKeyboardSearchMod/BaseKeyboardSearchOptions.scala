...
object BaseKeyboardSearchOptions {
  @scala.inline
  def apply[D, /* <: typingsSlinky.std.HTMLElement */ E](items: js.Array[D], onChange: /* data */ SearchData[D, E] => Unit): BaseKeyboardSearchOptions[D, E] = {
  ...
  @scala.inline
  implicit class BaseKeyboardSearchOptionsOps[Self <: BaseKeyboardSearchOptions[_, _], D, /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with (BaseKeyboardSearchOptions[D, E])) extends AnyVal {
    @scala.inline
