...
object SearchData {
  @scala.inline
  def apply[D, /* <: typingsSlinky.std.HTMLElement */ E](index: Double, item: D, items: js.Array[D], query: String, target: E): SearchData[D, E] = {
  ...
  @scala.inline
  implicit class SearchDataOps[Self <: SearchData[_, _], D, /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with (SearchData[D, E])) extends AnyVal {
    @scala.inline
