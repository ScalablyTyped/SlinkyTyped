...
import typingsSlinky.reactMdUtils.typesMod.HorizontalPosition
...
object createHorizontalPositionMod {
  ...
  object EqualWidthOptions {
    ...
    implicit class EqualWidthOptionsMutableBuilder[Self <: EqualWidthOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContainerRectClientRect(value: ClientRect): Self = StObject.set(x, "containerRect", value.asInstanceOf[js.Any])
