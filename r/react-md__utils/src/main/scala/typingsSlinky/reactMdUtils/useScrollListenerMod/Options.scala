package typingsSlinky.reactMdUtils.useScrollListenerMod
...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](onScroll: /* evt */ Event => Unit): Options[E] = {
    val __obj = js.Dynamic.literal(onScroll = js.Any.fromFunction1(onScroll))
    __obj.asInstanceOf[Options[E]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with Options[E]) extends AnyVal {
    @scala.inline
