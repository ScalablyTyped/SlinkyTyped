...
import typingsSlinky.reactMdUtils.typesMod.VerticalPosition
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainerRectClientRect(value: ClientRect): Self = this.set("containerRect", value.asInstanceOf[js.Any])
