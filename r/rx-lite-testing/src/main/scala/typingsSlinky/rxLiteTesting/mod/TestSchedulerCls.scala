...
class TestSchedulerCls ()
  extends typingsSlinky.rxLiteTesting.Rx.TestScheduler {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def createColdObservable[T](records: typingsSlinky.rxLiteTesting.Rx.Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createHotObservable[T](records: typingsSlinky.rxLiteTesting.Rx.Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createObserver[T](): typingsSlinky.rxLiteTesting.Rx.MockObserver[T] = js.native
  ...
  /* CompleteClass */
  override def startWithCreate[T](create: js.Function0[Observable[T]]): typingsSlinky.rxLiteTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
  override def startWithDispose[T](create: js.Function0[Observable[T]], disposedAt: Double): typingsSlinky.rxLiteTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
  override def startWithTiming[T](create: js.Function0[Observable[T]], createdAt: Double, subscribedAt: Double, disposedAt: Double): typingsSlinky.rxLiteTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
