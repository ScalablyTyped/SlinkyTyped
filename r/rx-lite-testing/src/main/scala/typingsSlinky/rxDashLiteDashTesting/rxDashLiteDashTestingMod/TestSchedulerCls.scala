...
class TestSchedulerCls ()
  extends typingsSlinky.rxDashLiteDashTesting.Rx.TestScheduler {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def createColdObservable[T](records: typingsSlinky.rxDashLiteDashTesting.Rx.Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createHotObservable[T](records: typingsSlinky.rxDashLiteDashTesting.Rx.Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createObserver[T](): typingsSlinky.rxDashLiteDashTesting.Rx.MockObserver[T] = js.native
  ...
  /* CompleteClass */
  override def startWithCreate[T](create: js.Function0[Observable[T]]): typingsSlinky.rxDashLiteDashTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
  override def startWithDispose[T](create: js.Function0[Observable[T]], disposedAt: Double): typingsSlinky.rxDashLiteDashTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
  override def startWithTiming[T](create: js.Function0[Observable[T]], createdAt: Double, subscribedAt: Double, disposedAt: Double): typingsSlinky.rxDashLiteDashTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
