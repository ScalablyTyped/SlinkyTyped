...
object ReactDashMotionDashUiDashPack
  ...
  typingsSlinky.reactDashMotionDashUiDashPack.reactDashMotionDashUiDashPackMod.default.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
