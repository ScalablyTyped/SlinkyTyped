...
object ReactMotionUiPack {
  ...
  object ReactMotionUiPack {
    ...
    implicit def make(companion: ReactMotionUiPack.type): typingsSlinky.reactMotionUiPack.components.ReactMotionUiPack.ReactMotionUiPack.Builder = new typingsSlinky.reactMotionUiPack.components.ReactMotionUiPack.ReactMotionUiPack.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: TransitionProps): typingsSlinky.reactMotionUiPack.components.ReactMotionUiPack.ReactMotionUiPack.Builder = new typingsSlinky.reactMotionUiPack.components.ReactMotionUiPack.ReactMotionUiPack.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
