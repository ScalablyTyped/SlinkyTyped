package typingsSlinky.reactMotionUiPack
...
object mod {
  ...
  object default extends Shortcut {
    ...
    @JSImport("react-motion-ui-pack", JSImport.Default)
    @js.native
    val ^ : ComponentClass[TransitionProps, js.Object] = js.native
    
    type _To = ComponentClass[TransitionProps, js.Object]
    
    /* This means you don't have to write `^`, but can instead just say `default.foo` */
    override def _to: ComponentClass[TransitionProps, js.Object] = ^
  }
