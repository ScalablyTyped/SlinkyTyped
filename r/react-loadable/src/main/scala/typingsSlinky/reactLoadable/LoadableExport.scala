...
object LoadableExport {
  ...
  object CommonOptions {
    ...
    implicit class CommonOptionsMutableBuilder[Self <: CommonOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLoading(value: ReactComponentClass[LoadingComponentProps]): Self = StObject.set(x, "loading", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object Options {
    ...
    def OptionsWithRender[Props, Exports /* <: js.Object */](
      ...
      __obj.asInstanceOf[typingsSlinky.reactLoadable.LoadableExport.OptionsWithRender[Props, Exports]]
    }
    ...
    def OptionsWithoutRender[Props](
      ...
      __obj.asInstanceOf[typingsSlinky.reactLoadable.LoadableExport.OptionsWithoutRender[Props]]
    }
  }
  ...
  object OptionsWithMap {
    ...
    implicit class OptionsWithMapMutableBuilder[Self <: OptionsWithMap[_, _], Props, Exports /* <: StringDictionary[js.Any] */] (val x: Self with (OptionsWithMap[Props, Exports])) extends AnyVal {
      ...
      @scala.inline
      def setRender(value: (Exports, Props) => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
    }
  }
  ...
  object OptionsWithoutRender {
    ...
    implicit class OptionsWithoutRenderMutableBuilder[Self <: OptionsWithoutRender[_], Props] (val x: Self with OptionsWithoutRender[Props]) extends AnyVal {
      ...
      @scala.inline
      def setLoader(value: () => js.Promise[ReactComponentClass[Props] | Default[Props]]): Self = StObject.set(x, "loader", js.Any.fromFunction0(value))
    }
  }
}
