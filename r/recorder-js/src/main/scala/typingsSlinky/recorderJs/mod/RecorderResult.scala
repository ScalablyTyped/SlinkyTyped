...
trait RecorderResult extends js.Object {
  var blob: Blob
  var buffer: js.Array[scala.scalajs.js.typedarray.Float32Array]
}

object RecorderResult {
  @scala.inline
  def apply(blob: Blob, buffer: js.Array[scala.scalajs.js.typedarray.Float32Array]): RecorderResult = {
