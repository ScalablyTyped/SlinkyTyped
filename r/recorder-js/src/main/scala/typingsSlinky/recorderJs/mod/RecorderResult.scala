...
object RecorderResult {
  ...
  implicit class RecorderResultOps[Self <: RecorderResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBufferVarargs(value: js.typedarray.Float32Array*): Self = this.set("buffer", js.Array(value :_*))
    
    @scala.inline
    def setBuffer(value: js.Array[js.typedarray.Float32Array]): Self = this.set("buffer", value.asInstanceOf[js.Any])
  }
}
