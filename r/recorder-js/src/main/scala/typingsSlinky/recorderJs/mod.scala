...
object mod {
  ...
  object RecorderResult {
    ...
    implicit class RecorderResultMutableBuilder[Self <: RecorderResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBuffer(value: js.Array[js.typedarray.Float32Array]): Self = StObject.set(x, "buffer", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBufferVarargs(value: js.typedarray.Float32Array*): Self = StObject.set(x, "buffer", js.Array(value :_*))
    }
  }
}
