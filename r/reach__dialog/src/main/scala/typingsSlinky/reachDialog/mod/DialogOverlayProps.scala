...
object DialogOverlayProps {
  ...
  implicit class DialogOverlayPropsOps[Self <: DialogOverlayProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialFocusRef(value: ReactRef[HTMLElement]): Self = this.set("initialFocusRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteInitialFocusRef: Self = this.set("initialFocusRef", js.undefined)
