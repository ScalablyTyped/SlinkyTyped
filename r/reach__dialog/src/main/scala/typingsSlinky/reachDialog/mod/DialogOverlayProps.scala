...
trait DialogOverlayProps extends js.Object {
  ...
  var initialFocusRef: js.UndefOr[ReactRef[HTMLElement]] = js.native
...
object DialogOverlayProps {
  ...
  @scala.inline
  implicit class DialogOverlayPropsOps[Self <: DialogOverlayProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInitialFocusRef(value: ReactRef[HTMLElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initialFocusRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutInitialFocusRef: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initialFocusRef")(js.undefined)
        ret
    }
    @scala.inline
