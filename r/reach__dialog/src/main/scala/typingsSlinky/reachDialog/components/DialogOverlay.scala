...
import typingsSlinky.reachDialog.mod.DialogOverlayProps
...
object DialogOverlay {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def initialFocusRef(value: ReactRef[HTMLElement]): this.type = set("initialFocusRef", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DialogOverlayProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DialogOverlay.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
