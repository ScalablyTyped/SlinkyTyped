package typingsSlinky.rollupDashPluginDashDelete.rollupDashPluginDashDeleteMod

import typingsSlinky.fastDashGlob.outTypesMod.FileSystemAdapter
import typingsSlinky.fastDashGlob.outTypesMod.Pattern
import typingsSlinky.globby.globbyMod.ExpandDirectoriesOption
...
trait Options
  extends typingsSlinky.del.delMod.Options {
  /**
