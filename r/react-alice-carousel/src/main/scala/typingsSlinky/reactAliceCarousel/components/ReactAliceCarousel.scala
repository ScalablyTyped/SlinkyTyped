...
object ReactAliceCarousel
  ...
  def apply(
    ...
    controlsStrategy: typingsSlinky.reactAliceCarousel.reactAliceCarouselStrings.default | responsive = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAliceCarousel.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = typingsSlinky.reactAliceCarousel.mod.Props
}
