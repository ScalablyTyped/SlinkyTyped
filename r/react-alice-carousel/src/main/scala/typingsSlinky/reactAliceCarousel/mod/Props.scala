...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setControlsStrategy(value: typingsSlinky.reactAliceCarousel.reactAliceCarouselStrings.default | responsive): Self = this.set("controlsStrategy", value.asInstanceOf[js.Any])
    @scala.inline
