...
object AutoplayDirection extends StObject {
  ...
  /* "ltr" */ val LTR: typingsSlinky.reactAliceCarousel.typesMod.AutoplayDirection.LTR with String = js.native
  
  @js.native
  sealed trait RTL extends AutoplayDirection
  /* "rtl" */ val RTL: typingsSlinky.reactAliceCarousel.typesMod.AutoplayDirection.RTL with String = js.native
}
