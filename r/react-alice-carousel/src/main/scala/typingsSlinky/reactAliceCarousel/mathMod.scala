...
object mathMod {
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getActiveIndex")
  @js.native
  def getActiveIndex(index: Double, dotsLength: Double, infinite: Boolean): Double = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "getFadeoutAnimationIndex")
  @js.native
  def getFadeoutAnimationIndex(state: State): Double = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "getFadeoutAnimationPosition")
  @js.native
  def getFadeoutAnimationPosition(nextIndex: js.Any, state: State): Double = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "getIsLeftDirection")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getShiftIndex")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getStartIndex")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getSwipeLimitMax")
  @js.native
  def getSwipeLimitMax(state: PartialState, props: PartialProps): Double = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "getSwipeLimitMin")
  @js.native
  def getSwipeLimitMin(state: PartialState, props: PartialProps): Double = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "getSwipeShiftValue")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getSwipeTouchendIndex")
  @js.native
  def getSwipeTouchendIndex(position: js.Any, state: State): Double = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "getSwipeTouchendPosition")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getSwipeTransformationCursor")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getTransformationItemIndex")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getTransformationSetItem")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "getUpdateSlidePositionIndex")
  @js.native
  def getUpdateSlidePositionIndex(activeIndex: Double, itemsCount: Double): Double = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "isVerticalTouchmoveDetected")
  @js.native
  ...
  @JSImport("react-alice-carousel/lib/utils/math", "shouldCancelSlideAnimation")
  @js.native
  def shouldCancelSlideAnimation(activeIndex: js.Any, itemsCount: js.Any, itemsInSlide: js.Any): Boolean = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "shouldRecalculateSlideIndex")
  @js.native
  def shouldRecalculateSlideIndex(activeIndex: js.Any, itemsCount: js.Any): Boolean = js.native
  
  @JSImport("react-alice-carousel/lib/utils/math", "shouldRecalculateSwipePosition")
  @js.native
