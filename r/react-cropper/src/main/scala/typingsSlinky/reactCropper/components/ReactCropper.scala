...
object ReactCropper
  ...
  def apply(
    ...
    prefix: String = null,
    preload: String = null,
    preview: org.scalajs.dom.raw.Element | js.Array[org.scalajs.dom.raw.Element] | NodeList | String = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.img.tag.type, typingsSlinky.reactCropper.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
