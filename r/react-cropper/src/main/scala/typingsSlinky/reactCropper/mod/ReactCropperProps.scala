...
object ReactCropperProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLImageElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLImageElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLImageElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLImageElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLImageElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLImageElement, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLImageElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLImageElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLImageElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLImageElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLImageElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLImageElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLImageElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLImageElement, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLImageElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLImageElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLImageElement] => Unit = null,
    onLoad: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLImageElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLImageElement] => Unit = null,
    onPause: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLImageElement] => Unit = null,
    onProgress: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLImageElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLImageElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLImageElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLImageElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLImageElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLImageElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLImageElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLImageElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLImageElement] => Unit = null,
