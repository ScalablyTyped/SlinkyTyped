...
object ReactCropperProps {
  ...
  implicit class ReactCropperPropsOps[Self <: ReactCropperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviewNodeList(value: NodeList): Self = this.set("preview", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreviewElement(value: Element): Self = this.set("preview", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[ReactCropper]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ ReactCropper | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: LegacyRef[ReactCropper]): Self = this.set("ref", value.asInstanceOf[js.Any])
