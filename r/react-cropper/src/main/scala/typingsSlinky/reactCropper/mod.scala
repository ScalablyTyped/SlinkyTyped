package typingsSlinky.reactCropper
...
object mod {
  ...
  object ReactCropperProps {
    ...
    implicit class ReactCropperPropsMutableBuilder[Self <: ReactCropperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReady(value: CustomEvent => Unit): Self = StObject.set(x, "ready", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRefRefObject(value: ReactRef[ReactCropper]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
