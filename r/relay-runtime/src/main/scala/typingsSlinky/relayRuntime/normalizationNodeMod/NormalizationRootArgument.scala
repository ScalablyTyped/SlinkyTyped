...
object NormalizationRootArgument {
  @scala.inline
  def apply(kind: String, name: String): NormalizationRootArgument = {
    val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[NormalizationRootArgument]
  }
  @scala.inline
  implicit class NormalizationRootArgumentOps[Self <: NormalizationRootArgument] (val x: Self) extends AnyVal {
    @scala.inline
