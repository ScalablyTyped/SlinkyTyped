...
object relayDeclarativeMutationConfigMod {
  ...
  */
  ...
  object DeclarativeMutationConfig {
    ...
    @scala.inline
    def NodeDeleteConfig(deletedIDFieldName: String, `type`: NODE_DELETE): typingsSlinky.relayRuntime.relayDeclarativeMutationConfigMod.NodeDeleteConfig = {
      val __obj = js.Dynamic.literal(deletedIDFieldName = deletedIDFieldName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.relayRuntime.relayDeclarativeMutationConfigMod.NodeDeleteConfig]
    }
    
    @scala.inline
    def RangeAddConfig(edgeName: String, `type`: RANGE_ADD): typingsSlinky.relayRuntime.relayDeclarativeMutationConfigMod.RangeAddConfig = {
      val __obj = js.Dynamic.literal(edgeName = edgeName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.relayRuntime.relayDeclarativeMutationConfigMod.RangeAddConfig]
    }
    ...
    def RangeDeleteConfig(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.relayRuntime.relayDeclarativeMutationConfigMod.RangeDeleteConfig]
    }
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.relayRuntime.relayRuntimeStrings.append
    - typingsSlinky.relayRuntime.relayRuntimeStrings.prepend
  */
  trait RangeOperations extends StObject
  object RangeOperations {
    
    @scala.inline
    def append: typingsSlinky.relayRuntime.relayRuntimeStrings.append = "append".asInstanceOf[typingsSlinky.relayRuntime.relayRuntimeStrings.append]
    
    @scala.inline
    def prepend: typingsSlinky.relayRuntime.relayRuntimeStrings.prepend = "prepend".asInstanceOf[typingsSlinky.relayRuntime.relayRuntimeStrings.prepend]
  }
}
