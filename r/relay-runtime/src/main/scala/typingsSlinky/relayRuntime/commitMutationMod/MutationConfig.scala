...
object MutationConfig {
  ...
  def apply[TOperation](
    ...
    onError: js.UndefOr[Null | (/* error */ js.Error => Unit)] = js.undefined,
    ...
    if (!js.isUndefined(onError)) __obj.updateDynamic("onError")(if (onError != null) js.Any.fromFunction1(onError.asInstanceOf[/* error */ js.Error => Unit]) else null)
