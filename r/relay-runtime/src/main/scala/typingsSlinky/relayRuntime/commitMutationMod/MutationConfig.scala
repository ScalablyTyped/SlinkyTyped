...
object MutationConfig {
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.commitMutationMod.MutationParameters */ TOperation](
  ...
  @scala.inline
  implicit class MutationConfigOps[Self <: MutationConfig[_], /* <: typingsSlinky.relayRuntime.commitMutationMod.MutationParameters */ TOperation] (val x: Self with MutationConfig[TOperation]) extends AnyVal {
    @scala.inline
