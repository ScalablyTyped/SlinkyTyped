...
import typingsSlinky.relayRuntime.anon.Stop
...
import typingsSlinky.relayRuntime.relayFeatureFlagsMod.FeatureFlags
...
import typingsSlinky.relayRuntime.relayProfilerMod.ProfileHandler
...
object mod {
  ...
  class QueryResponseCache protected ()
    extends typingsSlinky.relayRuntime.relayQueryResponseCacheMod.default {
  ...
  object RelayProfiler {
    ...
    @js.native
    def attachAggregateHandler(name: String, handler: typingsSlinky.relayRuntime.relayProfilerMod.Handler): Unit = js.native
    ...
    @js.native
    def detachAggregateHandler(name: String, handler: typingsSlinky.relayRuntime.relayProfilerMod.Handler): Unit = js.native
  ...
  class Store protected ()
    extends typingsSlinky.relayRuntime.relayModernStoreMod.default {
  ...
  {[ ref in Refs ]: true}
    */ typingsSlinky.relayRuntime.relayRuntimeStrings.FragmentRefs with TopLevel[js.Any]
