...
object GraphQLSubscriptionConfig {
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TSubscription](
  ...
  @scala.inline
  implicit class GraphQLSubscriptionConfigOps[Self <: GraphQLSubscriptionConfig[_], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TSubscription] (val x: Self with GraphQLSubscriptionConfig[TSubscription]) extends AnyVal {
    @scala.inline
