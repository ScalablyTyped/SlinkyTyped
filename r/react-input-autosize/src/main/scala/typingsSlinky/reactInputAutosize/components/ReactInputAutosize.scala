package typingsSlinky.reactInputAutosize.components
...
import typingsSlinky.reactInputAutosize.mod.AutosizeInputProps
import typingsSlinky.reactInputAutosize.mod.default
...
object ReactInputAutosize {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def inputRef(value: /* instance */ HTMLInputElement | Null => Unit): this.type = set("inputRef", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onAutosize(value: /* inputWidth */ String | Double => Unit): this.type = set("onAutosize", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def placeholderIsMinWidth(value: Boolean): this.type = set("placeholderIsMinWidth", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: ReactInputAutosize.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
