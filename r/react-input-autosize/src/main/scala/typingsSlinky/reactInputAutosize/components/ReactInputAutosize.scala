...
object ReactInputAutosize
  ...
  def apply(
    ...
    if (!js.isUndefined(placeholderIsMinWidth)) __obj.updateDynamic("placeholderIsMinWidth")(placeholderIsMinWidth.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.reactInputAutosize.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
