...
import typingsSlinky.rcSwitch.rcSwitchStrings.assertive
import typingsSlinky.rcSwitch.rcSwitchStrings.both
import typingsSlinky.rcSwitch.rcSwitchStrings.copy
import typingsSlinky.rcSwitch.rcSwitchStrings.date
import typingsSlinky.rcSwitch.rcSwitchStrings.decimal
import typingsSlinky.rcSwitch.rcSwitchStrings.descending
import typingsSlinky.rcSwitch.rcSwitchStrings.dialog
import typingsSlinky.rcSwitch.rcSwitchStrings.email
import typingsSlinky.rcSwitch.rcSwitchStrings.execute
import typingsSlinky.rcSwitch.rcSwitchStrings.grammar
import typingsSlinky.rcSwitch.rcSwitchStrings.grid
import typingsSlinky.rcSwitch.rcSwitchStrings.horizontal
import typingsSlinky.rcSwitch.rcSwitchStrings.inherit
import typingsSlinky.rcSwitch.rcSwitchStrings.link
import typingsSlinky.rcSwitch.rcSwitchStrings.list
import typingsSlinky.rcSwitch.rcSwitchStrings.listbox
import typingsSlinky.rcSwitch.rcSwitchStrings.location
import typingsSlinky.rcSwitch.rcSwitchStrings.menu
import typingsSlinky.rcSwitch.rcSwitchStrings.mixed
import typingsSlinky.rcSwitch.rcSwitchStrings.move
import typingsSlinky.rcSwitch.rcSwitchStrings.no
import typingsSlinky.rcSwitch.rcSwitchStrings.none
import typingsSlinky.rcSwitch.rcSwitchStrings.numeric
import typingsSlinky.rcSwitch.rcSwitchStrings.off
import typingsSlinky.rcSwitch.rcSwitchStrings.on
import typingsSlinky.rcSwitch.rcSwitchStrings.other
import typingsSlinky.rcSwitch.rcSwitchStrings.page
import typingsSlinky.rcSwitch.rcSwitchStrings.polite
import typingsSlinky.rcSwitch.rcSwitchStrings.popup
import typingsSlinky.rcSwitch.rcSwitchStrings.removals
import typingsSlinky.rcSwitch.rcSwitchStrings.search
import typingsSlinky.rcSwitch.rcSwitchStrings.spelling
import typingsSlinky.rcSwitch.rcSwitchStrings.step
import typingsSlinky.rcSwitch.rcSwitchStrings.tel
import typingsSlinky.rcSwitch.rcSwitchStrings.text
import typingsSlinky.rcSwitch.rcSwitchStrings.time
import typingsSlinky.rcSwitch.rcSwitchStrings.tree
import typingsSlinky.rcSwitch.rcSwitchStrings.url
import typingsSlinky.rcSwitch.rcSwitchStrings.vertical
import typingsSlinky.rcSwitch.rcSwitchStrings.yes
...
object SwitchProps {
  ...
  implicit class SwitchPropsOps[Self <: SwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(
      value: (/* checked */ Boolean, /* event */ SyntheticMouseEvent[HTMLButtonElement] | SyntheticKeyboardEvent[HTMLButtonElement]) => Unit
