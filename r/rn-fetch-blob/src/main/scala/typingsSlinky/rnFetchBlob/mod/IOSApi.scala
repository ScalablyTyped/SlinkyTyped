...
object IOSApi {
  ...
  implicit class IOSApiOps[Self <: IOSApi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOpenDocument(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("openDocument")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPreviewDocument(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("previewDocument")(js.Any.fromFunction1(value))
        ret
    }
  }
