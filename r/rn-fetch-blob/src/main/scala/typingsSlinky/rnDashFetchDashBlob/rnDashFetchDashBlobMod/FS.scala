...
import typingsSlinky.rnDashFetchDashBlob.Anon_Free
...
trait FS extends js.Object {
  var RNFetchBlobSession: typingsSlinky.rnDashFetchDashBlob.rnDashFetchDashBlobMod.RNFetchBlobSession = js.native
