package typingsSlinky.reactNavigationCore.getActionFromStateMod

import typingsSlinky.reactNavigationCore.anon.Name
import typingsSlinky.reactNavigationCore.reactNavigationCoreStrings.NAVIGATE
