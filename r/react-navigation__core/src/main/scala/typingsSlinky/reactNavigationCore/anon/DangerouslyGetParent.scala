...
@js.native
trait DangerouslyGetParent extends js.Object {
  ...
  def dangerouslyGetState_Readonlykeystringindexnum(): Readonlykeystringindexnum = js.native
  
  def dispatch(
    action: js.Function1[
      (/* state */ js.Any) | (/* state */ Readonlykeystringindexnum), 
