...
trait AddKeyedListener extends js.Object {
  ...
  var addKeyedListener: js.UndefOr[typingsSlinky.reactNavigationCore.navigationBuilderContextMod.AddKeyedListener] = js.native
  
  var addListener: js.UndefOr[typingsSlinky.reactNavigationCore.navigationBuilderContextMod.AddListener] = js.native
