...
package object mod {
  ...
  type KeySelectorCreator[S, C, D] = js.Function1[
    /* selectorInputs */ typingsSlinky.reReselect.AnonInputSelectors[D, C, S], 
  ...
  type OutputCachedSelector[S, R, C, D] = js.Function2[
    ...
    (typingsSlinky.reReselect.mod.OutputSelector[S, R, C, D]) with (typingsSlinky.reReselect.AnonCache[S, R, C, D])
  ]
  type OutputParametricCachedSelector[S, P, R, C, D] = js.Function2[
    ...
    (typingsSlinky.reReselect.mod.OutputParametricSelector[S, P, R, C, D]) with (typingsSlinky.reReselect.AnonClearCache[S, P, R, C, D])
  ]
  type OutputParametricSelector[S, P, R, C, D] = (typingsSlinky.reReselect.mod.ParametricSelector[S, P, R]) with (typingsSlinky.reReselect.AnonDependencies[C, D])
  type OutputSelector[S, R, C, D] = (typingsSlinky.reReselect.mod.Selector[S, R]) with (typingsSlinky.reReselect.AnonDependencies[C, D])
  ...
  type ParametricKeySelectorCreator[S, P, C, D] = js.Function1[
    /* selectorInputs */ typingsSlinky.reReselect.AnonKeySelector[D, C, S, P], 
