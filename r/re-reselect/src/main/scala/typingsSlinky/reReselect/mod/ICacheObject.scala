...
object ICacheObject {
  ...
  implicit class ICacheObjectOps[Self <: ICacheObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsValidCacheKey(value: /* key */ js.Any => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isValidCacheKey")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutIsValidCacheKey: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isValidCacheKey")(js.undefined)
        ret
    }
  }
