...
package object mod {
  ...
  type ReducerHandler[State] = js.Function3[
    ...
    /* action */ js.UndefOr[typingsSlinky.reduxAction.mod.BaseAction], 
    State
  ]
  
  type ReducerHandlers[State] = org.scalablytyped.runtime.StringDictionary[typingsSlinky.reduxAction.mod.ReducerHandler[State]]
  
  type ThunkAction[Payload] = js.Function2[
    /* dispatch */ typingsSlinky.redux.mod.Dispatch[js.Any], 
    /* getState */ js.Function0[js.Any], 
    js.Promise[typingsSlinky.reduxAction.mod.Action[Payload]]
  ]
  
  type ThunkMetaAction[Payload, Meta] = js.Function2[
    /* dispatch */ typingsSlinky.redux.mod.Dispatch[js.Any], 
    /* getState */ js.Function0[js.Any], 
    js.Promise[typingsSlinky.reduxAction.mod.MetaAction[Payload, Meta]]
  ]
}
