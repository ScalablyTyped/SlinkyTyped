...
object CountdownCircleTimer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactCountdownCircleTimer.mod.CountdownCircleTimer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactCountdownCircleTimer.mod.CountdownCircleTimer] = {
  ...
  type Props = typingsSlinky.reactCountdownCircleTimer.mod.Props
}
