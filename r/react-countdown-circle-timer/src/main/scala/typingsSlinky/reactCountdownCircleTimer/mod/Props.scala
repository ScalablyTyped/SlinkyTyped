...
object Props {
  ...
  def apply(
    ...
    if (!js.isUndefined(isLinearGradient)) __obj.updateDynamic("isLinearGradient")(isLinearGradient.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isPlaying)) __obj.updateDynamic("isPlaying")(isPlaying.get.asInstanceOf[js.Any])
