...
trait ReactImageFallbackProps extends js.Object {
  ...
  var onError: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event_, HTMLImageElement], Unit]] = js.undefined
  var onLoad: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event_, HTMLImageElement], Unit]] = js.undefined
  var src: String
}
...
object ReactImageFallbackProps {
  ...
  def apply(
    ...
    onError: /* event */ SyntheticEvent[Event_, HTMLImageElement] => Unit = null,
    onLoad: /* event */ SyntheticEvent[Event_, HTMLImageElement] => Unit = null
