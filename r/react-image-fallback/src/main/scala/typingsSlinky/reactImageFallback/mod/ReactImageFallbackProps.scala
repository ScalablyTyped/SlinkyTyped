...
object ReactImageFallbackProps {
  ...
  implicit class ReactImageFallbackPropsOps[Self <: ReactImageFallbackProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFallbackImageReactElement(value: ReactElement): Self = this.set("fallbackImage", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInitialImageReactElement(value: ReactElement): Self = this.set("initialImage", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnError(value: /* event */ SyntheticEvent[Event, HTMLImageElement] => Unit): Self = this.set("onError", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnError: Self = this.set("onError", js.undefined)
    
    @scala.inline
    def setOnLoad(value: /* event */ SyntheticEvent[Event, HTMLImageElement] => Unit): Self = this.set("onLoad", js.Any.fromFunction1(value))
