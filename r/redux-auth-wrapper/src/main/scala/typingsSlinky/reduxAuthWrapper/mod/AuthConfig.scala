...
object AuthConfig {
  ...
  implicit class AuthConfigOps[Self <: AuthConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthenticatingComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("AuthenticatingComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setAuthenticatingComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("AuthenticatingComponent", value.asInstanceOf[js.Any])
    @scala.inline
