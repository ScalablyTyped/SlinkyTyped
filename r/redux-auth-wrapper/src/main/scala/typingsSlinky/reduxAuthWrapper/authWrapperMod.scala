...
object authWrapperMod {
  ...
  object AuthWrapperConfig {
    ...
    implicit class AuthWrapperConfigMutableBuilder[Self <: AuthWrapperConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFailureComponentComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "FailureComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFailureComponentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "FailureComponent", value.asInstanceOf[js.Any])
