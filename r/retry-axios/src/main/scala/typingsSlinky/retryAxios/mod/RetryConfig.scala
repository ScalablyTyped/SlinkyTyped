...
object RetryConfig {
  ...
  implicit class RetryConfigOps[Self <: RetryConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInstance(value: AxiosInstance): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnRetryAttempt(value: /* err */ AxiosError[_] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShouldRetry(value: /* err */ AxiosError[_] => Boolean): Self = {
        val ret = this.duplicate
