package typingsSlinky.rdfLoadersRegistry.anon
...
object LoaderRegistry {
  ...
  implicit class LoaderRegistryOps[Self <: LoaderRegistry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLoaderRegistry(value: typingsSlinky.rdfLoadersRegistry.mod.LoaderRegistry): Self = this.set("loaderRegistry", value.asInstanceOf[js.Any])
  }
}
