...
object ^
  extends TopLevel[
      Instantiable0[StructType] with (Instantiable1[/* fields */ js.Array[js.Any], StructType]) with (Instantiable1[/* fields */ js.Object, StructType]) with (Instantiable2[/* fields */ js.Object, /* opt */ js.Object, StructType]) with (Instantiable2[/* fields */ js.UndefOr[scala.Nothing], /* opt */ js.Object, StructType])
    ] {
