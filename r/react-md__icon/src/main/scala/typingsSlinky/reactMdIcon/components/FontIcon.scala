...
object FontIcon {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def forceFontSize(value: Boolean): this.type = set("forceFontSize", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FontIconProps with RefAttributes[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
