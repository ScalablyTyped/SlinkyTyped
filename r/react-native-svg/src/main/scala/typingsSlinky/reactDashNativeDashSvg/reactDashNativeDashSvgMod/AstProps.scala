...
object AstProps {
  ...
  def apply(
    ...
    vectorEffect: typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.none | `non-scaling-stroke` | nonScalingStroke | typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.default | inherit | uri = null,
    viewBox: String = null,
