...
import typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.EllipseProps
...
object Ellipse
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.Ellipse] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.Ellipse] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.Ellipse] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.Ellipse](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
