...
import typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.MaskProps
...
import typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.TMaskUnits
...
object Mask
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.Mask] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.Mask] = {
