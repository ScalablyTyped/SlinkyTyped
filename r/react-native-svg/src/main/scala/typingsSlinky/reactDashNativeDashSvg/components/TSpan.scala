...
import typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.TSpanProps
...
object TSpan
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.TSpan] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.TSpan] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.TSpan] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.TSpan](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
