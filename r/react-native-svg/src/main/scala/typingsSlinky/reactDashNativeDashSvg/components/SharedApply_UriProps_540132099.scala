...
import typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.SvgProps
import typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.TransformObject
import typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgMod.UriProps
...
abstract class SharedApply_UriProps_540132099[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: disabled, height, id, onTouchCancel, onTouchEnd, onTouchMove, onTouchStart, width */
  def apply(
    ...
    `override`: SvgProps = null,
    pointerEvents: `box-none` | typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.none | `box-only` | typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.auto = null,
    ...
    uri: String = null,
    vectorEffect: typingsSlinky.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.none | `non-scaling-stroke` | nonScalingStroke | default | inherit | uri = null,
    viewBox: String = null,
    x: NumberArray = null,
    y: NumberArray = null,
