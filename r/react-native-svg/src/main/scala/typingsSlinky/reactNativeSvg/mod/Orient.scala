...
object Orient extends StObject {
  ...
  /* "auto" */ val AUTO: typingsSlinky.reactNativeSvg.mod.Orient.AUTO with String = js.native
  
  @js.native
  sealed trait AUTO_START_REVERSE extends Orient
  /* "auto-start-reverse" */ val AUTO_START_REVERSE: typingsSlinky.reactNativeSvg.mod.Orient.AUTO_START_REVERSE with String = js.native
}
