...
object MarkerUnits extends StObject {
  ...
  /* "strokeWidth" */ val STROKE_WIDTH: typingsSlinky.reactNativeSvg.mod.MarkerUnits.STROKE_WIDTH with String = js.native
  
  @js.native
  sealed trait USER_SPACE_ON_USE extends MarkerUnits
  /* "userSpaceOnUse" */ val USER_SPACE_ON_USE: typingsSlinky.reactNativeSvg.mod.MarkerUnits.USER_SPACE_ON_USE with String = js.native
}
