...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.`text-bottom`
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.alphabetic
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.ideographic
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.middle
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.central
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.mathematical
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.`text-top`
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.bottom
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.center
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.top
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.`text-before-edge`
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.`text-after-edge`
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.`before-edge`
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.`after-edge`
  - typingsSlinky.reactNativeSvg.reactNativeSvgStrings.hanging
*/
