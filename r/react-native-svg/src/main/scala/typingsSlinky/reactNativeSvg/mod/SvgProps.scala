...
object SvgProps {
  ...
  def apply(
    ...
    pointerEvents: `box-none` | typingsSlinky.reactNativeSvg.reactNativeSvgStrings.none | `box-only` | typingsSlinky.reactNativeSvg.reactNativeSvgStrings.auto = null,
    ...
    vectorEffect: typingsSlinky.reactNativeSvg.reactNativeSvgStrings.none | `non-scaling-stroke` | nonScalingStroke | typingsSlinky.reactNativeSvg.reactNativeSvgStrings.default | inherit | uri = null,
    viewBox: String = null,
