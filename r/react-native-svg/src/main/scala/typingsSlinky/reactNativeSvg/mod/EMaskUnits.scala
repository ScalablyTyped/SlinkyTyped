...
object EMaskUnits extends StObject {
  ...
  sealed trait OBJECT_BOUNDING_BOX
    extends EMaskUnits
       with TMaskUnits
  /* "objectBoundingBox" */ val OBJECT_BOUNDING_BOX: typingsSlinky.reactNativeSvg.mod.EMaskUnits.OBJECT_BOUNDING_BOX with String = js.native
  
  @js.native
  sealed trait USER_SPACE_ON_USE
    extends EMaskUnits
       with TMaskUnits
  /* "userSpaceOnUse" */ val USER_SPACE_ON_USE: typingsSlinky.reactNativeSvg.mod.EMaskUnits.USER_SPACE_ON_USE with String = js.native
}
