...
import typingsSlinky.reactNativeSvg.mod.PolylineProps
...
object Polyline
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvg.mod.Polyline] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Polyline] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Polyline] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeSvg.mod.Polyline](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
