...
import typingsSlinky.reactNativeSvg.mod.EllipseProps
...
object Ellipse
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvg.mod.Ellipse] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Ellipse] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Ellipse] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeSvg.mod.Ellipse](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = EllipseProps
}
