...
@scala.inline
class SharedBuilder_XmlProps_1831478542[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def xml(value: String): this.type = set("xml", value.asInstanceOf[js.Any])
  @scala.inline
  def xmlNull: this.type = set("xml", null)
  @scala.inline
