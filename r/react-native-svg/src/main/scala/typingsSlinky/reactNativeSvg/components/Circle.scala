...
object Circle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvg.mod.Circle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Circle] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Circle] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeSvg.mod.Circle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
