...
object TextPath {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def method(value: TextPathMethod): this.type = set("method", value.asInstanceOf[js.Any])
    
    @scala.inline
    def midLine(value: TextPathMidLine): this.type = set("midLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def spacing(value: TextPathSpacing): this.type = set("spacing", value.asInstanceOf[js.Any])
