...
object TextPath
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvg.mod.TextPath] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.TextPath] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.TextPath] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeSvg.mod.TextPath](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
