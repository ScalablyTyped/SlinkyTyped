...
import typingsSlinky.reactNativeSvg.mod.PathProps
...
object Path
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvg.mod.Path] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Path] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Path] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeSvg.mod.Path](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
