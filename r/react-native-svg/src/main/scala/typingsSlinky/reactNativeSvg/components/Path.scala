...
import typingsSlinky.reactNativeSvg.mod.PathCls
...
object Path {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, PathCls] {
  ...
  def withProps(p: PathProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
