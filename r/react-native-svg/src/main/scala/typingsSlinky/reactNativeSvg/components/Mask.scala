...
import typingsSlinky.reactNativeSvg.mod.MaskCls
...
object Mask {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, MaskCls] {
    ...
    @scala.inline
    def maskContentUnits(value: TMaskUnits): this.type = set("maskContentUnits", value.asInstanceOf[js.Any])
    
    @scala.inline
    def maskTransform(value: ColumnMajorTransformMatrix | String): this.type = set("maskTransform", value.asInstanceOf[js.Any])
    
    @scala.inline
    def maskUnits(value: TMaskUnits): this.type = set("maskUnits", value.asInstanceOf[js.Any])
