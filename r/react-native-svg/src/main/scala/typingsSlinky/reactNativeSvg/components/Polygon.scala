...
import typingsSlinky.reactNativeSvg.mod.PolygonProps
...
object Polygon
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvg.mod.Polygon] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Polygon] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeSvg.mod.Polygon] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeSvg.mod.Polygon](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
