package typingsSlinky.reactNativeSignatureCapture.components
...
import typingsSlinky.reactNativeSignatureCapture.mod.SaveEventParams
import typingsSlinky.reactNativeSignatureCapture.mod.SignatureCaptureProps
import typingsSlinky.reactNativeSignatureCapture.mod.default
...
object ReactNativeSignatureCapture {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onDragEvent(value: /* event */ js.Any => Unit): this.type = set("onDragEvent", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onSaveEvent(value: /* params */ SaveEventParams => Unit): this.type = set("onSaveEvent", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def saveImageFileInExtStorage(value: Boolean): this.type = set("saveImageFileInExtStorage", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def showNativeButtons(value: Boolean): this.type = set("showNativeButtons", value.asInstanceOf[js.Any])
    @scala.inline
    def showTitleLabel(value: Boolean): this.type = set("showTitleLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def viewMode(value: portrait | landscape): this.type = set("viewMode", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: SignatureCaptureProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ReactNativeSignatureCapture.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
