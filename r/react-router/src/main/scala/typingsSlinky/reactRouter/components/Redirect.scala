...
object Redirect
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouter.mod.Redirect] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouter.mod.Redirect] = {
