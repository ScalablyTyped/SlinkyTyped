...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.reactRouter.reactRouterStrings.AnonHistory with js.Any */] extends js.Object {
...
object AnonHistory {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouter.reactRouterStrings.AnonHistory with js.Any */](history: History[LocationState], route: AnonLocation[Params]): AnonHistory[Params] = {
