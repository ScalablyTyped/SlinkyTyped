...
object WrappedComponentRef {
  @scala.inline
  def apply[/* <: typingsSlinky.react.mod.ComponentType[_] */ C](): WrappedComponentRef[C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WrappedComponentRef[C]]
  }
  @scala.inline
  implicit class WrappedComponentRefOps[Self <: WrappedComponentRef[_], /* <: typingsSlinky.react.mod.ComponentType[_] */ C] (val x: Self with WrappedComponentRef[C]) extends AnyVal {
    @scala.inline
