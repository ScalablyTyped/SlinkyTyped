...
object History {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouter.reactRouterStrings.History with org.scalablytyped.runtime.TopLevel[js.Any] */ Params](history: typingsSlinky.history.mod.History[LocationState], route: Location[Params]): History[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouter.reactRouterStrings.History with org.scalablytyped.runtime.TopLevel[js.Any] */ Params] (val x: Self with History[Params]) extends AnyVal {
    @scala.inline
