...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.reactRouter.reactRouterStrings.RouteChildrenProps with TopLevel[js.Any] */, S] extends StObject {
...
object RouteChildrenProps {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouter.reactRouterStrings.RouteChildrenProps with TopLevel[js.Any] */, S](history: History[LocationState], location: Location[S]): RouteChildrenProps[Params, S] = {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouter.reactRouterStrings.RouteChildrenProps with TopLevel[js.Any] */, S] (val x: Self with (RouteChildrenProps[Params, S])) extends AnyVal {
