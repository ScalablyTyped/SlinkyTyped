...
object RouterChildContext {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouter.reactRouterStrings.RouterChildContext with org.scalablytyped.runtime.TopLevel[js.Any] */ Params](router: History[Params]): RouterChildContext[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouter.reactRouterStrings.RouterChildContext with org.scalablytyped.runtime.TopLevel[js.Any] */ Params] (val x: Self with RouterChildContext[Params]) extends AnyVal {
    @scala.inline
