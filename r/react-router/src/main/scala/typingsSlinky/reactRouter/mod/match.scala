...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.reactRouter.reactRouterStrings.`match` with js.Any */] extends js.Object {
  var isExact: Boolean
  var params: Params
  var path: String
  var url: String
...
object `match` {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouter.reactRouterStrings.`match` with js.Any */](isExact: Boolean, params: Params, path: String, url: String): `match`[Params] = {
