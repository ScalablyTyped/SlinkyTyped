...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.reactRouter.reactRouterStrings.`match` with TopLevel[js.Any] */] extends StObject {
...
object `match` {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouter.reactRouterStrings.`match` with TopLevel[js.Any] */](isExact: Boolean, params: Params, path: String, url: String): `match`[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouter.reactRouterStrings.`match` with TopLevel[js.Any] */] (val x: Self with `match`[Params]) extends AnyVal {
