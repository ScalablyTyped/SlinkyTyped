...
object `match` {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouter.reactRouterStrings.`match` with org.scalablytyped.runtime.TopLevel[js.Any] */ Params](isExact: Boolean, params: Params, path: String, url: String): `match`[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouter.reactRouterStrings.`match` with org.scalablytyped.runtime.TopLevel[js.Any] */ Params] (val x: Self with `match`[Params]) extends AnyVal {
    @scala.inline
