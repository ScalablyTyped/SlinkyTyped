...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.reactDashRouter.reactDashRouterStrings.Anon_History with js.Any */] extends js.Object {
...
object Anon_History {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactDashRouter.reactDashRouterStrings.Anon_History with js.Any */](history: History[LocationState], route: Anon_Location[Params]): Anon_History[Params] = {
