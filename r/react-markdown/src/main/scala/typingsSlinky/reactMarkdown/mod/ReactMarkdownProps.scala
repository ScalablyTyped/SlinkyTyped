...
object ReactMarkdownProps {
  ...
  def apply(
    ...
    transformImageUri: js.UndefOr[
      Null | ((/* uri */ String, /* children */ js.UndefOr[TagMod[Any]], /* title */ js.UndefOr[String], /* alt */ js.UndefOr[String]) => String)
    ] = js.undefined,
    transformLinkUri: js.UndefOr[
      Null | ((/* uri */ String, /* children */ js.UndefOr[TagMod[Any]], /* title */ js.UndefOr[String]) => String)
    ] = js.undefined,
    ...
    if (!js.isUndefined(transformImageUri)) __obj.updateDynamic("transformImageUri")(if (transformImageUri != null) js.Any.fromFunction4(transformImageUri.asInstanceOf[(/* uri */ String, /* children */ js.UndefOr[TagMod[Any]], /* title */ js.UndefOr[String], /* alt */ js.UndefOr[String]) => String]) else null)
    if (!js.isUndefined(transformLinkUri)) __obj.updateDynamic("transformLinkUri")(if (transformLinkUri != null) js.Any.fromFunction3(transformLinkUri.asInstanceOf[(/* uri */ String, /* children */ js.UndefOr[TagMod[Any]], /* title */ js.UndefOr[String]) => String]) else null)
