package typingsSlinky.reduxDashPersistDashTransformDashEncrypt.reduxDashPersistDashTransformDashEncryptMod
...
object EncryptorConfig {
  @scala.inline
  def apply(secretKey: String, onError: /* err */ js.Error => Unit = null): EncryptorConfig = {
