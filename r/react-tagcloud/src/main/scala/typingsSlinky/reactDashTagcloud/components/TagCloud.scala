package typingsSlinky.reactDashTagcloud.components
...
object TagCloud
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashTagcloud.reactTagCloud.TagCloud] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashTagcloud.reactTagCloud.TagCloud] = {
