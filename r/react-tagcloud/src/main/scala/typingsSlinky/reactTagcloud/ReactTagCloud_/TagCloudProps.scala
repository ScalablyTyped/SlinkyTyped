...
object TagCloudProps {
  ...
  def apply(
    ...
    ref: js.UndefOr[Null | LegacyRef[Unit]] = js.undefined,
    ...
    if (!js.isUndefined(disableRandomColor)) __obj.updateDynamic("disableRandomColor")(disableRandomColor.get.asInstanceOf[js.Any])
