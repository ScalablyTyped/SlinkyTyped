...
object TagCloud
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactTagcloud.mod.TagCloud] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactTagcloud.mod.TagCloud] = {
