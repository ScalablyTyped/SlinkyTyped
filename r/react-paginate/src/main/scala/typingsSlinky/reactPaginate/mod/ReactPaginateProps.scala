...
trait ReactPaginateProps extends js.Object {
  ...
  /**
    * Label for ellipsis.
    */
  var breakLabel: js.UndefOr[String | ReactElement] = js.native
  /**
  ...
  /**
    ...
    */
  var nextLabel: js.UndefOr[ReactElement] = js.native
  /**
  ...
  /**
    ...
    */
  var previousLabel: js.UndefOr[ReactElement] = js.native
  /**
...
object ReactPaginateProps {
  ...
  implicit class ReactPaginatePropsOps[Self <: ReactPaginateProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBreakLabelReactElement(value: ReactElement): Self = this.set("breakLabel", value.asInstanceOf[js.Any])
    @scala.inline
    def setBreakLabel(value: String | ReactElement): Self = this.set("breakLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNextLabelReactElement(value: ReactElement): Self = this.set("nextLabel", value.asInstanceOf[js.Any])
    @scala.inline
    def setNextLabel(value: ReactElement): Self = this.set("nextLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPreviousLabelReactElement(value: ReactElement): Self = this.set("previousLabel", value.asInstanceOf[js.Any])
    @scala.inline
    def setPreviousLabel(value: ReactElement): Self = this.set("previousLabel", value.asInstanceOf[js.Any])
    @scala.inline
