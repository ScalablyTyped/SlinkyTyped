...
object mod extends Shortcut {
  ...
  @JSImport("react-paginate", JSImport.Default)
  @js.native
  val default: ReactComponentClass[ReactPaginateProps] = js.native
  ...
  object ReactPaginateProps {
    ...
    implicit class ReactPaginatePropsMutableBuilder[Self <: ReactPaginateProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBreakLabel(value: String | ReactElement): Self = StObject.set(x, "breakLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBreakLabelReactElement(value: ReactElement): Self = StObject.set(x, "breakLabel", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNextLabel(value: ReactElement): Self = StObject.set(x, "nextLabel", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPreviousLabel(value: ReactElement): Self = StObject.set(x, "previousLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreviousLabelReactElement(value: ReactElement): Self = StObject.set(x, "previousLabel", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[ReactPaginateProps]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ReactComponentClass[ReactPaginateProps] = default
}
