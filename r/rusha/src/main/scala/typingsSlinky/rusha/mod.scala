...
object mod extends Shortcut {
  ...
  trait RushaWorkerRequest extends StObject {
    ...
    var data: String | js.Array[Double] | js.typedarray.ArrayBuffer | Buffer | Blob = js.native
  ...
  object RushaWorkerRequest {
    ...
    @scala.inline
    def apply(data: String | js.Array[Double] | js.typedarray.ArrayBuffer | Buffer | Blob, id: String): RushaWorkerRequest = {
    ...
    implicit class RushaWorkerRequestMutableBuilder[Self <: RushaWorkerRequest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setData(value: String | js.Array[Double] | js.typedarray.ArrayBuffer | Buffer | Blob): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
