...
object ReactContentLoader {
  ...
  implicit def make(companion: ReactContentLoader.type): SharedBuilder_IContentLoaderProps1813843303 = new SharedBuilder_IContentLoaderProps1813843303(js.Array(this.component, js.Dictionary.empty))()
}
