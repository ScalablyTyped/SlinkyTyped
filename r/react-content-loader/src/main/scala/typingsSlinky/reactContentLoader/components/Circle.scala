...
object Circle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactContentLoader.nativeMod.Circle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactContentLoader.nativeMod.Circle] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactContentLoader.nativeMod.Circle] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactContentLoader.nativeMod.Circle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
