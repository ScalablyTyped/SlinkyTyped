...
@scala.inline
class SharedBuilder_IContentLoaderProps1813843303 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def gradientRatio(value: Double): this.type = set("gradientRatio", value.asInstanceOf[js.Any])
  @scala.inline
