...
object Rect
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactContentLoader.nativeMod.Rect] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactContentLoader.nativeMod.Rect] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactContentLoader.nativeMod.Rect] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactContentLoader.nativeMod.Rect](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
