...
object Holder {
  @JSImport("react-content-loader/dist/native/Holder", JSImport.Default)
  @js.native
  ...
  def withProps(p: IContentLoaderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Holder.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
