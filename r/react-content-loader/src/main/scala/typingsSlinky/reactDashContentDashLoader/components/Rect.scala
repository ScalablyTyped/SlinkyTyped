...
object Rect
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashContentDashLoader.distNativeMod.Rect] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashContentDashLoader.distNativeMod.Rect] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashContentDashLoader.distNativeMod.Rect] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashContentDashLoader.distNativeMod.Rect](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
