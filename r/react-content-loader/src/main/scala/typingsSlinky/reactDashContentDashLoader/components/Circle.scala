...
object Circle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashContentDashLoader.distNativeMod.Circle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashContentDashLoader.distNativeMod.Circle] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashContentDashLoader.distNativeMod.Circle] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashContentDashLoader.distNativeMod.Circle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
