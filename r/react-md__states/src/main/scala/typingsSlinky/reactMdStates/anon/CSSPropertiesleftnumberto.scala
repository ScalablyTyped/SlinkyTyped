...
object CSSPropertiesleftnumberto {
  ...
  implicit class CSSPropertiesleftnumbertoOps[Self <: CSSPropertiesleftnumberto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeight(value: (js.UndefOr[HeightProperty[String | Double]]) with Double): Self = this.set("height", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLeft(value: (js.UndefOr[LeftProperty[String | Double]]) with Double): Self = this.set("left", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTop(value: (js.UndefOr[TopProperty[String | Double]]) with Double): Self = this.set("top", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWidth(value: (js.UndefOr[WidthProperty[String | Double]]) with Double): Self = this.set("width", value.asInstanceOf[js.Any])
