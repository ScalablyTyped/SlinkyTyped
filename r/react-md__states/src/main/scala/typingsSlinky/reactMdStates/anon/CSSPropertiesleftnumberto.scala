...
@js.native
trait CSSPropertiesleftnumberto extends js.Object {
  ...
  /**
    ...
    */
  var height: (js.UndefOr[Height[String | Double]]) with Double = js.native
  ...
  /**
    ...
    */
  var left: (js.UndefOr[Left[String | Double]]) with Double = js.native
  ...
  /**
    ...
    */
  var top: (js.UndefOr[Top[String | Double]]) with Double = js.native
  ...
  /**
    ...
    */
  var width: (js.UndefOr[Width[String | Double]]) with Double = js.native
...
object CSSPropertiesleftnumberto {
  ...
  @scala.inline
  def apply(
    height: (js.UndefOr[Height[String | Double]]) with Double,
    left: (js.UndefOr[Left[String | Double]]) with Double,
    top: (js.UndefOr[Top[String | Double]]) with Double,
    width: (js.UndefOr[Width[String | Double]]) with Double
  ...
  @scala.inline
  implicit class CSSPropertiesleftnumbertoOps[Self <: CSSPropertiesleftnumberto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeight(value: (js.UndefOr[Height[String | Double]]) with Double): Self = this.set("height", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLeft(value: (js.UndefOr[Left[String | Double]]) with Double): Self = this.set("left", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTop(value: (js.UndefOr[Top[String | Double]]) with Double): Self = this.set("top", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWidth(value: (js.UndefOr[Width[String | Double]]) with Double): Self = this.set("width", value.asInstanceOf[js.Any])
