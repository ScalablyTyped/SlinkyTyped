...
@js.native
trait InteractionStatesOptions[E /* <: HTMLElement */] extends js.Object {
  /**
...
object InteractionStatesOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): InteractionStatesOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InteractionStatesOptions[E]]
  }
  @scala.inline
  implicit class InteractionStatesOptionsOps[Self <: InteractionStatesOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with InteractionStatesOptions[E]) extends AnyVal {
    @scala.inline
