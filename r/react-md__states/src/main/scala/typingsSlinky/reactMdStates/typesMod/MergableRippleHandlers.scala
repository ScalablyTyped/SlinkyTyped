...
object MergableRippleHandlers {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): MergableRippleHandlers[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MergableRippleHandlers[E]]
  }
  @scala.inline
  implicit class MergableRippleHandlersOps[Self <: MergableRippleHandlers[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with MergableRippleHandlers[E]) extends AnyVal {
    @scala.inline
