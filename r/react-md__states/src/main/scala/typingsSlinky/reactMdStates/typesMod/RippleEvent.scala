...
object RippleEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](currentTarget: EventTarget with E, target: EventTarget, `type`: String): RippleEvent[E] = {
  ...
  @scala.inline
  implicit class RippleEventOps[Self <: RippleEvent[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with RippleEvent[E]) extends AnyVal {
    @scala.inline
