...
object RipplesOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): RipplesOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RipplesOptions[E]]
  }
  @scala.inline
  implicit class RipplesOptionsOps[Self <: RipplesOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with RipplesOptions[E]) extends AnyVal {
    @scala.inline
