...
object PressedStatesOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): PressedStatesOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PressedStatesOptions[E]]
  }
  @scala.inline
  implicit class PressedStatesOptionsOps[Self <: PressedStatesOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with PressedStatesOptions[E]) extends AnyVal {
    @scala.inline
