...
object ReleaseAction {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](event: RippleEvent[E], `type`: /* "RELEASE" */ String): ReleaseAction[E] = {
    val __obj = js.Dynamic.literal(event = event.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReleaseAction[E]]
  }
  @scala.inline
  implicit class ReleaseActionOps[Self <: ReleaseAction[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with ReleaseAction[E]) extends AnyVal {
    @scala.inline
