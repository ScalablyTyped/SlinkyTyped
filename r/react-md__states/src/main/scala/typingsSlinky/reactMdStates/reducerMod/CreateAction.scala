...
object CreateAction {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](disableSpacebarClick: Boolean, event: RippleEvent[E], `type`: /* "CREATE" */ String): CreateAction[E] = {
  ...
  @scala.inline
  implicit class CreateActionOps[Self <: CreateAction[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with CreateAction[E]) extends AnyVal {
    @scala.inline
