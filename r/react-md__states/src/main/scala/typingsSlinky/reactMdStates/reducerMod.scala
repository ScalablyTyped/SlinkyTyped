...
object reducerMod {
  ...
  */
  ...
  object RippleStateAction {
    ...
    @scala.inline
    def CancelAction(ease: Boolean, `type`: /* "CANCEL" */ String): typingsSlinky.reactMdStates.reducerMod.CancelAction = {
      val __obj = js.Dynamic.literal(ease = ease.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdStates.reducerMod.CancelAction]
    }
    
    @scala.inline
    def CreateAction[E /* <: HTMLElement */](disableSpacebarClick: Boolean, event: RippleEvent[E], `type`: /* "CREATE" */ String): typingsSlinky.reactMdStates.reducerMod.CreateAction[E] = {
      val __obj = js.Dynamic.literal(disableSpacebarClick = disableSpacebarClick.asInstanceOf[js.Any], event = event.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdStates.reducerMod.CreateAction[E]]
    }
    
    @scala.inline
    def EnteredAction(ripple: RippleState, `type`: /* "ENTERED" */ String): typingsSlinky.reactMdStates.reducerMod.EnteredAction = {
      val __obj = js.Dynamic.literal(ripple = ripple.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdStates.reducerMod.EnteredAction]
    }
    
    @scala.inline
    def ReleaseAction[E /* <: HTMLElement */](event: RippleEvent[E], `type`: /* "RELEASE" */ String): typingsSlinky.reactMdStates.reducerMod.ReleaseAction[E] = {
      val __obj = js.Dynamic.literal(event = event.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdStates.reducerMod.ReleaseAction[E]]
    }
    
    @scala.inline
    def RemoveAction(ripple: RippleState, `type`: /* "REMOVE" */ String): typingsSlinky.reactMdStates.reducerMod.RemoveAction = {
      val __obj = js.Dynamic.literal(ripple = ripple.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdStates.reducerMod.RemoveAction]
    }
  }
}
