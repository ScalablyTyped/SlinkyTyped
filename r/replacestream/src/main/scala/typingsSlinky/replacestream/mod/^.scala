...
object ^ extends js.Object {
  ...
  def apply(search: js.RegExp, replace: String): js.Any = js.native
  def apply(search: js.RegExp, replace: String, options: Options): js.Any = js.native
  def apply(search: js.RegExp, replace: ReplaceFunction): js.Any = js.native
  def apply(search: js.RegExp, replace: ReplaceFunction, options: Options): js.Any = js.native
}
