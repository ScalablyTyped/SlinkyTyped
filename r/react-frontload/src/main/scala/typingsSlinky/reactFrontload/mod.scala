...
object mod {
  ...
  @JSImport("react-frontload", "Frontload")
  @js.native
  val Frontload: ReactComponentClass[FrontloadProps] = js.native
  
  @JSImport("react-frontload", "frontloadConnect")
  @js.native
  def frontloadConnect(frontload: js.Function1[/* props */ js.Any, js.Promise[Unit]]): js.Function1[/* Component */ ReactComponentClass[js.Object], ReactComponentClass[js.Object]] = js.native
  @JSImport("react-frontload", "frontloadConnect")
  @js.native
  def frontloadConnect(frontload: js.Function1[/* props */ js.Any, js.Promise[Unit]], options: FrontloadConnectOptions): js.Function1[/* Component */ ReactComponentClass[js.Object], ReactComponentClass[js.Object]] = js.native
