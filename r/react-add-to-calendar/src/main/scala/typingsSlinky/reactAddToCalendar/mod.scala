...
object mod extends Shortcut {
  ...
  @JSImport("react-add-to-calendar", JSImport.Default)
  @js.native
  val default: ReactComponentClass[AddToCalendarProps] = js.native
  ...
  trait AddToCalendarEvent extends StObject {
    ...
    var endTime: js.UndefOr[String | js.Date] = js.native
    
    var location: js.UndefOr[String] = js.native
    
    var startTime: js.UndefOr[String | js.Date] = js.native
  ...
  object AddToCalendarEvent {
    ...
    implicit class AddToCalendarEventMutableBuilder[Self <: AddToCalendarEvent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndTime(value: String | js.Date): Self = StObject.set(x, "endTime", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStartTime(value: String | js.Date): Self = StObject.set(x, "startTime", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[AddToCalendarProps]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ReactComponentClass[AddToCalendarProps] = default
}
