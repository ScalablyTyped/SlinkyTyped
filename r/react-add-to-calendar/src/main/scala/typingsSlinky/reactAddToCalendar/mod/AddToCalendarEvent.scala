...
object AddToCalendarEvent {
  ...
  implicit class AddToCalendarEventOps[Self <: AddToCalendarEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndTime(value: String | js.Date): Self = this.set("endTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStartTime(value: String | js.Date): Self = this.set("startTime", value.asInstanceOf[js.Any])
    @scala.inline
