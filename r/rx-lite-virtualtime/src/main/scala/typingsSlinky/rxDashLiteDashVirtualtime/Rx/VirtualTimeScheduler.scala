package typingsSlinky.rxDashLiteDashVirtualtime.Rx

import typingsSlinky.rxDashCore.Rx.IDisposable
import typingsSlinky.rxDashLite.Rx.IScheduler
import typingsSlinky.rxDashLite.Rx.internals.ScheduledItem
...
trait VirtualTimeScheduler[TAbsolute, TRelative] extends IScheduler {
  ...
  def scheduleAbsoluteWithState[TState](
    ...
    dueTime: TAbsolute,
    action: js.Function2[
      /* scheduler */ typingsSlinky.rxDashCore.Rx.IScheduler, 
      /* state */ TState, 
      IDisposable
    ]
  ): IDisposable
...
object VirtualTimeScheduler {
  ...
  def apply[TAbsolute, TRelative](
    ...
    scheduleAbsoluteWithState: (js.Any, TAbsolute, js.Function2[/* scheduler */ typingsSlinky.rxDashCore.Rx.IScheduler, js.Any, IDisposable]) => IDisposable,
    ...
    scheduleRelativeWithState: (js.Any, TRelative, js.Function2[/* scheduler */ typingsSlinky.rxDashCore.Rx.IScheduler, js.Any, IDisposable]) => IDisposable,
