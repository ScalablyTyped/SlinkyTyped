...
object mod {
  ...
  @js.native
  class ContentBlock ()
    extends typingsSlinky.draftJs.mod.ContentBlock
  
  @JSImport("react-draft-wysiwyg", "ContentState")
  @js.native
  class ContentState ()
    extends typingsSlinky.draftJs.mod.ContentState
  ...
  @js.native
  class EditorState ()
    extends typingsSlinky.draftJs.mod.EditorState
  
  @JSImport("react-draft-wysiwyg", "SelectionState")
  @js.native
  class SelectionState ()
    extends typingsSlinky.draftJs.mod.SelectionState
  ...
  object EditorProps {
    ...
    implicit class EditorPropsMutableBuilder[Self <: EditorProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBlur(value: slinky.core.SyntheticEvent[EventTarget with js.Object, Event] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnFocus(value: slinky.core.SyntheticEvent[EventTarget with js.Object, Event] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnFocusUndefined: Self = StObject.set(x, "onFocus", js.undefined)
      
      @scala.inline
      def setOnTab(value: slinky.web.SyntheticKeyboardEvent[js.Object] => Unit): Self = StObject.set(x, "onTab", js.Any.fromFunction1(value))
  ...
  type SyntheticEvent = slinky.core.SyntheticEvent[Event, js.Object]
