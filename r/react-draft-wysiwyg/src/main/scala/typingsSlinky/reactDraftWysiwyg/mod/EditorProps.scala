...
object EditorProps {
  ...
  def apply(
    ...
    onBlur: slinky.core.SyntheticEvent[EventTarget with js.Object, Event_] => Unit = null,
    ...
    onFocus: slinky.core.SyntheticEvent[EventTarget with js.Object, Event_] => Unit = null,
