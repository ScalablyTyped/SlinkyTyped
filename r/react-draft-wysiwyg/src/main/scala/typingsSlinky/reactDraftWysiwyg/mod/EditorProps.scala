...
object EditorProps {
  ...
  def apply(
    ...
    onBlur: slinky.core.SyntheticEvent[EventTarget with js.Object, Event] => Unit = null,
    ...
    onFocus: slinky.core.SyntheticEvent[EventTarget with js.Object, Event] => Unit = null,
