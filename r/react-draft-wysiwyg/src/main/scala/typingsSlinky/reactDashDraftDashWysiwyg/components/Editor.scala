package typingsSlinky.reactDashDraftDashWysiwyg.components
...
import typingsSlinky.reactDashDraftDashWysiwyg.reactDashDraftDashWysiwygMod.ContentBlock
import typingsSlinky.reactDashDraftDashWysiwyg.reactDashDraftDashWysiwygMod.EditorProps
import typingsSlinky.reactDashDraftDashWysiwyg.reactDashDraftDashWysiwygMod.EditorState
import typingsSlinky.reactDashDraftDashWysiwyg.reactDashDraftDashWysiwygMod.RawDraftContentState
...
object Editor
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashDraftDashWysiwyg.reactDashDraftDashWysiwygMod.Editor
    ] {
  ...
  /* The following DOM/SVG props were specified: onBlur, onChange, onFocus, placeholder, readOnly, spellCheck, tabIndex */
  def apply(
  ...
  typingsSlinky.reactDashDraftDashWysiwyg.reactDashDraftDashWysiwygMod.Editor](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
