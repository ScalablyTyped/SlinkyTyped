...
object Fulfilled {
  ...
  implicit def make[T](companion: Fulfilled.type): SharedBuilder_AnonPersist_214611622[T] = new SharedBuilder_AnonPersist_214611622[T](js.Array(this.component, js.Dictionary.empty))()
}
