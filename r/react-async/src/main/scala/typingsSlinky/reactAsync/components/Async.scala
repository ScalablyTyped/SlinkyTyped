...
object Async {
  ...
  @scala.inline
  def apply[T](): SharedBuilder_AsyncProps2057177666[typingsSlinky.reactAsync.mod.Async[js.Any], T] = {
    val __props = js.Dynamic.literal()
    new SharedBuilder_AsyncProps2057177666[typingsSlinky.reactAsync.mod.Async[js.Any], T](js.Array(this.component, __props.asInstanceOf[AsyncProps[T]]))
  }
