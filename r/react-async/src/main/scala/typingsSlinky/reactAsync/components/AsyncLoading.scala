...
object AsyncLoading {
  ...
  implicit def make[T](companion: AsyncLoading.type): SharedBuilder_Initial1771268107[T] = new SharedBuilder_Initial1771268107[T](js.Array(this.component, js.Dictionary.empty))()
}
