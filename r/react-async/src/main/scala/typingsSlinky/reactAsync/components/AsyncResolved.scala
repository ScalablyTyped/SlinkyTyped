...
object AsyncResolved {
  ...
  implicit def make[T](companion: AsyncResolved.type): SharedBuilder_AnonPersist_214611622[T] = new SharedBuilder_AnonPersist_214611622[T](js.Array(this.component, js.Dictionary.empty))()
}
