...
object AsyncResolved {
  ...
  implicit def make[T](companion: AsyncResolved.type): SharedBuilder_Persist_1362630938[T] = new SharedBuilder_Persist_1362630938[T](js.Array(this.component, js.Dictionary.empty))()
}
