...
object IfInitial {
  ...
  class Builder[/* <: js.Object */ T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def childrenFunction1(value: /* state */ AsyncInitial[T, AbstractState[T]] => ReactElement): this.type = set("children", js.Any.fromFunction1(value))
    @scala.inline
    def children(value: InitialChildren[T]): this.type = set("children", value.asInstanceOf[js.Any])
    @scala.inline
    def persist(value: Boolean): this.type = set("persist", value.asInstanceOf[js.Any])
  }
  
  def withProps[/* <: js.Object */ T](p: State[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
