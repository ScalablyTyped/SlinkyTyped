...
object AsyncPending {
  ...
  implicit def make[T](companion: AsyncPending.type): SharedBuilder_AnonInitial2048159340[T] = new SharedBuilder_AnonInitial2048159340[T](js.Array(this.component, js.Dictionary.empty))()
}
