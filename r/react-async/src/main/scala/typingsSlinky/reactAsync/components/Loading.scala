...
object Loading {
  ...
  implicit def make[T](companion: Loading.type): SharedBuilder_Initial1771268107[T] = new SharedBuilder_Initial1771268107[T](js.Array(this.component, js.Dictionary.empty))()
}
