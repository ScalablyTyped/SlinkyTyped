...
object ChildrenPersistState {
  @scala.inline
  def apply[T](state: AsyncState[T]): ChildrenPersistState[T] = {
    val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChildrenPersistState[T]]
  }
  @scala.inline
  implicit class ChildrenPersistStateOps[Self[t] <: ChildrenPersistState[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
