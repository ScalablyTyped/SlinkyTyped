...
object AnonChildrenPersistState {
  @scala.inline
  def apply[T](state: AsyncState[T]): AnonChildrenPersistState[T] = {
    val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonChildrenPersistState[T]]
  }
  @scala.inline
  implicit class AnonChildrenPersistStateOps[Self[t] <: AnonChildrenPersistState[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
