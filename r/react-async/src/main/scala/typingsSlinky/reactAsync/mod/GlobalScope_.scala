...
import typingsSlinky.reactAsync.anon.FnCall
import typingsSlinky.reactAsync.anon.Instantiable
...
trait GlobalScope_ extends js.Object {
  var AbortController: js.UndefOr[Instantiable with Instantiable0[org.scalajs.dom.experimental.AbortController]] = js.native
