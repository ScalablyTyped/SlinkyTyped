package typingsSlinky.reactTextTruncate
...
object mod {
  ...
  type TextTruncate = ReactComponentClass[TextTruncateProps]
  ...
  trait TextTruncateProps extends StObject {
    ...
    var textElement: js.UndefOr[ReactElement] = js.native
    
    var textTruncateChild: js.UndefOr[ReactElement] = js.native
  ...
  object TextTruncateProps {
    ...
    implicit class TextTruncatePropsMutableBuilder[Self <: TextTruncateProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTextElement(value: ReactElement): Self = StObject.set(x, "textElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTextElementReactElement(value: ReactElement): Self = StObject.set(x, "textElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTextElementUndefined: Self = StObject.set(x, "textElement", js.undefined)
      
      @scala.inline
      def setTextTruncateChild(value: ReactElement): Self = StObject.set(x, "textTruncateChild", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTextTruncateChildReactElement(value: ReactElement): Self = StObject.set(x, "textTruncateChild", value.asInstanceOf[js.Any])
