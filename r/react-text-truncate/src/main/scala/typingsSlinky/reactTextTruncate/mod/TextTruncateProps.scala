...
object TextTruncateProps {
  ...
  implicit class TextTruncatePropsOps[Self <: TextTruncateProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextElementReactElement(value: ReactElement): Self = this.set("textElement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTextElement(value: ReactElement): Self = this.set("textElement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTextElement: Self = this.set("textElement", js.undefined)
    
    @scala.inline
    def setTextTruncateChildReactElement(value: ReactElement): Self = this.set("textTruncateChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTextTruncateChild(value: ReactElement): Self = this.set("textTruncateChild", value.asInstanceOf[js.Any])
