...
package object reactMod {
  ...
  type LazyExoticComponent[T /* <: ReactComponentClass[_] */] = ReactComponentClass[ComponentPropsWithRef[T]] with Anon_Result[T]
  type LegacyRef[T] = String | Ref[T]
  // will show `Memo(${Component.displayName || Component.name})` in devtools by default,
  // but can be given its own specific name
  type MemoExoticComponent[T /* <: ReactComponentClass[_] */] = ReactComponentClass[ComponentPropsWithRef[T]] with Anon_Type[T]
