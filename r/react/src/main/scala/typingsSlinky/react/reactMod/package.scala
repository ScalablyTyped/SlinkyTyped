...
package object reactMod {
  ...
  import typingsSlinky.propDashTypes.propDashTypesMod.InferProps
  ...
  type ComponentPropsWithRef[T /* <: slinky.core.facade.ReactElement */] = PropsWithRef[ComponentProps[T]] | (PropsWithoutRef[_] with RefAttributes[InstanceType[T]])
  ...
  // tslint:disable-next-line:no-empty-interface
  type FormEvent[T] = BaseSyntheticEvent[typingsSlinky.std.Event, EventTarget with T, EventTarget]
  ...
  type ReactEventHandler[T] = EventHandler[SyntheticEvent[T, typingsSlinky.std.Event]]
  ...
  // Component API
  // ----------------------------------------------------------------------
  type ReactInstance = (Component[js.Any, js.Object, js.Any]) | typingsSlinky.std.Element
  ...
  type TransitionStartFunction = js.Function1[
    /* callback */ typingsSlinky.react.experimentalMod.reactMod.TransitionFunction, 
    Unit
  ]
  type UIEventHandler[T] = EventHandler[UIEvent[T]]
  type ValidationMap[T] = typingsSlinky.propDashTypes.propDashTypesMod.ValidationMap[T]
  //
  // React.PropTypes
  // ----------------------------------------------------------------------
  type Validator[T] = typingsSlinky.propDashTypes.propDashTypesMod.Validator[T]
