...
object figcaption {
  ...
  val component: String = "figcaption"
  
  implicit def make(companion: figcaption.type): SharedBuilder_DetailedHTMLProps1276931637[HTMLElement] = new SharedBuilder_DetailedHTMLProps1276931637[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
