...
object nav {
  ...
  implicit def make(companion: nav.type): SharedBuilder_DetailedHTMLProps1276931637[HTMLElement] = new SharedBuilder_DetailedHTMLProps1276931637[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
}
