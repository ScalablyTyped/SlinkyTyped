...
@js.native
trait WheelEvent[T]
  extends MouseEvent[T, org.scalajs.dom.raw.WheelEvent] {
...
object WheelEvent {
  ...
  @scala.inline
  implicit class WheelEventOps[Self <: SyntheticWheelEvent[_], T] (val x: Self with SyntheticWheelEvent[T]) extends AnyVal {
    @scala.inline
