...
object SVGAttributes {
  ...
  implicit class SVGAttributesOps[Self[t] <: SVGAttributes[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withAutoReverse(value: Booleanish): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withExternalResourcesRequired(value: Booleanish): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFocusable(value: Booleanish | auto): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreserveAlpha(value: Booleanish): Self[T] = {
        val ret = this.duplicate
