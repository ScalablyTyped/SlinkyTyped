...
trait TransitionEvent[T]
  extends BaseSyntheticEvent[org.scalajs.dom.raw.TransitionEvent, EventTarget with T, EventTarget] {
...
object TransitionEvent {
  ...
  @scala.inline
  implicit class TransitionEventOps[Self <: SyntheticTransitionEvent[_], T] (val x: Self with SyntheticTransitionEvent[T]) extends AnyVal {
    @scala.inline
