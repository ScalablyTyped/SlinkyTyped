...
trait ReactHTML extends js.Object {
  ...
  var webview: DetailedHTMLFactory[WebViewHTMLAttributes[HTMLElement], HTMLElement] = js.native
}
...
object ReactHTML {
  ...
  implicit class ReactHTMLOps[Self <: ReactHTML] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSlot(value: DetailedHTMLFactory[SlotHTMLAttributes[HTMLSlotElement], HTMLSlotElement]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWebview(value: DetailedHTMLFactory[WebViewHTMLAttributes[HTMLElement], HTMLElement]): Self = {
        val ret = this.duplicate
