...
object FocusEvent {
  ...
  def apply[T](
    ...
    __obj.asInstanceOf[SyntheticFocusEvent[T]]
  }
  
  @scala.inline
  implicit class FocusEventMutableBuilder[Self <: SyntheticFocusEvent[_], T] (val x: Self with SyntheticFocusEvent[T]) extends AnyVal {
