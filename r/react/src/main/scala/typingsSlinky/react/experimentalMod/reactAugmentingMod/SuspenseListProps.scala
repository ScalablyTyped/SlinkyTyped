...
object SuspenseListProps {
  @scala.inline
  implicit def apply(value: DirectionalSuspenseListProps): SuspenseListProps = value.asInstanceOf[SuspenseListProps]
  @scala.inline
  implicit def apply(value: NonDirectionalSuspenseListProps): SuspenseListProps = value.asInstanceOf[SuspenseListProps]
}
