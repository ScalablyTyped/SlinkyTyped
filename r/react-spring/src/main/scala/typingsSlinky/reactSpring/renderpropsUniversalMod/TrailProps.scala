...
object TrailProps {
  ...
  @scala.inline
  def apply[TItem, DS /* <: js.Object */](children: (TItem, Double) => SpringRendererFunc[DS], items: js.Array[TItem] | TItem): TrailProps[TItem, DS] = {
  ...
  @scala.inline
  implicit class TrailPropsOps[Self <: TrailProps[_, _], TItem, DS /* <: js.Object */] (val x: Self with (TrailProps[TItem, DS])) extends AnyVal {
