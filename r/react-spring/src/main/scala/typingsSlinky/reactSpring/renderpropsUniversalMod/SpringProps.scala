...
object SpringProps {
  ...
  @scala.inline
  def apply[DS /* <: js.Object */](): SpringProps[DS] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SpringProps[DS]]
  }
  
  @scala.inline
  implicit class SpringPropsOps[Self <: SpringProps[_], DS /* <: js.Object */] (val x: Self with SpringProps[DS]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: DS => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
