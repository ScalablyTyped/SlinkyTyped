...
@JSImport("react-spring/renderprops-konva", JSImport.Namespace)
@js.native
object renderpropsKonvaMod extends js.Object {
  ...
  type KonvaComponents = Pick[
    /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof konva */ js.Any, 
    /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof konva * / any ]: / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof konva * / any[K] extends react.react.ReactType<any>? K : never}[keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof konva * / any] */ js.Any
  ]
}
