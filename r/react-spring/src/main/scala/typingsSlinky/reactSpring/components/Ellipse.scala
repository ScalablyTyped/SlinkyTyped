...
import typingsSlinky.reactSpring.reactSpringStrings.ellipse
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.ellipse]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Ellipse {
  ...
  @JSImport("react-spring/renderprops", "animated.ellipse")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[ellipse]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Ellipse.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
