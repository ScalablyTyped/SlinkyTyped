...
import typingsSlinky.reactSpring.reactSpringStrings.tbody
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.tbody]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Tbody {
  ...
  @JSImport("react-spring/renderprops", "animated.tbody")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[tbody]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Tbody.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
