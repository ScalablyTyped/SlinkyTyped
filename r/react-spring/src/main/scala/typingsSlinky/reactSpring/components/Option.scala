...
import typingsSlinky.reactSpring.reactSpringStrings.option
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.option]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Option {
  ...
  @JSImport("react-spring/renderprops", "animated.option")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[option]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Option.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
