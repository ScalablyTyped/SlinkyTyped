...
import typingsSlinky.reactSpring.reactSpringStrings.li
...
object Li {
  @JSImport("react-spring/renderprops", "animated.li")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[li]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
