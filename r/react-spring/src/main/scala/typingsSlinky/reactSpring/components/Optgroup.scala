...
import typingsSlinky.reactSpring.reactSpringStrings.optgroup
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.optgroup]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Optgroup {
  ...
  @JSImport("react-spring/renderprops", "animated.optgroup")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[optgroup]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Optgroup.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
