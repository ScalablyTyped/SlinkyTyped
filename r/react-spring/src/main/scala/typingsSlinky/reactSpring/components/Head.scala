...
import typingsSlinky.reactSpring.reactSpringStrings.head
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.head]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Head {
  ...
  @JSImport("react-spring/renderprops", "animated.head")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[head]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
