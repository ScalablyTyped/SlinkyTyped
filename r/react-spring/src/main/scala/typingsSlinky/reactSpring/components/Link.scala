...
import typingsSlinky.reactSpring.reactSpringStrings.link
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.link]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Link {
  ...
  @JSImport("react-spring/renderprops", "animated.link")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[link]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
