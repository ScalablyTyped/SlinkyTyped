...
import typingsSlinky.reactSpring.reactSpringStrings.image
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.image]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Image {
  @JSImport("react-spring/renderprops", "animated.image")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[image]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
