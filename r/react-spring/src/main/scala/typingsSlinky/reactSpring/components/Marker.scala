...
import typingsSlinky.reactSpring.reactSpringStrings.marker
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.marker]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Marker {
  @JSImport("react-spring/renderprops", "animated.marker")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[marker]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Marker.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
