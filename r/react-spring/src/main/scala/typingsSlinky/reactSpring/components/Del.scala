...
import typingsSlinky.reactSpring.reactSpringStrings.del
...
object Del {
  ...
  @JSImport("react-spring/renderprops", "animated.del")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[del]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Del.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
