...
import typingsSlinky.reactSpring.reactSpringStrings.pre
...
object Pre {
  @JSImport("react-spring/renderprops", "animated.pre")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[pre]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Pre.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
