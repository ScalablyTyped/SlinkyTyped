...
import typingsSlinky.reactSpring.reactSpringStrings.animate
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.animate]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Animate {
  ...
  @JSImport("react-spring/renderprops", "animated.animate")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[animate]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Animate.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
