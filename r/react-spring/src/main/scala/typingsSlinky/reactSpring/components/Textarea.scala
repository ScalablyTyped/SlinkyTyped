...
import typingsSlinky.reactSpring.reactSpringStrings.textarea
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.textarea]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Textarea {
  ...
  @JSImport("react-spring/renderprops", "animated.textarea")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[textarea]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
