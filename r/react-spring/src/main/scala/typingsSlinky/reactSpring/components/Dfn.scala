...
import typingsSlinky.reactSpring.reactSpringStrings.dfn
...
object Dfn {
  @JSImport("react-spring/renderprops", "animated.dfn")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[dfn]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Dfn.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
