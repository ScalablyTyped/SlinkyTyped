...
import typingsSlinky.reactSpring.reactSpringStrings.body
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.body]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Body {
  @JSImport("react-spring/renderprops", "animated.body")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[body]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
