...
object Trail {
  ...
  @scala.inline
  class Builder[TItem, DS /* <: js.Object */] (val args: js.Array[js.Any])
    extends AnyVal
  ...
  def withProps[TItem, DS /* <: js.Object */](p: TrailProps[TItem, DS]): Builder[TItem, DS] = new Builder[TItem, DS](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply[TItem, DS /* <: js.Object */](children: (TItem, Double) => SpringRendererFunc[DS], items: js.Array[TItem] | TItem): Builder[TItem, DS] = {
