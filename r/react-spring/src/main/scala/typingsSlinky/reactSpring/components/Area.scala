...
import typingsSlinky.reactSpring.reactSpringStrings.area
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.area]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Area {
  ...
  @JSImport("react-spring/renderprops", "animated.area")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[area]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Area.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
