...
import typingsSlinky.reactSpring.reactSpringStrings.select
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.select]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Select {
  @JSImport("react-spring/renderprops", "animated.select")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[select]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
