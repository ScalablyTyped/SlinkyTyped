...
import typingsSlinky.reactSpring.reactSpringStrings.feOffset
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.feOffset]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object FeOffset {
  @JSImport("react-spring/renderprops", "animated.feOffset")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[feOffset]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FeOffset.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
