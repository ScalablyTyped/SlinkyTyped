...
import typingsSlinky.reactSpring.reactSpringStrings.td
...
{[ P in K ]: T[P]}
  * / typingsSlinky.std.stdStrings.Pick with js.Any)) with typingsSlinky.react.mod.RefAttributes[typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.td]] because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Td {
  @JSImport("react-spring/renderprops", "animated.td")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[td]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Td.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
