...
import typingsSlinky.reactSpring.reactSpringStrings.input
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.input]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Input {
  ...
  @JSImport("react-spring/renderprops", "animated.input")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[input]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
