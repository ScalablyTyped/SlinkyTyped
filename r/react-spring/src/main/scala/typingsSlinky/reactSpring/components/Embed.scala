...
import typingsSlinky.reactSpring.reactSpringStrings.embed
...
typingsSlinky.std.InstanceType[typingsSlinky.reactSpring.reactSpringStrings.embed]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object Embed {
  ...
  @JSImport("react-spring/renderprops", "animated.embed")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[embed]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
