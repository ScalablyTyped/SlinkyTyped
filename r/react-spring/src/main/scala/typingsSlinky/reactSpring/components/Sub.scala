...
import typingsSlinky.reactSpring.reactSpringStrings.sub
...
object Sub {
  @JSImport("react-spring/renderprops", "animated.sub")
  @js.native
  object component extends js.Object
  
  def apply(p: ComponentPropsWithRef[sub]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Sub.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
