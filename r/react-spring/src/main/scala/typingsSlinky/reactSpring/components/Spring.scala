...
object Spring {
  ...
  @scala.inline
  class Builder[/* <: js.Object */ DS] (val args: js.Array[js.Any])
    extends AnyVal
  ...
  def withProps[/* <: js.Object */ DS](p: SpringProps[DS]): Builder[DS] = new Builder[DS](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[/* <: js.Object */ DS](): Builder[DS] = {
    val __props = js.Dynamic.literal()
    new Builder[DS](js.Array(this.component, __props.asInstanceOf[SpringProps[DS]]))
  }
  implicit def make[/* <: js.Object */ DS](companion: Spring.type): Builder[DS] = new Builder[DS](js.Array(this.component, js.Dictionary.empty))()
}
