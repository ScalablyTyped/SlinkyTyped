...
@JSImport("react-spring/renderprops-universal.cjs", JSImport.Namespace)
@js.native
object renderpropsUniversalCjsMod extends js.Object {
  @js.native
  class Keyframes[S /* <: js.Object */, DS /* <: js.Object */] ()
    extends typingsSlinky.reactSpring.renderpropsUniversalMod.Keyframes[S, DS]
