...
object UseTransitionResult {
  ...
  @scala.inline
  def apply[TItem, DS /* <: js.Object */](item: TItem, key: String, props: AnimatedValue[ForwardedProps[DS]], state: State): UseTransitionResult[TItem, DS] = {
  ...
  @scala.inline
  implicit class UseTransitionResultOps[Self <: UseTransitionResult[_, _], TItem, DS /* <: js.Object */] (val x: Self with (UseTransitionResult[TItem, DS])) extends AnyVal {
