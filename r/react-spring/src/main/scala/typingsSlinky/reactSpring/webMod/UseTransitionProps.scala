...
object UseTransitionProps {
  ...
  @scala.inline
  def apply[TItem, DS /* <: js.Object */](): UseTransitionProps[TItem, DS] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UseTransitionProps[TItem, DS]]
  }
  
  @scala.inline
  implicit class UseTransitionPropsOps[Self <: UseTransitionProps[_, _], TItem, DS /* <: js.Object */] (val x: Self with (UseTransitionProps[TItem, DS])) extends AnyVal {
