...
import typingsSlinky.reactSpring.webMod.InferFrom
...
object From {
  ...
  @scala.inline
  def apply[DS /* <: js.Object */](): From[DS] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[From[DS]]
  }
  
  @scala.inline
  implicit class FromOps[Self <: From[_], DS /* <: js.Object */] (val x: Self with From[DS]) extends AnyVal {
