package typingsSlinky.reactMaskedinput.components
...
import typingsSlinky.reactMaskedinput.mod.CharsFormatters
import typingsSlinky.reactMaskedinput.mod.MaskedInputProps
import typingsSlinky.reactMaskedinput.mod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactMaskedinput {
  
  @scala.inline
  def apply(mask: String): Builder = {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def formatCharacters(value: CharsFormatters): this.type = set("formatCharacters", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: ChangeEvent[js.Any] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def placeholderChar(value: String): this.type = set("placeholderChar", value.asInstanceOf[js.Any])
