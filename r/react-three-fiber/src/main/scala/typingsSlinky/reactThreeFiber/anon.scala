...
import typingsSlinky.reactThreeFiber.canvasMod.ComputeOffsetsFunction
import typingsSlinky.reactThreeFiber.canvasMod.DomEvent
import typingsSlinky.reactThreeFiber.canvasMod.FilterFunction
import typingsSlinky.reactThreeFiber.canvasMod.Intersection
import typingsSlinky.reactThreeFiber.canvasMod.SharedCanvasContext
import typingsSlinky.reactThreeFiber.threeTypesMod.Euler
import typingsSlinky.reactThreeFiber.threeTypesMod.Layers
import typingsSlinky.reactThreeFiber.threeTypesMod.Matrix4
import typingsSlinky.reactThreeFiber.threeTypesMod.Quaternion
...
import typingsSlinky.three.raycasterMod.RaycasterParameters
...
object anon {
  ...
  trait Camera[T] extends StObject {
    ...
    var camera: typingsSlinky.reactThreeFiber.canvasMod.Camera = js.native
  ...
  object Camera {
    ...
    implicit class CameraMutableBuilder[Self <: Camera[_], T] (val x: Self with Camera[T]) extends AnyVal {
      ...
      @scala.inline
      def setCamera(value: typingsSlinky.reactThreeFiber.canvasMod.Camera): Self = StObject.set(x, "camera", value.asInstanceOf[js.Any])
  ...
  trait Color extends StObject {
    ...
    var color: js.UndefOr[typingsSlinky.reactThreeFiber.threeTypesMod.Color] = js.native
  }
  object Color {
    ...
    implicit class ColorMutableBuilder[Self <: Color] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: typingsSlinky.reactThreeFiber.threeTypesMod.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
  ...
  trait Dispose extends StObject {
    ...
    var position: js.UndefOr[typingsSlinky.reactThreeFiber.threeTypesMod.Vector3] = js.native
    
    var quaternion: js.UndefOr[Quaternion] = js.native
    
    var rotation: js.UndefOr[Euler] = js.native
    
    var scale: js.UndefOr[typingsSlinky.reactThreeFiber.threeTypesMod.Vector3] = js.native
    
    var up: js.UndefOr[typingsSlinky.reactThreeFiber.threeTypesMod.Vector3] = js.native
  }
  object Dispose {
    ...
    implicit class DisposeMutableBuilder[Self <: Dispose] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPosition(value: typingsSlinky.reactThreeFiber.threeTypesMod.Vector3): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setScale(value: typingsSlinky.reactThreeFiber.threeTypesMod.Vector3): Self = StObject.set(x, "scale", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScaleUndefined: Self = StObject.set(x, "scale", js.undefined)
      
      @scala.inline
      def setUp(value: typingsSlinky.reactThreeFiber.threeTypesMod.Vector3): Self = StObject.set(x, "up", value.asInstanceOf[js.Any])
  ...
  trait FnCall extends StObject {
    ...
    def apply(x: Double, y: Double, z: Double): typingsSlinky.three.eulerMod.Euler = js.native
    def apply(x: Double, y: Double, z: Double, order: String): typingsSlinky.three.eulerMod.Euler = js.native
  }
  ...
  trait PartialRaycasterfilterFil extends StObject {
    ...
    var camera: js.UndefOr[typingsSlinky.three.cameraMod.Camera] = js.native
    ...
    var intersectObject: js.UndefOr[
        js.Function1[/* object */ Object3D, js.Array[typingsSlinky.three.raycasterMod.Intersection]]
      ] = js.native
    ...
    var layers: js.UndefOr[typingsSlinky.three.layersMod.Layers] = js.native
    
    var near: js.UndefOr[Double] = js.native
    
    var params: js.UndefOr[RaycasterParameters] = js.native
    
    var ray: js.UndefOr[typingsSlinky.three.rayMod.Ray] = js.native
    
    var set: js.UndefOr[
        js.Function2[
          /* origin */ typingsSlinky.three.vector3Mod.Vector3, 
          /* direction */ typingsSlinky.three.vector3Mod.Vector3, 
          Unit
        ]
      ] = js.native
    
    var setFromCamera: js.UndefOr[
        js.Function2[/* coords */ X, /* camera */ typingsSlinky.three.cameraMod.Camera, Unit]
      ] = js.native
  }
  object PartialRaycasterfilterFil {
    ...
    implicit class PartialRaycasterfilterFilMutableBuilder[Self <: PartialRaycasterfilterFil] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCamera(value: typingsSlinky.three.cameraMod.Camera): Self = StObject.set(x, "camera", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFilter(
        value: (/* items */ js.Array[typingsSlinky.three.raycasterMod.Intersection], /* state */ SharedCanvasContext) => js.Array[typingsSlinky.three.raycasterMod.Intersection]
      ...
      @scala.inline
      def setIntersectObject(value: /* object */ Object3D => js.Array[typingsSlinky.three.raycasterMod.Intersection]): Self = StObject.set(x, "intersectObject", js.Any.fromFunction1(value))
      
      @scala.inline
      def setIntersectObjectUndefined: Self = StObject.set(x, "intersectObject", js.undefined)
      
      @scala.inline
      def setIntersectObjects(value: /* objects */ js.Array[Object3D] => js.Array[typingsSlinky.three.raycasterMod.Intersection]): Self = StObject.set(x, "intersectObjects", js.Any.fromFunction1(value))
      
      @scala.inline
      def setIntersectObjectsUndefined: Self = StObject.set(x, "intersectObjects", js.undefined)
      
      @scala.inline
      def setLayers(value: typingsSlinky.three.layersMod.Layers): Self = StObject.set(x, "layers", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRay(value: typingsSlinky.three.rayMod.Ray): Self = StObject.set(x, "ray", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSet(
        value: (/* origin */ typingsSlinky.three.vector3Mod.Vector3, /* direction */ typingsSlinky.three.vector3Mod.Vector3) => Unit
      ): Self = StObject.set(x, "set", js.Any.fromFunction2(value))
      
      @scala.inline
      def setSetFromCamera(value: (/* coords */ X, /* camera */ typingsSlinky.three.cameraMod.Camera) => Unit): Self = StObject.set(x, "setFromCamera", js.Any.fromFunction2(value))
  ...
  trait PartialWebGLShadowMap extends StObject {
    ...
    var render: js.UndefOr[
        js.Function3[
          ...
          /* scene */ Scene, 
          /* camera */ typingsSlinky.three.cameraMod.Camera, 
          Unit
        ]
      ] = js.native
  ...
  object PartialWebGLShadowMap {
    ...
    implicit class PartialWebGLShadowMapMutableBuilder[Self <: PartialWebGLShadowMap] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRender(
        value: (/* shadowsArray */ js.Array[Light], /* scene */ Scene, /* camera */ typingsSlinky.three.cameraMod.Camera) => Unit
  ...
  @js.native
  trait TypeofColor
    extends Instantiable0[typingsSlinky.three.mod.Color] {
  ...
  @js.native
  trait TypeofEuler
    extends Instantiable0[typingsSlinky.three.mod.Euler] {
  ...
  trait TypeofQuaternion
    extends Instantiable0[typingsSlinky.three.mod.Quaternion] {
  ...
  trait Vertices extends StObject {
    ...
    var vertices: js.UndefOr[js.Array[typingsSlinky.reactThreeFiber.threeTypesMod.Vector3]] = js.native
  }
  object Vertices {
    ...
    implicit class VerticesMutableBuilder[Self <: Vertices] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setVertices(value: js.Array[typingsSlinky.reactThreeFiber.threeTypesMod.Vector3]): Self = StObject.set(x, "vertices", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVerticesUndefined: Self = StObject.set(x, "vertices", js.undefined)
      
      @scala.inline
      def setVerticesVarargs(value: typingsSlinky.reactThreeFiber.threeTypesMod.Vector3*): Self = StObject.set(x, "vertices", js.Array(value :_*))
    }
  }
}
