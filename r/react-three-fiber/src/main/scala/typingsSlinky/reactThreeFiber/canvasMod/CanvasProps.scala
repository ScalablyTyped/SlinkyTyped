...
trait CanvasProps extends js.Object {
  ...
  var camera: js.UndefOr[
    Partial[
      (Object3DNode[typingsSlinky.three.mod.Camera, Instantiable0[typingsSlinky.three.mod.Camera]]) with (Object3DNode[PerspectiveCamera, Instantiable0[PerspectiveCamera]]) with (Object3DNode[
        OrthographicCamera, 
        Instantiable4[
          /* left */ Double, 
          /* right */ Double, 
