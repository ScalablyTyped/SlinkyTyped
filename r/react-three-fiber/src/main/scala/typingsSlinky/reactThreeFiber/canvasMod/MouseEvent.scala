...
object MouseEvent {
  ...
  implicit class MouseEventOps[Self <: MouseEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNativeEvent(value: org.scalajs.dom.raw.MouseEvent): Self = this.set("nativeEvent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceEvent(value: SyntheticMouseEvent[Element]): Self = this.set("sourceEvent", value.asInstanceOf[js.Any])
