...
trait WheelEvent extends DomEvent {
  ...
  var nativeEvent: org.scalajs.dom.raw.WheelEvent = js.native
  ...
  var sourceEvent: SyntheticWheelEvent[Element] = js.native
...
object WheelEvent {
  ...
  implicit class WheelEventOps[Self <: WheelEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNativeEvent(value: org.scalajs.dom.raw.WheelEvent): Self = this.set("nativeEvent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceEvent(value: SyntheticWheelEvent[Element]): Self = this.set("sourceEvent", value.asInstanceOf[js.Any])
