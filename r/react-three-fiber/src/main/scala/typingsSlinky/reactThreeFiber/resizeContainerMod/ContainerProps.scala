package typingsSlinky.reactThreeFiber.resizeContainerMod
...
import typingsSlinky.reactThreeFiber.anon.PartialRaycasterfilterFil
import typingsSlinky.reactThreeFiber.anon.PartialWebGLRendererParam
import typingsSlinky.reactThreeFiber.anon.PartialWebGLShadowMap
import typingsSlinky.reactThreeFiber.canvasMod.CanvasContext
import typingsSlinky.reactThreeFiber.canvasMod.ResizeOptions
import typingsSlinky.reactThreeFiber.threeTypesMod.Object3DNode
...
- typingsSlinky.reactThreeFiber.canvasMod.CanvasProps because var conflicts: children. Inlined vr, webgl1, concurrent, shadowMap, colorManagement, orthographic, resize, invalidateFrameloop, updateDefaultCamera, noEvents, gl, camera, raycaster, pixelRatio, onCreated, onPointerMissed */ @js.native
trait ContainerProps extends HTMLAttributes[HTMLDivElement] {
  ...
  @JSName("children")
  var children_ContainerProps: ReactElement = js.native
