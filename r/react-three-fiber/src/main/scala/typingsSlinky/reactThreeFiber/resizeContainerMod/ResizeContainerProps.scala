...
trait ResizeContainerProps extends ContainerProps {
  ...
  var preRender: js.UndefOr[ReactElement] = js.native
...
object ResizeContainerProps {
  ...
  implicit class ResizeContainerPropsOps[Self <: ResizeContainerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreRenderReactElement(value: ReactElement): Self = this.set("preRender", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreRender(value: ReactElement): Self = this.set("preRender", value.asInstanceOf[js.Any])
