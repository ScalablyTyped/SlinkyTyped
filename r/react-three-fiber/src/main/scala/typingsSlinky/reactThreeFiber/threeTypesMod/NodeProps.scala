...
object NodeProps {
  ...
  implicit class NodePropsOps[Self <: NodeProps[_, _], T, P] (val x: Self with (NodeProps[T, P])) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[ReactElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ ReactElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: Ref[ReactElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
