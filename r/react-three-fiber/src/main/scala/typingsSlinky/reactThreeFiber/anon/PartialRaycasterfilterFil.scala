...
object PartialRaycasterfilterFil {
  ...
  implicit class PartialRaycasterfilterFilOps[Self <: PartialRaycasterfilterFil] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCamera(value: typingsSlinky.three.cameraMod.Camera): Self = this.set("camera", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSetFromCamera(value: (/* coords */ X, /* camera */ typingsSlinky.three.cameraMod.Camera) => Unit): Self = this.set("setFromCamera", js.Any.fromFunction2(value))
