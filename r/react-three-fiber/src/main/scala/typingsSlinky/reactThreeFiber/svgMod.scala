...
object svgMod {
  ...
  @JSImport("react-three-fiber/targets/svg", "createPortal")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "extend")
  @js.native
  def extend(objects: js.Object): Unit = js.native
  
  @JSImport("react-three-fiber/targets/svg", "forceResize")
  @js.native
  def forceResize(): Unit = js.native
  
  @JSImport("react-three-fiber/targets/svg", "invalidate")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "isOrthographicCamera")
  @js.native
  def isOrthographicCamera(`def`: Camera): /* is three.three.OrthographicCamera */ Boolean = js.native
  
  @JSImport("react-three-fiber/targets/svg", "render")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "renderGl")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "unmountComponentAtNode")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "useCanvas")
  @js.native
  def useCanvas(props: UseCanvasProps): DomEventHandlers = js.native
  
  @JSImport("react-three-fiber/targets/svg", "useFrame")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "useGraph")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "useResource")
  @js.native
  ...
  @JSImport("react-three-fiber/targets/svg", "useThree")
  @js.native
  def useThree(): SharedCanvasContext = js.native
  
  @JSImport("react-three-fiber/targets/svg", "useUpdate")
  @js.native
