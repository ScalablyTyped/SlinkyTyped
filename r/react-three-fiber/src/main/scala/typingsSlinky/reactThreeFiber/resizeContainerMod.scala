...
object resizeContainerMod {
  ...
  trait Renderer extends StObject {
    ...
    var render: js.Function2[/* scene */ Object3D, /* camera */ typingsSlinky.three.cameraMod.Camera, Unit] = js.native
  ...
  object Renderer {
    ...
    @scala.inline
    def apply(
      render: (/* scene */ Object3D, /* camera */ typingsSlinky.three.cameraMod.Camera) => Unit,
    ...
    implicit class RendererMutableBuilder[Self <: Renderer] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRender(value: (/* scene */ Object3D, /* camera */ typingsSlinky.three.cameraMod.Camera) => Unit): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
  ...
  object ResizeContainerProps {
    ...
    implicit class ResizeContainerPropsMutableBuilder[Self <: ResizeContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPreRender(value: ReactElement): Self = StObject.set(x, "preRender", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreRenderReactElement(value: ReactElement): Self = StObject.set(x, "preRender", value.asInstanceOf[js.Any])
