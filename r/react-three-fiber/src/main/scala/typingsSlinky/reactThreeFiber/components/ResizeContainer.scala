...
import typingsSlinky.reactThreeFiber.resizeContainerMod.Renderer
...
object ResizeContainer {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def colorManagement(value: Boolean): this.type = set("colorManagement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def concurrent(value: Boolean): this.type = set("concurrent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def effects(value: (/* renderer */ js.Any, /* parent */ HTMLDivElement) => js.Function0[_]): this.type = set("effects", js.Any.fromFunction2(value))
    
    @scala.inline
    def gl(value: PartialWebGLRendererParam): this.type = set("gl", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def invalidateFrameloop(value: Boolean): this.type = set("invalidateFrameloop", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def noEvents(value: Boolean): this.type = set("noEvents", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onCreated(value: /* props */ CanvasContext => js.Promise[_] | Unit): this.type = set("onCreated", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onPointerMissed(value: () => Unit): this.type = set("onPointerMissed", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def orthographic(value: Boolean): this.type = set("orthographic", value.asInstanceOf[js.Any])
    
    @scala.inline
    def pixelRatio(value: Double | (js.Tuple2[Double, Double])): this.type = set("pixelRatio", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def raycaster(value: PartialRaycasterfilterFil): this.type = set("raycaster", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def shadowMap(value: Boolean | PartialWebGLShadowMap): this.type = set("shadowMap", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def updateDefaultCamera(value: Boolean): this.type = set("updateDefaultCamera", value.asInstanceOf[js.Any])
    
    @scala.inline
    def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
    
    @scala.inline
    def vr(value: Boolean): this.type = set("vr", value.asInstanceOf[js.Any])
    
    @scala.inline
    def webgl1(value: Boolean): this.type = set("webgl1", value.asInstanceOf[js.Any])
  }
