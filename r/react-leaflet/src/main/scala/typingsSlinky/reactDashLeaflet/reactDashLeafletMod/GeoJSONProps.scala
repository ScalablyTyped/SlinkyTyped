...
import typingsSlinky.leaflet.leafletMod.StyleFunction
...
- typings.reactDashLeaflet.reactDashLeafletMod.MapLayerProps because var conflicts: attribution, pane. Inlined children */ trait GeoJSONProps
  ...
  var coordsToLatLng: js.UndefOr[
    js.Function1[
      ...
      typingsSlinky.leaflet.leafletMod.LatLng
    ]
  ] = js.undefined
  ...
  var pointToLayer: js.UndefOr[
    js.Function2[
      /* geoJsonPoint */ Feature[typingsSlinky.geojson.geojsonMod.Point, js.Any], 
      /* latlng */ typingsSlinky.leaflet.leafletMod.LatLng, 
      Layer
    ]
  ] = js.undefined
...
object GeoJSONProps {
  ...
  def apply(
    ...
    color: String = null,
    coordsToLatLng: /* coords */ (js.Tuple2[Double, Double]) | (js.Tuple3[Double, Double, Double]) => typingsSlinky.leaflet.leafletMod.LatLng = null,
    ...
    pane: String = null,
    pointToLayer: (/* geoJsonPoint */ Feature[typingsSlinky.geojson.geojsonMod.Point, js.Any], /* latlng */ typingsSlinky.leaflet.leafletMod.LatLng) => Layer = null,
