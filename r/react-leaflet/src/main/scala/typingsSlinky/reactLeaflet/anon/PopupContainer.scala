...
object PopupContainer {
  @scala.inline
  def apply[/* <: typingsSlinky.leaflet.mod.Path */ E](popupContainer: E): PopupContainer[E] = {
    val __obj = js.Dynamic.literal(popupContainer = popupContainer.asInstanceOf[js.Any])
    __obj.asInstanceOf[PopupContainer[E]]
  }
  @scala.inline
  implicit class PopupContainerOps[Self <: PopupContainer[_], /* <: typingsSlinky.leaflet.mod.Path */ E] (val x: Self with PopupContainer[E]) extends AnyVal {
    @scala.inline
