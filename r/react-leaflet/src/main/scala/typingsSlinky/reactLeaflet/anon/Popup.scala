...
object Popup {
  @scala.inline
  def apply[/* <: typingsSlinky.leaflet.mod.Popup_ */ E](popup: E): Popup[E] = {
    val __obj = js.Dynamic.literal(popup = popup.asInstanceOf[js.Any])
    __obj.asInstanceOf[Popup[E]]
  }
  @scala.inline
  implicit class PopupOps[Self <: Popup[_], /* <: typingsSlinky.leaflet.mod.Popup_ */ E] (val x: Self with Popup[E]) extends AnyVal {
    @scala.inline
