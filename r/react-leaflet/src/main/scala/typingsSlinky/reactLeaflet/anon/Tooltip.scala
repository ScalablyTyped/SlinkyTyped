...
object Tooltip {
  @scala.inline
  def apply[/* <: typingsSlinky.leaflet.mod.Tooltip_ */ E](tooltip: E): Tooltip[E] = {
    val __obj = js.Dynamic.literal(tooltip = tooltip.asInstanceOf[js.Any])
    __obj.asInstanceOf[Tooltip[E]]
  }
  @scala.inline
  implicit class TooltipOps[Self <: Tooltip[_], /* <: typingsSlinky.leaflet.mod.Tooltip_ */ E] (val x: Self with Tooltip[E]) extends AnyVal {
    @scala.inline
