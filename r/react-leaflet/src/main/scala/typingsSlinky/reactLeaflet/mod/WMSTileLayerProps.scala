...
import typingsSlinky.leaflet.mod.WMSOptions
...
- typingsSlinky.reactLeaflet.mod.MapLayerProps because var conflicts: attribution, pane. Inlined children */ trait WMSTileLayerProps
  extends WMSOptions
