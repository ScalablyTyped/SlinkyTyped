...
- typingsSlinky.leaflet.mod.GridLayerOptions because var conflicts: attribution, pane. Inlined maxZoom, tileSize, updateWhenIdle, bounds, minZoom, noWrap, updateWhenZooming, className, zIndex, opacity, keepBuffer, updateInterval */ @js.native
