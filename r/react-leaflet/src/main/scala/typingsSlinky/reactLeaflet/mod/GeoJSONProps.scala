...
- typingsSlinky.reactLeaflet.mod.MapLayerProps because var conflicts: attribution, pane. Inlined children */ trait GeoJSONProps
  extends PathOptions
     with PathEvents {
...
object GeoJSONProps {
  ...
  def apply(
    ...
    pane: String = null,
    pointToLayer: (/* geoJsonPoint */ Feature[typingsSlinky.geojson.mod.Point, js.Any], /* latlng */ LatLng_) => Layer = null,
