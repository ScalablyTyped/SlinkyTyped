...
- typingsSlinky.leaflet.mod.GeoJSONOptions because var conflicts: attribution, pane. Inlined style, pointToLayer, onEachFeature, coordsToLatLng, filter
- typingsSlinky.reactLeaflet.mod.FeatureGroupEvents because var conflicts: onclick, oncontextmenu, ondblclick, onmouseout, onmouseover. Inlined onlayeradd, onlayerremove */ @js.native
