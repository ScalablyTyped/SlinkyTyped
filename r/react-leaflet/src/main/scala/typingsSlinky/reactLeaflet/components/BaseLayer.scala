...
object BaseLayer {
  ...
  implicit def make[/* <: typingsSlinky.reactLeaflet.mod.LayersControl.ControlledLayerProps */ P](companion: BaseLayer.type): Builder[P] = new Builder[P](js.Array(this.component, js.Dictionary.empty))()
}
