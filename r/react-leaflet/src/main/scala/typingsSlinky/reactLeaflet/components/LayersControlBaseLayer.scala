...
import typingsSlinky.reactLeaflet.mod.LayersControl.BaseLayer
...
object LayersControlBaseLayer {
  ...
  class Builder[P <: ControlledLayerProps] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, BaseLayer[js.Any]]
  
  def apply[P <: ControlledLayerProps](p: P): Builder[P] = new Builder[P](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make[P <: ControlledLayerProps](companion: LayersControlBaseLayer.type): Builder[P] = new Builder[P](js.Array(this.component, js.Dictionary.empty))()
}
