...
import typingsSlinky.reactLeaflet.mod.ScaleControlProps
...
object ScaleControl {
  ...
  @scala.inline
  class Builder[P <: ScaleControlProps, E <: Scale] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactLeaflet.mod.ScaleControl[js.Any, js.Any]]
