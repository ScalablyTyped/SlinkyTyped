...
trait ListItemLayoutProps extends Props {
  ...
  /**
    ...
    */
  var leftActions: js.UndefOr[js.Array[ReactElement]] = js.native
  /**
  ...
  /**
    ...
    */
  var rightActions: js.UndefOr[js.Array[ReactElement]] = js.native
  /**
...
object ListItemLayoutProps {
  ...
  implicit class ListItemLayoutPropsOps[Self <: ListItemLayoutProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemContentReactElement(value: ReactElement): Self = this.set("itemContent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLeftActionsVarargs(value: ReactElement*): Self = this.set("leftActions", js.Array(value :_*))
    @scala.inline
    def setLeftActions(value: js.Array[ReactElement]): Self = this.set("leftActions", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRightActionsVarargs(value: ReactElement*): Self = this.set("rightActions", js.Array(value :_*))
    @scala.inline
    def setRightActions(value: js.Array[ReactElement]): Self = this.set("rightActions", value.asInstanceOf[js.Any])
    @scala.inline
