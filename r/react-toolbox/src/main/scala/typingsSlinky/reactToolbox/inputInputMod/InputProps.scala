...
object InputProps {
  ...
  implicit class InputPropsOps[Self <: InputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHintReactElement(value: ReactElement): Self = this.set("hint", value.asInstanceOf[js.Any])
    @scala.inline
    def setHint(value: ReactElement): Self = this.set("hint", value.asInstanceOf[js.Any])
    @scala.inline
