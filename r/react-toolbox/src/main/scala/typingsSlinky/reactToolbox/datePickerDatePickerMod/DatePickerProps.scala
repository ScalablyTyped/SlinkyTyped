...
object DatePickerProps {
  ...
  implicit class DatePickerPropsOps[Self <: DatePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisabledDates(value: js.Array[js.Date]): Self = this.set("disabledDates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDisabledDates: Self = this.set("disabledDates", js.undefined)
    
    @scala.inline
    def setEnabledDatesVarargs(value: js.Date*): Self = this.set("enabledDates", js.Array(value :_*))
    
    @scala.inline
    def setEnabledDates(value: js.Array[js.Date]): Self = this.set("enabledDates", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValue(value: js.Date | String): Self = this.set("value", value.asInstanceOf[js.Any])
