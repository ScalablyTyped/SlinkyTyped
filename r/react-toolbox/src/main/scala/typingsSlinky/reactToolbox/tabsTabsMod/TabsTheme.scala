package typingsSlinky.reactToolbox.tabsTabsMod
...
- typingsSlinky.reactToolbox.tabContentMod.TabContentTheme because var conflicts: active. Inlined tab */ trait TabsTheme extends TabTheme {
  /**
