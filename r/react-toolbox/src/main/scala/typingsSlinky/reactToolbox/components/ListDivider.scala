...
object ListDivider {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def theme(value: ListDividerTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: ListDividerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
