...
import typingsSlinky.reactToolbox.tableHeadMod.TableHeadProps
import typingsSlinky.reactToolbox.tableHeadMod.TableHeadTheme
...
object TableHead {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactToolbox.tableMod.TableHead] {
    @scala.inline
    def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    @scala.inline
    def displaySelect(value: Boolean): this.type = set("displaySelect", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: TableHeadTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
