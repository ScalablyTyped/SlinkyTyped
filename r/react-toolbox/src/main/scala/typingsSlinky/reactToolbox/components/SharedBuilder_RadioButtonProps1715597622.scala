...
@scala.inline
class SharedBuilder_RadioButtonProps1715597622[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def theme(value: RadioButtonTheme with RadioTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  @scala.inline
