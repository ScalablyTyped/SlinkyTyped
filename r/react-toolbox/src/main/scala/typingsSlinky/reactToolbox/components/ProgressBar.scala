...
object ProgressBar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def multicolor(value: Boolean): this.type = set("multicolor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: ProgressBarTheme): this.type = set("theme", value.asInstanceOf[js.Any])
    @scala.inline
    def `type`(value: linear | circular): this.type = set("type", value.asInstanceOf[js.Any])
    @scala.inline
