...
object Chip {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def deletable(value: Boolean): this.type = set("deletable", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onDeleteClick(value: js.Function): this.type = set("onDeleteClick", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: ChipTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
