...
object Dropdown {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def allowBlank(value: Boolean): this.type = set("allowBlank", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def template(value: js.Function): this.type = set("template", value.asInstanceOf[js.Any])
    @scala.inline
    def theme(value: DropdownTheme): this.type = set("theme", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  @scala.inline
  def apply(source: js.Array[_]): Builder = {
