...
object Slider {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onDragStop(value: js.Function): this.type = set("onDragStop", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: SliderTheme): this.type = set("theme", value.asInstanceOf[js.Any])
    @scala.inline
