...
import typingsSlinky.reactToolbox.tabMod.TabProps
import typingsSlinky.reactToolbox.tabMod.TabTheme
...
object Tab {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactToolbox.tabsMod.Tab] {
    @scala.inline
    ...
    @scala.inline
    def onActive(value: js.Function): this.type = set("onActive", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: TabTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
