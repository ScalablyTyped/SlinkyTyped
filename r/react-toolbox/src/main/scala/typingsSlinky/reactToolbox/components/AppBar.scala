...
object AppBar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onLeftIconClick(value: js.Function): this.type = set("onLeftIconClick", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onRightIconClick(value: js.Function): this.type = set("onRightIconClick", value.asInstanceOf[js.Any])
    @scala.inline
