...
import typingsSlinky.reactToolbox.libTabsTabsMod.TabsProps
import typingsSlinky.reactToolbox.libTabsTabsMod.TabsTheme
import typingsSlinky.reactToolbox.libTabsTabsMod.default
...
object Tabs {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableAnimatedBottomBorder(value: Boolean): this.type = set("disableAnimatedBottomBorder", value.asInstanceOf[js.Any])
    @scala.inline
    def fixed(value: Boolean): this.type = set("fixed", value.asInstanceOf[js.Any])
    @scala.inline
    def hideMode(value: display | unmounted): this.type = set("hideMode", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: TabsTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
