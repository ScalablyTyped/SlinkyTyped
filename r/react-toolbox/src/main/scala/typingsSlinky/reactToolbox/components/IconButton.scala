...
object IconButton
  ...
  /* The following DOM/SVG props were specified: className, disabled, href, style, type */
  def apply(
  ...
  typingsSlinky.reactToolbox.buttonIconButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
