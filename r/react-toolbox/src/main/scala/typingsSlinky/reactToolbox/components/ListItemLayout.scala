...
object ListItemLayout
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactToolbox.libListMod.ListItemLayout] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactToolbox.libListMod.ListItemLayout] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactToolbox.libListMod.ListItemLayout] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactToolbox.libListMod.ListItemLayout](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
