...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onRippleEnded(value: js.Function): this.type = set("onRippleEnded", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def spread(value: Double): this.type = set("spread", value.asInstanceOf[js.Any])
    @scala.inline
    def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    @scala.inline
    def target(value: String): this.type = set("target", value.asInstanceOf[js.Any])
    @scala.inline
    def theme(value: ButtonTheme | RippleTheme): this.type = set("theme", value.asInstanceOf[js.Any])
    @scala.inline
