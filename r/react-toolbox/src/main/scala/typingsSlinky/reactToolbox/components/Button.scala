...
import typingsSlinky.reactToolbox.libButtonMod.default
...
object Button
  ...
  /* The following DOM/SVG props were specified: className, disabled, href, label, style, target, type */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactToolbox.libButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
