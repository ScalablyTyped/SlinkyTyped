...
object Table {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onRowSelect(value: js.Function): this.type = set("onRowSelect", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: TableTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
