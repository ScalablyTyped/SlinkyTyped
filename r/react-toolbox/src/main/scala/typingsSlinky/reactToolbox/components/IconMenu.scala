...
object IconMenu
  ...
  def apply(
    ...
    if (!js.isUndefined(iconRipple)) __obj.updateDynamic("iconRipple")(iconRipple.asInstanceOf[js.Any])
    if (!js.isUndefined(inverse)) __obj.updateDynamic("inverse")(inverse.asInstanceOf[js.Any])
    if (!js.isUndefined(menuRipple)) __obj.updateDynamic("menuRipple")(menuRipple.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactToolbox.menuIconMenuMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
