...
import typingsSlinky.reactToolbox.buttonBrowseButtonMod.BrowseButtonTheme
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object BrowseButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactToolbox.libButtonMod.BrowseButton] {
  @JSImport("react-toolbox/lib/button", "BrowseButton")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: className, disabled, href, label, style, type */
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactToolbox.libButtonMod.BrowseButton] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactToolbox.libButtonMod.BrowseButton] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactToolbox.libButtonMod.BrowseButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
