...
object Autocomplete
  ...
  /* The following DOM/SVG props were specified: className, disabled, multiple, name, required, rows, style, type */
  def apply(
  ...
  typingsSlinky.reactToolbox.libAutocompleteMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
