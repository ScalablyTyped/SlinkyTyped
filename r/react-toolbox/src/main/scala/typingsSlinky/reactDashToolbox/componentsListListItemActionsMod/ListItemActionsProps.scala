package typingsSlinky.reactDashToolbox.componentsListListItemActionsMod

import slinky.core.TagMod
import typingsSlinky.reactDashToolbox.componentsListListItemActionMod.ListItemActionTheme
