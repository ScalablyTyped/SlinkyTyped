package typingsSlinky.reactDashToolbox.componentsCardCardMediaMod
...
import typingsSlinky.reactDashToolbox.reactDashToolboxStrings.square
import typingsSlinky.reactDashToolbox.reactDashToolboxStrings.wide
