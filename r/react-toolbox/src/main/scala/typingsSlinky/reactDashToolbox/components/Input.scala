...
import typingsSlinky.reactDashToolbox.libInputInputMod.InputProps
import typingsSlinky.reactDashToolbox.libInputInputMod.InputTheme
import typingsSlinky.reactDashToolbox.libInputMod.default
...
object Input
  ...
  /* The following DOM/SVG props were specified: className, disabled, name, required, rows, type */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashToolbox.libInputMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
