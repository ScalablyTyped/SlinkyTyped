...
import typingsSlinky.reactDashToolbox.libSliderMod.default
import typingsSlinky.reactDashToolbox.libSliderSliderMod.SliderProps
import typingsSlinky.reactDashToolbox.libSliderSliderMod.SliderTheme
...
object Slider
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashToolbox.libSliderMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
