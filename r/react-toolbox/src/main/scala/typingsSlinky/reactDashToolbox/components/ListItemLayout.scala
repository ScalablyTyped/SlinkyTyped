...
import typingsSlinky.reactDashToolbox.libListListItemLayoutMod.ListItemLayoutTheme
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ListItemLayout
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashToolbox.libListMod.ListItemLayout] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashToolbox.libListMod.ListItemLayout] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashToolbox.libListMod.ListItemLayout] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashToolbox.libListMod.ListItemLayout](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ListItemLayoutProps
}
