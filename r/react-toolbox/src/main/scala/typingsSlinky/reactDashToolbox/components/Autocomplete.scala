...
import typingsSlinky.reactDashToolbox.libAutocompleteAutocompleteMod.AutocompleteProps
import typingsSlinky.reactDashToolbox.libAutocompleteAutocompleteMod.AutocompleteTheme
import typingsSlinky.reactDashToolbox.libAutocompleteMod.default
...
object Autocomplete
  ...
  /* The following DOM/SVG props were specified: className, disabled, multiple, name, required, rows, type */
  def apply(
  ...
  typingsSlinky.reactDashToolbox.libAutocompleteMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
