...
import typingsSlinky.reactDashToolbox.libButtonIconButtonMod.IconButtonTheme
import typingsSlinky.reactDashToolbox.libButtonIconButtonMod.default
...
object IconButton
  ...
  typingsSlinky.reactDashToolbox.libButtonIconButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
