...
import typingsSlinky.reactDashToolbox.libButtonBaseMod.ButtonTheme
import typingsSlinky.reactDashToolbox.libButtonButtonMod.ButtonProps
import typingsSlinky.reactDashToolbox.libButtonMod.default
import typingsSlinky.reactDashToolbox.libRippleMod.RippleTheme
...
object Button
  ...
  @JSImport("react-toolbox/lib/button", JSImport.Default)
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: className, disabled, href, target, type */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashToolbox.libButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
