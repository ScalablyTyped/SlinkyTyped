...
import typingsSlinky.reactDashToolbox.libDialogDialogMod.DialogActionProps
import typingsSlinky.reactDashToolbox.libDialogDialogMod.DialogProps
import typingsSlinky.reactDashToolbox.libDialogDialogMod.DialogTheme
import typingsSlinky.reactDashToolbox.libDialogMod.default
...
object Dialog
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashToolbox.libDialogMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
