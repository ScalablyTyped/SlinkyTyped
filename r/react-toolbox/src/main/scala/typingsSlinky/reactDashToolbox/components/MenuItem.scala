...
import typingsSlinky.reactDashToolbox.libMenuMenuItemMod.MenuItemProps
import typingsSlinky.reactDashToolbox.libMenuMenuItemMod.MenuItemTheme
import typingsSlinky.reactDashToolbox.libMenuMenuItemMod.default
...
object MenuItem
  ...
  /* The following DOM/SVG props were specified: className, disabled, selected */
  def apply(
    caption: String,
