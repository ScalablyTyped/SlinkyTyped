...
import typingsSlinky.reactDashToolbox.libDrawerDrawerMod.DrawerProps
import typingsSlinky.reactDashToolbox.libDrawerDrawerMod.DrawerTheme
import typingsSlinky.reactDashToolbox.libDrawerMod.default
...
object Drawer
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashToolbox.libDrawerMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
