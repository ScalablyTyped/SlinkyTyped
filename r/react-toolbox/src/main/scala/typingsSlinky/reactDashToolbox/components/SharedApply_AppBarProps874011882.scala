...
import typingsSlinky.reactDashToolbox.libAppUnderscoreBarAppBarMod.AppBarProps
import typingsSlinky.reactDashToolbox.libAppUnderscoreBarAppBarMod.AppBarTheme
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_AppBarProps874011882[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: className */
  def apply(
    fixed: js.UndefOr[Boolean] = js.undefined,
    flat: js.UndefOr[Boolean] = js.undefined,
    leftIcon: TagMod[Any] = null,
