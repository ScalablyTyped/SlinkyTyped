...
import typingsSlinky.reactDashToolbox.libAvatarAvatarMod.AvatarTheme
import typingsSlinky.reactDashToolbox.libAvatarMod.default
...
object Avatar
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashToolbox.libAvatarMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
