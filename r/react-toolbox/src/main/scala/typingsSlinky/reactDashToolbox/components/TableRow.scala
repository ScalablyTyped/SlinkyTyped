...
import typingsSlinky.reactDashToolbox.libTableTableRowMod.TableRowProps
import typingsSlinky.reactDashToolbox.libTableTableRowMod.TableRowTheme
import typingsSlinky.reactDashToolbox.libTableTableRowMod.default
...
object TableRow
  ...
  typingsSlinky.reactDashToolbox.libTableTableRowMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
