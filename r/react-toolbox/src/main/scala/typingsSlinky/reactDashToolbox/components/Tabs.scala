...
import typingsSlinky.reactDashToolbox.libTabsTabsMod.TabsTheme
import typingsSlinky.reactDashToolbox.libTabsTabsMod.default
...
object Tabs
  ...
  typingsSlinky.reactDashToolbox.libTabsTabsMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
