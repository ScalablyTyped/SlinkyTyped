...
import typingsSlinky.reactDashToolbox.libHocPortalMod.PortalProps
import typingsSlinky.reactDashToolbox.libHocPortalMod.default
...
object Portal
  ...
  typingsSlinky.reactDashToolbox.libHocPortalMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
