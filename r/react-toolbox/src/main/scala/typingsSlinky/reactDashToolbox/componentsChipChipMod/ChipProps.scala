package typingsSlinky.reactDashToolbox.componentsChipChipMod
...
object ChipProps {
  ...
  def apply(
    ...
    onDeleteClick: js.Function = null,
    ...
    if (onDeleteClick != null) __obj.updateDynamic("onDeleteClick")(onDeleteClick.asInstanceOf[js.Any])
