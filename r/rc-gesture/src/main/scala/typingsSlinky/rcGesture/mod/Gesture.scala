...
import typingsSlinky.rcGesture.anon.AvailablePan
import typingsSlinky.rcGesture.rcGestureStrings.`pan-x pan-y`
import typingsSlinky.rcGesture.rcGestureStrings.`pan-x`
import typingsSlinky.rcGesture.rcGestureStrings.`pan-y`
import typingsSlinky.rcGesture.rcGestureStrings.auto
