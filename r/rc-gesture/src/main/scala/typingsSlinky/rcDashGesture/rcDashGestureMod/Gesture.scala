...
import typingsSlinky.rcDashGesture.Anon_AvailablePan
import typingsSlinky.rcDashGesture.rcDashGestureStrings.`pan-x pan-y`
import typingsSlinky.rcDashGesture.rcDashGestureStrings.`pan-x`
import typingsSlinky.rcDashGesture.rcDashGestureStrings.`pan-y`
import typingsSlinky.rcDashGesture.rcDashGestureStrings.auto
