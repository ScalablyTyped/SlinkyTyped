...
object FeaturedGames {
  ...
  object FeaturedGames {
    ...
    @scala.inline
    def apply(clientRefreshInterval: Double, gameList: js.Array[FeaturedGameInfo]): typingsSlinky.riotGamesApi.RiotGamesAPI.FeaturedGames.FeaturedGames = {
      ...
      __obj.asInstanceOf[typingsSlinky.riotGamesApi.RiotGamesAPI.FeaturedGames.FeaturedGames]
    }
    
    @scala.inline
    implicit class FeaturedGamesMutableBuilder[Self <: typingsSlinky.riotGamesApi.RiotGamesAPI.FeaturedGames.FeaturedGames] (val x: Self) extends AnyVal {
