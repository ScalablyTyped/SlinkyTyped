...
object ParticipantFrame {
  ...
  implicit class ParticipantFrameOps[Self <: ParticipantFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCurrentGold(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("currentGold")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDominionScore(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dominionScore")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withJungleMinionsKilled(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("jungleMinionsKilled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMinionsKilled(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minionsKilled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTeamScore(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("teamScore")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTotalGold(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("totalGold")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
