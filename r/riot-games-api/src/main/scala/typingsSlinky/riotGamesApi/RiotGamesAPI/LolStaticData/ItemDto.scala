...
trait ItemDto extends js.Object {
  ...
  var effect: js.Array[StringDictionary[String]] = js.native
...
object ItemDto {
  ...
  @scala.inline
  implicit class ItemDtoOps[Self <: ItemDto] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEffectVarargs(value: StringDictionary[String]*): Self = this.set("effect", js.Array(value :_*))
    @scala.inline
    def setEffect(value: js.Array[StringDictionary[String]]): Self = this.set("effect", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGold(value: GoldDto): Self = this.set("gold", value.asInstanceOf[js.Any])
    @scala.inline
