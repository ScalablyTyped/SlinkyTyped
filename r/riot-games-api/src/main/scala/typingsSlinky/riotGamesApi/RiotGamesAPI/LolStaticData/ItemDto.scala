...
@js.native
trait ItemDto extends StObject {
...
object ItemDto {
  ...
  @scala.inline
  implicit class ItemDtoMutableBuilder[Self <: ItemDto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEffect(value: js.Array[StringDictionary[String]]): Self = StObject.set(x, "effect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEffectVarargs(value: StringDictionary[String]*): Self = StObject.set(x, "effect", js.Array(value :_*))
