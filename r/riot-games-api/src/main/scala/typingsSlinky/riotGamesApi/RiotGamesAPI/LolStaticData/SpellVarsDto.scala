...
object SpellVarsDto {
  ...
  implicit class SpellVarsDtoOps[Self <: SpellVarsDto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCoeff(value: js.Array[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("coeff")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDyn(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dyn")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRanksWith(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ranksWith")(value.asInstanceOf[js.Any])
        ret
    }
  }
