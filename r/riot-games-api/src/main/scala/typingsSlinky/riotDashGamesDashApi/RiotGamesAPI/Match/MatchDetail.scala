...
trait MatchDetail extends js.Object {
  ...
  var region: String
  var season: String
  var teams: js.Array[typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Match.Team]
...
object MatchDetail {
  ...
  def apply(
    ...
    region: String,
    season: String,
    teams: js.Array[typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Match.Team],
    timeline: Timeline
  ): MatchDetail = {
