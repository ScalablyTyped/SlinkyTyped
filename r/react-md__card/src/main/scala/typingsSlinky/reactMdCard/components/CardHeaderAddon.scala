...
object CardHeaderAddon {
  
  @JSImport("@react-md/card/types/CardHeaderAddon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CardHeaderAddon.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
