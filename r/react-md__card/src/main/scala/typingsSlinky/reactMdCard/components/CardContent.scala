package typingsSlinky.reactMdCard.components
...
object CardContent {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableExtraPadding(value: Boolean): this.type = set("disableExtraPadding", value.asInstanceOf[js.Any])
    
    @scala.inline
    def disablePadding(value: Boolean): this.type = set("disablePadding", value.asInstanceOf[js.Any])
    
    @scala.inline
    def disableParagraphMargin(value: Boolean): this.type = set("disableParagraphMargin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def disableSecondaryColor(value: Boolean): this.type = set("disableSecondaryColor", value.asInstanceOf[js.Any])
  ...
  def withProps(p: CardContentProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
