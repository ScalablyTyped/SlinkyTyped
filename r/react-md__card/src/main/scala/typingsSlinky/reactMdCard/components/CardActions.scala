...
object CardActions {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def align(value: start | end | center): this.type = set("align", value.asInstanceOf[js.Any])
  ...
  def withProps(p: CardActionsProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
