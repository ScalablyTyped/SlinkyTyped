package typingsSlinky.reactMdCard.cardHeaderMod
...
object CardHeaderProps {
  ...
  implicit class CardHeaderPropsOps[Self <: CardHeaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterChildrenReactElement(value: ReactElement): Self = this.set("afterChildren", value.asInstanceOf[js.Any])
    @scala.inline
    def setAfterChildren(value: ReactElement): Self = this.set("afterChildren", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setBeforeChildrenReactElement(value: ReactElement): Self = this.set("beforeChildren", value.asInstanceOf[js.Any])
    @scala.inline
    def setBeforeChildren(value: ReactElement): Self = this.set("beforeChildren", value.asInstanceOf[js.Any])
    @scala.inline
