...
/**
  ...
  */
@JSImport("@react-md/card/types/CardHeader", JSImport.Default)
@js.native
object default extends TopLevel[ForwardRefExoticComponent[CardHeaderProps with RefAttributes[HTMLDivElement]]]
