...
import typingsSlinky.rosie.rosieMod.IFactory
import typingsSlinky.rosie.rosieMod.IFactoryStatic
...
object rosieMod extends js.Object {
  ...
  trait IFactory[T] extends js.Object {
    ...
    {[ k in keyof T ]:? T[k]}
      */ typingsSlinky.rosie.rosieStrings.IFactory with T
    ): T = js.native
    def attributes(
      attributes: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ k in keyof T ]:? T[k]}
    ...
    {[ K in Keys ]: T[K] | (opts? : any): T[K]}
      */ typingsSlinky.rosie.rosieStrings.IFactory with js.Any
    ): IFactory[T] = js.native
    /**
  ...
  trait IFactoryStatic
    ...
    def build[T](
      ...
      attributes: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ k in keyof T ]:? T[k]}
      */ typingsSlinky.rosie.rosieStrings.IFactoryStatic with T
    ): T = js.native
    def build[T](
      name: String,
      attributes: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
