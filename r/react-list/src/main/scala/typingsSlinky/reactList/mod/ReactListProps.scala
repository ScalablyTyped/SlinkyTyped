...
object ReactListProps {
  ...
  implicit class ReactListPropsOps[Self <: ReactListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAxis(value: typingsSlinky.reactList.reactListStrings.x | y): Self = this.set("axis", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemRenderer(value: (/* index */ Double, /* key */ Double | String) => ReactElement): Self = this.set("itemRenderer", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setItemsRenderer(value: (/* items */ js.Array[ReactElement], /* ref */ String) => ReactElement): Self = this.set("itemsRenderer", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setScrollParentGetter(value: () => ReactElement): Self = this.set("scrollParentGetter", js.Any.fromFunction0(value))
