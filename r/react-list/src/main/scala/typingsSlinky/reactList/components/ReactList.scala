...
object ReactList
  ...
  def apply(
    ...
    itemRenderer: (/* index */ Double, /* key */ Double | String) => ReactElement = null,
    itemSizeEstimator: (/* index */ Double, /* cache */ js.Object) => Double = null,
    itemSizeGetter: /* index */ Double => Double = null,
    itemsRenderer: (/* items */ js.Array[ReactElement], /* ref */ String) => ReactElement = null,
    length: Int | Double = null,
    minSize: Int | Double = null,
    pageSize: Int | Double = null,
    scrollParentGetter: () => ReactElement = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactList.mod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
