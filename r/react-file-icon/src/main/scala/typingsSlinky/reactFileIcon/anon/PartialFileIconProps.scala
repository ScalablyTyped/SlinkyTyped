package typingsSlinky.reactFileIcon.anon
...
@js.native
trait PartialFileIconProps extends js.Object {
...
object PartialFileIconProps {
  ...
  @scala.inline
  implicit class PartialFileIconPropsOps[Self <: PartialFileIconProps] (val x: Self) extends AnyVal {
