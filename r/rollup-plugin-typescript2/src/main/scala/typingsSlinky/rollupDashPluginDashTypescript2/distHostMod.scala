...
import typingsSlinky.rollupDashPluginDashTypescript2.distIoptionsMod.TransformerFactoryCreator
...
object distHostMod extends js.Object {
  ...
  class LanguageServiceHost protected ()
    extends typingsSlinky.typescript.typescriptMod.LanguageServiceHost {
