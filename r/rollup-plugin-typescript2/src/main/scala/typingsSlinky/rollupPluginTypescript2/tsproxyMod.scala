...
import typingsSlinky.rollupPluginTypescript2.anon.TypeofScriptSnapshot
...
object tsproxyMod {
  ...
  object tsModule {
    ...
    @JSImport("rollup-plugin-typescript2/dist/tsproxy", "tsModule.OperationCanceledException")
    @js.native
    def OperationCanceledException: Instantiable0[typingsSlinky.typescript.mod.OperationCanceledException] = js.native
    @scala.inline
    def OperationCanceledException_=(x: Instantiable0[typingsSlinky.typescript.mod.OperationCanceledException]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OperationCanceledException")(x.asInstanceOf[js.Any])
