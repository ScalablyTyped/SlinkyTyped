...
object contextMod {
  ...
  object VerbosityLevel extends StObject {
    ...
    /* 3 */ val Debug: typingsSlinky.rollupPluginTypescript2.contextMod.VerbosityLevel.Debug with Double = js.native
    
    @js.native
    sealed trait Error extends VerbosityLevel
    /* 0 */ val Error: typingsSlinky.rollupPluginTypescript2.contextMod.VerbosityLevel.Error with Double = js.native
    
    @js.native
    sealed trait Info extends VerbosityLevel
    /* 2 */ val Info: typingsSlinky.rollupPluginTypescript2.contextMod.VerbosityLevel.Info with Double = js.native
    
    @js.native
    sealed trait Warning extends VerbosityLevel
    /* 1 */ val Warning: typingsSlinky.rollupPluginTypescript2.contextMod.VerbosityLevel.Warning with Double = js.native
  }
