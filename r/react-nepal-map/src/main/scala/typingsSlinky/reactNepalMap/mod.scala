...
object mod {
  ...
  @js.native
  val DistrictMap: ReactComponentClass[MapPropsTypes] = js.native
  
  @JSImport("react-nepal-map", "ProvinceMap")
  @js.native
  val ProvinceMap: ReactComponentClass[ProvinceMapPropsTypes] = js.native
  
  @JSImport("react-nepal-map", "ZonalMap")
  @js.native
  val ZonalMap: ReactComponentClass[MapPropsTypes] = js.native
