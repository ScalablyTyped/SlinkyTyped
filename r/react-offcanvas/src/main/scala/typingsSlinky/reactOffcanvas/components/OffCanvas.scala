...
object OffCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactOffcanvas.mod.OffCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactOffcanvas.mod.OffCanvas] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactOffcanvas.mod.OffCanvas] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactOffcanvas.mod.OffCanvas](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
