...
object OffCanvasMenu
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashOffcanvas.reactDashOffcanvasMod.OffCanvasMenu] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashOffcanvas.reactDashOffcanvasMod.OffCanvasMenu](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
