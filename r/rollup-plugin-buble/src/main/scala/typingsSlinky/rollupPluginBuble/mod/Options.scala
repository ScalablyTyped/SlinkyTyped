...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExclude(value: (js.Array[String | js.RegExp]) | String | js.RegExp): Self = this.set("exclude", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInclude(value: (js.Array[String | js.RegExp]) | String | js.RegExp): Self = this.set("include", value.asInstanceOf[js.Any])
    @scala.inline
