...
object Options {
  @scala.inline
  def apply(
    exclude: js.UndefOr[Null | (js.Array[String | js.RegExp]) | String | js.RegExp] = js.undefined,
    file: String = null,
    include: js.UndefOr[Null | (js.Array[String | js.RegExp]) | String | js.RegExp] = js.undefined,
