...
import typingsSlinky.rimraf.Fn_Buffer
import typingsSlinky.rimraf.Fn_Mode
import typingsSlinky.rimraf.Fn_Options
...
import typingsSlinky.rimraf.rimrafNumbers.`false`
