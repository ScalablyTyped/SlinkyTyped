package typingsSlinky.reactJsonTree
...
object mod {
  ...
  object JSONTreeProps {
    ...
    implicit class JSONTreePropsMutableBuilder[Self <: JSONTreeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPostprocessValue(value: /* raw */ String => ReactElement): Self = StObject.set(x, "postprocessValue", js.Any.fromFunction1(value))
