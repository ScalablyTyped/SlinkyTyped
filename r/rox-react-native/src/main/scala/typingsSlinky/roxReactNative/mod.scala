package typingsSlinky.roxReactNative

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.roxReactNative.roxReactNativeStrings.`false`
import typingsSlinky.roxReactNative.roxReactNativeStrings.`true`
import typingsSlinky.roxReactNative.roxReactNativeStrings.verbose
...
object mod {
  ...
  object FreezeOptions extends StObject {
    ...
    /* 3 */ val freezeOptionNone: typingsSlinky.roxReactNative.mod.FreezeOptions.freezeOptionNone with Double = js.native
    
    @js.native
    sealed trait freezeOptionUntilForeground extends FreezeOptions
    /* 2 */ val freezeOptionUntilForeground: typingsSlinky.roxReactNative.mod.FreezeOptions.freezeOptionUntilForeground with Double = js.native
    
    @js.native
    sealed trait freezeOptionUntilLaunch extends FreezeOptions
    /* 1 */ val freezeOptionUntilLaunch: typingsSlinky.roxReactNative.mod.FreezeOptions.freezeOptionUntilLaunch with Double = js.native
  }
  ...
  object RoxFetcherStatus extends StObject {
    ...
    /* "APPLIED_FROM_CACHE" */ val AppliedFromCache: typingsSlinky.roxReactNative.mod.RoxFetcherStatus.AppliedFromCache with String = js.native
    
    @js.native
    sealed trait AppliedFromEmbedded extends RoxFetcherStatus
    /* "APPLIED_FROM_EMBEDDED" */ val AppliedFromEmbedded: typingsSlinky.roxReactNative.mod.RoxFetcherStatus.AppliedFromEmbedded with String = js.native
    
    @js.native
    sealed trait AppliedFromNetwork extends RoxFetcherStatus
    /* "APPLIED_FROM_NETWORK" */ val AppliedFromNetwork: typingsSlinky.roxReactNative.mod.RoxFetcherStatus.AppliedFromNetwork with String = js.native
    
    @js.native
    sealed trait ErrorFetchFailed extends RoxFetcherStatus
    /* "ERROR_FETCH_FAILED" */ val ErrorFetchFailed: typingsSlinky.roxReactNative.mod.RoxFetcherStatus.ErrorFetchFailed with String = js.native
  }
