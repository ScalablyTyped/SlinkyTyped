...
object Displaymessage {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(error_code = error_code.asInstanceOf[js.Any], error_message = error_message.asInstanceOf[js.Any], error_type = error_type.asInstanceOf[js.Any], display_message = display_message.asInstanceOf[js.Any])
