...
trait AnonInstitution extends js.Object {
  var institution: AnonName = js.native
...
object AnonInstitution {
  ...
  @scala.inline
  implicit class AnonInstitutionOps[Self <: AnonInstitution] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withInstitution(value: AnonName): Self = {
