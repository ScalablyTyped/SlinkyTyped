package typingsSlinky.reactDashTruncate.components
...
object ReactDashTruncate
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[Truncate] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with Truncate, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with Truncate, Event] => Unit = null,
