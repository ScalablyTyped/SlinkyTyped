...
object mod {
  ...
  object TruncateProps {
    ...
    implicit class TruncatePropsMutableBuilder[Self <: TruncateProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEllipsis(value: ReactElement): Self = StObject.set(x, "ellipsis", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEllipsisReactElement(value: ReactElement): Self = StObject.set(x, "ellipsis", value.asInstanceOf[js.Any])
