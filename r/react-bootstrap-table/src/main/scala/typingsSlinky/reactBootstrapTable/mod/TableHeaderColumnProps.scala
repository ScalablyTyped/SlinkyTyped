...
object TableHeaderColumnProps {
  ...
  def apply(
    ...
    customInsertEditor: GetElement = null,
    ...
    key: Key = null,
    ref: js.UndefOr[Null | LegacyRef[TableHeaderColumn]] = js.undefined,
    ...
    if (!js.isUndefined(dataSort)) __obj.updateDynamic("dataSort")(dataSort.get.asInstanceOf[js.Any])
    if (!js.isUndefined(defaultASC)) __obj.updateDynamic("defaultASC")(defaultASC.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(filterFormatted)) __obj.updateDynamic("filterFormatted")(filterFormatted.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(headerTitle)) __obj.updateDynamic("headerTitle")(headerTitle.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hidden)) __obj.updateDynamic("hidden")(hidden.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hiddenOnInsert)) __obj.updateDynamic("hiddenOnInsert")(hiddenOnInsert.get.asInstanceOf[js.Any])
