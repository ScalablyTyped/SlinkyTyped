...
object CustomFilter {
  @scala.inline
  def apply[/* <: js.Object */ FParams, /* <: typingsSlinky.reactBootstrapTable.mod.CustomFilterElement */ FElement](
    customFilterParameters: CustomFilterParameters[FParams],
  ...
  @scala.inline
  implicit class CustomFilterOps[Self <: CustomFilter[_, _], /* <: js.Object */ FParams, /* <: typingsSlinky.reactBootstrapTable.mod.CustomFilterElement */ FElement] (val x: Self with (CustomFilter[FParams, FElement])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.CustomFilter): Self = this.set("type", value.asInstanceOf[js.Any])
  }
