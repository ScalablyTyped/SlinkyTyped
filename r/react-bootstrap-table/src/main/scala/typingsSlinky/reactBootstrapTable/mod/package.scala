...
package object mod {
  ...
  type EditSelectOptionValue = js.Array[typingsSlinky.reactBootstrapTable.AnonValue | scala.Double | java.lang.String]
  ...
  */
  ...
  type SizePerPageList = js.Array[typingsSlinky.reactBootstrapTable.AnonText | scala.Double]
}
