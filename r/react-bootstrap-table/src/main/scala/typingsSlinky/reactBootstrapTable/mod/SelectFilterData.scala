...
object SelectFilterData {
  ...
  @scala.inline
  def apply(`type`: typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.SelectFilter, value: String): SelectFilterData = {
  ...
  implicit class SelectFilterDataOps[Self <: SelectFilterData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.SelectFilter): Self = this.set("type", value.asInstanceOf[js.Any])
