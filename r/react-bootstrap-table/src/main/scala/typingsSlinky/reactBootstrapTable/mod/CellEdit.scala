...
object CellEdit {
  ...
  def apply[TRow](
    ...
    if (!js.isUndefined(blurToEscape)) __obj.updateDynamic("blurToEscape")(blurToEscape.get.asInstanceOf[js.Any])
    if (!js.isUndefined(blurToSave)) __obj.updateDynamic("blurToSave")(blurToSave.get.asInstanceOf[js.Any])
