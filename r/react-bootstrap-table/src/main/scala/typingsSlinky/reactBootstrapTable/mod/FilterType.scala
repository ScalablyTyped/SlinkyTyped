...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.TextFilter
  - typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.RegexFilter
  - typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.SelectFilter
  - typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.NumberFilter
  - typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.DateFilter
  - typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.CustomFilter
  - typingsSlinky.reactBootstrapTable.reactBootstrapTableStrings.ArrayFilter
*/
