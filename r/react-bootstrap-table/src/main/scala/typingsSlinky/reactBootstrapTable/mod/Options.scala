...
object Options {
  ...
  implicit class OptionsOps[Self <: Options[_], /* <: js.Object */ TRow] (val x: Self with Options[TRow]) extends AnyVal {
    ...
    @scala.inline
    def setClearSearchBtn(value: /* onClick */ js.Function1[/* e */ SyntheticMouseEvent[_], Unit] => ReactElement): Self = this.set("clearSearchBtn", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setDeleteBtn(value: /* onClick */ js.Function1[/* e */ SyntheticMouseEvent[_], Unit] => ReactElement): Self = this.set("deleteBtn", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setExportCSVBtn(value: /* onClick */ js.Function1[/* e */ SyntheticMouseEvent[_], Unit] => ReactElement): Self = this.set("exportCSVBtn", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setInsertBtn(value: /* onClick */ js.Function1[/* e */ SyntheticMouseEvent[_], Unit] => ReactElement): Self = this.set("insertBtn", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setNoDataTextReactElement(value: ReactElement): Self = this.set("noDataText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnRowDoubleClick(value: (/* row */ TRow, /* event */ SyntheticMouseEvent[_]) => Unit): Self = this.set("onRowDoubleClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowDoubleClick: Self = this.set("onRowDoubleClick", js.undefined)
    @scala.inline
    def setOnRowMouseOut(value: (/* row */ TRow, /* e */ SyntheticMouseEvent[_]) => Unit): Self = this.set("onRowMouseOut", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowMouseOut: Self = this.set("onRowMouseOut", js.undefined)
    @scala.inline
    def setOnRowMouseOver(value: (/* row */ TRow, /* e */ SyntheticMouseEvent[_]) => Unit): Self = this.set("onRowMouseOver", js.Any.fromFunction2(value))
    @scala.inline
