...
trait CustomFilter[FParams /* <: js.Object */, FElement /* <: CustomFilterElement */] extends js.Object {
  ...
  /**
  	 ...
  	 */
  var `type`: typingsSlinky.reactDashBootstrapDashTable.reactDashBootstrapDashTableStrings.CustomFilter
  /**
  ...
  def getElement_CustomFilter(
    filterHandler: js.Function2[
      ...
      /* type */ js.UndefOr[
        typingsSlinky.reactDashBootstrapDashTable.reactDashBootstrapDashTableStrings.CustomFilter
      ], 
      Unit
    ],
...
object CustomFilter {
  ...
  def apply[FParams /* <: js.Object */, FElement /* <: CustomFilterElement */](
    ...
    `type`: typingsSlinky.reactDashBootstrapDashTable.reactDashBootstrapDashTableStrings.CustomFilter
