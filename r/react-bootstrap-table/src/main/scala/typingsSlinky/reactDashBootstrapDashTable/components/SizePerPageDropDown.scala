...
object SizePerPageDropDown
  ...
  typingsSlinky.reactDashBootstrapDashTable.reactDashBootstrapDashTableMod.SizePerPageDropDown](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
