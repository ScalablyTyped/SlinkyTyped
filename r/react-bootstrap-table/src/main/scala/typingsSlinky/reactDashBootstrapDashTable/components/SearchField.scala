...
object SearchField
  ...
  typingsSlinky.reactDashBootstrapDashTable.reactDashBootstrapDashTableMod.SearchField](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
