...
import typingsSlinky.reactDashBootstrapDashTable.reactDashBootstrapDashTableMod.EditCheckboxOptionValue
import typingsSlinky.reactDashBootstrapDashTable.reactDashBootstrapDashTableMod.EditSelectOptionValue
