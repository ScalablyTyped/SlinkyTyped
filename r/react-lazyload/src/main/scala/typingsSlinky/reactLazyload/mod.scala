package typingsSlinky.reactLazyload
...
object mod {
  ...
  @js.native
  def lazyload(option: js.Object): ReactComponentClass[LazyLoadProps] = js.native
  ...
  object LazyLoadProps {
    ...
    implicit class LazyLoadPropsMutableBuilder[Self <: LazyLoadProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScrollContainerElement(value: Element): Self = StObject.set(x, "scrollContainer", value.asInstanceOf[js.Any])
  ...
  type LazyLoad_ = ReactComponentClass[LazyLoadProps]
}
