...
import typingsSlinky.reactDocgenTypescriptPlugin.pluginMod.DocgenPlugin
import typingsSlinky.reactDocgenTypescriptPlugin.pluginMod.DocgenPluginType
import typingsSlinky.reactDocgenTypescriptPlugin.pluginMod.PluginOptions
