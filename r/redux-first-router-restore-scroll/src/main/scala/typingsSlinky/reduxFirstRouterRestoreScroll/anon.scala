...
object anon {
  ...
  trait Read extends StObject {
    ...
    def read(location: Location[typingsSlinky.history.mod.LocationState]): Location[typingsSlinky.history.mod.LocationState] = js.native
    def read(location: Location[typingsSlinky.history.mod.LocationState], key: String): Location[typingsSlinky.history.mod.LocationState] = js.native
    
    def save(location: Location[typingsSlinky.history.mod.LocationState], key: String, value: js.Any): Unit = js.native
    def save(location: Location[typingsSlinky.history.mod.LocationState], key: Null, value: js.Any): Unit = js.native
