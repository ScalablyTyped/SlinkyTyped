...
object map extends js.Object {
  ...
  def apply[T1, T2, U](entries: js.Tuple2[Arg[T1], Arg[T2]], mapFn: js.Function1[/* item */ T1 | T2, U], label: String): typingsSlinky.rsvp.mod.RSVP.Promise[js.Array[U] with `7`] = js.native
  def apply[T1, T2, T3, U](entries: js.Tuple3[Arg[T1], Arg[T2], Arg[T3]], mapFn: js.Function1[/* item */ T1 | T2 | T3, U]): typingsSlinky.rsvp.mod.RSVP.Promise[js.Array[U] with `6`] = js.native
