...
object filter extends js.Object {
  def apply[T](entries: js.Array[Arg[T]], filterFn: js.Function1[/* item */ T, Boolean]): typingsSlinky.rsvp.rsvpMod.RSVP.Promise[js.Array[T]] = js.native
  def apply[T](entries: js.Array[Arg[T]], filterFn: js.Function1[/* item */ T, Boolean], label: String): typingsSlinky.rsvp.rsvpMod.RSVP.Promise[js.Array[T]] = js.native
  def apply[T1, T2](entries: js.Tuple2[Arg[T1], Arg[T2]], filterFn: js.Function1[/* item */ T1 | T2, Boolean]): typingsSlinky.rsvp.rsvpMod.RSVP.Promise[js.Array[T1 | T2]] = js.native
  def apply[T1, T2](
