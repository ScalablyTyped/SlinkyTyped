...
object Tabs
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rmcDashTabs.libTabsMod.Tabs] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rmcDashTabs.libTabsMod.Tabs] = {
