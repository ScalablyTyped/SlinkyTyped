...
object DefaultTabBar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rmcDashTabs.rmcDashTabsMod.DefaultTabBar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rmcDashTabs.rmcDashTabsMod.DefaultTabBar] = {
