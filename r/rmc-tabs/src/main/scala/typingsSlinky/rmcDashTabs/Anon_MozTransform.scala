...
trait Anon_MozTransform extends js.Object {
  var MozTransform: js.Any
  var WebkitTransform: js.Any
  var transform: js.Any
}

object Anon_MozTransform {
  @scala.inline
  def apply(MozTransform: js.Any, WebkitTransform: js.Any, transform: js.Any): Anon_MozTransform = {
    ...
    __obj.asInstanceOf[Anon_MozTransform]
  }
}
