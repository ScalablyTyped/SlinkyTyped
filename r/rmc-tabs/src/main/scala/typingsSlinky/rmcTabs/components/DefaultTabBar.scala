...
object DefaultTabBar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rmcTabs.mod.DefaultTabBar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rmcTabs.mod.DefaultTabBar] = {
