...
trait TabBarPropsType extends js.Object {
  ...
  var renderUnderline: js.UndefOr[js.Function1[/* style */ CSSProperties | js.Any, ReactElement]] = js.native
...
object TabBarPropsType {
  ...
  implicit class TabBarPropsTypeOps[Self <: TabBarPropsType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderUnderline(value: /* style */ CSSProperties | js.Any => ReactElement): Self = this.set("renderUnderline", js.Any.fromFunction1(value))
    @scala.inline
