...
trait PropsType extends js.Object {
  ...
  /** render for TabBar */
  var renderTabBar: js.UndefOr[(js.Function1[/* props */ TabBarPropsType, ReactElement]) | `false`] = js.native
...
object PropsType {
  ...
  implicit class PropsTypeOps[Self <: PropsType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderTabBarFunction1(value: /* props */ TabBarPropsType => ReactElement): Self = this.set("renderTabBar", js.Any.fromFunction1(value))
    @scala.inline
    def setRenderTabBar(value: (js.Function1[/* props */ TabBarPropsType, ReactElement]) | `false`): Self = this.set("renderTabBar", value.asInstanceOf[js.Any])
    @scala.inline
