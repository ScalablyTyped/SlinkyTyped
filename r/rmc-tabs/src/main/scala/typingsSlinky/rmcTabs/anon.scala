...
object anon {
  ...
  trait TypeofDefaultTabBar
    extends Instantiable1[/* props */ typingsSlinky.rmcTabs.defaultTabBarMod.PropsType, DefaultTabBar] {
    
    var defaultProps: typingsSlinky.rmcTabs.defaultTabBarMod.PropsType = js.native
  }
}
