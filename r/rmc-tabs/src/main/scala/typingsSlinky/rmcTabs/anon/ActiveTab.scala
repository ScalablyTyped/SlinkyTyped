...
object ActiveTab {
  @scala.inline
  def apply[/* <: typingsSlinky.rmcTabs.tabsBaseMod.StateType */ S, /* <: typingsSlinky.rmcTabs.propsTypeMod.PropsType */ P](
  ...
  @scala.inline
  implicit class ActiveTabOps[Self <: ActiveTab[_, _], /* <: typingsSlinky.rmcTabs.tabsBaseMod.StateType */ S, /* <: typingsSlinky.rmcTabs.propsTypeMod.PropsType */ P] (val x: Self with (ActiveTab[S, P])) extends AnyVal {
    @scala.inline
