...
trait AnonActiveTextColor extends js.Object {
  ...
  var container: AnonHeight = js.native
...
object AnonActiveTextColor {
  ...
  @scala.inline
  implicit class AnonActiveTextColorOps[Self <: AnonActiveTextColor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withContainer(value: AnonHeight): Self = {
        val ret = this.duplicate
