...
object propsTypeMod {
  ...
  object PropsType {
    ...
    implicit class PropsTypeMutableBuilder[Self <: PropsType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderTabBar(value: (js.Function1[/* props */ TabBarPropsType, ReactElement]) | `false`): Self = StObject.set(x, "renderTabBar", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderTabBarFunction1(value: /* props */ TabBarPropsType => ReactElement): Self = StObject.set(x, "renderTabBar", js.Any.fromFunction1(value))
  ...
  object TabBarPropsType {
    ...
    implicit class TabBarPropsTypeMutableBuilder[Self <: TabBarPropsType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderUnderline(value: /* style */ CSSProperties | js.Any => ReactElement): Self = StObject.set(x, "renderUnderline", js.Any.fromFunction1(value))
