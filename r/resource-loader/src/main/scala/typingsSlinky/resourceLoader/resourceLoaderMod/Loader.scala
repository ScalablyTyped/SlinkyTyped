...
import typingsSlinky.resourceLoader.resourceLoaderMod.Loader.OnCompleteSignal
import typingsSlinky.resourceLoader.resourceLoaderMod.Loader.OnErrorSignal
import typingsSlinky.resourceLoader.resourceLoaderMod.Loader.OnLoadSignal
import typingsSlinky.resourceLoader.resourceLoaderMod.Loader.OnProgressSignal
import typingsSlinky.resourceLoader.resourceLoaderMod.Loader.OnStartSignal
...
class Loader () extends js.Object {
  ...
  def add(
    name: String,
    url: String,
    callback: typingsSlinky.resourceLoader.resourceLoaderMod.Resource.OnCompleteSignal
  ): this.type = js.native
  def add(
    name: String,
    url: String,
  ...
  def add(url: String, callback: typingsSlinky.resourceLoader.resourceLoaderMod.Resource.OnCompleteSignal): this.type = js.native
  def add(
    url: String,
    options: js.UndefOr[scala.Nothing],
    callback: typingsSlinky.resourceLoader.resourceLoaderMod.Resource.OnCompleteSignal
