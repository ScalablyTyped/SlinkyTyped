...
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Resource.IMetadata
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Resource.LOAD_TYPE
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Resource.XHR_RESPONSE_TYPE
