...
import typingsSlinky.resourceDashLoader.miniDashSignalsMod.default
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Loader.OnCompleteSignal
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Loader.OnErrorSignal
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Loader.OnLoadSignal
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Loader.OnProgressSignal
import typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Loader.OnStartSignal
...
class Loader () extends js.Object {
  ...
  def add(
    name: String,
    url: String,
    callback: typingsSlinky.resourceDashLoader.resourceDashLoaderMod.Resource.OnCompleteSignal
  ): this.type = js.native
