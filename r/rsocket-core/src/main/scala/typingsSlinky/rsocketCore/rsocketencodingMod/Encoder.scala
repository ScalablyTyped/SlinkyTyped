...
object Encoder {
  @scala.inline
  def apply[/* <: typingsSlinky.rsocketTypes.reactiveSocketTypesMod.Encodable */ T](
  ...
  @scala.inline
  implicit class EncoderOps[Self <: Encoder[_], /* <: typingsSlinky.rsocketTypes.reactiveSocketTypesMod.Encodable */ T] (val x: Self with Encoder[T]) extends AnyVal {
    @scala.inline
