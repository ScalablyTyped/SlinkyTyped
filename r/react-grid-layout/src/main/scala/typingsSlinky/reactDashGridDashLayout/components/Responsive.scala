...
object Responsive
  ...
  /* The following DOM/SVG props were specified: className, onDrop */
  def apply(
  ...
  typingsSlinky.reactDashGridDashLayout.reactDashGridDashLayoutMod.Responsive](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
