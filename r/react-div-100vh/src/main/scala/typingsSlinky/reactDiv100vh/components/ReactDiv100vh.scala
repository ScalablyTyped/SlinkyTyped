...
object ReactDiv100vh {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def as(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176 */ js.Any): this.type = set("as", value.asInstanceOf[js.Any])
  ...
  def withProps(p: Div100vhProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
