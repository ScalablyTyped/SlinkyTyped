package typingsSlinky.reactDiv100vh.components
...
import typingsSlinky.reactDiv100vh.mod.Div100vhProps
import typingsSlinky.reactDiv100vh.mod.default
...
object ReactDiv100vh
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDiv100vh.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = Div100vhProps
}
