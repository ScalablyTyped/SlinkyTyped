...
object ThemeProvider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactCssThemr.mod.ThemeProvider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactCssThemr.mod.ThemeProvider] = {
