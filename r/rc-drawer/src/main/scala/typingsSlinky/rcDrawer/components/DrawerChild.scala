...
object DrawerChild
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, hidden, id, lang, open, placeholder, spellCheck, style, suppressContentEditableWarning, tabIndex, title */
  def apply(
    about: String = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.rcDrawer.drawerChildMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
