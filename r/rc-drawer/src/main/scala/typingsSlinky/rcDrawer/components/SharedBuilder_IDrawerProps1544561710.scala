...
@scala.inline
class SharedBuilder_IDrawerProps1544561710[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def levelMoveFunction1(value: /* e */ AnonTarget => ILevelMove): this.type = set("levelMove", js.Any.fromFunction1(value))
  @scala.inline
  def levelMove(value: ILevelMove | (js.Function1[/* e */ AnonTarget, ILevelMove])): this.type = set("levelMove", value.asInstanceOf[js.Any])
  @scala.inline
