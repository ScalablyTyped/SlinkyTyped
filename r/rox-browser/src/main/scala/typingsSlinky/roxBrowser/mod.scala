...
object mod {
  ...
  object RoxFetcherStatus extends StObject {
    ...
    /* "APPLIED_FROM_CACHE" */ val AppliedFromCache: typingsSlinky.roxBrowser.mod.RoxFetcherStatus.AppliedFromCache with String = js.native
    
    @js.native
    sealed trait AppliedFromEmbedded extends RoxFetcherStatus
    /* "APPLIED_FROM_EMBEDDED" */ val AppliedFromEmbedded: typingsSlinky.roxBrowser.mod.RoxFetcherStatus.AppliedFromEmbedded with String = js.native
    
    @js.native
    sealed trait AppliedFromNetwork extends RoxFetcherStatus
    /* "APPLIED_FROM_NETWORK" */ val AppliedFromNetwork: typingsSlinky.roxBrowser.mod.RoxFetcherStatus.AppliedFromNetwork with String = js.native
    
    @js.native
    sealed trait ErrorFetchFailed extends RoxFetcherStatus
    /* "ERROR_FETCH_FAILED" */ val ErrorFetchFailed: typingsSlinky.roxBrowser.mod.RoxFetcherStatus.ErrorFetchFailed with String = js.native
  }
  ...
  object RoxFlagFreezeLevel extends StObject {
    ...
    /* "none" */ val None: typingsSlinky.roxBrowser.mod.RoxFlagFreezeLevel.None with String = js.native
    
    @js.native
    sealed trait UntilForeground extends RoxFlagFreezeLevel
    /* "untilForeground" */ val UntilForeground: typingsSlinky.roxBrowser.mod.RoxFlagFreezeLevel.UntilForeground with String = js.native
    
    @js.native
    sealed trait UntilLaunch extends RoxFlagFreezeLevel
    /* "untilLaunch" */ val UntilLaunch: typingsSlinky.roxBrowser.mod.RoxFlagFreezeLevel.UntilLaunch with String = js.native
  }
  ...
  object RoxOverridesPosition extends StObject {
    ...
    /* "bottom left" */ val BottomLeft: typingsSlinky.roxBrowser.mod.RoxOverridesPosition.BottomLeft with String = js.native
    
    @js.native
    sealed trait BottomRight extends RoxOverridesPosition
    /* "bottom right" */ val BottomRight: typingsSlinky.roxBrowser.mod.RoxOverridesPosition.BottomRight with String = js.native
    
    @js.native
    sealed trait TopLeft extends RoxOverridesPosition
    /* "top left" */ val TopLeft: typingsSlinky.roxBrowser.mod.RoxOverridesPosition.TopLeft with String = js.native
    
    @js.native
    sealed trait TopRight extends RoxOverridesPosition
    /* "top right" */ val TopRight: typingsSlinky.roxBrowser.mod.RoxOverridesPosition.TopRight with String = js.native
  }
