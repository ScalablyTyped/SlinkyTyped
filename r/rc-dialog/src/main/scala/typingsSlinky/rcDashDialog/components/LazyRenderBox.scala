...
import typingsSlinky.rcDashDialog.libLazyRenderBoxMod.ILazyRenderBoxPropTypes
import typingsSlinky.rcDashDialog.libLazyRenderBoxMod.default
...
object LazyRenderBox
  ...
  typingsSlinky.rcDashDialog.libLazyRenderBoxMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
