...
object analyticsMod {
  ...
  object SessionState extends StObject {
    ...
    /* "end" */ val End: typingsSlinky.reactNativeGoogleAnalyticsBridge.analyticsMod.SessionState.End with String = js.native
    
    @js.native
    sealed trait Start extends SessionState
    /* "start" */ val Start: typingsSlinky.reactNativeGoogleAnalyticsBridge.analyticsMod.SessionState.Start with String = js.native
  }
