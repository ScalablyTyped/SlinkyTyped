...
import typingsSlinky.reactNativeGoogleAnalyticsBridge.analyticsMod.EventMetadata
import typingsSlinky.reactNativeGoogleAnalyticsBridge.analyticsMod.HitPayload
import typingsSlinky.reactNativeGoogleAnalyticsBridge.analyticsMod.TimingMetadata
