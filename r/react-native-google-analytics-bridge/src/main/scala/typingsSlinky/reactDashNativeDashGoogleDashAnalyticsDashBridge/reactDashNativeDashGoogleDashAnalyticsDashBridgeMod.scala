...
import typingsSlinky.reactDashNativeDashGoogleDashAnalyticsDashBridge.distGoogleAnalyticsSettingsMod.default
import typingsSlinky.reactDashNativeDashGoogleDashAnalyticsDashBridge.distModelsCustomMod.CustomDimensionsFieldIndexMap
import typingsSlinky.reactDashNativeDashGoogleDashAnalyticsDashBridge.distModelsDataLayerEventMod.DataLayerEvent
...
object reactDashNativeDashGoogleDashAnalyticsDashBridgeMod extends js.Object {
  ...
  class GoogleAnalyticsTracker protected ()
    extends typingsSlinky.reactDashNativeDashGoogleDashAnalyticsDashBridge.distGoogleAnalyticsTrackerMod.default {
    /**
  ...
  class GoogleTagManager ()
    extends typingsSlinky.reactDashNativeDashGoogleDashAnalyticsDashBridge.distGoogleTagManagerMod.default
  ...
  object ProductActionEnum extends js.Object {
    ...
    def apply(value: Double): js.UndefOr[
        typingsSlinky.reactDashNativeDashGoogleDashAnalyticsDashBridge.distModelsProductMod.ProductActionEnum with Double
      ] = js.native
  }
