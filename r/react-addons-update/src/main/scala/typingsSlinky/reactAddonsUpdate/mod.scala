package typingsSlinky.reactAddonsUpdate

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateArraySpec
import typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpec
...
object mod {
  ...
  object reactAugmentingMod {
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecCommand
      - typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecPath
    */
    ...
    object _UpdateSpec {
      ...
      @scala.inline
      def UpdateSpecCommand(): typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecCommand = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecCommand]
      }
      
      @scala.inline
      def UpdateSpecPath(): typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecPath = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecPath]
      }
    }
  }
}
