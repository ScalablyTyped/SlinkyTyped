...
object PopperProps {
  ...
  implicit class PopperPropsOps[Self <: PopperProps[_], Modifiers] (val x: Self with PopperProps[Modifiers]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: PopperChildrenProps => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setReferenceElementHTMLElement(value: HTMLElement): Self = this.set("referenceElement", value.asInstanceOf[js.Any])
