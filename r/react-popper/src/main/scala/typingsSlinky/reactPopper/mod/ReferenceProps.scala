...
trait ReferenceProps extends js.Object {
  ...
  def children(props: ReferenceChildrenProps): TagMod[Any] = js.native
}

object ReferenceProps {
  @scala.inline
  def apply(children: ReferenceChildrenProps => TagMod[Any]): ReferenceProps = {
  ...
  implicit class ReferencePropsOps[Self <: ReferenceProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChildren(value: ReferenceChildrenProps => TagMod[Any]): Self = {
