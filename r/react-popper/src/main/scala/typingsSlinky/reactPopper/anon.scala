...
import typingsSlinky.popperjsCore.anon.Arrow
import typingsSlinky.popperjsCore.anon.Dictkey
import typingsSlinky.popperjsCore.anon.PartialCSSStyleDeclaratio
import typingsSlinky.popperjsCore.anon.PartialModifieranyany
import typingsSlinky.popperjsCore.anon.Popper
...
object anon {
  ...
  trait Attributes extends StObject {
    ...
    var update: js.Function0[js.Promise[typingsSlinky.popperjsCore.anon.PartialState]] | Null = js.native
  }
  object Attributes {
    ...
    implicit class AttributesMutableBuilder[Self <: Attributes] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUpdate(value: () => js.Promise[typingsSlinky.popperjsCore.anon.PartialState]): Self = StObject.set(x, "update", js.Any.fromFunction0(value))
  ...
  trait OmitPartialOptionsmodifie extends StObject {
    ...
    var onFirstUpdate: js.UndefOr[js.Function1[/* arg0 */ typingsSlinky.popperjsCore.anon.PartialState, Unit]] = js.native
  ...
  object OmitPartialOptionsmodifie {
    ...
    implicit class OmitPartialOptionsmodifieMutableBuilder[Self <: OmitPartialOptionsmodifie] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnFirstUpdate(value: /* arg0 */ typingsSlinky.popperjsCore.anon.PartialState => Unit): Self = StObject.set(x, "onFirstUpdate", js.Any.fromFunction1(value))
  ...
  trait PartialState extends StObject {
    ...
    var orderedModifiers: js.UndefOr[js.Array[typingsSlinky.popperjsCore.typesMod.Modifier[_, _]]] = js.native
  ...
  object PartialState {
    ...
    implicit class PartialStateMutableBuilder[Self <: PartialState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOrderedModifiers(value: js.Array[typingsSlinky.popperjsCore.typesMod.Modifier[_, _]]): Self = StObject.set(x, "orderedModifiers", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOrderedModifiersUndefined: Self = StObject.set(x, "orderedModifiers", js.undefined)
      
      @scala.inline
      def setOrderedModifiersVarargs(value: (typingsSlinky.popperjsCore.typesMod.Modifier[js.Any, js.Any])*): Self = StObject.set(x, "orderedModifiers", js.Array(value :_*))
