...
import typingsSlinky.reactPopper.anon.CreatePopper
import typingsSlinky.reactPopper.anon.OmitPartialOptionsmodifie
import typingsSlinky.reactPopper.anon.PartialState
import typingsSlinky.reactPopper.reactPopperStrings.applyStyles
import typingsSlinky.reactPopper.reactPopperStrings.arrow
import typingsSlinky.reactPopper.reactPopperStrings.computeStyles
import typingsSlinky.reactPopper.reactPopperStrings.eventListeners
import typingsSlinky.reactPopper.reactPopperStrings.flip
import typingsSlinky.reactPopper.reactPopperStrings.hide
import typingsSlinky.reactPopper.reactPopperStrings.name
import typingsSlinky.reactPopper.reactPopperStrings.offset
import typingsSlinky.reactPopper.reactPopperStrings.popperOffsets
import typingsSlinky.reactPopper.reactPopperStrings.preventOverflow
...
object mod {
  ...
  type Modifier[Name, Options /* <: js.Object */] = (Partial[typingsSlinky.popperjsCore.typesMod.Modifier[Name, Options]]) | StrictModifier[Name]
  ...
  trait PopperProps[Modifiers] extends StObject {
    ...
    def children(props: PopperChildrenProps): ReactElement = js.native
  ...
  object PopperProps {
    ...
    @scala.inline
    def apply[Modifiers](children: PopperChildrenProps => ReactElement): PopperProps[Modifiers] = {
    ...
    implicit class PopperPropsMutableBuilder[Self <: PopperProps[_], Modifiers] (val x: Self with PopperProps[Modifiers]) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: PopperChildrenProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setReferenceElementHTMLElement(value: HTMLElement): Self = StObject.set(x, "referenceElement", value.asInstanceOf[js.Any])
  ...
  object ReferenceProps {
    ...
    implicit class ReferencePropsMutableBuilder[Self <: ReferenceProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ReferenceChildrenProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
