package typingsSlinky.rmcDrawer.mod
...
object DrawerProps {
  ...
  implicit class DrawerPropsOps[Self <: DrawerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSidebarReactElement(value: ReactElement): Self = this.set("sidebar", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSidebar(value: ReactElement): Self = this.set("sidebar", value.asInstanceOf[js.Any])
