...
object InputOptions {
  ...
  implicit class InputOptionsOps[Self <: InputOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExternalVarargs(value: (String | js.RegExp)*): Self = this.set("external", js.Array(value :_*))
    @scala.inline
    def setExternalRegExp(value: js.RegExp): Self = this.set("external", value.asInstanceOf[js.Any])
    @scala.inline
