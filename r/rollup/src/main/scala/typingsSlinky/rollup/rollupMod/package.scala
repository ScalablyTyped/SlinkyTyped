...
package object rollupMod {
  ...
  import typingsSlinky.rollup.Anon_AssetFileName
  import typingsSlinky.rollup.Anon_AssetReferenceId
  import typingsSlinky.rollup.Anon_ChunkId
  import typingsSlinky.rollup.Anon_Code
  import typingsSlinky.rollup.Anon_Name
  import typingsSlinky.rollup.rollupStrings.`no-external`
