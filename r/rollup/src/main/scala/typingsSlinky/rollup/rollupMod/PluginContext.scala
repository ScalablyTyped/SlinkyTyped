...
import typingsSlinky.rollup.Anon_ColumnLine
import typingsSlinky.rollup.Anon_HasModuleSideEffects
import typingsSlinky.rollup.Anon_Name
import typingsSlinky.rollup.Anon_SkipSelf
...
trait PluginContext extends MinimalPluginContext {
  ...
  def emitChunk(id: String, options: Anon_Name): String = js.native
