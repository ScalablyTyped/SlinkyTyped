...
trait PluginHooks extends OutputPluginHooks {
  ...
  def load(id: String): (js.Promise[SourceDescription | String | Null]) | SourceDescription | String | Null = js.native
  ...
  def resolveImportMeta(prop: String, options: Anon_ChunkId): js.UndefOr[String | Null] = js.native
  def resolveImportMeta(prop: Null, options: Anon_ChunkId): js.UndefOr[String | Null] = js.native
