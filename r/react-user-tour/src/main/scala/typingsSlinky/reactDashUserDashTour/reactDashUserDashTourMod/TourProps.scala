package typingsSlinky.reactDashUserDashTour.reactDashUserDashTourMod
...
object TourProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event, js.Any] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with js.Any, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[js.Any] => Unit = null,
    onCanPlay: SyntheticEvent[Event, js.Any] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, js.Any] => Unit = null,
    onChange: SyntheticEvent[EventTarget with js.Any, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, js.Any] => Unit = null,
    onEmptied: SyntheticEvent[Event, js.Any] => Unit = null,
    onEncrypted: SyntheticEvent[Event, js.Any] => Unit = null,
    onEnded: SyntheticEvent[Event, js.Any] => Unit = null,
    onError: SyntheticEvent[Event, js.Any] => Unit = null,
    onFocus: SyntheticFocusEvent[js.Any] => Unit = null,
    onInput: SyntheticEvent[EventTarget with js.Any, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with js.Any, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, js.Any] => Unit = null,
    onLoadStart: SyntheticEvent[Event, js.Any] => Unit = null,
    onLoadedData: SyntheticEvent[Event, js.Any] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, js.Any] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, js.Any] => Unit = null,
    onPlay: SyntheticEvent[Event, js.Any] => Unit = null,
    onPlaying: SyntheticEvent[Event, js.Any] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, js.Any] => Unit = null,
    onRateChange: SyntheticEvent[Event, js.Any] => Unit = null,
    onReset: SyntheticEvent[EventTarget with js.Any, Event] => Unit = null,
    onScroll: SyntheticUIEvent[js.Any] => Unit = null,
    onSeeked: SyntheticEvent[Event, js.Any] => Unit = null,
    onSeeking: SyntheticEvent[Event, js.Any] => Unit = null,
    onSelect: SyntheticEvent[Event, js.Any] => Unit = null,
    onStalled: SyntheticEvent[Event, js.Any] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with js.Any, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, js.Any] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, js.Any] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, js.Any] => Unit = null,
    onWaiting: SyntheticEvent[Event, js.Any] => Unit = null,
