package typingsSlinky.reactUserTour.components
...
object ReactUserTour {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def arrow(value: js.Any): this.type = set("arrow", value.asInstanceOf[js.Any])
    
    @scala.inline
    def arrowColor(value: String): this.type = set("arrowColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def arrowSize(value: Double): this.type = set("arrowSize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def backButtonText(value: String): this.type = set("backButtonText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def buttonContainerStyle(value: js.Any): this.type = set("buttonContainerStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def buttonStyle(value: js.Any): this.type = set("buttonStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def doneButtonText(value: String): this.type = set("doneButtonText", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hideButtons(value: Boolean): this.type = set("hideButtons", value.asInstanceOf[js.Any])
