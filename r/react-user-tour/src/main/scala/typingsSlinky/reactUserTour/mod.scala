package typingsSlinky.reactUserTour
...
object mod {
  ...
  @JSImport("react-user-tour", JSImport.Default)
  @js.native
  def default: ReactComponentClass[TourProps] = js.native
  @scala.inline
  def default_=(x: ReactComponentClass[TourProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("default")(x.asInstanceOf[js.Any])
  ...
  object TourStep {
    ...
    implicit class TourStepMutableBuilder[Self <: TourStep] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBody(value: String | ReactElement): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBodyReactElement(value: ReactElement): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
