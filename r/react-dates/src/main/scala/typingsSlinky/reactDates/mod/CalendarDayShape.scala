...
object CalendarDayShape {
  ...
  implicit class CalendarDayShapeOps[Self <: CalendarDayShape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDayClick(value: (/* day */ Moment, /* event */ SyntheticMouseEvent[HTMLTableDataCellElement]) => Unit): Self = this.set("onDayClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnDayClick: Self = this.set("onDayClick", js.undefined)
    
    @scala.inline
    def setOnDayMouseEnter(value: (/* day */ Moment, /* event */ SyntheticMouseEvent[HTMLTableDataCellElement]) => Unit): Self = this.set("onDayMouseEnter", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnDayMouseEnter: Self = this.set("onDayMouseEnter", js.undefined)
    
    @scala.inline
    def setOnDayMouseLeave(value: (/* day */ Moment, /* event */ SyntheticMouseEvent[HTMLTableDataCellElement]) => Unit): Self = this.set("onDayMouseLeave", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setRenderDayContents(value: (/* day */ Moment, /* modifiers */ ModifiersShape) => ReactElement): Self = this.set("renderDayContents", js.Any.fromFunction2(value))
