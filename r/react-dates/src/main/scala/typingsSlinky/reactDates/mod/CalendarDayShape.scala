...
trait CalendarDayShape extends StObject {
  ...
  var onDayClick: js.UndefOr[
    js.Function2[/* day */ Moment, /* event */ SyntheticMouseEvent[HTMLTableDataCellElement], Unit]
  ] = js.native
...
object CalendarDayShape {
  ...
  implicit class CalendarDayShapeMutableBuilder[Self <: CalendarDayShape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDayClick(value: (/* day */ Moment, /* event */ SyntheticMouseEvent[HTMLTableDataCellElement]) => Unit): Self = StObject.set(x, "onDayClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnDayClickUndefined: Self = StObject.set(x, "onDayClick", js.undefined)
    
    @scala.inline
    def setOnDayMouseEnter(value: (/* day */ Moment, /* event */ SyntheticMouseEvent[HTMLTableDataCellElement]) => Unit): Self = StObject.set(x, "onDayMouseEnter", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnDayMouseEnterUndefined: Self = StObject.set(x, "onDayMouseEnter", js.undefined)
    
    @scala.inline
    def setOnDayMouseLeave(value: (/* day */ Moment, /* event */ SyntheticMouseEvent[HTMLTableDataCellElement]) => Unit): Self = StObject.set(x, "onDayMouseLeave", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setRenderDayContents(value: (/* day */ Moment, /* modifiers */ ModifiersShape) => ReactElement): Self = StObject.set(x, "renderDayContents", js.Any.fromFunction2(value))
