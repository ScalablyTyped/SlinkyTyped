...
@js.native
trait DateRangePickerPhrases extends StObject {
...
object DateRangePickerPhrases {
  ...
  @scala.inline
  implicit class DateRangePickerPhrasesMutableBuilder[Self <: DateRangePickerPhrases] (val x: Self) extends AnyVal {
