...
object SingleDatePickerInputShape {
  ...
  implicit class SingleDatePickerInputShapeMutableBuilder[Self <: SingleDatePickerInputShape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClearDate(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onClearDate", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnKeyDownShiftTab(value: SyntheticKeyboardEvent[HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyDownShiftTab", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnKeyDownShiftTabUndefined: Self = StObject.set(x, "onKeyDownShiftTab", js.undefined)
    
    @scala.inline
    def setOnKeyDownTab(value: SyntheticKeyboardEvent[HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyDownTab", js.Any.fromFunction1(value))
