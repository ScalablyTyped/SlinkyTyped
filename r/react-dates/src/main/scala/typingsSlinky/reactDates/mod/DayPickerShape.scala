...
trait DayPickerShape extends js.Object {
  ...
  var renderMonthElement: js.UndefOr[js.Function1[/* props */ IsVisible, String | ReactElement]] = js.undefined
...
object DayPickerShape {
  ...
  def apply(
    ...
    renderMonthElement: /* props */ IsVisible => String | ReactElement = null,
