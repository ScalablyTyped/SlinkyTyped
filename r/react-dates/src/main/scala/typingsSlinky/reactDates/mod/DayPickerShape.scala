...
object DayPickerShape {
  ...
  implicit class DayPickerShapeOps[Self <: DayPickerShape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNavNextReactElement(value: ReactElement): Self = this.set("navNext", value.asInstanceOf[js.Any])
    @scala.inline
    def setNavNext(value: String | ReactElement): Self = this.set("navNext", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteNavNext: Self = this.set("navNext", js.undefined)
    @scala.inline
    def setNavPrevReactElement(value: ReactElement): Self = this.set("navPrev", value.asInstanceOf[js.Any])
    @scala.inline
    def setNavPrev(value: String | ReactElement): Self = this.set("navPrev", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRenderCalendarDay(value: /* day */ momentObj => String | ReactElement): Self = this.set("renderCalendarDay", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderCalendarDay: Self = this.set("renderCalendarDay", js.undefined)
    @scala.inline
    def setRenderCalendarInfo(value: () => String | ReactElement): Self = this.set("renderCalendarInfo", js.Any.fromFunction0(value))
    @scala.inline
    def deleteRenderCalendarInfo: Self = this.set("renderCalendarInfo", js.undefined)
    @scala.inline
    def setRenderDayContents(value: /* day */ momentObj => String | ReactElement): Self = this.set("renderDayContents", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderDayContents: Self = this.set("renderDayContents", js.undefined)
    @scala.inline
    def setRenderMonthElement(value: /* props */ IsVisible => String | ReactElement): Self = this.set("renderMonthElement", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderMonthElement: Self = this.set("renderMonthElement", js.undefined)
    @scala.inline
    def setRenderMonthText(value: /* day */ momentObj => String | ReactElement): Self = this.set("renderMonthText", js.Any.fromFunction1(value))
    @scala.inline
