...
@js.native
trait SingleDatePickerPhrases extends StObject {
...
object SingleDatePickerPhrases {
  ...
  @scala.inline
  implicit class SingleDatePickerPhrasesMutableBuilder[Self <: SingleDatePickerPhrases] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCloseDatePicker(value: String): Self = StObject.set(x, "closeDatePicker", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCloseDatePickerUndefined: Self = StObject.set(x, "closeDatePicker", js.undefined)
