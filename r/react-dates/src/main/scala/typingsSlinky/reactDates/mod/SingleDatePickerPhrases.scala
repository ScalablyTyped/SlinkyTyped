...
trait SingleDatePickerPhrases extends js.Object {
  ...
  var chooseAvailableDate: js.UndefOr[js.Function1[/* date */ String, String]] = js.native
...
object SingleDatePickerPhrases {
  @scala.inline
  def apply(): SingleDatePickerPhrases = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SingleDatePickerPhrases]
  }
  @scala.inline
  implicit class SingleDatePickerPhrasesOps[Self <: SingleDatePickerPhrases] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withChooseAvailableDate(value: /* date */ String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("chooseAvailableDate")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutChooseAvailableDate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("chooseAvailableDate")(js.undefined)
        ret
    }
    @scala.inline
