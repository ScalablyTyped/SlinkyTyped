...
object FirstVisibleMonthIndex {
  ...
  implicit class FirstVisibleMonthIndexOps[Self <: FirstVisibleMonthIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnMonthTransitionEnd(value: /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLDivElement]] => Unit): Self = this.set("onMonthTransitionEnd", js.Any.fromFunction1(value))
