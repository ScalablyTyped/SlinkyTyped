...
trait RenderMonthText extends RenderMonthProps {
  ...
  var renderMonthElement: js.UndefOr[(js.Function1[/* props */ IsVisible, ReactElement]) | Null] = js.native
...
object RenderMonthText {
  ...
  implicit class RenderMonthTextMutableBuilder[Self <: RenderMonthText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderMonthElement(value: /* props */ IsVisible => ReactElement): Self = StObject.set(x, "renderMonthElement", js.Any.fromFunction1(value))
