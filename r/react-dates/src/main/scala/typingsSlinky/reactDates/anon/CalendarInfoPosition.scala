...
object CalendarInfoPosition {
  ...
  implicit class CalendarInfoPositionOps[Self <: CalendarInfoPosition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNavNext(value: ReactElement): Self = this.set("navNext", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNavPrev(value: ReactElement): Self = this.set("navPrev", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBlur(value: SyntheticKeyboardEvent[HTMLDivElement] => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnOutsideClick(value: /* e */ SyntheticMouseEvent[HTMLElement] => Unit): Self = this.set("onOutsideClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnTab(value: SyntheticKeyboardEvent[HTMLDivElement] => Unit): Self = this.set("onTab", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderCalendarInfo(value: () => ReactElement): Self = this.set("renderCalendarInfo", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setRenderKeyboardShortcutsButton(value: /* props */ OnClick => ReactElement): Self = this.set("renderKeyboardShortcutsButton", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteRenderKeyboardShortcutsButton: Self = this.set("renderKeyboardShortcutsButton", js.undefined)
    
    @scala.inline
    def setRenderKeyboardShortcutsPanel(value: /* props */ CloseButtonAriaLabel => ReactElement): Self = this.set("renderKeyboardShortcutsPanel", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteRenderKeyboardShortcutsPanel: Self = this.set("renderKeyboardShortcutsPanel", js.undefined)
    
    @scala.inline
    def setRenderNavNextButton(value: /* props */ AriaLabel => ReactElement): Self = this.set("renderNavNextButton", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderNavPrevButton(value: /* props */ AriaLabel => ReactElement): Self = this.set("renderNavPrevButton", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderWeekHeaderElement(value: /* day */ String => ReactElement): Self = this.set("renderWeekHeaderElement", js.Any.fromFunction1(value))
