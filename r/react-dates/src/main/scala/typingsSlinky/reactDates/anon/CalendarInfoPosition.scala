...
import typingsSlinky.reactDates.mod.DayPickerPhrases
...
trait CalendarInfoPosition extends StObject {
  ...
  var onOutsideClick: js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[HTMLElement], Unit]] = js.native
  ...
  var renderKeyboardShortcutsButton: js.UndefOr[js.Function1[/* props */ OnClick, ReactElement]] = js.native
  
  var renderKeyboardShortcutsPanel: js.UndefOr[js.Function1[/* props */ CloseButtonAriaLabel, ReactElement]] = js.native
...
object CalendarInfoPosition {
  ...
  implicit class CalendarInfoPositionMutableBuilder[Self <: CalendarInfoPosition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNavNext(value: ReactElement): Self = StObject.set(x, "navNext", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNavNextReactElement(value: ReactElement): Self = StObject.set(x, "navNext", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNavPrev(value: ReactElement): Self = StObject.set(x, "navPrev", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNavPrevReactElement(value: ReactElement): Self = StObject.set(x, "navPrev", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBlur(value: SyntheticKeyboardEvent[HTMLDivElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnOutsideClick(value: /* e */ SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onOutsideClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnTab(value: SyntheticKeyboardEvent[HTMLDivElement] => Unit): Self = StObject.set(x, "onTab", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderCalendarInfo(value: () => ReactElement): Self = StObject.set(x, "renderCalendarInfo", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setRenderKeyboardShortcutsButton(value: /* props */ OnClick => ReactElement): Self = StObject.set(x, "renderKeyboardShortcutsButton", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRenderKeyboardShortcutsButtonUndefined: Self = StObject.set(x, "renderKeyboardShortcutsButton", js.undefined)
    
    @scala.inline
    def setRenderKeyboardShortcutsPanel(value: /* props */ CloseButtonAriaLabel => ReactElement): Self = StObject.set(x, "renderKeyboardShortcutsPanel", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRenderKeyboardShortcutsPanelUndefined: Self = StObject.set(x, "renderKeyboardShortcutsPanel", js.undefined)
    
    @scala.inline
    def setRenderNavNextButton(value: /* props */ AriaLabel => ReactElement): Self = StObject.set(x, "renderNavNextButton", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderNavPrevButton(value: /* props */ AriaLabel => ReactElement): Self = StObject.set(x, "renderNavPrevButton", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderWeekHeaderElement(value: /* day */ String => ReactElement): Self = StObject.set(x, "renderWeekHeaderElement", js.Any.fromFunction1(value))
