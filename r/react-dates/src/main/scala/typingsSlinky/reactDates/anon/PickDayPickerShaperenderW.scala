...
@js.native
trait PickDayPickerShaperenderW extends js.Object {
...
object PickDayPickerShaperenderW {
  ...
  @scala.inline
  implicit class PickDayPickerShaperenderWOps[Self <: PickDayPickerShaperenderW] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderKeyboardShortcutsButton(value: js.Any): Self = this.set("renderKeyboardShortcutsButton", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRenderKeyboardShortcutsButton: Self = this.set("renderKeyboardShortcutsButton", js.undefined)
    
    @scala.inline
    def setRenderKeyboardShortcutsPanel(value: js.Any): Self = this.set("renderKeyboardShortcutsPanel", value.asInstanceOf[js.Any])
