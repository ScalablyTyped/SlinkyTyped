...
object ReadMoreProps {
  ...
  implicit class ReadMorePropsOps[Self <: ReadMoreProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderRevealedFooter(value: js.Function0[Unit] => ReactElement): Self = this.set("renderRevealedFooter", js.Any.fromFunction1(value))
    @scala.inline
    def setRenderTruncatedFooter(value: js.Function0[Unit] => ReactElement): Self = this.set("renderTruncatedFooter", js.Any.fromFunction1(value))
    @scala.inline
