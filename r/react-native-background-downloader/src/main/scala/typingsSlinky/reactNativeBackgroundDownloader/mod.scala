...
object mod extends Shortcut {
  ...
  object DownloadTaskState extends StObject {
    ...
    /* "DONE" */ val DONE: typingsSlinky.reactNativeBackgroundDownloader.mod.DownloadTaskState.DONE with String = js.native
    
    @js.native
    sealed trait DOWNLOADING extends DownloadTaskState
    /* "DOWNLOADING" */ val DOWNLOADING: typingsSlinky.reactNativeBackgroundDownloader.mod.DownloadTaskState.DOWNLOADING with String = js.native
    
    @js.native
    sealed trait FAILED extends DownloadTaskState
    /* "FAILED" */ val FAILED: typingsSlinky.reactNativeBackgroundDownloader.mod.DownloadTaskState.FAILED with String = js.native
    
    @js.native
    sealed trait PAUSED extends DownloadTaskState
    /* "PAUSED" */ val PAUSED: typingsSlinky.reactNativeBackgroundDownloader.mod.DownloadTaskState.PAUSED with String = js.native
    
    @js.native
    sealed trait STOPPED extends DownloadTaskState
    /* "STOPPED" */ val STOPPED: typingsSlinky.reactNativeBackgroundDownloader.mod.DownloadTaskState.STOPPED with String = js.native
  }
  ...
  trait RNBackgroundDownloader extends StObject {
    ...
    var Network: typingsSlinky.reactNativeBackgroundDownloader.mod.Network = js.native
    
    var Priority: typingsSlinky.reactNativeBackgroundDownloader.mod.Priority = js.native
