...
import typingsSlinky.reselect.mod.OutputParametricSelector
import typingsSlinky.reselect.mod.OutputSelector
import typingsSlinky.reselect.mod.ParametricSelector
import typingsSlinky.reselect.mod.Selector
...
trait FnCall extends js.Object {
  def apply[S1, R1, T](selectors: js.Array[Selector[S1, R1]], combiner: js.Function1[/* res1 */ R1, T]): OutputSelector[S1, T, js.Function1[/* res1 */ R1, T]] = js.native
  def apply[S, R1, T](selector: Selector[S, R1], combiner: js.Function1[/* res */ R1, T]): OutputSelector[S, T, js.Function1[/* res */ R1, T]] = js.native
  def apply[S, R1, R2, T](
