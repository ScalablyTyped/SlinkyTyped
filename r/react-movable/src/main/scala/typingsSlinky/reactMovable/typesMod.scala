...
import typingsSlinky.reactMovable.anon.Ref
...
object typesMod {
  ...
  object IItemProps {
    ...
    implicit class IItemPropsMutableBuilder[Self <: IItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnKeyDown(value: /* e */ SyntheticKeyboardEvent[Element] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnKeyDownUndefined: Self = StObject.set(x, "onKeyDown", js.undefined)
      
      @scala.inline
      def setOnWheel(value: /* e */ SyntheticWheelEvent[Element] => Unit): Self = StObject.set(x, "onWheel", js.Any.fromFunction1(value))
  ...
  object IProps {
    ...
    implicit class IPropsMutableBuilder[Self <: IProps[_], Value] (val x: Self with IProps[Value]) extends AnyVal {
      ...
      @scala.inline
      def setRenderItem(value: RenderItemParams[Value] => ReactElement): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRenderList(value: RenderListParams => ReactElement): Self = StObject.set(x, "renderList", js.Any.fromFunction1(value))
