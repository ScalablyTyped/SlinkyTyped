...
@js.native
trait RenderItemParams[Value] extends js.Object {
...
object RenderItemParams {
  ...
  @scala.inline
  implicit class RenderItemParamsOps[Self <: RenderItemParams[_], Value] (val x: Self with RenderItemParams[Value]) extends AnyVal {
