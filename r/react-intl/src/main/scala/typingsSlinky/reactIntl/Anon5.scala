...
object Anon5 {
  @scala.inline
  def apply[P, IntlPropName](WrappedComponent: ReactComponentClass[P]): Anon5[P, IntlPropName] = {
    val __obj = js.Dynamic.literal(WrappedComponent = WrappedComponent.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon5[P, IntlPropName]]
  }
  @scala.inline
  implicit class Anon5Ops[Self[p, intlpropname] <: Anon5[p, intlpropname], P, IntlPropName] (val x: Self[P, IntlPropName]) extends AnyVal {
    @scala.inline
