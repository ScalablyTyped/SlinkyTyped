...
object FormattedPlural {
  ...
  def withProps(p: PickProps2childrenotherze): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FormattedPlural.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
