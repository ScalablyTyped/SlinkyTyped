...
object Anon4 {
  @scala.inline
  def apply[P, IntlPropName](WrappedComponent: ReactComponentClass[P]): Anon4[P, IntlPropName] = {
    val __obj = js.Dynamic.literal(WrappedComponent = WrappedComponent.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon4[P, IntlPropName]]
  }
  @scala.inline
  implicit class Anon4Ops[Self[p, intlpropname] <: Anon4[p, intlpropname], P, IntlPropName] (val x: Self[P, IntlPropName]) extends AnyVal {
    @scala.inline
