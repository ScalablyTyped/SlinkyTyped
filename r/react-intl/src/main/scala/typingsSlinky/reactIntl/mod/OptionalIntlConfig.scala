...
/* Inlined react-intl.react-intl.Omit<react-intl.react-intl.IntlConfig, keyof std.Pick<react-intl.react-intl.IntlConfig, 'formats' | 'messages' | 'timeZone' | 'textComponent' | 'defaultLocale' | 'defaultFormats' | 'onError'>> & std.Partial<std.Pick<react-intl.react-intl.IntlConfig, 'formats' | 'messages' | 'timeZone' | 'textComponent' | 'defaultLocale' | 'defaultFormats' | 'onError'>> */
@js.native
trait OptionalIntlConfig extends js.Object {
  ...
  var onError: js.UndefOr[js.Function1[/* err */ String, Unit]] = js.native
...
object OptionalIntlConfig {
  ...
  implicit class OptionalIntlConfigOps[Self <: OptionalIntlConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutDefaultFormats: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defaultFormats")(js.undefined)
        ret
    }
    @scala.inline
