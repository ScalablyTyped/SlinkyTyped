...
package object injectIntlMod {
  type WithIntlProps[P] = (typingsSlinky.reactIntl.typesMod.Omit[P, typingsSlinky.reactIntl.reactIntlStrings.intl]) with typingsSlinky.reactIntl.anon.ForwardedRef
