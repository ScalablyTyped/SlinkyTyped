...
trait `7` extends js.Object {
  ...
  var value: /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<react-intl.react-intl/lib/src/types.IntlShape['formatDisplayName']>[0] */ js.Any = js.native
}
object `7` {
