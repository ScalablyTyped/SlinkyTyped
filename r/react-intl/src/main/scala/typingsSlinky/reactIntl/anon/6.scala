...
trait `6` extends js.Object {
  ...
  var value: /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<react-intl.react-intl/lib/src/types.IntlShape['formatList']>[0] */ js.Any = js.native
}
object `6` {
