...
object DateTimeFormatOptionsCustChildren {
  @scala.inline
  def apply(children: js.Array[DateTimeFormatPart] => ReactElement | Null): DateTimeFormatOptionsCustChildren = {
    val __obj = js.Dynamic.literal(children = js.Any.fromFunction1(children))
    __obj.asInstanceOf[DateTimeFormatOptionsCustChildren]
  }
  @scala.inline
  implicit class DateTimeFormatOptionsCustChildrenOps[Self <: DateTimeFormatOptionsCustChildren] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withChildren(value: js.Array[DateTimeFormatPart] => ReactElement | Null): Self = {
