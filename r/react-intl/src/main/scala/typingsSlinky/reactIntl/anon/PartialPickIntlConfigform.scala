...
/* Inlined std.Partial<std.Pick<react-intl.react-intl/src/types.IntlConfig, 'formats' | 'messages' | 'timeZone' | 'textComponent' | 'defaultLocale' | 'defaultFormats' | 'onError'>> */
@js.native
trait PartialPickIntlConfigform extends js.Object {
...
object PartialPickIntlConfigform {
  
  @scala.inline
  def apply(): PartialPickIntlConfigform = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPickIntlConfigform]
  }
  
  @scala.inline
  implicit class PartialPickIntlConfigformOps[Self <: PartialPickIntlConfigform] (val x: Self) extends AnyVal {
