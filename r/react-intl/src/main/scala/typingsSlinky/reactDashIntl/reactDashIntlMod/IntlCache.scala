...
trait IntlCache extends js.Object {
  ...
  var message: Record[String, typingsSlinky.intlDashMessageformat.intlDashMessageformatMod.default]
...
object IntlCache {
  ...
  def apply(
    ...
    message: Record[String, typingsSlinky.intlDashMessageformat.intlDashMessageformatMod.default],
