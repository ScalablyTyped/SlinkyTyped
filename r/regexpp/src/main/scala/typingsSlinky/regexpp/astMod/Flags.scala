...
trait Flags
  ...
  @JSName("type")
  var type_Flags: typingsSlinky.regexpp.regexppStrings.Flags = js.native
...
object Flags {
  ...
  implicit class FlagsMutableBuilder[Self <: Flags] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.regexpp.regexppStrings.Flags): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
