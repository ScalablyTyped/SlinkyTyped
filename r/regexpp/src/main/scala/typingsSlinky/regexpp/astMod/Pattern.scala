...
trait Pattern
  ...
  @JSName("type")
  var type_Pattern: typingsSlinky.regexpp.regexppStrings.Pattern = js.native
}
object Pattern {
  ...
  implicit class PatternMutableBuilder[Self <: Pattern] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.regexpp.regexppStrings.Pattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
