...
trait Character
  ...
  @JSName("type")
  var type_Character: typingsSlinky.regexpp.regexppStrings.Character = js.native
...
object Character {
  ...
  implicit class CharacterMutableBuilder[Self <: Character] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.regexpp.regexppStrings.Character): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
