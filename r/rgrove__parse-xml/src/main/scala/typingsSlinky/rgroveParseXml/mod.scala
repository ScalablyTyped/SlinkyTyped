package typingsSlinky.rgroveParseXml
...
object mod {
  ...
  */
  ...
  object Node {
    ...
    @scala.inline
    def CData(text: String, `type`: cdata): typingsSlinky.rgroveParseXml.mod.CData = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rgroveParseXml.mod.CData]
    }
    
    @scala.inline
    def Comment(content: String, `type`: comment): typingsSlinky.rgroveParseXml.mod.Comment = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rgroveParseXml.mod.Comment]
    }
    
    @scala.inline
    def Element(attributes: StringDictionary[String], children: js.Array[NodeBase], name: String, `type`: element): typingsSlinky.rgroveParseXml.mod.Element = {
      val __obj = js.Dynamic.literal(attributes = attributes.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rgroveParseXml.mod.Element]
    }
    
    @scala.inline
    def Text(text: String, `type`: text): typingsSlinky.rgroveParseXml.mod.Text = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rgroveParseXml.mod.Text]
    }
  }
