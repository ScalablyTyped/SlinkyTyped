...
import typingsSlinky.reactDashFoundation.componentsFlexDashVideoMod.FlexVideoProps
...
object FlexVideo
  ...
  def apply(
    ...
    isVimeo: js.UndefOr[Boolean] = js.undefined,
    isWidescreen: js.UndefOr[Boolean] = js.undefined,
    itemID: String = null,
    ...
    if (!js.isUndefined(isVimeo)) __obj.updateDynamic("isVimeo")(isVimeo.asInstanceOf[js.Any])
    if (!js.isUndefined(isWidescreen)) __obj.updateDynamic("isWidescreen")(isWidescreen.asInstanceOf[js.Any])
