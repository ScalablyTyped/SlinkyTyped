...
import typingsSlinky.reactDashFoundation.componentsThumbnailMod.ThumbnailProps
...
abstract class SharedApply_ThumbnailProps_269677755 (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, js.Object] = new slinky.core.BuildingComponent[slinky.web.html.img.tag.type, js.Object](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
