...
import typingsSlinky.reactDashFoundation.componentsSliderMod.TwoHandleSliderProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object TwoHandleSlider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashFoundation.componentsSliderMod.TwoHandleSlider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashFoundation.componentsSliderMod.TwoHandleSlider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashFoundation.componentsSliderMod.TwoHandleSlider] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.reactDashFoundation.componentsSliderMod.TwoHandleSlider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
