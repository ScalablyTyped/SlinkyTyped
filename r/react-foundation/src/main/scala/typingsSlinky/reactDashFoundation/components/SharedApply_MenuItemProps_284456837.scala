...
import typingsSlinky.reactDashFoundation.componentsMenuMod.MenuItemProps
...
abstract class SharedApply_MenuItemProps_284456837 (implicit pw: ExternalPropsWriterProvider)
