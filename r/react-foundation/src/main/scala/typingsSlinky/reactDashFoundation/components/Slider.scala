...
import typingsSlinky.reactDashFoundation.componentsSliderMod.SliderHandleProps
import typingsSlinky.reactDashFoundation.componentsSliderMod.SliderProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Slider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashFoundation.componentsSliderMod.Slider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashFoundation.componentsSliderMod.Slider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashFoundation.componentsSliderMod.Slider] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.reactDashFoundation.componentsSliderMod.Slider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
