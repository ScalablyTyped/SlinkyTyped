...
import typingsSlinky.reactDashFoundation.componentsResponsiveMod.MenuIconProps
import typingsSlinky.reactDashFoundation.componentsResponsiveMod.ResponsiveNavigationProps
import typingsSlinky.reactDashFoundation.componentsResponsiveMod.TitleBarProps
import typingsSlinky.reactDashFoundation.componentsResponsiveMod.TitleBarTitleProps
import typingsSlinky.reactDashFoundation.componentsTopDashBarMod.TopBarProps
...
object ResponsiveNavigation
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashFoundation.reactDashFoundationMod.ResponsiveNavigation
    ] {
  ...
  typingsSlinky.reactDashFoundation.reactDashFoundationMod.ResponsiveNavigation](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ResponsiveNavigationProps
}
