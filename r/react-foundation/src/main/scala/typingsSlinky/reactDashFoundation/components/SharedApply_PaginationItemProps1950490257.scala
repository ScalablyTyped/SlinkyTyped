...
import typingsSlinky.reactDashFoundation.componentsPaginationMod.PaginationItemProps
...
abstract class SharedApply_PaginationItemProps1950490257 (implicit pw: ExternalPropsWriterProvider)
