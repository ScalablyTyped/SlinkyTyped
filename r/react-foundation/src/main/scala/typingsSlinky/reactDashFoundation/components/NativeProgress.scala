...
import typingsSlinky.reactDashFoundation.componentsProgressDashBarMod.NativeProgressProps
...
object NativeProgress
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, js.Object] = new slinky.core.BuildingComponent[slinky.web.html.progress.tag.type, js.Object](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = NativeProgressProps
}
