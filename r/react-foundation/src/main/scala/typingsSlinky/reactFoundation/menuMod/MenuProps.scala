...
object MenuProps {
  ...
  implicit class MenuPropsOps[Self <: MenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlignment(value: MenuAlignments): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHorizontalOnMedium(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("horizontalOnMedium")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHorizontalOnMedium: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("horizontalOnMedium")(js.undefined)
        ret
    }
    @scala.inline
    def withIconsOnTop(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iconsOnTop")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIconsOnTop: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iconsOnTop")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withoutIsSimple: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isSimple")(js.undefined)
        ret
    }
    @scala.inline
