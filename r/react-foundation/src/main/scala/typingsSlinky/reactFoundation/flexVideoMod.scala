...
object flexVideoMod {
  ...
  trait FlexVideoProps
    ...
    var isVimeo: js.UndefOr[Boolean] = js.native
    
    var isWidescreen: js.UndefOr[Boolean] = js.native
  ...
  object FlexVideoProps {
    ...
    @scala.inline
    def apply(): FlexVideoProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FlexVideoProps]
    }
    
    @scala.inline
    implicit class FlexVideoPropsMutableBuilder[Self <: FlexVideoProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIsVimeo(value: Boolean): Self = StObject.set(x, "isVimeo", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsVimeoUndefined: Self = StObject.set(x, "isVimeo", js.undefined)
      
      @scala.inline
      def setIsWidescreen(value: Boolean): Self = StObject.set(x, "isWidescreen", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsWidescreenUndefined: Self = StObject.set(x, "isWidescreen", js.undefined)
