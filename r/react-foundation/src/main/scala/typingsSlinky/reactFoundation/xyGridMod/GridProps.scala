...
object GridProps {
  ...
  def apply(
    ...
    upOnLarge: js.UndefOr[Double] = js.undefined,
    upOnMedium: js.UndefOr[Double] = js.undefined,
    upOnSmall: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(upOnLarge)) __obj.updateDynamic("upOnLarge")(upOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(upOnMedium)) __obj.updateDynamic("upOnMedium")(upOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(upOnSmall)) __obj.updateDynamic("upOnSmall")(upOnSmall.get.asInstanceOf[js.Any])
