...
object GridProps {
  ...
  implicit class GridPropsOps[Self <: GridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCollapseOnLarge(value: GutterTypes): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCollapseOnMedium(value: GutterTypes): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCollapseOnSmall(value: GutterTypes): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGridFrame(value: ExtendedBreakpoints): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gridFrame")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutGridFrame: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gridFrame")(js.undefined)
        ret
    }
    @scala.inline
    def withGutters(value: GutterTypes): Self = {
        val ret = this.duplicate
