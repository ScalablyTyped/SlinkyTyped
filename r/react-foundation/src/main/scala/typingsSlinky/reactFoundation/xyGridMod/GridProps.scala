package typingsSlinky.reactFoundation.xyGridMod
...
object GridProps {
  ...
  implicit class GridPropsOps[Self <: GridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCollapseOnLarge(value: GutterTypes): Self = this.set("collapseOnLarge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCollapseOnLarge: Self = this.set("collapseOnLarge", js.undefined)
    
    @scala.inline
    def setCollapseOnMedium(value: GutterTypes): Self = this.set("collapseOnMedium", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCollapseOnMedium: Self = this.set("collapseOnMedium", js.undefined)
    
    @scala.inline
    def setCollapseOnSmall(value: GutterTypes): Self = this.set("collapseOnSmall", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCollapseOnSmall: Self = this.set("collapseOnSmall", js.undefined)
    ...
    @scala.inline
    def setGridFrame(value: ExtendedBreakpoints): Self = this.set("gridFrame", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGridFrame: Self = this.set("gridFrame", js.undefined)
    
    @scala.inline
    def setGutters(value: GutterTypes): Self = this.set("gutters", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUpOnLarge(value: Double): Self = this.set("upOnLarge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUpOnLarge: Self = this.set("upOnLarge", js.undefined)
    
    @scala.inline
    def setUpOnMedium(value: Double): Self = this.set("upOnMedium", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUpOnMedium: Self = this.set("upOnMedium", js.undefined)
