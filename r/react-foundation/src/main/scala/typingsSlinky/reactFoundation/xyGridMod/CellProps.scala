...
object CellProps {
  ...
  implicit class CellPropsOps[Self <: CellProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuto(value: ExtendedBreakpoints): Self = this.set("auto", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setShrink(value: ExtendedBreakpoints): Self = this.set("shrink", value.asInstanceOf[js.Any])
    @scala.inline
