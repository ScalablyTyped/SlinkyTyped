...
object CellProps {
  ...
  def apply(
    ...
    offsetOnLarge: js.UndefOr[Double] = js.undefined,
    offsetOnMedium: js.UndefOr[Double] = js.undefined,
    offsetOnSmall: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(offsetOnLarge)) __obj.updateDynamic("offsetOnLarge")(offsetOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(offsetOnMedium)) __obj.updateDynamic("offsetOnMedium")(offsetOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(offsetOnSmall)) __obj.updateDynamic("offsetOnSmall")(offsetOnSmall.get.asInstanceOf[js.Any])
