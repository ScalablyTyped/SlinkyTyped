...
- typingsSlinky.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined download, href, hrefLang, media, ping, referrerPolicy, rel, target, `type` */ @js.native
trait LinkProps
