...
object PaginationProps {
  ...
  implicit class PaginationPropsOps[Self <: PaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsSmall(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isSmall")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsSmall: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isSmall")(js.undefined)
        ret
    }
    @scala.inline
    def withIsTiny(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isTiny")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsTiny: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isTiny")(js.undefined)
        ret
    }
    @scala.inline
