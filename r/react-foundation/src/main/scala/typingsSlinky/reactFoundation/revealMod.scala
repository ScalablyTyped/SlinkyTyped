...
object revealMod {
  ...
  @js.native
  val Reveal: ReactComponentClass[PaginationProps] = js.native
  ...
  object PaginationProps {
    ...
    implicit class PaginationPropsMutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIsTiny(value: Boolean): Self = StObject.set(x, "isTiny", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsTinyUndefined: Self = StObject.set(x, "isTiny", js.undefined)
