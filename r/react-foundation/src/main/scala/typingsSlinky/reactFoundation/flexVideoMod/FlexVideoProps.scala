...
object FlexVideoProps {
  ...
  implicit class FlexVideoPropsOps[Self <: FlexVideoProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsVimeo(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isVimeo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsVimeo: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isVimeo")(js.undefined)
        ret
    }
    @scala.inline
    def withIsWidescreen(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isWidescreen")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsWidescreen: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isWidescreen")(js.undefined)
        ret
    }
    @scala.inline
