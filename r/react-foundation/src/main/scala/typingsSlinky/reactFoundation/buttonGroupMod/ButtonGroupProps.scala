...
object ButtonGroupProps {
  ...
  implicit class ButtonGroupPropsOps[Self <: ButtonGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColor(value: ButtonGroupColors | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSize(value: ButtonGroupSizes): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStackFor(value: Breakpoints): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stackFor")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStackFor: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stackFor")(js.undefined)
        ret
    }
    @scala.inline
