package typingsSlinky.reactFoundation.buttonGroupMod
...
object ButtonGroupProps {
  ...
  implicit class ButtonGroupPropsOps[Self <: ButtonGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: ButtonGroupColors | String): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSize(value: ButtonGroupSizes): Self = this.set("size", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStackFor(value: Breakpoints): Self = this.set("stackFor", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteStackFor: Self = this.set("stackFor", js.undefined)
    @scala.inline
