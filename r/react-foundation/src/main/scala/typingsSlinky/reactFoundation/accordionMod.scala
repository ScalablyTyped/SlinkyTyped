...
object accordionMod {
  ...
  @JSImport("react-foundation/components/accordion", "Accordion")
  @js.native
  val Accordion: ReactComponentClass[AccordianProps] = js.native
  
  @JSImport("react-foundation/components/accordion", "AccordionContent")
  @js.native
  val AccordionContent: ReactComponentClass[AccordianContentProps] = js.native
  
  @JSImport("react-foundation/components/accordion", "AccordionItem")
  @js.native
  val AccordionItem: ReactComponentClass[AccordianItemProps] = js.native
  
  @JSImport("react-foundation/components/accordion", "AccordionTitle")
  @js.native
  ...
  object AccordianContentProps {
    ...
    @scala.inline
    def apply(): AccordianContentProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AccordianContentProps]
    }
    
    @scala.inline
    implicit class AccordianContentPropsMutableBuilder[Self <: AccordianContentProps] (val x: Self) extends AnyVal {
  ...
  object AccordianItemProps {
    ...
    @scala.inline
    def apply(): AccordianItemProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AccordianItemProps]
    }
    
    @scala.inline
    implicit class AccordianItemPropsMutableBuilder[Self <: AccordianItemProps] (val x: Self) extends AnyVal {
  ...
  object AccordianProps {
    ...
    @scala.inline
    def apply(): AccordianProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AccordianProps]
    }
    
    @scala.inline
    implicit class AccordianPropsMutableBuilder[Self <: AccordianProps] (val x: Self) extends AnyVal {
  ...
  trait AccordionTitleProps extends AnchorHTMLAttributes[HTMLAnchorElement] {
  ...
  object AccordionTitleProps {
    ...
    @scala.inline
    implicit class AccordionTitlePropsMutableBuilder[Self <: AccordionTitleProps] (val x: Self) extends AnyVal {
