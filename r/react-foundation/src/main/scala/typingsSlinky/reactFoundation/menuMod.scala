...
object menuMod {
  ...
  object MenuProps {
    ...
    implicit class MenuPropsMutableBuilder[Self <: MenuProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAlignment(value: MenuAlignments): Self = StObject.set(x, "alignment", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHorizontalOnMedium(value: Boolean): Self = StObject.set(x, "horizontalOnMedium", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHorizontalOnMediumUndefined: Self = StObject.set(x, "horizontalOnMedium", js.undefined)
      
      @scala.inline
      def setIconsOnTop(value: Boolean): Self = StObject.set(x, "iconsOnTop", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIconsOnTopUndefined: Self = StObject.set(x, "iconsOnTop", js.undefined)
      ...
      @scala.inline
      def setIsDropdown(value: Boolean): Self = StObject.set(x, "isDropdown", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsDropdownUndefined: Self = StObject.set(x, "isDropdown", js.undefined)
      ...
      @scala.inline
      def setIsSimpleUndefined: Self = StObject.set(x, "isSimple", js.undefined)
