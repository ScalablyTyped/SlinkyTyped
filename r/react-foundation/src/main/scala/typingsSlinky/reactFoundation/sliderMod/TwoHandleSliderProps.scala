...
- typingsSlinky.reactFoundation.sliderMod.SliderCommonProps because var conflicts: className. Inlined isVertical, isDisabled */ trait TwoHandleSliderProps extends HTMLAttributes[HTMLDivElement] {
