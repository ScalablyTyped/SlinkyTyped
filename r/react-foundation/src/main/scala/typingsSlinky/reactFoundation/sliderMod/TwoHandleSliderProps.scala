...
object TwoHandleSliderProps {
  ...
  implicit class TwoHandleSliderPropsOps[Self <: TwoHandleSliderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxHandle(value: SliderHandleProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxHandle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMaxHandle: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxHandle")(js.undefined)
        ret
    }
    @scala.inline
    def withMinHandle(value: SliderHandleProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minHandle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMinHandle: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minHandle")(js.undefined)
        ret
    }
  }
