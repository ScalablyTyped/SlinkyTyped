...
object RowProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(collapseOnLarge)) __obj.updateDynamic("collapseOnLarge")(collapseOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(collapseOnMedium)) __obj.updateDynamic("collapseOnMedium")(collapseOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(collapseOnSmall)) __obj.updateDynamic("collapseOnSmall")(collapseOnSmall.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(uncollapseOnLarge)) __obj.updateDynamic("uncollapseOnLarge")(uncollapseOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(uncollapseOnMedium)) __obj.updateDynamic("uncollapseOnMedium")(uncollapseOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(uncollapseOnSmall)) __obj.updateDynamic("uncollapseOnSmall")(uncollapseOnSmall.get.asInstanceOf[js.Any])
    if (unselectable != null) __obj.updateDynamic("unselectable")(unselectable.asInstanceOf[js.Any])
    if (!js.isUndefined(unstackOnLarge)) __obj.updateDynamic("unstackOnLarge")(unstackOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(unstackOnMedium)) __obj.updateDynamic("unstackOnMedium")(unstackOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(unstackOnSmall)) __obj.updateDynamic("unstackOnSmall")(unstackOnSmall.get.asInstanceOf[js.Any])
