...
object RowProps {
  ...
  implicit class RowPropsOps[Self <: RowProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCollapseOnLarge(value: Boolean): Self = this.set("collapseOnLarge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCollapseOnLarge: Self = this.set("collapseOnLarge", js.undefined)
    
    @scala.inline
    def setCollapseOnMedium(value: Boolean): Self = this.set("collapseOnMedium", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCollapseOnMedium: Self = this.set("collapseOnMedium", js.undefined)
    
    @scala.inline
    def setCollapseOnSmall(value: Boolean): Self = this.set("collapseOnSmall", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUncollapseOnLarge(value: Boolean): Self = this.set("uncollapseOnLarge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUncollapseOnLarge: Self = this.set("uncollapseOnLarge", js.undefined)
    
    @scala.inline
    def setUncollapseOnMedium(value: Boolean): Self = this.set("uncollapseOnMedium", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUncollapseOnMedium: Self = this.set("uncollapseOnMedium", js.undefined)
    
    @scala.inline
    def setUncollapseOnSmall(value: Boolean): Self = this.set("uncollapseOnSmall", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUncollapseOnSmall: Self = this.set("uncollapseOnSmall", js.undefined)
    ...
    @scala.inline
    def setUnstackOnLarge(value: Boolean): Self = this.set("unstackOnLarge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUnstackOnLarge: Self = this.set("unstackOnLarge", js.undefined)
    
    @scala.inline
    def setUnstackOnMedium(value: Boolean): Self = this.set("unstackOnMedium", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUnstackOnMedium: Self = this.set("unstackOnMedium", js.undefined)
    
    @scala.inline
    def setUnstackOnSmall(value: Boolean): Self = this.set("unstackOnSmall", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUnstackOnSmall: Self = this.set("unstackOnSmall", js.undefined)
