...
object ResponsiveNavigationProps {
  ...
  implicit class ResponsiveNavigationPropsOps[Self <: ResponsiveNavigationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMenuIcon(value: MenuIconProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitleBar(value: TitleBarProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitleBarTitle(value: TitleBarTitleProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("titleBarTitle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTitleBarTitle: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("titleBarTitle")(js.undefined)
        ret
    }
    @scala.inline
    def withTopBar(value: TopBarProps): Self = {
        val ret = this.duplicate
