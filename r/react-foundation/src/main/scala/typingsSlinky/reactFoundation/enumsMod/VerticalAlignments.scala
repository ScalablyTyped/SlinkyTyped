...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactFoundation.reactFoundationStrings.top
  - typingsSlinky.reactFoundation.reactFoundationStrings.middle
  - typingsSlinky.reactFoundation.reactFoundationStrings.bottom
  - typingsSlinky.reactFoundation.reactFoundationStrings.stretch
*/
