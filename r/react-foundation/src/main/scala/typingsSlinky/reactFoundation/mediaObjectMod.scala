...
object mediaObjectMod {
  ...
  object MediaObjectProps {
    ...
    @scala.inline
    implicit class MediaObjectPropsMutableBuilder[Self <: MediaObjectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStackForSmall(value: Boolean): Self = StObject.set(x, "stackForSmall", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStackForSmallUndefined: Self = StObject.set(x, "stackForSmall", js.undefined)
  ...
  trait MediaObjectSectionProps
    ...
    var alignment: js.UndefOr[HorizontalAlignments] = js.native
    ...
    var isBottom: js.UndefOr[Boolean] = js.native
    
    var isMain: js.UndefOr[Boolean] = js.native
    
    var isMiddle: js.UndefOr[Boolean] = js.native
  ...
  object MediaObjectSectionProps {
    ...
    @scala.inline
    def apply(): MediaObjectSectionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MediaObjectSectionProps]
    }
    
    @scala.inline
    implicit class MediaObjectSectionPropsMutableBuilder[Self <: MediaObjectSectionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAlignment(value: HorizontalAlignments): Self = StObject.set(x, "alignment", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIsBottom(value: Boolean): Self = StObject.set(x, "isBottom", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsBottomUndefined: Self = StObject.set(x, "isBottom", js.undefined)
      
      @scala.inline
      def setIsMain(value: Boolean): Self = StObject.set(x, "isMain", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsMainUndefined: Self = StObject.set(x, "isMain", js.undefined)
      
      @scala.inline
      def setIsMiddle(value: Boolean): Self = StObject.set(x, "isMiddle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsMiddleUndefined: Self = StObject.set(x, "isMiddle", js.undefined)
