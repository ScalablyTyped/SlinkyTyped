...
object buttonMod {
  ...
  - typingsSlinky.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined target, media, rel, ping, referrerPolicy, href, download, `type`, hrefLang */ @js.native
  trait LinkProps
    extends ButtonPropsCommon
       with AriaAttributes
