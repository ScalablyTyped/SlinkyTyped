...
trait AnonClearfix extends js.Object {
...
object AnonClearfix {
  ...
  def apply(
    ...
    if (!js.isUndefined(`show-for-landscape`)) __obj.updateDynamic("show-for-landscape")(`show-for-landscape`.asInstanceOf[js.Any])
    if (!js.isUndefined(`show-for-portrait`)) __obj.updateDynamic("show-for-portrait")(`show-for-portrait`.asInstanceOf[js.Any])
    if (!js.isUndefined(`show-for-sr`)) __obj.updateDynamic("show-for-sr")(`show-for-sr`.asInstanceOf[js.Any])
    if (!js.isUndefined(`show-on-focus`)) __obj.updateDynamic("show-on-focus")(`show-on-focus`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonClearfix]
  }
}
