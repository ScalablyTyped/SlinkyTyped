...
object SwitchProps {
  ...
  implicit class SwitchPropsOps[Self <: SwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActive(value: SwitchActiveProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInactive(value: SwitchInactiveProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInput(value: SwitchInputProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPaddle(value: SwitchPaddleProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("paddle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPaddle: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("paddle")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSize(value: SwitchSizes): Self = {
        val ret = this.duplicate
