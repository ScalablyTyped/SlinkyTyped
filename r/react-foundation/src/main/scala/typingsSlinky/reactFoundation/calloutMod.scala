...
object calloutMod {
  ...
  @JSImport("react-foundation/components/callout", "Callout")
  @js.native
  ...
  object CalloutProps {
    ...
    implicit class CalloutPropsMutableBuilder[Self <: CalloutProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: CalloutColors | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSize(value: CalloutSizes): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
