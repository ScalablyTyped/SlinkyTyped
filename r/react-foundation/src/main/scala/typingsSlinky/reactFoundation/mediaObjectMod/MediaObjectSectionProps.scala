...
object MediaObjectSectionProps {
  ...
  implicit class MediaObjectSectionPropsOps[Self <: MediaObjectSectionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlignment(value: HorizontalAlignments): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIsBottom(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isBottom")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsBottom: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isBottom")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withoutIsMain: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isMain")(js.undefined)
        ret
    }
    @scala.inline
    def withIsMiddle(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isMiddle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsMiddle: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isMiddle")(js.undefined)
        ret
    }
    @scala.inline
