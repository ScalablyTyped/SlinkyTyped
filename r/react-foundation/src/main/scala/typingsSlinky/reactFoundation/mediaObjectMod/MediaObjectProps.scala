...
object MediaObjectProps {
  ...
  implicit class MediaObjectPropsOps[Self <: MediaObjectProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStackForSmall(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stackForSmall")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStackForSmall: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stackForSmall")(js.undefined)
        ret
    }
    @scala.inline
