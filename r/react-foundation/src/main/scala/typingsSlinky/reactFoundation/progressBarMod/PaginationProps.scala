...
object PaginationProps {
  ...
  implicit class PaginationPropsOps[Self <: PaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: ProgressColors | String): Self = this.set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMeter(value: ProgressMeterWithTextProps): Self = this.set("meter", value.asInstanceOf[js.Any])
