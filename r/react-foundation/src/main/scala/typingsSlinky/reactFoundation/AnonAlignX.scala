...
trait AnonAlignX extends js.Object {
  var alignX: Requireable[_]
  var alignY: Requireable[_]
  var breakpoint: Validator[_]
  var centerAlign: Requireable[_]
  var flexChild: Requireable[_]
  var flexContainer: Requireable[_]
  var flexDirCol: Requireable[_]
  var flexDirColRev: Requireable[_]
  var flexDirRow: Requireable[_]
  var flexDirRowRev: Requireable[_]
  var flexOrder: Requireable[_]
  var flexOrderLarge: Requireable[_]
  var flexOrderMedium: Requireable[_]
  var flexOrderSmall: Requireable[_]
  var float: Requireable[_]
  var hideFor: Requireable[_]
  var hideOnlyFor: Requireable[_]
  var isClearfix: Requireable[_]
  var isHidden: Requireable[_]
  var isInvisible: Requireable[_]
  var selfAlignX: Requireable[_]
  var selfAlignY: Requireable[_]
  var showFor: Requireable[_]
  var showForLandscape: Requireable[_]
  var showForPortrait: Requireable[_]
  var showForSr: Requireable[_]
  var showOnFocus: Requireable[_]
  var showOnlyFor: Requireable[_]
}
