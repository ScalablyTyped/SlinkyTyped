...
object TitleBarTitle {
  ...
  def withProps(p: TitleBarTitleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TitleBarTitle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
