...
object MediaObject {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def stackForSmall(value: Boolean): this.type = set("stackForSmall", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: MediaObjectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MediaObject.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
