...
object FlexVideo {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def isVimeo(value: Boolean): this.type = set("isVimeo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def isWidescreen(value: Boolean): this.type = set("isWidescreen", value.asInstanceOf[js.Any])
