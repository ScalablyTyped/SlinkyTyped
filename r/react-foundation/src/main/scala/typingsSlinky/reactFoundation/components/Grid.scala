...
object Grid {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def collapseOnLarge(value: GutterTypes): this.type = set("collapseOnLarge", value.asInstanceOf[js.Any])
    @scala.inline
    def collapseOnMedium(value: GutterTypes): this.type = set("collapseOnMedium", value.asInstanceOf[js.Any])
    @scala.inline
    def collapseOnSmall(value: GutterTypes): this.type = set("collapseOnSmall", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def gridFrame(value: ExtendedBreakpoints): this.type = set("gridFrame", value.asInstanceOf[js.Any])
    @scala.inline
    def gutters(value: GutterTypes): this.type = set("gutters", value.asInstanceOf[js.Any])
    @scala.inline
