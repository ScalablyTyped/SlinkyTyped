...
object SwitchActive {
  ...
  def withProps(p: SwitchActiveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SwitchActive.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
