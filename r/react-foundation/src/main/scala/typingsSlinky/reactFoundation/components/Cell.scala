...
object Cell {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def auto(value: ExtendedBreakpoints): this.type = set("auto", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def shrink(value: ExtendedBreakpoints): this.type = set("shrink", value.asInstanceOf[js.Any])
