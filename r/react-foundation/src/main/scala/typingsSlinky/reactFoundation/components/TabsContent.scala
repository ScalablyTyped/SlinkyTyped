...
object TabsContent {
  ...
  def withProps(p: TabsContentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: TabsContent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
