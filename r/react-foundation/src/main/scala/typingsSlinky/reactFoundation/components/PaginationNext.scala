...
object PaginationNext {
  ...
  implicit def make(companion: PaginationNext.type): SharedBuilder_PaginationItemProps88470200 = new SharedBuilder_PaginationItemProps88470200(js.Array(this.component, js.Dictionary.empty))()
}
