...
import typingsSlinky.reactFoundation.revealMod.PaginationProps
...
object Reveal {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def isLarge(value: Boolean): this.type = set("isLarge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def isSmall(value: Boolean): this.type = set("isSmall", value.asInstanceOf[js.Any])
    
    @scala.inline
    def isTiny(value: Boolean): this.type = set("isTiny", value.asInstanceOf[js.Any])
