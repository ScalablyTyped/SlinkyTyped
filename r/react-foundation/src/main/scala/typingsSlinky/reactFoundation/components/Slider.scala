...
object Slider {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.Slider] {
    @scala.inline
    ...
    @scala.inline
    def handle(value: SliderHandleProps): this.type = set("handle", value.asInstanceOf[js.Any])
    @scala.inline
