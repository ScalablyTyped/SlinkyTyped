...
import typingsSlinky.reactFoundation.sliderMod.SliderProps
...
object Slider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactFoundation.mod.Slider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.Slider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.Slider] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactFoundation.mod.Slider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
