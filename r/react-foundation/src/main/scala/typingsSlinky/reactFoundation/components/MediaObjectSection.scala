...
object MediaObjectSection {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def alignment(value: HorizontalAlignments): this.type = set("alignment", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def isBottom(value: Boolean): this.type = set("isBottom", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def isMain(value: Boolean): this.type = set("isMain", value.asInstanceOf[js.Any])
    
    @scala.inline
    def isMiddle(value: Boolean): this.type = set("isMiddle", value.asInstanceOf[js.Any])
  ...
  def withProps(p: MediaObjectSectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: MediaObjectSection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
