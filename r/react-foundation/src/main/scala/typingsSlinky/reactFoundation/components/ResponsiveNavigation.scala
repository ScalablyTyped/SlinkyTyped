...
object ResponsiveNavigation {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.ResponsiveNavigation] {
    ...
    @scala.inline
    def menuIcon(value: MenuIconProps): this.type = set("menuIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def titleBar(value: TitleBarProps): this.type = set("titleBar", value.asInstanceOf[js.Any])
    
    @scala.inline
    def titleBarTitle(value: TitleBarTitleProps): this.type = set("titleBarTitle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def topBar(value: TopBarProps): this.type = set("topBar", value.asInstanceOf[js.Any])
