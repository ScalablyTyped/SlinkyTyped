...
import typingsSlinky.reactFoundation.responsiveMod.ResponsiveNavigationProps
...
object ResponsiveNavigation
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactFoundation.mod.ResponsiveNavigation] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.ResponsiveNavigation] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.ResponsiveNavigation] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.reactFoundation.mod.ResponsiveNavigation](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
