...
object ButtonGroup
  ...
  def apply(
    ...
    color: ButtonGroupColors | String = null,
    ...
    size: ButtonGroupSizes = null,
    slot: String = null,
    stackFor: Breakpoints = null,
    ...
    if (!js.isUndefined(isStacked)) __obj.updateDynamic("isStacked")(isStacked.asInstanceOf[js.Any])
    ...
    if (stackFor != null) __obj.updateDynamic("stackFor")(stackFor.asInstanceOf[js.Any])
