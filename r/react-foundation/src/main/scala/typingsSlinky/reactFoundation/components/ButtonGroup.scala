...
import typingsSlinky.reactFoundation.enumsMod.ButtonGroupColors
import typingsSlinky.reactFoundation.enumsMod.ButtonGroupSizes
...
object ButtonGroup {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def color(value: ButtonGroupColors | String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isStacked(value: Boolean): this.type = set("isStacked", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def size(value: ButtonGroupSizes): this.type = set("size", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stackFor(value: Breakpoints): this.type = set("stackFor", value.asInstanceOf[js.Any])
    @scala.inline
