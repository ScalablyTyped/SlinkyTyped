...
import typingsSlinky.reactFoundation.progressBarMod.PaginationProps
...
object Progress {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def color(value: ProgressColors | String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def meter(value: ProgressMeterWithTextProps): this.type = set("meter", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def valueText(value: String): this.type = set("valueText", value.asInstanceOf[js.Any])
    @scala.inline
