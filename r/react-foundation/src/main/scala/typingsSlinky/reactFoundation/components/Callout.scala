...
import typingsSlinky.reactFoundation.enumsMod.CalloutColors
import typingsSlinky.reactFoundation.enumsMod.CalloutSizes
...
object Callout {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def color(value: CalloutColors | String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def size(value: CalloutSizes): this.type = set("size", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: Callout.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
