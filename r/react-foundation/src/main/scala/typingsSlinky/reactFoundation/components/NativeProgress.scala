...
object NativeProgress
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLProgressElement, Event_] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLProgressElement, Event_] => Unit = null,
