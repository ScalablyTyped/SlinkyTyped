...
import typingsSlinky.reactFoundation.sliderMod.TwoHandleSliderProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object TwoHandleSlider {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.TwoHandleSlider] {
    @scala.inline
    ...
    @scala.inline
    def fill(value: SliderFillProps): this.type = set("fill", value.asInstanceOf[js.Any])
    @scala.inline
    def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    @scala.inline
    def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def initialEnd(value: Double): this.type = set("initialEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def initialStart(value: Double): this.type = set("initialStart", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def maxHandle(value: SliderHandleProps): this.type = set("maxHandle", value.asInstanceOf[js.Any])
    @scala.inline
    def minHandle(value: SliderHandleProps): this.type = set("minHandle", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: TwoHandleSliderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TwoHandleSlider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
