...
object TwoHandleSlider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactFoundation.mod.TwoHandleSlider] {
  ...
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.TwoHandleSlider] = {
    ...
    if (maxHandle != null) __obj.updateDynamic("maxHandle")(maxHandle.asInstanceOf[js.Any])
    if (minHandle != null) __obj.updateDynamic("minHandle")(minHandle.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactFoundation.mod.TwoHandleSlider] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactFoundation.mod.TwoHandleSlider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = TwoHandleSliderProps
}
