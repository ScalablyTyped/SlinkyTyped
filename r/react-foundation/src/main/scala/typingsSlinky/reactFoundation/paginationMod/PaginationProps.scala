...
object PaginationProps {
  ...
  implicit class PaginationPropsOps[Self <: PaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsCentered(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isCentered")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsCentered: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isCentered")(js.undefined)
        ret
    }
    @scala.inline
