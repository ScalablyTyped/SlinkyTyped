...
import typingsSlinky.rrNotifications.mod.NotificationPayload
...
object anon {
  ...
  trait AnimationDuration extends StObject {
    ...
    def renderNotification(args: Payload): ReactElement = js.native
  ...
  object AnimationDuration {
    ...
    @scala.inline
    def apply(renderNotification: Payload => ReactElement): AnimationDuration = {
    ...
    implicit class AnimationDurationMutableBuilder[Self <: AnimationDuration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderNotification(value: Payload => ReactElement): Self = StObject.set(x, "renderNotification", js.Any.fromFunction1(value))
