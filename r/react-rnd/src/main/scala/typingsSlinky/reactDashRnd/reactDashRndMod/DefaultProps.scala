...
object DefaultProps {
  ...
  def apply(
    maxHeight: Double,
    maxWidth: Double,
    onDrag: (/* e */ DraggableEvent, /* data */ typingsSlinky.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false`,
    onDragStart: (/* e */ DraggableEvent, /* data */ typingsSlinky.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false`,
    onDragStop: (/* e */ DraggableEvent, /* data */ typingsSlinky.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false`,
