...
object Props {
  ...
  def apply(
    ...
    onDrag: (/* e */ DraggableEvent, /* data */ typingsSlinky.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false` = null,
    onDragStart: (/* e */ DraggableEvent, /* data */ typingsSlinky.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false` = null,
    onDragStop: (/* e */ DraggableEvent, /* data */ typingsSlinky.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false` = null,
