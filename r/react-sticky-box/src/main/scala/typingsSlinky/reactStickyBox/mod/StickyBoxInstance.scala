...
object StickyBoxInstance {
  ...
  implicit class StickyBoxInstanceOps[Self <: StickyBoxInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScrollPaneWindow(value: Window): Self = this.set("scrollPane", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScrollPaneHTMLElement(value: HTMLElement): Self = this.set("scrollPane", value.asInstanceOf[js.Any])
