...
import typingsSlinky.relayDashCompiler.libCoreGraphQLIRVisitorMod.NodeVisitor
...
import typingsSlinky.relayDashCompiler.libReportersGraphQLConsoleReporterMod.GraphQLMultiReporter
...
object relayDashCompilerMod extends js.Object {
  ...
  class GraphQLCompilerContext protected ()
    extends typingsSlinky.relayDashCompiler.libCoreGraphQLCompilerContextMod.GraphQLCompilerContext {
  ...
  @js.native
  class MultiReporter ()
    extends typingsSlinky.relayDashCompiler.libReportersGraphQLMultiReporterMod.GraphQLMultiReporter {
    /* CompleteClass */
    override def reportError(caughtLocation: String, error: js.Error): Unit = js.native
    /* CompleteClass */
    override def reportMessage(message: String): Unit = js.native
