...
object ClientExtension {
  @scala.inline
  def apply(
    Argument: NodeVisitorObject[typingsSlinky.relayCompiler.iRMod.Argument] = null,
    ClientExtension: (typingsSlinky.relayCompiler.iRMod.ClientExtension, /* key */ js.UndefOr[js.Any], /* parent */ js.UndefOr[Null | VisitNode | js.Array[VisitNode]], /* path */ js.UndefOr[js.Array[js.Any]], /* ancestors */ js.UndefOr[js.Array[VisitNode | js.Array[VisitNode]]]) => // Note: ancestors includes arrays which contain the visited node
