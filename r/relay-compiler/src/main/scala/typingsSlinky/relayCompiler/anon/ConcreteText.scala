...
object ConcreteText {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(concreteText = concreteText.asInstanceOf[js.Any], definition = definition.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], moduleName = moduleName.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any], sourceHash = sourceHash.asInstanceOf[js.Any], typeText = typeText.asInstanceOf[js.Any], docText = docText.asInstanceOf[js.Any], documentType = documentType.asInstanceOf[js.Any], hash = hash.asInstanceOf[js.Any])
