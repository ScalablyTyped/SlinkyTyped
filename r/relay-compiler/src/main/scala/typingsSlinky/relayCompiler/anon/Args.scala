...
trait Args extends js.Object {
  ...
  var args: js.Array[typingsSlinky.relayCompiler.schemaMod.Argument] = js.native
...
object Args {
  ...
  implicit class ArgsOps[Self <: Args] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArgsVarargs(value: typingsSlinky.relayCompiler.schemaMod.Argument*): Self = this.set("args", js.Array(value :_*))
    
    @scala.inline
    def setArgs(value: js.Array[typingsSlinky.relayCompiler.schemaMod.Argument]): Self = this.set("args", value.asInstanceOf[js.Any])
