...
trait ModuleImport
  ...
  var kind: typingsSlinky.relayCompiler.relayCompilerStrings.ModuleImport = js.native
...
object ModuleImport {
  ...
  implicit class ModuleImportOps[Self <: ModuleImport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.relayCompiler.relayCompilerStrings.ModuleImport): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
