...
trait Root
  ...
  var kind: typingsSlinky.relayCompiler.relayCompilerStrings.Root = js.native
...
object Root {
  ...
  implicit class RootOps[Self <: Root] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.relayCompiler.relayCompilerStrings.Root): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
