...
trait Condition
  ...
  var kind: typingsSlinky.relayCompiler.relayCompilerStrings.Condition = js.native
...
object Condition {
  ...
  implicit class ConditionOps[Self <: Condition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.relayCompiler.relayCompilerStrings.Condition): Self = this.set("kind", value.asInstanceOf[js.Any])
