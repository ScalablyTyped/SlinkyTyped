...
trait ObjectValue
  ...
  var kind: typingsSlinky.relayCompiler.relayCompilerStrings.ObjectValue = js.native
...
object ObjectValue {
  ...
  implicit class ObjectValueOps[Self <: ObjectValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.relayCompiler.relayCompilerStrings.ObjectValue): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
