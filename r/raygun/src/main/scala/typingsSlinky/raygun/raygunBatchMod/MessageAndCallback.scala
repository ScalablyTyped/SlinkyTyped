...
import typingsSlinky.raygun.typesMod.Callback
...
object MessageAndCallback {
  ...
  implicit class MessageAndCallbackOps[Self <: MessageAndCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallbackFunction2(value: (/* e */ js.Error | Null, /* t */ IncomingMessage | Null) => Unit): Self = this.set("callback", js.Any.fromFunction2(value))
