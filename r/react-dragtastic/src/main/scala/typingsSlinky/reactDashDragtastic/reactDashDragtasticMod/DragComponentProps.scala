...
import typingsSlinky.reactDashDragtastic.Anon_IsOverAccepted
...
trait DragComponentProps extends js.Object {
  ...
  def children(arg: State with Anon_IsOverAccepted): TagMod[Any]
}

object DragComponentProps {
  @scala.inline
  def apply(
    children: State with Anon_IsOverAccepted => TagMod[Any],
