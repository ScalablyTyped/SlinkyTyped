package typingsSlinky.reactDashDragtastic.reactDashDragtasticMod

import slinky.core.TagMod
import typingsSlinky.reactDashDragtastic.Anon_EventsIsOver
...
trait DroppableProps extends js.Object {
  ...
  def children(arg: State with Anon_EventsIsOver): TagMod[Any]
}

object DroppableProps {
  @scala.inline
  def apply(
    children: State with Anon_EventsIsOver => TagMod[Any],
