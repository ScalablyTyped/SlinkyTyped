...
import typingsSlinky.rcUpload.rcUploadStrings.`additions removals`
import typingsSlinky.rcUpload.rcUploadStrings.`additions text`
import typingsSlinky.rcUpload.rcUploadStrings.`inline`
import typingsSlinky.rcUpload.rcUploadStrings.`removals additions`
import typingsSlinky.rcUpload.rcUploadStrings.`removals text`
import typingsSlinky.rcUpload.rcUploadStrings.`text additions`
import typingsSlinky.rcUpload.rcUploadStrings.`text removals`
import typingsSlinky.rcUpload.rcUploadStrings.additions
import typingsSlinky.rcUpload.rcUploadStrings.all
import typingsSlinky.rcUpload.rcUploadStrings.ascending
import typingsSlinky.rcUpload.rcUploadStrings.assertive
import typingsSlinky.rcUpload.rcUploadStrings.both
import typingsSlinky.rcUpload.rcUploadStrings.copy
import typingsSlinky.rcUpload.rcUploadStrings.date
import typingsSlinky.rcUpload.rcUploadStrings.decimal
import typingsSlinky.rcUpload.rcUploadStrings.descending
import typingsSlinky.rcUpload.rcUploadStrings.dialog
import typingsSlinky.rcUpload.rcUploadStrings.done
import typingsSlinky.rcUpload.rcUploadStrings.email
import typingsSlinky.rcUpload.rcUploadStrings.enter
import typingsSlinky.rcUpload.rcUploadStrings.execute
import typingsSlinky.rcUpload.rcUploadStrings.go
import typingsSlinky.rcUpload.rcUploadStrings.grammar
import typingsSlinky.rcUpload.rcUploadStrings.grid
import typingsSlinky.rcUpload.rcUploadStrings.horizontal
import typingsSlinky.rcUpload.rcUploadStrings.inherit
import typingsSlinky.rcUpload.rcUploadStrings.link
import typingsSlinky.rcUpload.rcUploadStrings.list
import typingsSlinky.rcUpload.rcUploadStrings.listbox
import typingsSlinky.rcUpload.rcUploadStrings.location
import typingsSlinky.rcUpload.rcUploadStrings.menu
import typingsSlinky.rcUpload.rcUploadStrings.mixed
import typingsSlinky.rcUpload.rcUploadStrings.move
import typingsSlinky.rcUpload.rcUploadStrings.next
import typingsSlinky.rcUpload.rcUploadStrings.no
import typingsSlinky.rcUpload.rcUploadStrings.none
import typingsSlinky.rcUpload.rcUploadStrings.numeric
import typingsSlinky.rcUpload.rcUploadStrings.off
import typingsSlinky.rcUpload.rcUploadStrings.on
import typingsSlinky.rcUpload.rcUploadStrings.other
import typingsSlinky.rcUpload.rcUploadStrings.page
import typingsSlinky.rcUpload.rcUploadStrings.patch_
import typingsSlinky.rcUpload.rcUploadStrings.polite
import typingsSlinky.rcUpload.rcUploadStrings.popup
import typingsSlinky.rcUpload.rcUploadStrings.post_
import typingsSlinky.rcUpload.rcUploadStrings.previous
import typingsSlinky.rcUpload.rcUploadStrings.put_
import typingsSlinky.rcUpload.rcUploadStrings.removals
import typingsSlinky.rcUpload.rcUploadStrings.search
import typingsSlinky.rcUpload.rcUploadStrings.send
import typingsSlinky.rcUpload.rcUploadStrings.spelling
import typingsSlinky.rcUpload.rcUploadStrings.step
import typingsSlinky.rcUpload.rcUploadStrings.tel
import typingsSlinky.rcUpload.rcUploadStrings.text
import typingsSlinky.rcUpload.rcUploadStrings.time
import typingsSlinky.rcUpload.rcUploadStrings.tree
import typingsSlinky.rcUpload.rcUploadStrings.url
import typingsSlinky.rcUpload.rcUploadStrings.vertical
import typingsSlinky.rcUpload.rcUploadStrings.yes
...
object interfaceMod {
  ...
  trait UploadProps extends StObject {
    ...
    var onError: js.UndefOr[js.Function3[/* error */ js.Error, /* ret */ js.Object, /* file */ RcFile, Unit]] = js.native
  ...
  object UploadProps {
    ...
    implicit class UploadPropsMutableBuilder[Self <: UploadProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAction(value: String | (js.Function1[/* file */ RcFile, String])): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setActionFunction1(value: /* file */ RcFile => String): Self = StObject.set(x, "action", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setBeforeUpload(value: (/* file */ RcFile, /* FileList */ js.Array[RcFile]) => Boolean | js.Promise[RcFile]): Self = StObject.set(x, "beforeUpload", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setComponent(value: JSXElementConstructor[_]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunction1(value: _ => ReactElement | Null): Self = StObject.set(x, "component", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setCustomRequest(value: () => Unit): Self = StObject.set(x, "customRequest", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setData(value: js.Object | (js.Function1[/* file */ RcFile | String | Blob, js.Object])): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDataFunction1(value: /* file */ RcFile | String | Blob => js.Object): Self = StObject.set(x, "data", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnError(value: (/* error */ js.Error, /* ret */ js.Object, /* file */ RcFile) => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction3(value))
      ...
      @scala.inline
      def setOnSuccess(value: (/* response */ js.Object, /* file */ RcFile, /* xhr */ js.Object) => Unit): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3(value))
      ...
      @scala.inline
      def setTransformFile(value: /* file */ RcFile => String | Blob | RcFile | (js.Thenable[String | Blob | RcFile])): Self = StObject.set(x, "transformFile", js.Any.fromFunction1(value))
  ...
  object UploadRequestError {
    ...
    @scala.inline
    implicit class UploadRequestErrorMutableBuilder[Self <: UploadRequestError] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.rcUpload.rcUploadStrings.POST
    - typingsSlinky.rcUpload.rcUploadStrings.PUT
    - typingsSlinky.rcUpload.rcUploadStrings.PATCH
    - typingsSlinky.rcUpload.rcUploadStrings.post_
    - typingsSlinky.rcUpload.rcUploadStrings.put_
    - typingsSlinky.rcUpload.rcUploadStrings.patch_
  */
  trait UploadRequestMethod extends StObject
  object UploadRequestMethod {
    
    @scala.inline
    def PATCH: typingsSlinky.rcUpload.rcUploadStrings.PATCH = "PATCH".asInstanceOf[typingsSlinky.rcUpload.rcUploadStrings.PATCH]
    
    @scala.inline
    def POST: typingsSlinky.rcUpload.rcUploadStrings.POST = "POST".asInstanceOf[typingsSlinky.rcUpload.rcUploadStrings.POST]
    
    @scala.inline
    def PUT: typingsSlinky.rcUpload.rcUploadStrings.PUT = "PUT".asInstanceOf[typingsSlinky.rcUpload.rcUploadStrings.PUT]
  ...
  trait UploadRequestOption[T] extends StObject {
    ...
    var onError: js.UndefOr[
        js.Function2[
          /* event */ UploadRequestError | org.scalajs.dom.raw.ProgressEvent, 
          /* body */ js.UndefOr[T], 
          Unit
        ]
      ] = js.native
  ...
  object UploadRequestOption {
    ...
    @scala.inline
    implicit class UploadRequestOptionMutableBuilder[Self <: UploadRequestOption[_], T] (val x: Self with UploadRequestOption[T]) extends AnyVal {
      ...
      @scala.inline
      def setOnError(
        value: (/* event */ UploadRequestError | org.scalajs.dom.raw.ProgressEvent, /* body */ js.UndefOr[T]) => Unit
      ...
      @scala.inline
      def setOnSuccess(value: (/* body */ T, /* xhr */ XMLHttpRequest) => Unit): Self = StObject.set(x, "onSuccess", js.Any.fromFunction2(value))
