...
import typingsSlinky.rcUpload.interfaceMod.UploadProgressEvent
import typingsSlinky.rcUpload.interfaceMod.UploadRequestHeader
...
@scala.inline
class SharedBuilder_UploadProps307879974[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def beforeUpload(value: (/* file */ RcFile, /* FileList */ js.Array[RcFile]) => Boolean | js.Promise[RcFile]): this.type = set("beforeUpload", js.Any.fromFunction2(value))
  ...
  @scala.inline
  def customRequest(value: () => Unit): this.type = set("customRequest", js.Any.fromFunction0(value))
  ...
  @scala.inline
  def onError(value: (/* error */ js.Error, /* ret */ js.Object, /* file */ RcFile) => Unit): this.type = set("onError", js.Any.fromFunction3(value))
  ...
  @scala.inline
  def onSuccess(value: (/* response */ js.Object, /* file */ RcFile, /* xhr */ js.Object) => Unit): this.type = set("onSuccess", js.Any.fromFunction3(value))
  ...
  @scala.inline
  def transformFile(value: /* file */ RcFile => String | Blob | RcFile | (js.Thenable[String | Blob | RcFile])): this.type = set("transformFile", js.Any.fromFunction1(value))
