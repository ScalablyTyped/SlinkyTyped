...
object UploadProps {
  ...
  implicit class UploadPropsOps[Self <: UploadProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnError(value: (/* error */ js.Error, /* ret */ js.Object, /* file */ RcFile) => Unit): Self = this.set("onError", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setOnMouseEnter(value: /* e */ SyntheticMouseEvent[HTMLDivElement] => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: /* e */ SyntheticMouseEvent[HTMLDivElement] => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction1(value))
