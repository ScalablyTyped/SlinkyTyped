...
object AdditionalVirtualizedSelectProps {
  ...
  implicit class AdditionalVirtualizedSelectPropsOps[Self <: AdditionalVirtualizedSelectProps[_], TValue] (val x: Self with AdditionalVirtualizedSelectProps[TValue]) extends AnyVal {
    ...
    @scala.inline
    def setOptionRenderer(value: /* options */ VirtualizedOptionRenderOptions[TValue] => ReactElement): Self = this.set("optionRenderer", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOptionRenderer: Self = this.set("optionRenderer", js.undefined)
    
    @scala.inline
    def setSelectComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("selectComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("selectComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectComponent(value: ReactComponentClass[_]): Self = this.set("selectComponent", value.asInstanceOf[js.Any])
