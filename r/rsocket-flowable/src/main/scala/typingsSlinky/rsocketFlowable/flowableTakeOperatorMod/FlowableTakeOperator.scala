package typingsSlinky.rsocketFlowable.flowableTakeOperatorMod
...
object FlowableTakeOperator {
  ...
  @scala.inline
  implicit class FlowableTakeOperatorOps[Self <: FlowableTakeOperator[_], T] (val x: Self with FlowableTakeOperator[T]) extends AnyVal {
    @scala.inline
