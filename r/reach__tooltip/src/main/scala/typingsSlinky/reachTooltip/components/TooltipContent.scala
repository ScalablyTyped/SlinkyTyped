...
import typingsSlinky.reachTooltip.mod.BaseTooltipProps
...
object TooltipContent {
  ...
  def withProps(p: BaseTooltipProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TooltipContent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
