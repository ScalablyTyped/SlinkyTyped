package typingsSlinky.reachTooltip.components
...
import typingsSlinky.reachTooltip.mod.TooltipPopupProps
...
object TooltipPopup {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def position(value: (/* position1 */ DOMRect, /* position2 */ DOMRect) => DOMRect): this.type = set("position", js.Any.fromFunction2(value))
  ...
  def withProps(p: TooltipPopupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
