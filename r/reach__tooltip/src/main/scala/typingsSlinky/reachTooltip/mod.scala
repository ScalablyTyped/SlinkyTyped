package typingsSlinky.reachTooltip
...
import typingsSlinky.reachTooltip.reachTooltipStrings.assertive
import typingsSlinky.reachTooltip.reachTooltipStrings.both
import typingsSlinky.reachTooltip.reachTooltipStrings.copy
import typingsSlinky.reachTooltip.reachTooltipStrings.date
import typingsSlinky.reachTooltip.reachTooltipStrings.decimal
import typingsSlinky.reachTooltip.reachTooltipStrings.descending
import typingsSlinky.reachTooltip.reachTooltipStrings.dialog
import typingsSlinky.reachTooltip.reachTooltipStrings.email
import typingsSlinky.reachTooltip.reachTooltipStrings.execute
import typingsSlinky.reachTooltip.reachTooltipStrings.grammar
import typingsSlinky.reachTooltip.reachTooltipStrings.grid
import typingsSlinky.reachTooltip.reachTooltipStrings.horizontal
import typingsSlinky.reachTooltip.reachTooltipStrings.inherit
import typingsSlinky.reachTooltip.reachTooltipStrings.link
import typingsSlinky.reachTooltip.reachTooltipStrings.list
import typingsSlinky.reachTooltip.reachTooltipStrings.listbox
import typingsSlinky.reachTooltip.reachTooltipStrings.location
import typingsSlinky.reachTooltip.reachTooltipStrings.menu
import typingsSlinky.reachTooltip.reachTooltipStrings.mixed
import typingsSlinky.reachTooltip.reachTooltipStrings.move
import typingsSlinky.reachTooltip.reachTooltipStrings.no
import typingsSlinky.reachTooltip.reachTooltipStrings.none
import typingsSlinky.reachTooltip.reachTooltipStrings.numeric
import typingsSlinky.reachTooltip.reachTooltipStrings.off
import typingsSlinky.reachTooltip.reachTooltipStrings.on
import typingsSlinky.reachTooltip.reachTooltipStrings.other
import typingsSlinky.reachTooltip.reachTooltipStrings.page
import typingsSlinky.reachTooltip.reachTooltipStrings.polite
import typingsSlinky.reachTooltip.reachTooltipStrings.popup
import typingsSlinky.reachTooltip.reachTooltipStrings.removals
import typingsSlinky.reachTooltip.reachTooltipStrings.search
import typingsSlinky.reachTooltip.reachTooltipStrings.spelling
import typingsSlinky.reachTooltip.reachTooltipStrings.step
import typingsSlinky.reachTooltip.reachTooltipStrings.tel
import typingsSlinky.reachTooltip.reachTooltipStrings.text
import typingsSlinky.reachTooltip.reachTooltipStrings.time
import typingsSlinky.reachTooltip.reachTooltipStrings.tree
import typingsSlinky.reachTooltip.reachTooltipStrings.url
import typingsSlinky.reachTooltip.reachTooltipStrings.vertical
import typingsSlinky.reachTooltip.reachTooltipStrings.yes
...
object mod extends Shortcut {
  ...
  @js.native
  val TooltipContent: ReactComponentClass[BaseTooltipProps] = js.native
  
  @JSImport("@reach/tooltip", "TooltipPopup")
  @js.native
  val TooltipPopup: ReactComponentClass[TooltipPopupProps] = js.native
  
  @JSImport("@reach/tooltip", "useTooltip")
  @js.native
  ...
  /* Inlined parent @reach/tooltip.@reach/tooltip.Omit<react.react.HTMLProps<std.HTMLDivElement>, 'label'> */
  @js.native
  trait BaseTooltipProps extends StObject {
    ...
    var position: js.UndefOr[js.Function2[/* position1 */ DOMRect, /* position2 */ DOMRect, DOMRect]] = js.native
  ...
  object BaseTooltipProps {
    ...
    @scala.inline
    def apply(): BaseTooltipProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BaseTooltipProps]
    }
    
    @scala.inline
    implicit class BaseTooltipPropsMutableBuilder[Self <: BaseTooltipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPosition(value: (/* position1 */ DOMRect, /* position2 */ DOMRect) => DOMRect): Self = StObject.set(x, "position", js.Any.fromFunction2(value))
  ...
  object TooltipParams {
    ...
    implicit class TooltipParamsMutableBuilder[Self <: TooltipParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTriggerRect(value: DOMRect): Self = StObject.set(x, "triggerRect", value.asInstanceOf[js.Any])
    }
  }
  ...
  @js.native
  trait TriggerParams extends StObject {
  ...
  object TriggerParams {
    ...
    @scala.inline
    implicit class TriggerParamsMutableBuilder[Self <: TriggerParams] (val x: Self) extends AnyVal {
      
      @scala.inline
      def `setAria-describedby`(value: String): Self = StObject.set(x, "aria-describedby", value.asInstanceOf[js.Any])
      
      @scala.inline
      def `setData-reach-tooltip-trigger`(value: String): Self = StObject.set(x, "data-reach-tooltip-trigger", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnBlur(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnFocus(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnKeyDown(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseDown(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseEnter(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseLeave(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseMove(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1(value))
