...
object EvilIcons {
  ...
  object Button {
    @JSImport("react-native-vector-icons/EvilIcons", "Button")
    @js.native
    object component extends js.Object
  ...
  object TabBarItem {
    @JSImport("react-native-vector-icons/EvilIcons", "TabBarItem")
    @js.native
    object component extends js.Object
  ...
  object TabBarItemIOS {
    @JSImport("react-native-vector-icons/EvilIcons", "TabBarItemIOS")
    @js.native
    object component extends js.Object
  ...
  object ToolbarAndroid {
    @JSImport("react-native-vector-icons/EvilIcons", "ToolbarAndroid")
    @js.native
    object component extends js.Object
