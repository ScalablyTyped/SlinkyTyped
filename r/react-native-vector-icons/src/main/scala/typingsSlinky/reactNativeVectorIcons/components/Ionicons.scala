...
object Ionicons {
  ...
  object Button {
    @JSImport("react-native-vector-icons/Ionicons", "Button")
    @js.native
    object component extends js.Object
  ...
  object TabBarItem {
    @JSImport("react-native-vector-icons/Ionicons", "TabBarItem")
    @js.native
    object component extends js.Object
  ...
  object TabBarItemIOS {
    @JSImport("react-native-vector-icons/Ionicons", "TabBarItemIOS")
    @js.native
    object component extends js.Object
  ...
  object ToolbarAndroid {
    @JSImport("react-native-vector-icons/Ionicons", "ToolbarAndroid")
    @js.native
    object component extends js.Object
