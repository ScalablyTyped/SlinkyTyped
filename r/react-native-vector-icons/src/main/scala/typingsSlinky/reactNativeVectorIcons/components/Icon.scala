...
object Icon {
  ...
  object Button {
    @JSImport("react-native-vector-icons/Icon", "Button")
    @js.native
    object component extends js.Object
  ...
  object TabBarItem {
    @JSImport("react-native-vector-icons/Icon", "TabBarItem")
    @js.native
    object component extends js.Object
  ...
  object TabBarItemIOS {
    @JSImport("react-native-vector-icons/Icon", "TabBarItemIOS")
    @js.native
    object component extends js.Object
  ...
  object ToolbarAndroid {
    @JSImport("react-native-vector-icons/Icon", "ToolbarAndroid")
    @js.native
    object component extends js.Object
