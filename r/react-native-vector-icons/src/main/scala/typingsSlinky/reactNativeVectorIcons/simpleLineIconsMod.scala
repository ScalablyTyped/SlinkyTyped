...
object simpleLineIconsMod {
  ...
  object default {
    ...
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.Button")
    @js.native
    ...
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.TabBarItemIOS")
    @js.native
    ...
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.ToolbarAndroid")
    @js.native
    ...
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.getImageSource")
    @js.native
    ...
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.getImageSourceSync")
    @js.native
    ...
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.getRawGlyphMap")
    @js.native
    def getRawGlyphMap(): StringDictionary[Double] = js.native
    
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.hasIcon")
    @js.native
    def hasIcon(name: String): Boolean = js.native
    
    @JSImport("react-native-vector-icons/SimpleLineIcons", "default.loadFont")
    @js.native
