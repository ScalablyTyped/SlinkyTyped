...
object featherMod {
  ...
  object default {
    ...
    @JSImport("react-native-vector-icons/Feather", "default.getImageSource")
    @js.native
    ...
    @JSImport("react-native-vector-icons/Feather", "default.getImageSourceSync")
    @js.native
    ...
    @JSImport("react-native-vector-icons/Feather", "default.getRawGlyphMap")
    @js.native
    def getRawGlyphMap(): StringDictionary[Double] = js.native
    
    @JSImport("react-native-vector-icons/Feather", "default.hasIcon")
    @js.native
    def hasIcon(name: String): Boolean = js.native
    
    @JSImport("react-native-vector-icons/Feather", "default.loadFont")
    @js.native
