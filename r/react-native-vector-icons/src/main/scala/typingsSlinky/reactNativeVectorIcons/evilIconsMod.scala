...
object evilIconsMod {
  ...
  object default {
    ...
    @JSImport("react-native-vector-icons/EvilIcons", "default.getImageSource")
    @js.native
    ...
    @JSImport("react-native-vector-icons/EvilIcons", "default.getImageSourceSync")
    @js.native
    ...
    @JSImport("react-native-vector-icons/EvilIcons", "default.getRawGlyphMap")
    @js.native
    def getRawGlyphMap(): StringDictionary[Double] = js.native
    
    @JSImport("react-native-vector-icons/EvilIcons", "default.hasIcon")
    @js.native
    def hasIcon(name: String): Boolean = js.native
    
    @JSImport("react-native-vector-icons/EvilIcons", "default.loadFont")
    @js.native
