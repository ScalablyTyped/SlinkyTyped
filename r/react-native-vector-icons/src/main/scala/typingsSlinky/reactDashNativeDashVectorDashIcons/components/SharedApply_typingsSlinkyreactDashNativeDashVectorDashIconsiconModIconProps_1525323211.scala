...
abstract class SharedApply_typingsSlinkyreactDashNativeDashVectorDashIconsiconModIconProps_1525323211[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
