...
abstract class SharedApply_typingsSlinkyreactDashNativeDashVectorDashIconsiconModToolbarAndroidProps1440336791[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
