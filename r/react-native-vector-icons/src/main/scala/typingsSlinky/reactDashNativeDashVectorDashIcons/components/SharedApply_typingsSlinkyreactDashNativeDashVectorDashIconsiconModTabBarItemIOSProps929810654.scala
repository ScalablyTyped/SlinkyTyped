...
abstract class SharedApply_typingsSlinkyreactDashNativeDashVectorDashIconsiconModTabBarItemIOSProps929810654[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    if (selectedIconName != null) __obj.updateDynamic("selectedIconName")(selectedIconName.asInstanceOf[js.Any])
