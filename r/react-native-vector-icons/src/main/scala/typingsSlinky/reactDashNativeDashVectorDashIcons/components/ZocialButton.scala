...
import typingsSlinky.reactDashNativeDashVectorDashIcons.zocialMod.default.Button
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* The following DOM/SVG props were specified: disabled, name, onBlur, onFocus, size */
object ZocialButton extends SharedApply_typingsSlinkyreactDashNativeDashVectorDashIconsiconModIconButtonProps_562613305[Button] {
