...
package object reactDashAutosuggestMod {
  ...
  import typingsSlinky.reactDashAutosuggest.PartialRecordThemeKeystringCSSProperties
  ...
  type RenderInputComponent[TSuggestion] = js.Function1[/* inputProps */ InputProps[TSuggestion], TagMod[Any]]
  type RenderSectionTitle = js.Function1[/* section */ js.Any, TagMod[Any]]
  type RenderSuggestion[TSuggestion] = js.Function2[/* suggestion */ TSuggestion, /* params */ RenderSuggestionParams, TagMod[Any]]
  type RenderSuggestionsContainer = js.Function1[/* params */ RenderSuggestionsContainerParams, TagMod[Any]]
