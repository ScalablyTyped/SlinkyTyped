...
object AutosuggestPropsBase {
  ...
  implicit class AutosuggestPropsBaseOps[Self <: AutosuggestPropsBase[_], TSuggestion] (val x: Self with AutosuggestPropsBase[TSuggestion]) extends AnyVal {
    ...
    @scala.inline
    def setRenderSuggestion(value: (TSuggestion, /* params */ RenderSuggestionParams) => ReactElement): Self = this.set("renderSuggestion", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setRenderInputComponent(value: /* inputProps */ InputProps[TSuggestion] => ReactElement): Self = this.set("renderInputComponent", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteRenderInputComponent: Self = this.set("renderInputComponent", js.undefined)
    
    @scala.inline
    def setRenderSuggestionsContainer(value: /* params */ RenderSuggestionsContainerParams => ReactElement): Self = this.set("renderSuggestionsContainer", js.Any.fromFunction1(value))
