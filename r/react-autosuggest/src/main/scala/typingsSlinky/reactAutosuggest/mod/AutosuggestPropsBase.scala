...
object AutosuggestPropsBase {
  ...
  implicit class AutosuggestPropsBaseMutableBuilder[Self <: AutosuggestPropsBase[_], TSuggestion] (val x: Self with AutosuggestPropsBase[TSuggestion]) extends AnyVal {
    ...
    @scala.inline
    def setRenderInputComponent(value: /* inputProps */ InputProps[TSuggestion] => ReactElement): Self = StObject.set(x, "renderInputComponent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRenderInputComponentUndefined: Self = StObject.set(x, "renderInputComponent", js.undefined)
    
    @scala.inline
    def setRenderSuggestion(value: (TSuggestion, /* params */ RenderSuggestionParams) => ReactElement): Self = StObject.set(x, "renderSuggestion", js.Any.fromFunction2(value))
    
    @scala.inline
    def setRenderSuggestionsContainer(value: /* params */ RenderSuggestionsContainerParams => ReactElement): Self = StObject.set(x, "renderSuggestionsContainer", js.Any.fromFunction1(value))
