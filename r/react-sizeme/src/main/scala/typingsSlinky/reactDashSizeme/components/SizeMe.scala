package typingsSlinky.reactDashSizeme.components
...
import typingsSlinky.reactDashSizeme.reactDashSizemeMod.SizeMeRenderProps
...
object SizeMe
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashSizeme.reactDashSizemeMod.SizeMe] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashSizeme.reactDashSizemeMod.SizeMe] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashSizeme.reactDashSizemeMod.SizeMe] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashSizeme.reactDashSizemeMod.SizeMe](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
