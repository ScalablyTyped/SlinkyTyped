package typingsSlinky.routeDashParser.routeDashParserMod

import typingsSlinky.routeDashParser.routeDashParserBooleans.`false`
...
trait Route[TParams /* <: js.Object */] extends js.Object {
  ...
  {[ k in keyof TParams ]: string}
    */ typingsSlinky.routeDashParser.routeDashParserStrings.Route with js.Any) | `false`
  /**
