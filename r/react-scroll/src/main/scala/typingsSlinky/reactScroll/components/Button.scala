...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactScroll.mod.Button] {
    ...
    @scala.inline
    def durationFunction1(value: /* distance */ Double => Double): this.type = set("duration", js.Any.fromFunction1(value))
    
    @scala.inline
    def duration(value: Double | String | (js.Function1[/* distance */ Double, Double])): this.type = set("duration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def saveHashHistory(value: Boolean): this.type = set("saveHashHistory", value.asInstanceOf[js.Any])
