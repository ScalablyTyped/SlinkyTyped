package typingsSlinky.reactScroll.components
...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def containerId(value: String): this.type = set("containerId", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def hashSpy(value: Boolean): this.type = set("hashSpy", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def ignoreCancelEvents(value: Boolean): this.type = set("ignoreCancelEvents", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isDynamic(value: Boolean): this.type = set("isDynamic", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onSetActive(value: /* to */ String => Unit): this.type = set("onSetActive", js.Any.fromFunction1(value))
    @scala.inline
    def onSetInactive(value: () => Unit): this.type = set("onSetInactive", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def smooth(value: Boolean | String): this.type = set("smooth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def spy(value: Boolean): this.type = set("spy", value.asInstanceOf[js.Any])
    @scala.inline
