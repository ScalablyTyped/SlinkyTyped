...
object animateScrollMod {
  ...
  @JSImport("react-scroll/modules/mixins/animate-scroll", "animateTopScroll")
  @js.native
  def animateTopScroll(y: Double, options: js.Any, to: String, target: js.Any): Unit = js.native
  
  @JSImport("react-scroll/modules/mixins/animate-scroll", "getAnimationType")
  @js.native
  def getAnimationType(options: Smooth): js.Function1[/* x */ Double, Double] = js.native
  
  @JSImport("react-scroll/modules/mixins/animate-scroll", "scrollMore")
  @js.native
  ...
  @JSImport("react-scroll/modules/mixins/animate-scroll", "scrollTo")
  @js.native
  ...
  @JSImport("react-scroll/modules/mixins/animate-scroll", "scrollToBottom")
  @js.native
  ...
  @JSImport("react-scroll/modules/mixins/animate-scroll", "scrollToTop")
  @js.native
