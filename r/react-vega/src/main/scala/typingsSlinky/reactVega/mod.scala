...
object mod {
  ...
  type Vega = ReactComponentClass[VegaPropsWithSpec]
  ...
  object VegaPropsWithoutSpec {
    ...
    implicit class VegaPropsWithoutSpecMutableBuilder[Self <: VegaPropsWithoutSpec] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnParseError(value: /* error */ js.Error => Unit): Self = StObject.set(x, "onParseError", js.Any.fromFunction1(value))
