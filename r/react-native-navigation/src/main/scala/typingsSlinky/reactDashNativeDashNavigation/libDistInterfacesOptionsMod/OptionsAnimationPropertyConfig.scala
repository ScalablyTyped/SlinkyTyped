...
import typingsSlinky.reactDashNativeDashNavigation.reactDashNativeDashNavigationStrings.accelerate
import typingsSlinky.reactDashNativeDashNavigation.reactDashNativeDashNavigationStrings.decelerate
