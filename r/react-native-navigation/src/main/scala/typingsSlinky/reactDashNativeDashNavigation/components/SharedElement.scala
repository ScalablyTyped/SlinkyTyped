...
import typingsSlinky.reactDashNativeDashNavigation.libDistAdaptersSharedElementMod.SharedElementProps
...
object SharedElement
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashNavigation.libDistAdaptersSharedElementMod.SharedElement
    ] {
  ...
  def apply(elementId: String, resizeMode: String, _overrides: StringDictionary[js.Any] = null): BuildingComponent[
    tag.type, 
    typingsSlinky.reactDashNativeDashNavigation.libDistAdaptersSharedElementMod.SharedElement
  ] = {
