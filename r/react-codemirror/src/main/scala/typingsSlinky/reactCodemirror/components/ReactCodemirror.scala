...
import typingsSlinky.reactCodemirror.ReactCodeMirror.ReactCodeMirror
...
object ReactCodemirror {
  ...
  object ReactCodemirror {
    ...
    implicit def make(companion: ReactCodemirror.type): typingsSlinky.reactCodemirror.components.ReactCodemirror.ReactCodemirror.Builder = new typingsSlinky.reactCodemirror.components.ReactCodemirror.ReactCodemirror.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ReactCodeMirrorProps): typingsSlinky.reactCodemirror.components.ReactCodemirror.ReactCodemirror.Builder = new typingsSlinky.reactCodemirror.components.ReactCodemirror.ReactCodemirror.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, ReactCodeMirror] {
