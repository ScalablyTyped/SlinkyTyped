...
object Helmet
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashHelmetDashAsync.reactDashHelmetDashAsyncMod.Helmet
    ] {
  ...
  typingsSlinky.reactDashHelmetDashAsync.reactDashHelmetDashAsyncMod.Helmet](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
