package typingsSlinky.reactNativeWindows.datePickerPropsMod
...
object IDatePickerProps {
  ...
  implicit class IDatePickerPropsOps[Self <: IDatePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDateChange(value: /* newDate */ js.Date => Unit): Self = this.set("onDateChange", js.Any.fromFunction1(value))
