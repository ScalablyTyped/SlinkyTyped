...
import typingsSlinky.reactNativeWindows.datePickerPropsMod.IDatePickerChangeEvent
...
object DatePicker {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeWindows.mod.DatePicker] {
    ...
    @scala.inline
    def dateFormat(value: (`day month year`) | (`dayofweek day month`) | longdate | shortdate): this.type = set("dateFormat", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("dayOfWeekFormat", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: /* event */ IDatePickerChangeEvent => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def onDateChange(value: /* newDate */ js.Date => Unit): this.type = set("onDateChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def selectedDate(value: js.Date): this.type = set("selectedDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def timeZoneOffsetInSeconds(value: Double): this.type = set("timeZoneOffsetInSeconds", value.asInstanceOf[js.Any])
