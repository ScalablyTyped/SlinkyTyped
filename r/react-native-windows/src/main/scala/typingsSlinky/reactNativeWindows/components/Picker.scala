...
object Picker {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeWindows.mod.Picker] {
    ...
    @scala.inline
    def onChange(value: /* event */ IPickerChangeEvent => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onValueChange(value: (/* value */ js.Any, /* itemIndex */ Double, /* text */ String) => Unit): this.type = set("onValueChange", js.Any.fromFunction3(value))
