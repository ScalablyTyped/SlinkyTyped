...
object Glyph {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def colorEnabled(value: Boolean): this.type = set("colorEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def emSize(value: Double): this.type = set("emSize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def style(value: StyleProp[GlyphStyle]): this.type = set("style", value.asInstanceOf[js.Any])
