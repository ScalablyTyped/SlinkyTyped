package typingsSlinky.reactNativeWindows.components
...
object Flyout {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def horizontalOffset(value: Double): this.type = set("horizontalOffset", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def isLightDismissEnabled(value: Boolean): this.type = set("isLightDismissEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def isOpen(value: Boolean): this.type = set("isOpen", value.asInstanceOf[js.Any])
    
    @scala.inline
    def isOverlayEnabled(value: Boolean): this.type = set("isOverlayEnabled", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onDismiss(value: /* isOpen */ Boolean => Unit): this.type = set("onDismiss", js.Any.fromFunction1(value))
