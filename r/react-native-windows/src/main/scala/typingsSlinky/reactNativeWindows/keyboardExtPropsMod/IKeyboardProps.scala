...
object IKeyboardProps {
  ...
  implicit class IKeyboardPropsOps[Self <: IKeyboardProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnKeyDown(value: SyntheticEvent[NodeHandle, INativeKeyboardEvent] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnKeyDown: Self = this.set("onKeyDown", js.undefined)
    
    @scala.inline
    def setOnKeyDownCapture(value: SyntheticEvent[NodeHandle, INativeKeyboardEvent] => Unit): Self = this.set("onKeyDownCapture", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnKeyDownCapture: Self = this.set("onKeyDownCapture", js.undefined)
    
    @scala.inline
    def setOnKeyUp(value: SyntheticEvent[NodeHandle, INativeKeyboardEvent] => Unit): Self = this.set("onKeyUp", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnKeyUp: Self = this.set("onKeyUp", js.undefined)
    
    @scala.inline
    def setOnKeyUpCapture(value: SyntheticEvent[NodeHandle, INativeKeyboardEvent] => Unit): Self = this.set("onKeyUpCapture", js.Any.fromFunction1(value))
