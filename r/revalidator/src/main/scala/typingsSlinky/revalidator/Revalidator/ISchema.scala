...
object ISchema {
  ...
  implicit class ISchemaOps[Self <: ISchema[_], T] (val x: Self with ISchema[T]) extends AnyVal {
    ...
    @scala.inline
    def setPatternRegExp(value: js.RegExp): Self = this.set("pattern", value.asInstanceOf[js.Any])
    @scala.inline
    def setPattern(value: js.RegExp | String): Self = this.set("pattern", value.asInstanceOf[js.Any])
    @scala.inline
