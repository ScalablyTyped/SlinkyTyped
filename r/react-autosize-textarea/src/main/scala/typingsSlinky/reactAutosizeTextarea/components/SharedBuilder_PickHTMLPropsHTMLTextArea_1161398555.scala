...
@scala.inline
class SharedBuilder_PickHTMLPropsHTMLTextArea_1161398555[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def onResize(value: /* e */ Event => Unit): this.type = set("onResize", js.Any.fromFunction1(value))
