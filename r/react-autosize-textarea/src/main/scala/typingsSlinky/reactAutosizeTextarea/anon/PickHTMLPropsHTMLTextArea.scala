package typingsSlinky.reactAutosizeTextarea.anon
...
@js.native
trait PickHTMLPropsHTMLTextArea extends js.Object {
...
object PickHTMLPropsHTMLTextArea {
  ...
  @scala.inline
  implicit class PickHTMLPropsHTMLTextAreaOps[Self <: PickHTMLPropsHTMLTextArea] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget with HTMLTextAreaElement, Event] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnResize(value: /* e */ Event => Unit): Self = this.set("onResize", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLTextAreaElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLTextAreaElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: Ref[HTMLTextAreaElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
