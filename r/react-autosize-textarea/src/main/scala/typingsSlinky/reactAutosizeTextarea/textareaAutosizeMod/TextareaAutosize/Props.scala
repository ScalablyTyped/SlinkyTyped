...
/* Inlined react-autosize-textarea.react-autosize-textarea/lib/TextareaAutosize.TextareaAutosize.RequiredProps & std.Partial<react-autosize-textarea.react-autosize-textarea/lib/TextareaAutosize.TextareaAutosize.DefaultProps> */
@js.native
