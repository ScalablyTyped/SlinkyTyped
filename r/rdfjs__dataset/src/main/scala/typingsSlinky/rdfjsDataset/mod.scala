...
object mod {
  ...
  @js.native
  def dataset[InQuad /* <: BaseQuad */](): typingsSlinky.rdfjsDataset.datasetCoreMod.^[InQuad] = js.native
  @JSImport("@rdfjs/dataset", "dataset")
  @js.native
  def dataset[InQuad /* <: BaseQuad */](quads: js.Array[InQuad]): typingsSlinky.rdfjsDataset.datasetCoreMod.^[InQuad] = js.native
