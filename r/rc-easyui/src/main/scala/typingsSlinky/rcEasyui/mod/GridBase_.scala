...
class GridBase_ protected ()
  ...
  def componentDidMount_MGridBase_(): Unit = js.native
  @JSName("componentDidUpdate")
  def componentDidUpdate_MGridBase_(e: js.Any): Unit = js.native
  @JSName("componentWillUnmount")
  def componentWillUnmount_MGridBase_(): Unit = js.native
