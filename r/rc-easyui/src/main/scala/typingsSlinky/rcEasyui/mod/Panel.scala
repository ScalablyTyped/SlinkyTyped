...
class Panel protected ()
  ...
  def closableClasses(): js.Any = js.native
  ...
  def componentDidUpdate_MPanel(e: js.Any): Unit = js.native
  
  def expand(): Unit = js.native
  
  def footerClasses(): js.Any = js.native
  
  def hasFooter(): js.Any = js.native
  
  def hasHeader(): js.Any = js.native
  
  def headerClasses(): js.Any = js.native
  
  def panelBody(): js.Any = js.native
  
  def panelClasses(): js.Any = js.native
  
  def panelFooter(): js.Any = js.native
  
  def panelHeader(): js.Any = js.native
...
object Panel {
  ...
  object defaultProps {
    ...
    @JSImport("rc-easyui", "Panel.defaultProps.onCollapse")
    @js.native
    def onCollapse(): Unit = js.native
    
    @JSImport("rc-easyui", "Panel.defaultProps.onExpand")
    @js.native
