package typingsSlinky.rcEasyui.mod.TimePicker

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("rc-easyui", "TimePicker.defaultProps")
@js.native
object defaultProps extends js.Object {
  val ampm: js.Array[String] = js.native
  val arrowAlign: String = js.native
  val arrowIconCls: String = js.native
  val defaultCloseText: String = js.native
  val defaultOkText: String = js.native
