...
import typingsSlinky.rcEasyui.anon.Invalid
...
class FieldBase protected ()
  ...
  def componentDidUpdate_MFieldBase(e: js.Any): Unit = js.native
  
  @JSName("componentWillUnmount")
  def componentWillUnmount_MFieldBase(): Unit = js.native
  
  def getFieldName(): js.Any = js.native
}
/* static members */
object FieldBase {
  ...
  @scala.inline
  def defaultProps_=(x: Invalid): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
