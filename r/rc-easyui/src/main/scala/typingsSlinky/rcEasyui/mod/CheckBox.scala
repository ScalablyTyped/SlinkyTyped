...
object CheckBox {
  ...
  object defaultProps {
    ...
    @JSImport("rc-easyui", "CheckBox.defaultProps.checked")
    @js.native
    val checked: Boolean = js.native
    
    @JSImport("rc-easyui", "CheckBox.defaultProps.disabled")
    @js.native
    val disabled: Boolean = js.native
    
    @JSImport("rc-easyui", "CheckBox.defaultProps.multiple")
    @js.native
    val multiple: Boolean = js.native
    
    @JSImport("rc-easyui", "CheckBox.defaultProps.onChange")
    @js.native
