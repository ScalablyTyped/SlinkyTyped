...
/* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLDivElement>, 'onChange'> */
trait TabsProps extends js.Object {
  ...
  var moreIcon: js.UndefOr[ReactElement] = js.undefined
  ...
  var tabBarExtraContent: js.UndefOr[ReactElement] = js.undefined
...
object TabsProps {
  ...
  implicit class TabsPropsOps[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimated(value: Boolean | AnimatedConfig): Self = this.set("animated", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMoreIconReactElement(value: ReactElement): Self = this.set("moreIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def setMoreIcon(value: ReactElement): Self = this.set("moreIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMoreIcon: Self = this.set("moreIcon", js.undefined)
    @scala.inline
    def setMoreTransitionName(value: String): Self = this.set("moreTransitionName", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): Self = this.set("onTabClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnTabClick: Self = this.set("onTabClick", js.undefined)
    @scala.inline
    def setOnTabScroll(value: /* info */ Direction => Unit): Self = this.set("onTabScroll", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRenderTabBar(value: (/* props */ js.Any, /* DefaultTabBar */ ReactComponentClass[js.Object]) => ReactElement): Self = this.set("renderTabBar", js.Any.fromFunction2(value))
    @scala.inline
