package typingsSlinky.rcTabs.tabNodeMod
...
object TabNodeProps {
  ...
  implicit class TabNodePropsOps[Self <: TabNodeProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: /* e */ SyntheticMouseEvent[Element] | SyntheticKeyboardEvent[Element] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
