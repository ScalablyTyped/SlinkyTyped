...
object SankeyProps {
  ...
  implicit class SankeyPropsOps[Self <: SankeyProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnLinkClick(value: (SankeyPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onLinkClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnLinkClick: Self = this.set("onLinkClick", js.undefined)
    
    @scala.inline
    def setOnLinkMouseOut(value: (SankeyPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onLinkMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnLinkMouseOut: Self = this.set("onLinkMouseOut", js.undefined)
    
    @scala.inline
    def setOnLinkMouseOver(value: (SankeyPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onLinkMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnLinkMouseOver: Self = this.set("onLinkMouseOver", js.undefined)
    
    @scala.inline
    def setOnValueClick(value: (SankeyPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnValueClick: Self = this.set("onValueClick", js.undefined)
    
    @scala.inline
    def setOnValueMouseOut(value: (SankeyPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnValueMouseOut: Self = this.set("onValueMouseOut", js.undefined)
    
    @scala.inline
    def setOnValueMouseOver(value: (SankeyPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOver", js.Any.fromFunction2(value))
