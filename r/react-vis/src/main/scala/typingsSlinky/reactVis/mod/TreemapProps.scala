...
import typingsSlinky.reactVis.reactVisStrings.`partition-pivot`
import typingsSlinky.reactVis.reactVisStrings.binary
import typingsSlinky.reactVis.reactVisStrings.circlePack
import typingsSlinky.reactVis.reactVisStrings.color
import typingsSlinky.reactVis.reactVisStrings.dice
import typingsSlinky.reactVis.reactVisStrings.partition
import typingsSlinky.reactVis.reactVisStrings.resquarify
import typingsSlinky.reactVis.reactVisStrings.size
import typingsSlinky.reactVis.reactVisStrings.slice
import typingsSlinky.reactVis.reactVisStrings.slicedice
import typingsSlinky.reactVis.reactVisStrings.squarify
...
object TreemapProps {
  ...
  implicit class TreemapPropsMutableBuilder[Self <: TreemapProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnLeafClick(value: (TreemapPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onLeafClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnLeafClickUndefined: Self = StObject.set(x, "onLeafClick", js.undefined)
    
    @scala.inline
    def setOnLeafMouseOut(value: (TreemapPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onLeafMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnLeafMouseOutUndefined: Self = StObject.set(x, "onLeafMouseOut", js.undefined)
    
    @scala.inline
    def setOnLeafMouseOver(value: (TreemapPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onLeafMouseOver", js.Any.fromFunction2(value))
