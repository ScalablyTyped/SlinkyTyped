...
object TreemapProps {
  ...
  implicit class TreemapPropsOps[Self <: TreemapProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnLeafClick(value: (TreemapPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onLeafClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnLeafClick: Self = this.set("onLeafClick", js.undefined)
    
    @scala.inline
    def setOnLeafMouseOut(value: (TreemapPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onLeafMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnLeafMouseOut: Self = this.set("onLeafMouseOut", js.undefined)
    
    @scala.inline
    def setOnLeafMouseOver(value: (TreemapPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onLeafMouseOver", js.Any.fromFunction2(value))
