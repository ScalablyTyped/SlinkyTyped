...
object VoronoiProps {
  ...
  implicit class VoronoiPropsMutableBuilder[Self <: VoronoiProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBlur(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnHover(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onHover", js.Any.fromFunction1(value))
