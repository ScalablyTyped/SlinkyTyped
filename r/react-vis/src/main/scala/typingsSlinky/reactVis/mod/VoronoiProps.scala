...
object VoronoiProps {
  ...
  implicit class VoronoiPropsOps[Self <: VoronoiProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBlur(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnHover(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = this.set("onHover", js.Any.fromFunction1(value))
