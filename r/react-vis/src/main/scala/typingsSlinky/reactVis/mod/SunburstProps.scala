...
object SunburstProps {
  ...
  implicit class SunburstPropsOps[Self <: SunburstProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnValueClick(value: (SunburstPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnValueClick: Self = this.set("onValueClick", js.undefined)
    @scala.inline
    def setOnValueMouseOut(value: (SunburstPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOut", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnValueMouseOut: Self = this.set("onValueMouseOut", js.undefined)
    @scala.inline
    def setOnValueMouseOver(value: (SunburstPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOver", js.Any.fromFunction2(value))
    @scala.inline
