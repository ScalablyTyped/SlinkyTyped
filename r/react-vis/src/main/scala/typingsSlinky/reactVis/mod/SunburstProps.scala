...
object SunburstProps {
  ...
  implicit class SunburstPropsMutableBuilder[Self <: SunburstProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnValueClick(value: (SunburstPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnValueClickUndefined: Self = StObject.set(x, "onValueClick", js.undefined)
    
    @scala.inline
    def setOnValueMouseOut(value: (SunburstPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnValueMouseOutUndefined: Self = StObject.set(x, "onValueMouseOut", js.undefined)
    
    @scala.inline
    def setOnValueMouseOver(value: (SunburstPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onValueMouseOver", js.Any.fromFunction2(value))
