...
import typingsSlinky.reactVis.reactVisStrings.color0
import typingsSlinky.reactVis.reactVisStrings.opacity
import typingsSlinky.reactVis.reactVisStrings.opacity0
import typingsSlinky.reactVis.reactVisStrings.size
import typingsSlinky.reactVis.reactVisStrings.size0
import typingsSlinky.reactVis.reactVisStrings.x
import typingsSlinky.reactVis.reactVisStrings.x0
import typingsSlinky.reactVis.reactVisStrings.y
import typingsSlinky.reactVis.reactVisStrings.y0
...
object AbstractSeriesProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactVis.mod.AbstractSeriesPoint */ T](): AbstractSeriesProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AbstractSeriesProps[T]]
  }
  @scala.inline
  implicit class AbstractSeriesPropsOps[Self <: AbstractSeriesProps[_], /* <: typingsSlinky.reactVis.mod.AbstractSeriesPoint */ T] (val x: Self with AbstractSeriesProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnSeriesClick(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = this.set("onSeriesClick", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnSeriesClick: Self = this.set("onSeriesClick", js.undefined)
    @scala.inline
    def setOnSeriesMouseOut(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = this.set("onSeriesMouseOut", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnSeriesMouseOut: Self = this.set("onSeriesMouseOut", js.undefined)
    @scala.inline
    def setOnSeriesMouseOver(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = this.set("onSeriesMouseOver", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnSeriesMouseOver: Self = this.set("onSeriesMouseOver", js.undefined)
    @scala.inline
    def setOnSeriesRightClick(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = this.set("onSeriesRightClick", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnSeriesRightClick: Self = this.set("onSeriesRightClick", js.undefined)
    @scala.inline
    def setOnValueClick(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnValueClick: Self = this.set("onValueClick", js.undefined)
    @scala.inline
    def setOnValueMouseOut(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOut", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnValueMouseOut: Self = this.set("onValueMouseOut", js.undefined)
    @scala.inline
    def setOnValueMouseOver(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOver", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnValueMouseOver: Self = this.set("onValueMouseOver", js.undefined)
    @scala.inline
    def setOnValueRightClick(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueRightClick", js.Any.fromFunction2(value))
    @scala.inline
