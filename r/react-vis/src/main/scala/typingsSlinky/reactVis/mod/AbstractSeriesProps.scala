...
object AbstractSeriesProps {
  ...
  implicit class AbstractSeriesPropsMutableBuilder[Self <: AbstractSeriesProps[_], T /* <: AbstractSeriesPoint */] (val x: Self with AbstractSeriesProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnSeriesClick(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onSeriesClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnSeriesClickUndefined: Self = StObject.set(x, "onSeriesClick", js.undefined)
    
    @scala.inline
    def setOnSeriesMouseOut(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onSeriesMouseOut", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnSeriesMouseOutUndefined: Self = StObject.set(x, "onSeriesMouseOut", js.undefined)
    
    @scala.inline
    def setOnSeriesMouseOver(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onSeriesMouseOver", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnSeriesMouseOverUndefined: Self = StObject.set(x, "onSeriesMouseOver", js.undefined)
    
    @scala.inline
    def setOnSeriesRightClick(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onSeriesRightClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnSeriesRightClickUndefined: Self = StObject.set(x, "onSeriesRightClick", js.undefined)
    
    @scala.inline
    def setOnValueClick(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnValueClickUndefined: Self = StObject.set(x, "onValueClick", js.undefined)
    
    @scala.inline
    def setOnValueMouseOut(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnValueMouseOutUndefined: Self = StObject.set(x, "onValueMouseOut", js.undefined)
    
    @scala.inline
    def setOnValueMouseOver(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnValueMouseOverUndefined: Self = StObject.set(x, "onValueMouseOver", js.undefined)
    
    @scala.inline
    def setOnValueRightClick(value: (T, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onValueRightClick", js.Any.fromFunction2(value))
