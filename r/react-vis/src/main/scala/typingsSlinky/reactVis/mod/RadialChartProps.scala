...
object RadialChartProps {
  ...
  implicit class RadialChartPropsOps[Self <: RadialChartProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnValueClick(value: (RadialChartPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnValueClick: Self = this.set("onValueClick", js.undefined)
    @scala.inline
    def setOnValueMouseOut(value: (RadialChartPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOut", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnValueMouseOut: Self = this.set("onValueMouseOut", js.undefined)
    @scala.inline
    def setOnValueMouseOver(value: (RadialChartPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onValueMouseOver", js.Any.fromFunction2(value))
    @scala.inline
