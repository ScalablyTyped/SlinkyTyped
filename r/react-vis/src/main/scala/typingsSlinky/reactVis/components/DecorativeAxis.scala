...
import typingsSlinky.reactVis.anon.Y
...
object DecorativeAxis {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.DecorativeAxis] {
    ...
    @scala.inline
    def dataVarargs(value: (DecorativeAxisPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    
    @scala.inline
    def data(value: js.Array[DecorativeAxisPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onValueClick(value: (DecorativeAxisPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (DecorativeAxisPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (DecorativeAxisPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (DecorativeAxisPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def tickValue(value: /* x */ js.Any => String | Double): this.type = set("tickValue", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def apply(axisDomain: js.Array[Double], axisEnd: Y, axisStart: Y): Builder = {
