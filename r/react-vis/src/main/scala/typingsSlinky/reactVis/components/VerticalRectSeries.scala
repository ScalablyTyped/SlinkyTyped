...
import typingsSlinky.reactVis.mod.VerticalRectSeriesPoint
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object VerticalRectSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.VerticalRectSeries] {
    ...
    @scala.inline
    def dataVarargs(value: (VerticalRectSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    
    @scala.inline
    def data(value: js.Array[VerticalRectSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onNearestX(value: (VerticalRectSeriesPoint, /* data */ RVNearestXData[VerticalRectSeriesPoint]) => Unit): this.type = set("onNearestX", js.Any.fromFunction2(value))
    
    @scala.inline
    def onNearestXY(value: (VerticalRectSeriesPoint, /* data */ RVNearestXYData[VerticalRectSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueClick(value: (VerticalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (VerticalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (VerticalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (VerticalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
  ...
  implicit def make(companion: VerticalRectSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
