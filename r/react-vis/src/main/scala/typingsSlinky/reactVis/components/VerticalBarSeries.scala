...
import typingsSlinky.reactVis.mod.VerticalBarSeriesPoint
import typingsSlinky.reactVis.mod.VerticalBarSeriesProps
...
object VerticalBarSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.VerticalBarSeries] {
    ...
    @scala.inline
    def dataVarargs(value: (VerticalBarSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    
    @scala.inline
    def data(value: js.Array[VerticalBarSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onNearestX(value: (VerticalBarSeriesPoint, /* data */ RVNearestXData[VerticalBarSeriesPoint]) => Unit): this.type = set("onNearestX", js.Any.fromFunction2(value))
    
    @scala.inline
    def onNearestXY(value: (VerticalBarSeriesPoint, /* data */ RVNearestXYData[VerticalBarSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueClick(value: (VerticalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (VerticalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (VerticalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (VerticalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
