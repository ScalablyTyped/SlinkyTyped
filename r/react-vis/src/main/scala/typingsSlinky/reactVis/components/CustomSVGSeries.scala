...
object CustomSVGSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.CustomSVGSeries] {
    @scala.inline
    ...
    @scala.inline
    def customComponentFunction1(value: /* row */ js.Any => _): this.type = set("customComponent", js.Any.fromFunction1(value))
    @scala.inline
    def customComponent(value: String | (js.Function1[/* row */ js.Any, _])): this.type = set("customComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def dataVarargs(value: (CustomSVGSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    @scala.inline
    def data(value: js.Array[CustomSVGSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    @scala.inline
    def fill(value: String | Double): this.type = set("fill", value.asInstanceOf[js.Any])
    @scala.inline
    def getColor(
      value: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    @scala.inline
    def onValueClick(value: (CustomSVGSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    @scala.inline
    def onValueMouseOut(value: (CustomSVGSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    @scala.inline
    def onValueMouseOver(value: (CustomSVGSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    @scala.inline
    def onValueRightClick(value: (CustomSVGSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps(p: CustomSVGSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CustomSVGSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
