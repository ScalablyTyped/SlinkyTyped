...
object LineMarkSeriesCanvas {
  
  @JSImport("react-vis", "LineMarkSeriesCanvas")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.LineMarkSeriesCanvas] {
    ...
    @scala.inline
    def dataVarargs(value: (LineMarkSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    ...
    @scala.inline
    def onValueClick(value: (LineMarkSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (LineMarkSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (LineMarkSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (LineMarkSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
  ...
  def withProps(p: AbstractSeriesProps[LineMarkSeriesPoint]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: LineMarkSeriesCanvas.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
