...
object ContourSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.ContourSeries] {
    @scala.inline
    ...
    @scala.inline
    def bandwidth(value: Double): this.type = set("bandwidth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onValueClick(value: (ContourSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    @scala.inline
    def onValueMouseOut(value: (ContourSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    @scala.inline
    def onValueMouseOver(value: (ContourSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    @scala.inline
    def onValueRightClick(value: (ContourSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps(p: ContourSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ContourSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
