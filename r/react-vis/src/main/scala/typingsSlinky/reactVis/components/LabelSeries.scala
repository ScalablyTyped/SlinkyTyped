...
import typingsSlinky.reactVis.mod.LabelSeriesPoint
import typingsSlinky.reactVis.mod.LabelSeriesProps
...
object LabelSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.LabelSeries] {
    ...
    @scala.inline
    def allowOffsetToBeReversed(value: Boolean): this.type = set("allowOffsetToBeReversed", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def data(value: js.Array[LabelSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def dataVarargs(value: (LabelSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    ...
    @scala.inline
    def getColor(
      value: LabelSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    @scala.inline
    def labelAnchorX(value: String): this.type = set("labelAnchorX", value.asInstanceOf[js.Any])
    
    @scala.inline
    def labelAnchorY(value: String): this.type = set("labelAnchorY", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onNearestX(value: (LabelSeriesPoint, /* data */ RVNearestXData[LabelSeriesPoint]) => Unit): this.type = set("onNearestX", js.Any.fromFunction2(value))
    
    @scala.inline
    def onNearestXY(value: (LabelSeriesPoint, /* data */ RVNearestXYData[LabelSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueClick(value: (LabelSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (LabelSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (LabelSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (LabelSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
  ...
  implicit def make(companion: LabelSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LabelSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
