...
import typingsSlinky.reactVis.mod.MarkSeriesProps
...
object MarkSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.MarkSeries] {
    ...
    @scala.inline
    def getNull(value: MarkSeriesPoint => js.Any): this.type = set("getNull", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: MarkSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MarkSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
