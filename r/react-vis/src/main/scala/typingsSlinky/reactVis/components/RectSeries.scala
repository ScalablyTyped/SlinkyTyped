...
import typingsSlinky.reactVis.mod.RectSeriesProps
...
object RectSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.RectSeries] {
    ...
    @scala.inline
    def dataVarargs(value: (RectSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    
    @scala.inline
    def data(value: js.Array[RectSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def linePosAttr(value: String): this.type = set("linePosAttr", value.asInstanceOf[js.Any])
    
    @scala.inline
    def lineSizeAttr(value: String): this.type = set("lineSizeAttr", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onValueClick(value: (RectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (RectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (RectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (RectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def valuePosAttr(value: String): this.type = set("valuePosAttr", value.asInstanceOf[js.Any])
    
    @scala.inline
    def valueSizeAttr(value: String): this.type = set("valueSizeAttr", value.asInstanceOf[js.Any])
  ...
  def withProps(p: RectSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: RectSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
