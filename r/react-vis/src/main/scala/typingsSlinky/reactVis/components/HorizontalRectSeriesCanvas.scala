...
import typingsSlinky.reactVis.mod.HorizontalRectSeriesPoint
...
object HorizontalRectSeriesCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.HorizontalRectSeriesCanvas] {
    ...
    @scala.inline
    def data(value: js.Array[HorizontalRectSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def dataVarargs(value: (HorizontalRectSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    ...
    @scala.inline
    def onNearestX(value: (HorizontalRectSeriesPoint, /* data */ RVNearestXData[HorizontalRectSeriesPoint]) => Unit): this.type = set("onNearestX", js.Any.fromFunction2(value))
    
    @scala.inline
    def onNearestXY(value: (HorizontalRectSeriesPoint, /* data */ RVNearestXYData[HorizontalRectSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueClick(value: (HorizontalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (HorizontalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (HorizontalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (HorizontalRectSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
