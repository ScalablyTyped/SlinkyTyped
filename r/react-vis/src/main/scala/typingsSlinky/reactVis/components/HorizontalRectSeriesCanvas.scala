...
object HorizontalRectSeriesCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onNearestXY(value: (HorizontalRectSeriesPoint, /* data */ RVNearestXData[HorizontalRectSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
