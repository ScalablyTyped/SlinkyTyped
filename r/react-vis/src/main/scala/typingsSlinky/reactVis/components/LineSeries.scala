...
import typingsSlinky.reactVis.mod.LineSeriesProps
...
object LineSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.LineSeries] {
    @scala.inline
    ...
    @scala.inline
    def getNull(value: LineSeriesPoint => js.Any): this.type = set("getNull", js.Any.fromFunction1(value))
    @scala.inline
    def getOpacity(
      value: LineSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
