...
import typingsSlinky.reactVis.mod.AreaSeriesPoint
import typingsSlinky.reactVis.mod.AreaSeriesProps
...
object AreaSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.AreaSeries] {
    ...
    @scala.inline
    def data(value: js.Array[AreaSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def dataVarargs(value: (AreaSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    ...
    @scala.inline
    def getNull(value: AreaSeriesPoint => js.Any): this.type = set("getNull", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onNearestX(value: (AreaSeriesPoint, /* data */ RVNearestXData[AreaSeriesPoint]) => Unit): this.type = set("onNearestX", js.Any.fromFunction2(value))
    
    @scala.inline
    def onNearestXY(value: (AreaSeriesPoint, /* data */ RVNearestXYData[AreaSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueClick(value: (AreaSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (AreaSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (AreaSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (AreaSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
