...
import typingsSlinky.reactVis.mod.HeatmapSeriesPoint
...
object HeatmapSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.HeatmapSeries] {
    ...
    @scala.inline
    def dataVarargs(value: (HeatmapSeriesPoint | js.Array[js.Any])*): this.type = set("data", js.Array(value :_*))
    
    @scala.inline
    def data(value: js.Array[HeatmapSeriesPoint | js.Array[_]]): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def getColor(
      value: HeatmapSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    @scala.inline
    def onNearestX(value: (HeatmapSeriesPoint, /* data */ RVNearestXData[HeatmapSeriesPoint]) => Unit): this.type = set("onNearestX", js.Any.fromFunction2(value))
    
    @scala.inline
    def onNearestXY(value: (HeatmapSeriesPoint, /* data */ RVNearestXYData[HeatmapSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueClick(value: (HeatmapSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (HeatmapSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (HeatmapSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (HeatmapSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
  ...
  def withProps(p: AbstractSeriesProps[HeatmapSeriesPoint]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: HeatmapSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
