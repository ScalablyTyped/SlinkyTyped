...
import typingsSlinky.reactVis.mod.LineMarkSeriesProps
...
object LineMarkSeries {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.LineMarkSeries] {
    ...
    @scala.inline
    def curveFunction1(value: /* x */ js.Any => _): this.type = set("curve", js.Any.fromFunction1(value))
    
    @scala.inline
    def curve(value: String | (js.Function1[/* x */ js.Any, _])): this.type = set("curve", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def getNull(value: LineMarkSeriesPoint => js.Any): this.type = set("getNull", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def lineStyle(value: CSSProperties): this.type = set("lineStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def markStyle(value: CSSProperties): this.type = set("markStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def strokeStyle(value: dashed | solid): this.type = set("strokeStyle", value.asInstanceOf[js.Any])
