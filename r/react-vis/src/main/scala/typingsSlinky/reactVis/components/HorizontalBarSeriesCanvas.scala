...
import typingsSlinky.reactVis.mod.HorizontalBarSeriesCanvasProps
import typingsSlinky.reactVis.mod.HorizontalBarSeriesPoint
...
object HorizontalBarSeriesCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.HorizontalBarSeriesCanvas] {
    ...
    @scala.inline
    def getColor(
      value: HorizontalBarSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    @scala.inline
    def onNearestX(value: (HorizontalBarSeriesPoint, /* data */ RVNearestXData[HorizontalBarSeriesPoint]) => Unit): this.type = set("onNearestX", js.Any.fromFunction2(value))
    
    @scala.inline
    def onNearestXY(value: (HorizontalBarSeriesPoint, /* data */ RVNearestXYData[HorizontalBarSeriesPoint]) => Unit): this.type = set("onNearestXY", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueClick(value: (HorizontalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOut(value: (HorizontalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOut", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueMouseOver(value: (HorizontalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueMouseOver", js.Any.fromFunction2(value))
    
    @scala.inline
    def onValueRightClick(value: (HorizontalBarSeriesPoint, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): this.type = set("onValueRightClick", js.Any.fromFunction2(value))
  ...
  def withProps(p: HorizontalBarSeriesCanvasProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(barWidth: Double): Builder = {
    val __props = js.Dynamic.literal(barWidth = barWidth.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[HorizontalBarSeriesCanvasProps]))
  }
}
