...
import typingsSlinky.reactVis.mod.VerticalBarSeriesCanvasProps
import typingsSlinky.reactVis.mod.VerticalBarSeriesPoint
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object VerticalBarSeriesCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactVis.mod.VerticalBarSeriesCanvas] {
    @scala.inline
  ...
  def withProps(p: VerticalBarSeriesCanvasProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(barWidth: Double): Builder = {
    val __props = js.Dynamic.literal(barWidth = barWidth.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[VerticalBarSeriesCanvasProps]))
  }
}
