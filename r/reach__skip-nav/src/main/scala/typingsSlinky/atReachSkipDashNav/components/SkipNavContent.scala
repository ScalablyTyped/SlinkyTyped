...
object SkipNavContent
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atReachSkipDashNav.atReachSkipDashNavMod.SkipNavContent] {
  @JSImport("@reach/skip-nav", "SkipNavContent")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  type Props = SkipNavProps with HTMLProps[HTMLDivElement]
}
