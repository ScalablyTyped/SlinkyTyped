package typingsSlinky.reachSkipNav.components
...
import typingsSlinky.reachSkipNav.mod.SkipNavProps
...
object SkipNavLink {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reachSkipNav.mod.SkipNavLink] {
    @scala.inline
  ...
  def withProps(p: SkipNavProps with HTMLProps[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: SkipNavLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
