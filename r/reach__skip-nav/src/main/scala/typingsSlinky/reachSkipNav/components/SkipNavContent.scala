...
object SkipNavContent {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reachSkipNav.mod.SkipNavContent] {
  ...
  def withProps(p: SkipNavProps with HTMLProps[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SkipNavContent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
