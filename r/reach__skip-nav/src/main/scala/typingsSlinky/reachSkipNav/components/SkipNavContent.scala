...
object SkipNavContent
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reachSkipNav.mod.SkipNavContent] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reachSkipNav.mod.SkipNavContent] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reachSkipNav.mod.SkipNavContent] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reachSkipNav.mod.SkipNavContent](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
