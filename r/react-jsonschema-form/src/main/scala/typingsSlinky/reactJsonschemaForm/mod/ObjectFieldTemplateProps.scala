...
object ObjectFieldTemplateProps {
  ...
  implicit class ObjectFieldTemplatePropsMutableBuilder[Self <: ObjectFieldTemplateProps[_], T] (val x: Self with ObjectFieldTemplateProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setDescriptionField(value: ReactComponentClass[Description]): Self = StObject.set(x, "DescriptionField", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleField(value: ReactComponentClass[Id]): Self = StObject.set(x, "TitleField", value.asInstanceOf[js.Any])
