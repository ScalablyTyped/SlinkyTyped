...
object ObjectFieldTemplateProps {
  ...
  implicit class ObjectFieldTemplatePropsOps[Self <: ObjectFieldTemplateProps[_], T] (val x: Self with ObjectFieldTemplateProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setDescriptionField(value: ReactComponentClass[Description]): Self = this.set("DescriptionField", value.asInstanceOf[js.Any])
    @scala.inline
    def setTitleField(value: ReactComponentClass[Id]): Self = this.set("TitleField", value.asInstanceOf[js.Any])
    @scala.inline
