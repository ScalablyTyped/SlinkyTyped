...
object FormProps {
  ...
  implicit class FormPropsMutableBuilder[Self <: FormProps[_], T] (val x: Self with FormProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setArrayFieldTemplate(value: ReactComponentClass[ArrayFieldTemplateProps[_]]): Self = StObject.set(x, "ArrayFieldTemplate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCustomFormats(value: StringDictionary[String | js.RegExp | (js.Function1[/* data */ String, Boolean])]): Self = StObject.set(x, "customFormats", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFieldTemplate(value: ReactComponentClass[FieldTemplateProps]): Self = StObject.set(x, "FieldTemplate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setObjectFieldTemplate(value: ReactComponentClass[ObjectFieldTemplateProps[_]]): Self = StObject.set(x, "ObjectFieldTemplate", value.asInstanceOf[js.Any])
