...
object FormProps {
  ...
  implicit class FormPropsOps[Self <: FormProps[_], T] (val x: Self with FormProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setArrayFieldTemplate(value: ReactComponentClass[ArrayFieldTemplateProps[_]]): Self = this.set("ArrayFieldTemplate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteArrayFieldTemplate: Self = this.set("ArrayFieldTemplate", js.undefined)
    @scala.inline
    def setErrorList(value: ReactComponentClass[ErrorListProps]): Self = this.set("ErrorList", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteErrorList: Self = this.set("ErrorList", js.undefined)
    @scala.inline
    def setFieldTemplate(value: ReactComponentClass[FieldTemplateProps]): Self = this.set("FieldTemplate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFieldTemplate: Self = this.set("FieldTemplate", js.undefined)
    @scala.inline
    def setObjectFieldTemplate(value: ReactComponentClass[ObjectFieldTemplateProps[_]]): Self = this.set("ObjectFieldTemplate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCustomFormats(value: StringDictionary[String | js.RegExp | (js.Function1[/* data */ String, Boolean])]): Self = this.set("customFormats", value.asInstanceOf[js.Any])
    @scala.inline
