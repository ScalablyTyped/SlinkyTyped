...
object UiSchema {
  ...
  implicit class UiSchemaMutableBuilder[Self <: UiSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUiColonArrayFieldTemplate(value: ReactComponentClass[ArrayFieldTemplateProps[_]]): Self = StObject.set(x, "ui:ArrayFieldTemplate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUiColonArrayFieldTemplateUndefined: Self = StObject.set(x, "ui:ArrayFieldTemplate", js.undefined)
    
    @scala.inline
    def setUiColonFieldTemplate(value: ReactComponentClass[FieldTemplateProps]): Self = StObject.set(x, "ui:FieldTemplate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUiColonFieldTemplateUndefined: Self = StObject.set(x, "ui:FieldTemplate", js.undefined)
    
    @scala.inline
    def setUiColonObjectFieldTemplate(value: ReactComponentClass[ObjectFieldTemplateProps[_]]): Self = StObject.set(x, "ui:ObjectFieldTemplate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUiColonfieldComponentClass(value: ReactComponentClass[FieldProps[js.Any]]): Self = StObject.set(x, "ui:field", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUiColonfieldFunctionComponent(value: ReactComponentClass[FieldProps[js.Any]]): Self = StObject.set(x, "ui:field", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUiColonwidgetComponentClass(value: ReactComponentClass[WidgetProps]): Self = StObject.set(x, "ui:widget", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUiColonwidgetFunctionComponent(value: ReactComponentClass[WidgetProps]): Self = StObject.set(x, "ui:widget", value.asInstanceOf[js.Any])
