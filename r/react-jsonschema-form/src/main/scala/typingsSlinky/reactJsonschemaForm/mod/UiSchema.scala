...
object UiSchema {
  ...
  implicit class UiSchemaOps[Self <: UiSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUiColonArrayFieldTemplate(value: ReactComponentClass[ArrayFieldTemplateProps[_]]): Self = this.set("ui:ArrayFieldTemplate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUiColonArrayFieldTemplate: Self = this.set("ui:ArrayFieldTemplate", js.undefined)
    @scala.inline
    def setUiColonFieldTemplate(value: ReactComponentClass[FieldTemplateProps]): Self = this.set("ui:FieldTemplate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUiColonFieldTemplate: Self = this.set("ui:FieldTemplate", js.undefined)
    @scala.inline
    def setUiColonObjectFieldTemplate(value: ReactComponentClass[ObjectFieldTemplateProps[_]]): Self = this.set("ui:ObjectFieldTemplate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUiColonObjectFieldTemplate: Self = this.set("ui:ObjectFieldTemplate", js.undefined)
    @scala.inline
    def setUiColonfieldFunctionComponent(value: ReactComponentClass[FieldProps[js.Any]]): Self = this.set("ui:field", value.asInstanceOf[js.Any])
    @scala.inline
    def setUiColonfieldComponentClass(value: ReactComponentClass[FieldProps[js.Any]]): Self = this.set("ui:field", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setUiColonwidgetFunctionComponent(value: ReactComponentClass[WidgetProps]): Self = this.set("ui:widget", value.asInstanceOf[js.Any])
    @scala.inline
    def setUiColonwidgetComponentClass(value: ReactComponentClass[WidgetProps]): Self = this.set("ui:widget", value.asInstanceOf[js.Any])
    @scala.inline
