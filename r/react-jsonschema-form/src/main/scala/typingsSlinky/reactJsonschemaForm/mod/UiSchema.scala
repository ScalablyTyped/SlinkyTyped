...
trait UiSchema
  ...
  var uiColonArrayFieldTemplate: js.UndefOr[ReactComponentClass[ArrayFieldTemplateProps[_]]] = js.undefined
  @JSName("ui:FieldTemplate")
  var uiColonFieldTemplate: js.UndefOr[ReactComponentClass[FieldTemplateProps]] = js.undefined
  @JSName("ui:ObjectFieldTemplate")
  var uiColonObjectFieldTemplate: js.UndefOr[ReactComponentClass[ObjectFieldTemplateProps[_]]] = js.undefined
  @JSName("ui:field")
...
object UiSchema {
  ...
  def apply(
    ...
    uiColonArrayFieldTemplate: ReactComponentClass[ArrayFieldTemplateProps[_]] = null,
    uiColonFieldTemplate: ReactComponentClass[FieldTemplateProps] = null,
    uiColonObjectFieldTemplate: ReactComponentClass[ObjectFieldTemplateProps[_]] = null,
