...
import typingsSlinky.reactJsonschemaForm.anon.Label
...
object utilsMod {
  ...
  @js.native
  def setState(instance: ReactComponentClass[js.Object], state: js.Any, callback: js.Function): Unit = js.native
  
  @JSImport("react-jsonschema-form/lib/utils", "shouldRender")
  @js.native
  def shouldRender(comp: ReactComponentClass[js.Object], nextProps: js.Any, nextState: js.Any): Boolean = js.native
  ...
  @js.native
  def toConstant(schema: JSONSchema6): js.UndefOr[JSONSchema6Type | js.Error] = js.native
