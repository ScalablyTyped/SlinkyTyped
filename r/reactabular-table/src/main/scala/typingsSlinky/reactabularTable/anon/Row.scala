...
object Row {
  ...
  implicit class RowOps[Self <: Row] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCellFunction1(value: /* props */ js.Any => ReactElement | ReactInstance): Self = this.set("cell", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCell(value: String | (js.Function1[/* props */ js.Any, ReactElement | ReactInstance])): Self = this.set("cell", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCell: Self = this.set("cell", js.undefined)
    
    @scala.inline
    def setRowFunction2(value: (/* props */ js.Any, /* rowData */ js.Any) => ReactElement): Self = this.set("row", js.Any.fromFunction2(value))
