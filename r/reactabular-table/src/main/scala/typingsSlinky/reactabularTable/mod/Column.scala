...
object Column {
  ...
  implicit class ColumnOps[Self <: Column] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCell(value: Formatters): Self = this.set("cell", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCell: Self = this.set("cell", js.undefined)
    @scala.inline
    def setChildrenVarargs(value: Column*): Self = this.set("children", js.Array(value :_*))
    @scala.inline
    def setChildren(value: js.Array[Column]): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteChildren: Self = this.set("children", js.undefined)
    @scala.inline
    def setHeader(value: Draggable): Self = this.set("header", value.asInstanceOf[js.Any])
    @scala.inline
