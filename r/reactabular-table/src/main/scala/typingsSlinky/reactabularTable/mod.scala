...
import typingsSlinky.reactabularTable.anon.ColumnIndex
...
import typingsSlinky.reactabularTable.anon.RowData
import typingsSlinky.reactabularTable.anon.RowIndex
...
object mod {
  ...
  type CellFormatter = js.Function2[/* value */ js.Any, /* props */ RowIndex, String | ReactElement]
  ...
  type ColumnFormatter = js.Function2[/* label */ String | ReactElement, /* props */ RowData, String | ReactElement]
  
  type ColumnTransform = js.Function2[
    /* label */ String | ReactElement | ReactInstance, 
  ...
  object Renderers {
    ...
    implicit class RenderersMutableBuilder[Self <: Renderers] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTable(value: String | js.Function0[ReactElement]): Self = StObject.set(x, "table", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTableFunction0(value: () => ReactElement): Self = StObject.set(x, "table", js.Any.fromFunction0(value))
