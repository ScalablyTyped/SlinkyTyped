...
import typingsSlinky.reactSelect.reactSelectStrings.inputValue
import typingsSlinky.reactSelect.reactSelectStrings.menuIsOpen
import typingsSlinky.reactSelect.reactSelectStrings.onChange
import typingsSlinky.reactSelect.reactSelectStrings.onInputChange
import typingsSlinky.reactSelect.reactSelectStrings.onMenuClose
import typingsSlinky.reactSelect.reactSelectStrings.onMenuOpen
import typingsSlinky.reactSelect.reactSelectStrings.value
...
object stateManagerMod {
  ...
  @js.native
  def default[T /* <: typingsSlinky.reactSelect.selectMod.default[_] */](SelectComponent: T): StateManager[GetOptionType[T], T] = js.native
  ...
  class StateManager[OptionType /* <: OptionTypeBase */, T /* <: default[OptionType] */] protected ()
    ...
    def this(props: StateProps[typingsSlinky.reactSelect.selectMod.Props[OptionType]] with Props[OptionType] with typingsSlinky.reactSelect.selectMod.Props[OptionType]) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(
      props: StateProps[typingsSlinky.reactSelect.selectMod.Props[OptionType]] with Props[OptionType] with typingsSlinky.reactSelect.selectMod.Props[OptionType],
      context: js.Any
    ) = this()
  ...
  type StateProps[T /* <: typingsSlinky.reactSelect.selectMod.Props[_] */] = Pick[
    T, 
    Exclude[
      /* keyof T */ String, 
