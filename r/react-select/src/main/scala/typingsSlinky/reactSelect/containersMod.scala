...
object containersMod {
  ...
  @js.native
  val IndicatorsContainer: ReactComponentClass[IndicatorContainerProps[js.Any]] = js.native
  
  @JSImport("react-select/src/components/containers", "SelectContainer")
  @js.native
  val SelectContainer: ReactComponentClass[ContainerProps[js.Any]] = js.native
