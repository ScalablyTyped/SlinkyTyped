...
object componentsSingleValueMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[SingleValueProps[js.Any]] = js.native
  
  @JSImport("react-select/src/components/SingleValue", "SingleValue")
  @js.native
  val SingleValue: ReactComponentClass[SingleValueProps[js.Any]] = js.native
  ...
  type _To = ReactComponentClass[SingleValueProps[js.Any]]
  
  /* This means you don't have to write `default`, but can instead just say `componentsSingleValueMod.foo` */
  override def _to: ReactComponentClass[SingleValueProps[js.Any]] = default
}
