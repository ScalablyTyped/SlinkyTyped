...
object AsyncProps {
  ...
  @scala.inline
  implicit class AsyncPropsOps[Self <: AsyncProps[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with AsyncProps[OptionType]) extends AnyVal {
    @scala.inline
