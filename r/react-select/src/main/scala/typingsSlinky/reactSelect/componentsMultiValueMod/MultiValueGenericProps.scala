...
object MultiValueGenericProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](data: OptionType, innerProps: ClassName, selectProps: js.Any): MultiValueGenericProps[OptionType] = {
  ...
  @scala.inline
  implicit class MultiValueGenericPropsOps[Self <: MultiValueGenericProps[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with MultiValueGenericProps[OptionType]) extends AnyVal {
    @scala.inline
