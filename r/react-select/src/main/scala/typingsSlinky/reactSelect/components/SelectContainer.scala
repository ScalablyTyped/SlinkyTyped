...
object SelectContainer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactSelect.containersMod.SelectContainer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactSelect.containersMod.SelectContainer] = {
