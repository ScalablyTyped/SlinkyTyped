...
object DropdownIndicator {
  ...
  def withProps(p: IndicatorProps[js.Any]): SharedBuilder_IndicatorProps_1414441721[typingsSlinky.reactSelect.indicatorsMod.DropdownIndicator] = new SharedBuilder_IndicatorProps_1414441721[typingsSlinky.reactSelect.indicatorsMod.DropdownIndicator](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    clearValue: () => Unit,
  ...
  ): SharedBuilder_IndicatorProps_1414441721[typingsSlinky.reactSelect.indicatorsMod.DropdownIndicator] = {
    ...
    new SharedBuilder_IndicatorProps_1414441721[typingsSlinky.reactSelect.indicatorsMod.DropdownIndicator](js.Array(this.component, __props.asInstanceOf[IndicatorProps[js.Any]]))
  }
}
