...
import typingsSlinky.reactSelect.asyncCreatableMod.default
...
object AsyncCreatable
  ...
  typingsSlinky.reactSelect.asyncCreatableMod.default[js.Any]]]
  }
  type Props = typingsSlinky.reactSelect.srcAsyncCreatableMod.Props[js.Any]
}
