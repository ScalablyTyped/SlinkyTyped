...
object NoOptionsMessage {
  ...
  def withProps(p: NoticeProps[js.Any]): SharedBuilder_NoticeProps_1947114659[typingsSlinky.reactSelect.menuMod.NoOptionsMessage] = new SharedBuilder_NoticeProps_1947114659[typingsSlinky.reactSelect.menuMod.NoOptionsMessage](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    clearValue: () => Unit,
  ...
  ): SharedBuilder_NoticeProps_1947114659[typingsSlinky.reactSelect.menuMod.NoOptionsMessage] = {
    ...
    new SharedBuilder_NoticeProps_1947114659[typingsSlinky.reactSelect.menuMod.NoOptionsMessage](js.Array(this.component, __props.asInstanceOf[NoticeProps[js.Any]]))
  }
}
