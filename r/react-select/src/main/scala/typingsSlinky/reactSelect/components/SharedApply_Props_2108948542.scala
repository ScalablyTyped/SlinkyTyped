...
abstract class SharedApply_Props_2108948542[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = typingsSlinky.reactSelect.selectMod.Props[js.Any]
}
