...
import typingsSlinky.reactSelect.componentsSingleValueMod.default
...
object SingleValue {
  ...
  def withProps(p: SingleValueProps[js.Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    clearValue: () => Unit,
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SingleValueProps[js.Any]]))
  }
}
