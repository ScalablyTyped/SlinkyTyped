...
@scala.inline
class SharedBuilder_StatePropsPropsProps40828826[R <: js.Object, /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType, /* <: typingsSlinky.reactSelect.selectMod.default[OptionType] */ T] (val args: js.Array[js.Any])
  extends AnyVal
