...
object MultiValueRemove {
  ...
  implicit def make(companion: MultiValueRemove.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
