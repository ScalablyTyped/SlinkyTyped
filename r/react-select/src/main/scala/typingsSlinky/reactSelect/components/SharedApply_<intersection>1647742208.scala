...
abstract class `SharedApply_<intersection>1647742208`[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = StateProps[typingsSlinky.reactSelect.selectMod.Props[js.Any]] with typingsSlinky.reactSelect.stateManagerMod.Props[js.Any] with typingsSlinky.reactSelect.selectMod.Props[js.Any]
}
