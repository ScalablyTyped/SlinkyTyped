...
object MenuList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactSelect.menuMod.MenuList] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactSelect.menuMod.MenuList] = {
