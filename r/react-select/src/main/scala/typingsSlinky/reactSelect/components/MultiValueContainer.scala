...
object MultiValueContainer {
  ...
  @scala.inline
  def apply(data: js.Any, innerProps: ClassName, selectProps: js.Any): SharedBuilder_MultiValueGenericProps_351876057[typingsSlinky.reactSelect.componentsMultiValueMod.MultiValueContainer] = {
