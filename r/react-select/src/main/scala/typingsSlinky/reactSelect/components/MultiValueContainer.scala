...
object MultiValueContainer {
  ...
  implicit def make(companion: MultiValueContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
