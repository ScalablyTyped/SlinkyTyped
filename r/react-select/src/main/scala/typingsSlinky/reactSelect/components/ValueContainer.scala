...
object ValueContainer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactSelect.containersMod.ValueContainer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactSelect.containersMod.ValueContainer] = {
  ...
  type Props = ValueContainerProps[js.Any]
}
