...
object MultiValueGeneric {
  ...
  @scala.inline
  def apply(data: js.Any, innerProps: AnonClassName, selectProps: js.Any): SharedBuilder_MultiValueGenericProps_351876057[typingsSlinky.reactSelect.componentsMultiValueMod.MultiValueGeneric] = {
