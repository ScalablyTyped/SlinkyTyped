...
object LoadingIndicator
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactSelect.indicatorsMod.LoadingIndicator] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactSelect.indicatorsMod.LoadingIndicator] = {
  ...
  type Props = LoadingIconProps[js.Any]
}
