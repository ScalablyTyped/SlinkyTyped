...
object Creatable {
  ...
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](): Builder[OptionType] = {
    val __props = js.Dynamic.literal()
    new Builder[OptionType](js.Array(this.component, __props.asInstanceOf[Props[OptionType]]))
  }
  implicit def make[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](companion: Creatable.type): Builder[OptionType] = new Builder[OptionType](js.Array(this.component, js.Dictionary.empty))()
}
