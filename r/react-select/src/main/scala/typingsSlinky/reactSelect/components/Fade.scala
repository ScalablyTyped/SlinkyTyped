...
object Fade
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactSelect.transitionsMod.Fade] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactSelect.transitionsMod.Fade] = {
