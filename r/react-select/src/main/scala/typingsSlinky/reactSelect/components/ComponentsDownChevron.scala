...
object ComponentsDownChevron {
  ...
  implicit def make(companion: ComponentsDownChevron.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
