...
object CreatableProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](): CreatableProps[OptionType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreatableProps[OptionType]]
  }
  @scala.inline
  implicit class CreatablePropsOps[Self <: CreatableProps[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with CreatableProps[OptionType]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFormatCreateLabel(value: /* inputValue */ String => ReactElement): Self = this.set("formatCreateLabel", js.Any.fromFunction1(value))
    @scala.inline
    def deleteFormatCreateLabel: Self = this.set("formatCreateLabel", js.undefined)
    @scala.inline
    def setGetNewOptionData(value: (/* inputValue */ String, /* optionLabel */ ReactElement) => OptionType): Self = this.set("getNewOptionData", js.Any.fromFunction2(value))
    @scala.inline
