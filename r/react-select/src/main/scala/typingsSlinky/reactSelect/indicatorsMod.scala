...
object indicatorsMod {
  ...
  @js.native
  val ClearIndicator: ReactComponentClass[IndicatorProps[js.Any]] = js.native
  ...
  @js.native
  val DropdownIndicator: ReactComponentClass[IndicatorProps[js.Any]] = js.native
  
  @JSImport("react-select/src/components/indicators", "IndicatorSeparator")
  @js.native
  val IndicatorSeparator: ReactComponentClass[IndicatorProps[js.Any]] = js.native
  
  @JSImport("react-select/src/components/indicators", "LoadingIndicator")
  @js.native
  val LoadingIndicator: ReactComponentClass[LoadingIconProps[js.Any]] = js.native
