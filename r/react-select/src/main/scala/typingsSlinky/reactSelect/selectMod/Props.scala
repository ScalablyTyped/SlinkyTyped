...
object Props {
  ...
  implicit class PropsOps[Self <: Props[_], OptionType /* <: OptionTypeBase */] (val x: Self with Props[OptionType]) extends AnyVal {
    ...
    @scala.inline
    def setFormatGroupLabel(value: /* group */ GroupType[OptionType] => ReactElement): Self = this.set("formatGroupLabel", js.Any.fromFunction1(value))
    ...
    ): Self = this.set("formatOptionLabel", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnMenuScrollToBottom(value: /* event */ SyntheticEvent[Event, HTMLElement] => Unit): Self = this.set("onMenuScrollToBottom", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMenuScrollToBottom: Self = this.set("onMenuScrollToBottom", js.undefined)
    
    @scala.inline
    def setOnMenuScrollToTop(value: /* event */ SyntheticEvent[Event, HTMLElement] => Unit): Self = this.set("onMenuScrollToTop", js.Any.fromFunction1(value))
