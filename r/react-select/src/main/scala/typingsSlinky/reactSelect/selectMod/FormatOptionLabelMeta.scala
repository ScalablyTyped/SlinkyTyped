...
object FormatOptionLabelMeta {
  ...
  @scala.inline
  implicit class FormatOptionLabelMetaOps[Self <: FormatOptionLabelMeta[_], OptionType /* <: OptionTypeBase */] (val x: Self with FormatOptionLabelMeta[OptionType]) extends AnyVal {
