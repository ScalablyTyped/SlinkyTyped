...
object FormatOptionLabelMeta {
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](context: FormatOptionLabelContext, inputValue: String): FormatOptionLabelMeta[OptionType] = {
  ...
  @scala.inline
  implicit class FormatOptionLabelMetaOps[Self <: FormatOptionLabelMeta[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with FormatOptionLabelMeta[OptionType]) extends AnyVal {
    @scala.inline
