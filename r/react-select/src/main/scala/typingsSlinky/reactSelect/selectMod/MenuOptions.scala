...
object MenuOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](focusable: js.Array[OptionType], render: js.Array[OptionType]): MenuOptions[OptionType] = {
  ...
  @scala.inline
  implicit class MenuOptionsOps[Self <: MenuOptions[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with MenuOptions[OptionType]) extends AnyVal {
    @scala.inline
