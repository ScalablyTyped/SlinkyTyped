...
object Props {
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](): Props[OptionType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Props[OptionType]]
  }
  @scala.inline
  implicit class PropsOps[Self <: Props[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with Props[OptionType]) extends AnyVal {
    @scala.inline
