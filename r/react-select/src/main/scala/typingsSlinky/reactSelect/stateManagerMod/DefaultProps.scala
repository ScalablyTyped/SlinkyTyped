...
object DefaultProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](defaultInputValue: String, defaultMenuIsOpen: Boolean): DefaultProps[OptionType] = {
  ...
  @scala.inline
  implicit class DefaultPropsOps[Self <: DefaultProps[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with DefaultProps[OptionType]) extends AnyVal {
    @scala.inline
