...
object SelectComponentsConfig {
  @scala.inline
  def apply[/* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType](): SelectComponentsConfig[OptionType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SelectComponentsConfig[OptionType]]
  }
  @scala.inline
  implicit class SelectComponentsConfigOps[Self <: SelectComponentsConfig[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with SelectComponentsConfig[OptionType]) extends AnyVal {
    @scala.inline
