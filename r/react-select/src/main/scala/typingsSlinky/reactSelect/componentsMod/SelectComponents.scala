...
object SelectComponents {
  ...
  @scala.inline
  implicit class SelectComponentsOps[Self <: SelectComponents[_], /* <: typingsSlinky.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with SelectComponents[OptionType]) extends AnyVal {
    @scala.inline
