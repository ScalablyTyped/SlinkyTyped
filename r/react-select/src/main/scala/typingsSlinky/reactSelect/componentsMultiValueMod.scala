...
import typingsSlinky.reactSelect.anon.CropWithEllipsis
...
object componentsMultiValueMod {
  ...
  @js.native
  val MultiValueContainer: ReactComponentClass[MultiValueGenericProps[js.Any]] = js.native
  
  @JSImport("react-select/src/components/MultiValue", "MultiValueGeneric")
  @js.native
  val MultiValueGeneric: ReactComponentClass[MultiValueGenericProps[js.Any]] = js.native
  
  @JSImport("react-select/src/components/MultiValue", "MultiValueLabel")
  @js.native
  val MultiValueLabel: ReactComponentClass[MultiValueGenericProps[js.Any]] = js.native
