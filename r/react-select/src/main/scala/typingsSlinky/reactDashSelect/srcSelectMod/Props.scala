...
import typingsSlinky.reactDashSelect.srcTypesMod.FocusEventHandler
...
- Dropped {[ key in string ]: any} */ trait Props[OptionType /* <: OptionTypeBase */] extends js.Object {
  ...
  var formatGroupLabel: js.UndefOr[typingsSlinky.reactDashSelect.srcBuiltinsMod.formatGroupLabel[OptionType]] = js.undefined
  ...
  var getOptionLabel: js.UndefOr[typingsSlinky.reactDashSelect.srcBuiltinsMod.getOptionLabel[OptionType]] = js.undefined
  /* Resolves option data to a string to compare options and specify value attributes */
  var getOptionValue: js.UndefOr[typingsSlinky.reactDashSelect.srcBuiltinsMod.getOptionValue[OptionType]] = js.undefined
  ...
  var onMenuScrollToBottom: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLElement], Unit]] = js.undefined
  /* Fired when the user scrolls to the top of the menu */
  var onMenuScrollToTop: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLElement], Unit]] = js.undefined
...
object Props {
  ...
  def apply[OptionType /* <: OptionTypeBase */](
    ...
    formatOptionLabel: (/* option */ OptionType, /* labelMeta */ FormatOptionLabelMeta[OptionType]) => TagMod[Any] = null,
