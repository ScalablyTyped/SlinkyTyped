...
object MenuList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashSelect.srcComponentsMenuMod.MenuList] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashSelect.srcComponentsMenuMod.MenuList] = {
