...
object Placeholder
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashSelect.animatedMod.Placeholder] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashSelect.animatedMod.Placeholder] = {
  ...
  type Props = AnimatedPlaceholderProps[js.Any]
}
