...
import typingsSlinky.reactDashSelect.Anon_ClassNameEvent
import typingsSlinky.reactDashSelect.srcComponentsMultiValueMod.MultiValueRemoveProps
...
object MultiValueRemove
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashSelect.srcComponentsMultiValueMod.MultiValueRemove[js.Any]
    ] {
  ...
  def apply[OptionType /* <: OptionTypeBase */](
    ...
    selectProps: typingsSlinky.reactDashSelect.srcSelectMod.Props[OptionType] with js.Any,
