...
object ButtonProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ T](): ButtonProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ButtonProps[T]]
  }
  @scala.inline
  implicit class ButtonPropsOps[Self <: ButtonProps[_], /* <: typingsSlinky.std.HTMLElement */ T] (val x: Self with ButtonProps[T]) extends AnyVal {
    @scala.inline
