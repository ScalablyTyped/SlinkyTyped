...
object MenuProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ T](children: ReactElement | (js.Function1[/* hasIsOpen */ IsOpen, ReactElement])): MenuProps[T] = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.asInstanceOf[MenuProps[T]]
  }
  @scala.inline
  implicit class MenuPropsOps[Self <: MenuProps[_], /* <: typingsSlinky.std.HTMLElement */ T] (val x: Self with MenuProps[T]) extends AnyVal {
    @scala.inline
