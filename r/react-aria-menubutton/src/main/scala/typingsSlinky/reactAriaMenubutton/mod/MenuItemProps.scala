...
object MenuItemProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ T](): MenuItemProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuItemProps[T]]
  }
  @scala.inline
  implicit class MenuItemPropsOps[Self <: MenuItemProps[_], /* <: typingsSlinky.std.HTMLElement */ T] (val x: Self with MenuItemProps[T]) extends AnyVal {
    @scala.inline
