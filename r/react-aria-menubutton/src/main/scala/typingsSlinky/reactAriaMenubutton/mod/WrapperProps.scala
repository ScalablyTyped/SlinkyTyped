...
trait WrapperProps[T /* <: HTMLElement */]
  ...
  /**
    ...
    */
  var onSelection: js.UndefOr[js.Function2[/* value */ js.Any, /* event */ SyntheticEvent[Event, T], _]] = js.undefined
  var tag: js.UndefOr[
...
object WrapperProps {
  ...
  def apply[T](
    ...
    onSelection: (/* value */ js.Any, /* event */ SyntheticEvent[Event, T]) => _ = null,
