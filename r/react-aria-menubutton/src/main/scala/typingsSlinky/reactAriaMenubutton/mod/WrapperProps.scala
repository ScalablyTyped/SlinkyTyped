...
object WrapperProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ T](): WrapperProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WrapperProps[T]]
  }
  @scala.inline
  implicit class WrapperPropsOps[Self <: WrapperProps[_], /* <: typingsSlinky.std.HTMLElement */ T] (val x: Self with WrapperProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnSelection(value: (/* value */ js.Any, /* event */ SyntheticEvent[Event, T]) => _): Self = this.set("onSelection", js.Any.fromFunction2(value))
    @scala.inline
