...
trait WrapperProps[T /* <: HTMLElement */]
  ...
  /**
  	 ...
  	 */
  var onSelection: js.UndefOr[js.Function2[/* value */ js.Any, /* event */ SyntheticEvent[Event_, T], _]] = js.undefined
  var tag: js.UndefOr[
...
object WrapperProps {
  ...
  def apply[T /* <: HTMLElement */](
    ...
    onSelection: (/* value */ js.Any, /* event */ SyntheticEvent[Event_, T]) => _ = null,
