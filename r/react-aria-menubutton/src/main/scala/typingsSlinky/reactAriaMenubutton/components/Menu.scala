...
object Menu
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactAriaMenubutton.mod.Menu] {
  ...
  ): BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Menu] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactAriaMenubutton.mod.Menu] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Menu](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
