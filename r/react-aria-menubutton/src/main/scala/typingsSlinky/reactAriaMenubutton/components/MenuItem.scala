...
import typingsSlinky.reactAriaMenubutton.mod.MenuItemProps
...
object MenuItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactAriaMenubutton.mod.MenuItem] {
  ...
  ): BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.MenuItem] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactAriaMenubutton.mod.MenuItem] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.MenuItem](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
