...
object Button
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactAriaMenubutton.mod.Button] {
  ...
  ): BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Button] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactAriaMenubutton.mod.Button] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Button](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ButtonProps[HTMLElement]
}
