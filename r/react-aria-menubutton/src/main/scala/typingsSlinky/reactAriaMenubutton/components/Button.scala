package typingsSlinky.reactAriaMenubutton.components
...
import typingsSlinky.reactAriaMenubutton.mod.ButtonProps
...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Button] {
    @scala.inline
    ...
    @scala.inline
    def tag(value: /* import warning: importer.ImportType#apply Failed type conversion: T['tagName'] */ js.Any): this.type = set("tag", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: ButtonProps[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
