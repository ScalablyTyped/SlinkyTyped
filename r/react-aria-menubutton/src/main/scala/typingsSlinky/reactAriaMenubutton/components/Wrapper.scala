...
object Wrapper {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Wrapper] {
    @scala.inline
    ...
    @scala.inline
    def onMenuToggle(value: /* obj */ WrapperState => _): this.type = set("onMenuToggle", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onSelection(value: (/* value */ js.Any, /* event */ SyntheticEvent[Event_, HTMLElement]) => _): this.type = set("onSelection", js.Any.fromFunction2(value))
    @scala.inline
