...
import typingsSlinky.reactAriaMenubutton.mod.WrapperProps
import typingsSlinky.reactAriaMenubutton.mod.WrapperState
...
object Wrapper
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactAriaMenubutton.mod.Wrapper] {
  ...
  def apply(
    ...
    onSelection: (/* value */ js.Any, /* event */ SyntheticEvent[Event_, HTMLElement]) => _ = null,
  ...
  ): BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Wrapper] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactAriaMenubutton.mod.Wrapper] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactAriaMenubutton.mod.Wrapper](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = WrapperProps[HTMLElement]
}
