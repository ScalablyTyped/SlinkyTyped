...
object mod {
  ...
  object MenuProps {
    ...
    implicit class MenuPropsMutableBuilder[Self <: MenuProps[_], T /* <: HTMLElement */] (val x: Self with MenuProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ReactElement | (js.Function1[/* hasIsOpen */ IsOpen, ReactElement])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* hasIsOpen */ IsOpen => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  object WrapperProps {
    ...
    implicit class WrapperPropsMutableBuilder[Self <: WrapperProps[_], T /* <: HTMLElement */] (val x: Self with WrapperProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setOnSelection(value: (/* value */ js.Any, /* event */ SyntheticEvent[Event, T]) => _): Self = StObject.set(x, "onSelection", js.Any.fromFunction2(value))
