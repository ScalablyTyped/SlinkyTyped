...
import typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.ButtonProps
...
object Button
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.Button
    ] {
  ...
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.Button](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
