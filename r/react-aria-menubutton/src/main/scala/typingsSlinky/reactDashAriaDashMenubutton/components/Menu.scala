...
import typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.MenuProps
...
object Menu
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.Menu
    ] {
  ...
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.Menu](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MenuProps[HTMLElement]
}
