...
import typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.WrapperProps
import typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.WrapperState
...
object Wrapper
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.Wrapper
    ] {
  ...
  def apply(
    ...
    onSelection: (/* value */ js.Any, /* event */ SyntheticEvent[Event, HTMLElement]) => _ = null,
  ...
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.Wrapper](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
