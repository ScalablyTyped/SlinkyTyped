package typingsSlinky.reactDashAriaDashMenubutton.components
...
import typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.MenuItemProps
...
object MenuItem
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.MenuItem
    ] {
  ...
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashAriaDashMenubutton.reactDashAriaDashMenubuttonMod.MenuItem](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MenuItemProps[HTMLElement]
}
