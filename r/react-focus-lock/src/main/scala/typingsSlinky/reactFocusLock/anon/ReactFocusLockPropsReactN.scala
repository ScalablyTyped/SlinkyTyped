...
object ReactFocusLockPropsReactN {
  ...
  implicit class ReactFocusLockPropsReactNOps[Self <: ReactFocusLockPropsReactN] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSideCar(value: ReactComponentClass[_]): Self = this.set("sideCar", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setAsFunctionComponent(value: ReactComponentClass[(Record[String, _]) with Children]): Self = this.set("as", value.asInstanceOf[js.Any])
    @scala.inline
    def setAsComponentClass(value: ReactComponentClass[(Record[String, _]) with Children]): Self = this.set("as", value.asInstanceOf[js.Any])
    @scala.inline
