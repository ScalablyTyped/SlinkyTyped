...
object ReactFocusLockPropsReactN {
  ...
  implicit class ReactFocusLockPropsReactNOps[Self <: ReactFocusLockPropsReactN] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAsFunctionComponent(value: ReactComponentClass[(Record[String, _]) with Children]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("as")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAsComponentClass(value: ReactComponentClass[(Record[String, _]) with Children]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("as")(value.asInstanceOf[js.Any])
        ret
    }
