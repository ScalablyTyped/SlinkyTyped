...
object interfacesMod {
  ...
  object ReactFocusLockProps {
    ...
    implicit class ReactFocusLockPropsMutableBuilder[Self <: ReactFocusLockProps[_, _], ChildrenType, LockProps] (val x: Self with (ReactFocusLockProps[ChildrenType, LockProps])) extends AnyVal {
      ...
      @scala.inline
      def setAsComponentClass(value: ReactComponentClass[LockProps with ChildrenChildrenType[ChildrenType]]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAsFunctionComponent(value: ReactComponentClass[LockProps with ChildrenChildrenType[ChildrenType]]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
