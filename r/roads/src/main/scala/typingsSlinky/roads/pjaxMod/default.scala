...
class default protected () extends RoadsPjax {
  ...
  /* CompleteClass */
  override var _road: typingsSlinky.roads.roadMod.default = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def render(response_object: typingsSlinky.roads.responseMod.default): Unit = js.native
}
