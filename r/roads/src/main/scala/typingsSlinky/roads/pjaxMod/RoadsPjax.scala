...
object RoadsPjax {
  ...
  implicit class RoadsPjaxOps[Self <: RoadsPjax] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_road(value: typingsSlinky.roads.roadMod.default): Self = this.set("_road", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRender(value: typingsSlinky.roads.responseMod.default => Unit): Self = this.set("render", js.Any.fromFunction1(value))
