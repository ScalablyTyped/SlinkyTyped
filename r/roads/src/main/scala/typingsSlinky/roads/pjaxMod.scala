...
object pjaxMod {
  ...
  object RoadsPjax {
    ...
    implicit class RoadsPjaxMutableBuilder[Self <: RoadsPjax] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRender(value: typingsSlinky.roads.responseMod.default => Unit): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def set_road(value: typingsSlinky.roads.roadMod.default): Self = StObject.set(x, "_road", value.asInstanceOf[js.Any])
