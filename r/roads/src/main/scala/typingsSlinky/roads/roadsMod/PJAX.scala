...
class PJAX protected () extends js.Object {
  ...
  def this(road: Road, container_element: Null, window: Window) = this()
  def this(road: Road, container_element: Element, window: Window) = this()
  /**
    ...
    */
  def addCookieMiddleware(document: Document): js.Any = js.native
  /**
