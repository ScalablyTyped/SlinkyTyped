...
object RcTreeSelect {
  ...
  implicit def make[ValueType](companion: RcTreeSelect.type): SharedBuilder_TreeSelectProps_1571959893[default[ValueType], ValueType] = new SharedBuilder_TreeSelectProps_1571959893[default[ValueType], ValueType](js.Array(this.component, js.Dictionary.empty))()
  object TreeNode {
