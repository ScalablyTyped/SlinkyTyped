...
object Accepts {
  ...
  @scala.inline
  implicit class AcceptsOps[Self <: Accepts] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAccepts(value: String | js.Array[String]): Self = this.set("accepts", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHandleFiles(value: /* files */ js.Array[Blob] => Unit): Self = this.set("handleFiles", js.Any.fromFunction1(value))
    @scala.inline
