...
object MaterialIndicator
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeIndicators.mod.MaterialIndicator] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.MaterialIndicator] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.MaterialIndicator] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeIndicators.mod.MaterialIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
