...
import typingsSlinky.reactNativeIndicators.mod.BallIndicatorProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object BallIndicator
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeIndicators.mod.BallIndicator] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.BallIndicator] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.BallIndicator] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeIndicators.mod.BallIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
