...
object BarIndicator
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeIndicators.mod.BarIndicator] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.BarIndicator] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.BarIndicator] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeIndicators.mod.BarIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
