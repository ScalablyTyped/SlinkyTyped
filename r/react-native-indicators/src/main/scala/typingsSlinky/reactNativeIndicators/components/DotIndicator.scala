...
object DotIndicator
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeIndicators.mod.DotIndicator] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.DotIndicator] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeIndicators.mod.DotIndicator] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeIndicators.mod.DotIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
