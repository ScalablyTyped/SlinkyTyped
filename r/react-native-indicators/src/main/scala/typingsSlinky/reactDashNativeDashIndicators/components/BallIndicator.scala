...
import typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.BallIndicatorProps
...
object BallIndicator
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.BallIndicator
    ] {
  ...
  typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.BallIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
