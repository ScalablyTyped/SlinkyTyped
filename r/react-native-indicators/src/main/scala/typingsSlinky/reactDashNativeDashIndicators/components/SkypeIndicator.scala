...
import typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.SkypeIndicatorProps
...
object SkypeIndicator
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.SkypeIndicator
    ] {
  ...
  typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.SkypeIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
