...
import typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.PulseIndicatorProps
...
object PulseIndicator
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.PulseIndicator
    ] {
  ...
  typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.PulseIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
