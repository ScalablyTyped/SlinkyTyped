...
object BarIndicator
  ...
  typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.BarIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
