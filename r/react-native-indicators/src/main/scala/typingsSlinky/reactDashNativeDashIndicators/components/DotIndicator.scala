...
import typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.DotIndicatorProps
...
object DotIndicator
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.DotIndicator
    ] {
  ...
  typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.DotIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
