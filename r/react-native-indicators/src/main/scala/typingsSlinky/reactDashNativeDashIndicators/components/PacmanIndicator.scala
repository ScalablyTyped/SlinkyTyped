...
import typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.PacmanIndicatorProps
...
object PacmanIndicator
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.PacmanIndicator
    ] {
  ...
  typingsSlinky.reactDashNativeDashIndicators.reactDashNativeDashIndicatorsMod.PacmanIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
