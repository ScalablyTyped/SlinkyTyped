...
import typingsSlinky.reactDashInteractive.reactDashInteractiveMod.ClickType
...
trait Anon_Arg0 extends js.Object {
  ...
  var onClick: js.UndefOr[
    js.Function2[/* event */ SyntheticEvent[Event, Element], /* clickType */ ClickType, Unit]
  ] = js.undefined
...
object Anon_Arg0 {
  ...
  def apply(
    ...
    onClick: (/* event */ SyntheticEvent[Event, Element], /* clickType */ ClickType) => Unit = null,
