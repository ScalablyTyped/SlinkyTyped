...
object anon {
  ...
  object As {
    ...
    implicit class AsMutableBuilder[Self <: As] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnLongPress(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = StObject.set(x, "onLongPress", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnTapFour(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = StObject.set(x, "onTapFour", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnTapFourUndefined: Self = StObject.set(x, "onTapFour", js.undefined)
      
      @scala.inline
      def setOnTapThree(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = StObject.set(x, "onTapThree", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnTapThreeUndefined: Self = StObject.set(x, "onTapThree", js.undefined)
      
      @scala.inline
      def setOnTapTwo(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = StObject.set(x, "onTapTwo", js.Any.fromFunction1(value))
  ...
  object Event {
    ...
    implicit class EventMutableBuilder[Self <: Event] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEvent(value: SyntheticEvent[org.scalajs.dom.raw.Event, Element]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
