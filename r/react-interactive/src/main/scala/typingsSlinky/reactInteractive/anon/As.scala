...
object As {
  ...
  implicit class AsOps[Self <: As] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnLongPress(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = this.set("onLongPress", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnTapFour(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = this.set("onTapFour", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnTapFour: Self = this.set("onTapFour", js.undefined)
    
    @scala.inline
    def setOnTapThree(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = this.set("onTapThree", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnTapThree: Self = this.set("onTapThree", js.undefined)
    
    @scala.inline
    def setOnTapTwo(value: /* event */ org.scalajs.dom.raw.Event => Unit): Self = this.set("onTapTwo", js.Any.fromFunction1(value))
