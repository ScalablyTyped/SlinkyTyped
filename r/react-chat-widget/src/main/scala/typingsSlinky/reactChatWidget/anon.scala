...
object anon {
  ...
  object Autofocus {
    ...
    implicit class AutofocusMutableBuilder[Self <: Autofocus] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomLauncher(value: ReactComponentClass[js.Function0[Unit]]): Self = StObject.set(x, "customLauncher", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomLauncherComponentClass(value: ReactComponentClass[js.Function0[Unit]]): Self = StObject.set(x, "customLauncher", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomLauncherFunctionComponent(value: ReactComponentClass[js.Function0[Unit]]): Self = StObject.set(x, "customLauncher", value.asInstanceOf[js.Any])
