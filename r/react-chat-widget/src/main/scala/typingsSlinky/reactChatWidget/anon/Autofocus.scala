...
object Autofocus {
  ...
  implicit class AutofocusOps[Self <: Autofocus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomLauncherFunctionComponent(value: ReactComponentClass[js.Function0[Unit]]): Self = this.set("customLauncher", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomLauncherComponentClass(value: ReactComponentClass[js.Function0[Unit]]): Self = this.set("customLauncher", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomLauncher(value: ReactComponentClass[js.Function0[Unit]]): Self = this.set("customLauncher", value.asInstanceOf[js.Any])
