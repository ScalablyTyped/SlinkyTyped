...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "popmotion" % "8.7.3-1d3dfc",
  "org.scalablytyped.slinky" %%% "popmotion-pose" % "3.4.11-8318fc",
  "org.scalablytyped.slinky" %%% "popmotion__easing" % "1.0.2-77664a",
  "org.scalablytyped.slinky" %%% "popmotion__popcorn" % "0.4.4-4889b2",
  "org.scalablytyped.slinky" %%% "pose-core" % "2.1.1-e76a03",
