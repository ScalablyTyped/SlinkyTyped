...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "popmotion" % "8.7.3-c5b434",
  "org.scalablytyped.slinky" %%% "popmotion-pose" % "3.4.11-67620c",
  "org.scalablytyped.slinky" %%% "popmotion__easing" % "1.0.2-cc701e",
  "org.scalablytyped.slinky" %%% "popmotion__popcorn" % "0.4.4-1c5622",
  "org.scalablytyped.slinky" %%% "pose-core" % "2.1.1-f10b13",
