...
abstract class SharedApply_Props1279161752[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = typingsSlinky.reactPose.transitionTypesMod.Props
}
