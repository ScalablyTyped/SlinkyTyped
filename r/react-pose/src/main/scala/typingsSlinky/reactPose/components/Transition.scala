...
import typingsSlinky.reactPose.transitionMod.default
...
object Transition {
  ...
  implicit def make(companion: Transition.type): SharedBuilder_Props826758526[default] = new SharedBuilder_Props826758526[default](js.Array(this.component, js.Dictionary.empty))()
}
