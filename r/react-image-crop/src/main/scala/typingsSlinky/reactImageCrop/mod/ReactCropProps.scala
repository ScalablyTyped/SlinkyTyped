...
object ReactCropProps {
  ...
  implicit class ReactCropPropsOps[Self <: ReactCropProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnImageError(value: /* event */ SyntheticEvent[Event, HTMLImageElement] => Unit): Self = this.set("onImageError", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderComponentReactElement(value: ReactElement): Self = this.set("renderComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRenderComponent(value: ReactElement): Self = this.set("renderComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRenderComponent: Self = this.set("renderComponent", js.undefined)
    
    @scala.inline
    def setRenderSelectionAddon(value: /* state */ js.Any => ReactElement): Self = this.set("renderSelectionAddon", js.Any.fromFunction1(value))
