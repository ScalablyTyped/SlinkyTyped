...
object mod extends Shortcut {
  ...
  object StrategyOverrides {
    ...
    implicit class StrategyOverridesMutableBuilder[Self <: StrategyOverrides] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setShouldRejectClick(value: (/* lastTouchEventTimestamp */ js.Date, /* clickEventTimestamp */ js.Date) => Boolean): Self = StObject.set(x, "shouldRejectClick", js.Any.fromFunction2(value))
