...
import typingsSlinky.reactEditText.mod.EditTextProps
...
object EditText {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactEditText.mod.EditText] {
    ...
    @scala.inline
    def `type`(value: inputTextType): this.type = set("type", value.asInstanceOf[js.Any])
