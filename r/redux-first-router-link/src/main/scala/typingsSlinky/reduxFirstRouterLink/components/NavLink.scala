package typingsSlinky.reduxFirstRouterLink.components
...
import typingsSlinky.reduxFirstRouterLink.mod.Match
import typingsSlinky.reduxFirstRouterLink.mod.NavLinkProps
...
object NavLink {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reduxFirstRouterLink.mod.NavLink] {
    ...
    @scala.inline
    def ariaCurrent(value: String): this.type = set("ariaCurrent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def down(value: Boolean): this.type = set("down", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def isActive(value: (/* match */ Match[js.Object], /* location */ Location) => Boolean): this.type = set("isActive", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def redirect(value: Boolean): this.type = set("redirect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def shouldDispatch(value: Boolean): this.type = set("shouldDispatch", value.asInstanceOf[js.Any])
