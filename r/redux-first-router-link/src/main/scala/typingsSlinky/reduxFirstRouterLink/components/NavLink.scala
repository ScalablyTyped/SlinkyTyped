...
object NavLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reduxFirstRouterLink.mod.NavLink] {
  @JSImport("redux-first-router-link", "NavLink")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: className, contentEditable, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, hidden, id, lang, placeholder, spellCheck, style, suppressContentEditableWarning, tabIndex, target, title */
  def apply(
    to: To,
    about: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reduxFirstRouterLink.mod.NavLink] = {
