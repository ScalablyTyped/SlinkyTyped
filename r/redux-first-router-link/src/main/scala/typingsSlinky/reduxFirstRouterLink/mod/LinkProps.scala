...
object LinkProps {
  ...
  implicit class LinkPropsOps[Self <: LinkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShouldDispatch(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shouldDispatch")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutShouldDispatch: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shouldDispatch")(js.undefined)
        ret
    }
    @scala.inline
