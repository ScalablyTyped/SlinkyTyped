...
object SwipeableConfig {
  ...
  implicit class SwipeableConfigOps[Self <: SwipeableConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnSwipeDown(value: (Double, Double, js.Function0[Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onSwipeDown")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withOnSwipeLeft(value: (Double, Double, js.Function0[Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onSwipeLeft")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withOnSwipeRight(value: (Double, Double, js.Function0[Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onSwipeRight")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withOnSwipeUp(value: (Double, Double, js.Function0[Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onSwipeUp")(js.Any.fromFunction3(value))
        ret
    }
  }
