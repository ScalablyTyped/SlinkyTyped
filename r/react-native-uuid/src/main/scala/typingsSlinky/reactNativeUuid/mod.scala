package typingsSlinky.reactNativeUuid
...
object mod extends Shortcut {
  ...
  trait uuid extends StObject {
    ...
    def parse(id: String, buffer: js.UndefOr[scala.Nothing], offset: Double): js.typedarray.ArrayBuffer = js.native
    ...
    def v1(options: js.UndefOr[scala.Nothing], buffer: js.typedarray.ArrayBuffer): String = js.native
    def v1(options: js.UndefOr[scala.Nothing], buffer: js.typedarray.ArrayBuffer, offset: Double): String = js.native
    def v1(options: typingsSlinky.reactNativeUuid.mod.v1): String = js.native
    def v1(options: typingsSlinky.reactNativeUuid.mod.v1, buffer: js.UndefOr[scala.Nothing], offset: Double): String = js.native
    ...
    def v4(options: js.UndefOr[scala.Nothing], buffer: js.typedarray.ArrayBuffer): String = js.native
    def v4(options: js.UndefOr[scala.Nothing], buffer: js.typedarray.ArrayBuffer, offset: Double): String = js.native
    def v4(options: typingsSlinky.reactNativeUuid.mod.v4): String = js.native
    def v4(options: typingsSlinky.reactNativeUuid.mod.v4, buffer: js.UndefOr[scala.Nothing], offset: Double): String = js.native
  ...
  object v1 {
    ...
    implicit class v1MutableBuilder[Self <: v1] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMsecs(value: Double | js.Date): Self = StObject.set(x, "msecs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMsecsDate(value: js.Date): Self = StObject.set(x, "msecs", value.asInstanceOf[js.Any])
