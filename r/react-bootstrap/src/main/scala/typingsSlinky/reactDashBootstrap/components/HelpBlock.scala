...
import typingsSlinky.reactDashBootstrap.libHelpBlockMod.HelpBlockProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object HelpBlock
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.HelpBlock] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libHelpBlockMod.HelpBlock] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libHelpBlockMod.HelpBlock, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libHelpBlockMod.HelpBlock, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.HelpBlock] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.HelpBlock] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.HelpBlock](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
