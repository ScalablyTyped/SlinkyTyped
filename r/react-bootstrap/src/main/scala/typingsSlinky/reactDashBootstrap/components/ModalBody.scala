...
import typingsSlinky.reactDashBootstrap.libModalBodyMod.ModalBodyProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ModalBody
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalBody] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libModalBodyMod.ModalBody] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libModalBodyMod.ModalBody, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libModalBodyMod.ModalBody, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalBody] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalBody] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalBody](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
