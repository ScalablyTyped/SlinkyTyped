...
import typingsSlinky.reactDashBootstrap.libAlertMod.AlertProps
...
object Alert
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.Alert] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libAlertMod.Alert] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libAlertMod.Alert, Event] => Unit = null,
    onDismiss: js.Function = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libAlertMod.Alert, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Alert] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Alert] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.Alert](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
