...
import typingsSlinky.reactDashBootstrap.libNavbarToggleMod.NavbarToggleProps
import typingsSlinky.reactDashBootstrap.libNavbarToggleMod.^
...
object NavbarToggle
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libNavbarToggleMod.NavbarToggle] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libNavbarToggleMod.NavbarToggle, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libNavbarToggleMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
