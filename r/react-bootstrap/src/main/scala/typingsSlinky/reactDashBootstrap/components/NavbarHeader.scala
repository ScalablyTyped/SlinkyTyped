...
import typingsSlinky.reactDashBootstrap.libNavbarHeaderMod.NavbarHeaderProps
import typingsSlinky.reactDashBootstrap.libNavbarHeaderMod.^
...
object NavbarHeader
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libNavbarHeaderMod.NavbarHeader] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libNavbarHeaderMod.NavbarHeader, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libNavbarHeaderMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = NavbarHeaderProps
}
