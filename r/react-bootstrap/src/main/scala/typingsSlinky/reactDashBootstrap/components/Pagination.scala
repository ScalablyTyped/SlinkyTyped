...
import typingsSlinky.reactDashBootstrap.libPaginationMod.PaginationProps
...
object Pagination
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.Pagination] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPaginationMod.Pagination] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPaginationMod.Pagination, 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Pagination] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Pagination] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.Pagination](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
