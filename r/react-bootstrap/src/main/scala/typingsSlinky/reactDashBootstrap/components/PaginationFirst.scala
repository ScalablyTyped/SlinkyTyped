...
import typingsSlinky.reactDashBootstrap.libPaginationFirstMod.PaginationFirstProps
import typingsSlinky.reactDashBootstrap.libPaginationFirstMod.^
...
object PaginationFirst
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPaginationFirstMod.PaginationFirst] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPaginationFirstMod.PaginationFirst, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPaginationFirstMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
