...
import typingsSlinky.reactDashBootstrap.libModalDialogMod.ModalDialogProps
...
object ModalDialog
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalDialog] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libModalDialogMod.ModalDialog] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libModalDialogMod.ModalDialog, 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalDialog] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalDialog] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.ModalDialog](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
