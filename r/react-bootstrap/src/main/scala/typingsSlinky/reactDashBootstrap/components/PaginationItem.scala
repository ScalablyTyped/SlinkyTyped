...
import typingsSlinky.reactDashBootstrap.libPaginationItemMod.PaginationItemProps
import typingsSlinky.reactDashBootstrap.libPaginationItemMod.^
...
object PaginationItem
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPaginationItemMod.PaginationItem] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPaginationItemMod.PaginationItem, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPaginationItemMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
