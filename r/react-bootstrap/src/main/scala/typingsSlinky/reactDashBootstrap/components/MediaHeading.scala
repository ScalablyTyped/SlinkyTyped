...
import typingsSlinky.reactDashBootstrap.libMediaHeadingMod.MediaHeadingProps
import typingsSlinky.reactDashBootstrap.libMediaHeadingMod.^
...
object MediaHeading
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libMediaHeadingMod.MediaHeading] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libMediaHeadingMod.MediaHeading, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libMediaHeadingMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MediaHeadingProps
}
