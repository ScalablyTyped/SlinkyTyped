...
import typingsSlinky.reactDashBootstrap.libMediaRightMod.MediaRightProps
import typingsSlinky.reactDashBootstrap.libMediaRightMod.^
...
object MediaRight
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libMediaRightMod.MediaRight] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libMediaRightMod.MediaRight, 
      Event
    ] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMediaRightMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
