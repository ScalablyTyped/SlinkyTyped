...
import typingsSlinky.reactDashBootstrap.libCheckboxMod.CheckboxProps
...
object Checkbox
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.Checkbox] {
  @JSImport("react-bootstrap/lib", "Checkbox")
  @js.native
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libCheckboxMod.Checkbox] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libCheckboxMod.Checkbox, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libCheckboxMod.Checkbox, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Checkbox] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Checkbox] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.Checkbox](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
