...
import typingsSlinky.reactDashBootstrap.libPaginationPrevMod.PaginationPrevProps
import typingsSlinky.reactDashBootstrap.libPaginationPrevMod.^
...
object PaginationPrev
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPaginationPrevMod.PaginationPrev] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPaginationPrevMod.PaginationPrev, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPaginationPrevMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = PaginationPrevProps
}
