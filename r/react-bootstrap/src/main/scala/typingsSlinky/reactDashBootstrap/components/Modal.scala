...
import typingsSlinky.reactDashBootstrap.libModalMod.ModalProps
...
object Modal
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.Modal] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libModalMod.Modal] => Unit = null,
    onBackdropClick: /* node */ HTMLElement => _ = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libModalMod.Modal, Event] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libModalMod.Modal, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Modal] = {
