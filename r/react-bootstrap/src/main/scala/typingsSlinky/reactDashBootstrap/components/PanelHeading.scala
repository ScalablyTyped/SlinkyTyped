...
import typingsSlinky.reactDashBootstrap.libPanelHeadingMod.PanelHeadingProps
import typingsSlinky.reactDashBootstrap.libPanelHeadingMod.^
...
object PanelHeading
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPanelHeadingMod.PanelHeading] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPanelHeadingMod.PanelHeading, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPanelHeadingMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = PanelHeadingProps
}
