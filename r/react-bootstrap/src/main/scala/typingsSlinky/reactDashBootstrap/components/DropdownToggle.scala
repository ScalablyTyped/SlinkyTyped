...
import typingsSlinky.reactDashBootstrap.libDropdownToggleMod.DropdownToggleProps
import typingsSlinky.reactDashBootstrap.libDropdownToggleMod.^
...
object DropdownToggle
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libDropdownToggleMod.DropdownToggle] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libDropdownToggleMod.DropdownToggle, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libDropdownToggleMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
