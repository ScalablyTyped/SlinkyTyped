...
import typingsSlinky.reactDashBootstrap.libInputGroupAddonMod.InputGroupAddonProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object InputGroupAddon
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.InputGroupAddon] {
  @JSImport("react-bootstrap/lib", "InputGroupAddon")
  @js.native
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libInputGroupAddonMod.InputGroupAddon] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libInputGroupAddonMod.InputGroupAddon, 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.InputGroupAddon] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.InputGroupAddon] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashBootstrap.libMod.InputGroupAddon](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
