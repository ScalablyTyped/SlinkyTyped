...
import typingsSlinky.reactDashBootstrap.libPaginationEllipsisMod.PaginationEllipsisProps
import typingsSlinky.reactDashBootstrap.libPaginationEllipsisMod.^
...
object PaginationEllipsis
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPaginationEllipsisMod.PaginationEllipsis] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPaginationEllipsisMod.PaginationEllipsis, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPaginationEllipsisMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
