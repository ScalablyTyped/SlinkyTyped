...
import typingsSlinky.reactDashBootstrap.libPanelTitleMod.PanelTitleProps
import typingsSlinky.reactDashBootstrap.libPanelTitleMod.^
...
object PanelTitle
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPanelTitleMod.PanelTitle] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPanelTitleMod.PanelTitle, 
      Event
    ] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libPanelTitleMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
