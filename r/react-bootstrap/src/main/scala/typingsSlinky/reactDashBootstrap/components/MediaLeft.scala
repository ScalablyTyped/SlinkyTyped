...
import typingsSlinky.reactDashBootstrap.libMediaLeftMod.MediaLeftProps
import typingsSlinky.reactDashBootstrap.libMediaLeftMod.^
...
object MediaLeft
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libMediaLeftMod.MediaLeft] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libMediaLeftMod.MediaLeft, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libMediaLeftMod.MediaLeft, Event] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMediaLeftMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MediaLeftProps
}
