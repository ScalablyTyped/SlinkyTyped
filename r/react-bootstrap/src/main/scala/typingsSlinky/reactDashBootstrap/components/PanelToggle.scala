...
import typingsSlinky.reactDashBootstrap.libPanelToggleMod.PanelToggleProps
import typingsSlinky.reactDashBootstrap.libPanelToggleMod.^
...
object PanelToggle
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPanelToggleMod.PanelToggle] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPanelToggleMod.PanelToggle, 
      Event
    ] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libPanelToggleMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
