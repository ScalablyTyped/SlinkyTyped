...
import typingsSlinky.reactDashBootstrap.libFadeMod.FadeProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Fade
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.Fade] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libFadeMod.Fade] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libFadeMod.Fade, Event] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libFadeMod.Fade, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Fade] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Fade] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.Fade](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
