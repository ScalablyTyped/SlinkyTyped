...
import typingsSlinky.reactDashBootstrap.libMediaListItemMod.MediaListItemProps
import typingsSlinky.reactDashBootstrap.libMediaListItemMod.^
...
object MediaListItem
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libMediaListItemMod.MediaListItem] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libMediaListItemMod.MediaListItem, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libMediaListItemMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
