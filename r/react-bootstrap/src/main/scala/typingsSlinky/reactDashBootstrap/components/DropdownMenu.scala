...
import typingsSlinky.reactDashBootstrap.libDropdownMenuMod.DropdownMenuProps
import typingsSlinky.reactDashBootstrap.libDropdownMenuMod.^
...
object DropdownMenu
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libDropdownMenuMod.DropdownMenu] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libDropdownMenuMod.DropdownMenu, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libDropdownMenuMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
