...
import typingsSlinky.reactDashBootstrap.libPanelCollapseMod.PanelCollapseProps
import typingsSlinky.reactDashBootstrap.libPanelCollapseMod.^
...
object PanelCollapse
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPanelCollapseMod.PanelCollapse] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPanelCollapseMod.PanelCollapse, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPanelCollapseMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
