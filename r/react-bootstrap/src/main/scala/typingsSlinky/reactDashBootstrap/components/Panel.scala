...
object Panel
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPanelMod.Panel] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libPanelMod.Panel, Event] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libPanelMod.Panel, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Panel] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Panel] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.Panel](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
