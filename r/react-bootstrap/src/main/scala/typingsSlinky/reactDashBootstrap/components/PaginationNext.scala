...
import typingsSlinky.reactDashBootstrap.libPaginationNextMod.PaginationNextProps
import typingsSlinky.reactDashBootstrap.libPaginationNextMod.^
...
object PaginationNext
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPaginationNextMod.PaginationNext] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPaginationNextMod.PaginationNext, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPaginationNextMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
