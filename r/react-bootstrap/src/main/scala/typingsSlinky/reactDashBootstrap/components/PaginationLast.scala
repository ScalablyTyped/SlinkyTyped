...
import typingsSlinky.reactDashBootstrap.libPaginationLastMod.PaginationLastProps
import typingsSlinky.reactDashBootstrap.libPaginationLastMod.^
...
object PaginationLast
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPaginationLastMod.PaginationLast] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPaginationLastMod.PaginationLast, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libPaginationLastMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = PaginationLastProps
}
