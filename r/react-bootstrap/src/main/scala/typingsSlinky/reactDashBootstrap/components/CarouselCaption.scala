...
import typingsSlinky.reactDashBootstrap.libCarouselCaptionMod.CarouselCaptionProps
...
object CarouselCaption
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libCarouselCaptionMod.CarouselCaption] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libCarouselCaptionMod.CarouselCaption, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libCarouselCaptionMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
