...
import typingsSlinky.reactDashBootstrap.libPanelFooterMod.PanelFooterProps
import typingsSlinky.reactDashBootstrap.libPanelFooterMod.^
...
object PanelFooter
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libPanelFooterMod.PanelFooter] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libPanelFooterMod.PanelFooter, 
      Event
    ] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libPanelFooterMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = PanelFooterProps
}
