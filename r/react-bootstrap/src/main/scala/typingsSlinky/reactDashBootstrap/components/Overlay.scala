...
import typingsSlinky.reactDashBootstrap.libOverlayMod.OverlayProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Overlay
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.Overlay] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Overlay] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.Overlay] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.Overlay](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
