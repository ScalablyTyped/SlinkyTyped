...
import typingsSlinky.reactDashBootstrap.libNavbarCollapseMod.NavbarCollapseProps
import typingsSlinky.reactDashBootstrap.libNavbarCollapseMod.^
...
object NavbarCollapse
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libNavbarCollapseMod.NavbarCollapse] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashBootstrap.libNavbarCollapseMod.NavbarCollapse, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrap.libNavbarCollapseMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
