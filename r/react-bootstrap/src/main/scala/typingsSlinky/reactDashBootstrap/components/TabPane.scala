...
import typingsSlinky.reactDashBootstrap.libTabPaneMod.TabPaneProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object TabPane
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashBootstrap.libMod.TabPane] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashBootstrap.libTabPaneMod.TabPane] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libTabPaneMod.TabPane, Event] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashBootstrap.libTabPaneMod.TabPane, Event] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.TabPane] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashBootstrap.libMod.TabPane] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashBootstrap.libMod.TabPane](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
