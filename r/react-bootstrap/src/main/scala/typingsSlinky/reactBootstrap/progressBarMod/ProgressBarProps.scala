...
object ProgressBarProps {
  ...
  implicit class ProgressBarPropsOps[Self <: ProgressBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInterpolatedClass(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("interpolatedClass")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutInterpolatedClass: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("interpolatedClass")(js.undefined)
        ret
    }
    @scala.inline
