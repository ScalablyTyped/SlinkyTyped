...
object pagerMod {
  ...
  @js.native
  class Item ()
    extends typingsSlinky.reactBootstrap.pagerItemMod.^
  /* static member */
  @JSImport("react-bootstrap/lib/Pager", "Item")
  @js.native
  def Item: Instantiable0[typingsSlinky.reactBootstrap.pagerItemMod.^] = js.native
  @scala.inline
  def Item_=(x: Instantiable0[typingsSlinky.reactBootstrap.pagerItemMod.^]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
