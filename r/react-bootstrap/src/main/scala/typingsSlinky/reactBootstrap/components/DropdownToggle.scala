...
object DropdownToggle {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onAbort(
      value: SyntheticEvent[Event_, typingsSlinky.reactBootstrap.dropdownToggleMod.DropdownToggle] => Unit
  ...
  def withProps(p: DropdownToggleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: DropdownToggle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
