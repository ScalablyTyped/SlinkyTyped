...
object NavbarCollapse {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onAbort(
      value: SyntheticEvent[Event_, typingsSlinky.reactBootstrap.navbarCollapseMod.NavbarCollapse] => Unit
  ...
  def withProps(p: HTMLProps[typingsSlinky.reactBootstrap.navbarCollapseMod.NavbarCollapse]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: NavbarCollapse.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
