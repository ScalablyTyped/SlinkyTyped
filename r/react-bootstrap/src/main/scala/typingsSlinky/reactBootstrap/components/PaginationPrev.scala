...
object PaginationPrev {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onAbort(
      value: SyntheticEvent[Event_, typingsSlinky.reactBootstrap.paginationPrevMod.PaginationPrev] => Unit
  ...
  def withProps(p: PaginationPrevProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: PaginationPrev.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
