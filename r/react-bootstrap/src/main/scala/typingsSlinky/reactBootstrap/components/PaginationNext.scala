...
object PaginationNext {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onAbort(
      value: SyntheticEvent[Event_, typingsSlinky.reactBootstrap.paginationNextMod.PaginationNext] => Unit
  ...
  def withProps(p: PaginationNextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: PaginationNext.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
