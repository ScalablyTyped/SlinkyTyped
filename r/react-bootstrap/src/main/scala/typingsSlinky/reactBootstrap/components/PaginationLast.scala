...
object PaginationLast {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onAbort(
      value: SyntheticEvent[Event_, typingsSlinky.reactBootstrap.paginationLastMod.PaginationLast] => Unit
  ...
  def withProps(p: PaginationLastProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: PaginationLast.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
