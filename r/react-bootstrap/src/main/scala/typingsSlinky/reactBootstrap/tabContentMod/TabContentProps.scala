...
object TabContentProps {
  ...
  implicit class TabContentPropsOps[Self <: TabContentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimationFunctionComponent(value: ReactComponentClass[_]): Self = this.set("animation", value.asInstanceOf[js.Any])
    @scala.inline
    def setAnimationComponentClass(value: ReactComponentClass[_]): Self = this.set("animation", value.asInstanceOf[js.Any])
    @scala.inline
