...
object SinkMap {
  ...
  @scala.inline
  implicit class SinkMapOps[Self <: SinkMap[_, _], InputStream /* <: EventEmitter */, OutputStream /* <: EventEmitter */] (val x: Self with (SinkMap[InputStream, OutputStream])) extends AnyVal {
