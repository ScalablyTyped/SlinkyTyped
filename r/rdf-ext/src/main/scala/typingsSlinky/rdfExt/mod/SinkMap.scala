...
object SinkMap {
  @scala.inline
  def apply[/* <: typingsSlinky.node.eventsMod.EventEmitter */ InputStream, /* <: typingsSlinky.node.eventsMod.EventEmitter */ OutputStream](
  ...
  @scala.inline
  implicit class SinkMapOps[Self <: SinkMap[_, _], /* <: typingsSlinky.node.eventsMod.EventEmitter */ InputStream, /* <: typingsSlinky.node.eventsMod.EventEmitter */ OutputStream] (val x: Self with (SinkMap[InputStream, OutputStream])) extends AnyVal {
    @scala.inline
