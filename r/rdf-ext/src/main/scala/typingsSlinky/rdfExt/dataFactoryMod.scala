...
object dataFactoryMod {
  ...
  object defaults {
    ...
    class PrefixMap protected ()
      extends typingsSlinky.rdfExt.prefixMapMod.^ {
      def this(factory: DataFactory[Quad, Quad], prefixes: typingsSlinky.rdfExt.prefixMapMod.Prefixes) = this()
    }
    @JSImport("rdf-ext/lib/DataFactory", "defaults.PrefixMap")
    @js.native
    def PrefixMap: Instantiable2[
        /* factory */ DataFactory[Quad, Quad], 
        /* prefixes */ typingsSlinky.rdfExt.prefixMapMod.Prefixes, 
        typingsSlinky.rdfExt.prefixMapMod.^
      ] = js.native
    @scala.inline
    def PrefixMap_=(
      x: Instantiable2[
  ...
  type Prefixes = typingsSlinky.rdfExt.prefixMapMod.^ | PrefixesRecord
