...
trait RootOptions extends js.Object {
  ...
  var hydrationOptions: js.UndefOr[typingsSlinky.reactDashDom.experimentalMod.reactDashDomMod.HydrationOptions] = js.undefined
}
...
object RootOptions {
  ...
  def apply(
    ...
    hydrationOptions: typingsSlinky.reactDashDom.experimentalMod.reactDashDomMod.HydrationOptions = null
  ): RootOptions = {
