...
trait RootOptions extends js.Object {
  ...
  var hydrationOptions: js.UndefOr[typingsSlinky.reactDom.experimentalMod.reactDomAugmentingMod.HydrationOptions] = js.undefined
}
...
object RootOptions {
  ...
  implicit class RootOptionsOps[Self <: RootOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHydrationOptions(value: typingsSlinky.reactDom.experimentalMod.reactDomAugmentingMod.HydrationOptions): Self = this.set("hydrationOptions", value.asInstanceOf[js.Any])
    @scala.inline
