...
trait Anon_Assets[ProjectConfig, DependencyConfig] extends js.Object {
...
object Anon_Assets {
  ...
  def apply[ProjectConfig, DependencyConfig](
  ...
  ): Anon_Assets[ProjectConfig, DependencyConfig] = {
    ...
    __obj.asInstanceOf[Anon_Assets[ProjectConfig, DependencyConfig]]
  }
}
