...
import typingsSlinky.atReactDashNativeDashCommunityCli.Anon_Assets
...
trait PlatformConfig[ProjectParams, DependencyParams, ProjectConfig, DependencyConfig] extends js.Object {
  ...
  def linkConfig(): Anon_Assets[ProjectConfig, DependencyConfig]
...
object PlatformConfig {
  ...
  def apply[ProjectParams, DependencyParams, ProjectConfig, DependencyConfig](
    ...
    linkConfig: () => Anon_Assets[ProjectConfig, DependencyConfig],
