...
trait UserDependencyConfig extends js.Object {
  ...
  var dependency: js.UndefOr[typingsSlinky.reactNativeCommunityCli.anon.Hooks] = js.undefined
  // Haste config defined by legacy `rnpm`
  var haste: js.UndefOr[typingsSlinky.reactNativeCommunityCli.anon.Platforms] = js.undefined
...
object UserDependencyConfig {
  ...
  def apply(
    ...
    dependency: typingsSlinky.reactNativeCommunityCli.anon.Hooks = null,
    haste: typingsSlinky.reactNativeCommunityCli.anon.Platforms = null,
