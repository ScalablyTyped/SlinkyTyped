...
object CopyAssets {
  ...
  @scala.inline
  implicit class CopyAssetsOps[Self[projectconfig, dependencyconfig] <: CopyAssets[projectconfig, dependencyconfig], ProjectConfig, DependencyConfig] (val x: Self[ProjectConfig, DependencyConfig]) extends AnyVal {
    @scala.inline
