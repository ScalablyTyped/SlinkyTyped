...
object ReactElementisRootMenuboo {
  ...
  implicit class ReactElementisRootMenubooMutableBuilder[Self <: ReactElementisRootMenuboo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubMenuInstanceComponent(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "subMenuInstance", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubMenuInstanceElement(value: Element): Self = StObject.set(x, "subMenuInstance", value.asInstanceOf[js.Any])
