...
trait PartialSubPopupMenuProps extends js.Object {
  ...
  var builtinPlacements: js.UndefOr[typingsSlinky.rcMenu.interfaceMod.BuiltinPlacements] = js.native
...
object PartialSubPopupMenuProps {
  ...
  implicit class PartialSubPopupMenuPropsOps[Self <: PartialSubPopupMenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBuiltinPlacements(value: typingsSlinky.rcMenu.interfaceMod.BuiltinPlacements): Self = this.set("builtinPlacements", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnDestroy(value: /* key */ typingsSlinky.react.mod.Key => Unit): Self = this.set("onDestroy", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnDestroy: Self = this.set("onDestroy", js.undefined)
    
    @scala.inline
    def setOnOpenChange(value: /* keys */ js.Array[typingsSlinky.react.mod.Key] | Open => Unit): Self = this.set("onOpenChange", js.Any.fromFunction1(value))
