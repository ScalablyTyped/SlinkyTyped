...
object PartialSubPopupMenuProps {
  ...
  implicit class PartialSubPopupMenuPropsOps[Self <: PartialSubPopupMenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBuiltinPlacements(value: typingsSlinky.rcMenu.interfaceMod.BuiltinPlacements): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnDestroy(value: /* key */ typingsSlinky.react.mod.Key => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnOpenChange(value: /* keys */ js.Array[typingsSlinky.react.mod.Key] | Open => Unit): Self = {
        val ret = this.duplicate
