...
object PartialSubPopupMenuProps {
  ...
  def apply(
    ...
    builtinPlacements: typingsSlinky.rcMenu.interfaceMod.BuiltinPlacements = null,
    ...
    onDestroy: /* key */ typingsSlinky.react.mod.Key => Unit = null,
    onOpenChange: /* keys */ js.Array[typingsSlinky.react.mod.Key] | Open => Unit = null,
