...
package object interfaceMod {
  ...
  type HoverEventHandler = js.Function1[/* info */ typingsSlinky.rcMenu.AnonHover, scala.Unit]
  ...
  type MenuHoverEventHandler = js.Function1[/* info */ typingsSlinky.rcMenu.AnonKey, scala.Unit]
  type OpenAnimation = java.lang.String | (typingsSlinky.std.Record[java.lang.String, js.Any])
  type OpenEventHandler = js.Function1[
    /* keys */ js.Array[typingsSlinky.react.mod.Key] | typingsSlinky.rcMenu.AnonOpen, 
    scala.Unit
  ]
