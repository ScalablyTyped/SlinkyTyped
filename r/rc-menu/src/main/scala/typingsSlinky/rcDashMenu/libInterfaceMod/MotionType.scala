...
object MotionType {
  ...
  def apply(
    ...
    onAppearActive: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onAppearEnd: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onAppearStart: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onEnterActive: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onEnterEnd: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onEnterStart: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onLeaveActive: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onLeaveEnd: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
    onLeaveStart: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit] = null,
