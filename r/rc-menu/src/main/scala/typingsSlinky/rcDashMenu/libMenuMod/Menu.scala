...
import typingsSlinky.rcDashMenu.Anon_GetWrappedInstanceSubPopupMenu
...
trait Menu
  ...
  var innerMenu: ReactComponentClass[SubPopupMenuProps] with Anon_GetWrappedInstanceSubPopupMenu = js.native
