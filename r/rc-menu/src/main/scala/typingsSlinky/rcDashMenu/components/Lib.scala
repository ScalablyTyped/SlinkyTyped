...
import typingsSlinky.rcDashMenu.libMod.default
...
object Lib
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.rcDashMenu.libMod.default].asInstanceOf[String | js.Object]
