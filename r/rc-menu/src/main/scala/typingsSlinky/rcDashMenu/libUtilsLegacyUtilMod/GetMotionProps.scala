package typingsSlinky.rcDashMenu.libUtilsLegacyUtilMod

import typingsSlinky.rcDashMenu.libInterfaceMod.AnimationType
import typingsSlinky.rcDashMenu.libInterfaceMod.MotionType
import typingsSlinky.rcDashMenu.libInterfaceMod.TransitionNameType
