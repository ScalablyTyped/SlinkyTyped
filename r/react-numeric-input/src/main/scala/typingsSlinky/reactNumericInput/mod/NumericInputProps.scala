...
object NumericInputProps {
  ...
  implicit class NumericInputPropsOps[Self <: NumericInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxFunction1(value: ReactComponentClass[NumericInputProps] => js.UndefOr[Double]): Self = this.set("max", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setMinFunction1(value: ReactComponentClass[NumericInputProps] => js.UndefOr[Double]): Self = this.set("min", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setMobileFunction1(value: ReactComponentClass[NumericInputProps] => Boolean): Self = this.set("mobile", js.Any.fromFunction1(value))
    
    @scala.inline
    def setMobile(value: Boolean | auto | (js.Function1[ReactComponentClass[NumericInputProps], Boolean])): Self = this.set("mobile", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBlur(value: SyntheticFocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnFocus(value: SyntheticFocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnKeyDown(value: SyntheticKeyboardEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPrecisionFunction1(value: ReactComponentClass[NumericInputProps] => js.UndefOr[Double | Null]): Self = this.set("precision", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPrecision(value: Double | (js.Function1[ReactComponentClass[NumericInputProps], js.UndefOr[Double | Null]])): Self = this.set("precision", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStepFunction2(value: (ReactComponentClass[NumericInputProps], /* direction */ String) => js.UndefOr[Double]): Self = this.set("step", js.Any.fromFunction2(value))
