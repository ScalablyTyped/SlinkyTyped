...
abstract class SharedApply_LinearComponentProps1839916677[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  def apply(
    data: typingsSlinky.reactChartjs2.mod.ChartData[ChartData],
