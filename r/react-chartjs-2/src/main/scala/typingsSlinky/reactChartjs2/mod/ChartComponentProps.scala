...
object ChartComponentProps {
  ...
  implicit class ChartComponentPropsOps[Self <: ChartComponentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataFunction1(value: /* element */ HTMLElement => typingsSlinky.chartJs.mod.ChartData): Self = this.set("data", js.Any.fromFunction1(value))
    
    @scala.inline
    def setData(value: ChartData[typingsSlinky.chartJs.mod.ChartData]): Self = this.set("data", value.asInstanceOf[js.Any])
