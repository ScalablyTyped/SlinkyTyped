...
object locationChangeAction {
  @scala.inline
  def apply[/* <: typingsSlinky.history.mod.Pathname */ P, /* <: typingsSlinky.history.mod.Search */ S, /* <: typingsSlinky.history.mod.Hash */ H](payload: typingsSlinky.reduxFirstRouting.anon.Hash[P, S, H], `type`: ROUTERSlashLOCATION_CHANGE): locationChangeAction[P, S, H] = {
    val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[locationChangeAction[P, S, H]]
  }
  @scala.inline
  implicit class locationChangeActionOps[Self <: locationChangeAction[_, _, _], /* <: typingsSlinky.history.mod.Pathname */ P, /* <: typingsSlinky.history.mod.Search */ S, /* <: typingsSlinky.history.mod.Hash */ H] (val x: Self with (locationChangeAction[P, S, H])) extends AnyVal {
    @scala.inline
