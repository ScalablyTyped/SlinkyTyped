...
object replaceAction {
  @scala.inline
  def apply[/* <: typingsSlinky.history.mod.Path | typingsSlinky.history.mod.LocationDescriptorObject[typingsSlinky.history.mod.LocationState] */ T](payload: T, `type`: ROUTERSlashREPLACE): replaceAction[T] = {
    val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[replaceAction[T]]
  }
  @scala.inline
  implicit class replaceActionOps[Self <: replaceAction[_], /* <: typingsSlinky.history.mod.Path | typingsSlinky.history.mod.LocationDescriptorObject[typingsSlinky.history.mod.LocationState] */ T] (val x: Self with replaceAction[T]) extends AnyVal {
    @scala.inline
