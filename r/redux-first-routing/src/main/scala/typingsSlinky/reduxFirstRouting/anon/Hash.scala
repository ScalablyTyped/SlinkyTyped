...
object Hash {
  ...
  @scala.inline
  def apply[P /* <: typingsSlinky.history.mod.Pathname */, S /* <: Search */, H /* <: typingsSlinky.history.mod.Hash */](hash: H, pathname: P, queries: js.Any, search: S): Hash[P, S, H] = {
  ...
  @scala.inline
  implicit class HashOps[Self <: Hash[_, _, _], P /* <: typingsSlinky.history.mod.Pathname */, S /* <: Search */, H /* <: typingsSlinky.history.mod.Hash */] (val x: Self with (Hash[P, S, H])) extends AnyVal {
