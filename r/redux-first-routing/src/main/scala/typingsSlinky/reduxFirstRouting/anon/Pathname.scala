...
object Pathname {
  ...
  @scala.inline
  implicit class PathnameOps[Self <: Pathname[_, _, _], P /* <: typingsSlinky.history.mod.Pathname */, S /* <: Search */, H /* <: typingsSlinky.history.mod.Hash */] (val x: Self with (Pathname[P, S, H])) extends AnyVal {
