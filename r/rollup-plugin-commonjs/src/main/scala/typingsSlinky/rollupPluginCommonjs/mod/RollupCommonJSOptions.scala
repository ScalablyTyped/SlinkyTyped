...
object RollupCommonJSOptions {
  ...
  implicit class RollupCommonJSOptionsOps[Self <: RollupCommonJSOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExtensionsVarargs(value: (String | js.RegExp)*): Self = this.set("extensions", js.Array(value :_*))
    @scala.inline
    def setExtensions(value: js.Array[String | js.RegExp]): Self = this.set("extensions", value.asInstanceOf[js.Any])
    @scala.inline
