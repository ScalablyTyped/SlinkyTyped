...
import typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.HotKeysProps
...
object HotKeys
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.HotKeys] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.HotKeys] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.HotKeys] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.HotKeys](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
