...
import typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.GlobalHotKeysProps
import typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.KeyMap
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object GlobalHotKeys
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.GlobalHotKeys] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.GlobalHotKeys] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.GlobalHotKeys] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashHotkeys.reactDashHotkeysMod.GlobalHotKeys](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = GlobalHotKeysProps
}
