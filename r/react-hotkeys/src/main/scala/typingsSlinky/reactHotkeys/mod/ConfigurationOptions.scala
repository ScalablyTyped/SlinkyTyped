...
object ConfigurationOptions {
  ...
  implicit class ConfigurationOptionsOps[Self <: ConfigurationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultComponentFunctionComponent(value: ReactComponentClass[ComponentProps]): Self = this.set("defaultComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultComponentComponentClass(value: ReactComponentClass[js.Object]): Self = this.set("defaultComponent", value.asInstanceOf[js.Any])
