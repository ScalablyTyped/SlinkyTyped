...
object ConfigurationOptions {
  ...
  implicit class ConfigurationOptionsMutableBuilder[Self <: ConfigurationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultComponentComponentClass(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultComponentFunctionComponent(value: ReactComponentClass[ComponentProps]): Self = StObject.set(x, "defaultComponent", value.asInstanceOf[js.Any])
