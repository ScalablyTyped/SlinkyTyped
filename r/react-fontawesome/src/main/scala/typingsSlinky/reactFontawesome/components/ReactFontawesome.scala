package typingsSlinky.reactFontawesome.components
...
object ReactFontawesome {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, ^] {
    @scala.inline
    ...
    @scala.inline
    def cssModule(value: js.Any): this.type = set("cssModule", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def flip(value: FontAwesomeFlip): this.type = set("flip", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def size(value: FontAwesomeSize): this.type = set("size", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stack(value: FontAwesomeStack): this.type = set("stack", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: FontAwesomeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(name: String): Builder = {
    val __props = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[FontAwesomeProps]))
  }
}
