...
trait QueryBuilder[M /* <: AnyModel */, InstanceProps /* <: js.Object */] extends js.Object {
  ...
  /**
    ...
    */
  def all(): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  ...
  /**
    ...
    */
  def exclude(lookupObj: LookupSpec[M]): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  ...
  /**
    ...
    * @return a new {@link QuerySet} instance with objects that passed the filter.
    */
  def filter(lookupObj: LookupSpec[M]): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  ...
  def orderBy(iteratees: js.Array[SortIteratee[M]]): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  def orderBy(iteratees: js.Array[SortIteratee[M]], orders: js.Array[SortOrder]): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  def orderBy(iteratees: js.Array[SortIteratee[M]], orders: SortOrder): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  /**
    ...
    */
  def orderBy(iteratees: SortIteratee[M]): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  def orderBy(iteratees: SortIteratee[M], orders: js.Array[SortOrder]): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
  def orderBy(iteratees: SortIteratee[M], orders: SortOrder): typingsSlinky.reduxOrm.querySetMod.QuerySet[M, InstanceProps] = js.native
