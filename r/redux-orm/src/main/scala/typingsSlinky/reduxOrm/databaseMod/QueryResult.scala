...
object QueryResult {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, typingsSlinky.reduxOrm.modelMod.Serializable] */ Row](rows: js.Array[Row]): QueryResult[Row] = {
    val __obj = js.Dynamic.literal(rows = rows.asInstanceOf[js.Any])
    __obj.asInstanceOf[QueryResult[Row]]
  }
  @scala.inline
  implicit class QueryResultOps[Self <: QueryResult[_], /* <: typingsSlinky.std.Record[java.lang.String, typingsSlinky.reduxOrm.modelMod.Serializable] */ Row] (val x: Self with QueryResult[Row]) extends AnyVal {
    @scala.inline
