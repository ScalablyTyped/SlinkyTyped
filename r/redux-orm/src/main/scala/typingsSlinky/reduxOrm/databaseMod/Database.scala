...
object Database {
  @scala.inline
  def apply[/* <: typingsSlinky.reduxOrm.ormMod.IndexedModelClasses[
  _, 
  ...
  @scala.inline
  implicit class DatabaseOps[Self <: Database[_, _], /* <: typingsSlinky.reduxOrm.ormMod.IndexedModelClasses[
  _, 
  typingsSlinky.std.Extract[
    / * keyof any * / java.lang.String, 
    / * import warning: importer.ImportType#apply Failed type conversion: any[keyof any]['modelName'] * / js.Any
  ]] */ I, Tables] (val x: Self with (Database[I, Tables])) extends AnyVal {
    @scala.inline
