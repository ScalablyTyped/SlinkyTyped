...
import typingsSlinky.reduxOrm.reduxOrmStrings.arrName
import typingsSlinky.reduxOrm.reduxOrmStrings.fields
import typingsSlinky.reduxOrm.reduxOrmStrings.id
import typingsSlinky.reduxOrm.reduxOrmStrings.idAttribute
import typingsSlinky.reduxOrm.reduxOrmStrings.items
import typingsSlinky.reduxOrm.reduxOrmStrings.itemsById
import typingsSlinky.reduxOrm.reduxOrmStrings.mapName
...
object tableMod {
  ...
  {[ K in redux-orm.redux-orm/Model.FieldSpecKeys<std.InstanceType<MClass>, redux-orm.redux-orm.OneToOne | redux-orm.redux-orm.ForeignKey> ]: string}
    */ typingsSlinky.reduxOrm.reduxOrmStrings.TableIndexes with TopLevel[js.Any]
