...
import typingsSlinky.reduxOrm.fieldsMod.FkCreator
import typingsSlinky.reduxOrm.fieldsMod.ManyCreator
import typingsSlinky.reduxOrm.fieldsMod.OneToOneCreator
import typingsSlinky.reduxOrm.fieldsMod.RelationalFieldOpts
...
import typingsSlinky.reduxOrm.reduxMod.ORMSelector
import typingsSlinky.reduxOrm.reduxMod.Selector
...
object mod {
  ...
  class ForeignKey protected ()
    extends typingsSlinky.reduxOrm.fieldsMod.ForeignKey {
  ...
  class ManyToMany protected ()
    extends typingsSlinky.reduxOrm.fieldsMod.ManyToMany {
    def this(opts: RelationalFieldOpts) = this()
    def this(toModelName: String) = this()
    def this(toModelName: String, relatedName: String) = this()
  }
  ...
  class OneToOne_ protected ()
    extends typingsSlinky.reduxOrm.fieldsMod.OneToOne_ {
    def this(opts: RelationalFieldOpts) = this()
    def this(toModelName: String) = this()
    def this(toModelName: String, relatedName: String) = this()
  }
  ...
  class QuerySet[M /* <: AnyModel */, InstanceProps /* <: js.Object */] protected ()
    extends typingsSlinky.reduxOrm.querySetMod.default[M, InstanceProps] {
    /**
