...
object ModelTableOpts {
  @scala.inline
  def apply[/* <: org.scalablytyped.runtime.Instantiable0[typingsSlinky.reduxOrm.modelMod.AnyModel] */ MClass](
  ...
  @scala.inline
  implicit class ModelTableOptsOps[Self <: ModelTableOpts[_], /* <: org.scalablytyped.runtime.Instantiable0[typingsSlinky.reduxOrm.modelMod.AnyModel] */ MClass] (val x: Self with ModelTableOpts[MClass]) extends AnyVal {
    @scala.inline
