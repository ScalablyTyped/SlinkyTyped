...
import typingsSlinky.reduxOrm.helpersMod.Assign
import typingsSlinky.reduxOrm.helpersMod.Diff
import typingsSlinky.reduxOrm.helpersMod.Intersection
...
object sessionMod {
  ...
  {[ K in keyof I ]: redux-orm.redux-orm/Model.ModelType<std.InstanceType<I[K]>>}
    */ typingsSlinky.reduxOrm.reduxOrmStrings.OrmSession with TopLevel[I], 
    (Diff[
      Session[I], 
      /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof I ]: redux-orm.redux-orm/Model.ModelType<std.InstanceType<I[K]>>}
