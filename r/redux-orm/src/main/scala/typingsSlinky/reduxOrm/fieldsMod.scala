...
import typingsSlinky.reduxOrm.reduxOrmBooleans.`false`
import typingsSlinky.reduxOrm.reduxOrmBooleans.`true`
...
object fieldsMod {
  ...
  class Attribute () extends Field {
    ...
    var `type`: typingsSlinky.reduxOrm.reduxOrmStrings.attr = js.native
  }
  ...
  class ForeignKey protected () extends RelationalField {
    ...
    var `type`: typingsSlinky.reduxOrm.reduxOrmStrings.fk = js.native
  }
  ...
  class ManyToMany protected () extends RelationalField {
    ...
    var `type`: typingsSlinky.reduxOrm.reduxOrmStrings.many = js.native
  }
