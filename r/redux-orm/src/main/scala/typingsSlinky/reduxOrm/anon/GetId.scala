...
object GetId {
  @scala.inline
  def apply[/* <: typingsSlinky.reduxOrm.modelMod.Model[
  org.scalablytyped.runtime.Instantiable0[typingsSlinky.reduxOrm.modelMod.AnyModel], 
  _] */ M](getId: () => IdType[M]): GetId[M] = {
    val __obj = js.Dynamic.literal(getId = js.Any.fromFunction0(getId))
    __obj.asInstanceOf[GetId[M]]
  }
  @scala.inline
  implicit class GetIdOps[Self <: GetId[_], /* <: typingsSlinky.reduxOrm.modelMod.Model[
  org.scalablytyped.runtime.Instantiable0[typingsSlinky.reduxOrm.modelMod.AnyModel], 
  _] */ M] (val x: Self with GetId[M]) extends AnyVal {
    @scala.inline
