...
trait Props extends js.Object {
  ...
  var button: typingsSlinky.reapop.typesMod.NotificationButton = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButton(value: typingsSlinky.reapop.typesMod.NotificationButton): Self = this.set("button", value.asInstanceOf[js.Any])
