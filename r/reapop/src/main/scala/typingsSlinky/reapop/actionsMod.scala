...
object actionsMod {
  ...
  */
  ...
  object NotificationActions {
    ...
    @scala.inline
    def DismissNotificationAction(payload: String, `type`: DismissNotification): typingsSlinky.reapop.actionsMod.DismissNotificationAction = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reapop.actionsMod.DismissNotificationAction]
    }
    
    @scala.inline
    def DismissNotificationsAction(`type`: DismissNotifications): typingsSlinky.reapop.actionsMod.DismissNotificationsAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reapop.actionsMod.DismissNotificationsAction]
    }
    
    @scala.inline
    def UpsertNotificationAction(payload: Notification, `type`: UpsertNotification): typingsSlinky.reapop.actionsMod.UpsertNotificationAction = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reapop.actionsMod.UpsertNotificationAction]
    }
  }
