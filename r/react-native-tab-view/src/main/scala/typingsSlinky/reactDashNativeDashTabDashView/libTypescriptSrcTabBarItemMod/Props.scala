package typingsSlinky.reactDashNativeDashTabDashView.libTypescriptSrcTabBarItemMod
...
import typingsSlinky.reactDashNativeDashTabDashView.Anon_ColorFocused
...
trait Props[T /* <: Route */] extends js.Object {
  ...
  var renderIcon: js.UndefOr[js.Function1[/* scene */ Anon_ColorFocused[T], TagMod[Any]]] = js.undefined
  var renderLabel: js.UndefOr[js.Function1[/* scene */ Anon_ColorFocused[T], TagMod[Any]]] = js.undefined
  var route: T
...
object Props {
  ...
  def apply[T /* <: Route */](
    ...
    renderIcon: /* scene */ Anon_ColorFocused[T] => TagMod[Any] = null,
    renderLabel: /* scene */ Anon_ColorFocused[T] => TagMod[Any] = null,
