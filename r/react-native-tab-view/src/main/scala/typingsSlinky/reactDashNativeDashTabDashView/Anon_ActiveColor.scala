...
import typingsSlinky.reactDashNativeDashTabDashView.libTypescriptSrcTypesMod.Event
...
import typingsSlinky.reactDashNativeDashTabDashView.libTypescriptSrcTypesMod.Scene
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait Anon_ActiveColor[T /* <: Route */] extends js.Object {
  ...
  var renderBadge: js.UndefOr[js.Function1[/* scene */ Scene[T], TagMod[Any]]] = js.undefined
  var renderIcon: js.UndefOr[js.Function1[/* scene */ Scene[T] with Anon_Color, TagMod[Any]]] = js.undefined
  var renderLabel: js.UndefOr[js.Function1[/* scene */ Scene[T] with Anon_Color, TagMod[Any]]] = js.undefined
  ...
  def renderIndicator(props: Props[T]): TagMod[Any]
}
...
object Anon_ActiveColor {
  ...
  def apply[T /* <: Route */](
    ...
    renderIndicator: Props[T] => TagMod[Any],
    ...
    renderIcon: /* scene */ Scene[T] with Anon_Color => TagMod[Any] = null,
    renderLabel: /* scene */ Scene[T] with Anon_Color => TagMod[Any] = null,
