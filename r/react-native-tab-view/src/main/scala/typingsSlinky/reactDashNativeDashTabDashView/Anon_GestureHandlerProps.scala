...
trait Anon_GestureHandlerProps extends js.Object {
  ...
  def renderTabBar[P /* <: Route */](props: typingsSlinky.reactDashNativeDashTabDashView.libTypescriptSrcTabBarMod.Props[P]): Element
}
...
object Anon_GestureHandlerProps {
  ...
  def apply(
    ...
    renderTabBar: typingsSlinky.reactDashNativeDashTabDashView.libTypescriptSrcTabBarMod.Props[js.Any] => Element,
