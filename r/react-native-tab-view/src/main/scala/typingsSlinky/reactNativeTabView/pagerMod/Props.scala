...
trait Props[T /* <: Route */] extends js.Object {
  ...
  def children(props: EventEmitterPropsposition): ReactElement = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props[_], T /* <: Route */] (val x: Self with Props[T]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: EventEmitterPropsposition => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
