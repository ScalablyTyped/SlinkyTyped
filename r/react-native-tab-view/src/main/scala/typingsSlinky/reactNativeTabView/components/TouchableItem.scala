...
import typingsSlinky.reactNativeTabView.touchableItemMod.Props
...
object TouchableItem {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeTabView.mod.TouchableItem] {
  ...
  @scala.inline
  def apply(onPress: () => Unit, pressColor: String): Builder = {
    val __props = js.Dynamic.literal(onPress = js.Any.fromFunction0(onPress), pressColor = pressColor.asInstanceOf[js.Any])
