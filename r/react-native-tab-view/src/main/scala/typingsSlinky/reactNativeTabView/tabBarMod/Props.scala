...
trait Props[T /* <: Route */] extends js.Object {
  ...
  var renderIcon: js.UndefOr[js.Function1[/* scene */ Scene[T] with Color, TagMod[Any]]] = js.undefined
  var renderLabel: js.UndefOr[js.Function1[/* scene */ Scene[T] with Color, TagMod[Any]]] = js.undefined
  ...
  def renderIndicator(props: typingsSlinky.reactNativeTabView.tabBarIndicatorMod.Props[T]): TagMod[Any]
}
...
object Props {
  ...
  def apply[T](
    ...
    renderIcon: /* scene */ Scene[T] with Color => TagMod[Any] = null,
    renderLabel: /* scene */ Scene[T] with Color => TagMod[Any] = null,
