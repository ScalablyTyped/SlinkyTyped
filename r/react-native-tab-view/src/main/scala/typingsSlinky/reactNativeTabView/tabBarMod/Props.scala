...
trait Props[T /* <: Route */] extends js.Object {
  ...
  var renderIcon: js.UndefOr[js.Function1[/* scene */ Scene[T] with Color, ReactElement]] = js.native
  var renderLabel: js.UndefOr[js.Function1[/* scene */ Scene[T] with Color, ReactElement]] = js.native
  var renderTabBarItem: js.UndefOr[
    js.Function1[
      /* props */ typingsSlinky.reactNativeTabView.tabBarItemMod.Props[T] with Key, 
      ReactElement
    ]
  ] = js.native
  ...
  def renderIndicator(props: typingsSlinky.reactNativeTabView.tabBarIndicatorMod.Props[T]): ReactElement = js.native
}
...
object Props {
  ...
  implicit class PropsOps[Self <: Props[_], /* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T] (val x: Self with Props[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderIndicator(value: typingsSlinky.reactNativeTabView.tabBarIndicatorMod.Props[T] => ReactElement): Self = this.set("renderIndicator", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRenderIcon(value: /* scene */ Scene[T] with Color => ReactElement): Self = this.set("renderIcon", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderIcon: Self = this.set("renderIcon", js.undefined)
    @scala.inline
    def setRenderLabel(value: /* scene */ Scene[T] with Color => ReactElement): Self = this.set("renderLabel", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderLabel: Self = this.set("renderLabel", js.undefined)
    @scala.inline
    def setRenderTabBarItem(
      value: /* props */ typingsSlinky.reactNativeTabView.tabBarItemMod.Props[T] with Key => ReactElement
    ): Self = this.set("renderTabBarItem", js.Any.fromFunction1(value))
    @scala.inline
