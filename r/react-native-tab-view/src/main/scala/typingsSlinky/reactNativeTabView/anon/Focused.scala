...
object Focused {
  @scala.inline
  def apply[/* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T](color: String, focused: Boolean, route: T): Focused[T] = {
  ...
  @scala.inline
  implicit class FocusedOps[Self <: Focused[_], /* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T] (val x: Self with Focused[T]) extends AnyVal {
    @scala.inline
