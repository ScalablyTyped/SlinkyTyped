...
object Focused {
  ...
  @scala.inline
  def apply[T /* <: typingsSlinky.reactNativeTabView.typesMod.Route */](color: String, focused: Boolean, route: T): Focused[T] = {
  ...
  @scala.inline
  implicit class FocusedOps[Self <: Focused[_], T /* <: typingsSlinky.reactNativeTabView.typesMod.Route */] (val x: Self with Focused[T]) extends AnyVal {
