...
object NavigationState {
  @scala.inline
  def apply[/* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T](navigationState: typingsSlinky.reactNativeTabView.typesMod.NavigationState[T]): NavigationState[T] = {
    val __obj = js.Dynamic.literal(navigationState = navigationState.asInstanceOf[js.Any])
    __obj.asInstanceOf[NavigationState[T]]
  }
  @scala.inline
  implicit class NavigationStateOps[Self <: NavigationState[_], /* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T] (val x: Self with NavigationState[T]) extends AnyVal {
    @scala.inline
