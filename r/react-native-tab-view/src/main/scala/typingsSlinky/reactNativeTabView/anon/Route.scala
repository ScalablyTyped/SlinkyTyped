...
object Route {
  @scala.inline
  def apply[/* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T](route: T): Route[T] = {
    val __obj = js.Dynamic.literal(route = route.asInstanceOf[js.Any])
    __obj.asInstanceOf[Route[T]]
  }
  @scala.inline
  implicit class RouteOps[Self <: Route[_], /* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T] (val x: Self with Route[T]) extends AnyVal {
    @scala.inline
