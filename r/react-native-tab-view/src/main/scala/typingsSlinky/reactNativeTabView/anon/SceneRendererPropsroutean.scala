...
trait SceneRendererPropsroutean extends js.Object {
  var layout: typingsSlinky.reactNativeTabView.typesMod.Layout = js.native
...
object SceneRendererPropsroutean {
  ...
  def apply(
    jumpTo: String => Unit,
    layout: typingsSlinky.reactNativeTabView.typesMod.Layout,
  ...
  implicit class SceneRendererPropsrouteanOps[Self <: SceneRendererPropsroutean] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayout(value: typingsSlinky.reactNativeTabView.typesMod.Layout): Self = this.set("layout", value.asInstanceOf[js.Any])
    @scala.inline
    def setPosition(
