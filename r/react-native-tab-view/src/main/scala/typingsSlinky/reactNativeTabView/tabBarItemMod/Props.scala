...
trait Props[T /* <: Route */] extends js.Object {
  ...
  var renderIcon: js.UndefOr[js.Function1[/* scene */ Focused[T], TagMod[Any]]] = js.undefined
  var renderLabel: js.UndefOr[js.Function1[/* scene */ Focused[T], TagMod[Any]]] = js.undefined
  var route: T
...
object Props {
  ...
  def apply[T](
    ...
    renderIcon: /* scene */ Focused[T] => TagMod[Any] = null,
    renderLabel: /* scene */ Focused[T] => TagMod[Any] = null,
