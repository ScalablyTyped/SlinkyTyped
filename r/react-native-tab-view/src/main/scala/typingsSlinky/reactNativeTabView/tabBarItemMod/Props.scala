...
trait Props[T /* <: Route */] extends js.Object {
  ...
  var renderBadge: js.UndefOr[js.Function1[/* scene */ Scene[T], ReactElement]] = js.native
  var renderIcon: js.UndefOr[js.Function1[/* scene */ Focused[T], ReactElement]] = js.native
  var renderLabel: js.UndefOr[js.Function1[/* scene */ Focused[T], ReactElement]] = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props[_], /* <: typingsSlinky.reactNativeTabView.typesMod.Route */ T] (val x: Self with Props[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderBadge(value: /* scene */ Scene[T] => ReactElement): Self = this.set("renderBadge", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderBadge: Self = this.set("renderBadge", js.undefined)
    @scala.inline
    def setRenderIcon(value: /* scene */ Focused[T] => ReactElement): Self = this.set("renderIcon", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderIcon: Self = this.set("renderIcon", js.undefined)
    @scala.inline
    def setRenderLabel(value: /* scene */ Focused[T] => ReactElement): Self = this.set("renderLabel", js.Any.fromFunction1(value))
    @scala.inline
