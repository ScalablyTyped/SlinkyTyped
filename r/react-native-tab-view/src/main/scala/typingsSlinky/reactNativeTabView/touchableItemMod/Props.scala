...
/* Inlined react-native.react-native.ViewProps & {onPress (): void,   onLongPress :(): void | undefined,   delayPressIn :number | undefined,   borderless :boolean | undefined,   pressColor :string,   pressOpacity :number | undefined,   children :react.react.ReactNode | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined} */
@js.native
