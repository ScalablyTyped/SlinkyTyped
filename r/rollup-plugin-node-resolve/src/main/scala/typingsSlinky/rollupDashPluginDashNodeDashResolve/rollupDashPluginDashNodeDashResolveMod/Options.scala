package typingsSlinky.rollupDashPluginDashNodeDashResolve.rollupDashPluginDashNodeDashResolveMod

import typingsSlinky.resolve.resolveMod.AsyncOpts
...
object Options {
  ...
  def apply(
    ...
    only: js.Array[String | js.RegExp] = null,
