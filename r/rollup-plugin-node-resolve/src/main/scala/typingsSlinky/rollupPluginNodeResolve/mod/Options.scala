...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnlyVarargs(value: (String | js.RegExp)*): Self = this.set("only", js.Array(value :_*))
    @scala.inline
    def setOnly(value: js.Array[String | js.RegExp]): Self = this.set("only", value.asInstanceOf[js.Any])
    @scala.inline
