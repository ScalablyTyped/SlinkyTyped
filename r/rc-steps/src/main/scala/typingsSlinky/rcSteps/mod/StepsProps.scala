...
trait StepsProps extends js.Object {
  ...
  var `type`: js.UndefOr[typingsSlinky.rcSteps.rcStepsStrings.default | navigation] = js.undefined
}
...
object StepsProps {
  ...
  def apply(
    ...
    `type`: typingsSlinky.rcSteps.rcStepsStrings.default | navigation = null
  ): StepsProps = {
