...
object useFocusManagerMod {
  ...
  object FocusManagerOptions {
    ...
    implicit class FocusManagerOptionsMutableBuilder[Self <: FocusManagerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDidHandle(value: (/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element]) => Unit): Self = StObject.set(x, "didHandle", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnChange(value: (/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      @scala.inline
      def setWillHandle(value: (/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element]) => Boolean | Unit): Self = StObject.set(x, "willHandle", js.Any.fromFunction2(value))
