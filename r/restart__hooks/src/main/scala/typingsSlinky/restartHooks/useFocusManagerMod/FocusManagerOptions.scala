...
trait FocusManagerOptions extends js.Object {
  ...
  var didHandle: js.UndefOr[
    js.Function2[/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element], Unit]
  ] = js.native
  ...
  var willHandle: js.UndefOr[
    js.Function2[/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element], Boolean | Unit]
  ] = js.native
}
object FocusManagerOptions {
  ...
  implicit class FocusManagerOptionsOps[Self <: FocusManagerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDidHandle(value: (/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element]) => Unit): Self = this.set("didHandle", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteDidHandle: Self = this.set("didHandle", js.undefined)
    
    @scala.inline
    def setOnChange(value: (/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element]) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    
    @scala.inline
    def setWillHandle(value: (/* focused */ Boolean, /* event */ SyntheticFocusEvent[Element]) => Boolean | Unit): Self = this.set("willHandle", js.Any.fromFunction2(value))
