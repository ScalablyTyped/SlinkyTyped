...
trait Request extends js.Object {
  var connection: AnonSocket = js.native
  var headers: RequestHeaders = js.native
  var info: js.UndefOr[AnonRemoteAddress] = js.native
  var socket: js.UndefOr[AnonRemoteAddress] = js.native
}

object Request {
  @scala.inline
  def apply(connection: AnonSocket, headers: RequestHeaders): Request = {
  ...
  implicit class RequestOps[Self <: Request] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConnection(value: AnonSocket): Self = {
    ...
    @scala.inline
    def withInfo(value: AnonRemoteAddress): Self = {
        val ret = this.duplicate
