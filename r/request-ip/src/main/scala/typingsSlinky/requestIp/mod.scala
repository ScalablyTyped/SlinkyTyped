...
import typingsSlinky.requestIp.anon.RemoteAddress
import typingsSlinky.requestIp.anon.Socket
  ...
  object global {
    ...
    object Express {
      ...
      object Request {
        ...
        @scala.inline
        def apply(): typingsSlinky.requestIp.mod.global.Express.Request = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsSlinky.requestIp.mod.global.Express.Request]
        }
        
        @scala.inline
        implicit class RequestMutableBuilder[Self <: typingsSlinky.requestIp.mod.global.Express.Request] (val x: Self) extends AnyVal {
