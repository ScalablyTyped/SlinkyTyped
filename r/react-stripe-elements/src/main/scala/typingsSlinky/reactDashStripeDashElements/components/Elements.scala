...
object Elements
  ...
  typingsSlinky.reactDashStripeDashElements.reactDashStripeDashElementsMod.Elements](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
