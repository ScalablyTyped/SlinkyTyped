...
import typingsSlinky.reactDashStripeDashElements.reactDashStripeDashElementsMod.ReactStripeElements.PaymentRequestButtonElementProps
...
object PaymentRequestButtonElement
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashStripeDashElements.reactDashStripeDashElementsMod.PaymentRequestButtonElement
    ] {
  ...
  /* The following DOM/SVG props were specified: className, disabled, id, onBlur, onChange, onClick, onFocus, placeholder, value */
  def apply(
  ...
  typingsSlinky.reactDashStripeDashElements.reactDashStripeDashElementsMod.PaymentRequestButtonElement](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
