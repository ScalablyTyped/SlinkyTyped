...
trait SwiperProperties extends Props[Swiper] {
  var activeDot: js.UndefOr[ReactElement] = js.undefined
  ...
  var loadMinimalLoader: js.UndefOr[ReactElement] = js.undefined
  ...
  var prevButton: js.UndefOr[ReactElement] = js.undefined
