...
object SwiperProperties {
  ...
  implicit class SwiperPropertiesOps[Self <: SwiperProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveDot(value: ReactElement): Self = this.set("activeDot", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLoadMinimalLoader(value: ReactElement): Self = this.set("loadMinimalLoader", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRenderPagination(value: (/* index */ Double, /* total */ Double, /* thisObject */ Swiper) => ReactElement): Self = this.set("renderPagination", js.Any.fromFunction3(value))
    @scala.inline
