...
object mod {
  ...
  object SwiperProperties {
    ...
    implicit class SwiperPropertiesMutableBuilder[Self <: SwiperProperties] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActiveDot(value: ReactElement): Self = StObject.set(x, "activeDot", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLoadMinimalLoader(value: ReactElement): Self = StObject.set(x, "loadMinimalLoader", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPrevButton(value: ReactElement): Self = StObject.set(x, "prevButton", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRenderPagination(value: (/* index */ Double, /* total */ Double, /* thisObject */ Swiper) => ReactElement): Self = StObject.set(x, "renderPagination", js.Any.fromFunction3(value))
  ...
  object SwiperState {
    ...
    implicit class SwiperStateMutableBuilder[Self <: SwiperState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDir(value: typingsSlinky.reactNativeSwiper.reactNativeSwiperStrings.x | y): Self = StObject.set(x, "dir", value.asInstanceOf[js.Any])
