...
import typingsSlinky.reactDashNativeDashSwiper.Anon_X
import typingsSlinky.reactDashNativeDashSwiper.reactDashNativeDashSwiperStrings.x
import typingsSlinky.reactDashNativeDashSwiper.reactDashNativeDashSwiperStrings.y
