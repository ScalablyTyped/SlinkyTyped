...
object mod {
  ...
  */
  ...
  object _ReducerMapValue {
    ...
    @scala.inline
    def ReducerMap[State, Payload](): typingsSlinky.reduxActions.mod.ReducerMap[State, Payload] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.reduxActions.mod.ReducerMap[State, Payload]]
    }
    
    @scala.inline
    def ReducerNextThrow[State, Payload](): typingsSlinky.reduxActions.mod.ReducerNextThrow[State, Payload] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.reduxActions.mod.ReducerNextThrow[State, Payload]]
    }
  }
}
