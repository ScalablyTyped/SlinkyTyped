package typingsSlinky.reduxDashActions
...
package object reduxDashActionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reduxDashActions.reduxDashActionsMod.Reducer[State, Payload]
    - typings.reduxDashActions.reduxDashActionsMod.ReducerNextThrow[State, Payload]
    - typings.reduxDashActions.reduxDashActionsMod.ReducerMap[State, Payload]
  */
