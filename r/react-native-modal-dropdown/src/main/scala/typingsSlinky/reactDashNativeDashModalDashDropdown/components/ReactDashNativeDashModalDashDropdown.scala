...
object ReactDashNativeDashModalDashDropdown
  ...
  typingsSlinky.reactDashNativeDashModalDashDropdown.reactDashNativeDashModalDashDropdownMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
