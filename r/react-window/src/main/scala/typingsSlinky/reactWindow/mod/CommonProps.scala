...
object CommonProps {
  ...
  implicit class CommonPropsOps[Self <: CommonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInnerElementTypeFunctionComponent(value: ReactComponentClass[js.Any]): Self = this.set("innerElementType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInnerElementTypeComponentClass(value: ReactComponentClass[js.Any]): Self = this.set("innerElementType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOuterElementTypeFunctionComponent(value: ReactComponentClass[js.Any]): Self = this.set("outerElementType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOuterElementTypeComponentClass(value: ReactComponentClass[js.Any]): Self = this.set("outerElementType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOuterRefRefObject(value: ReactRef[_]): Self = this.set("outerRef", value.asInstanceOf[js.Any])
