...
object CommonProps {
  ...
  implicit class CommonPropsMutableBuilder[Self <: CommonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInnerElementTypeComponentClass(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "innerElementType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInnerElementTypeFunctionComponent(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "innerElementType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOuterElementTypeComponentClass(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "outerElementType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOuterElementTypeFunctionComponent(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "outerElementType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOuterRefRefObject(value: ReactRef[_]): Self = StObject.set(x, "outerRef", value.asInstanceOf[js.Any])
