...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactWindow.reactWindowStrings.auto
  - typingsSlinky.reactWindow.reactWindowStrings.smart
  - typingsSlinky.reactWindow.reactWindowStrings.center
  - typingsSlinky.reactWindow.reactWindowStrings.end
  - typingsSlinky.reactWindow.reactWindowStrings.start
*/
