...
object VariableSizeList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactWindow.mod.VariableSizeList] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactWindow.mod.VariableSizeList] = {
