...
object FixedSizeList {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactWindow.mod.FixedSizeList] {
    @scala.inline
  ...
  @scala.inline
  def apply(height: Double | String, itemCount: Double, itemSize: Double, width: Double | String): Builder = {
    val __props = js.Dynamic.literal(height = height.asInstanceOf[js.Any], itemCount = itemCount.asInstanceOf[js.Any], itemSize = itemSize.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
