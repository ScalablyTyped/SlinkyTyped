...
import typingsSlinky.reactDashWindow.reactDashWindowMod.FixedSizeGridProps
...
object FixedSizeGrid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashWindow.reactDashWindowMod.FixedSizeGrid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashWindow.reactDashWindowMod.FixedSizeGrid] = {
