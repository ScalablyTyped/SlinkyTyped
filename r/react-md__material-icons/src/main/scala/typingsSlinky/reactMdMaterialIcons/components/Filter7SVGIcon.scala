...
object Filter7SVGIcon {
  
  @JSImport("@react-md/material-icons", "Filter7SVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Filter7SVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
