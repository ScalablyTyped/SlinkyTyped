...
object CallSplitSVGIcon {
  
  @JSImport("@react-md/material-icons", "CallSplitSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CallSplitSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
