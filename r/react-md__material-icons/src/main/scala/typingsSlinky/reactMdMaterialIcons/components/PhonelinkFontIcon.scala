...
object PhonelinkFontIcon {
  
  @JSImport("@react-md/material-icons", "PhonelinkFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PhonelinkFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
