...
object SentimentSatisfiedFontIcon {
  ...
  implicit def make(companion: SentimentSatisfiedFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
}
