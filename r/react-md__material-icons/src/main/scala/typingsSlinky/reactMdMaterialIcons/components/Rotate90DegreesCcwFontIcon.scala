...
object Rotate90DegreesCcwFontIcon {
  ...
  implicit def make(companion: Rotate90DegreesCcwFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
