...
object KeyboardArrowDownFontIcon {
  
  @JSImport("@react-md/material-icons", "KeyboardArrowDownFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: KeyboardArrowDownFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
