...
object LocalLaundryServiceFontIcon {
  
  @JSImport("@react-md/material-icons", "LocalLaundryServiceFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LocalLaundryServiceFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
