...
object Filter9PlusFontIcon {
  
  @JSImport("@react-md/material-icons", "Filter9PlusFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Filter9PlusFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
