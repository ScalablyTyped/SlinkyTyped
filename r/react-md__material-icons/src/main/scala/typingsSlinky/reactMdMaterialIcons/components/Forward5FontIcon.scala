...
object Forward5FontIcon {
  
  @JSImport("@react-md/material-icons", "Forward5FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Forward5FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
