...
object CloudDownloadSVGIcon {
  
  @JSImport("@react-md/material-icons", "CloudDownloadSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CloudDownloadSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
