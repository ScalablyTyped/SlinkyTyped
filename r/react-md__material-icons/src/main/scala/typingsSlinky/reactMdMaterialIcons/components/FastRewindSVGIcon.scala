...
object FastRewindSVGIcon {
  
  @JSImport("@react-md/material-icons", "FastRewindSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FastRewindSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
