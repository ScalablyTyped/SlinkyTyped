...
object HeadsetSVGIcon {
  
  @JSImport("@react-md/material-icons", "HeadsetSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: HeadsetSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
