...
object AccessibilityFontIcon {
  
  @JSImport("@react-md/material-icons", "AccessibilityFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AccessibilityFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
