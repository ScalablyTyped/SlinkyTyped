...
object SwitchCameraSVGIcon {
  
  @JSImport("@react-md/material-icons", "SwitchCameraSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SwitchCameraSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
