...
object Filter9PlusSVGIcon {
  
  @JSImport("@react-md/material-icons", "Filter9PlusSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Filter9PlusSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
