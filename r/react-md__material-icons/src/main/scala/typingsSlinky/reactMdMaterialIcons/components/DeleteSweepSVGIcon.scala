...
object DeleteSweepSVGIcon {
  
  @JSImport("@react-md/material-icons", "DeleteSweepSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DeleteSweepSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
