...
object Replay5FontIcon {
  
  @JSImport("@react-md/material-icons", "Replay5FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Replay5FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
