...
object Brightness3FontIcon {
  
  @JSImport("@react-md/material-icons", "Brightness3FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Brightness3FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
