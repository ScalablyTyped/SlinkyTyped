...
object TurnedInSVGIcon {
  
  @JSImport("@react-md/material-icons", "TurnedInSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TurnedInSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
