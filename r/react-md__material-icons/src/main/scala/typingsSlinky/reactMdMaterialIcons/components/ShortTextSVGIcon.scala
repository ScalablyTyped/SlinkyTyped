...
object ShortTextSVGIcon {
  
  @JSImport("@react-md/material-icons", "ShortTextSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ShortTextSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
