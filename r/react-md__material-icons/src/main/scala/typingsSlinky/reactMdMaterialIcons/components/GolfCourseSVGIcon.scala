...
object GolfCourseSVGIcon {
  
  @JSImport("@react-md/material-icons", "GolfCourseSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: GolfCourseSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
