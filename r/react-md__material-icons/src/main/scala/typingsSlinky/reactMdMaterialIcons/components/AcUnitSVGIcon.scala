...
object AcUnitSVGIcon {
  
  @JSImport("@react-md/material-icons", "AcUnitSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AcUnitSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
