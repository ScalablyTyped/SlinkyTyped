...
object ModeEditFontIcon {
  
  @JSImport("@react-md/material-icons", "ModeEditFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ModeEditFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1257903674[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
