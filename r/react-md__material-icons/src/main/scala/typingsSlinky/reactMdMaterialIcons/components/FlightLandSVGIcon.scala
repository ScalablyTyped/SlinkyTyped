...
object FlightLandSVGIcon {
  
  @JSImport("@react-md/material-icons", "FlightLandSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FlightLandSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
