...
object ShuffleSVGIcon {
  
  @JSImport("@react-md/material-icons", "ShuffleSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ShuffleSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
