...
object SettingsRemoteSVGIcon {
  
  @JSImport("@react-md/material-icons", "SettingsRemoteSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SettingsRemoteSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
