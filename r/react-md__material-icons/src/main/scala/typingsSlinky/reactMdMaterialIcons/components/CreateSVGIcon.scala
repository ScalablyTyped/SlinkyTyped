...
object CreateSVGIcon {
  
  @JSImport("@react-md/material-icons", "CreateSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CreateSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
