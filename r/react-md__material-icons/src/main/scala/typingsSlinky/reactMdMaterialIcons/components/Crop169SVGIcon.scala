...
object Crop169SVGIcon {
  
  @JSImport("@react-md/material-icons", "Crop169SVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Crop169SVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
