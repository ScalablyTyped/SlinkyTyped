...
object SignalWifi4BarLockSVGIcon {
  
  @JSImport("@react-md/material-icons", "SignalWifi4BarLockSVGIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SignalWifi4BarLockSVGIcon.type): SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement] = new SharedBuilder_SVGIconPropsRefAttributes_1547990045[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
