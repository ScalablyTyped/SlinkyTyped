...
object mod {
  ...
  object SQLErrors extends StObject {
    ...
    /* 6 */ val CONSTRAINT_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.CONSTRAINT_ERR with Double = js.native
    
    @js.native
    sealed trait DATABASE_ERR extends SQLErrors
    /* 1 */ val DATABASE_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.DATABASE_ERR with Double = js.native
    
    @js.native
    sealed trait QUOTA_ERR extends SQLErrors
    /* 4 */ val QUOTA_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.QUOTA_ERR with Double = js.native
    
    @js.native
    sealed trait SYNTAX_ERR extends SQLErrors
    /* 5 */ val SYNTAX_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.SYNTAX_ERR with Double = js.native
    
    @js.native
    sealed trait TIMEOUT_ERR extends SQLErrors
    /* 7 */ val TIMEOUT_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.TIMEOUT_ERR with Double = js.native
    
    @js.native
    sealed trait TOO_LARGE_ERR extends SQLErrors
    /* 3 */ val TOO_LARGE_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.TOO_LARGE_ERR with Double = js.native
    
    @js.native
    sealed trait UNKNOWN_ERR extends SQLErrors
    /* 0 */ val UNKNOWN_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.UNKNOWN_ERR with Double = js.native
    
    @js.native
    sealed trait VERSION_ERR extends SQLErrors
    /* 2 */ val VERSION_ERR: typingsSlinky.reactNativeSqliteStorage.mod.SQLErrors.VERSION_ERR with Double = js.native
  }
