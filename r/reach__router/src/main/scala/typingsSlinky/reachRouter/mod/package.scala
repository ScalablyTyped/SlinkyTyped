...
package object mod {
  ...
  type HistoryLocation = typingsSlinky.reachRouter.mod.WindowLocation[typingsSlinky.history.mod.LocationState] with typingsSlinky.reachRouter.AnonState
  ...
  type WindowLocation[S] = typingsSlinky.std.Location_ with typingsSlinky.history.mod.Location[S]
}
