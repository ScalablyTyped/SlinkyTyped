...
object Link
  ...
  def apply[TState](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reachRouter.mod.Link[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.reachRouter.mod.Link[js.Any]]]
  }
