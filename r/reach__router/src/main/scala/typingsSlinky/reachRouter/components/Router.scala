...
import typingsSlinky.reachRouter.mod.RouterProps
...
object Router
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reachRouter.mod.Router] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reachRouter.mod.Router] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reachRouter.mod.Router] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reachRouter.mod.Router](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
