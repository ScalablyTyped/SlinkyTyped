...
object Router {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reachRouter.mod.Router] {
    ...
    @scala.inline
    def component(value: ReactComponentClass[js.Object] | String): this.type = set("component", value.asInstanceOf[js.Any])
  ...
  def withProps(p: RouterProps with HTMLProps[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
