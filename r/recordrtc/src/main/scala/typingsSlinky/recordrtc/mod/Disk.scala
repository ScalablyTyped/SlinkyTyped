...
object Disk {
  ...
  implicit class DiskOps[Self <: Disk] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAudio(value: Blob): Self = this.set("audio", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAudio: Self = this.set("audio", js.undefined)
    
    @scala.inline
    def setGif(value: Blob): Self = this.set("gif", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGif: Self = this.set("gif", js.undefined)
    
    @scala.inline
    def setVideo(value: Blob): Self = this.set("video", value.asInstanceOf[js.Any])
