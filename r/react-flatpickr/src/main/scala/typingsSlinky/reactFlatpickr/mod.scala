...
import typingsSlinky.flatpickr.mod.flatpickr.Instance
...
object mod {
  ...
  object DateTimePickerProps {
    ...
    implicit class DateTimePickerPropsMutableBuilder[Self <: DateTimePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(
        value: (/* dates */ js.Array[Date], /* currentDateString */ String, /* self */ typingsSlinky.flatpickr.instanceMod.Instance, /* data */ js.UndefOr[js.Any]) => Unit
      ...
      @scala.inline
      def setOnprogress(value: js.ThisFunction1[DateTimePickerProps, /* ev */ ProgressEvent, _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
