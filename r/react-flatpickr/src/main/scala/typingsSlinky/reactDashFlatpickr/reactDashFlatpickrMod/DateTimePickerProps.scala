package typingsSlinky.reactDashFlatpickr.reactDashFlatpickrMod
...
import typingsSlinky.flatpickr.flatpickrMod.flatpickr.Options.Hook
...
- Dropped {[ P in std.Exclude<keyof std.Partial<std.HTMLInputElement>, 'value'> ]: std.Partial<std.HTMLInputElement>[P]} */ trait DateTimePickerProps extends js.Object {
  ...
  var render: js.UndefOr[
    js.Function2[
      /* props */ Omit[
        DateTimePickerProps, 
        options | typingsSlinky.reactDashFlatpickr.reactDashFlatpickrStrings.render
      ], 
...
object DateTimePickerProps {
  ...
  def apply(
    ...
    value: String | js.Date | Double | (js.Array[String | js.Date | Double]) = null
  ): DateTimePickerProps = {
