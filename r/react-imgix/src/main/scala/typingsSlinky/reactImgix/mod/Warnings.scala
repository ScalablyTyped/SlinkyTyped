...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactImgix.reactImgixStrings.fallbackImage
  - typingsSlinky.reactImgix.reactImgixStrings.sizesAttribute
  - typingsSlinky.reactImgix.reactImgixStrings.invalidARFormat
*/
