...
object Marker {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def coordinates(value: Point): this.type = set("coordinates", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onMouseEnter(value: /* event */ SyntheticMouseEvent[SVGPathElement] => Unit): this.type = set("onMouseEnter", js.Any.fromFunction1(value))
    @scala.inline
    def onMouseLeave(value: /* event */ SyntheticMouseEvent[SVGPathElement] => Unit): this.type = set("onMouseLeave", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onMouseUp(value: /* event */ SyntheticMouseEvent[SVGPathElement] => Unit): this.type = set("onMouseUp", js.Any.fromFunction1(value))
    @scala.inline
