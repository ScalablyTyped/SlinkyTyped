...
trait MarkerProps extends js.Object {
  ...
  var onBlur: js.UndefOr[
    FocusEventHandler[SVGPathElement] | (js.Function1[/* event */ SyntheticFocusEvent[SVGPathElement], Unit])
  ] = js.native
  ...
  var onMouseDown: js.UndefOr[
    (js.Function1[/* event */ SyntheticMouseEvent[SVGPathElement], Unit]) | MouseEventHandler[SVGPathElement]
  ] = js.native
