...
trait LineProps extends js.Object {
  ...
  var onBlur: js.UndefOr[
    js.Function2[/* line */ Line, /* evt */ SyntheticFocusEvent[SVGPathElement], Unit]
  ] = js.undefined
  var onClick: js.UndefOr[
    js.Function2[/* line */ Line, /* evt */ SyntheticMouseEvent[SVGPathElement], Unit]
  ] = js.undefined
...
object LineProps {
  ...
  def apply(
    ...
    line: Line = null,
    onBlur: (/* line */ Line, /* evt */ SyntheticFocusEvent[SVGPathElement]) => Unit = null,
    onClick: (/* line */ Line, /* evt */ SyntheticMouseEvent[SVGPathElement]) => Unit = null,
    onFocus: (/* line */ Line, /* evt */ SyntheticFocusEvent[SVGPathElement]) => Unit = null,
    onMouseDown: (/* line */ Line, /* evt */ SyntheticMouseEvent[SVGPathElement]) => Unit = null,
    onMouseEnter: (/* line */ Line, /* evt */ SyntheticMouseEvent[SVGPathElement]) => Unit = null,
    onMouseLeave: (/* line */ Line, /* evt */ SyntheticMouseEvent[SVGPathElement]) => Unit = null,
    onMouseMove: (/* line */ Line, /* evt */ SyntheticMouseEvent[SVGPathElement]) => Unit = null,
    onMouseUp: (/* line */ Line, /* evt */ SyntheticMouseEvent[SVGPathElement]) => Unit = null,
