...
import typingsSlinky.reactDashRelay.libRelayDashExperimentalEntryPointTypesMod.PreloadFetchPolicy
import typingsSlinky.reactDashRelay.libRelayDashExperimentalQueryResourceMod.RenderPolicy
import typingsSlinky.reactDashRelay.libRelayDashExperimentalUseLoadMoreFunctionMod.Direction
import typingsSlinky.reactDashRelay.reactDashRelayMod.FetchPolicy
...
object reactDashRelayStrings {
  ...
  sealed trait `network-only`
    extends FetchPolicy
       with typingsSlinky.reactDashRelay.libRelayDashExperimentalQueryResourceMod.FetchPolicy
  ...
  sealed trait `store-only`
    extends typingsSlinky.reactDashRelay.libRelayDashExperimentalQueryResourceMod.FetchPolicy
