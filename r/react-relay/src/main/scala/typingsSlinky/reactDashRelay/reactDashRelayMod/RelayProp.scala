...
trait RelayProp extends js.Object {
  var environment: typingsSlinky.relayDashRuntime.relayDashRuntimeMod.Environment
...
object RelayProp {
  @scala.inline
  def apply(
    environment: typingsSlinky.relayDashRuntime.relayDashRuntimeMod.Environment,
