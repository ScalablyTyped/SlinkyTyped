...
trait Anon_EntryPointsExtraPropsGetComponent[TEntryPointComponent] extends js.Object {
  var entryPoints: LibraryManagedAttributes[
    TEntryPointComponent, 
    typingsSlinky.reactDashRelay.reactDashRelayStrings.entryPoints
  ]
  var extraProps: LibraryManagedAttributes[
    TEntryPointComponent, 
    typingsSlinky.reactDashRelay.reactDashRelayStrings.extraProps
  ]
  var queries: LibraryManagedAttributes[TEntryPointComponent, typingsSlinky.reactDashRelay.reactDashRelayStrings.queries]
