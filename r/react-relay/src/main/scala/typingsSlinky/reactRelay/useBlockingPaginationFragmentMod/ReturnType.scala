...
object ReturnType {
  ...
  @scala.inline
  implicit class ReturnTypeOps[Self <: ReturnType[_, _, _], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, TKey, TFragmentData] (val x: Self with (ReturnType[TQuery, TKey, TFragmentData])) extends AnyVal {
    @scala.inline
