...
object QueryRenderer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRelay.mod.QueryRenderer[js.Any]] {
  ...
  def apply[TOperation /* <: OperationType */](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRelay.mod.QueryRenderer[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactRelay.mod.QueryRenderer[js.Any]]]
  }
  type Props = AnonCacheConfig with QueryRendererProps[js.Any]
}
