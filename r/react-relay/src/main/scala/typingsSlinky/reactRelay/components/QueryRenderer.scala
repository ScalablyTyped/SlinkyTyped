...
object QueryRenderer {
  ...
  def apply[TOperation /* <: OperationType */](
    ...
    new Builder[TOperation](js.Array(this.component, __props.asInstanceOf[CacheConfig with QueryRendererProps[TOperation]]))
  }
  ...
  class Builder[TOperation /* <: OperationType */] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def cacheConfig(value: typingsSlinky.relayRuntime.relayRuntimeTypesMod.CacheConfig): this.type = set("cacheConfig", value.asInstanceOf[js.Any])
  ...
  def withProps[TOperation /* <: OperationType */](p: CacheConfig with QueryRendererProps[TOperation]): Builder[TOperation] = new Builder[TOperation](js.Array(this.component, p.asInstanceOf[js.Any]))
}
