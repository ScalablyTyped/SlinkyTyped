...
object QueryRenderer {
  ...
  @scala.inline
  class Builder[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TOperation] (val args: js.Array[js.Any])
    extends AnyVal
  ...
  def withProps[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TOperation](p: typingsSlinky.reactRelay.anon.CacheConfig with QueryRendererProps[TOperation]): Builder[TOperation] = new Builder[TOperation](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TOperation](
