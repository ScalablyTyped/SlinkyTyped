...
package object mod {
  ...
  type ContainerProps[Props] = typingsSlinky.reactRelay.mod.MappedFragmentProps[
    typingsSlinky.std.Pick[
      Props, 
      typingsSlinky.std.Exclude[java.lang.String, typingsSlinky.reactRelay.reactRelayStrings.relay]
    ]
  ]
  ...
  {[ K in keyof T ]: react-relay.react-relay.FragmentOrRegularProp<T[K]>}
    */ typingsSlinky.reactRelay.reactRelayStrings.MappedFragmentProps with T
