...
object QueryRendererProps {
  ...
  @scala.inline
  implicit class QueryRendererPropsOps[Self <: QueryRendererProps[_], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TOperation] (val x: Self with QueryRendererProps[TOperation]) extends AnyVal {
    @scala.inline
