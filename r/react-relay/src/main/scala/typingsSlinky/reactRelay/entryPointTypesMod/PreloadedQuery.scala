...
object PreloadedQuery {
  ...
  @scala.inline
  implicit class PreloadedQueryOps[Self <: PreloadedQuery[_, _], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, TEnvironmentProviderOptions] (val x: Self with (PreloadedQuery[TQuery, TEnvironmentProviderOptions])) extends AnyVal {
    @scala.inline
