...
object ThinQueryParams {
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, TEnvironmentProviderOptions](
  ...
  @scala.inline
  implicit class ThinQueryParamsOps[Self <: ThinQueryParams[_, _], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, TEnvironmentProviderOptions] (val x: Self with (ThinQueryParams[TQuery, TEnvironmentProviderOptions])) extends AnyVal {
    @scala.inline
