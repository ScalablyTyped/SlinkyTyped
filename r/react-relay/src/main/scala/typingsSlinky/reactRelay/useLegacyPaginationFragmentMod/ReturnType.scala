...
object ReturnType {
  ...
  @scala.inline
  implicit class ReturnTypeOps[Self <: ReturnType[_, _, _], TQuery /* <: OperationType */, TKey, TFragmentData] (val x: Self with (ReturnType[TQuery, TKey, TFragmentData])) extends AnyVal {
