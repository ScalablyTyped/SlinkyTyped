...
object Error {
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TOperation](): Error[TOperation] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Error[TOperation]]
  }
  @scala.inline
  implicit class ErrorOps[Self <: Error[_], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TOperation] (val x: Self with Error[TOperation]) extends AnyVal {
    @scala.inline
