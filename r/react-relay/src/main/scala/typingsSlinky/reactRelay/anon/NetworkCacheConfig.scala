...
trait NetworkCacheConfig extends js.Object {
  var networkCacheConfig: js.UndefOr[typingsSlinky.relayRuntime.relayRuntimeTypesMod.CacheConfig] = js.undefined
}

object NetworkCacheConfig {
  @scala.inline
  def apply(networkCacheConfig: typingsSlinky.relayRuntime.relayRuntimeTypesMod.CacheConfig = null): NetworkCacheConfig = {
