package typingsSlinky.reactRelay.matchContainerMod
...
trait MatchContainerProps[TProps, TFallback] extends js.Object {
  ...
  val loader: js.Function1[/* module */ js.Any, ReactComponentClass[TProps]] = js.native
...
object MatchContainerProps {
  ...
  @scala.inline
  def apply[TProps, TFallback](loader: /* module */ js.Any => ReactComponentClass[TProps]): MatchContainerProps[TProps, TFallback] = {
  ...
  implicit class MatchContainerPropsOps[Self <: MatchContainerProps[_, _], TProps, TFallback] (val x: Self with (MatchContainerProps[TProps, TFallback])) extends AnyVal {
    ...
    @scala.inline
    def setLoader(value: /* module */ js.Any => ReactComponentClass[TProps]): Self = this.set("loader", js.Any.fromFunction1(value))
