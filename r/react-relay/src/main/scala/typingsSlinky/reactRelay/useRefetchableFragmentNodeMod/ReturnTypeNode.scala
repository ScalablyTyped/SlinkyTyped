...
object ReturnTypeNode {
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, /* <: org.scalablytyped.runtime.StringDictionary[js.Any] | scala.Null */ TKey, TOptions](
  ...
  @scala.inline
  implicit class ReturnTypeNodeOps[Self <: ReturnTypeNode[_, _, _], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, /* <: org.scalablytyped.runtime.StringDictionary[js.Any] | scala.Null */ TKey, TOptions] (val x: Self with (ReturnTypeNode[TQuery, TKey, TOptions])) extends AnyVal {
    @scala.inline
