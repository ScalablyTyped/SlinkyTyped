...
object UseMutationConfig {
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.commitMutationMod.MutationParameters */ TMutation](
  ...
  @scala.inline
  implicit class UseMutationConfigOps[Self <: UseMutationConfig[_], /* <: typingsSlinky.relayRuntime.commitMutationMod.MutationParameters */ TMutation] (val x: Self with UseMutationConfig[TMutation]) extends AnyVal {
    @scala.inline
