...
object AnonError {
  @scala.inline
  def apply[TOperation](): AnonError[TOperation] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonError[TOperation]]
  }
  @scala.inline
  implicit class AnonErrorOps[Self[toperation] <: AnonError[toperation], TOperation] (val x: Self[TOperation]) extends AnyVal {
    @scala.inline
