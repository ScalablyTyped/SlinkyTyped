...
import typingsSlinky.reactDashMdl.reactDashMdlMod.ChipProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Chip
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Chip] {
  ...
  def apply(
    ...
    onClose: SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.Chip] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Chip] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Chip] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Chip](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
