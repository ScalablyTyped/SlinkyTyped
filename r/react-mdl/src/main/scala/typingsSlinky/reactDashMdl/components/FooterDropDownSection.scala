...
import typingsSlinky.reactDashMdl.reactDashMdlMod.FooterDropDownSectionProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object FooterDropDownSection
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.FooterDropDownSection] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.FooterDropDownSection] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.FooterDropDownSection, 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.FooterDropDownSection] = {
  ...
  type Props = FooterDropDownSectionProps
}
