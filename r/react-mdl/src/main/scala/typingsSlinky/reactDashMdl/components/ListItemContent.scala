...
import typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContentProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ListItemContent
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContent] {
  ...
  def apply(
    ...
    avatar: String | typingsSlinky.react.reactMod._Global_.JSX.Element = null,
    ...
    icon: String | typingsSlinky.react.reactMod._Global_.JSX.Element = null,
    inlist: js.Any = null,
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContent] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContent, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContent, Event] => Unit = null,
    prefix: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContent] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContent] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemContent](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
