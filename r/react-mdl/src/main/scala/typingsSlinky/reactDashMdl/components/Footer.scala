...
import typingsSlinky.reactDashMdl.reactDashMdlMod.FooterProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Footer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Footer] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.Footer] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.Footer, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.Footer, Event] => Unit = null,
    prefix: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Footer] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Footer] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Footer](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
