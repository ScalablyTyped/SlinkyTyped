...
object MDLComponent
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.MDLComponent] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashMdl.reactDashMdlMod.MDLComponent](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
