...
object Radio
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.Radio] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.Radio, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.Radio, Event] => Unit = null,
    prefix: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Radio] = {
