...
import typingsSlinky.reactDashMdl.reactDashMdlMod.ListItemProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ListItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.ListItem] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.ListItem] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.ListItem] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.ListItem](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
