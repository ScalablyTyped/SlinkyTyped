...
object Slider
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.Slider] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.Slider, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.reactDashMdl.reactDashMdlMod.Slider, Event] => Unit = null,
    prefix: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Slider] = {
