...
import typingsSlinky.reactDashMdl.reactDashMdlMod.SnackbarProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Snackbar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Snackbar] {
  ...
  def apply(
    ...
    onActionClick: SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.Snackbar] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.Snackbar] = {
