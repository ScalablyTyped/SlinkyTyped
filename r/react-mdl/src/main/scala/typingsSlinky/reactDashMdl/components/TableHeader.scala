...
object TableHeader
  ...
  def apply(
    ...
    onClick: (/* e */ SyntheticMouseEvent[typingsSlinky.reactDashMdl.reactDashMdlMod.TableHeader], /* name */ String) => _ = null,
    prefix: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.TableHeader] = {
