...
import typingsSlinky.reactDashMdl.reactDashMdlMod.HeaderTabsProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object HeaderTabs
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.HeaderTabs] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.HeaderTabs] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashMdl.reactDashMdlMod.HeaderTabs] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashMdl.reactDashMdlMod.HeaderTabs](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
