...
import typingsSlinky.reactDashMdl.Anon_Html
...
object TabsProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Event, Tabs] => Unit = null,
    onBlur: SyntheticFocusEvent[Tabs] => Unit = null,
    onCanPlay: SyntheticEvent[Event, Tabs] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, Tabs] => Unit = null,
    onChange: /* tabId */ Double => _ = null,
    onClick: SyntheticMouseEvent[Tabs] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[Tabs] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[Tabs] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[Tabs] => Unit = null,
    onContextMenu: SyntheticMouseEvent[Tabs] => Unit = null,
    onCopy: SyntheticClipboardEvent[Tabs] => Unit = null,
    onCut: SyntheticClipboardEvent[Tabs] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[Tabs] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, Tabs] => Unit = null,
    onEmptied: SyntheticEvent[Event, Tabs] => Unit = null,
    onEncrypted: SyntheticEvent[Event, Tabs] => Unit = null,
    onEnded: SyntheticEvent[Event, Tabs] => Unit = null,
    onError: SyntheticEvent[Event, Tabs] => Unit = null,
    onFocus: SyntheticFocusEvent[Tabs] => Unit = null,
    onInput: SyntheticEvent[EventTarget with Tabs, Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[Tabs] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[Tabs] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[Tabs] => Unit = null,
    onLoad: SyntheticEvent[Event, Tabs] => Unit = null,
    onLoadStart: SyntheticEvent[Event, Tabs] => Unit = null,
    onLoadedData: SyntheticEvent[Event, Tabs] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, Tabs] => Unit = null,
    onMouseDown: SyntheticMouseEvent[Tabs] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[Tabs] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[Tabs] => Unit = null,
    onMouseMove: SyntheticMouseEvent[Tabs] => Unit = null,
    onMouseOut: SyntheticMouseEvent[Tabs] => Unit = null,
    onMouseOver: SyntheticMouseEvent[Tabs] => Unit = null,
    onMouseUp: SyntheticMouseEvent[Tabs] => Unit = null,
    onPaste: SyntheticClipboardEvent[Tabs] => Unit = null,
    onPause: SyntheticEvent[Event, Tabs] => Unit = null,
    onPlay: SyntheticEvent[Event, Tabs] => Unit = null,
    onPlaying: SyntheticEvent[Event, Tabs] => Unit = null,
    onProgress: SyntheticEvent[Event, Tabs] => Unit = null,
    onRateChange: SyntheticEvent[Event, Tabs] => Unit = null,
    onScroll: SyntheticUIEvent[Tabs] => Unit = null,
    onSeeked: SyntheticEvent[Event, Tabs] => Unit = null,
    onSeeking: SyntheticEvent[Event, Tabs] => Unit = null,
    onSelect: SyntheticEvent[Event, Tabs] => Unit = null,
    onStalled: SyntheticEvent[Event, Tabs] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with Tabs, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, Tabs] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, Tabs] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[Tabs] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[Tabs] => Unit = null,
    onTouchMove: SyntheticTouchEvent[Tabs] => Unit = null,
    onTouchStart: SyntheticTouchEvent[Tabs] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, Tabs] => Unit = null,
    onWaiting: SyntheticEvent[Event, Tabs] => Unit = null,
    onWheel: SyntheticWheelEvent[Tabs] => Unit = null,
