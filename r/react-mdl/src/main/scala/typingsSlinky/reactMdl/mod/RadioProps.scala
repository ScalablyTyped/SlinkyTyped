...
object RadioProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Event, Radio] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with Radio, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[Radio] => Unit = null,
    onCanPlay: SyntheticEvent[Event, Radio] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, Radio] => Unit = null,
    onChange: SyntheticEvent[EventTarget with Radio, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, Radio] => Unit = null,
    onEmptied: SyntheticEvent[Event, Radio] => Unit = null,
    onEncrypted: SyntheticEvent[Event, Radio] => Unit = null,
    onEnded: SyntheticEvent[Event, Radio] => Unit = null,
    onError: SyntheticEvent[Event, Radio] => Unit = null,
    onFocus: SyntheticFocusEvent[Radio] => Unit = null,
    onInput: SyntheticEvent[EventTarget with Radio, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with Radio, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, Radio] => Unit = null,
    onLoadStart: SyntheticEvent[Event, Radio] => Unit = null,
    onLoadedData: SyntheticEvent[Event, Radio] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, Radio] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, Radio] => Unit = null,
    onPlay: SyntheticEvent[Event, Radio] => Unit = null,
    onPlaying: SyntheticEvent[Event, Radio] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, Radio] => Unit = null,
    onRateChange: SyntheticEvent[Event, Radio] => Unit = null,
    onReset: SyntheticEvent[EventTarget with Radio, Event] => Unit = null,
    onScroll: SyntheticUIEvent[Radio] => Unit = null,
    onSeeked: SyntheticEvent[Event, Radio] => Unit = null,
    onSeeking: SyntheticEvent[Event, Radio] => Unit = null,
    onSelect: SyntheticEvent[Event, Radio] => Unit = null,
    onStalled: SyntheticEvent[Event, Radio] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with Radio, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, Radio] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, Radio] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, Radio] => Unit = null,
    onWaiting: SyntheticEvent[Event, Radio] => Unit = null,
