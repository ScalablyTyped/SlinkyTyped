...
object TabsProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Event_, Tabs] => Unit = null,
    onBlur: SyntheticFocusEvent[Tabs] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, Tabs] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, Tabs] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, Tabs] => Unit = null,
    onEmptied: SyntheticEvent[Event_, Tabs] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, Tabs] => Unit = null,
    onEnded: SyntheticEvent[Event_, Tabs] => Unit = null,
    onError: SyntheticEvent[Event_, Tabs] => Unit = null,
    onFocus: SyntheticFocusEvent[Tabs] => Unit = null,
    onInput: SyntheticEvent[EventTarget with Tabs, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, Tabs] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, Tabs] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, Tabs] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, Tabs] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, Tabs] => Unit = null,
    onPlay: SyntheticEvent[Event_, Tabs] => Unit = null,
    onPlaying: SyntheticEvent[Event_, Tabs] => Unit = null,
    onProgress: SyntheticEvent[Event_, Tabs] => Unit = null,
    onRateChange: SyntheticEvent[Event_, Tabs] => Unit = null,
    onScroll: SyntheticUIEvent[Tabs] => Unit = null,
    onSeeked: SyntheticEvent[Event_, Tabs] => Unit = null,
    onSeeking: SyntheticEvent[Event_, Tabs] => Unit = null,
    onSelect: SyntheticEvent[Event_, Tabs] => Unit = null,
    onStalled: SyntheticEvent[Event_, Tabs] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with Tabs, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, Tabs] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, Tabs] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, Tabs] => Unit = null,
    onWaiting: SyntheticEvent[Event_, Tabs] => Unit = null,
