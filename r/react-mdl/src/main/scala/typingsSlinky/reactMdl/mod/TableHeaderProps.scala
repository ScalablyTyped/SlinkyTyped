...
trait TableHeaderProps
  ...
  var onClick: js.UndefOr[js.Function2[/* e */ SyntheticMouseEvent[TableHeader], /* name */ String, _]] = js.undefined
  var sortFn: js.UndefOr[js.Function3[/* a */ js.Any, /* b */ js.Any, /* isAsc */ Boolean, Double]] = js.undefined
  var title: js.UndefOr[String] = js.undefined
  var tooltip: js.UndefOr[TagMod[Any]] = js.undefined
}
...
object TableHeaderProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onBlur: SyntheticFocusEvent[TableHeader] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onClick: (/* e */ SyntheticMouseEvent[TableHeader], /* name */ String) => _ = null,
    onCompositionEnd: SyntheticCompositionEvent[TableHeader] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[TableHeader] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[TableHeader] => Unit = null,
    onContextMenu: SyntheticMouseEvent[TableHeader] => Unit = null,
    onCopy: SyntheticClipboardEvent[TableHeader] => Unit = null,
    onCut: SyntheticClipboardEvent[TableHeader] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[TableHeader] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onEmptied: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onEnded: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onError: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onFocus: SyntheticFocusEvent[TableHeader] => Unit = null,
    onInput: SyntheticEvent[EventTarget with TableHeader, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[TableHeader] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[TableHeader] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[TableHeader] => Unit = null,
    onLoad: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onMouseDown: SyntheticMouseEvent[TableHeader] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[TableHeader] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[TableHeader] => Unit = null,
    onMouseMove: SyntheticMouseEvent[TableHeader] => Unit = null,
    onMouseOut: SyntheticMouseEvent[TableHeader] => Unit = null,
    onMouseOver: SyntheticMouseEvent[TableHeader] => Unit = null,
    onMouseUp: SyntheticMouseEvent[TableHeader] => Unit = null,
    onPaste: SyntheticClipboardEvent[TableHeader] => Unit = null,
    onPause: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onPlay: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onPlaying: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onProgress: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onRateChange: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onScroll: SyntheticUIEvent[TableHeader] => Unit = null,
    onSeeked: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onSeeking: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onSelect: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onStalled: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with TableHeader, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[TableHeader] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[TableHeader] => Unit = null,
    onTouchMove: SyntheticTouchEvent[TableHeader] => Unit = null,
    onTouchStart: SyntheticTouchEvent[TableHeader] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onWaiting: SyntheticEvent[Event_, TableHeader] => Unit = null,
    onWheel: SyntheticWheelEvent[TableHeader] => Unit = null,
