...
object TableHeaderProps {
  ...
  implicit class TableHeaderPropsOps[Self <: TableHeaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCellFormatter(value: (/* value */ js.Any, /* row */ js.Any, /* index */ Double) => ReactElement): Self = this.set("cellFormatter", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setOnClick(value: (/* e */ SyntheticMouseEvent[TableHeader], /* name */ String) => _): Self = this.set("onClick", js.Any.fromFunction2(value))
