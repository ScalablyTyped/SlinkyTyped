...
object TableHeaderProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event, TableHeader] => Unit = null,
    onBlur: SyntheticFocusEvent[TableHeader] => Unit = null,
    onCanPlay: SyntheticEvent[Event, TableHeader] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, TableHeader] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, TableHeader] => Unit = null,
    onEmptied: SyntheticEvent[Event, TableHeader] => Unit = null,
    onEncrypted: SyntheticEvent[Event, TableHeader] => Unit = null,
    onEnded: SyntheticEvent[Event, TableHeader] => Unit = null,
    onError: SyntheticEvent[Event, TableHeader] => Unit = null,
    onFocus: SyntheticFocusEvent[TableHeader] => Unit = null,
    onInput: SyntheticEvent[EventTarget with TableHeader, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, TableHeader] => Unit = null,
    onLoadStart: SyntheticEvent[Event, TableHeader] => Unit = null,
    onLoadedData: SyntheticEvent[Event, TableHeader] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, TableHeader] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, TableHeader] => Unit = null,
    onPlay: SyntheticEvent[Event, TableHeader] => Unit = null,
    onPlaying: SyntheticEvent[Event, TableHeader] => Unit = null,
    onProgress: SyntheticEvent[Event, TableHeader] => Unit = null,
    onRateChange: SyntheticEvent[Event, TableHeader] => Unit = null,
    onScroll: SyntheticUIEvent[TableHeader] => Unit = null,
    onSeeked: SyntheticEvent[Event, TableHeader] => Unit = null,
    onSeeking: SyntheticEvent[Event, TableHeader] => Unit = null,
    onSelect: SyntheticEvent[Event, TableHeader] => Unit = null,
    onStalled: SyntheticEvent[Event, TableHeader] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with TableHeader, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, TableHeader] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, TableHeader] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, TableHeader] => Unit = null,
    onWaiting: SyntheticEvent[Event, TableHeader] => Unit = null,
