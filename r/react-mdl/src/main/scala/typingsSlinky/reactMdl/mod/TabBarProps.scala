...
object TabBarProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Event, TabBar] => Unit = null,
    onBlur: SyntheticFocusEvent[TabBar] => Unit = null,
    onCanPlay: SyntheticEvent[Event, TabBar] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, TabBar] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, TabBar] => Unit = null,
    onEmptied: SyntheticEvent[Event, TabBar] => Unit = null,
    onEncrypted: SyntheticEvent[Event, TabBar] => Unit = null,
    onEnded: SyntheticEvent[Event, TabBar] => Unit = null,
    onError: SyntheticEvent[Event, TabBar] => Unit = null,
    onFocus: SyntheticFocusEvent[TabBar] => Unit = null,
    onInput: SyntheticEvent[EventTarget with TabBar, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, TabBar] => Unit = null,
    onLoadStart: SyntheticEvent[Event, TabBar] => Unit = null,
    onLoadedData: SyntheticEvent[Event, TabBar] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, TabBar] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, TabBar] => Unit = null,
    onPlay: SyntheticEvent[Event, TabBar] => Unit = null,
    onPlaying: SyntheticEvent[Event, TabBar] => Unit = null,
    onProgress: SyntheticEvent[Event, TabBar] => Unit = null,
    onRateChange: SyntheticEvent[Event, TabBar] => Unit = null,
    onScroll: SyntheticUIEvent[TabBar] => Unit = null,
    onSeeked: SyntheticEvent[Event, TabBar] => Unit = null,
    onSeeking: SyntheticEvent[Event, TabBar] => Unit = null,
    onSelect: SyntheticEvent[Event, TabBar] => Unit = null,
    onStalled: SyntheticEvent[Event, TabBar] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with TabBar, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, TabBar] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, TabBar] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, TabBar] => Unit = null,
    onWaiting: SyntheticEvent[Event, TabBar] => Unit = null,
