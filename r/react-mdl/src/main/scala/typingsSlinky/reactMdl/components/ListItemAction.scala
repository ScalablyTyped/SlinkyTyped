...
import typingsSlinky.reactMdl.mod.ListItemActionProps
...
object ListItemAction
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.ListItemAction] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.ListItemAction] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.ListItemAction] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.ListItemAction](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
