...
import typingsSlinky.reactMdl.mod.DialogActionsProps
...
object DialogActions
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.DialogActions] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.DialogActions] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.DialogActions] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.DialogActions](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
