...
import typingsSlinky.reactMdl.mod.CheckboxProps
...
object Checkbox
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Checkbox] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Checkbox] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Checkbox] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Checkbox](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
