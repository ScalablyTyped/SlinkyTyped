...
import typingsSlinky.reactMdl.mod.DialogProps
...
object Dialog
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Dialog] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Dialog] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Dialog] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Dialog](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
