...
import typingsSlinky.reactMdl.mod.FABButtonProps
...
object FABButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.FABButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.FABButton] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.FABButton] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.FABButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
