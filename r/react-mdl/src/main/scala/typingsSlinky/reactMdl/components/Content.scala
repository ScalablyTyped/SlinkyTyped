...
import typingsSlinky.reactMdl.mod.ContentProps
...
object Content
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Content] {
  ...
  def apply(
    ...
    classID: String = null,
    color: String = null,
    component: String | ReactElement | js.Function = null,
    ...
    onClick: SyntheticMouseEvent[js.Any] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Content] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Content] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Content](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
