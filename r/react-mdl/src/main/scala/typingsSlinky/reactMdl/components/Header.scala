...
object Header {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Header] {
    @scala.inline
    ...
    @scala.inline
    def hideTop(value: Boolean): this.type = set("hideTop", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def seamed(value: Boolean): this.type = set("seamed", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def waterfall(value: Boolean): this.type = set("waterfall", value.asInstanceOf[js.Any])
    @scala.inline
