...
object Chip {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Chip] {
    @scala.inline
    ...
    @scala.inline
    def onClick(value: SyntheticMouseEvent[typingsSlinky.reactMdl.mod.Chip] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    def onClose(value: SyntheticMouseEvent[typingsSlinky.reactMdl.mod.Chip] => Unit): this.type = set("onClose", js.Any.fromFunction1(value))
    @scala.inline
