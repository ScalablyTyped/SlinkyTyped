...
import typingsSlinky.reactMdl.mod.ChipProps
...
object Chip
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Chip] {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, js.Any] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[js.Any] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[js.Any] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[js.Any] => Unit = null,
    onAuxClick: SyntheticMouseEvent[js.Any] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with js.Any, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[js.Any] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, js.Any] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, js.Any] => Unit = null,
    onChange: SyntheticEvent[EventTarget with js.Any, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[typingsSlinky.reactMdl.mod.Chip] => Unit = null,
    onClose: SyntheticMouseEvent[typingsSlinky.reactMdl.mod.Chip] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[js.Any] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[js.Any] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[js.Any] => Unit = null,
    onContextMenu: SyntheticMouseEvent[js.Any] => Unit = null,
    onCopy: SyntheticClipboardEvent[js.Any] => Unit = null,
    onCut: SyntheticClipboardEvent[js.Any] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[js.Any] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, js.Any] => Unit = null,
    onEmptied: SyntheticEvent[Event_, js.Any] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, js.Any] => Unit = null,
    onEnded: SyntheticEvent[Event_, js.Any] => Unit = null,
    onError: SyntheticEvent[Event_, js.Any] => Unit = null,
    onFocus: SyntheticFocusEvent[js.Any] => Unit = null,
    onInput: SyntheticEvent[EventTarget with js.Any, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with js.Any, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[js.Any] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[js.Any] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[js.Any] => Unit = null,
    onLoad: SyntheticEvent[Event_, js.Any] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, js.Any] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, js.Any] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, js.Any] => Unit = null,
    onMouseDown: SyntheticMouseEvent[js.Any] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[js.Any] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[js.Any] => Unit = null,
    onMouseMove: SyntheticMouseEvent[js.Any] => Unit = null,
    onMouseOut: SyntheticMouseEvent[js.Any] => Unit = null,
    onMouseOver: SyntheticMouseEvent[js.Any] => Unit = null,
    onMouseUp: SyntheticMouseEvent[js.Any] => Unit = null,
    onPaste: SyntheticClipboardEvent[js.Any] => Unit = null,
    onPause: SyntheticEvent[Event_, js.Any] => Unit = null,
    onPlay: SyntheticEvent[Event_, js.Any] => Unit = null,
    onPlaying: SyntheticEvent[Event_, js.Any] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[js.Any] => Unit = null,
    onPointerDown: SyntheticPointerEvent[js.Any] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[js.Any] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[js.Any] => Unit = null,
    onPointerMove: SyntheticPointerEvent[js.Any] => Unit = null,
    onPointerOut: SyntheticPointerEvent[js.Any] => Unit = null,
    onPointerOver: SyntheticPointerEvent[js.Any] => Unit = null,
    onPointerUp: SyntheticPointerEvent[js.Any] => Unit = null,
    onProgress: SyntheticEvent[Event_, js.Any] => Unit = null,
    onRateChange: SyntheticEvent[Event_, js.Any] => Unit = null,
    onReset: SyntheticEvent[EventTarget with js.Any, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[js.Any] => Unit = null,
    onSeeked: SyntheticEvent[Event_, js.Any] => Unit = null,
    onSeeking: SyntheticEvent[Event_, js.Any] => Unit = null,
    onSelect: SyntheticEvent[Event_, js.Any] => Unit = null,
    onStalled: SyntheticEvent[Event_, js.Any] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with js.Any, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, js.Any] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, js.Any] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[js.Any] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[js.Any] => Unit = null,
    onTouchMove: SyntheticTouchEvent[js.Any] => Unit = null,
    onTouchStart: SyntheticTouchEvent[js.Any] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[js.Any] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, js.Any] => Unit = null,
    onWaiting: SyntheticEvent[Event_, js.Any] => Unit = null,
    onWheel: SyntheticWheelEvent[js.Any] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Chip] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Chip] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Chip](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
