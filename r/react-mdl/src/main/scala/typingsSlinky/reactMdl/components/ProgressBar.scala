...
import typingsSlinky.reactMdl.mod.ProgressBarProps
...
object ProgressBar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.ProgressBar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.ProgressBar] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.ProgressBar] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.ProgressBar](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
