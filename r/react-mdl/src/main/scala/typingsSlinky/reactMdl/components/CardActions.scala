...
object CardActions {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.CardActions] {
    @scala.inline
  ...
  def withProps(p: CardActionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
