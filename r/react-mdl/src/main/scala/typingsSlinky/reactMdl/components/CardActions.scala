...
import typingsSlinky.reactMdl.mod.CardActionProps
...
object CardActions
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.CardActions] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.CardActions] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.CardActions] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.CardActions](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
