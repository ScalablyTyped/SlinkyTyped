...
import typingsSlinky.reactMdl.mod.CardTitleProps
...
object CardTitle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.CardTitle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.CardTitle] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.CardTitle] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.CardTitle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
