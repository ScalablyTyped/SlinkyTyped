...
import typingsSlinky.reactMdl.mod.SwitchProps
...
object Switch
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Switch] {
  ...
  def apply(
    ...
    onChange: SyntheticEvent[EventTarget with typingsSlinky.reactMdl.mod.Switch, Event_] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Switch] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Switch] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Switch](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
