...
object Switch {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Switch] {
    @scala.inline
    ...
    @scala.inline
    def onChange(value: SyntheticEvent[EventTarget with typingsSlinky.reactMdl.mod.Switch, Event_] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
