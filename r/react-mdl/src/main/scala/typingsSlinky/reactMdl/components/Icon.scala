...
import typingsSlinky.reactMdl.mod.IconProps
...
object Icon
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Icon] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Icon] = {
