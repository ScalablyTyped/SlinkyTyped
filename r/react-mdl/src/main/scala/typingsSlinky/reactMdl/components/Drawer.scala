...
import typingsSlinky.reactMdl.mod.DrawerProps
...
object Drawer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Drawer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Drawer] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Drawer] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Drawer](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
