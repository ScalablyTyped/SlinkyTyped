...
import typingsSlinky.reactMdl.mod.DialogTitleProps
...
object DialogTitle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.DialogTitle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.DialogTitle] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.DialogTitle] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.DialogTitle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
