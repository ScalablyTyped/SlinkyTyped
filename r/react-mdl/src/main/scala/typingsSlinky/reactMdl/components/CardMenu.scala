...
object CardMenu {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.CardMenu] {
  ...
  implicit def make(companion: CardMenu.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
