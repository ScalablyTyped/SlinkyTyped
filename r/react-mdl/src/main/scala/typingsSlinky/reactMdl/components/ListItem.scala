...
object ListItem {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.ListItem] {
    @scala.inline
    ...
    @scala.inline
    def threeLine(value: Boolean): this.type = set("threeLine", value.asInstanceOf[js.Any])
    @scala.inline
    def title(value: String): this.type = set("title", value.asInstanceOf[js.Any])
    @scala.inline
    def translate(value: yes | no): this.type = set("translate", value.asInstanceOf[js.Any])
    @scala.inline
    def twoLine(value: Boolean): this.type = set("twoLine", value.asInstanceOf[js.Any])
    @scala.inline
