...
import typingsSlinky.reactMdl.mod.GridProps
...
object Grid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Grid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Grid] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Grid] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Grid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
