...
object Tab {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Tab] {
    @scala.inline
    ...
    @scala.inline
    def cssPrefix(value: String): this.type = set("cssPrefix", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onTabClick(value: /* tabId */ Double => _): this.type = set("onTabClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def tabId(value: Double): this.type = set("tabId", value.asInstanceOf[js.Any])
    @scala.inline
