...
import typingsSlinky.reactMdl.mod.HeaderTabsProps
...
object HeaderTabs
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.HeaderTabs] {
  ...
  def apply(
    ...
    onChange: SyntheticEvent[EventTarget with typingsSlinky.reactMdl.mod.Header, Event_] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.HeaderTabs] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.HeaderTabs] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.HeaderTabs](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = HeaderTabsProps
}
