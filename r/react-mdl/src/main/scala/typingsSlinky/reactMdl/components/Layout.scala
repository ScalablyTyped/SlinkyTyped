...
object Layout {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Layout] {
    @scala.inline
    ...
    @scala.inline
    def fixedDrawer(value: Boolean): this.type = set("fixedDrawer", value.asInstanceOf[js.Any])
    @scala.inline
    def fixedHeader(value: Boolean): this.type = set("fixedHeader", value.asInstanceOf[js.Any])
    @scala.inline
    def fixedTabs(value: Boolean): this.type = set("fixedTabs", value.asInstanceOf[js.Any])
    @scala.inline
