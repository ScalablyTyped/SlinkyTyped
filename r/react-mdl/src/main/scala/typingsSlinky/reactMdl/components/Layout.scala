...
import typingsSlinky.reactMdl.mod.LayoutProps
...
object Layout
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Layout] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Layout] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Layout] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Layout](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
