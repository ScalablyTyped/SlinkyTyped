...
object MDLBasicComponent {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.MDLBasicComponent] {
  ...
  implicit def make(companion: MDLBasicComponent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
