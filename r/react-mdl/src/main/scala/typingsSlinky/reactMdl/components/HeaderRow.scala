...
object HeaderRow {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.HeaderRow] {
    ...
    @scala.inline
    def hideSpacer(value: Boolean): this.type = set("hideSpacer", value.asInstanceOf[js.Any])
  ...
  def withProps(p: HeaderRowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: HeaderRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
