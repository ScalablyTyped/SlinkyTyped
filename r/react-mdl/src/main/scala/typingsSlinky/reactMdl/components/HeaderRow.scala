...
import typingsSlinky.reactMdl.mod.HeaderRowProps
...
object HeaderRow
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.HeaderRow] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.HeaderRow] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.HeaderRow](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
