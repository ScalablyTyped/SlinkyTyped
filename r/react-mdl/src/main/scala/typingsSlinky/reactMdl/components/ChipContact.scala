...
object ChipContact {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.ChipContact] {
    @scala.inline
  ...
  def withProps(p: HTMLProps[js.Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ChipContact.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
