...
object Snackbar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Snackbar] {
  ...
  def apply(
    ...
    onActionClick: SyntheticMouseEvent[typingsSlinky.reactMdl.mod.Snackbar] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Snackbar] = {
