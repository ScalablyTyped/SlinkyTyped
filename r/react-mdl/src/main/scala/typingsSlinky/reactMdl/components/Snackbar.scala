...
import typingsSlinky.reactMdl.mod.SnackbarProps
...
object Snackbar {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Snackbar] {
    ...
    @scala.inline
    def onActionClick(value: SyntheticMouseEvent[typingsSlinky.reactMdl.mod.Snackbar] => Unit): this.type = set("onActionClick", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def apply(active: Boolean, onTimeout: () => js.Any): Builder = {
    val __props = js.Dynamic.literal(active = active.asInstanceOf[js.Any], onTimeout = js.Any.fromFunction0(onTimeout))
