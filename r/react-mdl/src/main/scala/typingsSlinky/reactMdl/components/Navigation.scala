...
import typingsSlinky.reactMdl.mod.NavigationProps
...
object Navigation
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.Navigation] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Navigation] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.Navigation] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactMdl.mod.Navigation](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
