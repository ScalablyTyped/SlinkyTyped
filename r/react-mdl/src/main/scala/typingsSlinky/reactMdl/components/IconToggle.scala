...
import typingsSlinky.reactMdl.mod.IconToggleProps
...
object IconToggle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactMdl.mod.IconToggle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactMdl.mod.IconToggle] = {
