package typingsSlinky.reactToggle.components
...
import typingsSlinky.reactToggle.mod.ToggleIcons
import typingsSlinky.reactToggle.mod.ToggleProps
import typingsSlinky.reactToggle.mod.default
...
object ReactToggle
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.reactToggle.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
