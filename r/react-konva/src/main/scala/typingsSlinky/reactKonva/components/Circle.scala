...
object Circle {
  ...
  def apply(radius: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CircleConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Circle]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsSlinky.konva.circleMod.CircleConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[typingsSlinky.konva.circleMod.CircleConfig]) => Unit
  ...
  def withProps(p: CircleConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Circle]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
