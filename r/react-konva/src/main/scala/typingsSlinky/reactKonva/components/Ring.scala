...
object Ring {
  ...
  def apply(innerRadius: Double, outerRadius: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[RingConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Ring]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsSlinky.konva.ringMod.RingConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[typingsSlinky.konva.ringMod.RingConfig]) => Unit
  ...
  def withProps(p: RingConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Ring]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
