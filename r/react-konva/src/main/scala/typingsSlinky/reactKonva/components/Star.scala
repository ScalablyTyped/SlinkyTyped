...
object Star {
  ...
  def apply(innerRadius: Double, numPoints: Double, outerRadius: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[StarConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Star]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsSlinky.konva.starMod.StarConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[typingsSlinky.konva.starMod.StarConfig]) => Unit
  ...
  def withProps(p: StarConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Star]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
