...
object Label {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Label with js.Object] {
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.NodeConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Label]
