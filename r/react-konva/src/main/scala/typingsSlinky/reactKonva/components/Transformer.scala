...
import typingsSlinky.konva.transformerMod.Box
...
object Transformer {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Transformer with js.Object] {
    
    @scala.inline
    def anchorFill(value: String): this.type = set("anchorFill", value.asInstanceOf[js.Any])
    
    @scala.inline
    def anchorSize(value: Double): this.type = set("anchorSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def anchorStroke(value: String): this.type = set("anchorStroke", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def borderStroke(value: String): this.type = set("borderStroke", value.asInstanceOf[js.Any])
    
    @scala.inline
    def borderStrokeWidth(value: Double): this.type = set("borderStrokeWidth", value.asInstanceOf[js.Any])
    
    @scala.inline
    def boundBoxFunc(value: (/* oldBox */ Box, /* newBox */ Box) => Box): this.type = set("boundBoxFunc", js.Any.fromFunction2(value))
    
    @scala.inline
    def centeredScaling(value: Boolean): this.type = set("centeredScaling", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[TransformerConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def ignoreStroke(value: Boolean): this.type = set("ignoreStroke", value.asInstanceOf[js.Any])
    
    @scala.inline
    def keepRatio(value: Boolean): this.type = set("keepRatio", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def node(value: typingsSlinky.konva.rectMod.Rect): this.type = set("node", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def resizeEnabled(value: Boolean): this.type = set("resizeEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def rotateAnchorOffset(value: Double): this.type = set("rotateAnchorOffset", value.asInstanceOf[js.Any])
