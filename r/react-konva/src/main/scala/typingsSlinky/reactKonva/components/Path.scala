...
object Path {
  ...
  def apply(data: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PathConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Path]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsSlinky.konva.pathMod.PathConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[typingsSlinky.konva.pathMod.PathConfig]) => Unit
  ...
  def withProps(p: PathConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Path]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
