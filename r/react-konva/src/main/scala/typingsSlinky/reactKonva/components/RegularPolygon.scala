...
object RegularPolygon {
  ...
  def apply(radius: Double, sides: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[RegularPolygonConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.RegularPolygon]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsSlinky.konva.regularPolygonMod.RegularPolygonConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[typingsSlinky.konva.regularPolygonMod.RegularPolygonConfig]) => Unit
  ...
  def withProps(
    p: RegularPolygonConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.RegularPolygon]
