...
import typingsSlinky.konva.regularPolygonMod.RegularPolygonConfig
...
object RegularPolygon {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.RegularPolygon with js.Object] {
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[RegularPolygonConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[RegularPolygonConfig]) => Unit
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.RegularPolygonConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.RegularPolygon]
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(radius: Double, sides: Double): Builder = {
    val __props = js.Dynamic.literal(radius = radius.asInstanceOf[js.Any], sides = sides.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[typingsSlinky.konva.mod.Konva.RegularPolygonConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.RegularPolygon]]))
  }
}
