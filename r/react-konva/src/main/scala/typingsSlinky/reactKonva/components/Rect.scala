...
import typingsSlinky.konva.rectMod.RectConfig
...
object Rect {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Rect with js.Object] {
    
    @scala.inline
    def cornerRadiusVarargs(value: Double*): this.type = set("cornerRadius", js.Array(value :_*))
    
    @scala.inline
    def cornerRadius(value: Double | js.Array[Double]): this.type = set("cornerRadius", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[RectConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hitFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[RectConfig]) => Unit): this.type = set("hitFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def sceneFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[RectConfig]) => Unit): this.type = set("sceneFunc", js.Any.fromFunction2(value))
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.RectConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Rect]
