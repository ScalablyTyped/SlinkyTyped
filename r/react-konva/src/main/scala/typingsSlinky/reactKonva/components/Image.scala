...
import typingsSlinky.konva.imageMod.ImageConfig
...
object Image {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Image with js.Object] {
    ...
    @scala.inline
    def hitFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ImageConfig]) => Unit): this.type = set("hitFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def image(value: CanvasImageSource): this.type = set("image", value.asInstanceOf[js.Any])
    
    @scala.inline
    def imageHTMLCanvasElement(value: HTMLCanvasElement): this.type = set("image", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def sceneFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ImageConfig]) => Unit): this.type = set("sceneFunc", js.Any.fromFunction2(value))
