...
object Group {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Group with js.Object] {
    
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[NodeConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.NodeConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Group]
