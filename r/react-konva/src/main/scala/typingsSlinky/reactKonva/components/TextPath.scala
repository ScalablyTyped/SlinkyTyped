...
object TextPath {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[TextPathConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hitFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[TextPathConfig]) => Unit): this.type = set("hitFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def sceneFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[TextPathConfig]) => Unit): this.type = set("sceneFunc", js.Any.fromFunction2(value))
