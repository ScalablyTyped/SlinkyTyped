...
object Shape {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Shape with js.Object] {
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[ShapeConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hitFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ShapeConfig]) => Unit): this.type = set("hitFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def sceneFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ShapeConfig]) => Unit): this.type = set("sceneFunc", js.Any.fromFunction2(value))
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.ShapeConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Shape]
