...
object Layer {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Layer with js.Object] {
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.LayerConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Layer]
