...
import typingsSlinky.konva.arrowMod.ArrowConfig
...
object Arrow {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Arrow with js.Object] {
    
    @scala.inline
    def bezier(value: Boolean): this.type = set("bezier", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[ArrowConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hitFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ArrowConfig]) => Unit): this.type = set("hitFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def pointerAtBeginning(value: Boolean): this.type = set("pointerAtBeginning", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def sceneFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ArrowConfig]) => Unit): this.type = set("sceneFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def tension(value: Double): this.type = set("tension", value.asInstanceOf[js.Any])
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.ArrowConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arrow]
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(points: js.Array[Double]): Builder = {
    val __props = js.Dynamic.literal(points = points.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[typingsSlinky.konva.mod.Konva.ArrowConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arrow]]))
  }
}
