...
object Arrow {
  ...
  def apply(points: js.Array[Double]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ArrowConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arrow]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsSlinky.konva.arrowMod.ArrowConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[typingsSlinky.konva.arrowMod.ArrowConfig]) => Unit
  ...
  def withProps(p: ArrowConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arrow]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
