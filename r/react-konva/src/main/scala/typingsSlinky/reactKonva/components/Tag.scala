...
import typingsSlinky.konva.labelMod.TagConfig
...
object Tag {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Tag with js.Object] {
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[TagConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hitFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[TagConfig]) => Unit): this.type = set("hitFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def pointerDirection(value: String): this.type = set("pointerDirection", value.asInstanceOf[js.Any])
    
    @scala.inline
    def pointerHeight(value: Double): this.type = set("pointerHeight", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def sceneFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[TagConfig]) => Unit): this.type = set("sceneFunc", js.Any.fromFunction2(value))
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.TagConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Tag]
