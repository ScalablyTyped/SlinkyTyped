...
import typingsSlinky.konva.arcMod.ArcConfig
...
object Arc {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.konva.mod.Konva.Arc with js.Object] {
    ...
    @scala.inline
    def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[ArcConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hitFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ArcConfig]) => Unit): this.type = set("hitFunc", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def sceneFunc(value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[ArcConfig]) => Unit): this.type = set("sceneFunc", js.Any.fromFunction2(value))
  ...
  def withProps(
    p: typingsSlinky.konva.mod.Konva.ArcConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arc]
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(angle: Double, innerRadius: Double, outerRadius: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[typingsSlinky.konva.mod.Konva.ArcConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arc]]))
  }
}
