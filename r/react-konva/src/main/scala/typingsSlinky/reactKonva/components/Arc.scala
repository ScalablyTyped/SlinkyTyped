...
object Arc {
  ...
  def apply(angle: Double, innerRadius: Double, outerRadius: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ArcConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arc]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def dragBoundFunc(
      value: js.ThisFunction1[/* this */ Node[typingsSlinky.konva.arcMod.ArcConfig], /* pos */ Vector2d, Vector2d]
    ...
    @scala.inline
    def hitFunc(
      value: (/* con */ Context, /* shape */ typingsSlinky.konva.shapeMod.Shape[typingsSlinky.konva.arcMod.ArcConfig]) => Unit
  ...
  def withProps(p: ArcConfig with KonvaNodeEvents with ClassAttributes[typingsSlinky.konva.mod.Konva.Arc]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
