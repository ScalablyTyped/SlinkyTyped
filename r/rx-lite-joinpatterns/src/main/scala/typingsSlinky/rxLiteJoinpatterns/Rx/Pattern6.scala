...
object Pattern6 {
  ...
  @scala.inline
  implicit class Pattern6Ops[Self[t1, t2, t3, t4, t5, t6] <: Pattern6[t1, t2, t3, t4, t5, t6], T1, T2, T3, T4, T5, T6] (val x: Self[T1, T2, T3, T4, T5, T6]) extends AnyVal {
    @scala.inline
    def duplicate: Self[T1, T2, T3, T4, T5, T6] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[T1, T2, T3, T4, T5, T6]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): (Self[T1, T2, T3, T4, T5, T6]) with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[(Self[T1, T2, T3, T4, T5, T6]) with Other]
    @scala.inline
    def withAnd(value: Observable[js.Any] => Pattern7[T1, T2, T3, T4, T5, T6, js.Any]): Self[T1, T2, T3, T4, T5, T6] = {
