package typingsSlinky.reactNativeDraggableFlatlist.components
...
import typingsSlinky.reactNativeDraggableFlatlist.mod.DraggableFlatListProps
...
object ReactNativeDraggableFlatlist {
  ...
  class Builder[Item] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def getItem(value: (/* data */ js.Any, /* index */ Double) => Item): this.type = set("getItem", js.Any.fromFunction2(value))
    @scala.inline
    def getItemCount(value: /* data */ js.Any => Double): this.type = set("getItemCount", js.Any.fromFunction1(value))
    @scala.inline
    def getItemLayout(value: (/* data */ js.Any, /* index */ Double) => AnonIndex): this.type = set("getItemLayout", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def keyExtractor(value: (Item, /* index */ Double) => String): this.type = set("keyExtractor", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def onMoveBegin(value: /* index */ Double => Unit): this.type = set("onMoveBegin", js.Any.fromFunction1(value))
    @scala.inline
    def onMoveEnd(value: /* info */ OnMoveEndInfo[Item] => Unit): this.type = set("onMoveEnd", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def scrollPercent(value: Double): this.type = set("scrollPercent", value.asInstanceOf[js.Any])
    @scala.inline
