...
object TypistBackspace {
  ...
  implicit def make(companion: TypistBackspace.type): SharedBuilder_BackSpaceProps_1527818222[typingsSlinky.reactTypist.mod.Typist.Backspace] = new SharedBuilder_BackSpaceProps_1527818222[typingsSlinky.reactTypist.mod.Typist.Backspace](js.Array(this.component, js.Dictionary.empty))()
}
