...
import typingsSlinky.radium.radiumMod.default.StyleRoot
...
object RadiumStyleRoot
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.radium.radiumMod.Radium.StyleRoot] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with typingsSlinky.radium.radiumMod.Radium.StyleRoot, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with typingsSlinky.radium.radiumMod.Radium.StyleRoot, Event] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, StyleRoot] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.radium.radiumMod.default.StyleRoot](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
