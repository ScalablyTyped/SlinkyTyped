...
version := "0.13-dt-20200220Z-8faecf"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "material-ui__types" % "5.0.0-965396",
  "org.scalablytyped.slinky" %%% "prop-types" % "15.7-dt-20190924Z-6bb503",
  "org.scalablytyped.slinky" %%% "react" % "16.9-dt-20200227Z-f18fda",
  "org.scalablytyped.slinky" %%% "react-swipeable-views" % "0.13-dt-20200227Z-cc8465",
