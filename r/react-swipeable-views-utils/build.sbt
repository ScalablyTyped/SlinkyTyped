...
version := "0.13-dt-20200303Z-6227fe"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "material-ui__types" % "5.0.0-c52a7a",
  "org.scalablytyped.slinky" %%% "prop-types" % "15.7-dt-20190924Z-7e1d98",
  "org.scalablytyped.slinky" %%% "react" % "16.9-dt-20200409Z-36b705",
  "org.scalablytyped.slinky" %%% "react-swipeable-views" % "0.13-dt-20200227Z-da1657",
