...
version := "0.13-dt-20191209Z-e9d8db"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "material-ui__types" % "4.1.1-02a6bf",
  "org.scalablytyped.slinky" %%% "prop-types" % "15.7-dt-20190924Z-1d231d",
  "org.scalablytyped.slinky" %%% "react" % "16.9-dt-20191220Z-f02704",
  "org.scalablytyped.slinky" %%% "react-swipeable-views" % "0.13-dt-20190221Z-28c8e6",
