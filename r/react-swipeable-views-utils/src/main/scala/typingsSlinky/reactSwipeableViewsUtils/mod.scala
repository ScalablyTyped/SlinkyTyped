...
object mod {
  ...
  type SlideRendererCallback = js.Function1[/* render */ SlideRenderProps, ReactElement]
  ...
  trait WithVirtualize extends StObject {
    ...
    def slideRenderer(render: SlideRendererCallback): ReactElement = js.native
  }
  object WithVirtualize {
    ...
    def apply(
      ...
      slideRenderer: SlideRendererCallback => ReactElement
    ): WithVirtualize = {
    ...
    implicit class WithVirtualizeMutableBuilder[Self <: WithVirtualize] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSlideRenderer(value: SlideRendererCallback => ReactElement): Self = StObject.set(x, "slideRenderer", js.Any.fromFunction1(value))
    }
  }
  ...
  object WithVirtualizeProps {
    ...
    def apply(
      index: Double,
      onChangeIndex: (/* index */ Double, /* indexLatest */ Double) => Unit,
      slideRenderer: /* render */ SlideRenderProps => ReactElement
    ): WithVirtualizeProps = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], onChangeIndex = js.Any.fromFunction2(onChangeIndex), slideRenderer = js.Any.fromFunction1(slideRenderer))
    ...
    implicit class WithVirtualizePropsMutableBuilder[Self <: WithVirtualizeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSlideRenderer(value: /* render */ SlideRenderProps => ReactElement): Self = StObject.set(x, "slideRenderer", js.Any.fromFunction1(value))
    }
  }
}
