...
object TextInputMaskProps {
  ...
  implicit class TextInputMaskPropsOps[Self <: TextInputMaskProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnChangeText(value: (/* formatted */ String, /* extracted */ js.UndefOr[String]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onChangeText")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMaskDefaultValue(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maskDefaultValue")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMaskDefaultValue: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maskDefaultValue")(js.undefined)
        ret
    }
    @scala.inline
