...
object ReactNativeTextInputMask {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def autoCapitalize(
      value: typingsSlinky.reactNativeTextInputMask.reactNativeTextInputMaskStrings.none | sentences | words | characters
    ): this.type = set("autoCapitalize", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def keyboardAppearance(value: typingsSlinky.reactNative.reactNativeStrings.default | light | dark): this.type = set("keyboardAppearance", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def maskDefaultValue(value: Boolean): this.type = set("maskDefaultValue", value.asInstanceOf[js.Any])
    @scala.inline
