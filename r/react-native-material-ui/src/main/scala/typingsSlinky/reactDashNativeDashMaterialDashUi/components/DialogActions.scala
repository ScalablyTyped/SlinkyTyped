...
object DialogActions
  ...
  typingsSlinky.reactDashNativeDashMaterialDashUi.reactDashNativeDashMaterialDashUiMod.Dialog.Actions](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
