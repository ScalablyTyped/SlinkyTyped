...
object Icon
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaterialUi.mod.Icon] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialUi.mod.Icon] = {
