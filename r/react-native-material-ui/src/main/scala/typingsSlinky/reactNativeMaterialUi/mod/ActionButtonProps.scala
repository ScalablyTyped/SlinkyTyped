...
object ActionButtonProps {
  ...
  implicit class ActionButtonPropsOps[Self <: ActionButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionsVarargs(value: (ReactElement | typingsSlinky.reactNativeMaterialUi.anon.Icon | String)*): Self = this.set("actions", js.Array(value :_*))
    @scala.inline
    def setActions(value: js.Array[ReactElement | typingsSlinky.reactNativeMaterialUi.anon.Icon | String]): Self = this.set("actions", value.asInstanceOf[js.Any])
    @scala.inline
