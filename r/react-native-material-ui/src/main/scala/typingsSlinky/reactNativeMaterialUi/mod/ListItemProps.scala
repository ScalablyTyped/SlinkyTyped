...
object ListItemProps {
  ...
  implicit class ListItemPropsMutableBuilder[Self <: ListItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCenterElement(value: ReactElement | String | ListItemCenterElement): Self = StObject.set(x, "centerElement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRightElement(value: ReactElement | String): Self = StObject.set(x, "rightElement", value.asInstanceOf[js.Any])
