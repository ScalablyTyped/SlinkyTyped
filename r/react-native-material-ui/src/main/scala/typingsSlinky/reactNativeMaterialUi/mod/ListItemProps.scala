...
object ListItemProps {
  ...
  implicit class ListItemPropsOps[Self <: ListItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCenterElement(value: ReactElement | String | ListItemCenterElement): Self = this.set("centerElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRightElement(value: ReactElement | String): Self = this.set("rightElement", value.asInstanceOf[js.Any])
    @scala.inline
