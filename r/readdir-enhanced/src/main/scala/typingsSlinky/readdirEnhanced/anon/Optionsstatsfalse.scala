...
import typingsSlinky.readdirEnhanced.readdirEnhancedBooleans.`false`
...
/* Inlined readdir-enhanced.readdir-enhanced/lib/types-public.Options & {  stats ? :false} */
@js.native
trait Optionsstatsfalse extends js.Object {
  ...
  /**
    ...
    * Defaults to `false`.
    */
  var stats: js.UndefOr[Boolean with `false`] = js.native
  /**
...
object Optionsstatsfalse {
  @scala.inline
  def apply(): Optionsstatsfalse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Optionsstatsfalse]
  }
  @scala.inline
  implicit class OptionsstatsfalseOps[Self <: Optionsstatsfalse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStats(value: Boolean with `false`): Self = {
        val ret = this.duplicate
