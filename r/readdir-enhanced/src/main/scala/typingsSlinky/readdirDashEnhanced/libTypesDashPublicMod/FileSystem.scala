package typingsSlinky.readdirDashEnhanced.libTypesDashPublicMod
...
trait FileSystem extends js.Object {
  /**
    ...
    */
  def lstat(path: String, callback: Callback[typingsSlinky.node.fsMod.Stats]): Unit
  /**
  ...
  /**
    ...
    */
  def stat(path: String, callback: Callback[typingsSlinky.node.fsMod.Stats]): Unit
}
