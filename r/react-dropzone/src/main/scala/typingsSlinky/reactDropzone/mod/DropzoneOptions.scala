...
trait DropzoneOptions extends js.Object {
  ...
  var onDropRejected: js.UndefOr[js.Function2[/* files */ js.Array[File], /* event */ DropEvent, Unit]] = js.native
...
object DropzoneOptions {
  ...
  implicit class DropzoneOptionsOps[Self <: DropzoneOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetFilesFromEvent(value: /* event */ DropEvent => js.Promise[js.Array[File | DataTransferItem]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnDropAccepted(value: (/* files */ js.Array[File], /* event */ DropEvent) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnDropRejected(value: (/* files */ js.Array[File], /* event */ DropEvent) => Unit): Self = {
        val ret = this.duplicate
