...
trait TypeofTransports extends js.Object {
  ...
  var FetchTransport: Instantiable0[typingsSlinky.sentryBrowser.mod.Transports.FetchTransport] = js.native
  
  var XHRTransport: Instantiable0[typingsSlinky.sentryBrowser.mod.Transports.XHRTransport] = js.native
}
