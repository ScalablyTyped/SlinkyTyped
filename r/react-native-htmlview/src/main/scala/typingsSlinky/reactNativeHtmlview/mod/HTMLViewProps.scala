...
object HTMLViewProps {
  ...
  implicit class HTMLViewPropsOps[Self <: HTMLViewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNodeComponentFunctionComponent(value: ReactComponentClass[js.Object]): Self = this.set("NodeComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setNodeComponentComponentClass(value: ReactComponentClass[js.Object]): Self = this.set("NodeComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setNodeComponent(value: ReactComponentClass[js.Object]): Self = this.set("NodeComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteNodeComponent: Self = this.set("NodeComponent", js.undefined)
    @scala.inline
    def setRootComponentFunctionComponent(value: ReactComponentClass[js.Object]): Self = this.set("RootComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setRootComponentComponentClass(value: ReactComponentClass[js.Object]): Self = this.set("RootComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setRootComponent(value: ReactComponentClass[js.Object]): Self = this.set("RootComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRootComponent: Self = this.set("RootComponent", js.undefined)
    @scala.inline
    def setTextComponentFunctionComponent(value: ReactComponentClass[js.Object]): Self = this.set("TextComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setTextComponentComponentClass(value: ReactComponentClass[js.Object]): Self = this.set("TextComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setTextComponent(value: ReactComponentClass[js.Object]): Self = this.set("TextComponent", value.asInstanceOf[js.Any])
    @scala.inline
