...
object checkoutMod {
  ...
  */
  ...
  object Adjustment {
    ...
    @scala.inline
    def ItemAdjustment(itemCode: String, quantity: Double): typingsSlinky.recurlyRecurlyJs.checkoutMod.ItemAdjustment = {
      val __obj = js.Dynamic.literal(itemCode = itemCode.asInstanceOf[js.Any], quantity = quantity.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.recurlyRecurlyJs.checkoutMod.ItemAdjustment]
    }
    
    @scala.inline
    def NonItemAdjustment(amount: Double, quantity: Double, taxCode: String, taxExempt: Boolean): typingsSlinky.recurlyRecurlyJs.checkoutMod.NonItemAdjustment = {
      ...
      __obj.asInstanceOf[typingsSlinky.recurlyRecurlyJs.checkoutMod.NonItemAdjustment]
    }
  }
