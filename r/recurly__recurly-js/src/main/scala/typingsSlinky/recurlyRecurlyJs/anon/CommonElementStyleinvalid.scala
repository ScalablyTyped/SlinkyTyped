...
/* Inlined @recurly/recurly-js.@recurly/recurly-js/lib/elements.CommonElementStyle & {  invalid ? :@recurly/recurly-js.@recurly/recurly-js/lib/elements.CommonElementStyle,   placeholder ? :{  color ? :string,   fontWeight ? :string,   content ? :{  number ? :string,   expiry ? :string,   cvv ? :string}}} */
@js.native
trait CommonElementStyleinvalid extends js.Object {
...
object CommonElementStyleinvalid {
  @scala.inline
  def apply(): CommonElementStyleinvalid = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommonElementStyleinvalid]
  }
  @scala.inline
  implicit class CommonElementStyleinvalidOps[Self <: CommonElementStyleinvalid] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPlaceholder(value: Color): Self = {
        val ret = this.duplicate
