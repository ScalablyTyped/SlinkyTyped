...
@js.native
trait CommonElementStyleinvalidFontColor extends StObject {
...
object CommonElementStyleinvalidFontColor {
  ...
  @scala.inline
  implicit class CommonElementStyleinvalidFontColorMutableBuilder[Self <: CommonElementStyleinvalidFontColor] (val x: Self) extends AnyVal {
