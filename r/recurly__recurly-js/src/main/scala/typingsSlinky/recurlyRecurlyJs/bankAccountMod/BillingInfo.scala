...
import typingsSlinky.recurlyRecurlyJs.recurlyRecurlyJsStrings.becs
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Rewritten from type alias, can be one of: 
  - typingsSlinky.recurlyRecurlyJs.bankAccountMod.SepaBillingInfo
  - typingsSlinky.recurlyRecurlyJs.bankAccountMod.BacsBillingInfo
  - typingsSlinky.recurlyRecurlyJs.bankAccountMod.BecsBillingInfo
  - typingsSlinky.recurlyRecurlyJs.bankAccountMod.BankAccountBillingInfo
*/
