package typingsSlinky.recurlyRecurlyJs.mod._Global_
...
object Window {
  ...
  implicit class WindowOps[Self <: Window] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRecurly(value: Recurly): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("recurly")(value.asInstanceOf[js.Any])
        ret
    }
  }
