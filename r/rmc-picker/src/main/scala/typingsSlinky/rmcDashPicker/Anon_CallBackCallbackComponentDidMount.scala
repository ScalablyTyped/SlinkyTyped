...
@js.native
trait Anon_CallBackCallbackComponentDidMount extends js.Object {
  ...
  var props: Anon_Children with IPopupPickerProps = js.native
  ...
  def getContent(): String | ReactElement | SFCElement[Anon_Picker] = js.native
