...
import typingsSlinky.rmcDashPicker.libNativePickerDotIosMod.default
...
object NativePickerDotIos
  ...
  typingsSlinky.rmcDashPicker.libNativePickerDotIosMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
