...
import typingsSlinky.rmcPicker.nativePickerIosMod.default
...
object NativePickerDotios {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onValueChange(value: (/* itemValue */ js.Any, /* itemPosition */ Double) => Unit): this.type = set("onValueChange", js.Any.fromFunction2(value))
    @scala.inline
  ...
  object Item {
    ...
    def withProps(p: PickerItemProps): typingsSlinky.rmcPicker.components.NativePickerDotios.Item.Builder = new typingsSlinky.rmcPicker.components.NativePickerDotios.Item.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    @scala.inline
    def apply(label: String): typingsSlinky.rmcPicker.components.NativePickerDotios.Item.Builder = {
        val __props = js.Dynamic.literal(label = label.asInstanceOf[js.Any])
        new typingsSlinky.rmcPicker.components.NativePickerDotios.Item.Builder(js.Array(this.component, __props.asInstanceOf[PickerItemProps]))
    }
  }
