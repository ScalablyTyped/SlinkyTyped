...
object FinalState {
  ...
  def apply[D](
    ...
    canNext: Boolean,
    canPrevious: Boolean,
    children: (FinalState[D], js.Function0[ReactElement], Instance[D]) => TagMod[Any],
    className: String,
