...
@js.native
trait PartialTableHeaderGroupPr extends StObject {
...
object PartialTableHeaderGroupPr {
  ...
  @scala.inline
  implicit class PartialTableHeaderGroupPrMutableBuilder[Self <: PartialTableHeaderGroupPr] (val x: Self) extends AnyVal {
