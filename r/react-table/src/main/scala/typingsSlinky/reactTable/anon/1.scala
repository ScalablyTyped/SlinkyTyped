...
trait `1`[D /* <: js.Object */] extends js.Object {
  var accessor: js.UndefOr[typingsSlinky.reactTable.mod.Accessor[D] | IdType[D]] = js.undefined
}

object `1` {
  @scala.inline
  def apply[D](accessor: typingsSlinky.reactTable.mod.Accessor[D] | IdType[D] = null): `1`[D] = {
