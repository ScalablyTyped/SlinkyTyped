...
trait Accessor[D /* <: js.Object */] extends js.Object {
  var accessor: js.UndefOr[typingsSlinky.reactTable.mod.Accessor[D]] = js.undefined
}

object Accessor {
  @scala.inline
  def apply[D](accessor: (D, /* index */ Double, /* sub */ Data[D]) => CellValue[js.Any] = null): Accessor[D] = {
