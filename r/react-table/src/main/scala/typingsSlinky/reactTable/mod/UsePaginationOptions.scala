...
object UsePaginationOptions {
  @scala.inline
  def apply[/* <: js.Object */ D](): UsePaginationOptions[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UsePaginationOptions[D]]
  }
  @scala.inline
  implicit class UsePaginationOptionsOps[Self <: UsePaginationOptions[_], /* <: js.Object */ D] (val x: Self with UsePaginationOptions[D]) extends AnyVal {
    @scala.inline
