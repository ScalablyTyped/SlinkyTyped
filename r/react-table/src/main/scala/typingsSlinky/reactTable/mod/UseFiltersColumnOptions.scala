...
object UseFiltersColumnOptions {
  ...
  implicit class UseFiltersColumnOptionsMutableBuilder[Self <: UseFiltersColumnOptions[_], D /* <: js.Object */] (val x: Self with UseFiltersColumnOptions[D]) extends AnyVal {
    ...
    @scala.inline
    def setFilterComponentClass(value: ReactComponentClass[FilterProps[D]]): Self = StObject.set(x, "Filter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFilterFunctionComponent(value: ReactComponentClass[FilterProps[D]]): Self = StObject.set(x, "Filter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFilterReactElement(value: ReactElement): Self = StObject.set(x, "Filter", value.asInstanceOf[js.Any])
