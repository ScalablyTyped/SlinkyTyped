...
object UseFiltersColumnOptions {
  ...
  implicit class UseFiltersColumnOptionsOps[Self <: UseFiltersColumnOptions[_], D /* <: js.Object */] (val x: Self with UseFiltersColumnOptions[D]) extends AnyVal {
    ...
    @scala.inline
    def setFilterReactElement(value: ReactElement): Self = this.set("Filter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFilterFunctionComponent(value: ReactComponentClass[FilterProps[D]]): Self = this.set("Filter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFilterComponentClass(value: ReactComponentClass[FilterProps[D]]): Self = this.set("Filter", value.asInstanceOf[js.Any])
