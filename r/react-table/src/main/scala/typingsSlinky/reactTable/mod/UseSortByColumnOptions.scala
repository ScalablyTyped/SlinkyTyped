...
object UseSortByColumnOptions {
  ...
  def apply[D](
    ...
    if (!js.isUndefined(sortDescFirst)) __obj.updateDynamic("sortDescFirst")(sortDescFirst.get.asInstanceOf[js.Any])
    if (!js.isUndefined(sortInverted)) __obj.updateDynamic("sortInverted")(sortInverted.get.asInstanceOf[js.Any])
