...
object UseSortByColumnOptions {
  @scala.inline
  def apply[/* <: js.Object */ D](): UseSortByColumnOptions[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UseSortByColumnOptions[D]]
  }
  @scala.inline
  implicit class UseSortByColumnOptionsOps[Self <: UseSortByColumnOptions[_], /* <: js.Object */ D] (val x: Self with UseSortByColumnOptions[D]) extends AnyVal {
    @scala.inline
