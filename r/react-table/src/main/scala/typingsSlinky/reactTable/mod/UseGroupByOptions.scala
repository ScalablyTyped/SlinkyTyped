...
object UseGroupByOptions {
  @scala.inline
  def apply[/* <: js.Object */ D](): UseGroupByOptions[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UseGroupByOptions[D]]
  }
  @scala.inline
  implicit class UseGroupByOptionsOps[Self <: UseGroupByOptions[_], /* <: js.Object */ D] (val x: Self with UseGroupByOptions[D]) extends AnyVal {
    @scala.inline
