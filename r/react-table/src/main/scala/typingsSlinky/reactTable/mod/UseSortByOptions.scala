...
object UseSortByOptions {
  ...
  @scala.inline
  implicit class UseSortByOptionsOps[Self <: UseSortByOptions[_], D /* <: js.Object */] (val x: Self with UseSortByOptions[D]) extends AnyVal {
    ...
    @scala.inline
    def setIsMultiSortEvent(value: /* e */ SyntheticMouseEvent[Element] => Boolean): Self = this.set("isMultiSortEvent", js.Any.fromFunction1(value))
