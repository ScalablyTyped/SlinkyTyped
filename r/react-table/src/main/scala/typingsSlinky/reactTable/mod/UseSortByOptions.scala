...
trait UseSortByOptions[D /* <: js.Object */] extends js.Object {
  ...
  var isMultiSortEvent: js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[Element], Boolean]] = js.undefined
...
object UseSortByOptions {
  ...
  def apply[D](
    ...
    isMultiSortEvent: /* e */ SyntheticMouseEvent[Element] => Boolean = null,
