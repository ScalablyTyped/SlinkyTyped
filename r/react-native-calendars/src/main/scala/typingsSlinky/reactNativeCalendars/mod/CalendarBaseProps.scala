...
object CalendarBaseProps {
  ...
  implicit class CalendarBasePropsOps[Self <: CalendarBaseProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentDate(value: js.Date): Self = this.set("current", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDayComponentFunctionComponent(value: ReactComponentClass[DayComponentProps]): Self = this.set("dayComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDayComponentComponent(value: ReactComponentClass[DayComponentProps]): Self = this.set("dayComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDayComponent(value: ReactComponentClass[DayComponentProps]): Self = this.set("dayComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderArrow(value: /* direction */ left | right => ReactElement): Self = this.set("renderArrow", js.Any.fromFunction1(value))
