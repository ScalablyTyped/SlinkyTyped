...
trait AgendaProps[TItem] extends js.Object {
  ...
  /**
    ...
    */
  var refreshControl: js.UndefOr[TagMod[Any]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var renderDay: js.UndefOr[js.Function2[/* date */ js.UndefOr[DateObject], /* item */ TItem, TagMod[Any]]] = js.undefined
  /**
    *  Specify what should be rendered instead of ActivityIndicator
    */
  var renderEmptyData: js.UndefOr[js.Function0[TagMod[Any]]] = js.undefined
  /**
    *  Specify how agenda knob should look like.
    */
  var renderKnob: js.UndefOr[js.Function0[TagMod[Any]]] = js.undefined
  /**
  ...
  /**
    ...
    */
  def renderEmptyDate(): TagMod[Any]
  /**
    *  Specify how each item should be rendered in agenda.
    */
  def renderItem(item: TItem, firstDayInDay: Boolean): TagMod[Any]
  /**
...
object AgendaProps {
  ...
  def apply[TItem](
    ...
    refreshControl: TagMod[Any] = null,
    refreshing: js.UndefOr[Boolean] = js.undefined,
    renderDay: (/* date */ js.UndefOr[DateObject], /* item */ TItem) => TagMod[Any] = null,
    renderEmptyData: () => TagMod[Any] = null,
    renderKnob: () => TagMod[Any] = null,
