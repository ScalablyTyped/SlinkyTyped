...
object AgendaProps {
  ...
  implicit class AgendaPropsOps[Self <: AgendaProps[_], TItem] (val x: Self with AgendaProps[TItem]) extends AnyVal {
    ...
    @scala.inline
    def setRenderEmptyDate(value: () => ReactElement): Self = this.set("renderEmptyDate", js.Any.fromFunction0(value))
    
    @scala.inline
    def setRenderItem(value: (TItem, Boolean) => ReactElement): Self = this.set("renderItem", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setRefreshControlReactElement(value: ReactElement): Self = this.set("refreshControl", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderDay(value: (/* date */ js.UndefOr[DateObject], /* item */ TItem) => ReactElement): Self = this.set("renderDay", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteRenderDay: Self = this.set("renderDay", js.undefined)
    
    @scala.inline
    def setRenderEmptyData(value: () => ReactElement): Self = this.set("renderEmptyData", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteRenderEmptyData: Self = this.set("renderEmptyData", js.undefined)
    
    @scala.inline
    def setRenderKnob(value: () => ReactElement): Self = this.set("renderKnob", js.Any.fromFunction0(value))
