...
import typingsSlinky.reactDashNativeDashCalendars.reactDashNativeDashCalendarsStrings.left
import typingsSlinky.reactDashNativeDashCalendars.reactDashNativeDashCalendarsStrings.right
...
object CalendarListBaseProps {
  ...
  def apply(
    ...
    dayComponent: ReactComponentClass[DayComponentProps] = null,
    ...
    renderArrow: /* direction */ left | right => TagMod[Any] = null,
