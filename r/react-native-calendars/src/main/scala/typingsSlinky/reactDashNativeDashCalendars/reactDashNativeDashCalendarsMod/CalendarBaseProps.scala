...
trait CalendarBaseProps extends js.Object {
  ...
  /**
    ...
    */
  var dayComponent: js.UndefOr[ReactComponentClass[DayComponentProps]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var renderArrow: js.UndefOr[js.Function1[/* direction */ left | right, TagMod[Any]]] = js.undefined
  /**
