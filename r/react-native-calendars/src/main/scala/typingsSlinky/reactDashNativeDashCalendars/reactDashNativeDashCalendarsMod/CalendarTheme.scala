...
object CalendarTheme {
  ...
  def apply(
    ...
    if (`stylesheet.agenda.list` != null) __obj.updateDynamic("stylesheet.agenda.list")(`stylesheet.agenda.list`.asInstanceOf[js.Any])
    if (`stylesheet.agenda.main` != null) __obj.updateDynamic("stylesheet.agenda.main")(`stylesheet.agenda.main`.asInstanceOf[js.Any])
    if (`stylesheet.calendar-list.main` != null) __obj.updateDynamic("stylesheet.calendar-list.main")(`stylesheet.calendar-list.main`.asInstanceOf[js.Any])
    if (`stylesheet.calendar.header` != null) __obj.updateDynamic("stylesheet.calendar.header")(`stylesheet.calendar.header`.asInstanceOf[js.Any])
    if (`stylesheet.calendar.main` != null) __obj.updateDynamic("stylesheet.calendar.main")(`stylesheet.calendar.main`.asInstanceOf[js.Any])
    if (`stylesheet.day.basic` != null) __obj.updateDynamic("stylesheet.day.basic")(`stylesheet.day.basic`.asInstanceOf[js.Any])
    if (`stylesheet.day.multiDot` != null) __obj.updateDynamic("stylesheet.day.multiDot")(`stylesheet.day.multiDot`.asInstanceOf[js.Any])
    if (`stylesheet.day.period` != null) __obj.updateDynamic("stylesheet.day.period")(`stylesheet.day.period`.asInstanceOf[js.Any])
    if (`stylesheet.day.single` != null) __obj.updateDynamic("stylesheet.day.single")(`stylesheet.day.single`.asInstanceOf[js.Any])
