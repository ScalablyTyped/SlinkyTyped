...
import typingsSlinky.reactDashNativeDashCalendars.reactDashNativeDashCalendarsMod.CalendarListBaseProps
...
object CalendarList
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashCalendars.reactDashNativeDashCalendarsMod.CalendarList
    ] {
