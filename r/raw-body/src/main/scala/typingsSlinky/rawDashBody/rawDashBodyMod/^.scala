package typingsSlinky.rawDashBody.rawDashBodyMod

import typingsSlinky.node.Buffer
import typingsSlinky.node.streamMod.Readable
import typingsSlinky.rawDashBody.Anon_Encoding
...
object ^ extends js.Object {
  ...
  def apply(stream: Readable, options: (Options with Anon_Encoding) | Encoding | Options): js.Promise[String] = js.native
  def apply(
    stream: Readable,
    options: (Options with Anon_Encoding) | Encoding | Options,
