...
object mod {
  ...
  object BaseProps {
    ...
    implicit class BasePropsMutableBuilder[Self <: BaseProps[_], T] (val x: Self with BaseProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setOnHighlightDate(value: /* date */ js.Date => Unit): Self = StObject.set(x, "onHighlightDate", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnHighlightDateUndefined: Self = StObject.set(x, "onHighlightDate", js.undefined)
      
      @scala.inline
      def setOnHighlightRange(value: /* date */ js.Date => Unit): Self = StObject.set(x, "onHighlightRange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setPaginationArrowComponent(value: ReactComponentClass[PaginationArrowProps[js.Object]]): Self = StObject.set(x, "paginationArrowComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPaginationArrowComponentComponentClass(value: ReactComponentClass[PaginationArrowProps[js.Object]]): Self = StObject.set(x, "paginationArrowComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPaginationArrowComponentFunctionComponent(value: ReactComponentClass[PaginationArrowProps[js.Object]]): Self = StObject.set(x, "paginationArrowComponent", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object Props {
    ...
    @scala.inline
    def RangeProps[T](): typingsSlinky.reactDaterangePicker.mod.RangeProps[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.reactDaterangePicker.mod.RangeProps[T]]
    }
    
    @scala.inline
    def SingleProps[T](): typingsSlinky.reactDaterangePicker.mod.SingleProps[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.reactDaterangePicker.mod.SingleProps[T]]
    }
  }
