...
object BaseProps {
  ...
  implicit class BasePropsOps[Self <: BaseProps[_], T] (val x: Self with BaseProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnHighlightDate(value: /* date */ js.Date => Unit): Self = this.set("onHighlightDate", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnHighlightDate: Self = this.set("onHighlightDate", js.undefined)
    
    @scala.inline
    def setOnHighlightRange(value: /* date */ js.Date => Unit): Self = this.set("onHighlightRange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPaginationArrowComponentFunctionComponent(value: ReactComponentClass[PaginationArrowProps[js.Object]]): Self = this.set("paginationArrowComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaginationArrowComponentComponentClass(value: ReactComponentClass[PaginationArrowProps[js.Object]]): Self = this.set("paginationArrowComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaginationArrowComponent(value: ReactComponentClass[PaginationArrowProps[js.Object]]): Self = this.set("paginationArrowComponent", value.asInstanceOf[js.Any])
