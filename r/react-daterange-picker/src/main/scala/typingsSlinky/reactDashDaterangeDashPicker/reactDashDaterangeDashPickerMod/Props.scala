...
import typingsSlinky.momentDashRange.momentDashRangeMod.DateRange
...
trait Props[T]
  ...
  var paginationArrowComponent: js.UndefOr[ReactComponentClass[PaginationArrowProps[js.Object]]] = js.undefined
