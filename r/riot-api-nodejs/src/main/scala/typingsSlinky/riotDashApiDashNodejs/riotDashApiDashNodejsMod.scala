...
import typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.API
import typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Champion.ChampionDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Champion.ChampionListDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.ChampionMastery.ChampionMasteryDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.CurrentGame.CurrentGameInfo
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.FeaturedGames.FeaturedGames
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Game.RecentGamesDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.League.LeagueDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.ItemDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.ItemListDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.LanguageStringsDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.MapDataDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.MasteryDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.MasteryListDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.RealmDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.RuneDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.RuneListDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.SummonerSpellDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.SummonerSpellListDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStatus.Shard
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Match.MatchDetail
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.MatchList.MatchList
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Stats.PlayerStatsSummaryListDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Stats.RankedStatsDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Summoner.MasteryPagesDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Summoner.RunePagesDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Summoner.SummonerDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.Team.TeamDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.TournamentProvider.LobbyEventDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.TournamentProvider.TournamentCodeDto
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.TournamentProvider.TournamentCodeParameters
import typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.TournamentProvider.TournamentCodeUpdateParameters
...
object riotDashApiDashNodejsMod extends js.Object {
  ...
  class ClassicAPI protected () extends API {
    ...
    /**
      ...
      */
    def staticDataChampionById(championsId: Double): js.Promise[typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.ChampionDto] = js.native
    /**
      * get Champions (static data)
      * @param     {RiotGamesAPI.LolStaticData.ChampionListDto}    callback    data callback
      */
    def staticDataChampions(): js.Promise[typingsSlinky.riotDashGamesDashApi.RiotGamesAPI.LolStaticData.ChampionListDto] = js.native
    /**
  ...
  object region_e extends js.Object {
    ...
    /* 0 */ val BR: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.BR with Double = js.native
    /* 1 */ val EUNE: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.EUNE with Double = js.native
    /* 2 */ val EUW: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.EUW with Double = js.native
    /* 3 */ val KR: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.KR with Double = js.native
    /* 4 */ val LAN: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.LAN with Double = js.native
    /* 5 */ val LAS: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.LAS with Double = js.native
    /* 6 */ val NA: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.NA with Double = js.native
    /* 7 */ val OCE: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.OCE with Double = js.native
    /* 10 */ val PBE: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.PBE with Double = js.native
    /* 9 */ val RU: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.RU with Double = js.native
    /* 8 */ val TR: typingsSlinky.riotDashApiDashNodejs.riotDashApiDashNodejsMod.region_e.TR with Double = js.native
    @JSBracketAccess
