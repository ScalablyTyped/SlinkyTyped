...
@scala.inline
class SharedBuilder_MorphReplaceProps1929517191[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def easing(value: /* props */ js.Any => Double): this.type = set("easing", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def rotation(value: String): this.type = set("rotation", value.asInstanceOf[js.Any])
