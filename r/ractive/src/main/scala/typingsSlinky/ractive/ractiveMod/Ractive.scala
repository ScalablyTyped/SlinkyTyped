...
class Ractive[T /* <: Ractive[T] */] () extends js.Object {
  ...
  def transition(transition: String, node: typingsSlinky.std.HTMLElement, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
  ...
  def transition(transition: Transition, node: typingsSlinky.std.HTMLElement, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
