...
object BaseInitOpts {
  @scala.inline
  def apply[/* <: typingsSlinky.ractive.mod.Ractive[T] */ T](): BaseInitOpts[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BaseInitOpts[T]]
  }
  @scala.inline
  implicit class BaseInitOptsOps[Self <: BaseInitOpts[_], /* <: typingsSlinky.ractive.mod.Ractive[T] */ T] (val x: Self with BaseInitOpts[T]) extends AnyVal {
    @scala.inline
