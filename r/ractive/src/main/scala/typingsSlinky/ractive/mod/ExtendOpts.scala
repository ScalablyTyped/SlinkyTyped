...
object ExtendOpts {
  @scala.inline
  def apply[/* <: typingsSlinky.ractive.mod.Ractive[T] */ T](): ExtendOpts[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExtendOpts[T]]
  }
  @scala.inline
  implicit class ExtendOptsOps[Self <: ExtendOpts[_], /* <: typingsSlinky.ractive.mod.Ractive[T] */ T] (val x: Self with ExtendOpts[T]) extends AnyVal {
    @scala.inline
