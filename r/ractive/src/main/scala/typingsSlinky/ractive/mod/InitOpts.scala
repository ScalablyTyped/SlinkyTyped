...
object InitOpts {
  @scala.inline
  def apply[/* <: typingsSlinky.ractive.mod.Ractive[T] */ T](): InitOpts[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InitOpts[T]]
  }
  @scala.inline
  implicit class InitOptsOps[Self <: InitOpts[_], /* <: typingsSlinky.ractive.mod.Ractive[T] */ T] (val x: Self with InitOpts[T]) extends AnyVal {
    @scala.inline
