...
object Registries {
  @scala.inline
  def apply[/* <: typingsSlinky.ractive.mod.Ractive[T] */ T](
  ...
  @scala.inline
  implicit class RegistriesOps[Self <: Registries[_], /* <: typingsSlinky.ractive.mod.Ractive[T] */ T] (val x: Self with Registries[T]) extends AnyVal {
    @scala.inline
