package typingsSlinky.reactDashIconDashBase.components
...
import typingsSlinky.reactDashIconDashBase.reactDashIconDashBaseMod.IconBaseProps
import typingsSlinky.reactDashIconDashBase.reactDashIconDashBaseMod.default
...
object ReactDashIconDashBase
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[ReactSVGElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with ReactSVGElement, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with ReactSVGElement, Event] => Unit = null,
  ...
  typingsSlinky.reactDashIconDashBase.reactDashIconDashBaseMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
