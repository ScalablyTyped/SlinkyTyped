...
object ReactImageGalleryProps {
  ...
  implicit class ReactImageGalleryPropsOps[Self <: ReactImageGalleryProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderCustomControls(value: () => ReactElement): Self = this.set("renderCustomControls", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteRenderCustomControls: Self = this.set("renderCustomControls", js.undefined)
    
    @scala.inline
    def setRenderFullscreenButton(value: (/* onClick */ MouseEventHandler[HTMLElement], /* isFullscreen */ Boolean) => ReactElement): Self = this.set("renderFullscreenButton", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteRenderFullscreenButton: Self = this.set("renderFullscreenButton", js.undefined)
    
    @scala.inline
    def setRenderItem(value: /* item */ ReactImageGalleryItem => ReactElement): Self = this.set("renderItem", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderPlayPauseButton(value: (/* onClick */ MouseEventHandler[HTMLElement], /* isPlaying */ Boolean) => ReactElement): Self = this.set("renderPlayPauseButton", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setRenderThumbInner(value: /* item */ ReactImageGalleryItem => ReactElement): Self = this.set("renderThumbInner", js.Any.fromFunction1(value))
