...
object ReactSortableTreeProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(isVirtualized)) __obj.updateDynamic("isVirtualized")(isVirtualized.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(onlyExpandSearchedNodes)) __obj.updateDynamic("onlyExpandSearchedNodes")(onlyExpandSearchedNodes.get.asInstanceOf[js.Any])
