...
object NodeRendererProps {
  ...
  implicit class NodeRendererPropsMutableBuilder[Self <: NodeRendererProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtons(value: js.Array[ReactElement]): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setButtonsUndefined: Self = StObject.set(x, "buttons", js.undefined)
    
    @scala.inline
    def setButtonsVarargs(value: ReactElement*): Self = StObject.set(x, "buttons", js.Array(value :_*))
    ...
    @scala.inline
    def setIcons(value: js.Array[ReactElement]): Self = StObject.set(x, "icons", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIconsUndefined: Self = StObject.set(x, "icons", js.undefined)
    
    @scala.inline
    def setIconsVarargs(value: ReactElement*): Self = StObject.set(x, "icons", js.Array(value :_*))
    ...
    @scala.inline
    def setSubtitle(value: /* data */ NodeData => ReactElement): Self = StObject.set(x, "subtitle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTitle(value: /* data */ NodeData => ReactElement): Self = StObject.set(x, "title", js.Any.fromFunction1(value))
