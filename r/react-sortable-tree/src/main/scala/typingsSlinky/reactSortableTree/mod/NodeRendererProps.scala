...
object NodeRendererProps {
  ...
  implicit class NodeRendererPropsOps[Self <: NodeRendererProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonsVarargs(value: ReactElement*): Self = this.set("buttons", js.Array(value :_*))
    
    @scala.inline
    def setButtons(value: js.Array[ReactElement]): Self = this.set("buttons", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIconsVarargs(value: ReactElement*): Self = this.set("icons", js.Array(value :_*))
    
    @scala.inline
    def setIcons(value: js.Array[ReactElement]): Self = this.set("icons", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSubtitle(value: /* data */ NodeData => ReactElement): Self = this.set("subtitle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTitle(value: /* data */ NodeData => ReactElement): Self = this.set("title", js.Any.fromFunction1(value))
