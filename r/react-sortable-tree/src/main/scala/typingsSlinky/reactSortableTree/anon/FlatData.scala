...
object FlatData {
  @scala.inline
  def apply[T, I, K, P](flatData: NumberDictionary[T] | StringDictionary[T]): FlatData[T, I, K, P] = {
    val __obj = js.Dynamic.literal(flatData = flatData.asInstanceOf[js.Any])
    __obj.asInstanceOf[FlatData[T, I, K, P]]
  }
  @scala.inline
  implicit class FlatDataOps[Self[t, i, k, p] <: FlatData[t, i, k, p], T, I, K, P] (val x: Self[T, I, K, P]) extends AnyVal {
    @scala.inline
