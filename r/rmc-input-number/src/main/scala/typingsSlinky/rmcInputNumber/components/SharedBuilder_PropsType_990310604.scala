...
@scala.inline
class SharedBuilder_PropsType_990310604[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def downStyle(value: js.Any): this.type = set("downStyle", value.asInstanceOf[js.Any])
  @scala.inline
  def inputStyle(value: js.Any): this.type = set("inputStyle", value.asInstanceOf[js.Any])
  @scala.inline
  def keyboardType(value: js.Any): this.type = set("keyboardType", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def upStyle(value: js.Any): this.type = set("upStyle", value.asInstanceOf[js.Any])
  @scala.inline
