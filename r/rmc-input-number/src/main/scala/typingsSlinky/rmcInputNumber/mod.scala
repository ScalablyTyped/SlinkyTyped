...
import typingsSlinky.rmcInputNumber.anon.FocusOnUpDown
...
object mod {
  ...
  object PropsType {
    ...
    implicit class PropsTypeMutableBuilder[Self <: PropsType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDownHandlerReactElement(value: ReactElement): Self = StObject.set(x, "downHandler", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setUpHandlerReactElement(value: ReactElement): Self = StObject.set(x, "upHandler", value.asInstanceOf[js.Any])
