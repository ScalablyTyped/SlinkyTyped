...
object PropsType {
  ...
  implicit class PropsTypeOps[Self <: PropsType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDownHandlerReactElement(value: ReactElement): Self = this.set("downHandler", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUpHandlerReactElement(value: ReactElement): Self = this.set("upHandler", value.asInstanceOf[js.Any])
