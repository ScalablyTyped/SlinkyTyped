...
object PersistGate
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reduxPersist.integrationReactMod.PersistGate] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reduxPersist.integrationReactMod.PersistGate] = {
