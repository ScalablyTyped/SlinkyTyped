...
object typesMod {
  ...
  object PersistConfig {
    ...
    implicit class PersistConfigMutableBuilder[Self <: PersistConfig[_, _, _, _], S, RS, HSS, ESS] (val x: Self with (PersistConfig[S, RS, HSS, ESS])) extends AnyVal {
      ...
      @scala.inline
      def setWriteFailHandler(value: /* err */ js.Error => Unit): Self = StObject.set(x, "writeFailHandler", js.Any.fromFunction1(value))
  ...
  */
  ...
  object PersistorAction {
    ...
    @scala.inline
    def RegisterAction(key: String, `type`: persistSlashREGISTER): typingsSlinky.reduxPersist.typesMod.RegisterAction = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reduxPersist.typesMod.RegisterAction]
    }
    
    @scala.inline
    def RehydrateAction(key: String, `type`: persistSlashREHYDRATE): typingsSlinky.reduxPersist.typesMod.RehydrateAction = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reduxPersist.typesMod.RehydrateAction]
    }
  }
