...
import typingsSlinky.monacoDashEditor.monacoDashEditorMod.CancellationTokenSource
import typingsSlinky.monacoDashEditor.monacoDashEditorMod.Emitter
...
trait TypeofmonacoEditor extends js.Object {
  var CancellationTokenSource: Instantiable0[typingsSlinky.monacoDashEditor.monacoDashEditorMod.CancellationTokenSource]
  var Emitter: Instantiable0[typingsSlinky.monacoDashEditor.monacoDashEditorMod.Emitter[js.Object]]
  ...
  var Token: Instantiable3[
    ...
    /* type */ String, 
    /* language */ String, 
    typingsSlinky.monacoDashEditor.monacoDashEditorMod.Token
  ]
