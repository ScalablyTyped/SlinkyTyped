...
import typingsSlinky.monacoEditor.mod.languages.html.LanguageServiceDefaults
...
object Typeofhtml {
  ...
  implicit class TypeofhtmlOps[Self <: Typeofhtml] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHandlebarDefaults(value: LanguageServiceDefaults): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handlebarDefaults")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHtmlDefaults(value: LanguageServiceDefaults): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("htmlDefaults")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRazorDefaults(value: LanguageServiceDefaults): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("razorDefaults")(value.asInstanceOf[js.Any])
        ret
    }
  }
