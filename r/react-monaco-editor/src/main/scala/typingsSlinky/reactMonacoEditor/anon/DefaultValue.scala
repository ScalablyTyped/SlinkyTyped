...
trait DefaultValue extends js.Object {
  ...
  var original: Requireable[String] = js.native
...
object DefaultValue {
  ...
  def apply(
    ...
    original: Requireable[String],
    overrideServices: Requireable[js.Object],
    theme: Requireable[String],
    value: Requireable[String],
    width: Requireable[String | Double]
  ): DefaultValue = {
    val __obj = js.Dynamic.literal(defaultValue = defaultValue.asInstanceOf[js.Any], editorDidMount = editorDidMount.asInstanceOf[js.Any], editorWillMount = editorWillMount.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], language = language.asInstanceOf[js.Any], onChange = onChange.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], original = original.asInstanceOf[js.Any], overrideServices = overrideServices.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
  ...
  implicit class DefaultValueOps[Self <: DefaultValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginal(value: Requireable[String]): Self = this.set("original", value.asInstanceOf[js.Any])
    @scala.inline
