...
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKTextFieldProperties
...
object MKTextField
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKTextField
    ] {
  @JSImport("react-native-material-kit", "MKTextField")
  @js.native
  ...
  def apply(
    ...
    if (!js.isUndefined(underlineEnabled)) __obj.updateDynamic("underlineEnabled")(underlineEnabled.asInstanceOf[js.Any])
  ...
  typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKTextField](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MKTextFieldProperties
}
