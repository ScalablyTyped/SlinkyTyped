package typingsSlinky.reactDashNativeDashMaterialDashKit.components
...
import typingsSlinky.reactDashNativeDashMaterialDashKit.Anon_Checked
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKPropTypes.rippleLocation
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKRadioButtonGroup
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKRadioButtonProperties
...
object MKRadioButton
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKRadioButton
    ] {
  ...
  /* The following DOM/SVG props were specified: checked, disabled, onBlur, onFocus, onTouchCancel, onTouchEnd, onTouchMove, onTouchStart */
  def apply(
  ...
  typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKRadioButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MKRadioButtonProperties
}
