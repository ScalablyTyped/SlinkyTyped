...
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKSwitchProperties
...
object MKSwitch
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKSwitch
    ] {
  ...
  /* The following DOM/SVG props were specified: checked, disabled, onBlur, onFocus */
  def apply(
  ...
  typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKSwitch](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
