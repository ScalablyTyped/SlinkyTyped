...
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKButtonProperties
...
object MKButton
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKButton
    ] {
  ...
  /* The following DOM/SVG props were specified: disabled, onBlur, onFocus, onTouchCancel, onTouchEnd, onTouchMove, onTouchStart */
  def apply(
