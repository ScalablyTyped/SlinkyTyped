...
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKSpinnerProperties
...
object MKSpinner
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKSpinner
    ] {
  ...
  typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKSpinner](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MKSpinnerProperties
}
