...
import typingsSlinky.reactDashNativeDashMaterialDashKit.Anon_Max
import typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKRangeSliderProperties
...
object MKRangeSlider
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKRangeSlider
    ] {
  ...
  def apply(
    ...
    onConfirm: /* curValue */ Anon_Max => Unit = null,
  ...
  typingsSlinky.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.MKRangeSlider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MKRangeSliderProperties
}
