...
trait MKRangeSliderProperties extends BaseSlider {
  ...
  var onChange: js.UndefOr[js.Function1[/* curValue */ Anon_Max, Unit]] = js.undefined
  var onConfirm: js.UndefOr[js.Function1[/* curValue */ Anon_Max, Unit]] = js.undefined
...
object MKRangeSliderProperties {
  ...
  def apply(
    ...
    onChange: /* curValue */ Anon_Max => Unit = null,
