...
object MKSpinnerProperties {
  ...
  def apply(
    ...
    spinnerAniDuration: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(spinnerAniDuration)) __obj.updateDynamic("spinnerAniDuration")(spinnerAniDuration.get.asInstanceOf[js.Any])
