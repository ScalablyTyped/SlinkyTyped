...
object MKCheckboxProperties {
  ...
  @scala.inline
  implicit class MKCheckboxPropertiesOps[Self <: MKCheckboxProperties] (val x: Self) extends AnyVal {
    @scala.inline
