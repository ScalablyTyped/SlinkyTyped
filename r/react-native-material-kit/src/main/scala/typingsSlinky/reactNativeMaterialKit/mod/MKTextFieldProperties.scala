...
- typingsSlinky.reactNativeMaterialKit.mod.FloatingLabelProperties because var conflicts: allowFontScaling. Inlined floatingLabelEnabled, floatingLabelAniDuration, floatingLabelBottomMargin, floatingLabelFont */ trait MKTextFieldProperties extends TextInputProps {
...
object MKTextFieldProperties {
  ...
  def apply(
    ...
    underlineSize: js.UndefOr[Double] = js.undefined,
    value: String = null
    ...
    if (!js.isUndefined(underlineEnabled)) __obj.updateDynamic("underlineEnabled")(underlineEnabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(underlineSize)) __obj.updateDynamic("underlineSize")(underlineSize.get.asInstanceOf[js.Any])
