...
import typingsSlinky.reactNativeMaterialKit.mod.MKSliderProperties
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object MKSlider {
  @JSImport("react-native-material-kit", "MKSlider")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKSlider] {
    @scala.inline
    ...
    @scala.inline
    def lowerTrackColor(value: String): this.type = set("lowerTrackColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onConfirm(value: () => Unit): this.type = set("onConfirm", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def thumbPadding(value: Double): this.type = set("thumbPadding", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def upperTrackColor(value: String): this.type = set("upperTrackColor", value.asInstanceOf[js.Any])
    @scala.inline
    def value(value: Double): this.type = set("value", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: MKSliderProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MKSlider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
