...
object MKProgress
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKProgress] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKProgress] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKProgress] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKProgress](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
