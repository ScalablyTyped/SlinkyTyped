...
import typingsSlinky.reactNativeMaterialKit.mod.MKProgressProperties
...
object MKProgress {
  ...
  object Indeterminate {
    ...
    class Builder (val args: js.Array[js.Any])
      extends AnyVal
         with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKProgress.Indeterminate] {
    ...
    implicit def make(companion: Indeterminate.type): typingsSlinky.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder = new typingsSlinky.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: IndeterminateProgressProperties): typingsSlinky.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder = new typingsSlinky.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKProgress] {
    ...
    @scala.inline
    def bufferAniDuration(value: Double): this.type = set("bufferAniDuration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def bufferColor(value: String): this.type = set("bufferColor", value.asInstanceOf[js.Any])
