...
object MKProgressIndeterminate {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, Indeterminate] {
    @scala.inline
    ...
    @scala.inline
    def progressAniDuration(value: Double): this.type = set("progressAniDuration", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IndeterminateProgressProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MKProgressIndeterminate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
