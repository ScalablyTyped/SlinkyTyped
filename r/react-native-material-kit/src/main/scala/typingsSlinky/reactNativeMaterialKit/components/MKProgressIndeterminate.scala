...
import typingsSlinky.reactNativeMaterialKit.mod.IndeterminateProgressProperties
import typingsSlinky.reactNativeMaterialKit.mod.MKProgress.Indeterminate
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object MKProgressIndeterminate
  extends ExternalComponentWithAttributesWithRefType[tag.type, Indeterminate] {
  ...
  ): BuildingComponent[tag.type, Indeterminate] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Indeterminate] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeMaterialKit.mod.MKProgress.Indeterminate](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IndeterminateProgressProperties
}
