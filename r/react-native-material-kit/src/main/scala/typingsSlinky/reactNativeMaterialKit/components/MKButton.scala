...
import typingsSlinky.reactNativeMaterialKit.mod.MKButtonProperties
...
object MKButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKButton] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKButton] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
