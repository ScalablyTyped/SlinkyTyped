...
object MKCheckbox {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKCheckbox] {
    @scala.inline
    ...
    @scala.inline
    def inset(value: Double): this.type = set("inset", value.asInstanceOf[js.Any])
    @scala.inline
