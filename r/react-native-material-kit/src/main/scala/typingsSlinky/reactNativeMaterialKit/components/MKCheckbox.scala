...
import typingsSlinky.reactNativeMaterialKit.mod.MKCheckboxProperties
...
object MKCheckbox
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKCheckbox] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKCheckbox] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKCheckbox] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKCheckbox](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MKCheckboxProperties
}
