...
object MKRipple {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKRipple] {
    @scala.inline
  ...
  def withProps(p: MKRippleProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MKRipple.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
