...
object MKRadioButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKRadioButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKRadioButton] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKRadioButton] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeMaterialKit.mod.MKRadioButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
