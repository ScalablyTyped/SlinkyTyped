...
object MKRadioButton {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKRadioButton] {
    @scala.inline
    ...
    @scala.inline
    def borderOffColor(value: String): this.type = set("borderOffColor", value.asInstanceOf[js.Any])
    @scala.inline
    def borderOnColor(value: String): this.type = set("borderOnColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def extraRippleRadius(value: Double): this.type = set("extraRippleRadius", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def group(value: MKRadioButtonGroup): this.type = set("group", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: MKRadioButtonProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MKRadioButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
