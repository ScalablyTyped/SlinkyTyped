...
object MKSpinner {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKSpinner] {
    @scala.inline
    ...
    @scala.inline
    def spinnerAniDuration(value: Double): this.type = set("spinnerAniDuration", value.asInstanceOf[js.Any])
    @scala.inline
