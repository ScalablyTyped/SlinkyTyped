...
import typingsSlinky.reactNativeMaterialKit.mod.MKSwitchProperties
...
object MKSwitch {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def offColor(value: String): this.type = set("offColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onColor(value: String): this.type = set("onColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def rippleAniDuration(value: Double): this.type = set("rippleAniDuration", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def thumbAniDuration(value: Double): this.type = set("thumbAniDuration", value.asInstanceOf[js.Any])
    @scala.inline
    def thumbOffColor(value: String): this.type = set("thumbOffColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def trackSize(value: Double): this.type = set("trackSize", value.asInstanceOf[js.Any])
    @scala.inline
    def tvParallaxProperties(value: TVParallaxProperties): this.type = set("tvParallaxProperties", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: MKSwitchProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MKSwitch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
