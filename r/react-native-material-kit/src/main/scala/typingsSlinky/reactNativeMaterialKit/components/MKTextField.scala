...
import typingsSlinky.reactNativeMaterialKit.mod.MKTextFieldProperties
...
object MKTextField {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKTextField] {
    ...
    @scala.inline
    def additionalInputProps(value: TextInputProps): this.type = set("additionalInputProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def floatingLabelAniDuration(value: Double): this.type = set("floatingLabelAniDuration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def floatingLabelBottomMargin(value: Double): this.type = set("floatingLabelBottomMargin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def floatingLabelEnabled(value: Boolean): this.type = set("floatingLabelEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def floatingLabelFont(value: font): this.type = set("floatingLabelFont", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onTextChange(value: /* val */ String => Unit): this.type = set("onTextChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def password(value: Boolean): this.type = set("password", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def textInputStyle(value: TextStyle): this.type = set("textInputStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def underlineEnabled(value: Boolean): this.type = set("underlineEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def underlineSize(value: Double): this.type = set("underlineSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def value(value: String): this.type = set("value", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: MKTextField.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MKTextFieldProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
