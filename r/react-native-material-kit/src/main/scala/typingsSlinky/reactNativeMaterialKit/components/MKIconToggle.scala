...
import typingsSlinky.reactNativeMaterialKit.mod.MKIconToggleProperties
...
object MKIconToggle {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKIconToggle] {
    @scala.inline
    ...
    @scala.inline
    def maskBorderRadius(value: Double): this.type = set("maskBorderRadius", value.asInstanceOf[js.Any])
    @scala.inline
    def maskBorderRadiusInPercent(value: Double): this.type = set("maskBorderRadiusInPercent", value.asInstanceOf[js.Any])
    @scala.inline
    def maskColor(value: String): this.type = set("maskColor", value.asInstanceOf[js.Any])
    @scala.inline
    def maskDuration(value: Double): this.type = set("maskDuration", value.asInstanceOf[js.Any])
    @scala.inline
    def maskEnabled(value: Boolean): this.type = set("maskEnabled", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onCheckedChange(value: /* checked */ Boolean => Unit): this.type = set("onCheckedChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def rippleLocation(value: typingsSlinky.reactNativeMaterialKit.mod.MKPropTypes.rippleLocation): this.type = set("rippleLocation", value.asInstanceOf[js.Any])
    @scala.inline
    def shadowAniEnabled(value: Boolean): this.type = set("shadowAniEnabled", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: MKIconToggleProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MKIconToggle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
