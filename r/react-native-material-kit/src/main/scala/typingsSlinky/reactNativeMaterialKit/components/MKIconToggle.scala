...
object MKIconToggle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKIconToggle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKIconToggle] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeMaterialKit.mod.MKIconToggle] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeMaterialKit.mod.MKIconToggle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
