...
import typingsSlinky.ravenDashJs.Anon_Request
import typingsSlinky.ravenDashJs.Anon_Sentryclient
...
trait RavenTransportOptions extends js.Object {
  ...
  var data: js.Any
  var url: String
  def onError(error: js.Error with Anon_Request): Unit
  def onSuccess(): Unit
}
...
object RavenTransportOptions {
  ...
  def apply(
    ...
    data: js.Any,
    onError: js.Error with Anon_Request => Unit,
    onSuccess: () => Unit,
    url: String
