package typingsSlinky.ravenDashJs.ravenDashJsMod
...
object RavenOptions {
  ...
  def apply(
    ...
    ignoreErrors: js.Array[js.RegExp | String] = null,
    ignoreUrls: js.Array[js.RegExp | String] = null,
    includePaths: js.Array[js.RegExp | String] = null,
    ...
    sanitizeKeys: js.Array[js.RegExp | String] = null,
    ...
    whitelistUrls: js.Array[js.RegExp | String] = null
  ): RavenOptions = {
