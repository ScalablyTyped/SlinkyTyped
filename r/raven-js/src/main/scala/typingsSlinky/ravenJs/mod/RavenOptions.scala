...
object RavenOptions {
  ...
  implicit class RavenOptionsOps[Self <: RavenOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreErrorsVarargs(value: (js.RegExp | String)*): Self = this.set("ignoreErrors", js.Array(value :_*))
    
    @scala.inline
    def setIgnoreErrors(value: js.Array[js.RegExp | String]): Self = this.set("ignoreErrors", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIgnoreErrors: Self = this.set("ignoreErrors", js.undefined)
    
    @scala.inline
    def setIgnoreUrlsVarargs(value: (js.RegExp | String)*): Self = this.set("ignoreUrls", js.Array(value :_*))
    
    @scala.inline
    def setIgnoreUrls(value: js.Array[js.RegExp | String]): Self = this.set("ignoreUrls", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIgnoreUrls: Self = this.set("ignoreUrls", js.undefined)
    
    @scala.inline
    def setIncludePathsVarargs(value: (js.RegExp | String)*): Self = this.set("includePaths", js.Array(value :_*))
    
    @scala.inline
    def setIncludePaths(value: js.Array[js.RegExp | String]): Self = this.set("includePaths", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSanitizeKeysVarargs(value: (js.RegExp | String)*): Self = this.set("sanitizeKeys", js.Array(value :_*))
    
    @scala.inline
    def setSanitizeKeys(value: js.Array[js.RegExp | String]): Self = this.set("sanitizeKeys", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWhitelistUrlsVarargs(value: (js.RegExp | String)*): Self = this.set("whitelistUrls", js.Array(value :_*))
    
    @scala.inline
    def setWhitelistUrls(value: js.Array[js.RegExp | String]): Self = this.set("whitelistUrls", value.asInstanceOf[js.Any])
