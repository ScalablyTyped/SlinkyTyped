  ...
  */
  ...
  object RavenOptions {
    ...
    implicit class RavenOptionsMutableBuilder[Self <: RavenOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIgnoreErrors(value: js.Array[js.RegExp | String]): Self = StObject.set(x, "ignoreErrors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIgnoreErrorsUndefined: Self = StObject.set(x, "ignoreErrors", js.undefined)
      
      @scala.inline
      def setIgnoreErrorsVarargs(value: (js.RegExp | String)*): Self = StObject.set(x, "ignoreErrors", js.Array(value :_*))
      
      @scala.inline
      def setIgnoreUrls(value: js.Array[js.RegExp | String]): Self = StObject.set(x, "ignoreUrls", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIgnoreUrlsUndefined: Self = StObject.set(x, "ignoreUrls", js.undefined)
      
      @scala.inline
      def setIgnoreUrlsVarargs(value: (js.RegExp | String)*): Self = StObject.set(x, "ignoreUrls", js.Array(value :_*))
      
      @scala.inline
      def setIncludePaths(value: js.Array[js.RegExp | String]): Self = StObject.set(x, "includePaths", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIncludePathsUndefined: Self = StObject.set(x, "includePaths", js.undefined)
      
      @scala.inline
      def setIncludePathsVarargs(value: (js.RegExp | String)*): Self = StObject.set(x, "includePaths", js.Array(value :_*))
      ...
      @scala.inline
      def setSanitizeKeys(value: js.Array[js.RegExp | String]): Self = StObject.set(x, "sanitizeKeys", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSanitizeKeysUndefined: Self = StObject.set(x, "sanitizeKeys", js.undefined)
      
      @scala.inline
      def setSanitizeKeysVarargs(value: (js.RegExp | String)*): Self = StObject.set(x, "sanitizeKeys", js.Array(value :_*))
      ...
      @scala.inline
      def setWhitelistUrls(value: js.Array[js.RegExp | String]): Self = StObject.set(x, "whitelistUrls", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWhitelistUrlsUndefined: Self = StObject.set(x, "whitelistUrls", js.undefined)
      
      @scala.inline
      def setWhitelistUrlsVarargs(value: (js.RegExp | String)*): Self = StObject.set(x, "whitelistUrls", js.Array(value :_*))
    }
  }
