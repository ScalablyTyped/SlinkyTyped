...
object ReactDashNativeDashMultiDashSlider
  ...
  typingsSlinky.reactDashNativeDashMultiDashSlider.reactDashNativeDashMultiDashSliderMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
