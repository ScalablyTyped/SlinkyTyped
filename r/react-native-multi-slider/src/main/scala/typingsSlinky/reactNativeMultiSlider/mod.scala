package typingsSlinky.reactNativeMultiSlider
...
object mod {
  ...
  type MultiSlider = ReactComponentClass[MultiSliderProps]
  ...
  object MultiSliderProps {
    ...
    implicit class MultiSliderPropsMutableBuilder[Self <: MultiSliderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomMarker(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarker", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMarkerComponentClass(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarker", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMarkerFunctionComponent(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarker", value.asInstanceOf[js.Any])
