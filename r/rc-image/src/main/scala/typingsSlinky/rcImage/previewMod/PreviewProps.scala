package typingsSlinky.rcImage.previewMod
...
trait PreviewProps extends js.Object {
  ...
  var onClose: js.UndefOr[
    js.Function1[/* e */ SyntheticEvent[Event, HTMLDivElement | HTMLLIElement], Unit]
  ] = js.native
...
object PreviewProps {
  ...
  implicit class PreviewPropsOps[Self <: PreviewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClose(value: /* e */ SyntheticEvent[Event, HTMLDivElement | HTMLLIElement] => Unit): Self = this.set("onClose", js.Any.fromFunction1(value))
