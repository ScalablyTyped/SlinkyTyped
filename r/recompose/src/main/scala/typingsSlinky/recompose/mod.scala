...
object mod {
  ...
  @js.native
  def componentFromProp(propName: String): ReactComponentClass[_] = js.native
  
  @JSImport("recompose", "componentFromStream")
  @js.native
  def componentFromStream[TProps](propsToReactNode: mapper[Subscribable[TProps], Subscribable[ReactElement]]): ReactComponentClass[TProps] = js.native
  ...
  @JSImport("recompose", "createEagerElement")
  @js.native
  def createEagerElement(`type`: String, props: js.UndefOr[scala.Nothing], children: ReactElement): ReactElement = js.native
  @JSImport("recompose", "createEagerElement")
  @js.native
  def createEagerElement(`type`: String, props: js.Object): ReactElement = js.native
  @JSImport("recompose", "createEagerElement")
  @js.native
  def createEagerElement(`type`: String, props: js.Object, children: ReactElement): ReactElement = js.native
  @JSImport("recompose", "createEagerElement")
  @js.native
  def createEagerElement(`type`: ReactComponentClass[_]): ReactElement = js.native
  @JSImport("recompose", "createEagerElement")
  @js.native
  def createEagerElement(`type`: ReactComponentClass[_], props: js.UndefOr[scala.Nothing], children: ReactElement): ReactElement = js.native
  @JSImport("recompose", "createEagerElement")
  @js.native
  def createEagerElement(`type`: ReactComponentClass[_], props: js.Object): ReactElement = js.native
  @JSImport("recompose", "createEagerElement")
  @js.native
  def createEagerElement(`type`: ReactComponentClass[_], props: js.Object, children: ReactElement): ReactElement = js.native
  ...
  @JSImport("recompose", "createEagerFactory")
  @js.native
  def createEagerFactory(`type`: ReactComponentClass[_]): componentFactory = js.native
  ...
  @js.native
  def createSink(callback: js.Function1[/* props */ js.Object, Unit]): ReactComponentClass[_] = js.native
  ...
  @js.native
  def getDisplayName(component: ReactComponentClass[_]): String = js.native
  ...
  @js.native
  def nest(Components: (String | ReactComponentClass[_])*): ReactComponentClass[_] = js.native
  ...
  @js.native
  def pure[TProps](component: ReactComponentClass[TProps]): ReactComponentClass[TProps] = js.native
  ...
  @JSImport("recompose", "renderComponent")
  @js.native
  def renderComponent[TProps](component: ReactComponentClass[TProps]): ComponentEnhancer[_, _] = js.native
  ...
  @js.native
  def setDisplayName(displayName: String): js.Function1[/* component */ ReactComponentClass[_], ReactComponentClass[_]] = js.native
  ...
  @js.native
  def setPropTypes[P](propTypes: ValidationMap[P]): js.Function1[/* component */ ReactComponentClass[P], ReactComponentClass[P]] = js.native
  
  @JSImport("recompose", "setStatic")
  @js.native
  def setStatic(key: String, value: js.Any): js.Function1[/* component */ ReactComponentClass[_], ReactComponentClass[_]] = js.native
  ...
  @js.native
  def toRenderProps[TInner, TOutter](hoc: InferableComponentEnhancerWithProps[TInner with TOutter, TOutter]): ReactComponentClass[TOutter with Children[TInner]] = js.native
  ...
  @js.native
  def wrapDisplayName(component: ReactComponentClass[_], wrapperName: String): String = js.native
  ...
  {[ P in keyof THandlers ]: (props : TOutter): THandlers[P]}
    */ typingsSlinky.recompose.recomposeStrings.HandleCreatorsHandlers with TopLevel[THandlers]
  ...
  type InferableComponentEnhancerWithProps[TInjectedProps, TNeedsProps] = js.Function1[
    ...
    ReactComponentClass[(Omit[TInjectedProps, /* keyof TInjectedProps */ String]) with TNeedsProps]
  ]
  ...
  {[ updaterName in keyof TUpdaters ]: (state : TState, props : TOutter): TUpdaters[updaterName]}
    */ typingsSlinky.recompose.recomposeStrings.StateUpdaters with TopLevel[TUpdaters]
