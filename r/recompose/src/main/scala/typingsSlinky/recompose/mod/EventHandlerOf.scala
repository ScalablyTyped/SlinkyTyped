...
object EventHandlerOf {
  @scala.inline
  def apply[T, /* <: typingsSlinky.recompose.mod.Subscribable[T] */ TSubs](handler: T => Unit, stream: TSubs): EventHandlerOf[T, TSubs] = {
  ...
  @scala.inline
  implicit class EventHandlerOfOps[Self <: EventHandlerOf[_, _], T, /* <: typingsSlinky.recompose.mod.Subscribable[T] */ TSubs] (val x: Self with (EventHandlerOf[T, TSubs])) extends AnyVal {
    @scala.inline
