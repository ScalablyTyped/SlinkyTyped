...
object LiveProvider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactLive.mod.LiveProvider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactLive.mod.LiveProvider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactLive.mod.LiveProvider] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactLive.mod.LiveProvider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
