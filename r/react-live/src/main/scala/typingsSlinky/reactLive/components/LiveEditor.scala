...
import typingsSlinky.reactLive.mod.LiveEditorProps
...
object LiveEditor
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactLive.mod.LiveEditor] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactLive.mod.LiveEditor] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactLive.mod.LiveEditor] = new slinky.core.BuildingComponent[slinky.web.html.pre.tag.type, typingsSlinky.reactLive.mod.LiveEditor](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = LiveEditorProps
}
