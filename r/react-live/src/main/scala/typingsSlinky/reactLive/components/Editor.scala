...
import typingsSlinky.reactLive.mod.EditorProps
...
object Editor
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactLive.mod.Editor] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactLive.mod.Editor] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactLive.mod.Editor] = new slinky.core.BuildingComponent[slinky.web.html.pre.tag.type, typingsSlinky.reactLive.mod.Editor](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
