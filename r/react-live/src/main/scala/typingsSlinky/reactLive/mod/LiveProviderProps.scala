...
object LiveProviderProps {
  ...
  implicit class LiveProviderPropsOps[Self <: LiveProviderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNoInline(value: Boolean): Self = this.set("noInline", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNoInline: Self = this.set("noInline", js.undefined)
    ...
    @scala.inline
    def setScope(value: StringDictionary[js.Any]): Self = this.set("scope", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTransformCode(value: /* code */ String => String): Self = this.set("transformCode", js.Any.fromFunction1(value))
