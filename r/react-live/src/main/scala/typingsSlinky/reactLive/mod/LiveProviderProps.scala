...
/* Inlined react-live.react-live.Omit<react-live.react-live.DivProps, 'scope'> & {  scope ? :{[key: string] : any},   code ? :string,   noInline ? :boolean, transformCode ? (code : string): string,   language ? :prism-react-renderer.prism-react-renderer.Language,   disabled ? :boolean,   theme ? :prism-react-renderer.prism-react-renderer.PrismTheme} */
@js.native
trait LiveProviderProps extends js.Object {
...
object LiveProviderProps {
  ...
  @scala.inline
  implicit class LiveProviderPropsOps[Self <: LiveProviderProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withNoInline(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noInline")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNoInline: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noInline")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withScope(value: StringDictionary[js.Any]): Self = {
        val ret = this.duplicate
