...
object GroupAlert extends StObject {
  ...
  /* 0 */ val All: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.GroupAlert.All with Double = js.native
  
  @js.native
  sealed trait Children extends GroupAlert
  /* 2 */ val Children: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.GroupAlert.Children with Double = js.native
  
  @js.native
  sealed trait Summary extends GroupAlert
  /* 1 */ val Summary: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.GroupAlert.Summary with Double = js.native
}
