...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.alarm
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.call
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.email
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.err
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.event
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.msg
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.progress
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.promo
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.recommendation
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.reminder
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.service
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.social
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.status
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.system
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.transport
*/
