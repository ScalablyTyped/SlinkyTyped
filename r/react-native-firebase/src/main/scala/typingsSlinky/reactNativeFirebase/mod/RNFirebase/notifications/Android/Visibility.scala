...
object Visibility extends StObject {
  ...
  /* 0 */ val Private: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.Visibility.Private with Double = js.native
  
  @js.native
  sealed trait Public extends Visibility
  /* 1 */ val Public: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.Visibility.Public with Double = js.native
  
  @js.native
  sealed trait Secret extends Visibility
  /* -1 */ val Secret: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.Visibility.Secret with Double = js.native
}
