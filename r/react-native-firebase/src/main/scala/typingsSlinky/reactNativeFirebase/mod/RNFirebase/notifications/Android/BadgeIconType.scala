...
object BadgeIconType extends StObject {
  ...
  /* 2 */ val Large: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.BadgeIconType.Large with Double = js.native
  
  @js.native
  sealed trait None extends BadgeIconType
  /* 0 */ val None: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.BadgeIconType.None with Double = js.native
  
  @js.native
  sealed trait Small extends BadgeIconType
  /* 1 */ val Small: typingsSlinky.reactNativeFirebase.mod.RNFirebase.notifications.Android.BadgeIconType.Small with Double = js.native
}
