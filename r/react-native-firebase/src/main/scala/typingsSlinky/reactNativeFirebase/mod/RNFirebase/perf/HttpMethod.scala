...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.CONNECT
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.DELETE
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.GET
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.HEAD
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.OPTIONS
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.PATCH
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.POST
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.PUT
  - typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.TRACE
*/
