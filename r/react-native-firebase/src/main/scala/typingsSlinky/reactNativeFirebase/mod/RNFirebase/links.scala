...
import typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.SHORT
import typingsSlinky.reactNativeFirebase.reactNativeFirebaseStrings.UNGUESSABLE
