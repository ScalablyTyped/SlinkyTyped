...
import typingsSlinky.reactNativeFirebase.mod.RNFirebase.ActionCodeInfo
import typingsSlinky.reactNativeFirebase.mod.RNFirebase.ActionCodeSettings
import typingsSlinky.reactNativeFirebase.mod.RNFirebase.ConfirmationResult
import typingsSlinky.reactNativeFirebase.mod.RNFirebase.PhoneAuthListener
import typingsSlinky.reactNativeFirebase.mod.RNFirebase.User
import typingsSlinky.reactNativeFirebase.mod.RNFirebase.UserCredential
