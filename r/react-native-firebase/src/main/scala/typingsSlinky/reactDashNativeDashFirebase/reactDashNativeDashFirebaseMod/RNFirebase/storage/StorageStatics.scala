...
import typingsSlinky.reactDashNativeDashFirebase.Anon_CACHESDIRECTORYPATH
...
trait StorageStatics extends js.Object {
  ...
  var TaskEvent: typingsSlinky.reactDashNativeDashFirebase.reactDashNativeDashFirebaseMod.RNFirebase.storage.TaskEvent
  var TaskState: typingsSlinky.reactDashNativeDashFirebase.reactDashNativeDashFirebaseMod.RNFirebase.storage.TaskState
}
