...
import typingsSlinky.reactDashNativeDashFirebase.reactDashNativeDashFirebaseStrings.SHORT
import typingsSlinky.reactDashNativeDashFirebase.reactDashNativeDashFirebaseStrings.UNGUESSABLE
