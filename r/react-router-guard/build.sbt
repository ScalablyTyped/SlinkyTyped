...
version := "2.3-dt-20200902Z-97435f"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-loadable" % "5.5-dt-20201028Z-21126b",
  "org.scalablytyped.slinky" %%% "react-router" % "5.1-dt-20201002Z-c02345",
  "org.scalablytyped.slinky" %%% "react-router-dom" % "5.1-dt-20201006Z-288e23",
