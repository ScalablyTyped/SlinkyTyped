...
object Redirect
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterGuard.mod.Redirect] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterGuard.mod.Redirect] = {
