...
object anon {
  ...
  @js.native
  trait Default[T /* <: ReactComponentClass[_] */] extends StObject {
  ...
  object Default {
    ...
    @scala.inline
    implicit class DefaultMutableBuilder[Self <: Default[_], T /* <: ReactComponentClass[_] */] (val x: Self with Default[T]) extends AnyVal {
