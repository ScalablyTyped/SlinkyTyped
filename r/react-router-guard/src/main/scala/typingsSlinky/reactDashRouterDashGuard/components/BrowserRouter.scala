...
object BrowserRouter
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashRouterDashGuard.reactDashRouterDashGuardMod.BrowserRouter
    ] {
  ...
  typingsSlinky.reactDashRouterDashGuard.reactDashRouterDashGuardMod.BrowserRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
