...
object Switch
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashRouterDashGuard.reactDashRouterDashGuardMod.Switch
    ] {
  ...
  typingsSlinky.reactDashRouterDashGuard.reactDashRouterDashGuardMod.Switch](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
