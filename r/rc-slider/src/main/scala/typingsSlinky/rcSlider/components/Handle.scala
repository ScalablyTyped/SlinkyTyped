...
object Handle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rcSlider.mod.Handle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rcSlider.mod.Handle] = {
