package typingsSlinky.rcDashSlider.rcDashSliderMod

import slinky.core.TagMod
import typingsSlinky.rcDashTooltip.rcDashTooltipMod.RCTooltip.Props
...
object WithTooltipProps {
  @scala.inline
  def apply(tipFormatter: /* value */ Double => TagMod[Any] = null, tipProps: Partial[Props] = null): WithTooltipProps = {
