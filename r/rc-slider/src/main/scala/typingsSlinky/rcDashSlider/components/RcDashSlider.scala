...
import typingsSlinky.rcDashSlider.rcDashSliderMod.SliderProps
import typingsSlinky.rcDashSlider.rcDashSliderMod.default
...
object RcDashSlider
  ...
  /* The following DOM/SVG props were specified: className, disabled, onBlur, onChange, tabIndex */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.rcDashSlider.rcDashSliderMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
