...
object FactoryInit {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.DatasetCore[OutQuad, InQuad] */ D, /* <: typingsSlinky.rdfJs.mod.BaseQuad */ OutQuad, /* <: typingsSlinky.rdfJs.mod.BaseQuad */ InQuad](factory: DatasetCoreFactory[OutQuad, InQuad, D], formats: PickparsersSinkMapEventEm): FactoryInit[D, OutQuad, InQuad] = {
  ...
  @scala.inline
  implicit class FactoryInitOps[Self <: FactoryInit[_, _, _], /* <: typingsSlinky.rdfJs.mod.DatasetCore[OutQuad, InQuad] */ D, /* <: typingsSlinky.rdfJs.mod.BaseQuad */ OutQuad, /* <: typingsSlinky.rdfJs.mod.BaseQuad */ InQuad] (val x: Self with (FactoryInit[D, OutQuad, InQuad])) extends AnyVal {
    @scala.inline
