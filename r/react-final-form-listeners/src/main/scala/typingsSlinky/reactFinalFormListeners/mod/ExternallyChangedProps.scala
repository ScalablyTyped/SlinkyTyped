...
trait ExternallyChangedProps extends js.Object {
  ...
  def children(externallyChanged: Boolean): ReactElement = js.native
}

object ExternallyChangedProps {
  @scala.inline
  def apply(children: Boolean => ReactElement, name: String): ExternallyChangedProps = {
  ...
  implicit class ExternallyChangedPropsOps[Self <: ExternallyChangedProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: Boolean => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
