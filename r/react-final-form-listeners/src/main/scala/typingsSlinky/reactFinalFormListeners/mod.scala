package typingsSlinky.reactFinalFormListeners
...
object mod {
  ...
  @js.native
  val ExternallyChanged: ReactComponentClass[ExternallyChangedProps] = js.native
  
  @JSImport("react-final-form-listeners", "OnBlur")
  @js.native
  val OnBlur: ReactComponentClass[OnBlurProps] = js.native
  
  @JSImport("react-final-form-listeners", "OnChange")
  @js.native
  val OnChange: ReactComponentClass[OnChangeProps] = js.native
  
  @JSImport("react-final-form-listeners", "OnFocus")
  @js.native
  val OnFocus: ReactComponentClass[OnFocusProps] = js.native
  ...
  object ExternallyChangedProps {
    ...
    implicit class ExternallyChangedPropsMutableBuilder[Self <: ExternallyChangedProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: Boolean => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
