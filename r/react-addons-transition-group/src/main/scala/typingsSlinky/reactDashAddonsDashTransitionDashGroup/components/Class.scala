...
object Class
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashAddonsDashTransitionDashGroup.reactDashAddonsDashTransitionDashGroupMod.Class
    ] {
  ...
  typingsSlinky.reactDashAddonsDashTransitionDashGroup.reactDashAddonsDashTransitionDashGroupMod.Class](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
