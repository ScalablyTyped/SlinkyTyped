package typingsSlinky.reactTreeview
...
object mod {
  ...
  trait TreeProps extends HTMLAttributes[HTMLDivElement] {
    ...
    var nodeLabel: ReactElement = js.native
  ...
  object TreeProps {
    ...
    implicit class TreePropsMutableBuilder[Self <: TreeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNodeLabel(value: ReactElement): Self = StObject.set(x, "nodeLabel", value.asInstanceOf[js.Any])
  ...
  type TreeView = ReactComponentClass[TreeProps]
}
