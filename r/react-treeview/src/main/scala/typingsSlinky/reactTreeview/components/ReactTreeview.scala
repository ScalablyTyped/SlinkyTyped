package typingsSlinky.reactTreeview.components
...
import typingsSlinky.reactTreeview.mod.TreeProps
import typingsSlinky.reactTreeview.mod.^
...
object ReactTreeview {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def nodeLabel(value: ReactElement): this.type = set("nodeLabel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def treeViewClassName(value: String): this.type = set("treeViewClassName", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ReactTreeview.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
