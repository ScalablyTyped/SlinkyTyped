...
import typingsSlinky.reactDashInstantsearchDashCore.reactDashInstantsearchDashCoreStrings.and
import typingsSlinky.reactDashInstantsearchDashCore.reactDashInstantsearchDashCoreStrings.or
