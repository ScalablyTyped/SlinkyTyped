...
import typingsSlinky.reactDashInstantsearchDashCore.reactDashInstantsearchDashCoreStrings.full
import typingsSlinky.reactDashInstantsearchDashCore.reactDashInstantsearchDashCoreStrings.none
import typingsSlinky.reactDashInstantsearchDashCore.reactDashInstantsearchDashCoreStrings.partial
