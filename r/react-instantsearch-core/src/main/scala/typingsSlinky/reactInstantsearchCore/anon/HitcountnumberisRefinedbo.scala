...
object HitcountnumberisRefinedbo {
  ...
  implicit class HitcountnumberisRefinedboMutableBuilder[Self <: HitcountnumberisRefinedbo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_highlightResult(value: typingsSlinky.reactInstantsearchCore.mod.HighlightResult[Value]): Self = StObject.set(x, "_highlightResult", value.asInstanceOf[js.Any])
  }
}
