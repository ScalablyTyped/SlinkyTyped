  ...
  object ReactMasonryLayoutExport {
    ...
    object MasonryLayoutProps {
      ...
      implicit class MasonryLayoutPropsMutableBuilder[Self <: MasonryLayoutProps] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setInfiniteScrollEndIndicator(value: ReactElement): Self = StObject.set(x, "infiniteScrollEndIndicator", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setInfiniteScrollEndIndicatorReactElement(value: ReactElement): Self = StObject.set(x, "infiniteScrollEndIndicator", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setInfiniteScrollSpinner(value: ReactElement): Self = StObject.set(x, "infiniteScrollSpinner", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setInfiniteScrollSpinnerReactElement(value: ReactElement): Self = StObject.set(x, "infiniteScrollSpinner", value.asInstanceOf[js.Any])
