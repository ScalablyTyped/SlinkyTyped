package typingsSlinky.reactMasonryLayout.mod.ReactMasonryLayoutExport
...
trait MasonryLayoutProps extends js.Object {
  ...
  /**
    ...
    */
  var infiniteScrollEndIndicator: js.UndefOr[ReactElement] = js.native
  /**
  ...
  /**
    ...
    */
  var infiniteScrollSpinner: js.UndefOr[ReactElement] = js.native
  /**
...
object MasonryLayoutProps {
  ...
  implicit class MasonryLayoutPropsOps[Self <: MasonryLayoutProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInfiniteScrollEndIndicatorReactElement(value: ReactElement): Self = this.set("infiniteScrollEndIndicator", value.asInstanceOf[js.Any])
    @scala.inline
    def setInfiniteScrollEndIndicator(value: ReactElement): Self = this.set("infiniteScrollEndIndicator", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInfiniteScrollSpinnerReactElement(value: ReactElement): Self = this.set("infiniteScrollSpinner", value.asInstanceOf[js.Any])
    @scala.inline
    def setInfiniteScrollSpinner(value: ReactElement): Self = this.set("infiniteScrollSpinner", value.asInstanceOf[js.Any])
    @scala.inline
