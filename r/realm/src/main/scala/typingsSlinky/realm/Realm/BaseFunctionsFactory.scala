...
object BaseFunctionsFactory {
  ...
  implicit class BaseFunctionsFactoryOps[Self <: BaseFunctionsFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallFunctionStreaming(value: (String, /* repeated */ js.Any) => js.Promise[AsyncIterable[js.typedarray.Uint8Array]]): Self = this.set("callFunctionStreaming", js.Any.fromFunction2(value))
  }
}
