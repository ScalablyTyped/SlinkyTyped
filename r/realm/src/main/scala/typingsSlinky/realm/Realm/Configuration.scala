...
object Configuration {
  ...
  implicit class ConfigurationOps[Self <: Configuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncryptionKeyArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("encryptionKey", value.asInstanceOf[js.Any])
    @scala.inline
    def setEncryptionKeyArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("encryptionKey", value.asInstanceOf[js.Any])
    @scala.inline
    def setEncryptionKeyInt8Array(value: js.typedarray.Int8Array): Self = this.set("encryptionKey", value.asInstanceOf[js.Any])
    @scala.inline
    def setEncryptionKey(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | js.typedarray.Int8Array): Self = this.set("encryptionKey", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): Self = this.set("migration", js.Any.fromFunction2(value))
    @scala.inline
