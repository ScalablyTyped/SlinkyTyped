...
object SyncConfiguration {
  ...
  def apply(
    ...
    if (!js.isUndefined(_disableQueryBasedSyncUrlChecks)) __obj.updateDynamic("_disableQueryBasedSyncUrlChecks")(_disableQueryBasedSyncUrlChecks.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(fullSynchronization)) __obj.updateDynamic("fullSynchronization")(fullSynchronization.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(validate_ssl)) __obj.updateDynamic("validate_ssl")(validate_ssl.get.asInstanceOf[js.Any])
