package typingsSlinky.realm.realmMod
...
object Sync extends js.Object {
  ...
  object User extends js.Object {
    ...
    val current: typingsSlinky.realm.Realm.Sync.User = js.native
    // Deprecated
    /** @deprecated, to be removed in future versions */
    ...
    /** @deprecated, to be removed in future versions */
    def registerWithProvider(server: String, options: Anon_Provider): js.Promise[typingsSlinky.realm.Realm.Sync.User] = js.native
