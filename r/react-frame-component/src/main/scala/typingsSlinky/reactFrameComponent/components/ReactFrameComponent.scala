...
object ReactFrameComponent
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLIFrameElement, Event_] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLIFrameElement, Event_] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.iframe.tag.type, typingsSlinky.reactFrameComponent.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
