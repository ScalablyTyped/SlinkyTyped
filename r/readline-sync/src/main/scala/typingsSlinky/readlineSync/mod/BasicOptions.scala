...
object BasicOptions {
  ...
  implicit class BasicOptionsOps[Self <: BasicOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFalseValueRegExp(value: js.RegExp): Self = this.set("falseValue", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLimitRegExp(value: js.RegExp): Self = this.set("limit", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrueValueRegExp(value: js.RegExp): Self = this.set("trueValue", value.asInstanceOf[js.Any])
