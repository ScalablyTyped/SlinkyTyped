...
object mod {
  ...
  object BasicOptions {
    ...
    implicit class BasicOptionsMutableBuilder[Self <: BasicOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFalseValueRegExp(value: js.RegExp): Self = StObject.set(x, "falseValue", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLimitRegExp(value: js.RegExp): Self = StObject.set(x, "limit", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTrueValueRegExp(value: js.RegExp): Self = StObject.set(x, "trueValue", value.asInstanceOf[js.Any])
