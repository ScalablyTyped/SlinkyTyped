package typingsSlinky.rcDashTooltip.components
...
import typingsSlinky.rcDashTooltip.rcDashTooltipMod.RCTooltip.Placement
...
object RcDashTooltip
  ...
  type Props = typingsSlinky.rcDashTooltip.rcDashTooltipMod.RCTooltip.Props
}
