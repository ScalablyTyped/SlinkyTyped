...
object Gallery {
  ...
  object defaultProps {
    ...
    @scala.inline
    def src_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("src")(x.asInstanceOf[js.Any])
  }
  ...
  object propTypes {
    ...
    object show {
      ...
      @JSImport("react-weui", "Gallery.propTypes.show.isRequired")
      @js.native
    ...
    object src {
      ...
      @JSImport("react-weui", "Gallery.propTypes.src.isRequired")
      @js.native
      def isRequired(p0: js.Any, p1: js.Any, p2: js.Any, p3: js.Any, p4: js.Any, p5: js.Any): js.Any = js.native
    }
  }
