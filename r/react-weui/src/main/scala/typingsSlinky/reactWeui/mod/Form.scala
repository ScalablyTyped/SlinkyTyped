...
object Form {
  ...
  @js.native
  def defaultProps: typingsSlinky.reactWeui.anon.Checkbox = js.native
  @scala.inline
  def defaultProps_=(x: typingsSlinky.reactWeui.anon.Checkbox): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
