...
object mod {
  ...
  trait CalendarPickerProps extends StObject {
    ...
    var nextComponent: js.UndefOr[ReactElement] = js.native
  ...
  object CalendarPickerProps {
    ...
    implicit class CalendarPickerPropsMutableBuilder[Self <: CalendarPickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisabledDates(value: js.Array[js.Date] | DisabledDatesFunc): Self = StObject.set(x, "disabledDates", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNextComponent(value: ReactElement): Self = StObject.set(x, "nextComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNextComponentReactElement(value: ReactElement): Self = StObject.set(x, "nextComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPreviousComponent(value: ReactElement): Self = StObject.set(x, "previousComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreviousComponentReactElement(value: ReactElement): Self = StObject.set(x, "previousComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectedEndDate(value: js.Date): Self = StObject.set(x, "selectedEndDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectedStartDate(value: js.Date): Self = StObject.set(x, "selectedStartDate", value.asInstanceOf[js.Any])
