...
object CalendarPickerProps {
  ...
  implicit class CalendarPickerPropsOps[Self <: CalendarPickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisabledDates(value: js.Array[js.Date] | DisabledDatesFunc): Self = this.set("disabledDates", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNextComponentReactElement(value: ReactElement): Self = this.set("nextComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNextComponent(value: ReactElement): Self = this.set("nextComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPreviousComponent(value: ReactElement): Self = this.set("previousComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectedEndDate(value: js.Date): Self = this.set("selectedEndDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectedStartDate(value: js.Date): Self = this.set("selectedStartDate", value.asInstanceOf[js.Any])
