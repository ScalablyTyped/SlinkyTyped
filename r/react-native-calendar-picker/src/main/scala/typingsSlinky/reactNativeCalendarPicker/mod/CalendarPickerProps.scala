...
trait CalendarPickerProps extends js.Object {
  ...
  var nextComponent: js.UndefOr[TagMod[Any]] = js.undefined
  ...
  var previousComponent: js.UndefOr[TagMod[Any]] = js.undefined
...
object CalendarPickerProps {
  ...
  def apply(
    ...
    disabledDates: js.Array[js.Date] | DisabledDatesFunc = null,
    ...
    previousComponent: TagMod[Any] = null,
    ...
    selectedStartDate: js.Date = null,
