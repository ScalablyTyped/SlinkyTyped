...
object generatorCommonMod {
  ...
  trait Replacements
    ...
    var regExpPatternsToRemove: js.UndefOr[js.Array[js.RegExp]] = js.native
  ...
  object Replacements {
    ...
    implicit class ReplacementsMutableBuilder[Self <: Replacements] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRegExpPatternsToRemove(value: js.Array[js.RegExp]): Self = StObject.set(x, "regExpPatternsToRemove", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRegExpPatternsToRemoveUndefined: Self = StObject.set(x, "regExpPatternsToRemove", js.undefined)
      
      @scala.inline
      def setRegExpPatternsToRemoveVarargs(value: js.RegExp*): Self = StObject.set(x, "regExpPatternsToRemove", js.Array(value :_*))
