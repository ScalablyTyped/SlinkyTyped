...
object Replacements {
  ...
  implicit class ReplacementsOps[Self <: Replacements] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRegExpPatternsToRemoveVarargs(value: js.RegExp*): Self = this.set("regExpPatternsToRemove", js.Array(value :_*))
    
    @scala.inline
    def setRegExpPatternsToRemove(value: js.Array[js.RegExp]): Self = this.set("regExpPatternsToRemove", value.asInstanceOf[js.Any])
