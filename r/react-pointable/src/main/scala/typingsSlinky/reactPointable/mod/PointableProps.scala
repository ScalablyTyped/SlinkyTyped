...
object PointableProps {
  ...
  implicit class PointablePropsOps[Self <: PointableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElementRef(value: /* el */ HTMLElement | SVGElement => Unit): Self = this.set("elementRef", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setTagName(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 173 */ js.Any): Self = this.set("tagName", value.asInstanceOf[js.Any])
    @scala.inline
