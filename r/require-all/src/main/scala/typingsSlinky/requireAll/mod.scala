...
import typingsSlinky.requireAll.requireAllBooleans.`false`
import typingsSlinky.requireAll.requireAllBooleans.`true`
...
object mod {
  ...
  trait Options extends StObject {
    ...
    var excludeDirs: js.UndefOr[js.RegExp] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExcludeDirs(value: js.RegExp): Self = StObject.set(x, "excludeDirs", value.asInstanceOf[js.Any])
