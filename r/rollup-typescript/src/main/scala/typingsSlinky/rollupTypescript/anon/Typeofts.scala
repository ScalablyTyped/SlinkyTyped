...
trait Typeofts extends js.Object {
  ...
  def visitNodes[T /* <: Node */](nodes: js.UndefOr[scala.Nothing], visitor: Visitor, test: js.UndefOr[scala.Nothing], start: Double): NodeArray[T] = js.native
  def visitNodes[T /* <: Node */](
    nodes: js.UndefOr[scala.Nothing],
    visitor: Visitor,
    test: js.UndefOr[scala.Nothing],
  ...
  @JSName("visitNodes")
  def visitNodes_T_Node_Union[T /* <: Node */](nodes: js.UndefOr[scala.Nothing], visitor: Visitor, test: js.UndefOr[scala.Nothing], start: Double): js.UndefOr[NodeArray[T]] = js.native
  @JSName("visitNodes")
  def visitNodes_T_Node_Union[T /* <: Node */](
    nodes: js.UndefOr[scala.Nothing],
    visitor: Visitor,
