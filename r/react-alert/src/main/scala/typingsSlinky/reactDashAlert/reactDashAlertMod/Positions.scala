...
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`bottom center`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`bottom left`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`bottom right`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`middle left`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`middle right`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`top center`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`top left`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.`top right`
import typingsSlinky.reactDashAlert.reactDashAlertStrings.middle
