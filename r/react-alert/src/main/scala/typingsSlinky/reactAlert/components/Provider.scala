...
object Provider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactAlert.mod.Provider] {
  ...
  def apply(
    template: ReactComponentClass[AlertComponentPropsWithStyle],
    about: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactAlert.mod.Provider] = {
