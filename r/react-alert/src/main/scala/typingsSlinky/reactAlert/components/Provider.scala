package typingsSlinky.reactAlert.components
...
import typingsSlinky.reactAlert.mod.AlertComponentPropsWithStyle
import typingsSlinky.reactAlert.mod.AlertManager
import typingsSlinky.reactAlert.mod.AlertPosition
...
object Provider {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactAlert.mod.Provider] {
    @scala.inline
    ...
    @scala.inline
    def context(value: Context[js.UndefOr[AlertManager]]): this.type = set("context", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def position(value: AlertPosition): this.type = set("position", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def transition(value: AlertTransition): this.type = set("transition", value.asInstanceOf[js.Any])
    @scala.inline
