...
import typingsSlinky.requestDashPromise.Fn_Error
import typingsSlinky.requestDashPromise.Fn_ErrorFilter1
...
trait RequestPromise[T] extends Request {
  ...
  def promise(): typingsSlinky.bluebird.bluebirdMod.^[T] = js.native
