...
object mod {
  ...
  type InfiniteScroll = ReactComponentClass[InfiniteScrollProps]
  ...
  trait InfiniteScrollProps extends StObject {
    ...
    /**
      ...
      */
    var endMessage: js.UndefOr[ReactElement] = js.native
    ...
    /**
      ...
      */
    var loader: ReactElement = js.native
    ...
    /**
      ...
      */
    var pullDownToRefreshContent: js.UndefOr[ReactElement] = js.native
    ...
    /**
      ...
      */
    var releaseToRefreshContent: js.UndefOr[ReactElement] = js.native
    ...
    /**
      ...
      */
    var scrollableTarget: js.UndefOr[ReactElement | String] = js.native
  ...
  object InfiniteScrollProps {
    ...
    implicit class InfiniteScrollPropsMutableBuilder[Self <: InfiniteScrollProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndMessage(value: ReactElement): Self = StObject.set(x, "endMessage", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEndMessageReactElement(value: ReactElement): Self = StObject.set(x, "endMessage", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPullDownToRefreshContent(value: ReactElement): Self = StObject.set(x, "pullDownToRefreshContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPullDownToRefreshContentReactElement(value: ReactElement): Self = StObject.set(x, "pullDownToRefreshContent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setReleaseToRefreshContent(value: ReactElement): Self = StObject.set(x, "releaseToRefreshContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setReleaseToRefreshContentReactElement(value: ReactElement): Self = StObject.set(x, "releaseToRefreshContent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setScrollableTarget(value: ReactElement | String): Self = StObject.set(x, "scrollableTarget", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScrollableTargetReactElement(value: ReactElement): Self = StObject.set(x, "scrollableTarget", value.asInstanceOf[js.Any])
