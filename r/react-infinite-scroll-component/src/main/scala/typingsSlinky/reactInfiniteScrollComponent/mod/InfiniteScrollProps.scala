...
object InfiniteScrollProps {
  ...
  implicit class InfiniteScrollPropsOps[Self <: InfiniteScrollProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndMessageReactElement(value: ReactElement): Self = this.set("endMessage", value.asInstanceOf[js.Any])
    @scala.inline
    def setEndMessage(value: ReactElement): Self = this.set("endMessage", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPullDownToRefreshContentReactElement(value: ReactElement): Self = this.set("pullDownToRefreshContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setPullDownToRefreshContent(value: ReactElement): Self = this.set("pullDownToRefreshContent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setReleaseToRefreshContentReactElement(value: ReactElement): Self = this.set("releaseToRefreshContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setReleaseToRefreshContent(value: ReactElement): Self = this.set("releaseToRefreshContent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setScrollableTargetReactElement(value: ReactElement): Self = this.set("scrollableTarget", value.asInstanceOf[js.Any])
    @scala.inline
    def setScrollableTarget(value: ReactElement | String): Self = this.set("scrollableTarget", value.asInstanceOf[js.Any])
    @scala.inline
