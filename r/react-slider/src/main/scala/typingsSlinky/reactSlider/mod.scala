...
object mod extends Shortcut {
  ...
  @js.native
  class ^ protected ()
    extends Component[ReactSliderProps, js.Object, js.Any] {
    def this(props: ReactSliderProps) = this()
    def this(props: ReactSliderProps, context: js.Any) = this()
  }
  @JSImport("react-slider", JSImport.Namespace)
  @js.native
  val ^ : ComponentClass[ReactSliderProps, js.Object] = js.native
  ...
  object ReactSliderProps {
    ...
    implicit class ReactSliderPropsMutableBuilder[Self <: ReactSliderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderThumb(value: (/* props */ js.Object, /* state */ Index) => ReactElement): Self = StObject.set(x, "renderThumb", js.Any.fromFunction2(value))
      
      @scala.inline
      def setRenderThumbUndefined: Self = StObject.set(x, "renderThumb", js.undefined)
      
      @scala.inline
      def setRenderTrack(value: (/* props */ js.Object, /* state */ Value) => ReactElement): Self = StObject.set(x, "renderTrack", js.Any.fromFunction2(value))
  ...
  type _To = ComponentClass[ReactSliderProps, js.Object]
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: ComponentClass[ReactSliderProps, js.Object] = ^
}
