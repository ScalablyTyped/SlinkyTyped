...
object ReactSliderProps {
  ...
  implicit class ReactSliderPropsOps[Self <: ReactSliderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderThumb(value: (/* props */ js.Object, /* state */ Index) => ReactElement): Self = this.set("renderThumb", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteRenderThumb: Self = this.set("renderThumb", js.undefined)
    
    @scala.inline
    def setRenderTrack(value: (/* props */ js.Object, /* state */ Value) => ReactElement): Self = this.set("renderTrack", js.Any.fromFunction2(value))
