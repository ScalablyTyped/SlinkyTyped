package typingsSlinky.rcDashTable.libExpandableTableMod

import slinky.core.TagMod
import typingsSlinky.rcDashTable.Anon_Expandable
import typingsSlinky.rcDashTable.Anon_HandleExpandChange
...
import typingsSlinky.rcDashTable.libInterfaceMod.TableStore
...
trait ExpandableTableProps[ValueType] extends js.Object {
  ...
  var columnManager: typingsSlinky.rcDashTable.libColumnManagerMod.default
  ...
  def children(info: Anon_HandleExpandChange[ValueType]): TagMod[Any]
}

object ExpandableTableProps {
  @scala.inline
  def apply[ValueType](
    children: Anon_HandleExpandChange[ValueType] => TagMod[Any],
    columnManager: typingsSlinky.rcDashTable.libColumnManagerMod.default,
    ...
    expandIcon: /* props */ Anon_Expandable[ValueType] => TagMod[Any] = null,
    ...
    expandedRowRender: (ValueType, /* index */ Double, /* indent */ Double, /* expanded */ Boolean) => TagMod[Any] = null,
