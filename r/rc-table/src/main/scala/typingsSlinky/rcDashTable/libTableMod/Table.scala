...
import typingsSlinky.rcDashTable.Anon_Cancel
import typingsSlinky.rcDashTable.Anon_Remove
import typingsSlinky.rcDashTable.Anon_TableAnonColumnManager
...
import typingsSlinky.rcDashTable.libInterfaceMod.ScrollPosition
...
trait Table[ValueType]
  ...
  var columnManager: typingsSlinky.rcDashTable.libColumnManagerMod.default = js.native
