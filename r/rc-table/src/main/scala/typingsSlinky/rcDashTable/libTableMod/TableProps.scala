...
- Dropped {[ P in std.Exclude<keyof rc-table.rc-table/lib/ExpandableTable.ExpandableTableProps<ValueType>, 'prefixCls' | 'children'> ]: rc-table.rc-table/lib/ExpandableTable.ExpandableTableProps<ValueType>[P]} */ trait TableProps[ValueType] extends js.Object {
  ...
  var footer: js.UndefOr[js.Function1[/* data */ js.Array[ValueType], TagMod[Any]]] = js.undefined
  ...
  var title: js.UndefOr[js.Function1[/* data */ js.Array[ValueType], TagMod[Any]]] = js.undefined
...
object TableProps {
  ...
  def apply[ValueType](
    ...
    onRowClick: (ValueType, /* index */ Double, /* event */ SyntheticEvent[Event, Element]) => Unit = null,
    onRowContextMenu: (ValueType, /* index */ Double, /* event */ SyntheticEvent[Event, Element]) => Unit = null,
    onRowDoubleClick: (ValueType, /* index */ Double, /* event */ SyntheticEvent[Event, Element]) => Unit = null,
    onRowMouseEnter: (ValueType, /* index */ Double, /* event */ SyntheticEvent[Event, Element]) => Unit = null,
    onRowMouseLeave: (ValueType, /* index */ Double, /* event */ SyntheticEvent[Event, Element]) => Unit = null,
