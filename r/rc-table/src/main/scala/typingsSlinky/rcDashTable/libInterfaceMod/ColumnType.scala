...
trait ColumnType[ValueType] extends js.Object {
  ...
  var onCellClick: js.UndefOr[
    js.Function2[/* record */ ValueType, /* e */ SyntheticMouseEvent[HTMLElement], Unit]
  ] = js.undefined
...
object ColumnType {
  ...
  def apply[ValueType](
    ...
    onCellClick: (/* record */ ValueType, /* e */ SyntheticMouseEvent[HTMLElement]) => Unit = null,
    onHeaderCell: (ColumnType[DefaultValueType], /* index */ js.UndefOr[Double]) => HTMLAttributes[HTMLElement] = null,
    render: (/* value */ js.Any, /* record */ ValueType, /* index */ Double) => TagMod[Any] | RenderedCell = null,
