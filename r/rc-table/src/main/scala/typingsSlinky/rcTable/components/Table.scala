...
object Table {
  ...
  implicit def make[/* <: typingsSlinky.rcTable.interfaceMod.DefaultRecordType */ RecordType](companion: Table.type): SharedBuilder_TableProps_175475921[RecordType] = new SharedBuilder_TableProps_175475921[RecordType](js.Array(this.component, js.Dictionary.empty))()
  object ColumnGroup {
