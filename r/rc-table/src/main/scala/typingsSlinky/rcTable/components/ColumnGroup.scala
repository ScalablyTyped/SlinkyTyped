...
object ColumnGroup {
  ...
  def withProps[RecordType](p: ColumnGroupProps[RecordType]): Builder[RecordType] = new Builder[RecordType](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[RecordType](children: ReactElement | js.Array[ReactElement]): Builder[RecordType] = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    new Builder[RecordType](js.Array(this.component, __props.asInstanceOf[ColumnGroupProps[RecordType]]))
  }
}
