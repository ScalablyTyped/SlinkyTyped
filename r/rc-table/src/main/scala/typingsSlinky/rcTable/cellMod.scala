...
object cellMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ForwardRefExoticComponent[CellProps[_] with RefAttributes[_]]] = js.native
  ...
  object CellProps {
    ...
    implicit class CellPropsMutableBuilder[Self <: CellProps[_], RecordType /* <: DefaultRecordType */] (val x: Self with CellProps[RecordType]) extends AnyVal {
      ...
      @scala.inline
      def setAppendNodeReactElement(value: ReactElement): Self = StObject.set(x, "appendNode", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[ForwardRefExoticComponent[CellProps[_] with RefAttributes[_]]]
  
  /* This means you don't have to write `default`, but can instead just say `cellMod.foo` */
  override def _to: ReactComponentClass[ForwardRefExoticComponent[CellProps[_] with RefAttributes[_]]] = default
}
