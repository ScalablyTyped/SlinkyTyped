...
object TableComponents {
  ...
  implicit class TableComponentsMutableBuilder[Self <: TableComponents[_], RecordType] (val x: Self with TableComponents[RecordType]) extends AnyVal {
    ...
    @scala.inline
    def setBodyFunction2(value: (/* data */ js.Array[RecordType], /* info */ OnScroll) => ReactElement): Self = StObject.set(x, "body", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setTableComponentClass(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "table", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTableFunctionComponent(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "table", value.asInstanceOf[js.Any])
