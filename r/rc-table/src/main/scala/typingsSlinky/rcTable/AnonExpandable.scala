...
object AnonExpandable {
  @scala.inline
  def apply[RecordType](): AnonExpandable[RecordType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonExpandable[RecordType]]
  }
  @scala.inline
  implicit class AnonExpandableOps[Self[recordtype] <: AnonExpandable[recordtype], RecordType] (val x: Self[RecordType]) extends AnyVal {
    @scala.inline
