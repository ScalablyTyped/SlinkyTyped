package typingsSlinky.resizeDashObserverDashPolyfill.resizeDashObserverDashPolyfillMod._Global_

import org.scalajs.dom.raw.Element
import typingsSlinky.resizeDashObserverDashPolyfill.resizeDashObserverDashPolyfillMod.DOMRectReadOnly
