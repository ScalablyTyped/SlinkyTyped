package typingsSlinky.resizeObserverPolyfill
...
object mod {
  ...
  object global {
    ...
    object ResizeObserver {
      ...
      @scala.inline
      def apply(disconnect: () => Unit, observe: Element => Unit, unobserve: Element => Unit): typingsSlinky.resizeObserverPolyfill.mod.global.ResizeObserver = {
        val __obj = js.Dynamic.literal(disconnect = js.Any.fromFunction0(disconnect), observe = js.Any.fromFunction1(observe), unobserve = js.Any.fromFunction1(unobserve))
        __obj.asInstanceOf[typingsSlinky.resizeObserverPolyfill.mod.global.ResizeObserver]
      }
      
      @scala.inline
      implicit class ResizeObserverMutableBuilder[Self <: typingsSlinky.resizeObserverPolyfill.mod.global.ResizeObserver] (val x: Self) extends AnyVal {
    ...
    type ResizeObserverCallback = js.Function2[
        ...
        /* observer */ typingsSlinky.resizeObserverPolyfill.mod.global.ResizeObserver, 
        Unit
      ]
