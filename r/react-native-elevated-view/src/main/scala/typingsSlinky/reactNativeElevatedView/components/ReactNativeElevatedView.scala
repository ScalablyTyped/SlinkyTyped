package typingsSlinky.reactNativeElevatedView.components
...
import typingsSlinky.reactNativeElevatedView.mod.ElevatedViewProperties
import typingsSlinky.reactNativeElevatedView.mod.default
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ReactNativeElevatedView
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeElevatedView.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
