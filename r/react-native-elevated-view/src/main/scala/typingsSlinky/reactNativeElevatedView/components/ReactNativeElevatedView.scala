...
object ReactNativeElevatedView {
  ...
  def withProps(p: ElevatedViewProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ReactNativeElevatedView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
