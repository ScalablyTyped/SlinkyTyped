...
import typingsSlinky.reactDashNativeDashFetchDashBlob.Anon_Free
...
trait FS extends js.Object {
  var RNFetchBlobSession: typingsSlinky.reactDashNativeDashFetchDashBlob.reactDashNativeDashFetchDashBlobMod.RNFetchBlobSession = js.native
  ...
  def df(): js.Promise[Anon_Free] = js.native
  /**
