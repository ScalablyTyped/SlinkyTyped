package typingsSlinky.reactDashNativeDashDrawerDashLayout.components
...
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.DrawerLayoutProperties
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.DrawerLayoutSlideEvent
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.default
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutStrings.`locked-closed`
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutStrings.`locked-open`
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutStrings.`on-drag`
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutStrings.left
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutStrings.right
import typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutStrings.unlocked
...
object ReactDashNativeDashDrawerDashLayout
  ...
  def apply(
    ...
    keyboardDismissMode: typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutStrings.none | `on-drag` = null,
