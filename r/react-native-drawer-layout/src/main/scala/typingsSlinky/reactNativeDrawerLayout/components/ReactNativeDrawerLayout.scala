package typingsSlinky.reactNativeDrawerLayout.components
...
import typingsSlinky.reactNativeDrawerLayout.mod.DrawerLayoutProperties
import typingsSlinky.reactNativeDrawerLayout.mod.DrawerLayoutSlideEvent
...
object ReactNativeDrawerLayout {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def keyboardDismissMode(value: typingsSlinky.reactNativeDrawerLayout.reactNativeDrawerLayoutStrings.none | `on-drag`): this.type = set("keyboardDismissMode", value.asInstanceOf[js.Any])
