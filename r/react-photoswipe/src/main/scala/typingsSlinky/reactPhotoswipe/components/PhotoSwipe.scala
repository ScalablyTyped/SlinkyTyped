...
object PhotoSwipe
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactPhotoswipe.mod.PhotoSwipe] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactPhotoswipe.mod.PhotoSwipe] = {
