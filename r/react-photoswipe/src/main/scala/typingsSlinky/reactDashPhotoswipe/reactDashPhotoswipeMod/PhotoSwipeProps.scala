...
trait PhotoSwipeProps extends js.Object {
  ...
  /**
    ...
    * {@link https://photoswipe.com/documentation/api.html}
    */
  var updateScrollOffset: js.UndefOr[js.Function2[/* instance */ PhotoSwipe, /* _offset */ Anon_X, Unit]] = js.undefined
}
...
object PhotoSwipeProps {
  ...
  def apply(
    ...
    preventDragEvent: (/* instance */ PhotoSwipe, /* e */ MouseEvent, /* isDown */ Boolean, /* preventObj */ Anon_Prevent) => Unit = null,
