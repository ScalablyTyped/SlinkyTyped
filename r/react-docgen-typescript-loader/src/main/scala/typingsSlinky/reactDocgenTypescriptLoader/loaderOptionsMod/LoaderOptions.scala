package typingsSlinky.reactDocgenTypescriptLoader.loaderOptionsMod

import typingsSlinky.reactDocgenTypescript.parserMod.Component
import typingsSlinky.reactDocgenTypescript.parserMod.ComponentNameResolver
import typingsSlinky.reactDocgenTypescript.parserMod.PropFilter
import typingsSlinky.reactDocgenTypescript.parserMod.PropItem
import typingsSlinky.reactDocgenTypescript.reactDocgenTypescriptBooleans.`false`
...
object LoaderOptions {
  ...
  implicit class LoaderOptionsOps[Self <: LoaderOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPropFilter(value: (/* props */ PropItem, /* component */ Component) => Boolean): Self = this.set("propFilter", js.Any.fromFunction2(value))
