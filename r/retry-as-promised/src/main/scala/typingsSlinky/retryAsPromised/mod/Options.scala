...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMatchRegExp(value: js.RegExp): Self = this.set("match", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMatchError(value: js.Error): Self = this.set("match", value.asInstanceOf[js.Any])
