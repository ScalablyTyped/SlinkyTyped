...
object GetWorkspaceResponse {
  ...
  @scala.inline
  implicit class GetWorkspaceResponseOps[Self <: GetWorkspaceResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: Workspace): Self = this.set("data", value.asInstanceOf[js.Any])
