...
object GetCollectionResponse {
  ...
  @scala.inline
  implicit class GetCollectionResponseOps[Self <: GetCollectionResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: Collection): Self = this.set("data", value.asInstanceOf[js.Any])
