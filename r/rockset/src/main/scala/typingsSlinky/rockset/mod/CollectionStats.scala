...
object CollectionStats {
  @scala.inline
  def apply(
    doc_count: Int | Double = null,
    fill_progress: Int | Double = null,
    last_queried_ms: Int | Double = null,
    last_updated_ms: Int | Double = null,
    purged_doc_count: Int | Double = null,
    purged_doc_size: Int | Double = null,
    total_size: Int | Double = null
  ): CollectionStats = {
