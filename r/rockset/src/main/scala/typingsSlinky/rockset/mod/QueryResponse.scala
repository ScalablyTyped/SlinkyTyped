...
object QueryResponse {
  ...
  implicit class QueryResponseOps[Self <: QueryResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumn_fields(value: js.Array[QueryFieldType]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("column_fields")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutColumn_fields: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("column_fields")(js.undefined)
        ret
    }
    @scala.inline
    def withFields(value: js.Array[QueryFieldType]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStats(value: QueryResponseStats): Self = {
        val ret = this.duplicate
