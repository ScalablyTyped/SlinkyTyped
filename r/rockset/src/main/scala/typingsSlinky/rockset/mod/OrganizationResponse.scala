...
object OrganizationResponse {
  ...
  @scala.inline
  implicit class OrganizationResponseOps[Self <: OrganizationResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: Organization): Self = this.set("data", value.asInstanceOf[js.Any])
