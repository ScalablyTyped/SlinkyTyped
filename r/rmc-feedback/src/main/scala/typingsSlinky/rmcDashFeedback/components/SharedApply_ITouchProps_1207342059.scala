package typingsSlinky.rmcDashFeedback.components
...
abstract class SharedApply_ITouchProps_1207342059[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
