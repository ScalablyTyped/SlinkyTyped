...
trait MapContextProps extends js.Object {
  ...
  var viewport: js.UndefOr[
    typingsSlinky.viewportDashMercatorDashProject.viewportDashMercatorDashProjectMod.default
  ] = js.undefined
}
...
object MapContextProps {
  ...
  def apply(
    ...
    viewport: typingsSlinky.viewportDashMercatorDashProject.viewportDashMercatorDashProjectMod.default = null
  ): MapContextProps = {
