...
import typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.CanvasOverlayProps
import typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.CanvasRedrawOptions
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object CanvasOverlay
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.CanvasOverlay] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.CanvasOverlay] = {
