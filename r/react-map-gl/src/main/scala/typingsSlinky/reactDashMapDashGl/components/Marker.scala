...
import typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.MarkerProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Marker
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.Marker] {
  @JSImport("react-map-gl", "Marker")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: className, draggable, onDrag, onDragEnd, onDragStart */
  def apply(
    latitude: Double,
    longitude: Double,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.Marker] = {
