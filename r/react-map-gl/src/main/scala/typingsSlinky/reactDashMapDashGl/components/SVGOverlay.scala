...
import typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.SVGOverlayProps
import typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.SVGRedrawOptions
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object SVGOverlay
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.SVGOverlay] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMapDashGl.reactDashMapDashGlMod.SVGOverlay] = {
