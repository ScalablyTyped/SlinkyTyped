...
abstract class SharedApply_InteractiveMapProps_2020844625[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: className, onClick, onContextMenu, onError, onLoad, onMouseDown, onMouseEnter, onMouseLeave, onMouseMove, onMouseOut, onMouseUp, onTouchEnd, onTouchMove, onTouchStart, onWheel */
  def apply(
