...
object ContextViewStateChangeInfo {
  ...
  implicit class ContextViewStateChangeInfoOps[Self <: ContextViewStateChangeInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInteractionState(value: ExtraState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("interactionState")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNewViewState(value: ViewportProps): Self = {
        val ret = this.duplicate
