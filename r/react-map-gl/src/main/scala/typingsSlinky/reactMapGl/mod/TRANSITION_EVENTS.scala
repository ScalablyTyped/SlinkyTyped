...
object TRANSITION_EVENTS extends StObject {
  ...
  /* 1 */ val BREAK: typingsSlinky.reactMapGl.mod.TRANSITION_EVENTS.BREAK with Double = js.native
  
  @js.native
  sealed trait IGNORE extends TRANSITION_EVENTS
  /* 3 */ val IGNORE: typingsSlinky.reactMapGl.mod.TRANSITION_EVENTS.IGNORE with Double = js.native
  
  @js.native
  sealed trait SNAP_TO_END extends TRANSITION_EVENTS
  /* 2 */ val SNAP_TO_END: typingsSlinky.reactMapGl.mod.TRANSITION_EVENTS.SNAP_TO_END with Double = js.native
  
  @js.native
  sealed trait UPDATE extends TRANSITION_EVENTS
  /* 4 */ val UPDATE: typingsSlinky.reactMapGl.mod.TRANSITION_EVENTS.UPDATE with Double = js.native
}
