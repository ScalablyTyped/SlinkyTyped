...
name := "react-map-gl"
version := "5.2-dt-20201104Z-a030bb"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "mapbox-gl" % "1.12-dt-20201117Z-d94b30",
  ...
  "org.scalablytyped.slinky" %%% "viewport-mercator-project" % "6.1-dt-20200809Z-8161b6")
