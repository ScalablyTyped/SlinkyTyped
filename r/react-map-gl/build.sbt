...
name := "react-map-gl"
version := "5.0-dt-20191115Z-240a71"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "gl-matrix" % "2.4-dt-20190322Z-030af0",
  ...
  "org.scalablytyped.slinky" %%% "viewport-mercator-project" % "6.1-dt-20190313Z-cfff75")
