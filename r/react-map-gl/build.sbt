...
name := "react-map-gl"
version := "5.2-dt-20200426Z-ec63e7"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "gl-matrix" % "2.4-dt-20200225Z-bf11ab",
  ...
  "org.scalablytyped.slinky" %%% "viewport-mercator-project" % "6.1-dt-20190313Z-25c37f")
