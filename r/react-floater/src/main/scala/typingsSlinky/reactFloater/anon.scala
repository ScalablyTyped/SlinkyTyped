...
object anon {
  ...
  object CSSPropertieslengthnumber {
    ...
    @scala.inline
    implicit class CSSPropertieslengthnumberMutableBuilder[Self <: CSSPropertieslengthnumber] (val x: Self) extends AnyVal {
  ...
  object Offset {
    ...
    implicit class OffsetMutableBuilder[Self <: Offset] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPlacement(value: Omit[Placement, center]): Self = StObject.set(x, "placement", value.asInstanceOf[js.Any])
  ...
  object PartialStyles {
    ...
    implicit class PartialStylesMutableBuilder[Self <: PartialStyles] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFloaterCenteredUndefined: Self = StObject.set(x, "floaterCentered", js.undefined)
      
      @scala.inline
      def setFloaterClosing(value: CSSProperties): Self = StObject.set(x, "floaterClosing", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFloaterClosingUndefined: Self = StObject.set(x, "floaterClosing", js.undefined)
      
      @scala.inline
      def setFloaterOpening(value: CSSProperties): Self = StObject.set(x, "floaterOpening", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFloaterOpeningUndefined: Self = StObject.set(x, "floaterOpening", js.undefined)
      
      @scala.inline
      def setFloaterUndefined: Self = StObject.set(x, "floater", js.undefined)
      
      @scala.inline
      def setFloaterWithAnimation(value: CSSProperties): Self = StObject.set(x, "floaterWithAnimation", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFloaterWithAnimationUndefined: Self = StObject.set(x, "floaterWithAnimation", js.undefined)
      
      @scala.inline
      def setFloaterWithComponent(value: CSSProperties): Self = StObject.set(x, "floaterWithComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFloaterWithComponentUndefined: Self = StObject.set(x, "floaterWithComponent", js.undefined)
      ...
      @scala.inline
      def setWrapperPositionUndefined: Self = StObject.set(x, "wrapperPosition", js.undefined)
