...
object ReactFloater
  ...
  def PropsWithComponent(
    ...
    callback: (/* action */ Action, /* props */ typingsSlinky.reactFloater.mod.PropsWithComponent | PropsWithContent) => Unit = null,
  ...
  def PropsWithContent(
    content: TagMod[Any],
    autoOpen: js.UndefOr[Boolean] = js.undefined,
    callback: (/* action */ Action, /* props */ PropsWithComponent | typingsSlinky.reactFloater.mod.PropsWithContent) => Unit = null,
    debug: js.UndefOr[Boolean] = js.undefined,
    disableAnimation: js.UndefOr[Boolean] = js.undefined,
    disableFlip: js.UndefOr[Boolean] = js.undefined,
    disableHoverToClick: js.UndefOr[Boolean] = js.undefined,
