...
import typingsSlinky.remotedevServer.remotedevServerBooleans.`true`
import typingsSlinky.remotedevServer.remotedevServerStrings.http
import typingsSlinky.remotedevServer.remotedevServerStrings.https
...
object mod {
  ...
  object LogLevel extends StObject {
    ...
    /* 1 */ val ERROR: typingsSlinky.remotedevServer.mod.LogLevel.ERROR with Double = js.native
    
    @js.native
    sealed trait INFO extends LogLevel
    /* 3 */ val INFO: typingsSlinky.remotedevServer.mod.LogLevel.INFO with Double = js.native
    
    @js.native
    sealed trait NONE extends LogLevel
    /* 0 */ val NONE: typingsSlinky.remotedevServer.mod.LogLevel.NONE with Double = js.native
    
    @js.native
    sealed trait WARN extends LogLevel
    /* 2 */ val WARN: typingsSlinky.remotedevServer.mod.LogLevel.WARN with Double = js.native
  }
