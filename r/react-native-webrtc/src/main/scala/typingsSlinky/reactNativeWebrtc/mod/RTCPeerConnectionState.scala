...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.reactNativeWebrtc.reactNativeWebrtcStrings.connecting
...
object RTCPeerConnectionState {
  ...
  @scala.inline
  def connecting: typingsSlinky.reactNativeWebrtc.reactNativeWebrtcStrings.connecting = "connecting".asInstanceOf[typingsSlinky.reactNativeWebrtc.reactNativeWebrtcStrings.connecting]
