...
import typingsSlinky.reactDashNativeDashSvgDashCharts.Anon_Id
...
import typingsSlinky.reactDashNativeDashSvgDashCharts.reactDashNativeDashSvgDashChartsMod.StackedBarChartProps
...
object StackedBarChart
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashSvgDashCharts.reactDashNativeDashSvgDashChartsMod.StackedBarChart[js.Any]
    ] {
  ...
  def apply[T](
    ...
    renderGradient: /* props */ Anon_Id => ReactComponentClass[LinearGradientProps | RadialGradientProps] = null,
