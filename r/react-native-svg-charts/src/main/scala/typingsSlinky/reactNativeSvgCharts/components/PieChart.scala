...
object PieChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvgCharts.mod.PieChart[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvgCharts.mod.PieChart[js.Any]] = {
  ...
  typingsSlinky.reactNativeSvgCharts.mod.PieChart[js.Any]]]
  }
