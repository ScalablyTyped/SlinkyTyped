...
import typingsSlinky.reactNativeSvgCharts.mod.BarChartProps
...
object BarChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvgCharts.mod.BarChart[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvgCharts.mod.BarChart[js.Any]] = {
  ...
  typingsSlinky.reactNativeSvgCharts.mod.BarChart[js.Any]]]
  }
  type Props = BarChartProps[js.Any]
}
