...
object LineChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvgCharts.mod.LineChart[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvgCharts.mod.LineChart[js.Any]] = {
  ...
  typingsSlinky.reactNativeSvgCharts.mod.LineChart[js.Any]]]
  }
  type Props = ChartProps[js.Any]
}
