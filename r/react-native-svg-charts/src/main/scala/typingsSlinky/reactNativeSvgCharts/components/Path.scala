...
object Path
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSvgCharts.mod.Path] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSvgCharts.mod.Path] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeSvgCharts.mod.Path] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeSvgCharts.mod.Path](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
