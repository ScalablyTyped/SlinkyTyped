...
object PartialLineProps {
  ...
  implicit class PartialLinePropsOps[Self <: PartialLineProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFill(value: typingsSlinky.reactNativeSvg.mod.Color): Self = this.set("fill", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStroke(value: typingsSlinky.reactNativeSvg.mod.Color): Self = this.set("stroke", value.asInstanceOf[js.Any])
    @scala.inline
