...
import typingsSlinky.reactNativeSvgCharts.reactNativeSvgChartsStrings.BOTH
...
object AnonBOTH {
  @scala.inline
  def apply(BOTH: BOTH, HORIZONTAL: HORIZONTAL, VERTICAL: VERTICAL): AnonBOTH = {
