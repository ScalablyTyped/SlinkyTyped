...
object StackedAreaChartProps {
  ...
  implicit class StackedAreaChartPropsOps[Self <: StackedAreaChartProps[_], T] (val x: Self with StackedAreaChartProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderGradient(value: /* props */ Color[T] => ReactComponentClass[LinearGradientProps | RadialGradientProps]): Self = this.set("renderGradient", js.Any.fromFunction1(value))
    @scala.inline
