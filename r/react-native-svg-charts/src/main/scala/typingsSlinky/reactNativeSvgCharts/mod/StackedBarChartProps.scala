...
object StackedBarChartProps {
  ...
  implicit class StackedBarChartPropsMutableBuilder[Self <: StackedBarChartProps[_], T] (val x: Self with StackedBarChartProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderGradient(value: /* props */ Id => ReactComponentClass[LinearGradientProps | RadialGradientProps]): Self = StObject.set(x, "renderGradient", js.Any.fromFunction1(value))
