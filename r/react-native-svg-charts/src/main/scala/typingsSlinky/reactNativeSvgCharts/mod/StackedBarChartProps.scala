...
object StackedBarChartProps {
  ...
  implicit class StackedBarChartPropsOps[Self <: StackedBarChartProps[_], T] (val x: Self with StackedBarChartProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderGradient(value: /* props */ Id => ReactComponentClass[LinearGradientProps | RadialGradientProps]): Self = this.set("renderGradient", js.Any.fromFunction1(value))
