...
object PieChartProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactNativeSvgCharts.mod.PieChartData */ T](data: js.Array[T]): PieChartProps[T] = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    __obj.asInstanceOf[PieChartProps[T]]
  }
  @scala.inline
  implicit class PieChartPropsOps[Self <: PieChartProps[_], /* <: typingsSlinky.reactNativeSvgCharts.mod.PieChartData */ T] (val x: Self with PieChartProps[T]) extends AnyVal {
    @scala.inline
