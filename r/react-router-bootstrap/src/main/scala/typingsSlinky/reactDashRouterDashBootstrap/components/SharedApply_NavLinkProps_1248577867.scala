package typingsSlinky.reactDashRouterDashBootstrap.components
...
abstract class SharedApply_NavLinkProps_1248577867 (implicit pw: ExternalPropsWriterProvider)
