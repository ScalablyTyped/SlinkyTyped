package typingsSlinky.reactSwipeableViews.components
...
import typingsSlinky.reactSwipeableViews.mod.SpringConfig
import typingsSlinky.reactSwipeableViews.mod.SwipeableViewsProps
import typingsSlinky.reactSwipeableViews.mod.default
...
object ReactSwipeableViews {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def animateHeight(value: Boolean): this.type = set("animateHeight", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def axis(value: AxisType): this.type = set("axis", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def disableLazyLoading(value: Boolean): this.type = set("disableLazyLoading", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def enableMouseEvents(value: Boolean): this.type = set("enableMouseEvents", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def ignoreNativeScroll(value: Boolean): this.type = set("ignoreNativeScroll", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChangeIndex(value: (/* index */ Double, /* indexLatest */ Double) => Unit): this.type = set("onChangeIndex", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def onSwitching(value: (/* index */ Double, /* type */ OnSwitchingCallbackTypeDescriptor) => Unit): this.type = set("onSwitching", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def resistance(value: Boolean): this.type = set("resistance", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def slideClassName(value: String): this.type = set("slideClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def slideStyle(value: CSSProperties): this.type = set("slideStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def springConfig(value: SpringConfig): this.type = set("springConfig", value.asInstanceOf[js.Any])
    @scala.inline
