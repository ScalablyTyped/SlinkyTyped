...
object BaseFormProps {
  ...
  @scala.inline
  implicit class BaseFormPropsOps[Self <: BaseFormProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOnReset(value: SyntheticEvent[EventTarget with HTMLFormElement, Event_] => Unit): Self = {
        val ret = this.duplicate
