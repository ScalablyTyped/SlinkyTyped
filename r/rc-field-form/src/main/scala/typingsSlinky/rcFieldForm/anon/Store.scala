...
trait Store extends js.Object {
  var store: typingsSlinky.rcFieldForm.interfaceMod.Store
}
...
object Store {
  ...
  implicit class StoreOps[Self <: Store] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStore(value: typingsSlinky.rcFieldForm.interfaceMod.Store): Self = this.set("store", value.asInstanceOf[js.Any])
  }
