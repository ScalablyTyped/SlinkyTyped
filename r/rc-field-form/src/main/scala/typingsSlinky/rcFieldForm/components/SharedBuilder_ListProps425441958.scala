...
class SharedBuilder_ListProps425441958 (val args: js.Array[js.Any])
  ...
  @scala.inline
  def initialValue(value: js.Array[_]): this.type = set("initialValue", value.asInstanceOf[js.Any])
  
  @scala.inline
  def initialValueVarargs(value: js.Any*): this.type = set("initialValue", js.Array(value :_*))
