...
object Component {
  ...
  object Component {
    ...
    implicit def make[Values](companion: Component.type): SharedBuilder_FieldProps1642681149[Values] = new SharedBuilder_FieldProps1642681149[Values](js.Array(this.component, js.Dictionary.empty))()
