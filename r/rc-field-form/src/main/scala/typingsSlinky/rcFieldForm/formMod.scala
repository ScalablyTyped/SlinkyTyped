...
object formMod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefRenderFunction[FormInstance[js.Any], FormProps[js.Any]] = js.native
  
  /* Inlined std.Omit<react.react.FormHTMLAttributes<std.HTMLFormElement>, 'onSubmit'> */
  @js.native
  trait BaseFormProps extends StObject {
  ...
  object BaseFormProps {
    ...
    @scala.inline
    def apply(): BaseFormProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BaseFormProps]
    }
    
    @scala.inline
    implicit class BaseFormPropsMutableBuilder[Self <: BaseFormProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: SyntheticEvent[EventTarget with HTMLFormElement, Event] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnReset(value: SyntheticEvent[EventTarget with HTMLFormElement, Event] => Unit): Self = StObject.set(x, "onReset", js.Any.fromFunction1(value))
  ...
  object FormProps {
    ...
    @scala.inline
    implicit class FormPropsMutableBuilder[Self <: FormProps[_], Values] (val x: Self with FormProps[Values]) extends AnyVal {
      
      @scala.inline
      def setChildren(value: RenderProps | ReactElement): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction2(value: (/* values */ Store, /* form */ FormInstance[js.Any]) => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setComponent(value: `false` | String | ReactComponentClass[_]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFields(value: js.Array[FieldData]): Self = StObject.set(x, "fields", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFieldsUndefined: Self = StObject.set(x, "fields", js.undefined)
      
      @scala.inline
      def setFieldsVarargs(value: FieldData*): Self = StObject.set(x, "fields", js.Array(value :_*))
      
      @scala.inline
      def setForm(value: FormInstance[Values]): Self = StObject.set(x, "form", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFormUndefined: Self = StObject.set(x, "form", js.undefined)
      
      @scala.inline
      def setInitialValues(value: Store): Self = StObject.set(x, "initialValues", value.asInstanceOf[js.Any])
  ...
  type RenderProps = js.Function2[/* values */ Store, /* form */ FormInstance[js.Any], ReactElement]
  
  type _To = ForwardRefRenderFunction[FormInstance[js.Any], FormProps[js.Any]]
  
  /* This means you don't have to write `default`, but can instead just say `formMod.foo` */
  override def _to: ForwardRefRenderFunction[FormInstance[js.Any], FormProps[js.Any]] = default
}
