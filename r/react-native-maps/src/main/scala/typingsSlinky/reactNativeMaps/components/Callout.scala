...
object Callout {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.Callout] {
    @scala.inline
  ...
  def withProps(p: MapCalloutProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
