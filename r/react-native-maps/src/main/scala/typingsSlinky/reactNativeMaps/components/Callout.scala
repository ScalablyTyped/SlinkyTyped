...
object Callout
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.Callout] {
  ...
  def apply(
    ...
    onPress: SyntheticEvent[NodeHandle, Anon0 with AnonCoordinate] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.Callout] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.Callout] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeMaps.mod.Callout](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
