...
import typingsSlinky.reactNativeMaps.mod.MapUrlTileProps
...
object UrlTile {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.UrlTile] {
    ...
    @scala.inline
    def maximumZ(value: Double): this.type = set("maximumZ", value.asInstanceOf[js.Any])
  ...
  def withProps(p: MapUrlTileProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(urlTemplate: String): Builder = {
    val __props = js.Dynamic.literal(urlTemplate = urlTemplate.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MapUrlTileProps]))
  }
}
