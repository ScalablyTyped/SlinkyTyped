...
object UrlTile
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.UrlTile] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.UrlTile] = {
