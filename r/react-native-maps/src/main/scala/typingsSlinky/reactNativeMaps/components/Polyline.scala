...
object Polyline
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.Polyline] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.Polyline] = {
