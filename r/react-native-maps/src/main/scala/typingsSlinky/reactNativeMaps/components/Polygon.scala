...
object Polygon
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.Polygon] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.Polygon] = {
