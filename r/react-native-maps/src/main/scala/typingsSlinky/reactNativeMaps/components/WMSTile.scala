...
object WMSTile
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.WMSTile] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.WMSTile] = {
