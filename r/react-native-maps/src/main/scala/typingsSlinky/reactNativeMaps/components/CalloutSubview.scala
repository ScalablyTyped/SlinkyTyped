...
object CalloutSubview {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.CalloutSubview] {
    @scala.inline
    ...
    @scala.inline
    def onPress(value: SyntheticEvent[NodeHandle, Anon1 with AnonCoordinate] => Unit): this.type = set("onPress", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: MapCalloutSubviewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CalloutSubview.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
