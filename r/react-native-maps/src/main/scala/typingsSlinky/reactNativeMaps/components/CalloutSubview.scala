...
import typingsSlinky.reactNativeMaps.mod.MapCalloutSubviewProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object CalloutSubview
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.CalloutSubview] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.CalloutSubview] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.CalloutSubview] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeMaps.mod.CalloutSubview](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MapCalloutSubviewProps
}
