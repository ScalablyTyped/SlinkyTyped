...
object Circle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.Circle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.Circle] = {
