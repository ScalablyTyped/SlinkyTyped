...
import typingsSlinky.reactNativeMaps.mod.MapLocalTileProps
...
object LocalTile {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.LocalTile] {
    @scala.inline
  ...
  def withProps(p: MapLocalTileProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(pathTemplate: String): Builder = {
    val __props = js.Dynamic.literal(pathTemplate = pathTemplate.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MapLocalTileProps]))
  }
}
