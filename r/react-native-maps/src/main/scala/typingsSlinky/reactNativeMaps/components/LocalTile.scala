...
object LocalTile
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeMaps.mod.LocalTile] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeMaps.mod.LocalTile] = {
