...
abstract class SharedApply_MarkerProps1253354942[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: draggable, title */
  def apply(
    ...
    onDeselect: SyntheticEvent[NodeHandle, AnonActionId with AnonCoordinate] => Unit = null,
    onDrag: SyntheticEvent[NodeHandle, js.Object with AnonCoordinate] => Unit = null,
    onDragEnd: SyntheticEvent[NodeHandle, js.Object with AnonCoordinate] => Unit = null,
    onDragStart: SyntheticEvent[NodeHandle, js.Object with AnonCoordinate] => Unit = null,
    ...
    onPress: SyntheticEvent[NodeHandle, AnonAction with AnonCoordinate] => Unit = null,
    ...
    onSelect: SyntheticEvent[NodeHandle, AnonId with AnonCoordinate] => Unit = null,
