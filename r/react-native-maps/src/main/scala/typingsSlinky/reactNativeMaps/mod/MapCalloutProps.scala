...
trait MapCalloutProps extends ViewProps {
  var onPress: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, Anon0 with AnonCoordinate], Unit]] = js.native
...
object MapCalloutProps {
  ...
  implicit class MapCalloutPropsOps[Self <: MapCalloutProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnPress(value: SyntheticEvent[NodeHandle, Anon0 with AnonCoordinate] => Unit): Self = {
