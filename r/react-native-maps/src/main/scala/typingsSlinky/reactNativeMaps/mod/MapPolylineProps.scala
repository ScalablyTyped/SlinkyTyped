...
object MapPolylineProps {
  ...
  implicit class MapPolylinePropsOps[Self <: MapPolylineProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCoordinates(value: js.Array[LatLng]): Self = {
    ...
    @scala.inline
    def withStrokeColors(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("strokeColors")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStrokeColors: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("strokeColors")(js.undefined)
        ret
    }
    @scala.inline
