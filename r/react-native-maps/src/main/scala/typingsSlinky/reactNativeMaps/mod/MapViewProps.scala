...
trait MapViewProps extends ViewProps {
  ...
  var onCalloutPress: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, Anon0 with AnonCoordinate], Unit]] = js.undefined
  var onKmlReady: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, AnonMarkers], Unit]] = js.undefined
  var onLongPress: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, js.Object with AnonCoordinate], Unit]] = js.undefined
  var onMapReady: js.UndefOr[js.Function0[Unit]] = js.undefined
  var onMarkerDeselect: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, AnonActionId with AnonCoordinate], Unit]] = js.undefined
  var onMarkerDrag: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, js.Object with AnonCoordinate], Unit]] = js.undefined
  var onMarkerDragEnd: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, js.Object with AnonCoordinate], Unit]] = js.undefined
  var onMarkerDragStart: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, js.Object with AnonCoordinate], Unit]] = js.undefined
  var onMarkerPress: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, AnonAction with AnonCoordinate], Unit]] = js.undefined
  var onMarkerSelect: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, AnonId with AnonCoordinate], Unit]] = js.undefined
  var onPanDrag: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, js.Object with AnonCoordinate], Unit]] = js.undefined
  var onPoiClick: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, AnonName with AnonCoordinate], Unit]] = js.undefined
  var onPress: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, js.Object with AnonCoordinate], Unit]] = js.undefined
