...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNativeMaps.reactNativeMapsStrings.standard
  - typingsSlinky.reactNativeMaps.reactNativeMapsStrings.satellite
  - typingsSlinky.reactNativeMaps.reactNativeMapsStrings.hybrid
  - typingsSlinky.reactNativeMaps.reactNativeMapsStrings.terrain
