...
trait MapCalloutSubviewProps extends ViewProps {
  var onPress: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, Anon1 with AnonCoordinate], Unit]] = js.undefined
}
...
object MapCalloutSubviewProps {
  ...
  def apply(
    ...
    onPress: SyntheticEvent[NodeHandle, Anon1 with AnonCoordinate] => Unit = null,
