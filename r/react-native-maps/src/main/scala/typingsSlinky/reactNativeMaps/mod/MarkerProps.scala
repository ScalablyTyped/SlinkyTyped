...
object MarkerProps {
  ...
  implicit class MarkerPropsOps[Self <: MarkerProps] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("onDeselect", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnSelect(value: SyntheticEvent[NodeHandle, Id with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit): Self = this.set("onSelect", js.Any.fromFunction1(value))
    @scala.inline
