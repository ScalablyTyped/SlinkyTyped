...
object MarkerProps {
  ...
  implicit class MarkerPropsMutableBuilder[Self <: MarkerProps] (val x: Self) extends AnyVal {
    ...
    ): Self = StObject.set(x, "onDeselect", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnSelect(value: SyntheticEvent[NodeHandle, Id with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
