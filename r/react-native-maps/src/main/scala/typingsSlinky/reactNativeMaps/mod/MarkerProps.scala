...
object MarkerProps {
  ...
  def apply(
    ...
    onDeselect: SyntheticEvent[NodeHandle, ActionId with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit = null,
    onDrag: SyntheticEvent[NodeHandle, js.Object with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit = null,
    onDragEnd: SyntheticEvent[NodeHandle, js.Object with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit = null,
    onDragStart: SyntheticEvent[NodeHandle, js.Object with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit = null,
    ...
    onPress: SyntheticEvent[NodeHandle, Action with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit = null,
    ...
    onSelect: SyntheticEvent[NodeHandle, Id with typingsSlinky.reactNativeMaps.anon.Coordinate] => Unit = null,
    ...
    if (!js.isUndefined(tracksInfoWindowChanges)) __obj.updateDynamic("tracksInfoWindowChanges")(tracksInfoWindowChanges.get.asInstanceOf[js.Any])
    if (!js.isUndefined(tracksViewChanges)) __obj.updateDynamic("tracksViewChanges")(tracksViewChanges.get.asInstanceOf[js.Any])
