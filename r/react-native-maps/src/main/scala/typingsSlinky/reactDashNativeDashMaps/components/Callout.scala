...
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.MapCalloutProps
...
object Callout
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.Callout] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.Callout] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.Callout] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.Callout](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = MapCalloutProps
}
