...
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.MapCalloutSubviewProps
...
object CalloutSubview
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.CalloutSubview
    ] {
  ...
  typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.CalloutSubview](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
