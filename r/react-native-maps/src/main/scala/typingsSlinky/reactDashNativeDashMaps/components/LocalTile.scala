...
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.MapLocalTileProps
...
object LocalTile
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.LocalTile
    ] {
