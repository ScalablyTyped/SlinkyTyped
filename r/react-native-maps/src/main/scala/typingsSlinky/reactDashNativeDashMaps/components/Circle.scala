...
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.MapCircleProps
...
object Circle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.Circle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.Circle] = {
