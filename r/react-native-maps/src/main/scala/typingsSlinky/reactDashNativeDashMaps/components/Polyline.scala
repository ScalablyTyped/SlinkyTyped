...
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.LineCapType
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.LineJoinType
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.MapEvent
import typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.MapPolylineProps
...
object Polyline
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashMaps.reactDashNativeDashMapsMod.Polyline
    ] {
