...
object mod {
  ...
  object AriaModalProps {
    ...
    implicit class AriaModalPropsMutableBuilder[Self <: AriaModalProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setApplicationNodeElement(value: Element): Self = StObject.set(x, "applicationNode", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setApplicationNodeNode(value: Node): Self = StObject.set(x, "applicationNode", value.asInstanceOf[js.Any])
  ...
  type RequiredAriaTypes[T, U] = (typingsSlinky.reactAriaModal.reactAriaModalStrings.RequiredAriaTypes with TopLevel[T] with TopLevel[js.Any]) | (typingsSlinky.reactAriaModal.reactAriaModalStrings.RequiredAriaTypes with TopLevel[js.Any] with TopLevel[U])
}
