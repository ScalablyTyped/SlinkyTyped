...
object AriaModalProps {
  ...
  implicit class AriaModalPropsOps[Self <: AriaModalProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApplicationNodeNode(value: Node): Self = this.set("applicationNode", value.asInstanceOf[js.Any])
    @scala.inline
    def setApplicationNodeElement(value: Element): Self = this.set("applicationNode", value.asInstanceOf[js.Any])
    @scala.inline
