...
object LifecycleComponent
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactLifecycleComponent.mod.LifecycleComponent] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactLifecycleComponent.mod.LifecycleComponent] = {
  ...
  type Props = typingsSlinky.reactLifecycleComponent.mod.Props[js.Any, js.Any]
}
