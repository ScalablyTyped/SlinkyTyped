...
object RellaxInstance {
  ...
  implicit class RellaxInstanceOps[Self <: RellaxInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElmsNodeListOf(value: NodeListOf[Element with Node]): Self = this.set("elms", value.asInstanceOf[js.Any])
    @scala.inline
    def setElms(value: (NodeListOf[Element with Node]) | js.Array[Element]): Self = this.set("elms", value.asInstanceOf[js.Any])
    @scala.inline
