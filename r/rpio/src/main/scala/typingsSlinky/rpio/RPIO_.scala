package typingsSlinky.rpio

import typingsSlinky.rpio.rpioStrings.`raspi-2`
import typingsSlinky.rpio.rpioStrings.`raspi-3`
import typingsSlinky.rpio.rpioStrings.`raspi-aPlussign`
import typingsSlinky.rpio.rpioStrings.`raspi-a`
import typingsSlinky.rpio.rpioStrings.`raspi-b-r1`
import typingsSlinky.rpio.rpioStrings.`raspi-bPlussign`
import typingsSlinky.rpio.rpioStrings.`raspi-b`
import typingsSlinky.rpio.rpioStrings.`raspi-zero-w`
import typingsSlinky.rpio.rpioStrings.`raspi-zero`
import typingsSlinky.rpio.rpioStrings.gpio
import typingsSlinky.rpio.rpioStrings.physical
