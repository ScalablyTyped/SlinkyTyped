...
import typingsSlinky.reactJoyride.mod.Placement
import typingsSlinky.reactJoyride.mod.PlacementBeacon
...
object reactJoyrideStrings {
  ...
  @js.native
  sealed trait errorColontarget_not_found extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait stepColonafter extends StObject
  @scala.inline
  def stepColonafter: stepColonafter = "step:after".asInstanceOf[stepColonafter]
  
  @js.native
  sealed trait stepColonbefore extends StObject
  @scala.inline
