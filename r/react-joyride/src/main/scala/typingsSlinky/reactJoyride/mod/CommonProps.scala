...
object CommonProps {
  ...
  implicit class CommonPropsMutableBuilder[Self <: CommonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBeaconComponent(value: ReactElement): Self = StObject.set(x, "beaconComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBeaconComponentComponentClass(value: ReactComponentClass[BeaconRenderProps]): Self = StObject.set(x, "beaconComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBeaconComponentFunctionComponent(value: ReactComponentClass[BeaconRenderProps]): Self = StObject.set(x, "beaconComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTooltipComponent(value: ReactElement): Self = StObject.set(x, "tooltipComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTooltipComponentComponentClass(value: ReactComponentClass[TooltipRenderProps]): Self = StObject.set(x, "tooltipComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTooltipComponentFunctionComponent(value: ReactComponentClass[TooltipRenderProps]): Self = StObject.set(x, "tooltipComponent", value.asInstanceOf[js.Any])
