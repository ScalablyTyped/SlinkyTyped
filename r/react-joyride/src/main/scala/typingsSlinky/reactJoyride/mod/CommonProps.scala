...
object CommonProps {
  ...
  implicit class CommonPropsOps[Self <: CommonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBeaconComponentFunctionComponent(value: ReactComponentClass[BeaconRenderProps]): Self = this.set("beaconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setBeaconComponentComponentClass(value: ReactComponentClass[BeaconRenderProps]): Self = this.set("beaconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setBeaconComponent(value: ReactElement): Self = this.set("beaconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTooltipComponentFunctionComponent(value: ReactComponentClass[TooltipRenderProps]): Self = this.set("tooltipComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setTooltipComponentComponentClass(value: ReactComponentClass[TooltipRenderProps]): Self = this.set("tooltipComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setTooltipComponent(value: ReactElement): Self = this.set("tooltipComponent", value.asInstanceOf[js.Any])
    @scala.inline
