...
object Prompt
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterNative.mod.Prompt] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterNative.mod.Prompt] = {
