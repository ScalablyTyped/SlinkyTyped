...
object Redirect
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterNative.mod.Redirect] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterNative.mod.Redirect] = {
