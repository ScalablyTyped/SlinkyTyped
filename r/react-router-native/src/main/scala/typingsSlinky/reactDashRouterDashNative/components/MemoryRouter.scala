...
object MemoryRouter
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashRouterDashNative.reactDashRouterDashNativeMod.MemoryRouter
    ] {
  ...
  typingsSlinky.reactDashRouterDashNative.reactDashRouterDashNativeMod.MemoryRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
