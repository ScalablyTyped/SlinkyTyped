...
object NativeRouter
  ...
  typingsSlinky.reactDashRouterDashNative.reactDashRouterDashNativeMod.NativeRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
