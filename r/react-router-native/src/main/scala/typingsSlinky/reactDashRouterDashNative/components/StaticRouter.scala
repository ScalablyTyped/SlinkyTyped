...
object StaticRouter
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashRouterDashNative.reactDashRouterDashNativeMod.StaticRouter
    ] {
  ...
  typingsSlinky.reactDashRouterDashNative.reactDashRouterDashNativeMod.StaticRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
