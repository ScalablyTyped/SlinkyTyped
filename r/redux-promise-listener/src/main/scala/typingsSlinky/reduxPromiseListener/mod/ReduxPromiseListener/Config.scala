...
object Config {
  @scala.inline
  def apply[/* <: typingsSlinky.redux.mod.AnyAction */ StartAction, /* <: typingsSlinky.redux.mod.AnyAction */ ResolveAction, /* <: typingsSlinky.redux.mod.AnyAction */ RejectAction, TReturn](reject: String | ActionMatcher, resolve: String | ActionMatcher, start: String): Config[StartAction, ResolveAction, RejectAction, TReturn] = {
  ...
  @scala.inline
  implicit class ConfigOps[Self <: Config[_, _, _, _], /* <: typingsSlinky.redux.mod.AnyAction */ StartAction, /* <: typingsSlinky.redux.mod.AnyAction */ ResolveAction, /* <: typingsSlinky.redux.mod.AnyAction */ RejectAction, TReturn] (val x: Self with (Config[StartAction, ResolveAction, RejectAction, TReturn])) extends AnyVal {
    @scala.inline
