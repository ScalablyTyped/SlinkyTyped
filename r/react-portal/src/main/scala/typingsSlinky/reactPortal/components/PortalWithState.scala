...
object PortalWithState
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactPortal.mod.PortalWithState] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactPortal.mod.PortalWithState] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactPortal.mod.PortalWithState] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactPortal.mod.PortalWithState](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
