...
object ReactDashNativeDashCollapsible
  ...
  typingsSlinky.reactDashNativeDashCollapsible.reactDashNativeDashCollapsibleMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
