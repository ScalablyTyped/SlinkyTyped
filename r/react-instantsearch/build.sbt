...
version := "6.3-dt-20200515Z-a92c34"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-instantsearch-dom" % "6.3-dt-20200515Z-d84b65",
  "org.scalablytyped.slinky" %%% "react-instantsearch-native" % "6.3-dt-20200323Z-88fa5b",
