...
object anon {
  ...
  trait ReadonlySearchBoxProps extends StObject {
    ...
    val loadingIndicator: js.UndefOr[ReactElement] = js.native
    
    val onChange: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLInputElement], _]] = js.native
    
    val onReset: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLFormElement], _]] = js.native
    
    val onSubmit: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event, HTMLFormElement], _]] = js.native
    
    val reset: js.UndefOr[ReactElement] = js.native
    
    val searchAsYouType: js.UndefOr[Boolean] = js.native
    
    val showLoadingIndicator: js.UndefOr[Boolean] = js.native
    
    val submit: js.UndefOr[ReactElement] = js.native
