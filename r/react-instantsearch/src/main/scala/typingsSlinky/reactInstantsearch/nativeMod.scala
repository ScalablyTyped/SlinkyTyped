...
object nativeMod {
  ...
  class Configure protected ()
    extends typingsSlinky.reactInstantsearchNative.mod.Configure {
  ...
  class Index protected ()
    extends typingsSlinky.reactInstantsearchNative.mod.Index {
    def this(props: js.Any) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  class InstantSearch protected ()
    extends typingsSlinky.reactInstantsearchNative.mod.InstantSearch {
