...
object AsyncQueueAction {
  @scala.inline
  def apply[/* <: typingsSlinky.redux.mod.Action[_] */ T](callback: (js.Function0[Unit], Dispatch[T]) => Unit, queue: String): AsyncQueueAction[T] = {
  ...
  @scala.inline
  implicit class AsyncQueueActionOps[Self <: AsyncQueueAction[_], /* <: typingsSlinky.redux.mod.Action[_] */ T] (val x: Self with AsyncQueueAction[T]) extends AnyVal {
    @scala.inline
