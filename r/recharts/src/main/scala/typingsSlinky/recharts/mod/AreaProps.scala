...
trait AreaProps extends js.Object {
  ...
  var dot: js.UndefOr[Boolean | js.Object | ReactElement | ContentRenderer[DotProps]] = js.native
...
object AreaProps {
  ...
  implicit class AreaPropsOps[Self <: AreaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActiveDot(value: Boolean | js.Object | ReactElement | ContentRenderer[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activeDot")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withDot(value: Boolean | js.Object | ReactElement | ContentRenderer[DotProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dot")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withLabel(value: Boolean | js.Object | ContentRenderer[_] | ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(value.asInstanceOf[js.Any])
        ret
    }
