...
object TextProps {
  ...
  implicit class TextPropsOps[Self <: TextProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCapHeight(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScaleToFit(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleToFit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutScaleToFit: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleToFit")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTextAnchor(value: start | middle | end | inherit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVerticalAnchor(value: start | middle | end): Self = {
        val ret = this.duplicate
