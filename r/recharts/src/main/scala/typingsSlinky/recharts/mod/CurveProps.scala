...
object CurveProps {
  ...
  implicit class CurvePropsOps[Self <: CurveProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBaseLine(value: Double | js.Array[_]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPathRefRefObject(value: ReactRef[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pathRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPathRefFunction1(value: /* instance */ _ | Null => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pathRef")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPathRef(value: Ref[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pathRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPathRef: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pathRef")(js.undefined)
        ret
    }
    @scala.inline
    def withPathRefNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pathRef")(null)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPoints(value: js.Array[js.Object]): Self = {
        val ret = this.duplicate
