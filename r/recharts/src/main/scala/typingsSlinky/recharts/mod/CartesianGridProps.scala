...
object CartesianGridProps {
  ...
  implicit class CartesianGridPropsMutableBuilder[Self <: CartesianGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHorizontalFunction1(value: LineProps with CartesianGridProps => ReactElement): Self = StObject.set(x, "horizontal", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setHorizontalReactElement(value: ReactElement): Self = StObject.set(x, "horizontal", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVerticalFunction1(value: LineProps with CartesianGridProps => ReactElement): Self = StObject.set(x, "vertical", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setVerticalReactElement(value: ReactElement): Self = StObject.set(x, "vertical", value.asInstanceOf[js.Any])
