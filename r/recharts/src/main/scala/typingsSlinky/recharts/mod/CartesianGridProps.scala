...
object CartesianGridProps {
  ...
  implicit class CartesianGridPropsOps[Self <: CartesianGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHorizontalReactElement(value: ReactElement): Self = this.set("horizontal", value.asInstanceOf[js.Any])
    @scala.inline
    def setHorizontalFunction1(value: LineProps with CartesianGridProps => ReactElement): Self = this.set("horizontal", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setVerticalReactElement(value: ReactElement): Self = this.set("vertical", value.asInstanceOf[js.Any])
    @scala.inline
    def setVerticalFunction1(value: LineProps with CartesianGridProps => ReactElement): Self = this.set("vertical", js.Any.fromFunction1(value))
    @scala.inline
