...
trait LabelProps extends js.Object {
  ...
  var viewBox: js.UndefOr[ViewBox | PolarViewBox] = js.native
...
object LabelProps {
  ...
  implicit class LabelPropsOps[Self <: LabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentFunction1(value: _ => ReactElement): Self = this.set("content", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setFormatter(value: /* label */ String | Double => ReactElement): Self = this.set("formatter", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setViewBox(value: ViewBox | PolarViewBox): Self = this.set("viewBox", value.asInstanceOf[js.Any])
    @scala.inline
