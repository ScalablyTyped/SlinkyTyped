...
object LabelProps {
  ...
  implicit class LabelPropsMutableBuilder[Self <: LabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentFunction1(value: _ => ReactElement): Self = StObject.set(x, "content", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setViewBox(value: ViewBox | PolarViewBox): Self = StObject.set(x, "viewBox", value.asInstanceOf[js.Any])
