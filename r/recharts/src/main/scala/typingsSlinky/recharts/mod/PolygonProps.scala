...
@js.native
trait PolygonProps extends js.Object {
  ...
  var points: js.UndefOr[js.Array[PolygonPoint]] = js.native
...
object PolygonProps {
  ...
  implicit class PolygonPropsOps[Self <: PolygonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPointsVarargs(value: PolygonPoint*): Self = this.set("points", js.Array(value :_*))
    
    @scala.inline
    def setPoints(value: js.Array[PolygonPoint]): Self = this.set("points", value.asInstanceOf[js.Any])
