...
object PolygonProps {
  ...
  implicit class PolygonPropsMutableBuilder[Self <: PolygonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPoints(value: js.Array[PolygonPoint]): Self = StObject.set(x, "points", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPointsUndefined: Self = StObject.set(x, "points", js.undefined)
    
    @scala.inline
    def setPointsVarargs(value: PolygonPoint*): Self = StObject.set(x, "points", js.Array(value :_*))
