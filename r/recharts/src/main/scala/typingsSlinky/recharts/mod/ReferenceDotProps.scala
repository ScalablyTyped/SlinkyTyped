...
object ReferenceDotProps {
  ...
  implicit class ReferenceDotPropsOps[Self <: ReferenceDotProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClassName(value: Double | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIfOverflow(value: IfOverflowType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ifOverflow")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIfOverflow: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ifOverflow")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsFront(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isFront")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsFront: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isFront")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLabelFunction1(value: /* repeated */ js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withLabel(value: String | Double | ReactElement | RechartsFunction): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withShapeFunction1(value: EventAttributesPartialPre => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withShape(value: ContentRenderer[EventAttributesPartialPre] | ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withXAxis(value: ReferenceDotAxisConfiguration): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withYAxis(value: ReferenceDotAxisConfiguration): Self = {
        val ret = this.duplicate
