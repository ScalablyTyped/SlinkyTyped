...
object ScatterProps {
  ...
  implicit class ScatterPropsOps[Self <: ScatterProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActiveShapeFunction1(value: /* repeated */ js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activeShape")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withActiveShape(value: js.Object | RechartsFunction | ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activeShape")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withLineReactElement(value: ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("line")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLineFunction1(value: /* repeated */ js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("line")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withLine(value: Boolean | js.Object | RechartsFunction | ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("line")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withLineJointTypeFunction1(value: /* context */ CanvasRenderingContext2D | Path_ => CurveGenerator): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lineJointType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withLineJointType(value: LineType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lineJointType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLineJointType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lineJointType")(js.undefined)
        ret
    }
    @scala.inline
    def withLineType(value: joint | fitting): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoints(value: js.Array[ScatterPoint]): Self = {
        val ret = this.duplicate
