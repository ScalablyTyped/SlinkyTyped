...
object XAxisProps {
  ...
  implicit class XAxisPropsMutableBuilder[Self <: XAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTickFunction1(value: _ => ReactElement): Self = StObject.set(x, "tick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTickReactElement(value: ReactElement): Self = StObject.set(x, "tick", value.asInstanceOf[js.Any])
