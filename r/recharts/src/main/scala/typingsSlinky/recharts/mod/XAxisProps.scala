...
object XAxisProps {
  ...
  implicit class XAxisPropsOps[Self <: XAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllowDuplicatedCategory(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowDuplicatedCategory")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAllowDuplicatedCategory: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowDuplicatedCategory")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOrientation(value: top | bottom): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: XPadding): Self = {
        val ret = this.duplicate
