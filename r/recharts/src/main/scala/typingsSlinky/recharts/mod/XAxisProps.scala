...
object XAxisProps {
  ...
  implicit class XAxisPropsOps[Self <: XAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTickReactElement(value: ReactElement): Self = this.set("tick", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTickFunction1(value: _ => ReactElement): Self = this.set("tick", js.Any.fromFunction1(value))
