...
object RadarProps {
  ...
  implicit class RadarPropsMutableBuilder[Self <: RadarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDotFunction1(value: DotProps => ReactElement): Self = StObject.set(x, "dot", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setShapeFunction1(value: RadarProps => ReactElement): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
