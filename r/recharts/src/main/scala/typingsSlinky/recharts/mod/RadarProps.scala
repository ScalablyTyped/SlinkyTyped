...
object RadarProps {
  ...
  implicit class RadarPropsOps[Self <: RadarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDotFunction1(value: DotProps => ReactElement): Self = this.set("dot", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setShapeFunction1(value: RadarProps => ReactElement): Self = this.set("shape", js.Any.fromFunction1(value))
