...
object RadarProps {
  ...
  implicit class RadarPropsOps[Self <: RadarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabel(value: js.Object | ReactElement | ContentRenderer[_] | Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withPoints(value: js.Array[RadarPoint]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShapeFunction1(value: RadarProps => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withShape(value: ReactElement | ContentRenderer[RadarProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(value.asInstanceOf[js.Any])
        ret
    }
