...
@js.native
trait PieProps extends StObject {
  ...
  var blendStroke: js.UndefOr[Boolean] = js.native
  ...
  var midAngle: js.UndefOr[Double] = js.native
  
  var minAngle: js.UndefOr[Double] = js.native
  
  var nameKey: js.UndefOr[String | Double | (js.Function1[/* dataObject */ js.Any, Double])] = js.native
  ...
  var paddingAngle: js.UndefOr[Double] = js.native
  
  var pointerEvents: js.UndefOr[String] = js.native
  
  var r: js.UndefOr[Double] = js.native
  
  var sectors: js.UndefOr[js.Array[js.Object]] = js.native
  ...
  var valueKey: js.UndefOr[String | Double | (js.Function1[/* dataObject */ js.Any, Double])] = js.native
...
object PieProps {
  ...
  @scala.inline
  def apply(dataKey: DataKey): PieProps = {
    val __obj = js.Dynamic.literal(dataKey = dataKey.asInstanceOf[js.Any])
    __obj.asInstanceOf[PieProps]
  }
  
  @scala.inline
  implicit class PiePropsMutableBuilder[Self <: PieProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveShape(value: js.Object | ContentRenderer[_] | ReactElement): Self = StObject.set(x, "activeShape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActiveShapeFunction1(value: _ => ReactElement): Self = StObject.set(x, "activeShape", js.Any.fromFunction1(value))
    
    @scala.inline
    def setActiveShapeReactElement(value: ReactElement): Self = StObject.set(x, "activeShape", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBlendStroke(value: Boolean): Self = StObject.set(x, "blendStroke", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBlendStrokeUndefined: Self = StObject.set(x, "blendStroke", js.undefined)
    ...
    @scala.inline
    def setLabel(value: OffsetRadius | ReactElement | ContentRenderer[PieLabelRenderProps] | Boolean): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelFunction1(value: PieLabelRenderProps => ReactElement): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLabelLine(value: js.Object | (ContentRenderer[LineProps with js.Any]) | ReactElement | Boolean): Self = StObject.set(x, "labelLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelLineFunction1(value: LineProps with js.Any => ReactElement): Self = StObject.set(x, "labelLine", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLabelLineReactElement(value: ReactElement): Self = StObject.set(x, "labelLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMidAngle(value: Double): Self = StObject.set(x, "midAngle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMidAngleUndefined: Self = StObject.set(x, "midAngle", js.undefined)
    ...
    @scala.inline
    def setNameKey(value: String | Double | (js.Function1[/* dataObject */ js.Any, Double])): Self = StObject.set(x, "nameKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNameKeyFunction1(value: /* dataObject */ js.Any => Double): Self = StObject.set(x, "nameKey", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPaddingAngle(value: Double): Self = StObject.set(x, "paddingAngle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaddingAngleUndefined: Self = StObject.set(x, "paddingAngle", js.undefined)
    ...
    @scala.inline
    def setSectors(value: js.Array[js.Object]): Self = StObject.set(x, "sectors", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSectorsUndefined: Self = StObject.set(x, "sectors", js.undefined)
    
    @scala.inline
    def setSectorsVarargs(value: js.Object*): Self = StObject.set(x, "sectors", js.Array(value :_*))
    ...
    @scala.inline
    def setValueKey(value: String | Double | (js.Function1[/* dataObject */ js.Any, Double])): Self = StObject.set(x, "valueKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValueKeyFunction1(value: /* dataObject */ js.Any => Double): Self = StObject.set(x, "valueKey", js.Any.fromFunction1(value))
