...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.recharts.rechartsStrings.ease
  - typingsSlinky.recharts.rechartsStrings.`ease-in`
  - typingsSlinky.recharts.rechartsStrings.`ease-out`
  - typingsSlinky.recharts.rechartsStrings.`ease-in-out`
