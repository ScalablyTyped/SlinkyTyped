...
@js.native
trait CartesianAxisProps extends js.Object {
  ...
  var ticksGenerator: js.UndefOr[TickGeneratorFunction] = js.native
...
object CartesianAxisProps {
  @scala.inline
  def apply(): CartesianAxisProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CartesianAxisProps]
  }
  @scala.inline
  implicit class CartesianAxisPropsOps[Self <: CartesianAxisProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTicksGenerator(value: /* noTicksProps */ js.Object => js.Array[js.Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ticksGenerator")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutTicksGenerator: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ticksGenerator")(js.undefined)
        ret
    }
    @scala.inline
