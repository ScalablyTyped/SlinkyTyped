...
@js.native
trait CartesianAxisProps extends StObject {
...
object CartesianAxisProps {
  ...
  @scala.inline
  implicit class CartesianAxisPropsMutableBuilder[Self <: CartesianAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTicksGenerator(value: /* noTicksProps */ js.Object => js.Array[js.Any]): Self = StObject.set(x, "ticksGenerator", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTicksGeneratorUndefined: Self = StObject.set(x, "ticksGenerator", js.undefined)
