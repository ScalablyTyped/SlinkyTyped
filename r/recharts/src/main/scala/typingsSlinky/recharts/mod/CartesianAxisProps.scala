...
object CartesianAxisProps {
  ...
  implicit class CartesianAxisPropsOps[Self <: CartesianAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTicksGenerator(value: /* noTicksProps */ js.Object => js.Array[js.Any]): Self = this.set("ticksGenerator", js.Any.fromFunction1(value))
    @scala.inline
    def deleteTicksGenerator: Self = this.set("ticksGenerator", js.undefined)
    @scala.inline
