...
object LineProps {
  ...
  implicit class LinePropsOps[Self <: LineProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveDotReactElement(value: ReactElement): Self = this.set("activeDot", value.asInstanceOf[js.Any])
    @scala.inline
    def setActiveDotFunction1(value: _ => ReactElement): Self = this.set("activeDot", js.Any.fromFunction1(value))
    @scala.inline
    def setActiveDot(value: js.Object | ReactElement | ContentRenderer[_] | Boolean): Self = this.set("activeDot", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDotFunction1(value: DotPropspayloadany => ReactElement): Self = this.set("dot", js.Any.fromFunction1(value))
    @scala.inline
    def setDot(value: js.Object | ReactElement | ContentRenderer[DotPropspayloadany] | Boolean): Self = this.set("dot", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLabelFunction1(value: _ => ReactElement): Self = this.set("label", js.Any.fromFunction1(value))
    @scala.inline
    def setLabel(value: Boolean | js.Object | ReactElement | ContentRenderer[_]): Self = this.set("label", value.asInstanceOf[js.Any])
    @scala.inline
