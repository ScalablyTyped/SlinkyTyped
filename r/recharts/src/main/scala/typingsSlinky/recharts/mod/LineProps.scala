...
trait LineProps extends StObject {
  ...
  var activeDot: js.UndefOr[js.Object | ReactElement | ContentRenderer[_] | Boolean] = js.native
  ...
  var dot: js.UndefOr[js.Object | ReactElement | ContentRenderer[DotPropspayloadany] | Boolean] = js.native
  ...
  var label: js.UndefOr[Boolean | js.Object | ReactElement | ContentRenderer[_]] = js.native
...
object LineProps {
  ...
  @scala.inline
  def apply(dataKey: DataKey): LineProps = {
  ...
  implicit class LinePropsMutableBuilder[Self <: LineProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveDot(value: js.Object | ReactElement | ContentRenderer[_] | Boolean): Self = StObject.set(x, "activeDot", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActiveDotFunction1(value: _ => ReactElement): Self = StObject.set(x, "activeDot", js.Any.fromFunction1(value))
    
    @scala.inline
    def setActiveDotReactElement(value: ReactElement): Self = StObject.set(x, "activeDot", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDot(value: js.Object | ReactElement | ContentRenderer[DotPropspayloadany] | Boolean): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDotFunction1(value: DotPropspayloadany => ReactElement): Self = StObject.set(x, "dot", js.Any.fromFunction1(value))
    
    @scala.inline
    def setDotReactElement(value: ReactElement): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: Boolean | js.Object | ReactElement | ContentRenderer[_]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelFunction1(value: _ => ReactElement): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
