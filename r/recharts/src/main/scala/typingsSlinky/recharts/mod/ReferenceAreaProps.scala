...
object ReferenceAreaProps {
  ...
  implicit class ReferenceAreaPropsOps[Self <: ReferenceAreaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShapeFunction1(value: ReferenceAreaProps with RectangleProps => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withShape(value: (ContentRenderer[ReferenceAreaProps with RectangleProps]) | ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(value.asInstanceOf[js.Any])
        ret
    }
