...
object ReferenceAreaProps {
  ...
  implicit class ReferenceAreaPropsMutableBuilder[Self <: ReferenceAreaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShape(value: (ContentRenderer[ReferenceAreaProps with RectangleProps]) | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: ReferenceAreaProps with RectangleProps => ReactElement): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
