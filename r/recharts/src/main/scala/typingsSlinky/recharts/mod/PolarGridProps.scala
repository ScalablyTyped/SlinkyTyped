...
object PolarGridProps {
  ...
  implicit class PolarGridPropsOps[Self <: PolarGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGridType(value: polygon | circle): Self = this.set("gridType", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPolarAnglesVarargs(value: Double*): Self = this.set("polarAngles", js.Array(value :_*))
    @scala.inline
    def setPolarAngles(value: js.Array[Double]): Self = this.set("polarAngles", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePolarAngles: Self = this.set("polarAngles", js.undefined)
    @scala.inline
    def setPolarRadiusVarargs(value: Double*): Self = this.set("polarRadius", js.Array(value :_*))
    @scala.inline
    def setPolarRadius(value: js.Array[Double]): Self = this.set("polarRadius", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePolarRadius: Self = this.set("polarRadius", js.undefined)
    @scala.inline
