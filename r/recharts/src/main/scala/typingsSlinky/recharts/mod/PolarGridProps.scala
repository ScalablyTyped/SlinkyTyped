...
@js.native
trait PolarGridProps extends StObject {
...
object PolarGridProps {
  ...
  @scala.inline
  implicit class PolarGridPropsMutableBuilder[Self <: PolarGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGridType(value: polygon | circle): Self = StObject.set(x, "gridType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPolarAngles(value: js.Array[Double]): Self = StObject.set(x, "polarAngles", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPolarAnglesUndefined: Self = StObject.set(x, "polarAngles", js.undefined)
    
    @scala.inline
    def setPolarAnglesVarargs(value: Double*): Self = StObject.set(x, "polarAngles", js.Array(value :_*))
    
    @scala.inline
    def setPolarRadius(value: js.Array[Double]): Self = StObject.set(x, "polarRadius", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPolarRadiusUndefined: Self = StObject.set(x, "polarRadius", js.undefined)
    
    @scala.inline
    def setPolarRadiusVarargs(value: Double*): Self = StObject.set(x, "polarRadius", js.Array(value :_*))
