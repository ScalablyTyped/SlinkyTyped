...
object ReferenceLineProps {
  ...
  implicit class ReferenceLinePropsOps[Self <: ReferenceLineProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabel(value: String | Double | ContentRenderer[_] | ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withPosition(value: ReferenceLinePosition): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSegment(value: js.Tuple2[SegmentItem, SegmentItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShapeFunction1(value: EventAttributesPartialPreAlignmentBaseline => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withShape(value: ContentRenderer[EventAttributesPartialPreAlignmentBaseline] | ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(value.asInstanceOf[js.Any])
        ret
    }
