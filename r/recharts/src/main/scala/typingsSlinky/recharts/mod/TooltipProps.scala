...
object TooltipProps {
  ...
  implicit class TooltipPropsOps[Self <: TooltipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentFunction1(value: TooltipProps => ReactElement): Self = this.set("content", js.Any.fromFunction1(value))
    @scala.inline
    def setContentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("content", value.asInstanceOf[js.Any])
    @scala.inline
    def setContent(value: ReactElement | ReactComponentClass[_] | ContentRenderer[TooltipProps]): Self = this.set("content", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCursorReactElement(value: ReactElement): Self = this.set("cursor", value.asInstanceOf[js.Any])
    @scala.inline
    def setCursorFunctionComponent(value: ReactComponentClass[_]): Self = this.set("cursor", value.asInstanceOf[js.Any])
    @scala.inline
    def setCursor(value: Boolean | js.Object | ReactElement | ReactComponentClass[_]): Self = this.set("cursor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLabelFormatter(value: /* label */ String | Double => ReactElement): Self = this.set("labelFormatter", js.Any.fromFunction1(value))
    @scala.inline
