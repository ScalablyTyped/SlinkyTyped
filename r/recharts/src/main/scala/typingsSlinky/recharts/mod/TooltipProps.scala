...
object TooltipProps {
  ...
  implicit class TooltipPropsMutableBuilder[Self <: TooltipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContent(value: ReactElement | ReactComponentClass[_] | ContentRenderer[TooltipProps]): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContentFunction1(value: TooltipProps => ReactElement): Self = StObject.set(x, "content", js.Any.fromFunction1(value))
    
    @scala.inline
    def setContentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCursor(value: Boolean | js.Object | ReactElement | ReactComponentClass[_]): Self = StObject.set(x, "cursor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCursorFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "cursor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabelFormatter(value: /* label */ String | Double => ReactElement): Self = StObject.set(x, "labelFormatter", js.Any.fromFunction1(value))
