...
object BarProps {
  ...
  implicit class BarPropsOps[Self <: BarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundReactElement(value: ReactElement): Self = this.set("background", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBackgroundFunction1(value: _ => ReactElement): Self = this.set("background", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setLabelFunctionComponent(value: ReactComponentClass[LabelProps]): Self = this.set("label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShapeReactElement(value: ReactElement): Self = this.set("shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: RectangleProps => ReactElement): Self = this.set("shape", js.Any.fromFunction1(value))
