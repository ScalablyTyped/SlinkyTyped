...
trait BarProps extends StObject {
  ...
  var label: js.UndefOr[
    Boolean | Label | LabelProps | ReactComponentClass[LabelProps] | ReactElement | ContentRenderer[_]
  ] = js.native
...
object BarProps {
  ...
  implicit class BarPropsMutableBuilder[Self <: BarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundFunction1(value: _ => ReactElement): Self = StObject.set(x, "background", js.Any.fromFunction1(value))
    
    @scala.inline
    def setBackgroundReactElement(value: ReactElement): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(
      value: Boolean | Label | LabelProps | ReactComponentClass[LabelProps] | ReactElement | ContentRenderer[_]
    ...
    @scala.inline
    def setLabelFunctionComponent(value: ReactComponentClass[LabelProps]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShapeFunction1(value: RectangleProps => ReactElement): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
    
    @scala.inline
    def setShapeReactElement(value: ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
