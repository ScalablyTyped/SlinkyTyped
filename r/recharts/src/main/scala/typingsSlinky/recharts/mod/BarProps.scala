...
object BarProps {
  ...
  implicit class BarPropsOps[Self <: BarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabelFunctionComponent(value: ReactComponentClass[LabelProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withShapeFunction1(value: RectangleProps => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withShape(value: ReactElement | ContentRenderer[RectangleProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("shape")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withStackId(value: String | Double): Self = {
        val ret = this.duplicate
