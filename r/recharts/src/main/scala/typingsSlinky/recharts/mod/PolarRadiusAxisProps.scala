...
object PolarRadiusAxisProps {
  ...
  @scala.inline
  implicit class PolarRadiusAxisPropsOps[Self <: PolarRadiusAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDomain(value: js.Tuple2[PolarRadiusAxisDomain, PolarRadiusAxisDomain]): Self = this.set("domain", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOrientation(value: left | right | middle): Self = this.set("orientation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTick(value: Boolean | js.Object | ReactElement | ContentRenderer[_]): Self = this.set("tick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTicksVarargs(value: PolarRadiusAxisTick*): Self = this.set("ticks", js.Array(value :_*))
    
    @scala.inline
    def setTicks(value: js.Array[PolarRadiusAxisTick]): Self = this.set("ticks", value.asInstanceOf[js.Any])
