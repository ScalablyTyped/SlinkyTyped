...
object PolarRadiusAxisProps {
  ...
  implicit class PolarRadiusAxisPropsOps[Self <: PolarRadiusAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDomain(value: js.Tuple2[PolarRadiusAxisDomain, PolarRadiusAxisDomain]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOrientation(value: left | right | middle): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTick(value: Boolean | js.Object | ReactElement | ContentRenderer[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tick")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withTicks(value: js.Array[PolarRadiusAxisTick]): Self = {
        val ret = this.duplicate
