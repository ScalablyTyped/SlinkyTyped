...
trait PolarRadiusAxisProps extends StObject {
  ...
  var domain: js.UndefOr[js.Tuple2[PolarRadiusAxisDomain, PolarRadiusAxisDomain]] = js.native
  ...
  var orientation: js.UndefOr[left | right | middle] = js.native
  ...
  var tick: js.UndefOr[Boolean | js.Object | ReactElement | ContentRenderer[_]] = js.native
  
  var tickCount: js.UndefOr[Double] = js.native
  
  var tickFormatter: js.UndefOr[TickFormatterFunction] = js.native
  
  var ticks: js.UndefOr[js.Array[PolarRadiusAxisTick]] = js.native
...
object PolarRadiusAxisProps {
  ...
  @scala.inline
  def apply(): PolarRadiusAxisProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PolarRadiusAxisProps]
  }
  
  @scala.inline
  implicit class PolarRadiusAxisPropsMutableBuilder[Self <: PolarRadiusAxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDomain(value: js.Tuple2[PolarRadiusAxisDomain, PolarRadiusAxisDomain]): Self = StObject.set(x, "domain", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOrientation(value: left | right | middle): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTick(value: Boolean | js.Object | ReactElement | ContentRenderer[_]): Self = StObject.set(x, "tick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTicks(value: js.Array[PolarRadiusAxisTick]): Self = StObject.set(x, "ticks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTicksUndefined: Self = StObject.set(x, "ticks", js.undefined)
    
    @scala.inline
    def setTicksVarargs(value: PolarRadiusAxisTick*): Self = StObject.set(x, "ticks", js.Array(value :_*))
