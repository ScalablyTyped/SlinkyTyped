...
import typingsSlinky.recharts.EventAttributesPartialPreAlignmentBaseline
...
object ReferenceLine
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.ReferenceLine] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ReferenceLine] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ReferenceLine] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.ReferenceLine](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
