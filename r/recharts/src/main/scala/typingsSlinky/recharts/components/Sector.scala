...
import typingsSlinky.recharts.mod.SectorProps
...
object Sector
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Sector] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Sector] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Sector] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Sector](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
