...
import typingsSlinky.recharts.mod.PieLabelRenderProps
import typingsSlinky.recharts.mod.PieProps
...
object Pie {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def blendStroke(value: Boolean): this.type = set("blendStroke", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def label(value: AnonOffsetRadius | ReactElement | ContentRenderer[PieLabelRenderProps] | Boolean): this.type = set("label", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def maxRadius(value: Double): this.type = set("maxRadius", value.asInstanceOf[js.Any])
    @scala.inline
    def midAngle(value: Double): this.type = set("midAngle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def paddingAngle(value: Double): this.type = set("paddingAngle", value.asInstanceOf[js.Any])
    @scala.inline
