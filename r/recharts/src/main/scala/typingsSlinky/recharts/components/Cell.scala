...
import typingsSlinky.recharts.mod.CellProps
...
object Cell
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Cell] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Cell] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Cell] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Cell](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
