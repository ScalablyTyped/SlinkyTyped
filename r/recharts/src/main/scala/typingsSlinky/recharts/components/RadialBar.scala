...
import typingsSlinky.recharts.mod.RadialBarData
import typingsSlinky.recharts.mod.RadialBarProps
...
object RadialBar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def minPointSize(value: Double): this.type = set("minPointSize", value.asInstanceOf[js.Any])
