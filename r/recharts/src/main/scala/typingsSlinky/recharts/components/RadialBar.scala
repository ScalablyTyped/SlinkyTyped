...
object RadialBar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.RadialBar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.RadialBar] = {
