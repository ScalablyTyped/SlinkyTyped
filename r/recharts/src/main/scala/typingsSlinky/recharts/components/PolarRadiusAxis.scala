...
object PolarRadiusAxis
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.PolarRadiusAxis] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.PolarRadiusAxis] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.PolarRadiusAxis] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.PolarRadiusAxis](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
