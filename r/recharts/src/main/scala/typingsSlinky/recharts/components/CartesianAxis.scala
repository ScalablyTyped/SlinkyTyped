...
import typingsSlinky.recharts.mod.CartesianAxisProps
...
object CartesianAxis
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.CartesianAxis] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.CartesianAxis] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.CartesianAxis] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.CartesianAxis](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
