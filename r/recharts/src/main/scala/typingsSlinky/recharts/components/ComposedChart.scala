...
import typingsSlinky.recharts.mod.ComposedChartProps
...
object ComposedChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.ComposedChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ComposedChart] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ComposedChart] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.ComposedChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
