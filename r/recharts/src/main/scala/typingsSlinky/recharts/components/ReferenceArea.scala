...
import typingsSlinky.recharts.mod.ReferenceAreaProps
...
object ReferenceArea
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.ReferenceArea] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ReferenceArea] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ReferenceArea] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.ReferenceArea](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
