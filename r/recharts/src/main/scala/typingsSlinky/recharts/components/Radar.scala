...
import typingsSlinky.recharts.mod.RadarPoint
import typingsSlinky.recharts.mod.RadarProps
...
object Radar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Radar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Radar] = {
