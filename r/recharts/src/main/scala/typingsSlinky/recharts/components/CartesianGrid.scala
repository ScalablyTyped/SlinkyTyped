...
object CartesianGrid
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.rechartsMod.CartesianGrid] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.rechartsMod.CartesianGrid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
