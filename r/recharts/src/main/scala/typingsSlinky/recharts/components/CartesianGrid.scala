...
object CartesianGrid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.CartesianGrid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.CartesianGrid] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.CartesianGrid] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.CartesianGrid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
