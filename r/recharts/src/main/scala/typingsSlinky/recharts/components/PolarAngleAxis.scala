...
object PolarAngleAxis {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.recharts.mod.PolarAngleAxis] {
    @scala.inline
    ...
    @scala.inline
    def angleAxisId(value: String | Double): this.type = set("angleAxisId", value.asInstanceOf[js.Any])
    @scala.inline
    def axisLine(value: Boolean | js.Object): this.type = set("axisLine", value.asInstanceOf[js.Any])
    @scala.inline
    def axisLineType(value: polygon | circle): this.type = set("axisLineType", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def orientation(value: inner | outer): this.type = set("orientation", value.asInstanceOf[js.Any])
    @scala.inline
