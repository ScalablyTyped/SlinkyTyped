...
import typingsSlinky.recharts.mod.SymbolsProps
...
object Symbols
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Symbols] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Symbols] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Symbols] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Symbols](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
