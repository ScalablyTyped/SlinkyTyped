...
object Symbols {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.recharts.mod.Symbols] {
    ...
    @scala.inline
    def sizeType(value: area | diameter): this.type = set("sizeType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `type`(value: circle | cross | diamond | square | star | triangle | wye): this.type = set("type", value.asInstanceOf[js.Any])
