...
import typingsSlinky.recharts.mod.BarChartProps
...
object BarChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.BarChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.BarChart] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.BarChart] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.BarChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
