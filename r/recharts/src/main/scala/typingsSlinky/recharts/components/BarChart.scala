...
object BarChart {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.recharts.mod.BarChart] {
    @scala.inline
  ...
  implicit def make(companion: BarChart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
