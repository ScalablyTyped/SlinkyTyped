...
import typingsSlinky.recharts.mod.BarData
import typingsSlinky.recharts.mod.BarProps
...
object Bar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Bar] {
  ...
  def apply(
    ...
    label: Boolean | typingsSlinky.recharts.mod.Label | LabelProps | ReactComponentClass[LabelProps] | ReactElement | ContentRenderer[_] = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Bar] = {
