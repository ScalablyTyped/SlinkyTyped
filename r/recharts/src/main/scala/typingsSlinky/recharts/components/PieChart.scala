...
object PieChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.PieChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.PieChart] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.PieChart] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.PieChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
