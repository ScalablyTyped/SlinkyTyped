...
import typingsSlinky.recharts.mod.RadarChartProps
...
object RadarChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.RadarChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.RadarChart] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.RadarChart] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.RadarChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
