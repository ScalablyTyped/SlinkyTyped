...
import typingsSlinky.recharts.mod.CurveProps
...
object Curve
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Curve] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Curve] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Curve] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Curve](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
