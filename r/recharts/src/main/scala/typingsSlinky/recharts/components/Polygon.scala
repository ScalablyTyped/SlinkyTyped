...
import typingsSlinky.recharts.mod.PolygonPoint
import typingsSlinky.recharts.mod.PolygonProps
...
object Polygon
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Polygon] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Polygon] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Polygon] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Polygon](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
