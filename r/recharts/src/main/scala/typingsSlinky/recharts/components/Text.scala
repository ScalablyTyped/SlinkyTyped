...
import typingsSlinky.recharts.mod.TextProps
...
object Text {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.recharts.mod.Text] {
    ...
    @scala.inline
    def capHeight(value: String): this.type = set("capHeight", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def scaleToFit(value: Boolean): this.type = set("scaleToFit", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def textAnchor(value: start | middle | end | inherit): this.type = set("textAnchor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def verticalAnchor(value: start | middle | end): this.type = set("verticalAnchor", value.asInstanceOf[js.Any])
