...
object Text
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Text] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Text] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Text] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Text](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
