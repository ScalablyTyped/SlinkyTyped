...
import typingsSlinky.recharts.mod.RectangleProps
...
object Rectangle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Rectangle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Rectangle] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Rectangle] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Rectangle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
