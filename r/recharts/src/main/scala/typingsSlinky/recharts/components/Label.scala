...
import typingsSlinky.recharts.mod.PolarViewBox
...
object Label
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Label] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Label] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Label] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Label](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
