...
object Label {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.recharts.mod.Label] {
    ...
    @scala.inline
    def viewBox(value: ViewBox | PolarViewBox): this.type = set("viewBox", value.asInstanceOf[js.Any])
