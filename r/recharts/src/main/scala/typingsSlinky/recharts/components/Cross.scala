...
import typingsSlinky.recharts.mod.CrossProps
...
object Cross
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.Cross] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Cross] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.Cross] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.Cross](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
