...
object ReferenceDot
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.recharts.mod.ReferenceDot] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ReferenceDot] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.recharts.mod.ReferenceDot] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.recharts.mod.ReferenceDot](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
