...
import typingsSlinky.recharts.mod.ReferenceDotAxisConfiguration
import typingsSlinky.recharts.mod.ReferenceDotProps
...
object ReferenceDot {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.recharts.mod.ReferenceDot] {
    ...
    @scala.inline
    def labelFunction1(value: /* repeated */ js.Any => Unit): this.type = set("label", js.Any.fromFunction1(value))
    
    @scala.inline
    def label(value: String | Double | ReactElement | RechartsFunction): this.type = set("label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def xAxis(value: ReferenceDotAxisConfiguration): this.type = set("xAxis", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def yAxis(value: ReferenceDotAxisConfiguration): this.type = set("yAxis", value.asInstanceOf[js.Any])
