package typingsSlinky.rmcTrigger
...
trait AnonAfterPopupVisibleChange extends js.Object {
  ...
  var getDocument: js.Function0[Document_] = js.native
...
object AnonAfterPopupVisibleChange {
  ...
  @scala.inline
  implicit class AnonAfterPopupVisibleChangeOps[Self <: AnonAfterPopupVisibleChange] (val x: Self) extends AnyVal {
    @scala.inline
