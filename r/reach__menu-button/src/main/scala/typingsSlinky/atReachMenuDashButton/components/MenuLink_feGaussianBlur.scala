...
import typingsSlinky.atReachMenuDashButton.atReachMenuDashButtonStrings.feGaussianBlur
...
object MenuLink_feGaussianBlur
  ...
  type Props = MenuLinkProps[feGaussianBlur]
}
