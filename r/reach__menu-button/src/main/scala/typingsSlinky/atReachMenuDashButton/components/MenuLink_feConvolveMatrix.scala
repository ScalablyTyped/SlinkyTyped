...
import typingsSlinky.atReachMenuDashButton.atReachMenuDashButtonStrings.feConvolveMatrix
...
object MenuLink_feConvolveMatrix
  ...
  type Props = MenuLinkProps[feConvolveMatrix]
}
