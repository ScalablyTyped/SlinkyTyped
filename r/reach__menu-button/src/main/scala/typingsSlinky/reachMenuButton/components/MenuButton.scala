...
object MenuButton
  ...
  def apply(
    ...
    onClick: SyntheticMouseEvent[HTMLButtonElement] | (/* e */ SyntheticMouseEvent[HTMLElement]) => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLButtonElement] | (/* e */ SyntheticKeyboardEvent[HTMLElement]) => Unit = null,
