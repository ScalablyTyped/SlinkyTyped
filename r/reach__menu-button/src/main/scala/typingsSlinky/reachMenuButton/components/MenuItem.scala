...
object MenuItem
  ...
  def apply(
    ...
    onClick: SyntheticMouseEvent[HTMLDivElement] | (/* e */ SyntheticMouseEvent[HTMLElement]) => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLDivElement] | (/* e */ SyntheticKeyboardEvent[HTMLElement]) => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLDivElement] | (/* e */ SyntheticMouseEvent[HTMLElement]) => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLDivElement, Event_] => Unit = null,
    onSelect: js.Function0[Unit] | ReactEventHandler[HTMLDivElement] = null,
