...
object MenuItem {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onSelectFunction1(value: SyntheticEvent[Event_, HTMLDivElement] => Unit): this.type = set("onSelect", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setState(value: /* s */ State => PartialState): this.type = set("setState", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def state(value: State): this.type = set("state", value.asInstanceOf[js.Any])
    @scala.inline
