...
object As {
  @scala.inline
  def apply[/* <: typingsSlinky.reachMenuButton.mod.SupportedMenuLinkComponent */ T](): As[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[As[T]]
  }
  @scala.inline
  implicit class AsOps[Self <: As[_], /* <: typingsSlinky.reachMenuButton.mod.SupportedMenuLinkComponent */ T] (val x: Self with As[T]) extends AnyVal {
    @scala.inline
