...
trait MenuItemProps extends js.Object {
  ...
  var onClick: js.UndefOr[
    (js.Function1[/* e */ SyntheticMouseEvent[HTMLElement], Unit]) | MouseEventHandler[HTMLDivElement]
  ] = js.native
  // Composition Events
  ...
  var onKeyDown: js.UndefOr[
    (js.Function1[/* e */ SyntheticKeyboardEvent[HTMLElement], Unit]) | KeyboardEventHandler[HTMLDivElement]
  ] = js.native
