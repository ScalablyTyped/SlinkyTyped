...
package object mod {
  type MenuLinkProps[T /* <: typingsSlinky.reachMenuButton.mod.SupportedMenuLinkComponent */] = typingsSlinky.reachMenuButton.mod.ResolvedMenuLinkProps[T] with typingsSlinky.reachMenuButton.AnonAs[T]
  ...
  ]) with typingsSlinky.reachMenuButton.AnonChildren
