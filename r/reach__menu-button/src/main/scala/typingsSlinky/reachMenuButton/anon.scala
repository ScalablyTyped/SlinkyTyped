...
object anon {
  ...
  object As {
    ...
    implicit class AsMutableBuilder[Self <: As[_], T /* <: SupportedMenuLinkComponent */] (val x: Self with As[T]) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[T]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[T]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnClick(value: /* e */ SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
