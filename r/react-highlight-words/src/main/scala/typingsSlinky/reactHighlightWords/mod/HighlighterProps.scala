...
object HighlighterProps {
  ...
  implicit class HighlighterPropsOps[Self <: HighlighterProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHighlightTagFunctionComponent(value: ReactComponentClass[_]): Self = this.set("highlightTag", value.asInstanceOf[js.Any])
    @scala.inline
    def setHighlightTagComponentClass(value: ReactComponentClass[_]): Self = this.set("highlightTag", value.asInstanceOf[js.Any])
    @scala.inline
    def setHighlightTag(value: String | ReactComponentClass[_]): Self = this.set("highlightTag", value.asInstanceOf[js.Any])
    @scala.inline
