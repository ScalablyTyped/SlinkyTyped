...
object mod {
  ...
  type Highlighter = ReactComponentClass[HighlighterProps]
  ...
  object HighlighterProps {
    ...
    implicit class HighlighterPropsMutableBuilder[Self <: HighlighterProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHighlightTag(value: String | ReactComponentClass[_]): Self = StObject.set(x, "highlightTag", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHighlightTagComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "highlightTag", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHighlightTagFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "highlightTag", value.asInstanceOf[js.Any])
