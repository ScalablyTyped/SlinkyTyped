...
object SagaMiddlewareOptions {
  @scala.inline
  def apply[/* <: js.Object */ C](): SagaMiddlewareOptions[C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SagaMiddlewareOptions[C]]
  }
  @scala.inline
  implicit class SagaMiddlewareOptionsOps[Self <: SagaMiddlewareOptions[_], /* <: js.Object */ C] (val x: Self with SagaMiddlewareOptions[C]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnError(value: (/* error */ js.Error, /* errorInfo */ ErrorInfo) => Unit): Self = this.set("onError", js.Any.fromFunction2(value))
    @scala.inline
