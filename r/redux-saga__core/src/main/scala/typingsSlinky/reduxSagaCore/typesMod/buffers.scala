...
object buffers extends js.Object {
  /**
    ...
    */
  def dropping[T](): typingsSlinky.node.Buffer = js.native
  def dropping[T](limit: Double): typingsSlinky.node.Buffer = js.native
  /**
    * Like `fixed` but Overflow will cause the buffer to expand dynamically.
    */
  def expanding[T](): typingsSlinky.node.Buffer = js.native
  def expanding[T](limit: Double): typingsSlinky.node.Buffer = js.native
  /**
    ...
    */
  def fixed[T](): typingsSlinky.node.Buffer = js.native
  def fixed[T](limit: Double): typingsSlinky.node.Buffer = js.native
  /**
    * No buffering, new messages will be lost if there are no pending takers
    */
  def none[T](): typingsSlinky.node.Buffer = js.native
  /**
    * Same as `fixed` but Overflow will insert the new message at the end and
    * drop the oldest message in the buffer.
    */
  def sliding[T](): typingsSlinky.node.Buffer = js.native
  def sliding[T](limit: Double): typingsSlinky.node.Buffer = js.native
}
