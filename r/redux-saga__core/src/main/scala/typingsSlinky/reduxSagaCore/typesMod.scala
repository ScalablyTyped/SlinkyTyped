...
object typesMod {
  ...
  trait EventChannel_[T] extends StObject {
    ...
    def flush(cb: js.Function1[/* items */ js.Array[T] | typingsSlinky.reduxSagaCore.typesMod.END, Unit]): Unit = js.native
    
    def take(cb: js.Function1[/* message */ T | typingsSlinky.reduxSagaCore.typesMod.END, Unit]): Unit = js.native
  }
  object EventChannel_ {
    ...
    def apply[T](
      close: () => Unit,
      flush: js.Function1[/* items */ js.Array[T] | typingsSlinky.reduxSagaCore.typesMod.END, Unit] => Unit,
      take: js.Function1[/* message */ T | typingsSlinky.reduxSagaCore.typesMod.END, Unit] => Unit
    ): EventChannel_[T] = {
    ...
    implicit class EventChannel_MutableBuilder[Self <: EventChannel_[_], T] (val x: Self with EventChannel_[T]) extends AnyVal {
      ...
      @scala.inline
      def setFlush(
        value: js.Function1[/* items */ js.Array[T] | typingsSlinky.reduxSagaCore.typesMod.END, Unit] => Unit
      ): Self = StObject.set(x, "flush", js.Any.fromFunction1(value))
      
      @scala.inline
      def setTake(value: js.Function1[/* message */ T | typingsSlinky.reduxSagaCore.typesMod.END, Unit] => Unit): Self = StObject.set(x, "take", js.Any.fromFunction1(value))
    }
  }
  ...
  trait MulticastChannel_[T] extends StObject {
    ...
    def put(message: typingsSlinky.reduxSagaCore.typesMod.END): Unit = js.native
    
    def take(cb: js.Function1[/* message */ T | typingsSlinky.reduxSagaCore.typesMod.END, Unit]): Unit = js.native
    def take(
      cb: js.Function1[/* message */ T | typingsSlinky.reduxSagaCore.typesMod.END, Unit],
  ...
  object RunSagaOptions {
    ...
    implicit class RunSagaOptionsMutableBuilder[Self <: RunSagaOptions[_, _], A, S] (val x: Self with (RunSagaOptions[A, S])) extends AnyVal {
      ...
      @scala.inline
      def setOnError(value: (/* error */ js.Error, /* errorInfo */ ErrorInfo) => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction2(value))
  ...
  type Subscribe[T] = js.Function1[
    /* cb */ js.Function1[/* input */ T | typingsSlinky.reduxSagaCore.typesMod.END, Unit], 
    Unsubscribe
  ]
  ...
  object TakeableChannel {
    ...
    @scala.inline
    def apply[T](take: js.Function1[/* message */ T | typingsSlinky.reduxSagaCore.typesMod.END, Unit] => Unit): TakeableChannel[T] = {
