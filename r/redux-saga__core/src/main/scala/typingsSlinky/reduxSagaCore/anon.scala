...
object anon {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Context with TopLevel[js.Any] */, Name /* <: String */] extends StObject {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): void}
    */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Fn with TopLevel[js.Any] */, Name /* <: String */] extends StObject {
  ...
  object Fn {
    ...
    def apply[Ctx /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ P in Name ]: (this : Ctx, args : ...any): void}
      */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Fn with TopLevel[js.Any] */, Name /* <: String */](context: Ctx, fn: Name): Fn[Ctx, Name] = {
      val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], fn = fn.asInstanceOf[js.Any])
    ...
    {[ P in Name ]: (this : Ctx, args : ...any): void}
      */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Fn with TopLevel[js.Any] */, Name /* <: String */] (val x: Self with (Fn[Ctx, Name])) extends AnyVal {
