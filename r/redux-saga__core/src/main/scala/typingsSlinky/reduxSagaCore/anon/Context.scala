...
object Context {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    * / typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Context with org.scalablytyped.runtime.TopLevel[js.Any] */ Ctx, /* <: java.lang.String */ Name](context: Ctx, fn: Name): Context[Ctx, Name] = {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    * / typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Context with org.scalablytyped.runtime.TopLevel[js.Any] */ Ctx, /* <: java.lang.String */ Name] (val x: Self with (Context[Ctx, Name])) extends AnyVal {
    @scala.inline
