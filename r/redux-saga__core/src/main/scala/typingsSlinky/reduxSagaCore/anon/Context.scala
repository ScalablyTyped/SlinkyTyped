...
{[ P in Name ]: (this : Ctx, args : ...any): any}
  */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Context with TopLevel[js.Any] */, Name /* <: String */] extends js.Object {
...
object Context {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Context with TopLevel[js.Any] */, Name /* <: String */](context: Ctx, fn: Name): Context[Ctx, Name] = {
  ...
  @scala.inline
  implicit class ContextOps[Self <: Context[_, _], Ctx /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Context with TopLevel[js.Any] */, Name /* <: String */] (val x: Self with (Context[Ctx, Name])) extends AnyVal {
