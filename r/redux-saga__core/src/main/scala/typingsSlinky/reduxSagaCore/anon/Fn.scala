...
object Fn {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): void}
    * / typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Fn with org.scalablytyped.runtime.TopLevel[js.Any] */ Ctx, /* <: java.lang.String */ Name](context: Ctx, fn: Name): Fn[Ctx, Name] = {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): void}
    * / typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.Fn with org.scalablytyped.runtime.TopLevel[js.Any] */ Ctx, /* <: java.lang.String */ Name] (val x: Self with (Fn[Ctx, Name])) extends AnyVal {
    @scala.inline
