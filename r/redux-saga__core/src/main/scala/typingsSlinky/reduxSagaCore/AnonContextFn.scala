...
{[ P in Name ]: (this : Ctx, args : ...any): void}
  */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.AnonContextFn with js.Any */, Name /* <: String */] extends js.Object {
  var context: Ctx
  var fn: Name
}
...
object AnonContextFn {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): void}
    */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.AnonContextFn with js.Any */, Name /* <: String */](context: Ctx, fn: Name): AnonContextFn[Ctx, Name] = {
