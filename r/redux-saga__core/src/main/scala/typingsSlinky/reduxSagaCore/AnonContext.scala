...
{[ P in Name ]: (this : Ctx, args : ...any): any}
  */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.AnonContext with js.Any */, Name /* <: String */] extends js.Object {
  var context: Ctx
  var fn: Name
}
...
object AnonContext {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.AnonContext with js.Any */, Name /* <: String */](context: Ctx, fn: Name): AnonContext[Ctx, Name] = {
