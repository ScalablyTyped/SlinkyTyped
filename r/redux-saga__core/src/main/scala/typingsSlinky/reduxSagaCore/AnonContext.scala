...
{[ P in Name ]: (this : Ctx, args : ...any): any}
  */ typingsSlinky.reduxSagaCore.reduxSagaCoreStrings.AnonContext with TopLevel[js.Any] */, Name /* <: String */] extends js.Object {
...
object AnonContext {
  @scala.inline
  def apply[Ctx, Name](context: Ctx, fn: Name): AnonContext[Ctx, Name] = {
  ...
  @scala.inline
  implicit class AnonContextOps[Self[ctx, name] <: AnonContext[ctx, name], Ctx, Name] (val x: Self[Ctx, Name]) extends AnyVal {
    @scala.inline
