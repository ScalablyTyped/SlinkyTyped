...
object PutEffectDescriptor {
  @scala.inline
  def apply[/* <: typingsSlinky.redux.mod.Action[_] */ A](action: A, channel: Null): PutEffectDescriptor[A] = {
  ...
  @scala.inline
  implicit class PutEffectDescriptorOps[Self <: PutEffectDescriptor[_], /* <: typingsSlinky.redux.mod.Action[_] */ A] (val x: Self with PutEffectDescriptor[A]) extends AnyVal {
    @scala.inline
