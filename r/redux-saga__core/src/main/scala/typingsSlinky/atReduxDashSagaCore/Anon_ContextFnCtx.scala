...
{[ P in Name ]: (this : Ctx, args : ...any): void}
  */ typingsSlinky.atReduxDashSagaCore.atReduxDashSagaCoreStrings.Anon_ContextFnCtx with js.Any */, Name /* <: String */] extends js.Object {
  var context: Ctx
  var fn: Name
}
...
object Anon_ContextFnCtx {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): void}
    */ typingsSlinky.atReduxDashSagaCore.atReduxDashSagaCoreStrings.Anon_ContextFnCtx with js.Any */, Name /* <: String */](context: Ctx, fn: Name): Anon_ContextFnCtx[Ctx, Name] = {
