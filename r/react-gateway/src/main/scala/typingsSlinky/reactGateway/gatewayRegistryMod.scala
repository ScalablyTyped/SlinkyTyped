...
object gatewayRegistryMod {
  ...
  object GatewayRegistry {
    ...
    implicit class GatewayRegistryMutableBuilder[Self <: GatewayRegistry] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddChild(value: (String, String, ReactElement) => Unit): Self = StObject.set(x, "addChild", js.Any.fromFunction3(value))
      
      @scala.inline
      def setAddContainer(value: (String, ReactComponentClass[js.Object]) => Unit): Self = StObject.set(x, "addContainer", js.Any.fromFunction2(value))
      
      @scala.inline
      def setClearChild(value: (String, String) => Unit): Self = StObject.set(x, "clearChild", js.Any.fromFunction2(value))
      
      @scala.inline
      def setRegister(value: (String, ReactElement) => String): Self = StObject.set(x, "register", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def set_children(value: StringDictionary[js.UndefOr[StringDictionary[ReactElement]]]): Self = StObject.set(x, "_children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def set_containers(value: StringDictionary[js.UndefOr[ReactComponentClass[js.Object] | Null]]): Self = StObject.set(x, "_containers", value.asInstanceOf[js.Any])
