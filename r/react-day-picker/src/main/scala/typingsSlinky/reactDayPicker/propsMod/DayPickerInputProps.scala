...
object DayPickerInputProps {
  ...
  implicit class DayPickerInputPropsOps[Self <: DayPickerInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatDate(value: (/* date */ js.Date, /* format */ String, /* locale */ String) => String): Self = this.set("formatDate", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setOnChange(value: /* e */ SyntheticFocusEvent[HTMLDivElement] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    
    @scala.inline
    def setOnClick(value: /* e */ SyntheticFocusEvent[HTMLDivElement] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    
    @scala.inline
    def setOnDayChange(value: (/* day */ js.Date, /* DayModifiers */ DayModifiers, /* dayPickerInput */ default) => Unit): Self = this.set("onDayChange", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setOnKeyUp(value: /* e */ SyntheticFocusEvent[HTMLDivElement] => Unit): Self = this.set("onKeyUp", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setParseDate(value: (/* str */ String, /* format */ String, /* locale */ String) => js.Date | Unit): Self = this.set("parseDate", js.Any.fromFunction3(value))
