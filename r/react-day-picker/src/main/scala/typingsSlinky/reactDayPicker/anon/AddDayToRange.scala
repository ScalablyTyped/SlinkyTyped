...
@js.native
trait AddDayToRange extends js.Object {
...
object AddDayToRange {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AddDayToRange]
  }
  @scala.inline
  implicit class AddDayToRangeOps[Self <: AddDayToRange] (val x: Self) extends AnyVal {
    @scala.inline
