...
object Modifiers {
  ...
  implicit class ModifiersOps[Self <: Modifiers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOutsideDate(value: js.Date): Self = this.set("outside", value.asInstanceOf[js.Any])
    @scala.inline
    def setOutsideFunction1(value: /* date */ js.Date => Boolean): Self = this.set("outside", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setTodayDate(value: js.Date): Self = this.set("today", value.asInstanceOf[js.Any])
    @scala.inline
    def setTodayFunction1(value: /* date */ js.Date => Boolean): Self = this.set("today", js.Any.fromFunction1(value))
    @scala.inline
