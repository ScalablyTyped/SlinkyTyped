...
object _Modifier {
  @scala.inline
  def BeforeAfterModifier(after: js.Date, before: js.Date): _Modifier = {
    val __obj = js.Dynamic.literal(after = after.asInstanceOf[js.Any], before = before.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[_Modifier]
  }
  @scala.inline
  def AfterModifier(after: js.Date): _Modifier = {
    val __obj = js.Dynamic.literal(after = after.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[_Modifier]
  }
  @scala.inline
  def BeforeModifier(before: js.Date): _Modifier = {
  ...
  @scala.inline
  def RangeModifier(from: js.Date, to: js.Date): _Modifier = {
