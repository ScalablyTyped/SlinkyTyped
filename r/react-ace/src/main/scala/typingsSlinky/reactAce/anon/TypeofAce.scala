...
import typingsSlinky.aceBuilds.mod.Ace.SelectionCls
...
trait TypeofAce extends js.Object {
  ...
  var SelectionCls: Instantiable1[/* session */ EditSession, typingsSlinky.aceBuilds.mod.Ace.SelectionCls] = js.native
}
