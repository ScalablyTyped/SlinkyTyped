...
trait ValidationMapISplitEditor extends js.Object {
  var annotations: js.UndefOr[Validator[js.UndefOr[js.Array[js.Array[Annotation]]]]] = js.native
...
object ValidationMapISplitEditor {
  ...
  implicit class ValidationMapISplitEditorOps[Self <: ValidationMapISplitEditor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnnotations(value: Validator[js.UndefOr[js.Array[js.Array[Annotation]]]]): Self = {
    ...
    @scala.inline
    def withDefaultValue(value: Validator[js.UndefOr[js.Array[String]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarkers(value: Validator[js.UndefOr[js.Array[js.Array[IMarker]]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnBlur(value: Validator[js.UndefOr[js.Function1[/* value */ Event, Unit]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnFocus(value: Validator[js.UndefOr[js.Function1[/* value */ Event, Unit]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSplits(value: Validator[Double]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStyle(value: Validator[_]): Self = {
        val ret = this.duplicate
