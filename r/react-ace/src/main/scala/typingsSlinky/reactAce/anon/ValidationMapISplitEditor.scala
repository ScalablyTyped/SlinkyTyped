...
trait ValidationMapISplitEditor extends js.Object {
  var annotations: js.UndefOr[Validator[js.UndefOr[js.Array[js.Array[Annotation]]]]] = js.undefined
...
object ValidationMapISplitEditor {
  @scala.inline
  def apply(
    annotations: Validator[js.UndefOr[js.Array[js.Array[Annotation]]]] = null,
    ...
    onBlur: Validator[js.UndefOr[js.Function1[/* value */ Event, Unit]]] = null,
    onChange: Validator[
      js.UndefOr[js.Function2[/* value */ js.Array[String], /* event */ js.UndefOr[_], Unit]]
    ] = null,
    ...
    onFocus: Validator[js.UndefOr[js.Function1[/* value */ Event, Unit]]] = null,
