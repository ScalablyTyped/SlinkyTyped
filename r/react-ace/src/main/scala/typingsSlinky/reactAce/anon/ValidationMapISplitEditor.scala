...
object ValidationMapISplitEditor {
  ...
  @scala.inline
  implicit class ValidationMapISplitEditorOps[Self <: ValidationMapISplitEditor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAnnotations(value: Validator[js.UndefOr[js.Array[js.Array[IAnnotation]]]]): Self = this.set("annotations", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDefaultValue(value: Validator[js.UndefOr[js.Array[String]]]): Self = this.set("defaultValue", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMarkers(value: Validator[js.UndefOr[js.Array[js.Array[IMarker]]]]): Self = this.set("markers", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnBeforeLoad(value: Validator[js.UndefOr[js.Function1[/* ace */ _, Unit]]]): Self = this.set("onBeforeLoad", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnBeforeLoad: Self = this.set("onBeforeLoad", js.undefined)
    @scala.inline
    def setOnBlur(value: Validator[js.UndefOr[js.Function1[/* value */ Event, Unit]]]): Self = this.set("onBlur", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnFocus(value: Validator[js.UndefOr[js.Function1[/* value */ Event, Unit]]]): Self = this.set("onFocus", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSplits(value: Validator[Double]): Self = this.set("splits", value.asInstanceOf[js.Any])
    @scala.inline
