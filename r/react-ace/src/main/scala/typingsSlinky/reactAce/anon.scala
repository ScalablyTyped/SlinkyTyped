...
object anon {
  ...
  trait TypeofAceBuilds extends StObject {
    ...
    def createEditSession(text: String, mode: SyntaxMode): typingsSlinky.aceBuilds.mod.Ace.EditSession = js.native
    def createEditSession(text: Document, mode: SyntaxMode): typingsSlinky.aceBuilds.mod.Ace.EditSession = js.native
