...
trait ValidationMapISplitEditor extends js.Object {
  ...
  var onBlur: js.UndefOr[Validator[js.UndefOr[js.Function1[/* value */ Event_, Unit]]]] = js.native
  ...
  var onFocus: js.UndefOr[Validator[js.UndefOr[js.Function1[/* value */ Event_, Unit]]]] = js.native
...
object ValidationMapISplitEditor {
  ...
  implicit class ValidationMapISplitEditorOps[Self <: ValidationMapISplitEditor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnBlur(value: Validator[js.UndefOr[js.Function1[/* value */ Event_, Unit]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnFocus(value: Validator[js.UndefOr[js.Function1[/* value */ Event_, Unit]]]): Self = {
        val ret = this.duplicate
