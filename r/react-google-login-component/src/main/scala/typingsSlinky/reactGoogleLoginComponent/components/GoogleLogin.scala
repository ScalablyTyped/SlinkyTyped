package typingsSlinky.reactGoogleLoginComponent.components
...
import typingsSlinky.reactGoogleLoginComponent.mod.GoogleLoginInfo
import typingsSlinky.reactGoogleLoginComponent.mod.GoogleLoginProps
...
object GoogleLogin {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactGoogleLoginComponent.mod.GoogleLogin] {
    ...
    @scala.inline
    def fetchBasicProfile(value: Boolean): this.type = set("fetchBasicProfile", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def apply(responseHandler: GoogleLoginInfo => Unit, socialId: String): Builder = {
