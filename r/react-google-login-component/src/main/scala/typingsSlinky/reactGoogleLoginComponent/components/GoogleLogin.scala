...
object GoogleLogin
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactGoogleLoginComponent.mod.GoogleLogin] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactGoogleLoginComponent.mod.GoogleLogin] = {
