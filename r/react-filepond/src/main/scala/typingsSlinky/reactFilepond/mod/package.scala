...
package object mod {
  ...
  type FetchServerConfigFunction = js.Function6[
    ...
    /* load */ js.Function1[/* file */ typingsSlinky.reactFilepond.mod.ActualFileObject, scala.Unit], 
    /* error */ js.Function1[/* errorText */ java.lang.String, scala.Unit], 
    /* progress */ typingsSlinky.reactFilepond.mod.ProgressServerConfigFunction, 
  ...
  type ProcessServerConfigFunction = js.Function7[
    ...
    /* file */ typingsSlinky.reactFilepond.mod.ActualFileObject, 
