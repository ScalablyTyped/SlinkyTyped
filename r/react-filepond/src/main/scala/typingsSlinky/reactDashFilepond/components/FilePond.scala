...
object FilePond
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashFilepond.reactDashFilepondMod.FilePond] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashFilepond.reactDashFilepondMod.FilePond](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
