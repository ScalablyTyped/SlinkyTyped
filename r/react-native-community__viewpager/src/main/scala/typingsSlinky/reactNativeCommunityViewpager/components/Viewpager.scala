...
import typingsSlinky.reactNativeCommunityViewpager.mod.ViewPagerAndroidOnPageScrollEventData
import typingsSlinky.reactNativeCommunityViewpager.mod.ViewPagerAndroidOnPageSelectedEventData
import typingsSlinky.reactNativeCommunityViewpager.mod.ViewPagerAndroidProps
...
object Viewpager {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def keyboardDismissMode(
      value: typingsSlinky.reactNativeCommunityViewpager.reactNativeCommunityViewpagerStrings.none | `on-drag`
  ...
  def withProps(p: ViewPagerAndroidProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
