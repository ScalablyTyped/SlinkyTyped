...
object Viewpager
  ...
  def apply(
    ...
    keyboardDismissMode: typingsSlinky.reactNativeCommunityViewpager.reactNativeCommunityViewpagerStrings.none | `on-drag` = null,
  ...
  typingsSlinky.reactNativeCommunityViewpager.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
