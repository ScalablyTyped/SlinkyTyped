...
object RequireDirectoryOptions {
  ...
  implicit class RequireDirectoryOptionsOps[Self <: RequireDirectoryOptions[_, _], T, U] (val x: Self with (RequireDirectoryOptions[T, U])) extends AnyVal {
    ...
    @scala.inline
    def setExclude(value: js.RegExp | CheckPathFn): Self = this.set("exclude", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInclude(value: js.RegExp | CheckPathFn): Self = this.set("include", value.asInstanceOf[js.Any])
    @scala.inline
