...
object anon {
  ...
  object PartialMediaQueryAllQuery {
    ...
    @scala.inline
    implicit class PartialMediaQueryAllQueryMutableBuilder[Self <: PartialMediaQueryAllQuery] (val x: Self) extends AnyVal {
  ...
  object PartialMediaQueryAllQueryAll {
    ...
    @scala.inline
    implicit class PartialMediaQueryAllQueryAllMutableBuilder[Self <: PartialMediaQueryAllQueryAll] (val x: Self) extends AnyVal {
  ...
  object PartialMediaQueryMatchers {
    ...
    @scala.inline
    implicit class PartialMediaQueryMatchersMutableBuilder[Self <: PartialMediaQueryMatchers] (val x: Self) extends AnyVal {
