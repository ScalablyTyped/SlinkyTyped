...
import typingsSlinky.reactResponsive.anon.PartialMediaQueryAllQueryAll
...
object mod {
  ...
  @js.native
  val Context: typingsSlinky.react.mod.Context[PartialMediaQueryAllQuery] = js.native
  ...
  type MediaQuery = ReactComponentClass[MediaQueryProps]
  ...
  object MediaQueryProps {
    ...
    implicit class MediaQueryPropsMutableBuilder[Self <: MediaQueryProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ReactElement | (js.Function1[/* matches */ Boolean, ReactElement])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: String | ReactComponentClass[_] | (ClassType[_, _, _])): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
