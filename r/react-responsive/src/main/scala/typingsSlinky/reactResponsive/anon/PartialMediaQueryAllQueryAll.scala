package typingsSlinky.reactResponsive.anon
...
/* Inlined std.Partial<react-responsive.react-responsive.MediaQueryAllQueryable & {  query ? :string}> */
@js.native
trait PartialMediaQueryAllQueryAll extends js.Object {
...
object PartialMediaQueryAllQueryAll {
  @scala.inline
  def apply(): PartialMediaQueryAllQueryAll = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMediaQueryAllQueryAll]
  }
  @scala.inline
  implicit class PartialMediaQueryAllQueryAllOps[Self <: PartialMediaQueryAllQueryAll] (val x: Self) extends AnyVal {
    @scala.inline
