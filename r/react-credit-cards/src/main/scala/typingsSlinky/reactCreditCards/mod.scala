...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.reactCreditCards.reactCreditCardsStrings.number
    - typingsSlinky.reactCreditCards.reactCreditCardsStrings.expiry
  ...
  */
  ...
  type ReactCreditCard = ReactComponentClass[ReactCreditCardProps]
