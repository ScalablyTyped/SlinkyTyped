...
object BufferList {
  @scala.inline
  def apply[/* <: typingsSlinky.safeBuffer.mod.Buffer */ D](
    clear: () => Unit,
    concat: Double => D,
    head: Entry[D],
    join: js.Any => String,
  ...
  @scala.inline
  implicit class BufferListOps[Self <: BufferList[_], /* <: typingsSlinky.safeBuffer.mod.Buffer */ D] (val x: Self with BufferList[D]) extends AnyVal {
    @scala.inline
