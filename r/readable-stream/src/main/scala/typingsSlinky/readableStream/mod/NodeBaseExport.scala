...
object NodeBaseExport extends js.Object {
  var Duplex: typingsSlinky.node.streamMod.Duplex = js.native
  var PassThrough: typingsSlinky.node.streamMod.PassThrough = js.native
  var Readable: typingsSlinky.node.streamMod.Readable = js.native
  var Stream: typingsSlinky.node.streamMod.^ = js.native
  var Transform: typingsSlinky.node.streamMod.Transform = js.native
