...
import typingsSlinky.readableStream.readableStreamStrings.close
import typingsSlinky.readableStream.readableStreamStrings.data
import typingsSlinky.readableStream.readableStreamStrings.end
import typingsSlinky.readableStream.readableStreamStrings.error
import typingsSlinky.readableStream.readableStreamStrings.pause
import typingsSlinky.readableStream.readableStreamStrings.readable
import typingsSlinky.readableStream.readableStreamStrings.resume
...
object NodeBaseExport {
  ...
  @js.native
  def Duplex: typingsSlinky.node.streamMod.Duplex = js.native
  @scala.inline
  def Duplex_=(x: typingsSlinky.node.streamMod.Duplex): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Duplex")(x.asInstanceOf[js.Any])
  
  @JSImport("readable-stream", "NodeBaseExport.PassThrough")
  @js.native
  def PassThrough: typingsSlinky.node.streamMod.PassThrough = js.native
  @scala.inline
  def PassThrough_=(x: typingsSlinky.node.streamMod.PassThrough): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PassThrough")(x.asInstanceOf[js.Any])
  
  @JSImport("readable-stream", "NodeBaseExport.Readable")
  @js.native
  def Readable_ : typingsSlinky.node.streamMod.Readable = js.native
  
  @scala.inline
  def Readable__=(x: typingsSlinky.node.streamMod.Readable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Readable")(x.asInstanceOf[js.Any])
  
  @JSImport("readable-stream", "NodeBaseExport.Stream")
  @js.native
  def Stream: typingsSlinky.node.streamMod.^ = js.native
  @scala.inline
  def Stream_=(x: typingsSlinky.node.streamMod.^): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Stream")(x.asInstanceOf[js.Any])
  
  @JSImport("readable-stream", "NodeBaseExport.Transform")
  @js.native
  def Transform: typingsSlinky.node.streamMod.Transform = js.native
  @scala.inline
  def Transform_=(x: typingsSlinky.node.streamMod.Transform): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Transform")(x.asInstanceOf[js.Any])
  
  @JSImport("readable-stream", "NodeBaseExport.Writable")
  @js.native
  def Writable: typingsSlinky.node.streamMod.Writable = js.native
  @scala.inline
  def Writable_=(x: typingsSlinky.node.streamMod.Writable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Writable")(x.asInstanceOf[js.Any])
  ...
  @JSImport("readable-stream", "NodeBaseExport.constructor")
  @js.native
  def constructor(opts: typingsSlinky.node.streamMod.ReadableOptions): js.Any = js.native
