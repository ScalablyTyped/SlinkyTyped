...
import typingsSlinky.reactDashMotion.reactDashMotionMod.MotionProps
...
object Motion
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashMotion.reactDashMotionMod.Motion] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashMotion.reactDashMotionMod.Motion] = {
