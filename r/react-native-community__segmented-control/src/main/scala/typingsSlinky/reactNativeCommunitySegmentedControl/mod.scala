package typingsSlinky.reactNativeCommunitySegmentedControl
...
object mod {
  ...
  /**
    ...
    * ````
    */
  type SegmentedControlComponent = ReactComponentClass[SegmentedControlProps]
  ...
  object SegmentedControlProps {
    ...
    implicit class SegmentedControlPropsMutableBuilder[Self <: SegmentedControlProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: SyntheticEvent[NodeHandle, NativeSegmentedControlIOSChangeEvent] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
