package typingsSlinky.reactNativeCommunitySegmentedControl.components
...
import typingsSlinky.reactNativeCommunitySegmentedControl.mod.FontStyle
import typingsSlinky.reactNativeCommunitySegmentedControl.mod.NativeSegmentedControlIOSChangeEvent
import typingsSlinky.reactNativeCommunitySegmentedControl.mod.SegmentedControlProps
import typingsSlinky.reactNativeCommunitySegmentedControl.mod.default
import typingsSlinky.reactNativeCommunitySegmentedControl.reactNativeCommunitySegmentedControlStrings.dark
import typingsSlinky.reactNativeCommunitySegmentedControl.reactNativeCommunitySegmentedControlStrings.light
...
object SegmentedControl {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def activeFontStyle(value: FontStyle): this.type = set("activeFontStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def appearance(value: dark | light): this.type = set("appearance", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def momentary(value: Boolean): this.type = set("momentary", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: SyntheticEvent[NodeHandle, NativeSegmentedControlIOSChangeEvent] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
