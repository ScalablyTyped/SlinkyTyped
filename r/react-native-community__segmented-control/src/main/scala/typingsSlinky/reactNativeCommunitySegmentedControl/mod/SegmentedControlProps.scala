package typingsSlinky.reactNativeCommunitySegmentedControl.mod
...
object SegmentedControlProps {
  ...
  implicit class SegmentedControlPropsOps[Self <: SegmentedControlProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[NodeHandle, NativeSegmentedControlIOSChangeEvent] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
