...
import typingsSlinky.reactDashFa.reactDashFaMod.IconStackProps
...
object IconStack
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with ReactComponentClass[IconStackProps], Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with ReactComponentClass[IconStackProps], Event] => Unit = null,
