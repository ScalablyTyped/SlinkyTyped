...
object mod extends Shortcut {
  ...
  object DatePickerProps {
    ...
    implicit class DatePickerPropsMutableBuilder[Self <: DatePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClearButtonElement(value: ReactElement): Self = StObject.set(x, "clearButtonElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClearButtonElementReactElement(value: ReactElement): Self = StObject.set(x, "clearButtonElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClearButtonElementUndefined: Self = StObject.set(x, "clearButtonElement", js.undefined)
      
      @scala.inline
      def setCustomControl(value: ReactComponentClass[_]): Self = StObject.set(x, "customControl", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomControlComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "customControl", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomControlFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "customControl", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNextButtonElement(value: ReactElement): Self = StObject.set(x, "nextButtonElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNextButtonElementReactElement(value: ReactElement): Self = StObject.set(x, "nextButtonElement", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPreviousButtonElement(value: ReactElement): Self = StObject.set(x, "previousButtonElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreviousButtonElementReactElement(value: ReactElement): Self = StObject.set(x, "previousButtonElement", value.asInstanceOf[js.Any])
