...
object Class
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapDatePicker.mod.Class] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapDatePicker.mod.Class] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactBootstrapDatePicker.mod.Class] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactBootstrapDatePicker.mod.Class](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
