...
object ReactBootstrapDatePicker {
  ...
  object Class {
    ...
    implicit def make(companion: Class.type): typingsSlinky.reactBootstrapDatePicker.components.ReactBootstrapDatePicker.Class.Builder = new typingsSlinky.reactBootstrapDatePicker.components.ReactBootstrapDatePicker.Class.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DatePickerProps): typingsSlinky.reactBootstrapDatePicker.components.ReactBootstrapDatePicker.Class.Builder = new typingsSlinky.reactBootstrapDatePicker.components.ReactBootstrapDatePicker.Class.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
