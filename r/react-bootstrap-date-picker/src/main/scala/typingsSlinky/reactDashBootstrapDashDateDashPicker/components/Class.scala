package typingsSlinky.reactDashBootstrapDashDateDashPicker.components
...
import typingsSlinky.reactDashBootstrapDashDateDashPicker.reactDashBootstrapDashDateDashPickerMod.DatePickerProps
...
object Class
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashBootstrapDashDateDashPicker.reactDashBootstrapDashDateDashPickerMod.Class
    ] {
  ...
  /* The following DOM/SVG props were specified: autoFocus, className, disabled, onBlur, onFocus */
  def apply(
  ...
  typingsSlinky.reactDashBootstrapDashDateDashPicker.reactDashBootstrapDashDateDashPickerMod.Class](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
