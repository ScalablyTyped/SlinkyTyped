...
trait Props[FormFields] extends js.Object {
  ...
  var render: js.UndefOr[js.Function1[/* hooks */ FormHooks[FormFields], ReactElement]] = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props[_], FormFields] (val x: Self with Props[FormFields]) extends AnyVal {
    ...
    @scala.inline
    def setRender(value: /* hooks */ FormHooks[FormFields] => ReactElement): Self = this.set("render", js.Any.fromFunction1(value))
