...
object mod {
  ...
  object ErrorResponseArgs {
    ...
    implicit class ErrorResponseArgsMutableBuilder[Self <: ErrorResponseArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMessage(value: String | js.Error): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMessageError(value: js.Error): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props[_], FormFields] (val x: Self with Props[FormFields]) extends AnyVal {
      ...
      @scala.inline
      def setRender(value: /* hooks */ FormHooks[FormFields] => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  */
  ...
  object ResponseArgs {
    ...
    @scala.inline
    def ErrorResponseArgs(message: String | js.Error, status: error): typingsSlinky.reactMailchimpSubscribe.mod.ErrorResponseArgs = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMailchimpSubscribe.mod.ErrorResponseArgs]
    }
    
    @scala.inline
    def SuccessResponseArgs(message: String, status: success): typingsSlinky.reactMailchimpSubscribe.mod.SuccessResponseArgs = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMailchimpSubscribe.mod.SuccessResponseArgs]
    }
  }
