...
object Dropdown {
  ...
  implicit def make(companion: Dropdown.type): SharedBuilder_DropdownPropsRefAttributes821852308[Ref[js.Any] with js.Object] = new SharedBuilder_DropdownPropsRefAttributes821852308[Ref[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
