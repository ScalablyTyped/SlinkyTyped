...
object Dropdown {
  ...
  implicit def make(companion: Dropdown.type): `SharedBuilder_<intersection>821852308`[Ref[js.Any]] = new `SharedBuilder_<intersection>821852308`[Ref[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
