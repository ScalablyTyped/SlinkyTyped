package typingsSlinky.reactMdTabs.anon
...
@js.native
trait PickTabsListPropshiddenco extends js.Object {
...
object PickTabsListPropshiddenco {
  ...
  @scala.inline
  implicit class PickTabsListPropshiddencoOps[Self <: PickTabsListPropshiddenco] (val x: Self) extends AnyVal {
    @scala.inline
