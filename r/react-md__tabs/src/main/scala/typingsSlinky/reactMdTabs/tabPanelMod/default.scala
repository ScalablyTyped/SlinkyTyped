...
/**
  ...
  */
@JSImport("@react-md/tabs/types/TabPanel", JSImport.Default)
@js.native
object default extends TopLevel[ForwardRefExoticComponent[TabPanelProps with RefAttributes[HTMLDivElement]]]
