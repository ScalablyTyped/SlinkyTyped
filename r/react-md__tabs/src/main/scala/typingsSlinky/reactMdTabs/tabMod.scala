...
import typingsSlinky.reactMdTabs.reactMdTabsStrings.assertive
import typingsSlinky.reactMdTabs.reactMdTabsStrings.both
import typingsSlinky.reactMdTabs.reactMdTabsStrings.copy
import typingsSlinky.reactMdTabs.reactMdTabsStrings.date
import typingsSlinky.reactMdTabs.reactMdTabsStrings.decimal
import typingsSlinky.reactMdTabs.reactMdTabsStrings.descending
import typingsSlinky.reactMdTabs.reactMdTabsStrings.dialog
import typingsSlinky.reactMdTabs.reactMdTabsStrings.email
import typingsSlinky.reactMdTabs.reactMdTabsStrings.execute
import typingsSlinky.reactMdTabs.reactMdTabsStrings.grammar
import typingsSlinky.reactMdTabs.reactMdTabsStrings.grid
import typingsSlinky.reactMdTabs.reactMdTabsStrings.horizontal
import typingsSlinky.reactMdTabs.reactMdTabsStrings.inherit
import typingsSlinky.reactMdTabs.reactMdTabsStrings.link
import typingsSlinky.reactMdTabs.reactMdTabsStrings.list
import typingsSlinky.reactMdTabs.reactMdTabsStrings.listbox
import typingsSlinky.reactMdTabs.reactMdTabsStrings.location
import typingsSlinky.reactMdTabs.reactMdTabsStrings.menu
import typingsSlinky.reactMdTabs.reactMdTabsStrings.mixed
import typingsSlinky.reactMdTabs.reactMdTabsStrings.move
import typingsSlinky.reactMdTabs.reactMdTabsStrings.no
import typingsSlinky.reactMdTabs.reactMdTabsStrings.none
import typingsSlinky.reactMdTabs.reactMdTabsStrings.numeric
import typingsSlinky.reactMdTabs.reactMdTabsStrings.off
import typingsSlinky.reactMdTabs.reactMdTabsStrings.on
import typingsSlinky.reactMdTabs.reactMdTabsStrings.other
import typingsSlinky.reactMdTabs.reactMdTabsStrings.page
import typingsSlinky.reactMdTabs.reactMdTabsStrings.polite
import typingsSlinky.reactMdTabs.reactMdTabsStrings.popup
import typingsSlinky.reactMdTabs.reactMdTabsStrings.removals
import typingsSlinky.reactMdTabs.reactMdTabsStrings.search
import typingsSlinky.reactMdTabs.reactMdTabsStrings.spelling
import typingsSlinky.reactMdTabs.reactMdTabsStrings.step
import typingsSlinky.reactMdTabs.reactMdTabsStrings.tel
import typingsSlinky.reactMdTabs.reactMdTabsStrings.text
import typingsSlinky.reactMdTabs.reactMdTabsStrings.time
import typingsSlinky.reactMdTabs.reactMdTabsStrings.tree
import typingsSlinky.reactMdTabs.reactMdTabsStrings.url
import typingsSlinky.reactMdTabs.reactMdTabsStrings.vertical
import typingsSlinky.reactMdTabs.reactMdTabsStrings.yes
...
object tabMod {
  ...
  @JSImport("@react-md/tabs/types/Tab", "Tab")
  @js.native
  val Tab: ForwardRefExoticComponent[TabProps with RefAttributes[HTMLButtonElement]] = js.native
  
  /* Inlined parent @react-md/tabs.@react-md/tabs/types/types.TabConfig */
  /* Inlined parent react.react.HTMLAttributes<std.HTMLButtonElement> */
  /* Inlined parent std.Omit<@react-md/states.@react-md/states.InteractionStatesOptions<std.HTMLButtonElement>, 'disableSpacebarClick'> */
  @js.native
  trait TabProps extends StObject {
    ...
    /**
      ...
      */
    var panelId: js.UndefOr[String] = js.native
  ...
  object TabProps {
    ...
    @scala.inline
    def apply(active: Boolean, id: String): TabProps = {
    ...
    implicit class TabPropsMutableBuilder[Self <: TabProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPanelId(value: String): Self = StObject.set(x, "panelId", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPanelIdUndefined: Self = StObject.set(x, "panelId", js.undefined)
