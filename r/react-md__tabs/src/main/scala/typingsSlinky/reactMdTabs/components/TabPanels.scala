...
object TabPanels {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableScrollFix(value: Boolean): this.type = set("disableScrollFix", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TabPanelsProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
