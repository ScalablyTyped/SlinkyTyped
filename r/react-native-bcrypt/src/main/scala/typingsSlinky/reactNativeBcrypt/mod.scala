...
object mod extends js.Object {
  ...
  trait ReactNativeBcrypt extends js.Object {
    ...
    /**
      ...
      */
    def compare(s: String, hash: String, callback: js.Function2[/* error */ js.Error, /* boolean */ Boolean, _]): Unit = js.native
    def compare(
      s: String,
      hash: String,
      callback: js.Function2[/* error */ js.Error, /* boolean */ Boolean, _],
      progressCallback: js.Function1[/* number */ Double, _]
    ): Unit = js.native
    ...
    def genSalt(
      ...
      seed_length: js.UndefOr[scala.Nothing],
      callback: js.Function2[/* error */ js.Error, /* string */ js.UndefOr[String], _]
    ): Unit = js.native
    def genSalt(
      rounds: js.UndefOr[scala.Nothing],
      seed_length: js.Function2[/* error */ js.Error, /* string */ js.UndefOr[String], _]
    ): Unit = js.native
    def genSalt(
      rounds: js.UndefOr[scala.Nothing],
      seed_length: js.Function2[/* error */ js.Error, /* string */ js.UndefOr[String], _],
    ...
    def genSalt(rounds: js.UndefOr[scala.Nothing], seed_length: Double): Unit = js.native
    def genSalt(
      rounds: js.UndefOr[scala.Nothing],
      seed_length: Double,
      callback: js.Function2[/* error */ js.Error, /* string */ js.UndefOr[String], _]
    ): Unit = js.native
    def genSalt(rounds: js.Function2[/* error */ js.Error, /* string */ js.UndefOr[String], _]): Unit = js.native
    def genSalt(
      rounds: js.Function2[/* error */ js.Error, /* string */ js.UndefOr[String], _],
      seed_length: js.UndefOr[scala.Nothing],
      callback: js.Function2[/* error */ js.Error, /* string */ js.UndefOr[String], _]
    ): Unit = js.native
    def genSalt(
    ...
    def genSaltSync(round: js.UndefOr[scala.Nothing], seed_length: Double): String = js.native
