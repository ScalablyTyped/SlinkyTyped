...
version := "9.0-dt-20200213Z-249a4f"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "html-webpack-plugin" % "3.2-dt-20200129Z-0a722d",
  ...
  "org.scalablytyped.slinky" %%% "webpack-dev-server" % "3.10-dt-20200227Z-30f712",
