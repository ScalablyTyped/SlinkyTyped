...
version := "9.0-dt-20191220Z-3ba08e"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-2077df",
  ...
  "org.scalablytyped.slinky" %%% "webpack-dev-server" % "3.9-dt-20191127Z-10597f",
