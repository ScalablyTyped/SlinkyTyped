...
trait Typeofcompilation extends js.Object {
  var Asset: Instantiable0[typingsSlinky.webpack.mod.compilation.Asset]
  var Chunk: Instantiable0[typingsSlinky.webpack.mod.compilation.Chunk]
  var ChunkGroup: Instantiable0[typingsSlinky.webpack.mod.compilation.ChunkGroup]
  var ChunkHash: Instantiable0[typingsSlinky.webpack.mod.compilation.ChunkHash]
  var ChunkTemplate: Instantiable0[typingsSlinky.webpack.mod.compilation.ChunkTemplate]
  var Compilation: Instantiable0[typingsSlinky.webpack.mod.compilation.Compilation]
  var ContextModuleFactory: Instantiable0[typingsSlinky.webpack.mod.compilation.ContextModuleFactory]
  var DependenciesBlock: Instantiable0[typingsSlinky.webpack.mod.compilation.DependenciesBlock]
  var Dependency: TypeofDependency
  var DllModuleFactory: Instantiable0[typingsSlinky.webpack.mod.compilation.DllModuleFactory]
  var HotUpdateChunkTemplate: Instantiable0[typingsSlinky.webpack.mod.compilation.HotUpdateChunkTemplate]
  var MainTemplate: Instantiable0[typingsSlinky.webpack.mod.compilation.MainTemplate]
  var Module: Instantiable1[/* type */ String, typingsSlinky.webpack.mod.compilation.Module]
  var ModuleTemplate: Instantiable0[typingsSlinky.webpack.mod.compilation.ModuleTemplate]
  var NormalModuleFactory: Instantiable0[NormalModuleFactory_]
  var Record: Instantiable0[typingsSlinky.webpack.mod.compilation.Record]
  var RuntimeTemplate: Instantiable0[typingsSlinky.webpack.mod.compilation.RuntimeTemplate]
