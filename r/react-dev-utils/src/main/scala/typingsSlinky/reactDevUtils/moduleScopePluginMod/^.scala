package typingsSlinky.reactDevUtils.moduleScopePluginMod
...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify webpack.Plugin * / any */ @JSImport("react-dev-utils/ModuleScopePlugin", JSImport.Namespace)
@js.native
