...
object mod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CameraProps] = js.native
  
  @JSImport("react-html5-camera-photo", "Camera")
  @js.native
  val Camera: ReactComponentClass[CameraProps] = js.native
  ...
  trait CameraProps extends StObject {
    ...
    /**
      ...
      */
    var onCameraError: js.UndefOr[js.Function1[/* error */ js.Error, Unit]] = js.native
  ...
  object CameraProps {
    ...
    implicit class CameraPropsMutableBuilder[Self <: CameraProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnCameraError(value: /* error */ js.Error => Unit): Self = StObject.set(x, "onCameraError", js.Any.fromFunction1(value))
  ...
  type _To = ReactComponentClass[CameraProps]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ReactComponentClass[CameraProps] = default
}
