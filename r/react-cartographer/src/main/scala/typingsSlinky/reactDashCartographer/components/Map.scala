package typingsSlinky.reactDashCartographer.components

import org.scalablytyped.runtime.StringDictionary
import slinky.core.BuildingComponent
import slinky.core.ExternalComponentWithAttributesWithRefType
import slinky.web.html.`*`.tag
import typingsSlinky.reactDashCartographer.libComponentsMapMod.MapProps
import typingsSlinky.reactDashCartographer.libComponentsMapMod.default
import typingsSlinky.reactDashCartographer.reactDashCartographerStrings.bing
import typingsSlinky.reactDashCartographer.reactDashCartographerStrings.google
import typingsSlinky.reactDashCartographer.reactDashCartographerStrings.yahoo
