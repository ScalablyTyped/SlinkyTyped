...
object MapData {
  ...
  implicit class MapDataOps[Self <: MapData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLocationLink(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("locationLink")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLocationText(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("locationText")(value.asInstanceOf[js.Any])
        ret
    }
  }
