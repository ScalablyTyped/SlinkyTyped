...
@scala.inline
class SharedBuilder_TextFieldProps_1541991017[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def activeLineWidth(value: Double): this.type = set("activeLineWidth", value.asInstanceOf[js.Any])
  @scala.inline
  def affixTextStyle(value: StyleProp[TextStyle]): this.type = set("affixTextStyle", value.asInstanceOf[js.Any])
  @scala.inline
  def affixTextStyleNull: this.type = set("affixTextStyle", null)
  @scala.inline
  ...
  @scala.inline
  def characterRestriction(value: Double): this.type = set("characterRestriction", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def disabledLineType(
    value: solid | dotted | dashed | typingsSlinky.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.none
  ): this.type = set("disabledLineType", value.asInstanceOf[js.Any])
  @scala.inline
  def disabledLineWidth(value: Double): this.type = set("disabledLineWidth", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def formatText(value: /* text */ String => String): this.type = set("formatText", js.Any.fromFunction1(value))
  @scala.inline
  ...
  def lineType(
    value: solid | dotted | dashed | typingsSlinky.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.none
  ): this.type = set("lineType", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def renderLeftAccessory(value: () => ReactElement): this.type = set("renderLeftAccessory", js.Any.fromFunction0(value))
  @scala.inline
  def renderRightAccessory(value: () => ReactElement): this.type = set("renderRightAccessory", js.Any.fromFunction0(value))
  @scala.inline
