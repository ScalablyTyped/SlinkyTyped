...
@js.native
trait Element[V /* <: String | js.typedarray.Uint8Array */] extends js.Object {
...
object Element {
  @scala.inline
  def apply[/* <: java.lang.String | typingsSlinky.std.Uint8Array */ V](length: Double, lengthSize: Double, `type`: Double): Element[V] = {
  ...
  @scala.inline
  implicit class ElementOps[Self <: Element[_], /* <: java.lang.String | typingsSlinky.std.Uint8Array */ V] (val x: Self with Element[V]) extends AnyVal {
    @scala.inline
