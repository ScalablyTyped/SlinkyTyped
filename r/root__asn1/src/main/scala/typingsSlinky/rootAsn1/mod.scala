...
import typingsSlinky.rootAsn1.anon.Der
import typingsSlinky.rootAsn1.anon.DerJson
import typingsSlinky.rootAsn1.anon.Json
import typingsSlinky.rootAsn1.anon.JsonVerbose
import typingsSlinky.rootAsn1.anon.Verbose
import typingsSlinky.rootAsn1.anon.`0`
...
object mod {
  ...
  @js.native
  def pack(asn1: ArrInput): js.typedarray.Uint8Array = js.native
  @JSImport("@root/asn1", "pack")
  @js.native
  def pack(asn1: ArrInput, opts: Json): js.typedarray.Uint8Array = js.native
  @JSImport("@root/asn1", "pack")
  @js.native
  def pack(asn1: ArrInput, opts: `0`): String = js.native
  @JSImport("@root/asn1", "pack")
  @js.native
  def pack(asn1: ElementInput): js.typedarray.Uint8Array = js.native
  @JSImport("@root/asn1", "pack")
  @js.native
  def pack(asn1: ElementInput, opts: Json): js.typedarray.Uint8Array = js.native
  @JSImport("@root/asn1", "pack")
  @js.native
  ...
  @js.native
  def parseVerbose(buf: js.typedarray.Uint8Array): ElementBuffer = js.native
  @JSImport("@root/asn1", "parseVerbose")
  @js.native
  def parseVerbose(buf: js.typedarray.Uint8Array, opts: Json): ElementBuffer = js.native
  @JSImport("@root/asn1", "parseVerbose")
  @js.native
  def parseVerbose(buf: js.typedarray.Uint8Array, opts: `0`): ElementHex = js.native
  ...
  type ArrInput = js.Tuple2[
    String | Double, 
    String | js.typedarray.Uint8Array | (js.Array[
  ...
  object Element {
    ...
    @scala.inline
    def apply[V /* <: String | js.typedarray.Uint8Array */](length: Double, lengthSize: Double, `type`: Double): Element[V] = {
    ...
    @scala.inline
    implicit class ElementMutableBuilder[Self <: Element[_], V /* <: String | js.typedarray.Uint8Array */] (val x: Self with Element[V]) extends AnyVal {
  ...
  trait ElementInput extends StObject {
    ...
    var value: js.UndefOr[String | js.typedarray.Uint8Array] = js.native
  }
  object ElementInput {
    ...
    implicit class ElementInputMutableBuilder[Self <: ElementInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValue(value: String | js.typedarray.Uint8Array): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
