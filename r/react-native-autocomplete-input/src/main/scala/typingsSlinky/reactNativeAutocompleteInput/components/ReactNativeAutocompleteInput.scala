...
object ReactNativeAutocompleteInput {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def hideResults(value: Boolean): this.type = set("hideResults", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def keyExtractor(value: (T, /* i */ Double) => String): this.type = set("keyExtractor", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def listStyle(value: StyleProp[ViewStyle]): this.type = set("listStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def listStyleNull: this.type = set("listStyle", null)
    ...
    @scala.inline
    def onShowResult(value: /* showResults */ Boolean => Unit): this.type = set("onShowResult", js.Any.fromFunction1(value))
