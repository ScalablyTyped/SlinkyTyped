...
object mod {
  ...
  type Autocomplete[T] = ReactComponentClass[AutocompleteProps[T]]
  ...
  trait AutocompleteProps[T] extends TextInputProps {
    ...
    /**
      ...
      */
    def renderItem(itemWithIndex: Index[T]): ReactElement = js.native
    ...
    /**
      ...
      */
    var renderTextInput: js.UndefOr[js.Function1[/* props */ TextInputProperties, ReactElement]] = js.native
  }
  object AutocompleteProps {
    
    @scala.inline
    def apply[T](data: js.Array[T], renderItem: Index[T] => ReactElement): AutocompleteProps[T] = {
    ...
    implicit class AutocompletePropsMutableBuilder[Self <: AutocompleteProps[_], T] (val x: Self with AutocompleteProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setRenderItem(value: Index[T] => ReactElement): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRenderTextInput(value: /* props */ TextInputProperties => ReactElement): Self = StObject.set(x, "renderTextInput", js.Any.fromFunction1(value))
