...
object AutocompleteProps {
  ...
  implicit class AutocompletePropsOps[Self <: AutocompleteProps[_], T] (val x: Self with AutocompleteProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderItem(value: Index[T] => ReactElement): Self = this.set("renderItem", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRenderTextInput(value: /* props */ TextInputProperties => ReactElement): Self = this.set("renderTextInput", js.Any.fromFunction1(value))
    @scala.inline
