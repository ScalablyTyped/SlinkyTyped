package typingsSlinky.reactDashNativeDashAutocompleteDashInput.reactDashNativeDashAutocompleteDashInputMod
...
trait AutocompleteProps[T] extends TextInputProps {
  ...
  /**
    ...
    */
  def renderItem(itemWithIndex: Anon_Index[T]): TagMod[Any]
}
