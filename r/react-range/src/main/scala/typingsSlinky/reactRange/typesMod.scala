...
object typesMod {
  ...
  object IMarkProps {
    ...
    @scala.inline
    def apply(key: String, ref: ReactRef[_], style: CSSProperties): IMarkProps = {
    ...
    implicit class IMarkPropsMutableBuilder[Self <: IMarkProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: ReactRef[_]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
  ...
  object IProps {
    ...
    implicit class IPropsMutableBuilder[Self <: IProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderMark(value: /* params */ Index => ReactElement): Self = StObject.set(x, "renderMark", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRenderMarkUndefined: Self = StObject.set(x, "renderMark", js.undefined)
      
      @scala.inline
      def setRenderThumb(value: IsDragged => ReactElement): Self = StObject.set(x, "renderThumb", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRenderTrack(value: Children => ReactElement): Self = StObject.set(x, "renderTrack", js.Any.fromFunction1(value))
