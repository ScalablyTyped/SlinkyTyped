...
import typingsSlinky.reactDashRange.Anon_Children
import typingsSlinky.reactDashRange.Anon_Index
...
trait IProps extends js.Object {
  ...
  def renderThumb(params: Anon_Index): TagMod[Any]
  def renderTrack(params: Anon_Children): TagMod[Any]
}
...
object IProps {
  ...
  def apply(
    ...
    renderThumb: Anon_Index => TagMod[Any],
    renderTrack: Anon_Children => TagMod[Any],
    rtl: Boolean,
    step: Double,
