package typingsSlinky.reactWorldFlags.components
...
import typingsSlinky.reactWorldFlags.mod.FlagProps
...
object ReactWorldFlags {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def fallback(value: Element): this.type = set("fallback", value.asInstanceOf[js.Any])
