...
object Router {
  ...
  implicit class RouterOps[Self <: Router[_], TState] (val x: Self with Router[TState]) extends AnyVal {
    ...
    @scala.inline
    def setGetPathAndParamsForState(value: TState => typingsSlinky.reduxFirstRouter.anon.Params): Self = this.set("getPathAndParamsForState", js.Any.fromFunction1(value))
    @scala.inline
