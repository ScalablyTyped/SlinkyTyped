...
object Options {
  ...
  implicit class OptionsOps[Self <: Options[_, _], TKeys, TState] (val x: Self with (Options[TKeys, TState])) extends AnyVal {
    ...
    @scala.inline
    def setCreateHistory(value: () => History[typingsSlinky.history.mod.LocationState]): Self = this.set("createHistory", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setRestoreScroll(value: /* history */ History[typingsSlinky.history.mod.LocationState] => ScrollBehavior_): Self = this.set("restoreScroll", js.Any.fromFunction1(value))
