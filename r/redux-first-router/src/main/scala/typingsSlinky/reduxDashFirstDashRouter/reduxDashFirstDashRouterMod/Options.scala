...
trait Options[TKeys, TState] extends js.Object {
  ...
  /**
    ...
    */
  var createHistory: js.UndefOr[js.Function0[History[typingsSlinky.history.historyMod.LocationState]]] = js.undefined
  /**
  ...
  var restoreScroll: js.UndefOr[
    js.Function1[
      /* history */ History[typingsSlinky.history.historyMod.LocationState], 
      ScrollBehavior
    ]
  ] = js.undefined
  /**
...
object Options {
  ...
  def apply[TKeys, TState](
    ...
    createHistory: () => History[typingsSlinky.history.historyMod.LocationState] = null,
    ...
    restoreScroll: /* history */ History[typingsSlinky.history.historyMod.LocationState] => ScrollBehavior = null,
