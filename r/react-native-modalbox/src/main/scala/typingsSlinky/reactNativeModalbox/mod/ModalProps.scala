...
object ModalProps {
  ...
  implicit class ModalPropsOps[Self <: ModalProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackdropContentReactElement(value: ReactElement): Self = this.set("backdropContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setBackdropContent(value: ReactElement): Self = this.set("backdropContent", value.asInstanceOf[js.Any])
    @scala.inline
