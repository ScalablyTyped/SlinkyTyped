...
import typingsSlinky.reactForm.anon.FieldPropsInputHTMLAttrib
...
import typingsSlinky.reactForm.anon.Label
...
import typingsSlinky.reactForm.reactFormBooleans.`false`
...
object mod {
  ...
  @js.native
  val Checkbox: ReactComponentClass[FieldProps with InputHTMLAttributes[HTMLInputElement]] = js.native
  ...
  @js.native
  def FormField(component: ReactComponentClass[_]): ReactComponentClass[_] = js.native
  
  @JSImport("react-form", "NestedForm")
  @js.native
  val NestedForm: ReactComponentClass[FieldProps] = js.native
  
  @JSImport("react-form", "Radio")
  @js.native
  val Radio: ReactComponentClass[FieldPropsInputHTMLAttrib] = js.native
  ...
  @js.native
  val StyledCheckbox: ReactComponentClass[StyledPropsInputHTMLAttri] = js.native
  
  @JSImport("react-form", "StyledRadio")
  @js.native
  val StyledRadio: ReactComponentClass[StyledPropsInputHTMLAttriAbout] = js.native
  ...
  @js.native
  val StyledSelect: ReactComponentClass[StyledProps with SelectProps with InputHTMLAttributes[HTMLSelectElement]] = js.native
  
  @JSImport("react-form", "StyledText")
  @js.native
  val StyledText: ReactComponentClass[StyledProps with InputHTMLAttributes[HTMLInputElement]] = js.native
  
  @JSImport("react-form", "StyledTextArea")
  @js.native
  val StyledTextArea: ReactComponentClass[StyledProps with TextareaHTMLAttributes[HTMLTextAreaElement]] = js.native
  
  @JSImport("react-form", "Text")
  @js.native
  val Text: ReactComponentClass[FieldProps with InputHTMLAttributes[HTMLInputElement]] = js.native
  
  @JSImport("react-form", "TextArea")
  @js.native
  val TextArea: ReactComponentClass[FieldProps with TextareaHTMLAttributes[HTMLTextAreaElement]] = js.native
  ...
  object FormApi {
    ...
    implicit class FormApiMutableBuilder[Self <: FormApi] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSubmitForm(value: SyntheticEvent[Event, _] => Unit): Self = StObject.set(x, "submitForm", js.Any.fromFunction1(value))
  ...
  object FormProps {
    ...
    implicit class FormPropsMutableBuilder[Self <: FormProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponent(value: ReactType[typingsSlinky.reactForm.anon.FormApi]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[typingsSlinky.reactForm.anon.FormApi]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[typingsSlinky.reactForm.anon.FormApi]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
  ...
  type RenderReturn = ReactElement | `false` | Null | js.Array[scala.Nothing]
