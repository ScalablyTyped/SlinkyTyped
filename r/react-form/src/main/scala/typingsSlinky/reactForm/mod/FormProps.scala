...
trait FormProps extends js.Object {
  ...
  var component: js.UndefOr[ReactType[typingsSlinky.reactForm.anon.FormApi]] = js.native
...
object FormProps {
  ...
  implicit class FormPropsOps[Self <: FormProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[typingsSlinky.reactForm.anon.FormApi]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[typingsSlinky.reactForm.anon.FormApi]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponent(value: ReactType[typingsSlinky.reactForm.anon.FormApi]): Self = this.set("component", value.asInstanceOf[js.Any])
