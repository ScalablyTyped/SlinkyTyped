...
trait FormProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[typingsSlinky.reactForm.anon.FormApi]] = js.undefined
...
object FormProps {
  ...
  def apply(
    ...
    component: ReactComponentClass[typingsSlinky.reactForm.anon.FormApi] = null,
    ...
    onSubmit: (/* values */ FormValues, /* submissionEvent */ SyntheticEvent[Event, _], /* formApi */ FormApi) => Unit = null,
