...
object FormApi {
  @scala.inline
  def apply(formApi: typingsSlinky.reactForm.mod.FormApi): FormApi = {
  ...
  implicit class FormApiOps[Self <: FormApi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormApi(value: typingsSlinky.reactForm.mod.FormApi): Self = this.set("formApi", value.asInstanceOf[js.Any])
  }
