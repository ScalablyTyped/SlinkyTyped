...
trait ReadonlyPartialFormProps extends js.Object {
  ...
  val getApi: js.UndefOr[js.Function1[/* formApi */ typingsSlinky.reactForm.mod.FormApi, Unit]] = js.native
  
  val onSubmit: js.UndefOr[
    js.Function3[
      /* values */ FormValues, 
      /* submissionEvent */ SyntheticEvent[Event, _], 
      /* formApi */ typingsSlinky.reactForm.mod.FormApi, 
      Unit
    ]
  ] = js.native
  
  val onSubmitFailure: js.UndefOr[
    js.Function2[/* errors */ FormErrors, /* formApi */ typingsSlinky.reactForm.mod.FormApi, Unit]
  ] = js.native
  ...
  val render: js.UndefOr[js.Function1[/* formApi */ typingsSlinky.reactForm.mod.FormApi, RenderReturn]] = js.native
...
object ReadonlyPartialFormProps {
  ...
  implicit class ReadonlyPartialFormPropsOps[Self <: ReadonlyPartialFormProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[FormApi]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[FormApi]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetApi(value: /* formApi */ typingsSlinky.reactForm.mod.FormApi => Unit): Self = this.set("getApi", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnSubmitFailure(value: (/* errors */ FormErrors, /* formApi */ typingsSlinky.reactForm.mod.FormApi) => Unit): Self = this.set("onSubmitFailure", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnSubmitFailure: Self = this.set("onSubmitFailure", js.undefined)
    
    @scala.inline
    def setPreSubmit(value: (/* values */ FormValues, /* formApi */ typingsSlinky.reactForm.mod.FormApi) => FormValues): Self = this.set("preSubmit", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setRender(value: /* formApi */ typingsSlinky.reactForm.mod.FormApi => RenderReturn): Self = this.set("render", js.Any.fromFunction1(value))
