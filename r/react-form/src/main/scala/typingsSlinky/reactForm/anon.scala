...
object anon {
  ...
  object FieldPropsInputHTMLAttrib {
    ...
    @scala.inline
    implicit class FieldPropsInputHTMLAttribMutableBuilder[Self <: FieldPropsInputHTMLAttrib] (val x: Self) extends AnyVal {
  ...
  object FieldPropschildrenpropsFi {
    ...
    @scala.inline
    implicit class FieldPropschildrenpropsFiMutableBuilder[Self <: FieldPropschildrenpropsFi] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setChildren(value: (js.Function1[/* props */ FieldApi, RenderReturn]) | RenderReturn): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* props */ FieldApi => RenderReturn): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setChildrenVarargs(value: scala.Nothing*): Self = StObject.set(x, "children", js.Array(value :_*))
  ...
  object FormApi {
    ...
    implicit class FormApiMutableBuilder[Self <: FormApi] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormApi(value: typingsSlinky.reactForm.mod.FormApi): Self = StObject.set(x, "formApi", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait FormPropschildrenpropsFor extends StObject {
    ...
    var getApi: js.UndefOr[js.Function1[/* formApi */ typingsSlinky.reactForm.mod.FormApi, Unit]] = js.native
    ...
    var render: js.UndefOr[js.Function1[/* formApi */ typingsSlinky.reactForm.mod.FormApi, RenderReturn]] = js.native
  ...
  object FormPropschildrenpropsFor {
    ...
    implicit class FormPropschildrenpropsForMutableBuilder[Self <: FormPropschildrenpropsFor] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (js.Function1[/* props */ FormFunctionProps, RenderReturn]) | RenderReturn): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* props */ FormFunctionProps => RenderReturn): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setComponent(value: ReactType[FormApi]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[FormApi]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[FormApi]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setGetApi(value: /* formApi */ typingsSlinky.reactForm.mod.FormApi => Unit): Self = StObject.set(x, "getApi", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnSubmitFailure(value: (/* errors */ FormErrors, /* formApi */ typingsSlinky.reactForm.mod.FormApi) => Unit): Self = StObject.set(x, "onSubmitFailure", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPreSubmit(value: (/* values */ FormValues, /* formApi */ typingsSlinky.reactForm.mod.FormApi) => FormValues): Self = StObject.set(x, "preSubmit", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRender(value: /* formApi */ typingsSlinky.reactForm.mod.FormApi => RenderReturn): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  object Label {
    ...
    implicit class LabelMutableBuilder[Self <: Label] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValue(value: FormValue): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  ...
  object StyledPropsInputHTMLAttri {
    ...
    @scala.inline
    implicit class StyledPropsInputHTMLAttriMutableBuilder[Self <: StyledPropsInputHTMLAttri] (val x: Self) extends AnyVal {
  ...
  object StyledPropsInputHTMLAttriAbout {
    ...
    @scala.inline
    implicit class StyledPropsInputHTMLAttriAboutMutableBuilder[Self <: StyledPropsInputHTMLAttriAbout] (val x: Self) extends AnyVal {
  ...
  object StyledPropschildrenpropsF {
    ...
    @scala.inline
    implicit class StyledPropschildrenpropsFMutableBuilder[Self <: StyledPropschildrenpropsF] (val x: Self) extends AnyVal {
