...
object StyledRadio {
  ...
  @scala.inline
  def apply(group: FieldApi, label: String): Builder = {
    val __props = js.Dynamic.literal(group = group.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[StyledPropsInputHTMLAttriAbout]))
  }
  ...
  def withProps(p: StyledPropsInputHTMLAttriAbout): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
