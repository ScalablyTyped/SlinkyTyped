...
object StyledTextArea {
  ...
  def withProps(p: StyledProps with TextareaHTMLAttributes[HTMLTextAreaElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: StyledTextArea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
