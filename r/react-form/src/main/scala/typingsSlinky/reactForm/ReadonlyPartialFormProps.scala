...
trait ReadonlyPartialFormProps extends js.Object {
  ...
  val component: js.UndefOr[ReactComponentClass[AnonFormApi]] = js.native
  ...
  val getApi: js.UndefOr[js.Function1[/* formApi */ FormApi, Unit]] = js.native
  ...
  val onSubmitFailure: js.UndefOr[js.Function2[/* errors */ FormErrors, /* formApi */ FormApi, Unit]] = js.native
  val preSubmit: js.UndefOr[js.Function2[/* values */ FormValues, /* formApi */ FormApi, FormValues]] = js.native
  val preValidate: js.UndefOr[js.Function1[/* values */ FormValues, FormValues]] = js.native
  val render: js.UndefOr[js.Function1[/* formApi */ FormApi, RenderReturn]] = js.native
