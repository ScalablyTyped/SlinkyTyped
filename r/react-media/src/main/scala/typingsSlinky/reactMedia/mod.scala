...
object mod {
  ...
  object MultiQueryProps {
    ...
    implicit class MultiQueryPropsMutableBuilder[Self <: MultiQueryProps[_], Queries] (val x: Self with MultiQueryProps[Queries]) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (js.Function1[/* matches */ QueryResults[Queries], ReactElement]) | ReactElement): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* matches */ QueryResults[Queries] => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  {[ key in keyof Queries ]: boolean}
    */ typingsSlinky.reactMedia.reactMediaStrings.QueryResults with TopLevel[js.Any]
  ...
  object SingleQueryProps {
    ...
    implicit class SingleQueryPropsMutableBuilder[Self <: SingleQueryProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (js.Function1[/* matches */ Boolean, ReactElement]) | ReactElement): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* matches */ Boolean => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
