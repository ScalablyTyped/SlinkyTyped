...
package object reactDashMediaMod {
  ...
  import typingsSlinky.reactDashMedia.Anon_Children
  import typingsSlinky.reactDashMedia.Anon_ChildrenDefaultMatches
  ...
  {[ key in keyof Queries ]: boolean}
    */ typingsSlinky.reactDashMedia.reactDashMediaStrings.QueryResults with js.Any
