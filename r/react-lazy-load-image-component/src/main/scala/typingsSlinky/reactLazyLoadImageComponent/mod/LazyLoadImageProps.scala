...
object LazyLoadImageProps {
  ...
  implicit class LazyLoadImagePropsOps[Self <: LazyLoadImageProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlaceholderSrc(value: String): Self = this.set("placeholderSrc", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePlaceholderSrc: Self = this.set("placeholderSrc", js.undefined)
    ...
    @scala.inline
    def setWrapperProps(value: HTMLAttributes[HTMLSpanElement]): Self = this.set("wrapperProps", value.asInstanceOf[js.Any])
