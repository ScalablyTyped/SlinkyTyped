...
object LazyLoadImageProps {
  ...
  @scala.inline
  implicit class LazyLoadImagePropsOps[Self <: LazyLoadImageProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLoading(value: eager | `lazy`): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPlaceholderSrc(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("placeholderSrc")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPlaceholderSrc: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("placeholderSrc")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withReferrerPolicy(value: `no-referrer` | origin | `unsafe-url`): Self = {
        val ret = this.duplicate
