...
object ComponentElement {
  @scala.inline
  def apply[P, /* <: typingsSlinky.rax.mod.Component[P, typingsSlinky.rax.mod.ComponentState, _] */ T](props: P, `type`: ComponentClass[P, ComponentState]): ComponentElement[P, T] = {
    val __obj = js.Dynamic.literal(props = props.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ComponentElement[P, T]]
  }
  @scala.inline
  implicit class ComponentElementOps[Self <: ComponentElement[_, _], P, /* <: typingsSlinky.rax.mod.Component[P, typingsSlinky.rax.mod.ComponentState, _] */ T] (val x: Self with (ComponentElement[P, T])) extends AnyVal {
    @scala.inline
