...
package object mod {
  ...
  // Event Handler Types
  // ----------------------------------------------------------------------
  type EventHandler[E /* <: typingsSlinky.rax.mod.SyntheticEvent[_, typingsSlinky.std.Event_] */] = js.Function1[/* event */ E, scala.Unit]
  ...
  // tslint:disable-next-line:no-empty-interface
  type FormEvent[T] = typingsSlinky.rax.mod.SyntheticEvent[T, typingsSlinky.std.Event_]
  ...
  type PropsWithChildren[P] = P with typingsSlinky.rax.AnonChildren
  /** Ensures that the props do not include string ref, which cannot be forwarded */
  type PropsWithRef[P] = P | (typingsSlinky.rax.mod.PropsWithoutRef[P] with typingsSlinky.rax.AnonRefExclude)
  ...
  type RaxEventHandler[T] = typingsSlinky.rax.mod.EventHandler[typingsSlinky.rax.mod.SyntheticEvent[T, typingsSlinky.std.Event_]]
