...
object createElement extends js.Object {
  ...
  def apply[P /* <: HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.Element */](`type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 114 */ js.Any): DetailedRaxHTMLElement[P, T] = js.native
  def apply[P /* <: HTMLAttributes[T] */, T /* <: org.scalajs.dom.raw.Element */](
