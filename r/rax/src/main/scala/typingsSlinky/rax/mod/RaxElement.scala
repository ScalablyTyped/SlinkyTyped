...
object RaxElement {
  @scala.inline
  def apply[P, /* <: java.lang.String | typingsSlinky.rax.mod.JSXElementConstructor[_] */ T](props: P, `type`: T): RaxElement[P, T] = {
    val __obj = js.Dynamic.literal(props = props.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[RaxElement[P, T]]
  }
  @scala.inline
  implicit class RaxElementOps[Self <: RaxElement[_, _], P, /* <: java.lang.String | typingsSlinky.rax.mod.JSXElementConstructor[_] */ T] (val x: Self with (RaxElement[P, T])) extends AnyVal {
    @scala.inline
