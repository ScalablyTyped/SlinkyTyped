...
import typingsSlinky.reactDashGoogleDashMapsDashLoader.TypeofClassMarker
import typingsSlinky.reactDashGoogleDashMapsDashLoader.TypeofData
import typingsSlinky.reactDashGoogleDashMapsDashLoader.Typeofadsense
import typingsSlinky.reactDashGoogleDashMapsDashLoader.Typeofdrawing
import typingsSlinky.reactDashGoogleDashMapsDashLoader.Typeofevent
import typingsSlinky.reactDashGoogleDashMapsDashLoader.Typeofgeometry
import typingsSlinky.reactDashGoogleDashMapsDashLoader.Typeofplaces
import typingsSlinky.reactDashGoogleDashMapsDashLoader.Typeofvisualization
