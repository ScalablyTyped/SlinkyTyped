...
import typingsSlinky.rmcDialog.rmcDialogNumbers.`0`
import typingsSlinky.rmcDialog.rmcDialogNumbers.`1.05`
import typingsSlinky.rmcDialog.rmcDialogNumbers.`1`
