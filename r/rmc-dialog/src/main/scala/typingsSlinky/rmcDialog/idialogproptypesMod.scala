...
object idialogproptypesMod {
  ...
  object IDialogPropTypes {
    ...
    implicit class IDialogPropTypesMutableBuilder[Self <: IDialogPropTypes] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnAnimateLeave(value: () => Unit): Self = StObject.set(x, "onAnimateLeave", js.Any.fromFunction0(value))
      
      @scala.inline
      def setOnAnimateLeaveUndefined: Self = StObject.set(x, "onAnimateLeave", js.undefined)
      
      @scala.inline
      def setOnClose(value: /* e */ js.Any => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
