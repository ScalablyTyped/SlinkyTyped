...
version := "0.0-dt-20200914Z-22b412"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-dnd" % "11.1.3-22adb3",
  "org.scalablytyped.slinky" %%% "react-sortable-tree" % "0.3-dt-20200717Z-812ecb",
  "org.scalablytyped.slinky" %%% "react-virtualized" % "9.21-dt-20201002Z-763175",
