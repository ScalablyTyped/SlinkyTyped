...
object PartialDropDownProps {
  ...
  implicit class PartialDropDownPropsOps[Self <: PartialDropDownProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPropsExtractor(value: (/* item */ DropDownData, /* index */ Double) => Partial[PartialDropDownProps]): Self = this.set("propsExtractor", js.Any.fromFunction2(value))
    
    @scala.inline
    def deletePropsExtractor: Self = this.set("propsExtractor", js.undefined)
    
    @scala.inline
    def setRenderAccessory(value: () => ReactElement): Self = this.set("renderAccessory", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteRenderAccessory: Self = this.set("renderAccessory", js.undefined)
    
    @scala.inline
    def setRenderBase(value: /* props */ RenderBaseProps => ReactElement): Self = this.set("renderBase", js.Any.fromFunction1(value))
