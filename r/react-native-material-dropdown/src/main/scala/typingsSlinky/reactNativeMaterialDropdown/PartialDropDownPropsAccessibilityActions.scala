...
trait PartialDropDownPropsAccessibilityActions extends js.Object {
...
object PartialDropDownPropsAccessibilityActions {
  @scala.inline
  def apply(
    ...
    propsExtractor: (/* item */ DropDownData, /* index */ Double) => PartialDropDownPropsAbsoluteRTLLayout = null,
    ...
    __obj.asInstanceOf[PartialDropDownPropsAccessibilityActions]
  }
}
