...
trait PartialDropDownPropsAccessibilityComponentType extends js.Object {
...
object PartialDropDownPropsAccessibilityComponentType {
  @scala.inline
  def apply(
    ...
    data: js.Array[PartialDropDownPropsAccessibilityComponentType] = null,
    ...
    propsExtractor: (PartialDropDownPropsAccessibilityComponentType, /* index */ Double) => Partial[DropDownProps] = null,
    ...
    valueExtractor: (PartialDropDownPropsAccessibilityComponentType, /* index */ Double) => String = null
    ...
    __obj.asInstanceOf[PartialDropDownPropsAccessibilityComponentType]
  }
}
