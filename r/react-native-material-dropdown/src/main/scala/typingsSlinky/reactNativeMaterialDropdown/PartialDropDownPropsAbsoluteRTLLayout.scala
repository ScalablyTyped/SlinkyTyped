...
object PartialDropDownPropsAbsoluteRTLLayout {
  ...
  implicit class PartialDropDownPropsAbsoluteRTLLayoutOps[Self <: PartialDropDownPropsAbsoluteRTLLayout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabelExtractor(value: (PartialDropDownPropsAbsoluteRTLLayout, /* index */ Double) => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPropsExtractor(value: (PartialDropDownPropsAbsoluteRTLLayout, /* index */ Double) => Partial[DropDownProps]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withValueExtractor(value: (PartialDropDownPropsAbsoluteRTLLayout, /* index */ Double) => String): Self = {
        val ret = this.duplicate
