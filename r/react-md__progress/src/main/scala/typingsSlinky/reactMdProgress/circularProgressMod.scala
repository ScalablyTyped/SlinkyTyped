...
import typingsSlinky.reactMdProgress.reactMdProgressStrings.assertive
import typingsSlinky.reactMdProgress.reactMdProgressStrings.both
import typingsSlinky.reactMdProgress.reactMdProgressStrings.copy
import typingsSlinky.reactMdProgress.reactMdProgressStrings.date
import typingsSlinky.reactMdProgress.reactMdProgressStrings.decimal
import typingsSlinky.reactMdProgress.reactMdProgressStrings.descending
import typingsSlinky.reactMdProgress.reactMdProgressStrings.dialog
import typingsSlinky.reactMdProgress.reactMdProgressStrings.email
import typingsSlinky.reactMdProgress.reactMdProgressStrings.execute
import typingsSlinky.reactMdProgress.reactMdProgressStrings.grammar
import typingsSlinky.reactMdProgress.reactMdProgressStrings.grid
import typingsSlinky.reactMdProgress.reactMdProgressStrings.horizontal
import typingsSlinky.reactMdProgress.reactMdProgressStrings.inherit
import typingsSlinky.reactMdProgress.reactMdProgressStrings.link
import typingsSlinky.reactMdProgress.reactMdProgressStrings.list
import typingsSlinky.reactMdProgress.reactMdProgressStrings.listbox
import typingsSlinky.reactMdProgress.reactMdProgressStrings.location
import typingsSlinky.reactMdProgress.reactMdProgressStrings.menu
import typingsSlinky.reactMdProgress.reactMdProgressStrings.mixed
import typingsSlinky.reactMdProgress.reactMdProgressStrings.move
import typingsSlinky.reactMdProgress.reactMdProgressStrings.no
import typingsSlinky.reactMdProgress.reactMdProgressStrings.none
import typingsSlinky.reactMdProgress.reactMdProgressStrings.numeric
import typingsSlinky.reactMdProgress.reactMdProgressStrings.off
import typingsSlinky.reactMdProgress.reactMdProgressStrings.on
import typingsSlinky.reactMdProgress.reactMdProgressStrings.other
import typingsSlinky.reactMdProgress.reactMdProgressStrings.page
import typingsSlinky.reactMdProgress.reactMdProgressStrings.polite
import typingsSlinky.reactMdProgress.reactMdProgressStrings.popup
import typingsSlinky.reactMdProgress.reactMdProgressStrings.removals
import typingsSlinky.reactMdProgress.reactMdProgressStrings.search
import typingsSlinky.reactMdProgress.reactMdProgressStrings.spelling
import typingsSlinky.reactMdProgress.reactMdProgressStrings.step
import typingsSlinky.reactMdProgress.reactMdProgressStrings.tel
import typingsSlinky.reactMdProgress.reactMdProgressStrings.text
import typingsSlinky.reactMdProgress.reactMdProgressStrings.time
import typingsSlinky.reactMdProgress.reactMdProgressStrings.tree
import typingsSlinky.reactMdProgress.reactMdProgressStrings.url
import typingsSlinky.reactMdProgress.reactMdProgressStrings.vertical
import typingsSlinky.reactMdProgress.reactMdProgressStrings.yes
...
object circularProgressMod {
  ...
  trait CircularProgressProps extends StObject {
    ...
    /**
      ...
      */
    var circleClassName: js.UndefOr[String] = js.native
    ...
    /**
      ...
      * style (if it exists).
      */
    var circleStyle: js.UndefOr[CSSProperties] = js.native
    ...
    /**
      ...
      * style (if it exists).
      */
    var svgStyle: js.UndefOr[CSSProperties] = js.native
  ...
  object CircularProgressProps {
    ...
    @scala.inline
    def apply(id: String): CircularProgressProps = {
    ...
    implicit class CircularProgressPropsMutableBuilder[Self <: CircularProgressProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCircleClassName(value: String): Self = StObject.set(x, "circleClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCircleClassNameUndefined: Self = StObject.set(x, "circleClassName", js.undefined)
      
      @scala.inline
      def setCircleStyle(value: CSSProperties): Self = StObject.set(x, "circleStyle", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSvgStyle(value: CSSProperties): Self = StObject.set(x, "svgStyle", value.asInstanceOf[js.Any])
