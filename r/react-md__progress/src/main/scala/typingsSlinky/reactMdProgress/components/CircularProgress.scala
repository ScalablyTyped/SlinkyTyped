package typingsSlinky.reactMdProgress.components
...
object CircularProgress {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def center(value: Double): this.type = set("center", value.asInstanceOf[js.Any])
    
    @scala.inline
    def centered(value: Boolean): this.type = set("centered", value.asInstanceOf[js.Any])
    
    @scala.inline
    def circleClassName(value: String): this.type = set("circleClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def circleStyle(value: CSSProperties): this.type = set("circleStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def maxRotation(value: Double): this.type = set("maxRotation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def svgClassName(value: String): this.type = set("svgClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def svgStyle(value: CSSProperties): this.type = set("svgStyle", value.asInstanceOf[js.Any])
  ...
  def withProps(p: CircularProgressProps with RefAttributes[HTMLSpanElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(id: String): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[CircularProgressProps with RefAttributes[HTMLSpanElement]]))
  }
}
