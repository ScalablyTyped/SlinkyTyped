...
import typingsSlinky.recast.anon.PartialOptions
...
object mod {
  ...
  object types {
    ...
    object namedTypes {
      ...
      @JSImport("recast", "types.namedTypes")
      @js.native
  ...
  type Transformer = js.Function2[/* ast */ ASTNode, /* callback */ js.Function1[/* ast */ ASTNode, Unit], Unit]
}
