...
object internals extends js.Object {
  ...
  class PriorityQueue[TTime] protected ()
    ...
    /* CompleteClass */
    override def dequeue(): typingsSlinky.rxLite.Rx.internals.ScheduledItem[TTime] = js.native
    /* CompleteClass */
    override def enqueue(item: typingsSlinky.rxLite.Rx.internals.ScheduledItem[TTime]): Unit = js.native
    /* CompleteClass */
    override def heapify(index: Double): Unit = js.native
    /* CompleteClass */
    override def isHigherPriority(left: Double, right: Double): Boolean = js.native
    /* CompleteClass */
    override def peek(): typingsSlinky.rxLite.Rx.internals.ScheduledItem[TTime] = js.native
    /* CompleteClass */
    override def percolate(index: Double): Unit = js.native
    /* CompleteClass */
    override def remove(item: typingsSlinky.rxLite.Rx.internals.ScheduledItem[TTime]): Boolean = js.native
    /* CompleteClass */
  ...
  class ScheduledItem[TTime] protected ()
    ...
    /* CompleteClass */
    override var disposable: typingsSlinky.rxLite.Rx.SingleAssignmentDisposable = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    override def compareTo(other: typingsSlinky.rxLite.Rx.internals.ScheduledItem[TTime]): Double = js.native
    /* CompleteClass */
