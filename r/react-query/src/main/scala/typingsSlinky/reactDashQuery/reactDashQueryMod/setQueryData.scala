...
import typingsSlinky.reactDashQuery.Anon_ShouldRefetch
...
object setQueryData extends js.Object {
  ...
  def apply(queryKey: String, data: js.Any, options: Anon_ShouldRefetch): Unit | js.Promise[Unit] = js.native
  def apply(queryKey: js.Tuple2[String, js.Object], data: js.Any): Unit | js.Promise[Unit] = js.native
  def apply(queryKey: js.Tuple2[String, js.Object], data: js.Any, options: Anon_ShouldRefetch): Unit | js.Promise[Unit] = js.native
}
