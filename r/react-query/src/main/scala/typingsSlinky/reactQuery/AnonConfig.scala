...
object AnonConfig {
  ...
  @scala.inline
  implicit class AnonConfigOps[Self[tkey, tvariables, tresult] <: AnonConfig[tkey, tvariables, tresult], TKey, TVariables, TResult] (val x: Self[TKey, TVariables, TResult]) extends AnyVal {
    @scala.inline
