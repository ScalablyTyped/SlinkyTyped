...
package object mod {
  type MutateFunction[TResults, TVariables /* <: js.Object */] = js.Function2[
    ...
    /* options */ js.UndefOr[typingsSlinky.reactQuery.AnonUpdateQuery], 
    js.Promise[TResults]
  ]
  ...
  type QueryKey[TVariables] = java.lang.String | (js.Tuple2[java.lang.String, TVariables]) | typingsSlinky.reactQuery.reactQueryBooleans.`false` | scala.Null | typingsSlinky.reactQuery.mod.QueryKeyFunction[TVariables]
  type QueryKeyFunction[TVariables] = js.Function0[
    java.lang.String | (js.Tuple2[java.lang.String, TVariables]) | typingsSlinky.reactQuery.reactQueryBooleans.`false` | scala.Null
  ]
}
