...
object useQuery extends js.Object {
  def apply[TResult, TSingleKey /* <: String */](queryKey: js.UndefOr[Null | TSingleKey], queryFn: QueryFunction[TResult, js.Array[TSingleKey]]): QueryResult[TResult] = js.native
  def apply[TResult, TSingleKey /* <: String */](
    queryKey: js.UndefOr[Null | TSingleKey],
