...
object Variables {
  ...
  @scala.inline
  implicit class VariablesOps[Self[tsinglekey, tvariables, tresult, tmorevariable] <: Variables[tsinglekey, tvariables, tresult, tmorevariable], TSingleKey, TVariables, TResult, TMoreVariable] (val x: Self[TSingleKey, TVariables, TResult, TMoreVariable]) extends AnyVal {
    @scala.inline
