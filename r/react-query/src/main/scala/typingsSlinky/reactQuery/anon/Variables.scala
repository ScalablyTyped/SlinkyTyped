...
object Variables {
  @scala.inline
  def apply[/* <: java.lang.String */ TSingleKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult, TMoreVariable](
  ...
  @scala.inline
  implicit class VariablesOps[Self <: Variables[_, _, _, _], /* <: java.lang.String */ TSingleKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult, TMoreVariable] (val x: Self with (Variables[TSingleKey, TVariables, TResult, TMoreVariable])) extends AnyVal {
    @scala.inline
