...
object QueryFn {
  ...
  @scala.inline
  implicit class QueryFnOps[Self[tsinglekey, tvariables, tresult] <: QueryFn[tsinglekey, tvariables, tresult], TSingleKey, TVariables, TResult] (val x: Self[TSingleKey, TVariables, TResult]) extends AnyVal {
    @scala.inline
