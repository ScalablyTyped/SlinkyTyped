...
object QueryFn {
  @scala.inline
  def apply[/* <: java.lang.String */ TSingleKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult](
  ...
  @scala.inline
  implicit class QueryFnOps[Self <: QueryFn[_, _, _], /* <: java.lang.String */ TSingleKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult] (val x: Self with (QueryFn[TSingleKey, TVariables, TResult])) extends AnyVal {
    @scala.inline
