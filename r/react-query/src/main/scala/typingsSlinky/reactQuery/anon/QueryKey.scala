...
object QueryKey {
  ...
  @scala.inline
  implicit class QueryKeyOps[Self <: QueryKey[_, _, _, _], TKey /* <: AnyQueryKey */, TVariables /* <: AnyVariables */, TResult, TMoreVariable] (val x: Self with (QueryKey[TKey, TVariables, TResult, TMoreVariable])) extends AnyVal {
