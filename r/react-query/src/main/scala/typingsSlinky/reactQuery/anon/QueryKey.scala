...
object QueryKey {
  @scala.inline
  def apply[/* <: typingsSlinky.reactQuery.mod.AnyQueryKey */ TKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult, TMoreVariable](
  ...
  @scala.inline
  implicit class QueryKeyOps[Self <: QueryKey[_, _, _, _], /* <: typingsSlinky.reactQuery.mod.AnyQueryKey */ TKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult, TMoreVariable] (val x: Self with (QueryKey[TKey, TVariables, TResult, TMoreVariable])) extends AnyVal {
    @scala.inline
