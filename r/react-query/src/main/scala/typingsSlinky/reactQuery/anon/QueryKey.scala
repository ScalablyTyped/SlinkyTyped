...
object QueryKey {
  ...
  @scala.inline
  implicit class QueryKeyOps[Self[tkey, tvariables, tresult, tmorevariable] <: QueryKey[tkey, tvariables, tresult, tmorevariable], TKey, TVariables, TResult, TMoreVariable] (val x: Self[TKey, TVariables, TResult, TMoreVariable]) extends AnyVal {
    @scala.inline
