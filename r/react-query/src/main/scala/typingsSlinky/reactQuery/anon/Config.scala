...
object Config {
  ...
  @scala.inline
  implicit class ConfigOps[Self <: Config[_, _, _], TKey /* <: AnyQueryKey */, TVariables /* <: AnyVariables */, TResult] (val x: Self with (Config[TKey, TVariables, TResult])) extends AnyVal {
