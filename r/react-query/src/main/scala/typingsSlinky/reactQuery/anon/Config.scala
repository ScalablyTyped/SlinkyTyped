...
object Config {
  @scala.inline
  def apply[/* <: typingsSlinky.reactQuery.mod.AnyQueryKey */ TKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult](
  ...
  @scala.inline
  implicit class ConfigOps[Self <: Config[_, _, _], /* <: typingsSlinky.reactQuery.mod.AnyQueryKey */ TKey, /* <: typingsSlinky.reactQuery.mod.AnyVariables */ TVariables, TResult] (val x: Self with (Config[TKey, TVariables, TResult])) extends AnyVal {
    @scala.inline
