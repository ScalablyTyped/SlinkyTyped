...
object RequestChannelFrame {
  ...
  @scala.inline
  implicit class RequestChannelFrameOps[Self <: RequestChannelFrame] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: `0x07`): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
