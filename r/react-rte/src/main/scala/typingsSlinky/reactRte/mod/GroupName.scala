...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactRte.reactRteStrings.INLINE_STYLE_BUTTONS
  - typingsSlinky.reactRte.reactRteStrings.BLOCK_TYPE_BUTTONS
  - typingsSlinky.reactRte.reactRteStrings.LINK_BUTTONS
  - typingsSlinky.reactRte.reactRteStrings.BLOCK_TYPE_DROPDOWN
  - typingsSlinky.reactRte.reactRteStrings.HISTORY_BUTTONS
  - typingsSlinky.reactRte.reactRteStrings.IMAGE_BUTTON
*/
