package typingsSlinky.reactDashRte.components
...
import typingsSlinky.reactDashRte.reactDashRteMod.CustomControl
import typingsSlinky.reactDashRte.reactDashRteMod.EditorValue
import typingsSlinky.reactDashRte.reactDashRteMod.ToolbarConfig
import typingsSlinky.reactDashRte.reactDashRteMod.default
...
object ReactDashRte
  ...
  /* The following DOM/SVG props were specified: autoFocus, className, disabled, onChange, placeholder, readOnly */
  def apply(
    value: EditorValue,
  ...
  type Props = typingsSlinky.reactDashRte.reactDashRteMod.Props
}
