...
import typingsSlinky.rmcDashDateDashPicker.libPopupMod.IPopupDatePickerProps
import typingsSlinky.rmcDashDateDashPicker.libPopupMod.default
...
object Popup
  ...
  type Props = IPopupDatePickerProps
}
