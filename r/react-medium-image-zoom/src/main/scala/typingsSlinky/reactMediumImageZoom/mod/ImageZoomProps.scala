...
object ImageZoomProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(isZoomed)) __obj.updateDynamic("isZoomed")(isZoomed.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(shouldReplaceImage)) __obj.updateDynamic("shouldReplaceImage")(shouldReplaceImage.get.asInstanceOf[js.Any])
    if (!js.isUndefined(shouldRespectMaxDimension)) __obj.updateDynamic("shouldRespectMaxDimension")(shouldRespectMaxDimension.get.asInstanceOf[js.Any])
