...
object messageSocketServerMod {
  ...
  object default {
    ...
    @scala.inline
    def attachToServer_=(x: js.Function2[/* server */ Server, /* path */ String, Broadcast]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("attachToServer")(x.asInstanceOf[js.Any])
