...
import typingsSlinky.reactNativeCommunityCliServerApi.openStackFrameInEditorMiddlewareMod.Options
...
object mod {
  ...
  object eventsSocketServer {
    ...
    def attachToServer: js.Function3[
        /* server */ typingsSlinky.reactNativeCommunityCliServerApi.eventsSocketServerMod.Server, 
        /* path */ String, 
  ...
  object messageSocketServer {
    ...
    def attachToServer: js.Function2[
        /* server */ typingsSlinky.reactNativeCommunityCliServerApi.messageSocketServerMod.Server, 
        /* path */ String, 
        Broadcast
      ] = js.native
    @scala.inline
  ...
  @js.native
  def openStackFrameInEditorMiddleware(options: Options): typingsSlinky.connect.mod.Server = js.native
  
  @JSImport("@react-native-community/cli-server-api/build", "openURLMiddleware")
  @js.native
  val openURLMiddleware: typingsSlinky.connect.mod.Server = js.native
