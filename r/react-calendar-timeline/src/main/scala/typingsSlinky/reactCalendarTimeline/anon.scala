...
object anon {
  ...
  object Key {
    ...
    implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKey(value: typingsSlinky.reactCalendarTimeline.mod.Id): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnContextMenu(value: SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onContextMenu", js.Any.fromFunction1(value))
