...
object ReactCalendarGroupRendererProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactCalendarTimeline.mod.TimelineGroupBase */ CustomGroup](group: CustomGroup): ReactCalendarGroupRendererProps[CustomGroup] = {
    val __obj = js.Dynamic.literal(group = group.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReactCalendarGroupRendererProps[CustomGroup]]
  }
  @scala.inline
  implicit class ReactCalendarGroupRendererPropsOps[Self <: ReactCalendarGroupRendererProps[_], /* <: typingsSlinky.reactCalendarTimeline.mod.TimelineGroupBase */ CustomGroup] (val x: Self with ReactCalendarGroupRendererProps[CustomGroup]) extends AnyVal {
    @scala.inline
