...
object DateHeaderProps {
  ...
  implicit class DateHeaderPropsOps[Self <: DateHeaderProps[_], Data] (val x: Self with DateHeaderProps[Data]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: /* props */ SidebarHeaderChildrenFnProps[Data] => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setIntervalRenderer(value: /* props */ js.UndefOr[IntervalRenderer[Data]] => ReactElement): Self = this.set("intervalRenderer", js.Any.fromFunction1(value))
