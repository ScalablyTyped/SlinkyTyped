...
trait DateHeaderProps[Data] extends StObject {
  ...
  var children: js.UndefOr[js.Function1[/* props */ SidebarHeaderChildrenFnProps[Data], ReactElement]] = js.native
  ...
  var intervalRenderer: js.UndefOr[js.Function1[/* props */ js.UndefOr[IntervalRenderer[Data]], ReactElement]] = js.native
...
object DateHeaderProps {
  ...
  implicit class DateHeaderPropsMutableBuilder[Self <: DateHeaderProps[_], Data] (val x: Self with DateHeaderProps[Data]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: /* props */ SidebarHeaderChildrenFnProps[Data] => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setIntervalRenderer(value: /* props */ js.UndefOr[IntervalRenderer[Data]] => ReactElement): Self = StObject.set(x, "intervalRenderer", js.Any.fromFunction1(value))
