...
trait ReactCalendarTimelineProps[CustomItem /* <: TimelineItemBase[_] */, CustomGroup /* <: TimelineGroupBase */] extends js.Object {
  ...
  var onItemDeselect: js.UndefOr[js.Function1[/* e */ SyntheticEvent[Event_, Element], scala.Unit]] = js.undefined
...
object ReactCalendarTimelineProps {
  ...
  def apply[CustomItem /* <: TimelineItemBase[_] */, CustomGroup /* <: TimelineGroupBase */](
    ...
    onCanvasClick: (/* groupId */ Id, /* time */ Double, /* e */ SyntheticEvent[Event_, Element]) => scala.Unit = null,
    onCanvasContextMenu: (/* groupId */ Id, /* time */ Double, /* e */ SyntheticEvent[Event_, Element]) => scala.Unit = null,
    onCanvasDoubleClick: (/* groupId */ Id, /* time */ Double, /* e */ SyntheticEvent[Event_, Element]) => scala.Unit = null,
    onItemClick: (/* itemId */ Id, /* e */ SyntheticEvent[Event_, Element], /* time */ Double) => scala.Unit = null,
    onItemContextMenu: (/* itemId */ Id, /* e */ SyntheticEvent[Event_, Element], /* time */ Double) => scala.Unit = null,
    onItemDeselect: /* e */ SyntheticEvent[Event_, Element] => scala.Unit = null,
    onItemDoubleClick: (/* itemId */ Id, /* e */ SyntheticEvent[Event_, Element], /* time */ Double) => scala.Unit = null,
