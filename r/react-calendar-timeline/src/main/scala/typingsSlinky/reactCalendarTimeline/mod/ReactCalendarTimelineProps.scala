...
object ReactCalendarTimelineProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactCalendarTimeline.mod.TimelineItemBase[_] */ CustomItem, /* <: typingsSlinky.reactCalendarTimeline.mod.TimelineGroupBase */ CustomGroup](groups: js.Array[CustomGroup], items: js.Array[CustomItem]): ReactCalendarTimelineProps[CustomItem, CustomGroup] = {
  ...
  @scala.inline
  implicit class ReactCalendarTimelinePropsOps[Self <: ReactCalendarTimelineProps[_, _], /* <: typingsSlinky.reactCalendarTimeline.mod.TimelineItemBase[_] */ CustomItem, /* <: typingsSlinky.reactCalendarTimeline.mod.TimelineGroupBase */ CustomGroup] (val x: Self with (ReactCalendarTimelineProps[CustomItem, CustomGroup])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDefaultTimeEndDate(value: js.Date): Self = this.set("defaultTimeEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def setDefaultTimeEnd(value: js.Date | Moment): Self = this.set("defaultTimeEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDefaultTimeEnd: Self = this.set("defaultTimeEnd", js.undefined)
    @scala.inline
    def setDefaultTimeStartDate(value: js.Date): Self = this.set("defaultTimeStart", value.asInstanceOf[js.Any])
    @scala.inline
    def setDefaultTimeStart(value: js.Date | Moment): Self = this.set("defaultTimeStart", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGroupRenderer(value: /* props */ ReactCalendarGroupRendererProps[CustomGroup] => ReactElement): Self = this.set("groupRenderer", js.Any.fromFunction1(value))
    @scala.inline
    def deleteGroupRenderer: Self = this.set("groupRenderer", js.undefined)
    @scala.inline
    def setHeaderRefRefObject(value: ReactRef[_]): Self = this.set("headerRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setItemRenderer(value: /* props */ ReactCalendarItemRendererProps[CustomItem] => ReactElement): Self = this.set("itemRenderer", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnCanvasClick(value: (/* groupId */ Id, /* time */ Double, /* e */ SyntheticEvent[Event, Element]) => scala.Unit): Self = this.set("onCanvasClick", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnCanvasClick: Self = this.set("onCanvasClick", js.undefined)
    @scala.inline
    def setOnCanvasContextMenu(value: (/* groupId */ Id, /* time */ Double, /* e */ SyntheticEvent[Event, Element]) => scala.Unit): Self = this.set("onCanvasContextMenu", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnCanvasContextMenu: Self = this.set("onCanvasContextMenu", js.undefined)
    @scala.inline
    def setOnCanvasDoubleClick(value: (/* groupId */ Id, /* time */ Double, /* e */ SyntheticEvent[Event, Element]) => scala.Unit): Self = this.set("onCanvasDoubleClick", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnCanvasDoubleClick: Self = this.set("onCanvasDoubleClick", js.undefined)
    @scala.inline
    def setOnItemClick(value: (/* itemId */ Id, /* e */ SyntheticEvent[Event, Element], /* time */ Double) => scala.Unit): Self = this.set("onItemClick", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnItemClick: Self = this.set("onItemClick", js.undefined)
    @scala.inline
    def setOnItemContextMenu(value: (/* itemId */ Id, /* e */ SyntheticEvent[Event, Element], /* time */ Double) => scala.Unit): Self = this.set("onItemContextMenu", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnItemContextMenu: Self = this.set("onItemContextMenu", js.undefined)
    @scala.inline
    def setOnItemDeselect(value: /* e */ SyntheticEvent[Event, Element] => scala.Unit): Self = this.set("onItemDeselect", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnItemDeselect: Self = this.set("onItemDeselect", js.undefined)
    @scala.inline
    def setOnItemDoubleClick(value: (/* itemId */ Id, /* e */ SyntheticEvent[Event, Element], /* time */ Double) => scala.Unit): Self = this.set("onItemDoubleClick", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def setRightSidebarContentReactElement(value: ReactElement): Self = this.set("rightSidebarContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setRightSidebarContent(value: ReactElement): Self = this.set("rightSidebarContent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setScrollRefRefObject(value: ReactRef[_]): Self = this.set("scrollRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSidebarContentReactElement(value: ReactElement): Self = this.set("sidebarContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setSidebarContent(value: ReactElement): Self = this.set("sidebarContent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVisibleTimeEndDate(value: js.Date): Self = this.set("visibleTimeEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def setVisibleTimeEnd(value: js.Date | Moment | Double): Self = this.set("visibleTimeEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteVisibleTimeEnd: Self = this.set("visibleTimeEnd", js.undefined)
    @scala.inline
    def setVisibleTimeStartDate(value: js.Date): Self = this.set("visibleTimeStart", value.asInstanceOf[js.Any])
    @scala.inline
    def setVisibleTimeStart(value: js.Date | Moment | Double): Self = this.set("visibleTimeStart", value.asInstanceOf[js.Any])
    @scala.inline
