...
import typingsSlinky.reactDashCalendarDashTimeline.reactDashCalendarDashTimelineBooleans.`false`
import typingsSlinky.reactDashCalendarDashTimeline.reactDashCalendarDashTimelineBooleans.`true`
...
trait ReactCalendarTimelineProps[CustomItem /* <: TimelineItemBase[_] */, CustomGroup /* <: TimelineGroupBase */] extends js.Object {
  ...
  var visibleTimeEnd: js.UndefOr[js.Date | Moment] = js.undefined
  var visibleTimeStart: js.UndefOr[js.Date | Moment] = js.undefined
}
...
object ReactCalendarTimelineProps {
  ...
  def apply[CustomItem /* <: TimelineItemBase[_] */, CustomGroup /* <: TimelineGroupBase */](
    ...
    onCanvasClick: (/* groupId */ Double, /* time */ Double, /* e */ SyntheticEvent[Event, Element]) => scala.Unit = null,
    onCanvasContextMenu: (/* group */ CustomGroup, /* time */ Double, /* e */ SyntheticEvent[Event, Element]) => scala.Unit = null,
    onCanvasDoubleClick: (/* group */ CustomGroup, /* time */ Double, /* e */ SyntheticEvent[Event, Element]) => scala.Unit = null,
    onItemClick: (/* itemId */ Double, /* e */ SyntheticEvent[Event, Element], /* time */ Double) => scala.Unit = null,
    onItemContextMenu: (/* itemId */ Double, /* e */ SyntheticEvent[Event, Element], /* time */ Double) => scala.Unit = null,
    onItemDeselect: /* e */ SyntheticEvent[Event, Element] => scala.Unit = null,
    onItemDoubleClick: (/* itemId */ Double, /* e */ SyntheticEvent[Event, Element], /* time */ Double) => scala.Unit = null,
