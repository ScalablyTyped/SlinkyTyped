...
object TimelineHeaders
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashCalendarDashTimeline.reactDashCalendarDashTimelineMod.TimelineHeaders
    ] {
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with org.scalajs.dom.raw.Element, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with org.scalajs.dom.raw.Element, Event] => Unit = null,
    prefix: String = null,
  ...
  typingsSlinky.reactDashCalendarDashTimeline.reactDashCalendarDashTimelineMod.TimelineHeaders](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
