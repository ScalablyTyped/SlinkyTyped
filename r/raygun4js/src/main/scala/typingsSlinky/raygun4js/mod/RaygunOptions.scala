...
object RaygunOptions {
  ...
  implicit class RaygunOptionsOps[Self <: RaygunOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcludedHostnamesVarargs(value: (String | js.RegExp)*): Self = this.set("excludedHostnames", js.Array(value :_*))
    @scala.inline
    def setExcludedHostnames(value: js.Array[String | js.RegExp]): Self = this.set("excludedHostnames", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteExcludedHostnames: Self = this.set("excludedHostnames", js.undefined)
    @scala.inline
    def setExcludedUserAgentsVarargs(value: (String | js.RegExp)*): Self = this.set("excludedUserAgents", js.Array(value :_*))
    @scala.inline
    def setExcludedUserAgents(value: js.Array[String | js.RegExp]): Self = this.set("excludedUserAgents", value.asInstanceOf[js.Any])
    @scala.inline
