  ...
  */
  ...
  object RaygunOptions {
    ...
    implicit class RaygunOptionsMutableBuilder[Self <: RaygunOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExcludedHostnames(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "excludedHostnames", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExcludedHostnamesUndefined: Self = StObject.set(x, "excludedHostnames", js.undefined)
      
      @scala.inline
      def setExcludedHostnamesVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "excludedHostnames", js.Array(value :_*))
      
      @scala.inline
      def setExcludedUserAgents(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "excludedUserAgents", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExcludedUserAgentsUndefined: Self = StObject.set(x, "excludedUserAgents", js.undefined)
      
      @scala.inline
      def setExcludedUserAgentsVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "excludedUserAgents", js.Array(value :_*))
