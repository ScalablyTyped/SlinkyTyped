...
import typingsSlinky.raygun4js.Anon_Level
import typingsSlinky.raygun4js.Anon_PathType
...
trait RaygunV2 extends js.Object {
  ...
  def apply(key: recordBreadcrumb, message: Anon_Level, metadata: js.Object): Unit = js.native
  ...
  def apply(key: trackEvent, value: Anon_PathType): Unit = js.native
