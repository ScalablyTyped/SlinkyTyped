...
import typingsSlinky.recoil.mod.DefaultValue
import typingsSlinky.recoil.mod.GetRecoilValue
import typingsSlinky.recoil.mod.Loadable
import typingsSlinky.recoil.mod.LoadablePromise
import typingsSlinky.recoil.mod.RecoilState
import typingsSlinky.recoil.mod.RecoilValue
import typingsSlinky.recoil.mod.ResetRecoilState
import typingsSlinky.recoil.mod.SetRecoilState
...
object anon {
  ...
  object ReadonlystatehasErrorcont {
    ...
    implicit class ReadonlystatehasErrorcontMutableBuilder[Self <: ReadonlystatehasErrorcont] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContents(value: js.Error): Self = StObject.set(x, "contents", value.asInstanceOf[js.Any])
