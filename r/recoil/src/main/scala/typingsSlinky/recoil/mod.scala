...
object mod {
  ...
  @js.native
  val RecoilRoot: ReactComponentClass[RecoilRootProps] = js.native
  ...
  @js.native
  def waitForAll[RecoilValues /* <: StringDictionary[RecoilValue[_]] */](param: RecoilValues): RecoilValueReadOnly[UnwrapRecoilValueLoadables[RecoilValues]] = js.native
  @JSImport("recoil", "waitForAll")
  @js.native
  def waitForAll_RecoilValues_ArrayRecoilValueWildcard[RecoilValues /* <: js.Array[RecoilValue[_]] */](param: RecoilValues): RecoilValueReadOnly[UnwrapRecoilValueLoadables[RecoilValues]] = js.native
  
  @JSImport("recoil", "waitForAny")
  @js.native
  def waitForAny[RecoilValues /* <: StringDictionary[RecoilValue[_]] */](param: RecoilValues): RecoilValueReadOnly[UnwrapRecoilValueLoadables[RecoilValues]] = js.native
  @JSImport("recoil", "waitForAny")
  @js.native
  def waitForAny_RecoilValues_ArrayRecoilValueWildcard[RecoilValues /* <: js.Array[RecoilValue[_]] */](param: RecoilValues): RecoilValueReadOnly[UnwrapRecoilValueLoadables[RecoilValues]] = js.native
  
  @JSImport("recoil", "waitForNone")
  @js.native
  def waitForNone[RecoilValues /* <: StringDictionary[RecoilValue[_]] */](param: RecoilValues): RecoilValueReadOnly[UnwrapRecoilValueLoadables[RecoilValues]] = js.native
  @JSImport("recoil", "waitForNone")
  @js.native
  def waitForNone_RecoilValues_ArrayRecoilValueWildcard[RecoilValues /* <: js.Array[RecoilValue[_]] */](param: RecoilValues): RecoilValueReadOnly[UnwrapRecoilValueLoadables[RecoilValues]] = js.native
  ...
  */
  ...
  object Loadable {
    ...
    @scala.inline
    def Contents[T](contents: T, state: hasValue): typingsSlinky.recoil.anon.Contents[T] = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.recoil.anon.Contents[T]]
    }
    
    @scala.inline
    def ReadonlystatehasErrorcont(contents: js.Error, state: hasError): typingsSlinky.recoil.anon.ReadonlystatehasErrorcont = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.recoil.anon.ReadonlystatehasErrorcont]
    }
    
    @scala.inline
    def State[T](contents: LoadablePromise[T], state: loading): typingsSlinky.recoil.anon.State[T] = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.recoil.anon.State[T]]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.recoil.mod.RecoilValueReadOnly[T]
    - typingsSlinky.recoil.mod.RecoilState[T]
  */
  ...
  trait TreeState extends StObject {
    ...
    val dirtyAtoms: typingsSlinky.std.Set[NodeKey] = js.native
    
    val isSnapshot: Boolean = js.native
    
    val nodeDeps: Map[NodeKey, typingsSlinky.std.Set[NodeKey]] = js.native
    
    val nodeToComponentSubscriptions: Map[NodeKey, Map[Double, js.Tuple2[String, ComponentCallback]]] = js.native
    
    val nodeToNodeSubscriptions: Map[NodeKey, typingsSlinky.std.Set[NodeKey]] = js.native
  ...
  object TreeState {
    ...
    def apply(
      ...
      dirtyAtoms: typingsSlinky.std.Set[NodeKey],
      isSnapshot: Boolean,
      nodeDeps: Map[NodeKey, typingsSlinky.std.Set[NodeKey]],
      nodeToComponentSubscriptions: Map[NodeKey, Map[Double, js.Tuple2[String, ComponentCallback]]],
      nodeToNodeSubscriptions: Map[NodeKey, typingsSlinky.std.Set[NodeKey]],
    ...
    implicit class TreeStateMutableBuilder[Self <: TreeState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDirtyAtoms(value: typingsSlinky.std.Set[NodeKey]): Self = StObject.set(x, "dirtyAtoms", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsSnapshot(value: Boolean): Self = StObject.set(x, "isSnapshot", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNodeDeps(value: Map[NodeKey, typingsSlinky.std.Set[NodeKey]]): Self = StObject.set(x, "nodeDeps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNodeToNodeSubscriptions(value: Map[NodeKey, typingsSlinky.std.Set[NodeKey]]): Self = StObject.set(x, "nodeToNodeSubscriptions", value.asInstanceOf[js.Any])
  ...
  {[ P in keyof T ]: recoil.recoil.Loadable<recoil.recoil.UnwrapRecoilValue<T[P]>>}
    */ typingsSlinky.recoil.recoilStrings.UnwrapRecoilValueLoadables with TopLevel[T]
}
