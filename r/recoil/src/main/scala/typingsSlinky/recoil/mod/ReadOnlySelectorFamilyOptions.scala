...
import typingsSlinky.recoil.anon.Get
...
object ReadOnlySelectorFamilyOptions {
  @scala.inline
  def apply[T, /* <: typingsSlinky.recoil.mod.SerializableParam */ P](get: P => js.Function1[/* opts */ Get, js.Promise[T] | RecoilValue[T] | T], key: String): ReadOnlySelectorFamilyOptions[T, P] = {
  ...
  @scala.inline
  implicit class ReadOnlySelectorFamilyOptionsOps[Self <: ReadOnlySelectorFamilyOptions[_, _], T, /* <: typingsSlinky.recoil.mod.SerializableParam */ P] (val x: Self with (ReadOnlySelectorFamilyOptions[T, P])) extends AnyVal {
    @scala.inline
