...
object ReadWriteSelectorFamilyOptions {
  @scala.inline
  def apply[T, /* <: typingsSlinky.recoil.mod.SerializableParam */ P](
  ...
  @scala.inline
  implicit class ReadWriteSelectorFamilyOptionsOps[Self <: ReadWriteSelectorFamilyOptions[_, _], T, /* <: typingsSlinky.recoil.mod.SerializableParam */ P] (val x: Self with (ReadWriteSelectorFamilyOptions[T, P])) extends AnyVal {
    @scala.inline
