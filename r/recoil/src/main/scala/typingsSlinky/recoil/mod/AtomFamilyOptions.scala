...
object AtomFamilyOptions {
  ...
  @scala.inline
  implicit class AtomFamilyOptionsOps[Self <: AtomFamilyOptions[_, _], T, /* <: typingsSlinky.recoil.mod.SerializableParam */ P] (val x: Self with (AtomFamilyOptions[T, P])) extends AnyVal {
    @scala.inline
