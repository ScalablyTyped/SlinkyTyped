package typingsSlinky.atRebassForms.atRebassFormsMod
...
- Dropped {[ P in std.Exclude<keyof react.react.InputHTMLAttributes<std.HTMLInputElement>, 'variant' | 'tx'> ]: react.react.InputHTMLAttributes<std.HTMLInputElement>[P]} */ trait CheckboxProps extends BoxKnownProps
