...
import typingsSlinky.atRebassForms.atRebassFormsMod.RadioProps
...
object Radio
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Radio] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Radio] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Radio] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Radio](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
