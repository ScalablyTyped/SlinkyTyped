...
import typingsSlinky.atRebassForms.atRebassFormsMod.LabelProps
...
object Label
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Label] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Label] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Label] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Label](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
