...
import typingsSlinky.atRebassForms.atRebassFormsMod.TextareaProps
...
object Textarea
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Textarea] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Textarea] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Textarea] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.atRebassForms.atRebassFormsMod.Textarea](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
