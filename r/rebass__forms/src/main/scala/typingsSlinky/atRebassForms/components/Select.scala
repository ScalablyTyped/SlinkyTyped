package typingsSlinky.atRebassForms.components
...
import typingsSlinky.atRebassForms.atRebassFormsMod.SelectProps
...
object Select
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Select] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Select] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Select] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Select](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
