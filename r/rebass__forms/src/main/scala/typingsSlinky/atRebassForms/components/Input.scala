...
import typingsSlinky.atRebassForms.atRebassFormsMod.InputProps
...
object Input
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Input] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Input] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Input] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atRebassForms.atRebassFormsMod.Input](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
