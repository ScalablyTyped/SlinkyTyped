...
object Label
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Label] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Label] = new slinky.core.BuildingComponent[slinky.web.html.label.tag.type, typingsSlinky.rebassForms.mod.Label](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
