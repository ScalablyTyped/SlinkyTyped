...
object Slider
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Slider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Slider] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.rebassForms.mod.Slider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
