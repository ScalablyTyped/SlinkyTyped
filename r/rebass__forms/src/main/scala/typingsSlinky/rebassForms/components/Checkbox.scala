...
import typingsSlinky.rebassForms.mod.CheckboxProps
...
object Checkbox
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rebassForms.mod.Checkbox] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Checkbox] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Checkbox] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.rebassForms.mod.Checkbox](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
