...
import typingsSlinky.rebassForms.mod.InputProps
...
object Input
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rebassForms.mod.Input] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Input] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Input] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.rebassForms.mod.Input](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
