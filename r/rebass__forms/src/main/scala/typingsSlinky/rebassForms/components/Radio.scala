...
import typingsSlinky.rebassForms.mod.RadioProps
...
object Radio
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rebassForms.mod.Radio] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Radio] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Radio] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.rebassForms.mod.Radio](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
