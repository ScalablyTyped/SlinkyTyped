...
import typingsSlinky.rebassForms.mod.TextareaProps
...
object Textarea
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rebassForms.mod.Textarea] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Textarea] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.rebassForms.mod.Textarea] = new slinky.core.BuildingComponent[slinky.web.html.textarea.tag.type, typingsSlinky.rebassForms.mod.Textarea](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
