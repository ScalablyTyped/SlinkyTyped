...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-native-gesture-handler" % "1.7.0-f04d67",
  "org.scalablytyped.slinky" %%% "react-native-safe-area-context" % "3.0.7-edef18",
  "org.scalablytyped.slinky" %%% "react-navigation" % "4.4.0-e3a9b0",
