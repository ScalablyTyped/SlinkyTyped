...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-native-gesture-handler" % "1.7.0-6671bb",
  "org.scalablytyped.slinky" %%% "react-native-safe-area-context" % "3.0.7-e864dc",
  "org.scalablytyped.slinky" %%% "react-navigation" % "4.4.0-b5e410",
