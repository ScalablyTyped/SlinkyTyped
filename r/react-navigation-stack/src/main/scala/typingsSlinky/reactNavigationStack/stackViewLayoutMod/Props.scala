package typingsSlinky.reactNavigationStack.stackViewLayoutMod
...
/* Inlined react-navigation-stack.react-navigation-stack/lib/typescript/types.NavigationStackConfig & {  isLandscape :boolean,   transitionProps :react-navigation-stack.react-navigation-stack/lib/typescript/types.TransitionProps,   lastTransitionProps :react-navigation-stack.react-navigation-stack/lib/typescript/types.TransitionProps | undefined,   transitionConfig :(transitionProps : react-navigation-stack.react-navigation-stack/lib/typescript/types.TransitionProps, prevTransitionProps : react-navigation-stack.react-navigation-stack/lib/typescript/types.TransitionProps | undefined, isModal : boolean | undefined): react-navigation-stack.react-navigation-stack/lib/typescript/types.TransitionConfig | undefined,   onGestureBegin :(): void | undefined,   onGestureEnd :(): void | undefined,   onGestureCanceled :(): void | undefined,   screenProps :unknown | undefined} */
...
object Props {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(isLandscape = isLandscape.asInstanceOf[js.Any], transitionConfig = transitionConfig.asInstanceOf[js.Any], transitionProps = transitionProps.asInstanceOf[js.Any])
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("transitionConfig", value.asInstanceOf[js.Any])
    @scala.inline
