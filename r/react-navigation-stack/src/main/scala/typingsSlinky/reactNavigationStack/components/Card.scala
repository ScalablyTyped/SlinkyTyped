...
import typingsSlinky.reactNavigationStack.cardMod.default
...
object Card {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def gestureResponseDistance(value: Horizontal): this.type = set("gestureResponseDistance", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def next(value: AnimatedInterpolation): this.type = set("next", value.asInstanceOf[js.Any])
