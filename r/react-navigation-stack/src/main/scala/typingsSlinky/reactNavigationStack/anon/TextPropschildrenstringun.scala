...
/* Inlined react-native.react-native.TextProps & {  children :string | undefined} */
trait TextPropschildrenstringun extends js.Object {
  /**
...
object TextPropschildrenstringun {
  @scala.inline
  def apply(): TextPropschildrenstringun = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextPropschildrenstringun]
  }
  @scala.inline
  implicit class TextPropschildrenstringunOps[Self <: TextPropschildrenstringun] (val x: Self) extends AnyVal {
    @scala.inline
