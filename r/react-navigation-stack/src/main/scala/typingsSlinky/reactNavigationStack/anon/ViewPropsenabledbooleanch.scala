...
@js.native
trait ViewPropsenabledbooleanch extends js.Object {
...
object ViewPropsenabledbooleanch {
  ...
  @scala.inline
  def apply(enabled: Boolean): ViewPropsenabledbooleanch = {
    val __obj = js.Dynamic.literal(enabled = enabled.asInstanceOf[js.Any])
    __obj.asInstanceOf[ViewPropsenabledbooleanch]
  }
  
  @scala.inline
  implicit class ViewPropsenabledbooleanchOps[Self <: ViewPropsenabledbooleanch] (val x: Self) extends AnyVal {
