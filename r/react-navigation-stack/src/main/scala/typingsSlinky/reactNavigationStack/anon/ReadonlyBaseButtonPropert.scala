...
trait ReadonlyBaseButtonPropert extends StObject {
  ...
  val hitSlop: js.UndefOr[
    Double | typingsSlinky.reactNativeGestureHandler.anon.Bottom | typingsSlinky.reactNativeGestureHandler.anon.Left | Right | typingsSlinky.reactNativeGestureHandler.anon.Height | BottomHeight
  ] = js.native
...
object ReadonlyBaseButtonPropert {
  ...
  implicit class ReadonlyBaseButtonPropertMutableBuilder[Self <: ReadonlyBaseButtonPropert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHitSlop(
      value: Double | typingsSlinky.reactNativeGestureHandler.anon.Bottom | typingsSlinky.reactNativeGestureHandler.anon.Left | Right | typingsSlinky.reactNativeGestureHandler.anon.Height | BottomHeight
