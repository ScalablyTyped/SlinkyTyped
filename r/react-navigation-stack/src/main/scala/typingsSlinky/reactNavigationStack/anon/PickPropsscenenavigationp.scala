...
trait PickPropsscenenavigationp extends js.Object {
...
object PickPropsscenenavigationp {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PickPropsscenenavigationp]
  }
  @scala.inline
  implicit class PickPropsscenenavigationpOps[Self <: PickPropsscenenavigationp] (val x: Self) extends AnyVal {
    @scala.inline
