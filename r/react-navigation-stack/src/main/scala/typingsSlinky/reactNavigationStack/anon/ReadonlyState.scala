...
trait ReadonlyState extends StObject {
  ...
  val previousRoutes: js.Array[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]] = js.native
  
  val replacingRouteKeys: js.Array[String] = js.native
  
  val routes: js.Array[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]] = js.native
}
object ReadonlyState {
  ...
  def apply(
    ...
    previousRoutes: js.Array[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]],
  ...
  implicit class ReadonlyStateMutableBuilder[Self <: ReadonlyState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviousRoutes(value: js.Array[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]]): Self = StObject.set(x, "previousRoutes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreviousRoutesVarargs(value: typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]*): Self = StObject.set(x, "previousRoutes", js.Array(value :_*))
