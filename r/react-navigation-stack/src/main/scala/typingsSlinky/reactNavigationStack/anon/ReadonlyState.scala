...
object ReadonlyState {
  ...
  implicit class ReadonlyStateOps[Self <: ReadonlyState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviousRoutesVarargs(value: typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]*): Self = this.set("previousRoutes", js.Array(value :_*))
    
    @scala.inline
    def setPreviousRoutes(value: js.Array[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]]): Self = this.set("previousRoutes", value.asInstanceOf[js.Any])
