...
object ContainerStyleLight {
  ...
  implicit class ContainerStyleLightOps[Self <: ContainerStyleLight] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScreenInterpolator(value: SceneInterpolatorProps => OpacityNumber | OpacityTransform | OpacityUndefinedTransformArray): Self = this.set("screenInterpolator", js.Any.fromFunction1(value))
    @scala.inline
