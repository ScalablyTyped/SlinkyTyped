...
@JSImport("react-navigation-stack/lib/typescript/src/vendor/TransitionConfigs/TransitionPresets", JSImport.Namespace)
@js.native
object transitionPresetsMod extends js.Object {
