...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnTransitionEnd(value: (/* props */ typingsSlinky.reactNavigationStack.anon.Route, /* closing */ Boolean) => Unit): Self = this.set("onTransitionEnd", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnTransitionEnd: Self = this.set("onTransitionEnd", js.undefined)
    
    @scala.inline
    def setOnTransitionStart(value: (/* props */ typingsSlinky.reactNavigationStack.anon.Route, /* closing */ Boolean) => Unit): Self = this.set("onTransitionStart", js.Any.fromFunction2(value))
