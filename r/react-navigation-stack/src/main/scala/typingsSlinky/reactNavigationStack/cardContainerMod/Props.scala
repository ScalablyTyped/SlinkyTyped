package typingsSlinky.reactNavigationStack.cardContainerMod
...
trait Props extends js.Object {
  ...
  var onTransitionEnd: js.UndefOr[js.Function2[/* props */ Route, /* closing */ Boolean, Unit]] = js.native
  var onTransitionStart: js.UndefOr[js.Function2[/* props */ Route, /* closing */ Boolean, Unit]] = js.native
  ...
  var scene: Scene[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]] = js.native
  /**
    * Object which specifies the animation type (timing or spring) and their options (such as duration for timing).
    */
  var transitionSpec: Close = js.native
  def getFocusedRoute(): typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String] = js.native
  def getPreviousScene(props: Route): js.UndefOr[Scene[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]]] = js.native
...
object Props {
  ...
  def apply(
    ...
    getFocusedRoute: () => typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String],
    getPreviousScene: Route => js.UndefOr[Scene[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]]],
    ...
    scene: Scene[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]],
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetFocusedRoute(value: () => typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]): Self = this.set("getFocusedRoute", js.Any.fromFunction0(value))
    @scala.inline
    def setGetPreviousScene(value: Route => js.UndefOr[Scene[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]]]): Self = this.set("getPreviousScene", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setScene(value: Scene[typingsSlinky.reactNavigationStack.vendorTypesMod.Route[String]]): Self = this.set("scene", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnTransitionEnd(value: (/* props */ Route, /* closing */ Boolean) => Unit): Self = this.set("onTransitionEnd", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnTransitionEnd: Self = this.set("onTransitionEnd", js.undefined)
    @scala.inline
    def setOnTransitionStart(value: (/* props */ Route, /* closing */ Boolean) => Unit): Self = this.set("onTransitionStart", js.Any.fromFunction2(value))
    @scala.inline
