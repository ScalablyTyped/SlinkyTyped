...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNavigationStack.reactNavigationStackStrings.willFocus
  - typingsSlinky.reactNavigationStack.reactNavigationStackStrings.didFocus
  - typingsSlinky.reactNavigationStack.reactNavigationStackStrings.willBlur
  - typingsSlinky.reactNavigationStack.reactNavigationStackStrings.didBlur
*/
