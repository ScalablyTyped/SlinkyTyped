...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayoutInterpolator(value: SceneInterpolatorProps => js.Any): Self = this.set("layoutInterpolator", js.Any.fromFunction1(value))
    @scala.inline
    def setLayoutPreset(value: HeaderLayoutPreset): Self = this.set("layoutPreset", value.asInstanceOf[js.Any])
    @scala.inline
    def setLeftButtonInterpolator(value: SceneInterpolatorProps => js.Any): Self = this.set("leftButtonInterpolator", js.Any.fromFunction1(value))
    @scala.inline
    def setLeftLabelInterpolator(value: SceneInterpolatorProps => js.Any): Self = this.set("leftLabelInterpolator", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setTitleFromLeftInterpolator(value: SceneInterpolatorProps => js.Any): Self = this.set("titleFromLeftInterpolator", js.Any.fromFunction1(value))
    @scala.inline
