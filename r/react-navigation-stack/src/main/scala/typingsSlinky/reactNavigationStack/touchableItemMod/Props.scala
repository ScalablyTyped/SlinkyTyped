...
/* Inlined react-native.react-native.ViewProps & {  pressColor :string | undefined,   disabled :boolean | undefined,   borderless :boolean | undefined,   delayPressIn :number | undefined,   onPress :(): void | undefined,   children :react.react.ReactNode} */
@js.native
