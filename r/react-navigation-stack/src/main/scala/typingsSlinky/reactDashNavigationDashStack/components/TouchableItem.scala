...
import typingsSlinky.reactDashNavigationDashStack.AccessibilityActionInfo
import typingsSlinky.reactDashNavigationDashStack.libTypescriptViewsTouchableItemMod.default
import typingsSlinky.reactDashNavigationDashStack.reactDashNavigationDashStackStrings.`box-none`
import typingsSlinky.reactDashNavigationDashStack.reactDashNavigationDashStackStrings.`box-only`
...
object TouchableItem
  ...
  type Props = typingsSlinky.reactDashNavigationDashStack.libTypescriptViewsTouchableItemMod.Props
}
