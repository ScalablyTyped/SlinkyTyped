package typingsSlinky.rollupDashPluginDashPostcss.rollupDashPluginDashPostcssMod

import typingsSlinky.cssnano.cssnanoMod.CssNanoOptions
import typingsSlinky.rollupDashPluginDashPostcss.Anon_Ctx
import typingsSlinky.rollupDashPluginDashPostcss.Anon_InsertAt
import typingsSlinky.rollupDashPluginDashPostcss.rollupDashPluginDashPostcssStrings.`inline`
...
trait PostCssPluginOptions extends js.Object {
  ...
  var config: js.UndefOr[Boolean | Anon_Ctx] = js.undefined
  var exec: js.UndefOr[Boolean] = js.undefined
  var extensions: js.UndefOr[js.Array[String]] = js.undefined
  var extract: js.UndefOr[Boolean | String] = js.undefined
  var inject: js.UndefOr[Boolean | Anon_InsertAt] = js.undefined
