...
import typingsSlinky.reactDashPlacesDashAutocomplete.Anon_GetInputProps
...
trait PropTypes extends js.Object {
  ...
  def children(opts: Anon_GetInputProps): TagMod[Any]
}

object PropTypes {
  @scala.inline
  def apply(
    children: Anon_GetInputProps => TagMod[Any],
