...
trait Readonlyloadingbooleansug extends js.Object {
  val getInputProps: js.Function1[/* options */ js.UndefOr[js.Object], AnonAriaactivedescendant with js.Object] = js.native
...
object Readonlyloadingbooleansug {
  ...
  implicit class ReadonlyloadingbooleansugOps[Self <: Readonlyloadingbooleansug] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetInputProps(value: /* options */ js.UndefOr[js.Object] => AnonAriaactivedescendant with js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getInputProps")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetSuggestionItemProps(value: (/* suggestion */ Suggestion, /* options */ js.UndefOr[js.Object]) => AnonId with js.Object): Self = {
        val ret = this.duplicate
