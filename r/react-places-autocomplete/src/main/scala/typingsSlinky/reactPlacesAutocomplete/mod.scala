...
object mod {
  ...
  type AutocompletePrediction = typingsSlinky.googlemaps.google.maps.places.AutocompletePrediction
  
  type PlacesAutocomplete = ReactComponentClass[PropTypes]
  
  @js.native
  trait PropTypes extends StObject {
    
    def children(opts: Readonlyloadingbooleansug): ReactElement = js.native
  ...
  object PropTypes {
    ...
    @scala.inline
    def apply(children: Readonlyloadingbooleansug => ReactElement): PropTypes = {
    ...
    implicit class PropTypesMutableBuilder[Self <: PropTypes] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: Readonlyloadingbooleansug => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
