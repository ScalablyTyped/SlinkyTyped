...
trait PropTypes extends js.Object {
  ...
  def children(opts: Readonlyloadingbooleansug): TagMod[Any]
}

object PropTypes {
  @scala.inline
  def apply(
    children: Readonlyloadingbooleansug => TagMod[Any],
    ...
    if (!js.isUndefined(shouldFetchSuggestions)) __obj.updateDynamic("shouldFetchSuggestions")(shouldFetchSuggestions.get.asInstanceOf[js.Any])
