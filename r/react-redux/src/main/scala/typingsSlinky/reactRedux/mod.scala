...
import typingsSlinky.reactRedux.anon.WrappedComponent
...
object mod {
  ...
  type ConnectedComponent[C /* <: ReactComponentClass[_] */, P] = (ReactComponentClass[LibraryManagedAttributes[C, P]]) with (NonReactStatics[C, js.Object]) with WrappedComponent[C]
  ...
  {[ P in keyof DecorationTargetProps ]: P extends keyof InjectedProps? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : InjectedProps[P] : DecorationTargetProps[P]}
    */ typingsSlinky.reactRedux.reactReduxStrings.Matching with TopLevel[js.Any]
  ...
  {[ C in keyof TDispatchProps ]: react-redux.react-redux.HandleThunkActionCreator<TDispatchProps[C]>}
    */ typingsSlinky.reactRedux.reactReduxStrings.ResolveThunks with TopLevel[TDispatchProps])
  ...
  {[ P in std.Extract<keyof InjectedProps, keyof DecorationTargetProps> ]:? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : never}
    */ typingsSlinky.reactRedux.reactReduxStrings.Shared with TopLevel[js.Any]
