...
object ReactReduxContextValue {
  @scala.inline
  def apply[SS, /* <: typingsSlinky.redux.mod.Action[_] */ A](store: Store[SS, A], storeState: SS): ReactReduxContextValue[SS, A] = {
  ...
  @scala.inline
  implicit class ReactReduxContextValueOps[Self <: ReactReduxContextValue[_, _], SS, /* <: typingsSlinky.redux.mod.Action[_] */ A] (val x: Self with (ReactReduxContextValue[SS, A])) extends AnyVal {
    @scala.inline
