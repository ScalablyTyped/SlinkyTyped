...
object DispatchProp {
  @scala.inline
  def apply[/* <: typingsSlinky.redux.mod.Action[_] */ A](dispatch: A => A): DispatchProp[A] = {
    val __obj = js.Dynamic.literal(dispatch = js.Any.fromFunction1(dispatch))
    __obj.asInstanceOf[DispatchProp[A]]
  }
  @scala.inline
  implicit class DispatchPropOps[Self <: DispatchProp[_], /* <: typingsSlinky.redux.mod.Action[_] */ A] (val x: Self with DispatchProp[A]) extends AnyVal {
    @scala.inline
