...
package object mod {
  ...
  type InferableComponentEnhancerWithProps[TInjectedProps, TNeedsProps] = js.Function1[
    ...
    typingsSlinky.reactRedux.mod.ConnectedComponent[
      js.Any, 
      (typingsSlinky.reactRedux.mod.Omit[
        typingsSlinky.reactRedux.mod.GetProps[_], 
  ...
  {[ P in keyof DecorationTargetProps ]: P extends keyof InjectedProps? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : InjectedProps[P] : DecorationTargetProps[P]}
    */ typingsSlinky.reactRedux.reactReduxStrings.Matching with org.scalablytyped.runtime.TopLevel[js.Any]
  ...
  {[ P in std.Extract<keyof InjectedProps, keyof DecorationTargetProps> ]:? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : never}
    */ typingsSlinky.reactRedux.reactReduxStrings.Shared with org.scalablytyped.runtime.TopLevel[js.Any]
