...
object ScrollIntoView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.rrc.mod.ScrollIntoView] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.rrc.mod.ScrollIntoView] = {
