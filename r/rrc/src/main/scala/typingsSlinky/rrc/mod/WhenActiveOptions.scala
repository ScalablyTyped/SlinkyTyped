...
object WhenActiveOptions {
  ...
  implicit class WhenActiveOptionsOps[Self <: WhenActiveOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPathProp(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pathProp")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPathProp: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pathProp")(js.undefined)
        ret
    }
    @scala.inline
