...
object mod {
  ...
  object OptionalProps {
    ...
    implicit class OptionalPropsMutableBuilder[Self <: OptionalProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomMiniature(value: ReactElement | ReactComponentClass[js.Object]): Self = StObject.set(x, "customMiniature", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMiniatureComponentClass(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "customMiniature", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMiniatureFunctionComponent(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "customMiniature", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMiniatureReactElement(value: ReactElement): Self = StObject.set(x, "customMiniature", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomToolbar(value: ReactComponentClass[_]): Self = StObject.set(x, "customToolbar", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomToolbarComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "customToolbar", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomToolbarFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "customToolbar", value.asInstanceOf[js.Any])
  ...
  object ViewerMouseEvent {
    ...
    implicit class ViewerMouseEventMutableBuilder[Self <: ViewerMouseEvent[_], T] (val x: Self with ViewerMouseEvent[T]) extends AnyVal {
      ...
      @scala.inline
      def setOriginalEvent(value: SyntheticMouseEvent[T]): Self = StObject.set(x, "originalEvent", value.asInstanceOf[js.Any])
  ...
  object ViewerTouchEvent {
    ...
    implicit class ViewerTouchEventMutableBuilder[Self <: ViewerTouchEvent[_], T] (val x: Self with ViewerTouchEvent[T]) extends AnyVal {
      ...
      @scala.inline
      def setOriginalEvent(value: SyntheticTouchEvent[T]): Self = StObject.set(x, "originalEvent", value.asInstanceOf[js.Any])
