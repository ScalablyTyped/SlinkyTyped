...
object UncontrolledReactSVGPanZoom {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactSvgPanZoom.mod.UncontrolledReactSVGPanZoom] {
    @scala.inline
    ...
    @scala.inline
    def onChangeValue(value: /* value */ Value => Unit): this.type = set("onChangeValue", js.Any.fromFunction1(value))
    @scala.inline
