...
trait OptionalProps extends js.Object {
  ...
  var customMiniature: ReactElement | ReactComponentClass[js.Object]
  // override default toolbar component
  // TODO: specify function type more clearly
  var customToolbar: ReactComponentClass[_] | ReactComponentClass[_]
...
object OptionalProps {
  ...
  def apply(
    ...
    customToolbar: ReactComponentClass[_] | ReactComponentClass[_],
