...
object mod {
  ...
  object ReactTagsInputProps {
    ...
    implicit class ReactTagsInputPropsMutableBuilder[Self <: ReactTagsInputProps[_], Tag] (val x: Self with ReactTagsInputProps[Tag]) extends AnyVal {
      ...
      @scala.inline
      def setRenderInput(value: /* props */ RenderInputProps[Tag] => ReactElement): Self = StObject.set(x, "renderInput", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRenderTag(value: /* props */ RenderTagProps[Tag] => ReactElement): Self = StObject.set(x, "renderTag", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setValidationRegex(value: js.RegExp): Self = StObject.set(x, "validationRegex", value.asInstanceOf[js.Any])
