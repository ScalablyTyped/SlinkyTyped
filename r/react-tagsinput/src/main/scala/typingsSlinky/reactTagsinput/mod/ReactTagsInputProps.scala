...
trait ReactTagsInputProps[Tag] extends Props[TagsInput[Tag]] {
  ...
  var renderInput: js.UndefOr[js.Function1[/* props */ RenderInputProps[Tag], ReactElement]] = js.native
  
  var renderLayout: js.UndefOr[RenderLayout] = js.native
  
  var renderTag: js.UndefOr[js.Function1[/* props */ RenderTagProps[Tag], ReactElement]] = js.native
...
object ReactTagsInputProps {
  ...
  implicit class ReactTagsInputPropsOps[Self <: ReactTagsInputProps[_], Tag] (val x: Self with ReactTagsInputProps[Tag]) extends AnyVal {
    ...
    @scala.inline
    def setRenderInput(value: /* props */ RenderInputProps[Tag] => ReactElement): Self = this.set("renderInput", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderTag(value: /* props */ RenderTagProps[Tag] => ReactElement): Self = this.set("renderTag", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setValidationRegex(value: js.RegExp): Self = this.set("validationRegex", value.asInstanceOf[js.Any])
