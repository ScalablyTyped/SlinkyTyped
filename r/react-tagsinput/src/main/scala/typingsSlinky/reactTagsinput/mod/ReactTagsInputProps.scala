...
trait ReactTagsInputProps[Tag] extends Props[TagsInput[Tag]] {
  ...
  var renderInput: js.UndefOr[js.Function1[/* props */ RenderInputProps[Tag], TagMod[Any]]] = js.undefined
  var renderLayout: js.UndefOr[RenderLayout] = js.undefined
  var renderTag: js.UndefOr[js.Function1[/* props */ RenderTagProps[Tag], TagMod[Any]]] = js.undefined
...
object ReactTagsInputProps {
  ...
  def apply[Tag](
    ...
    renderInput: /* props */ RenderInputProps[Tag] => TagMod[Any] = null,
    renderLayout: (/* tagElements */ js.Array[ReactElement], /* inputElement */ ReactElement) => ReactChild = null,
    renderTag: /* props */ RenderTagProps[Tag] => TagMod[Any] = null,
