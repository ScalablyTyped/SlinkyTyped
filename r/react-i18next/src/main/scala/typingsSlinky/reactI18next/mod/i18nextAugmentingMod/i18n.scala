package typingsSlinky.reactI18next.mod.i18nextAugmentingMod

import typingsSlinky.reactI18next.mod.ReportNamespaces
...
object i18n {
  ...
  implicit class i18nOps[Self <: i18n] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReportNamespaces(value: ReportNamespaces): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reportNamespaces")(value.asInstanceOf[js.Any])
        ret
    }
  }
