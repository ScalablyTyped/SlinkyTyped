...
import typingsSlinky.reactI18next.AnonLng
...
trait TranslationProps extends js.Object {
  ...
  def children(t: TFunction, options: AnonLng): TagMod[Any] = js.native
}

object TranslationProps {
  @scala.inline
  def apply(children: (TFunction, AnonLng) => TagMod[Any]): TranslationProps = {
  ...
  implicit class TranslationPropsOps[Self <: TranslationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChildren(value: (TFunction, AnonLng) => TagMod[Any]): Self = {
