...
object EventListenerProps {
  ...
  implicit class EventListenerPropsOps[Self <: EventListenerProps[_], T /* <: EventTarget | WindowEventTargets */] (val x: Self with EventListenerProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnMessage(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ MessageEvent, _]): Self = this.set("onMessage", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnMessage: Self = this.set("onMessage", js.undefined)
    
    @scala.inline
    def setOnMessageCapture(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ MessageEvent, _]): Self = this.set("onMessageCapture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnProgress(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, _]): Self = this.set("onProgress", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnProgress: Self = this.set("onProgress", js.undefined)
    
    @scala.inline
    def setOnProgressCapture(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, _]): Self = this.set("onProgressCapture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnReadyStateChange(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, _]): Self = this.set("onReadyStateChange", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnReadyStateChange: Self = this.set("onReadyStateChange", js.undefined)
    
    @scala.inline
    def setOnReadyStateChangeCapture(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, _]): Self = this.set("onReadyStateChangeCapture", value.asInstanceOf[js.Any])
