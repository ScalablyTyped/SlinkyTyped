...
object EventListenerProps {
  ...
  implicit class EventListenerPropsOps[Self <: EventListenerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnProgress(value: /* ev */ ProgressEvent => _): Self = this.set("onProgress", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnProgress: Self = this.set("onProgress", js.undefined)
    @scala.inline
    def setOnProgressCapture(value: /* ev */ ProgressEvent => _): Self = this.set("onProgressCapture", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnReadyStateChange(value: /* ev */ ProgressEvent => _): Self = this.set("onReadyStateChange", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnReadyStateChange: Self = this.set("onReadyStateChange", js.undefined)
    @scala.inline
    def setOnReadyStateChangeCapture(value: /* ev */ ProgressEvent => _): Self = this.set("onReadyStateChangeCapture", js.Any.fromFunction1(value))
    @scala.inline
