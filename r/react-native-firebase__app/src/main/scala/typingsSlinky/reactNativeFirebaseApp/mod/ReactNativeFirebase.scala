...
import typingsSlinky.reactNativeFirebaseApp.anon.Call
import typingsSlinky.reactNativeFirebaseApp.anon.SDKVERSION
...
object ReactNativeFirebase {
  ...
  object FirebaseApp {
    ...
    implicit class FirebaseAppMutableBuilder[Self <: FirebaseApp] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUtils(value: () => typingsSlinky.reactNativeFirebaseApp.mod.Utils_.Module): Self = StObject.set(x, "utils", js.Any.fromFunction0(value))
    }
  }
