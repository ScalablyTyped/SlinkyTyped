...
trait Props extends js.Object {
  ...
  var children: TagMod[Any] | (js.Function1[/* status */ Status, TagMod[Any]])
...
object Props {
  ...
  def apply(
    ...
    children: TagMod[Any] | (js.Function1[/* status */ Status, TagMod[Any]]) = null,
    ...
    if (!js.isUndefined(enableTransforms)) __obj.updateDynamic("enableTransforms")(enableTransforms.get.asInstanceOf[js.Any])
