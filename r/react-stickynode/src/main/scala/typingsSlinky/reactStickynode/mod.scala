package typingsSlinky.reactStickynode

import slinky.core.ReactComponentClass
import slinky.core.facade.ReactElement
import typingsSlinky.react.mod.Component
import typingsSlinky.reactStickynode.mod.StatusCode.STATUS_FIXED
import typingsSlinky.reactStickynode.mod.StatusCode.STATUS_ORIGINAL
import typingsSlinky.reactStickynode.mod.StatusCode.STATUS_RELEASED
...
object mod {
  ...
  @js.native
  def STATUS_FIXED: typingsSlinky.reactStickynode.mod.StatusCode.STATUS_FIXED = js.native
  @scala.inline
  ...
  @js.native
  def STATUS_ORIGINAL: typingsSlinky.reactStickynode.mod.StatusCode.STATUS_ORIGINAL = js.native
  @scala.inline
  ...
  @js.native
  def STATUS_RELEASED: typingsSlinky.reactStickynode.mod.StatusCode.STATUS_RELEASED = js.native
  @scala.inline
  ...
  object StatusCode extends StObject {
    ...
    /* 2 */ val STATUS_FIXED: typingsSlinky.reactStickynode.mod.StatusCode.STATUS_FIXED with Double = js.native
    
    /** The default status, located at the original position. */
    @js.native
    sealed trait STATUS_ORIGINAL extends StatusCode
    /* 0 */ val STATUS_ORIGINAL: typingsSlinky.reactStickynode.mod.StatusCode.STATUS_ORIGINAL with Double = js.native
    ...
    /* 1 */ val STATUS_RELEASED: typingsSlinky.reactStickynode.mod.StatusCode.STATUS_RELEASED with Double = js.native
  }
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ReactElement | (js.Function1[/* status */ Status, ReactElement])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* status */ Status => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  /** A performant and comprehensive React sticky component. */
  type Sticky = ReactComponentClass[Props]
}
