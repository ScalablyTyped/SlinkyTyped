package typingsSlinky.reflectDashMetadata.reflectDashMetadataMod._Global_

import typingsSlinky.reflectDashMetadata.Fn_PropertyKey
...
object Reflect extends js.Object {
  ...
  /**
    ...
    *
    */
  def decorate(decorators: js.Array[PropertyDecorator | MethodDecorator], target: js.Object, propertyKey: String): js.PropertyDescriptor = js.native
  def decorate(
