...
object paginationPaginationMod {
  ...
  object PaginationModifiers {
    ...
    @scala.inline
    implicit class PaginationModifiersMutableBuilder[Self <: PaginationModifiers] (val x: Self) extends AnyVal {
  ...
  object PaginationVariables {
    ...
    @scala.inline
    implicit class PaginationVariablesMutableBuilder[Self <: PaginationVariables] (val x: Self) extends AnyVal {
  ...
  object PaginationVariablesDefaults {
    ...
    @scala.inline
    implicit class PaginationVariablesDefaultsMutableBuilder[Self <: PaginationVariablesDefaults] (val x: Self) extends AnyVal {
