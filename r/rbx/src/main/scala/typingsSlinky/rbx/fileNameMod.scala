...
object fileNameMod {
  ...
  @js.native
  val FileName: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object FileNameProps {
    ...
    @scala.inline
    def apply(): FileNameProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FileNameProps]
    }
    
    @scala.inline
    implicit class FileNamePropsMutableBuilder[Self <: FileNameProps] (val x: Self) extends AnyVal {
