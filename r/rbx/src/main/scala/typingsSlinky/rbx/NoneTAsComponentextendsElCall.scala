...
trait NoneTAsComponentextendsElCall extends js.Object {
  ...
  var Icon: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ReactElement] = js.native
  var Title: ForwardRefAsExoticComponent[CardHeaderTitleProps, ReactElement] = js.native
