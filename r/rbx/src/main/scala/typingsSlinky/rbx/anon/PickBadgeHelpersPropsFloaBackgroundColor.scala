...
@js.native
trait PickBadgeHelpersPropsFloaBackgroundColor extends StObject {
...
object PickBadgeHelpersPropsFloaBackgroundColor {
  ...
  @scala.inline
  implicit class PickBadgeHelpersPropsFloaBackgroundColorMutableBuilder[Self <: PickBadgeHelpersPropsFloaBackgroundColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any]): Self = StObject.set(x, "responsive", value.asInstanceOf[js.Any])
