...
trait PickBadgeHelpersPropsFloaBackgroundColor extends js.Object {
  ...
  var textSize: js.UndefOr[
    typingsSlinky.rbx.rbxNumbers.`1` | typingsSlinky.rbx.rbxNumbers.`2` | typingsSlinky.rbx.rbxNumbers.`3` | typingsSlinky.rbx.rbxNumbers.`4` | typingsSlinky.rbx.rbxNumbers.`5` | typingsSlinky.rbx.rbxNumbers.`6` | `7`
  ] = js.native
...
object PickBadgeHelpersPropsFloaBackgroundColor {
  ...
  @scala.inline
  def apply(): PickBadgeHelpersPropsFloaBackgroundColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickBadgeHelpersPropsFloaBackgroundColor]
  }
  
  @scala.inline
  implicit class PickBadgeHelpersPropsFloaBackgroundColorOps[Self <: PickBadgeHelpersPropsFloaBackgroundColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any]): Self = this.set("responsive", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTooltipResponsive(
      value: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
      */ typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any]
    ): Self = this.set("tooltipResponsive", value.asInstanceOf[js.Any])
