...
trait PickBadgeHelpersPropsFloaBackgroundColor extends js.Object {
  ...
  var responsive: js.UndefOr[
    typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any]
  ] = js.undefined
...
object PickBadgeHelpersPropsFloaBackgroundColor {
  @scala.inline
  def apply(
    ...
    responsive: typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any] = null,
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any] = null,
    unselectable: js.UndefOr[Boolean] = js.undefined
  ): PickBadgeHelpersPropsFloaBackgroundColor = {
