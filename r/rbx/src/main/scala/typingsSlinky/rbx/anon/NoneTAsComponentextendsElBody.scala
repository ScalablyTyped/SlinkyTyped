...
@js.native
trait NoneTAsComponentextendsElBody extends js.Object {
  ...
  var Body: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ReactElement] = js.native
  
  @JSName("$$typeof")
  var DollarDollartypeof: js.Symbol = js.native
  
  var Foot: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ReactElement] = js.native
  
  var Head: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ReactElement] = js.native
  
  var Title: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ReactElement] = js.native
