...
@js.native
trait ColumnGroupPropsBackgroundColor extends StObject {
...
object ColumnGroupPropsBackgroundColor {
  ...
  @scala.inline
  implicit class ColumnGroupPropsBackgroundColorMutableBuilder[Self <: ColumnGroupPropsBackgroundColor] (val x: Self) extends AnyVal {
