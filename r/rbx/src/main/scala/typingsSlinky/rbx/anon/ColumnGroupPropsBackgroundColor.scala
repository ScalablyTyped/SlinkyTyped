...
import typingsSlinky.rbx.columnGroupMod.ColumnGroupBreakpointOptions
...
@js.native
trait ColumnGroupPropsBackgroundColor extends js.Object {
  ...
  var gapSize: js.UndefOr[
    typingsSlinky.rbx.rbxNumbers.`0` | typingsSlinky.rbx.rbxNumbers.`1` | typingsSlinky.rbx.rbxNumbers.`2` | typingsSlinky.rbx.rbxNumbers.`3` | typingsSlinky.rbx.rbxNumbers.`4` | typingsSlinky.rbx.rbxNumbers.`5` | typingsSlinky.rbx.rbxNumbers.`6` | typingsSlinky.rbx.rbxNumbers.`7` | `8`
  ] = js.native
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.ColumnGroupPropsBackgroundColor with TopLevel[js.Any]
  ] = js.native
...
object ColumnGroupPropsBackgroundColor {
  @scala.inline
  def apply(): ColumnGroupPropsBackgroundColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColumnGroupPropsBackgroundColor]
  }
  @scala.inline
  implicit class ColumnGroupPropsBackgroundColorOps[Self <: ColumnGroupPropsBackgroundColor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withGapSize(
      value: typingsSlinky.rbx.rbxNumbers.`0` | typingsSlinky.rbx.rbxNumbers.`1` | typingsSlinky.rbx.rbxNumbers.`2` | typingsSlinky.rbx.rbxNumbers.`3` | typingsSlinky.rbx.rbxNumbers.`4` | typingsSlinky.rbx.rbxNumbers.`5` | typingsSlinky.rbx.rbxNumbers.`6` | typingsSlinky.rbx.rbxNumbers.`7` | `8`
    ): Self = {
        val ret = this.duplicate
