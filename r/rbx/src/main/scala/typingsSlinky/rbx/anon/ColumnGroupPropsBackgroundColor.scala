...
trait ColumnGroupPropsBackgroundColor extends js.Object {
  ...
  var gapSize: js.UndefOr[
    typingsSlinky.rbx.rbxNumbers.`0` | typingsSlinky.rbx.rbxNumbers.`1` | typingsSlinky.rbx.rbxNumbers.`2` | typingsSlinky.rbx.rbxNumbers.`3` | typingsSlinky.rbx.rbxNumbers.`4` | typingsSlinky.rbx.rbxNumbers.`5` | typingsSlinky.rbx.rbxNumbers.`6` | `7` | `8`
  ] = js.native
...
object ColumnGroupPropsBackgroundColor {
  ...
  implicit class ColumnGroupPropsBackgroundColorOps[Self <: ColumnGroupPropsBackgroundColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGapSize(
      value: typingsSlinky.rbx.rbxNumbers.`0` | typingsSlinky.rbx.rbxNumbers.`1` | typingsSlinky.rbx.rbxNumbers.`2` | typingsSlinky.rbx.rbxNumbers.`3` | typingsSlinky.rbx.rbxNumbers.`4` | typingsSlinky.rbx.rbxNumbers.`5` | typingsSlinky.rbx.rbxNumbers.`6` | `7` | `8`
    ): Self = this.set("gapSize", value.asInstanceOf[js.Any])
