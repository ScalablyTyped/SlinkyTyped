...
trait PickNavbarItemContainerPrActive extends js.Object {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickNavbarItemContainerPrActive with TopLevel[js.Any]
  ] = js.undefined
...
object PickNavbarItemContainerPrActive {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickNavbarItemContainerPrActive with TopLevel[js.Any] = null,
