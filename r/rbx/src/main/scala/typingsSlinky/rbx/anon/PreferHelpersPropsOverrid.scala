...
@js.native
trait PreferHelpersPropsOverrid extends js.Object {
...
object PreferHelpersPropsOverrid {
  ...
  @scala.inline
  implicit class PreferHelpersPropsOverridOps[Self <: PreferHelpersPropsOverrid] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltipResponsive(value: Kinmobiletabletdesktopwid): Self = this.set("tooltipResponsive", value.asInstanceOf[js.Any])
