...
@js.native
trait PreferHelpersPropsOverrid extends StObject {
  ...
  var tooltipResponsive: js.UndefOr[Kinmobiletabletdesktopwid] = js.native
  
  var unselectable: js.UndefOr[Boolean] = js.native
}
object PreferHelpersPropsOverrid {
  
  @scala.inline
  def apply(): PreferHelpersPropsOverrid = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PreferHelpersPropsOverrid]
  }
  
  @scala.inline
  implicit class PreferHelpersPropsOverridMutableBuilder[Self <: PreferHelpersPropsOverrid] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltipResponsive(value: Kinmobiletabletdesktopwid): Self = StObject.set(x, "tooltipResponsive", value.asInstanceOf[js.Any])
