...
object PreferHelpersPropsOverridBadge {
  ...
  def apply(
    ...
    responsive: typingsSlinky.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any] = null,
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any] = null,
    unselectable: js.UndefOr[Boolean] = js.undefined
  ): PreferHelpersPropsOverridBadge = {
