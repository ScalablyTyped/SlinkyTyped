...
@js.native
trait PreferHelpersPropsOverridBadge extends StObject {
  ...
  var responsive: js.UndefOr[
    typingsSlinky.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any]
  ] = js.native
...
object PreferHelpersPropsOverridBadge {
  
  @scala.inline
  def apply(): PreferHelpersPropsOverridBadge = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PreferHelpersPropsOverridBadge]
  }
  
  @scala.inline
  implicit class PreferHelpersPropsOverridBadgeMutableBuilder[Self <: PreferHelpersPropsOverridBadge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: typingsSlinky.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any]): Self = StObject.set(x, "responsive", value.asInstanceOf[js.Any])
