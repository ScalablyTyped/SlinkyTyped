...
@js.native
trait PreferHelpersPropsOverridBadge extends js.Object {
...
object PreferHelpersPropsOverridBadge {
  ...
  @scala.inline
  implicit class PreferHelpersPropsOverridBadgeOps[Self <: PreferHelpersPropsOverridBadge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: typingsSlinky.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any]): Self = this.set("responsive", value.asInstanceOf[js.Any])
