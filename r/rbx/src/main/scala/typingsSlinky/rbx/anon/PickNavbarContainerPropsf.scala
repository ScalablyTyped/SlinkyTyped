...
/* Inlined std.Pick<rbx.rbx/components/navbar/navbar-container.NavbarContainerProps, 'fixed' | 'transparent' | 'active' | 'hidden' | 'document' | 'color' | 'overlay' | 'italic' | 'relative' | 'tooltip' | 'className' | 'badge' | 'badgeColor' | 'badgeOutlined' | 'badgeRounded' | 'badgeSize' | 'clearfix' | 'pull' | 'marginless' | 'paddingless' | 'radiusless' | 'shadowless' | 'unselectable' | 'clipped' | 'responsive' | 'textAlign' | 'textSize' | 'tooltipActive' | 'tooltipColor' | 'tooltipMultiline' | 'tooltipPosition' | 'tooltipResponsive' | 'backgroundColor' | 'textColor' | 'textTransform' | 'textWeight' | 'invisible' | 'srOnly' | 'managed'> */
trait PickNavbarContainerPropsf extends js.Object {
  ...
  var responsive: js.UndefOr[BinmobilefullhdtouchLimit] = js.undefined
  ...
  var textSize: js.UndefOr[
    typingsSlinky.rbx.rbxNumbers.`1` | typingsSlinky.rbx.rbxNumbers.`2` | typingsSlinky.rbx.rbxNumbers.`3` | typingsSlinky.rbx.rbxNumbers.`4` | typingsSlinky.rbx.rbxNumbers.`5` | typingsSlinky.rbx.rbxNumbers.`6` | typingsSlinky.rbx.rbxNumbers.`7`
  ] = js.undefined
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickNavbarContainerPropsf with TopLevel[js.Any]
  ] = js.undefined
  var transparent: js.UndefOr[Boolean] = js.undefined
  var unselectable: js.UndefOr[Boolean] = js.undefined
}

object PickNavbarContainerPropsf {
  @scala.inline
  def apply(
    ...
    responsive: BinmobilefullhdtouchLimit = null,
    ...
    textSize: typingsSlinky.rbx.rbxNumbers.`1` | typingsSlinky.rbx.rbxNumbers.`2` | typingsSlinky.rbx.rbxNumbers.`3` | typingsSlinky.rbx.rbxNumbers.`4` | typingsSlinky.rbx.rbxNumbers.`5` | typingsSlinky.rbx.rbxNumbers.`6` | typingsSlinky.rbx.rbxNumbers.`7` = null,
    ...
    tooltipResponsive: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickNavbarContainerPropsf with TopLevel[js.Any] = null,
    transparent: js.UndefOr[Boolean] = js.undefined,
    unselectable: js.UndefOr[Boolean] = js.undefined
  ): PickNavbarContainerPropsf = {
