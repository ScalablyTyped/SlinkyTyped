...
trait PickNavbarContainerPropsf extends js.Object {
  ...
  var responsive: js.UndefOr[BinmobilefullhdtouchLimit] = js.native
...
object PickNavbarContainerPropsf {
  @scala.inline
  def apply(): PickNavbarContainerPropsf = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickNavbarContainerPropsf]
  }
  @scala.inline
  implicit class PickNavbarContainerPropsfOps[Self <: PickNavbarContainerPropsf] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResponsive(value: BinmobilefullhdtouchLimit): Self = this.set("responsive", value.asInstanceOf[js.Any])
    @scala.inline
