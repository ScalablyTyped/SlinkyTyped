...
@js.native
trait PickNavbarContainerPropsf extends StObject {
...
object PickNavbarContainerPropsf {
  ...
  @scala.inline
  implicit class PickNavbarContainerPropsfMutableBuilder[Self <: PickNavbarContainerPropsf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: BinmobilefullhdtouchLimit): Self = StObject.set(x, "responsive", value.asInstanceOf[js.Any])
