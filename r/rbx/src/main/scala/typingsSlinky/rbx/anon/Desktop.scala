...
object Desktop {
  @scala.inline
  def apply[TAsComponent](): Desktop[TAsComponent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Desktop[TAsComponent]]
  }
  @scala.inline
  implicit class DesktopOps[Self[tascomponent] <: Desktop[tascomponent], TAsComponent] (val x: Self[TAsComponent]) extends AnyVal {
    @scala.inline
