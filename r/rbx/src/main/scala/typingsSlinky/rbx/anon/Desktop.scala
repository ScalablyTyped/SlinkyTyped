...
@js.native
trait Desktop[TAsComponent /* <: ReactElement */] extends js.Object {
...
object Desktop {
  @scala.inline
  def apply[/* <: typingsSlinky.react.mod.ElementType[_] */ TAsComponent](): Desktop[TAsComponent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Desktop[TAsComponent]]
  }
  @scala.inline
  implicit class DesktopOps[Self <: Desktop[_], /* <: typingsSlinky.react.mod.ElementType[_] */ TAsComponent] (val x: Self with Desktop[TAsComponent]) extends AnyVal {
    @scala.inline
