...
@js.native
trait Desktop[TAsComponent /* <: ReactElement */] extends StObject {
...
object Desktop {
  ...
  @scala.inline
  def apply[TAsComponent /* <: ReactElement */](): Desktop[TAsComponent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Desktop[TAsComponent]]
  }
  
  @scala.inline
  implicit class DesktopMutableBuilder[Self <: Desktop[_], TAsComponent /* <: ReactElement */] (val x: Self with Desktop[TAsComponent]) extends AnyVal {
