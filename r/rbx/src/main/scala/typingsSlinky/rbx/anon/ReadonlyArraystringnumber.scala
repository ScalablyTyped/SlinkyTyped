...
trait ReadonlyArraystringnumber extends js.Object {
  ...
  val flat: js.ThisFunction0[/* this */ js.Any, js.Array[FlatArray[_, typingsSlinky.rbx.rbxNumbers.`1`]]] = js.native
...
object ReadonlyArraystringnumber {
  ...
  def apply(
    ...
    flat: js.ThisFunction0[/* this */ js.Any, js.Array[FlatArray[_, typingsSlinky.rbx.rbxNumbers.`1`]]],
  ...
  implicit class ReadonlyArraystringnumberOps[Self <: ReadonlyArraystringnumber] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFlat(
      value: js.ThisFunction0[/* this */ js.Any, js.Array[FlatArray[_, typingsSlinky.rbx.rbxNumbers.`1`]]]
