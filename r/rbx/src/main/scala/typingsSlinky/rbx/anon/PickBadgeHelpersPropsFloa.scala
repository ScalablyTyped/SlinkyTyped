...
@js.native
trait PickBadgeHelpersPropsFloa extends StObject {
...
object PickBadgeHelpersPropsFloa {
  ...
  @scala.inline
  implicit class PickBadgeHelpersPropsFloaMutableBuilder[Self <: PickBadgeHelpersPropsFloa] (val x: Self) extends AnyVal {
