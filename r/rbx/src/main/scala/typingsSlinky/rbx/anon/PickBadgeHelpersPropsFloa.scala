...
trait PickBadgeHelpersPropsFloa extends js.Object {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloa with TopLevel[js.Any]
  ] = js.undefined
  var unselectable: js.UndefOr[Boolean] = js.undefined
}

object PickBadgeHelpersPropsFloa {
  @scala.inline
  def apply(
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickBadgeHelpersPropsFloa with TopLevel[js.Any] = null,
    unselectable: js.UndefOr[Boolean] = js.undefined
  ): PickBadgeHelpersPropsFloa = {
    ...
    __obj.asInstanceOf[PickBadgeHelpersPropsFloa]
  }
}
