...
trait PickNavbarItemContainerPr extends js.Object {
  ...
  var responsive: js.UndefOr[typingsSlinky.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any]] = js.undefined
...
object PickNavbarItemContainerPr {
  ...
  def apply(
    ...
    responsive: typingsSlinky.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any] = null,
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any] = null,
    unselectable: js.UndefOr[Boolean] = js.undefined,
    up: js.UndefOr[Boolean] = js.undefined
  ): PickNavbarItemContainerPr = {
