...
object PickNavbarItemContainerPr {
  ...
  implicit class PickNavbarItemContainerPrOps[Self <: PickNavbarItemContainerPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: typingsSlinky.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any]): Self = this.set("responsive", value.asInstanceOf[js.Any])
    @scala.inline
