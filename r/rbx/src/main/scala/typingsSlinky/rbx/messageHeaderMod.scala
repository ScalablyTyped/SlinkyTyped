...
object messageHeaderMod {
  
  @JSImport("rbx/components/message/message-header", "MessageHeader")
  @js.native
  val MessageHeader: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object MessageHeaderProps {
    ...
    @scala.inline
    implicit class MessageHeaderPropsMutableBuilder[Self <: MessageHeaderProps] (val x: Self) extends AnyVal {
