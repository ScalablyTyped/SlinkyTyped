...
object paginationLinkMod {
  ...
  @js.native
  val PaginationLink: ForwardRefAsExoticComponent[PaginationLinkProps, ReactElement] = js.native
  ...
  object PaginationLinkModifiers {
    ...
    @scala.inline
    implicit class PaginationLinkModifiersMutableBuilder[Self <: PaginationLinkModifiers] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/pagination/pagination-link.PaginationLinkModifiers */
  @js.native
  trait PaginationLinkProps extends StObject {
