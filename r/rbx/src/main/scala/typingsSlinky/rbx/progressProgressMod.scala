...
object progressProgressMod {
  ...
  @js.native
  val Progress: ForwardRefAsExoticComponent[ProgressProps, ReactElement] = js.native
  ...
  object ProgressModifierProps {
    ...
    @scala.inline
    implicit class ProgressModifierPropsMutableBuilder[Self <: ProgressModifierProps] (val x: Self) extends AnyVal {
  ...
  object ProgressVariables {
    ...
    @scala.inline
    implicit class ProgressVariablesMutableBuilder[Self <: ProgressVariables] (val x: Self) extends AnyVal {
  ...
  object ProgressVariablesDefaults {
    ...
    @scala.inline
    implicit class ProgressVariablesDefaultsMutableBuilder[Self <: ProgressVariablesDefaults] (val x: Self) extends AnyVal {
