package typingsSlinky.rbx.fieldBodyMod
...
@js.native
trait FieldBodyProps extends js.Object {
...
object FieldBodyProps {
  ...
  @scala.inline
  implicit class FieldBodyPropsOps[Self <: FieldBodyProps] (val x: Self) extends AnyVal {
