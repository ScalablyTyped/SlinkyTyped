package typingsSlinky.rbx.panelTabGroupMod
...
@js.native
trait PanelTabGroupProps extends js.Object {
...
object PanelTabGroupProps {
  
  @scala.inline
  def apply(): PanelTabGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PanelTabGroupProps]
  }
  
  @scala.inline
  implicit class PanelTabGroupPropsOps[Self <: PanelTabGroupProps] (val x: Self) extends AnyVal {
