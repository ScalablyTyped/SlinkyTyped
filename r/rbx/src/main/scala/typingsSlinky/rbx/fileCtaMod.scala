...
object fileCtaMod {
  ...
  @js.native
  val FileCTA: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object FileCTAProps {
    ...
    @scala.inline
    def apply(): FileCTAProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FileCTAProps]
    }
    
    @scala.inline
    implicit class FileCTAPropsMutableBuilder[Self <: FileCTAProps] (val x: Self) extends AnyVal {
