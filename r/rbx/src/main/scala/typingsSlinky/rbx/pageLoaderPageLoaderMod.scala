...
object pageLoaderPageLoaderMod {
  
  object PAGE_LOADER_DEFAULTS {
    
    @JSImport("rbx/elements/page-loader/page-loader", "PAGE_LOADER_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/page-loader/page-loader", "PAGE_LOADER_DEFAULTS.directions")
    @js.native
    def directions: js.Tuple2[`right-to-left`, `left-to-right`] = js.native
    @scala.inline
    def directions_=(x: js.Tuple2[`right-to-left`, `left-to-right`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("directions")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("rbx/elements/page-loader/page-loader", "PageLoader")
  @js.native
  val PageLoader: ForwardRefAsExoticComponent[PageLoaderProps, ReactElement] = js.native
  ...
  object PageLoaderModifierProps {
    ...
    @scala.inline
    implicit class PageLoaderModifierPropsMutableBuilder[Self <: PageLoaderModifierProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDirection(value: `right-to-left` | `left-to-right`): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/page-loader/page-loader.PageLoaderModifierProps */
  @js.native
  trait PageLoaderProps extends StObject {
  ...
  object PageLoaderProps {
    
    @scala.inline
    def apply(): PageLoaderProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PageLoaderProps]
    }
    
    @scala.inline
    implicit class PageLoaderPropsMutableBuilder[Self <: PageLoaderProps] (val x: Self) extends AnyVal {
