...
object imageContainerMod {
  
  object IMAGE_CONTAINER_DEFAULTS {
    
    @JSImport("rbx/elements/image/image-container", "IMAGE_CONTAINER_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/image/image-container", "IMAGE_CONTAINER_DEFAULTS.dimmensions")
    @js.native
    def dimmensions: js.Tuple7[`16`, `24`, `32`, `48`, `64`, `96`, `128`] = js.native
    @scala.inline
    def dimmensions_=(x: js.Tuple7[`16`, `24`, `32`, `48`, `64`, `96`, `128`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dimmensions")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/image/image-container", "IMAGE_CONTAINER_DEFAULTS.ratios")
    @js.native
    def ratios: js.Tuple16[
        `16by9`, 
        `1by1`, 
        `1by2`, 
        `1by3`, 
    ...
    ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ratios")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("rbx/elements/image/image-container", "ImageContainer")
  @js.native
  val ImageContainer: ForwardRefAsExoticComponent[ImageContainerProps, ReactElement] = js.native
  ...
  object ImageContainerModifierProps {
    ...
    @scala.inline
    implicit class ImageContainerModifierPropsMutableBuilder[Self <: ImageContainerModifierProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ImageContainerProps extends StObject {
  ...
  object ImageContainerProps {
    ...
    @scala.inline
    implicit class ImageContainerPropsMutableBuilder[Self <: ImageContainerProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ImageContainerVariables extends StObject {
  ...
  object ImageContainerVariables {
    ...
    @scala.inline
    implicit class ImageContainerVariablesMutableBuilder[Self <: ImageContainerVariables] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ImageContainerVariablesDefaults extends StObject {
  ...
  object ImageContainerVariablesDefaults {
    ...
    @scala.inline
    implicit class ImageContainerVariablesDefaultsMutableBuilder[Self <: ImageContainerVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ImageContainerVariablesOverrides extends StObject
}
