...
@js.native
trait Anon7[TAsComponent /* <: ReactElement */] extends js.Object {
  var as: js.UndefOr[TAsComponent] = js.native
}

object Anon7 {
  @scala.inline
  def apply[TAsComponent](): Anon7[TAsComponent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Anon7[TAsComponent]]
  }
  @scala.inline
  implicit class Anon7Ops[Self[tascomponent] <: Anon7[tascomponent], TAsComponent] (val x: Self[TAsComponent]) extends AnyVal {
    @scala.inline
