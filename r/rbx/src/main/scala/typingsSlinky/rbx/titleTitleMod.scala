...
object titleTitleMod {
  ...
  object TITLE_DEFAULTS {
    
    @JSImport("rbx/elements/title/title", "TITLE_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/title/title", "TITLE_DEFAULTS.sizes")
    @js.native
    def sizes: js.Tuple6[`1`, `2`, `3`, `4`, `5`, `6`] = js.native
    @scala.inline
    def sizes_=(x: js.Tuple6[`1`, `2`, `3`, `4`, `5`, `6`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("rbx/elements/title/title", "Title")
  @js.native
  val Title: ForwardRefAsExoticComponent[TitleProps, ReactElement] = js.native
  ...
  object TitleModifierProps {
    ...
    @scala.inline
    implicit class TitleModifierPropsMutableBuilder[Self <: TitleModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setSize(value: `1` | `2` | `3` | `4` | `5` | `6`): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSizeUndefined: Self = StObject.set(x, "size", js.undefined)
      
      @scala.inline
      def setSpaced(value: Boolean): Self = StObject.set(x, "spaced", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSpacedUndefined: Self = StObject.set(x, "spaced", js.undefined)
      
      @scala.inline
      def setSubtitle(value: Boolean): Self = StObject.set(x, "subtitle", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/title/title.TitleModifierProps */
  @js.native
  ...
  @js.native
  trait TitleVariables extends StObject {
  ...
  object TitleVariables {
    ...
    @scala.inline
    implicit class TitleVariablesMutableBuilder[Self <: TitleVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setSizes(value: `1` | `2` | `3` | `4` | `5` | `6`): Self = StObject.set(x, "sizes", value.asInstanceOf[js.Any])
    }
  }
  
  @js.native
  trait TitleVariablesDefaults extends StObject {
  ...
  object TitleVariablesDefaults {
    ...
    @scala.inline
    implicit class TitleVariablesDefaultsMutableBuilder[Self <: TitleVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait TitleVariablesOverrides extends StObject
}
