...
import typingsSlinky.rbx.contentContentMod.ContentModifierProps
...
object contentMod {
  ...
  object Content {
    ...
    @scala.inline
    def OrderedList_=(x: NoneTAsComponentextendsElItem): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OrderedList")(x.asInstanceOf[js.Any])
