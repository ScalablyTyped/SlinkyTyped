...
import typingsSlinky.rbx.panelTabMod.PanelTabModifierProps
...
trait NoneTAsComponentextendsElDisplayName extends js.Object {
  ...
  var Group: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ReactElement] = js.native
  ...
  def apply[TAsComponent /* <: ReactElement */](
    props: Anon7[TAsComponent] with HelpersPropsOverrides with PickBadgeHelpersPropsFloaBackgroundColor with PanelTabModifierProps with (Pick[
