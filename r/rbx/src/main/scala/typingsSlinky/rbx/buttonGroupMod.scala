...
object buttonGroupMod {
  ...
  @js.native
  val ButtonGroup: ForwardRefAsExoticComponent[ButtonGroupProps, ReactElement] = js.native
  ...
  object ButtonGroupModifierProps {
    ...
    @scala.inline
    implicit class ButtonGroupModifierPropsMutableBuilder[Self <: ButtonGroupModifierProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHasAddons(value: Boolean): Self = StObject.set(x, "hasAddons", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHasAddonsUndefined: Self = StObject.set(x, "hasAddons", js.undefined)
  ...
  object ButtonGroupVariables {
    ...
    @scala.inline
    implicit class ButtonGroupVariablesMutableBuilder[Self <: ButtonGroupVariables] (val x: Self) extends AnyVal {
  ...
  object ButtonGroupVariablesDefaults {
    ...
    @scala.inline
    implicit class ButtonGroupVariablesDefaultsMutableBuilder[Self <: ButtonGroupVariablesDefaults] (val x: Self) extends AnyVal {
