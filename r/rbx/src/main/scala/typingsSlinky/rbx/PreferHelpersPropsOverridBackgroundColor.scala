...
trait PreferHelpersPropsOverridBackgroundColor extends js.Object {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PreferHelpersPropsOverridBackgroundColor with TopLevel[js.Any]
  ] = js.native
...
object PreferHelpersPropsOverridBackgroundColor {
  @scala.inline
  def apply(): PreferHelpersPropsOverridBackgroundColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PreferHelpersPropsOverridBackgroundColor]
  }
  @scala.inline
  implicit class PreferHelpersPropsOverridBackgroundColorOps[Self <: PreferHelpersPropsOverridBackgroundColor] (val x: Self) extends AnyVal {
    @scala.inline
