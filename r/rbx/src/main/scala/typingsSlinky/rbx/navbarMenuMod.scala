...
object navbarMenuMod {
  
  @JSImport("rbx/components/navbar/navbar-menu", "NavbarMenu")
  @js.native
  val NavbarMenu: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object NavbarMenuProps {
    
    @scala.inline
    def apply(): NavbarMenuProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[NavbarMenuProps]
    }
    
    @scala.inline
    implicit class NavbarMenuPropsMutableBuilder[Self <: NavbarMenuProps] (val x: Self) extends AnyVal {
