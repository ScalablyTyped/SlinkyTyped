package typingsSlinky.rbx.heroBodyMod
...
@js.native
trait HeroBodyProps extends js.Object {
...
object HeroBodyProps {
  ...
  @scala.inline
  implicit class HeroBodyPropsOps[Self <: HeroBodyProps] (val x: Self) extends AnyVal {
    @scala.inline
