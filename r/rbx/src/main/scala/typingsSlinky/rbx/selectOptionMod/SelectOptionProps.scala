package typingsSlinky.rbx.selectOptionMod
...
@js.native
trait SelectOptionProps extends js.Object {
...
object SelectOptionProps {
  @scala.inline
  def apply(): SelectOptionProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SelectOptionProps]
  }
  @scala.inline
  implicit class SelectOptionPropsOps[Self <: SelectOptionProps] (val x: Self) extends AnyVal {
    @scala.inline
