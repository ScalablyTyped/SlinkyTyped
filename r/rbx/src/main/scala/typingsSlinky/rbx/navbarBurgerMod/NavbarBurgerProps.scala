...
/* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/navbar/navbar-burger.NavbarBurgerModifierProps */
@js.native
trait NavbarBurgerProps extends js.Object {
...
object NavbarBurgerProps {
  @scala.inline
  def apply(): NavbarBurgerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavbarBurgerProps]
  }
  @scala.inline
  implicit class NavbarBurgerPropsOps[Self <: NavbarBurgerProps] (val x: Self) extends AnyVal {
    @scala.inline
