...
object cardHeaderMod {
  ...
  object CardHeader {
    ...
    @js.native
    def Title: ForwardRefAsExoticComponent[CardHeaderTitleProps, ReactElement] = js.native
    @scala.inline
    def Title_=(x: ForwardRefAsExoticComponent[CardHeaderTitleProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Title")(x.asInstanceOf[js.Any])
