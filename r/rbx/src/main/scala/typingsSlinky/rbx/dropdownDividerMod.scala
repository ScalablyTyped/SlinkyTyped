...
object dropdownDividerMod {
  
  @JSImport("rbx/components/dropdown/dropdown-divider", "DropdownDivider")
  @js.native
  val DropdownDivider: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object DropdownDividerProps {
    ...
    @scala.inline
    implicit class DropdownDividerPropsMutableBuilder[Self <: DropdownDividerProps] (val x: Self) extends AnyVal {
