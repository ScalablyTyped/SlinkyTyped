...
object contentContentMod {
  ...
  object ContentModifierProps {
    ...
    @scala.inline
    implicit class ContentModifierPropsMutableBuilder[Self <: ContentModifierProps] (val x: Self) extends AnyVal {
  ...
  object ContentVariables {
    ...
    @scala.inline
    implicit class ContentVariablesMutableBuilder[Self <: ContentVariables] (val x: Self) extends AnyVal {
  ...
  object ContentVariablesDefaults {
    ...
    @scala.inline
    implicit class ContentVariablesDefaultsMutableBuilder[Self <: ContentVariablesDefaults] (val x: Self) extends AnyVal {
