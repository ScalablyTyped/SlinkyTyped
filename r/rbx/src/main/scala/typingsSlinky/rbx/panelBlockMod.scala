...
object panelBlockMod {
  
  @JSImport("rbx/components/panel/panel-block", "PanelBlock")
  @js.native
  val PanelBlock: ForwardRefAsExoticComponent[PanelBlockProps, ReactElement] = js.native
  ...
  object PanelBlockModifierProps {
    ...
    @scala.inline
    implicit class PanelBlockModifierPropsMutableBuilder[Self <: PanelBlockModifierProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/panel/panel-block.PanelBlockModifierProps */
  @js.native
  ...
  object PanelBlockProps {
    ...
    @scala.inline
    def apply(): PanelBlockProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PanelBlockProps]
    }
    
    @scala.inline
    implicit class PanelBlockPropsMutableBuilder[Self <: PanelBlockProps] (val x: Self) extends AnyVal {
