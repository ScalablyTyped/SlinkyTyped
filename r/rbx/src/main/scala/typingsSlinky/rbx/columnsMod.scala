...
object columnsMod {
  ...
  object Column {
    ...
    @JSImport("rbx/grid/columns", "Column")
    @js.native
    ...
    @JSImport("rbx/grid/columns", "Column.Group")
    @js.native
    def Group: ForwardRefAsExoticComponent[ColumnGroupPropsBackgroundColor, ReactElement] = js.native
    @scala.inline
    def Group_=(x: ForwardRefAsExoticComponent[ColumnGroupPropsBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/grid/columns", "Column.defaultProps")
    @js.native
    ...
    @JSImport("rbx/grid/columns", "Column.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/grid/columns", "Column.$$typeof")
    @js.native
