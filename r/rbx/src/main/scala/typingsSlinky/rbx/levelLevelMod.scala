...
object levelLevelMod {
  ...
  object Level {
    ...
    @JSImport("rbx/components/level/level", "Level.Item")
    @js.native
    ...
    @JSImport("rbx/components/level/level", "Level.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/level/level", "Level.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/level/level", "Level.$$typeof")
    @js.native
  ...
  @js.native
  trait LevelModifierProps extends StObject {
  ...
  object LevelModifierProps {
    ...
    @scala.inline
    implicit class LevelModifierPropsMutableBuilder[Self <: LevelModifierProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/level/level.LevelModifierProps */
  @js.native
  ...
  object LevelProps {
    ...
    @scala.inline
    def apply(): LevelProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LevelProps]
    }
    
    @scala.inline
    implicit class LevelPropsMutableBuilder[Self <: LevelProps] (val x: Self) extends AnyVal {
