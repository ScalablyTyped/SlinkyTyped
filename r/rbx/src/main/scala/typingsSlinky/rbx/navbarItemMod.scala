...
object navbarItemMod {
  ...
  object NavbarItem {
    ...
    @JSImport("rbx/components/navbar/navbar-item", "NavbarItem.Container")
    @js.native
    class Container protected () extends NavbarItemContainer {
      def this(props: NavbarItemContainerProps) = this()
    }
    @JSImport("rbx/components/navbar/navbar-item", "NavbarItem.Container")
    @js.native
    def Container: TypeofNavbarItemContainer = js.native
    @scala.inline
    def Container_=(x: TypeofNavbarItemContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Container")(x.asInstanceOf[js.Any])
    ...
    @JSImport("rbx/components/navbar/navbar-item", "NavbarItem.$$typeof")
    @js.native
  ...
  object NavbarItemProps {
    ...
    @scala.inline
    implicit class NavbarItemPropsMutableBuilder[Self <: NavbarItemProps] (val x: Self) extends AnyVal {
