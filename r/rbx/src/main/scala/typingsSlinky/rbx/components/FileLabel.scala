...
object FileLabel {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: FileLabel.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
