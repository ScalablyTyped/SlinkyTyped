...
object FileIcon {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: FileIcon.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
