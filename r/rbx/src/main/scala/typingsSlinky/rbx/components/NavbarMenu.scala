...
object NavbarMenu {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: NavbarMenu.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
