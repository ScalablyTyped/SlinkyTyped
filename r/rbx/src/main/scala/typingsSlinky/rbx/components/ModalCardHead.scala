...
object ModalCardHead {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ModalCardHead.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
