...
object ModalCardFoot {
  @JSImport("rbx/components/modal/modal-card-foot", "ModalCardFoot")
  @js.native
  ...
  implicit def make[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](companion: ModalCardFoot.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
