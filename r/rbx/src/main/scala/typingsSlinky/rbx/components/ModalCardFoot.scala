...
object ModalCardFoot {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ModalCardFoot.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
