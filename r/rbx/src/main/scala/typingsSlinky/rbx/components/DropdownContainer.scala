...
object DropdownContainer {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.rbx.dropdownContainerMod.DropdownContainer] {
    @scala.inline
  ...
  def withProps(p: DropdownContainerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: DropdownContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
