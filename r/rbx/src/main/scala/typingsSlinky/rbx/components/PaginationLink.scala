...
object PaginationLink {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: PaginationLink.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
