...
object Help {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Help.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
