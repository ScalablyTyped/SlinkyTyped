...
typingsSlinky.rbx.anon.As[TAsComponent] with typingsSlinky.rbx.helpMod.HelpProps, 
...
object Help {
  ...
  def apply[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](
    p: (Prefer[As[TAsComponent] with HelpProps, ComponentProps[TAsComponent]]) with (RefAttributes[TAsComponent | FromReactType[TAsComponent]])
  ): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](companion: Help.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
