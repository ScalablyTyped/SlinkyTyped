...
object NavbarDivider {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: NavbarDivider.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
