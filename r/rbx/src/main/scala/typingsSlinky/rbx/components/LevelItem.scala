...
object LevelItem {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: LevelItem.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
