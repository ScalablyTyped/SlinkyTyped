...
object ModalCardTitle {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ModalCardTitle.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
