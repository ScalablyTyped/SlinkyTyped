...
object Heading {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Heading.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
