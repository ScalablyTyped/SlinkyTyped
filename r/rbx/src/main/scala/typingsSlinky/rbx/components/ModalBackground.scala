...
object ModalBackground {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ModalBackground.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
