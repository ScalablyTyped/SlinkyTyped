...
object ContentOrderedListItem {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ContentOrderedListItem.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
