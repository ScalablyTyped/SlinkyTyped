...
object Icon {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Icon.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
