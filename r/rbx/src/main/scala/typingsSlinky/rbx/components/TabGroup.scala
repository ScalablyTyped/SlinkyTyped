...
object TabGroup {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: TabGroup.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
