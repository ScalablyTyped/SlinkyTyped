...
object Notification {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Notification.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
