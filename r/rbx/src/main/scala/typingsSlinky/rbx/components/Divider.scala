...
object Divider {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Divider.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
