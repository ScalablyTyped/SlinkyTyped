...
object Media {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Media.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
