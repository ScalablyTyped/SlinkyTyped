...
object CardFooterItem {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: CardFooterItem.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
