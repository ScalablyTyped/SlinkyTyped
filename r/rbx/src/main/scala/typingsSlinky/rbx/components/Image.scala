...
object Image {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Image.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
