...
object ListItem {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ListItem.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
