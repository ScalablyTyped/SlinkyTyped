...
object MenuList {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: MenuList.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
