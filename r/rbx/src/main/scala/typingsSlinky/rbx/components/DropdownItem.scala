...
object DropdownItem {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: DropdownItem.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
