...
import typingsSlinky.rbx.cardHeaderTitleMod.CardHeaderTitleProps
...
typingsSlinky.rbx.anon.As[TAsComponent] with typingsSlinky.rbx.cardHeaderTitleMod.CardHeaderTitleProps, 
...
object CardHeaderTitle {
  ...
  def apply[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](
    p: (Prefer[As[TAsComponent] with CardHeaderTitleProps, ComponentProps[TAsComponent]]) with (RefAttributes[TAsComponent | FromReactType[TAsComponent]])
  ): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](companion: CardHeaderTitle.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
