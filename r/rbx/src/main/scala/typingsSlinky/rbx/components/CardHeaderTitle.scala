...
object CardHeaderTitle {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: CardHeaderTitle.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
