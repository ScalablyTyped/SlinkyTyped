...
object CardContent {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: CardContent.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
