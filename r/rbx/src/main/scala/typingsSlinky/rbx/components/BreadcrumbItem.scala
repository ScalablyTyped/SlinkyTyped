...
object BreadcrumbItem {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: BreadcrumbItem.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
