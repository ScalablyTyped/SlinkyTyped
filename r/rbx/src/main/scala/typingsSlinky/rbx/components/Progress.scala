...
object Progress {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Progress.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
