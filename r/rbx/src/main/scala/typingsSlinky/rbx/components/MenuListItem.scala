...
typingsSlinky.rbx.anon.As[TAsComponent] with typingsSlinky.rbx.menuListItemMod.MenuListItemProps, 
...
object MenuListItem {
  ...
  implicit def make[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](companion: MenuListItem.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
