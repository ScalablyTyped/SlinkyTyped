...
object CardHeader {
  ...
  implicit def make[TAsComponent <: ReactElement](companion: CardHeader.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
