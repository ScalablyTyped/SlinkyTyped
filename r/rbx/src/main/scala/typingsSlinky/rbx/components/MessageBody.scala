...
object MessageBody {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: MessageBody.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
