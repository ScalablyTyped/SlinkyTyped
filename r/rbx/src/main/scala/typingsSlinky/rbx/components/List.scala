...
object List {
  ...
  implicit def make[TAsComponent <: ReactElement](companion: List.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
