...
object HeroBody {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: HeroBody.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
