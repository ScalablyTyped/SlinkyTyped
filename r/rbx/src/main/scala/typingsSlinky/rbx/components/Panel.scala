...
object Panel {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Panel.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
