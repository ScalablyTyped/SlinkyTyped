...
object Message {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Message.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
