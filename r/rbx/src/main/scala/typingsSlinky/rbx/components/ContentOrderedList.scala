...
import typingsSlinky.rbx.contentOrderedListMod.ContentOrderedListModifierProps
import typingsSlinky.rbx.exoticMod.FromReactType
import typingsSlinky.rbx.helpersMod.HelpersPropsOverrides
import typingsSlinky.rbx.rbxStrings.`type`
...
/* The props of this component has an unsupported shape. You can use `set` manually to use it, but with no compiler support :/ . Couldn't find props for typingsSlinky.rbx.anon.`6`[TAsComponent] with typingsSlinky.rbx.helpersMod.HelpersPropsOverrides with typingsSlinky.rbx.anon.PickBadgeHelpersPropsFloa with typingsSlinky.rbx.contentOrderedListMod.ContentOrderedListModifierProps with (typingsSlinky.std.Pick[
...
object ContentOrderedList {
  ...
  implicit def make[/* <: typingsSlinky.react.mod.ElementType[js.Any] */ TAsComponent](companion: ContentOrderedList.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
