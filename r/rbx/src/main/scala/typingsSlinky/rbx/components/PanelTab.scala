...
object PanelTab {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: PanelTab.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
