...
object Block {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Block.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
