...
object NavbarDropdown {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: NavbarDropdown.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
