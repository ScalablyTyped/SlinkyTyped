...
object PaginationEllipsis {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: PaginationEllipsis.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
