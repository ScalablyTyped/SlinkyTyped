...
@scala.inline
class SharedBuilder_DropdownContainerProps_161885961[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def align(value: right): this.type = set("align", value.asInstanceOf[js.Any])
