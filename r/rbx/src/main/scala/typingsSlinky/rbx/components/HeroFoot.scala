...
object HeroFoot {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: HeroFoot.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
