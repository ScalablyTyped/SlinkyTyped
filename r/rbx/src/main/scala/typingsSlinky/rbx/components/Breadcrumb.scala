...
object Breadcrumb {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Breadcrumb.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
