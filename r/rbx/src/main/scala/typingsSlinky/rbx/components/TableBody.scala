...
object TableBody {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: TableBody.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
