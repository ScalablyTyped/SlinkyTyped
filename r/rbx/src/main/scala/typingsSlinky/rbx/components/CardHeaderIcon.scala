...
object CardHeaderIcon {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: CardHeaderIcon.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
