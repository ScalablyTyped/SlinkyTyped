...
object Generic {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Generic.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
