...
object ModalCard {
  ...
  implicit def make[TAsComponent <: ReactElement](companion: ModalCard.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
