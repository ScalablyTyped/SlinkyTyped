...
object PanelBlock {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: PanelBlock.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
