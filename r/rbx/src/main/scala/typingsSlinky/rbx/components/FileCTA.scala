...
object FileCTA {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: FileCTA.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
