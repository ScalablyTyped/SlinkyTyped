...
object MenuLabel {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: MenuLabel.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
