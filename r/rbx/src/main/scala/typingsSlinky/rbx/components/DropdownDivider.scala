...
object DropdownDivider {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: DropdownDivider.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
