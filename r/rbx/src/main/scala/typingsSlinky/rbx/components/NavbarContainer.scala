...
object NavbarContainer {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.rbx.navbarContainerMod.NavbarContainer] {
    @scala.inline
  ...
  def withProps(p: NavbarContainerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: NavbarContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
