...
object NavbarBrand {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: NavbarBrand.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
