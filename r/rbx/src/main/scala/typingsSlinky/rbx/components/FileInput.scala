...
object FileInput {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: FileInput.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
