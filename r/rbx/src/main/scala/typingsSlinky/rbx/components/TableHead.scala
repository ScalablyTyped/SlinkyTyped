...
object TableHead {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: TableHead.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
