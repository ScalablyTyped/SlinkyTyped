...
object Tile {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Tile.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
