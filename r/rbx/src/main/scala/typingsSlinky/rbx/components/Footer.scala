...
object Footer {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Footer.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
