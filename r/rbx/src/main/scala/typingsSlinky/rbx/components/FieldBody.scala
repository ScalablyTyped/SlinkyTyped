...
object FieldBody {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: FieldBody.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
