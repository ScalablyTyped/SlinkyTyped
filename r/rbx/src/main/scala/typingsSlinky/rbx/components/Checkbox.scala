...
object Checkbox {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Checkbox.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
