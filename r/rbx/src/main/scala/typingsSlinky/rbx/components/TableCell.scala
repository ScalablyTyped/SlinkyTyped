...
object TableCell {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: TableCell.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
