...
object HeroHead {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: HeroHead.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
