...
object TableFoot {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: TableFoot.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
