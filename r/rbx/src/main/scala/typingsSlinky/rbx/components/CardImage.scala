...
object CardImage {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: CardImage.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
