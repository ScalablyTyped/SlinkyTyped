...
object ColumnGroup {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ColumnGroup.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
