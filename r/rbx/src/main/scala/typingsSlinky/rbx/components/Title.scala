...
object Title {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Title.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
