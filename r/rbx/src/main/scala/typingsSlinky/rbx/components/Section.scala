...
object Section {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Section.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
