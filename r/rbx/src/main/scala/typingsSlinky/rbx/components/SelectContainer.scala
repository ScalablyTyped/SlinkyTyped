...
typingsSlinky.rbx.anon.As[TAsComponent] with typingsSlinky.rbx.selectMod.SelectContainerProps, 
...
object SelectContainer {
  @JSImport("rbx/elements/form/select", "SelectContainer")
  @js.native
  ...
  def apply[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](
    p: (Prefer[As[TAsComponent] with SelectContainerProps, ComponentProps[TAsComponent]]) with (RefAttributes[TAsComponent | FromReactType[TAsComponent]])
  ): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](companion: SelectContainer.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
