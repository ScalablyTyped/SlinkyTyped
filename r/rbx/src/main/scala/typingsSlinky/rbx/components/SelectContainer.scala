...
object SelectContainer {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: SelectContainer.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
