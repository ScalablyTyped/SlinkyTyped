...
object ButtonGroup {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ButtonGroup.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
