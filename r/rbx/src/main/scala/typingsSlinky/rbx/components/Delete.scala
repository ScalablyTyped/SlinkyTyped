...
object Delete {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Delete.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
