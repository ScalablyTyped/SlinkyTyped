...
object MessageHeader {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: MessageHeader.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
