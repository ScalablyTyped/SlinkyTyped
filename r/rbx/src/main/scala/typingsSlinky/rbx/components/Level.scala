...
object Level {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Level.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
