...
object PanelHeading {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: PanelHeading.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
