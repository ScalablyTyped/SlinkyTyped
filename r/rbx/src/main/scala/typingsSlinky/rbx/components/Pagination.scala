...
object Pagination {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Pagination.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
