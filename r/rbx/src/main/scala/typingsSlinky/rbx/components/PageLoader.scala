...
object PageLoader {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: PageLoader.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
