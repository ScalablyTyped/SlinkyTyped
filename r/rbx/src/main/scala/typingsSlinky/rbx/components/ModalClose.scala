...
object ModalClose {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ModalClose.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
