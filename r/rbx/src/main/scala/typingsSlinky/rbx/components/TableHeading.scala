...
object TableHeading {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: TableHeading.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
