...
object Box {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Box.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
