...
object DropdownTrigger {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: DropdownTrigger.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
