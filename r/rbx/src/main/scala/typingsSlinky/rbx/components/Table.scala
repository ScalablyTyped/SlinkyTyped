...
object Table {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Table.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
