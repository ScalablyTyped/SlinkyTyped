...
object Hero {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Hero.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
