...
object NavbarLink {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: NavbarLink.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
