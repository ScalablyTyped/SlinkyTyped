...
typingsSlinky.rbx.anon.As[TAsComponent] with typingsSlinky.rbx.navbarLinkMod.NavbarLinkProps, 
...
object NavbarLink {
  ...
  def apply[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](
    p: (Prefer[As[TAsComponent] with NavbarLinkProps, ComponentProps[TAsComponent]]) with (RefAttributes[TAsComponent | FromReactType[TAsComponent]])
  ): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](companion: NavbarLink.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
