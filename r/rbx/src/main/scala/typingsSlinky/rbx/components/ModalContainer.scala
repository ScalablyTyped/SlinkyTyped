...
object ModalContainer {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.rbx.modalContainerMod.ModalContainer] {
  ...
  def withProps(p: ModalContainerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ModalContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
