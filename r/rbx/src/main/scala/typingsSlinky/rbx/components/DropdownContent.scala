...
object DropdownContent {
  ...
  implicit def make[/* <: typingsSlinky.react.mod.ReactType[js.Any] */ TAsComponent](companion: DropdownContent.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
