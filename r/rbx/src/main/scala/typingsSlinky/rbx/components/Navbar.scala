...
object Navbar {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Navbar.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
