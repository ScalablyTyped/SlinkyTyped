...
object Control {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Control.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
