...
object PanelTabGroup {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: PanelTabGroup.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
