...
object ImageContainer {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: ImageContainer.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
