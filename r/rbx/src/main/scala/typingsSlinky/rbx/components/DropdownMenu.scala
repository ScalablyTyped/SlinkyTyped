...
object DropdownMenu {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: DropdownMenu.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
