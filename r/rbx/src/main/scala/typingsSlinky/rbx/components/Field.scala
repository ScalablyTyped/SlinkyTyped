...
object Field {
  ...
  implicit def make[TAsComponent /* <: ReactElement */](companion: Field.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
