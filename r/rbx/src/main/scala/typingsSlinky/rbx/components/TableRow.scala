...
object TableRow {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: TableRow.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
