...
object Numeric {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Numeric.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
