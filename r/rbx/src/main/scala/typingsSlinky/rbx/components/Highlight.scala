...
object Highlight {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: Highlight.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
