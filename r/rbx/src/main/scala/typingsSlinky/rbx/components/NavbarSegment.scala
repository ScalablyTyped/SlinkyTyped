...
object NavbarSegment {
  ...
  implicit def make[TAsComponent /* <: ReactType[js.Any] */](companion: NavbarSegment.type): Builder[TAsComponent] = new Builder[TAsComponent](js.Array(this.component, js.Dictionary.empty))()
}
