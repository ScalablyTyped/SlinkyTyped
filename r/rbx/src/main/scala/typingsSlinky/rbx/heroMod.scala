...
@JSImport("rbx/layout/hero", JSImport.Namespace)
@js.native
object heroMod extends js.Object {
  @js.native
  object Hero extends js.Object {
    ...
    def apply[TAsComponent /* <: ReactElement */](
      props: Anon7[TAsComponent] with HelpersPropsOverrides with PickBadgeHelpersPropsFloa with HeroModifierProps with (Pick[
