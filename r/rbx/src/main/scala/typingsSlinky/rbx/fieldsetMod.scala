...
object fieldsetMod {
  ...
  object FieldsetModifierProps {
    ...
    @scala.inline
    implicit class FieldsetModifierPropsMutableBuilder[Self <: FieldsetModifierProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/form/fieldset.FieldsetModifierProps */
  @js.native
