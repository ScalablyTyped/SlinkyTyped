...
trait PickDropdownContainerProp extends js.Object {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typingsSlinky.rbx.rbxStrings.PickDropdownContainerProp with TopLevel[js.Any]
  ] = js.native
...
object PickDropdownContainerProp {
  @scala.inline
  def apply(): PickDropdownContainerProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickDropdownContainerProp]
  }
  @scala.inline
  implicit class PickDropdownContainerPropOps[Self <: PickDropdownContainerProp] (val x: Self) extends AnyVal {
    @scala.inline
