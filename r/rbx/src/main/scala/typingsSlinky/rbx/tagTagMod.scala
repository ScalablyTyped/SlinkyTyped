...
object tagTagMod {
  ...
  object TAG_DEFAULTS {
    ...
    @JSImport("rbx/elements/tag/tag", "TAG_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/tag/tag", "TAG_DEFAULTS.sizes")
    @js.native
    def sizes: js.Tuple3[normal, medium, large] = js.native
    @scala.inline
    def sizes_=(x: js.Tuple3[normal, medium, large]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object Tag {
    ...
    @JSImport("rbx/elements/tag/tag", "Tag")
    @js.native
    ...
    @JSImport("rbx/elements/tag/tag", "Tag.Group")
    @js.native
    def Group: ForwardRefAsExoticComponent[TagGroupProps, ReactElement] = js.native
    @scala.inline
    def Group_=(x: ForwardRefAsExoticComponent[TagGroupProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/tag/tag", "Tag.defaultProps")
    @js.native
    ...
    @JSImport("rbx/elements/tag/tag", "Tag.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/tag/tag", "Tag.$$typeof")
    @js.native
  ...
  @js.native
  trait TagModifierProps extends StObject {
  ...
  object TagModifierProps {
    ...
    @scala.inline
    implicit class TagModifierPropsMutableBuilder[Self <: TagModifierProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSize(value: normal | medium | large): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/tag/tag.TagModifierProps */
  @js.native
  ...
  @js.native
  trait TagVariables extends StObject {
  ...
  object TagVariables {
    ...
    @scala.inline
    implicit class TagVariablesMutableBuilder[Self <: TagVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setSizes(value: normal | medium | large): Self = StObject.set(x, "sizes", value.asInstanceOf[js.Any])
    }
  }
  
  @js.native
  trait TagVariablesDefaults extends StObject {
  ...
  object TagVariablesDefaults {
    ...
    @scala.inline
    implicit class TagVariablesDefaultsMutableBuilder[Self <: TagVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait TagVariablesOverrides extends StObject
}
