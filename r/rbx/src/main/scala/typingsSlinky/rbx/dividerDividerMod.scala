...
object dividerDividerMod {
  ...
  object DividerModifierProps {
    ...
    @scala.inline
    implicit class DividerModifierPropsMutableBuilder[Self <: DividerModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setChildren(value: String | Double): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/layout/divider/divider.DividerModifierProps */
  @js.native
