...
object heroBodyMod {
  ...
  @JSImport("rbx/layout/hero/hero-body", "HeroBody")
  @js.native
  val HeroBody: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  
  /* Inlined rbx.rbx/base/helpers.HelpersProps */
  @js.native
  trait HeroBodyProps extends StObject {
  ...
  object HeroBodyProps {
    
    @scala.inline
    def apply(): HeroBodyProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HeroBodyProps]
    }
    
    @scala.inline
    implicit class HeroBodyPropsMutableBuilder[Self <: HeroBodyProps] (val x: Self) extends AnyVal {
