...
/* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/navbar/navbar-dropdown.NavbarDropdownModifierProps */
@js.native
trait NavbarDropdownProps extends js.Object {
...
object NavbarDropdownProps {
  ...
  @scala.inline
  def apply(): NavbarDropdownProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavbarDropdownProps]
  }
  
  @scala.inline
  implicit class NavbarDropdownPropsOps[Self <: NavbarDropdownProps] (val x: Self) extends AnyVal {
