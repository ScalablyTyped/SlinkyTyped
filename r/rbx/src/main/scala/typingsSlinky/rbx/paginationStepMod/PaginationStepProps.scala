...
@js.native
trait PaginationStepProps extends js.Object {
...
object PaginationStepProps {
  @scala.inline
  def apply(align: next | previous): PaginationStepProps = {
    val __obj = js.Dynamic.literal(align = align.asInstanceOf[js.Any])
    __obj.asInstanceOf[PaginationStepProps]
  }
  @scala.inline
  implicit class PaginationStepPropsOps[Self <: PaginationStepProps] (val x: Self) extends AnyVal {
    @scala.inline
