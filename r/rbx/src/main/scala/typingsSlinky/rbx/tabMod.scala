...
object tabMod {
  ...
  object Tab {
    ...
    @JSImport("rbx/components/tab", "Tab")
    @js.native
    ...
    @JSImport("rbx/components/tab", "Tab.Group")
    @js.native
    ...
    @JSImport("rbx/components/tab", "Tab.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/tab", "Tab.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/tab", "Tab.$$typeof")
    @js.native
