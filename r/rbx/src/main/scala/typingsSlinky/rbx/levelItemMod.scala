...
object levelItemMod {
  ...
  @js.native
  val LevelItem: ForwardRefAsExoticComponent[LevelItemProps, ReactElement] = js.native
  ...
  object LevelItemModifierProps {
    ...
    @scala.inline
    implicit class LevelItemModifierPropsMutableBuilder[Self <: LevelItemModifierProps] (val x: Self) extends AnyVal {
  ...
  object LevelItemProps {
    ...
    @scala.inline
    def apply(): LevelItemProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LevelItemProps]
    }
    
    @scala.inline
    implicit class LevelItemPropsMutableBuilder[Self <: LevelItemProps] (val x: Self) extends AnyVal {
  ...
  object LevelItemVariables {
    ...
    @scala.inline
    implicit class LevelItemVariablesMutableBuilder[Self <: LevelItemVariables] (val x: Self) extends AnyVal {
  ...
  object LevelItemVariablesDefaults {
    ...
    @scala.inline
    implicit class LevelItemVariablesDefaultsMutableBuilder[Self <: LevelItemVariablesDefaults] (val x: Self) extends AnyVal {
