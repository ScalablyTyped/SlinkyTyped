...
import typingsSlinky.rbx.rbxStrings.bordered
...
import typingsSlinky.rbx.rbxStrings.striped
import typingsSlinky.rbx.rbxStrings.success
import typingsSlinky.rbx.rbxStrings.tbody
...
import typingsSlinky.rbx.tableRowMod.TableRowProps
...
object tableTableMod {
  ...
  object Table {
    ...
    @scala.inline
    def Body_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, tbody]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Body")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/table/table", "Table.Cell")
    @js.native
    def Cell: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
    @scala.inline
    def Cell_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Cell")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def Row: ForwardRefAsExoticComponent[TableRowProps, ReactElement] = js.native
    @scala.inline
    def Row_=(x: ForwardRefAsExoticComponent[TableRowProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Row")(x.asInstanceOf[js.Any])
  ...
  object TableModifierProps {
    ...
    @scala.inline
    implicit class TableModifierPropsMutableBuilder[Self <: TableModifierProps] (val x: Self) extends AnyVal {
