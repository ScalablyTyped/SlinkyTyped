package typingsSlinky.rbx.paginationEllipsisMod
...
@js.native
trait PaginationEllipsisProps extends js.Object {
...
object PaginationEllipsisProps {
  ...
  @scala.inline
  implicit class PaginationEllipsisPropsOps[Self <: PaginationEllipsisProps] (val x: Self) extends AnyVal {
    @scala.inline
