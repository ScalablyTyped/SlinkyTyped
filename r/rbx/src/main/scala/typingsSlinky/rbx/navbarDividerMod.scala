...
object navbarDividerMod {
  ...
  @JSImport("rbx/components/navbar/navbar-divider", "NavbarDivider")
  @js.native
  val NavbarDivider: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  
  /* Inlined rbx.rbx/base/helpers.HelpersProps */
  @js.native
  trait NavbarDividerProps extends StObject {
  ...
  object NavbarDividerProps {
    ...
    @scala.inline
    implicit class NavbarDividerPropsMutableBuilder[Self <: NavbarDividerProps] (val x: Self) extends AnyVal {
