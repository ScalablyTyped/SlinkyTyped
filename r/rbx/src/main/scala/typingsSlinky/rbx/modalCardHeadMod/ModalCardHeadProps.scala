package typingsSlinky.rbx.modalCardHeadMod
...
@js.native
trait ModalCardHeadProps extends js.Object {
...
object ModalCardHeadProps {
  ...
  @scala.inline
  implicit class ModalCardHeadPropsOps[Self <: ModalCardHeadProps] (val x: Self) extends AnyVal {
    @scala.inline
