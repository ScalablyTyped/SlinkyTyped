...
/* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/navbar/navbar-link.NavbarLinkModifierProps */
@js.native
trait NavbarLinkProps extends js.Object {
