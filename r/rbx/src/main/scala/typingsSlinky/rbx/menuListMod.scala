...
object menuListMod {
  ...
  object MenuList {
    ...
    @js.native
    def Item: ForwardRefAsExoticComponent[MenuListItemProps, ReactElement] = js.native
    @scala.inline
    def Item_=(x: ForwardRefAsExoticComponent[MenuListItemProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
