package typingsSlinky.rbx.dropdownContentMod
...
@js.native
trait DropdownContentProps extends js.Object {
...
object DropdownContentProps {
  
  @scala.inline
  def apply(): DropdownContentProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DropdownContentProps]
  }
  
  @scala.inline
  implicit class DropdownContentPropsOps[Self <: DropdownContentProps] (val x: Self) extends AnyVal {
