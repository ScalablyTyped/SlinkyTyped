...
object cardFooterMod {
  ...
  object CardFooter {
    ...
    @JSImport("rbx/components/card/card-footer", "CardFooter")
    @js.native
    ...
    @JSImport("rbx/components/card/card-footer", "CardFooter.Item")
    @js.native
    def Item: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
    @scala.inline
    def Item_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card/card-footer", "CardFooter.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/card/card-footer", "CardFooter.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card/card-footer", "CardFooter.$$typeof")
    @js.native
  ...
  @js.native
  trait CardFooterProps extends StObject {
