...
object messageBodyMod {
  
  @JSImport("rbx/components/message/message-body", "MessageBody")
  @js.native
  val MessageBody: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object MessageBodyProps {
    ...
    @scala.inline
    implicit class MessageBodyPropsMutableBuilder[Self <: MessageBodyProps] (val x: Self) extends AnyVal {
