...
object fieldMod {
  ...
  object Field {
    ...
    @js.native
    def Label: ForwardRefAsExoticComponent[FieldLabelProps, ReactElement] = js.native
    @scala.inline
    def Label_=(x: ForwardRefAsExoticComponent[FieldLabelProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Label")(x.asInstanceOf[js.Any])
