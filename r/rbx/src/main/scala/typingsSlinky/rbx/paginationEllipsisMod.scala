...
object paginationEllipsisMod {
  ...
  @js.native
  val PaginationEllipsis: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object PaginationEllipsisProps {
    ...
    @scala.inline
    implicit class PaginationEllipsisPropsMutableBuilder[Self <: PaginationEllipsisProps] (val x: Self) extends AnyVal {
