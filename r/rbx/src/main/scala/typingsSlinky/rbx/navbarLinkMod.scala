...
object navbarLinkMod {
  
  @JSImport("rbx/components/navbar/navbar-link", "NavbarLink")
  @js.native
  val NavbarLink: ForwardRefAsExoticComponent[NavbarLinkProps, ReactElement] = js.native
  ...
  object NavbarLinkModifierProps {
    ...
    @scala.inline
    implicit class NavbarLinkModifierPropsMutableBuilder[Self <: NavbarLinkModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setArrowless(value: Boolean): Self = StObject.set(x, "arrowless", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setArrowlessUndefined: Self = StObject.set(x, "arrowless", js.undefined)
