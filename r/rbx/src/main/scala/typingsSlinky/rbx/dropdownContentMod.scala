...
object dropdownContentMod {
  ...
  @js.native
  val DropdownContent: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object DropdownContentProps {
    ...
    @scala.inline
    implicit class DropdownContentPropsMutableBuilder[Self <: DropdownContentProps] (val x: Self) extends AnyVal {
