...
object Select {
  ...
  @js.native
  def Container: ForwardRefAsExoticComponent[SelectContainerProps, ReactElement] = js.native
  @scala.inline
  def Container_=(x: ForwardRefAsExoticComponent[SelectContainerProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Container")(x.asInstanceOf[js.Any])
  
  @JSImport("rbx", "Select.Option")
  @js.native
  def Option: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
  @scala.inline
  def Option_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Option")(x.asInstanceOf[js.Any])
