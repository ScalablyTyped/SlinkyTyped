...
object File {
  ...
  @JSImport("rbx", "File.CTA")
  @js.native
  def CTA: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
  @scala.inline
  def CTA_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CTA")(x.asInstanceOf[js.Any])
  
  @JSImport("rbx", "File.Icon")
  @js.native
  ...
  @JSImport("rbx", "File.Input")
  @js.native
  def Input: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
  @scala.inline
  def Input_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Input")(x.asInstanceOf[js.Any])
  
  @JSImport("rbx", "File.Label")
  @js.native
  ...
  @JSImport("rbx", "File.Name")
  @js.native
  def Name: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
  @scala.inline
  def Name_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Name")(x.asInstanceOf[js.Any])
  
  @JSImport("rbx", "File.defaultProps")
  @js.native
  ...
  @JSImport("rbx", "File.displayName")
  @js.native
  def displayName: js.UndefOr[String] = js.native
  @scala.inline
  def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("rbx", "File.$$typeof")
  @js.native
