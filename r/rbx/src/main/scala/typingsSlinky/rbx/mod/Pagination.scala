...
object Pagination {
  ...
  @JSImport("rbx", "Pagination.Ellipsis")
  @js.native
  ...
  @JSImport("rbx", "Pagination.defaultProps")
  @js.native
  ...
  @JSImport("rbx", "Pagination.displayName")
  @js.native
  def displayName: js.UndefOr[String] = js.native
  @scala.inline
  def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("rbx", "Pagination.$$typeof")
  @js.native
