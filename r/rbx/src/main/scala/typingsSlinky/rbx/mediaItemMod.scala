...
object mediaItemMod {
  ...
  object MEDIA_ITEM_DEFAULTS {
    
    @JSImport("rbx/components/media/media-item", "MEDIA_ITEM_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/media/media-item", "MEDIA_ITEM_DEFAULTS.alignments")
    @js.native
    def alignments: js.Tuple3[content, left, right] = js.native
    @scala.inline
    def alignments_=(x: js.Tuple3[content, left, right]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("rbx/components/media/media-item", "MediaItem")
  @js.native
  val MediaItem: ForwardRefAsExoticComponent[MediaItemProps, ReactElement] = js.native
  ...
  object MediaItemModifierProps {
    ...
    @scala.inline
    implicit class MediaItemModifierPropsMutableBuilder[Self <: MediaItemModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlign(value: content | left | right): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/media/media-item.MediaItemModifierProps */
  @js.native
  ...
  object MediaItemProps {
    ...
    @scala.inline
    def apply(): MediaItemProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MediaItemProps]
    }
    
    @scala.inline
    implicit class MediaItemPropsMutableBuilder[Self <: MediaItemProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait MediaItemVariables extends StObject {
  ...
  object MediaItemVariables {
    ...
    @scala.inline
    implicit class MediaItemVariablesMutableBuilder[Self <: MediaItemVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlignments(value: content | left | right): Self = StObject.set(x, "alignments", value.asInstanceOf[js.Any])
    }
  }
  
  @js.native
  trait MediaItemVariablesDefaults extends StObject {
  ...
  object MediaItemVariablesDefaults {
    ...
    @scala.inline
    implicit class MediaItemVariablesDefaultsMutableBuilder[Self <: MediaItemVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait MediaItemVariablesOverrides extends StObject
}
