...
object messageMessageMod {
  ...
  object MessageModifierProps {
    ...
    @scala.inline
    implicit class MessageModifierPropsMutableBuilder[Self <: MessageModifierProps] (val x: Self) extends AnyVal {
  ...
  object MessageVariables {
    ...
    @scala.inline
    implicit class MessageVariablesMutableBuilder[Self <: MessageVariables] (val x: Self) extends AnyVal {
  ...
  object MessageVariablesDefaults {
    ...
    @scala.inline
    implicit class MessageVariablesDefaultsMutableBuilder[Self <: MessageVariablesDefaults] (val x: Self) extends AnyVal {
