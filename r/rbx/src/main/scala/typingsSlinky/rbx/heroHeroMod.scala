...
object heroHeroMod {
  ...
  object HERO_DEFAULTS {
    
    @JSImport("rbx/layout/hero/hero", "HERO_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/layout/hero/hero", "HERO_DEFAULTS.sizes")
    @js.native
    def sizes: js.Tuple5[small, medium, large, fullheight, `fullheight-with-navbar`] = js.native
    @scala.inline
    def sizes_=(x: js.Tuple5[small, medium, large, fullheight, `fullheight-with-navbar`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object Hero {
    ...
    @JSImport("rbx/layout/hero/hero", "Hero.Body")
    @js.native
    ...
    @JSImport("rbx/layout/hero/hero", "Hero.Foot")
    @js.native
    def Foot: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
    @scala.inline
    def Foot_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Foot")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/layout/hero/hero", "Hero.Head")
    @js.native
    def Head: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement] = js.native
    @scala.inline
    def Head_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Head")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/layout/hero/hero", "Hero.defaultProps")
    @js.native
    ...
    @JSImport("rbx/layout/hero/hero", "Hero.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/layout/hero/hero", "Hero.$$typeof")
    @js.native
  ...
  object HeroModifierProps {
    ...
    @scala.inline
    implicit class HeroModifierPropsMutableBuilder[Self <: HeroModifierProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSize(value: small | medium | large | fullheight | `fullheight-with-navbar`): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/layout/hero/hero.HeroModifierProps */
  @js.native
  trait HeroProps extends StObject {
    ...
    var textSize: js.UndefOr[`1` | `2` | `3` | `4` | `5` | typingsSlinky.rbx.rbxNumbers.`6` | `7`] = js.native
  ...
  object HeroProps {
    ...
    @scala.inline
    implicit class HeroPropsMutableBuilder[Self <: HeroProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTextSize(value: `1` | `2` | `3` | `4` | `5` | typingsSlinky.rbx.rbxNumbers.`6` | `7`): Self = StObject.set(x, "textSize", value.asInstanceOf[js.Any])
  ...
  @js.native
  trait HeroVariables extends StObject {
  ...
  object HeroVariables {
    ...
    @scala.inline
    implicit class HeroVariablesMutableBuilder[Self <: HeroVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setSizes(value: small | medium | large | fullheight | `fullheight-with-navbar`): Self = StObject.set(x, "sizes", value.asInstanceOf[js.Any])
    }
  }
  
  @js.native
  trait HeroVariablesDefaults extends StObject {
  ...
  object HeroVariablesDefaults {
    ...
    @scala.inline
    implicit class HeroVariablesDefaultsMutableBuilder[Self <: HeroVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait HeroVariablesOverrides extends StObject
}
