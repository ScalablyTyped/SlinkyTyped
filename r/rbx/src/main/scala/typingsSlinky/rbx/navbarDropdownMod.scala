...
object navbarDropdownMod {
  
  object NAVBAR_DROPDOWN_DEFAULTS {
    
    @JSImport("rbx/components/navbar/navbar-dropdown", "NAVBAR_DROPDOWN_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/navbar/navbar-dropdown", "NAVBAR_DROPDOWN_DEFAULTS.alignments")
    @js.native
  ...
  @js.native
  val NavbarDropdown: ForwardRefAsExoticComponent[NavbarDropdownProps, ReactElement] = js.native
  ...
  object NavbarDropdownModifierProps {
    ...
    @scala.inline
    implicit class NavbarDropdownModifierPropsMutableBuilder[Self <: NavbarDropdownModifierProps] (val x: Self) extends AnyVal {
  ...
  object NavbarDropdownProps {
    ...
    @scala.inline
    implicit class NavbarDropdownPropsMutableBuilder[Self <: NavbarDropdownProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait NavbarDropdownVariables extends StObject {
  ...
  object NavbarDropdownVariables {
    ...
    @scala.inline
    implicit class NavbarDropdownVariablesMutableBuilder[Self <: NavbarDropdownVariables] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait NavbarDropdownVariablesDefaults extends StObject {
  ...
  object NavbarDropdownVariablesDefaults {
    ...
    @scala.inline
    implicit class NavbarDropdownVariablesDefaultsMutableBuilder[Self <: NavbarDropdownVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait NavbarDropdownVariablesOverrides extends StObject
}
