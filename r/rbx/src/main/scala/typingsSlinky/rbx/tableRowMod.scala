...
object tableRowMod {
  ...
  @js.native
  val TableRow: ForwardRefAsExoticComponent[TableRowProps, ReactElement] = js.native
  ...
  object TableRowHelperProps {
    ...
    @scala.inline
    implicit class TableRowHelperPropsMutableBuilder[Self <: TableRowHelperProps] (val x: Self) extends AnyVal {
