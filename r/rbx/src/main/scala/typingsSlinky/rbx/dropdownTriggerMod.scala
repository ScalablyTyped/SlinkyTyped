...
object dropdownTriggerMod {
  
  @JSImport("rbx/components/dropdown/dropdown-trigger", "DropdownTrigger")
  @js.native
  val DropdownTrigger: ForwardRefAsExoticComponent[DropdownTriggerProps, ReactElement] = js.native
  ...
  object DropdownTriggerModifierProps {
    ...
    @scala.inline
    implicit class DropdownTriggerModifierPropsMutableBuilder[Self <: DropdownTriggerModifierProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/dropdown/dropdown-trigger.DropdownTriggerModifierProps */
  @js.native
  ...
  object DropdownTriggerProps {
    ...
    @scala.inline
    def apply(): DropdownTriggerProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DropdownTriggerProps]
    }
    
    @scala.inline
    implicit class DropdownTriggerPropsMutableBuilder[Self <: DropdownTriggerProps] (val x: Self) extends AnyVal {
