...
object exoticMod extends js.Object {
  ...
  trait ForwardRefAsExoticComponent[TOwnProps, TDefaultComponent /* <: ReactComponentClass[_] */] extends js.Object {
    ...
    def apply[TAsComponent /* <: ReactComponentClass[_] */](
      props: (Prefer[AnonAs[TAsComponent] with TOwnProps, ComponentProps[TAsComponent]]) with (RefAttributes[TAsComponent | FromReactType[TAsComponent]])
  ...
  type FromReactType[T /* <: ReactComponentClass[_] */] = T | js.Any
}
