...
object fieldBodyMod {
  ...
  @js.native
  val FieldBody: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object FieldBodyProps {
    ...
    @scala.inline
    def apply(): FieldBodyProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FieldBodyProps]
    }
    
    @scala.inline
    implicit class FieldBodyPropsMutableBuilder[Self <: FieldBodyProps] (val x: Self) extends AnyVal {
