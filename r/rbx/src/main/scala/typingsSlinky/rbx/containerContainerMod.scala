...
object containerContainerMod {
  ...
  object ContainerModifierProps {
    ...
    @scala.inline
    implicit class ContainerModifierPropsMutableBuilder[Self <: ContainerModifierProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/container/container.ContainerModifierProps */
  @js.native
