...
object menuListItemMod {
  
  @JSImport("rbx/components/menu/menu-list-item", "MenuListItem")
  @js.native
  val MenuListItem: ForwardRefAsExoticComponent[MenuListItemProps, ReactElement] = js.native
  ...
  object MenuListItemModifierProps {
    ...
    @scala.inline
    implicit class MenuListItemModifierPropsMutableBuilder[Self <: MenuListItemModifierProps] (val x: Self) extends AnyVal {
  ...
  object MenuListItemProps {
    ...
    @scala.inline
    implicit class MenuListItemPropsMutableBuilder[Self <: MenuListItemProps] (val x: Self) extends AnyVal {
