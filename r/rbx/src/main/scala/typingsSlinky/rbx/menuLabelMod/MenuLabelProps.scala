package typingsSlinky.rbx.menuLabelMod
...
@js.native
trait MenuLabelProps extends js.Object {
...
object MenuLabelProps {
  ...
  @scala.inline
  implicit class MenuLabelPropsOps[Self <: MenuLabelProps] (val x: Self) extends AnyVal {
    @scala.inline
