...
object sectionSectionMod {
  ...
  object SECTION_DEFAULTS {
    ...
    @scala.inline
    def sizes_=(x: js.Tuple2[medium, large]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object SectionModifierProps {
    ...
    @scala.inline
    implicit class SectionModifierPropsMutableBuilder[Self <: SectionModifierProps] (val x: Self) extends AnyVal {
  ...
  object SectionProps {
    ...
    @scala.inline
    def apply(): SectionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SectionProps]
    }
    
    @scala.inline
    implicit class SectionPropsMutableBuilder[Self <: SectionProps] (val x: Self) extends AnyVal {
  ...
  object SectionVariables {
    ...
    @scala.inline
    implicit class SectionVariablesMutableBuilder[Self <: SectionVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setSizes(value: medium | large): Self = StObject.set(x, "sizes", value.asInstanceOf[js.Any])
    }
  }
  ...
  object SectionVariablesDefaults {
    ...
    @scala.inline
    implicit class SectionVariablesDefaultsMutableBuilder[Self <: SectionVariablesDefaults] (val x: Self) extends AnyVal {
