...
object paginationStepMod {
  ...
  object PAGINATION_STEP_DEFAULTS {
    ...
    @scala.inline
    def alignments_=(x: js.Tuple2[next, previous]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("rbx/components/pagination/pagination-step", "PaginationStep")
  @js.native
  val PaginationStep: ForwardRefAsExoticComponent[PaginationStepProps, ReactElement] = js.native
  ...
  object PaginationStepModifierProps {
    ...
    @scala.inline
    implicit class PaginationStepModifierPropsMutableBuilder[Self <: PaginationStepModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlign(value: next | previous): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
    }
  }
  ...
  object PaginationStepProps {
    ...
    @scala.inline
    implicit class PaginationStepPropsMutableBuilder[Self <: PaginationStepProps] (val x: Self) extends AnyVal {
  ...
  object PaginationStepVariables {
    ...
    @scala.inline
    implicit class PaginationStepVariablesMutableBuilder[Self <: PaginationStepVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlignments(value: next | previous): Self = StObject.set(x, "alignments", value.asInstanceOf[js.Any])
    }
  }
  ...
  object PaginationStepVariablesDefaults {
    ...
    @scala.inline
    implicit class PaginationStepVariablesDefaultsMutableBuilder[Self <: PaginationStepVariablesDefaults] (val x: Self) extends AnyVal {
