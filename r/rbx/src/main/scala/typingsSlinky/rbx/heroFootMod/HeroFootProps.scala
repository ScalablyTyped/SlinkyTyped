package typingsSlinky.rbx.heroFootMod
...
@js.native
trait HeroFootProps extends js.Object {
...
object HeroFootProps {
  ...
  @scala.inline
  implicit class HeroFootPropsOps[Self <: HeroFootProps] (val x: Self) extends AnyVal {
