package typingsSlinky.rbx.panelIconMod
...
@js.native
trait PanelIconProps extends js.Object {
...
object PanelIconProps {
  @scala.inline
  def apply(): PanelIconProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PanelIconProps]
  }
  @scala.inline
  implicit class PanelIconPropsOps[Self <: PanelIconProps] (val x: Self) extends AnyVal {
    @scala.inline
