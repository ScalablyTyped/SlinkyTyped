...
object dropdownItemMod {
  ...
  @js.native
  val DropdownItem: ForwardRefAsExoticComponent[DropdownItemProps, ReactElement] = js.native
  ...
  object DropdownItemModifierProps {
    ...
    @scala.inline
    implicit class DropdownItemModifierPropsMutableBuilder[Self <: DropdownItemModifierProps] (val x: Self) extends AnyVal {
