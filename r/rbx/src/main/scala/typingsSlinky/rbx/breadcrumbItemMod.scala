...
object breadcrumbItemMod {
  ...
  @js.native
  val BreadcrumbItem: ForwardRefAsExoticComponent[BreadcrumbItemProps, ReactElement] = js.native
  ...
  object BreadcrumbItemModifierProps {
    ...
    @scala.inline
    implicit class BreadcrumbItemModifierPropsMutableBuilder[Self <: BreadcrumbItemModifierProps] (val x: Self) extends AnyVal {
