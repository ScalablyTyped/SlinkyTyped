package typingsSlinky.rbx.messageBodyMod
...
@js.native
trait MessageBodyProps extends js.Object {
...
object MessageBodyProps {
  @scala.inline
  def apply(): MessageBodyProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MessageBodyProps]
  }
  @scala.inline
  implicit class MessageBodyPropsOps[Self <: MessageBodyProps] (val x: Self) extends AnyVal {
    @scala.inline
