package typingsSlinky.rbx.paginationListMod
...
@js.native
trait PaginationListProps extends js.Object {
...
object PaginationListProps {
  @scala.inline
  def apply(): PaginationListProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PaginationListProps]
  }
  @scala.inline
  implicit class PaginationListPropsOps[Self <: PaginationListProps] (val x: Self) extends AnyVal {
    @scala.inline
