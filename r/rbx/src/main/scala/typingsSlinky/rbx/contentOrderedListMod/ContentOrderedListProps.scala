...
@js.native
trait ContentOrderedListProps extends js.Object {
...
object ContentOrderedListProps {
  @scala.inline
  def apply(): ContentOrderedListProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ContentOrderedListProps]
  }
  @scala.inline
  implicit class ContentOrderedListPropsOps[Self <: ContentOrderedListProps] (val x: Self) extends AnyVal {
    @scala.inline
