...
object heroFootMod {
  ...
  @js.native
  val HeroFoot: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object HeroFootProps {
    
    @scala.inline
    def apply(): HeroFootProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HeroFootProps]
    }
    
    @scala.inline
    implicit class HeroFootPropsMutableBuilder[Self <: HeroFootProps] (val x: Self) extends AnyVal {
