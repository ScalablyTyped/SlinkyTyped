...
object tableFootMod {
  ...
  @js.native
  val TableFoot: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object TableFootProps {
    
    @scala.inline
    def apply(): TableFootProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TableFootProps]
    }
    
    @scala.inline
    implicit class TableFootPropsMutableBuilder[Self <: TableFootProps] (val x: Self) extends AnyVal {
