...
object buttonButtonMod {
  ...
  object BUTTON_DEFAULTS {
    ...
    @scala.inline
    def sizes_=(x: js.Tuple4[small, normal, medium, large]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/button/button", "BUTTON_DEFAULTS.states")
    @js.native
    def states: js.Tuple4[hovered, focused, active, loading] = js.native
    @scala.inline
    def states_=(x: js.Tuple4[hovered, focused, active, loading]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("states")(x.asInstanceOf[js.Any])
  }
  ...
  object Button {
    ...
    @js.native
    def Group: ForwardRefAsExoticComponent[ButtonGroupProps, ReactElement] = js.native
    @scala.inline
    def Group_=(x: ForwardRefAsExoticComponent[ButtonGroupProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
  ...
  object ButtonModifierProps {
    ...
    @scala.inline
    implicit class ButtonModifierPropsMutableBuilder[Self <: ButtonModifierProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSize(value: small | normal | medium | large): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSizeUndefined: Self = StObject.set(x, "size", js.undefined)
      
      @scala.inline
      def setState(value: hovered | focused | active | loading): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
  ...
  object ButtonVariables {
    ...
    @scala.inline
    implicit class ButtonVariablesMutableBuilder[Self <: ButtonVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setSizes(value: small | normal | medium | large): Self = StObject.set(x, "sizes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStates(value: hovered | focused | active | loading): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ButtonVariablesDefaults {
    ...
    @scala.inline
    implicit class ButtonVariablesDefaultsMutableBuilder[Self <: ButtonVariablesDefaults] (val x: Self) extends AnyVal {
