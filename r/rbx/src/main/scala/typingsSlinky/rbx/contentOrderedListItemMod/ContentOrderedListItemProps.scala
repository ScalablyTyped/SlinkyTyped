package typingsSlinky.rbx.contentOrderedListItemMod
...
@js.native
trait ContentOrderedListItemProps extends js.Object {
...
object ContentOrderedListItemProps {
  @scala.inline
  def apply(): ContentOrderedListItemProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ContentOrderedListItemProps]
  }
  @scala.inline
  implicit class ContentOrderedListItemPropsOps[Self <: ContentOrderedListItemProps] (val x: Self) extends AnyVal {
    @scala.inline
