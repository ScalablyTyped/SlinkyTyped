package typingsSlinky.rbx.numericMod
...
@js.native
trait NumericProps extends js.Object {
...
object NumericProps {
  ...
  @scala.inline
  def apply(): NumericProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NumericProps]
  }
  
  @scala.inline
  implicit class NumericPropsOps[Self <: NumericProps] (val x: Self) extends AnyVal {
