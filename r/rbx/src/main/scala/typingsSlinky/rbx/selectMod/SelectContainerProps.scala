...
/* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/form/select.SelectContainerModifierProps */
@js.native
trait SelectContainerProps extends js.Object {
...
object SelectContainerProps {
  @scala.inline
  def apply(): SelectContainerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SelectContainerProps]
  }
  @scala.inline
  implicit class SelectContainerPropsOps[Self <: SelectContainerProps] (val x: Self) extends AnyVal {
    @scala.inline
