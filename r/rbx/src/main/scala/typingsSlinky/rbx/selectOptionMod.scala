...
object selectOptionMod {
  ...
  @js.native
  val SelectOption: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ReactElement] = js.native
  ...
  object SelectOptionProps {
    ...
    @scala.inline
    implicit class SelectOptionPropsMutableBuilder[Self <: SelectOptionProps] (val x: Self) extends AnyVal {
