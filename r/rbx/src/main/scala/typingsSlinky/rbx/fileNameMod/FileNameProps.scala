package typingsSlinky.rbx.fileNameMod
...
@js.native
trait FileNameProps extends js.Object {
...
object FileNameProps {
  ...
  @scala.inline
  implicit class FileNamePropsOps[Self <: FileNameProps] (val x: Self) extends AnyVal {
