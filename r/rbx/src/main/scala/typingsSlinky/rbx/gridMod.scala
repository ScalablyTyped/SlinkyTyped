...
object gridMod {
  ...
  object Column {
    ...
    @JSImport("rbx/grid", "Column.Group")
    @js.native
    ...
    @JSImport("rbx/grid", "Column.defaultProps")
    @js.native
    ...
    @JSImport("rbx/grid", "Column.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/grid", "Column.$$typeof")
    @js.native
