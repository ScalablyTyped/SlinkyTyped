...
object modalBackgroundMod {
  
  @JSImport("rbx/components/modal/modal-background", "ModalBackground")
  @js.native
  val ModalBackground: ForwardRefAsExoticComponent[ModalBackgroundProps, ReactElement] = js.native
  ...
  object ModalBackgroundModifierProps {
    ...
    @scala.inline
    implicit class ModalBackgroundModifierPropsMutableBuilder[Self <: ModalBackgroundModifierProps] (val x: Self) extends AnyVal {
  ...
  object ModalBackgroundProps {
    ...
    @scala.inline
    def apply(): ModalBackgroundProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalBackgroundProps]
    }
    
    @scala.inline
    implicit class ModalBackgroundPropsMutableBuilder[Self <: ModalBackgroundProps] (val x: Self) extends AnyVal {
