package typingsSlinky.rbx.modalCardTitleMod
...
@js.native
trait ModalCardTitleProps extends js.Object {
...
object ModalCardTitleProps {
  @scala.inline
  def apply(): ModalCardTitleProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModalCardTitleProps]
  }
  @scala.inline
  implicit class ModalCardTitlePropsOps[Self <: ModalCardTitleProps] (val x: Self) extends AnyVal {
    @scala.inline
