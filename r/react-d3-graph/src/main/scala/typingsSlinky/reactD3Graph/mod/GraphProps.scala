...
object GraphProps {
  ...
  def apply[N, L](
    ...
    onRightClickLink: (/* event */ SyntheticMouseEvent[Element], /* source */ String, /* target */ String) => Unit = null,
    onRightClickNode: (/* event */ SyntheticMouseEvent[Element], /* nodeId */ String) => Unit = null
  ): GraphProps[N, L] = {
