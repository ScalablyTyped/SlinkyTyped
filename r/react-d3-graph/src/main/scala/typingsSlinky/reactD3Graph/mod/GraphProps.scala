...
object GraphProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N, /* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L](id: String): GraphProps[N, L] = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphProps[N, L]]
  }
  @scala.inline
  implicit class GraphPropsOps[Self <: GraphProps[_, _], /* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N, /* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L] (val x: Self with (GraphProps[N, L])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnClickGraph(value: /* event */ SyntheticMouseEvent[Element] => Unit): Self = this.set("onClickGraph", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnRightClickNode(value: (/* event */ SyntheticMouseEvent[Element], /* nodeId */ String) => Unit): Self = this.set("onRightClickNode", js.Any.fromFunction2(value))
    @scala.inline
