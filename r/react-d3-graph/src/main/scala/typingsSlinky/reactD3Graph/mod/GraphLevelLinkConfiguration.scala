...
object GraphLevelLinkConfiguration {
  @scala.inline
  def apply[/* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L](
    color: String,
    fontColor: String,
    fontSize: Double,
    fontWeight: String,
  ...
  @scala.inline
  implicit class GraphLevelLinkConfigurationOps[Self <: GraphLevelLinkConfiguration[_], /* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L] (val x: Self with GraphLevelLinkConfiguration[L]) extends AnyVal {
    @scala.inline
