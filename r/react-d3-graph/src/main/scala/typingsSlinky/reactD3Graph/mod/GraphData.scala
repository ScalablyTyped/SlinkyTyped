...
object GraphData {
  @scala.inline
  def apply[/* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N, /* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L](links: js.Array[L], nodes: js.Array[N]): GraphData[N, L] = {
  ...
  @scala.inline
  implicit class GraphDataOps[Self <: GraphData[_, _], /* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N, /* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L] (val x: Self with (GraphData[N, L])) extends AnyVal {
    @scala.inline
