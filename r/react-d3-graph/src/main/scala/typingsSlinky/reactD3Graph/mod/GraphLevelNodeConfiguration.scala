...
object GraphLevelNodeConfiguration {
  @scala.inline
  def apply[/* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N](
    color: String,
    fontColor: String,
    fontSize: Double,
    fontWeight: String,
  ...
  @scala.inline
  implicit class GraphLevelNodeConfigurationOps[Self <: GraphLevelNodeConfiguration[_], /* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N] (val x: Self with GraphLevelNodeConfiguration[N]) extends AnyVal {
    @scala.inline
