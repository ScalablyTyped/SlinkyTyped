...
object GraphConfiguration {
  @scala.inline
  def apply[/* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N, /* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L](
  ...
  @scala.inline
  implicit class GraphConfigurationOps[Self <: GraphConfiguration[_, _], /* <: typingsSlinky.reactD3Graph.mod.GraphNode */ N, /* <: typingsSlinky.reactD3Graph.mod.GraphLink */ L] (val x: Self with (GraphConfiguration[N, L])) extends AnyVal {
    @scala.inline
