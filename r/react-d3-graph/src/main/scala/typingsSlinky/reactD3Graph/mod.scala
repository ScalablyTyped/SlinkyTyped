package typingsSlinky.reactD3Graph

import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.raw.Element
import slinky.web.SyntheticMouseEvent
import typingsSlinky.react.mod.Component
import typingsSlinky.reactD3Graph.anon.AlphaTarget
...
object mod {
  ...
  object GraphEventCallbacks {
    ...
    implicit class GraphEventCallbacksMutableBuilder[Self <: GraphEventCallbacks] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClickGraph(value: SyntheticMouseEvent[Element] => Unit): Self = StObject.set(x, "onClickGraph", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnRightClickLink(value: (SyntheticMouseEvent[Element], String, String) => Unit): Self = StObject.set(x, "onRightClickLink", js.Any.fromFunction3(value))
      
      @scala.inline
      def setOnRightClickNode(value: (SyntheticMouseEvent[Element], String) => Unit): Self = StObject.set(x, "onRightClickNode", js.Any.fromFunction2(value))
    }
  }
  ...
  trait GraphProps[N /* <: GraphNode */, L /* <: GraphLink */] extends StObject {
    ...
    var onClickGraph: js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[Element], Unit]] = js.native
    ...
    var onRightClickNode: js.UndefOr[
        js.Function2[/* event */ SyntheticMouseEvent[Element], /* nodeId */ String, Unit]
      ] = js.native
  }
  object GraphProps {
    ...
    implicit class GraphPropsMutableBuilder[Self <: GraphProps[_, _], N /* <: GraphNode */, L /* <: GraphLink */] (val x: Self with (GraphProps[N, L])) extends AnyVal {
      ...
      @scala.inline
      def setOnClickGraph(value: /* event */ SyntheticMouseEvent[Element] => Unit): Self = StObject.set(x, "onClickGraph", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnRightClickNode(value: (/* event */ SyntheticMouseEvent[Element], /* nodeId */ String) => Unit): Self = StObject.set(x, "onRightClickNode", js.Any.fromFunction2(value))
