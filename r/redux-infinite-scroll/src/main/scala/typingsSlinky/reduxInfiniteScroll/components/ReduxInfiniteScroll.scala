package typingsSlinky.reduxInfiniteScroll.components
...
object ReduxInfiniteScroll {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def containerHeight(value: Double | String): this.type = set("containerHeight", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def elementIsScrollable(value: Boolean): this.type = set("elementIsScrollable", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def holderType(value: String): this.type = set("holderType", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def loadingMore(value: Boolean): this.type = set("loadingMore", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def showLoader(value: Boolean): this.type = set("showLoader", value.asInstanceOf[js.Any])
    @scala.inline
