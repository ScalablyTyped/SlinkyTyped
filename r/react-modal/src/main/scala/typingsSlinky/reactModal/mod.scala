...
object mod {
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAppElementHTMLElement(value: HTMLElement): Self = StObject.set(x, "appElement", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnRequestClose(value: /* event */ SyntheticMouseEvent[Element] | SyntheticKeyboardEvent[Element] => Unit): Self = StObject.set(x, "onRequestClose", js.Any.fromFunction1(value))
