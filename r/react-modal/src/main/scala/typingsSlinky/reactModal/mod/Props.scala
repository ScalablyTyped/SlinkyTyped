...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppElementHTMLElement(value: HTMLElement): Self = this.set("appElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnRequestClose(value: /* event */ SyntheticMouseEvent[Element] | SyntheticKeyboardEvent[Element] => Unit): Self = this.set("onRequestClose", js.Any.fromFunction1(value))
    @scala.inline
