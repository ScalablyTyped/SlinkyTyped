...
trait AxisDependency extends js.Object {
  var axisDependency: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.mod.AxisDependency] = js.undefined
  var scaleX: Double
  var scaleY: Double
  var xValue: Double
  var yValue: Double
...
object AxisDependency {
  ...
  def apply(
    ...
    xValue: Double,
    yValue: Double,
    axisDependency: typingsSlinky.reactNativeChartsWrapper.mod.AxisDependency = null
  ): AxisDependency = {
