...
trait Digits extends js.Object {
  ...
  var markerColor: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.mod.Color] = js.undefined
  var textColor: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.mod.Color] = js.undefined
...
object Digits {
  ...
  def apply(
    ...
    markerColor: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.mod.Color] = js.undefined,
    textColor: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.mod.Color] = js.undefined,
