...
object Digits {
  ...
  implicit class DigitsOps[Self <: Digits] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarkerColor(value: typingsSlinky.reactNativeChartsWrapper.mod.Color): Self = this.set("markerColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMarkerColor: Self = this.set("markerColor", js.undefined)
    
    @scala.inline
    def setTextColor(value: typingsSlinky.reactNativeChartsWrapper.mod.Color): Self = this.set("textColor", value.asInstanceOf[js.Any])
