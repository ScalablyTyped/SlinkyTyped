...
object Digits {
  ...
  implicit class DigitsMutableBuilder[Self <: Digits] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarkerColor(value: typingsSlinky.reactNativeChartsWrapper.mod.Color): Self = StObject.set(x, "markerColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarkerColorUndefined: Self = StObject.set(x, "markerColor", js.undefined)
    
    @scala.inline
    def setTextColor(value: typingsSlinky.reactNativeChartsWrapper.mod.Color): Self = StObject.set(x, "textColor", value.asInstanceOf[js.Any])
