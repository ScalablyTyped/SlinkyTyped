...
import typingsSlinky.reactNativeChartsWrapper.mod.AxisDependency
...
object AnonAxisDependency {
  @scala.inline
  def apply(scaleX: Double, scaleY: Double, xValue: Double, yValue: Double): AnonAxisDependency = {
  ...
  @scala.inline
  implicit class AnonAxisDependencyOps[Self <: AnonAxisDependency] (val x: Self) extends AnyVal {
    @scala.inline
