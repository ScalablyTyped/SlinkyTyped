...
trait PieChartProps extends PieRadarChartBase {
  ...
  var styledCenterText: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.anon.Color] = js.undefined
...
object PieChartProps {
  ...
  def apply(
    ...
    styledCenterText: typingsSlinky.reactNativeChartsWrapper.anon.Color = null,
    testID: String = null,
