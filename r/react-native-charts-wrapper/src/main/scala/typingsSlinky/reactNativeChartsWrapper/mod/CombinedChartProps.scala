...
object CombinedChartProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(drawBarShadow)) __obj.updateDynamic("drawBarShadow")(drawBarShadow.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(highlightFullBarEnabled)) __obj.updateDynamic("highlightFullBarEnabled")(highlightFullBarEnabled.get.asInstanceOf[js.Any])
