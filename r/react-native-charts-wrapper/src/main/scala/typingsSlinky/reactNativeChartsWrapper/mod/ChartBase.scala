...
object ChartBase {
  ...
  implicit class ChartBaseOps[Self <: ChartBase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[NodeHandle, Action] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    
    @scala.inline
    def setOnSelect(value: SyntheticEvent[NodeHandle, Y | Null] => Unit): Self = this.set("onSelect", js.Any.fromFunction1(value))
