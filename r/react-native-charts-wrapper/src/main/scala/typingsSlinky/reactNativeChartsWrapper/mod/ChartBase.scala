...
object ChartBase {
  ...
  implicit class ChartBaseMutableBuilder[Self <: ChartBase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[NodeHandle, Action] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    @scala.inline
    def setOnSelect(value: SyntheticEvent[NodeHandle, Y | Null] => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
