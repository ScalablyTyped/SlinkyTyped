...
trait ChartBase extends ViewProps {
  ...
  var onChange: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, AnonAction], Unit]] = js.undefined
  var onSelect: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, AnonY | Null], Unit]] = js.undefined
  var touchEnabled: js.UndefOr[Boolean] = js.undefined
  var xAxis: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.mod.xAxis] = js.undefined
}
