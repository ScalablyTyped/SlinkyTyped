...
trait ChartBase extends ViewProps {
  ...
  var onChange: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, Action], Unit]] = js.undefined
  var onSelect: js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, Y | Null], Unit]] = js.undefined
