...
object ScatterChartProps {
  ...
  @scala.inline
  implicit class ScatterChartPropsOps[Self <: ScatterChartProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: ScatterData): Self = this.set("data", value.asInstanceOf[js.Any])
