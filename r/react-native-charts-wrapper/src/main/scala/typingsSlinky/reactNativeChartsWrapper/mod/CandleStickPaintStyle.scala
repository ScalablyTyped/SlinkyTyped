...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.FILL
  - typingsSlinky.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.STROKE
  - typingsSlinky.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.FILL_AND_STROKE
*/
