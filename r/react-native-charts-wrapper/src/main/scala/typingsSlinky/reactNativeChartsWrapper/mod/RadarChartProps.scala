...
trait RadarChartProps extends PieRadarChartBase {
  ...
  var yAxis: js.UndefOr[typingsSlinky.reactNativeChartsWrapper.mod.yAxis] = js.undefined
}
...
object RadarChartProps {
  ...
  def apply(
    ...
    skipWebLineCount: js.UndefOr[Double] = js.undefined,
    ...
    webAlpha: js.UndefOr[Double] = js.undefined,
    webColor: js.UndefOr[Color] = js.undefined,
    webColorInner: js.UndefOr[Color] = js.undefined,
    webLineWidth: js.UndefOr[Double] = js.undefined,
    webLineWidthInner: js.UndefOr[Double] = js.undefined,
    xAxis: xAxis = null,
    yAxis: yAxis = null
  ): RadarChartProps = {
    ...
    if (!js.isUndefined(skipWebLineCount)) __obj.updateDynamic("skipWebLineCount")(skipWebLineCount.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(webAlpha)) __obj.updateDynamic("webAlpha")(webAlpha.get.asInstanceOf[js.Any])
    if (!js.isUndefined(webColor)) __obj.updateDynamic("webColor")(webColor.get.asInstanceOf[js.Any])
    if (!js.isUndefined(webColorInner)) __obj.updateDynamic("webColorInner")(webColorInner.get.asInstanceOf[js.Any])
    if (!js.isUndefined(webLineWidth)) __obj.updateDynamic("webLineWidth")(webLineWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(webLineWidthInner)) __obj.updateDynamic("webLineWidthInner")(webLineWidthInner.get.asInstanceOf[js.Any])
