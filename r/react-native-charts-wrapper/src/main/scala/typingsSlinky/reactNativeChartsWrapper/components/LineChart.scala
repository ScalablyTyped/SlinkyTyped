...
object LineChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.LineChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.LineChart] = {
