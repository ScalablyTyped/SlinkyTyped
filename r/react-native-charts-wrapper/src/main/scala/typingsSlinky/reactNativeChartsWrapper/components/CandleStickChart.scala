...
import typingsSlinky.reactNativeChartsWrapper.mod.CandleStickChartProps
import typingsSlinky.reactNativeChartsWrapper.mod.CandleStickData
...
object CandleStickChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.CandleStickChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.CandleStickChart] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.CandleStickChart] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeChartsWrapper.mod.CandleStickChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
