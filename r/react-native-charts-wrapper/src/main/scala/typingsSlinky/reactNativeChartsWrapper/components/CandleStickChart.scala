...
object CandleStickChart {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.CandleStickChart] {
    @scala.inline
    ...
    @scala.inline
    def data(value: CandleStickData): this.type = set("data", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: CandleStickChartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CandleStickChart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
