...
import typingsSlinky.reactNativeChartsWrapper.mod.BubbleChartProps
import typingsSlinky.reactNativeChartsWrapper.mod.BubbleData
...
object BubbleChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.BubbleChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.BubbleChart] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.BubbleChart] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeChartsWrapper.mod.BubbleChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
