...
object CombinedChart {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def data(value: CombinedData): this.type = set("data", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def drawBarShadow(value: Boolean): this.type = set("drawBarShadow", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def highlightFullBarEnabled(value: Boolean): this.type = set("highlightFullBarEnabled", value.asInstanceOf[js.Any])
    @scala.inline
