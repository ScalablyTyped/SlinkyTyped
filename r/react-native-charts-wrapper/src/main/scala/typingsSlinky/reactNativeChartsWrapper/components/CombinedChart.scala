...
import typingsSlinky.reactNativeChartsWrapper.mod.CombinedChartProps
import typingsSlinky.reactNativeChartsWrapper.mod.CombinedData
import typingsSlinky.reactNativeChartsWrapper.mod.Offsets
import typingsSlinky.reactNativeChartsWrapper.mod.xAxis
import typingsSlinky.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.BAR
import typingsSlinky.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.BUBBLE
...
object CombinedChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.CombinedChart] {
  ...
  def apply(
    ...
    drawBarShadow: js.UndefOr[Boolean] = js.undefined,
    ...
    highlightFullBarEnabled: js.UndefOr[Boolean] = js.undefined,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.CombinedChart] = {
    ...
    if (!js.isUndefined(drawBarShadow)) __obj.updateDynamic("drawBarShadow")(drawBarShadow.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(drawValueAboveBar)) __obj.updateDynamic("drawValueAboveBar")(drawValueAboveBar.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(highlightFullBarEnabled)) __obj.updateDynamic("highlightFullBarEnabled")(highlightFullBarEnabled.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.CombinedChart] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeChartsWrapper.mod.CombinedChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CombinedChartProps
}
