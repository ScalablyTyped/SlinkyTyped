...
object PieChart {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.PieChart] {
    ...
    @scala.inline
    def centerTextRadiusPercent(value: Double): this.type = set("centerTextRadiusPercent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def data(value: PieData): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def drawEntryLabels(value: Boolean): this.type = set("drawEntryLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def entryLabelColor(value: Color): this.type = set("entryLabelColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def entryLabelTextSize(value: Double): this.type = set("entryLabelTextSize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def holeColor(value: Color): this.type = set("holeColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def holeRadius(value: Double): this.type = set("holeRadius", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def rotationEnabled(value: Boolean): this.type = set("rotationEnabled", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def transparentCircleColor(value: Color): this.type = set("transparentCircleColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def transparentCircleRadius(value: Double): this.type = set("transparentCircleRadius", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def usePercentValues(value: Boolean): this.type = set("usePercentValues", value.asInstanceOf[js.Any])
