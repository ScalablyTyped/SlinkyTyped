...
import typingsSlinky.reactNativeChartsWrapper.mod.RadarChartProps
import typingsSlinky.reactNativeChartsWrapper.mod.RadarData
...
object RadarChart {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.RadarChart] {
    ...
    @scala.inline
    def data(value: RadarData): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def drawWeb(value: Boolean): this.type = set("drawWeb", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def skipWebLineCount(value: Double): this.type = set("skipWebLineCount", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def webAlpha(value: Double): this.type = set("webAlpha", value.asInstanceOf[js.Any])
    
    @scala.inline
    def webColor(value: Color): this.type = set("webColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def webColorInner(value: Color): this.type = set("webColorInner", value.asInstanceOf[js.Any])
    
    @scala.inline
    def webLineWidth(value: Double): this.type = set("webLineWidth", value.asInstanceOf[js.Any])
    
    @scala.inline
    def webLineWidthInner(value: Double): this.type = set("webLineWidthInner", value.asInstanceOf[js.Any])
    
    @scala.inline
    def xAxis(value: typingsSlinky.reactNativeChartsWrapper.mod.xAxis): this.type = set("xAxis", value.asInstanceOf[js.Any])
    
    @scala.inline
    def yAxis(value: typingsSlinky.reactNativeChartsWrapper.mod.yAxis): this.type = set("yAxis", value.asInstanceOf[js.Any])
  }
