...
object RadarChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.RadarChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.RadarChart] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeChartsWrapper.mod.RadarChart] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeChartsWrapper.mod.RadarChart](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
