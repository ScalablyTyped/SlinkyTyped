...
class AjaxObservable[T] protected ()
  extends typingsSlinky.rxjs.internalObservableDomAjaxObservableMod.AjaxObservable[T] {
...
object AjaxObservable extends js.Object {
  ...
  /**
    ...
    * @nocollapse
    */
  def create(urlOrRequest: String): Observable[typingsSlinky.rxjs.internalObservableDomAjaxObservableMod.AjaxResponse] = js.native
  def create(urlOrRequest: AjaxRequest): Observable[typingsSlinky.rxjs.internalObservableDomAjaxObservableMod.AjaxResponse] = js.native
}
