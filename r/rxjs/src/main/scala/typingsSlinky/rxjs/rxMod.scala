...
object rxMod {
  ...
  class AsyncSubject[T] ()
    extends typingsSlinky.rxjs.asyncSubjectMod.AsyncSubject[T]
  ...
  object Subscription {
    ...
    @js.native
    def EMPTY: typingsSlinky.rxjs.subscriptionMod.Subscription = js.native
    @scala.inline
    def EMPTY_=(x: typingsSlinky.rxjs.subscriptionMod.Subscription): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EMPTY")(x.asInstanceOf[js.Any])
  }
  ...
  object operators {
    ...
    def groupBy[T, K, R](
      ...
      subjectSelector: js.Function0[typingsSlinky.rxjs.subjectMod.Subject[R]]
    ...
    def multicast[T](
      subjectFactory: js.ThisFunction0[
          /* this */ typingsSlinky.rxjs.internalObservableMod.Observable[T], 
          typingsSlinky.rxjs.subjectMod.Subject[T]
        ]
    ): UnaryFunction[
    ...
    @JSImport("rxjs/internal/Rx", "operators.multicast")
    @js.native
    def multicast[T](subject: typingsSlinky.rxjs.subjectMod.Subject[T]): UnaryFunction[
        typingsSlinky.rxjs.internalObservableMod.Observable[T], 
        typingsSlinky.rxjs.connectableObservableMod.ConnectableObservable[T]
      ] = js.native
    @JSImport("rxjs/internal/Rx", "operators.multicast")
    ...
    @js.native
    def multicast[T, O /* <: ObservableInput[_] */](
      subject: typingsSlinky.rxjs.subjectMod.Subject[T],
      selector: js.Function1[/* shared */ typingsSlinky.rxjs.internalObservableMod.Observable[T], O]
    ): UnaryFunction[
        typingsSlinky.rxjs.internalObservableMod.Observable[T], 
