...
object bindNodeCallback extends js.Object {
  def apply(callbackFunc: js.Function): js.Function1[
    /* repeated */ js.Any, 
    typingsSlinky.rxjs.internalObservableMod.Observable[js.Array[_]]
  ] = js.native
  def apply(callbackFunc: js.Function1[/* callback */ js.Function1[/* err */ js.Any, _], _]): js.Function0[typingsSlinky.rxjs.internalObservableMod.Observable[Unit]] = js.native
  def apply(
    callbackFunc: js.Function1[/* callback */ js.Function1[/* err */ js.Any, _], _],
    scheduler: SchedulerLike
  ): js.Function0[typingsSlinky.rxjs.internalObservableMod.Observable[Unit]] = js.native
  ...
  def apply[A1](callbackFunc: js.Function2[/* arg1 */ A1, /* callback */ js.Function1[/* err */ js.Any, _], _]): js.Function1[/* arg1 */ A1, typingsSlinky.rxjs.internalObservableMod.Observable[Unit]] = js.native
  def apply[A1](
