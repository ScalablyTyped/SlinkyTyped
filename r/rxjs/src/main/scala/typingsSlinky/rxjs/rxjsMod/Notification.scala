...
class Notification[T] protected ()
  extends typingsSlinky.rxjs.internalNotificationMod.Notification[T] {
...
object Notification extends js.Object {
  ...
  /**
    ...
    * @nocollapse
    */
  def createComplete(): typingsSlinky.rxjs.internalNotificationMod.Notification[_] = js.native
  /**
    ...
    * @nocollapse
    */
  def createError[T](): typingsSlinky.rxjs.internalNotificationMod.Notification[T] = js.native
  def createError[T](err: js.Any): typingsSlinky.rxjs.internalNotificationMod.Notification[T] = js.native
  /**
    ...
    * @nocollapse
    */
  def createNext[T](value: T): typingsSlinky.rxjs.internalNotificationMod.Notification[T] = js.native
}
