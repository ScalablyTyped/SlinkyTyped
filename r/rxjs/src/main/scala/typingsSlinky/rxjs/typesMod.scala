...
object typesMod {
  ...
  */
  ...
  object PartialObserver {
    ...
    @scala.inline
    def CompletionObserver[T](complete: () => Unit): typingsSlinky.rxjs.typesMod.CompletionObserver[T] = {
      val __obj = js.Dynamic.literal(complete = js.Any.fromFunction0(complete))
      __obj.asInstanceOf[typingsSlinky.rxjs.typesMod.CompletionObserver[T]]
    }
    
    @scala.inline
    def ErrorObserver[T](error: js.Any => Unit): typingsSlinky.rxjs.typesMod.ErrorObserver[T] = {
      val __obj = js.Dynamic.literal(error = js.Any.fromFunction1(error))
      __obj.asInstanceOf[typingsSlinky.rxjs.typesMod.ErrorObserver[T]]
    }
    
    @scala.inline
    def NextObserver[T](next: T => Unit): typingsSlinky.rxjs.typesMod.NextObserver[T] = {
      val __obj = js.Dynamic.literal(next = js.Any.fromFunction1(next))
      __obj.asInstanceOf[typingsSlinky.rxjs.typesMod.NextObserver[T]]
    }
  }
