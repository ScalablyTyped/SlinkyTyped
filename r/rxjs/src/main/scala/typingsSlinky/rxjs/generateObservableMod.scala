...
object generateObservableMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<T> * / any */ @JSImport("rxjs/observable/GenerateObservable", "GenerateObservable")
  @js.native
  class GenerateObservable[T] ()
    extends typingsSlinky.rxjsCompat.generateObservableMod.GenerateObservable[T]
  /* static members */
  object GenerateObservable {
    
    @JSImport("rxjs/observable/GenerateObservable", "GenerateObservable.create")
    @js.native
    def create[S](
      initialState: S,
