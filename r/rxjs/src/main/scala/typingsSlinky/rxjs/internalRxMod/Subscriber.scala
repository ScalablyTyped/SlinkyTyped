...
/**
  ...
  */
class Subscriber[T] ()
  extends typingsSlinky.rxjs.internalSubscriberMod.Subscriber[T] {
...
object Subscriber extends js.Object {
  /**
    ...
    * @nocollapse
    */
  def create[T](): typingsSlinky.rxjs.internalSubscriberMod.Subscriber[T] = js.native
  def create[T](next: js.Function1[/* x */ js.UndefOr[T], Unit]): typingsSlinky.rxjs.internalSubscriberMod.Subscriber[T] = js.native
  def create[T](
