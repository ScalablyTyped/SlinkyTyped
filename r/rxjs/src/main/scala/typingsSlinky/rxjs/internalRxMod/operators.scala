...
import typingsSlinky.rxjs.internalOperatorsGroupByMod.GroupedObservable
import typingsSlinky.rxjs.internalOperatorsShareReplayMod.ShareReplayConfig
...
object operators extends js.Object {
  ...
  def catchError[T, O /* <: ObservableInput[_] */](
    selector: js.Function2[
      /* err */ js.Any, 
      /* caught */ typingsSlinky.rxjs.internalObservableMod.Observable[T], 
      O
    ]
  ...
  def delayWhen[T](
    delayDurationSelector: js.Function2[
      /* value */ T, 
      /* index */ Double, 
      typingsSlinky.rxjs.internalObservableMod.Observable[_ | scala.Nothing]
    ]
  ...
  def dematerialize[T](): OperatorFunction[typingsSlinky.rxjs.internalNotificationMod.Notification[T], T] = js.native
  ...
  def groupBy[T, K, R](
    ...
    subjectSelector: js.Function0[typingsSlinky.rxjs.internalSubjectMod.Subject[R]]
  ): OperatorFunction[T, GroupedObservable[K, R]] = js.native
  @JSName("groupBy")
  ...
  def materialize[T](): OperatorFunction[T, typingsSlinky.rxjs.internalNotificationMod.Notification[T]] = js.native
  ...
  def multicast[T](
    subjectFactory: js.ThisFunction0[
      ...
      typingsSlinky.rxjs.internalSubjectMod.Subject[T]
    ]
  ): UnaryFunction[
    typingsSlinky.rxjs.internalObservableMod.Observable[T], 
    typingsSlinky.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[T]
  ] = js.native
  def multicast[T](subject: typingsSlinky.rxjs.internalSubjectMod.Subject[T]): UnaryFunction[
    typingsSlinky.rxjs.internalObservableMod.Observable[T], 
    typingsSlinky.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[T]
  ] = js.native
  def multicast[T, O /* <: ObservableInput[_] */](
    ...
    selector: js.Function1[/* shared */ typingsSlinky.rxjs.internalObservableMod.Observable[T], O]
  ): OperatorFunction[T, ObservedValueOf[O]] = js.native
  def multicast[T, O /* <: ObservableInput[_] */](
    subject: typingsSlinky.rxjs.internalSubjectMod.Subject[T],
    selector: js.Function1[/* shared */ typingsSlinky.rxjs.internalObservableMod.Observable[T], O]
  ): UnaryFunction[
    typingsSlinky.rxjs.internalObservableMod.Observable[T], 
    typingsSlinky.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[ObservedValueOf[O]]
  ] = js.native
  ...
  def race[T](observables: js.Array[typingsSlinky.rxjs.internalObservableMod.Observable[T]]): MonoTypeOperatorFunction[T] = js.native
  @JSName("race")
  def race_TR_OperatorFunction[T, R](
    observables: (typingsSlinky.rxjs.internalObservableMod.Observable[_] | js.Array[typingsSlinky.rxjs.internalObservableMod.Observable[_]])*
  ): OperatorFunction[T, R] = js.native
  @JSName("race")
  ...
  def timeInterval[T](): OperatorFunction[T, typingsSlinky.rxjs.internalOperatorsTimeIntervalMod.TimeInterval[T]] = js.native
  def timeInterval[T](scheduler: SchedulerLike): OperatorFunction[T, typingsSlinky.rxjs.internalOperatorsTimeIntervalMod.TimeInterval[T]] = js.native
  ...
  def timestamp[T](): OperatorFunction[T, typingsSlinky.rxjs.internalOperatorsTimestampMod.Timestamp[T]] = js.native
  def timestamp[T](scheduler: SchedulerLike): OperatorFunction[T, typingsSlinky.rxjs.internalOperatorsTimestampMod.Timestamp[T]] = js.native
  ...
  def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Double, maxWindowSize: Double): OperatorFunction[T, typingsSlinky.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowTime[T](
