...
object TableCheckboxProps {
  ...
  implicit class TableCheckboxPropsOps[Self <: TableCheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckboxRefRefObject(value: ReactRef[HTMLInputElement]): Self = this.set("checkboxRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClick(value: SyntheticMouseEvent[HTMLTableDataCellElement] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
