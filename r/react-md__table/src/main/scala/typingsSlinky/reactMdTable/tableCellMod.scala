...
import typingsSlinky.reactMdTable.reactMdTableStrings.colSpan
...
import typingsSlinky.reactMdTable.reactMdTableStrings.scope
...
object tableCellMod {
  ...
  trait TableCellProps extends TableCellOptions {
    ...
    /**
      ...
      * prop to `null`.
      */
    var sortIcon: js.UndefOr[ReactElement] = js.native
  ...
  object TableCellProps {
    ...
    implicit class TableCellPropsMutableBuilder[Self <: TableCellProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSortIcon(value: ReactElement): Self = StObject.set(x, "sortIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSortIconReactElement(value: ReactElement): Self = StObject.set(x, "sortIcon", value.asInstanceOf[js.Any])
