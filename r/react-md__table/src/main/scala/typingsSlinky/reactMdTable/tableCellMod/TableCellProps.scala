...
object TableCellProps {
  ...
  implicit class TableCellPropsOps[Self <: TableCellProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSortIconReactElement(value: ReactElement): Self = this.set("sortIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def setSortIcon(value: ReactElement): Self = this.set("sortIcon", value.asInstanceOf[js.Any])
    @scala.inline
