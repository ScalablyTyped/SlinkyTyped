package typingsSlinky.reactMdMenu.anon
...
@js.native
trait PickBaseMenuPropshiddenviAbout extends js.Object {
...
object PickBaseMenuPropshiddenviAbout {
  ...
  @scala.inline
  implicit class PickBaseMenuPropshiddenviAboutOps[Self <: PickBaseMenuPropshiddenviAbout] (val x: Self) extends AnyVal {
