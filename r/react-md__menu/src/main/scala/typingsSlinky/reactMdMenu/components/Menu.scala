...
object Menu {
  ...
  object PickBaseMenuPropshiddenvi {
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def disableControlClickOkay(value: Boolean): this.type = set("disableControlClickOkay", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def role(value: menu): this.type = set("role", value.asInstanceOf[js.Any])
