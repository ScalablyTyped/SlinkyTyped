...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-md__app-bar" % "2.1.2-00d92e",
  "org.scalablytyped.slinky" %%% "react-md__button" % "2.1.2-6fd34f",
  "org.scalablytyped.slinky" %%% "react-md__divider" % "2.1.2-6e8029",
  "org.scalablytyped.slinky" %%% "react-md__list" % "2.1.2-1ee4e1",
