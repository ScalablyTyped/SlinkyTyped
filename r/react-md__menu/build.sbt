...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-md__app-bar" % "2.1.2-e49404",
  "org.scalablytyped.slinky" %%% "react-md__button" % "2.1.2-b48689",
  "org.scalablytyped.slinky" %%% "react-md__divider" % "2.1.2-2cff3c",
  "org.scalablytyped.slinky" %%% "react-md__list" % "2.1.2-8cbbc7",
