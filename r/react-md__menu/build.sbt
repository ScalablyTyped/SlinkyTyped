...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-md__app-bar" % "2.4.2-ec9268",
  "org.scalablytyped.slinky" %%% "react-md__button" % "2.4.2-c334f4",
  "org.scalablytyped.slinky" %%% "react-md__divider" % "2.4.2-5e64e9",
  "org.scalablytyped.slinky" %%% "react-md__list" % "2.4.3-1dfdfa",
  "org.scalablytyped.slinky" %%% "react-md__portal" % "2.4.2-bfd793",
  "org.scalablytyped.slinky" %%% "react-md__states" % "2.4.2-857f1f",
