...
import typingsSlinky.reactDashNavigation.reactDashNavigationMod.NavigationEventPayload
import typingsSlinky.reactDashNavigation.reactDashNavigationMod.NavigationEventsProps
...
object NavigationEvents
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNavigation.reactDashNavigationMod.NavigationEvents
    ] {
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNavigation.reactDashNavigationMod.NavigationEvents].asInstanceOf[String | js.Object]
  def apply(
