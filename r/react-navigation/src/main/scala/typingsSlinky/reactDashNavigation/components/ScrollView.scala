...
object ScrollView
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNavigation.reactDashNavigationMod.ScrollView].asInstanceOf[String | js.Object]
  def apply(
