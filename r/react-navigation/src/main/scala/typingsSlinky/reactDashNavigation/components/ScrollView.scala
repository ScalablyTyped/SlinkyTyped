...
object ScrollView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNavigation.reactDashNavigationMod.ScrollView] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNavigation.reactDashNavigationMod.ScrollView] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNavigation.reactDashNavigationMod.ScrollView] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNavigation.reactDashNavigationMod.ScrollView](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
