...
import typingsSlinky.reactDashNavigation.Anon_Bottom
import typingsSlinky.reactDashNavigation.reactDashNavigationMod.SafeAreaViewProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object SafeAreaView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNavigation.reactDashNavigationMod.SafeAreaView] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNavigation.reactDashNavigationMod.SafeAreaView] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNavigation.reactDashNavigationMod.SafeAreaView] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNavigation.reactDashNavigationMod.SafeAreaView](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
