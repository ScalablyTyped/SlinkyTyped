...
object AnonNavigationOptionsNavigationScreenConfig {
  @scala.inline
  def apply[Params, ScreenProps](): AnonNavigationOptionsNavigationScreenConfig[Params, ScreenProps] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonNavigationOptionsNavigationScreenConfig[Params, ScreenProps]]
  }
  @scala.inline
  implicit class AnonNavigationOptionsNavigationScreenConfigOps[Self[params, screenprops] <: AnonNavigationOptionsNavigationScreenConfig[params, screenprops], Params, ScreenProps] (val x: Self[Params, ScreenProps]) extends AnyVal {
    @scala.inline
    ...
    def withNavigationOptionsFunction1(
      value: /* navigationOptionsContainer */ (NavigationScreenConfigProps[NavigationSwitchProp[NavigationRoute[NavigationParams], Params], ScreenProps]) with AnonNavigationOptionsOptions[js.Object] => js.Object
