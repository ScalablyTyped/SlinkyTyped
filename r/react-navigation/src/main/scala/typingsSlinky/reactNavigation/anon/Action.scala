...
object Action {
  @scala.inline
  def apply[/* <: typingsSlinky.reactNavigation.mod.NavigationParams */ T](routeName: String): Action[T] = {
    val __obj = js.Dynamic.literal(routeName = routeName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Action[T]]
  }
  @scala.inline
  implicit class ActionOps[Self <: Action[_], /* <: typingsSlinky.reactNavigation.mod.NavigationParams */ T] (val x: Self with Action[T]) extends AnyVal {
    @scala.inline
