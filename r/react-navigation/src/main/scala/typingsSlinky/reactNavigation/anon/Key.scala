...
object Key {
  @scala.inline
  def apply[/* <: typingsSlinky.reactNavigation.mod.NavigationParams */ T](routeName: String | Action[T]): Key[T] = {
    val __obj = js.Dynamic.literal(routeName = routeName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Key[T]]
  }
  @scala.inline
  implicit class KeyOps[Self <: Key[_], /* <: typingsSlinky.reactNavigation.mod.NavigationParams */ T] (val x: Self with Key[T]) extends AnyVal {
    @scala.inline
