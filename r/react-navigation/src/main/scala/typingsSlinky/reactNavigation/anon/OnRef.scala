...
object OnRef {
  @scala.inline
  def apply[/* <: typingsSlinky.react.mod.ComponentClass[P, typingsSlinky.react.mod.ComponentState] */ T, /* <: typingsSlinky.reactNavigation.mod.NavigationInjectedProps[typingsSlinky.reactNavigation.mod.NavigationParams] */ P](): OnRef[T, P] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OnRef[T, P]]
  }
  @scala.inline
  implicit class OnRefOps[Self <: OnRef[_, _], /* <: typingsSlinky.react.mod.ComponentClass[P, typingsSlinky.react.mod.ComponentState] */ T, /* <: typingsSlinky.reactNavigation.mod.NavigationInjectedProps[typingsSlinky.reactNavigation.mod.NavigationParams] */ P] (val x: Self with (OnRef[T, P])) extends AnyVal {
    @scala.inline
