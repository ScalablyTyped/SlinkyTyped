...
import typingsSlinky.reactNavigation.mod.EventType
import typingsSlinky.reactNavigation.mod.NavigatorType
import typingsSlinky.reactNavigation.mod.SafeAreaViewForceInsetValue
...
object reactNavigationStrings {
  ...
  @js.native
  sealed trait NavigationSlashBACK extends StObject
  @scala.inline
  def NavigationSlashBACK: NavigationSlashBACK = "Navigation/BACK".asInstanceOf[NavigationSlashBACK]
  
  @js.native
  sealed trait NavigationSlashCLOSE_DRAWER extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait NavigationSlashCOMPLETE_TRANSITION extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait NavigationSlashDRAWER_CLOSED extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait NavigationSlashDRAWER_OPENED extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait NavigationSlashURI extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait isLandscape extends StObject
  @scala.inline
