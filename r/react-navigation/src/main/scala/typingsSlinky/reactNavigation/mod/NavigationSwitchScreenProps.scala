...
object NavigationSwitchScreenProps {
  ...
  @scala.inline
  implicit class NavigationSwitchScreenPropsOps[Self[params, screenprops] <: NavigationSwitchScreenProps[params, screenprops], Params, ScreenProps] (val x: Self[Params, ScreenProps]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withNavigation(value: NavigationSwitchProp[NavigationRoute[NavigationParams], Params]): Self[Params, ScreenProps] = {
