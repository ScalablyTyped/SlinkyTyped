...
import typingsSlinky.reactNavigation.mod.SafeAreaViewProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object SafeAreaView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNavigation.mod.SafeAreaView] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNavigation.mod.SafeAreaView] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNavigation.mod.SafeAreaView] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNavigation.mod.SafeAreaView](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
