...
object SectionList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNavigation.mod.SectionList[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNavigation.mod.SectionList[js.Any]] = {
  ...
  typingsSlinky.reactNavigation.mod.SectionList[js.Any]]]
  }
