...
object NavigationEvents
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNavigation.mod.NavigationEvents] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNavigation.mod.NavigationEvents] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNavigation.mod.NavigationEvents] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNavigation.mod.NavigationEvents](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
