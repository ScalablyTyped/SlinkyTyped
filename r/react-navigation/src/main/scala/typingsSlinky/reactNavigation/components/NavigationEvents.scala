...
import typingsSlinky.reactNavigation.mod.NavigationEventPayload
import typingsSlinky.reactNavigation.mod.NavigationEventsProps
...
object NavigationEvents {
  ...
  @JSImport("react-navigation", "NavigationEvents")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onDidBlur(value: /* payload */ NavigationEventPayload => Unit): this.type = set("onDidBlur", js.Any.fromFunction1(value))
    
    @scala.inline
    def onDidFocus(value: /* payload */ NavigationEventPayload => Unit): this.type = set("onDidFocus", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onWillBlur(value: /* payload */ NavigationEventPayload => Unit): this.type = set("onWillBlur", js.Any.fromFunction1(value))
    
    @scala.inline
    def onWillFocus(value: /* payload */ NavigationEventPayload => Unit): this.type = set("onWillFocus", js.Any.fromFunction1(value))
  ...
  def withProps(p: NavigationEventsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: NavigationEvents.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
