...
object ThemedStatusBar {
  ...
  implicit def make(companion: ThemedStatusBar.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
