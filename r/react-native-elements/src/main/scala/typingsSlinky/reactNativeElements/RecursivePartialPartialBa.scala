...
trait RecursivePartialPartialBa extends js.Object {
  ...
  var value: js.UndefOr[RecursivePartial[js.UndefOr[TagMod[Any]]]] = js.native
}
...
object RecursivePartialPartialBa {
  ...
  implicit class RecursivePartialPartialBaOps[Self <: RecursivePartialPartialBa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBadgeStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStatus(value: RecursivePartial[js.UndefOr[primary | success | warning | error]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withValue(value: RecursivePartial[js.UndefOr[TagMod[Any]]]): Self = {
        val ret = this.duplicate
