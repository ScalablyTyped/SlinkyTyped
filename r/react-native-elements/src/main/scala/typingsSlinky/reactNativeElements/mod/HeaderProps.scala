...
object HeaderProps {
  ...
  implicit class HeaderPropsMutableBuilder[Self <: HeaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCenterComponentReactElement(value: ReactElement): Self = StObject.set(x, "centerComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLeftComponentReactElement(value: ReactElement): Self = StObject.set(x, "leftComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRightComponentReactElement(value: ReactElement): Self = StObject.set(x, "rightComponent", value.asInstanceOf[js.Any])
