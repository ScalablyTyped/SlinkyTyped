...
object Image
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeElements.mod.Image] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.Image] = {
