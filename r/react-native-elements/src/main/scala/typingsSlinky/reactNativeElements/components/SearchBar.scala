...
object SearchBar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeElements.mod.SearchBar] {
  ...
  def apply(
    ...
    platform: typingsSlinky.reactNativeElements.reactNativeElementsStrings.default | ios | android = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.SearchBar] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.SearchBar] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeElements.mod.SearchBar](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
