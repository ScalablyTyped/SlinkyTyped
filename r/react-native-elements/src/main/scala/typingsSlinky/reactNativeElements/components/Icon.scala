...
object Icon {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.Icon] {
    ...
    @scala.inline
    def iconProps(value: typingsSlinky.reactNativeVectorIcons.iconMod.IconProps): this.type = set("iconProps", value.asInstanceOf[js.Any])
