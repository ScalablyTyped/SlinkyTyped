...
object Icon
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeElements.mod.Icon] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.Icon] = {
