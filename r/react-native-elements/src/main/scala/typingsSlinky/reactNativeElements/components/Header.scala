...
import typingsSlinky.reactNativeElements.mod.HeaderProps
...
object Header {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.Header] {
    @scala.inline
    ...
    @scala.inline
    def centerContainerStyleNull: this.type = set("centerContainerStyle", null)
    @scala.inline
    ...
    @scala.inline
    def leftContainerStyleNull: this.type = set("leftContainerStyle", null)
    @scala.inline
    ...
    @scala.inline
    def placement(value: left | center | right): this.type = set("placement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def rightContainerStyleNull: this.type = set("rightContainerStyle", null)
    @scala.inline
    def shouldRasterizeIOS(value: Boolean): this.type = set("shouldRasterizeIOS", value.asInstanceOf[js.Any])
    @scala.inline
    def statusBarProps(value: StatusBarProperties): this.type = set("statusBarProps", value.asInstanceOf[js.Any])
    @scala.inline
