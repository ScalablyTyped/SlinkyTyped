...
object Input
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeElements.mod.Input] {
  @JSImport("react-native-elements", "Input")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: autoFocus, disabled, placeholder, spellCheck */
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.Input] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.Input] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeElements.mod.Input](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
