...
object Overlay
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeElements.mod.Overlay] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeElements.mod.Overlay] = {
