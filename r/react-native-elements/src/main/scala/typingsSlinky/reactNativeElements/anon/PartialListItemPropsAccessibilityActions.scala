...
@js.native
trait PartialListItemPropsAccessibilityActions extends StObject {
  ...
  var leftAvatar: js.UndefOr[PartialAvatarPropsActiveOpacity | ReactElement] = js.native
  ...
  var rightAvatar: js.UndefOr[PartialAvatarPropsActiveOpacity | ReactElement] = js.native
...
object PartialListItemPropsAccessibilityActions {
  ...
  @scala.inline
  def apply(): PartialListItemPropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemPropsAccessibilityActions]
  }
  
  @scala.inline
  implicit class PartialListItemPropsAccessibilityActionsMutableBuilder[Self <: PartialListItemPropsAccessibilityActions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeftAvatar(value: PartialAvatarPropsActiveOpacity | ReactElement): Self = StObject.set(x, "leftAvatar", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRightAvatar(value: PartialAvatarPropsActiveOpacity | ReactElement): Self = StObject.set(x, "rightAvatar", value.asInstanceOf[js.Any])
