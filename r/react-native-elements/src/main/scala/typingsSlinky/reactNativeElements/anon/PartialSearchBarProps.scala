...
object PartialSearchBarProps {
  ...
  implicit class PartialSearchBarPropsOps[Self <: PartialSearchBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCancelIconReactElement(value: ReactElement): Self = this.set("cancelIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[NodeHandle, TextInputChangeEventData] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
