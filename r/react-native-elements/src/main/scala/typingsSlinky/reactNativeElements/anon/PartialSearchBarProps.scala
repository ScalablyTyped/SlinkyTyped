...
object PartialSearchBarProps {
  ...
  implicit class PartialSearchBarPropsMutableBuilder[Self <: PartialSearchBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCancelIconReactElement(value: ReactElement): Self = StObject.set(x, "cancelIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSearchIconReactElement(value: ReactElement): Self = StObject.set(x, "searchIcon", value.asInstanceOf[js.Any])
