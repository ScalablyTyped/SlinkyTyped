...
object RecursivePartialPartialOv {
  ...
  implicit class RecursivePartialPartialOvOps[Self <: RecursivePartialPartialOv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModalComponent(value: RecursivePartial[js.UndefOr[ReactComponentClass[js.Object]]]): Self = this.set("ModalComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnOrientationChange(value: RecursivePartial[js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, _], Unit]]]): Self = this.set("onOrientationChange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnShow(value: RecursivePartial[js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, _], Unit]]]): Self = this.set("onShow", value.asInstanceOf[js.Any])
