...
trait RecursivePartialPartialIm extends js.Object {
  var ImageComponent: js.UndefOr[RecursivePartial[js.UndefOr[ReactComponentClass[_]]]] = js.undefined
...
object RecursivePartialPartialIm {
  @scala.inline
  def apply(
    ImageComponent: RecursivePartial[js.UndefOr[ReactComponentClass[_]]] = null,
    ...
    onError: RecursivePartial[js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, ImageErrorEventData], Unit]]] = null,
    onLayout: RecursivePartial[js.UndefOr[js.Function1[/* event */ LayoutChangeEvent, Unit]]] = null,
    onLoad: RecursivePartial[js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, ImageLoadEventData], Unit]]] = null,
