package typingsSlinky.reactDashNativeDashElements
...
package object reactDashNativeDashElementsMod {
  ...
  */
  ...
  {[ P in keyof T ]:? / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias react-native-elements.react-native-elements.RecursivePartial<T[P]> * / object}
    */ typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsStrings.RecursivePartial with js.Any
