...
import typingsSlinky.reactDashNative.reactDashNativeMod.ModalBaseProps
import typingsSlinky.reactDashNative.reactDashNativeMod.ModalPropsAndroid
import typingsSlinky.reactDashNative.reactDashNativeMod.ModalPropsIOS
