...
object SocialIcon
  ...
  typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.SocialIcon](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
