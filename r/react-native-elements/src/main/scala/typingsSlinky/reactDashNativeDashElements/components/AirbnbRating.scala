...
object AirbnbRating
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.AirbnbRating
    ] {
  ...
  typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.AirbnbRating](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
