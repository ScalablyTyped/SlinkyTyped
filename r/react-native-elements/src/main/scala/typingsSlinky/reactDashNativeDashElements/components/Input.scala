...
object Input
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.Input
    ] {
  ...
  /* The following DOM/SVG props were specified: autoFocus, disabled, onBlur, onChange, onFocus, onKeyPress, onScroll, onTouchCancel, onTouchEnd, onTouchMove, onTouchStart, placeholder, spellCheck */
  def apply(
  ...
  typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.Input](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
