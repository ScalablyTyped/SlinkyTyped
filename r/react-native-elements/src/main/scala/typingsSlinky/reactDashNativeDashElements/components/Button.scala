...
object Button
  ...
  typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.Button](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
