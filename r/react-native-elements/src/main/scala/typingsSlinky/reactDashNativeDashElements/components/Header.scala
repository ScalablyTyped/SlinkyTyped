...
import typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.HeaderProps
import typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.HeaderSubComponent
...
object Header
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.Header
    ] {
