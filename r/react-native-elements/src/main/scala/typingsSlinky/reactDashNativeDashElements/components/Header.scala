...
object Header
  ...
  typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.Header](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
