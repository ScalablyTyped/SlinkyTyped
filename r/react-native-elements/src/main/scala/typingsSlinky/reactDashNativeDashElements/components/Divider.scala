...
import typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.DividerProps
...
object Divider
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.Divider
    ] {
  ...
  typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.Divider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
