...
import typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.ElementObject
import typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.InnerBorderStyleProperty
...
object ButtonGroup
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashElements.reactDashNativeDashElementsMod.ButtonGroup
    ] {
