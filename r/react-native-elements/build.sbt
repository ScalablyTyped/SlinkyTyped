...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-native-ratings" % "7.3.0-2f09e4",
  "org.scalablytyped.slinky" %%% "react-native-vector-icons" % "6.4-dt-20200918Z-736454",
