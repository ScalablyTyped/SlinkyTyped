...
import typingsSlinky.reactDashSketchapp.Anon_Style
import typingsSlinky.reactDashSketchapp.reactDashSketchappNumbers.`1`
...
object StyleSheet extends js.Object {
  ...
  {[ P in keyof T ]: react-sketchapp.react-sketchapp.StyleReference}
    */ typingsSlinky.reactDashSketchapp.reactDashSketchappStrings.StyleSheet with js.Any = js.native
