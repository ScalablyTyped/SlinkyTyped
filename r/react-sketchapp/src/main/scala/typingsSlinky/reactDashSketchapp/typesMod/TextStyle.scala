...
import typingsSlinky.reactDashSketchapp.reactDashSketchappStrings.lowercase
...
import typingsSlinky.reactDashSketchapp.reactDashSketchappStrings.uppercase
