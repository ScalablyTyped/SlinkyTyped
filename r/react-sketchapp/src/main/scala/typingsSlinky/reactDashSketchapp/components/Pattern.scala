...
import typingsSlinky.reactDashSketchapp.libComponentsSvgPatternMod.default
...
object Pattern
  ...
  typingsSlinky.reactDashSketchapp.libComponentsSvgPatternMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
