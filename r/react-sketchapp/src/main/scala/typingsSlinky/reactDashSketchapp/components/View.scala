...
object View
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashSketchapp.reactDashSketchappMod.View] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashSketchapp.reactDashSketchappMod.View](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
