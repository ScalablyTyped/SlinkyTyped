...
import typingsSlinky.reactSketchapp.polylineMod.PolylineProps
import typingsSlinky.reactSketchapp.polylineMod.default
...
object Polyline {
  ...
  @scala.inline
  def apply(points: String): Builder = {
    val __props = js.Dynamic.literal(points = points.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[PolylineProps]))
  }
}
