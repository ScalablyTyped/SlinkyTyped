...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.reactSketchapp.reactSketchappStrings.wider
  - typingsSlinky.reactSketchapp.reactSketchappStrings.narrower
  - typingsSlinky.reactSketchapp.reactSketchappStrings.`ultra-condensed`
  - typingsSlinky.reactSketchapp.reactSketchappStrings.`extra-condensed`
  - typingsSlinky.reactSketchapp.reactSketchappStrings.condensed
  - typingsSlinky.reactSketchapp.reactSketchappStrings.`semi-condensed`
  - typingsSlinky.reactSketchapp.reactSketchappStrings.`semi-expanded`
  - typingsSlinky.reactSketchapp.reactSketchappStrings.expanded
  - typingsSlinky.reactSketchapp.reactSketchappStrings.`extra-expanded`
  - typingsSlinky.reactSketchapp.reactSketchappStrings.`ultra-expanded`
*/
