package typingsSlinky.reactScrollIntoViewIfNeeded.components
...
import typingsSlinky.reactScrollIntoViewIfNeeded.mod.ReactScrollIntoViewIfNeededProps
import typingsSlinky.reactScrollIntoViewIfNeeded.mod.default
...
object ReactScrollIntoViewIfNeeded {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def elementType(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176 */ js.Any): this.type = set("elementType", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ReactScrollIntoViewIfNeeded.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReactScrollIntoViewIfNeededProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
