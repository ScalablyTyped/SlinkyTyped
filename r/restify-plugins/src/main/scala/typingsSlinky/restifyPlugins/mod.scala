...
import typingsSlinky.restifyPlugins.anon.MapParams
import typingsSlinky.restifyPlugins.anon.MaxBodySize
...
object mod {
  ...
  trait AuditLoggerOptions extends StObject {
    ...
    /**
      ...
      */
    var server: js.UndefOr[typingsSlinky.restify.mod.Server] = js.native
  }
  object AuditLoggerOptions {
    ...
    implicit class AuditLoggerOptionsMutableBuilder[Self <: AuditLoggerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setServer(value: typingsSlinky.restify.mod.Server): Self = StObject.set(x, "server", value.asInstanceOf[js.Any])
