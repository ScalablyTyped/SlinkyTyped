...
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.`box-none`
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.`box-only`
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.`no-hide-descendants`
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.`on-drag`
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.always
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.assertive
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.auto
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.automatic
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.black
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.button
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.center
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.end
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.fast
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.handled
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.interactive
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.never
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.no
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.none
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.normal
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.polite
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.radiobutton_checked
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.radiobutton_unchecked
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.scrollableAxes
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.start
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.white
import typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.yes
...
trait FlatListProps extends js.Object {
  ...
  var indicatorStyle: js.UndefOr[
    typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.default | black | white
  ] = js.native
...
object FlatListProps {
  ...
  implicit class FlatListPropsOps[Self <: FlatListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCellRendererComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("CellRendererComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCellRendererComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("CellRendererComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCellRendererComponent(value: ReactComponentClass[_]): Self = this.set("CellRendererComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setListEmptyComponentReactElement(value: ReactElement): Self = this.set("ListEmptyComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListEmptyComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("ListEmptyComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListEmptyComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("ListEmptyComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListEmptyComponent(value: ReactComponentClass[_] | ReactElement): Self = this.set("ListEmptyComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setListFooterComponentReactElement(value: ReactElement): Self = this.set("ListFooterComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListFooterComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("ListFooterComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListFooterComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("ListFooterComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListFooterComponent(value: ReactComponentClass[_] | ReactElement): Self = this.set("ListFooterComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setListHeaderComponentReactElement(value: ReactElement): Self = this.set("ListHeaderComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListHeaderComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("ListHeaderComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListHeaderComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("ListHeaderComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListHeaderComponent(value: ReactComponentClass[_] | ReactElement): Self = this.set("ListHeaderComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIndicatorStyle(
      value: typingsSlinky.reactNativeImageGallery.reactNativeImageGalleryStrings.default | black | white
    ): Self = this.set("indicatorStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnMomentumScrollBegin(value: SyntheticEvent[NodeHandle, NativeScrollEvent] => Unit): Self = this.set("onMomentumScrollBegin", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMomentumScrollBegin: Self = this.set("onMomentumScrollBegin", js.undefined)
    
    @scala.inline
    def setOnMomentumScrollEnd(value: SyntheticEvent[NodeHandle, NativeScrollEvent] => Unit): Self = this.set("onMomentumScrollEnd", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnScroll(value: SyntheticEvent[NodeHandle, NativeScrollEvent] => Unit): Self = this.set("onScroll", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnScrollBeginDrag(value: SyntheticEvent[NodeHandle, NativeScrollEvent] => Unit): Self = this.set("onScrollBeginDrag", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnScrollBeginDrag: Self = this.set("onScrollBeginDrag", js.undefined)
    
    @scala.inline
    def setOnScrollEndDrag(value: SyntheticEvent[NodeHandle, NativeScrollEvent] => Unit): Self = this.set("onScrollEndDrag", js.Any.fromFunction1(value))
