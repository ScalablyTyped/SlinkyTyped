...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorComponent(value: () => ReactElement): Self = this.set("errorComponent", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setImageComponent(value: (/* imageProps */ ImageProps, /* imageDimensions */ ImageDimensions) => ReactElement): Self = this.set("imageComponent", js.Any.fromFunction2(value))
