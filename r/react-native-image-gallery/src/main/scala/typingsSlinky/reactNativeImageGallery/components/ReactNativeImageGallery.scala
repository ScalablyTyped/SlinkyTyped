package typingsSlinky.reactNativeImageGallery.components
...
import typingsSlinky.reactNativeImageGallery.mod.FlatListProps
import typingsSlinky.reactNativeImageGallery.mod.GestureState
import typingsSlinky.reactNativeImageGallery.mod.Image
import typingsSlinky.reactNativeImageGallery.mod.ImageDimensions
import typingsSlinky.reactNativeImageGallery.mod.Props
import typingsSlinky.reactNativeImageGallery.mod.ScrollEvent
import typingsSlinky.reactNativeImageGallery.mod.ScrollState
import typingsSlinky.reactNativeImageGallery.mod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactNativeImageGallery {
  
  @scala.inline
  def apply(images: js.Array[Image]): Builder = {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def errorComponent(value: () => ReactElement): this.type = set("errorComponent", js.Any.fromFunction0(value))
    
    @scala.inline
    def flatListProps(value: FlatListProps): this.type = set("flatListProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def imageComponent(value: (/* imageProps */ ImageProps, /* imageDimensions */ ImageDimensions) => ReactElement): this.type = set("imageComponent", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onLongPress(value: /* state */ GestureState => Unit): this.type = set("onLongPress", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onPageScroll(value: /* event */ ScrollEvent => Unit): this.type = set("onPageScroll", js.Any.fromFunction1(value))
    
    @scala.inline
    def onPageScrollStateChanged(value: /* state */ ScrollState => Unit): this.type = set("onPageScrollStateChanged", js.Any.fromFunction1(value))
    
    @scala.inline
    def onPageSelected(value: /* page */ Double => Unit): this.type = set("onPageSelected", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onSingleTapConfirmed(value: /* page */ Double => Unit): this.type = set("onSingleTapConfirmed", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def scrollViewStyle(value: StyleProp[ViewStyle]): this.type = set("scrollViewStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def scrollViewStyleNull: this.type = set("scrollViewStyle", null)
