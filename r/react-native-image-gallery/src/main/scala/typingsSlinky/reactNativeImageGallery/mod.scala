...
object mod {
  ...
  object ScrollState extends StObject {
    ...
    /* "dragging" */ val DRAGGING: typingsSlinky.reactNativeImageGallery.mod.ScrollState.DRAGGING with String = js.native
    
    @js.native
    sealed trait IDLE extends ScrollState
    /* "idle" */ val IDLE: typingsSlinky.reactNativeImageGallery.mod.ScrollState.IDLE with String = js.native
    
    @js.native
    sealed trait SETTLING extends ScrollState
    /* "settling" */ val SETTLING: typingsSlinky.reactNativeImageGallery.mod.ScrollState.SETTLING with String = js.native
  }
  ...
  type Gallery = ReactComponentClass[Props]
  ...
  */
  ...
  object Image {
    ...
    @scala.inline
    def LocalImage(dimensions: ImageDimensions, source: Double): typingsSlinky.reactNativeImageGallery.mod.LocalImage = {
      val __obj = js.Dynamic.literal(dimensions = dimensions.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactNativeImageGallery.mod.LocalImage]
    }
    
    @scala.inline
    def RemoteImage(source: Uri): typingsSlinky.reactNativeImageGallery.mod.RemoteImage = {
      val __obj = js.Dynamic.literal(source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactNativeImageGallery.mod.RemoteImage]
    }
  }
  ...
  trait Props extends ViewProps {
    ...
    /**
      ...
      */
    var errorComponent: js.UndefOr[js.Function0[ReactElement]] = js.native
    ...
    var imageComponent: js.UndefOr[
        js.Function2[/* imageProps */ ImageProps, /* imageDimensions */ ImageDimensions, ReactElement]
      ] = js.native
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrorComponent(value: () => ReactElement): Self = StObject.set(x, "errorComponent", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setImageComponent(value: (/* imageProps */ ImageProps, /* imageDimensions */ ImageDimensions) => ReactElement): Self = StObject.set(x, "imageComponent", js.Any.fromFunction2(value))
