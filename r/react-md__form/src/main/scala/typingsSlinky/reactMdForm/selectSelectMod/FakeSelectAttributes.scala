...
@js.native
trait FakeSelectAttributes extends js.Object {
...
object FakeSelectAttributes {
  ...
  @scala.inline
  def apply(): FakeSelectAttributes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FakeSelectAttributes]
  }
  
  @scala.inline
  implicit class FakeSelectAttributesOps[Self <: FakeSelectAttributes] (val x: Self) extends AnyVal {
