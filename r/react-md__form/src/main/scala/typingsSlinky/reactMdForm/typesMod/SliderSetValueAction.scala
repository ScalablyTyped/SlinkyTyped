...
object SliderSetValueAction {
  ...
  @scala.inline
  implicit class SliderSetValueActionOps[Self <: SliderSetValueAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: setValue): Self = this.set("type", value.asInstanceOf[js.Any])
