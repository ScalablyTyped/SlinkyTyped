package typingsSlinky.reactMdForm.textFieldContainerMod
...
object TextFieldContainerOptions {
  ...
  implicit class TextFieldContainerOptionsOps[Self <: TextFieldContainerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeftChildrenReactElement(value: ReactElement): Self = this.set("leftChildren", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLeftChildren(value: ReactElement): Self = this.set("leftChildren", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLeftChildren: Self = this.set("leftChildren", js.undefined)
    
    @scala.inline
    def setRightChildrenReactElement(value: ReactElement): Self = this.set("rightChildren", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRightChildren(value: ReactElement): Self = this.set("rightChildren", value.asInstanceOf[js.Any])
