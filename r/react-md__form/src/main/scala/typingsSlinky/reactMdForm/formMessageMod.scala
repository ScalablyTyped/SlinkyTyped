...
object formMessageMod {
  
  @JSImport("@react-md/form/types/text-field/FormMessage", "FormMessage")
  @js.native
  val FormMessage: ForwardRefExoticComponent[FormMessagePropsPartialFo] = js.native
  
  @js.native
  trait FormMessageCounterProps extends StObject {
  ...
  object FormMessageCounterProps {
    ...
    @scala.inline
    implicit class FormMessageCounterPropsMutableBuilder[Self <: FormMessageCounterProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setCounterClassName(value: String): Self = StObject.set(x, "counterClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCounterClassNameUndefined: Self = StObject.set(x, "counterClassName", js.undefined)
      
      @scala.inline
      def setCounterStyle(value: CSSProperties): Self = StObject.set(x, "counterStyle", value.asInstanceOf[js.Any])
  ...
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLDivElement>, 'minLength' | 'maxLength'> */
  @js.native
  trait FormMessageProps extends StObject {
    ...
    /**
      ...
      * `"alert"`.
      */
    var disableWrap: js.UndefOr[Boolean] = js.native
    ...
    /**
      ...
      * `disableWrap={true}`.
      */
    var messageClassName: js.UndefOr[String] = js.native
    ...
    /**
      ...
      */
    var messageStyle: js.UndefOr[CSSProperties] = js.native
    ...
    /**
      ...
      */
    var role: js.UndefOr[alert] = js.native
  ...
  object FormMessageProps {
    ...
    @scala.inline
    def apply(id: String): FormMessageProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[FormMessageProps]
    }
    
    @scala.inline
    implicit class FormMessagePropsMutableBuilder[Self <: FormMessageProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisableWrap(value: Boolean): Self = StObject.set(x, "disableWrap", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableWrapUndefined: Self = StObject.set(x, "disableWrap", js.undefined)
      ...
      @scala.inline
      def setMessageClassName(value: String): Self = StObject.set(x, "messageClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMessageClassNameUndefined: Self = StObject.set(x, "messageClassName", js.undefined)
      
      @scala.inline
      def setMessageStyle(value: CSSProperties): Self = StObject.set(x, "messageStyle", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRole(value: alert): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
