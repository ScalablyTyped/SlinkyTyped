...
object FileInput {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableIconSpacing(value: Boolean): this.type = set("disableIconSpacing", value.asInstanceOf[js.Any])
    
    @scala.inline
    def disableRepeatableFiles(value: Boolean): this.type = set("disableRepeatableFiles", value.asInstanceOf[js.Any])
