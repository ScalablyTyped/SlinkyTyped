...
object TextArea {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def areaClassName(value: String): this.type = set("areaClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def areaStyle(value: CSSProperties): this.type = set("areaStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def resize(value: TextAreaResize): this.type = set("resize", value.asInstanceOf[js.Any])
