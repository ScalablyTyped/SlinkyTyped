...
object TextFieldAddon {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def presentational(value: Boolean): this.type = set("presentational", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TextFieldAddonProps with RefAttributes[HTMLSpanElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
