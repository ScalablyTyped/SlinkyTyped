...
object FormMessage {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def counterClassName(value: String): this.type = set("counterClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def counterStyle(value: CSSProperties): this.type = set("counterStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def disableWrap(value: Boolean): this.type = set("disableWrap", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def messageClassName(value: String): this.type = set("messageClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def messageStyle(value: CSSProperties): this.type = set("messageStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def role(value: alert): this.type = set("role", value.asInstanceOf[js.Any])
    @scala.inline
