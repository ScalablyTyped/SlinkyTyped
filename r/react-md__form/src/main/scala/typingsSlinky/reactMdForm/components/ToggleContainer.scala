...
object ToggleContainer {
  ...
  def withProps(p: ToggleContainerProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ToggleContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
