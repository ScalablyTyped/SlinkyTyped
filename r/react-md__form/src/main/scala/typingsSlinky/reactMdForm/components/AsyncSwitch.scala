...
object AsyncSwitch {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def ballClassName(value: String): this.type = set("ballClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def ballStyle(value: CSSProperties): this.type = set("ballStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def progressClassName(value: String): this.type = set("progressClassName", value.asInstanceOf[js.Any])
