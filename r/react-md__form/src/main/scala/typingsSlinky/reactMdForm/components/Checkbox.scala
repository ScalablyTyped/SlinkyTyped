...
object Checkbox {
  ...
  def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CheckboxProps with RefAttributes[HTMLInputElement]]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableIconOverlay(value: Boolean): this.type = set("disableIconOverlay", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def toggleClassName(value: String): this.type = set("toggleClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def toggleStyle(value: CSSProperties): this.type = set("toggleStyle", value.asInstanceOf[js.Any])
