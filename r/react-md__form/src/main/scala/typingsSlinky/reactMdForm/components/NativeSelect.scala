...
object NativeSelect {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, HTMLSelectElement] {
    @scala.inline
    ...
    @scala.inline
    def selectClassName(value: String): this.type = set("selectClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def selectStyle(value: CSSProperties): this.type = set("selectStyle", value.asInstanceOf[js.Any])
    @scala.inline
