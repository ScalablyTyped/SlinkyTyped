...
object Select {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableLeftAddon(value: Boolean): this.type = set("disableLeftAddon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def displayLabelClassName(value: String): this.type = set("displayLabelClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def displayLabelStyle(value: CSSProperties): this.type = set("displayLabelStyle", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("getDisplayLabel", js.Any.fromFunction3(value))
  ...
  def withProps(p: SelectProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  ...
  def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SelectProps with RefAttributes[HTMLDivElement]]))
  }
}
