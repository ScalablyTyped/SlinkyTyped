...
import typingsSlinky.reactMdForm.passwordMod.ConfigurableVisibilityIcon
...
import typingsSlinky.reactMdForm.reactMdFormStrings.password
...
object Password {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableVisibility(value: Boolean): this.type = set("disableVisibility", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def getVisibilityIcon(value: /* type */ text | password => ReactElement): this.type = set("getVisibilityIcon", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onVisibilityClick(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): this.type = set("onVisibilityClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def visibilityStyle(value: CSSProperties): this.type = set("visibilityStyle", value.asInstanceOf[js.Any])
