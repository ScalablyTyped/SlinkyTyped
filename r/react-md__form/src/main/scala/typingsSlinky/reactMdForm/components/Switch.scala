...
object Switch {
  ...
  def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SwitchProps with RefAttributes[HTMLInputElement]]))
  }
  ...
  def withProps(p: SwitchProps with RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
