...
object Form {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disablePreventDefault(value: Boolean): this.type = set("disablePreventDefault", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FormProps with RefAttributes[HTMLFormElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
