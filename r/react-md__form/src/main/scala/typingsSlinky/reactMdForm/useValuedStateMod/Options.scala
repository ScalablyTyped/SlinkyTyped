...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.reactMdForm.useValuedStateMod.TextElement */ T](): Options[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[T]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_], /* <: typingsSlinky.reactMdForm.useValuedStateMod.TextElement */ T] (val x: Self with Options[T]) extends AnyVal {
    @scala.inline
