...
import typingsSlinky.reactMdForm.listboxMod.ListboxChangeEventData
import typingsSlinky.reactMdForm.listboxMod.ListboxOptions
...
object selectSelectMod {
  ...
  object FakeSelectAttributes {
    ...
    @scala.inline
    implicit class FakeSelectAttributesMutableBuilder[Self <: FakeSelectAttributes] (val x: Self) extends AnyVal {
  ...
  object SelectProps {
    ...
    implicit class SelectPropsMutableBuilder[Self <: SelectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisableLeftAddon(value: Boolean): Self = StObject.set(x, "disableLeftAddon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableLeftAddonUndefined: Self = StObject.set(x, "disableLeftAddon", js.undefined)
      ...
      @scala.inline
      def setDisplayLabelClassName(value: String): Self = StObject.set(x, "displayLabelClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisplayLabelClassNameUndefined: Self = StObject.set(x, "displayLabelClassName", js.undefined)
      
      @scala.inline
      def setDisplayLabelStyle(value: CSSProperties): Self = StObject.set(x, "displayLabelStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisplayLabelStyleUndefined: Self = StObject.set(x, "displayLabelStyle", js.undefined)
      
      @scala.inline
      def setGetDisplayLabel(
        value: (/* option */ ListboxOption, /* labelKey */ String, /* includeLeft */ Boolean) => ReactElement
      ): Self = StObject.set(x, "getDisplayLabel", js.Any.fromFunction3(value))
      
      @scala.inline
      def setGetDisplayLabelUndefined: Self = StObject.set(x, "getDisplayLabel", js.undefined)
