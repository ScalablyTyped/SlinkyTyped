...
object passwordMod {
  ...
  object ConfigurableVisibilityIcon {
    ...
    implicit class ConfigurableVisibilityIconMutableBuilder[Self <: ConfigurableVisibilityIcon] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInvisible(value: ReactElement): Self = StObject.set(x, "invisible", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInvisibleUndefined: Self = StObject.set(x, "invisible", js.undefined)
      
      @scala.inline
      def setVisible(value: ReactElement): Self = StObject.set(x, "visible", value.asInstanceOf[js.Any])
  ...
  type GetVisibilityIcon = js.Function1[/* type */ text | password, ReactElement]
  ...
  trait PasswordProps extends StObject {
    ...
    /**
      ...
      */
    var visibilityIcon: js.UndefOr[ReactElement | ConfigurableVisibilityIcon] = js.native
  ...
  object PasswordProps {
    ...
    implicit class PasswordPropsMutableBuilder[Self <: PasswordProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetVisibilityIcon(value: /* type */ text | password => ReactElement): Self = StObject.set(x, "getVisibilityIcon", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnVisibilityClick(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onVisibilityClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setVisibilityIcon(value: ReactElement | ConfigurableVisibilityIcon): Self = StObject.set(x, "visibilityIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVisibilityIconReactElement(value: ReactElement): Self = StObject.set(x, "visibilityIcon", value.asInstanceOf[js.Any])
