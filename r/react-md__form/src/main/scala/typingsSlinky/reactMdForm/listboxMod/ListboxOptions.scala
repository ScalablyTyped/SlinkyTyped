package typingsSlinky.reactMdForm.listboxMod
...
object ListboxOptions {
  ...
  implicit class ListboxOptionsOps[Self <: ListboxOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetOptionLabel(value: (/* option */ ListboxOption, /* labelKey */ String) => ReactElement): Self = this.set("getOptionLabel", js.Any.fromFunction2(value))
    @scala.inline
