package typingsSlinky.reactMdForm.toggleContainerMod
...
/**
  ...
  */
@JSImport("@react-md/form/types/toggle/ToggleContainer", JSImport.Default)
@js.native
object default extends TopLevel[
      ForwardRefExoticComponent[ToggleContainerProps with RefAttributes[HTMLDivElement]]
    ]
