...
object switchMod {
  ...
  @JSImport("@react-md/form/types/toggle/Switch", "Switch")
  @js.native
  ...
  trait SwitchProps extends StObject {
    ...
    /**
      ...
      */
    var ballClassName: js.UndefOr[String] = js.native
    
    /**
      * An optional style to apply to the switch's ball.
      */
    var ballStyle: js.UndefOr[CSSProperties] = js.native
  ...
  object SwitchProps {
    ...
    @scala.inline
    def apply(id: String): SwitchProps = {
    ...
    implicit class SwitchPropsMutableBuilder[Self <: SwitchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBallClassName(value: String): Self = StObject.set(x, "ballClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBallClassNameUndefined: Self = StObject.set(x, "ballClassName", js.undefined)
      
      @scala.inline
      def setBallStyle(value: CSSProperties): Self = StObject.set(x, "ballStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBallStyleUndefined: Self = StObject.set(x, "ballStyle", js.undefined)
      ...
      @scala.inline
      def setLabelDisabled(value: Boolean): Self = StObject.set(x, "labelDisabled", value.asInstanceOf[js.Any])
