...
object anon {
  ...
  object FormMessagePropsPartialFo {
    ...
    @scala.inline
    implicit class FormMessagePropsPartialFoMutableBuilder[Self <: FormMessagePropsPartialFo] (val x: Self) extends AnyVal {
  ...
  /* Inlined @react-md/form.@react-md/form/types/toggle/InputToggle.InputToggleProps & {  type :'checkbox',   indeterminate :boolean | undefined} & react.react.RefAttributes<std.HTMLInputElement> */
  @js.native
  trait InputTogglePropstypecheck extends StObject {
  ...
  object InputTogglePropstypecheck {
    ...
    @scala.inline
    def apply(id: String, `type`: checkbox): InputTogglePropstypecheck = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[InputTogglePropstypecheck]
    }
    
    @scala.inline
    implicit class InputTogglePropstypecheckMutableBuilder[Self <: InputTogglePropstypecheck] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait InputTogglePropstyperadio extends StObject {
  ...
  object InputTogglePropstyperadio {
    ...
    @scala.inline
    implicit class InputTogglePropstyperadioMutableBuilder[Self <: InputTogglePropstyperadio] (val x: Self) extends AnyVal {
  ...
  object OmitHTMLAttributesHTMLDiv {
    ...
    @scala.inline
    implicit class OmitHTMLAttributesHTMLDivMutableBuilder[Self <: OmitHTMLAttributesHTMLDiv] (val x: Self) extends AnyVal {
