...
object PasswordProps {
  ...
  implicit class PasswordPropsOps[Self <: PasswordProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetVisibilityIcon(value: /* type */ text | password => ReactElement): Self = this.set("getVisibilityIcon", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnVisibilityClick(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("onVisibilityClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setVisibilityIconReactElement(value: ReactElement): Self = this.set("visibilityIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVisibilityIcon(value: ReactElement | ConfigurableVisibilityIcon): Self = this.set("visibilityIcon", value.asInstanceOf[js.Any])
