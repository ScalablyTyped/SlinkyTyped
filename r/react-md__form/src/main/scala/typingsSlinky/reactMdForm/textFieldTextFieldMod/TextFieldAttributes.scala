package typingsSlinky.reactMdForm.textFieldTextFieldMod
...
/* Inlined std.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, 'type'> */
@js.native
trait TextFieldAttributes extends js.Object {
...
object TextFieldAttributes {
  
  @scala.inline
  def apply(): TextFieldAttributes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextFieldAttributes]
  }
  
  @scala.inline
  implicit class TextFieldAttributesOps[Self <: TextFieldAttributes] (val x: Self) extends AnyVal {
