...
object RoxSetupOptions {
  ...
  implicit class RoxSetupOptionsOps[Self <: RoxSetupOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFetchIntervalInSec(value: Double): Self = this.set("fetchIntervalInSec", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFetchIntervalInSec: Self = this.set("fetchIntervalInSec", js.undefined)
    @scala.inline
