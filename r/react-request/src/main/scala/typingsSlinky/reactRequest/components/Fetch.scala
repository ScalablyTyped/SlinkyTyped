...
object Fetch
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRequest.mod.Fetch[js.Any]] {
  ...
  def apply[T](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRequest.mod.Fetch[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactRequest.mod.Fetch[js.Any]]]
  }
