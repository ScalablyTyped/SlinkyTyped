...
trait FetchProps[T] extends FetchRequestProps {
  ...
  var children: js.UndefOr[js.Function1[/* renderProps */ RenderProps[T], ReactElement]] = js.native
...
object FetchProps {
  ...
  implicit class FetchPropsOps[Self <: FetchProps[_], T] (val x: Self with FetchProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: /* renderProps */ RenderProps[T] => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
