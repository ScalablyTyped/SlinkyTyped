...
object FeedOptions {
  ...
  implicit class FeedOptionsOps[Self <: FeedOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPubDateDate(value: js.Date): Self = this.set("pubDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPubDate(value: js.Date | String): Self = this.set("pubDate", value.asInstanceOf[js.Any])
