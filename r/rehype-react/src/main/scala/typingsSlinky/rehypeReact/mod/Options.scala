...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFragmentFunctionComponent(value: ReactComponentClass[Children]): Self = this.set("Fragment", value.asInstanceOf[js.Any])
    @scala.inline
    def setFragmentComponentClass(value: ReactComponentClass[Children]): Self = this.set("Fragment", value.asInstanceOf[js.Any])
    @scala.inline
    def setFragment(value: ReactComponentClass[Children]): Self = this.set("Fragment", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFragment: Self = this.set("Fragment", js.undefined)
    @scala.inline
    def setComponents(value: StringDictionary[ReactComponentClass[_]]): Self = this.set("components", value.asInstanceOf[js.Any])
    @scala.inline
