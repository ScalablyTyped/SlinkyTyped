...
object Header
  ...
  typingsSlinky.reactDashNativeDashSettingsDashList.reactDashNativeDashSettingsDashListMod.default.Header](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
