package typingsSlinky.reactDashNativeDashSettingsDashList.reactDashNativeDashSettingsDashListMod
...
trait ItemProps extends js.Object {
  var arrowIcon: js.UndefOr[TagMod[Any]] = js.undefined
  ...
  /**
    * Right side content
    */
  var rightSideContent: js.UndefOr[TagMod[Any]] = js.undefined
  /**
    * Right Side Style
    */
