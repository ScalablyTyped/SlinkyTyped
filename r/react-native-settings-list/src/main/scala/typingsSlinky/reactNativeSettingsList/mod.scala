...
object mod {
  ...
  trait ItemProps extends StObject {
    ...
    var arrowIcon: js.UndefOr[ReactElement] = js.native
    ...
    /**
      * Right side content
      */
    var rightSideContent: js.UndefOr[ReactElement] = js.native
  ...
  object ItemProps {
    ...
    implicit class ItemPropsMutableBuilder[Self <: ItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArrowIcon(value: ReactElement): Self = StObject.set(x, "arrowIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setArrowIconReactElement(value: ReactElement): Self = StObject.set(x, "arrowIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRightSideContent(value: ReactElement): Self = StObject.set(x, "rightSideContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRightSideContentReactElement(value: ReactElement): Self = StObject.set(x, "rightSideContent", value.asInstanceOf[js.Any])
  ...
  object SettingsList {
    ...
    type Header = ReactComponentClass[HeaderProps]
    
    type Item = ReactComponentClass[ItemProps]
  }
  type SettingsList = ReactComponentClass[SettingsListProps]
