...
object ItemProps {
  ...
  implicit class ItemPropsOps[Self <: ItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrowIconReactElement(value: ReactElement): Self = this.set("arrowIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def setArrowIcon(value: ReactElement): Self = this.set("arrowIcon", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRightSideContentReactElement(value: ReactElement): Self = this.set("rightSideContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setRightSideContent(value: ReactElement): Self = this.set("rightSideContent", value.asInstanceOf[js.Any])
    @scala.inline
