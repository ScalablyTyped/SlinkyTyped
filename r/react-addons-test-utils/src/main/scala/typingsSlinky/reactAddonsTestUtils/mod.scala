...
object mod {
  ...
  @js.native
  def isCompositeComponentWithType[T /* <: ReactComponentClass[_] */, C /* <: ReactComponentClass[_] */](instance: ReactInstance, `type`: ClassType[_, T, C]): T = js.native
  
  @JSImport("react-addons-test-utils", "isDOMComponent")
  @js.native
  ...
  @JSImport("react-addons-test-utils", "renderIntoDocument")
  @js.native
  def renderIntoDocument[T /* <: ReactComponentClass[_] */](element: CElement[_, T]): T = js.native
  @JSImport("react-addons-test-utils", "renderIntoDocument")
  @js.native
  ...
  @JSImport("react-addons-test-utils", "scryRenderedDOMComponentsWithClass")
  @js.native
  def scryRenderedDOMComponentsWithClass(root: ReactComponentClass[_], className: String): js.Array[Element] = js.native
  
  @JSImport("react-addons-test-utils", "scryRenderedDOMComponentsWithTag")
  @js.native
