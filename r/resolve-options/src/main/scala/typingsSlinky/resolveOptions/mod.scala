...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSince(value: js.Date | Double | (js.Function1[/* repeated */ js.Any, js.Date | Double])): Self = StObject.set(x, "since", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSinceDate(value: js.Date): Self = StObject.set(x, "since", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSinceFunction1(value: /* repeated */ js.Any => js.Date | Double): Self = StObject.set(x, "since", js.Any.fromFunction1(value))
  ...
  object Resolver {
    ...
    implicit class ResolverMutableBuilder[Self <: Resolver] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResolve(value: String => js.UndefOr[Double | String | Boolean | js.Date | Null]): Self = StObject.set(x, "resolve", js.Any.fromFunction1(value))
    }
  }
}
