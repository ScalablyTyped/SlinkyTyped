...
trait Options extends js.Object {
  ...
  var since: js.UndefOr[js.Date | Double | (js.Function1[/* repeated */ js.Any, js.Date | Double])] = js.undefined
}
...
object Options {
  ...
  def apply(
    ...
    since: js.Date | Double | (js.Function1[/* repeated */ js.Any, js.Date | Double]) = null
  ): Options = {
