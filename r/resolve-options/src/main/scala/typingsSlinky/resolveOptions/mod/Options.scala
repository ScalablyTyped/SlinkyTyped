...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSinceFunction1(value: /* repeated */ js.Any => js.Date | Double): Self = this.set("since", js.Any.fromFunction1(value))
    @scala.inline
    def setSince(value: js.Date | Double | (js.Function1[/* repeated */ js.Any, js.Date | Double])): Self = this.set("since", value.asInstanceOf[js.Any])
    @scala.inline
