...
object NavigationBarProps {
  ...
  implicit class NavigationBarPropsOps[Self <: NavigationBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeftButtonReactElement(value: ReactElement): Self = this.set("leftButton", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRightButtonReactElement(value: ReactElement): Self = this.set("rightButton", value.asInstanceOf[js.Any])
