...
object SpeechBubble {
  ...
  implicit def make(companion: SpeechBubble.type): SharedBuilder_KawaiiProps1805116402 = new SharedBuilder_KawaiiProps1805116402(js.Array(this.component, js.Dictionary.empty))()
}
