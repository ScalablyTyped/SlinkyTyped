...
import typingsSlinky.atRdfjsSerializerDashJsonld.atRdfjsSerializerDashJsonldStrings.`object`
import typingsSlinky.atRdfjsSerializerDashJsonld.atRdfjsSerializerDashJsonldStrings.string
