...
object ReplicationReplicaSyncOnInfo {
  ...
  implicit class ReplicationReplicaSyncOnInfoOps[Self <: ReplicationReplicaSyncOnInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaster_sync_in_progress(value: ON): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("master_sync_in_progress")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMaster_sync_last_io_seconds_ago(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("master_sync_last_io_seconds_ago")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMaster_sync_left_bytes(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("master_sync_left_bytes")(value.asInstanceOf[js.Any])
        ret
    }
  }
