...
object LinkStatus extends StObject {
  ...
  /* "down" */ val DOWN: typingsSlinky.redisInfo.mod.LinkStatus.DOWN with String = js.native
  
  @js.native
  sealed trait UP extends LinkStatus
  /* "up" */ val UP: typingsSlinky.redisInfo.mod.LinkStatus.UP with String = js.native
}
