...
object Class
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashCssDashTransitionDashReplace.reactDashCssDashTransitionDashReplaceMod.Class
    ] {
  ...
  typingsSlinky.reactDashCssDashTransitionDashReplace.reactDashCssDashTransitionDashReplaceMod.Class](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
