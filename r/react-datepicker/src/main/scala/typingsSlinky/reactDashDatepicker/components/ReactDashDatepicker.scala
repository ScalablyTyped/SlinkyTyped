package typingsSlinky.reactDashDatepicker.components
...
import typingsSlinky.reactDashDatepicker.Anon_Children
import typingsSlinky.reactDashDatepicker.Anon_Code
...
import typingsSlinky.reactDashDatepicker.reactDashDatepickerMod.default
...
object ReactDashDatepicker
  ...
  /* The following DOM/SVG props were specified: autoComplete, autoFocus, className, disabled, id, name, onBlur, onFocus, onKeyDown, open, readOnly, required, tabIndex */
  def apply(
    ...
    onInputError: /* err */ Anon_Code => Unit = null,
    onMonthChange: /* date */ js.Date => Unit = null,
    onMonthMouseLeave: () => Unit = null,
    onSelect: (/* date */ js.Date, /* event */ js.UndefOr[SyntheticEvent[Event, _]]) => Unit = null,
    onWeekSelect: (/* firstDayOfWeek */ js.Date, /* weekNumber */ String | Double, /* event */ js.UndefOr[SyntheticEvent[Event, _]]) => Unit = null,
    ...
    popperContainer: /* props */ Anon_Children => TagMod[Any] = null,
    ...
    renderCustomHeader: /* params */ Anon_ChangeMonth => TagMod[Any] = null,
