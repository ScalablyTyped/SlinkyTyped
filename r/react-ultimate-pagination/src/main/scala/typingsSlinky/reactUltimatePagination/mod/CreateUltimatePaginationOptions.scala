...
object CreateUltimatePaginationOptions {
  ...
  implicit class CreateUltimatePaginationOptionsOps[Self <: CreateUltimatePaginationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWrapperComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("WrapperComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWrapperComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("WrapperComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWrapperComponent(value: String | ReactComponentClass[_]): Self = this.set("WrapperComponent", value.asInstanceOf[js.Any])
