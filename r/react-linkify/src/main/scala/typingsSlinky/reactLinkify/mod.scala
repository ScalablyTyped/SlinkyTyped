...
object mod {
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentDecorator(value: (/* decoratedHref */ String, /* decoratedText */ String, /* key */ Double) => ReactElement): Self = StObject.set(x, "componentDecorator", js.Any.fromFunction3(value))
  ...
  type ReactLinkify = ReactComponentClass[Props]
}
