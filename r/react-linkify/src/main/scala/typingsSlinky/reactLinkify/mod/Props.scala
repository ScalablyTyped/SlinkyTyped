...
trait Props extends js.Object {
  ...
  var componentDecorator: js.UndefOr[
    js.Function3[/* decoratedHref */ String, /* decoratedText */ String, /* key */ Double, ReactElement]
  ] = js.native
  /**
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentDecorator(value: (/* decoratedHref */ String, /* decoratedText */ String, /* key */ Double) => ReactElement): Self = this.set("componentDecorator", js.Any.fromFunction3(value))
    @scala.inline
