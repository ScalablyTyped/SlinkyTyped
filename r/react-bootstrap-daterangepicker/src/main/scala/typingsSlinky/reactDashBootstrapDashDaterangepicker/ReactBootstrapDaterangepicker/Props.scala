package typingsSlinky.reactDashBootstrapDashDaterangepicker.ReactBootstrapDaterangepicker
...
import typingsSlinky.daterangepicker.daterangepickerMod.Options
