...
import typingsSlinky.reactBootstrapDaterangepicker.global.ReactBootstrapDaterangepicker.DateRangePicker
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ReactBootstrapDaterangepickerDateRangePicker {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, DateRangePicker] {
    @scala.inline
  ...
  implicit def make(companion: ReactBootstrapDaterangepickerDateRangePicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
