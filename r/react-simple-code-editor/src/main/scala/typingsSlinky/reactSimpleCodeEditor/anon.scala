...
object anon {
  ...
  trait DetailedHTMLPropsHTMLAttr extends StObject {
    ...
    def highlight(value: String): String | ReactElement = js.native
    ...
    var onBlur: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticFocusEvent[HTMLTextAreaElement], Unit]]) = js.native
    ...
    var onClick: js.UndefOr[MouseEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[HTMLTextAreaElement], Unit]]) = js.native
    ...
    // Focus Events
    var onFocus: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticFocusEvent[HTMLTextAreaElement], Unit]]) = js.native
    ...
    // also a Media Event
    // Keyboard Events
    var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticKeyboardEvent[HTMLTextAreaElement], Unit]]) = js.native
    
    var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] = js.native
    
    var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticKeyboardEvent[HTMLTextAreaElement], Unit]]) = js.native
  ...
  object DetailedHTMLPropsHTMLAttr {
    ...
    implicit class DetailedHTMLPropsHTMLAttrMutableBuilder[Self <: DetailedHTMLPropsHTMLAttr] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHighlight(value: String => String | ReactElement): Self = StObject.set(x, "highlight", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnBlur(
        value: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticFocusEvent[HTMLTextAreaElement], Unit]])
      ...
      @scala.inline
      def setOnClick(
        value: js.UndefOr[MouseEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[HTMLTextAreaElement], Unit]])
      ...
      @scala.inline
      def setOnKeyDown(
        value: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ SyntheticKeyboardEvent[HTMLTextAreaElement], Unit]])
