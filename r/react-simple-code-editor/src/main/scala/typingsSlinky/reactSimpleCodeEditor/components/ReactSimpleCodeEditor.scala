...
object ReactSimpleCodeEditor {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def ignoreTabKey(value: Boolean): this.type = set("ignoreTabKey", value.asInstanceOf[js.Any])
    @scala.inline
    def inlist(value: js.Any): this.type = set("inlist", value.asInstanceOf[js.Any])
    @scala.inline
    def inputMode(value: none | text | tel | url | email | numeric | decimal | search): this.type = set("inputMode", value.asInstanceOf[js.Any])
    @scala.inline
    def insertSpaces(value: Boolean): this.type = set("insertSpaces", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def textareaId(value: String): this.type = set("textareaId", value.asInstanceOf[js.Any])
    @scala.inline
