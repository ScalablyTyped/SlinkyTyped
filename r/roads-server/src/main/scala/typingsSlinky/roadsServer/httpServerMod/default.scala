...
class default protected () extends Server {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var server: typingsSlinky.node.httpMod.Server = js.native
  /**
    ...
    */
  /* CompleteClass */
  /* protected */ override def error_handler(http_response: ServerResponse, error: js.Error): Unit = js.native
  /**
