package typingsSlinky.roadsServer.httpServerMod
...
trait Server extends js.Object {
  ...
  /**
    ...
    * @type HTTPServer
    */
  var server: typingsSlinky.node.httpMod.Server
  /**
