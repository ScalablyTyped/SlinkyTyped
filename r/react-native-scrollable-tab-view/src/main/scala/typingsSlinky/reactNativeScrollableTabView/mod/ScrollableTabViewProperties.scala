...
object ScrollableTabViewProperties {
  ...
  implicit class ScrollableTabViewPropertiesOps[Self <: ScrollableTabViewProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderTabBarFunction1(value: /* props */ typingsSlinky.reactNativeScrollableTabView.anon.TabBarProps => ReactElement): Self = this.set("renderTabBar", js.Any.fromFunction1(value))
