...
object drawerRouterMod {
  ...
  */
  ...
  object DrawerActionType {
    ...
    @scala.inline
    def SourceTarget(`type`: OPEN_DRAWER | CLOSE_DRAWER | TOGGLE_DRAWER): typingsSlinky.reactNavigationRouters.anon.SourceTarget = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactNavigationRouters.anon.SourceTarget]
    }
    
    @scala.inline
    def TabActionType(payload: NameParams, `type`: JUMP_TO): typingsSlinky.reactNavigationRouters.tabRouterMod.TabActionType = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactNavigationRouters.tabRouterMod.TabActionType]
    }
  }
