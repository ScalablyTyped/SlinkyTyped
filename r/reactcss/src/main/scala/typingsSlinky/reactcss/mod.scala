package typingsSlinky.reactcss
...
object mod {
  ...
  @js.native
  def hover[A](component: ComponentClass[A, js.Object]): ReactComponentClass[A] = js.native
  @JSImport("reactcss", "hover")
  @js.native
  def hover[A](component: StatelessComponent[A]): ReactComponentClass[A] = js.native
