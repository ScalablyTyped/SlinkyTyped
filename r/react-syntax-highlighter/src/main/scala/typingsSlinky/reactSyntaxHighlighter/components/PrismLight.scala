...
import typingsSlinky.reactSyntaxHighlighter.esmPrismLightMod.default
...
object PrismLight {
  ...
  implicit def make(companion: PrismLight.type): SharedBuilder_SyntaxHighlighterProps_1113076166[default] = new SharedBuilder_SyntaxHighlighterProps_1113076166[default](js.Array(this.component, js.Dictionary.empty))()
}
