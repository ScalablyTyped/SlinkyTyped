...
object mod {
  ...
  @js.native
  class default ()
    extends typingsSlinky.reactSyntaxHighlighter.esmDefaultHighlightMod.default
  
  @JSImport("react-syntax-highlighter", "Light")
  @js.native
  class Light ()
    extends typingsSlinky.reactSyntaxHighlighter.esmLightMod.default
  /* static members */
  object Light {
  ...
  @js.native
  class LightAsync ()
    extends typingsSlinky.reactSyntaxHighlighter.esmLightAsyncMod.default
  /* static members */
  object LightAsync {
  ...
  @js.native
  class Prism ()
    extends typingsSlinky.reactSyntaxHighlighter.esmPrismMod.default
  
  @JSImport("react-syntax-highlighter", "PrismAsync")
  @js.native
  class PrismAsync ()
    extends typingsSlinky.reactSyntaxHighlighter.esmPrismAsyncMod.default
  
  @JSImport("react-syntax-highlighter", "PrismAsyncLight")
  @js.native
  class PrismAsyncLight ()
    extends typingsSlinky.reactSyntaxHighlighter.esmPrismAsyncLightMod.default
  /* static members */
  ...
  @js.native
  class PrismLight ()
    extends typingsSlinky.reactSyntaxHighlighter.esmPrismLightMod.default
  /* static members */
  object PrismLight {
