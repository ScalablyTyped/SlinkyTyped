...
trait ReactNotificationOptions extends js.Object {
  ...
  var content: js.UndefOr[ReactComponentClass[js.Object] | TagMod[Any]] = js.undefined
  var dismiss: js.UndefOr[DismissOptions] = js.undefined
  var id: js.UndefOr[String] = js.undefined
  var insert: js.UndefOr[top | bottom] = js.undefined
  var message: js.UndefOr[String | TagMod[Any] | ReactComponentClass[js.Object]] = js.undefined
  ...
  var title: js.UndefOr[String | TagMod[Any] | ReactComponentClass[js.Object]] = js.undefined
...
object ReactNotificationOptions {
  ...
  def apply(
    ...
    content: ReactComponentClass[js.Object] | TagMod[Any] = null,
    dismiss: DismissOptions = null,
    id: String = null,
    insert: top | bottom = null,
    message: String | TagMod[Any] | ReactComponentClass[js.Object] = null,
    onRemoval: (/* id */ String, /* removedBy */ js.Any) => Unit = null,
    slidingEnter: TransitionOptions = null,
    slidingExit: TransitionOptions = null,
    title: String | TagMod[Any] | ReactComponentClass[js.Object] = null,
    touchRevert: TransitionOptions = null,
    touchSlidingExit: TransitionOptions = null,
    `type`: success | danger | info | typingsSlinky.reactNotificationsComponent.reactNotificationsComponentStrings.default | warning = null,
