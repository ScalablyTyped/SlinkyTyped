package typingsSlinky.rotDashJs.libSchedulerSchedulerMod
...
trait Scheduler[T] extends js.Object {
  var _current: js.Any
  var _queue: typingsSlinky.rotDashJs.libEventqueueMod.default[T]
...
object Scheduler {
  ...
  def apply[T](
    _current: js.Any,
    _queue: typingsSlinky.rotDashJs.libEventqueueMod.default[T],
    _repeat: js.Array[T],
