package typingsSlinky.rotDashJs.libEngineMod
...
trait Engine extends js.Object {
  var _lock: Double
  var _scheduler: typingsSlinky.rotDashJs.libSchedulerSchedulerMod.default[_]
  /**
...
object Engine {
  ...
  def apply(
    _lock: Double,
    _scheduler: typingsSlinky.rotDashJs.libSchedulerSchedulerMod.default[_],
    lock: () => Engine,
    start: () => Engine,
    unlock: () => Engine
  ): Engine = {
