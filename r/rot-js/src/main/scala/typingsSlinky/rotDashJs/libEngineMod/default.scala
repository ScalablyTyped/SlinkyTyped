...
class default protected () extends Engine {
  def this(scheduler: typingsSlinky.rotDashJs.libSchedulerSchedulerMod.default[_]) = this()
  /* CompleteClass */
  override var _lock: Double = js.native
  /* CompleteClass */
  override var _scheduler: typingsSlinky.rotDashJs.libSchedulerSchedulerMod.default[_] = js.native
  /**
