...
class default protected () extends Engine {
  def this(scheduler: typingsSlinky.rotJs.schedulerSchedulerMod.default[_]) = this()
  /* CompleteClass */
  override var _lock: Double = js.native
  /* CompleteClass */
  override var _scheduler: typingsSlinky.rotJs.schedulerSchedulerMod.default[_] = js.native
  /**
