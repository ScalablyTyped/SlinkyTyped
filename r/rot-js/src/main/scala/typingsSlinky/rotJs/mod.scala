...
object mod {
  ...
  object Color {
    ...
    @js.native
    def interpolate(
      color1: typingsSlinky.rotJs.colorMod.Color,
      color2: typingsSlinky.rotJs.colorMod.Color,
      factor: Double
    ): typingsSlinky.rotJs.colorMod.Color = js.native
    
    @JSImport("rot-js", "Color.interpolateHSL")
    @js.native
    def interpolateHSL(color1: typingsSlinky.rotJs.colorMod.Color, color2: typingsSlinky.rotJs.colorMod.Color): typingsSlinky.rotJs.colorMod.Color = js.native
    @JSImport("rot-js", "Color.interpolateHSL")
    @js.native
    def interpolateHSL(
      color1: typingsSlinky.rotJs.colorMod.Color,
    ...
    @js.native
    def multiply(color1: typingsSlinky.rotJs.colorMod.Color, colors: typingsSlinky.rotJs.colorMod.Color*): typingsSlinky.rotJs.colorMod.Color = js.native
    
    @JSImport("rot-js", "Color.multiply_")
    @js.native
    def multiply_(color1: typingsSlinky.rotJs.colorMod.Color, colors: typingsSlinky.rotJs.colorMod.Color*): typingsSlinky.rotJs.colorMod.Color = js.native
    
    @JSImport("rot-js", "Color.randomize")
    @js.native
    def randomize(color: typingsSlinky.rotJs.colorMod.Color, diff: Double): typingsSlinky.rotJs.colorMod.Color = js.native
    @JSImport("rot-js", "Color.randomize")
    @js.native
    def randomize(color: typingsSlinky.rotJs.colorMod.Color, diff: typingsSlinky.rotJs.colorMod.Color): typingsSlinky.rotJs.colorMod.Color = js.native
    
    @JSImport("rot-js", "Color.rgb2hsl")
    @js.native
    def rgb2hsl(color: typingsSlinky.rotJs.colorMod.Color): typingsSlinky.rotJs.colorMod.Color = js.native
    
    @JSImport("rot-js", "Color.toHex")
    @js.native
    def toHex(color: typingsSlinky.rotJs.colorMod.Color): String = js.native
    
    @JSImport("rot-js", "Color.toRGB")
    @js.native
    def toRGB(color: typingsSlinky.rotJs.colorMod.Color): String = js.native
  }
  ...
  class Engine protected ()
    extends typingsSlinky.rotJs.engineMod.default {
  ...
  /**
    ...
    */
  class EventQueue[T] ()
    extends typingsSlinky.rotJs.eventqueueMod.default[T]
  ...
  class Lighting protected ()
    extends typingsSlinky.rotJs.lightingMod.default {
  ...
  object Noise {
    ...
    @JSImport("rot-js", "Noise.Simplex")
    @js.native
    def Simplex: Instantiable1[/* gradients */ js.UndefOr[Double], typingsSlinky.rotJs.simplexMod.default] = js.native
    @scala.inline
    def Simplex_=(x: Instantiable1[/* gradients */ js.UndefOr[Double], typingsSlinky.rotJs.simplexMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Simplex")(x.asInstanceOf[js.Any])
  }
  ...
  @JSImport("rot-js", "RNG")
  @js.native
  val RNG: typingsSlinky.rotJs.rngMod.RNG = js.native
  ...
  object Scheduler {
    ...
    @JSImport("rot-js", "Scheduler.Action")
    @js.native
    def Action: Instantiable0[typingsSlinky.rotJs.actionMod.default[js.Object]] = js.native
    @scala.inline
    def Action_=(x: Instantiable0[typingsSlinky.rotJs.actionMod.default[js.Object]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Action")(x.asInstanceOf[js.Any])
    ...
    @JSImport("rot-js", "Scheduler.Simple")
    @js.native
    def Simple: Instantiable0[typingsSlinky.rotJs.simpleMod.default[js.Object]] = js.native
    @scala.inline
    def Simple_=(x: Instantiable0[typingsSlinky.rotJs.simpleMod.default[js.Object]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Simple")(x.asInstanceOf[js.Any])
    ...
    @JSImport("rot-js", "Scheduler.Speed")
    @js.native
    def Speed: Instantiable0[typingsSlinky.rotJs.speedMod.default[SpeedActor]] = js.native
    @scala.inline
    def Speed_=(x: Instantiable0[typingsSlinky.rotJs.speedMod.default[SpeedActor]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Speed")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("rot-js", "StringGenerator")
  @js.native
  class StringGenerator protected ()
    extends typingsSlinky.rotJs.stringgeneratorMod.default {
