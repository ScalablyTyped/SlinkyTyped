...
object displayMod {
  ...
  object default {
    ...
    @js.native
    def Hex: Instantiable0[typingsSlinky.rotJs.hexMod.default] = js.native
    @scala.inline
    def Hex_=(x: Instantiable0[typingsSlinky.rotJs.hexMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Hex")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def Term: Instantiable0[typingsSlinky.rotJs.termMod.default] = js.native
    @scala.inline
    def Term_=(x: Instantiable0[typingsSlinky.rotJs.termMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Term")(x.asInstanceOf[js.Any])
    
    @JSImport("rot-js/lib/display/display", "default.Tile")
    @js.native
    def Tile: Instantiable0[typingsSlinky.rotJs.tileMod.default] = js.native
    ...
    @scala.inline
    def Tile_=(x: Instantiable0[typingsSlinky.rotJs.tileMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Tile")(x.asInstanceOf[js.Any])
  }
  ...
  trait Display extends StObject {
    ...
    var _backend: typingsSlinky.rotJs.backendMod.default = js.native
