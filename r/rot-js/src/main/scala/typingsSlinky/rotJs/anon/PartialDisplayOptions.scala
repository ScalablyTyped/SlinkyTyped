...
object PartialDisplayOptions {
  ...
  implicit class PartialDisplayOptionsOps[Self <: PartialDisplayOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTileSetHTMLVideoElement(value: HTMLVideoElement): Self = this.set("tileSet", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTileSetHTMLImageElement(value: HTMLImageElement): Self = this.set("tileSet", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTileSetHTMLCanvasElement(value: HTMLCanvasElement): Self = this.set("tileSet", value.asInstanceOf[js.Any])
