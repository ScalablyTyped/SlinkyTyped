...
import typingsSlinky.pdfjsDashDist.pdfjsDashDistMod.PDFPageProxy
import typingsSlinky.react.reactMod.LegacyRef
import typingsSlinky.reactDashPdf.distPageMod.LoadingProcessData
import typingsSlinky.reactDashPdf.distPageMod.RenderFunction
import typingsSlinky.reactDashPdf.distPageMod.TextItem
import typingsSlinky.reactDashPdf.distPageMod.TextLayerItemInternal
import typingsSlinky.reactDashPdf.distPageMod.default
...
object Page
  ...
  def apply(
    ...
    customTextRenderer: /* layer */ TextLayerItemInternal => typingsSlinky.react.reactMod._Global_.JSX.Element = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashPdf.distPageMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = typingsSlinky.reactDashPdf.distPageMod.Props
}
