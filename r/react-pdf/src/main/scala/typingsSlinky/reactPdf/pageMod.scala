...
import typingsSlinky.pdfjsDist.mod.PDFAnnotations
import typingsSlinky.pdfjsDist.mod.PDFPageViewport
import typingsSlinky.pdfjsDist.mod.PDFPromise
import typingsSlinky.pdfjsDist.mod.PDFRef
import typingsSlinky.pdfjsDist.mod.PDFRenderParams
import typingsSlinky.pdfjsDist.mod.PDFRenderTask
import typingsSlinky.pdfjsDist.mod.TextContent
import typingsSlinky.pdfjsDist.mod.ViewportParameters
...
object pageMod {
  ...
  @js.native
  trait PDFPageProxy
    extends typingsSlinky.pdfjsDist.mod.PDFPageProxy {
  ...
  type Page = ReactComponentClass[Props]
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomTextRenderer(value: /* layer */ TextLayerItemInternal => ReactElement): Self = StObject.set(x, "customTextRenderer", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setErrorFunction0(value: () => ReactElement): Self = StObject.set(x, "error", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setInputRefRefObject(value: ReactRef[HTMLDivElement]): Self = StObject.set(x, "inputRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLoadingFunction0(value: () => ReactElement): Self = StObject.set(x, "loading", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setNoDataFunction0(value: () => ReactElement): Self = StObject.set(x, "noData", js.Any.fromFunction0(value))
      
      @scala.inline
      def setNoDataReactElement(value: ReactElement): Self = StObject.set(x, "noData", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNoDataUndefined: Self = StObject.set(x, "noData", js.undefined)
      
      @scala.inline
      def setOnGetAnnotationsError(value: /* error */ js.Error => Unit): Self = StObject.set(x, "onGetAnnotationsError", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnGetTextError(value: /* error */ js.Error => Unit): Self = StObject.set(x, "onGetTextError", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnRenderError(value: /* error */ js.Error => Unit): Self = StObject.set(x, "onRenderError", js.Any.fromFunction1(value))
