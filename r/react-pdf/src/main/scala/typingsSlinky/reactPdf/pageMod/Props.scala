...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomTextRenderer(value: /* layer */ TextLayerItemInternal => ReactElement): Self = this.set("customTextRenderer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setErrorFunction0(value: () => ReactElement): Self = this.set("error", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setInputRefRefObject(value: ReactRef[HTMLDivElement]): Self = this.set("inputRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLoadingFunction0(value: () => ReactElement): Self = this.set("loading", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setNoDataReactElement(value: ReactElement): Self = this.set("noData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNoDataFunction0(value: () => ReactElement): Self = this.set("noData", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setOnGetAnnotationsError(value: /* error */ js.Error => Unit): Self = this.set("onGetAnnotationsError", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnGetTextError(value: /* error */ js.Error => Unit): Self = this.set("onGetTextError", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnLoadError(value: /* error */ js.Error => Unit): Self = this.set("onLoadError", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnRenderError(value: /* error */ js.Error => Unit): Self = this.set("onRenderError", js.Any.fromFunction1(value))
