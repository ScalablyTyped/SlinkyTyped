...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo__react-components" % "3.1.5-d71312",
  "org.scalablytyped.slinky" %%% "apollo__react-hoc" % "3.1.5-b9d457",
  "org.scalablytyped.slinky" %%% "apollo__react-hooks" % "3.1.5-f31cba",
  "org.scalablytyped.slinky" %%% "apollo__react-ssr" % "3.1.5-a1f307",
