...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo__react-components" % "3.1.3-535fce",
  "org.scalablytyped.slinky" %%% "apollo__react-hoc" % "3.1.3-49d382",
  "org.scalablytyped.slinky" %%% "apollo__react-hooks" % "3.1.3-65e8ba",
  "org.scalablytyped.slinky" %%% "apollo__react-ssr" % "3.1.3-454bca",
