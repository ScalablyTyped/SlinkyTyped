...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo__react-components" % "3.1.3-c3bcd3",
  "org.scalablytyped.slinky" %%% "apollo__react-hoc" % "3.1.3-8af413",
  "org.scalablytyped.slinky" %%% "apollo__react-hooks" % "3.1.3-2aef21",
  "org.scalablytyped.slinky" %%% "apollo__react-ssr" % "3.1.3-60cc04",
