...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo__react-common" % "3.1.4-c4c427",
  "org.scalablytyped.slinky" %%% "apollo__react-components" % "3.1.5-4131b2",
  "org.scalablytyped.slinky" %%% "apollo__react-hoc" % "3.1.5-c34d52",
  "org.scalablytyped.slinky" %%% "apollo__react-hooks" % "3.1.5-fd9f76",
  "org.scalablytyped.slinky" %%% "apollo__react-ssr" % "3.1.5-fd79f4",
