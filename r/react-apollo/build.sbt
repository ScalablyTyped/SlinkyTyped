...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo__react-components" % "3.1.3-6e95ef",
  "org.scalablytyped.slinky" %%% "apollo__react-hoc" % "3.1.3-239b27",
  "org.scalablytyped.slinky" %%% "apollo__react-hooks" % "3.1.3-c35b20",
  "org.scalablytyped.slinky" %%% "apollo__react-ssr" % "3.1.3-c43c53",
