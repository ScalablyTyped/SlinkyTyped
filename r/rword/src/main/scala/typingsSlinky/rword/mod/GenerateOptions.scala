...
object GenerateOptions {
  ...
  implicit class GenerateOptionsOps[Self <: GenerateOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainsRegExp(value: js.RegExp): Self = this.set("contains", value.asInstanceOf[js.Any])
    @scala.inline
    def setContains(value: js.RegExp | String): Self = this.set("contains", value.asInstanceOf[js.Any])
    @scala.inline
