...
object mod {
  ...
  object GenerateOptions {
    ...
    implicit class GenerateOptionsMutableBuilder[Self <: GenerateOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContains(value: js.RegExp | String): Self = StObject.set(x, "contains", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setContainsRegExp(value: js.RegExp): Self = StObject.set(x, "contains", value.asInstanceOf[js.Any])
