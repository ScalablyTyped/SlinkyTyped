package typingsSlinky.reactNativePhotoView.components
...
object ReactNativePhotoView {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def androidScaleType(value: center | centerCrop | centerInside | fitCenter | fitStart | fitEnd | fitXY): this.type = set("androidScaleType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def androidZoomTransitionDuration(value: Double): this.type = set("androidZoomTransitionDuration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onProgress(value: (/* loaded */ Double, /* total */ Double) => Unit): this.type = set("onProgress", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onScale(value: (/* scale */ Double, /* target */ js.UndefOr[ReactElement]) => Unit): this.type = set("onScale", js.Any.fromFunction2(value))
