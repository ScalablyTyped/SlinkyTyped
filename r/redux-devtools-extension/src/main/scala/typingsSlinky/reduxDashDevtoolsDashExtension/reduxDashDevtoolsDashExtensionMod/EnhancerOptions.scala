...
import typingsSlinky.reduxDashDevtoolsDashExtension.Anon_Custom
import typingsSlinky.reduxDashDevtoolsDashExtension.Anon_Date
...
trait EnhancerOptions extends js.Object {
  ...
  /**
    ...
    */
  var features: js.UndefOr[Anon_Custom] = js.undefined
  /**
  ...
  /**
    ...
    */
  var serialize: js.UndefOr[Boolean | Anon_Date] = js.undefined
  /**
