package typingsSlinky.reactShare
...
/* Inlined react-share.react-share.CommonShareButtonProps & {  title ? :string,   separator ? :string} */
@js.native
trait CommonShareButtonPropstitBeforeOnClick extends js.Object {
  /**
...
object CommonShareButtonPropstitBeforeOnClick {
  ...
  @scala.inline
  implicit class CommonShareButtonPropstitBeforeOnClickOps[Self <: CommonShareButtonPropstitBeforeOnClick] (val x: Self) extends AnyVal {
    @scala.inline
