...
/* Inlined react-share.react-share.CommonShareButtonProps & {  title ? :string,   image ? :string} */
@js.native
trait CommonShareButtonPropstitDisabled extends js.Object {
  /**
...
object CommonShareButtonPropstitDisabled {
  ...
  @scala.inline
  implicit class CommonShareButtonPropstitDisabledOps[Self <: CommonShareButtonPropstitDisabled] (val x: Self) extends AnyVal {
    @scala.inline
