...
abstract class SharedApply_CommonShareButtonPropstitClassName_1314768430 (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = CommonShareButtonPropstitClassName
}
