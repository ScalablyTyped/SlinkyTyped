...
abstract class SharedApply_CommonShareButtonPropstitAdditionalProps1239215145 (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = CommonShareButtonPropstitAdditionalProps
}
