...
abstract class SharedApply_CommonShareButtonPropstitBeforeOnClick_478153398 (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = CommonShareButtonPropstitBeforeOnClick
}
