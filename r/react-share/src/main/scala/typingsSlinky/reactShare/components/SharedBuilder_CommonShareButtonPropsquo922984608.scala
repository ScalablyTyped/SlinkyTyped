...
@scala.inline
class SharedBuilder_CommonShareButtonPropsquo922984608 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def hashtag(value: String): this.type = set("hashtag", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def quote(value: String): this.type = set("quote", value.asInstanceOf[js.Any])
  @scala.inline
