...
object WorkplaceIcon {
  
  @JSImport("react-share", "WorkplaceIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WorkplaceIcon.type): SharedBuilder_IconComponentProps_1792398978 = new SharedBuilder_IconComponentProps_1792398978(js.Array(this.component, js.Dictionary.empty))()
