...
@js.native
trait CommonShareButtonPropstit extends js.Object {
  ...
  var hashtags: js.UndefOr[js.Array[String]] = js.native
...
object CommonShareButtonPropstit {
  ...
  @scala.inline
  implicit class CommonShareButtonPropstitOps[Self <: CommonShareButtonPropstit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHashtagsVarargs(value: String*): Self = this.set("hashtags", js.Array(value :_*))
    
    @scala.inline
    def setHashtags(value: js.Array[String]): Self = this.set("hashtags", value.asInstanceOf[js.Any])
