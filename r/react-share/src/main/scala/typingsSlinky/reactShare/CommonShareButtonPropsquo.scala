...
/* Inlined react-share.react-share.CommonShareButtonProps & {  quote ? :string,   hashtag ? :string} */
@js.native
trait CommonShareButtonPropsquo extends js.Object {
  /**
...
object CommonShareButtonPropsquo {
  ...
  @scala.inline
  implicit class CommonShareButtonPropsquoOps[Self <: CommonShareButtonPropsquo] (val x: Self) extends AnyVal {
    @scala.inline
