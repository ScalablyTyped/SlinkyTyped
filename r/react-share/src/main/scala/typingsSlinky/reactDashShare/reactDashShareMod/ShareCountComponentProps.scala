...
trait ShareCountComponentProps extends js.Object {
  ...
  var children: js.UndefOr[js.Function1[/* shareCount */ Double, TagMod[Any]]] = js.undefined
...
object ShareCountComponentProps {
  @scala.inline
  def apply(url: String, children: /* shareCount */ Double => TagMod[Any] = null, className: String = null): ShareCountComponentProps = {
