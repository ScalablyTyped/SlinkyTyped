package typingsSlinky.reactDashSlick.components
...
import typingsSlinky.reactDashSlick.reactDashSlickMod.Slider
import typingsSlinky.reactDashSlick.reactDashSlickMod.SwipeDirection
import typingsSlinky.reactDashSlick.reactDashSlickMod.default
...
object ReactDashSlick
  ...
  typingsSlinky.reactDashSlick.reactDashSlickMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = Settings
}
