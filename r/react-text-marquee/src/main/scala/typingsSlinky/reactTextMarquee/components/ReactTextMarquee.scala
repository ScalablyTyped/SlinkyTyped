package typingsSlinky.reactTextMarquee.components
...
import typingsSlinky.reactTextMarquee.mod.MarqueeProps
import typingsSlinky.reactTextMarquee.mod.default
...
object ReactTextMarquee {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def hoverToStop(value: Boolean): this.type = set("hoverToStop", value.asInstanceOf[js.Any])
    @scala.inline
