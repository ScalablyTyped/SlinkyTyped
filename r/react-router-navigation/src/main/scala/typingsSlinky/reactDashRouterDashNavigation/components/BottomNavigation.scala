...
import typingsSlinky.reactDashRouterDashNavigation.reactDashRouterDashNavigationMod.BottomNavigationProps
...
object BottomNavigation
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashRouterDashNavigation.reactDashRouterDashNavigationMod.BottomNavigation
    ] {
  ...
  typingsSlinky.reactDashRouterDashNavigation.reactDashRouterDashNavigationMod.BottomNavigation](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
