...
object Tabs
  ...
  typingsSlinky.reactDashRouterDashNavigation.reactDashRouterDashNavigationMod.Tabs](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
