...
trait NavBarProps extends js.Object {
  ...
  var renderLeftButton: js.UndefOr[js.Function1[/* props */ CardSubViewProps, ReactElement]] = js.native
  var renderNavBar: js.UndefOr[js.Function1[/* props */ CardSubViewProps, ReactElement]] = js.native
  // Right button
  var renderRightButton: js.UndefOr[js.Function1[/* props */ CardSubViewProps, ReactElement]] = js.native
  var renderTitle: js.UndefOr[js.Function1[/* props */ CardSubViewProps, ReactElement]] = js.native
  // Title
...
object NavBarProps {
  ...
  implicit class NavBarPropsOps[Self <: NavBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderLeftButton(value: /* props */ CardSubViewProps => ReactElement): Self = this.set("renderLeftButton", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderLeftButton: Self = this.set("renderLeftButton", js.undefined)
    @scala.inline
    def setRenderNavBar(value: /* props */ CardSubViewProps => ReactElement): Self = this.set("renderNavBar", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderNavBar: Self = this.set("renderNavBar", js.undefined)
    @scala.inline
    def setRenderRightButton(value: /* props */ CardSubViewProps => ReactElement): Self = this.set("renderRightButton", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderRightButton: Self = this.set("renderRightButton", js.undefined)
    @scala.inline
    def setRenderTitle(value: /* props */ CardSubViewProps => ReactElement): Self = this.set("renderTitle", js.Any.fromFunction1(value))
    @scala.inline
