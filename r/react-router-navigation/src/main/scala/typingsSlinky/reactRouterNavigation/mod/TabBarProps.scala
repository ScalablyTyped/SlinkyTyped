...
trait TabBarProps extends js.Object {
  ...
  var renderLabel: js.UndefOr[js.Function1[/* props */ TabSubViewProps, ReactElement]] = js.native
  var renderTabBar: js.UndefOr[js.Function1[/* props */ TabSubViewProps, ReactElement]] = js.native
  // <BottomNavigation /> only:
  var renderTabIcon: js.UndefOr[js.Function1[/* props */ TabSubViewProps, ReactElement]] = js.native
...
object TabBarProps {
  ...
  implicit class TabBarPropsOps[Self <: TabBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderLabel(value: /* props */ TabSubViewProps => ReactElement): Self = this.set("renderLabel", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderLabel: Self = this.set("renderLabel", js.undefined)
    @scala.inline
    def setRenderTabBar(value: /* props */ TabSubViewProps => ReactElement): Self = this.set("renderTabBar", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderTabBar: Self = this.set("renderTabBar", js.undefined)
    @scala.inline
    def setRenderTabIcon(value: /* props */ TabSubViewProps => ReactElement): Self = this.set("renderTabIcon", js.Any.fromFunction1(value))
    @scala.inline
