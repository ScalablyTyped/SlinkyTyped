package typingsSlinky.reactBlockies
...
object mod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[IdenticonProps] = js.native
  
  @JSImport("react-blockies", "Identicon")
  @js.native
  val Identicon: ReactComponentClass[IdenticonProps] = js.native
  ...
  type _To = ReactComponentClass[IdenticonProps]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ReactComponentClass[IdenticonProps] = default
}
