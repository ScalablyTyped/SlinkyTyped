package typingsSlinky.reactDashTether.reactDashTetherMod.ReactTether
...
import typingsSlinky.reactDashTether.reactDashTetherMod.TetherComponent
import typingsSlinky.tether.tetherMod.ITetherOptions
...
object TetherComponentProps {
  ...
  def apply(
    ...
    renderElement: /* ref */ ReactRef[HTMLElement] => TagMod[Any] = null,
    renderElementTag: String = null,
    renderElementTo: Element | String = null,
    renderTarget: /* ref */ ReactRef[HTMLElement] => TagMod[Any] = null,
