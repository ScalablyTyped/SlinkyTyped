...
object TetherComponentProps {
  ...
  implicit class TetherComponentPropsOps[Self <: TetherComponentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderElement(value: /* ref */ ReactRef[Element] => ReactElement): Self = this.set("renderElement", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderElementToElement(value: Element): Self = this.set("renderElementTo", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderTarget(value: /* ref */ ReactRef[Element] => ReactElement): Self = this.set("renderTarget", js.Any.fromFunction1(value))
