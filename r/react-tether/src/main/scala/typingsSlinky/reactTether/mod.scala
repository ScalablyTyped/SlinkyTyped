...
object mod {
  ...
  object ReactTether {
    ...
    */
    ...
    type RenderProp = js.Function1[/* ref */ ReactRef[Element], ReactElement]
    ...
    object TetherComponentProps {
      ...
      implicit class TetherComponentPropsMutableBuilder[Self <: TetherComponentProps] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setRenderElement(value: /* ref */ ReactRef[Element] => ReactElement): Self = StObject.set(x, "renderElement", js.Any.fromFunction1(value))
        ...
        @scala.inline
        def setRenderElementToElement(value: Element): Self = StObject.set(x, "renderElementTo", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setRenderTarget(value: /* ref */ ReactRef[Element] => ReactElement): Self = StObject.set(x, "renderTarget", js.Any.fromFunction1(value))
