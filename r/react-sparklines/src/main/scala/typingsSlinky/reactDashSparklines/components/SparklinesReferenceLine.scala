...
object SparklinesReferenceLine
  ...
  typingsSlinky.reactDashSparklines.reactDashSparklinesMod.SparklinesReferenceLine](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
