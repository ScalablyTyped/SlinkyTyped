...
import typingsSlinky.reactInputCalendar.global.reactInputCalendar.ReactInputCalendar
import typingsSlinky.reactInputCalendar.reactInputCalendar.ReactInputCalendarProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ReactInputCalendarReactInputCalendar {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, ReactInputCalendar] {
    @scala.inline
  ...
  implicit def make(companion: ReactInputCalendarReactInputCalendar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
