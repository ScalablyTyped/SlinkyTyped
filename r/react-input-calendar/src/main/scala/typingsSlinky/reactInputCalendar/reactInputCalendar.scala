...
object reactInputCalendar {
  ...
  type ReactInputCalendar = ReactComponentClass[ReactInputCalendarProps]
  ...
  object ReactInputCalendarProps {
    ...
    implicit class ReactInputCalendarPropsMutableBuilder[Self <: ReactInputCalendarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDate(value: String | js.Date): Self = StObject.set(x, "date", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnFocus(value: /* event */ SyntheticEvent[Event, ReactComponentClass[ReactInputCalendarProps]] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
