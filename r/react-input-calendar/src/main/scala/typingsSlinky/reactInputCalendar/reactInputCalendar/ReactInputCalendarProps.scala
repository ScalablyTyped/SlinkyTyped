...
object ReactInputCalendarProps {
  ...
  implicit class ReactInputCalendarPropsOps[Self <: ReactInputCalendarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDate(value: String | js.Date): Self = this.set("date", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnFocus(value: /* event */ SyntheticEvent[Event, ReactComponentClass[ReactInputCalendarProps]] => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
