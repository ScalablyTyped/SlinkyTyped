...
object ReactInputCalendarProps {
  ...
  def apply(
    ...
    onBlur: (/* event */ SyntheticEvent[Event, ReactComponentClass[ReactInputCalendarProps]], /* computableDate */ String) => Unit = null,
    onChange: /* computableDate */ String => Unit = null,
    onFocus: /* event */ SyntheticEvent[Event, ReactComponentClass[ReactInputCalendarProps]] => Unit = null,
