...
object ReactSpinkit {
  ...
  object ReactSpinkit {
    ...
    implicit def make(companion: ReactSpinkit.type): typingsSlinky.reactSpinkit.components.ReactSpinkit.ReactSpinkit.Builder = new typingsSlinky.reactSpinkit.components.ReactSpinkit.ReactSpinkit.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: SpinnerProps): typingsSlinky.reactSpinkit.components.ReactSpinkit.ReactSpinkit.Builder = new typingsSlinky.reactSpinkit.components.ReactSpinkit.ReactSpinkit.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
