...
object SpinnerProps {
  ...
  implicit class SpinnerPropsOps[Self <: SpinnerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFadeIn(value: full | half | quarter | none): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOverrideSpinnerClassName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("overrideSpinnerClassName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOverrideSpinnerClassName: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("overrideSpinnerClassName")(js.undefined)
        ret
    }
    @scala.inline
