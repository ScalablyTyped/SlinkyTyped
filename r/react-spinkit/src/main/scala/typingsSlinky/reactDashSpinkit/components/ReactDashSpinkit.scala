package typingsSlinky.reactDashSpinkit.components
...
import typingsSlinky.reactDashSpinkit.reactDashSpinkitMod.SpinnerProps
import typingsSlinky.reactDashSpinkit.reactDashSpinkitMod.^
...
object ReactDashSpinkit
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashSpinkit.reactDashSpinkitMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
