package typingsSlinky.reactDashRouterDashParamDashLink.components
...
object ParamLink
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashRouterDashParamDashLink.reactDashRouterDashParamDashLinkMod.ParamLink
    ] {
