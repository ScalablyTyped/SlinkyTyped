...
object ParamLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterParamLink.mod.ParamLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterParamLink.mod.ParamLink] = {
