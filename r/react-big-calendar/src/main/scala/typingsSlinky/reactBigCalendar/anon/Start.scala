...
object Start {
  ...
  implicit class StartMutableBuilder[Self <: Start[_], TEvent /* <: js.Object */] (val x: Self with Start[TEvent]) extends AnyVal {
    ...
    @scala.inline
    def setEnd(value: /* event */ TEvent => js.Date): Self = StObject.set(x, "end", js.Any.fromFunction1(value))
    
    @scala.inline
    def setEndUndefined: Self = StObject.set(x, "end", js.undefined)
    
    @scala.inline
    def setStart(value: /* event */ TEvent => js.Date): Self = StObject.set(x, "start", js.Any.fromFunction1(value))
