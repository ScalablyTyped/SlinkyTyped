...
trait CSSPropertiesxOffsetnumbe extends js.Object {
  ...
  /**
    ...
    */
  var direction: js.UndefOr[typingsSlinky.csstype.mod.Property.Direction] = js.native
...
object CSSPropertiesxOffsetnumbe {
  ...
  implicit class CSSPropertiesxOffsetnumbeOps[Self <: CSSPropertiesxOffsetnumbe] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDirection(value: typingsSlinky.csstype.mod.Property.Direction): Self = this.set("direction", value.asInstanceOf[js.Any])
