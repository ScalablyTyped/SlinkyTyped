...
object CSSPropertiesxOffsetnumbe {
  ...
  implicit class CSSPropertiesxOffsetnumbeOps[Self <: CSSPropertiesxOffsetnumbe] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKhtmlOpacity(value: GlobalsNumber): Self = this.set("KhtmlOpacity", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozOpacity(value: GlobalsNumber): Self = this.set("MozOpacity", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMsGridColumns(value: GridAutoColumnsProperty[String | Double]): Self = this.set("msGridColumns", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMsGridColumns: Self = this.set("msGridColumns", js.undefined)
    @scala.inline
    def setMsGridRows(value: GridAutoRowsProperty[String | Double]): Self = this.set("msGridRows", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOffsetPosition(value: OffsetPositionProperty[String | Double]): Self = this.set("offsetPosition", value.asInstanceOf[js.Any])
    @scala.inline
