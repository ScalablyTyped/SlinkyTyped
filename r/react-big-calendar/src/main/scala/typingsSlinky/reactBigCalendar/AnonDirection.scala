...
object AnonDirection {
  @scala.inline
  def apply[TEvent](action: resize | move, direction: UP | DOWN | LEFT | RIGHT, event: TEvent): AnonDirection[TEvent] = {
  ...
  @scala.inline
  implicit class AnonDirectionOps[Self[tevent] <: AnonDirection[tevent], TEvent] (val x: Self[TEvent]) extends AnyVal {
    @scala.inline
