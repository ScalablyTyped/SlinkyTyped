...
object dragAndDropMod {
  ...
  @js.native
  def default[TEvent /* <: js.Object */, TResource /* <: js.Object */](calendar: ReactComponentClass[CalendarProps[TEvent, TResource]]): ReactComponentClass[DragAndDropCalendarProps[TEvent, TResource]] = js.native
  
  type DragAndDropCalendar[TEvent /* <: js.Object */, TResource /* <: js.Object */] = ReactComponentClass[DragAndDropCalendarProps[TEvent, TResource]]
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsSlinky.reactBigCalendar.dragAndDropMod.withDragAndDropProps because var conflicts: components, elementProps, selectable, step. Inlined onEventDrop, onEventResize, onDragStart, onDragOver, onDropFromOutside, dragFromOutsideItem, draggableAccessor, resizableAccessor, resizable */ @js.native
  trait DragAndDropCalendarProps[TEvent /* <: js.Object */, TResource /* <: js.Object */] extends CalendarProps[TEvent, TResource] {
    
    var dragFromOutsideItem: js.UndefOr[js.Function0[(/* keyof TEvent */ String) | (js.Function1[TEvent, js.Date])]] = js.native
  ...
  object DragAndDropCalendarProps {
    ...
    implicit class DragAndDropCalendarPropsMutableBuilder[Self <: DragAndDropCalendarProps[_, _], TEvent /* <: js.Object */, TResource /* <: js.Object */] (val x: Self with (DragAndDropCalendarProps[TEvent, TResource])) extends AnyVal {
      ...
      @scala.inline
      def setDragFromOutsideItem(value: () => (/* keyof TEvent */ String) | (js.Function1[TEvent, js.Date])): Self = StObject.set(x, "dragFromOutsideItem", js.Any.fromFunction0(value))
  ...
  object withDragAndDropProps {
    ...
    implicit class withDragAndDropPropsMutableBuilder[Self <: withDragAndDropProps[_, _], TEvent /* <: js.Object */, TResource /* <: js.Object */] (val x: Self with (withDragAndDropProps[TEvent, TResource])) extends AnyVal {
      ...
      @scala.inline
      def setDragFromOutsideItem(value: () => (/* keyof TEvent */ String) | (js.Function1[/* event */ TEvent, js.Date])): Self = StObject.set(x, "dragFromOutsideItem", js.Any.fromFunction0(value))
