...
object ViewProps {
  ...
  implicit class ViewPropsOps[Self <: ViewProps[_, _], TEvent /* <: js.Object */, TResource /* <: js.Object */] (val x: Self with (ViewProps[TEvent, TResource])) extends AnyVal {
    ...
    @scala.inline
    def setOnDrillDown(value: (js.UndefOr[js.Function2[/* date */ js.Date, /* view */ View, Unit]]) with js.Any): Self = this.set("onDrillDown", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[Calendar[TEvent, TResource]]): Self = this.set("ref", value.asInstanceOf[js.Any])
