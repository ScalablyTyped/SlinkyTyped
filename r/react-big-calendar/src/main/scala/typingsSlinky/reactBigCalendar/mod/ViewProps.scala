...
trait ViewProps[TEvent /* <: js.Object */, TResource /* <: js.Object */] extends StObject {
  ...
  // = this.handleNavigate
  var onDrillDown: (js.UndefOr[js.Function2[/* date */ js.Date, /* view */ View, Unit]]) with js.Any = js.native
...
object ViewProps {
  ...
  def apply[TEvent /* <: js.Object */, TResource /* <: js.Object */](
    ...
    onDrillDown: (js.UndefOr[js.Function2[/* date */ js.Date, /* view */ View, Unit]]) with js.Any,
  ...
  implicit class ViewPropsMutableBuilder[Self <: ViewProps[_, _], TEvent /* <: js.Object */, TResource /* <: js.Object */] (val x: Self with (ViewProps[TEvent, TResource])) extends AnyVal {
    ...
    @scala.inline
    def setOnDrillDown(value: (js.UndefOr[js.Function2[/* date */ js.Date, /* view */ View, Unit]]) with js.Any): Self = StObject.set(x, "onDrillDown", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[Calendar[TEvent, TResource]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
