...
object CalendarProps {
  ...
  @scala.inline
  implicit class CalendarPropsOps[Self <: CalendarProps[_, _], TEvent /* <: js.Object */, TResource /* <: js.Object */] (val x: Self with (CalendarProps[TEvent, TResource])) extends AnyVal {
