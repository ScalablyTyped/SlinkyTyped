...
object Components_ {
  ...
  @scala.inline
  def apply[TEvent /* <: js.Object */](): Components_[TEvent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Components_[TEvent]]
  }
  
  @scala.inline
  implicit class Components_Ops[Self <: Components_[_], TEvent /* <: js.Object */] (val x: Self with Components_[TEvent]) extends AnyVal {
