package typingsSlinky.reactDashGamepad
...
import typingsSlinky.reactDashGamepad.reactDashGamepadMod.InvertedAxis
import typingsSlinky.reactDashGamepad.reactDashGamepadMod.InvertibleAxis
