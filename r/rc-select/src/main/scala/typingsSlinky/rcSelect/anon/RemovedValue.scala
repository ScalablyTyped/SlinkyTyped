...
object RemovedValue {
  @scala.inline
  def apply[/* <: typingsSlinky.rcSelect.generatorMod.RawValueType | js.Object */ P](removedValue: P, values: js.Array[P]): RemovedValue[P] = {
  ...
  @scala.inline
  implicit class RemovedValueOps[Self <: RemovedValue[_], /* <: typingsSlinky.rcSelect.generatorMod.RawValueType | js.Object */ P] (val x: Self with RemovedValue[P]) extends AnyVal {
    @scala.inline
