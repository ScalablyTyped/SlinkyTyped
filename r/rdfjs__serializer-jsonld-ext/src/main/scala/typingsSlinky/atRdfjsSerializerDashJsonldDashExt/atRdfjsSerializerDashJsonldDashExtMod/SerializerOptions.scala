...
import typingsSlinky.atRdfjsSerializerDashJsonldDashExt.atRdfjsSerializerDashJsonldDashExtStrings.`object`
import typingsSlinky.atRdfjsSerializerDashJsonldDashExt.atRdfjsSerializerDashJsonldDashExtStrings.string
