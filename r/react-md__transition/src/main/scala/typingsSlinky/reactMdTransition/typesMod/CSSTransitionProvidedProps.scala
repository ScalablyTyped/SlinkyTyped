...
object CSSTransitionProvidedProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](ref: /* instance */ E | Null => Unit): CSSTransitionProvidedProps[E] = {
    val __obj = js.Dynamic.literal(ref = js.Any.fromFunction1(ref))
    __obj.asInstanceOf[CSSTransitionProvidedProps[E]]
  }
  @scala.inline
  implicit class CSSTransitionProvidedPropsOps[Self <: CSSTransitionProvidedProps[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with CSSTransitionProvidedProps[E]) extends AnyVal {
    @scala.inline
