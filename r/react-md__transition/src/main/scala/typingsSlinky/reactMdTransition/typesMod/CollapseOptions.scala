...
object CollapseOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): CollapseOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CollapseOptions[E]]
  }
  @scala.inline
  implicit class CollapseOptionsOps[Self <: CollapseOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with CollapseOptions[E]) extends AnyVal {
    @scala.inline
