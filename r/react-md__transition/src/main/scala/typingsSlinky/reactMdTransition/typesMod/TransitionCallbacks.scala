...
object TransitionCallbacks {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): TransitionCallbacks[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TransitionCallbacks[E]]
  }
  @scala.inline
  implicit class TransitionCallbacksOps[Self <: TransitionCallbacks[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with TransitionCallbacks[E]) extends AnyVal {
    @scala.inline
