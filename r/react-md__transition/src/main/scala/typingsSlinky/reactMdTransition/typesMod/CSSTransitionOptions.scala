...
object CSSTransitionOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](classNames: CSSTransitionClassNames | String, timeout: TransitionTimeout, transitionIn: Boolean): CSSTransitionOptions[E] = {
  ...
  @scala.inline
  implicit class CSSTransitionOptionsOps[Self <: CSSTransitionOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with CSSTransitionOptions[E]) extends AnyVal {
    @scala.inline
