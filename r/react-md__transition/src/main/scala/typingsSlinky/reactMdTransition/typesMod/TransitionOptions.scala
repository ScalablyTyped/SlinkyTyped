...
object TransitionOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](timeout: TransitionTimeout, transitionIn: Boolean): TransitionOptions[E] = {
  ...
  @scala.inline
  implicit class TransitionOptionsOps[Self <: TransitionOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with TransitionOptions[E]) extends AnyVal {
    @scala.inline
