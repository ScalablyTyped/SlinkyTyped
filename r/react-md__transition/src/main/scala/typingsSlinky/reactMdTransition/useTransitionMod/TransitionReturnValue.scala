package typingsSlinky.reactMdTransition.useTransitionMod
...
object TransitionReturnValue {
  ...
  @scala.inline
  implicit class TransitionReturnValueOps[Self <: TransitionReturnValue[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with TransitionReturnValue[E]) extends AnyVal {
    @scala.inline
