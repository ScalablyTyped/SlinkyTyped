package typingsSlinky.reactMdTransition.useCrossFadeMod
...
object CrossFadeOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): CrossFadeOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CrossFadeOptions[E]]
  }
  @scala.inline
  implicit class CrossFadeOptionsOps[Self <: CrossFadeOptions[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with CrossFadeOptions[E]) extends AnyVal {
    @scala.inline
