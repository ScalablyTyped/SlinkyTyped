...
object CrossFade {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onEnter(value: (HTMLDivElement, /* isAppearing */ Boolean) => Unit): this.type = set("onEnter", js.Any.fromFunction2(value))
    @scala.inline
    def onEntered(value: (HTMLDivElement, /* isAppearing */ Boolean) => Unit): this.type = set("onEntered", js.Any.fromFunction2(value))
    @scala.inline
    def onEntering(value: (HTMLDivElement, /* isAppearing */ Boolean) => Unit): this.type = set("onEntering", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def onExit(value: HTMLDivElement => Unit): this.type = set("onExit", js.Any.fromFunction1(value))
    @scala.inline
    def onExited(value: HTMLDivElement => Unit): this.type = set("onExited", js.Any.fromFunction1(value))
    @scala.inline
    def onExiting(value: HTMLDivElement => Unit): this.type = set("onExiting", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def transitionIn(value: Boolean): this.type = set("transitionIn", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: PickCrossFadePropshiddenc): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CrossFade.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
