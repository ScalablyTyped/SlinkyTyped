...
object anon {
  ...
  object Backend {
    ...
    implicit class BackendMutableBuilder[Self <: Backend[_, _], BackendContext, BackendOptions] (val x: Self with (Backend[BackendContext, BackendOptions])) extends AnyVal {
      ...
      @scala.inline
      def setBackend(
        value: (/* manager */ DragDropManager, /* globalContext */ js.UndefOr[js.Any], /* configuration */ js.UndefOr[js.Any]) => typingsSlinky.dndCore.interfacesMod.Backend
  ...
  @js.native
  trait DecoratedComponent[C /* <: ReactComponentClass[_] */] extends StObject {
  ...
  object DecoratedComponent {
    ...
    @scala.inline
    def apply[C /* <: ReactComponentClass[_] */](DecoratedComponent: C): DecoratedComponent[C] = {
    ...
    @scala.inline
    implicit class DecoratedComponentMutableBuilder[Self <: DecoratedComponent[_], C /* <: ReactComponentClass[_] */] (val x: Self with DecoratedComponent[C]) extends AnyVal {
