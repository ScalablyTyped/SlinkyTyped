...
object DragSourceHookSpec {
  @scala.inline
  def apply[/* <: typingsSlinky.reactDnd.hooksApiMod.DragObjectWithType */ DragObject, DropResult, CollectedProps](item: DragObject): DragSourceHookSpec[DragObject, DropResult, CollectedProps] = {
    val __obj = js.Dynamic.literal(item = item.asInstanceOf[js.Any])
    __obj.asInstanceOf[DragSourceHookSpec[DragObject, DropResult, CollectedProps]]
  }
  @scala.inline
  implicit class DragSourceHookSpecOps[Self <: DragSourceHookSpec[_, _, _], /* <: typingsSlinky.reactDnd.hooksApiMod.DragObjectWithType */ DragObject, DropResult, CollectedProps] (val x: Self with (DragSourceHookSpec[DragObject, DropResult, CollectedProps])) extends AnyVal {
    @scala.inline
