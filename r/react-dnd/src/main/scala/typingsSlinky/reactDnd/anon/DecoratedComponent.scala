...
object DecoratedComponent {
  @scala.inline
  def apply[/* <: typingsSlinky.react.mod.ComponentType[_] */ C](DecoratedComponent: C): DecoratedComponent[C] = {
  ...
  @scala.inline
  implicit class DecoratedComponentOps[Self <: DecoratedComponent[_], /* <: typingsSlinky.react.mod.ComponentType[_] */ C] (val x: Self with DecoratedComponent[C]) extends AnyVal {
    @scala.inline
