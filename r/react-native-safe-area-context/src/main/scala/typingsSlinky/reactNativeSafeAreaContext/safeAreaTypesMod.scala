...
object safeAreaTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.top
    - typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.right
    - typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.bottom
    - typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.left
  */
  trait Edge extends StObject
  object Edge {
    
    @scala.inline
    def bottom: typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.bottom = "bottom".asInstanceOf[typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.bottom]
    
    @scala.inline
    def left: typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.left = "left".asInstanceOf[typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.left]
    
    @scala.inline
    def right: typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.right = "right".asInstanceOf[typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.right]
    
    @scala.inline
    def top: typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.top = "top".asInstanceOf[typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.top]
  }
  ...
  type InsetChangeNativeCallback = js.Function1[SyntheticEvent[NodeHandle, Metrics], Unit]
  
  type InsetChangedEvent = SyntheticEvent[NodeHandle, Metrics]
  ...
  object NativeSafeAreaProviderProps {
    ...
    implicit class NativeSafeAreaProviderPropsMutableBuilder[Self <: NativeSafeAreaProviderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnInsetsChange(value: SyntheticEvent[NodeHandle, Metrics] => Unit): Self = StObject.set(x, "onInsetsChange", js.Any.fromFunction1(value))
