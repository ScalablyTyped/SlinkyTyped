...
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.`box-none`
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.`box-only`
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.`no-hide-descendants`
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.assertive
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.auto
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.button
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.margin
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.no
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.none
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.padding
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.polite
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.radiobutton_checked
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.radiobutton_unchecked
import typingsSlinky.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.yes
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined react-native.react-native.ViewProps & {  children :react.react.ReactNode | undefined,   mode :'padding' | 'margin' | undefined,   edges :std.ReadonlyArray<react-native-safe-area-context.react-native-safe-area-context/lib/typescript/src/SafeArea.types.Edge> | undefined} */
@js.native
trait NativeSafeAreaViewProps extends js.Object {
  ...
  var mode: js.UndefOr[padding | margin] = js.native
...
object NativeSafeAreaViewProps {
  ...
  @scala.inline
  implicit class NativeSafeAreaViewPropsOps[Self <: NativeSafeAreaViewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMode(value: padding | margin): Self = this.set("mode", value.asInstanceOf[js.Any])
