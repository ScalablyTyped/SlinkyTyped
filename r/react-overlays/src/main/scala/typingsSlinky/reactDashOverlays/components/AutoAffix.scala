...
import typingsSlinky.reactDashOverlays.libAutoAffixMod.AutoAffixProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object AutoAffix
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashOverlays.libMod.AutoAffix] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashOverlays.libMod.AutoAffix] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashOverlays.libMod.AutoAffix] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashOverlays.libMod.AutoAffix](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = AutoAffixProps
}
