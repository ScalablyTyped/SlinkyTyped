...
import typingsSlinky.reactDashOverlays.libModalManagerMod.^
import typingsSlinky.reactDashOverlays.libModalMod.ModalProps
import typingsSlinky.reactDashOverlays.reactDashOverlaysStrings.static
...
object Modal
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashOverlays.libMod.Modal] {
  @JSImport("react-overlays/lib", "Modal")
  @js.native
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashOverlays.libMod.Modal] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashOverlays.libMod.Modal] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactDashOverlays.libMod.Modal](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
