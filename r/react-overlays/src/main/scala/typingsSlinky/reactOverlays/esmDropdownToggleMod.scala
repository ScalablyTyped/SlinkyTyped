...
object esmDropdownToggleMod {
  ...
  trait DropdownToggleProps extends StObject {
    ...
    def children(args: UseDropdownToggleHelperspProps): ReactElement = js.native
  }
  object DropdownToggleProps {
    
    @scala.inline
    def apply(children: UseDropdownToggleHelperspProps => ReactElement): DropdownToggleProps = {
    ...
    implicit class DropdownTogglePropsMutableBuilder[Self <: DropdownToggleProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: UseDropdownToggleHelperspProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
