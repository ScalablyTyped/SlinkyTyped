...
object reactOverlaysStrings {
  ...
  sealed trait abort
    extends MouseEvents
       with typingsSlinky.reactOverlays.esmUseRootCloseMod.MouseEvents
  @scala.inline
  ...
  sealed trait concat
    extends Modifiers
       with typingsSlinky.reactOverlays.usePopperMod.Modifiers
  @scala.inline
  ...
  @js.native
  sealed trait down
    extends DropDirection
       with typingsSlinky.reactOverlays.dropdownContextMod.DropDirection
  @scala.inline
