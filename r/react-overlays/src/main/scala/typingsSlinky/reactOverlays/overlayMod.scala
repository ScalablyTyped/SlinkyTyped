...
object overlayMod extends Shortcut {
  ...
  object OverlayProps {
    ...
    implicit class OverlayPropsMutableBuilder[Self <: OverlayProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ArrowProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOffsetFunction1(value: /* details */ typingsSlinky.reactOverlays.anon.Placement => OffsetValue): Self = StObject.set(x, "offset", js.Any.fromFunction1(value))
