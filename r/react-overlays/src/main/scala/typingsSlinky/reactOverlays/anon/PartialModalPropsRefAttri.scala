...
@js.native
trait PartialModalPropsRefAttri extends js.Object {
...
object PartialModalPropsRefAttri {
  ...
  @scala.inline
  implicit class PartialModalPropsRefAttriOps[Self <: PartialModalPropsRefAttri] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[ModalHandle]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ ModalHandle | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: typingsSlinky.react.mod.Ref[ModalHandle]): Self = this.set("ref", value.asInstanceOf[js.Any])
