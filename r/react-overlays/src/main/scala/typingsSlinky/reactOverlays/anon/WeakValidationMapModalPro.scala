...
trait WeakValidationMapModalPro extends js.Object {
  ...
  var onBackdropClick: js.UndefOr[
    Validator[js.UndefOr[(js.Function1[/* e */ SyntheticEvent[Event, Element], Unit]) | Null]]
  ] = js.native
  ...
  var ref: js.UndefOr[Validator[js.UndefOr[Null | typingsSlinky.react.mod.Ref[ModalHandle]]]] = js.native
  
  var renderBackdrop: js.UndefOr[
    Validator[
      js.UndefOr[(js.Function1[/* props */ RenderModalBackdropProps, ReactElement]) | Null]
    ]
  ] = js.native
  
  var renderDialog: js.UndefOr[
    Validator[
      js.UndefOr[(js.Function1[/* props */ RenderModalDialogProps, ReactElement]) | Null]
    ]
  ] = js.native
...
object WeakValidationMapModalPro {
  ...
  implicit class WeakValidationMapModalProOps[Self <: WeakValidationMapModalPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBackdropClick(value: Validator[js.UndefOr[(js.Function1[/* e */ SyntheticEvent[Event, Element], Unit]) | Null]]): Self = this.set("onBackdropClick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRef(value: Validator[js.UndefOr[Null | typingsSlinky.react.mod.Ref[ModalHandle]]]): Self = this.set("ref", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("renderDialog", value.asInstanceOf[js.Any])
