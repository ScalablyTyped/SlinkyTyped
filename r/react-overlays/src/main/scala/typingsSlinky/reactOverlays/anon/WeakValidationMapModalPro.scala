...
object WeakValidationMapModalPro {
  ...
  implicit class WeakValidationMapModalProMutableBuilder[Self <: WeakValidationMapModalPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBackdropClick(value: Validator[js.UndefOr[(js.Function1[/* e */ SyntheticEvent[Event, Element], Unit]) | Null]]): Self = StObject.set(x, "onBackdropClick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRef(value: Validator[js.UndefOr[Null | typingsSlinky.react.mod.Ref[ModalHandle]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
