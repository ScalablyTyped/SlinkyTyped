...
object Affix
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactOverlays.mod.Affix] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactOverlays.mod.Affix] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactOverlays.mod.Affix] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactOverlays.mod.Affix](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
