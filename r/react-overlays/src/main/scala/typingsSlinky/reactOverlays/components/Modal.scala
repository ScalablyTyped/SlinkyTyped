...
object Modal {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def backdropTransitionFunctionComponent(value: ReactComponentClass[TransitionProps]): this.type = set("backdropTransition", value.asInstanceOf[js.Any])
    @scala.inline
    def backdropTransitionComponentClass(value: ReactComponentClass[TransitionProps]): this.type = set("backdropTransition", value.asInstanceOf[js.Any])
    @scala.inline
    def backdropTransition(value: ReactComponentClass[TransitionProps]): this.type = set("backdropTransition", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def renderBackdrop(value: /* props */ js.Any => TagMod[Any]): this.type = set("renderBackdrop", js.Any.fromFunction1(value))
    @scala.inline
    def renderDialog(value: /* props */ js.Any => TagMod[Any]): this.type = set("renderDialog", js.Any.fromFunction1(value))
    @scala.inline
