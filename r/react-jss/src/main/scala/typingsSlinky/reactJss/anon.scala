...
object anon {
  ...
  trait InnerRef extends StObject {
    ...
    var innerRef: js.UndefOr[ReactRef[_] | (js.Function1[/* instance */ js.Any, Unit])] = js.native
  }
  object InnerRef {
    ...
    implicit class InnerRefMutableBuilder[Self <: InnerRef] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInnerRef(value: ReactRef[_] | (js.Function1[/* instance */ js.Any, Unit])): Self = StObject.set(x, "innerRef", value.asInstanceOf[js.Any])
