...
object MotionType {
  ...
  implicit class MotionTypeOps[Self <: MotionType] (val x: Self) extends AnyVal {
    ...
    def setOnAppearActive(
      value: (/* element */ HTMLElement, /* event */ js.UndefOr[SyntheticTransitionEvent[HTMLElement] | SyntheticAnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit]
