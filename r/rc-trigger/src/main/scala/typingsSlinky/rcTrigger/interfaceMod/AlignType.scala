...
import typingsSlinky.rcTrigger.anon.AdjustX
...
object AlignType {
  ...
  implicit class AlignTypeOps[Self <: AlignType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreShake(value: Boolean): Self = this.set("ignoreShake", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIgnoreShake: Self = this.set("ignoreShake", js.undefined)
    @scala.inline
