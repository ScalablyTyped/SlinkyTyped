package typingsSlinky.rcTrigger.mod
...
trait TriggerProps extends js.Object {
  ...
  var popup: ReactElement | js.Function0[ReactElement]
...
object TriggerProps {
  ...
  implicit class TriggerPropsOps[Self <: TriggerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPopupReactElement(value: ReactElement): Self = this.set("popup", value.asInstanceOf[js.Any])
    @scala.inline
    def setPopupFunction0(value: () => ReactElement): Self = this.set("popup", js.Any.fromFunction0(value))
    @scala.inline
    def setPopup(value: ReactElement | js.Function0[ReactElement]): Self = this.set("popup", value.asInstanceOf[js.Any])
    @scala.inline
