...
import typingsSlinky.rcTrigger.rcTriggerBooleans.`false`
...
trait LeavedClassName extends js.Object {
  ...
  var motionName: js.UndefOr[String | Appear] = js.undefined
  var onAppearActive: js.UndefOr[
    js.Function2[
      /* element */ HTMLElement, 
      /* event */ SyntheticAnimationEvent[HTMLElement] | SyntheticTransitionEvent[HTMLElement], 
...
object LeavedClassName {
  ...
  implicit class LeavedClassNameOps[Self <: LeavedClassName] (val x: Self) extends AnyVal {
    ...
    def setOnAppearActive(
      value: (/* element */ HTMLElement, /* event */ SyntheticAnimationEvent[HTMLElement] | SyntheticTransitionEvent[HTMLElement]) => `false` | Unit | CSSProperties
