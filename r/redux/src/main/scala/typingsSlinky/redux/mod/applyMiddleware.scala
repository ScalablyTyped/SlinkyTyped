...
import typingsSlinky.redux.anon.DispatchExt
import typingsSlinky.redux.anon.`0`
import typingsSlinky.redux.anon.`1`
import typingsSlinky.redux.anon.`2`
import typingsSlinky.redux.anon.`3`
...
object applyMiddleware extends js.Object {
  ...
  def apply[Ext1, S](middleware1: Middleware[Ext1, S, _]): StoreEnhancer[typingsSlinky.redux.anon.Dispatch[Ext1], js.Object] = js.native
