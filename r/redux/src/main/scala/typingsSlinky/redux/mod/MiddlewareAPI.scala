...
object MiddlewareAPI {
  @scala.inline
  def apply[/* <: typingsSlinky.redux.mod.Dispatch[typingsSlinky.redux.mod.AnyAction] */ D, S](dispatch: D, getState: () => S): MiddlewareAPI[D, S] = {
  ...
  @scala.inline
  implicit class MiddlewareAPIOps[Self <: MiddlewareAPI[_, _], /* <: typingsSlinky.redux.mod.Dispatch[typingsSlinky.redux.mod.AnyAction] */ D, S] (val x: Self with (MiddlewareAPI[D, S])) extends AnyVal {
    @scala.inline
