...
object `3` {
  ...
  @scala.inline
  implicit class `3Ops`[Self[ext1, ext2, ext3, ext4, ext5] <: `3`[ext1, ext2, ext3, ext4, ext5], Ext1, Ext2, Ext3, Ext4, Ext5] (val x: Self[Ext1, Ext2, Ext3, Ext4, Ext5]) extends AnyVal {
    @scala.inline
