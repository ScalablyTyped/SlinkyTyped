package typingsSlinky.reactSound
...
object mod extends Shortcut {
  ...
  @JSImport("react-sound", JSImport.Default)
  @js.native
  val default: ReactComponentClass[ReactSoundProps] = js.native
  ...
  type _To = ReactComponentClass[ReactSoundProps]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ReactComponentClass[ReactSoundProps] = default
}
