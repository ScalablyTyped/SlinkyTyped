...
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotaccessDottokenDotkey
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDoterror
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDoterrorDotdescription
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotexpirationDotkey
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotidtoken
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotloginDoterror
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotloginDotrequest
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotnonceDotidtoken
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotsessionDotstate
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotstateDotlogin
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotstateDotrenew
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDottokenDotkeys
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDottokenDotrenewDotstatus
import typingsSlinky.reactDashAdal.reactDashAdalStrings.adalDotusername
