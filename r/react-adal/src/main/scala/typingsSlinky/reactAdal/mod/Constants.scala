...
import typingsSlinky.reactAdal.anon.ACCESSTOKENKEY
import typingsSlinky.reactAdal.anon.ERROR
import typingsSlinky.reactAdal.anon.`0`
import typingsSlinky.reactAdal.reactAdalNumbers.`483`
import typingsSlinky.reactAdal.reactAdalNumbers.`600`
import typingsSlinky.reactAdal.reactAdalStrings.Canceled
import typingsSlinky.reactAdal.reactAdalStrings.Completed
import typingsSlinky.reactAdal.reactAdalStrings.Verticalline
import typingsSlinky.reactAdal.reactAdalStrings.`6000`
import typingsSlinky.reactAdal.reactAdalStrings.`In Progress`
import typingsSlinky.reactAdal.reactAdalStrings.access_token
import typingsSlinky.reactAdal.reactAdalStrings.error_description
import typingsSlinky.reactAdal.reactAdalStrings.expires_in
import typingsSlinky.reactAdal.reactAdalStrings.id_token
import typingsSlinky.reactAdal.reactAdalStrings.session_state
