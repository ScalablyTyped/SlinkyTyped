package typingsSlinky.reactAdal.anon

import typingsSlinky.reactAdal.reactAdalStrings.adalDotaccessDottokenDotkey
import typingsSlinky.reactAdal.reactAdalStrings.adalDoterror
import typingsSlinky.reactAdal.reactAdalStrings.adalDoterrorDotdescription
import typingsSlinky.reactAdal.reactAdalStrings.adalDotexpirationDotkey
import typingsSlinky.reactAdal.reactAdalStrings.adalDotidtoken
import typingsSlinky.reactAdal.reactAdalStrings.adalDotloginDoterror
import typingsSlinky.reactAdal.reactAdalStrings.adalDotloginDotrequest
import typingsSlinky.reactAdal.reactAdalStrings.adalDotnonceDotidtoken
import typingsSlinky.reactAdal.reactAdalStrings.adalDotsessionDotstate
import typingsSlinky.reactAdal.reactAdalStrings.adalDotstateDotlogin
import typingsSlinky.reactAdal.reactAdalStrings.adalDotstateDotrenew
import typingsSlinky.reactAdal.reactAdalStrings.adalDottokenDotkeys
import typingsSlinky.reactAdal.reactAdalStrings.adalDottokenDotrenewDotstatus
import typingsSlinky.reactAdal.reactAdalStrings.adalDotusername
