...
import typingsSlinky.rmcDashCalendar.libCalendarMod.Calendar
import typingsSlinky.rmcDashCalendar.libCalendarMod.StateType
...
object libCalendarMod extends js.Object {
  ...
  trait Calendar
    ...
    def selectDate(date: js.Date, useDateTime: Boolean, oldState: Anon_EndDate): StateType = js.native
    def selectDate(date: js.Date, useDateTime: Boolean, oldState: Anon_EndDate, props: Anon_Children with PropsType): StateType = js.native
    def setClientHeight(height: Double): Unit = js.native
    def shortcutSelect(startDate: js.Date, endDate: js.Date): Unit = js.native
    def shortcutSelect(startDate: js.Date, endDate: js.Date, props: Anon_Children with PropsType): Unit = js.native
  }
  ...
  type ExtraData = typingsSlinky.rmcDashCalendar.libDateDataTypesMod.Models.ExtraData
}
