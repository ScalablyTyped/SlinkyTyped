...
import typingsSlinky.rmcDashCalendar.libCalendarConfirmPanelMod.ConfirmPanelPropsType
import typingsSlinky.rmcDashCalendar.libCalendarConfirmPanelMod.default
