...
object anon {
  ...
  object ReadonlychildrenReactNode {
    ...
    implicit class ReadonlychildrenReactNodeMutableBuilder[Self <: ReadonlychildrenReactNode] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderHeader(value: /* prop */ PropsType => ReactElement): Self = StObject.set(x, "renderHeader", js.Any.fromFunction1(value))
  ...
  object WeekComponents {
    ...
    implicit class WeekComponentsMutableBuilder[Self <: WeekComponents] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setWeekComponents(value: js.Array[ReactElement]): Self = StObject.set(x, "weekComponents", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWeekComponentsVarargs(value: ReactElement*): Self = StObject.set(x, "weekComponents", js.Array(value :_*))
    }
  }
}
