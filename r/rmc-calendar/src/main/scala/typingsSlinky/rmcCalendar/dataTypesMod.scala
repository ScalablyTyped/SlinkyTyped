...
object dataTypesMod {
  ...
  object Models {
    ...
    object SelectType extends StObject {
      ...
      /* 2 */ val All: typingsSlinky.rmcCalendar.dataTypesMod.Models.SelectType.All with Double = js.native
      
      /** 区间止 */
      @js.native
      sealed trait End extends SelectType
      /* 6 */ val End: typingsSlinky.rmcCalendar.dataTypesMod.Models.SelectType.End with Double = js.native
      
      /** 区间中 */
      @js.native
      sealed trait Middle extends SelectType
      /* 5 */ val Middle: typingsSlinky.rmcCalendar.dataTypesMod.Models.SelectType.Middle with Double = js.native
      
      @js.native
      sealed trait None extends SelectType
      /* 0 */ val None: typingsSlinky.rmcCalendar.dataTypesMod.Models.SelectType.None with Double = js.native
      
      /** 区间仅选择了 起 */
      @js.native
      sealed trait Only extends SelectType
      /* 3 */ val Only: typingsSlinky.rmcCalendar.dataTypesMod.Models.SelectType.Only with Double = js.native
      
      /** 单选 */
      @js.native
      sealed trait Single extends SelectType
      /* 1 */ val Single: typingsSlinky.rmcCalendar.dataTypesMod.Models.SelectType.Single with Double = js.native
      
      /** 区间起 */
      @js.native
      sealed trait Start extends SelectType
      /* 4 */ val Start: typingsSlinky.rmcCalendar.dataTypesMod.Models.SelectType.Start with Double = js.native
    }
    ...
    trait ExtraData extends StObject {
      ...
      var cellRender: js.UndefOr[js.Function1[/* date */ js.Date, ReactElement]] = js.native
    ...
    object ExtraData {
      ...
      implicit class ExtraDataMutableBuilder[Self <: ExtraData] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCellRender(value: /* date */ js.Date => ReactElement): Self = StObject.set(x, "cellRender", js.Any.fromFunction1(value))
    ...
    object MonthData {
      ...
      implicit class MonthDataMutableBuilder[Self <: MonthData] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setFirstDate(value: js.Date): Self = StObject.set(x, "firstDate", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setLastDate(value: js.Date): Self = StObject.set(x, "lastDate", value.asInstanceOf[js.Any])
