...
import typingsSlinky.rdfDashJs.rdfDashJsStrings.map
import typingsSlinky.rdfDashJs.rdfDashJsStrings.run
import typingsSlinky.rdfDashJs.rdfDashJsStrings.test
