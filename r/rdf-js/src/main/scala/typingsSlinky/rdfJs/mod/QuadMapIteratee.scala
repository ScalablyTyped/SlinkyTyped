...
object QuadMapIteratee {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.BaseQuad */ Q](map: (Q, Dataset[Q, Q]) => Q): QuadMapIteratee[Q] = {
    val __obj = js.Dynamic.literal(map = js.Any.fromFunction2(map))
    __obj.asInstanceOf[QuadMapIteratee[Q]]
  }
  @scala.inline
  implicit class QuadMapIterateeOps[Self <: QuadMapIteratee[_], /* <: typingsSlinky.rdfJs.mod.BaseQuad */ Q] (val x: Self with QuadMapIteratee[Q]) extends AnyVal {
    @scala.inline
