...
object QuadRunIteratee {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.BaseQuad */ Q](run: (Q, Dataset[Q, Q]) => Unit): QuadRunIteratee[Q] = {
    val __obj = js.Dynamic.literal(run = js.Any.fromFunction2(run))
    __obj.asInstanceOf[QuadRunIteratee[Q]]
  }
  @scala.inline
  implicit class QuadRunIterateeOps[Self <: QuadRunIteratee[_], /* <: typingsSlinky.rdfJs.mod.BaseQuad */ Q] (val x: Self with QuadRunIteratee[Q]) extends AnyVal {
    @scala.inline
