...
object QuadFilterIteratee {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.BaseQuad */ Q](test: (Q, Dataset[Q, Q]) => Boolean): QuadFilterIteratee[Q] = {
    val __obj = js.Dynamic.literal(test = js.Any.fromFunction2(test))
    __obj.asInstanceOf[QuadFilterIteratee[Q]]
  }
  @scala.inline
  implicit class QuadFilterIterateeOps[Self <: QuadFilterIteratee[_], /* <: typingsSlinky.rdfJs.mod.BaseQuad */ Q] (val x: Self with QuadFilterIteratee[Q]) extends AnyVal {
    @scala.inline
