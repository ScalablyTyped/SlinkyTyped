...
import typingsSlinky.rrule.anon.Dtstart
...
object rrulestrMod {
  ...
  @js.native
  def rrulestr(s: String): default | typingsSlinky.rrule.rrulesetMod.default = js.native
  @JSImport("rrule/dist/esm/src/rrulestr", "rrulestr")
  @js.native
  def rrulestr(s: String, options: PartialRRuleStrOptions): default | typingsSlinky.rrule.rrulesetMod.default = js.native
