...
object Dtstart {
  ...
  implicit class DtstartOps[Self <: Dtstart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExdatevalsVarargs(value: js.Date*): Self = this.set("exdatevals", js.Array(value :_*))
    @scala.inline
    def setExdatevals(value: js.Array[js.Date]): Self = this.set("exdatevals", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRdatevalsVarargs(value: js.Date*): Self = this.set("rdatevals", js.Array(value :_*))
    @scala.inline
    def setRdatevals(value: js.Array[js.Date]): Self = this.set("rdatevals", value.asInstanceOf[js.Any])
    @scala.inline
