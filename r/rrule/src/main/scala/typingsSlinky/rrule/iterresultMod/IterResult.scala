...
object IterResult {
  @scala.inline
  def apply[/* <: typingsSlinky.rrule.typesMod.QueryMethodTypes */ M](
  ...
  @scala.inline
  implicit class IterResultOps[Self <: IterResult[_], /* <: typingsSlinky.rrule.typesMod.QueryMethodTypes */ M] (val x: Self with IterResult[M]) extends AnyVal {
    @scala.inline
