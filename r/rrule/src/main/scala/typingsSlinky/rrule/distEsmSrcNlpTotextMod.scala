...
@js.native
object distEsmSrcNlpTotextMod extends js.Object {
  @js.native
  ...
  class default protected () extends ToText {
    def this(rrule: typingsSlinky.rrule.rruleMod.default) = this()
    def this(rrule: typingsSlinky.rrule.rruleMod.default, gettext: GetText) = this()
    def this(rrule: typingsSlinky.rrule.rruleMod.default, gettext: GetText, language: Language) = this()
    def this(
      rrule: typingsSlinky.rrule.rruleMod.default,
      gettext: GetText,
      language: Language,
  ...
  object default extends js.Object {
    ...
    /**
      ...
      * @return {Boolean}
      */
    def isFullyConvertible(rrule: typingsSlinky.rrule.rruleMod.default): Boolean = js.native
  }
