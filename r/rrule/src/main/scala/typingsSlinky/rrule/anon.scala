...
object anon {
  ...
  object Dtstart {
    ...
    implicit class DtstartMutableBuilder[Self <: Dtstart] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExdatevals(value: js.Array[js.Date]): Self = StObject.set(x, "exdatevals", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExdatevalsVarargs(value: js.Date*): Self = StObject.set(x, "exdatevals", js.Array(value :_*))
      ...
      @scala.inline
      def setRdatevals(value: js.Array[js.Date]): Self = StObject.set(x, "rdatevals", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRdatevalsVarargs(value: js.Date*): Self = StObject.set(x, "rdatevals", js.Array(value :_*))
  ...
  object ParsedOptions {
    ...
    implicit class ParsedOptionsMutableBuilder[Self <: ParsedOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParsedOptions(value: typingsSlinky.rrule.typesMod.ParsedOptions): Self = StObject.set(x, "parsedOptions", value.asInstanceOf[js.Any])
    }
  }
