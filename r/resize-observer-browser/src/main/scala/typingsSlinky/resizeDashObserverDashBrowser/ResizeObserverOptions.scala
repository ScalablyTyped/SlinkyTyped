...
import typingsSlinky.resizeDashObserverDashBrowser.resizeDashObserverDashBrowserStrings.`border-box`
import typingsSlinky.resizeDashObserverDashBrowser.resizeDashObserverDashBrowserStrings.`content-box`
