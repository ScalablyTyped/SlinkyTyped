...
package object mod {
  ...
  type Routine[TTriggerActionCreator, TRequestActionCreator, TSuccessActionCreator, TFailureActionCreator, TFulfillActionCreator] = TTriggerActionCreator with typingsSlinky.reduxSagaRoutines.keyinRoutineStagesstring with (typingsSlinky.reduxSagaRoutines.AnonFailure[
