...
object AnonFailure {
  ...
  @scala.inline
  implicit class AnonFailureOps[Self[ttriggeractioncreator, trequestactioncreator, tsuccessactioncreator, tfailureactioncreator, tfulfillactioncreator] <: AnonFailure[
    ttriggeractioncreator, 
    trequestactioncreator, 
    tsuccessactioncreator, 
    tfailureactioncreator, 
