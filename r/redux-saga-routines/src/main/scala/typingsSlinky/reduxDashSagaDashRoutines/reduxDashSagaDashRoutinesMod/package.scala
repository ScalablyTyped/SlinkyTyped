package typingsSlinky.reduxDashSagaDashRoutines
...
package object reduxDashSagaDashRoutinesMod {
  ...
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.Action
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.ActionFunction0
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.ActionFunction1
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.ActionFunction2
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.ActionFunction3
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.ActionFunction4
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.ActionFunctionAny
  import typingsSlinky.reduxDashActions.reduxDashActionsMod.ActionMeta
  import typingsSlinky.reduxDashSagaDashRoutines.Anon_Failure
  ...
  type Routine[TTriggerActionCreator, TRequestActionCreator, TSuccessActionCreator, TFailureActionCreator, TFulfillActionCreator] = TTriggerActionCreator with typingsSlinky.reduxDashSagaDashRoutines.reduxDashSagaDashRoutinesStrings.Routine with js.Any with (Anon_Failure[
