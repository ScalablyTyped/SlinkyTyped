...
version := "3.1-dt-20190417Z-c93cd8"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "redux-actions" % "2.6-dt-20190508Z-eb5967",
  "org.scalablytyped.slinky" %%% "redux-form" % "8.2-dt-20200227Z-f091b6",
