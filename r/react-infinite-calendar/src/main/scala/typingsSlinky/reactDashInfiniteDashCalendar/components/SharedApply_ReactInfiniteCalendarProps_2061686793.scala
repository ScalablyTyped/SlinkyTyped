...
import typingsSlinky.reactDashInfiniteDashCalendar.reactDashInfiniteDashCalendarNumbers.`false`
...
abstract class SharedApply_ReactInfiniteCalendarProps_2061686793[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
