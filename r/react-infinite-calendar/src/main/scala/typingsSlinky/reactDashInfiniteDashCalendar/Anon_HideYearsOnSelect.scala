...
import typingsSlinky.reactDashInfiniteDashCalendar.reactDashInfiniteDashCalendarStrings.landscape
import typingsSlinky.reactDashInfiniteDashCalendar.reactDashInfiniteDashCalendarStrings.portrait
