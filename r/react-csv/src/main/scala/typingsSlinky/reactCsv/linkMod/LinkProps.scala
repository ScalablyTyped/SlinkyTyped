...
object LinkProps {
  ...
  def apply(
    ...
    lang: String = null,
    media: String = null,
    onAbort: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLAnchorElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLAnchorElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLAnchorElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLAnchorElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLAnchorElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLAnchorElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLAnchorElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLAnchorElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLAnchorElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLAnchorElement] => Unit = null,
