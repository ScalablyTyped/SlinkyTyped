...
import typingsSlinky.reactMdButton.reactMdButtonStrings.menu
...
object unstyledButtonMod {
  
  @JSImport("@react-md/button/types/UnstyledButton", "UnstyledButton")
  @js.native
  ...
  @js.native
  trait UnstyledButtonProps extends StObject {
  ...
  object UnstyledButtonProps {
    
    @scala.inline
    def apply(): UnstyledButtonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[UnstyledButtonProps]
    }
    
    @scala.inline
    implicit class UnstyledButtonPropsMutableBuilder[Self <: UnstyledButtonProps] (val x: Self) extends AnyVal {
