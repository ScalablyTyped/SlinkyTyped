...
object UnstyledButton {
  ...
  def withProps(p: PickButtonHTMLAttributesH): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: UnstyledButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
