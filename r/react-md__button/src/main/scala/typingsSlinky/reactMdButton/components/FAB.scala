package typingsSlinky.reactMdButton.components
...
object FAB {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def position(value: FABPosition): this.type = set("position", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: FABProps with RefAttributes[HTMLSpanElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
