...
object ReactDashNativeDashDatepicker
  ...
  typingsSlinky.reactDashNativeDashDatepicker.reactDashNativeDashDatepickerMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
