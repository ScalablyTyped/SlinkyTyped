...
object DatePickerProps {
  ...
  implicit class DatePickerPropsOps[Self <: DatePickerProps] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("androidMode", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDate(value: String | js.Date | Moment): Self = this.set("date", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGetDateStr(value: /* date */ js.Date => String): Self = this.set("getDateStr", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setIconComponent(value: ReactElement): Self = this.set("iconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnDateChange(value: (/* dateStr */ String, /* date */ js.Date) => Unit): Self = this.set("onDateChange", js.Any.fromFunction2(value))
    @scala.inline
