...
object ReactNativeDatepicker
  ...
  def apply(
    ...
    androidMode: typingsSlinky.reactNativeDatepicker.reactNativeDatepickerStrings.default | calendar | spinner = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNativeDatepicker.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
