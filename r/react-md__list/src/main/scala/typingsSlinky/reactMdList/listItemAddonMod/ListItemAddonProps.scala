...
object ListItemAddonProps {
  ...
  implicit class ListItemAddonPropsOps[Self <: ListItemAddonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddonReactElement(value: ReactElement): Self = this.set("addon", value.asInstanceOf[js.Any])
    @scala.inline
    def setAddon(value: ReactElement): Self = this.set("addon", value.asInstanceOf[js.Any])
    @scala.inline
