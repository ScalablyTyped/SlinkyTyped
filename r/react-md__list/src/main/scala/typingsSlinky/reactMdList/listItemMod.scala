...
object listItemMod {
  ...
  - typingsSlinky.reactMdStates.useInteractionStatesMod.InteractionStatesOptions because var conflicts: className, disabled. Inlined disableProgrammaticRipple, rippleClassNames, disableRipple, disableSpacebarClick, rippleClassName, rippleContainerClassName, handlers, rippleTimeout, enablePressedAndRipple, disableEnterClick, disablePressedFallback */ @js.native
