package typingsSlinky.reactNativeWheelPick.components
...
import typingsSlinky.reactNativeWheelPick.mod.PickerProps
...
object Picker {
  ...
  @scala.inline
  def apply[T](onValueChange: T => Unit, pickerData: js.Array[T]): Builder[T] = {
    val __props = js.Dynamic.literal(onValueChange = js.Any.fromFunction1(onValueChange), pickerData = pickerData.asInstanceOf[js.Any])
    new Builder[T](js.Array(this.component, __props.asInstanceOf[PickerProps[T]]))
  }
  ...
  class Builder[T] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeWheelPick.mod.Picker[T]] {
    ...
    @scala.inline
    def itemSpace(value: Double): this.type = set("itemSpace", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def selectedValue(value: T): this.type = set("selectedValue", value.asInstanceOf[js.Any])
  ...
  def withProps[T](p: PickerProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
