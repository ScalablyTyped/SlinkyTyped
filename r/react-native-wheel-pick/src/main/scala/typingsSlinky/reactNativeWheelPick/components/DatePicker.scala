...
import typingsSlinky.reactNativeWheelPick.mod.DatePickerProps
...
object DatePicker {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeWheelPick.mod.DatePicker] {
    ...
    @scala.inline
    def labelUnit(value: Date): this.type = set("labelUnit", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def order(value: String): this.type = set("order", value.asInstanceOf[js.Any])
