...
import typingsSlinky.rcVirtualList.listMod.ListProps
...
object RawList {
  ...
  class Builder[T] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def component(value: String | ReactComponentClass[_]): this.type = set("component", value.asInstanceOf[js.Any])
