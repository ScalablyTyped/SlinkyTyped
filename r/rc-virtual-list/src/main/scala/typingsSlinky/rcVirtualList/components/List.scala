...
object List {
  ...
  def withProps[Item](p: Children with ListProps[Item]): Builder[Item] = new Builder[Item](js.Array(this.component, p.asInstanceOf[js.Any]))
  ...
  def apply[Item](
    ...
    new Builder[Item](js.Array(this.component, __props.asInstanceOf[Children with ListProps[Item]]))
  }
}
