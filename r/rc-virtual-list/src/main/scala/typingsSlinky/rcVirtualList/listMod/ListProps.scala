...
object ListProps {
  ...
  implicit class ListPropsOps[Self <: ListProps[_], T] (val x: Self with ListProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: (T, /* index */ Double, /* props */ Style) => ReactElement): Self = this.set("children", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setComponent(value: String | ReactComponentClass[_]): Self = this.set("component", value.asInstanceOf[js.Any])
