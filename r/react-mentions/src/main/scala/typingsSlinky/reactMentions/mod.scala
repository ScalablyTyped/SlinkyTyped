...
import typingsSlinky.reactMentions.reactMentionsStrings.assertive
import typingsSlinky.reactMentions.reactMentionsStrings.both
import typingsSlinky.reactMentions.reactMentionsStrings.copy
import typingsSlinky.reactMentions.reactMentionsStrings.date
import typingsSlinky.reactMentions.reactMentionsStrings.decimal
import typingsSlinky.reactMentions.reactMentionsStrings.descending
import typingsSlinky.reactMentions.reactMentionsStrings.dialog
import typingsSlinky.reactMentions.reactMentionsStrings.email
import typingsSlinky.reactMentions.reactMentionsStrings.execute
import typingsSlinky.reactMentions.reactMentionsStrings.grammar
import typingsSlinky.reactMentions.reactMentionsStrings.grid
import typingsSlinky.reactMentions.reactMentionsStrings.horizontal
import typingsSlinky.reactMentions.reactMentionsStrings.inherit
import typingsSlinky.reactMentions.reactMentionsStrings.link
import typingsSlinky.reactMentions.reactMentionsStrings.list
import typingsSlinky.reactMentions.reactMentionsStrings.listbox
import typingsSlinky.reactMentions.reactMentionsStrings.location
import typingsSlinky.reactMentions.reactMentionsStrings.menu
import typingsSlinky.reactMentions.reactMentionsStrings.mixed
import typingsSlinky.reactMentions.reactMentionsStrings.move
import typingsSlinky.reactMentions.reactMentionsStrings.no
import typingsSlinky.reactMentions.reactMentionsStrings.none
import typingsSlinky.reactMentions.reactMentionsStrings.numeric
import typingsSlinky.reactMentions.reactMentionsStrings.off
import typingsSlinky.reactMentions.reactMentionsStrings.on
import typingsSlinky.reactMentions.reactMentionsStrings.other
import typingsSlinky.reactMentions.reactMentionsStrings.page
import typingsSlinky.reactMentions.reactMentionsStrings.polite
import typingsSlinky.reactMentions.reactMentionsStrings.popup
import typingsSlinky.reactMentions.reactMentionsStrings.removals
import typingsSlinky.reactMentions.reactMentionsStrings.search
import typingsSlinky.reactMentions.reactMentionsStrings.spelling
import typingsSlinky.reactMentions.reactMentionsStrings.step
import typingsSlinky.reactMentions.reactMentionsStrings.tel
import typingsSlinky.reactMentions.reactMentionsStrings.text
import typingsSlinky.reactMentions.reactMentionsStrings.time
import typingsSlinky.reactMentions.reactMentionsStrings.tree
import typingsSlinky.reactMentions.reactMentionsStrings.url
import typingsSlinky.reactMentions.reactMentionsStrings.vertical
import typingsSlinky.reactMentions.reactMentionsStrings.yes
...
object mod {
  ...
  @js.native
  val Mention: ReactComponentClass[MentionProps] = js.native
  ...
  @JSImport("react-mentions", "MentionsInput")
  @js.native
  val MentionsInput: ReactComponentClass[MentionsInputProps] = js.native
  ...
  object MentionProps {
    ...
    implicit class MentionPropsMutableBuilder[Self <: MentionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTrigger(value: String | js.RegExp): Self = StObject.set(x, "trigger", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTriggerRegExp(value: js.RegExp): Self = StObject.set(x, "trigger", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait MentionsInputProps extends StObject {
    ...
    var onKeyDown: js.UndefOr[
        js.Function1[/* event */ SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement], Unit]
      ] = js.native
    ...
    var onSelect: js.UndefOr[js.Function1[/* event */ SyntheticUIEvent[Element], Unit]] = js.native
  ...
  object MentionsInputProps {
    ...
    implicit class MentionsInputPropsMutableBuilder[Self <: MentionsInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBlur(
        value: (/* event */ SyntheticFocusEvent[HTMLInputElement | HTMLTextAreaElement], /* clickedSuggestion */ Boolean) => Unit
      ...
      @scala.inline
      def setOnKeyDown(value: /* event */ SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnSelect(value: /* event */ SyntheticUIEvent[Element] => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
