...
object MentionProps {
  ...
  implicit class MentionPropsOps[Self <: MentionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTriggerRegExp(value: js.RegExp): Self = this.set("trigger", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTrigger(value: String | js.RegExp): Self = this.set("trigger", value.asInstanceOf[js.Any])
