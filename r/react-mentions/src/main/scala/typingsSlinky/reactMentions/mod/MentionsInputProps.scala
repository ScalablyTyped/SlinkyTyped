...
object MentionsInputProps {
  ...
  def apply(
    ...
    onChange: (/* event */ Target, /* newValue */ String, /* newPlainTextValue */ String, /* mentions */ js.Array[MentionItem]) => Unit = null,
    ...
    if (!js.isUndefined(allowSpaceInQuery)) __obj.updateDynamic("allowSpaceInQuery")(allowSpaceInQuery.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowSuggestionsAboveCursor)) __obj.updateDynamic("allowSuggestionsAboveCursor")(allowSuggestionsAboveCursor.get.asInstanceOf[js.Any])
