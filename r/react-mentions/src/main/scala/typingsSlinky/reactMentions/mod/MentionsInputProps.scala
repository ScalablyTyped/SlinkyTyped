...
object MentionsInputProps {
  ...
  implicit class MentionsInputPropsOps[Self <: MentionsInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowSpaceInQuery(value: Boolean): Self = this.set("allowSpaceInQuery", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAllowSpaceInQuery: Self = this.set("allowSpaceInQuery", js.undefined)
    
    @scala.inline
    def setAllowSuggestionsAboveCursor(value: Boolean): Self = this.set("allowSuggestionsAboveCursor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAllowSuggestionsAboveCursor: Self = this.set("allowSuggestionsAboveCursor", js.undefined)
    ...
    @scala.inline
    def setOnKeyDown(value: /* event */ SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnSelect(value: /* event */ SyntheticUIEvent[Element] => Unit): Self = this.set("onSelect", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSuggestionsPortalHost(value: Element): Self = this.set("suggestionsPortalHost", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSuggestionsPortalHost: Self = this.set("suggestionsPortalHost", js.undefined)
