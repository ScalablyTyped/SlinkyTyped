...
object MentionsInput {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactMentions.mod.MentionsInput] {
    @scala.inline
    def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    @scala.inline
    def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    @scala.inline
    def allowSpaceInQuery(value: Boolean): this.type = set("allowSpaceInQuery", value.asInstanceOf[js.Any])
    @scala.inline
    def allowSuggestionsAboveCursor(value: Boolean): this.type = set("allowSuggestionsAboveCursor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def ignoreAccents(value: Boolean): this.type = set("ignoreAccents", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onKeyDown(value: /* event */ SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): this.type = set("onKeyDown", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onSelect(value: /* event */ SyntheticUIEvent[Element] => Unit): this.type = set("onSelect", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def suggestionsPortalHost(value: Element): this.type = set("suggestionsPortalHost", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: MentionsInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: MentionsInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
