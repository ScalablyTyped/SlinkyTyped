package typingsSlinky.reactDashMentions.reactDashMentionsMod
...
- Dropped {[ P in std.Exclude<keyof react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, 'onChange' | 'onBlur' | 'onKeyDown' | 'onSelect'> ]: react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>[P]} */ trait MentionsInputProps extends js.Object {
  ...
  var inputRef: js.UndefOr[ReactRef[HTMLInputElement | HTMLTextAreaElement]] = js.undefined
  ...
  var onSelect: js.UndefOr[js.Function1[/* event */ SyntheticUIEvent[Element], Unit]] = js.undefined
...
object MentionsInputProps {
  ...
  def apply(
    ...
    onKeyDown: /* event */ SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onSelect: /* event */ SyntheticUIEvent[Element] => Unit = null,
