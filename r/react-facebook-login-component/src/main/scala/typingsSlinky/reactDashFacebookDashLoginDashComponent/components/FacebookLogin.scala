package typingsSlinky.reactDashFacebookDashLoginDashComponent.components
...
import typingsSlinky.reactDashFacebookDashLoginDashComponent.reactDashFacebookDashLoginDashComponentMod.FacebookLoginInfo
import typingsSlinky.reactDashFacebookDashLoginDashComponent.reactDashFacebookDashLoginDashComponentMod.FacebookLoginProps
...
object FacebookLogin
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashFacebookDashLoginDashComponent.reactDashFacebookDashLoginDashComponentMod.FacebookLogin
    ] {
