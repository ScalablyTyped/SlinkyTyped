...
import typingsSlinky.roslib.anon.StringString
...
import typingsSlinky.roslib.roslibNumbers.`2`
...
object mod {
  ...
  class UrdfModel protected () extends StObject {
    /**
      ...
      */
    def this(options: typingsSlinky.roslib.anon.String) = this()
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.roslib.mod.UrdfSphere
    - typingsSlinky.roslib.mod.UrdfBox
    - typingsSlinky.roslib.mod.UrdfCylinder
    - typingsSlinky.roslib.mod.UrdfMesh
  */
