package typingsSlinky.reactDashNativeDashGoogleDashSignin.components
...
import typingsSlinky.reactDashNativeDashGoogleDashSignin.reactDashNativeDashGoogleDashSigninMod.GoogleSigninButtonProps
...
object GoogleSigninButton
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashGoogleDashSignin.reactDashNativeDashGoogleDashSigninMod.GoogleSigninButton
    ] {
  ...
  typingsSlinky.reactDashNativeDashGoogleDashSignin.reactDashNativeDashGoogleDashSigninMod.GoogleSigninButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
