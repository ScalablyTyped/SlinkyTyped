...
object mod {
  ...
  object GoogleSigninButton {
    ...
    object Color extends StObject {
      ...
      /* 1 */ val Dark: typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton.Color.Dark with Double = js.native
      
      @js.native
      sealed trait Light extends Color
      /* 0 */ val Light: typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton.Color.Light with Double = js.native
    }
    ...
    object Size extends StObject {
      ...
      /* 2 */ val Icon: typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton.Size.Icon with Double = js.native
      
      @js.native
      sealed trait Standard extends Size
      /* 0 */ val Standard: typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton.Size.Standard with Double = js.native
      
      @js.native
      sealed trait Wide extends Size
      /* 1 */ val Wide: typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton.Size.Wide with Double = js.native
    }
  }
