package typingsSlinky.reactNativeGoogleSignin.components
...
import typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButtonProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object GoogleSigninButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNativeGoogleSignin.mod.GoogleSigninButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
