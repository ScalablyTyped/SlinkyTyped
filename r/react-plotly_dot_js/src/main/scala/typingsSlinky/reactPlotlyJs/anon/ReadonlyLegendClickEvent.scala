...
object ReadonlyLegendClickEvent {
  ...
  implicit class ReadonlyLegendClickEventOps[Self <: ReadonlyLegendClickEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConfig(value: typingsSlinky.plotlyJs.anon.PartialConfig): Self = this.set("config", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFullLayout(value: typingsSlinky.plotlyJs.anon.PartialLayout): Self = this.set("fullLayout", value.asInstanceOf[js.Any])
    @scala.inline
    def setLayout(value: typingsSlinky.plotlyJs.anon.PartialLayout): Self = this.set("layout", value.asInstanceOf[js.Any])
    @scala.inline
