...
trait ReadonlyHTMLElement extends StObject {
  ...
  val onprogress: js.UndefOr[(js.ThisFunction1[/* this */ this.type, /* ev */ ProgressEvent, _]) | Null] = js.native
...
object ReadonlyHTMLElement {
  ...
  implicit class ReadonlyHTMLElementMutableBuilder[Self <: ReadonlyHTMLElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[ReadonlyHTMLElement, /* ev */ ProgressEvent, _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
