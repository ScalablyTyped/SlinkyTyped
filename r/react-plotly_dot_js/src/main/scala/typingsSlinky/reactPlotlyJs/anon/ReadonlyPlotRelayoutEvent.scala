...
import typingsSlinky.reactPlotlyJs.reactPlotlyJsStrings.`x unified`
import typingsSlinky.reactPlotlyJs.reactPlotlyJsStrings.`y unified`
...
object ReadonlyPlotRelayoutEvent {
  ...
  implicit class ReadonlyPlotRelayoutEventOps[Self <: ReadonlyPlotRelayoutEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHovermode(
      value: closest | typingsSlinky.reactPlotlyJs.reactPlotlyJsStrings.x | y | (`x unified`) | (`y unified`) | `false`
