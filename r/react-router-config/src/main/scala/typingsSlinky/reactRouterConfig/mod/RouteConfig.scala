...
object RouteConfig {
  ...
  implicit class RouteConfigOps[Self <: RouteConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[js.Object | RouteConfigComponentProps[_]]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[js.Object | RouteConfigComponentProps[_]]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponent(value: ReactComponentClass[js.Object | RouteConfigComponentProps[_]]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRender(value: /* props */ RouteConfigComponentProps[_] => ReactElement): Self = this.set("render", js.Any.fromFunction1(value))
