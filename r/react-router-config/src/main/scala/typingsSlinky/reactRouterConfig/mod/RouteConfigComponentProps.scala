...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.reactRouterConfig.reactRouterConfigStrings.RouteConfigComponentProps with js.Any */] extends RouteComponentProps[Params, StaticContext, LocationState] {
...
object RouteConfigComponentProps {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouterConfig.reactRouterConfigStrings.RouteConfigComponentProps with js.Any */](
