...
object RouteConfigComponentProps {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouterConfig.reactRouterConfigStrings.RouteConfigComponentProps with org.scalablytyped.runtime.TopLevel[js.Any] */ Params](history: History[LocationState], location: Location[LocationState], `match`: `match`[Params]): RouteConfigComponentProps[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouterConfig.reactRouterConfigStrings.RouteConfigComponentProps with org.scalablytyped.runtime.TopLevel[js.Any] */ Params] (val x: Self with RouteConfigComponentProps[Params]) extends AnyVal {
    @scala.inline
