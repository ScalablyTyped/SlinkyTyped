...
object RouteConfigComponentProps {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouterConfig.reactRouterConfigStrings.RouteConfigComponentProps with TopLevel[js.Any] */](history: History[LocationState], location: Location[LocationState], `match`: `match`[Params]): RouteConfigComponentProps[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouterConfig.reactRouterConfigStrings.RouteConfigComponentProps with TopLevel[js.Any] */] (val x: Self with RouteConfigComponentProps[Params]) extends AnyVal {
