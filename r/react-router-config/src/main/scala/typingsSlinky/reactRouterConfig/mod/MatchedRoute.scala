...
object MatchedRoute {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouterConfig.reactRouterConfigStrings.MatchedRoute with org.scalablytyped.runtime.TopLevel[js.Any] */ Params](`match`: `match`[Params], route: RouteConfig): MatchedRoute[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.reactRouterConfig.reactRouterConfigStrings.MatchedRoute with org.scalablytyped.runtime.TopLevel[js.Any] */ Params] (val x: Self with MatchedRoute[Params]) extends AnyVal {
    @scala.inline
