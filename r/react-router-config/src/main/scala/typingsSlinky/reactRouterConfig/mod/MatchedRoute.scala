...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.reactRouterConfig.reactRouterConfigStrings.MatchedRoute with js.Any */] extends js.Object {
...
object MatchedRoute {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.reactRouterConfig.reactRouterConfigStrings.MatchedRoute with js.Any */](`match`: `match`[Params], route: RouteConfig): MatchedRoute[Params] = {
