package typingsSlinky.reactDashNativeDashAnimatable
...
package object reactDashNativeDashAnimatableMod {
  ...
  {[ k in react-native-animatable.react-native-animatable.Animation ]: (duration? : number): std.Promise<{  finished  :boolean}>}
    */ typingsSlinky.reactDashNativeDashAnimatable.reactDashNativeDashAnimatableStrings.AnimatableAnimationMethods with js.Any
  ]
