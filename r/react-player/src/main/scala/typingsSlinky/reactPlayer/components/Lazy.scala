...
import typingsSlinky.reactPlayer.lazyMod.Config
...
object Lazy {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onReady(value: /* player */ typingsSlinky.reactPlayer.lazyMod.ReactPlayer => Unit): this.type = set("onReady", js.Any.fromFunction1(value))
    @scala.inline
