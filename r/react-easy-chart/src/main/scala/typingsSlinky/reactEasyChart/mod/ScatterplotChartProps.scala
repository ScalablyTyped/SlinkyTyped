...
object ScatterplotChartProps {
  ...
  implicit class ScatterplotChartPropsOps[Self <: ScatterplotChartProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setXDomainRangeVarargs(value: (js.Date | Double | String)*): Self = this.set("xDomainRange", js.Array(value :_*))
    
    @scala.inline
    def setXDomainRange(value: js.Array[js.Date | Double | String]): Self = this.set("xDomainRange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setYDomainRangeVarargs(value: (js.Date | Double | String)*): Self = this.set("yDomainRange", js.Array(value :_*))
    
    @scala.inline
    def setYDomainRange(value: js.Array[js.Date | Double | String]): Self = this.set("yDomainRange", value.asInstanceOf[js.Any])
