...
object LineChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactEasyChart.mod.LineChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactEasyChart.mod.LineChart] = {
