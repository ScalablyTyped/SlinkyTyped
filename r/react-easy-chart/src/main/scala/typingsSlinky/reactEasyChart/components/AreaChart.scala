...
object AreaChart {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactEasyChart.mod.AreaChart] {
    ...
    @scala.inline
    def noAreaGradient(value: Boolean): this.type = set("noAreaGradient", value.asInstanceOf[js.Any])
