...
import typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.ScatterplotChartProps
import typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.ScatterplotData
...
object ScatterplotChart
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.ScatterplotChart
    ] {
