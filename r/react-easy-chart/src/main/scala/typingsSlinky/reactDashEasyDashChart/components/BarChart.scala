...
import typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.BarChartProps
import typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.BarData
...
object BarChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.BarChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.BarChart] = {
