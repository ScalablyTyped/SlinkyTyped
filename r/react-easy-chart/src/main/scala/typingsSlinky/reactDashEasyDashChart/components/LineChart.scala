...
import typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.LineChartProps
...
object LineChart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.LineChart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashEasyDashChart.reactDashEasyDashChartMod.LineChart] = {
