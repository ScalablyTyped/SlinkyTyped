...
object ActionSheetCustomProps {
  ...
  implicit class ActionSheetCustomPropsOps[Self <: ActionSheetCustomProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptionsVarargs(value: ReactElement*): Self = this.set("options", js.Array(value :_*))
    @scala.inline
    def setOptions(value: js.Array[ReactElement]): Self = this.set("options", value.asInstanceOf[js.Any])
    @scala.inline
