package typingsSlinky.reactNativeActionsheet
...
object mod {
  ...
  trait ActionSheetCustomProps extends StObject {
    ...
    var options: js.Array[ReactElement] = js.native
  ...
  object ActionSheetCustomProps {
    ...
    @scala.inline
    def apply(onPress: Double => Unit, options: js.Array[ReactElement]): ActionSheetCustomProps = {
    ...
    implicit class ActionSheetCustomPropsMutableBuilder[Self <: ActionSheetCustomProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: js.Array[ReactElement]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOptionsVarargs(value: ReactElement*): Self = StObject.set(x, "options", js.Array(value :_*))
