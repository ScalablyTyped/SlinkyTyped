...
import typingsSlinky.reactDashNativeDashActionsheet.reactDashNativeDashActionsheetMod.ActionSheetCustomProps
...
object ActionSheetCustom
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashActionsheet.reactDashNativeDashActionsheetMod.ActionSheetCustom
    ] {
