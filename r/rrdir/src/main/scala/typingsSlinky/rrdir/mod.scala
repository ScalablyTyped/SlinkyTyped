...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsSlinky.rrdir.mod.rrdir = js.native
  ...
  type _To = typingsSlinky.rrdir.mod.rrdir
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsSlinky.rrdir.mod.rrdir = ^
