...
@scala.inline
class SharedBuilder_LinearGradientProps1757348134[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def locations(value: js.Array[Double]): this.type = set("locations", value.asInstanceOf[js.Any])
  
  @scala.inline
  def locationsVarargs(value: Double*): this.type = set("locations", js.Array(value :_*))
  ...
  @scala.inline
  def useAngle(value: Boolean): this.type = set("useAngle", value.asInstanceOf[js.Any])
}
