package typingsSlinky.reactDashNativeDashLinearDashGradient.components
...
import typingsSlinky.reactDashNativeDashLinearDashGradient.Anon_X
import typingsSlinky.reactDashNativeDashLinearDashGradient.reactDashNativeDashLinearDashGradientMod.LinearGradientProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_LinearGradientProps_1619161069[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: onTouchCancel, onTouchEnd, onTouchMove, onTouchStart */
  def apply(
    colors: js.Array[String | Double],
    ...
    useAngle: js.UndefOr[Boolean] = js.undefined,
    ...
    if (angleCenter != null) __obj.updateDynamic("angleCenter")(angleCenter.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useAngle)) __obj.updateDynamic("useAngle")(useAngle.asInstanceOf[js.Any])
