...
object ResizableProps {
  ...
  implicit class ResizablePropsOps[Self <: ResizableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandleReactElement(value: ReactElement): Self = this.set("handle", value.asInstanceOf[js.Any])
    @scala.inline
    def setHandleFunction1(value: /* resizeHandle */ ResizeHandle => ReactElement): Self = this.set("handle", js.Any.fromFunction1(value))
    @scala.inline
    def setHandle(value: ReactElement | (js.Function1[/* resizeHandle */ ResizeHandle, ReactElement])): Self = this.set("handle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnResize(value: (/* e */ SyntheticEvent[Event, Element], /* data */ ResizeCallbackData) => _): Self = this.set("onResize", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnResize: Self = this.set("onResize", js.undefined)
    @scala.inline
    def setOnResizeStart(value: (/* e */ SyntheticEvent[Event, Element], /* data */ ResizeCallbackData) => _): Self = this.set("onResizeStart", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnResizeStart: Self = this.set("onResizeStart", js.undefined)
    @scala.inline
    def setOnResizeStop(value: (/* e */ SyntheticEvent[Event, Element], /* data */ ResizeCallbackData) => _): Self = this.set("onResizeStop", js.Any.fromFunction2(value))
    @scala.inline
