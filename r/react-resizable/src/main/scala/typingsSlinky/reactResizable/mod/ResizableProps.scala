...
object ResizableProps {
  ...
  def apply(
    ...
    onResize: (/* e */ SyntheticEvent[Event_, Element], /* data */ ResizeCallbackData) => _ = null,
    onResizeStart: (/* e */ SyntheticEvent[Event_, Element], /* data */ ResizeCallbackData) => _ = null,
    onResizeStop: (/* e */ SyntheticEvent[Event_, Element], /* data */ ResizeCallbackData) => _ = null,
