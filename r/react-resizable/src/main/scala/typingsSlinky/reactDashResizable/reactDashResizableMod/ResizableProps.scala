...
trait ResizableProps extends js.Object {
  ...
  var handle: js.UndefOr[TagMod[Any] | (js.Function1[/* resizeHandle */ ResizeHandle, TagMod[Any]])] = js.undefined
...
object ResizableProps {
  ...
  def apply(
    ...
    onResize: (/* e */ SyntheticEvent[Event, Element], /* data */ ResizeCallbackData) => _ = null,
    onResizeStart: (/* e */ SyntheticEvent[Event, Element], /* data */ ResizeCallbackData) => _ = null,
    onResizeStop: (/* e */ SyntheticEvent[Event, Element], /* data */ ResizeCallbackData) => _ = null,
