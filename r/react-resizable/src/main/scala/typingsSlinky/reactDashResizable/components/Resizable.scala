...
import typingsSlinky.reactDashResizable.reactDashResizableMod.ResizableProps
...
object Resizable
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashResizable.reactDashResizableMod.Resizable] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashResizable.reactDashResizableMod.Resizable] = {
