...
object MaskOptions {
  ...
  implicit class MaskOptionsOps[Self <: MaskOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaskVarargs(value: (String | js.RegExp)*): Self = this.set("mask", js.Array(value :_*))
    
    @scala.inline
    def setMask(value: String | (js.Array[String | js.RegExp])): Self = this.set("mask", value.asInstanceOf[js.Any])
