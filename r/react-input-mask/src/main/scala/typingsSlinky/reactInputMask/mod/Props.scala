...
object Props {
  ...
  def apply(
    ...
    lang: String = null,
    list: String = null,
    maskChar: js.UndefOr[Null | String] = js.undefined,
    ...
    if (!js.isUndefined(alwaysShowMask)) __obj.updateDynamic("alwaysShowMask")(alwaysShowMask.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(maskChar)) __obj.updateDynamic("maskChar")(maskChar.asInstanceOf[js.Any])
