package typingsSlinky.reactInputMask.components
...
import typingsSlinky.reactInputMask.mod.InputState
import typingsSlinky.reactInputMask.mod.MaskOptions
import typingsSlinky.reactInputMask.mod.Props
import typingsSlinky.reactInputMask.mod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactInputMask {
  
  @scala.inline
  def apply(mask: String | (js.Array[String | js.RegExp])): Builder = {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def alwaysShowMask(value: Boolean): this.type = set("alwaysShowMask", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def maskCharNull: this.type = set("maskChar", null)
