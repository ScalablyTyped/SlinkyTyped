...
object TabContent
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactTabsRedux.mod.TabContent] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactTabsRedux.mod.TabContent] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactTabsRedux.mod.TabContent] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactTabsRedux.mod.TabContent](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
