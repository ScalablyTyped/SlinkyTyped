...
object TabLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactTabsRedux.mod.TabLink] {
  @JSImport("react-tabs-redux", "TabLink")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: className, default */
  def apply(
    to: Double | String,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactTabsRedux.mod.TabLink] = {
