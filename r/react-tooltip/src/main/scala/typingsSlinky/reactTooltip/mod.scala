...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.reactTooltip.reactTooltipStrings.float
    - typingsSlinky.reactTooltip.reactTooltipStrings.solid
  */
  trait Effect extends StObject
  object Effect {
    
    @scala.inline
    def float: typingsSlinky.reactTooltip.reactTooltipStrings.float = "float".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.float]
    
    @scala.inline
    def solid: typingsSlinky.reactTooltip.reactTooltipStrings.solid = "solid".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.solid]
  }
  
  type GetContent = GetContentFunc | (js.Tuple2[GetContentFunc, Double])
  
  type GetContentFunc = js.Function1[/* toolTipStr */ String, ReactElement]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.reactTooltip.reactTooltipStrings.top
    - typingsSlinky.reactTooltip.reactTooltipStrings.right
    - typingsSlinky.reactTooltip.reactTooltipStrings.bottom
    - typingsSlinky.reactTooltip.reactTooltipStrings.left
  */
  ...
  type ReactTooltip = ReactComponentClass[TooltipProps]
  ...
  object TooltipProps {
    ...
    implicit class TooltipPropsMutableBuilder[Self <: TooltipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetContentFunction1(value: /* toolTipStr */ String => ReactElement): Self = StObject.set(x, "getContent", js.Any.fromFunction1(value))
  ...
  */
  ...
  object Type {
    ...
    @scala.inline
    def dark: typingsSlinky.reactTooltip.reactTooltipStrings.dark = "dark".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.dark]
    
    @scala.inline
    def error: typingsSlinky.reactTooltip.reactTooltipStrings.error = "error".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.error]
    
    @scala.inline
    def info: typingsSlinky.reactTooltip.reactTooltipStrings.info = "info".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.info]
    
    @scala.inline
    def light: typingsSlinky.reactTooltip.reactTooltipStrings.light = "light".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.light]
    
    @scala.inline
    def success: typingsSlinky.reactTooltip.reactTooltipStrings.success = "success".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.success]
    
    @scala.inline
    def warning: typingsSlinky.reactTooltip.reactTooltipStrings.warning = "warning".asInstanceOf[typingsSlinky.reactTooltip.reactTooltipStrings.warning]
  }
