...
import typingsSlinky.reachCombobox.reachComboboxStrings.assertive
import typingsSlinky.reachCombobox.reachComboboxStrings.both
import typingsSlinky.reachCombobox.reachComboboxStrings.copy
import typingsSlinky.reachCombobox.reachComboboxStrings.date
import typingsSlinky.reachCombobox.reachComboboxStrings.decimal
import typingsSlinky.reachCombobox.reachComboboxStrings.descending
import typingsSlinky.reachCombobox.reachComboboxStrings.dialog
import typingsSlinky.reachCombobox.reachComboboxStrings.email
import typingsSlinky.reachCombobox.reachComboboxStrings.execute
import typingsSlinky.reachCombobox.reachComboboxStrings.grammar
import typingsSlinky.reachCombobox.reachComboboxStrings.grid
import typingsSlinky.reachCombobox.reachComboboxStrings.horizontal
import typingsSlinky.reachCombobox.reachComboboxStrings.inherit
import typingsSlinky.reachCombobox.reachComboboxStrings.link
import typingsSlinky.reachCombobox.reachComboboxStrings.list
import typingsSlinky.reachCombobox.reachComboboxStrings.listbox
import typingsSlinky.reachCombobox.reachComboboxStrings.location
import typingsSlinky.reachCombobox.reachComboboxStrings.menu
import typingsSlinky.reachCombobox.reachComboboxStrings.mixed
import typingsSlinky.reachCombobox.reachComboboxStrings.move
import typingsSlinky.reachCombobox.reachComboboxStrings.no
import typingsSlinky.reachCombobox.reachComboboxStrings.none
import typingsSlinky.reachCombobox.reachComboboxStrings.numeric
import typingsSlinky.reachCombobox.reachComboboxStrings.off
import typingsSlinky.reachCombobox.reachComboboxStrings.on
import typingsSlinky.reachCombobox.reachComboboxStrings.other
import typingsSlinky.reachCombobox.reachComboboxStrings.page
import typingsSlinky.reachCombobox.reachComboboxStrings.polite
import typingsSlinky.reachCombobox.reachComboboxStrings.popup
import typingsSlinky.reachCombobox.reachComboboxStrings.removals
import typingsSlinky.reachCombobox.reachComboboxStrings.search
import typingsSlinky.reachCombobox.reachComboboxStrings.spelling
import typingsSlinky.reachCombobox.reachComboboxStrings.step
import typingsSlinky.reachCombobox.reachComboboxStrings.tel
import typingsSlinky.reachCombobox.reachComboboxStrings.text
import typingsSlinky.reachCombobox.reachComboboxStrings.time
import typingsSlinky.reachCombobox.reachComboboxStrings.tree
import typingsSlinky.reachCombobox.reachComboboxStrings.url
import typingsSlinky.reachCombobox.reachComboboxStrings.vertical
import typingsSlinky.reachCombobox.reachComboboxStrings.yes
...
object mod {
  ...
  @js.native
  val Combobox: ReactComponentClass[ComboboxProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxInput")
  @js.native
  val ComboboxInput: ReactComponentClass[ComboboxInputProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxList")
  @js.native
  val ComboboxList: ReactComponentClass[ComboboxListProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxOption")
  @js.native
  val ComboboxOption: ReactComponentClass[ComboboxOptionProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxOptionText")
  @js.native
  val ComboboxOptionText: ReactComponentClass[js.Object] = js.native
  
  @JSImport("@reach/combobox", "ComboboxPopover")
  @js.native
  val ComboboxPopover: ReactComponentClass[ComboboxPopoverProps] = js.native
  ...
  object ComboboxListProps {
    ...
    @scala.inline
    implicit class ComboboxListPropsMutableBuilder[Self <: ComboboxListProps] (val x: Self) extends AnyVal {
  ...
  object ComboboxOptionProps {
    ...
    @scala.inline
    implicit class ComboboxOptionPropsMutableBuilder[Self <: ComboboxOptionProps] (val x: Self) extends AnyVal {
  ...
  object ComboboxPopoverProps {
    ...
    @scala.inline
    implicit class ComboboxPopoverPropsMutableBuilder[Self <: ComboboxPopoverProps] (val x: Self) extends AnyVal {
  ...
  object ComboboxProps {
    ...
    implicit class ComboboxPropsMutableBuilder[Self <: ComboboxProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnSelect(value: /* value */ String => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
