...
import typingsSlinky.reachCombobox.mod.ComboboxListProps
...
object ComboboxList {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def persistSelection(value: Boolean): this.type = set("persistSelection", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ComboboxListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
