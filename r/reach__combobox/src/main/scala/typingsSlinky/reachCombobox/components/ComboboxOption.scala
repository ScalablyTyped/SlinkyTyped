...
import typingsSlinky.reachCombobox.mod.ComboboxOptionProps
...
object ComboboxOption {
  ...
  def withProps(p: ComboboxOptionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(value: String): Builder = {
    val __props = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ComboboxOptionProps]))
  }
}
