...
import typingsSlinky.reachCombobox.mod.ComboboxPopoverProps
...
object ComboboxPopover {
  ...
  def withProps(p: ComboboxPopoverProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
