...
import typingsSlinky.reactDashDataDashGrid.AdazzleReactDataGrid.ColumnEventCallback
...
trait Column[T] extends js.Object {
  ...
  var getRowMetaData: js.UndefOr[
    js.Function2[
      /* rowdata */ T, 
      /* column */ js.UndefOr[typingsSlinky.reactDashDataDashGrid.AdazzleReactDataGrid.Column[T]], 
      _
    ]
  ] = js.undefined
  /**
...
object Column {
  ...
  def apply[T](
    ...
    getRowMetaData: (/* rowdata */ T, /* column */ js.UndefOr[typingsSlinky.reactDashDataDashGrid.AdazzleReactDataGrid.Column[T]]) => _ = null,
