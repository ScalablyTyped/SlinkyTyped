...
import typingsSlinky.reactDataGrid.global.AdazzleReactDataGrid.ReactDataGrid.editors.EditorBase
...
object AdazzleReactDataGridReactDataGridEditorsEditorBase {
  ...
  implicit def make[P, S](companion: AdazzleReactDataGridReactDataGridEditorsEditorBase.type): Builder[P, S] = new Builder[P, S](js.Array(this.component, js.Dictionary.empty))()
}
