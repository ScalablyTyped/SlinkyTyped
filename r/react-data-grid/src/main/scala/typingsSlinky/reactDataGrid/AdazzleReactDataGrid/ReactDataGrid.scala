...
object ReactDataGrid {
  ...
  type Cell = ReactComponentClass[js.Any]
  ...
  object CellCopyPasteEvent {
    ...
    @scala.inline
    def apply(cellKey: String, fromRow: Double, rowIdx: Double, toRow: Double, value: js.Any): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellCopyPasteEvent = {
      ...
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellCopyPasteEvent]
    }
    
    @scala.inline
    implicit class CellCopyPasteEventMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellCopyPasteEvent] (val x: Self) extends AnyVal {
  ...
  object CellDragEvent {
    ...
    @scala.inline
    def apply(cellKey: String, fromRow: Double, toRow: Double, value: js.Any): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellDragEvent = {
      ...
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellDragEvent]
    }
    
    @scala.inline
    implicit class CellDragEventMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellDragEvent] (val x: Self) extends AnyVal {
  ...
  object CellExpandEvent {
    ...
    @scala.inline
    def apply[T](expandArgs: js.Any, idx: Double, rowData: T, rowIdx: Double): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellExpandEvent[T] = {
      ...
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellExpandEvent[T]]
    }
    
    @scala.inline
    implicit class CellExpandEventMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellExpandEvent[_], T] (val x: Self with typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.CellExpandEvent[T]) extends AnyVal {
  ...
  trait Column[T] extends StObject {
    ...
    var getRowMetaData: js.UndefOr[
        js.Function2[
          /* rowdata */ T, 
          /* column */ js.UndefOr[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.Column[T]], 
          _
        ]
      ] = js.native
  ...
  object Column {
    ...
    @scala.inline
    def apply[T](key: String, name: String): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.Column[T] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.Column[T]]
    }
    
    @scala.inline
    implicit class ColumnMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.Column[_], T] (val x: Self with typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.Column[T]) extends AnyVal {
      ...
      def setGetRowMetaData(
        value: (/* rowdata */ T, /* column */ js.UndefOr[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.Column[T]]) => _
  ...
  object DragHandleDoubleClickEvent {
    ...
    @scala.inline
    def apply[T](e: SyntheticEvent[Event, _], idx: Double, rowData: T, rowIdx: Double): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.DragHandleDoubleClickEvent[T] = {
      ...
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.DragHandleDoubleClickEvent[T]]
    }
    
    @scala.inline
    implicit class DragHandleDoubleClickEventMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.DragHandleDoubleClickEvent[_], T] (val x: Self with typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.DragHandleDoubleClickEvent[T]) extends AnyVal {
  ...
  object Filter {
    ...
    @scala.inline
    def apply(columnKey: String, filterTerm: String): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.Filter = {
      val __obj = js.Dynamic.literal(columnKey = columnKey.asInstanceOf[js.Any], filterTerm = filterTerm.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.Filter]
    }
    
    @scala.inline
    implicit class FilterMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.Filter] (val x: Self) extends AnyVal {
  ...
  object GridRowsUpdatedEvent {
    ...
    def apply[T](
      ...
      toRow: Double,
      updated: T
    ): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.GridRowsUpdatedEvent[T] = {
      ...
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.GridRowsUpdatedEvent[T]]
    }
    
    @scala.inline
    implicit class GridRowsUpdatedEventMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.GridRowsUpdatedEvent[_], T] (val x: Self with typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.GridRowsUpdatedEvent[T]) extends AnyVal {
  ...
  object OnRowExpandToggle {
    ...
    @scala.inline
    def apply(columnGroupName: String, name: String, shouldExpand: Boolean): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.OnRowExpandToggle = {
      ...
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.OnRowExpandToggle]
    }
    
    @scala.inline
    implicit class OnRowExpandToggleMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.OnRowExpandToggle] (val x: Self) extends AnyVal {
  ...
  type Row = ReactComponentClass[js.Any]
  ...
  object RowUpdateEvent {
    ...
    @scala.inline
    def apply[T](cellKey: String, key: String, rowIdx: Double, updated: T): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.RowUpdateEvent[T] = {
      ...
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.RowUpdateEvent[T]]
    }
    
    @scala.inline
    implicit class RowUpdateEventMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.RowUpdateEvent[_], T] (val x: Self with typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.RowUpdateEvent[T]) extends AnyVal {
  ...
  object SelectionParams {
    ...
    @scala.inline
    def apply[T](row: T, rowIdx: Double): typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.SelectionParams[T] = {
      val __obj = js.Dynamic.literal(row = row.asInstanceOf[js.Any], rowIdx = rowIdx.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.SelectionParams[T]]
    }
    
    @scala.inline
    implicit class SelectionParamsMutableBuilder[Self <: typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.SelectionParams[_], T] (val x: Self with typingsSlinky.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid.SelectionParams[T]) extends AnyVal {
