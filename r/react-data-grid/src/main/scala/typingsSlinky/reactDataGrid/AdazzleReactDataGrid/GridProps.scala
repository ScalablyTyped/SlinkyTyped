...
object GridProps {
  ...
  implicit class GridPropsMutableBuilder[Self <: GridProps[_], T] (val x: Self with GridProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setEmptyRowsView(value: ReactComponentClass[_]): Self = StObject.set(x, "emptyRowsView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEmptyRowsViewComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "emptyRowsView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEmptyRowsViewFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "emptyRowsView", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRowActionsCell(value: ReactComponentClass[_]): Self = StObject.set(x, "rowActionsCell", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowActionsCellComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "rowActionsCell", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowActionsCellFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "rowActionsCell", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRowGroupRenderer(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "rowGroupRenderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowGroupRendererComponentClass(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "rowGroupRenderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowGroupRendererFunctionComponent(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "rowGroupRenderer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRowRenderer(value: ReactElement | ReactComponentClass[_]): Self = StObject.set(x, "rowRenderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowRendererComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "rowRenderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowRendererFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "rowRenderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowRendererReactElement(value: ReactElement): Self = StObject.set(x, "rowRenderer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectAllRenderer(value: ReactComponentClass[_]): Self = StObject.set(x, "selectAllRenderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectAllRendererComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "selectAllRenderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectAllRendererFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "selectAllRenderer", value.asInstanceOf[js.Any])
