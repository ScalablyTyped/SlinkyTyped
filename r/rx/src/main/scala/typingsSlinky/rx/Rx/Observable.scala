...
import typingsSlinky.rx.Map
import typingsSlinky.rx.Rx.special.FlatMapResultSelector
...
- typingsSlinky.rx.Rx.ObservableOrPromise because Already inherited */ @js.native
