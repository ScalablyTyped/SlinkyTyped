...
object rxBackpressureMod {
  
  @JSImport("rx.backpressure", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("rx.backpressure", "AnonymousObserver")
  @js.native
  ...
  @JSImport("rx.backpressure", "AnonymousSubject")
  @js.native
  ...
  @JSImport("rx.backpressure", "BehaviorSubject")
  @js.native
  ...
  @JSImport("rx.backpressure", "CompositeDisposable")
  @js.native
  ...
  @JSImport("rx.backpressure", "Disposable")
  @js.native
  ...
  @JSImport("rx.backpressure", "Observable")
  @js.native
  ...
  @JSImport("rx.backpressure", "Observer")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.backpressure", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.backpressure", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.backpressure", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.backpressure", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.backpressure", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.backpressure", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.backpressure", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.backpressure", "ReplaySubject")
  @js.native
  ...
  @JSImport("rx.backpressure", "Scheduler")
  @js.native
  ...
  @JSImport("rx.backpressure", "SingleAssignmentDisposable")
  @js.native
  ...
  @JSImport("rx.backpressure", "Subject")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.backpressure", "TestScheduler")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.backpressure", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.backpressure", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.backpressure", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.backpressure", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.backpressure", "internals")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.backpressure", "internals.AbstractObserver")
    @js.native
    ...
    @JSImport("rx.backpressure", "internals.PriorityQueue")
    @js.native
    ...
    @JSImport("rx.backpressure", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.backpressure", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.backpressure", "internals.inherits")
    @js.native
    ...
    @JSImport("rx.backpressure", "internals.isEqual")
    @js.native
