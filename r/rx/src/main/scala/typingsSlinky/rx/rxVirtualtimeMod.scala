...
object rxVirtualtimeMod {
  
  @JSImport("rx.virtualtime", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("rx.virtualtime", "AnonymousObserver")
  @js.native
  ...
  @JSImport("rx.virtualtime", "Disposable")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.virtualtime", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.virtualtime", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.virtualtime", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.virtualtime", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.virtualtime", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.virtualtime", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.virtualtime", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.virtualtime", "Recorded")
  @js.native
  ...
  @JSImport("rx.virtualtime", "Scheduler")
  @js.native
  ...
  @JSImport("rx.virtualtime", "SingleAssignmentDisposable")
  @js.native
  ...
  @JSImport("rx.virtualtime", "Subscription")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.virtualtime", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.virtualtime", "helpers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.virtualtime", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.virtualtime", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.virtualtime", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.virtualtime", "internals.PriorityQueue")
    @js.native
    ...
    @JSImport("rx.virtualtime", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.virtualtime", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.virtualtime", "internals.isEqual")
    @js.native
