...
object rxSortingMod {
  ...
  @JSImport("rx.sorting", JSImport.Namespace)
  @js.native
  ...
  @JSImport("rx.sorting", "CompositeDisposable")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.sorting", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.sorting", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.sorting", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.sorting", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.sorting", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.sorting", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.sorting", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.sorting", "SerialDisposable")
  @js.native
  ...
  @JSImport("rx.sorting", "SingleAssignmentDisposable")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.sorting", "TestScheduler")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.sorting", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.sorting", "helpers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.sorting", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.sorting", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.sorting", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.sorting", "internals.AbstractObserver")
    @js.native
    ...
    @JSImport("rx.sorting", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.sorting", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.sorting", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.sorting", "internals.isEqual")
    @js.native
