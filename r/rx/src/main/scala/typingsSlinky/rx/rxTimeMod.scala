...
object rxTimeMod {
  ...
  @JSImport("rx.time", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("rx.time", "AnonymousObserver")
  @js.native
  ...
  @JSImport("rx.time", "BehaviorSubject")
  @js.native
  ...
  @JSImport("rx.time", "CompositeDisposable")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.time", "HistoricalScheduler")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.time", "ReactiveTest")
    @js.native
    val ^ : js.Any = js.native
    
    /** Default virtual time used for creation of observable sequences in unit tests. */
    @JSImport("rx.time", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.time", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.time", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.time", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.time", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.time", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.time", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.time", "ReplaySubject")
  @js.native
  ...
  @JSImport("rx.time", "SerialDisposable")
  @js.native
  ...
  @JSImport("rx.time", "SingleAssignmentDisposable")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.time", "TestScheduler")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.time", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.time", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.time", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.time", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.time", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.time", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.time", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.time", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.time", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.time", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.time", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.time", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.time", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.time", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.time", "internals")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.time", "internals.AbstractObserver")
    @js.native
    ...
    @JSImport("rx.time", "internals.SchedulePeriodicRecursive")
    @js.native
    ...
    @JSImport("rx.time", "internals.ScheduledItem")
    @js.native
    ...
    @JSImport("rx.time", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.time", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.time", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.time", "internals.inherits")
    @js.native
    ...
    @JSImport("rx.time", "internals.isEqual")
    @js.native
