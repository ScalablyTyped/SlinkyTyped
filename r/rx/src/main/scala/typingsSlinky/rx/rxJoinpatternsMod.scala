...
object rxJoinpatternsMod {
  
  @JSImport("rx.joinpatterns", JSImport.Namespace)
  @js.native
  ...
  @JSImport("rx.joinpatterns", "AsyncSubject")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "BehaviorSubject")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "CompositeDisposable")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "Disposable")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "MockObserver")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "Observable")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "Observer")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.joinpatterns", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.joinpatterns", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.joinpatterns", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.joinpatterns", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.joinpatterns", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.joinpatterns", "RefCountDisposable")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "ReplaySubject")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "Scheduler")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "SerialDisposable")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "SingleAssignmentDisposable")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "Subject")
  @js.native
  ...
  @JSImport("rx.joinpatterns", "Subscription")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.joinpatterns", "TestScheduler")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.joinpatterns", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.joinpatterns", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.joinpatterns", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.joinpatterns", "internals")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.joinpatterns", "internals.AbstractObserver")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "internals.SchedulePeriodicRecursive")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "internals.ScheduledItem")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "internals.inherits")
    @js.native
    ...
    @JSImport("rx.joinpatterns", "internals.isEqual")
    @js.native
