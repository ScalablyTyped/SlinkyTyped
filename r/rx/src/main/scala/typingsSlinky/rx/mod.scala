...
object mod {
  ...
  object ReactiveTest {
    ...
    @JSImport("rx", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx", "ReactiveTest.subscribed")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx", "helpers.notSupported")
    @js.native
