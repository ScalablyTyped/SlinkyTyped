...
object rxCoreTestingMod {
  
  @JSImport("rx.core.testing", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("rx.core.testing", "AnonymousObserver")
  @js.native
  ...
  @JSImport("rx.core.testing", "AnonymousSubject")
  @js.native
  ...
  @JSImport("rx.core.testing", "AsyncSubject")
  @js.native
  ...
  @JSImport("rx.core.testing", "BehaviorSubject")
  @js.native
  ...
  @JSImport("rx.core.testing", "CompositeDisposable")
  @js.native
  ...
  @JSImport("rx.core.testing", "Disposable")
  @js.native
  ...
  @JSImport("rx.core.testing", "Notification")
  @js.native
  ...
  @JSImport("rx.core.testing", "Observable")
  @js.native
  ...
  @JSImport("rx.core.testing", "Observer")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.core.testing", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.core.testing", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.testing", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.testing", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.testing", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.testing", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.core.testing", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.core.testing", "Recorded")
  @js.native
  ...
  @JSImport("rx.core.testing", "RefCountDisposable")
  @js.native
  ...
  @JSImport("rx.core.testing", "ReplaySubject")
  @js.native
  ...
  @JSImport("rx.core.testing", "Scheduler")
  @js.native
  ...
  @JSImport("rx.core.testing", "SingleAssignmentDisposable")
  @js.native
  ...
  @JSImport("rx.core.testing", "Subject")
  @js.native
  ...
  @JSImport("rx.core.testing", "Subscription")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.core.testing", "TestScheduler")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.core.testing", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.core.testing", "helpers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.core.testing", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.core.testing", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.core.testing", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.core.testing", "internals")
    @js.native
    val ^ : js.Any = js.native
    ...
    @JSImport("rx.core.testing", "internals.SchedulePeriodicRecursive")
    @js.native
    ...
    @JSImport("rx.core.testing", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.core.testing", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.core.testing", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.core.testing", "internals.inherits")
    @js.native
    ...
    @JSImport("rx.core.testing", "internals.isEqual")
    @js.native
