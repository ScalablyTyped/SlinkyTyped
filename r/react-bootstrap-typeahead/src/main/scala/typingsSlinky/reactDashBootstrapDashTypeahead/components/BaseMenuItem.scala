...
import typingsSlinky.reactDashBootstrapDashTypeahead.reactDashBootstrapDashTypeaheadMod.BaseMenuItemProps
...
object BaseMenuItem
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashBootstrapDashTypeahead.reactDashBootstrapDashTypeaheadMod.BaseMenuItem
    ] {
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with li, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with li, Event] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrapDashTypeahead.reactDashBootstrapDashTypeaheadMod.BaseMenuItem](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
