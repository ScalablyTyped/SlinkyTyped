...
import typingsSlinky.reactDashBootstrapDashTypeahead.reactDashBootstrapDashTypeaheadMod.TokenProps
import typingsSlinky.reactDashBootstrapDashTypeahead.reactDashBootstrapDashTypeaheadStrings.div
...
object Token
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashBootstrapDashTypeahead.reactDashBootstrapDashTypeaheadMod.Token
    ] {
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with div, Event] => Unit = null,
    onRemove: () => Unit = null,
    onReset: SyntheticEvent[EventTarget with div, Event] => Unit = null,
  ...
  typingsSlinky.reactDashBootstrapDashTypeahead.reactDashBootstrapDashTypeaheadMod.Token](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
