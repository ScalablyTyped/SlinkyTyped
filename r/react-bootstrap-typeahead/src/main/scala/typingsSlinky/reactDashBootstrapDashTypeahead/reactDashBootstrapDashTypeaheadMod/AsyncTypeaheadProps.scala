...
trait AsyncTypeaheadProps[T /* <: TypeaheadModel */] extends TypeaheadProps[T] {
  ...
  var promptText: js.UndefOr[TagMod[Any]] = js.undefined
  /* Message to display in the menu while the request is pending. */
  var searchText: js.UndefOr[TagMod[Any]] = js.undefined
...
object AsyncTypeaheadProps {
  ...
  def apply[T /* <: TypeaheadModel */](
    ...
    promptText: TagMod[Any] = null,
    renderMenu: (/* results */ js.Array[TypeaheadResult[T]], /* menuProps */ js.Any) => TagMod[Any] = null,
    renderMenuItemChildren: (/* option */ TypeaheadResult[T], /* props */ TypeaheadMenuProps[T], /* index */ Double) => TagMod[Any] = null,
    renderToken: (T, /* props */ TypeaheadMenuProps[T], /* index */ Double) => TagMod[Any] = null,
    searchText: TagMod[Any] = null,
