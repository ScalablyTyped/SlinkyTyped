...
object InputProps {
  ...
  implicit class InputPropsMutableBuilder[Self <: InputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: SyntheticMouseEvent[input] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setShouldSelectHint(value: (/* shouldSelect */ Boolean, /* e */ SyntheticKeyboardEvent[HTMLInputElement]) => Boolean): Self = StObject.set(x, "shouldSelectHint", js.Any.fromFunction2(value))
