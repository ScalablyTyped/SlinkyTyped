...
object TypeaheadContext {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](): TypeaheadContext[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypeaheadContext[T]]
  }
  @scala.inline
  implicit class TypeaheadContextOps[Self <: TypeaheadContext[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadContext[T]) extends AnyVal {
    @scala.inline
