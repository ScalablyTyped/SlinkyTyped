...
object TypeaheadState {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](isFocused: Boolean, selected: js.Array[T], showMenu: Boolean, shownResults: Double, text: String): TypeaheadState[T] = {
  ...
  @scala.inline
  implicit class TypeaheadStateOps[Self <: TypeaheadState[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadState[T]) extends AnyVal {
    @scala.inline
