...
object MenuItemContext {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](): MenuItemContext[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuItemContext[T]]
  }
  @scala.inline
  implicit class MenuItemContextOps[Self <: MenuItemContext[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with MenuItemContext[T]) extends AnyVal {
    @scala.inline
