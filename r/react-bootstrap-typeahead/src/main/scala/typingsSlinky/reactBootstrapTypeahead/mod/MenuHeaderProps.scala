...
trait MenuHeaderProps extends js.Object {
  ...
  var onAbort: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onAnimationEnd: js.UndefOr[AnimationEventHandler[li]] = js.undefined
  var onAnimationIteration: js.UndefOr[AnimationEventHandler[li]] = js.undefined
  var onAnimationStart: js.UndefOr[AnimationEventHandler[li]] = js.undefined
  var onAuxClick: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onBeforeInput: js.UndefOr[FormEventHandler[li]] = js.undefined
  var onBlur: js.UndefOr[FocusEventHandler[li]] = js.undefined
  var onCanPlay: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onCanPlayThrough: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onChange: js.UndefOr[FormEventHandler[li]] = js.undefined
  var onClick: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onCompositionEnd: js.UndefOr[CompositionEventHandler[li]] = js.undefined
  var onCompositionStart: js.UndefOr[CompositionEventHandler[li]] = js.undefined
  var onCompositionUpdate: js.UndefOr[CompositionEventHandler[li]] = js.undefined
  var onContextMenu: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onCopy: js.UndefOr[ClipboardEventHandler[li]] = js.undefined
  var onCut: js.UndefOr[ClipboardEventHandler[li]] = js.undefined
  var onDoubleClick: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onDrag: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDragEnd: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDragEnter: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDragExit: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDragLeave: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDragOver: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDragStart: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDrop: js.UndefOr[DragEventHandler[li]] = js.undefined
  var onDurationChange: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onEmptied: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onEncrypted: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onEnded: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onError: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onFocus: js.UndefOr[FocusEventHandler[li]] = js.undefined
  var onInput: js.UndefOr[FormEventHandler[li]] = js.undefined
  var onInvalid: js.UndefOr[FormEventHandler[li]] = js.undefined
  var onKeyDown: js.UndefOr[KeyboardEventHandler[li]] = js.undefined
  var onKeyPress: js.UndefOr[KeyboardEventHandler[li]] = js.undefined
  var onKeyUp: js.UndefOr[KeyboardEventHandler[li]] = js.undefined
  var onLoad: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onLoadStart: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onLoadedData: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onLoadedMetadata: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onMouseDown: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onMouseEnter: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onMouseLeave: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onMouseMove: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onMouseOut: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onMouseOver: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onMouseUp: js.UndefOr[MouseEventHandler[li]] = js.undefined
  var onPaste: js.UndefOr[ClipboardEventHandler[li]] = js.undefined
  var onPause: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onPlay: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onPlaying: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onPointerCancel: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onPointerDown: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onPointerEnter: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onPointerLeave: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onPointerMove: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onPointerOut: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onPointerOver: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onPointerUp: js.UndefOr[PointerEventHandler[li]] = js.undefined
  var onProgress: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onRateChange: js.UndefOr[ReactEventHandler[li]] = js.undefined
  ...
  var onSeeking: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onSelect: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onStalled: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onSubmit: js.UndefOr[FormEventHandler[li]] = js.undefined
  var onSuspend: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onTimeUpdate: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onTouchCancel: js.UndefOr[TouchEventHandler[li]] = js.undefined
  var onTouchEnd: js.UndefOr[TouchEventHandler[li]] = js.undefined
  var onTouchMove: js.UndefOr[TouchEventHandler[li]] = js.undefined
  var onTouchStart: js.UndefOr[TouchEventHandler[li]] = js.undefined
  var onTransitionEnd: js.UndefOr[TransitionEventHandler[li]] = js.undefined
  var onVolumeChange: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onWaiting: js.UndefOr[ReactEventHandler[li]] = js.undefined
  var onWheel: js.UndefOr[WheelEventHandler[li]] = js.undefined
  ...
  var ref: js.UndefOr[LegacyRef[li]] = js.undefined
...
object MenuHeaderProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Event, li] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[Event, li] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, li] => Unit = null,
    onChange: SyntheticEvent[EventTarget with li, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, li] => Unit = null,
    onEmptied: SyntheticEvent[Event, li] => Unit = null,
    onEncrypted: SyntheticEvent[Event, li] => Unit = null,
    onEnded: SyntheticEvent[Event, li] => Unit = null,
    onError: SyntheticEvent[Event, li] => Unit = null,
    onFocus: SyntheticFocusEvent[li] => Unit = null,
    onInput: SyntheticEvent[EventTarget with li, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with li, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, li] => Unit = null,
    onLoadStart: SyntheticEvent[Event, li] => Unit = null,
    onLoadedData: SyntheticEvent[Event, li] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, li] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, li] => Unit = null,
    onPlay: SyntheticEvent[Event, li] => Unit = null,
    onPlaying: SyntheticEvent[Event, li] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, li] => Unit = null,
    onRateChange: SyntheticEvent[Event, li] => Unit = null,
    onReset: SyntheticEvent[EventTarget with li, Event] => Unit = null,
    onScroll: SyntheticUIEvent[li] => Unit = null,
    onSeeked: SyntheticEvent[Event, li] => Unit = null,
    onSeeking: SyntheticEvent[Event, li] => Unit = null,
    onSelect: SyntheticEvent[Event, li] => Unit = null,
    onStalled: SyntheticEvent[Event, li] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with li, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, li] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, li] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, li] => Unit = null,
    onWaiting: SyntheticEvent[Event, li] => Unit = null,
    ...
    ref: js.UndefOr[Null | LegacyRef[li]] = js.undefined,
    rel: String = null,
