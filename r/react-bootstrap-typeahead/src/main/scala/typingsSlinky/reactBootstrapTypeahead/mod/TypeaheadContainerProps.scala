...
object TypeaheadContainerProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](isFocused: Boolean, selected: js.Array[T], showMenu: Boolean, shownResults: Double, text: String): TypeaheadContainerProps[T] = {
  ...
  @scala.inline
  implicit class TypeaheadContainerPropsOps[Self <: TypeaheadContainerProps[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadContainerProps[T]) extends AnyVal {
    @scala.inline
