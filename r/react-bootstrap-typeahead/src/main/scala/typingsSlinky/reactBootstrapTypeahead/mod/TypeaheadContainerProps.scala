...
object TypeaheadContainerProps {
  @scala.inline
  def apply[T](isFocused: Boolean, selected: js.Array[T], showMenu: Boolean, shownResults: Double, text: String): TypeaheadContainerProps[T] = {
  ...
  @scala.inline
  implicit class TypeaheadContainerPropsOps[Self[t] <: TypeaheadContainerProps[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
