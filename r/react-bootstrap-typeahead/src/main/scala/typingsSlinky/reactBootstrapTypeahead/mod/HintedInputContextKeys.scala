...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.hintText
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.initialItem
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.onAdd
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.selectHintOnEnter
*/
