...
object InputContainerPropsMultiple {
  ...
  @scala.inline
  implicit class InputContainerPropsMultipleOps[Self <: InputContainerPropsMultiple[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with InputContainerPropsMultiple[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRenderToken(value: (T, TypeaheadMenuProps[T], Double) => ReactElement): Self = this.set("renderToken", js.Any.fromFunction3(value))
    @scala.inline
