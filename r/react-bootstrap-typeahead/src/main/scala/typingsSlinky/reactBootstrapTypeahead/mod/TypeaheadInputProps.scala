...
object TypeaheadInputProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](): TypeaheadInputProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypeaheadInputProps[T]]
  }
  @scala.inline
  implicit class TypeaheadInputPropsOps[Self <: TypeaheadInputProps[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadInputProps[T]) extends AnyVal {
    @scala.inline
