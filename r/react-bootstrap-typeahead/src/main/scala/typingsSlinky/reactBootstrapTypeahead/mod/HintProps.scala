...
object HintProps {
  ...
  implicit class HintPropsOps[Self <: HintProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShouldSelect(value: (/* shouldSelect */ Boolean, /* e */ SyntheticKeyboardEvent[HTMLInputElement]) => Boolean): Self = this.set("shouldSelect", js.Any.fromFunction2(value))
