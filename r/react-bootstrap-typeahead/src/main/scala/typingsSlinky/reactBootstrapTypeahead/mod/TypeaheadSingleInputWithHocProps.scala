...
object TypeaheadSingleInputWithHocProps {
  ...
  @scala.inline
  implicit class TypeaheadSingleInputWithHocPropsOps[Self <: TypeaheadSingleInputWithHocProps[_], T /* <: TypeaheadModel */] (val x: Self with TypeaheadSingleInputWithHocProps[T]) extends AnyVal {
