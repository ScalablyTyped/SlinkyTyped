...
object TypeaheadMulitInputWithHocProps {
  ...
  @scala.inline
  implicit class TypeaheadMulitInputWithHocPropsOps[Self <: TypeaheadMulitInputWithHocProps[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadMulitInputWithHocProps[T]) extends AnyVal {
    @scala.inline
