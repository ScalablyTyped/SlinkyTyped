...
object HintedInputContext {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](): HintedInputContext[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HintedInputContext[T]]
  }
  @scala.inline
  implicit class HintedInputContextOps[Self <: HintedInputContext[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with HintedInputContext[T]) extends AnyVal {
    @scala.inline
