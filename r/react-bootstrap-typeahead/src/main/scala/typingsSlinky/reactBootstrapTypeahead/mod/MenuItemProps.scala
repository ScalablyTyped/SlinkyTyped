...
object MenuItemProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](option: T, position: Double): MenuItemProps[T] = {
  ...
  @scala.inline
  implicit class MenuItemPropsOps[Self <: MenuItemProps[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with MenuItemProps[T]) extends AnyVal {
    @scala.inline
