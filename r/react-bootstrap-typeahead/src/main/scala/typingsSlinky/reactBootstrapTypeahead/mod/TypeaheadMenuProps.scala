...
object TypeaheadMenuProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](id: String, options: js.Array[T]): TypeaheadMenuProps[T] = {
  ...
  @scala.inline
  implicit class TypeaheadMenuPropsOps[Self <: TypeaheadMenuProps[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadMenuProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setInnerRefRefObject(value: ReactRef[HTMLUListElement]): Self = this.set("innerRef", value.asInstanceOf[js.Any])
    @scala.inline
