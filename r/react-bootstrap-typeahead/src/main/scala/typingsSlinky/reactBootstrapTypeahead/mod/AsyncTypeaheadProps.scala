...
trait AsyncTypeaheadProps[T /* <: TypeaheadModel */] extends TypeaheadProps[T] {
  ...
  var promptText: js.UndefOr[ReactElement] = js.native
...
object AsyncTypeaheadProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](isLoading: Boolean, onSearch: String => Unit, options: js.Array[T]): AsyncTypeaheadProps[T] = {
  ...
  @scala.inline
  implicit class AsyncTypeaheadPropsOps[Self <: AsyncTypeaheadProps[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with AsyncTypeaheadProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPromptTextReactElement(value: ReactElement): Self = this.set("promptText", value.asInstanceOf[js.Any])
    @scala.inline
    def setPromptText(value: ReactElement): Self = this.set("promptText", value.asInstanceOf[js.Any])
    @scala.inline
