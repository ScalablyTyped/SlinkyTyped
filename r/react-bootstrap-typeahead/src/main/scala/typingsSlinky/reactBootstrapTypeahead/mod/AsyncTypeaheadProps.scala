...
object AsyncTypeaheadProps {
  ...
  implicit class AsyncTypeaheadPropsMutableBuilder[Self <: AsyncTypeaheadProps[_], T /* <: TypeaheadModel */] (val x: Self with AsyncTypeaheadProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setPromptText(value: ReactElement): Self = StObject.set(x, "promptText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPromptTextReactElement(value: ReactElement): Self = StObject.set(x, "promptText", value.asInstanceOf[js.Any])
