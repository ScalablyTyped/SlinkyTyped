...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.activeIndex
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.isOnlyResult
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.onActiveItemChange
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.onInitialItemChange
  - typingsSlinky.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.onMenuItemClick
*/
trait MenuItemContextKeys extends js.Object
