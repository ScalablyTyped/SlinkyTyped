...
object TypeaheadProps {
  ...
  @scala.inline
  implicit class TypeaheadPropsMutableBuilder[Self <: TypeaheadProps[_], T /* <: TypeaheadModel */] (val x: Self with TypeaheadProps[T]) extends AnyVal {
    ...
    ): Self = StObject.set(x, "renderToken", js.Any.fromFunction3(value))
