...
object TypeaheadProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T](options: js.Array[T]): TypeaheadProps[T] = {
    val __obj = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[TypeaheadProps[T]]
  }
  @scala.inline
  implicit class TypeaheadPropsOps[Self <: TypeaheadProps[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRenderToken(
      value: (/* selectedItem */ T, /* props */ TypeaheadMenuProps[T], /* index */ Double) => ReactElement
    ): Self = this.set("renderToken", js.Any.fromFunction3(value))
    @scala.inline
