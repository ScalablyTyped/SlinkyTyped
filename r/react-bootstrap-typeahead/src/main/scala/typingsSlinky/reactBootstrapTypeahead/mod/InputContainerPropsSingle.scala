...
object InputContainerPropsSingle {
  ...
  @scala.inline
  implicit class InputContainerPropsSingleOps[Self <: InputContainerPropsSingle[_], /* <: typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with InputContainerPropsSingle[T]) extends AnyVal {
    @scala.inline
