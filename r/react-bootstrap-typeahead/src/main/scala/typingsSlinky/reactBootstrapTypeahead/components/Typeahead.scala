...
object Typeahead
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.Typeahead[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.Typeahead[js.Any]] = {
  ...
  typingsSlinky.reactBootstrapTypeahead.mod.Typeahead[js.Any]]]
  }
