...
object TypeaheadInputMulti
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadInputMulti[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadInputMulti[js.Any]] = {
  ...
  typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadInputMulti[js.Any]]]
  }
