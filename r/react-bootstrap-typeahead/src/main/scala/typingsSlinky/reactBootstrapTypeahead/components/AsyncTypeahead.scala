...
object AsyncTypeahead
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.AsyncTypeahead[js.Any]] {
  @JSImport("react-bootstrap-typeahead", "AsyncTypeahead")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: autoFocus, disabled, multiple, open, placeholder */
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.AsyncTypeahead[js.Any]] = {
  ...
  typingsSlinky.reactBootstrapTypeahead.mod.AsyncTypeahead[js.Any]]]
  }
