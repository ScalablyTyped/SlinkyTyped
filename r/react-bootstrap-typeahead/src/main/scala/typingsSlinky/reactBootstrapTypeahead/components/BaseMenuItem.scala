...
object BaseMenuItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.BaseMenuItem] {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, li] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[li] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[li] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[li] => Unit = null,
    onAuxClick: SyntheticMouseEvent[li] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with li, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[li] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, li] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, li] => Unit = null,
    onChange: SyntheticEvent[EventTarget with li, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[li] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[li] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[li] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[li] => Unit = null,
    onContextMenu: SyntheticMouseEvent[li] => Unit = null,
    onCopy: SyntheticClipboardEvent[li] => Unit = null,
    onCut: SyntheticClipboardEvent[li] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[li] => Unit = null,
    onDrag: DragEvent[li] => Unit = null,
    onDragEnd: DragEvent[li] => Unit = null,
    onDragEnter: DragEvent[li] => Unit = null,
    onDragExit: DragEvent[li] => Unit = null,
    onDragLeave: DragEvent[li] => Unit = null,
    onDragOver: DragEvent[li] => Unit = null,
    onDragStart: DragEvent[li] => Unit = null,
    onDrop: DragEvent[li] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, li] => Unit = null,
    onEmptied: SyntheticEvent[Event_, li] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, li] => Unit = null,
    onEnded: SyntheticEvent[Event_, li] => Unit = null,
    onError: SyntheticEvent[Event_, li] => Unit = null,
    onFocus: SyntheticFocusEvent[li] => Unit = null,
    onInput: SyntheticEvent[EventTarget with li, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with li, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[li] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[li] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[li] => Unit = null,
    onLoad: SyntheticEvent[Event_, li] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, li] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, li] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, li] => Unit = null,
    onMouseDown: SyntheticMouseEvent[li] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[li] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[li] => Unit = null,
    onMouseMove: SyntheticMouseEvent[li] => Unit = null,
    onMouseOut: SyntheticMouseEvent[li] => Unit = null,
    onMouseOver: SyntheticMouseEvent[li] => Unit = null,
    onMouseUp: SyntheticMouseEvent[li] => Unit = null,
    onPaste: SyntheticClipboardEvent[li] => Unit = null,
    onPause: SyntheticEvent[Event_, li] => Unit = null,
    onPlay: SyntheticEvent[Event_, li] => Unit = null,
    onPlaying: SyntheticEvent[Event_, li] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[li] => Unit = null,
    onPointerDown: SyntheticPointerEvent[li] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[li] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[li] => Unit = null,
    onPointerMove: SyntheticPointerEvent[li] => Unit = null,
    onPointerOut: SyntheticPointerEvent[li] => Unit = null,
    onPointerOver: SyntheticPointerEvent[li] => Unit = null,
    onPointerUp: SyntheticPointerEvent[li] => Unit = null,
    onProgress: SyntheticEvent[Event_, li] => Unit = null,
    onRateChange: SyntheticEvent[Event_, li] => Unit = null,
    onReset: SyntheticEvent[EventTarget with li, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[li] => Unit = null,
    onSeeked: SyntheticEvent[Event_, li] => Unit = null,
    onSeeking: SyntheticEvent[Event_, li] => Unit = null,
    onSelect: SyntheticEvent[Event_, li] => Unit = null,
    onStalled: SyntheticEvent[Event_, li] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with li, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, li] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, li] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[li] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[li] => Unit = null,
    onTouchMove: SyntheticTouchEvent[li] => Unit = null,
    onTouchStart: SyntheticTouchEvent[li] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[li] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, li] => Unit = null,
    onWaiting: SyntheticEvent[Event_, li] => Unit = null,
    onWheel: SyntheticWheelEvent[li] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.BaseMenuItem] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.BaseMenuItem] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactBootstrapTypeahead.mod.BaseMenuItem](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
