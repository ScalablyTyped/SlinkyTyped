...
object Token
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.Token] {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, div] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[div] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[div] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[div] => Unit = null,
    onAuxClick: SyntheticMouseEvent[div] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with div, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[div] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, div] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, div] => Unit = null,
    onChange: SyntheticEvent[EventTarget with div, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[div] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[div] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[div] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[div] => Unit = null,
    onContextMenu: SyntheticMouseEvent[div] => Unit = null,
    onCopy: SyntheticClipboardEvent[div] => Unit = null,
    onCut: SyntheticClipboardEvent[div] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[div] => Unit = null,
    onDrag: DragEvent[div] => Unit = null,
    onDragEnd: DragEvent[div] => Unit = null,
    onDragEnter: DragEvent[div] => Unit = null,
    onDragExit: DragEvent[div] => Unit = null,
    onDragLeave: DragEvent[div] => Unit = null,
    onDragOver: DragEvent[div] => Unit = null,
    onDragStart: DragEvent[div] => Unit = null,
    onDrop: DragEvent[div] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, div] => Unit = null,
    onEmptied: SyntheticEvent[Event_, div] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, div] => Unit = null,
    onEnded: SyntheticEvent[Event_, div] => Unit = null,
    onError: SyntheticEvent[Event_, div] => Unit = null,
    onFocus: SyntheticFocusEvent[div] => Unit = null,
    onInput: SyntheticEvent[EventTarget with div, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with div, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[div] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[div] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[div] => Unit = null,
    onLoad: SyntheticEvent[Event_, div] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, div] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, div] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, div] => Unit = null,
    onMouseDown: SyntheticMouseEvent[div] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[div] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[div] => Unit = null,
    onMouseMove: SyntheticMouseEvent[div] => Unit = null,
    onMouseOut: SyntheticMouseEvent[div] => Unit = null,
    onMouseOver: SyntheticMouseEvent[div] => Unit = null,
    onMouseUp: SyntheticMouseEvent[div] => Unit = null,
    onPaste: SyntheticClipboardEvent[div] => Unit = null,
    onPause: SyntheticEvent[Event_, div] => Unit = null,
    onPlay: SyntheticEvent[Event_, div] => Unit = null,
    onPlaying: SyntheticEvent[Event_, div] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[div] => Unit = null,
    onPointerDown: SyntheticPointerEvent[div] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[div] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[div] => Unit = null,
    onPointerMove: SyntheticPointerEvent[div] => Unit = null,
    onPointerOut: SyntheticPointerEvent[div] => Unit = null,
    onPointerOver: SyntheticPointerEvent[div] => Unit = null,
    onPointerUp: SyntheticPointerEvent[div] => Unit = null,
    onProgress: SyntheticEvent[Event_, div] => Unit = null,
    onRateChange: SyntheticEvent[Event_, div] => Unit = null,
    onRemove: () => Unit = null,
    onReset: SyntheticEvent[EventTarget with div, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[div] => Unit = null,
    onSeeked: SyntheticEvent[Event_, div] => Unit = null,
    onSeeking: SyntheticEvent[Event_, div] => Unit = null,
    onSelect: SyntheticEvent[Event_, div] => Unit = null,
    onStalled: SyntheticEvent[Event_, div] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with div, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, div] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, div] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[div] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[div] => Unit = null,
    onTouchMove: SyntheticTouchEvent[div] => Unit = null,
    onTouchStart: SyntheticTouchEvent[div] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[div] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, div] => Unit = null,
    onWaiting: SyntheticEvent[Event_, div] => Unit = null,
    onWheel: SyntheticWheelEvent[div] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.Token] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.Token] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactBootstrapTypeahead.mod.Token](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
