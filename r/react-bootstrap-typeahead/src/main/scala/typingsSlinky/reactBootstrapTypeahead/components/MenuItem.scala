...
object MenuItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.MenuItem[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.MenuItem[js.Any]] = {
  ...
  typingsSlinky.reactBootstrapTypeahead.mod.MenuItem[js.Any]]]
  }
  type Props = MenuItemProps[js.Any]
}
