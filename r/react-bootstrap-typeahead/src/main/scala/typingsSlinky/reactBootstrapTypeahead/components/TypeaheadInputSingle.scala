...
object TypeaheadInputSingle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadInputSingle[js.Any]] {
  @JSImport("react-bootstrap-typeahead", "TypeaheadInputSingle")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: accept, autoFocus, capture, checked, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, form, height, hidden, id, lang, list, max, min, multiple, name, pattern, placeholder, readOnly, required, size, spellCheck, src, step, style, suppressContentEditableWarning, tabIndex, title, width */
  def apply[T /* <: TypeaheadModel */](
    ...
    onAbort: SyntheticEvent[Event_, input] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[input] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[input] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[input] => Unit = null,
    onAuxClick: SyntheticMouseEvent[input] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with input, Event_] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, input] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, input] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[input] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[input] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[input] => Unit = null,
    onContextMenu: SyntheticMouseEvent[input] => Unit = null,
    onCopy: SyntheticClipboardEvent[input] => Unit = null,
    onCut: SyntheticClipboardEvent[input] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[input] => Unit = null,
    onDrag: DragEvent[input] => Unit = null,
    onDragEnd: DragEvent[input] => Unit = null,
    onDragEnter: DragEvent[input] => Unit = null,
    onDragExit: DragEvent[input] => Unit = null,
    onDragLeave: DragEvent[input] => Unit = null,
    onDragOver: DragEvent[input] => Unit = null,
    onDragStart: DragEvent[input] => Unit = null,
    onDrop: DragEvent[input] => Unit = null,
    onDurationChange: SyntheticEvent[Event_, input] => Unit = null,
    onEmptied: SyntheticEvent[Event_, input] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, input] => Unit = null,
    onEnded: SyntheticEvent[Event_, input] => Unit = null,
    onError: SyntheticEvent[Event_, input] => Unit = null,
    onInput: SyntheticEvent[EventTarget with input, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with input, Event_] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[input] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[input] => Unit = null,
    onLoad: SyntheticEvent[Event_, input] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, input] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, input] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, input] => Unit = null,
    onMouseDown: SyntheticMouseEvent[input] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[input] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[input] => Unit = null,
    onMouseMove: SyntheticMouseEvent[input] => Unit = null,
    onMouseOut: SyntheticMouseEvent[input] => Unit = null,
    onMouseOver: SyntheticMouseEvent[input] => Unit = null,
    onMouseUp: SyntheticMouseEvent[input] => Unit = null,
    onPaste: SyntheticClipboardEvent[input] => Unit = null,
    onPause: SyntheticEvent[Event_, input] => Unit = null,
    onPlay: SyntheticEvent[Event_, input] => Unit = null,
    onPlaying: SyntheticEvent[Event_, input] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[input] => Unit = null,
    onPointerDown: SyntheticPointerEvent[input] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[input] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[input] => Unit = null,
    onPointerMove: SyntheticPointerEvent[input] => Unit = null,
    onPointerOut: SyntheticPointerEvent[input] => Unit = null,
    onPointerOver: SyntheticPointerEvent[input] => Unit = null,
    onPointerUp: SyntheticPointerEvent[input] => Unit = null,
    onProgress: SyntheticEvent[Event_, input] => Unit = null,
    onRateChange: SyntheticEvent[Event_, input] => Unit = null,
    onReset: SyntheticEvent[EventTarget with input, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[input] => Unit = null,
    onSeeked: SyntheticEvent[Event_, input] => Unit = null,
    onSeeking: SyntheticEvent[Event_, input] => Unit = null,
    onSelect: SyntheticEvent[Event_, input] => Unit = null,
    onStalled: SyntheticEvent[Event_, input] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with input, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, input] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, input] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[input] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[input] => Unit = null,
    onTouchMove: SyntheticTouchEvent[input] => Unit = null,
    onTouchStart: SyntheticTouchEvent[input] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[input] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, input] => Unit = null,
    onWaiting: SyntheticEvent[Event_, input] => Unit = null,
    onWheel: SyntheticWheelEvent[input] => Unit = null,
    prefix: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadInputSingle[js.Any]] = {
  ...
  typingsSlinky.reactBootstrapTypeahead.mod.TypeaheadInputSingle[js.Any]]]
  }
