...
object Button {
  ...
  def withProps(p: ButtonProps with ViewProps with TextProps): SharedBuilder_ButtonPropsViewPropsTextProps_620818419[typingsSlinky.reactNativeDialog.mod.default.Button] = new SharedBuilder_ButtonPropsViewPropsTextProps_620818419[typingsSlinky.reactNativeDialog.mod.default.Button](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(label: String, onPress: () => Unit): SharedBuilder_ButtonPropsViewPropsTextProps_620818419[typingsSlinky.reactNativeDialog.mod.default.Button] = {
    val __props = js.Dynamic.literal(label = label.asInstanceOf[js.Any], onPress = js.Any.fromFunction0(onPress))
    new SharedBuilder_ButtonPropsViewPropsTextProps_620818419[typingsSlinky.reactNativeDialog.mod.default.Button](js.Array(this.component, __props.asInstanceOf[ButtonProps with ViewProps with TextProps]))
  }
}
