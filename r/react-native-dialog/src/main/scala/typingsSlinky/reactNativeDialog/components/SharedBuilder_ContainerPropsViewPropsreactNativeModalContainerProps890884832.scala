...
@scala.inline
class SharedBuilder_ContainerPropsViewPropsreactNativeModalContainerProps890884832[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def animationIn(value: Animation | (CustomAnimation[TextStyle with ViewStyle with ImageStyle])): this.type = set("animationIn", value.asInstanceOf[js.Any])
  @scala.inline
  def animationInTiming(value: Double): this.type = set("animationInTiming", value.asInstanceOf[js.Any])
  @scala.inline
  def animationOut(value: Animation | (CustomAnimation[TextStyle with ViewStyle with ImageStyle])): this.type = set("animationOut", value.asInstanceOf[js.Any])
  @scala.inline
  def animationOutTiming(value: Double): this.type = set("animationOutTiming", value.asInstanceOf[js.Any])
  @scala.inline
  def avoidKeyboard(value: Boolean): this.type = set("avoidKeyboard", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def backdropTransitionInTiming(value: Double): this.type = set("backdropTransitionInTiming", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def blurComponentIOS(value: TagMod[Any]): this.type = set("blurComponentIOS", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def contentStyle(value: ViewStyle): this.type = set("contentStyle", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def deviceWidth(value: Double): this.type = set("deviceWidth", value.asInstanceOf[js.Any])
  @scala.inline
  def footerStyle(value: ViewStyle): this.type = set("footerStyle", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def headerStyle(value: ViewStyle): this.type = set("headerStyle", value.asInstanceOf[js.Any])
  @scala.inline
  def hideModalContentWhileAnimating(value: Boolean): this.type = set("hideModalContentWhileAnimating", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def onBackButtonPress(value: () => Unit): this.type = set("onBackButtonPress", js.Any.fromFunction0(value))
  @scala.inline
  ...
  @scala.inline
  def onModalHide(value: () => Unit): this.type = set("onModalHide", js.Any.fromFunction0(value))
  @scala.inline
  def onModalShow(value: () => Unit): this.type = set("onModalShow", js.Any.fromFunction0(value))
  @scala.inline
  def onModalWillHide(value: () => Unit): this.type = set("onModalWillHide", js.Any.fromFunction0(value))
  @scala.inline
  def onModalWillShow(value: () => Unit): this.type = set("onModalWillShow", js.Any.fromFunction0(value))
  @scala.inline
  ...
  @scala.inline
  def onOrientationChange(value: SyntheticEvent[NodeHandle, js.Any] => Unit): this.type = set("onOrientationChange", js.Any.fromFunction1(value))
  @scala.inline
  ...
  @scala.inline
  def onSwipeCancel(value: () => Unit): this.type = set("onSwipeCancel", js.Any.fromFunction0(value))
  @scala.inline
  def onSwipeComplete(value: /* params */ OnSwipeCompleteParams => Unit): this.type = set("onSwipeComplete", js.Any.fromFunction1(value))
  @scala.inline
  def onSwipeMove(value: /* percentageShown */ Double => Unit): this.type = set("onSwipeMove", js.Any.fromFunction1(value))
  @scala.inline
  ...
  @scala.inline
  def presentationStyle(value: PresentationStyle): this.type = set("presentationStyle", value.asInstanceOf[js.Any])
  @scala.inline
  def propagateSwipe(value: Boolean): this.type = set("propagateSwipe", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def scrollHorizontal(value: Boolean): this.type = set("scrollHorizontal", value.asInstanceOf[js.Any])
  @scala.inline
  def scrollOffset(value: Double): this.type = set("scrollOffset", value.asInstanceOf[js.Any])
  @scala.inline
  def scrollOffsetMax(value: Double): this.type = set("scrollOffsetMax", value.asInstanceOf[js.Any])
  @scala.inline
  def scrollTo(value: /* e */ _ => Unit): this.type = set("scrollTo", js.Any.fromFunction1(value))
  @scala.inline
  def scrollToNull: this.type = set("scrollTo", null)
  @scala.inline
