...
object Description {
  ...
  def withProps(p: DescriptionProps with ViewProps with TextProps): SharedBuilder_DescriptionPropsViewPropsTextProps1493291014[typingsSlinky.reactNativeDialog.mod.default.Description] = new SharedBuilder_DescriptionPropsViewPropsTextProps1493291014[typingsSlinky.reactNativeDialog.mod.default.Description](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Description.type): SharedBuilder_DescriptionPropsViewPropsTextProps1493291014[typingsSlinky.reactNativeDialog.mod.default.Description] = new SharedBuilder_DescriptionPropsViewPropsTextProps1493291014[typingsSlinky.reactNativeDialog.mod.default.Description](js.Array(this.component, js.Dictionary.empty))()
}
