package typingsSlinky.reactNativeDialog
...
object mod {
  ...
  object default {
    ...
    class Button protected ()
      extends typingsSlinky.reactNativeDialog.mod.Dialog.Button {
    ...
    class Container protected ()
      extends typingsSlinky.reactNativeDialog.mod.Dialog.Container {
    ...
    class Description protected ()
      extends typingsSlinky.reactNativeDialog.mod.Dialog.Description {
    ...
    class Input[T] protected ()
      extends typingsSlinky.reactNativeDialog.mod.Dialog.Input[T] {
    ...
    class Title protected ()
      extends typingsSlinky.reactNativeDialog.mod.Dialog.Title {
  ...
  trait ContainerProps extends StObject {
    ...
    var blurComponentIOS: js.UndefOr[ReactElement] = js.native
  ...
  object ContainerProps {
    ...
    @scala.inline
    def apply(children: js.Array[ReactElement]): ContainerProps = {
    ...
    implicit class ContainerPropsMutableBuilder[Self <: ContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBlurComponentIOS(value: ReactElement): Self = StObject.set(x, "blurComponentIOS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBlurComponentIOSReactElement(value: ReactElement): Self = StObject.set(x, "blurComponentIOS", value.asInstanceOf[js.Any])
  ...
  object InputProps {
    ...
    implicit class InputPropsMutableBuilder[Self <: InputProps[_], T] (val x: Self with InputProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setTextInputRefRefObject(value: ReactRef[T]): Self = StObject.set(x, "textInputRef", value.asInstanceOf[js.Any])
  ...
  trait reactNativeModalContainerProps extends StObject {
    ...
    var customBackdrop: js.UndefOr[ReactElement] = js.native
  ...
  object reactNativeModalContainerProps {
    ...
    implicit class reactNativeModalContainerPropsMutableBuilder[Self <: reactNativeModalContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomBackdropReactElement(value: ReactElement): Self = StObject.set(x, "customBackdrop", value.asInstanceOf[js.Any])
