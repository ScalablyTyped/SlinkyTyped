...
object reactNativeModalContainerProps {
  ...
  implicit class reactNativeModalContainerPropsOps[Self <: reactNativeModalContainerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomBackdropReactElement(value: ReactElement): Self = this.set("customBackdrop", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomBackdrop(value: ReactElement): Self = this.set("customBackdrop", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnOrientationChange(value: SyntheticEvent[NodeHandle, js.Any] => Unit): Self = this.set("onOrientationChange", js.Any.fromFunction1(value))
    @scala.inline
