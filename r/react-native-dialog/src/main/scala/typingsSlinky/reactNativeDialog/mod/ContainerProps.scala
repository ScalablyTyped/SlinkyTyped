...
object ContainerProps {
  ...
  implicit class ContainerPropsOps[Self <: ContainerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlurComponentIOSReactElement(value: ReactElement): Self = this.set("blurComponentIOS", value.asInstanceOf[js.Any])
    @scala.inline
    def setBlurComponentIOS(value: ReactElement): Self = this.set("blurComponentIOS", value.asInstanceOf[js.Any])
    @scala.inline
