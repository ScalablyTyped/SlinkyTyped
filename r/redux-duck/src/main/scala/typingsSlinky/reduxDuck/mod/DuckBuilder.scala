...
object DuckBuilder {
  @scala.inline
  def apply[/* <: typingsSlinky.redux.mod.Action[_] */ AppAction](
  ...
  @scala.inline
  implicit class DuckBuilderOps[Self <: DuckBuilder[_], /* <: typingsSlinky.redux.mod.Action[_] */ AppAction] (val x: Self with DuckBuilder[AppAction]) extends AnyVal {
    @scala.inline
