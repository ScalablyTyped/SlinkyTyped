package typingsSlinky.reduxDashDuck
...
package object reduxDashDuckMod {
  ...
  import typingsSlinky.reduxDashDuck.Anon_Payload
  ...
  {[ T in A['type'] ]:? (x : S, y : std.Extract<A, {  type  :T}>): S}
    */ typingsSlinky.reduxDashDuck.reduxDashDuckStrings.ActionHandlers with js.Any
