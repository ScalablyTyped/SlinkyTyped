...
object Badge {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableNullOnZero(value: Boolean): this.type = set("disableNullOnZero", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def theme(value: BadgeTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  ...
  def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[BadgeProps with RefAttributes[HTMLSpanElement]]))
  }
}
