package typingsSlinky.reactMdBadge.components
...
object BadgeContainer {
  ...
  def withProps(p: BadgeContainerProps with RefAttributes[HTMLSpanElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: BadgeContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
