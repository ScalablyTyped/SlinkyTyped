...
object badgedButtonMod {
  ...
  object BadgedButtonProps {
    ...
    implicit class BadgedButtonPropsMutableBuilder[Self <: BadgedButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBadgeRefRefObject(value: ReactRef[HTMLSpanElement]): Self = StObject.set(x, "badgeRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setButtonChildren(value: ReactElement): Self = StObject.set(x, "buttonChildren", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonChildrenReactElement(value: ReactElement): Self = StObject.set(x, "buttonChildren", value.asInstanceOf[js.Any])
