package typingsSlinky.reactMdBadge.badgeMod
...
/**
  ...
  */
@JSImport("@react-md/badge/types/Badge", JSImport.Default)
@js.native
object default extends TopLevel[ForwardRefExoticComponent[BadgeProps with RefAttributes[HTMLSpanElement]]]
