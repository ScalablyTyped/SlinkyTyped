...
object VerticalTimelineElement
  ...
  typingsSlinky.reactDashVerticalDashTimelineDashComponent.reactDashVerticalDashTimelineDashComponentMod.VerticalTimelineElement](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
