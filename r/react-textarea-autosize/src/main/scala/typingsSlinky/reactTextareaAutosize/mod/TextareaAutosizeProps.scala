...
trait TextareaAutosizeProps
  ...
  var inputRef: js.UndefOr[
    (js.Function1[/* node */ org.scalajs.dom.raw.HTMLTextAreaElement, Unit]) | ReactRef[org.scalajs.dom.raw.HTMLTextAreaElement]
  ] = js.undefined
  /**
  ...
  var onChange_TextareaAutosizeProps: js.UndefOr[
    js.Function1[/* event */ ChangeEvent[org.scalajs.dom.raw.HTMLTextAreaElement], Unit]
  ] = js.undefined
  /**
...
object TextareaAutosizeProps {
  ...
  def apply(
    ...
    inputRef: (js.Function1[/* node */ org.scalajs.dom.raw.HTMLTextAreaElement, Unit]) | ReactRef[org.scalajs.dom.raw.HTMLTextAreaElement] = null,
    maxRows: Int | Double = null,
    minRows: Int | Double = null,
    onChange: /* event */ ChangeEvent[org.scalajs.dom.raw.HTMLTextAreaElement] => Unit = null,
