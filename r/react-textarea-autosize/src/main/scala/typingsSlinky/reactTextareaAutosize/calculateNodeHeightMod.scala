...
import typingsSlinky.reactTextareaAutosize.getSizingDataMod.SizingData
...
object calculateNodeHeightMod {
  ...
  @JSImport("react-textarea-autosize/dist/declarations/src/calculateNodeHeight", JSImport.Default)
  @js.native
