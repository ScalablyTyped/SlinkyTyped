...
import typingsSlinky.reactTextareaAutosize.anon.Height
...
import typingsSlinky.reactTextareaAutosize.reactTextareaAutosizeStrings.maxHeight
import typingsSlinky.reactTextareaAutosize.reactTextareaAutosizeStrings.menu
import typingsSlinky.reactTextareaAutosize.reactTextareaAutosizeStrings.minHeight
...
object mod extends Shortcut {
  ...
  type Style = (Omit[NonNullable[js.UndefOr[CSSProperties]], maxHeight | minHeight]) with Height
  ...
  object TextareaHeightChangeMeta {
    ...
    @scala.inline
    implicit class TextareaHeightChangeMetaMutableBuilder[Self <: TextareaHeightChangeMeta] (val x: Self) extends AnyVal {
