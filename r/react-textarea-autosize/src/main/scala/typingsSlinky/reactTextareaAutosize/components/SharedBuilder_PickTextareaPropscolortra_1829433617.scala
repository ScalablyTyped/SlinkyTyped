...
import typingsSlinky.reactTextareaAutosize.mod.Style
import typingsSlinky.reactTextareaAutosize.mod.TextareaHeightChangeMeta
...
@scala.inline
class SharedBuilder_PickTextareaPropscolortra_1829433617[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def cacheMeasurements(value: Boolean): this.type = set("cacheMeasurements", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def minRows(value: Double): this.type = set("minRows", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def onChange(value: ChangeEvent[HTMLTextAreaElement] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onHeightChange(value: (/* height */ Double, /* meta */ TextareaHeightChangeMeta) => Unit): this.type = set("onHeightChange", js.Any.fromFunction2(value))
  ...
  @scala.inline
  def onSelect(value: SyntheticEvent[Event, HTMLTextAreaElement] => Unit): this.type = set("onSelect", js.Any.fromFunction1(value))
