...
import typingsSlinky.reactTextareaAutosize.mod.TextareaAutosizeProps
import typingsSlinky.reactTextareaAutosize.mod.default
...
object ReactTextareaAutosize
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.textarea.tag.type, typingsSlinky.reactTextareaAutosize.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
