package typingsSlinky.reactTextareaAutosize.anon
...
@js.native
trait PickTextareaPropscolortra extends js.Object {
...
object PickTextareaPropscolortra {
  ...
  @scala.inline
  implicit class PickTextareaPropscolortraOps[Self <: PickTextareaPropscolortra] (val x: Self) extends AnyVal {
