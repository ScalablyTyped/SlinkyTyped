...
object anon {
  ...
  object PickTextareaPropscolortra {
    
    @scala.inline
    def apply(): PickTextareaPropscolortra = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PickTextareaPropscolortra]
    }
    
    @scala.inline
    implicit class PickTextareaPropscolortraMutableBuilder[Self <: PickTextareaPropscolortra] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCacheMeasurements(value: Boolean): Self = StObject.set(x, "cacheMeasurements", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnHeightChange(value: (/* height */ Double, /* meta */ TextareaHeightChangeMeta) => Unit): Self = StObject.set(x, "onHeightChange", js.Any.fromFunction2(value))
