...
object mod extends Shortcut {
  ...
  @js.native
  class ^ protected ()
    extends Component[ReactHammerProps, js.Object, js.Any] {
    def this(props: ReactHammerProps) = this()
    def this(props: ReactHammerProps, context: js.Any) = this()
  }
  @JSImport("react-hammerjs", JSImport.Namespace)
  @js.native
  val ^ : ComponentClass[ReactHammerProps, js.Object] = js.native
  ...
  type _To = ComponentClass[ReactHammerProps, js.Object]
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: ComponentClass[ReactHammerProps, js.Object] = ^
}
