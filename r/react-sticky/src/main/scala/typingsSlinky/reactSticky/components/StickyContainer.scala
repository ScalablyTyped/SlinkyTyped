...
object StickyContainer {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactSticky.mod.StickyContainer] {
    @scala.inline
  ...
  def withProps(p: HTMLAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: StickyContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
