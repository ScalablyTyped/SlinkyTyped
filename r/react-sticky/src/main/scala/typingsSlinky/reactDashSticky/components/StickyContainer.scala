...
object StickyContainer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashSticky.reactDashStickyMod.StickyContainer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashSticky.reactDashStickyMod.StickyContainer] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashSticky.reactDashStickyMod.StickyContainer] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashSticky.reactDashStickyMod.StickyContainer](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
