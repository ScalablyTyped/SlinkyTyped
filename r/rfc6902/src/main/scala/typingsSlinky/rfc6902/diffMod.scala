...
object diffMod {
  ...
  */
  ...
  object Operation {
    ...
    @scala.inline
    def AddOperation(op: add, path: String, value: js.Any): typingsSlinky.rfc6902.diffMod.AddOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rfc6902.diffMod.AddOperation]
    }
    
    @scala.inline
    def CopyOperation(from: String, op: copy, path: String): typingsSlinky.rfc6902.diffMod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rfc6902.diffMod.CopyOperation]
    }
    
    @scala.inline
    def MoveOperation(from: String, op: move, path: String): typingsSlinky.rfc6902.diffMod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rfc6902.diffMod.MoveOperation]
    }
    
    @scala.inline
    def RemoveOperation(op: remove, path: String): typingsSlinky.rfc6902.diffMod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rfc6902.diffMod.RemoveOperation]
    }
    
    @scala.inline
    def ReplaceOperation(op: replace, path: String, value: js.Any): typingsSlinky.rfc6902.diffMod.ReplaceOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rfc6902.diffMod.ReplaceOperation]
    }
    
    @scala.inline
    def TestOperation(op: test, path: String, value: js.Any): typingsSlinky.rfc6902.diffMod.TestOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.rfc6902.diffMod.TestOperation]
    }
  }
