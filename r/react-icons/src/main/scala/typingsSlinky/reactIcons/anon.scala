...
object anon {
  ...
  object IconBasePropsattrundefine {
    ...
    @scala.inline
    implicit class IconBasePropsattrundefineMutableBuilder[Self <: IconBasePropsattrundefine] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttr(value: js.Object): Self = StObject.set(x, "attr", value.asInstanceOf[js.Any])
