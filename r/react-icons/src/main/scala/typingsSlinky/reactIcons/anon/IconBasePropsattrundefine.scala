package typingsSlinky.reactIcons.anon
...
import typingsSlinky.reactIcons.reactIconsStrings.additions
import typingsSlinky.reactIcons.reactIconsStrings.all
import typingsSlinky.reactIcons.reactIconsStrings.alphabetic
import typingsSlinky.reactIcons.reactIconsStrings.anonymous
import typingsSlinky.reactIcons.reactIconsStrings.ascending
...
import typingsSlinky.reactIcons.reactIconsStrings.descending
import typingsSlinky.reactIcons.reactIconsStrings.dialog
import typingsSlinky.reactIcons.reactIconsStrings.evenodd
import typingsSlinky.reactIcons.reactIconsStrings.execute
import typingsSlinky.reactIcons.reactIconsStrings.grammar
import typingsSlinky.reactIcons.reactIconsStrings.grid
import typingsSlinky.reactIcons.reactIconsStrings.hanging
import typingsSlinky.reactIcons.reactIconsStrings.horizontal
import typingsSlinky.reactIcons.reactIconsStrings.ideographic
import typingsSlinky.reactIcons.reactIconsStrings.inherit
import typingsSlinky.reactIcons.reactIconsStrings.initial
import typingsSlinky.reactIcons.reactIconsStrings.isolated
import typingsSlinky.reactIcons.reactIconsStrings.linearRGB
import typingsSlinky.reactIcons.reactIconsStrings.link
import typingsSlinky.reactIcons.reactIconsStrings.list
import typingsSlinky.reactIcons.reactIconsStrings.listbox
import typingsSlinky.reactIcons.reactIconsStrings.location
import typingsSlinky.reactIcons.reactIconsStrings.mathematical
...
import typingsSlinky.reactIcons.reactIconsStrings.none
import typingsSlinky.reactIcons.reactIconsStrings.nonzero
import typingsSlinky.reactIcons.reactIconsStrings.off
import typingsSlinky.reactIcons.reactIconsStrings.other
import typingsSlinky.reactIcons.reactIconsStrings.page
import typingsSlinky.reactIcons.reactIconsStrings.polite
...
import typingsSlinky.reactIcons.reactIconsStrings.text
import typingsSlinky.reactIcons.reactIconsStrings.time
...
object IconBasePropsattrundefine {
  @scala.inline
  def apply(): IconBasePropsattrundefine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IconBasePropsattrundefine]
  }
  @scala.inline
  implicit class IconBasePropsattrundefineOps[Self <: IconBasePropsattrundefine] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAttr(value: js.Object): Self = {
        val ret = this.duplicate
