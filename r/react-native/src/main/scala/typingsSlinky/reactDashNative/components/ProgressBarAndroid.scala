...
object ProgressBarAndroid
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNative.reactDashNativeMod.ProgressBarAndroid].asInstanceOf[String | js.Object]
  def apply(
