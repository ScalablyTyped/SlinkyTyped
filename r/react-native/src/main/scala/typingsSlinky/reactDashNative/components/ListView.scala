...
import typingsSlinky.reactDashNative.reactDashNativeMod.ListViewDataSource
...
object ListView
  ...
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ListView] = {
    ...
    if (!js.isUndefined(enableEmptySections)) __obj.updateDynamic("enableEmptySections")(enableEmptySections.asInstanceOf[js.Any])
