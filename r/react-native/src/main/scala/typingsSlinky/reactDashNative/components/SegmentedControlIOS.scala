...
import typingsSlinky.reactDashNative.reactDashNativeMod.SegmentedControlIOSProps
...
object SegmentedControlIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.SegmentedControlIOS] {
  @JSImport("react-native", "SegmentedControlIOS")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: onChange, onTouchCancel, onTouchEnd, onTouchMove, onTouchStart */
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.SegmentedControlIOS] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.SegmentedControlIOS] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNative.reactDashNativeMod.SegmentedControlIOS](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = SegmentedControlIOSProps
}
