...
object SegmentedControlIOS
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNative.reactDashNativeMod.SegmentedControlIOS].asInstanceOf[String | js.Object]
  def apply(
