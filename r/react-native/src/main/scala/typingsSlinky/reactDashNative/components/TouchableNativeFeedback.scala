...
object TouchableNativeFeedback
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNative.reactDashNativeMod.TouchableNativeFeedback].asInstanceOf[String | js.Object]
