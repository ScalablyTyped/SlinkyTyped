...
import typingsSlinky.reactDashNative.reactDashNativeMod.ProgressViewIOSProps
...
import typingsSlinky.reactDashNative.reactDashNativeStrings.bar
...
object ProgressViewIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ProgressViewIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ProgressViewIOS] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ProgressViewIOS] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNative.reactDashNativeMod.ProgressViewIOS](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ProgressViewIOSProps
}
