...
import typingsSlinky.reactDashNative.reactDashNativeMod.KeyboardAvoidingViewProps
...
import typingsSlinky.reactDashNative.reactDashNativeStrings.height
...
import typingsSlinky.reactDashNative.reactDashNativeStrings.padding
import typingsSlinky.reactDashNative.reactDashNativeStrings.polite
import typingsSlinky.reactDashNative.reactDashNativeStrings.position
...
object KeyboardAvoidingView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.KeyboardAvoidingView] {
  ...
  def apply(
    ...
    behavior: height | position | padding = null,
    ...
    keyboardVerticalOffset: Int | Double = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.KeyboardAvoidingView] = {
    ...
    if (keyboardVerticalOffset != null) __obj.updateDynamic("keyboardVerticalOffset")(keyboardVerticalOffset.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.KeyboardAvoidingView] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNative.reactDashNativeMod.KeyboardAvoidingView](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
