...
object ToolbarAndroid
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNative.reactDashNativeMod.ToolbarAndroid].asInstanceOf[String | js.Object]
  def apply(
