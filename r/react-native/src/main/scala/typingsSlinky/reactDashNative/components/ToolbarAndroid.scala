...
import typingsSlinky.reactDashNative.reactDashNativeMod.ToolbarAndroidProps
...
object ToolbarAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ToolbarAndroid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ToolbarAndroid] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ToolbarAndroid] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNative.reactDashNativeMod.ToolbarAndroid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
