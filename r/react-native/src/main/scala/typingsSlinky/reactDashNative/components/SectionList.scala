...
import typingsSlinky.reactDashNative.reactDashNativeMod.SectionListProps
import typingsSlinky.reactDashNative.reactDashNativeMod.SectionListRenderItemInfo
...
object SectionList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.SectionList[js.Any]] {
  ...
  def apply[SectionT](
    ...
    SectionSeparatorComponent: ReactComponentClass[_] | ReactElement = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.SectionList[js.Any]] = {
  ...
  typingsSlinky.reactDashNative.reactDashNativeMod.SectionList[js.Any]]]
  }
