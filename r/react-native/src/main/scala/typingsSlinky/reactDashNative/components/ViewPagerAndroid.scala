...
import typingsSlinky.reactDashNative.reactDashNativeMod.ViewPagerAndroidOnPageScrollEventData
import typingsSlinky.reactDashNative.reactDashNativeMod.ViewPagerAndroidOnPageSelectedEventData
import typingsSlinky.reactDashNative.reactDashNativeMod.ViewPagerAndroidProps
...
object ViewPagerAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ViewPagerAndroid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ViewPagerAndroid] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ViewPagerAndroid] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNative.reactDashNativeMod.ViewPagerAndroid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
