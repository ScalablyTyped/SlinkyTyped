...
object TouchableOpacity
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.TouchableOpacity] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.TouchableOpacity] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.TouchableOpacity] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNative.reactDashNativeMod.TouchableOpacity](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
