...
object TouchableOpacity
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNative.reactDashNativeMod.TouchableOpacity].asInstanceOf[String | js.Object]
  def apply(
