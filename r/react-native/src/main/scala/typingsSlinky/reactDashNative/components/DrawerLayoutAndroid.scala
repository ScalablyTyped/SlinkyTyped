...
import typingsSlinky.reactDashNative.reactDashNativeMod.DrawerLayoutAndroidProps
...
object DrawerLayoutAndroid
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.DrawerLayoutAndroid] = {
