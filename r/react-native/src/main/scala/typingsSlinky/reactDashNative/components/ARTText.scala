...
import typingsSlinky.reactDashNative.reactDashNativeMod.ARTTextProps
...
object ARTText
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ARTText] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashNative.reactDashNativeMod.ARTText] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashNative.reactDashNativeMod.ARTText](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
