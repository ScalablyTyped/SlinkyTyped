...
object ActivityIndicator
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.reactDashNative.reactDashNativeMod.ActivityIndicator].asInstanceOf[String | js.Object]
  def apply(
