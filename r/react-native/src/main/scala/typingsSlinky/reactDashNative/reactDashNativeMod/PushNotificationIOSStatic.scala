...
import typingsSlinky.reactDashNative.Anon_Code
import typingsSlinky.reactDashNative.reactDashNativeStrings.localNotification
import typingsSlinky.reactDashNative.reactDashNativeStrings.notification
import typingsSlinky.reactDashNative.reactDashNativeStrings.register
import typingsSlinky.reactDashNative.reactDashNativeStrings.registrationError
...
trait PushNotificationIOSStatic extends js.Object {
  /**
    ...
    */
  var FetchResult: typingsSlinky.reactDashNative.reactDashNativeMod.FetchResult = js.native
  /**
