...
import typingsSlinky.reactDashNative.Anon_Screen
import typingsSlinky.reactDashNative.reactDashNativeStrings.change
import typingsSlinky.reactDashNative.reactDashNativeStrings.screen
...
trait Dimensions extends js.Object {
  ...
  def addEventListener_change(`type`: change, handler: js.Function1[/* hasWindowScreen */ Anon_Screen, Unit]): Unit = js.native
  @JSName("get")
  ...
  def removeEventListener_change(`type`: change, handler: js.Function1[/* hasWindowScreen */ Anon_Screen, Unit]): Unit = js.native
  /**
