...
import typingsSlinky.reactDashNative.Anon_Commands
import typingsSlinky.reactDashNative.Anon_Format
import typingsSlinky.reactDashNative.reactDashNativeStrings.window
...
trait UIManagerStatic extends js.Object {
  ...
  def takeSnapshot(view: Double, options: Anon_Format): js.Promise[String] = js.native
  def takeSnapshot(view: ReactElement): js.Promise[String] = js.native
  def takeSnapshot(view: ReactElement, options: Anon_Format): js.Promise[String] = js.native
  @JSName("takeSnapshot")
  def takeSnapshot_window(view: window): js.Promise[String] = js.native
  @JSName("takeSnapshot")
  def takeSnapshot_window(view: window, options: Anon_Format): js.Promise[String] = js.native
}
