...
import typingsSlinky.reactDashNative.Anon_NativeEvent
...
import typingsSlinky.reactDashNative.reactDashNativeStrings.large_
...
import typingsSlinky.reactDashNative.reactDashNativeStrings.small_
...
trait ActivityIndicatorIOSProps extends ViewProps {
  ...
  /**
    ...
    */
  @JSName("onLayout")
  var onLayout_ActivityIndicatorIOSProps: js.UndefOr[js.Function1[/* event */ Anon_NativeEvent, Unit]] = js.undefined
  /**
...
object ActivityIndicatorIOSProps {
  ...
  def apply(
    ...
    onLayout: /* event */ Anon_NativeEvent => Unit = null,
