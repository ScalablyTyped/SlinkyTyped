...
trait SectionListProps[ItemT] extends VirtualizedListWithoutRenderItemProps[ItemT] {
  ...
  /**
    ...
    */
  var SectionSeparatorComponent: js.UndefOr[ReactComponentClass[_] | ReactElement | Null] = js.undefined
  /**
  ...
  var getItemLayout_SectionListProps: js.UndefOr[
    js.Function2[/* data */ js.Array[SectionListData[ItemT]] | Null, /* index */ Double, Anon_Index]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var renderSectionFooter: js.UndefOr[js.Function1[/* info */ Anon_Section[ItemT], ReactElement | Null]] = js.undefined
  /**
    * Rendered at the top of each section. Sticky headers are not yet supported.
    */
  var renderSectionHeader: js.UndefOr[js.Function1[/* info */ Anon_Section[ItemT], ReactElement | Null]] = js.undefined
  /**
...
object SectionListProps {
  ...
  def apply[ItemT](
    ...
    getItemLayout: (/* data */ js.Array[SectionListData[ItemT]] | Null, /* index */ Double) => Anon_Index = null,
