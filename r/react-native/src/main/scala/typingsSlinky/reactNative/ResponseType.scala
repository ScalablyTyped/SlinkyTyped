...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNative.reactNativeStrings.basic
  - typingsSlinky.reactNative.reactNativeStrings.cors
  - typingsSlinky.reactNative.reactNativeStrings.default
  - typingsSlinky.reactNative.reactNativeStrings.error
  - typingsSlinky.reactNative.reactNativeStrings.opaque
  - typingsSlinky.reactNative.reactNativeStrings.opaqueredirect
*/
