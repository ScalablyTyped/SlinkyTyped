...
object NativeMethods {
  ...
  implicit class NativeMethodsOps[Self <: NativeMethods] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMeasure(value: MeasureOnSuccessCallback => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("measure")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMeasureInWindow(value: MeasureInWindowOnSuccessCallback => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("measureInWindow")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMeasureLayout(value: (Double, MeasureLayoutOnSuccessCallback, js.Function0[Unit]) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetNativeProps(value: js.Object => Unit): Self = {
        val ret = this.duplicate
