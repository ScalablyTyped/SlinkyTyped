...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNative.reactNativeStrings.easeIn
  - typingsSlinky.reactNative.reactNativeStrings.easeInEaseOut
  - typingsSlinky.reactNative.reactNativeStrings.easeOut
  - typingsSlinky.reactNative.reactNativeStrings.linear
  - typingsSlinky.reactNative.reactNativeStrings.keyboard
*/
