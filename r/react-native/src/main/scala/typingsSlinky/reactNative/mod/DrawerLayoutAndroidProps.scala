...
object DrawerLayoutAndroidProps {
  ...
  implicit class DrawerLayoutAndroidPropsMutableBuilder[Self <: DrawerLayoutAndroidProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDrawerSlide(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = StObject.set(x, "onDrawerSlide", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderNavigationView(value: () => ReactElement): Self = StObject.set(x, "renderNavigationView", js.Any.fromFunction0(value))
