...
object PanResponderCallbacks {
  ...
  implicit class PanResponderCallbacksMutableBuilder[Self <: PanResponderCallbacks] (val x: Self) extends AnyVal {
    ...
    ): Self = StObject.set(x, "onPanResponderEnd", js.Any.fromFunction2(value))
    ...
    def setOnPanResponderGrant(
      value: (SyntheticEvent[NodeHandle, NativeTouchEvent], /* gestureState */ PanResponderGestureState) => Unit
    ): Self = StObject.set(x, "onPanResponderGrant", js.Any.fromFunction2(value))
    ...
    def setOnPanResponderMove(
      value: (SyntheticEvent[NodeHandle, NativeTouchEvent], /* gestureState */ PanResponderGestureState) => Unit
    ): Self = StObject.set(x, "onPanResponderMove", js.Any.fromFunction2(value))
    ...
    def setOnPanResponderReject(
      value: (SyntheticEvent[NodeHandle, NativeTouchEvent], /* gestureState */ PanResponderGestureState) => Unit
    ): Self = StObject.set(x, "onPanResponderReject", js.Any.fromFunction2(value))
    ...
    def setOnPanResponderRelease(
      value: (SyntheticEvent[NodeHandle, NativeTouchEvent], /* gestureState */ PanResponderGestureState) => Unit
    ): Self = StObject.set(x, "onPanResponderRelease", js.Any.fromFunction2(value))
    ...
    def setOnPanResponderStart(
      value: (SyntheticEvent[NodeHandle, NativeTouchEvent], /* gestureState */ PanResponderGestureState) => Unit
    ): Self = StObject.set(x, "onPanResponderStart", js.Any.fromFunction2(value))
    ...
    def setOnPanResponderTerminate(
      value: (SyntheticEvent[NodeHandle, NativeTouchEvent], /* gestureState */ PanResponderGestureState) => Unit
    ): Self = StObject.set(x, "onPanResponderTerminate", js.Any.fromFunction2(value))
