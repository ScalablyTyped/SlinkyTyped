...
import typingsSlinky.reactNative.reactNativeStrings.UIBackgroundFetchResultFailed
import typingsSlinky.reactNative.reactNativeStrings.UIBackgroundFetchResultNewData
import typingsSlinky.reactNative.reactNativeStrings.UIBackgroundFetchResultNoData
