...
object ViewPagerAndroidProps {
  ...
  implicit class ViewPagerAndroidPropsMutableBuilder[Self <: ViewPagerAndroidProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnPageScroll(value: SyntheticEvent[NodeHandle, ViewPagerAndroidOnPageScrollEventData] => Unit): Self = StObject.set(x, "onPageScroll", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnPageSelected(value: SyntheticEvent[NodeHandle, ViewPagerAndroidOnPageSelectedEventData] => Unit): Self = StObject.set(x, "onPageSelected", js.Any.fromFunction1(value))
