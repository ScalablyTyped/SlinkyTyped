...
object ViewPagerAndroidProps {
  ...
  implicit class ViewPagerAndroidPropsOps[Self <: ViewPagerAndroidProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnPageScroll(value: SyntheticEvent[NodeHandle, ViewPagerAndroidOnPageScrollEventData] => Unit): Self = this.set("onPageScroll", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnPageSelected(value: SyntheticEvent[NodeHandle, ViewPagerAndroidOnPageSelectedEventData] => Unit): Self = this.set("onPageSelected", js.Any.fromFunction1(value))
    @scala.inline
