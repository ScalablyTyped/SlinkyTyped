...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.reactNative.reactNativeStrings.boldTextChanged
  - typingsSlinky.reactNative.reactNativeStrings.grayscaleChanged
  - typingsSlinky.reactNative.reactNativeStrings.invertColorsChanged
  - typingsSlinky.reactNative.reactNativeStrings.reduceMotionChanged
