...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNative.reactNativeStrings.activate
  - typingsSlinky.reactNative.reactNativeStrings.increment
  - typingsSlinky.reactNative.reactNativeStrings.decrement
  - typingsSlinky.reactNative.reactNativeStrings.longpress
  - typingsSlinky.reactNative.reactNativeStrings.magicTap
  - typingsSlinky.reactNative.reactNativeStrings.escape
*/
