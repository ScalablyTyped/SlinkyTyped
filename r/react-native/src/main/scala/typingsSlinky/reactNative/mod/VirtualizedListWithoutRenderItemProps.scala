...
trait VirtualizedListWithoutRenderItemProps[ItemT] extends ScrollViewProps {
  var CellRendererComponent: js.UndefOr[ReactComponentClass[_]] = js.undefined
  /**
...
object VirtualizedListWithoutRenderItemProps {
  @scala.inline
  def apply[ItemT](
    CellRendererComponent: ReactComponentClass[_] = null,
    ListEmptyComponent: js.UndefOr[Null | ReactComponentClass[_] | ReactElement] = js.undefined,
    ListFooterComponent: js.UndefOr[Null | ReactComponentClass[_] | ReactElement] = js.undefined,
    ListHeaderComponent: js.UndefOr[Null | ReactComponentClass[_] | ReactElement] = js.undefined,
