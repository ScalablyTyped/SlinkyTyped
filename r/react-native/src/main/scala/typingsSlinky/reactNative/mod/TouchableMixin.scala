...
object TouchableMixin {
  ...
  implicit class TouchableMixinMutableBuilder[Self <: TouchableMixin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTouchableHandleActivePressIn(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = StObject.set(x, "touchableHandleActivePressIn", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTouchableHandleActivePressOut(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = StObject.set(x, "touchableHandleActivePressOut", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTouchableHandleLongPress(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = StObject.set(x, "touchableHandleLongPress", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTouchableHandlePress(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = StObject.set(x, "touchableHandlePress", js.Any.fromFunction1(value))
  }
}
