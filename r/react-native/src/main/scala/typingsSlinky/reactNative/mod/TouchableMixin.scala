...
trait TouchableMixin extends js.Object {
  ...
  /**
    ...
    */
  def touchableHandleActivePressIn(e: SyntheticEvent[NodeHandle, NativeTouchEvent]): Unit
  /**
    ...
    */
  def touchableHandleActivePressOut(e: SyntheticEvent[NodeHandle, NativeTouchEvent]): Unit
  /**
    ...
    */
  def touchableHandleLongPress(e: SyntheticEvent[NodeHandle, NativeTouchEvent]): Unit
  /**
    * Invoked when the item is "selected" - meaning the interaction ended by
    * letting up while the item was either in the state
    * `RESPONDER_ACTIVE_PRESS_IN` or `RESPONDER_INACTIVE_PRESS_IN`.
    */
  def touchableHandlePress(e: SyntheticEvent[NodeHandle, NativeTouchEvent]): Unit
}
