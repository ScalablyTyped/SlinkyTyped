...
trait ARTStatic extends js.Object {
  var ClippingRectangle: Instantiable0[typingsSlinky.reactNative.mod.ClippingRectangle]
  var Group: Instantiable0[typingsSlinky.reactNative.mod.Group]
  var Shape: Instantiable0[typingsSlinky.reactNative.mod.Shape]
  var Surface: Instantiable0[typingsSlinky.reactNative.mod.Surface]
