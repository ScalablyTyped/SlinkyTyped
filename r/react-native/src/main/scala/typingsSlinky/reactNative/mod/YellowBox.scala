...
object YellowBox {
  ...
  @scala.inline
  def defaultProps_=(x: js.UndefOr[Partial[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def getDerivedStateFromError_=(x: js.UndefOr[GetDerivedStateFromError[js.Any, js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getDerivedStateFromError")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def propTypes_=(x: js.UndefOr[WeakValidationMap[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("propTypes")(x.asInstanceOf[js.Any])
}
