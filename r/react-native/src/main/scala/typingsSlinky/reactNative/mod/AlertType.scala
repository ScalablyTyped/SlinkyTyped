...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.reactNative.reactNativeStrings.`plain-text`
  - typingsSlinky.reactNative.reactNativeStrings.`secure-text`
  - typingsSlinky.reactNative.reactNativeStrings.`login-password`
*/
