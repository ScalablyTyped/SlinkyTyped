...
trait PressableProps extends StObject {
  ...
  /**
    ...
    */
  var onLongPress: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.native
  ...
  /**
    ...
    */
  var onPress: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.native
  
  /**
    * Called when a touch is engaged before `onPress`.
    */
  var onPressIn: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.native
  
  /**
    * Called when a touch is released before `onPress`.
    */
  var onPressOut: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.native
...
object PressableProps {
  ...
  implicit class PressablePropsMutableBuilder[Self <: PressableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: ReactElement | (js.Function1[/* state */ PressableStateCallbackType, ReactElement])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setChildrenFunction1(value: /* state */ PressableStateCallbackType => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
