...
trait PressableProps extends js.Object {
  ...
  /**
    ...
    */
  var children: ReactElement | (js.Function1[/* state */ PressableStateCallbackType, ReactElement])
  ...
  /**
    ...
    */
  var onLongPress: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onPress: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.undefined
  /**
    * Called when a touch is engaged before `onPress`.
    */
  var onPressIn: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.undefined
  /**
    * Called when a touch is released before `onPress`.
    */
  var onPressOut: js.UndefOr[Null | (js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit])] = js.undefined
...
object PressableProps {
  ...
  implicit class PressablePropsOps[Self <: PressableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenFunction1(value: /* state */ PressableStateCallbackType => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
    def setChildren(value: ReactElement | (js.Function1[/* state */ PressableStateCallbackType, ReactElement])): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
