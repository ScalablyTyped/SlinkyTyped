...
import typingsSlinky.reactNative.mod.TouchableNativeFeedbackProps
...
object TouchableNativeFeedback
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.TouchableNativeFeedback] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableNativeFeedback] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableNativeFeedback] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNative.mod.TouchableNativeFeedback](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
