...
object Image
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.Image] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.Image] = {
