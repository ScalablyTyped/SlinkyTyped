...
object TabBarIOSItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.TabBarIOSItem] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TabBarIOSItem] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TabBarIOSItem] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.TabBarIOSItem](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
