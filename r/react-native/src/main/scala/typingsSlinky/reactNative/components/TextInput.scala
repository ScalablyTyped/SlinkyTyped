...
object TextInput
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.TextInput] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TextInput] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TextInput] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.TextInput](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
