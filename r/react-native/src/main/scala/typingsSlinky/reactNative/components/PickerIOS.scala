...
import typingsSlinky.reactNative.mod.PickerIOSProps
...
object PickerIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.PickerIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.PickerIOS] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.PickerIOS] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.PickerIOS](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
