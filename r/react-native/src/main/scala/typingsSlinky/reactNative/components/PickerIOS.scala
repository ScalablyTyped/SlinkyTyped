...
object PickerIOS {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.PickerIOS] {
    @scala.inline
    ...
    @scala.inline
    def onValueChange(value: /* value */ String | Double => Unit): this.type = set("onValueChange", js.Any.fromFunction1(value))
    @scala.inline
