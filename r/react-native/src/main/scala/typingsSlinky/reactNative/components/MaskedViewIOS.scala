...
import typingsSlinky.reactNative.mod.MaskedViewIOSProps
...
object MaskedViewIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.MaskedViewIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.MaskedViewIOS] = {
