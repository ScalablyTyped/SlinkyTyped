...
import typingsSlinky.reactNative.mod.ViewPagerAndroidProps
...
object ViewPagerAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.ViewPagerAndroid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ViewPagerAndroid] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ViewPagerAndroid] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.ViewPagerAndroid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
