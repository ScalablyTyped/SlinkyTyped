...
object ScrollView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.ScrollView] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ScrollView] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ScrollView] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.ScrollView](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
