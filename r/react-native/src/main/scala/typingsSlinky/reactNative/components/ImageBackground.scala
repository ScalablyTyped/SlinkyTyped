...
object ImageBackground {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.ImageBackground] {
    @scala.inline
    ...
    @scala.inline
    def imageRef(value: /* image */ typingsSlinky.reactNative.mod.Image => Unit): this.type = set("imageRef", js.Any.fromFunction1(value))
    @scala.inline
