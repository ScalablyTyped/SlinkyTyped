...
import typingsSlinky.reactNative.mod.ImageBackgroundProps
...
object ImageBackground
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.ImageBackground] {
  ...
  def apply(
    ...
    imageRef: /* image */ typingsSlinky.reactNative.mod.Image => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ImageBackground] = {
