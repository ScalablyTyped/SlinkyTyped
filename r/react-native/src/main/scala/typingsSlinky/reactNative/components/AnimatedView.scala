...
object AnimatedView {
  ...
  def apply(p: ComponentProps[TypeofView] | AnimatedProps[ComponentPropsWithRef[TypeofView]]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
