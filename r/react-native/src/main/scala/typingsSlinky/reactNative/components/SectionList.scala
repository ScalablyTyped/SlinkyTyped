...
object SectionList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.SectionList[js.Any]] {
  ...
  def apply[SectionT](
    ...
    getItemLayout: (/* data */ js.Array[SectionListData[SectionT]] | Null, /* index */ Double) => AnonIndex = null,
    ...
    renderSectionFooter: /* info */ AnonSection[SectionT] => ReactElement | Null = null,
    renderSectionHeader: /* info */ AnonSection[SectionT] => ReactElement | Null = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.SectionList[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.SectionList[js.Any]]]
  }
