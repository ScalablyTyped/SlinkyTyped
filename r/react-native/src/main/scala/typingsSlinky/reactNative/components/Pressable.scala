...
import typingsSlinky.reactNative.mod.PressableAndroidRippleConfig
import typingsSlinky.reactNative.mod.PressableProps
import typingsSlinky.reactNative.mod.PressableStateCallbackType
...
object Pressable {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def android_disableSound(value: Boolean): this.type = set("android_disableSound", value.asInstanceOf[js.Any])
    
    @scala.inline
    def android_disableSoundNull: this.type = set("android_disableSound", null)
    
    @scala.inline
    def android_ripple(value: PressableAndroidRippleConfig): this.type = set("android_ripple", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def delayLongPressNull: this.type = set("delayLongPress", null)
    ...
    @scala.inline
    def hitSlop(value: Insets | Double): this.type = set("hitSlop", value.asInstanceOf[js.Any])
    
    @scala.inline
    def hitSlopNull: this.type = set("hitSlop", null)
    ...
    @scala.inline
    def onLongPressNull: this.type = set("onLongPress", null)
    ...
    @scala.inline
    def onPressOutNull: this.type = set("onPressOut", null)
    ...
    @scala.inline
    def pressRetentionOffset(value: Insets | Double): this.type = set("pressRetentionOffset", value.asInstanceOf[js.Any])
    
    @scala.inline
    def pressRetentionOffsetNull: this.type = set("pressRetentionOffset", null)
    ...
    @scala.inline
    def testOnly_pressed(value: Boolean): this.type = set("testOnly_pressed", value.asInstanceOf[js.Any])
    
    @scala.inline
    def testOnly_pressedNull: this.type = set("testOnly_pressed", null)
  ...
  def withProps(p: PressableProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
