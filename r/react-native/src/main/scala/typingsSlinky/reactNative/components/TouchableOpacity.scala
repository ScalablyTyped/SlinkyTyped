...
object TouchableOpacity
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.TouchableOpacity] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableOpacity] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableOpacity] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.TouchableOpacity](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
