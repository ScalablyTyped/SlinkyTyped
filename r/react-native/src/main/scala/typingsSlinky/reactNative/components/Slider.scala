...
import typingsSlinky.reactNative.mod.SliderProps
...
object Slider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.Slider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.Slider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.Slider] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.Slider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
