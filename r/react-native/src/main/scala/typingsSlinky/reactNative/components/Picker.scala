...
object Picker
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.Picker] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.Picker] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.Picker] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.Picker](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
