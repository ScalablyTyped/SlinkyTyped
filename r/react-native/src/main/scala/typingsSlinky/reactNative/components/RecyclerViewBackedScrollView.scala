...
import typingsSlinky.reactNative.mod.RecyclerViewBackedScrollViewProps
...
object RecyclerViewBackedScrollView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.RecyclerViewBackedScrollView] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.RecyclerViewBackedScrollView] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.RecyclerViewBackedScrollView] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNative.mod.RecyclerViewBackedScrollView](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
