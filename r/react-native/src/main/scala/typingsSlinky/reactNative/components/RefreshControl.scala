...
import typingsSlinky.reactNative.mod.RefreshControlProps
...
object RefreshControl {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.RefreshControl] {
    @scala.inline
  ...
  def withProps(p: RefreshControlProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(refreshing: Boolean): Builder = {
    val __props = js.Dynamic.literal(refreshing = refreshing.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RefreshControlProps]))
  }
}
