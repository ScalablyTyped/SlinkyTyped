...
object RefreshControl
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.RefreshControl] {
  @JSImport("react-native", "RefreshControl")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: size, title */
  def apply(
    refreshing: Boolean,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.RefreshControl] = {
