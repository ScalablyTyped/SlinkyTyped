...
object SnapshotViewIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.SnapshotViewIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.SnapshotViewIOS] = {
  ...
  type Props = SnapshotViewIOSProps
}
