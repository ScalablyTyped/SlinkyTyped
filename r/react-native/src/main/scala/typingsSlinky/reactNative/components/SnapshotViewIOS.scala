...
import typingsSlinky.reactNative.mod.SnapshotViewIOSProps
...
object SnapshotViewIOS {
  @JSImport("react-native", "SnapshotViewIOS")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.SnapshotViewIOS] {
    @scala.inline
  ...
  def withProps(p: SnapshotViewIOSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(onSnapshotReady: () => js.Any, testIdentifier: String): Builder = {
    val __props = js.Dynamic.literal(onSnapshotReady = js.Any.fromFunction0(onSnapshotReady), testIdentifier = testIdentifier.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SnapshotViewIOSProps]))
  }
}
