...
object TabBarIOS {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.TabBarIOS] {
    ...
    @scala.inline
    def itemPositioning(value: fill | center | auto): this.type = set("itemPositioning", value.asInstanceOf[js.Any])
