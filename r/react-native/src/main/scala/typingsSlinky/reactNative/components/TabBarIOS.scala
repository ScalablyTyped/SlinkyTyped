...
import typingsSlinky.reactNative.mod.TabBarIOSProps
...
object TabBarIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.TabBarIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TabBarIOS] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TabBarIOS] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.TabBarIOS](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
