...
object DatePickerIOS {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.DatePickerIOS] {
    @scala.inline
    ...
    @scala.inline
    def minuteInterval(value: `1` | `2` | `3` | `4` | `5` | `6` | `10` | `12` | `15` | `20` | `30`): this.type = set("minuteInterval", value.asInstanceOf[js.Any])
    @scala.inline
    def mode(value: date | time | datetime): this.type = set("mode", value.asInstanceOf[js.Any])
    @scala.inline
