...
object DatePickerIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.DatePickerIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.DatePickerIOS] = {
