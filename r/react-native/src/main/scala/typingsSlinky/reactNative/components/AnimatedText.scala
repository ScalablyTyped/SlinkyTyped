...
typingsSlinky.std.InstanceType[org.scalablytyped.runtime.Instantiable0[typingsSlinky.reactNative.mod.Text]]]) because: IArray(Could't extract props from js.Any because couldn't resolve ClassTree., Couldn't find props for / * import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in K ]: T[P]}
...
object AnimatedText {
  ...
  def apply(p: AnimatedProps[ComponentPropsWithRef[Instantiable0[typingsSlinky.reactNative.mod.Text]]]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
