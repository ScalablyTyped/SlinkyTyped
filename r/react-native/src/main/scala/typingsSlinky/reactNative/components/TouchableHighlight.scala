...
object TouchableHighlight
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.TouchableHighlight] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableHighlight] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableHighlight] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.TouchableHighlight](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
