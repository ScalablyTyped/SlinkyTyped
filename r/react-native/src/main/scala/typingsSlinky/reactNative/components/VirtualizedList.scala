...
object VirtualizedList {
  ...
  class Builder[ItemT] (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.VirtualizedList[js.Any]] {
    @scala.inline
    ...
    @scala.inline
    def getItemLayout(value: (/* data */ js.Any, /* index */ Double) => Index): this.type = set("getItemLayout", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps[ItemT](p: VirtualizedListProps[ItemT]): Builder[ItemT] = new Builder[ItemT](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[ItemT](): Builder[ItemT] = {
    val __props = js.Dynamic.literal()
    new Builder[ItemT](js.Array(this.component, __props.asInstanceOf[VirtualizedListProps[ItemT]]))
  }
  implicit def make[ItemT](companion: VirtualizedList.type): Builder[ItemT] = new Builder[ItemT](js.Array(this.component, js.Dictionary.empty))()
}
