...
object SegmentedControlIOS {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.SegmentedControlIOS] {
    @scala.inline
  ...
  def withProps(p: SegmentedControlIOSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: SegmentedControlIOS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
