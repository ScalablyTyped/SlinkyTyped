...
import typingsSlinky.reactNative.mod.SegmentedControlIOSProps
...
object SegmentedControlIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.SegmentedControlIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.SegmentedControlIOS] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.SegmentedControlIOS] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.SegmentedControlIOS](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
