...
import typingsSlinky.reactNative.mod.ToolbarAndroidAction
import typingsSlinky.reactNative.mod.ToolbarAndroidProps
...
object ToolbarAndroid {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def logo(value: ImageURISource): this.type = set("logo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def nativeID(value: String): this.type = set("nativeID", value.asInstanceOf[js.Any])
    
    @scala.inline
    def navIcon(value: ImageURISource): this.type = set("navIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onActionSelected(value: /* position */ Double => Unit): this.type = set("onActionSelected", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def overflowIcon(value: ImageURISource): this.type = set("overflowIcon", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ToolbarAndroid.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToolbarAndroidProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
