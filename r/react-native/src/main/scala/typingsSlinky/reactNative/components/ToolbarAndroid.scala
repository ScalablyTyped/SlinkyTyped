...
object ToolbarAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.ToolbarAndroid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ToolbarAndroid] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ToolbarAndroid] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.ToolbarAndroid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
