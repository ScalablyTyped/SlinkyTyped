...
import typingsSlinky.reactNative.mod.SwitchProps
...
object Switch
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.Switch] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.Switch] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.Switch] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.Switch](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
