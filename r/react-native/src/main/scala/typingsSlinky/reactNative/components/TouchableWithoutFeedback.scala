...
object TouchableWithoutFeedback
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.TouchableWithoutFeedback] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableWithoutFeedback] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableWithoutFeedback] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactNative.mod.TouchableWithoutFeedback](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
