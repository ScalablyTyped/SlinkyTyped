...
object TouchableWithoutFeedback {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.TouchableWithoutFeedback] {
    @scala.inline
  ...
  def withProps(p: TouchableWithoutFeedbackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TouchableWithoutFeedback.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
