...
import typingsSlinky.reactNative.mod.ProgressViewIOSProps
...
object ProgressViewIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.ProgressViewIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ProgressViewIOS] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ProgressViewIOS] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.ProgressViewIOS](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
