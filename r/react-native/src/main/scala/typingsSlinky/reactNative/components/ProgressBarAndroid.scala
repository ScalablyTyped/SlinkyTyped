...
import typingsSlinky.reactNative.mod.ProgressBarAndroidProps
...
object ProgressBarAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.ProgressBarAndroid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ProgressBarAndroid] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ProgressBarAndroid] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.ProgressBarAndroid](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
