...
object AnimatedFlatList {
  ...
  def apply(p: AnimatedProps[ComponentProps[typingsSlinky.reactNative.mod.FlatList[js.Any]]]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
