...
object NavigatorIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.NavigatorIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.NavigatorIOS] = {
