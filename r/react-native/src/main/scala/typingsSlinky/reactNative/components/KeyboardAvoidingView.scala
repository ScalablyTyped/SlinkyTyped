...
import typingsSlinky.reactNative.mod.KeyboardAvoidingViewProps
...
object KeyboardAvoidingView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.KeyboardAvoidingView] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.KeyboardAvoidingView] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.KeyboardAvoidingView] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.KeyboardAvoidingView](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
