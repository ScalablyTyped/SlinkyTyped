...
object KeyboardAvoidingView {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.KeyboardAvoidingView] {
    ...
    @scala.inline
    def behavior(value: height | position | padding): this.type = set("behavior", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def keyboardVerticalOffset(value: Double): this.type = set("keyboardVerticalOffset", value.asInstanceOf[js.Any])
