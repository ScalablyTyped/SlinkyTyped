...
import typingsSlinky.reactNative.mod.SwitchIOSProps
...
object SwitchIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.SwitchIOS] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.SwitchIOS] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.SwitchIOS] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.SwitchIOS](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
