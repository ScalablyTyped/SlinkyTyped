...
object ListView {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def enableEmptySections(value: Boolean): this.type = set("enableEmptySections", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChangeVisibleRows(
      value: (/* visibleRows */ js.Array[StringDictionary[StringDictionary[Boolean]]], /* changedRows */ js.Array[StringDictionary[StringDictionary[Boolean]]]) => Unit
    ): this.type = set("onChangeVisibleRows", js.Any.fromFunction2(value))
    @scala.inline
    def onContentSizeChange(value: (/* w */ Double, /* h */ Double) => Unit): this.type = set("onContentSizeChange", js.Any.fromFunction2(value))
    @scala.inline
    def onEndReached(value: () => Unit): this.type = set("onEndReached", js.Any.fromFunction0(value))
    @scala.inline
