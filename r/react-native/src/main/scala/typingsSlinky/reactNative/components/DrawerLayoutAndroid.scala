...
object DrawerLayoutAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.DrawerLayoutAndroid] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.DrawerLayoutAndroid] = {
