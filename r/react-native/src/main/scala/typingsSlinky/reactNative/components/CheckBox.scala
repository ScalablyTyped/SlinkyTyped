...
import typingsSlinky.reactNative.mod.CheckBoxProps
...
object CheckBox
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.CheckBox] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.CheckBox] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.CheckBox] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.CheckBox](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
