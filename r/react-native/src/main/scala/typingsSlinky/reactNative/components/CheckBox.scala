...
object CheckBox {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.CheckBox] {
    @scala.inline
    ...
    @scala.inline
    def onChange(value: /* value */ Boolean => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
