...
object ActivityIndicator {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNative.mod.ActivityIndicator] {
    @scala.inline
    ...
    @scala.inline
    def size(value: Double | small_ | large_): this.type = set("size", value.asInstanceOf[js.Any])
    @scala.inline
