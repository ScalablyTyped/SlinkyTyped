...
object ActivityIndicator
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNative.mod.ActivityIndicator] {
  ...
  def apply(
    ...
    size: Double | small_ | large_ = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ActivityIndicator] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactNative.mod.ActivityIndicator] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactNative.mod.ActivityIndicator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
