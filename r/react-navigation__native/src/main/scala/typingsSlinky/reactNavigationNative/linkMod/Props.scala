package typingsSlinky.reactNavigationNative.linkMod
...
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.`no-hide-descendants`
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.all
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.assertive
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.auto
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.balanced
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.button
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.clip
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.email
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.head
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.highQuality
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.link
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.middle
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.no
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.none
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.phoneNumber
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.polite
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.radiobutton_checked
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.radiobutton_unchecked
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.simple
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.tail
import typingsSlinky.reactNavigationNative.reactNavigationNativeStrings.yes
...
trait Props extends js.Object {
  ...
  var onPress: (js.UndefOr[
    js.Function1[
      /* e */ SyntheticMouseEvent[HTMLAnchorElement] | (SyntheticEvent[NodeHandle, NativeTouchEvent]), 
      Unit
    ]
  ]) with (js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit]]) = js.native
...
object Props {
  ...
  def apply(
    ...
    ]) with (js.UndefOr[js.Function1[SyntheticEvent[NodeHandle, NativeTouchEvent], Unit]]),
    to: String
  ): Props = {
