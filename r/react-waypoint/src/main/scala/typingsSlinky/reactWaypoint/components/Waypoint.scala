...
object Waypoint
  extends ExternalComponentWithAttributesWithRefType[tag.type, Waypoint_] {
  ...
  ): BuildingComponent[tag.type, Waypoint_] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Waypoint_] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactWaypoint.mod.Waypoint_](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
