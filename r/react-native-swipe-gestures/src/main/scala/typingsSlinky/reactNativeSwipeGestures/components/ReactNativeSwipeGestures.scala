package typingsSlinky.reactNativeSwipeGestures.components
...
import typingsSlinky.reactNativeSwipeGestures.mod.GestureRecognizerConfig
import typingsSlinky.reactNativeSwipeGestures.mod.GestureRecognizerProps
import typingsSlinky.reactNativeSwipeGestures.mod.default
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ReactNativeSwipeGestures {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def config(value: GestureRecognizerConfig): this.type = set("config", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onSwipe(value: (/* gestureName */ String, /* gestureState */ PanResponderGestureState) => Unit): this.type = set("onSwipe", js.Any.fromFunction2(value))
    @scala.inline
    def onSwipeDown(value: /* gestureState */ PanResponderGestureState => Unit): this.type = set("onSwipeDown", js.Any.fromFunction1(value))
    @scala.inline
    def onSwipeLeft(value: /* gestureState */ PanResponderGestureState => Unit): this.type = set("onSwipeLeft", js.Any.fromFunction1(value))
    @scala.inline
    def onSwipeRight(value: /* gestureState */ PanResponderGestureState => Unit): this.type = set("onSwipeRight", js.Any.fromFunction1(value))
    @scala.inline
    def onSwipeUp(value: /* gestureState */ PanResponderGestureState => Unit): this.type = set("onSwipeUp", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: GestureRecognizerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ReactNativeSwipeGestures.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
