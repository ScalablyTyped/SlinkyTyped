...
object ReactDashResizeDashDetector
  ...
  typingsSlinky.reactDashResizeDashDetector.reactDashResizeDashDetectorMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
