...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.reactToastify.reactToastifyStrings.DARK
*/
trait KeyOfType extends js.Object
object KeyOfType {
  
  @scala.inline
  def DARK: typingsSlinky.reactToastify.reactToastifyStrings.DARK = "DARK".asInstanceOf[typingsSlinky.reactToastify.reactToastifyStrings.DARK]
