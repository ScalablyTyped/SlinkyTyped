...
object propValidatorMod {
  ...
  @JSImport("react-toastify/dist/utils/propValidator", "canBeRendered")
  @js.native
  ...
  @JSImport("react-toastify/dist/utils/propValidator", "getAutoCloseDelay")
  @js.native
  ...
  @JSImport("react-toastify/dist/utils/propValidator", "hasToastId")
  @js.native
  ...
  @JSImport("react-toastify/dist/utils/propValidator", "isBool")
  @js.native
  def isBool(v: js.Any): /* is std.Boolean */ Boolean = js.native
  
  @JSImport("react-toastify/dist/utils/propValidator", "isFn")
  @js.native
  def isFn(v: js.Any): /* is std.Function */ Boolean = js.native
  
  @JSImport("react-toastify/dist/utils/propValidator", "isNum")
  @js.native
  def isNum(v: js.Any): /* is std.Number */ Boolean = js.native
  
  @JSImport("react-toastify/dist/utils/propValidator", "isStr")
  @js.native
  def isStr(v: js.Any): /* is std.String */ Boolean = js.native
  
  @JSImport("react-toastify/dist/utils/propValidator", "objectValues")
  @js.native
  def objectValues[T](obj: Record[String, T]): js.Array[T] = js.native
  
  @JSImport("react-toastify/dist/utils/propValidator", "parseClassName")
  @js.native
