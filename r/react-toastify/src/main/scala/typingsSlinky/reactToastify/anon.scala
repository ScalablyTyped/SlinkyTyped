...
import typingsSlinky.reactToastify.toastContainerReducerMod.Action
...
object anon {
  ...
  object EventHandlers {
    ...
    implicit class EventHandlersMutableBuilder[Self <: EventHandlers] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setToastRef(value: ReactRef[HTMLDivElement]): Self = StObject.set(x, "toastRef", value.asInstanceOf[js.Any])
    }
  }
