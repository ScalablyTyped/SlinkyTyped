...
object NotValidatedToastProps {
  ...
  implicit class NotValidatedToastPropsOps[Self <: NotValidatedToastProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenFunction1(value: /* props */ ToastContentProps => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTransitionFunctionComponent(value: ReactComponentClass[ToastTransitionProps]): Self = this.set("transition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTransitionComponentClass(value: ReactComponentClass[ToastTransitionProps]): Self = this.set("transition", value.asInstanceOf[js.Any])
