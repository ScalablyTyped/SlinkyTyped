...
import typingsSlinky.reactToastify.constantMod.KeyOfPosition
import typingsSlinky.reactToastify.constantMod.KeyOfType
...
object reactToastifyStrings {
  ...
  sealed trait Toastify
    extends typingsSlinky.reactToastify.constantMod.DEFAULT
