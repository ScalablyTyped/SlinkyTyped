...
object ToastContainer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashToastify.reactDashToastifyMod.ToastContainer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashToastify.reactDashToastifyMod.ToastContainer] = {
