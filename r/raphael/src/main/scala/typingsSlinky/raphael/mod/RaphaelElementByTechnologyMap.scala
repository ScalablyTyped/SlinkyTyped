...
object RaphaelElementByTechnologyMap {
  @scala.inline
  def apply[/* <: typingsSlinky.std.SVGElement */ TSvg, /* <: typingsSlinky.raphael.mod.VMLElement */ TVml](SVG: TSvg, VML: TVml): RaphaelElementByTechnologyMap[TSvg, TVml] = {
  ...
  @scala.inline
  implicit class RaphaelElementByTechnologyMapOps[Self <: RaphaelElementByTechnologyMap[_, _], /* <: typingsSlinky.std.SVGElement */ TSvg, /* <: typingsSlinky.raphael.mod.VMLElement */ TVml] (val x: Self with (RaphaelElementByTechnologyMap[TSvg, TVml])) extends AnyVal {
    @scala.inline
