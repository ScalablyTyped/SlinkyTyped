...
object RaphaelElementPluginRegistry {
  ...
  @scala.inline
  implicit class RaphaelElementPluginRegistryOps[Self <: RaphaelElementPluginRegistry[_], /* <: typingsSlinky.raphael.mod.RaphaelTechnology */ TTechnology] (val x: Self with RaphaelElementPluginRegistry[TTechnology]) extends AnyVal {
    @scala.inline
