...
object RaphaelSetPluginRegistry {
  @scala.inline
  def apply[/* <: typingsSlinky.raphael.mod.RaphaelTechnology */ TTechnology](
  ...
  @scala.inline
  implicit class RaphaelSetPluginRegistryOps[Self <: RaphaelSetPluginRegistry[_], /* <: typingsSlinky.raphael.mod.RaphaelTechnology */ TTechnology] (val x: Self with RaphaelSetPluginRegistry[TTechnology]) extends AnyVal {
    @scala.inline
