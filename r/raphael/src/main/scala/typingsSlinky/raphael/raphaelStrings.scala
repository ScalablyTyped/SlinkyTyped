...
import typingsSlinky.raphael.mod.RaphaelBuiltinEasingFormula
import typingsSlinky.raphael.mod.RaphaelDashArrayType
import typingsSlinky.raphael.mod.RaphaelFontOrigin
import typingsSlinky.raphael.mod.RaphaelLineCapType
import typingsSlinky.raphael.mod.RaphaelLineJoinType
import typingsSlinky.raphael.mod.RaphaelShapeType
import typingsSlinky.raphael.mod.RaphaelTechnology
