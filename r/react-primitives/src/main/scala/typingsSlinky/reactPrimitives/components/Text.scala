...
object Text
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactPrimitives.mod.Text] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactPrimitives.mod.Text] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactPrimitives.mod.Text] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactPrimitives.mod.Text](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
