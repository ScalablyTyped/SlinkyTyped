...
object Image
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactPrimitives.mod.Image] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactPrimitives.mod.Image] = {
