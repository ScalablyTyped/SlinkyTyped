...
object AnimatedFlatList {
  ...
  def apply(p: AnimatedProps[ComponentPropsWithRef[Instantiable0[FlatList[js.Object]]]]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
