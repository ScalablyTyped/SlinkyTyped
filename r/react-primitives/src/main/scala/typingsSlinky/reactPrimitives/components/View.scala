...
object View
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactPrimitives.mod.View] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactPrimitives.mod.View] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactPrimitives.mod.View] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactPrimitives.mod.View](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
