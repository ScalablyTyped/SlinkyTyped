...
object Touchable
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactPrimitives.mod.Touchable] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactPrimitives.mod.Touchable] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactPrimitives.mod.Touchable] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactPrimitives.mod.Touchable](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
