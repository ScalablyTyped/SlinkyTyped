...
trait PlatformStatic extends js.Object {
  ...
  {[ platform in react-primitives.react-primitives.PlatformOSType | 'default' ]:? T}
    */ typingsSlinky.reactPrimitives.reactPrimitivesStrings.PlatformStatic with js.Any
  ): T
}
...
object PlatformStatic {
  ...
  {[ platform in react-primitives.react-primitives.PlatformOSType | 'default' ]:? T}
    */ typingsSlinky.reactPrimitives.reactPrimitivesStrings.PlatformStatic with js.Any => js.Any
  ): PlatformStatic = {
