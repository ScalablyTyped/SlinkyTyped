...
object Image
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.Image] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.Image] = {
