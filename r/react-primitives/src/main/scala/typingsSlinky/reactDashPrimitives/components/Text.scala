package typingsSlinky.reactDashPrimitives.components
...
object Text
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.Text] {
  @JSImport("react-primitives", "Text")
  @js.native
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.Text] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.Text] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.Text](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
