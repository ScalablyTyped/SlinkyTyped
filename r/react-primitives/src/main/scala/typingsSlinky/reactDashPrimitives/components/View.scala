...
object View
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.View] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.View] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.View] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.reactDashPrimitives.reactDashPrimitivesMod.View](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
