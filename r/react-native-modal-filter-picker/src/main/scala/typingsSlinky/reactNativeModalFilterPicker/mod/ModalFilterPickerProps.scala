...
object ModalFilterPickerProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactNativeModalFilterPicker.mod.ModalFilterPickerOption */ T](onCancel: () => Unit, onSelect: String => Unit, options: js.Array[T]): ModalFilterPickerProps[T] = {
  ...
  @scala.inline
  implicit class ModalFilterPickerPropsOps[Self <: ModalFilterPickerProps[_], /* <: typingsSlinky.reactNativeModalFilterPicker.mod.ModalFilterPickerOption */ T] (val x: Self with ModalFilterPickerProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRenderCancelButton(value: () => ReactElement): Self = this.set("renderCancelButton", js.Any.fromFunction0(value))
    @scala.inline
    def deleteRenderCancelButton: Self = this.set("renderCancelButton", js.undefined)
    @scala.inline
    def setRenderList(value: () => ReactElement): Self = this.set("renderList", js.Any.fromFunction0(value))
    @scala.inline
    def deleteRenderList: Self = this.set("renderList", js.undefined)
    @scala.inline
    def setRenderOption(value: (/* option */ T, /* isSelected */ Boolean) => ReactElement): Self = this.set("renderOption", js.Any.fromFunction2(value))
    @scala.inline
