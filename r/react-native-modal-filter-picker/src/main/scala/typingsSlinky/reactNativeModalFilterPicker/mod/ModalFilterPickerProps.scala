...
trait ModalFilterPickerProps[T /* <: ModalFilterPickerOption */] extends js.Object {
  ...
  var renderCancelButton: js.UndefOr[js.Function0[ReactElement]] = js.undefined
  var renderList: js.UndefOr[js.Function0[ReactElement]] = js.undefined
  var renderOption: js.UndefOr[js.Function2[/* option */ T, /* isSelected */ Boolean, ReactElement]] = js.undefined
...
object ModalFilterPickerProps {
  ...
  def apply[T](
    ...
    renderOption: (/* option */ T, /* isSelected */ Boolean) => ReactElement = null,
