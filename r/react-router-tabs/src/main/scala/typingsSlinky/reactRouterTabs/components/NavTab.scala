...
object NavTab
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactRouterTabs.mod.NavTab] {
  ...
  def apply(
    ...
    allowClickOnActive: js.UndefOr[Boolean] = js.undefined,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactRouterTabs.mod.NavTab] = {
    ...
    if (!js.isUndefined(allowClickOnActive)) __obj.updateDynamic("allowClickOnActive")(allowClickOnActive.asInstanceOf[js.Any])
