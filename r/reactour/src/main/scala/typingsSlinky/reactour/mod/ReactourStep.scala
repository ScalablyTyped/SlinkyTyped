...
trait ReactourStep extends js.Object {
  ...
  /**
    * Content of the step
    */
  var content: TagMod[Any] | (js.Function1[/* args */ ReactourStepContentArgs, TagMod[Any]])
  /**
...
object ReactourStep {
  ...
  def apply(
    ...
    content: TagMod[Any] | (js.Function1[/* args */ ReactourStepContentArgs, TagMod[Any]]) = null,
