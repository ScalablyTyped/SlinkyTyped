...
trait ReactourStep extends js.Object {
  ...
  /**
    * Content of the step
    */
  var content: ReactElement | (js.Function1[/* args */ ReactourStepContentArgs, ReactElement]) = js.native
...
object ReactourStep {
  ...
  implicit class ReactourStepOps[Self <: ReactourStep] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentFunction1(value: /* args */ ReactourStepContentArgs => ReactElement): Self = this.set("content", js.Any.fromFunction1(value))
    
    @scala.inline
    def setContent(value: ReactElement | (js.Function1[/* args */ ReactourStepContentArgs, ReactElement])): Self = this.set("content", value.asInstanceOf[js.Any])
