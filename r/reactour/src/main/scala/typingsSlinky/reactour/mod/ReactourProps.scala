...
trait ReactourProps extends js.Object {
  ...
  /**
    ...
    */
  var badgeContent: js.UndefOr[js.Function2[/* current */ Double, /* total */ Double, ReactElement]] = js.native
  /**
  ...
  /**
    ...
    */
  var lastStepNextButton: js.UndefOr[ReactElement] = js.native
  /**
...
object ReactourProps {
  ...
  implicit class ReactourPropsOps[Self <: ReactourProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnRequestClose(value: SyntheticMouseEvent[HTMLDivElement] => Unit): Self = this.set("onRequestClose", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setBadgeContent(value: (/* current */ Double, /* total */ Double) => ReactElement): Self = this.set("badgeContent", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setLastStepNextButtonReactElement(value: ReactElement): Self = this.set("lastStepNextButton", value.asInstanceOf[js.Any])
    @scala.inline
    def setLastStepNextButton(value: ReactElement): Self = this.set("lastStepNextButton", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNextButtonReactElement(value: ReactElement): Self = this.set("nextButton", value.asInstanceOf[js.Any])
    @scala.inline
    def setNextButton(value: ReactElement): Self = this.set("nextButton", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPrevButtonReactElement(value: ReactElement): Self = this.set("prevButton", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrevButton(value: ReactElement): Self = this.set("prevButton", value.asInstanceOf[js.Any])
    @scala.inline
