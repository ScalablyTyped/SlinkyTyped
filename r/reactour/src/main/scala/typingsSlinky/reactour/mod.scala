...
object mod {
  ...
  @js.native
  val Controls: ReactComponentClass[ControlsProps] = js.native
  
  @JSImport("reactour", "Dot")
  @js.native
  val Dot: ReactComponentClass[DotProps] = js.native
  
  @JSImport("reactour", "Navigation")
  @js.native
  val Navigation: ReactComponentClass[NavigationProps] = js.native
  ...
  object ReactourProps {
    ...
    implicit class ReactourPropsMutableBuilder[Self <: ReactourProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBadgeContent(value: (/* current */ Double, /* total */ Double) => ReactElement): Self = StObject.set(x, "badgeContent", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setLastStepNextButton(value: ReactElement): Self = StObject.set(x, "lastStepNextButton", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastStepNextButtonReactElement(value: ReactElement): Self = StObject.set(x, "lastStepNextButton", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNextButtonReactElement(value: ReactElement): Self = StObject.set(x, "nextButton", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnRequestClose(value: SyntheticMouseEvent[HTMLDivElement] => Unit): Self = StObject.set(x, "onRequestClose", js.Any.fromFunction1(value))
      
      @scala.inline
      def setPrevButton(value: ReactElement): Self = StObject.set(x, "prevButton", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrevButtonReactElement(value: ReactElement): Self = StObject.set(x, "prevButton", value.asInstanceOf[js.Any])
  ...
  object ReactourStep {
    ...
    implicit class ReactourStepMutableBuilder[Self <: ReactourStep] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContent(value: ReactElement | (js.Function1[/* args */ ReactourStepContentArgs, ReactElement])): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setContentFunction1(value: /* args */ ReactourStepContentArgs => ReactElement): Self = StObject.set(x, "content", js.Any.fromFunction1(value))
