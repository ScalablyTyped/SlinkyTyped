...
object TransitionGroup {
  ...
  def apply(p: TransitionGroupProps[div, js.Any]): Default[tag.type, typingsSlinky.reactTransitionGroup.mod.TransitionGroup] = new Default[tag.type, typingsSlinky.reactTransitionGroup.mod.TransitionGroup](js.Array(this.component, p.asInstanceOf[js.Any]))
