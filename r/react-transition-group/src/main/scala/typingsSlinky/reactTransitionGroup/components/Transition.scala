...
object Transition {
  object EndListenerProps {
    ...
    @scala.inline
    class Builder[/* <: js.UndefOr[typingsSlinky.std.HTMLElement] */ RefElement] (val args: js.Array[js.Any])
      extends AnyVal
    ...
    def withProps[/* <: js.UndefOr[typingsSlinky.std.HTMLElement] */ RefElement](p: typingsSlinky.reactTransitionGroup.transitionMod.EndListenerProps[RefElement]): Builder[RefElement] = new Builder[RefElement](js.Array(this.component, p.asInstanceOf[js.Any]))
    @scala.inline
    def apply[/* <: js.UndefOr[typingsSlinky.std.HTMLElement] */ RefElement](addEndListener: EndHandler[RefElement]): Builder[RefElement] = {
  ...
  object TimeoutProps {
    ...
    def withProps[/* <: js.UndefOr[typingsSlinky.std.HTMLElement] */ RefElement](p: typingsSlinky.reactTransitionGroup.transitionMod.TimeoutProps[RefElement]): Builder[RefElement] = new Builder[RefElement](js.Array(this.component, p.asInstanceOf[js.Any]))
    @scala.inline
    def apply[/* <: js.UndefOr[typingsSlinky.std.HTMLElement] */ RefElement](timeout: Double | Appear): Builder[RefElement] = {
