...
object Explicit {
  @scala.inline
  def apply[/* <: js.Function2[/ * node * / typingsSlinky.std.HTMLElement, / * repeated * / js.Any, scala.Unit] */ ImplicitRefHandler, /* <: js.Function1[/ * repeated * / js.Any, scala.Unit] */ ExplicitRefHandler](explicit: ExplicitRefHandler, `implicit`: ImplicitRefHandler): Explicit[ImplicitRefHandler, ExplicitRefHandler] = {
  ...
  @scala.inline
  implicit class ExplicitOps[Self <: Explicit[_, _], /* <: js.Function2[/ * node * / typingsSlinky.std.HTMLElement, / * repeated * / js.Any, scala.Unit] */ ImplicitRefHandler, /* <: js.Function1[/ * repeated * / js.Any, scala.Unit] */ ExplicitRefHandler] (val x: Self with (Explicit[ImplicitRefHandler, ExplicitRefHandler])) extends AnyVal {
    @scala.inline
