...
object BaseTransitionProps {
  @scala.inline
  def apply[/* <: js.UndefOr[typingsSlinky.std.HTMLElement] */ RefElement](): BaseTransitionProps[RefElement] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BaseTransitionProps[RefElement]]
  }
  @scala.inline
  implicit class BaseTransitionPropsOps[Self <: BaseTransitionProps[_], /* <: js.UndefOr[typingsSlinky.std.HTMLElement] */ RefElement] (val x: Self with BaseTransitionProps[RefElement]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setChildrenFunction1(value: /* status */ TransitionStatus => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setNodeRefRefObject(value: ReactRef[RefElement]): Self = this.set("nodeRef", value.asInstanceOf[js.Any])
    @scala.inline
