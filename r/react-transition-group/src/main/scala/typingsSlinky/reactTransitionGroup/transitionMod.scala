...
object transitionMod {
  ...
  object BaseTransitionProps {
    ...
    implicit class BaseTransitionPropsMutableBuilder[Self <: BaseTransitionProps[_], RefElement /* <: js.UndefOr[HTMLElement] */] (val x: Self with BaseTransitionProps[RefElement]) extends AnyVal {
      ...
      @scala.inline
      def setChildrenFunction1(value: /* status */ TransitionStatus => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setNodeRefRefObject(value: ReactRef[RefElement]): Self = StObject.set(x, "nodeRef", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    *
    */
  type Transition[RefElement /* <: js.UndefOr[HTMLElement] */] = ReactComponentClass[TransitionProps[RefElement]]
  ...
  type TransitionChildren = ReactElement | (js.Function1[/* status */ TransitionStatus, ReactElement])
  ...
  */
  ...
  object TransitionProps {
    ...
    @scala.inline
    def EndListenerProps[RefElement /* <: js.UndefOr[HTMLElement] */](addEndListener: EndHandler[RefElement]): typingsSlinky.reactTransitionGroup.transitionMod.EndListenerProps[RefElement] = {
      val __obj = js.Dynamic.literal(addEndListener = addEndListener.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactTransitionGroup.transitionMod.EndListenerProps[RefElement]]
    }
    
    @scala.inline
    def TimeoutProps[RefElement /* <: js.UndefOr[HTMLElement] */](timeout: Double | Appear): typingsSlinky.reactTransitionGroup.transitionMod.TimeoutProps[RefElement] = {
      val __obj = js.Dynamic.literal(timeout = timeout.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactTransitionGroup.transitionMod.TimeoutProps[RefElement]]
    }
  }
