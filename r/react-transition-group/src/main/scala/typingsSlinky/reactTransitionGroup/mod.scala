...
object mod {
  ...
  class SwitchTransition ()
    extends typingsSlinky.reactTransitionGroup.switchTransitionMod.default
  ...
  class Transition[RefElement /* <: js.UndefOr[HTMLElement] */] ()
    extends typingsSlinky.reactTransitionGroup.transitionMod.default[RefElement]
  ...
  class TransitionGroup ()
    extends typingsSlinky.reactTransitionGroup.transitionGroupMod.default
