...
object mod {
  ...
  object EmailCryptType extends StObject {
    ...
    /* 2 */ val EmailCryptTypeMD5: typingsSlinky.reactNativeAppsflyer.mod.EmailCryptType.EmailCryptTypeMD5 with Double = js.native
    
    @js.native
    sealed trait EmailCryptTypeNone extends EmailCryptType
    /* 0 */ val EmailCryptTypeNone: typingsSlinky.reactNativeAppsflyer.mod.EmailCryptType.EmailCryptTypeNone with Double = js.native
    
    @js.native
    sealed trait EmailCryptTypeSHA1 extends EmailCryptType
    /* 1 */ val EmailCryptTypeSHA1: typingsSlinky.reactNativeAppsflyer.mod.EmailCryptType.EmailCryptTypeSHA1 with Double = js.native
    
    @js.native
    sealed trait EmailCryptTypeSHA256 extends EmailCryptType
    /* 3 */ val EmailCryptTypeSHA256: typingsSlinky.reactNativeAppsflyer.mod.EmailCryptType.EmailCryptTypeSHA256 with Double = js.native
  }
