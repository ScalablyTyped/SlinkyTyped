...
object TableToolkitProps {
  ...
  @scala.inline
  implicit class TableToolkitPropsOps[Self <: TableToolkitProps[_], T /* <: js.Object */] (val x: Self with TableToolkitProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: ToolkitContextType => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
