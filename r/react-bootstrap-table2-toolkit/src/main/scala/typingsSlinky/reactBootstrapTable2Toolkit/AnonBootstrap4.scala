...
object AnonBootstrap4 {
  @scala.inline
  def apply(columns: js.Array[ColumnDescription[_, _]], data: js.Array[_], keyField: js.Any): AnonBootstrap4 = {
  ...
  @scala.inline
  implicit class AnonBootstrap4Ops[Self <: AnonBootstrap4] (val x: Self) extends AnyVal {
    @scala.inline
