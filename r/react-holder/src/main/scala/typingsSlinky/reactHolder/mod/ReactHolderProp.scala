...
object ReactHolderProp {
  ...
  def apply(
    ...
    lang: String = null,
    lineWrap: js.UndefOr[Double] = js.undefined,
    onAbort: SyntheticEvent[Event, ReactHolder] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onChange: SyntheticEvent[EventTarget with ReactHolder, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onEmptied: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onEncrypted: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onEnded: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onError: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onFocus: SyntheticFocusEvent[ReactHolder] => Unit = null,
    onInput: SyntheticEvent[EventTarget with ReactHolder, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with ReactHolder, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onLoadStart: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onLoadedData: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, ReactHolder] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onPlay: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onPlaying: SyntheticEvent[Event, ReactHolder] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onRateChange: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onReset: SyntheticEvent[EventTarget with ReactHolder, Event] => Unit = null,
    onScroll: SyntheticUIEvent[ReactHolder] => Unit = null,
    onSeeked: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onSeeking: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onSelect: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onStalled: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with ReactHolder, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, ReactHolder] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, ReactHolder] => Unit = null,
    onWaiting: SyntheticEvent[Event, ReactHolder] => Unit = null,
    ...
    if (!js.isUndefined(lineWrap)) __obj.updateDynamic("lineWrap")(lineWrap.get.asInstanceOf[js.Any])
