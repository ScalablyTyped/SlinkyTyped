...
trait NumberFilterProps[T /* <: js.Object */] extends js.Object {
  ...
  var defaultValue: js.UndefOr[js.Any with typingsSlinky.reactBootstrapTable2Filter.anon.Comparator] = js.undefined
...
object NumberFilterProps {
  ...
  def apply[T](
    ...
    defaultValue: js.Any with typingsSlinky.reactBootstrapTable2Filter.anon.Comparator = null,
