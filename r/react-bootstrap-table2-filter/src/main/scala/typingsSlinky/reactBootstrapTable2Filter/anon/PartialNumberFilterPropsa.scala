...
object PartialNumberFilterPropsa {
  ...
  implicit class PartialNumberFilterPropsaOps[Self <: PartialNumberFilterPropsa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComparatorsVarargs(value: typingsSlinky.reactBootstrapTable2Filter.mod.Comparator*): Self = this.set("comparators", js.Array(value :_*))
    @scala.inline
    def setComparators(value: js.Array[typingsSlinky.reactBootstrapTable2Filter.mod.Comparator]): Self = this.set("comparators", value.asInstanceOf[js.Any])
    @scala.inline
