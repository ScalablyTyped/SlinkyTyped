package typingsSlinky.reactDashInfiniteDashScroller.reactDashInfiniteDashScrollerMod.InfiniteScroll
...
trait InfiniteScrollProps
  extends AllHTMLAttributes[
      typingsSlinky.reactDashInfiniteDashScroller.reactDashInfiniteDashScrollerMod.InfiniteScroll.InfiniteScroll
    ]
