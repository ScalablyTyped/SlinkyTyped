...
trait DropdownListProps
  ...
  /**
    ...
    * is set to true.
    */
  var busySpinner: js.UndefOr[TagMod[Any]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var itemComponent: js.UndefOr[ReactComponentClass[_] | String] = js.undefined
  ...
  /**
    ...
    * component renders the text of the selected item (specified by textfield)
    */
  var valueComponent: js.UndefOr[ReactComponentClass[_]] = js.undefined
  /**
