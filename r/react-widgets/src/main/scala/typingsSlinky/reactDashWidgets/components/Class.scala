...
object Class
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashWidgets.libCalendarMod.Class] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashWidgets.libCalendarMod.Class] = {
