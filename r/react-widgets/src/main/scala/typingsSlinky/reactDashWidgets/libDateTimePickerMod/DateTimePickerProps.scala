...
import typingsSlinky.reactDashWidgets.libCommonPropsMod.AutoFocus
import typingsSlinky.reactDashWidgets.libCommonPropsMod.ReactWidgetsCommonDropdownProps
...
trait DateTimePickerProps
  ...
  /**
    ...
    */
  var onKeyDown: js.UndefOr[js.Function1[/* event */ SyntheticKeyboardEvent[_], Unit]] = js.undefined
  /**
    * The native onKeyPress event, called preventDefault will stop any custom behavior.
    */
  var onKeyPress: js.UndefOr[js.Function1[/* event */ SyntheticKeyboardEvent[_], Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var popupTransition: js.UndefOr[ReactComponentClass[_] | String] = js.undefined
  /**
  ...
  /**
    ...
    */
  var timeComponent: js.UndefOr[ReactComponentClass[_] | String] = js.undefined
  /**
