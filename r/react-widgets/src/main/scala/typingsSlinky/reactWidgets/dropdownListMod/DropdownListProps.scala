...
object DropdownListProps {
  ...
  implicit class DropdownListPropsOps[Self <: DropdownListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValueComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("valueComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setValueComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("valueComponent", value.asInstanceOf[js.Any])
    @scala.inline
