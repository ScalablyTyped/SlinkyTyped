...
object ComboboxProps {
  ...
  implicit class ComboboxPropsOps[Self <: ComboboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBusySpinnerReactElement(value: ReactElement): Self = this.set("busySpinner", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBusySpinner(value: ReactElement): Self = this.set("busySpinner", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPopupTransitionFunctionComponent(value: ReactComponentClass[_]): Self = this.set("popupTransition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPopupTransitionComponentClass(value: ReactComponentClass[_]): Self = this.set("popupTransition", value.asInstanceOf[js.Any])
