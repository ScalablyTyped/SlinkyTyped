...
object ComboboxMessages {
  ...
  implicit class ComboboxMessagesOps[Self <: ComboboxMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEmptyFilterFunction1(value: /* props */ ComboboxProps => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("emptyFilter")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withEmptyFilter(value: String | (js.Function1[/* props */ ComboboxProps, String])): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("emptyFilter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEmptyListFunction1(value: /* props */ ComboboxProps => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("emptyList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withEmptyList(value: String | (js.Function1[/* props */ ComboboxProps, String])): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("emptyList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOpenFunction1(value: /* props */ ComboboxProps => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("open")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOpen(value: String | (js.Function1[/* props */ ComboboxProps, String])): Self = {
        val ret = this.duplicate
