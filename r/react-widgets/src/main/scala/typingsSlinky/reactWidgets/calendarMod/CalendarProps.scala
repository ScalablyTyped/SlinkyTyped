...
trait CalendarProps
  ...
  /**
    ...
    * 1900 - 1999.
    */
  var centuryFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dateFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
  /**
    ...
    */
  var dayComponent: js.UndefOr[ReactComponentClass[_]] = js.undefined
  /**
    * A formatter calendar days of the week, the default formats each day as a Narrow name:
    * "Mo", "Tu", etc.
    */
  var dayFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
  /**
    * A formatter for decade, the default formats the first and last year of the decade like:
    * 2000 - 2009.
    */
  var decadeFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
  /**
    * Default value.
    */
  ...
  /**
    ...
    */
  var footerFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
  /**
    * A formatter for the header button of the month view
    */
  var headerFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
  /**
  ...
  /**
    ...
    */
  var monthFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
  /**
    * Change event Handler that is called when the value is changed. The handler is called with
    * the Date object
    */
  var onChange: js.UndefOr[js.Function1[/* date */ js.UndefOr[js.Date], Unit]] = js.undefined
  /**
    * Change event Handler that is called when the currentDate is changed. The handler is
    * called with the currentDate object.
    */
  var onCurrentDateChange: js.UndefOr[js.Function1[/* date */ js.UndefOr[js.Date], Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var yearFormat: js.UndefOr[String | (js.Function1[/* day */ js.Date, String])] = js.undefined
}
