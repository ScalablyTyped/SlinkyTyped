...
object CalendarProps {
  ...
  implicit class CalendarPropsOps[Self <: CalendarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCenturyFormatFunction1(value: /* day */ js.Date => String): Self = this.set("centuryFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setCenturyFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("centuryFormat", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCurrentDate(value: js.Date): Self = this.set("currentDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCurrentDate: Self = this.set("currentDate", js.undefined)
    @scala.inline
    def setDateFormatFunction1(value: /* day */ js.Date => String): Self = this.set("dateFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setDateFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("dateFormat", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDateFormat: Self = this.set("dateFormat", js.undefined)
    @scala.inline
    def setDayComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("dayComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setDayComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("dayComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDayFormatFunction1(value: /* day */ js.Date => String): Self = this.set("dayFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setDayFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("dayFormat", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDayFormat: Self = this.set("dayFormat", js.undefined)
    @scala.inline
    def setDecadeFormatFunction1(value: /* day */ js.Date => String): Self = this.set("decadeFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setDecadeFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("decadeFormat", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFooterFormatFunction1(value: /* day */ js.Date => String): Self = this.set("footerFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setFooterFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("footerFormat", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFooterFormat: Self = this.set("footerFormat", js.undefined)
    @scala.inline
    def setHeaderFormatFunction1(value: /* day */ js.Date => String): Self = this.set("headerFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setHeaderFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("headerFormat", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMonthFormatFunction1(value: /* day */ js.Date => String): Self = this.set("monthFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setMonthFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("monthFormat", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMonthFormat: Self = this.set("monthFormat", js.undefined)
    @scala.inline
    def setOnChange(value: /* date */ js.UndefOr[js.Date] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    @scala.inline
    def setOnCurrentDateChange(value: /* date */ js.UndefOr[js.Date] => Unit): Self = this.set("onCurrentDateChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnNavigate(value: (/* date */ js.Date, /* direction */ String, /* view */ String) => Unit): Self = this.set("onNavigate", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def setYearFormatFunction1(value: /* day */ js.Date => String): Self = this.set("yearFormat", js.Any.fromFunction1(value))
    @scala.inline
    def setYearFormat(value: String | (js.Function1[/* day */ js.Date, String])): Self = this.set("yearFormat", value.asInstanceOf[js.Any])
    @scala.inline
