...
object DateTimePickerProps {
  ...
  implicit class DateTimePickerPropsOps[Self <: DateTimePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateIcon(value: ReactElement): Self = this.set("dateIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDateIcon: Self = this.set("dateIcon", js.undefined)
    
    @scala.inline
    def setDefaultCurrentDate(value: js.Date): Self = this.set("defaultCurrentDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* date */ js.UndefOr[js.Date], /* dateStr */ js.UndefOr[String]) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnKeyDown(value: /* event */ SyntheticKeyboardEvent[_] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnKeyDown: Self = this.set("onKeyDown", js.undefined)
    
    @scala.inline
    def setOnKeyPress(value: /* event */ SyntheticKeyboardEvent[_] => Unit): Self = this.set("onKeyPress", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnKeyPress: Self = this.set("onKeyPress", js.undefined)
    
    @scala.inline
    def setOnSelect(value: /* date */ js.UndefOr[js.Date] => Unit): Self = this.set("onSelect", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setParseFunction1(value: /* str */ String => js.Date): Self = this.set("parse", js.Any.fromFunction1(value))
    
    @scala.inline
    def setParse(value: (js.Function1[/* str */ String, js.Date]) | js.Array[String] | String): Self = this.set("parse", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTimeComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("timeComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTimeComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("timeComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTimeIcon(value: ReactElement): Self = this.set("timeIcon", value.asInstanceOf[js.Any])
