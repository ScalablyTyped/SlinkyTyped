...
object SelectList
  ...
  /* The following DOM/SVG props were specified: autoFocus, id, multiple, name, tabIndex */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.reactWidgets.mod.SelectList.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
