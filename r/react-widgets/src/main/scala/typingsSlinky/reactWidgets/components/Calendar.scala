...
object Calendar {
  ...
  object Calendar {
    ...
    implicit def make(companion: Calendar.type): typingsSlinky.reactWidgets.components.Calendar.Calendar.Builder = new typingsSlinky.reactWidgets.components.Calendar.Calendar.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: CalendarProps): typingsSlinky.reactWidgets.components.Calendar.Calendar.Builder = new typingsSlinky.reactWidgets.components.Calendar.Calendar.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("react-widgets", "Calendar")
  @js.native
  val component: js.Object = js.native
