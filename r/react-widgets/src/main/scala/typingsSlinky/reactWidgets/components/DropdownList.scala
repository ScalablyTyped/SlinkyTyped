...
object DropdownList {
  ...
  object DropdownList {
    ...
    implicit def make(companion: DropdownList.type): typingsSlinky.reactWidgets.components.DropdownList.DropdownList.Builder = new typingsSlinky.reactWidgets.components.DropdownList.DropdownList.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownListProps): typingsSlinky.reactWidgets.components.DropdownList.DropdownList.Builder = new typingsSlinky.reactWidgets.components.DropdownList.DropdownList.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("react-widgets", "DropdownList")
  @js.native
  val component: js.Object = js.native
