...
object DateTimePicker {
  ...
  object DateTimePicker {
    ...
    implicit def make(companion: DateTimePicker.type): typingsSlinky.reactWidgets.components.DateTimePicker.DateTimePicker.Builder = new typingsSlinky.reactWidgets.components.DateTimePicker.DateTimePicker.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DateTimePickerProps): typingsSlinky.reactWidgets.components.DateTimePicker.DateTimePicker.Builder = new typingsSlinky.reactWidgets.components.DateTimePicker.DateTimePicker.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("react-widgets", "DateTimePicker")
  @js.native
  val component: js.Object = js.native
