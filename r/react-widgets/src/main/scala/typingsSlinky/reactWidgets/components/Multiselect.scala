...
object Multiselect {
  ...
  object Multiselect {
    ...
    implicit def make(companion: Multiselect.type): typingsSlinky.reactWidgets.components.Multiselect.Multiselect.Builder = new typingsSlinky.reactWidgets.components.Multiselect.Multiselect.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: MultiselectProps): typingsSlinky.reactWidgets.components.Multiselect.Multiselect.Builder = new typingsSlinky.reactWidgets.components.Multiselect.Multiselect.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("react-widgets", "Multiselect")
  @js.native
  val component: js.Object = js.native
