...
object dropdownListMod extends Shortcut {
  ...
  @js.native
  class ^ protected ()
    extends Component[DropdownListProps, js.Object, js.Any] {
  ...
  object DropdownListProps {
    ...
    implicit class DropdownListPropsMutableBuilder[Self <: DropdownListProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValueComponentComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "valueComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValueComponentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "valueComponent", value.asInstanceOf[js.Any])
