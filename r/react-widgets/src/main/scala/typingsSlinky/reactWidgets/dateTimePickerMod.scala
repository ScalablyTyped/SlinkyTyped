...
object dateTimePickerMod extends Shortcut {
  ...
  type DateTimePickerClass = ReactComponentClass[DateTimePickerProps]
  ...
  object DateTimePickerProps {
    ...
    implicit class DateTimePickerPropsMutableBuilder[Self <: DateTimePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDateIcon(value: ReactElement): Self = StObject.set(x, "dateIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDefaultCurrentDate(value: js.Date): Self = StObject.set(x, "defaultCurrentDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* date */ js.UndefOr[js.Date], /* dateStr */ js.UndefOr[String]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnKeyDown(value: /* event */ SyntheticKeyboardEvent[_] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnKeyDownUndefined: Self = StObject.set(x, "onKeyDown", js.undefined)
      
      @scala.inline
      def setOnKeyPress(value: /* event */ SyntheticKeyboardEvent[_] => Unit): Self = StObject.set(x, "onKeyPress", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnKeyPressUndefined: Self = StObject.set(x, "onKeyPress", js.undefined)
      
      @scala.inline
      def setOnSelect(value: /* date */ js.UndefOr[js.Date] => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setParse(value: (js.Function1[/* str */ String, js.Date]) | js.Array[String] | String): Self = StObject.set(x, "parse", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setParseFunction1(value: /* str */ String => js.Date): Self = StObject.set(x, "parse", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTimeComponentComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "timeComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTimeComponentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "timeComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTimeIcon(value: ReactElement): Self = StObject.set(x, "timeIcon", value.asInstanceOf[js.Any])
