...
object MultiselectProps {
  ...
  implicit class MultiselectPropsOps[Self <: MultiselectProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("tagComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setTagComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("tagComponent", value.asInstanceOf[js.Any])
    @scala.inline
