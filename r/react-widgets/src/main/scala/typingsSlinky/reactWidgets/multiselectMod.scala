...
object multiselectMod extends Shortcut {
  ...
  object MultiselectProps {
    ...
    implicit class MultiselectPropsMutableBuilder[Self <: MultiselectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTagComponentComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "tagComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTagComponentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "tagComponent", value.asInstanceOf[js.Any])
