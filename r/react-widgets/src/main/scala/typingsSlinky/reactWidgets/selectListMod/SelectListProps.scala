...
object SelectListProps {
  ...
  implicit class SelectListPropsOps[Self <: SelectListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("groupComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGroupComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("groupComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("itemComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("itemComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setListComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("listComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("listComponent", value.asInstanceOf[js.Any])
