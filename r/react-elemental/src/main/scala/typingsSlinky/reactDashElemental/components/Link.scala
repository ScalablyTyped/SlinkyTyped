...
object Link
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashElemental.reactDashElementalMod.Link] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashElemental.reactDashElementalMod.Link] = new slinky.core.BuildingComponent[
  slinky.web.html.a.tag.type, 
  typingsSlinky.reactDashElemental.reactDashElementalMod.Link](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
