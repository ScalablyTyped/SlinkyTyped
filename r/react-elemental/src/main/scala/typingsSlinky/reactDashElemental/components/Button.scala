...
import typingsSlinky.reactDashElemental.reactDashElementalMod.ButtonProps
...
object Button
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactDashElemental.reactDashElementalMod.Button] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactDashElemental.reactDashElementalMod.Button] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactDashElemental.reactDashElementalMod.Button] = new slinky.core.BuildingComponent[
  slinky.web.html.button.tag.type, 
  typingsSlinky.reactDashElemental.reactDashElementalMod.Button](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
