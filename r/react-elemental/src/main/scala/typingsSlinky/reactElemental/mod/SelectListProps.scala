...
object SelectListProps {
  ...
  implicit class SelectListPropsOps[Self <: SelectListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptionsVarargs(value: typingsSlinky.reactElemental.anon.Label*): Self = this.set("options", js.Array(value :_*))
    
    @scala.inline
    def setOptions(value: js.Array[typingsSlinky.reactElemental.anon.Label]): Self = this.set("options", value.asInstanceOf[js.Any])
