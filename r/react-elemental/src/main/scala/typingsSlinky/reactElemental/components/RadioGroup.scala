...
object RadioGroup {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactElemental.mod.RadioGroup] {
    @scala.inline
    ...
    @scala.inline
    def idleColor(value: String): this.type = set("idleColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: (SyntheticEvent[EventTarget with HTMLDivElement, Event_]) | (/* value */ String) => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    ): this.type = set("radioRenderer", js.Any.fromFunction3(value))
    @scala.inline
