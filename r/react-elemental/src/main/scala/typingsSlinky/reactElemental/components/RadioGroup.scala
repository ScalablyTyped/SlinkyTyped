...
object RadioGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactElemental.mod.RadioGroup] {
  ...
  def apply(
    ...
    onChange: (SyntheticEvent[EventTarget with HTMLDivElement, Event_]) | (/* value */ String) => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactElemental.mod.RadioGroup] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactElemental.mod.RadioGroup] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactElemental.mod.RadioGroup](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
