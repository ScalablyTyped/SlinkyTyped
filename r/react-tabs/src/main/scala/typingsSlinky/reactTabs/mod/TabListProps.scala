...
object TabListProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLUListElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLUListElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLUListElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLUListElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLUListElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLUListElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLUListElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLUListElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLUListElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLUListElement] => Unit = null,
