...
object TabListProps {
  ...
  implicit class TabListPropsOps[Self <: TabListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClassName(value: String | js.Array[String] | StringDictionary[Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRefRefObject(value: ReactRef[HTMLUListElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRefFunction1(value: /* instance */ HTMLUListElement | Null => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRef(value: LegacyRef[HTMLUListElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
