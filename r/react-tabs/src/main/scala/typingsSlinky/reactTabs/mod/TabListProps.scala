package typingsSlinky.reactTabs.mod
...
import typingsSlinky.reactTabs.reactTabsStrings.assertive
import typingsSlinky.reactTabs.reactTabsStrings.both
import typingsSlinky.reactTabs.reactTabsStrings.copy
import typingsSlinky.reactTabs.reactTabsStrings.date
import typingsSlinky.reactTabs.reactTabsStrings.decimal
import typingsSlinky.reactTabs.reactTabsStrings.descending
import typingsSlinky.reactTabs.reactTabsStrings.dialog
import typingsSlinky.reactTabs.reactTabsStrings.email
import typingsSlinky.reactTabs.reactTabsStrings.execute
import typingsSlinky.reactTabs.reactTabsStrings.grammar
import typingsSlinky.reactTabs.reactTabsStrings.grid
import typingsSlinky.reactTabs.reactTabsStrings.horizontal
import typingsSlinky.reactTabs.reactTabsStrings.inherit
import typingsSlinky.reactTabs.reactTabsStrings.link
import typingsSlinky.reactTabs.reactTabsStrings.list
import typingsSlinky.reactTabs.reactTabsStrings.listbox
import typingsSlinky.reactTabs.reactTabsStrings.location
import typingsSlinky.reactTabs.reactTabsStrings.menu
import typingsSlinky.reactTabs.reactTabsStrings.mixed
import typingsSlinky.reactTabs.reactTabsStrings.move
import typingsSlinky.reactTabs.reactTabsStrings.no
import typingsSlinky.reactTabs.reactTabsStrings.none
import typingsSlinky.reactTabs.reactTabsStrings.numeric
import typingsSlinky.reactTabs.reactTabsStrings.off
import typingsSlinky.reactTabs.reactTabsStrings.on
import typingsSlinky.reactTabs.reactTabsStrings.other
import typingsSlinky.reactTabs.reactTabsStrings.page
import typingsSlinky.reactTabs.reactTabsStrings.polite
import typingsSlinky.reactTabs.reactTabsStrings.popup
import typingsSlinky.reactTabs.reactTabsStrings.removals
import typingsSlinky.reactTabs.reactTabsStrings.search
import typingsSlinky.reactTabs.reactTabsStrings.spelling
import typingsSlinky.reactTabs.reactTabsStrings.step
import typingsSlinky.reactTabs.reactTabsStrings.tel
import typingsSlinky.reactTabs.reactTabsStrings.text
import typingsSlinky.reactTabs.reactTabsStrings.time
import typingsSlinky.reactTabs.reactTabsStrings.tree
...
object TabListProps {
  ...
  implicit class TabListPropsOps[Self <: TabListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLUListElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
