...
object TabsProps {
  ...
  implicit class TabsPropsOps[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDefaultFocus(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDisabledTabClassName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disabledTabClassName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDisabledTabClassName: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disabledTabClassName")(js.undefined)
        ret
    }
    @scala.inline
    def withDomRef(value: /* node */ js.UndefOr[HTMLElement] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("domRef")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutDomRef: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("domRef")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withForceRenderTabPanel(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forceRenderTabPanel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutForceRenderTabPanel: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forceRenderTabPanel")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOnSelect(value: (/* index */ Double, /* last */ Double, /* event */ Event_) => Boolean | Unit): Self = {
        val ret = this.duplicate
