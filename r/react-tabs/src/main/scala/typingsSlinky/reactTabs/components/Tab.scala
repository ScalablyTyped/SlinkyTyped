...
object Tab
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.Tab] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.Tab] = new slinky.core.BuildingComponent[slinky.web.html.li.tag.type, typingsSlinky.reactTabs.mod.Tab](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = TabProps
}
