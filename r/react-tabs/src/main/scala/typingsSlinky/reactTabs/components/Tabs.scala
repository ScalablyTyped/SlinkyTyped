...
object Tabs
  ...
  def apply(
    ...
    onSelect: (/* index */ Double, /* last */ Double, /* event */ Event_) => Boolean | Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.Tabs] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.Tabs] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactTabs.mod.Tabs](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
