package typingsSlinky.reactTabs.components
...
import typingsSlinky.reactTabs.mod.TabsProps
...
object Tabs {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def defaultFocus(value: Boolean): this.type = set("defaultFocus", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def disabledTabClassName(value: String): this.type = set("disabledTabClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def domRef(value: /* node */ js.UndefOr[HTMLElement] => Unit): this.type = set("domRef", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def forceRenderTabPanel(value: Boolean): this.type = set("forceRenderTabPanel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onSelect(value: (/* index */ Double, /* last */ Double, /* event */ Event_) => Boolean | Unit): this.type = set("onSelect", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def selectedTabClassName(value: String): this.type = set("selectedTabClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def selectedTabPanelClassName(value: String): this.type = set("selectedTabPanelClassName", value.asInstanceOf[js.Any])
    @scala.inline
