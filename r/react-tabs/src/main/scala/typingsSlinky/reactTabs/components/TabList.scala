...
import typingsSlinky.reactTabs.mod.TabListProps
...
object TabList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactTabs.mod.TabList] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.TabList] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.TabList] = new slinky.core.BuildingComponent[slinky.web.html.ul.tag.type, typingsSlinky.reactTabs.mod.TabList](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
