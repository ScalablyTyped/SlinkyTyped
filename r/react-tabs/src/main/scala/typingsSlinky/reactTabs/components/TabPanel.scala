...
object TabPanel {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactTabs.mod.TabPanel] {
    @scala.inline
    ...
    @scala.inline
    def selectedClassName(value: String): this.type = set("selectedClassName", value.asInstanceOf[js.Any])
    @scala.inline
