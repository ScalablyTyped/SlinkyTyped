...
import typingsSlinky.reactTabs.mod.TabPanelProps
...
object TabPanel
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactTabs.mod.TabPanel] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.TabPanel] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.reactTabs.mod.TabPanel] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.reactTabs.mod.TabPanel](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
