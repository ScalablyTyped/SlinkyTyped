...
object WindowScrollerProps {
  ...
  implicit class WindowScrollerPropsOps[Self <: WindowScrollerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: WindowScrollerChildProps => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setScrollElementElement(value: Element): Self = this.set("scrollElement", value.asInstanceOf[js.Any])
    @scala.inline
