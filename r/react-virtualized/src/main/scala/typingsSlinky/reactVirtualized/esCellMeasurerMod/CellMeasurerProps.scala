...
/* key */ StringDictionary[js.Any] {
  ...
  var children: (js.Function1[/* props */ CellMeasurerChildProps, TagMod[Any]]) | TagMod[Any] = js.native
...
object CellMeasurerProps {
  ...
  implicit class CellMeasurerPropsOps[Self <: CellMeasurerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCache(value: CellMeasurerCacheInterface): Self = {
    ...
    @scala.inline
    def withChildrenFunction1(value: /* props */ CellMeasurerChildProps => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("children")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withChildren(value: (js.Function1[/* props */ CellMeasurerChildProps, TagMod[Any]]) | TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("children")(value.asInstanceOf[js.Any])
        ret
    }
