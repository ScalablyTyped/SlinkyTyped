...
/* key */ StringDictionary[js.Any] {
  ...
  var children: (js.Function1[/* props */ CellMeasurerChildProps, ReactElement]) | ReactElement = js.native
...
object CellMeasurerProps {
  ...
  implicit class CellMeasurerPropsOps[Self <: CellMeasurerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenFunction1(value: /* props */ CellMeasurerChildProps => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
    def setChildren(value: (js.Function1[/* props */ CellMeasurerChildProps, ReactElement]) | ReactElement): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
