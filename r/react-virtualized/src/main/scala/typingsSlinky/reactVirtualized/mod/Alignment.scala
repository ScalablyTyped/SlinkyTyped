...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactVirtualized.reactVirtualizedStrings.auto
  - typingsSlinky.reactVirtualized.reactVirtualizedStrings.end
  - typingsSlinky.reactVirtualized.reactVirtualizedStrings.start
  - typingsSlinky.reactVirtualized.reactVirtualizedStrings.center
*/
