...
object esMultiGridMod {
  ...
  object MultiGrid {
    ...
    @JSImport("react-virtualized/dist/es/MultiGrid", "MultiGrid.getDerivedStateFromProps")
    @js.native
  ...
  /* Inlined {  classNameBottomLeftGrid :string | undefined,   classNameBottomRightGrid :string | undefined,   classNameTopLeftGrid :string | undefined,   classNameTopRightGrid :string | undefined,   enableFixedColumnScroll :boolean | undefined,   enableFixedRowScroll :boolean | undefined,   fixedColumnCount :number | undefined,   fixedRowCount :number | undefined,   style :react.react.CSSProperties | undefined,   styleBottomLeftGrid :react.react.CSSProperties | undefined,   styleBottomRightGrid :react.react.CSSProperties | undefined,   styleTopLeftGrid :react.react.CSSProperties | undefined,   styleTopRightGrid :react.react.CSSProperties | undefined} & react-virtualized.react-virtualized/dist/es/Grid.GridProps */
  @js.native
