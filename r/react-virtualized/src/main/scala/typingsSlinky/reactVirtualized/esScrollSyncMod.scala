...
object esScrollSyncMod {
  ...
  /* key */ StringDictionary[js.Any] {
    ...
    /**
      ...
      */
    def children(props: ScrollSyncChildProps): ReactElement = js.native
  }
  object ScrollSyncProps {
    
    @scala.inline
    def apply(children: ScrollSyncChildProps => ReactElement): ScrollSyncProps = {
    ...
    implicit class ScrollSyncPropsMutableBuilder[Self <: ScrollSyncProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ScrollSyncChildProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
