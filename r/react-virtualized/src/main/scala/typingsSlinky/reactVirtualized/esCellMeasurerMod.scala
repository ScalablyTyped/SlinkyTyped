...
import typingsSlinky.reactVirtualized.anon.Index
...
object esCellMeasurerMod {
  ...
  object CellMeasurerProps {
    ...
    implicit class CellMeasurerPropsMutableBuilder[Self <: CellMeasurerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (js.Function1[/* props */ CellMeasurerChildProps, ReactElement]) | ReactElement): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* props */ CellMeasurerChildProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
