...
@js.native
trait AnonClassNameBottomRightGrid extends js.Object {
...
object AnonClassNameBottomRightGrid {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonClassNameBottomRightGrid]
  }
  @scala.inline
  implicit class AnonClassNameBottomRightGridOps[Self <: AnonClassNameBottomRightGrid] (val x: Self) extends AnyVal {
    @scala.inline
