...
trait AnonOnResize extends js.Object {
  var scrollElement: js.UndefOr[Window_] = js.native
...
object AnonOnResize {
  ...
  @scala.inline
  implicit class AnonOnResizeOps[Self <: AnonOnResize] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withScrollElement(value: Window_): Self = {
        val ret = this.duplicate
