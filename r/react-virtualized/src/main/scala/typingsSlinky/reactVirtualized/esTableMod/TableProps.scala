...
/* key */ StringDictionary[js.Any] {
  ...
  var noRowsRenderer: js.UndefOr[js.Function0[ReactElement | Null]] = js.native
...
object TableProps {
  ...
  implicit class TablePropsMutableBuilder[Self <: TableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNoRowsRenderer(value: () => ReactElement | Null): Self = StObject.set(x, "noRowsRenderer", js.Any.fromFunction0(value))
