...
object esListMod {
  ...
  object ListProps {
    ...
    implicit class ListPropsMutableBuilder[Self <: ListProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNoRowsRenderer(value: () => ReactElement): Self = StObject.set(x, "noRowsRenderer", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setRowRenderer(value: /* props */ ListRowProps => ReactElement): Self = StObject.set(x, "rowRenderer", js.Any.fromFunction1(value))
  ...
  type ListRowRenderer = js.Function1[/* props */ ListRowProps, ReactElement]
