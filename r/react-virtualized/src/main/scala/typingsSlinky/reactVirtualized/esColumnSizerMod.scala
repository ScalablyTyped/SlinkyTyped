...
object esColumnSizerMod {
  ...
  /* key */ StringDictionary[js.Any] {
    ...
    /**
      ...
      */
    def children(props: SizedColumnProps): ReactElement = js.native
  ...
  object ColumnSizerProps {
    ...
    @scala.inline
    def apply(children: SizedColumnProps => ReactElement, width: Double): ColumnSizerProps = {
    ...
    implicit class ColumnSizerPropsMutableBuilder[Self <: ColumnSizerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: SizedColumnProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
