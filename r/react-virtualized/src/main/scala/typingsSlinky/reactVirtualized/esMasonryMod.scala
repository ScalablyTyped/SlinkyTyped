...
import typingsSlinky.reactVirtualized.anon.Reset
...
object esMasonryMod {
  ...
  type CellRenderer = js.Function1[/* props */ MasonryCellProps, ReactElement]
  ...
  /* key */ StringDictionary[js.Any] {
    ...
    var keyMapper: js.UndefOr[typingsSlinky.reactVirtualized.esCellMeasurerMod.KeyMapper] = js.native
  ...
  object MasonryProps {
    ...
    implicit class MasonryPropsMutableBuilder[Self <: MasonryProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCellRenderer(value: /* props */ MasonryCellProps => ReactElement): Self = StObject.set(x, "cellRenderer", js.Any.fromFunction1(value))
