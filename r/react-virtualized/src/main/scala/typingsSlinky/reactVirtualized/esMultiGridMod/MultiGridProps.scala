...
object MultiGridProps {
  ...
  def apply(
    ...
    fixedColumnCount: js.UndefOr[Double] = js.undefined,
    fixedRowCount: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(enableFixedColumnScroll)) __obj.updateDynamic("enableFixedColumnScroll")(enableFixedColumnScroll.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableFixedRowScroll)) __obj.updateDynamic("enableFixedRowScroll")(enableFixedRowScroll.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(fixedColumnCount)) __obj.updateDynamic("fixedColumnCount")(fixedColumnCount.get.asInstanceOf[js.Any])
    if (!js.isUndefined(fixedRowCount)) __obj.updateDynamic("fixedRowCount")(fixedRowCount.get.asInstanceOf[js.Any])
