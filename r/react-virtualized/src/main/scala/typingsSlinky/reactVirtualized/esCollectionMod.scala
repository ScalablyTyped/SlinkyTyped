...
object esCollectionMod {
  ...
  type CollectionCellGroupRenderer = js.Function1[/* params */ CollectionCellGroupRendererParams, js.Array[ReactElement]]
  ...
  object CollectionCellGroupRendererParams {
    ...
    implicit class CollectionCellGroupRendererParamsMutableBuilder[Self <: CollectionCellGroupRendererParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCellRenderer(value: /* params */ CollectionCellRendererParams => ReactElement): Self = StObject.set(x, "cellRenderer", js.Any.fromFunction1(value))
  ...
  type CollectionCellRenderer = js.Function1[/* params */ CollectionCellRendererParams, ReactElement]
