...
trait AnonClassName extends js.Object {
  ...
  var rowClassName: Requireable[String | (js.Function1[/* params */ Index, String])] = js.native
  var rowCount: Validator[Double] = js.native
  var rowGetter: Validator[js.Function1[/* params */ Index, _]] = js.native
  var rowHeight: Validator[Double | (js.Function1[/* params */ Index, Double])] = js.native
  var rowRenderer: Requireable[js.Function1[/* props */ TableRowProps, TagMod[Any]]] = js.native
  var rowStyle: Validator[CSSProperties | (js.Function1[/* params */ Index, CSSProperties])] = js.native
  var scrollToAlignment: Validator[Alignment] = js.native
  var scrollToIndex: Validator[Double] = js.native
  var scrollTop: Requireable[Double] = js.native
  var sort: Requireable[js.Function1[/* params */ AnonSortBy, Unit]] = js.native
...
object AnonClassName {
  ...
  implicit class AnonClassNameOps[Self <: AnonClassName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRowClassName(value: Requireable[String | (js.Function1[/* params */ Index, String])]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRowGetter(value: Validator[js.Function1[/* params */ Index, _]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowGetter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRowHeight(value: Validator[Double | (js.Function1[/* params */ Index, Double])]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRowStyle(value: Validator[CSSProperties | (js.Function1[/* params */ Index, CSSProperties])]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowStyle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withScrollToAlignment(value: Validator[Alignment]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSort(value: Requireable[js.Function1[/* params */ AnonSortBy, Unit]]): Self = {
        val ret = this.duplicate
