...
object ClassName {
  ...
  implicit class ClassNameOps[Self <: ClassName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNoRowsRenderer(value: Requireable[js.Function0[ReactElement]]): Self = this.set("noRowsRenderer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRowGetter(value: Validator[js.Function1[/* params */ typingsSlinky.reactVirtualized.mod.Index, _]]): Self = this.set("rowGetter", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("rowHeight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowRenderer(value: Requireable[js.Function1[/* props */ TableRowProps, ReactElement]]): Self = this.set("rowRenderer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScrollToAlignment(value: Validator[typingsSlinky.reactVirtualized.mod.Alignment]): Self = this.set("scrollToAlignment", value.asInstanceOf[js.Any])
