...
trait ClassName extends StObject {
  ...
  var rowRenderer: Requireable[js.Function1[/* props */ TableRowProps, ReactElement]] = js.native
...
object ClassName {
  ...
  def apply(
    ...
    rowRenderer: Requireable[js.Function1[/* props */ TableRowProps, ReactElement]],
    rowStyle: Validator[
      CSSProperties | (js.Function1[/* params */ typingsSlinky.reactVirtualized.mod.Index, CSSProperties])
    ],
  ...
  implicit class ClassNameMutableBuilder[Self <: ClassName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNoRowsRenderer(value: Requireable[js.Function0[ReactElement]]): Self = StObject.set(x, "noRowsRenderer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRowGetter(value: Validator[js.Function1[/* params */ typingsSlinky.reactVirtualized.mod.Index, _]]): Self = StObject.set(x, "rowGetter", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "rowHeight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowRenderer(value: Requireable[js.Function1[/* props */ TableRowProps, ReactElement]]): Self = StObject.set(x, "rowRenderer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScrollToAlignment(value: Validator[typingsSlinky.reactVirtualized.mod.Alignment]): Self = StObject.set(x, "scrollToAlignment", value.asInstanceOf[js.Any])
