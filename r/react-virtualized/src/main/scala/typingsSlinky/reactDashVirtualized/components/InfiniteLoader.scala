...
import typingsSlinky.reactDashVirtualized.distEsInfiniteLoaderMod.InfiniteLoaderProps
...
object InfiniteLoader
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashVirtualized.distEsInfiniteLoaderMod.InfiniteLoader
    ] {
