...
import typingsSlinky.reactDashVirtualized.reactDashVirtualizedStrings.ASC
import typingsSlinky.reactDashVirtualized.reactDashVirtualizedStrings.DESC
...
trait SortDirectionStatic extends js.Object {
  /**
    ...
    */
  var ASC: typingsSlinky.reactDashVirtualized.reactDashVirtualizedStrings.ASC
  /**
    * Sort items in descending order.
    * This means arranging from the highest value to the lowest (e.g. z-a, 9-0).
    */
  var DESC: typingsSlinky.reactDashVirtualized.reactDashVirtualizedStrings.DESC
}
