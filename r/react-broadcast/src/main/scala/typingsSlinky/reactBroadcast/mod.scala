package typingsSlinky.reactBroadcast
...
object mod {
  ...
  class Subscriber[T] protected ()
    extends Component[typingsSlinky.reactBroadcast.mod.Subscriber.Props[T], js.Any, js.Any] {
    def this(props: typingsSlinky.reactBroadcast.mod.Subscriber.Props[T]) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: typingsSlinky.reactBroadcast.mod.Subscriber.Props[T], context: js.Any) = this()
  }
  object Subscriber {
    ...
    trait Props[T] extends StObject {
      ...
      var children: js.UndefOr[js.Function1[/* state */ T, ReactElement]] = js.native
    ...
    object Props {
      ...
      @scala.inline
      def apply[T](channel: String): typingsSlinky.reactBroadcast.mod.Subscriber.Props[T] = {
        val __obj = js.Dynamic.literal(channel = channel.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.reactBroadcast.mod.Subscriber.Props[T]]
      }
      
      @scala.inline
      implicit class PropsMutableBuilder[Self <: typingsSlinky.reactBroadcast.mod.Subscriber.Props[_], T] (val x: Self with typingsSlinky.reactBroadcast.mod.Subscriber.Props[T]) extends AnyVal {
        
        @scala.inline
        def setChannel(value: String): Self = StObject.set(x, "channel", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setChildren(value: /* state */ T => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
