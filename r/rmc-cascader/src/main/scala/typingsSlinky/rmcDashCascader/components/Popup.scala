...
import typingsSlinky.rmcDashCascader.libPopupMod.IPopupCascaderProps
import typingsSlinky.rmcDashCascader.libPopupMod.default
...
object Popup
  ...
  type Props = IPopupCascaderProps
}
