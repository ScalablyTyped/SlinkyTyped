package typingsSlinky.reactMdTree.anon
...
import typingsSlinky.reactMdTree.useNestedTreeListMod.NestedTreeItem
...
object NestedTreeItemUnknownTree {
  ...
  @scala.inline
  implicit class NestedTreeItemUnknownTreeOps[Self <: NestedTreeItemUnknownTree] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setChildItemsVarargs(value: NestedTreeItem[UnknownTreeItem]*): Self = this.set("childItems", js.Array(value :_*))
    @scala.inline
    def setChildItems(value: js.Array[NestedTreeItem[UnknownTreeItem]]): Self = this.set("childItems", value.asInstanceOf[js.Any])
    @scala.inline
