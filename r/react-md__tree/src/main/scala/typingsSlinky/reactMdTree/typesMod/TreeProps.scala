...
trait TreeProps[T /* <: BaseTreeItem */]
  ...
  /**
    ...
    */
  var getItemLabel: js.UndefOr[js.Function2[/* item */ T, /* labelKey */ String, ReactElement]] = js.native
  /**
    * @see GetItemProps
    */
...
object TreeProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactMdTree.typesMod.BaseTreeItem */ T](
    data: TreeData[T],
  ...
  @scala.inline
  implicit class TreePropsOps[Self <: TreeProps[_], /* <: typingsSlinky.reactMdTree.typesMod.BaseTreeItem */ T] (val x: Self with TreeProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setGetItemLabel(value: (/* item */ T, /* labelKey */ String) => ReactElement): Self = this.set("getItemLabel", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setLinkComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("linkComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setLinkComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("linkComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setLinkComponent(value: ReactElement): Self = this.set("linkComponent", value.asInstanceOf[js.Any])
    @scala.inline
