...
object anon {
  ...
  object BaseTreeItemvisibleIndexn {
    ...
    @scala.inline
    implicit class BaseTreeItemvisibleIndexnMutableBuilder[Self <: BaseTreeItemvisibleIndexn] (val x: Self) extends AnyVal {
  ...
  object ChildItems {
    ...
    @scala.inline
    implicit class ChildItemsMutableBuilder[Self <: ChildItems] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "childItems", value.asInstanceOf[js.Any])
      ...
      ): Self = StObject.set(x, "childItems", js.Array(value :_*))
    }
  }
  ...
  object NestedTreeItemUnknownTree {
    ...
    @scala.inline
    implicit class NestedTreeItemUnknownTreeMutableBuilder[Self <: NestedTreeItemUnknownTree] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setChildItems(value: js.Array[NestedTreeItem[UnknownTreeItem]]): Self = StObject.set(x, "childItems", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildItemsUndefined: Self = StObject.set(x, "childItems", js.undefined)
      
      @scala.inline
      def setChildItemsVarargs(value: NestedTreeItem[UnknownTreeItem]*): Self = StObject.set(x, "childItems", js.Array(value :_*))
  ...
  object PickTreeGroupPropshiddenc {
    ...
    @scala.inline
    implicit class PickTreeGroupPropshiddencMutableBuilder[Self <: PickTreeGroupPropshiddenc] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: SyntheticEvent[EventTarget with ListElement, Event] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRef(value: Ref[ListElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* instance */ ListElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRefNull: Self = StObject.set(x, "ref", null)
      
      @scala.inline
      def setRefRefObject(value: ReactRef[ListElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
  ...
  object RequiredTreeItemSelection {
    ...
    @scala.inline
    implicit class RequiredTreeItemSelectionMutableBuilder[Self <: RequiredTreeItemSelection] (val x: Self) extends AnyVal {
  ...
  object VisibleIndex {
    ...
    @scala.inline
    implicit class VisibleIndexMutableBuilder[Self <: VisibleIndex] (val x: Self) extends AnyVal {
