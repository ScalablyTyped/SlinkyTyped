...
object typesMod {
  ...
  object ConfigurableTreeItemProps {
    ...
    implicit class ConfigurableTreeItemPropsMutableBuilder[Self <: ConfigurableTreeItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContentComponent(value: ReactElement): Self = StObject.set(x, "contentComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setContentComponentComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "contentComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setContentComponentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "contentComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLiRefRefObject(value: ReactRef[HTMLLIElement]): Self = StObject.set(x, "liRef", value.asInstanceOf[js.Any])
  ...
  object ProvidedTreeItemProps {
    ...
    implicit class ProvidedTreeItemPropsMutableBuilder[Self <: ProvidedTreeItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderChildItems(value: () => ReactElement): Self = StObject.set(x, "renderChildItems", js.Any.fromFunction0(value))
  ...
  trait ProvidedTreeProps extends StObject {
    ...
    var expanderIcon: ReactElement = js.native
    
    var expanderLeft: Boolean = js.native
    
    var getItemLabel: js.Function2[/* item */ UnknownTreeItem, /* labelKey */ String, ReactElement] = js.native
  ...
  object ProvidedTreeProps {
    ...
    def apply(
      ...
      getItemLabel: (/* item */ UnknownTreeItem, /* labelKey */ String) => ReactElement,
    ...
    implicit class ProvidedTreePropsMutableBuilder[Self <: ProvidedTreeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetItemLabel(value: (/* item */ UnknownTreeItem, /* labelKey */ String) => ReactElement): Self = StObject.set(x, "getItemLabel", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setLinkComponentComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "linkComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLinkComponentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "linkComponent", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object TreeProps {
    ...
    implicit class TreePropsMutableBuilder[Self <: TreeProps[_], T /* <: BaseTreeItem */] (val x: Self with TreeProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setGetItemLabel(value: (/* item */ T, /* labelKey */ String) => ReactElement): Self = StObject.set(x, "getItemLabel", js.Any.fromFunction2(value))
