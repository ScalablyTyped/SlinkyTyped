...
object mod {
  ...
  class Client () extends EventEmitter {
    ...
    def captureException(error: js.Error, options: js.UndefOr[scala.Nothing], cb: CaptureCallback): String = js.native
  ...
  @js.native
  def captureException(e: js.Error): String = js.native
  @JSImport("raven", "captureException")
  @js.native
  def captureException(e: js.Error, cb: CaptureCallback): String = js.native
  @JSImport("raven", "captureException")
  @js.native
  def captureException(e: js.Error, options: js.UndefOr[scala.Nothing], cb: CaptureCallback): String = js.native
  @JSImport("raven", "captureException")
  @js.native
  def captureException(e: js.Error, options: CaptureOptions): String = js.native
  @JSImport("raven", "captureException")
  @js.native
  def captureException(e: js.Error, options: CaptureOptions, cb: CaptureCallback): String = js.native
