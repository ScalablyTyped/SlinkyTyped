...
trait PaginationProps extends js.Object {
  ...
  /**
    ...
    */
  var dotElement: js.UndefOr[ReactElement] = js.native
  ...
  /**
    ...
    */
  var inactiveDotElement: js.UndefOr[ReactElement] = js.native
  ...
  var renderDots: js.UndefOr[
    js.Function3[/* activeIndex */ Double, /* total */ Double, /* context */ js.Any, ReactElement]
  ] = js.native
...
object PaginationProps {
  ...
  implicit class PaginationPropsOps[Self <: PaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCarouselRef(value: ReactComponentClass[FlatListProps[_]]): Self = this.set("carouselRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDotElementReactElement(value: ReactElement): Self = this.set("dotElement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDotElement(value: ReactElement): Self = this.set("dotElement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInactiveDotElementReactElement(value: ReactElement): Self = this.set("inactiveDotElement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInactiveDotElement(value: ReactElement): Self = this.set("inactiveDotElement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderDots(value: (/* activeIndex */ Double, /* total */ Double, /* context */ js.Any) => ReactElement): Self = this.set("renderDots", js.Any.fromFunction3(value))
