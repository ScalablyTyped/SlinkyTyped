...
object ParallaxImage {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeSnapCarousel.mod.ParallaxImage] {
    @scala.inline
    ...
    @scala.inline
    def parallaxFactor(value: Double): this.type = set("parallaxFactor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def scrollPosition(value: Value): this.type = set("scrollPosition", value.asInstanceOf[js.Any])
    @scala.inline
    def showSpinner(value: Boolean): this.type = set("showSpinner", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def apply(source: ImageSourcePropType): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ParallaxImageProperties]))
  }
}
