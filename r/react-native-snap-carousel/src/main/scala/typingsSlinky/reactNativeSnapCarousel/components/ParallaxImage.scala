...
object ParallaxImage
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.reactNativeSnapCarousel.mod.ParallaxImage] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.reactNativeSnapCarousel.mod.ParallaxImage] = {
