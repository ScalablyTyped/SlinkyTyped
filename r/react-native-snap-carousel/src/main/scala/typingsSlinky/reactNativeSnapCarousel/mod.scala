...
object mod {
  ...
  object AdditionalParallaxProps {
    ...
    implicit class AdditionalParallaxPropsMutableBuilder[Self <: AdditionalParallaxProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCarouselRef(value: ReactComponentClass[FlatListProps[_]]): Self = StObject.set(x, "carouselRef", value.asInstanceOf[js.Any])
  ...
  object PaginationProps {
    ...
    implicit class PaginationPropsMutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDotElement(value: ReactElement): Self = StObject.set(x, "dotElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDotElementReactElement(value: ReactElement): Self = StObject.set(x, "dotElement", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInactiveDotElement(value: ReactElement): Self = StObject.set(x, "inactiveDotElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInactiveDotElementReactElement(value: ReactElement): Self = StObject.set(x, "inactiveDotElement", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRenderDots(value: (/* activeIndex */ Double, /* total */ Double, /* context */ js.Any) => ReactElement): Self = StObject.set(x, "renderDots", js.Any.fromFunction3(value))
