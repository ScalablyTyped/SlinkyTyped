package typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselMod
...
import typingsSlinky.reactDashNativeDashSnapDashCarousel.Anon_Index
import typingsSlinky.reactDashNativeDashSnapDashCarousel.Anon_InputRange
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.center
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.decay
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.end
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.spring
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.stack
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.start
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.timing
import typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.tinder
...
trait CarouselProps[T] extends Props[ScrollViewProps] {
  ...
  var layout: js.UndefOr[
    typingsSlinky.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.default | stack | tinder
  ] = js.native
  /**
  ...
  var scrollInterpolator: js.UndefOr[
    js.Function2[/* index */ Double, /* carouselProps */ CarouselProps[_], Anon_InputRange]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  def renderItem(item: Anon_Index[T]): TagMod[Any] = js.native
  def renderItem(item: Anon_Index[T], parallaxProps: AdditionalParallaxProps): TagMod[Any] = js.native
}
