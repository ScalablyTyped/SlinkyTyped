...
package object mod {
  ...
  /**
    ...
    */
  type ExtendScriptFunction = typingsSlinky.redlock.mod.LockScriptFunction
  /**
    * Function that returns the LUA script to run on the
  ...
  /**
    ...
    */
  type UnlockScriptFunction = typingsSlinky.redlock.mod.LockScriptFunction
}
