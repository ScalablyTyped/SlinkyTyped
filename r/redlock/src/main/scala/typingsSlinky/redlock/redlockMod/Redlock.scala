...
import typingsSlinky.redlock.redlockStrings.clientError
...
trait Redlock extends EventEmitter {
  ...
  /**
    ...
    */
  def acquire(resource: String, ttl: Double): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def acquire(resource: String, ttl: Double, callback: Callback[Lock]): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def acquire(resource: js.Array[String], ttl: Double): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def acquire(resource: js.Array[String], ttl: Double, callback: Callback[Lock]): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  /*
  ...
  /**
    ...
    */
  def extend(lock: Lock, ttl: Double): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def extend(lock: Lock, ttl: Double, callback: Callback[Lock]): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  /**
    * This method locks a resource using the redlock algorithm.
    *
    * ```js
    ...
    * @param ttl - how long to keep the lock (milliseconds)
    */
  def lock(resource: String, ttl: Double): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def lock(resource: String, ttl: Double, callback: Callback[Lock]): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def lock(resource: js.Array[String], ttl: Double): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def lock(resource: js.Array[String], ttl: Double, callback: Callback[Lock]): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  /**
    * Subscribe to `clientError` events.
  ...
  /**
    ...
    */
  def quit(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  def quit(callback: Callback[Unit]): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  def release(lock: Lock): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  def release(lock: Lock, callback: Callback[Unit]): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  /**
    ...
    * @param callback - be notified once lock has been released by the clients
    */
  def unlock(lock: Lock): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  def unlock(lock: Lock, callback: Callback[Unit]): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
}
