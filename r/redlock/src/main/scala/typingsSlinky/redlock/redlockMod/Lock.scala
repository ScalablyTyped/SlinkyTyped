...
class Lock protected () extends js.Object {
  ...
  def extend(ttl: Double): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def extend(ttl: Double, callback: Callback[Lock]): typingsSlinky.bluebird.bluebirdMod.^[Lock] = js.native
  def unlock(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  def unlock(callback: Callback[Unit]): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
}
