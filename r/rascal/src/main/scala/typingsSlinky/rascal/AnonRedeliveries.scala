...
trait AnonRedeliveries extends js.Object {
  ...
  var vhosts: AnonConnection = js.native
}
...
object AnonRedeliveries {
  ...
  @scala.inline
  implicit class AnonRedeliveriesOps[Self <: AnonRedeliveries] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withVhosts(value: AnonConnection): Self = {
        val ret = this.duplicate
