...
object SQIPErrorCodes extends StObject {
  ...
  /* "canceled" */ val CANCELED: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.CANCELED with String = js.native
  ...
  /* "failed" */ val FAILED: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.FAILED with String = js.native
  ...
  /* "noNetwork" */ val NO_NETWORK: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.NO_NETWORK with String = js.native
  ...
  /* "unsupportedSDKVersion" */ val UNSUPPORTED_SDK_VERSION: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.UNSUPPORTED_SDK_VERSION with String = js.native
  ...
  /* "usageError" */ val USAGE_ERROR: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.USAGE_ERROR with String = js.native
}
