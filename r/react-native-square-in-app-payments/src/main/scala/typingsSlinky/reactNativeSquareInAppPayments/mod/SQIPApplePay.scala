...
object SQIPApplePay {
  ...
  object ApplePayPaymentType extends StObject {
    ...
    /* 2 */ val PaymentTypeFinal: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPApplePay.ApplePayPaymentType.PaymentTypeFinal with Double = js.native
    
    /** A summary item representing an estimated or unknown cost. */
    @js.native
    sealed trait PaymentTypePending extends ApplePayPaymentType
    /* 1 */ val PaymentTypePending: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPApplePay.ApplePayPaymentType.PaymentTypePending with Double = js.native
  }
