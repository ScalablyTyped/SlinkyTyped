...
import typingsSlinky.reactNativeSquareInAppPayments.mod.Card
...
@js.native
trait BuyerVerificationDetails extends js.Object {
...
object BuyerVerificationDetails {
  ...
  @scala.inline
  implicit class BuyerVerificationDetailsOps[Self <: BuyerVerificationDetails] (val x: Self) extends AnyVal {
