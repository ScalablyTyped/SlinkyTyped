...
package object SQIPCardEntry {
  ...
  type BuyerVerificationSuccessCallback = js.Function1[
    /* buyerVerificationDetails */ typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPCardEntry.BuyerVerificationDetails, 
    scala.Unit
  ]
  ...
  type CardEntryNonceRequestSuccessCallback = js.Function1[
    /* cardDetails */ typingsSlinky.reactNativeSquareInAppPayments.mod.CardDetails, 
    scala.Unit
  ]
  
  type KeyboardAppearance = typingsSlinky.reactNativeSquareInAppPayments.reactNativeSquareInAppPaymentsStrings.Light | java.lang.String
}
