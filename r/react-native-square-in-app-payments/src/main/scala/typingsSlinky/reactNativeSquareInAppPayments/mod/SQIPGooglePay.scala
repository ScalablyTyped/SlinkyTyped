...
object SQIPGooglePay {
  ...
  object GooglePayEnvironment extends StObject {
    ...
    /* 1 */ val EnvironmentProduction: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayEnvironment.EnvironmentProduction with Double = js.native
    ...
    /* 3 */ val EnvironmentTest: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayEnvironment.EnvironmentTest with Double = js.native
  }
  ...
  object GooglePayPriceStatus extends StObject {
    ...
    /* 2 */ val TotalPriceStatusEstimated: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayPriceStatus.TotalPriceStatusEstimated with Double = js.native
    ...
    /* 3 */ val TotalPriceStatusFinal: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayPriceStatus.TotalPriceStatusFinal with Double = js.native
    
    /** used for a capability check */
    @js.native
    sealed trait TotalPriceStatusNotCurrentlyKnown extends GooglePayPriceStatus
    /* 1 */ val TotalPriceStatusNotCurrentlyKnown: typingsSlinky.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayPriceStatus.TotalPriceStatusNotCurrentlyKnown with Double = js.native
  }
