package typingsSlinky.reactDashTextDashMask.reactDashTextDashMaskMod

import typingsSlinky.reactDashTextDashMask.Anon_SomeCharsRejected
...
trait conformToMaskResult extends js.Object {
  ...
  var meta: Anon_SomeCharsRejected
}
