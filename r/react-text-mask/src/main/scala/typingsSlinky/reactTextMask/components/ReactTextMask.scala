package typingsSlinky.reactTextMask.components
...
import typingsSlinky.reactTextMask.mod.MaskedInputProps
...
object ReactTextMask {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def guide(value: Boolean): this.type = set("guide", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def keepCharPositions(value: Boolean): this.type = set("keepCharPositions", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def render(value: (/* ref */ js.Function1[/* inputElement */ HTMLElement, Unit], /* props */ js.Any) => _): this.type = set("render", js.Any.fromFunction2(value))
    @scala.inline
