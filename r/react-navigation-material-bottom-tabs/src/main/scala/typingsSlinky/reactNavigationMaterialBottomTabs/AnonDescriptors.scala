...
trait AnonDescriptors extends js.Object {
  ...
  def renderIcon(options: AnonTintColor): TagMod[Any] = js.native
}
...
object AnonDescriptors {
  ...
  @scala.inline
  implicit class AnonDescriptorsOps[Self <: AnonDescriptors] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRenderIcon(value: AnonTintColor => TagMod[Any]): Self = {
        val ret = this.duplicate
