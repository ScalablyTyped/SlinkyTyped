...
trait NavigationMaterialBottomTabOptions extends js.Object {
  ...
  var tabBarIcon: js.UndefOr[TagMod[Any] | (js.Function1[/* props */ AnonFocused, TagMod[Any]])] = js.undefined
  var tabBarLabel: js.UndefOr[TagMod[Any]] = js.undefined
...
object NavigationMaterialBottomTabOptions {
  ...
  def apply(
    ...
    tabBarIcon: TagMod[Any] | (js.Function1[/* props */ AnonFocused, TagMod[Any]]) = null,
    tabBarLabel: TagMod[Any] = null,
    tabBarOnPress: /* props */ AnonDefaultHandler => Unit = null,
