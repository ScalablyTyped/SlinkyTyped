...
trait NavigationMaterialBottomTabOptions extends js.Object {
  ...
  var tabBarIcon: js.UndefOr[TagMod[Any] | (js.Function1[/* props */ Focused, TagMod[Any]])] = js.undefined
...
object NavigationMaterialBottomTabOptions {
  ...
  def apply(
    ...
    tabBarIcon: TagMod[Any] | (js.Function1[/* props */ Focused, TagMod[Any]]) = null,
