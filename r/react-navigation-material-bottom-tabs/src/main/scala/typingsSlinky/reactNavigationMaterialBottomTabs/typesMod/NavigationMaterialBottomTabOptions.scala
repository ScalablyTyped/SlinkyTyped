...
trait NavigationMaterialBottomTabOptions extends js.Object {
  ...
  var tabBarIcon: js.UndefOr[ReactElement | (js.Function1[/* props */ Focused, ReactElement])] = js.native
  var tabBarLabel: js.UndefOr[ReactElement] = js.native
...
object NavigationMaterialBottomTabOptions {
  ...
  implicit class NavigationMaterialBottomTabOptionsOps[Self <: NavigationMaterialBottomTabOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTabBarIconReactElement(value: ReactElement): Self = this.set("tabBarIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def setTabBarIconFunction1(value: /* props */ Focused => ReactElement): Self = this.set("tabBarIcon", js.Any.fromFunction1(value))
    @scala.inline
    def setTabBarIcon(value: ReactElement | (js.Function1[/* props */ Focused, ReactElement])): Self = this.set("tabBarIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTabBarIcon: Self = this.set("tabBarIcon", js.undefined)
    @scala.inline
    def setTabBarLabelReactElement(value: ReactElement): Self = this.set("tabBarLabel", value.asInstanceOf[js.Any])
    @scala.inline
    def setTabBarLabel(value: ReactElement): Self = this.set("tabBarLabel", value.asInstanceOf[js.Any])
    @scala.inline
