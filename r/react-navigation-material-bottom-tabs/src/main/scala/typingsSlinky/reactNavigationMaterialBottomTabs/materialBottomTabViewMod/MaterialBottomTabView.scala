...
import typingsSlinky.reactNavigationMaterialBottomTabs.AnonColor
import typingsSlinky.reactNavigationMaterialBottomTabs.AnonRouteAnonKey
...
trait MaterialBottomTabView
  ...
  def _renderIcon(hasRouteFocusedColor: AnonColor): TagMod[Any] = js.native
}
