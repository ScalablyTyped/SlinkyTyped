package typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.components
...
import typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.Anon_FocusedRoute
import typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.libTypescriptSrcViewsMaterialBottomTabViewMod.Options
import typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.libTypescriptSrcViewsMaterialBottomTabViewMod.default
...
object MaterialBottomTabView
  ...
  def apply(
    ...
    renderIcon: Anon_FocusedRoute => TagMod[Any],
  ...
  type Props = typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.libTypescriptSrcViewsMaterialBottomTabViewMod.Props
}
