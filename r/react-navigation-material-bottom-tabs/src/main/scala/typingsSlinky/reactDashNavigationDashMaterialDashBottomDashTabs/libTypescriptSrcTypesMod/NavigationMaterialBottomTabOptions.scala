...
import typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.Anon_DefaultHandler
import typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.Anon_Focused
...
trait NavigationMaterialBottomTabOptions extends js.Object {
  ...
  var tabBarIcon: js.UndefOr[TagMod[Any] | (js.Function1[/* props */ Anon_Focused, TagMod[Any]])] = js.undefined
...
object NavigationMaterialBottomTabOptions {
  ...
  def apply(
    ...
    tabBarIcon: TagMod[Any] | (js.Function1[/* props */ Anon_Focused, TagMod[Any]]) = null,
