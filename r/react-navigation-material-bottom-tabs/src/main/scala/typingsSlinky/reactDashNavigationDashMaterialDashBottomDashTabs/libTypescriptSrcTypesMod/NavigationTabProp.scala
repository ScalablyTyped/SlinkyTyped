package typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.libTypescriptSrcTypesMod
...
import typingsSlinky.reactDashNavigationDashMaterialDashBottomDashTabs.reactDashNavigationDashMaterialDashBottomDashTabsStrings.refocus
