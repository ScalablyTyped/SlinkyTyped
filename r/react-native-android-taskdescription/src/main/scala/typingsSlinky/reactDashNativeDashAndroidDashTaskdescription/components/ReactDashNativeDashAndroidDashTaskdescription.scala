...
object ReactDashNativeDashAndroidDashTaskdescription
  ...
  typingsSlinky.reactDashNativeDashAndroidDashTaskdescription.reactDashNativeDashAndroidDashTaskdescriptionMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
