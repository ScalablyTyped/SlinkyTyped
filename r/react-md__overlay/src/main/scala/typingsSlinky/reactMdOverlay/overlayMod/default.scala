...
/**
  ...
  */
@JSImport("@react-md/overlay/types/Overlay", JSImport.Default)
@js.native
object default extends TopLevel[ForwardRefExoticComponent[OverlayProps with RefAttributes[HTMLDivElement]]]
