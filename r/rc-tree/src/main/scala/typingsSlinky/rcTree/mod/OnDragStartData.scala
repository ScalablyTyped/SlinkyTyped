...
object OnDragStartData {
  @scala.inline
  def apply(event: Event_, node: ReactComponentClass[InternalTreeNodeProps]): OnDragStartData = {
    val __obj = js.Dynamic.literal(event = event.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any])
    __obj.asInstanceOf[OnDragStartData]
  }
  @scala.inline
  implicit class OnDragStartDataOps[Self <: OnDragStartData] (val x: Self) extends AnyVal {
    @scala.inline
