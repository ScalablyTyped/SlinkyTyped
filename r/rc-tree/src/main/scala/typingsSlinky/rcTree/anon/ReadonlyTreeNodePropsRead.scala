...
trait ReadonlyTreeNodePropsRead extends js.Object {
  ...
  val checkable: js.UndefOr[Boolean] = js.undefined
  val checked: js.UndefOr[Boolean] = js.undefined
  val children: js.UndefOr[ReactElement] = js.undefined
  val className: js.UndefOr[String] = js.undefined
  val data: js.UndefOr[DataNode] = js.undefined
  val disableCheckbox: js.UndefOr[Boolean] = js.undefined
  val disabled: js.UndefOr[Boolean] = js.undefined
  val domRef: js.UndefOr[Ref[HTMLDivElement]] = js.undefined
  val dragOver: js.UndefOr[Boolean] = js.undefined
  val dragOverGapBottom: js.UndefOr[Boolean] = js.undefined
  val dragOverGapTop: js.UndefOr[Boolean] = js.undefined
  val eventKey: js.UndefOr[typingsSlinky.rcTree.interfaceMod.Key] = js.undefined
  val expanded: js.UndefOr[Boolean] = js.undefined
  val halfChecked: js.UndefOr[Boolean] = js.undefined
  val icon: js.UndefOr[IconType] = js.undefined
  val isEnd: js.UndefOr[js.Array[Boolean]] = js.undefined
  val isLeaf: js.UndefOr[Boolean] = js.undefined
  val isStart: js.UndefOr[js.Array[Boolean]] = js.undefined
  val loaded: js.UndefOr[Boolean] = js.undefined
  val loading: js.UndefOr[Boolean] = js.undefined
  val onMouseMove: js.UndefOr[MouseEventHandler[HTMLDivElement]] = js.undefined
  val pos: js.UndefOr[String] = js.undefined
  val prefixCls: js.UndefOr[String] = js.undefined
  val selectable: js.UndefOr[Boolean] = js.undefined
  val selected: js.UndefOr[Boolean] = js.undefined
  val style: js.UndefOr[CSSProperties] = js.undefined
  val switcherIcon: js.UndefOr[IconType] = js.undefined
  val title: js.UndefOr[ReactElement | (js.Function1[/* data */ DataNode, ReactElement])] = js.undefined
}

object ReadonlyTreeNodePropsRead {
  @scala.inline
  def apply(): ReadonlyTreeNodePropsRead = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReadonlyTreeNodePropsRead]
  }
  @scala.inline
