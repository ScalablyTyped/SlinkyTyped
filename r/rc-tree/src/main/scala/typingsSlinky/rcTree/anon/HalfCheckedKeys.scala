...
import typingsSlinky.rcTree.rcTreeBooleans.`false`
...
trait HalfCheckedKeys extends StObject {
  ...
  var halfCheckedKeys: js.Array[typingsSlinky.rcTree.interfaceMod.Key] = js.native
}
object HalfCheckedKeys {
  
  @scala.inline
  def apply(checked: `false`, halfCheckedKeys: js.Array[typingsSlinky.rcTree.interfaceMod.Key]): HalfCheckedKeys = {
