...
object nodeListMod extends Shortcut {
  ...
  object NodeListRef {
    ...
    @scala.inline
    def apply(scrollTo: /* scroll */ typingsSlinky.rcTree.anon.Key => Unit): NodeListRef = {
    ...
    implicit class NodeListRefMutableBuilder[Self <: NodeListRef] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScrollTo(value: /* scroll */ typingsSlinky.rcTree.anon.Key => Unit): Self = StObject.set(x, "scrollTo", js.Any.fromFunction1(value))
    }
  }
