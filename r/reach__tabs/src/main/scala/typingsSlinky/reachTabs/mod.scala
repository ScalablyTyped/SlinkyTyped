package typingsSlinky.reachTabs
...
import typingsSlinky.reachTabs.reachTabsStrings.`additions removals`
import typingsSlinky.reachTabs.reachTabsStrings.`additions text`
import typingsSlinky.reachTabs.reachTabsStrings.`inline`
import typingsSlinky.reachTabs.reachTabsStrings.`removals additions`
import typingsSlinky.reachTabs.reachTabsStrings.`removals text`
import typingsSlinky.reachTabs.reachTabsStrings.`text additions`
import typingsSlinky.reachTabs.reachTabsStrings.`text removals`
import typingsSlinky.reachTabs.reachTabsStrings.additions
import typingsSlinky.reachTabs.reachTabsStrings.all
import typingsSlinky.reachTabs.reachTabsStrings.ascending
import typingsSlinky.reachTabs.reachTabsStrings.assertive
import typingsSlinky.reachTabs.reachTabsStrings.both
import typingsSlinky.reachTabs.reachTabsStrings.copy
import typingsSlinky.reachTabs.reachTabsStrings.date
import typingsSlinky.reachTabs.reachTabsStrings.decimal
import typingsSlinky.reachTabs.reachTabsStrings.descending
import typingsSlinky.reachTabs.reachTabsStrings.dialog
import typingsSlinky.reachTabs.reachTabsStrings.email
import typingsSlinky.reachTabs.reachTabsStrings.execute
import typingsSlinky.reachTabs.reachTabsStrings.grammar
import typingsSlinky.reachTabs.reachTabsStrings.grid
import typingsSlinky.reachTabs.reachTabsStrings.horizontal
import typingsSlinky.reachTabs.reachTabsStrings.inherit
import typingsSlinky.reachTabs.reachTabsStrings.link
import typingsSlinky.reachTabs.reachTabsStrings.list
import typingsSlinky.reachTabs.reachTabsStrings.listbox
import typingsSlinky.reachTabs.reachTabsStrings.location
import typingsSlinky.reachTabs.reachTabsStrings.menu
import typingsSlinky.reachTabs.reachTabsStrings.mixed
import typingsSlinky.reachTabs.reachTabsStrings.move
import typingsSlinky.reachTabs.reachTabsStrings.no
import typingsSlinky.reachTabs.reachTabsStrings.none
import typingsSlinky.reachTabs.reachTabsStrings.numeric
import typingsSlinky.reachTabs.reachTabsStrings.off
import typingsSlinky.reachTabs.reachTabsStrings.on
import typingsSlinky.reachTabs.reachTabsStrings.other
import typingsSlinky.reachTabs.reachTabsStrings.page
import typingsSlinky.reachTabs.reachTabsStrings.polite
import typingsSlinky.reachTabs.reachTabsStrings.popup
import typingsSlinky.reachTabs.reachTabsStrings.removals
import typingsSlinky.reachTabs.reachTabsStrings.search
import typingsSlinky.reachTabs.reachTabsStrings.spelling
import typingsSlinky.reachTabs.reachTabsStrings.step
import typingsSlinky.reachTabs.reachTabsStrings.tel
import typingsSlinky.reachTabs.reachTabsStrings.text
import typingsSlinky.reachTabs.reachTabsStrings.time
import typingsSlinky.reachTabs.reachTabsStrings.tree
import typingsSlinky.reachTabs.reachTabsStrings.url
import typingsSlinky.reachTabs.reachTabsStrings.vertical
import typingsSlinky.reachTabs.reachTabsStrings.yes
...
object mod {
  ...
  @js.native
  val Tab: ReactComponentClass[TabProps] = js.native
  
  @JSImport("@reach/tabs", "TabList")
  @js.native
  val TabList: ReactComponentClass[TabContainerProps] = js.native
  ...
  @js.native
  val TabPanels: ReactComponentClass[TabContainerProps] = js.native
  ...
  trait TabsProps extends StObject {
    ...
    var onChange: js.UndefOr[js.Function1[/* index */ Double, Unit]] = js.native
  ...
  object TabsProps {
    ...
    implicit class TabsPropsMutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: /* index */ Double => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
