...
import typingsSlinky.atReachTabs.atReachTabsMod.TabContainerProps
...
abstract class SharedApply_TabContainerProps615347519 (implicit pw: ExternalPropsWriterProvider)
