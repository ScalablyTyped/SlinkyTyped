package typingsSlinky.rcCollapse.interfaceMod
...
object CollapsePanelProps {
  ...
  implicit class CollapsePanelPropsOps[Self <: CollapsePanelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpandIcon(value: /* props */ js.Object => ReactElement): Self = this.set("expandIcon", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setExtra(value: String | ReactElement): Self = this.set("extra", value.asInstanceOf[js.Any])
