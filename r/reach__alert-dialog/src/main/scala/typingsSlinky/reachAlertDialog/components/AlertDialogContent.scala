...
import typingsSlinky.reachAlertDialog.mod.AlertDialogContentProps
...
object AlertDialogContent {
  ...
  def withProps(p: AlertDialogContentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
