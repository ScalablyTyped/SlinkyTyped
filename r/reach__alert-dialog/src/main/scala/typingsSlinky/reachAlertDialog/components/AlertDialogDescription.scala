...
object AlertDialogDescription {
  ...
  implicit def make(companion: AlertDialogDescription.type): SharedBuilder_HTMLProps74936298[LegacyRef[js.Any]] = new SharedBuilder_HTMLProps74936298[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
