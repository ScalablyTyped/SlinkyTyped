package typingsSlinky.reachAlertDialog
...
object mod {
  ...
  /* Inlined {  children :react.react.ReactNode} & @reach/dialog.@reach/dialog.DialogContentProps */
  @js.native
  trait AlertDialogContentProps extends StObject {
  ...
  @js.native
  trait AlertDialogProps extends StObject {
  ...
  object AlertDialogProps {
    ...
    implicit class AlertDialogPropsMutableBuilder[Self <: AlertDialogProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLeastDestructiveRef(value: ReactRef[HTMLElement]): Self = StObject.set(x, "leastDestructiveRef", value.asInstanceOf[js.Any])
