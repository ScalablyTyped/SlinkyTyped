...
/* Inlined {  isOpen ? :boolean, onDismiss ? (): void,   leastDestructiveRef  :react.react.RefObject<std.HTMLElement>,   children  :react.react.ReactNode} & @reach/dialog.@reach/dialog.DialogProps */
@js.native
...
object AlertDialogProps {
  ...
  implicit class AlertDialogPropsOps[Self <: AlertDialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLeastDestructiveRef(value: ReactRef[HTMLElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("leastDestructiveRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
