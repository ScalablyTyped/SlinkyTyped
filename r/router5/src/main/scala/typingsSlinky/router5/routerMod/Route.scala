...
object Route {
  @scala.inline
  def apply[/* <: typingsSlinky.router5.routerMod.DefaultDependencies */ Dependencies](name: String, path: String): Route[Dependencies] = {
  ...
  @scala.inline
  implicit class RouteOps[Self <: Route[_], /* <: typingsSlinky.router5.routerMod.DefaultDependencies */ Dependencies] (val x: Self with Route[Dependencies]) extends AnyVal {
    @scala.inline
