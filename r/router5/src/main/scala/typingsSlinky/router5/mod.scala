...
object mod extends js.Object {
  ...
  def createRouter[Dependencies /* <: Record[String, _] */](routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]]): Router[Dependencies] = js.native
  def createRouter[Dependencies /* <: Record[String, _] */](
    routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]],
    options: js.UndefOr[scala.Nothing],
    dependencies: Dependencies
  ): Router[Dependencies] = js.native
  def createRouter[Dependencies /* <: Record[String, _] */](routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]], options: PartialOptions): Router[Dependencies] = js.native
  def createRouter[Dependencies /* <: Record[String, _] */](
    routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]],
  ...
  def default[Dependencies /* <: Record[String, _] */](routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]]): Router[Dependencies] = js.native
  def default[Dependencies /* <: Record[String, _] */](
    routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]],
    options: js.UndefOr[scala.Nothing],
    dependencies: Dependencies
  ): Router[Dependencies] = js.native
  def default[Dependencies /* <: Record[String, _] */](routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]], options: PartialOptions): Router[Dependencies] = js.native
  def default[Dependencies /* <: Record[String, _] */](
    routes: js.Array[typingsSlinky.router5.routerMod.Route[Dependencies]],
    options: PartialOptions,
    dependencies: Dependencies
