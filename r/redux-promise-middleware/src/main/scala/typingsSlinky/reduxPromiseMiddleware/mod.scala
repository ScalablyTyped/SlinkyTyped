...
object mod extends Shortcut {
  ...
  object ActionType extends StObject {
    ...
    /* "FULFILLED" */ val Fulfilled: typingsSlinky.reduxPromiseMiddleware.mod.ActionType.Fulfilled with String = js.native
    
    @js.native
    sealed trait Pending extends ActionType
    /* "PENDING" */ val Pending: typingsSlinky.reduxPromiseMiddleware.mod.ActionType.Pending with String = js.native
    
    @js.native
    sealed trait Rejected extends ActionType
    /* "REJECTED" */ val Rejected: typingsSlinky.reduxPromiseMiddleware.mod.ActionType.Rejected with String = js.native
  }
