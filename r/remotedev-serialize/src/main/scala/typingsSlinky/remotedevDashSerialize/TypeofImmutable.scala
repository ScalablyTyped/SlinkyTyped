...
trait TypeofImmutable extends js.Object {
  ...
  def get[TProps, K /* <: String */](record: typingsSlinky.immutable.Immutable.Record[TProps], key: K, notSetValue: js.Any): /* import warning: importer.ImportType#apply Failed type conversion: TProps[K] */ js.Any = js.native
  ...
  @JSName("remove")
  def remove_KC_CollectionKWildcard[K, C /* <: typingsSlinky.immutable.Immutable.Collection[K, _] */](collection: C, key: K): C = js.native
  @JSName("remove")
  def remove_TPropsC_RecordTPropsK_String[TProps, C /* <: typingsSlinky.immutable.Immutable.Record[TProps] */, K /* <: String */](collection: C, key: K): C = js.native
  ...
  @JSName("set")
  def set_TPropsC_RecordTPropsK_String[TProps, C /* <: typingsSlinky.immutable.Immutable.Record[TProps] */, K /* <: String */](
    record: C,
    key: K,
  ...
  @JSName("update")
  def update_TPropsC_RecordTPropsK_String[TProps, C /* <: typingsSlinky.immutable.Immutable.Record[TProps] */, K /* <: String */](
    record: C,
    key: K,
    updater: js.Function1[
  ...
  @JSName("update")
  def update_TPropsC_RecordTPropsK_StringNSV[TProps, C /* <: typingsSlinky.immutable.Immutable.Record[TProps] */, K /* <: String */, NSV](
    record: C,
    key: K,
    notSetValue: NSV,
    updater: js.Function1[
