...
object ScreenProps {
  ...
  implicit class ScreenPropsOps[Self <: ScreenProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnAppear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = this.set("onAppear", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnDisappear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = this.set("onDisappear", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnDisappear: Self = this.set("onDisappear", js.undefined)
    
    @scala.inline
    def setOnDismissed(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = this.set("onDismissed", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnDismissed: Self = this.set("onDismissed", js.undefined)
    
    @scala.inline
    def setOnWillAppear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = this.set("onWillAppear", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnWillAppear: Self = this.set("onWillAppear", js.undefined)
    
    @scala.inline
    def setOnWillDisappear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = this.set("onWillDisappear", js.Any.fromFunction1(value))
