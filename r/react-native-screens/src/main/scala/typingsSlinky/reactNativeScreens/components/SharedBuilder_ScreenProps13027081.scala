...
import typingsSlinky.reactNativeScreens.mod.ScreenReplaceTypes
import typingsSlinky.reactNativeScreens.mod.StackAnimationTypes
import typingsSlinky.reactNativeScreens.mod.StackPresentationTypes
...
@scala.inline
class SharedBuilder_ScreenProps13027081[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def active(value: `0` | `1` | AnimatedInterpolation): this.type = set("active", value.asInstanceOf[js.Any])
  
  @scala.inline
  def activityState(value: `0` | `1` | `2` | AnimatedInterpolation): this.type = set("activityState", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def gestureEnabled(value: Boolean): this.type = set("gestureEnabled", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def onAppear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): this.type = set("onAppear", js.Any.fromFunction1(value))
  
  @scala.inline
  def onComponentRef(value: /* view */ js.Any => Unit): this.type = set("onComponentRef", js.Any.fromFunction1(value))
  
  @scala.inline
  def onDisappear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): this.type = set("onDisappear", js.Any.fromFunction1(value))
  
  @scala.inline
  def onDismissed(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): this.type = set("onDismissed", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def onWillAppear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): this.type = set("onWillAppear", js.Any.fromFunction1(value))
  
  @scala.inline
  def onWillDisappear(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): this.type = set("onWillDisappear", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def replaceAnimation(value: ScreenReplaceTypes): this.type = set("replaceAnimation", value.asInstanceOf[js.Any])
  
  @scala.inline
  def shouldRasterizeIOS(value: Boolean): this.type = set("shouldRasterizeIOS", value.asInstanceOf[js.Any])
  
  @scala.inline
  def stackAnimation(value: StackAnimationTypes): this.type = set("stackAnimation", value.asInstanceOf[js.Any])
  
  @scala.inline
  def stackPresentation(value: StackPresentationTypes): this.type = set("stackPresentation", value.asInstanceOf[js.Any])
