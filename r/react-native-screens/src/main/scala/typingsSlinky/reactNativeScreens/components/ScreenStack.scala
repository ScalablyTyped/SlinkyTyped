...
import typingsSlinky.reactNativeScreens.mod.ScreenStackProps
...
object ScreenStack {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeScreens.mod.ScreenStack] {
    ...
    @scala.inline
    def onFinishTransitioning(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): this.type = set("onFinishTransitioning", js.Any.fromFunction1(value))
  ...
  def withProps(p: ScreenStackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ScreenStack.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
