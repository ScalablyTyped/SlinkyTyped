...
import typingsSlinky.reactNativeScreens.mod.ScreenStackHeaderConfigProps
...
object ScreenStackHeaderConfig {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.reactNativeScreens.mod.ScreenStackHeaderConfig] {
    ...
    @scala.inline
    def backButtonInCustomView(value: Boolean): this.type = set("backButtonInCustomView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def backTitle(value: String): this.type = set("backTitle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def backTitleFontFamily(value: String): this.type = set("backTitleFontFamily", value.asInstanceOf[js.Any])
    
    @scala.inline
    def backTitleFontSize(value: Double): this.type = set("backTitleFontSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def backgroundColor(value: String): this.type = set("backgroundColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def blurEffect(value: BlurEffectTypes): this.type = set("blurEffect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def direction(value: rtl | ltr): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hideShadow(value: Boolean): this.type = set("hideShadow", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def largeTitle(value: Boolean): this.type = set("largeTitle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def largeTitleBackgroundColor(value: String): this.type = set("largeTitleBackgroundColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def largeTitleColor(value: String): this.type = set("largeTitleColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def largeTitleFontFamily(value: String): this.type = set("largeTitleFontFamily", value.asInstanceOf[js.Any])
    
    @scala.inline
    def largeTitleFontSize(value: Double): this.type = set("largeTitleFontSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def largeTitleHideShadow(value: Boolean): this.type = set("largeTitleHideShadow", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def statusBarAnimation(value: typingsSlinky.reactNativeScreens.reactNativeScreensStrings.none | fade | slide): this.type = set("statusBarAnimation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def statusBarHidden(value: Boolean): this.type = set("statusBarHidden", value.asInstanceOf[js.Any])
    
    @scala.inline
    def statusBarStyle(value: inverted | typingsSlinky.reactNativeScreens.reactNativeScreensStrings.auto | light | dark): this.type = set("statusBarStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def titleFontFamily(value: String): this.type = set("titleFontFamily", value.asInstanceOf[js.Any])
    
    @scala.inline
    def titleFontSize(value: Double): this.type = set("titleFontSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def topInsetEnabled(value: Boolean): this.type = set("topInsetEnabled", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ScreenStackHeaderConfigProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ScreenStackHeaderConfig.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
