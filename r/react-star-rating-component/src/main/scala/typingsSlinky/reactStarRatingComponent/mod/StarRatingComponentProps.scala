...
object StarRatingComponentProps {
  ...
  implicit class StarRatingComponentPropsOps[Self <: StarRatingComponentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderStarIcon(
      value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => ReactElement | String
    ): Self = this.set("renderStarIcon", js.Any.fromFunction3(value))
    @scala.inline
    def deleteRenderStarIcon: Self = this.set("renderStarIcon", js.undefined)
    @scala.inline
    def setRenderStarIconHalf(
      value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => ReactElement | String
    ): Self = this.set("renderStarIconHalf", js.Any.fromFunction3(value))
    @scala.inline
