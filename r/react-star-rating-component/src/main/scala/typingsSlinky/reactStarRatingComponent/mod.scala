...
object mod {
  ...
  type StarRatingComponent = ReactComponentClass[StarRatingComponentProps]
  ...
  object StarRatingComponentProps {
    ...
    implicit class StarRatingComponentPropsMutableBuilder[Self <: StarRatingComponentProps] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "renderStarIcon", js.Any.fromFunction3(value))
      
      @scala.inline
      def setRenderStarIconHalf(
        value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => ReactElement | String
      ): Self = StObject.set(x, "renderStarIconHalf", js.Any.fromFunction3(value))
