...
import typingsSlinky.bunyan.mod.Serializer
...
object bunyan {
  ...
  @js.native
  def createLogger(name: String): typingsSlinky.bunyan.mod.^ = js.native
  ...
  trait RequestCaptureOptions extends StObject {
    ...
    var stream: js.UndefOr[typingsSlinky.bunyan.mod.Stream] = js.native
    
    /** The streams to which to write when dumping captured records. */
    var streams: js.UndefOr[js.Array[typingsSlinky.bunyan.mod.Stream]] = js.native
  }
  object RequestCaptureOptions {
    ...
    implicit class RequestCaptureOptionsMutableBuilder[Self <: RequestCaptureOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStream(value: typingsSlinky.bunyan.mod.Stream): Self = StObject.set(x, "stream", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStreamUndefined: Self = StObject.set(x, "stream", js.undefined)
      
      @scala.inline
      def setStreams(value: js.Array[typingsSlinky.bunyan.mod.Stream]): Self = StObject.set(x, "streams", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStreamsUndefined: Self = StObject.set(x, "streams", js.undefined)
      
      @scala.inline
      def setStreamsVarargs(value: typingsSlinky.bunyan.mod.Stream*): Self = StObject.set(x, "streams", js.Array(value :_*))
    }
  }
}
