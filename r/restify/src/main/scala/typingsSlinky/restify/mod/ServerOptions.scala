...
object ServerOptions {
  ...
  implicit class ServerOptionsOps[Self <: ServerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHttpsServerOptions(value: typingsSlinky.node.httpsMod.ServerOptions): Self = this.set("httpsServerOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSpdy(value: typingsSlinky.spdy.mod.ServerOptions): Self = this.set("spdy", value.asInstanceOf[js.Any])
