...
trait ServerOptions extends StObject {
  ...
  var log: js.UndefOr[typingsSlinky.bunyan.mod.^] = js.native
...
object ServerOptions {
  ...
  implicit class ServerOptionsMutableBuilder[Self <: ServerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHttpsServerOptions(value: typingsSlinky.node.httpsMod.ServerOptions): Self = StObject.set(x, "httpsServerOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSpdy(value: typingsSlinky.spdy.mod.ServerOptions): Self = StObject.set(x, "spdy", value.asInstanceOf[js.Any])
