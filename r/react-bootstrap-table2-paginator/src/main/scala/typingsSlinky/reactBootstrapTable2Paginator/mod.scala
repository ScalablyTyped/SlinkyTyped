...
object mod {
  ...
  @js.native
  val PaginationListStandalone: ReactComponentClass[PaginationChildProps] = js.native
  ...
  @js.native
  val PaginationTotalStandalone: ReactComponentClass[PaginationChildProps] = js.native
  
  @JSImport("react-bootstrap-table2-paginator", "SizePerPageDropdownStandalone")
  @js.native
  val SizePerPageDropdownStandalone: ReactComponentClass[SizePerPageDropdownStandaloneProps] = js.native
