...
import typingsSlinky.reduxApiMiddleware.anon.MetaMeta
import typingsSlinky.reduxApiMiddleware.anon.PayloadPayload
...
object mod {
  ...
  class RequestError protected () extends Error {
    ...
    @JSName("name")
    var name_RequestError: typingsSlinky.reduxApiMiddleware.reduxApiMiddlewareStrings.RequestError = js.native
  }
  ...
  object RSAACall {
    ...
    implicit class RSAACallMutableBuilder[Self <: RSAACall[_, _, _], State, Payload, Meta] (val x: Self with (RSAACall[State, Payload, Meta])) extends AnyVal {
      ...
      @scala.inline
      def setBodyReadableStream(value: ReadableStream[js.typedarray.Uint8Array]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHeadersHeaders(value: Headers): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOptionsRequestInit(value: RequestInit): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  type ValidAction[Payload, Meta] = typingsSlinky.reduxApiMiddleware.anon.Error with (PayloadPayload[Payload] | js.Object) with (MetaMeta[Meta] | js.Object)
