...
package object reduxDashApiDashMiddlewareMod {
  import typingsSlinky.reduxDashApiDashMiddleware.Anon_Error
  import typingsSlinky.reduxDashApiDashMiddleware.Anon_Meta
  import typingsSlinky.reduxDashApiDashMiddleware.Anon_Payload
