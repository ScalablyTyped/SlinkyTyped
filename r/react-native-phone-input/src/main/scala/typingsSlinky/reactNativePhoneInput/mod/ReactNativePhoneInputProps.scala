...
object ReactNativePhoneInputProps {
  ...
  @scala.inline
  implicit class ReactNativePhoneInputPropsOps[Self <: ReactNativePhoneInputProps[_], TextComponentType /* <: ReactComponentClass[js.Object] */] (val x: Self with ReactNativePhoneInputProps[TextComponentType]) extends AnyVal {
