...
object ReactNativePhoneInputProps {
  @scala.inline
  def apply[/* <: typingsSlinky.react.mod.ComponentType[js.Object] */ TextComponentType](): ReactNativePhoneInputProps[TextComponentType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReactNativePhoneInputProps[TextComponentType]]
  }
  @scala.inline
  implicit class ReactNativePhoneInputPropsOps[Self <: ReactNativePhoneInputProps[_], /* <: typingsSlinky.react.mod.ComponentType[js.Object] */ TextComponentType] (val x: Self with ReactNativePhoneInputProps[TextComponentType]) extends AnyVal {
    @scala.inline
