package typingsSlinky.reactMdChip.chipMod
...
/**
  ...
  */
@JSImport("@react-md/chip/types/Chip", JSImport.Default)
@js.native
object default extends TopLevel[ForwardRefExoticComponent[ChipProps with RefAttributes[HTMLButtonElement]]]
