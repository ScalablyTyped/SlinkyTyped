package typingsSlinky.reactMdChip.components
...
object Chip {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def disableContentWrap(value: Boolean): this.type = set("disableContentWrap", value.asInstanceOf[js.Any])
    @scala.inline
    def disableIconTransition(value: Boolean): this.type = set("disableIconTransition", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def raisable(value: Boolean): this.type = set("raisable", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def theme(value: outline | solid): this.type = set("theme", value.asInstanceOf[js.Any])
    @scala.inline
