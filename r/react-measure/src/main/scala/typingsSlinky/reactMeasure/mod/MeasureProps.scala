...
object MeasureProps {
  ...
  implicit class MeasurePropsOps[Self <: MeasureProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: ReactComponentClass[MeasuredComponentProps]): Self = this.set("children", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInnerRefRefObject(value: ReactRef[Element]): Self = this.set("innerRef", value.asInstanceOf[js.Any])
