...
object RcMotion {
  ...
  implicit def make(companion: RcMotion.type): SharedBuilder_CSSMotionPropsrefRefanyun1753656749[js.Object] = new SharedBuilder_CSSMotionPropsrefRefanyun1753656749[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
