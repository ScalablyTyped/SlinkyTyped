...
import typingsSlinky.rcMotion.diffMod.KeyObject
...
object cssmotionlistMod extends Shortcut {
  ...
  @JSImport("rc-motion/es/CSSMotionList", JSImport.Default)
  @js.native
  val default: ReactComponentClass[CSSMotionListProps] = js.native
  
  @JSImport("rc-motion/es/CSSMotionList", "genCSSMotionList")
  @js.native
  def genCSSMotionList(transitionSupport: Boolean): ReactComponentClass[CSSMotionListProps] = js.native
  @JSImport("rc-motion/es/CSSMotionList", "genCSSMotionList")
  @js.native
  def genCSSMotionList(transitionSupport: Boolean, CSSMotion: ForwardRefExoticComponent[CSSMotionPropsrefRefanyun]): ReactComponentClass[CSSMotionListProps] = js.native
  ...
  trait CSSMotionListProps extends StObject {
    ...
    var component: js.UndefOr[String | ReactComponentClass[js.Object] | `false`] = js.native
    ...
    var onVisibleChanged: js.UndefOr[
        js.Function2[/* visible */ Boolean, /* info */ typingsSlinky.rcMotion.anon.Key, Unit]
      ] = js.native
  ...
  object CSSMotionListProps {
    ...
    implicit class CSSMotionListPropsMutableBuilder[Self <: CSSMotionListProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponent(value: String | ReactComponentClass[js.Object] | `false`): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnVisibleChanged(value: (/* visible */ Boolean, /* info */ typingsSlinky.rcMotion.anon.Key) => Unit): Self = StObject.set(x, "onVisibleChanged", js.Any.fromFunction2(value))
  ...
  type _To = ReactComponentClass[CSSMotionListProps]
  
  /* This means you don't have to write `default`, but can instead just say `cssmotionlistMod.foo` */
  override def _to: ReactComponentClass[CSSMotionListProps] = default
}
