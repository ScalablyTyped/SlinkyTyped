package typingsSlinky.rcMotion.cssmotionMod
...
@js.native
trait CSSMotionProps extends js.Object {
...
object CSSMotionProps {
  ...
  @scala.inline
  implicit class CSSMotionPropsOps[Self <: CSSMotionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInternalRefRefObject(value: ReactRef[_]): Self = this.set("internalRef", value.asInstanceOf[js.Any])
