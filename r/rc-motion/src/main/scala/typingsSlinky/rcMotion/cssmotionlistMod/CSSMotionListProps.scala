...
@js.native
trait CSSMotionListProps extends js.Object {
...
object CSSMotionListProps {
  ...
  @scala.inline
  implicit class CSSMotionListPropsOps[Self <: CSSMotionListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeysVarargs(value: (Key | Dictname)*): Self = this.set("keys", js.Array(value :_*))
    
    @scala.inline
    def setKeys(value: js.Array[Key | Dictname]): Self = this.set("keys", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponent(value: String | ReactComponentClass[js.Object] | `false`): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnVisibleChanged(value: (/* visible */ Boolean, /* info */ typingsSlinky.rcMotion.anon.Key) => Unit): Self = this.set("onVisibleChanged", js.Any.fromFunction2(value))
