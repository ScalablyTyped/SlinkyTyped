...
object mod {
  ...
  object Rivets extends Shortcut {
    ...
    @js.native
    val ^ : typingsSlinky.rivets.mod.Rivets.Rivets = js.native
    @js.native
    ...
    type _To = typingsSlinky.rivets.mod.Rivets.Rivets
    
    /* This means you don't have to write `^`, but can instead just say `Rivets.foo` */
    override def _to: typingsSlinky.rivets.mod.Rivets.Rivets = ^
  }
}
