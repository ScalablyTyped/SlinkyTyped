package typingsSlinky.reactImageMagnifiers
...
object mod {
  ...
  @js.native
  val GlassMagnifier: ReactComponentClass[GlassMagnifierProps] = js.native
  ...
  @js.native
  val Magnifier: ReactComponentClass[MagnifierProps] = js.native
  
  @JSImport("react-image-magnifiers", "MagnifierContainer")
  @js.native
  val MagnifierContainer: ReactComponentClass[MagnifierContainerProps] = js.native
  
  @JSImport("react-image-magnifiers", "MagnifierPreview")
  @js.native
  val MagnifierPreview: ReactComponentClass[MagnifierPreviewProps] = js.native
  
  @JSImport("react-image-magnifiers", "MagnifierZoom")
  @js.native
  val MagnifierZoom: ReactComponentClass[MagnifierZoomProps] = js.native
  
  @JSImport("react-image-magnifiers", "PictureInPictureMagnifier")
  @js.native
  val PictureInPictureMagnifier: ReactComponentClass[PictureInPictureMagnifierProps] = js.native
  
  @JSImport("react-image-magnifiers", "SideBySideMagnifier")
  @js.native
  val SideBySideMagnifier: ReactComponentClass[SideBySideMagnifierProps] = js.native
  ...
  trait CommonProps extends StObject {
    ...
    var onImageLoad: js.UndefOr[js.Function1[/* ev */ SyntheticEvent[Event, Element], Unit]] = js.native
    
    var onLargeImageLoad: js.UndefOr[js.Function1[/* ev */ SyntheticEvent[Event, Element], Unit]] = js.native
    
    var onZoomEnd: js.UndefOr[js.Function0[Unit]] = js.native
    
    var onZoomStart: js.UndefOr[js.Function0[Unit]] = js.native
    
    var renderOverlay: js.UndefOr[js.Function1[/* state */ Boolean, ReactElement]] = js.native
  ...
  object CommonProps {
    ...
    implicit class CommonPropsMutableBuilder[Self <: CommonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnImageLoad(value: /* ev */ SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onImageLoad", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnImageLoadUndefined: Self = StObject.set(x, "onImageLoad", js.undefined)
      
      @scala.inline
      def setOnLargeImageLoad(value: /* ev */ SyntheticEvent[Event, Element] => Unit): Self = StObject.set(x, "onLargeImageLoad", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRenderOverlay(value: /* state */ Boolean => ReactElement): Self = StObject.set(x, "renderOverlay", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.click
    - typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.doubleClick
  */
  trait MouseActivation extends StObject
  object MouseActivation {
    
    @scala.inline
    def click: typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.click = "click".asInstanceOf[typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.click]
    
    @scala.inline
    def doubleClick: typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.doubleClick = "doubleClick".asInstanceOf[typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.doubleClick]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.tap
    - typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.doubleTap
    - typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.longTouch
  */
  trait TouchActivation extends StObject
  object TouchActivation {
    
    @scala.inline
    def doubleTap: typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.doubleTap = "doubleTap".asInstanceOf[typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.doubleTap]
    
    @scala.inline
    def longTouch: typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.longTouch = "longTouch".asInstanceOf[typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.longTouch]
    
    @scala.inline
    def tap: typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.tap = "tap".asInstanceOf[typingsSlinky.reactImageMagnifiers.reactImageMagnifiersStrings.tap]
  }
}
