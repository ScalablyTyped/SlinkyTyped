...
object CommonProps {
  ...
  implicit class CommonPropsOps[Self <: CommonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnImageLoad(value: /* ev */ SyntheticEvent[Event, Element] => Unit): Self = this.set("onImageLoad", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnImageLoad: Self = this.set("onImageLoad", js.undefined)
    
    @scala.inline
    def setOnLargeImageLoad(value: /* ev */ SyntheticEvent[Event, Element] => Unit): Self = this.set("onLargeImageLoad", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderOverlay(value: /* state */ Boolean => ReactElement): Self = this.set("renderOverlay", js.Any.fromFunction1(value))
