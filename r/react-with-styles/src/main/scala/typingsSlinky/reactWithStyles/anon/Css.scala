...
object Css {
  ...
  @scala.inline
  def apply[TStyles /* <: Styles */](css: js.Function, styles: TStyles): Css[TStyles] = {
    val __obj = js.Dynamic.literal(css = css.asInstanceOf[js.Any], styles = styles.asInstanceOf[js.Any])
    __obj.asInstanceOf[Css[TStyles]]
  }
  
  @scala.inline
  implicit class CssOps[Self <: Css[_], TStyles /* <: Styles */] (val x: Self with Css[TStyles]) extends AnyVal {
