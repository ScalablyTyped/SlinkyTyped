...
object Css {
  @scala.inline
  def apply[/* <: typingsSlinky.reactWithStyles.mod.Styles */ TStyles](css: js.Function, styles: TStyles): Css[TStyles] = {
    val __obj = js.Dynamic.literal(css = css.asInstanceOf[js.Any], styles = styles.asInstanceOf[js.Any])
    __obj.asInstanceOf[Css[TStyles]]
  }
  @scala.inline
  implicit class CssOps[Self <: Css[_], /* <: typingsSlinky.reactWithStyles.mod.Styles */ TStyles] (val x: Self with Css[TStyles]) extends AnyVal {
    @scala.inline
