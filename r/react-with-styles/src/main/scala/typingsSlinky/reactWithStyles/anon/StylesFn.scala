...
object StylesFn {
  @scala.inline
  def apply[/* <: typingsSlinky.reactWithStyles.mod.Styles */ TStyles](stylesFn: /* repeated */ js.Any => TStyles): StylesFn[TStyles] = {
    val __obj = js.Dynamic.literal(stylesFn = js.Any.fromFunction1(stylesFn))
    __obj.asInstanceOf[StylesFn[TStyles]]
  }
  @scala.inline
  implicit class StylesFnOps[Self <: StylesFn[_], /* <: typingsSlinky.reactWithStyles.mod.Styles */ TStyles] (val x: Self with StylesFn[TStyles]) extends AnyVal {
    @scala.inline
