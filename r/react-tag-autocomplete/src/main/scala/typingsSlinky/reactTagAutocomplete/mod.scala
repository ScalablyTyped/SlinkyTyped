...
object mod {
  ...
  type ReactTags = ReactComponentClass[ReactTagsProps]
  ...
  object ReactTagsProps {
    ...
    implicit class ReactTagsPropsMutableBuilder[Self <: ReactTagsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTagComponent(value: ReactComponentClass[TagComponentProps]): Self = StObject.set(x, "tagComponent", value.asInstanceOf[js.Any])
  ...
  object TagComponentProps {
    ...
    implicit class TagComponentPropsMutableBuilder[Self <: TagComponentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnDelete(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onDelete", js.Any.fromFunction1(value))
