package typingsSlinky.reactNativeCheckBox
...
object mod {
  ...
  type CheckBox = ReactComponentClass[CheckBoxProps]
  ...
  trait CheckBoxProps extends StObject {
    ...
    var leftTextView: js.UndefOr[ReactElement] = js.native
    ...
    var rightTextView: js.UndefOr[ReactElement] = js.native
  ...
  object CheckBoxProps {
    ...
    implicit class CheckBoxPropsMutableBuilder[Self <: CheckBoxProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLeftTextView(value: ReactElement): Self = StObject.set(x, "leftTextView", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLeftTextViewReactElement(value: ReactElement): Self = StObject.set(x, "leftTextView", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRightTextView(value: ReactElement): Self = StObject.set(x, "rightTextView", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRightTextViewReactElement(value: ReactElement): Self = StObject.set(x, "rightTextView", value.asInstanceOf[js.Any])
