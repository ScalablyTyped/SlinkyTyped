...
object CheckBoxProps {
  ...
  implicit class CheckBoxPropsOps[Self <: CheckBoxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeftTextViewReactElement(value: ReactElement): Self = this.set("leftTextView", value.asInstanceOf[js.Any])
    @scala.inline
    def setLeftTextView(value: ReactElement): Self = this.set("leftTextView", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRightTextViewReactElement(value: ReactElement): Self = this.set("rightTextView", value.asInstanceOf[js.Any])
    @scala.inline
    def setRightTextView(value: ReactElement): Self = this.set("rightTextView", value.asInstanceOf[js.Any])
    @scala.inline
