...
object DrawerNavigatorItems {
  ...
  def withProps(p: DrawerNavigatorItemsProps): SharedBuilder_DrawerNavigatorItemsProps644699346[default] = new SharedBuilder_DrawerNavigatorItemsProps644699346[default](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    ...
    new SharedBuilder_DrawerNavigatorItemsProps644699346[default](js.Array(this.component, __props.asInstanceOf[DrawerNavigatorItemsProps]))
  }
}
