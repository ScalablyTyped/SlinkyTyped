...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNavigationDrawer.reactNavigationDrawerStrings.unlocked
  - typingsSlinky.reactNavigationDrawer.reactNavigationDrawerStrings.`locked-closed`
  - typingsSlinky.reactNavigationDrawer.reactNavigationDrawerStrings.`locked-open`
*/
