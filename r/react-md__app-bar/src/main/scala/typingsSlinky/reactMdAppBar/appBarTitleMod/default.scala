package typingsSlinky.reactMdAppBar.appBarTitleMod
...
/**
  ...
  */
@JSImport("@react-md/app-bar/types/AppBarTitle", JSImport.Default)
@js.native
object default extends TopLevel[
      ForwardRefExoticComponent[AppBarTitleProps with RefAttributes[HTMLHeadingElement]]
    ]
