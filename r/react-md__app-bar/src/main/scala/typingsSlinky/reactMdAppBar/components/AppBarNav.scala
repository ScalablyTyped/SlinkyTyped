...
object AppBarNav {
  ...
  def withProps(p: AppBarNavProps with RefAttributes[HTMLButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: AppBarNav.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
