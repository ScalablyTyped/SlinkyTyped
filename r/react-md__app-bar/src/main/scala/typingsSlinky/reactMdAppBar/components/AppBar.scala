...
import typingsSlinky.reactMdAppBar.appBarMod.AppBarHeight
import typingsSlinky.reactMdAppBar.appBarMod.AppBarPosition
import typingsSlinky.reactMdAppBar.appBarMod.AppBarProps
import typingsSlinky.reactMdAppBar.appBarMod.AppBarTheme
...
object AppBar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def fixedElevation(value: Boolean): this.type = set("fixedElevation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def fixedPosition(value: AppBarPosition): this.type = set("fixedPosition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def flexWrap(value: Boolean): this.type = set("flexWrap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def height(value: AppBarHeight): this.type = set("height", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def theme(value: AppBarTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  ...
  def withProps(p: AppBarProps with RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
