...
object ReactDashNativeDashFlipDashCard
  ...
  typingsSlinky.reactDashNativeDashFlipDashCard.reactDashNativeDashFlipDashCardMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
