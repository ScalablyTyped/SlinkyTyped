...
import typingsSlinky.reactSortableHoc.anon.Target
...
object mod {
  ...
  @js.native
  def SortableContainer[P](wrappedComponent: WrappedComponent[P]): ReactComponentClass[P with SortableContainerProps] = js.native
  @JSImport("react-sortable-hoc", "SortableContainer")
  @js.native
  def SortableContainer[P](wrappedComponent: WrappedComponent[P], config: Config): ReactComponentClass[P with SortableContainerProps] = js.native
  
  @JSImport("react-sortable-hoc", "SortableElement")
  @js.native
  def SortableElement[P](wrappedComponent: WrappedComponent[P]): ReactComponentClass[P with SortableElementProps] = js.native
  @JSImport("react-sortable-hoc", "SortableElement")
  @js.native
  def SortableElement[P](wrappedComponent: WrappedComponent[P], config: Config): ReactComponentClass[P with SortableElementProps] = js.native
  
  @JSImport("react-sortable-hoc", "SortableHandle")
  @js.native
  def SortableHandle[P](wrappedComponent: WrappedComponent[P]): ReactComponentClass[P] = js.native
  @JSImport("react-sortable-hoc", "SortableHandle")
  @js.native
  def SortableHandle[P](wrappedComponent: WrappedComponent[P], config: Config): ReactComponentClass[P] = js.native
  ...
  */
  ...
  object SortableContainerProps {
    ...
    implicit class SortableContainerPropsMutableBuilder[Self <: SortableContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHelperContainerHTMLElement(value: HTMLElement): Self = StObject.set(x, "helperContainer", value.asInstanceOf[js.Any])
  ...
  type WrappedComponent[P] = ReactComponentClass[P] | WrappedComponentFactory[P]
  
  type WrappedComponentFactory[P] = js.Function1[/* props */ P, ReactElement]
}
