...
object EffectiveConnectionType {
  ...
  implicit class EffectiveConnectionTypeOps[Self <: EffectiveConnectionType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEffectiveConnectionType(value: typingsSlinky.reactAdaptiveHooks.networkMod.EffectiveConnectionType): Self = this.set("effectiveConnectionType", value.asInstanceOf[js.Any])
