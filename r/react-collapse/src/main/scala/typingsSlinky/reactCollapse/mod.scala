...
object mod {
  ...
  trait CollapseProps extends HTMLProps[Collapse] {
    ...
    @JSName("children")
    var children_CollapseProps: ReactElement = js.native
  ...
  object CollapseProps {
    ...
    implicit class CollapsePropsMutableBuilder[Self <: CollapseProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTheme(value: typingsSlinky.reactCollapse.anon.Collapse): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
