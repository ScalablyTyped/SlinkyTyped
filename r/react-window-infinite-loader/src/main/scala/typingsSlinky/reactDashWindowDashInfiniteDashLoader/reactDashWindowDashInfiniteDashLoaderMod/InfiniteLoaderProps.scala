package typingsSlinky.reactDashWindowDashInfiniteDashLoader.reactDashWindowDashInfiniteDashLoaderMod

import slinky.core.TagMod
import typingsSlinky.reactDashWindowDashInfiniteDashLoader.Anon_OnItemsRendered
...
trait InfiniteLoaderProps extends js.Object {
  ...
  def children(props: Anon_OnItemsRendered): TagMod[Any]
...
object InfiniteLoaderProps {
  @scala.inline
  def apply(
    children: Anon_OnItemsRendered => TagMod[Any],
