...
trait Rules[P /* <: js.Object */] extends js.Object {
  ...
  {[ key in keyof P ]: react-native-joi.react-native-joi.SchemaLike}
    */ typingsSlinky.reactNativeJoi.reactNativeJoiStrings.Rules with TopLevel[js.Any])
  ] = js.undefined
...
object Rules {
  ...
  {[ key in keyof P ]: react-native-joi.react-native-joi.SchemaLike}
    */ typingsSlinky.reactNativeJoi.reactNativeJoiStrings.Rules with TopLevel[js.Any]) = null,
