...
import typingsSlinky.reactNativeJoi.anon.Arrays
...
object ValidationOptions {
  ...
  def apply(
    ...
    presence: typingsSlinky.reactNativeJoi.reactNativeJoiStrings.optional | typingsSlinky.reactNativeJoi.reactNativeJoiStrings.required | typingsSlinky.reactNativeJoi.reactNativeJoiStrings.forbidden = null,
