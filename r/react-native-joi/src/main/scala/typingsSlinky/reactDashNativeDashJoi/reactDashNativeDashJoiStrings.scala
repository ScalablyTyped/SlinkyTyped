...
import typingsSlinky.reactDashNativeDashJoi.reactDashNativeDashJoiMod.GuidVersions
import typingsSlinky.reactDashNativeDashJoi.reactDashNativeDashJoiMod.Types
