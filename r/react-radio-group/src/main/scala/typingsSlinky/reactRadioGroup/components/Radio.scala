...
object Radio {
  ...
  object Radio {
    ...
    @scala.inline
    def apply(value: js.Any): typingsSlinky.reactRadioGroup.components.Radio.Radio.Builder = {
      val __props = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      new typingsSlinky.reactRadioGroup.components.Radio.Radio.Builder(js.Array(this.component, __props.asInstanceOf[RadioProps]))
    }
    ...
    def withProps(p: RadioProps): typingsSlinky.reactRadioGroup.components.Radio.Radio.Builder = new typingsSlinky.reactRadioGroup.components.Radio.Radio.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("react-radio-group", "Radio")
  @js.native
  val component: js.Object = js.native
