...
import typingsSlinky.reactRadioGroup.mod.RadioGroup.RadioGroupProps
import typingsSlinky.reactRadioGroup.mod.RadioGroup.^
...
object RadioGroup {
  ...
  object RadioGroup {
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def Component(value: ReactType[Omit[HTMLProps[_], onChange | role]]): this.type = set("Component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def ComponentComponentClass(value: ReactComponentClass[Omit[HTMLProps[_], onChange | role]]): this.type = set("Component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def ComponentFunctionComponent(value: ReactComponentClass[Omit[HTMLProps[_], onChange | role]]): this.type = set("Component", value.asInstanceOf[js.Any])
    ...
    implicit def make(companion: RadioGroup.type): typingsSlinky.reactRadioGroup.components.RadioGroup.RadioGroup.Builder = new typingsSlinky.reactRadioGroup.components.RadioGroup.RadioGroup.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: RadioGroupProps): typingsSlinky.reactRadioGroup.components.RadioGroup.RadioGroup.Builder = new typingsSlinky.reactRadioGroup.components.RadioGroup.RadioGroup.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("react-radio-group", "RadioGroup")
  @js.native
  val component: js.Object = js.native
