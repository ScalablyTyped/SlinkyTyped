...
object anon {
  ...
  object Component {
    ...
    implicit class ComponentMutableBuilder[Self <: Component] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[Omit[HTMLProps[_], onChange | role]]): Self = StObject.set(x, "Component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[Omit[HTMLProps[_], onChange | role]]): Self = StObject.set(x, "Component", value.asInstanceOf[js.Any])
