...
trait RectProps extends js.Object {
  var children: js.UndefOr[js.Function1[/* args */ Rect, TagMod[Any]]] = js.undefined
...
object RectProps {
  @scala.inline
  def apply(
    children: /* args */ Rect => TagMod[Any] = null,
    observe: js.UndefOr[Boolean] = js.undefined,
    onChange: /* rect */ DOMRect => Unit = null
  ): RectProps = {
    val __obj = js.Dynamic.literal()
    if (children != null) __obj.updateDynamic("children")(js.Any.fromFunction1(children))
    if (!js.isUndefined(observe)) __obj.updateDynamic("observe")(observe.get.asInstanceOf[js.Any])
