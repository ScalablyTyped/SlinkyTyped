...
object useMessageQueueMod {
  ...
  */
  ...
  object MessageActions {
    ...
    @scala.inline
    def AddMessageAction[M /* <: Message */](duplicates: DuplicateBehavior, message: M, `type`: /* "ADD_MESSAGE" */ String): typingsSlinky.reactMdAlert.useMessageQueueMod.AddMessageAction[M] = {
      val __obj = js.Dynamic.literal(duplicates = duplicates.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdAlert.useMessageQueueMod.AddMessageAction[M]]
    }
    
    @scala.inline
    def PopMessageAction(`type`: /* "POP_MESSAGE" */ String): typingsSlinky.reactMdAlert.useMessageQueueMod.PopMessageAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdAlert.useMessageQueueMod.PopMessageAction]
    }
    
    @scala.inline
    def ResetQueueAction(`type`: /* "RESET_QUEUE" */ String): typingsSlinky.reactMdAlert.useMessageQueueMod.ResetQueueAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.reactMdAlert.useMessageQueueMod.ResetQueueAction]
    }
  }
