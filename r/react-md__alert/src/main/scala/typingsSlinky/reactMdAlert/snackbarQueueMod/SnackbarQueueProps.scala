package typingsSlinky.reactMdAlert.snackbarQueueMod
...
object SnackbarQueueProps {
  @scala.inline
  def apply[/* <: typingsSlinky.reactMdAlert.messageQueueContextMod.ToastMessage */ M](id: String, queue: js.Array[M]): SnackbarQueueProps[M] = {
  ...
  @scala.inline
  implicit class SnackbarQueuePropsOps[Self <: SnackbarQueueProps[_], /* <: typingsSlinky.reactMdAlert.messageQueueContextMod.ToastMessage */ M] (val x: Self with SnackbarQueueProps[M]) extends AnyVal {
    @scala.inline
