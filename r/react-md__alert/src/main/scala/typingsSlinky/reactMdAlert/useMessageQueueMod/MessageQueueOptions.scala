...
object MessageQueueOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.reactMdAlert.messageQueueContextMod.Message */ M](): MessageQueueOptions[M] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MessageQueueOptions[M]]
  }
  @scala.inline
  implicit class MessageQueueOptionsOps[Self <: MessageQueueOptions[_], /* <: typingsSlinky.reactMdAlert.messageQueueContextMod.Message */ M] (val x: Self with MessageQueueOptions[M]) extends AnyVal {
    @scala.inline
