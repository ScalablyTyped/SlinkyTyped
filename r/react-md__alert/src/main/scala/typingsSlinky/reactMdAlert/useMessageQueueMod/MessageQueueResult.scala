...
object MessageQueueResult {
  ...
  @scala.inline
  implicit class MessageQueueResultOps[Self <: MessageQueueResult[_], /* <: typingsSlinky.reactMdAlert.messageQueueContextMod.Message */ M] (val x: Self with MessageQueueResult[M]) extends AnyVal {
    @scala.inline
