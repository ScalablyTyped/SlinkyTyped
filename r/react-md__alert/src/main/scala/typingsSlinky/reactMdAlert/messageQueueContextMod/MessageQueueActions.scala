...
object MessageQueueActions {
  @scala.inline
  def apply[/* <: typingsSlinky.reactMdAlert.messageQueueContextMod.Message */ M](
    hideMessage: () => Unit,
    popMessage: () => Unit,
  ...
  @scala.inline
  implicit class MessageQueueActionsOps[Self <: MessageQueueActions[_], /* <: typingsSlinky.reactMdAlert.messageQueueContextMod.Message */ M] (val x: Self with MessageQueueActions[M]) extends AnyVal {
    @scala.inline
