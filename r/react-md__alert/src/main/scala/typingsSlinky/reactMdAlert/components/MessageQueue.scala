...
object MessageQueue {
  ...
  @scala.inline
  class Builder[/* <: typingsSlinky.reactMdAlert.messageQueueContextMod.ToastMessage */ M] (val args: js.Array[js.Any])
    extends AnyVal
    ...
    @scala.inline
    def duplicates(value: DuplicateBehavior): this.type = set("duplicates", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onActionClick(value: (M, /* event */ SyntheticMouseEvent[HTMLButtonElement]) => Unit): this.type = set("onActionClick", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps[/* <: typingsSlinky.reactMdAlert.messageQueueContextMod.ToastMessage */ M](p: MessageQueueProps[M]): Builder[M] = new Builder[M](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply[/* <: typingsSlinky.reactMdAlert.messageQueueContextMod.ToastMessage */ M](id: String): Builder[M] = {
