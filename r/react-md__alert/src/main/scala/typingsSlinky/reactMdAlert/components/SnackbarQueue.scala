...
object SnackbarQueue {
  @JSImport("@react-md/alert/types/SnackbarQueue", JSImport.Default)
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onActionClick(value: (js.Any, /* event */ SyntheticMouseEvent[HTMLButtonElement]) => Unit): this.type = set("onActionClick", js.Any.fromFunction2(value))
    @scala.inline
