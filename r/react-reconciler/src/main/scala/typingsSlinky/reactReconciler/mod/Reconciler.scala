...
trait Reconciler[Instance, TextInstance, Container, PublicInstance] extends js.Object {
  ...
  def getPublicRootInstance(container: OpaqueRoot): ReactComponentClass[_] | PublicInstance | Null = js.native
  ...
  def updateContainer(
    ...
    parentComponent: js.UndefOr[ReactComponentClass[_] | Null],
