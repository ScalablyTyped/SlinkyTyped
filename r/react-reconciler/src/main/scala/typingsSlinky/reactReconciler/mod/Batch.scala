...
object Batch {
  ...
  implicit class BatchOps[Self <: Batch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_defer(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_defer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_expirationTime(value: ExpirationTime): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_expirationTime")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_onComplete(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_onComplete")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def with_next(value: Batch): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_next")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_nextNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_next")(null)
        ret
    }
  }
