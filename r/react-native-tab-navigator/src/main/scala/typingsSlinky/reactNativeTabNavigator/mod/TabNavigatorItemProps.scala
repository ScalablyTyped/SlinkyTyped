...
object TabNavigatorItemProps {
  ...
  implicit class TabNavigatorItemPropsOps[Self <: TabNavigatorItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderBadge(value: () => ReactElement): Self = this.set("renderBadge", js.Any.fromFunction0(value))
    @scala.inline
    def deleteRenderBadge: Self = this.set("renderBadge", js.undefined)
    @scala.inline
    def setRenderIcon(value: () => ReactElement): Self = this.set("renderIcon", js.Any.fromFunction0(value))
    @scala.inline
    def deleteRenderIcon: Self = this.set("renderIcon", js.undefined)
    @scala.inline
    def setRenderSelectedIcon(value: () => ReactElement): Self = this.set("renderSelectedIcon", js.Any.fromFunction0(value))
    @scala.inline
