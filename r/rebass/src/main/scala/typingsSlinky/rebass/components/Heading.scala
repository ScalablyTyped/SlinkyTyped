...
import typingsSlinky.rebass.mod.HeadingProps
...
object Heading {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def fontFamily(value: ResponsiveValue[FontFamilyProperty, RequiredTheme]): this.type = set("fontFamily", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def fontStyle(value: ResponsiveValue[FontStyleProperty, RequiredTheme]): this.type = set("fontStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def textAlign(value: ResponsiveValue[TextAlignProperty, RequiredTheme]): this.type = set("textAlign", value.asInstanceOf[js.Any])
    @scala.inline
