...
trait FlexProps extends js.Object {
  ...
  /**
    ...
    */
  var alignItems: js.UndefOr[ResponsiveValue[AlignItemsProperty, RequiredTheme]] = js.native
  /**
  ...
  /**
    ...
    */
  var flexDirection: js.UndefOr[ResponsiveValue[FlexDirectionProperty, RequiredTheme]] = js.native
  /**
    ...
    */
  var flexWrap: js.UndefOr[ResponsiveValue[FlexWrapProperty, RequiredTheme]] = js.native
  /**
  ...
  /**
    ...
    */
  var justifyContent: js.UndefOr[ResponsiveValue[JustifyContentProperty, RequiredTheme]] = js.native
...
object FlexProps {
  ...
  implicit class FlexPropsOps[Self <: FlexProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlignItems(value: ResponsiveValue[AlignItemsProperty, RequiredTheme]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFlexDirection(value: ResponsiveValue[FlexDirectionProperty, RequiredTheme]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFlexWrap(value: ResponsiveValue[FlexWrapProperty, RequiredTheme]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withJustifyContent(value: ResponsiveValue[JustifyContentProperty, RequiredTheme]): Self = {
        val ret = this.duplicate
