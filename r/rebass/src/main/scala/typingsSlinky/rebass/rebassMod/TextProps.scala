...
import typingsSlinky.styledDashSystem.styledDashSystemMod.FontFamilyProps
import typingsSlinky.styledDashSystem.styledDashSystemMod.FontWeightProps
import typingsSlinky.styledDashSystem.styledDashSystemMod.LetterSpacingProps
import typingsSlinky.styledDashSystem.styledDashSystemMod.LineHeightProps
...
import typingsSlinky.styledDashSystem.styledDashSystemMod.TextAlignProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveDifficultInheritance.summarizeChanges 
- Dropped {[ P in std.Exclude<keyof react.react.HTMLProps<std.HTMLDivElement>, keyof rebass.rebass.TextKnownProps> ]: react.react.HTMLProps<std.HTMLDivElement>[P]} */ trait TextProps
