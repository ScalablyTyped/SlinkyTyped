...
name := "rebass"
version := "4.0-dt-20200925Z-5d019c"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "styled-components" % "5.1-dt-20201010Z-fe2277",
  "org.scalablytyped.slinky" %%% "styled-system" % "5.1-dt-20201028Z-afff8f",
  "org.scalablytyped.slinky" %%% "styled-system__css" % "5.0-dt-20200925Z-a7d06b")
