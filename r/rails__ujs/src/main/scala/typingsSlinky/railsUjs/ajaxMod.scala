...
object ajaxMod {
  ...
  object AjaxOptions {
    ...
    implicit class AjaxOptionsMutableBuilder[Self <: AjaxOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDataDocument(value: Document): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDataFormData(value: FormData): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDataNull: Self = StObject.set(x, "data", null)
      
      @scala.inline
      def setDataReadableStream(value: ReadableStream[js.typedarray.Uint8Array]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
