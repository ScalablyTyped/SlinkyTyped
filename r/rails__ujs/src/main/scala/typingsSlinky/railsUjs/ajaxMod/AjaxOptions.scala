package typingsSlinky.railsUjs.ajaxMod
...
object AjaxOptions {
  ...
  implicit class AjaxOptionsOps[Self <: AjaxOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataFormData(value: FormData): Self = this.set("data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataReadableStream(value: ReadableStream[js.typedarray.Uint8Array]): Self = this.set("data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataDocument(value: Document): Self = this.set("data", value.asInstanceOf[js.Any])
