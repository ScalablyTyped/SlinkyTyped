...
object RangyClassApplierOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(applyToEditableOnly)) __obj.updateDynamic("applyToEditableOnly")(applyToEditableOnly.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useExistingElements)) __obj.updateDynamic("useExistingElements")(useExistingElements.get.asInstanceOf[js.Any])
