...
import typingsSlinky.reactHotLoader.anon.PartialConfig
...
object mod {
  ...
  @js.native
  def areComponentsEqual[T](typeA: ReactComponentClass[T], typeB: ReactComponentClass[T]): Boolean = js.native
  ...
  object AppContainerProps {
    ...
    implicit class AppContainerPropsMutableBuilder[Self <: AppContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrorReporter(value: ReactComponentClass[ErrorReporterProps]): Self = StObject.set(x, "errorReporter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorReporterComponentClass(value: ReactComponentClass[ErrorReporterProps]): Self = StObject.set(x, "errorReporter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorReporterFunctionComponent(value: ReactComponentClass[ErrorReporterProps]): Self = StObject.set(x, "errorReporter", value.asInstanceOf[js.Any])
