...
object anon {
  ...
  trait PartialConfig extends StObject {
    ...
    var ErrorOverlay: js.UndefOr[ReactComponentClass[Errors]] = js.native
  ...
  object PartialConfig {
    ...
    implicit class PartialConfigMutableBuilder[Self <: PartialConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrorOverlay(value: ReactComponentClass[Errors]): Self = StObject.set(x, "ErrorOverlay", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorOverlayComponentClass(value: ReactComponentClass[Errors]): Self = StObject.set(x, "ErrorOverlay", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorOverlayFunctionComponent(value: ReactComponentClass[Errors]): Self = StObject.set(x, "ErrorOverlay", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorOverlayUndefined: Self = StObject.set(x, "ErrorOverlay", js.undefined)
      
      @scala.inline
      def setErrorReporter(value: ReactComponentClass[HotError]): Self = StObject.set(x, "errorReporter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorReporterComponentClass(value: ReactComponentClass[HotError]): Self = StObject.set(x, "errorReporter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorReporterFunctionComponent(value: ReactComponentClass[HotError]): Self = StObject.set(x, "errorReporter", value.asInstanceOf[js.Any])
