...
object PartialConfig {
  ...
  implicit class PartialConfigOps[Self <: PartialConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorOverlayFunctionComponent(value: ReactComponentClass[Errors]): Self = this.set("ErrorOverlay", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setErrorOverlayComponentClass(value: ReactComponentClass[Errors]): Self = this.set("ErrorOverlay", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setErrorOverlay(value: ReactComponentClass[Errors]): Self = this.set("ErrorOverlay", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setErrorReporterFunctionComponent(value: ReactComponentClass[HotError]): Self = this.set("errorReporter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setErrorReporterComponentClass(value: ReactComponentClass[HotError]): Self = this.set("errorReporter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setErrorReporter(value: ReactComponentClass[HotError]): Self = this.set("errorReporter", value.asInstanceOf[js.Any])
