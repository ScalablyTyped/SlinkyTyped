...
object Errors {
  ...
  implicit class ErrorsOps[Self <: Errors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorsVarargs(value: HotError*): Self = this.set("errors", js.Array(value :_*))
    @scala.inline
    def setErrors(value: js.Array[HotError]): Self = this.set("errors", value.asInstanceOf[js.Any])
  }
