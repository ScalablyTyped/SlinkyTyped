...
import typingsSlinky.reactDashHotDashLoader.Anon_Errors
...
trait Config extends js.Object {
  /**
    ...
    */
  var ErrorOverlay: ReactComponentClass[Anon_Errors]
  /**
  ...
  /**
    ...
    */
  var errorReporter: ReactComponentClass[HotError]
  /**
...
object Config {
  @scala.inline
  def apply(
    ErrorOverlay: ReactComponentClass[Anon_Errors],
    allowSFC: Boolean,
