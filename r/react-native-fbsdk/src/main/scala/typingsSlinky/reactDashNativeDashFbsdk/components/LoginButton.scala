...
import typingsSlinky.reactDashNativeDashFbsdk.reactDashNativeDashFbsdkMod.LoginBehaviorIOS
import typingsSlinky.reactDashNativeDashFbsdk.reactDashNativeDashFbsdkMod.LoginButtonProps
import typingsSlinky.reactDashNativeDashFbsdk.reactDashNativeDashFbsdkMod.LoginResult
import typingsSlinky.reactDashNativeDashFbsdk.reactDashNativeDashFbsdkMod.Permissions
...
object LoginButton
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.reactDashNativeDashFbsdk.reactDashNativeDashFbsdkMod.LoginButton
    ] {
  ...
  typingsSlinky.reactDashNativeDashFbsdk.reactDashNativeDashFbsdkMod.LoginButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
