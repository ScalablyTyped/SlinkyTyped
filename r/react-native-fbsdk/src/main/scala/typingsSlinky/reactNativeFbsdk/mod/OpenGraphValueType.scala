...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.reactNativeFbsdk.reactNativeFbsdkStrings.number
  - typingsSlinky.reactNativeFbsdk.reactNativeFbsdkStrings.`open-graph-object`
  - typingsSlinky.reactNativeFbsdk.reactNativeFbsdkStrings.photo
  - typingsSlinky.reactNativeFbsdk.reactNativeFbsdkStrings.string
*/
