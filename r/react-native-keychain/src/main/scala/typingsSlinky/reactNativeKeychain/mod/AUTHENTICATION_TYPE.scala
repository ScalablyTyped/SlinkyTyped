...
object AUTHENTICATION_TYPE extends StObject {
  ...
  /* "AuthenticationWithBiometrics" */ val BIOMETRICS: typingsSlinky.reactNativeKeychain.mod.AUTHENTICATION_TYPE.BIOMETRICS with String = js.native
  
  @js.native
  sealed trait DEVICE_PASSCODE_OR_BIOMETRICS extends AUTHENTICATION_TYPE
  /* "AuthenticationWithBiometricsDevicePasscode" */ val DEVICE_PASSCODE_OR_BIOMETRICS: typingsSlinky.reactNativeKeychain.mod.AUTHENTICATION_TYPE.DEVICE_PASSCODE_OR_BIOMETRICS with String = js.native
}
