...
import typingsSlinky.reactGa.reactGaStrings.beacon
import typingsSlinky.reactGa.reactGaStrings.image
import typingsSlinky.reactGa.reactGaStrings.xhr
...
object mod {
  ...
  @JSImport("react-ga", "OutboundLink")
  @js.native
  val OutboundLink_ : ReactComponentClass[OutboundLinkProps with HTMLProps[HTMLAnchorElement]] = js.native
