...
object RequestRetryOptions {
  ...
  implicit class RequestRetryOptionsOps[Self <: RequestRetryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelayStrategy(value: (/* err */ js.Error, /* response */ IncomingMessage, /* body */ js.Any) => Double): Self = this.set("delayStrategy", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setRetryStrategy(value: (/* err */ js.Error, /* response */ IncomingMessage, /* body */ js.Any) => Boolean): Self = this.set("retryStrategy", js.Any.fromFunction3(value))
