...
import typingsSlinky.request.mod.AWSOptions
import typingsSlinky.request.mod.AuthOptions
import typingsSlinky.request.mod.CookieJar
import typingsSlinky.request.mod.CoreOptions
import typingsSlinky.request.mod.HawkOptions
import typingsSlinky.request.mod.Headers
import typingsSlinky.request.mod.HttpArchiveRequest
import typingsSlinky.request.mod.Multipart
import typingsSlinky.request.mod.OAuthOptions
import typingsSlinky.request.mod.PoolOptions
import typingsSlinky.request.mod.RequestPart
...
object RequestRetryOptions {
  ...
  def apply(
    ...
    cert: Buffer = null,
    delayStrategy: (/* err */ js.Error, /* response */ IncomingMessage, /* body */ js.Any) => Double = null,
    ...
    retryStrategy: (/* err */ js.Error, /* response */ IncomingMessage, /* body */ js.Any) => Boolean = null,
    ...
    if (!js.isUndefined(fullResponse)) __obj.updateDynamic("fullResponse")(fullResponse.get.asInstanceOf[js.Any])
