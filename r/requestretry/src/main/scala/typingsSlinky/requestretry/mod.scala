...
object mod extends Shortcut {
  ...
  type DelayStrategy = js.Function3[/* err */ js.Error, /* response */ IncomingMessage, /* body */ js.Any, Double]
  ...
  object RequestRetryOptions {
    ...
    implicit class RequestRetryOptionsMutableBuilder[Self <: RequestRetryOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDelayStrategy(value: (/* err */ js.Error, /* response */ IncomingMessage, /* body */ js.Any) => Double): Self = StObject.set(x, "delayStrategy", js.Any.fromFunction3(value))
      ...
      @scala.inline
      def setRetryStrategy(value: (/* err */ js.Error, /* response */ IncomingMessage, /* body */ js.Any) => Boolean): Self = StObject.set(x, "retryStrategy", js.Any.fromFunction3(value))
