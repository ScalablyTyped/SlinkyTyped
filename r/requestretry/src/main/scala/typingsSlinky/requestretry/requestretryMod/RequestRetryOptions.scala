...
import typingsSlinky.request.requestMod.AWSOptions
import typingsSlinky.request.requestMod.AuthOptions
import typingsSlinky.request.requestMod.CookieJar
import typingsSlinky.request.requestMod.CoreOptions
import typingsSlinky.request.requestMod.HawkOptions
