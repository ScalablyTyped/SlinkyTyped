...
object AutoCompleteProps {
  ...
  implicit class AutoCompletePropsOps[Self <: AutoCompleteProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterResultsChildrenReactElement(value: ReactElement): Self = this.set("afterResultsChildren", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAfterResultsChildren(value: ReactElement): Self = this.set("afterResultsChildren", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBeforeResultsChildrenReactElement(value: ReactElement): Self = this.set("beforeResultsChildren", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBeforeResultsChildren(value: ReactElement): Self = this.set("beforeResultsChildren", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFilterOptions(value: typingsSlinky.reactMdAutocomplete.anon.FilterFunctionOptions): Self = this.set("filterOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetResultLabel(value: (/* data */ AutoCompleteData, /* labelKey */ String, /* query */ String) => ReactElement): Self = this.set("getResultLabel", js.Any.fromFunction3(value))
