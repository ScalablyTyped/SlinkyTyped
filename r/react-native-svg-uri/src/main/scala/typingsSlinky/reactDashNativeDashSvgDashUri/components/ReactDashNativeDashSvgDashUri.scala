...
object ReactDashNativeDashSvgDashUri
  ...
  typingsSlinky.reactDashNativeDashSvgDashUri.reactDashNativeDashSvgDashUriMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
