...
object WEBGLCompressedTextureS3tcSrgb {
  ...
  implicit class WEBGLCompressedTextureS3tcSrgbOps[Self <: WEBGLCompressedTextureS3tcSrgb] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCOMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT(value: GLenum): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCOMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT(value: GLenum): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCOMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT(value: GLenum): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCOMPRESSED_SRGB_S3TC_DXT1_EXT(value: GLenum): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("COMPRESSED_SRGB_S3TC_DXT1_EXT")(value.asInstanceOf[js.Any])
        ret
    }
  }
