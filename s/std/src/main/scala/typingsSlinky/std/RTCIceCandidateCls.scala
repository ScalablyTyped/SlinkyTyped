...
class RTCIceCandidateCls () extends RTCIceCandidate {
  def this(candidateInitDict: org.scalajs.dom.experimental.webrtc.RTCIceCandidateInit) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def toJSON(): org.scalajs.dom.experimental.webrtc.RTCIceCandidateInit = js.native
}
