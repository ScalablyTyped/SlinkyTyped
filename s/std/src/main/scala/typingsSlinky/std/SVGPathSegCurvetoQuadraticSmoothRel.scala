...
object SVGPathSegCurvetoQuadraticSmoothRel {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticSmoothRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticSmoothRel]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoQuadraticSmoothRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticSmoothRel] (val x: Self) extends AnyVal {
