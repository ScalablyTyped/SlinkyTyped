...
object SVGPathSegMovetoRel {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegMovetoRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegMovetoRel]
  }
  
  @scala.inline
  implicit class SVGPathSegMovetoRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegMovetoRel] (val x: Self) extends AnyVal {
