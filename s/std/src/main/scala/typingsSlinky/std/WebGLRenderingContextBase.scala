...
trait WebGLRenderingContextBase extends js.Object {
  ...
  def compileShader(shader: org.scalajs.dom.raw.WebGLShader): Unit = js.native
  def copyTexImage2D(
    target: GLenum,
    level: GLint,
  ...
  def createBuffer(): org.scalajs.dom.raw.WebGLBuffer | Null = js.native
  def createFramebuffer(): org.scalajs.dom.raw.WebGLFramebuffer | Null = js.native
  def createProgram(): org.scalajs.dom.raw.WebGLProgram | Null = js.native
  def createRenderbuffer(): org.scalajs.dom.raw.WebGLRenderbuffer | Null = js.native
  def createShader(`type`: GLenum): org.scalajs.dom.raw.WebGLShader | Null = js.native
  ...
  def detachShader(program: org.scalajs.dom.raw.WebGLProgram, shader: org.scalajs.dom.raw.WebGLShader): Unit = js.native
  ...
  def getActiveAttrib(program: org.scalajs.dom.raw.WebGLProgram, index: GLuint): org.scalajs.dom.raw.WebGLActiveInfo | Null = js.native
  def getActiveUniform(program: org.scalajs.dom.raw.WebGLProgram, index: GLuint): org.scalajs.dom.raw.WebGLActiveInfo | Null = js.native
  def getAttachedShaders(program: org.scalajs.dom.raw.WebGLProgram): js.Array[org.scalajs.dom.raw.WebGLShader] | Null = js.native
  def getAttribLocation(program: org.scalajs.dom.raw.WebGLProgram, name: java.lang.String): GLint = js.native
  def getBufferParameter(target: GLenum, pname: GLenum): js.Any = js.native
  def getContextAttributes(): org.scalajs.dom.raw.WebGLContextAttributes | Null = js.native
  def getError(): GLenum = js.native
  def getExtension(extensionName: java.lang.String): js.Any = js.native
  @JSName("getExtension")
  def getExtension_ANGLEinstancedarrays(extensionName: typingsSlinky.std.stdStrings.ANGLE_instanced_arrays): ANGLE_instanced_arrays | Null = js.native
  @JSName("getExtension")
  def getExtension_EXTblendminmax(extensionName: typingsSlinky.std.stdStrings.EXT_blend_minmax): EXT_blend_minmax | Null = js.native
  @JSName("getExtension")
  def getExtension_EXTfragdepth(extensionName: typingsSlinky.std.stdStrings.EXT_frag_depth): EXT_frag_depth | Null = js.native
  @JSName("getExtension")
  def getExtension_EXTsRGB(extensionName: typingsSlinky.std.stdStrings.EXT_sRGB): EXT_sRGB | Null = js.native
  @JSName("getExtension")
  def getExtension_EXTshadertexturelod(extensionName: typingsSlinky.std.stdStrings.EXT_shader_texture_lod): EXT_shader_texture_lod | Null = js.native
  @JSName("getExtension")
  def getExtension_EXTtexturefilteranisotropic(extensionName: typingsSlinky.std.stdStrings.EXT_texture_filter_anisotropic): EXT_texture_filter_anisotropic | Null = js.native
  @JSName("getExtension")
  def getExtension_OESelementindexuint(extensionName: typingsSlinky.std.stdStrings.OES_element_index_uint): OES_element_index_uint | Null = js.native
  @JSName("getExtension")
  def getExtension_OESstandardderivatives(extensionName: typingsSlinky.std.stdStrings.OES_standard_derivatives): OES_standard_derivatives | Null = js.native
  @JSName("getExtension")
  def getExtension_OEStexturefloat(extensionName: typingsSlinky.std.stdStrings.OES_texture_float): OES_texture_float | Null = js.native
  @JSName("getExtension")
  def getExtension_OEStexturefloatlinear(extensionName: typingsSlinky.std.stdStrings.OES_texture_float_linear): OES_texture_float_linear | Null = js.native
  @JSName("getExtension")
  def getExtension_OEStexturehalffloat(extensionName: typingsSlinky.std.stdStrings.OES_texture_half_float): OES_texture_half_float | Null = js.native
  @JSName("getExtension")
  def getExtension_OEStexturehalffloatlinear(extensionName: typingsSlinky.std.stdStrings.OES_texture_half_float_linear): OES_texture_half_float_linear | Null = js.native
  @JSName("getExtension")
  def getExtension_OESvertexarrayobject(extensionName: typingsSlinky.std.stdStrings.OES_vertex_array_object): OES_vertex_array_object | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLcolorbufferfloat(extensionName: typingsSlinky.std.stdStrings.WEBGL_color_buffer_float): WEBGL_color_buffer_float | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLcompressedtextureastc(extensionName: typingsSlinky.std.stdStrings.WEBGL_compressed_texture_astc): WEBGL_compressed_texture_astc | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLcompressedtextures3tc(extensionName: typingsSlinky.std.stdStrings.WEBGL_compressed_texture_s3tc): WEBGL_compressed_texture_s3tc | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLcompressedtextures3tcsrgb(extensionName: typingsSlinky.std.stdStrings.WEBGL_compressed_texture_s3tc_srgb): WEBGL_compressed_texture_s3tc_srgb | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLdebugrendererinfo(extensionName: typingsSlinky.std.stdStrings.WEBGL_debug_renderer_info): WEBGL_debug_renderer_info | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLdebugshaders(extensionName: typingsSlinky.std.stdStrings.WEBGL_debug_shaders): WEBGL_debug_shaders | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLdepthtexture(extensionName: typingsSlinky.std.stdStrings.WEBGL_depth_texture): WEBGL_depth_texture | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLdrawbuffers(extensionName: typingsSlinky.std.stdStrings.WEBGL_draw_buffers): WEBGL_draw_buffers | Null = js.native
  @JSName("getExtension")
  def getExtension_WEBGLlosecontext(extensionName: typingsSlinky.std.stdStrings.WEBGL_lose_context): WEBGL_lose_context | Null = js.native
  ...
  def getProgramParameter(program: org.scalajs.dom.raw.WebGLProgram, pname: GLenum): js.Any = js.native
  def getRenderbufferParameter(target: GLenum, pname: GLenum): js.Any = js.native
  def getShaderInfoLog(shader: org.scalajs.dom.raw.WebGLShader): java.lang.String | Null = js.native
  def getShaderParameter(shader: org.scalajs.dom.raw.WebGLShader, pname: GLenum): js.Any = js.native
  def getShaderPrecisionFormat(shadertype: GLenum, precisiontype: GLenum): org.scalajs.dom.raw.WebGLShaderPrecisionFormat | Null = js.native
  def getShaderSource(shader: org.scalajs.dom.raw.WebGLShader): java.lang.String | Null = js.native
  ...
  def getUniform(program: org.scalajs.dom.raw.WebGLProgram, location: org.scalajs.dom.raw.WebGLUniformLocation): js.Any = js.native
  def getUniformLocation(program: org.scalajs.dom.raw.WebGLProgram, name: java.lang.String): org.scalajs.dom.raw.WebGLUniformLocation | Null = js.native
  ...
  def shaderSource(shader: org.scalajs.dom.raw.WebGLShader, source: java.lang.String): Unit = js.native
