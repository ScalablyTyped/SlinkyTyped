...
import typingsSlinky.std.stdStrings.ANGLE_instanced_arrays
import typingsSlinky.std.stdStrings.EXT_blend_minmax
import typingsSlinky.std.stdStrings.EXT_frag_depth
import typingsSlinky.std.stdStrings.EXT_sRGB
import typingsSlinky.std.stdStrings.EXT_shader_texture_lod
import typingsSlinky.std.stdStrings.EXT_texture_filter_anisotropic
import typingsSlinky.std.stdStrings.OES_element_index_uint
import typingsSlinky.std.stdStrings.OES_standard_derivatives
import typingsSlinky.std.stdStrings.OES_texture_float
import typingsSlinky.std.stdStrings.OES_texture_float_linear
import typingsSlinky.std.stdStrings.OES_texture_half_float
import typingsSlinky.std.stdStrings.OES_texture_half_float_linear
import typingsSlinky.std.stdStrings.OES_vertex_array_object
import typingsSlinky.std.stdStrings.WEBGL_color_buffer_float
import typingsSlinky.std.stdStrings.WEBGL_compressed_texture_astc
import typingsSlinky.std.stdStrings.WEBGL_compressed_texture_s3tc
import typingsSlinky.std.stdStrings.WEBGL_compressed_texture_s3tc_srgb
import typingsSlinky.std.stdStrings.WEBGL_debug_renderer_info
import typingsSlinky.std.stdStrings.WEBGL_debug_shaders
