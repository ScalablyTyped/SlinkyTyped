...
trait SVGSVGElement
  ...
  def getComputedStyle(elt: Element): org.scalajs.dom.raw.CSSStyleDeclaration = js.native
  def getComputedStyle(elt: Element, pseudoElt: java.lang.String): org.scalajs.dom.raw.CSSStyleDeclaration = js.native
