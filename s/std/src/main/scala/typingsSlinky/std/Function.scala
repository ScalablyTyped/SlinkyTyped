...
trait Function extends js.Object {
  ...
  /**
    ...
    */
  @JSName("apply")
  def apply(`this`: js.Function, thisArg: js.Any): js.Any = js.native
  @JSName("apply")
  def apply(`this`: js.Function, thisArg: js.Any, argArray: js.Any): js.Any = js.native
  /**
    ...
    */
  def bind(`this`: js.Function, thisArg: js.Any, argArray: js.Any*): js.Any = js.native
  /**
