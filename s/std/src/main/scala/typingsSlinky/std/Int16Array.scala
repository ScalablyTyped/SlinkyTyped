...
trait Int16Array extends /* index */ NumberDictionary[Double] {
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _]): js.typedarray.Int16Array = js.native
  def filter(
    callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _],
    thisArg: js.Any
  ...
  def slice(start: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Int16Array = js.native
  ...
  def subarray(begin: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Int16Array = js.native
  ...
  val toStringTag: typingsSlinky.std.stdStrings.Int16Array = js.native
