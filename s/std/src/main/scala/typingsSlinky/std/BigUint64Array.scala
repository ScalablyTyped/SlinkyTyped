...
/**
  ...
  */
@js.native
trait BigUint64Array extends /* index */ NumberDictionary[BigInt] {
  ...
  val toStringTag: typingsSlinky.std.stdStrings.BigUint64Array = js.native
  /**
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ BigInt, /* index */ Double, /* array */ this.type, _]): BigUint64Array = js.native
  def filter(
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def map(callbackfn: js.Function3[/* value */ BigInt, /* index */ Double, /* array */ this.type, BigInt]): BigUint64Array = js.native
  def map(
