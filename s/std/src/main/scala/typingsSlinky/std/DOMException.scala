...
object DOMException {
  ...
  def apply(
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.DOMException]
  }
  
  @scala.inline
  implicit class DOMExceptionMutableBuilder[Self <: org.scalajs.dom.raw.DOMException] (val x: Self) extends AnyVal {
