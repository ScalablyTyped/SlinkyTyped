...
object WEBGLDebugShaders {
  ...
  implicit class WEBGLDebugShadersOps[Self <: WEBGLDebugShaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetTranslatedShaderSource(value: org.scalajs.dom.raw.WebGLShader => java.lang.String): Self = this.set("getTranslatedShaderSource", js.Any.fromFunction1(value))
  }
}
