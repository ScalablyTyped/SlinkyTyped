...
trait Event_ extends js.Object {
  ...
  /**
    ...
    */
  val currentTarget: org.scalajs.dom.raw.EventTarget | Null = js.native
  /**
  ...
  /**
    ...
    */
  val target: org.scalajs.dom.raw.EventTarget | Null = js.native
  /**
...
@js.native
object Event_
  extends Instantiable1[/* type */ java.lang.String, Event_]
     with Instantiable2[/* type */ java.lang.String, /* eventInitDict */ EventInit, Event_] {
  val AT_TARGET: Double = js.native
  val BUBBLING_PHASE: Double = js.native
  val CAPTURING_PHASE: Double = js.native
  val NONE: Double = js.native
