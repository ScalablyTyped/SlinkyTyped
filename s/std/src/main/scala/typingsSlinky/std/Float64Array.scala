...
trait Float64Array extends /* index */ NumberDictionary[Double] {
  ...
  val toStringTag: typingsSlinky.std.stdStrings.Float64Array = js.native
  /**
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _]): scala.scalajs.js.typedarray.Float64Array = js.native
  def filter(
    callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _],
    thisArg: js.Any
  ): scala.scalajs.js.typedarray.Float64Array = js.native
  /**
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def map(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Double]): scala.scalajs.js.typedarray.Float64Array = js.native
  def map(
  ...
  /**
    ...
    */
  def reverse(): scala.scalajs.js.typedarray.Float64Array = js.native
  /**
  ...
  /**
    ...
    */
  def slice(): scala.scalajs.js.typedarray.Float64Array = js.native
  def slice(start: Double): scala.scalajs.js.typedarray.Float64Array = js.native
  def slice(start: Double, end: Double): scala.scalajs.js.typedarray.Float64Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(): scala.scalajs.js.typedarray.Float64Array = js.native
  def subarray(begin: Double): scala.scalajs.js.typedarray.Float64Array = js.native
  def subarray(begin: Double, end: Double): scala.scalajs.js.typedarray.Float64Array = js.native
  /**
