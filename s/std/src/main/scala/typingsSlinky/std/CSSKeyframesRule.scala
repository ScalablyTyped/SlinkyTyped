...
object CSSKeyframesRule {
  ...
  implicit class CSSKeyframesRuleOps[Self <: org.scalajs.dom.raw.CSSKeyframesRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeleteRule(value: java.lang.String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteRule")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFindRule(value: java.lang.String => org.scalajs.dom.raw.CSSKeyframeRule | Null): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("findRule")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
