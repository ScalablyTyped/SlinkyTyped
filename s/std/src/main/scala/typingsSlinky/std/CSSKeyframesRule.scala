...
object CSSKeyframesRule {
  ...
  implicit class CSSKeyframesRuleOps[Self <: org.scalajs.dom.raw.CSSKeyframesRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCssRules(value: org.scalajs.dom.raw.CSSRuleList): Self = this.set("cssRules", value.asInstanceOf[js.Any])
    @scala.inline
    def setDeleteRule(value: java.lang.String => Unit): Self = this.set("deleteRule", js.Any.fromFunction1(value))
    @scala.inline
    def setFindRule(value: java.lang.String => org.scalajs.dom.raw.CSSKeyframeRule | Null): Self = this.set("findRule", js.Any.fromFunction1(value))
    @scala.inline
