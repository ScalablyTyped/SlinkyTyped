...
object SVGPathSegLinetoHorizontalRel {
  ...
  def apply(
    ...
    x: Double
  ): org.scalajs.dom.raw.SVGPathSegLinetoHorizontalRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegLinetoHorizontalRel]
  }
  
  @scala.inline
  implicit class SVGPathSegLinetoHorizontalRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegLinetoHorizontalRel] (val x: Self) extends AnyVal {
