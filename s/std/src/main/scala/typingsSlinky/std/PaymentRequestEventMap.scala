...
object PaymentRequestEventMap {
  ...
  implicit class PaymentRequestEventMapOps[Self <: PaymentRequestEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShippingaddresschange(value: org.scalajs.dom.raw.Event): Self = this.set("shippingaddresschange", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShippingoptionchange(value: org.scalajs.dom.raw.Event): Self = this.set("shippingoptionchange", value.asInstanceOf[js.Any])
  }
}
