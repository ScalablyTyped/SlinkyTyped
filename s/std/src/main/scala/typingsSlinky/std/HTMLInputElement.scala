...
trait HTMLInputElement extends HTMLElement {
  ...
  /**
    ...
    */
  var files: org.scalajs.dom.raw.FileList | Null = js.native
  ...
  val labels: (org.scalajs.dom.raw.NodeListOf[org.scalajs.dom.raw.HTMLLabelElement with org.scalajs.dom.raw.Node]) | Null = js.native
  
  /**
    * Specifies the ID of a pre-defined datalist of options for an input element.
    */
  val list: org.scalajs.dom.raw.HTMLElement | Null = js.native
