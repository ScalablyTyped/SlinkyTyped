...
object StaticRangeInit {
  ...
  implicit class StaticRangeInitOps[Self <: StaticRangeInit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndContainer(value: org.scalajs.dom.raw.Node): Self = this.set("endContainer", value.asInstanceOf[js.Any])
    @scala.inline
    def setEndOffset(value: Double): Self = this.set("endOffset", value.asInstanceOf[js.Any])
    @scala.inline
    def setStartContainer(value: org.scalajs.dom.raw.Node): Self = this.set("startContainer", value.asInstanceOf[js.Any])
    @scala.inline
