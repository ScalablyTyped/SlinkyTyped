...
trait Int8ArrayConstructor
  extends Instantiable0[js.typedarray.Int8Array]
     with Instantiable1[
  ...
  def from(arrayLike: js.Iterable[Double], mapfn: js.UndefOr[scala.Nothing], thisArg: js.Any): js.typedarray.Int8Array = js.native
