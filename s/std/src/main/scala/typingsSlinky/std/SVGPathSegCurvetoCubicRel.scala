...
object SVGPathSegCurvetoCubicRel {
  ...
  def apply(
    ...
    y1: Double,
    y2: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoCubicRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoCubicRel]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoCubicRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoCubicRel] (val x: Self) extends AnyVal {
