...
object AuthenticationExtensionsClientInputs {
  ...
  implicit class AuthenticationExtensionsClientInputsOps[Self <: AuthenticationExtensionsClientInputs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAppid(value: java.lang.String): Self = {
    ...
    @scala.inline
    def withAuthnSel(value: AuthenticatorSelectionList): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withExts(value: scala.Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLoc(value: scala.Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUvi(value: scala.Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUvm(value: scala.Boolean): Self = {
        val ret = this.duplicate
