...
package object std {
  ...
  */
  ...
  type EventHandlerNonNull = js.Function1[/* event */ typingsSlinky.std.Event_, js.Any]
  type EventListener = js.Function1[/* evt */ typingsSlinky.std.Event_, scala.Unit]
  ...
  */
  type MessageEventSource = typingsSlinky.std._MessageEventSource | typingsSlinky.std.WindowProxy
  ...
  type OnBeforeUnloadEventHandlerNonNull = js.Function1[/* event */ typingsSlinky.std.Event_, java.lang.String | scala.Null]
  ...
  type OnErrorEventHandlerNonNull = js.Function5[
    /* event */ typingsSlinky.std.Event_ | java.lang.String, 
  ...
  type WindowProxy = typingsSlinky.std.Window_
  ...
  type XPathNSResolver = (js.Function1[/* prefix */ java.lang.String | scala.Null, java.lang.String | scala.Null]) | typingsSlinky.std.AnonLookupNamespaceURI
