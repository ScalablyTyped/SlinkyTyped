...
object SVGPathSegCurvetoQuadraticRel {
  ...
  def apply(
    ...
    y: Double,
    y1: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticRel]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoQuadraticRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticRel] (val x: Self) extends AnyVal {
