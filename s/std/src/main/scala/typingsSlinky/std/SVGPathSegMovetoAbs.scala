...
object SVGPathSegMovetoAbs {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegMovetoAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegMovetoAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegMovetoAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegMovetoAbs] (val x: Self) extends AnyVal {
