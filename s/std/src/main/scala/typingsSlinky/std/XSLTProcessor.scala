...
object XSLTProcessor {
  ...
  implicit class XSLTProcessorOps[Self <: XSLTProcessor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImportStylesheet(value: org.scalajs.dom.raw.Node => Unit): Self = this.set("importStylesheet", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setTransformToDocument(value: org.scalajs.dom.raw.Node => org.scalajs.dom.raw.Document): Self = this.set("transformToDocument", js.Any.fromFunction1(value))
    @scala.inline
    ...
    ): Self = this.set("transformToFragment", js.Any.fromFunction2(value))
  }
