...
trait DocumentEventMap
  ...
  var pointerlockchange: Event_ = js.native
  var pointerlockerror: Event_ = js.native
  var readystatechange: Event_ = js.native
  var visibilitychange: Event_ = js.native
}
...
object DocumentEventMap {
  ...
  implicit class DocumentEventMapOps[Self <: DocumentEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPointerlockchange(value: Event_): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pointerlockchange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPointerlockerror(value: Event_): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVisibilitychange(value: Event_): Self = {
        val ret = this.duplicate
