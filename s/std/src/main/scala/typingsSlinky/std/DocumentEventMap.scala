...
trait DocumentEventMap
  ...
  var pointerlockchange: org.scalajs.dom.raw.Event = js.native
  var pointerlockerror: org.scalajs.dom.raw.Event = js.native
  var readystatechange: org.scalajs.dom.raw.Event = js.native
  var visibilitychange: org.scalajs.dom.raw.Event = js.native
}
...
object DocumentEventMap {
  ...
  implicit class DocumentEventMapOps[Self <: DocumentEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFullscreenchange(value: org.scalajs.dom.raw.Event): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fullscreenchange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFullscreenerror(value: org.scalajs.dom.raw.Event): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fullscreenerror")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPointerlockchange(value: org.scalajs.dom.raw.Event): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pointerlockchange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPointerlockerror(value: org.scalajs.dom.raw.Event): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pointerlockerror")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withVisibilitychange(value: org.scalajs.dom.raw.Event): Self = {
        val ret = this.duplicate
