...
object XPathResult {
  ...
  implicit class XPathResultOps[Self <: org.scalajs.dom.raw.XPathResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIterateNext(value: () => org.scalajs.dom.raw.Node | Null): Self = this.set("iterateNext", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setSnapshotItem(value: Double => org.scalajs.dom.raw.Node | Null): Self = this.set("snapshotItem", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSingleNodeValue(value: org.scalajs.dom.raw.Node): Self = this.set("singleNodeValue", value.asInstanceOf[js.Any])
    @scala.inline
