...
trait Uint8Array extends /* index */ NumberDictionary[Double] {
  ...
  def slice(start: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Uint8Array = js.native
  ...
  def subarray(begin: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Uint8Array = js.native
  ...
  val toStringTag: typingsSlinky.std.stdStrings.Uint8Array = js.native
