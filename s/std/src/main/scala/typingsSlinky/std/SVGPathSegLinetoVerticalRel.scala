...
object SVGPathSegLinetoVerticalRel {
  ...
  def apply(
    ...
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegLinetoVerticalRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegLinetoVerticalRel]
  }
  
  @scala.inline
  implicit class SVGPathSegLinetoVerticalRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegLinetoVerticalRel] (val x: Self) extends AnyVal {
