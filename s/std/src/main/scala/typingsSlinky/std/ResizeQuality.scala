...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.std.stdStrings.pixelated
*/
trait ResizeQuality extends js.Object
object ResizeQuality {
  ...
  @scala.inline
  def pixelated: typingsSlinky.std.stdStrings.pixelated = "pixelated".asInstanceOf[typingsSlinky.std.stdStrings.pixelated]
}
