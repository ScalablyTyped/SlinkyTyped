...
object PushSubscriptionOptionsInit {
  ...
  implicit class PushSubscriptionOptionsInitOps[Self <: PushSubscriptionOptionsInit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApplicationServerKeyArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("applicationServerKey", value.asInstanceOf[js.Any])
    @scala.inline
    def setApplicationServerKeyArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("applicationServerKey", value.asInstanceOf[js.Any])
    @scala.inline
