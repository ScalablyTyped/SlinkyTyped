...
object SVGPathSegLinetoRel {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegLinetoRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegLinetoRel]
  }
  
  @scala.inline
  implicit class SVGPathSegLinetoRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegLinetoRel] (val x: Self) extends AnyVal {
