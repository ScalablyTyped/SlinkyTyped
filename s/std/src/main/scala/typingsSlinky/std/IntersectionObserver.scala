...
object IntersectionObserver {
  ...
  implicit class IntersectionObserverOps[Self <: IntersectionObserver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObserve(value: org.scalajs.dom.raw.Element => Unit): Self = this.set("observe", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRoot(value: org.scalajs.dom.raw.Element): Self = this.set("root", value.asInstanceOf[js.Any])
