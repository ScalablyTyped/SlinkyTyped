...
object ReadableStreamReader {
  ...
  @scala.inline
  implicit class ReadableStreamReaderOps[Self <: org.scalajs.dom.experimental.ReadableStreamReader[_], R] (val x: Self with org.scalajs.dom.experimental.ReadableStreamReader[R]) extends AnyVal {
    @scala.inline
