...
trait Window
  ...
  def getMatchedCSSRules(elt: Element): org.scalajs.dom.raw.CSSRuleList = js.native
  def getMatchedCSSRules(elt: Element, pseudoElt: java.lang.String): org.scalajs.dom.raw.CSSRuleList = js.native
