...
@js.native
class SVGPathSegArcAbsCls () extends SVGPathSegArcAbs {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var largeArcFlag: scala.Boolean = js.native
  /* CompleteClass */
  override val pathSegType: Double = js.native
  /* CompleteClass */
  override val pathSegTypeAsLetter: java.lang.String = js.native
  /* CompleteClass */
  override var r1: Double = js.native
  /* CompleteClass */
  override var r2: Double = js.native
  /* CompleteClass */
  override var sweepFlag: scala.Boolean = js.native
  /* CompleteClass */
