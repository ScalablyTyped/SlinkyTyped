...
trait ObjectConstructor
  ...
  {[ k in std.PropertyKey ]: T}
    */ typingsSlinky.std.stdStrings.ObjectConstructor with js.Any = js.native
  /**
  ...
  /**
    ...
    * @param o Object that contains the properties and methods. This can be an object that you created or an existing Document Object Model (DOM) object.
    */
  def getOwnPropertyDescriptors[T](o: T): typingsSlinky.std.stdStrings.ObjectConstructor with T with StringDictionary[js.PropertyDescriptor] = js.native
  /**
