...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.std.stdStrings.alphabetic
  - typingsSlinky.std.stdStrings.bottom
  - typingsSlinky.std.stdStrings.hanging
  - typingsSlinky.std.stdStrings.ideographic
  - typingsSlinky.std.stdStrings.middle
  - typingsSlinky.std.stdStrings.top
*/
