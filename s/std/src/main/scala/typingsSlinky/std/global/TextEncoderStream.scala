...
class TextEncoderStream ()
  extends typingsSlinky.std.TextEncoderStream {
  /**
    * Returns "utf-8".
    */
  /* CompleteClass */
  ...
  /* CompleteClass */
  @JSName("writable")
  override val writable_TextEncoderStream: typingsSlinky.std.WritableStream[java.lang.String] = js.native
}

@JSGlobal("TextEncoderStream")
@js.native
object TextEncoderStream
  extends Instantiable0[typingsSlinky.std.TextEncoderStream]
