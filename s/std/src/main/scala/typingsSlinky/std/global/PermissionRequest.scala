...
import typingsSlinky.std.MSWebViewPermissionState
import typingsSlinky.std.MSWebViewPermissionType
...
class PermissionRequest ()
  extends typingsSlinky.std.PermissionRequest {
  /* CompleteClass */
...
object PermissionRequest
  extends Instantiable0[typingsSlinky.std.PermissionRequest]
