...
import typingsSlinky.std.NavigationType
...
class PerformanceNavigationTiming ()
  extends typingsSlinky.std.PerformanceNavigationTiming {
  /* CompleteClass */
...
object PerformanceNavigationTiming
  extends Instantiable0[typingsSlinky.std.PerformanceNavigationTiming]
