...
import typingsSlinky.std.Intl.BCP47LanguageTag
import typingsSlinky.std.Intl.RelativeTimeFormatOptions
...
object RelativeTimeFormat
  ...
  */
Instantiable0[typingsSlinky.std.Intl.RelativeTimeFormat]
     with Instantiable1[
      (/* locales */ js.Array[BCP47LanguageTag]) | (/* locales */ BCP47LanguageTag), 
      typingsSlinky.std.Intl.RelativeTimeFormat
    ]
     with Instantiable2[
