...
object MediaTrackSettings {
  ...
  @scala.inline
  implicit class MediaTrackSettingsOps[Self <: org.scalajs.dom.experimental.mediastream.MediaTrackSettings] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFacingMode(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withResizeMode(value: java.lang.String): Self = {
        val ret = this.duplicate
