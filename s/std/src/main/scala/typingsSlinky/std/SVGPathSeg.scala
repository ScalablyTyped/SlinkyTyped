...
object SVGPathSeg {
  ...
  def apply(
  ...
  ): org.scalajs.dom.raw.SVGPathSeg = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSeg]
  }
  
  @scala.inline
  implicit class SVGPathSegMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSeg] (val x: Self) extends AnyVal {
