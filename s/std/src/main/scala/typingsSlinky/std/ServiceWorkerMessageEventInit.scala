...
object ServiceWorkerMessageEventInit {
  ...
  implicit class ServiceWorkerMessageEventInitOps[Self <: org.scalajs.dom.experimental.serviceworkers.ServiceWorkerMessageEventInit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPortsNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ports")(null)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSource(value: org.scalajs.dom.experimental.serviceworkers.ServiceWorker | org.scalajs.dom.raw.MessagePort): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("source")(value.asInstanceOf[js.Any])
        ret
    }
