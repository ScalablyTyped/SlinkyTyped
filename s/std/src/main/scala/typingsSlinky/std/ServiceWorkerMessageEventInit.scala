...
trait ServiceWorkerMessageEventInit extends EventInit {
  ...
  var ports: js.UndefOr[js.Array[org.scalajs.dom.raw.MessagePort] | Null] = js.undefined
...
object ServiceWorkerMessageEventInit {
  ...
  def apply(
    ...
    ports: js.UndefOr[Null | js.Array[org.scalajs.dom.raw.MessagePort]] = js.undefined,
    source: js.UndefOr[
      Null | org.scalajs.dom.experimental.serviceworkers.ServiceWorker | org.scalajs.dom.raw.MessagePort
    ] = js.undefined
