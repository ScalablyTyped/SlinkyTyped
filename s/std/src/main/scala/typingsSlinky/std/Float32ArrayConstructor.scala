...
trait Float32ArrayConstructor
  extends Instantiable0[js.typedarray.Float32Array]
     with Instantiable1[
  ...
  def from(arrayLike: js.Iterable[Double], mapfn: js.UndefOr[scala.Nothing], thisArg: js.Any): js.typedarray.Float32Array = js.native
  ...
  def from[T](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, Double], thisArg: js.Any): js.typedarray.Float32Array = js.native
