...
object SVGPathSegCurvetoQuadraticAbs {
  ...
  def apply(
    ...
    y: Double,
    y1: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoQuadraticAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticAbs] (val x: Self) extends AnyVal {
