...
object HTMLMarqueeElementEventMap {
  ...
  implicit class HTMLMarqueeElementEventMapOps[Self <: HTMLMarqueeElementEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBounce(value: org.scalajs.dom.raw.Event): Self = this.set("bounce", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFinish(value: org.scalajs.dom.raw.Event): Self = this.set("finish", value.asInstanceOf[js.Any])
