...
trait HTMLMarqueeElementEventMap extends HTMLElementEventMap {
  ...
  var bounce: org.scalajs.dom.raw.Event = js.native
  
  var finish: org.scalajs.dom.raw.Event = js.native
...
object HTMLMarqueeElementEventMap {
  ...
  def apply(
    ...
    bounce: org.scalajs.dom.raw.Event,
    ...
    finish: org.scalajs.dom.raw.Event,
  ...
  implicit class HTMLMarqueeElementEventMapMutableBuilder[Self <: HTMLMarqueeElementEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBounce(value: org.scalajs.dom.raw.Event): Self = StObject.set(x, "bounce", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFinish(value: org.scalajs.dom.raw.Event): Self = StObject.set(x, "finish", value.asInstanceOf[js.Any])
