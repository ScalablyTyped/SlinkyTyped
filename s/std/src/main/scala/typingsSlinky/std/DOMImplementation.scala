...
trait DOMImplementation extends js.Object {
  ...
  def createDocument(namespaceURI: java.lang.String, qualifiedName: java.lang.String, doctype: DocumentType): org.scalajs.dom.raw.Document = js.native
  def createDocument(namespaceURI: java.lang.String, qualifiedName: Null, doctype: DocumentType): org.scalajs.dom.raw.Document = js.native
  def createDocument(namespaceURI: Null, qualifiedName: java.lang.String): org.scalajs.dom.raw.Document = js.native
  def createDocument(namespaceURI: Null, qualifiedName: java.lang.String, doctype: DocumentType): org.scalajs.dom.raw.Document = js.native
  def createDocument(namespaceURI: Null, qualifiedName: Null, doctype: DocumentType): org.scalajs.dom.raw.Document = js.native
