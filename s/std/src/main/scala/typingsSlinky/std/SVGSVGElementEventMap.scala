...
trait SVGSVGElementEventMap
  ...
  var SVGUnload: org.scalajs.dom.raw.Event = js.native
...
object SVGSVGElementEventMap {
  @scala.inline
  def apply(
    SVGUnload: org.scalajs.dom.raw.Event,
  ...
  implicit class SVGSVGElementEventMapOps[Self <: SVGSVGElementEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSVGUnload(value: org.scalajs.dom.raw.Event): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SVGUnload")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSVGZoom(value: SVGZoomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SVGZoom")(value.asInstanceOf[js.Any])
        ret
    }
  }
