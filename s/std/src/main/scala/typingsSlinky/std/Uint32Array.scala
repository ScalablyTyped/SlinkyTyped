...
trait Uint32Array extends /* index */ NumberDictionary[Double] {
  ...
  val toStringTag: typingsSlinky.std.stdStrings.Uint32Array = js.native
  /**
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _]): js.typedarray.Uint32Array = js.native
  def filter(
    callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _],
    thisArg: js.Any
  ...
  def slice(start: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Uint32Array = js.native
  ...
  def subarray(begin: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Uint32Array = js.native
