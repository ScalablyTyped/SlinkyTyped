...
trait HTMLMediaElementEventMap
  ...
  var msneedkey: MSMediaKeyNeededEvent = js.native
  var waitingforkey: org.scalajs.dom.raw.Event = js.native
}
...
object HTMLMediaElementEventMap {
  ...
  def apply(
    ...
    fullscreenchange: org.scalajs.dom.raw.Event,
    fullscreenerror: org.scalajs.dom.raw.Event,
  ...
  implicit class HTMLMediaElementEventMapOps[Self <: HTMLMediaElementEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEncrypted(value: MediaEncryptedEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("encrypted")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMsneedkey(value: MSMediaKeyNeededEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("msneedkey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withWaitingforkey(value: org.scalajs.dom.raw.Event): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waitingforkey")(value.asInstanceOf[js.Any])
        ret
    }
  }
