...
import typingsSlinky.swiper.swiperMod.DOM7Element
import typingsSlinky.swiper.swiperMod.SelectableElement
import typingsSlinky.swiper.swiperMod.SwiperModule
import typingsSlinky.swiper.swiperMod.SwiperOptions
import typingsSlinky.swiper.swiperMod.default
