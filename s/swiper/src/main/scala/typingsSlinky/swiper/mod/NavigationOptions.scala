...
object NavigationOptions {
  ...
  implicit class NavigationOptionsMutableBuilder[Self <: NavigationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextElHTMLElement(value: HTMLElement): Self = StObject.set(x, "nextEl", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrevElHTMLElement(value: HTMLElement): Self = StObject.set(x, "prevEl", value.asInstanceOf[js.Any])
