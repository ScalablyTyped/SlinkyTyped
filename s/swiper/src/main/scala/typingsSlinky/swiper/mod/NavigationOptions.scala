...
object NavigationOptions {
  ...
  implicit class NavigationOptionsOps[Self <: NavigationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextElHTMLElement(value: HTMLElement): Self = this.set("nextEl", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrevElHTMLElement(value: HTMLElement): Self = this.set("prevEl", value.asInstanceOf[js.Any])
