...
object PaginationOptions {
  ...
  def apply(
    ...
    renderBullet: (/* index */ Double, /* className */ String) => Unit = null,
    renderCustom: (/* swiper */ Swiper, /* current */ Double, /* total */ Double) => Unit = null,
    renderFraction: (/* currentClass */ String, /* totalClass */ String) => Unit = null,
    renderProgressbar: /* progressbarFillClass */ String => Unit = null,
