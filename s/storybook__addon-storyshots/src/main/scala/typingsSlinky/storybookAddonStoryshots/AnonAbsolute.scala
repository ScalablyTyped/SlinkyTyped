...
trait AnonAbsolute extends js.Object {
  ...
  var statCache: js.UndefOr[StringDictionary[`false` | AnonIsDirectory]] = js.native
...
object AnonAbsolute {
  @scala.inline
  def apply(absolute: Boolean, ignore: js.Array[String]): AnonAbsolute = {
  ...
  implicit class AnonAbsoluteOps[Self <: AnonAbsolute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStatCache(value: StringDictionary[`false` | AnonIsDirectory]): Self = {
        val ret = this.duplicate
