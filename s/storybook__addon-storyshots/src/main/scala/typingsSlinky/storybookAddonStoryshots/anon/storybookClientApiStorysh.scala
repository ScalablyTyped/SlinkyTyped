...
object storybookClientApiStorysh {
  ...
  implicit class storybookClientApiStoryshOps[Self <: storybookClientApiStorysh] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStoryKindRegexRegExp(value: js.RegExp): Self = this.set("storyKindRegex", value.asInstanceOf[js.Any])
    @scala.inline
    def setStoryKindRegex(value: js.RegExp | String): Self = this.set("storyKindRegex", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteStoryKindRegex: Self = this.set("storyKindRegex", js.undefined)
    @scala.inline
    def setStoryNameRegexRegExp(value: js.RegExp): Self = this.set("storyNameRegex", value.asInstanceOf[js.Any])
    @scala.inline
    def setStoryNameRegex(value: js.RegExp | String): Self = this.set("storyNameRegex", value.asInstanceOf[js.Any])
    @scala.inline
