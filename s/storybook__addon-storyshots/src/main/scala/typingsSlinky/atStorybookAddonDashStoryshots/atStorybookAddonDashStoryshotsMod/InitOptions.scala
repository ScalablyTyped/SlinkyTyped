...
trait InitOptions[Rendered] extends js.Object {
  ...
  var storyKindRegex: js.UndefOr[js.RegExp] = js.undefined
  var storyNameRegex: js.UndefOr[js.RegExp] = js.undefined
...
object InitOptions {
  ...
  def apply[Rendered](
    ...
    storyKindRegex: js.RegExp = null,
    storyNameRegex: js.RegExp = null,
    suite: String = null,
