...
version := "7.0-dt-20200205Z-5ecdf9"
scalaVersion := "2.13.1"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.4",
  "org.scalablytyped.slinky" %%% "ag-channel" % "4.0-dt-20200205Z-d0ace5",
  ...
  "org.scalablytyped.slinky" %%% "socketcluster-client" % "15.1-dt-20200214Z-d67236",
  "org.scalablytyped.slinky" %%% "socketcluster-server" % "15.0-dt-20200214Z-ef34bd",
