...
version := "7.0-dt-20200519Z-4350f3"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "socketcluster-client" % "15.1-dt-20200624Z-fbff4a",
  "org.scalablytyped.slinky" %%% "socketcluster-server" % "15.0-dt-20200214Z-112639",
