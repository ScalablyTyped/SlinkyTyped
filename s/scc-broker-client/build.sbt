...
version := "6.1-dt-20191126Z-cf43a1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "sc-broker" % "5.1-dt-20191126Z-e870e9",
  ...
  "org.scalablytyped.slinky" %%% "socketcluster-client" % "13.0-dt-20191126Z-a645f4",
