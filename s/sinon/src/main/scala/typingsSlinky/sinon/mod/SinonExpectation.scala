...
import typingsSlinky.sinon.anon.MatchArgumentsArrayany
import typingsSlinky.sinon.anon.PartialMatchArgumentsArra
...
trait SinonExpectation extends js.Object {
  ...
  /**
    ...
    * @param name
    */
  def named(name: String): SinonStub[js.Array[_], _] = js.native
  /**
    * Set the displayName of the spy or stub.
    * @param name
    */
  @JSName("named")
  def named_SinonSpy(name: String): SinonSpy[js.Array[_], _] = js.native
