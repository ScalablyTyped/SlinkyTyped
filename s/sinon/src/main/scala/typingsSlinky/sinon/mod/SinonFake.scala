...
trait SinonFake extends js.Object {
  ...
  /**
    ...
    */
  def apply(fn: js.Function): SinonSpy[js.Array[_], _] = js.native
  ...
  /**
    ...
    */
  def rejects(`val`: js.Any): SinonSpy[js.Array[_], _] = js.native
  
  /**
    * Creates a fake that returns a resolved Promise for the passed value.
    * @param val Resolved promise
    */
  def resolves(`val`: js.Any): SinonSpy[js.Array[_], _] = js.native
  
  /**
    * Creates a fake that returns the val argument
    * @param val Returned value
    */
  def returns(`val`: js.Any): SinonSpy[js.Array[_], _] = js.native
  
  def throws(`val`: String): SinonSpy[js.Array[_], _] = js.native
  /**
