...
trait SinonFakeTimers extends js.Object {
  ...
  def requestAnimationFrame_Double(callback: js.Function1[/* time */ Double, Unit]): Double = js.native
  /**
  ...
  def requestIdleCallback_Double(callback: js.Function0[Unit]): Double = js.native
  @JSName("requestIdleCallback")
  def requestIdleCallback_Double(callback: js.Function0[Unit], timeout: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("setImmediate")
  def setImmediate_Double(callback: js.Function1[/* repeated */ js.Any, Unit], args: js.Any*): Double = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("setInterval")
  def setInterval_Double(callback: js.Function1[/* repeated */ js.Any, Unit], timeout: Double, args: js.Any*): Double = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("setTimeout")
  def setTimeout_Double(callback: js.Function1[/* repeated */ js.Any, Unit], timeout: Double, args: js.Any*): Double = js.native
