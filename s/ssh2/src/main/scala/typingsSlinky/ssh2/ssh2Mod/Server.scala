...
import typingsSlinky.ssh2.Anon_Address
import typingsSlinky.ssh2.Anon_Fd
import typingsSlinky.ssh2.ssh2Strings.close
import typingsSlinky.ssh2.ssh2Strings.connection
...
class Server protected () extends EventEmitter {
  ...
  def close(callback: js.Function1[/* err */ js.Error, Unit]): this.type = js.native
  /**
    * Asynchronously get the number of concurrent connections on the server.
    */
  def getConnections(callback: js.Function2[/* err */ js.Error, /* count */ Double, Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback An optional callback to add to the `listening` event of the server.
    */
  def listen(handle: typingsSlinky.node.netMod.Server): this.type = js.native
  def listen(handle: typingsSlinky.node.netMod.Server, backlog: Double): this.type = js.native
  def listen(handle: typingsSlinky.node.netMod.Server, backlog: Double, callback: js.Function0[Unit]): this.type = js.native
  def listen(handle: typingsSlinky.node.netMod.Server, callback: js.Function0[Unit]): this.type = js.native
