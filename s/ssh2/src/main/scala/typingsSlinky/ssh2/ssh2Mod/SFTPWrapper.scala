...
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsMod.FileEntry
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsMod.InputAttributes
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsMod.ReadFileOptions
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsMod.ReadStreamOptions
...
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsMod.WriteStreamOptions
