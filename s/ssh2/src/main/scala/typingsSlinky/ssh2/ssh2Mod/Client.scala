...
class Client () extends EventEmitter {
  ...
  def exec(
    command: String,
    options: ExecOptions,
    callback: js.Function2[/* err */ js.Error, /* channel */ ClientChannel, Unit]
  ): Boolean = js.native
  /**
  ...
  def forwardIn(
    remoteAddr: String,
    remotePort: Double,
    callback: js.Function2[/* err */ js.Error, /* bindPort */ Double, Unit]
  ): Boolean = js.native
  /**
  ...
  def openssh_forwardInStreamLocal(socketPath: String, callback: js.Function1[/* err */ js.Error, Unit]): Boolean = js.native
  /**
  ...
  def openssh_forwardOutStreamLocal(socketPath: String, callback: js.Function2[/* err */ js.Error, /* channel */ ClientChannel, Unit]): Boolean = js.native
  /**
  ...
  def openssh_noMoreSessions(callback: js.Function1[/* err */ js.Error, Unit]): Boolean = js.native
  /**
  ...
  def openssh_unforwardInStreamLocal(socketPath: String, callback: js.Function1[/* err */ js.Error, Unit]): Boolean = js.native
  /**
    ...
    */
  def sftp(callback: js.Function2[/* err */ js.Error, /* sftp */ SFTPWrapper, Unit]): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def subsys(subsystem: String, callback: js.Function2[/* err */ js.Error, /* channel */ ClientChannel, Unit]): Boolean = js.native
  /**
  ...
  def unforwardIn(remoteAddr: String, remotePort: Double, callback: js.Function1[/* err */ js.Error, Unit]): Boolean = js.native
}
