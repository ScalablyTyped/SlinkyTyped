...
import typingsSlinky.ssh2.ssh2Strings.`change password`
import typingsSlinky.ssh2.ssh2Strings.`keyboard-interactive`
import typingsSlinky.ssh2.ssh2Strings.`tcp connection`
import typingsSlinky.ssh2.ssh2Strings.banner
import typingsSlinky.ssh2.ssh2Strings.close
import typingsSlinky.ssh2.ssh2Strings.connect
import typingsSlinky.ssh2.ssh2Strings.continue
import typingsSlinky.ssh2.ssh2Strings.end
import typingsSlinky.ssh2.ssh2Strings.error
import typingsSlinky.ssh2.ssh2Strings.greeting
import typingsSlinky.ssh2.ssh2Strings.ready
...
class Client () extends EventEmitter {
  ...
  def forwardIn(
    remoteAddr: String,
    remotePort: Double,
    callback: js.Function2[/* err */ js.UndefOr[js.Error], /* bindPort */ Double, Unit]
  ): Boolean = js.native
  ...
  /**
    ...
    */
  @JSName("on")
  def on_error(event: error, listener: js.Function1[/* err */ js.Error with ClientErrorExtensions, Unit]): this.type = js.native
  /**
  ...
  def openssh_forwardInStreamLocal(socketPath: String, callback: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Boolean = js.native
  ...
  def openssh_noMoreSessions(callback: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Boolean = js.native
  ...
  def openssh_unforwardInStreamLocal(socketPath: String, callback: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Boolean = js.native
  ...
  /**
    ...
    */
  def sftp(callback: js.Function2[/* err */ js.UndefOr[js.Error], /* sftp */ SFTPWrapper, Unit]): Boolean = js.native
