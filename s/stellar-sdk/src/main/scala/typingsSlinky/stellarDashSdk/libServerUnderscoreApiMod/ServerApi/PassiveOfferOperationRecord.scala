...
import typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseType.createPassiveOffer
...
trait PassiveOfferOperationRecord
  extends BaseOperationRecord[
      createPassiveOffer, 
      typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.createPassiveOffer
    ]
