...
import typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseType.bumpSequence
...
trait BumpSequenceOperationRecord
  extends BaseOperationRecord[
      bumpSequence, 
      typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.bumpSequence
    ]
