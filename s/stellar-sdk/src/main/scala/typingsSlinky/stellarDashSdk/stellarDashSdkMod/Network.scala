...
class Network protected ()
  extends typingsSlinky.stellarDashBase.stellarDashBaseMod.Network {
...
object Network extends js.Object {
  def current(): typingsSlinky.stellarDashBase.stellarDashBaseMod.Network = js.native
  def networkId(): String = js.native
  def networkPassphrase(): String = js.native
  def use(network: typingsSlinky.stellarDashBase.stellarDashBaseMod.Network): Unit = js.native
