...
import typingsSlinky.stellarDashSdk.libStellarUnderscoreTomlUnderscoreResolverMod.StellarTomlResolver.StellarTomlResolveOptions
...
class StellarTomlResolver ()
  extends typingsSlinky.stellarDashSdk.libStellarUnderscoreTomlUnderscoreResolverMod.StellarTomlResolver
