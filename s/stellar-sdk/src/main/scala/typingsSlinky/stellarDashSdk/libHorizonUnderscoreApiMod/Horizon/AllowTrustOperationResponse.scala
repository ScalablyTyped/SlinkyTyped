...
import typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseType.allowTrust
...
trait AllowTrustOperationResponse
  extends BaseOperationResponse[
      allowTrust, 
      typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.allowTrust
    ] {
...
object AllowTrustOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typingsSlinky.stellarDashSdk.stellarDashSdkStrings.BaseResponse with js.Any,
    ...
    trustor: String,
    `type`: allowTrust,
    type_i: typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.allowTrust
