...
import typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.TransactionFailedExtras
import typingsSlinky.stellarDashSdk.stellarDashSdkNumbers.`400`
import typingsSlinky.stellarDashSdk.stellarDashSdkStrings.`Transaction Failed`
