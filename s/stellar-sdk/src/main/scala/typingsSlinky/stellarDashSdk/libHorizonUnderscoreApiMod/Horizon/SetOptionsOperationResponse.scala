...
import typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseType.setOptions
import typingsSlinky.stellarDashSdk.stellarDashSdkNumbers.`1`
import typingsSlinky.stellarDashSdk.stellarDashSdkNumbers.`2`
import typingsSlinky.stellarDashSdk.stellarDashSdkStrings.auth_required_flag
import typingsSlinky.stellarDashSdk.stellarDashSdkStrings.auth_revocable_flag
...
trait SetOptionsOperationResponse
  extends BaseOperationResponse[
      setOptions, 
      typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.setOptions
    ] {
...
object SetOptionsOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typingsSlinky.stellarDashSdk.stellarDashSdkStrings.BaseResponse with js.Any,
    ...
    `type`: setOptions,
    type_i: typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.setOptions,
