...
import typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseType.createAccount
...
trait CreateAccountOperationResponse
  extends BaseOperationResponse[
      createAccount, 
      typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.createAccount
    ] {
  var account: String
  var funder: String
...
object CreateAccountOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typingsSlinky.stellarDashSdk.stellarDashSdkStrings.BaseResponse with js.Any,
    account: String,
    created_at: String,
    funder: String,
    id: String,
    ...
    `type`: createAccount,
    type_i: typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.createAccount
