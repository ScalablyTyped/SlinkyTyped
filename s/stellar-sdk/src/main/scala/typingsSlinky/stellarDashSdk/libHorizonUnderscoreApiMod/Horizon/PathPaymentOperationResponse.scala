...
import typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseType.pathPayment
...
trait PathPaymentOperationResponse
  extends BaseOperationResponse[
      pathPayment, 
      typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.pathPayment
    ] {
  var amount: String
...
object PathPaymentOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typingsSlinky.stellarDashSdk.stellarDashSdkStrings.BaseResponse with js.Any,
    ...
    `type`: pathPayment,
    type_i: typingsSlinky.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.pathPayment,
