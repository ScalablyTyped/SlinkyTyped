...
object Records {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.BaseResponse[scala.Nothing] */ T](records: js.Array[T]): Records[T] = {
    val __obj = js.Dynamic.literal(records = records.asInstanceOf[js.Any])
    __obj.asInstanceOf[Records[T]]
  }
  @scala.inline
  implicit class RecordsOps[Self <: Records[_], /* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.BaseResponse[scala.Nothing] */ T] (val x: Self with Records[T]) extends AnyVal {
    @scala.inline
