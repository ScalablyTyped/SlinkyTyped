...
object CollectionPage {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.BaseResponse[scala.Nothing] */ T](
  ...
  @scala.inline
  implicit class CollectionPageOps[Self <: CollectionPage[_], /* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.BaseResponse[scala.Nothing] */ T] (val x: Self with CollectionPage[T]) extends AnyVal {
    @scala.inline
