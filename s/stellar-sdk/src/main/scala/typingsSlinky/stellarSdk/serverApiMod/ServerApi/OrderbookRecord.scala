...
import typingsSlinky.stellarSdk.AnonAmount
...
trait OrderbookRecord
  ...
  var asks: js.Array[AnonAmount] = js.native
  var base: Asset = js.native
  var bids: js.Array[AnonAmount] = js.native
...
object OrderbookRecord {
  ...
  implicit class OrderbookRecordOps[Self <: OrderbookRecord] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAsks(value: js.Array[AnonAmount]): Self = {
    ...
    @scala.inline
    def withBids(value: js.Array[AnonAmount]): Self = {
        val ret = this.duplicate
