...
import typingsSlinky.stellarSdk.horizonApiMod.Horizon.OperationResponseType.revokeSponsorship
...
- typingsSlinky.stellarSdk.horizonApiMod.Horizon.RevokeSponsorshipOperationResponse because var conflicts: _links, created_at, id, paging_token, source_account, transaction_hash, `type`, type_i. Inlined account_id, claimable_balance_id, data_account_id, data_name, offer_id, trustline_account_id, trustline_asset, signer_account_id, signer_key */ @js.native
trait RevokeSponsorshipOperationRecord
  extends BaseOperationRecord[
      revokeSponsorship, 
      typingsSlinky.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.revokeSponsorship
    ]
