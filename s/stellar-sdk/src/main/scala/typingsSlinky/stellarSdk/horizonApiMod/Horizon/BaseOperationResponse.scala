...
object BaseOperationResponse {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.OperationResponseType */ T, /* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI */ TI](
  ...
  @scala.inline
  implicit class BaseOperationResponseOps[Self <: BaseOperationResponse[_, _], /* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.OperationResponseType */ T, /* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI */ TI] (val x: Self with (BaseOperationResponse[T, TI])) extends AnyVal {
    @scala.inline
