...
object BalanceLineAsset {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarBase.mod.AssetType.credit4 | typingsSlinky.stellarBase.mod.AssetType.credit12 */ T](
    asset_code: String,
    asset_issuer: String,
    asset_type: T,
    balance: String,
  ...
  @scala.inline
  implicit class BalanceLineAssetOps[Self <: BalanceLineAsset[_], /* <: typingsSlinky.stellarBase.mod.AssetType.credit4 | typingsSlinky.stellarBase.mod.AssetType.credit12 */ T] (val x: Self with BalanceLineAsset[T]) extends AnyVal {
    @scala.inline
