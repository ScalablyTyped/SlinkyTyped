...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.stellarSdk.horizonApiMod.Horizon.ErrorResponseData.RateLimitExceeded
  - typingsSlinky.stellarSdk.horizonApiMod.Horizon.ErrorResponseData.InternalServerError
  - typingsSlinky.stellarSdk.horizonApiMod.Horizon.ErrorResponseData.TransactionFailed
*/
