...
object ResponseCollection {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.BaseResponse[scala.Nothing] */ T](_embedded: Records[T], _links: Next): ResponseCollection[T] = {
  ...
  @scala.inline
  implicit class ResponseCollectionOps[Self <: ResponseCollection[_], /* <: typingsSlinky.stellarSdk.horizonApiMod.Horizon.BaseResponse[scala.Nothing] */ T] (val x: Self with ResponseCollection[T]) extends AnyVal {
    @scala.inline
