...
@JSImport("stellar-sdk", "xdr.PaymentResult")
@js.native
class PaymentResult ()
  extends typingsSlinky.stellarBase.mod.xdr.PaymentResult
object PaymentResult {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.PaymentResult.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-sdk", "xdr.PaymentResult.write")
  @js.native
