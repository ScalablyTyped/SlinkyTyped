...
class AuthenticatedMessageV0 protected ()
  extends typingsSlinky.stellarBase.mod.xdr.AuthenticatedMessageV0 {
  def this(attributes: Mac) = this()
}
object AuthenticatedMessageV0 {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.AuthenticatedMessageV0.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-sdk", "xdr.AuthenticatedMessageV0.write")
  @js.native
