...
class CreatePassiveSellOfferOp protected ()
  extends typingsSlinky.stellarBase.mod.xdr.CreatePassiveSellOfferOp {
  def this(attributes: typingsSlinky.stellarBase.anon.Price) = this()
}
object CreatePassiveSellOfferOp {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.CreatePassiveSellOfferOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-sdk", "xdr.CreatePassiveSellOfferOp.write")
  @js.native
