...
@JSImport("stellar-sdk", "xdr.AccountEntryExtensionV2Ext")
@js.native
class AccountEntryExtensionV2Ext ()
  extends typingsSlinky.stellarBase.mod.xdr.AccountEntryExtensionV2Ext
object AccountEntryExtensionV2Ext {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.AccountEntryExtensionV2Ext.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-sdk", "xdr.AccountEntryExtensionV2Ext.write")
  @js.native
  def write(value: typingsSlinky.stellarBase.xdrMod.xdr.AccountEntryExtensionV2Ext, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.AccountEntryExtensionV2Ext.0")
  @js.native
