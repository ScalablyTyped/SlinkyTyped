...
object ServerTime {
  ...
  implicit class ServerTimeOps[Self <: ServerTime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLocalTimeRecorded(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("localTimeRecorded")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withServerTime(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("serverTime")(value.asInstanceOf[js.Any])
        ret
    }
  }
