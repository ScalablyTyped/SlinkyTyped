...
object Route {
  ...
  @scala.inline
  def apply(hideOnly: Boolean, path: String, startsWith: Boolean): Default[tag.type, js.Object] = {
    val __props = js.Dynamic.literal(hideOnly = hideOnly.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], startsWith = startsWith.asInstanceOf[js.Any])
