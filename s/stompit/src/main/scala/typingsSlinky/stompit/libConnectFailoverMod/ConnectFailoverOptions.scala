  ...
  var connectFunction: js.UndefOr[
    js.Function2[
      ...
      /* connectionListener */ js.UndefOr[
        js.Function2[/* err */ js.Error | Null, /* client */ typingsSlinky.stompit.libClientMod.^, Unit]
      ], 
      typingsSlinky.stompit.libClientMod.^
    ]
  ] = js.undefined
...
object ConnectFailoverOptions {
  ...
  def apply(
    connectFunction: (/* options */ ConnectOptions, /* connectionListener */ js.UndefOr[
      js.Function2[/* err */ js.Error | Null, /* client */ typingsSlinky.stompit.libClientMod.^, Unit]
    ]) => typingsSlinky.stompit.libClientMod.^ = null,
