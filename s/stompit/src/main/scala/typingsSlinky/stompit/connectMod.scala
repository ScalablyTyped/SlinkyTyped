...
import typingsSlinky.stompit.clientMod.^
...
object connectMod {
  ...
  */
  ...
  object ConnectOptions {
    ...
    @scala.inline
    def NetIpcConnectOptions(path: String): typingsSlinky.stompit.connectMod.NetIpcConnectOptions = {
      val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stompit.connectMod.NetIpcConnectOptions]
    }
    
    @scala.inline
    def NetTcpConnectOptions(port: Double): typingsSlinky.stompit.connectMod.NetTcpConnectOptions = {
      val __obj = js.Dynamic.literal(port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stompit.connectMod.NetTcpConnectOptions]
    }
    
    @scala.inline
    def SslConnectOptions(ssl: `true`): typingsSlinky.stompit.connectMod.SslConnectOptions = {
      val __obj = js.Dynamic.literal(ssl = ssl.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stompit.connectMod.SslConnectOptions]
    }
  }
  
  type ConnectionListener = js.Function2[/* err */ js.Error | Null, /* client */ ^, Unit]
