package typingsSlinky.stompit.libClientMod
...
@js.native
trait Client
  extends typingsSlinky.stompit.libSocketMod.^ {
  ...
  def getSubscription(id: Double): typingsSlinky.stompit.libClientSubscriptionMod.^ = js.native
  ...
  def readEmptyBody(frame: typingsSlinky.stompit.libIncomingFrameStreamMod.^): Unit = js.native
  def readEmptyBody(
    frame: typingsSlinky.stompit.libIncomingFrameStreamMod.^,
  ...
  def setImplicitSubscription(id: Double): typingsSlinky.stompit.libClientSubscriptionMod.^ = js.native
  def setImplicitSubscription(id: Double, ack: Ack): typingsSlinky.stompit.libClientSubscriptionMod.^ = js.native
  def setImplicitSubscription(id: Double, ack: Ack, messageListener: MessageCallback): typingsSlinky.stompit.libClientSubscriptionMod.^ = js.native
  def subscribe(): typingsSlinky.stompit.libClientSubscriptionMod.^ = js.native
  def subscribe(headers: js.Any): typingsSlinky.stompit.libClientSubscriptionMod.^ = js.native
  def subscribe(headers: js.Any, messageListener: MessageCallback): typingsSlinky.stompit.libClientSubscriptionMod.^ = js.native
}
