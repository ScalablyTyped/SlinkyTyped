...
object Options_ {
  ...
  def apply(
    ...
    if (!js.isUndefined(commitAll)) __obj.updateDynamic("commitAll")(commitAll.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(firstRelease)) __obj.updateDynamic("firstRelease")(firstRelease.get.asInstanceOf[js.Any])
    if (!js.isUndefined(gitTagFallback)) __obj.updateDynamic("gitTagFallback")(gitTagFallback.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(noVerify)) __obj.updateDynamic("noVerify")(noVerify.get.asInstanceOf[js.Any])
