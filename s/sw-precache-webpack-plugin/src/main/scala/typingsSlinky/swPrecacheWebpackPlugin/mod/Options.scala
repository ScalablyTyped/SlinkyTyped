...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStaticFileGlobsIgnorePatternsVarargs(value: js.RegExp*): Self = this.set("staticFileGlobsIgnorePatterns", js.Array(value :_*))
    
    @scala.inline
    def setStaticFileGlobsIgnorePatterns(value: js.Array[js.RegExp]): Self = this.set("staticFileGlobsIgnorePatterns", value.asInstanceOf[js.Any])
