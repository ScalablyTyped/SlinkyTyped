...
object config extends js.Object {
  ...
  def apply(entry: js.UndefOr[scala.Nothing], hasAddDecorator: LinkOptions): js.Array[_] = js.native
  def apply(entry: js.Array[_]): js.Array[_] = js.native
  def apply(entry: js.Array[_], hasAddDecorator: LinkOptions): js.Array[_] = js.native
}
