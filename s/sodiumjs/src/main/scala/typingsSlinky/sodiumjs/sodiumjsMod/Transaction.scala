...
@js.native
class Transaction ()
  extends typingsSlinky.sodiumjs.distTypingsSodiumTransactionMod.Transaction
...
object Transaction extends js.Object {
  ...
  var currentTransaction: typingsSlinky.sodiumjs.distTypingsSodiumTransactionMod.Transaction = js.native
