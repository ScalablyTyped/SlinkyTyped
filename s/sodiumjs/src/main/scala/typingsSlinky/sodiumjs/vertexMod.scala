...
import typingsSlinky.typescriptCollections.mod.Set
...
object vertexMod {
  ...
  object Color extends StObject {
    ...
    /* 0 */ val black: typingsSlinky.sodiumjs.vertexMod.Color.black with Double = js.native
    
    @js.native
    sealed trait gray extends Color
    /* 1 */ val gray: typingsSlinky.sodiumjs.vertexMod.Color.gray with Double = js.native
    
    @js.native
    sealed trait purple extends Color
    /* 3 */ val purple: typingsSlinky.sodiumjs.vertexMod.Color.purple with Double = js.native
    
    @js.native
    sealed trait white extends Color
    /* 2 */ val white: typingsSlinky.sodiumjs.vertexMod.Color.white with Double = js.native
  }
