...
import typingsSlinky.stickyCluster.AnonStickyclusterworkerindex
...
trait Options extends js.Object {
  ...
  var env: js.UndefOr[js.Function1[/* index */ Double, AnonStickyclusterworkerindex]] = js.native
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnv(value: /* index */ Double => AnonStickyclusterworkerindex): Self = {
        val ret = this.duplicate
