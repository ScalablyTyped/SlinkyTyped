...
import typingsSlinky.scDashChannel.scDashChannelStrings.pending
import typingsSlinky.scDashChannel.scDashChannelStrings.subscribed
import typingsSlinky.scDashChannel.scDashChannelStrings.unsubscribed
...
class SCChannel protected () extends Emitter {
  ...
  def publish(data: js.Any, callback: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
