...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.saml20.mod.ValidationOptionsWithKey
    - typingsSlinky.saml20.mod.ValidationOptionsWithPrint
  */
  trait ValidationOptions extends StObject
  object ValidationOptions {
    
    @scala.inline
    def ValidationOptionsWithKey(publicKey: String): typingsSlinky.saml20.mod.ValidationOptionsWithKey = {
      val __obj = js.Dynamic.literal(publicKey = publicKey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.saml20.mod.ValidationOptionsWithKey]
    }
    
    @scala.inline
    def ValidationOptionsWithPrint(thumbprint: String): typingsSlinky.saml20.mod.ValidationOptionsWithPrint = {
      val __obj = js.Dynamic.literal(thumbprint = thumbprint.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.saml20.mod.ValidationOptionsWithPrint]
    }
  }
