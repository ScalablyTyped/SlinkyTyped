...
object libXMLMod extends js.Object {
  ...
  object XML extends js.Object {
    ...
    type Iterator = typingsSlinky.tstl.containerHashMapMod.HashMap.Iterator[String, XMLList]
    type ReverseIterator = typingsSlinky.tstl.containerHashMapMod.HashMap.ReverseIterator[String, XMLList]
    type iterator = typingsSlinky.sxml.libXMLMod.XML.Iterator
