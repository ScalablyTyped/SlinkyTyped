...
import typingsSlinky.sharp.mod.OutputInfo
...
object anon {
  ...
  object Create {
    ...
    implicit class CreateMutableBuilder[Self <: Create] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCreate(value: typingsSlinky.sharp.mod.Create): Self = StObject.set(x, "create", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Data extends StObject {
    ...
    var data: typingsSlinky.node.Buffer = js.native
  ...
  object Data {
    ...
    @scala.inline
    def apply(data: typingsSlinky.node.Buffer, info: OutputInfo): Data = {
    ...
    implicit class DataMutableBuilder[Self <: Data] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setData(value: typingsSlinky.node.Buffer): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
  ...
  object Raw {
    ...
    implicit class RawMutableBuilder[Self <: Raw] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRaw(value: typingsSlinky.sharp.mod.Raw): Self = StObject.set(x, "raw", value.asInstanceOf[js.Any])
    }
  }
