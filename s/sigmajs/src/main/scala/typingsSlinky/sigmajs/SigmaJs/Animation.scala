...
object Animation {
  ...
  implicit class AnimationOps[Self <: Animation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCamera(value: (Camera, StringDictionary[js.Any], StringDictionary[js.Any]) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("camera")(js.Any.fromFunction3(value))
        ret
    }
  }
