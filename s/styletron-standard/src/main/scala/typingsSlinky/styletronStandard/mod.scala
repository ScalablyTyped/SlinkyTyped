...
object mod {
  ...
  type Properties = typingsSlinky.csstype.mod.Properties[String | Double]
  ...
  type StyleObject = Properties with typingsSlinky.styletronStandard.styletronStandardStrings.StyleObject with TopLevel[js.Any]
}
