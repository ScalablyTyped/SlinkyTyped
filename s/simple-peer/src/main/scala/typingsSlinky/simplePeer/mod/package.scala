...
package object mod {
  type SimplePeerData = java.lang.String | typingsSlinky.node.Buffer | typingsSlinky.simplePeer.mod.TypedArray | js.typedarray.ArrayBuffer | org.scalajs.dom.raw.Blob
