...
trait Typeofshipit extends js.Object {
  ...
  def initConfig(config: js.Object): typingsSlinky.shipitCli.Typeofshipit = js.native
  ...
  def start(tasks: String*): typingsSlinky.shipitCli.Typeofshipit = js.native
  def start(tasks: String): typingsSlinky.shipitCli.Typeofshipit = js.native
  def start(tasks: js.Array[String]): typingsSlinky.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: js.Array[String]): typingsSlinky.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: js.Array[String], fn: js.Function0[Unit]): typingsSlinky.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: EmptyCallback): typingsSlinky.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: EmptyCallback, fn: js.Function0[Unit]): typingsSlinky.shipitCli.Typeofshipit = js.native
}
