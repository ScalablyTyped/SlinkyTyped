...
trait Typeofshipit extends js.Object {
  ...
  def initConfig(config: js.Object): typingsSlinky.shipitDashCli.Typeofshipit = js.native
  ...
  def start(tasks: String*): typingsSlinky.shipitDashCli.Typeofshipit = js.native
  def start(tasks: String): typingsSlinky.shipitDashCli.Typeofshipit = js.native
  def start(tasks: js.Array[String]): typingsSlinky.shipitDashCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: js.Array[String]): typingsSlinky.shipitDashCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: js.Array[String], fn: js.Function0[Unit]): typingsSlinky.shipitDashCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: EmptyCallback): typingsSlinky.shipitDashCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: EmptyCallback, fn: js.Function0[Unit]): typingsSlinky.shipitDashCli.Typeofshipit = js.native
}
