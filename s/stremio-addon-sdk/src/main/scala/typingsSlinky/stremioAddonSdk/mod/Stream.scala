...
object Stream {
  @scala.inline
  def apply(
    behaviorHints: CountryWhitelist = null,
    externalUrl: String = null,
    fileIdx: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(fileIdx)) __obj.updateDynamic("fileIdx")(fileIdx.get.asInstanceOf[js.Any])
