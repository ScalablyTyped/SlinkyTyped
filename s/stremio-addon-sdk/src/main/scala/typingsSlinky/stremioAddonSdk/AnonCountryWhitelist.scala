...
@js.native
trait AnonCountryWhitelist extends js.Object {
  /**
...
object AnonCountryWhitelist {
  @scala.inline
  def apply(): AnonCountryWhitelist = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCountryWhitelist]
  }
  @scala.inline
  implicit class AnonCountryWhitelistOps[Self <: AnonCountryWhitelist] (val x: Self) extends AnyVal {
    @scala.inline
