...
import typingsSlinky.shopifyDashPrime.distModelsPriceUnderscoreRuleMod.PriceRule
...
import typingsSlinky.shopifyDashPrime.distServicesPriceUnderscoreRulesMod.PriceRules
