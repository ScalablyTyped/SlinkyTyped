package typingsSlinky.shopifyDashPrime.distModelsWebhookMod
...
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.json
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.xml
