...
object distInfrastructureMod extends js.Object {
  ...
  class BaseService protected ()
    extends typingsSlinky.shopifyDashPrime.distInfrastructureBaseUnderscoreServiceMod.BaseService {
    def this(shopDomain: String, accessToken: String, resource: String) = this()
  }
  
  @js.native
  class ShopifyError protected ()
    extends typingsSlinky.shopifyDashPrime.distInfrastructureShopifyUnderscoreErrorMod.ShopifyError {
