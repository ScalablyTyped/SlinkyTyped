package typingsSlinky.shopifyDashPrime.distModelsMetaUnderscoreFieldMod

import typingsSlinky.shopifyDashPrime.distModelsBaseMod.ShopifyObject
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.integer
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.string
