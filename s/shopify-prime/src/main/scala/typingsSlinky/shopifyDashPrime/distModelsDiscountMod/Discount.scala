package typingsSlinky.shopifyDashPrime.distModelsDiscountMod

import typingsSlinky.shopifyDashPrime.distModelsBaseMod.ShopifyObject
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.applies_to_resource
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.custom_collection
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.fixed_amount
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.percentage
import typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.shipping
...
trait Discount extends ShopifyObject {
  ...
  var applies_to_resource: js.UndefOr[
    typingsSlinky.shopifyDashPrime.shopifyDashPrimeStrings.applies_to_resource | custom_collection | String
  ] = js.undefined
  /**
