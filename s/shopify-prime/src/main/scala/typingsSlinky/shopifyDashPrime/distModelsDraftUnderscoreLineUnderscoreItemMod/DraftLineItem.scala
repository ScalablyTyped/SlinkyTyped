package typingsSlinky.shopifyDashPrime.distModelsDraftUnderscoreLineUnderscoreItemMod
...
import typingsSlinky.shopifyDashPrime.distModelsLineUnderscoreItemUnderscorePropertyMod.LineItemProperty
