...
@JSImport("shopify-prime/dist/tests/products", JSImport.Namespace)
@js.native
object distTestsProductsMod extends js.Object {
  @js.native
  class ProductTests () extends js.Object {
    ...
    def Test8(): js.Promise[Unit] = js.native
