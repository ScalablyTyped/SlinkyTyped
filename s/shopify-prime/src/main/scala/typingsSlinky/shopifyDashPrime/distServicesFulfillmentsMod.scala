...
import typingsSlinky.shopifyDashPrime.distModelsFulfillmentMod.Fulfillment
...
import typingsSlinky.shopifyDashPrime.distServicesFulfillmentsMod.Fulfillments
