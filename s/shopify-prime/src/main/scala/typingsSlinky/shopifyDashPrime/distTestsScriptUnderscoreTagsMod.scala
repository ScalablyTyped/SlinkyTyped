...
@JSImport("shopify-prime/dist/tests/script_tags", JSImport.Namespace)
@js.native
object distTestsScriptUnderscoreTagsMod extends js.Object {
  @js.native
  class ScriptTagTests () extends js.Object {
