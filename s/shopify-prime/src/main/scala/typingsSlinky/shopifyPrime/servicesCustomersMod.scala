...
import typingsSlinky.shopifyPrime.customerMod.CustomerInvite
import typingsSlinky.shopifyPrime.customersMod.CustomerSearchOptions
...
@js.native
object servicesCustomersMod extends js.Object {
