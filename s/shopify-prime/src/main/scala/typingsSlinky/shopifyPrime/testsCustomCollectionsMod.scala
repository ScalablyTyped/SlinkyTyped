...
@JSImport("shopify-prime/dist/tests/custom_collections", JSImport.Namespace)
@js.native
object testsCustomCollectionsMod extends js.Object {
  @js.native
  class CustomCollectionTests () extends js.Object {
