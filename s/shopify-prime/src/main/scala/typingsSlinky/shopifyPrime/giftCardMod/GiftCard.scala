...
object GiftCard {
  ...
  implicit class GiftCardOps[Self <: GiftCard] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisabled_at(value: js.Date): Self = this.set("disabled_at", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisabled_at: Self = this.set("disabled_at", js.undefined)
    @scala.inline
    def setExpires_on(value: js.Date): Self = this.set("expires_on", value.asInstanceOf[js.Any])
    @scala.inline
