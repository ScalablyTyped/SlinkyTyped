...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEntries(value: js.Array[_] | js.RegExp | EntriesFunction): Self = StObject.set(x, "entries", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEntriesFunction1(value: /* key */ String => Boolean): Self = StObject.set(x, "entries", js.Any.fromFunction1(value))
      
      @scala.inline
      def setEntriesRegExp(value: js.RegExp): Self = StObject.set(x, "entries", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setErrorHandler(value: (/* err */ js.Error, /* invokeErr */ js.Function0[Unit]) => Unit): Self = StObject.set(x, "errorHandler", js.Any.fromFunction2(value))
