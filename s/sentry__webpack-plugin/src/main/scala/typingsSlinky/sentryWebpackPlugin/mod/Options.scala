...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesRegExp(value: js.RegExp): Self = this.set("entries", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEntries(value: js.Array[_] | js.RegExp | EntriesFunction): Self = this.set("entries", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEntries: Self = this.set("entries", js.undefined)
    
    @scala.inline
    def setErrorHandler(value: (/* err */ js.Error, /* invokeErr */ js.Function0[Unit]) => Unit): Self = this.set("errorHandler", js.Any.fromFunction2(value))
