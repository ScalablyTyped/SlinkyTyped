...
object Options {
  ...
  def apply(
    ...
    errorHandler: (/* err */ js.Error, /* invokeErr */ js.Function0[Unit]) => Unit = null,
    ...
    if (!js.isUndefined(sourceMapReference)) __obj.updateDynamic("sourceMapReference")(sourceMapReference.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stripCommonPrefix)) __obj.updateDynamic("stripCommonPrefix")(stripCommonPrefix.get.asInstanceOf[js.Any])
