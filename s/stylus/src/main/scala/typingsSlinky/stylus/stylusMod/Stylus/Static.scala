...
trait Static extends js.Object {
  var Compiler: Instantiable0[typingsSlinky.stylus.stylusMod.Stylus.Compiler] = js.native
  var Evaluator: Instantiable0[typingsSlinky.stylus.stylusMod.Stylus.Evaluator] = js.native
  var Parser: Instantiable0[typingsSlinky.stylus.stylusMod.Stylus.Parser] = js.native
  var Visitor: Instantiable0[typingsSlinky.stylus.stylusMod.Stylus.Visitor] = js.native
  /**
    * Expose BIFs.
    */
