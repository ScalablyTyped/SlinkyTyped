...
trait Static extends StObject {
  ...
  var Compiler: Instantiable0[typingsSlinky.stylus.mod.Stylus.Compiler] = js.native
  
  var Evaluator: Instantiable0[typingsSlinky.stylus.mod.Stylus.Evaluator] = js.native
  
  var Parser: Instantiable0[typingsSlinky.stylus.mod.Stylus.Parser] = js.native
  
  var Visitor: Instantiable0[typingsSlinky.stylus.mod.Stylus.Visitor] = js.native
