...
import typingsSlinky.stylus.mod.Stylus.Nodes.Boolean
...
import typingsSlinky.stylus.mod.Stylus.Nodes.Number
...
import typingsSlinky.stylus.mod.Stylus.Nodes.String
