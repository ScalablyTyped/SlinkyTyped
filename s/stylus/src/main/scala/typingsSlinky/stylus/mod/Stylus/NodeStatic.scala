...
object NodeStatic {
  ...
  implicit class NodeStaticOps[Self <: NodeStatic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoolean(value: Instantiable0[typingsSlinky.stylus.mod.Stylus.Nodes.Boolean]): Self = this.set("Boolean", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setString(value: Instantiable1[/* val */ String, typingsSlinky.stylus.mod.Stylus.Nodes.String]): Self = this.set("String", value.asInstanceOf[js.Any])
    @scala.inline
    def setTernary(
    ...
    @scala.inline
    def setFalse(value: typingsSlinky.stylus.mod.Stylus.Nodes.Boolean): Self = this.set("false", value.asInstanceOf[js.Any])
    @scala.inline
    def setTrue(value: typingsSlinky.stylus.mod.Stylus.Nodes.Boolean): Self = this.set("true", value.asInstanceOf[js.Any])
  }
