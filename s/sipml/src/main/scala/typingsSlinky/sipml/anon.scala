...
object anon {
  ...
  trait Listener extends StObject {
    ...
    var events: typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType | js.Array[typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType] = js.native
    
    def listener(e: typingsSlinky.sipml.SIPml.Stack.Event): Unit = js.native
  }
  object Listener {
    
    @scala.inline
    def apply(
      events: typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType | js.Array[typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType],
      listener: typingsSlinky.sipml.SIPml.Stack.Event => Unit
    ): Listener = {
      val __obj = js.Dynamic.literal(events = events.asInstanceOf[js.Any], listener = js.Any.fromFunction1(listener))
    ...
    implicit class ListenerMutableBuilder[Self <: Listener] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEvents(
        value: typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType | js.Array[typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType]
      ): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEventsVarargs(value: typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType*): Self = StObject.set(x, "events", js.Array(value :_*))
      
      @scala.inline
      def setListener(value: typingsSlinky.sipml.SIPml.Stack.Event => Unit): Self = StObject.set(x, "listener", js.Any.fromFunction1(value))
    }
  }
