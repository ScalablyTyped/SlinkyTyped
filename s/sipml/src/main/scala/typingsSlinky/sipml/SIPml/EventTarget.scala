...
object EventTarget {
  @scala.inline
  def apply[/* <: java.lang.String */ EventSubscriptionType, /* <: typingsSlinky.sipml.SIPml.Event */ EventType](
  ...
  @scala.inline
  implicit class EventTargetOps[Self <: EventTarget[_, _], /* <: java.lang.String */ EventSubscriptionType, /* <: typingsSlinky.sipml.SIPml.Event */ EventType] (val x: Self with (EventTarget[EventSubscriptionType, EventType])) extends AnyVal {
    @scala.inline
