...
import typingsSlinky.sipml.SIPml.Session
...
object Event {
  ...
  implicit class EventOps[Self <: Event] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNewSession(value: Session): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("newSession")(value.asInstanceOf[js.Any])
        ret
    }
  }
