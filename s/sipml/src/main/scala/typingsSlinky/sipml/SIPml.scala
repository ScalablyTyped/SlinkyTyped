...
object SIPml {
  ...
  object Session {
    ...
    object Call {
      ...
      /**
        ...
        * "i_info" |
        */
      type EventSubscriptionType = typingsSlinky.sipml.SIPml.Session.EventSubscriptionType
    }
    ...
    object Event {
      ...
      def apply(
        ...
        session: Session,
        `type`: String
      ): typingsSlinky.sipml.SIPml.Session.Event = {
        ...
        __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.sipml.SIPml.Session.Event]
      }
      
      @scala.inline
      implicit class EventMutableBuilder[Self <: typingsSlinky.sipml.SIPml.Session.Event] (val x: Self) extends AnyVal {
  ...
  trait Stack
    extends EventTarget[
          typingsSlinky.sipml.SIPml.Stack.EventSubscriptionType, 
          typingsSlinky.sipml.SIPml.Stack.Event
        ] {
  ...
  object Stack {
    ...
    object Configuration {
      ...
      @scala.inline
      def apply(): typingsSlinky.sipml.SIPml.Stack.Configuration = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.sipml.SIPml.Stack.Configuration]
      }
      
      @scala.inline
      implicit class ConfigurationMutableBuilder[Self <: typingsSlinky.sipml.SIPml.Stack.Configuration] (val x: Self) extends AnyVal {
    ...
    object Event {
      ...
      def apply(
        ...
        __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.sipml.SIPml.Stack.Event]
      }
      
      @scala.inline
      implicit class EventMutableBuilder[Self <: typingsSlinky.sipml.SIPml.Stack.Event] (val x: Self) extends AnyVal {
