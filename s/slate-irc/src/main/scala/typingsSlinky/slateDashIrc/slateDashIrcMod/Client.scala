package typingsSlinky.slateDashIrc.slateDashIrcMod

import typingsSlinky.slateDashIrc.Anon_Mode
import typingsSlinky.slateDashIrc.slateDashIrcStrings.away
import typingsSlinky.slateDashIrc.slateDashIrcStrings.data
import typingsSlinky.slateDashIrc.slateDashIrcStrings.join
import typingsSlinky.slateDashIrc.slateDashIrcStrings.message
import typingsSlinky.slateDashIrc.slateDashIrcStrings.mode
import typingsSlinky.slateDashIrc.slateDashIrcStrings.motd
import typingsSlinky.slateDashIrc.slateDashIrcStrings.nick
import typingsSlinky.slateDashIrc.slateDashIrcStrings.notice
import typingsSlinky.slateDashIrc.slateDashIrcStrings.part
import typingsSlinky.slateDashIrc.slateDashIrcStrings.quit
import typingsSlinky.slateDashIrc.slateDashIrcStrings.topic
import typingsSlinky.slateDashIrc.slateDashIrcStrings.welcome
...
class Client () extends js.Object {
  ...
  def names(
    channel: String,
    callback: js.Function2[/* error */ js.Error, /* names */ js.Array[Anon_Mode], Unit]
  ): Unit = js.native
