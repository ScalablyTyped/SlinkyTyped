...
import typingsSlinky.saucelabs.saucelabsStrings.ANDROID_INSTRUMENTATION
import typingsSlinky.saucelabs.saucelabsStrings.APPIUM
import typingsSlinky.saucelabs.saucelabsStrings.BATCH
import typingsSlinky.saucelabs.saucelabsStrings.MANUAL
