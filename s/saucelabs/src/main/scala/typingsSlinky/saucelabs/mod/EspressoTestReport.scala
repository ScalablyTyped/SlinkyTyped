...
object EspressoTestReport {
  
  @scala.inline
  def apply(): EspressoTestReport = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EspressoTestReport]
  }
  
  @scala.inline
  implicit class EspressoTestReportMutableBuilder[Self <: EspressoTestReport] (val x: Self) extends AnyVal {
