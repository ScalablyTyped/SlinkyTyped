...
trait AppiumTestReport
  ...
  var vitalsLogRecordingEnabled: js.UndefOr[Boolean] = js.native
  
  var withSystemError: js.UndefOr[Boolean] = js.native
}
object AppiumTestReport {
  
  @scala.inline
  def apply(): AppiumTestReport = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AppiumTestReport]
  }
  
  @scala.inline
  implicit class AppiumTestReportMutableBuilder[Self <: AppiumTestReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHasWdaLogs(value: Boolean): Self = StObject.set(x, "hasWdaLogs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHasWdaLogsUndefined: Self = StObject.set(x, "hasWdaLogs", js.undefined)
    ...
    @scala.inline
    def setOptionalSharedId(value: SharedLiveViewId): Self = StObject.set(x, "optionalSharedId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOptionalSharedIdUndefined: Self = StObject.set(x, "optionalSharedId", js.undefined)
    ...
    @scala.inline
    def setVitalsLogRecordingEnabled(value: Boolean): Self = StObject.set(x, "vitalsLogRecordingEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVitalsLogRecordingEnabledUndefined: Self = StObject.set(x, "vitalsLogRecordingEnabled", js.undefined)
