...
object AppiumTestReport {
  ...
  @scala.inline
  implicit class AppiumTestReportOps[Self <: AppiumTestReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHasWdaLogs(value: Boolean): Self = this.set("hasWdaLogs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHasWdaLogs: Self = this.set("hasWdaLogs", js.undefined)
    ...
    @scala.inline
    def setOptionalSharedId(value: SharedLiveViewId): Self = this.set("optionalSharedId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOptionalSharedId: Self = this.set("optionalSharedId", js.undefined)
    ...
    @scala.inline
    def setVitalsLogRecordingEnabled(value: Boolean): Self = this.set("vitalsLogRecordingEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteVitalsLogRecordingEnabled: Self = this.set("vitalsLogRecordingEnabled", js.undefined)
