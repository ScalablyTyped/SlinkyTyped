...
object mod {
  ...
  @js.native
  def Failure[A](e: js.Error): Try[A] = js.native
  ...
  trait Future[A] extends StObject {
    ...
    def failed(): Future[js.Error] = js.native
    ...
    def recover[B /* <: A */](f: js.Function1[/* e */ js.Error, Optional[B]]): Future[A] = js.native
    
    def recoverWith[B /* <: A */](f: js.Function1[/* e */ js.Error, Optional[Future[B]]]): Future[A] = js.native
    
    def transform[B](f: js.Function1[/* t */ Try[A], Try[B]]): Future[B] = js.native
    
    def transform1[B](fs: js.Function1[/* a */ A, B], ff: js.Function1[/* e */ js.Error, js.Error]): Future[B] = js.native
  ...
  object Future {
    ...
    @js.native
    def failed[A](e: js.Error): Future[A] = js.native
    ...
    implicit class FutureMutableBuilder[Self <: Future[_], A] (val x: Self with Future[A]) extends AnyVal {
      ...
      @scala.inline
      def setFailed(value: () => Future[js.Error]): Self = StObject.set(x, "failed", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setRecover(value: js.Function1[/* e */ js.Error, Optional[js.Any]] => Future[A]): Self = StObject.set(x, "recover", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRecoverWith(value: js.Function1[/* e */ js.Error, Optional[Future[js.Any]]] => Future[A]): Self = StObject.set(x, "recoverWith", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTransform1(
        value: (js.Function1[/* a */ A, js.Any], js.Function1[/* e */ js.Error, js.Error]) => Future[js.Any]
      ): Self = StObject.set(x, "transform1", js.Any.fromFunction2(value))
  ...
  trait Try[A] extends StObject {
    ...
    def fold[B](fe: js.Function1[/* e */ js.Error, B], ff: js.Function1[/* a */ A, B]): B = js.native
    ...
    def recover[B /* <: A */](f: js.Function1[/* e */ js.Error, Optional[Try[B]]]): Try[A] = js.native
    
    def toOptional(): Optional[A] = js.native
    
    def transform[B](fs: js.Function1[/* a */ A, Try[B]], ff: js.Function1[/* e */ js.Error, Try[B]]): Try[B] = js.native
  }
  object Try {
    ...
    implicit class TryMutableBuilder[Self <: Try[_], A] (val x: Self with Try[A]) extends AnyVal {
      ...
      @scala.inline
      def setFold(value: (js.Function1[/* e */ js.Error, js.Any], js.Function1[/* a */ A, js.Any]) => js.Any): Self = StObject.set(x, "fold", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setGetError(value: () => js.Error): Self = StObject.set(x, "getError", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setRecover(value: js.Function1[/* e */ js.Error, Optional[Try[js.Any]]] => Try[A]): Self = StObject.set(x, "recover", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTransform(
        value: (js.Function1[/* a */ A, Try[js.Any]], js.Function1[/* e */ js.Error, Try[js.Any]]) => Try[js.Any]
