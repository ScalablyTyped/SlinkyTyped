...
trait SliceSource extends js.Object {
  ...
  def slice(length: Double): js.Promise[js.typedarray.Uint8Array] = js.native
}
object SliceSource {
  ...
  implicit class SliceSourceOps[Self <: SliceSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSlice(value: Double => js.Promise[js.typedarray.Uint8Array]): Self = this.set("slice", js.Any.fromFunction1(value))
  }
}
