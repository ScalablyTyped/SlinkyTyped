package typingsSlinky.syntaxDashError

import typingsSlinky.acorn.acornMod.Options
...
object syntaxDashErrorMod extends js.Object {
  /**
    ...
    */
  def apply(src: js.Any): js.UndefOr[js.SyntaxError with Anon_Annotated] = js.native
  def apply(src: js.Any, file: String): js.UndefOr[js.SyntaxError with Anon_Annotated] = js.native
  def apply(src: js.Any, file: String, opts: Options): js.UndefOr[js.SyntaxError with Anon_Annotated] = js.native
}
