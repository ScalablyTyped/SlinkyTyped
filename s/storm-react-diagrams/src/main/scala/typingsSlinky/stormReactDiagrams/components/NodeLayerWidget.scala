...
object NodeLayerWidget
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.stormReactDiagrams.mod.NodeLayerWidget] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.stormReactDiagrams.mod.NodeLayerWidget] = {
