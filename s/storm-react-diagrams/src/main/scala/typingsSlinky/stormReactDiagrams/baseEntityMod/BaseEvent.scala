...
object BaseEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.stormReactDiagrams.baseEntityMod.BaseEntity[typingsSlinky.stormReactDiagrams.baseEntityMod.BaseListener[_]] */ T](entity: BaseEntity[BaseListener[_]], firing: Boolean, id: String, stopPropagation: () => js.Any): BaseEvent[T] = {
  ...
  @scala.inline
  implicit class BaseEventOps[Self <: BaseEvent[_], /* <: typingsSlinky.stormReactDiagrams.baseEntityMod.BaseEntity[typingsSlinky.stormReactDiagrams.baseEntityMod.BaseListener[_]] */ T] (val x: Self with BaseEvent[T]) extends AnyVal {
    @scala.inline
