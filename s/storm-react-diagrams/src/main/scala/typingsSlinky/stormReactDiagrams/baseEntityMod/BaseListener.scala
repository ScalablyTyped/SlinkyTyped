...
object BaseListener {
  @scala.inline
  def apply[/* <: typingsSlinky.stormReactDiagrams.baseEntityMod.BaseEntity[typingsSlinky.stormReactDiagrams.baseEntityMod.BaseListener[_]] */ T](): BaseListener[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BaseListener[T]]
  }
  @scala.inline
  implicit class BaseListenerOps[Self <: BaseListener[_], /* <: typingsSlinky.stormReactDiagrams.baseEntityMod.BaseEntity[typingsSlinky.stormReactDiagrams.baseEntityMod.BaseListener[_]] */ T] (val x: Self with BaseListener[T]) extends AnyVal {
    @scala.inline
