...
@js.native
class Toolkit ()
  extends typingsSlinky.stormDashReactDashDiagrams.distSrcToolkitMod.Toolkit
...
object Toolkit extends js.Object {
  ...
  def generateCurvePath(
    firstPoint: typingsSlinky.stormDashReactDashDiagrams.distSrcModelsPointModelMod.PointModel,
    lastPoint: typingsSlinky.stormDashReactDashDiagrams.distSrcModelsPointModelMod.PointModel
  ): String = js.native
  def generateCurvePath(
    firstPoint: typingsSlinky.stormDashReactDashDiagrams.distSrcModelsPointModelMod.PointModel,
    lastPoint: typingsSlinky.stormDashReactDashDiagrams.distSrcModelsPointModelMod.PointModel,
