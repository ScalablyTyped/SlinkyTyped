package typingsSlinky.sinonAsPromised.mod
...
object SinonStub {
  ...
  implicit class SinonStubOps[Self <: SinonStub] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRejects(value: js.Any => SinonStub): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rejects")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withResolves(value: js.Any => SinonStub): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolves")(js.Any.fromFunction1(value))
        ret
    }
  }
