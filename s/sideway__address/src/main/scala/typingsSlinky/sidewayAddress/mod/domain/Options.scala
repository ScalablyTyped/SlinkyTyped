package typingsSlinky.sidewayAddress.mod.domain

import typingsSlinky.sidewayAddress.mod.domain.Tlds.Allow
import typingsSlinky.sidewayAddress.mod.domain.Tlds.Deny
