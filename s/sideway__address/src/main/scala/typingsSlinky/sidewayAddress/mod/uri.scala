...
import typingsSlinky.hapiHoek.mod.ts.XOR
import typingsSlinky.sidewayAddress.mod.uri.Options.Relative
...
object uri {
  ...
  object Options {
    ...
    object Options {
      ...
      @scala.inline
      def apply(): typingsSlinky.sidewayAddress.mod.uri.Options.Options = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.sidewayAddress.mod.uri.Options.Options]
      }
      
      @scala.inline
      implicit class OptionsMutableBuilder[Self <: typingsSlinky.sidewayAddress.mod.uri.Options.Options] (val x: Self) extends AnyVal {
  ...
  type Options = XOR[typingsSlinky.sidewayAddress.mod.uri.Options.Options, Relative]
}
