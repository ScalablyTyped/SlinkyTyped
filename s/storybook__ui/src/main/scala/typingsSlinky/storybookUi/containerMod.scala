...
import typingsSlinky.storybookUi.anon.Align
import typingsSlinky.storybookUi.anon.BasePanelRenderPropsalign
import typingsSlinky.storybookUi.anon.BasePanelRenderPropsdocsO
import typingsSlinky.storybookUi.anon.BasePanelRenderPropshidde
import typingsSlinky.storybookUi.anon.Hidden
import typingsSlinky.storybookUi.anon.IsFullscreen
import typingsSlinky.storybookUi.anon.IsToolshown
import typingsSlinky.storybookUi.anon.Left
import typingsSlinky.storybookUi.storybookUiBooleans.`false`
import typingsSlinky.storybookUi.storybookUiStrings.nav
import typingsSlinky.storybookUi.storybookUiStrings.panel
...
object containerMod {
  ...
  @js.native
  val Layout: ReactComponentClass[
  ...
  @js.native
  val Main: ReactComponentClass[IsFullscreen] = js.native
  
  @JSImport("@storybook/ui/dist/components/layout/container", "Panel")
  @js.native
  val Panel: ReactComponentClass[Align] = js.native
  
  @JSImport("@storybook/ui/dist/components/layout/container", "Preview")
  @js.native
  val Preview: ReactComponentClass[Hidden] = js.native
  
  @JSImport("@storybook/ui/dist/components/layout/container", "Sidebar")
  @js.native
  val Sidebar: ReactComponentClass[Hidden] = js.native
  ...
  trait LayoutProps extends StObject {
    ...
    def children(data: LayoutRenderProps): ReactElement = js.native
  ...
  object LayoutProps {
    ...
    def apply(
      bounds: Left,
      children: LayoutRenderProps => ReactElement,
      docsOnly: Boolean,
      options: IsToolshown,
      panelCount: Double,
      theme: Theme,
    ...
    implicit class LayoutPropsMutableBuilder[Self <: LayoutProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: LayoutRenderProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.storybookUi.storybookUiStrings.right
    - typingsSlinky.storybookUi.storybookUiStrings.bottom
  */
  trait PanelPosition extends StObject
  object PanelPosition {
    
    @scala.inline
    def bottom: typingsSlinky.storybookUi.storybookUiStrings.bottom = "bottom".asInstanceOf[typingsSlinky.storybookUi.storybookUiStrings.bottom]
    
    @scala.inline
    def right: typingsSlinky.storybookUi.storybookUiStrings.right = "right".asInstanceOf[typingsSlinky.storybookUi.storybookUiStrings.right]
  }
}
