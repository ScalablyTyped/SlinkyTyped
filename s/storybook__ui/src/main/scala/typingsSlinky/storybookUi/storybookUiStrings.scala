...
import typingsSlinky.storybookUi.containerMod.PanelPosition
import typingsSlinky.storybookUi.draggersMod.Axis
import typingsSlinky.storybookUi.mobileMod.ActiveTabsType
import typingsSlinky.storybookUi.shortcutsMod.Feature
...
object storybookUiStrings {
  ...
  sealed trait args
    extends Item
       with typingsSlinky.storybookUi.containersSidebarMod.Item
       with typingsSlinky.storybookUi.containersPreviewMod.Item
  @scala.inline
