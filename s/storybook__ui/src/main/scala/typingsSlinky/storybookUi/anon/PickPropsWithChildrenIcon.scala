...
trait PickPropsWithChildrenIcon extends StObject {
  ...
  var ref: js.UndefOr[(js.Function1[/* instance */ SVGSVGElement, Unit]) | ReactRef[SVGSVGElement]] = js.native
...
object PickPropsWithChildrenIcon {
  ...
  implicit class PickPropsWithChildrenIconMutableBuilder[Self <: PickPropsWithChildrenIcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: (js.Function1[/* instance */ SVGSVGElement, Unit]) | ReactRef[SVGSVGElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
