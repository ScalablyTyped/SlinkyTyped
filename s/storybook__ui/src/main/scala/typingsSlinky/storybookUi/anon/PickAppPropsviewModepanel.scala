...
import typingsSlinky.reactSizeme.mod.WithSizeOnSizeCallback
...
object PickAppPropsviewModepanel {
  ...
  implicit class PickAppPropsviewModepanelMutableBuilder[Self <: PickAppPropsviewModepanel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnSize(value: /* size */ typingsSlinky.reactSizeme.anon.Height => Unit): Self = StObject.set(x, "onSize", js.Any.fromFunction1(value))
