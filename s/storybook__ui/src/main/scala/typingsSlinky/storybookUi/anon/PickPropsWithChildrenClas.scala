...
import typingsSlinky.storybookUi.storybookUiStrings.reset
...
import typingsSlinky.storybookUi.storybookUiStrings.submit
...
object PickPropsWithChildrenClas {
  
  @scala.inline
  def apply(): PickPropsWithChildrenClas = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickPropsWithChildrenClas]
  }
  
  @scala.inline
  implicit class PickPropsWithChildrenClasMutableBuilder[Self <: PickPropsWithChildrenClas] (val x: Self) extends AnyVal {
