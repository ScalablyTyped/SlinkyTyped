...
object PropsWithChildrenPickPick {
  ...
  @scala.inline
  def apply(): PropsWithChildrenPickPick = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PropsWithChildrenPickPick]
  }
  
  @scala.inline
  implicit class PropsWithChildrenPickPickMutableBuilder[Self <: PropsWithChildrenPickPick] (val x: Self) extends AnyVal {
