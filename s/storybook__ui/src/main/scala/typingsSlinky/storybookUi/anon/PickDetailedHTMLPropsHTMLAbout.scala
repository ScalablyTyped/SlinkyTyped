...
object PickDetailedHTMLPropsHTMLAbout {
  
  @scala.inline
  def apply(): PickDetailedHTMLPropsHTMLAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickDetailedHTMLPropsHTMLAbout]
  }
  
  @scala.inline
  implicit class PickDetailedHTMLPropsHTMLAboutMutableBuilder[Self <: PickDetailedHTMLPropsHTMLAbout] (val x: Self) extends AnyVal {
