...
import typingsSlinky.storybookUi.anon.Height
...
object appMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[PickAppPropsviewModepanel] = js.native
  ...
  type _To = ReactComponentClass[PickAppPropsviewModepanel]
  
  /* This means you don't have to write `default`, but can instead just say `appMod.foo` */
  override def _to: ReactComponentClass[PickAppPropsviewModepanel] = default
}
