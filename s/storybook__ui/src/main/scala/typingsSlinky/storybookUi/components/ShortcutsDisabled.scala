...
object ShortcutsDisabled {
  
  @JSImport("@storybook/ui/dist/components/sidebar/Search.stories", "ShortcutsDisabled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ShortcutsDisabled.type): typingsSlinky.StBuildingComponent.Default[tag.type, js.Object] = new typingsSlinky.StBuildingComponent.Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
