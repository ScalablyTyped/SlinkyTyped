...
object GridHeaderRow {
  ...
  implicit def make(companion: GridHeaderRow.type): SharedBuilder_DetailedHTMLPropsOmit0_1853247385[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsOmit0_1853247385[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
