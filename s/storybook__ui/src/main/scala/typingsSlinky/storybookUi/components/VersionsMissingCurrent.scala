...
object VersionsMissingCurrent {
  
  @JSImport("@storybook/ui/dist/components/sidebar/Refs.stories", "VersionsMissingCurrent")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: VersionsMissingCurrent.type): typingsSlinky.StBuildingComponent.Default[tag.type, js.Object] = new typingsSlinky.StBuildingComponent.Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
