...
object SidebarSubheading {
  
  @JSImport("@storybook/ui/dist/components/sidebar/SidebarSubheading", JSImport.Default)
  @js.native
  ...
  def withProps(
    p: PropsWithChildren[
      (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement]) with (Omit[DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement], theme]) with `0`[Theme]
    ]
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SidebarSubheading.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
