...
object SidebarSearch {
  @JSImport("@storybook/ui/dist/components/sidebar/SidebarSearch", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SidebarSearch.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
