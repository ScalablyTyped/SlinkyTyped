...
object Handle {
  ...
  @scala.inline
  def apply(axis: Axis, isDragging: Boolean): Builder = {
    val __props = js.Dynamic.literal(axis = axis.asInstanceOf[js.Any], isDragging = isDragging.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[(DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement]) with (Omit[typingsSlinky.storybookUi.anon.Axis, theme]) with `0`[Theme]]))
  }
  ...
  def withProps(
    p: (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement]) with (Omit[typingsSlinky.storybookUi.anon.Axis, theme]) with `0`[Theme]
