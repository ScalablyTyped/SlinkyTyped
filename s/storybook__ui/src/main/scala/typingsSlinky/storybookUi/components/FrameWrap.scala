...
object FrameWrap {
  ...
  @scala.inline
  def apply(offset: Double): Builder = {
    val __props = js.Dynamic.literal(offset = offset.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[(DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement]) with (Omit[Offset, theme]) with `0`[Theme]]))
  }
  ...
  def withProps(
    p: (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement]) with (Omit[Offset, theme]) with `0`[Theme]
