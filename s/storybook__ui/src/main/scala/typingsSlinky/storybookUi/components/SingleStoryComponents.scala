...
object SingleStoryComponents {
  
  @JSImport("@storybook/ui/dist/components/sidebar/Tree.stories", "SingleStoryComponents")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SingleStoryComponents.type): typingsSlinky.StBuildingComponent.Default[tag.type, js.Object] = new typingsSlinky.StBuildingComponent.Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
