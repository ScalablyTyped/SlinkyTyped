...
object ShortcutsPage {
  
  @JSImport("@storybook/ui/dist/settings/shortcuts_page", "ShortcutsPage")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ShortcutsPage.type): typingsSlinky.StBuildingComponent.Default[tag.type, js.Object] = new typingsSlinky.StBuildingComponent.Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
