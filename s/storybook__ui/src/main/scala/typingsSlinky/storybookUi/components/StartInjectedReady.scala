...
object StartInjectedReady {
  
  @JSImport("@storybook/ui/dist/components/sidebar/Refs.stories", "StartInjectedReady")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: StartInjectedReady.type): typingsSlinky.StBuildingComponent.Default[tag.type, js.Object] = new typingsSlinky.StBuildingComponent.Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
