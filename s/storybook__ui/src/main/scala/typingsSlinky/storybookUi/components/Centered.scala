...
object Centered {
  ...
  implicit def make(companion: Centered.type): SharedBuilder_DetailedHTMLPropsOmit0_1853247385[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsOmit0_1853247385[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
