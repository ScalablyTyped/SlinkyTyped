...
import typingsSlinky.storybookUi.anon.PickDetailedHTMLPropsButt
...
object Action {
  ...
  implicit def make(companion: Action.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(
    p: (DetailedHTMLProps[ButtonHTMLAttributes[HTMLButtonElement], HTMLButtonElement]) with (Omit[PickDetailedHTMLPropsButt, theme]) with `0`[Theme]
