...
object DesktopOnly {
  ...
  implicit def make(companion: DesktopOnly.type): SharedBuilder_DetailedHTMLPropsOmit01735681597[HTMLSpanElement] = new SharedBuilder_DetailedHTMLPropsOmit01735681597[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
