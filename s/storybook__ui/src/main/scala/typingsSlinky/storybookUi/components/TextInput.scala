...
object TextInput {
  ...
  @scala.inline
  def apply(valid: ValidationStates): Builder = {
    val __props = js.Dynamic.literal(valid = valid.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[PropsWithChildrenPickPick with (Omit[Valid, theme]) with `0`[Theme]]))
  }
  ...
  def withProps(p: PropsWithChildrenPickPick with (Omit[Valid, theme]) with `0`[Theme]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
