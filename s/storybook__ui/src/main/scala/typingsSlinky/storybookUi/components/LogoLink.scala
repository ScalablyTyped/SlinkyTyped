...
object LogoLink {
  ...
  implicit def make(companion: LogoLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(
    p: (DetailedHTMLProps[AnchorHTMLAttributes[HTMLAnchorElement], HTMLAnchorElement]) with (Omit[PickDetailedHTMLPropsAnch, theme]) with `0`[Theme]
