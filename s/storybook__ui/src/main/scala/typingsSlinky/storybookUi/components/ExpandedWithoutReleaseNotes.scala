...
object ExpandedWithoutReleaseNotes {
  
  @JSImport("@storybook/ui/dist/components/sidebar/Menu.stories", "ExpandedWithoutReleaseNotes")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ExpandedWithoutReleaseNotes.type): typingsSlinky.StBuildingComponent.Default[tag.type, js.Object] = new typingsSlinky.StBuildingComponent.Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
