...
object NotificationItemSpacer {
  
  @JSImport("@storybook/ui/dist/components/notifications/NotificationItem", "NotificationItemSpacer")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NotificationItemSpacer.type): SharedBuilder_DetailedHTMLPropsOmit0_1853247385[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsOmit0_1853247385[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
