...
object StartInjectedLoading {
  
  @JSImport("@storybook/ui/dist/components/sidebar/Refs.stories", "StartInjectedLoading")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: StartInjectedLoading.type): typingsSlinky.StBuildingComponent.Default[tag.type, js.Object] = new typingsSlinky.StBuildingComponent.Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
