...
object Path {
  ...
  implicit def make(companion: Path.type): SharedBuilder_DetailedHTMLPropsOmit01735681597[HTMLSpanElement] = new SharedBuilder_DetailedHTMLPropsOmit01735681597[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
