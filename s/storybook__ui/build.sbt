...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-syntax-highlighter" % "11.0-dt-20200225Z-80c10b",
  "org.scalablytyped.slinky" %%% "std" % "3.8-16327f",
  "org.scalablytyped.slinky" %%% "storybook__addon-actions" % "5.3.13-3d62c4",
  "org.scalablytyped.slinky" %%% "storybook__api" % "5.3.13-5ed1a3",
  "org.scalablytyped.slinky" %%% "storybook__channels" % "5.3.13-3d5a2e",
  "org.scalablytyped.slinky" %%% "storybook__components" % "5.3.13-d7b183",
