...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-syntax-highlighter" % "11.0-dt-20200225Z-c03371",
  "org.scalablytyped.slinky" %%% "std" % "3.8-8ac92e",
  "org.scalablytyped.slinky" %%% "storybook__addon-actions" % "5.3.17-0fb97a",
  "org.scalablytyped.slinky" %%% "storybook__api" % "5.3.17-7a0d15",
  "org.scalablytyped.slinky" %%% "storybook__channels" % "5.3.17-c8eadd",
  "org.scalablytyped.slinky" %%% "storybook__components" % "5.3.17-035b73",
