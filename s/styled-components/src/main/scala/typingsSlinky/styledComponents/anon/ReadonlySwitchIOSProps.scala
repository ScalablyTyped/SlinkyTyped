...
trait ReadonlySwitchIOSProps extends StObject {
  ...
  val onTintColor: js.UndefOr[ColorValue] = js.native
  ...
  val onValueChange: js.UndefOr[js.Function1[/* value */ Boolean, Unit]] = js.native
  ...
  val thumbTintColor: js.UndefOr[ColorValue] = js.native
  ...
  val value: js.UndefOr[Boolean] = js.native
}
object ReadonlySwitchIOSProps {
  
  @scala.inline
  def apply(): ReadonlySwitchIOSProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReadonlySwitchIOSProps]
  }
  
  @scala.inline
  implicit class ReadonlySwitchIOSPropsMutableBuilder[Self <: ReadonlySwitchIOSProps] (val x: Self) extends AnyVal {
