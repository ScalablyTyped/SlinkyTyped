...
import typingsSlinky.styledComponents.TypeofImage
import typingsSlinky.styledComponents.TypeofListView
import typingsSlinky.styledComponents.TypeofPicker
import typingsSlinky.styledComponents.TypeofPickerIOS
import typingsSlinky.styledComponents.TypeofRefreshControl
import typingsSlinky.styledComponents.TypeofStatusBar
import typingsSlinky.styledComponents.TypeofSwipeableListView
import typingsSlinky.styledComponents.TypeofTabBarIOS
import typingsSlinky.styledComponents.TypeofTextInput
import typingsSlinky.styledComponents.TypeofTouchableNativeFeed
import typingsSlinky.styledComponents.TypeofView
...
trait ReactNativeStyledInterface[T /* <: js.Object */] extends ReactNativeThemedBaseStyledInterface[AnyIfEmpty[T]] {
  ...
  var Button: ReactNativeThemedStyledFunction[Instantiable0[typingsSlinky.reactNative.mod.Button], T] = js.native
  ...
  var FlatList: ReactNativeThemedStyledFunction[Instantiable0[typingsSlinky.reactNative.mod.FlatList[js.Object]], T] = js.native
  ...
  var Modal: ReactNativeThemedStyledFunction[Instantiable0[typingsSlinky.reactNative.mod.Modal], T] = js.native
  var NavigatorIOS: ReactNativeThemedStyledFunction[Instantiable0[typingsSlinky.reactNative.mod.NavigatorIOS], T] = js.native
  ...
  var SwitchIOS: ReactNativeThemedStyledFunction[Instantiable0[typingsSlinky.reactNative.mod.SwitchIOS], T] = js.native
