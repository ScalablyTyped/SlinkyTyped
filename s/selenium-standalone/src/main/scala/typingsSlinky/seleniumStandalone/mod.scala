...
object mod {
  ...
  @js.native
  def install(cb: js.Function2[js.UndefOr[js.Error], /* fsPaths */ FsPaths, Unit]): Unit = js.native
  @JSImport("selenium-standalone", "install")
  @js.native
  def install(
  ...
  @JSImport("selenium-standalone", "install")
  @js.native
  def install(opts: InstallOpts, cb: js.Function2[js.UndefOr[js.Error], /* fsPaths */ FsPaths, Unit]): Unit = js.native
  
  @JSImport("selenium-standalone", "start")
  @js.native
  def start(cb: js.Function2[js.Error | Null, /* selenium */ ChildProcess, Unit]): Unit = js.native
  @JSImport("selenium-standalone", "start")
  @js.native
  def start(
  ...
  @JSImport("selenium-standalone", "start")
  @js.native
  def start(opts: StartOpts, cb: js.Function2[js.Error | Null, /* selenium */ ChildProcess, Unit]): Unit = js.native
  ...
  object InstallOpts {
    ...
    implicit class InstallOptsMutableBuilder[Self <: InstallOpts] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCb(value: /* error */ js.Error => Unit): Self = StObject.set(x, "cb", js.Any.fromFunction1(value))
  ...
  object StartOpts {
    ...
    implicit class StartOptsMutableBuilder[Self <: StartOpts] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCb(value: (/* error */ js.Error, /* child */ ChildProcess) => Unit): Self = StObject.set(x, "cb", js.Any.fromFunction2(value))
