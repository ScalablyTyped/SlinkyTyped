...
import typingsSlinky.seleniumDashStandalone.seleniumDashStandaloneStrings.ia32
import typingsSlinky.seleniumDashStandalone.seleniumDashStandaloneStrings.x64
