...
@js.native
trait Occupant
  extends typingsSlinky.strophe.mucMod.stropheMod.Strophe.MUC.OccupantInfo {
  ...
  def update(data: typingsSlinky.strophe.mucMod.stropheMod.Strophe.MUC.OccupantInfo): Unit = js.native
