...
object Strophe {
  ...
  object MUC {
    ...
    @js.native
    trait Occupant
      extends typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.OccupantInfo {
      ...
      def update(data: typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.OccupantInfo): Unit = js.native
    ...
    type OccupantMap = StringDictionary[typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.Occupant]
    ...
    trait Plugin extends StObject {
      ...
      /**
        ...
        */
      def init(conn: typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.Connection): Unit = js.native
