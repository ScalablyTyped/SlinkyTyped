...
import typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.Connection
...
trait Plugin extends js.Object {
  ...
  def join(
    ...
    msg_handler_cb: js.Function2[
      /* stanza */ Element, 
      /* room */ typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.XmppRoom, 
      Boolean
    ],
    ...
    roster_cb: js.Function2[
      /* occupants */ typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.OccupantMap, 
      /* room */ typingsSlinky.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.XmppRoom, 
      Boolean
    ]
  ): Unit = js.native
