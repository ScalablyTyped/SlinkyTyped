...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCore(value: String): Self = this.set("core", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSolrVersion(value: String): Self = this.set("solrVersion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSolrVersion: Self = this.set("solrVersion", js.undefined)
  }
}
