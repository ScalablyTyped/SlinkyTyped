...
import typingsSlinky.sugarDashCore.sugarjs.Array.ChainableBase
...
object Array extends js.Object {
  ...
  type Chainable[T, RawValue] = (ChainableBase[T, RawValue]) with typingsSlinky.sugarDashCore.sugarjs.Object.ChainableBase[RawValue]
}
