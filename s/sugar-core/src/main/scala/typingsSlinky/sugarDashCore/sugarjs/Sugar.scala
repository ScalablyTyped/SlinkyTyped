...
trait Sugar extends js.Object {
  ...
  def apply(): typingsSlinky.sugarDashCore.sugarjs.Sugar = js.native
  def apply(opts: ExtendOptions): typingsSlinky.sugarDashCore.sugarjs.Sugar = js.native
  def createNamespace(name: java.lang.String): SugarNamespace = js.native
  def extend(): typingsSlinky.sugarDashCore.sugarjs.Sugar = js.native
  def extend(opts: ExtendOptions): typingsSlinky.sugarDashCore.sugarjs.Sugar = js.native
}
