...
object ConfigureReadmeConfig {
  ...
  implicit class ConfigureReadmeConfigOps[Self <: ConfigureReadmeConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDocPreview(value: /* props */ Children => ReactElement): Self = this.set("DocPreview", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteDocPreview: Self = this.set("DocPreview", js.undefined)
    
    @scala.inline
    def setFooterPreview(value: /* props */ Children => ReactElement): Self = this.set("FooterPreview", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteFooterPreview: Self = this.set("FooterPreview", js.undefined)
    
    @scala.inline
    def setHeaderPreview(value: /* props */ Children => ReactElement): Self = this.set("HeaderPreview", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteHeaderPreview: Self = this.set("HeaderPreview", js.undefined)
    
    @scala.inline
    def setStoryPreview(value: /* props */ Children => ReactElement): Self = this.set("StoryPreview", js.Any.fromFunction1(value))
