...
object IBrowser {
  ...
  implicit class IBrowserOps[Self <: IBrowser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcludeCoverageUnits(value: js.RegExp): Self = this.set("excludeCoverageUnits", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHostPageUrl(value: String): Self = this.set("hostPageUrl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIncludeCoverageUnits(value: js.RegExp): Self = this.set("includeCoverageUnits", value.asInstanceOf[js.Any])
