...
- typingsSlinky.siesta.Siesta.Harness.IBrowserExtJSCore because var conflicts: coverageUnit, excludeCoverageUnits. Inlined installLoaderInstrumentationHook */ @js.native
...
object IBrowserExtJS {
  ...
  implicit class IBrowserExtJSOps[Self <: IBrowserExtJS] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllowExtVersionChange(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowExtVersionChange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLoaderPath(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loaderPath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withWaitForAppReady(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waitForAppReady")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withWaitForExtReady(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waitForExtReady")(value.asInstanceOf[js.Any])
        ret
    }
  }
