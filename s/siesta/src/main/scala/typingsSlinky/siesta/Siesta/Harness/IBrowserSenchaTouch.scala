...
object IBrowserSenchaTouch {
  ...
  @scala.inline
  implicit class IBrowserSenchaTouchOps[Self <: IBrowserSenchaTouch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPerformSetup(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("performSetup")(value.asInstanceOf[js.Any])
        ret
    }
  }
