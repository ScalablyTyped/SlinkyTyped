...
trait IExtJSAjax extends js.Object {
  ...
  def isAjaxLoading(`object`: js.UndefOr[scala.Nothing], description: String): Unit = js.native
  ...
  def waitForAjaxRequest(callback: js.Function, scope: js.UndefOr[scala.Nothing], timeout: Double): Unit = js.native
  ...
  def waitForAjaxRequest(`object`: js.Any, callback: js.Function, scope: js.UndefOr[scala.Nothing], timeout: Double): Unit = js.native
