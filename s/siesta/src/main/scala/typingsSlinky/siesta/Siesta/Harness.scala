...
object Harness {
  ...
  object IBrowser {
    ...
    implicit class IBrowserMutableBuilder[Self <: IBrowser] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExcludeCoverageUnits(value: js.RegExp): Self = StObject.set(x, "excludeCoverageUnits", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHostPageUrl(value: String): Self = StObject.set(x, "hostPageUrl", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIncludeCoverageUnits(value: js.RegExp): Self = StObject.set(x, "includeCoverageUnits", value.asInstanceOf[js.Any])
