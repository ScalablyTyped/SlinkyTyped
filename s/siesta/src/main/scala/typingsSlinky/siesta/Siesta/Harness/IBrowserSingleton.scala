...
object IBrowserSingleton {
  ...
  implicit class IBrowserSingletonOps[Self <: IBrowserSingleton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExtJS(value: IBrowserExtJS): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ExtJS")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSenchaTouch(value: IBrowserSenchaTouch): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SenchaTouch")(value.asInstanceOf[js.Any])
        ret
    }
  }
