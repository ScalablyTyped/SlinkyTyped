...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTableComponentFunctionComponent(value: ReactComponentClass[TableComponentOptionProps]): Self = this.set("TableComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTableComponentComponentClass(value: ReactComponentClass[TableComponentOptionProps]): Self = this.set("TableComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTableComponent(value: ReactComponentClass[TableComponentOptionProps]): Self = this.set("TableComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPropTablesVarargs(value: ReactComponentClass[js.Any]*): Self = this.set("propTables", js.Array(value :_*))
    
    @scala.inline
    def setPropTables(value: js.Array[ReactComponentClass[_]] | `false`): Self = this.set("propTables", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePropTables: Self = this.set("propTables", js.undefined)
    
    @scala.inline
    def setPropTablesExcludeVarargs(value: ReactComponentClass[js.Any]*): Self = this.set("propTablesExclude", js.Array(value :_*))
    
    @scala.inline
    def setPropTablesExclude(value: js.Array[ReactComponentClass[_]]): Self = this.set("propTablesExclude", value.asInstanceOf[js.Any])
