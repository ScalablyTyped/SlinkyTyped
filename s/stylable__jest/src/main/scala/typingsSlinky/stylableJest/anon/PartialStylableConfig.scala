package typingsSlinky.stylableJest.anon
...
import typingsSlinky.stylableJest.stylableJestStrings.development
import typingsSlinky.stylableJest.stylableJestStrings.production
...
@js.native
trait PartialStylableConfig extends js.Object {
...
object PartialStylableConfig {
  ...
  @scala.inline
  implicit class PartialStylableConfigOps[Self <: PartialStylableConfig] (val x: Self) extends AnyVal {
