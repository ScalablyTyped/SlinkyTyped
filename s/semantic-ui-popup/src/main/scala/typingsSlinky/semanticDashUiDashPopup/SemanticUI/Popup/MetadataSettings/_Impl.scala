package typingsSlinky.semanticDashUiDashPopup.SemanticUI.Popup.MetadataSettings
...
object _Impl {
  @scala.inline
  def apply(content: String, html: String, offset: String, position: String, title: String, variation: String): _Impl = {
