package typingsSlinky.semanticDashUiDashPopup.SemanticUI.PopupSettings

import typingsSlinky.semanticDashUiDashPopup.JQuery
import typingsSlinky.semanticDashUiDashPopup.SemanticUI.Popup.ClassNameSettings
import typingsSlinky.semanticDashUiDashPopup.SemanticUI.Popup.DelaySettings
import typingsSlinky.semanticDashUiDashPopup.SemanticUI.Popup.ErrorSettings
import typingsSlinky.semanticDashUiDashPopup.SemanticUI.Popup.MetadataSettings
import typingsSlinky.semanticDashUiDashPopup.SemanticUI.Popup.SelectorSettings
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupBooleans.`false`
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupStrings.adjacent
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupStrings.auto
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupStrings.click
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupStrings.focus
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupStrings.hover
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupStrings.manual
import typingsSlinky.semanticDashUiDashPopup.semanticDashUiDashPopupStrings.opposite
