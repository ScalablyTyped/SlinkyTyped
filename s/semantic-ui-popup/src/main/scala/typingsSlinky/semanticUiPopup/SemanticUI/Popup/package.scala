...
package object Popup {
  type ClassNameSettings = typingsSlinky.semanticUiPopup.SemanticUI.Popup.ClassNameSettings.Param
  ...
  type SelectorSettings = typingsSlinky.semanticUiPopup.SemanticUI.Popup.SelectorSettings_
}
