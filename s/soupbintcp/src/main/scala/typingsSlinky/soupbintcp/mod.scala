package typingsSlinky.soupbintcp
...
object mod {
  ...
  object PacketType extends StObject {
    ...
    /* 0x52 */ val CLIENT_HEARTBEAT: typingsSlinky.soupbintcp.mod.PacketType.CLIENT_HEARTBEAT with Double = js.native
    
    @js.native
    sealed trait DEBUG extends PacketType
    /* 0x2b */ val DEBUG: typingsSlinky.soupbintcp.mod.PacketType.DEBUG with Double = js.native
    
    // H
    @js.native
    sealed trait END_OF_SESSION extends PacketType
    /* 0x5a */ val END_OF_SESSION: typingsSlinky.soupbintcp.mod.PacketType.END_OF_SESSION with Double = js.native
    
    // +
    @js.native
    sealed trait LOGIN_ACCEPTED extends PacketType
    /* 0x41 */ val LOGIN_ACCEPTED: typingsSlinky.soupbintcp.mod.PacketType.LOGIN_ACCEPTED with Double = js.native
    
    // A
    @js.native
    sealed trait LOGIN_REJECTED extends PacketType
    /* 0x4a */ val LOGIN_REJECTED: typingsSlinky.soupbintcp.mod.PacketType.LOGIN_REJECTED with Double = js.native
    
    // Z
    @js.native
    sealed trait LOGIN_REQUEST extends PacketType
    /* 0x4c */ val LOGIN_REQUEST: typingsSlinky.soupbintcp.mod.PacketType.LOGIN_REQUEST with Double = js.native
    
    // R
    @js.native
    sealed trait LOGOUT_REQUEST extends PacketType
    /* 0x4f */ val LOGOUT_REQUEST: typingsSlinky.soupbintcp.mod.PacketType.LOGOUT_REQUEST with Double = js.native
    
    // J
    @js.native
    sealed trait SEQUENCED_DATA extends PacketType
    /* 0x53 */ val SEQUENCED_DATA: typingsSlinky.soupbintcp.mod.PacketType.SEQUENCED_DATA with Double = js.native
    
    // S
    @js.native
    sealed trait SERVER_HEARTBEAT extends PacketType
    /* 0x48 */ val SERVER_HEARTBEAT: typingsSlinky.soupbintcp.mod.PacketType.SERVER_HEARTBEAT with Double = js.native
    
    // L
    @js.native
    sealed trait UNSEQUENCED_DATA extends PacketType
    /* 0x55 */ val UNSEQUENCED_DATA: typingsSlinky.soupbintcp.mod.PacketType.UNSEQUENCED_DATA with Double = js.native
  }
