...
object SBArrayType {
  ...
  @scala.inline
  implicit class SBArrayTypeOps[Self <: SBArrayType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: array): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValue(value: SBType): Self = this.set("value", value.asInstanceOf[js.Any])
