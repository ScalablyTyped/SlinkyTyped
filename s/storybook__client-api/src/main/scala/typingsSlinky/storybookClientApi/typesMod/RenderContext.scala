...
import typingsSlinky.storybookClientApi.anon.Description
...
object RenderContext {
  ...
  implicit class RenderContextMutableBuilder[Self <: RenderContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShowException(value: js.Error => Unit): Self = StObject.set(x, "showException", js.Any.fromFunction1(value))
