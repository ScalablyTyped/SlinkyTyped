...
import typingsSlinky.atStorybookAddons.Anon_Current
...
import typingsSlinky.atStorybookClientDashApi.distClientUnderscoreApiMod.default
...
object atStorybookClientDashApiMod extends js.Object {
  ...
  class ConfigApi protected ()
    extends typingsSlinky.atStorybookClientDashApi.distConfigUnderscoreApiMod.default {
    def this(hasChannelStoryStoreClientApiClearDecorators: Anon_Channel) = this()
  }
  
  @js.native
  class HooksContext ()
    extends typingsSlinky.atStorybookClientDashApi.distHooksMod.HooksContext
  
  @js.native
  class StoryStore protected ()
    extends typingsSlinky.atStorybookClientDashApi.distStoryUnderscoreStoreMod.default {
