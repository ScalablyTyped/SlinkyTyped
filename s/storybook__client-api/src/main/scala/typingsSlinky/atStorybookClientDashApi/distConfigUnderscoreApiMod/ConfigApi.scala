package typingsSlinky.atStorybookClientDashApi.distConfigUnderscoreApiMod
...
trait ConfigApi extends js.Object {
  var _channel: typingsSlinky.atStorybookChannels.atStorybookChannelsMod.default
  var _storyStore: typingsSlinky.atStorybookClientDashApi.distStoryUnderscoreStoreMod.default
...
object ConfigApi {
  @scala.inline
  def apply(
    _channel: typingsSlinky.atStorybookChannels.atStorybookChannelsMod.default,
    _clearDecorators: () => Unit,
    _renderError: js.Error => Unit,
    _renderMain: () => Unit,
    _storyStore: typingsSlinky.atStorybookClientDashApi.distStoryUnderscoreStoreMod.default,
