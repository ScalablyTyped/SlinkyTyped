...
object semanticUiModalStrings {
  ...
  @js.native
  sealed trait allowMultiple extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `cache sizes` extends StObject
  @scala.inline
  def `cache sizes`: `cache sizes` = ("cache sizes").asInstanceOf[`cache sizes`]
  
  @js.native
  sealed trait `can fit` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait detachable extends StObject
  @scala.inline
  def detachable: detachable = "detachable".asInstanceOf[detachable]
  
  @js.native
  sealed trait dimmerSettings extends StObject
  @scala.inline
  def dimmerSettings: dimmerSettings = "dimmerSettings".asInstanceOf[dimmerSettings]
  ...
  @js.native
  sealed trait `hide all` extends StObject
  @scala.inline
  def `hide all`: `hide all` = ("hide all").asInstanceOf[`hide all`]
  
  @js.native
  sealed trait `hide dimmer` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `is active` extends StObject
  @scala.inline
  def `is active`: `is active` = ("is active").asInstanceOf[`is active`]
  
  @js.native
  sealed trait keyboardShortcuts extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait onApprove extends StObject
  @scala.inline
  def onApprove: onApprove = "onApprove".asInstanceOf[onApprove]
  
  @js.native
  sealed trait onDeny extends StObject
  @scala.inline
  def onDeny: onDeny = "onDeny".asInstanceOf[onDeny]
  ...
  @js.native
  sealed trait `show dimmer` extends StObject
  @scala.inline
