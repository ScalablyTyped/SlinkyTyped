...
import typingsSlinky.semanticDashUiDashModal.SemanticUI.Modal
import typingsSlinky.semanticDashUiDashModal.SemanticUI.ModalSettings
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`attach events`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`cache sizes`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`can fit`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`hide all`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`hide dimmer`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`hide others`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`is active`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`set active`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.`show dimmer`
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.destroy
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.hide
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.refresh
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.setting
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.show
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalStrings.toggle
