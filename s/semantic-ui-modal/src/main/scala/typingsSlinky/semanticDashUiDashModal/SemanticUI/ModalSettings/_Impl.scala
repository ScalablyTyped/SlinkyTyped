package typingsSlinky.semanticDashUiDashModal.SemanticUI.ModalSettings

import typingsSlinky.semanticDashUiDashDimmer.SemanticUI.DimmerSettings
import typingsSlinky.semanticDashUiDashModal.JQuery
import typingsSlinky.semanticDashUiDashModal.SemanticUI.Modal.ClassNameSettings
import typingsSlinky.semanticDashUiDashModal.SemanticUI.Modal.ErrorSettings
import typingsSlinky.semanticDashUiDashModal.SemanticUI.Modal.SelectorSettings
import typingsSlinky.semanticDashUiDashModal.semanticDashUiDashModalBooleans.`false`
