...
import typingsSlinky.sentryUtils.instrumentMod.InstrumentHandler
import typingsSlinky.sentryUtils.loggerMod.Logger_
import typingsSlinky.sentryUtils.miscMod.SemVer
import typingsSlinky.sentryUtils.miscMod.SentryGlobal
...
object mod extends js.Object {
  ...
  def walk(
    ...
    memo: typingsSlinky.sentryUtils.memoMod.Memo
  ): js.Any = js.native
  def walk(key: String, value: js.Any, depth: Double): js.Any = js.native
  def walk(key: String, value: js.Any, depth: Double, memo: typingsSlinky.sentryUtils.memoMod.Memo): js.Any = js.native
  
  @js.native
  class Dsn protected ()
    extends typingsSlinky.sentryUtils.dsnMod.Dsn {
  ...
  @js.native
  class Memo ()
    extends typingsSlinky.sentryUtils.memoMod.Memo
  
  @js.native
  class PromiseBuffer[T] ()
    extends typingsSlinky.sentryUtils.promisebufferMod.PromiseBuffer[T] {
    def this(_limit: Double) = this()
  }
  
  @js.native
  class SentryError protected ()
    extends typingsSlinky.sentryUtils.errorMod.SentryError {
    def this(message: String) = this()
  }
  
  @js.native
  class SyncPromise[T] protected ()
    extends typingsSlinky.sentryUtils.syncpromiseMod.SyncPromise[T] {
