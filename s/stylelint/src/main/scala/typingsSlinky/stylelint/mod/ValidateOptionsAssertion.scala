...
object ValidateOptionsAssertion {
  @scala.inline
  def Actual(actual: js.Any, optional: `false` = null, possible: js.Any = null): ValidateOptionsAssertion = {
  ...
  @scala.inline
  def Optional(optional: `true`, possible: js.Any, actual: js.Any = null): ValidateOptionsAssertion = {
