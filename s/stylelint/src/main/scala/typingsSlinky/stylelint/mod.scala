...
object mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.stylelint.stylelintStrings.`css-in-js`
    - typingsSlinky.stylelint.stylelintStrings.html
    - typingsSlinky.stylelint.stylelintStrings.less
    - typingsSlinky.stylelint.stylelintStrings.markdown
    - typingsSlinky.stylelint.stylelintStrings.sass
    - typingsSlinky.stylelint.stylelintStrings.scss
    - typingsSlinky.stylelint.stylelintStrings.sugarss
  */
  ...
  */
  ...
  object ValidateOptionsAssertion {
    ...
    @scala.inline
    def Actual(actual: js.Any): typingsSlinky.stylelint.anon.Actual = {
      val __obj = js.Dynamic.literal(actual = actual.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stylelint.anon.Actual]
    }
    
    @scala.inline
    def Optional(optional: `true`, possible: js.Any): typingsSlinky.stylelint.anon.Optional = {
      val __obj = js.Dynamic.literal(optional = optional.asInstanceOf[js.Any], possible = possible.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stylelint.anon.Optional]
    }
  }
