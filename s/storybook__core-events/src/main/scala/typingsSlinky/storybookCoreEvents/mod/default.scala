package typingsSlinky.storybookCoreEvents.mod
...
object default extends js.Object {
  ...
  /* "getCurrentStory" */ val GET_CURRENT_STORY: typingsSlinky.storybookCoreEvents.mod.events.GET_CURRENT_STORY with String = js.native
  
  /* "getStories" */ val GET_STORIES: typingsSlinky.storybookCoreEvents.mod.events.GET_STORIES with String = js.native
  ...
  /* "storiesConfigured" */ val STORIES_CONFIGURED: typingsSlinky.storybookCoreEvents.mod.events.STORIES_CONFIGURED with String = js.native
  ...
  /* "storyAdded" */ val STORY_ADDED: typingsSlinky.storybookCoreEvents.mod.events.STORY_ADDED with String = js.native
  ...
  /* "storyInit" */ val STORY_INIT: typingsSlinky.storybookCoreEvents.mod.events.STORY_INIT with String = js.native
  
  /* "storyMissing" */ val STORY_MISSING: typingsSlinky.storybookCoreEvents.mod.events.STORY_MISSING with String = js.native
  
  /* "storyRender" */ val STORY_RENDER: typingsSlinky.storybookCoreEvents.mod.events.STORY_RENDER with String = js.native
