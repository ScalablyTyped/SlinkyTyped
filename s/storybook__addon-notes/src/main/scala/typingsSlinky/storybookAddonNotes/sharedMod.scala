...
object sharedMod {
  ...
  */
  ...
  object _Parameters {
    ...
    @scala.inline
    def DisabledParameter(disable: Boolean): typingsSlinky.storybookAddonNotes.sharedMod.DisabledParameter = {
      val __obj = js.Dynamic.literal(disable = disable.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.storybookAddonNotes.sharedMod.DisabledParameter]
    }
    
    @scala.inline
    def MarkdownParameter(markdown: String): typingsSlinky.storybookAddonNotes.sharedMod.MarkdownParameter = {
      val __obj = js.Dynamic.literal(markdown = markdown.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.storybookAddonNotes.sharedMod.MarkdownParameter]
    }
    
    @scala.inline
    def TextParameter(text: String): typingsSlinky.storybookAddonNotes.sharedMod.TextParameter = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.storybookAddonNotes.sharedMod.TextParameter]
    }
  }
}
