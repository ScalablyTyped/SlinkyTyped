...
object panelMod {
  ...
  @js.native
  def default(hasActive: Props): ReactElement = js.native
  
  @JSImport("@storybook/addon-notes/dist/Panel", "NotesLink")
  @js.native
  def NotesLink(hasHrefChildrenProps: NotesLinkProps): ReactElement = js.native
  
  @JSImport("@storybook/addon-notes/dist/Panel", "SyntaxHighlighter")
  @js.native
  def SyntaxHighlighter(hasClassNameChildrenProps: SyntaxHighlighterProps): ReactElement = js.native
