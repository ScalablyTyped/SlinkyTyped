...
package object mod {
  ...
  type EventNameToHandler[O, N /* <: typingsSlinky.saxes.mod.EventName */] = /* import warning: importer.ImportType#apply Failed type conversion: saxes.AnonAttribute<O>[N] */ js.Any
  ...
  type PIHandler = js.Function1[/* data */ typingsSlinky.saxes.AnonBody, scala.Unit]
