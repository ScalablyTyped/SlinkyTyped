...
object Proxy {
  @scala.inline
  def apply[/* <: typingsSlinky.saywhen.mod.Func */ T](`then`: T => Proxy[T], thenReturn: js.Any => Proxy[T], thenThrow: js.Error => Proxy[T]): Proxy[T] = {
  ...
  @scala.inline
  implicit class ProxyOps[Self <: Proxy[_], /* <: typingsSlinky.saywhen.mod.Func */ T] (val x: Self with Proxy[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setThenThrow(value: js.Error => Proxy[T]): Self = this.set("thenThrow", js.Any.fromFunction1(value))
  }
