...
import typingsSlinky.sentryTypes.anon.Values
...
import typingsSlinky.sentryTypes.requestMod.Request
import typingsSlinky.sentryTypes.scopeMod.CaptureContext
import typingsSlinky.sentryTypes.scopeMod.Scope
import typingsSlinky.sentryTypes.sdkinfoMod.SdkInfo
import typingsSlinky.sentryTypes.sentryTypesStrings.transaction
import typingsSlinky.sentryTypes.severityMod.Severity
import typingsSlinky.sentryTypes.spanMod.Span
import typingsSlinky.sentryTypes.stacktraceMod.Stacktrace
import typingsSlinky.sentryTypes.transactionMod.Measurements
...
object eventMod {
  ...
  trait EventHint extends StObject {
    ...
    var originalException: js.UndefOr[js.Error | String | Null] = js.native
    
    var syntheticException: js.UndefOr[js.Error | Null] = js.native
  }
  object EventHint {
    ...
    implicit class EventHintMutableBuilder[Self <: EventHint] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOriginalException(value: js.Error | String): Self = StObject.set(x, "originalException", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOriginalExceptionError(value: js.Error): Self = StObject.set(x, "originalException", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSyntheticException(value: js.Error): Self = StObject.set(x, "syntheticException", value.asInstanceOf[js.Any])
