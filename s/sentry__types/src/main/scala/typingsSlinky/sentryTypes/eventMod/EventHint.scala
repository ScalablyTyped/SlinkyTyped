package typingsSlinky.sentryTypes.eventMod
...
object EventHint {
  ...
  implicit class EventHintOps[Self <: EventHint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginalExceptionError(value: js.Error): Self = this.set("originalException", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOriginalException(value: js.Error | String): Self = this.set("originalException", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSyntheticException(value: js.Error): Self = this.set("syntheticException", value.asInstanceOf[js.Any])
