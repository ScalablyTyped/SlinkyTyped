...
@js.native
object sqlite3Mod extends js.Object {
  @js.native
  trait Database extends js.Object {
    ...
    def eachAsync(
      sql: String,
      cb: js.ThisFunction2[
          /* this */ typingsSlinky.sqlite3.sqlite3Mod.Statement, 
          /* err */ Error | Null, 
          /* row */ js.Any, 
          Unit
        ]
    ...
    def execAsync(sql: String): js.Promise[typingsSlinky.sqlite3.sqlite3Mod.Statement] = js.native
