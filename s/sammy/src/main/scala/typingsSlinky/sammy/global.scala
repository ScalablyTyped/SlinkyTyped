...
import typingsSlinky.sammy.Sammy.DataLocationProxy
import typingsSlinky.sammy.Sammy.FormBuilder
import typingsSlinky.sammy.Sammy.Store
...
object global {
  ...
  object Sammy {
    ...
    @js.native
    def DataLocationProxy: typingsSlinky.sammy.Sammy.DataLocationProxy = js.native
    ...
    @js.native
    def FormBuilder: typingsSlinky.sammy.Sammy.FormBuilder = js.native
    @scala.inline
    ...
    class Object protected ()
      extends typingsSlinky.sammy.Sammy.Object {
    ...
    @js.native
    def Store: typingsSlinky.sammy.Sammy.Store = js.native
    @scala.inline
