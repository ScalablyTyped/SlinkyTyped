package typingsSlinky.selectorDashSet.selectorDashSetDotNextMod

import org.scalajs.dom.raw.Element
import typingsSlinky.selectorDashSet.Anon_Data
import typingsSlinky.selectorDashSet.Anon_DataElements
