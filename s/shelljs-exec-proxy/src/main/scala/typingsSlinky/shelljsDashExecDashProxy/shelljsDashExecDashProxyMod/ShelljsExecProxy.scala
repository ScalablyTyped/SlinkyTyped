package typingsSlinky.shelljsDashExecDashProxy.shelljsDashExecDashProxyMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.node.NodeJS.ProcessEnv
import typingsSlinky.node.childUnderscoreProcessMod.ChildProcess
import typingsSlinky.shelljs.Anon_Async
import typingsSlinky.shelljs.Anon_AsyncTrue
import typingsSlinky.shelljs.shelljsMod.ExecCallback
import typingsSlinky.shelljs.shelljsMod.ExecOptions
import typingsSlinky.shelljs.shelljsMod.HeadOptions
import typingsSlinky.shelljs.shelljsMod.ShellArray
import typingsSlinky.shelljs.shelljsMod.ShellConfig
import typingsSlinky.shelljs.shelljsMod.ShellString
import typingsSlinky.shelljs.shelljsMod.ShellStringConstructor
import typingsSlinky.shelljs.shelljsMod.TailOptions
import typingsSlinky.shelljs.shelljsMod.TestOptions
import typingsSlinky.shelljs.shelljsMod.TouchOptionsArray
import typingsSlinky.shelljs.shelljsMod.TouchOptionsLiteral
import typingsSlinky.shelljsDashExecDashProxy.shelljsDashExecDashProxyStrings.PlussignN
import typingsSlinky.shelljsDashExecDashProxy.shelljsDashExecDashProxyStrings.`-N`
import typingsSlinky.shelljsDashExecDashProxy.shelljsDashExecDashProxyStrings.`-c`
...
trait ShelljsExecProxy extends /* k */ StringDictionary[Exec] {
  ...
  /**
  	 ...
  	 */
  def ShellString(value: String): typingsSlinky.shelljs.shelljsMod.ShellString = js.native
