...
import typingsSlinky.shelljs.mod.ShellArray
import typingsSlinky.shelljs.mod.ShellConfig
import typingsSlinky.shelljs.mod.ShellString
import typingsSlinky.shelljs.mod.ShellStringConstructor
import typingsSlinky.shelljs.mod.TailOptions
import typingsSlinky.shelljs.mod.TestOptions
import typingsSlinky.shelljs.mod.TouchOptionsArray
...
trait ShelljsExecProxy extends /* k */ StringDictionary[Exec] {
  ...
  /**
  	 ...
  	 */
  def ShellString(value: String): typingsSlinky.shelljs.mod.ShellString = js.native
