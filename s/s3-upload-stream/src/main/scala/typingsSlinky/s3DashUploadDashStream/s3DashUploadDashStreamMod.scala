...
import typingsSlinky.s3DashUploadDashStream.s3DashUploadDashStreamMod.S3StreamUploader
import typingsSlinky.s3DashUploadDashStream.s3DashUploadDashStreamMod.S3WriteStream
