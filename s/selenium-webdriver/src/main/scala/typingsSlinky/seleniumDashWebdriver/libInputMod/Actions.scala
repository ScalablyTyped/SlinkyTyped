...
import typingsSlinky.seleniumDashWebdriver.Anon_X
import typingsSlinky.seleniumDashWebdriver.libCommandMod.Executor
import typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.ILocation
...
class Actions protected () extends js.Object {
  ...
  def this(executor: Executor, options: Anon_Async) = this()
  def this(executor: Executor, options: Anon_AsyncBoolean) = this()
  def this(executor: Executor, options: Anon_Bridge) = this()
  /**
  ...
  def dragAndDrop(from: WebElement, to: Anon_X): Actions = js.native
