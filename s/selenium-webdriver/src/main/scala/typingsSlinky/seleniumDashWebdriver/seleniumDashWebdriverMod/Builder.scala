...
import typingsSlinky.seleniumDashWebdriver.chromeMod.ServiceBuilder
import typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.Preferences
...
class Builder () extends js.Object {
  ...
  /**
    ...
    *     for this builder.
    */
  def getChromeOptions(): typingsSlinky.seleniumDashWebdriver.chromeMod.Options = js.native
  /**
    * @return {firefox.Options} the Firefox specific options currently configured
    *     for this instance.
    */
  def getFirefoxOptions(): typingsSlinky.seleniumDashWebdriver.firefoxMod.Options = js.native
  /**
  ...
  /**
    ...
    *     for this instance.
    */
  def getSafariOptions(): typingsSlinky.seleniumDashWebdriver.safariMod.Options = js.native
  /**
  ...
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setChromeOptions(options: typingsSlinky.seleniumDashWebdriver.chromeMod.Options): Builder = js.native
  /**
  ...
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setEdgeOptions(options: typingsSlinky.seleniumDashWebdriver.edgeMod.Options): Builder = js.native
  /**
    ...
    * @return {!Builder} a self reference.
    */
  def setEdgeService(service: typingsSlinky.seleniumDashWebdriver.edgeMod.ServiceBuilder): Builder = js.native
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setFirefoxOptions(options: typingsSlinky.seleniumDashWebdriver.firefoxMod.Options): Builder = js.native
  /**
    ...
    * @return {!Builder} a self reference.
    */
  def setFirefoxService(service: typingsSlinky.seleniumDashWebdriver.firefoxMod.ServiceBuilder): Builder = js.native
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setIeOptions(options: typingsSlinky.seleniumDashWebdriver.ieMod.Options): Builder = js.native
  /**
    ...
    * @return {!Builder} a self reference.
    */
  def setIeService(service: typingsSlinky.seleniumDashWebdriver.ieMod.ServiceBuilder): Builder = js.native
  ...
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setSafariOptions(options: typingsSlinky.seleniumDashWebdriver.safariMod.Options): Builder = js.native
  /**
  ...
  def withCapabilities(capabilities: typingsSlinky.seleniumDashWebdriver.libCapabilitiesMod.Capabilities): Builder = js.native
}
