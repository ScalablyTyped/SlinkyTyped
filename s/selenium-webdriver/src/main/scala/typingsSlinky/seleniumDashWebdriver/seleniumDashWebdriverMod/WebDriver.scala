...
import typingsSlinky.seleniumDashWebdriver.Anon_Async
import typingsSlinky.seleniumDashWebdriver.Anon_AsyncBoolean
import typingsSlinky.seleniumDashWebdriver.Anon_Bridge
import typingsSlinky.seleniumDashWebdriver.httpMod.Executor
import typingsSlinky.seleniumDashWebdriver.libCommandMod.Command
...
class WebDriver protected () extends js.Object {
  ...
  /**
    ...
    */
  def actions(): typingsSlinky.seleniumDashWebdriver.libInputMod.Actions = js.native
  def actions(options: Anon_Async): typingsSlinky.seleniumDashWebdriver.libInputMod.Actions = js.native
  def actions(options: Anon_AsyncBoolean): typingsSlinky.seleniumDashWebdriver.libInputMod.Actions = js.native
  def actions(options: Anon_Bridge): typingsSlinky.seleniumDashWebdriver.libInputMod.Actions = js.native
  /**
  ...
  /**
    ...
    */
  def getCapabilities(): js.Promise[typingsSlinky.seleniumDashWebdriver.libCapabilitiesMod.Capabilities] = js.native
  /**
  ...
  def getExecutor(): typingsSlinky.seleniumDashWebdriver.libCommandMod.Executor = js.native
  /**
