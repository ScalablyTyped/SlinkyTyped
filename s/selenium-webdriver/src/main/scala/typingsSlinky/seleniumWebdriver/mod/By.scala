...
@js.native
class By protected ()
  extends typingsSlinky.seleniumWebdriver.byMod.By {
  /**
...
object By extends js.Object {
  /**
    ...
    */
  def className(name: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
  /**
    ...
    */
  def css(selector: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
  /**
    ...
    * @return {!By} The new locator.
    */
  def id(id: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
  /**
  ...
  /**
    ...
    * @return {!By} The new locator.
    */
  def linkText(text: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
  /**
    ...
    * @return {!By} The new locator.
    */
  def name(name: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
  /**
    * Locates link elements whose
    ...
    * @return {!By} The new locator.
    */
  def partialLinkText(text: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
  /**
    ...
    */
  def tagName(name: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
  /**
    ...
    */
  def xpath(xpath: String): typingsSlinky.seleniumWebdriver.byMod.By = js.native
}
