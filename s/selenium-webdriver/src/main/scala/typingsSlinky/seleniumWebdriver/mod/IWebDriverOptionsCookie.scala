...
object IWebDriverOptionsCookie {
  ...
  implicit class IWebDriverOptionsCookieOps[Self <: IWebDriverOptionsCookie] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpiryDate(value: js.Date): Self = this.set("expiry", value.asInstanceOf[js.Any])
    @scala.inline
    def setExpiry(value: Double | js.Date): Self = this.set("expiry", value.asInstanceOf[js.Any])
    @scala.inline
