...
object ieMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.seleniumWebdriver.seleniumWebdriverStrings.FATAL
    - typingsSlinky.seleniumWebdriver.seleniumWebdriverStrings.ERROR
    - typingsSlinky.seleniumWebdriver.seleniumWebdriverStrings.WARN
    - typingsSlinky.seleniumWebdriver.seleniumWebdriverStrings.INFO
    - typingsSlinky.seleniumWebdriver.seleniumWebdriverStrings.DEBUG
    - typingsSlinky.seleniumWebdriver.seleniumWebdriverStrings.TRACE
  */
