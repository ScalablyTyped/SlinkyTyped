...
object byMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.seleniumWebdriver.AnonClassName
    - typingsSlinky.seleniumWebdriver.AnonCss
    - typingsSlinky.seleniumWebdriver.AnonId
    - typingsSlinky.seleniumWebdriver.AnonJs
    - typingsSlinky.seleniumWebdriver.AnonLinkText
    - typingsSlinky.seleniumWebdriver.AnonName
    - typingsSlinky.seleniumWebdriver.AnonPartialLinkText
    - typingsSlinky.seleniumWebdriver.AnonTagName
    - typingsSlinky.seleniumWebdriver.AnonXpath
  */
