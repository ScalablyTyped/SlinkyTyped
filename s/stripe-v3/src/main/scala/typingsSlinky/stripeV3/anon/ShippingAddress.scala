...
object ShippingAddress {
  ...
  implicit class ShippingAddressMutableBuilder[Self <: ShippingAddress] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShippingAddress(value: typingsSlinky.stripeV3.stripe.paymentRequest.ShippingAddress): Self = StObject.set(x, "shippingAddress", value.asInstanceOf[js.Any])
