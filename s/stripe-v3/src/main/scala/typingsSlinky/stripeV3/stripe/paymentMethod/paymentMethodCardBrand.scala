...
object paymentMethodCardBrand {
  ...
  @scala.inline
  def amex: typingsSlinky.stripeV3.stripeV3Strings.amex = "amex".asInstanceOf[typingsSlinky.stripeV3.stripeV3Strings.amex]
  
  @scala.inline
  def diners: typingsSlinky.stripeV3.stripeV3Strings.diners = "diners".asInstanceOf[typingsSlinky.stripeV3.stripeV3Strings.diners]
  ...
  @scala.inline
  def unionpay: typingsSlinky.stripeV3.stripeV3Strings.unionpay = "unionpay".asInstanceOf[typingsSlinky.stripeV3.stripeV3Strings.unionpay]
