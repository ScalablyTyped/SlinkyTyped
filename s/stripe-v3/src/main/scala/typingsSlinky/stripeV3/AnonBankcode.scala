...
object AnonBankcode {
  @scala.inline
  def apply(fingerprint: String, last4: String, mandate_reference: String): AnonBankcode = {
  ...
  @scala.inline
  implicit class AnonBankcodeOps[Self <: AnonBankcode] (val x: Self) extends AnyVal {
    @scala.inline
