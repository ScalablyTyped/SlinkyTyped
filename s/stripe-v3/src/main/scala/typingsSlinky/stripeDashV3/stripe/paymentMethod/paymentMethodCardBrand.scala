...
import typingsSlinky.stripeDashV3.stripeDashV3Strings.discover_
import typingsSlinky.stripeDashV3.stripeDashV3Strings.jcb_
import typingsSlinky.stripeDashV3.stripeDashV3Strings.mastercard_
import typingsSlinky.stripeDashV3.stripeDashV3Strings.unknown_
import typingsSlinky.stripeDashV3.stripeDashV3Strings.visa_
...
object paymentMethodCardBrand {
  @scala.inline
  def amex: typingsSlinky.stripeDashV3.stripeDashV3Strings.amex = this.cast("amex")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def diners: typingsSlinky.stripeDashV3.stripeDashV3Strings.diners = this.cast("diners")
  @scala.inline
  ...
  @scala.inline
  def unionpay: typingsSlinky.stripeDashV3.stripeDashV3Strings.unionpay = this.cast("unionpay")
  @scala.inline
