...
object paymentMethodType {
  @scala.inline
  def card: typingsSlinky.stripeDashV3.stripeDashV3Strings.card = this.cast("card")
  @scala.inline
  def card_present: typingsSlinky.stripeDashV3.stripeDashV3Strings.card_present = this.cast("card_present")
  @scala.inline
