...
object tokenizationType {
  @scala.inline
  def android_pay: typingsSlinky.stripeDashV3.stripeDashV3Strings.android_pay = this.cast("android_pay")
  @scala.inline
  def apple_pay: typingsSlinky.stripeDashV3.stripeDashV3Strings.apple_pay = this.cast("apple_pay")
  @scala.inline
