...
object SockettyServer {
  ...
  implicit class SockettyServerOps[Self <: SockettyServer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConnection(value: js.Function1[/* socket */ SockettySocket, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("connection")(js.Any.fromFunction1(value))
        ret
    }
  }
