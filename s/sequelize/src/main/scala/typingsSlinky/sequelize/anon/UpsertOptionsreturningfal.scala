...
object UpsertOptionsreturningfal {
  ...
  @scala.inline
  def apply(returning: js.UndefOr[Boolean] with js.UndefOr[`false`]): UpsertOptionsreturningfal = {
    val __obj = js.Dynamic.literal(returning = returning.asInstanceOf[js.Any])
    __obj.asInstanceOf[UpsertOptionsreturningfal]
  }
  
  @scala.inline
  implicit class UpsertOptionsreturningfalOps[Self <: UpsertOptionsreturningfal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturning(value: js.UndefOr[Boolean] with js.UndefOr[`false`]): Self = this.set("returning", value.asInstanceOf[js.Any])
