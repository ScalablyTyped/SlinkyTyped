...
package object sequelizeMod {
  ...
  import typingsSlinky.sequelize.Anon_
  import typingsSlinky.sequelize.Anon_Adjacent
  import typingsSlinky.sequelize.Anon_As
  import typingsSlinky.sequelize.Anon_Through
  import typingsSlinky.sequelize.sequelizeStrings.DEFERRED
  import typingsSlinky.sequelize.sequelizeStrings.EXCLUSIVE
  import typingsSlinky.sequelize.sequelizeStrings.IMMEDIATE
  import typingsSlinky.sequelize.sequelizeStrings.SERIALIZABLE
  import typingsSlinky.sequelize.sequelizeStrings.SHARE
  import typingsSlinky.sequelize.sequelizeStrings.UPDATE
  import typingsSlinky.sequelize.sequelizeStrings.`KEY SHARE`
  import typingsSlinky.sequelize.sequelizeStrings.`NO KEY UPDATE`
  import typingsSlinky.sequelize.sequelizeStrings.`READ COMMITTED`
  import typingsSlinky.sequelize.sequelizeStrings.`READ UNCOMMITTED`
  import typingsSlinky.sequelize.sequelizeStrings.`REPEATABLE READ`
  ...
  type BelongsToCreateAssociationMixin[TAttributes, TInstance] = js.Function2[
    ...
    typingsSlinky.bluebird.bluebirdMod.^[TInstance]
  ]
  /**
  ...
  type BelongsToGetAssociationMixin[TInstance] = js.Function1[
    ...
    typingsSlinky.bluebird.bluebirdMod.^[TInstance | Null]
  ]
  /**
  ...
  type BelongsToManyCountAssociationsMixin = js.Function1[
    ...
    typingsSlinky.bluebird.bluebirdMod.^[Double]
  ]
  /**
  ...
  type BelongsToManyGetAssociationsMixin[TInstance] = js.Function1[
    ...
    typingsSlinky.bluebird.bluebirdMod.^[js.Array[TInstance]]
  ]
  /**
  ...
  type BelongsToManyHasAssociationMixin[TInstance, TInstancePrimaryKey] = js.Function2[
    ...
    typingsSlinky.bluebird.bluebirdMod.^[Boolean]
  ]
  /**
  ...
  {[ P in keyof T ]: string | sequelize.sequelize.DataTypeAbstract | sequelize.sequelize.DefineAttributeColumnOptions}
    */ typingsSlinky.sequelize.sequelizeStrings.DefineModelAttributes with js.Any
  /**
  ...
  {[ P in keyof T ]:? sequelize.sequelize.Primitives | std.Array<sequelize.sequelize.Primitives> | sequelize.sequelize.WhereLogic | T[P] extends sequelize.sequelize.Primitives? null : / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias sequelize.sequelize.WhereOptions<T[P]> * / object | sequelize.sequelize.col | sequelize.sequelize.and | sequelize.sequelize.or | sequelize.sequelize.WhereGeometryOptions | sequelize.sequelize.WhereNested | sequelize.sequelize.where | null}
    */ typingsSlinky.sequelize.sequelizeStrings.WhereOptions with T
}
