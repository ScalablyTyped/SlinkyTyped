...
import typingsSlinky.sequelize.Anon_Clone
import typingsSlinky.sequelize.Anon_Skip
...
trait Instance[TAttributes] extends js.Object {
  /**
    ...
    * @see Model
    */
  var Model: typingsSlinky.sequelize.sequelizeMod.Model[this.type, TAttributes, TAttributes] = js.native
  /**
  ...
  def decrement(fields: String): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def decrement(fields: String, options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def decrement(fields: js.Array[String]): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def decrement(fields: js.Array[String], options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  /**
    ...
    */
  def decrement(fields: Partial[TAttributes]): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def decrement(fields: Partial[TAttributes], options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  /**
    * Destroy the row corresponding to this instance. Depending on your setting for paranoid, the row will
    * either be completely deleted, or have its deletedAt timestamp set to the current time.
    */
  def destroy(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  def destroy(options: InstanceDestroyOptions): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  def increment(fields: String): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def increment(fields: String, options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def increment(fields: js.Array[String]): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def increment(fields: js.Array[String], options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  /**
    ...
    */
  def increment(fields: Partial[TAttributes]): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def increment(fields: Partial[TAttributes], options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  ...
  /**
    ...
    */
  def reload(): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def reload(options: AnyFindOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  /**
    * Restore the row corresponding to this instance. Only available for paranoid models.
    */
  def restore(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  def restore(options: InstanceRestoreOptions): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  def save(): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def save(options: InstanceSaveOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  ...
  def update(keys: js.Object): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def update(keys: js.Object, options: InstanceUpdateOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  /**
  ...
  def update[K /* <: String */](
    key: K,
    value: /* import warning: importer.ImportType#apply Failed type conversion: TAttributes[K] */ js.Any
  ): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def update[K /* <: String */](
    key: K,
    value: /* import warning: importer.ImportType#apply Failed type conversion: TAttributes[K] */ js.Any,
    options: InstanceUpdateOptions
  ): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def updateAttributes(keys: js.Object): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  def updateAttributes(keys: js.Object, options: InstanceUpdateOptions): typingsSlinky.bluebird.bluebirdMod.^[this.type] = js.native
  ...
  def validate(options: Anon_Skip): typingsSlinky.bluebird.bluebirdMod.^[ValidationError] = js.native
  /**
