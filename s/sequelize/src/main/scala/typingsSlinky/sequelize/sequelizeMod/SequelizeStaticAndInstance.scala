...
import typingsSlinky.sequelize.Anon_A1
...
trait SequelizeStaticAndInstance extends Errors {
  /**
    ...
    */
  var Deferrable: typingsSlinky.sequelize.sequelizeMod.Deferrable = js.native
  /**
    * A reference to the sequelize instance class.
    */
  var Instance: typingsSlinky.sequelize.sequelizeMod.Instance[_] = js.native
  /**
    ...
    */
  var Model: typingsSlinky.sequelize.sequelizeMod.Model[_, _, _] = js.native
  ...
  /**
    ...
    */
  var QueryTypes: typingsSlinky.sequelize.sequelizeMod.QueryTypes = js.native
  /**
  ...
  /**
    ...
    */
  var Utils: typingsSlinky.sequelize.sequelizeMod.Utils = js.native
  /**
    ...
    */
  var Validator: typingsSlinky.sequelize.sequelizeMod.Validator = js.native
  /**
    * An AND query
    *
    * @param args Each argument will be joined by AND
    */
  def and(args: (String | js.Object)*): typingsSlinky.sequelize.sequelizeMod.and = js.native
  ...
  /**
    ...
    */
  def cast(`val`: js.Any, `type`: String): typingsSlinky.sequelize.sequelizeMod.cast = js.native
  /**
    ...
    */
  def col(col: String): typingsSlinky.sequelize.sequelizeMod.col = js.native
  ...
  /**
    ...
    */
  def fn(fn: String, args: js.Any*): typingsSlinky.sequelize.sequelizeMod.fn = js.native
  /**
    ...
    *     '<value>'".
    */
  def json(conditionsOrPath: String): typingsSlinky.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: String, value: String): typingsSlinky.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: String, value: Boolean): typingsSlinky.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: String, value: Double): typingsSlinky.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object): typingsSlinky.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: String): typingsSlinky.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: Boolean): typingsSlinky.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: Double): typingsSlinky.sequelize.sequelizeMod.json = js.native
  /**
    * Creates a object representing a literal, i.e. something that will not be escaped.
    *
    * @param val
    */
  def literal(`val`: js.Any): typingsSlinky.sequelize.sequelizeMod.literal = js.native
  /**
    * An OR query
    *
    * @param args Each argument will be joined by OR
    */
  def or(args: (String | js.Object)*): typingsSlinky.sequelize.sequelizeMod.or = js.native
  /**
    ...
    *     etc.)
    */
  def where(attr: js.Object, comparator: String, logic: String): typingsSlinky.sequelize.sequelizeMod.where = js.native
  def where(attr: js.Object, comparator: String, logic: js.Object): typingsSlinky.sequelize.sequelizeMod.where = js.native
  def where(attr: js.Object, logic: String): typingsSlinky.sequelize.sequelizeMod.where = js.native
  def where(attr: js.Object, logic: js.Object): typingsSlinky.sequelize.sequelizeMod.where = js.native
}
