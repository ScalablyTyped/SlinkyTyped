...
trait Transaction extends js.Object {
  ...
  /**
    ...
    */
  def commit(): typingsSlinky.bluebird.bluebirdMod.^[Unit]
  /**
    * Rollback (abort) the transaction
    */
  def rollback(): typingsSlinky.bluebird.bluebirdMod.^[Unit]
}
...
object Transaction {
  ...
  def apply(
    ...
    commit: () => typingsSlinky.bluebird.bluebirdMod.^[Unit],
    rollback: () => typingsSlinky.bluebird.bluebirdMod.^[Unit]
  ): Transaction = {
