...
import typingsSlinky.sequelize.sequelizeStrings.`10`
import typingsSlinky.sequelize.sequelizeStrings.`13`
import typingsSlinky.sequelize.sequelizeStrings.`4`
import typingsSlinky.sequelize.sequelizeStrings.`6`
import typingsSlinky.sequelize.sequelizeStrings.all
import typingsSlinky.sequelize.sequelizeStrings.any
...
trait ValidatorJSType extends js.Object {
  ...
  @JSName("isUUID")
  def isUUID_3(str: String, version: typingsSlinky.sequelize.sequelizeStrings.`3`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_4(str: String, version: typingsSlinky.sequelize.sequelizeNumbers.`4`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_4(str: String, version: `4`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_5(str: String, version: `5`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_5(str: String, version: typingsSlinky.sequelize.sequelizeStrings.`5`): Boolean = js.native
  @JSName("isUUID")
