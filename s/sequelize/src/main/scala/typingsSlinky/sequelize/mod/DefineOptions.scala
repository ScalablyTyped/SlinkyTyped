...
object DefineOptions {
  ...
  def apply[TInstance](
    ...
    rejectOnError: Boolean | js.Error = null,
    ...
    if (!js.isUndefined(freezeTableName)) __obj.updateDynamic("freezeTableName")(freezeTableName.get.asInstanceOf[js.Any])
    if (getterMethods != null) __obj.updateDynamic("getterMethods")(getterMethods.asInstanceOf[js.Any])
    if (!js.isUndefined(hasTrigger)) __obj.updateDynamic("hasTrigger")(hasTrigger.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(underscored)) __obj.updateDynamic("underscored")(underscored.get.asInstanceOf[js.Any])
    if (!js.isUndefined(underscoredAll)) __obj.updateDynamic("underscoredAll")(underscoredAll.get.asInstanceOf[js.Any])
