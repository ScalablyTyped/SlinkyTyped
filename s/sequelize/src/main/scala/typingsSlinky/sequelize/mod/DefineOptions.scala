...
object DefineOptions {
  ...
  implicit class DefineOptionsOps[Self <: DefineOptions[_], TInstance] (val x: Self with DefineOptions[TInstance]) extends AnyVal {
    ...
    @scala.inline
    def setRejectOnErrorError(value: js.Error): Self = this.set("rejectOnError", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRejectOnError(value: Boolean | js.Error): Self = this.set("rejectOnError", value.asInstanceOf[js.Any])
