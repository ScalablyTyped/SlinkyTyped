...
trait Sequelize
  ...
  /**
    ...
    */
  def authenticate(): typingsSlinky.bluebird.mod.^[Unit] = js.native
  def authenticate(options: QueryOptions): typingsSlinky.bluebird.mod.^[Unit] = js.native
  ...
  /**
    ...
    */
  def close(): typingsSlinky.bluebird.mod.^[Unit] = js.native
  ...
  /**
    ...
    */
  def createSchema(schema: String, options: `2`): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    */
  def drop(): typingsSlinky.bluebird.mod.^[_] = js.native
  def drop(options: DropOptions): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def dropAllSchemas(options: `2`): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def dropSchema(schema: String, options: `2`): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @param options Query options.
    */
  def set(variables: js.Object, options: QueryOptionsTransactionRequired): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def showAllSchemas(options: `2`): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    */
  def sync(): typingsSlinky.bluebird.mod.^[_] = js.native
  def sync(options: SyncOptions): typingsSlinky.bluebird.mod.^[_] = js.native
  
  def transaction(): typingsSlinky.bluebird.mod.^[Transaction] = js.native
  def transaction(options: TransactionOptions): typingsSlinky.bluebird.mod.^[Transaction] = js.native
  def transaction[T](autoCallback: js.Function1[/* t */ Transaction, js.Thenable[T]]): typingsSlinky.bluebird.mod.^[T] = js.native
  /**
    ...
    */
  def transaction[T](options: TransactionOptions, autoCallback: js.Function1[/* t */ Transaction, js.Thenable[T]]): typingsSlinky.bluebird.mod.^[T] = js.native
  ...
  /**
    ...
    */
  def truncate(): typingsSlinky.bluebird.mod.^[_] = js.native
  def truncate(options: DestroyOptions): typingsSlinky.bluebird.mod.^[_] = js.native
  
  def validate(): typingsSlinky.bluebird.mod.^[ValidationError] = js.native
  def validate(options: QueryOptions): typingsSlinky.bluebird.mod.^[ValidationError] = js.native
}
