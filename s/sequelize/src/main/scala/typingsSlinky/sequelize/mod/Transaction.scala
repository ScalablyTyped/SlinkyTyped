...
object Transaction {
  ...
  implicit class TransactionOps[Self <: Transaction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommit(value: () => typingsSlinky.bluebird.mod.^[Unit]): Self = this.set("commit", js.Any.fromFunction0(value))
    
    @scala.inline
    def setRollback(value: () => typingsSlinky.bluebird.mod.^[Unit]): Self = this.set("rollback", js.Any.fromFunction0(value))
  }
}
