...
object RetryOptions {
  ...
  implicit class RetryOptionsMutableBuilder[Self <: RetryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMatch(value: js.Array[String | js.RegExp | js.Error]): Self = StObject.set(x, "match", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMatchUndefined: Self = StObject.set(x, "match", js.undefined)
    
    @scala.inline
    def setMatchVarargs(value: (String | js.RegExp | js.Error)*): Self = StObject.set(x, "match", js.Array(value :_*))
