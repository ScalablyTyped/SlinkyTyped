...
object RetryOptions {
  ...
  implicit class RetryOptionsOps[Self <: RetryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMatchVarargs(value: (String | js.RegExp | js.Error)*): Self = this.set("match", js.Array(value :_*))
    
    @scala.inline
    def setMatch(value: js.Array[String | js.RegExp | js.Error]): Self = this.set("match", value.asInstanceOf[js.Any])
