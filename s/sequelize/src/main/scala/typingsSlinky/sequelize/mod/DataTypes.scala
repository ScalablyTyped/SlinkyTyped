...
import typingsSlinky.sequelize.AnonLength
import typingsSlinky.sequelize.AnonLengthNumber
import typingsSlinky.sequelize.AnonLengthString
import typingsSlinky.sequelize.AnonPrecision
import typingsSlinky.sequelize.AnonSubtype
import typingsSlinky.sequelize.AnonType
import typingsSlinky.sequelize.AnonValues
