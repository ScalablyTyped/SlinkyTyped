...
import typingsSlinky.sequelize.anon.Length
import typingsSlinky.sequelize.anon.LengthNumber
import typingsSlinky.sequelize.anon.LengthString
import typingsSlinky.sequelize.anon.Precision
import typingsSlinky.sequelize.anon.Subtype
