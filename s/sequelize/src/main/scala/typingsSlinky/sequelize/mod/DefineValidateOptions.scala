...
object DefineValidateOptions {
  ...
  implicit class DefineValidateOptionsMutableBuilder[Self <: DefineValidateOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIs(value: String | (js.Array[String | js.RegExp]) | js.RegExp | Args): Self = StObject.set(x, "is", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsRegExp(value: js.RegExp): Self = StObject.set(x, "is", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "is", js.Array(value :_*))
    ...
    @scala.inline
    def setNot(value: String | (js.Array[String | js.RegExp]) | js.RegExp | Args): Self = StObject.set(x, "not", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNotRegExp(value: js.RegExp): Self = StObject.set(x, "not", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNotUndefined: Self = StObject.set(x, "not", js.undefined)
    
    @scala.inline
    def setNotVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "not", js.Array(value :_*))
  }
}
