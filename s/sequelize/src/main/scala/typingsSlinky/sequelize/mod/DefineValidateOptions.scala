...
object DefineValidateOptions {
  ...
  def apply(
    ...
    is: String | (js.Array[String | js.RegExp]) | js.RegExp | Args = null,
    ...
    isUUID: `3` | `4` | `5` | typingsSlinky.sequelize.sequelizeStrings.`3` | typingsSlinky.sequelize.sequelizeStrings.`4` | typingsSlinky.sequelize.sequelizeStrings.`5` | all | ArgsNumber = null,
    ...
    not: String | (js.Array[String | js.RegExp]) | js.RegExp | Args = null,
