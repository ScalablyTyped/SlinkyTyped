...
object DefineValidateOptions {
  ...
  implicit class DefineValidateOptionsOps[Self <: DefineValidateOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsVarargs(value: (String | js.RegExp)*): Self = this.set("is", js.Array(value :_*))
    
    @scala.inline
    def setIsRegExp(value: js.RegExp): Self = this.set("is", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIs(value: String | (js.Array[String | js.RegExp]) | js.RegExp | Args): Self = this.set("is", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNotVarargs(value: (String | js.RegExp)*): Self = this.set("not", js.Array(value :_*))
    
    @scala.inline
    def setNotRegExp(value: js.RegExp): Self = this.set("not", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNot(value: String | (js.Array[String | js.RegExp]) | js.RegExp | Args): Self = this.set("not", value.asInstanceOf[js.Any])
