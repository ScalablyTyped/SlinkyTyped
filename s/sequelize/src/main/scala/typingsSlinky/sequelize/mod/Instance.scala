...
trait Instance[TAttributes] extends js.Object {
  ...
  def decrement(fields: String): typingsSlinky.bluebird.mod.^[this.type] = js.native
  def decrement(fields: String, options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.mod.^[this.type] = js.native
  def decrement(fields: js.Array[String]): typingsSlinky.bluebird.mod.^[this.type] = js.native
  def decrement(fields: js.Array[String], options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.mod.^[this.type] = js.native
  /**
  ...
  def increment(fields: String): typingsSlinky.bluebird.mod.^[this.type] = js.native
  def increment(fields: String, options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.mod.^[this.type] = js.native
  def increment(fields: js.Array[String]): typingsSlinky.bluebird.mod.^[this.type] = js.native
  def increment(fields: js.Array[String], options: InstanceIncrementDecrementOptions): typingsSlinky.bluebird.mod.^[this.type] = js.native
  /**
