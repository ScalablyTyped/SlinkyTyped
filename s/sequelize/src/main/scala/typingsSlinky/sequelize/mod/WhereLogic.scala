...
object WhereLogic {
  ...
  implicit class WhereLogicOps[Self <: WhereLogic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set$between(value: js.Tuple2[js.Date | Double, js.Date | Double]): Self = this.set("$between", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def set$gtDate(value: js.Date): Self = this.set("$gt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$gt(value: Double | String | js.Date): Self = this.set("$gt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def delete$gt: Self = this.set("$gt", js.undefined)
    
    @scala.inline
    def set$gteDate(value: js.Date): Self = this.set("$gte", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$gte(value: Double | String | js.Date): Self = this.set("$gte", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def set$ltDate(value: js.Date): Self = this.set("$lt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$lt(value: Double | String | js.Date): Self = this.set("$lt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def delete$lt: Self = this.set("$lt", js.undefined)
    
    @scala.inline
    def set$lteDate(value: js.Date): Self = this.set("$lte", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$lte(value: Double | String | js.Date): Self = this.set("$lte", value.asInstanceOf[js.Any])
