...
object WhereLogic {
  @scala.inline
  def apply(
    $between: js.Tuple2[js.Date | Double, js.Date | Double] = null,
    $contained: js.Any = null,
    $contains: js.Any = null,
    $gt: Double | String | js.Date = null,
    $gte: Double | String | js.Date = null,
    $iLike: String | WherePGStatement = null,
    $ilike: String | WherePGStatement = null,
    $in: (js.Array[String | Double]) | literal = null,
    $like: String | WherePGStatement = null,
    $lt: Double | String | js.Date = null,
    $lte: Double | String | js.Date = null,
