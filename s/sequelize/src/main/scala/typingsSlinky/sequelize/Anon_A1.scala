...
trait Anon_A1
  ...
  /**
    ...
    */
  var AggregateError: Instantiable0[typingsSlinky.bluebird.bluebirdMod.AggregateError] = js.native
  /**
    * Signals that an operation has been aborted or cancelled. The default reason used by `.cancel`.
    */
  var CancellationError: Instantiable0[typingsSlinky.bluebird.bluebirdMod.CancellationError] = js.native
  /**
    * returned by `Bluebird.disposer()`.
    */
  var Disposer: Instantiable0[typingsSlinky.bluebird.bluebirdMod.Disposer[js.Object]] = js.native
  /**
    ...
    */
  var OperationalError: Instantiable0[typingsSlinky.bluebird.bluebirdMod.OperationalError] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeoutError: Instantiable0[typingsSlinky.bluebird.bluebirdMod.TimeoutError] = js.native
  /**
