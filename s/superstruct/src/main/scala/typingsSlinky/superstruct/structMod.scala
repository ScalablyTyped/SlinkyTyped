...
import typingsSlinky.superstruct.anon.Defaults
...
object structMod extends js.Object {
  ...
  trait Struct extends js.Object {
    ...
    /**
      ...
      * ```
      */
    def fail(obj: typingsSlinky.superstruct.anon.Branch): Failure = js.native
    /**
    ...
    /**
      ...
      * ```
      */
    def validate(value: js.Any): js.Tuple2[js.UndefOr[js.Error], js.UndefOr[_]] = js.native
  }
