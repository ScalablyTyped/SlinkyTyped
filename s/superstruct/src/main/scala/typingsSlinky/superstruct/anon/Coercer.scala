...
import typingsSlinky.superstruct.indexCjsMod.StructContext
import typingsSlinky.superstruct.indexCjsMod.StructResult
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait Coercer[S, T] extends js.Object {
...
object Coercer {
  ...
  @scala.inline
  implicit class CoercerOps[Self <: Coercer[_, _], S, T] (val x: Self with (Coercer[S, T])) extends AnyVal {
