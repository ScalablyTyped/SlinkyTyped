...
object anon {
  ...
  trait Refiner[S, T] extends StObject {
    ...
    var refiner: js.UndefOr[
        js.Function2[
          /* value */ T, 
          /* context */ typingsSlinky.superstruct.structMod.StructContext, 
          typingsSlinky.superstruct.structMod.StructResult
        ]
      ] = js.native
  ...
  object Refiner {
    ...
    implicit class RefinerMutableBuilder[Self <: Refiner[_, _], S, T] (val x: Self with (Refiner[S, T])) extends AnyVal {
      ...
      @scala.inline
      def setRefiner(
        value: (/* value */ T, /* context */ typingsSlinky.superstruct.structMod.StructContext) => typingsSlinky.superstruct.structMod.StructResult
      ...
      @scala.inline
      def setValidator(
        value: (/* value */ js.Any, /* context */ typingsSlinky.superstruct.structMod.StructContext) => typingsSlinky.superstruct.structMod.StructResult
  ...
  trait Schema[S, T] extends StObject {
    ...
    var refiner: js.UndefOr[
        js.Function2[
          /* value */ T, 
          /* context */ typingsSlinky.superstruct.indexEsMod.StructContext, 
          typingsSlinky.superstruct.indexEsMod.StructResult
        ]
      ] = js.native
  ...
  object Schema {
    ...
    implicit class SchemaMutableBuilder[Self <: Schema[_, _], S, T] (val x: Self with (Schema[S, T])) extends AnyVal {
      ...
      @scala.inline
      def setRefiner(
        value: (/* value */ T, /* context */ typingsSlinky.superstruct.indexEsMod.StructContext) => typingsSlinky.superstruct.indexEsMod.StructResult
      ): Self = StObject.set(x, "refiner", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setValidator(
        value: (/* value */ js.Any, /* context */ typingsSlinky.superstruct.indexEsMod.StructContext) => typingsSlinky.superstruct.indexEsMod.StructResult
      ): Self = StObject.set(x, "validator", js.Any.fromFunction2(value))
