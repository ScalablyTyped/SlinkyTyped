...
@js.native
trait Superstruct extends js.Object {
  /**
    * The class for errors thrown by `Structs`, defaults to [[StructError]].
    */
  var Error: Anon_Failures = js.native
  /**
...
@JSImport("superstruct/lib/superstruct", "superstruct")
@js.native
object superstruct extends js.Object {
  def apply(): Superstruct = js.native
  def apply(settings: Partial[SuperstructSettings]): Superstruct = js.native
}
