...
object mod {
  ...
  @js.native
  def validate[T](value: js.Any, struct: Struct[T, _]): js.Tuple2[js.UndefOr[typingsSlinky.superstruct.structMod.StructError], js.UndefOr[T]] = js.native
  @JSImport("superstruct", "validate")
  @js.native
  def validate[T](value: js.Any, struct: Struct[T, _], coercing: Boolean): js.Tuple2[js.UndefOr[typingsSlinky.superstruct.structMod.StructError], js.UndefOr[T]] = js.native
