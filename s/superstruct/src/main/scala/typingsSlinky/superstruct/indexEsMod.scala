...
import typingsSlinky.superstruct.anon.Schema
...
object indexEsMod {
  ...
  @js.native
  def enums[T /* <: Double */](values: js.Array[T]): Struct_[T, _] = js.native
  @JSImport("superstruct/lib/index.es", "enums")
  @js.native
  def enums_T_String[T /* <: String */](values: js.Array[T]): Struct_[T, _] = js.native
  ...
  @js.native
  def literal[T](constant: T): Struct_[T, _] = js.native
  /**
