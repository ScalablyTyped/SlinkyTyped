...
package object indexCjsMod {
  ...
  /**
    ...
    * undefined (ie. when `optional()` is used to define a type)
    */
  type OptionalizeObject[T] = typingsSlinky.superstruct.indexCjsMod.Flatten[
  ...
  type StructRecord[T] = typingsSlinky.std.Record[java.lang.String, typingsSlinky.superstruct.indexCjsMod.Struct_[T, js.Any]]
  /**
  ...
  /**
    * A `StructResult` is returned from validation functions.
    */
  type StructResult = scala.Boolean | js.Iterable[typingsSlinky.superstruct.indexCjsMod.StructFailure]
  ...
  /**
    * A type utility to extract the type from a `Struct` class.
    */
  type StructType[T /* <: typingsSlinky.superstruct.indexCjsMod.Struct_[_, _] */] = /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<T['refiner']>[0] */ js.Any
}
