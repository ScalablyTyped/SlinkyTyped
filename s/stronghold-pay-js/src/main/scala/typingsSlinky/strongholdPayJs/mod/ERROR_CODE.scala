...
@JSImport("stronghold-pay-js", "ERROR_CODE")
@js.native
object ERROR_CODE extends js.Object {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typingsSlinky.strongholdPayJs.mod.global.Stronghold.ERROR_CODE with String] = js.native
