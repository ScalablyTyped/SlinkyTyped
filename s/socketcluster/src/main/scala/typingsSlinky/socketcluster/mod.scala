...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.socketcluster.socketclusterStrings.red
    - typingsSlinky.socketcluster.socketclusterStrings.green
    - typingsSlinky.socketcluster.socketclusterStrings.yellow
  */
