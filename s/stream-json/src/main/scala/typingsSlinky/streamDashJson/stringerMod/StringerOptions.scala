package typingsSlinky.streamDashJson.stringerMod
...
trait StringerOptions extends TransformOptions {
  var useKeyValues: js.UndefOr[Boolean] = js.undefined
  var useNumberValues: js.UndefOr[Boolean] = js.undefined
...
object StringerOptions {
  ...
  def apply(
    ...
    useKeyValues: js.UndefOr[Boolean] = js.undefined,
    useNumberValues: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(useKeyValues)) __obj.updateDynamic("useKeyValues")(useKeyValues.asInstanceOf[js.Any])
    if (!js.isUndefined(useNumberValues)) __obj.updateDynamic("useNumberValues")(useNumberValues.asInstanceOf[js.Any])
