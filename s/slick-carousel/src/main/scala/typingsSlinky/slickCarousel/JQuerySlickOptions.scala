...
object JQuerySlickOptions {
  ...
  implicit class JQuerySlickOptionsOps[Self <: JQuerySlickOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppendArrowsElement(value: Element): Self = this.set("appendArrows", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAppendDotsElement(value: Element): Self = this.set("appendDots", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAsNavForElement(value: Element): Self = this.set("asNavFor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNextArrowElement(value: Element): Self = this.set("nextArrow", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrevArrowElement(value: Element): Self = this.set("prevArrow", value.asInstanceOf[js.Any])
