...
object JQuerySlickOptions {
  ...
  implicit class JQuerySlickOptionsMutableBuilder[Self <: JQuerySlickOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppendArrowsElement(value: Element): Self = StObject.set(x, "appendArrows", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAppendDotsElement(value: Element): Self = StObject.set(x, "appendDots", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAsNavForElement(value: Element): Self = StObject.set(x, "asNavFor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNextArrowElement(value: Element): Self = StObject.set(x, "nextArrow", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrevArrowElement(value: Element): Self = StObject.set(x, "prevArrow", value.asInstanceOf[js.Any])
