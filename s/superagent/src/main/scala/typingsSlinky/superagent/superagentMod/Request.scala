...
import typingsSlinky.superagent.Anon_Auto
import typingsSlinky.superagent.Anon_Bearer
import typingsSlinky.superagent.Anon_ContentType
import typingsSlinky.superagent.Anon_Deadline
import typingsSlinky.superagent.Anon_Passphrase
