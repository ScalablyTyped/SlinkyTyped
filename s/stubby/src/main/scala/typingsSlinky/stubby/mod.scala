...
object mod {
  ...
  */
  ...
  object StubbyMethod {
    ...
    @scala.inline
    def CONNECT: typingsSlinky.stubby.stubbyStrings.CONNECT = "CONNECT".asInstanceOf[typingsSlinky.stubby.stubbyStrings.CONNECT]
    
    @scala.inline
    def DELETE: typingsSlinky.stubby.stubbyStrings.DELETE = "DELETE".asInstanceOf[typingsSlinky.stubby.stubbyStrings.DELETE]
    
    @scala.inline
    def GET: typingsSlinky.stubby.stubbyStrings.GET = "GET".asInstanceOf[typingsSlinky.stubby.stubbyStrings.GET]
    
    @scala.inline
    def HEAD: typingsSlinky.stubby.stubbyStrings.HEAD = "HEAD".asInstanceOf[typingsSlinky.stubby.stubbyStrings.HEAD]
    
    @scala.inline
    def OPTIONS: typingsSlinky.stubby.stubbyStrings.OPTIONS = "OPTIONS".asInstanceOf[typingsSlinky.stubby.stubbyStrings.OPTIONS]
    
    @scala.inline
    def PATCH: typingsSlinky.stubby.stubbyStrings.PATCH = "PATCH".asInstanceOf[typingsSlinky.stubby.stubbyStrings.PATCH]
    
    @scala.inline
    def POST: typingsSlinky.stubby.stubbyStrings.POST = "POST".asInstanceOf[typingsSlinky.stubby.stubbyStrings.POST]
    
    @scala.inline
    def PUT: typingsSlinky.stubby.stubbyStrings.PUT = "PUT".asInstanceOf[typingsSlinky.stubby.stubbyStrings.PUT]
    
    @scala.inline
    def TRACE: typingsSlinky.stubby.stubbyStrings.TRACE = "TRACE".asInstanceOf[typingsSlinky.stubby.stubbyStrings.TRACE]
  }
  ...
  */
  ...
  object StubbyOptions {
    ...
    def StubbyWithKeyCertOptions(
      ...
      __obj.asInstanceOf[typingsSlinky.stubby.mod.StubbyWithKeyCertOptions]
    }
    
    @scala.inline
    def StubbyWithPfxOptions(): typingsSlinky.stubby.mod.StubbyWithPfxOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.stubby.mod.StubbyWithPfxOptions]
    }
  }
