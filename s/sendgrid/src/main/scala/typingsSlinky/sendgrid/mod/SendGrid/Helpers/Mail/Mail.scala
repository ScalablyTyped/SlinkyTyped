...
object Mail {
  ...
  def apply(
  ...
  ): typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.Mail = {
    ...
    __obj.asInstanceOf[typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.Mail]
  }
  
  @scala.inline
  implicit class MailMutableBuilder[Self <: typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.Mail] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setToJSON(value: () => typingsSlinky.sendgrid.anon.Asm): Self = StObject.set(x, "toJSON", js.Any.fromFunction0(value))
  }
}
