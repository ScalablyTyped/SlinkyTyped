...
trait Helper extends js.Object {
  ...
  var Attachment: Instantiable0[typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.Attachment]
  ...
  var Category: Instantiable1[/* name */ String, typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.Category]
  ...
  var Mail: Instantiable0[typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.Mail]
  var MailSettings: Instantiable0[typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.MailSettings]
  var OpenTracking: Instantiable2[
    /* enable */ Boolean, 
    /* subscriptionTag */ String, 
    typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.OpenTracking
  ]
  var Personalization: Instantiable0[typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.Personalization]
  var SandBoxMode: Instantiable1[/* enable */ Boolean, typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.SandBoxMode]
  ...
  var TrackingSettings: Instantiable0[typingsSlinky.sendgrid.mod.SendGrid.Helpers.Mail.TrackingSettings]
}
