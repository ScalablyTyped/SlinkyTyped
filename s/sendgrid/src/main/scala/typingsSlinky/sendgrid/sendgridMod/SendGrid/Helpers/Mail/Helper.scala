package typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail
...
trait Helper extends js.Object {
  var Asm: Instantiable2[
    ...
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Asm
  ]
  var Attachment: Instantiable0[typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Attachment]
  var Bcc: Instantiable2[
    /* enable */ Boolean, 
    /* email */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Bcc
  ]
  var BypassListManagement: Instantiable1[
    /* enable */ Boolean, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.BypassListManagement
  ]
  var Category: Instantiable1[
    /* name */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Category
  ]
  var ClickTracking: Instantiable2[
    /* enable */ Boolean, 
    /* enableText */ Boolean, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.ClickTracking
  ]
  var Content: Instantiable2[
    /* mimetype */ String, 
    /* text */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Content
  ]
  var CustomArgs: Instantiable2[
    /* key */ String, 
    /* value */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.CustomArgs
  ]
  var Email: Instantiable2[
    /* address */ String, 
    js.UndefOr[/* name */ String], 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Email
  ]
  var Footer: Instantiable3[
    /* enable */ Boolean, 
    /* text */ String, 
    /* html */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Footer
  ]
  var Ganalytics: Instantiable6[
    ...
    /* utm_content */ String, 
    /* utm_campaign */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Ganalytics
  ]
  var Header: Instantiable2[
    /* key */ String, 
    /* value */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Header
  ]
  var Mail: Instantiable0[typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Mail]
  var MailSettings: Instantiable0[typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.MailSettings]
  var OpenTracking: Instantiable2[
    /* enable */ Boolean, 
    /* subscriptionTag */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.OpenTracking
  ]
  var Personalization: Instantiable0[typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Personalization]
  var SandBoxMode: Instantiable1[
    /* enable */ Boolean, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.SandBoxMode
  ]
  var Section: Instantiable2[
    /* key */ String, 
    /* value */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Section
  ]
  var SpamCheck: Instantiable3[
    /* enable */ Boolean, 
    /* threshold */ Double, 
    /* post_to_url */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.SpamCheck
  ]
  var SubscriptionTracking: Instantiable4[
    ...
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.SubscriptionTracking
  ]
  var Substitution: Instantiable2[
    /* key */ String, 
    /* value */ String, 
    typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Substitution
  ]
  var TrackingSettings: Instantiable0[typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.TrackingSettings]
}
...
object Helper {
  ...
  def apply(
    ...
    Mail: Instantiable0[typingsSlinky.sendgrid.sendgridMod.SendGrid.Helpers.Mail.Mail],
