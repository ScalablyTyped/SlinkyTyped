...
object Helper_ {
  ...
  implicit class Helper_Ops[Self <: Helper_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReplaceRecursiveRegExp(value: /* repeated */ js.Any => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("replaceRecursiveRegExp")(js.Any.fromFunction1(value))
        ret
    }
  }
