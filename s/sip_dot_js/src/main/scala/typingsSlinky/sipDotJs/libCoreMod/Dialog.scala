...
class Dialog protected ()
  extends typingsSlinky.sipDotJs.libCoreDialogsMod.Dialog {
  /**
    * Dialog constructor.
...
object Dialog extends js.Object {
  ...
  def initialDialogStateForUserAgentClient(
    outgoingRequestMessage: typingsSlinky.sipDotJs.libCoreMessagesMod.OutgoingRequestMessage,
    incomingResponseMessage: typingsSlinky.sipDotJs.libCoreMessagesMod.IncomingResponseMessage
  ...
  def initialDialogStateForUserAgentServer(
    incomingRequestMessage: typingsSlinky.sipDotJs.libCoreMessagesMod.IncomingRequestMessage,
    toTag: String
  ): DialogState = js.native
  def initialDialogStateForUserAgentServer(
    incomingRequestMessage: typingsSlinky.sipDotJs.libCoreMessagesMod.IncomingRequestMessage,
