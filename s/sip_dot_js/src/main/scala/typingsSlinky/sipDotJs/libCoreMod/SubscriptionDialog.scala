...
class SubscriptionDialog protected ()
  extends typingsSlinky.sipDotJs.libCoreDialogsMod.SubscriptionDialog {
  def this(
    subscriptionEvent: String,
    subscriptionExpires: Double,
    subscriptionState: typingsSlinky.sipDotJs.libCoreSubscriptionSubscriptionMod.SubscriptionState,
...
object SubscriptionDialog extends js.Object {
  ...
  def initialDialogStateForSubscription(
    outgoingSubscribeRequestMessage: typingsSlinky.sipDotJs.libCoreMessagesMod.OutgoingRequestMessage,
    incomingNotifyRequestMessage: typingsSlinky.sipDotJs.libCoreMessagesMod.IncomingRequestMessage
