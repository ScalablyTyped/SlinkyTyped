...
import typingsSlinky.sipDotJs.sipDotJsStrings.connected
import typingsSlinky.sipDotJs.sipDotJsStrings.connecting
import typingsSlinky.sipDotJs.sipDotJsStrings.disconnected
import typingsSlinky.sipDotJs.sipDotJsStrings.disconnecting
...
class Transport protected ()
  extends EventEmitter
     with typingsSlinky.sipDotJs.libApiTransportMod.Transport {
