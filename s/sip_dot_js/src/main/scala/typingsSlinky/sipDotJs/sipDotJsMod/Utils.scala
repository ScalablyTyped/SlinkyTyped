...
import typingsSlinky.sipDotJs.libUtilsMod.Utils.Deferred
...
object Utils extends js.Object {
  ...
  def normalizeTarget(target: String): js.UndefOr[typingsSlinky.sipDotJs.libCoreMessagesUriMod.URI] = js.native
  def normalizeTarget(target: String, domain: String): js.UndefOr[typingsSlinky.sipDotJs.libCoreMessagesUriMod.URI] = js.native
  def normalizeTarget(target: typingsSlinky.sipDotJs.libCoreMessagesUriMod.URI): js.UndefOr[typingsSlinky.sipDotJs.libCoreMessagesUriMod.URI] = js.native
  def normalizeTarget(target: typingsSlinky.sipDotJs.libCoreMessagesUriMod.URI, domain: String): js.UndefOr[typingsSlinky.sipDotJs.libCoreMessagesUriMod.URI] = js.native
