...
object Exceptions extends js.Object {
  ...
  class ClosedSessionDescriptionHandlerError ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.ClosedSessionDescriptionHandlerError
  
  @js.native
  class ConfigurationError protected ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.ConfigurationError {
  ...
  class InvalidStateError protected ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.InvalidStateError {
    def this(status: typingsSlinky.sipDotJs.libEnumsMod.SessionStatus) = this()
  }
  
  @js.native
  class MethodParameterError protected ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.MethodParameterError {
    def this(method: String, parameter: String, value: js.Any) = this()
  }
  
  @js.native
  class NotSupportedError protected ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.NotSupportedError {
    def this(message: String) = this()
  }
  
  @js.native
  class RenegotiationError protected ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.RenegotiationError {
    def this(message: String) = this()
  }
  
  @js.native
  class SessionDescriptionHandlerError protected ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.SessionDescriptionHandlerError {
  ...
  class TerminatedSessionError ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.TerminatedSessionError
  ...
  class UnsupportedSessionDescriptionContentTypeError ()
    extends typingsSlinky.sipDotJs.libExceptionsMod.Exceptions.UnsupportedSessionDescriptionContentTypeError {
    def this(message: String) = this()
  }
