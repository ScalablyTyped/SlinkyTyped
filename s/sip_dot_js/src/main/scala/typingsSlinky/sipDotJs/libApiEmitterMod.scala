...
@js.native
object libApiEmitterMod extends js.Object {
  @js.native
  trait Emitter[T] extends js.Object {
    ...
    def addListener(listener: js.Function1[/* data */ T, Unit], options: Anon_Once): Unit = js.native
    /**
  ...
  def _makeEmitter[T](eventEmitter: EventEmitter): Emitter[T] = js.native
  def _makeEmitter[T](eventEmitter: EventEmitter, eventName: String): Emitter[T] = js.native
}
