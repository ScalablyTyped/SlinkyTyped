...
class Referrer protected ()
  extends typingsSlinky.sipDotJs.libApiReferrerMod.Referrer {
  def this(
    session: typingsSlinky.sipDotJs.libApiSessionMod.Session,
    referTo: typingsSlinky.sipDotJs.libApiSessionMod.Session
  ) = this()
  /**
    ...
    */
  def this(session: typingsSlinky.sipDotJs.libApiSessionMod.Session, referTo: URI) = this()
  def this(
    session: typingsSlinky.sipDotJs.libApiSessionMod.Session,
    referTo: typingsSlinky.sipDotJs.libApiSessionMod.Session,
    options: ReferrerOptions
  ) = this()
  def this(session: typingsSlinky.sipDotJs.libApiSessionMod.Session, referTo: URI, options: ReferrerOptions) = this()
}
