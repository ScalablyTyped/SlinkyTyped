...
import typingsSlinky.sipDotJs.Anon_Options
import typingsSlinky.sipDotJs.libClientContextMod.ClientContext
...
import typingsSlinky.sipDotJs.libEnumsMod.UAStatus
import typingsSlinky.sipDotJs.libPublishContextMod.PublishContext
...
import typingsSlinky.sipDotJs.libSubscriptionMod.Subscription
import typingsSlinky.sipDotJs.libTransportMod.Transport
import typingsSlinky.sipDotJs.libUAMod.UA.Options
import typingsSlinky.sipDotJs.sipDotJsStrings.inviteSent
import typingsSlinky.sipDotJs.sipDotJsStrings.invite_
import typingsSlinky.sipDotJs.sipDotJsStrings.message_
import typingsSlinky.sipDotJs.sipDotJsStrings.notify_
import typingsSlinky.sipDotJs.sipDotJsStrings.outOfDialogReferRequested
import typingsSlinky.sipDotJs.sipDotJsStrings.registered
import typingsSlinky.sipDotJs.sipDotJsStrings.registrationFailed
import typingsSlinky.sipDotJs.sipDotJsStrings.subscribe_
import typingsSlinky.sipDotJs.sipDotJsStrings.transportCreated
import typingsSlinky.sipDotJs.sipDotJsStrings.unregistered
...
class UA_ () extends EventEmitter {
  ...
  def invite(target: String, options: typingsSlinky.sipDotJs.libSessionMod.InviteClientContext.Options): InviteClientContext = js.native
  def invite(
    target: String,
    options: typingsSlinky.sipDotJs.libSessionMod.InviteClientContext.Options,
    modifiers: SessionDescriptionHandlerModifiers
  ): InviteClientContext = js.native
  def invite(target: URI): InviteClientContext = js.native
  def invite(target: URI, options: typingsSlinky.sipDotJs.libSessionMod.InviteClientContext.Options): InviteClientContext = js.native
  def invite(
    target: URI,
    options: typingsSlinky.sipDotJs.libSessionMod.InviteClientContext.Options,
    modifiers: SessionDescriptionHandlerModifiers
