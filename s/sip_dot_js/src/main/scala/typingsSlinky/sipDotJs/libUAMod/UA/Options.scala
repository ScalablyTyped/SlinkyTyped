...
import typingsSlinky.sipDotJs.Anon_BuiltinEnabled
import typingsSlinky.sipDotJs.libConstantsMod.C.supported
import typingsSlinky.sipDotJs.libCoreMod.DigestAuthentication
...
trait Options extends js.Object {
  ...
  var authenticationFactory: js.UndefOr[
    js.Function1[/* ua */ typingsSlinky.sipDotJs.libUAMod.UA, DigestAuthentication | _]
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    authenticationFactory: /* ua */ typingsSlinky.sipDotJs.libUAMod.UA => DigestAuthentication | _ = null,
