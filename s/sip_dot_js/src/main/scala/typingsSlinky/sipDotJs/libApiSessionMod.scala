...
object libApiSessionMod extends js.Object {
  ...
  abstract class Session protected () extends js.Object {
    ...
    /** @internal */
    var _dialog: js.UndefOr[typingsSlinky.sipDotJs.libCoreSessionSessionMod.Session] = js.native
    /** @internal */
    ...
    /**
      ...
      */
    val dialog: js.UndefOr[typingsSlinky.sipDotJs.libCoreSessionSessionMod.Session] = js.native
