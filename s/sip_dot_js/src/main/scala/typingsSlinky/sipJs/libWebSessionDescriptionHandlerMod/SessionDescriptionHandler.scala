...
import typingsSlinky.sipJs.sipJsStrings.`peerConnection-SetLocalDescriptionFailed`
import typingsSlinky.sipJs.sipJsStrings.`peerConnection-createAnswerFailed`
import typingsSlinky.sipJs.sipJsStrings.`peerConnection-createOfferFailed`
import typingsSlinky.sipJs.sipJsStrings.`peerConnection-setRemoteDescriptionFailed`
import typingsSlinky.sipJs.sipJsStrings.addStream
import typingsSlinky.sipJs.sipJsStrings.addTrack
import typingsSlinky.sipJs.sipJsStrings.confirmed
import typingsSlinky.sipJs.sipJsStrings.getDescription
import typingsSlinky.sipJs.sipJsStrings.iceCandidate
import typingsSlinky.sipJs.sipJsStrings.iceConectionClosed
import typingsSlinky.sipJs.sipJsStrings.iceConnection
import typingsSlinky.sipJs.sipJsStrings.iceConnectionChecking
import typingsSlinky.sipJs.sipJsStrings.iceConnectionCompleted
import typingsSlinky.sipJs.sipJsStrings.iceConnectionConnected
import typingsSlinky.sipJs.sipJsStrings.iceConnectionDisconnected
import typingsSlinky.sipJs.sipJsStrings.iceConnectionFailed
import typingsSlinky.sipJs.sipJsStrings.iceGathering
import typingsSlinky.sipJs.sipJsStrings.iceGatheringComplete
import typingsSlinky.sipJs.sipJsStrings.setDescription
import typingsSlinky.sipJs.sipJsStrings.setRemoteDescription
import typingsSlinky.sipJs.sipJsStrings.userMedia
import typingsSlinky.sipJs.sipJsStrings.userMediaFailed
import typingsSlinky.sipJs.sipJsStrings.userMediaRequest
