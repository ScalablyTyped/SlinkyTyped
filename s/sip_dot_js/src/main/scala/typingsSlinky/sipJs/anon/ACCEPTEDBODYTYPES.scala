...
@js.native
trait ACCEPTEDBODYTYPES extends js.Object {
...
object ACCEPTEDBODYTYPES {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ACCEPTEDBODYTYPES]
  }
  @scala.inline
  implicit class ACCEPTEDBODYTYPESOps[Self <: ACCEPTEDBODYTYPES] (val x: Self) extends AnyVal {
    @scala.inline
