...
- typingsSlinky.sipJs.clientContextMod.ClientContext because Inheritance from two classes. Inlined request, send, receiveResponse, onRequestTimeout, onTransportError */ @JSImport("sip.js/lib/Session", "InviteClientContext")
@js.native
