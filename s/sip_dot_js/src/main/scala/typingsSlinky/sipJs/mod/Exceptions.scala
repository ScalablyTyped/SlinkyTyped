...
object Exceptions extends js.Object {
  ...
  class ClosedSessionDescriptionHandlerError ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.ClosedSessionDescriptionHandlerError
  
  @js.native
  class ConfigurationError protected ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.ConfigurationError {
  ...
  class InvalidStateError protected ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.InvalidStateError {
    def this(status: typingsSlinky.sipJs.enumsMod.SessionStatus) = this()
  }
  
  @js.native
  class MethodParameterError protected ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.MethodParameterError {
    def this(method: String, parameter: String, value: js.Any) = this()
  }
  
  @js.native
  class NotSupportedError protected ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.NotSupportedError {
    def this(message: String) = this()
  }
  
  @js.native
  class RenegotiationError protected ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.RenegotiationError {
    def this(message: String) = this()
  }
  
  @js.native
  class SessionDescriptionHandlerError protected ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.SessionDescriptionHandlerError {
  ...
  class TerminatedSessionError ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.TerminatedSessionError
  ...
  class UnsupportedSessionDescriptionContentTypeError ()
    extends typingsSlinky.sipJs.libExceptionsMod.Exceptions.UnsupportedSessionDescriptionContentTypeError {
    def this(message: String) = this()
  }
