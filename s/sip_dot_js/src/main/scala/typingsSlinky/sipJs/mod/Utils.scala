...
import typingsSlinky.sipJs.libUtilsMod.Utils.Deferred
...
object Utils extends js.Object {
  ...
  def normalizeTarget(target: String): js.UndefOr[typingsSlinky.sipJs.uriMod.URI] = js.native
  def normalizeTarget(target: String, domain: String): js.UndefOr[typingsSlinky.sipJs.uriMod.URI] = js.native
  def normalizeTarget(target: typingsSlinky.sipJs.uriMod.URI): js.UndefOr[typingsSlinky.sipJs.uriMod.URI] = js.native
  def normalizeTarget(target: typingsSlinky.sipJs.uriMod.URI, domain: String): js.UndefOr[typingsSlinky.sipJs.uriMod.URI] = js.native
