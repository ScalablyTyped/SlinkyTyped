...
import typingsSlinky.sipJs.userAgentCoreUserAgentCoreMod.UserAgentCore
...
object subscriptionDialogMod {
  ...
  - typingsSlinky.sipJs.subscriptionSubscriptionMod.Subscription because var conflicts: id. Inlined delegate, subscriptionExpires, subscriptionState, autoRefresh, subscribe, subscribe, subscribe, subscribe, refresh, unsubscribe */ @JSImport("sip.js/lib/core/dialogs/subscription-dialog", "SubscriptionDialog")
  @js.native
