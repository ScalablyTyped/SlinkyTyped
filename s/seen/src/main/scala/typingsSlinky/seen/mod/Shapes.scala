...
object Shapes {
  ...
  @JSImport("seen", "Shapes.path")
  @js.native
  def path(points: js.Array[Point]): Shape = js.native
  
  @JSImport("seen", "Shapes.pipe")
  @js.native
  ...
  @JSImport("seen", "Shapes.pyramid")
  @js.native
  def pyramid(): Shape = js.native
  
  @JSImport("seen", "Shapes.rectangle")
  @js.native
  def rectangle(point1: Point, point2: Point): Shape = js.native
  
  @JSImport("seen", "Shapes.sphere")
  @js.native
  ...
  @JSImport("seen", "Shapes.tetrahedron")
  @js.native
  def tetrahedron(): Shape = js.native
  
  @JSImport("seen", "Shapes.text")
  @js.native
