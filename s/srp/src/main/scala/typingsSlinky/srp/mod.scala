...
object mod {
  ...
  @JSImport("srp", "genKey")
  @js.native
  def genKey(bytes: Double, callback: js.Function2[/* error */ js.Error, /* key */ Buffer, Unit]): Unit = js.native
  @JSImport("srp", "genKey")
  @js.native
  def genKey(callback: js.Function2[/* error */ js.Error, /* key */ Buffer, Unit]): Unit = js.native
