...
import typingsSlinky.semanticUiRating.SemanticUI.Rating.ClassNameSettings.Param
...
import typingsSlinky.semanticUiRating.anon.PartialPickImplkeyofImpl
import typingsSlinky.semanticUiRating.anon.PartialPickImplkeyofImplActive
import typingsSlinky.semanticUiRating.anon.PickImplactive
import typingsSlinky.semanticUiRating.anon.PickImplclassName
import typingsSlinky.semanticUiRating.anon.PickImplclearable
import typingsSlinky.semanticUiRating.anon.PickImpldebug
import typingsSlinky.semanticUiRating.anon.PickImplerror
import typingsSlinky.semanticUiRating.anon.PickImplfireOnInit
import typingsSlinky.semanticUiRating.anon.PickImplhover
import typingsSlinky.semanticUiRating.anon.PickImplinitialRating
import typingsSlinky.semanticUiRating.anon.PickImplinteractive
import typingsSlinky.semanticUiRating.anon.PickImplloading
import typingsSlinky.semanticUiRating.anon.PickImplname
import typingsSlinky.semanticUiRating.anon.PickImplnamespace
import typingsSlinky.semanticUiRating.anon.PickImplonRate
import typingsSlinky.semanticUiRating.anon.PickImplperformance
import typingsSlinky.semanticUiRating.anon.PickImplselector
import typingsSlinky.semanticUiRating.anon.PickImplsilent
import typingsSlinky.semanticUiRating.anon.PickImplverbose
...
object SemanticUI {
  ...
  object Rating {
    ...
    object ErrorSettings {
      ...
      object Param {
        ...
        @scala.inline
        def apply(action: String with js.UndefOr[String]): typingsSlinky.semanticUiRating.SemanticUI.Rating.ErrorSettings.Param = {
          val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsSlinky.semanticUiRating.SemanticUI.Rating.ErrorSettings.Param]
        }
        
        @scala.inline
        implicit class ParamMutableBuilder[Self <: typingsSlinky.semanticUiRating.SemanticUI.Rating.ErrorSettings.Param] (val x: Self) extends AnyVal {
    ...
    object SelectorSettings {
      ...
      object Param {
        ...
        @scala.inline
        def apply(icon: String with js.UndefOr[String]): typingsSlinky.semanticUiRating.SemanticUI.Rating.SelectorSettings.Param = {
          val __obj = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsSlinky.semanticUiRating.SemanticUI.Rating.SelectorSettings.Param]
        }
        
        @scala.inline
        implicit class ParamMutableBuilder[Self <: typingsSlinky.semanticUiRating.SemanticUI.Rating.SelectorSettings.Param] (val x: Self) extends AnyVal {
  ...
  /**
    ...
    */
  type RatingSettings = typingsSlinky.semanticUiRating.SemanticUI.RatingSettings.Param
}
