package typingsSlinky.simplestorageJs

import org.scalablytyped.runtime.Shortcut
import typingsSlinky.simplestorageJs.mod.simplestoragejs.SimpleStorage
  ...
  object simplestoragejs {
    ...
    trait SimpleStorage extends StObject {
      ...
      /**
        ...
        */
      def deleteKey(key: String): Boolean | js.Error = js.native
      ...
      /**
        ...
        */
      def flush(): Boolean | js.Error = js.native
      ...
      /**
        ...
        */
      def set(key: String, value: js.Any): Boolean | js.Error = js.native
      def set(key: String, value: js.Any, options: SetOptions): Boolean | js.Error = js.native
      ...
      /**
        ...
        */
      def setTTL(key: String, ttl: Double): Boolean | js.Error = js.native
