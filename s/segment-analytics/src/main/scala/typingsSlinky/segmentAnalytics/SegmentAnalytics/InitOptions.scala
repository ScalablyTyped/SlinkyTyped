...
object InitOptions {
  ...
  implicit class InitOptionsOps[Self <: InitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGroup(value: GroupOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLocalStorage(value: StoreOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMetrics(value: MetricsOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: UserOptions): Self = {
        val ret = this.duplicate
