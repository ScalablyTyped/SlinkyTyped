...
import typingsSlinky.storybookCsf.anon.Groups
...
object mod {
  ...
  object SeparatorOptions {
    ...
    implicit class SeparatorOptionsMutableBuilder[Self <: SeparatorOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGroupSeparator(value: String | js.RegExp): Self = StObject.set(x, "groupSeparator", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGroupSeparatorRegExp(value: js.RegExp): Self = StObject.set(x, "groupSeparator", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRootSeparator(value: String | js.RegExp): Self = StObject.set(x, "rootSeparator", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRootSeparatorRegExp(value: js.RegExp): Self = StObject.set(x, "rootSeparator", value.asInstanceOf[js.Any])
    }
  }
