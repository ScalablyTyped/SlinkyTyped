...
object Descriptor {
  @scala.inline
  def apply[Obj, /* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤](): Descriptor[Obj, S̤t̤a̤m̤p̤] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Descriptor[Obj, S̤t̤a̤m̤p̤]]
  }
  @scala.inline
  implicit class DescriptorOps[Self <: Descriptor[_, _], Obj, /* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤] (val x: Self with (Descriptor[Obj, S̤t̤a̤m̤p̤])) extends AnyVal {
    @scala.inline
