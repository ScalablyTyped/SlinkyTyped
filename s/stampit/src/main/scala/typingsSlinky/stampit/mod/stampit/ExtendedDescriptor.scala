...
object ExtendedDescriptor {
  @scala.inline
  def apply[Obj, /* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤](): ExtendedDescriptor[Obj, S̤t̤a̤m̤p̤] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExtendedDescriptor[Obj, S̤t̤a̤m̤p̤]]
  }
  @scala.inline
  implicit class ExtendedDescriptorOps[Self <: ExtendedDescriptor[_, _], Obj, /* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤] (val x: Self with (ExtendedDescriptor[Obj, S̤t̤a̤m̤p̤])) extends AnyVal {
    @scala.inline
