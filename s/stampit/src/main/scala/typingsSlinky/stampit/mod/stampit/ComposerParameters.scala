...
object ComposerParameters {
  @scala.inline
  def apply[/* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤](composables: js.Array[Composable], stamp: S̤t̤a̤m̤p̤): ComposerParameters[S̤t̤a̤m̤p̤] = {
  ...
  @scala.inline
  implicit class ComposerParametersOps[Self <: ComposerParameters[_], /* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤] (val x: Self with ComposerParameters[S̤t̤a̤m̤p̤]) extends AnyVal {
    @scala.inline
