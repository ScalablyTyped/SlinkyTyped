...
object InitializerContext {
  @scala.inline
  def apply[Obj, /* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤](args: js.Array[_], instance: Obj, stamp: S̤t̤a̤m̤p̤): InitializerContext[Obj, S̤t̤a̤m̤p̤] = {
  ...
  @scala.inline
  implicit class InitializerContextOps[Self <: InitializerContext[_, _], Obj, /* <: typingsSlinky.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤] (val x: Self with (InitializerContext[Obj, S̤t̤a̤m̤p̤])) extends AnyVal {
    @scala.inline
