...
object PropsWithChildrenPickSeleAbout {
  ...
  def apply(
    ...
    name: String = null,
    onAbort: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLSelectElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLSelectElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLSelectElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLSelectElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLSelectElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLSelectElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLSelectElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLSelectElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLSelectElement] => Unit = null,
