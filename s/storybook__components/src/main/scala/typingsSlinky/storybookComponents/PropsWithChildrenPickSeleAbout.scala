...
object PropsWithChildrenPickSeleAbout {
  @scala.inline
  def apply(
    css: js.Any,
  ...
  ): PropsWithChildrenPickSeleAbout = {
    ...
    __obj.asInstanceOf[PropsWithChildrenPickSeleAbout]
  }
  @scala.inline
  implicit class PropsWithChildrenPickSeleAboutOps[Self <: PropsWithChildrenPickSeleAbout] (val x: Self) extends AnyVal {
    @scala.inline
