...
object TabsProps {
  ...
  implicit class TabsPropsOps[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setToolsReactElement(value: ReactElement): Self = this.set("tools", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTools(value: ReactElement): Self = this.set("tools", value.asInstanceOf[js.Any])
