...
object SideBySide {
  ...
  implicit def make(companion: SideBySide.type): SharedBuilder_DetailedHTMLPropsOmit0_575095177[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsOmit0_575095177[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
