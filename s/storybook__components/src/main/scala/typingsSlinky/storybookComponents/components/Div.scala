...
object Div {
  ...
  implicit def make(companion: Div.type): SharedBuilder_DetailedHTMLPropsOmit0823375440[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsOmit0823375440[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
