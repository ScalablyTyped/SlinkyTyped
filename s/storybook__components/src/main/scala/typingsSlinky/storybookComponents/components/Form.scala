...
import typingsSlinky.storybookComponents.anon.PropsWithChildrenPickPickAbout
...
object Form {
  ...
  object Button {
    ...
    def apply(p: js.Any): Default[slinky.web.html.`*`.tag.type, js.Object] = new Default[slinky.web.html.`*`.tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
    implicit def make(companion: Button.type): Default[slinky.web.html.`*`.tag.type, js.Object] = new Default[slinky.web.html.`*`.tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
  }
  ...
  object Textarea {
    ...
    class Builder (val args: js.Array[js.Any])
      extends AnyVal
         with StBuildingComponent[slinky.web.html.textarea.tag.type, js.Object] {
      @scala.inline
      def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
      @scala.inline
      def accept(value: String): this.type = set("accept", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def inputRefFunction1(value: /* node */ HTMLTextAreaElement => Unit): this.type = set("inputRef", js.Any.fromFunction1(value))
      @scala.inline
      def inputRef(value: (js.Function1[/* node */ HTMLTextAreaElement, Unit]) | ReactRef[HTMLTextAreaElement]): this.type = set("inputRef", value.asInstanceOf[js.Any])
      @scala.inline
      def integrity(value: String): this.type = set("integrity", value.asInstanceOf[js.Any])
      @scala.inline
      def is(value: String): this.type = set("is", value.asInstanceOf[js.Any])
      ...
      def onCanPlayThroughCapture(value: js.Any): this.type = set("onCanPlayThroughCapture", value.asInstanceOf[js.Any])
      @scala.inline
      def onChange(value: /* event */ ChangeEvent[HTMLTextAreaElement] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
      @scala.inline
      def onChangeCapture(value: js.Any): this.type = set("onChangeCapture", value.asInstanceOf[js.Any])
      @scala.inline
      ...
      def onGotPointerCaptureCapture(value: js.Any): this.type = set("onGotPointerCaptureCapture", value.asInstanceOf[js.Any])
      @scala.inline
      def onHeightChange(value: /* height */ Double => Unit): this.type = set("onHeightChange", js.Any.fromFunction1(value))
      @scala.inline
      ...
      def unselectable(value: on | off): this.type = set("unselectable", value.asInstanceOf[js.Any])
      @scala.inline
      def useCacheForDOMMeasurements(value: Boolean): this.type = set("useCacheForDOMMeasurements", value.asInstanceOf[js.Any])
      @scala.inline
      def useMap(value: String): this.type = set("useMap", value.asInstanceOf[js.Any])
      @scala.inline
      def valid(value: ValidationStates): this.type = set("valid", value.asInstanceOf[js.Any])
    ...
    def withProps(p: PropsWithChildrenPickPickAbout): typingsSlinky.storybookComponents.components.Form.Textarea.Builder = new typingsSlinky.storybookComponents.components.Form.Textarea.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    @scala.inline
    def apply(ref: js.UndefOr[Ref[_]] with js.UndefOr[LegacyRef[HTMLTextAreaElement]]): typingsSlinky.storybookComponents.components.Form.Textarea.Builder = {
        val __props = js.Dynamic.literal(ref = ref.asInstanceOf[js.Any])
        new typingsSlinky.storybookComponents.components.Form.Textarea.Builder(js.Array(this.component, __props.asInstanceOf[PropsWithChildrenPickPickAbout]))
    }
  }
