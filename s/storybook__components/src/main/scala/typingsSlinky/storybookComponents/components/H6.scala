...
object H6 {
  ...
  @JSImport("@storybook/components/dist/html", "components.h6")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: H6.type): SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement] = new SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
