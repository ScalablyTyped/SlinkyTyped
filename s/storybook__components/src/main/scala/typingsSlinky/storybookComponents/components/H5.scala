...
object H5 {
  ...
  @JSImport("@storybook/components/dist/html", "components.h5")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: H5.type): SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement] = new SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
