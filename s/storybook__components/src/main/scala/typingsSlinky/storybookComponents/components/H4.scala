...
object H4 {
  ...
  @JSImport("@storybook/components/dist/html", "components.h4")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: H4.type): SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement] = new SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
