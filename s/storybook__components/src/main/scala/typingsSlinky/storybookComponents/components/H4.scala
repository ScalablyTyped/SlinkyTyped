...
object H4 {
  ...
  @JSImport("@storybook/components/dist/html", "H4")
  @js.native
  ...
  implicit def make(companion: H4.type): SharedBuilder_PropsWithChildren_1724821862[HTMLHeadingElement] = new SharedBuilder_PropsWithChildren_1724821862[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
}
