...
import typingsSlinky.storybookComponents.separatorMod.SeparatorProps
...
object Separator {
  ...
  @JSImport("@storybook/components", "Separator")
  @js.native
  ...
  def withProps(
    p: (DetailedHTMLProps[HTMLAttributes[HTMLSpanElement], HTMLSpanElement]) with (Omit[SeparatorProps, theme]) with `0`[Theme]
