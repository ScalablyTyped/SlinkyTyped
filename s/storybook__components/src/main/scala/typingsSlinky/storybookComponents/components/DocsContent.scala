...
object DocsContent {
  ...
  implicit def make(companion: DocsContent.type): SharedBuilder_DetailedHTMLPropsOmit0_575095177[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsOmit0_575095177[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
