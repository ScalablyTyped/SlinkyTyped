...
object DocsContent {
  ...
  implicit def make(companion: DocsContent.type): SharedBuilder_PropsWithChildren1897537728[HTMLDivElement] = new SharedBuilder_PropsWithChildren1897537728[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
}
