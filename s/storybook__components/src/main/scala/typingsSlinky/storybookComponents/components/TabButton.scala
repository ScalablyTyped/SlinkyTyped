...
object TabButton {
  ...
  def withProps(
    p: (DetailedHTMLProps[ButtonHTMLAttributes[HTMLButtonElement], HTMLButtonElement]) with TabButtonProps with ThemeTheme[Theme]
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TabButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
