...
object Bar {
  ...
  @JSImport("@storybook/components", "Bar")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Bar.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
