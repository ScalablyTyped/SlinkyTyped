...
import typingsSlinky.storybookComponents.overlayScrollbarsComponentMod.OverlayScrollbarsComponentProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object OverlayScrollbarsComponent {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def extensionsVarargs(value: String*): this.type = set("extensions", js.Array(value :_*))
    
    @scala.inline
    def extensions(value: Extensions): this.type = set("extensions", value.asInstanceOf[js.Any])
  ...
  def withProps(p: OverlayScrollbarsComponentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: OverlayScrollbarsComponent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
