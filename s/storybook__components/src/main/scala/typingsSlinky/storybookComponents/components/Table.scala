...
object Table {
  ...
  @JSImport("@storybook/components/dist/html", "Table")
  @js.native
  ...
  def withProps(
    p: (DetailedHTMLProps[TableHTMLAttributes[HTMLTableElement], HTMLTableElement]) with (Omit[js.Object, theme]) with `0`[Theme]
