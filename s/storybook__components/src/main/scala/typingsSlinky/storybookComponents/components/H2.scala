...
object H2 {
  ...
  implicit def make(companion: H2.type): SharedBuilder_PropsWithChildren_1724821862[HTMLHeadingElement] = new SharedBuilder_PropsWithChildren_1724821862[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
}
