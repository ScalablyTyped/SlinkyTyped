...
object H2 {
  ...
  implicit def make(companion: H2.type): SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement] = new SharedBuilder_DetailedHTMLPropsOmit0_1375793306[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
