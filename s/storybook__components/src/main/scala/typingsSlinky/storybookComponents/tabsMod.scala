...
object tabsMod {
  ...
  trait TabsProps extends StObject {
    ...
    var tools: js.UndefOr[ReactElement] = js.native
  }
  object TabsProps {
    ...
    implicit class TabsPropsMutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTools(value: ReactElement): Self = StObject.set(x, "tools", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setToolsReactElement(value: ReactElement): Self = StObject.set(x, "tools", value.asInstanceOf[js.Any])
  ...
  object TabsStateProps {
    ...
    implicit class TabsStatePropsMutableBuilder[Self <: TabsStateProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: js.Array[ReactElement | FuncChildren]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenVarargs(value: (ReactElement | FuncChildren)*): Self = StObject.set(x, "children", js.Array(value :_*))
