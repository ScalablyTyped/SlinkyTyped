...
object formMod {
  ...
  object Form {
    ...
    @js.native
    def Button: ReactComponentClass[js.Any] = js.native
    @scala.inline
    def Button_=(x: ReactComponentClass[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Button")(x.asInstanceOf[js.Any])
    
    @JSImport("@storybook/components/dist/form", "Form.Field")
    @js.native
    def Field: ReactComponentClass[FieldProps] = js.native
    @scala.inline
    def Field_=(x: ReactComponentClass[FieldProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Field")(x.asInstanceOf[js.Any])
