...
object PickDetailedHTMLPropsHTML {
  ...
  @scala.inline
  def apply(): PickDetailedHTMLPropsHTML = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickDetailedHTMLPropsHTML]
  }
  
  @scala.inline
  implicit class PickDetailedHTMLPropsHTMLMutableBuilder[Self <: PickDetailedHTMLPropsHTML] (val x: Self) extends AnyVal {
