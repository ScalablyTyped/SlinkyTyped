...
trait StyledComponentPickPickHT extends js.Object {
  ...
  def withComponent[Tag /* <: ReactComponentClass[_] */](tag: Tag): StyledComponent[PropsOf[Tag], InputStyleProps, typingsSlinky.storybookTheming.typesMod.Theme] = js.native
  /**
  ...
  @JSName("withComponent")
  def withComponent_animate(tag: animate): StyledComponent[SVGProps[SVGElement], InputStyleProps, typingsSlinky.storybookTheming.typesMod.Theme] = js.native
  @JSName("withComponent")
  def withComponent_animateMotion(tag: animateMotion): StyledComponent[SVGProps[SVGElement], InputStyleProps, typingsSlinky.storybookTheming.typesMod.Theme] = js.native
  @JSName("withComponent")
  def withComponent_animateTransform(tag: animateTransform): StyledComponent[SVGProps[SVGElement], InputStyleProps, typingsSlinky.storybookTheming.typesMod.Theme] = js.native
  @JSName("withComponent")
  ...
  @JSName("withComponent")
  def withComponent_mpath(tag: mpath): StyledComponent[SVGProps[SVGElement], InputStyleProps, typingsSlinky.storybookTheming.typesMod.Theme] = js.native
  @JSName("withComponent")
