...
object PropsWithChildrenPickText {
  
  @scala.inline
  def apply(ref: js.UndefOr[Ref[_]] with js.UndefOr[LegacyRef[HTMLTextAreaElement]]): PropsWithChildrenPickText = {
    val __obj = js.Dynamic.literal(ref = ref.asInstanceOf[js.Any])
    __obj.asInstanceOf[PropsWithChildrenPickText]
  }
  
  @scala.inline
  implicit class PropsWithChildrenPickTextOps[Self <: PropsWithChildrenPickText] (val x: Self) extends AnyVal {
