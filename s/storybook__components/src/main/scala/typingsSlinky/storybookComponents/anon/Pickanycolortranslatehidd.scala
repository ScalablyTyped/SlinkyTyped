...
@js.native
trait Pickanycolortranslatehidd extends StObject {
...
object Pickanycolortranslatehidd {
  
  @scala.inline
  def apply(): Pickanycolortranslatehidd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Pickanycolortranslatehidd]
  }
  
  @scala.inline
  implicit class PickanycolortranslatehiddMutableBuilder[Self <: Pickanycolortranslatehidd] (val x: Self) extends AnyVal {
