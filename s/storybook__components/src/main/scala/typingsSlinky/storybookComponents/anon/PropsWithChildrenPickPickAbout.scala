...
trait PropsWithChildrenPickPickAbout extends js.Object {
  ...
  var ref: js.UndefOr[Ref[_]] with js.UndefOr[LegacyRef[HTMLTextAreaElement]] = js.native
...
object PropsWithChildrenPickPickAbout {
  
  @scala.inline
  def apply(ref: js.UndefOr[Ref[_]] with js.UndefOr[LegacyRef[HTMLTextAreaElement]]): PropsWithChildrenPickPickAbout = {
    val __obj = js.Dynamic.literal(ref = ref.asInstanceOf[js.Any])
    __obj.asInstanceOf[PropsWithChildrenPickPickAbout]
  }
  
  @scala.inline
  implicit class PropsWithChildrenPickPickAboutOps[Self <: PropsWithChildrenPickPickAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: js.UndefOr[Ref[_]] with js.UndefOr[LegacyRef[HTMLTextAreaElement]]): Self = this.set("ref", value.asInstanceOf[js.Any])
