...
object PropsWithChildrenDetailed {
  ...
  @scala.inline
  implicit class PropsWithChildrenDetailedOps[Self <: PropsWithChildrenDetailed] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget with HTMLFormElement, Event] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnReset(value: SyntheticEvent[EventTarget with HTMLFormElement, Event] => Unit): Self = this.set("onReset", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnSubmit(value: SyntheticEvent[EventTarget with HTMLFormElement, Event] => Unit): Self = this.set("onSubmit", js.Any.fromFunction1(value))
    @scala.inline
