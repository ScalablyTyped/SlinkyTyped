...
object PropsWithChildrenDetailed {
  
  @scala.inline
  def apply(): PropsWithChildrenDetailed = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PropsWithChildrenDetailed]
  }
  
  @scala.inline
  implicit class PropsWithChildrenDetailedMutableBuilder[Self <: PropsWithChildrenDetailed] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnSubmit(value: SyntheticEvent[EventTarget with HTMLFormElement, Event] => Unit): Self = StObject.set(x, "onSubmit", js.Any.fromFunction1(value))
