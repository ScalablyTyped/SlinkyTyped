...
object PropsWithChildrenPickSele {
  ...
  @scala.inline
  implicit class PropsWithChildrenPickSeleMutableBuilder[Self <: PropsWithChildrenPickSele] (val x: Self) extends AnyVal {
