...
@js.native
trait PickanycolortranslatehiddAbout extends StObject {
...
object PickanycolortranslatehiddAbout {
  
  @scala.inline
  def apply(): PickanycolortranslatehiddAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickanycolortranslatehiddAbout]
  }
  
  @scala.inline
  implicit class PickanycolortranslatehiddAboutMutableBuilder[Self <: PickanycolortranslatehiddAbout] (val x: Self) extends AnyVal {
