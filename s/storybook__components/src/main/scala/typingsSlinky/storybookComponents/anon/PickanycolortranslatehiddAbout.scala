...
@js.native
trait PickanycolortranslatehiddAbout extends js.Object {
...
object PickanycolortranslatehiddAbout {
  ...
  @scala.inline
  implicit class PickanycolortranslatehiddAboutOps[Self <: PickanycolortranslatehiddAbout] (val x: Self) extends AnyVal {
