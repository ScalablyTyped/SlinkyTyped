...
object PartialPickSelectHTMLAttr {
  ...
  @scala.inline
  def apply(): PartialPickSelectHTMLAttr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPickSelectHTMLAttr]
  }
  
  @scala.inline
  implicit class PartialPickSelectHTMLAttrMutableBuilder[Self <: PartialPickSelectHTMLAttr] (val x: Self) extends AnyVal {
