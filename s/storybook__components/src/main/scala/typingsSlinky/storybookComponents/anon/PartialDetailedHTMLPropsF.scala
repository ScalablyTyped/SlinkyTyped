...
object PartialDetailedHTMLPropsF {
  ...
  @scala.inline
  implicit class PartialDetailedHTMLPropsFOps[Self <: PartialDetailedHTMLPropsF] (val x: Self) extends AnyVal {
    @scala.inline
