...
object PartialDetailedHTMLPropsF {
  ...
  @scala.inline
  def apply(): PartialDetailedHTMLPropsF = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDetailedHTMLPropsF]
  }
  
  @scala.inline
  implicit class PartialDetailedHTMLPropsFMutableBuilder[Self <: PartialDetailedHTMLPropsF] (val x: Self) extends AnyVal {
