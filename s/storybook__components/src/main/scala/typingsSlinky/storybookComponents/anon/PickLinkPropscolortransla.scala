...
trait PickLinkPropscolortransla extends StObject {
  ...
  var ref: js.UndefOr[
    (js.Function1[/* instance */ HTMLAnchorElement, Unit]) | ReactRef[HTMLAnchorElement]
  ] = js.native
...
object PickLinkPropscolortransla {
  ...
  implicit class PickLinkPropscolortranslaMutableBuilder[Self <: PickLinkPropscolortransla] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: (js.Function1[/* instance */ HTMLAnchorElement, Unit]) | ReactRef[HTMLAnchorElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
