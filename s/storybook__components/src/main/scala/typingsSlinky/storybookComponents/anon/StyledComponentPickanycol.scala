...
@js.native
trait StyledComponentPickanycol extends StObject {
  
  def apply(props: PropsWithChildrenPickanyc): ReactElement | Null = js.native
  def apply(props: PropsWithChildrenPickanyc, context: js.Any): ReactElement | Null = js.native
  
  var __emotion_styles: js.Any = js.native
  
  var contextTypes: js.UndefOr[ValidationMap[_]] = js.native
  
  var defaultProps: js.UndefOr[PartialPickanycolortransl] = js.native
  
  var displayName: js.UndefOr[String] with String = js.native
  
  var propTypes: js.UndefOr[WeakValidationMapPickanyc] = js.native
  
  def withComponent[Tag /* <: ReactComponentClass[_] */](tag: Tag): StyledComponent[
    PropsOf[Tag], 
    Pickanycolortranslatehidd, 
