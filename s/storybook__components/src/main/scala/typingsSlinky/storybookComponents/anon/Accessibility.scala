...
object Accessibility {
  ...
  implicit class AccessibilityOps[Self <: Accessibility] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessibilityalt(value: String): Self = this.set("accessibilityalt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setChromatic(value: String): Self = this.set("chromatic", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setContrast(value: String): Self = this.set("contrast", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLightningoff(value: String): Self = this.set("lightningoff", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSharealt(value: String): Self = this.set("sharealt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUnfold(value: String): Self = this.set("unfold", value.asInstanceOf[js.Any])
