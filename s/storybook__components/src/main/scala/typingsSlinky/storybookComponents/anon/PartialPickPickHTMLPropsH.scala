...
object PartialPickPickHTMLPropsH {
  ...
  @scala.inline
  def apply(): PartialPickPickHTMLPropsH = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPickPickHTMLPropsH]
  }
  
  @scala.inline
  implicit class PartialPickPickHTMLPropsHMutableBuilder[Self <: PartialPickPickHTMLPropsH] (val x: Self) extends AnyVal {
