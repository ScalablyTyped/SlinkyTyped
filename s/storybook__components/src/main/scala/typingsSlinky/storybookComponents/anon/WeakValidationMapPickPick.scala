...
@js.native
trait WeakValidationMapPickPick extends StObject {
...
object WeakValidationMapPickPick {
  ...
  @scala.inline
  implicit class WeakValidationMapPickPickMutableBuilder[Self <: WeakValidationMapPickPick] (val x: Self) extends AnyVal {
