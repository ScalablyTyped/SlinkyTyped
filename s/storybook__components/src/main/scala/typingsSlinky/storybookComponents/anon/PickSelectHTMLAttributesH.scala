...
object PickSelectHTMLAttributesH {
  ...
  @scala.inline
  def apply(): PickSelectHTMLAttributesH = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickSelectHTMLAttributesH]
  }
  
  @scala.inline
  implicit class PickSelectHTMLAttributesHMutableBuilder[Self <: PickSelectHTMLAttributesH] (val x: Self) extends AnyVal {
