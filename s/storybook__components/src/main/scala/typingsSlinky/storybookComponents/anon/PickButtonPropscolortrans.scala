...
@js.native
trait PickButtonPropscolortrans extends js.Object {
...
object PickButtonPropscolortrans {
  ...
  @scala.inline
  implicit class PickButtonPropscolortransOps[Self <: PickButtonPropscolortrans] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLButtonElement => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: (js.Function1[/* instance */ HTMLButtonElement, Unit]) | ReactRef[HTMLButtonElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
