...
import typingsSlinky.storybookComponents.storybookComponentsStrings.reset
...
import typingsSlinky.storybookComponents.storybookComponentsStrings.submit
...
trait PickButtonPropscolortrans extends StObject {
  ...
  var ref: js.UndefOr[
    (js.Function1[/* instance */ HTMLButtonElement, Unit]) | ReactRef[HTMLButtonElement]
  ] = js.native
...
object PickButtonPropscolortrans {
  
  @scala.inline
  def apply(): PickButtonPropscolortrans = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickButtonPropscolortrans]
  }
  
  @scala.inline
  implicit class PickButtonPropscolortransMutableBuilder[Self <: PickButtonPropscolortrans] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: (js.Function1[/* instance */ HTMLButtonElement, Unit]) | ReactRef[HTMLButtonElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLButtonElement => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
