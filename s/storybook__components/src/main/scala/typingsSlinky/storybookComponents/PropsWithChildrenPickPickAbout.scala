...
trait PropsWithChildrenPickPickAbout extends js.Object {
  ...
  var ref: js.UndefOr[Ref[_] with LegacyRef[HTMLTextAreaElement]] = js.native
...
object PropsWithChildrenPickPickAbout {
  ...
  def apply(
    ...
    inputRef: (js.Function1[/* node */ HTMLTextAreaElement, Unit]) | ReactRef[HTMLTextAreaElement] = null,
  ...
  ): PropsWithChildrenPickPickAbout = {
