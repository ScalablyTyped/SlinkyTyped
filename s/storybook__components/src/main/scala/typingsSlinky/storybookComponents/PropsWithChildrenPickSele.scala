...
@js.native
trait PropsWithChildrenPickSele extends js.Object {
...
object PropsWithChildrenPickSele {
  @scala.inline
  def apply(
    css: js.Any,
    ...
    __obj.asInstanceOf[PropsWithChildrenPickSele]
  }
  @scala.inline
  implicit class PropsWithChildrenPickSeleOps[Self <: PropsWithChildrenPickSele] (val x: Self) extends AnyVal {
    @scala.inline
