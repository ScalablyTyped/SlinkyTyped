...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "overlayscrollbars" % "1.12-dt-20200515Z-1c0558",
  ...
  "org.scalablytyped.slinky" %%% "react-syntax-highlighter" % "13.5-dt-20201016Z-15ba03",
