package typingsSlinky.samchon.samchonMod
...
object library extends js.Object {
  ...
  class CartesianProduct protected ()
    extends typingsSlinky.samchon.libraryMod.CartesianProduct {
    /**
  ...
  class Factorial protected ()
    extends typingsSlinky.samchon.libraryMod.Factorial {
    /**
  ...
  class Permutation protected ()
    extends typingsSlinky.samchon.libraryMod.Permutation {
    /**
  ...
  class RepeatedPermutation protected ()
    extends typingsSlinky.samchon.libraryMod.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  @js.native
  class StringUtil ()
    extends typingsSlinky.samchon.libraryMod.StringUtil
  ...
  /**
    ...
    */
  class URLVariables ()
    extends typingsSlinky.samchon.libraryMod.URLVariables {
    /**
  ...
  @js.native
  class XML ()
    extends typingsSlinky.samchon.libraryMod.XML {
    def this(str: String) = this()
