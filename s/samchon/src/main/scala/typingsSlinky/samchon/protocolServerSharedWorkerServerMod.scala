...
import typingsSlinky.samchon.protocolCommunicatorClientUnderscoreDriverSharedWorkerClientDriverMod.SharedWorkerClientDriver
...
@js.native
object protocolServerSharedWorkerServerMod extends js.Object {
  @js.native
