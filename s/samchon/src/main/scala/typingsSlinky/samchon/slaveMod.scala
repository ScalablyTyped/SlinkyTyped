...
object slaveMod extends js.Object {
  ...
  /**
    ...
    */
  class InvokeHistory ()
    extends typingsSlinky.samchon.invokeHistoryMod.InvokeHistory {
    /**
  ...
  class PInvoke protected ()
    extends typingsSlinky.samchon.pinvokeMod.PInvoke {
    /**
  ...
  abstract class SlaveClient ()
    extends typingsSlinky.samchon.slaveClientMod.SlaveClient
  ...
  abstract class SlaveServer ()
    extends typingsSlinky.samchon.slaveServerMod.SlaveServer
  ...
  abstract class SlaveSystem ()
    extends typingsSlinky.samchon.slaveSystemMod.SlaveSystem
}
