...
object templatesSlaveMod extends js.Object {
  ...
  /**
    ...
    */
  class InvokeHistory ()
    extends typingsSlinky.samchon.templatesSlaveInvokeHistoryMod.InvokeHistory {
    /**
  ...
  class PInvoke protected ()
    extends typingsSlinky.samchon.templatesSlavePInvokeMod.PInvoke {
    /**
  ...
  abstract class SlaveClient ()
    extends typingsSlinky.samchon.templatesSlaveSlaveClientMod.SlaveClient
  ...
  abstract class SlaveServer ()
    extends typingsSlinky.samchon.templatesSlaveSlaveServerMod.SlaveServer
  ...
  abstract class SlaveSystem ()
    extends typingsSlinky.samchon.templatesSlaveSlaveSystemMod.SlaveSystem
