...
object parallelClientArrayMod {
  ...
  - typingsSlinky.samchon.iexternalclientarrayMod.IExternalClientArray because var conflicts: _Handle_system_erase, _Notify_erase, _Notify_insert, dispatcher_. Inlined  */ @JSImport("samchon/templates/parallel/derived/ParallelClientArray", "ParallelClientArray")
  @js.native
  /**
    * Default Constructor.
    */
