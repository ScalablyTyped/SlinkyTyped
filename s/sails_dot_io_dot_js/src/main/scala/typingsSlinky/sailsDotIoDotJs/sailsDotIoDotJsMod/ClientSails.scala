...
import typingsSlinky.sailsDotIoDotJs.sailsDotIoDotJsStrings.polling
import typingsSlinky.sailsDotIoDotJs.sailsDotIoDotJsStrings.production
import typingsSlinky.sailsDotIoDotJs.sailsDotIoDotJsStrings.websocket
