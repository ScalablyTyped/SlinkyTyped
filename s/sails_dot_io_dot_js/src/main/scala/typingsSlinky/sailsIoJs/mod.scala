package typingsSlinky.sailsIoJs
...
import typingsSlinky.sailsIoJs.sailsIoJsStrings.polling
import typingsSlinky.sailsIoJs.sailsIoJsStrings.production
import typingsSlinky.sailsIoJs.sailsIoJsStrings.reconnect
import typingsSlinky.sailsIoJs.sailsIoJsStrings.reconnecting
import typingsSlinky.sailsIoJs.sailsIoJsStrings.websocket
import typingsSlinky.socketIoClient.SocketIOClientStatic
...
object mod {
  ...
  object JWR {
    ...
    implicit class JWRMutableBuilder[Self <: JWR] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPipe(value: () => js.Error): Self = StObject.set(x, "pipe", js.Any.fromFunction0(value))
