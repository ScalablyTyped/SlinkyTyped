...
import typingsSlinky.sendcloud.AnonModifyat
...
trait ListMemberListResponse extends js.Object {
  var members: js.Array[AnonModifyat] = js.native
...
object ListMemberListResponse {
  @scala.inline
  def apply(members: js.Array[AnonModifyat], message: success, total_count: Double): ListMemberListResponse = {
  ...
  implicit class ListMemberListResponseOps[Self <: ListMemberListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMembers(value: js.Array[AnonModifyat]): Self = {
