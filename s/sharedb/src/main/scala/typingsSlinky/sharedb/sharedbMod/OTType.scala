...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.sharedb.sharedbStrings.`ot-text`
  - typingsSlinky.sharedb.sharedbStrings.`ot-json0`
  - typingsSlinky.sharedb.sharedbStrings.`ot-json1`
...
object OTType {
  ...
  @scala.inline
  def `ot-json1`: typingsSlinky.sharedb.sharedbStrings.`ot-json1` = "ot-json1".asInstanceOf[typingsSlinky.sharedb.sharedbStrings.`ot-json1`]
