...
object SubmitRequest {
  ...
  implicit class SubmitRequestMutableBuilder[Self <: SubmitRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOps(value: js.Array[typingsSlinky.sharedb.sharedbMod.Op]): Self = StObject.set(x, "ops", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOpsVarargs(value: typingsSlinky.sharedb.sharedbMod.Op*): Self = StObject.set(x, "ops", js.Array(value :_*))
