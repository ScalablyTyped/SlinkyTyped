...
object EditOp {
  ...
  implicit class EditOpMutableBuilder[Self <: EditOp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOp(value: js.Array[typingsSlinky.sharedb.sharedbMod.Op]): Self = StObject.set(x, "op", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOpVarargs(value: typingsSlinky.sharedb.sharedbMod.Op*): Self = StObject.set(x, "op", js.Array(value :_*))
