...
object middleware {
  ...
  object ApplyContext {
    ...
    def apply(
      ...
      agent: typingsSlinky.sharedb.agentMod.^,
      backend: sharedb,
      collection: String,
      id: String,
      index: String,
  ...
  trait BaseContext extends StObject {
    ...
    var agent: typingsSlinky.sharedb.agentMod.^ = js.native
  ...
  object BaseContext {
    ...
    implicit class BaseContextMutableBuilder[Self <: BaseContext] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAgent(value: typingsSlinky.sharedb.agentMod.^): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
  ...
  trait OpContext extends BaseContext {
    ...
    var op: typingsSlinky.sharedb.sharedbMod.Op = js.native
  }
  object OpContext {
    ...
    def apply(
      ...
      collection: String,
      id: String,
      op: typingsSlinky.sharedb.sharedbMod.Op
    ): OpContext = {
    ...
    implicit class OpContextMutableBuilder[Self <: OpContext] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOp(value: typingsSlinky.sharedb.sharedbMod.Op): Self = StObject.set(x, "op", value.asInstanceOf[js.Any])
    }
  }
