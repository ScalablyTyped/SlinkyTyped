package typingsSlinky.sharedb.libAgentMod

import typingsSlinky.node.streamMod.Duplex
import typingsSlinky.sharedb.Anon_IsServer
import typingsSlinky.sharedb.libSharedbMod.JSONObject
...
class ^ () extends Agent {
  /* CompleteClass */
  override var backend: typingsSlinky.sharedb.sharedbMod.^ = js.native
  /**
