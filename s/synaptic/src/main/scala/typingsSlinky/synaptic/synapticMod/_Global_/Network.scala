...
/**
  ...
  */
class Network ()
  extends typingsSlinky.synaptic.synapticMod.Network {
...
@js.native
object Network
  extends Instantiable0[typingsSlinky.synaptic.synapticMod.Network]
     with Instantiable1[/* options */ Options, typingsSlinky.synaptic.synapticMod.Network] {
  /**
