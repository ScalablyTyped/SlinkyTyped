...
import typingsSlinky.synaptic.Anon_Test
import typingsSlinky.synaptic.synapticMod.Trainer.DSROptions
import typingsSlinky.synaptic.synapticMod.Trainer.DSRTrainingResult
import typingsSlinky.synaptic.synapticMod.Trainer.ERGOptions
import typingsSlinky.synaptic.synapticMod.Trainer.ERGTrainingResult
import typingsSlinky.synaptic.synapticMod.Trainer.TrainingOptions
import typingsSlinky.synaptic.synapticMod.Trainer.TrainingResult
import typingsSlinky.synaptic.synapticMod.Trainer.TrainingSet
import typingsSlinky.synaptic.synapticMod.Trainer.XOROptions
...
class Trainer_ protected () extends js.Object {
  ...
  /**
    ...
    */
  def timingTask(): Anon_Test = js.native
  def timingTask(options: js.Any): Anon_Test = js.native
  /**
