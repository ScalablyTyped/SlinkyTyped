...
import typingsSlinky.sparkpost.sparkpostMod.CreateTransmission
import typingsSlinky.sparkpost.sparkpostMod.ResultsCallback
import typingsSlinky.sparkpost.sparkpostMod.ResultsPromise
import typingsSlinky.sparkpost.sparkpostMod.Transmission
import typingsSlinky.sparkpost.sparkpostMod.TransmissionSummary
