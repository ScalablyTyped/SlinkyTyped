...
import typingsSlinky.sparkpost.sparkpostMod.Callback
import typingsSlinky.sparkpost.sparkpostMod.CreateRecipientList
import typingsSlinky.sparkpost.sparkpostMod.RecipientList
import typingsSlinky.sparkpost.sparkpostMod.RecipientListMetadata
import typingsSlinky.sparkpost.sparkpostMod.RecipientListWithRecipients
import typingsSlinky.sparkpost.sparkpostMod.ResultsCallback
import typingsSlinky.sparkpost.sparkpostMod.ResultsPromise
import typingsSlinky.sparkpost.sparkpostMod.UpdateRecipientList
...
trait Anon_CallbackCreate extends js.Object {
  ...
  def get(id: String, options: Anon_Showrecipients): ResultsPromise[RecipientListWithRecipients] = js.native
  /**
    * Retrieve details about a specified recipient list by specifying its id in the URI path.
    * To retrieve the recipients contained in a list, the show_recipients parameter must be set to true.
    *
    ...
    */
  def get(id: String, options: Anon_Showrecipients, callback: Callback[RecipientListWithRecipients]): Unit = js.native
  /**
