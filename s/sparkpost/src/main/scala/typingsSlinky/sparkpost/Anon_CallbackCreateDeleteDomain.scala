...
import typingsSlinky.sparkpost.sparkpostMod.CreateSendingDomain
import typingsSlinky.sparkpost.sparkpostMod.ResultsCallback
import typingsSlinky.sparkpost.sparkpostMod.ResultsPromise
import typingsSlinky.sparkpost.sparkpostMod.SendingDomain
import typingsSlinky.sparkpost.sparkpostMod.UpdateSendingDomain
import typingsSlinky.sparkpost.sparkpostMod.VerifyOptions
import typingsSlinky.sparkpost.sparkpostMod.VerifyResults
