...
import typingsSlinky.sparkpost.mod.Response
import typingsSlinky.sparkpost.mod.ResultsCallback
import typingsSlinky.sparkpost.mod.ResultsPromise
import typingsSlinky.sparkpost.mod.UpdateWebhook
import typingsSlinky.sparkpost.mod.Webhook
import typingsSlinky.sparkpost.mod.WebhookLinks
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonGetBatchStatus extends js.Object {
  /**
  ...
  def get(id: String, options: AnonTimezone): ResultsPromise[WebhookLinks with Webhook] = js.native
  /**
    * Retrieve details about a specified webhook by its id
    *
    * @param id The id of the webhook to get
    ...
    * @param callback The request callback with RelayWebhook results
    */
  def get(id: String, options: AnonTimezone, callback: ResultsCallback[WebhookLinks with Webhook]): Unit = js.native
  /**
    ...
    */
  def getBatchStatus(id: String, callback: ResultsCallback[js.Array[AnonAttempts]]): Unit = js.native
  /**
    * Gets recent status information about a webhook.
    *
    * @param id The id of the webhook
    ...
    */
  def getBatchStatus(id: String, options: AnonLimit): ResultsPromise[js.Array[AnonAttempts]] = js.native
  /**
    * Gets recent status information about a webhook.
    *
    * @param id The id of the webhook
    ...
    * @param callback The request callback with status results
    */
  def getBatchStatus(id: String, options: AnonLimit, callback: ResultsCallback[js.Array[AnonAttempts]]): Unit = js.native
  /**
  ...
  def getSamples(options: AnonEvents): js.Promise[Response[_]] = js.native
  /**
    * List an example of the event data that will be posted by a Webhook for the specified events.
    * @param options The optional event name
    * @param callback The request callback containing examples
    */
  def getSamples(options: AnonEvents, callback: Callback[_]): Unit = js.native
  /**
  ...
  def list(options: AnonTimezone): ResultsPromise[js.Array[WebhookLinks with Webhook]] = js.native
  /**
    * List currently existing webhooks.
    * @param options Object containing optional timezone
    * @param callback The request callback with RelayWebhook results array
    */
  def list(options: AnonTimezone, callback: ResultsCallback[js.Array[WebhookLinks with Webhook]]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def validate(id: String, options: AnonMessageAny): ResultsPromise[AnonMsg] = js.native
  /**
    * Sends an example message event batch from the Webhook API to the target URL
    *
    * @param id The id of the webhook to validate
    ...
    */
  def validate(id: String, options: AnonMessageAny, callback: ResultsCallback[AnonMsg]): Unit = js.native
}
