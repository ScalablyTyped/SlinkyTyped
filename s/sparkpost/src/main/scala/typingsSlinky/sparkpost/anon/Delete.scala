...
import typingsSlinky.sparkpost.mod.CreateRecipientList
import typingsSlinky.sparkpost.mod.RecipientList
import typingsSlinky.sparkpost.mod.RecipientListMetadata
import typingsSlinky.sparkpost.mod.RecipientListWithRecipients
import typingsSlinky.sparkpost.mod.ResultsCallback
import typingsSlinky.sparkpost.mod.ResultsPromise
import typingsSlinky.sparkpost.mod.UpdateRecipientList
