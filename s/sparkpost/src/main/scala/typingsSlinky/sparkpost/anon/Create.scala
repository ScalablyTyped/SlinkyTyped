...
trait Create extends js.Object {
  ...
  /**
    ...
    */
  def get(domain: String): ResultsPromise[typingsSlinky.sparkpost.mod.Domain] = js.native
  /**
    * Retrieve an inbound domain by specifying its domain name in the URI path.
    * @param domain Domain name
    * @param callback The request callback with Domain results
    */
  def get(domain: String, callback: ResultsCallback[typingsSlinky.sparkpost.mod.Domain]): Unit = js.native
  /**
    * List all your inbound domains.
    * @returns Promise The Domain results array
    */
  def list(): ResultsPromise[js.Array[typingsSlinky.sparkpost.mod.Domain]] = js.native
  /**
    * List all your inbound domains.
    * @param callback The request callback with Domain results array
    */
  def list(callback: ResultsCallback[js.Array[typingsSlinky.sparkpost.mod.Domain]]): Unit = js.native
}
