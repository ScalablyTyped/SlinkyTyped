...
trait AnonList extends js.Object {
  /**
    ...
    */
  def create(options: CreateSendingDomain): ResultsPromise[AnonDomain] = js.native
  /**
    * Create a sending domain by providing a sending domain object as the POST request body.
    * @param options The create options
    * @param callback The request callback with basic info results
    */
  def create(options: CreateSendingDomain, callback: ResultsCallback[AnonDomain]): Unit = js.native
  /**
  ...
  /**
    ...
    * @returns Promise The basic info results
    */
  def update(domain: String, updateOpts: UpdateSendingDomain): ResultsPromise[AnonDomain] = js.native
  /**
    * Update the attributes of an existing sending domain by specifying its domain name in the URI path and use a sending domain object as the PUT request body.
    * @param domain The domain
    * @param updateOpts The update options
    * @param callback The request callback with basic info results
    */
  def update(domain: String, updateOpts: UpdateSendingDomain, callback: ResultsCallback[AnonDomain]): Unit = js.native
  /**
