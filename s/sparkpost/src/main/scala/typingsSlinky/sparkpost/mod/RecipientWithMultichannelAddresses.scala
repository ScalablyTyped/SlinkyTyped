...
object RecipientWithMultichannelAddresses {
  ...
  implicit class RecipientWithMultichannelAddressesOps[Self <: RecipientWithMultichannelAddresses] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMultichannel_addresses(value: js.Array[MultichannelAddress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multichannel_addresses")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAddress(value: Address | String): Self = {
        val ret = this.duplicate
