...
object Template {
  ...
  implicit class TemplateOps[Self <: Template] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLast_update_time(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("last_update_time")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOptions(value: TemplateOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast_use(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("last_use")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLast_use: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("last_use")(js.undefined)
        ret
    }
  }
