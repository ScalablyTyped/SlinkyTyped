package typingsSlinky.atStorybookAddonDashStoryshotsDashPuppeteer.atStorybookAddonDashStoryshotsDashPuppeteerMod

import typingsSlinky.jestDashImageDashSnapshot.jestDashImageDashSnapshotMod.MatchImageSnapshotOptions
import typingsSlinky.puppeteer.puppeteerMod.Browser
import typingsSlinky.puppeteer.puppeteerMod.DirectNavigationOptions
import typingsSlinky.puppeteer.puppeteerMod.Page
import typingsSlinky.puppeteer.puppeteerMod.ScreenshotOptions
