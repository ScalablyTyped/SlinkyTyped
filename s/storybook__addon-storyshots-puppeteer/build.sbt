...
version := "5.1-dt-20191122Z-1e193c"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jest-image-snapshot" % "2.11-dt-20191025Z-c0b9c3",
  ...
  "org.scalablytyped.slinky" %%% "storybook__addon-storyshots" % "5.1-dt-20191122Z-b3d4bf",
