...
trait Connection extends js.Object {
  ...
  /**
    ...
    */
  def connect(fn: js.Function2[/* err */ js.Error, /* conn */ this.type, Unit]): Unit = js.native
  
  /**
    * Immediately terminates the connection without waiting for
    * currently executing statements to complete.
    */
  def destroy(fn: js.Function2[/* err */ js.Error, /* conn */ this.type, Unit]): Unit = js.native
  ...
  /**
    ...
    */
  def execute(options: typingsSlinky.snowflakeSdk.anon.Binds): Unit = js.native
