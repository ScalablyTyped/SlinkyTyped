...
object mod {
  ...
  object StatementStatus extends StObject {
    ...
    /* "complete" */ val Complete: typingsSlinky.snowflakeSdk.mod.StatementStatus.Complete with String = js.native
    
    @js.native
    sealed trait Fetching extends StatementStatus
    /* "fetching" */ val Fetching: typingsSlinky.snowflakeSdk.mod.StatementStatus.Fetching with String = js.native
  }
  ...
  object ocspModes extends StObject {
    ...
    /* "FAIL_CLOSED" */ val FAIL_CLOSED: typingsSlinky.snowflakeSdk.mod.ocspModes.FAIL_CLOSED with String = js.native
    
    @js.native
    sealed trait FAIL_OPEN extends ocspModes
    /* "FAIL_OPEN" */ val FAIL_OPEN: typingsSlinky.snowflakeSdk.mod.ocspModes.FAIL_OPEN with String = js.native
    
    @js.native
    sealed trait INSECURE extends ocspModes
    /* "INSECURE" */ val INSECURE: typingsSlinky.snowflakeSdk.mod.ocspModes.INSECURE with String = js.native
  }
