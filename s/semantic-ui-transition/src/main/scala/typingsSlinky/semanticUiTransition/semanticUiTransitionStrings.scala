...
object semanticUiTransitionStrings {
  ...
  @js.native
  sealed trait `get animation event` extends StObject
  @scala.inline
  def `get animation event`: `get animation event` = ("get animation event").asInstanceOf[`get animation event`]
  
  @js.native
  sealed trait `get animation name` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `is looping` extends StObject
  @scala.inline
  def `is looping`: `is looping` = ("is looping").asInstanceOf[`is looping`]
  
  @js.native
  sealed trait `is supported` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait looping extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `set duration` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `stop all` extends StObject
  @scala.inline
