...
object ConnectOpts {
  ...
  def apply(
    ...
    if (!js.isUndefined(forceNew)) __obj.updateDynamic("forceNew")(forceNew.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(reconnection)) __obj.updateDynamic("reconnection")(reconnection.asInstanceOf[js.Any])
