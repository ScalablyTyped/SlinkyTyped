...
trait SocketIOClientStatic extends js.Object {
  ...
  /**
    ...
    */
  def Manager(opts: ConnectOpts): typingsSlinky.socketIoClient.SocketIOClient.Manager = js.native
  /**
  ...
  /**
    * Manager constructor - exposed for the standalone build
    */
  def Manager(uri: String): typingsSlinky.socketIoClient.SocketIOClient.Manager = js.native
  def Manager(uri: String, opts: ConnectOpts): typingsSlinky.socketIoClient.SocketIOClient.Manager = js.native
  /**
    * Manager constructor - exposed for the standalone build
    */
  @JSName("Manager")
  ...
  /**
    ...
    */
  var Socket: typingsSlinky.socketIoClient.SocketIOClient.Socket = js.native
