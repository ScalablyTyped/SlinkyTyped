...
object Callbacks {
  @scala.inline
  def apply(
    afterClose: () => Boolean | Unit = null,
    afterOpen: () => Boolean | Unit = null,
    beforeClose: () => Boolean | Unit = null,
    beforeOpen: () => Boolean | Unit = null,
    close: () => Boolean | Unit = null,
    open: () => Boolean | Unit = null
  ): Callbacks = {
