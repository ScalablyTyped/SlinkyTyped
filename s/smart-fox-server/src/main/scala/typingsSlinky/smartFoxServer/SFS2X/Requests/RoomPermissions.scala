...
object RoomPermissions {
  ...
  implicit class RoomPermissionsOps[Self <: RoomPermissions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllowNameChange(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowNameChange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAllowPasswordStateChange(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowPasswordStateChange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAllowPublicMessages(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowPublicMessages")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAloowResizing(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("aloowResizing")(value.asInstanceOf[js.Any])
        ret
    }
  }
