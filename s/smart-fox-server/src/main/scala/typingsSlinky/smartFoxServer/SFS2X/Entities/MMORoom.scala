...
object MMORoom {
  ...
  implicit class MMORoomOps[Self <: MMORoom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetMMOItem(value: Double => MMOItem): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMMOItem")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetMMOItems(value: () => js.Array[MMOItem]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMMOItems")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withHigherMapLimit(value: MapLimits): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("higherMapLimit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLowerMapLimit(value: MapLimits): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lowerMapLimit")(value.asInstanceOf[js.Any])
        ret
    }
  }
