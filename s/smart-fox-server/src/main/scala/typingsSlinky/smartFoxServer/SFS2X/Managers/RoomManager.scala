...
object RoomManager {
  ...
  implicit class RoomManagerOps[Self <: RoomManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContainsGroup(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("containsGroup")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withContainsRoom(value: js.Any => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("containsRoom")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withContainsRoomInGroup(value: (js.Any, String) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("containsRoomInGroup")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetJoinedRooms(value: () => js.Array[SFSRoom]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getJoinedRooms")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRoomById(value: Double => SFSRoom): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRoomById")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetRoomByName(value: String => SFSRoom): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRoomByName")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetRoomCount(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRoomCount")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRoomGroups(value: () => js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRoomGroups")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRoomList(value: () => js.Array[SFSRoom]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRoomList")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRoomListFromGroup(value: String => js.Array[SFSRoom]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRoomListFromGroup")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetUserRooms(value: SFSUser => js.Array[SFSRoom]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getUserRooms")(js.Any.fromFunction1(value))
        ret
    }
  }
