...
class MMORoom protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def containsUser(user: typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getMMOItem(id: Double): typingsSlinky.smartFoxServer.SFS2X.Entities.MMOItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getMMOItems(): js.Array[typingsSlinky.smartFoxServer.SFS2X.Entities.MMOItem] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getPlayerList(): js.Array[typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSpectatorList(): js.Array[typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getUserById(id: Double): typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getUserByName(name: String): typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getUserList(): js.Array[typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser] = js.native
  /**
