...
object Game extends js.Object {
  ...
  class SFSGameSettings protected ()
    ...
    /* CompleteClass */
    override var events: typingsSlinky.smartFoxServer.SFS2X.Requests.RoomEvents = js.native
    /** @type {RoomExtension} Sets the Extension that must be attached to the Room on the server-side, and its settings. */
    /* CompleteClass */
    override var extension: typingsSlinky.smartFoxServer.SFS2X.Requests.RoomExtension = js.native
    ...
    /* CompleteClass */
    override var permissions: typingsSlinky.smartFoxServer.SFS2X.Requests.RoomPermissions = js.native
