...
class SFSUser protected ()
  ...
  /* CompleteClass */
  override var aoiEntryPoint: Vec3D = js.native
  ...
  /* CompleteClass */
  override var isItMe: Boolean = js.native
  ...
  /* CompleteClass */
  override var privilegeId: Double = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getPlayerId(room: typingsSlinky.smartFoxServer.SFS2X.Entities.SFSRoom): Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def isJoinedInRoom(room: typingsSlinky.smartFoxServer.SFS2X.Entities.SFSRoom): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def isPlayerInRoom(room: typingsSlinky.smartFoxServer.SFS2X.Entities.SFSRoom): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def isSpectatorInRoom(room: typingsSlinky.smartFoxServer.SFS2X.Entities.SFSRoom): Boolean = js.native
  /**
