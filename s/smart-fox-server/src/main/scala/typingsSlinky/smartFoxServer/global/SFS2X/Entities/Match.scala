...
object Match extends js.Object {
  ...
  object BoolMatch extends js.Object {
    ...
    var EQUALS: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.BoolMatch = js.native
    /** @type {BoolMatch} An instance of BoolMatch representing the following condition: bool1 != bool2. */
    var NOT_EQUALS: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.BoolMatch = js.native
  }
  ...
  object LogicOperator extends js.Object {
    ...
    var AND: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.LogicOperator = js.native
    /** @type {LogicOperator} An instance of LogicOperator representing the OR logical operator. */
    var OR: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.LogicOperator = js.native
  }
  ...
  object NumberMatch extends js.Object {
    ...
    var EQUALS: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.NumberMatch = js.native
    /** @type {NumberMatch} An instance of NumberMatch representing the following condition: number1 > number2. */
    var GREATER_THAN: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.NumberMatch = js.native
    /** @type {NumberMatch} An instance of NumberMatch representing the following condition: number1 >= number2. */
    var GREATER_THAN_OR_EQUAL_TO: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.NumberMatch = js.native
    /** @type {NumberMatch} An instance of NumberMatch representing the following condition: number1 < number2. */
    var LESS_THAN: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.NumberMatch = js.native
    /** @type {NumberMatch} An instance of NumberMatch representing the following condition: number1 <= number2. */
    var LESS_THAN_OR_EQUAL_TO: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.NumberMatch = js.native
    /** @type {NumberMatch} An instance of NumberMatch representing the following condition: number1 != number2. */
    var NOT_EQUALS: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.NumberMatch = js.native
  }
  ...
  object StringMatch extends js.Object {
    ...
    var CONTAINS: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.StringMatch = js.native
    ...
    var ENDS_WITH: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.StringMatch = js.native
    /** @type {StringMatch} An instance of StringMatch representing the following condition: string1 == string2. */
    var EQUALS: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.StringMatch = js.native
    /** @type {StringMatch} An instance of StringMatch representing the following condition: string1 != string2. */
    var NOT_EQUALS: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.StringMatch = js.native
    ...
    var STARTS_WITH: typingsSlinky.smartFoxServer.SFS2X.Entities.Match.StringMatch = js.native
  }
