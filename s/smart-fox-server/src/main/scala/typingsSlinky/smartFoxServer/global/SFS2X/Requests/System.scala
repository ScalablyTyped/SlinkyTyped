...
object System {
  ...
  class AdminMessageRequest protected ()
    ...
    /**
      ...
      */
    def this(message: String, recipientMode: typingsSlinky.smartFoxServer.SFS2X.Requests.MessageRecipientMode) = this()
    def this(
      message: String,
      recipientMode: typingsSlinky.smartFoxServer.SFS2X.Requests.MessageRecipientMode,
      params: js.Object
    ) = this()
  }
  ...
  class BanUserRequest protected ()
    ...
    def this(
      ...
      banMode: typingsSlinky.smartFoxServer.SFS2X.Requests.BanMode
    ) = this()
    def this(userId: Double, message: String, banMode: typingsSlinky.smartFoxServer.SFS2X.Requests.BanMode) = this()
    def this(
      userId: Double,
      message: js.UndefOr[scala.Nothing],
  ...
  class CreateRoomRequest protected ()
    extends typingsSlinky.smartFoxServer.SFS2X.Requests.System.CreateRoomRequest {
    /**
      ...
      */
    def this(settings: typingsSlinky.smartFoxServer.SFS2X.Requests.RoomSettings) = this()
    def this(settings: typingsSlinky.smartFoxServer.SFS2X.Requests.RoomSettings, autoJoin: Boolean) = this()
    def this(
      settings: typingsSlinky.smartFoxServer.SFS2X.Requests.RoomSettings,
  ...
  class ExtensionRequest protected ()
    extends typingsSlinky.smartFoxServer.SFS2X.Requests.System.ExtensionRequest {
    /**
  ...
  class ModeratorMessageRequest protected ()
    extends typingsSlinky.smartFoxServer.SFS2X.Requests.System.ModeratorMessageRequest {
    /**
  ...
  class PrivateMessageRequest protected ()
    extends typingsSlinky.smartFoxServer.SFS2X.Requests.System.PrivateMessageRequest {
    /**
  ...
  class SetUserVariablesRequest protected ()
    extends typingsSlinky.smartFoxServer.SFS2X.Requests.System.SetUserVariablesRequest {
    /**
  ...
  class SubscribeRoomGroupRequest protected ()
    extends typingsSlinky.smartFoxServer.SFS2X.Requests.System.SubscribeRoomGroupRequest {
    /**
