...
object Invitation extends js.Object {
  ...
  class SFSInvitation protected ()
    ...
    /* CompleteClass */
    override var invitee: typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser = js.native
    /** @type {SFSUser} Returns the SFSUser object corresponding to the user who sent the invitation. */
    /* CompleteClass */
    override var inviter: typingsSlinky.smartFoxServer.SFS2X.Entities.SFSUser = js.native
