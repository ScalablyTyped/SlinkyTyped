...
version := "1.x-dt-20200515Z-286634"
scalaVersion := "2.13.3"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.5",
  "org.scalablytyped.slinky" %%% "apidevtools__swagger-parser" % "10.0.1-11ea42",
  ...
  "org.scalablytyped.slinky" %%% "swagger-parser" % "10.0.1-c37c98")
