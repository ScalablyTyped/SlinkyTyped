...
import typingsSlinky.swaggerExpressMiddleware.anon.FieldNameSize
...
object MulterOptions {
  ...
  def apply(
    dest: String = null,
    fileFilter: (/* req */ Request_[ParamsDictionary, _, _, Query], /* file */ File, /* callback */ js.Function2[/* error */ js.Error, /* acceptFile */ Boolean, Unit]) => Unit = null,
