...
import typingsSlinky.swaggerDashExpressDashMiddleware.Anon_FieldNameSize
...
object MulterOptions {
  ...
  def apply(
    dest: String = null,
    fileFilter: (/* req */ Request[ParamsDictionary], /* file */ File, /* callback */ js.Function2[/* error */ js.Error, /* acceptFile */ Boolean, Unit]) => Unit = null,
