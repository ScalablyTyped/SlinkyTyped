...
trait ActivityButtonProps extends js.Object {
  var activateLabel: js.UndefOr[String | (js.Tuple3[String, String, TagMod[Any]])] = js.undefined
  var activateText: js.UndefOr[String] = js.undefined
  var deactivateLabel: js.UndefOr[String | (js.Tuple3[String, String, TagMod[Any]])] = js.undefined
