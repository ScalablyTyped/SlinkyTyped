...
object ActivityButtonProps {
  ...
  implicit class ActivityButtonPropsOps[Self <: ActivityButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActivateLabel(value: String | (js.Tuple3[String, String, ReactElement])): Self = this.set("activateLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDeactivateLabel(value: String | (js.Tuple3[String, String, ReactElement])): Self = this.set("deactivateLabel", value.asInstanceOf[js.Any])
    @scala.inline
