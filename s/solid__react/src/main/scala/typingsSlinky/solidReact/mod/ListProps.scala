...
trait ListProps extends js.Object {
  var children: js.UndefOr[js.Function2[/* listItem */ LDflexValue, /* index */ Double, ReactElement]] = js.undefined
  var container: js.UndefOr[js.Function1[ReactElement, ReactElement]] = js.undefined
...
object ListProps {
  ...
  def apply(
    src: String,
    children: (/* listItem */ LDflexValue, /* index */ Double) => ReactElement = null,
