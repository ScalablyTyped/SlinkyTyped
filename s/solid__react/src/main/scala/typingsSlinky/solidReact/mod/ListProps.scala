...
object ListProps {
  ...
  implicit class ListPropsOps[Self <: ListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: (/* listItem */ LDflexValue, /* index */ Double) => ReactElement): Self = this.set("children", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteChildren: Self = this.set("children", js.undefined)
    
    @scala.inline
    def setContainer(value: ReactElement => ReactElement): Self = this.set("container", js.Any.fromFunction1(value))
