...
@scala.inline
class SharedBuilder_ActivityButtonPropsHTMLAttributes307943597[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def `object`(value: String): this.type = set("object", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def shortName(value: String): this.type = set("shortName", value.asInstanceOf[js.Any])
  @scala.inline
