...
abstract class `SharedApply_<intersection>2033407234`[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  def apply(
    about: String = null,
    accessKey: String = null,
    activateLabel: String | (js.Tuple3[String, String, TagMod[Any]]) = null,
    ...
    deactivateLabel: String | (js.Tuple3[String, String, TagMod[Any]]) = null,
