...
object hrefstringHTMLAttributesH {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLAnchorElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLAnchorElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLAnchorElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLAnchorElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLAnchorElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLAnchorElement, Event] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLAnchorElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLAnchorElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLAnchorElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLAnchorElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLAnchorElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLAnchorElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLAnchorElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLAnchorElement, Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLAnchorElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLAnchorElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLAnchorElement] => Unit = null,
    onLoad: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLAnchorElement] => Unit = null,
    onPause: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLAnchorElement] => Unit = null,
    onProgress: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLAnchorElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLAnchorElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLAnchorElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLAnchorElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLAnchorElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLAnchorElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLAnchorElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLAnchorElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLAnchorElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLAnchorElement] => Unit = null,
