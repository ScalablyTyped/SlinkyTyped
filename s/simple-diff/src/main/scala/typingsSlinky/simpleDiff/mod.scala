...
import typingsSlinky.simpleDiff.anon.NewPath
...
object mod {
  ...
  */
  ...
  object Event {
    ...
    @scala.inline
    def AddEvent(newPath: Path, newValue: js.Any, oldPath: Path, `type`: add): typingsSlinky.simpleDiff.mod.AddEvent = {
      val __obj = js.Dynamic.literal(newPath = newPath.asInstanceOf[js.Any], newValue = newValue.asInstanceOf[js.Any], oldPath = oldPath.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.simpleDiff.mod.AddEvent]
    }
    ...
    def AddItemEvent(
      ...
      val __obj = js.Dynamic.literal(curIndex = curIndex.asInstanceOf[js.Any], newIndex = newIndex.asInstanceOf[js.Any], newPath = newPath.asInstanceOf[js.Any], newValue = newValue.asInstanceOf[js.Any], oldIndex = oldIndex.asInstanceOf[js.Any], oldPath = oldPath.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.simpleDiff.mod.AddItemEvent]
    }
    
    @scala.inline
    def ChangeEvent(newPath: Path, newValue: js.Any, oldPath: Path, oldValue: js.Any, `type`: change): typingsSlinky.simpleDiff.mod.ChangeEvent = {
      val __obj = js.Dynamic.literal(newPath = newPath.asInstanceOf[js.Any], newValue = newValue.asInstanceOf[js.Any], oldPath = oldPath.asInstanceOf[js.Any], oldValue = oldValue.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.simpleDiff.mod.ChangeEvent]
    }
    ...
    def MoveItemEvent(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.simpleDiff.mod.MoveItemEvent]
    }
    
    @scala.inline
    def RemoveEvent(newPath: Path, oldPath: Path, oldValue: js.Any, `type`: remove): typingsSlinky.simpleDiff.mod.RemoveEvent = {
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.simpleDiff.mod.RemoveEvent]
    }
    ...
    def RemoveItemEvent(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.simpleDiff.mod.RemoveItemEvent]
    }
  }
