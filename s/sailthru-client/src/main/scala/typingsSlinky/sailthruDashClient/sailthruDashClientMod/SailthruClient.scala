package typingsSlinky.sailthruDashClient.sailthruDashClientMod

import typingsSlinky.sailthruDashClient.Anon_Limit
...
trait SailthruClient extends js.Object {
  ...
  /**
    ...
    */
  def getLastRateLimitInfo(action: String, method: String): Anon_Limit = js.native
  /**
