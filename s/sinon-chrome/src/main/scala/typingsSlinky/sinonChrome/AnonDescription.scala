...
trait AnonDescription extends js.Object {
  ...
  var placeholders: js.UndefOr[StringDictionary[AnonContent]] = js.native
}

object AnonDescription {
  @scala.inline
  def apply(message: String): AnonDescription = {
  ...
  implicit class AnonDescriptionOps[Self <: AnonDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPlaceholders(value: StringDictionary[AnonContent]): Self = {
        val ret = this.duplicate
