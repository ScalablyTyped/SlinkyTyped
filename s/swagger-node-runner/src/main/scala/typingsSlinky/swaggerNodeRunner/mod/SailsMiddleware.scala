...
object SailsMiddleware {
  ...
  implicit class SailsMiddlewareOps[Self <: SailsMiddleware] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChain(value: () => js.Function3[/* req */ Request, /* res */ Response, /* next */ NextFunction, Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("chain")(js.Any.fromFunction0(value))
        ret
    }
  }
