...
trait ExecFunction extends StObject {
  ...
  /**
    ...
    */
  def apply(command: String): typingsSlinky.shelljs.mod.ShellString = js.native
  /**
    * Executes the given command synchronously.
    *
    * @param command The command to execute.
  ...
  /**
    ...
    */
  def apply(command: String, options: ExecOptionsasyncfalseunde): typingsSlinky.shelljs.mod.ShellString = js.native
  /**
  ...
  /**
    ...
    *                or if `{async: true}` was passed, a `ChildProcess`.
    */
  def apply(command: String, options: ExecOptions): typingsSlinky.shelljs.mod.ShellString | ChildProcess = js.native
  /**
    * Executes the given command synchronously.
    *
    * @param command The command to execute.
