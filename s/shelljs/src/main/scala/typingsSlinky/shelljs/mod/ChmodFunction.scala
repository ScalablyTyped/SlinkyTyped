...
trait ChmodFunction extends StObject {
  ...
  /**
    ...
    */
  def apply(mode: String, file: String): typingsSlinky.shelljs.mod.ShellString = js.native
  def apply(mode: Double, file: String): typingsSlinky.shelljs.mod.ShellString = js.native
  /**
    * Alters the permissions of a file or directory by either specifying the absolute
    * permissions in octal form or expressing the changes in symbols.
    *
    ...
    * @return        Object with shell exit code, stderr and stdout.
    */
  def apply(options: String, mode: String, file: String): typingsSlinky.shelljs.mod.ShellString = js.native
  def apply(options: String, mode: Double, file: String): typingsSlinky.shelljs.mod.ShellString = js.native
}
