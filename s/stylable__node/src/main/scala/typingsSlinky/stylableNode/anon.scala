...
import typingsSlinky.stylableCore.anon.Cwd
import typingsSlinky.stylableCore.anon.Dictkey
import typingsSlinky.stylableCore.anon.Dirname
...
import typingsSlinky.stylableNode.stylableNodeStrings.development
import typingsSlinky.stylableNode.stylableNodeStrings.production
...
object anon {
  ...
  object Errors {
    ...
    @scala.inline
    def apply(errors: js.Array[js.Error], result: js.Array[String]): Errors = {
