package typingsSlinky.semanticDashUiDashReact.distCommonjsElementsListListIconMod
...
import typingsSlinky.semanticDashUiDashReact.distCommonjsElementsIconIconMod.StrictIconProps
