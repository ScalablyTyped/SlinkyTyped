...
object Button
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.semanticDashUiDashReact.distCommonjsElementsButtonMod.default].asInstanceOf[String | js.Object]
  def apply(
    about: String = null,
