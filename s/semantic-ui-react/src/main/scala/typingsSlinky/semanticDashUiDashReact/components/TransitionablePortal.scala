...
object TransitionablePortal
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsTransitionablePortalMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
