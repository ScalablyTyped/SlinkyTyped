...
object Menu
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.semanticDashUiDashReact.distCommonjsCollectionsMenuMod.default].asInstanceOf[String | js.Object]
  def apply(
