...
object DropdownSearchInput
  ...
  def apply(as: js.Any = null, tabIndex: Double | String = null, _overrides: StringDictionary[js.Any] = null): BuildingComponent[tag.type, default] = {
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsModulesDropdownDropdownSearchInputMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
