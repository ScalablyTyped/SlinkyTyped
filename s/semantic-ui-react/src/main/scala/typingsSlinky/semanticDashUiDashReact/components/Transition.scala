...
object Transition
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsModulesTransitionMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
