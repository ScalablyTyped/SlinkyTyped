...
object SidebarPusher
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsModulesSidebarSidebarPusherMod.default.asInstanceOf[String | js.Object]
  def apply(
