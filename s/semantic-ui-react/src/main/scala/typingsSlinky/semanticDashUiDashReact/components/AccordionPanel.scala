...
object AccordionPanel
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.semanticDashUiDashReact.distCommonjsModulesAccordionAccordionPanelMod.default].asInstanceOf[String | js.Object]
  def apply(
