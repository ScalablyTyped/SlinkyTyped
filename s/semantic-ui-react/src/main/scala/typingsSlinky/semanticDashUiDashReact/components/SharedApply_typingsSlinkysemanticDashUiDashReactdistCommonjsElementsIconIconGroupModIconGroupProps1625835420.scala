...
abstract class SharedApply_typingsSlinkysemanticDashUiDashReactdistCommonjsElementsIconIconGroupModIconGroupProps1625835420 (implicit pw: ExternalPropsWriterProvider)
