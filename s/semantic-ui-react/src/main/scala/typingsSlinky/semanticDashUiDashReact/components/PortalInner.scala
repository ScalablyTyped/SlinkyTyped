...
object PortalInner
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsPortalPortalInnerMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
