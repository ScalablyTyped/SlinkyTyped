...
object PlaceholderParagraph
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsElementsPlaceholderPlaceholderParagraphMod.default.asInstanceOf[String | js.Object]
  def apply(
