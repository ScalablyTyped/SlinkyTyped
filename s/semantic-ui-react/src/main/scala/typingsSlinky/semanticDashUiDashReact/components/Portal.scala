...
import typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsPortalMod.default
...
object Portal
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsPortalMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
