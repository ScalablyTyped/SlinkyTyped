...
object Message
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsCollectionsMessageMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
