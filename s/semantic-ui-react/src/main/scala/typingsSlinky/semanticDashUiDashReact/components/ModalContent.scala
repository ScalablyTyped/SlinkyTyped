...
object ModalContent
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsModulesModalModalContentMod.default.asInstanceOf[String | js.Object]
  def apply(
