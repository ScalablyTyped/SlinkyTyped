...
object FeedContent
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsViewsFeedFeedContentMod.default.asInstanceOf[String | js.Object]
  def apply(
