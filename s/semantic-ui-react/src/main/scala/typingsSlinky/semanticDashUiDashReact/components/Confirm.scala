...
import typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsConfirmConfirmMod.ConfirmProps
import typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsConfirmMod.default
...
object Confirm
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsConfirmMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
