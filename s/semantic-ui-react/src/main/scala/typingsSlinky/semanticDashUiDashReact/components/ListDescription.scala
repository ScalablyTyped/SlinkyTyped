...
object ListDescription
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsElementsListListDescriptionMod.default.asInstanceOf[String | js.Object]
  def apply(
