...
object PlaceholderHeader
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsElementsPlaceholderPlaceholderHeaderMod.default.asInstanceOf[String | js.Object]
  def apply(
