...
object TransitionGroup
  ...
  typingsSlinky.semanticDashUiDashReact.distCommonjsModulesTransitionTransitionGroupMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
