...
object Card
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.semanticDashUiDashReact.distCommonjsViewsCardMod.default].asInstanceOf[String | js.Object]
  def apply(
