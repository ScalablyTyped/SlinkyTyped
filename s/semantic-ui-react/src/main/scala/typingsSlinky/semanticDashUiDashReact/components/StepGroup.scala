...
object StepGroup
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsElementsStepStepGroupMod.default.asInstanceOf[String | js.Object]
  def apply(
