...
object ListContent
  ...
  override val component: String | js.Object = typingsSlinky.semanticDashUiDashReact.distCommonjsElementsListListContentMod.default.asInstanceOf[String | js.Object]
  def apply(
