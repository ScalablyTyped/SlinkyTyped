...
import typingsSlinky.semanticDashUiDashReact.srcGenericMod.SemanticWIDTHSNUMBER
...
object semanticDashUiDashReactNumbers {
  ...
  sealed trait `1`
    extends SemanticWIDTHS
       ...
       with typingsSlinky.semanticDashUiDashReact.distCommonjsGenericMod.SemanticWIDTHSNUMBER
