package typingsSlinky.semanticDashUiDashReact.distCommonjsAddonsSelectSelectMod
...
import typingsSlinky.semanticDashUiDashReact.distCommonjsModulesDropdownDropdownMod.StrictDropdownProps
