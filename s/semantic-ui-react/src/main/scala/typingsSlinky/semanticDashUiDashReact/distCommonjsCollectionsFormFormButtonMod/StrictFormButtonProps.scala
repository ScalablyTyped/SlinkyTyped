package typingsSlinky.semanticDashUiDashReact.distCommonjsCollectionsFormFormButtonMod
...
import typingsSlinky.semanticDashUiDashReact.distCommonjsElementsButtonButtonMod.StrictButtonProps
