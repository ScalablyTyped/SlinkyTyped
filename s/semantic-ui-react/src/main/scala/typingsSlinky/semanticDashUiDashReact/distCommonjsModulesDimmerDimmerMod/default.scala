package typingsSlinky.semanticDashUiDashReact.distCommonjsModulesDimmerDimmerMod
...
object default extends TopLevel[DimmerComponent] {
  @js.native
  class Inner ()
    extends typingsSlinky.semanticDashUiDashReact.distCommonjsModulesDimmerDimmerInnerMod.default
