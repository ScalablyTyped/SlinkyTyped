...
object itemExtraMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ItemExtraProps] = js.native
  ...
  type _To = ReactComponentClass[ItemExtraProps]
  
  /* This means you don't have to write `default`, but can instead just say `itemExtraMod.foo` */
  override def _to: ReactComponentClass[ItemExtraProps] = default
}
