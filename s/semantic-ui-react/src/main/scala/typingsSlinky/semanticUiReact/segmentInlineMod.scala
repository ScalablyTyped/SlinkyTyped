...
object segmentInlineMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[SegmentInlineProps] = js.native
  ...
  type _To = ReactComponentClass[SegmentInlineProps]
  
  /* This means you don't have to write `default`, but can instead just say `segmentInlineMod.foo` */
  override def _to: ReactComponentClass[SegmentInlineProps] = default
}
