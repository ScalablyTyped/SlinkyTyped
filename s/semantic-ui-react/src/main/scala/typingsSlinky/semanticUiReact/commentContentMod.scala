...
object commentContentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CommentContentProps] = js.native
  ...
  type _To = ReactComponentClass[CommentContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `commentContentMod.foo` */
  override def _to: ReactComponentClass[CommentContentProps] = default
}
