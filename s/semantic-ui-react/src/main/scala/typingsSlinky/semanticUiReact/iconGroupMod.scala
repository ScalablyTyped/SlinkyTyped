...
object iconGroupMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[IconGroupProps] = js.native
  ...
  type _To = ReactComponentClass[IconGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `iconGroupMod.foo` */
  override def _to: ReactComponentClass[IconGroupProps] = default
}
