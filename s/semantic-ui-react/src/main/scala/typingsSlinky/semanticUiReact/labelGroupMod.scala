...
object labelGroupMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[LabelGroupProps] = js.native
  ...
  type _To = ReactComponentClass[LabelGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `labelGroupMod.foo` */
  override def _to: ReactComponentClass[LabelGroupProps] = default
}
