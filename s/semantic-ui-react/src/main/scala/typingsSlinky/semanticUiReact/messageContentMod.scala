...
object messageContentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[MessageContentProps] = js.native
  ...
  type _To = ReactComponentClass[MessageContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `messageContentMod.foo` */
  override def _to: ReactComponentClass[MessageContentProps] = default
}
