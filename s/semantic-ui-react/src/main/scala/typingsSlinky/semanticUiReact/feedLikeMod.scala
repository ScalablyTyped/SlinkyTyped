...
object feedLikeMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FeedLikeProps] = js.native
  ...
  type _To = ReactComponentClass[FeedLikeProps]
  
  /* This means you don't have to write `default`, but can instead just say `feedLikeMod.foo` */
  override def _to: ReactComponentClass[FeedLikeProps] = default
}
