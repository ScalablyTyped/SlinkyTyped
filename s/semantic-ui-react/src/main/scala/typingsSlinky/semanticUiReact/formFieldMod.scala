...
object formFieldMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FormFieldProps] = js.native
  ...
  type _To = ReactComponentClass[FormFieldProps]
  
  /* This means you don't have to write `default`, but can instead just say `formFieldMod.foo` */
  override def _to: ReactComponentClass[FormFieldProps] = default
}
