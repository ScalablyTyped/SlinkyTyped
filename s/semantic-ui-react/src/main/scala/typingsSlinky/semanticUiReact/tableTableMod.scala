...
object tableTableMod extends Shortcut {
  ...
  object StrictTableProps {
    ...
    implicit class StrictTablePropsMutableBuilder[Self <: StrictTableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFooterRowReactElement(value: ReactElement): Self = StObject.set(x, "footerRow", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHeaderRowReactElement(value: ReactElement): Self = StObject.set(x, "headerRow", value.asInstanceOf[js.Any])
