...
object formInputMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FormInputProps] = js.native
  ...
  type _To = ReactComponentClass[FormInputProps]
  
  /* This means you don't have to write `default`, but can instead just say `formInputMod.foo` */
  override def _to: ReactComponentClass[FormInputProps] = default
}
