...
object placeholderParagraphMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[PlaceholderParagraphProps] = js.native
  ...
  type _To = ReactComponentClass[PlaceholderParagraphProps]
  
  /* This means you don't have to write `default`, but can instead just say `placeholderParagraphMod.foo` */
  override def _to: ReactComponentClass[PlaceholderParagraphProps] = default
}
