...
object StrictMessageProps {
  ...
  implicit class StrictMessagePropsOps[Self <: StrictMessageProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHeader(value: SemanticShorthandItem[MessageHeaderProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("header")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withIcon(value: js.Any | Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withList(value: SemanticShorthandCollection[MessageItemProps]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnDismiss(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* data */ MessageProps) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSize(value: MessageSizeProp): Self = {
        val ret = this.duplicate
