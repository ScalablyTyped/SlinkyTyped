...
object dropdownTextMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[DropdownTextProps] = js.native
  ...
  type _To = ReactComponentClass[DropdownTextProps]
  
  /* This means you don't have to write `default`, but can instead just say `dropdownTextMod.foo` */
  override def _to: ReactComponentClass[DropdownTextProps] = default
}
