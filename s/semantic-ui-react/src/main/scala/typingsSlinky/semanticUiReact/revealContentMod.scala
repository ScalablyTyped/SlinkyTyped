...
object revealContentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[RevealContentProps] = js.native
  ...
  type _To = ReactComponentClass[RevealContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `revealContentMod.foo` */
  override def _to: ReactComponentClass[RevealContentProps] = default
}
