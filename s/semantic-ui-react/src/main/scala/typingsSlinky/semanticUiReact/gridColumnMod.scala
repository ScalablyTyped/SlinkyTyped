...
object gridColumnMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[GridColumnProps] = js.native
  ...
  */
  ...
  type _To = ReactComponentClass[GridColumnProps]
  
  /* This means you don't have to write `default`, but can instead just say `gridColumnMod.foo` */
  override def _to: ReactComponentClass[GridColumnProps] = default
}
