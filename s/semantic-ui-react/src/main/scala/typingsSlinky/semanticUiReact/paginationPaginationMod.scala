...
object paginationPaginationMod {
  ...
  object default {
    ...
    @js.native
    class Item ()
      extends typingsSlinky.semanticUiReact.paginationItemMod.default
  }
  
  object Pagination {
    
    /* was `typeof PaginationItem` */
    type Item = typingsSlinky.semanticUiReact.paginationItemMod.default
  }
  ...
  object StrictPaginationProps {
    ...
    implicit class StrictPaginationPropsMutableBuilder[Self <: StrictPaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEllipsisItemReactElement(value: ReactElement): Self = StObject.set(x, "ellipsisItem", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFirstItemReactElement(value: ReactElement): Self = StObject.set(x, "firstItem", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLastItemReactElement(value: ReactElement): Self = StObject.set(x, "lastItem", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNextItemReactElement(value: ReactElement): Self = StObject.set(x, "nextItem", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNextItemUndefined: Self = StObject.set(x, "nextItem", js.undefined)
      
      @scala.inline
      def setOnPageChange(value: (/* event */ SyntheticMouseEvent[HTMLAnchorElement], /* data */ PaginationProps) => Unit): Self = StObject.set(x, "onPageChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPageItemReactElement(value: ReactElement): Self = StObject.set(x, "pageItem", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPrevItemReactElement(value: ReactElement): Self = StObject.set(x, "prevItem", value.asInstanceOf[js.Any])
