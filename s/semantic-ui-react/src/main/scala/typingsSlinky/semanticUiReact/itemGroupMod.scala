...
object itemGroupMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ItemGroupProps] = js.native
  ...
  type _To = ReactComponentClass[ItemGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `itemGroupMod.foo` */
  override def _to: ReactComponentClass[ItemGroupProps] = default
}
