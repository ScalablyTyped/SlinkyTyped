...
object statisticValueMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[StatisticValueProps] = js.native
  ...
  type _To = ReactComponentClass[StatisticValueProps]
  
  /* This means you don't have to write `default`, but can instead just say `statisticValueMod.foo` */
  override def _to: ReactComponentClass[StatisticValueProps] = default
}
