...
object listDescriptionMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ListDescriptionProps] = js.native
  ...
  type _To = ReactComponentClass[ListDescriptionProps]
  
  /* This means you don't have to write `default`, but can instead just say `listDescriptionMod.foo` */
  override def _to: ReactComponentClass[ListDescriptionProps] = default
}
