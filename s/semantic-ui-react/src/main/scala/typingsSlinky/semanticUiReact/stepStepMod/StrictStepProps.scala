...
object StrictStepProps {
  ...
  implicit class StrictStepPropsOps[Self <: StrictStepProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDescription(value: SemanticShorthandItem[StepDescriptionProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("description")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withOnClick(value: (/* event */ SyntheticMouseEvent[HTMLAnchorElement], /* data */ StepProps) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitle(value: SemanticShorthandItem[StepTitleProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("title")(value.asInstanceOf[js.Any])
        ret
    }
