...
trait StrictDropdownProps extends js.Object {
  ...
  var additionLabel: js.UndefOr[Double | String | ReactElement] = js.native
...
object StrictDropdownProps {
  ...
  @scala.inline
  implicit class StrictDropdownPropsOps[Self <: StrictDropdownProps] (val x: Self) extends AnyVal {
