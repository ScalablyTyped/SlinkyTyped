...
object feedLabelMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FeedLabelProps] = js.native
  ...
  type _To = ReactComponentClass[FeedLabelProps]
  
  /* This means you don't have to write `default`, but can instead just say `feedLabelMod.foo` */
  override def _to: ReactComponentClass[FeedLabelProps] = default
}
