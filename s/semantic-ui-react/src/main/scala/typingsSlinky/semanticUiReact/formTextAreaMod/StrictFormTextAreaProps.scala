...
- typingsSlinky.semanticUiReact.formFieldMod.StrictFormFieldProps because var conflicts: as, children, className, disabled, id, required. Inlined content, control, error, `inline`, label, `type`, width */ trait StrictFormTextAreaProps extends StrictTextAreaProps {
...
object StrictFormTextAreaProps {
  ...
  def apply(
    ...
    name: String = null,
    onAbort: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onChange: (SyntheticEvent[EventTarget with HTMLTextAreaElement, Event_], /* data */ TextAreaProps) => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLTextAreaElement] => Unit = null,
    onInput: (SyntheticEvent[EventTarget with HTMLTextAreaElement, Event_], /* data */ TextAreaProps) => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLTextAreaElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    ...
    onSeeked: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLTextAreaElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLTextAreaElement] => Unit = null,
