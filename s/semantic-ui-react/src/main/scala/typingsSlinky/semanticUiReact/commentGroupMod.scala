...
object commentGroupMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CommentGroupProps] = js.native
  ...
  type _To = ReactComponentClass[CommentGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `commentGroupMod.foo` */
  override def _to: ReactComponentClass[CommentGroupProps] = default
}
