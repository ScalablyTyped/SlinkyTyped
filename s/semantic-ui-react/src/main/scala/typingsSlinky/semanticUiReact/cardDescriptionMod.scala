...
object cardDescriptionMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CardDescriptionProps] = js.native
  
  @js.native
  trait CardDescriptionProps
    extends StrictCardDescriptionProps
  ...
  type _To = ReactComponentClass[CardDescriptionProps]
  
  /* This means you don't have to write `default`, but can instead just say `cardDescriptionMod.foo` */
  override def _to: ReactComponentClass[CardDescriptionProps] = default
}
