...
object commentActionsMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CommentActionsProps] = js.native
  ...
  type _To = ReactComponentClass[CommentActionsProps]
  
  /* This means you don't have to write `default`, but can instead just say `commentActionsMod.foo` */
  override def _to: ReactComponentClass[CommentActionsProps] = default
}
