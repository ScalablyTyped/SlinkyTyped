...
object listHeaderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ListHeaderProps] = js.native
  ...
  type _To = ReactComponentClass[ListHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `listHeaderMod.foo` */
  override def _to: ReactComponentClass[ListHeaderProps] = default
}
