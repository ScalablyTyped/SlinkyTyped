package typingsSlinky.semanticUiReact.cardHeaderMod
...
trait StrictCardHeaderProps extends js.Object {
...
object StrictCardHeaderProps {
  ...
  @scala.inline
  implicit class StrictCardHeaderPropsOps[Self <: StrictCardHeaderProps] (val x: Self) extends AnyVal {
    @scala.inline
