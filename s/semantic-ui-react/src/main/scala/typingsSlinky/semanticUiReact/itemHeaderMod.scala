...
object itemHeaderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ItemHeaderProps] = js.native
  ...
  type _To = ReactComponentClass[ItemHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `itemHeaderMod.foo` */
  override def _to: ReactComponentClass[ItemHeaderProps] = default
}
