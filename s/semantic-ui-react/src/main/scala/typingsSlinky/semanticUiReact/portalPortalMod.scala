...
object portalPortalMod {
  ...
  object default {
    ...
    @js.native
    class Inner ()
      extends typingsSlinky.semanticUiReact.portalInnerMod.default
  }
  
  object Portal {
    
    /* was `typeof PortalInner` */
    type Inner = typingsSlinky.semanticUiReact.portalInnerMod.default
  }
  ...
  object StrictPortalProps {
    ...
    implicit class StrictPortalPropsMutableBuilder[Self <: StrictPortalProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClose(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* data */ PortalProps) => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnOpen(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* data */ PortalProps) => Unit): Self = StObject.set(x, "onOpen", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setTriggerRefRefObject(value: ReactRef[_]): Self = StObject.set(x, "triggerRef", value.asInstanceOf[js.Any])
