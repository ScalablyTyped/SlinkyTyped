package typingsSlinky.semanticUiReact.searchResultsMod
...
object StrictSearchResultsProps {
  ...
  @scala.inline
  implicit class StrictSearchResultsPropsOps[Self <: StrictSearchResultsProps] (val x: Self) extends AnyVal {
    @scala.inline
