...
object feedDateMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FeedDateProps] = js.native
  ...
  type _To = ReactComponentClass[FeedDateProps]
  
  /* This means you don't have to write `default`, but can instead just say `feedDateMod.foo` */
  override def _to: ReactComponentClass[FeedDateProps] = default
}
