...
object commentMetadataMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CommentMetadataProps] = js.native
  ...
  type _To = ReactComponentClass[CommentMetadataProps]
  
  /* This means you don't have to write `default`, but can instead just say `commentMetadataMod.foo` */
  override def _to: ReactComponentClass[CommentMetadataProps] = default
}
