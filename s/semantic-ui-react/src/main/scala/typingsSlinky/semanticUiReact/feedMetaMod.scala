...
object feedMetaMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FeedMetaProps] = js.native
  ...
  object StrictFeedMetaProps {
    ...
    implicit class StrictFeedMetaPropsMutableBuilder[Self <: StrictFeedMetaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLikeReactElement(value: ReactElement): Self = StObject.set(x, "like", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[FeedMetaProps]
  
  /* This means you don't have to write `default`, but can instead just say `feedMetaMod.foo` */
  override def _to: ReactComponentClass[FeedMetaProps] = default
}
