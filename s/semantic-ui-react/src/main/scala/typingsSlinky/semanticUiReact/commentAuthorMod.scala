...
object commentAuthorMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CommentAuthorProps] = js.native
  ...
  type _To = ReactComponentClass[CommentAuthorProps]
  
  /* This means you don't have to write `default`, but can instead just say `commentAuthorMod.foo` */
  override def _to: ReactComponentClass[CommentAuthorProps] = default
}
