package typingsSlinky.semanticUiReact.loaderLoaderMod
...
object StrictLoaderProps {
  ...
  @scala.inline
  implicit class StrictLoaderPropsOps[Self <: StrictLoaderProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setInline(value: Boolean | centered): Self = this.set("inline", value.asInstanceOf[js.Any])
    @scala.inline
