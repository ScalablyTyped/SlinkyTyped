...
object messageItemMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[MessageItemProps] = js.native
  ...
  type _To = ReactComponentClass[MessageItemProps]
  
  /* This means you don't have to write `default`, but can instead just say `messageItemMod.foo` */
  override def _to: ReactComponentClass[MessageItemProps] = default
}
