...
object popupHeaderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[PopupHeaderProps] = js.native
  ...
  type _To = ReactComponentClass[PopupHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `popupHeaderMod.foo` */
  override def _to: ReactComponentClass[PopupHeaderProps] = default
}
