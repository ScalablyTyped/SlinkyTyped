package typingsSlinky.semanticUiReact.messageListMod
...
object StrictMessageListProps {
  ...
  @scala.inline
  implicit class StrictMessageListPropsOps[Self <: StrictMessageListProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: SemanticShorthandCollection[MessageItemProps]): Self = {
        val ret = this.duplicate
