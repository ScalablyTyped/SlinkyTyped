...
object StrictStickyProps {
  ...
  implicit class StrictStickyPropsOps[Self <: StrictStickyProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScrollContextDocument(value: Document): Self = this.set("scrollContext", value.asInstanceOf[js.Any])
    @scala.inline
    def setScrollContextWindow(value: Window): Self = this.set("scrollContext", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setScrollContextHTMLElement(value: HTMLElement): Self = this.set("scrollContext", value.asInstanceOf[js.Any])
    @scala.inline
