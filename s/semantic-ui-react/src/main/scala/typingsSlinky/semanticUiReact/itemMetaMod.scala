...
object itemMetaMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ItemMetaProps] = js.native
  ...
  type _To = ReactComponentClass[ItemMetaProps]
  
  /* This means you don't have to write `default`, but can instead just say `itemMetaMod.foo` */
  override def _to: ReactComponentClass[ItemMetaProps] = default
}
