...
object dropdownMenuMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[DropdownMenuProps] = js.native
  ...
  type _To = ReactComponentClass[DropdownMenuProps]
  
  /* This means you don't have to write `default`, but can instead just say `dropdownMenuMod.foo` */
  override def _to: ReactComponentClass[DropdownMenuProps] = default
}
