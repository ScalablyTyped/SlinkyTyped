...
object searchResultsMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[SearchResultsProps] = js.native
  ...
  type _To = ReactComponentClass[SearchResultsProps]
  
  /* This means you don't have to write `default`, but can instead just say `searchResultsMod.foo` */
  override def _to: ReactComponentClass[SearchResultsProps] = default
}
