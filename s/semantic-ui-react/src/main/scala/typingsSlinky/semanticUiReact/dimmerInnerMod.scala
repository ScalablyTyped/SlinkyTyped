...
object dimmerInnerMod {
  ...
  type DimmerInner = ReactComponentClass[DimmerInnerProps]
  ...
  object StrictDimmerInnerProps {
    ...
    implicit class StrictDimmerInnerPropsMutableBuilder[Self <: StrictDimmerInnerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClick(value: (/* event */ SyntheticMouseEvent[HTMLDivElement], /* data */ DimmerInnerProps) => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnClickOutside(value: (/* event */ SyntheticMouseEvent[HTMLDivElement], /* data */ DimmerInnerProps) => Unit): Self = StObject.set(x, "onClickOutside", js.Any.fromFunction2(value))
