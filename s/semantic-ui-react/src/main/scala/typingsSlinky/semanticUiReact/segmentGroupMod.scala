...
object segmentGroupMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[SegmentGroupProps] = js.native
  ...
  type _To = ReactComponentClass[SegmentGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `segmentGroupMod.foo` */
  override def _to: ReactComponentClass[SegmentGroupProps] = default
}
