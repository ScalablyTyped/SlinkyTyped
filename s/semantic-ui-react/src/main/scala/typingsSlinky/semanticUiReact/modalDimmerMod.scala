...
object modalDimmerMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ModalDimmerProps] = js.native
  ...
  type _To = ReactComponentClass[ModalDimmerProps]
  
  /* This means you don't have to write `default`, but can instead just say `modalDimmerMod.foo` */
  override def _to: ReactComponentClass[ModalDimmerProps] = default
}
