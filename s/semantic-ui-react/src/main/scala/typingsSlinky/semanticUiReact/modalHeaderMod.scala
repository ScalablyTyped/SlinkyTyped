...
object modalHeaderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ModalHeaderProps] = js.native
  ...
  type _To = ReactComponentClass[ModalHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `modalHeaderMod.foo` */
  override def _to: ReactComponentClass[ModalHeaderProps] = default
}
