...
object stepDescriptionMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[StepDescriptionProps] = js.native
  ...
  type _To = ReactComponentClass[StepDescriptionProps]
  
  /* This means you don't have to write `default`, but can instead just say `stepDescriptionMod.foo` */
  override def _to: ReactComponentClass[StepDescriptionProps] = default
}
