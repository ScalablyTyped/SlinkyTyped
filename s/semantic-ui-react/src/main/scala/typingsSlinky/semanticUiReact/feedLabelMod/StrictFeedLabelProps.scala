...
object StrictFeedLabelProps {
  ...
  implicit class StrictFeedLabelPropsOps[Self <: StrictFeedLabelProps] (val x: Self) extends AnyVal {
    ...
    def withImageFunction3(
      value: (/* component */ ReactComponentClass[HtmlImageProps], HtmlImageProps, /* children */ js.UndefOr[TagMod[Any] | ReactNodeArray]) => ReactElement | Null
    ): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImage(value: SemanticShorthandItem[HtmlImageProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("image")(value.asInstanceOf[js.Any])
        ret
    }
