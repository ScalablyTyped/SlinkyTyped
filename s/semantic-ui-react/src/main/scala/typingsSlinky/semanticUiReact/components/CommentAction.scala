...
import typingsSlinky.semanticUiReact.commentActionMod.default
...
object CommentAction
  ...
  typingsSlinky.semanticUiReact.commentActionMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
