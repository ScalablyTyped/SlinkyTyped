...
object FormDropdown {
  ...
  def withProps(p: FormDropdownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FormDropdown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
