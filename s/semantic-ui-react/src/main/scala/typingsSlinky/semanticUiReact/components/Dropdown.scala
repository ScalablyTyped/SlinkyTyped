...
object Dropdown {
  ...
  object Divider {
    ...
    implicit def make(companion: Divider.type): SharedBuilder_DropdownDividerProps1604490139[typingsSlinky.semanticUiReact.mod.Dropdown.Divider] = new SharedBuilder_DropdownDividerProps1604490139[typingsSlinky.semanticUiReact.mod.Dropdown.Divider](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownDividerProps): SharedBuilder_DropdownDividerProps1604490139[typingsSlinky.semanticUiReact.mod.Dropdown.Divider] = new SharedBuilder_DropdownDividerProps1604490139[typingsSlinky.semanticUiReact.mod.Dropdown.Divider](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Header {
    ...
    implicit def make(companion: Header.type): SharedBuilder_DropdownHeaderProps1502232053[typingsSlinky.semanticUiReact.mod.Dropdown.Header] = new SharedBuilder_DropdownHeaderProps1502232053[typingsSlinky.semanticUiReact.mod.Dropdown.Header](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownHeaderProps): SharedBuilder_DropdownHeaderProps1502232053[typingsSlinky.semanticUiReact.mod.Dropdown.Header] = new SharedBuilder_DropdownHeaderProps1502232053[typingsSlinky.semanticUiReact.mod.Dropdown.Header](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): SharedBuilder_DropdownItemProps1131760844[typingsSlinky.semanticUiReact.mod.Dropdown.Item] = new SharedBuilder_DropdownItemProps1131760844[typingsSlinky.semanticUiReact.mod.Dropdown.Item](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownItemProps): SharedBuilder_DropdownItemProps1131760844[typingsSlinky.semanticUiReact.mod.Dropdown.Item] = new SharedBuilder_DropdownItemProps1131760844[typingsSlinky.semanticUiReact.mod.Dropdown.Item](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object SearchInput {
    ...
    implicit def make(companion: SearchInput.type): SharedBuilder_DropdownSearchInputProps_1676240592[typingsSlinky.semanticUiReact.mod.Dropdown.SearchInput] = new SharedBuilder_DropdownSearchInputProps_1676240592[typingsSlinky.semanticUiReact.mod.Dropdown.SearchInput](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownSearchInputProps): SharedBuilder_DropdownSearchInputProps_1676240592[typingsSlinky.semanticUiReact.mod.Dropdown.SearchInput] = new SharedBuilder_DropdownSearchInputProps_1676240592[typingsSlinky.semanticUiReact.mod.Dropdown.SearchInput](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.semanticUiReact.mod.Dropdown] {
