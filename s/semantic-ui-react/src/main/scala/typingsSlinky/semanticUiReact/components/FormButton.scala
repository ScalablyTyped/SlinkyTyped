...
object FormButton {
  ...
  def withProps(p: FormButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FormButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
