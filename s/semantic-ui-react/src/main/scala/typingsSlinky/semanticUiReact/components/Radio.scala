...
import typingsSlinky.semanticUiReact.radioRadioMod.RadioProps
...
object Radio {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onClick(value: (/* event */ SyntheticMouseEvent[HTMLInputElement], /* data */ CheckboxProps) => Unit): this.type = set("onClick", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def onMouseDown(value: (/* event */ SyntheticMouseEvent[HTMLInputElement], /* data */ CheckboxProps) => Unit): this.type = set("onMouseDown", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def onMouseUp(value: (/* event */ SyntheticMouseEvent[HTMLInputElement], /* data */ CheckboxProps) => Unit): this.type = set("onMouseUp", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def radio(value: Boolean): this.type = set("radio", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def slider(value: Boolean): this.type = set("slider", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `type`(value: checkbox | radio): this.type = set("type", value.asInstanceOf[js.Any])
    @scala.inline
