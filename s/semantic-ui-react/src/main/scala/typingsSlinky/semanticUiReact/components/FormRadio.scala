...
object FormRadio {
  ...
  def withProps(p: FormRadioProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FormRadio.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
