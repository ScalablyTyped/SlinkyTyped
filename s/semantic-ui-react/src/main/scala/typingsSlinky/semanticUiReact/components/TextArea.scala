...
object TextArea {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    def onInput(
      value: (SyntheticEvent[EventTarget with HTMLTextAreaElement, Event_], /* data */ TextAreaProps) => Unit
    ): this.type = set("onInput", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def rows(value: Double | String): this.type = set("rows", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: StrictTextAreaProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
