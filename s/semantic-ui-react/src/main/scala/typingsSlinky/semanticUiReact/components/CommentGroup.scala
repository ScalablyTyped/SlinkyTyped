...
object CommentGroup {
  ...
  def withProps(p: CommentGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CommentGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
