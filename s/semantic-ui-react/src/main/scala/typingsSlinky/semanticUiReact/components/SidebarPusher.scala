...
object SidebarPusher {
  ...
  def withProps(p: SidebarPusherProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: SidebarPusher.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
