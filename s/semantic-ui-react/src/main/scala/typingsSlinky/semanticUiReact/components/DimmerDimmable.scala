...
object DimmerDimmable {
  ...
  def withProps(p: DimmerDimmableProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: DimmerDimmable.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
