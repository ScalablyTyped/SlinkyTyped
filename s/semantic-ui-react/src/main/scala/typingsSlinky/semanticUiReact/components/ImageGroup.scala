...
object ImageGroup {
  ...
  def withProps(p: ImageGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ImageGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
