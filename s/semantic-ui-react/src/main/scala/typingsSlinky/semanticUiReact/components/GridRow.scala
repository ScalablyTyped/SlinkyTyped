...
object GridRow {
  ...
  def withProps(p: GridRowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: GridRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
