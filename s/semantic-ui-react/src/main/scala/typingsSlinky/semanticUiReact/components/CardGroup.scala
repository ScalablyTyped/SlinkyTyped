...
object CardGroup {
  ...
  def withProps(p: CardGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CardGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
