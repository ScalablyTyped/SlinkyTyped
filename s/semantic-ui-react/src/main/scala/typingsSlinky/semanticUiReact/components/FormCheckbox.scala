...
object FormCheckbox {
  ...
  def withProps(p: FormCheckboxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FormCheckbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
