...
object FeedLike {
  ...
  def withProps(p: FeedLikeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FeedLike.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
