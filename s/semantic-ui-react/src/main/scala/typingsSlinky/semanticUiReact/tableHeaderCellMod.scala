...
import typingsSlinky.semanticUiReact.semanticUiReactStrings.ascending
import typingsSlinky.semanticUiReact.semanticUiReactStrings.descending
...
object tableHeaderCellMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[TableHeaderCellProps] = js.native
  ...
  type _To = ReactComponentClass[TableHeaderCellProps]
  
  /* This means you don't have to write `default`, but can instead just say `tableHeaderCellMod.foo` */
  override def _to: ReactComponentClass[TableHeaderCellProps] = default
}
