...
object menuMenuMod {
  ...
  object StrictMenuProps {
    ...
    implicit class StrictMenuPropsMutableBuilder[Self <: StrictMenuProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnItemClick(value: (/* event */ SyntheticMouseEvent[HTMLAnchorElement], /* data */ MenuItemProps) => Unit): Self = StObject.set(x, "onItemClick", js.Any.fromFunction2(value))
