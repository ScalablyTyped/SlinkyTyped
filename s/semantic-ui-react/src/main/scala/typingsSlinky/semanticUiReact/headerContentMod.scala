...
object headerContentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[HeaderContentProps] = js.native
  ...
  type _To = ReactComponentClass[HeaderContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `headerContentMod.foo` */
  override def _to: ReactComponentClass[HeaderContentProps] = default
}
