...
object StrictProgressProps {
  ...
  implicit class StrictProgressPropsOps[Self <: StrictProgressProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttached(value: top | bottom): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIndicating(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indicating")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIndicating: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indicating")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPercent(value: Double | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withProgress(value: Boolean | percent | ratio | value): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSize(value: tiny | small | medium | large | big): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTotal(value: Double | String): Self = {
        val ret = this.duplicate
