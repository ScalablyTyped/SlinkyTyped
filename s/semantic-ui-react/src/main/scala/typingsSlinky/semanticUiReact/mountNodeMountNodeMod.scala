...
object mountNodeMountNodeMod {
  ...
  object StrictMountNodeProps {
    ...
    implicit class StrictMountNodePropsMutableBuilder[Self <: StrictMountNodeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNodeHTMLElement(value: HTMLElement): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNodeNull: Self = StObject.set(x, "node", null)
      
      @scala.inline
      def setNodeRefObject(value: ReactRef[_]): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
