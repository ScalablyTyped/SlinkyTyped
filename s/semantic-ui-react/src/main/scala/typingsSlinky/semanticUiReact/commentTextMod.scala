...
object commentTextMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CommentTextProps] = js.native
  ...
  type _To = ReactComponentClass[CommentTextProps]
  
  /* This means you don't have to write `default`, but can instead just say `commentTextMod.foo` */
  override def _to: ReactComponentClass[CommentTextProps] = default
}
