...
object itemDescriptionMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ItemDescriptionProps] = js.native
  ...
  type _To = ReactComponentClass[ItemDescriptionProps]
  
  /* This means you don't have to write `default`, but can instead just say `itemDescriptionMod.foo` */
  override def _to: ReactComponentClass[ItemDescriptionProps] = default
}
