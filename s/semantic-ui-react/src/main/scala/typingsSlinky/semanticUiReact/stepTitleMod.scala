...
object stepTitleMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[StepTitleProps] = js.native
  ...
  type _To = ReactComponentClass[StepTitleProps]
  
  /* This means you don't have to write `default`, but can instead just say `stepTitleMod.foo` */
  override def _to: ReactComponentClass[StepTitleProps] = default
}
