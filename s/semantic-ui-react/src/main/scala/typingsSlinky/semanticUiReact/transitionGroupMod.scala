...
object transitionGroupMod extends Shortcut {
  ...
  @JSImport("semantic-ui-react/dist/commonjs/modules/Transition/TransitionGroup", JSImport.Default)
  @js.native
  val default: ReactComponentClass[TransitionGroupProps] = js.native
  ...
  type TransitionGroupComponent = ReactComponentClass[TransitionGroupProps]
  ...
  type _To = ReactComponentClass[TransitionGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `transitionGroupMod.foo` */
  override def _to: ReactComponentClass[TransitionGroupProps] = default
}
