...
object messageHeaderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[MessageHeaderProps] = js.native
  ...
  type _To = ReactComponentClass[MessageHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `messageHeaderMod.foo` */
  override def _to: ReactComponentClass[MessageHeaderProps] = default
}
