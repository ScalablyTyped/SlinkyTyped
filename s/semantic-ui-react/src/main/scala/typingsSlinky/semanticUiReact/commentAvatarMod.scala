...
object commentAvatarMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CommentAvatarProps] = js.native
  ...
  type _To = ReactComponentClass[CommentAvatarProps]
  
  /* This means you don't have to write `default`, but can instead just say `commentAvatarMod.foo` */
  override def _to: ReactComponentClass[CommentAvatarProps] = default
}
