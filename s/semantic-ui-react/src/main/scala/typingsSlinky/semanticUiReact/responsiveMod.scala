...
import typingsSlinky.semanticUiReact.responsiveResponsiveMod.ResponsiveWidthShorthand
...
object responsiveMod {
  ...
  @js.native
  class default ()
    extends typingsSlinky.semanticUiReact.responsiveResponsiveMod.default
  object default {
