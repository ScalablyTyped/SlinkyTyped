...
object placeholderHeaderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[PlaceholderHeaderProps] = js.native
  ...
  type _To = ReactComponentClass[PlaceholderHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `placeholderHeaderMod.foo` */
  override def _to: ReactComponentClass[PlaceholderHeaderProps] = default
}
