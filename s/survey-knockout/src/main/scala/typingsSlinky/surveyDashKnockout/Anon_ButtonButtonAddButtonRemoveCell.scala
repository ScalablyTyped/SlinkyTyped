...
trait Anon_ButtonButtonAddButtonRemoveCell extends js.Object {
  var button: String
...
object Anon_ButtonButtonAddButtonRemoveCell {
  @scala.inline
  def apply(
    button: String,
    buttonAdd: String,
    ...
    iconRemove: String,
    root: String
  ): Anon_ButtonButtonAddButtonRemoveCell = {
    ...
    __obj.asInstanceOf[Anon_ButtonButtonAddButtonRemoveCell]
  }
}
