...
import typingsSlinky.surveyDashKnockout.surveyDashKnockoutStrings.`survey-panel`
import typingsSlinky.surveyDashKnockout.surveyDashKnockoutStrings.`survey-question`
