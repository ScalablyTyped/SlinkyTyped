...
trait Anon_ClearButtonImageItem extends js.Object {
...
object Anon_ClearButtonImageItem {
  @scala.inline
  def apply(
    clearButton: String,
    image: String,
    ...
    __obj.asInstanceOf[Anon_ClearButtonImageItem]
  }
}
