...
@js.native
trait AnonItemDisabled extends js.Object {
...
object AnonItemDisabled {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonItemDisabled]
  }
  @scala.inline
  implicit class AnonItemDisabledOps[Self <: AnonItemDisabled] (val x: Self) extends AnyVal {
    @scala.inline
