...
object AnonButtonCollapsed {
  ...
  @scala.inline
  implicit class AnonButtonCollapsedOps[Self <: AnonButtonCollapsed] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withButtonCollapsed(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("buttonCollapsed")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withButtonExpanded(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("buttonExpanded")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
