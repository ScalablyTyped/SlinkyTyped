...
object AnonIcon {
  @scala.inline
  def apply(icon: String, item: String, locationBottom: String, locationTop: String, root: String): AnonIcon = {
  ...
  implicit class AnonIconOps[Self <: AnonIcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLocationBottom(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("locationBottom")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLocationTop(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("locationTop")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
