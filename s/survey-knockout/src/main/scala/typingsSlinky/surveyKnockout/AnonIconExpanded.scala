...
@js.native
trait AnonIconExpanded extends js.Object {
...
object AnonIconExpanded {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonIconExpanded]
  }
  @scala.inline
  implicit class AnonIconExpandedOps[Self <: AnonIconExpanded] (val x: Self) extends AnyVal {
    @scala.inline
