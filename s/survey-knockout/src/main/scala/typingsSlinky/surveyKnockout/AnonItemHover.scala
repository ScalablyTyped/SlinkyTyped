...
@js.native
trait AnonItemHover extends js.Object {
...
object AnonItemHover {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonItemHover]
  }
  @scala.inline
  implicit class AnonItemHoverOps[Self <: AnonItemHover] (val x: Self) extends AnyVal {
    @scala.inline
