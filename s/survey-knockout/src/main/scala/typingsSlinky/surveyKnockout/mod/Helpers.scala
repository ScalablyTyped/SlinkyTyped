...
object Helpers {
  ...
  @JSImport("survey-knockout", "Helpers.isCharDigit")
  @js.native
  def isCharDigit(ch: String): Boolean = js.native
  
  @JSImport("survey-knockout", "Helpers.isCharNotLetterAndDigit")
  @js.native
  def isCharNotLetterAndDigit(ch: String): Boolean = js.native
  
  @JSImport("survey-knockout", "Helpers.isConvertibleToNumber")
  @js.native
  def isConvertibleToNumber(value: js.Any): Boolean = js.native
  
  @JSImport("survey-knockout", "Helpers.isNumber")
  @js.native
  def isNumber(value: js.Any): Boolean = js.native
  
  @JSImport("survey-knockout", "Helpers.isTwoValueEquals")
  @js.native
  ...
  /**
    ...
    * @param value
    */
  @JSImport("survey-knockout", "Helpers.isValueEmpty")
  @js.native
  def isValueEmpty(value: js.Any): Boolean = js.native
  
  @JSImport("survey-knockout", "Helpers.randomizeArray")
  @js.native
