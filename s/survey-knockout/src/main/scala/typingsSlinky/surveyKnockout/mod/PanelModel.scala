...
- typingsSlinky.surveyKnockout.mod.ITitleOwner because var conflicts: isRequireTextAfterTitle, isRequireTextBeforeTitle, isRequireTextOnStart, locTitle, name, requiredText. Inlined no
- typingsSlinky.surveyKnockout.mod.IElement because var conflicts: containsErrors, isPage, isPanel, isReadOnly, isVisible, name, parent, visible. Inlined renderWidth, width, minWidth, maxWidth, rightIndent, startWithNewLine */ @JSImport("survey-knockout", "PanelModel")
@js.native
