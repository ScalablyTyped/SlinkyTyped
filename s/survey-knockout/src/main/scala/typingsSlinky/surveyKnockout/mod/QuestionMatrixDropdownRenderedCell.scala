...
@js.native
class QuestionMatrixDropdownRenderedCell () extends js.Object {
  ...
  val isCheckbox: Boolean = js.native
  ...
  val showErrorOnBottom: Boolean = js.native
  
  val showErrorOnTop: Boolean = js.native
