...
- typingsSlinky.surveyKnockout.mod.IPanel because Already inherited
- typingsSlinky.surveyKnockout.mod.IPage because var conflicts: containsErrors, elements, isPage, isPanel, isReadOnly, isVisible, name, parent. Inlined isStarted */ @JSImport("survey-knockout", "PageModel")
@js.native
