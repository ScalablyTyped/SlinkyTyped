...
package object SpotifyApi {
  ...
  /**
    ...
    */
  type ChangePlaylistDetailsReponse = typingsSlinky.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
  ...
  /**
    ...
    */
  type FollowPlaylistReponse = typingsSlinky.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
  ...
  /**
    ...
    */
  type UnfollowPlaylistReponse = typingsSlinky.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
    ...
    */
  type UploadCustomPlaylistCoverImageReponse = typingsSlinky.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
