...
object mod {
  ...
  trait ProducerMessageAttribute extends StObject {
    ...
    var DataType: typingsSlinky.sqsProducer.sqsProducerStrings.String | Binary = js.native
  ...
  object ProducerMessageAttribute {
    ...
    @scala.inline
    def apply(DataType: typingsSlinky.sqsProducer.sqsProducerStrings.String | Binary): ProducerMessageAttribute = {
    ...
    implicit class ProducerMessageAttributeMutableBuilder[Self <: ProducerMessageAttribute] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDataType(value: typingsSlinky.sqsProducer.sqsProducerStrings.String | Binary): Self = StObject.set(x, "DataType", value.asInstanceOf[js.Any])
