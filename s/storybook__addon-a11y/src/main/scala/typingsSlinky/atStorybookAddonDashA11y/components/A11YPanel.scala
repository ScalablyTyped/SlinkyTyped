...
import typingsSlinky.atStorybookAddonDashA11y.distComponentsA11YPanelMod.A11YPanelProps
...
object A11YPanel
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.atStorybookAddonDashA11y.distComponentsA11YPanelMod.A11YPanel
    ] {
  ...
  def apply(active: Boolean, api: API, _overrides: StringDictionary[js.Any] = null): BuildingComponent[
    tag.type, 
    typingsSlinky.atStorybookAddonDashA11y.distComponentsA11YPanelMod.A11YPanel
  ] = {
