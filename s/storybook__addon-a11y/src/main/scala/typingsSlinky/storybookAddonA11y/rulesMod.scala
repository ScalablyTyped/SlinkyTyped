...
object rulesMod {
  ...
  object ImpactValue extends StObject {
    ...
    /* "critical" */ val CRITICAL: typingsSlinky.storybookAddonA11y.rulesMod.ImpactValue.CRITICAL with String = js.native
    
    @js.native
    sealed trait MINOR extends ImpactValue
    /* "minor" */ val MINOR: typingsSlinky.storybookAddonA11y.rulesMod.ImpactValue.MINOR with String = js.native
    
    @js.native
    sealed trait MODERATE extends ImpactValue
    /* "moderate" */ val MODERATE: typingsSlinky.storybookAddonA11y.rulesMod.ImpactValue.MODERATE with String = js.native
    
    @js.native
    sealed trait SERIOUS extends ImpactValue
    /* "serious" */ val SERIOUS: typingsSlinky.storybookAddonA11y.rulesMod.ImpactValue.SERIOUS with String = js.native
  }
  
  @JSImport("@storybook/addon-a11y/dist/components/Report/Rules", "Rules")
  @js.native
  val Rules: ReactComponentClass[RulesProps] = js.native
