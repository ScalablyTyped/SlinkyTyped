...
object constantsMod {
  ...
  @JSImport("@storybook/addon-a11y/dist/constants", "ADDON_ID")
  @js.native
  val ADDON_ID: /* "storybook/a11y" */ String = js.native
  
  object EVENTS {
    
    @JSImport("@storybook/addon-a11y/dist/constants", "EVENTS")
    @js.native
  ...
  @JSImport("@storybook/addon-a11y/dist/constants", "PANEL_ID")
  @js.native
  val PANEL_ID: String = js.native
  
  @JSImport("@storybook/addon-a11y/dist/constants", "PARAM_KEY")
  @js.native
