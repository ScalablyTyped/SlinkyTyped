...
object PartialPickImplkeyofImpl {
  ...
  def apply(
    ...
    if (!js.isUndefined(alwaysRefresh)) __obj.updateDynamic("alwaysRefresh")(alwaysRefresh.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(ignoreFirstLoad)) __obj.updateDynamic("ignoreFirstLoad")(ignoreFirstLoad.get.asInstanceOf[js.Any])
