...
package object Tab {
  ...
  type ClassNameSettings = typingsSlinky.semanticUiTab.SemanticUI.Tab.ClassNameSettings.Param
  ...
  type TemplatesSettings = typingsSlinky.semanticUiTab.SemanticUI.Tab.TemplatesSettings_
}
