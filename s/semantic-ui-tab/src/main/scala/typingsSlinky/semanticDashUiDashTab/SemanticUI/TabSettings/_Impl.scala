package typingsSlinky.semanticDashUiDashTab.SemanticUI.TabSettings

import typingsSlinky.semanticDashUiDashApi.SemanticUI.ApiSettings
import typingsSlinky.semanticDashUiDashTab.JQuery
import typingsSlinky.semanticDashUiDashTab.SemanticUI.Tab.ClassNameSettings
import typingsSlinky.semanticDashUiDashTab.SemanticUI.Tab.ErrorSettings
import typingsSlinky.semanticDashUiDashTab.SemanticUI.Tab.MetadataSettings
import typingsSlinky.semanticDashUiDashTab.SemanticUI.Tab.SelectorSettings
import typingsSlinky.semanticDashUiDashTab.SemanticUI.Tab.TemplatesSettings
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabBooleans.`false`
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabStrings.DOM
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabStrings.all
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabStrings.hash
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabStrings.html
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabStrings.once
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabStrings.response
import typingsSlinky.semanticDashUiDashTab.semanticDashUiDashTabStrings.siblings
