...
import typingsSlinky.apidevtoolsSwaggerParser.mod.ApiCallback
import typingsSlinky.apidevtoolsSwaggerParser.mod.Options
import typingsSlinky.apidevtoolsSwaggerParser.mod.RefsCallback
...
object mod {
  ...
  @js.native
  class ^ ()
    extends typingsSlinky.apidevtoolsSwaggerParser.mod.^
  
  @JSImport("swagger-parser", "$Refs")
  @js.native
  class Refs ()
    extends typingsSlinky.apidevtoolsSwaggerParser.mod.Refs
  
  /* static member */
  @JSImport("swagger-parser", "bundle")
  @js.native
  ...
  /* static member */
  @JSImport("swagger-parser", "dereference")
  @js.native
  ...
  /* static member */
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(api: String): js.Promise[typingsSlinky.apidevtoolsSwaggerParser.mod.Refs] = js.native
  /**
    * *This method is used internally by other methods, such as `bundle` and `dereference`. You probably won't need to call this method yourself.*
    *
  ...
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(api: String, options: Options): js.Promise[typingsSlinky.apidevtoolsSwaggerParser.mod.Refs] = js.native
  /* static member */
  @JSImport("swagger-parser", "resolve")
  @js.native
  ...
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(api: Document): js.Promise[typingsSlinky.apidevtoolsSwaggerParser.mod.Refs] = js.native
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(api: Document, callback: RefsCallback): Unit = js.native
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(api: Document, options: Options): js.Promise[typingsSlinky.apidevtoolsSwaggerParser.mod.Refs] = js.native
  @JSImport("swagger-parser", "resolve")
  @js.native
  ...
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(baseUrl: String, api: String, options: Options): js.Promise[typingsSlinky.apidevtoolsSwaggerParser.mod.Refs] = js.native
  /* static member */
  @JSImport("swagger-parser", "resolve")
  @js.native
  ...
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(baseUrl: String, api: Document, options: Options): js.Promise[typingsSlinky.apidevtoolsSwaggerParser.mod.Refs] = js.native
  @JSImport("swagger-parser", "resolve")
  @js.native
  def resolve(baseUrl: String, api: Document, options: Options, callback: RefsCallback): Unit = js.native
  
  /* static member */
  @JSImport("swagger-parser", "validate")
  @js.native
