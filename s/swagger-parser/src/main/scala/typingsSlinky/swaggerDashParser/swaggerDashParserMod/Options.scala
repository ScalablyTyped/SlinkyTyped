package typingsSlinky.swaggerDashParser.swaggerDashParserMod

import typingsSlinky.swaggerDashParser.Anon_Circular
import typingsSlinky.swaggerDashParser.Anon_External
import typingsSlinky.swaggerDashParser.Anon_Json
import typingsSlinky.swaggerDashParser.Anon_Schema
...
trait Options extends js.Object {
  ...
  /**
    ...
    */
  var validate: js.UndefOr[Anon_Schema] = js.undefined
}

object Options {
  @scala.inline
  def apply(
    dereference: Anon_Circular = null,
    parse: Anon_Json = null,
    resolve: Anon_External = null,
