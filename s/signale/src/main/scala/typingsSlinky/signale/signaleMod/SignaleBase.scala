...
import typingsSlinky.signale.Anon_Label
...
trait SignaleBase[TTypes /* <: String */] extends js.Object {
  ...
  /**
    ...
    */
  def timeEnd(): Anon_Label = js.native
  def timeEnd(label: String): Anon_Label = js.native
  def timeEnd(label: String, span: Double): Anon_Label = js.native
