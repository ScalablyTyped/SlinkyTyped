...
import typingsSlinky.signale.AnonLabel
import typingsSlinky.signale.SignaleDefaultMethodsAwait
...
object ^ extends js.Object {
  var DefaultMethods: typingsSlinky.signale.mod.DefaultMethods = js.native
  var Signale: SignaleConstructor = js.native
  var SignaleConfig: typingsSlinky.signale.mod.SignaleConfig = js.native
  var SignaleOptions: typingsSlinky.signale.mod.SignaleOptions[DefaultMethods] = js.native
  @JSName("await")
