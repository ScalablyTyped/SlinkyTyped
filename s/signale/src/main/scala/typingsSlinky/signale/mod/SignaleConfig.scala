...
object SignaleConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(displayBadge)) __obj.updateDynamic("displayBadge")(displayBadge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(displayDate)) __obj.updateDynamic("displayDate")(displayDate.get.asInstanceOf[js.Any])
    if (!js.isUndefined(displayFilename)) __obj.updateDynamic("displayFilename")(displayFilename.get.asInstanceOf[js.Any])
    if (!js.isUndefined(displayLabel)) __obj.updateDynamic("displayLabel")(displayLabel.get.asInstanceOf[js.Any])
    if (!js.isUndefined(displayScope)) __obj.updateDynamic("displayScope")(displayScope.get.asInstanceOf[js.Any])
    if (!js.isUndefined(displayTimestamp)) __obj.updateDynamic("displayTimestamp")(displayTimestamp.get.asInstanceOf[js.Any])
    if (!js.isUndefined(underlineLabel)) __obj.updateDynamic("underlineLabel")(underlineLabel.get.asInstanceOf[js.Any])
    if (!js.isUndefined(underlineMessage)) __obj.updateDynamic("underlineMessage")(underlineMessage.get.asInstanceOf[js.Any])
    if (!js.isUndefined(underlinePrefix)) __obj.updateDynamic("underlinePrefix")(underlinePrefix.get.asInstanceOf[js.Any])
    if (!js.isUndefined(underlineSuffix)) __obj.updateDynamic("underlineSuffix")(underlineSuffix.get.asInstanceOf[js.Any])
    if (!js.isUndefined(uppercaseLabel)) __obj.updateDynamic("uppercaseLabel")(uppercaseLabel.get.asInstanceOf[js.Any])
