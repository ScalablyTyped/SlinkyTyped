...
object mod {
  ...
  object EChatEntryType extends StObject {
    ...
    /* 0 */ val ChatMsg: typingsSlinky.steam.mod.EChatEntryType.ChatMsg with Double = js.native
  }
  ...
  object EChatMemberStateChange extends StObject {
    ...
    /* 0 */ val Kicked: typingsSlinky.steam.mod.EChatMemberStateChange.Kicked with Double = js.native
  }
  ...
  object EPersonaState extends StObject {
    ...
    /* 0 */ val Online: typingsSlinky.steam.mod.EPersonaState.Online with Double = js.native
  }
  ...
  object EResult extends StObject {
    ...
    /* 0 */ val AccountLogonDenied: typingsSlinky.steam.mod.EResult.AccountLogonDenied with Double = js.native
  }
