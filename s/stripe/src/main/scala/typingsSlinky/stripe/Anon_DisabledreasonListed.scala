...
trait Anon_DisabledreasonListed extends js.Object {
  /**
...
object Anon_DisabledreasonListed {
  @scala.inline
  def apply(disabled_reason: listed | rejectedDotlisted | under_review, past_due: js.Array[String]): Anon_DisabledreasonListed = {
    val __obj = js.Dynamic.literal(disabled_reason = disabled_reason.asInstanceOf[js.Any], past_due = past_due.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Anon_DisabledreasonListed]
  }
}
