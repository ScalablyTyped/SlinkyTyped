...
trait AnonMcc extends js.Object {
  ...
  /**
    ...
    */
  var support_address: js.UndefOr[AnonCity] = js.native
  /**
...
object AnonMcc {
  ...
  @scala.inline
  implicit class AnonMccOps[Self <: AnonMcc] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSupport_address(value: AnonCity): Self = {
        val ret = this.duplicate
