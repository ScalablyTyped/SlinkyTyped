...
@js.native
trait AnonAdditionaldocument extends js.Object {
  /**
...
object AnonAdditionaldocument {
  ...
  @scala.inline
  implicit class AnonAdditionaldocumentOps[Self <: AnonAdditionaldocument] (val x: Self) extends AnyVal {
    @scala.inline
