...
object AnonAccountholdername {
  @scala.inline
  def apply(account_number: String, country: String, currency: String, `object`: String): AnonAccountholdername = {
  ...
  @scala.inline
  implicit class AnonAccountholdernameOps[Self <: AnonAccountholdername] (val x: Self) extends AnyVal {
    @scala.inline
