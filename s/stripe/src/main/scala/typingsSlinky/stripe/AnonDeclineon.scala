...
trait AnonDeclineon extends js.Object {
  /**
    ...
    */
  var decline_on: js.UndefOr[AnonAvsfailure] = js.native
  /**
...
object AnonDeclineon {
  @scala.inline
  def apply(): AnonDeclineon = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDeclineon]
  }
  @scala.inline
  implicit class AnonDeclineonOps[Self <: AnonDeclineon] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDecline_on(value: AnonAvsfailure): Self = {
