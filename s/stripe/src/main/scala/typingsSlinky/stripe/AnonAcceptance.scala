...
trait AnonAcceptance extends js.Object {
  var acceptance: js.UndefOr[AnonOffline] = js.native
...
object AnonAcceptance {
  @scala.inline
  def apply(): AnonAcceptance = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAcceptance]
  }
  @scala.inline
  implicit class AnonAcceptanceOps[Self <: AnonAcceptance] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAcceptance(value: AnonOffline): Self = {
