...
import typingsSlinky.stripe.stripeMod.issuing.disputes.IIssuingDisputeCreateOptions
import typingsSlinky.stripe.stripeMod.issuing.disputes.IIssuingDisputeListOptions
import typingsSlinky.stripe.stripeMod.issuing.disputes.IIssuingDisputeUpdateOptions
