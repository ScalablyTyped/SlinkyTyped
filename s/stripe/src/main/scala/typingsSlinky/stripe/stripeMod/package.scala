...
package object stripeMod {
  ...
  import typingsSlinky.stripe.Anon_Gt
  ...
  // Helper
  type IBankAccount = typingsSlinky.stripe.stripeMod.bankAccounts.IBankAccount
  type ICard = typingsSlinky.stripe.stripeMod.cards.ICard
  /**
  ...
  type ISource = typingsSlinky.stripe.stripeMod.sources.ISource
}
