...
import typingsSlinky.stripe.stripeMod.transfers.ITransferCreationOptions
import typingsSlinky.stripe.stripeMod.transfers.ITransferListOptions
import typingsSlinky.stripe.stripeMod.transfers.ITransferUpdateOptions
