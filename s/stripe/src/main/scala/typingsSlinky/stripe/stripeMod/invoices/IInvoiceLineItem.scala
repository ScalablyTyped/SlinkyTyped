package typingsSlinky.stripe.stripeMod.invoices

import typingsSlinky.stripe.stripeMod.IMetadata
import typingsSlinky.stripe.stripeMod.IResourceObject
import typingsSlinky.stripe.stripeMod.plans.IPlan
import typingsSlinky.stripe.stripeMod.taxRates.ITaxAmount
