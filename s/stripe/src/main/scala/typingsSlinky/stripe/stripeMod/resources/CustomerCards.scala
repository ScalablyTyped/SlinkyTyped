...
class CustomerCards () extends StripeResource {
  def create(data: Anon_Card): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    */
  def create(data: Anon_Card, options: HeaderOptions): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def create(
    data: Anon_Card,
  ...
  def create(data: Anon_Card, response: IResponseFn[typingsSlinky.stripe.stripeMod.cards.ICard]): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  ...
  def list(): IListPromise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def list(data: IListOptions): IListPromise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    */
  def list(data: IListOptions, options: HeaderOptions): IListPromise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def list(
    data: IListOptions,
    options: HeaderOptions,
  ...
  def list(data: IListOptions, response: IResponseFn[IList[typingsSlinky.stripe.stripeMod.cards.ICard]]): IListPromise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def list(options: HeaderOptions): IListPromise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def list(options: HeaderOptions, response: IResponseFn[IList[typingsSlinky.stripe.stripeMod.cards.ICard]]): IListPromise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def list(response: IResponseFn[IList[typingsSlinky.stripe.stripeMod.cards.ICard]]): IListPromise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def retrieve(cardId: String): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    * @param cardId The ID of the card to be retrieved.
    */
  def retrieve(cardId: String, options: HeaderOptions): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def retrieve(
    cardId: String,
    options: HeaderOptions,
    response: IResponseFn[typingsSlinky.stripe.stripeMod.cards.ICard]
  ): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def retrieve(cardId: String, response: IResponseFn[typingsSlinky.stripe.stripeMod.cards.ICard]): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def update(cardId: String, data: ICardUpdateOptions): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    * @param cardId The ID of the card to be retrieved.
    */
  def update(cardId: String, data: ICardUpdateOptions, options: HeaderOptions): js.Promise[typingsSlinky.stripe.stripeMod.cards.ICard] = js.native
  def update(
    cardId: String,
