package typingsSlinky.stripe.stripeMod.customers
...
import typingsSlinky.stripe.stripeMod.coupons.IDiscount
import typingsSlinky.stripe.stripeMod.customerTaxIds.ITaxId
import typingsSlinky.stripe.stripeMod.resources.CustomerCards
