...
object Director {
  ...
  def apply(
    ...
    percent_ownership: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(percent_ownership)) __obj.updateDynamic("percent_ownership")(percent_ownership.get.asInstanceOf[js.Any])
