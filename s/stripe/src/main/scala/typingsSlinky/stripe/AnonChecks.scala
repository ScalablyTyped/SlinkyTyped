...
trait AnonChecks extends js.Object {
  ...
  var generated_from: Null | AnonCharge = js.native
  /** The last four digits of the card. */
  var last4: String = js.native
  /** Contains details on how this Card may be be used for 3D Secure authentication. */
  var three_d_secure_usage: AnonSupported = js.native
...
object AnonChecks {
  ...
  @scala.inline
  implicit class AnonChecksOps[Self <: AnonChecks] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withGenerated_fromNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("generated_from")(null)
        ret
    }
    @scala.inline
