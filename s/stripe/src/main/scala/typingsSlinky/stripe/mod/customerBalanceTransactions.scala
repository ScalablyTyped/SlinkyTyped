...
object customerBalanceTransactions {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.stripe.stripeStrings.adjustment
    - typingsSlinky.stripe.stripeStrings.applied_to_invoice
    - typingsSlinky.stripe.stripeStrings.credit_note
    - typingsSlinky.stripe.stripeStrings.initial
    - typingsSlinky.stripe.stripeStrings.invoice_too_large
    - typingsSlinky.stripe.stripeStrings.invoice_too_small
    - typingsSlinky.stripe.stripeStrings.unspent_receiver_credit
  */
