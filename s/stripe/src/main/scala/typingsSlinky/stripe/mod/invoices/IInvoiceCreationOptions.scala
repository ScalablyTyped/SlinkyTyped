...
object IInvoiceCreationOptions {
  ...
  implicit class IInvoiceCreationOptionsOps[Self <: IInvoiceCreationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDue_dateDate(value: js.Date): Self = this.set("due_date", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDue_date(value: js.Date | Double): Self = this.set("due_date", value.asInstanceOf[js.Any])
