...
object IPaymentMethodListOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.stripe.mod.paymentMethods.IPaymentMethodType */ T](customer: String, `type`: T): IPaymentMethodListOptions[T] = {
  ...
  @scala.inline
  implicit class IPaymentMethodListOptionsOps[Self <: IPaymentMethodListOptions[_], /* <: typingsSlinky.stripe.mod.paymentMethods.IPaymentMethodType */ T] (val x: Self with IPaymentMethodListOptions[T]) extends AnyVal {
    @scala.inline
