...
object IProduct {
  ...
  implicit class IProductOps[Self <: IProduct] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeactivated_on(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deactivated_on")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withObject(value: product): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSkus(value: IList[ISku]): Self = {
        val ret = this.duplicate
