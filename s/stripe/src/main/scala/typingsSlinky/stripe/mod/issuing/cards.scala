...
import typingsSlinky.stripe.mod.issuing.cardholders.ICardholderAuthorizationControls
import typingsSlinky.stripe.mod.issuing.cardholders.ICardholderBillingAddress
import typingsSlinky.stripe.mod.issuing.cardholders.ISpendingLimit
...
object cards {
  ...
  */
  ...
  object IssuingCardReplacementReason {
    ...
    @scala.inline
    def damage: typingsSlinky.stripe.stripeStrings.damage = "damage".asInstanceOf[typingsSlinky.stripe.stripeStrings.damage]
    
    @scala.inline
    def expiration: typingsSlinky.stripe.stripeStrings.expiration = "expiration".asInstanceOf[typingsSlinky.stripe.stripeStrings.expiration]
    
    @scala.inline
    def loss: typingsSlinky.stripe.stripeStrings.loss = "loss".asInstanceOf[typingsSlinky.stripe.stripeStrings.loss]
    
    @scala.inline
    def theft: typingsSlinky.stripe.stripeStrings.theft = "theft".asInstanceOf[typingsSlinky.stripe.stripeStrings.theft]
  }
  ...
  */
  ...
  object IssuingCardStatus {
    ...
    @scala.inline
    def stolen: typingsSlinky.stripe.stripeStrings.stolen = "stolen".asInstanceOf[typingsSlinky.stripe.stripeStrings.stolen]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.stripe.stripeStrings.virtual
    - typingsSlinky.stripe.stripeStrings.physical
  */
