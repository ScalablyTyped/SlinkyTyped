...
object bankAccounts {
  ...
  object IBankAccount {
    ...
    def apply(
      ...
      __obj.asInstanceOf[typingsSlinky.stripe.mod.bankAccounts.IBankAccount]
    }
    
    @scala.inline
    implicit class IBankAccountMutableBuilder[Self <: typingsSlinky.stripe.mod.bankAccounts.IBankAccount] (val x: Self) extends AnyVal {
