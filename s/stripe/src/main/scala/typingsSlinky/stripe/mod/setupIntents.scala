...
object setupIntents {
  ...
  trait ISetupIntentTransferData extends StObject {
    ...
    /**
      ...
      */
    var destination: String | typingsSlinky.stripe.mod.bankAccounts.IBankAccount | ICardHash | IAccountCreationOptions = js.native
  }
  object ISetupIntentTransferData {
    
    @scala.inline
    def apply(
      destination: String | typingsSlinky.stripe.mod.bankAccounts.IBankAccount | ICardHash | IAccountCreationOptions
    ...
    implicit class ISetupIntentTransferDataMutableBuilder[Self <: ISetupIntentTransferData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDestination(
        value: String | typingsSlinky.stripe.mod.bankAccounts.IBankAccount | ICardHash | IAccountCreationOptions
