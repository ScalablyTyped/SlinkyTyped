...
object IBitcoinReceiverCreationOptions {
  ...
  implicit class IBitcoinReceiverCreationOptionsOps[Self <: IBitcoinReceiverCreationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRefund_mispayments(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("refund_mispayments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRefund_mispayments: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("refund_mispayments")(js.undefined)
        ret
    }
  }
