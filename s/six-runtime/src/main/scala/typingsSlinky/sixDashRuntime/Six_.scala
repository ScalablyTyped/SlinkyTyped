...
import typingsSlinky.sixDashRuntime.Six.PluginsMap
import typingsSlinky.sixDashRuntime.Six.plugins.rpc
import typingsSlinky.sixDashRuntime.Six.plugins.time.timmer
import typingsSlinky.sixDashRuntime.Six.plugins.view.render
import typingsSlinky.sixDashRuntime.Six.plugins.view.runtimeConf
...
trait Six_ extends js.Object {
  /**
    ...
    */
  var DataProvider: typingsSlinky.sixDashRuntime.Six.plugins.dataProvider.DataProvider = js.native
  /**
    * NODE_ENV的缩短版
    *
  ...
  /**
    ...
    */
  var http: typingsSlinky.sixDashRuntime.Six.plugins.http = js.native
  /**
    * 打日志方法
    */
  var log: typingsSlinky.sixDashRuntime.Six.plugins.log = js.native
  /**
    * Six的plugin的map
    */
