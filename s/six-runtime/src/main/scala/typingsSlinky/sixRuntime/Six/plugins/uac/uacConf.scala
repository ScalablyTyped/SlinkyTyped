...
object uacConf {
  ...
  implicit class uacConfOps[Self <: uacConf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFailHook(value: (js.Error, js.Object, next) => js.Any): Self = this.set("failHook", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setWhiteList(value: String | js.RegExp | js.Array[String] | whiteList): Self = this.set("whiteList", value.asInstanceOf[js.Any])
  }
}
