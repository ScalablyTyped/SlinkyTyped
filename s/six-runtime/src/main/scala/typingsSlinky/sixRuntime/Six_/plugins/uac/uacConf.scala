package typingsSlinky.sixRuntime.Six_.plugins.uac

import typingsSlinky.sixRuntime.Six_.next
...
trait uacConf extends js.Object {
  ...
  var whiteList: String | js.RegExp | js.Array[String] | typingsSlinky.sixRuntime.Six_.plugins.whiteList = js.native
