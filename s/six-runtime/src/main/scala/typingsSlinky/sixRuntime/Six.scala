...
import typingsSlinky.sixRuntime.Six.PluginsMap
import typingsSlinky.sixRuntime.Six.plugins.rpc
...
import typingsSlinky.sixRuntime.Six.plugins.time.timmer
...
import typingsSlinky.sixRuntime.Six.plugins.view.render
import typingsSlinky.sixRuntime.Six.plugins.view.runtimeConf
...
trait Six extends StObject {
  ...
  /**
    ...
    */
  var DataProvider: typingsSlinky.sixRuntime.Six.plugins.dataProvider.DataProvider = js.native
  ...
  /**
    ...
    */
  var http: typingsSlinky.sixRuntime.Six.plugins.http = js.native
  
  /**
    * 打日志方法
    */
  var log: typingsSlinky.sixRuntime.Six.plugins.log = js.native
    ...
    object sso {
      ...
      object ssoClientConf {
        ...
        implicit class ssoClientConfMutableBuilder[Self <: ssoClientConf] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setErrorHook(value: js.Error => Unit): Self = StObject.set(x, "errorHook", js.Any.fromFunction1(value))
      ...
      object ssoConf {
        ...
        implicit class ssoConfMutableBuilder[Self <: ssoConf] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setWhiteList(value: String | js.RegExp | js.Array[String] | whiteList): Self = StObject.set(x, "whiteList", value.asInstanceOf[js.Any])
    ...
    object uac {
      ...
      object uacConf {
        ...
        implicit class uacConfMutableBuilder[Self <: uacConf] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setFailHook(value: (js.Error, js.Object, next) => js.Any): Self = StObject.set(x, "failHook", js.Any.fromFunction3(value))
