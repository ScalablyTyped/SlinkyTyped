...
import typingsSlinky.sixRuntime.Six_.PluginsMap
import typingsSlinky.sixRuntime.Six_.plugins.rpc
import typingsSlinky.sixRuntime.Six_.plugins.time.timmer
import typingsSlinky.sixRuntime.Six_.plugins.view.render
import typingsSlinky.sixRuntime.Six_.plugins.view.runtimeConf
...
trait Six__ extends js.Object {
  /**
    ...
    */
  var DataProvider: typingsSlinky.sixRuntime.Six_.plugins.dataProvider.DataProvider = js.native
  /**
    * NODE_ENV的缩短版
    *
  ...
  /**
    ...
    */
  var http: typingsSlinky.sixRuntime.Six_.plugins.http = js.native
  /**
    * 打日志方法
    */
  var log: typingsSlinky.sixRuntime.Six_.plugins.log = js.native
  /**
    * Six的plugin的map
    */
