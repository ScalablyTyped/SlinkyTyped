...
package object slonikMod {
  ...
  import typingsSlinky.slonik.Anon_Connect
  import typingsSlinky.slonik.Anon_Database
  import typingsSlinky.slonik.Anon_Handler
  import typingsSlinky.slonik.Anon_HandlerSql
