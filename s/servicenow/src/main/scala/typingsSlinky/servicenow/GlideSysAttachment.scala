...
class GlideSysAttachment () extends js.Object {
  ...
  def getContent(record: typingsSlinky.servicenow.servicenow.GlideRecord): js.Any = js.native
  def getContentBase64(record: typingsSlinky.servicenow.servicenow.GlideRecord): String = js.native
