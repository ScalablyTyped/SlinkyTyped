...
trait GlideSystem extends js.Object {
  ...
  def eventQueue(
    eventName: String,
    gr: typingsSlinky.servicenow.servicenow.GlideRecord,
  ...
  def eventQueueScheduled(
    name: String,
    instance: typingsSlinky.servicenow.servicenow.GlideRecord,
    parm1: String,
    parm2: String,
    expiration: js.Object
  ): Unit = js.native
  def executeNow(job: typingsSlinky.servicenow.servicenow.GlideRecord): String = js.native
