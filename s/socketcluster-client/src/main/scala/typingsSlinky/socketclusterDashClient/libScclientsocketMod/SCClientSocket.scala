...
import typingsSlinky.scDashChannel.scDashChannelMod.SCChannel
import typingsSlinky.scDashChannel.scDashChannelMod.SCChannelOptions
import typingsSlinky.scDashErrors.scDashErrorsMod.SocketProtocolErrorStatuses
import typingsSlinky.scDashErrors.scDashErrorsMod.SocketProtocolIgnoreStatuses
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.authStateChange
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.authenticate
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.authenticated
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.close
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.closed
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.connect
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.connectAbort
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.connecting
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.deauthenticate
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.disconnect
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.error
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.kickOut
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.message
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.open
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.pending
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.raw
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.removeAuthToken
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.subscribe
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.subscribeFail
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.subscribeRequest
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.subscribeStateChange
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.unauthenticated
import typingsSlinky.socketclusterDashClient.socketclusterDashClientStrings.unsubscribe
...
trait SCClientSocket extends Emitter {
  ...
  def authenticate(
    ...
    callback: js.Function2[/* err */ js.Error, /* authStatus */ AuthStatus, Unit]
  ): Unit = js.native
  ...
  def deauthenticate(callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  ...
  def emit(
    event: String,
    data: js.Any,
    callback: js.Function2[/* err */ js.Error, /* responseData */ js.Any, Unit]
  ): Unit = js.native
  ...
  def publish(
    channelName: String,
    data: js.Any,
    callback: js.Function2[/* err */ js.Error, /* ackData */ js.Any, Unit]
  ): Unit = js.native
