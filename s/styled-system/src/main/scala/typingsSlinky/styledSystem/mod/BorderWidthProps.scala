...
object BorderWidthProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): BorderWidthProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BorderWidthProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class BorderWidthPropsOps[Self <: BorderWidthProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (BorderWidthProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
