...
object LineHeightProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): LineHeightProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LineHeightProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class LineHeightPropsOps[Self <: LineHeightProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (LineHeightProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
