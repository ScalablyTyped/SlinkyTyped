...
object MarginBottomProps {
  ...
  @scala.inline
  implicit class MarginBottomPropsOps[Self <: MarginBottomProps[_], ThemeType /* <: Theme[TLengthStyledSystem] */] (val x: Self with MarginBottomProps[ThemeType]) extends AnyVal {
