...
object BorderRightProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): BorderRightProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BorderRightProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class BorderRightPropsOps[Self <: BorderRightProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (BorderRightProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
