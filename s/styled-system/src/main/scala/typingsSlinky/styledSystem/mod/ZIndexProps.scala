...
object ZIndexProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): ZIndexProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZIndexProps[ThemeType]]
  }
  @scala.inline
  implicit class ZIndexPropsOps[Self <: ZIndexProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with ZIndexProps[ThemeType]) extends AnyVal {
    @scala.inline
