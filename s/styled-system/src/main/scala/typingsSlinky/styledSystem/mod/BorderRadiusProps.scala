...
object BorderRadiusProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): BorderRadiusProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BorderRadiusProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class BorderRadiusPropsOps[Self <: BorderRadiusProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (BorderRadiusProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
