...
object BorderRadiusProps {
  ...
  @scala.inline
  implicit class BorderRadiusPropsOps[Self <: BorderRadiusProps[_, _], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self with (BorderRadiusProps[ThemeType, TVal])) extends AnyVal {
