...
object SpaceProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): SpaceProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SpaceProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class SpacePropsOps[Self <: SpaceProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (SpaceProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
