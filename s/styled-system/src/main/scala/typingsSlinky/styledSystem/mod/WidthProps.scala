...
object WidthProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): WidthProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WidthProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class WidthPropsOps[Self <: WidthProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (WidthProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
