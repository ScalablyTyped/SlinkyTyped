...
object GridAutoRowsProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): GridAutoRowsProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridAutoRowsProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class GridAutoRowsPropsOps[Self <: GridAutoRowsProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (GridAutoRowsProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
