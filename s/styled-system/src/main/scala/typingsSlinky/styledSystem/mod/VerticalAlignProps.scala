...
object VerticalAlignProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): VerticalAlignProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VerticalAlignProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class VerticalAlignPropsOps[Self <: VerticalAlignProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (VerticalAlignProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
