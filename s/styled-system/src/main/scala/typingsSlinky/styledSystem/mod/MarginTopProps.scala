...
object MarginTopProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): MarginTopProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MarginTopProps[ThemeType]]
  }
  @scala.inline
  implicit class MarginTopPropsOps[Self <: MarginTopProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with MarginTopProps[ThemeType]) extends AnyVal {
    @scala.inline
