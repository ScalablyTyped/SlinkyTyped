...
object ColorStyleProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): ColorStyleProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorStyleProps[ThemeType]]
  }
  @scala.inline
  implicit class ColorStylePropsOps[Self <: ColorStyleProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with ColorStyleProps[ThemeType]) extends AnyVal {
    @scala.inline
