...
object GridAutoColumnsProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): GridAutoColumnsProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridAutoColumnsProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class GridAutoColumnsPropsOps[Self <: GridAutoColumnsProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (GridAutoColumnsProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
