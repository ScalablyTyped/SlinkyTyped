...
object PositionProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): PositionProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PositionProps[ThemeType]]
  }
  @scala.inline
  implicit class PositionPropsOps[Self <: PositionProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with PositionProps[ThemeType]) extends AnyVal {
    @scala.inline
