...
object MinHeightProps {
  ...
  @scala.inline
  implicit class MinHeightPropsOps[Self <: MinHeightProps[_, _], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self with (MinHeightProps[ThemeType, TVal])) extends AnyVal {
