...
object BackgroundPositionProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): BackgroundPositionProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackgroundPositionProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class BackgroundPositionPropsOps[Self <: BackgroundPositionProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (BackgroundPositionProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
