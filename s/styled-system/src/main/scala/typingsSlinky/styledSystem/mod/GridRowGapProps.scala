...
object GridRowGapProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): GridRowGapProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridRowGapProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class GridRowGapPropsOps[Self <: GridRowGapProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (GridRowGapProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
