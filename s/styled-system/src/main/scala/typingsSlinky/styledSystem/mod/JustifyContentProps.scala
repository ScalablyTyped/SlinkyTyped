...
object JustifyContentProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): JustifyContentProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[JustifyContentProps[ThemeType]]
  }
  @scala.inline
  implicit class JustifyContentPropsOps[Self <: JustifyContentProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with JustifyContentProps[ThemeType]) extends AnyVal {
    @scala.inline
