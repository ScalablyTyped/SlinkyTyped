...
object JustifyContentProps {
  ...
  @scala.inline
  implicit class JustifyContentPropsOps[Self <: JustifyContentProps[_], ThemeType /* <: Theme[TLengthStyledSystem] */] (val x: Self with JustifyContentProps[ThemeType]) extends AnyVal {
