...
object FontWeightProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): FontWeightProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FontWeightProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class FontWeightPropsOps[Self <: FontWeightProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (FontWeightProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
