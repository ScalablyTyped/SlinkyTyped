...
object MinWidthProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): MinWidthProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MinWidthProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class MinWidthPropsOps[Self <: MinWidthProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (MinWidthProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
