...
object PaddingBottomProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): PaddingBottomProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PaddingBottomProps[ThemeType]]
  }
  @scala.inline
  implicit class PaddingBottomPropsOps[Self <: PaddingBottomProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with PaddingBottomProps[ThemeType]) extends AnyVal {
    @scala.inline
