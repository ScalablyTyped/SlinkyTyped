...
object BorderColorProps {
  ...
  @scala.inline
  implicit class BorderColorPropsOps[Self <: BorderColorProps[_, _], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self with (BorderColorProps[ThemeType, TVal])) extends AnyVal {
