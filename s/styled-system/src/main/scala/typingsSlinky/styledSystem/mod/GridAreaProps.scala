...
object GridAreaProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): GridAreaProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridAreaProps[ThemeType]]
  }
  @scala.inline
  implicit class GridAreaPropsOps[Self <: GridAreaProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with GridAreaProps[ThemeType]) extends AnyVal {
    @scala.inline
