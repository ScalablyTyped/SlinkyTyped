...
object FontStyleProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): FontStyleProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FontStyleProps[ThemeType]]
  }
  @scala.inline
  implicit class FontStylePropsOps[Self <: FontStyleProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with FontStyleProps[ThemeType]) extends AnyVal {
    @scala.inline
