...
object MaxWidthProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): MaxWidthProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MaxWidthProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class MaxWidthPropsOps[Self <: MaxWidthProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (MaxWidthProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
