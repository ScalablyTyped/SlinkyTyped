...
object HeightProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): HeightProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HeightProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class HeightPropsOps[Self <: HeightProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (HeightProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
