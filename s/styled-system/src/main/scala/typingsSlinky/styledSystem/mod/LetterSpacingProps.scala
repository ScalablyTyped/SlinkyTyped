...
object LetterSpacingProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): LetterSpacingProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LetterSpacingProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class LetterSpacingPropsOps[Self <: LetterSpacingProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (LetterSpacingProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
