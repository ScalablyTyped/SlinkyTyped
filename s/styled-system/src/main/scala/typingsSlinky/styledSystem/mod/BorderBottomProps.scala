...
object BorderBottomProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): BorderBottomProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BorderBottomProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class BorderBottomPropsOps[Self <: BorderBottomProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (BorderBottomProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
