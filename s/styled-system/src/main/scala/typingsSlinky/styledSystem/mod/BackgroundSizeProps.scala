...
object BackgroundSizeProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): BackgroundSizeProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackgroundSizeProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class BackgroundSizePropsOps[Self <: BackgroundSizeProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (BackgroundSizeProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
