...
object AlignContentProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType](): AlignContentProps[ThemeType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AlignContentProps[ThemeType]]
  }
  @scala.inline
  implicit class AlignContentPropsOps[Self <: AlignContentProps[_], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType] (val x: Self with AlignContentProps[ThemeType]) extends AnyVal {
    @scala.inline
