...
object BackgroundColorProps {
  @scala.inline
  def apply[/* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): BackgroundColorProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackgroundColorProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class BackgroundColorPropsOps[Self <: BackgroundColorProps[_, _], /* <: typingsSlinky.styledSystem.mod.Theme[typingsSlinky.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (BackgroundColorProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
