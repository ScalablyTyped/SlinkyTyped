package typingsSlinky.semanticDashUiDashShape.SemanticUI.ShapeSettings

import typingsSlinky.semanticDashUiDashShape.JQuery
import typingsSlinky.semanticDashUiDashShape.SemanticUI.Shape.ClassNameSettings
import typingsSlinky.semanticDashUiDashShape.SemanticUI.Shape.ErrorSettings
import typingsSlinky.semanticDashUiDashShape.SemanticUI.Shape.SelectorSettings
import typingsSlinky.semanticDashUiDashShape.semanticDashUiDashShapeStrings.initial
import typingsSlinky.semanticDashUiDashShape.semanticDashUiDashShapeStrings.next
