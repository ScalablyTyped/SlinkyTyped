package typingsSlinky.svgParser
...
object mod {
  ...
  */
  ...
  object Node {
    ...
    @scala.inline
    def ElementNode(children: js.Array[Node | String], `type`: element): typingsSlinky.svgParser.mod.ElementNode = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.svgParser.mod.ElementNode]
    }
    
    @scala.inline
    def TextNode(`type`: text): typingsSlinky.svgParser.mod.TextNode = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.svgParser.mod.TextNode]
    }
  }
