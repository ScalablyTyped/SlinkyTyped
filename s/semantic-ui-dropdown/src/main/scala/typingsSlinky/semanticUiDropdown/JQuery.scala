...
trait JQuery extends js.Object {
  ...
  @JSName("dropdown")
  def dropdown_ClassNameSettings(behavior: setting, name: className, value: js.UndefOr[scala.Nothing]): ClassNameSettings = js.native
  @JSName("dropdown")
  ...
  @JSName("dropdown")
  def dropdown_LabelSettings(behavior: setting, name: label, value: js.UndefOr[scala.Nothing]): LabelSettings = js.native
  @JSName("dropdown")
