...
package object Dropdown {
  type ClassNameSettings = typingsSlinky.semanticUiDropdown.SemanticUI.Dropdown.ClassNameSettings.Param
  ...
  type RegExpSettings = typingsSlinky.semanticUiDropdown.SemanticUI.Dropdown.RegExpSettings_
