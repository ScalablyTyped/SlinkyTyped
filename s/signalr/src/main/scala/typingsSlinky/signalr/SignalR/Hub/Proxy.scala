...
trait Proxy extends js.Object {
  var connection: typingsSlinky.signalr.SignalR.Hub.Connection
  var hubName: String
  var state: js.Any
  def hasSubscriptions(): Boolean
  def init(connection: typingsSlinky.signalr.SignalR.Hub.Connection, hubName: String): Unit
  /**
...
object Proxy {
  @scala.inline
  def apply(
    connection: typingsSlinky.signalr.SignalR.Hub.Connection,
    hasSubscriptions: () => Boolean,
    hubName: String,
    init: (typingsSlinky.signalr.SignalR.Hub.Connection, String) => Unit,
