...
import typingsSlinky.simperium.mod.Change
import typingsSlinky.simperium.mod.DMPDiff
...
object anon {
  ...
  object VJSONDiff {
    ...
    implicit class VJSONDiffMutableBuilder[Self <: VJSONDiff[_], T] (val x: Self with VJSONDiff[T]) extends AnyVal {
      ...
      @scala.inline
      def setO(value: typingsSlinky.simperium.simperiumStrings.O): Self = StObject.set(x, "o", value.asInstanceOf[js.Any])
