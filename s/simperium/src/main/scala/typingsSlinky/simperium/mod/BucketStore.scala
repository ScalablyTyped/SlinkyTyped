...
object BucketStore {
  ...
  implicit class BucketStoreOps[Self <: BucketStore[_, _], T, Q] (val x: Self with (BucketStore[T, Q])) extends AnyVal {
    ...
    @scala.inline
    def setFind(value: (Q, EntitiesCallback[BucketObject[T], js.Error | Null]) => Unit): Self = this.set("find", js.Any.fromFunction2(value))
    
    @scala.inline
    def setGet(value: (EntityId, EntityCallback[BucketObject[T], js.Error | Null]) => Unit): Self = this.set("get", js.Any.fromFunction2(value))
    
    @scala.inline
    def setRemove(value: (EntityId, js.Function0[Unit]) => Unit): Self = this.set("remove", js.Any.fromFunction2(value))
    
    @scala.inline
    def setUpdate(value: (EntityId, T, Boolean, EntityCallback[BucketObject[T], js.Error | Null]) => Unit): Self = this.set("update", js.Any.fromFunction4(value))
  }
}
