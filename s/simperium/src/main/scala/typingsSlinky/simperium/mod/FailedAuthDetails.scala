...
import typingsSlinky.simperium.simperiumNumbers.`400`
import typingsSlinky.simperium.simperiumNumbers.`401`
import typingsSlinky.simperium.simperiumNumbers.`500`
