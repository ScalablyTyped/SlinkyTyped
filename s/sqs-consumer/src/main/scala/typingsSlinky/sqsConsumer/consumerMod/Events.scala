...
trait Events extends js.Object {
  ...
  var error: js.Tuple2[js.Error, Unit | SQSMessage | js.Array[SQSMessage]] = js.native
  
  var message_processed: js.Array[SQSMessage] = js.native
  
  var message_received: js.Array[SQSMessage] = js.native
  
  var processing_error: js.Tuple2[js.Error, SQSMessage] = js.native
  
  var response_processed: js.Array[js.Any] = js.native
  
  var stopped: js.Array[js.Any] = js.native
  
  var timeout_error: js.Tuple2[js.Error, SQSMessage] = js.native
}
object Events {
  ...
  implicit class EventsOps[Self <: Events] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setError(value: js.Tuple2[js.Error, Unit | SQSMessage | js.Array[SQSMessage]]): Self = this.set("error", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProcessing_error(value: js.Tuple2[js.Error, SQSMessage]): Self = this.set("processing_error", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTimeout_error(value: js.Tuple2[js.Error, SQSMessage]): Self = this.set("timeout_error", value.asInstanceOf[js.Any])
  }
}
