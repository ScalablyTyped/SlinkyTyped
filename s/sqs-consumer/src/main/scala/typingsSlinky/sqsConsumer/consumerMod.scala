...
import typingsSlinky.awsSdk.sqsMod.Message
...
object consumerMod {
  ...
  object Events {
    ...
    implicit class EventsMutableBuilder[Self <: Events] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setError(value: js.Tuple2[js.Error, Unit | SQSMessage | js.Array[SQSMessage]]): Self = StObject.set(x, "error", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setProcessing_error(value: js.Tuple2[js.Error, SQSMessage]): Self = StObject.set(x, "processing_error", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTimeout_error(value: js.Tuple2[js.Error, SQSMessage]): Self = StObject.set(x, "timeout_error", value.asInstanceOf[js.Any])
    }
  }
