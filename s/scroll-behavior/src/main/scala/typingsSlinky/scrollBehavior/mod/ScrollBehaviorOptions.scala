...
object ScrollBehaviorOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.scrollBehavior.mod.LocationBase */ TLocation, TContext](
  ...
  @scala.inline
  implicit class ScrollBehaviorOptionsOps[Self <: ScrollBehaviorOptions[_, _], /* <: typingsSlinky.scrollBehavior.mod.LocationBase */ TLocation, TContext] (val x: Self with (ScrollBehaviorOptions[TLocation, TContext])) extends AnyVal {
    @scala.inline
