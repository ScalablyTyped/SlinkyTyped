package typingsSlinky.sqlDashBricks.sqlDashBricksMod

import typingsSlinky.sqlDashBricks.Anon_Placeholder
...
trait Statement extends js.Object {
  ...
  def toParams(options: Anon_Placeholder): SqlBricksParam = js.native
}
