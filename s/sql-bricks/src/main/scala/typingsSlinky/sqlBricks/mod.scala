...
object mod extends Shortcut {
  ...
  */
  ...
  object _WhereExpression {
    ...
    @scala.inline
    def WhereBinary(col: String | SelectStatement, op: String, quantifier: String, `val`: js.Any): typingsSlinky.sqlBricks.mod.WhereBinary = {
      val __obj = js.Dynamic.literal(col = col.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], quantifier = quantifier.asInstanceOf[js.Any])
      __obj.updateDynamic("val")(`val`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.sqlBricks.mod.WhereBinary]
    }
    
    @scala.inline
    def WhereGroup(expressions: js.Array[WhereExpression]): typingsSlinky.sqlBricks.mod.WhereGroup = {
      val __obj = js.Dynamic.literal(expressions = expressions.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.sqlBricks.mod.WhereGroup]
    }
  }
