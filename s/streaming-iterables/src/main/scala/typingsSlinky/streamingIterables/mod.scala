...
import typingsSlinky.streamingIterables.anon.FnCallFuncIterable
import typingsSlinky.streamingIterables.anon.FnCallStartIterable
...
object mod {
  ...
  @JSImport("streaming-iterables", "batch")
  @js.native
  def batch[T](size: Double, iterable: js.Iterable[T]): UnwrapAnyIterableArray[js.Iterable[T]] = js.native
  @JSImport("streaming-iterables", "batch")
  @js.native
  ...
  @JSImport("streaming-iterables", "buffer")
  @js.native
  def buffer[T](size: Double, iterable: js.Iterable[T]): UnwrapAnyIterable[js.Iterable[T]] = js.native
  @JSImport("streaming-iterables", "buffer")
  @js.native
  ...
  @js.native
  def collect[T](iterable: js.Iterable[T]): UnwrapToPromiseOrAsyncIterable[js.Iterable[T]] = js.native
  @JSImport("streaming-iterables", "collect")
  @js.native
  ...
  @js.native
  def concat[I /* <: js.Array[AnyIterable[_]] */](
  ...
  @JSImport("streaming-iterables", "concat")
  @js.native
  def concat_I_ArrayIterableWildcard_Iterable[I /* <: js.Array[js.Iterable[_]] */](
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param iterables because its type I is not an array type */ iterables: I
  ): js.Iterable[UnArrayAnyIterable[I]] = js.native
  
  @JSImport("streaming-iterables", "consume")
  @js.native
  def consume[T](iterable: js.Iterable[T]): Unit = js.native
  @JSImport("streaming-iterables", "consume")
  @js.native
  ...
  @JSImport("streaming-iterables", "getIterator")
  @js.native
  def getIterator[T](iterable: js.Iterator[T]): js.Iterator[T] = js.native
  @JSImport("streaming-iterables", "getIterator")
  @js.native
  def getIterator[T](iterable: AsyncIterable[T]): AsyncIterator[T, _, js.UndefOr[scala.Nothing]] = js.native
  @JSImport("streaming-iterables", "getIterator")
  @js.native
  ...
  @JSImport("streaming-iterables", "getIterator")
  @js.native
  def getIterator_T_Union[T](iterable: js.Iterable[T]): (AsyncIterator[T, _, js.UndefOr[scala.Nothing]]) | js.Iterator[T] = js.native
  @JSImport("streaming-iterables", "getIterator")
  @js.native
  def getIterator_T_Union[T](iterable: AsyncIterable[T]): (AsyncIterator[T, _, js.UndefOr[scala.Nothing]]) | js.Iterator[T] = js.native
  ...
  @JSImport("streaming-iterables", "take")
  @js.native
  def take[T](count: Double, iterable: js.Iterable[T]): UnwrapAnyIterable[js.Iterable[T]] = js.native
  @JSImport("streaming-iterables", "take")
  @js.native
  ...
  @JSImport("streaming-iterables", "time")
  @js.native
  def time[T](config: TimeConfig, iterable: js.Iterable[T]): UnwrapAnyIterable[js.Iterable[T]] = js.native
  @JSImport("streaming-iterables", "time")
  @js.native
  ...
  type AnyIterable[T] = js.Iterable[T] | AsyncIterable[T]
  ...
  type Iterableish[T] = js.Iterable[T] | js.Iterator[T] | AsyncIterable[T] | (AsyncIterator[T, js.Any, js.UndefOr[scala.Nothing]])
  ...
  type UnwrapAnyIterable[M /* <: AnyIterable[_] */] = AsyncIterable[js.Any] | js.Iterable[js.Any]
