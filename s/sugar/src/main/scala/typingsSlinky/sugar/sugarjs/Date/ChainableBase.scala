...
trait ChainableBase[RawValue] extends js.Object {
  ...
  def advance(set: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def advance(set: String, reset: Boolean): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  ...
  def beginningOfDay(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  ...
  def beginningOfMonth(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def beginningOfWeek(): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def beginningOfWeek(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def beginningOfYear(): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def beginningOfYear(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  ...
  def endOfDay(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  ...
  def endOfMonth(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def endOfWeek(): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def endOfWeek(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def endOfYear(): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def endOfYear(localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  ...
  def get(d: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def get(d: String, options: DateCreateOptions): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  ...
  def isBetween(d1: String, d2: typingsSlinky.sugar.Date): SugarDefaultChainable[Boolean] = js.native
  def isBetween(d1: String, d2: typingsSlinky.sugar.Date, margin: Double): SugarDefaultChainable[Boolean] = js.native
  ...
  def isBetween(d1: typingsSlinky.sugar.Date, d2: String): SugarDefaultChainable[Boolean] = js.native
  def isBetween(d1: typingsSlinky.sugar.Date, d2: String, margin: Double): SugarDefaultChainable[Boolean] = js.native
  ...
  def relativeTo(d: typingsSlinky.sugar.Date): SugarDefaultChainable[String] = js.native
  def relativeTo(d: typingsSlinky.sugar.Date, localeCode: String): SugarDefaultChainable[String] = js.native
  def reset(): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def reset(unit: js.UndefOr[scala.Nothing], localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def reset(unit: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def reset(unit: String, localeCode: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def rewind(milliseconds: Double): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def rewind(set: String): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
  def rewind(set: String, reset: Boolean): SugarDefaultChainable[typingsSlinky.sugar.Date] = js.native
