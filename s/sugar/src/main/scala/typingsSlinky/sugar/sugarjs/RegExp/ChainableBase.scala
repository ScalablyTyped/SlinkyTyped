...
trait ChainableBase[RawValue] extends js.Object {
  var raw: RawValue
  def addFlags(flags: java.lang.String): SugarDefaultChainable[typingsSlinky.sugar.RegExp]
  ...
  def removeFlags(flags: java.lang.String): SugarDefaultChainable[typingsSlinky.sugar.RegExp]
  def setFlags(flags: java.lang.String): SugarDefaultChainable[typingsSlinky.sugar.RegExp]
...
object ChainableBase {
  @scala.inline
  def apply[RawValue](
    addFlags: java.lang.String => SugarDefaultChainable[typingsSlinky.sugar.RegExp],
    exec: java.lang.String => SugarDefaultChainable[RegExpExecArray | Null],
    getFlags: () => SugarDefaultChainable[java.lang.String],
    raw: RawValue,
    removeFlags: java.lang.String => SugarDefaultChainable[typingsSlinky.sugar.RegExp],
    setFlags: java.lang.String => SugarDefaultChainable[typingsSlinky.sugar.RegExp],
