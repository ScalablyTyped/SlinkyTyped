...
object ChainableBase {
  ...
  implicit class ChainableBaseOps[Self <: ChainableBase[_], RawValue] (val x: Self with ChainableBase[RawValue]) extends AnyVal {
    ...
    @scala.inline
    def setAddFlags(value: String => SugarDefaultChainable[typingsSlinky.sugar.RegExp]): Self = this.set("addFlags", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRemoveFlags(value: String => SugarDefaultChainable[typingsSlinky.sugar.RegExp]): Self = this.set("removeFlags", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetFlags(value: String => SugarDefaultChainable[typingsSlinky.sugar.RegExp]): Self = this.set("setFlags", js.Any.fromFunction1(value))
