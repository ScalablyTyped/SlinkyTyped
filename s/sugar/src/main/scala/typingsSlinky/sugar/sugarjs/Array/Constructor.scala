...
trait Constructor
  ...
  def average[T, U](instance: typingsSlinky.sugar.Array[T], map: String): Double = js.native
  ...
  def groupBy[T, U](instance: typingsSlinky.sugar.Array[T], map: String): js.Object = js.native
  def groupBy[T, U](
    instance: typingsSlinky.sugar.Array[T],
    map: String,
    groupFn: js.Function3[/* arr */ typingsSlinky.sugar.Array[T], /* key */ String, /* obj */ js.Object, Unit]
  ): js.Object = js.native
  ...
  def least[T, U](instance: typingsSlinky.sugar.Array[T], map: String): typingsSlinky.sugar.Array[T] = js.native
  def least[T, U](instance: typingsSlinky.sugar.Array[T], map: mapFn[T, U]): typingsSlinky.sugar.Array[T] = js.native
  def map[T, U](instance: typingsSlinky.sugar.Array[T], map: String): typingsSlinky.sugar.Array[U] = js.native
  ...
  def max[T, U](instance: typingsSlinky.sugar.Array[T], map: String): T = js.native
  ...
  def most[T, U](instance: typingsSlinky.sugar.Array[T], map: String): typingsSlinky.sugar.Array[T] = js.native
  ...
  def sum[T, U](instance: typingsSlinky.sugar.Array[T], map: String): Double = js.native
  ...
  def unique[T, U](instance: typingsSlinky.sugar.Array[T], map: String): typingsSlinky.sugar.Array[T] = js.native
