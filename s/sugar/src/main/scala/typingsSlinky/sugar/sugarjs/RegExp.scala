...
object RegExp {
  ...
  trait ChainableBase[RawValue] extends StObject {
    ...
    def addFlags(flags: java.lang.String): SugarDefaultChainable[typingsSlinky.sugar.RegExp] = js.native
    ...
    def removeFlags(flags: java.lang.String): SugarDefaultChainable[typingsSlinky.sugar.RegExp] = js.native
    
    def setFlags(flags: java.lang.String): SugarDefaultChainable[typingsSlinky.sugar.RegExp] = js.native
  ...
  object ChainableBase {
    ...
    implicit class ChainableBaseMutableBuilder[Self <: ChainableBase[_], RawValue] (val x: Self with ChainableBase[RawValue]) extends AnyVal {
      ...
      @scala.inline
      def setAddFlags(value: java.lang.String => SugarDefaultChainable[typingsSlinky.sugar.RegExp]): Self = StObject.set(x, "addFlags", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRemoveFlags(value: java.lang.String => SugarDefaultChainable[typingsSlinky.sugar.RegExp]): Self = StObject.set(x, "removeFlags", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSetFlags(value: java.lang.String => SugarDefaultChainable[typingsSlinky.sugar.RegExp]): Self = StObject.set(x, "setFlags", js.Any.fromFunction1(value))
  ...
  trait Constructor
    extends SugarNamespace
       with Instantiable0[Chainable[typingsSlinky.sugar.RegExp]]
       with Instantiable1[/* raw */ typingsSlinky.sugar.RegExp, Chainable[typingsSlinky.sugar.RegExp]] {
    
    def apply(): Chainable[typingsSlinky.sugar.RegExp] = js.native
    def apply(raw: typingsSlinky.sugar.RegExp): Chainable[typingsSlinky.sugar.RegExp] = js.native
    
    def addFlags(instance: typingsSlinky.sugar.RegExp, flags: java.lang.String): typingsSlinky.sugar.RegExp = js.native
    
    def escape(): java.lang.String = js.native
    def escape(str: java.lang.String): java.lang.String = js.native
    
    def getFlags(instance: typingsSlinky.sugar.RegExp): java.lang.String = js.native
    
    def removeFlags(instance: typingsSlinky.sugar.RegExp, flags: java.lang.String): typingsSlinky.sugar.RegExp = js.native
    
    def setFlags(instance: typingsSlinky.sugar.RegExp, flags: java.lang.String): typingsSlinky.sugar.RegExp = js.native
  }
}
