...
object ExtendOptions {
  ...
  implicit class ExtendOptionsOps[Self <: ExtendOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcept(value: typingsSlinky.sugar.Array[java.lang.String | NativeConstructor]): Self = this.set("except", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteExcept: Self = this.set("except", js.undefined)
    @scala.inline
    def setMethods(value: typingsSlinky.sugar.Array[java.lang.String]): Self = this.set("methods", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMethods: Self = this.set("methods", js.undefined)
    @scala.inline
    def setNamespaces(value: typingsSlinky.sugar.Array[NativeConstructor]): Self = this.set("namespaces", value.asInstanceOf[js.Any])
    @scala.inline
