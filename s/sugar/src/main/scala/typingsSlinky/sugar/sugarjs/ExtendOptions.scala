...
object ExtendOptions {
  ...
  implicit class ExtendOptionsOps[Self <: ExtendOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExcept(value: typingsSlinky.sugar.Array[java.lang.String | NativeConstructor]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMethods(value: typingsSlinky.sugar.Array[java.lang.String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNamespaces(value: typingsSlinky.sugar.Array[NativeConstructor]): Self = {
        val ret = this.duplicate
