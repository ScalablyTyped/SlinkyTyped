...
import typingsSlinky.std.MessageEventSource
...
@js.native
trait PartialMessageEventany extends js.Object {
...
object PartialMessageEventany {
  ...
  @scala.inline
  implicit class PartialMessageEventanyOps[Self <: PartialMessageEventany] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSourceServiceWorker(value: ServiceWorker): Self = this.set("source", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSourceMessagePort(value: MessagePort): Self = this.set("source", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSourceWindow(value: Window): Self = this.set("source", value.asInstanceOf[js.Any])
