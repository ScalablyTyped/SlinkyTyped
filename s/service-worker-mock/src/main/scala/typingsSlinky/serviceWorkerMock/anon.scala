...
object anon {
  ...
  object PartialMessageEventany {
    ...
    implicit class PartialMessageEventanyMutableBuilder[Self <: PartialMessageEventany] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSourceMessagePort(value: MessagePort): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSourceNull: Self = StObject.set(x, "source", null)
      
      @scala.inline
      def setSourceServiceWorker(value: ServiceWorker): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSourceUndefined: Self = StObject.set(x, "source", js.undefined)
      
      @scala.inline
      def setSourceWindow(value: Window): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
