...
object jsx extends js.Object {
  ...
  def apply(`type`: input, children: ReactElement*): DetailedReactHTMLElement[InputHTMLAttributes[HTMLInputElement], HTMLInputElement] = js.native
  def apply(
    `type`: input,
  ...
  def apply[P /* <: js.Object */](`type`: String, children: ReactElement*): ReactElement = js.native
  ...
  def apply[P /* <: js.Object */](`type`: ClassType[P, ReactComponentClass[P], ReactComponentClass[P]], children: ReactElement*): CElement[P, ReactComponentClass[P]] = js.native
  ...
  def apply[P /* <: js.Object */](`type`: ComponentClass[P, js.Object], children: ReactElement*): ReactElement = js.native
  ...
  def apply[P /* <: js.Object */](`type`: FunctionComponent[P], children: ReactElement*): FunctionComponentElement[P] = js.native
  ...
  def apply[P /* <: js.Object */, T /* <: ReactComponentClass[P] */, C /* <: ReactComponentClass[P] */](`type`: ClassType[P, T, C], children: ReactElement*): CElement[P, T] = js.native
