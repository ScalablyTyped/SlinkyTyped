...
object baseMod {
  ...
  object background {
    ...
    @JSImport("@storybook/theming/dist/base", "background.gridCellSize")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "background.hoverable")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "background.negative")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "background.positive")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "background.warning")
    @js.native
  ...
  object color {
    ...
    @JSImport("@storybook/theming/dist/base", "color")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@storybook/theming/dist/base", "color.ancillary")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.defaultText")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.lightest")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.mediumlight")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.negative")
    @js.native
    def negative: String = js.native
    @scala.inline
    def negative_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("negative")(x.asInstanceOf[js.Any])
    
    @JSImport("@storybook/theming/dist/base", "color.orange")
    @js.native
    def orange: String = js.native
    @scala.inline
    def orange_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("orange")(x.asInstanceOf[js.Any])
    
    @JSImport("@storybook/theming/dist/base", "color.positive")
    @js.native
    def positive: String = js.native
    @scala.inline
    def positive_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("positive")(x.asInstanceOf[js.Any])
    
    @JSImport("@storybook/theming/dist/base", "color.primary")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.secondary")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.tertiary")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.ultraviolet")
    @js.native
    ...
    @JSImport("@storybook/theming/dist/base", "color.warning")
    @js.native
    def warning: String = js.native
    @scala.inline
    def warning_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("warning")(x.asInstanceOf[js.Any])
