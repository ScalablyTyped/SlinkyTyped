...
@js.native
trait AnonAncillary extends js.Object {
...
object AnonAncillary {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonAncillary]
  }
  @scala.inline
  implicit class AnonAncillaryOps[Self <: AnonAncillary] (val x: Self) extends AnyVal {
    @scala.inline
