...
import typingsSlinky.stylelintDashWebpackDashPlugin.stylelintDashWebpackDashPluginStrings.error
import typingsSlinky.stylelintDashWebpackDashPlugin.stylelintDashWebpackDashPluginStrings.warning
