...
package object lintDirtyModulesPluginMod {
  ...
  type FileSystemInfoEntry = scala.Double | typingsSlinky.stylelintWebpackPlugin.anon.Partialtimestampnumber
  
  type Lint = js.Function1[
    /* options */ typingsSlinky.stylelintWebpackPlugin.getOptionsMod.Options, 
    js.Promise[typingsSlinky.stylelint.mod.LinterResult]
  ]
