...
import typingsSlinky.smpteTimecode.mod.FRAMERATE
...
object smpteTimecodeNumbers {
  ...
  @js.native
  sealed trait `24` extends FRAMERATE
  
  @js.native
  sealed trait `25` extends FRAMERATE
  
  @js.native
  sealed trait `29.97` extends FRAMERATE
  
  @js.native
  sealed trait `30` extends FRAMERATE
  
  @js.native
  sealed trait `50` extends FRAMERATE
  
  @js.native
  sealed trait `59.94` extends FRAMERATE
