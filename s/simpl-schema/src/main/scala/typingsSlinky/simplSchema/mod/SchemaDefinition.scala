...
object SchemaDefinition {
  ...
  implicit class SchemaDefinitionOps[Self <: SchemaDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxFunction0(value: () => Double | Boolean | js.Date): Self = this.set("max", js.Any.fromFunction0(value))
    @scala.inline
    def setMax(value: Double | Boolean | js.Date | (js.Function0[Double | Boolean | js.Date])): Self = this.set("max", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMinFunction0(value: () => Double | Boolean | js.Date): Self = this.set("min", js.Any.fromFunction0(value))
    @scala.inline
    def setMin(value: Double | Boolean | js.Date | (js.Function0[Double | Boolean | js.Date])): Self = this.set("min", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRegExVarargs(value: js.RegExp*): Self = this.set("regEx", js.Array(value :_*))
    @scala.inline
    def setRegExRegExp(value: js.RegExp): Self = this.set("regEx", value.asInstanceOf[js.Any])
    @scala.inline
    def setRegEx(value: js.RegExp | js.Array[js.RegExp]): Self = this.set("regEx", value.asInstanceOf[js.Any])
    @scala.inline
