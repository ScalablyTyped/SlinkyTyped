...
object mod extends Shortcut {
  ...
  class SimpleSchemaCls protected ()
    extends typingsSlinky.simplSchema.mod.SimpleSchema {
  ...
  object SchemaDefinition {
    ...
    implicit class SchemaDefinitionMutableBuilder[Self <: SchemaDefinition] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMax(value: Double | Boolean | js.Date | (js.Function0[Double | Boolean | js.Date])): Self = StObject.set(x, "max", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMaxFunction0(value: () => Double | Boolean | js.Date): Self = StObject.set(x, "max", js.Any.fromFunction0(value))
      
      @scala.inline
      def setMaxUndefined: Self = StObject.set(x, "max", js.undefined)
      
      @scala.inline
      def setMin(value: Double | Boolean | js.Date | (js.Function0[Double | Boolean | js.Date])): Self = StObject.set(x, "min", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMinFunction0(value: () => Double | Boolean | js.Date): Self = StObject.set(x, "min", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setRegEx(value: js.RegExp | js.Array[js.RegExp]): Self = StObject.set(x, "regEx", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRegExVarargs(value: js.RegExp*): Self = StObject.set(x, "regEx", js.Array(value :_*))
  ...
  type SimpleSchemaDefinition = (StringDictionary[
    SchemaDefinition | BooleanConstructor | StringConstructor | NumberConstructor | DateConstructor | ArrayConstructor | String | js.RegExp | typingsSlinky.simplSchema.mod.SimpleSchema
  ]) | js.Array[js.Any]
  ...
  trait SimpleSchemaStatic
    extends Instantiable1[/* schema */ SimpleSchemaDefinition, typingsSlinky.simplSchema.mod.SimpleSchema]
       with Instantiable2[
          /* schema */ SimpleSchemaDefinition, 
          /* options */ SimpleSchemaOptions, 
          typingsSlinky.simplSchema.mod.SimpleSchema
        ] {
