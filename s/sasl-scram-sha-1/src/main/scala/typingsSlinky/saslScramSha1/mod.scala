package typingsSlinky.saslScramSha1

import org.scalablytyped.runtime.Instantiable1
import typingsSlinky.saslScramSha1.saslScramSha1Booleans.`true`
import typingsSlinky.saslScramSha1.saslScramSha1Strings.`SCRAM-SHA-1`
