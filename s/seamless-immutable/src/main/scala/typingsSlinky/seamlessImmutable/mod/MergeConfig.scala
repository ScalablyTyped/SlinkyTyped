...
trait MergeConfig extends js.Object {
  ...
  var mode: js.UndefOr[typingsSlinky.seamlessImmutable.seamlessImmutableStrings.replace | merge] = js.undefined
}
...
object MergeConfig {
  ...
  def apply(
    ...
    mode: typingsSlinky.seamlessImmutable.seamlessImmutableStrings.replace | merge = null
  ): MergeConfig = {
