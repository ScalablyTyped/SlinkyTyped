...
import typingsSlinky.seamlessDashImmutable.seamlessDashImmutableStrings.merge
...
trait MergeConfig extends js.Object {
  ...
  var mode: js.UndefOr[typingsSlinky.seamlessDashImmutable.seamlessDashImmutableStrings.replace | merge] = js.undefined
}
...
object MergeConfig {
  ...
  def apply(
    ...
    mode: typingsSlinky.seamlessDashImmutable.seamlessDashImmutableStrings.replace | merge = null
  ): MergeConfig = {
