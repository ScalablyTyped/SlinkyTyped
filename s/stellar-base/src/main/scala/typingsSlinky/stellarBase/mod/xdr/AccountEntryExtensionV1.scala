...
@JSImport("stellar-base", "xdr.AccountEntryExtensionV1")
@js.native
class AccountEntryExtensionV1 protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.AccountEntryExtensionV1 {
  def this(attributes: typingsSlinky.stellarBase.anon.Liabilities) = this()
}
object AccountEntryExtensionV1 {
  
  /* static member */
  @JSImport("stellar-base", "xdr.AccountEntryExtensionV1.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.AccountEntryExtensionV1.write")
  @js.native
