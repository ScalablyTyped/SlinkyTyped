...
@JSImport("stellar-base", "xdr.ClaimableBalanceEntryExt")
@js.native
class ClaimableBalanceEntryExt ()
  extends typingsSlinky.stellarBase.xdrMod.default.ClaimableBalanceEntryExt
object ClaimableBalanceEntryExt {
  
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceEntryExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceEntryExt.write")
  @js.native
  def write(value: typingsSlinky.stellarBase.xdrMod.xdr.ClaimableBalanceEntryExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceEntryExt.0")
  @js.native
