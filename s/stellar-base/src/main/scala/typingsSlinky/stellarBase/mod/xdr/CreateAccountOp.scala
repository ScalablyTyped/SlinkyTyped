...
@JSImport("stellar-base", "xdr.CreateAccountOp")
@js.native
class CreateAccountOp protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.CreateAccountOp {
  def this(attributes: Destination) = this()
}
object CreateAccountOp {
  
  /* static member */
  @JSImport("stellar-base", "xdr.CreateAccountOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.CreateAccountOp.write")
  @js.native
