...
object SetOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarBase.mod.SignerOptions */ T](): SetOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SetOptions[T]]
  }
  @scala.inline
  implicit class SetOptionsOps[Self <: SetOptions[_], /* <: typingsSlinky.stellarBase.mod.SignerOptions */ T] (val x: Self with SetOptions[T]) extends AnyVal {
    @scala.inline
