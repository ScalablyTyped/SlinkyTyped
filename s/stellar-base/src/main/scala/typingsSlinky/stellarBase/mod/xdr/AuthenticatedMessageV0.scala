...
object AuthenticatedMessageV0 {
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.AuthenticatedMessageV0.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.AuthenticatedMessageV0.write")
  @js.native
