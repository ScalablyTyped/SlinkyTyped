...
class SimplePaymentResult protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.SimplePaymentResult {
  def this(attributes: AmountAsset) = this()
}
object SimplePaymentResult {
  
  /* static member */
  @JSImport("stellar-base", "xdr.SimplePaymentResult.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.SimplePaymentResult.write")
  @js.native
