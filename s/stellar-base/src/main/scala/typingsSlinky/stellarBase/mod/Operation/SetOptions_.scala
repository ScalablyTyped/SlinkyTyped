...
object SetOptions_ {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarBase.mod.SignerOptions */ T](signer: PreAuthTx | Sha256Hash | Ed25519PublicKey, `type`: SetOptions): SetOptions_[T] = {
    val __obj = js.Dynamic.literal(signer = signer.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SetOptions_[T]]
  }
  @scala.inline
  implicit class SetOptions_Ops[Self <: SetOptions_[_], /* <: typingsSlinky.stellarBase.mod.SignerOptions */ T] (val x: Self with SetOptions_[T]) extends AnyVal {
    @scala.inline
