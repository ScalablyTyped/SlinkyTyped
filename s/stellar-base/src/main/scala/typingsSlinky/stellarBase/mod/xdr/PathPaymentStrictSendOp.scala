...
class PathPaymentStrictSendOp protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.PathPaymentStrictSendOp {
  def this(attributes: DestAsset) = this()
}
object PathPaymentStrictSendOp {
  
  /* static member */
  @JSImport("stellar-base", "xdr.PathPaymentStrictSendOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.PathPaymentStrictSendOp.write")
  @js.native
