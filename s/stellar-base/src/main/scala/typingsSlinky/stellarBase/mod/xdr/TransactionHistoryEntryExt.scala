...
object TransactionHistoryEntryExt {
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionHistoryEntryExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionHistoryEntryExt.write")
  @js.native
  def write(value: typingsSlinky.stellarBase.xdrMod.xdr.TransactionHistoryEntryExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionHistoryEntryExt.0")
  @js.native
