...
@JSImport("stellar-base", "xdr.AuthCert")
@js.native
class AuthCert protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.AuthCert {
  def this(attributes: Expiration) = this()
}
object AuthCert {
  
  /* static member */
  @JSImport("stellar-base", "xdr.AuthCert.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.AuthCert.write")
  @js.native
