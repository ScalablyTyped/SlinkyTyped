...
@JSImport("stellar-base", "xdr.ManageSellOfferOp")
@js.native
class ManageSellOfferOp protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.ManageSellOfferOp {
  def this(attributes: Buying) = this()
}
object ManageSellOfferOp {
  
  /* static member */
  @JSImport("stellar-base", "xdr.ManageSellOfferOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.ManageSellOfferOp.write")
  @js.native
