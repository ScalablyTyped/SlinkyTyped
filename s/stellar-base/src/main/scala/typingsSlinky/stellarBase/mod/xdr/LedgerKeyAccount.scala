...
object LedgerKeyAccount {
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerKeyAccount.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerKeyAccount.write")
  @js.native
