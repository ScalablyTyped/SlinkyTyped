...
class Claimant protected () extends StObject {
  ...
  def toXDRObject(): typingsSlinky.stellarBase.xdrMod.default.Claimant = js.native
}
/* static members */
object Claimant {
  ...
  @js.native
  def fromXDR(claimantXdr: typingsSlinky.stellarBase.xdrMod.default.Claimant): Claimant = js.native
