...
@JSImport("stellar-base", "xdr.CreatePassiveSellOfferOp")
@js.native
class CreatePassiveSellOfferOp protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.CreatePassiveSellOfferOp {
  def this(attributes: typingsSlinky.stellarBase.anon.Price) = this()
}
object CreatePassiveSellOfferOp {
  
  /* static member */
  @JSImport("stellar-base", "xdr.CreatePassiveSellOfferOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.CreatePassiveSellOfferOp.write")
  @js.native
