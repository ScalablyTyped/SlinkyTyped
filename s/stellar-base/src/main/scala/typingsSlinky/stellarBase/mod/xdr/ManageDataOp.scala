...
object ManageDataOp {
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.ManageDataOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.ManageDataOp.write")
  @js.native
