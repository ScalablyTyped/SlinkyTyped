...
@JSImport("stellar-base", "xdr.UpgradeEntryMeta")
@js.native
class UpgradeEntryMeta protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.UpgradeEntryMeta {
  def this(attributes: Upgrade) = this()
}
object UpgradeEntryMeta {
  
  /* static member */
  @JSImport("stellar-base", "xdr.UpgradeEntryMeta.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.UpgradeEntryMeta.write")
  @js.native
