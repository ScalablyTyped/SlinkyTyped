...
@JSImport("stellar-base", "xdr.Claimant")
@js.native
class Claimant ()
  extends typingsSlinky.stellarBase.xdrMod.default.Claimant
object Claimant {
  
  /* static member */
  @JSImport("stellar-base", "xdr.Claimant.claimantTypeV0")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.Claimant.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.Claimant.write")
  @js.native
