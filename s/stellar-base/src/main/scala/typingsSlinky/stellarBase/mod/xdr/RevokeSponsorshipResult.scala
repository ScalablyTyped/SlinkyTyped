...
class RevokeSponsorshipResult ()
  extends typingsSlinky.stellarBase.xdrMod.default.RevokeSponsorshipResult
object RevokeSponsorshipResult {
  
  /* static member */
  @JSImport("stellar-base", "xdr.RevokeSponsorshipResult.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.RevokeSponsorshipResult.write")
  @js.native
