...
object TimeBounds {
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TimeBounds.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TimeBounds.write")
  @js.native
