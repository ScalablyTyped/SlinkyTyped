...
object BaseOperation {
  @scala.inline
  def apply[/* <: typingsSlinky.stellarBase.mod.OperationType */ T](`type`: T): BaseOperation[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[BaseOperation[T]]
  }
  @scala.inline
  implicit class BaseOperationOps[Self <: BaseOperation[_], /* <: typingsSlinky.stellarBase.mod.OperationType */ T] (val x: Self with BaseOperation[T]) extends AnyVal {
    @scala.inline
