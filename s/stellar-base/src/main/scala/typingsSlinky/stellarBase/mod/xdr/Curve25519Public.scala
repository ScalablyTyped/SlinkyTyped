...
@JSImport("stellar-base", "xdr.Curve25519Public")
@js.native
class Curve25519Public protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.Curve25519Public {
  def this(attributes: Key) = this()
}
object Curve25519Public {
  
  /* static member */
  @JSImport("stellar-base", "xdr.Curve25519Public.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.Curve25519Public.write")
  @js.native
