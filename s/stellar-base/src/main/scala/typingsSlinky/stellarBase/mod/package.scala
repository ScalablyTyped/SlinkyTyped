...
package object mod {
  ...
  type OperationType = typingsSlinky.stellarBase.mod.OperationType.CreateAccount | typingsSlinky.stellarBase.mod.OperationType.Payment | typingsSlinky.stellarBase.mod.OperationType.PathPaymentStrictReceive | typingsSlinky.stellarBase.mod.OperationType.PathPaymentStrictSend | typingsSlinky.stellarBase.mod.OperationType.CreatePassiveSellOffer | typingsSlinky.stellarBase.mod.OperationType.ManageSellOffer | typingsSlinky.stellarBase.mod.OperationType.ManageBuyOffer | typingsSlinky.stellarBase.mod.OperationType.SetOptions | typingsSlinky.stellarBase.mod.OperationType.ChangeTrust | typingsSlinky.stellarBase.mod.OperationType.AllowTrust | typingsSlinky.stellarBase.mod.OperationType.AccountMerge | typingsSlinky.stellarBase.mod.OperationType.Inflation | typingsSlinky.stellarBase.mod.OperationType.ManageData | typingsSlinky.stellarBase.mod.OperationType.BumpSequence
