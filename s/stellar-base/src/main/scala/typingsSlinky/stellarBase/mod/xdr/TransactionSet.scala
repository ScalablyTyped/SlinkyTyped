...
@JSImport("stellar-base", "xdr.TransactionSet")
@js.native
class TransactionSet protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.TransactionSet {
  def this(attributes: PreviousLedgerHash) = this()
}
object TransactionSet {
  
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionSet.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionSet.write")
  @js.native
