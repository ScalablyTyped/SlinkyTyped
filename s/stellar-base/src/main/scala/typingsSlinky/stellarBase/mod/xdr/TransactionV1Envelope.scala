...
class TransactionV1Envelope protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.TransactionV1Envelope {
  def this(attributes: Tx) = this()
}
object TransactionV1Envelope {
  
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionV1Envelope.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionV1Envelope.write")
  @js.native
