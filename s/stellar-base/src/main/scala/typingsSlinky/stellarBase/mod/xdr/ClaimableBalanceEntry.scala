...
class ClaimableBalanceEntry protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.ClaimableBalanceEntry {
  def this(attributes: AssetBalanceId) = this()
}
object ClaimableBalanceEntry {
  
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceEntry.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceEntry.write")
  @js.native
