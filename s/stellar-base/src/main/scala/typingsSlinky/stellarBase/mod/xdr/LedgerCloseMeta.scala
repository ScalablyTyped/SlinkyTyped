...
@JSImport("stellar-base", "xdr.LedgerCloseMeta")
@js.native
class LedgerCloseMeta ()
  extends typingsSlinky.stellarBase.xdrMod.default.LedgerCloseMeta
object LedgerCloseMeta {
  
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerCloseMeta.fromXDR")
  @js.native
