...
@JSImport("stellar-base", "xdr.AccountEntryExtensionV2")
@js.native
class AccountEntryExtensionV2 protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.AccountEntryExtensionV2 {
  def this(attributes: NumSponsored) = this()
}
object AccountEntryExtensionV2 {
  
  /* static member */
  @JSImport("stellar-base", "xdr.AccountEntryExtensionV2.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.AccountEntryExtensionV2.write")
  @js.native
