...
@JSImport("stellar-base", "xdr.TransactionSignaturePayload")
@js.native
class TransactionSignaturePayload protected ()
  extends typingsSlinky.stellarBase.xdrMod.default.TransactionSignaturePayload {
  def this(attributes: NetworkId) = this()
}
object TransactionSignaturePayload {
  
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionSignaturePayload.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionSignaturePayload.write")
  @js.native
