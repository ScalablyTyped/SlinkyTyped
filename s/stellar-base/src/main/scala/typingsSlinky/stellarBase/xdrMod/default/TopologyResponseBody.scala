...
@JSImport("stellar-base/types/xdr", "default.TopologyResponseBody")
@js.native
...
object TopologyResponseBody {
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TopologyResponseBody.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TopologyResponseBody.isValid")
  @js.native
  def isValid(value: typingsSlinky.stellarBase.xdrMod.xdr.TopologyResponseBody): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TopologyResponseBody.read")
  @js.native
  def read(io: Buffer): typingsSlinky.stellarBase.xdrMod.xdr.TopologyResponseBody = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TopologyResponseBody.toXDR")
  @js.native
  def toXDR(value: typingsSlinky.stellarBase.xdrMod.xdr.TopologyResponseBody): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TopologyResponseBody.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TopologyResponseBody.write")
  @js.native
