...
@JSImport("stellar-base/types/xdr", "default.LedgerUpgrade")
@js.native
class LedgerUpgrade ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.LedgerUpgrade
object LedgerUpgrade {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerUpgrade.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerUpgrade.write")
  @js.native
