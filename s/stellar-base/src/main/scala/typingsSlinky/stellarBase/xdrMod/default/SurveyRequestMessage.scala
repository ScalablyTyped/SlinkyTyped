...
@JSImport("stellar-base/types/xdr", "default.SurveyRequestMessage")
@js.native
class SurveyRequestMessage protected ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.SurveyRequestMessage {
  def this(attributes: CommandType) = this()
}
object SurveyRequestMessage {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SurveyRequestMessage.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SurveyRequestMessage.isValid")
  @js.native
  def isValid(value: typingsSlinky.stellarBase.xdrMod.xdr.SurveyRequestMessage): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SurveyRequestMessage.read")
  @js.native
  def read(io: Buffer): typingsSlinky.stellarBase.xdrMod.xdr.SurveyRequestMessage = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SurveyRequestMessage.toXDR")
  @js.native
  def toXDR(value: typingsSlinky.stellarBase.xdrMod.xdr.SurveyRequestMessage): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SurveyRequestMessage.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SurveyRequestMessage.write")
  @js.native
