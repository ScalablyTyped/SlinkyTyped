...
@JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt")
@js.native
class LedgerHeaderHistoryEntryExt ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntryExt
object LedgerHeaderHistoryEntryExt {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt.isValid")
  @js.native
  def isValid(value: typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntryExt): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt.read")
  @js.native
  def read(io: Buffer): typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntryExt = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt.toXDR")
  @js.native
  def toXDR(value: typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntryExt): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt.write")
  @js.native
  def write(value: typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntryExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntryExt.0")
  @js.native
