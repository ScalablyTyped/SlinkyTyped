...
@JSImport("stellar-base/types/xdr", "default.Hello")
@js.native
class Hello protected ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.Hello {
  def this(attributes: Cert) = this()
}
object Hello {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Hello.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Hello.write")
  @js.native
