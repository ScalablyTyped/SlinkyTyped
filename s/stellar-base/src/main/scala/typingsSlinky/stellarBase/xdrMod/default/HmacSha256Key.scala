...
@JSImport("stellar-base/types/xdr", "default.HmacSha256Key")
@js.native
class HmacSha256Key protected ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.HmacSha256Key {
  def this(attributes: Key) = this()
}
object HmacSha256Key {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.HmacSha256Key.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.HmacSha256Key.write")
  @js.native
