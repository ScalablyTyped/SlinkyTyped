...
@JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext")
@js.native
class LedgerEntryExtensionV1Ext ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.LedgerEntryExtensionV1Ext
object LedgerEntryExtensionV1Ext {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext.isValid")
  @js.native
  def isValid(value: typingsSlinky.stellarBase.xdrMod.xdr.LedgerEntryExtensionV1Ext): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext.read")
  @js.native
  def read(io: Buffer): typingsSlinky.stellarBase.xdrMod.xdr.LedgerEntryExtensionV1Ext = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext.toXDR")
  @js.native
  def toXDR(value: typingsSlinky.stellarBase.xdrMod.xdr.LedgerEntryExtensionV1Ext): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext.write")
  @js.native
  def write(value: typingsSlinky.stellarBase.xdrMod.xdr.LedgerEntryExtensionV1Ext, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryExtensionV1Ext.0")
  @js.native
