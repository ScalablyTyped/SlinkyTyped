...
@JSImport("stellar-base/types/xdr", "default.ClaimantV0")
@js.native
class ClaimantV0 protected ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.ClaimantV0 {
  def this(attributes: Predicate) = this()
}
object ClaimantV0 {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimantV0.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimantV0.write")
  @js.native
