...
@JSImport("stellar-base/types/xdr", "default.InnerTransactionResult")
@js.native
class InnerTransactionResult protected ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.InnerTransactionResult {
  def this(attributes: FeeCharged) = this()
}
object InnerTransactionResult {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InnerTransactionResult.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InnerTransactionResult.isValid")
  @js.native
  def isValid(value: typingsSlinky.stellarBase.xdrMod.xdr.InnerTransactionResult): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InnerTransactionResult.read")
  @js.native
  def read(io: Buffer): typingsSlinky.stellarBase.xdrMod.xdr.InnerTransactionResult = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InnerTransactionResult.toXDR")
  @js.native
  def toXDR(value: typingsSlinky.stellarBase.xdrMod.xdr.InnerTransactionResult): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InnerTransactionResult.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InnerTransactionResult.write")
  @js.native
