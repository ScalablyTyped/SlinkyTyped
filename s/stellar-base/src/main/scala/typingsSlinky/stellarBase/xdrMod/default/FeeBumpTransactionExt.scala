...
@JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt")
@js.native
class FeeBumpTransactionExt ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.FeeBumpTransactionExt
object FeeBumpTransactionExt {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt.isValid")
  @js.native
  def isValid(value: typingsSlinky.stellarBase.xdrMod.xdr.FeeBumpTransactionExt): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt.read")
  @js.native
  def read(io: Buffer): typingsSlinky.stellarBase.xdrMod.xdr.FeeBumpTransactionExt = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt.toXDR")
  @js.native
  def toXDR(value: typingsSlinky.stellarBase.xdrMod.xdr.FeeBumpTransactionExt): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt.write")
  @js.native
  def write(value: typingsSlinky.stellarBase.xdrMod.xdr.FeeBumpTransactionExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.FeeBumpTransactionExt.0")
  @js.native
