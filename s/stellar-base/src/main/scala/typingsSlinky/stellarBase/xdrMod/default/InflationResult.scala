...
@JSImport("stellar-base/types/xdr", "default.InflationResult")
@js.native
class InflationResult ()
  extends typingsSlinky.stellarBase.xdrMod.xdr.InflationResult
object InflationResult {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InflationResult.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InflationResult.inflationSuccess")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.InflationResult.write")
  @js.native
