...
@JSImport("stellar-base/types/xdr", "default.TransactionV0Envelope")
@js.native
...
object TransactionV0Envelope {
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Envelope.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Envelope.isValid")
  @js.native
  def isValid(value: typingsSlinky.stellarBase.xdrMod.xdr.TransactionV0Envelope): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Envelope.read")
  @js.native
  def read(io: Buffer): typingsSlinky.stellarBase.xdrMod.xdr.TransactionV0Envelope = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Envelope.toXDR")
  @js.native
  def toXDR(value: typingsSlinky.stellarBase.xdrMod.xdr.TransactionV0Envelope): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Envelope.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Envelope.write")
  @js.native
