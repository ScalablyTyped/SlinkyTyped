...
import typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntryExt
...
trait Hash extends StObject {
  ...
  var header: typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeader = js.native
}
object Hash {
  ...
  def apply(
    ...
    hash: Buffer,
    header: typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeader
  ): Hash = {
  ...
  implicit class HashMutableBuilder[Self <: Hash] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeader(value: typingsSlinky.stellarBase.xdrMod.xdr.LedgerHeader): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
  }
}
