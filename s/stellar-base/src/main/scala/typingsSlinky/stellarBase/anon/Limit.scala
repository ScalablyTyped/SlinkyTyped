...
trait Limit extends StObject {
  ...
  var line: typingsSlinky.stellarBase.xdrMod.xdr.Asset = js.native
}
object Limit {
  
  @scala.inline
  def apply(limit: Int64, line: typingsSlinky.stellarBase.xdrMod.xdr.Asset): Limit = {
  ...
  implicit class LimitMutableBuilder[Self <: Limit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLine(value: typingsSlinky.stellarBase.xdrMod.xdr.Asset): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
  }
}
