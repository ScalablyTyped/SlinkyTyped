...
import typingsSlinky.stellarBase.xdrMod.xdr.AuthCert
...
trait Cert extends StObject {
  ...
  var peerId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId = js.native
...
object Cert {
  ...
  def apply(
    ...
    peerId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId,
  ...
  implicit class CertMutableBuilder[Self <: Cert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPeerId(value: typingsSlinky.stellarBase.xdrMod.xdr.NodeId): Self = StObject.set(x, "peerId", value.asInstanceOf[js.Any])
