...
import typingsSlinky.stellarBase.xdrMod.xdr.TrustLineEntryV1Ext
...
object ExtLiabilities {
  ...
  @scala.inline
  def apply(ext: TrustLineEntryV1Ext, liabilities: typingsSlinky.stellarBase.xdrMod.xdr.Liabilities): ExtLiabilities = {
  ...
  implicit class ExtLiabilitiesMutableBuilder[Self <: ExtLiabilities] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLiabilities(value: typingsSlinky.stellarBase.xdrMod.xdr.Liabilities): Self = StObject.set(x, "liabilities", value.asInstanceOf[js.Any])
  }
}
