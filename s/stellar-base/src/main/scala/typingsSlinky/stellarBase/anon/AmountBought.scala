...
object AmountBought {
  ...
  implicit class AmountBoughtOps[Self <: AmountBought] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssetBought(value: typingsSlinky.stellarBase.xdrMod.xdr.Asset): Self = this.set("assetBought", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAssetSold(value: typingsSlinky.stellarBase.xdrMod.xdr.Asset): Self = this.set("assetSold", value.asInstanceOf[js.Any])
