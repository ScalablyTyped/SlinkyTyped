...
trait BytesRead extends StObject {
  ...
  var id: typingsSlinky.stellarBase.xdrMod.xdr.NodeId = js.native
...
object BytesRead {
  ...
  def apply(
    ...
    id: typingsSlinky.stellarBase.xdrMod.xdr.NodeId,
    messagesRead: Uint64,
  ...
  implicit class BytesReadMutableBuilder[Self <: BytesRead] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setId(value: typingsSlinky.stellarBase.xdrMod.xdr.NodeId): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
