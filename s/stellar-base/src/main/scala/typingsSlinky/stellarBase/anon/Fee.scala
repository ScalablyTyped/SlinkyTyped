...
object Fee {
  ...
  implicit class FeeMutableBuilder[Self <: Fee] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOperations(value: js.Array[typingsSlinky.stellarBase.xdrMod.xdr.Operation[Operation]]): Self = StObject.set(x, "operations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOperationsVarargs(value: typingsSlinky.stellarBase.xdrMod.xdr.Operation[Operation]*): Self = StObject.set(x, "operations", js.Array(value :_*))
