...
import typingsSlinky.stellarBase.xdrMod.xdr.ScpStatementPledges
import typingsSlinky.stellarBase.xdrMod.xdr.Uint64
...
trait NodeId extends StObject {
  ...
  var nodeId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId = js.native
...
object NodeId {
  ...
  @scala.inline
  def apply(
    nodeId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId,
  ...
  implicit class NodeIdMutableBuilder[Self <: NodeId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNodeId(value: typingsSlinky.stellarBase.xdrMod.xdr.NodeId): Self = StObject.set(x, "nodeId", value.asInstanceOf[js.Any])
