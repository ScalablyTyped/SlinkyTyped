...
import typingsSlinky.stellarBase.xdrMod.xdr.LedgerEntryChange
import typingsSlinky.stellarBase.xdrMod.xdr.TransactionMeta
import typingsSlinky.stellarBase.xdrMod.xdr.TransactionResultPair
