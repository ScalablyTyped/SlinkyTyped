...
object DestAsset {
  ...
  implicit class DestAssetOps[Self <: DestAsset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDestAsset(value: typingsSlinky.stellarBase.xdrMod.xdr.Asset): Self = this.set("destAsset", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPathVarargs(value: typingsSlinky.stellarBase.xdrMod.xdr.Asset*): Self = this.set("path", js.Array(value :_*))
    @scala.inline
    def setPath(value: js.Array[typingsSlinky.stellarBase.xdrMod.xdr.Asset]): Self = this.set("path", value.asInstanceOf[js.Any])
    @scala.inline
    def setSendAmount(value: Int64): Self = this.set("sendAmount", value.asInstanceOf[js.Any])
    @scala.inline
    def setSendAsset(value: typingsSlinky.stellarBase.xdrMod.xdr.Asset): Self = this.set("sendAsset", value.asInstanceOf[js.Any])
  }
