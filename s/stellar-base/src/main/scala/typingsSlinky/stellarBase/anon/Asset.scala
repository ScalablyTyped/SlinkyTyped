...
import typingsSlinky.stellarBase.xdrMod.xdr.AllowTrustOpAsset
...
trait Asset extends StObject {
  ...
  var trustor: typingsSlinky.stellarBase.xdrMod.xdr.AccountId = js.native
}
object Asset {
  ...
  def apply(
    ...
    authorize: Double,
    trustor: typingsSlinky.stellarBase.xdrMod.xdr.AccountId
  ): Asset = {
  ...
  implicit class AssetMutableBuilder[Self <: Asset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTrustor(value: typingsSlinky.stellarBase.xdrMod.xdr.AccountId): Self = StObject.set(x, "trustor", value.asInstanceOf[js.Any])
  }
}
