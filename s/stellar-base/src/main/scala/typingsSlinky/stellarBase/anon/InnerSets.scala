...
import typingsSlinky.stellarBase.xdrMod.xdr.ScpQuorumSet
...
trait InnerSets extends StObject {
  ...
  var validators: js.Array[typingsSlinky.stellarBase.xdrMod.xdr.PublicKey] = js.native
}
object InnerSets {
  ...
  def apply(
    ...
    threshold: Double,
    validators: js.Array[typingsSlinky.stellarBase.xdrMod.xdr.PublicKey]
  ): InnerSets = {
  ...
  implicit class InnerSetsMutableBuilder[Self <: InnerSets] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidators(value: js.Array[typingsSlinky.stellarBase.xdrMod.xdr.PublicKey]): Self = StObject.set(x, "validators", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValidatorsVarargs(value: typingsSlinky.stellarBase.xdrMod.xdr.PublicKey*): Self = StObject.set(x, "validators", js.Array(value :_*))
  }
}
