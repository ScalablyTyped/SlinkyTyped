...
object InnerSets {
  ...
  implicit class InnerSetsOps[Self <: InnerSets] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidatorsVarargs(value: typingsSlinky.stellarBase.xdrMod.xdr.PublicKey*): Self = this.set("validators", js.Array(value :_*))
    
    @scala.inline
    def setValidators(value: js.Array[typingsSlinky.stellarBase.xdrMod.xdr.PublicKey]): Self = this.set("validators", value.asInstanceOf[js.Any])
  }
}
