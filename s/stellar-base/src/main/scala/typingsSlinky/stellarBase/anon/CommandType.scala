...
object CommandType {
  ...
  implicit class CommandTypeOps[Self <: CommandType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSurveyedPeerId(value: typingsSlinky.stellarBase.xdrMod.xdr.NodeId): Self = this.set("surveyedPeerId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSurveyorPeerId(value: typingsSlinky.stellarBase.xdrMod.xdr.NodeId): Self = this.set("surveyorPeerId", value.asInstanceOf[js.Any])
  }
}
