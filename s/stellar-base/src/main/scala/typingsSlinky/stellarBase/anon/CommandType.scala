...
import typingsSlinky.stellarBase.xdrMod.xdr.Curve25519Public
import typingsSlinky.stellarBase.xdrMod.xdr.SurveyMessageCommandType
...
trait CommandType extends StObject {
  ...
  var surveyedPeerId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId = js.native
  
  var surveyorPeerId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId = js.native
}
object CommandType {
  ...
  def apply(
    ...
    ledgerNum: Double,
    surveyedPeerId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId,
    surveyorPeerId: typingsSlinky.stellarBase.xdrMod.xdr.NodeId
  ): CommandType = {
  ...
  implicit class CommandTypeMutableBuilder[Self <: CommandType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSurveyedPeerId(value: typingsSlinky.stellarBase.xdrMod.xdr.NodeId): Self = StObject.set(x, "surveyedPeerId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSurveyorPeerId(value: typingsSlinky.stellarBase.xdrMod.xdr.NodeId): Self = StObject.set(x, "surveyorPeerId", value.asInstanceOf[js.Any])
  }
}
