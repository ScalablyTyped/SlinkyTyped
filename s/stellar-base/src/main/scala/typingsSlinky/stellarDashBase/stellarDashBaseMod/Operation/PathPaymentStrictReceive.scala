...
trait PathPaymentStrictReceive
  extends BaseOperation[
      typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.PathPaymentStrictReceive
    ] {
...
object PathPaymentStrictReceive {
  ...
  def apply(
    ...
    sendAsset: Asset,
    sendMax: String,
    `type`: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.PathPaymentStrictReceive,
    source: String = null
...
object pathPaymentStrictReceive extends js.Object {
  def apply(
    options: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationOptions.PathPaymentStrictReceive
  ): typingsSlinky.stellarDashBase.stellarDashBaseMod.xdr.Operation[PathPaymentStrictReceive] = js.native
}
