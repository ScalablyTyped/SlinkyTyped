...
trait PathPaymentStrictSend
  extends BaseOperation[
      typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.PathPaymentStrictSend
    ] {
  var destAsset: Asset
  var destMin: String
...
object PathPaymentStrictSend {
  ...
  def apply(
    ...
    sendAmount: String,
    sendAsset: Asset,
    `type`: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.PathPaymentStrictSend,
    source: String = null
...
object pathPaymentStrictSend extends js.Object {
  def apply(options: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationOptions.PathPaymentStrictSend): typingsSlinky.stellarDashBase.stellarDashBaseMod.xdr.Operation[PathPaymentStrictSend] = js.native
}
