...
class Asset protected () extends js.Object {
  ...
  def toXDRObject(): typingsSlinky.stellarDashBase.stellarDashBaseMod.xdr.Asset = js.native
}
...
object Asset extends js.Object {
  def fromOperation(xdr: typingsSlinky.stellarDashBase.stellarDashBaseMod.xdr.Asset): Asset = js.native
