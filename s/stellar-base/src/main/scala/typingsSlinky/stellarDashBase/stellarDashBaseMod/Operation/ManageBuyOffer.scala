...
trait ManageBuyOffer
  extends BaseOperation[typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.ManageBuyOffer] {
...
object ManageBuyOffer {
  ...
  def apply(
    ...
    price: String,
    selling: Asset,
    `type`: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.ManageBuyOffer,
    source: String = null
  ): ManageBuyOffer = {
...
object manageBuyOffer extends js.Object {
  def apply(options: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationOptions.ManageBuyOffer): typingsSlinky.stellarDashBase.stellarDashBaseMod.xdr.Operation[ManageBuyOffer] = js.native
}
