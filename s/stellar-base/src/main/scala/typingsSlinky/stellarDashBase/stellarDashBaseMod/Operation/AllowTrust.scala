...
trait AllowTrust
  extends BaseOperation[typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.AllowTrust] {
...
object AllowTrust {
  ...
  def apply(
    assetCode: String,
    trustor: String,
    `type`: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationType.AllowTrust,
...
object allowTrust extends js.Object {
  def apply(options: typingsSlinky.stellarDashBase.stellarDashBaseMod.OperationOptions.AllowTrust): typingsSlinky.stellarDashBase.stellarDashBaseMod.xdr.Operation[AllowTrust] = js.native
}
