package typingsSlinky.simpleDashStatistics

import typingsSlinky.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.Data
import typingsSlinky.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.Item
import typingsSlinky.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.OddsSums
import typingsSlinky.simpleDashStatistics.srcChiUnderscoreSquaredUnderscoreDistributionUnderscoreTableMod.DistributionTable
import typingsSlinky.simpleDashStatistics.srcKernelUnderscoreDensityUnderscoreEstimationMod.BandwidthMethods
import typingsSlinky.simpleDashStatistics.srcKernelUnderscoreDensityUnderscoreEstimationMod.Kernels
...
@js.native
object simpleDashStatisticsMod extends js.Object {
  /**
    * https://simplestatistics.org/docs/#bayesianclassifier
    */
  @js.native
  class BayesianClassifier ()
    extends typingsSlinky.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.BayesianClassifier {
    /* CompleteClass */
  ...
  class PerceptronModel ()
    extends typingsSlinky.simpleDashStatistics.srcPerceptronMod.PerceptronModel {
    /* CompleteClass */
    ...
    /* CompleteClass */
    override def train(features: js.Array[Double], label: Double): typingsSlinky.simpleDashStatistics.srcPerceptronMod.PerceptronModel = js.native
  }
  ...
  def linearRegression(data: js.Array[js.Array[Double]]): Anon_B = js.native
  def linearRegressionLine(mb: Anon_BM): js.Function1[/* x */ Double, Double] = js.native
