...
import typingsSlinky.simpleDashStatistics.simpleDashStatisticsStrings.gaussian
import typingsSlinky.simpleDashStatistics.simpleDashStatisticsStrings.nrd
