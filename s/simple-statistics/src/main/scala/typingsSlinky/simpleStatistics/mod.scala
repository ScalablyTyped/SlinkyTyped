...
import typingsSlinky.simpleStatistics.anon.M
import typingsSlinky.simpleStatistics.bayesianClassifierMod.default
...
object mod {
  ...
  class PerceptronModel ()
    extends typingsSlinky.simpleStatistics.perceptronMod.default
