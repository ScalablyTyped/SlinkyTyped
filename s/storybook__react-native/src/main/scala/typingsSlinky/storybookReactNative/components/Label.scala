...
import typingsSlinky.storybookReactNative.anon.PickTextPropsRefAttribute
...
object Label {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def accessibilityStates(value: js.Any): this.type = set("accessibilityStates", value.asInstanceOf[js.Any])
  ...
  def withProps(
    p: TextProps with RefAttributes[Text] with (Omit[PickTextPropsRefAttribute, theme]) with `0`[BackgroundColor]
