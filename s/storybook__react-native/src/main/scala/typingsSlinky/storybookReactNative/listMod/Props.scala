package typingsSlinky.storybookReactNative.listMod
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnPressAddon(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onPressAddon")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
