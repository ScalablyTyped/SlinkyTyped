...
import typingsSlinky.atStorybookReactDashNative.distPreviewComponentsOnDeviceUINavigationBarMod.default
...
object Bar
  ...
  type Props = typingsSlinky.atStorybookReactDashNative.distPreviewComponentsOnDeviceUINavigationBarMod.Props
}
