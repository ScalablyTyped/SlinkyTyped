...
import typingsSlinky.atStorybookReactDashNative.distPreviewComponentsOnDeviceUIAddonsWrapperMod.default
...
object Wrapper
  ...
  type Props = typingsSlinky.atStorybookReactDashNative.distPreviewComponentsOnDeviceUIAddonsWrapperMod.Props
}
