...
import typingsSlinky.atStorybookReactDashNative.distPreviewComponentsOnDeviceUIPanelMod.default
...
object Panel
  ...
  type Props = typingsSlinky.atStorybookReactDashNative.distPreviewComponentsOnDeviceUIPanelMod.Props
}
