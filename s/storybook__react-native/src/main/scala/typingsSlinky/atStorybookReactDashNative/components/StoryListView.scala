...
import typingsSlinky.atStorybookReactDashNative.distPreviewComponentsStoryListViewMod.default
...
object StoryListView
  ...
  type Props = typingsSlinky.atStorybookReactDashNative.distPreviewComponentsStoryListViewMod.Props
}
