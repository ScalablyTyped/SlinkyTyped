...
object ChatInstanceFlags extends StObject {
  ...
  /* 0x000FFFFF + 1 >> 1 */ val Clan: typingsSlinky.steamid.mod.ChatInstanceFlags.Clan with scala.Nothing = js.native
  ...
  /* 0x000FFFFF + 1 >> 2 */ val Lobby: typingsSlinky.steamid.mod.ChatInstanceFlags.Lobby with scala.Nothing = js.native
  ...
  /* 0x000FFFFF + 1 >> 3 */ val MMSLobby: typingsSlinky.steamid.mod.ChatInstanceFlags.MMSLobby with scala.Nothing = js.native
}
