...
import typingsSlinky.socketDotIo.socketDotIoMod.Adapter
import typingsSlinky.socketDotIoDashRedis.Anon_Except
...
trait RedisAdapter extends Adapter {
  ...
  def broadcast(packet: js.Any, opts: Anon_Except, remote: Boolean): Unit = js.native
  /**
