...
object mod {
  ...
  class DeluxeSignal protected ()
    extends typingsSlinky.signalsJs.deluxeSignalMod.DeluxeSignal {
  ...
  @js.native
  class GenericEvent ()
    extends typingsSlinky.signalsJs.genericEventMod.GenericEvent {
  ...
  class MonoSignal protected ()
    extends typingsSlinky.signalsJs.monoSignalMod.MonoSignal {
    /**
  ...
  class OnceSignal protected ()
    extends typingsSlinky.signalsJs.onceSignalMod.OnceSignal {
    /**
  ...
  class PrioritySignal protected ()
    extends typingsSlinky.signalsJs.prioritySignalMod.PrioritySignal {
    def this(valueClasses: js.Any*) = this()
  }
  ...
  class Promise protected ()
    extends typingsSlinky.signalsJs.promiseMod.Promise {
    /**
      * Creates a Signal instance to dispatch value objects.
      * @param    valueClasses Any number of class references that enable type checks in dispatch().
      * For example, new Signal(String, uint)
  ...
  class Signal protected ()
    extends typingsSlinky.signalsJs.signalMod.Signal {
    /**
      * Creates a Signal instance to dispatch value objects.
      * @param    valueClasses Any number of class references that enable type checks in dispatch().
      * For example, new Signal(String, uint)
  ...
  class Slot protected ()
    extends typingsSlinky.signalsJs.slotMod.Slot {
    /**
  ...
  class SlotList protected ()
    extends typingsSlinky.signalsJs.slotListMod.SlotList {
    /**
    ...
    def this(head: ISlot, tail: typingsSlinky.signalsJs.slotListMod.SlotList) = this()
  }
  /* static members */
  object SlotList {
    ...
    @js.native
    def NIL: typingsSlinky.signalsJs.slotListMod.SlotList = js.native
    @scala.inline
    def NIL_=(x: typingsSlinky.signalsJs.slotListMod.SlotList): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NIL")(x.asInstanceOf[js.Any])
  }
}
