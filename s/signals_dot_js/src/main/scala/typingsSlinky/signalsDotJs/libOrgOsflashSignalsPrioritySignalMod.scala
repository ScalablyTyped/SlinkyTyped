...
import typingsSlinky.signalsDotJs.libOrgOsflashSignalsSignalMod.Signal
...
@js.native
object libOrgOsflashSignalsPrioritySignalMod extends js.Object {
  /* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
  - typings.signalsDotJs.libOrgOsflashSignalsIOnceSignalMod.IOnceSignal because Already inherited
  - typings.signalsDotJs.libOrgOsflashSignalsISignalMod.ISignal because Already inherited
  - typings.signalsDotJs.libOrgOsflashSignalsIPrioritySignalMod.IPrioritySignal because var conflicts: numListeners, valueClasses. Inlined addWithPriority, addOnceWithPriority */ @js.native
