package typingsSlinky.signalsDotJs.libOrgOsflashSignalsEventsIEventMod

import typingsSlinky.signalsDotJs.libOrgOsflashSignalsIPrioritySignalMod.IPrioritySignal
