...
import typingsSlinky.scanf.scanfStrings.`%S`
import typingsSlinky.scanf.scanfStrings.`%d`
import typingsSlinky.scanf.scanfStrings.`%f`
import typingsSlinky.scanf.scanfStrings.`%o`
import typingsSlinky.scanf.scanfStrings.`%s_`
import typingsSlinky.scanf.scanfStrings.`%x`
