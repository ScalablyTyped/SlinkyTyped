...
trait DefaultValue extends StObject {
  ...
  def children(value: js.Any, step: Double): ReactElement = js.native
...
object DefaultValue {
  ...
  @scala.inline
  def apply(children: (js.Any, Double) => ReactElement, values: js.Array[_]): DefaultValue = {
  ...
  implicit class DefaultValueMutableBuilder[Self <: DefaultValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: (js.Any, Double) => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
