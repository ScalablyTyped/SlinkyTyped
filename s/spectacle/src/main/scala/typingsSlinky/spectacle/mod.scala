...
import typingsSlinky.spectacle.anon.childrenReactNodeLayoutPr
...
object mod {
  ...
  @js.native
  val Appear: ReactComponentClass[Children] = js.native
  ...
  @js.native
  val CodePane: ReactComponentClass[AutoFillHeight] = js.native
  
  @JSImport("spectacle", "CodeSpan")
  @js.native
  val CodeSpan: ReactComponentClass[TypographyProps] = js.native
  
  @JSImport("spectacle", "Deck")
  @js.native
  val Deck: ReactComponentClass[AnimationsWhenGoingBack] = js.native
  
  @JSImport("spectacle", "FlexBox")
  @js.native
  val FlexBox: ReactComponentClass[
  ...
  @js.native
  val FullScreen: ReactComponentClass[Color] = js.native
  
  @JSImport("spectacle", "FullSizeImage")
  @js.native
  val FullSizeImage: ReactComponentClass[
    ImgHTMLAttributes[js.Object] with LayoutProps[RequiredTheme] with PositionProps[RequiredTheme]
  ] = js.native
  
  @JSImport("spectacle", "Grid")
  @js.native
  val Grid: ReactComponentClass[childrenReactNodeLayoutPr] = js.native
  
  @JSImport("spectacle", "Heading")
  @js.native
  val Heading: ReactComponentClass[TypographyProps] = js.native
  ...
  @js.native
  val Link: ReactComponentClass[TypographyProps with AnchorHTMLAttributes[js.Object]] = js.native
  
  @JSImport("spectacle", "ListItem")
  @js.native
  val ListItem: ReactComponentClass[TypographyProps] = js.native
  
  @JSImport("spectacle", "Markdown")
  @js.native
  val Markdown: ReactComponentClass[ContainsSlides] = js.native
  
  @JSImport("spectacle", "Notes")
  @js.native
  val Notes: ReactComponentClass[ChildrenReactNode] = js.native
  
  @JSImport("spectacle", "OrderedList")
  @js.native
  val OrderedList: ReactComponentClass[TypographyProps] = js.native
  
  @JSImport("spectacle", "Progress")
  @js.native
  val Progress: ReactComponentClass[Color] = js.native
  
  @JSImport("spectacle", "Quote")
  @js.native
  val Quote: ReactComponentClass[TypographyProps] = js.native
  
  @JSImport("spectacle", "Slide")
  @js.native
  val Slide: ReactComponentClass[BackgroundColor] = js.native
  
  @JSImport("spectacle", "SpectacleLogo")
  @js.native
  val SpectacleLogo: ReactComponentClass[Size] = js.native
  
  @JSImport("spectacle", "Stepper")
  @js.native
  val Stepper: ReactComponentClass[DefaultValue] = js.native
  
  @JSImport("spectacle", "Text")
  @js.native
  val Text: ReactComponentClass[TypographyProps] = js.native
  
  @JSImport("spectacle", "UnorderedList")
  @js.native
  val UnorderedList: ReactComponentClass[TypographyProps] = js.native
  ...
  @js.native
  val mdxComponentMap: Record[String, ReactElement] = js.native
  ...
  type TemplateFn = js.Function1[/* options */ CurrentSlide, ReactElement]
