...
object SlideProps {
  ...
  def apply(
    ...
    lastSlideIndex: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(lastSlideIndex)) __obj.updateDynamic("lastSlideIndex")(lastSlideIndex.get.asInstanceOf[js.Any])
