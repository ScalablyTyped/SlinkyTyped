...
object Fill {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.spectacle.mod.Fill] {
    @scala.inline
  ...
  implicit def make(companion: Fill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
