...
object S {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.spectacle.mod.S] {
    @scala.inline
    ...
    @scala.inline
    def `type`(value: sType | js.Array[sType]): this.type = set("type", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: SProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: S.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
