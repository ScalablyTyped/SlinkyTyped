...
import typingsSlinky.spectacle.mod.LinkProps
import typingsSlinky.spectacle.mod.targetType
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Link
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.spectacle.mod.Link] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.spectacle.mod.Link] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.spectacle.mod.Link] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.spectacle.mod.Link](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
