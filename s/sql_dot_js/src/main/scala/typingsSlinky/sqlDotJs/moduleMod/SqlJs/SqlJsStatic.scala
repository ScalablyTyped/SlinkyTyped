...
trait SqlJsStatic extends js.Object {
  var Database: Instantiable0[typingsSlinky.sqlDotJs.moduleMod.SqlJs.Database]
  var Statement: Instantiable0[typingsSlinky.sqlDotJs.moduleMod.SqlJs.Statement]
}
