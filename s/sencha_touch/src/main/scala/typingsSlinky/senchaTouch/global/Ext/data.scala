...
import typingsSlinky.senchaTouch.Ext.util.IHashMap
...
object data {
  ...
  @js.native
  class JsonP ()
    extends typingsSlinky.senchaTouch.Ext.data.JsonP
  /* static members */
  object JsonP {
  ...
  @js.native
  class Model ()
    extends typingsSlinky.senchaTouch.Ext.data.Model
  /* static members */
  object Model {
  ...
  @js.native
  class ModelManager ()
    extends typingsSlinky.senchaTouch.Ext.data.ModelManager
  /* static members */
  object ModelManager {
  ...
  @js.native
  class Node ()
    extends typingsSlinky.senchaTouch.Ext.data.Node
  /* static members */
  object Node {
  ...
  @js.native
  class NodeInterface ()
    extends typingsSlinky.senchaTouch.Ext.data.NodeInterface
  /* static members */
  ...
  @js.native
  class Record ()
    extends typingsSlinky.senchaTouch.Ext.data.Record
  /* static members */
  object Record {
  ...
  @js.native
  class SortTypes ()
    extends typingsSlinky.senchaTouch.Ext.data.SortTypes
  /* static members */
  object SortTypes {
    ...
    @scala.inline
    def stripTagsRE_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("stripTagsRE")(x.asInstanceOf[js.Any])
  }
  
  @JSGlobal("Ext.data.StoreManager")
  @js.native
  class StoreManager ()
    extends typingsSlinky.senchaTouch.Ext.data.StoreManager
  /* static members */
  object StoreManager {
  ...
  @js.native
  class StoreMgr ()
    extends typingsSlinky.senchaTouch.Ext.data.StoreMgr
  /* static members */
  object StoreMgr {
  ...
  @js.native
  class Types ()
    extends typingsSlinky.senchaTouch.Ext.data.Types
  /* static members */
  object Types {
    ...
    @scala.inline
    def stripRe_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("stripRe")(x.asInstanceOf[js.Any])
  }
  
  @JSGlobal("Ext.data.Validations")
  @js.native
  class Validations ()
    extends typingsSlinky.senchaTouch.Ext.data.Validations
  /* static members */
  object Validations {
    ...
    @scala.inline
    def emailRe_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("emailRe")(x.asInstanceOf[js.Any])
