...
import typingsSlinky.senchaTouch.Ext.draw.IMatrix
...
object draw {
  ...
  @js.native
  class Draw ()
    extends typingsSlinky.senchaTouch.Ext.draw.Draw
  /* static members */
  object Draw {
    ...
    @JSGlobal("Ext.draw.Draw.spline")
    @js.native
    def spline(points: typingsSlinky.senchaTouch.Ext.Array): Unit = js.native
  ...
  @js.native
  class Matrix ()
    extends typingsSlinky.senchaTouch.Ext.draw.Matrix
  /* static members */
  object Matrix {
    ...
    @JSGlobal("Ext.draw.Matrix.fly")
    @js.native
    def fly(elements: typingsSlinky.senchaTouch.Ext.Array): IMatrix = js.native
  ...
  @js.native
  class Solver ()
    extends typingsSlinky.senchaTouch.Ext.draw.Solver
  /* static members */
  object Solver {
  ...
  @js.native
  class Surface ()
    extends typingsSlinky.senchaTouch.Ext.draw.Surface
  /* static members */
  object Surface {
    ...
    @JSGlobal("Ext.draw.Surface.stableSort")
    @js.native
    def stableSort(list: typingsSlinky.senchaTouch.Ext.Array): Unit = js.native
  ...
  @js.native
  class TextMeasurer ()
    extends typingsSlinky.senchaTouch.Ext.draw.TextMeasurer
  /* static members */
  object TextMeasurer {
  ...
  class TimingFunctions ()
    extends typingsSlinky.senchaTouch.Ext.draw.TimingFunctions
  /* static members */
  ...
  object sprite {
    ...
    class AnimationParser ()
      extends typingsSlinky.senchaTouch.Ext.draw.sprite.AnimationParser
    /* static members */
    ...
    class AttributeParser ()
      extends typingsSlinky.senchaTouch.Ext.draw.sprite.AttributeParser
    /* static members */
