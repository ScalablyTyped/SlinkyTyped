...
@js.native
class Object ()
  extends typingsSlinky.senchaTouch.Ext.Object
...
object Object extends js.Object {
  ...
  /** [Method] Gets all keys of the given object as an array
    ...
    */
  def getKeys(): typingsSlinky.senchaTouch.Ext.Array = js.native
  def getKeys(`object`: js.Any): typingsSlinky.senchaTouch.Ext.Array = js.native
  ...
  /** [Method] Gets all values of the given object as an array
    ...
    */
  def getValues(): typingsSlinky.senchaTouch.Ext.Array = js.native
  def getValues(`object`: js.Any): typingsSlinky.senchaTouch.Ext.Array = js.native
  ...
  /** [Method] Convert a name  value pair to an array of objects with support for nested structures useful to construct query stri
    ...
    */
  def toQueryObjects(): typingsSlinky.senchaTouch.Ext.Array = js.native
  def toQueryObjects(name: js.UndefOr[scala.Nothing], value: js.UndefOr[scala.Nothing], recursive: Boolean): typingsSlinky.senchaTouch.Ext.Array = js.native
  def toQueryObjects(name: js.UndefOr[scala.Nothing], value: js.Any): typingsSlinky.senchaTouch.Ext.Array = js.native
  def toQueryObjects(name: js.UndefOr[scala.Nothing], value: js.Any, recursive: Boolean): typingsSlinky.senchaTouch.Ext.Array = js.native
  def toQueryObjects(name: java.lang.String): typingsSlinky.senchaTouch.Ext.Array = js.native
  def toQueryObjects(name: java.lang.String, value: js.UndefOr[scala.Nothing], recursive: Boolean): typingsSlinky.senchaTouch.Ext.Array = js.native
  def toQueryObjects(name: java.lang.String, value: js.Any): typingsSlinky.senchaTouch.Ext.Array = js.native
  def toQueryObjects(name: java.lang.String, value: js.Any, recursive: Boolean): typingsSlinky.senchaTouch.Ext.Array = js.native
