...
import typingsSlinky.senchaTouch.Ext.ILoader
...
@js.native
class Loader ()
  extends typingsSlinky.senchaTouch.Ext.Loader
/* static members */
object Loader {
  ...
  @JSGlobal("Ext.Loader.addClassPathMappings")
  @js.native
  def addClassPathMappings(paths: typingsSlinky.senchaTouch.Ext.Object): ILoader = js.native
  ...
  @JSGlobal("Ext.Loader.exclude")
  @js.native
  def exclude(excludes: typingsSlinky.senchaTouch.Ext.Array): js.Any = js.native
  ...
  @js.native
  def history: typingsSlinky.senchaTouch.Ext.Array = js.native
  @scala.inline
  def history_=(x: typingsSlinky.senchaTouch.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("history")(x.asInstanceOf[js.Any])
