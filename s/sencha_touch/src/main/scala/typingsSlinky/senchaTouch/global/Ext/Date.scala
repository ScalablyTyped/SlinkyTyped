...
@js.native
class Date ()
  extends typingsSlinky.senchaTouch.Ext.Date
/* static members */
object Date {
  ...
  @js.native
  def dayNames: typingsSlinky.senchaTouch.Ext.Array = js.native
  @scala.inline
  def dayNames_=(x: typingsSlinky.senchaTouch.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dayNames")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def monthNames: typingsSlinky.senchaTouch.Ext.Array = js.native
  @scala.inline
  def monthNames_=(x: typingsSlinky.senchaTouch.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("monthNames")(x.asInstanceOf[js.Any])
