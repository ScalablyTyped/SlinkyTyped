package typingsSlinky.senchaTouch.global.Ext.data
...
object ModelManager extends js.Object {
  ...
  def create(data: js.UndefOr[scala.Nothing], name: String): js.Any = js.native
  def create(data: js.UndefOr[scala.Nothing], name: String, id: Double): js.Any = js.native
  ...
  def onAvailable(id: String, fn: js.UndefOr[scala.Nothing], scope: js.Any): Unit = js.native
