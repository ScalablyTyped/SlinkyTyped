...
object association {
  ...
  trait IAssociation extends IBase {
    ...
    /** [Method] Returns the value of reader
      ...
      */
    var getReader: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.data.reader.IReader]] = js.native
    ...
    var reader: js.UndefOr[typingsSlinky.senchaTouch.Ext.data.reader.IReader] = js.native
    ...
    var setReader: js.UndefOr[
        js.Function1[/* reader */ js.UndefOr[typingsSlinky.senchaTouch.Ext.data.reader.IReader], Unit]
      ] = js.native
  ...
  object IAssociation {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.data.association.IAssociation = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.data.association.IAssociation]
    }
    
    @scala.inline
    implicit class IAssociationMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.data.association.IAssociation] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetReader(value: () => typingsSlinky.senchaTouch.Ext.data.reader.IReader): Self = StObject.set(x, "getReader", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setReader(value: typingsSlinky.senchaTouch.Ext.data.reader.IReader): Self = StObject.set(x, "reader", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSetReader(value: /* reader */ js.UndefOr[typingsSlinky.senchaTouch.Ext.data.reader.IReader] => Unit): Self = StObject.set(x, "setReader", js.Any.fromFunction1(value))
