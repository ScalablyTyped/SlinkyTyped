...
object filesystem {
  ...
  trait IEntry extends IBase {
    ...
    /** [Method] Returns the file system on which the entry resides
      ...
      */
    var getFileSystem: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.device.filesystem.IFileSystem]] = js.native
  ...
  object IEntry {
    ...
    implicit class IEntryMutableBuilder[Self <: IEntry] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetFileSystem(value: () => typingsSlinky.senchaTouch.Ext.device.filesystem.IFileSystem): Self = StObject.set(x, "getFileSystem", js.Any.fromFunction0(value))
  ...
  object IFileSystem {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.device.filesystem.IFileSystem = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.device.filesystem.IFileSystem]
    }
    
    @scala.inline
    implicit class IFileSystemMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.device.filesystem.IFileSystem] (val x: Self) extends AnyVal {
