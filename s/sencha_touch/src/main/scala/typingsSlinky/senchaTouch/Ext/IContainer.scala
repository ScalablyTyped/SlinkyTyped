...
object IContainer {
  ...
  implicit class IContainerOps[Self <: IContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: /* newItems */ js.UndefOr[js.Any] => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withChild(value: /* selector */ js.UndefOr[java.lang.String] => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDefaultType(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDown(value: /* selector */ js.UndefOr[java.lang.String] => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetAt(value: /* index */ js.UndefOr[Double] => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetComponent(value: /* component */ js.UndefOr[js.Any] => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetDefaultType(value: () => java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRemove(value: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRemoveAll(value: (/* destroy */ js.UndefOr[Boolean], /* everything */ js.UndefOr[Boolean]) => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRemoveDocked(value: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => IComponent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetDefaultType(value: /* defaultType */ js.UndefOr[java.lang.String] => Unit): Self = {
        val ret = this.duplicate
