...
object layout {
  ...
  object IDefault {
    ...
    implicit class IDefaultMutableBuilder[Self <: IDefault] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAnimation(value: typingsSlinky.senchaTouch.Ext.fx.layout.ICard): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAnimationUndefined: Self = StObject.set(x, "animation", js.undefined)
      
      @scala.inline
      def setGetAnimation(value: () => typingsSlinky.senchaTouch.Ext.fx.layout.ICard): Self = StObject.set(x, "getAnimation", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setSetAnimation(value: /* animation */ js.UndefOr[typingsSlinky.senchaTouch.Ext.fx.layout.ICard] => Unit): Self = StObject.set(x, "setAnimation", js.Any.fromFunction1(value))
