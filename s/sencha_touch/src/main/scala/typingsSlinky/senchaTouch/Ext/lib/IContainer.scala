...
trait IContainer
  ...
  /** [Method] Hides this Component optionally using an animation
  		...
  		*/
  @JSName("hide")
  var hide_IContainer: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.IComponent]] = js.undefined
  ...
  /** [Method] Shows this component optionally using an animation
  		...
  		*/
  @JSName("show")
  var show_IContainer: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.IComponent]] = js.undefined
...
object IContainer {
  @scala.inline
  def apply(
    IComponent: typingsSlinky.senchaTouch.Ext.IComponent = null,
    activeItem: js.Any = null,
    add: /* newItems */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.IComponent = null,
    ...
    child: /* selector */ js.UndefOr[String] => typingsSlinky.senchaTouch.Ext.IComponent = null,
    control: js.Any = null,
    defaultType: String = null,
    defaults: js.Any = null,
    down: /* selector */ js.UndefOr[String] => typingsSlinky.senchaTouch.Ext.IComponent = null,
    getActiveItem: () => _ = null,
    getAt: /* index */ js.UndefOr[Double] => typingsSlinky.senchaTouch.Ext.IComponent = null,
    getAutoDestroy: () => Boolean = null,
    getComponent: /* component */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.IComponent = null,
    getControl: () => _ = null,
    ...
    hide: () => typingsSlinky.senchaTouch.Ext.IComponent = null,
    ...
    remove: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.IComponent = null,
    removeAll: (/* destroy */ js.UndefOr[Boolean], /* everything */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.IComponent = null,
    removeAt: /* index */ js.UndefOr[Double] => IContainer = null,
    removeDocked: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.IComponent = null,
    ...
    show: () => typingsSlinky.senchaTouch.Ext.IComponent = null,
    unmask: () => Unit = null
  ): IContainer = {
