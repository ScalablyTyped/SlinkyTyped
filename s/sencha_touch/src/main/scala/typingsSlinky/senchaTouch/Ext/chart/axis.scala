...
object axis {
  ...
  object segmenter {
    ...
    object INumeric {
      ...
      @scala.inline
      def apply(): typingsSlinky.senchaTouch.Ext.chart.axis.segmenter.INumeric = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.chart.axis.segmenter.INumeric]
      }
      
      @scala.inline
      implicit class INumericMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.chart.axis.segmenter.INumeric] (val x: Self) extends AnyVal {
    ...
    object ITime {
      ...
      @scala.inline
      def apply(): typingsSlinky.senchaTouch.Ext.chart.axis.segmenter.ITime = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.chart.axis.segmenter.ITime]
      }
      
      @scala.inline
      implicit class ITimeMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.chart.axis.segmenter.ITime] (val x: Self) extends AnyVal {
  ...
  object sprite {
    ...
    object IAxis {
      ...
      @scala.inline
      def apply(): typingsSlinky.senchaTouch.Ext.chart.axis.sprite.IAxis = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.chart.axis.sprite.IAxis]
      }
      
      @scala.inline
      implicit class IAxisMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.chart.axis.sprite.IAxis] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setAxis(value: typingsSlinky.senchaTouch.Ext.chart.axis.IAxis): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setGetAxis(value: () => typingsSlinky.senchaTouch.Ext.chart.axis.sprite.IAxis): Self = StObject.set(x, "getAxis", js.Any.fromFunction0(value))
        ...
        @scala.inline
        def setSetAxis(value: /* axis */ js.UndefOr[typingsSlinky.senchaTouch.Ext.chart.axis.sprite.IAxis] => Unit): Self = StObject.set(x, "setAxis", js.Any.fromFunction1(value))
