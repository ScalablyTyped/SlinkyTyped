...
object ICandleStick {
  ...
  implicit class ICandleStickOps[Self <: ICandleStick] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOhlcType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ohlcType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOhlcType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ohlcType")(js.undefined)
        ret
    }
    @scala.inline
