...
object lib {
  ...
  trait IComponent extends IEvented {
    ...
    var up: js.UndefOr[
        js.Function1[
          ...
          typingsSlinky.senchaTouch.Ext.IContainer
        ]
      ] = js.native
  ...
  object IComponent {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.lib.IComponent = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.lib.IComponent]
    }
    
    @scala.inline
    implicit class IComponentMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.lib.IComponent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetParent(value: () => typingsSlinky.senchaTouch.Ext.lib.IComponent): Self = StObject.set(x, "getParent", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setHide(value: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.lib.IComponent): Self = StObject.set(x, "hide", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setShow(value: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.lib.IComponent): Self = StObject.set(x, "show", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setShowBy(
        value: (/* component */ js.UndefOr[typingsSlinky.senchaTouch.Ext.lib.IComponent], /* alignment */ js.UndefOr[java.lang.String]) => Unit
      ...
      @scala.inline
      def setUp(value: /* selector */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.IContainer): Self = StObject.set(x, "up", js.Any.fromFunction1(value))
  ...
  object IContainer {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.lib.IContainer = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.lib.IContainer]
    }
    
    @scala.inline
    implicit class IContainerMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.lib.IContainer] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdd(value: /* newItems */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.IComponent): Self = StObject.set(x, "add", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setChild(value: /* selector */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.IComponent): Self = StObject.set(x, "child", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setDown(value: /* selector */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.IComponent): Self = StObject.set(x, "down", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setGetAt(value: /* index */ js.UndefOr[Double] => typingsSlinky.senchaTouch.Ext.IComponent): Self = StObject.set(x, "getAt", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setGetComponent(value: /* component */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.IComponent): Self = StObject.set(x, "getComponent", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setHide(value: () => typingsSlinky.senchaTouch.Ext.IComponent): Self = StObject.set(x, "hide", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setRemoveAt(value: /* index */ js.UndefOr[Double] => typingsSlinky.senchaTouch.Ext.lib.IContainer): Self = StObject.set(x, "removeAt", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRemoveInnerAt(value: /* index */ js.UndefOr[Double] => typingsSlinky.senchaTouch.Ext.lib.IContainer): Self = StObject.set(x, "removeInnerAt", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setShow(value: () => typingsSlinky.senchaTouch.Ext.IComponent): Self = StObject.set(x, "show", js.Any.fromFunction0(value))
  ...
  object IPanel {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.lib.IPanel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.lib.IPanel]
    }
    
    @scala.inline
    implicit class IPanelMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.lib.IPanel] (val x: Self) extends AnyVal {
