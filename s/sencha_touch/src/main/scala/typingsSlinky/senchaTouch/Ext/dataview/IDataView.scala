...
trait IDataView extends IContainer {
  ...
  /** [Method] Returns the value of emptyText
    * @returns String
    */
  var getEmptyText: js.UndefOr[js.Function0[String]] = js.native
  ...
  /** [Method] Returns the value of pressedCls
    * @returns String
    */
  var getPressedCls: js.UndefOr[js.Function0[String]] = js.native
  ...
  /** [Method] Returns the value of selectedCls
    * @returns String
    */
  var getSelectedCls: js.UndefOr[js.Function0[String]] = js.native
  ...
  /** [Method] Returns the value of triggerCtEvent
    * @returns String
    */
  var getTriggerCtEvent: js.UndefOr[js.Function0[String]] = js.native
  /** [Method] Returns the value of triggerEvent
    * @returns String
    */
  var getTriggerEvent: js.UndefOr[js.Function0[String]] = js.native
  ...
  /** [Method] Sets the value of emptyText
    ...
    */
  var setEmptyText: js.UndefOr[js.Function1[/* emptyText */ js.UndefOr[String], Unit]] = js.native
  ...
  /** [Method] Sets the value of mode
    ...
    */
  var setMode: js.UndefOr[js.Function1[js.UndefOr[String], Unit]] = js.native
  /** [Method] Sets the value of pressedCls
    * @param pressedCls String The new value.
    */
  var setPressedCls: js.UndefOr[js.Function1[/* pressedCls */ js.UndefOr[String], Unit]] = js.native
  ...
  /** [Method] Sets the value of selectedCls
    ...
    */
  var setSelectedCls: js.UndefOr[js.Function1[/* selectedCls */ js.UndefOr[String], Unit]] = js.native
  ...
  /** [Method] Sets the value of triggerCtEvent
    ...
    */
  var setTriggerCtEvent: js.UndefOr[js.Function1[/* triggerCtEvent */ js.UndefOr[String], Unit]] = js.native
  /** [Method] Sets the value of triggerEvent
    * @param triggerEvent String The new value.
    */
  var setTriggerEvent: js.UndefOr[js.Function1[/* triggerEvent */ js.UndefOr[String], Unit]] = js.native
  ...
  /** [Config Option] (String) */
  var triggerCtEvent: js.UndefOr[String] = js.native
  /** [Config Option] (String) */
...
object IDataView {
  ...
  implicit class IDataViewOps[Self <: IDataView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetEmptyText(value: () => String): Self = this.set("getEmptyText", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetPressedCls(value: () => String): Self = this.set("getPressedCls", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetSelectedCls(value: () => String): Self = this.set("getSelectedCls", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetTriggerCtEvent(value: () => String): Self = this.set("getTriggerCtEvent", js.Any.fromFunction0(value))
    @scala.inline
    def deleteGetTriggerCtEvent: Self = this.set("getTriggerCtEvent", js.undefined)
    @scala.inline
    def setGetTriggerEvent(value: () => String): Self = this.set("getTriggerEvent", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setSetEmptyText(value: /* emptyText */ js.UndefOr[String] => Unit): Self = this.set("setEmptyText", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSetMode(value: js.UndefOr[String] => Unit): Self = this.set("setMode", js.Any.fromFunction1(value))
    @scala.inline
    def deleteSetMode: Self = this.set("setMode", js.undefined)
    @scala.inline
    def setSetPressedCls(value: /* pressedCls */ js.UndefOr[String] => Unit): Self = this.set("setPressedCls", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSetSelectedCls(value: /* selectedCls */ js.UndefOr[String] => Unit): Self = this.set("setSelectedCls", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSetTriggerCtEvent(value: /* triggerCtEvent */ js.UndefOr[String] => Unit): Self = this.set("setTriggerCtEvent", js.Any.fromFunction1(value))
    @scala.inline
    def deleteSetTriggerCtEvent: Self = this.set("setTriggerCtEvent", js.undefined)
    @scala.inline
    def setSetTriggerEvent(value: /* triggerEvent */ js.UndefOr[String] => Unit): Self = this.set("setTriggerEvent", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setTriggerCtEvent(value: String): Self = this.set("triggerCtEvent", value.asInstanceOf[js.Any])
    @scala.inline
