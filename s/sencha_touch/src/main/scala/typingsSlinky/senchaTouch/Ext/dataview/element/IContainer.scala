package typingsSlinky.senchaTouch.Ext.dataview.element
...
object IContainer {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IContainer = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IContainer = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IContainer], /* alignment */ js.UndefOr[String]) => Unit = null,
    ...
    up: /* selector */ js.UndefOr[String] => typingsSlinky.senchaTouch.Ext.IContainer = null,
    update: () => Unit = null,
