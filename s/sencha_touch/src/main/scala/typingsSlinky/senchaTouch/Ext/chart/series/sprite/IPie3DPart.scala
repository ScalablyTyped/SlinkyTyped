...
- typingsSlinky.senchaTouch.Ext.chart.IMarkerHolder because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bindMarker */ trait IPie3DPart extends IPath {
...
object IPie3DPart {
  ...
  def apply(
    ...
    config: js.Any = null,
    destroy: () => Unit = null,
    distortion: js.UndefOr[Double] = js.undefined,
    ...
    updatePath: /* path */ js.UndefOr[js.Any] => Unit = null,
    ...
    if (!js.isUndefined(distortion)) __obj.updateDynamic("distortion")(distortion.get.asInstanceOf[js.Any])
