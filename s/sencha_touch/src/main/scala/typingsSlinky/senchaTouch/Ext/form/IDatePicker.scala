...
trait IDatePicker
  ...
  /** [Method] Resets the Select field to the value of the first record in the store
  		...
  		*/
  @JSName("reset")
  var reset_IDatePicker: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.field.ISelect]] = js.undefined
...
object IDatePicker {
  @scala.inline
  def apply(
    ISelect: typingsSlinky.senchaTouch.Ext.field.ISelect = null,
    ...
    onChange: () => Unit = null,
    picker: js.Any = null,
    reset: () => typingsSlinky.senchaTouch.Ext.field.ISelect = null,
