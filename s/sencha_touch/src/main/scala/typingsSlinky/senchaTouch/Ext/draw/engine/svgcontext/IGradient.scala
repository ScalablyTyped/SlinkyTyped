package typingsSlinky.senchaTouch.Ext.draw.engine.svgcontext
...
object IGradient {
  ...
  implicit class IGradientOps[Self <: IGradient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddColorStop(value: (/* offset */ js.UndefOr[Double], /* color */ js.UndefOr[String]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addColorStop")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutAddColorStop: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addColorStop")(js.undefined)
        ret
    }
  }
