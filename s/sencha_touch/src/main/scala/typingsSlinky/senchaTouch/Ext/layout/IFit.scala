...
object IFit {
  ...
  implicit class IFitOps[Self <: IFit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnItemInnerStateChange(value: (/* item */ js.UndefOr[js.Any], /* isInner */ js.UndefOr[js.Any]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onItemInnerStateChange")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
