...
object ISpacer {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ISpacer = null,
    ...
    setWidth: /* width */ js.UndefOr[Double] => Unit = null,
    setZIndex: /* zIndex */ js.UndefOr[Double] => Unit = null,
    show: /* animation */ js.UndefOr[js.Any] => ISpacer = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISpacer], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
