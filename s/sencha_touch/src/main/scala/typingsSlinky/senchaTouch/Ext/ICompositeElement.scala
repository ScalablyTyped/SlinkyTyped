...
object ICompositeElement {
  ...
  implicit class ICompositeElementMutableBuilder[Self <: ICompositeElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdd(
      value: (/* els */ js.UndefOr[js.Any], /* root */ js.UndefOr[js.Any]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
    ): Self = StObject.set(x, "add", js.Any.fromFunction2(value))
    
    @scala.inline
    def setAddListener(
      value: (/* eventName */ js.UndefOr[js.Any], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* opt */ js.UndefOr[js.Any]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
    ...
    @scala.inline
    def setEach(
      value: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
    ...
    @scala.inline
    def setFill(value: /* els */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite): Self = StObject.set(x, "fill", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setFilter(
      value: /* selector */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
    ...
    def setRemoveElement(
      value: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
    ...
    def setReplaceElement(
      value: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
    ...
    @scala.inline
    def setSelect(
      value: (/* selector */ js.UndefOr[js.Any], /* composite */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
