...
trait ICompositeElement
  extends typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite {
  ...
  var addListener_ICompositeElement: js.UndefOr[
    js.Function4[
      ...
      typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
    ]
  ] = js.undefined
...
object ICompositeElement {
  ...
  def apply(
    ...
    add: (/* els */ js.UndefOr[js.Any], /* root */ js.UndefOr[js.Any]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    addAfterListener: (/* eventName */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => Unit = null,
    addBeforeListener: (/* eventName */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => Unit = null,
    addCls: (/* names */ js.UndefOr[java.lang.String], /* prefix */ js.UndefOr[java.lang.String], /* suffix */ js.UndefOr[java.lang.String]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    addEvents: /* eventNames */ js.UndefOr[js.Any] => Unit = null,
    addListener: (/* eventName */ js.UndefOr[js.Any], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* opt */ js.UndefOr[js.Any]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    addManagedListener: (/* object */ js.UndefOr[js.Any], /* eventName */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => Unit = null,
    alias: Array = null,
    alternateClassName: js.Any = null,
    appendChild: /* element */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    appendTo: /* el */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    applyStyles: /* styles */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    ...
    createChild: (/* config */ js.UndefOr[js.Any], /* insertBefore */ js.UndefOr[HTMLElement], /* returnDom */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    elements: Array = null,
    enableBubble: /* events */ js.UndefOr[js.Any] => Unit = null,
    extend: java.lang.String = null,
    fill: /* els */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    filter: /* selector */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    ...
    insertAfter: /* el */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    insertBefore: /* el */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    insertFirst: /* element */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    insertHtml: (/* where */ js.UndefOr[java.lang.String], /* html */ js.UndefOr[java.lang.String], /* returnEl */ js.UndefOr[Boolean]) => _ = null,
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    ...
    item: /* index */ js.UndefOr[Double] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    ...
    radioCls: /* className */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    relayEvents: (/* object */ js.UndefOr[js.Any], /* events */ js.UndefOr[js.Any]) => IObservable = null,
    remove: () => Unit = null,
    removeAfterListener: (/* eventName */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => Unit = null,
    removeAllListeners: () => Unit = null,
    removeBeforeListener: (/* eventName */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => Unit = null,
    removeCls: (/* names */ js.UndefOr[java.lang.String], /* prefix */ js.UndefOr[java.lang.String], /* suffix */ js.UndefOr[java.lang.String]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    removeListener: (/* eventName */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any], /* order */ js.UndefOr[java.lang.String]) => Unit = null,
    removeManagedListener: (/* object */ js.UndefOr[js.Any], /* eventName */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => Unit = null,
    repaint: () => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    replace: /* element */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    replaceCls: (/* oldName */ js.UndefOr[java.lang.String], /* newName */ js.UndefOr[java.lang.String], /* prefix */ js.UndefOr[java.lang.String], /* suffix */ js.UndefOr[java.lang.String]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    replaceWith: /* el */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    resumeEvents: /* discardQueuedEvents */ js.UndefOr[Boolean] => Unit = null,
    select: (/* selector */ js.UndefOr[js.Any], /* composite */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = null,
    self: IClass = null,
    serializeForm: /* form */ js.UndefOr[js.Any] => java.lang.String = null,
    set: (/* attributes */ js.UndefOr[js.Any], /* useSet */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setBottom: /* bottom */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setBox: /* box */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setBubbleEvents: /* bubbleEvents */ js.UndefOr[js.Any] => Unit = null,
    setCls: /* className */ js.UndefOr[js.Any] => Unit = null,
    setHTML: /* html */ js.UndefOr[java.lang.String] => Unit = null,
    setHeight: /* height */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setHtml: /* html */ js.UndefOr[java.lang.String] => Unit = null,
    setLeft: /* left */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Unit = null,
    setMaxHeight: /* height */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setMaxWidth: /* width */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setMinHeight: /* height */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setMinWidth: /* width */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setRight: /* right */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setSize: (/* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setStyle: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setTop: /* top */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setTopLeft: () => Unit = null,
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setVisible: /* visible */ js.UndefOr[Boolean] => IElement = null,
    setWidth: /* width */ js.UndefOr[js.Any] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setX: /* x */ js.UndefOr[Double] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setXY: /* pos */ js.UndefOr[Array] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    setY: /* y */ js.UndefOr[Double] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    show: () => Unit = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    statics: js.Any = null,
    suspendEvents: () => Unit = null,
    toggleCls: /* className */ js.UndefOr[java.lang.String] => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
