...
import typingsSlinky.senchaTouch.Ext.ISheet
...
object IPicker {
  ...
  implicit class IPickerOps[Self <: IPicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetToolbarPosition(value: () => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetToolbarPosition(value: /* toolbarPosition */ js.UndefOr[String] => Unit): Self = {
        val ret = this.duplicate
