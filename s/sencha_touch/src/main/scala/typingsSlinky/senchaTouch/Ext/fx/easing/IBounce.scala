...
object IBounce {
  ...
  implicit class IBounceOps[Self <: IBounce] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetSpringTension(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSpringTension")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withoutGetSpringTension: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSpringTension")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetSpringTension(value: /* springTension */ js.UndefOr[Double] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setSpringTension")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutSetSpringTension: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setSpringTension")(js.undefined)
        ret
    }
    @scala.inline
