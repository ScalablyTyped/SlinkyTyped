...
object env {
  ...
  object IBrowser {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.env.IBrowser = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.env.IBrowser]
    }
    
    @scala.inline
    implicit class IBrowserMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.env.IBrowser] (val x: Self) extends AnyVal {
