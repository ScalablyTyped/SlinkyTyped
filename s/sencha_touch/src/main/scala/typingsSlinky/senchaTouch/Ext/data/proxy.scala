...
object proxy {
  ...
  object IJsonP {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.data.proxy.IJsonP = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.data.proxy.IJsonP]
    }
    
    @scala.inline
    implicit class IJsonPMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.data.proxy.IJsonP] (val x: Self) extends AnyVal {
  ...
  object IProxy {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.data.proxy.IProxy = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.data.proxy.IProxy]
    }
    
    @scala.inline
    implicit class IProxyMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.data.proxy.IProxy] (val x: Self) extends AnyVal {
