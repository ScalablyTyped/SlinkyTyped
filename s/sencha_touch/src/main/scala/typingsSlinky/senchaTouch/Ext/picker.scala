...
object picker {
  ...
  object IDate {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.picker.IDate = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.picker.IDate]
    }
    
    @scala.inline
    implicit class IDateMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.picker.IDate] (val x: Self) extends AnyVal {
  ...
  object IPicker {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.picker.IPicker = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.picker.IPicker]
    }
    
    @scala.inline
    implicit class IPickerMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.picker.IPicker] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSetValue(
        value: (/* values */ js.UndefOr[js.Any], /* animated */ js.UndefOr[Boolean]) => typingsSlinky.senchaTouch.Ext.picker.IPicker
      ): Self = StObject.set(x, "setValue", js.Any.fromFunction2(value))
