...
object IClass {
  ...
  implicit class IClassMutableBuilder[Self <: IClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlatformConfig(value: js.Any): Self = StObject.set(x, "platformConfig", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlatformConfigUndefined: Self = StObject.set(x, "platformConfig", js.undefined)
