...
object IClass {
  ...
  implicit class IClassOps[Self <: IClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPlatformConfig(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("platformConfig")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPlatformConfig: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("platformConfig")(js.undefined)
        ret
    }
    @scala.inline
