...
trait IAbstract extends IComponent {
  ...
  /** [Method] Returns the value of axis
  		* @returns String
  		*/
  var getAxis: js.UndefOr[js.Function0[String]] = js.undefined
  /** [Method] Returns the value of barCls
  		* @returns String
  		*/
  var getBarCls: js.UndefOr[js.Function0[String]] = js.undefined
  ...
  /** [Method] Sets the value of axis
  		...
  		*/
  var setAxis: js.UndefOr[js.Function1[/* axis */ js.UndefOr[String], Unit]] = js.undefined
  /** [Method] Sets the value of barCls
  		* @param barCls String The new value.
  		*/
  var setBarCls: js.UndefOr[js.Function1[/* barCls */ js.UndefOr[String], Unit]] = js.undefined
...
object IAbstract {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => IAbstract = null,
    getPlugins: () => _ = null,
    getRatio: () => Double = null,
    getRecord: () => IModel = null,
    getRenderTo: () => typingsSlinky.senchaTouch.Ext.IElement = null,
    getRight: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IAbstract = null,
    ...
    renderTo: typingsSlinky.senchaTouch.Ext.IElement = null,
    ...
    setRenderTo: /* renderTo */ js.UndefOr[typingsSlinky.senchaTouch.Ext.IElement] => Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IAbstract = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IAbstract], /* alignment */ js.UndefOr[String]) => Unit = null,
