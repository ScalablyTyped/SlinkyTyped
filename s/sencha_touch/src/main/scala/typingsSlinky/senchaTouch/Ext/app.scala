...
object app {
  ...
  trait IApplication extends IController {
    ...
    /** [Method] Returns the value of router
      ...
      */
    var getRouter: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.app.IRouter]] = js.native
    ...
    var router: js.UndefOr[typingsSlinky.senchaTouch.Ext.app.IRouter] = js.native
    ...
    var setRouter: js.UndefOr[
        js.Function1[/* router */ js.UndefOr[typingsSlinky.senchaTouch.Ext.app.IRouter], Unit]
      ] = js.native
  ...
  object IApplication {
    ...
    implicit class IApplicationMutableBuilder[Self <: IApplication] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetRouter(value: () => typingsSlinky.senchaTouch.Ext.app.IRouter): Self = StObject.set(x, "getRouter", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setRouter(value: typingsSlinky.senchaTouch.Ext.app.IRouter): Self = StObject.set(x, "router", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSetRouter(value: /* router */ js.UndefOr[typingsSlinky.senchaTouch.Ext.app.IRouter] => Unit): Self = StObject.set(x, "setRouter", js.Any.fromFunction1(value))
  ...
  object IRouter {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.app.IRouter = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.app.IRouter]
    }
    
    @scala.inline
    implicit class IRouterMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.app.IRouter] (val x: Self) extends AnyVal {
