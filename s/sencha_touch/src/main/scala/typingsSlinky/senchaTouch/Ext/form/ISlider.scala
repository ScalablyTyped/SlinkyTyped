...
trait ISlider
  ...
  /** [Method] Resets the current field value back to the original value on this field when it was created
  		...
  		*/
  @JSName("reset")
  var reset_ISlider: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.field.IField]] = js.undefined
...
object ISlider {
  @scala.inline
  def apply(
    IField: typingsSlinky.senchaTouch.Ext.field.IField = null,
    getCls: () => String = null,
    ...
    reset: () => typingsSlinky.senchaTouch.Ext.field.IField = null,
