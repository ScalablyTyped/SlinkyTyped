...
trait ISlider
  ...
  /** [Method] Resets the current field value back to the original value on this field when it was created
    ...
    */
  @JSName("reset")
  var reset_ISlider: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.field.IField]] = js.native
...
object ISlider {
  ...
  implicit class ISliderMutableBuilder[Self <: ISlider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReset(value: () => typingsSlinky.senchaTouch.Ext.field.IField): Self = StObject.set(x, "reset", js.Any.fromFunction0(value))
