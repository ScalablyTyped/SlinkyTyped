package typingsSlinky.senchaTouch.Ext.dataview
...
object IList {
  ...
  implicit class IListOps[Self <: IList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDisclosureProperty(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetDisclosureProperty(value: () => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetDisclosureProperty(value: /* disclosureProperty */ js.UndefOr[String] => Unit): Self = {
        val ret = this.duplicate
