...
- typingsSlinky.senchaTouch.Ext.chart.IMarkerHolder because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bindMarker */ trait IAxis extends ISprite {
  /** [Config Option] (Number) */
  var The: js.UndefOr[Double] = js.undefined
  /** [Config Option] (Ext.chart.axis.Axis) */
  var axis: js.UndefOr[typingsSlinky.senchaTouch.Ext.chart.axis.IAxis] = js.undefined
...
object IAxis {
  ...
  def apply(
    ...
    attr: js.Any = null,
    axis: typingsSlinky.senchaTouch.Ext.chart.axis.IAxis = null,
