...
object IRequest {
  ...
  implicit class IRequestOps[Self <: IRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetProxy(value: () => typingsSlinky.senchaTouch.Ext.data.proxy.IProxy): Self = this.set("getProxy", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setProxy(value: typingsSlinky.senchaTouch.Ext.data.proxy.IProxy): Self = this.set("proxy", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSetProxy(value: /* proxy */ js.UndefOr[typingsSlinky.senchaTouch.Ext.data.proxy.IProxy] => Unit): Self = this.set("setProxy", js.Any.fromFunction1(value))
    @scala.inline
