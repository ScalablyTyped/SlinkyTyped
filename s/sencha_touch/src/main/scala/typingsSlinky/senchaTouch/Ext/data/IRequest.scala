...
object IRequest {
  ...
  implicit class IRequestMutableBuilder[Self <: IRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetProxy(value: () => typingsSlinky.senchaTouch.Ext.data.proxy.IProxy): Self = StObject.set(x, "getProxy", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setProxy(value: typingsSlinky.senchaTouch.Ext.data.proxy.IProxy): Self = StObject.set(x, "proxy", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSetProxy(value: /* proxy */ js.UndefOr[typingsSlinky.senchaTouch.Ext.data.proxy.IProxy] => Unit): Self = StObject.set(x, "setProxy", js.Any.fromFunction1(value))
