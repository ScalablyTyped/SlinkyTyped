...
trait IRequest extends IBase {
  ...
  /** [Method] Returns the value of proxy
    ...
    */
  var getProxy: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.data.proxy.IProxy]] = js.undefined
  ...
  var proxy: js.UndefOr[typingsSlinky.senchaTouch.Ext.data.proxy.IProxy] = js.undefined
...
object IRequest {
  ...
  def apply(
    ...
    getProxy: () => typingsSlinky.senchaTouch.Ext.data.proxy.IProxy = null,
    getRecords: () => _ = null,
    getScope: () => _ = null,
    ...
    proxy: typingsSlinky.senchaTouch.Ext.data.proxy.IProxy = null,
    self: IClass = null,
    ...
    setProxy: /* proxy */ js.UndefOr[typingsSlinky.senchaTouch.Ext.data.proxy.IProxy] => Unit = null,
