...
object IComponent {
  ...
  implicit class IComponentOps[Self <: IComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetRenderTo(value: () => typingsSlinky.senchaTouch.Ext.IElement): Self = this.set("getRenderTo", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setRenderTo(value: typingsSlinky.senchaTouch.Ext.IElement): Self = this.set("renderTo", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSetRenderTo(value: /* renderTo */ js.UndefOr[typingsSlinky.senchaTouch.Ext.IElement] => Unit): Self = this.set("setRenderTo", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setUp(value: /* selector */ js.UndefOr[String] => typingsSlinky.senchaTouch.Ext.IContainer): Self = this.set("up", js.Any.fromFunction1(value))
