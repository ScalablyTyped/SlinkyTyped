...
trait IComponent extends IEvented {
  ...
  /** [Method] Returns the value of renderTo
    * @returns Ext.Element
    */
  var getRenderTo: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.IElement]] = js.undefined
  ...
  var renderTo: js.UndefOr[typingsSlinky.senchaTouch.Ext.IElement] = js.undefined
