...
object IDefault {
  ...
  implicit class IDefaultOps[Self <: IDefault] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: typingsSlinky.senchaTouch.Ext.fx.layout.ICard): Self = this.set("animation", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAnimation: Self = this.set("animation", js.undefined)
    @scala.inline
    def setGetAnimation(value: () => typingsSlinky.senchaTouch.Ext.fx.layout.ICard): Self = this.set("getAnimation", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setSetAnimation(value: /* animation */ js.UndefOr[typingsSlinky.senchaTouch.Ext.fx.layout.ICard] => Unit): Self = this.set("setAnimation", js.Any.fromFunction1(value))
    @scala.inline
