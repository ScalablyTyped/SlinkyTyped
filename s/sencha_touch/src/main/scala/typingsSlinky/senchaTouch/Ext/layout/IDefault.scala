...
trait IDefault extends IAbstract {
  ...
  var animation: js.UndefOr[typingsSlinky.senchaTouch.Ext.fx.layout.ICard] = js.undefined
  /** [Method] Returns the value of animation
  		* @returns Ext.fx.layout.Card
  		*/
  var getAnimation: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.fx.layout.ICard]] = js.undefined
  /** [Method]
...
object IDefault {
  ...
  def apply(
    ...
    animation: typingsSlinky.senchaTouch.Ext.fx.layout.ICard = null,
    ...
    getAnimation: () => typingsSlinky.senchaTouch.Ext.fx.layout.ICard = null,
    ...
    onItemInnerStateChange: (/* item */ js.UndefOr[IComponent], /* isInner */ js.UndefOr[Boolean], /* destroying */ js.UndefOr[Boolean]) => Unit = null,
    ...
    self: IClass = null,
    setAnimation: /* animation */ js.UndefOr[typingsSlinky.senchaTouch.Ext.fx.layout.ICard] => Unit = null,
    ...
    if (onItemInnerStateChange != null) __obj.updateDynamic("onItemInnerStateChange")(js.Any.fromFunction3(onItemInnerStateChange))
