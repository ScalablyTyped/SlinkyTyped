...
object Element extends js.Object {
  ...
  /** [Method] Gets the globally shared flyweight Element with the passed node as the active element
  		...
  		*/
  def fly(): typingsSlinky.senchaTouch.Ext.dom.IElement = js.native
  def fly(element: js.Any): typingsSlinky.senchaTouch.Ext.dom.IElement = js.native
  def fly(element: js.Any, named: java.lang.String): typingsSlinky.senchaTouch.Ext.dom.IElement = js.native
  ...
  /** [Method] Retrieves Ext dom Element objects
  		...
  		*/
  def get(): typingsSlinky.senchaTouch.Ext.dom.IElement = js.native
  def get(element: js.Any): typingsSlinky.senchaTouch.Ext.dom.IElement = js.native
  ...
  /** [Method] Selects elements based on the passed CSS selector to enable Element methods to be applied to many related elements in
  		...
  		*/
  def select(): typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = js.native
  def select(selector: js.Any): typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = js.native
  def select(selector: js.Any, composite: Boolean): typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = js.native
  def select(selector: js.Any, composite: Boolean, root: js.Any): typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = js.native
