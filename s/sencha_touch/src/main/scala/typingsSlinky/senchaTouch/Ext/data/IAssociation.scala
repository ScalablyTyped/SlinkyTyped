...
object IAssociation {
  ...
  implicit class IAssociationOps[Self <: IAssociation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetReader(value: () => typingsSlinky.senchaTouch.Ext.data.reader.IReader): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReader(value: typingsSlinky.senchaTouch.Ext.data.reader.IReader): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetReader(value: /* reader */ js.UndefOr[typingsSlinky.senchaTouch.Ext.data.reader.IReader] => Unit): Self = {
        val ret = this.duplicate
