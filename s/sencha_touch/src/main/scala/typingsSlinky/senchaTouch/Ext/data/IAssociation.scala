...
trait IAssociation extends IBase {
  ...
  /** [Method] Returns the value of reader
  		...
  		*/
  var getReader: js.UndefOr[js.Function0[typingsSlinky.senchaTouch.Ext.data.reader.IReader]] = js.undefined
  ...
  var reader: js.UndefOr[typingsSlinky.senchaTouch.Ext.data.reader.IReader] = js.undefined
