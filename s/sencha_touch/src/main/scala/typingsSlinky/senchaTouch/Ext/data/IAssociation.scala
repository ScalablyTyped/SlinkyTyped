...
object IAssociation {
  ...
  implicit class IAssociationOps[Self <: IAssociation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetReader(value: () => typingsSlinky.senchaTouch.Ext.data.reader.IReader): Self = this.set("getReader", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setReader(value: typingsSlinky.senchaTouch.Ext.data.reader.IReader): Self = this.set("reader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSetReader(value: /* reader */ js.UndefOr[typingsSlinky.senchaTouch.Ext.data.reader.IReader] => Unit): Self = this.set("setReader", js.Any.fromFunction1(value))
