...
object writer {
  ...
  object IWriter {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.data.writer.IWriter = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.data.writer.IWriter]
    }
    
    @scala.inline
    implicit class IWriterMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.data.writer.IWriter] (val x: Self) extends AnyVal {
