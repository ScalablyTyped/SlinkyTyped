...
object ISQLTransaction {
  ...
  implicit class ISQLTransactionOps[Self <: ISQLTransaction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExecuteSql(value: /* config */ js.UndefOr[js.Any] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeSql")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutExecuteSql: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeSql")(js.undefined)
        ret
    }
  }
