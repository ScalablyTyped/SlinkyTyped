...
object IBar {
  ...
  def apply(
    ...
    hide: () => IBar = null,
    inGroupGapWidth: js.UndefOr[Double] = js.undefined,
    ...
    maxBarWidth: js.UndefOr[Double] = js.undefined,
    minBarWidth: js.UndefOr[Double] = js.undefined,
    minGapWidth: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(inGroupGapWidth)) __obj.updateDynamic("inGroupGapWidth")(inGroupGapWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(maxBarWidth)) __obj.updateDynamic("maxBarWidth")(maxBarWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(minBarWidth)) __obj.updateDynamic("minBarWidth")(minBarWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(minGapWidth)) __obj.updateDynamic("minGapWidth")(minGapWidth.get.asInstanceOf[js.Any])
