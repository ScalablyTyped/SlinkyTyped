...
object IExceptionEvent {
  ...
  implicit class IExceptionEventOps[Self <: IExceptionEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetError(value: /* error */ js.UndefOr[js.Any] => Unit): Self = this.set("setError", js.Any.fromFunction1(value))
    @scala.inline
    def deleteSetError: Self = this.set("setError", js.undefined)
  }
