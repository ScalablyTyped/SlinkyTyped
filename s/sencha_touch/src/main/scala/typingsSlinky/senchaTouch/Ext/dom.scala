...
object dom {
  ...
  type ICompositeElement = typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite
  ...
  object ICompositeElementLite {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite]
    }
    
    @scala.inline
    implicit class ICompositeElementLiteMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.dom.ICompositeElementLite] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSetVisible(value: /* visible */ js.UndefOr[Boolean] => typingsSlinky.senchaTouch.Ext.IElement): Self = StObject.set(x, "setVisible", js.Any.fromFunction1(value))
  ...
  object IElement {
    ...
    @scala.inline
    def apply(): typingsSlinky.senchaTouch.Ext.dom.IElement = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.senchaTouch.Ext.dom.IElement]
    }
    
    @scala.inline
    implicit class IElementMutableBuilder[Self <: typingsSlinky.senchaTouch.Ext.dom.IElement] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSetVisible(value: /* visible */ js.UndefOr[Boolean] => typingsSlinky.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setVisible", js.Any.fromFunction1(value))
