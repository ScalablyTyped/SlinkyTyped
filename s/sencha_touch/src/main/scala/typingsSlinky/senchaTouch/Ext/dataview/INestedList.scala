...
object INestedList {
  ...
  implicit class INestedListOps[Self <: INestedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetBackText(value: () => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetItemTextTpl(value: /* node */ js.UndefOr[IRecord] => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetTitleTextTpl(value: /* node */ js.UndefOr[IRecord] => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetBackText(value: /* backText */ js.UndefOr[String] => Unit): Self = {
        val ret = this.duplicate
