...
object INestedList {
  ...
  def apply(
    ...
    onItemTap: (/* list */ js.UndefOr[typingsSlinky.senchaTouch.Ext.IList], /* index */ js.UndefOr[Double], /* target */ js.UndefOr[IElement], /* record */ js.UndefOr[IRecord], /* e */ js.UndefOr[IEvent]) => Unit = null,
