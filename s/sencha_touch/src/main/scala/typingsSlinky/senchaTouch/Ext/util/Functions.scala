...
@js.native
class Functions () extends js.Object
...
object Functions extends js.Object {
  ...
  def createDelegate(fn: js.Any, scope: js.Any, args: Array): js.Any = js.native
  def createDelegate(fn: js.Any, scope: js.Any, args: Array, appendArgs: js.Any): js.Any = js.native
