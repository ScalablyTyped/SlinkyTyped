...
object IImg {
  ...
  def apply(
    ...
    getBackgroundCls: () => java.lang.String = null,
    ...
    getEl: () => typingsSlinky.senchaTouch.Ext.dom.IElement = null,
    ...
    getHtml: () => _ = null,
    getId: () => _ = null,
    getImageCls: () => java.lang.String = null,
    ...
    scroll: js.Any = null,
    self: IClass = null,
    setBackgroundCls: /* backgroundCls */ js.UndefOr[java.lang.String] => Unit = null,
    ...
    setImageCls: /* imageCls */ js.UndefOr[java.lang.String] => Unit = null,
    ...
    showBy: (/* component */ js.UndefOr[IImg], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
    ...
    if (backgroundCls != null) __obj.updateDynamic("backgroundCls")(backgroundCls.asInstanceOf[js.Any])
    ...
    if (getBackgroundCls != null) __obj.updateDynamic("getBackgroundCls")(js.Any.fromFunction0(getBackgroundCls))
    ...
    if (getImageCls != null) __obj.updateDynamic("getImageCls")(js.Any.fromFunction0(getImageCls))
    ...
    if (imageCls != null) __obj.updateDynamic("imageCls")(imageCls.asInstanceOf[js.Any])
    ...
    if (setBackgroundCls != null) __obj.updateDynamic("setBackgroundCls")(js.Any.fromFunction1(setBackgroundCls))
    ...
    if (setImageCls != null) __obj.updateDynamic("setImageCls")(js.Any.fromFunction1(setImageCls))
