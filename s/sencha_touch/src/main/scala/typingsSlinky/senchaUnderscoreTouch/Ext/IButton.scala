...
object IButton {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IButton = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IButton = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IButton], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
