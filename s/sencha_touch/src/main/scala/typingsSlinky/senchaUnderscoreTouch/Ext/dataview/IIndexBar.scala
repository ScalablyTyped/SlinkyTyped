...
import typingsSlinky.senchaUnderscoreTouch.Ext.IComponent
...
object IIndexBar {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IIndexBar = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IIndexBar = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IIndexBar = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IIndexBar], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
