package typingsSlinky.senchaUnderscoreTouch.Ext.form

import typingsSlinky.senchaUnderscoreTouch.Ext.data.IConnection
import typingsSlinky.senchaUnderscoreTouch.Ext.data.IModel
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait IFormPanel
  extends typingsSlinky.senchaUnderscoreTouch.Ext.IPanel {
  ...
  var doSetDisabled: js.UndefOr[
    js.Function1[
      ...
      typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel
    ]
  ] = js.undefined
  ...
  /** [Method] Hides a previously shown wait mask See showMask
  		...
  		*/
  var hideMask: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel]] = js.undefined
  ...
  /** [Method] Resets all fields in the form back to their original values
  		* @returns Ext.form.Panel This form.
  		*/
  var reset: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel]] = js.undefined
  ...
  var waitMsgTarget: js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.dom.IElement] = js.undefined
...
object IFormPanel {
  @scala.inline
  def apply(
    IPanel: typingsSlinky.senchaUnderscoreTouch.Ext.IPanel = null,
    api: js.Any = null,
    baseParams: js.Any = null,
    doSetDisabled: /* newDisabled */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    ...
    hideMask: () => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    load: /* options */ js.UndefOr[js.Any] => IConnection = null,
    loadModel: /* record */ js.UndefOr[IModel] => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    loadRecord: /* record */ js.UndefOr[IModel] => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    ...
    reset: () => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    ...
    setRecord: /* record */ js.UndefOr[IModel] => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    ...
    setValues: /* values */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    showMask: (/* cfg */ js.UndefOr[js.Any], /* target */ js.UndefOr[js.Any]) => typingsSlinky.senchaUnderscoreTouch.Ext.form.IPanel = null,
    ...
    waitMsgTarget: typingsSlinky.senchaUnderscoreTouch.Ext.dom.IElement = null,
    waitTpl: js.Any = null
  ): IFormPanel = {
