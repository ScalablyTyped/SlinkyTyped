package typingsSlinky.senchaUnderscoreTouch.Ext.draw.gradient

import typingsSlinky.senchaUnderscoreTouch.Ext.Array
import typingsSlinky.senchaUnderscoreTouch.Ext.IClass
import typingsSlinky.senchaUnderscoreTouch.Ext.draw.engine.ISvgContext
import typingsSlinky.senchaUnderscoreTouch.Ext.mixin.IIdentifiable
