package typingsSlinky.senchaUnderscoreTouch.Ext.data
...
trait IBelongsToAssociation
  extends typingsSlinky.senchaUnderscoreTouch.Ext.data.association.IAssociation {
...
object IBelongsToAssociation {
  ...
  def apply(
    ...
    getReader: () => typingsSlinky.senchaUnderscoreTouch.Ext.data.reader.IReader = null,
    ...
    reader: typingsSlinky.senchaUnderscoreTouch.Ext.data.reader.IReader = null,
    self: IClass = null,
    ...
    setReader: /* reader */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.data.reader.IReader] => Unit = null,
