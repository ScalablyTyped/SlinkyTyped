...
trait IDatePicker
  extends typingsSlinky.senchaUnderscoreTouch.Ext.field.ISelect {
  ...
  /** [Method] Resets the Select field to the value of the first record in the store
  		...
  		*/
  @JSName("reset")
  var reset_IDatePicker: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.field.ISelect]] = js.undefined
...
object IDatePicker {
  @scala.inline
  def apply(
    ISelect: typingsSlinky.senchaUnderscoreTouch.Ext.field.ISelect = null,
    ...
    onChange: () => Unit = null,
    picker: js.Any = null,
    reset: () => typingsSlinky.senchaUnderscoreTouch.Ext.field.ISelect = null,
