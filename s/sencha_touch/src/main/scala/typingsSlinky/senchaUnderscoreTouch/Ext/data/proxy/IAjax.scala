package typingsSlinky.senchaUnderscoreTouch.Ext.data.proxy

import typingsSlinky.senchaUnderscoreTouch.Ext.Array
import typingsSlinky.senchaUnderscoreTouch.Ext.IClass
import typingsSlinky.senchaUnderscoreTouch.Ext.data.IBatch
import typingsSlinky.senchaUnderscoreTouch.Ext.data.IOperation
import typingsSlinky.senchaUnderscoreTouch.Ext.data.IRequest
