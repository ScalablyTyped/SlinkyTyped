...
object ILine {
  ...
  def apply(
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.ILine = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.ILine = null,
