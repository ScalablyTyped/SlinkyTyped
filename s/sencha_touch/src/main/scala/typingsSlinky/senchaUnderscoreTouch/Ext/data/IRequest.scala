...
trait IRequest extends IBase {
  ...
  /** [Method] Returns the value of proxy
  		...
  		*/
  var getProxy: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.data.proxy.IProxy]] = js.undefined
  ...
  var proxy: js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.data.proxy.IProxy] = js.undefined
  ...
  var setProxy: js.UndefOr[
    js.Function1[
      /* proxy */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.data.proxy.IProxy], 
      Unit
    ]
  ] = js.undefined
...
object IRequest {
  ...
  def apply(
    ...
    getProxy: () => typingsSlinky.senchaUnderscoreTouch.Ext.data.proxy.IProxy = null,
    getRecords: () => _ = null,
    getScope: () => _ = null,
    ...
    proxy: typingsSlinky.senchaUnderscoreTouch.Ext.data.proxy.IProxy = null,
    self: IClass = null,
    ...
    setProxy: /* proxy */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.data.proxy.IProxy] => Unit = null,
