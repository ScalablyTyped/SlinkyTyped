...
object IListItemHeader {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => IListItemHeader = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IListItemHeader = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IListItemHeader = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IListItemHeader], /* alignment */ js.UndefOr[String]) => Unit = null,
