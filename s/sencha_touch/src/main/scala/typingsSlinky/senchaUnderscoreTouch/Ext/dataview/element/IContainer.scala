...
object IContainer {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IContainer = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IContainer = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IContainer = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IContainer], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
