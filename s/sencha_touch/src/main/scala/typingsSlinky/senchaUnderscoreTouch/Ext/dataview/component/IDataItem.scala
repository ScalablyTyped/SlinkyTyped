package typingsSlinky.senchaUnderscoreTouch.Ext.dataview.component
...
trait IDataItem
  extends typingsSlinky.senchaUnderscoreTouch.Ext.IContainer {
...
object IDataItem {
  @scala.inline
  def apply(
    IContainer: typingsSlinky.senchaUnderscoreTouch.Ext.IContainer = null,
    dataMap: js.Any = null,
    getDataMap: () => _ = null,
