...
object ICarousel {
  ...
  def apply(
    ...
    next: () => typingsSlinky.senchaUnderscoreTouch.Ext.carousel.ICarousel = null,
    prev: () => typingsSlinky.senchaUnderscoreTouch.Ext.carousel.ICarousel = null,
    previous: () => typingsSlinky.senchaUnderscoreTouch.Ext.carousel.ICarousel = null,
