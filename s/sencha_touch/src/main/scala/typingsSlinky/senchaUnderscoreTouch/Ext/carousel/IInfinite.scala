package typingsSlinky.senchaUnderscoreTouch.Ext.carousel
...
trait IInfinite
  extends typingsSlinky.senchaUnderscoreTouch.Ext.carousel.ICarousel {
...
object IInfinite {
  @scala.inline
  def apply(
    ICarousel: typingsSlinky.senchaUnderscoreTouch.Ext.carousel.ICarousel = null,
