...
trait IPullRefresh extends IComponent {
  ...
  /** [Method] Returns the value of list
  		...
  		*/
  var getList: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IList]] = js.undefined
  ...
  var list: js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IList] = js.undefined
  /** [Config Option] (String) */
  ...
  var setList: js.UndefOr[
    js.Function1[
      /* list */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IList], 
      Unit
    ]
  ] = js.undefined
...
object IPullRefresh {
  ...
  def apply(
    ...
    getLeft: () => _ = null,
    getList: () => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IList = null,
    getListeners: () => _ = null,
    ...
    left: js.Any = null,
    list: typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IList = null,
    ...
    setList: /* list */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.dataview.IList] => Unit = null,
