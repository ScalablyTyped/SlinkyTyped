package typingsSlinky.senchaUnderscoreTouch.Ext.chart.axis.sprite
...
- typings.senchaUnderscoreTouch.Ext.chart.IMarkerHolder because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bindMarker */ trait IAxis extends ISprite {
  ...
  var axis: js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.chart.axis.IAxis] = js.undefined
...
object IAxis {
  ...
  def apply(
    ...
    attr: js.Any = null,
    axis: typingsSlinky.senchaUnderscoreTouch.Ext.chart.axis.IAxis = null,
    ...
    getAxis: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.axis.sprite.IAxis = null,
    getBBox: () => Unit = null,
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.axis.sprite.IAxis = null,
    ...
    setAxis: /* axis */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.chart.axis.sprite.IAxis] => Unit = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.axis.sprite.IAxis = null,
