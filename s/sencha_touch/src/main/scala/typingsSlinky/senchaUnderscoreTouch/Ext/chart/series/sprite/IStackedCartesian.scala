...
trait IStackedCartesian
  extends typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.ICartesian {
...
object IStackedCartesian {
  ...
  def apply(
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IStackedCartesian = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IStackedCartesian = null,
