...
trait ITapRepeater
  extends typingsSlinky.senchaUnderscoreTouch.Ext.mixin.IObservable {
  ...
  var relayEvents_ITapRepeater: js.UndefOr[
    js.Function2[
      ...
      typingsSlinky.senchaUnderscoreTouch.Ext.mixin.IObservable
    ]
  ] = js.undefined
...
object ITapRepeater {
  ...
  def apply(
    ...
    relayEvents: (/* object */ js.UndefOr[js.Any], /* events */ js.UndefOr[js.Any]) => typingsSlinky.senchaUnderscoreTouch.Ext.mixin.IObservable = null,
