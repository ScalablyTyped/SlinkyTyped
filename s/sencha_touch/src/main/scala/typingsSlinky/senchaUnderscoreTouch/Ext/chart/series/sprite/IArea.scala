...
trait IArea
  extends typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IStackedCartesian {
...
object IArea {
  ...
  def apply(
    ...
    getId: () => _ = null,
    getIndexNearPoint: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any]) => Double = null,
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IArea = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IArea = null,
