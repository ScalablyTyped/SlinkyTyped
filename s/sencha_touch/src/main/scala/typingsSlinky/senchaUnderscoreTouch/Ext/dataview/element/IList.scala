package typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element
...
trait IList
  extends typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IContainer
...
object IList {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IList = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IList = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IList = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.dataview.element.IList], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
    ...
    up: /* selector */ js.UndefOr[java.lang.String] => typingsSlinky.senchaUnderscoreTouch.Ext.IContainer = null,
    update: () => Unit = null,
