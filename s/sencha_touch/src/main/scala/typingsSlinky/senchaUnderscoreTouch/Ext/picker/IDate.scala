package typingsSlinky.senchaUnderscoreTouch.Ext.picker
...
trait IDate
  extends typingsSlinky.senchaUnderscoreTouch.Ext.picker.IPicker {
  ...
  var setValue_IDate: js.UndefOr[
    js.Function2[
      ...
      typingsSlinky.senchaUnderscoreTouch.Ext.IPicker
    ]
  ] = js.undefined
...
object IDate {
  @scala.inline
  def apply(
    IPicker: typingsSlinky.senchaUnderscoreTouch.Ext.picker.IPicker = null,
    ...
    setValue: (/* value */ js.UndefOr[js.Any], /* animated */ js.UndefOr[js.Any]) => typingsSlinky.senchaUnderscoreTouch.Ext.IPicker = null,
