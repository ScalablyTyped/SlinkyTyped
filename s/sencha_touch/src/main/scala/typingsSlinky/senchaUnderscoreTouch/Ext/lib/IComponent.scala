...
trait IComponent extends IEvented {
  ...
  /** [Method] Retrieves the top level element representing this component
  		...
  		*/
  var getEl: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.dom.IElement]] = js.undefined
  ...
  var up: js.UndefOr[
    js.Function1[
      ...
      typingsSlinky.senchaUnderscoreTouch.Ext.IContainer
    ]
  ] = js.undefined
...
object IComponent {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typingsSlinky.senchaUnderscoreTouch.Ext.lib.IComponent = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.lib.IComponent = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.lib.IComponent = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.lib.IComponent], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
