...
trait IComponent extends IEvented {
  ...
  /** [Method] Returns the value of renderTo
  		* @returns Ext.Element
  		*/
  var getRenderTo: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.IElement]] = js.undefined
  ...
  var renderTo: js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.IElement] = js.undefined
  ...
  var setRenderTo: js.UndefOr[
    js.Function1[/* renderTo */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.IElement], Unit]
  ] = js.undefined
