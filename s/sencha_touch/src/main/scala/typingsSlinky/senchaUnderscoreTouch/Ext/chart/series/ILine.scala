...
object ILine {
  ...
  def apply(
    ...
    getRenderer: () => _ = null,
    getSelectionTolerance: () => Double = null,
    getShowInLegend: () => Boolean = null,
    getSmooth: () => _ = null,
    getSprites: () => Unit = null,
    getStep: () => Boolean = null,
    getStyle: () => _ = null,
    getSubStyle: () => _ = null,
    getSurface: () => _ = null,
    ...
    setFill: /* fill */ js.UndefOr[Boolean] => Unit = null,
    ...
    setSelectionTolerance: /* selectionTolerance */ js.UndefOr[Double] => Unit = null,
    setShowInLegend: /* showInLegend */ js.UndefOr[Boolean] => Unit = null,
    setSmooth: /* smooth */ js.UndefOr[js.Any] => Unit = null,
    setStep: /* step */ js.UndefOr[Boolean] => Unit = null,
