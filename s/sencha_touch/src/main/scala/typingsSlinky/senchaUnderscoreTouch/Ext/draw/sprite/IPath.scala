...
object IPath {
  ...
  def apply(
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.draw.sprite.IPath = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.draw.sprite.IPath = null,
    ...
    updatePath: (/* path */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.draw.sprite.IPath], /* attr */ js.UndefOr[js.Any]) => Unit = null,
