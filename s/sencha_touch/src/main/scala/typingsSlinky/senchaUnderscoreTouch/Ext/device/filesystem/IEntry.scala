...
trait IEntry extends IBase {
  ...
  /** [Method] Returns the file system on which the entry resides
  		...
  		*/
  var getFileSystem: js.UndefOr[
    js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.device.filesystem.IFileSystem]
  ] = js.undefined
...
object IEntry {
  ...
  def apply(
    ...
    getFileSystem: () => typingsSlinky.senchaUnderscoreTouch.Ext.device.filesystem.IFileSystem = null,
