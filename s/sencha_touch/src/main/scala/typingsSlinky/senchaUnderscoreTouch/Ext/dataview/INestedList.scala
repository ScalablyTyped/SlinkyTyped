...
import typingsSlinky.senchaUnderscoreTouch.Ext.data.INodeInterface
...
trait INestedList extends IContainer {
  ...
  var onItemTap: js.UndefOr[
    js.Function5[
      /* list */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.IList], 
...
object INestedList {
  ...
  def apply(
    ...
    onItemTap: (/* list */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.IList], /* index */ js.UndefOr[Double], /* target */ js.UndefOr[IElement], /* record */ js.UndefOr[IRecord], /* e */ js.UndefOr[IEvent]) => Unit = null,
