...
import typingsSlinky.senchaUnderscoreTouch.Ext.draw.sprite.IText
...
object ILabel {
  ...
  def apply(
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.label.ILabel = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.label.ILabel = null,
