package typingsSlinky.senchaUnderscoreTouch.Ext.data.association
...
trait IAssociation extends IBase {
  ...
  /** [Method] Returns the value of reader
  		...
  		*/
  var getReader: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.data.reader.IReader]] = js.undefined
  ...
  var reader: js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.data.reader.IReader] = js.undefined
  ...
  var setReader: js.UndefOr[
    js.Function1[
      /* reader */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.data.reader.IReader], 
      Unit
    ]
  ] = js.undefined
