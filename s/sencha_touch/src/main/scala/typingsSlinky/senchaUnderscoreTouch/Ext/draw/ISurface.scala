package typingsSlinky.senchaUnderscoreTouch.Ext.draw
...
import typingsSlinky.senchaUnderscoreTouch.Ext.draw.sprite.ISprite
...
trait ISurface
  extends typingsSlinky.senchaUnderscoreTouch.Ext.IComponent {
...
object ISurface {
  ...
  def apply(
    ...
    showBy: (/* component */ js.UndefOr[ISurface], /* alignment */ js.UndefOr[String]) => Unit = null,
    ...
    uses: Array = null,
    waitFor: /* surface */ js.UndefOr[ISurface] => Unit = null,
    width: js.Any = null,
    xtype: String = null,
