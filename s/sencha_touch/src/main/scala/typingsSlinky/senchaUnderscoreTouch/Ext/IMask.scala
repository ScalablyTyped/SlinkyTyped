...
object IMask {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IMask = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IMask = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IMask], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
