...
object IScatter {
  ...
  def apply(
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IScatter = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IScatter = null,
