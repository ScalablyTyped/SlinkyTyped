package typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite

import typingsSlinky.senchaUnderscoreTouch.Ext.Array
import typingsSlinky.senchaUnderscoreTouch.Ext.IClass
import typingsSlinky.senchaUnderscoreTouch.Ext.chart.IMarkers
import typingsSlinky.senchaUnderscoreTouch.Ext.draw.ISurface
...
object IPolar {
  ...
  def apply(
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IPolar = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IPolar = null,
