...
trait IApplication extends IController {
  ...
  /** [Method] Returns the value of router
  		...
  		*/
  var getRouter: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.app.IRouter]] = js.undefined
  ...
  var router: js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.app.IRouter] = js.undefined
  ...
  var setRouter: js.UndefOr[
    js.Function1[/* router */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.app.IRouter], Unit]
  ] = js.undefined
...
object IApplication {
  ...
  def apply(
    ...
    getRouter: () => typingsSlinky.senchaUnderscoreTouch.Ext.app.IRouter = null,
    getRoutes: () => _ = null,
    ...
    router: typingsSlinky.senchaUnderscoreTouch.Ext.app.IRouter = null,
    routes: js.Any = null,
    self: IClass = null,
    ...
    setRouter: /* router */ js.UndefOr[typingsSlinky.senchaUnderscoreTouch.Ext.app.IRouter] => Unit = null,
