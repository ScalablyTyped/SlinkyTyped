package typingsSlinky.senchaUnderscoreTouch.Ext.device.contacts
...
object IAbstract {
  ...
  def apply(
    ...
    getListeners: () => _ = null,
    getLocalizedLabel: /* config */ js.UndefOr[js.Any] => java.lang.String = null,
    getThumbnail: /* config */ js.UndefOr[js.Any] => java.lang.String = null,
