...
import typingsSlinky.senchaUnderscoreTouch.Ext.ISheet
...
object IPicker {
  ...
  def apply(
    ...
    setValue: (/* values */ js.UndefOr[js.Any], /* animated */ js.UndefOr[Boolean]) => typingsSlinky.senchaUnderscoreTouch.Ext.picker.IPicker = null,
    slots: Array = null,
    toolbar: js.Any = null,
