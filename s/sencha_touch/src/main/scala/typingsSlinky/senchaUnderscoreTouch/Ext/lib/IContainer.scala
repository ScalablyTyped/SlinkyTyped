package typingsSlinky.senchaUnderscoreTouch.Ext.lib

import typingsSlinky.senchaUnderscoreTouch.Ext.Array
import typingsSlinky.senchaUnderscoreTouch.Ext.scroll.IView
...
trait IContainer
  ...
  var getAt: js.UndefOr[
    js.Function1[/* index */ js.UndefOr[Double], typingsSlinky.senchaUnderscoreTouch.Ext.IComponent]
  ] = js.undefined
  ...
  /** [Method] Hides this Component optionally using an animation
  		...
  		*/
  @JSName("hide")
  var hide_IContainer: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.IComponent]] = js.undefined
  ...
  /** [Method] Shows this component optionally using an animation
  		...
  		*/
  @JSName("show")
  var show_IContainer: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.IComponent]] = js.undefined
...
object IContainer {
  @scala.inline
  def apply(
    IComponent: typingsSlinky.senchaUnderscoreTouch.Ext.IComponent = null,
    activeItem: js.Any = null,
    add: /* newItems */ js.UndefOr[js.Any] => typingsSlinky.senchaUnderscoreTouch.Ext.IComponent = null,
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.IComponent = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.IComponent = null,
    unmask: () => Unit = null
  ): IContainer = {
