package typingsSlinky.senchaUnderscoreTouch.Ext.device.purchases

import typingsSlinky.senchaUnderscoreTouch.Ext.Array
import typingsSlinky.senchaUnderscoreTouch.Ext.IClass
import typingsSlinky.senchaUnderscoreTouch.Ext.data.IErrors
import typingsSlinky.senchaUnderscoreTouch.Ext.data.IModel
import typingsSlinky.senchaUnderscoreTouch.Ext.data.IStore
...
object IProduct {
  ...
  def apply(
    ...
    config: js.Any = null,
    copy: /* id */ js.UndefOr[java.lang.String] => IProduct = null,
    destroy: () => Unit = null,
    ...
    erase: (/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => IProduct = null,
    ...
    proxy: js.Any = null,
    purchase: /* config */ js.UndefOr[js.Any] => Unit = null,
    raw: js.Any = null,
    ...
    save: (/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => IProduct = null,
    self: IClass = null,
    ...
    setConvertedData: /* data */ js.UndefOr[js.Any] => IProduct = null,
    setData: /* rawData */ js.UndefOr[js.Any] => IProduct = null,
    setDirty: () => Unit = null,
