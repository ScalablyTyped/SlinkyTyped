...
trait IRadar
  extends typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IPolar {
...
object IRadar {
  ...
  def apply(
    ...
    hide: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IRadar = null,
    ...
    show: () => typingsSlinky.senchaUnderscoreTouch.Ext.chart.series.sprite.IRadar = null,
