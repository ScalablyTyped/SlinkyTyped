...
trait ICheckbox
  extends typingsSlinky.senchaUnderscoreTouch.Ext.field.IField {
  ...
  /** [Method] Resets the current field value back to the original value on this field when it was created
  		...
  		*/
  @JSName("reset")
  var reset_ICheckbox: js.UndefOr[js.Function0[typingsSlinky.senchaUnderscoreTouch.Ext.field.IField]] = js.undefined
...
object ICheckbox {
  @scala.inline
  def apply(
    IField: typingsSlinky.senchaUnderscoreTouch.Ext.field.IField = null,
    ...
    reset: () => typingsSlinky.senchaUnderscoreTouch.Ext.field.IField = null,
