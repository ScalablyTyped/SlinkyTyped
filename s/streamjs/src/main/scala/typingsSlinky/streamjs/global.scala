...
object global extends js.Object {
  ...
  object Stream extends js.Object {
    ...
    class Optional[T] ()
      ...
      /* CompleteClass */
      override def filter(predicate: js.Function1[T, Boolean]): typingsSlinky.streamjs.Stream.Optional[T] = js.native
      /* CompleteClass */
      override def flatMap[U](mapper: js.Function1[T, typingsSlinky.streamjs.Stream.Optional[U]]): typingsSlinky.streamjs.Stream.Optional[U] = js.native
      /* CompleteClass */
      ...
      /* CompleteClass */
      override def map[U](mapper: js.Function1[T, U]): typingsSlinky.streamjs.Stream.Optional[U] = js.native
      /* CompleteClass */
