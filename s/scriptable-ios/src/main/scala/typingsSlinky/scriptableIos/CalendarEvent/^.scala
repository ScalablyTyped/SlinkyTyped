...
import typingsSlinky.scriptableIos.Calendar
...
object ^ extends js.Object {
  ...
  def between(startDate: js.Date, endDate: js.Date, calendars: js.Array[Calendar]): js.Promise[js.Array[typingsSlinky.scriptableIos.CalendarEvent]] = js.native
  /**
  ...
  def lastWeek(calendars: js.Array[Calendar]): js.Promise[js.Array[typingsSlinky.scriptableIos.CalendarEvent]] = js.native
  /**
  ...
  def nextWeek(calendars: js.Array[Calendar]): js.Promise[js.Array[typingsSlinky.scriptableIos.CalendarEvent]] = js.native
  /**
  ...
  def thisWeek(calendars: js.Array[Calendar]): js.Promise[js.Array[typingsSlinky.scriptableIos.CalendarEvent]] = js.native
  /**
  ...
  def today(calendars: js.Array[Calendar]): js.Promise[js.Array[typingsSlinky.scriptableIos.CalendarEvent]] = js.native
  /**
  ...
  def tomorrow(calendars: js.Array[Calendar]): js.Promise[js.Array[typingsSlinky.scriptableIos.CalendarEvent]] = js.native
  /**
  ...
  def yesterday(calendars: js.Array[Calendar]): js.Promise[js.Array[typingsSlinky.scriptableIos.CalendarEvent]] = js.native
}
