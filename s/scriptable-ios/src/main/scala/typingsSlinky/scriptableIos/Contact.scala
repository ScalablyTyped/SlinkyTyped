...
import typingsSlinky.scriptableIos.Contact.EmailAddresses
import typingsSlinky.scriptableIos.Contact.PhoneNumbers
import typingsSlinky.scriptableIos.Contact.PostalAddresses
import typingsSlinky.scriptableIos.Contact.SocialProfiles
