...
object Photos extends js.Object {
  /**
    ...
    */
  def fromCamera(): js.Promise[Image] = js.native
  /**
    ...
    */
  def fromLibrary(): js.Promise[Image] = js.native
  /**
    * _Get latest photo._
    *
    ...
    */
  def latestPhoto(): js.Promise[Image] = js.native
  /**
    ...
    */
  def latestPhotos(count: Double): js.Promise[js.Array[Image]] = js.native
  /**
    ...
    */
  def latestScreenshot(): js.Promise[Image] = js.native
  /**
    ...
    */
  def latestScreenshots(count: Double): js.Promise[js.Array[Image]] = js.native
  /**
  ...
  /**
    ...
    */
  def save(image: Image): Unit = js.native
}
