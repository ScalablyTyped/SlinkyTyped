...
class ContactsGroup ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addMember(contact: typingsSlinky.scriptableIos.Contact): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def removeMember(contact: typingsSlinky.scriptableIos.Contact): Unit = js.native
}
