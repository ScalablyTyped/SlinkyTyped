...
class Rect protected ()
  extends typingsSlinky.scriptableIos.Rect {
  /**
    * _Structure representing a rectangle._
    *
    * Constructs a new rectangle placed in a two-dimensional coordinate system.
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var origin: typingsSlinky.scriptableIos.Point = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var size: typingsSlinky.scriptableIos.Size = js.native
  /**
