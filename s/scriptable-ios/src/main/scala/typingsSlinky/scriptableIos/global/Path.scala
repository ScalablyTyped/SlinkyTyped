...
/**
  ...
  */
class Path ()
  extends typingsSlinky.scriptableIos.Path {
  /**
  ...
  override def addCurve(
    point: typingsSlinky.scriptableIos.Point,
    control1: typingsSlinky.scriptableIos.Point,
    control2: typingsSlinky.scriptableIos.Point
  ): Unit = js.native
  /**
    * _Adds an ellipse._
    *
    ...
    */
  /* CompleteClass */
  override def addEllipse(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addLine(point: typingsSlinky.scriptableIos.Point): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addLines(points: js.Array[typingsSlinky.scriptableIos.Point]): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addQuadCurve(point: typingsSlinky.scriptableIos.Point, control: typingsSlinky.scriptableIos.Point): Unit = js.native
  /**
    * _Adds a rectangle._
    *
    ...
    */
  /* CompleteClass */
  override def addRect(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addRects(rects: js.Array[typingsSlinky.scriptableIos.Rect]): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addRoundedRect(rect: typingsSlinky.scriptableIos.Rect, cornerWidth: Double, cornerHeight: Double): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def move(point: typingsSlinky.scriptableIos.Point): Unit = js.native
}
