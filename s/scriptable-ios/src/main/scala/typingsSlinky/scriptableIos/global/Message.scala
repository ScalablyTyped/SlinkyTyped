...
/**
  ...
  */
class Message ()
  extends typingsSlinky.scriptableIos.Message {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addDataAttachment(data: typingsSlinky.scriptableIos.Data, uti: String, filename: String): Unit = js.native
  /**
