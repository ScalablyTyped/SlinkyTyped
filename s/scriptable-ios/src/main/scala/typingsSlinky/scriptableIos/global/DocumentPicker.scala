...
object DocumentPicker extends js.Object {
  ...
  /**
    ...
    */
  def exportData(data: typingsSlinky.scriptableIos.Data): js.Promise[js.Array[String]] = js.native
  def exportData(data: typingsSlinky.scriptableIos.Data, name: String): js.Promise[js.Array[String]] = js.native
  ...
  /**
    ...
    */
  def exportImage(image: typingsSlinky.scriptableIos.Image): js.Promise[js.Array[String]] = js.native
  def exportImage(image: typingsSlinky.scriptableIos.Image, name: String): js.Promise[js.Array[String]] = js.native
