...
object args {
  ...
  @js.native
  def images: js.Array[typingsSlinky.scriptableIos.Image] = js.native
  @scala.inline
  def images_=(x: js.Array[typingsSlinky.scriptableIos.Image]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("images")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def notification: typingsSlinky.scriptableIos.Notification = js.native
  @scala.inline
  def notification_=(x: typingsSlinky.scriptableIos.Notification): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("notification")(x.asInstanceOf[js.Any])
