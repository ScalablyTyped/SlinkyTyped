...
class Reminder ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addRecurrenceRule(recurrenceRule: typingsSlinky.scriptableIos.RecurrenceRule): Unit = js.native
  /**
