...
/**
  ...
  */
class Mail ()
  extends typingsSlinky.scriptableIos.Mail {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addDataAttachment(data: typingsSlinky.scriptableIos.Data, mimeType: String, filename: String): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addImageAttachment(image: typingsSlinky.scriptableIos.Image): Unit = js.native
  /**
    * _Send the mail._
    *
