...
/**
  ...
  */
class DrawContext ()
  extends typingsSlinky.scriptableIos.DrawContext {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addPath(path: typingsSlinky.scriptableIos.Path): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def drawImageAtPoint(image: typingsSlinky.scriptableIos.Image, point: typingsSlinky.scriptableIos.Point): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def drawImageInRect(image: typingsSlinky.scriptableIos.Image, rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def drawText(text: String, pos: typingsSlinky.scriptableIos.Point): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def drawTextInRect(text: String, rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def fill(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
    * _Fills an ellipse._
    *
    ...
    */
  /* CompleteClass */
  override def fillEllipse(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def fillRect(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getImage(): typingsSlinky.scriptableIos.Image = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def setFillColor(color: typingsSlinky.scriptableIos.Color): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setStrokeColor(color: typingsSlinky.scriptableIos.Color): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setTextColor(color: typingsSlinky.scriptableIos.Color): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def stroke(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
    * _Strokes a rectangle._
    *
    ...
    */
  /* CompleteClass */
  override def strokeEllipse(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def strokeRect(rect: typingsSlinky.scriptableIos.Rect): Unit = js.native
}
