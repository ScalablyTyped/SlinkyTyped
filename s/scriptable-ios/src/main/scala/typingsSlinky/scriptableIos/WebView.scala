...
object WebView extends js.Object {
  /**
    ...
    */
  def loadFile(fileURL: String): js.Promise[Unit] = js.native
  def loadFile(fileURL: String, preferredSize: Size): js.Promise[Unit] = js.native
  def loadFile(fileURL: String, preferredSize: Size, fullscreen: Boolean): js.Promise[Unit] = js.native
  /**
  ...
  def loadHTML(html: String): js.Promise[Unit] = js.native
  def loadHTML(html: String, baseURL: String): js.Promise[Unit] = js.native
  def loadHTML(html: String, baseURL: String, preferredSize: Size): js.Promise[Unit] = js.native
  def loadHTML(html: String, baseURL: String, preferredSize: Size, fullscreen: Boolean): js.Promise[Unit] = js.native
  /**
    ...
    */
  def loadURL(url: String): js.Promise[Unit] = js.native
  def loadURL(url: String, preferredSize: Size): js.Promise[Unit] = js.native
  def loadURL(url: String, preferredSize: Size, fullscreen: Boolean): js.Promise[Unit] = js.native
}
