...
@js.native
class RecurrenceRule () extends js.Object
...
object RecurrenceRule extends js.Object {
  ...
  /**
    ...
    */
  def complexWeekly(interval: Double, daysOfTheWeek: js.Array[Double], setPositions: js.Array[Double]): RecurrenceRule = js.native
  /**
  ...
  /**
    ...
    */
  def daily(interval: Double): RecurrenceRule = js.native
  /**
    ...
    */
  def dailyEndDate(interval: Double, endDate: js.Date): RecurrenceRule = js.native
  /**
    ...
    */
  def dailyOccurrenceCount(interval: Double, occurrenceCount: Double): RecurrenceRule = js.native
  /**
    ...
    */
  def monthly(interval: Double): RecurrenceRule = js.native
  /**
    ...
    */
  def monthlyEndDate(interval: Double, endDate: js.Date): RecurrenceRule = js.native
  /**
    ...
    */
  def monthlyOccurrenceCount(interval: Double, occurrenceCount: Double): RecurrenceRule = js.native
  /**
    ...
    */
  def weekly(interval: Double): RecurrenceRule = js.native
  /**
    ...
    */
  def weeklyEndDate(interval: Double, endDate: js.Date): RecurrenceRule = js.native
  /**
    ...
    */
  def weeklyOccurrenceCount(interval: Double, occurrenceCount: Double): RecurrenceRule = js.native
  /**
    ...
    */
  def yearly(interval: Double): RecurrenceRule = js.native
  /**
    ...
    */
  def yearlyEndDate(interval: Double, endDate: js.Date): RecurrenceRule = js.native
  /**
    ...
    */
  def yearlyOccurrenceCount(interval: Double, occurrenceCount: Double): RecurrenceRule = js.native
}
