...
object Reminder extends js.Object {
  ...
  /**
    ...
    */
  def allDueBetween(startDate: js.Date, endDate: js.Date): js.Promise[js.Array[Reminder]] = js.native
  def allDueBetween(startDate: js.Date, endDate: js.Date, calendars: js.Array[Calendar]): js.Promise[js.Array[Reminder]] = js.native
  /**
  ...
  /**
    ...
    */
  def completedBetween(startDate: js.Date, endDate: js.Date): js.Promise[js.Array[Reminder]] = js.native
  def completedBetween(startDate: js.Date, endDate: js.Date, calendars: js.Array[Calendar]): js.Promise[js.Array[Reminder]] = js.native
  /**
    * _Fetches completed reminders._
    *
    ...
    */
  def completedDueBetween(startDate: js.Date, endDate: js.Date): js.Promise[js.Array[Reminder]] = js.native
  def completedDueBetween(startDate: js.Date, endDate: js.Date, calendars: js.Array[Calendar]): js.Promise[js.Array[Reminder]] = js.native
  /**
  ...
  /**
    ...
    */
  def incompleteDueBetween(startDate: js.Date, endDate: js.Date): js.Promise[js.Array[Reminder]] = js.native
  def incompleteDueBetween(startDate: js.Date, endDate: js.Date, calendars: js.Array[Calendar]): js.Promise[js.Array[Reminder]] = js.native
  /**
