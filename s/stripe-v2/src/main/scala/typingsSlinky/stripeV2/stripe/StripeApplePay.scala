...
import typingsSlinky.stripeV2.AnonMessage
  ...
  implicit class StripeApplePayOps[Self <: StripeApplePay] (val x: Self) extends AnyVal {
    ...
    def withBuildSession(
      value: (StripeApplePayPaymentRequest, js.Function2[
        ...
        ret.asInstanceOf[js.Dynamic].updateDynamic("buildSession")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withCheckAvailability(value: js.Function1[/* result */ Boolean, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("checkAvailability")(js.Any.fromFunction1(value))
        ret
    }
  }
