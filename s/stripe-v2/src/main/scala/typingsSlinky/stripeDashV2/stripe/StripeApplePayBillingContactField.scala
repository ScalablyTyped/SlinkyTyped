...
object StripeApplePayBillingContactField {
  ...
  @scala.inline
  def name: typingsSlinky.stripeDashV2.stripeDashV2Strings.name = this.cast("name")
  @scala.inline
  def postalAddress: typingsSlinky.stripeDashV2.stripeDashV2Strings.postalAddress = this.cast("postalAddress")
}
