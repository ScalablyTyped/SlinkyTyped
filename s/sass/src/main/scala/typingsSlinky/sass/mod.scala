...
object mod {
  ...
  object types {
    ...
    trait Null extends SassType {
      ...
      var NULL: typingsSlinky.sass.mod.types.Null = js.native
    }
    @JSImport("sass", "types.Null")
    @js.native
    val Null: typingsSlinky.sass.mod.types.Null = js.native
  ...
  */
  ...
  object _ImporterReturnType {
    ...
    @scala.inline
    def Contents(contents: String): typingsSlinky.sass.anon.Contents = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.sass.anon.Contents]
    }
    
    @scala.inline
    def File(file: String): typingsSlinky.sass.anon.File = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.sass.anon.File]
    }
  }
}
