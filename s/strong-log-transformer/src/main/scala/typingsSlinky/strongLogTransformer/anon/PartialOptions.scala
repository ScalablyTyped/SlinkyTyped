package typingsSlinky.strongLogTransformer.anon
...
object PartialOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(mergeMultiline)) __obj.updateDynamic("mergeMultiline")(mergeMultiline.get.asInstanceOf[js.Any])
