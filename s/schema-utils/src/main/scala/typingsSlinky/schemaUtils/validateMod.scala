...
object validateMod {
  ...
  type Schema = (typingsSlinky.jsonSchema.mod.JSONSchema4 with Extend) | (typingsSlinky.jsonSchema.mod.JSONSchema6 with Extend) | (typingsSlinky.jsonSchema.mod.JSONSchema7 with Extend)
