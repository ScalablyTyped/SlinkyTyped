package typingsSlinky.schemaDashUtils.declarationsValidateMod
...
object ValidationErrorConfiguration {
  ...
  def apply(
    ...
    name: String = null,
    postFormatter: (/* formattedError */ String, /* error */ typingsSlinky.ajv.ajvMod.ErrorObject with Anon_Children) => String = null
