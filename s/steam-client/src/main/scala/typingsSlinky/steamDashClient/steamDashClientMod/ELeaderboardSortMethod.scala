...
object ELeaderboardSortMethod extends js.Object {
  ...
  /* 1 */ val Ascending: typingsSlinky.steamDashClient.steamDashClientMod.ELeaderboardSortMethod.Ascending with Double = js.native
  /* 2 */ val Descending: typingsSlinky.steamDashClient.steamDashClientMod.ELeaderboardSortMethod.Descending with Double = js.native
  /* 0 */ val None: typingsSlinky.steamDashClient.steamDashClientMod.ELeaderboardSortMethod.None with Double = js.native
  @JSBracketAccess
