...
object EIntroducerRouting extends js.Object {
  ...
  /* 0 */ val FileShare: typingsSlinky.steamDashClient.steamDashClientMod.EIntroducerRouting.FileShare with Double = js.native
  /* 2 */ val P2PNetworking: typingsSlinky.steamDashClient.steamDashClientMod.EIntroducerRouting.P2PNetworking with Double = js.native
  /* 1 */ val P2PVoiceChat: typingsSlinky.steamDashClient.steamDashClientMod.EIntroducerRouting.P2PVoiceChat with Double = js.native
  @JSBracketAccess
