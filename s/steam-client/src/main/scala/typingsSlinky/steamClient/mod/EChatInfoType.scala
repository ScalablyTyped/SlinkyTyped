...
object EChatInfoType extends StObject {
  ...
  /* 2 */ val InfoUpdate: typingsSlinky.steamClient.mod.EChatInfoType.InfoUpdate with Double = js.native
  
  @js.native
  sealed trait MemberLimitChange extends EChatInfoType
  /* 3 */ val MemberLimitChange: typingsSlinky.steamClient.mod.EChatInfoType.MemberLimitChange with Double = js.native
  
  @js.native
  sealed trait StateChange extends EChatInfoType
  /* 1 */ val StateChange: typingsSlinky.steamClient.mod.EChatInfoType.StateChange with Double = js.native
}
