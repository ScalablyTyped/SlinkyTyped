...
object ELeaderboardSortMethod extends StObject {
  ...
  /* 1 */ val Ascending: typingsSlinky.steamClient.mod.ELeaderboardSortMethod.Ascending with Double = js.native
  
  @js.native
  sealed trait Descending extends ELeaderboardSortMethod
  /* 2 */ val Descending: typingsSlinky.steamClient.mod.ELeaderboardSortMethod.Descending with Double = js.native
  
  @js.native
  sealed trait None extends ELeaderboardSortMethod
  /* 0 */ val None: typingsSlinky.steamClient.mod.ELeaderboardSortMethod.None with Double = js.native
}
