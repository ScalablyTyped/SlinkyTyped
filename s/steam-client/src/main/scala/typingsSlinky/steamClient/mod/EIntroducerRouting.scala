...
object EIntroducerRouting extends StObject {
  ...
  /* 0 */ val FileShare: typingsSlinky.steamClient.mod.EIntroducerRouting.FileShare with Double = js.native
  
  @js.native
  sealed trait P2PNetworking extends EIntroducerRouting
  /* 2 */ val P2PNetworking: typingsSlinky.steamClient.mod.EIntroducerRouting.P2PNetworking with Double = js.native
  
  // removed
  @js.native
  sealed trait P2PVoiceChat extends EIntroducerRouting
  /* 1 */ val P2PVoiceChat: typingsSlinky.steamClient.mod.EIntroducerRouting.P2PVoiceChat with Double = js.native
}
