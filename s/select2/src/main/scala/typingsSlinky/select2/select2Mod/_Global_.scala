...
import typingsSlinky.select2.select2Strings.select2
import typingsSlinky.select2.select2Strings.select2Colonclose
import typingsSlinky.select2.select2Strings.select2Colonclosing
import typingsSlinky.select2.select2Strings.select2Colonopen
import typingsSlinky.select2.select2Strings.select2Colonopening
import typingsSlinky.select2.select2Strings.select2Colonselect
import typingsSlinky.select2.select2Strings.select2Colonselecting
import typingsSlinky.select2.select2Strings.select2Colonunselect
import typingsSlinky.select2.select2Strings.select2Colonunselecting
