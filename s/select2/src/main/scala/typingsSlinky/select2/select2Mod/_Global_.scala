...
import typingsSlinky.select2.select2Mod._Global_.JQuery
import typingsSlinky.select2.select2Strings.`select2:close`
import typingsSlinky.select2.select2Strings.`select2:closing`
import typingsSlinky.select2.select2Strings.`select2:open`
import typingsSlinky.select2.select2Strings.`select2:opening`
import typingsSlinky.select2.select2Strings.`select2:select`
import typingsSlinky.select2.select2Strings.`select2:selecting`
import typingsSlinky.select2.select2Strings.`select2:unselect`
import typingsSlinky.select2.select2Strings.`select2:unselecting`
...
object _Global_ extends js.Object {
  ...
  trait JQuery[TElement] extends js.Object {
    ...
    @JSName("data")
    def data_select2(key: typingsSlinky.select2.select2Strings.select2): Select2 = js.native
    @JSName("on")
