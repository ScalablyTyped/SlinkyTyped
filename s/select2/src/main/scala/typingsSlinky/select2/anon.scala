...
import typingsSlinky.select2.mod.Select2Require
...
object anon {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: typingsSlinky.select2.mod.Options[DataFormat | GroupedDataFormat, _]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    }
  }
