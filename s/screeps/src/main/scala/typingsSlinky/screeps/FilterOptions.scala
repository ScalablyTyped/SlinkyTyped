...
object FilterOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.screeps.FindConstant */ T](filter: FilterFunction[T] | FilterObject | String): FilterOptions[T] = {
    val __obj = js.Dynamic.literal(filter = filter.asInstanceOf[js.Any])
    __obj.asInstanceOf[FilterOptions[T]]
  }
  @scala.inline
  implicit class FilterOptionsOps[Self <: FilterOptions[_], /* <: typingsSlinky.screeps.FindConstant */ T] (val x: Self with FilterOptions[T]) extends AnyVal {
    @scala.inline
