...
object Mineral {
  @scala.inline
  def apply[/* <: typingsSlinky.screeps.MineralConstant */ T](
    density: Double,
  ...
  @scala.inline
  implicit class MineralOps[Self <: Mineral[_], /* <: typingsSlinky.screeps.MineralConstant */ T] (val x: Self with Mineral[T]) extends AnyVal {
    @scala.inline
