...
object HeapStatistics {
  ...
  implicit class HeapStatisticsOps[Self <: HeapStatistics] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDoes_zap_garbage(value: `0` | `1`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("does_zap_garbage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withExternally_allocated_size(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("externally_allocated_size")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
