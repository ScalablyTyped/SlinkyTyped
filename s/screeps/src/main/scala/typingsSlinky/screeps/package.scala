...
package object screeps {
  ...
  type LookAtResult[K /* <: typingsSlinky.screeps.LookConstant */] = (typingsSlinky.std.Pick[typingsSlinky.screeps.LookAtTypes, K]) with typingsSlinky.screeps.AnonType[K]
  ...
  type LookAtResultWithPos[K /* <: typingsSlinky.screeps.LookConstant */] = typingsSlinky.screeps.LookAtResult[K] with typingsSlinky.screeps.AnonY
  // Look Constants
  ...
  /**
    ...
    */
  type PowerCreepPowers = org.scalablytyped.runtime.NumberDictionary[typingsSlinky.screeps.AnonCooldownLevel]
