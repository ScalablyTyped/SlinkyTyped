...
object `24` {
  ...
  @scala.inline
  def apply(OH: typingsSlinky.screeps.screepsStrings.GHO2): `24` = {
  ...
  implicit class `24MutableBuilder`[Self <: `24`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOH(value: typingsSlinky.screeps.screepsStrings.GHO2): Self = StObject.set(x, "OH", value.asInstanceOf[js.Any])
  }
}
