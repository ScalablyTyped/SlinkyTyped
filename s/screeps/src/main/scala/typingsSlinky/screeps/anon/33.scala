...
object `33` {
  ...
  @scala.inline
  def apply(X: typingsSlinky.screeps.screepsStrings.XZHO2): `33` = {
  ...
  implicit class `33MutableBuilder`[Self <: `33`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setX(value: typingsSlinky.screeps.screepsStrings.XZHO2): Self = StObject.set(x, "X", value.asInstanceOf[js.Any])
  }
}
