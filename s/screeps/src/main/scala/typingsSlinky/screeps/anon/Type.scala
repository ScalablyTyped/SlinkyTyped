...
object Type {
  @scala.inline
  def apply[/* <: typingsSlinky.screeps.LookConstant */ K](`type`: K): Type[K] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Type[K]]
  }
  @scala.inline
  implicit class TypeOps[Self <: Type[_], /* <: typingsSlinky.screeps.LookConstant */ K] (val x: Self with Type[K]) extends AnyVal {
    @scala.inline
