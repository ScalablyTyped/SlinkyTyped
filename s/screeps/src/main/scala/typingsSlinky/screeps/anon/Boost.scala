...
object Boost {
  @scala.inline
  def apply[/* <: typingsSlinky.screeps.BodyPartConstant */ T](hits: Double, `type`: T): Boost[T] = {
    val __obj = js.Dynamic.literal(hits = hits.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Boost[T]]
  }
  @scala.inline
  implicit class BoostOps[Self <: Boost[_], /* <: typingsSlinky.screeps.BodyPartConstant */ T] (val x: Self with Boost[T]) extends AnyVal {
    @scala.inline
