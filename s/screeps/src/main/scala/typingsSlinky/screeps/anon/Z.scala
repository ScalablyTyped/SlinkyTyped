...
object Z {
  ...
  implicit class ZOps[Self <: Z] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setH(value: typingsSlinky.screeps.screepsStrings.KH): Self = this.set("H", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setO(value: KO): Self = this.set("O", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setZ(value: typingsSlinky.screeps.screepsStrings.ZK): Self = this.set("Z", value.asInstanceOf[js.Any])
  }
}
