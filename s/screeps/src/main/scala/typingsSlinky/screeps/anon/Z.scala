...
object Z {
  ...
  implicit class ZMutableBuilder[Self <: Z] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setH(value: typingsSlinky.screeps.screepsStrings.KH): Self = StObject.set(x, "H", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setO(value: KO): Self = StObject.set(x, "O", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setZ(value: typingsSlinky.screeps.screepsStrings.ZK): Self = StObject.set(x, "Z", value.asInstanceOf[js.Any])
  }
}
