...
object RangedHeal {
  ...
  implicit class RangedHealOps[Self <: RangedHeal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeal(value: typingsSlinky.screeps.screepsNumbers.`3`): Self = this.set("heal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRangedHeal(value: typingsSlinky.screeps.screepsNumbers.`3`): Self = this.set("rangedHeal", value.asInstanceOf[js.Any])
  }
}
