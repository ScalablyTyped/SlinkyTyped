...
object RangedHeal {
  ...
  implicit class RangedHealMutableBuilder[Self <: RangedHeal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeal(value: typingsSlinky.screeps.screepsNumbers.`3`): Self = StObject.set(x, "heal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRangedHeal(value: typingsSlinky.screeps.screepsNumbers.`3`): Self = StObject.set(x, "rangedHeal", value.asInstanceOf[js.Any])
  }
}
