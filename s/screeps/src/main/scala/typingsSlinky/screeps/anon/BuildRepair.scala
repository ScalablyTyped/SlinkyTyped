...
object BuildRepair {
  ...
  implicit class BuildRepairOps[Self <: BuildRepair] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBuild(value: typingsSlinky.screeps.screepsNumbers.`2`): Self = this.set("build", value.asInstanceOf[js.Any])
    @scala.inline
    def setRepair(value: typingsSlinky.screeps.screepsNumbers.`2`): Self = this.set("repair", value.asInstanceOf[js.Any])
  }
