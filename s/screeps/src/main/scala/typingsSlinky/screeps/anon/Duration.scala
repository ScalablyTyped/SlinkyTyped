...
object Duration {
  ...
  implicit class DurationMutableBuilder[Self <: Duration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCooldown(value: `300`): Self = StObject.set(x, "cooldown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDuration(value: `1000`): Self = StObject.set(x, "duration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEffect(value: js.Tuple5[`0.9`, `0.7`, `0.5`, `0.35`, `0.2`]): Self = StObject.set(x, "effect", value.asInstanceOf[js.Any])
