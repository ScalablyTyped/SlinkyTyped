...
object AnonBoost {
  @scala.inline
  def apply[T](hits: Double, `type`: T): AnonBoost[T] = {
    val __obj = js.Dynamic.literal(hits = hits.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBoost[T]]
  }
  @scala.inline
  implicit class AnonBoostOps[Self[t] <: AnonBoost[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withBoost(
      value: /* import warning: importer.ImportType#apply Failed type conversion: keyof screeps.AnonDictpart[T] */ js.Any
    ): Self[T] = {
        val ret = this.duplicate
