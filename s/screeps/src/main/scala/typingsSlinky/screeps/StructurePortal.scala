...
object StructurePortal {
  ...
  @scala.inline
  def apply(
    destination: RoomPosition | typingsSlinky.screeps.anon.Shard,
  ...
  implicit class StructurePortalMutableBuilder[Self <: StructurePortal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDestination(value: RoomPosition | typingsSlinky.screeps.anon.Shard): Self = StObject.set(x, "destination", value.asInstanceOf[js.Any])
