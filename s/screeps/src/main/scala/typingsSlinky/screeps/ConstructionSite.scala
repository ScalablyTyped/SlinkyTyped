...
object ConstructionSite {
  @scala.inline
  def apply[/* <: typingsSlinky.screeps.BuildableStructureConstant */ T](
  ...
  @scala.inline
  implicit class ConstructionSiteOps[Self <: ConstructionSite[_], /* <: typingsSlinky.screeps.BuildableStructureConstant */ T] (val x: Self with ConstructionSite[T]) extends AnyVal {
    @scala.inline
