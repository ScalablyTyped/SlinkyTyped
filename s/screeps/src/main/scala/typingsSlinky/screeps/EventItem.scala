...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.screeps.AnonData
  - typingsSlinky.screeps.AnonEvent
  - typingsSlinky.screeps.AnonObjectId
  - typingsSlinky.screeps.AnonDataEvent
  - typingsSlinky.screeps.AnonEventObjectId
  - typingsSlinky.screeps.AnonDataEventObjectId
  - typingsSlinky.screeps.AnonEventEVENTREPAIR
  - typingsSlinky.screeps.AnonEventEVENTRESERVECONTROLLER
  - typingsSlinky.screeps.AnonEventEVENTUPGRADECONTROLLER
  - typingsSlinky.screeps.AnonEventEVENTEXIT
  - typingsSlinky.screeps.AnonEventEVENTPOWER
  - typingsSlinky.screeps.AnonEventEVENTTRANSFER
*/
