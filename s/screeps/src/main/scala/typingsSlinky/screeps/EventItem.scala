...
/* Rewritten from type alias, can be one of: 
  - typings.screeps.Anon_Data
  - typings.screeps.Anon_DataEvent
  - typings.screeps.Anon_DataEventObjectId
  - typings.screeps.Anon_DataEventObjectIdEVENTBUILD
  - typings.screeps.Anon_DataEventObjectIdEVENTHARVEST
  - typings.screeps.Anon_DataEventObjectIdEVENTHEAL
  - typings.screeps.Anon_DataEventObjectIdEVENTREPAIR
  - typings.screeps.Anon_DataEventObjectIdEVENTRESERVECONTROLLER
  - typings.screeps.Anon_DataEventObjectIdEVENTUPGRADECONTROLLER
  - typings.screeps.Anon_DataEventObjectIdEVENTEXIT
  - typings.screeps.Anon_DataEventObjectIdEVENTPOWER
  - typings.screeps.Anon_DataEventObjectIdEVENTTRANSFER
*/
trait EventItem extends js.Object

object EventItem {
  @scala.inline
  def Anon_DataEventObjectIdEVENTRESERVECONTROLLER(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTHARVEST(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTEXIT(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTHEAL(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTREPAIR(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTBUILD(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTPOWER(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTUPGRADECONTROLLER(
  ...
  @scala.inline
  def Anon_DataEventObjectIdEVENTTRANSFER(
