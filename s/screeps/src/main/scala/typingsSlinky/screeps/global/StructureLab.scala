...
import typingsSlinky.screeps.ScreepsReturnCode
import typingsSlinky.screeps.StructureLabConstructor
...
@js.native
class StructureLab protected ()
  extends typingsSlinky.screeps.StructureLab {
  def this(id: Id[typingsSlinky.screeps.StructureLab]) = this()
  /**
  ...
  /* CompleteClass */
  @JSName("room")
  override var room_Structure: typingsSlinky.screeps.Room = js.native
  /**
    * One of the STRUCTURE_* constants.
    */
  /* CompleteClass */
  override var structureType: typingsSlinky.screeps.STRUCTURE_LAB = js.native
  /**
