...
class StructureNuker protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var structureType: typingsSlinky.screeps.STRUCTURE_NUKER = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def launchNuke(pos: typingsSlinky.screeps.RoomPosition): ScreepsReturnCode = js.native
  /**
