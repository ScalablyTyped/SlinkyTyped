...
import typingsSlinky.screeps.AnyCreep
...
import typingsSlinky.screeps.StructureTowerConstructor
...
class StructureTower protected ()
  extends typingsSlinky.screeps.StructureTower {
  def this(id: Id[typingsSlinky.screeps.StructureTower]) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var structureType: typingsSlinky.screeps.STRUCTURE_TOWER = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def repair(target: typingsSlinky.screeps.Structure[StructureConstant]): ScreepsReturnCode = js.native
}
