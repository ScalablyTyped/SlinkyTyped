...
import typingsSlinky.screeps.StructurePortalConstructor
import typingsSlinky.screeps.anon.Shard
...
class StructurePortal protected ()
  extends typingsSlinky.screeps.StructurePortal {
  def this(id: Id[typingsSlinky.screeps.StructurePortal]) = this()
  /**
    ...
    */
  /* CompleteClass */
  override var destination: typingsSlinky.screeps.RoomPosition | Shard = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var structureType: typingsSlinky.screeps.STRUCTURE_PORTAL = js.native
  /**
