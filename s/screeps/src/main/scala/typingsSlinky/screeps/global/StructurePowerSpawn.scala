...
import typingsSlinky.screeps.StructurePowerSpawnConstructor
import typingsSlinky.screeps.anon.StoreRESOURCEENERGYRESOUR
...
class StructurePowerSpawn protected ()
  extends typingsSlinky.screeps.StructurePowerSpawn {
  def this(id: Id[typingsSlinky.screeps.StructurePowerSpawn]) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var structureType: typingsSlinky.screeps.STRUCTURE_POWER_SPAWN = js.native
  /**
