...
object Resource {
  @scala.inline
  def apply[/* <: typingsSlinky.screeps.ResourceConstant */ T](
    amount: Double,
  ...
  @scala.inline
  implicit class ResourceOps[Self <: Resource[_], /* <: typingsSlinky.screeps.ResourceConstant */ T] (val x: Self with Resource[T]) extends AnyVal {
    @scala.inline
