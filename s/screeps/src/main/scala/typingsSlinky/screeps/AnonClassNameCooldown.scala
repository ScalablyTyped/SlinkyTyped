...
object AnonClassNameCooldown {
  ...
  @scala.inline
  implicit class AnonClassNameCooldownOps[Self <: AnonClassNameCooldown] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCooldown(value: `400`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cooldown")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDuration(value: js.Tuple5[`200`, `400`, `600`, `800`, `1000`]): Self = {
        val ret = this.duplicate
