...
object Structure {
  @scala.inline
  def apply[/* <: typingsSlinky.screeps.StructureConstant */ T](
  ...
  @scala.inline
  implicit class StructureOps[Self <: Structure[_], /* <: typingsSlinky.screeps.StructureConstant */ T] (val x: Self with Structure[T]) extends AnyVal {
    @scala.inline
