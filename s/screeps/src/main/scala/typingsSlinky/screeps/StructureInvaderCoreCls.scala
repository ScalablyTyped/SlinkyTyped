...
@js.native
class StructureInvaderCoreCls protected () extends StructureInvaderCore {
  def this(id: Id[StructureInvaderCore]) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var structureType: STRUCTURE_INVADER_CORE = js.native
  /**
