package typingsSlinky.simpleMock
...
object mod extends Shortcut {
  ...
  object Action {
    ...
    implicit class ActionMutableBuilder[Self <: Action[_], T] (val x: Self with Action[T]) extends AnyVal {
      ...
      @scala.inline
      def setThrowError(value: js.Error): Self = StObject.set(x, "throwError", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Calls {
    ...
    @scala.inline
    def apply[T](arg: js.Any, args: js.Array[_], context: js.Any, k: Double, returned: T, threw: js.Error): Calls[T] = {
    ...
    implicit class CallsMutableBuilder[Self <: Calls[_], T] (val x: Self with Calls[T]) extends AnyVal {
      ...
      @scala.inline
      def setThrew(value: js.Error): Self = StObject.set(x, "threw", value.asInstanceOf[js.Any])
    }
  }
