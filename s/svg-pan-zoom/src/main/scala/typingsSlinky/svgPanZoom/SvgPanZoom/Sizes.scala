...
object Sizes {
  ...
  implicit class SizesOps[Self <: Sizes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRealZoom(value: Double): Self = this.set("realZoom", value.asInstanceOf[js.Any])
    @scala.inline
    def setViewBox(value: Height): Self = this.set("viewBox", value.asInstanceOf[js.Any])
    @scala.inline
