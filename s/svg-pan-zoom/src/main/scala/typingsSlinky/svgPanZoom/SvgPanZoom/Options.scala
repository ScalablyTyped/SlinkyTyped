...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setViewportSelectorSVGElement(value: SVGElement): Self = this.set("viewportSelector", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setViewportSelectorHTMLElement(value: HTMLElement): Self = this.set("viewportSelector", value.asInstanceOf[js.Any])
