...
object Options {
  ...
  def apply(
    ...
    zoomScaleSensitivity: js.UndefOr[Double] = js.undefined
  ): Options = {
    ...
    if (!js.isUndefined(controlIconsEnabled)) __obj.updateDynamic("controlIconsEnabled")(controlIconsEnabled.get.asInstanceOf[js.Any])
    if (customEventsHandler != null) __obj.updateDynamic("customEventsHandler")(customEventsHandler.asInstanceOf[js.Any])
    if (!js.isUndefined(dblClickZoomEnabled)) __obj.updateDynamic("dblClickZoomEnabled")(dblClickZoomEnabled.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(panEnabled)) __obj.updateDynamic("panEnabled")(panEnabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(preventMouseEventsDefault)) __obj.updateDynamic("preventMouseEventsDefault")(preventMouseEventsDefault.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(zoomScaleSensitivity)) __obj.updateDynamic("zoomScaleSensitivity")(zoomScaleSensitivity.get.asInstanceOf[js.Any])
