...
import typingsSlinky.snykDockerPlugin.instructionParserMod.DockerFileLayers
import typingsSlinky.snykDockerPlugin.instructionParserMod.DockerFilePackages
