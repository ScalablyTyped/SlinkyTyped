...
import typingsSlinky.stylableCore.cssdocsMod.CssDoc
import typingsSlinky.stylableCore.customValuesMod.Box_
import typingsSlinky.stylableCore.customValuesMod.BoxedValueMap
import typingsSlinky.stylableCore.customValuesMod.CustomTypes
import typingsSlinky.stylableCore.customValuesMod.CustomValueExtension
...
import typingsSlinky.stylableCore.diagnosticsMod.Diagnostic
import typingsSlinky.stylableCore.memoryMinimalFsMod.MinimalFSSetup
import typingsSlinky.stylableCore.parserMod.CssParser
import typingsSlinky.stylableCore.selectorUtilsMod.SelectorAstNode
import typingsSlinky.stylableCore.selectorUtilsMod.SelectorChunk
...
import typingsSlinky.stylableCore.stateValidatorsMod.StateParamType
import typingsSlinky.stylableCore.stateValidatorsMod.StateResult
import typingsSlinky.stylableCore.stylableAssetsMod.OnUrlCallback
...
import typingsSlinky.stylableCore.stylableTransformerMod.TransformerOptions
...
object mod {
  ...
  @js.native
  class Diagnostics ()
    extends typingsSlinky.stylableCore.diagnosticsMod.Diagnostics {
  ...
  object SBTypesParsers {
    ...
    @js.native
    def stGlobal(decl: Declaration, _diagnostics: typingsSlinky.stylableCore.diagnosticsMod.Diagnostics): js.Any = js.native
  ...
  class StylableMeta protected ()
    extends typingsSlinky.stylableCore.stylableProcessorMod.StylableMeta {
    def this(ast: Root_, diagnostics: typingsSlinky.stylableCore.diagnosticsMod.Diagnostics) = this()
  }
  ...
  class StylableTransformer protected ()
    extends typingsSlinky.stylableCore.stylableTransformerMod.StylableTransformer {
  ...
  @js.native
  def createEmptyMeta(root: Root_, diagnostics: typingsSlinky.stylableCore.diagnosticsMod.Diagnostics): typingsSlinky.stylableCore.stylableMetaMod.StylableMeta = js.native
  ...
  @js.native
  def getCssDocsForSymbol(meta: typingsSlinky.stylableCore.stylableMetaMod.StylableMeta, symbol: StylableSymbol): CssDoc | Null = js.native
  ...
  @js.native
  def getSourcePath(root: Root_, diagnostics: typingsSlinky.stylableCore.diagnosticsMod.Diagnostics): String = js.native
  ...
  @JSImport("@stylable/core", "process")
  @js.native
  def process(root: Root_, diagnostics: typingsSlinky.stylableCore.diagnosticsMod.Diagnostics): typingsSlinky.stylableCore.stylableMetaMod.StylableMeta = js.native
  @JSImport("@stylable/core", "process")
  @js.native
  def process(
    root: Root_,
  ...
  def resolveCustomValues(
    meta: typingsSlinky.stylableCore.stylableMetaMod.StylableMeta,
    resolver: typingsSlinky.stylableCore.stylableResolverMod.StylableResolver
