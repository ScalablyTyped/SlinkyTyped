...
object stylableProcessorMod {
  ...
  class StylableMeta protected ()
    extends typingsSlinky.stylableCore.stylableMetaMod.StylableMeta {
  ...
  @js.native
  def createEmptyMeta(root: Root_, diagnostics: Diagnostics): typingsSlinky.stylableCore.stylableMetaMod.StylableMeta = js.native
  ...
  @JSImport("@stylable/core/cjs/stylable-processor", "process")
  @js.native
  def process(root: Root_, diagnostics: Diagnostics): typingsSlinky.stylableCore.stylableMetaMod.StylableMeta = js.native
  @JSImport("@stylable/core/cjs/stylable-processor", "process")
  @js.native
  def process(
    root: Root_,
