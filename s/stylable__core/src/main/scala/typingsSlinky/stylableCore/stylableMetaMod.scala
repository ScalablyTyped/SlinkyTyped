...
import typingsSlinky.stylableCore.selectorUtilsMod.SelectorChunk2
...
object stylableMetaMod {
  ...
  class StylableMeta protected () extends StObject {
    ...
    var root: typingsSlinky.stylableCore.stylableCoreStrings.root = js.native
  ...
  */
  ...
  object StylableSymbol {
    ...
    @scala.inline
    def CSSVarSymbol(_kind: cssVar, name: String): typingsSlinky.stylableCore.stylableMetaMod.CSSVarSymbol = {
      val __obj = js.Dynamic.literal(_kind = _kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stylableCore.stylableMetaMod.CSSVarSymbol]
    }
    
    @scala.inline
    def ClassSymbol(_kind: `class`, name: String): typingsSlinky.stylableCore.stylableMetaMod.ClassSymbol = {
      val __obj = js.Dynamic.literal(_kind = _kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stylableCore.stylableMetaMod.ClassSymbol]
    }
    
    @scala.inline
    def ElementSymbol(_kind: element, name: String): typingsSlinky.stylableCore.stylableMetaMod.ElementSymbol = {
      val __obj = js.Dynamic.literal(_kind = _kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stylableCore.stylableMetaMod.ElementSymbol]
    }
    
    @scala.inline
    def ImportSymbol(_kind: `import`, context: String, `import`: Imported, name: String, `type`: named | default): typingsSlinky.stylableCore.stylableMetaMod.ImportSymbol = {
      val __obj = js.Dynamic.literal(_kind = _kind.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("import")(`import`.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stylableCore.stylableMetaMod.ImportSymbol]
    }
    
    @scala.inline
    def KeyframesSymbol(_kind: keyframes, alias: String, name: String): typingsSlinky.stylableCore.stylableMetaMod.KeyframesSymbol = {
      val __obj = js.Dynamic.literal(_kind = _kind.asInstanceOf[js.Any], alias = alias.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stylableCore.stylableMetaMod.KeyframesSymbol]
    }
    
    @scala.inline
    def VarSymbol(_kind: `var`, name: String, node: Node, text: String, value: String): typingsSlinky.stylableCore.stylableMetaMod.VarSymbol = {
      ...
      __obj.asInstanceOf[typingsSlinky.stylableCore.stylableMetaMod.VarSymbol]
    }
  }
