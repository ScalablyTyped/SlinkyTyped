...
import typingsSlinky.stylableCore.anon.Word
import typingsSlinky.stylableCore.diagnosticsMod.Diagnostics
import typingsSlinky.stylableCore.stylableCoreStrings.Colonimport
import typingsSlinky.stylableCore.stylableCoreStrings.Colonvars
...
import typingsSlinky.stylableCore.stylableCoreStrings.`st-scope`
import typingsSlinky.stylableCore.stylableCoreStrings.args
import typingsSlinky.stylableCore.stylableCoreStrings.named
import typingsSlinky.stylableCore.stylableCoreStrings.namespace
...
object stylableValueParsersMod {
  ...
  @js.native
  val STYLABLE_NAMED_MATCHER: js.RegExp = js.native
  
  @JSImport("@stylable/core/cjs/stylable-value-parsers", "STYLABLE_VALUE_MATCHER")
  @js.native
  val STYLABLE_VALUE_MATCHER: js.RegExp = js.native
  ...
  @js.native
  val mixinDeclRegExp: js.RegExp = js.native
  ...
  object rootValueMapping {
    ...
    @js.native
    def namespace: typingsSlinky.stylableCore.stylableCoreStrings.namespace = js.native
    @scala.inline
  ...
  /* keyof @stylable/core.anon.Default */ /* Rewritten from type alias, can be one of: 
    - typingsSlinky.stylableCore.stylableCoreStrings.from
    - typingsSlinky.stylableCore.stylableCoreStrings.named
    - typingsSlinky.stylableCore.stylableCoreStrings.default
    - typingsSlinky.stylableCore.stylableCoreStrings.root
    - typingsSlinky.stylableCore.stylableCoreStrings.states
    - typingsSlinky.stylableCore.stylableCoreStrings.`extends`
    - typingsSlinky.stylableCore.stylableCoreStrings.mixin
    - typingsSlinky.stylableCore.stylableCoreStrings.partialMixin
    - typingsSlinky.stylableCore.stylableCoreStrings.global
  */
