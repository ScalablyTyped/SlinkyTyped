...
import typingsSlinky.stylableCore.anon.Meta
...
import typingsSlinky.stylableCore.stylableCoreStrings.css
import typingsSlinky.stylableCore.stylableCoreStrings.js_
