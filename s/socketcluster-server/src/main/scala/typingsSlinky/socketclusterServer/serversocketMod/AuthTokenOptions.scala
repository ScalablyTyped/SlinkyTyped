...
import typingsSlinky.jsonwebtoken.mod.Algorithm
...
object AuthTokenOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(rejectOnFailedDelivery)) __obj.updateDynamic("rejectOnFailedDelivery")(rejectOnFailedDelivery.asInstanceOf[js.Any])
