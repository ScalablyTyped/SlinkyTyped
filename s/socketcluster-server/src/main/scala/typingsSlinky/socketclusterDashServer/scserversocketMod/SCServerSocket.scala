package typingsSlinky.socketclusterDashServer.scserversocketMod

import typingsSlinky.componentDashEmitter.componentDashEmitterMod.Emitter
...
import typingsSlinky.socketclusterDashServer.Anon_Batch
import typingsSlinky.socketclusterDashServer.Anon_Binary
import typingsSlinky.socketclusterDashServer.scserverMod.AuthToken
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.authStateChange
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.authenticate
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.authenticated
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.close
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.closed
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.connectAbort
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.connecting
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.deauthenticate
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.disconnect
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.error
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.message
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.open
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.raw
import typingsSlinky.socketclusterDashServer.socketclusterDashServerStrings.unauthenticated
import typingsSlinky.ws.wsMod.Data
