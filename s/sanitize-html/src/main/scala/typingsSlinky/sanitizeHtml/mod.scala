...
import typingsSlinky.sanitizeHtml.anon.Multiple
  ...
  */
  ...
  object IOptions {
    ...
    implicit class IOptionsMutableBuilder[Self <: IOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAllowedStyles(value: StringDictionary[StringDictionary[js.Array[js.RegExp]]]): Self = StObject.set(x, "allowedStyles", value.asInstanceOf[js.Any])
