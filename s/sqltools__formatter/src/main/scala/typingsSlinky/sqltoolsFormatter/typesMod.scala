...
import typingsSlinky.sqltoolsFormatter.sqltoolsFormatterStrings.db2
import typingsSlinky.sqltoolsFormatter.sqltoolsFormatterStrings.lower
import typingsSlinky.sqltoolsFormatter.sqltoolsFormatterStrings.n1ql
import typingsSlinky.sqltoolsFormatter.sqltoolsFormatterStrings.plSlashsql
import typingsSlinky.sqltoolsFormatter.sqltoolsFormatterStrings.preserve
import typingsSlinky.sqltoolsFormatter.sqltoolsFormatterStrings.sql
import typingsSlinky.sqltoolsFormatter.sqltoolsFormatterStrings.upper
...
object typesMod {
  ...
  object TokenTypes extends StObject {
    ...
    /* "block-comment" */ val BLOCK_COMMENT: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.BLOCK_COMMENT with String = js.native
    
    @js.native
    sealed trait CLOSE_PAREN extends TokenTypes
    /* "close-paren" */ val CLOSE_PAREN: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.CLOSE_PAREN with String = js.native
    
    @js.native
    sealed trait LINE_COMMENT extends TokenTypes
    /* "line-comment" */ val LINE_COMMENT: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.LINE_COMMENT with String = js.native
    
    @js.native
    sealed trait NO_SPACE_OPERATOR extends TokenTypes
    /* "no-space-operator" */ val NO_SPACE_OPERATOR: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.NO_SPACE_OPERATOR with String = js.native
    
    @js.native
    sealed trait NUMBER extends TokenTypes
    /* "number" */ val NUMBER: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.NUMBER with String = js.native
    
    @js.native
    sealed trait OPEN_PAREN extends TokenTypes
    /* "open-paren" */ val OPEN_PAREN: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.OPEN_PAREN with String = js.native
    
    @js.native
    sealed trait OPERATOR extends TokenTypes
    /* "operator" */ val OPERATOR: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.OPERATOR with String = js.native
    
    @js.native
    sealed trait PLACEHOLDER extends TokenTypes
    /* "placeholder" */ val PLACEHOLDER: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.PLACEHOLDER with String = js.native
    
    @js.native
    sealed trait RESERVED extends TokenTypes
    /* "reserved" */ val RESERVED: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.RESERVED with String = js.native
    
    @js.native
    sealed trait RESERVED_NEWLINE extends TokenTypes
    /* "reserved-newline" */ val RESERVED_NEWLINE: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.RESERVED_NEWLINE with String = js.native
    
    @js.native
    sealed trait RESERVED_TOP_LEVEL extends TokenTypes
    /* "reserved-top-level" */ val RESERVED_TOP_LEVEL: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.RESERVED_TOP_LEVEL with String = js.native
    
    @js.native
    sealed trait RESERVED_TOP_LEVEL_NO_INDENT extends TokenTypes
    /* "reserved-top-level-no-indent" */ val RESERVED_TOP_LEVEL_NO_INDENT: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.RESERVED_TOP_LEVEL_NO_INDENT with String = js.native
    
    @js.native
    sealed trait SERVERVARIABLE extends TokenTypes
    /* "servervariable" */ val SERVERVARIABLE: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.SERVERVARIABLE with String = js.native
    
    @js.native
    sealed trait STRING extends TokenTypes
    /* "string" */ val STRING: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.STRING with String = js.native
    
    @js.native
    sealed trait WHITESPACE extends TokenTypes
    /* "whitespace" */ val WHITESPACE: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.WHITESPACE with String = js.native
    
    @js.native
    sealed trait WORD extends TokenTypes
    /* "word" */ val WORD: typingsSlinky.sqltoolsFormatter.typesMod.TokenTypes.WORD with String = js.native
  }
