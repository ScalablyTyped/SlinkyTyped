package typingsSlinky.sqltoolsFormatter.abstractMod
...
object AbstractFormatter {
  ...
  implicit class AbstractFormatterOps[Self <: AbstractFormatter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTokenizer(value: () => typingsSlinky.sqltoolsFormatter.tokenizerMod.default): Self = this.set("tokenizer", js.Any.fromFunction0(value))
