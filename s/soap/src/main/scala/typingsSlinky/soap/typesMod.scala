...
object typesMod {
  ...
  */
  ...
  object ISoapFault {
    ...
    @scala.inline
    def ISoapFault11(faultcode: Double | String, faultstring: String): typingsSlinky.soap.typesMod.ISoapFault11 = {
      val __obj = js.Dynamic.literal(faultcode = faultcode.asInstanceOf[js.Any], faultstring = faultstring.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.soap.typesMod.ISoapFault11]
    }
    
    @scala.inline
    def ISoapFault12(Code: Subcode, Reason: Text): typingsSlinky.soap.typesMod.ISoapFault12 = {
      val __obj = js.Dynamic.literal(Code = Code.asInstanceOf[js.Any], Reason = Reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.soap.typesMod.ISoapFault12]
    }
  }
