...
object libSecurityMod extends js.Object {
  ...
  class BasicAuthSecurity protected ()
    extends typingsSlinky.soap.libSecurityBasicAuthSecurityMod.BasicAuthSecurity {
  ...
  class BearerSecurity protected ()
    extends typingsSlinky.soap.libSecurityBearerSecurityMod.BearerSecurity {
  ...
  class ClientSSLSecurity protected ()
    extends typingsSlinky.soap.libSecurityClientSSLSecurityMod.ClientSSLSecurity {
  ...
  class ClientSSLSecurityPFX protected ()
    extends typingsSlinky.soap.libSecurityClientSSLSecurityPFXMod.ClientSSLSecurityPFX {
  ...
  class NTLMSecurity protected ()
    extends typingsSlinky.soap.libSecurityNTLMSecurityMod.NTLMSecurity {
    def this(defaults: js.Any) = this()
  }
  
  @js.native
  class WSSecurity protected ()
    extends typingsSlinky.soap.libSecurityWSSecurityMod.WSSecurity {
    def this(username: String, password: String) = this()
  ...
  class WSSecurityCert protected ()
    extends typingsSlinky.soap.libSecurityWSSecurityCertMod.WSSecurityCert {
