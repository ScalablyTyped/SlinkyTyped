package typingsSlinky.soap.libHttpMod
...
class HttpClient () extends js.Object {
  ...
  /**
    ...
    */
  def handleResponse(req: typingsSlinky.request.requestMod.Request, res: Response, body: js.Any): js.Any = js.native
  def request(
    rurl: String,
    data: js.Any,
    callback: js.Function3[/* error */ js.Any, /* res */ js.UndefOr[js.Any], /* body */ js.UndefOr[js.Any], _]
  ): typingsSlinky.request.requestMod.Request = js.native
  def request(
    rurl: String,
    data: js.Any,
    callback: js.Function3[/* error */ js.Any, /* res */ js.UndefOr[js.Any], /* body */ js.UndefOr[js.Any], _],
  ...
  def requestStream(rurl: String, data: js.Any): typingsSlinky.request.requestMod.Request = js.native
  def requestStream(rurl: String, data: js.Any, exheaders: IHeaders): typingsSlinky.request.requestMod.Request = js.native
  def requestStream(rurl: String, data: js.Any, exheaders: IHeaders, exoptions: IExOptions): typingsSlinky.request.requestMod.Request = js.native
  def requestStream(rurl: String, data: js.Any, exheaders: IHeaders, exoptions: IExOptions, caller: js.Any): typingsSlinky.request.requestMod.Request = js.native
}
