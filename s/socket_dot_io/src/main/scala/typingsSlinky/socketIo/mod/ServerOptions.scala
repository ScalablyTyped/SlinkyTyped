...
import typingsSlinky.engineIo.mod.AttachOptions
import typingsSlinky.engineIo.mod.Message
...
/**
  ...
  */
trait ServerOptions
  extends typingsSlinky.engineIo.mod.ServerOptions
     with AttachOptions {
  /**
...
object ServerOptions {
  ...
  def apply(
    ...
    handlePreflightRequest: Boolean | (js.Function3[
      /* server */ typingsSlinky.engineIo.mod.Server, 
      /* req */ IncomingMessage, 
      /* res */ ServerResponse, 
      Unit
    ]) = null,
