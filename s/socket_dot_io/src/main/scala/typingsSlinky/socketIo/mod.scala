...
import typingsSlinky.engineIo.mod.ServerAttachOptions
...
object mod extends Shortcut {
  ...
  class ^ () extends Server {
    ...
    /**
      ...
      */
    def this(srv: typingsSlinky.node.httpMod.Server) = this()
    def this(srv: typingsSlinky.node.httpsMod.Server) = this()
  ...
  /**
    ...
    */
  Instantiable1[
          (/* port */ Double) | (/* srv */ typingsSlinky.node.httpMod.Server) | (/* srv */ typingsSlinky.node.httpsMod.Server) | (/* opts */ ServerOptions) | (/* port */ String), 
          Server
        ]
       with /**
    * Default Server constructor
  ...
  Instantiable0[Server]
       with Instantiable2[
          (/* port */ Double) | (/* srv */ typingsSlinky.node.httpMod.Server) | (/* srv */ typingsSlinky.node.httpsMod.Server) | (/* port */ String), 
          /* opts */ ServerOptions, 
          Server
        ] {
    ...
    /**
      ...
      * @param opts An optional parameters object
      */
    def apply(srv: typingsSlinky.node.httpMod.Server): Server = js.native
    def apply(srv: typingsSlinky.node.httpMod.Server, opts: ServerOptions): Server = js.native
    def apply(srv: typingsSlinky.node.httpsMod.Server): Server = js.native
    def apply(srv: typingsSlinky.node.httpsMod.Server, opts: ServerOptions): Server = js.native
