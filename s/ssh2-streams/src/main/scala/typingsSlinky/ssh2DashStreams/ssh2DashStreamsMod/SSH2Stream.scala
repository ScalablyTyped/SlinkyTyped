...
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_CLOSE:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_DATA:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_EOF:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_EXTENDED_DATA:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_FAILURE:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_OPEN_CONFIRMATION:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_OPEN_FAILURE:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_REQUEST:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_SUCCESS:0`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`CHANNEL_WINDOW_ADJUST:0`
