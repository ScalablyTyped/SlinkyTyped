...
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`exit-signal`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`exit-status`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`pty-req`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`window-change`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`x11-req`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`xon-xoff`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.env
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.exec
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.shell
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.signal
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.subsystem
