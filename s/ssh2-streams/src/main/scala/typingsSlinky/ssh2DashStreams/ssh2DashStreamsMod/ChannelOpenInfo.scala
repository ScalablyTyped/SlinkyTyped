...
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`auth-agent@opensshDOTcom`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`direct-streamlocal@opensshDOTcom`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`direct-tcpip`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`forwarded-streamlocal@opensshDOTcom`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.`forwarded-tcpip`
import typingsSlinky.ssh2DashStreams.ssh2DashStreamsStrings.session
