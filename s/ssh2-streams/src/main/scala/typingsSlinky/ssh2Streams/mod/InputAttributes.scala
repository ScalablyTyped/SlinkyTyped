...
object InputAttributes {
  ...
  implicit class InputAttributesOps[Self <: InputAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAtimeDate(value: js.Date): Self = this.set("atime", value.asInstanceOf[js.Any])
    @scala.inline
    def setAtime(value: Double | js.Date): Self = this.set("atime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMtime(value: Double | js.Date): Self = this.set("mtime", value.asInstanceOf[js.Any])
    @scala.inline
