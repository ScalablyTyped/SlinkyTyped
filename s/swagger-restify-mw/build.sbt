...
version := "0.7-dt-20181022Z-ef10ad"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "swagger-node-runner" % "0.6-dt-20190212Z-fd66af",
  "org.scalablytyped.slinky" %%% "swagger-schema-official" % "2.0-dt-20200515Z-31f34e")
