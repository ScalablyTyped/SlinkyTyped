...
import typingsSlinky.svgSpritemapWebpackPlugin.anon.Chunk
import typingsSlinky.svgSpritemapWebpackPlugin.anon.Filename
import typingsSlinky.svgSpritemapWebpackPlugin.anon.Generate
...
trait Options extends js.Object {
  ...
  /**
    ...
    */
  var input: js.UndefOr[typingsSlinky.svgSpritemapWebpackPlugin.anon.Options] = js.native
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInput(value: typingsSlinky.svgSpritemapWebpackPlugin.anon.Options): Self = this.set("input", value.asInstanceOf[js.Any])
