...
import typingsSlinky.simplebarReact.mod.Props
...
object SimplebarReact {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def scrollableNodeProps(value: js.Object): this.type = set("scrollableNodeProps", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: SimplebarReact.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
