...
object ArgmentedEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.subscribeUiEvent.mod.EventType */ T](mainType: String, resize: Height, scroll: Delta, subType: String, touch: AxisIntention, `type`: T): ArgmentedEvent[T] = {
  ...
  @scala.inline
  implicit class ArgmentedEventOps[Self <: ArgmentedEvent[_], /* <: typingsSlinky.subscribeUiEvent.mod.EventType */ T] (val x: Self with ArgmentedEvent[T]) extends AnyVal {
    @scala.inline
