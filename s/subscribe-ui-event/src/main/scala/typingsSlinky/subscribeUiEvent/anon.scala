...
object anon {
  ...
  object AxisIntention {
    ...
    implicit class AxisIntentionMutableBuilder[Self <: AxisIntention] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAxisIntention(value: typingsSlinky.subscribeUiEvent.subscribeUiEventStrings.x | y | _empty): Self = StObject.set(x, "axisIntention", value.asInstanceOf[js.Any])
