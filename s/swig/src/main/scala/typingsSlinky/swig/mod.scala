...
object mod {
  ...
  object lexer {
    ...
    object TYPES extends StObject {
      ...
      /* 15 */ val ARRAYOPEN: typingsSlinky.swig.mod.lexer.TYPES.ARRAYOPEN with Double = js.native
      
      /** Variable assignment */
      @js.native
      sealed trait ASSIGNMENT extends TYPES
      /* 24 */ val ASSIGNMENT: typingsSlinky.swig.mod.lexer.TYPES.ASSIGNMENT with Double = js.native
      
      /** true or false */
      @js.native
      sealed trait BOOL extends TYPES
      /* 23 */ val BOOL: typingsSlinky.swig.mod.lexer.TYPES.BOOL with Double = js.native
      
      /** Close square bracket */
      @js.native
      sealed trait BRACKETCLOSE extends TYPES
      /* 13 */ val BRACKETCLOSE: typingsSlinky.swig.mod.lexer.TYPES.BRACKETCLOSE with Double = js.native
      
      /** Open square bracket */
      @js.native
      sealed trait BRACKETOPEN extends TYPES
      /* 12 */ val BRACKETOPEN: typingsSlinky.swig.mod.lexer.TYPES.BRACKETOPEN with Double = js.native
      
      /** Colon (:) */
      @js.native
      sealed trait COLON extends TYPES
      /* 19 */ val COLON: typingsSlinky.swig.mod.lexer.TYPES.COLON with Double = js.native
      
      /** Comma */
      @js.native
      sealed trait COMMA extends TYPES
      /* 8 */ val COMMA: typingsSlinky.swig.mod.lexer.TYPES.COMMA with Double = js.native
      
      /** JavaScript-valid comparator */
      @js.native
      sealed trait COMPARATOR extends TYPES
      /* 20 */ val COMPARATOR: typingsSlinky.swig.mod.lexer.TYPES.COMPARATOR with Double = js.native
      
      /** Close curly brace */
      @js.native
      sealed trait CURLYCLOSE extends TYPES
      /* 18 */ val CURLYCLOSE: typingsSlinky.swig.mod.lexer.TYPES.CURLYCLOSE with Double = js.native
      ...
      /* 17 */ val CURLYOPEN: typingsSlinky.swig.mod.lexer.TYPES.CURLYOPEN with Double = js.native
      
      /** Key on an object using dot-notation */
      @js.native
      sealed trait DOTKEY extends TYPES
      /* 14 */ val DOTKEY: typingsSlinky.swig.mod.lexer.TYPES.DOTKEY with Double = js.native
      
      /** Variable filter */
      @js.native
      sealed trait FILTER extends TYPES
      /* 2 */ val FILTER: typingsSlinky.swig.mod.lexer.TYPES.FILTER with Double = js.native
      
      /** Empty variable filter */
      @js.native
      sealed trait FILTEREMPTY extends TYPES
      /* 3 */ val FILTEREMPTY: typingsSlinky.swig.mod.lexer.TYPES.FILTEREMPTY with Double = js.native
      
      /** Function */
      @js.native
      sealed trait FUNCTION extends TYPES
      /* 4 */ val FUNCTION: typingsSlinky.swig.mod.lexer.TYPES.FUNCTION with Double = js.native
      
      /** Function with no arguments */
      @js.native
      sealed trait FUNCTIONEMPTY extends TYPES
      /* 5 */ val FUNCTIONEMPTY: typingsSlinky.swig.mod.lexer.TYPES.FUNCTIONEMPTY with Double = js.native
      
      /** Boolean logic */
      @js.native
      sealed trait LOGIC extends TYPES
      /* 21 */ val LOGIC: typingsSlinky.swig.mod.lexer.TYPES.LOGIC with Double = js.native
      
      /** Start of a method */
      @js.native
      sealed trait METHODOPEN extends TYPES
      /* 25 */ val METHODOPEN: typingsSlinky.swig.mod.lexer.TYPES.METHODOPEN with Double = js.native
      
      /** Boolean logic "not" */
      @js.native
      sealed trait NOT extends TYPES
      /* 22 */ val NOT: typingsSlinky.swig.mod.lexer.TYPES.NOT with Double = js.native
      
      /** Number */
      @js.native
      sealed trait NUMBER extends TYPES
      /* 10 */ val NUMBER: typingsSlinky.swig.mod.lexer.TYPES.NUMBER with Double = js.native
      
      /** Math operator */
      @js.native
      sealed trait OPERATOR extends TYPES
      /* 11 */ val OPERATOR: typingsSlinky.swig.mod.lexer.TYPES.OPERATOR with Double = js.native
      
      /** Close parenthesis */
      @js.native
      sealed trait PARENCLOSE extends TYPES
      /* 7 */ val PARENCLOSE: typingsSlinky.swig.mod.lexer.TYPES.PARENCLOSE with Double = js.native
      
      /** Open parenthesis */
      @js.native
      sealed trait PARENOPEN extends TYPES
      /* 6 */ val PARENOPEN: typingsSlinky.swig.mod.lexer.TYPES.PARENOPEN with Double = js.native
      
      /** Plain string */
      @js.native
      sealed trait STRING extends TYPES
      /* 1 */ val STRING: typingsSlinky.swig.mod.lexer.TYPES.STRING with Double = js.native
      ...
      /* 100 */ val UNKNOWN: typingsSlinky.swig.mod.lexer.TYPES.UNKNOWN with Double = js.native
      
      /** Variable */
      @js.native
      sealed trait VAR extends TYPES
      /* 9 */ val VAR: typingsSlinky.swig.mod.lexer.TYPES.VAR with Double = js.native
      
      /** Whitespace */
      @js.native
      sealed trait WHITESPACE extends TYPES
      /* 0 */ val WHITESPACE: typingsSlinky.swig.mod.lexer.TYPES.WHITESPACE with Double = js.native
    }
