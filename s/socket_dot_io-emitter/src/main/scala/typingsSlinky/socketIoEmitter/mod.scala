...
import typingsSlinky.socketIoEmitter.anon.Recordbroadcastjsonvolati
...
object mod {
  ...
  */
  ...
  object SocketIORedisOptions {
    ...
    @scala.inline
    def Host(host: String, port: Double): typingsSlinky.socketIoEmitter.anon.Host = {
      val __obj = js.Dynamic.literal(host = host.asInstanceOf[js.Any], port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.socketIoEmitter.anon.Host]
    }
    
    @scala.inline
    def Socket(socket: String): typingsSlinky.socketIoEmitter.anon.Socket = {
      val __obj = js.Dynamic.literal(socket = socket.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.socketIoEmitter.anon.Socket]
    }
  }
}
