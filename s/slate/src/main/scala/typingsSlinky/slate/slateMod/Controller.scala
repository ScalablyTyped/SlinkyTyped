...
import typingsSlinky.slate.Anon_Snapshot
import typingsSlinky.slate.Anon_Target
...
trait Controller extends js.Object {
  ...
  def addMarksAtRange(
    range: RangeTypeJSON,
    marks: typingsSlinky.immutable.Immutable.Set[MarkProperties | MarkJSON | Mark | String]
  ...
  def replaceTextByPath(
    ...
    length: Double,
    text: String,
    marks: typingsSlinky.immutable.Immutable.Set[Mark]
  ): Controller = js.native
  /**
  ...
  /**
    ...
    */
  def setTextByKey(key: String, text: String, marks: typingsSlinky.immutable.Immutable.Set[Mark]): Controller = js.native
  /**
    *  Insert `text` at `offset` in node by `path`.
    */
  def setTextByPath(path: List[Double], text: String, marks: typingsSlinky.immutable.Immutable.Set[Mark]): Controller = js.native
  /**
