...
import typingsSlinky.slate.Anon_Match
import typingsSlinky.slate.Anon_Type
...
trait Rules extends js.Object {
  ...
  var text: js.UndefOr[js.RegExp | (js.Function1[/* text */ String, Boolean])] = js.undefined
}
...
object Rules {
  ...
  def apply(
    ...
    text: js.RegExp | (js.Function1[/* text */ String, Boolean]) = null
  ): Rules = {
