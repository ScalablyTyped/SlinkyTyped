...
import typingsSlinky.slate.Anon_End
import typingsSlinky.slate.Anon_OnlyLeaves
import typingsSlinky.slate.Anon_OnlyTypes
...
trait BaseNode extends js.Object {
  ...
  def blocks(options: IterableOptions with Anon_OnlyLeaves): js.Iterable[js.Tuple2[Block, List[Double]]] = js.native
  ...
  def getActiveMarksAtRange(range: RangeType): Set[Mark] = js.native
  def getActiveMarksAtRange(range: RangeTypeJSON): Set[Mark] = js.native
  def getActiveMarksAtRange(range: RangeTypeProperties): Set[Mark] = js.native
  ...
  def getInsertMarksAtPoint(point: Point): Set[Mark] = js.native
  def getInsertMarksAtPoint(point: PointJSON): Set[Mark] = js.native
  def getInsertMarksAtPoint(point: PointProperties): Set[Mark] = js.native
  def getInsertMarksAtRange(range: Range): Set[Mark] = js.native
  def getInsertMarksAtRange(range: RangeJSON): Set[Mark] = js.native
  def getInsertMarksAtRange(range: RangeProperties): Set[Mark] = js.native
  ...
  def getSelectionIndexes(range: RangeType): Anon_End | Boolean | Null = js.native
  def getSelectionIndexes(range: RangeType, isSelected: Boolean): Anon_End | Boolean | Null = js.native
  ...
  def inlines(options: IterableOptions with Anon_OnlyLeaves): js.Iterable[js.Tuple2[Inline, List[Double]]] = js.native
  ...
  def marks(options: IterableOptions with Anon_OnlyTypes): js.Iterable[js.Tuple3[Mark, Node, List[Double]]] = js.native
