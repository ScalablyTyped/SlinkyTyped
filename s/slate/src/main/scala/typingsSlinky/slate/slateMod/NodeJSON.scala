...
/* Rewritten from type alias, can be one of: 
  - typings.slate.slateMod.DocumentJSON
  - typings.slate.slateMod.BlockJSON
  - typings.slate.slateMod.InlineJSON
  - typings.slate.slateMod.TextJSON
*/
...
object NodeJSON {
  ...
  def BlockJSON(
    ...
    data: StringDictionary[js.Any] = null,
    key: String = null,
    nodes: js.Array[typingsSlinky.slate.slateMod.BlockJSON | InlineJSON | TextJSON] = null,
    `object`: block = null
  ): NodeJSON = {
    val __obj = js.Dynamic.literal()
  ...
  def InlineJSON(
    ...
    data: StringDictionary[js.Any] = null,
    key: String = null,
    nodes: js.Array[typingsSlinky.slate.slateMod.InlineJSON | TextJSON] = null,
    `object`: `inline` = null
  ): NodeJSON = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
