...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.slate.mod.DocumentProperties
  - typingsSlinky.slate.mod.BlockProperties
  - typingsSlinky.slate.mod.InlineProperties
  - typingsSlinky.slate.mod.TextProperties
*/
