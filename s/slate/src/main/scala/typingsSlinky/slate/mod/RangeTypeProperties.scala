...
import typingsSlinky.slate.slateStrings.annotation
import typingsSlinky.slate.slateStrings.decoration
import typingsSlinky.slate.slateStrings.range
import typingsSlinky.slate.slateStrings.selection
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Rewritten from type alias, can be one of: 
  - typingsSlinky.slate.mod.RangeProperties
  - typingsSlinky.slate.mod.SelectionProperties
  - typingsSlinky.slate.mod.DecorationProperties
  - typingsSlinky.slate.mod.AnnotationProperties
*/
