...
import typingsSlinky.slate.AnonEnd
import typingsSlinky.slate.IterableOptionsonlyLeaves
import typingsSlinky.slate.IterableOptionsonlyTypesA
...
trait BaseNode extends js.Object {
  ...
  var `object`: document | block | `inline` | typingsSlinky.slate.slateStrings.text = js.native
  val text: String = js.native
  var `type`: String = js.native
  def addMark(path: Path, mark: Mark): Node = js.native
  def ancestors(path: Path): js.Iterable[js.Tuple2[Node, List[Double]]] = js.native
  /**
    * Assertion variants.
    */
  ...
  def blocks(): js.Iterable[js.Tuple2[Block, List[Double]]] = js.native
  def blocks(options: IterableOptionsonlyLeaves): js.Iterable[js.Tuple2[Block, List[Double]]] = js.native
  ...
  def createIterable(): js.Iterable[js.Tuple2[Node, List[Double]]] = js.native
  def createIterable(options: IterableOptions): js.Iterable[js.Tuple2[Node, List[Double]]] = js.native
  ...
  def descendants(): js.Iterable[js.Tuple2[Node, List[Double]]] = js.native
  def descendants(options: IterableOptions): js.Iterable[js.Tuple2[Node, List[Double]]] = js.native
  ...
  def inlines(): js.Iterable[js.Tuple2[Inline, List[Double]]] = js.native
  def inlines(options: IterableOptionsonlyLeaves): js.Iterable[js.Tuple2[Inline, List[Double]]] = js.native
  ...
  def marks(): js.Iterable[js.Tuple3[Mark, Node, List[Double]]] = js.native
  def marks(options: IterableOptionsonlyTypesA): js.Iterable[js.Tuple3[Mark, Node, List[Double]]] = js.native
  ...
  def siblings(path: Path): js.Iterable[js.Tuple2[Node, List[Double]]] = js.native
  def siblings(path: Path, options: IterableOptions): js.Iterable[js.Tuple2[Node, List[Double]]] = js.native
  def splitNode(path: Path, position: Double, properties: NodeProperties): Node = js.native
  def texts(options: IterableOptions): js.Iterable[js.Tuple2[Text, List[Double]]] = js.native
