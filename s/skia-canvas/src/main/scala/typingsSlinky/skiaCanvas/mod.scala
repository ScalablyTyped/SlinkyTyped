package typingsSlinky.skiaCanvas

import typingsSlinky.node.Buffer
import typingsSlinky.skiaCanvas.anon.Format
import typingsSlinky.skiaCanvas.anon.Page
import typingsSlinky.skiaCanvas.skiaCanvasStrings.`2d`
...
object mod {
  ...
  @js.native
  val FontLibrary: typingsSlinky.skiaCanvas.mod.FontLibrary = js.native
