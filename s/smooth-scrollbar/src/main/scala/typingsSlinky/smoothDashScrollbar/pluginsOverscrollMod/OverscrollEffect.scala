...
object OverscrollEffect extends js.Object {
  ...
  /* "bounce" */ val BOUNCE: typingsSlinky.smoothDashScrollbar.pluginsOverscrollMod.OverscrollEffect.BOUNCE with String = js.native
  /* "glow" */ val GLOW: typingsSlinky.smoothDashScrollbar.pluginsOverscrollMod.OverscrollEffect.GLOW with String = js.native
  @JSBracketAccess
