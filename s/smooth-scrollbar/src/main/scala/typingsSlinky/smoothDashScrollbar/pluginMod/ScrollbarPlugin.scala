package typingsSlinky.smoothDashScrollbar.pluginMod

import typingsSlinky.smoothDashScrollbar.interfacesDataDash2dMod.Data2d
...
class ScrollbarPlugin protected ()
  extends typingsSlinky.smoothDashScrollbar.interfacesPluginMod.ScrollbarPlugin {
  ...
  /* CompleteClass */
  override val scrollbar: typingsSlinky.smoothDashScrollbar.interfacesScrollbarMod.Scrollbar = js.native
  /* CompleteClass */
