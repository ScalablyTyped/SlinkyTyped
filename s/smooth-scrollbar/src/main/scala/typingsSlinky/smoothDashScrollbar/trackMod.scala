...
import typingsSlinky.smoothDashScrollbar.interfacesTrackMod.ScrollbarTrack
...
object trackMod extends js.Object {
  ...
  class TrackController protected ()
    extends typingsSlinky.smoothDashScrollbar.interfacesTrackMod.TrackController {
