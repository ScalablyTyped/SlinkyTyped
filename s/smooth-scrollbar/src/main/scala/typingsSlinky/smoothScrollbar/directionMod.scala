...
object directionMod {
  ...
  object TrackDirection extends StObject {
    ...
    /* "x" */ val X: typingsSlinky.smoothScrollbar.directionMod.TrackDirection.X with String = js.native
    
    @js.native
    sealed trait Y extends TrackDirection
    /* "y" */ val Y: typingsSlinky.smoothScrollbar.directionMod.TrackDirection.Y with String = js.native
  }
}
