package typingsSlinky.smoothScrollbar.pluginMod
...
object ScrollbarPlugin {
  ...
  implicit class ScrollbarPluginOps[Self <: ScrollbarPlugin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnRender(value: Data2d => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScrollbar(value: Scrollbar): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scrollbar")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTransformDelta(value: (Data2d, js.Any) => Data2d): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transformDelta")(js.Any.fromFunction2(value))
        ret
    }
  }
