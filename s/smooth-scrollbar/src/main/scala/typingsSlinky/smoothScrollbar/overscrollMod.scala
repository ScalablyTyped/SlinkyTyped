...
object overscrollMod {
  ...
  object OverscrollEffect extends StObject {
    ...
    /* "bounce" */ val BOUNCE: typingsSlinky.smoothScrollbar.overscrollMod.OverscrollEffect.BOUNCE with String = js.native
    
    @js.native
    sealed trait GLOW extends OverscrollEffect
    /* "glow" */ val GLOW: typingsSlinky.smoothScrollbar.overscrollMod.OverscrollEffect.GLOW with String = js.native
  }
