...
name := "server"
version := "1.0-dt-20191126Z-787a42"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "csurf" % "1.9.0-dt-20191022Z-f970d0",
  ...
  "org.scalablytyped.slinky" %%% "express-session" % "1.15-dt-20191118Z-67bd8d",
  "org.scalablytyped.slinky" %%% "formidable" % "1.0.16-dt-20190322Z-adf2a7",
  "org.scalablytyped.slinky" %%% "helmet" % "0.0-unknown-dt-20191029Z-fb2f89",
