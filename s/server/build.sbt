...
name := "server"
version := "1.0-dt-20201020Z-77cd2f"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "csurf" % "1.11-dt-20201107Z-99fc3a",
  ...
  "org.scalablytyped.slinky" %%% "express-session" % "1.17-dt-20201119Z-a8c2d5",
