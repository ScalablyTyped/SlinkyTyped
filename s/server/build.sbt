...
name := "server"
version := "1.0-dt-20191126Z-9d7ce1"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "csurf" % "1.9.0-dt-20200226Z-1ba225",
  ...
  "org.scalablytyped.slinky" %%% "helmet" % "0.0-unknown-dt-20200426Z-16df85",
