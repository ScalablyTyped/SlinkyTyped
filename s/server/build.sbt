...
name := "server"
version := "1.0-dt-20191126Z-fd9fb4"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "csurf" % "1.9.0-dt-20191022Z-227272",
  ...
  "org.scalablytyped.slinky" %%% "express-session" % "1.15-dt-20191118Z-c309b3",
  "org.scalablytyped.slinky" %%% "formidable" % "1.0.16-dt-20190322Z-952be7",
  "org.scalablytyped.slinky" %%% "helmet" % "0.0-unknown-dt-20191029Z-42f1c6",
