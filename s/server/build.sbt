...
name := "server"
version := "1.0-dt-20191126Z-19eb50"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "csurf" % "1.9.0-dt-20200226Z-77d938",
  ...
  "org.scalablytyped.slinky" %%% "express-session" % "1.17-dt-20200227Z-c1549b",
  "org.scalablytyped.slinky" %%% "formidable" % "1.0.16-dt-20200225Z-8efb65",
  "org.scalablytyped.slinky" %%% "helmet" % "0.0-unknown-dt-20200226Z-f217d8",
