...
object mod {
  ...
  object Facility extends StObject {
    ...
    /* 14 */ val Alert: typingsSlinky.syslogClient.mod.Facility.Alert with Double = js.native
    
    @js.native
    sealed trait Audit extends Facility
    /* 13 */ val Audit: typingsSlinky.syslogClient.mod.Facility.Audit with Double = js.native
    
    @js.native
    sealed trait Kernel extends Facility
    /* 0 */ val Kernel: typingsSlinky.syslogClient.mod.Facility.Kernel with Double = js.native
    
    @js.native
    sealed trait Local0 extends Facility
    /* 16 */ val Local0: typingsSlinky.syslogClient.mod.Facility.Local0 with Double = js.native
    
    @js.native
    sealed trait Local1 extends Facility
    /* 17 */ val Local1: typingsSlinky.syslogClient.mod.Facility.Local1 with Double = js.native
    
    @js.native
    sealed trait Local2 extends Facility
    /* 18 */ val Local2: typingsSlinky.syslogClient.mod.Facility.Local2 with Double = js.native
    
    @js.native
    sealed trait Local3 extends Facility
    /* 19 */ val Local3: typingsSlinky.syslogClient.mod.Facility.Local3 with Double = js.native
    
    @js.native
    sealed trait Local4 extends Facility
    /* 20 */ val Local4: typingsSlinky.syslogClient.mod.Facility.Local4 with Double = js.native
    
    @js.native
    sealed trait Local5 extends Facility
    /* 21 */ val Local5: typingsSlinky.syslogClient.mod.Facility.Local5 with Double = js.native
    
    @js.native
    sealed trait Local6 extends Facility
    /* 22 */ val Local6: typingsSlinky.syslogClient.mod.Facility.Local6 with Double = js.native
    
    @js.native
    sealed trait Local7 extends Facility
    /* 23 */ val Local7: typingsSlinky.syslogClient.mod.Facility.Local7 with Double = js.native
    
    @js.native
    sealed trait System extends Facility
    /* 3 */ val System: typingsSlinky.syslogClient.mod.Facility.System with Double = js.native
    
    @js.native
    sealed trait User extends Facility
    /* 1 */ val User: typingsSlinky.syslogClient.mod.Facility.User with Double = js.native
  }
  ...
  object Severity extends StObject {
    ...
    /* 1 */ val Alert: typingsSlinky.syslogClient.mod.Severity.Alert with Double = js.native
    
    @js.native
    sealed trait Critical extends Severity
    /* 2 */ val Critical: typingsSlinky.syslogClient.mod.Severity.Critical with Double = js.native
    
    @js.native
    sealed trait Debug extends Severity
    /* 7 */ val Debug: typingsSlinky.syslogClient.mod.Severity.Debug with Double = js.native
    
    @js.native
    sealed trait Emergency extends Severity
    /* 0 */ val Emergency: typingsSlinky.syslogClient.mod.Severity.Emergency with Double = js.native
    
    @js.native
    sealed trait Error extends Severity
    /* 3 */ val Error: typingsSlinky.syslogClient.mod.Severity.Error with Double = js.native
    
    @js.native
    sealed trait Informational extends Severity
    /* 6 */ val Informational: typingsSlinky.syslogClient.mod.Severity.Informational with Double = js.native
    
    @js.native
    sealed trait Notice extends Severity
    /* 5 */ val Notice: typingsSlinky.syslogClient.mod.Severity.Notice with Double = js.native
    
    @js.native
    sealed trait Warning extends Severity
    /* 4 */ val Warning: typingsSlinky.syslogClient.mod.Severity.Warning with Double = js.native
  }
  ...
  object Transport extends StObject {
    ...
    /* 1 */ val Tcp: typingsSlinky.syslogClient.mod.Transport.Tcp with Double = js.native
    
    @js.native
    sealed trait Udp extends Transport
    /* 2 */ val Udp: typingsSlinky.syslogClient.mod.Transport.Udp with Double = js.native
  }
