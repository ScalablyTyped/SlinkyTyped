...
object ContentTag {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.scrivito.mod.ContentTag] {
    ...
    @scala.inline
    def widgetProps(value: js.Object): this.type = set("widgetProps", value.asInstanceOf[js.Any])
  }
