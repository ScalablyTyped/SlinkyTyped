...
import typingsSlinky.snykDepGraph.snykDepGraphStrings.`true`
import typingsSlinky.snykDepGraph.snykDepGraphStrings.cyclic
import typingsSlinky.snykDepGraph.snykDepGraphStrings.dev
import typingsSlinky.snykDepGraph.snykDepGraphStrings.prod
