...
object anon {
  ...
  object Children {
    ...
    implicit class ChildrenMutableBuilder[Self <: Children] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (StandardEngine, DebugEngine, Boolean) => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction3(value))
    }
  }
  ...
  object StackIndex {
    ...
    implicit class StackIndexMutableBuilder[Self <: StackIndex] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStackIndex(value: typingsSlinky.styletronReact.mod.StackIndex): Self = StObject.set(x, "stackIndex", value.asInstanceOf[js.Any])
