...
import typingsSlinky.styletronDashReact.styletronDashReactMod.DevProviderProps
...
object DevProvider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.styletronDashReact.styletronDashReactMod.DevProvider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.styletronDashReact.styletronDashReactMod.DevProvider] = {
