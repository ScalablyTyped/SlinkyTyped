...
import typingsSlinky.styletronDashReact.styletronDashReactBooleans.`false`
...
object ReducerContainer {
  ...
  def AssignmentCommutativeReducerContainer(
    ...
    factory: StyleObject => typingsSlinky.styletronDashReact.styletronDashReactMod.AssignmentCommutativeReducerContainer,
