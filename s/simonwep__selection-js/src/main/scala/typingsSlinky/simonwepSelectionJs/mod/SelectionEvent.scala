...
object SelectionEvent {
  ...
  implicit class SelectionEventOps[Self <: SelectionEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOeMouseEvent(value: MouseEvent): Self = this.set("oe", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOeTouchEvent(value: TouchEvent): Self = this.set("oe", value.asInstanceOf[js.Any])
