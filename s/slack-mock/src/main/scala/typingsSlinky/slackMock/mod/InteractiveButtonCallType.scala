...
object InteractiveButtonCallType extends StObject {
  ...
  /* "response" */ val response: typingsSlinky.slackMock.mod.InteractiveButtonCallType.response with String = js.native
  
  @js.native
  sealed trait response_url extends InteractiveButtonCallType
  /* "response_url" */ val response_url: typingsSlinky.slackMock.mod.InteractiveButtonCallType.response_url with String = js.native
}
