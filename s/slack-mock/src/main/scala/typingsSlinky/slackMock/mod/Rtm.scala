...
object Rtm {
  ...
  implicit class RtmMutableBuilder[Self <: Rtm[_], T] (val x: Self with Rtm[T]) extends AnyVal {
    ...
    @scala.inline
    def setClients(value: js.Array[typingsSlinky.ws.mod.^]): Self = StObject.set(x, "clients", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setClientsVarargs(value: typingsSlinky.ws.mod.^ *): Self = StObject.set(x, "clients", js.Array(value :_*))
