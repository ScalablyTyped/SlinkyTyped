...
object Rtm {
  ...
  implicit class RtmOps[Self <: Rtm[_], T] (val x: Self with Rtm[T]) extends AnyVal {
    ...
    @scala.inline
    def setClientsVarargs(value: typingsSlinky.ws.mod.^ *): Self = this.set("clients", js.Array(value :_*))
    @scala.inline
    def setClients(value: js.Array[typingsSlinky.ws.mod.^]): Self = this.set("clients", value.asInstanceOf[js.Any])
    @scala.inline
