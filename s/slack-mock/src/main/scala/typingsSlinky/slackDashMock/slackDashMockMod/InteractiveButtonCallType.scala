...
object InteractiveButtonCallType extends js.Object {
  ...
  /* "response" */ val response: typingsSlinky.slackDashMock.slackDashMockMod.InteractiveButtonCallType.response with String = js.native
  /* "response_url" */ val response_url: typingsSlinky.slackDashMock.slackDashMockMod.InteractiveButtonCallType.response_url with String = js.native
  @JSBracketAccess
