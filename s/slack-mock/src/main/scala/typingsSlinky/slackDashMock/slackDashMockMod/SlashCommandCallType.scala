package typingsSlinky.slackDashMock.slackDashMockMod
...
object SlashCommandCallType extends js.Object {
  ...
  /* "response" */ val response: typingsSlinky.slackDashMock.slackDashMockMod.SlashCommandCallType.response with String = js.native
  /* "response_url" */ val response_url: typingsSlinky.slackDashMock.slackDashMockMod.SlashCommandCallType.response_url with String = js.native
  @JSBracketAccess
