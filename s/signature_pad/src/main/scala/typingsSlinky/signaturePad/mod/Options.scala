...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBegin(value: /* event */ MouseEvent | Touch => Unit): Self = this.set("onBegin", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnBegin: Self = this.set("onBegin", js.undefined)
    
    @scala.inline
    def setOnEnd(value: /* event */ MouseEvent | Touch => Unit): Self = this.set("onEnd", js.Any.fromFunction1(value))
