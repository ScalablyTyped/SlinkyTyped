...
trait Point extends js.Object {
  ...
  var point: typingsSlinky.signaturePad.mod.Point = js.native
}
...
object Point {
  ...
  implicit class PointOps[Self <: Point] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPoint(value: typingsSlinky.signaturePad.mod.Point): Self = this.set("point", value.asInstanceOf[js.Any])
  }
