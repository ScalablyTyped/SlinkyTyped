...
object SafariExtensionSettingsChangeEvent {
  ...
  implicit class SafariExtensionSettingsChangeEventOps[Self <: SafariExtensionSettingsChangeEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCurrentTarget(value: SafariExtensionSettings | SafariExtensionSecureSettings): Self = {
    ...
    @scala.inline
    def withTarget(value: SafariExtensionSettings | SafariExtensionSecureSettings): Self = {
        val ret = this.duplicate
