...
object mod {
  ...
  @JSImport("sha1", JSImport.Namespace)
  @js.native
  def apply(message: String, options: Sha1AsBytesOptions): js.typedarray.Uint8Array = js.native
  @JSImport("sha1", JSImport.Namespace)
  @js.native
  def apply(message: String, options: Sha1AsStringOptions): String = js.native
  @JSImport("sha1", JSImport.Namespace)
  @js.native
  def apply(message: String, options: Sha1Options): String | js.typedarray.Uint8Array = js.native
  @JSImport("sha1", JSImport.Namespace)
  @js.native
  def apply(message: Buffer): String = js.native
  @JSImport("sha1", JSImport.Namespace)
  @js.native
  def apply(message: Buffer, options: Sha1AsBytesOptions): js.typedarray.Uint8Array = js.native
  @JSImport("sha1", JSImport.Namespace)
  @js.native
  ...
  */
  ...
  object Sha1Options {
    ...
    @scala.inline
    def Sha1AsBytesOptions(asBytes: `true`): typingsSlinky.sha1.mod.Sha1AsBytesOptions = {
      val __obj = js.Dynamic.literal(asBytes = asBytes.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.sha1.mod.Sha1AsBytesOptions]
    }
    
    @scala.inline
    def Sha1AsStringOptions(): typingsSlinky.sha1.mod.Sha1AsStringOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.sha1.mod.Sha1AsStringOptions]
    }
  }
}
