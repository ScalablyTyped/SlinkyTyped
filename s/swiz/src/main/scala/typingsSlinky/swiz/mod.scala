package typingsSlinky.swiz

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.swiz.mod.struct.IField
import typingsSlinky.swiz.mod.struct.IObj
...
object mod {
  ...
  object SERIALIZATION extends StObject {
    ...
    /* 0 */ val SERIALIZATION_JSON: typingsSlinky.swiz.mod.SERIALIZATION.SERIALIZATION_JSON with Double = js.native
    
    @js.native
    sealed trait SERIALIZATION_XML extends SERIALIZATION
    /* 1 */ val SERIALIZATION_XML: typingsSlinky.swiz.mod.SERIALIZATION.SERIALIZATION_XML with Double = js.native
  }
