...
object ISwizOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(stripNulls)) __obj.updateDynamic("stripNulls")(stripNulls.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stripSerializerType)) __obj.updateDynamic("stripSerializerType")(stripSerializerType.get.asInstanceOf[js.Any])
