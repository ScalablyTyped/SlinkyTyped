...
object SERIALIZATION extends js.Object {
  ...
  /* 0 */ val SERIALIZATION_JSON: typingsSlinky.swiz.swizMod.SERIALIZATION.SERIALIZATION_JSON with Double = js.native
  /* 1 */ val SERIALIZATION_XML: typingsSlinky.swiz.swizMod.SERIALIZATION.SERIALIZATION_XML with Double = js.native
  @JSBracketAccess
