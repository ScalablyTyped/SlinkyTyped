...
object anon {
  ...
  object ClientApi {
    ...
    implicit class ClientApiMutableBuilder[Self <: ClientApi] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClientApi(value: typingsSlinky.storybookClientApi.mod.ClientApi): Self = StObject.set(x, "clientApi", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConfigApi(value: ConfigApi): Self = StObject.set(x, "configApi", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStoryStore(value: typingsSlinky.storybookClientApi.mod.StoryStore): Self = StObject.set(x, "storyStore", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Render {
    ...
    implicit class RenderMutableBuilder[Self <: Render] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChannel(value: typingsSlinky.storybookAddons.mod.Channel): Self = StObject.set(x, "channel", value.asInstanceOf[js.Any])
