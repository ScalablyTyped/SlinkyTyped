...
object PeerOpts {
  ...
  implicit class PeerOptsOps[Self <: PeerOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWrtcRTCIceCandidate(value: RTCIceCandidate): Self = this.set("wrtc", value.asInstanceOf[js.Any])
    @scala.inline
    def setWrtcRTCPeerConnection(value: RTCPeerConnection): Self = this.set("wrtc", value.asInstanceOf[js.Any])
    @scala.inline
    def setWrtcRTCSessionDescription(value: RTCSessionDescription): Self = this.set("wrtc", value.asInstanceOf[js.Any])
    @scala.inline
