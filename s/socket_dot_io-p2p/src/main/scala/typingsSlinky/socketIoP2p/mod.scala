package typingsSlinky.socketIoP2p
...
object mod {
  ...
  object PeerOpts {
    ...
    implicit class PeerOptsMutableBuilder[Self <: PeerOpts] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setWrtcRTCIceCandidate(value: RTCIceCandidate): Self = StObject.set(x, "wrtc", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWrtcRTCPeerConnection(value: RTCPeerConnection): Self = StObject.set(x, "wrtc", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWrtcRTCSessionDescription(value: RTCSessionDescription): Self = StObject.set(x, "wrtc", value.asInstanceOf[js.Any])
