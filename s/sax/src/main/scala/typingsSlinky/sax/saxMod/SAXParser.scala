package typingsSlinky.sax.saxMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.sax.Anon_Body
import typingsSlinky.sax.Anon_Name
import typingsSlinky.sax.Anon_Prefix
...
class SAXParser () extends js.Object {
  ...
  def onattribute(attr: Anon_Name): Unit = js.native
  def oncdata(cdata: String): Unit = js.native
  def onclosecdata(): Unit = js.native
  def onclosenamespace(ns: Anon_Prefix): Unit = js.native
  ...
  def onopennamespace(ns: Anon_Prefix): Unit = js.native
  def onopentag(tag: QualifiedTag): Unit = js.native
  def onopentag(tag: Tag): Unit = js.native
  def onprocessinginstruction(node: Anon_Body): Unit = js.native
