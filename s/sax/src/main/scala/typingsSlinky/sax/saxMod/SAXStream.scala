...
class SAXStream () extends Duplex {
  ...
  @JSName("on")
  def on_attribute(event: attribute, listener: js.ThisFunction1[/* this */ this.type, /* attr */ Anon_Name, Unit]): this.type = js.native
  @JSName("on")
  ...
  def on_closenamespace(
    ...
    listener: js.ThisFunction1[/* this */ this.type, /* ns */ Anon_Prefix, Unit]
  ): this.type = js.native
  @JSName("on")
  ...
  @JSName("on")
  def on_opennamespace(event: opennamespace, listener: js.ThisFunction1[/* this */ this.type, /* ns */ Anon_Prefix, Unit]): this.type = js.native
  @JSName("on")
  def on_opentag(
    event: opentag,
  ...
  def on_processinginstruction(
    ...
    listener: js.ThisFunction1[/* this */ this.type, /* node */ Anon_Body, Unit]
  ): this.type = js.native
  @JSName("on")
