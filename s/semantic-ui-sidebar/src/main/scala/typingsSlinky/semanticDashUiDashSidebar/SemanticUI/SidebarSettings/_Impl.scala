package typingsSlinky.semanticDashUiDashSidebar.SemanticUI.SidebarSettings

import typingsSlinky.semanticDashUiDashSidebar.JQuery
import typingsSlinky.semanticDashUiDashSidebar.SemanticUI.Sidebar.ClassNameSettings
import typingsSlinky.semanticDashUiDashSidebar.SemanticUI.Sidebar.DefaultTransitionSettings
import typingsSlinky.semanticDashUiDashSidebar.SemanticUI.Sidebar.ErrorSettings
import typingsSlinky.semanticDashUiDashSidebar.SemanticUI.Sidebar.RegExpSettings
import typingsSlinky.semanticDashUiDashSidebar.SemanticUI.Sidebar.SelectorSettings
import typingsSlinky.semanticDashUiDashSidebar.semanticDashUiDashSidebarStrings.auto
