package typingsSlinky.atStorybookAddonDashKnobs.distComponentsTypesSelectMod
...
object SelectTypeKnob {
  @scala.inline
  def apply[T /* <: SelectTypeKnobValue */](name: String, options: SelectTypeOptionsProp[T], value: T, defaultValue: T = null): SelectTypeKnob[T] = {
