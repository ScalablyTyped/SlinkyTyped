package typingsSlinky.atStorybookAddonDashKnobs.distKnobManagerMod

import typingsSlinky.atStorybookAddonDashKnobs.distComponentsTypesMod.KnobType
import typingsSlinky.atStorybookAddonDashKnobs.distTypeDashDefsMod.Knob
import typingsSlinky.atStorybookAddonDashKnobs.distTypeDashDefsMod.Mutable
...
trait KnobManager extends js.Object {
  ...
  var knobStore: typingsSlinky.atStorybookAddonDashKnobs.distKnobStoreMod.default
...
object KnobManager {
  ...
  def apply(
    ...
    knobStore: typingsSlinky.atStorybookAddonDashKnobs.distKnobStoreMod.default,
