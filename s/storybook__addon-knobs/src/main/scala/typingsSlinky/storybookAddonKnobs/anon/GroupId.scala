...
object GroupId {
  @scala.inline
  def apply[/* <: typingsSlinky.storybookAddonKnobs.typesMod.KnobType */ T](`type`: T): GroupId[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[GroupId[T]]
  }
  @scala.inline
  implicit class GroupIdOps[Self <: GroupId[_], /* <: typingsSlinky.storybookAddonKnobs.typesMod.KnobType */ T] (val x: Self with GroupId[T]) extends AnyVal {
    @scala.inline
