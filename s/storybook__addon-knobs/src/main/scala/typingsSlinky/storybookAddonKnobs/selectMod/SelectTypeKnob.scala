...
object SelectTypeKnob {
  @scala.inline
  def apply[/* <: typingsSlinky.storybookAddonKnobs.selectMod.SelectTypeKnobValue */ T](name: String, options: SelectTypeOptionsProp[T], value: T): SelectTypeKnob[T] = {
  ...
  @scala.inline
  implicit class SelectTypeKnobOps[Self <: SelectTypeKnob[_], /* <: typingsSlinky.storybookAddonKnobs.selectMod.SelectTypeKnobValue */ T] (val x: Self with SelectTypeKnob[T]) extends AnyVal {
    @scala.inline
