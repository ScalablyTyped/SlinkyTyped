...
object SelectTypeProps {
  @scala.inline
  def apply[/* <: typingsSlinky.storybookAddonKnobs.selectMod.SelectTypeKnobValue */ T](knob: SelectTypeKnob[T], onChange: T => T): SelectTypeProps[T] = {
    val __obj = js.Dynamic.literal(knob = knob.asInstanceOf[js.Any], onChange = js.Any.fromFunction1(onChange))
    __obj.asInstanceOf[SelectTypeProps[T]]
  }
  @scala.inline
  implicit class SelectTypePropsOps[Self <: SelectTypeProps[_], /* <: typingsSlinky.storybookAddonKnobs.selectMod.SelectTypeKnobValue */ T] (val x: Self with SelectTypeProps[T]) extends AnyVal {
    @scala.inline
