...
object OptionsTypeKnob {
  @scala.inline
  def apply[/* <: typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobValue[typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobSingleValue] */ T](name: String, options: OptionsTypeOptionsProp[T], optionsObj: OptionsKnobOptions, value: T): OptionsTypeKnob[T] = {
  ...
  @scala.inline
  implicit class OptionsTypeKnobOps[Self <: OptionsTypeKnob[_], /* <: typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobValue[typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobSingleValue] */ T] (val x: Self with OptionsTypeKnob[T]) extends AnyVal {
    @scala.inline
