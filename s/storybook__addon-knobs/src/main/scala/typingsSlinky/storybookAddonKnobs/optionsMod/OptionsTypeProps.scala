...
object OptionsTypeProps {
  @scala.inline
  def apply[/* <: typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobValue[typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobSingleValue] */ T](display: OptionsKnobOptionsDisplay, knob: OptionsTypeKnob[T], onChange: T => T): OptionsTypeProps[T] = {
  ...
  @scala.inline
  implicit class OptionsTypePropsOps[Self <: OptionsTypeProps[_], /* <: typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobValue[typingsSlinky.storybookAddonKnobs.optionsMod.OptionsTypeKnobSingleValue] */ T] (val x: Self with OptionsTypeProps[T]) extends AnyVal {
    @scala.inline
