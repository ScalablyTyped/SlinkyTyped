...
object OptionsTypeProps {
  ...
  @scala.inline
  implicit class OptionsTypePropsOps[Self <: OptionsTypeProps[_], T /* <: OptionsTypeKnobValue[OptionsTypeKnobSingleValue] */] (val x: Self with OptionsTypeProps[T]) extends AnyVal {
