...
import typingsSlinky.sawtoothSdk.protobufMod.IClientStateListRequest
...
class ClientStateListRequest ()
  extends typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest {
...
object ClientStateListRequest extends js.Object {
  ...
  /**
    ...
    */
  def create(): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  def create(properties: IClientStateListRequest): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  ...
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  def decode(reader: js.typedarray.Uint8Array): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  ...
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  ...
  /**
    ...
    * @returns ClientStateListRequest
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest = js.native
  ...
  /**
    ...
    */
  def toObject(message: typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest): StringDictionary[js.Any] = js.native
  def toObject(message: typingsSlinky.sawtoothSdk.protobufMod.ClientStateListRequest, options: IConversionOptions): StringDictionary[js.Any] = js.native
