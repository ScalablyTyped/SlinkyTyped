...
object ClientBatchGetRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientBatchGetRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientBatchGetRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientBatchGetRequest = js.native
  /**
