...
object ClientStateGetResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ClientStateGetResponse = js.native
  @JSImport("sawtooth-sdk/protobuf", "ClientStateGetResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientStateGetResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientStateGetResponse = js.native
  /**
