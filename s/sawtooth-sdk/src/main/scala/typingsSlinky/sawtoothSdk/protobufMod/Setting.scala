...
object Setting {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): Setting = js.native
  @JSImport("sawtooth-sdk/protobuf", "Setting.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Setting = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): Setting = js.native
  /**
