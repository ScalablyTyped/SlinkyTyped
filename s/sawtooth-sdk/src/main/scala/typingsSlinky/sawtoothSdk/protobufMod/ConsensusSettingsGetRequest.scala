...
object ConsensusSettingsGetRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ConsensusSettingsGetRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusSettingsGetRequest = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusSettingsGetRequest = js.native
