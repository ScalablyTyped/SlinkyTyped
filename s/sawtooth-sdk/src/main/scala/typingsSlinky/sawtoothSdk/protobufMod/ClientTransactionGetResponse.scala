...
object ClientTransactionGetResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientTransactionGetResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientTransactionGetResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientTransactionGetResponse = js.native
  /**
