...
object ClientEventsUnsubscribeRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientEventsUnsubscribeRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientEventsUnsubscribeRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientEventsUnsubscribeRequest = js.native
  /**
