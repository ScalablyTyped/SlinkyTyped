...
object ClientBatchStatus {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ClientBatchStatus = js.native
  @JSImport("sawtooth-sdk/protobuf", "ClientBatchStatus.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientBatchStatus = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientBatchStatus = js.native
  /**
