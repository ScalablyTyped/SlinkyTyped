...
object GetPeersResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): GetPeersResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GetPeersResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): GetPeersResponse = js.native
