...
import typingsSlinky.sawtoothSdk.protobufMod.ConsensusIgnoreBlockResponse.Status
...
object ConsensusIgnoreBlockResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ConsensusIgnoreBlockResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusIgnoreBlockResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusIgnoreBlockResponse = js.native
