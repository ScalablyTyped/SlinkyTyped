...
object ISuccessor {
  ...
  implicit class ISuccessorOps[Self <: ISuccessor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeletionsVarargs(value: js.typedarray.Uint8Array*): Self = this.set("deletions", js.Array(value :_*))
    
    @scala.inline
    def setDeletions(value: js.Array[js.typedarray.Uint8Array]): Self = this.set("deletions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSuccessor(value: js.typedarray.Uint8Array): Self = this.set("successor", value.asInstanceOf[js.Any])
