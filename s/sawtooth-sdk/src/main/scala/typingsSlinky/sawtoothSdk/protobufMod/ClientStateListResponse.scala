...
object ClientStateListResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ClientStateListResponse = js.native
  @JSImport("sawtooth-sdk/protobuf", "ClientStateListResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientStateListResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientStateListResponse = js.native
  /**
