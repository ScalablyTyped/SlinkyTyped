...
object ConsensusBlocksGetRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ConsensusBlocksGetRequest = js.native
  @JSImport("sawtooth-sdk/protobuf", "ConsensusBlocksGetRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusBlocksGetRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusBlocksGetRequest = js.native
  /**
