...
object ConsensusSummarizeBlockResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ConsensusSummarizeBlockResponse = js.native
  @JSImport("sawtooth-sdk/protobuf", "ConsensusSummarizeBlockResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusSummarizeBlockResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusSummarizeBlockResponse = js.native
  /**
