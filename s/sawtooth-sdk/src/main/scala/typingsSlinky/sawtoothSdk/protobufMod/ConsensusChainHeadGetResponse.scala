...
object ConsensusChainHeadGetResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ConsensusChainHeadGetResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusChainHeadGetResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusChainHeadGetResponse = js.native
