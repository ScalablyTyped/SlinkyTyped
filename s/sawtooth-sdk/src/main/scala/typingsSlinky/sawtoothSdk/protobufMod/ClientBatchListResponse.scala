...
object ClientBatchListResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientBatchListResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientBatchListResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientBatchListResponse = js.native
  /**
