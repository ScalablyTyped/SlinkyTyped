...
object RoleList extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): RoleList = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): RoleList = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): RoleList = js.native
