...
import typingsSlinky.sawtoothSdk.protobufMod.ClientBatchStatusResponse.Status
...
object ClientBatchStatusResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientBatchStatusResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientBatchStatusResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientBatchStatusResponse = js.native
