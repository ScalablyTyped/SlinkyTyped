...
object GossipBatchResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): GossipBatchResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GossipBatchResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): GossipBatchResponse = js.native
