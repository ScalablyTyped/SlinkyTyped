...
object ConsensusCheckBlocksResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ConsensusCheckBlocksResponse = js.native
  @JSImport("sawtooth-sdk/protobuf", "ConsensusCheckBlocksResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusCheckBlocksResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusCheckBlocksResponse = js.native
  /**
