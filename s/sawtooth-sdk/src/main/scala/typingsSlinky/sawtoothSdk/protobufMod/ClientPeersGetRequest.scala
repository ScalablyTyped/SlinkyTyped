...
object ClientPeersGetRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientPeersGetRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientPeersGetRequest = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientPeersGetRequest = js.native
