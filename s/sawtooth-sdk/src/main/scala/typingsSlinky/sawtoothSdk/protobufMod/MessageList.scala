...
object MessageList {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): MessageList = js.native
  @JSImport("sawtooth-sdk/protobuf", "MessageList.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): MessageList = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): MessageList = js.native
  /**
