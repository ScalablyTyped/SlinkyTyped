...
object ChangeLogEntry {
  ...
  object Successor {
    ...
    @js.native
    def decode(reader: js.typedarray.Uint8Array): Successor = js.native
    @JSImport("sawtooth-sdk/protobuf", "ChangeLogEntry.Successor.decode")
    @js.native
    def decode(reader: js.typedarray.Uint8Array, length: Double): Successor = js.native
    /**
    ...
    @js.native
    def decodeDelimited(reader: js.typedarray.Uint8Array): Successor = js.native
    /**
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ChangeLogEntry = js.native
  @JSImport("sawtooth-sdk/protobuf", "ChangeLogEntry.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ChangeLogEntry = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ChangeLogEntry = js.native
  /**
  ...
  object ISuccessor {
    ...
    implicit class ISuccessorMutableBuilder[Self <: ISuccessor] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDeletions(value: js.Array[js.typedarray.Uint8Array]): Self = StObject.set(x, "deletions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDeletionsVarargs(value: js.typedarray.Uint8Array*): Self = StObject.set(x, "deletions", js.Array(value :_*))
      
      @scala.inline
      def setSuccessor(value: js.typedarray.Uint8Array): Self = StObject.set(x, "successor", value.asInstanceOf[js.Any])
