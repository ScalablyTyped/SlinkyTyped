...
object ITransactionReceipt {
  ...
  implicit class ITransactionReceiptOps[Self <: ITransactionReceipt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataVarargs(value: js.typedarray.Uint8Array*): Self = this.set("data", js.Array(value :_*))
    @scala.inline
    def setData(value: js.Array[js.typedarray.Uint8Array]): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
