...
object ITransactionReceipt {
  ...
  implicit class ITransactionReceiptMutableBuilder[Self <: ITransactionReceipt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: js.Array[js.typedarray.Uint8Array]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataVarargs(value: js.typedarray.Uint8Array*): Self = StObject.set(x, "data", js.Array(value :_*))
