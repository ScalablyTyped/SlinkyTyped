...
object ConsensusCommitBlockResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ConsensusCommitBlockResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusCommitBlockResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusCommitBlockResponse = js.native
