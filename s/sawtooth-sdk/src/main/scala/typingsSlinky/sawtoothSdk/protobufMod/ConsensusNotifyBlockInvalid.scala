...
object ConsensusNotifyBlockInvalid extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ConsensusNotifyBlockInvalid = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusNotifyBlockInvalid = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusNotifyBlockInvalid = js.native
