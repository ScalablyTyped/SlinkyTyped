...
object ClientEventsGetResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientEventsGetResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientEventsGetResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientEventsGetResponse = js.native
