...
object Event {
  ...
  object Attribute {
    ...
    @js.native
    def decode(reader: js.typedarray.Uint8Array): Attribute = js.native
    @JSImport("sawtooth-sdk/protobuf", "Event.Attribute.decode")
    @js.native
    def decode(reader: js.typedarray.Uint8Array, length: Double): Attribute = js.native
    /**
    ...
    @js.native
    def decodeDelimited(reader: js.typedarray.Uint8Array): Attribute = js.native
    /**
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): Event = js.native
  @JSImport("sawtooth-sdk/protobuf", "Event.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Event = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): Event = js.native
  /**
