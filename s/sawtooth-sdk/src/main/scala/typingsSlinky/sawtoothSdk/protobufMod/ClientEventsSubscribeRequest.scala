...
object ClientEventsSubscribeRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ClientEventsSubscribeRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ClientEventsSubscribeRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ClientEventsSubscribeRequest = js.native
  /**
