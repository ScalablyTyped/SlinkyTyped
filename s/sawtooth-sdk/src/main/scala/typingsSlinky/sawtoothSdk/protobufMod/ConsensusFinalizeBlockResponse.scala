...
object ConsensusFinalizeBlockResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ConsensusFinalizeBlockResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusFinalizeBlockResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusFinalizeBlockResponse = js.native
  /**
