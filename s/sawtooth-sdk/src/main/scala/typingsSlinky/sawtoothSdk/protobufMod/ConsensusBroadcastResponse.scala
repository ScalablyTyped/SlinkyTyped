...
object ConsensusBroadcastResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ConsensusBroadcastResponse = js.native
  @JSImport("sawtooth-sdk/protobuf", "ConsensusBroadcastResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusBroadcastResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusBroadcastResponse = js.native
  /**
