...
object ConsensusRegisterResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ConsensusRegisterResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusRegisterResponse = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusRegisterResponse = js.native
