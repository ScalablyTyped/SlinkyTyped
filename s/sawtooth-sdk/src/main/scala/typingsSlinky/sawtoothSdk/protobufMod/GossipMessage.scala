...
object GossipMessage extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): GossipMessage = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GossipMessage = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): GossipMessage = js.native
  /**
