...
object ScrollRevealObjectOptions {
  ...
  implicit class ScrollRevealObjectOptionsOps[Self <: ScrollRevealObjectOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterReset(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = this.set("afterReset", js.Any.fromFunction1(value))
    @scala.inline
    def deleteAfterReset: Self = this.set("afterReset", js.undefined)
    @scala.inline
    def setAfterReveal(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = this.set("afterReveal", js.Any.fromFunction1(value))
    @scala.inline
    def deleteAfterReveal: Self = this.set("afterReveal", js.undefined)
    @scala.inline
    def setBeforeReset(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = this.set("beforeReset", js.Any.fromFunction1(value))
    @scala.inline
    def deleteBeforeReset: Self = this.set("beforeReset", js.undefined)
    @scala.inline
    def setBeforeReveal(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = this.set("beforeReveal", js.Any.fromFunction1(value))
    @scala.inline
