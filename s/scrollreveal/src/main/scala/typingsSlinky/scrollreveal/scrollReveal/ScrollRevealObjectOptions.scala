...
trait ScrollRevealObjectOptions extends js.Object {
  var afterReset: js.UndefOr[
    (js.Function1[/* domEl */ HTMLElement, Unit]) with (js.Function1[/* domEl */ NodeListOf[Element with Node], Unit])
  ] = js.undefined
...
object ScrollRevealObjectOptions {
  @scala.inline
  def apply(
    afterReset: (js.Function1[/* domEl */ HTMLElement, Unit]) with (js.Function1[/* domEl */ NodeListOf[Element with Node], Unit]) = null,
    afterReveal: (js.Function1[/* domEl */ HTMLElement, Unit]) with (js.Function1[/* domEl */ NodeListOf[Element with Node], Unit]) = null,
    beforeReset: (js.Function1[/* domEl */ HTMLElement, Unit]) with (js.Function1[/* domEl */ NodeListOf[Element with Node], Unit]) = null,
    beforeReveal: (js.Function1[/* domEl */ HTMLElement, Unit]) with (js.Function1[/* domEl */ NodeListOf[Element with Node], Unit]) = null,
