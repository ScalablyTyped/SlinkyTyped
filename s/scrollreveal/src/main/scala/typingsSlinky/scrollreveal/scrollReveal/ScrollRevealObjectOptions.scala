...
object ScrollRevealObjectOptions {
  @scala.inline
  def apply(
    afterReset: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit = null,
    afterReveal: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit = null,
    beforeReset: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit = null,
    beforeReveal: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit = null,
