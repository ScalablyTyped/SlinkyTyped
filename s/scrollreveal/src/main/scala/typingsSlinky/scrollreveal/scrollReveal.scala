...
object scrollReveal {
  ...
  object ScrollRevealObjectOptions {
    ...
    implicit class ScrollRevealObjectOptionsMutableBuilder[Self <: ScrollRevealObjectOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAfterReset(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = StObject.set(x, "afterReset", js.Any.fromFunction1(value))
      
      @scala.inline
      def setAfterResetUndefined: Self = StObject.set(x, "afterReset", js.undefined)
      
      @scala.inline
      def setAfterReveal(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = StObject.set(x, "afterReveal", js.Any.fromFunction1(value))
      
      @scala.inline
      def setAfterRevealUndefined: Self = StObject.set(x, "afterReveal", js.undefined)
      
      @scala.inline
      def setBeforeReset(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = StObject.set(x, "beforeReset", js.Any.fromFunction1(value))
      
      @scala.inline
      def setBeforeResetUndefined: Self = StObject.set(x, "beforeReset", js.undefined)
      
      @scala.inline
      def setBeforeReveal(value: /* domEl */ HTMLElement | (NodeListOf[Element with Node]) => Unit): Self = StObject.set(x, "beforeReveal", js.Any.fromFunction1(value))
