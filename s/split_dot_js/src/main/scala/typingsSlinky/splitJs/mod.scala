...
object mod {
  ...
  @js.native
  def apply(elements: js.Array[String | HTMLElement]): Instance = js.native
  @JSImport("split.js", JSImport.Namespace)
  @js.native
  def apply(elements: js.Array[String | HTMLElement], options: Options): Instance = js.native
  ...
  object CSSStyleDeclarationPartial {
    ...
    @scala.inline
    implicit class CSSStyleDeclarationPartialMutableBuilder[Self <: CSSStyleDeclarationPartial] (val x: Self) extends AnyVal {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDragInterval(value: Double): Self = StObject.set(x, "dragInterval", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDragIntervalUndefined: Self = StObject.set(x, "dragInterval", js.undefined)
      
      @scala.inline
      def setElementStyle(
        value: (/* dimension */ width | height, /* elementSize */ Double, /* gutterSize */ Double, /* index */ Double) => CSSStyleDeclarationPartial
      ): Self = StObject.set(x, "elementStyle", js.Any.fromFunction4(value))
      
      @scala.inline
      def setElementStyleUndefined: Self = StObject.set(x, "elementStyle", js.undefined)
      
      @scala.inline
      def setExpandToMin(value: Boolean): Self = StObject.set(x, "expandToMin", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExpandToMinUndefined: Self = StObject.set(x, "expandToMin", js.undefined)
      
      @scala.inline
      def setGutter(value: (/* index */ Double, /* direction */ horizontal | vertical) => HTMLElement): Self = StObject.set(x, "gutter", js.Any.fromFunction2(value))
      
      @scala.inline
      def setGutterAlign(value: String): Self = StObject.set(x, "gutterAlign", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGutterAlignUndefined: Self = StObject.set(x, "gutterAlign", js.undefined)
      ...
      ): Self = StObject.set(x, "gutterStyle", js.Any.fromFunction3(value))
      
      @scala.inline
      def setGutterStyleUndefined: Self = StObject.set(x, "gutterStyle", js.undefined)
      ...
      @scala.inline
      def setOnDrag(value: /* sizes */ js.Array[Double] => Unit): Self = StObject.set(x, "onDrag", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnDragEnd(value: /* sizes */ js.Array[Double] => Unit): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
      
      @scala.inline
      def setOnDragStart(value: /* sizes */ js.Array[Double] => Unit): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1(value))
  ...
  {[ P in keyof T ]:? T[P]}
    */ typingsSlinky.splitJs.splitJsStrings.Partial with TopLevel[T]
}
