...
trait Fn7 extends js.Object {
  ...
  def apply(range: RangeTypeJSON, mark: MarkJSON): Controller = js.native
  ...
  def apply(range: RangeTypeProperties, mark: MarkJSON): Controller = js.native
  ...
  def apply(range: RangeType, mark: MarkJSON): Controller = js.native
