...
trait Plugin[T /* <: Controller */]
  extends typingsSlinky.slate.mod.Plugin[T]
     with PluginOrPlugins[T] {
  var decorateNode: js.UndefOr[js.Function3[/* node */ Node, /* editor */ T, /* next */ js.Function0[_], _]] = js.undefined
  var onBeforeInput: js.UndefOr[EventHook[SyntheticEvent[EventTarget with Element, Event_]]] = js.undefined
  ...
  var onInput: js.UndefOr[EventHook[SyntheticEvent[EventTarget with Element, Event_]]] = js.undefined
  ...
  var onSelect: js.UndefOr[EventHook[SyntheticEvent[Event_, Element]]] = js.undefined
  ...
  var shouldNodeComponentUpdate: js.UndefOr[
    js.Function4[
      ...
      /* editor */ typingsSlinky.slate.mod.Editor, 
      /* next */ js.Function0[_], 
      _
    ]
  ] = js.undefined
...
object Plugin {
  ...
  def apply[T /* <: Controller */](
    ...
    onBeforeInput: (SyntheticEvent[EventTarget with Element, Event_], /* editor */ Editor, /* next */ js.Function0[js.Any]) => js.Any = null,
    ...
    onInput: (SyntheticEvent[EventTarget with Element, Event_], /* editor */ Editor, /* next */ js.Function0[js.Any]) => js.Any = null,
    ...
    onSelect: (SyntheticEvent[Event_, Element], /* editor */ Editor, /* next */ js.Function0[js.Any]) => js.Any = null,
