...
class Group[T /* <: SlickData */] ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var groups: js.Array[typingsSlinky.slickgrid.Slick.Group[T]] = js.native
  /**
  ...
  /***
    ...
    */
  /* CompleteClass */
  override var totals: typingsSlinky.slickgrid.Slick.GroupTotals[T] = js.native
  /***
    * Grouping value.
    * @property value
    * @type {Object}
  ...
  /***
    ...
    */
  /* CompleteClass */
  override def equals(group: typingsSlinky.slickgrid.Slick.Group[T]): Boolean = js.native
}
