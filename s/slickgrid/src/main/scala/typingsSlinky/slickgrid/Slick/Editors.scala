...
object Editors {
  ...
  trait LongText[T /* <: SlickData */] extends Editor[T] {
    ...
    def handleKeyDown(e: org.scalajs.dom.raw.Event): Unit = js.native
  ...
  object LongText {
    ...
    def apply[T /* <: SlickData */](
      ...
      destroy: () => Unit,
      focus: () => Unit,
      handleKeyDown: org.scalajs.dom.raw.Event => Unit,
      hide: () => Unit,
      init: () => Unit,
      isValueChanged: () => Boolean,
      loadValue: T => Unit,
    ...
    implicit class LongTextMutableBuilder[Self <: LongText[_], T /* <: SlickData */] (val x: Self with LongText[T]) extends AnyVal {
      ...
      @scala.inline
      def setHandleKeyDown(value: org.scalajs.dom.raw.Event => Unit): Self = StObject.set(x, "handleKeyDown", js.Any.fromFunction1(value))
