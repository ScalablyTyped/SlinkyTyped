...
object OnHeaderContextMenuEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T]): OnHeaderContextMenuEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnHeaderContextMenuEventArgsOps[Self <: OnHeaderContextMenuEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderContextMenuEventArgs[T]) extends AnyVal {
    @scala.inline
