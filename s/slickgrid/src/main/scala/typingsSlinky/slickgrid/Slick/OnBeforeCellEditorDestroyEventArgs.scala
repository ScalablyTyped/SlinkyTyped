...
object OnBeforeCellEditorDestroyEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](editor: Editor[T], grid: Grid[T]): OnBeforeCellEditorDestroyEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnBeforeCellEditorDestroyEventArgsOps[Self <: OnBeforeCellEditorDestroyEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnBeforeCellEditorDestroyEventArgs[T]) extends AnyVal {
    @scala.inline
