...
object OnBeforeHeaderRowCellDestroyEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T], node: HTMLElement): OnBeforeHeaderRowCellDestroyEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnBeforeHeaderRowCellDestroyEventArgsOps[Self <: OnBeforeHeaderRowCellDestroyEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnBeforeHeaderRowCellDestroyEventArgs[T]) extends AnyVal {
    @scala.inline
