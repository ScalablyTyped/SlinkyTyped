...
object OnDblClickEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](cell: Double, grid: Grid[T], row: Double): OnDblClickEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnDblClickEventArgsOps[Self <: OnDblClickEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnDblClickEventArgs[T]) extends AnyVal {
    @scala.inline
