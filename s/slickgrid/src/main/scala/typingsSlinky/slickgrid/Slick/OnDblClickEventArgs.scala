...
object OnDblClickEventArgs {
  @scala.inline
  def apply[T](cell: Double, grid: Grid[T], row: Double): OnDblClickEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnDblClickEventArgsOps[Self[t] <: OnDblClickEventArgs[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
