...
object ColumnMetadata {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](): ColumnMetadata[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColumnMetadata[T]]
  }
  @scala.inline
  implicit class ColumnMetadataOps[Self <: ColumnMetadata[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with ColumnMetadata[T]) extends AnyVal {
    @scala.inline
