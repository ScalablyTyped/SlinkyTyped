...
object Column {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](): Column[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Column[T]]
  }
  @scala.inline
  implicit class ColumnOps[Self <: Column[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with Column[T]) extends AnyVal {
    @scala.inline
