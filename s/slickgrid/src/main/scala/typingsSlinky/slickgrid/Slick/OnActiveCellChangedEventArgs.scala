...
object OnActiveCellChangedEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](cell: Double, grid: Grid[T], row: Double): OnActiveCellChangedEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnActiveCellChangedEventArgsOps[Self <: OnActiveCellChangedEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnActiveCellChangedEventArgs[T]) extends AnyVal {
    @scala.inline
