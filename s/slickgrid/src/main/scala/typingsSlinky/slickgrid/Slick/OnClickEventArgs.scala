...
object OnClickEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](cell: Double, grid: Grid[T], row: Double): OnClickEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnClickEventArgsOps[Self <: OnClickEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnClickEventArgs[T]) extends AnyVal {
    @scala.inline
