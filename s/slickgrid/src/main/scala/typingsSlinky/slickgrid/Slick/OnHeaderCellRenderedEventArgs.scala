...
object OnHeaderCellRenderedEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T], node: HTMLElement): OnHeaderCellRenderedEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnHeaderCellRenderedEventArgsOps[Self <: OnHeaderCellRenderedEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderCellRenderedEventArgs[T]) extends AnyVal {
    @scala.inline
