...
object OnCommandEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](button: HeaderButton, column: Column[T], command: String, grid: Grid[T]): OnCommandEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnCommandEventArgsOps[Self <: OnCommandEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnCommandEventArgs[T]) extends AnyVal {
    @scala.inline
