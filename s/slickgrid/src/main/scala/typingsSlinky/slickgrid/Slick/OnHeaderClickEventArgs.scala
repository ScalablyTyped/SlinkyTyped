...
object OnHeaderClickEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T]): OnHeaderClickEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnHeaderClickEventArgsOps[Self <: OnHeaderClickEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderClickEventArgs[T]) extends AnyVal {
    @scala.inline
