...
object OnValidationErrorEventArgs {
  ...
  @scala.inline
  implicit class OnValidationErrorEventArgsOps[Self <: OnValidationErrorEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnValidationErrorEventArgs[T]) extends AnyVal {
    @scala.inline
