...
object FormatterFactory {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](getFormatter: Column[T] => Formatter[_]): FormatterFactory[T] = {
    val __obj = js.Dynamic.literal(getFormatter = js.Any.fromFunction1(getFormatter))
    __obj.asInstanceOf[FormatterFactory[T]]
  }
  @scala.inline
  implicit class FormatterFactoryOps[Self <: FormatterFactory[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with FormatterFactory[T]) extends AnyVal {
    @scala.inline
