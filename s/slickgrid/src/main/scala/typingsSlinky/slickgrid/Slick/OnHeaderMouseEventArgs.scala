...
object OnHeaderMouseEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T]): OnHeaderMouseEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnHeaderMouseEventArgsOps[Self <: OnHeaderMouseEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderMouseEventArgs[T]) extends AnyVal {
    @scala.inline
