...
object OnSelectedRowsChangedEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](grid: Grid[T], rows: js.Array[Double]): OnSelectedRowsChangedEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnSelectedRowsChangedEventArgsOps[Self <: OnSelectedRowsChangedEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnSelectedRowsChangedEventArgs[T]) extends AnyVal {
    @scala.inline
