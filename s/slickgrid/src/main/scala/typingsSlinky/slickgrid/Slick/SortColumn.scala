...
object SortColumn {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](sortAsc: Boolean, sortCol: Column[T]): SortColumn[T] = {
  ...
  @scala.inline
  implicit class SortColumnOps[Self <: SortColumn[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with SortColumn[T]) extends AnyVal {
    @scala.inline
