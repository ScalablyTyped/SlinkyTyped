...
object OnAddNewRowEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T], item: T): OnAddNewRowEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnAddNewRowEventArgsOps[Self <: OnAddNewRowEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnAddNewRowEventArgs[T]) extends AnyVal {
    @scala.inline
