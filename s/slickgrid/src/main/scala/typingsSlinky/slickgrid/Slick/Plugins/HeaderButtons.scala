...
object HeaderButtons {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](destroy: () => Unit, init: Grid[T] => Unit, onCommand: Event[OnCommandEventArgs[T]]): HeaderButtons[T] = {
  ...
  @scala.inline
  implicit class HeaderButtonsOps[Self <: HeaderButtons[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with HeaderButtons[T]) extends AnyVal {
    @scala.inline
