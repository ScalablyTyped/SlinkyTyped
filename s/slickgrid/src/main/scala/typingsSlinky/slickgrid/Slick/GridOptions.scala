...
object GridOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](): GridOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridOptions[T]]
  }
  @scala.inline
  implicit class GridOptionsOps[Self <: GridOptions[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with GridOptions[T]) extends AnyVal {
    @scala.inline
