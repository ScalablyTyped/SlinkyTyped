...
object RowSelectionModel {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T, E](
    destroy: () => Unit,
  ...
  @scala.inline
  implicit class RowSelectionModelOps[Self <: RowSelectionModel[_, _], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T, E] (val x: Self with (RowSelectionModel[T, E])) extends AnyVal {
    @scala.inline
