...
object OnCellChangeEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](cell: Double, grid: Grid[T], item: T, row: Double): OnCellChangeEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnCellChangeEventArgsOps[Self <: OnCellChangeEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnCellChangeEventArgs[T]) extends AnyVal {
    @scala.inline
