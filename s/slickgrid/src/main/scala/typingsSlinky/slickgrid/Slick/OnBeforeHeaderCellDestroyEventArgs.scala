...
object OnBeforeHeaderCellDestroyEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T], node: HTMLElement): OnBeforeHeaderCellDestroyEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnBeforeHeaderCellDestroyEventArgsOps[Self <: OnBeforeHeaderCellDestroyEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnBeforeHeaderCellDestroyEventArgs[T]) extends AnyVal {
    @scala.inline
