...
object HeaderButton {
  ...
  implicit class HeaderButtonOps[Self <: HeaderButton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShowOnHover(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showOnHover")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutShowOnHover: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showOnHover")(js.undefined)
        ret
    }
    @scala.inline
