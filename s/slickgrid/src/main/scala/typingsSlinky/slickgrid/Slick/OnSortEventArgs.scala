...
object OnSortEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](grid: Grid[T], multiColumnSort: Boolean, sortAsc: Boolean): OnSortEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnSortEventArgsOps[Self <: OnSortEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnSortEventArgs[T]) extends AnyVal {
    @scala.inline
