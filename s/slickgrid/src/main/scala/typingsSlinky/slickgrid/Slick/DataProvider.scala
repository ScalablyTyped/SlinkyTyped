...
object DataProvider {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](getItem: Double => T, getLength: () => Double): DataProvider[T] = {
  ...
  @scala.inline
  implicit class DataProviderOps[Self <: DataProvider[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with DataProvider[T]) extends AnyVal {
    @scala.inline
