...
object OnCellCssStylesChangedEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](grid: Grid[T], hash: CellCssStylesHash, key: String): OnCellCssStylesChangedEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnCellCssStylesChangedEventArgsOps[Self <: OnCellCssStylesChangedEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnCellCssStylesChangedEventArgs[T]) extends AnyVal {
    @scala.inline
