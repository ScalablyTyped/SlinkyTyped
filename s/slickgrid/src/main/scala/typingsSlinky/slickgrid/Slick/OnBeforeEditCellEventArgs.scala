...
object OnBeforeEditCellEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](cell: Double, column: Column[T], grid: Grid[T], item: T, row: Double): OnBeforeEditCellEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnBeforeEditCellEventArgsOps[Self <: OnBeforeEditCellEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnBeforeEditCellEventArgs[T]) extends AnyVal {
    @scala.inline
