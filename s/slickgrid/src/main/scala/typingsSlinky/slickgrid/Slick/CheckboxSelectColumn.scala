...
object CheckboxSelectColumn {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](destroy: () => Unit, getColumnDefinition: () => ColumnMetadata[T], init: Grid[T] => Unit): CheckboxSelectColumn[T] = {
  ...
  @scala.inline
  implicit class CheckboxSelectColumnOps[Self <: CheckboxSelectColumn[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with CheckboxSelectColumn[T]) extends AnyVal {
    @scala.inline
