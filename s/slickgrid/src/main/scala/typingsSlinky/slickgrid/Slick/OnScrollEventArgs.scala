...
object OnScrollEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](grid: Grid[T], scrollLeft: Double, scrollTop: Double): OnScrollEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnScrollEventArgsOps[Self <: OnScrollEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnScrollEventArgs[T]) extends AnyVal {
    @scala.inline
