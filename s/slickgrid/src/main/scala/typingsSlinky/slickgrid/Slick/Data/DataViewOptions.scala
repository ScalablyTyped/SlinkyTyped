...
object DataViewOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](): DataViewOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DataViewOptions[T]]
  }
  @scala.inline
  implicit class DataViewOptionsOps[Self <: DataViewOptions[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with DataViewOptions[T]) extends AnyVal {
    @scala.inline
