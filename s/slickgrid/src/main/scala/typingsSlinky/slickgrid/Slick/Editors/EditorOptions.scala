...
object EditorOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], container: HTMLElement, grid: Grid[T]): EditorOptions[T] = {
  ...
  @scala.inline
  implicit class EditorOptionsOps[Self <: EditorOptions[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with EditorOptions[T]) extends AnyVal {
    @scala.inline
