...
object OnHeaderRowCellRenderedEventArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T], node: HTMLElement): OnHeaderRowCellRenderedEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnHeaderRowCellRenderedEventArgsOps[Self <: OnHeaderRowCellRenderedEventArgs[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderRowCellRenderedEventArgs[T]) extends AnyVal {
    @scala.inline
