...
object OnHeaderRowCellRenderedEventArgs {
  ...
  @scala.inline
  implicit class OnHeaderRowCellRenderedEventArgsOps[Self <: OnHeaderRowCellRenderedEventArgs[_], T /* <: SlickData */] (val x: Self with OnHeaderRowCellRenderedEventArgs[T]) extends AnyVal {
