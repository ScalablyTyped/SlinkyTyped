...
object SelectionModel {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T, E](destroy: () => Unit, init: Grid[T] => Unit, onSelectedRangesChanged: Event[E]): SelectionModel[T, E] = {
  ...
  @scala.inline
  implicit class SelectionModelOps[Self <: SelectionModel[_, _], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T, E] (val x: Self with (SelectionModel[T, E])) extends AnyVal {
    @scala.inline
