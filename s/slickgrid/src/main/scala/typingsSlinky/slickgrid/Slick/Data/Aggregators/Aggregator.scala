...
object Aggregator {
  @scala.inline
  def apply[/* <: typingsSlinky.slickgrid.Slick.SlickData */ T](accumulate: T => Unit, field: String, init: () => Unit, storeResult: GroupTotals[T] => Unit): Aggregator[T] = {
  ...
  @scala.inline
  implicit class AggregatorOps[Self <: Aggregator[_], /* <: typingsSlinky.slickgrid.Slick.SlickData */ T] (val x: Self with Aggregator[T]) extends AnyVal {
    @scala.inline
