...
- typings.solidityDashParserDashAntlr.solidityDashParserDashAntlrMod.ASTNode because Already inherited */ trait BinaryOperation
  ...
  @JSName("type")
  var type_BinaryOperation: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.BinaryOperation
}
...
object BinaryOperation {
  ...
  def apply(
    ...
    operator: BinOp,
    right: Expression,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.BinaryOperation,
    loc: Location = null,
