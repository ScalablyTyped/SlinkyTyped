...
trait StructDefinition
  ...
  var name: String
  @JSName("type")
  var type_StructDefinition: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.StructDefinition
}
...
object StructDefinition {
  ...
  def apply(
    ...
    name: String,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.StructDefinition,
    loc: Location = null,
