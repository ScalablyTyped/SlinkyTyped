...
- typings.solidityDashParserDashAntlr.solidityDashParserDashAntlrMod.ASTNode because Already inherited */ trait UserDefinedTypeName
  ...
  var namePath: String
  @JSName("type")
  var type_UserDefinedTypeName: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.UserDefinedTypeName
}
...
object UserDefinedTypeName {
  ...
  def apply(
    namePath: String,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.UserDefinedTypeName,
    loc: Location = null,
