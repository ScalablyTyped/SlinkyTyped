...
trait ModifierInvocation
  ...
  var name: String
  @JSName("type")
  var type_ModifierInvocation: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.ModifierInvocation
}
...
object ModifierInvocation {
  ...
  def apply(
    name: String,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.ModifierInvocation,
