...
trait ImportDirective
  ...
  @JSName("type")
  var type_ImportDirective: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.ImportDirective
...
object ImportDirective {
  ...
  def apply(
    ...
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.ImportDirective,
    unitAlias: String,
    loc: Location = null,
