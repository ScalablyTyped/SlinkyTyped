...
trait UsingForDeclaration
  ...
  @JSName("type")
  var type_UsingForDeclaration: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.UsingForDeclaration
}
...
object UsingForDeclaration {
  ...
  def apply(
    libraryName: String,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.UsingForDeclaration,
    typeName: TypeName,
    loc: Location = null,
