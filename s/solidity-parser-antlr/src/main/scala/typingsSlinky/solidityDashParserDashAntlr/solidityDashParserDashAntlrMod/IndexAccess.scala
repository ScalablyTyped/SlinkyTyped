...
- typings.solidityDashParserDashAntlr.solidityDashParserDashAntlrMod.ASTNode because Already inherited */ trait IndexAccess
  ...
  @JSName("type")
  var type_IndexAccess: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.IndexAccess
}
...
object IndexAccess {
  ...
  def apply(
    base: Expression,
    index: Expression,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.IndexAccess,
    loc: Location = null,
