...
trait InheritanceSpecifier
  ...
  @JSName("type")
  var type_InheritanceSpecifier: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.InheritanceSpecifier
}
...
object InheritanceSpecifier {
  ...
  def apply(
    ...
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.InheritanceSpecifier,
    loc: Location = null,
