...
trait VariableDeclaration
  ...
  @JSName("type")
  var type_VariableDeclaration: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.VariableDeclaration
...
object VariableDeclaration {
  ...
  def apply(
    ...
    isStateVar: Boolean,
    name: String,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.VariableDeclaration,
    typeName: TypeName,
