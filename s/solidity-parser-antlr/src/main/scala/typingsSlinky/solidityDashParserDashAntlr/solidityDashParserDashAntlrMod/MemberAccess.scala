...
trait MemberAccess
  ...
  @JSName("type")
  var type_MemberAccess: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.MemberAccess
}
...
object MemberAccess {
  ...
  def apply(
    ...
    memberName: String,
    `type`: typingsSlinky.solidityDashParserDashAntlr.solidityDashParserDashAntlrStrings.MemberAccess,
    loc: Location = null,
