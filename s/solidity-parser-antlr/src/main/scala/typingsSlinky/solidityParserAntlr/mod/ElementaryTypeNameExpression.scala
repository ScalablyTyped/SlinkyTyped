...
object ElementaryTypeNameExpression {
  ...
  implicit class ElementaryTypeNameExpressionOps[Self <: ElementaryTypeNameExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.ElementaryTypeNameExpression): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
