...
object AssemblyFunctionReturns {
  ...
  implicit class AssemblyFunctionReturnsMutableBuilder[Self <: AssemblyFunctionReturns] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyFunctionReturns): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
