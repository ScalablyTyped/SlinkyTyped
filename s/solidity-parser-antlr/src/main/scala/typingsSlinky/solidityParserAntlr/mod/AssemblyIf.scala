...
object AssemblyIf {
  ...
  @scala.inline
  implicit class AssemblyIfOps[Self <: AssemblyIf] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyIf): Self = this.set("type", value.asInstanceOf[js.Any])
  }
