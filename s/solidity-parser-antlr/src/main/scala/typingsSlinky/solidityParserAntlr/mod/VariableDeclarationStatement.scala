...
- typingsSlinky.solidityParserAntlr.mod.Statement because Already inherited */ trait VariableDeclarationStatement
  extends SimpleStatement
     with BaseASTNode
     with ASTNode {
  var initialValue: js.UndefOr[Expression] = js.undefined
  @JSName("type")
  var type_VariableDeclarationStatement: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.VariableDeclarationStatement
