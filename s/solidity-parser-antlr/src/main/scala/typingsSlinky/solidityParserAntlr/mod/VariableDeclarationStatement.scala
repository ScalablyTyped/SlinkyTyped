...
object VariableDeclarationStatement {
  ...
  implicit class VariableDeclarationStatementOps[Self <: VariableDeclarationStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.VariableDeclarationStatement): Self = this.set("type", value.asInstanceOf[js.Any])
