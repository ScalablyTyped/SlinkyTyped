...
object VariableDeclarationStatement {
  ...
  implicit class VariableDeclarationStatementMutableBuilder[Self <: VariableDeclarationStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.VariableDeclarationStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
