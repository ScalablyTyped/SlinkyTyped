...
trait IndexAccess
  ...
  @JSName("type")
  var type_IndexAccess: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.IndexAccess = js.native
}
object IndexAccess {
  ...
  implicit class IndexAccessMutableBuilder[Self <: IndexAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.IndexAccess): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
