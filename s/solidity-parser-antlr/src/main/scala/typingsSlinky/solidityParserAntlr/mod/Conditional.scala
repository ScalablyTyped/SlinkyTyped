...
- typingsSlinky.solidityParserAntlr.mod.ASTNode because Already inherited */ trait Conditional
  extends Expression
     with BaseASTNode {
  var falseExpression: ASTNode
  var trueExpression: ASTNode
  @JSName("type")
  var type_Conditional: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.Conditional
}
