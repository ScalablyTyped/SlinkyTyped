...
- typingsSlinky.solidityParserAntlr.mod.ASTNode because Already inherited */ trait AssemblyAssignment
  extends AssemblyItem
     with BaseASTNode {
  var expression: AssemblyExpression
  var names: js.Array[Identifier]
  @JSName("type")
  var type_AssemblyAssignment: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyAssignment
}
