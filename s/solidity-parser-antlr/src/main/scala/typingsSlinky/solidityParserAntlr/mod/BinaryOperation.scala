...
trait BinaryOperation
  ...
  @JSName("type")
  var type_BinaryOperation: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.BinaryOperation = js.native
}
object BinaryOperation {
  ...
  implicit class BinaryOperationMutableBuilder[Self <: BinaryOperation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.BinaryOperation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
