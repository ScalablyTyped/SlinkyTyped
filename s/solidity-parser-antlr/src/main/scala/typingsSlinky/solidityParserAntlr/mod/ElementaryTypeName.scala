...
trait ElementaryTypeName
  ...
  @JSName("type")
  var type_ElementaryTypeName: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.ElementaryTypeName = js.native
}
object ElementaryTypeName {
  ...
  implicit class ElementaryTypeNameMutableBuilder[Self <: ElementaryTypeName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.ElementaryTypeName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
