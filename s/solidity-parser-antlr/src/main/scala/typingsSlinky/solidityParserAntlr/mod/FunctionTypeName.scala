...
- typingsSlinky.solidityParserAntlr.mod.ASTNode because Already inherited */ trait FunctionTypeName
  extends TypeName
     with BaseASTNode {
  ...
  @JSName("type")
  var type_FunctionTypeName: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.FunctionTypeName
