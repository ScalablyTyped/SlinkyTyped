...
object AssemblyFunctionDefinition {
  ...
  @scala.inline
  implicit class AssemblyFunctionDefinitionOps[Self <: AssemblyFunctionDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyFunctionDefinition): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
