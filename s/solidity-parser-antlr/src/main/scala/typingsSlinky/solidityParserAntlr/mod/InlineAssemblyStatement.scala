...
object InlineAssemblyStatement {
  ...
  implicit class InlineAssemblyStatementMutableBuilder[Self <: InlineAssemblyStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.InlineAssemblyStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
