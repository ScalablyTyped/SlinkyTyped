...
object AssemblyCall {
  ...
  implicit class AssemblyCallOps[Self <: AssemblyCall] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withArguments(value: js.Array[AssemblyExpression]): Self = {
    ...
    @scala.inline
    def withType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyCall): Self = {
        val ret = this.duplicate
