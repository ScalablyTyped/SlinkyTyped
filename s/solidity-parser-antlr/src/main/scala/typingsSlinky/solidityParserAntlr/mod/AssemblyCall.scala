...
- typingsSlinky.solidityParserAntlr.mod.ASTNode because Already inherited */ trait AssemblyCall
  extends AssemblyExpression
     with BaseASTNode {
  var arguments: js.Array[AssemblyExpression]
  var functionName: String
  @JSName("type")
  var type_AssemblyCall: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyCall
}
