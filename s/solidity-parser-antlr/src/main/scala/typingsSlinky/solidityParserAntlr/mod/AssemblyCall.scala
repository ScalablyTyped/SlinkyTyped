...
trait AssemblyCall
  ...
  @JSName("type")
  var type_AssemblyCall: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyCall = js.native
}
object AssemblyCall {
  ...
  implicit class AssemblyCallMutableBuilder[Self <: AssemblyCall] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.AssemblyCall): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
