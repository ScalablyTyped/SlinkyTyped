...
object InheritanceSpecifier {
  ...
  implicit class InheritanceSpecifierMutableBuilder[Self <: InheritanceSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.solidityParserAntlr.solidityParserAntlrStrings.InheritanceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
