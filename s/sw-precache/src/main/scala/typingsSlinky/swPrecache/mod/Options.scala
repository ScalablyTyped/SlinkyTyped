...
trait Options extends js.Object {
  ...
  var runtimeCaching: js.UndefOr[js.Array[typingsSlinky.swPrecache.anon.Handler]] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    runtimeCaching: js.Array[typingsSlinky.swPrecache.anon.Handler] = null,
