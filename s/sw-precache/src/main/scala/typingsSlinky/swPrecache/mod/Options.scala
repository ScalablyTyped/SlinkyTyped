...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNavigateFallbackWhitelistVarargs(value: js.RegExp*): Self = this.set("navigateFallbackWhitelist", js.Array(value :_*))
    
    @scala.inline
    def setNavigateFallbackWhitelist(value: js.Array[js.RegExp]): Self = this.set("navigateFallbackWhitelist", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRuntimeCachingVarargs(value: typingsSlinky.swPrecache.anon.Handler*): Self = this.set("runtimeCaching", js.Array(value :_*))
    
    @scala.inline
    def setRuntimeCaching(value: js.Array[typingsSlinky.swPrecache.anon.Handler]): Self = this.set("runtimeCaching", value.asInstanceOf[js.Any])
