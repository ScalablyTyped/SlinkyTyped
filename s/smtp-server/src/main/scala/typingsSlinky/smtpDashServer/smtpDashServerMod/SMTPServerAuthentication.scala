...
import typingsSlinky.smtpDashServer.smtpDashServerStrings.LOGIN
import typingsSlinky.smtpDashServer.smtpDashServerStrings.PLAIN
import typingsSlinky.smtpDashServer.smtpDashServerStrings.XOAUTH2
