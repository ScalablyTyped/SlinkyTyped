...
object SMTPServerOptions {
  ...
  def apply(
    ...
    onClose: (/* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Unit = null,
    onConnect: (/* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Unit = null,
    onData: (/* stream */ SMTPServerDataStream, /* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Unit = null,
    ...
    pskCallback: (/* socket */ TLSSocket, /* identity */ String) => scala.scalajs.js.typedarray.DataView | TypedArray | Null = null,
