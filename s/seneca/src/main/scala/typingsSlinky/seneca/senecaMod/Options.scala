...
import typingsSlinky.seneca.Anon_Act
import typingsSlinky.seneca.Anon_Actcaller
import typingsSlinky.seneca.Anon_Active
import typingsSlinky.seneca.Anon_Actrouter
import typingsSlinky.seneca.Anon_Add
import typingsSlinky.seneca.Anon_Basic
import typingsSlinky.seneca.Anon_Host
import typingsSlinky.seneca.Anon_Interval
import typingsSlinky.seneca.Anon_IntervalRunning
import typingsSlinky.seneca.Anon_Level
import typingsSlinky.seneca.Anon_Local
...
object Options {
  ...
  def apply(
    ...
    errhandler: /* error */ js.Error => Unit = null,
