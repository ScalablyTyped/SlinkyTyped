...
trait AnonActcaller extends js.Object {
  ...
  var print: js.UndefOr[AnonOptions] = js.native
...
object AnonActcaller {
  @scala.inline
  def apply(): AnonActcaller = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonActcaller]
  }
  @scala.inline
  implicit class AnonActcallerOps[Self <: AnonActcaller] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPrint(value: AnonOptions): Self = {
        val ret = this.duplicate
