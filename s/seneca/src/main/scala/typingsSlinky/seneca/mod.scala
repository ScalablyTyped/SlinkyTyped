...
object mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.seneca.senecaStrings.quiet
    - typingsSlinky.seneca.senecaStrings.silent
    - typingsSlinky.seneca.senecaStrings.any
    - typingsSlinky.seneca.senecaStrings.all
    - typingsSlinky.seneca.senecaStrings.print
    - typingsSlinky.seneca.senecaStrings.standard
    - typingsSlinky.seneca.senecaStrings.test
  */
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrhandler(value: /* error */ js.Error => Unit): Self = StObject.set(x, "errhandler", js.Any.fromFunction1(value))
