...
object ChangeableSeatingChartConfig {
  ...
  implicit class ChangeableSeatingChartConfigOps[Self <: ChangeableSeatingChartConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxSelectedObjectsVarargs(value: typingsSlinky.seatsio.anon.Category*): Self = this.set("maxSelectedObjects", js.Array(value :_*))
    
    @scala.inline
    def setMaxSelectedObjects(value: Double | js.Array[typingsSlinky.seatsio.anon.Category]): Self = this.set("maxSelectedObjects", value.asInstanceOf[js.Any])
