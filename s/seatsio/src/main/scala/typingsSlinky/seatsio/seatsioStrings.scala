...
import typingsSlinky.seatsio.Seatsio.ColorScheme
import typingsSlinky.seatsio.Seatsio.StylePreset
import typingsSlinky.seatsio.Seatsio.Violations
...
object seatsioStrings {
  ...
  @js.native
  sealed trait Lato extends StObject
  @scala.inline
  def Lato: Lato = "Lato".asInstanceOf[Lato]
  ...
  @js.native
  sealed trait NotoSansHK extends StObject
  @scala.inline
  def NotoSansHK: NotoSansHK = "NotoSansHK".asInstanceOf[NotoSansHK]
  
  @js.native
  sealed trait Roboto extends StObject
  @scala.inline
  def Roboto: Roboto = "Roboto".asInstanceOf[Roboto]
  
  @js.native
  sealed trait WorkSans extends StObject
  @scala.inline
  def WorkSans: WorkSans = "WorkSans".asInstanceOf[WorkSans]
  
  @js.native
  sealed trait asymmetrical extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait fillEnabled extends StObject
  @scala.inline
  def fillEnabled: fillEnabled = "fillEnabled".asInstanceOf[fillEnabled]
  
  @js.native
  sealed trait fillHighlightedOption extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait lenient extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait manageChannels extends StObject
  @scala.inline
  def manageChannels: manageChannels = "manageChannels".asInstanceOf[manageChannels]
  
  @js.native
  sealed trait manageForSaleConfig extends StObject
  @scala.inline
  def manageForSaleConfig: manageForSaleConfig = "manageForSaleConfig".asInstanceOf[manageForSaleConfig]
  
  @js.native
  sealed trait manageObjectStatuses extends StObject
  @scala.inline
  def manageObjectStatuses: manageObjectStatuses = "manageObjectStatuses".asInstanceOf[manageObjectStatuses]
  
  @js.native
  sealed trait manageRulesets extends StObject
  @scala.inline
  def manageRulesets: manageRulesets = "manageRulesets".asInstanceOf[manageRulesets]
  
  @js.native
  sealed trait manageTableBooking extends StObject
  @scala.inline
  def manageTableBooking: manageTableBooking = "manageTableBooking".asInstanceOf[manageTableBooking]
  ...
  @js.native
  sealed trait minMax extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait spacious extends StObject
  @scala.inline
  def spacious: spacious = "spacious".asInstanceOf[spacious]
  ...
  @js.native
  sealed trait widthAndHeight extends StObject
  @scala.inline
  def widthAndHeight: widthAndHeight = "widthAndHeight".asInstanceOf[widthAndHeight]
}
