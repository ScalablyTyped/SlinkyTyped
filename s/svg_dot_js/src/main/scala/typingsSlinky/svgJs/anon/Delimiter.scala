...
trait Delimiter extends js.Object {
  var delimiter: js.RegExp
  var dots: js.RegExp
  var hex: js.RegExp
  var hyphen: js.RegExp
  var isBlank: js.RegExp
  var isCss: js.RegExp
  var isHex: js.RegExp
  var isImage: js.RegExp
  var isNumber: js.RegExp
  var isPathLetter: js.RegExp
  var isPercent: js.RegExp
  var isRgb: js.RegExp
  var numberAndUnit: js.RegExp
  var pathLetters: js.RegExp
  var reference: js.RegExp
  var rgb: js.RegExp
  var transforms: js.RegExp
  var whitespace: js.RegExp
}
