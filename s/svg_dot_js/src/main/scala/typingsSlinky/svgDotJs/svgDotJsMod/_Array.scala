...
@js.native
trait _Array
  extends Instantiable0[_Array]
     with Instantiable1[/* array */ ArrayAlias, _Array]
     with Instantiable2[/* array */ ArrayAlias, /* fallback */ js.Array[Double], _Array] {
  var value: js.Array[Double] = js.native
  def at(pos: NumberAlias): _Array = js.native
