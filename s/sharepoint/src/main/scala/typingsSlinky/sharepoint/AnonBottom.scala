...
object AnonBottom {
  @scala.inline
  def apply(bottom: Double, fight: Double, left: Double, top: Double): AnonBottom = {
  ...
  implicit class AnonBottomOps[Self <: AnonBottom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFight(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fight")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
