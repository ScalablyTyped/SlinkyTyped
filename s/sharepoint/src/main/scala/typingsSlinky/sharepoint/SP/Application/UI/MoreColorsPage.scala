...
object MoreColorsPage {
  ...
  implicit class MoreColorsPageOps[Self <: MoreColorsPage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_moreColorsPicker(value: () => MoreColorsPicker): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_moreColorsPicker")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSet_moreColorsPicker(value: MoreColorsPicker => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_moreColorsPicker")(js.Any.fromFunction1(value))
        ret
    }
  }
