...
object ListDataValidationFailure {
  ...
  implicit class ListDataValidationFailureOps[Self <: ListDataValidationFailure] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_reason(value: () => ListDataValidationFailureReason): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_reason")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_validationType(value: () => ListDataValidationType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_validationType")(js.Any.fromFunction0(value))
        ret
    }
  }
