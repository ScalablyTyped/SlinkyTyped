...
object SiteHealthResult {
  ...
  implicit class SiteHealthResultOps[Self <: SiteHealthResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGet_timeStamp(value: () => js.Date): Self = this.set("get_timeStamp", js.Any.fromFunction0(value))
    @scala.inline
    def setSet_status(value: SiteHealthStatusType => Unit): Self = this.set("set_status", js.Any.fromFunction1(value))
    @scala.inline
    def setSet_timeStamp(value: js.Date => Unit): Self = this.set("set_timeStamp", js.Any.fromFunction1(value))
  }
