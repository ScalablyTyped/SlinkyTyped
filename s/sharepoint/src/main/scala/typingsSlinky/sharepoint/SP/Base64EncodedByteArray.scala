...
object Base64EncodedByteArray {
  ...
  implicit class Base64EncodedByteArrayOps[Self <: Base64EncodedByteArray] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAppend(value: js.Any => Unit): Self = {
    ...
    @scala.inline
    def withSetByteAt(value: (Double, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setByteAt")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
