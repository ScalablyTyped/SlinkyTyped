...
object UpgradeInfo {
  ...
  implicit class UpgradeInfoOps[Self <: UpgradeInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGet_lastUpdated(value: () => js.Date): Self = this.set("get_lastUpdated", js.Any.fromFunction0(value))
    @scala.inline
    def setGet_logFile(value: () => String): Self = this.set("get_logFile", js.Any.fromFunction0(value))
    @scala.inline
    def setGet_requestDate(value: () => js.Date): Self = this.set("get_requestDate", js.Any.fromFunction0(value))
    @scala.inline
    def setGet_retryCount(value: () => Double): Self = this.set("get_retryCount", js.Any.fromFunction0(value))
    @scala.inline
    def setGet_startTime(value: () => js.Date): Self = this.set("get_startTime", js.Any.fromFunction0(value))
    @scala.inline
