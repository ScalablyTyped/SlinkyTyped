...
object MoreColorsPicker {
  ...
  implicit class MoreColorsPickerOps[Self <: MoreColorsPicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_colorValue(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_colorValue")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSet_colorValue(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_colorValue")(js.Any.fromFunction1(value))
        ret
    }
  }
