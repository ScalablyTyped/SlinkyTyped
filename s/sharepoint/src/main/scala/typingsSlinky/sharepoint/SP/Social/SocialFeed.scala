...
object SocialFeed {
  ...
  implicit class SocialFeedOps[Self <: SocialFeed] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_attributes(value: () => SocialFeedAttributes): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_attributes")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_newestProcessed(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_newestProcessed")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_oldestProcessed(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_oldestProcessed")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_threads(value: () => js.Array[SocialThread]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_threads")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_unreadMentionCount(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_unreadMentionCount")(js.Any.fromFunction0(value))
        ret
    }
  }
