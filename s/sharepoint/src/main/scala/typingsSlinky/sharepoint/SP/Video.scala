...
import typingsSlinky.sharepoint.SP.Video.EmbedCodeConfiguration
...
object Video extends js.Object {
  ...
  @js.native
  class VideoSet ()
    extends typingsSlinky.sharepoint.SP.DocumentSet.DocumentSet
  ...
  object VideoSet extends js.Object {
    ...
    def migrateVideo[T](context: ClientContext, videoFile: File): typingsSlinky.sharepoint.SP.ListItem[T] = js.native
    def uploadVideo(
