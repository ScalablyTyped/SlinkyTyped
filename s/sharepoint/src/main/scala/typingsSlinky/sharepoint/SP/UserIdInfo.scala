...
object UserIdInfo {
  ...
  implicit class UserIdInfoOps[Self <: UserIdInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_nameId(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_nameId")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_nameIdIssuer(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_nameIdIssuer")(js.Any.fromFunction0(value))
        ret
    }
  }
