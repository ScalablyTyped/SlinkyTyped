...
object ListDataValidationExceptionValue {
  ...
  implicit class ListDataValidationExceptionValueOps[Self <: ListDataValidationExceptionValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_fieldFailures(value: () => js.Array[ListDataValidationFailure]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_fieldFailures")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_itemFailure(value: () => ListDataValidationFailure): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_itemFailure")(js.Any.fromFunction0(value))
        ret
    }
  }
