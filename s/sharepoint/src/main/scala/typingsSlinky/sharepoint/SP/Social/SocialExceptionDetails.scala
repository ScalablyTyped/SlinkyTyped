...
object SocialExceptionDetails {
  ...
  implicit class SocialExceptionDetailsOps[Self <: SocialExceptionDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_internalErrorCode(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_internalErrorCode")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_internalMessage(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_internalMessage")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_internalStackTrace(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_internalStackTrace")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_internalTypeName(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_internalTypeName")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
