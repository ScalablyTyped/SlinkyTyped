...
import typingsSlinky.sharepoint.SP.WebParts.WebPart
import typingsSlinky.sharepoint.SP.WebParts.WebPartDefinition
import typingsSlinky.sharepoint.SP.WebParts.WebPartDefinitionCollection
