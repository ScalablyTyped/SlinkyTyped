...
object AttractModeControl {
  ...
  implicit class AttractModeControlOps[Self <: AttractModeControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCssAttractMode(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cssAttractMode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCssAttractModeBackground(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cssAttractModeBackground")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCssAttractModeCell(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cssAttractModeCell")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCssAttractModeIcon(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cssAttractModeIcon")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCssAttractModeText(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cssAttractModeText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCssAttractModeWrapper(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cssAttractModeWrapper")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDefaultAttractModeIcon(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defaultAttractModeIcon")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGet_imageElement(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_imageElement")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_textElement(value: () => HTMLElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_textElement")(js.Any.fromFunction0(value))
        ret
    }
  }
