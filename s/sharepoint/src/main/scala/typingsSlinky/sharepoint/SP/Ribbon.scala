...
object Ribbon {
  ...
  object PageManager {
    ...
    implicit class PageManagerMutableBuilder[Self <: PageManager] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGet_ribbon(value: () => typingsSlinky.sharepoint.SP.Ribbon.Ribbon): Self = StObject.set(x, "get_ribbon", js.Any.fromFunction0(value))
  ...
  object Ribbon {
    ...
    def apply(
    ...
    ): typingsSlinky.sharepoint.SP.Ribbon.Ribbon = {
      ...
      __obj.asInstanceOf[typingsSlinky.sharepoint.SP.Ribbon.Ribbon]
    }
  }
