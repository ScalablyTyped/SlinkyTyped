...
class List[T] () extends SecurableObject {
  ...
  def addItem(parameters: ListItemCreationInformation): typingsSlinky.sharepoint.SP.ListItem[T] = js.native
  /** Deletes the list. */
  def deleteObject(): Unit = js.native
  /** Returns the collection of changes from the change log that have occurred within the list, based on the specified query. */
  def getChanges(query: ChangeQuery): ChangeCollection = js.native
  /** Gets item by id. */
  def getItemById(id: Double): typingsSlinky.sharepoint.SP.ListItem[T] = js.native
