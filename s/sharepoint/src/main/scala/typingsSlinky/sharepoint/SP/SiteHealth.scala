...
object SiteHealth {
  ...
  object SiteHealthResult {
    ...
    implicit class SiteHealthResultMutableBuilder[Self <: SiteHealthResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGet_timeStamp(value: () => js.Date): Self = StObject.set(x, "get_timeStamp", js.Any.fromFunction0(value))
      
      @scala.inline
      def setSet_status(value: SiteHealthStatusType => Unit): Self = StObject.set(x, "set_status", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSet_timeStamp(value: js.Date => Unit): Self = StObject.set(x, "set_timeStamp", js.Any.fromFunction1(value))
    }
  }
