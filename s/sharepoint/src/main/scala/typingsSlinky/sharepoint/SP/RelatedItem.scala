...
object RelatedItem {
  ...
  implicit class RelatedItemOps[Self <: RelatedItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSet_webId(value: String => Unit): Self = {
        val ret = this.duplicate
