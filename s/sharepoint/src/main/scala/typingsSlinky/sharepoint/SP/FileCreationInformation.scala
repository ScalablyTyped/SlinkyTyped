...
object FileCreationInformation {
  ...
  implicit class FileCreationInformationOps[Self <: FileCreationInformation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_overwrite(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_overwrite")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSet_overwrite(value: Boolean => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_overwrite")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
