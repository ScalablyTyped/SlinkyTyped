...
object AttachmentCreationInformation {
  ...
  implicit class AttachmentCreationInformationOps[Self <: AttachmentCreationInformation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_contentStream(value: () => Base64EncodedByteArray): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_contentStream")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_fileName(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_fileName")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSet_contentStream(value: Base64EncodedByteArray => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_contentStream")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSet_fileName(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_fileName")(js.Any.fromFunction1(value))
        ret
    }
  }
