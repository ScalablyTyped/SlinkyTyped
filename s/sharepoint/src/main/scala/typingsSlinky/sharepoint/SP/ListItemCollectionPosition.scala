...
object ListItemCollectionPosition {
  ...
  implicit class ListItemCollectionPositionOps[Self <: ListItemCollectionPosition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_pagingInfo(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_pagingInfo")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSet_pagingInfo(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_pagingInfo")(js.Any.fromFunction1(value))
        ret
    }
  }
