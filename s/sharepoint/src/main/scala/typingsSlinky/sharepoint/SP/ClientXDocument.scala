...
object ClientXDocument {
  ...
  implicit class ClientXDocumentOps[Self <: ClientXDocument] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_root(value: () => XElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_root")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSet_root(value: XElement => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_root")(js.Any.fromFunction1(value))
        ret
    }
  }
