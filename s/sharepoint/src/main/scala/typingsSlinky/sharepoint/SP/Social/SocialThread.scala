...
object SocialThread {
  ...
  implicit class SocialThreadOps[Self <: SocialThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_actors(value: () => js.Array[SocialActor]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_actors")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_attributes(value: () => SocialThreadAttributes): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGet_ownerIndex(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_ownerIndex")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_permalink(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_permalink")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_postReference(value: () => SocialPostReference): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_postReference")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_replies(value: () => js.Array[SocialPost]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_replies")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_rootPost(value: () => SocialPost): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_rootPost")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGet_threadType(value: () => SocialThreadType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_threadType")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_totalReplyCount(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_totalReplyCount")(js.Any.fromFunction0(value))
        ret
    }
  }
