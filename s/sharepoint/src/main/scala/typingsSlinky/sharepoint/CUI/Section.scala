...
object Section {
  ...
  implicit class SectionOps[Self <: Section] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetRow(value: Double => Row): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRow")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGet_alignment(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_alignment")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_type(value: () => Double): Self = {
        val ret = this.duplicate
