...
object Ribbon {
  ...
  implicit class RibbonOps[Self <: Ribbon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddChildAtIndex(value: (js.Any, Double) => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addChildAtIndex")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withAddContextualGroup(value: (String, String, js.Any, String) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addContextualGroup")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withGet_contextualGroupIds(value: () => js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_contextualGroupIds")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withHideContextualGroup(value: String => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hideContextualGroup")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRefresh(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("refresh")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRemoveContextualGroup(value: String => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeContextualGroup")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetFocus(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setFocus")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetFocusOnCurrentTab(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setFocusOnCurrentTab")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetFocusOnRibbon(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setFocusOnRibbon")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withShowContextualGroup(value: String => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showContextualGroup")(js.Any.fromFunction1(value))
        ret
    }
  }
