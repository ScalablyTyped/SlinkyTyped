...
object Tab {
  ...
  implicit class TabOps[Self <: Tab] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_contextual(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_contextual")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_contextualGroupId(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_contextualGroupId")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_currentScalingIndex(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_currentScalingIndex")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_scaling(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_scaling")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_selected(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_selected")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withScaleDown(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleDown")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withScaleMax(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleMax")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withScaleUp(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleUp")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSet_selected(value: Boolean => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_selected")(js.Any.fromFunction1(value))
        ret
    }
  }
