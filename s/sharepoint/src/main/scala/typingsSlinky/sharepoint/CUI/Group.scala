...
object Group {
  ...
  implicit class GroupOps[Self <: Group] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSelectLayout(value: (String, String) => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectLayout")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withUnselectLayout(value: () => scala.Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unselectLayout")(js.Any.fromFunction0(value))
        ret
    }
  }
