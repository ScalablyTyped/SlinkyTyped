...
object RibbonComponent {
  ...
  @scala.inline
  implicit class RibbonComponentOps[Self <: RibbonComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGet_ribbon(value: () => Ribbon): Self = this.set("get_ribbon", js.Any.fromFunction0(value))
  }
}
