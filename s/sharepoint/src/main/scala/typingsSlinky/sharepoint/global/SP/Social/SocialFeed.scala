...
class SocialFeed ()
  ...
  /* CompleteClass */
  override def get_attributes(): typingsSlinky.sharepoint.SP.Social.SocialFeedAttributes = js.native
  ...
  /* CompleteClass */
  override def get_threads(): js.Array[typingsSlinky.sharepoint.SP.Social.SocialThread] = js.native
  /* CompleteClass */
