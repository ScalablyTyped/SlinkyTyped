...
class SocialThread ()
  ...
  /* CompleteClass */
  override def get_actors(): js.Array[typingsSlinky.sharepoint.SP.Social.SocialActor] = js.native
  ...
  /* CompleteClass */
  override def get_attributes(): typingsSlinky.sharepoint.SP.Social.SocialThreadAttributes = js.native
  ...
  /* CompleteClass */
  override def get_postReference(): typingsSlinky.sharepoint.SP.Social.SocialPostReference = js.native
  ...
  /* CompleteClass */
  override def get_replies(): js.Array[typingsSlinky.sharepoint.SP.Social.SocialPost] = js.native
  /* CompleteClass */
  override def get_rootPost(): typingsSlinky.sharepoint.SP.Social.SocialPost = js.native
  ...
  /* CompleteClass */
  override def get_threadType(): typingsSlinky.sharepoint.SP.Social.SocialThreadType = js.native
  /* CompleteClass */
