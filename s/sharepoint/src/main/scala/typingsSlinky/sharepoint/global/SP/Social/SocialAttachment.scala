...
class SocialAttachment ()
  ...
  /* CompleteClass */
  override def get_attachmentKind(): typingsSlinky.sharepoint.SP.Social.SocialAttachmentKind = js.native
  ...
  /* CompleteClass */
  override def get_clickAction(): typingsSlinky.sharepoint.SP.Social.SocialAttachmentAction = js.native
  ...
  /** Specifies the type of object that the attachment contains. */
  /* CompleteClass */
  override def set_attachmentKind(value: typingsSlinky.sharepoint.SP.Social.SocialAttachmentKind): typingsSlinky.sharepoint.SP.Social.SocialAttachmentKind = js.native
  /** Specifies the action to take when the user selects the attachment.
    This property is only present if the AttachmentKind is Video. */
  /* CompleteClass */
  override def set_clickAction(value: typingsSlinky.sharepoint.SP.Social.SocialAttachmentAction): typingsSlinky.sharepoint.SP.Social.SocialAttachmentAction = js.native
  /** Specifies the URI of the attachment content. */
  /* CompleteClass */
