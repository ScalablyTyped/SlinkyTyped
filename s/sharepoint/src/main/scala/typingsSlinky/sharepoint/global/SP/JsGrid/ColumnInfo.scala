...
class ColumnInfo protected ()
  extends typingsSlinky.sharepoint.SP.JsGrid.ColumnInfo {
  ...
  /* CompleteClass */
  override def fnGetCellEditMode(record: IRecord, fieldKey: String): typingsSlinky.sharepoint.SP.JsGrid.EditMode = js.native
