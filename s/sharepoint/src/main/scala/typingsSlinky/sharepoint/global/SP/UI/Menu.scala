...
@js.native
class Menu ()
  extends typingsSlinky.sharepoint.SP.UI.Menu {
  /* CompleteClass */
  ...
  override def addSubMenu(
    ...
    description: String,
    id: String
  ): typingsSlinky.sharepoint.SP.UI.Menu = js.native
  /* CompleteClass */
...
object Menu extends js.Object {
  def create(id: String): typingsSlinky.sharepoint.SP.UI.Menu = js.native
}
