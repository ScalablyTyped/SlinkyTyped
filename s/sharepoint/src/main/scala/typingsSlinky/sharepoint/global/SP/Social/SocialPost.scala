...
class SocialPost ()
  ...
  /* CompleteClass */
  override def get_attributes(): typingsSlinky.sharepoint.SP.Social.SocialPostAttributes = js.native
  ...
  /* CompleteClass */
  override def get_likerInfo(): typingsSlinky.sharepoint.SP.Social.SocialPostActorInfo = js.native
  ...
  /* CompleteClass */
  override def get_overlays(): js.Array[typingsSlinky.sharepoint.SP.Social.SocialDataOverlay] = js.native
  /** Specifies whether a post is the root post or a reply post in a thread */
  /* CompleteClass */
  override def get_postType(): typingsSlinky.sharepoint.SP.Social.SocialPostType = js.native
