...
@js.native
class Callout ()
  extends typingsSlinky.sharepoint.Callout {
  /** Adds a link to the actions panel in the bottom part of the callout window */
  /* CompleteClass */
  override def addAction(action: typingsSlinky.sharepoint.CalloutAction): Unit = js.native
  ...
  /* CompleteClass */
  override def getActionMenu(): typingsSlinky.sharepoint.CalloutActionMenu = js.native
  ...
  /* CompleteClass */
  override def getOpenOptions(): typingsSlinky.sharepoint.CalloutOpenOptions = js.native
  ...
  /* CompleteClass */
  override def set(options: typingsSlinky.sharepoint.CalloutOptions): js.Any = js.native
