...
class SocialDataItem ()
  ...
  /* CompleteClass */
  override def get_itemType(): typingsSlinky.sharepoint.SP.Social.SocialDataItemType = js.native
  /** Identifies the tag.  */
  /* CompleteClass */
  ...
  /** Specifies whether the item being inserted is a user, document, site, tag, or link. */
  /* CompleteClass */
  override def set_itemType(value: typingsSlinky.sharepoint.SP.Social.SocialDataItemType): typingsSlinky.sharepoint.SP.Social.SocialDataItemType = js.native
  /** Identifies the tag.  */
  /* CompleteClass */
