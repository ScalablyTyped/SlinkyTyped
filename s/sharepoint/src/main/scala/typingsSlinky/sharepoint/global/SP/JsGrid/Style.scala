...
object Style {
  ...
  object Type {
    ...
    @js.native
    def Cell: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.Cell = js.native
    @scala.inline
    ...
    @js.native
    def GridPane: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.GridPane = js.native
    @scala.inline
    ...
    @js.native
    def Header: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.Header = js.native
    @scala.inline
    ...
    @js.native
    def RowHeaderStyle: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.RowHeaderStyle = js.native
    @scala.inline
    ...
    @js.native
    def Splitter: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.Splitter = js.native
    
    @JSGlobal("SP.JsGrid.Style.Type.SplitterHandle")
    @js.native
    def SplitterHandle: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.SplitterHandle = js.native
    @scala.inline
    ...
    @js.native
    def TimescaleTier: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.TimescaleTier = js.native
    @scala.inline
    ...
    @js.native
    def Widget: typingsSlinky.sharepoint.SP.JsGrid.IStyleType.Widget = js.native
    @scala.inline
