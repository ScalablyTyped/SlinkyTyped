...
class Refinement protected ()
  ...
  /* CompleteClass */
  override def getRefinementControl(refinerName: String): typingsSlinky.sharepoint.Srch.RefinementControl = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def get_selectedRefinementControls(): js.Array[typingsSlinky.sharepoint.Srch.RefinementControl] = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def set_selectedRefinementControls(value: js.Array[typingsSlinky.sharepoint.Srch.RefinementControl]): js.Array[typingsSlinky.sharepoint.Srch.RefinementControl] = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def updateRefinementControls(newControls: js.Array[typingsSlinky.sharepoint.Srch.RefinementControl]): Unit = js.native
  /* CompleteClass */
