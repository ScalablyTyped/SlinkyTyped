...
class SocialPostDefinitionDataItem ()
  ...
  /* CompleteClass */
  override def get_itemType(): typingsSlinky.sharepoint.SP.Social.SocialPostDefinitionDataItemType = js.native
  ...
  /** Specifies whether the item being formatted is a text element, a user, a document, a site, a tag, or a link. */
  /* CompleteClass */
  override def set_itemType(value: typingsSlinky.sharepoint.SP.Social.SocialPostDefinitionDataItemType): typingsSlinky.sharepoint.SP.Social.SocialPostDefinitionDataItemType = js.native
  /** Specifies the post definition token to be replaced by the item */
  /* CompleteClass */
