...
class JsGridControl protected ()
  extends typingsSlinky.sharepoint.SP.JsGrid.JsGridControl {
...
object JsGridControl extends js.Object {
  ...
  class GanttParameters ()
    extends typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.GanttParameters {
    /* CompleteClass */
    override var columns: typingsSlinky.sharepoint.SP.JsGrid.ColumnInfoCollection = js.native
  }
  
  @js.native
  class Parameters ()
    extends typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.Parameters {
    /* CompleteClass */
    ...
    /* CompleteClass */
    override var commandMgr: typingsSlinky.sharepoint.SP.JsGrid.CommandManager = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    override var tableCache: typingsSlinky.sharepoint.SP.JsGrid.TableCache = js.native
    /* CompleteClass */
    override var tableViewParams: typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.TableViewParameters = js.native
  }
  
  @js.native
  class PivotedGridParameters ()
    extends typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.PivotedGridParameters
  
  @js.native
  class RowViewParameters ()
    extends typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.RowViewParameters {
    /* CompleteClass */
    ...
    /* CompleteClass */
    override var hierarchyMode: typingsSlinky.sharepoint.SP.JsGrid.HierarchyMode = js.native
    /* CompleteClass */
  ...
  class TableViewParameters ()
    extends typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.TableViewParameters {
    /* CompleteClass */
    override var allowedSelectionTypes: typingsSlinky.sharepoint.SP.JsGrid.SelectionTypeFlags = js.native
    /* CompleteClass */
    ...
    override var columns: typingsSlinky.sharepoint.SP.JsGrid.ColumnInfoCollection = js.native
    /* CompleteClass */
    override var defaultEditMode: typingsSlinky.sharepoint.SP.JsGrid.EditMode = js.native
     // TODO
    /* CompleteClass */
    override var ganttParams: typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.GanttParameters = js.native
    /* CompleteClass */
    override var gridFieldMap: StringDictionary[typingsSlinky.sharepoint.SP.JsGrid.GridField] = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    override var paneLayout: typingsSlinky.sharepoint.SP.JsGrid.PaneLayout = js.native
    /* CompleteClass */
    override var pivotedGridParams: typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.PivotedGridParameters = js.native
    /* CompleteClass */
    override var rowViewParams: typingsSlinky.sharepoint.SP.JsGrid.JsGridControl.RowViewParameters = js.native
  }
