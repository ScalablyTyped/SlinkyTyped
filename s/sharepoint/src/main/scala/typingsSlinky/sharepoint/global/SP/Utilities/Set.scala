...
class Set ()
  ...
  /* CompleteClass */
  override def AddArray(array: js.Array[_]): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
  /** Clears all the items from set */
  /* CompleteClass */
  override def Clear(): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
  /** Returns a copy of this set */
  /* CompleteClass */
  override def Clone(): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
  ...
  /* CompleteClass */
  override def Difference(otherSet: typingsSlinky.sharepoint.SP.Utilities.Set): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
  ...
  /* CompleteClass */
  override def Intersection(otherSet: typingsSlinky.sharepoint.SP.Utilities.Set): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
  ...
  /* CompleteClass */
  override def SymmetricDifference(otherSet: typingsSlinky.sharepoint.SP.Utilities.Set): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
  ...
  /* CompleteClass */
  override def Union(otherSet: typingsSlinky.sharepoint.SP.Utilities.Set): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
  /** Adds all items from otherSet to this set, and returns this set */
  /* CompleteClass */
  override def UnionWith(otherSet: typingsSlinky.sharepoint.SP.Utilities.Set): typingsSlinky.sharepoint.SP.Utilities.Set = js.native
}
