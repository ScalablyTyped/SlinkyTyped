...
object Utility extends js.Object {
  ...
  def formatDateTime(
    ...
    web: Web,
    datetime: js.Date,
    format: typingsSlinky.sharepoint.SP.Utilities.DateTimeFormat
  ...
  def resolvePrincipal(
    ...
    web: Web,
    input: String,
    scopes: typingsSlinky.sharepoint.SP.Utilities.PrincipalType,
    sources: typingsSlinky.sharepoint.SP.Utilities.PrincipalSource,
