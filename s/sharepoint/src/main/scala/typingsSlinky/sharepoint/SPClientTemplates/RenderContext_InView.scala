...
object RenderContext_InView {
  ...
  def apply(
    ...
    RenderBody: RenderContext_InView => String = null,
    RenderFieldByName: (RenderContext_InView, /* fieldName */ String) => String = null,
    RenderFields: RenderContext_InView => String = null,
    RenderFooter: RenderContext_InView => String = null,
    RenderGroups: RenderContext_InView => String = null,
    RenderHeader: RenderContext_InView => String = null,
    RenderItems: RenderContext_InView => String = null,
    RenderView: RenderContext_InView => String = null,
