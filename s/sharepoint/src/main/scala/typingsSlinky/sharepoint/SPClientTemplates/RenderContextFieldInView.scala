...
object RenderContextFieldInView {
  ...
  implicit class RenderContextFieldInViewOps[Self <: RenderContextFieldInView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCurrentFieldSchema(value: FieldSchemaInForm | FieldSchemaInView): Self = {
    ...
    @scala.inline
    def withFieldControlsModes(value: StringDictionary[ClientControlMode]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FieldControlsModes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
