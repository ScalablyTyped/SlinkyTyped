...
object FieldSchemaInFormMultiChoice {
  ...
  implicit class FieldSchemaInFormMultiChoiceOps[Self <: FieldSchemaInFormMultiChoice] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFillInChoice(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FillInChoice")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMultiChoices(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MultiChoices")(value.asInstanceOf[js.Any])
        ret
    }
  }
