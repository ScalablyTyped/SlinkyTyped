...
object RenderContextGroupInView {
  ...
  def apply(
    ...
    RenderBody: RenderContextGroupInView => String = null,
    RenderFieldByName: (RenderContextGroupInView, /* fieldName */ String) => String = null,
    RenderFields: RenderContextGroupInView => String = null,
    RenderFooter: RenderContextGroupInView => String = null,
    RenderGroups: RenderContextGroupInView => String = null,
    RenderHeader: RenderContextGroupInView => String = null,
    RenderItems: RenderContextGroupInView => String = null,
    RenderView: RenderContextGroupInView => String = null,
