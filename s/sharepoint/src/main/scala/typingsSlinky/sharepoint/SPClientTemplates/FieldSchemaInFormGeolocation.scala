...
object FieldSchemaInFormGeolocation {
  ...
  @scala.inline
  implicit class FieldSchemaInFormGeolocationOps[Self <: FieldSchemaInFormGeolocation] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBingMapsKey(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BingMapsKey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsBingMapBlockedInCurrentRegion(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsBingMapBlockedInCurrentRegion")(value.asInstanceOf[js.Any])
        ret
    }
  }
