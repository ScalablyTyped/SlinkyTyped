...
object FieldSchemaInFormGeolocation {
  ...
  implicit class FieldSchemaInFormGeolocationOps[Self <: FieldSchemaInFormGeolocation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBingMapsKey(value: String): Self = this.set("BingMapsKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsBingMapBlockedInCurrentRegion(value: Boolean): Self = this.set("IsBingMapBlockedInCurrentRegion", value.asInstanceOf[js.Any])
  }
}
