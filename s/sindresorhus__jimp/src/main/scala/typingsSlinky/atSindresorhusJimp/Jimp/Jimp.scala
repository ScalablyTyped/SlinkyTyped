package typingsSlinky.atSindresorhusJimp.Jimp

import typingsSlinky.atSindresorhusJimp.Anon_B
...
class Jimp protected () extends js.Object {
  ...
  def blit(src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def blit(src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double): this.type = js.native
  def blit(src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double, srcy: Double): this.type = js.native
  def blit(
    src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp,
    x: Double,
    y: Double,
    srcx: Double,
    srcy: Double,
  ...
  def clone(cb: ImageCallback): typingsSlinky.atSindresorhusJimp.Jimp.Jimp = js.native
  ...
  def composite(src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def composite(src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
  ...
  def displace(map: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, offset: Double): this.type = js.native
  def displace(map: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, offset: Double, cb: ImageCallback): this.type = js.native
  ...
  def mask(src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def mask(src: typingsSlinky.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
