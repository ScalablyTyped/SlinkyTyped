package typingsSlinky.sindresorhusJimp.Jimp

import typingsSlinky.node.Buffer
import typingsSlinky.sindresorhusJimp.AnonB
...
class Jimp protected () extends js.Object {
  ...
  def this(image: typingsSlinky.sindresorhusJimp.Jimp.Jimp) = this()
  def this(path: String) = this()
  def this(data: Buffer, cb: ImageCallback) = this()
  def this(image: typingsSlinky.sindresorhusJimp.Jimp.Jimp, cb: ImageCallback) = this()
  ...
  def blit(src: typingsSlinky.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def blit(src: typingsSlinky.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double): this.type = js.native
  def blit(src: typingsSlinky.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double, srcy: Double): this.type = js.native
  def blit(
    src: typingsSlinky.sindresorhusJimp.Jimp.Jimp,
    x: Double,
    y: Double,
    srcx: Double,
    srcy: Double,
  ...
  def clone(cb: ImageCallback): typingsSlinky.sindresorhusJimp.Jimp.Jimp = js.native
  ...
  def composite(src: typingsSlinky.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def composite(src: typingsSlinky.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
  ...
  def displace(map: typingsSlinky.sindresorhusJimp.Jimp.Jimp, offset: Double): this.type = js.native
  def displace(map: typingsSlinky.sindresorhusJimp.Jimp.Jimp, offset: Double, cb: ImageCallback): this.type = js.native
  ...
  def getBase64(mime: String, cb: js.Function2[/* err */ js.Error, /* src */ String, _]): this.type = js.native
  def getBuffer(mime: String, cb: js.Function2[/* err */ js.Error, /* buffer */ Buffer, _]): this.type = js.native
  def getExtension(): String = js.native
  def getMIME(): String = js.native
  def getPixelColor(x: Double, y: Double): Double = js.native
  def getPixelColor(x: Double, y: Double, cb: js.Function2[/* err */ js.Error, /* hex */ Double, _]): Double = js.native
  def getPixelIndex(x: Double, y: Double): Double = js.native
  def getPixelIndex(x: Double, y: Double, cb: js.Function2[/* err */ js.Error, /* i */ Double, _]): Double = js.native
  ...
  def hash(base: Double, cb: js.Function2[/* err */ js.Error, /* hash */ String, _]): String = js.native
  def histogram(): AnonB = js.native
  def inspect(): String = js.native
  def invert(): this.type = js.native
  def invert(cb: ImageCallback): this.type = js.native
  def mask(src: typingsSlinky.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def mask(src: typingsSlinky.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
...
object Jimp extends js.Object {
  ...
  def diff(img1: typingsSlinky.sindresorhusJimp.Jimp.Jimp, img2: typingsSlinky.sindresorhusJimp.Jimp.Jimp): AnonDiff = js.native
  def diff(
    img1: typingsSlinky.sindresorhusJimp.Jimp.Jimp,
    img2: typingsSlinky.sindresorhusJimp.Jimp.Jimp,
    threshold: Double
  ): AnonDiff = js.native
  def distance(img1: typingsSlinky.sindresorhusJimp.Jimp.Jimp, img2: typingsSlinky.sindresorhusJimp.Jimp.Jimp): Double = js.native
  ...
  /* These are constructors, have already moved up, TODO: remove it in the future
    ...
    */
  def read(src: String): js.Promise[typingsSlinky.sindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: String, cb: ImageCallback): js.Promise[typingsSlinky.sindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: Buffer): js.Promise[typingsSlinky.sindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: Buffer, cb: ImageCallback): js.Promise[typingsSlinky.sindresorhusJimp.Jimp.Jimp] = js.native
  ...
  def rgbaToInt(
    ...
    b: Double,
    a: Double,
    cb: js.Function2[/* err */ js.Error, /* i */ Double, _]
  ): Double = js.native
}
