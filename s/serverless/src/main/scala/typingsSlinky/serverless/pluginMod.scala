...
import typingsSlinky.serverless.anon.IsDisabledAtPrepopulation
import typingsSlinky.serverless.mod.Options
import typingsSlinky.serverless.mod.^
...
object pluginMod {
  ...
  type Commands = StringDictionary[typingsSlinky.serverless.anon.Commands]
