...
import typingsSlinky.serverless.serverlessStrings.`private`
import typingsSlinky.serverless.serverlessStrings.aws
import typingsSlinky.serverless.serverlessStrings.edge
import typingsSlinky.serverless.serverlessStrings.regional
