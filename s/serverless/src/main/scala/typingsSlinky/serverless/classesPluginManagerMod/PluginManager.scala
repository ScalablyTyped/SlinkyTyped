package typingsSlinky.serverless.classesPluginManagerMod

import typingsSlinky.serverless.classesPluginMod.Plugin
import typingsSlinky.serverless.classesPluginMod.PluginStatic
import typingsSlinky.serverless.serverlessMod.Options
...
trait PluginManager extends js.Object {
  ...
  var serverless: typingsSlinky.serverless.serverlessMod.^ = js.native
