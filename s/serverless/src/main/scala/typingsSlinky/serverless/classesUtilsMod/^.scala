package typingsSlinky.serverless.classesUtilsMod
...
class ^ protected () extends Utils {
  def this(serverless: typingsSlinky.serverless.serverlessMod.^) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def logStat(serverless: typingsSlinky.serverless.serverlessMod.^, context: String): js.Thenable[js.Object] = js.native
  /* CompleteClass */
