...
trait Utils extends js.Object {
  ...
  def logStat(serverless: typingsSlinky.serverless.serverlessMod.^, context: String): js.Thenable[js.Object]
...
object Utils {
  ...
  def apply(
    ...
    getVersion: () => String,
    logStat: (typingsSlinky.serverless.serverlessMod.^, String) => js.Thenable[js.Object],
