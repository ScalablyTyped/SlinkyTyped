package typingsSlinky.serverless.classesServiceMod

import typingsSlinky.serverless.Anon_CompiledCloudFormationTemplate
import typingsSlinky.serverless.serverlessMod.Event
import typingsSlinky.serverless.serverlessMod.FunctionDefinition
