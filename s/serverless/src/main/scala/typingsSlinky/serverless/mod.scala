...
object mod {
  ...
  object Serverless {
    ...
    implicit class ServerlessMutableBuilder[Self <: Serverless] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetProvider(value: String => typingsSlinky.serverless.awsProviderMod.^): Self = StObject.set(x, "getProvider", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setPluginManager(value: typingsSlinky.serverless.pluginManagerMod.^): Self = StObject.set(x, "pluginManager", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setService(value: typingsSlinky.serverless.serviceMod.^): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSetProvider(value: (String, typingsSlinky.serverless.awsProviderMod.^) => Null): Self = StObject.set(x, "setProvider", js.Any.fromFunction2(value))
      
      @scala.inline
      def setUtils(value: typingsSlinky.serverless.utilsMod.^): Self = StObject.set(x, "utils", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setYamlParser(value: typingsSlinky.serverless.yamlParserMod.^): Self = StObject.set(x, "yamlParser", value.asInstanceOf[js.Any])
    }
  }
}
