...
object mod {
  ...
  @JSImport("scrypt", "params")
  @js.native
  def params(maxtime: Double, cb: js.Function2[/* err */ js.Error | Null, /* obj */ Params_, Unit]): Unit = js.native
  @JSImport("scrypt", "params")
  @js.native
  ...
  @JSImport("scrypt", "verifyKdf")
  @js.native
  def verifyKdf(kdf: Buffer, key: String, cb: js.Function2[/* err */ js.Error | Null, /* obj */ Boolean, Unit]): Unit = js.native
  @JSImport("scrypt", "verifyKdf")
  @js.native
  def verifyKdf(kdf: Buffer, key: Buffer): js.Promise[Boolean] = js.native
  @JSImport("scrypt", "verifyKdf")
  @js.native
  def verifyKdf(kdf: Buffer, key: Buffer, cb: js.Function2[/* err */ js.Error | Null, /* obj */ Boolean, Unit]): Unit = js.native
