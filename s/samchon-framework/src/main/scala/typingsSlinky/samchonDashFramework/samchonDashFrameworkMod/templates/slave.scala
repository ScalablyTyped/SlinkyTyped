...
object slave extends js.Object {
  ...
  /**
    ...
    */
  class InvokeHistory ()
    extends typingsSlinky.samchon.samchonMod.templates.slave.InvokeHistory {
    /**
  ...
  class PInvoke protected ()
    extends typingsSlinky.samchon.samchonMod.templates.slave.PInvoke {
    /**
  ...
  abstract class SlaveClient ()
    extends typingsSlinky.samchon.samchonMod.templates.slave.SlaveClient
  ...
  abstract class SlaveServer ()
    extends typingsSlinky.samchon.samchonMod.templates.slave.SlaveServer
  ...
  abstract class SlaveSystem ()
    extends typingsSlinky.samchon.samchonMod.templates.slave.SlaveSystem
