package typingsSlinky.samchonDashFramework.samchonDashFrameworkMod
...
object library extends js.Object {
  ...
  class CartesianProduct protected ()
    extends typingsSlinky.samchon.samchonMod.library.CartesianProduct {
    /**
  ...
  class Factorial protected ()
    extends typingsSlinky.samchon.samchonMod.library.Factorial {
    /**
  ...
  class Permutation protected ()
    extends typingsSlinky.samchon.samchonMod.library.Permutation {
    /**
  ...
  class RepeatedPermutation protected ()
    extends typingsSlinky.samchon.samchonMod.library.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  @js.native
  class StringUtil ()
    extends typingsSlinky.samchon.samchonMod.library.StringUtil
  ...
  /**
    ...
    */
  class URLVariables ()
    extends typingsSlinky.samchon.samchonMod.library.URLVariables {
    /**
  ...
  @js.native
  class XML ()
    extends typingsSlinky.samchon.samchonMod.library.XML {
    def this(str: String) = this()
