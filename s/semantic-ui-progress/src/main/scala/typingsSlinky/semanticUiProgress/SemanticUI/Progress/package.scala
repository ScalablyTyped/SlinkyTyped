...
package object Progress {
  type ClassNameSettings = typingsSlinky.semanticUiProgress.SemanticUI.Progress.ClassNameSettings.Param
  ...
  type RegExpSettings = typingsSlinky.semanticUiProgress.SemanticUI.Progress.RegExpSettings_
