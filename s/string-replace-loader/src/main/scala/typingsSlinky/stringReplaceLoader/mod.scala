...
object mod {
  ...
  */
  ...
  object Options {
    ...
    @scala.inline
    def ReplaceEntries(multiple: js.Array[ReplaceEntry]): typingsSlinky.stringReplaceLoader.mod.ReplaceEntries = {
      val __obj = js.Dynamic.literal(multiple = multiple.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stringReplaceLoader.mod.ReplaceEntries]
    }
    
    @scala.inline
    def ReplaceEntry(replace: String | ReplaceCallback, search: String | js.RegExp): typingsSlinky.stringReplaceLoader.mod.ReplaceEntry = {
      val __obj = js.Dynamic.literal(replace = replace.asInstanceOf[js.Any], search = search.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.stringReplaceLoader.mod.ReplaceEntry]
    }
  }
  ...
  object ReplaceEntry {
    ...
    implicit class ReplaceEntryMutableBuilder[Self <: ReplaceEntry] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSearch(value: String | js.RegExp): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSearchRegExp(value: js.RegExp): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
