...
trait ReplaceEntry extends Options {
  ...
  var search: String | js.RegExp = js.native
...
object ReplaceEntry {
  ...
  @scala.inline
  def apply(replace: String | ReplaceCallback, search: String | js.RegExp): ReplaceEntry = {
  ...
  implicit class ReplaceEntryOps[Self <: ReplaceEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSearchRegExp(value: js.RegExp): Self = this.set("search", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSearch(value: String | js.RegExp): Self = this.set("search", value.asInstanceOf[js.Any])
