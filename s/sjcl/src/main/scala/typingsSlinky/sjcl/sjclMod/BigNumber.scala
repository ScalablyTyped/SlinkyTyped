...
import typingsSlinky.sjcl.sjclMod.TypeHelpers.BigNumberBinaryOperator
import typingsSlinky.sjcl.sjclMod.TypeHelpers.BigNumberTrinaryOperator
...
trait BigNumber extends js.Object {
  ...
  def toBits(len: Double): BitArray = js.native
