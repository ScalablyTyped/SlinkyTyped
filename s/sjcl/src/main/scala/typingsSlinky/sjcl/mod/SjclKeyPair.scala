...
object SjclKeyPair {
  @scala.inline
  def apply[/* <: typingsSlinky.sjcl.mod.SjclECCPublicKey */ P, /* <: typingsSlinky.sjcl.mod.SjclECCSecretKey */ S](pub: P, sec: S): SjclKeyPair[P, S] = {
    val __obj = js.Dynamic.literal(pub = pub.asInstanceOf[js.Any], sec = sec.asInstanceOf[js.Any])
    __obj.asInstanceOf[SjclKeyPair[P, S]]
  }
  @scala.inline
  implicit class SjclKeyPairOps[Self <: SjclKeyPair[_, _], /* <: typingsSlinky.sjcl.mod.SjclECCPublicKey */ P, /* <: typingsSlinky.sjcl.mod.SjclECCSecretKey */ S] (val x: Self with (SjclKeyPair[P, S])) extends AnyVal {
    @scala.inline
