...
object Headline {
  ...
  implicit class HeadlineOps[Self <: Headline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubHeadlineReactElement(value: ReactElement): Self = this.set("subHeadline", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubHeadline(value: String | ReactElement): Self = this.set("subHeadline", value.asInstanceOf[js.Any])
