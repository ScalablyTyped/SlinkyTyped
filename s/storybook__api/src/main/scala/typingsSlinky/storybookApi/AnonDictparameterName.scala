...
trait AnonDictparameterName
  ...
  var options: AnonDictkey = js.native
}

object AnonDictparameterName {
  @scala.inline
  def apply(filename: String, options: AnonDictkey): AnonDictparameterName = {
  ...
  @scala.inline
  implicit class AnonDictparameterNameOps[Self <: AnonDictparameterName] (val x: Self) extends AnyVal {
    @scala.inline
