...
object AnonDocsMode {
  @scala.inline
  def apply(docsMode: Boolean, enableShortcuts: Boolean, sidebarAnimations: Boolean): AnonDocsMode = {
  ...
  @scala.inline
  implicit class AnonDocsModeOps[Self <: AnonDocsMode] (val x: Self) extends AnyVal {
    @scala.inline
