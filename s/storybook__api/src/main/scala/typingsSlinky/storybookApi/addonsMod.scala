...
object addonsMod {
  ...
  object types extends StObject {
    ...
    /* "notes-element" */ val NOTES_ELEMENT: typingsSlinky.storybookApi.addonsMod.types.NOTES_ELEMENT with String = js.native
    
    @js.native
    sealed trait PANEL extends types
    /* "panel" */ val PANEL: typingsSlinky.storybookApi.addonsMod.types.PANEL with String = js.native
    
    @js.native
    sealed trait PREVIEW extends types
    /* "preview" */ val PREVIEW: typingsSlinky.storybookApi.addonsMod.types.PREVIEW with String = js.native
    
    @js.native
    sealed trait TAB extends types
    /* "tab" */ val TAB: typingsSlinky.storybookApi.addonsMod.types.TAB with String = js.native
    
    @js.native
    sealed trait TOOL extends types
    /* "tool" */ val TOOL: typingsSlinky.storybookApi.addonsMod.types.TOOL with String = js.native
  }
