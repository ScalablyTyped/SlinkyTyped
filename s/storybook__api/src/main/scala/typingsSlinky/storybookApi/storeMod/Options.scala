...
import typingsSlinky.storybookApi.storybookApiStrings.none
import typingsSlinky.storybookApi.storybookApiStrings.session
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPersistence(value: none | session | String): Self = {
