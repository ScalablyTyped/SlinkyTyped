...
object Socks5Auth extends js.Object {
  ...
  /* 1 */ val GSSApi: typingsSlinky.socks.typingsCommonConstantsMod.Socks5Auth.GSSApi with Double = js.native
  /* 0 */ val NoAuth: typingsSlinky.socks.typingsCommonConstantsMod.Socks5Auth.NoAuth with Double = js.native
  /* 2 */ val UserPass: typingsSlinky.socks.typingsCommonConstantsMod.Socks5Auth.UserPass with Double = js.native
  @JSBracketAccess
