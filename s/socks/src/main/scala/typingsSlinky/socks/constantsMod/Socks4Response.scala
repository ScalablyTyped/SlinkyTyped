...
object Socks4Response extends StObject {
  ...
  /* 91 */ val Failed: typingsSlinky.socks.constantsMod.Socks4Response.Failed with Double = js.native
  
  @js.native
  sealed trait Granted extends Socks4Response
  /* 90 */ val Granted: typingsSlinky.socks.constantsMod.Socks4Response.Granted with Double = js.native
  
  @js.native
  sealed trait Rejected extends Socks4Response
  /* 92 */ val Rejected: typingsSlinky.socks.constantsMod.Socks4Response.Rejected with Double = js.native
  
  @js.native
  sealed trait RejectedIdent extends Socks4Response
  /* 93 */ val RejectedIdent: typingsSlinky.socks.constantsMod.Socks4Response.RejectedIdent with Double = js.native
}
