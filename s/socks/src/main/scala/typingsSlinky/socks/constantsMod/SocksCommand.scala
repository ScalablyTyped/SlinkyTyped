...
object SocksCommand extends StObject {
  ...
  /* 3 */ val associate: typingsSlinky.socks.constantsMod.SocksCommand.associate with Double = js.native
  
  @js.native
  sealed trait bind extends SocksCommand
  /* 2 */ val bind: typingsSlinky.socks.constantsMod.SocksCommand.bind with Double = js.native
  
  @js.native
  sealed trait connect extends SocksCommand
  /* 1 */ val connect: typingsSlinky.socks.constantsMod.SocksCommand.connect with Double = js.native
}
