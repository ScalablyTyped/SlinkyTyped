...
object Socks5Auth extends StObject {
  ...
  /* 1 */ val GSSApi: typingsSlinky.socks.constantsMod.Socks5Auth.GSSApi with Double = js.native
  
  @js.native
  sealed trait NoAuth extends Socks5Auth
  /* 0 */ val NoAuth: typingsSlinky.socks.constantsMod.Socks5Auth.NoAuth with Double = js.native
  
  @js.native
  sealed trait UserPass extends Socks5Auth
  /* 2 */ val UserPass: typingsSlinky.socks.constantsMod.Socks5Auth.UserPass with Double = js.native
}
