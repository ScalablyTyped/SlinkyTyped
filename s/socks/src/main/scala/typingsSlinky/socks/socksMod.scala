...
import typingsSlinky.socks.typingsCommonConstantsMod.SocksClientEstablishedEvent
import typingsSlinky.socks.typingsCommonConstantsMod.SocksClientOptions
import typingsSlinky.socks.typingsCommonConstantsMod.SocksUDPFrameDetails
...
@js.native
object socksMod extends js.Object {
  @js.native
  class SocksClient protected ()
    extends typingsSlinky.socks.typingsClientSocksclientMod.SocksClient {
