...
object eventlistenersMod {
  ...
  trait On
    ...
    var progress: js.UndefOr[Listener[ProgressEvent] | js.Array[Listener[ProgressEvent]]] = js.native
  ...
  object On {
    ...
    implicit class OnMutableBuilder[Self <: On] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setProgress(value: Listener[ProgressEvent] | js.Array[Listener[ProgressEvent]]): Self = StObject.set(x, "progress", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setProgressUndefined: Self = StObject.set(x, "progress", js.undefined)
      
      @scala.inline
      def setProgressVarargs(value: Listener[ProgressEvent]*): Self = StObject.set(x, "progress", js.Array(value :_*))
