...
object On {
  ...
  implicit class OnOps[Self <: On] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProgressVarargs(value: Listener[ProgressEvent]*): Self = this.set("progress", js.Array(value :_*))
    
    @scala.inline
    def setProgress(value: Listener[ProgressEvent] | js.Array[Listener[ProgressEvent]]): Self = this.set("progress", value.asInstanceOf[js.Any])
