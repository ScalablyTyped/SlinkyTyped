...
import typingsSlinky.searchParams.encodeMod.arrayFormat
import typingsSlinky.searchParams.encodeMod.booleanFormat
import typingsSlinky.searchParams.encodeMod.nullFormat
