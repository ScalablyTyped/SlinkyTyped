...
trait IFinalOptions extends js.Object {
  var arrayFormat: typingsSlinky.searchParams.encodeMod.arrayFormat
  var booleanFormat: typingsSlinky.searchParams.encodeMod.booleanFormat
  var nullFormat: typingsSlinky.searchParams.encodeMod.nullFormat
}
