...
class V1Timecard () extends js.Object {
  /**
    ...
    */
  var clockin_location_id: js.UndefOr[String] = js.native
  /**
  ...
  /**
    ...
    * from another system.
    */
  var clockout_location_id: js.UndefOr[String] = js.native
  /**
  ...
  /**
    ...
    */
  var doubletime_seconds_worked: js.UndefOr[Double] = js.native
  /**
  ...
  /**
    ...
    */
  var overtime_seconds_worked: js.UndefOr[Double] = js.native
  /**
    * The total number of regular (non-overtime) seconds worked in the timecard.
    */
  var regular_seconds_worked: js.UndefOr[Double] = js.native
  /**
