...
import typingsSlinky.squareDashConnect.squareDashConnectStrings.APPROVED
import typingsSlinky.squareDashConnect.squareDashConnectStrings.FAILED
import typingsSlinky.squareDashConnect.squareDashConnectStrings.PENDING
import typingsSlinky.squareDashConnect.squareDashConnectStrings.REJECTED
