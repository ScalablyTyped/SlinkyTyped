...
import typingsSlinky.squareDashConnect.squareDashConnectStrings.TAX_SUBTOTAL_PHASE
import typingsSlinky.squareDashConnect.squareDashConnectStrings.TAX_TOTAL_PHASE
