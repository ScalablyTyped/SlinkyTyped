...
import typingsSlinky.squareConnect.mod.ActivityStatusType
import typingsSlinky.squareConnect.mod.AreaUnitType
import typingsSlinky.squareConnect.mod.CardBrandType
import typingsSlinky.squareConnect.mod.CountryType
import typingsSlinky.squareConnect.mod.CurrencyType
import typingsSlinky.squareConnect.mod.CustomerSourceType
import typingsSlinky.squareConnect.mod.DayOfWeekType
import typingsSlinky.squareConnect.mod.DiscountApplicationScopeType
import typingsSlinky.squareConnect.mod.DiscountType
import typingsSlinky.squareConnect.mod.ErrorCategoryType
import typingsSlinky.squareConnect.mod.ErrorCodeType
import typingsSlinky.squareConnect.mod.FulfillmentStateType
import typingsSlinky.squareConnect.mod.FulfillmentType
import typingsSlinky.squareConnect.mod.InventoryAlertType
import typingsSlinky.squareConnect.mod.InventoryStateType
import typingsSlinky.squareConnect.mod.InventoryType
import typingsSlinky.squareConnect.mod.LengthUnitType
import typingsSlinky.squareConnect.mod.ObjectType
import typingsSlinky.squareConnect.mod.OrderStateType
import typingsSlinky.squareConnect.mod.PricingType
import typingsSlinky.squareConnect.mod.ProductSourceType
import typingsSlinky.squareConnect.mod.SortOrderType
import typingsSlinky.squareConnect.mod.TaxApplicationScopeType
import typingsSlinky.squareConnect.mod.TaxType
import typingsSlinky.squareConnect.mod.VolumeUnitType
import typingsSlinky.squareConnect.mod.WeightUnitType
