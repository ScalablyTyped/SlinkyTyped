...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.squareConnect.squareConnectStrings.ITEM
  - typingsSlinky.squareConnect.squareConnectStrings.IMAGE
  - typingsSlinky.squareConnect.squareConnectStrings.CATEGORY
  - typingsSlinky.squareConnect.squareConnectStrings.ITEM_VARIATION
  - typingsSlinky.squareConnect.squareConnectStrings.TAX
  - typingsSlinky.squareConnect.squareConnectStrings.DISCOUNT
  - typingsSlinky.squareConnect.squareConnectStrings.MODIFIER_LIST
  - typingsSlinky.squareConnect.squareConnectStrings.MODIFIER
*/
