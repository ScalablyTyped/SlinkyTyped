...
import typingsSlinky.squareConnect.squareConnectStrings.APPOINTMENTS
import typingsSlinky.squareConnect.squareConnectStrings.BILLING
import typingsSlinky.squareConnect.squareConnectStrings.EXTERNAL_API
import typingsSlinky.squareConnect.squareConnectStrings.INVOICES
import typingsSlinky.squareConnect.squareConnectStrings.ONLINE_STORE
import typingsSlinky.squareConnect.squareConnectStrings.OTHER
import typingsSlinky.squareConnect.squareConnectStrings.PAYROLL
import typingsSlinky.squareConnect.squareConnectStrings.REGISTER
