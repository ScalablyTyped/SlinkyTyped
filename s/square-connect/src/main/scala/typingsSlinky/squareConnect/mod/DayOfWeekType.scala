...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.squareConnect.squareConnectStrings.SUN
  - typingsSlinky.squareConnect.squareConnectStrings.MON
  - typingsSlinky.squareConnect.squareConnectStrings.TUE
  - typingsSlinky.squareConnect.squareConnectStrings.WED
  - typingsSlinky.squareConnect.squareConnectStrings.THU
