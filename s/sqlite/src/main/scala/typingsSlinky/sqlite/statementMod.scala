...
import typingsSlinky.sqlite.interfacesMod.ISqlite.RunResult
...
object statementMod extends js.Object {
  ...
  @js.native
  class Statement[S /* <: typingsSlinky.sqlite.sqlite3Mod.Statement */] protected () extends js.Object {
    ...
    /**
      ...
      * parameters. This automatically sanitizes inputs.
      */
    def run(params: js.Any*): js.Promise[RunResult[typingsSlinky.sqlite.sqlite3Mod.Statement]] = js.native
