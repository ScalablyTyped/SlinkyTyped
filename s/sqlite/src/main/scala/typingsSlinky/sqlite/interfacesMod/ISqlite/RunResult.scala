...
object RunResult {
  @scala.inline
  def apply[/* <: typingsSlinky.sqlite.sqlite3Mod.Statement */ Stmt](stmt: typingsSlinky.sqlite.statementMod.Statement[Stmt]): RunResult[Stmt] = {
    val __obj = js.Dynamic.literal(stmt = stmt.asInstanceOf[js.Any])
    __obj.asInstanceOf[RunResult[Stmt]]
  }
  @scala.inline
  implicit class RunResultOps[Self <: RunResult[_], /* <: typingsSlinky.sqlite.sqlite3Mod.Statement */ Stmt] (val x: Self with RunResult[Stmt]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStmt(value: typingsSlinky.sqlite.statementMod.Statement[Stmt]): Self = this.set("stmt", value.asInstanceOf[js.Any])
    @scala.inline
