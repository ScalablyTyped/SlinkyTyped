...
object sqlite3Mod {
  ...
  trait sqlite3 extends StObject {
    ...
    var RunResult: typingsSlinky.sqlite.sqlite3Mod.RunResult = js.native
    
    var Statement: Instantiable0[typingsSlinky.sqlite.sqlite3Mod.Statement] = js.native
    
    var cached: typingsSlinky.sqlite.anon.Database = js.native
  ...
  object sqlite3 {
    ...
    def apply(
      ...
      cached: typingsSlinky.sqlite.anon.Database,
      verbose: () => sqlite3
    ): sqlite3 = {
    ...
    implicit class sqlite3MutableBuilder[Self <: sqlite3] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCached(value: typingsSlinky.sqlite.anon.Database): Self = StObject.set(x, "cached", value.asInstanceOf[js.Any])
