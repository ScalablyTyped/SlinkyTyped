...
/**
  ...
  */
class GlideTime ()
  extends typingsSlinky.servicenowLondon.GlideTime {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def subtract(start: typingsSlinky.servicenowLondon.GlideTime, end: typingsSlinky.servicenowLondon.GlideTime): typingsSlinky.servicenowLondon.GlideDuration = js.native
}
