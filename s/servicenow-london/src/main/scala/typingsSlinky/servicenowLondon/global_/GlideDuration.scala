...
/**
  ...
  */
class GlideDuration ()
  extends typingsSlinky.servicenowLondon.GlideDuration {
  /**
    ...
    */
  def this(another: typingsSlinky.servicenowLondon.GlideDuration) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def add(value: typingsSlinky.servicenowLondon.GlideDuration): typingsSlinky.servicenowLondon.GlideDuration = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def subtract(value: typingsSlinky.servicenowLondon.GlideDuration): typingsSlinky.servicenowLondon.GlideDuration = js.native
}
