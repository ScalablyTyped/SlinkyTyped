...
/**
  ...
  */
class GlideDateTime ()
  extends typingsSlinky.servicenowLondon.GlideDateTime {
  /**
    * Instantiates a new GlideDateTime object with the current date and time in Greenwich Mean Time
    * (GMT).
    *
    ...
    */
  def this(g: typingsSlinky.servicenowLondon.GlideDateTime) = this()
  /**
    * Instantiates a new GlideDateTime object with the current date and time in Greenwich Mean Time
    * (GMT).
    *
...
object GlideDateTime extends js.Object {
  ...
  /**
    ...
    */
  def subtract(start: typingsSlinky.servicenowLondon.GlideDateTime): typingsSlinky.servicenowLondon.GlideDuration = js.native
  def subtract(
    start: typingsSlinky.servicenowLondon.GlideDateTime,
    end: typingsSlinky.servicenowLondon.GlideDateTime
  ): typingsSlinky.servicenowLondon.GlideDuration = js.native
}
