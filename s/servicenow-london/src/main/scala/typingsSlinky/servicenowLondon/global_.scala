...
object global_ {
  ...
  class GlideEmailOutbound ()
    extends typingsSlinky.servicenowLondon.GlideEmailOutbound
  ...
  @JSGlobal("email")
  @js.native
  val email: typingsSlinky.servicenowLondon.GlideEmailOutbound = js.native
  ...
  object global {
    ...
    @js.native
    class Workflow ()
      extends typingsSlinky.servicenowLondon.global.Workflow
  }
