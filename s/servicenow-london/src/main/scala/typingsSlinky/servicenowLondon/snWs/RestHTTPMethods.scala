...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.servicenowLondon.servicenowLondonStrings.post
  - typingsSlinky.servicenowLondon.servicenowLondonStrings.delete
  - typingsSlinky.servicenowLondon.servicenowLondonStrings.patch
  - typingsSlinky.servicenowLondon.servicenowLondonStrings.put
  - typingsSlinky.servicenowLondon.servicenowLondonStrings.head
