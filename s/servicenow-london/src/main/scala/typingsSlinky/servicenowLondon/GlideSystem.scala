...
trait GlideSystem extends StObject {
  ...
  def eventQueueScheduled(name: String, instance: ScopedGlideRecord, parm1: String, parm2: String, expiration: js.Object): Unit = js.native
  
  def executeNow(job: ScopedGlideRecord): String = js.native
  ...
  def getEscapedMessage(id: String): String = js.native
  def getEscapedMessage(id: String, `object`: js.Any): String = js.native
  ...
  def getSession(): GlideSession = js.native
  ...
  def hoursAgo(hours: Double): String = js.native
  
  def hoursAgoEnd(hours: Double): String = js.native
  
  def hoursAgoStart(hours: Double): String = js.native
  ...
  def setProperty(key: String, value: String, description: String): Unit = js.native
