...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAsyncVarargs(value: (String | js.RegExp)*): Self = this.set("async", js.Array(value :_*))
    
    @scala.inline
    def setAsyncRegExp(value: js.RegExp): Self = this.set("async", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeferVarargs(value: (String | js.RegExp)*): Self = this.set("defer", js.Array(value :_*))
    
    @scala.inline
    def setDeferRegExp(value: js.RegExp): Self = this.set("defer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInlineVarargs(value: (String | js.RegExp)*): Self = this.set("inline", js.Array(value :_*))
    
    @scala.inline
    def setInlineRegExp(value: js.RegExp): Self = this.set("inline", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModuleVarargs(value: (String | js.RegExp)*): Self = this.set("module", js.Array(value :_*))
    
    @scala.inline
    def setModuleRegExp(value: js.RegExp): Self = this.set("module", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrefetchVarargs(value: (String | js.RegExp)*): Self = this.set("prefetch", js.Array(value :_*))
    
    @scala.inline
    def setPrefetchRegExp(value: js.RegExp): Self = this.set("prefetch", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPreloadVarargs(value: (String | js.RegExp)*): Self = this.set("preload", js.Array(value :_*))
    
    @scala.inline
    def setPreloadRegExp(value: js.RegExp): Self = this.set("preload", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSyncVarargs(value: (String | js.RegExp)*): Self = this.set("sync", js.Array(value :_*))
    
    @scala.inline
    def setSyncRegExp(value: js.RegExp): Self = this.set("sync", value.asInstanceOf[js.Any])
