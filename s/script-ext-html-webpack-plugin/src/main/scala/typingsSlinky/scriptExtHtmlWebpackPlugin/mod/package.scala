...
package object mod {
  ...
  type ScriptMatchingPatternPre = typingsSlinky.scriptExtHtmlWebpackPlugin.mod.ScriptMatchingPatternBase | typingsSlinky.scriptExtHtmlWebpackPlugin.anon.ScriptMatchingPatternHash
}
