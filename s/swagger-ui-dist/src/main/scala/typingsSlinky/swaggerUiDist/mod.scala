...
object mod {
  ...
  @js.native
  val SwaggerUIBundle: typingsSlinky.swaggerUiDist.mod.SwaggerUIBundle = js.native
  ...
  object SwaggerConfigs {
    ...
    implicit class SwaggerConfigsMutableBuilder[Self <: SwaggerConfigs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDomNodeHTMLElement(value: HTMLElement): Self = StObject.set(x, "domNode", value.asInstanceOf[js.Any])
