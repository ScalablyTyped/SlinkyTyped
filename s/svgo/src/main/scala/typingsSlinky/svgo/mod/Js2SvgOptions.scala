...
object Js2SvgOptions {
  ...
  implicit class Js2SvgOptionsOps[Self <: Js2SvgOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRegEntities(value: js.RegExp): Self = this.set("regEntities", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRegEntities: Self = this.set("regEntities", js.undefined)
    
    @scala.inline
    def setRegValEntities(value: js.RegExp): Self = this.set("regValEntities", value.asInstanceOf[js.Any])
