...
object Js2SvgOptions {
  ...
  implicit class Js2SvgOptionsMutableBuilder[Self <: Js2SvgOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRegEntities(value: js.RegExp): Self = StObject.set(x, "regEntities", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRegEntitiesUndefined: Self = StObject.set(x, "regEntities", js.undefined)
    
    @scala.inline
    def setRegValEntities(value: js.RegExp): Self = StObject.set(x, "regValEntities", value.asInstanceOf[js.Any])
