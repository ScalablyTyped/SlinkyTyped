...
object PluginRemoveUnknownsAndDefaults {
  ...
  implicit class PluginRemoveUnknownsAndDefaultsOps[Self <: PluginRemoveUnknownsAndDefaults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRemoveUnknownsAndDefaults(value: Boolean | js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeUnknownsAndDefaults")(value.asInstanceOf[js.Any])
        ret
    }
  }
