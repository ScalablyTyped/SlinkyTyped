...
object PluginRemoveAttributesBySelector {
  ...
  implicit class PluginRemoveAttributesBySelectorOps[Self <: PluginRemoveAttributesBySelector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRemoveAttributesBySelector(value: Boolean | js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeAttributesBySelector")(value.asInstanceOf[js.Any])
        ret
    }
  }
