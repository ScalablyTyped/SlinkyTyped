...
object PluginRemoveNonInheritableGroupAttrs {
  ...
  implicit class PluginRemoveNonInheritableGroupAttrsOps[Self <: PluginRemoveNonInheritableGroupAttrs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRemoveNonInheritableGroupAttrs(value: Boolean | js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeNonInheritableGroupAttrs")(value.asInstanceOf[js.Any])
        ret
    }
  }
