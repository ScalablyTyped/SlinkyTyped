...
trait Js2SvgOptions extends js.Object {
  ...
  /** @default /[&'"<>]/g */
  var regEntities: js.UndefOr[js.RegExp] = js.undefined
  /** @default /[&"<>]/g */
  var regValEntities: js.UndefOr[js.RegExp] = js.undefined
  /** @default '>' */
...
object Js2SvgOptions {
  ...
  def apply(
    ...
    regEntities: js.RegExp = null,
    regValEntities: js.RegExp = null,
