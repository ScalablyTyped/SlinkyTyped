...
import typingsSlinky.stylableOptimizer.mod.StylableOptimizer
import typingsSlinky.stylableWebpackPlugin.anon.AfterTransform
import typingsSlinky.stylableWebpackPlugin.anon.Apply
import typingsSlinky.stylableWebpackPlugin.anon.AutoInit
import typingsSlinky.stylableWebpackPlugin.anon.ClassNameOptimizations
import typingsSlinky.stylableWebpackPlugin.anon.DUPLICATEMODULENAMESPACE
import typingsSlinky.stylableWebpackPlugin.anon.FileDependencies
import typingsSlinky.stylableWebpackPlugin.anon.Module
import typingsSlinky.stylableWebpackPlugin.anon.Request
import typingsSlinky.stylableWebpackPlugin.stylableWebpackPluginStrings.external
import typingsSlinky.stylableWebpackPlugin.stylableWebpackPluginStrings.isolated
...
import typingsSlinky.stylableWebpackPlugin.stylableWebpackPluginStrings.shared
...
object typesMod {
  ...
  {[ P in keyof T ]:? T[P] extends new (): any? T[P] : std.Partial<T[P]>}
    */ typingsSlinky.stylableWebpackPlugin.stylableWebpackPluginStrings.ShallowPartial with TopLevel[js.Any]
