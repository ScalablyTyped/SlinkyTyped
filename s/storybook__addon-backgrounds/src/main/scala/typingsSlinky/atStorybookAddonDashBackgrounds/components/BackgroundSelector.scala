...
object BackgroundSelector
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.atStorybookAddonDashBackgrounds.distContainersBackgroundSelectorMod.BackgroundSelector
    ] {
  ...
  type Props = typingsSlinky.atStorybookAddonDashBackgrounds.distContainersBackgroundSelectorMod.Props
}
