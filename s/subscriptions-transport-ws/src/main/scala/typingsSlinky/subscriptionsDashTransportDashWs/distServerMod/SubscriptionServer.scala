package typingsSlinky.subscriptionsDashTransportDashWs.distServerMod
...
object SubscriptionServer extends js.Object {
  ...
  def create(options: ServerOptions, socketOptionsOrServer: typingsSlinky.ws.wsMod.ServerOptions): SubscriptionServer = js.native
}
