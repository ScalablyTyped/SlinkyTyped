...
import typingsSlinky.stropheJs.AnonAUTH
...
object ^ extends js.Object {
  ...
  var Builder: Instantiable2[
    ...
    typingsSlinky.stropheJs.mod.Strophe.Builder
  ] = js.native
  ...
  var Connection: Instantiable2[
    /* service */ String, 
    js.UndefOr[/* options */ typingsSlinky.stropheJs.mod.Strophe.ConnectionOptions], 
    typingsSlinky.stropheJs.mod.Strophe.Connection
  ] = js.native
