...
import typingsSlinky.sketchapp.sketchappStrings.MSImmutableHotspotLayer
...
object SketchMSImmutableHotspotLayer {
  ...
  implicit class SketchMSImmutableHotspotLayerOps[Self <: SketchMSImmutableHotspotLayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_class(value: MSImmutableHotspotLayer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_class")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFlow(value: SketchMSFlow): Self = {
        val ret = this.duplicate
