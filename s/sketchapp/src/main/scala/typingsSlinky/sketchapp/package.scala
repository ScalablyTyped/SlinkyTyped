...
package object sketchapp {
  type SketchMSFlow = typingsSlinky.sketchapp.SketchMSFlowConnection
  type SketchMSLayerFrame = typingsSlinky.sketchapp.SketchMSRect
  ...
  type SketchMSUserPages = org.scalablytyped.runtime.StringDictionary[typingsSlinky.sketchapp.AnonScrollOrigin]
}
