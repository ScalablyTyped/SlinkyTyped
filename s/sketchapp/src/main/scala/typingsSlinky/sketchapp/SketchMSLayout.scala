...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.sketchapp.SketchMSLayoutGrid
  - typingsSlinky.sketchapp.SketchMSLayoutSimpleGrid
*/
...
object SketchMSLayout {
  ...
  def SketchMSLayoutGrid(
    ...
    __obj.asInstanceOf[typingsSlinky.sketchapp.SketchMSLayoutGrid]
  }
  
  @scala.inline
  def SketchMSLayoutSimpleGrid(_class: simpleGrid, gridSize: Double, isEnabled: Double, thickGridTimes: Double): typingsSlinky.sketchapp.SketchMSLayoutSimpleGrid = {
    ...
    __obj.asInstanceOf[typingsSlinky.sketchapp.SketchMSLayoutSimpleGrid]
  }
}
