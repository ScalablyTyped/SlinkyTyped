...
object SketchMSSymbolMasterLayer {
  ...
  implicit class SketchMSSymbolMasterLayerOps[Self <: SketchMSSymbolMasterLayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_class(value: symbolMaster): Self = {
    ...
    @scala.inline
    def withChangeIdentifier(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIncludeBackgroundColorInInstance(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeBackgroundColorInInstance")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withResizesContent(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resizesContent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
