...
import typingsSlinky.sketchapp.sketchappStrings.text
...
object SketchMSTextLayer {
  ...
  implicit class SketchMSTextLayerOps[Self <: SketchMSTextLayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_class(value: text): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_class")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAttributedString(value: SketchMSAttributedString): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("attributedString")(value.asInstanceOf[js.Any])
        ret
    }
  }
