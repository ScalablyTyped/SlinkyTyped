package typingsSlinky.sequelizeCursorPagination
...
import typingsSlinky.sequelizeCursorPagination.mod.SequelizeCursorPagination.WithPaginationModel
import typingsSlinky.sequelizeCursorPagination.mod.SequelizeCursorPagination.WithPaginationOptions
...
object mod {
  ...
  object SequelizeCursorPagination {
    ...
    type WithPaginationModel[MethodName /* <: String */, Model, ModelInst, ModelAttrs] = Model with typingsSlinky.sequelizeCursorPagination.sequelizeCursorPaginationStrings.WithPaginationModel with TopLevel[js.Any]
