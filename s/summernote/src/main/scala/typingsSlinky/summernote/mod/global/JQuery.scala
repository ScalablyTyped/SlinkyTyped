...
import typingsSlinky.summernote.mod.global.Summernote.CreateLinkOptions
import typingsSlinky.summernote.mod.global.Summernote.EditImageCallback
import typingsSlinky.summernote.mod.global.Summernote.Options
