...
import typingsSlinky.summernote.summernoteStrings.backcolor_
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.summernote.summernoteStrings.bold
  - typingsSlinky.summernote.summernoteStrings.italic
  - typingsSlinky.summernote.summernoteStrings.underline
  - typingsSlinky.summernote.summernoteStrings.strikethrough
  - typingsSlinky.summernote.summernoteStrings.superscript
