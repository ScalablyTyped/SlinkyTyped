...
object global {
  ...
  object View {
    ...
    @js.native
    def builderStack: js.Array[typingsSlinky.spacePen.Builder] = js.native
    @scala.inline
    def builderStack_=(x: js.Array[typingsSlinky.spacePen.Builder]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("builderStack")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def popBuilder(): typingsSlinky.spacePen.Builder = js.native
