...
object mod {
  ...
  class Builder () extends StObject {
    ...
    def subview(outletName: js.Any, subview: typingsSlinky.spacePen.mod.View): Unit = js.native
  ...
  class View protected () extends StObject {
    ...
    def bindEventHandlers(view: typingsSlinky.spacePen.mod.View): Unit = js.native
    ...
    // tag end
    def initialize(view: typingsSlinky.spacePen.mod.View, args: js.Any): Unit = js.native
    
    def preempt(eventName: js.Any, handler: js.Any): js.Any = js.native
    
    def pushStack(elems: js.Any): js.Any = js.native
    
    def wireOutlets(view: typingsSlinky.spacePen.mod.View): Unit = js.native
  }
  object View {
    ...
    @js.native
    def builderStack: js.Array[typingsSlinky.spacePen.mod.Builder] = js.native
    @scala.inline
    def builderStack_=(x: js.Array[typingsSlinky.spacePen.mod.Builder]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("builderStack")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def popBuilder(): typingsSlinky.spacePen.mod.Builder = js.native
