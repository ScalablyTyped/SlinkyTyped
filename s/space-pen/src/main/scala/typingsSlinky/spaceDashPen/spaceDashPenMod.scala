...
object spaceDashPenMod extends js.Object {
  ...
  class Builder () extends js.Object {
    ...
    def subview(outletName: js.Any, subview: typingsSlinky.spaceDashPen.spaceDashPenMod.View): Unit = js.native
  ...
  class View protected () extends js.Object {
    ...
    def bindEventHandlers(view: typingsSlinky.spaceDashPen.spaceDashPenMod.View): Unit = js.native
    ...
    // tag end
    def initialize(view: typingsSlinky.spaceDashPen.spaceDashPenMod.View, args: js.Any): Unit = js.native
    def preempt(eventName: js.Any, handler: js.Any): js.Any = js.native
    def pushStack(elems: js.Any): js.Any = js.native
    def wireOutlets(view: typingsSlinky.spaceDashPen.spaceDashPenMod.View): Unit = js.native
  }
  ...
  object View extends js.Object {
    var builderStack: js.Array[typingsSlinky.spaceDashPen.spaceDashPenMod.Builder] = js.native
    // tag start
    ...
    def popBuilder(): typingsSlinky.spaceDashPen.spaceDashPenMod.Builder = js.native
