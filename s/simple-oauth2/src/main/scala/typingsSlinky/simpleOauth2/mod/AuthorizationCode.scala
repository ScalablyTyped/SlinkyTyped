...
import typingsSlinky.simpleOauth2.anon.Redirecturi
...
class AuthorizationCode[ClientIdName /* <: String */] protected () extends js.Object {
  ...
  def authorizeURL(
    params: typingsSlinky.simpleOauth2.simpleOauth2Strings.AuthorizationCode with TopLevel[js.Any] with Redirecturi
  ): String = js.native
  /**
