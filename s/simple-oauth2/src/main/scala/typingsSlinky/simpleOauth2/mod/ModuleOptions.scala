...
object ModuleOptions {
  @scala.inline
  def apply[/* <: java.lang.String */ ClientIdName](auth: AuthorizeHost, client: Id[ClientIdName]): ModuleOptions[ClientIdName] = {
  ...
  @scala.inline
  implicit class ModuleOptionsOps[Self <: ModuleOptions[_], /* <: java.lang.String */ ClientIdName] (val x: Self with ModuleOptions[ClientIdName]) extends AnyVal {
    @scala.inline
