...
import typingsSlinky.simpleOauth2.simpleOauth2Booleans.`true`
import typingsSlinky.simpleOauth2.simpleOauth2Strings.force
import typingsSlinky.simpleOauth2.simpleOauth2Strings.strict
...
object WreckHttpOptions {
  ...
  implicit class WreckHttpOptionsOps[Self <: WreckHttpOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRedirected(value: (/* statusCode */ Double, /* location */ String, /* req */ js.Any) => Unit): Self = {
        val ret = this.duplicate
