...
@js.native
trait AnonId[ClientIdName /* <: String */] extends js.Object {
...
object AnonId {
  @scala.inline
  def apply[ClientIdName](id: String, secret: String): AnonId[ClientIdName] = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], secret = secret.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonId[ClientIdName]]
  }
  @scala.inline
  implicit class AnonIdOps[Self[clientidname] <: AnonId[clientidname], ClientIdName] (val x: Self[ClientIdName]) extends AnyVal {
    @scala.inline
