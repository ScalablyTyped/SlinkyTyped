...
import typingsSlinky.simpleOauth2.simpleOauth2Strings.body
import typingsSlinky.simpleOauth2.simpleOauth2Strings.form
import typingsSlinky.simpleOauth2.simpleOauth2Strings.header
import typingsSlinky.simpleOauth2.simpleOauth2Strings.json
