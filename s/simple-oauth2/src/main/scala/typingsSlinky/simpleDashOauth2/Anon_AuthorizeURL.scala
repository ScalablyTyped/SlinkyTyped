...
import typingsSlinky.simpleDashOauth2.simpleDashOauth2Mod.AuthorizationTokenConfig
...
trait Anon_AuthorizeURL[ClientIdName /* <: String */] extends js.Object {
  ...
  def authorizeURL(
    params: typingsSlinky.simpleDashOauth2.simpleDashOauth2Strings.Anon_AuthorizeURL with js.Any with Anon_Redirecturi
  ): String = js.native
