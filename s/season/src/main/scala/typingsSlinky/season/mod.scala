...
object mod {
  ...
  @js.native
  def readFile(objectPath: String, callback: js.Function2[/* err */ js.Error | Null, /* object */ js.Any, Unit]): Unit = js.native
  @JSImport("season", "readFile")
  @js.native
  def readFile(
    objectPath: String,
  ...
  @js.native
  def writeFile(objectPath: String, `object`: js.Any, callback: js.Function1[/* err */ js.Error | Null, Unit]): Unit = js.native
