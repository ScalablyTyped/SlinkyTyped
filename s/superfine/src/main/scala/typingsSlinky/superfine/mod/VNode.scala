...
object VNode {
  ...
  @scala.inline
  implicit class VNodeOps[Self <: VNode[_], /* <: / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 * / js.Any */ TTagName] (val x: Self with VNode[TTagName]) extends AnyVal {
    @scala.inline
