...
@js.native
trait HtmlOrSvgElementTagNameMap extends js.Object {
...
object HtmlOrSvgElementTagNameMap {
  ...
  @scala.inline
  implicit class HtmlOrSvgElementTagNameMapOps[Self <: HtmlOrSvgElementTagNameMap] (val x: Self) extends AnyVal {
    @scala.inline
