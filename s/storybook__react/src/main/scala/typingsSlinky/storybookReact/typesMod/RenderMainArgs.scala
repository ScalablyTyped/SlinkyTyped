...
object RenderMainArgs {
  ...
  implicit class RenderMainArgsOps[Self <: RenderMainArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShowException(value: js.Error => Unit): Self = this.set("showException", js.Any.fromFunction1(value))
    @scala.inline
    def setShowMain(value: () => Unit): Self = this.set("showMain", js.Any.fromFunction0(value))
    @scala.inline
    def setStoryFn(value: ReactComponentClass[_]): Self = this.set("storyFn", value.asInstanceOf[js.Any])
  }
