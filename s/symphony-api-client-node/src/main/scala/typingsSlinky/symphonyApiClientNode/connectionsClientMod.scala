...
object connectionsClientMod {
  ...
  trait Connection extends StObject {
    ...
    var status: typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.REJECTED | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.ACCEPTED | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_INCOMING | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_OUTGOING = js.native
  ...
  object Connection {
    ...
    @scala.inline
    def apply(
      status: typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.REJECTED | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.ACCEPTED | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_INCOMING | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_OUTGOING,
      userId: Double
    ): Connection = {
    ...
    implicit class ConnectionMutableBuilder[Self <: Connection] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStatus(
        value: typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.REJECTED | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.ACCEPTED | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_INCOMING | typingsSlinky.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_OUTGOING
