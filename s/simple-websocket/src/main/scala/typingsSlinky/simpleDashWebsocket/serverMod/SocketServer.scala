package typingsSlinky.simpleDashWebsocket.serverMod

import typingsSlinky.node.Buffer
import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.node.httpMod.IncomingMessage
import typingsSlinky.node.netMod.Socket
import typingsSlinky.simpleDashWebsocket.simpleDashWebsocketStrings.connection
import typingsSlinky.simpleDashWebsocket.simpleDashWebsocketStrings.error
import typingsSlinky.simpleDashWebsocket.simpleDashWebsocketStrings.headers
import typingsSlinky.simpleDashWebsocket.simpleDashWebsocketStrings.listening
...
trait SocketServer extends EventEmitter {
  var clients: Set[typingsSlinky.ws.wsMod.^] = js.native
  ...
  def addListener_connection(
    event: connection,
    cb: js.Function1[/* client */ typingsSlinky.simpleDashWebsocket.simpleDashWebsocketMod.^, Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_connection(event: connection, socket: typingsSlinky.simpleDashWebsocket.simpleDashWebsocketMod.^): Boolean = js.native
  @JSName("emit")
  ...
  def handleUpgrade(
    ...
    socket: Socket,
    upgradeHead: Buffer,
    callback: js.Function1[/* client */ typingsSlinky.ws.wsMod.^, Unit]
  ): Unit = js.native
  @JSName("listeners")
  def listeners_connection(event: connection): js.Array[
    js.Function2[
      /* socket */ typingsSlinky.simpleDashWebsocket.simpleDashWebsocketMod.^, 
      /* request */ IncomingMessage, 
      Unit
    ]
  ] = js.native
