...
class SourceMapGenerator () extends StObject {
  ...
  /**
    ...
    */
  def applySourceMap(sourceMapConsumer: typingsSlinky.sourceMap.mod.SourceMapConsumer): Unit = js.native
  def applySourceMap(
    sourceMapConsumer: typingsSlinky.sourceMap.mod.SourceMapConsumer,
    sourceFile: js.UndefOr[scala.Nothing],
    sourceMapPath: String
  ): Unit = js.native
  def applySourceMap(sourceMapConsumer: typingsSlinky.sourceMap.mod.SourceMapConsumer, sourceFile: String): Unit = js.native
  def applySourceMap(
    sourceMapConsumer: typingsSlinky.sourceMap.mod.SourceMapConsumer,
    sourceFile: String,
    sourceMapPath: String
...
object SourceMapGenerator {
  ...
  @js.native
  def fromSourceMap(sourceMapConsumer: typingsSlinky.sourceMap.mod.SourceMapConsumer): SourceMapGenerator = js.native
}
