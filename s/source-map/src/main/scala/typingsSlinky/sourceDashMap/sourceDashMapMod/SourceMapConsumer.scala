package typingsSlinky.sourceDashMap.sourceDashMapMod

import org.scalablytyped.runtime.TopLevel
import typingsSlinky.sourceDashMap.Anon_Bias
...
trait SourceMapConsumer extends js.Object {
  ...
  /**
    ...
    *   - column: The column number in the generated source, or null.
    */
  def generatedPositionFor(originalPosition: MappedPosition with Anon_Bias): NullablePosition = js.native
  /**
  ...
  /**
    ...
    */
  def originalPositionFor(generatedPosition: Position with Anon_Bias): NullableMappedPosition = js.native
  /**
