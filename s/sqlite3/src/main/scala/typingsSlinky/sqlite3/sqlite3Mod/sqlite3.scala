...
import typingsSlinky.sqlite3.Anon_Callback
...
trait sqlite3 extends js.Object {
  var Database: Instantiable2[
    ...
    typingsSlinky.sqlite3.sqlite3Mod.Database
  ]
  ...
  var OPEN_URI: Double
  var RunResult: typingsSlinky.sqlite3.sqlite3Mod.RunResult
  var Statement: Instantiable0[typingsSlinky.sqlite3.sqlite3Mod.Statement]
...
object sqlite3 {
  ...
  def apply(
    ...
    verbose: () => typingsSlinky.sqlite3.sqlite3Mod.sqlite3
  ): sqlite3 = {
