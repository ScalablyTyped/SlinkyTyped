...
object mod {
  ...
  @js.native
  def verbose(): typingsSlinky.sqlite3.mod.sqlite3 = js.native
  ...
  object sqlite3 {
    ...
    def apply(
      ...
      verbose: () => typingsSlinky.sqlite3.mod.sqlite3
    ): typingsSlinky.sqlite3.mod.sqlite3 = {
      ...
      __obj.asInstanceOf[typingsSlinky.sqlite3.mod.sqlite3]
    }
    
    @scala.inline
    implicit class sqlite3MutableBuilder[Self <: typingsSlinky.sqlite3.mod.sqlite3] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setCached(value: typingsSlinky.sqlite3.anon.Database): Self = StObject.set(x, "cached", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVerbose(value: () => typingsSlinky.sqlite3.mod.sqlite3): Self = StObject.set(x, "verbose", js.Any.fromFunction0(value))
    }
  }
}
