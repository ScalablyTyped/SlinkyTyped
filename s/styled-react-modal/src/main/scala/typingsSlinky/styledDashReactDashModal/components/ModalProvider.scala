...
object ModalProvider
  ...
  typingsSlinky.styledDashReactDashModal.styledDashReactDashModalMod.ModalProvider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
