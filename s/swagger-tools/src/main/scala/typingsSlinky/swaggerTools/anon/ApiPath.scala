...
object ApiPath {
  @scala.inline
  def apply[/* <: typingsSlinky.swaggerTools.mod.SwaggerRequestParameters */ P](
    apiPath: String,
    params: P,
    path: js.Any,
    security: js.Array[_],
  ...
  @scala.inline
  implicit class ApiPathOps[Self <: ApiPath[_], /* <: typingsSlinky.swaggerTools.mod.SwaggerRequestParameters */ P] (val x: Self with ApiPath[P]) extends AnyVal {
    @scala.inline
