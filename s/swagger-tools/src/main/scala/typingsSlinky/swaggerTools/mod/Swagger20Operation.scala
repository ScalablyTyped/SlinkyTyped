...
object Swagger20Operation {
  ...
  implicit class Swagger20OperationOps[Self <: Swagger20Operation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResponses(value: StringDictionary[Swagger20Response]): Self = {
    ...
    @scala.inline
    def withParameters(value: js.Array[SwaggerParameterSchema]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSecurity(value: js.Array[Swagger20Security]): Self = {
        val ret = this.duplicate
