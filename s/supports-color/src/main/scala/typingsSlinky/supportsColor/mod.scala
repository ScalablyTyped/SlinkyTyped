package typingsSlinky.supportsColor

import typingsSlinky.supportsColor.mod.supportsColor.SupportsColor
import typingsSlinky.supportsColor.supportsColorBooleans.`false`
