...
object SignatureAlgorithmType {
  ...
  @scala.inline
  def `rsa-sha1`: typingsSlinky.samlp.samlpStrings.`rsa-sha1` = this.cast("rsa-sha1")
  @scala.inline
  def `rsa-sha256`: typingsSlinky.samlp.samlpStrings.`rsa-sha256` = this.cast("rsa-sha256")
}
