...
import typingsSlinky.scrollmagic.mod.EventType
import typingsSlinky.scrollmagic.mod.InfoOption
import typingsSlinky.scrollmagic.mod.SceneState
import typingsSlinky.scrollmagic.mod.ScrollDirection
import typingsSlinky.scrollmagic.mod._TriggerHook
