...
object mod {
  ...
  object ClientOptions {
    ...
    implicit class ClientOptionsMutableBuilder[Self <: ClientOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHydrateNodeListOf(value: NodeListOf[HTMLStyleElement with Node]): Self = StObject.set(x, "hydrate", value.asInstanceOf[js.Any])
  ...
  type hydrateType = HTMLCollectionOf[HTMLStyleElement] | js.Array[HTMLStyleElement] | (NodeListOf[HTMLStyleElement with Node])
}
