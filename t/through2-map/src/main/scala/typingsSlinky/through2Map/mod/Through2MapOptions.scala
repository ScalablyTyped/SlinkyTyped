...
object Through2MapOptions {
  ...
  implicit class Through2MapOptionsOps[Self <: Through2MapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWantStrings(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("wantStrings")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWantStrings: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("wantStrings")(js.undefined)
        ret
    }
  }
