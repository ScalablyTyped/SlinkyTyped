...
object ITabUserOptions {
  ...
  implicit class ITabUserOptionsOps[Self <: ITabUserOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFocusTrapDocument(value: Document): Self = this.set("focusTrap", value.asInstanceOf[js.Any])
    @scala.inline
    def setFocusTrapElement(value: Element): Self = this.set("focusTrap", value.asInstanceOf[js.Any])
    @scala.inline
