...
import typingsSlinky.testingLibraryUserEvent.anon.InitialSelectionEnd
...
object mod {
  ...
  object ITabUserOptions {
    ...
    implicit class ITabUserOptionsMutableBuilder[Self <: ITabUserOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFocusTrapDocument(value: Document): Self = StObject.set(x, "focusTrap", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFocusTrapElement(value: Element): Self = StObject.set(x, "focusTrap", value.asInstanceOf[js.Any])
