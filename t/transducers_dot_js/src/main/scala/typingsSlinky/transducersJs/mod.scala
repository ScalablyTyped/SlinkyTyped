...
object mod {
  ...
  @js.native
  def cat[TResult, TInput](f: Transformer_[TResult, TInput]): Transformer_[TResult, js.Iterable[TInput]] = js.native
  ...
  @js.native
  def into[TInput](to: String, xf: Transducer[TInput, String], from: js.Iterable[TInput]): String = js.native
  @JSImport("transducers.js", "into")
  @js.native
  def into[TInput, TOutput](to: js.Array[TOutput], xf: Transducer[TInput, TOutput], from: js.Iterable[TInput]): js.Array[TOutput] = js.native
  @JSImport("transducers.js", "into")
  @js.native
  ...
  @js.native
  def iterator[T](coll: js.Iterable[T]): IterableIterator[T] = js.native
  ...
  @js.native
  def mapcat[TInput, TOutput](f: js.Function1[/* x */ TInput, js.Iterable[TOutput]]): Transducer[TInput, TOutput] = js.native
  ...
  @js.native
  def reduce[TResult, TInput](coll: js.Iterable[TInput], xf: Transformer_[TResult, TInput], init: TResult): TResult = js.native
  @JSImport("transducers.js", "reduce")
  @js.native
  ...
  @JSImport("transducers.js", "seq")
  @js.native
  def seq[TInput, TOutput](coll: js.Iterable[TInput], xf: Transducer[TInput, TOutput]): IterableIterator[TOutput] = js.native
  @JSImport("transducers.js", "seq")
  @js.native
  ...
  @js.native
  def toArray[TInput, TOutput](coll: js.Iterable[TInput]): js.Array[TOutput] = js.native
  @JSImport("transducers.js", "toArray")
  @js.native
  def toArray[TInput, TOutput](coll: js.Iterable[TInput], xf: Transducer[TInput, TOutput]): js.Array[TOutput] = js.native
  @JSImport("transducers.js", "toArray")
  @js.native
  ...
  @js.native
  def toIter[TInput, TOutput](coll: js.Iterable[TInput]): IterableIterator[TOutput] = js.native
  @JSImport("transducers.js", "toIter")
  @js.native
  def toIter[TInput, TOutput](coll: js.Iterable[TInput], xf: Transducer[TInput, TOutput]): IterableIterator[TOutput] = js.native
  @JSImport("transducers.js", "toIter")
  @js.native
  ...
  @js.native
  def toObj[TInput, TOutput](coll: js.Iterable[TInput]): StringDictionary[TOutput] = js.native
  @JSImport("transducers.js", "toObj")
  @js.native
  def toObj[TInput, TOutput](coll: js.Iterable[TInput], xf: Transducer[TInput, js.Tuple2[String, TOutput]]): StringDictionary[TOutput] = js.native
  @JSImport("transducers.js", "toObj")
  @js.native
