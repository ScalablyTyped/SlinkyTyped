...
class EmptyStatementSyntax protected ()
  extends typingsSlinky.typescriptServices.TypeScript.EmptyStatementSyntax {
...
object EmptyStatementSyntax extends js.Object {
  def create1(): typingsSlinky.typescriptServices.TypeScript.EmptyStatementSyntax = js.native
}
