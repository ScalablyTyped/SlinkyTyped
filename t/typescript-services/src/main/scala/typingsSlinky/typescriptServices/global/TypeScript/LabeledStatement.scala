...
class LabeledStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.LabeledStatement {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.LabeledStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
