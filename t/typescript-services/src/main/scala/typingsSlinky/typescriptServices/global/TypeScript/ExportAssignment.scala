...
class ExportAssignment protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ExportAssignment {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ExportAssignment, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
