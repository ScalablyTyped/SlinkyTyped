...
@JSGlobal("TypeScript.ObjectType")
@js.native
class ObjectType protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ObjectType {
  def this(typeMembers: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var typeMembers: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ObjectType, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
