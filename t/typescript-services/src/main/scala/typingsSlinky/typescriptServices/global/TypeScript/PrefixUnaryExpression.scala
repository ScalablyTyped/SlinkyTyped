...
class PrefixUnaryExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.PrefixUnaryExpression {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.PrefixUnaryExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
