...
class GenericType protected ()
  extends typingsSlinky.typescriptServices.TypeScript.GenericType {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.GenericType, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
