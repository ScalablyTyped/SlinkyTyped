...
class ISyntaxList2 protected ()
  ...
  /* CompleteClass */
  override def any(func: js.Function1[/* v */ typingsSlinky.typescriptServices.TypeScript.AST, Boolean]): Boolean = js.native
  /* CompleteClass */
  override def childAt(index: Double): typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  override def firstOrDefault(
    func: js.Function2[/* v */ typingsSlinky.typescriptServices.TypeScript.AST, /* index */ Double, Boolean]
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ISyntaxList2, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
