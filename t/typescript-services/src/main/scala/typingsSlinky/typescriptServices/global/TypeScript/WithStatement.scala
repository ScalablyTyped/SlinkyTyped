...
@js.native
class WithStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.WithStatement {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.WithStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
