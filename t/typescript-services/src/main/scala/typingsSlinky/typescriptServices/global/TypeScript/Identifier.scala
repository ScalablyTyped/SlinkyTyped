...
class Identifier protected ()
  extends typingsSlinky.typescriptServices.TypeScript.Identifier {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.Identifier, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
