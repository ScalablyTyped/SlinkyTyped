...
class ParenthesizedExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ParenthesizedExpression {
  def this(
    openParenTrailingComments: js.Array[typingsSlinky.typescriptServices.TypeScript.Comment],
  ...
  /* CompleteClass */
  override var openParenTrailingComments: js.Array[typingsSlinky.typescriptServices.TypeScript.Comment] = js.native
  /* CompleteClass */
  ...
  override def structuralEquals(
    ast: typingsSlinky.typescriptServices.TypeScript.ParenthesizedExpression,
