...
@JSGlobal("TypeScript.ContinueStatement")
@js.native
class ContinueStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ContinueStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ContinueStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
