...
class ObjectLiteralExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ObjectLiteralExpression {
  def this(propertyAssignments: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var propertyAssignments: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  override def structuralEquals(
    ast: typingsSlinky.typescriptServices.TypeScript.ObjectLiteralExpression,
