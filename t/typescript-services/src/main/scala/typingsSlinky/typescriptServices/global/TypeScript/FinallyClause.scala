...
@JSGlobal("TypeScript.FinallyClause")
@js.native
class FinallyClause protected ()
  extends typingsSlinky.typescriptServices.TypeScript.FinallyClause {
  def this(block: typingsSlinky.typescriptServices.TypeScript.Block) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.CatchClause, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
