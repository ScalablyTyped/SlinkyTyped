...
class CaseSwitchClause protected ()
  extends typingsSlinky.typescriptServices.TypeScript.CaseSwitchClause {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.CaseSwitchClause, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
