...
class SimpleArrowFunctionExpressionSyntax protected ()
  extends typingsSlinky.typescriptServices.TypeScript.SimpleArrowFunctionExpressionSyntax {
  def this(
  ...
  /* CompleteClass */
  override var block: typingsSlinky.typescriptServices.TypeScript.BlockSyntax = js.native
  /* CompleteClass */
