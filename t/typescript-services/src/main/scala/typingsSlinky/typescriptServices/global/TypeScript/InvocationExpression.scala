...
class InvocationExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.InvocationExpression {
  def this(
    expression: typingsSlinky.typescriptServices.TypeScript.AST,
    argumentList: typingsSlinky.typescriptServices.TypeScript.ArgumentList
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var argumentList: typingsSlinky.typescriptServices.TypeScript.ArgumentList = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.InvocationExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
