...
class DiagnosticCategory ()
  extends typingsSlinky.typescriptServices.TypeScript.Services.DiagnosticCategory
object DiagnosticCategory {
  ...
  /* static member */
  @JSGlobal("TypeScript.Services.DiagnosticCategory.error")
  @js.native
  ...
  /* static member */
  @JSGlobal("TypeScript.Services.DiagnosticCategory.message")
  @js.native
  ...
  /* static member */
  @JSGlobal("TypeScript.Services.DiagnosticCategory.none")
  @js.native
  ...
  /* static member */
  @JSGlobal("TypeScript.Services.DiagnosticCategory.warning")
  @js.native
