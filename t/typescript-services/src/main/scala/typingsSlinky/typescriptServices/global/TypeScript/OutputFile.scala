...
class OutputFile protected ()
  ...
  /* CompleteClass */
  override var fileType: typingsSlinky.typescriptServices.TypeScript.OutputFileType = js.native
  /* CompleteClass */
  override var name: String = js.native
  /* CompleteClass */
  override var sourceMapEntries: js.Array[typingsSlinky.typescriptServices.TypeScript.SourceMapEntry] = js.native
  /* CompleteClass */
