...
class ReturnStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ReturnStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ReturnStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
