...
@js.native
class SwitchStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.SwitchStatement {
  def this(
    expression: typingsSlinky.typescriptServices.TypeScript.AST,
    closeParenToken: typingsSlinky.typescriptServices.TypeScript.ASTSpan,
    switchClauses: typingsSlinky.typescriptServices.TypeScript.ISyntaxList2
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var closeParenToken: typingsSlinky.typescriptServices.TypeScript.ASTSpan = js.native
  /* CompleteClass */
  override var expression: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var parent: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var switchClauses: typingsSlinky.typescriptServices.TypeScript.ISyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.SwitchStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
