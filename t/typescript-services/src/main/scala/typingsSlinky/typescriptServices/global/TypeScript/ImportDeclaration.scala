...
class ImportDeclaration protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ImportDeclaration {
  def this(
    ...
    moduleReference: typingsSlinky.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var moduleReference: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ImportDeclaration, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
