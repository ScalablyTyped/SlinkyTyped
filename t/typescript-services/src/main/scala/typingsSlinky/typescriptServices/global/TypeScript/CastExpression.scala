...
class CastExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.CastExpression {
  def this(
  ...
  /* CompleteClass */
  override var `type`: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.CastExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
