...
@js.native
class ForStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ForStatement {
  def this(
    variableDeclaration: typingsSlinky.typescriptServices.TypeScript.VariableDeclaration,
    initializer: typingsSlinky.typescriptServices.TypeScript.AST,
    condition: typingsSlinky.typescriptServices.TypeScript.AST,
    incrementor: typingsSlinky.typescriptServices.TypeScript.AST,
  ...
  /* CompleteClass */
  override var condition: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var incrementor: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var initializer: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var parent: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var statement: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var variableDeclaration: typingsSlinky.typescriptServices.TypeScript.VariableDeclaration = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ForStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
