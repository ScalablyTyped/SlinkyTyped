...
class ArrayType protected ()
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ArrayType, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
