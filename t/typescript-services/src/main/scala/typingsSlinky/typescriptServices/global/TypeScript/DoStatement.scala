...
class DoStatement protected ()
  ...
  /* CompleteClass */
  override var whileKeyword: typingsSlinky.typescriptServices.TypeScript.ASTSpan = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.DoStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
