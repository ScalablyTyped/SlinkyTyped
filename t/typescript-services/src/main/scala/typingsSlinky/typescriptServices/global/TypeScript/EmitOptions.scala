...
class EmitOptions protected ()
  ...
  /* CompleteClass */
  override def compilationSettings(): typingsSlinky.typescriptServices.TypeScript.ImmutableCompilationSettings = js.native
  /* CompleteClass */
  /* private */ override def determineCommonDirectoryPath(compiler: js.Any): js.Any = js.native
  /* CompleteClass */
  override def diagnostic(): typingsSlinky.typescriptServices.TypeScript.Diagnostic = js.native
  /* CompleteClass */
