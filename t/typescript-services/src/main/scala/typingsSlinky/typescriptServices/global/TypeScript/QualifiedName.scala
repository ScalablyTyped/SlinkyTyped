...
class QualifiedName protected ()
  extends typingsSlinky.typescriptServices.TypeScript.QualifiedName {
  def this(
    left: typingsSlinky.typescriptServices.TypeScript.AST,
    right: typingsSlinky.typescriptServices.TypeScript.Identifier
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var left: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var parent: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var right: typingsSlinky.typescriptServices.TypeScript.Identifier = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.QualifiedName, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
