...
class StringLiteral protected ()
  extends typingsSlinky.typescriptServices.TypeScript.StringLiteral {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.StringLiteral, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
