...
class Block protected ()
  extends typingsSlinky.typescriptServices.TypeScript.Block {
  def this(
    statements: typingsSlinky.typescriptServices.TypeScript.ISyntaxList2,
    closeBraceLeadingComments: js.Array[typingsSlinky.typescriptServices.TypeScript.Comment],
  ...
  /* CompleteClass */
  override var closeBraceLeadingComments: js.Array[typingsSlinky.typescriptServices.TypeScript.Comment] = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var statements: typingsSlinky.typescriptServices.TypeScript.ISyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.Block, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
