...
object Length {
  ...
  implicit class LengthOps[Self <: Length] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLineStartsVarargs(value: Double*): Self = this.set("lineStarts", js.Array(value :_*))
    
    @scala.inline
    def setLineStarts(value: js.Array[Double]): Self = this.set("lineStarts", value.asInstanceOf[js.Any])
  }
}
