...
object PositionTrackingWalker {
  ...
  implicit class PositionTrackingWalkerOps[Self <: PositionTrackingWalker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_position(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_position")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSkip(value: ISyntaxElement => Unit): Self = {
        val ret = this.duplicate
