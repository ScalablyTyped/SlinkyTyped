...
@js.native
trait DefaultSwitchClause extends AST {
...
object DefaultSwitchClause {
  ...
  @scala.inline
  implicit class DefaultSwitchClauseOps[Self <: DefaultSwitchClause] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (DefaultSwitchClause, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
}
