...
object CastExpression {
  ...
  implicit class CastExpressionOps[Self <: CastExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (CastExpression, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
    
    @scala.inline
    def setType(value: AST): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
