...
- typingsSlinky.typescriptServices.TypeScript.ICallExpression because var conflicts: _end, _start. Inlined expression, argumentList */ trait InvocationExpression extends AST {
