...
object InvocationTypeArgumentInferenceContext {
  ...
  @scala.inline
  implicit class InvocationTypeArgumentInferenceContextOps[Self <: InvocationTypeArgumentInferenceContext] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withArgumentASTs(value: ISeparatedSyntaxList2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("argumentASTs")(value.asInstanceOf[js.Any])
        ret
    }
  }
