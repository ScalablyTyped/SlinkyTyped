...
object IArrowFunctionExpressionSyntax {
  ...
  implicit class IArrowFunctionExpressionSyntaxOps[Self <: IArrowFunctionExpressionSyntax] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBlock(value: BlockSyntax): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("block")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEqualsGreaterThanToken(value: ISyntaxToken): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("equalsGreaterThanToken")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withExpression(value: IExpressionSyntax): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expression")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsArrowFunctionExpression(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isArrowFunctionExpression")(js.Any.fromFunction0(value))
        ret
    }
  }
