...
object TypeOfExpression {
  ...
  @scala.inline
  implicit class TypeOfExpressionOps[Self <: TypeOfExpression] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStructuralEquals(value: (TypeOfExpression, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
