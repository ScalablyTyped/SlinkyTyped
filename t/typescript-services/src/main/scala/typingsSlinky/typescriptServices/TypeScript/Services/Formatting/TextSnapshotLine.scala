...
object TextSnapshotLine {
  ...
  implicit class TextSnapshotLineOps[Self <: TextSnapshotLine] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_end(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_end")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_lineBreak(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_lineBreak")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_lineNumber(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_lineNumber")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_snapshot(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_snapshot")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
