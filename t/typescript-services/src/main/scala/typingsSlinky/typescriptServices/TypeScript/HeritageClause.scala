...
object HeritageClause {
  ...
  implicit class HeritageClauseOps[Self <: HeritageClause] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStructuralEquals(value: (HeritageClause, Boolean) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("structuralEquals")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withTypeNames(value: ISeparatedSyntaxList2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("typeNames")(value.asInstanceOf[js.Any])
        ret
    }
  }
