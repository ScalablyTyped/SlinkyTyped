...
@js.native
trait ArrayLiteralExpression extends AST {
...
object ArrayLiteralExpression {
  ...
  @scala.inline
  implicit class ArrayLiteralExpressionOps[Self <: ArrayLiteralExpression] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setExpressions(value: ISeparatedSyntaxList2): Self = this.set("expressions", value.asInstanceOf[js.Any])
    @scala.inline
    def setStructuralEquals(value: (ArrayLiteralExpression, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
