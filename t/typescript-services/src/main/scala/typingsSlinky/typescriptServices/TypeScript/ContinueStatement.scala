...
trait ContinueStatement extends AST {
  ...
  def structuralEquals(ast: ContinueStatement, includingPosition: Boolean): Boolean = js.native
}
...
object ContinueStatement {
  ...
  implicit class ContinueStatementOps[Self <: ContinueStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (ContinueStatement, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
