...
object ObjectCreationExpression {
  ...
  @scala.inline
  implicit class ObjectCreationExpressionMutableBuilder[Self <: ObjectCreationExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (ObjectCreationExpression, Boolean) => Boolean): Self = StObject.set(x, "structuralEquals", js.Any.fromFunction2(value))
  }
}
