...
object SyntaxIndenter {
  ...
  implicit class SyntaxIndenterOps[Self <: SyntaxIndenter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIndentMultiLineComment(value: (js.Any, js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentMultiLineComment")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withIndentSegment(value: js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentSegment")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIndentSingleLineOrSkippedText(value: (js.Any, js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentSingleLineOrSkippedText")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withIndentTriviaList(value: ISyntaxTriviaList => ISyntaxTriviaList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentTriviaList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIndentWhitespace(value: (js.Any, js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentWhitespace")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withIndentationAmount(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentationAmount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIndentationTrivia(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentationTrivia")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
