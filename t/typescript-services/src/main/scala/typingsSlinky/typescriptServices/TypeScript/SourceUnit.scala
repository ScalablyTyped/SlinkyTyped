...
object SourceUnit {
  ...
  implicit class SourceUnitOps[Self <: SourceUnit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndOfFileTokenLeadingComments(value: js.Array[Comment]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endOfFileTokenLeadingComments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStructuralEquals(value: (SourceUnit, Boolean) => Boolean): Self = {
        val ret = this.duplicate
