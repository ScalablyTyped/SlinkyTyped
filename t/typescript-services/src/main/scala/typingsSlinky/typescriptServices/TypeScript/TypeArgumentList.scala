...
@js.native
trait TypeArgumentList extends AST {
...
object TypeArgumentList {
  ...
  implicit class TypeArgumentListOps[Self <: TypeArgumentList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeArguments(value: ISeparatedSyntaxList2): Self = this.set("typeArguments", value.asInstanceOf[js.Any])
  }
}
