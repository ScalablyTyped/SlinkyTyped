...
@js.native
trait TypeParameterList extends AST {
...
object TypeParameterList {
  ...
  @scala.inline
  implicit class TypeParameterListOps[Self <: TypeParameterList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTypeParameters(value: ISeparatedSyntaxList2): Self = this.set("typeParameters", value.asInstanceOf[js.Any])
  }
