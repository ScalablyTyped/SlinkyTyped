...
object VoidExpression {
  ...
  @scala.inline
  implicit class VoidExpressionOps[Self <: VoidExpression] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStructuralEquals(value: (VoidExpression, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
