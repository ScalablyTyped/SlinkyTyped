...
object ForStatement {
  ...
  implicit class ForStatementOps[Self <: ForStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIncrementor(value: AST): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("incrementor")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withInitializer(value: AST): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStructuralEquals(value: (ForStatement, Boolean) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("structuralEquals")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withVariableDeclaration(value: VariableDeclaration): Self = {
        val ret = this.duplicate
