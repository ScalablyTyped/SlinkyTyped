...
object DepthLimitedWalker {
  ...
  implicit class DepthLimitedWalkerOps[Self <: DepthLimitedWalker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_maximumDepth(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_maximumDepth")(value.asInstanceOf[js.Any])
        ret
    }
  }
