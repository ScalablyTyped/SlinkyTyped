...
object PullFunctionExpressionDecl {
  ...
  @scala.inline
  implicit class PullFunctionExpressionDeclOps[Self <: PullFunctionExpressionDecl] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withFunctionExpressionName(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("functionExpressionName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetFunctionExpressionName(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFunctionExpressionName")(js.Any.fromFunction0(value))
        ret
    }
  }
