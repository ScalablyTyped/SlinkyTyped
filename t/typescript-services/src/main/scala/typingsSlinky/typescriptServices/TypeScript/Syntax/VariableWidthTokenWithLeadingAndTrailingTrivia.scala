...
object VariableWidthTokenWithLeadingAndTrailingTrivia {
  ...
  implicit class VariableWidthTokenWithLeadingAndTrailingTriviaOps[Self <: VariableWidthTokenWithLeadingAndTrailingTrivia] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_fullText(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_fullText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_leadingTriviaInfo(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_leadingTriviaInfo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_trailingTriviaInfo(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_trailingTriviaInfo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFindTokenInternal(value: (js.Any, js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("findTokenInternal")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRealize(value: () => js.Any): Self = {
        val ret = this.duplicate
