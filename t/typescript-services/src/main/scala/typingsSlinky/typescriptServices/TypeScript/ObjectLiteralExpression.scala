...
object ObjectLiteralExpression {
  ...
  implicit class ObjectLiteralExpressionOps[Self <: ObjectLiteralExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPropertyAssignments(value: ISeparatedSyntaxList2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("propertyAssignments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStructuralEquals(value: (ObjectLiteralExpression, Boolean) => Boolean): Self = {
        val ret = this.duplicate
