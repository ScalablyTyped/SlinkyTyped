...
object LanguageServiceShim {
  ...
  implicit class LanguageServiceShimOps[Self <: LanguageServiceShim] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_navigateToItemsToString(value: js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_navigateToItemsToString")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withForwardJSONCall(value: (String, js.Function0[_]) => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRealizeDiagnosticWithFileName(value: js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("realizeDiagnosticWithFileName")(js.Any.fromFunction1(value))
        ret
    }
  }
