...
object GenericType {
  ...
  implicit class GenericTypeOps[Self <: GenericType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStructuralEquals(value: (GenericType, Boolean) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("structuralEquals")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withTypeArgumentList(value: TypeArgumentList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("typeArgumentList")(value.asInstanceOf[js.Any])
        ret
    }
  }
