...
object GenericType {
  ...
  implicit class GenericTypeOps[Self <: GenericType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (GenericType, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
    
    @scala.inline
    def setTypeArgumentList(value: TypeArgumentList): Self = this.set("typeArgumentList", value.asInstanceOf[js.Any])
  }
}
