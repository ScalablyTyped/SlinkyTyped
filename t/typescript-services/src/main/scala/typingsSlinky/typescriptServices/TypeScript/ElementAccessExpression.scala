...
object ElementAccessExpression {
  ...
  implicit class ElementAccessExpressionOps[Self <: ElementAccessExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withArgumentExpression(value: AST): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("argumentExpression")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStructuralEquals(value: (ElementAccessExpression, Boolean) => Boolean): Self = {
        val ret = this.duplicate
