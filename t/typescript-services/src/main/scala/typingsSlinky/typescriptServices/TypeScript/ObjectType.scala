...
object ObjectType {
  ...
  implicit class ObjectTypeOps[Self <: ObjectType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (ObjectType, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
    @scala.inline
    def setTypeMembers(value: ISeparatedSyntaxList2): Self = this.set("typeMembers", value.asInstanceOf[js.Any])
  }
