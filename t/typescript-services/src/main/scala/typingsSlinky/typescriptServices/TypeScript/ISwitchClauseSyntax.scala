...
object ISwitchClauseSyntax {
  ...
  implicit class ISwitchClauseSyntaxOps[Self <: ISwitchClauseSyntax] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsSwitchClause(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isSwitchClause")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withStatements(value: ISyntaxList): Self = {
        val ret = this.duplicate
