...
object SyntaxDedenter {
  ...
  implicit class SyntaxDedenterOps[Self <: SyntaxDedenter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDedentMultiLineComment(value: js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dedentMultiLineComment")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDedentSegment(value: (js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dedentSegment")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withDedentTriviaList(value: js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dedentTriviaList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDedentWhitespace(value: (js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dedentWhitespace")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withDedentationAmount(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dedentationAmount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsAborted(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isAborted")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withLastTriviaWasNewLine(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lastTriviaWasNewLine")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinimumIndent(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minimumIndent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
