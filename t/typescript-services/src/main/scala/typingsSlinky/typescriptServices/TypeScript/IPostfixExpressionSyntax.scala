...
trait IPostfixExpressionSyntax extends IUnaryExpressionSyntax {
  def isPostfixExpression(): Boolean = js.native
}
...
object IPostfixExpressionSyntax {
  ...
  @scala.inline
  implicit class IPostfixExpressionSyntaxOps[Self <: IPostfixExpressionSyntax] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withIsPostfixExpression(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isPostfixExpression")(js.Any.fromFunction0(value))
        ret
    }
  }
