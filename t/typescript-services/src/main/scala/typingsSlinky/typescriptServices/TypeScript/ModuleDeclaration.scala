...
object ModuleDeclaration {
  ...
  implicit class ModuleDeclarationOps[Self <: ModuleDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndingToken(value: ASTSpan): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endingToken")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withModuleElements(value: ISyntaxList2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("moduleElements")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withName(value: AST): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("name")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStringLiteral(value: StringLiteral): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stringLiteral")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStructuralEquals(value: (ModuleDeclaration, Boolean) => Boolean): Self = {
        val ret = this.duplicate
