...
object IfStatement {
  ...
  implicit class IfStatementOps[Self <: IfStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withElseClause(value: ElseClause): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("elseClause")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStructuralEquals(value: (IfStatement, Boolean) => Boolean): Self = {
        val ret = this.duplicate
