...
object OtherPullDeclsWalker {
  ...
  implicit class OtherPullDeclsWalkerOps[Self <: OtherPullDeclsWalker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCurrentlyWalkingOtherDecls(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("currentlyWalkingOtherDecls")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withWalkOtherPullDecls(value: (PullDecl, js.Array[PullDecl], js.Function1[/* otherDecl */ PullDecl, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("walkOtherPullDecls")(js.Any.fromFunction3(value))
        ret
    }
  }
