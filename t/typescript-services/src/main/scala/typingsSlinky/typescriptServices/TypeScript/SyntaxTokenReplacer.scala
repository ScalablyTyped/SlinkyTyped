...
object SyntaxTokenReplacer {
  ...
  implicit class SyntaxTokenReplacerOps[Self <: SyntaxTokenReplacer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setToken1(value: js.Any): Self = this.set("token1", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setToken2(value: js.Any): Self = this.set("token2", value.asInstanceOf[js.Any])
  }
}
