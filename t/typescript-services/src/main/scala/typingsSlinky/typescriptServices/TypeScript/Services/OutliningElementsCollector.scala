...
import typingsSlinky.typescriptServices.TypeScript.DepthLimitedWalker
...
object OutliningElementsCollector {
  ...
  implicit class OutliningElementsCollectorOps[Self <: OutliningElementsCollector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddOutlineRange(value: (js.Any, js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addOutlineRange")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withInObjectLiteralExpression(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("inObjectLiteralExpression")(value.asInstanceOf[js.Any])
        ret
    }
  }
