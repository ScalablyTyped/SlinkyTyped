...
import typingsSlinky.typescriptServices.AnonEnclosingTypeWalkerState1
import typingsSlinky.typescriptServices.AnonIndexSigs1
import typingsSlinky.typescriptServices.AnonStateWhenStartedWalkingTypes1
