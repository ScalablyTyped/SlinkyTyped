...
object VariableDeclaration {
  ...
  implicit class VariableDeclarationOps[Self <: VariableDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeclarators(value: ISeparatedSyntaxList2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declarators")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStructuralEquals(value: (VariableDeclaration, Boolean) => Boolean): Self = {
        val ret = this.duplicate
