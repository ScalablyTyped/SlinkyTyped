...
object VariableDeclaration {
  ...
  implicit class VariableDeclarationOps[Self <: VariableDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeclarators(value: ISeparatedSyntaxList2): Self = this.set("declarators", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStructuralEquals(value: (VariableDeclaration, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
}
