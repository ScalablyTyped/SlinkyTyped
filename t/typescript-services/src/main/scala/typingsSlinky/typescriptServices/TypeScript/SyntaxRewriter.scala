...
object SyntaxRewriter {
  ...
  implicit class SyntaxRewriterOps[Self <: SyntaxRewriter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withVisitList(value: ISyntaxList => ISyntaxList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("visitList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withVisitNode(value: SyntaxNode => SyntaxNode): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("visitNode")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withVisitNodeOrToken(value: ISyntaxNodeOrToken => ISyntaxNodeOrToken): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("visitNodeOrToken")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withVisitSeparatedList(value: ISeparatedSyntaxList => ISeparatedSyntaxList): Self = {
        val ret = this.duplicate
