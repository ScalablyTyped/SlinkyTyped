...
object ISeparatedSyntaxList2 {
  ...
  implicit class ISeparatedSyntaxList2Ops[Self <: ISeparatedSyntaxList2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_separatorCount(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_separatorCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNonSeparatorAt(value: Double => AST): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNonSeparatorIndexOf(value: AST => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nonSeparatorIndexOf")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStructuralEquals(value: (ISeparatedSyntaxList2, Boolean) => Boolean): Self = {
        val ret = this.duplicate
