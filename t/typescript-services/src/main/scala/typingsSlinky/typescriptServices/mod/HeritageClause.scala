...
class HeritageClause protected ()
  ...
  /* CompleteClass */
  override var typeNames: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.HeritageClause, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
