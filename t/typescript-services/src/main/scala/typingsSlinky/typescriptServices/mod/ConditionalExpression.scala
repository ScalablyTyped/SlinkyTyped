...
@js.native
class ConditionalExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ConditionalExpression {
  def this(
    condition: typingsSlinky.typescriptServices.TypeScript.AST,
    whenTrue: typingsSlinky.typescriptServices.TypeScript.AST,
  ...
  /* CompleteClass */
  override var whenFalse: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var whenTrue: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ConditionalExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
