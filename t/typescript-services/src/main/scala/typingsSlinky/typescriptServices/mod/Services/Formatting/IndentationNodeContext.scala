...
class IndentationNodeContext protected ()
  ...
  /* CompleteClass */
  override def clone(pool: typingsSlinky.typescriptServices.TypeScript.Services.Formatting.IndentationNodeContextPool): typingsSlinky.typescriptServices.TypeScript.Services.Formatting.IndentationNodeContext = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def parent(): typingsSlinky.typescriptServices.TypeScript.Services.Formatting.IndentationNodeContext = js.native
  /* CompleteClass */
