...
class EnumDeclaration protected ()
  extends typingsSlinky.typescriptServices.TypeScript.EnumDeclaration {
  def this(
    ...
    enumElements: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var enumElements: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
