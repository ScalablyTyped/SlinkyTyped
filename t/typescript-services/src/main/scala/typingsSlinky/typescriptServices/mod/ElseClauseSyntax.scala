...
class ElseClauseSyntax protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ElseClauseSyntax {
...
object ElseClauseSyntax extends js.Object {
  def create1(statement: IStatementSyntax): typingsSlinky.typescriptServices.TypeScript.ElseClauseSyntax = js.native
}
