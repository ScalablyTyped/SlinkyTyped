...
class TryStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.TryStatement {
  def this(
    block: typingsSlinky.typescriptServices.TypeScript.Block,
    catchClause: typingsSlinky.typescriptServices.TypeScript.CatchClause,
    finallyClause: typingsSlinky.typescriptServices.TypeScript.FinallyClause
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var catchClause: typingsSlinky.typescriptServices.TypeScript.CatchClause = js.native
  /* CompleteClass */
  override var finallyClause: typingsSlinky.typescriptServices.TypeScript.FinallyClause = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.TryStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
