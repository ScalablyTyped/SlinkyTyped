...
class ElementAccessExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ElementAccessExpression {
  def this(
    expression: typingsSlinky.typescriptServices.TypeScript.AST,
    argumentExpression: typingsSlinky.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var argumentExpression: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  override def structuralEquals(
    ast: typingsSlinky.typescriptServices.TypeScript.ElementAccessExpression,
