...
@JSImport("typescript-services", "NumericLiteral")
@js.native
class NumericLiteral protected ()
  extends typingsSlinky.typescriptServices.TypeScript.NumericLiteral {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.NumericLiteral, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
