...
class InterfaceDeclaration protected ()
  ...
  /* CompleteClass */
  override var body: typingsSlinky.typescriptServices.TypeScript.ObjectType = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.InterfaceDeclaration, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
