...
class TypeQuery protected ()
  extends typingsSlinky.typescriptServices.TypeScript.TypeQuery {
  def this(name: typingsSlinky.typescriptServices.TypeScript.AST) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.TypeQuery, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
