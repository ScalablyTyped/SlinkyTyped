...
class BinaryExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.BinaryExpression {
  def this(
    _nodeType: typingsSlinky.typescriptServices.TypeScript.SyntaxKind,
    left: typingsSlinky.typescriptServices.TypeScript.AST,
    right: typingsSlinky.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var right: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.BinaryExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
