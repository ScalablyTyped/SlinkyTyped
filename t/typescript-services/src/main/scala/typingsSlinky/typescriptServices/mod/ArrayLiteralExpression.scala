...
@JSImport("typescript-services", "ArrayLiteralExpression")
@js.native
class ArrayLiteralExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ArrayLiteralExpression {
  def this(expressions: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var expressions: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  override def structuralEquals(
    ast: typingsSlinky.typescriptServices.TypeScript.ArrayLiteralExpression,
