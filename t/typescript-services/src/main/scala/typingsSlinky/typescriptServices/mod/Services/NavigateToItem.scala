...
class NavigateToItem ()
  extends typingsSlinky.typescriptServices.TypeScript.Services.NavigateToItem {
  /* CompleteClass */
  override var additionalSpans: js.Array[typingsSlinky.typescriptServices.TypeScript.Services.SpanInfo] = js.native
  /* CompleteClass */
