...
@JSImport("typescript-services", "ArgumentList")
@js.native
class ArgumentList protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ArgumentList {
  def this(
    typeArgumentList: typingsSlinky.typescriptServices.TypeScript.TypeArgumentList,
    _arguments: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2,
  ...
  /* CompleteClass */
  override var arguments: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var typeArgumentList: typingsSlinky.typescriptServices.TypeScript.TypeArgumentList = js.native
  /* CompleteClass */
