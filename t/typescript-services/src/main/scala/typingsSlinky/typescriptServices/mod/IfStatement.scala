...
class IfStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.IfStatement {
  def this(
    condition: typingsSlinky.typescriptServices.TypeScript.AST,
    statement: typingsSlinky.typescriptServices.TypeScript.AST,
    elseClause: typingsSlinky.typescriptServices.TypeScript.ElseClause
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var elseClause: typingsSlinky.typescriptServices.TypeScript.ElseClause = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.IfStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
