...
class MemberAccessExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.MemberAccessExpression {
  def this(
    expression: typingsSlinky.typescriptServices.TypeScript.AST,
    name: typingsSlinky.typescriptServices.TypeScript.Identifier
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var name: typingsSlinky.typescriptServices.TypeScript.Identifier = js.native
  /* CompleteClass */
  ...
  override def structuralEquals(
    ast: typingsSlinky.typescriptServices.TypeScript.MemberAccessExpression,
