...
class VariableStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.VariableStatement {
  def this(
    modifiers: js.Array[typingsSlinky.typescriptServices.TypeScript.PullElementFlags],
    declaration: typingsSlinky.typescriptServices.TypeScript.VariableDeclaration
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var declaration: typingsSlinky.typescriptServices.TypeScript.VariableDeclaration = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.VariableStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
