...
class ExpressionStatement protected ()
  extends typingsSlinky.typescriptServices.TypeScript.ExpressionStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.ExpressionStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
