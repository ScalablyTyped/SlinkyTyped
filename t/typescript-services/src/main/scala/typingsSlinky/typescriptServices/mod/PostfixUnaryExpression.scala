...
@JSImport("typescript-services", "PostfixUnaryExpression")
@js.native
class PostfixUnaryExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.PostfixUnaryExpression {
  def this(
    _nodeType: typingsSlinky.typescriptServices.TypeScript.SyntaxKind,
    operand: typingsSlinky.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var operand: typingsSlinky.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  override def structuralEquals(
    ast: typingsSlinky.typescriptServices.TypeScript.PostfixUnaryExpression,
