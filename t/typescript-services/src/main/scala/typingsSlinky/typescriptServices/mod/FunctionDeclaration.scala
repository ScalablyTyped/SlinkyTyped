...
@JSImport("typescript-services", "FunctionDeclaration")
@js.native
class FunctionDeclaration protected ()
  extends typingsSlinky.typescriptServices.TypeScript.FunctionDeclaration {
  def this(
    ...
    callSignature: typingsSlinky.typescriptServices.TypeScript.CallSignature,
  ...
  /* CompleteClass */
  override var callSignature: typingsSlinky.typescriptServices.TypeScript.CallSignature = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.FunctionDeclaration, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
