...
class TypeOfExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.TypeOfExpression {
  def this(expression: typingsSlinky.typescriptServices.TypeScript.AST) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.TypeOfExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
