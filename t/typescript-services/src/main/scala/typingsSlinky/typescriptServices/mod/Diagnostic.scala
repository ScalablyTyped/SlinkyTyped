...
import typingsSlinky.typescriptServices.TypeScript.DiagnosticInfo
...
class Diagnostic protected ()
  ...
  /* CompleteClass */
  override def additionalLocations(): js.Array[typingsSlinky.typescriptServices.TypeScript.Location] = js.native
  /* CompleteClass */
