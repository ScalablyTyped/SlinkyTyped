...
class VariableDeclaration protected ()
  extends typingsSlinky.typescriptServices.TypeScript.VariableDeclaration {
  def this(declarators: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var declarators: typingsSlinky.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.VariableDeclaration, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
