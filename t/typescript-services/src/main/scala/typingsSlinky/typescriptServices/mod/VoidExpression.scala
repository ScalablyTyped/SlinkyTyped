...
class VoidExpression protected ()
  extends typingsSlinky.typescriptServices.TypeScript.VoidExpression {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.VoidExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
