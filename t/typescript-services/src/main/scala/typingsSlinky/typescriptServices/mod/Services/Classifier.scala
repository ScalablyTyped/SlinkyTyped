...
class Classifier protected ()
  extends typingsSlinky.typescriptServices.TypeScript.Services.Classifier {
  ...
  /* CompleteClass */
  override def getClassificationsForLine(text: String, lexState: typingsSlinky.typescriptServices.TypeScript.Services.EndOfLineState): typingsSlinky.typescriptServices.TypeScript.Services.ClassificationResult = js.native
  /* CompleteClass */
