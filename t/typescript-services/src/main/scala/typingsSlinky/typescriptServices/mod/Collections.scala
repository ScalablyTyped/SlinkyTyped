...
object Collections {
  ...
  @js.native
  def DefaultStringTable: typingsSlinky.typescriptServices.TypeScript.Collections.StringTable = js.native
  ...
  @scala.inline
  def DefaultStringTable_=(x: typingsSlinky.typescriptServices.TypeScript.Collections.StringTable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefaultStringTable")(x.asInstanceOf[js.Any])
