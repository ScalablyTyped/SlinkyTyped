...
class TypeParameter protected ()
  extends typingsSlinky.typescriptServices.TypeScript.TypeParameter {
  def this(
    identifier: typingsSlinky.typescriptServices.TypeScript.Identifier,
    constraint: typingsSlinky.typescriptServices.TypeScript.Constraint
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var constraint: typingsSlinky.typescriptServices.TypeScript.Constraint = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.TypeParameter, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
