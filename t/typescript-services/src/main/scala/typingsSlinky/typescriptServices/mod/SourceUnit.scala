...
class SourceUnit protected ()
  extends typingsSlinky.typescriptServices.TypeScript.SourceUnit {
  def this(
    moduleElements: typingsSlinky.typescriptServices.TypeScript.ISyntaxList2,
    endOfFileTokenLeadingComments: js.Array[typingsSlinky.typescriptServices.TypeScript.Comment],
    _fileName: String
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var endOfFileTokenLeadingComments: js.Array[typingsSlinky.typescriptServices.TypeScript.Comment] = js.native
  /* CompleteClass */
  override var moduleElements: typingsSlinky.typescriptServices.TypeScript.ISyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsSlinky.typescriptServices.TypeScript.SourceUnit, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
