...
class ImmutableCompilationSettings protected ()
  ...
  /* CompleteClass */
  override def codeGenTarget(): typingsSlinky.typescriptServices.TypeScript.LanguageVersion = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def moduleGenTarget(): typingsSlinky.typescriptServices.TypeScript.ModuleGenTarget = js.native
  /* CompleteClass */
