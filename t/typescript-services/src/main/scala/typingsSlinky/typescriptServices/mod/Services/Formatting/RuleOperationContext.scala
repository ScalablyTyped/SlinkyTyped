...
class RuleOperationContext protected ()
  ...
  /* CompleteClass */
  override def InContext(context: typingsSlinky.typescriptServices.TypeScript.Services.Formatting.FormattingContext): Boolean = js.native
  /* CompleteClass */
...
object RuleOperationContext extends js.Object {
  var Any: typingsSlinky.typescriptServices.TypeScript.Services.Formatting.RuleOperationContext = js.native
}
