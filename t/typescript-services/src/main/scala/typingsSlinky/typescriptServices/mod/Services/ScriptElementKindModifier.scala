...
class ScriptElementKindModifier ()
  extends typingsSlinky.typescriptServices.TypeScript.Services.ScriptElementKindModifier
object ScriptElementKindModifier {
  ...
  @scala.inline
  def ambientModifier_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ambientModifier")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def exportedModifier_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("exportedModifier")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def privateMemberModifier_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("privateMemberModifier")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def publicMemberModifier_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("publicMemberModifier")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def staticModifier_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("staticModifier")(x.asInstanceOf[js.Any])
}
