...
class TextSnapshotLine protected ()
  ...
  /* CompleteClass */
  override def end(): typingsSlinky.typescriptServices.TypeScript.Services.Formatting.SnapshotPoint = js.native
  /* CompleteClass */
  override def endIncludingLineBreak(): typingsSlinky.typescriptServices.TypeScript.Services.Formatting.SnapshotPoint = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def start(): typingsSlinky.typescriptServices.TypeScript.Services.Formatting.SnapshotPoint = js.native
  /* CompleteClass */
