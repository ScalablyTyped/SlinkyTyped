...
import typingsSlinky.typescriptDashServices.Anon_AllowAutomaticSemicolonInsertion
...
class ParseOptions protected () extends js.Object {
  ...
  def toJSON(key: js.Any): Anon_AllowAutomaticSemicolonInsertion = js.native
}
