...
class TextSpan protected ()
  extends typingsSlinky.typescriptDashServices.TypeScript.TextSpan {
...
object TextSpan extends js.Object {
  def fromBounds(start: Double, end: Double): typingsSlinky.typescriptDashServices.TypeScript.TextSpan = js.native
}
