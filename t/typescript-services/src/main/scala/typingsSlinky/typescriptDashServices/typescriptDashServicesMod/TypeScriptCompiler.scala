...
class TypeScriptCompiler ()
  extends typingsSlinky.typescriptDashServices.TypeScript.TypeScriptCompiler {
  def this(logger: ILogger) = this()
  def this(
    logger: ILogger,
    _settings: typingsSlinky.typescriptDashServices.TypeScript.ImmutableCompilationSettings
  ) = this()
}
...
object TypeScriptCompiler extends js.Object {
  def getFullDiagnosticText(
    diagnostic: typingsSlinky.typescriptDashServices.TypeScript.Diagnostic,
