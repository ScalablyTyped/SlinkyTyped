...
class KeywordCompletions ()
  extends typingsSlinky.typescriptDashServices.TypeScript.Services.KeywordCompletions
...
object KeywordCompletions extends js.Object {
  ...
  def getKeywordCompltions(): js.Array[typingsSlinky.typescriptDashServices.TypeScript.Services.ResolvedCompletionEntry] = js.native
}
