...
class ExportAssignmentSyntax protected ()
  extends typingsSlinky.typescriptDashServices.TypeScript.ExportAssignmentSyntax {
  def this(
...
object ExportAssignmentSyntax extends js.Object {
  def create1(identifier: ISyntaxToken): typingsSlinky.typescriptDashServices.TypeScript.ExportAssignmentSyntax = js.native
}
