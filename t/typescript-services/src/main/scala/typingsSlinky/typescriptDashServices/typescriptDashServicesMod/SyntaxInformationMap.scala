...
class SyntaxInformationMap protected ()
  extends typingsSlinky.typescriptDashServices.TypeScript.SyntaxInformationMap {
...
object SyntaxInformationMap extends js.Object {
  def create(
    node: typingsSlinky.typescriptDashServices.TypeScript.SyntaxNode,
    trackParents: Boolean,
    trackPreviousToken: Boolean
  ): typingsSlinky.typescriptDashServices.TypeScript.SyntaxInformationMap = js.native
}
