...
import typingsSlinky.typescriptDashServices.TypeScript.Services.ILanguageService
import typingsSlinky.typescriptDashServices.TypeScript.Services.ILanguageServiceShimHost
import typingsSlinky.typescriptDashServices.TypeScript.Services.IShimFactory
...
class LanguageServiceShim protected ()
  extends typingsSlinky.typescriptDashServices.TypeScript.Services.LanguageServiceShim {
