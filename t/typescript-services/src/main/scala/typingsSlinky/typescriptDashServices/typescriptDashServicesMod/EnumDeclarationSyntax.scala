...
class EnumDeclarationSyntax protected ()
  extends typingsSlinky.typescriptDashServices.TypeScript.EnumDeclarationSyntax {
  def this(
...
object EnumDeclarationSyntax extends js.Object {
  def create(
    ...
    openBraceToken: ISyntaxToken,
    closeBraceToken: ISyntaxToken
  ): typingsSlinky.typescriptDashServices.TypeScript.EnumDeclarationSyntax = js.native
  def create1(identifier: ISyntaxToken): typingsSlinky.typescriptDashServices.TypeScript.EnumDeclarationSyntax = js.native
}
