...
@js.native
class Debug ()
  extends typingsSlinky.typescriptDashServices.TypeScript.Debug
...
object Debug extends js.Object {
  ...
  def shouldAssert(level: typingsSlinky.typescriptDashServices.TypeScript.AssertionLevel): Boolean = js.native
}
