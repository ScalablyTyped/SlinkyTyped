...
class QualifiedNameSyntax protected ()
  extends typingsSlinky.typescriptDashServices.TypeScript.QualifiedNameSyntax {
...
object QualifiedNameSyntax extends js.Object {
  def create1(left: INameSyntax, right: ISyntaxToken): typingsSlinky.typescriptDashServices.TypeScript.QualifiedNameSyntax = js.native
}
