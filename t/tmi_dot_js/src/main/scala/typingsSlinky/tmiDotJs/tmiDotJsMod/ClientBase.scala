...
import typingsSlinky.tmiDotJs.tmiDotJsStrings.CLOSED
import typingsSlinky.tmiDotJs.tmiDotJsStrings.CLOSING
import typingsSlinky.tmiDotJs.tmiDotJsStrings.CONNECTING
import typingsSlinky.tmiDotJs.tmiDotJsStrings.OPEN
