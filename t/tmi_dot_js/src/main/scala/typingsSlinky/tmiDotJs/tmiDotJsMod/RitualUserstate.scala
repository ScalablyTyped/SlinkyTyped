...
import typingsSlinky.tmiDotJs.tmiDotJsStrings.new_chatter
import typingsSlinky.tmiDotJs.tmiDotJsStrings.ritual
import typingsSlinky.tmiDotJs.tmiDotJsStrings.staff
