...
trait OverriddenMethods[TEmitter, TEventRecord, TEmitRecord] extends js.Object {
  ...
  def removeEventListener[T](event: String, listener: js.Function1[/* repeated */ js.Any, _]): EEMethodReturnType[TEmitter, typingsSlinky.tmiDotJs.tmiDotJsStrings.removeEventListener, T, Unit] = js.native
  def removeListener(event: js.Symbol, listener: js.Function1[/* repeated */ js.Any, _]): Unit = js.native
  def removeListener[T](event: String, listener: js.Function1[/* repeated */ js.Any, _]): EEMethodReturnType[TEmitter, typingsSlinky.tmiDotJs.tmiDotJsStrings.removeListener, T, Unit] = js.native
}
