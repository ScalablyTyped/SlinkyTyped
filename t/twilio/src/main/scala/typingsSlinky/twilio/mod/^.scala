...
object ^ extends js.Object {
  ...
  def apply(sid: js.UndefOr[scala.Nothing], tkn: String, options: ClientOptions): RestClient = js.native
  def apply(sid: String): RestClient = js.native
  def apply(sid: String, tkn: js.UndefOr[scala.Nothing], options: ClientOptions): RestClient = js.native
