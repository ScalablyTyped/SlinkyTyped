...
trait ExtractCommentOptions extends js.Object {
  ...
  var condition: String | js.RegExp | ExtractCommentFn = js.native
...
object ExtractCommentOptions {
  ...
  @scala.inline
  def apply(condition: String | js.RegExp | ExtractCommentFn): ExtractCommentOptions = {
  ...
  implicit class ExtractCommentOptionsOps[Self <: ExtractCommentOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCondition(value: String | js.RegExp | ExtractCommentFn): Self = this.set("condition", value.asInstanceOf[js.Any])
