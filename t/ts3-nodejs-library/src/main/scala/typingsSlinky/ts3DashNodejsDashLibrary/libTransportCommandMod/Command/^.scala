package typingsSlinky.ts3DashNodejsDashLibrary.libTransportCommandMod.Command

import typingsSlinky.std.Partial
import typingsSlinky.std.Pick
import typingsSlinky.ts3DashNodejsDashLibrary.Anon_Key
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesQueryResponseMod.QueryResponseTypes
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.raw
...
object ^ extends js.Object {
  /**
    ...
    */
  def build(command: typingsSlinky.ts3DashNodejsDashLibrary.libTransportCommandMod.Command): String = js.native
  /**
    * the custom snapshot request parser
    * @param data snapshot string
    * @param cmd command object
    */
  def buildSnapshotDeploy(data: String, cmd: typingsSlinky.ts3DashNodejsDashLibrary.libTransportCommandMod.Command): String = js.native
  /** escapes a string */
