package typingsSlinky.ts3DashNodejsDashLibrary.libTeamSpeakMod

import typingsSlinky.node.Buffer
import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.std.Partial
import typingsSlinky.ts3DashNodejsDashLibrary.libExceptionResponseErrorMod.ResponseError
import typingsSlinky.ts3DashNodejsDashLibrary.libNodeChannelGroupMod.TeamSpeakChannelGroup
...
import typingsSlinky.ts3DashNodejsDashLibrary.libNodeServerGroupMod.TeamSpeakServerGroup
import typingsSlinky.ts3DashNodejsDashLibrary.libNodeServerMod.TeamSpeakServer
import typingsSlinky.ts3DashNodejsDashLibrary.libTransportTeamSpeakQueryMod.TeamSpeakQuery.executeArgs
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ChannelCreate
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ChannelDelete
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ChannelMove
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ClientConnect
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ClientDisconnect
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ClientMoved
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.Debug
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ServerEdit
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.TextMessage
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.TokenUsed
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.BanAdd
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.BanClient
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.ChannelEdit
...
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.ClientUpdate
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.InstanceEdit
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.ServerTempPasswordAdd
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.TransferDownload
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.TransferUpload
...
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.BanList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.BindingList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelClientPermListId
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelClientPermListSid
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelFind
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelGroupClientList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelGroupCopy
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelGroupList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ChannelList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientDBFind
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientDBInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientDBList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientFind
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientGetDbidFromUid
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientGetIds
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientGetNameFromDbid
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientGetNameFromUid
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientGetUidFromClid
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ClientSetServerQueryLogin
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ComplainList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.CustomInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.CustomSearch
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.FTGetFileInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.FTGetFileList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.FTInitDownload
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.FTInitUpload
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.FTList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.HostInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.InstanceInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.LogView
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.MessageGet
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.MessageList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.PermFind
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.PermGet
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.PermIdGetByName
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.PermList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.PermOverview
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.PermissionList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.PrivilegeKeyList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.QueryLoginAdd
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.QueryLoginList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerCreate
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerGroupClientList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerGroupCopy
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerGroupList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerGroupsByClientId
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerIdGetByPort
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerRequestConnectionInfo
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.ServerTempPasswordList
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.SnapshotCreate
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.Token
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.Version
import typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.Whoami
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryBooleans.`false`
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryBooleans.`true`
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.channelcreate
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.channeldelete
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.channeledit
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.channelmoved
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.clientconnect
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.clientdisconnect
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.clientmoved
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.close
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.debug
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.error
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.flooding
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.ready
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.serveredit
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.textmessage
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryStrings.tokenused
...
class TeamSpeak protected () extends EventEmitter {
  ...
  /**
    ...
    */
  def ban(properties: BanAdd): js.Promise[typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.BanAdd] = js.native
  /**
    ...
    */
  def banClient(properties: BanClient): js.Promise[typingsSlinky.ts3DashNodejsDashLibrary.libTypesResponseTypesMod.BanAdd] = js.native
  /**
  ...
  def clientKick(
    clid: Double,
    reasonid: typingsSlinky.ts3DashNodejsDashLibrary.libTypesEnumMod.ReasonIdentifier,
    reasonmsg: String
  ...
  /**
    ...
    */
  def logAdd(loglevel: typingsSlinky.ts3DashNodejsDashLibrary.libTypesEnumMod.LogLevel, logmsg: String): js.Promise[js.Array[QueryResponseTypes]] = js.native
  /**
  ...
  def on_channeledit(
    ...
    listener: js.Function1[
      /* event */ typingsSlinky.ts3DashNodejsDashLibrary.libTypesEventsMod.ChannelEdit, 
      Unit
    ]
  ): this.type = js.native
  @JSName("on")
  ...
  /**
    ...
    */
  def privilegeKeyAdd(tokentype: typingsSlinky.ts3DashNodejsDashLibrary.libTypesEnumMod.TokenType, group: Double): js.Promise[Token] = js.native
  def privilegeKeyAdd(
    tokentype: typingsSlinky.ts3DashNodejsDashLibrary.libTypesEnumMod.TokenType,
    group: Double,
    cid: Double
  ...
  def sendTextMessage(
    target: Double,
    targetmode: typingsSlinky.ts3DashNodejsDashLibrary.libTypesEnumMod.TextMessageTargetMode,
    msg: String
  ): js.Promise[js.Array[QueryResponseTypes]] = js.native
  /**
    ...
    */
  def serverCreate(properties: typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.ServerEdit): js.Promise[ServerCreate] = js.native
  /**
    * deletes the server
  ...
  /**
    ...
    */
  def serverEdit(properties: typingsSlinky.ts3DashNodejsDashLibrary.libTypesPropertyTypesMod.ServerEdit): js.Promise[js.Array[QueryResponseTypes]] = js.native
