...
trait ConnectionParams extends js.Object {
  ...
  var protocol: typingsSlinky.ts3DashNodejsDashLibrary.libTypesEnumMod.QueryProtocol
...
object ConnectionParams {
  ...
  def apply(
    host: String,
    keepAlive: Boolean,
    protocol: typingsSlinky.ts3DashNodejsDashLibrary.libTypesEnumMod.QueryProtocol,
    queryport: Double,
    readyTimeout: Double,
