package typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryMod
...
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryNumbers.`false`
import typingsSlinky.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryNumbers.`true`
