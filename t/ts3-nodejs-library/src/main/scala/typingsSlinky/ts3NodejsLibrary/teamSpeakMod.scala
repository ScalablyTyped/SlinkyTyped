...
import typingsSlinky.ts3NodejsLibrary.anon.Cid
import typingsSlinky.ts3NodejsLibrary.anon.Cldbid
import typingsSlinky.ts3NodejsLibrary.anon.PartialChannelEntry
import typingsSlinky.ts3NodejsLibrary.anon.PartialChannelGroupEntry
import typingsSlinky.ts3NodejsLibrary.anon.PartialClientEntry
import typingsSlinky.ts3NodejsLibrary.anon.PartialConnectionParams
import typingsSlinky.ts3NodejsLibrary.anon.PartialServerEntry
import typingsSlinky.ts3NodejsLibrary.anon.PartialServerGroupEntry
import typingsSlinky.ts3NodejsLibrary.anon.Permid
import typingsSlinky.ts3NodejsLibrary.anon.Sgid
...
import typingsSlinky.ts3NodejsLibrary.enumMod.LogLevel
import typingsSlinky.ts3NodejsLibrary.enumMod.ReasonIdentifier
import typingsSlinky.ts3NodejsLibrary.enumMod.TextMessageTargetMode.CHANNEL
import typingsSlinky.ts3NodejsLibrary.enumMod.TextMessageTargetMode.CLIENT
import typingsSlinky.ts3NodejsLibrary.enumMod.TextMessageTargetMode.SERVER
import typingsSlinky.ts3NodejsLibrary.enumMod.TokenType.ChannelGroup
import typingsSlinky.ts3NodejsLibrary.enumMod.TokenType.ServerGroup
import typingsSlinky.ts3NodejsLibrary.eventsMod.ChannelCreate
import typingsSlinky.ts3NodejsLibrary.eventsMod.ChannelDelete
import typingsSlinky.ts3NodejsLibrary.eventsMod.ChannelMove
import typingsSlinky.ts3NodejsLibrary.eventsMod.ClientConnect
import typingsSlinky.ts3NodejsLibrary.eventsMod.ClientDisconnect
import typingsSlinky.ts3NodejsLibrary.eventsMod.ClientMoved
import typingsSlinky.ts3NodejsLibrary.eventsMod.Debug
...
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.ApiKeyList
...
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.ClientDBEdit
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.ClientEdit
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.ClientUpdate
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.InstanceEdit
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.ServerTempPasswordAdd
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.TransferDownload
import typingsSlinky.ts3NodejsLibrary.propertyTypesMod.TransferUpload
import typingsSlinky.ts3NodejsLibrary.responseErrorMod.ResponseError
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ApiKeyEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.BanEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.BindingEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ChannelClientPermIdList
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ChannelClientPermSidList
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ChannelFind
...
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ChannelInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientDBEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientDBFind
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientDBInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientFind
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientGetDbidFromUid
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientGetIdEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientGetNameFromDbid
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientGetNameFromUid
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientGetUidFromClid
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ClientSetServerQueryLogin
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ComplainEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.CustomInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.CustomSearch
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.FTGetFileEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.FTGetFileInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.FTInitDownload
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.FTInitUpload
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.FileTransferEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.HostInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.InstanceInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.LogView
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.MessageEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.MessageGet
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.PermFind
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.PermGet
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.PermIdGetByName
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.PermOverviewEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.PermissionEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.PrivilegeKeyEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.QueryLoginAdd
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.QueryLoginEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerCreate
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerGroupClientEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerGroupCopy
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerGroupsByClientId
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerIdGetByPort
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerRequestConnectionInfo
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.ServerTempPasswordEntry
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.SnapshotCreate
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.Token
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.Version
import typingsSlinky.ts3NodejsLibrary.responseTypesMod.Whoami
import typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup
...
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryBooleans.`false`
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryBooleans.`true`
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.`0`
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.channelcreate
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.channeldelete
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.channeledit
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.channelmoved
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.clientconnect
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.clientdisconnect
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.clientmoved
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.close
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.debug
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.error
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.flooding
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.ready
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.serveredit
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.textmessage
import typingsSlinky.ts3NodejsLibrary.ts3NodejsLibraryStrings.tokenused
...
object teamSpeakMod {
  ...
  class TeamSpeak protected () extends EventEmitter {
    ...
    /**
      ...
      */
    def ban(properties: BanAdd): js.Promise[typingsSlinky.ts3NodejsLibrary.responseTypesMod.BanAdd] = js.native
    ...
    /**
      ...
      */
    def banClient(properties: BanClient): js.Promise[typingsSlinky.ts3NodejsLibrary.responseTypesMod.BanAdd] = js.native
    ...
    val config: typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.ConnectionParams = js.native
    ...
    /**
      ...
      */
    def getServerGroupById(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.UndefOr[TeamSpeakServerGroup]] = js.native
    ...
    def on_channeledit(
      event: channeledit,
      listener: js.Function1[/* event */ typingsSlinky.ts3NodejsLibrary.eventsMod.ChannelEdit, Unit]
    ): this.type = js.native
    @JSName("on")
    ...
    def privilegeKeyAdd(
      ...
      group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType
    ): js.Any = js.native
    def privilegeKeyAdd(
      tokentype: ServerGroup,
      group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType,
    ...
    /**
      ...
      */
    def serverCreate(properties: typingsSlinky.ts3NodejsLibrary.propertyTypesMod.ServerEdit): js.Promise[ServerCreate] = js.native
    ...
    /**
      ...
      */
    def serverEdit(properties: typingsSlinky.ts3NodejsLibrary.propertyTypesMod.ServerEdit): js.Promise[js.Array[js.Any]] = js.native
    ...
    /**
      ...
      * @param group the servergroup id
      */
    def serverGroupClientList(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.Array[ServerGroupClientEntry]] = js.native
    ...
    /**
      ...
      */
    def serverGroupCopy(sourceGroup: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[ServerGroupCopy] = js.native
    def serverGroupCopy(
      sourceGroup: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType,
      targetGroup: js.UndefOr[typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType],
      `type`: js.UndefOr[scala.Nothing],
      name: String
    ...
    def serverGroupCopy(
      sourceGroup: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType,
      targetGroup: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType
    ): js.Promise[ServerGroupCopy] = js.native
    ...
    /**
      ...
      */
    def serverGroupDel(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.Array[js.Any]] = js.native
    def serverGroupDel(
      group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType,
      force: Boolean
    ): js.Promise[js.Array[js.Any]] = js.native
    ...
    /**
      ...
      * @param perm the permid or permsid
      */
    def serverGroupDelPerm(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType, perm: String): js.Promise[js.Array[js.Any]] = js.native
    def serverGroupDelPerm(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType, perm: Double): js.Promise[js.Array[js.Any]] = js.native
    ...
    /**
      ...
      * @param permsid if the permsid option is set to true the output will contain the permission names
      */
    def serverGroupPermList(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.Array[Permission[Sgid]]] = js.native
    ...
    /**
      ...
      * @param tokencustomset token custom set
      */
    def serverGroupPrivilegeKeyAdd(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[Token] = js.native
    ...
    /**
      ...
      */
    def serverGroupRename(group: typingsSlinky.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup.GroupType, name: String): js.Promise[js.Array[js.Any]] = js.native
  ...
  object TeamSpeak {
    ...
    object QueryProtocol extends StObject {
      ...
      @js.native
      sealed trait RAW
        extends typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.QueryProtocol
    ...
    trait ConnectionParams extends StObject {
      ...
      var protocol: typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.QueryProtocol = js.native
    ...
    object ConnectionParams {
      ...
      def apply(
        ...
        protocol: typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.QueryProtocol,
        queryport: Double,
        readyTimeout: Double
      ): typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.ConnectionParams = {
        ...
        __obj.asInstanceOf[typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.ConnectionParams]
      }
      
      @scala.inline
      implicit class ConnectionParamsMutableBuilder[Self <: typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.ConnectionParams] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setProtocol(value: typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.QueryProtocol): Self = StObject.set(x, "protocol", value.asInstanceOf[js.Any])
  ...
  type ConnectionParams = typingsSlinky.ts3NodejsLibrary.teamSpeakMod.TeamSpeak.ConnectionParams
}
