...
object PartialQueryResponseTypes {
  ...
  def apply(
    ...
    virtualserver_client_connections: Int | Double = null,
    ...
    if (virtualserver_client_connections != null) __obj.updateDynamic("virtualserver_client_connections")(virtualserver_client_connections.asInstanceOf[js.Any])
