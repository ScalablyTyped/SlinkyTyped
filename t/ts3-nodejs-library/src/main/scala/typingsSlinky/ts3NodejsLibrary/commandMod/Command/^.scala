...
import typingsSlinky.ts3NodejsLibrary.anon.PartialPartialQueryRespon
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def buildSnapshotDeploy(data: String, cmd: typingsSlinky.ts3NodejsLibrary.commandMod.Command): String = js.native
  /** escapes a string */
