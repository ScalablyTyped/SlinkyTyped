...
object contextMod {
  ...
  object SelectType extends StObject {
    ...
    /* 0 */ val NONE: typingsSlinky.ts3NodejsLibrary.contextMod.SelectType.NONE with Double = js.native
    
    @js.native
    sealed trait PORT extends SelectType
    /* 2 */ val PORT: typingsSlinky.ts3NodejsLibrary.contextMod.SelectType.PORT with Double = js.native
    
    @js.native
    sealed trait SID extends SelectType
    /* 1 */ val SID: typingsSlinky.ts3NodejsLibrary.contextMod.SelectType.SID with Double = js.native
  }
  ...
  */
  ...
  object Context {
    ...
    @scala.inline
    def SelectNoneContext(events: js.Array[ActiveEvent], selectType: NONE, selected: `0`): typingsSlinky.ts3NodejsLibrary.contextMod.SelectNoneContext = {
      ...
      __obj.asInstanceOf[typingsSlinky.ts3NodejsLibrary.contextMod.SelectNoneContext]
    }
    
    @scala.inline
    def SelectPortContext(events: js.Array[ActiveEvent], selectType: PORT, selected: Double): typingsSlinky.ts3NodejsLibrary.contextMod.SelectPortContext = {
      val __obj = js.Dynamic.literal(events = events.asInstanceOf[js.Any], selectType = selectType.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.ts3NodejsLibrary.contextMod.SelectPortContext]
    }
    
    @scala.inline
    def SelectSidContext(events: js.Array[ActiveEvent], selectType: SID, selected: String): typingsSlinky.ts3NodejsLibrary.contextMod.SelectSidContext = {
      val __obj = js.Dynamic.literal(events = events.asInstanceOf[js.Any], selectType = selectType.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.ts3NodejsLibrary.contextMod.SelectSidContext]
    }
  }
