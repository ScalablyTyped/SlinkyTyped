...
object abstractMod extends js.Object {
  ...
  abstract class Abstract protected () extends js.Object {
    ...
    /**
      ...
      */
    def getPropertyByName[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 319 */ js.Any */](name: T): /* import warning: importer.ImportType#apply Failed type conversion: ts3-nodejs-library.ts3-nodejs-library/lib/types/QueryResponse.QueryResponse[T] */ js.Any = js.native
