...
import typingsSlinky.ts3NodejsLibrary.anon.PartialPermType
import typingsSlinky.ts3NodejsLibrary.permissionMod.Permission.IConfig
import typingsSlinky.ts3NodejsLibrary.permissionMod.Permission.PermId
import typingsSlinky.ts3NodejsLibrary.permissionMod.Permission.PermSid
