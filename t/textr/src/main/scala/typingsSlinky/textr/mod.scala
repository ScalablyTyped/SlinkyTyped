...
object mod {
  ...
  @js.native
  def apply(): typingsSlinky.textr.mod.textr = js.native
  @JSImport("textr", JSImport.Namespace)
  @js.native
  def apply(defaults: TextrArgs): typingsSlinky.textr.mod.textr = js.native
  ...
  trait textr extends StObject {
    ...
    ): typingsSlinky.textr.mod.textr = js.native
  }
}
