...
object waitForMod {
  ...
  trait waitForOptions extends StObject {
    ...
    var onTimeout: js.UndefOr[js.Function1[/* error */ js.Error, js.Error]] = js.native
  ...
  object waitForOptions {
    ...
    implicit class waitForOptionsMutableBuilder[Self <: waitForOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnTimeout(value: /* error */ js.Error => js.Error): Self = StObject.set(x, "onTimeout", js.Any.fromFunction1(value))
