package typingsSlinky.twitterDashStreamDashChannels.twitterDashStreamDashChannelsMod

import typingsSlinky.node.NodeJS.EventEmitter
import typingsSlinky.twitterDashStreamDashChannels.Anon_RemoveAllListeners
import typingsSlinky.twitterDashStreamDashChannels.twitterDashStreamDashChannelsMod.StreamChannels.Channels
import typingsSlinky.twitterDashStreamDashChannels.twitterDashStreamDashChannelsMod.StreamChannels.StreamChannelsOptions
...
class StreamChannels_ protected () extends EventEmitter {
  /**
    ...
    */
  def this(apiClient: typingsSlinky.twit.twitMod.^, options: StreamChannelsOptions) = this()
  /**
