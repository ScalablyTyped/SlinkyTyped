...
object mod {
  ...
  @js.native
  def cat[TResult, TInput](xf: Transformer[TResult, TInput]): Transformer[TResult, js.Iterable[TInput]] = js.native
  ...
  @js.native
  def into[TInput](empty: String, xf: Transducer[TInput, String], coll: js.Iterable[TInput]): String = js.native
  @JSImport("transducers-js", "into")
  @js.native
  def into[TInput](empty: String, xf: Transducer[js.Tuple2[String, TInput], String], coll: StringDictionary[TInput]): String = js.native
  @JSImport("transducers-js", "into")
  @js.native
  def into[TInput, TOutput](empty: js.Array[TOutput], xf: Transducer[TInput, TOutput], coll: js.Iterable[TInput]): js.Array[TOutput] = js.native
  @JSImport("transducers-js", "into")
  @js.native
  ...
  @js.native
  def mapcat[TResult, TInput, TOutput](f: js.Function1[/* arr */ TInput, js.Iterable[TOutput]]): Transducer[TInput, TOutput] = js.native
  ...
  @js.native
  def reduce[TResult, TInput](xf: Reducer[TResult, TInput], init: TResult, coll: js.Iterable[TInput]): TResult = js.native
  @JSImport("transducers-js", "reduce")
  @js.native
  ...
  @JSImport("transducers-js", "reduce")
  @js.native
  def reduce[TResult, TInput](xf: Transformer[TResult, TInput], init: TResult, coll: js.Iterable[TInput]): TResult = js.native
  @JSImport("transducers-js", "reduce")
  @js.native
