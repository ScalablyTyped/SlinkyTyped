...
object PackOptions {
  ...
  implicit class PackOptionsOps[Self <: PackOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFinish(value: /* pack */ typingsSlinky.tarStream.mod.Pack_ => Unit): Self = this.set("finish", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteFinish: Self = this.set("finish", js.undefined)
    
    @scala.inline
    def setPack(value: typingsSlinky.tarStream.mod.Pack_): Self = this.set("pack", value.asInstanceOf[js.Any])
