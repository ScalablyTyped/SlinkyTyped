...
import typingsSlinky.tarDashFs.tarDashFsStrings.directory
import typingsSlinky.tarDashFs.tarDashFsStrings.file
import typingsSlinky.tarDashFs.tarDashFsStrings.link
import typingsSlinky.tarDashFs.tarDashFsStrings.symlink
