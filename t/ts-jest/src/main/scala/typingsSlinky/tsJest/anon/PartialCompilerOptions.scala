...
import typingsSlinky.typescript.mod.ImportsNotUsedAsValues
import typingsSlinky.typescript.mod.JsxEmit
...
import typingsSlinky.typescript.mod.NewLineKind
...
@js.native
trait PartialCompilerOptions extends js.Object {
  ...
  var jsxFragmentFactory: js.UndefOr[String] = js.native
  
  var jsxImportSource: js.UndefOr[String] = js.native
  ...
  var tsBuildInfoFile: js.UndefOr[String] = js.native
...
object PartialCompilerOptions {
  ...
  @scala.inline
  def apply(): PartialCompilerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCompilerOptions]
  }
  
  @scala.inline
  implicit class PartialCompilerOptionsOps[Self <: PartialCompilerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJsxFragmentFactory(value: String): Self = this.set("jsxFragmentFactory", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteJsxFragmentFactory: Self = this.set("jsxFragmentFactory", js.undefined)
    
    @scala.inline
    def setJsxImportSource(value: String): Self = this.set("jsxImportSource", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTsBuildInfoFile(value: String): Self = this.set("tsBuildInfoFile", value.asInstanceOf[js.Any])
