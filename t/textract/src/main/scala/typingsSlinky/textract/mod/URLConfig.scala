...
object URLConfig {
  ...
  implicit class URLConfigOps[Self <: URLConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTypeOverride(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("typeOverride")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTypeOverride: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("typeOverride")(js.undefined)
        ret
    }
  }
