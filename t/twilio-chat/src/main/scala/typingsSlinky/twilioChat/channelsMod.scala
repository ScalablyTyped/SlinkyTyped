...
import typingsSlinky.twilioChat.channelMod.ChannelDescriptor
import typingsSlinky.twilioChat.channelMod.ChannelServices
...
object channelsMod {
  ...
  class Channel protected ()
    extends typingsSlinky.twilioChat.channelMod.Channel {
    /**
  ...
  class Channels protected () extends EventEmitter {
    ...
    def pushChannel(descriptor: typingsSlinky.twilioChat.channeldescriptorMod.ChannelDescriptor): js.Promise[typingsSlinky.twilioChat.channelMod.Channel] = js.native
  ...
  object Channels {
    ...
    */
    ...
    object DataSource {
      ...
      @scala.inline
      def sync: typingsSlinky.twilioChat.twilioChatStrings.sync = "sync".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.sync]
      
      @scala.inline
      def synclist: typingsSlinky.twilioChat.twilioChatStrings.synclist = "synclist".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.synclist]
    }
  }
