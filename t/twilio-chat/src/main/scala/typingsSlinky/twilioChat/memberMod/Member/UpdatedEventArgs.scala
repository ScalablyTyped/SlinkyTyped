...
trait UpdatedEventArgs extends js.Object {
  var member: typingsSlinky.twilioChat.memberMod.Member = js.native
  var updateReasons: js.Array[UpdateReason] = js.native
}

object UpdatedEventArgs {
  @scala.inline
  def apply(member: typingsSlinky.twilioChat.memberMod.Member, updateReasons: js.Array[UpdateReason]): UpdatedEventArgs = {
  ...
  implicit class UpdatedEventArgsOps[Self <: UpdatedEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMember(value: typingsSlinky.twilioChat.memberMod.Member): Self = this.set("member", value.asInstanceOf[js.Any])
    @scala.inline
