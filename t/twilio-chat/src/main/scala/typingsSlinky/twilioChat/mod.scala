...
import typingsSlinky.twilioChat.channelsMod.Channel
import typingsSlinky.twilioChat.mod.Client.ChannelSortingOptions
import typingsSlinky.twilioChat.mod.Client.ConnectionState
import typingsSlinky.twilioChat.mod.Client.CreateChannelOptions
import typingsSlinky.twilioChat.mod.Client.NotificationsChannelType
import typingsSlinky.twilioChat.mod.Client.Options
import typingsSlinky.twilioChat.paginatorMod.Paginator
import typingsSlinky.twilioChat.pushnotificationMod.PushNotification.Descriptor
...
object mod {
  ...
  class Client protected () extends EventEmitter {
    ...
    /**
      ...
      */
    def getSubscribedUsers(): js.Promise[js.Array[typingsSlinky.twilioChat.userMod.User]] = js.native
    ...
    /**
      ...
      */
    def getUser(identity: String): js.Promise[typingsSlinky.twilioChat.userMod.User] = js.native
    ...
    var parsePushNotification_Original: js.Function1[
        ...
        typingsSlinky.twilioChat.pushnotificationMod.PushNotification
      ] = js.native
    ...
    def user: typingsSlinky.twilioChat.userMod.User = js.native
  ...
  object Client {
    ...
    */
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.twilioChat.twilioChatStrings.ascending
      - typingsSlinky.twilioChat.twilioChatStrings.descending
    */
    trait ChannelSortingOrder extends StObject
    object ChannelSortingOrder {
      
      @scala.inline
      def ascending: typingsSlinky.twilioChat.twilioChatStrings.ascending = "ascending".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.ascending]
      
      @scala.inline
      def descending: typingsSlinky.twilioChat.twilioChatStrings.descending = "descending".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.descending]
    }
  ...
  class PushNotification protected ()
    extends typingsSlinky.twilioChat.pushnotificationMod.PushNotification {
    /**
