...
import typingsSlinky.twilioChat.anon.Current
  ...
  object Channel {
    ...
    */
    ...
    object NotificationLevel {
      ...
      @scala.inline
      def default: typingsSlinky.twilioChat.twilioChatStrings.default = "default".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.default]
      
      @scala.inline
      def muted: typingsSlinky.twilioChat.twilioChatStrings.muted = "muted".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.muted]
    }
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsSlinky.twilioChat.twilioChatStrings.notParticipating
    ...
    */
    ...
    object Type {
      ...
      @scala.inline
      def `private`: typingsSlinky.twilioChat.twilioChatStrings.`private` = "private".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.`private`]
      
      @scala.inline
      def public: typingsSlinky.twilioChat.twilioChatStrings.public = "public".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.public]
    }
    
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.twilioChat.twilioChatStrings.attributes
      - typingsSlinky.twilioChat.twilioChatStrings.createdBy
      ...
      - typingsSlinky.twilioChat.twilioChatStrings.notificationLevel
    */
    ...
    object UpdateReason {
      ...
      @scala.inline
      def createdBy: typingsSlinky.twilioChat.twilioChatStrings.createdBy = "createdBy".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.createdBy]
