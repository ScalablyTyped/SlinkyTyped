...
import typingsSlinky.twilioChat.pushnotificationMod.PushNotification.Type
  ...
  object PushNotification {
    ...
    */
    ...
    object Type {
      ...
      @scala.inline
      def twilioDotchannelDotadded_to_channel: typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotadded_to_channel = "twilio.channel.added_to_channel".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotadded_to_channel]
      
      @scala.inline
      def twilioDotchannelDotinvited_to_channel: typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotinvited_to_channel = "twilio.channel.invited_to_channel".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotinvited_to_channel]
      
      @scala.inline
      def twilioDotchannelDotnew_message: typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotnew_message = "twilio.channel.new_message".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotnew_message]
      
      @scala.inline
      def twilioDotchannelDotremoved_from_channel: typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotremoved_from_channel = "twilio.channel.removed_from_channel".asInstanceOf[typingsSlinky.twilioChat.twilioChatStrings.twilioDotchannelDotremoved_from_channel]
    }
  }
}
