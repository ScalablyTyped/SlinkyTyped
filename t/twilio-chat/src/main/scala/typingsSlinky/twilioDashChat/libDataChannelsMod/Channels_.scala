...
import typingsSlinky.twilioDashChat.libUtilDeferredMod.Deferred
...
class Channels_ protected () extends EventEmitter {
  ...
  val channels: Map[String, typingsSlinky.twilioDashChat.libChannelMod.Channel] = js.native
  ...
  /**
    ...
    */
  def addChannel(options: js.Any): js.Promise[typingsSlinky.twilioDashChat.libChannelMod.Channel] = js.native
  /**
    * Fetch channels list and instantiate all necessary objects
    */
  def fetchChannels(): Unit = js.native
  def getChannel(sid: String): js.Promise[typingsSlinky.twilioDashChat.libChannelMod.Channel] = js.native
  def getChannels(args: js.Any): js.Promise[_] = js.native
  def pushChannel(descriptor: ChannelDescriptor): js.Promise[typingsSlinky.twilioDashChat.libChannelMod.Channel] = js.native
}
