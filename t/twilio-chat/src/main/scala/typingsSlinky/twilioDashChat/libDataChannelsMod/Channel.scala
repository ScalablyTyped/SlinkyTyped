...
import typingsSlinky.twilioDashChat.libChannelMod.ChannelDescriptor
import typingsSlinky.twilioDashChat.libChannelMod.ChannelServices
...
class Channel protected ()
  extends typingsSlinky.twilioDashChat.libChannelMod.Channel {
  /**
