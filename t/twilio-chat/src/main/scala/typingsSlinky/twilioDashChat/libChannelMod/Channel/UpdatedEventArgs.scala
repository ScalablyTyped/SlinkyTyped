...
trait UpdatedEventArgs extends js.Object {
  var channel: typingsSlinky.twilioDashChat.libChannelMod.Channel
  var updateReasons: js.Array[UpdateReason]
}

object UpdatedEventArgs {
  @scala.inline
  def apply(channel: typingsSlinky.twilioDashChat.libChannelMod.Channel, updateReasons: js.Array[UpdateReason]): UpdatedEventArgs = {
