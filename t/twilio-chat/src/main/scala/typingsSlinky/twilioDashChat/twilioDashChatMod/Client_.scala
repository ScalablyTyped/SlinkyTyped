...
import typingsSlinky.twilioDashChat.libDataChannelsMod.Channel
...
import typingsSlinky.twilioDashChat.twilioDashChatMod.Client.ChannelSortingOptions
import typingsSlinky.twilioDashChat.twilioDashChatMod.Client.ConnectionState
import typingsSlinky.twilioDashChat.twilioDashChatMod.Client.CreateChannelOptions
import typingsSlinky.twilioDashChat.twilioDashChatMod.Client.NotificationsChannelType
...
class Client_ protected () extends EventEmitter {
  ...
  /**
    ...
    */
  def getSubscribedUsers(): js.Promise[js.Array[typingsSlinky.twilioDashChat.libUserMod.User]] = js.native
  /**
    ...
    */
  def getUser(identity: String): js.Promise[typingsSlinky.twilioDashChat.libUserMod.User] = js.native
  /**
  ...
  def user(): typingsSlinky.twilioDashChat.libUserMod.User = js.native
}
