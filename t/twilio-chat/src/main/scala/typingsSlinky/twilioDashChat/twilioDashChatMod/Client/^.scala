...
import typingsSlinky.twilioDashChat.libPushnotificationMod.PushNotification
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def create(token: String): js.Promise[typingsSlinky.twilioDashChat.twilioDashChatMod.Client] = js.native
  def create(token: String, options: Options): js.Promise[typingsSlinky.twilioDashChat.twilioDashChatMod.Client] = js.native
  /**
