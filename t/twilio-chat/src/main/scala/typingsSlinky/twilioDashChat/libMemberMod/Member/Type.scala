...
object Type {
  ...
  @scala.inline
  def sms: typingsSlinky.twilioDashChat.twilioDashChatStrings.sms = this.cast("sms")
  @scala.inline
  def whatsapp: typingsSlinky.twilioDashChat.twilioDashChatStrings.whatsapp = this.cast("whatsapp")
}
