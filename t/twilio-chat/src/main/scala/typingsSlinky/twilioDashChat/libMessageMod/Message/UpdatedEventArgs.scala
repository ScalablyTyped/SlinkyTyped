...
trait UpdatedEventArgs extends js.Object {
  var message: typingsSlinky.twilioDashChat.libMessageMod.Message
  var updateReasons: js.Array[UpdateReason]
}

object UpdatedEventArgs {
  @scala.inline
  def apply(message: typingsSlinky.twilioDashChat.libMessageMod.Message, updateReasons: js.Array[UpdateReason]): UpdatedEventArgs = {
