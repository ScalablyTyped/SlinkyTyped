...
import typingsSlinky.twilioDashChat.libMessageMod.Message.UpdateReason
...
object twilioDashChatStrings {
  ...
  sealed trait attributes
    extends UpdateReason
       ...
       with typingsSlinky.twilioDashChat.libUserMod.User.UpdateReason
  ...
  sealed trait notifiable
    extends typingsSlinky.twilioDashChat.libUserMod.User.UpdateReason
