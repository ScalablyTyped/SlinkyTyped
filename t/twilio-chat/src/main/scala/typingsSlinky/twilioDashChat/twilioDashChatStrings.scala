package typingsSlinky.twilioDashChat

import typingsSlinky.twilioDashChat.libChannelMod.Channel.NotificationLevel
import typingsSlinky.twilioDashChat.libChannelMod.Channel.Status
import typingsSlinky.twilioDashChat.libDataChannelsMod.Channels.DataSource
import typingsSlinky.twilioDashChat.libMemberMod.Member.Type
import typingsSlinky.twilioDashChat.libUserMod.User.SubscriptionState
import typingsSlinky.twilioDashChat.libUserMod.User.UpdateReason
import typingsSlinky.twilioDashChat.twilioDashChatMod.Client.ChannelSortingCriteria
import typingsSlinky.twilioDashChat.twilioDashChatMod.Client.ChannelSortingOrder
import typingsSlinky.twilioDashChat.twilioDashChatMod.Client._LogLevel
...
object twilioDashChatStrings {
  ...
  sealed trait attributes
    extends UpdateReason
       with typingsSlinky.twilioDashChat.libMemberMod.Member.UpdateReason
       with typingsSlinky.twilioDashChat.libChannelMod.Channel.UpdateReason
       with typingsSlinky.twilioDashChat.libMessageMod.Message.UpdateReason
  
  @js.native
  sealed trait author
    extends typingsSlinky.twilioDashChat.libMessageMod.Message.UpdateReason
  ...
  sealed trait createdBy
    extends typingsSlinky.twilioDashChat.libChannelMod.Channel.UpdateReason
  
  @js.native
  sealed trait dateCreated
    extends typingsSlinky.twilioDashChat.libMemberMod.Member.UpdateReason
       with typingsSlinky.twilioDashChat.libChannelMod.Channel.UpdateReason
  ...
  @js.native
  sealed trait media
    extends typingsSlinky.twilioDashChat.libMessageMod.Message.Type
  ...
  sealed trait `private`
    extends typingsSlinky.twilioDashChat.libChannelMod.Channel.Type
  ...
  sealed trait twilioDOTchannelDOTadded_to_channel
    extends typingsSlinky.twilioDashChat.libPushnotificationMod.PushNotification.Type
