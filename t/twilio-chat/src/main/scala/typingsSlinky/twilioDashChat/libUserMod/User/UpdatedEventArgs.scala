...
trait UpdatedEventArgs extends js.Object {
  ...
  var user: typingsSlinky.twilioDashChat.libUserMod.User
}

object UpdatedEventArgs {
  @scala.inline
  def apply(updateReasons: js.Array[UpdateReason], user: typingsSlinky.twilioDashChat.libUserMod.User): UpdatedEventArgs = {
