...
object IntrospectionSchema {
  ...
  implicit class IntrospectionSchemaOps[Self <: IntrospectionSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQueryType(value: IntrospectionNamedTypeRef): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMutationType(value: IntrospectionNamedTypeRef): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSubscriptionType(value: IntrospectionNamedTypeRef): Self = {
        val ret = this.duplicate
