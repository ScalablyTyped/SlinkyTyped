...
object ValidationContext {
  ...
  implicit class ValidationContextMutableBuilder[Self <: ValidationContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetErrors(value: () => js.Array[js.Error]): Self = StObject.set(x, "getErrors", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setReportError(value: js.Error => Unit): Self = StObject.set(x, "reportError", js.Any.fromFunction1(value))
  }
}
