...
import typingsSlinky.vueTestUtils.mod.ThisTypedMountOptions
...
object mod {
  ...
  trait VueFireObject extends AsyncFireObject {
    ...
    def apply(element: Document, event: org.scalajs.dom.raw.Event): js.Promise[Unit] = js.native
    def apply(element: Element, event: org.scalajs.dom.raw.Event): js.Promise[Unit] = js.native
    def apply(element: Window, event: org.scalajs.dom.raw.Event): js.Promise[Unit] = js.native
