...
import typingsSlinky.testingLibraryVue.testingLibraryVueBooleans.`false`
...
import typingsSlinky.vue.optionsMod.InjectOptions
import typingsSlinky.vue.optionsMod.PropsDefinition
import typingsSlinky.vue.optionsMod.RenderContext
import typingsSlinky.vue.optionsMod.WatchHandler
import typingsSlinky.vue.optionsMod.WatchOptionsWithHandler
...
import typingsSlinky.vueTestUtils.mod.Slots
import typingsSlinky.vueTestUtils.mod.Stubs
...
trait RenderOptions[V /* <: Vue */, S] extends js.Object {
  ...
  var renderError: js.UndefOr[js.Function2[/* createElement */ CreateElement, /* err */ js.Error, VNode]] = js.native
...
object RenderOptions {
  ...
  implicit class RenderOptionsOps[Self <: RenderOptions[_, _], V /* <: Vue */, S] (val x: Self with (RenderOptions[V, S])) extends AnyVal {
    ...
    @scala.inline
    def setAttachToElement(value: Element): Self = this.set("attachTo", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setErrorCaptured(value: (/* err */ js.Error, /* vm */ Vue, /* info */ String) => Boolean | Unit): Self = this.set("errorCaptured", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setRenderError(value: (/* createElement */ CreateElement, /* err */ js.Error) => VNode): Self = this.set("renderError", js.Any.fromFunction2(value))
