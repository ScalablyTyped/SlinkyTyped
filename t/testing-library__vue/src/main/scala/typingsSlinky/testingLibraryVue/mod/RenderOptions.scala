...
object RenderOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.vue.vueMod.Vue */ V, S](): RenderOptions[V, S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RenderOptions[V, S]]
  }
  @scala.inline
  implicit class RenderOptionsOps[Self <: RenderOptions[_, _], /* <: typingsSlinky.vue.vueMod.Vue */ V, S] (val x: Self with (RenderOptions[V, S])) extends AnyVal {
    @scala.inline
