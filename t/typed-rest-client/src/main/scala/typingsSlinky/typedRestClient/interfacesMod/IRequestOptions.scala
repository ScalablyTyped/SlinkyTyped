...
object IRequestOptions {
  ...
  implicit class IRequestOptionsOps[Self <: IRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPresignedUrlPatternsVarargs(value: js.RegExp*): Self = this.set("presignedUrlPatterns", js.Array(value :_*))
    @scala.inline
    def setPresignedUrlPatterns(value: js.Array[js.RegExp]): Self = this.set("presignedUrlPatterns", value.asInstanceOf[js.Any])
    @scala.inline
