...
object interfacesMod {
  ...
  object IRequestOptions {
    ...
    implicit class IRequestOptionsMutableBuilder[Self <: IRequestOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPresignedUrlPatterns(value: js.Array[js.RegExp]): Self = StObject.set(x, "presignedUrlPatterns", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPresignedUrlPatternsUndefined: Self = StObject.set(x, "presignedUrlPatterns", js.undefined)
      
      @scala.inline
      def setPresignedUrlPatternsVarargs(value: js.RegExp*): Self = StObject.set(x, "presignedUrlPatterns", js.Array(value :_*))
