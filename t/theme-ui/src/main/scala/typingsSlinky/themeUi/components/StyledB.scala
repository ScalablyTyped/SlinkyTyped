...
object StyledB {
  ...
  implicit def make(companion: StyledB.type): `SharedBuilder_<intersection>_1296358154`[LegacyRef[js.Any] with js.Object] = new `SharedBuilder_<intersection>_1296358154`[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
