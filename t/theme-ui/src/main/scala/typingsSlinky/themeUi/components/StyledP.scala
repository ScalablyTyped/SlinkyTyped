...
object StyledP
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLParagraphElement, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLParagraphElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLParagraphElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLParagraphElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLParagraphElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLParagraphElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLParagraphElement, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLParagraphElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLParagraphElement, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLParagraphElement] => Unit = null,
  ...
  type Props = (DetailedHTMLProps[HTMLAttributes[HTMLParagraphElement], HTMLParagraphElement]) with SxProps with AnonAs
}
