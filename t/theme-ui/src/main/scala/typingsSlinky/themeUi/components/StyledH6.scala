...
object StyledH6 {
  ...
  implicit def make(companion: StyledH6.type): `SharedBuilder_<intersection>_93340326`[LegacyRef[js.Any] with js.Object] = new `SharedBuilder_<intersection>_93340326`[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
