...
object StyledH6 {
  ...
  implicit def make(companion: StyledH6.type): `SharedBuilder_<intersection>1112162328`[LegacyRef[js.Any]] = new `SharedBuilder_<intersection>1112162328`[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
