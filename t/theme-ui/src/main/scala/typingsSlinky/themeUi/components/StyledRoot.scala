...
object StyledRoot {
  ...
  implicit def make(companion: StyledRoot.type): SharedBuilder_DetailedHTMLPropsSxPropsAs_1810236765[LegacyRef[js.Any] with js.Object] = new SharedBuilder_DetailedHTMLPropsSxPropsAs_1810236765[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
