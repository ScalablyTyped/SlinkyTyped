...
object StyledRoot {
  ...
  implicit def make(companion: StyledRoot.type): `SharedBuilder_<intersection>_1810236765`[LegacyRef[js.Any]] = new `SharedBuilder_<intersection>_1810236765`[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
