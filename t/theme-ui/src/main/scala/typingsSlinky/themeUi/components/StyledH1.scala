...
object StyledH1 {
  ...
  implicit def make(companion: StyledH1.type): `SharedBuilder_<intersection>1112162328`[LegacyRef[js.Any]] = new `SharedBuilder_<intersection>1112162328`[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
