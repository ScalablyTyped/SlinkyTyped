...
abstract class `SharedApply_<intersection>_295721111` (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = (DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]) with SxProps with AnonAs
}
