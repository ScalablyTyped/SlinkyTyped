...
object StyledTable {
  ...
  def withProps(
    p: (DetailedHTMLProps[TableHTMLAttributes[HTMLTableElement], HTMLTableElement]) with SxProps with AnonAs
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: StyledTable.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
