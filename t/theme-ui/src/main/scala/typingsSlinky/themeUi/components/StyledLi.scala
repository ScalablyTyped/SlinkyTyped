...
object StyledLi {
  ...
  def withProps(p: (DetailedHTMLProps[LiHTMLAttributes[HTMLLIElement], HTMLLIElement]) with SxProps with AnonAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: StyledLi.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
