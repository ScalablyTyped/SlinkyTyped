...
object StyledLi {
  ...
  def withProps(p: (DetailedHTMLProps[LiHTMLAttributes[HTMLLIElement], HTMLLIElement]) with SxProps with As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
