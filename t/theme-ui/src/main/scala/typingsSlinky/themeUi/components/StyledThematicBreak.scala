...
object StyledThematicBreak {
  ...
  implicit def make(companion: StyledThematicBreak.type): `SharedBuilder_<intersection>_1810236765`[LegacyRef[js.Any]] = new `SharedBuilder_<intersection>_1810236765`[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
