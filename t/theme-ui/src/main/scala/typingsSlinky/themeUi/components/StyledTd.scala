...
object StyledTd
  ...
  /* The following DOM/SVG props were specified: key */
  def apply(
    abbr: String = null,
    about: String = null,
  ...
  type Props = (DetailedHTMLProps[TdHTMLAttributes[HTMLTableDataCellElement], HTMLTableDataCellElement]) with SxProps with AnonAs
}
