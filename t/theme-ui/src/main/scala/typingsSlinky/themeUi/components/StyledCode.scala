...
object StyledCode {
  ...
  implicit def make(companion: StyledCode.type): SharedBuilder_DetailedHTMLPropsSxPropsAs1849220441[LegacyRef[js.Any] with js.Object] = new SharedBuilder_DetailedHTMLPropsSxPropsAs1849220441[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
