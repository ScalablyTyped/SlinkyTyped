...
object StyledCode {
  ...
  implicit def make(companion: StyledCode.type): `SharedBuilder_<intersection>1849220441`[LegacyRef[js.Any]] = new `SharedBuilder_<intersection>1849220441`[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
