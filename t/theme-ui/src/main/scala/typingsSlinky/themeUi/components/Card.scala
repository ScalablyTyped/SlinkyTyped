...
object Card {
  ...
  def apply(p: PropsWithoutRef[CardProps] with RefAttributes[HTMLDivElement]): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @JSImport("theme-ui", "Card")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Card.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
