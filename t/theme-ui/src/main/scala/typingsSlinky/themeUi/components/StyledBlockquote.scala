...
object StyledBlockquote {
  ...
  def withProps(p: (DetailedHTMLProps[BlockquoteHTMLAttributes[HTMLElement], HTMLElement]) with SxProps with As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
