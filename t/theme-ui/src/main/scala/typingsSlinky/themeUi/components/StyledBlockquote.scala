...
object StyledBlockquote {
  ...
  def withProps(
    p: (DetailedHTMLProps[BlockquoteHTMLAttributes[HTMLElement], HTMLElement]) with SxProps with AnonAs
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: StyledBlockquote.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
