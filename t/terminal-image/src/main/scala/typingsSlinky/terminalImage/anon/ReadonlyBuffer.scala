package typingsSlinky.terminalImage.anon
...
object ReadonlyBuffer {
  ...
  def apply(
    ...
    equals: js.typedarray.Uint8Array => Boolean,
  ...
  implicit class ReadonlyBufferOps[Self <: ReadonlyBuffer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBufferArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("buffer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCompare(value: js.typedarray.Uint8Array => Double): Self = this.set("compare", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCopy(value: js.typedarray.Uint8Array => Double): Self = this.set("copy", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setEquals(value: js.typedarray.Uint8Array => Boolean): Self = this.set("equals", js.Any.fromFunction1(value))
