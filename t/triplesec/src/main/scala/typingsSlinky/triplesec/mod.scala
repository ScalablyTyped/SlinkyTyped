package typingsSlinky.triplesec
...
object mod {
  ...
  @js.native
  def decrypt(arg: Arguments, cb: js.Function2[/* err */ js.Error | Null, /* buff */ Buffer | Null, Unit]): Unit = js.native
  
  @JSImport("triplesec", "encrypt")
  @js.native
  def encrypt(arg: Arguments, cb: js.Function2[/* err */ js.Error | Null, /* buff */ Buffer | Null, Unit]): Unit = js.native
