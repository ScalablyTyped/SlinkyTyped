package typingsSlinky.tileDashReduce

import typingsSlinky.tileDashReduce.TileReduce.Tile
import typingsSlinky.tileDashReduce.tileDashReduceStrings.end
import typingsSlinky.tileDashReduce.tileDashReduceStrings.map
import typingsSlinky.tileDashReduce.tileDashReduceStrings.reduce
import typingsSlinky.tileDashReduce.tileDashReduceStrings.start
