...
import typingsSlinky.tempy.anon.Call
import typingsSlinky.tempy.anon.CallTask
import typingsSlinky.tempy.anon.Extension
import typingsSlinky.tempy.anon.Name
import typingsSlinky.tempy.anon.Task
...
object mod {
  ...
  @JSImport("tempy", "write")
  @js.native
  def write(fileContent: js.typedarray.DataView): js.Promise[String] = js.native
  @JSImport("tempy", "write")
  @js.native
  ...
  @JSImport("tempy", "writeSync")
  @js.native
  def writeSync(fileContent: js.typedarray.DataView): String = js.native
  @JSImport("tempy", "writeSync")
  @js.native
  def writeSync(fileContent: js.typedarray.DataView, options: FileOptions): String = js.native
  @JSImport("tempy", "writeSync")
  @js.native
