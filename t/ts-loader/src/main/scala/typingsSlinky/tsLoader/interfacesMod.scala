...
import typingsSlinky.tsLoader.anon.OutputFileName
import typingsSlinky.tsLoader.anon.TsLoaderDefinitionFileVersions
import typingsSlinky.tsLoader.anon.Typeoftypescript
import typingsSlinky.tsLoader.tsLoaderStrings.error_
...
object interfacesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.tsLoader.tsLoaderStrings.INFO
    - typingsSlinky.tsLoader.tsLoaderStrings.WARN
    - typingsSlinky.tsLoader.tsLoaderStrings.ERROR
  */
  trait LogLevel extends StObject
  object LogLevel {
    
    @scala.inline
    def ERROR: typingsSlinky.tsLoader.tsLoaderStrings.ERROR = "ERROR".asInstanceOf[typingsSlinky.tsLoader.tsLoaderStrings.ERROR]
    
    @scala.inline
    def INFO: typingsSlinky.tsLoader.tsLoaderStrings.INFO = "INFO".asInstanceOf[typingsSlinky.tsLoader.tsLoaderStrings.INFO]
    
    @scala.inline
    def WARN: typingsSlinky.tsLoader.tsLoaderStrings.WARN = "WARN".asInstanceOf[typingsSlinky.tsLoader.tsLoaderStrings.WARN]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.tsLoader.tsLoaderStrings.error_
    - typingsSlinky.tsLoader.tsLoaderStrings.warning
  */
  ...
  object Severity {
    ...
    @scala.inline
    def warning: typingsSlinky.tsLoader.tsLoaderStrings.warning = "warning".asInstanceOf[typingsSlinky.tsLoader.tsLoaderStrings.warning]
  }
  
  @js.native
  trait SolutionBuilderWithWatchHost
    extends typingsSlinky.typescript.mod.SolutionBuilderWithWatchHost[EmitAndSemanticDiagnosticsBuilderProgram]
       with WatchFactory {
