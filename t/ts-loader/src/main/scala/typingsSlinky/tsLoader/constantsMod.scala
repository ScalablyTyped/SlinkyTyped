...
object constantsMod {
  ...
  @JSImport("ts-loader/dist/constants", "CarriageReturnLineFeed")
  @js.native
  val CarriageReturnLineFeed: /* "\r\n" */ String = js.native
  
  @JSImport("ts-loader/dist/constants", "CarriageReturnLineFeedCode")
  @js.native
  val CarriageReturnLineFeedCode: /* 0 */ Double = js.native
  
  @JSImport("ts-loader/dist/constants", "EOL")
  @js.native
  val EOL: String = js.native
  
  @JSImport("ts-loader/dist/constants", "LineFeed")
  @js.native
  val LineFeed: /* "\n" */ String = js.native
  
  @JSImport("ts-loader/dist/constants", "LineFeedCode")
  @js.native
