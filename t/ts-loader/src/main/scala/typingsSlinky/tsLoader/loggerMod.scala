...
object loggerMod {
  ...
  object LogLevel extends StObject {
    ...
    /* 3 */ val ERROR: typingsSlinky.tsLoader.loggerMod.LogLevel.ERROR with Double = js.native
    
    @js.native
    sealed trait INFO extends LogLevel
    /* 1 */ val INFO: typingsSlinky.tsLoader.loggerMod.LogLevel.INFO with Double = js.native
    
    @js.native
    sealed trait WARN extends LogLevel
    /* 2 */ val WARN: typingsSlinky.tsLoader.loggerMod.LogLevel.WARN with Double = js.native
  }
