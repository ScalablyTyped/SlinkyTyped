...
import typingsSlinky.atThemeDashUiComponents.atThemeDashUiComponentsMod.ImageProps
...
object Image
  ...
  type Props = PropsWithoutRef[ImageProps] with RefAttributes[HTMLImageElement]
}
