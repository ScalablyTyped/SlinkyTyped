...
import typingsSlinky.atThemeDashUiComponents.atThemeDashUiComponentsMod.AspectRatioProps
...
object AspectRatio
  ...
  type Props = PropsWithoutRef[AspectRatioProps] with RefAttributes[HTMLDivElement]
}
