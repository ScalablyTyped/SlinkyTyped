...
import typingsSlinky.atThemeDashUiComponents.atThemeDashUiComponentsMod.CheckboxProps
...
object Checkbox
  ...
  type Props = PropsWithoutRef[CheckboxProps] with RefAttributes[HTMLInputElement]
}
