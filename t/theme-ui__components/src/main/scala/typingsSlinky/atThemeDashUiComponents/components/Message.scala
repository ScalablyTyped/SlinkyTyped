...
import typingsSlinky.atThemeDashUiComponents.atThemeDashUiComponentsMod.MessageProps
...
object Message
  ...
  type Props = PropsWithoutRef[MessageProps] with RefAttributes[HTMLDivElement]
}
