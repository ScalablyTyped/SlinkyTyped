...
import typingsSlinky.atThemeDashUiComponents.atThemeDashUiComponentsMod.AvatarProps
...
object Avatar
  ...
  type Props = PropsWithoutRef[AvatarProps] with RefAttributes[HTMLImageElement]
}
