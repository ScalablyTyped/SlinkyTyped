...
import typingsSlinky.atThemeDashUiComponents.atThemeDashUiComponentsMod.DividerProps
...
object Divider
  ...
  type Props = PropsWithoutRef[DividerProps] with RefAttributes[HTMLDivElement]
}
