...
import typingsSlinky.atThemeDashUiComponents.atThemeDashUiComponentsMod.InputProps
...
object Input
  ...
  type Props = PropsWithoutRef[InputProps] with RefAttributes[HTMLInputElement]
}
