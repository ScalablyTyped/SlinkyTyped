...
/* Inlined parent @theme-ui/components.@theme-ui/components.Assign<react.react.ComponentPropsWithRef<'button'>, @theme-ui/components.@theme-ui/components.BoxOwnProps> */
