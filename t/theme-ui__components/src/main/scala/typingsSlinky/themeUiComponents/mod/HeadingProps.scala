...
/* Inlined parent @theme-ui/components.@theme-ui/components.Assign<react.react.ComponentPropsWithRef<'h2'>, @theme-ui/components.@theme-ui/components.BoxOwnProps> */
