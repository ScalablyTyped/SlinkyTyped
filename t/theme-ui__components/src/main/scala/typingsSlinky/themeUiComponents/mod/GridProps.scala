...
object GridProps {
  @scala.inline
  def apply(
    columns: js.UndefOr[Null | (ResponsiveValue[String | Double, RequiredTheme])] = js.undefined,
    gap: js.UndefOr[Null | (ResponsiveValue[String | Double, RequiredTheme])] = js.undefined,
    width: js.UndefOr[Null | (ResponsiveValue[String | Double, RequiredTheme])] = js.undefined
  ): GridProps = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(columns)) __obj.updateDynamic("columns")(columns.asInstanceOf[js.Any])
    if (!js.isUndefined(gap)) __obj.updateDynamic("gap")(gap.asInstanceOf[js.Any])
