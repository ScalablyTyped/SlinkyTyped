...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAtime(value: Boolean | js.Date): Self = this.set("atime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMtime(value: Boolean | js.Date): Self = this.set("mtime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTime(value: js.Date | String | Double): Self = this.set("time", value.asInstanceOf[js.Any])
