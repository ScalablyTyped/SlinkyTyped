...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAtime(value: Boolean | js.Date): Self = StObject.set(x, "atime", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMtime(value: Boolean | js.Date): Self = StObject.set(x, "mtime", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTime(value: js.Date | String | Double): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
