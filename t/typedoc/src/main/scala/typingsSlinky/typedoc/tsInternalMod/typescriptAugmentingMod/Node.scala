...
object Node {
  ...
  implicit class NodeOps[Self <: Node] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocalSymbol(value: typingsSlinky.typescript.mod.Symbol): Self = this.set("localSymbol", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLocalSymbol: Self = this.set("localSymbol", js.undefined)
    @scala.inline
    def setSymbol(value: typingsSlinky.typescript.mod.Symbol): Self = this.set("symbol", value.asInstanceOf[js.Any])
    @scala.inline
