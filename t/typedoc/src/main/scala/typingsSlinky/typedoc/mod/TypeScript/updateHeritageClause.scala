...
@JSImport("typedoc", "TypeScript.updateHeritageClause")
@js.native
object updateHeritageClause extends js.Object {
  
  /** @deprecated Use `factory.updateHeritageClause` or the factory supplied by your transformation context instead. */
  def apply(node: HeritageClause, types: js.Array[ExpressionWithTypeArguments]): HeritageClause = js.native
}
