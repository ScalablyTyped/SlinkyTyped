...
class DeclarationReflectionSerializer protected ()
  extends typingsSlinky.typedoc.serializersMod.DeclarationReflectionSerializer {
...
object DeclarationReflectionSerializer {
  ...
  @JSImport("typedoc/dist/lib/serialization", "DeclarationReflectionSerializer.PRIORITY")
  @js.native
