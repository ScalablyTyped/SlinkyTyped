...
object ReflectionObject {
  @scala.inline
  def apply(flags: ReflectionFlagsObject, id: Double, kind: Double, kindString: String, name: String): ReflectionObject = {
  ...
  @scala.inline
  implicit class ReflectionObjectOps[Self <: ReflectionObject] (val x: Self) extends AnyVal {
    @scala.inline
