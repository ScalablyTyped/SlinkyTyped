...
trait ReadonlyBooleanDeclaratio extends js.Object {
  ...
  val `type`: typingsSlinky.typedoc.optionsDeclarationMod.ParameterType.Boolean = js.native
}
object ReadonlyBooleanDeclaratio {
  ...
  implicit class ReadonlyBooleanDeclaratioOps[Self <: ReadonlyBooleanDeclaratio] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.typedoc.optionsDeclarationMod.ParameterType.Boolean): Self = this.set("type", value.asInstanceOf[js.Any])
