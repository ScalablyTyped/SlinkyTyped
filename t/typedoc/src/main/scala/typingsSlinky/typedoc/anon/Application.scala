...
trait Application extends js.Object {
  var application: typingsSlinky.typedoc.applicationMod.Application = js.native
}
...
object Application {
  ...
  implicit class ApplicationOps[Self <: Application] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApplication(value: typingsSlinky.typedoc.applicationMod.Application): Self = {
