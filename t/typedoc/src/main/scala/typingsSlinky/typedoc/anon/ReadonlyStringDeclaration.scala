...
import typingsSlinky.typedoc.optionsDeclarationMod.ParameterHint
...
trait ReadonlyStringDeclaration extends StObject {
  ...
  val `type`: js.UndefOr[typingsSlinky.typedoc.optionsDeclarationMod.ParameterType.String] = js.native
}
object ReadonlyStringDeclaration {
  ...
  implicit class ReadonlyStringDeclarationMutableBuilder[Self <: ReadonlyStringDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.typedoc.optionsDeclarationMod.ParameterType.String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
