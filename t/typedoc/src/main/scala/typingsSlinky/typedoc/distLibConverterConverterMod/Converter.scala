...
import typingsSlinky.typedoc.distLibConverterComponentsMod.ConverterComponent
...
class Converter () extends ChildableComponent[Application, ConverterComponent] {
  ...
  def convertType(context: Context, node: Node, `type`: typingsSlinky.typescript.typescriptMod.Type): js.UndefOr[Type] = js.native
  ...
  def convertTypes(
    context: Context,
    nodes: js.Array[Node],
    types: js.Array[typingsSlinky.typescript.typescriptMod.Type]
