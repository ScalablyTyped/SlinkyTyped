package typingsSlinky.typedoc.distLibUtilsOptionsOptionsMod
...
object OptionsReadMode extends js.Object {
  ...
  /* 1 */ val Fetch: typingsSlinky.typedoc.distLibUtilsOptionsOptionsMod.OptionsReadMode.Fetch with Double = js.native
  /* 0 */ val Prefetch: typingsSlinky.typedoc.distLibUtilsOptionsOptionsMod.OptionsReadMode.Prefetch with Double = js.native
  @JSBracketAccess
