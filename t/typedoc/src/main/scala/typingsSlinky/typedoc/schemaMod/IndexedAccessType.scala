...
trait IndexedAccessType extends SomeType {
  ...
  var indexType: ModelToObject[typingsSlinky.typedoc.modelsTypesMod.Type] | typingsSlinky.typedoc.modelsTypesMod.Type = js.native
  
  var objectType: ModelToObject[typingsSlinky.typedoc.modelsTypesMod.Type] | typingsSlinky.typedoc.modelsTypesMod.Type = js.native
...
object IndexedAccessType {
  ...
  implicit class IndexedAccessTypeMutableBuilder[Self <: IndexedAccessType] (val x: Self) extends AnyVal {
    ...
    ): Self = StObject.set(x, "indexType", value.asInstanceOf[js.Any])
    ...
    def setObjectType(
      value: ModelToObject[typingsSlinky.typedoc.modelsTypesMod.Type] | typingsSlinky.typedoc.modelsTypesMod.Type
    ): Self = StObject.set(x, "objectType", value.asInstanceOf[js.Any])
