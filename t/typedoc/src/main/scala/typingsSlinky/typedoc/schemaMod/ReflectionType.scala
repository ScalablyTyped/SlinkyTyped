...
object ReflectionType {
  ...
  implicit class ReflectionTypeOps[Self <: ReflectionType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeclaration(value: ModelToObject[typingsSlinky.typedoc.reflectionsDeclarationMod.DeclarationReflection]): Self = this.set("declaration", value.asInstanceOf[js.Any])
    @scala.inline
