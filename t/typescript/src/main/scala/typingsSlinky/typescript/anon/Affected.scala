...
import typingsSlinky.typescript.mod.AffectedFileResult
...
@js.native
trait Affected[T] extends AffectedFileResult[T] {
...
object Affected {
  ...
  @scala.inline
  implicit class AffectedOps[Self[t] <: Affected[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
