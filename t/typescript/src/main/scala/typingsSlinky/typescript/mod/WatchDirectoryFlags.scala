...
object WatchDirectoryFlags extends StObject {
  ...
  /* 0 */ val None: typingsSlinky.typescript.mod.WatchDirectoryFlags.None with Double = js.native
  
  @js.native
  sealed trait Recursive extends WatchDirectoryFlags
  /* 1 */ val Recursive: typingsSlinky.typescript.mod.WatchDirectoryFlags.Recursive with Double = js.native
}
