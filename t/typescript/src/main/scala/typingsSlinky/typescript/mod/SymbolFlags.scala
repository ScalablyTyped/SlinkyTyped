...
object SymbolFlags extends js.Object {
  ...
  /* 8 */ @js.native
  object EnumMember
    extends TopLevel[typingsSlinky.typescript.mod.SymbolFlags.EnumMember with Double]
  ...
  /* 131072 */ @js.native
  object Signature
    extends TopLevel[typingsSlinky.typescript.mod.SymbolFlags.Signature with Double]
  ...
  /* 788968 */ @js.native
  object Type
    extends TopLevel[typingsSlinky.typescript.mod.SymbolFlags.Type with Double]
  ...
  object TypeParameter
    extends TopLevel[typingsSlinky.typescript.mod.SymbolFlags.TypeParameter with Double]
