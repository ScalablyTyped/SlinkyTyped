...
@JSImport("typescript", "createJSDocReadonlyTag")
@js.native
object createJSDocReadonlyTag extends js.Object {
  ...
  def apply(tagName: js.UndefOr[scala.Nothing], comment: java.lang.String): JSDocReadonlyTag = js.native
  def apply(tagName: Identifier): JSDocReadonlyTag = js.native
  def apply(tagName: Identifier, comment: java.lang.String): JSDocReadonlyTag = js.native
}
