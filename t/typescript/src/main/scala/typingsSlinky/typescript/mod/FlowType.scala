...
object FlowType {
  ...
  @scala.inline
  def IncompleteType(flags: TypeFlags, `type`: Type): typingsSlinky.typescript.mod.IncompleteType = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.typescript.mod.IncompleteType]
  }
  ...
  def Type(
    ...
    getConstraint: () => js.UndefOr[typingsSlinky.typescript.mod.Type],
    getConstructSignatures: () => js.Array[Signature],
    getDefault: () => js.UndefOr[typingsSlinky.typescript.mod.Type],
    getFlags: () => TypeFlags,
    getNonNullableType: () => typingsSlinky.typescript.mod.Type,
    getNumberIndexType: () => js.UndefOr[typingsSlinky.typescript.mod.Type],
    getProperties: () => js.Array[Symbol],
    getProperty: java.lang.String => js.UndefOr[Symbol],
    getStringIndexType: () => js.UndefOr[typingsSlinky.typescript.mod.Type],
    ...
    __obj.asInstanceOf[typingsSlinky.typescript.mod.Type]
  }
}
