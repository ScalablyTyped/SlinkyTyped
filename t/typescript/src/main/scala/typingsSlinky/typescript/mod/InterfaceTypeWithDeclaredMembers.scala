...
object InterfaceTypeWithDeclaredMembers {
  ...
  implicit class InterfaceTypeWithDeclaredMembersOps[Self <: InterfaceTypeWithDeclaredMembers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeclaredCallSignatures(value: js.Array[Signature]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declaredCallSignatures")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDeclaredConstructSignatures(value: js.Array[Signature]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declaredConstructSignatures")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDeclaredProperties(value: js.Array[Symbol]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declaredProperties")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDeclaredNumberIndexInfo(value: IndexInfo): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declaredNumberIndexInfo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDeclaredNumberIndexInfo: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declaredNumberIndexInfo")(js.undefined)
        ret
    }
    @scala.inline
    def withDeclaredStringIndexInfo(value: IndexInfo): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declaredStringIndexInfo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDeclaredStringIndexInfo: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("declaredStringIndexInfo")(js.undefined)
        ret
    }
  }
