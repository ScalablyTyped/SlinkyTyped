...
trait SubstitutionType extends Type {
  ...
  var typeVariable: TypeVariable = js.native
}
...
object SubstitutionType {
  ...
  implicit class SubstitutionTypeOps[Self <: SubstitutionType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSubstitute(value: Type): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("substitute")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTypeVariable(value: TypeVariable): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("typeVariable")(value.asInstanceOf[js.Any])
        ret
    }
  }
