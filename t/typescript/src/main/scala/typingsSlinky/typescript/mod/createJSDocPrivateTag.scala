...
@JSImport("typescript", "createJSDocPrivateTag")
@js.native
object createJSDocPrivateTag extends js.Object {
  ...
  def apply(tagName: js.UndefOr[scala.Nothing], comment: java.lang.String): JSDocPrivateTag = js.native
  def apply(tagName: Identifier): JSDocPrivateTag = js.native
  def apply(tagName: Identifier, comment: java.lang.String): JSDocPrivateTag = js.native
}
