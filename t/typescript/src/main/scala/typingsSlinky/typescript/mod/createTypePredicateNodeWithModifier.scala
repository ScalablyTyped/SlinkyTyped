...
object createTypePredicateNodeWithModifier extends js.Object {
  def apply(assertsModifier: js.UndefOr[AssertsToken], parameterName: java.lang.String): TypePredicateNode = js.native
  def apply(assertsModifier: js.UndefOr[AssertsToken], parameterName: java.lang.String, `type`: TypeNode): TypePredicateNode = js.native
