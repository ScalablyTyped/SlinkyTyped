...
trait IdentifierTypePredicate
  extends TypePredicateBase
     with TypePredicate {
  @JSName("kind")
  var kind_IdentifierTypePredicate: typingsSlinky.typescript.mod.TypePredicateKind.Identifier
...
object IdentifierTypePredicate {
  ...
  implicit class IdentifierTypePredicateOps[Self <: IdentifierTypePredicate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.typescript.mod.TypePredicateKind.Identifier): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
