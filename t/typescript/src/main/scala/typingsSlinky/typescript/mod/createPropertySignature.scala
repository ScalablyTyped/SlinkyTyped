...
object createPropertySignature extends js.Object {
  def apply(modifiers: js.UndefOr[js.Array[Modifier]], name: java.lang.String): PropertySignature = js.native
  def apply(modifiers: js.UndefOr[js.Array[Modifier]], name: java.lang.String, questionToken: QuestionToken): PropertySignature = js.native
  def apply(
