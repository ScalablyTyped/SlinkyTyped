...
object EvolvingArrayType {
  ...
  implicit class EvolvingArrayTypeOps[Self <: EvolvingArrayType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFinalArrayType(value: Type): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("finalArrayType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFinalArrayType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("finalArrayType")(js.undefined)
        ret
    }
  }
