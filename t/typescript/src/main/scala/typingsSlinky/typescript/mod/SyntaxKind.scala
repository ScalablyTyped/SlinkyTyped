...
object SyntaxKind extends js.Object {
  ...
  object AbstractKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.AbstractKeyword with Double]
  ...
  object AssertsKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.AssertsKeyword with Double]
  ...
  /* 129 */ @js.native
  object AsyncKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.AsyncKeyword with Double]
  ...
  /* 130 */ @js.native
  object AwaitKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.AwaitKeyword with Double]
  ...
  /* 84 */ @js.native
  object ConstKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.ConstKeyword with Double]
  ...
  object DeclareKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.DeclareKeyword with Double]
  ...
  object DefaultKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.DefaultKeyword with Double]
  ...
  object ExportKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.ExportKeyword with Double]
  ...
  object JSDocDeprecatedTag
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.JSDocDeprecatedTag with Double]
  ...
  object JSDocNameReference
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.JSDocNameReference with Double]
  ...
  /* 332 */ @js.native
  object JSDocSeeTag
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.JSDocSeeTag with Double]
  ...
  object NamedTupleMember
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.NamedTupleMember with Double]
  ...
  object PrivateKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.PrivateKeyword with Double]
  ...
  object ProtectedKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.ProtectedKeyword with Double]
  ...
  object PublicKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.PublicKeyword with Double]
  ...
  object ReadonlyKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.ReadonlyKeyword with Double]
  ...
  object StaticKeyword
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.StaticKeyword with Double]
  ...
  object TemplateLiteralType
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.TemplateLiteralType with Double]
  
  @js.native
  sealed trait TemplateLiteralTypeSpan extends SyntaxKind
  /* 194 */ @js.native
  object TemplateLiteralTypeSpan
    extends TopLevel[typingsSlinky.typescript.mod.SyntaxKind.TemplateLiteralTypeSpan with Double]
