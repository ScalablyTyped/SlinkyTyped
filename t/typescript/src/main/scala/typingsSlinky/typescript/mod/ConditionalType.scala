...
object ConditionalType {
  ...
  implicit class ConditionalTypeOps[Self <: ConditionalType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResolvedFalseType(value: Type): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolvedFalseType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withResolvedTrueType(value: Type): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolvedTrueType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRoot(value: ConditionalRoot): Self = {
        val ret = this.duplicate
