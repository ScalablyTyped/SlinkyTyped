...
object NodeFlags extends js.Object {
  ...
  /* 4194304 */ @js.native
  object JSDoc
    extends TopLevel[typingsSlinky.typescript.mod.NodeFlags.JSDoc with Double]
  ...
  object OptionalChain
    extends TopLevel[typingsSlinky.typescript.mod.NodeFlags.OptionalChain with Double]
