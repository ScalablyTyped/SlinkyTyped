...
@JSImport("typescript", "createJSDocClassTag")
@js.native
object createJSDocClassTag extends js.Object {
  ...
  def apply(tagName: js.UndefOr[scala.Nothing], comment: java.lang.String): JSDocClassTag = js.native
  def apply(tagName: Identifier): JSDocClassTag = js.native
  def apply(tagName: Identifier, comment: java.lang.String): JSDocClassTag = js.native
}
