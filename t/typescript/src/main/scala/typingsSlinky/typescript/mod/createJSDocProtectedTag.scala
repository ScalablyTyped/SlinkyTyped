...
@JSImport("typescript", "createJSDocProtectedTag")
@js.native
object createJSDocProtectedTag extends js.Object {
  ...
  def apply(tagName: js.UndefOr[scala.Nothing], comment: java.lang.String): JSDocProtectedTag = js.native
  def apply(tagName: Identifier): JSDocProtectedTag = js.native
  def apply(tagName: Identifier, comment: java.lang.String): JSDocProtectedTag = js.native
}
