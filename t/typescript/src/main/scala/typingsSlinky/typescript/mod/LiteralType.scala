...
object LiteralType {
  ...
  implicit class LiteralTypeOps[Self <: LiteralType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFreshType(value: LiteralType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("freshType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRegularType(value: LiteralType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("regularType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withValue(value: java.lang.String | Double | PseudoBigInt): Self = {
        val ret = this.duplicate
