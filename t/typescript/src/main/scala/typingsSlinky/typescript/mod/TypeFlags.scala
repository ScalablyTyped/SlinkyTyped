...
object TypeFlags extends js.Object {
  ...
  object BigIntLiteral
    extends TopLevel[typingsSlinky.typescript.mod.TypeFlags.BigIntLiteral with Double]
  ...
  object BooleanLiteral
    extends TopLevel[typingsSlinky.typescript.mod.TypeFlags.BooleanLiteral with Double]
  ...
  /* 4 */ @js.native
  object String
    extends TopLevel[typingsSlinky.typescript.mod.TypeFlags.String with Double]
  ...
  object StructuredType
    extends TopLevel[typingsSlinky.typescript.mod.TypeFlags.StructuredType with Double]
  ...
  object TypeParameter
    extends TopLevel[typingsSlinky.typescript.mod.TypeFlags.TypeParameter with Double]
  
  @js.native
  sealed trait TypeVariable extends TypeFlags
  /* 8650752 */ @js.native
  object TypeVariable
    extends TopLevel[typingsSlinky.typescript.mod.TypeFlags.TypeVariable with Double]
