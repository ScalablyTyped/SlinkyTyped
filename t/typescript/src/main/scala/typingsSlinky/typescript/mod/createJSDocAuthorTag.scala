...
@JSImport("typescript", "createJSDocAuthorTag")
@js.native
object createJSDocAuthorTag extends js.Object {
  ...
  def apply(tagName: js.UndefOr[scala.Nothing], comment: java.lang.String): JSDocAuthorTag = js.native
  def apply(tagName: Identifier): JSDocAuthorTag = js.native
  def apply(tagName: Identifier, comment: java.lang.String): JSDocAuthorTag = js.native
}
