...
object IncrementalProgramOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.typescript.mod.BuilderProgram */ T](options: CompilerOptions, rootNames: js.Array[java.lang.String]): IncrementalProgramOptions[T] = {
  ...
  @scala.inline
  implicit class IncrementalProgramOptionsOps[Self <: IncrementalProgramOptions[_], /* <: typingsSlinky.typescript.mod.BuilderProgram */ T] (val x: Self with IncrementalProgramOptions[T]) extends AnyVal {
    @scala.inline
