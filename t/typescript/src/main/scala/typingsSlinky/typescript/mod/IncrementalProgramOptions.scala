...
object IncrementalProgramOptions {
  ...
  @scala.inline
  implicit class IncrementalProgramOptionsOps[Self <: IncrementalProgramOptions[_], T /* <: BuilderProgram */] (val x: Self with IncrementalProgramOptions[T]) extends AnyVal {
