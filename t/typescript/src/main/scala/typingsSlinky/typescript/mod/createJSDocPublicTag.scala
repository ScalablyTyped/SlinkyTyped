...
@JSImport("typescript", "createJSDocPublicTag")
@js.native
object createJSDocPublicTag extends js.Object {
  ...
  def apply(tagName: js.UndefOr[scala.Nothing], comment: java.lang.String): JSDocPublicTag = js.native
  def apply(tagName: Identifier): JSDocPublicTag = js.native
  def apply(tagName: Identifier, comment: java.lang.String): JSDocPublicTag = js.native
}
