...
object EmitHint extends js.Object {
  ...
  /* 1 */ @js.native
  object Expression
    extends TopLevel[typingsSlinky.typescript.mod.EmitHint.Expression with Double]
  ...
  /* 0 */ @js.native
  object SourceFile
    extends TopLevel[typingsSlinky.typescript.mod.EmitHint.SourceFile with Double]
