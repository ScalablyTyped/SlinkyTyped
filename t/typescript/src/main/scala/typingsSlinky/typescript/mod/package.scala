...
package object mod {
  ...
  type AffectedFileResult[T] = js.UndefOr[typingsSlinky.typescript.AnonAffected[T]]
  ...
  */
  ...
  type DocumentRegistryBucketKey = java.lang.String with typingsSlinky.typescript.AnonBucketKey
  ...
  */
  ...
  type Path = java.lang.String with typingsSlinky.typescript.AnonPathBrand
  ...
  type String = (java.lang.String with typingsSlinky.typescript.AnonEscapedIdentifier) | (scala.Unit with typingsSlinky.typescript.AnonEscapedIdentifier) | typingsSlinky.typescript.mod.InternalSymbolName
  ...
  type WithMetadata[T] = T with typingsSlinky.typescript.AnonMetadata
