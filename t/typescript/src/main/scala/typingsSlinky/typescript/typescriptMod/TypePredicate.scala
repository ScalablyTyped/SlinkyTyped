...
import typingsSlinky.typescript.typescriptMod.TypePredicateKind.AssertsIdentifier
import typingsSlinky.typescript.typescriptMod.TypePredicateKind.AssertsThis
import typingsSlinky.typescript.typescriptMod.TypePredicateKind.This
...
object TypePredicate {
  ...
  def IdentifierTypePredicate(
    kind: typingsSlinky.typescript.typescriptMod.TypePredicateKind.Identifier,
