...
object NewLineKind extends js.Object {
  ...
  /* 0 */ val CarriageReturnLineFeed: typingsSlinky.typescript.typescriptMod.NewLineKind.CarriageReturnLineFeed with Double = js.native
  /* 1 */ val LineFeed: typingsSlinky.typescript.typescriptMod.NewLineKind.LineFeed with Double = js.native
  @JSBracketAccess
