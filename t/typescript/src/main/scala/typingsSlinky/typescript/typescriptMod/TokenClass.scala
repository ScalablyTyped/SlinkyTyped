...
object TokenClass extends js.Object {
  ...
  object BigIntLiteral
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TokenClass.BigIntLiteral with Double]
  ...
  /* 5 */ @js.native
  object Identifier
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TokenClass.Identifier with Double]
  ...
  object StringLiteral
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TokenClass.StringLiteral with Double]
