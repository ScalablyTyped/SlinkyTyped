...
trait System extends js.Object {
  ...
  var getModifiedTime: js.UndefOr[js.Function1[/* path */ String, js.UndefOr[js.Date]]] = js.native
  var newLine: String = js.native
  var realpath: js.UndefOr[js.Function1[/* path */ String, String]] = js.native
  var setModifiedTime: js.UndefOr[js.Function2[/* path */ String, /* time */ js.Date, Unit]] = js.native
