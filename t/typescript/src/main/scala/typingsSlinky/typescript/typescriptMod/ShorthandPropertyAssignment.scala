...
trait ShorthandPropertyAssignment
  extends ObjectLiteralElement
     ...
     with _HasJSDoc {
  var equalsToken: js.UndefOr[Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.EqualsToken]] = js.native
  var exclamationToken: js.UndefOr[ExclamationToken] = js.native
  @JSName("kind")
  var kind_ShorthandPropertyAssignment: typingsSlinky.typescript.typescriptMod.SyntaxKind.ShorthandPropertyAssignment = js.native
  @JSName("name")
