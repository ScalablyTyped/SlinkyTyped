...
package object typescriptMod {
  ...
  import typingsSlinky.typescript.Anon_Affected
  import typingsSlinky.typescript.Anon_BucketKey
  import typingsSlinky.typescript.Anon_EscapedIdentifier
  import typingsSlinky.typescript.Anon_Metadata
  import typingsSlinky.typescript.Anon_Name
  import typingsSlinky.typescript.Anon_PathBrand
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.AbstractKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.AssertsKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.AsteriskAsteriskToken
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.AsyncKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.AwaitKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.ConstKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.DeclareKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.DefaultKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.ExportKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.PrivateKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.ProtectedKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.PublicKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.ReadonlyKeyword
  import typingsSlinky.typescript.typescriptMod.SyntaxKind.StaticKeyword
  ...
  */
  ...
  type AsteriskToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.AsteriskToken]
  ...
  */
  ...
  type ColonToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.ColonToken]
  ...
  type DotDotDotToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.DotDotDotToken]
  type DotToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.DotToken]
  type EmitHelperUniqueNameCallback = js.Function1[/* name */ String, String]
  type EndOfFileToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.EndOfFileToken] with JSDocContainer
  type EnumType = Type
  type EqualityOperatorOrHigher = RelationalOperatorOrHigher | EqualityOperator
  type EqualsGreaterThanToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.EqualsGreaterThanToken]
  type EqualsToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.EqualsToken]
  type ErrorCallback = js.Function2[/* message */ DiagnosticMessage, /* length */ Double, Unit]
  type ExclamationToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.ExclamationToken]
  ...
  */
  ...
  type MinusToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.MinusToken]
  type Modifier = Token[
  ...
  type PlusToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.PlusToken]
  type QuestionDotToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.QuestionDotToken]
  type QuestionToken = Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.QuestionToken]
