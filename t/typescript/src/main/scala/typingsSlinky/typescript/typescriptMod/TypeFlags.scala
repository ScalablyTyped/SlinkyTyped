...
object TypeFlags extends js.Object {
  ...
  object BigIntLiteral
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TypeFlags.BigIntLiteral with Double]
  ...
  object BooleanLiteral
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TypeFlags.BooleanLiteral with Double]
  ...
  object StringLiteral
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TypeFlags.StringLiteral with Double]
  ...
  object StructuredType
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TypeFlags.StructuredType with Double]
  ...
  object TypeParameter
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TypeFlags.TypeParameter with Double]
  
  /* 8650752 */ @js.native
  object TypeVariable
    extends TopLevel[typingsSlinky.typescript.typescriptMod.TypeFlags.TypeVariable with Double]
