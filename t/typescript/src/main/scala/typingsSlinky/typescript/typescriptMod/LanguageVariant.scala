...
object LanguageVariant extends js.Object {
  ...
  /* 1 */ val JSX: typingsSlinky.typescript.typescriptMod.LanguageVariant.JSX with Double = js.native
  /* 0 */ val Standard: typingsSlinky.typescript.typescriptMod.LanguageVariant.Standard with Double = js.native
  @JSBracketAccess
