...
import typingsSlinky.typescript.Anon_TypeArguments
...
trait TypeChecker extends js.Object {
  ...
  def getConstantValue(node: EnumMember): js.UndefOr[String | Double] = js.native
  ...
  def getFullyQualifiedName(symbol: Symbol): String = js.native
  ...
  def getPropertyOfType(`type`: Type, propertyName: String): js.UndefOr[Symbol] = js.native
  ...
  def isValidPropertyAccess(node: ImportTypeNode, propertyName: String): Boolean = js.native
  def isValidPropertyAccess(node: PropertyAccessExpression, propertyName: String): Boolean = js.native
  def isValidPropertyAccess(node: QualifiedName, propertyName: String): Boolean = js.native
  /**
  ...
  /** Note that the resulting nodes cannot be checked. */
  def signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind): js.UndefOr[SignatureDeclaration with Anon_TypeArguments] = js.native
  def signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind, enclosingDeclaration: Node): js.UndefOr[SignatureDeclaration with Anon_TypeArguments] = js.native
  def signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind, enclosingDeclaration: Node, flags: NodeBuilderFlags): js.UndefOr[SignatureDeclaration with Anon_TypeArguments] = js.native
  def signatureToString(signature: Signature): String = js.native
  def signatureToString(signature: Signature, enclosingDeclaration: Node): String = js.native
  def signatureToString(signature: Signature, enclosingDeclaration: Node, flags: TypeFormatFlags): String = js.native
  def signatureToString(signature: Signature, enclosingDeclaration: Node, flags: TypeFormatFlags, kind: SignatureKind): String = js.native
  /** Note that the resulting nodes cannot be checked. */
  ...
  def symbolToString(symbol: Symbol): String = js.native
  def symbolToString(symbol: Symbol, enclosingDeclaration: Node): String = js.native
  def symbolToString(symbol: Symbol, enclosingDeclaration: Node, meaning: SymbolFlags): String = js.native
  def symbolToString(symbol: Symbol, enclosingDeclaration: Node, meaning: SymbolFlags, flags: SymbolFormatFlags): String = js.native
  /** Note that the resulting nodes cannot be checked. */
  ...
  def tryGetMemberInModuleExports(memberName: String, moduleSymbol: Symbol): js.UndefOr[Symbol] = js.native
  /** Note that the resulting nodes cannot be checked. */
  ...
  def typePredicateToString(predicate: TypePredicate): String = js.native
  def typePredicateToString(predicate: TypePredicate, enclosingDeclaration: Node): String = js.native
  def typePredicateToString(predicate: TypePredicate, enclosingDeclaration: Node, flags: TypeFormatFlags): String = js.native
  def typeToString(`type`: Type): String = js.native
  def typeToString(`type`: Type, enclosingDeclaration: Node): String = js.native
  def typeToString(`type`: Type, enclosingDeclaration: Node, flags: TypeFormatFlags): String = js.native
  /** Note that the resulting nodes cannot be checked. */
