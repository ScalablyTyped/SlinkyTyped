...
trait SourceFile
  ...
  var endOfFileToken: Token[typingsSlinky.typescript.typescriptMod.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  var kind_SourceFile: typingsSlinky.typescript.typescriptMod.SyntaxKind.SourceFile = js.native
