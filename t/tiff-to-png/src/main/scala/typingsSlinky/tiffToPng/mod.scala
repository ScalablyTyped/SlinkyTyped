package typingsSlinky.tiffToPng

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.tiffToPng.tiffToPngBooleans.`true`
import typingsSlinky.tiffToPng.tiffToPngNumbers.`1`
import typingsSlinky.tiffToPng.tiffToPngNumbers.`2`
import typingsSlinky.tiffToPng.tiffToPngStrings.A3
import typingsSlinky.tiffToPng.tiffToPngStrings.A4
import typingsSlinky.tiffToPng.tiffToPngStrings.jpg
import typingsSlinky.tiffToPng.tiffToPngStrings.png
...
object mod {
  ...
  object TiffConverterError {
    ...
    @scala.inline
    def apply(error: js.Error, filename: String, target: String, tiff: String): TiffConverterError = {
