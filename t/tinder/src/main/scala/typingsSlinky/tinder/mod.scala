...
object mod {
  ...
  trait TinderRecommendation extends StObject {
    ...
    // todo
    var teaser: typingsSlinky.tinder.anon.String = js.native
  ...
  object TinderRecommendation {
    ...
    def apply(
      ...
      ping_time: String,
      schools: js.Array[_],
      teaser: typingsSlinky.tinder.anon.String,
    ...
    implicit class TinderRecommendationMutableBuilder[Self <: TinderRecommendation] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTeaser(value: typingsSlinky.tinder.anon.String): Self = StObject.set(x, "teaser", value.asInstanceOf[js.Any])
