...
object CompressOptions {
  ...
  implicit class CompressOptionsOps[Self <: CompressOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTop_retainRegExp(value: js.RegExp): Self = this.set("top_retain", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTop_retain(value: String | js.Array[String] | js.RegExp): Self = this.set("top_retain", value.asInstanceOf[js.Any])
