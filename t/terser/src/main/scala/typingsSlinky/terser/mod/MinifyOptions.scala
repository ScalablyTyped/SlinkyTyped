...
object MinifyOptions {
  ...
  implicit class MinifyOptionsOps[Self <: MinifyOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeep_classnamesRegExp(value: js.RegExp): Self = this.set("keep_classnames", value.asInstanceOf[js.Any])
    @scala.inline
    def setKeep_classnames(value: Boolean | js.RegExp): Self = this.set("keep_classnames", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteKeep_classnames: Self = this.set("keep_classnames", js.undefined)
    @scala.inline
    def setKeep_fnamesRegExp(value: js.RegExp): Self = this.set("keep_fnames", value.asInstanceOf[js.Any])
    @scala.inline
    def setKeep_fnames(value: Boolean | js.RegExp): Self = this.set("keep_fnames", value.asInstanceOf[js.Any])
    @scala.inline
