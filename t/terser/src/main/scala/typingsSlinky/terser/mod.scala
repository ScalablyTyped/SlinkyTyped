...
object mod {
  ...
  object InlineFunctions extends StObject {
    ...
    /* 0 */ val Disabled: typingsSlinky.terser.mod.InlineFunctions.Disabled with Double = js.native
    
    @js.native
    sealed trait SimpleFunctions extends InlineFunctions
    /* 1 */ val SimpleFunctions: typingsSlinky.terser.mod.InlineFunctions.SimpleFunctions with Double = js.native
    
    @js.native
    sealed trait WithArguments extends InlineFunctions
    /* 2 */ val WithArguments: typingsSlinky.terser.mod.InlineFunctions.WithArguments with Double = js.native
    
    @js.native
    sealed trait WithArgumentsAndVariables extends InlineFunctions
    /* 3 */ val WithArgumentsAndVariables: typingsSlinky.terser.mod.InlineFunctions.WithArgumentsAndVariables with Double = js.native
  }
  ...
  object OutputQuoteStyle extends StObject {
    ...
    /* 2 */ val AlwaysDouble: typingsSlinky.terser.mod.OutputQuoteStyle.AlwaysDouble with Double = js.native
    
    @js.native
    sealed trait AlwaysOriginal extends OutputQuoteStyle
    /* 3 */ val AlwaysOriginal: typingsSlinky.terser.mod.OutputQuoteStyle.AlwaysOriginal with Double = js.native
    
    @js.native
    sealed trait AlwaysSingle extends OutputQuoteStyle
    /* 1 */ val AlwaysSingle: typingsSlinky.terser.mod.OutputQuoteStyle.AlwaysSingle with Double = js.native
    
    @js.native
    sealed trait PreferDouble extends OutputQuoteStyle
    /* 0 */ val PreferDouble: typingsSlinky.terser.mod.OutputQuoteStyle.PreferDouble with Double = js.native
  }
  ...
  object CompressOptions {
    ...
    implicit class CompressOptionsMutableBuilder[Self <: CompressOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKeep_classnames(value: Boolean | js.RegExp): Self = StObject.set(x, "keep_classnames", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setKeep_classnamesRegExp(value: js.RegExp): Self = StObject.set(x, "keep_classnames", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setKeep_fnames(value: Boolean | js.RegExp): Self = StObject.set(x, "keep_fnames", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setKeep_fnamesRegExp(value: js.RegExp): Self = StObject.set(x, "keep_fnames", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTop_retain(value: String | js.Array[String] | js.RegExp): Self = StObject.set(x, "top_retain", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTop_retainNull: Self = StObject.set(x, "top_retain", null)
      
      @scala.inline
      def setTop_retainRegExp(value: js.RegExp): Self = StObject.set(x, "top_retain", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object ECMA {
    ...
    @scala.inline
    def `2015`: typingsSlinky.terser.terserNumbers.`2015` = 2015.asInstanceOf[typingsSlinky.terser.terserNumbers.`2015`]
    
    @scala.inline
    def `2016`: typingsSlinky.terser.terserNumbers.`2016` = 2016.asInstanceOf[typingsSlinky.terser.terserNumbers.`2016`]
    
    @scala.inline
    def `2017`: typingsSlinky.terser.terserNumbers.`2017` = 2017.asInstanceOf[typingsSlinky.terser.terserNumbers.`2017`]
    
    @scala.inline
    def `2018`: typingsSlinky.terser.terserNumbers.`2018` = 2018.asInstanceOf[typingsSlinky.terser.terserNumbers.`2018`]
    
    @scala.inline
    def `2019`: typingsSlinky.terser.terserNumbers.`2019` = 2019.asInstanceOf[typingsSlinky.terser.terserNumbers.`2019`]
    
    @scala.inline
    def `2020`: typingsSlinky.terser.terserNumbers.`2020` = 2020.asInstanceOf[typingsSlinky.terser.terserNumbers.`2020`]
    
    @scala.inline
    def `5`: typingsSlinky.terser.terserNumbers.`5` = 5.asInstanceOf[typingsSlinky.terser.terserNumbers.`5`]
  }
  ...
  object FormatOptions {
    ...
    implicit class FormatOptionsMutableBuilder[Self <: FormatOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCommentsRegExp(value: js.RegExp): Self = StObject.set(x, "comments", value.asInstanceOf[js.Any])
  ...
  object ManglePropertiesOptions {
    ...
    implicit class ManglePropertiesOptionsMutableBuilder[Self <: ManglePropertiesOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRegex(value: js.RegExp | String): Self = StObject.set(x, "regex", value.asInstanceOf[js.Any])
