...
object OutputQuoteStyle extends js.Object {
  ...
  /* 2 */ val AlwaysDouble: typingsSlinky.terser.terserMod.OutputQuoteStyle.AlwaysDouble with Double = js.native
  /* 3 */ val AlwaysOriginal: typingsSlinky.terser.terserMod.OutputQuoteStyle.AlwaysOriginal with Double = js.native
  /* 1 */ val AlwaysSingle: typingsSlinky.terser.terserMod.OutputQuoteStyle.AlwaysSingle with Double = js.native
  /* 0 */ val PreferDouble: typingsSlinky.terser.terserMod.OutputQuoteStyle.PreferDouble with Double = js.native
  @JSBracketAccess
