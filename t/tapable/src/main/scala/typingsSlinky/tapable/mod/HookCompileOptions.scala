...
object HookCompileOptions {
  ...
  @scala.inline
  implicit class HookCompileOptionsOps[Self <: HookCompileOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: TapType): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
