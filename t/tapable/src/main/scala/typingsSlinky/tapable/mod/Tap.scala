...
object Tap {
  ...
  @scala.inline
  implicit class TapOps[Self <: Tap[_, _, _, _, _], TTapType /* <: TapType */, TArg1, TArg2, TArg3, THookResult] (val x: Self with (Tap[TTapType, TArg1, TArg2, TArg3, THookResult])) extends AnyVal {
