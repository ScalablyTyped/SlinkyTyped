...
object Tap {
  @scala.inline
  def apply[/* <: typingsSlinky.tapable.mod.TapType */ TTapType, TArg1, TArg2, TArg3, THookResult](
  ...
  @scala.inline
  implicit class TapOps[Self <: Tap[_, _, _, _, _], /* <: typingsSlinky.tapable.mod.TapType */ TTapType, TArg1, TArg2, TArg3, THookResult] (val x: Self with (Tap[TTapType, TArg1, TArg2, TArg3, THookResult])) extends AnyVal {
    @scala.inline
