...
import typingsSlinky.tapable.anon.Before
import typingsSlinky.tapable.anon.Fn
import typingsSlinky.tapable.anon.FnType
import typingsSlinky.tapable.anon.Type
import typingsSlinky.tapable.anon.`0`
import typingsSlinky.tapable.mod.Tapable.CallbackFunction
import typingsSlinky.tapable.mod.Tapable.Handler
import typingsSlinky.tapable.mod.Tapable.Plugin
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.tapable.tapableStrings.sync
    - typingsSlinky.tapable.tapableStrings.async
    - typingsSlinky.tapable.tapableStrings.promise
  */
