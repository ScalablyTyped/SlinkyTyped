...
import typingsSlinky.typescriptDashCollections.distLibLinkedDictionaryMod.LinkedDictionary
...
@js.native
object distLibLinkedDictionaryMod extends js.Object {
  @js.native
  trait LinkedDictionary[K, V]
    extends typingsSlinky.typescriptDashCollections.distLibDictionaryMod.default[K, V] {
