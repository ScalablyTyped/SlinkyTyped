package typingsSlinky.typescriptDashCollections.distLibSetMod
...
trait Set[T] extends js.Object {
  /**
    ...
    * @protected
    */
  var dictionary: typingsSlinky.typescriptDashCollections.distLibDictionaryMod.default[T, _]
  /**
...
object Set {
  ...
  def apply[T](
    ...
    clear: () => Unit,
    contains: T => Boolean,
    dictionary: typingsSlinky.typescriptDashCollections.distLibDictionaryMod.default[T, _],
