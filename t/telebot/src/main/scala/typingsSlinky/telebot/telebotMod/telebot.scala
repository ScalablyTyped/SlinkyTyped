...
import typingsSlinky.telebot.Anon_CacheTime
import typingsSlinky.telebot.Anon_Caption
import typingsSlinky.telebot.Anon_CaptionDuration
import typingsSlinky.telebot.Anon_CaptionDurationFileName
import typingsSlinky.telebot.Anon_CaptionDurationFileNameNotification
import typingsSlinky.telebot.Anon_ChatId
import typingsSlinky.telebot.Anon_ChatIdInlineMessageId
import typingsSlinky.telebot.Anon_ChatIdInlineMsgId
import typingsSlinky.telebot.Anon_ChatIdInlineMsgIdMessageId
import typingsSlinky.telebot.Anon_Currency
import typingsSlinky.telebot.Anon_Duration
import typingsSlinky.telebot.Anon_ErrorMessage
import typingsSlinky.telebot.Anon_ErrorMessageString
import typingsSlinky.telebot.Anon_FileName
import typingsSlinky.telebot.Anon_FoursquareId
import typingsSlinky.telebot.Anon_Limit
import typingsSlinky.telebot.Anon_Notification
import typingsSlinky.telebot.Anon_NotificationBoolean
import typingsSlinky.telebot.Anon_NotificationReplyMarkup
...
trait telebot extends js.Object {
  ...
  def setGameScore(user_id: Double, score: Double, opt: Anon_ChatId): Boolean | js.Error | js.Any = js.native
