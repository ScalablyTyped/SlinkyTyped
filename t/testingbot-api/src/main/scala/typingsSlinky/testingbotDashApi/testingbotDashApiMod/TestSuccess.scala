...
object TestSuccess {
  @scala.inline
  def `0`: typingsSlinky.testingbotDashApi.testingbotDashApiNumbers.`0` = this.cast(0)
  @scala.inline
  def `1`: typingsSlinky.testingbotDashApi.testingbotDashApiNumbers.`1` = this.cast(1)
  @scala.inline
