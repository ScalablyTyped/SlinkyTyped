...
object GeometryObject {
  ...
  def GeometryCollection[P /* <: Properties */](
    ...
    `type`: typingsSlinky.topojsonDashSpecification.topojsonDashSpecificationStrings.GeometryCollection,
    bbox: BBox = null,
  ...
  def MultiPoint[P /* <: Properties */](
    ...
    `type`: typingsSlinky.topojsonDashSpecification.topojsonDashSpecificationStrings.MultiPoint,
    bbox: BBox = null,
    id: Double | String = null,
    properties: P = null
  ): GeometryObject[P] = {
  ...
  def Point[P /* <: Properties */](
    ...
    `type`: typingsSlinky.topojsonDashSpecification.topojsonDashSpecificationStrings.Point,
    bbox: BBox = null,
    id: Double | String = null,
    properties: P = null
  ): GeometryObject[P] = {
  ...
  def Polygon[P /* <: Properties */](
    ...
    `type`: typingsSlinky.topojsonDashSpecification.topojsonDashSpecificationStrings.Polygon,
    bbox: BBox = null,
    id: Double | String = null,
    properties: P = null
  ): GeometryObject[P] = {
  ...
  def MultiLineString[P /* <: Properties */](
    arcs: js.Array[ArcIndexes],
    `type`: typingsSlinky.topojsonDashSpecification.topojsonDashSpecificationStrings.MultiLineString,
    bbox: BBox = null,
    id: Double | String = null,
    properties: P = null
  ): GeometryObject[P] = {
  ...
  def MultiPolygon[P /* <: Properties */](
    ...
    `type`: typingsSlinky.topojsonDashSpecification.topojsonDashSpecificationStrings.MultiPolygon,
    bbox: BBox = null,
    id: Double | String = null,
    properties: P = null
  ): GeometryObject[P] = {
