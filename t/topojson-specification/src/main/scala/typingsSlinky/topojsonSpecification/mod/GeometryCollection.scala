...
object GeometryCollection {
  ...
  @scala.inline
  implicit class GeometryCollectionOps[Self <: GeometryCollection[_], /* <: typingsSlinky.topojsonSpecification.mod.Properties */ P] (val x: Self with GeometryCollection[P]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typingsSlinky.topojsonSpecification.topojsonSpecificationStrings.GeometryCollection): Self = this.set("type", value.asInstanceOf[js.Any])
  }
