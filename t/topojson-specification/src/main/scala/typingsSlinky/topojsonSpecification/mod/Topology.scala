...
object Topology {
  @scala.inline
  def apply[/* <: typingsSlinky.topojsonSpecification.mod.Objects[typingsSlinky.topojsonSpecification.mod.Properties] */ T](
    arcs: js.Array[Arc],
    objects: T,
  ...
  @scala.inline
  implicit class TopologyOps[Self <: Topology[_], /* <: typingsSlinky.topojsonSpecification.mod.Objects[typingsSlinky.topojsonSpecification.mod.Properties] */ T] (val x: Self with Topology[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typingsSlinky.topojsonSpecification.topojsonSpecificationStrings.Topology): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
