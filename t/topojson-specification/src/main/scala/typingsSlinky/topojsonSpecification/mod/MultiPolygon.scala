...
object MultiPolygon {
  ...
  @scala.inline
  implicit class MultiPolygonOps[Self <: MultiPolygon[_], /* <: typingsSlinky.topojsonSpecification.mod.Properties */ P] (val x: Self with MultiPolygon[P]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typingsSlinky.topojsonSpecification.topojsonSpecificationStrings.MultiPolygon): Self = this.set("type", value.asInstanceOf[js.Any])
  }
