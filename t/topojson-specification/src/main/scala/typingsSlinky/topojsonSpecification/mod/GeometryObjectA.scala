...
object GeometryObjectA {
  @scala.inline
  def apply[/* <: typingsSlinky.topojsonSpecification.mod.Properties */ P](): GeometryObjectA[P] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GeometryObjectA[P]]
  }
  @scala.inline
  implicit class GeometryObjectAOps[Self <: GeometryObjectA[_], /* <: typingsSlinky.topojsonSpecification.mod.Properties */ P] (val x: Self with GeometryObjectA[P]) extends AnyVal {
    @scala.inline
