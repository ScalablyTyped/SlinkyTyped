...
object MultiLineString {
  ...
  @scala.inline
  implicit class MultiLineStringOps[Self[p] <: MultiLineString[p], P] (val x: Self[P]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.topojsonSpecification.topojsonSpecificationStrings.MultiLineString): Self[P] = {
        val ret = this.duplicate
