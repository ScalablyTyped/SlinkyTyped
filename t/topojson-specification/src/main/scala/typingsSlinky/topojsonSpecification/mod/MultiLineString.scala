...
object MultiLineString {
  ...
  @scala.inline
  implicit class MultiLineStringOps[Self <: MultiLineString[_], /* <: typingsSlinky.topojsonSpecification.mod.Properties */ P] (val x: Self with MultiLineString[P]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typingsSlinky.topojsonSpecification.topojsonSpecificationStrings.MultiLineString): Self = this.set("type", value.asInstanceOf[js.Any])
  }
