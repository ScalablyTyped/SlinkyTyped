...
@JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "sparseToDense")
@js.native
object sparseToDense extends js.Object {
  
  def apply[R /* <: typingsSlinky.tensorflowTfjsCore.distTypesMod.Rank */](
    sparseIndices: Tensor[typingsSlinky.tensorflowTfjsCore.distTypesMod.Rank],
    sparseValues: Tensor[typingsSlinky.tensorflowTfjsCore.distTypesMod.Rank],
