...
object backendUtil {
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.assertAndGetBroadcastShape")
  @js.native
  def assertAndGetBroadcastShape(shapeA: js.Array[Double], shapeB: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.assertAxesAreInnerMostDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.axesAreInnerMostDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.complexWithOddIndex")
  @js.native
  ...
  object segmentUtil {
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.segment_util.collectGatherOpShapeInfo")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.segment_util.computeOutShape")
    @js.native
    def computeOutShape(aShape: js.Array[Double], axis: Double, numSegments: Double): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.segment_util.segOpComputeOptimalWindowSize")
    @js.native
  ...
  object sliceUtil {
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.assertParamsValid")
    @js.native
    def assertParamsValid(input: TensorInfo, begin: js.Array[Double], size: js.Array[Double]): Unit = js.native
    
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.computeFlatOffset")
    @js.native
    def computeFlatOffset(begin: js.Array[Double], strides: js.Array[Double]): Double = js.native
    
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.computeOutShape")
    @js.native
    def computeOutShape(begin: js.Array[Double], end: js.Array[Double], strides: js.Array[Double]): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.getNormalizedAxes")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.isSliceContinous")
    @js.native
    def isSliceContinous(shape: js.Array[Double], begin: js.Array[Double], size: js.Array[Double]): Boolean = js.native
    
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.maskToAxes")
    @js.native
    def maskToAxes(mask: Double): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.parseSliceParams")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.startForAxis")
    @js.native
    def startForAxis(
      beginMask: Double,
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.startIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.stopForAxis")
    @js.native
    def stopForAxis(
      endMask: Double,
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.stopIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.stridesForAxis")
    @js.native
    def stridesForAxis(strides: js.Array[Double], axis: Double, ellipsisMask: Double): Double = js.native
    
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.slice_util.stridesWithElidedDims")
    @js.native
