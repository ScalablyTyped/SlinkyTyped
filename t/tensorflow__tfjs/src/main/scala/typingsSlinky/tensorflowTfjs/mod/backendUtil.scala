...
object backendUtil extends js.Object {
  ...
  def computeConv2DInfo(
    ...
    roundingMode: typingsSlinky.tensorflowTfjs.tensorflowTfjsStrings.floor | typingsSlinky.tensorflowTfjs.tensorflowTfjsStrings.round | typingsSlinky.tensorflowTfjs.tensorflowTfjsStrings.ceil
