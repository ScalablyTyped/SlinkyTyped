...
object signal {
  ...
  @JSImport("@tensorflow/tfjs", "signal.frame")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "signal.hammingWindow")
  @js.native
  def hammingWindow(windowLength: Double): Tensor[R1] = js.native
  
  @JSImport("@tensorflow/tfjs", "signal.hannWindow")
  @js.native
  def hannWindow(windowLength: Double): Tensor[R1] = js.native
  
  @JSImport("@tensorflow/tfjs", "signal.stft")
  @js.native
