...
object data extends js.Object {
  ...
  class CSVDataset protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.atTensorflowTfjsDashDataMod.CSVDataset {
    /**
      * Create a `CSVDataset`.
      *
  ...
  abstract class Dataset[T /* <: TensorContainer */] ()
    extends typingsSlinky.atTensorflowTfjsDashData.atTensorflowTfjsDashDataMod.Dataset[T]
  
  @js.native
  class FileDataSource protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.atTensorflowTfjsDashDataMod.FileDataSource {
  ...
  class TextLineDataset protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.atTensorflowTfjsDashDataMod.TextLineDataset {
    /**
  ...
  class URLDataSource protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.atTensorflowTfjsDashDataMod.URLDataSource {
    /**
