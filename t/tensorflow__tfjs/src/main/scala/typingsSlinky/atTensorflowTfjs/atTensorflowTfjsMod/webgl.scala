...
import typingsSlinky.atTensorflowTfjs.atTensorflowTfjsNumbers.`1`
import typingsSlinky.atTensorflowTfjs.atTensorflowTfjsNumbers.`2`
...
object webgl extends js.Object {
  @js.native
  class GPGPUContext ()
    extends typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreMod.webgl.GPGPUContext {
    def this(gl: WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreMod.webgl.MathBackendWebGL {
