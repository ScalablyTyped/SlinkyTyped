...
@js.native
class Tensor[R /* <: typingsSlinky.atTensorflowTfjsDashCore.distTypesMod.Rank */] protected ()
  extends typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreMod.Tensor[R] {
  def this(
...
object tensor extends js.Object {
  ...
  def apply[R /* <: typingsSlinky.atTensorflowTfjsDashCore.distTypesMod.Rank */](values: TensorLike): typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[R] = js.native
