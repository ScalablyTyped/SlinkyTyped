...
import typingsSlinky.tensorflowTfjsBackendWebgl.shaderCompilerMod.ShapeInfo
...
object gpgpuMathMod {
  ...
  object TensorData {
    ...
    implicit class TensorDataMutableBuilder[Self <: TensorData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUniformValuesFloat32Array(value: js.typedarray.Float32Array): Self = StObject.set(x, "uniformValues", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUniformValuesInt32Array(value: js.typedarray.Int32Array): Self = StObject.set(x, "uniformValues", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUniformValuesUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "uniformValues", value.asInstanceOf[js.Any])
