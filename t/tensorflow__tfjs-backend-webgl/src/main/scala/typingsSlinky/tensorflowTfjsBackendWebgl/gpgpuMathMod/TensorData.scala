...
object TensorData {
  ...
  implicit class TensorDataOps[Self <: TensorData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUniformValuesInt32Array(value: js.typedarray.Int32Array): Self = this.set("uniformValues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUniformValuesFloat32Array(value: js.typedarray.Float32Array): Self = this.set("uniformValues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUniformValuesUint8Array(value: js.typedarray.Uint8Array): Self = this.set("uniformValues", value.asInstanceOf[js.Any])
