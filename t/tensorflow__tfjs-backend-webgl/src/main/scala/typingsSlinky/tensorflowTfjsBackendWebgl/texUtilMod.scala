...
object texUtilMod {
  ...
  object PackingScheme extends StObject {
    ...
    /* 0 */ val DENSE: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.PackingScheme.DENSE with Double = js.native
    ...
    /* 1 */ val SHARED_BATCH: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.PackingScheme.SHARED_BATCH with Double = js.native
  }
  ...
  object PhysicalTextureType extends StObject {
    ...
    /* 4 */ val PACKED_2X2_FLOAT16: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.PhysicalTextureType.PACKED_2X2_FLOAT16 with Double = js.native
    
    @js.native
    sealed trait PACKED_2X2_FLOAT32 extends PhysicalTextureType
    /* 3 */ val PACKED_2X2_FLOAT32: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.PhysicalTextureType.PACKED_2X2_FLOAT32 with Double = js.native
    
    @js.native
    sealed trait PACKED_4X1_UNSIGNED_BYTE extends PhysicalTextureType
    /* 2 */ val PACKED_4X1_UNSIGNED_BYTE: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.PhysicalTextureType.PACKED_4X1_UNSIGNED_BYTE with Double = js.native
    
    @js.native
    sealed trait UNPACKED_FLOAT16 extends PhysicalTextureType
    /* 0 */ val UNPACKED_FLOAT16: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.PhysicalTextureType.UNPACKED_FLOAT16 with Double = js.native
    
    @js.native
    sealed trait UNPACKED_FLOAT32 extends PhysicalTextureType
    /* 1 */ val UNPACKED_FLOAT32: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.PhysicalTextureType.UNPACKED_FLOAT32 with Double = js.native
  }
  ...
  object TextureUsage extends StObject {
    ...
    /* 3 */ val DOWNLOAD: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.TextureUsage.DOWNLOAD with Double = js.native
    
    @js.native
    sealed trait PIXELS extends TextureUsage
    /* 2 */ val PIXELS: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.TextureUsage.PIXELS with Double = js.native
    
    @js.native
    sealed trait RENDER extends TextureUsage
    /* 0 */ val RENDER: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.TextureUsage.RENDER with Double = js.native
    
    @js.native
    sealed trait UPLOAD extends TextureUsage
    /* 1 */ val UPLOAD: typingsSlinky.tensorflowTfjsBackendWebgl.texUtilMod.TextureUsage.UPLOAD with Double = js.native
  }
  
  @JSImport("@tensorflow/tfjs-backend-webgl/dist/tex_util", "decodeMatrixFromUnpackedColorRGBAArray")
  @js.native
  def decodeMatrixFromUnpackedColorRGBAArray(unpackedArray: js.typedarray.Float32Array, matrix: js.typedarray.Float32Array, channels: Double): Unit = js.native
