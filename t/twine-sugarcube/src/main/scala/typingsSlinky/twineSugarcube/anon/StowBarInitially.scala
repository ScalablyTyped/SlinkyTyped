...
@js.native
trait StowBarInitially extends js.Object {
...
object StowBarInitially {
  ...
  @scala.inline
  implicit class StowBarInitiallyOps[Self <: StowBarInitially] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStowBarInitially(value: Boolean | Double): Self = this.set("stowBarInitially", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUpdateStoryElements(value: Boolean): Self = this.set("updateStoryElements", value.asInstanceOf[js.Any])
  }
}
