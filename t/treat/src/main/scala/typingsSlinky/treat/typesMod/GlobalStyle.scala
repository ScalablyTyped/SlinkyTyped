...
/* Inlined treat.treat/lib/types/types.CSSProperties & treat.treat/lib/types/types.MediaQueries<treat.treat/lib/types/types.CSSProperties> & treat.treat/lib/types/types.FeatureQueries<treat.treat/lib/types/types.CSSProperties> */
@js.native
trait GlobalStyle extends js.Object {
  
  var `@keyframes`: js.UndefOr[CSSKeyframes | String] = js.native
  
  var `@media`: js.UndefOr[StringDictionary[CSSProperties]] = js.native
  
  var `@supports`: js.UndefOr[StringDictionary[CSSProperties]] = js.native
...
object GlobalStyle {
  ...
  @scala.inline
  def apply(): GlobalStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GlobalStyle]
  }
  
  @scala.inline
  implicit class GlobalStyleOps[Self <: GlobalStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `set@keyframes`(value: CSSKeyframes | String): Self = this.set("@keyframes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `delete@keyframes`: Self = this.set("@keyframes", js.undefined)
    
    @scala.inline
    def `set@media`(value: StringDictionary[CSSProperties]): Self = this.set("@media", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `delete@media`: Self = this.set("@media", js.undefined)
    
    @scala.inline
    def `set@supports`(value: StringDictionary[CSSProperties]): Self = this.set("@supports", value.asInstanceOf[js.Any])
