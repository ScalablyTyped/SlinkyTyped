...
import typingsSlinky.torrentDashStream.torrentDashStreamStrings.download
import typingsSlinky.torrentDashStream.torrentDashStreamStrings.idle
import typingsSlinky.torrentDashStream.torrentDashStreamStrings.ready
import typingsSlinky.torrentDashStream.torrentDashStreamStrings.torrent
import typingsSlinky.torrentDashStream.torrentDashStreamStrings.upload
