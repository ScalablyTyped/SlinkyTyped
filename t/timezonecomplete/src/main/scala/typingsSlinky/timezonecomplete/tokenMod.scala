...
object tokenMod {
  ...
  object TokenType extends StObject {
    ...
    /* 6 */ val DAY: typingsSlinky.timezonecomplete.tokenMod.TokenType.DAY with Double = js.native
    
    @js.native
    sealed trait DAYPERIOD extends TokenType
    /* 8 */ val DAYPERIOD: typingsSlinky.timezonecomplete.tokenMod.TokenType.DAYPERIOD with Double = js.native
    
    @js.native
    sealed trait ERA extends TokenType
    /* 1 */ val ERA: typingsSlinky.timezonecomplete.tokenMod.TokenType.ERA with Double = js.native
    
    @js.native
    sealed trait HOUR extends TokenType
    /* 9 */ val HOUR: typingsSlinky.timezonecomplete.tokenMod.TokenType.HOUR with Double = js.native
    ...
    /* 0 */ val IDENTITY: typingsSlinky.timezonecomplete.tokenMod.TokenType.IDENTITY with Double = js.native
    
    @js.native
    sealed trait MINUTE extends TokenType
    /* 10 */ val MINUTE: typingsSlinky.timezonecomplete.tokenMod.TokenType.MINUTE with Double = js.native
    
    @js.native
    sealed trait MONTH extends TokenType
    /* 4 */ val MONTH: typingsSlinky.timezonecomplete.tokenMod.TokenType.MONTH with Double = js.native
    
    @js.native
    sealed trait QUARTER extends TokenType
    /* 3 */ val QUARTER: typingsSlinky.timezonecomplete.tokenMod.TokenType.QUARTER with Double = js.native
    
    @js.native
    sealed trait SECOND extends TokenType
    /* 11 */ val SECOND: typingsSlinky.timezonecomplete.tokenMod.TokenType.SECOND with Double = js.native
    
    @js.native
    sealed trait WEEK extends TokenType
    /* 5 */ val WEEK: typingsSlinky.timezonecomplete.tokenMod.TokenType.WEEK with Double = js.native
    
    @js.native
    sealed trait WEEKDAY extends TokenType
    /* 7 */ val WEEKDAY: typingsSlinky.timezonecomplete.tokenMod.TokenType.WEEKDAY with Double = js.native
    
    @js.native
    sealed trait YEAR extends TokenType
    /* 2 */ val YEAR: typingsSlinky.timezonecomplete.tokenMod.TokenType.YEAR with Double = js.native
    
    @js.native
    sealed trait ZONE extends TokenType
    /* 12 */ val ZONE: typingsSlinky.timezonecomplete.tokenMod.TokenType.ZONE with Double = js.native
  }
