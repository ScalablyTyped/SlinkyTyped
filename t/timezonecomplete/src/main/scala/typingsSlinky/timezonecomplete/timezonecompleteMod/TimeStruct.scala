...
import typingsSlinky.timezonecomplete.distLibBasicsMod.TimeComponentOpts
...
class TimeStruct protected ()
  extends typingsSlinky.timezonecomplete.distLibBasicsMod.TimeStruct {
  /**
    * Constructor
    *
...
object TimeStruct extends js.Object {
  ...
  ): typingsSlinky.timezonecomplete.distLibBasicsMod.TimeStruct = js.native
  /**
    ...
    * @throws nothing
    */
  def fromDate(d: js.Date, df: typingsSlinky.timezonecomplete.distLibJavascriptMod.DateFunctions): typingsSlinky.timezonecomplete.distLibBasicsMod.TimeStruct = js.native
  /**
    * Returns a TimeStruct from an ISO 8601 string WITHOUT time zone
    * @throws timezonecomplete.Argument.S if `s` is not a proper iso string
    */
  def fromString(s: String): typingsSlinky.timezonecomplete.distLibBasicsMod.TimeStruct = js.native
  /**
    * Create a TimeStruct from a number of unix milliseconds
    * (backward compatibility)
    * @throws timezonecomplete.Argument.UnixMillis for non-integer milliseconds
    */
  def fromUnix(unixMillis: Double): typingsSlinky.timezonecomplete.distLibBasicsMod.TimeStruct = js.native
}
