...
/**
  ...
  */
class Duration ()
  extends typingsSlinky.timezonecomplete.distLibDurationMod.Duration {
  /**
  ...
  def this(amount: Double, unit: typingsSlinky.timezonecomplete.distLibBasicsMod.TimeUnit) = this()
}
...
object Duration extends js.Object {
  /**
    ...
    */
  def days(amount: Double): typingsSlinky.timezonecomplete.distLibDurationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def hours(amount: Double): typingsSlinky.timezonecomplete.distLibDurationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def milliseconds(amount: Double): typingsSlinky.timezonecomplete.distLibDurationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def minutes(amount: Double): typingsSlinky.timezonecomplete.distLibDurationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def months(amount: Double): typingsSlinky.timezonecomplete.distLibDurationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def seconds(amount: Double): typingsSlinky.timezonecomplete.distLibDurationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def years(amount: Double): typingsSlinky.timezonecomplete.distLibDurationMod.Duration = js.native
}
