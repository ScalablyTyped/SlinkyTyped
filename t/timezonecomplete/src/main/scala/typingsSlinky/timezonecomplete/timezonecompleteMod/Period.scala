...
import typingsSlinky.timezonecomplete.distLibPeriodMod.PeriodJson
...
class Period protected ()
  extends typingsSlinky.timezonecomplete.distLibPeriodMod.Period {
  /**
    * Constructor
  ...
  /**
    ...
    */
  def this(
    reference: typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime,
    interval: typingsSlinky.timezonecomplete.distLibDurationMod.Duration
  ) = this()
  /**
    * Constructor
    * LIMITATION: if dst equals RegularLocalTime, and unit is Second, Minute or Hour,
  ...
  def this(
    reference: typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime,
    amount: Double,
    unit: typingsSlinky.timezonecomplete.distLibBasicsMod.TimeUnit
  ) = this()
  def this(
    reference: typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime,
    interval: typingsSlinky.timezonecomplete.distLibDurationMod.Duration,
    dst: typingsSlinky.timezonecomplete.distLibPeriodMod.PeriodDst
  ) = this()
  def this(
    reference: typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime,
    amount: Double,
