...
class TimeZone protected ()
  extends typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone
...
object TimeZone extends js.Object {
  ...
  /**
    ...
    * @throws nothing
    */
  def local(): typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone = js.native
  /**
  ...
  /**
    ...
    */
  def utc(): typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone = js.native
  /**
    ...
    */
  def zone(offset: Double): typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone = js.native
  /**
    ...
    */
  def zone(s: String): typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone = js.native
  def zone(s: String, dst: Boolean): typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone = js.native
}
