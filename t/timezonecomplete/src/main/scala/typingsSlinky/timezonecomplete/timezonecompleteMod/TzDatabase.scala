...
class TzDatabase protected ()
  extends typingsSlinky.timezonecomplete.distLibTzDashDatabaseMod.TzDatabase
...
object TzDatabase extends js.Object {
  ...
  /**
    ...
    */
  def instance(): typingsSlinky.timezonecomplete.distLibTzDashDatabaseMod.TzDatabase = js.native
}
