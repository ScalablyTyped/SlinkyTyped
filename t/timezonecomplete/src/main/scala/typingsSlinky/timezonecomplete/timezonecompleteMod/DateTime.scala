...
import typingsSlinky.timezonecomplete.distLibTimesourceMod.TimeSource
...
/**
  ...
  */
class DateTime ()
  extends typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime {
  /**
  ...
  /**
    ...
    */
  def this(tm: typingsSlinky.timezonecomplete.distLibBasicsMod.TimeStruct) = this()
  /**
    * Constructor
  ...
  /**
    ...
    */
  def this(date: js.Date, getFuncs: typingsSlinky.timezonecomplete.distLibJavascriptMod.DateFunctions) = this()
  def this(isoString: String, timeZone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone) = this()
  def this(
    tm: typingsSlinky.timezonecomplete.distLibBasicsMod.TimeStruct,
    timeZone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone
  ) = this()
  def this(unixTimestamp: Double, timeZone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone) = this()
  def this(
    dateString: String,
    formatString: String,
    timeZone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone
  ...
  def this(
    date: js.Date,
    getFuncs: typingsSlinky.timezonecomplete.distLibJavascriptMod.DateFunctions,
    timeZone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone
  ) = this()
  /**
...
object DateTime extends js.Object {
  ...
  def exists(
    ...
    zone: js.UndefOr[Null | typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone],
  ...
  /**
    ...
    * @throws timezonecomplete.Argument.TimeZone if the given time zone is invalid
    */
  def fromExcel(n: Double): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  def fromExcel(n: Double, timeZone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  /**
    * Current date+time in the given time zone
    * @param timeZone	The desired time zone (optional, defaults to UTC).
    * @throws timezonecomplete.NotFound.Zone if the UTC time zone doesn't exist in the time zone database
    */
  def now(): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  def now(timeZone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  /**
    * Current date+time in local time
    * @throws nothing
    */
  def nowLocal(): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  /**
    * Current date+time in UTC time
    * @throws timezonecomplete.NotFound.Zone if the UTC time zone doesn't exist in the time zone database
    */
  def nowUtc(): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  /**
    ...
    * @throws timezonecomplete.Argument.FormatString if the given format string is invalid
    */
  def parse(s: String, format: String): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  def parse(s: String, format: String, zone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  def parse(
    s: String,
    format: String,
    zone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone,
    locale: PartialLocale
  ): typingsSlinky.timezonecomplete.distLibDatetimeMod.DateTime = js.native
  def parse(
    s: String,
    format: String,
    zone: typingsSlinky.timezonecomplete.distLibTimezoneMod.TimeZone,
