...
class DateTime ()
  ...
  /**
    ...
    */
  def this(date: js.Date, getFuncs: typingsSlinky.timezonecomplete.javascriptMod.DateFunctions) = this()
  ...
  def this(
    date: js.Date,
    getFuncs: typingsSlinky.timezonecomplete.javascriptMod.DateFunctions,
    timeZone: typingsSlinky.timezonecomplete.timezoneMod.TimeZone
  ) = this()
  /**
...
object DateTime extends js.Object {
  ...
  def exists(
    ...
    zone: js.UndefOr[Null | typingsSlinky.timezonecomplete.timezoneMod.TimeZone],
