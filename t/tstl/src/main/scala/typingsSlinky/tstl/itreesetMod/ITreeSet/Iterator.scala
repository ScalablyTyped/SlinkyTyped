...
@js.native
trait Iterator[Key, Unique /* <: Boolean */, SourceT /* <: typingsSlinky.tstl.itreesetMod.ITreeSet[Key, Unique, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, Unique, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, Unique, SourceT, IteratorT, ReverseT] */] extends js.Object {
...
object Iterator {
  ...
  @scala.inline
  def apply[Key, Unique /* <: Boolean */, SourceT /* <: typingsSlinky.tstl.itreesetMod.ITreeSet[Key, Unique, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, Unique, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, Unique, SourceT, IteratorT, ReverseT] */](
    next: () => IteratorT,
    prev: () => IteratorT,
    reverse: () => ReverseT,
    source: () => SourceT,
  ...
  @scala.inline
  implicit class IteratorOps[Self <: Iterator[_, _, _, _, _], Key, Unique /* <: Boolean */, SourceT /* <: typingsSlinky.tstl.itreesetMod.ITreeSet[Key, Unique, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, Unique, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, Unique, SourceT, IteratorT, ReverseT] */] (val x: Self with (Iterator[Key, Unique, SourceT, IteratorT, ReverseT])) extends AnyVal {
