...
object minmax_element extends js.Object {
  def apply[ForwardIterator /* <: IForwardIterator[ValueType[ForwardIterator], ForwardIterator] */](first: ForwardIterator, last: ForwardIterator): typingsSlinky.tstl.utilityPairMod.Pair[ForwardIterator, ForwardIterator] = js.native
