...
/**
  ...
  */
class List[T] ()
  extends typingsSlinky.tstl.containerMod.List[T] {
  /**
  ...
  /**
    ...
    */
  def this(obj: typingsSlinky.tstl.containerListMod.List[T]) = this()
  /**
    * Range Constructor.
    *
...
object List extends js.Object {
  ...
  class Iterator[T] protected ()
    extends typingsSlinky.tstl.containerMod.List.Iterator[T]
