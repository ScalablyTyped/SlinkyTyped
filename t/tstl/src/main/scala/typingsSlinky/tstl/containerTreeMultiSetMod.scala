...
object containerTreeMultiSetMod extends js.Object {
  ...
  object TreeMultiSet extends js.Object {
    ...
    type iterator[Key] = typingsSlinky.tstl.containerTreeMultiSetMod.TreeMultiSet.Iterator[Key]
    type reverse_iterator[Key] = typingsSlinky.tstl.containerTreeMultiSetMod.TreeMultiSet.ReverseIterator[Key]
  }
