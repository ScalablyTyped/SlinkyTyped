...
import typingsSlinky.tstl.baseContainerUniqueTreeMapMod.UniqueTreeMap
import typingsSlinky.tstl.experimentalContainerFlatMapMod.FlatMap
import typingsSlinky.tstl.experimentalContainerFlatMapMod.FlatMap.Iterator
import typingsSlinky.tstl.experimentalContainerFlatMapMod.FlatMap.ReverseIterator
...
object experimentalContainerFlatMapMod extends js.Object {
  ...
  object FlatMap extends js.Object {
    ...
    type Iterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementVectorMod.MapElementVector.Iterator[Key, T, `true`, FlatMap[Key, T]]
    type ReverseIterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementVectorMod.MapElementVector.ReverseIterator[Key, T, `true`, FlatMap[Key, T]]
    type iterator[Key, T] = typingsSlinky.tstl.experimentalContainerFlatMapMod.FlatMap.Iterator[Key, T]
    type reverse_iterator[Key, T] = typingsSlinky.tstl.experimentalContainerFlatMapMod.FlatMap.ReverseIterator[Key, T]
  }
