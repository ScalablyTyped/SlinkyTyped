...
object containerVectorMod extends js.Object {
  ...
  object Vector extends js.Object {
    ...
    type iterator[T] = typingsSlinky.tstl.containerVectorMod.Vector.Iterator[T]
    type reverse_iterator[T] = typingsSlinky.tstl.containerVectorMod.Vector.ReverseIterator[T]
  }
