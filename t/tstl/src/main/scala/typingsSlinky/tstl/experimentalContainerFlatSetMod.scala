...
import typingsSlinky.tstl.experimentalContainerFlatSetMod.FlatSet
import typingsSlinky.tstl.experimentalContainerFlatSetMod.FlatSet.Iterator
import typingsSlinky.tstl.experimentalContainerFlatSetMod.FlatSet.ReverseIterator
...
object experimentalContainerFlatSetMod extends js.Object {
  ...
  object FlatSet extends js.Object {
    ...
    type Iterator[Key] = typingsSlinky.tstl.baseContainerSetElementVectorMod.SetElementVector.Iterator[Key, `true`, FlatSet[Key]]
    type ReverseIterator[Key] = typingsSlinky.tstl.baseContainerSetElementVectorMod.SetElementVector.ReverseIterator[Key, `true`, FlatSet[Key]]
    type iterator[Key] = typingsSlinky.tstl.experimentalContainerFlatSetMod.FlatSet.Iterator[Key]
    type reverse_iterator[Key] = typingsSlinky.tstl.experimentalContainerFlatSetMod.FlatSet.ReverseIterator[Key]
  }
