...
import typingsSlinky.tstl.containerTreeMapMod.TreeMap
import typingsSlinky.tstl.containerTreeMapMod.TreeMap.Iterator
import typingsSlinky.tstl.containerTreeMapMod.TreeMap.ReverseIterator
...
object containerTreeMapMod extends js.Object {
  ...
  object TreeMap extends js.Object {
    ...
    type Iterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `true`, TreeMap[Key, T]]
    type ReverseIterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.ReverseIterator[Key, T, `true`, TreeMap[Key, T]]
    type iterator[Key, T] = typingsSlinky.tstl.containerTreeMapMod.TreeMap.Iterator[Key, T]
    type reverse_iterator[Key, T] = typingsSlinky.tstl.containerTreeMapMod.TreeMap.ReverseIterator[Key, T]
  }
