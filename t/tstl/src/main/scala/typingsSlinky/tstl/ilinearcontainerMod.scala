...
import typingsSlinky.tstl.ilinearcontainerMod.ILinearContainer.Iterator
import typingsSlinky.tstl.ilinearcontainerMod.ILinearContainer.ReverseIterator
...
object ilinearcontainerMod extends js.Object {
  ...
  object ILinearContainer extends js.Object {
    /**
      ...
      */
    type Iterator[T /* <: ElemT */, SourceT /* <: ILinearContainer[T, SourceT, IteratorT, ReverseT, T] */, IteratorT /* <: /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias tstl.tstl/base/container/ILinearContainer.ILinearContainer.Iterator<T, SourceT, IteratorT, ReverseT, T> */ js.Object */, ReverseT /* <: ReverseIterator[T, SourceT, IteratorT, ReverseT, T] */, ElemT] = typingsSlinky.tstl.icontainerMod.IContainer.Iterator[T, SourceT, IteratorT, ReverseT, ElemT]
    /**
      * Reverse iterator of {@link ILinearContainer}
      *
      * @author Jenogho Nam <http://samchon.org>
      */
    type ReverseIterator[T /* <: ElemT */, SourceT /* <: ILinearContainer[T, SourceT, IteratorT, ReverseT, T] */, IteratorT /* <: Iterator[T, SourceT, IteratorT, ReverseT, T] */, ReverseT /* <: /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias tstl.tstl/base/container/ILinearContainer.ILinearContainer.ReverseIterator<T, SourceT, IteratorT, ReverseT, T> */ js.Object */, ElemT] = typingsSlinky.tstl.icontainerMod.IContainer.ReverseIterator[T, SourceT, IteratorT, ReverseT, ElemT]
  }
