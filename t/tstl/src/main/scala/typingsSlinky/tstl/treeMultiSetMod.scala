...
object treeMultiSetMod extends js.Object {
  ...
  object TreeMultiSet extends js.Object {
    ...
    /**
      ...
      */
    type Iterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.Iterator[Key, `false`, TreeMultiSet[Key]]
    /**
      * Reverse iterator of {@link TreeMultiSet}
      */
    type ReverseIterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.ReverseIterator[Key, `false`, TreeMultiSet[Key]]
  }
