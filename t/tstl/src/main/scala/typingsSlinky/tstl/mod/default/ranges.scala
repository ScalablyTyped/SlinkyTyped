...
object ranges extends js.Object {
  ...
  @JSName("equal_range")
  def equalRange[Range /* <: js.Array[_] | IForwardContainer[_] */](range: Range, `val`: ValueType[Range]): typingsSlinky.tstl.pairMod.Pair[IteratorType[Range], IteratorType[Range]] = js.native
  @JSName("equal_range")
  def equalRange[Range /* <: js.Array[_] | IForwardContainer[_] */](range: Range, `val`: ValueType[Range], comp: Comparator[ValueType[Range], ValueType[Range]]): typingsSlinky.tstl.pairMod.Pair[IteratorType[Range], IteratorType[Range]] = js.native
  ...
  def minmaxElement[Range /* <: js.Array[_] | IForwardContainer[_] */](range: Range): typingsSlinky.tstl.pairMod.Pair[IteratorType[Range], IteratorType[Range]] = js.native
  @JSName("minmax_element")
  def minmaxElement[Range /* <: js.Array[_] | IForwardContainer[_] */](range: Range, comp: Comparator[ValueType[Range], ValueType[Range]]): typingsSlinky.tstl.pairMod.Pair[IteratorType[Range], IteratorType[Range]] = js.native
  
  def mismatch[Range1 /* <: js.Array[_] | IForwardContainer[_] */](range1: Range1, range2: js.Array[ValueType[Range1]]): typingsSlinky.tstl.pairMod.Pair[IteratorType[Range1], IteratorType[js.Array[ValueType[Range1]]]] = js.native
  def mismatch[Range1 /* <: js.Array[_] | IForwardContainer[_] */](range1: Range1, range2: IForwardContainer[IForwardIterator[ValueType[Range1], _]]): typingsSlinky.tstl.pairMod.Pair[
    IteratorType[Range1], 
    IteratorType[IForwardContainer[IForwardIterator[ValueType[Range1], _]]]
  ] = js.native
  def mismatch[Range1 /* <: js.Array[_] | IForwardContainer[_] */, Range2 /* <: js.Array[_] */](range1: Range1, range2: Range2): typingsSlinky.tstl.pairMod.Pair[IteratorType[Range1], IteratorType[Range2]] = js.native
  def mismatch[Range1 /* <: js.Array[_] | IForwardContainer[_] */, Range2 /* <: js.Array[_] | IForwardContainer[_] */](range1: Range1, range2: Range2, pred: BinaryPredicatorInferrer[Range1, Range2]): typingsSlinky.tstl.pairMod.Pair[IteratorType[Range1], IteratorType[Range2]] = js.native
