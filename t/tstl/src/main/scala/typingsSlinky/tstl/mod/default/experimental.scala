...
object experimental extends js.Object {
  ...
  /**
    ...
    */
  class FlatMap[Key, T] ()
    extends typingsSlinky.tstl.tstlModuleMod.experimental.FlatMap[Key, T] {
  ...
  class FlatMultiMap[Key, T] ()
    extends typingsSlinky.tstl.tstlModuleMod.experimental.FlatMultiMap[Key, T] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  class FlatMultiSet[Key] ()
    extends typingsSlinky.tstl.tstlModuleMod.experimental.FlatMultiSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  /**
    ...
    */
  class FlatSet[Key] ()
    extends typingsSlinky.tstl.tstlModuleMod.experimental.FlatSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
