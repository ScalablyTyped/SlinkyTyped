...
object hashMultiSetMod extends js.Object {
  ...
  class HashMultiSet[Key] () extends MultiSet[Key, HashMultiSet[Key], Iterator[Key], ReverseIterator[Key]] {
    ...
    /* protected */ def _Handle_erase(
      first: (typingsSlinky.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]]) | Iterator[Key],
      last: (typingsSlinky.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]]) | Iterator[Key]
    ): Unit = js.native
    ...
    /* protected */ def _Insert_by_key_InsertRet(key: Key): InsertRet[
        ...
        `false`, 
        HashMultiSet[Key], 
        typingsSlinky.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]], 
        typingsSlinky.tstl.ihashsetMod.IHashSet.ReverseIterator[Key, `false`, HashMultiSet[Key]]
      ] = js.native
    /**
      ...
      */
    def begin(index: Double): typingsSlinky.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("begin")
    ...
    /**
      ...
      * @return Iterator from the specific bucket.
      */
    def end(index: Double): typingsSlinky.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("end")
  ...
  object HashMultiSet extends js.Object {
    ...
    /**
      ...
      */
    type Iterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.Iterator[Key, `false`, HashMultiSet[Key]]
    /**
      * Reverse iterator of {@link HashMultiSet}
      */
    type ReverseIterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.ReverseIterator[Key, `false`, HashMultiSet[Key]]
  }
