...
object ReverseIterator {
  ...
  @scala.inline
  def apply[T /* <: ElemT */, SourceT /* <: typingsSlinky.tstl.idequecontainerMod.IDequeContainer[T, SourceT, IteratorT, ReverseT, T] */, IteratorT /* <: Iterator[T, SourceT, IteratorT, ReverseT, T] */, ReverseT /* <: ReverseIterator[T, SourceT, IteratorT, ReverseT, T] */, ElemT](base: () => IteratorT, next: () => ReverseT, prev: () => ReverseT, source: () => SourceT, value: T): ReverseIterator[T, SourceT, IteratorT, ReverseT, ElemT] = {
  ...
  @scala.inline
  implicit class ReverseIteratorOps[Self <: ReverseIterator[_, _, _, _, _], T /* <: ElemT */, SourceT /* <: typingsSlinky.tstl.idequecontainerMod.IDequeContainer[T, SourceT, IteratorT, ReverseT, T] */, IteratorT /* <: Iterator[T, SourceT, IteratorT, ReverseT, T] */, ReverseT /* <: ReverseIterator[T, SourceT, IteratorT, ReverseT, T] */, ElemT] (val x: Self with (ReverseIterator[T, SourceT, IteratorT, ReverseT, ElemT])) extends AnyVal {
