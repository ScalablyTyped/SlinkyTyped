...
object experimentalMod extends js.Object {
  ...
  class flat_map[Key, T] ()
    extends typingsSlinky.tstl.experimentalContainerMod.flat_map[Key, T] {
    def this(comp: js.Function2[/* x */ Key, /* y */ Key, Boolean]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  class flat_multimap[Key, T] ()
    extends typingsSlinky.tstl.experimentalContainerMod.flat_multimap[Key, T] {
    def this(comp: js.Function2[/* x */ Key, /* y */ Key, Boolean]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  class flat_multiset[Key] ()
    extends typingsSlinky.tstl.experimentalContainerMod.flat_multiset[Key] {
    def this(comp: js.Function2[/* x */ Key, /* y */ Key, Boolean]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  /**
    ...
    */
  class flat_set[Key] ()
    extends typingsSlinky.tstl.experimentalContainerMod.flat_set[Key] {
    def this(comp: js.Function2[/* x */ Key, /* y */ Key, Boolean]) = this()
    /**
      * Initializer Constructor.
      *
