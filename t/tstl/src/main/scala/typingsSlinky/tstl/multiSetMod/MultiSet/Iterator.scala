package typingsSlinky.tstl.multiSetMod.MultiSet
...
@js.native
trait Iterator[Key, SourceT /* <: typingsSlinky.tstl.multiSetMod.MultiSet[Key, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, SourceT, IteratorT, ReverseT] */] extends js.Object {
...
object Iterator {
  ...
  @scala.inline
  def apply[Key, SourceT /* <: typingsSlinky.tstl.multiSetMod.MultiSet[Key, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, SourceT, IteratorT, ReverseT] */](
    next: () => IteratorT,
    prev: () => IteratorT,
    reverse: () => ReverseT,
    source: () => SourceT,
  ...
  @scala.inline
  implicit class IteratorOps[Self <: Iterator[_, _, _, _], Key, SourceT /* <: typingsSlinky.tstl.multiSetMod.MultiSet[Key, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, SourceT, IteratorT, ReverseT] */] (val x: Self with (Iterator[Key, SourceT, IteratorT, ReverseT])) extends AnyVal {
