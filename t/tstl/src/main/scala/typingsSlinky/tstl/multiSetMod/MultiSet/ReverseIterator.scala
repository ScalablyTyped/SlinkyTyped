...
@js.native
trait ReverseIterator[Key, SourceT /* <: typingsSlinky.tstl.multiSetMod.MultiSet[Key, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, SourceT, IteratorT, ReverseT] */] extends js.Object {
...
object ReverseIterator {
  ...
  @scala.inline
  implicit class ReverseIteratorOps[Self <: ReverseIterator[_, _, _, _], Key, SourceT /* <: typingsSlinky.tstl.multiSetMod.MultiSet[Key, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, SourceT, IteratorT, ReverseT] */] (val x: Self with (ReverseIterator[Key, SourceT, IteratorT, ReverseT])) extends AnyVal {
