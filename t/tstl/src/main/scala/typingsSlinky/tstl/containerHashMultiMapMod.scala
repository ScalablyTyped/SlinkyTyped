...
object containerHashMultiMapMod extends js.Object {
  ...
  class HashMultiMap[Key, T] () extends MultiMap[Key, T, HashMultiMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T]] {
    ...
    /* protected */ def _Handle_erase(
      first: (Iterator[Key, T]) | (typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `false`, HashMultiMap[Key, T]]),
      last: (Iterator[Key, T]) | (typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `false`, HashMultiMap[Key, T]])
    ): Unit = js.native
    /**
      * @hidden
      */
    ...
    /**
      ...
      */
    def begin(index: Double): typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("begin")
    ...
    /**
      ...
      * @return Iterator from the specific bucket.
      */
    def end(index: Double): typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("end")
    ...
    /**
      ...
      */
    @JSName("rbegin")
    def rbegin_ReverseIterator(): typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.ReverseIterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    /**
    ...
    /**
      ...
      */
    @JSName("rend")
    def rend_ReverseIterator(): typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.ReverseIterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    /**
