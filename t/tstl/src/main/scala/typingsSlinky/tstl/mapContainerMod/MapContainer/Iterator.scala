...
object Iterator {
  ...
  @scala.inline
  def apply[Key, T, Unique /* <: Boolean */, SourceT /* <: typingsSlinky.tstl.mapContainerMod.MapContainer[Key, T, Unique, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, T, Unique, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, T, Unique, SourceT, IteratorT, ReverseT] */](
    first: Key,
    next: () => IteratorT,
    prev: () => IteratorT,
    reverse: () => ReverseT,
  ...
  @scala.inline
  implicit class IteratorOps[Self <: Iterator[_, _, _, _, _, _], Key, T, Unique /* <: Boolean */, SourceT /* <: typingsSlinky.tstl.mapContainerMod.MapContainer[Key, T, Unique, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, T, Unique, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, T, Unique, SourceT, IteratorT, ReverseT] */] (val x: Self with (Iterator[Key, T, Unique, SourceT, IteratorT, ReverseT])) extends AnyVal {
