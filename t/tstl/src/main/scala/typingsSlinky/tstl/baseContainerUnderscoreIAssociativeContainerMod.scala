...
import typingsSlinky.tstl.baseContainerUnderscoreIAssociativeContainerMod._IAssociativeContainer
...
@JSImport("tstl/base/container/_IAssociativeContainer", JSImport.Namespace)
@js.native
object baseContainerUnderscoreIAssociativeContainerMod extends js.Object {
  @js.native
  ...
  def _Fetch_arguments[Key, T /* <: Elem */, SourceT /* <: _IAssociativeContainer[Key, T, SourceT, IteratorT, ReverseIteratorT, Elem] */, IteratorT /* <: Iterator[T, SourceT, IteratorT, ReverseIteratorT, Elem] */, ReverseIteratorT /* <: IReverseIterator[T, SourceT, IteratorT, ReverseIteratorT, Elem] */, Elem](source: SourceT, args: js.Any*): Anon_Ramda = js.native
}
