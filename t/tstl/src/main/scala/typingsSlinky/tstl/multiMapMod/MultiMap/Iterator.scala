...
@js.native
trait Iterator[Key, T, SourceT /* <: typingsSlinky.tstl.multiMapMod.MultiMap[Key, T, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, T, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, T, SourceT, IteratorT, ReverseT] */] extends js.Object {
...
object Iterator {
  ...
  @scala.inline
  implicit class IteratorOps[Self <: Iterator[_, _, _, _, _], Key, T, SourceT /* <: typingsSlinky.tstl.multiMapMod.MultiMap[Key, T, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, T, SourceT, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, T, SourceT, IteratorT, ReverseT] */] (val x: Self with (Iterator[Key, T, SourceT, IteratorT, ReverseT])) extends AnyVal {
