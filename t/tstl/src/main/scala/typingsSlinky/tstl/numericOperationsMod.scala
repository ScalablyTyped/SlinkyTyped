...
object numericOperationsMod extends js.Object {
  ...
  type BinaryTransformer[OutputIterator /* <: IForwardIterator[typingsSlinky.tstl.ipointerMod.IPointer.ValueType[OutputIterator], OutputIterator] */] = js.Function2[
    /* x */ typingsSlinky.tstl.ipointerMod.IPointer.ValueType[OutputIterator], 
    /* y */ typingsSlinky.tstl.ipointerMod.IPointer.ValueType[OutputIterator], 
    typingsSlinky.tstl.ipointerMod.IPointer.ValueType[OutputIterator]
  ]
  ...
  type UnaryTransformer[Range /* <: js.Array[_] | IForwardContainer[_] */, OutputIterator /* <: IForwardIterator[typingsSlinky.tstl.ipointerMod.IPointer.ValueType[OutputIterator], OutputIterator] */] = js.Function1[
    /* val */ ValueType[Range], 
    typingsSlinky.tstl.ipointerMod.IPointer.ValueType[OutputIterator]
  ]
}
