...
import typingsSlinky.tstl.treeMapMod.TreeMap.ReverseIterator
...
object treeMapMod extends js.Object {
  ...
  object TreeMap extends js.Object {
    ...
    /**
      ...
      */
    type Iterator[Key, T] = typingsSlinky.tstl.mapElementListMod.MapElementList.Iterator[Key, T, `true`, TreeMap[Key, T]]
    
    /**
      * Reverse iterator of {@link TreeMap}
      */
    type ReverseIterator[Key, T] = typingsSlinky.tstl.mapElementListMod.MapElementList.ReverseIterator[Key, T, `true`, TreeMap[Key, T]]
  }
}
