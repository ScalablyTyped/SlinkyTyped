...
import typingsSlinky.tstl.experimentalContainerFlatMultiMapMod.FlatMultiMap
import typingsSlinky.tstl.experimentalContainerFlatMultiMapMod.FlatMultiMap.Iterator
import typingsSlinky.tstl.experimentalContainerFlatMultiMapMod.FlatMultiMap.ReverseIterator
...
object experimentalContainerFlatMultiMapMod extends js.Object {
  ...
  object FlatMultiMap extends js.Object {
    ...
    type Iterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementVectorMod.MapElementVector.Iterator[Key, T, `false`, FlatMultiMap[Key, T]]
    type ReverseIterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementVectorMod.MapElementVector.ReverseIterator[Key, T, `false`, FlatMultiMap[Key, T]]
    type iterator[Key, T] = typingsSlinky.tstl.experimentalContainerFlatMultiMapMod.FlatMultiMap.Iterator[Key, T]
    type reverse_iterator[Key, T] = typingsSlinky.tstl.experimentalContainerFlatMultiMapMod.FlatMultiMap.ReverseIterator[Key, T]
  }
