...
import typingsSlinky.tstl.baseContainerMultiTreeMapMod.MultiTreeMap
import typingsSlinky.tstl.containerTreeMultiMapMod.TreeMultiMap
import typingsSlinky.tstl.containerTreeMultiMapMod.TreeMultiMap.Iterator
import typingsSlinky.tstl.containerTreeMultiMapMod.TreeMultiMap.ReverseIterator
...
object containerTreeMultiMapMod extends js.Object {
  ...
  /**
    ...
    */
  class TreeMultiMap[Key, T] () extends MultiTreeMap[Key, T, TreeMultiMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T]] {
  ...
  object TreeMultiMap extends js.Object {
    ...
    type Iterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `false`, TreeMultiMap[Key, T]]
    type ReverseIterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.ReverseIterator[Key, T, `false`, TreeMultiMap[Key, T]]
    type iterator[Key, T] = typingsSlinky.tstl.containerTreeMultiMapMod.TreeMultiMap.Iterator[Key, T]
    type reverse_iterator[Key, T] = typingsSlinky.tstl.containerTreeMultiMapMod.TreeMultiMap.ReverseIterator[Key, T]
  }
