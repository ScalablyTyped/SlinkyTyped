...
/**
  * @hidden
  */
trait IErasableContainer[Iterator /* <: IForwardIterator[ValueType[Iterator], Iterator] */] extends js.Object {
  def begin(): Iterator
  def end(): Iterator
...
object IErasableContainer {
  @scala.inline
  def apply[Iterator /* <: IForwardIterator[ValueType[Iterator], Iterator] */](begin: () => Iterator, end: () => Iterator, erase: (Iterator, Iterator) => Iterator): IErasableContainer[Iterator] = {
