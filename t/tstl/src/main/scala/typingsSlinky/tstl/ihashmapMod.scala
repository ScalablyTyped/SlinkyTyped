...
import typingsSlinky.tstl.ihashmapMod.IHashMap.ReverseIterator
...
object ihashmapMod extends js.Object {
  ...
  object IHashMap extends js.Object {
    ...
    /**
      ...
      */
    type Iterator[Key, T, Unique /* <: Boolean */, Source /* <: IHashMap[Key, T, Unique, Source] */] = typingsSlinky.tstl.mapElementListMod.MapElementList.Iterator[Key, T, Unique, Source]
    ...
    /**
      ...
      * @author Jenogho Nam <http://samchon.org>
      */
    type ReverseIterator[Key, T, Unique /* <: Boolean */, Source /* <: IHashMap[Key, T, Unique, Source] */] = typingsSlinky.tstl.mapElementListMod.MapElementList.ReverseIterator[Key, T, Unique, Source]
  }
}
