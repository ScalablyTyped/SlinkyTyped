...
object containerTreeSetMod extends js.Object {
  ...
  object TreeSet extends js.Object {
    ...
    type iterator[Key] = typingsSlinky.tstl.containerTreeSetMod.TreeSet.Iterator[Key]
    type reverse_iterator[Key] = typingsSlinky.tstl.containerTreeSetMod.TreeSet.ReverseIterator[Key]
  }
