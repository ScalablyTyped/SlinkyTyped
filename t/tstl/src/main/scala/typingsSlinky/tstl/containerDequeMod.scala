...
object containerDequeMod extends js.Object {
  ...
  object Deque extends js.Object {
    ...
    type iterator[T] = typingsSlinky.tstl.containerDequeMod.Deque.Iterator[T]
    type reverse_iterator[T] = typingsSlinky.tstl.containerDequeMod.Deque.ReverseIterator[T]
  }
