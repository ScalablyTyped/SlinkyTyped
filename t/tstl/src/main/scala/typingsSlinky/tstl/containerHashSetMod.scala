...
import typingsSlinky.tstl.baseHashUnderscoreSetHashBucketsMod._SetHashBuckets
import typingsSlinky.tstl.containerHashSetMod.HashSet
import typingsSlinky.tstl.containerHashSetMod.HashSet.Iterator
import typingsSlinky.tstl.containerHashSetMod.HashSet.ReverseIterator
...
object containerHashSetMod extends js.Object {
  ...
  class HashSet[Key] () extends UniqueSet[Key, HashSet[Key], Iterator[Key], ReverseIterator[Key]] {
    ...
    /* protected */ def _Handle_erase(
      first: (typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.Iterator[Key, `true`, HashSet[Key]]) | Iterator[Key],
      last: (typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.Iterator[Key, `true`, HashSet[Key]]) | Iterator[Key]
    ): Unit = js.native
    /**
      * @hidden
      */
    ...
    /* protected */ def _Insert_by_key_InsertRet(key: Key): InsertRet[
        ...
        `true`, 
        HashSet[Key], 
        typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.Iterator[Key, `true`, HashSet[Key]], 
        typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.ReverseIterator[Key, `true`, HashSet[Key]]
      ] = js.native
    /**
      ...
      */
    def begin(index: Double): typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.Iterator[Key, `true`, HashSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("begin")
    ...
    /**
      ...
      * @return Iterator from the specific bucket.
      */
    def end(index: Double): typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.Iterator[Key, `true`, HashSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("end")
    ...
    /**
      ...
      */
    @JSName("rbegin")
    def rbegin_ReverseIterator(): typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.ReverseIterator[Key, `true`, HashSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    /**
    ...
    /**
      ...
      */
    @JSName("rend")
    def rend_ReverseIterator(): typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.ReverseIterator[Key, `true`, HashSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    /**
  ...
  object HashSet extends js.Object {
    ...
    type Iterator[Key] = typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.Iterator[Key, `true`, HashSet[Key]]
    type ReverseIterator[Key] = typingsSlinky.tstl.baseContainerSetElementListMod.SetElementList.ReverseIterator[Key, `true`, HashSet[Key]]
    type iterator[Key] = typingsSlinky.tstl.containerHashSetMod.HashSet.Iterator[Key]
    type reverse_iterator[Key] = typingsSlinky.tstl.containerHashSetMod.HashSet.ReverseIterator[Key]
  }
