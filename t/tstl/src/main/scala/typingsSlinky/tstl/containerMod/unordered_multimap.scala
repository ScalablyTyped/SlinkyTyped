...
class unordered_multimap[Key, T] ()
  extends typingsSlinky.tstl.containerHashMultiMapMod.unordered_multimap[Key, T] {
  ...
  /**
    ...
    */
  def this(obj: typingsSlinky.tstl.containerHashMultiMapMod.HashMultiMap[Key, T]) = this()
  /**
    * Range Constructor.
    *
