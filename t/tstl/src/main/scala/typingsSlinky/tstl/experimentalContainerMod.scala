...
object experimentalContainerMod extends js.Object {
  ...
  /**
    ...
    */
  class FlatMap[Key, T] ()
    extends typingsSlinky.tstl.flatMapMod.FlatMap[Key, T] {
  ...
  class FlatMultiMap[Key, T] ()
    extends typingsSlinky.tstl.flatMultiMapMod.FlatMultiMap[Key, T] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  class FlatMultiSet[Key] ()
    extends typingsSlinky.tstl.flatMultiSetMod.FlatMultiSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  /**
    ...
    */
  class FlatSet[Key] ()
    extends typingsSlinky.tstl.flatSetMod.FlatSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
