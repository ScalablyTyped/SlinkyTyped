...
object Indices {
  ...
  implicit class IndicesOps[Self <: Indices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIndicesVarargs(value: js.typedarray.Uint8Array*): Self = this.set("indices", js.Array(value :_*))
    
    @scala.inline
    def setIndicesInt32Array(value: js.typedarray.Int32Array): Self = this.set("indices", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIndicesFloat32Array(value: js.typedarray.Float32Array): Self = this.set("indices", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIndicesUint8Array(value: js.typedarray.Uint8Array): Self = this.set("indices", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOutputValuesFloat32Array(value: js.typedarray.Float32Array): Self = this.set("outputValues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOutputValuesVarargs(value: js.typedarray.Uint8Array*): Self = this.set("outputValues", js.Array(value :_*))
    
    @scala.inline
    def setOutputValuesInt32Array(value: js.typedarray.Int32Array): Self = this.set("outputValues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOutputValues(value: BackendValues): Self = this.set("outputValues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOutputValuesUint8Array(value: js.typedarray.Uint8Array): Self = this.set("outputValues", value.asInstanceOf[js.Any])
  }
}
