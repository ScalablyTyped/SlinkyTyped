...
import typingsSlinky.tensorflowTfjsCore.kernelNamesMod.AvgPoolBackpropAttrs
import typingsSlinky.tensorflowTfjsCore.kernelNamesMod.AvgPoolBackpropInputs
