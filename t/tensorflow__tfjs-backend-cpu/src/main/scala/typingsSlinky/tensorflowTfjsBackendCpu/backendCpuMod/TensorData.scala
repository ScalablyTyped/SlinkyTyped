...
object TensorData {
  @scala.inline
  def apply[/* <: typingsSlinky.tensorflowTfjsCore.distTypesMod.DataType */ D](dtype: D): TensorData[D] = {
    val __obj = js.Dynamic.literal(dtype = dtype.asInstanceOf[js.Any])
    __obj.asInstanceOf[TensorData[D]]
  }
  @scala.inline
  implicit class TensorDataOps[Self <: TensorData[_], /* <: typingsSlinky.tensorflowTfjsCore.distTypesMod.DataType */ D] (val x: Self with TensorData[D]) extends AnyVal {
    @scala.inline
