...
object SystemInfoWifiSecurityMode extends StObject {
  ...
  /* "EAP" */ val EAP: typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoWifiSecurityMode.EAP with String = js.native
  
  @js.native
  sealed trait NONE extends SystemInfoWifiSecurityMode
  /* "NONE" */ val NONE: typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoWifiSecurityMode.NONE with String = js.native
  
  @js.native
  sealed trait WEP extends SystemInfoWifiSecurityMode
  /* "WEP" */ val WEP: typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoWifiSecurityMode.WEP with String = js.native
  
  @js.native
  sealed trait WPA2_PSK extends SystemInfoWifiSecurityMode
  /* "WPA2_PSK" */ val WPA2_PSK: typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoWifiSecurityMode.WPA2_PSK with String = js.native
  
  @js.native
  sealed trait WPA_PSK extends SystemInfoWifiSecurityMode
  /* "WPA_PSK" */ val WPA_PSK: typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoWifiSecurityMode.WPA_PSK with String = js.native
}
