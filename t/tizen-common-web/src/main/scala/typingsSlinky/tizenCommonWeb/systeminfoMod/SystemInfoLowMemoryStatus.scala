...
object SystemInfoLowMemoryStatus extends StObject {
  ...
  /* "NORMAL" */ val NORMAL: typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoLowMemoryStatus.NORMAL with String = js.native
  
  @js.native
  sealed trait WARNING extends SystemInfoLowMemoryStatus
  /* "WARNING" */ val WARNING: typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoLowMemoryStatus.WARNING with String = js.native
}
