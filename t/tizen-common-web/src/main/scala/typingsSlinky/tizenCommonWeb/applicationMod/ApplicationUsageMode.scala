...
object ApplicationUsageMode extends StObject {
  ...
  /* "FREQUENTLY" */ val FREQUENTLY: typingsSlinky.tizenCommonWeb.applicationMod.ApplicationUsageMode.FREQUENTLY with String = js.native
  
  @js.native
  sealed trait RECENTLY extends ApplicationUsageMode
  /* "RECENTLY" */ val RECENTLY: typingsSlinky.tizenCommonWeb.applicationMod.ApplicationUsageMode.RECENTLY with String = js.native
}
