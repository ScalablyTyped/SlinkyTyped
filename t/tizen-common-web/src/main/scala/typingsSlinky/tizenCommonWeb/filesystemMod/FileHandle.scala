...
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.BEGIN
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.CURRENT
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.END
