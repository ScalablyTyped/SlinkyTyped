...
object FileStream {
  ...
  implicit class FileStreamOps[Self <: FileStream] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReadBytes(value: Double => js.typedarray.Uint8Array): Self = this.set("readBytes", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setWriteBytes(value: js.typedarray.Uint8Array => Unit): Self = this.set("writeBytes", js.Any.fromFunction1(value))
  }
