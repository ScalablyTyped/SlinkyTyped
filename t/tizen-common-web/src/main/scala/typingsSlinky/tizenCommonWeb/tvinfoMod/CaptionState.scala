...
object CaptionState extends StObject {
  ...
  /* "CAPTION_OFF" */ val CAPTION_OFF: typingsSlinky.tizenCommonWeb.tvinfoMod.CaptionState.CAPTION_OFF with String = js.native
  
  @js.native
  sealed trait CAPTION_ON extends CaptionState
  /* "CAPTION_ON" */ val CAPTION_ON: typingsSlinky.tizenCommonWeb.tvinfoMod.CaptionState.CAPTION_ON with String = js.native
}
