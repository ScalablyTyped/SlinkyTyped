...
object downloadMod {
  ...
  object DownloadNetworkType extends StObject {
    ...
    /* "ALL" */ val ALL: typingsSlinky.tizenCommonWeb.downloadMod.DownloadNetworkType.ALL with String = js.native
    
    @js.native
    sealed trait CELLULAR extends DownloadNetworkType
    /* "CELLULAR" */ val CELLULAR: typingsSlinky.tizenCommonWeb.downloadMod.DownloadNetworkType.CELLULAR with String = js.native
    
    @js.native
    sealed trait WIFI extends DownloadNetworkType
    /* "WIFI" */ val WIFI: typingsSlinky.tizenCommonWeb.downloadMod.DownloadNetworkType.WIFI with String = js.native
  }
  ...
  object DownloadState extends StObject {
    ...
    /* "ABANDONED" */ val ABANDONED: typingsSlinky.tizenCommonWeb.downloadMod.DownloadState.ABANDONED with String = js.native
    
    @js.native
    sealed trait CANCELED extends DownloadState
    /* "CANCELED" */ val CANCELED: typingsSlinky.tizenCommonWeb.downloadMod.DownloadState.CANCELED with String = js.native
    
    @js.native
    sealed trait COMPLETED extends DownloadState
    /* "COMPLETED" */ val COMPLETED: typingsSlinky.tizenCommonWeb.downloadMod.DownloadState.COMPLETED with String = js.native
    
    @js.native
    sealed trait DOWNLOADING extends DownloadState
    /* "DOWNLOADING" */ val DOWNLOADING: typingsSlinky.tizenCommonWeb.downloadMod.DownloadState.DOWNLOADING with String = js.native
    
    @js.native
    sealed trait FAILED extends DownloadState
    /* "FAILED" */ val FAILED: typingsSlinky.tizenCommonWeb.downloadMod.DownloadState.FAILED with String = js.native
    
    @js.native
    sealed trait PAUSED extends DownloadState
    /* "PAUSED" */ val PAUSED: typingsSlinky.tizenCommonWeb.downloadMod.DownloadState.PAUSED with String = js.native
    
    @js.native
    sealed trait QUEUED extends DownloadState
    /* "QUEUED" */ val QUEUED: typingsSlinky.tizenCommonWeb.downloadMod.DownloadState.QUEUED with String = js.native
  }
