...
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.AAC
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.BACK
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.CANCEL
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.DOLBY
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.DOLBY_DIGITAL_PLUS
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.DOWN
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.DTS
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.KEYPAD
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.KEYPAD_DEL
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.KEYPAD_ENTER
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.LEFT
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.MOVE
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.PAGE_LEFT
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.PAGE_RIGHT
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.PCM
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.PREPARING
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.RIGHT
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.SELECT
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.UP
...
object tvaudiocontrolMod {
  ...
  object AudioBeepType extends StObject {
    ...
    /* "BACK" */ val BACK: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.BACK with String = js.native
    
    @js.native
    sealed trait CANCEL extends AudioBeepType
    /* "CANCEL" */ val CANCEL: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.CANCEL with String = js.native
    
    @js.native
    sealed trait DOWN extends AudioBeepType
    /* "DOWN" */ val DOWN: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.DOWN with String = js.native
    
    @js.native
    sealed trait KEYPAD extends AudioBeepType
    /* "KEYPAD" */ val KEYPAD: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.KEYPAD with String = js.native
    
    @js.native
    sealed trait KEYPAD_DEL extends AudioBeepType
    /* "KEYPAD_DEL" */ val KEYPAD_DEL: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.KEYPAD_DEL with String = js.native
    
    @js.native
    sealed trait KEYPAD_ENTER extends AudioBeepType
    /* "KEYPAD_ENTER" */ val KEYPAD_ENTER: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.KEYPAD_ENTER with String = js.native
    
    @js.native
    sealed trait LEFT extends AudioBeepType
    /* "LEFT" */ val LEFT: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.LEFT with String = js.native
    
    @js.native
    sealed trait MOVE extends AudioBeepType
    /* "MOVE" */ val MOVE: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.MOVE with String = js.native
    
    @js.native
    sealed trait PAGE_LEFT extends AudioBeepType
    /* "PAGE_LEFT" */ val PAGE_LEFT: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.PAGE_LEFT with String = js.native
    
    @js.native
    sealed trait PAGE_RIGHT extends AudioBeepType
    /* "PAGE_RIGHT" */ val PAGE_RIGHT: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.PAGE_RIGHT with String = js.native
    
    @js.native
    sealed trait PREPARING extends AudioBeepType
    /* "PREPARING" */ val PREPARING: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.PREPARING with String = js.native
    
    @js.native
    sealed trait RIGHT extends AudioBeepType
    /* "RIGHT" */ val RIGHT: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.RIGHT with String = js.native
    
    @js.native
    sealed trait SELECT extends AudioBeepType
    /* "SELECT" */ val SELECT: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.SELECT with String = js.native
    
    @js.native
    sealed trait UP extends AudioBeepType
    /* "UP" */ val UP: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.UP with String = js.native
    
    @js.native
    sealed trait WARNING extends AudioBeepType
    /* "WARNING" */ val WARNING: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioBeepType.WARNING with String = js.native
  }
  ...
  object AudioOutputMode extends StObject {
    ...
    /* "AAC" */ val AAC: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioOutputMode.AAC with String = js.native
    
    @js.native
    sealed trait DOLBY extends AudioOutputMode
    /* "DOLBY" */ val DOLBY: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioOutputMode.DOLBY with String = js.native
    
    @js.native
    sealed trait DOLBY_DIGITAL_PLUS extends AudioOutputMode
    /* "DOLBY_DIGITAL_PLUS" */ val DOLBY_DIGITAL_PLUS: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioOutputMode.DOLBY_DIGITAL_PLUS with String = js.native
    
    @js.native
    sealed trait DTS extends AudioOutputMode
    /* "DTS" */ val DTS: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioOutputMode.DTS with String = js.native
    
    @js.native
    sealed trait PCM extends AudioOutputMode
    /* "PCM" */ val PCM: typingsSlinky.tizenCommonWeb.tvaudiocontrolMod.AudioOutputMode.PCM with String = js.native
  }
