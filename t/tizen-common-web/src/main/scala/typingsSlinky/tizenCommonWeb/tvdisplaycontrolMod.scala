...
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.CHECKER_BD
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.FRAME_SEQUENCE
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.FROM_2D_TO_3D
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.LINE_BY_LINE
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.NOT_CONNECTED
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.NOT_SUPPORTED
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.OFF
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.READY
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.SIDE_BY_SIDE
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.TOP_BOTTOM
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.VERTICAL_STRIPE
...
object tvdisplaycontrolMod {
  ...
  object Display3DEffectMode extends StObject {
    ...
    /* "CHECKER_BD" */ val CHECKER_BD: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.CHECKER_BD with String = js.native
    
    @js.native
    sealed trait FRAME_SEQUENCE extends Display3DEffectMode
    /* "FRAME_SEQUENCE" */ val FRAME_SEQUENCE: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.FRAME_SEQUENCE with String = js.native
    
    @js.native
    sealed trait FROM_2D_TO_3D extends Display3DEffectMode
    /* "FROM_2D_TO_3D" */ val FROM_2D_TO_3D: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.FROM_2D_TO_3D with String = js.native
    
    @js.native
    sealed trait LINE_BY_LINE extends Display3DEffectMode
    /* "LINE_BY_LINE" */ val LINE_BY_LINE: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.LINE_BY_LINE with String = js.native
    
    @js.native
    sealed trait OFF extends Display3DEffectMode
    /* "OFF" */ val OFF: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.OFF with String = js.native
    
    @js.native
    sealed trait SIDE_BY_SIDE extends Display3DEffectMode
    /* "SIDE_BY_SIDE" */ val SIDE_BY_SIDE: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.SIDE_BY_SIDE with String = js.native
    
    @js.native
    sealed trait TOP_BOTTOM extends Display3DEffectMode
    /* "TOP_BOTTOM" */ val TOP_BOTTOM: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.TOP_BOTTOM with String = js.native
    
    @js.native
    sealed trait VERTICAL_STRIPE extends Display3DEffectMode
    /* "VERTICAL_STRIPE" */ val VERTICAL_STRIPE: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.VERTICAL_STRIPE with String = js.native
  }
  ...
  object Display3DModeState extends StObject {
    ...
    /* "NOT_CONNECTED" */ val NOT_CONNECTED: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DModeState.NOT_CONNECTED with String = js.native
    
    @js.native
    sealed trait NOT_SUPPORTED extends Display3DModeState
    /* "NOT_SUPPORTED" */ val NOT_SUPPORTED: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DModeState.NOT_SUPPORTED with String = js.native
    
    @js.native
    sealed trait READY extends Display3DModeState
    /* "READY" */ val READY: typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DModeState.READY with String = js.native
  }
