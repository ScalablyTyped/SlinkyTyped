...
object tvdisplaycontrolMod extends js.Object {
  ...
  object Display3DEffectMode extends js.Object {
    ...
    object CHECKER_BD
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.CHECKER_BD with String
            ]
    
    /* "FRAME_SEQUENCE" */ @js.native
    object FRAME_SEQUENCE
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.FRAME_SEQUENCE with String
            ]
    
    /* "FROM_2D_TO_3D" */ @js.native
    object FROM_2D_TO_3D
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.FROM_2D_TO_3D with String
            ]
    
    /* "LINE_BY_LINE" */ @js.native
    object LINE_BY_LINE
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.LINE_BY_LINE with String
            ]
    
    /* "OFF" */ @js.native
    object OFF
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.OFF with String
            ]
    
    /* "SIDE_BY_SIDE" */ @js.native
    object SIDE_BY_SIDE
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.SIDE_BY_SIDE with String
            ]
    
    /* "TOP_BOTTOM" */ @js.native
    object TOP_BOTTOM
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.TOP_BOTTOM with String
            ]
    
    /* "VERTICAL_STRIPE" */ @js.native
    object VERTICAL_STRIPE
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DEffectMode.VERTICAL_STRIPE with String
            ]
  ...
  object Display3DModeState extends js.Object {
    ...
    object NOT_CONNECTED
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DModeState.NOT_CONNECTED with String
            ]
    
    /* "NOT_SUPPORTED" */ @js.native
    object NOT_SUPPORTED
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DModeState.NOT_SUPPORTED with String
            ]
    
    /* "READY" */ @js.native
    object READY
      extends TopLevel[
              typingsSlinky.tizenCommonWeb.tvdisplaycontrolMod.Display3DModeState.READY with String
            ]
