...
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.EXTERNAL
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.INTERNAL
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.MOUNTED
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.REMOVED
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.UNMOUNTABLE
...
object filesystemMod {
  ...
  object BaseSeekPosition extends StObject {
    ...
    /* "BEGIN" */ val BEGIN: typingsSlinky.tizenCommonWeb.filesystemMod.BaseSeekPosition.BEGIN with String = js.native
    
    @js.native
    sealed trait CURRENT extends BaseSeekPosition
    /* "CURRENT" */ val CURRENT: typingsSlinky.tizenCommonWeb.filesystemMod.BaseSeekPosition.CURRENT with String = js.native
    
    @js.native
    sealed trait END extends BaseSeekPosition
    /* "END" */ val END: typingsSlinky.tizenCommonWeb.filesystemMod.BaseSeekPosition.END with String = js.native
  }
  ...
  object FileMode extends StObject {
    ...
    /* "a" */ val a: typingsSlinky.tizenCommonWeb.filesystemMod.FileMode.a with String = js.native
    
    @js.native
    sealed trait r extends FileMode
    /* "r" */ val r: typingsSlinky.tizenCommonWeb.filesystemMod.FileMode.r with String = js.native
    
    @js.native
    sealed trait rw extends FileMode
    /* "rw" */ val rw: typingsSlinky.tizenCommonWeb.filesystemMod.FileMode.rw with String = js.native
    
    @js.native
    sealed trait rwo extends FileMode
    /* "rwo" */ val rwo: typingsSlinky.tizenCommonWeb.filesystemMod.FileMode.rwo with String = js.native
    
    @js.native
    sealed trait w extends FileMode
    /* "w" */ val w: typingsSlinky.tizenCommonWeb.filesystemMod.FileMode.w with String = js.native
  }
  ...
  object FileSystemStorageState extends StObject {
    ...
    /* "MOUNTED" */ val MOUNTED: typingsSlinky.tizenCommonWeb.filesystemMod.FileSystemStorageState.MOUNTED with String = js.native
    
    @js.native
    sealed trait REMOVED extends FileSystemStorageState
    /* "REMOVED" */ val REMOVED: typingsSlinky.tizenCommonWeb.filesystemMod.FileSystemStorageState.REMOVED with String = js.native
    
    @js.native
    sealed trait UNMOUNTABLE extends FileSystemStorageState
    /* "UNMOUNTABLE" */ val UNMOUNTABLE: typingsSlinky.tizenCommonWeb.filesystemMod.FileSystemStorageState.UNMOUNTABLE with String = js.native
  }
  ...
  object FileSystemStorageType extends StObject {
    ...
    /* "EXTERNAL" */ val EXTERNAL: typingsSlinky.tizenCommonWeb.filesystemMod.FileSystemStorageType.EXTERNAL with String = js.native
    
    @js.native
    sealed trait INTERNAL extends FileSystemStorageType
    /* "INTERNAL" */ val INTERNAL: typingsSlinky.tizenCommonWeb.filesystemMod.FileSystemStorageType.INTERNAL with String = js.native
  }
  ...
  object FileFilter {
    ...
    implicit class FileFilterMutableBuilder[Self <: FileFilter] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndCreated(value: js.Date): Self = StObject.set(x, "endCreated", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEndModified(value: js.Date): Self = StObject.set(x, "endModified", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStartCreated(value: js.Date): Self = StObject.set(x, "startCreated", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStartModified(value: js.Date): Self = StObject.set(x, "startModified", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait FileStream extends StObject {
    ...
    /**
      ...
      */
    def readBytes(byteCount: Double): js.typedarray.Uint8Array = js.native
    ...
    /**
      ...
      * @throw WebAPIException IOError, TypeMismatchError, SecurityError
      */
    def writeBytes(byteData: js.typedarray.Uint8Array): Unit = js.native
  }
  object FileStream {
    ...
    def apply(
      ...
      readBytes: Double => js.typedarray.Uint8Array,
      write: String => Unit,
      writeBase64: String => Unit,
      writeBytes: js.typedarray.Uint8Array => Unit
    ): FileStream = {
    ...
    implicit class FileStreamMutableBuilder[Self <: FileStream] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReadBytes(value: Double => js.typedarray.Uint8Array): Self = StObject.set(x, "readBytes", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setWriteBytes(value: js.typedarray.Uint8Array => Unit): Self = StObject.set(x, "writeBytes", js.Any.fromFunction1(value))
    }
  }
