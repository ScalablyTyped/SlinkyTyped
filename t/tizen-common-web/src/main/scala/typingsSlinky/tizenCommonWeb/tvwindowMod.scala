...
import typingsSlinky.tizenCommonWeb.systeminfoMod.SystemInfoVideoSourceInfo
...
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.BEHIND
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.FRONT
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.MAIN
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.Percentsign
import typingsSlinky.tizenCommonWeb.tizenCommonWebStrings.px
...
object tvwindowMod {
  ...
  object AspectRatio extends StObject {
    ...
    /* "ASPECT_RATIO_16x9" */ val ASPECT_RATIO_16x9: typingsSlinky.tizenCommonWeb.tvwindowMod.AspectRatio.ASPECT_RATIO_16x9 with String = js.native
    
    @js.native
    sealed trait ASPECT_RATIO_1x1 extends AspectRatio
    /* "ASPECT_RATIO_1x1" */ val ASPECT_RATIO_1x1: typingsSlinky.tizenCommonWeb.tvwindowMod.AspectRatio.ASPECT_RATIO_1x1 with String = js.native
    
    @js.native
    sealed trait ASPECT_RATIO_221x100 extends AspectRatio
    /* "ASPECT_RATIO_221x100" */ val ASPECT_RATIO_221x100: typingsSlinky.tizenCommonWeb.tvwindowMod.AspectRatio.ASPECT_RATIO_221x100 with String = js.native
    
    @js.native
    sealed trait ASPECT_RATIO_4x3 extends AspectRatio
    /* "ASPECT_RATIO_4x3" */ val ASPECT_RATIO_4x3: typingsSlinky.tizenCommonWeb.tvwindowMod.AspectRatio.ASPECT_RATIO_4x3 with String = js.native
    
    @js.native
    sealed trait ASPECT_RATIO_UNKNOWN extends AspectRatio
    /* "ASPECT_RATIO_UNKNOWN" */ val ASPECT_RATIO_UNKNOWN: typingsSlinky.tizenCommonWeb.tvwindowMod.AspectRatio.ASPECT_RATIO_UNKNOWN with String = js.native
  }
  ...
  object MeasurementUnit extends StObject {
    ...
    /* "%" */ val Percentsign: typingsSlinky.tizenCommonWeb.tvwindowMod.MeasurementUnit.Percentsign with String = js.native
    
    @js.native
    sealed trait px extends MeasurementUnit
    /* "px" */ val px: typingsSlinky.tizenCommonWeb.tvwindowMod.MeasurementUnit.px with String = js.native
  }
  ...
  object WindowType extends StObject {
    ...
    /* "MAIN" */ val MAIN: typingsSlinky.tizenCommonWeb.tvwindowMod.WindowType.MAIN with String = js.native
  }
  ...
  object ZPosition extends StObject {
    ...
    /* "BEHIND" */ val BEHIND: typingsSlinky.tizenCommonWeb.tvwindowMod.ZPosition.BEHIND with String = js.native
    
    @js.native
    sealed trait FRONT extends ZPosition
    /* "FRONT" */ val FRONT: typingsSlinky.tizenCommonWeb.tvwindowMod.ZPosition.FRONT with String = js.native
  }
