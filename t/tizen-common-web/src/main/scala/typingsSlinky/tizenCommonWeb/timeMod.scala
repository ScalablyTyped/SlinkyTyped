...
object timeMod {
  ...
  class TZDate () extends StObject {
    ...
    /**
      ...
      * @throw WebAPIException with error type UnknownError, if the call failed due to an unknown error.
      */
    def getNextDSTTransition(): js.UndefOr[TZDate] = js.native
    ...
    /**
      ...
      * @throw WebAPIException with error type UnknownError, if the call failed due to an unknown error.
      */
    def getPreviousDSTTransition(): js.UndefOr[TZDate] = js.native
  ...
  object TimeDurationUnit extends StObject {
    ...
    /* "DAYS" */ val DAYS: typingsSlinky.tizenCommonWeb.timeMod.TimeDurationUnit.DAYS with String = js.native
    
    @js.native
    sealed trait HOURS extends TimeDurationUnit
    /* "HOURS" */ val HOURS: typingsSlinky.tizenCommonWeb.timeMod.TimeDurationUnit.HOURS with String = js.native
    
    @js.native
    sealed trait MINS extends TimeDurationUnit
    /* "MINS" */ val MINS: typingsSlinky.tizenCommonWeb.timeMod.TimeDurationUnit.MINS with String = js.native
    
    @js.native
    sealed trait MSECS extends TimeDurationUnit
    /* "MSECS" */ val MSECS: typingsSlinky.tizenCommonWeb.timeMod.TimeDurationUnit.MSECS with String = js.native
    
    @js.native
    sealed trait SECS extends TimeDurationUnit
    /* "SECS" */ val SECS: typingsSlinky.tizenCommonWeb.timeMod.TimeDurationUnit.SECS with String = js.native
  }
  ...
  Instantiable0[TZDate]
       ...
       with Instantiable2[js.UndefOr[/* datetime */ js.Date], /* timezone */ String, TZDate]
