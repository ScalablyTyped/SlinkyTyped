...
import typingsSlinky.nodeDashTelegramDashBotDashApi.nodeDashTelegramDashBotDashApiMod.PollingOptions
import typingsSlinky.nodeDashTelegramDashBotDashApi.nodeDashTelegramDashBotDashApiMod.WebHookOptions
...
trait ConstructorOptions
  extends typingsSlinky.nodeDashTelegramDashBotDashApi.nodeDashTelegramDashBotDashApiMod.ConstructorOptions {
