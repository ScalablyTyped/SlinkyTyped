...
trait PartialPageDefinitionsBeforeLoad extends js.Object {
  ...
  var mixins: js.UndefOr[js.Array[PartialPageDefinitionsAttached]] = js.undefined
...
object PartialPageDefinitionsBeforeLoad {
  @scala.inline
  def apply(
    attached: () => Unit = null,
    ...
    mixins: js.Array[PartialPageDefinitionsAttached] = null,
    moved: () => Unit = null,
    ...
    ready: () => Unit = null
  ): PartialPageDefinitionsBeforeLoad = {
    ...
    __obj.asInstanceOf[PartialPageDefinitionsBeforeLoad]
  }
}
