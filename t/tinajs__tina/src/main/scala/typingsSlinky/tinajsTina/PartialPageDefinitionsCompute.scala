...
trait PartialPageDefinitionsCompute extends js.Object {
...
object PartialPageDefinitionsCompute {
  @scala.inline
  def apply(
    attached: () => Unit = null,
    beforeLoad: js.ThisFunction0[PartialPageDefinitionsCompute, Unit] = null,
    ...
    moved: () => Unit = null,
    onHide: js.ThisFunction0[PartialPageDefinitionsCompute, Unit] = null,
    onLoad: js.ThisFunction1[PartialPageDefinitionsCompute, /* options */ js.UndefOr[js.Any], Unit] = null,
    onPageScroll: PartialPageDefinitionsCompute => Unit = null,
    onPullDownRefresh: PartialPageDefinitionsCompute => Unit = null,
    onReachBottom: PartialPageDefinitionsCompute => Unit = null,
    onReady: js.ThisFunction0[PartialPageDefinitionsCompute, Unit] = null,
    onShareAppMessage: PartialPageDefinitionsCompute => Unit = null,
    onShow: js.ThisFunction0[PartialPageDefinitionsCompute, Unit] = null,
    onUnload: js.ThisFunction0[PartialPageDefinitionsCompute, Unit] = null,
    properties: ComponentProperties = null,
    ready: () => Unit = null
  ): PartialPageDefinitionsCompute = {
    ...
    __obj.asInstanceOf[PartialPageDefinitionsCompute]
  }
}
