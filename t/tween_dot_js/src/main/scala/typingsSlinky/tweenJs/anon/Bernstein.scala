...
object Bernstein {
  ...
  implicit class BernsteinOps[Self <: Bernstein] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBernstein(value: (Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Bernstein")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withCatmullRom(value: (Double, Double, Double, Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CatmullRom")(js.Any.fromFunction5(value))
        ret
    }
    @scala.inline
    def withFactorial(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Factorial")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withLinear(value: (Double, Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Linear")(js.Any.fromFunction3(value))
        ret
    }
  }
