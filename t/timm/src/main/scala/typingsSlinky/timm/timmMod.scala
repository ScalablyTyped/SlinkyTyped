...
import typingsSlinky.timm.timmMod.ArrayOrObject
import typingsSlinky.timm.timmMod.Key
...
@js.native
object timmMod extends js.Object {
  ...
  def omit(obj: js.Object, attrs: String): js.Object = js.native
  def omit(obj: js.Object, attrs: js.Array[String]): js.Object = js.native
