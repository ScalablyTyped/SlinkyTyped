...
import typingsSlinky.timm.anon.FnCall
import typingsSlinky.timm.anon.FnCallABC
import typingsSlinky.timm.anon.FnCallABRest
import typingsSlinky.timm.anon.FnCallArray
import typingsSlinky.timm.anon.FnCallArrayIdx
import typingsSlinky.timm.anon.FnCallArrayIdxNewItem
import typingsSlinky.timm.anon.FnCallArrayIdxVal
import typingsSlinky.timm.anon.FnCallArrayVal
import typingsSlinky.timm.anon.FnCallObjAttrs
import typingsSlinky.timm.anon.FnCallObjKeyVal
import typingsSlinky.timm.anon.FnCallObjPath
...
object mod extends js.Object {
  ...
  {[ P in K ]: V}
    */ typingsSlinky.timm.timmStrings.set with TopLevel[js.Any] = js.native
  def set[K /* <: String */, V](obj: Null, key: K, `val`: V): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in K ]: V}
    */ typingsSlinky.timm.timmStrings.set with TopLevel[js.Any] = js.native
  def set[T /* <: js.Object */, K /* <: String */, V](obj: T, key: K, `val`: V): (Omit[T, /* keyof {[ P in K ]: any} */ String]) with typingsSlinky.timm.timmStrings.set with TopLevel[js.Any] = js.native
  ...
  object default extends js.Object {
    ...
    def set[K /* <: String */, V](obj: js.UndefOr[scala.Nothing], key: K, `val`: V): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ P in K ]: V}
      */ typingsSlinky.timm.timmStrings.default with TopLevel[js.Any] = js.native
    def set[K /* <: String */, V](obj: Null, key: K, `val`: V): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ P in K ]: V}
      */ typingsSlinky.timm.timmStrings.default with TopLevel[js.Any] = js.native
    def set[T /* <: js.Object */, K /* <: String */, V](obj: T, key: K, `val`: V): (Omit[T, /* keyof {[ P in K ]: any} */ String]) with typingsSlinky.timm.timmStrings.default with TopLevel[js.Any] = js.native
