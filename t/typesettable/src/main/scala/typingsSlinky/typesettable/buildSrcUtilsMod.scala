...
object buildSrcUtilsMod extends js.Object {
  ...
  class Cache[T] protected ()
    extends typingsSlinky.typesettable.buildSrcUtilsCacheMod.Cache[T] {
    /**
      * @constructor
      *
  ...
  @js.native
  class Methods ()
    extends typingsSlinky.typesettable.buildSrcUtilsMethodsMod.Methods
  
  @js.native
  class StringMethods ()
    extends typingsSlinky.typesettable.buildSrcUtilsStringMethodsMod.StringMethods
  
  @js.native
  class Tokenizer ()
    extends typingsSlinky.typesettable.buildSrcUtilsTokenizerMod.Tokenizer
