...
object utilsMod extends js.Object {
  ...
  class Cache[T] protected ()
    extends typingsSlinky.typesettable.cacheMod.Cache[T] {
    /**
      * @constructor
      *
  ...
  @js.native
  class Methods ()
    extends typingsSlinky.typesettable.methodsMod.Methods
  /* static members */
  @js.native
  ...
  @js.native
  class StringMethods ()
    extends typingsSlinky.typesettable.stringMethodsMod.StringMethods
  /* static members */
  @js.native
  ...
  @js.native
  class Tokenizer ()
    extends typingsSlinky.typesettable.tokenizerMod.Tokenizer
}
