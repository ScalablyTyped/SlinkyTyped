...
object mod {
  ...
  class CacheMeasurer protected ()
    extends typingsSlinky.typesettable.measurersMod.CacheMeasurer {
    def this(ruler: IRuler) = this()
    def this(ruler: IRulerFactoryContext) = this()
  }
  ...
  class CharacterMeasurer protected ()
    extends typingsSlinky.typesettable.measurersMod.CharacterMeasurer {
    def this(ruler: IRuler) = this()
    def this(ruler: IRulerFactoryContext) = this()
    def this(ruler: IRuler, useGuards: Boolean) = this()
    def this(ruler: IRulerFactoryContext, useGuards: Boolean) = this()
  ...
  @js.native
  class Methods ()
    extends typingsSlinky.typesettable.utilsMod.Methods
  /* static members */
  object Methods {
  ...
  class SingleLineWrapper ()
    extends typingsSlinky.typesettable.wrappersMod.SingleLineWrapper
  /* static members */
  ...
  @js.native
  class StringMethods ()
    extends typingsSlinky.typesettable.utilsMod.StringMethods
  /* static members */
  ...
  @js.native
  class Tokenizer ()
    extends typingsSlinky.typesettable.utilsMod.Tokenizer
  ...
  @js.native
  class Wrapper ()
    extends typingsSlinky.typesettable.wrappersMod.Wrapper
