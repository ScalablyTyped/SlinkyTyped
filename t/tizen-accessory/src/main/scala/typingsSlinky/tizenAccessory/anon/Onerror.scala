...
import typingsSlinky.tizenAccessory.SAPeerAgent
import typingsSlinky.tizenAccessory.tizenAccessoryStrings.AVAILABLE
import typingsSlinky.tizenAccessory.tizenAccessoryStrings.UNAVAILABLE
