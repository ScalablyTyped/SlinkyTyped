...
object servicesMod {
  ...
  class Router protected ()
    extends typingsSlinky.twilioSync.routerMod.Router {
  ...
  class Twilsock protected ()
    extends typingsSlinky.twilsock.mod.Twilsock {
    /**
  ...
  object Services {
    ...
    implicit class ServicesMutableBuilder[Self <: Services] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRouter(value: typingsSlinky.twilioSync.routerMod.Router): Self = StObject.set(x, "router", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTwilsock(value: typingsSlinky.twilsock.mod.Twilsock): Self = StObject.set(x, "twilsock", value.asInstanceOf[js.Any])
    }
  }
