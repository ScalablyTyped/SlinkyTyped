...
import typingsSlinky.twilioDashSync.libListitemMod.ListItemDescriptor
...
import typingsSlinky.twilioDashSync.libSyncdocumentMod.SyncDocumentImpl
import typingsSlinky.twilioDashSync.libSynclistMod.SyncListImpl
import typingsSlinky.twilioDashSync.libSyncmapMod.SyncMapImpl
...
object twilioDashSyncMod extends js.Object {
  ...
  class SyncClient protected ()
    extends typingsSlinky.twilioDashSync.libClientMod.SyncClient {
  ...
  class SyncDocument protected ()
    extends typingsSlinky.twilioDashSync.libSyncdocumentMod.SyncDocument {
  ...
  class SyncList protected ()
    extends typingsSlinky.twilioDashSync.libSynclistMod.SyncList {
  ...
  class SyncMap protected ()
    extends typingsSlinky.twilioDashSync.libSyncmapMod.SyncMap {
