...
import typingsSlinky.twilioDashSync.libSubscriptionsMod.Subscriptions
...
trait Services extends js.Object {
  ...
  var router: typingsSlinky.twilioDashSync.libRouterMod.Router
  var storage: Storage
  var subscriptions: Subscriptions
  var twilsock: typingsSlinky.twilsock.twilsockMod.Twilsock
}
...
object Services {
  ...
  def apply(
    ...
    router: typingsSlinky.twilioDashSync.libRouterMod.Router,
    storage: Storage,
    subscriptions: Subscriptions,
    twilsock: typingsSlinky.twilsock.twilsockMod.Twilsock
  ): Services = {
