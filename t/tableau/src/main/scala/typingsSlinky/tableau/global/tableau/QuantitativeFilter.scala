...
class QuantitativeFilter ()
  extends typingsSlinky.tableau.tableau.QuantitativeFilter {
  /** Gets the maximum value as specified in the domain. */
  /* CompleteClass */
  override def getDomainMax(): typingsSlinky.tableau.tableau.DataValue = js.native
  /** Gets the minimum value as specified in the domain. */
  /* CompleteClass */
  override def getDomainMin(): typingsSlinky.tableau.tableau.DataValue = js.native
  ...
  /* CompleteClass */
  override def getMax(): typingsSlinky.tableau.tableau.DataValue = js.native
  /** Gets the minimum value, inclusive, applied to the filter. */
  /* CompleteClass */
  override def getMin(): typingsSlinky.tableau.tableau.DataValue = js.native
