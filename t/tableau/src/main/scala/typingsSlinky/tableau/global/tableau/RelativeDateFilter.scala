...
class RelativeDateFilter ()
  extends typingsSlinky.tableau.tableau.RelativeDateFilter {
  /** Gets the field that is currently being filtered. */
  /* CompleteClass */
  override def getFieldAsync(): js.Promise[typingsSlinky.tableau.tableau.Field] = js.native
  ...
  /* CompleteClass */
  override def getFilterType(): typingsSlinky.tableau.tableau.FilterType = js.native
  /** The date period of the filter. See PeriodType Enum for the values in the enum. */
  /* CompleteClass */
  override def getPeriod(): typingsSlinky.tableau.tableau.PeriodType = js.native
  /** The range of the date filter (years, months, etc.). See DateRangeType Enum for the values in the enum. */
  /* CompleteClass */
  override def getRange(): typingsSlinky.tableau.tableau.DateRangeType = js.native
