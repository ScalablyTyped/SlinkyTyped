...
class StoryPointSwitchEvent ()
  extends typingsSlinky.tableau.tableau.StoryPointSwitchEvent {
  ...
  /* CompleteClass */
  override def getNewStoryPoint(): typingsSlinky.tableau.tableau.StoryPoint = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getOldStoryPointInfo(): typingsSlinky.tableau.tableau.StoryPointInfo = js.native
