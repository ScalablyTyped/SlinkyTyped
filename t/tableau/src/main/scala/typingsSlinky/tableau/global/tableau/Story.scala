...
@js.native
class Story ()
  extends typingsSlinky.tableau.tableau.Story {
  /** Activates the next story point if there is one. If the current story point is the last one, then is stays active. */
  /* CompleteClass */
  override def activateNextStoryPointAsync(): js.Promise[typingsSlinky.tableau.tableau.StoryPoint] = js.native
  /** Activates the previous story point if there is one. If the current story point is the first one, then it stays active. */
  /* CompleteClass */
  override def activatePreviousStoryPointAsync(): js.Promise[typingsSlinky.tableau.tableau.StoryPoint] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def activateStoryPointAsync(index: Double): js.Promise[typingsSlinky.tableau.tableau.StoryPoint] = js.native
  /**
  ...
  /* CompleteClass */
  override def getActiveStoryPoint(): typingsSlinky.tableau.tableau.StoryPoint = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getStoryPointsInfo(): js.Array[typingsSlinky.tableau.tableau.StoryPointInfo] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def revertStoryPointAsync(index: Double): js.Promise[typingsSlinky.tableau.tableau.StoryPoint] = js.native
}
