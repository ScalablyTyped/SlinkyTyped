...
import typingsSlinky.tableau.tableau.SheetSizeOptions
...
@js.native
class Dashboard ()
  extends typingsSlinky.tableau.tableau.Dashboard {
  /**
  ...
  /* CompleteClass */
  override def getObjects(): js.Array[typingsSlinky.tableau.tableau.DashboardObject] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getParentStoryPoint(): typingsSlinky.tableau.tableau.StoryPoint = js.native
  /** Gets the type of the sheet. SheetType is an enum with the following values: WORKSHEET , DASHBOARD and STORY. */
  /* CompleteClass */
  override def getSheetType(): typingsSlinky.tableau.tableau.SheetType = js.native
  ...
  /* CompleteClass */
  override def getWorkbook(): typingsSlinky.tableau.tableau.Workbook = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getWorksheets(): js.Array[typingsSlinky.tableau.tableau.Worksheet] = js.native
}
