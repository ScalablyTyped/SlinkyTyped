...
@js.native
class StoryPoint ()
  extends typingsSlinky.tableau.tableau.StoryPoint {
  ...
  /* CompleteClass */
  override def getContainedSheet(): typingsSlinky.tableau.tableau.Sheet = js.native
  ...
  /* CompleteClass */
  override def getParentStory(): typingsSlinky.tableau.tableau.Story = js.native
}
