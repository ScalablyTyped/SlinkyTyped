...
import typingsSlinky.tableau.tableau.TableauEventName.CUSTOM_VIEW_LOAD
import typingsSlinky.tableau.tableau.TableauEventName.CUSTOM_VIEW_REMOVE
import typingsSlinky.tableau.tableau.TableauEventName.CUSTOM_VIEW_SAVE
import typingsSlinky.tableau.tableau.TableauEventName.CUSTOM_VIEW_SET_DEFAULT
import typingsSlinky.tableau.tableau.TableauEventName.FILTER_CHANGE
import typingsSlinky.tableau.tableau.TableauEventName.MARKS_SELECTION
import typingsSlinky.tableau.tableau.TableauEventName.PARAMETER_VALUE_CHANGE
import typingsSlinky.tableau.tableau.TableauEventName.STORY_POINT_SWITCH
