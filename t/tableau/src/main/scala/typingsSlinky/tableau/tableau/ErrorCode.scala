...
object ErrorCode extends js.Object {
  ...
  /* "browserNotCapable" */ val BROWSER_NOT_CAPABLE: typingsSlinky.tableau.tableau.ErrorCode.BROWSER_NOT_CAPABLE with String = js.native
  /* "downloadWorkbookNotAllowed" */ val DOWNLOAD_WORKBOOK_NOT_ALLOWED: typingsSlinky.tableau.tableau.ErrorCode.DOWNLOAD_WORKBOOK_NOT_ALLOWED with String = js.native
  /* "filterCannotBePerformed" */ val FILTER_CANNOT_BE_PERFORMED: typingsSlinky.tableau.tableau.ErrorCode.FILTER_CANNOT_BE_PERFORMED with String = js.native
  /* "indexOutOfRange" */ val INDEX_OUT_OF_RANGE: typingsSlinky.tableau.tableau.ErrorCode.INDEX_OUT_OF_RANGE with String = js.native
  /* "internalError" */ val INTERNAL_ERROR: typingsSlinky.tableau.tableau.ErrorCode.INTERNAL_ERROR with String = js.native
  /* "invalidAggregationFieldName" */ val INVALID_AGGREGATION_FIELD_NAME: typingsSlinky.tableau.tableau.ErrorCode.INVALID_AGGREGATION_FIELD_NAME with String = js.native
  /* "invalidCustomViewName" */ val INVALID_CUSTOM_VIEW_NAME: typingsSlinky.tableau.tableau.ErrorCode.INVALID_CUSTOM_VIEW_NAME with String = js.native
  /* "invalidDateParameter" */ val INVALID_DATE_PARAMETER: typingsSlinky.tableau.tableau.ErrorCode.INVALID_DATE_PARAMETER with String = js.native
  /* "invalidFilterFieldName" */ val INVALID_FILTER_FIELDNAME: typingsSlinky.tableau.tableau.ErrorCode.INVALID_FILTER_FIELDNAME with String = js.native
  /* "invalidFilterFieldNameOrValue" */ val INVALID_FILTER_FIELDNAME_OR_VALUE: typingsSlinky.tableau.tableau.ErrorCode.INVALID_FILTER_FIELDNAME_OR_VALUE with String = js.native
  /* "invalidFilterFieldValue" */ val INVALID_FILTER_FIELDVALUE: typingsSlinky.tableau.tableau.ErrorCode.INVALID_FILTER_FIELDVALUE with String = js.native
  /* "invalidParameter" */ val INVALID_PARAMETER: typingsSlinky.tableau.tableau.ErrorCode.INVALID_PARAMETER with String = js.native
  /* "invalidSelectionDate" */ val INVALID_SELECTION_DATE: typingsSlinky.tableau.tableau.ErrorCode.INVALID_SELECTION_DATE with String = js.native
  /* "invalidSelectionFieldName" */ val INVALID_SELECTION_FIELDNAME: typingsSlinky.tableau.tableau.ErrorCode.INVALID_SELECTION_FIELDNAME with String = js.native
  /* "invalidSelectionValue" */ val INVALID_SELECTION_VALUE: typingsSlinky.tableau.tableau.ErrorCode.INVALID_SELECTION_VALUE with String = js.native
  /* "invalidSize" */ val INVALID_SIZE: typingsSlinky.tableau.tableau.ErrorCode.INVALID_SIZE with String = js.native
  /* "invalidSizeBehaviorOnWorksheet" */ val INVALID_SIZE_BEHAVIOR_ON_WORKSHEET: typingsSlinky.tableau.tableau.ErrorCode.INVALID_SIZE_BEHAVIOR_ON_WORKSHEET with String = js.native
  /* "invalidToolbarButtonName" */ val INVALID_TOOLBAR_BUTTON_NAME: typingsSlinky.tableau.tableau.ErrorCode.INVALID_TOOLBAR_BUTTON_NAME with String = js.native
  /* "invalidUrl" */ val INVALID_URL: typingsSlinky.tableau.tableau.ErrorCode.INVALID_URL with String = js.native
  /* "maxVizResizeAttempts" */ val MAX_VIZ_RESIZE_ATTEMPTS: typingsSlinky.tableau.tableau.ErrorCode.MAX_VIZ_RESIZE_ATTEMPTS with String = js.native
  /* "missingMaxSize" */ val MISSING_MAX_SIZE: typingsSlinky.tableau.tableau.ErrorCode.MISSING_MAX_SIZE with String = js.native
  /* "missingMinMaxSize" */ val MISSING_MINMAX_SIZE: typingsSlinky.tableau.tableau.ErrorCode.MISSING_MINMAX_SIZE with String = js.native
  /* "missingMinSize" */ val MISSING_MIN_SIZE: typingsSlinky.tableau.tableau.ErrorCode.MISSING_MIN_SIZE with String = js.native
  /* "missingRangeNForRelativeDateFilters" */ val MISSING_RANGEN_FOR_RELATIVE_DATE_FILTERS: typingsSlinky.tableau.tableau.ErrorCode.MISSING_RANGEN_FOR_RELATIVE_DATE_FILTERS with String = js.native
  /* "notActiveSheet" */ val NOT_ACTIVE_SHEET: typingsSlinky.tableau.tableau.ErrorCode.NOT_ACTIVE_SHEET with String = js.native
  /* "noUrlForHiddenWorksheet" */ val NO_URL_FOR_HIDDEN_WORKSHEET: typingsSlinky.tableau.tableau.ErrorCode.NO_URL_FOR_HIDDEN_WORKSHEET with String = js.native
  /* "noUrlOrParentElementNotFound" */ val NO_URL_OR_PARENT_ELEMENT_NOT_FOUND: typingsSlinky.tableau.tableau.ErrorCode.NO_URL_OR_PARENT_ELEMENT_NOT_FOUND with String = js.native
  /* "nullOrEmptyParameter" */ val NULL_OR_EMPTY_PARAMETER: typingsSlinky.tableau.tableau.ErrorCode.NULL_OR_EMPTY_PARAMETER with String = js.native
  /* "serverError" */ val SERVER_ERROR: typingsSlinky.tableau.tableau.ErrorCode.SERVER_ERROR with String = js.native
  /* "sheetNotInWorkbook" */ val SHEET_NOT_IN_WORKBOOK: typingsSlinky.tableau.tableau.ErrorCode.SHEET_NOT_IN_WORKBOOK with String = js.native
  /* "staleDataReference" */ val STALE_DATA_REFERENCE: typingsSlinky.tableau.tableau.ErrorCode.STALE_DATA_REFERENCE with String = js.native
  /* "unsupportedEventName" */ val UNSUPPORTED_EVENT_NAME: typingsSlinky.tableau.tableau.ErrorCode.UNSUPPORTED_EVENT_NAME with String = js.native
  /* "vizAlreadyInManager" */ val VIZ_ALREADY_IN_MANAGER: typingsSlinky.tableau.tableau.ErrorCode.VIZ_ALREADY_IN_MANAGER with String = js.native
  @JSBracketAccess
