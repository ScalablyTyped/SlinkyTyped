...
object Dashboard {
  ...
  implicit class DashboardOps[Self <: Dashboard] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetObjects(value: () => js.Array[DashboardObject]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getObjects")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetParentStoryPoint(value: () => StoryPoint): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getParentStoryPoint")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetWorksheets(value: () => js.Array[Worksheet]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getWorksheets")(js.Any.fromFunction0(value))
        ret
    }
  }
