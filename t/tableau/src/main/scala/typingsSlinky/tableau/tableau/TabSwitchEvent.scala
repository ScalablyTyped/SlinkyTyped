...
object TabSwitchEvent {
  ...
  implicit class TabSwitchEventOps[Self <: TabSwitchEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetNewSheetName(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getNewSheetName")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetOldSheetName(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOldSheetName")(js.Any.fromFunction0(value))
        ret
    }
  }
