...
object ConcreteFilter {
  ...
  def CategoricalFilter(
    ...
    __obj.asInstanceOf[typingsSlinky.tableau.tableau.CategoricalFilter]
  }
  ...
  def QuantitativeFilter(
    ...
    __obj.asInstanceOf[typingsSlinky.tableau.tableau.QuantitativeFilter]
  }
  ...
  def RelativeDateFilter(
    ...
    __obj.asInstanceOf[typingsSlinky.tableau.tableau.RelativeDateFilter]
  }
}
