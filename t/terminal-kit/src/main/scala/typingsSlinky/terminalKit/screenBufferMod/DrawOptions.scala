...
trait DrawOptions extends js.Object {
  ...
  var dstClipRect: js.UndefOr[typingsSlinky.terminalKit.rectMod.^] = js.undefined
  var srcClipRect: js.UndefOr[typingsSlinky.terminalKit.rectMod.^] = js.undefined
...
object DrawOptions {
  ...
  def apply(
    ...
    dstClipRect: typingsSlinky.terminalKit.rectMod.^ = null,
    srcClipRect: typingsSlinky.terminalKit.rectMod.^ = null,
