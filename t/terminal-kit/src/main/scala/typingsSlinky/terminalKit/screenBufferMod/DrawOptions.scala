...
object DrawOptions {
  ...
  implicit class DrawOptionsOps[Self <: DrawOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDstClipRect(value: typingsSlinky.terminalKit.rectMod.^): Self = this.set("dstClipRect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDstClipRect: Self = this.set("dstClipRect", js.undefined)
    
    @scala.inline
    def setSrcClipRect(value: typingsSlinky.terminalKit.rectMod.^): Self = this.set("srcClipRect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWrap(value: Boolean | typingsSlinky.terminalKit.terminalKitStrings.x | y): Self = this.set("wrap", value.asInstanceOf[js.Any])
