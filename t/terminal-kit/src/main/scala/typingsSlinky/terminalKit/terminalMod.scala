...
import typingsSlinky.nextgenEvents.mod.^
...
import typingsSlinky.terminalKit.anon.G
...
import typingsSlinky.terminalKit.anon.`3`
...
object terminalMod {
  ...
  object HookConfig {
    ...
    implicit class HookConfigMutableBuilder[Self <: HookConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTokenRegExp(value: js.RegExp): Self = StObject.set(x, "tokenRegExp", value.asInstanceOf[js.Any])
