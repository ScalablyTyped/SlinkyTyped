...
import typingsSlinky.terminalKit.anon.`5`
...
object textBufferMod {
  ...
  trait Options extends StObject {
    ...
    var dst: typingsSlinky.terminalKit.screenBufferMod.^ = js.native
  ...
  object Options {
    ...
    @scala.inline
    def apply(dst: typingsSlinky.terminalKit.screenBufferMod.^): Options = {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDst(value: typingsSlinky.terminalKit.screenBufferMod.^): Self = StObject.set(x, "dst", value.asInstanceOf[js.Any])
