...
import typingsSlinky.terminalDashKit.screenBufferMod.DrawOptions
...
trait TextBuffer extends js.Object {
  ...
  def iterate(options: Anon_FinalCall, callback: js.Function1[/* cellData */ Anon_AttrMisc, Unit]): Unit = js.native
