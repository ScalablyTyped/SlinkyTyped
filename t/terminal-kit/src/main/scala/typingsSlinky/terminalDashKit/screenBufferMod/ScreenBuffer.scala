...
import typingsSlinky.terminalDashKit.Anon_Attr
import typingsSlinky.terminalDashKit.Anon_AttrChar
import typingsSlinky.terminalDashKit.Anon_Dst
import typingsSlinky.terminalDashKit.Anon_X
...
@js.native
trait ScreenBuffer
  extends typingsSlinky.nextgenDashEvents.nextgenDashEventsMod.^ {
  ...
  def resize(fromRect: typingsSlinky.terminalDashKit.rectMod.Options): Unit = js.native
  def resize(fromRect: typingsSlinky.terminalDashKit.rectMod.^): Unit = js.native
