...
trait DrawOptions extends js.Object {
  ...
  var dstClipRect: js.UndefOr[typingsSlinky.terminalDashKit.rectMod.^] = js.undefined
  var srcClipRect: js.UndefOr[typingsSlinky.terminalDashKit.rectMod.^] = js.undefined
...
object DrawOptions {
  ...
  def apply(
    ...
    dstClipRect: typingsSlinky.terminalDashKit.rectMod.^ = null,
    srcClipRect: typingsSlinky.terminalDashKit.rectMod.^ = null,
