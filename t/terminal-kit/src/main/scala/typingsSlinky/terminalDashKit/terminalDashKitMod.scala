...
import typingsSlinky.terminalDashKit.rectMod.AbsoluteOptions
import typingsSlinky.terminalDashKit.rectMod.Region
import typingsSlinky.terminalDashKit.rectMod.^
import typingsSlinky.terminalDashKit.screenBufferMod.Attributes
import typingsSlinky.terminalDashKit.screenBufferMod.Options
import typingsSlinky.terminalDashKit.terminalMod.CreateOptions
...
object terminalDashKitMod extends js.Object {
  ...
  class Rect protected () extends ^ {
    ...
    def this(options: typingsSlinky.terminalDashKit.rectMod.Rect) = this()
  ...
  class ScreenBufferHD protected ()
    extends typingsSlinky.terminalDashKit.screenBufferHDMod.^ {
  ...
  class TextBuffer protected ()
    extends typingsSlinky.terminalDashKit.textBufferMod.^ {
    def this(options: typingsSlinky.terminalDashKit.textBufferMod.Options) = this()
  }
  ...
  object ScreenBuffer extends js.Object {
    ...
    def create(options: Options): typingsSlinky.terminalDashKit.screenBufferMod.ScreenBuffer = js.native
    def createFromString(options: Anon_AttrTransparencyChar, str: String): typingsSlinky.terminalDashKit.screenBufferMod.ScreenBuffer = js.native
    def loadImage(
      url: String,
      calback: js.Function2[
          /* error */ js.UndefOr[js.Any], 
          /* image */ js.UndefOr[typingsSlinky.terminalDashKit.screenBufferHDMod.^], 
          Unit
        ]
    ): Unit = js.native
    def loadImage(
      ...
      calback: js.Function2[
          /* error */ js.Any, 
          /* image */ typingsSlinky.terminalDashKit.screenBufferHDMod.^, 
          Unit
        ]
    ): Unit = js.native
    def loadSync(filepath: String): typingsSlinky.terminalDashKit.screenBufferMod.ScreenBuffer = js.native
  ...
  object Terminal extends js.Object {
    ...
    class AutocompletionArray[T] ()
      extends typingsSlinky.terminalDashKit.terminalMod.AutocompletionArray[T]
