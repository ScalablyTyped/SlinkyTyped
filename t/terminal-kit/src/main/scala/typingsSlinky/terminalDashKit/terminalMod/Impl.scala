...
import typingsSlinky.terminalDashKit.Anon_Abort
import typingsSlinky.terminalDashKit.Anon_B
import typingsSlinky.terminalDashKit.Anon_BarStyle
import typingsSlinky.terminalDashKit.Anon_Button
import typingsSlinky.terminalDashKit.Anon_Continue
import typingsSlinky.terminalDashKit.Anon_Delay
import typingsSlinky.terminalDashKit.Anon_NoAlternate
import typingsSlinky.terminalDashKit.Anon_Promise
import typingsSlinky.terminalDashKit.Anon_PromiseGridMenuResponse
import typingsSlinky.terminalDashKit.Anon_PromiseSingleColumnMenuResponse
import typingsSlinky.terminalDashKit.Anon_ShrinkAnonHeight
...
trait Impl extends js.Object {
  ...
  def bar(value: Double, options: Anon_BarStyle): Unit = js.native
  ...
  def drawImage(url: String, options: Anon_ShrinkAnonHeight): js.Promise[Unit] = js.native
  def drawImage(url: String, options: Anon_ShrinkAnonHeight, callback: Callback[Unit]): Unit = js.native
  ...
  def fullscreen(options: Anon_NoAlternate): Unit = js.native
  def getColor(register: Double): Unit = js.native
  def getColor(register: Double, callback: Callback[Anon_B]): Unit = js.native
  ...
  def grabInput(options: Anon_Button): Unit = js.native
  def grabInput(options: Anon_Button, safeCallback: Boolean): Unit = js.native
  ...
  def gridMenu(menuItems: js.Array[String]): Anon_PromiseGridMenuResponse = js.native
  def gridMenu(menuItems: js.Array[String], callback: Callback[GridMenuResponse]): Unit = js.native
  def gridMenu(menuItems: js.Array[String], options: GridMenuOptions): Anon_PromiseGridMenuResponse = js.native
  ...
  def inputField(): Anon_Abort = js.native
  def inputField(callback: Callback[String]): Unit = js.native
  def inputField(options: InputFieldOptions): Anon_Abort = js.native
  ...
  def setColor(register: Double, rgb: Anon_B): Unit = js.native
  def setColor(register: Double, rgb: Anon_B, names: js.Array[String]): Unit = js.native
  ...
  def singleColumnMenu(menuItems: js.Array[String]): Anon_PromiseSingleColumnMenuResponse = js.native
  def singleColumnMenu(menuItems: js.Array[String], callback: Callback[SingleColumnMenuResponse]): Unit = js.native
  def singleColumnMenu(menuItems: js.Array[String], options: SingleColumnMenuOptions): Anon_PromiseSingleColumnMenuResponse = js.native
  def singleColumnMenu(
    menuItems: js.Array[String],
    options: SingleColumnMenuOptions,
    callback: Callback[SingleColumnMenuResponse]
  ): Unit = js.native
  def singleLineMenu(menuItems: js.Array[String]): Anon_Promise = js.native
  def singleLineMenu(menuItems: js.Array[String], callback: Callback[SingleLineMenuResponse]): Unit = js.native
  def singleLineMenu(menuItems: js.Array[String], options: SingleLineMenuOptions): Anon_Promise = js.native
  def singleLineMenu(
    menuItems: js.Array[String],
    options: SingleLineMenuOptions,
    callback: Callback[SingleLineMenuResponse]
  ): Unit = js.native
  def singleRowMenu(menuItems: js.Array[String]): Anon_Promise = js.native
  def singleRowMenu(menuItems: js.Array[String], callback: Callback[SingleLineMenuResponse]): Unit = js.native
  def singleRowMenu(menuItems: js.Array[String], options: SingleLineMenuOptions): Anon_Promise = js.native
  def singleRowMenu(
    menuItems: js.Array[String],
    options: SingleLineMenuOptions,
    callback: Callback[SingleLineMenuResponse]
  ...
  def slowTyping(str: String, options: Anon_Delay): js.Promise[Unit] = js.native
  def slowTyping(str: String, options: Anon_Delay, callback: Callback[Unit]): Unit = js.native
  ...
  def wrapColumn(options: Anon_Continue): Unit = js.native
  ...
  def yesOrNo(): Anon_Abort = js.native
  def yesOrNo(options: YesOrNoOptions): Anon_Abort = js.native
