...
trait styleConfig extends js.Object {
  ...
  var imgProcess: js.UndefOr[typingsSlinky.textversionjs.mod.imgProcess] = js.undefined
  var keepNbsps: js.UndefOr[Boolean] = js.undefined
  var linkProcess: js.UndefOr[typingsSlinky.textversionjs.mod.linkProcess] = js.undefined
...
object styleConfig {
  ...
  def apply(
    ...
    listIndentionTabs: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(keepNbsps)) __obj.updateDynamic("keepNbsps")(keepNbsps.get.asInstanceOf[js.Any])
    if (linkProcess != null) __obj.updateDynamic("linkProcess")(js.Any.fromFunction2(linkProcess))
    if (!js.isUndefined(listIndentionTabs)) __obj.updateDynamic("listIndentionTabs")(listIndentionTabs.get.asInstanceOf[js.Any])
