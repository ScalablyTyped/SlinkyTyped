...
import typingsSlinky.tinymce.tinymceMod.dom.DOMUtils
import typingsSlinky.tinymce.tinymceMod.dom.DomQuery
import typingsSlinky.tinymce.tinymceMod.dom.Selection
import typingsSlinky.tinymce.tinymceMod.dom.Serializer
import typingsSlinky.tinymce.tinymceMod.html.DomParser
import typingsSlinky.tinymce.tinymceMod.html.Schema
import typingsSlinky.tinymce.tinymceMod.util.Observable
import typingsSlinky.tinymce.tinymceMod.util.URI
...
class Editor protected () extends Observable {
  def this(id: String, settings: Settings, editorManager: EditorManager) = this()
  @JSName("$")
  ...
  var notificationManager: typingsSlinky.tinymce.tinymceMod.notificationManager = js.native
