...
object dom {
  ...
  trait TreeWalker extends StObject {
    ...
    def current(): typingsSlinky.tinymce.mod.html.Node = js.native
    
    def next(): typingsSlinky.tinymce.mod.html.Node = js.native
    
    def prev(): typingsSlinky.tinymce.mod.html.Node = js.native
  }
  object TreeWalker {
    
    @scala.inline
    def apply(
      current: () => typingsSlinky.tinymce.mod.html.Node,
      next: () => typingsSlinky.tinymce.mod.html.Node,
      prev: () => typingsSlinky.tinymce.mod.html.Node
    ): typingsSlinky.tinymce.mod.dom.TreeWalker = {
      ...
      __obj.asInstanceOf[typingsSlinky.tinymce.mod.dom.TreeWalker]
    }
    
    @scala.inline
    implicit class TreeWalkerMutableBuilder[Self <: typingsSlinky.tinymce.mod.dom.TreeWalker] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setCurrent(value: () => typingsSlinky.tinymce.mod.html.Node): Self = StObject.set(x, "current", js.Any.fromFunction0(value))
      
      @scala.inline
      def setNext(value: () => typingsSlinky.tinymce.mod.html.Node): Self = StObject.set(x, "next", js.Any.fromFunction0(value))
      
      @scala.inline
      def setPrev(value: () => typingsSlinky.tinymce.mod.html.Node): Self = StObject.set(x, "prev", js.Any.fromFunction0(value))
    }
  }
}
