...
object Settings_ {
  ...
  implicit class Settings_MutableBuilder[Self <: Settings_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProtect(value: js.Array[js.RegExp]): Self = StObject.set(x, "protect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProtectUndefined: Self = StObject.set(x, "protect", js.undefined)
    
    @scala.inline
    def setProtectVarargs(value: js.RegExp*): Self = StObject.set(x, "protect", js.Array(value :_*))
