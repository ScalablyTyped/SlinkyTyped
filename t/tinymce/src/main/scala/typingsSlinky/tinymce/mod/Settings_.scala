...
object Settings_ {
  ...
  implicit class Settings_Ops[Self <: Settings_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProtectVarargs(value: js.RegExp*): Self = this.set("protect", js.Array(value :_*))
    
    @scala.inline
    def setProtect(value: js.Array[js.RegExp]): Self = this.set("protect", value.asInstanceOf[js.Any])
