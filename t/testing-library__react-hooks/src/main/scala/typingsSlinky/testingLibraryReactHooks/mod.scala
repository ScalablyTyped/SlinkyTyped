package typingsSlinky.testingLibraryReactHooks

import slinky.core.ReactComponentClass
import typingsSlinky.reactTestRenderer.mod.DebugPromiseLike
import typingsSlinky.testingLibraryReactHooks.anon.PickWaitOptionstimeout
import typingsSlinky.testingLibraryReactHooks.anon.PickWaitOptionstimeoutsup
...
object mod {
  ...
  trait RenderHookOptions[P] extends StObject {
    ...
    var wrapper: js.UndefOr[ReactComponentClass[P]] = js.native
  }
  object RenderHookOptions {
    ...
    implicit class RenderHookOptionsMutableBuilder[Self <: RenderHookOptions[_], P] (val x: Self with RenderHookOptions[P]) extends AnyVal {
      ...
      @scala.inline
      def setWrapper(value: ReactComponentClass[P]): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWrapperComponentClass(value: ReactComponentClass[P]): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWrapperFunctionComponent(value: ReactComponentClass[P]): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
