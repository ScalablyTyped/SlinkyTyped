...
object RenderHookOptions {
  ...
  implicit class RenderHookOptionsOps[Self <: RenderHookOptions[_], P] (val x: Self with RenderHookOptions[P]) extends AnyVal {
    ...
    @scala.inline
    def setWrapperFunctionComponent(value: ReactComponentClass[P]): Self = this.set("wrapper", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWrapperComponentClass(value: ReactComponentClass[P]): Self = this.set("wrapper", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWrapper(value: ReactComponentClass[P]): Self = this.set("wrapper", value.asInstanceOf[js.Any])
