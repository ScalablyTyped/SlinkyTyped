...
object mod {
  ...
  object default {
    ...
    @js.native
    val `match`: js.Function1[/* expectedValue */ js.RegExp | String, js.Any] = js.native
    @JSImport("ts-mockito", "default.match")
    @js.native
  ...
  @JSImport("ts-mockito", "anyFunction")
  @js.native
  def anyFunction(): js.Any = js.native
  
  @JSImport("ts-mockito", "anyNumber")
  @js.native
  def anyNumber(): js.Any = js.native
  
  @JSImport("ts-mockito", "anyOfClass")
  @js.native
  def anyOfClass[T](expectedClass: Instantiable1[/* args (repeated) */ js.Any, T]): js.Any = js.native
  
  @JSImport("ts-mockito", "anyString")
  @js.native
  def anyString(): js.Any = js.native
  
  @JSImport("ts-mockito", "anything")
  @js.native
  def anything(): js.Any = js.native
  
  @JSImport("ts-mockito", "between")
  @js.native
  def between(min: Double, max: Double): js.Any = js.native
  
  @JSImport("ts-mockito", "capture")
  @js.native
  def capture[T0](method: js.Function1[/* a */ T0, _]): ArgCaptor1[T0] = js.native
  @JSImport("ts-mockito", "capture")
  @js.native
  ...
  @JSImport("ts-mockito", "deepEqual")
  @js.native
  def deepEqual[T](expectedValue: T): T = js.native
  
  @JSImport("ts-mockito", "instance")
  @js.native
  def instance[T](mockedValue: T): T = js.native
  
  @JSImport("ts-mockito", "mock")
  @js.native
  def mock[T](): T = js.native
  @JSImport("ts-mockito", "mock")
  @js.native
  ...
  @JSImport("ts-mockito", "notNull")
  @js.native
  def notNull(): js.Any = js.native
  
  @JSImport("ts-mockito", "objectContaining")
  @js.native
  def objectContaining(expectedValue: js.Object): js.Any = js.native
  
  @JSImport("ts-mockito", "reset")
  @js.native
  def reset[T](mockedValues: T*): Unit = js.native
  
  @JSImport("ts-mockito", "resetCalls")
  @js.native
  def resetCalls[T](mockedValues: T*): Unit = js.native
  
  @JSImport("ts-mockito", "spy")
  @js.native
  def spy[T](instanceToSpy: T): T = js.native
  
  @JSImport("ts-mockito", "strictEqual")
  @js.native
  def strictEqual(expectedValue: js.Any): js.Any = js.native
  
  @JSImport("ts-mockito", "verify")
  @js.native
  def verify[T](method: T): MethodStubVerificator[T] = js.native
  
  @JSImport("ts-mockito", "when")
  @js.native
  def when[T](method: T): MethodStubSetter[T, Unit, js.Error] = js.native
  @JSImport("ts-mockito", "when")
  @js.native
