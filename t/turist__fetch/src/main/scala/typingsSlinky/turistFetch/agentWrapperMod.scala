...
import typingsSlinky.turistFetch.typesMod.AgentOptions
...
object agentWrapperMod {
  ...
  trait Agent extends StObject {
    ...
    def getAgent(url: String): typingsSlinky.node.httpMod.Agent = js.native
  ...
  object Agent {
    ...
    @scala.inline
    def apply(getAgent: String => typingsSlinky.node.httpMod.Agent, `private`: js.Any): Agent = {
    ...
    implicit class AgentMutableBuilder[Self <: Agent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetAgent(value: String => typingsSlinky.node.httpMod.Agent): Self = StObject.set(x, "getAgent", js.Any.fromFunction1(value))
