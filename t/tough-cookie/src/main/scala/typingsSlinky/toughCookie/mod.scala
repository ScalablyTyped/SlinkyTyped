  ...
  object Cookie {
    ...
    object Properties {
      ...
      implicit class PropertiesMutableBuilder[Self <: Properties] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreation(value: js.Date): Self = StObject.set(x, "creation", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setLastAccessed(value: js.Date): Self = StObject.set(x, "lastAccessed", value.asInstanceOf[js.Any])
  ...
  object CookieJar {
    ...
    object Serialized {
      ...
      implicit class SerializedMutableBuilder[Self <: Serialized] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCookies(value: js.Array[typingsSlinky.toughCookie.mod.Cookie.Serialized]): Self = StObject.set(x, "cookies", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setCookiesVarargs(value: typingsSlinky.toughCookie.mod.Cookie.Serialized*): Self = StObject.set(x, "cookies", js.Array(value :_*))
