...
object Serialized {
  ...
  implicit class SerializedOps[Self <: Serialized] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCookiesVarargs(value: typingsSlinky.toughCookie.mod.Cookie.Serialized*): Self = this.set("cookies", js.Array(value :_*))
    @scala.inline
    def setCookies(value: js.Array[typingsSlinky.toughCookie.mod.Cookie.Serialized]): Self = this.set("cookies", value.asInstanceOf[js.Any])
    @scala.inline
