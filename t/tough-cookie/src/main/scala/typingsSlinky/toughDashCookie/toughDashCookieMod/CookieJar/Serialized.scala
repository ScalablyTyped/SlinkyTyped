...
trait Serialized extends js.Object {
  var cookies: js.Array[typingsSlinky.toughDashCookie.toughDashCookieMod.Cookie.Serialized]
...
object Serialized {
  @scala.inline
  def apply(
    cookies: js.Array[typingsSlinky.toughDashCookie.toughDashCookieMod.Cookie.Serialized],
