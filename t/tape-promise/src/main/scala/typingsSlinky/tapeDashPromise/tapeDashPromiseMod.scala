...
import typingsSlinky.tape.tapeMod.TestOptions
...
@js.native
object tapeDashPromiseMod extends js.Object {
  ...
  trait AsyncTapeFunction extends js.Object {
    ...
    /**
    	 ...
    	 */
    def createHarness(): AsyncTapeFunction with Anon_Cb = js.native
  ...
  def default(tapeTest: js.Any): AsyncTapeFunction with Anon_Cb = js.native
