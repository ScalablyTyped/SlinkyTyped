...
object mod {
  ...
  */
  ...
  object EntityWithIndices {
    ...
    @scala.inline
    def CashtagWithIndices(cashtag: String, indices: js.Tuple2[Double, Double]): typingsSlinky.twitterText.mod.CashtagWithIndices = {
      val __obj = js.Dynamic.literal(cashtag = cashtag.asInstanceOf[js.Any], indices = indices.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.twitterText.mod.CashtagWithIndices]
    }
    
    @scala.inline
    def HashtagWithIndices(hashtag: String, indices: js.Tuple2[Double, Double]): typingsSlinky.twitterText.mod.HashtagWithIndices = {
      val __obj = js.Dynamic.literal(hashtag = hashtag.asInstanceOf[js.Any], indices = indices.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.twitterText.mod.HashtagWithIndices]
    }
    
    @scala.inline
    def MentionOrListWithIndices(indices: js.Tuple2[Double, Double], listSlug: String, screenName: String): typingsSlinky.twitterText.mod.MentionOrListWithIndices = {
      ...
      __obj.asInstanceOf[typingsSlinky.twitterText.mod.MentionOrListWithIndices]
    }
    
    @scala.inline
    def MentionWithIndices(indices: js.Tuple2[Double, Double], screenName: String): typingsSlinky.twitterText.mod.MentionWithIndices = {
      val __obj = js.Dynamic.literal(indices = indices.asInstanceOf[js.Any], screenName = screenName.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.twitterText.mod.MentionWithIndices]
    }
    
    @scala.inline
    def UrlWithIndices(indices: js.Tuple2[Double, Double], url: String): typingsSlinky.twitterText.mod.UrlWithIndices = {
      val __obj = js.Dynamic.literal(indices = indices.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.twitterText.mod.UrlWithIndices]
    }
  }
