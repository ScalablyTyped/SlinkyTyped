...
object TweetLengthOptions {
  ...
  implicit class TweetLengthOptionsOps[Self <: TweetLengthOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShort_url_length(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("short_url_length")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withShort_url_length_https(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("short_url_length_https")(value.asInstanceOf[js.Any])
        ret
    }
  }
