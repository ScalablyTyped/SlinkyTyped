...
object mod {
  ...
  object Theming {
    ...
    implicit class ThemingMutableBuilder[Self <: Theming[_], Theme] (val x: Self with Theming[Theme]) extends AnyVal {
      ...
      @scala.inline
      def setThemeProviderComponentClass(value: ReactComponentClass[ThemeProviderProps[Theme]]): Self = StObject.set(x, "ThemeProvider", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setThemeProviderFunctionComponent(value: ReactComponentClass[ThemeProviderProps[Theme]]): Self = StObject.set(x, "ThemeProvider", value.asInstanceOf[js.Any])
  ...
  type WithThemeFactory[Theme] = js.Function1[
    /* comp */ ReactComponentClass[ThemeNonNullable[Theme]], 
    ReactComponentClass[ThemeNonNullable[Theme] with `0`[Theme]]
  ]
}
