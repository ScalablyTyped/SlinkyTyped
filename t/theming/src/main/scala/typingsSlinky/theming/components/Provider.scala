...
object Provider {
  @JSImport("theming", "ThemeContext.Provider")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def value(value: DefaultTheme): this.type = set("value", value.asInstanceOf[js.Any])
    @scala.inline
    def valueNull: this.type = set("value", null)
  }
  
  def withProps(p: ProviderProps[DefaultTheme]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
