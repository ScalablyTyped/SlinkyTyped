...
object ThemeProvider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.theming.themingMod.ThemeProvider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.theming.themingMod.ThemeProvider] = {
