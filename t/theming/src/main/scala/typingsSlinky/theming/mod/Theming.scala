...
object Theming {
  ...
  implicit class ThemingOps[Self <: Theming[_], Theme] (val x: Self with Theming[Theme]) extends AnyVal {
    ...
    @scala.inline
    def setThemeProviderFunctionComponent(value: ReactComponentClass[ThemeProviderProps[Theme]]): Self = this.set("ThemeProvider", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setThemeProviderComponentClass(value: ReactComponentClass[ThemeProviderProps[Theme]]): Self = this.set("ThemeProvider", value.asInstanceOf[js.Any])
