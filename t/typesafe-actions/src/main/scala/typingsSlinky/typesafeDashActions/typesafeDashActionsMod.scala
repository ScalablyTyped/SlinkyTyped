...
import typingsSlinky.typesafeDashActions.distCreateDashActionDashDeprecatedMod.FSA
import typingsSlinky.typesafeDashActions.distCreateDashActionMod.PayloadMetaAction
import typingsSlinky.typesafeDashActions.distCreateDashAsyncDashActionMod.AsyncActionBuilder
...
object typesafeDashActionsMod extends js.Object {
  ...
  def isActionOf[AC /* <: typingsSlinky.typesafeDashActions.distIsDashActionDashOfMod.ActionCreator[Anon_TypeString] */](actionCreator: AC): js.Function1[/* action */ Anon_TypeString, /* is std.ReturnType<AC> */ Boolean] = js.native
  def isActionOf[AC /* <: typingsSlinky.typesafeDashActions.distIsDashActionDashOfMod.ActionCreator[Anon_TypeString] */](actionCreator: AC, action: Anon_TypeString): /* is std.ReturnType<AC> */ Boolean = js.native
  def isActionOf[AC /* <: typingsSlinky.typesafeDashActions.distIsDashActionDashOfMod.ActionCreator[Anon_TypeString] */](actionCreator: js.Array[AC]): js.Function1[/* action */ Anon_TypeString, /* is std.ReturnType<AC> */ Boolean] = js.native
  def isActionOf[AC /* <: typingsSlinky.typesafeDashActions.distIsDashActionDashOfMod.ActionCreator[Anon_TypeString] */](actionCreator: js.Array[AC], action: Anon_TypeString): /* is std.ReturnType<AC> */ Boolean = js.native
