...
object createActionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.typesafeActions.AnonMetaPayload[T, P, M]
    - typingsSlinky.typesafeActions.AnonPayloadType[T, P]
    - typingsSlinky.typesafeActions.AnonMetaType[T, M]
    - typingsSlinky.typesafeActions.AnonTypeT[T]
  */
