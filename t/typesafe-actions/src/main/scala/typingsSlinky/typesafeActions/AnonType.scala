...
object AnonType {
  @scala.inline
  def apply[T, P, M, E](error: E, meta: M, payload: P, `type`: T): AnonType[T, P, M, E] = {
  ...
  @scala.inline
  implicit class AnonTypeOps[Self[t, p, m, e] <: AnonType[t, p, m, e], T, P, M, E] (val x: Self[T, P, M, E]) extends AnyVal {
    @scala.inline
