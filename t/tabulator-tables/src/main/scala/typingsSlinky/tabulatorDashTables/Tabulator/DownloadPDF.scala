...
import typingsSlinky.tabulatorDashTables.tabulatorDashTablesStrings.landscape
import typingsSlinky.tabulatorDashTables.tabulatorDashTablesStrings.portrait
