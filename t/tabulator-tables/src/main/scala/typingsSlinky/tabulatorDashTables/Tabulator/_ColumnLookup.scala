...
object _ColumnLookup {
  ...
  def ColumnComponent(
    ...
    getField: () => String,
    getNextColumn: () => typingsSlinky.tabulatorDashTables.Tabulator.ColumnComponent | `false`,
    getParentColumn: () => typingsSlinky.tabulatorDashTables.Tabulator.ColumnComponent | `false`,
    getPrevColumn: () => typingsSlinky.tabulatorDashTables.Tabulator.ColumnComponent | `false`,
    getSubColumns: () => js.Array[typingsSlinky.tabulatorDashTables.Tabulator.ColumnComponent],
    getTable: () => typingsSlinky.tabulatorDashTables.Tabulator,
  ...
  def ColumnDefinition(
    ...
    columns: js.Array[typingsSlinky.tabulatorDashTables.Tabulator.ColumnDefinition] = null,
