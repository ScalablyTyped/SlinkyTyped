...
object AutoCompleteParams {
  ...
  implicit class AutoCompleteParamsOps[Self <: AutoCompleteParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEmptyPlaceholderHTMLElement(value: HTMLElement): Self = this.set("emptyPlaceholder", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSearchingPlaceholderHTMLElement(value: HTMLElement): Self = this.set("searchingPlaceholder", value.asInstanceOf[js.Any])
    @scala.inline
