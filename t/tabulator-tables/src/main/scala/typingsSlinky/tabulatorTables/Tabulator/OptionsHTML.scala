...
object OptionsHTML {
  ...
  implicit class OptionsHTMLOps[Self <: OptionsHTML] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrintFooterHTMLElement(value: HTMLElement): Self = this.set("printFooter", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPrintHeaderHTMLElement(value: HTMLElement): Self = this.set("printHeader", value.asInstanceOf[js.Any])
    @scala.inline
