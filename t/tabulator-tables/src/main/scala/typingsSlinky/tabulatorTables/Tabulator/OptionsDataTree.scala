...
object OptionsDataTree {
  ...
  implicit class OptionsDataTreeOps[Self <: OptionsDataTree] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataTreeCollapseElementHTMLElement(value: HTMLElement): Self = this.set("dataTreeCollapseElement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataTreeExpandElementHTMLElement(value: HTMLElement): Self = this.set("dataTreeExpandElement", value.asInstanceOf[js.Any])
