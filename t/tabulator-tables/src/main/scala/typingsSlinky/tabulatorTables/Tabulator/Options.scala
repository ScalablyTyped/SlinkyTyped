...
import typingsSlinky.tabulatorTables.AnonColumnCalcs
import typingsSlinky.tabulatorTables.PickFilterfieldvalue
...
import typingsSlinky.tabulatorTables.tabulatorTablesStrings.middle
...
- typingsSlinky.tabulatorTables.Tabulator.OptionsCell because var conflicts: cellClick, cellContext, cellDblClick, cellDblTap, cellEditCancelled, cellEdited, cellEditing, cellMouseEnter, cellMouseLeave, cellMouseMove, cellMouseOut, cellMouseOver, cellTap, cellTapHold. Inlined  */ trait Options
...
object Options {
  ...
  def apply(
    ...
    movableRowsReceived: (/* fromRow */ RowComponent, /* toRow */ RowComponent, /* fromTable */ typingsSlinky.tabulatorTables.Tabulator) => Unit = null,
    movableRowsReceivedFailed: (/* fromRow */ RowComponent, /* toRow */ RowComponent, /* fromTable */ typingsSlinky.tabulatorTables.Tabulator) => Unit = null,
    ...
    movableRowsReceivingStart: (/* fromRow */ RowComponent, /* toTable */ typingsSlinky.tabulatorTables.Tabulator) => Unit = null,
    movableRowsReceivingStop: /* fromTable */ typingsSlinky.tabulatorTables.Tabulator => Unit = null,
    ...
    movableRowsSent: (/* fromRow */ RowComponent, /* toRow */ RowComponent, /* toTable */ typingsSlinky.tabulatorTables.Tabulator) => Unit = null,
    movableRowsSentFailed: (/* fromRow */ RowComponent, /* toRow */ RowComponent, /* toTable */ typingsSlinky.tabulatorTables.Tabulator) => Unit = null,
