...
object MenuObject {
  @scala.inline
  def apply[/* <: typingsSlinky.tabulatorTables.Tabulator.RowComponent | typingsSlinky.tabulatorTables.Tabulator.CellComponent | typingsSlinky.tabulatorTables.Tabulator.ColumnComponent | typingsSlinky.tabulatorTables.Tabulator.GroupComponent */ T](
  ...
  @scala.inline
  implicit class MenuObjectOps[Self <: MenuObject[_], /* <: typingsSlinky.tabulatorTables.Tabulator.RowComponent | typingsSlinky.tabulatorTables.Tabulator.CellComponent | typingsSlinky.tabulatorTables.Tabulator.ColumnComponent | typingsSlinky.tabulatorTables.Tabulator.GroupComponent */ T] (val x: Self with MenuObject[T]) extends AnyVal {
    @scala.inline
