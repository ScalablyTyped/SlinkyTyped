...
object OptionsLocale {
  ...
  implicit class OptionsLocaleOps[Self <: OptionsLocale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLangs(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("langs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLangs: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("langs")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLocalized(value: (/* locale */ String, /* lang */ js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("localized")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
