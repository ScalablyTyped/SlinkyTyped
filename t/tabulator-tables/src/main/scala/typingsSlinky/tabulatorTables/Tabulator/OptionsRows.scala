...
object OptionsRows {
  ...
  implicit class OptionsRowsOps[Self <: OptionsRows] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMovableRowsConnectedElementsHTMLElement(value: HTMLElement): Self = this.set("movableRowsConnectedElements", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMovableRowsConnectedTablesHTMLElement(value: HTMLElement): Self = this.set("movableRowsConnectedTables", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMovableRowsReceivingStart(value: (/* fromRow */ RowComponent, /* toTable */ typingsSlinky.tabulatorTables.Tabulator) => Unit): Self = this.set("movableRowsReceivingStart", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteMovableRowsReceivingStart: Self = this.set("movableRowsReceivingStart", js.undefined)
    
    @scala.inline
    def setMovableRowsReceivingStop(value: /* fromTable */ typingsSlinky.tabulatorTables.Tabulator => Unit): Self = this.set("movableRowsReceivingStop", js.Any.fromFunction1(value))
