...
object OptionsGeneral {
  ...
  implicit class OptionsGeneralOps[Self <: OptionsGeneral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFooterElementHTMLElement(value: HTMLElement): Self = this.set("footerElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPlaceholderHTMLElement(value: HTMLElement): Self = this.set("placeholder", value.asInstanceOf[js.Any])
    @scala.inline
