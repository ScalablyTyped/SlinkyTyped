...
object AccountInfo {
  ...
  implicit class AccountInfoOps[Self <: AccountInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUsedAddressesVarargs(value: typingsSlinky.trezorConnect.anon.Address*): Self = this.set("usedAddresses", js.Array(value :_*))
    @scala.inline
    def setUsedAddresses(value: js.Array[typingsSlinky.trezorConnect.anon.Address]): Self = this.set("usedAddresses", value.asInstanceOf[js.Any])
    @scala.inline
