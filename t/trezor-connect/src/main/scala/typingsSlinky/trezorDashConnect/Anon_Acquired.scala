...
import typingsSlinky.trezorDashConnect.trezorDashConnectMod.DeviceFirmwareStatus
import typingsSlinky.trezorDashConnect.trezorDashConnectMod.DeviceMode
import typingsSlinky.trezorDashConnect.trezorDashConnectMod.DeviceStatus
import typingsSlinky.trezorDashConnect.trezorDashConnectMod.Features
import typingsSlinky.trezorDashConnect.trezorDashConnectMod.FirmwareRelease
