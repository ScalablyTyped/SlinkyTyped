...
object RenderOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.testingLibraryDom.getQueriesForElementMod.Queries */ Q](): RenderOptions[Q] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RenderOptions[Q]]
  }
  @scala.inline
  implicit class RenderOptionsOps[Self <: RenderOptions[_], /* <: typingsSlinky.testingLibraryDom.getQueriesForElementMod.Queries */ Q] (val x: Self with RenderOptions[Q]) extends AnyVal {
    @scala.inline
