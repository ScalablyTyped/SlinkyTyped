...
trait Status extends js.Object {
  ...
  var current_user_retweet: js.UndefOr[AnonId] = js.undefined
...
object Status {
  ...
  def apply(
    ...
    if (!js.isUndefined(favorited)) __obj.updateDynamic("favorited")(favorited.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(possibly_sensitive)) __obj.updateDynamic("possibly_sensitive")(possibly_sensitive.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(withheld_copyright)) __obj.updateDynamic("withheld_copyright")(withheld_copyright.asInstanceOf[js.Any])
