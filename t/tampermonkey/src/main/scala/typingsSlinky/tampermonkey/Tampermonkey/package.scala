...
package object Tampermonkey {
  type NotificationOnClick = js.ThisFunction0[/* this */ typingsSlinky.tampermonkey.Tampermonkey.NotificationThis, scala.Unit]
  /** `clicked` is `true` when `text` was set */
  type NotificationOnDone = js.ThisFunction1[
    /* this */ typingsSlinky.tampermonkey.Tampermonkey.NotificationThis, 
