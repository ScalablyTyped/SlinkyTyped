...
import typingsSlinky.typedDashGithubDashApi.distInterfacesIssueMod.IssueRef
...
import typingsSlinky.typedDashGithubDashApi.typedDashGithubDashApiStrings.none
import typingsSlinky.typedDashGithubDashApi.typedDashGithubDashApiStrings.open
import typingsSlinky.typedDashGithubDashApi.typedDashGithubDashApiStrings.popularity
