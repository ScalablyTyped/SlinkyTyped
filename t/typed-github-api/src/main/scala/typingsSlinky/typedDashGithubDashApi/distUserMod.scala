...
import typingsSlinky.typedDashGithubDashApi.distApiDashInterfacesUserMod.PrivateUser
import typingsSlinky.typedDashGithubDashApi.distApiDashInterfacesUserMod.User
