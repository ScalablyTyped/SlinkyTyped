...
@js.native
abstract class WebHook[TData /* <: WebHookData */, TApiData /* <: typingsSlinky.typedDashGithubDashApi.distApiDashInterfacesWebDashHooksMod.WebHookData */] protected () extends GitHubRef {
