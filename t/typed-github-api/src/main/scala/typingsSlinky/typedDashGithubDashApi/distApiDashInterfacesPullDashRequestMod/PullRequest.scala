package typingsSlinky.typedDashGithubDashApi.distApiDashInterfacesPullDashRequestMod

import typingsSlinky.typedDashGithubDashApi.distApiDashInterfacesBranchMod.BranchSummary
