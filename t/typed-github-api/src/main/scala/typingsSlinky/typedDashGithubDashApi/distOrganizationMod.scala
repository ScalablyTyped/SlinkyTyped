...
import typingsSlinky.typedDashGithubDashApi.distApiDashInterfacesUserMod.Organization
...
object distOrganizationMod extends js.Object {
  ...
  - typings.typedDashGithubDashApi.distInterfacesOrganizationMod.OrganizationSummary because Already inherited
  - typings.typedDashGithubDashApi.distInterfacesOrganizationMod.Organization because var conflicts: avatarUri, description, id, login. Inlined name, company, blog, location, email, publicRepos, publicGists, followers, following, createdAt, updatedAt, htmlUri, hasOrganizationProjects, hasRepositoryProjects */ @js.native
  ...
  /* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
  - typings.typedDashGithubDashApi.distInterfacesOwnerDashRefMod.OwnerRef because Already inherited
  - typings.typedDashGithubDashApi.distInterfacesOrganizationMod.OrganizationSummary because var conflicts: login. Inlined id, avatarUri, description */ @js.native
