...
import typingsSlinky.typedGithubApi.anon.Additions
import typingsSlinky.typedGithubApi.anon.Bloburl
...
object Commit {
  ...
  implicit class CommitOps[Self <: Commit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFiles(value: js.Array[Bloburl]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("files")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStats(value: Additions): Self = {
        val ret = this.duplicate
