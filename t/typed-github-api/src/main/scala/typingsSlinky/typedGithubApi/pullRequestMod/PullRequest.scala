...
object PullRequest {
  ...
  implicit class PullRequestOps[Self <: PullRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClosed_at(value: js.Date): Self = this.set("closed_at", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setClosed_atNull: Self = this.set("closed_at", null)
    
    @scala.inline
    def setMerged_at(value: js.Date): Self = this.set("merged_at", value.asInstanceOf[js.Any])
