...
@js.native
trait AnonAdditions extends js.Object {
  var additions: Double = js.native
  var deletions: Double = js.native
  var total: Double = js.native
}

object AnonAdditions {
  @scala.inline
  def apply(additions: Double, deletions: Double, total: Double): AnonAdditions = {
    ...
    __obj.asInstanceOf[AnonAdditions]
  }
  @scala.inline
  implicit class AnonAdditionsOps[Self <: AnonAdditions] (val x: Self) extends AnyVal {
    @scala.inline
