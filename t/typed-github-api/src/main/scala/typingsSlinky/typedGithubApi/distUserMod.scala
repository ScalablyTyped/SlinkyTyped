...
object distUserMod {
  ...
  - typingsSlinky.typedGithubApi.ownerRefMod.OwnerRef because Already inherited
  - typingsSlinky.typedGithubApi.interfacesUserMod.UserSummary because Already inherited
  - typingsSlinky.typedGithubApi.interfacesUserMod.User because var conflicts: avatarUri, id, login. Inlined name, company, blog, location, email, publicRepos, publicGists, followers, following, createdAt, updatedAt */ @JSImport("typed-github-api/dist/user", "UserClass")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsSlinky.typedGithubApi.ownerRefMod.OwnerRef because Already inherited
  - typingsSlinky.typedGithubApi.interfacesUserMod.UserSummary because var conflicts: login. Inlined id, avatarUri */ @JSImport("typed-github-api/dist/user", "UserSummaryClass")
  @js.native
