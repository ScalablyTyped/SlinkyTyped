...
object userMod {
  ...
  object OrganizationSummary {
    ...
    implicit class OrganizationSummaryMutableBuilder[Self <: OrganizationSummary] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: typingsSlinky.typedGithubApi.typedGithubApiStrings.Organization): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
  ...
  object UserSummary {
    ...
    implicit class UserSummaryMutableBuilder[Self <: UserSummary] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: typingsSlinky.typedGithubApi.typedGithubApiStrings.User): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
}
