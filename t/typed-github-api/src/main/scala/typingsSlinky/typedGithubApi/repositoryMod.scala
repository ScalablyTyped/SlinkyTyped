...
object repositoryMod {
  ...
  object Repository {
    ...
    implicit class RepositoryMutableBuilder[Self <: Repository] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOwner(value: UserSummary): Self = StObject.set(x, "owner", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPushed_at(value: js.Date): Self = StObject.set(x, "pushed_at", value.asInstanceOf[js.Any])
