...
import typingsSlinky.textBuffer.AnonExclusiveInvalidate
import typingsSlinky.textBuffer.AnonInvalidate
import typingsSlinky.textBuffer.AnonMaintainHistory
import typingsSlinky.textBuffer.AnonNewExtent
import typingsSlinky.textBuffer.AnonNormalizeLineEndings
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Events.BufferChanged
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Events.BufferChanging
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Events.BufferStoppedChanging
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Events.BufferWatchError
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Events.FileSaved
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Options.FindMarker
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Options.ScanContext
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Structures.BufferScanResult
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Structures.ContextualBufferScanResult
...
trait TextBuffer extends js.Object {
  ...
  def release(): typingsSlinky.textBuffer.mod._Global_.TextBuffer.TextBuffer = js.native
  ...
  def retain(): typingsSlinky.textBuffer.mod._Global_.TextBuffer.TextBuffer = js.native
  /**
