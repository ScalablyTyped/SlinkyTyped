...
import typingsSlinky.textBuffer.AnonExclusive
import typingsSlinky.textBuffer.mod._Global_.TextBuffer.Events.MarkerChanged
...
trait Marker extends js.Object {
  ...
  def setRange(range: RangeCompatible, params: AnonExclusive): Boolean = js.native
  /**
