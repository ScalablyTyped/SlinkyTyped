package typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer

import typingsSlinky.eventDashKit.eventDashKitMod.Disposable
import typingsSlinky.pathwatcher.pathwatcherMod.File
import typingsSlinky.textDashBuffer.Anon_ExclusiveInside
import typingsSlinky.textDashBuffer.Anon_ExclusiveInsideInvalidate
import typingsSlinky.textDashBuffer.Anon_MaintainHistory
import typingsSlinky.textDashBuffer.Anon_NewExtent
import typingsSlinky.textDashBuffer.Anon_NormalizeLineEndings
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Events.BufferChanged
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Events.BufferChanging
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Events.BufferStoppedChanging
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Events.BufferWatchError
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Events.FileSaved
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Options.FindMarker
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Options.ScanContext
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Structures.BufferScanResult
import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Structures.ContextualBufferScanResult
...
trait TextBuffer extends js.Object {
  ...
  def release(): typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.TextBuffer = js.native
  ...
  def retain(): typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.TextBuffer = js.native
  /**
