package typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Events

import typingsSlinky.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Structures.TextChange
