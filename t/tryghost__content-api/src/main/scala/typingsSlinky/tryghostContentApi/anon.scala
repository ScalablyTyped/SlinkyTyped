...
object anon {
  ...
  object Pagination {
    ...
    @scala.inline
    def apply(pagination: typingsSlinky.tryghostContentApi.mod.Pagination): Pagination = {
    ...
    implicit class PaginationMutableBuilder[Self <: Pagination] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPagination(value: typingsSlinky.tryghostContentApi.mod.Pagination): Self = StObject.set(x, "pagination", value.asInstanceOf[js.Any])
    }
  }
