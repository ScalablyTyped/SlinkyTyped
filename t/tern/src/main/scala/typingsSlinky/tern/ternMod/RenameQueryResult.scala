...
object RenameQueryResult {
  ...
  implicit class RenameQueryResultOps[Self <: RenameQueryResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChangesVarargs(value: typingsSlinky.tern.anon.File*): Self = this.set("changes", js.Array(value :_*))
    @scala.inline
    def setChanges(value: js.Array[typingsSlinky.tern.anon.File]): Self = this.set("changes", value.asInstanceOf[js.Any])
  }
