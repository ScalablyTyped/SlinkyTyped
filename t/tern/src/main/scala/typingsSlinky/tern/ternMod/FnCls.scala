...
class FnCls protected ()
  extends typingsSlinky.tern.libInferMod.Fn {
  def this(
    name: js.UndefOr[scala.Nothing],
    self: typingsSlinky.tern.libInferMod.AVal,
    args: js.Array[typingsSlinky.tern.libInferMod.AVal],
    argNames: js.Array[String],
    retval: typingsSlinky.tern.libInferMod.AVal
  ) = this()
  def this(
    name: String,
    self: typingsSlinky.tern.libInferMod.AVal,
