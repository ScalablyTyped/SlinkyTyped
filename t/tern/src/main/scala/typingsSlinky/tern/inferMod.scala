...
object inferMod {
  ...
  trait AVal extends ANull {
    ...
    /**
      ...
      * assignment “weak”.
      */
    def addType(`type`: typingsSlinky.tern.inferMod.Type): Unit = js.native
    def addType(`type`: typingsSlinky.tern.inferMod.Type, weight: Double): Unit = js.native
    ...
    /**
      ...
      */
    def getFunctionType(): js.UndefOr[typingsSlinky.tern.inferMod.Fn] = js.native
    
    /**
      * Asks the AVal if it contains an Object type. Useful when
      * you aren’t interested in other kinds of types.
      */
    def getObjType(): typingsSlinky.tern.inferMod.Obj | Null = js.native
    
    /** Get an `AVal` that represents the named property of this type. */
    def getProp(prop: String): typingsSlinky.tern.inferMod.AVal = js.native
    ...
    /**
      ...
      */
    def getType(): typingsSlinky.tern.inferMod.Type | Null = js.native
    def getType(guess: Boolean): typingsSlinky.tern.inferMod.Type | Null = js.native
    
    /** Queries whether the AVal _currently_ holds the given type. */
    def hasType(`type`: typingsSlinky.tern.inferMod.Type): Boolean = js.native
    ...
    val propertyOf: js.UndefOr[typingsSlinky.tern.inferMod.Obj] = js.native
    
    val types: js.Array[typingsSlinky.tern.inferMod.Type] = js.native
  }
  ...
  trait Context extends StObject {
    ...
    var topScope: typingsSlinky.tern.inferMod.Scope = js.native
  }
  object Context {
    ...
    implicit class ContextMutableBuilder[Self <: Context] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTopScope(value: typingsSlinky.tern.inferMod.Scope): Self = StObject.set(x, "topScope", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Fn
    ...
    val args: js.UndefOr[js.Array[typingsSlinky.tern.inferMod.AVal]] = js.native
    
    /**
      * Asks the AVal if it contains a function type. Useful when
      * you aren’t interested in other kinds of types.
      */
    def getFunctionType(): typingsSlinky.tern.inferMod.Fn = js.native
    
    def isArrowFn(): Boolean = js.native
    
    val retval: typingsSlinky.tern.inferMod.AVal = js.native
    
    var self: js.UndefOr[typingsSlinky.tern.inferMod.Type] = js.native
  }
  ...
  trait Obj
    extends IType
       with typingsSlinky.tern.inferMod.Type {
    ...
    def defProp(prop: String): typingsSlinky.tern.inferMod.AVal = js.native
    def defProp(prop: String, originNode: Node): typingsSlinky.tern.inferMod.AVal = js.native
    
    /** Call the given function for all properties of the object, including properties that are added in the future. */
    def forAllProps(
      f: js.Function3[
          /* prop */ String, 
          /* val */ typingsSlinky.tern.inferMod.AVal, 
          /* local */ Boolean, 
          Unit
        ]
    ): Unit = js.native
    ...
    /**
      ...
      * you aren’t interested in other kinds of types.
      */
    def getObjType(): typingsSlinky.tern.inferMod.Obj = js.native
    
    /** Get an `AVal` that represents the named property of this type. */
    def getProp(prop: String): typingsSlinky.tern.inferMod.AVal = js.native
    
    /** Looks up the AVal associated with the given property, or returns null if it doesn’t exist. */
    def hasProp(prop: String): typingsSlinky.tern.inferMod.AVal | Null = js.native
  ...
  object Prim {
    ...
    implicit class PrimMutableBuilder[Self <: Prim] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetProp(value: String => typingsSlinky.tern.inferMod.AVal): Self = StObject.set(x, "getProp", js.Any.fromFunction1(value))
  ...
  trait Scope
    ...
    /**
      ...
      */
    def defVar(name: String, originNode: Node): typingsSlinky.tern.inferMod.AVal = js.native
  }
  ...
  */
  ...
  trait AValConstructor
    extends Instantiable0[typingsSlinky.tern.inferMod.AVal]
  
  @js.native
  trait ArrConstructor
    extends /** Constructor that creates an array type with the given content type. */
  Instantiable0[typingsSlinky.tern.inferMod.Arr]
       with Instantiable1[
          /* contentType */ typingsSlinky.tern.inferMod.AVal, 
          typingsSlinky.tern.inferMod.Arr
        ]
  ...
  trait Constraint_ extends ANull {
    ...
    def typeHint(): js.UndefOr[typingsSlinky.tern.inferMod.Type] = js.native
  }
  object Constraint_ {
    ...
    def apply(
      ...
      typeHint: () => js.UndefOr[typingsSlinky.tern.inferMod.Type]
    ): Constraint_ = {
    ...
    implicit class Constraint_MutableBuilder[Self <: Constraint_] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTypeHint(value: () => js.UndefOr[typingsSlinky.tern.inferMod.Type]): Self = StObject.set(x, "typeHint", js.Any.fromFunction0(value))
    }
  }
  ...
  trait FnConstructor
    extends Instantiable5[
          ...
          /* argNames */ js.Array[String], 
          /* retval */ typingsSlinky.tern.inferMod.AVal, 
          typingsSlinky.tern.inferMod.Fn
        ]
  
  @js.native
  trait IType extends ANull {
    
    def getType(): typingsSlinky.tern.inferMod.Type = js.native
  ...
  object IType {
    ...
    def apply(
      ...
      getProp: /* repeated */ js.Any => ANull,
      getSymbolType: /* repeated */ js.Any => js.UndefOr[ANull],
      getType: () => typingsSlinky.tern.inferMod.Type,
      hasType: typingsSlinky.tern.inferMod.Type => Boolean,
      isEmpty: /* repeated */ js.Any => Boolean,
      origin: String,
    ...
    implicit class ITypeMutableBuilder[Self <: IType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetType(value: () => typingsSlinky.tern.inferMod.Type): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
      
      @scala.inline
      def setHasType(value: typingsSlinky.tern.inferMod.Type => Boolean): Self = StObject.set(x, "hasType", js.Any.fromFunction1(value))
  ...
  trait ObjConstructor
    extends Instantiable0[typingsSlinky.tern.inferMod.Obj]
       with Instantiable1[`true` | (/* proto */ js.Object), typingsSlinky.tern.inferMod.Obj]
       with Instantiable2[
  ...
  trait ScopeConstructor
    extends Instantiable0[typingsSlinky.tern.inferMod.Scope]
       with Instantiable2[
          /* parent */ typingsSlinky.tern.inferMod.Scope, 
          /* originNode */ Node, 
          typingsSlinky.tern.inferMod.Scope
        ]
  
  @js.native
  trait TypeConstructor
    extends Instantiable0[typingsSlinky.tern.inferMod.Type]
}
