...
object Query {
  @scala.inline
  def apply[/* <: typingsSlinky.tern.ternMod.Query */ Q](): Query[Q] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Query[Q]]
  }
  @scala.inline
  implicit class QueryOps[Self <: Query[_], /* <: typingsSlinky.tern.ternMod.Query */ Q] (val x: Self with Query[Q]) extends AnyVal {
    @scala.inline
