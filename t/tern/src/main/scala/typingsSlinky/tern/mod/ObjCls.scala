...
class ObjCls ()
  ...
  /* CompleteClass */
  override def getFunctionType(args: js.Any*): js.UndefOr[typingsSlinky.tern.inferMod.ANull] = js.native
  /* CompleteClass */
  override def getObjType(args: js.Any*): js.UndefOr[typingsSlinky.tern.inferMod.ANull | Null] = js.native
  /* CompleteClass */
  override def getProp(args: js.Any*): typingsSlinky.tern.inferMod.ANull = js.native
  /* CompleteClass */
  override def getSymbolType(args: js.Any*): js.UndefOr[typingsSlinky.tern.inferMod.ANull] = js.native
  /* CompleteClass */
  override def getType(): typingsSlinky.tern.inferMod.Type = js.native
  /* CompleteClass */
  override def getType(args: js.Any*): js.UndefOr[typingsSlinky.tern.inferMod.ANull | Null] = js.native
  /* CompleteClass */
  override def hasType(args: js.Any*): Boolean = js.native
  /** Queries whether the AVal _currently_ holds the given type. */
  /* CompleteClass */
  override def hasType(`type`: typingsSlinky.tern.inferMod.Type): Boolean = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def typeHint(args: js.Any*): js.UndefOr[typingsSlinky.tern.inferMod.ANull | Null] = js.native
}
