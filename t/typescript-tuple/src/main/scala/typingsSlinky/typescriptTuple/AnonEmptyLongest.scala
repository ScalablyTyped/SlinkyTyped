...
object AnonEmptyLongest {
  ...
  @scala.inline
  implicit class AnonEmptyLongestOps[Self[longest, tupleset] <: AnonEmptyLongest[longest, tupleset], Longest, TupleSet] (val x: Self[Longest, TupleSet]) extends AnyVal {
    @scala.inline
