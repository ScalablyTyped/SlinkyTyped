...
package object libMod {
  type AllIndexesEqual[Type, Tuple /* <: js.Array[_] */] = typingsSlinky.typescriptTuple.utilsMod.IndexesNormalize[
    typingsSlinky.typescriptTuple.utilsMod.AllIndexesEqual[Type, Tuple, js.Array[js.Any], js.Array[js.Any]]
  ]
  type AllIndexesSubset[Type, Tuple /* <: js.Array[_] */] = typingsSlinky.typescriptTuple.utilsMod.IndexesNormalize[
    typingsSlinky.typescriptTuple.utilsMod.AllIndexesSubset[Type, Tuple, js.Array[js.Any], js.Array[js.Any]]
  ]
  type AllIndexesSuperset[Type, Tuple /* <: js.Array[_] */] = typingsSlinky.typescriptTuple.utilsMod.IndexesNormalize[
    typingsSlinky.typescriptTuple.utilsMod.AllIndexesSuperset[Type, Tuple, js.Array[js.Any], js.Array[js.Any]]
  ]
  type Append[Tuple /* <: js.Array[_] */, Addend] = typingsSlinky.typescriptTuple.libMod.Reverse[
    typingsSlinky.typescriptTuple.libMod.Prepend[typingsSlinky.typescriptTuple.libMod.Reverse[Tuple], Addend]
  ]
  ...
  type Repeat[Type, Count /* <: scala.Double */] = typingsSlinky.typescriptTuple.utilsMod.Repeat[Type, Count, js.Array[js.Any]]
  ...
  type SliceStartQuantity[Tuple /* <: js.Array[_] */, Start /* <: scala.Double */, Quantity /* <: scala.Double */] = typingsSlinky.typescriptTuple.utilsMod.SliceStartQuantity[Tuple, Start, Quantity, js.Array[js.Any], js.Array[js.Any]]
