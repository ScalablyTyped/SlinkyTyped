...
object NonEmpty {
  ...
  @scala.inline
  implicit class NonEmptyOps[Self[notfound, tuple, `type`, count] <: NonEmpty[notfound, tuple, `type`, count], NotFound, Tuple, Type, Count] (val x: Self[NotFound, Tuple, Type, Count]) extends AnyVal {
    @scala.inline
