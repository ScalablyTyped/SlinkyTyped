...
object ERROR {
  ...
  implicit class ERRORMutableBuilder[Self <: ERROR] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCODENAME(value: InfiniteLeft with typingsSlinky.typescriptTuple.typescriptTupleStrings.Infinite): Self = StObject.set(x, "CODENAME", value.asInstanceOf[js.Any])
