...
object ERROR {
  ...
  implicit class ERROROps[Self <: ERROR] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCODENAME(value: InfiniteLeft with typingsSlinky.typescriptTuple.typescriptTupleStrings.Infinite): Self = this.set("CODENAME", value.asInstanceOf[js.Any])
    @scala.inline
