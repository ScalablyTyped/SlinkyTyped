...
object InfiniteArray {
  ...
  @scala.inline
  implicit class InfiniteArrayOps[Self[holder, tuple, replacement] <: InfiniteArray[holder, tuple, replacement], Holder, Tuple, Replacement] (val x: Self[Holder, Tuple, Replacement]) extends AnyVal {
    @scala.inline
