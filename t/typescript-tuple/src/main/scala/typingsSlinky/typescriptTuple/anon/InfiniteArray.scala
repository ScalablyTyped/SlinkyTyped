...
object InfiniteArray {
  ...
  @scala.inline
  implicit class InfiniteArrayOps[Self <: InfiniteArray[_, _, _], /* <: js.Array[_] */ Holder, /* <: js.Array[_] */ Tuple, Replacement] (val x: Self with (InfiniteArray[Holder, Tuple, Replacement])) extends AnyVal {
    @scala.inline
