...
object EmptyNonEmpty {
  ...
  @scala.inline
  implicit class EmptyNonEmptyOps[Self <: EmptyNonEmpty[_, _], Shortest, /* <: js.Array[js.Array[_]] */ TupleSet] (val x: Self with (EmptyNonEmpty[Shortest, TupleSet])) extends AnyVal {
    @scala.inline
