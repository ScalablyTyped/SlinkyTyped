...
object AnonEmptyInfinite {
  ...
  @scala.inline
  implicit class AnonEmptyInfiniteOps[Self[notfound, tuple, `type`, count] <: AnonEmptyInfinite[notfound, tuple, `type`, count], NotFound, Tuple, Type, Count] (val x: Self[NotFound, Tuple, Type, Count]) extends AnyVal {
    @scala.inline
