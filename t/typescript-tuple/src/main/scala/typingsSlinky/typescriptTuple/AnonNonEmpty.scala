...
object AnonNonEmpty {
  ...
  @scala.inline
  implicit class AnonNonEmptyOps[Self[notfound, tuple, `type`, count] <: AnonNonEmpty[notfound, tuple, `type`, count], NotFound, Tuple, Type, Count] (val x: Self[NotFound, Tuple, Type, Count]) extends AnyVal {
    @scala.inline
