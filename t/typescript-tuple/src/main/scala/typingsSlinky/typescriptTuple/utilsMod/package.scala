...
package object utilsMod {
  ...
  type IndexesNormalize[Indexes /* <: js.Array[_] */] = typingsSlinky.typescriptTuple.utilsMod.IsFinite[
    Indexes, 
    typingsSlinky.typescriptTuple.utilsMod.Reverse[Indexes, js.Array[js.Any]], 
    typingsSlinky.typescriptTuple.utilsMod.Concat[typingsSlinky.typescriptTuple.utilsMod.Reverse[js.Any, js.Array[js.Any]], js.Any]
  ]
  ...
  type LastIndexEqual[Type, Tuple /* <: js.Array[_] */, NotFound] = typingsSlinky.typescriptTuple.utilsMod.LastIndexFirst[
    typingsSlinky.typescriptTuple.utilsMod.AllIndexesEqual[Type, Tuple, js.Array[js.Any], js.Array[js.Any]], 
    NotFound
  ]
  type LastIndexFirst[Tuple /* <: js.Array[_] */, NotFound] = typingsSlinky.typescriptTuple.utilsMod.IsFinite[Tuple, typingsSlinky.typescriptTuple.utilsMod.First[Tuple, NotFound], js.Any]
  type LastIndexSubset[Type, Tuple /* <: js.Array[_] */, NotFound] = typingsSlinky.typescriptTuple.utilsMod.LastIndexFirst[
    typingsSlinky.typescriptTuple.utilsMod.AllIndexesSubset[Type, Tuple, js.Array[js.Any], js.Array[js.Any]], 
    NotFound
  ]
  type LastIndexSuperset[Type, Tuple /* <: js.Array[_] */, NotFound] = typingsSlinky.typescriptTuple.utilsMod.LastIndexFirst[
  ...
  type SliceStartQuantity[Tuple /* <: js.Array[_] */, Start /* <: scala.Double */, Quantity /* <: scala.Double */, Holder /* <: js.Array[_] */, Count /* <: js.Array[_] */] = /* import warning: importer.ImportType#apply Failed type conversion: typescript-tuple.anon.Before<Tuple, Holder>[Tuple extends [] ? 'end' : Quantity extends Holder['length'] ? 'end' : Start extends Count['length'] ? 'start' : 'before'] */ js.Any
  ...
  type SplitInfiniteTuple[Tuple /* <: js.Array[_] */] = js.Tuple2[typingsSlinky.typescriptTuple.utilsMod.Reverse[js.Any, js.Array[js.Any]], js.Any]
