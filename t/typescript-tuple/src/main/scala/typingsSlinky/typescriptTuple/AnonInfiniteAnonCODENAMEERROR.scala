...
trait AnonInfiniteAnonCODENAMEERROR[TupleSet /* <: js.Array[js.Array[_]] */] extends js.Object {
  ...
  var infinite: AnonCODENAMEERROR = js.native
  var nonEmpty: Concat[
...
object AnonInfiniteAnonCODENAMEERROR {
  ...
  @scala.inline
  implicit class AnonInfiniteAnonCODENAMEERROROps[Self[tupleset] <: AnonInfiniteAnonCODENAMEERROR[tupleset], TupleSet] (val x: Self[TupleSet]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInfinite(value: AnonCODENAMEERROR): Self[TupleSet] = {
        val ret = this.duplicate
