...
import typingsSlinky.typescriptDashTuple.typescriptDashTupleStrings.InfiniteTuple
import typingsSlinky.typescriptDashTuple.typescriptDashTupleStrings.`Cannot reverse an infinite tuple`
