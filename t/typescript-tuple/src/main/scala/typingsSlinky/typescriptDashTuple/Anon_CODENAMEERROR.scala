...
import typingsSlinky.typescriptDashTuple.typescriptDashTupleStrings.InfiniteLeft
import typingsSlinky.typescriptDashTuple.typescriptDashTupleStrings.`Left is not finite`
