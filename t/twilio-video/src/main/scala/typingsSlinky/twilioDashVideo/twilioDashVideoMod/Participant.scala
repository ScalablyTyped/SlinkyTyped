...
import typingsSlinky.twilioDashVideo.twilioDashVideoMod.Participant.Identity
...
class Participant () extends EventEmitter {
  ...
  var sid: typingsSlinky.twilioDashVideo.twilioDashVideoMod.Participant.SID = js.native
