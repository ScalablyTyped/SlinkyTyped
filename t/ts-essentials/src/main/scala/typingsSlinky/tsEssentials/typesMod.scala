...
object typesMod {
  ...
  {-readonly [ P in keyof T ]: ts-essentials.ts-essentials/dist/types.DeepWritable<T[P]>}
    */ typingsSlinky.tsEssentials.tsEssentialsStrings.DeepWritableObject with TopLevel[T]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.tsEssentials.tsEssentialsBooleans.`false`
    - typingsSlinky.tsEssentials.tsEssentialsBooleans.`true`
  */
  ...
  {[ Q in keyof T ]: T[Q]}
    */ typingsSlinky.tsEssentials.tsEssentialsStrings.IsFullyWritable with TopLevel[T], 
    Writable[
      /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ Q in keyof T ]: T[Q]}
    */ typingsSlinky.tsEssentials.tsEssentialsStrings.IsFullyWritable with TopLevel[T]
  ...
  {-readonly [ P in keyof T ]: T[P]}
    */ typingsSlinky.tsEssentials.tsEssentialsStrings.Writable with TopLevel[T]
