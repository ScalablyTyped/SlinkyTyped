package typingsSlinky.ttiPolyfill.mod
...
object GetFirstConsistentlyInteractiveOpts {
  ...
  implicit class GetFirstConsistentlyInteractiveOptsOps[Self <: GetFirstConsistentlyInteractiveOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUseMutationObserver(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("useMutationObserver")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutUseMutationObserver: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("useMutationObserver")(js.undefined)
        ret
    }
  }
