...
object testUtilsMod {
  ...
  object FakeAnalyser {
    ...
    implicit class FakeAnalyserMutableBuilder[Self <: FakeAnalyser] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetFloatFrequencyData(value: js.typedarray.Float32Array => Unit): Self = StObject.set(x, "getFloatFrequencyData", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGetFloatTimeDomainData(value: js.typedarray.Float32Array => Unit): Self = StObject.set(x, "getFloatTimeDomainData", js.Any.fromFunction1(value))
