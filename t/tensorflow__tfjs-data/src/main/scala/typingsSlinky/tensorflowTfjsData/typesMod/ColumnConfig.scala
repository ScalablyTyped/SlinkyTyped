...
object ColumnConfig {
  ...
  implicit class ColumnConfigOps[Self <: ColumnConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultInt32Array(value: js.typedarray.Int32Array): Self = this.set("default", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultFloat32Array(value: js.typedarray.Float32Array): Self = this.set("default", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultUint8Array(value: js.typedarray.Uint8Array): Self = this.set("default", value.asInstanceOf[js.Any])
