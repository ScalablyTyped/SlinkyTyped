...
object FakeAnalyser {
  ...
  implicit class FakeAnalyserOps[Self <: FakeAnalyser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetFloatFrequencyData(value: js.typedarray.Float32Array => Unit): Self = this.set("getFloatFrequencyData", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetFloatTimeDomainData(value: js.typedarray.Float32Array => Unit): Self = this.set("getFloatTimeDomainData", js.Any.fromFunction1(value))
