...
object typesMod {
  ...
  object ColumnConfig {
    ...
    implicit class ColumnConfigMutableBuilder[Self <: ColumnConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultFloat32Array(value: js.typedarray.Float32Array): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultInt32Array(value: js.typedarray.Int32Array): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
