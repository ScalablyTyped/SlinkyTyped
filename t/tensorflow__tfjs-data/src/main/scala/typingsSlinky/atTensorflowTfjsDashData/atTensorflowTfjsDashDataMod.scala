...
object atTensorflowTfjsDashDataMod extends js.Object {
  ...
  class CSVDataset protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.distDatasetsCsvUnderscoreDatasetMod.CSVDataset {
    /**
      * Create a `CSVDataset`.
      *
  ...
  abstract class Dataset[T /* <: TensorContainer */] ()
    extends typingsSlinky.atTensorflowTfjsDashData.distDatasetMod.Dataset[T]
  
  @js.native
  class FileDataSource protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.distSourcesFileUnderscoreDataUnderscoreSourceMod.FileDataSource {
  ...
  class TextLineDataset protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.distDatasetsTextUnderscoreLineUnderscoreDatasetMod.TextLineDataset {
    /**
  ...
  class URLDataSource protected ()
    extends typingsSlinky.atTensorflowTfjsDashData.distSourcesUrlUnderscoreDataUnderscoreSourceMod.URLDataSource {
    /**
