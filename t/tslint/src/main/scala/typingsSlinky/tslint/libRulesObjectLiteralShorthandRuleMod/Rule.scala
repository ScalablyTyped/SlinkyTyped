package typingsSlinky.tslint.libRulesObjectLiteralShorthandRuleMod

import typingsSlinky.tslint.libLanguageRuleRuleMod.IRuleMetadata
import typingsSlinky.tslint.tslintMod.Rules.AbstractRule
import typingsSlinky.tslint.tslintStrings.`Shorthand method assignments have been disallowedDot`
import typingsSlinky.tslint.tslintStrings.`Shorthand property and method assignments have been disallowedDot`
import typingsSlinky.tslint.tslintStrings.`Shorthand property assignments have been disallowedDot`
