...
object allMod extends js.Object {
  ...
  object rules extends js.Object {
    ...
    var `array-type`: OptionsString = js.native
    var `arrow-parens`: Boolean = js.native
    var `arrow-return-shorthand`: OptionsString = js.native
    ...
    var `comment-type`: OptionsArray = js.native
    ...
    var `file-name-casing`: OptionsString = js.native
    ...
    var indent: OptionsArray = js.native
    ...
    var `linebreak-style`: OptionsString = js.native
    var `match-default-export-name`: Boolean = js.native
    var `max-classes-per-file`: OptionsNumber = js.native
    var `max-file-line-count`: OptionsNumber = js.native
    var `max-line-length`: OptionsLimit = js.native
    var `member-access`: OptionsArray = js.native
    var `member-ordering`: OptionsAlphabetize = js.native
    ...
    var `no-duplicate-variable`: OptionsArray = js.native
    ...
    var `no-inferrable-types`: OptionsArray = js.native
    ...
    var `no-unnecessary-class`: OptionsArray = js.native
    ...
    var quotemark: OptionsArray = js.native
    var radix: Boolean = js.native
    var `restrict-plus-operands`: Boolean = js.native
    var `return-undefined`: Boolean = js.native
    var semicolon: OptionsArray = js.native
    var `space-before-function-paren`: OptionsAnonymous = js.native
    ...
    var `trailing-comma`: OptionsEsSpecCompliant = js.native
    var `triple-equals`: Boolean = js.native
    var `type-literal-delimiter`: Boolean = js.native
    var typedef: OptionsArray = js.native
    var `typedef-whitespace`: `0` = js.native
