...
import typingsSlinky.tslint.libVerifyLinesMod.ErrorLine
import typingsSlinky.tslint.libVerifyLinesMod.Line
import typingsSlinky.tslint.tslintStrings.`~nil`
