...
import typingsSlinky.tslint.libRulesCompletedDashDocsTagExclusionMod.IContentTags
...
object Anon_Content {
  @scala.inline
  def apply(content: IContentTags, existence: js.Array[String]): Anon_Content = {
