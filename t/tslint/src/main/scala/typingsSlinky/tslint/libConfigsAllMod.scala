...
@js.native
object libConfigsAllMod extends js.Object {
  ...
  object rules extends js.Object {
    ...
    var align: Anon_OptionsArray = js.native
    var `array-type`: Anon_OptionsString = js.native
    var `arrow-parens`: Boolean = js.native
    var `arrow-return-shorthand`: Anon_OptionsString = js.native
    var `await-promise`: Boolean = js.native
    var `ban-comma-operator`: Boolean = js.native
    var `ban-ts-ignore`: Boolean = js.native
    var `ban-types`: Anon_Options = js.native
    ...
    var `comment-format`: Anon_OptionsArray = js.native
    var `comment-type`: Anon_OptionsArray = js.native
    ...
    var `file-name-casing`: Anon_OptionsString = js.native
    ...
    var indent: Anon_OptionsArray = js.native
    var `interface-name`: Boolean = js.native
    var `interface-over-type-literal`: Boolean = js.native
    var `invalid-void`: Boolean = js.native
    var `jsdoc-format`: Anon_OptionsString = js.native
    var `label-position`: Boolean = js.native
    var `linebreak-style`: Anon_OptionsString = js.native
    var `match-default-export-name`: Boolean = js.native
    var `max-classes-per-file`: Anon_OptionsNumber = js.native
    var `max-file-line-count`: Anon_OptionsNumber = js.native
    var `max-line-length`: Anon_OptionsAnonLimit = js.native
    var `member-access`: Anon_OptionsArray = js.native
    var `member-ordering`: Anon_OptionsAnonAlphabetize = js.native
    ...
    var `no-duplicate-variable`: Anon_OptionsArray = js.native
    ...
    var `no-inferrable-types`: Anon_OptionsArray = js.native
    ...
    var `no-unnecessary-class`: Anon_OptionsArray = js.native
    ...
    var quotemark: Anon_OptionsArray = js.native
    var radix: Boolean = js.native
    var `restrict-plus-operands`: Boolean = js.native
    var `return-undefined`: Boolean = js.native
    var semicolon: Anon_OptionsArray = js.native
    var `space-before-function-paren`: Anon_OptionsAnonAnonymous = js.native
    var `space-within-parens`: Anon_OptionsNumber = js.native
    ...
    var `trailing-comma`: Anon_OptionsAnonEsSpecCompliant = js.native
    var `triple-equals`: Boolean = js.native
    var `type-literal-delimiter`: Boolean = js.native
    var typedef: Anon_OptionsArray = js.native
    var `typedef-whitespace`: Anon_OptionsAnonCallsignature = js.native
    ...
    var `variable-name`: Anon_OptionsArray = js.native
    var whitespace: Anon_OptionsArray = js.native
  }
