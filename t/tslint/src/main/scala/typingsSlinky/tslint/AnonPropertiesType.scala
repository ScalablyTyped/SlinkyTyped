...
trait AnonPropertiesType extends js.Object {
  var properties: AnonTags = js.native
...
object AnonPropertiesType {
  ...
  @scala.inline
  implicit class AnonPropertiesTypeOps[Self <: AnonPropertiesType] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withProperties(value: AnonTags): Self = {
