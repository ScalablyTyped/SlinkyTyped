...
object LintResult {
  ...
  implicit class LintResultOps[Self <: LintResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFailuresVarargs(value: typingsSlinky.tslint.ruleMod.RuleFailure*): Self = this.set("failures", js.Array(value :_*))
    @scala.inline
    def setFailures(value: js.Array[typingsSlinky.tslint.ruleMod.RuleFailure]): Self = this.set("failures", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFixesVarargs(value: typingsSlinky.tslint.ruleMod.RuleFailure*): Self = this.set("fixes", js.Array(value :_*))
    @scala.inline
    def setFixes(value: js.Array[typingsSlinky.tslint.ruleMod.RuleFailure]): Self = this.set("fixes", value.asInstanceOf[js.Any])
    @scala.inline
