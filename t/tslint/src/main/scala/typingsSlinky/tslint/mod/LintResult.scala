...
trait LintResult extends js.Object {
  ...
  var failures: js.Array[typingsSlinky.tslint.ruleMod.RuleFailure]
  var fixes: js.UndefOr[js.Array[typingsSlinky.tslint.ruleMod.RuleFailure]] = js.undefined
...
object LintResult {
  ...
  def apply(
    ...
    output: String,
    warningCount: Double,
    fixes: js.Array[typingsSlinky.tslint.ruleMod.RuleFailure] = null
  ): LintResult = {
