...
object interfaceNameRuleMod {
  ...
  object Rule {
    ...
    @scala.inline
    def FAILURE_STRING_NO_PREFIX_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FAILURE_STRING_NO_PREFIX")(x.asInstanceOf[js.Any])
