...
object preferObjectSpreadRuleMod {
  ...
  object Rule {
    ...
    @scala.inline
    def ASSIGNMENT_FAILURE_STRING_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ASSIGNMENT_FAILURE_STRING")(x.asInstanceOf[js.Any])
