...
object importSpacingRuleMod {
  ...
  object Rule {
    ...
    @scala.inline
    def ADD_SPACE_AFTER_FROM_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ADD_SPACE_AFTER_FROM")(x.asInstanceOf[js.Any])
    
    @JSImport("tslint/lib/rules/importSpacingRule", "Rule.ADD_SPACE_AFTER_IMPORT")
    @js.native
    def ADD_SPACE_AFTER_IMPORT: String = js.native
    @scala.inline
    def ADD_SPACE_AFTER_IMPORT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ADD_SPACE_AFTER_IMPORT")(x.asInstanceOf[js.Any])
    
    @JSImport("tslint/lib/rules/importSpacingRule", "Rule.ADD_SPACE_AFTER_STAR")
    @js.native
    def ADD_SPACE_AFTER_STAR: String = js.native
    @scala.inline
    def ADD_SPACE_AFTER_STAR_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ADD_SPACE_AFTER_STAR")(x.asInstanceOf[js.Any])
    
    @JSImport("tslint/lib/rules/importSpacingRule", "Rule.ADD_SPACE_BEFORE_FROM")
    @js.native
    def ADD_SPACE_BEFORE_FROM: String = js.native
    @scala.inline
    def ADD_SPACE_BEFORE_FROM_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ADD_SPACE_BEFORE_FROM")(x.asInstanceOf[js.Any])
    
    @JSImport("tslint/lib/rules/importSpacingRule", "Rule.NO_LINE_BREAKS")
    @js.native
    def NO_LINE_BREAKS: String = js.native
    @scala.inline
    def NO_LINE_BREAKS_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NO_LINE_BREAKS")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def TOO_MANY_SPACES_AFTER_FROM_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TOO_MANY_SPACES_AFTER_FROM")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def TOO_MANY_SPACES_AFTER_IMPORT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TOO_MANY_SPACES_AFTER_IMPORT")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def TOO_MANY_SPACES_AFTER_STAR_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TOO_MANY_SPACES_AFTER_STAR")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def TOO_MANY_SPACES_BEFORE_FROM_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TOO_MANY_SPACES_BEFORE_FROM")(x.asInstanceOf[js.Any])
