...
object noVoidExpressionRuleMod {
  
  @JSImport("tslint/lib/rules/noVoidExpressionRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noVoidExpressionRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noVoidExpressionRule", "Rule.metadata")
    @js.native
