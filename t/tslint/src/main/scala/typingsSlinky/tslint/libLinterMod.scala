...
import typingsSlinky.tslint.libConfigurationMod.IConfigurationFile
import typingsSlinky.tslint.libConfigurationMod.IConfigurationLoadResult
import typingsSlinky.tslint.libLanguageRuleRuleMod.RuleFailure
import typingsSlinky.tslint.tslintMod.ILinterOptions
import typingsSlinky.tslint.tslintMod.LintResult
