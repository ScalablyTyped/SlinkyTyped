...
@js.native
object libConfigsRecommendedMod extends js.Object {
  @js.native
  object jsRules extends js.Object {
    ...
    var `max-line-length`: Anon_OptionsArrayNumber = js.native
    ...
    var `one-variable-per-declaration`: Anon_OptionsArray = js.native
    ...
    var `trailing-comma`: Anon_OptionsAnonMultiline = js.native
    var `triple-equals`: Anon_OptionsArray = js.native
  ...
  object rules extends js.Object {
    ...
    var align: Anon_OptionsArray = js.native
    var `array-type`: Anon_OptionsArray = js.native
    ...
    var `import-spacing`: Boolean = js.native
    var indent: Anon_OptionsArray = js.native
    var `interface-name`: Anon_OptionsArray = js.native
    var `interface-over-type-literal`: Boolean = js.native
    var `jsdoc-format`: Boolean = js.native
    var `label-position`: Boolean = js.native
    var `max-classes-per-file`: Anon_OptionsNumber = js.native
    var `max-line-length`: Anon_OptionsNumber = js.native
    var `member-access`: Boolean = js.native
    var `member-ordering`: Anon_OptionsAnonOrder = js.native
    var `new-parens`: Boolean = js.native
    ...
    var `one-line`: Anon_OptionsArray = js.native
    var `one-variable-per-declaration`: Anon_OptionsArray = js.native
    var `only-arrow-functions`: Anon_OptionsArray = js.native
    var `ordered-imports`: Anon_OptionsAnonImportsourcesorder = js.native
