...
/* Inlined tabris.tabris.Omit<tabris.tabris.Action, 'set'> */
@js.native
trait OmitActionset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ NavigationView[Page, Action], Action] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Action, Omit[Action, set]]], js.Any] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[Action] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Action, Action] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Action, Action] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[Action, Omit[Action, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
  ...
  var onBackgroundChanged: ChangeListeners[Action, background] = js.native
  var onBaselineChanged: ChangeListeners[Action, baseline] = js.native
  var onBottomChanged: ChangeListeners[Action, bottom] = js.native
  var onBoundsChanged: ChangeListeners[Action, bounds] = js.native
  var onCenterXChanged: ChangeListeners[Action, centerX] = js.native
  var onCenterYChanged: ChangeListeners[Action, centerY] = js.native
  var onClassChanged: ChangeListeners[Action, `class`] = js.native
  var onClassListChanged: ChangeListeners[Action, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[Action, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[Action]] = js.native
  var onElevationChanged: ChangeListeners[Action, elevation] = js.native
  var onEnabledChanged: ChangeListeners[Action, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[Action, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[Action, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[Action, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[Action, id] = js.native
  var onImageChanged: ChangeListeners[Action, image] = js.native
  var onLayoutDataChanged: ChangeListeners[Action, layoutData] = js.native
  var onLeftChanged: ChangeListeners[Action, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[Action]] = js.native
  var onOpacityChanged: ChangeListeners[Action, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[Action]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[Action]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[Action]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[Action]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[Action]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[Action]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[Action]] = js.native
  var onPlacementChanged: ChangeListeners[Action, placement] = js.native
  var onResize: Listeners[WidgetResizeEvent[Action]] = js.native
  var onRightChanged: ChangeListeners[Action, right] = js.native
  var onSelect: Listeners[EventObject[Action]] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[Action]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Action]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[Action]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[Action]] = js.native
  var onTap: Listeners[WidgetTapEvent[Action]] = js.native
  var onTitleChanged: ChangeListeners[Action, title] = js.native
  var onTopChanged: ChangeListeners[Action, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[Action]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[Action]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[Action]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[Action]] = js.native
  var onTransformChanged: ChangeListeners[Action, transform] = js.native
  var onVisibleChanged: ChangeListeners[Action, visible] = js.native
  var onWidthChanged: ChangeListeners[Action, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Action]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Action] = js.native
  ...
  def appendTo(parent: NavigationView[Page, Action]): Action = js.native
  def detach(): Action = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Action): Action = js.native
  def insertBefore(widget: Action): Action = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Action = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Action = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Action = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Action = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Action = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): Action = js.native
  def triggerAsync(`type`: String): js.Promise[Action] = js.native
}
