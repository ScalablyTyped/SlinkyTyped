...
import typingsSlinky.tabris.mod.Video
...
import typingsSlinky.tabris.tabrisStrings.duration
...
import typingsSlinky.tabris.tabrisStrings.fail
import typingsSlinky.tabris.tabrisStrings.finish
...
import typingsSlinky.tabris.tabrisStrings.pause
import typingsSlinky.tabris.tabrisStrings.play
import typingsSlinky.tabris.tabrisStrings.position
import typingsSlinky.tabris.tabrisStrings.ready
import typingsSlinky.tabris.tabrisStrings.right
import typingsSlinky.tabris.tabrisStrings.set
import typingsSlinky.tabris.tabrisStrings.speed
import typingsSlinky.tabris.tabrisStrings.stale
...
/* Inlined tabris.tabris.Omit<tabris.tabris.Video, 'set'> */
@js.native
trait OmitVideoset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Video] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Video, Omit[Video, set]]], js.Any] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[Video] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Video] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Video] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[Video, Omit[Video, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
  ...
  var onAutoPlayChanged: ChangeListeners[Video, autoPlay] = js.native
  var onBackgroundChanged: ChangeListeners[Video, background] = js.native
  var onBaselineChanged: ChangeListeners[Video, baseline] = js.native
  var onBottomChanged: ChangeListeners[Video, bottom] = js.native
  var onBoundsChanged: ChangeListeners[Video, bounds] = js.native
  var onCenterXChanged: ChangeListeners[Video, centerX] = js.native
  var onCenterYChanged: ChangeListeners[Video, centerY] = js.native
  var onClassChanged: ChangeListeners[Video, `class`] = js.native
  var onClassListChanged: ChangeListeners[Video, classList] = js.native
  var onControlsVisibleChanged: ChangeListeners[Video, controlsVisible] = js.native
  var onCornerRadiusChanged: ChangeListeners[Video, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[Video]] = js.native
  var onDurationChanged: ChangeListeners[Video, duration] = js.native
  var onElevationChanged: ChangeListeners[Video, elevation] = js.native
  var onEnabledChanged: ChangeListeners[Video, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[Video, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[Video, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[Video, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[Video, id] = js.native
  var onLayoutDataChanged: ChangeListeners[Video, layoutData] = js.native
  var onLeftChanged: ChangeListeners[Video, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[Video]] = js.native
  var onOpacityChanged: ChangeListeners[Video, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[Video]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[Video]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[Video]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[Video]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[Video]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[Video]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[Video]] = js.native
  var onPositionChanged: ChangeListeners[Video, position] = js.native
  var onResize: Listeners[WidgetResizeEvent[Video]] = js.native
  var onRightChanged: ChangeListeners[Video, right] = js.native
  var onSpeedChanged: ChangeListeners[Video, speed] = js.native
  var onStateChanged: ChangeListeners[Video, state] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[Video]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Video]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[Video]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[Video]] = js.native
  var onTap: Listeners[WidgetTapEvent[Video]] = js.native
  var onTopChanged: ChangeListeners[Video, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[Video]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[Video]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[Video]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[Video]] = js.native
  var onTransformChanged: ChangeListeners[Video, transform] = js.native
  var onUrlChanged: ChangeListeners[Video, url] = js.native
  var onVisibleChanged: ChangeListeners[Video, visible] = js.native
  var onWidthChanged: ChangeListeners[Video, width] = js.native
  @JSName("on")
  ...
  @JSName("play")
  var play_Original: js.Function1[/* speed */ js.UndefOr[Double], Unit] = js.native
  var position: Double = js.native
  var right: ConstraintValue = js.native
  @JSName("seek")
  var seek_Original: js.Function1[/* position */ Double, Unit] = js.native
  @JSName("siblings")
  var siblings_Original: js.Function1[/* selector */ js.UndefOr[Selector[Widget, Widget]], WidgetCollection[Widget]] = js.native
  var speed: Double = js.native
  var state: empty | fail | finish | open | pause | play | ready | stale = js.native
  var top: ConstraintValue = js.native
  var transform: Transformation = js.native
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Video]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Video] = js.native
  ...
  def appendTo(parent: Composite[Widget]): Video = js.native
  def detach(): Video = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): Video = js.native
  def insertBefore(widget: Widget): Video = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Video = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Video = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Video = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Video = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Video = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): Video = js.native
  def triggerAsync(`type`: String): js.Promise[Video] = js.native
}
