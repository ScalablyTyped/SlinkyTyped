...
import typingsSlinky.tabris.mod.Popover
...
trait OmitPopoverset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Popover, Omit[Popover, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with Anon2 = js.native
  @JSName("off")
