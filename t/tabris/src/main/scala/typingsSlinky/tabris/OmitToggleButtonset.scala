...
import typingsSlinky.tabris.mod.ToggleButton
import typingsSlinky.tabris.mod.ToggleButtonSelectEvent
...
/* Inlined tabris.tabris.Omit<tabris.tabris.ToggleButton, 'set'> */
@js.native
trait OmitToggleButtonset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], ToggleButton] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[ToggleButton] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, ToggleButton] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, ToggleButton] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[
    ToggleButton, 
    Omit[ToggleButton, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ]) with AnonChildrenString = js.native
  ...
  var onAlignmentChanged: ChangeListeners[ToggleButton, alignment] = js.native
  var onBackgroundChanged: ChangeListeners[ToggleButton, background] = js.native
  var onBaselineChanged: ChangeListeners[ToggleButton, baseline] = js.native
  var onBottomChanged: ChangeListeners[ToggleButton, bottom] = js.native
  var onBoundsChanged: ChangeListeners[ToggleButton, bounds] = js.native
  var onCenterXChanged: ChangeListeners[ToggleButton, centerX] = js.native
  var onCenterYChanged: ChangeListeners[ToggleButton, centerY] = js.native
  var onCheckedChanged: ChangeListeners[ToggleButton, checked] = js.native
  var onClassChanged: ChangeListeners[ToggleButton, `class`] = js.native
  var onClassListChanged: ChangeListeners[ToggleButton, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[ToggleButton, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[ToggleButton]] = js.native
  var onElevationChanged: ChangeListeners[ToggleButton, elevation] = js.native
  var onEnabledChanged: ChangeListeners[ToggleButton, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[ToggleButton, excludeFromLayout] = js.native
  var onFontChanged: ChangeListeners[ToggleButton, font] = js.native
  var onHeightChanged: ChangeListeners[ToggleButton, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[ToggleButton, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[ToggleButton, id] = js.native
  var onImageChanged: ChangeListeners[ToggleButton, image] = js.native
  var onLayoutDataChanged: ChangeListeners[ToggleButton, layoutData] = js.native
  var onLeftChanged: ChangeListeners[ToggleButton, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[ToggleButton]] = js.native
  var onOpacityChanged: ChangeListeners[ToggleButton, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[ToggleButton]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[ToggleButton]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[ToggleButton]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[ToggleButton]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[ToggleButton]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[ToggleButton]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[ToggleButton]] = js.native
  var onResize: Listeners[WidgetResizeEvent[ToggleButton]] = js.native
  var onRightChanged: ChangeListeners[ToggleButton, right] = js.native
  var onSelect: Listeners[ToggleButtonSelectEvent[ToggleButton]] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[ToggleButton]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[ToggleButton]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[ToggleButton]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[ToggleButton]] = js.native
  var onTap: Listeners[WidgetTapEvent[ToggleButton]] = js.native
  var onTextChanged: ChangeListeners[ToggleButton, text] = js.native
  var onTextColorChanged: ChangeListeners[ToggleButton, textColor] = js.native
  var onTopChanged: ChangeListeners[ToggleButton, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[ToggleButton]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[ToggleButton]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[ToggleButton]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[ToggleButton]] = js.native
  var onTransformChanged: ChangeListeners[ToggleButton, transform] = js.native
  var onVisibleChanged: ChangeListeners[ToggleButton, visible] = js.native
  var onWidthChanged: ChangeListeners[ToggleButton, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ToggleButton]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ToggleButton] = js.native
  ...
  def appendTo(parent: Composite[Widget]): ToggleButton = js.native
  def detach(): ToggleButton = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): ToggleButton = js.native
  def insertBefore(widget: Widget): ToggleButton = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ToggleButton = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): ToggleButton = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ToggleButton = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): ToggleButton = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ToggleButton = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): ToggleButton = js.native
  def triggerAsync(`type`: String): js.Promise[ToggleButton] = js.native
}
