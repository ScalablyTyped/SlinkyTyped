...
import typingsSlinky.tabris.tabrisStrings.`ease-in-out`
import typingsSlinky.tabris.tabrisStrings.`ease-in`
import typingsSlinky.tabris.tabrisStrings.`ease-out`
import typingsSlinky.tabris.tabrisStrings.linear
...
trait AnimationOptions extends js.Object {
  ...
  /**
    ...
    */
  var easing: js.UndefOr[linear | `ease-in` | `ease-out` | `ease-in-out`] = js.native
  /**
...
object AnimationOptions {
  ...
  implicit class AnimationOptionsOps[Self <: AnimationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEasing(value: linear | `ease-in` | `ease-out` | `ease-in-out`): Self = {
        val ret = this.duplicate
