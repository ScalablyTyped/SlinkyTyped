...
import typingsSlinky.tabris.tabrisStrings.Android
import typingsSlinky.tabris.tabrisStrings.`landscape-primary`
import typingsSlinky.tabris.tabrisStrings.`landscape-secondary`
import typingsSlinky.tabris.tabrisStrings.`portrait-primary`
import typingsSlinky.tabris.tabrisStrings.`portrait-secondary`
import typingsSlinky.tabris.tabrisStrings.iOS
...
class Device_ protected () extends NativeObject {
  ...
  /**
    ...
    */
  var onOrientationChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.orientation] = js.native
  /**
