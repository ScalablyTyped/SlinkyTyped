...
class Video () extends Widget {
  ...
  val jsxAttributes_Video: (JSXAttributes[this.type, Omit[this.type, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
  /**
  ...
  /**
    ...
    */
  var onDurationChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.duration] = js.native
  /**
    * Fired when the [*position*](#position) property has changed.
    */
  var onPositionChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.position] = js.native
  /**
    * Fired when the [*speed*](#speed) property has changed.
    */
  var onSpeedChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.speed] = js.native
  /**
    * Fired when the [*state*](#state) property has changed.
    */
  var onStateChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.state] = js.native
  /**
