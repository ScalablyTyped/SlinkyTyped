...
import typingsSlinky.tabris.tabrisStrings.alphabetic
import typingsSlinky.tabris.tabrisStrings.bevel
import typingsSlinky.tabris.tabrisStrings.bottom
import typingsSlinky.tabris.tabrisStrings.butt
import typingsSlinky.tabris.tabrisStrings.center
import typingsSlinky.tabris.tabrisStrings.end
import typingsSlinky.tabris.tabrisStrings.hanging
import typingsSlinky.tabris.tabrisStrings.ideographic
import typingsSlinky.tabris.tabrisStrings.left
import typingsSlinky.tabris.tabrisStrings.middle
import typingsSlinky.tabris.tabrisStrings.miter
import typingsSlinky.tabris.tabrisStrings.right
import typingsSlinky.tabris.tabrisStrings.round
import typingsSlinky.tabris.tabrisStrings.square
...
class CanvasContext protected () extends js.Object {
  ...
  /**
    ...
    */
  def createImageData(imageData: typingsSlinky.tabris.ImageData): typingsSlinky.tabris.ImageData = js.native
  /**
    ...
    */
  def createImageData(width: Double, height: Double): typingsSlinky.tabris.ImageData = js.native
  /**
  ...
  /**
    ...
    */
  def getImageData(x: Double, y: Double, width: Double, height: Double): typingsSlinky.tabris.ImageData = js.native
  /**
  ...
  /**
    ...
    */
  def putImageData(imageData: typingsSlinky.tabris.ImageData, x: Double, y: Double): Unit = js.native
  /**
