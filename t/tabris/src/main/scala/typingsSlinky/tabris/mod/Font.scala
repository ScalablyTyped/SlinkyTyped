...
import typingsSlinky.tabris.tabrisStrings.`sans-serif`
import typingsSlinky.tabris.tabrisStrings.black
import typingsSlinky.tabris.tabrisStrings.bold
import typingsSlinky.tabris.tabrisStrings.italic
import typingsSlinky.tabris.tabrisStrings.light
import typingsSlinky.tabris.tabrisStrings.medium
import typingsSlinky.tabris.tabrisStrings.normal
import typingsSlinky.tabris.tabrisStrings.thin
...
object Font extends js.Object {
  val condensed: typingsSlinky.tabris.tabrisStrings.condensed = js.native
  val monospace: typingsSlinky.tabris.tabrisStrings.monospace = js.native
  val sansSerif: `sans-serif` = js.native
  val serif: typingsSlinky.tabris.tabrisStrings.serif = js.native
  /**
