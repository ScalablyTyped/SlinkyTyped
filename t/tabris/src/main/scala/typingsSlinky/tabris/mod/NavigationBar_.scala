...
import typingsSlinky.tabris.anon.OmitNavigationBarset
...
class NavigationBar_ protected () extends NativeObject {
  ...
  val jsxAttributes_NavigationBar_ : (JSXAttributes[this.type, Omit[this.type, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
  /**
