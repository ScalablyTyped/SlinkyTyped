...
import typingsSlinky.tabris.tabrisStrings.idleTimeoutEnabled
import typingsSlinky.tabris.tabrisStrings.pinnedCertificates
import typingsSlinky.tabris.tabrisStrings.trustedCertificates
