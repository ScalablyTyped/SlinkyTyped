...
class WebView () extends Widget {
  ...
  val jsxAttributes_WebView: (JSXAttributes[this.type, Omit[this.type, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
  /**
    * Fired when the [*canGoBack*](#canGoBack) property has changed.
    */
  var onCanGoBackChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.canGoBack] = js.native
  /**
    * Fired when the [*canGoForward*](#canGoForward) property has changed.
    */
  var onCanGoForwardChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.canGoForward] = js.native
  /**
