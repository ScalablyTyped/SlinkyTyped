...
import typingsSlinky.tabris.tabrisStrings.columnCount
import typingsSlinky.tabris.tabrisStrings.createCell
...
import typingsSlinky.tabris.tabrisStrings.updateCell
...
class CollectionView[CellWidgetType /* <: Widget */] () extends Composite[CellWidgetType] {
  ...
  val jsxAttributes_CollectionView: (JSXAttributes[this.type, Omit[this.type, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with (Partial[
    Pick[CollectionView[CellWidgetType], cellHeight | cellType | createCell | updateCell]
  ...
  /**
    ...
    */
  var onFirstVisibleIndexChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.firstVisibleIndex] = js.native
  /**
  ...
  /**
    ...
    */
  var onLastVisibleIndexChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.lastVisibleIndex] = js.native
  /**
