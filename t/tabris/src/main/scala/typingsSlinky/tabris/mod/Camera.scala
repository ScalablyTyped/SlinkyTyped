...
import typingsSlinky.tabris.tabrisStrings.external
import typingsSlinky.tabris.tabrisStrings.front
...
class Camera protected () extends NativeObject {
  ...
  /**
    ...
    */
  var onAvailableCaptureResolutionsChanged: ChangeListeners[this.type, typingsSlinky.tabris.tabrisStrings.availableCaptureResolutions] = js.native
  /**
