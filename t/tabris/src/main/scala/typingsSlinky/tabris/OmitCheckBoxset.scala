...
import typingsSlinky.tabris.mod.CheckBox
import typingsSlinky.tabris.mod.CheckBoxSelectEvent
...
trait OmitCheckBoxset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[CheckBox, Omit[CheckBox, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
