...
import typingsSlinky.tabris.mod.TextView
import typingsSlinky.tabris.mod.TextViewTapLinkEvent
...
/* Inlined tabris.tabris.Omit<tabris.tabris.TextView, 'set'> */
@js.native
trait OmitTextViewset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], TextView] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[TextView, Omit[TextView, set]]], js.Any] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[TextView] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, TextView] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, TextView] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[TextView, Omit[TextView, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with AnonChildren = js.native
  ...
  var onAlignmentChanged: ChangeListeners[TextView, alignment] = js.native
  var onBackgroundChanged: ChangeListeners[TextView, background] = js.native
  var onBaselineChanged: ChangeListeners[TextView, baseline] = js.native
  var onBottomChanged: ChangeListeners[TextView, bottom] = js.native
  var onBoundsChanged: ChangeListeners[TextView, bounds] = js.native
  var onCenterXChanged: ChangeListeners[TextView, centerX] = js.native
  var onCenterYChanged: ChangeListeners[TextView, centerY] = js.native
  var onClassChanged: ChangeListeners[TextView, `class`] = js.native
  var onClassListChanged: ChangeListeners[TextView, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[TextView, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[TextView]] = js.native
  var onElevationChanged: ChangeListeners[TextView, elevation] = js.native
  var onEnabledChanged: ChangeListeners[TextView, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[TextView, excludeFromLayout] = js.native
  var onFontChanged: ChangeListeners[TextView, font] = js.native
  var onHeightChanged: ChangeListeners[TextView, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[TextView, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[TextView, id] = js.native
  var onLayoutDataChanged: ChangeListeners[TextView, layoutData] = js.native
  var onLeftChanged: ChangeListeners[TextView, left] = js.native
  var onLineSpacingChanged: ChangeListeners[TextView, lineSpacing] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[TextView]] = js.native
  var onMarkupEnabledChanged: ChangeListeners[TextView, markupEnabled] = js.native
  var onMaxLinesChanged: ChangeListeners[TextView, maxLines] = js.native
  var onOpacityChanged: ChangeListeners[TextView, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[TextView]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[TextView]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[TextView]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[TextView]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[TextView]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[TextView]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[TextView]] = js.native
  var onResize: Listeners[WidgetResizeEvent[TextView]] = js.native
  var onRightChanged: ChangeListeners[TextView, right] = js.native
  var onSelectableChanged: ChangeListeners[TextView, selectable] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[TextView]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[TextView]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[TextView]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[TextView]] = js.native
  var onTap: Listeners[WidgetTapEvent[TextView]] = js.native
  var onTapLink: Listeners[TextViewTapLinkEvent[TextView]] = js.native
  var onTextChanged: ChangeListeners[TextView, text] = js.native
  var onTextColorChanged: ChangeListeners[TextView, textColor] = js.native
  var onTopChanged: ChangeListeners[TextView, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[TextView]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[TextView]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[TextView]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[TextView]] = js.native
  var onTransformChanged: ChangeListeners[TextView, transform] = js.native
  var onVisibleChanged: ChangeListeners[TextView, visible] = js.native
  var onWidthChanged: ChangeListeners[TextView, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[TextView]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, TextView] = js.native
  ...
  def appendTo(parent: Composite[Widget]): TextView = js.native
  def detach(): TextView = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): TextView = js.native
  def insertBefore(widget: Widget): TextView = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): TextView = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): TextView = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): TextView = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): TextView = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): TextView = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): TextView = js.native
  def triggerAsync(`type`: String): js.Promise[TextView] = js.native
}
