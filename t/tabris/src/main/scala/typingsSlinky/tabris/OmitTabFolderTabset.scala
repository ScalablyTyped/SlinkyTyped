...
import typingsSlinky.tabris.mod.TabFolderScrollEvent
import typingsSlinky.tabris.mod.TabFolderSelectEvent
...
/* Inlined tabris.tabris.Omit<tabris.tabris.TabFolder<tabris.tabris.Tab>, 'set'> */
@js.native
trait OmitTabFolderTabset[TabType /* <: Tab */] extends js.Object {
  @JSName("$children")
  ...
  var _apply_Original: js.Function1[
    /* properties */ StringDictionary[Properties[Widget, OmitWidgetsetCheckDisposed[TabType]]], 
    TabFolder[TabType]
  ] = js.native
  ...
  @JSName("_children")
  var _children_Original: js.Function1[/* selector */ js.UndefOr[Selector[Tab, Tab]], WidgetCollection[Tab]] = js.native
  ...
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Tab, TabFolder[TabType]] = js.native
  @JSName("apply")
  ...
  @JSName("children")
  var children_Original: js.Function1[/* selector */ js.UndefOr[Selector[Tab, Tab]], WidgetCollection[Tab]] = js.native
  ...
  @JSName("find")
  var find_Original: js.Function1[/* selector */ js.UndefOr[Selector[Widget, Tab]], WidgetCollection[Tab]] = js.native
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[TabFolder[TabType]]] = js.native
  ...
  var onPagingChanged: ChangeListeners[TabFolder[TabType], paging] = js.native
  ...
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[TabFolder[TabType]]] = js.native
  ...
  var onScroll: Listeners[TabFolderScrollEvent[TabFolder[TabType]]] = js.native
  var onSelect: Listeners[TabFolderSelectEvent[TabFolder[TabType]]] = js.native
  var onSelectedTabIndicatorTintColorChanged: ChangeListeners[TabFolder[TabType], selectedTabIndicatorTintColor] = js.native
  var onSelectedTabTintColorChanged: ChangeListeners[TabFolder[TabType], selectedTabTintColor] = js.native
  var onSelectionChanged: ChangeListeners[TabFolder[TabType], selection] = js.native
  var onSelectionIndexChanged: ChangeListeners[TabFolder[TabType], selectionIndex] = js.native
  ...
  var onTabBarBackgroundChanged: ChangeListeners[TabFolder[TabType], tabBarBackground] = js.native
  var onTabBarElevationChanged: ChangeListeners[TabFolder[TabType], tabBarElevation] = js.native
  var onTabTintColorChanged: ChangeListeners[TabFolder[TabType], tabTintColor] = js.native
  ...
  def _apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetCheckDisposed[TabType]]]): TabFolder[TabType] = js.native
  def _checkDisposed(): Unit = js.native
  def _checkLayout(value: Layout): Unit = js.native
  def _children[Result /* <: Tab */](): WidgetCollection[Result] = js.native
  def _children[Result /* <: Tab */](selector: Selector[Tab, Result]): WidgetCollection[Result] = js.native
  ...
  def append(widgets: Tab*): TabFolder[TabType] = js.native
  def appendTo(parent: Composite[Widget]): TabFolder[TabType] = js.native
  @JSName("apply")
  def apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetCheckDisposed[TabType]]]): TabFolder[TabType] = js.native
  def children[Result /* <: Tab */](): WidgetCollection[Result] = js.native
  def children[Result /* <: Tab */](selector: Selector[Tab, Result]): WidgetCollection[Result] = js.native
  def detach(): TabFolder[TabType] = js.native
  def dispose(): Unit = js.native
  def find[Result /* <: Tab */](): WidgetCollection[Result] = js.native
  def find[Result /* <: Tab */](selector: Selector[Widget, Result]): WidgetCollection[Result] = js.native
