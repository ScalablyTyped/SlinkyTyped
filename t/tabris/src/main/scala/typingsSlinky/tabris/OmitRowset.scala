...
import typingsSlinky.tabris.mod.Row
import typingsSlinky.tabris.mod.RowLayout
...
/* Inlined tabris.tabris.Omit<tabris.tabris.Row, 'set'> */
@js.native
trait OmitRowset extends js.Object {
  @JSName("$children")
  ...
  @JSName("_apply")
  var _apply_Original: js.Function1[/* properties */ StringDictionary[Properties[Widget, OmitWidgetsetBottom]], Row] = js.native
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Row] = js.native
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, Row] = js.native
  @JSName("apply")
  var apply_Original: js.Function1[/* properties */ StringDictionary[Properties[Widget, OmitWidgetsetBottom]], Row] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Row, Omit[Row, set]]], js.Any] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[Row] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Row] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Row] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[Row, Omit[Row, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with Anon2 = js.native
  var layout: RowLayout = js.native
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[Row]] = js.native
  var onBackgroundChanged: ChangeListeners[Row, background] = js.native
  var onBaselineChanged: ChangeListeners[Row, baseline] = js.native
  var onBottomChanged: ChangeListeners[Row, bottom] = js.native
  var onBoundsChanged: ChangeListeners[Row, bounds] = js.native
  var onCenterXChanged: ChangeListeners[Row, centerX] = js.native
  var onCenterYChanged: ChangeListeners[Row, centerY] = js.native
  var onClassChanged: ChangeListeners[Row, `class`] = js.native
  var onClassListChanged: ChangeListeners[Row, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[Row, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[Row]] = js.native
  var onElevationChanged: ChangeListeners[Row, elevation] = js.native
  var onEnabledChanged: ChangeListeners[Row, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[Row, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[Row, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[Row, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[Row, id] = js.native
  var onLayoutDataChanged: ChangeListeners[Row, layoutData] = js.native
  var onLeftChanged: ChangeListeners[Row, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[Row]] = js.native
  var onOpacityChanged: ChangeListeners[Row, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[Row]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[Row]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[Row]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[Row]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[Row]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[Row]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[Row]] = js.native
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[Row]] = js.native
  var onResize: Listeners[WidgetResizeEvent[Row]] = js.native
  var onRightChanged: ChangeListeners[Row, right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[Row]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Row]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[Row]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[Row]] = js.native
  var onTap: Listeners[WidgetTapEvent[Row]] = js.native
  var onTopChanged: ChangeListeners[Row, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[Row]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[Row]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[Row]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[Row]] = js.native
  var onTransformChanged: ChangeListeners[Row, transform] = js.native
  var onVisibleChanged: ChangeListeners[Row, visible] = js.native
  var onWidthChanged: ChangeListeners[Row, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Row]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Row] = js.native
  ...
  def _apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetBottom]]): Row = js.native
  ...
  def append(widgets: Widget*): Row = js.native
  def appendTo(parent: Composite[Widget]): Row = js.native
  @JSName("apply")
  def apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetBottom]]): Row = js.native
  ...
  def insertAfter(widget: Widget): Row = js.native
  def insertBefore(widget: Widget): Row = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Row = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Row = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Row = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Row = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Row = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): Row = js.native
  def triggerAsync(`type`: String): js.Promise[Row] = js.native
}
