...
import typingsSlinky.tabris.mod.Switch
import typingsSlinky.tabris.mod.SwitchSelectEvent
...
trait OmitSwitchset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Switch, Omit[Switch, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
