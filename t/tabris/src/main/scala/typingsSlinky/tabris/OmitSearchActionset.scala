...
import typingsSlinky.tabris.mod.SearchAction
import typingsSlinky.tabris.mod.SearchActionAcceptEvent
import typingsSlinky.tabris.mod.SearchActionInputEvent
...
import typingsSlinky.tabris.tabrisStrings.overflow
import typingsSlinky.tabris.tabrisStrings.placement
...
/* Inlined tabris.tabris.Omit<tabris.tabris.SearchAction, 'set'> */
@js.native
trait OmitSearchActionset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ NavigationView[Page, Action], SearchAction] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[SearchAction] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Action, SearchAction] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Action, SearchAction] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[
    SearchAction, 
    Omit[SearchAction, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ...
  var onAccept: Listeners[SearchActionAcceptEvent[SearchAction]] = js.native
  var onBackgroundChanged: ChangeListeners[SearchAction, background] = js.native
  var onBaselineChanged: ChangeListeners[SearchAction, baseline] = js.native
  var onBottomChanged: ChangeListeners[SearchAction, bottom] = js.native
  var onBoundsChanged: ChangeListeners[SearchAction, bounds] = js.native
  var onCenterXChanged: ChangeListeners[SearchAction, centerX] = js.native
  var onCenterYChanged: ChangeListeners[SearchAction, centerY] = js.native
  var onClassChanged: ChangeListeners[SearchAction, `class`] = js.native
  var onClassListChanged: ChangeListeners[SearchAction, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[SearchAction, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[SearchAction]] = js.native
  var onElevationChanged: ChangeListeners[SearchAction, elevation] = js.native
  var onEnabledChanged: ChangeListeners[SearchAction, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[SearchAction, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[SearchAction, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[SearchAction, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[SearchAction, id] = js.native
  var onImageChanged: ChangeListeners[SearchAction, image] = js.native
  var onInput: Listeners[SearchActionInputEvent[SearchAction]] = js.native
  var onLayoutDataChanged: ChangeListeners[SearchAction, layoutData] = js.native
  var onLeftChanged: ChangeListeners[SearchAction, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[SearchAction]] = js.native
  var onMessageChanged: ChangeListeners[SearchAction, message] = js.native
  var onOpacityChanged: ChangeListeners[SearchAction, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[SearchAction]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[SearchAction]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[SearchAction]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[SearchAction]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[SearchAction]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[SearchAction]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[SearchAction]] = js.native
  var onPlacementChanged: ChangeListeners[SearchAction, placement] = js.native
  var onProposalsChanged: ChangeListeners[SearchAction, proposals] = js.native
  var onResize: Listeners[WidgetResizeEvent[SearchAction]] = js.native
  var onRightChanged: ChangeListeners[SearchAction, right] = js.native
  var onSelect: Listeners[EventObject[SearchAction]] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[SearchAction]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[SearchAction]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[SearchAction]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[SearchAction]] = js.native
  var onTap: Listeners[WidgetTapEvent[SearchAction]] = js.native
  var onTextChanged: ChangeListeners[SearchAction, text] = js.native
  var onTitleChanged: ChangeListeners[SearchAction, title] = js.native
  var onTopChanged: ChangeListeners[SearchAction, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[SearchAction]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[SearchAction]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[SearchAction]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[SearchAction]] = js.native
  var onTransformChanged: ChangeListeners[SearchAction, transform] = js.native
  var onVisibleChanged: ChangeListeners[SearchAction, visible] = js.native
  var onWidthChanged: ChangeListeners[SearchAction, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[SearchAction]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, SearchAction] = js.native
  ...
  def appendTo(parent: NavigationView[Page, Action]): SearchAction = js.native
  def detach(): SearchAction = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Action): SearchAction = js.native
  def insertBefore(widget: Action): SearchAction = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): SearchAction = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): SearchAction = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): SearchAction = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): SearchAction = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): SearchAction = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): SearchAction = js.native
  def triggerAsync(`type`: String): js.Promise[SearchAction] = js.native
}
