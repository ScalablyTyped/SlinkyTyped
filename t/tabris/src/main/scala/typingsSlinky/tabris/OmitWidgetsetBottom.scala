...
@js.native
trait OmitWidgetsetBottom extends js.Object {
  ...
  var jsxAttributes: JSXAttributes[Row, Omit[Row, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]] = js.native
