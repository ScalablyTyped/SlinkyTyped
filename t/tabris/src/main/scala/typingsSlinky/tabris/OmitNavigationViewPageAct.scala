...
import typingsSlinky.tabris.tabrisStrings.drawerActionVisible
...
import typingsSlinky.tabris.tabrisStrings.pageAnimation
import typingsSlinky.tabris.tabrisStrings.right
import typingsSlinky.tabris.tabrisStrings.set
import typingsSlinky.tabris.tabrisStrings.titleTextColor
import typingsSlinky.tabris.tabrisStrings.toolbarColor
import typingsSlinky.tabris.tabrisStrings.toolbarHeight
import typingsSlinky.tabris.tabrisStrings.toolbarVisible
...
/* Inlined tabris.tabris.Omit<tabris.tabris.NavigationView<tabris.tabris.Page, tabris.tabris.Action>, 'set'> */
@js.native
trait OmitNavigationViewPageAct[PageType /* <: Page */, ActionType /* <: Action */] extends js.Object {
  @JSName("$children")
  ...
  var _apply_Original: js.Function1[
    /* properties */ StringDictionary[Properties[Widget, OmitWidgetsetAppendTo[PageType, ActionType]]], 
  ...
  var _children_Original: js.Function1[
    /* selector */ js.UndefOr[Selector[Page | Action, Page | Action]], 
    WidgetCollection[Page | Action]
  ] = js.native
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], NavigationView[PageType, ActionType]] = js.native
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Page | Action, NavigationView[PageType, ActionType]] = js.native
  @JSName("apply")
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[NavigationView[Page, Action], Omit[NavigationView[Page, Action], set]]
    ], 
    js.Any
  ] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[NavigationView[PageType, ActionType]] = js.native
  @JSName("dispose")
  ...
  var find_Original: js.Function1[
    /* selector */ js.UndefOr[Selector[Widget, Page | Action]], 
    WidgetCollection[Page | Action]
  ] = js.native
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, NavigationView[PageType, ActionType]] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, NavigationView[PageType, ActionType]] = js.native
  @JSName("isDisposed")
  ...
  var jsxAttributes: (JSXAttributes[
    ...
    Omit[
      NavigationView[PageType, ActionType], 
      set | typingsSlinky.tabris.tabrisStrings.jsxAttributes
    ]
  ]) with Anon4 = js.native
  ...
  var onActionColorChanged: ChangeListeners[NavigationView[PageType, ActionType], actionColor] = js.native
  var onActionTextColorChanged: ChangeListeners[NavigationView[PageType, ActionType], actionTextColor] = js.native
  var onAddChild: Listeners[CompositeAddChildEvent[NavigationView[PageType, ActionType]]] = js.native
  var onBackgroundChanged: ChangeListeners[NavigationView[PageType, ActionType], background] = js.native
  var onBaselineChanged: ChangeListeners[NavigationView[PageType, ActionType], baseline] = js.native
  var onBottomChanged: ChangeListeners[NavigationView[PageType, ActionType], bottom] = js.native
  var onBoundsChanged: ChangeListeners[NavigationView[PageType, ActionType], bounds] = js.native
  var onCenterXChanged: ChangeListeners[NavigationView[PageType, ActionType], centerX] = js.native
  var onCenterYChanged: ChangeListeners[NavigationView[PageType, ActionType], centerY] = js.native
  var onClassChanged: ChangeListeners[NavigationView[PageType, ActionType], `class`] = js.native
  var onClassListChanged: ChangeListeners[NavigationView[PageType, ActionType], classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[NavigationView[PageType, ActionType], cornerRadius] = js.native
  var onDispose: Listeners[EventObject[NavigationView[PageType, ActionType]]] = js.native
  var onDrawerActionVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], drawerActionVisible] = js.native
  var onElevationChanged: ChangeListeners[NavigationView[PageType, ActionType], elevation] = js.native
  var onEnabledChanged: ChangeListeners[NavigationView[PageType, ActionType], enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[NavigationView[PageType, ActionType], excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[NavigationView[PageType, ActionType], height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[NavigationView[PageType, ActionType], highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[NavigationView[PageType, ActionType], id] = js.native
  var onLayoutDataChanged: ChangeListeners[NavigationView[PageType, ActionType], layoutData] = js.native
  var onLeftChanged: ChangeListeners[NavigationView[PageType, ActionType], left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[NavigationView[PageType, ActionType]]] = js.native
  var onOpacityChanged: ChangeListeners[NavigationView[PageType, ActionType], opacity] = js.native
  var onPageAnimationChanged: ChangeListeners[NavigationView[PageType, ActionType], pageAnimation] = js.native
  var onPan: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]] = js.native
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[NavigationView[PageType, ActionType]]] = js.native
  var onResize: Listeners[WidgetResizeEvent[NavigationView[PageType, ActionType]]] = js.native
  var onRightChanged: ChangeListeners[NavigationView[PageType, ActionType], right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]] = js.native
  var onTap: Listeners[WidgetTapEvent[NavigationView[PageType, ActionType]]] = js.native
  var onTitleTextColorChanged: ChangeListeners[NavigationView[PageType, ActionType], titleTextColor] = js.native
  var onToolbarColorChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarColor] = js.native
  var onToolbarHeightChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarHeight] = js.native
  var onToolbarVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarVisible] = js.native
  var onTopChanged: ChangeListeners[NavigationView[PageType, ActionType], top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]] = js.native
  var onTransformChanged: ChangeListeners[NavigationView[PageType, ActionType], transform] = js.native
  var onVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], visible] = js.native
  var onWidthChanged: ChangeListeners[NavigationView[PageType, ActionType], width] = js.native
  @JSName("on")
  ...
  @JSName("pages")
  var pages_Original: js.Function1[/* selector */ js.UndefOr[Selector[Widget, Widget]], WidgetCollection[Page]] = js.native
  @JSName("parent")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[NavigationView[PageType, ActionType]]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, NavigationView[PageType, ActionType]] = js.native
  ...
  def _apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetAppendTo[PageType, ActionType]]]): NavigationView[PageType, ActionType] = js.native
  def _checkDisposed(): Unit = js.native
  def _checkLayout(value: Layout): Unit = js.native
  def _children[Result /* <: Page | Action */](): WidgetCollection[Result] = js.native
  def _children[Result /* <: Page | Action */](selector: Selector[Page | Action, Result]): WidgetCollection[Result] = js.native
  ...
  def append(widgets: (Page | Action)*): NavigationView[PageType, ActionType] = js.native
  def appendTo(parent: Composite[Widget]): NavigationView[PageType, ActionType] = js.native
  @JSName("apply")
  def apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetAppendTo[PageType, ActionType]]]): NavigationView[PageType, ActionType] = js.native
  def children[Result /* <: Page | Action */](): WidgetCollection[Result] = js.native
  def children[Result /* <: Page | Action */](selector: Selector[Page | Action, Result]): WidgetCollection[Result] = js.native
  def detach(): NavigationView[PageType, ActionType] = js.native
  def dispose(): Unit = js.native
  def find[Result /* <: Page | Action */](): WidgetCollection[Result] = js.native
  def find[Result /* <: Page | Action */](selector: Selector[Widget, Result]): WidgetCollection[Result] = js.native
  def insertAfter(widget: Widget): NavigationView[PageType, ActionType] = js.native
  def insertBefore(widget: Widget): NavigationView[PageType, ActionType] = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): NavigationView[PageType, ActionType] = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): NavigationView[PageType, ActionType] = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): NavigationView[PageType, ActionType] = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): NavigationView[PageType, ActionType] = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): NavigationView[PageType, ActionType] = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def pages(selector: Selector[Widget, Widget]): WidgetCollection[Page] = js.native
  ...
  def trigger(`type`: String): NavigationView[PageType, ActionType] = js.native
  def triggerAsync(`type`: String): js.Promise[NavigationView[PageType, ActionType]] = js.native
}
