...
import typingsSlinky.tabris.mod.ScrollView
...
@js.native
trait OmitWidgetsetBounds extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], ScrollView] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[ScrollView] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, ScrollView] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, ScrollView] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: JSXAttributes[
    ScrollView, 
    Omit[ScrollView, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ] = js.native
  ...
  var onBackgroundChanged: ChangeListeners[ScrollView, background] = js.native
  var onBaselineChanged: ChangeListeners[ScrollView, baseline] = js.native
  var onBottomChanged: ChangeListeners[ScrollView, bottom] = js.native
  var onBoundsChanged: ChangeListeners[ScrollView, bounds] = js.native
  var onCenterXChanged: ChangeListeners[ScrollView, centerX] = js.native
  var onCenterYChanged: ChangeListeners[ScrollView, centerY] = js.native
  var onClassChanged: ChangeListeners[ScrollView, `class`] = js.native
  var onClassListChanged: ChangeListeners[ScrollView, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[ScrollView, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[ScrollView]] = js.native
  var onElevationChanged: ChangeListeners[ScrollView, elevation] = js.native
  var onEnabledChanged: ChangeListeners[ScrollView, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[ScrollView, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[ScrollView, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[ScrollView, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[ScrollView, id] = js.native
  var onLayoutDataChanged: ChangeListeners[ScrollView, layoutData] = js.native
  var onLeftChanged: ChangeListeners[ScrollView, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[ScrollView]] = js.native
  var onOpacityChanged: ChangeListeners[ScrollView, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[ScrollView]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[ScrollView]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[ScrollView]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[ScrollView]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[ScrollView]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[ScrollView]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[ScrollView]] = js.native
  var onResize: Listeners[WidgetResizeEvent[ScrollView]] = js.native
  var onRightChanged: ChangeListeners[ScrollView, right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[ScrollView]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[ScrollView]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[ScrollView]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[ScrollView]] = js.native
  var onTap: Listeners[WidgetTapEvent[ScrollView]] = js.native
  var onTopChanged: ChangeListeners[ScrollView, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[ScrollView]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[ScrollView]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[ScrollView]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[ScrollView]] = js.native
  var onTransformChanged: ChangeListeners[ScrollView, transform] = js.native
  var onVisibleChanged: ChangeListeners[ScrollView, visible] = js.native
  var onWidthChanged: ChangeListeners[ScrollView, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ScrollView]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ScrollView] = js.native
  ...
  def appendTo(parent: Composite[Widget]): ScrollView = js.native
  def detach(): ScrollView = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): ScrollView = js.native
  def insertBefore(widget: Widget): ScrollView = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ScrollView = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): ScrollView = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ScrollView = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): ScrollView = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ScrollView = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): ScrollView = js.native
  def triggerAsync(`type`: String): js.Promise[ScrollView] = js.native
}
