...
import typingsSlinky.tabris.mod.RefreshComposite
...
/* Inlined tabris.tabris.Omit<tabris.tabris.RefreshComposite, 'set'> */
@js.native
trait OmitRefreshCompositeset extends js.Object {
  @JSName("$children")
  ...
  var _apply_Original: js.Function1[
    /* properties */ StringDictionary[Properties[Widget, OmitWidgetsetBaseline]], 
    RefreshComposite
  ] = js.native
  ...
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, RefreshComposite] = js.native
  @JSName("apply")
  ...
  var jsxAttributes: (JSXAttributes[
    RefreshComposite, 
    Omit[RefreshComposite, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[RefreshComposite]] = js.native
  ...
  var onRefresh: Listeners[EventObject[RefreshComposite]] = js.native
  var onRefreshEnabledChanged: ChangeListeners[RefreshComposite, refreshEnabled] = js.native
  var onRefreshIndicatorChanged: ChangeListeners[RefreshComposite, refreshIndicator] = js.native
  var onRefreshMessageChanged: ChangeListeners[RefreshComposite, refreshMessage] = js.native
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[RefreshComposite]] = js.native
  ...
  def _apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetBaseline]]): RefreshComposite = js.native
  ...
  def append(widgets: Widget*): RefreshComposite = js.native
  def appendTo(parent: Composite[Widget]): RefreshComposite = js.native
  @JSName("apply")
  def apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetBaseline]]): RefreshComposite = js.native
