...
import typingsSlinky.tabris.mod.AlertDialog
import typingsSlinky.tabris.mod.AlertDialogCloseEvent
import typingsSlinky.tabris.mod.ChangeListeners
import typingsSlinky.tabris.mod.ContentView_
...
trait OmitAlertDialogset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[
    AlertDialog, 
    Omit[AlertDialog, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ]) with Anon1 = js.native
