...
import typingsSlinky.tabris.mod.StatusBarTapEvent
import typingsSlinky.tabris.mod.StatusBar_
...
import typingsSlinky.tabris.tabrisStrings.displayMode
import typingsSlinky.tabris.tabrisStrings.float
import typingsSlinky.tabris.tabrisStrings.hide
import typingsSlinky.tabris.tabrisStrings.light
import typingsSlinky.tabris.tabrisStrings.set
import typingsSlinky.tabris.tabrisStrings.theme
...
@js.native
trait OmitStatusBarset extends js.Object {
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[StatusBar_, Omit[StatusBar_, set]]], js.Any] = js.native
  ...
  var jsxAttributes: (JSXAttributes[
    StatusBar_, 
    Omit[StatusBar_, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ...
  var onBackgroundChanged: ChangeListeners[StatusBar_, background] = js.native
  var onDisplayModeChanged: ChangeListeners[StatusBar_, displayMode] = js.native
  var onTap: Listeners[StatusBarTapEvent[StatusBar_]] = js.native
  var onThemeChanged: ChangeListeners[StatusBar_, theme] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[StatusBar_]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, StatusBar_] = js.native
  @JSName("$getProperty")
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): StatusBar_ = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): StatusBar_ = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): StatusBar_ = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): StatusBar_ = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): StatusBar_ = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): StatusBar_ = js.native
  def trigger(`type`: String): StatusBar_ = js.native
  def triggerAsync(`type`: String): js.Promise[StatusBar_] = js.native
}
