...
import typingsSlinky.tabris.mod.TimeDialog
import typingsSlinky.tabris.mod.TimeDialogCloseEvent
import typingsSlinky.tabris.mod.TimeDialogSelectEvent
...
trait OmitTimeDialogset extends js.Object {
  ...
  var jsxAttributes: JSXAttributes[
    TimeDialog, 
    Omit[TimeDialog, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ] = js.native
  @JSName("off")
