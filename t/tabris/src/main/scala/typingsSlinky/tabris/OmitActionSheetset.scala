...
import typingsSlinky.tabris.mod.ActionSheet
import typingsSlinky.tabris.mod.ActionSheetCloseEvent
import typingsSlinky.tabris.mod.ActionSheetSelectEvent
...
/* Inlined tabris.tabris.Omit<tabris.tabris.ActionSheet, 'set'> */
@js.native
trait OmitActionSheetset extends js.Object {
  ...
  @JSName("close")
  var close_Original: js.Function0[ActionSheet] = js.native
  @JSName("constructor")
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[ActionSheet, Omit[ActionSheet, set]]], 
    js.Any
  ] = js.native
  ...
  var jsxAttributes: (JSXAttributes[
    ActionSheet, 
    Omit[ActionSheet, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ]) with AnonChildrenFlatten = js.native
  ...
  var onActionsChanged: ChangeListeners[ActionSheet, actions] = js.native
  var onClose: Listeners[ActionSheetCloseEvent[ActionSheet]] = js.native
  var onMessageChanged: ChangeListeners[ActionSheet, message] = js.native
  var onSelect: Listeners[ActionSheetSelectEvent[ActionSheet]] = js.native
  var onTitleChanged: ChangeListeners[ActionSheet, title] = js.native
  @JSName("on")
  ...
  @JSName("open")
  var open_Original: js.Function0[ActionSheet] = js.native
  var title: String = js.native
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ActionSheet]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ActionSheet] = js.native
  @JSName("$getProperty")
  ...
  def close(): ActionSheet = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ActionSheet = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): ActionSheet = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ActionSheet = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): ActionSheet = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ActionSheet = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): ActionSheet = js.native
  def open(): ActionSheet = js.native
  def trigger(`type`: String): ActionSheet = js.native
  def triggerAsync(`type`: String): js.Promise[ActionSheet] = js.native
}
