...
import typingsSlinky.tabris.mod.InactivityTimer
...
@js.native
trait OmitInactivityTimerset extends js.Object {
  ...
  var jsxAttributes: JSXAttributes[
    InactivityTimer, 
    Omit[InactivityTimer, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ] = js.native
  @JSName("off")
  ...
  var onDelayChanged: ChangeListeners[InactivityTimer, delay] = js.native
  var onTimeout: Listeners[EventObject[InactivityTimer]] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[InactivityTimer]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, InactivityTimer] = js.native
  @JSName("$getProperty")
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): InactivityTimer = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): InactivityTimer = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): InactivityTimer = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): InactivityTimer = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): InactivityTimer = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): InactivityTimer = js.native
  def triggerAsync(`type`: String): js.Promise[InactivityTimer] = js.native
}
