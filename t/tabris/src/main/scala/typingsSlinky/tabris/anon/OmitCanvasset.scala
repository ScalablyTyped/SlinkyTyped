...
import typingsSlinky.tabris.mod.Canvas
import typingsSlinky.tabris.mod.CanvasContext
...
trait OmitCanvasset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Canvas, Omit[Canvas, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with `1` = js.native
