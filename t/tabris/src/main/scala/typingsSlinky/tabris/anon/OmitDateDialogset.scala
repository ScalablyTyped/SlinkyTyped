...
import typingsSlinky.tabris.mod.DateDialog
import typingsSlinky.tabris.mod.DateDialogCloseEvent
import typingsSlinky.tabris.mod.DateDialogSelectEvent
...
trait OmitDateDialogset extends js.Object {
  ...
  var jsxAttributes: JSXAttributes[
    DateDialog, 
    Omit[DateDialog, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ] = js.native
