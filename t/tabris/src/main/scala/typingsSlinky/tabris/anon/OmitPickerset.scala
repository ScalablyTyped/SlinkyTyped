...
import typingsSlinky.tabris.mod.Picker
import typingsSlinky.tabris.mod.PickerSelectEvent
...
/* Inlined tabris.tabris.Omit<tabris.tabris.Picker, 'set'> */
@js.native
trait OmitPickerset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Picker] = js.native
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[(Properties[Picker, Omit[Picker, set]]) with PartialPickPickeritemText], 
    js.Any
  ] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[Picker] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Picker] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Picker] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var itemCount: Double = js.native
  @JSName("itemText")
  var itemText_Original: js.Function1[/* index */ Double, String] = js.native
  var jsxAttributes: (JSXAttributes[Picker, Omit[Picker, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with js.Object with PartialPickPickeritemText = js.native
  ...
  var onBackgroundChanged: ChangeListeners[Picker, background] = js.native
  var onBaselineChanged: ChangeListeners[Picker, baseline] = js.native
  var onBorderColorChanged: ChangeListeners[Picker, borderColor] = js.native
  var onBottomChanged: ChangeListeners[Picker, bottom] = js.native
  var onBoundsChanged: ChangeListeners[Picker, bounds] = js.native
  var onCenterXChanged: ChangeListeners[Picker, centerX] = js.native
  var onCenterYChanged: ChangeListeners[Picker, centerY] = js.native
  var onClassChanged: ChangeListeners[Picker, `class`] = js.native
  var onClassListChanged: ChangeListeners[Picker, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[Picker, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[Picker]] = js.native
  var onElevationChanged: ChangeListeners[Picker, elevation] = js.native
  var onEnabledChanged: ChangeListeners[Picker, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[Picker, excludeFromLayout] = js.native
  var onFloatMessageChanged: ChangeListeners[Picker, floatMessage] = js.native
  var onFontChanged: ChangeListeners[Picker, font] = js.native
  var onHeightChanged: ChangeListeners[Picker, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[Picker, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[Picker, id] = js.native
  var onItemCountChanged: ChangeListeners[Picker, itemCount] = js.native
  var onItemTextChanged: ChangeListeners[Picker, itemText] = js.native
  var onLayoutDataChanged: ChangeListeners[Picker, layoutData] = js.native
  var onLeftChanged: ChangeListeners[Picker, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[Picker]] = js.native
  var onMessageChanged: ChangeListeners[Picker, message] = js.native
  var onOpacityChanged: ChangeListeners[Picker, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[Picker]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[Picker]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[Picker]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[Picker]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[Picker]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[Picker]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[Picker]] = js.native
  var onResize: Listeners[WidgetResizeEvent[Picker]] = js.native
  var onRightChanged: ChangeListeners[Picker, right] = js.native
  var onSelect: Listeners[PickerSelectEvent[Picker]] = js.native
  var onSelectionIndexChanged: ChangeListeners[Picker, selectionIndex] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[Picker]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Picker]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[Picker]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[Picker]] = js.native
  var onTap: Listeners[WidgetTapEvent[Picker]] = js.native
  var onTextColorChanged: ChangeListeners[Picker, textColor] = js.native
  var onTopChanged: ChangeListeners[Picker, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[Picker]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[Picker]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[Picker]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[Picker]] = js.native
  var onTransformChanged: ChangeListeners[Picker, transform] = js.native
  var onVisibleChanged: ChangeListeners[Picker, visible] = js.native
  var onWidthChanged: ChangeListeners[Picker, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Picker]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Picker] = js.native
  ...
  def appendTo(parent: Composite[Widget]): Picker = js.native
  def detach(): Picker = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): Picker = js.native
  def insertBefore(widget: Widget): Picker = js.native
  def isDisposed(): Boolean = js.native
  def itemText(index: Double): String = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Picker = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Picker = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Picker = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Picker = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Picker = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): Picker = js.native
  def triggerAsync(`type`: String): js.Promise[Picker] = js.native
}
