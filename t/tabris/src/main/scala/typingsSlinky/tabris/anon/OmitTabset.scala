...
import typingsSlinky.tabris.tabrisStrings.selectedImage
...
/* Inlined tabris.tabris.Omit<tabris.tabris.Tab, 'set'> */
@js.native
trait OmitTabset extends js.Object {
  @JSName("$children")
  ...
  @JSName("_apply")
  var _apply_Original: js.Function1[/* properties */ StringDictionary[Properties[Widget, OmitWidgetsetCenterY]], Tab] = js.native
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ TabFolder[Tab], Tab] = js.native
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, Tab] = js.native
  @JSName("apply")
  var apply_Original: js.Function1[/* properties */ StringDictionary[Properties[Widget, OmitWidgetsetCenterY]], Tab] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Tab, Omit[Tab, set]]], js.Any] = js.native
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Tab, Tab] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Tab, Tab] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[Tab, Omit[Tab, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with `1` = js.native
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[Tab]] = js.native
  var onAppear: Listeners[EventObject[Tab]] = js.native
  var onBackgroundChanged: ChangeListeners[Tab, background] = js.native
  var onBadgeChanged: ChangeListeners[Tab, badge] = js.native
  var onBadgeColorChanged: ChangeListeners[Tab, badgeColor] = js.native
  ...
  var onDisappear: Listeners[EventObject[Tab]] = js.native
  ...
  var onImageChanged: ChangeListeners[Tab, image] = js.native
  ...
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[Tab]] = js.native
  var onReselect: Listeners[EventObject[Tab]] = js.native
  var onResize: Listeners[WidgetResizeEvent[Tab]] = js.native
  var onRightChanged: ChangeListeners[Tab, right] = js.native
  var onSelect: Listeners[EventObject[Tab]] = js.native
  var onSelectedImageChanged: ChangeListeners[Tab, selectedImage] = js.native
  ...
  var onTitleChanged: ChangeListeners[Tab, title] = js.native
  ...
  @JSName("parent")
  var parent_Original: js.Function0[TabFolder[Tab]] = js.native
  var right: ConstraintValue = js.native
  var selectedImage: ImageValue = js.native
  @JSName("siblings")
  var siblings_Original: js.Function1[/* selector */ js.UndefOr[Selector[Widget, Tab]], WidgetCollection[Tab]] = js.native
  ...
  def _apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetCenterY]]): Tab = js.native
  ...
  def append(widgets: Widget*): Tab = js.native
  def appendTo(parent: TabFolder[Tab]): Tab = js.native
  @JSName("apply")
  def apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetCenterY]]): Tab = js.native
  ...
  def insertAfter(widget: Tab): Tab = js.native
  def insertBefore(widget: Tab): Tab = js.native
  ...
  def parent(): TabFolder[Tab] = js.native
