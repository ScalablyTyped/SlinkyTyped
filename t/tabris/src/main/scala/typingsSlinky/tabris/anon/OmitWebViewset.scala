...
import typingsSlinky.tabris.mod.WebView
import typingsSlinky.tabris.mod.WebViewDownloadEvent
import typingsSlinky.tabris.mod.WebViewMessageEvent
import typingsSlinky.tabris.mod.WebViewNavigateEvent
...
import typingsSlinky.tabris.tabrisStrings.canGoBack
import typingsSlinky.tabris.tabrisStrings.canGoForward
...
/* Inlined tabris.tabris.Omit<tabris.tabris.WebView, 'set'> */
@js.native
trait OmitWebViewset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], WebView] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[WebView, Omit[WebView, set]]], js.Any] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[WebView] = js.native
  @JSName("dispose")
  ...
  @JSName("goBack")
  var goBack_Original: js.Function0[Unit] = js.native
  @JSName("goForward")
  var goForward_Original: js.Function0[Unit] = js.native
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, WebView] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, WebView] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[WebView, Omit[WebView, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
  ...
  var onBackgroundChanged: ChangeListeners[WebView, background] = js.native
  var onBaselineChanged: ChangeListeners[WebView, baseline] = js.native
  var onBottomChanged: ChangeListeners[WebView, bottom] = js.native
  var onBoundsChanged: ChangeListeners[WebView, bounds] = js.native
  var onCanGoBackChanged: ChangeListeners[WebView, canGoBack] = js.native
  var onCanGoForwardChanged: ChangeListeners[WebView, canGoForward] = js.native
  var onCenterXChanged: ChangeListeners[WebView, centerX] = js.native
  var onCenterYChanged: ChangeListeners[WebView, centerY] = js.native
  var onClassChanged: ChangeListeners[WebView, `class`] = js.native
  var onClassListChanged: ChangeListeners[WebView, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[WebView, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[WebView]] = js.native
  var onDownload: Listeners[WebViewDownloadEvent[WebView]] = js.native
  var onElevationChanged: ChangeListeners[WebView, elevation] = js.native
  var onEnabledChanged: ChangeListeners[WebView, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[WebView, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[WebView, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[WebView, highlightOnTouch] = js.native
  var onHtmlChanged: ChangeListeners[WebView, html] = js.native
  var onIdChanged: ChangeListeners[WebView, id] = js.native
  var onLayoutDataChanged: ChangeListeners[WebView, layoutData] = js.native
  var onLeftChanged: ChangeListeners[WebView, left] = js.native
  var onLoad: Listeners[EventObject[WebView]] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[WebView]] = js.native
  var onMessage: Listeners[WebViewMessageEvent[WebView]] = js.native
  var onNavigate: Listeners[WebViewNavigateEvent[WebView]] = js.native
  var onOpacityChanged: ChangeListeners[WebView, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[WebView]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[WebView]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[WebView]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[WebView]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[WebView]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[WebView]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[WebView]] = js.native
  var onResize: Listeners[WidgetResizeEvent[WebView]] = js.native
  var onRightChanged: ChangeListeners[WebView, right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[WebView]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[WebView]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[WebView]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[WebView]] = js.native
  var onTap: Listeners[WidgetTapEvent[WebView]] = js.native
  var onTopChanged: ChangeListeners[WebView, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[WebView]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[WebView]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[WebView]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[WebView]] = js.native
  var onTransformChanged: ChangeListeners[WebView, transform] = js.native
  var onUrlChanged: ChangeListeners[WebView, url] = js.native
  var onVisibleChanged: ChangeListeners[WebView, visible] = js.native
  var onWidthChanged: ChangeListeners[WebView, width] = js.native
  @JSName("on")
  ...
  @JSName("postMessage")
  var postMessage_Original: js.Function2[/* message */ String, /* targetOrigin */ String, WebView] = js.native
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[WebView]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, WebView] = js.native
  ...
  def appendTo(parent: Composite[Widget]): WebView = js.native
  def detach(): WebView = js.native
  def dispose(): Unit = js.native
  def goBack(): Unit = js.native
  def goForward(): Unit = js.native
  def insertAfter(widget: Widget): WebView = js.native
  def insertBefore(widget: Widget): WebView = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): WebView = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): WebView = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): WebView = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): WebView = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): WebView = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def postMessage(message: String, targetOrigin: String): WebView = js.native
  ...
  def trigger(`type`: String): WebView = js.native
  def triggerAsync(`type`: String): js.Promise[WebView] = js.native
}
