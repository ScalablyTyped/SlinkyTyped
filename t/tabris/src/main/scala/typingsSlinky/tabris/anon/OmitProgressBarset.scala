...
import typingsSlinky.tabris.mod.ProgressBar
...
/* Inlined tabris.tabris.Omit<tabris.tabris.ProgressBar, 'set'> */
@js.native
trait OmitProgressBarset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], ProgressBar] = js.native
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[ProgressBar, Omit[ProgressBar, set]]], 
    js.Any
  ] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[ProgressBar] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, ProgressBar] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, ProgressBar] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[
    ProgressBar, 
    Omit[ProgressBar, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ...
  var onBackgroundChanged: ChangeListeners[ProgressBar, background] = js.native
  var onBaselineChanged: ChangeListeners[ProgressBar, baseline] = js.native
  var onBottomChanged: ChangeListeners[ProgressBar, bottom] = js.native
  var onBoundsChanged: ChangeListeners[ProgressBar, bounds] = js.native
  var onCenterXChanged: ChangeListeners[ProgressBar, centerX] = js.native
  var onCenterYChanged: ChangeListeners[ProgressBar, centerY] = js.native
  var onClassChanged: ChangeListeners[ProgressBar, `class`] = js.native
  var onClassListChanged: ChangeListeners[ProgressBar, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[ProgressBar, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[ProgressBar]] = js.native
  var onElevationChanged: ChangeListeners[ProgressBar, elevation] = js.native
  var onEnabledChanged: ChangeListeners[ProgressBar, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[ProgressBar, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[ProgressBar, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[ProgressBar, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[ProgressBar, id] = js.native
  var onLayoutDataChanged: ChangeListeners[ProgressBar, layoutData] = js.native
  var onLeftChanged: ChangeListeners[ProgressBar, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[ProgressBar]] = js.native
  var onMaximumChanged: ChangeListeners[ProgressBar, maximum] = js.native
  var onMinimumChanged: ChangeListeners[ProgressBar, minimum] = js.native
  var onOpacityChanged: ChangeListeners[ProgressBar, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[ProgressBar]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[ProgressBar]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[ProgressBar]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[ProgressBar]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[ProgressBar]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[ProgressBar]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[ProgressBar]] = js.native
  var onResize: Listeners[WidgetResizeEvent[ProgressBar]] = js.native
  var onRightChanged: ChangeListeners[ProgressBar, right] = js.native
  var onSelectionChanged: ChangeListeners[ProgressBar, selection] = js.native
  var onStateChanged: ChangeListeners[ProgressBar, state] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[ProgressBar]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[ProgressBar]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[ProgressBar]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[ProgressBar]] = js.native
  var onTap: Listeners[WidgetTapEvent[ProgressBar]] = js.native
  var onTintColorChanged: ChangeListeners[ProgressBar, tintColor] = js.native
  var onTopChanged: ChangeListeners[ProgressBar, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[ProgressBar]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[ProgressBar]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[ProgressBar]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[ProgressBar]] = js.native
  var onTransformChanged: ChangeListeners[ProgressBar, transform] = js.native
  var onVisibleChanged: ChangeListeners[ProgressBar, visible] = js.native
  var onWidthChanged: ChangeListeners[ProgressBar, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ProgressBar]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ProgressBar] = js.native
  ...
  def appendTo(parent: Composite[Widget]): ProgressBar = js.native
  def detach(): ProgressBar = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): ProgressBar = js.native
  def insertBefore(widget: Widget): ProgressBar = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ProgressBar = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): ProgressBar = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ProgressBar = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): ProgressBar = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ProgressBar = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): ProgressBar = js.native
  def triggerAsync(`type`: String): js.Promise[ProgressBar] = js.native
}
