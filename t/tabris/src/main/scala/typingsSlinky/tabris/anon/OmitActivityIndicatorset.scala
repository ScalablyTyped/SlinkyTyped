...
import typingsSlinky.tabris.mod.ActivityIndicator
...
/* Inlined tabris.tabris.Omit<tabris.tabris.ActivityIndicator, 'set'> */
@js.native
trait OmitActivityIndicatorset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], ActivityIndicator] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[ActivityIndicator] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, ActivityIndicator] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, ActivityIndicator] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[
    ActivityIndicator, 
    Omit[ActivityIndicator, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ...
  var onBackgroundChanged: ChangeListeners[ActivityIndicator, background] = js.native
  var onBaselineChanged: ChangeListeners[ActivityIndicator, baseline] = js.native
  var onBottomChanged: ChangeListeners[ActivityIndicator, bottom] = js.native
  var onBoundsChanged: ChangeListeners[ActivityIndicator, bounds] = js.native
  var onCenterXChanged: ChangeListeners[ActivityIndicator, centerX] = js.native
  var onCenterYChanged: ChangeListeners[ActivityIndicator, centerY] = js.native
  var onClassChanged: ChangeListeners[ActivityIndicator, `class`] = js.native
  var onClassListChanged: ChangeListeners[ActivityIndicator, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[ActivityIndicator, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[ActivityIndicator]] = js.native
  var onElevationChanged: ChangeListeners[ActivityIndicator, elevation] = js.native
  var onEnabledChanged: ChangeListeners[ActivityIndicator, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[ActivityIndicator, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[ActivityIndicator, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[ActivityIndicator, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[ActivityIndicator, id] = js.native
  var onLayoutDataChanged: ChangeListeners[ActivityIndicator, layoutData] = js.native
  var onLeftChanged: ChangeListeners[ActivityIndicator, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[ActivityIndicator]] = js.native
  var onOpacityChanged: ChangeListeners[ActivityIndicator, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[ActivityIndicator]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[ActivityIndicator]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[ActivityIndicator]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[ActivityIndicator]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[ActivityIndicator]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[ActivityIndicator]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[ActivityIndicator]] = js.native
  var onResize: Listeners[WidgetResizeEvent[ActivityIndicator]] = js.native
  var onRightChanged: ChangeListeners[ActivityIndicator, right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[ActivityIndicator]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[ActivityIndicator]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[ActivityIndicator]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[ActivityIndicator]] = js.native
  var onTap: Listeners[WidgetTapEvent[ActivityIndicator]] = js.native
  var onTintColorChanged: ChangeListeners[ActivityIndicator, tintColor] = js.native
  var onTopChanged: ChangeListeners[ActivityIndicator, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[ActivityIndicator]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[ActivityIndicator]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[ActivityIndicator]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[ActivityIndicator]] = js.native
  var onTransformChanged: ChangeListeners[ActivityIndicator, transform] = js.native
  var onVisibleChanged: ChangeListeners[ActivityIndicator, visible] = js.native
  var onWidthChanged: ChangeListeners[ActivityIndicator, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ActivityIndicator]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ActivityIndicator] = js.native
  ...
  def appendTo(parent: Composite[Widget]): ActivityIndicator = js.native
  def detach(): ActivityIndicator = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): ActivityIndicator = js.native
  def insertBefore(widget: Widget): ActivityIndicator = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ActivityIndicator = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): ActivityIndicator = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ActivityIndicator = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): ActivityIndicator = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ActivityIndicator = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): ActivityIndicator = js.native
  def triggerAsync(`type`: String): js.Promise[ActivityIndicator] = js.native
}
