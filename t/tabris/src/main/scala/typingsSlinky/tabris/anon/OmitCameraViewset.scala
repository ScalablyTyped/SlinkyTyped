...
import typingsSlinky.tabris.mod.Camera
import typingsSlinky.tabris.mod.CameraView
...
import typingsSlinky.tabris.tabrisStrings.scaleMode
...
/* Inlined tabris.tabris.Omit<tabris.tabris.CameraView, 'set'> */
@js.native
trait OmitCameraViewset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], CameraView] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[CameraView, Omit[CameraView, set]]], js.Any] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[CameraView] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, CameraView] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, CameraView] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: JSXAttributes[
    CameraView, 
    Omit[CameraView, set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ] = js.native
  ...
  var onBackgroundChanged: ChangeListeners[CameraView, background] = js.native
  var onBaselineChanged: ChangeListeners[CameraView, baseline] = js.native
  var onBottomChanged: ChangeListeners[CameraView, bottom] = js.native
  var onBoundsChanged: ChangeListeners[CameraView, bounds] = js.native
  var onCameraChanged: ChangeListeners[CameraView, camera] = js.native
  var onCenterXChanged: ChangeListeners[CameraView, centerX] = js.native
  var onCenterYChanged: ChangeListeners[CameraView, centerY] = js.native
  var onClassChanged: ChangeListeners[CameraView, `class`] = js.native
  var onClassListChanged: ChangeListeners[CameraView, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[CameraView, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[CameraView]] = js.native
  var onElevationChanged: ChangeListeners[CameraView, elevation] = js.native
  var onEnabledChanged: ChangeListeners[CameraView, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[CameraView, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[CameraView, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[CameraView, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[CameraView, id] = js.native
  var onLayoutDataChanged: ChangeListeners[CameraView, layoutData] = js.native
  var onLeftChanged: ChangeListeners[CameraView, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[CameraView]] = js.native
  var onOpacityChanged: ChangeListeners[CameraView, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[CameraView]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[CameraView]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[CameraView]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[CameraView]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[CameraView]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[CameraView]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[CameraView]] = js.native
  var onResize: Listeners[WidgetResizeEvent[CameraView]] = js.native
  var onRightChanged: ChangeListeners[CameraView, right] = js.native
  var onScaleModeChanged: ChangeListeners[CameraView, scaleMode] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[CameraView]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[CameraView]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[CameraView]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[CameraView]] = js.native
  var onTap: Listeners[WidgetTapEvent[CameraView]] = js.native
  var onTopChanged: ChangeListeners[CameraView, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[CameraView]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[CameraView]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[CameraView]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[CameraView]] = js.native
  var onTransformChanged: ChangeListeners[CameraView, transform] = js.native
  var onVisibleChanged: ChangeListeners[CameraView, visible] = js.native
  var onWidthChanged: ChangeListeners[CameraView, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[CameraView]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, CameraView] = js.native
  ...
  def appendTo(parent: Composite[Widget]): CameraView = js.native
  def detach(): CameraView = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): CameraView = js.native
  def insertBefore(widget: Widget): CameraView = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): CameraView = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): CameraView = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): CameraView = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): CameraView = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): CameraView = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): CameraView = js.native
  def triggerAsync(`type`: String): js.Promise[CameraView] = js.native
}
