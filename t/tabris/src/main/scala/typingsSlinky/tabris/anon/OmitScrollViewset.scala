...
trait OmitScrollViewset extends js.Object {
  ...
  @JSName("scrollToX")
  var scrollToX_Original: js.Function2[/* offset */ Double, /* options */ js.UndefOr[Animate], ScrollView] = js.native
  @JSName("scrollToY")
  var scrollToY_Original: js.Function2[/* offset */ Double, /* options */ js.UndefOr[Animate], ScrollView] = js.native
  ...
  def scrollToX(offset: Double, options: Animate): ScrollView = js.native
  def scrollToY(offset: Double): ScrollView = js.native
  def scrollToY(offset: Double, options: Animate): ScrollView = js.native
