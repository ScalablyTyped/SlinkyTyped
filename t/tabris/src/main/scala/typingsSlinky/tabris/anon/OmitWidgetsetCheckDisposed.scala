...
import typingsSlinky.tabris.mod.TabFolder
...
@js.native
trait OmitWidgetsetCheckDisposed[TabType /* <: Tab */] extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], TabFolder[TabType]] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[TabFolder[TabType]] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, TabFolder[TabType]] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, TabFolder[TabType]] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: JSXAttributes[
    TabFolder[TabType], 
    Omit[TabFolder[TabType], set | typingsSlinky.tabris.tabrisStrings.jsxAttributes]
  ] = js.native
  ...
  var onBackgroundChanged: ChangeListeners[TabFolder[TabType], background] = js.native
  var onBaselineChanged: ChangeListeners[TabFolder[TabType], baseline] = js.native
  var onBottomChanged: ChangeListeners[TabFolder[TabType], bottom] = js.native
  var onBoundsChanged: ChangeListeners[TabFolder[TabType], bounds] = js.native
  var onCenterXChanged: ChangeListeners[TabFolder[TabType], centerX] = js.native
  var onCenterYChanged: ChangeListeners[TabFolder[TabType], centerY] = js.native
  var onClassChanged: ChangeListeners[TabFolder[TabType], `class`] = js.native
  var onClassListChanged: ChangeListeners[TabFolder[TabType], classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[TabFolder[TabType], cornerRadius] = js.native
  var onDispose: Listeners[EventObject[TabFolder[TabType]]] = js.native
  var onElevationChanged: ChangeListeners[TabFolder[TabType], elevation] = js.native
  var onEnabledChanged: ChangeListeners[TabFolder[TabType], enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[TabFolder[TabType], excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[TabFolder[TabType], height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[TabFolder[TabType], highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[TabFolder[TabType], id] = js.native
  var onLayoutDataChanged: ChangeListeners[TabFolder[TabType], layoutData] = js.native
  var onLeftChanged: ChangeListeners[TabFolder[TabType], left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[TabFolder[TabType]]] = js.native
  var onOpacityChanged: ChangeListeners[TabFolder[TabType], opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[TabFolder[TabType]]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[TabFolder[TabType]]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[TabFolder[TabType]]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[TabFolder[TabType]]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[TabFolder[TabType]]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[TabFolder[TabType]]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[TabFolder[TabType]]] = js.native
  var onResize: Listeners[WidgetResizeEvent[TabFolder[TabType]]] = js.native
  var onRightChanged: ChangeListeners[TabFolder[TabType], right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[TabFolder[TabType]]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[TabFolder[TabType]]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[TabFolder[TabType]]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[TabFolder[TabType]]] = js.native
  var onTap: Listeners[WidgetTapEvent[TabFolder[TabType]]] = js.native
  var onTopChanged: ChangeListeners[TabFolder[TabType], top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[TabFolder[TabType]]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[TabFolder[TabType]]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[TabFolder[TabType]]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[TabFolder[TabType]]] = js.native
  var onTransformChanged: ChangeListeners[TabFolder[TabType], transform] = js.native
  var onVisibleChanged: ChangeListeners[TabFolder[TabType], visible] = js.native
  var onWidthChanged: ChangeListeners[TabFolder[TabType], width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[TabFolder[TabType]]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, TabFolder[TabType]] = js.native
  ...
  def appendTo(parent: Composite[Widget]): TabFolder[TabType] = js.native
  def detach(): TabFolder[TabType] = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): TabFolder[TabType] = js.native
  def insertBefore(widget: Widget): TabFolder[TabType] = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): TabFolder[TabType] = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): TabFolder[TabType] = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): TabFolder[TabType] = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): TabFolder[TabType] = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): TabFolder[TabType] = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): TabFolder[TabType] = js.native
  def triggerAsync(`type`: String): js.Promise[TabFolder[TabType]] = js.native
}
