...
import typingsSlinky.tablesorter.sortingTableSortingMod.TableSorting
import typingsSlinky.tablesorter.systemTablesorterCacheMod.TablesorterCache
...
import typingsSlinky.tablesorter.widgetsWidgetOptionStoreMod.WidgetOptionStore
