package typingsSlinky.tablesorter.widgetsWidgetOptionsMod
...
import typingsSlinky.tablesorter.filteringFilterFunctionCollectionMod.FilterFunctionCollection
import typingsSlinky.tablesorter.filteringFilterFunctionMod.FilterFunction
import typingsSlinky.tablesorter.filteringFilterPlaceholdersMod.FilterPlaceholders
import typingsSlinky.tablesorter.filteringFormatterFilterControlFactoryMod.FilterControlFactory
import typingsSlinky.tablesorter.filteringMatchTypeSettingsMod.MatchTypeSettings
import typingsSlinky.tablesorter.filteringSelectSourcesMod.SelectSources
import typingsSlinky.tablesorter.pagingPageSizeMod.PageSize
import typingsSlinky.tablesorter.pagingPagerClassesMod.PagerClasses
import typingsSlinky.tablesorter.pagingPagerDataPartMod.PagerDataPart
import typingsSlinky.tablesorter.pagingPagerInitialRowsMod.PagerInitialRows
import typingsSlinky.tablesorter.pagingPagerOutputProcessorMod.PagerOutputProcessor
import typingsSlinky.tablesorter.pagingPagerSelectorsMod.PagerSelectors
import typingsSlinky.tablesorter.storageStorageTypeMod.StorageType
import typingsSlinky.tablesorter.systemMappedSettingsMod.MappedSettings
...
import typingsSlinky.tablesorter.widgetsColumnWidgetOptionsMod.ColumnOptions
import typingsSlinky.tablesorter.widgetsFilterOptionsMod.FilterOptions
import typingsSlinky.tablesorter.widgetsPagerOptionsMod.PagerOptions
import typingsSlinky.tablesorter.widgetsResizingOptionsMod.ResizingOptions
import typingsSlinky.tablesorter.widgetsSaveSortOptionsMod.SaveSortOptions
import typingsSlinky.tablesorter.widgetsStickyHeaderOptionsMod.StickyHeaderOptions
import typingsSlinky.tablesorter.widgetsZebraOptionsMod.ZebraOptions
