package typingsSlinky.tablesorter.filterBoxMod
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.tablesorter.tablesorterStrings.select
  - typingsSlinky.tablesorter.tablesorterStrings.from
  - typingsSlinky.tablesorter.tablesorterStrings.to
*/
