package typingsSlinky.tablesorter.filteringFormatterOptionsUISliderOptionsMod
...
import typingsSlinky.tablesorter.filteringFormatterOptionsRangeOptionsMod.RangeOptions
