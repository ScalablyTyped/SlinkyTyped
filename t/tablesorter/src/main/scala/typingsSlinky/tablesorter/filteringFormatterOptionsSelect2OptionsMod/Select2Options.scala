package typingsSlinky.tablesorter.filteringFormatterOptionsSelect2OptionsMod

import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.select2.select2Mod.AjaxOptions
...
import typingsSlinky.select2.select2Mod.LoadingData
import typingsSlinky.select2.select2Mod.OptGroupData
import typingsSlinky.select2.select2Mod.OptionData
import typingsSlinky.select2.select2Mod.Options
import typingsSlinky.select2.select2Mod.SearchOptions
import typingsSlinky.select2.select2Mod.Translation
