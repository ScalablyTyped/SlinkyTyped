...
import typingsSlinky.select2.mod.AjaxOptions
...
import typingsSlinky.select2.mod.LoadingData
import typingsSlinky.select2.mod.OptGroupData
import typingsSlinky.select2.mod.OptionData
import typingsSlinky.select2.mod.Options
import typingsSlinky.select2.mod.SearchOptions
import typingsSlinky.select2.mod.Translation
