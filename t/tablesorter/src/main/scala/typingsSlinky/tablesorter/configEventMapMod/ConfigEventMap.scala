package typingsSlinky.tablesorter.configEventMapMod
...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.tablesorter.tablesorterStrings.filterInit
  - typingsSlinky.tablesorter.tablesorterStrings.filterEnd
*/
