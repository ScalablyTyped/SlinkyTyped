package typingsSlinky.tablesorter.emptySortingMod
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.tablesorter.tablesorterStrings.emptyMin
  - typingsSlinky.tablesorter.tablesorterStrings.emptyMax
