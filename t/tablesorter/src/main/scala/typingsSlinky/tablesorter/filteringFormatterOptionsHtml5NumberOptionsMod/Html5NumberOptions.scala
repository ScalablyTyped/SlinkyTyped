package typingsSlinky.tablesorter.filteringFormatterOptionsHtml5NumberOptionsMod
...
import typingsSlinky.tablesorter.filteringFormatterOptionsTestableOptionsMod.TestableOptions
