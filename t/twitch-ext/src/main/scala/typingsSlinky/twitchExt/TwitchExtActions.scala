...
object TwitchExtActions {
  ...
  implicit class TwitchExtActionsOps[Self <: TwitchExtActions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFollowChannel(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("followChannel")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOnFollow(value: js.Function2[/* didFollow */ Boolean, /* channelName */ String, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onFollow")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRequestIdShare(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requestIdShare")(js.Any.fromFunction0(value))
        ret
    }
  }
