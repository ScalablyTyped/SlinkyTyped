...
object mod {
  ...
  def compress(
    ...
    callback: js.Function1[/* error */ js.Error | String | Null, Unit]
  ): Unit = js.native
  @JSImport("targz", "compress")
  @js.native
  ...
  @JSImport("targz", "compress")
  @js.native
  def compress(opts: options, callback: js.Function1[/* error */ js.Error | String | Null, Unit]): Unit = js.native
  ...
  @JSImport("targz", "decompress")
  @js.native
  def decompress(opts: options, callback: js.Function1[/* error */ js.Error | String | Null, Unit]): Unit = js.native
