...
object layers extends js.Object {
  ...
  abstract class Layer protected ()
    extends typingsSlinky.atTensorflowTfjsDashLayers.distExportsUnderscoreLayersMod.Layer {
    def this(args: LayerArgs) = this()
  }
  
  @js.native
  class RNN protected ()
    extends typingsSlinky.atTensorflowTfjsDashLayers.distExportsUnderscoreLayersMod.RNN {
