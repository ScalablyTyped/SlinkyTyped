...
class SymbolicTensor protected ()
  extends typingsSlinky.atTensorflowTfjsDashLayers.distEngineTopologyMod.SymbolicTensor {
  /**
    *
    * @param dtype
    * @param shape
  ...
  def this(
    ...
    shape: Shape,
    sourceLayer: Layer,
    inputs: js.Array[typingsSlinky.atTensorflowTfjsDashLayers.distEngineTopologyMod.SymbolicTensor],
    callArgs: Kwargs
  ) = this()
  def this(
    dtype: DataType,
