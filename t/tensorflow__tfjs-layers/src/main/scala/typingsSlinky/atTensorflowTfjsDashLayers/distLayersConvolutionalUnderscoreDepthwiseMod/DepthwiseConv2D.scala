package typingsSlinky.atTensorflowTfjsDashLayers.distLayersConvolutionalUnderscoreDepthwiseMod
...
import typingsSlinky.atTensorflowTfjsDashLayers.distLayersConvolutionalMod.BaseConv
