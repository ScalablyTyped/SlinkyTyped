...
import typingsSlinky.atTensorflowTfjsDashCore.distIoTypesMod.SaveConfig
...
import typingsSlinky.atTensorflowTfjsDashLayers.distBaseUnderscoreCallbacksMod.History
...
import typingsSlinky.atTensorflowTfjsDashLayers.distEngineTrainingUnderscoreDatasetMod.ModelEvaluateDatasetArgs
import typingsSlinky.atTensorflowTfjsDashLayers.distEngineTrainingUnderscoreDatasetMod.ModelFitDatasetArgs
import typingsSlinky.atTensorflowTfjsDashLayers.distEngineTrainingUnderscoreTensorsMod.ModelFitArgs
...
import typingsSlinky.atTensorflowTfjsDashLayers.distTypesMod.NamedTensor
...
class LayersModel protected () extends Container {
  ...
  def execute(
    inputs: js.Array[Tensor[Rank] | typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank]],
    outputs: String
  ...
  /**
    ...
    * outputs.
    */
  def execute(inputs: typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank], outputs: String): typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank] | js.Array[typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank]] = js.native
  def execute(
    inputs: typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank],
    outputs: js.Array[String]
  ): typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank] | js.Array[typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank]] = js.native
  ...
  ): typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank] | js.Array[typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank]] | NamedTensorMap = js.native
  def predict(inputs: NamedTensorMap, config: ModelPredictConfig): typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank] | js.Array[typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank]] | NamedTensorMap = js.native
  def predict(x: js.Array[Tensor[Rank]]): Tensor[Rank] | js.Array[Tensor[Rank]] = js.native
  def predict(
    x: js.Array[Tensor[Rank] | typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[Rank]],
