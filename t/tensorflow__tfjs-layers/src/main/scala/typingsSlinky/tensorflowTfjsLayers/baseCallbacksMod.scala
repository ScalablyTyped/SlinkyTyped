...
object baseCallbacksMod {
  ...
  object ModelLoggingVerbosity extends StObject {
    ...
    /* 0 */ val SILENT: typingsSlinky.tensorflowTfjsLayers.baseCallbacksMod.ModelLoggingVerbosity.SILENT with Double = js.native
    
    @js.native
    sealed trait VERBOSE extends ModelLoggingVerbosity
    /* 1 */ val VERBOSE: typingsSlinky.tensorflowTfjsLayers.baseCallbacksMod.ModelLoggingVerbosity.VERBOSE with Double = js.native
  }
