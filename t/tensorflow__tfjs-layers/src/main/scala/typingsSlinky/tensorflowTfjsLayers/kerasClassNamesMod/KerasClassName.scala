...
object KerasClassName {
  ...
  @scala.inline
  def L1L2: typingsSlinky.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.L1L2 = "L1L2".asInstanceOf[typingsSlinky.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.L1L2]
