...
package object baseCallbacksMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.epoch
    - typingsSlinky.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.never
    - scala.Double
  */
  type YieldEveryOptions = typingsSlinky.tensorflowTfjsLayers.baseCallbacksMod._YieldEveryOptions | scala.Double
}
