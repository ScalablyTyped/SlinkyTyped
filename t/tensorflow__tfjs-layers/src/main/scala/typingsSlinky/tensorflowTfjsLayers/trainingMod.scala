...
import typingsSlinky.tensorflowTfjsLayers.distTypesMod.NamedTensor
...
import typingsSlinky.tensorflowTfjsLayers.trainingDatasetMod.ModelEvaluateDatasetArgs
import typingsSlinky.tensorflowTfjsLayers.trainingDatasetMod.ModelFitDatasetArgs
import typingsSlinky.tensorflowTfjsLayers.trainingTensorsMod.ModelFitArgs
...
object trainingMod {
  ...
  - typingsSlinky.tensorflowTfjsCore.modelTypesMod.InferenceModel because var conflicts: inputs, outputs. Inlined execute, execute, execute, execute, execute, execute, predict, predict, predict */ @JSImport("@tensorflow/tfjs-layers/dist/engine/training", "LayersModel")
  @js.native
