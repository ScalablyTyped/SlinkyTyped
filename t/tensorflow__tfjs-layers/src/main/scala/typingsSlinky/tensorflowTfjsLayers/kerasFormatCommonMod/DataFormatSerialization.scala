...
object DataFormatSerialization {
  ...
  @scala.inline
  def channels_first: typingsSlinky.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.channels_first = this.cast("channels_first")
  @scala.inline
  def channels_last: typingsSlinky.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.channels_last = this.cast("channels_last")
}
