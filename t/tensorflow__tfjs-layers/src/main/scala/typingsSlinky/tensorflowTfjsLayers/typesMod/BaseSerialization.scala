...
object BaseSerialization {
  @scala.inline
  def apply[/* <: java.lang.String */ N, /* <: typingsSlinky.tensorflowTfjsLayers.typesMod.PyJson[typingsSlinky.std.Extract[/ * keyof T * / java.lang.String, java.lang.String]] */ T](class_name: N, config: T): BaseSerialization[N, T] = {
  ...
  @scala.inline
  implicit class BaseSerializationOps[Self <: BaseSerialization[_, _], /* <: java.lang.String */ N, /* <: typingsSlinky.tensorflowTfjsLayers.typesMod.PyJson[typingsSlinky.std.Extract[/ * keyof T * / java.lang.String, java.lang.String]] */ T] (val x: Self with (BaseSerialization[N, T])) extends AnyVal {
    @scala.inline
