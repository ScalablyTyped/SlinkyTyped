...
object DropoutLayerConfig {
  ...
  implicit class DropoutLayerConfigOps[Self <: DropoutLayerConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNoise_shape(value: js.Array[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noise_shape")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNoise_shape: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noise_shape")(js.undefined)
        ret
    }
    @scala.inline
