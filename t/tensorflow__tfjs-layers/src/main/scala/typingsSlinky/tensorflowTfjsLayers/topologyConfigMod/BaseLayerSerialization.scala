...
object BaseLayerSerialization {
  @scala.inline
  def apply[/* <: java.lang.String */ N, /* <: typingsSlinky.tensorflowTfjsLayers.topologyConfigMod.LayerConfig */ C](class_name: N, config: JsonLayer[C], name: String): BaseLayerSerialization[N, C] = {
  ...
  @scala.inline
  implicit class BaseLayerSerializationOps[Self <: BaseLayerSerialization[_, _], /* <: java.lang.String */ N, /* <: typingsSlinky.tensorflowTfjsLayers.topologyConfigMod.LayerConfig */ C] (val x: Self with (BaseLayerSerialization[N, C])) extends AnyVal {
    @scala.inline
