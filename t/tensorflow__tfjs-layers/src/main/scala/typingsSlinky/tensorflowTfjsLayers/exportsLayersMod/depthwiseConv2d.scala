...
@JSImport("@tensorflow/tfjs-layers/dist/exports_layers", "depthwiseConv2d")
@js.native
object depthwiseConv2d extends js.Object {
  
  def apply(args: DepthwiseConv2DLayerArgs): typingsSlinky.tensorflowTfjsLayers.topologyMod.Layer = js.native
}
