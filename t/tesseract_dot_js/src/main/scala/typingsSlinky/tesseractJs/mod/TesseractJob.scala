...
object TesseractJob {
  ...
  implicit class TesseractJobOps[Self <: TesseractJob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: js.Function1[/* error */ js.Error, Unit] => TesseractJob): Self = this.set("catch", js.Any.fromFunction1(value))
    
    @scala.inline
    def setFinally(value: js.Function1[/* resultOrError */ js.Error | Page, Unit] => TesseractJob): Self = this.set("finally", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setError(value: /* error */ js.Error => TesseractJob): Self = this.set("error", js.Any.fromFunction1(value))
