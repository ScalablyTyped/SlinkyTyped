...
object SaverDef {
  ...
  object CheckpointFormatVersion extends StObject {
    ...
    /* 0 */ val LEGACY: typingsSlinky.tensorflowTfjsConverter.compiledApiMod.SaverDef.CheckpointFormatVersion.LEGACY with Double = js.native
    
    @js.native
    sealed trait V1 extends CheckpointFormatVersion
    /* 1 */ val V1: typingsSlinky.tensorflowTfjsConverter.compiledApiMod.SaverDef.CheckpointFormatVersion.V1 with Double = js.native
    
    @js.native
    sealed trait V2 extends CheckpointFormatVersion
    /* 2 */ val V2: typingsSlinky.tensorflowTfjsConverter.compiledApiMod.SaverDef.CheckpointFormatVersion.V2 with Double = js.native
  }
}
