...
object IBytesList {
  ...
  implicit class IBytesListOps[Self <: IBytesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValueVarargs(value: js.typedarray.Uint8Array*): Self = this.set("value", js.Array(value :_*))
    @scala.inline
    def setValue(value: js.Array[js.typedarray.Uint8Array]): Self = this.set("value", value.asInstanceOf[js.Any])
    @scala.inline
