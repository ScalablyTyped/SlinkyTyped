...
object ITensor {
  ...
  implicit class ITensorMutableBuilder[Self <: ITensor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStringVal(value: js.Array[js.typedarray.Uint8Array]): Self = StObject.set(x, "stringVal", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStringValVarargs(value: js.typedarray.Uint8Array*): Self = StObject.set(x, "stringVal", js.Array(value :_*))
    
    @scala.inline
    def setTensorContent(value: js.typedarray.Uint8Array): Self = StObject.set(x, "tensorContent", value.asInstanceOf[js.Any])
