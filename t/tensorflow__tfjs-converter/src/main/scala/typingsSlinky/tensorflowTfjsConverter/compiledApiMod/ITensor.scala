...
object ITensor {
  ...
  implicit class ITensorOps[Self <: ITensor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStringValVarargs(value: js.typedarray.Uint8Array*): Self = this.set("stringVal", js.Array(value :_*))
    
    @scala.inline
    def setStringVal(value: js.Array[js.typedarray.Uint8Array]): Self = this.set("stringVal", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTensorContent(value: js.typedarray.Uint8Array): Self = this.set("tensorContent", value.asInstanceOf[js.Any])
