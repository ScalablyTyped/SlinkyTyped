...
object CollectionDef {
  ...
  object IBytesList {
    ...
    implicit class IBytesListMutableBuilder[Self <: IBytesList] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValue(value: js.Array[js.typedarray.Uint8Array]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValueVarargs(value: js.typedarray.Uint8Array*): Self = StObject.set(x, "value", js.Array(value :_*))
    }
  }
