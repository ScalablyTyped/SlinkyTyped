...
object tensorUtilsMod {
  ...
  @JSImport("@tensorflow/tfjs-converter/dist/executor/tensor_utils", "assertShapesMatchAllowUndefinedSize")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-converter/dist/executor/tensor_utils", "shapesEqualAllowUndefinedSize")
  @js.native
