...
import typingsSlinky.tensorflowTfjsConverter.compiledApiMod.IGraphDef
...
object operationMapperMod extends js.Object {
  ...
  def parseDtypeParam(value: typingsSlinky.tensorflowTfjsConverter.compiledApiMod.DataType): DataType = js.native
