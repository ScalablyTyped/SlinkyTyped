package typingsSlinky.atTensorflowTfjsDashConverter.distSrcDataCompiledUnderscoreApiMod.AttrValue

import typingsSlinky.atTensorflowTfjsDashConverter.distSrcDataCompiledUnderscoreApiMod.DataType
import typingsSlinky.atTensorflowTfjsDashConverter.distSrcDataCompiledUnderscoreApiMod.INameAttrList
import typingsSlinky.atTensorflowTfjsDashConverter.distSrcDataCompiledUnderscoreApiMod.ITensor
