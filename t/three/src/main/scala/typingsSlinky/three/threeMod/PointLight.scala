...
@js.native
class PointLight ()
  extends typingsSlinky.three.srcLightsPointLightMod.PointLight {
  ...
  def this(color: typingsSlinky.three.srcMathColorMod.Color, intensity: Double, distance: Double) = this()
