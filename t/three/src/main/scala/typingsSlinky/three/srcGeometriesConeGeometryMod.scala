...
import typingsSlinky.three.srcGeometriesCylinderGeometryMod.CylinderBufferGeometry
import typingsSlinky.three.srcGeometriesCylinderGeometryMod.CylinderGeometry
