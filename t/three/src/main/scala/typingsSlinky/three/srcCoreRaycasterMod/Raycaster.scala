package typingsSlinky.three.srcCoreRaycasterMod

import typingsSlinky.three.Anon_X
import typingsSlinky.three.srcCamerasCameraMod.Camera
import typingsSlinky.three.srcCoreObject3DMod.Object3D
import typingsSlinky.three.srcMathRayMod.Ray
...
class Raycaster () extends js.Object {
  ...
  /**
  	 ...
  	 */
  def setFromCamera(coords: Anon_X, camera: Camera): Unit = js.native
}
