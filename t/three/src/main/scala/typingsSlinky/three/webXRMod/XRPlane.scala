...
import typingsSlinky.three.threeStrings.Horizontal
import typingsSlinky.three.threeStrings.Vertical
...
object XRPlane {
  ...
  implicit class XRPlaneMutableBuilder[Self <: XRPlane] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlaneSpace(value: EventTarget): Self = StObject.set(x, "planeSpace", value.asInstanceOf[js.Any])
