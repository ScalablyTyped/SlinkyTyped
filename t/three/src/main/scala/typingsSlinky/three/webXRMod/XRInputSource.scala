...
object XRInputSource {
  ...
  implicit class XRInputSourceMutableBuilder[Self <: XRInputSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGripSpace(value: EventTarget): Self = StObject.set(x, "gripSpace", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTargetRaySpace(value: EventTarget): Self = StObject.set(x, "targetRaySpace", value.asInstanceOf[js.Any])
  }
}
