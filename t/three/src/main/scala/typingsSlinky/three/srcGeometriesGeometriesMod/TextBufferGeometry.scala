...
import typingsSlinky.three.srcGeometriesTextGeometryMod.TextGeometryParameters
...
class TextBufferGeometry protected ()
  extends typingsSlinky.three.srcGeometriesTextGeometryMod.TextBufferGeometry {
