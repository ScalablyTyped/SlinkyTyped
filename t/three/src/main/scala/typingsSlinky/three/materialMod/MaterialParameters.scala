...
object MaterialParameters {
  ...
  implicit class MaterialParametersOps[Self <: MaterialParameters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOverdraw(value: Double): Self = this.set("overdraw", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOverdraw: Self = this.set("overdraw", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setVertexColors(value: Colors): Self = this.set("vertexColors", value.asInstanceOf[js.Any])
    @scala.inline
