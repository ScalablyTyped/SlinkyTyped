...
@js.native
class PointLight ()
  extends typingsSlinky.three.pointLightMod.PointLight {
  ...
  def this(color: typingsSlinky.three.colorMod.Color, intensity: js.UndefOr[scala.Nothing], distance: Double) = this()
  def this(color: typingsSlinky.three.colorMod.Color, intensity: Double, distance: Double) = this()
  def this(
  ...
  def this(color: typingsSlinky.three.colorMod.Color, intensity: Double, distance: Double, decay: Double) = this()
}
