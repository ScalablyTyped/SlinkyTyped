...
@js.native
class RectAreaLight ()
  extends typingsSlinky.three.rectAreaLightMod.RectAreaLight {
  ...
  def this(color: typingsSlinky.three.colorMod.Color, intensity: js.UndefOr[scala.Nothing], width: Double) = this()
  def this(color: typingsSlinky.three.colorMod.Color, intensity: Double, width: Double) = this()
  def this(
  ...
  def this(color: typingsSlinky.three.colorMod.Color, intensity: Double, width: Double, height: Double) = this()
}
