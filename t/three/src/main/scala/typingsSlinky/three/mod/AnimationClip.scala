...
object AnimationClip extends js.Object {
  ...
  def parseAnimation(animation: js.Any, bones: js.Array[typingsSlinky.three.boneMod.Bone], nodeName: String): typingsSlinky.three.animationClipMod.AnimationClip = js.native
