...
object twilsockMod extends js.Object {
  ...
  class TransportUnavailableError protected ()
    extends typingsSlinky.twilsock.libErrorTransportunavailableerrorMod.TransportUnavailableError {
  ...
  class Twilsock protected ()
    extends typingsSlinky.twilsock.libClientMod.TwilsockClient {
    /**
  ...
  class TwilsockError protected ()
    extends typingsSlinky.twilsock.libErrorTwilsockerrorMod.TwilsockError {
    def this(description: String) = this()
  }
