...
object mod extends js.Object {
  ...
  class TransportUnavailableError protected ()
    extends typingsSlinky.twilsock.transportunavailableerrorMod.TransportUnavailableError {
  ...
  class Twilsock protected ()
    extends typingsSlinky.twilsock.clientMod.TwilsockClient {
    /**
  ...
  class TwilsockError protected ()
    extends typingsSlinky.twilsock.twilsockerrorMod.TwilsockError {
    def this(description: String) = this()
  }
