package typingsSlinky.twilsock.libTwilsockMod
...
import typingsSlinky.twilsock.libTwilsockMod.TwilsockChannel.State
import typingsSlinky.twilsock.libWebsocketchannelMod.WebSocketChannel
