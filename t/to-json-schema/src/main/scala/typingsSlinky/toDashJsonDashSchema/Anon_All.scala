...
import typingsSlinky.toDashJsonDashSchema.toDashJsonDashSchemaStrings.all
import typingsSlinky.toDashJsonDashSchema.toDashJsonDashSchemaStrings.first
import typingsSlinky.toDashJsonDashSchema.toDashJsonDashSchemaStrings.tuple
import typingsSlinky.toDashJsonDashSchema.toDashJsonDashSchemaStrings.uniform
