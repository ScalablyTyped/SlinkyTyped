...
import typingsSlinky.tinycolor2.Anon_000
import typingsSlinky.tinycolor2.Anon_000000080
...
Instantiable0[Instance]
  ...
  /**
    ...
    */
  var hexNames: Anon_000000080 = js.native
  /**
    * key: 'real' color name
    * value: hex value ex. names["red"] --> "f00"
    */
  var names: Anon_000 = js.native
