...
object TinySliderSettings {
  ...
  implicit class TinySliderSettingsOps[Self <: TinySliderSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutoplayButtonHTMLElement(value: HTMLElement): Self = this.set("autoplayButton", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setControlsContainerHTMLElement(value: HTMLElement): Self = this.set("controlsContainer", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNavContainerHTMLElement(value: HTMLElement): Self = this.set("navContainer", value.asInstanceOf[js.Any])
    @scala.inline
