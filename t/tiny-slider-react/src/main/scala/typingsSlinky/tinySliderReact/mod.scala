...
object mod {
  ...
  type TinySlider = ReactComponentClass[TinySliderProps]
  ...
  object TinySliderSettings {
    ...
    implicit class TinySliderSettingsMutableBuilder[Self <: TinySliderSettings] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAutoplayButtonHTMLElement(value: HTMLElement): Self = StObject.set(x, "autoplayButton", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setControlsContainerHTMLElement(value: HTMLElement): Self = StObject.set(x, "controlsContainer", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNavContainerHTMLElement(value: HTMLElement): Self = StObject.set(x, "navContainer", value.asInstanceOf[js.Any])
