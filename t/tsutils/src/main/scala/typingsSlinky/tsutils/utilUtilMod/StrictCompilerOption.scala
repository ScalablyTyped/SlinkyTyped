...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.tsutils.tsutilsStrings.noImplicitAny
  - typingsSlinky.tsutils.tsutilsStrings.noImplicitThis
  - typingsSlinky.tsutils.tsutilsStrings.strictNullChecks
  - typingsSlinky.tsutils.tsutilsStrings.strictFunctionTypes
  - typingsSlinky.tsutils.tsutilsStrings.strictPropertyInitialization
  - typingsSlinky.tsutils.tsutilsStrings.alwaysStrict
  - typingsSlinky.tsutils.tsutilsStrings.strictBindCallApply
*/
