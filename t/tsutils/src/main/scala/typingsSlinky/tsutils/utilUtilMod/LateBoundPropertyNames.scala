...
object LateBoundPropertyNames {
  ...
  implicit class LateBoundPropertyNamesOps[Self <: LateBoundPropertyNames] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKnown(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("known")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNames(value: js.Array[PropertyName]): Self = {
        val ret = this.duplicate
