...
import typingsSlinky.titanium.Titanium.UI.iOS.AdView
import typingsSlinky.titanium.Titanium.UI.iOS.AnchorAttachmentBehavior
import typingsSlinky.titanium.Titanium.UI.iOS.Animator
import typingsSlinky.titanium.Titanium.UI.iOS.ApplicationShortcuts
import typingsSlinky.titanium.Titanium.UI.iOS.AttributedString
import typingsSlinky.titanium.Titanium.UI.iOS.BlurView
import typingsSlinky.titanium.Titanium.UI.iOS.CollisionBehavior
import typingsSlinky.titanium.Titanium.UI.iOS.CoverFlowView
import typingsSlinky.titanium.Titanium.UI.iOS.DocumentViewer
import typingsSlinky.titanium.Titanium.UI.iOS.DynamicItemBehavior
import typingsSlinky.titanium.Titanium.UI.iOS.FeedbackGenerator
import typingsSlinky.titanium.Titanium.UI.iOS.GravityBehavior
import typingsSlinky.titanium.Titanium.UI.iOS.LivePhotoView
import typingsSlinky.titanium.Titanium.UI.iOS.MenuPopup
import typingsSlinky.titanium.Titanium.UI.iOS.NavigationWindow
import typingsSlinky.titanium.Titanium.UI.iOS.PreviewAction
import typingsSlinky.titanium.Titanium.UI.iOS.PreviewActionGroup
import typingsSlinky.titanium.Titanium.UI.iOS.PreviewContext
import typingsSlinky.titanium.Titanium.UI.iOS.PushBehavior
import typingsSlinky.titanium.Titanium.UI.iOS.SnapBehavior
import typingsSlinky.titanium.Titanium.UI.iOS.SplitWindow
import typingsSlinky.titanium.Titanium.UI.iOS.Stepper
import typingsSlinky.titanium.Titanium.UI.iOS.TabbedBar
import typingsSlinky.titanium.Titanium.UI.iOS.Toolbar
import typingsSlinky.titanium.Titanium.UI.iOS.ViewAttachmentBehavior
import typingsSlinky.titanium.Titanium.UI.iOS.WebViewConfiguration
import typingsSlinky.titanium.Titanium.UI.iOS.WebViewDecisionHandler
import typingsSlinky.titanium.Titanium.UI.iOS.WebViewProcessPool
...
trait TypeofiOS extends js.Object {
  ...
  /**
  			 ...
  			 */
  def createAttribute(): typingsSlinky.titanium.Titanium.UI.iOS.Attribute = js.native
  def createAttribute(parameters: js.Any): typingsSlinky.titanium.Titanium.UI.iOS.Attribute = js.native
  /**
