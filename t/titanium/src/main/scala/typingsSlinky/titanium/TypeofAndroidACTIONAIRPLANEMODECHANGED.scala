...
import typingsSlinky.titanium.Titanium.Android.BigPictureStyle
import typingsSlinky.titanium.Titanium.Android.BigTextStyle
import typingsSlinky.titanium.Titanium.Android.BroadcastReceiver
import typingsSlinky.titanium.Titanium.Android.Intent
import typingsSlinky.titanium.Titanium.Android.Notification
import typingsSlinky.titanium.Titanium.Android.NotificationChannel
import typingsSlinky.titanium.Titanium.Android.PendingIntent
import typingsSlinky.titanium.Titanium.Android.QuickSettingsService
import typingsSlinky.titanium.Titanium.Android.RemoteViews
import typingsSlinky.titanium.Titanium.Android.Service
...
@js.native
trait TypeofAndroidACTIONAIRPLANEMODECHANGED extends js.Object {
  /**
  ...
  def requestPermissions(permissions: String, callback: js.Function1[/* param0 */ RequestPermissionAccessResult, _]): Unit = js.native
  /**
  		 * Request for permission access.
  		 */
