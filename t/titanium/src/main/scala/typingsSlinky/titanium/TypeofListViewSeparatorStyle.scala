...
trait TypeofListViewSeparatorStyle extends js.Object {
  /**
...
object TypeofListViewSeparatorStyle {
  @scala.inline
  def apply(
    NONE: Double,
    SINGLE_LINE: Double,
