...
/**
  ...
  */
@js.native
trait TabTouchmoveEvent extends TabBaseEvent {
...
object TabTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabTouchmoveEvent]
  }
  
  @scala.inline
  implicit class TabTouchmoveEventMutableBuilder[Self <: TabTouchmoveEvent] (val x: Self) extends AnyVal {
