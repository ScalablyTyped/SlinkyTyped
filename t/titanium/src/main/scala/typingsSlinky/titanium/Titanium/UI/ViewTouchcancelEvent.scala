...
/**
  ...
  */
@js.native
trait ViewTouchcancelEvent extends ViewBaseEvent {
...
object ViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ViewTouchcancelEventMutableBuilder[Self <: ViewTouchcancelEvent] (val x: Self) extends AnyVal {
