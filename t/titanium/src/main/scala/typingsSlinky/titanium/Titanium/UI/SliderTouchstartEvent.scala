...
/**
  ...
  */
@js.native
trait SliderTouchstartEvent extends SliderBaseEvent {
...
object SliderTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SliderTouchstartEvent]
  }
  
  @scala.inline
  implicit class SliderTouchstartEventMutableBuilder[Self <: SliderTouchstartEvent] (val x: Self) extends AnyVal {
