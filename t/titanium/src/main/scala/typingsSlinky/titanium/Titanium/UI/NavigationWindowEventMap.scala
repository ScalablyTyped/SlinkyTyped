...
trait NavigationWindowEventMap extends ProxyEventMap {
  var androidback: NavigationWindowAndroidbackEvent
  var androidcamera: NavigationWindowAndroidcameraEvent
  var androidfocus: NavigationWindowAndroidfocusEvent
  var androidsearch: NavigationWindowAndroidsearchEvent
  var androidvoldown: NavigationWindowAndroidvoldownEvent
  var androidvolup: NavigationWindowAndroidvolupEvent
  ...
  var longclick: NavigationWindowLongclickEvent
