...
/**
  ...
  */
@js.native
trait ButtonTouchendEvent extends ButtonBaseEvent {
...
object ButtonTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonTouchendEvent]
  }
  
  @scala.inline
  implicit class ButtonTouchendEventMutableBuilder[Self <: ButtonTouchendEvent] (val x: Self) extends AnyVal {
