...
trait AttributedString extends Proxy {
  /**
  				 ...
  				 */
  var attributes: js.Array[typingsSlinky.titanium.Titanium.UI.iOS.Attribute]
  /**
  ...
  /**
  				 ...
  				 */
  def addAttribute(attribute: typingsSlinky.titanium.Titanium.UI.iOS.Attribute): Unit
  /**
  				 * Gets the value of the <Titanium.UI.iOS.AttributedString.attributes> property.
  				 */
  def getAttributes(): js.Array[typingsSlinky.titanium.Titanium.UI.iOS.Attribute]
  /**
  ...
  /**
  				 ...
  				 */
  def setAttributes(attributes: js.Array[typingsSlinky.titanium.Titanium.UI.iOS.Attribute]): Unit
  /**
...
object AttributedString {
  @scala.inline
  def apply(
    addAttribute: typingsSlinky.titanium.Titanium.UI.iOS.Attribute => Unit,
    addEventListener: (String, js.Function1[/* param0 */ js.Any, _]) => Unit,
    apiName: String,
    applyProperties: js.Any => Unit,
    attributes: js.Array[typingsSlinky.titanium.Titanium.UI.iOS.Attribute],
    bubbleParent: Boolean,
    fireEvent: (String, js.Any) => Unit,
    getApiName: () => String,
    getAttributes: () => js.Array[typingsSlinky.titanium.Titanium.UI.iOS.Attribute],
    getBubbleParent: () => Boolean,
    getText: () => String,
    removeEventListener: (String, js.Function1[/* param0 */ js.Any, _]) => Unit,
    setAttributes: js.Array[typingsSlinky.titanium.Titanium.UI.iOS.Attribute] => Unit,
