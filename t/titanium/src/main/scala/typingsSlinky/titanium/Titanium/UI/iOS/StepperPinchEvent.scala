...
/**
  ...
  */
@js.native
trait StepperPinchEvent extends StepperBaseEvent {
...
object StepperPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[StepperPinchEvent]
  }
  
  @scala.inline
  implicit class StepperPinchEventMutableBuilder[Self <: StepperPinchEvent] (val x: Self) extends AnyVal {
