...
/**
  ...
  */
@js.native
trait TableViewTouchmoveEvent extends TableViewBaseEvent {
...
object TableViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TableViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class TableViewTouchmoveEventMutableBuilder[Self <: TableViewTouchmoveEvent] (val x: Self) extends AnyVal {
