...
trait Calendar extends Proxy {
  ...
  /**
  			 ...
  			 */
  def createEvent(properties: js.Any): typingsSlinky.titanium.Titanium.Calendar.Event = js.native
  /**
  			 * Gets the event with the specified identifier.
  			 */
  def getEventById(id: Double): typingsSlinky.titanium.Titanium.Calendar.Event = js.native
  def getEventsBetweenDates(date1: String, date2: String): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
  /**
  			 * Gets events that occur between two dates.
  			 */
  def getEventsBetweenDates(date1: String, date2: Date): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
  def getEventsBetweenDates(date1: Date, date2: String): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
  /**
  			 * Gets events that occur between two dates.
  			 */
  def getEventsBetweenDates(date1: Date, date2: Date): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
  /**
  			 * Gets events that occur on a specified date.
  			 */
  def getEventsInDate(year: Double, month: Double, day: Double): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
  /**
  			 * Gets events that occur during a specified month.
  			 */
  def getEventsInMonth(year: Double, month: Double): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
  /**
  			 * Gets all events that occur during a specified year.
  			 */
  def getEventsInYear(year: Double): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
  /**
