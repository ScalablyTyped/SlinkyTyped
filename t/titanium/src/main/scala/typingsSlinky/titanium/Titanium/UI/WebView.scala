...
import typingsSlinky.titanium.titaniumStrings.message
import typingsSlinky.titanium.titaniumStrings.onLoadResource
import typingsSlinky.titanium.titaniumStrings.pinch
import typingsSlinky.titanium.titaniumStrings.postlayout
import typingsSlinky.titanium.titaniumStrings.redirect
import typingsSlinky.titanium.titaniumStrings.singletap
import typingsSlinky.titanium.titaniumStrings.sslerror
...
class WebView () extends View {
  ...
  def addEventListener_progress(
    name: typingsSlinky.titanium.titaniumStrings.progress,
  ...
  @JSName("fireEvent")
  def fireEvent_progress(name: typingsSlinky.titanium.titaniumStrings.progress): Unit = js.native
  @JSName("fireEvent")
  def fireEvent_progress(name: typingsSlinky.titanium.titaniumStrings.progress, event: WebViewProgressEvent): Unit = js.native
  @JSName("fireEvent")
