...
/**
  ...
  */
@js.native
trait AlertDialogTouchmoveEvent extends AlertDialogBaseEvent {
...
object AlertDialogTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AlertDialogTouchmoveEvent]
  }
  
  @scala.inline
  implicit class AlertDialogTouchmoveEventMutableBuilder[Self <: AlertDialogTouchmoveEvent] (val x: Self) extends AnyVal {
