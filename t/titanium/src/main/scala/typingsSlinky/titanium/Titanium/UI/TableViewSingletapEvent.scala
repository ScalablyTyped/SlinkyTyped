...
object TableViewSingletapEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TableViewSingletapEvent]
  }
  
  @scala.inline
  implicit class TableViewSingletapEventMutableBuilder[Self <: TableViewSingletapEvent] (val x: Self) extends AnyVal {
