...
import typingsSlinky.titanium.titaniumStrings.metadata
import typingsSlinky.titanium.titaniumStrings.seek
...
trait AudioPlayer extends Proxy {
  ...
  @JSName("fireEvent")
  def fireEvent_progress(name: typingsSlinky.titanium.titaniumStrings.progress, event: AudioPlayerProgressEvent): Unit = js.native
  @JSName("fireEvent")
