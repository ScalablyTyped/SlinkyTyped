...
/**
  ...
  */
@js.native
trait BlurViewTouchcancelEvent extends BlurViewBaseEvent {
...
object BlurViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BlurViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class BlurViewTouchcancelEventMutableBuilder[Self <: BlurViewTouchcancelEvent] (val x: Self) extends AnyVal {
