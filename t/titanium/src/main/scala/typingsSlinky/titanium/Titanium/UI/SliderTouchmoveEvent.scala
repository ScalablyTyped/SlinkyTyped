...
/**
  ...
  */
@js.native
trait SliderTouchmoveEvent extends SliderBaseEvent {
...
object SliderTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SliderTouchmoveEvent]
  }
  
  @scala.inline
  implicit class SliderTouchmoveEventMutableBuilder[Self <: SliderTouchmoveEvent] (val x: Self) extends AnyVal {
