...
trait ProgressIndicatorBaseEvent extends js.Object {
...
object ProgressIndicatorBaseEvent {
  ...
  @scala.inline
  implicit class ProgressIndicatorBaseEventOps[Self <: ProgressIndicatorBaseEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSource(value: ProgressIndicator): Self = this.set("source", value.asInstanceOf[js.Any])
  }
}
