...
/**
  ...
  */
@js.native
trait OptionDialogPinchEvent extends OptionDialogBaseEvent {
...
object OptionDialogPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OptionDialogPinchEvent]
  }
  
  @scala.inline
  implicit class OptionDialogPinchEventMutableBuilder[Self <: OptionDialogPinchEvent] (val x: Self) extends AnyVal {
