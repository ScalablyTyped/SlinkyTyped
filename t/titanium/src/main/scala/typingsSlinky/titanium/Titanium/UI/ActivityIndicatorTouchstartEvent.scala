...
/**
  ...
  */
@js.native
trait ActivityIndicatorTouchstartEvent extends ActivityIndicatorBaseEvent {
...
object ActivityIndicatorTouchstartEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ActivityIndicatorTouchstartEvent = {
    ...
    __obj.asInstanceOf[ActivityIndicatorTouchstartEvent]
  }
  
  @scala.inline
  implicit class ActivityIndicatorTouchstartEventMutableBuilder[Self <: ActivityIndicatorTouchstartEvent] (val x: Self) extends AnyVal {
