...
/**
  ...
  */
@js.native
trait TextAreaTouchendEvent extends TextAreaBaseEvent {
...
object TextAreaTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextAreaTouchendEvent]
  }
  
  @scala.inline
  implicit class TextAreaTouchendEventMutableBuilder[Self <: TextAreaTouchendEvent] (val x: Self) extends AnyVal {
