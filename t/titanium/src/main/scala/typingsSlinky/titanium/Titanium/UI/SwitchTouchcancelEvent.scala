...
/**
  ...
  */
@js.native
trait SwitchTouchcancelEvent extends SwitchBaseEvent {
...
object SwitchTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SwitchTouchcancelEvent]
  }
  
  @scala.inline
  implicit class SwitchTouchcancelEventMutableBuilder[Self <: SwitchTouchcancelEvent] (val x: Self) extends AnyVal {
