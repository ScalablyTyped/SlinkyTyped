...
/**
  ...
  */
@js.native
trait PopoverTouchendEvent extends PopoverBaseEvent {
...
object PopoverTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PopoverTouchendEvent]
  }
  
  @scala.inline
  implicit class PopoverTouchendEventMutableBuilder[Self <: PopoverTouchendEvent] (val x: Self) extends AnyVal {
