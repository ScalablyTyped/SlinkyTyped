...
/**
  ...
  */
@js.native
trait ImageViewTouchcancelEvent extends ImageViewBaseEvent {
...
object ImageViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ImageViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ImageViewTouchcancelEventMutableBuilder[Self <: ImageViewTouchcancelEvent] (val x: Self) extends AnyVal {
