...
/**
  ...
  */
@js.native
trait TabTouchcancelEvent extends TabBaseEvent {
...
object TabTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabTouchcancelEvent]
  }
  
  @scala.inline
  implicit class TabTouchcancelEventMutableBuilder[Self <: TabTouchcancelEvent] (val x: Self) extends AnyVal {
