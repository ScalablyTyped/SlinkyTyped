...
/**
  ...
  */
@js.native
trait TextFieldTouchmoveEvent extends TextFieldBaseEvent {
...
object TextFieldTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextFieldTouchmoveEvent]
  }
  
  @scala.inline
  implicit class TextFieldTouchmoveEventMutableBuilder[Self <: TextFieldTouchmoveEvent] (val x: Self) extends AnyVal {
