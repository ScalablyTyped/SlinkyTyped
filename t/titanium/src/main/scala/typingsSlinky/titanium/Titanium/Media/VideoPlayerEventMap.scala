...
trait VideoPlayerEventMap extends ProxyEventMap {
  var click: VideoPlayerClickEvent
  var complete: VideoPlayerCompleteEvent
  var dblclick: VideoPlayerDblclickEvent
  var doubletap: VideoPlayerDoubletapEvent
  var durationavailable: VideoPlayerDurationavailableEvent
  var error: VideoPlayerErrorEvent
  var focus: VideoPlayerFocusEvent
  var keypressed: VideoPlayerKeypressedEvent
  var load: VideoPlayerLoadEvent
  var loadstate: VideoPlayerLoadstateEvent
  var longclick: VideoPlayerLongclickEvent
  var longpress: VideoPlayerLongpressEvent
  var naturalsizeavailable: VideoPlayerNaturalsizeavailableEvent
  var pinch: VideoPlayerPinchEvent
  var playbackstate: VideoPlayerPlaybackstateEvent
  var playing: VideoPlayerPlayingEvent
  var postlayout: VideoPlayerPostlayoutEvent
  var preload: VideoPlayerPreloadEvent
  var resize: VideoPlayerResizeEvent
  var singletap: VideoPlayerSingletapEvent
  var swipe: VideoPlayerSwipeEvent
  var touchcancel: VideoPlayerTouchcancelEvent
  var touchend: VideoPlayerTouchendEvent
  var touchmove: VideoPlayerTouchmoveEvent
  var touchstart: VideoPlayerTouchstartEvent
  var twofingertap: VideoPlayerTwofingertapEvent
}
