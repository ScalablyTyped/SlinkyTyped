...
/**
  ...
  */
@js.native
trait ProgressBarTouchmoveEvent extends ProgressBarBaseEvent {
...
object ProgressBarTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProgressBarTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ProgressBarTouchmoveEventMutableBuilder[Self <: ProgressBarTouchmoveEvent] (val x: Self) extends AnyVal {
