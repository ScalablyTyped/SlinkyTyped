...
/**
  ...
  */
@js.native
trait EmailDialogTouchmoveEvent extends EmailDialogBaseEvent {
...
object EmailDialogTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EmailDialogTouchmoveEvent]
  }
  
  @scala.inline
  implicit class EmailDialogTouchmoveEventMutableBuilder[Self <: EmailDialogTouchmoveEvent] (val x: Self) extends AnyVal {
