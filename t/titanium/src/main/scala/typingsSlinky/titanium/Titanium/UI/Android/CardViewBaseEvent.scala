...
trait CardViewBaseEvent extends js.Object {
  /**
...
object CardViewBaseEvent {
  ...
  @scala.inline
  implicit class CardViewBaseEventOps[Self <: CardViewBaseEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSource(value: CardView): Self = this.set("source", value.asInstanceOf[js.Any])
  }
