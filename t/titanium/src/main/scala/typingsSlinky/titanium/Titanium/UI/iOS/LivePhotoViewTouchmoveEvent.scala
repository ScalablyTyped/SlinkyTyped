...
/**
  ...
  */
@js.native
trait LivePhotoViewTouchmoveEvent extends LivePhotoViewBaseEvent {
...
object LivePhotoViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LivePhotoViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class LivePhotoViewTouchmoveEventMutableBuilder[Self <: LivePhotoViewTouchmoveEvent] (val x: Self) extends AnyVal {
