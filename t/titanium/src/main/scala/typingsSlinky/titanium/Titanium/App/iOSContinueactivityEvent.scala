...
object iOSContinueactivityEvent {
  ...
  implicit class iOSContinueactivityEventOps[Self <: iOSContinueactivityEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSearchableItemActivityIdentifier(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("searchableItemActivityIdentifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
