...
/**
  ...
  */
@js.native
trait ScrollViewTouchmoveEvent extends ScrollViewBaseEvent {
...
object ScrollViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScrollViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ScrollViewTouchmoveEventMutableBuilder[Self <: ScrollViewTouchmoveEvent] (val x: Self) extends AnyVal {
