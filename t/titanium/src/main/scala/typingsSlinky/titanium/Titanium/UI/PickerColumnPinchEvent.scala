...
/**
  ...
  */
@js.native
trait PickerColumnPinchEvent extends PickerColumnBaseEvent {
...
object PickerColumnPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerColumnPinchEvent]
  }
  
  @scala.inline
  implicit class PickerColumnPinchEventMutableBuilder[Self <: PickerColumnPinchEvent] (val x: Self) extends AnyVal {
