...
/**
  ...
  */
@js.native
trait SplitWindowTouchmoveEvent extends SplitWindowBaseEvent {
...
object SplitWindowTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SplitWindowTouchmoveEvent]
  }
  
  @scala.inline
  implicit class SplitWindowTouchmoveEventMutableBuilder[Self <: SplitWindowTouchmoveEvent] (val x: Self) extends AnyVal {
