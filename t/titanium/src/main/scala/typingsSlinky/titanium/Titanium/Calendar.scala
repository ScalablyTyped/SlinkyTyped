...
import typingsSlinky.titanium.EventsAuthorizationResponse
...
object Calendar extends js.Object {
  ...
  class Alert () extends Proxy {
    ...
    /**
    			 ...
    			 */
    def getAbsoluteDate(): js.Date = js.native
    /**
    ...
    /**
    			 ...
    			 */
    def setAbsoluteDate(absoluteDate: js.Date): Unit = js.native
    /**
  ...
  class Calendar () extends Proxy {
    ...
    /**
    			 ...
    			 */
    def createEvent(properties: Dictionary[typingsSlinky.titanium.Titanium.Calendar.Event]): typingsSlinky.titanium.Titanium.Calendar.Event = js.native
    /**
    			 * Gets the event with the specified identifier.
    			 */
    def getEventById(id: String): typingsSlinky.titanium.Titanium.Calendar.Event = js.native
    def getEventsBetweenDates(date1: String, date2: String): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
    def getEventsBetweenDates(date1: String, date2: js.Date): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
    def getEventsBetweenDates(date1: js.Date, date2: String): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
    /**
    			 * Gets events that occur between two dates.
    			 */
    def getEventsBetweenDates(date1: js.Date, date2: js.Date): js.Array[typingsSlinky.titanium.Titanium.Calendar.Event] = js.native
    /**
  ...
  class Event () extends Proxy {
    ...
    /**
    			 ...
    			 */
    def setBegin(begin: js.Date): Unit = js.native
    /**
  ...
  /**
  		 ...
  		 */
  val allCalendars: js.Array[typingsSlinky.titanium.Titanium.Calendar.Calendar] = js.native
  /**
  		 * All calendars known to the native calendar app that can add, edit, and
  		 * delete items in the calendar.
  		 */
  val allEditableCalendars: js.Array[typingsSlinky.titanium.Titanium.Calendar.Calendar] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val defaultCalendar: typingsSlinky.titanium.Titanium.Calendar.Calendar = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val selectableCalendars: js.Array[typingsSlinky.titanium.Titanium.Calendar.Calendar] = js.native
  /**
  		 * Adds the specified callback as an event listener for the named event.
  		 */
  def addEventListener(name: String, callback: js.Function1[/* param0 */ typingsSlinky.titanium.Titanium.Event, Unit]): Unit = js.native
  /**
  		 * Adds the specified callback as an event listener for the named event.
  		 */
  ...
  /**
  		 ...
  		 */
  def getAllCalendars(): js.Array[typingsSlinky.titanium.Titanium.Calendar.Calendar] = js.native
  /**
  		 ...
  		 */
  def getAllEditableCalendars(): js.Array[typingsSlinky.titanium.Titanium.Calendar.Calendar] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def getCalendarById(id: String): typingsSlinky.titanium.Titanium.Calendar.Calendar = js.native
  /**
  		 ...
  		 */
  def getDefaultCalendar(): typingsSlinky.titanium.Titanium.Calendar.Calendar = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def getSelectableCalendars(): js.Array[typingsSlinky.titanium.Titanium.Calendar.Calendar] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def removeEventListener(name: String, callback: js.Function1[/* param0 */ typingsSlinky.titanium.Titanium.Event, Unit]): Unit = js.native
  /**
  		 * Removes the specified callback as an event listener for the named event.
  		 */
