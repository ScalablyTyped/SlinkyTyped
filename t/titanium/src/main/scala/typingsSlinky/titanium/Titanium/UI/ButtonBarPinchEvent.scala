...
/**
  ...
  */
@js.native
trait ButtonBarPinchEvent extends ButtonBarBaseEvent {
...
object ButtonBarPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonBarPinchEvent]
  }
  
  @scala.inline
  implicit class ButtonBarPinchEventMutableBuilder[Self <: ButtonBarPinchEvent] (val x: Self) extends AnyVal {
