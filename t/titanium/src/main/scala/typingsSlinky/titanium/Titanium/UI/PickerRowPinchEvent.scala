...
/**
  ...
  */
@js.native
trait PickerRowPinchEvent extends PickerRowBaseEvent {
...
object PickerRowPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerRowPinchEvent]
  }
  
  @scala.inline
  implicit class PickerRowPinchEventMutableBuilder[Self <: PickerRowPinchEvent] (val x: Self) extends AnyVal {
