...
/**
  ...
  */
@js.native
trait AlertDialogPinchEvent extends AlertDialogBaseEvent {
...
object AlertDialogPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AlertDialogPinchEvent]
  }
  
  @scala.inline
  implicit class AlertDialogPinchEventMutableBuilder[Self <: AlertDialogPinchEvent] (val x: Self) extends AnyVal {
