...
import typingsSlinky.titanium.MovieSize
import typingsSlinky.titanium.ThumbnailResponse
...
import typingsSlinky.titanium.titaniumStrings.durationavailable
...
import typingsSlinky.titanium.titaniumStrings.loadstate
import typingsSlinky.titanium.titaniumStrings.longclick
import typingsSlinky.titanium.titaniumStrings.longpress
import typingsSlinky.titanium.titaniumStrings.naturalsizeavailable
import typingsSlinky.titanium.titaniumStrings.pinch
import typingsSlinky.titanium.titaniumStrings.playbackstate
import typingsSlinky.titanium.titaniumStrings.postlayout
import typingsSlinky.titanium.titaniumStrings.preload
import typingsSlinky.titanium.titaniumStrings.resize
...
class VideoPlayer () extends View {
  ...
  def addEventListener_playing(
    name: typingsSlinky.titanium.titaniumStrings.playing,
  ...
  @JSName("fireEvent")
  def fireEvent_playing(name: typingsSlinky.titanium.titaniumStrings.playing): Unit = js.native
  @JSName("fireEvent")
  def fireEvent_playing(name: typingsSlinky.titanium.titaniumStrings.playing, event: VideoPlayerPlayingEvent): Unit = js.native
  @JSName("fireEvent")
