...
/**
  ...
  */
@js.native
trait ListViewTouchcancelEvent extends ListViewBaseEvent {
...
object ListViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ListViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ListViewTouchcancelEventMutableBuilder[Self <: ListViewTouchcancelEvent] (val x: Self) extends AnyVal {
