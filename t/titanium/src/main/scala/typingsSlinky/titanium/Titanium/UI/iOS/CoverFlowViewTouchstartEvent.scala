...
/**
  ...
  */
@js.native
trait CoverFlowViewTouchstartEvent extends CoverFlowViewBaseEvent {
...
object CoverFlowViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CoverFlowViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class CoverFlowViewTouchstartEventMutableBuilder[Self <: CoverFlowViewTouchstartEvent] (val x: Self) extends AnyVal {
