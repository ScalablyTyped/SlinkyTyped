...
/**
  ...
  */
@js.native
trait LivePhotoViewTouchendEvent extends LivePhotoViewBaseEvent {
...
object LivePhotoViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LivePhotoViewTouchendEvent]
  }
  
  @scala.inline
  implicit class LivePhotoViewTouchendEventMutableBuilder[Self <: LivePhotoViewTouchendEvent] (val x: Self) extends AnyVal {
