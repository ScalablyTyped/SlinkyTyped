...
/**
  ...
  */
@js.native
trait TextAreaTouchcancelEvent extends TextAreaBaseEvent {
...
object TextAreaTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextAreaTouchcancelEvent]
  }
  
  @scala.inline
  implicit class TextAreaTouchcancelEventMutableBuilder[Self <: TextAreaTouchcancelEvent] (val x: Self) extends AnyVal {
