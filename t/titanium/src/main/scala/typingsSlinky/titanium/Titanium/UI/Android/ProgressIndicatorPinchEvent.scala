...
/**
  ...
  */
@js.native
trait ProgressIndicatorPinchEvent extends ProgressIndicatorBaseEvent {
...
object ProgressIndicatorPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProgressIndicatorPinchEvent]
  }
  
  @scala.inline
  implicit class ProgressIndicatorPinchEventMutableBuilder[Self <: ProgressIndicatorPinchEvent] (val x: Self) extends AnyVal {
