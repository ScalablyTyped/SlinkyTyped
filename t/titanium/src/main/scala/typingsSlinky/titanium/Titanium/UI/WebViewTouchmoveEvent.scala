...
/**
  ...
  */
@js.native
trait WebViewTouchmoveEvent extends WebViewBaseEvent {
...
object WebViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WebViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class WebViewTouchmoveEventMutableBuilder[Self <: WebViewTouchmoveEvent] (val x: Self) extends AnyVal {
