...
/**
  ...
  */
@js.native
trait BlurViewTouchendEvent extends BlurViewBaseEvent {
...
object BlurViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BlurViewTouchendEvent]
  }
  
  @scala.inline
  implicit class BlurViewTouchendEventMutableBuilder[Self <: BlurViewTouchendEvent] (val x: Self) extends AnyVal {
