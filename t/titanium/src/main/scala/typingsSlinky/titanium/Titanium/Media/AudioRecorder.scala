...
object AudioRecorder {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2(addEventListener), apiName = apiName.asInstanceOf[js.Any], applyProperties = js.Any.fromFunction1(applyProperties), bubbleParent = bubbleParent.asInstanceOf[js.Any], compression = compression.asInstanceOf[js.Any], fireEvent = js.Any.fromFunction2(fireEvent), format = format.asInstanceOf[js.Any], getApiName = js.Any.fromFunction0(getApiName), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getCompression = js.Any.fromFunction0(getCompression), getFormat = js.Any.fromFunction0(getFormat), getPaused = js.Any.fromFunction0(getPaused), getRecording = js.Any.fromFunction0(getRecording), getStopped = js.Any.fromFunction0(getStopped), pause = js.Any.fromFunction0(pause), paused = paused.asInstanceOf[js.Any], recording = recording.asInstanceOf[js.Any], removeEventListener = js.Any.fromFunction2(removeEventListener), resume = js.Any.fromFunction0(resume), setBubbleParent = js.Any.fromFunction1(setBubbleParent), setCompression = js.Any.fromFunction1(setCompression), setFormat = js.Any.fromFunction1(setFormat), start = js.Any.fromFunction0(start), stop = js.Any.fromFunction0(stop), stopped = stopped.asInstanceOf[js.Any])
