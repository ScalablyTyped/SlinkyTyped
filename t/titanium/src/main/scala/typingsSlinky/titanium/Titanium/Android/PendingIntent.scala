...
object PendingIntent {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2(addEventListener), apiName = apiName.asInstanceOf[js.Any], applyProperties = js.Any.fromFunction1(applyProperties), bubbleParent = bubbleParent.asInstanceOf[js.Any], fireEvent = js.Any.fromFunction2(fireEvent), flags = flags.asInstanceOf[js.Any], getApiName = js.Any.fromFunction0(getApiName), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getFlags = js.Any.fromFunction0(getFlags), getIntent = js.Any.fromFunction0(getIntent), getUpdateCurrentIntent = js.Any.fromFunction0(getUpdateCurrentIntent), intent = intent.asInstanceOf[js.Any], removeEventListener = js.Any.fromFunction2(removeEventListener), setBubbleParent = js.Any.fromFunction1(setBubbleParent), setFlags = js.Any.fromFunction1(setFlags), setIntent = js.Any.fromFunction1(setIntent), setUpdateCurrentIntent = js.Any.fromFunction1(setUpdateCurrentIntent), updateCurrentIntent = updateCurrentIntent.asInstanceOf[js.Any])
