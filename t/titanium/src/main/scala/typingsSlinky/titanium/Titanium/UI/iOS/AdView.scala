...
import typingsSlinky.titanium.Titanium.UI.Matrix3D
...
trait AdView extends Proxy {
  ...
  /**
  				 ...
  				 */
  def cancelAction(): Unit = js.native
  /**
  ...
  /**
  				 ...
  				 */
  def getAdSize(): String = js.native
  /**
  ...
  /**
  				 ...
  				 */
  def setAdSize(adSize: String): Unit = js.native
  /**
