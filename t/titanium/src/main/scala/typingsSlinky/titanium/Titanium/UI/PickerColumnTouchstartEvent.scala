...
/**
  ...
  */
@js.native
trait PickerColumnTouchstartEvent extends PickerColumnBaseEvent {
...
object PickerColumnTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerColumnTouchstartEvent]
  }
  
  @scala.inline
  implicit class PickerColumnTouchstartEventMutableBuilder[Self <: PickerColumnTouchstartEvent] (val x: Self) extends AnyVal {
