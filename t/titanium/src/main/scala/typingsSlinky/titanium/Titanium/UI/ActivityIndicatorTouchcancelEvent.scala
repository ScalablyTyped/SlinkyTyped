...
/**
  ...
  */
@js.native
trait ActivityIndicatorTouchcancelEvent extends ActivityIndicatorBaseEvent {
...
object ActivityIndicatorTouchcancelEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ActivityIndicatorTouchcancelEvent = {
    ...
    __obj.asInstanceOf[ActivityIndicatorTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ActivityIndicatorTouchcancelEventMutableBuilder[Self <: ActivityIndicatorTouchcancelEvent] (val x: Self) extends AnyVal {
