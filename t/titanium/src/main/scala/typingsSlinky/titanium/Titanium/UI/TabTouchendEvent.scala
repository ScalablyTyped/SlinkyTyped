...
/**
  ...
  */
@js.native
trait TabTouchendEvent extends TabBaseEvent {
...
object TabTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabTouchendEvent]
  }
  
  @scala.inline
  implicit class TabTouchendEventMutableBuilder[Self <: TabTouchendEvent] (val x: Self) extends AnyVal {
