...
/**
  ...
  */
@js.native
trait MaskedImagePinchEvent extends MaskedImageBaseEvent {
...
object MaskedImagePinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[MaskedImagePinchEvent]
  }
  
  @scala.inline
  implicit class MaskedImagePinchEventMutableBuilder[Self <: MaskedImagePinchEvent] (val x: Self) extends AnyVal {
