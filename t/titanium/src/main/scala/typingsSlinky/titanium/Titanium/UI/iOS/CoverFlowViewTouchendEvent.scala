...
/**
  ...
  */
@js.native
trait CoverFlowViewTouchendEvent extends CoverFlowViewBaseEvent {
...
object CoverFlowViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CoverFlowViewTouchendEvent]
  }
  
  @scala.inline
  implicit class CoverFlowViewTouchendEventMutableBuilder[Self <: CoverFlowViewTouchendEvent] (val x: Self) extends AnyVal {
