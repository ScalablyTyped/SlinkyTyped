...
/**
  ...
  */
@js.native
trait CoverFlowViewTouchmoveEvent extends CoverFlowViewBaseEvent {
...
object CoverFlowViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CoverFlowViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class CoverFlowViewTouchmoveEventMutableBuilder[Self <: CoverFlowViewTouchmoveEvent] (val x: Self) extends AnyVal {
