...
/**
  ...
  */
@js.native
trait ListViewTouchendEvent extends ListViewBaseEvent {
...
object ListViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ListViewTouchendEvent]
  }
  
  @scala.inline
  implicit class ListViewTouchendEventMutableBuilder[Self <: ListViewTouchendEvent] (val x: Self) extends AnyVal {
