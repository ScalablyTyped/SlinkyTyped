...
trait TabGroupEventMap extends ProxyEventMap {
  var androidback: TabGroupAndroidbackEvent
  var androidcamera: TabGroupAndroidcameraEvent
  var androidfocus: TabGroupAndroidfocusEvent
  var androidsearch: TabGroupAndroidsearchEvent
  var androidvoldown: TabGroupAndroidvoldownEvent
  var androidvolup: TabGroupAndroidvolupEvent
  var blur: TabGroupBlurEvent
  var click: TabGroupClickEvent
  var close: TabGroupCloseEvent
  var dblclick: TabGroupDblclickEvent
  var doubletap: TabGroupDoubletapEvent
  var focus: TabGroupFocusEvent
  var keypressed: TabGroupKeypressedEvent
  var longclick: TabGroupLongclickEvent
  var longpress: TabGroupLongpressEvent
  var open: TabGroupOpenEvent
  var pinch: TabGroupPinchEvent
  var postlayout: TabGroupPostlayoutEvent
  var singletap: TabGroupSingletapEvent
  var swipe: TabGroupSwipeEvent
  var touchcancel: TabGroupTouchcancelEvent
  var touchend: TabGroupTouchendEvent
  var touchmove: TabGroupTouchmoveEvent
  var touchstart: TabGroupTouchstartEvent
  var twofingertap: TabGroupTwofingertapEvent
}
