...
/**
  ...
  */
@js.native
trait AlertDialogTouchstartEvent extends AlertDialogBaseEvent {
...
object AlertDialogTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AlertDialogTouchstartEvent]
  }
  
  @scala.inline
  implicit class AlertDialogTouchstartEventMutableBuilder[Self <: AlertDialogTouchstartEvent] (val x: Self) extends AnyVal {
