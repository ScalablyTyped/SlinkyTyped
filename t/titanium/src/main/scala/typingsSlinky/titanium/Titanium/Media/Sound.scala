...
object Sound {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(AUDIO_TYPE_ALARM = AUDIO_TYPE_ALARM.asInstanceOf[js.Any], AUDIO_TYPE_MEDIA = AUDIO_TYPE_MEDIA.asInstanceOf[js.Any], AUDIO_TYPE_NOTIFICATION = AUDIO_TYPE_NOTIFICATION.asInstanceOf[js.Any], AUDIO_TYPE_RING = AUDIO_TYPE_RING.asInstanceOf[js.Any], AUDIO_TYPE_SIGNALLING = AUDIO_TYPE_SIGNALLING.asInstanceOf[js.Any], AUDIO_TYPE_VOICE = AUDIO_TYPE_VOICE.asInstanceOf[js.Any], STATE_BUFFERING = STATE_BUFFERING.asInstanceOf[js.Any], STATE_INITIALIZED = STATE_INITIALIZED.asInstanceOf[js.Any], STATE_PAUSED = STATE_PAUSED.asInstanceOf[js.Any], STATE_PLAYING = STATE_PLAYING.asInstanceOf[js.Any], STATE_STARTING = STATE_STARTING.asInstanceOf[js.Any], STATE_STOPPED = STATE_STOPPED.asInstanceOf[js.Any], STATE_STOPPING = STATE_STOPPING.asInstanceOf[js.Any], STATE_WAITING_FOR_DATA = STATE_WAITING_FOR_DATA.asInstanceOf[js.Any], STATE_WAITING_FOR_QUEUE = STATE_WAITING_FOR_QUEUE.asInstanceOf[js.Any], addEventListener = js.Any.fromFunction2(addEventListener), allowBackground = allowBackground.asInstanceOf[js.Any], apiName = apiName.asInstanceOf[js.Any], applyProperties = js.Any.fromFunction1(applyProperties), audioType = audioType.asInstanceOf[js.Any], bubbleParent = bubbleParent.asInstanceOf[js.Any], duration = duration.asInstanceOf[js.Any], fireEvent = js.Any.fromFunction2(fireEvent), getApiName = js.Any.fromFunction0(getApiName), getAudioType = js.Any.fromFunction0(getAudioType), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getDuration = js.Any.fromFunction0(getDuration), getTime = js.Any.fromFunction0(getTime), getUrl = js.Any.fromFunction0(getUrl), getVolume = js.Any.fromFunction0(getVolume), isLooping = js.Any.fromFunction0(isLooping), isPaused = js.Any.fromFunction0(isPaused), isPlaying = js.Any.fromFunction0(isPlaying), looping = looping.asInstanceOf[js.Any], pause = js.Any.fromFunction0(pause), paused = paused.asInstanceOf[js.Any], play = js.Any.fromFunction0(play), playing = playing.asInstanceOf[js.Any], release = js.Any.fromFunction0(release), removeEventListener = js.Any.fromFunction2(removeEventListener), reset = js.Any.fromFunction0(reset), setAudioType = js.Any.fromFunction1(setAudioType), setBubbleParent = js.Any.fromFunction1(setBubbleParent), setLooping = js.Any.fromFunction1(setLooping), setPaused = js.Any.fromFunction1(setPaused), setTime = js.Any.fromFunction1(setTime), setUrl = js.Any.fromFunction1(setUrl), setVolume = js.Any.fromFunction1(setVolume), stop = js.Any.fromFunction0(stop), time = time.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], volume = volume.asInstanceOf[js.Any])
