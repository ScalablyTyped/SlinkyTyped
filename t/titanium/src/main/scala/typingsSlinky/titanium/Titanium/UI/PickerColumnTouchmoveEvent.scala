...
/**
  ...
  */
@js.native
trait PickerColumnTouchmoveEvent extends PickerColumnBaseEvent {
...
object PickerColumnTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerColumnTouchmoveEvent]
  }
  
  @scala.inline
  implicit class PickerColumnTouchmoveEventMutableBuilder[Self <: PickerColumnTouchmoveEvent] (val x: Self) extends AnyVal {
