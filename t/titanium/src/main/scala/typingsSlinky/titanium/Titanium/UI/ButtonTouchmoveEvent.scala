...
/**
  ...
  */
@js.native
trait ButtonTouchmoveEvent extends ButtonBaseEvent {
...
object ButtonTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ButtonTouchmoveEventMutableBuilder[Self <: ButtonTouchmoveEvent] (val x: Self) extends AnyVal {
