...
/**
  ...
  */
@js.native
trait ToolbarTouchcancelEvent extends ToolbarBaseEvent {
...
object ToolbarTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ToolbarTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ToolbarTouchcancelEventMutableBuilder[Self <: ToolbarTouchcancelEvent] (val x: Self) extends AnyVal {
