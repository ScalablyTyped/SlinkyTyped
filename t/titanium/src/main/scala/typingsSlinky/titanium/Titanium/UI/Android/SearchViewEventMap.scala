...
trait SearchViewEventMap extends ProxyEventMap {
  var blur: SearchViewBlurEvent
  var cancel: SearchViewCancelEvent
  var change: SearchViewChangeEvent
  var click: SearchViewClickEvent
  var dblclick: SearchViewDblclickEvent
  var doubletap: SearchViewDoubletapEvent
  var focus: SearchViewFocusEvent
  var keypressed: SearchViewKeypressedEvent
  var longclick: SearchViewLongclickEvent
  var longpress: SearchViewLongpressEvent
  var pinch: SearchViewPinchEvent
  var postlayout: SearchViewPostlayoutEvent
  var singletap: SearchViewSingletapEvent
  var submit: SearchViewSubmitEvent
  var swipe: SearchViewSwipeEvent
  var touchcancel: SearchViewTouchcancelEvent
  var touchend: SearchViewTouchendEvent
  var touchmove: SearchViewTouchmoveEvent
  var touchstart: SearchViewTouchstartEvent
  var twofingertap: SearchViewTwofingertapEvent
}
