...
/**
  ...
  */
@js.native
trait DrawerLayoutTouchendEvent extends DrawerLayoutBaseEvent {
...
object DrawerLayoutTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DrawerLayoutTouchendEvent]
  }
  
  @scala.inline
  implicit class DrawerLayoutTouchendEventMutableBuilder[Self <: DrawerLayoutTouchendEvent] (val x: Self) extends AnyVal {
