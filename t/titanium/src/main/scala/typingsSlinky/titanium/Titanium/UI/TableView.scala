...
import typingsSlinky.titanium.TableViewAnimationProperties
import typingsSlinky.titanium.TableViewIndexEntry
...
import typingsSlinky.titanium.titaniumStrings.rowsselected
