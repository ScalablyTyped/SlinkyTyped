...
import typingsSlinky.titanium.TextFieldPadding
import typingsSlinky.titanium.textFieldSelectedParams
...
trait TextField extends View {
  ...
  /**
  			 ...
  			 */
  var keyboardToolbar: js.Array[View] | Toolbar | typingsSlinky.titanium.Titanium.UI.iOS.Toolbar = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def getKeyboardToolbar(): js.Array[View] | Toolbar | typingsSlinky.titanium.Titanium.UI.iOS.Toolbar = js.native
  /**
  ...
  def setKeyboardToolbar(keyboardToolbar: typingsSlinky.titanium.Titanium.UI.iOS.Toolbar): Unit = js.native
  /**
