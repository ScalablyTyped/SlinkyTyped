...
trait TextField extends View {
  ...
  /**
  			 ...
  			 */
  var keyboardToolbar: js.Array[View] | typingsSlinky.titanium.Titanium.UI.iOS.Toolbar = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def getKeyboardToolbar(): js.Array[View] | typingsSlinky.titanium.Titanium.UI.iOS.Toolbar = js.native
  /**
