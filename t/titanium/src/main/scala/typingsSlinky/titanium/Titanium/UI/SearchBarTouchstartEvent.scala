...
/**
  ...
  */
@js.native
trait SearchBarTouchstartEvent extends SearchBarBaseEvent {
...
object SearchBarTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchBarTouchstartEvent]
  }
  
  @scala.inline
  implicit class SearchBarTouchstartEventMutableBuilder[Self <: SearchBarTouchstartEvent] (val x: Self) extends AnyVal {
