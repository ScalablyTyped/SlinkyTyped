...
trait Item extends Proxy {
  ...
  /**
    ...
    */
  val dateAdded: js.Date = js.native
  /**
  ...
  /**
    ...
    */
  val lastPlayedDate: js.Date = js.native
  /**
  ...
  /**
    ...
    */
  val releaseDate: js.Date = js.native
  /**
  ...
  /**
    ...
    */
  def getDateAdded(): js.Date = js.native
  /**
  ...
  /**
    ...
    */
  def getLastPlayedDate(): js.Date = js.native
  /**
  ...
  /**
    ...
    */
  def getReleaseDate(): js.Date = js.native
  /**
