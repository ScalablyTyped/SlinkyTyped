...
/**
  ...
  */
@js.native
trait ProgressBarTouchendEvent extends ProgressBarBaseEvent {
...
object ProgressBarTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProgressBarTouchendEvent]
  }
  
  @scala.inline
  implicit class ProgressBarTouchendEventMutableBuilder[Self <: ProgressBarTouchendEvent] (val x: Self) extends AnyVal {
