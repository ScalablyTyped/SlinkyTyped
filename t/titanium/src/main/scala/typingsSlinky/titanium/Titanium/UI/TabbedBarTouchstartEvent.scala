...
/**
  ...
  */
@js.native
trait TabbedBarTouchstartEvent extends TabbedBarBaseEvent {
...
object TabbedBarTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabbedBarTouchstartEvent]
  }
  
  @scala.inline
  implicit class TabbedBarTouchstartEventMutableBuilder[Self <: TabbedBarTouchstartEvent] (val x: Self) extends AnyVal {
