...
/**
  ...
  */
@js.native
trait StepperTouchmoveEvent extends StepperBaseEvent {
...
object StepperTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[StepperTouchmoveEvent]
  }
  
  @scala.inline
  implicit class StepperTouchmoveEventMutableBuilder[Self <: StepperTouchmoveEvent] (val x: Self) extends AnyVal {
