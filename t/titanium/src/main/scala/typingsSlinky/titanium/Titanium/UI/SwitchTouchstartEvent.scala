...
/**
  ...
  */
@js.native
trait SwitchTouchstartEvent extends SwitchBaseEvent {
...
object SwitchTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SwitchTouchstartEvent]
  }
  
  @scala.inline
  implicit class SwitchTouchstartEventMutableBuilder[Self <: SwitchTouchstartEvent] (val x: Self) extends AnyVal {
