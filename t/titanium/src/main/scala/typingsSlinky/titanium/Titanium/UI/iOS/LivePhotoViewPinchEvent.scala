...
/**
  ...
  */
@js.native
trait LivePhotoViewPinchEvent extends LivePhotoViewBaseEvent {
...
object LivePhotoViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LivePhotoViewPinchEvent]
  }
  
  @scala.inline
  implicit class LivePhotoViewPinchEventMutableBuilder[Self <: LivePhotoViewPinchEvent] (val x: Self) extends AnyVal {
