...
/**
  ...
  */
@js.native
trait CardViewTouchendEvent extends CardViewBaseEvent {
...
object CardViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CardViewTouchendEvent]
  }
  
  @scala.inline
  implicit class CardViewTouchendEventMutableBuilder[Self <: CardViewTouchendEvent] (val x: Self) extends AnyVal {
