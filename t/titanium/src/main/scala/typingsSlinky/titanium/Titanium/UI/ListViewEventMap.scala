...
trait ListViewEventMap extends ProxyEventMap {
  var cancelprefetch: ListViewCancelprefetchEvent
  var click: ListViewClickEvent
  var dblclick: ListViewDblclickEvent
  var delete: ListViewDeleteEvent
  var doubletap: ListViewDoubletapEvent
  var dragend: ListViewDragendEvent
  var dragstart: ListViewDragstartEvent
  var editaction: ListViewEditactionEvent
  var focus: ListViewFocusEvent
  var indexclick: ListViewIndexclickEvent
  var insert: ListViewInsertEvent
  var itemclick: ListViewItemclickEvent
  var itemsselected: ListViewItemsselectedEvent
  var keypressed: ListViewKeypressedEvent
  var longclick: ListViewLongclickEvent
  var longpress: ListViewLongpressEvent
  var marker: ListViewMarkerEvent
  var move: ListViewMoveEvent
  var noresults: ListViewNoresultsEvent
  var pinch: ListViewPinchEvent
  var postlayout: ListViewPostlayoutEvent
  var prefetch: ListViewPrefetchEvent
  var pull: ListViewPullEvent
  var pullend: ListViewPullendEvent
  var scrollend: ListViewScrollendEvent
  var scrolling: ListViewScrollingEvent
  var scrollstart: ListViewScrollstartEvent
  var singletap: ListViewSingletapEvent
  var swipe: ListViewSwipeEvent
  var touchcancel: ListViewTouchcancelEvent
  var touchend: ListViewTouchendEvent
  var touchmove: ListViewTouchmoveEvent
  var touchstart: ListViewTouchstartEvent
  var twofingertap: ListViewTwofingertapEvent
}
