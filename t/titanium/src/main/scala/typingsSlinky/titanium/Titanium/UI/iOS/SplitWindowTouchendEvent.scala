...
/**
  ...
  */
@js.native
trait SplitWindowTouchendEvent extends SplitWindowBaseEvent {
...
object SplitWindowTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SplitWindowTouchendEvent]
  }
  
  @scala.inline
  implicit class SplitWindowTouchendEventMutableBuilder[Self <: SplitWindowTouchendEvent] (val x: Self) extends AnyVal {
