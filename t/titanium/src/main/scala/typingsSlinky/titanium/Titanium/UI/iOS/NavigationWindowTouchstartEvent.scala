...
/**
  ...
  */
@js.native
trait NavigationWindowTouchstartEvent extends NavigationWindowBaseEvent {
...
object NavigationWindowTouchstartEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): NavigationWindowTouchstartEvent = {
    ...
    __obj.asInstanceOf[NavigationWindowTouchstartEvent]
  }
  
  @scala.inline
  implicit class NavigationWindowTouchstartEventMutableBuilder[Self <: NavigationWindowTouchstartEvent] (val x: Self) extends AnyVal {
