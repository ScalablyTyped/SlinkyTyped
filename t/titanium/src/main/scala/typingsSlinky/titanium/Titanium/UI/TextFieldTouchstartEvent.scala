...
/**
  ...
  */
@js.native
trait TextFieldTouchstartEvent extends TextFieldBaseEvent {
...
object TextFieldTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextFieldTouchstartEvent]
  }
  
  @scala.inline
  implicit class TextFieldTouchstartEventMutableBuilder[Self <: TextFieldTouchstartEvent] (val x: Self) extends AnyVal {
