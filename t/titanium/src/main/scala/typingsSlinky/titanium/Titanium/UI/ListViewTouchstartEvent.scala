...
/**
  ...
  */
@js.native
trait ListViewTouchstartEvent extends ListViewBaseEvent {
...
object ListViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ListViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class ListViewTouchstartEventMutableBuilder[Self <: ListViewTouchstartEvent] (val x: Self) extends AnyVal {
