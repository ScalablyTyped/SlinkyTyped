...
/**
  ...
  */
@js.native
trait PickerRowTouchendEvent extends PickerRowBaseEvent {
...
object PickerRowTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerRowTouchendEvent]
  }
  
  @scala.inline
  implicit class PickerRowTouchendEventMutableBuilder[Self <: PickerRowTouchendEvent] (val x: Self) extends AnyVal {
