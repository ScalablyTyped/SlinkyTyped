...
/**
  ...
  */
@js.native
trait DashboardViewTouchendEvent extends DashboardViewBaseEvent {
...
object DashboardViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DashboardViewTouchendEvent]
  }
  
  @scala.inline
  implicit class DashboardViewTouchendEventMutableBuilder[Self <: DashboardViewTouchendEvent] (val x: Self) extends AnyVal {
