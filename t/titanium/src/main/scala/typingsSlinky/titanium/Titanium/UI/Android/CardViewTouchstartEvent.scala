...
/**
  ...
  */
@js.native
trait CardViewTouchstartEvent extends CardViewBaseEvent {
...
object CardViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CardViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class CardViewTouchstartEventMutableBuilder[Self <: CardViewTouchstartEvent] (val x: Self) extends AnyVal {
