...
/**
  ...
  */
@js.native
trait PickerColumnTouchcancelEvent extends PickerColumnBaseEvent {
...
object PickerColumnTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerColumnTouchcancelEvent]
  }
  
  @scala.inline
  implicit class PickerColumnTouchcancelEventMutableBuilder[Self <: PickerColumnTouchcancelEvent] (val x: Self) extends AnyVal {
