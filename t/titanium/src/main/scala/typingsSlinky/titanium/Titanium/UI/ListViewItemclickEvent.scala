...
object ListViewItemclickEvent {
  ...
  implicit class ListViewItemclickEventOps[Self <: ListViewItemclickEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAccessoryClicked(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accessoryClicked")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBindId(value: String): Self = {
        val ret = this.duplicate
