...
/**
  ...
  */
@js.native
trait SearchViewTouchstartEvent extends SearchViewBaseEvent {
...
object SearchViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class SearchViewTouchstartEventMutableBuilder[Self <: SearchViewTouchstartEvent] (val x: Self) extends AnyVal {
