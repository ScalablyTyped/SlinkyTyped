...
/**
  ...
  */
@js.native
trait EmailDialogTouchcancelEvent extends EmailDialogBaseEvent {
...
object EmailDialogTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EmailDialogTouchcancelEvent]
  }
  
  @scala.inline
  implicit class EmailDialogTouchcancelEventMutableBuilder[Self <: EmailDialogTouchcancelEvent] (val x: Self) extends AnyVal {
