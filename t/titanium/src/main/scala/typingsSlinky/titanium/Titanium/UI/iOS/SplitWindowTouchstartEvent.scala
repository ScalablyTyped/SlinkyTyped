...
/**
  ...
  */
@js.native
trait SplitWindowTouchstartEvent extends SplitWindowBaseEvent {
...
object SplitWindowTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SplitWindowTouchstartEvent]
  }
  
  @scala.inline
  implicit class SplitWindowTouchstartEventMutableBuilder[Self <: SplitWindowTouchstartEvent] (val x: Self) extends AnyVal {
