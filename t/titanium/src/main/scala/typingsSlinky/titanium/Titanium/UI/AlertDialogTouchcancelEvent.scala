...
/**
  ...
  */
@js.native
trait AlertDialogTouchcancelEvent extends AlertDialogBaseEvent {
...
object AlertDialogTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AlertDialogTouchcancelEvent]
  }
  
  @scala.inline
  implicit class AlertDialogTouchcancelEventMutableBuilder[Self <: AlertDialogTouchcancelEvent] (val x: Self) extends AnyVal {
