...
/**
  ...
  */
@js.native
trait ProgressIndicatorTouchmoveEvent extends ProgressIndicatorBaseEvent {
...
object ProgressIndicatorTouchmoveEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ProgressIndicatorTouchmoveEvent = {
    ...
    __obj.asInstanceOf[ProgressIndicatorTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ProgressIndicatorTouchmoveEventMutableBuilder[Self <: ProgressIndicatorTouchmoveEvent] (val x: Self) extends AnyVal {
