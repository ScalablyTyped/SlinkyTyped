...
/**
  ...
  */
@js.native
trait MaskedImageTouchcancelEvent extends MaskedImageBaseEvent {
...
object MaskedImageTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[MaskedImageTouchcancelEvent]
  }
  
  @scala.inline
  implicit class MaskedImageTouchcancelEventMutableBuilder[Self <: MaskedImageTouchcancelEvent] (val x: Self) extends AnyVal {
