...
/**
  ...
  */
@js.native
trait TabTouchstartEvent extends TabBaseEvent {
...
object TabTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabTouchstartEvent]
  }
  
  @scala.inline
  implicit class TabTouchstartEventMutableBuilder[Self <: TabTouchstartEvent] (val x: Self) extends AnyVal {
