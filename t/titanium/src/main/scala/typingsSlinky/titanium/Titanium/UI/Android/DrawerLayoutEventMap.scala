...
trait DrawerLayoutEventMap extends ProxyEventMap {
  var change: DrawerLayoutChangeEvent
  var click: DrawerLayoutClickEvent
  var close: DrawerLayoutCloseEvent
  var dblclick: DrawerLayoutDblclickEvent
  var doubletap: DrawerLayoutDoubletapEvent
  var focus: DrawerLayoutFocusEvent
  var keypressed: DrawerLayoutKeypressedEvent
  var longclick: DrawerLayoutLongclickEvent
  var longpress: DrawerLayoutLongpressEvent
  var open: DrawerLayoutOpenEvent
  var pinch: DrawerLayoutPinchEvent
  var postlayout: DrawerLayoutPostlayoutEvent
  var singletap: DrawerLayoutSingletapEvent
  var slide: DrawerLayoutSlideEvent
  var swipe: DrawerLayoutSwipeEvent
  var touchcancel: DrawerLayoutTouchcancelEvent
  var touchend: DrawerLayoutTouchendEvent
  var touchmove: DrawerLayoutTouchmoveEvent
  var touchstart: DrawerLayoutTouchstartEvent
  var twofingertap: DrawerLayoutTwofingertapEvent
}
