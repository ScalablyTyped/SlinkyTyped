...
/**
  ...
  */
@js.native
trait SearchBarTouchcancelEvent extends SearchBarBaseEvent {
...
object SearchBarTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchBarTouchcancelEvent]
  }
  
  @scala.inline
  implicit class SearchBarTouchcancelEventMutableBuilder[Self <: SearchBarTouchcancelEvent] (val x: Self) extends AnyVal {
