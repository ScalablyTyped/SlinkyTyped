...
/**
  ...
  */
@js.native
trait ProgressBarTouchstartEvent extends ProgressBarBaseEvent {
...
object ProgressBarTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProgressBarTouchstartEvent]
  }
  
  @scala.inline
  implicit class ProgressBarTouchstartEventMutableBuilder[Self <: ProgressBarTouchstartEvent] (val x: Self) extends AnyVal {
