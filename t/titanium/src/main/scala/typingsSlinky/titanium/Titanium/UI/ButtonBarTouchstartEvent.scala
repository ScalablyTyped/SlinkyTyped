...
/**
  ...
  */
@js.native
trait ButtonBarTouchstartEvent extends ButtonBarBaseEvent {
...
object ButtonBarTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonBarTouchstartEvent]
  }
  
  @scala.inline
  implicit class ButtonBarTouchstartEventMutableBuilder[Self <: ButtonBarTouchstartEvent] (val x: Self) extends AnyVal {
