...
/**
  ...
  */
@js.native
trait TabbedBarTouchmoveEvent extends TabbedBarBaseEvent {
...
object TabbedBarTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabbedBarTouchmoveEvent]
  }
