...
/**
  ...
  */
@js.native
trait EmailDialogTouchendEvent extends EmailDialogBaseEvent {
...
object EmailDialogTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EmailDialogTouchendEvent]
  }
  
  @scala.inline
  implicit class EmailDialogTouchendEventMutableBuilder[Self <: EmailDialogTouchendEvent] (val x: Self) extends AnyVal {
