...
/**
  ...
  */
@js.native
trait MaskedImageTouchmoveEvent extends MaskedImageBaseEvent {
...
object MaskedImageTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[MaskedImageTouchmoveEvent]
  }
  
  @scala.inline
  implicit class MaskedImageTouchmoveEventMutableBuilder[Self <: MaskedImageTouchmoveEvent] (val x: Self) extends AnyVal {
