...
/**
  ...
  */
@js.native
trait SearchBarPinchEvent extends SearchBarBaseEvent {
...
object SearchBarPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchBarPinchEvent]
  }
  
  @scala.inline
  implicit class SearchBarPinchEventMutableBuilder[Self <: SearchBarPinchEvent] (val x: Self) extends AnyVal {
