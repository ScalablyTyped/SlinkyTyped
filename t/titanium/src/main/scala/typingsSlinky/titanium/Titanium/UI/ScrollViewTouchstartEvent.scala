...
/**
  ...
  */
@js.native
trait ScrollViewTouchstartEvent extends ScrollViewBaseEvent {
...
object ScrollViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScrollViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class ScrollViewTouchstartEventMutableBuilder[Self <: ScrollViewTouchstartEvent] (val x: Self) extends AnyVal {
