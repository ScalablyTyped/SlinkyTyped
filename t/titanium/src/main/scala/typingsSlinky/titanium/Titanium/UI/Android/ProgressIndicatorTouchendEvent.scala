...
/**
  ...
  */
@js.native
trait ProgressIndicatorTouchendEvent extends ProgressIndicatorBaseEvent {
...
object ProgressIndicatorTouchendEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ProgressIndicatorTouchendEvent = {
    ...
    __obj.asInstanceOf[ProgressIndicatorTouchendEvent]
  }
  
  @scala.inline
  implicit class ProgressIndicatorTouchendEventMutableBuilder[Self <: ProgressIndicatorTouchendEvent] (val x: Self) extends AnyVal {
