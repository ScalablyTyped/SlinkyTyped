...
/**
  ...
  */
@js.native
trait MaskedImageTouchstartEvent extends MaskedImageBaseEvent {
...
object MaskedImageTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[MaskedImageTouchstartEvent]
  }
  
  @scala.inline
  implicit class MaskedImageTouchstartEventMutableBuilder[Self <: MaskedImageTouchstartEvent] (val x: Self) extends AnyVal {
