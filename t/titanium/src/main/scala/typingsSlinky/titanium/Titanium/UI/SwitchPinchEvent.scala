...
/**
  ...
  */
@js.native
trait SwitchPinchEvent extends SwitchBaseEvent {
...
object SwitchPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SwitchPinchEvent]
  }
  
  @scala.inline
  implicit class SwitchPinchEventMutableBuilder[Self <: SwitchPinchEvent] (val x: Self) extends AnyVal {
