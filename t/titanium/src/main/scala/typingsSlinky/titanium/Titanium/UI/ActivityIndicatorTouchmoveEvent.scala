...
/**
  ...
  */
@js.native
trait ActivityIndicatorTouchmoveEvent extends ActivityIndicatorBaseEvent {
...
object ActivityIndicatorTouchmoveEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ActivityIndicatorTouchmoveEvent = {
    ...
    __obj.asInstanceOf[ActivityIndicatorTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ActivityIndicatorTouchmoveEventMutableBuilder[Self <: ActivityIndicatorTouchmoveEvent] (val x: Self) extends AnyVal {
