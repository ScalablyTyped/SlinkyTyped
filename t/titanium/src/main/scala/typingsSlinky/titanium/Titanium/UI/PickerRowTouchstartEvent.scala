...
/**
  ...
  */
@js.native
trait PickerRowTouchstartEvent extends PickerRowBaseEvent {
...
object PickerRowTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerRowTouchstartEvent]
  }
  
  @scala.inline
  implicit class PickerRowTouchstartEventMutableBuilder[Self <: PickerRowTouchstartEvent] (val x: Self) extends AnyVal {
