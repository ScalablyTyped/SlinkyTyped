...
/**
  ...
  */
@js.native
trait SliderTouchcancelEvent extends SliderBaseEvent {
...
object SliderTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SliderTouchcancelEvent]
  }
  
  @scala.inline
  implicit class SliderTouchcancelEventMutableBuilder[Self <: SliderTouchcancelEvent] (val x: Self) extends AnyVal {
