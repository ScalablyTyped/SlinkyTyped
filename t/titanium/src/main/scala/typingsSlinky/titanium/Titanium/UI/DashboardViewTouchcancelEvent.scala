...
/**
  ...
  */
@js.native
trait DashboardViewTouchcancelEvent extends DashboardViewBaseEvent {
...
object DashboardViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DashboardViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class DashboardViewTouchcancelEventMutableBuilder[Self <: DashboardViewTouchcancelEvent] (val x: Self) extends AnyVal {
