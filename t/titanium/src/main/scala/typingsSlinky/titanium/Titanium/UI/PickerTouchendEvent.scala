...
/**
  ...
  */
@js.native
trait PickerTouchendEvent extends PickerBaseEvent {
...
object PickerTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerTouchendEvent]
  }
  
  @scala.inline
  implicit class PickerTouchendEventMutableBuilder[Self <: PickerTouchendEvent] (val x: Self) extends AnyVal {
