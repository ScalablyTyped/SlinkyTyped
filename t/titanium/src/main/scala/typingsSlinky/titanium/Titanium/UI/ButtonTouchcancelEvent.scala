...
/**
  ...
  */
@js.native
trait ButtonTouchcancelEvent extends ButtonBaseEvent {
...
object ButtonTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ButtonTouchcancelEventMutableBuilder[Self <: ButtonTouchcancelEvent] (val x: Self) extends AnyVal {
