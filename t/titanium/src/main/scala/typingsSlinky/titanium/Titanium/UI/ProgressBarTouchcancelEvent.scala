...
/**
  ...
  */
@js.native
trait ProgressBarTouchcancelEvent extends ProgressBarBaseEvent {
...
object ProgressBarTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProgressBarTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ProgressBarTouchcancelEventMutableBuilder[Self <: ProgressBarTouchcancelEvent] (val x: Self) extends AnyVal {
