...
/**
  ...
  */
@js.native
trait TabGroupTouchcancelEvent extends TabGroupBaseEvent {
...
object TabGroupTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabGroupTouchcancelEvent]
  }
  
  @scala.inline
  implicit class TabGroupTouchcancelEventMutableBuilder[Self <: TabGroupTouchcancelEvent] (val x: Self) extends AnyVal {
