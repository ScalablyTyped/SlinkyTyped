...
trait LabelEventMap extends ProxyEventMap {
  var click: LabelClickEvent
  var dblclick: LabelDblclickEvent
  var doubletap: LabelDoubletapEvent
  var focus: LabelFocusEvent
  var keypressed: LabelKeypressedEvent
  var link: LabelLinkEvent
  var longclick: LabelLongclickEvent
  var longpress: LabelLongpressEvent
  var pinch: LabelPinchEvent
  var postlayout: LabelPostlayoutEvent
  var singletap: LabelSingletapEvent
  var swipe: LabelSwipeEvent
  var touchcancel: LabelTouchcancelEvent
  var touchend: LabelTouchendEvent
  var touchmove: LabelTouchmoveEvent
  var touchstart: LabelTouchstartEvent
  var twofingertap: LabelTwofingertapEvent
}
