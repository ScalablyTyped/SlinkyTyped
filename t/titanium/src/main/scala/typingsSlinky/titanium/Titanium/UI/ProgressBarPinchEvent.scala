...
/**
  ...
  */
@js.native
trait ProgressBarPinchEvent extends ProgressBarBaseEvent {
...
object ProgressBarPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProgressBarPinchEvent]
  }
  
  @scala.inline
  implicit class ProgressBarPinchEventMutableBuilder[Self <: ProgressBarPinchEvent] (val x: Self) extends AnyVal {
