...
/**
  ...
  */
@js.native
trait VideoPlayerTouchstartEvent extends VideoPlayerBaseEvent {
...
object VideoPlayerTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[VideoPlayerTouchstartEvent]
  }
  
  @scala.inline
  implicit class VideoPlayerTouchstartEventMutableBuilder[Self <: VideoPlayerTouchstartEvent] (val x: Self) extends AnyVal {
