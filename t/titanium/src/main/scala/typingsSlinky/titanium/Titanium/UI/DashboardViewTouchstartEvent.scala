...
/**
  ...
  */
@js.native
trait DashboardViewTouchstartEvent extends DashboardViewBaseEvent {
...
object DashboardViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DashboardViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class DashboardViewTouchstartEventMutableBuilder[Self <: DashboardViewTouchstartEvent] (val x: Self) extends AnyVal {
