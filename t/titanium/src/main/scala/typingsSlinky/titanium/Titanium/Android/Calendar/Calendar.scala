...
trait Calendar extends Proxy {
  ...
  /**
  				 ...
  				 */
  def createEvent(properties: js.Any): typingsSlinky.titanium.Titanium.Android.Calendar.Event
  /**
  				 * Gets the event with the specified identifier.
  				 */
  def getEventById(id: Double): typingsSlinky.titanium.Titanium.Android.Calendar.Event
  /**
  				 * Gets events that occur between two dates.
  				 */
  def getEventsBetweenDates(date1: js.Date, date2: js.Date): js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event]
  /**
  				 * Gets events that occur on a specified date.
  				 */
  def getEventsInDate(year: Double, month: Double, day: Double): js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event]
  /**
  				 * Gets events that occur during a specified month.
  				 */
  def getEventsInMonth(year: Double, month: Double): js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event]
  /**
  				 * Gets all events that occur during a specified year.
  				 */
  def getEventsInYear(year: Double): js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event]
  /**
...
object Calendar {
  ...
  def apply(
    ...
    createEvent: js.Any => typingsSlinky.titanium.Titanium.Android.Calendar.Event,
    fireEvent: (String, js.Any) => Unit,
    getApiName: () => String,
    getBubbleParent: () => Boolean,
    getEventById: Double => typingsSlinky.titanium.Titanium.Android.Calendar.Event,
    getEventsBetweenDates: (js.Date, js.Date) => js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event],
    getEventsInDate: (Double, Double, Double) => js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event],
    getEventsInMonth: (Double, Double) => js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event],
    getEventsInYear: Double => js.Array[typingsSlinky.titanium.Titanium.Android.Calendar.Event],
    getHidden: () => Boolean,
    getId: () => String,
    getName: () => String,
    getSelected: () => Boolean,
