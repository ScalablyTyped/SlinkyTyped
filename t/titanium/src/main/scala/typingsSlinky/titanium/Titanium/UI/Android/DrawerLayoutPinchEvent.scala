...
/**
  ...
  */
@js.native
trait DrawerLayoutPinchEvent extends DrawerLayoutBaseEvent {
...
object DrawerLayoutPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DrawerLayoutPinchEvent]
  }
  
  @scala.inline
  implicit class DrawerLayoutPinchEventMutableBuilder[Self <: DrawerLayoutPinchEvent] (val x: Self) extends AnyVal {
