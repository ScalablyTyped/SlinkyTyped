...
/**
  ...
  */
@js.native
trait MaskedImageTouchendEvent extends MaskedImageBaseEvent {
...
object MaskedImageTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[MaskedImageTouchendEvent]
  }
  
  @scala.inline
  implicit class MaskedImageTouchendEventMutableBuilder[Self <: MaskedImageTouchendEvent] (val x: Self) extends AnyVal {
