...
/**
  ...
  */
@js.native
trait TextAreaPinchEvent extends TextAreaBaseEvent {
...
object TextAreaPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextAreaPinchEvent]
  }
  
  @scala.inline
  implicit class TextAreaPinchEventMutableBuilder[Self <: TextAreaPinchEvent] (val x: Self) extends AnyVal {
