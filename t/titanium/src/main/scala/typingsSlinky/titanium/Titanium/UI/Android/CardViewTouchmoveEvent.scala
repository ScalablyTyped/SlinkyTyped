...
/**
  ...
  */
@js.native
trait CardViewTouchmoveEvent extends CardViewBaseEvent {
...
object CardViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CardViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class CardViewTouchmoveEventMutableBuilder[Self <: CardViewTouchmoveEvent] (val x: Self) extends AnyVal {
