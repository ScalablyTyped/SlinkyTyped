...
import typingsSlinky.titanium.titleAttributesParams
...
trait NavigationWindow extends Proxy {
  ...
  /**
  				 ...
  				 */
  val navigationWindow: typingsSlinky.titanium.Titanium.UI.NavigationWindow = js.native
  /**
  ...
  /**
  				 ...
  				 */
  def getNavigationWindow(): typingsSlinky.titanium.Titanium.UI.NavigationWindow = js.native
  /**
