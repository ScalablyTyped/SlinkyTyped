...
/**
  ...
  */
@js.native
trait SwitchTouchmoveEvent extends SwitchBaseEvent {
...
object SwitchTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SwitchTouchmoveEvent]
  }
  
  @scala.inline
  implicit class SwitchTouchmoveEventMutableBuilder[Self <: SwitchTouchmoveEvent] (val x: Self) extends AnyVal {
