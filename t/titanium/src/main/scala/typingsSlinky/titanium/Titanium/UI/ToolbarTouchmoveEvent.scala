...
/**
  ...
  */
@js.native
trait ToolbarTouchmoveEvent extends ToolbarBaseEvent {
...
object ToolbarTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ToolbarTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ToolbarTouchmoveEventMutableBuilder[Self <: ToolbarTouchmoveEvent] (val x: Self) extends AnyVal {
