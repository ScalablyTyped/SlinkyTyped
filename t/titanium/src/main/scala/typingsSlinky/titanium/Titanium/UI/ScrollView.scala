...
import typingsSlinky.titanium.titaniumStrings.dragEnd
import typingsSlinky.titanium.titaniumStrings.dragStart
...
import typingsSlinky.titanium.titaniumStrings.scale
