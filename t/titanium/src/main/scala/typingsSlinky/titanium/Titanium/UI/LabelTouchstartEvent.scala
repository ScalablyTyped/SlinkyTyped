...
/**
  ...
  */
@js.native
trait LabelTouchstartEvent extends LabelBaseEvent {
...
object LabelTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LabelTouchstartEvent]
  }
  
  @scala.inline
  implicit class LabelTouchstartEventMutableBuilder[Self <: LabelTouchstartEvent] (val x: Self) extends AnyVal {
