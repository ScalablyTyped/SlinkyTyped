...
/**
  ...
  */
@js.native
trait SearchViewTouchcancelEvent extends SearchViewBaseEvent {
...
object SearchViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class SearchViewTouchcancelEventMutableBuilder[Self <: SearchViewTouchcancelEvent] (val x: Self) extends AnyVal {
