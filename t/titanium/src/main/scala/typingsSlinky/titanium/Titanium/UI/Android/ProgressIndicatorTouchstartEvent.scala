...
/**
  ...
  */
@js.native
trait ProgressIndicatorTouchstartEvent extends ProgressIndicatorBaseEvent {
...
object ProgressIndicatorTouchstartEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ProgressIndicatorTouchstartEvent = {
    ...
    __obj.asInstanceOf[ProgressIndicatorTouchstartEvent]
  }
  
  @scala.inline
  implicit class ProgressIndicatorTouchstartEventMutableBuilder[Self <: ProgressIndicatorTouchstartEvent] (val x: Self) extends AnyVal {
