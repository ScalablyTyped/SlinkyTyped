...
/**
  ...
  */
@js.native
trait TabbedBarPinchEvent extends TabbedBarBaseEvent {
...
object TabbedBarPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabbedBarPinchEvent]
  }
  
  @scala.inline
  implicit class TabbedBarPinchEventMutableBuilder[Self <: TabbedBarPinchEvent] (val x: Self) extends AnyVal {
