...
trait WindowEventMap extends ProxyEventMap {
  var androidback: WindowAndroidbackEvent
  var androidcamera: WindowAndroidcameraEvent
  var androidfocus: WindowAndroidfocusEvent
  var androidsearch: WindowAndroidsearchEvent
  var androidvoldown: WindowAndroidvoldownEvent
  var androidvolup: WindowAndroidvolupEvent
  var blur: WindowBlurEvent
  var click: WindowClickEvent
  var close: WindowCloseEvent
  var dblclick: WindowDblclickEvent
  var doubletap: WindowDoubletapEvent
  var focus: WindowFocusEvent
  var keypressed: WindowKeypressedEvent
  var longclick: WindowLongclickEvent
  var longpress: WindowLongpressEvent
  var open: WindowOpenEvent
  var pinch: WindowPinchEvent
  var postlayout: WindowPostlayoutEvent
  var singletap: WindowSingletapEvent
  var swipe: WindowSwipeEvent
  var touchcancel: WindowTouchcancelEvent
  var touchend: WindowTouchendEvent
  var touchmove: WindowTouchmoveEvent
  var touchstart: WindowTouchstartEvent
  var twofingertap: WindowTwofingertapEvent
}
