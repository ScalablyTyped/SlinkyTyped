...
/**
  ...
  */
@js.native
trait NavigationWindowTouchmoveEvent extends NavigationWindowBaseEvent {
...
object NavigationWindowTouchmoveEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): NavigationWindowTouchmoveEvent = {
    ...
    __obj.asInstanceOf[NavigationWindowTouchmoveEvent]
  }
  
  @scala.inline
  implicit class NavigationWindowTouchmoveEventMutableBuilder[Self <: NavigationWindowTouchmoveEvent] (val x: Self) extends AnyVal {
