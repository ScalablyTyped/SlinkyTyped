...
/**
  ...
  */
@js.native
trait ScrollableViewTouchendEvent extends ScrollableViewBaseEvent {
...
object ScrollableViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScrollableViewTouchendEvent]
  }
  
  @scala.inline
  implicit class ScrollableViewTouchendEventMutableBuilder[Self <: ScrollableViewTouchendEvent] (val x: Self) extends AnyVal {
