...
/**
  ...
  */
@js.native
trait WindowTouchendEvent extends WindowBaseEvent {
...
object WindowTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WindowTouchendEvent]
  }
  
  @scala.inline
  implicit class WindowTouchendEventMutableBuilder[Self <: WindowTouchendEvent] (val x: Self) extends AnyVal {
