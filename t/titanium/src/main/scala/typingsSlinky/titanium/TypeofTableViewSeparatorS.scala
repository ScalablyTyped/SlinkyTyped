...
trait TypeofTableViewSeparatorS extends js.Object {
  /**
...
object TypeofTableViewSeparatorS {
  @scala.inline
  def apply(
    NONE: Double,
    SINGLE_LINE: Double,
    ...
    __obj.asInstanceOf[TypeofTableViewSeparatorS]
  }
}
