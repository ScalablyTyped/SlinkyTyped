...
import typingsSlinky.titanium.Titanium.Geolocation.Android.LocationProvider
import typingsSlinky.titanium.Titanium.Geolocation.Android.LocationRule
...
@js.native
trait TypeofAndroidAddLocationProvider extends js.Object {
  /**
