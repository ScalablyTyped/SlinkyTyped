...
object App {
  ...
  object Android {
    ...
    def addEventListener_shortcutitemclick(
      ...
      callback: js.ThisFunction1[
          /* this */ typingsSlinky.titanium.Titanium.App.Android, 
  ...
  object Properties {
    ...
    def addEventListener_change(
      name: change,
      callback: js.ThisFunction1[
          /* this */ typingsSlinky.titanium.Titanium.App.Properties, 
  ...
  def addEventListener_accessibilitychanged(
    ...
    callback: js.ThisFunction1[
      /* this */ typingsSlinky.titanium.Titanium.App, 
  ...
  def addEventListener_close(
    name: close,
    callback: js.ThisFunction1[/* this */ typingsSlinky.titanium.Titanium.App, /* event */ AppCloseEvent, Unit]
  ): Unit = js.native
  @JSGlobal("Titanium.App.addEventListener")
  @js.native
  ...
  def addEventListener_pause(
    name: pause,
    callback: js.ThisFunction1[/* this */ typingsSlinky.titanium.Titanium.App, /* event */ AppPauseEvent, Unit]
  ): Unit = js.native
  @JSGlobal("Titanium.App.addEventListener")
  @js.native
  def addEventListener_paused(
    name: paused,
    callback: js.ThisFunction1[/* this */ typingsSlinky.titanium.Titanium.App, /* event */ AppPausedEvent, Unit]
  ): Unit = js.native
  @JSGlobal("Titanium.App.addEventListener")
  @js.native
  def addEventListener_proximity(
    name: proximity,
    callback: js.ThisFunction1[/* this */ typingsSlinky.titanium.Titanium.App, /* event */ AppProximityEvent, Unit]
  ): Unit = js.native
  @JSGlobal("Titanium.App.addEventListener")
  @js.native
  def addEventListener_resume(
    name: resume,
    callback: js.ThisFunction1[/* this */ typingsSlinky.titanium.Titanium.App, /* event */ AppResumeEvent, Unit]
  ): Unit = js.native
  @JSGlobal("Titanium.App.addEventListener")
  @js.native
  def addEventListener_resumed(
    name: resumed,
    callback: js.ThisFunction1[/* this */ typingsSlinky.titanium.Titanium.App, /* event */ AppResumedEvent, Unit]
  ): Unit = js.native
  @JSGlobal("Titanium.App.addEventListener")
  @js.native
  def addEventListener_shortcutitemclick(
  ...
  def addEventListener_started(
    name: started,
    callback: js.ThisFunction1[/* this */ typingsSlinky.titanium.Titanium.App, /* event */ AppStartedEvent, Unit]
  ): Unit = js.native
  @JSGlobal("Titanium.App.addEventListener")
  @js.native
  ...
  object iOS {
    ...
    def addEventListener_backgroundfetch(
      ...
      callback: js.ThisFunction1[
          /* this */ typingsSlinky.titanium.Titanium.App.iOS, 
