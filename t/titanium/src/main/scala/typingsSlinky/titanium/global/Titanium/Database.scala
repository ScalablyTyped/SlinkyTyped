...
object Database extends js.Object {
  ...
  @js.native
  class DB ()
    extends typingsSlinky.titanium.Titanium.Database.DB
  ...
  @js.native
  class ResultSet ()
    extends typingsSlinky.titanium.Titanium.Database.ResultSet
  ...
  /**
  		 ...
  		 */
  def install(path: String, dbName: String): typingsSlinky.titanium.Titanium.Database.DB = js.native
  /**
  		 * Opens an SQLite database.
  		 */
  def open(dbName: String): typingsSlinky.titanium.Titanium.Database.DB = js.native
  /**
