...
import typingsSlinky.titanium.Titanium.GestureOrientationchangeEvent
import typingsSlinky.titanium.Titanium.GestureShakeEvent
import typingsSlinky.titanium.Titanium.UI.TabGroup
import typingsSlinky.titanium.Titanium.UI.Window
import typingsSlinky.titanium.titaniumStrings.orientationchange
import typingsSlinky.titanium.titaniumStrings.shake
...
object Gesture {
  ...
  def addEventListener_orientationchange(
    ...
    callback: js.ThisFunction1[
      /* this */ typingsSlinky.titanium.Titanium.Gesture, 
