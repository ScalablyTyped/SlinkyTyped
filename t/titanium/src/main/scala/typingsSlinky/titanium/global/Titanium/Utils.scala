...
object Utils extends js.Object {
  ...
  /**
    ...
    */
  def base64decode(obj: String): typingsSlinky.titanium.Titanium.Blob = js.native
  def base64decode(obj: typingsSlinky.titanium.Titanium.Blob): typingsSlinky.titanium.Titanium.Blob = js.native
  def base64decode(obj: File): typingsSlinky.titanium.Titanium.Blob = js.native
  
  /**
    * Returns the specified data encoded to Base64.
    */
  def base64encode(obj: String): typingsSlinky.titanium.Titanium.Blob = js.native
  def base64encode(obj: typingsSlinky.titanium.Titanium.Blob): typingsSlinky.titanium.Titanium.Blob = js.native
  def base64encode(obj: File): typingsSlinky.titanium.Titanium.Blob = js.native
  ...
  def md5HexDigest(obj: typingsSlinky.titanium.Titanium.Blob): String = js.native
  ...
  def sha1(obj: typingsSlinky.titanium.Titanium.Blob): String = js.native
  
  /**
    * Returns a SHA-256 hash of the specified data as a hex-based String.
    */
  def sha256(obj: String): String = js.native
  def sha256(obj: typingsSlinky.titanium.Titanium.Blob): String = js.native
}
