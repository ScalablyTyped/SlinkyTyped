...
import typingsSlinky.titanium.Titanium.AccelerometerUpdateEvent
...
import typingsSlinky.titanium.titaniumStrings.update
...
object Accelerometer {
  ...
  def addEventListener_update(
    ...
    callback: js.ThisFunction1[
      /* this */ typingsSlinky.titanium.Titanium.Accelerometer, 
