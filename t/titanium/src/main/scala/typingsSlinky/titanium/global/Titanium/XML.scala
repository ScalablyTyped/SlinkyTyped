...
object XML extends js.Object {
  ...
  @js.native
  class Attr ()
    extends typingsSlinky.titanium.Titanium.XML.Attr
  ...
  @js.native
  class CDATASection ()
    extends typingsSlinky.titanium.Titanium.XML.CDATASection
  ...
  @js.native
  class CharacterData ()
    extends typingsSlinky.titanium.Titanium.XML.CharacterData
  ...
  @js.native
  class Comment ()
    extends typingsSlinky.titanium.Titanium.XML.Comment
  ...
  class DOMImplementation ()
    extends typingsSlinky.titanium.Titanium.XML.DOMImplementation
  ...
  @js.native
  class Document ()
    extends typingsSlinky.titanium.Titanium.XML.Document
  ...
  class DocumentFragment ()
    extends typingsSlinky.titanium.Titanium.XML.DocumentFragment
  ...
  @js.native
  class DocumentType ()
    extends typingsSlinky.titanium.Titanium.XML.DocumentType
  ...
  @js.native
  class Element ()
    extends typingsSlinky.titanium.Titanium.XML.Element
  ...
  @js.native
  class Entity ()
    extends typingsSlinky.titanium.Titanium.XML.Entity
  ...
  class EntityReference ()
    extends typingsSlinky.titanium.Titanium.XML.EntityReference
  ...
  @js.native
  class NamedNodeMap ()
    extends typingsSlinky.titanium.Titanium.XML.NamedNodeMap
  ...
  @js.native
  class Node ()
    extends typingsSlinky.titanium.Titanium.XML.Node
  ...
  @js.native
  class NodeList ()
    extends typingsSlinky.titanium.Titanium.XML.NodeList
  ...
  @js.native
  class Notation ()
    extends typingsSlinky.titanium.Titanium.XML.Notation
  ...
  class ProcessingInstruction ()
    extends typingsSlinky.titanium.Titanium.XML.ProcessingInstruction
  ...
  @js.native
  class Text ()
    extends typingsSlinky.titanium.Titanium.XML.Text
  ...
  /**
  		 ...
  		 */
  def parseString(xml: String): typingsSlinky.titanium.Titanium.XML.Document = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def serializeToString(node: typingsSlinky.titanium.Titanium.XML.Node): String = js.native
  /**
