...
package object global {
  ...
  /**
    ...
    */
  @scala.inline
  def console: typingsSlinky.titanium.mod.global.Console_ = js.Dynamic.global.selectDynamic("console").asInstanceOf[typingsSlinky.titanium.mod.global.Console_]
  @scala.inline
  def console_=(x: typingsSlinky.titanium.mod.global.Console_): scala.Unit = js.Dynamic.global.updateDynamic("console")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def global: typingsSlinky.titanium.Titanium.Global = js.Dynamic.global.selectDynamic("global").asInstanceOf[typingsSlinky.titanium.Titanium.Global]
  @scala.inline
  def global_=(x: typingsSlinky.titanium.Titanium.Global): scala.Unit = js.Dynamic.global.updateDynamic("global")(x.asInstanceOf[js.Any])
