...
object iPad extends js.Object {
  ...
  /**
    ...
    */
  def createPopover(): typingsSlinky.titanium.Titanium.UI.iPad.Popover = js.native
  def createPopover(parameters: Dictionary[typingsSlinky.titanium.Titanium.UI.iPad.Popover]): typingsSlinky.titanium.Titanium.UI.iPad.Popover = js.native
  ...
  @js.native
  class Popover ()
    extends typingsSlinky.titanium.Titanium.UI.iPad.Popover
}
