...
import typingsSlinky.titanium.Titanium.GeolocationAuthorizationEvent
import typingsSlinky.titanium.Titanium.GeolocationCalibrationEvent
import typingsSlinky.titanium.Titanium.GeolocationHeadingEvent
import typingsSlinky.titanium.Titanium.GeolocationLocationEvent
import typingsSlinky.titanium.Titanium.GeolocationLocationupdatepausedEvent
import typingsSlinky.titanium.Titanium.GeolocationLocationupdateresumedEvent
import typingsSlinky.titanium.Titanium.UI.TabGroup
import typingsSlinky.titanium.Titanium.UI.Window
import typingsSlinky.titanium.titaniumStrings.authorization
import typingsSlinky.titanium.titaniumStrings.calibration
import typingsSlinky.titanium.titaniumStrings.heading
import typingsSlinky.titanium.titaniumStrings.location
import typingsSlinky.titanium.titaniumStrings.locationupdatepaused
import typingsSlinky.titanium.titaniumStrings.locationupdateresumed
...
object Geolocation {
  ...
  object Android {
    ...
    class LocationProvider ()
      extends typingsSlinky.titanium.Titanium.Geolocation.Android.LocationProvider
    ...
    @js.native
    class LocationRule ()
      extends typingsSlinky.titanium.Titanium.Geolocation.Android.LocationRule
    ...
    @js.native
    def addLocationProvider(provider: typingsSlinky.titanium.Titanium.Geolocation.Android.LocationProvider): Unit = js.native
    ...
    @js.native
    def addLocationRule(rule: typingsSlinky.titanium.Titanium.Geolocation.Android.LocationRule): Unit = js.native
    ...
    @js.native
    def createLocationProvider(): typingsSlinky.titanium.Titanium.Geolocation.Android.LocationProvider = js.native
    @JSGlobal("Titanium.Geolocation.Android.createLocationProvider")
    @js.native
    def createLocationProvider(parameters: Dictionary[typingsSlinky.titanium.Titanium.Geolocation.Android.LocationProvider]): typingsSlinky.titanium.Titanium.Geolocation.Android.LocationProvider = js.native
    ...
    @js.native
    def createLocationRule(): typingsSlinky.titanium.Titanium.Geolocation.Android.LocationRule = js.native
    @JSGlobal("Titanium.Geolocation.Android.createLocationRule")
    @js.native
    def createLocationRule(parameters: Dictionary[typingsSlinky.titanium.Titanium.Geolocation.Android.LocationRule]): typingsSlinky.titanium.Titanium.Geolocation.Android.LocationRule = js.native
    ...
    @js.native
    def removeLocationProvider(provider: typingsSlinky.titanium.Titanium.Geolocation.Android.LocationProvider): Unit = js.native
    ...
    @js.native
    def removeLocationRule(rule: typingsSlinky.titanium.Titanium.Geolocation.Android.LocationRule): Unit = js.native
  ...
  def addEventListener_authorization(
    ...
    callback: js.ThisFunction1[
      /* this */ typingsSlinky.titanium.Titanium.Geolocation, 
