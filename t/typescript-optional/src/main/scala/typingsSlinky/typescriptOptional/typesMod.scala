...
object typesMod {
  ...
  */
  ...
  object Option {
    ...
    @scala.inline
    def Empty[T](kind: empty): typingsSlinky.typescriptOptional.typesMod.Empty[T] = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.typescriptOptional.typesMod.Empty[T]]
    }
    
    @scala.inline
    def Present[T](kind: present, value: T): typingsSlinky.typescriptOptional.typesMod.Present[T] = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.typescriptOptional.typesMod.Present[T]]
    }
  }
