...
import typingsSlinky.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeNumbers.`1`
import typingsSlinky.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeNumbers.`2`
...
object webgl extends js.Object {
  @js.native
  class GPGPUContext ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.webgl.GPGPUContext {
    def this(gl: WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.webgl.MathBackendWebGL {
