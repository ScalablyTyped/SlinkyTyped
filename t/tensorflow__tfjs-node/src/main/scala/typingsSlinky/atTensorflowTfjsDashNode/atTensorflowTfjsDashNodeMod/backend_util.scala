...
import typingsSlinky.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.channelsFirst
import typingsSlinky.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.channelsLast
...
object backend_util extends js.Object {
  ...
  def computeConv2DInfo(
    ...
    roundingMode: typingsSlinky.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.floor | typingsSlinky.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.round | typingsSlinky.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.ceil
