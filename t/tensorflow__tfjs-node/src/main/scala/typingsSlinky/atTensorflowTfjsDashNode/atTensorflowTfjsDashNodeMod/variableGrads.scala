...
import typingsSlinky.atTensorflowTfjsDashCore.Anon_GradsValue
...
object variableGrads extends js.Object {
  ...
  def apply(
    ...
    varList: js.Array[
      typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Variable[typingsSlinky.atTensorflowTfjsDashCore.distTypesMod.Rank]
    ]
