...
object serialization extends js.Object {
  ...
  abstract class Serializable ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.serialization.Serializable
  
  @js.native
  class SerializationMap protected ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.serialization.SerializationMap
