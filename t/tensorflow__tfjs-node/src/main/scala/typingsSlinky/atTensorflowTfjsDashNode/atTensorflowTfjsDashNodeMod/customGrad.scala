...
import typingsSlinky.atTensorflowTfjsDashCore.distEngineMod.CustomGradientFunc
...
object customGrad extends js.Object {
  ...
  def apply[T /* <: typingsSlinky.atTensorflowTfjsDashCore.distTensorMod.Tensor[typingsSlinky.atTensorflowTfjsDashCore.distTypesMod.Rank] */](f: CustomGradientFunc[T]): js.Function1[
