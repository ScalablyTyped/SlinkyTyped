...
import typingsSlinky.atTensorflowTfjsDashData.distTypesMod.FileElement
...
object data extends js.Object {
  ...
  class CSVDataset protected ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.data.CSVDataset {
    /**
      * Create a `CSVDataset`.
      *
  ...
  abstract class Dataset[T /* <: TensorContainer */] ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.data.Dataset[T]
  
  @js.native
  class FileDataSource protected ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.data.FileDataSource {
  ...
  class TextLineDataset protected ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.data.TextLineDataset {
    /**
  ...
  class URLDataSource protected ()
    extends typingsSlinky.atTensorflowTfjs.atTensorflowTfjsMod.data.URLDataSource {
    /**
  ...
  def func[T /* <: TensorContainer */](f: js.Function0[(IteratorResult[T, _]) | (js.Promise[IteratorResult[T, _]])]): typingsSlinky.atTensorflowTfjsDashData.distDatasetMod.Dataset[T] = js.native
  def generator[T /* <: TensorContainer */](generator: js.Function0[js.Iterator[T] | js.Promise[js.Iterator[T]]]): typingsSlinky.atTensorflowTfjsDashData.distDatasetMod.Dataset[T] = js.native
  ...
  def zip[O /* <: TensorContainer */](datasets: DatasetContainer): typingsSlinky.atTensorflowTfjsDashData.distDatasetMod.Dataset[O] = js.native
  /* static members */
  @js.native
