...
object TFJSBinding {
  ...
  implicit class TFJSBindingOps[Self <: TFJSBinding] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTensorDataSync(value: Double => js.typedarray.Float32Array | js.typedarray.Int32Array | js.typedarray.Uint8Array): Self = this.set("tensorDataSync", js.Any.fromFunction1(value))
  }
