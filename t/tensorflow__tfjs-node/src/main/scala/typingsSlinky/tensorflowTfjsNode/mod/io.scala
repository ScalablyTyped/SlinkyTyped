...
object io {
  ...
  @scala.inline
  def concatenateArrayBuffers_=(x: js.Function1[/* buffers */ js.Array[js.typedarray.ArrayBuffer], js.typedarray.ArrayBuffer]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("concatenateArrayBuffers")(x.asInstanceOf[js.Any])
