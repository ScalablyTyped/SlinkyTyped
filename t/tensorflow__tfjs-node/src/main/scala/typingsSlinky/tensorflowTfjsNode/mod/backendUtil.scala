...
object backendUtil {
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.ERF_A1")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.ERF_A4")
  @js.native
  val ERF_A4: /* -1.453152027 */ Double = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.ERF_A5")
  @js.native
  val ERF_A5: /* 1.061405429 */ Double = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.ERF_P")
  @js.native
  val ERF_P: /* 0.3275911 */ Double = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.PARALLELIZE_THRESHOLD")
  @js.native
  val PARALLELIZE_THRESHOLD: /* 30 */ Double = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.SELU_SCALE")
  @js.native
  val SELU_SCALE: /* 1.0507009873554805 */ Double = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.SELU_SCALEALPHA")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.complexWithEvenIndex")
  @js.native
  def complexWithEvenIndex(complex: js.typedarray.Float32Array): Imag = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.complexWithOddIndex")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.computeOptimalWindowSize")
  @js.native
  def computeOptimalWindowSize(inSize: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.computeOutAndReduceShapes")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.computeOutShape")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.eitherStridesOrDilationsAreOne")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.getImageCenter")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.getInnerMostAxes")
  @js.native
  def getInnerMostAxes(numAxes: Double, rank: Double): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.getPermuted")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.getReductionAxes")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.getReshapedPermuted")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.getSliceSize")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.getUndoAxesPermutation")
  @js.native
  def getUndoAxesPermutation(axes: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.linspaceImpl")
  @js.native
  def linspaceImpl(start: Double, stop: Double, num: Double): Tensor[R1] = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.log")
  @js.native
  def log(msg: js.Object*): Unit = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.mergeRealAndImagArrays")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.prepareSplitSize")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.reshapeTensor")
  @js.native
  ...
  object segmentUtil {
    ...
    @JSImport("@tensorflow/tfjs-node", "backend_util.segment_util.collectGatherOpShapeInfo")
    @js.native
  ...
  object sliceUtil {
    ...
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.isSliceContinous")
    @js.native
    def isSliceContinous(shape: js.Array[Double], begin: js.Array[Double], size: js.Array[Double]): Boolean = js.native
    
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.maskToAxes")
    @js.native
    def maskToAxes(mask: Double): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.parseSliceParams")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.startForAxis")
    @js.native
    def startForAxis(
      beginMask: Double,
    ...
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.startIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.stopForAxis")
    @js.native
    def stopForAxis(
      endMask: Double,
    ...
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.stopIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.stridesForAxis")
    @js.native
    def stridesForAxis(strides: js.Array[Double], axis: Double, ellipsisMask: Double): Double = js.native
    
    @JSImport("@tensorflow/tfjs-node", "backend_util.slice_util.stridesWithElidedDims")
    @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.splitRealAndImagArrays")
  @js.native
  def splitRealAndImagArrays(complex: js.typedarray.Float32Array): Imag = js.native
  
  @JSImport("@tensorflow/tfjs-node", "backend_util.tupleValuesAreOne")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "backend_util.warn")
  @js.native
