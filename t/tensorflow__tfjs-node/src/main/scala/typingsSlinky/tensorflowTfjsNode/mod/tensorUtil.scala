...
object tensorUtil {
  ...
  @JSImport("@tensorflow/tfjs-node", "tensor_util.assertTypesMatch")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "tensor_util.getTensorsInContainer")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "tensor_util.isTensorInList")
  @js.native
  def isTensorInList(
  ...
  @JSImport("@tensorflow/tfjs-node", "tensor_util.makeTypesMatch")
  @js.native
