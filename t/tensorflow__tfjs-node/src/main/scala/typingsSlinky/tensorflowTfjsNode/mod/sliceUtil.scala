...
object sliceUtil {
  ...
  @JSImport("@tensorflow/tfjs-node", "slice_util.isSliceContinous")
  @js.native
  def isSliceContinous(shape: js.Array[Double], begin: js.Array[Double], size: js.Array[Double]): Boolean = js.native
  
  @JSImport("@tensorflow/tfjs-node", "slice_util.maskToAxes")
  @js.native
  def maskToAxes(mask: Double): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-node", "slice_util.parseSliceParams")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "slice_util.startForAxis")
  @js.native
  def startForAxis(
    beginMask: Double,
  ...
  @JSImport("@tensorflow/tfjs-node", "slice_util.startIndicesWithElidedDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "slice_util.stopForAxis")
  @js.native
  def stopForAxis(
    endMask: Double,
  ...
  @JSImport("@tensorflow/tfjs-node", "slice_util.stopIndicesWithElidedDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "slice_util.stridesForAxis")
  @js.native
  def stridesForAxis(strides: js.Array[Double], axis: Double, ellipsisMask: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-node", "slice_util.stridesWithElidedDims")
  @js.native
