...
object data {
  ...
  @JSImport("@tensorflow/tfjs-node", "data.Dataset")
  @js.native
  ...
  object Dataset {
    ...
    @JSImport("@tensorflow/tfjs-node", "data.Dataset.MAX_BUFFER_SIZE")
    @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "data.func")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "data.generator")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "data.microphone")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "data.webcam")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "data.zip")
  @js.native
