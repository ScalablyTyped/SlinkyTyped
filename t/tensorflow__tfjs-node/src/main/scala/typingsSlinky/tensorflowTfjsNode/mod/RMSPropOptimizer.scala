...
@JSImport("@tensorflow/tfjs-node", "RMSPropOptimizer")
@js.native
class RMSPropOptimizer protected ()
  extends typingsSlinky.tensorflowTfjs.mod.RMSPropOptimizer {
...
object RMSPropOptimizer {
  ...
  /** @nocollapse */
  @JSImport("@tensorflow/tfjs-node", "RMSPropOptimizer.className")
  @js.native
  ...
  /** @nocollapse */
  @JSImport("@tensorflow/tfjs-node", "RMSPropOptimizer.fromConfig")
  @js.native
