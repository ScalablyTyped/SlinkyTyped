...
object mod {
  ...
  */
  ...
  object ClipOptions {
    ...
    @scala.inline
    def ClipHtmlOptions(html: `true`): typingsSlinky.textClipper.mod.ClipHtmlOptions = {
      val __obj = js.Dynamic.literal(html = html.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.textClipper.mod.ClipHtmlOptions]
    }
    
    @scala.inline
    def ClipPlainTextOptions(): typingsSlinky.textClipper.mod.ClipPlainTextOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.textClipper.mod.ClipPlainTextOptions]
    }
  }
