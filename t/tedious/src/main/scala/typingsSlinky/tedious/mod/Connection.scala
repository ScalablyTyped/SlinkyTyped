...
import typingsSlinky.tedious.tediousStrings.charsetChange
import typingsSlinky.tedious.tediousStrings.connect
import typingsSlinky.tedious.tediousStrings.databaseChange
import typingsSlinky.tedious.tediousStrings.debug
import typingsSlinky.tedious.tediousStrings.end
import typingsSlinky.tedious.tediousStrings.error
...
class Connection protected () extends EventEmitter {
  ...
  /**
    ...
    */
  def beginTransaction(callback: js.Function1[/* error */ js.UndefOr[js.Error], Unit]): Unit = js.native
  def beginTransaction(
    callback: js.Function1[/* error */ js.UndefOr[js.Error], Unit],
    name: js.UndefOr[scala.Nothing],
    isolationLevel: ISOLATION_LEVEL
  ): Unit = js.native
  def beginTransaction(callback: js.Function1[/* error */ js.UndefOr[js.Error], Unit], name: String): Unit = js.native
  def beginTransaction(
    callback: js.Function1[/* error */ js.UndefOr[js.Error], Unit],
    name: String,
    isolationLevel: ISOLATION_LEVEL
  ...
  /**
    ...
    */
  def newBulkLoad(tableName: String, callback: js.Function2[/* error */ js.Error, /* rowCount */ Double, Unit]): BulkLoad = js.native
  ...
  /**
    ...
    */
  @JSName("on")
  def on_connect(event: connect, listener: js.Function1[/* err */ js.Error, Unit]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("on")
  def on_errorMessage(event: errorMessage, listener: js.Function1[/* err */ js.Error, Unit]): this.type = js.native
  /**
  ...
  /**
    ...
    *                     As only one request at a time may be executed on a connection, another request should not be initiated until this callback is called.
    */
  def reset(callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  ...
  /**
    ...
    *                         As only one request at a time may be executed on a connection, another request should not be initiated until this callback is called.
    */
  def rollbackTransaction(callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  ...
  /**
    ...
    *                     As only one request at a time may be executed on a connection, another request should not be initiated until this callback is called.
    */
  def saveTransaction(callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  ...
  def transaction(
    callback: js.Function2[
      ...
      /* done */ js.Function3[
        ...
        /* doneCallback */ js.UndefOr[js.Function2[/* error */ js.UndefOr[js.Error], /* repeated */ js.Any, Unit]], 
        /* repeated */ js.Any, 
        Unit
      ], 
      Unit
