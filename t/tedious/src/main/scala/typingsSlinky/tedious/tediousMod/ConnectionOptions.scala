package typingsSlinky.tedious.tediousMod
...
object ConnectionOptions {
  ...
  def apply(
    ...
    maxRetriesOnTransientErrors: Int | Double = null,
    packetSize: Int | Double = null,
