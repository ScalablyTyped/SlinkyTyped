...
object cardStyleInterpolatorsMod {
  ...
  @JSImport("tuya-panel-kit/@react-navigation/stack/TransitionConfigs/CardStyleInterpolators", "forFadeFromBottomAndroid")
  @js.native
  ...
  @JSImport("tuya-panel-kit/@react-navigation/stack/TransitionConfigs/CardStyleInterpolators", "forHorizontalIOS")
  @js.native
  def forHorizontalIOS(hasCurrentNextInvertedLayouts: StackCardInterpolationProps): StackCardInterpolatedStyle = js.native
  
  @JSImport("tuya-panel-kit/@react-navigation/stack/TransitionConfigs/CardStyleInterpolators", "forModalPresentationIOS")
  @js.native
  ...
  @JSImport("tuya-panel-kit/@react-navigation/stack/TransitionConfigs/CardStyleInterpolators", "forNoAnimation")
  @js.native
  def forNoAnimation(): StackCardInterpolatedStyle = js.native
  
  @JSImport("tuya-panel-kit/@react-navigation/stack/TransitionConfigs/CardStyleInterpolators", "forRevealFromBottomAndroid")
  @js.native
  ...
  @JSImport("tuya-panel-kit/@react-navigation/stack/TransitionConfigs/CardStyleInterpolators", "forScaleFromCenterAndroid")
  @js.native
  def forScaleFromCenterAndroid(hasCurrentNextClosing: StackCardInterpolationProps): StackCardInterpolatedStyle = js.native
  
  @JSImport("tuya-panel-kit/@react-navigation/stack/TransitionConfigs/CardStyleInterpolators", "forVerticalIOS")
  @js.native
