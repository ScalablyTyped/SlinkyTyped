...
import typingsSlinky.reactNative.mod.ViewPagerAndroidOnPageScrollEventData
import typingsSlinky.reactNative.mod.ViewPagerAndroidOnPageSelectedEventData
...
object Carousel {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def carouselChange(value: /* index */ Double => Unit): this.type = set("carouselChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def dotWrapperStyle(value: StyleProp[ViewStyle]): this.type = set("dotWrapperStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hasDots(value: Boolean): this.type = set("hasDots", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onMomentumScrollEnd(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): this.type = set("onMomentumScrollEnd", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onPageScroll(value: SyntheticEvent[NodeHandle, ViewPagerAndroidOnPageScrollEventData] => Unit): this.type = set("onPageScroll", js.Any.fromFunction1(value))
    
    @scala.inline
    def onPageScrollStateChanged(value: /* state */ Idle | Dragging | Settling => Unit): this.type = set("onPageScrollStateChanged", js.Any.fromFunction1(value))
    
    @scala.inline
    def onPageSelected(value: SyntheticEvent[NodeHandle, ViewPagerAndroidOnPageSelectedEventData] => Unit): this.type = set("onPageSelected", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def onScrollBeginDrag(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): this.type = set("onScrollBeginDrag", js.Any.fromFunction2(value))
    
    @scala.inline
    def onScrollEndDrag(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): this.type = set("onScrollEndDrag", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def pageStyle(value: StyleProp[ViewStyle]): this.type = set("pageStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def pageStyleNull: this.type = set("pageStyle", null)
