...
import typingsSlinky.tuyaPanelKit.headerBackgroundMod.Props
...
object HeaderBackground {
  ...
  @scala.inline
  def apply(style: js.UndefOr[StyleProp[ViewStyle]] with js.UndefOr[WithAnimatedValue[StyleProp[ViewStyle]]]): Builder = {
