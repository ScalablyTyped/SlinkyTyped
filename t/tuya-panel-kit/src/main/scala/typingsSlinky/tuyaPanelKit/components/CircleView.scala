...
import typingsSlinky.tuyaPanelKit.mod.CircleViewProps
...
object CircleView {
  ...
  def apply(radius: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CircleViewProps]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.tuyaPanelKit.mod.CircleView] {
  ...
  def withProps(p: CircleViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
