...
object HeaderBackButton {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def screenLayout(value: typingsSlinky.tuyaPanelKit.stackTypesMod.Layout): this.type = set("screenLayout", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def titleLayout(value: typingsSlinky.tuyaPanelKit.stackTypesMod.Layout): this.type = set("titleLayout", value.asInstanceOf[js.Any])
