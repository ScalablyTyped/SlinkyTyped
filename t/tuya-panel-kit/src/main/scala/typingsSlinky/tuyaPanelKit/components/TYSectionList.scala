...
object TYSectionList {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def contentContainStyle(value: StyleProp[ViewStyle]): this.type = set("contentContainStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def contentContainStyleNull: this.type = set("contentContainStyle", null)
    ...
    @scala.inline
    def getItem(value: (/* data */ js.Any, /* index */ Double) => SectionDataProps): this.type = set("getItem", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def getItemLayout(
      value: (/* data */ (js.Array[SectionListData[SectionDataProps, DefaultSectionT]]) | Null, /* index */ Double) => Index
    ...
    @scala.inline
    def headerStyle(value: StyleProp[ViewStyle]): this.type = set("headerStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def keyExtractor(value: (SectionDataProps, /* index */ Double) => String): this.type = set("keyExtractor", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def renderItem(
      value: /* info */ SectionListRenderItemInfo[SectionDataProps, DefaultSectionT] => ReactElement | Null
    ): this.type = set("renderItem", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def renderSectionFooter(value: /* info */ Section[SectionDataProps, DefaultSectionT] => ReactElement | Null): this.type = set("renderSectionFooter", js.Any.fromFunction1(value))
    
    @scala.inline
    def renderSectionHeader(value: /* info */ Section[SectionDataProps, DefaultSectionT] => ReactElement | Null): this.type = set("renderSectionHeader", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def sectionListRef(value: () => Unit): this.type = set("sectionListRef", js.Any.fromFunction0(value))
