...
import typingsSlinky.tuyaPanelKit.mod.ModalProps
...
object Modal {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.tuyaPanelKit.mod.Modal] {
    ...
    @scala.inline
    def onMaskPress(value: () => Unit): this.type = set("onMaskPress", js.Any.fromFunction0(value))
