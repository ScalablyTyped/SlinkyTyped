...
import typingsSlinky.tuyaPanelKit.mod.TimerPickerProps
...
object TimerPicker {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def endTime(value: Double): this.type = set("endTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def is12Hours(value: Boolean): this.type = set("is12Hours", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onTimerChange(value: (/* startTime */ Double, /* endTime */ Double) => Unit): this.type = set("onTimerChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onValueChange(value: (/* value */ String | Double, /* index */ Double) => Unit): this.type = set("onValueChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def singlePicker(value: Boolean): this.type = set("singlePicker", value.asInstanceOf[js.Any])
    
    @scala.inline
    def startTime(value: Double): this.type = set("startTime", value.asInstanceOf[js.Any])
