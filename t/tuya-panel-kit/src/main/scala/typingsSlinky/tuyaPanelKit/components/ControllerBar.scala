...
import typingsSlinky.tuyaPanelKit.mod.ControllerBarProps
import typingsSlinky.tuyaPanelKit.tuyaPanelKitStrings.alpha
...
object ControllerBar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def backgroundType(value: alpha | pure): this.type = set("backgroundType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def hasBottomBorder(value: Boolean): this.type = set("hasBottomBorder", value.asInstanceOf[js.Any])
