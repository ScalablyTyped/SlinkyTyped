...
object BackIconColor {
  ...
  @scala.inline
  implicit class BackIconColorMutableBuilder[Self <: BackIconColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setList(value: CellFontColor): Self = StObject.set(x, "list", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListUndefined: Self = StObject.set(x, "list", js.undefined)
    
    @scala.inline
    def setNumberSelector(value: CellPlusColor): Self = StObject.set(x, "numberSelector", value.asInstanceOf[js.Any])
