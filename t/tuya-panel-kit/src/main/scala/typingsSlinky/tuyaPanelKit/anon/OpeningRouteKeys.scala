...
@js.native
trait OpeningRouteKeys extends js.Object {
...
object OpeningRouteKeys {
  ...
  @scala.inline
  implicit class OpeningRouteKeysOps[Self <: OpeningRouteKeys] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviousRoutesVarargs(value: ReadonlykeystringnamestriKey*): Self = this.set("previousRoutes", js.Array(value :_*))
    
    @scala.inline
    def setPreviousRoutes(value: js.Array[ReadonlykeystringnamestriKey]): Self = this.set("previousRoutes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRoutesVarargs(value: ReadonlykeystringnamestriKey*): Self = this.set("routes", js.Array(value :_*))
    
    @scala.inline
    def setRoutes(value: js.Array[ReadonlykeystringnamestriKey]): Self = this.set("routes", value.asInstanceOf[js.Any])
  }
}
