...
trait KeyState extends js.Object {
  ...
  var state: js.UndefOr[PartialStateNavigationStaHistory] = js.native
}
object KeyState {
  ...
  implicit class KeyStateOps[Self <: KeyState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setState(value: PartialStateNavigationStaHistory): Self = this.set("state", value.asInstanceOf[js.Any])
