...
- typingsSlinky.tuyaPanelKit.mod.IconFontProps because var conflicts: color, style. Inlined viewBox, useART, ascent, descent, unitsPerEm, x, y, scaleX, scaleY, scale, spaceOffset, size, hFlip, vFlip, name, width, height, fill, stroke, strokeWidth, strokeJoin, strokeCap, strokeDash, d, opacity */ @js.native
...
object TopBarActionProps {
  ...
  @scala.inline
  implicit class TopBarActionPropsMutableBuilder[Self <: TopBarActionProps] (val x: Self) extends AnyVal {
