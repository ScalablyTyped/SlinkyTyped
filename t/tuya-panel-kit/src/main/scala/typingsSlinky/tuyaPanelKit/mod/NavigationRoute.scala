...
import typingsSlinky.tuyaPanelKit.anon.NavigationAny
...
trait NavigationRoute extends StObject {
  ...
  var Scene: ReactComponentClass[js.Object] = js.native
...
object NavigationRoute {
  ...
  @scala.inline
  def apply(Scene: ReactComponentClass[js.Object], id: String): NavigationRoute = {
  ...
  implicit class NavigationRouteMutableBuilder[Self <: NavigationRoute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScene(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "Scene", value.asInstanceOf[js.Any])
