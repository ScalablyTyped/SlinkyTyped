...
object SliderProps {
  ...
  implicit class SliderPropsMutableBuilder[Self <: SliderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderMaximumTrack(value: () => ReactElement): Self = StObject.set(x, "renderMaximumTrack", js.Any.fromFunction0(value))
    
    @scala.inline
    def setRenderMaximumTrackUndefined: Self = StObject.set(x, "renderMaximumTrack", js.undefined)
    
    @scala.inline
    def setRenderMinimumTrack(value: () => ReactElement): Self = StObject.set(x, "renderMinimumTrack", js.Any.fromFunction0(value))
    
    @scala.inline
    def setRenderMinimumTrackUndefined: Self = StObject.set(x, "renderMinimumTrack", js.undefined)
    
    @scala.inline
    def setRenderThumb(value: () => ReactElement): Self = StObject.set(x, "renderThumb", js.Any.fromFunction0(value))
