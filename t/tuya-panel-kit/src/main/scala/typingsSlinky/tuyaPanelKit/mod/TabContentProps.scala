...
trait TabContentProps extends StObject {
  ...
  var renderPlaceholder: js.UndefOr[js.Function2[/* activeIndex */ Double, /* child */ ReactElement, ReactElement]] = js.native
...
object TabContentProps {
  ...
  implicit class TabContentPropsMutableBuilder[Self <: TabContentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderPlaceholder(value: (/* activeIndex */ Double, /* child */ ReactElement) => ReactElement): Self = StObject.set(x, "renderPlaceholder", js.Any.fromFunction2(value))
