...
import typingsSlinky.tuyaPanelKit.anon.Bic
...
trait DevInfo[S] extends StObject {
  ...
  {[ K in keyof S ]: tuya-panel-kit.tuya-panel-kit.DpSchema}
    */ typingsSlinky.tuyaPanelKit.tuyaPanelKitStrings.DevInfo with TopLevel[js.Any] = js.native
...
object DevInfo {
  ...
  {[ K in keyof S ]: tuya-panel-kit.tuya-panel-kit.DpSchema}
    */ typingsSlinky.tuyaPanelKit.tuyaPanelKitStrings.DevInfo with TopLevel[js.Any],
    schemaExt: String,
    sharedTime: Double,
    sigmeshId: String,
