...
trait CarouselProps extends ViewPagerAndroidProps {
  ...
  var dots: js.UndefOr[ReactElement | (js.Function1[/* params */ CurrentIndex, ReactElement])] = js.native
  ...
  var onMomentumScrollEnd: js.UndefOr[
    js.Function2[SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any, Unit]
  ] = js.native
...
object CarouselProps {
  ...
  implicit class CarouselPropsMutableBuilder[Self <: CarouselProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDots(value: ReactElement | (js.Function1[/* params */ CurrentIndex, ReactElement])): Self = StObject.set(x, "dots", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDotsComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "dots", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDotsFunction1(value: /* params */ CurrentIndex => ReactElement): Self = StObject.set(x, "dots", js.Any.fromFunction1(value))
    
    @scala.inline
    def setDotsFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "dots", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnMomentumScrollEnd(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): Self = StObject.set(x, "onMomentumScrollEnd", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnMomentumScrollEndUndefined: Self = StObject.set(x, "onMomentumScrollEnd", js.undefined)
    
    @scala.inline
    def setOnScrollBeginDrag(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): Self = StObject.set(x, "onScrollBeginDrag", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnScrollBeginDragUndefined: Self = StObject.set(x, "onScrollBeginDrag", js.undefined)
    
    @scala.inline
    def setOnScrollEndDrag(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): Self = StObject.set(x, "onScrollEndDrag", js.Any.fromFunction2(value))
