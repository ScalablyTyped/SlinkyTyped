...
object CarouselProps {
  ...
  implicit class CarouselPropsOps[Self <: CarouselProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDotsFunction1(value: /* params */ CurrentIndex => ReactElement): Self = this.set("dots", js.Any.fromFunction1(value))
    
    @scala.inline
    def setDotsFunctionComponent(value: ReactComponentClass[_]): Self = this.set("dots", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDotsComponentClass(value: ReactComponentClass[_]): Self = this.set("dots", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDots(value: ReactElement | (js.Function1[/* params */ CurrentIndex, ReactElement])): Self = this.set("dots", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnMomentumScrollEnd(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): Self = this.set("onMomentumScrollEnd", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnMomentumScrollEnd: Self = this.set("onMomentumScrollEnd", js.undefined)
    
    @scala.inline
    def setOnScrollBeginDrag(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): Self = this.set("onScrollBeginDrag", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnScrollBeginDrag: Self = this.set("onScrollBeginDrag", js.undefined)
    
    @scala.inline
    def setOnScrollEndDrag(value: (SyntheticEvent[NodeHandle, NativeScrollEvent], /* state */ js.Any) => Unit): Self = this.set("onScrollEndDrag", js.Any.fromFunction2(value))
