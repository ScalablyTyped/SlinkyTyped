...
object DialogCheckboxProps {
  ...
  @scala.inline
  implicit class DialogCheckboxPropsMutableBuilder[Self <: DialogCheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSource(value: js.Array[DialogCheckbox]): Self = StObject.set(x, "dataSource", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataSourceVarargs(value: DialogCheckbox*): Self = StObject.set(x, "dataSource", js.Array(value :_*))
    ...
    @scala.inline
    def setOnChange(value: /* value */ String | Double => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
