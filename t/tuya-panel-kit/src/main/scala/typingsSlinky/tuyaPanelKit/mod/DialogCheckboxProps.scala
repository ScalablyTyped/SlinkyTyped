...
@js.native
trait DialogCheckboxProps extends js.Object {
  ...
  var dataSource: js.Array[DialogCheckbox] = js.native
  ...
  var onChange: js.UndefOr[js.Function1[/* value */ String | Double, Unit]] = js.native
...
object DialogCheckboxProps {
  ...
  def apply(
    cancelText: String,
    confirmText: String,
    dataSource: js.Array[DialogCheckbox],
    title: String,
    value: String | Double | js.Array[String]
  ): DialogCheckboxProps = {
    val __obj = js.Dynamic.literal(cancelText = cancelText.asInstanceOf[js.Any], confirmText = confirmText.asInstanceOf[js.Any], dataSource = dataSource.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[DialogCheckboxProps]
  }
  
  @scala.inline
  implicit class DialogCheckboxPropsOps[Self <: DialogCheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSourceVarargs(value: DialogCheckbox*): Self = this.set("dataSource", js.Array(value :_*))
    
    @scala.inline
    def setDataSource(value: js.Array[DialogCheckbox]): Self = this.set("dataSource", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: /* value */ String | Double => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
