...
trait PopupDatePickerProps extends StObject {
  ...
  var _onDataChange: js.UndefOr[js.Function1[/* date */ js.Date, Unit]] = js.native
  ...
  var onDateChange: js.UndefOr[js.Function1[/* value */ js.UndefOr[js.Date], Unit]] = js.native
...
object PopupDatePickerProps {
  ...
  implicit class PopupDatePickerPropsMutableBuilder[Self <: PopupDatePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDateChange(value: /* value */ js.UndefOr[js.Date] => Unit): Self = StObject.set(x, "onDateChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def set_onDataChange(value: /* date */ js.Date => Unit): Self = StObject.set(x, "_onDataChange", js.Any.fromFunction1(value))
