...
object PopupDatePickerProps {
  ...
  implicit class PopupDatePickerPropsOps[Self <: PopupDatePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_onDataChange(value: /* date */ js.Date => Unit): Self = this.set("_onDataChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnDateChange(value: /* value */ js.UndefOr[js.Date] => Unit): Self = this.set("onDateChange", js.Any.fromFunction1(value))
