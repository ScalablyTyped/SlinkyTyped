...
object NavigationOptions {
  ...
  implicit class NavigationOptionsOps[Self <: NavigationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderStatusBar(value: () => ReactElement): Self = this.set("renderStatusBar", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteRenderStatusBar: Self = this.set("renderStatusBar", js.undefined)
    
    @scala.inline
    def setRenderTopBar(value: () => ReactElement): Self = this.set("renderTopBar", js.Any.fromFunction0(value))
