...
import typingsSlinky.tuyaPanelKit.anon.Uri
import typingsSlinky.tuyaPanelKit.themeMod.LinearGradientBackground
import typingsSlinky.tuyaPanelKit.themeMod.RadialGradientBackground
...
trait NavigationOptions extends StObject {
  ...
  /**
    * @desc 自定义渲染状态栏
    */
  var renderStatusBar: js.UndefOr[js.Function0[ReactElement]] = js.native
  
  /**
    * @desc 自定义渲染头部栏
    */
  var renderTopBar: js.UndefOr[js.Function0[ReactElement]] = js.native
...
object NavigationOptions {
  ...
  implicit class NavigationOptionsMutableBuilder[Self <: NavigationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderStatusBar(value: () => ReactElement): Self = StObject.set(x, "renderStatusBar", js.Any.fromFunction0(value))
    
    @scala.inline
    def setRenderStatusBarUndefined: Self = StObject.set(x, "renderStatusBar", js.undefined)
    
    @scala.inline
    def setRenderTopBar(value: () => ReactElement): Self = StObject.set(x, "renderTopBar", js.Any.fromFunction0(value))
