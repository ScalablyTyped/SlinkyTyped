...
object ProgressProps {
  ...
  implicit class ProgressPropsOps[Self <: ProgressProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderCenterViewReactElement(value: ReactElement): Self = this.set("renderCenterView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRenderCenterView(value: ReactElement): Self = this.set("renderCenterView", value.asInstanceOf[js.Any])
