...
trait ProgressProps extends GestureProps {
  ...
  var renderCenterView: js.UndefOr[ReactElement] = js.native
...
object ProgressProps {
  ...
  implicit class ProgressPropsMutableBuilder[Self <: ProgressProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderCenterView(value: ReactElement): Self = StObject.set(x, "renderCenterView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRenderCenterViewReactElement(value: ReactElement): Self = StObject.set(x, "renderCenterView", value.asInstanceOf[js.Any])
