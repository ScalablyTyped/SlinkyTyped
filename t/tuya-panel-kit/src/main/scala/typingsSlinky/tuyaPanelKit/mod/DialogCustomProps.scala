...
object DialogCustomProps {
  ...
  implicit class DialogCustomPropsOps[Self <: DialogCustomProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFooterFunction0(value: () => ReactElement): Self = this.set("footer", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setFooter(value: ReactElement | js.Function0[ReactElement]): Self = this.set("footer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHeaderFunction0(value: () => ReactElement): Self = this.set("header", js.Any.fromFunction0(value))
    
    @scala.inline
    def setHeaderFunctionComponent(value: ReactComponentClass[_]): Self = this.set("header", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHeaderComponentClass(value: ReactComponentClass[_]): Self = this.set("header", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHeader(value: ReactElement | js.Function0[ReactElement]): Self = this.set("header", value.asInstanceOf[js.Any])
