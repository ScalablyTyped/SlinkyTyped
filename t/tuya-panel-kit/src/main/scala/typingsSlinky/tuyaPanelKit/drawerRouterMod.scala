...
object drawerRouterMod {
  ...
  */
  ...
  object DrawerActionType {
    ...
    @scala.inline
    def `13`(`type`: OPEN_DRAWER | CLOSE_DRAWER | TOGGLE_DRAWER): typingsSlinky.tuyaPanelKit.anon.`13` = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.tuyaPanelKit.anon.`13`]
    }
    
    @scala.inline
    def TabActionType(payload: NameString, `type`: JUMP_TO): typingsSlinky.tuyaPanelKit.tabRouterMod.TabActionType = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.tuyaPanelKit.tabRouterMod.TabActionType]
    }
  }
