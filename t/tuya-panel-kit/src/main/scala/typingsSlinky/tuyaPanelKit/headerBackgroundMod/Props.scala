package typingsSlinky.tuyaPanelKit.headerBackgroundMod
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStyle(value: js.UndefOr[StyleProp[ViewStyle]] with js.UndefOr[WithAnimatedValue[StyleProp[ViewStyle]]]): Self = this.set("style", value.asInstanceOf[js.Any])
