...
object StackHeaderProps {
  ...
  implicit class StackHeaderPropsMutableBuilder[Self <: StackHeaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNavigation(value: StackNavigationProp[ParamListBase, String]): Self = StObject.set(x, "navigation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPrevious(value: Scene[Route[String, js.UndefOr[js.Object]]]): Self = StObject.set(x, "previous", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreviousUndefined: Self = StObject.set(x, "previous", js.undefined)
    
    @scala.inline
    def setScene(value: Scene[Route[String, js.UndefOr[js.Object]]]): Self = StObject.set(x, "scene", value.asInstanceOf[js.Any])
