...
import typingsSlinky.tuyaPanelKit.anon.Bottom
import typingsSlinky.tuyaPanelKit.anon.Close
import typingsSlinky.tuyaPanelKit.anon.Horizontal
import typingsSlinky.tuyaPanelKit.anon.Style
import typingsSlinky.tuyaPanelKit.anon.StyleWithAnimatedValue
import typingsSlinky.tuyaPanelKit.anon.TintColor
...
import typingsSlinky.tuyaPanelKit.tuyaPanelKitStrings.pop_
import typingsSlinky.tuyaPanelKit.tuyaPanelKitStrings.push_
...
object StackNavigationOptions {
  ...
  implicit class StackNavigationOptionsOps[Self <: StackNavigationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeader(value: /* props */ StackHeaderProps => ReactElement): Self = this.set("header", js.Any.fromFunction1(value))
