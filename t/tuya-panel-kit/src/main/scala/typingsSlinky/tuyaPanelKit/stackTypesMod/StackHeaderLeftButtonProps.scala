...
trait StackHeaderLeftButtonProps extends StObject {
  ...
  /**
    ...
    */
  var backImage: js.UndefOr[js.Function1[/* props */ TintColorString, ReactElement]] = js.native
...
object StackHeaderLeftButtonProps {
  ...
  implicit class StackHeaderLeftButtonPropsMutableBuilder[Self <: StackHeaderLeftButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackImage(value: /* props */ TintColorString => ReactElement): Self = StObject.set(x, "backImage", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnLabelLayout(value: SyntheticEvent[NodeHandle, typingsSlinky.reactNative.anon.Layout] => Unit): Self = StObject.set(x, "onLabelLayout", js.Any.fromFunction1(value))
