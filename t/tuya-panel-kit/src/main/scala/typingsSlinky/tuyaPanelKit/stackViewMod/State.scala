package typingsSlinky.tuyaPanelKit.stackViewMod
...
object State {
  ...
  implicit class StateOps[Self <: State] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviousRoutesVarargs(value: (Route[String, js.UndefOr[js.Object]])*): Self = this.set("previousRoutes", js.Array(value :_*))
    
    @scala.inline
    def setPreviousRoutes(value: js.Array[Route[String, js.UndefOr[js.Object]]]): Self = this.set("previousRoutes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRoutesVarargs(value: (Route[String, js.UndefOr[js.Object]])*): Self = this.set("routes", js.Array(value :_*))
    
    @scala.inline
    def setRoutes(value: js.Array[Route[String, js.UndefOr[js.Object]]]): Self = this.set("routes", value.asInstanceOf[js.Any])
  }
}
