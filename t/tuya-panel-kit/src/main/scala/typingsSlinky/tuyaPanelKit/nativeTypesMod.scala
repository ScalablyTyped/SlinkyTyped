...
import typingsSlinky.tuyaPanelKit.anon.Background
import typingsSlinky.tuyaPanelKit.anon.InitialRouteName
import typingsSlinky.tuyaPanelKit.getPathFromStateMod.Options
import typingsSlinky.tuyaPanelKit.getPathFromStateMod.State
...
object nativeTypesMod {
  ...
  trait LinkingOptions extends StObject {
    ...
    var getStateFromPath: js.UndefOr[
        js.Function2[
          /* path */ String, 
          /* options */ js.UndefOr[typingsSlinky.tuyaPanelKit.getStateFromPathMod.Options], 
  ...
  object LinkingOptions {
    ...
    implicit class LinkingOptionsMutableBuilder[Self <: LinkingOptions] (val x: Self) extends AnyVal {
      ...
      def setGetStateFromPath(
        value: (/* path */ String, /* options */ js.UndefOr[typingsSlinky.tuyaPanelKit.getStateFromPathMod.Options]) => js.UndefOr[ResultState]
