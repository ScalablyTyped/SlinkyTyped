package typingsSlinky.typeorm.mysqlConnectionCredentialsOptionsMod
...
@js.native
trait MysqlConnectionCredentialsOptions extends js.Object {
...
object MysqlConnectionCredentialsOptions {
  ...
  @scala.inline
  implicit class MysqlConnectionCredentialsOptionsOps[Self <: MysqlConnectionCredentialsOptions] (val x: Self) extends AnyVal {
