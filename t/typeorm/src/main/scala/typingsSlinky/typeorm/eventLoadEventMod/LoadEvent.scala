package typingsSlinky.typeorm.eventLoadEventMod
...
@js.native
trait LoadEvent[Entity] extends js.Object {
...
object LoadEvent {
  ...
  @scala.inline
  implicit class LoadEventOps[Self <: LoadEvent[_], Entity] (val x: Self with LoadEvent[Entity]) extends AnyVal {
