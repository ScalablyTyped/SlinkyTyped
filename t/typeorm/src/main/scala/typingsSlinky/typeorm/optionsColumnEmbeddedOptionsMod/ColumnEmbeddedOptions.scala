package typingsSlinky.typeorm.optionsColumnEmbeddedOptionsMod
...
@js.native
trait ColumnEmbeddedOptions extends js.Object {
...
object ColumnEmbeddedOptions {
  ...
  @scala.inline
  implicit class ColumnEmbeddedOptionsOps[Self <: ColumnEmbeddedOptions] (val x: Self) extends AnyVal {
