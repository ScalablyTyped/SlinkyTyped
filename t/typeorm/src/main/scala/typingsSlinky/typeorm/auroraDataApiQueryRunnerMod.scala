...
import typingsSlinky.typeorm.auroraDataApiDriverMod.AuroraDataApiDriver
...
@JSImport("typeorm/browser/driver/aurora-data-api/AuroraDataApiQueryRunner", JSImport.Namespace)
@js.native
object auroraDataApiQueryRunnerMod extends js.Object {
