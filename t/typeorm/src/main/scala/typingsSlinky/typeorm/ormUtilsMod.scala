...
import typingsSlinky.typeorm.anon.Items
...
object ormUtilsMod {
  ...
  @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils")
  @js.native
  ...
  object OrmUtils {
    ...
    /**
      ...
      */
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.chunk")
    @js.native
    def chunk[T](array: js.Array[T], size: Double): js.Array[js.Array[T]] = js.native
    
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.compare2Objects")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.compareIds")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.deepCompare")
    @js.native
    def deepCompare(args: js.Any*): Boolean = js.native
    
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.groupBy")
    @js.native
    ...
    /**
      * Compares two arrays.
      */
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.isArraysEqual")
    @js.native
    def isArraysEqual(arr1: js.Array[_], arr2: js.Array[_]): Boolean = js.native
    
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.isObject")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.mergeDeep")
    @js.native
    def mergeDeep(target: js.Any, sources: js.Any*): js.Any = js.native
    
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.splitClassesAndStrings")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.toBoolean")
    @js.native
    def toBoolean(value: js.Any): Boolean = js.native
    
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.uniq")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("typeorm/browser/util/OrmUtils", "OrmUtils.zipObject")
    @js.native
