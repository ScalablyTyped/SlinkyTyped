...
object Timestamp {
  ...
  @js.native
  def MAX_VALUE: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp = js.native
  @scala.inline
  def MAX_VALUE_=(x: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MAX_VALUE")(x.asInstanceOf[js.Any])
  
  @JSImport("typeorm", "Timestamp.MIN_VALUE")
  @js.native
  def MIN_VALUE: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp = js.native
  @scala.inline
  def MIN_VALUE_=(x: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MIN_VALUE")(x.asInstanceOf[js.Any])
  
  @JSImport("typeorm", "Timestamp.NEG_ONE")
  @js.native
  def NEG_ONE: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp = js.native
  @scala.inline
  def NEG_ONE_=(x: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NEG_ONE")(x.asInstanceOf[js.Any])
  
  @JSImport("typeorm", "Timestamp.ONE")
  @js.native
  def ONE: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp = js.native
  @scala.inline
  def ONE_=(x: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ONE")(x.asInstanceOf[js.Any])
  
  @JSImport("typeorm", "Timestamp.ZERO")
  @js.native
  def ZERO: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp = js.native
  @scala.inline
  def ZERO_=(x: typingsSlinky.typeorm.mongodbTypingsMod.Timestamp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ZERO")(x.asInstanceOf[js.Any])
