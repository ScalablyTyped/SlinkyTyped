...
object Timestamp extends js.Object {
  ...
  var MAX_VALUE: typingsSlinky.typeorm.typingsMod.Timestamp = js.native
  
  var MIN_VALUE: typingsSlinky.typeorm.typingsMod.Timestamp = js.native
  
  var NEG_ONE: typingsSlinky.typeorm.typingsMod.Timestamp = js.native
  
  var ONE: typingsSlinky.typeorm.typingsMod.Timestamp = js.native
  
  var ZERO: typingsSlinky.typeorm.typingsMod.Timestamp = js.native
