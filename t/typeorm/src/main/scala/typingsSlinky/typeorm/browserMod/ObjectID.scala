...
@js.native
class ObjectID ()
  extends typingsSlinky.typeorm.typingsMod.ObjectID {
...
object ObjectID {
  ...
  @js.native
  def createFromHexString(hexString: String): typingsSlinky.typeorm.typingsMod.ObjectID = js.native
  ...
  @js.native
  def createFromTime(time: scala.Double): typingsSlinky.typeorm.typingsMod.ObjectID = js.native
