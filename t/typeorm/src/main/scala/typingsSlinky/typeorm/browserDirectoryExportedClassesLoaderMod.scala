...
object browserDirectoryExportedClassesLoaderMod {
  ...
  @JSImport("typeorm/browser/platform/BrowserDirectoryExportedClassesLoader", "importClassesFromDirectories")
  @js.native
  ...
  @JSImport("typeorm/browser/platform/BrowserDirectoryExportedClassesLoader", "importJsonsFromDirectories")
  @js.native
