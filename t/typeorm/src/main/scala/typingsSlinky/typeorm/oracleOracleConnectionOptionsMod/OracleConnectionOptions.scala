package typingsSlinky.typeorm.oracleOracleConnectionOptionsMod
...
object OracleConnectionOptions {
  ...
  implicit class OracleConnectionOptionsOps[Self <: OracleConnectionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplication(value: MasterOracleConnectionCredentialsOptions): Self = this.set("replication", value.asInstanceOf[js.Any])
