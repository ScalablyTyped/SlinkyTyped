...
import typingsSlinky.typeorm.migrationMod.Migration
...
@JSImport("typeorm/browser/migration/MigrationExecutor", JSImport.Namespace)
@js.native
object migrationExecutorMod extends js.Object {
