...
import typingsSlinky.typeorm.anon.NewColumnTableColumn
import typingsSlinky.typeorm.commonObjectLiteralMod.ObjectLiteral
import typingsSlinky.typeorm.driverQueryMod.Query
import typingsSlinky.typeorm.platformPlatformToolsMod.ReadStream
import typingsSlinky.typeorm.queryRunnerBaseQueryRunnerMod.BaseQueryRunner
import typingsSlinky.typeorm.sqliteAbstractAbstractSqliteDriverMod.AbstractSqliteDriver
import typingsSlinky.typeorm.tableTableCheckMod.TableCheck
import typingsSlinky.typeorm.tableTableColumnMod.TableColumn
import typingsSlinky.typeorm.tableTableExclusionMod.TableExclusion
import typingsSlinky.typeorm.tableTableForeignKeyMod.TableForeignKey
import typingsSlinky.typeorm.tableTableIndexMod.TableIndex
...
object sqliteAbstractAbstractSqliteQueryRunnerMod extends js.Object {
  ...
  abstract class AbstractSqliteQueryRunner () extends BaseQueryRunner {
    ...
    def changeColumns(tableOrName: String, changedColumns: js.Array[NewColumnTableColumn]): js.Promise[Unit] = js.native
    /**
      * Changes a column in the table.
    ...
    /**
      ...
      */
    def changeColumns(tableOrName: Table, changedColumns: js.Array[NewColumnTableColumn]): js.Promise[Unit] = js.native
    ...
    /**
      ...
      */
    var driver: AbstractSqliteDriver = js.native
    ...
    /* protected */ def recreateTable(newTable: Table, oldTable: Table): js.Promise[Unit] = js.native
    /* protected */ def recreateTable(newTable: Table, oldTable: Table, migrateData: Boolean): js.Promise[Unit] = js.native
