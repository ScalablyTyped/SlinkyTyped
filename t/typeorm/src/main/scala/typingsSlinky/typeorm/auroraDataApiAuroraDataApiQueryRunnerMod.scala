...
import typingsSlinky.typeorm.anon.Database
import typingsSlinky.typeorm.anon.NewColumnOldColumn
import typingsSlinky.typeorm.anon.NewColumnTableColumn
import typingsSlinky.typeorm.auroraDataApiAuroraDataApiDriverMod.AuroraDataApiDriver
...
@JSImport("typeorm/driver/aurora-data-api/AuroraDataApiQueryRunner", JSImport.Namespace)
@js.native
object auroraDataApiAuroraDataApiQueryRunnerMod extends js.Object {
