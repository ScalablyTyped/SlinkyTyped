...
import typingsSlinky.typeorm.anon.IsArray
...
import typingsSlinky.typeorm.dataTypeDefaultsMod.DataTypeDefaults
import typingsSlinky.typeorm.entityMetadataMod.EntityMetadata
import typingsSlinky.typeorm.mappedColumnTypesMod.MappedColumnTypes
...
object driverMod extends js.Object {
  ...
  trait Driver extends js.Object {
    ...
    /**
      ...
      */
    def normalizeType(column: IsArray): String = js.native
