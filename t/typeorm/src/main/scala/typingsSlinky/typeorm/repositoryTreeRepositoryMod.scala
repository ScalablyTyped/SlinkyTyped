...
import typingsSlinky.typeorm.anon.ParentId
...
@JSImport("typeorm/repository/TreeRepository", JSImport.Namespace)
@js.native
object repositoryTreeRepositoryMod extends js.Object {
