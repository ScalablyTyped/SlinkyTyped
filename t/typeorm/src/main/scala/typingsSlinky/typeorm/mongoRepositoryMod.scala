...
import typingsSlinky.typeorm.mongoEntityManagerMod.MongoEntityManager
...
@JSImport("typeorm/browser/repository/MongoRepository", JSImport.Namespace)
@js.native
object mongoRepositoryMod extends js.Object {
