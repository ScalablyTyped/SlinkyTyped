...
import typingsSlinky.typeorm.entitySchemaEntitySchemaCheckOptionsMod.EntitySchemaCheckOptions
import typingsSlinky.typeorm.entitySchemaEntitySchemaExclusionOptionsMod.EntitySchemaExclusionOptions
import typingsSlinky.typeorm.entitySchemaEntitySchemaIndexOptionsMod.EntitySchemaIndexOptions
import typingsSlinky.typeorm.entitySchemaEntitySchemaUniqueOptionsMod.EntitySchemaUniqueOptions
...
object entitySchemaEntitySchemaOptionsMod extends js.Object {
  ...
  class EntitySchemaOptions[T] () extends js.Object {
    ...
    {[ P in keyof T ]:? typeorm.typeorm/entity-schema/EntitySchemaColumnOptions.EntitySchemaColumnOptions}
      */ typingsSlinky.typeorm.typeormStrings.EntitySchemaOptions with TopLevel[js.Any] = js.native
    ...
    {[ P in keyof T ]:? typeorm.typeorm/entity-schema/EntitySchemaRelationOptions.EntitySchemaRelationOptions}
      */ typingsSlinky.typeorm.typeormStrings.EntitySchemaOptions with TopLevel[js.Any]
      ] = js.native
