...
import typingsSlinky.typeorm.anon.Transaction
...
import typingsSlinky.typeorm.entityManagerSqljsEntityManagerMod.SqljsEntityManager
...
import typingsSlinky.typeorm.migrationMigrationMod.Migration
import typingsSlinky.typeorm.namingStrategyNamingStrategyInterfaceMod.NamingStrategyInterface
import typingsSlinky.typeorm.queryBuilderRelationLoaderMod.RelationLoader
...
import typingsSlinky.typeorm.repositoryMongoRepositoryMod.MongoRepository
...
import typingsSlinky.typeorm.typeormRelationIdLoaderMod.RelationIdLoader
