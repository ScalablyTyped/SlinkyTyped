...
@js.native
trait ColumnsEmbeddedMetadataEntityMetadata extends js.Object {
...
object ColumnsEmbeddedMetadataEntityMetadata {
  ...
  @scala.inline
  implicit class ColumnsEmbeddedMetadataEntityMetadataOps[Self <: ColumnsEmbeddedMetadataEntityMetadata] (val x: Self) extends AnyVal {
