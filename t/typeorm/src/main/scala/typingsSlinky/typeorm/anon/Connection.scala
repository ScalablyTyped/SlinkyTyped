...
object Connection {
  ...
  implicit class ConnectionOps[Self <: Connection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParentClosureEntityMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = this.set("parentClosureEntityMetadata", value.asInstanceOf[js.Any])
