...
@js.native
trait SubQuery extends js.Object {
  
  var metadata: js.UndefOr[typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata] = js.native
...
object SubQuery {
  ...
  @scala.inline
  implicit class SubQueryOps[Self <: SubQuery] (val x: Self) extends AnyVal {
