...
object Deferrable {
  ...
  implicit class DeferrableOps[Self <: Deferrable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReferencedEntityMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = this.set("referencedEntityMetadata", value.asInstanceOf[js.Any])
