...
trait Deferrable extends StObject {
  ...
  var referencedEntityMetadata: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata = js.native
}
object Deferrable {
  ...
  def apply(
    ...
    referencedEntityMetadata: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata
  ): Deferrable = {
  ...
  implicit class DeferrableMutableBuilder[Self <: Deferrable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReferencedEntityMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = StObject.set(x, "referencedEntityMetadata", value.asInstanceOf[js.Any])
  }
}
