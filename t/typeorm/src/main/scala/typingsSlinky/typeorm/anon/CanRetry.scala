...
@js.native
trait CanRetry extends js.Object {
...
object CanRetry {
  ...
  @scala.inline
  def apply(master: MysqlConnectionCredentialsOptions, slaves: js.Array[MysqlConnectionCredentialsOptions]): CanRetry = {
  ...
  @scala.inline
  implicit class CanRetryOps[Self <: CanRetry] (val x: Self) extends AnyVal {
