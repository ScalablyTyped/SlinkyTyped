...
trait PartialRelationIdAttribut extends StObject {
  ...
  var junctionMetadata: js.UndefOr[typingsSlinky.typeorm.entityMetadataMod.EntityMetadata] = js.native
...
object PartialRelationIdAttribut {
  ...
  implicit class PartialRelationIdAttributMutableBuilder[Self <: PartialRelationIdAttribut] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJunctionMetadata(value: typingsSlinky.typeorm.entityMetadataMod.EntityMetadata): Self = StObject.set(x, "junctionMetadata", value.asInstanceOf[js.Any])
