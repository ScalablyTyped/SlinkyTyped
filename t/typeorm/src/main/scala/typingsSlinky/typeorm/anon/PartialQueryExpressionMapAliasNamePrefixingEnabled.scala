...
import typingsSlinky.typeorm.queryBuilderJoinAttributeMod.JoinAttribute
...
import typingsSlinky.typeorm.queryBuilderSelectQueryBuilderOptionMod.SelectQueryBuilderOption
import typingsSlinky.typeorm.queryBuilderSelectQueryMod.SelectQuery
...
trait PartialQueryExpressionMapAliasNamePrefixingEnabled extends StObject {
  ...
  var connection: js.UndefOr[typingsSlinky.typeorm.connectionConnectionMod.Connection] = js.native
  
  var constructor: js.UndefOr[
    js.Function1[/* connection */ typingsSlinky.typeorm.connectionConnectionMod.Connection, js.Any]
  ] = js.native
...
object PartialQueryExpressionMapAliasNamePrefixingEnabled {
  ...
  implicit class PartialQueryExpressionMapAliasNamePrefixingEnabledMutableBuilder[Self <: PartialQueryExpressionMapAliasNamePrefixingEnabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(value: /* connection */ typingsSlinky.typeorm.connectionConnectionMod.Connection => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setLockVersion(value: Double | js.Date): Self = StObject.set(x, "lockVersion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLockVersionDate(value: js.Date): Self = StObject.set(x, "lockVersion", value.asInstanceOf[js.Any])
