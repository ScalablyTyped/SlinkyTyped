...
object PartialQueryExpressionMapAliasNamePrefixingEnabled {
  ...
  implicit class PartialQueryExpressionMapAliasNamePrefixingEnabledOps[Self <: PartialQueryExpressionMapAliasNamePrefixingEnabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(value: /* connection */ typingsSlinky.typeorm.connectionConnectionMod.Connection => js.Any): Self = this.set("constructor", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setLockVersionDate(value: js.Date): Self = this.set("lockVersion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLockVersion(value: Double | js.Date): Self = this.set("lockVersion", value.asInstanceOf[js.Any])
