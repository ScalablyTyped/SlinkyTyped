...
import typingsSlinky.typeorm.mongodbTypingsMod.ClientSession
import typingsSlinky.typeorm.mongodbTypingsMod.CollationDocument
import typingsSlinky.typeorm.mongodbTypingsMod.Timestamp
...
object ChangeStreamOptionsstartABatchSize {
  ...
  implicit class ChangeStreamOptionsstartABatchSizeMutableBuilder[Self <: ChangeStreamOptionsstartABatchSize] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReadPreference(value: typingsSlinky.typeorm.mongodbTypingsMod.ReadPreference): Self = StObject.set(x, "readPreference", value.asInstanceOf[js.Any])
