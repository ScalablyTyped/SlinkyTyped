...
object Args {
  ...
  implicit class ArgsOps[Self <: Args] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParentClosureEntityMetadata(value: typingsSlinky.typeorm.entityMetadataMod.EntityMetadata): Self = this.set("parentClosureEntityMetadata", value.asInstanceOf[js.Any])
