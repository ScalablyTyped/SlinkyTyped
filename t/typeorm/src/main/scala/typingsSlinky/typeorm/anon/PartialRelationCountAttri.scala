...
object PartialRelationCountAttri {
  ...
  implicit class PartialRelationCountAttriOps[Self <: PartialRelationCountAttri] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJoinInverseSideMetadata(value: typingsSlinky.typeorm.entityMetadataMod.EntityMetadata): Self = this.set("joinInverseSideMetadata", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMetadata(value: typingsSlinky.typeorm.entityMetadataMod.EntityMetadata): Self = this.set("metadata", value.asInstanceOf[js.Any])
