...
@js.native
trait PartialRelationCountAttri extends StObject {
  ...
  var joinInverseSideMetadata: js.UndefOr[typingsSlinky.typeorm.entityMetadataMod.EntityMetadata] = js.native
...
object PartialRelationCountAttri {
  ...
  @scala.inline
  implicit class PartialRelationCountAttriMutableBuilder[Self <: PartialRelationCountAttri] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJoinInverseSideMetadata(value: typingsSlinky.typeorm.entityMetadataMod.EntityMetadata): Self = StObject.set(x, "joinInverseSideMetadata", value.asInstanceOf[js.Any])
