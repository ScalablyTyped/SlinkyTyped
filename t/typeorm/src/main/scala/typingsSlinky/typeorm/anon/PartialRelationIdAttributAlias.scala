...
trait PartialRelationIdAttributAlias extends StObject {
  ...
  var joinInverseSideMetadata: js.UndefOr[typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata] = js.native
  
  var junctionAlias: js.UndefOr[String] = js.native
  
  var junctionMetadata: js.UndefOr[typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata] = js.native
...
object PartialRelationIdAttributAlias {
  ...
  implicit class PartialRelationIdAttributAliasMutableBuilder[Self <: PartialRelationIdAttributAlias] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJoinInverseSideMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = StObject.set(x, "joinInverseSideMetadata", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJunctionMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = StObject.set(x, "junctionMetadata", value.asInstanceOf[js.Any])
