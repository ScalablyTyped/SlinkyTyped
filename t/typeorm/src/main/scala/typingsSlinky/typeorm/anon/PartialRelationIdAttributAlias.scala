...
object PartialRelationIdAttributAlias {
  ...
  implicit class PartialRelationIdAttributAliasOps[Self <: PartialRelationIdAttributAlias] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJoinInverseSideMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = this.set("joinInverseSideMetadata", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJunctionMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = this.set("junctionMetadata", value.asInstanceOf[js.Any])
