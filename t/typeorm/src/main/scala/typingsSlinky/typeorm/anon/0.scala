...
trait `0` extends StObject {
  ...
  var readPreference: typingsSlinky.typeorm.typingsMod.ReadPreference | String = js.native
}
object `0` {
  
  @scala.inline
  def apply(readPreference: typingsSlinky.typeorm.typingsMod.ReadPreference | String): `0` = {
