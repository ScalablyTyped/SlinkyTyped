...
trait PartialQueryExpressionMap extends StObject {
  ...
  var connection: js.UndefOr[typingsSlinky.typeorm.connectionMod.Connection] = js.native
  
  var constructor: js.UndefOr[
    js.Function1[/* connection */ typingsSlinky.typeorm.connectionMod.Connection, js.Any]
  ] = js.native
...
object PartialQueryExpressionMap {
  ...
  implicit class PartialQueryExpressionMapMutableBuilder[Self <: PartialQueryExpressionMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(value: /* connection */ typingsSlinky.typeorm.connectionMod.Connection => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
