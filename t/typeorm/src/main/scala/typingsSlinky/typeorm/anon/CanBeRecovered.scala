...
import typingsSlinky.typeorm.persistenceSubjectChangeMapMod.SubjectChangeMap
...
@js.native
trait CanBeRecovered extends js.Object {
  ...
  var metadata: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata = js.native
...
object CanBeRecovered {
  ...
  @scala.inline
  def apply(metadata: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): CanBeRecovered = {
    val __obj = js.Dynamic.literal(metadata = metadata.asInstanceOf[js.Any])
    __obj.asInstanceOf[CanBeRecovered]
  }
  
  @scala.inline
  implicit class CanBeRecoveredOps[Self <: CanBeRecovered] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMetadata(value: typingsSlinky.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = this.set("metadata", value.asInstanceOf[js.Any])
