...
object AlwaysEnabled {
  ...
  implicit class AlwaysEnabledMutableBuilder[Self <: AlwaysEnabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProvider(value: /* connection */ typingsSlinky.typeorm.connectionMod.Connection => QueryResultCache): Self = StObject.set(x, "provider", js.Any.fromFunction1(value))
