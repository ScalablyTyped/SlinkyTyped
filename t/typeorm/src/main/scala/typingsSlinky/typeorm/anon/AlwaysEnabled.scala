...
@js.native
trait AlwaysEnabled extends js.Object {
  ...
  val provider: js.UndefOr[
    js.Function1[/* connection */ typingsSlinky.typeorm.connectionMod.Connection, QueryResultCache]
  ] = js.native
...
object AlwaysEnabled {
  ...
  @scala.inline
  implicit class AlwaysEnabledOps[Self <: AlwaysEnabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProvider(value: /* connection */ typingsSlinky.typeorm.connectionMod.Connection => QueryResultCache): Self = this.set("provider", js.Any.fromFunction1(value))
