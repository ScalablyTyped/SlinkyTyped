...
import typingsSlinky.typeorm.mysqlMysqlDriverMod.MysqlDriver
...
@JSImport("typeorm/driver/mysql/MysqlQueryRunner", JSImport.Namespace)
@js.native
object mysqlMysqlQueryRunnerMod extends js.Object {
