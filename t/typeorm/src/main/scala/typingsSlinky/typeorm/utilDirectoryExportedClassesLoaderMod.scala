...
object utilDirectoryExportedClassesLoaderMod {
  ...
  @JSImport("typeorm/util/DirectoryExportedClassesLoader", "importClassesFromDirectories")
  @js.native
  ...
  @JSImport("typeorm/util/DirectoryExportedClassesLoader", "importJsonsFromDirectories")
  @js.native
