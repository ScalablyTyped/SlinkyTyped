...
import typingsSlinky.typeorm.anon.Entities
import typingsSlinky.typeorm.anon.PartialQueryExpressionMapAliasNamePrefixingEnabled
import typingsSlinky.typeorm.anon.Raw
