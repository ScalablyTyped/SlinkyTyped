...
import typingsSlinky.typeorm.cockroachDriverMod.CockroachDriver
...
@JSImport("typeorm/browser/driver/cockroachdb/CockroachQueryRunner", JSImport.Namespace)
@js.native
object cockroachQueryRunnerMod extends js.Object {
