...
import typingsSlinky.typeorm.anon.`0`
...
@JSImport("typeorm/browser/driver/mongodb/typings", "Db")
@js.native
class Db protected () extends EventEmitter {
  ...
  def command(command: js.Object, options: `0`): js.Promise[_] = js.native
  /**
    * Execute a command.
    *
    * @param command The command hash.
    ...
    * @see http://mongodb.github.io/node-mongodb-native/2.1/api/Db.html#command
    */
  def command(command: js.Object, options: `0`, callback: MongoCallback[_]): Unit = js.native
