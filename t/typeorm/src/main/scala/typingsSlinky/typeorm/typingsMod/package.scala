...
package object typingsMod {
  ...
  type EndCallback = js.Function1[/* error */ typingsSlinky.typeorm.typingsMod.MongoError, scala.Unit]
  ...
  type GridFSBucketErrorCallback = js.Function1[/* err */ js.UndefOr[typingsSlinky.typeorm.typingsMod.MongoError], scala.Unit]
  
  type IteratorCallback[T] = js.Function1[/* doc */ T, scala.Unit]
  
  type MongoCallback[T] = js.Function2[/* error */ typingsSlinky.typeorm.typingsMod.MongoError, /* result */ T, scala.Unit]
}
