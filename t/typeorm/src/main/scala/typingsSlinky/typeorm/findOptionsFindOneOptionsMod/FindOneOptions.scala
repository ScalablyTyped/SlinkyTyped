package typingsSlinky.typeorm.findOptionsFindOneOptionsMod

import org.scalablytyped.runtime.TopLevel
import typingsSlinky.typeorm.anon.DisableMixedMap
import typingsSlinky.typeorm.anon.Milliseconds
import typingsSlinky.typeorm.anon.Mode
import typingsSlinky.typeorm.anon.`2`
...
import typingsSlinky.typeorm.findOptionsJoinOptionsMod.JoinOptions
...
trait FindOneOptions[Entity] extends js.Object {
  ...
  {[ P in keyof Entity ]:? 'ASC' | 'DESC' | 1 | -1}
    */ typingsSlinky.typeorm.typeormStrings.FindOneOptions with TopLevel[js.Any]
  ] = js.native
