package typingsSlinky.typeorm.cockroachdbCockroachConnectionCredentialsOptionsMod
...
@js.native
trait CockroachConnectionCredentialsOptions extends js.Object {
...
object CockroachConnectionCredentialsOptions {
  ...
  @scala.inline
  implicit class CockroachConnectionCredentialsOptionsOps[Self <: CockroachConnectionCredentialsOptions] (val x: Self) extends AnyVal {
