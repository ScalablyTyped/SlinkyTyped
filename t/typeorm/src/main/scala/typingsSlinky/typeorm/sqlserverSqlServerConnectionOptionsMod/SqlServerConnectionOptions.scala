package typingsSlinky.typeorm.sqlserverSqlServerConnectionOptionsMod
...
object SqlServerConnectionOptions {
  ...
  implicit class SqlServerConnectionOptionsOps[Self <: SqlServerConnectionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplication(value: SlavesArray): Self = this.set("replication", value.asInstanceOf[js.Any])
