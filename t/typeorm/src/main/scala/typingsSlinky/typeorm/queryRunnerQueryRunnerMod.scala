...
import typingsSlinky.typeorm.driverSqlInMemoryMod.SqlInMemory
...
import typingsSlinky.typeorm.subscriberBroadcasterMod.Broadcaster
...
object queryRunnerQueryRunnerMod extends js.Object {
  ...
  trait QueryRunner extends js.Object {
    ...
    def changeColumns(table: String, changedColumns: js.Array[NewColumnTableColumn]): js.Promise[Unit] = js.native
    /**
      * Changes columns in the table.
      */
    def changeColumns(table: Table, changedColumns: js.Array[NewColumnTableColumn]): js.Promise[Unit] = js.native
    ...
    def dropTable(table: String, ifExist: js.UndefOr[scala.Nothing], dropForeignKeys: Boolean): js.Promise[Unit] = js.native
    ...
    def dropTable(table: Table, ifExist: js.UndefOr[scala.Nothing], dropForeignKeys: Boolean): js.Promise[Unit] = js.native
