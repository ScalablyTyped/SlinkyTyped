...
import typingsSlinky.typeorm.broadcasterMod.Broadcaster
...
@JSImport("typeorm/browser/query-runner/QueryRunner", JSImport.Namespace)
@js.native
object queryRunnerMod extends js.Object {
