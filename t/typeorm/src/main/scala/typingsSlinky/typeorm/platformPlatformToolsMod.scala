...
import typingsSlinky.typeorm.typeormStrings.browser
import typingsSlinky.typeorm.typeormStrings.node
...
object platformPlatformToolsMod {
  ...
  @js.native
  class EventEmitter ()
    extends typingsSlinky.node.eventsMod.EventEmitter {
  ...
  object EventEmitter {
    ...
    @js.native
    def listenerCount(emitter: typingsSlinky.node.eventsMod.EventEmitter, event: String): Double = js.native
    @JSImport("typeorm/platform/PlatformTools", "EventEmitter.listenerCount")
    @js.native
    def listenerCount(emitter: typingsSlinky.node.eventsMod.EventEmitter, event: js.Symbol): Double = js.native
  }
  ...
  object Readable {
    ...
    @js.native
    def from(iterable: js.Iterable[_]): typingsSlinky.node.streamMod.Readable = js.native
    @JSImport("typeorm/platform/PlatformTools", "Readable.from")
    @js.native
    def from(iterable: js.Iterable[_], options: ReadableOptions): typingsSlinky.node.streamMod.Readable = js.native
    @JSImport("typeorm/platform/PlatformTools", "Readable.from")
    @js.native
    def from(iterable: AsyncIterable[_]): typingsSlinky.node.streamMod.Readable = js.native
    @JSImport("typeorm/platform/PlatformTools", "Readable.from")
    @js.native
    def from(iterable: AsyncIterable[_], options: ReadableOptions): typingsSlinky.node.streamMod.Readable = js.native
  }
