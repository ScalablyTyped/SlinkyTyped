package typingsSlinky.typeorm.sqljsConnectionOptionsMod
...
trait SqljsConnectionOptions
  ...
  /**
    ...
    */
  val database: js.UndefOr[js.typedarray.Uint8Array] = js.native
...
object SqljsConnectionOptions {
  ...
  implicit class SqljsConnectionOptionsOps[Self <: SqljsConnectionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDatabase(value: js.typedarray.Uint8Array): Self = this.set("database", value.asInstanceOf[js.Any])
