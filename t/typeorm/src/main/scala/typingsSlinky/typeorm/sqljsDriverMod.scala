...
import typingsSlinky.typeorm.sqljsConnectionOptionsMod.SqljsConnectionOptions
...
object sqljsDriverMod extends js.Object {
  ...
  class SqljsDriver protected () extends AbstractSqliteDriver {
    ...
    /* protected */ def createDatabaseConnectionWithImport(database: js.typedarray.Uint8Array): js.Promise[_] = js.native
    ...
    def load(fileNameOrLocalStorageOrData: js.typedarray.Uint8Array): js.Promise[_] = js.native
    def load(fileNameOrLocalStorageOrData: js.typedarray.Uint8Array, checkIfFileOrLocalStorageExists: Boolean): js.Promise[_] = js.native
