...
@js.native
trait ExecuteDbAdminCommandOptions extends js.Object {
...
object ExecuteDbAdminCommandOptions {
  ...
  @scala.inline
  implicit class ExecuteDbAdminCommandOptionsOps[Self <: ExecuteDbAdminCommandOptions] (val x: Self) extends AnyVal {
