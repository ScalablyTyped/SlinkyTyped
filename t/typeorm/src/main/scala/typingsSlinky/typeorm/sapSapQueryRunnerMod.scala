...
import typingsSlinky.typeorm.sapSapDriverMod.SapDriver
...
@JSImport("typeorm/driver/sap/SapQueryRunner", JSImport.Namespace)
@js.native
object sapSapQueryRunnerMod extends js.Object {
