...
class Client protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(sid: String): js.Promise[typingsSlinky.twilioDashMcsDashClient.libMediaMod.Media] = js.native
  /**
    ...
    * @returns {Promise<Media>}
    */
  def post(contentType: String, media: String): js.Promise[typingsSlinky.twilioDashMcsDashClient.libMediaMod.Media] = js.native
  def post(contentType: String, media: Buffer): js.Promise[typingsSlinky.twilioDashMcsDashClient.libMediaMod.Media] = js.native
  /**
    ...
    * @returns {Promise<Media>}
    */
  def postFormData(formData: FormData): js.Promise[typingsSlinky.twilioDashMcsDashClient.libMediaMod.Media] = js.native
  /**
