...
trait JSPMConfiguration extends js.Object {
  /**
  		JSPM configuration.
  		*/
  var jspm: js.UndefOr[typingsSlinky.typeFest.packageJsonMod.PackageJson] = js.undefined
}

object JSPMConfiguration {
  @scala.inline
  def apply(jspm: typingsSlinky.typeFest.packageJsonMod.PackageJson = null): JSPMConfiguration = {
