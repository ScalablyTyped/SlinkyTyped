...
trait JSPMConfiguration extends js.Object {
  /**
  		JSPM configuration.
  		*/
  var jspm: js.UndefOr[typingsSlinky.typeDashFest.sourcePackageDashJsonMod.PackageJson] = js.undefined
}

object JSPMConfiguration {
  @scala.inline
  def apply(jspm: typingsSlinky.typeDashFest.sourcePackageDashJsonMod.PackageJson = null): JSPMConfiguration = {
