...
trait TrustedTypePolicyFactory extends js.Object {
  ...
  def createPolicy[Keys /* <: /* keyof trusted-types.trusted-types._Global_.TrustedTypePolicyOptions */ createHTML | createScript | createScriptURL | createURL */](name: String, policyOptions: Pick[TrustedTypePolicyOptions, Keys]): Pick[TrustedTypePolicy, name | Keys] = js.native
  def createPolicy[Keys /* <: /* keyof trusted-types.trusted-types._Global_.TrustedTypePolicyOptions */ createHTML | createScript | createScriptURL | createURL */](name: String, policyOptions: Pick[TrustedTypePolicyOptions, Keys], expose: Boolean): Pick[TrustedTypePolicy, name | Keys] = js.native
