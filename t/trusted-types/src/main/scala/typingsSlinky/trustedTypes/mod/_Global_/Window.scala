...
trait Window extends js.Object {
  var TrustedHTML: typingsSlinky.trustedTypes.mod._Global_.TrustedHTML
  var TrustedScript: typingsSlinky.trustedTypes.mod._Global_.TrustedScript
  var TrustedScriptURL: typingsSlinky.trustedTypes.mod._Global_.TrustedScriptURL
  var TrustedTypePolicy: typingsSlinky.trustedTypes.mod._Global_.TrustedTypePolicy
  var TrustedTypePolicyFactory: typingsSlinky.trustedTypes.mod._Global_.TrustedTypePolicyFactory
  /** @deprecated Prefer the lowercase version. */
  var TrustedTypes: js.UndefOr[TrustedTypePolicyFactory] = js.undefined
  var TrustedURL: typingsSlinky.trustedTypes.mod._Global_.TrustedURL
