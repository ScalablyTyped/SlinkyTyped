package typingsSlinky.trustedDashTypes.trustedDashTypesMod._Global_
...
trait Window extends js.Object {
  var TrustedHTML: typingsSlinky.trustedDashTypes.trustedDashTypesMod._Global_.TrustedHTML
  var TrustedScript: typingsSlinky.trustedDashTypes.trustedDashTypesMod._Global_.TrustedScript
  var TrustedScriptURL: typingsSlinky.trustedDashTypes.trustedDashTypesMod._Global_.TrustedScriptURL
  var TrustedTypePolicy: typingsSlinky.trustedDashTypes.trustedDashTypesMod._Global_.TrustedTypePolicy
  var TrustedTypePolicyFactory: typingsSlinky.trustedDashTypes.trustedDashTypesMod._Global_.TrustedTypePolicyFactory
  /** @deprecated Prefer the lowercase version. */
  var TrustedTypes: js.UndefOr[TrustedTypePolicyFactory] = js.undefined
  var TrustedURL: typingsSlinky.trustedDashTypes.trustedDashTypesMod._Global_.TrustedURL
