package typingsSlinky.atTestingDashLibraryJestDashDom
...
object jest extends js.Object {
  ...
  trait Matchers[R, T] extends js.Object {
    ...
    def toHaveTextContent(text: String, options: Anon_NormalizeWhitespace): R = js.native
    def toHaveTextContent(text: RegExp): R = js.native
    def toHaveTextContent(text: RegExp, options: Anon_NormalizeWhitespace): R = js.native
