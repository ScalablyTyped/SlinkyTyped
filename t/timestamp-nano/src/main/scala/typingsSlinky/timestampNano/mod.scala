...
object mod {
  ...
  @JSImport("timestamp-nano", "fromInt64BE")
  @js.native
  def fromInt64BE(time: js.typedarray.Uint8Array): Timestamp = js.native
  @JSImport("timestamp-nano", "fromInt64BE")
  @js.native
  def fromInt64BE(time: js.typedarray.Uint8Array, offset: Double): Timestamp = js.native
  ...
  @JSImport("timestamp-nano", "fromInt64LE")
  @js.native
  def fromInt64LE(time: js.typedarray.Uint8Array): Timestamp = js.native
  @JSImport("timestamp-nano", "fromInt64LE")
  @js.native
  def fromInt64LE(time: js.typedarray.Uint8Array, offset: Double): Timestamp = js.native
