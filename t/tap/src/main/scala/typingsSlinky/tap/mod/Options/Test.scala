...
object Test {
  ...
  implicit class TestOps[Self <: Test] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGrepVarargs(value: js.RegExp*): Self = this.set("grep", js.Array(value :_*))
    @scala.inline
    def setGrep(value: js.Array[js.RegExp]): Self = this.set("grep", value.asInstanceOf[js.Any])
    @scala.inline
