...
object ProfileInfo {
  ...
  implicit class ProfileInfoOps[Self <: ProfileInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResultInt32Array(value: js.typedarray.Int32Array): Self = this.set("result", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResultFloat32Array(value: js.typedarray.Float32Array): Self = this.set("result", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResultUint8Array(value: js.typedarray.Uint8Array): Self = this.set("result", value.asInstanceOf[js.Any])
