...
object typesMod {
  ...
  object ModelArtifacts {
    ...
    implicit class ModelArtifactsMutableBuilder[Self <: ModelArtifacts] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setModelTopology(value: js.Object | js.typedarray.ArrayBuffer): Self = StObject.set(x, "modelTopology", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setModelTopologyArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "modelTopology", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWeightData(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "weightData", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.tensorflowTfjsCore.tensorflowTfjsCoreStrings.model
    - typingsSlinky.tensorflowTfjsCore.tensorflowTfjsCoreStrings.optimizer
  */
