...
import typingsSlinky.tensorflowTfjsCore.webglTypesMod.WebGL1DisjointQueryTimerExtension
import typingsSlinky.tensorflowTfjsCore.webglTypesMod.WebGL2DisjointQueryTimerExtension
