...
object RandNormalDataTypes {
  @scala.inline
  def apply(float32: js.typedarray.Float32Array, int32: js.typedarray.Int32Array): RandNormalDataTypes = {
  ...
  @scala.inline
  implicit class RandNormalDataTypesOps[Self <: RandNormalDataTypes] (val x: Self) extends AnyVal {
    @scala.inline
