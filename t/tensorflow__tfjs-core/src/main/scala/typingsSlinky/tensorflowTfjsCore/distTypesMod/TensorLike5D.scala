...
*/
trait TensorLike5D extends js.Object
...
object TensorLike5D {
  ...
  ): TensorLike5D = value.asInstanceOf[TensorLike5D]
  @scala.inline
  implicit def apply(value: TypedArray): TensorLike5D = value.asInstanceOf[TensorLike5D]
}
