...
object testUtilMod {
  ...
  @JSImport("@tensorflow/tfjs-core/dist/test_util", "expectArrayBuffersEqual")
  @js.native
  def expectArrayBuffersEqual(actual: js.typedarray.ArrayBuffer, expected: js.typedarray.ArrayBuffer): Unit = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/test_util", "expectArraysClose")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/test_util", "expectArraysEqual")
  @js.native
  def expectArraysEqual(actual: TensorLike, expected: TensorLike): Unit = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/test_util", "expectNumbersClose")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/test_util", "expectPromiseToFail")
  @js.native
  def expectPromiseToFail(fn: js.Function0[js.Promise[js.Object]], done: DoneFn): Unit = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/test_util", "expectValuesInRange")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/test_util", "testEpsilon")
  @js.native
