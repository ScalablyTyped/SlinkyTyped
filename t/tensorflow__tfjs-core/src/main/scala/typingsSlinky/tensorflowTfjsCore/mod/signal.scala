...
object signal {
  ...
  @JSImport("@tensorflow/tfjs-core", "signal.frame")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "signal.hammingWindow")
  @js.native
  def hammingWindow(windowLength: Double): Tensor[R1] = js.native
  
  @JSImport("@tensorflow/tfjs-core", "signal.hannWindow")
  @js.native
  def hannWindow(windowLength: Double): Tensor[R1] = js.native
  
  @JSImport("@tensorflow/tfjs-core", "signal.stft")
  @js.native
