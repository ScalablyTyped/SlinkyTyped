...
object Bias {
  @scala.inline
  def apply[/* <: typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor3D | typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor4D */ T](
  ...
  @scala.inline
  implicit class BiasOps[Self <: Bias[_], /* <: typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor3D | typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor4D */ T] (val x: Self with Bias[T]) extends AnyVal {
    @scala.inline
