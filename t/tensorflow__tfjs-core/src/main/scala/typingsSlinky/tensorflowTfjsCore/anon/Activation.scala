...
object Activation {
  ...
  @scala.inline
  implicit class ActivationOps[Self <: Activation[_], /* <: typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor3D | typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor4D */ T] (val x: Self with Activation[T]) extends AnyVal {
    @scala.inline
