...
object Grads {
  @scala.inline
  def apply[/* <: typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor[typingsSlinky.tensorflowTfjsCore.distTypesMod.Rank] */ T](grads: js.Array[Tensor[Rank]], value: T): Grads[T] = {
    val __obj = js.Dynamic.literal(grads = grads.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[Grads[T]]
  }
  @scala.inline
  implicit class GradsOps[Self <: Grads[_], /* <: typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor[typingsSlinky.tensorflowTfjsCore.distTypesMod.Rank] */ T] (val x: Self with Grads[T]) extends AnyVal {
    @scala.inline
