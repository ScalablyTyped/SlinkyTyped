...
object GradFunc {
  @scala.inline
  def apply[/* <: typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor[typingsSlinky.tensorflowTfjsCore.distTypesMod.Rank] */ T](gradFunc: (T, js.Array[Tensor[Rank]]) => Tensor[Rank] | js.Array[Tensor[Rank]], value: T): GradFunc[T] = {
  ...
  @scala.inline
  implicit class GradFuncOps[Self <: GradFunc[_], /* <: typingsSlinky.tensorflowTfjsCore.tensorMod.Tensor[typingsSlinky.tensorflowTfjsCore.distTypesMod.Rank] */ T] (val x: Self with GradFunc[T]) extends AnyVal {
    @scala.inline
