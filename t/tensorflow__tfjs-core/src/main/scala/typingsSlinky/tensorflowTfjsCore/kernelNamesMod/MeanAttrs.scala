...
@js.native
trait MeanAttrs extends js.Object {
...
object MeanAttrs {
  ...
  @scala.inline
  def apply(axis: Double | js.Array[Double], keepDims: Boolean): MeanAttrs = {
  ...
  @scala.inline
  implicit class MeanAttrsOps[Self <: MeanAttrs] (val x: Self) extends AnyVal {
