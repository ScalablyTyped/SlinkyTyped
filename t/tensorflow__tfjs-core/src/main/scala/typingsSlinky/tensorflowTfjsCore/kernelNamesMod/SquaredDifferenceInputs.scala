...
@js.native
trait SquaredDifferenceInputs extends StObject {
...
object SquaredDifferenceInputs {
  ...
  @scala.inline
  implicit class SquaredDifferenceInputsMutableBuilder[Self <: SquaredDifferenceInputs] (val x: Self) extends AnyVal {
