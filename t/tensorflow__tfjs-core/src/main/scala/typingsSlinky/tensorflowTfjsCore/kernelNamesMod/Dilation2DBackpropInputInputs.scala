...
@js.native
trait Dilation2DBackpropInputInputs extends js.Object {
...
object Dilation2DBackpropInputInputs {
  ...
  @scala.inline
  implicit class Dilation2DBackpropInputInputsOps[Self <: Dilation2DBackpropInputInputs] (val x: Self) extends AnyVal {
