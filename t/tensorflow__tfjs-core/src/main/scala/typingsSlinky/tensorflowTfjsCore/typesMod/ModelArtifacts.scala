...
object ModelArtifacts {
  ...
  implicit class ModelArtifactsOps[Self <: ModelArtifacts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModelTopology(value: js.Object | js.typedarray.ArrayBuffer): Self = this.set("modelTopology", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWeightData(value: js.typedarray.ArrayBuffer): Self = this.set("weightData", value.asInstanceOf[js.Any])
