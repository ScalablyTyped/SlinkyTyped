...
object distUtilMod {
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "arraysEqual")
  @js.native
  def arraysEqual(n1: FlatVector, n2: FlatVector): Boolean = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "assert")
  @js.native
  def assert(expr: Boolean, msg: js.Function0[String]): Unit = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "assertNonNegativeIntegerDimensions")
  @js.native
  def assertNonNegativeIntegerDimensions(shape: js.Array[Double]): Unit = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "assertNonNull")
  @js.native
  def assertNonNull(a: TensorLike): Unit = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "assertShapesMatch")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "bytesFromStringArray")
  @js.native
  def bytesFromStringArray(arr: js.Array[js.typedarray.Uint8Array]): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "bytesPerElement")
  @js.native
  def bytesPerElement(dtype: DataType): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "checkConversionForErrors")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "clamp")
  @js.native
  def clamp(min: Double, x: Double, max: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "computeStrides")
  @js.native
  def computeStrides(shape: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "createScalarValue")
  @js.native
  def createScalarValue(value: DataType, dtype: DataType): BackendValues = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "createShuffledIndices")
  @js.native
  def createShuffledIndices(n: Double): js.typedarray.Uint32Array = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "decodeString")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "distSquared")
  @js.native
  def distSquared(a: FlatVector, b: FlatVector): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "encodeString")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "fetch")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "flatten")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "getArrayFromDType")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "getTypedArrayFromDType")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "makeZerosNestedTypedArray")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "makeZerosTypedArray")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "nearestDivisor")
  @js.native
  def nearestDivisor(size: Double, start: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "nearestLargerEven")
  @js.native
  def nearestLargerEven(`val`: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "now")
  @js.native
  def now(): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "parseAxisParam")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "randUniform")
  @js.native
  def randUniform(a: Double, b: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "repeatedTry")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "rightPad")
  @js.native
  def rightPad(a: String, size: Double): String = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "shuffle")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "sizeFromShape")
  @js.native
  def sizeFromShape(shape: js.Array[Double]): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "sizeToSquarishShape")
  @js.native
  def sizeToSquarishShape(size: Double): js.Tuple2[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "squeezeShape")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/util", "sum")
  @js.native
  def sum(arr: js.Array[Double]): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "tanh")
  @js.native
  def tanh(x: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "toNestedArray")
  @js.native
  def toNestedArray(shape: js.Array[Double], a: TypedArray): Double | js.Array[_] = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/util", "toTypedArray")
  @js.native
