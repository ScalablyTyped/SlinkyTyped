...
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreNumbers.`1`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreNumbers.`2`
import typingsSlinky.atTensorflowTfjsDashCore.distBackendsWebglTexUnderscoreUtilMod.TextureConfig
...
object distWebglMod extends js.Object {
  @js.native
  class GPGPUContext ()
    extends typingsSlinky.atTensorflowTfjsDashCore.distBackendsWebglGpgpuUnderscoreContextMod.GPGPUContext {
    def this(gl: WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends typingsSlinky.atTensorflowTfjsDashCore.distBackendsWebglBackendUnderscoreWebglMod.MathBackendWebGL {
    def this(gpgpu: typingsSlinky.atTensorflowTfjsDashCore.distBackendsWebglGpgpuUnderscoreContextMod.GPGPUContext) = this()
  }
