...
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return min(BACKSLASHn    vec4(greaterThanEqual(a, vec4(1DOT0))) +BACKSLASHn    vec4(greaterThanEqual(b, vec4(1DOT0))),BACKSLASHn    vec4(1DOT0));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return vec4(BACKSLASHn    vec4(greaterThanEqual(a, vec4(1DOT0))) *BACKSLASHn    vec4(greaterThanEqual(b, vec4(1DOT0))));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return vec4(equal(a, b));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return vec4(greaterThan(a, b));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return vec4(greaterThanEqual(a, b));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return vec4(lessThan(a, b));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return vec4(lessThanEqual(a, b));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  return vec4(notEqual(a, b));BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  vec4 aLessThanZero = vec4(lessThan(a, vec4(0DOT)));BACKSLASHn  return (aLessThanZero * (b * a)) + ((vec4(1DOT0) - aLessThanZero) * a);BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  vec4 bGTEZero = vec4(greaterThanEqual(b, vec4(0DOT)));BACKSLASHn  return (bGTEZero * a) + ((vec4(1DOT0) - bGTEZero) * (a * (b + vec4(1DOT0))));BACKSLASHn`
