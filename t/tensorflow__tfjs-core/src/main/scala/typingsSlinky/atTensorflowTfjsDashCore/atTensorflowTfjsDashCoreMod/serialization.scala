...
object serialization extends js.Object {
  ...
  abstract class Serializable ()
    extends typingsSlinky.atTensorflowTfjsDashCore.distSerializationMod.Serializable
  
  @js.native
  class SerializationMap protected ()
    extends typingsSlinky.atTensorflowTfjsDashCore.distSerializationMod.SerializationMap
