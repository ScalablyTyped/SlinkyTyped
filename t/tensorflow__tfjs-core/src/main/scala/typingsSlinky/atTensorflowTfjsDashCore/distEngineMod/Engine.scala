...
import typingsSlinky.atTensorflowTfjsDashCore.Anon_Factory
import typingsSlinky.atTensorflowTfjsDashCore.Anon_Grads
...
import typingsSlinky.atTensorflowTfjsDashCore.distEnvironmentMod.Environment
...
class Engine protected ()
  ...
  {[ P in keyof I ]: (): I[P]}
    */ typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.Engine with I
    ]
  ): T = js.native
  def runKernelFunc[T /* <: Tensor[Rank] | js.Array[Tensor[Rank]] */, I /* <: NamedTensorMap */](
    forwardFunc: ForwardFunc[T],
