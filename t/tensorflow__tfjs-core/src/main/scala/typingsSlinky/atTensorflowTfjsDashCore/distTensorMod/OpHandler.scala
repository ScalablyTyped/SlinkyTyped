...
import typingsSlinky.atTensorflowTfjsDashCore.Anon_AlignCorners
import typingsSlinky.atTensorflowTfjsDashCore.Anon_Fft
...
import typingsSlinky.atTensorflowTfjsDashCore.distTypesMod.TensorLike3D
...
trait OpHandler extends js.Object {
  var image: Anon_AlignCorners = js.native
  var spectral: Anon_Fft = js.native
  ...
  def topk[T /* <: Tensor[Rank] */](x: T, k: Double, sorted: Boolean): Anon_Indices[T] = js.native
