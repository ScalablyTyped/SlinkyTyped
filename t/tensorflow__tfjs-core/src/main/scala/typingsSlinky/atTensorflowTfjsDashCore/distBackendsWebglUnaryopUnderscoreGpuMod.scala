...
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  float e2x = exp(-2DOT0 * abs(x));BACKSLASHn  return sign(x) * (1DOT0 - e2x) / (1DOT0 + e2x);BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  float e2x = exp(-x);BACKSLASHn  return (e2x + 1DOT0 / e2x) / 2DOT0;BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  float e2x = exp(x);BACKSLASHn  return (e2x - 1DOT0 / e2x) / 2DOT0;BACKSLASHn`
...
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`BACKSLASHn  if (isnan(x)) { return 0DOT0; }BACKSLASHn  return sign(x);BACKSLASHn`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`if (x < 0DOT0) return NAN;BACKSLASHn  return log(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return (x >= 0DOT0) ? x : (exp(x) - 1DOT0);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return -x;`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return 1DOT0 / (1DOT0 + exp(-1DOT0 * x));`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return 1DOT0 / x;`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return abs(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return ceil(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return exp(x) - 1DOT0;`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return exp(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return float(!(x >= 1DOT0));`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return float(!isnan(x) && !isinf(x));`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return float(int(x));`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return float(isinf(x));`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return float(isnan(x));`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return floor(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return inversesqrt(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return log(1DOT0 + x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return sqrt(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return tan(x);`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return x * x;`
import typingsSlinky.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.`return x;`
