...
import typingsSlinky.atTensorflowTfjsDashCore.distBackendsWebglWebglUnderscoreTypesMod.WebGL1DisjointQueryTimerExtension
import typingsSlinky.atTensorflowTfjsDashCore.distBackendsWebglWebglUnderscoreTypesMod.WebGL2DisjointQueryTimerExtension
