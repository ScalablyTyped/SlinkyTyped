...
import typingsSlinky.tarDashStream.tarDashStreamStrings.`block-device`
import typingsSlinky.tarDashStream.tarDashStreamStrings.`character-device`
import typingsSlinky.tarDashStream.tarDashStreamStrings.`contiguous-file`
import typingsSlinky.tarDashStream.tarDashStreamStrings.`gnu-long-link-path`
import typingsSlinky.tarDashStream.tarDashStreamStrings.`gnu-long-path`
import typingsSlinky.tarDashStream.tarDashStreamStrings.`pax-global-header`
import typingsSlinky.tarDashStream.tarDashStreamStrings.`pax-header`
import typingsSlinky.tarDashStream.tarDashStreamStrings.directory
import typingsSlinky.tarDashStream.tarDashStreamStrings.fifo
import typingsSlinky.tarDashStream.tarDashStreamStrings.file
import typingsSlinky.tarDashStream.tarDashStreamStrings.link
import typingsSlinky.tarDashStream.tarDashStreamStrings.symlink
