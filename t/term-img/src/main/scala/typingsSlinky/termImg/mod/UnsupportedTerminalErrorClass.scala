...
trait UnsupportedTerminalErrorClass extends Error {
  @JSName("name")
  val name_UnsupportedTerminalErrorClass: typingsSlinky.termImg.termImgStrings.UnsupportedTerminalError
}
...
object UnsupportedTerminalErrorClass {
  ...
  def apply(
    message: String,
    name: typingsSlinky.termImg.termImgStrings.UnsupportedTerminalError,
    stack: String = null
