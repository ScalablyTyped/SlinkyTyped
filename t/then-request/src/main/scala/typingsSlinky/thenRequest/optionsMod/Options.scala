package typingsSlinky.thenRequest.optionsMod
...
import typingsSlinky.thenRequest.thenRequestStrings.file
import typingsSlinky.thenRequest.thenRequestStrings.memory
...
trait Options extends js.Object {
  ...
  var form: js.UndefOr[typingsSlinky.formData.mod.^] = js.native
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForm(value: typingsSlinky.formData.mod.^): Self = this.set("form", value.asInstanceOf[js.Any])
