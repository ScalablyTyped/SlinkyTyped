...
import typingsSlinky.typestyle.libTypesMod.MediaQuery
...
object typestyleMod extends js.Object {
  ...
  class TypeStyle protected ()
    extends typingsSlinky.typestyle.libInternalTypestyleMod.TypeStyle {
  ...
  def createTypeStyle(): typingsSlinky.typestyle.libInternalTypestyleMod.TypeStyle = js.native
  def createTypeStyle(target: Anon_TextContent): typingsSlinky.typestyle.libInternalTypestyleMod.TypeStyle = js.native
