package typingsSlinky.tizenTvWebapis.adinfoMod
...
@js.native
trait AdInfoManager extends js.Object {
...
object AdInfoManager {
  ...
  @scala.inline
  implicit class AdInfoManagerOps[Self <: AdInfoManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetTIFA(value: () => String): Self = this.set("getTIFA", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetVersion(value: () => String): Self = this.set("getVersion", js.Any.fromFunction0(value))
    
    @scala.inline
    def setIsLATEnabled(value: () => Boolean): Self = this.set("isLATEnabled", js.Any.fromFunction0(value))
  }
}
