...
object avinfoMod {
  ...
  object AvInfoDigitalCompMode extends StObject {
    ...
    /* 0 */ val DOLBY_DIGITAL_COMP_MODE_LINE: typingsSlinky.tizenTvWebapis.avinfoMod.AvInfoDigitalCompMode.DOLBY_DIGITAL_COMP_MODE_LINE with Double = js.native
    ...
    /* 1 */ val DOLBY_DIGITAL_COMP_MODE_RF: typingsSlinky.tizenTvWebapis.avinfoMod.AvInfoDigitalCompMode.DOLBY_DIGITAL_COMP_MODE_RF with Double = js.native
  }
