...
object NetworkWiFiSecurityMode extends StObject {
  ...
  /* 4 */ val EAP: typingsSlinky.tizenTvWebapis.networkMod.NetworkWiFiSecurityMode.EAP with Double = js.native
  ...
  /* 5 */ val NONE: typingsSlinky.tizenTvWebapis.networkMod.NetworkWiFiSecurityMode.NONE with Double = js.native
  ...
  /* 6 */ val UNKNOWN: typingsSlinky.tizenTvWebapis.networkMod.NetworkWiFiSecurityMode.UNKNOWN with Double = js.native
  ...
  /* 1 */ val WEP: typingsSlinky.tizenTvWebapis.networkMod.NetworkWiFiSecurityMode.WEP with Double = js.native
  ...
  /* 3 */ val WPA2_PSK: typingsSlinky.tizenTvWebapis.networkMod.NetworkWiFiSecurityMode.WPA2_PSK with Double = js.native
  ...
  /* 2 */ val WPA_PSK: typingsSlinky.tizenTvWebapis.networkMod.NetworkWiFiSecurityMode.WPA_PSK with Double = js.native
}
