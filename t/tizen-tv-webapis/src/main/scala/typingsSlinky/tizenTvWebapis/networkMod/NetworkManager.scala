...
import typingsSlinky.tizenTvWebapis.anon.AES
import typingsSlinky.tizenTvWebapis.anon.AUTO
import typingsSlinky.tizenTvWebapis.anon.CELLULAR
import typingsSlinky.tizenTvWebapis.anon.EAP
import typingsSlinky.tizenTvWebapis.anon.GATEWAYCONNECTED
