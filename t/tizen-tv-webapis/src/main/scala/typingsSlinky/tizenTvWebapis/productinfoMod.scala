...
import typingsSlinky.tizenTvWebapis.anon.CONFIGKEYDATASERVICE
import typingsSlinky.tizenTvWebapis.anon.NOGLASS3DNOTSUPPORTED
import typingsSlinky.tizenTvWebapis.anon.SITYPEDEVELOPINGSERVER
...
object productinfoMod {
  ...
  object ProductInfoConfigKey extends StObject {
    ...
    /* 0 */ val CONFIG_KEY_DATA_SERVICE: typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoConfigKey.CONFIG_KEY_DATA_SERVICE with Double = js.native
    ...
    /* 1 */ val CONFIG_KEY_SERVICE_COUNTRY: typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoConfigKey.CONFIG_KEY_SERVICE_COUNTRY with Double = js.native
  }
  ...
  object ProductInfoNoGlass3dSupport extends StObject {
    ...
    /* 0 */ val NO_GLASS_3D_NOT_SUPPORTED: typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoNoGlass3dSupport.NO_GLASS_3D_NOT_SUPPORTED with Double = js.native
    ...
    /* 1 */ val NO_GLASS_3D_SUPPORTED: typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoNoGlass3dSupport.NO_GLASS_3D_SUPPORTED with Double = js.native
  }
  ...
  object ProductInfoSiServerType extends StObject {
    ...
    /* 2 */ val SI_TYPE_DEVELOPING_SERVER: typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoSiServerType.SI_TYPE_DEVELOPING_SERVER with Double = js.native
    ...
    /* 1 */ val SI_TYPE_DEVELOPMENT_SERVER: typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoSiServerType.SI_TYPE_DEVELOPMENT_SERVER with Double = js.native
    ...
    /* 0 */ val SI_TYPE_OPERATIING_SERVER: typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoSiServerType.SI_TYPE_OPERATIING_SERVER with Double = js.native
  }
