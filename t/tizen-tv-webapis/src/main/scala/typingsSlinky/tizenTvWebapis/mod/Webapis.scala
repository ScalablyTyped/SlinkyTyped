package typingsSlinky.tizenTvWebapis.mod

import typingsSlinky.tizenTvWebapis.adinfoMod.AdInfoManager
import typingsSlinky.tizenTvWebapis.appcommonMod.AppCommonManager
import typingsSlinky.tizenTvWebapis.avinfoMod.AVInfoManager
import typingsSlinky.tizenTvWebapis.avplayMod.AVPlayManager
import typingsSlinky.tizenTvWebapis.avplaystoreMod.AVPlayStoreManager
import typingsSlinky.tizenTvWebapis.billingMod.BillingManager
import typingsSlinky.tizenTvWebapis.networkMod.NetworkManager
import typingsSlinky.tizenTvWebapis.productinfoMod.ProductInfoManager
import typingsSlinky.tizenTvWebapis.ssoMod.SsoManager
import typingsSlinky.tizenTvWebapis.tvinfoMod.TvInfoManager
import typingsSlinky.tizenTvWebapis.webapisMod.WebAPIException
import typingsSlinky.tizenTvWebapis.widgetdataMod.WidgetDataManager
...
trait Webapis extends js.Object {
  ...
  var WebAPIException: typingsSlinky.tizenTvWebapis.webapisMod.WebAPIException = js.native
