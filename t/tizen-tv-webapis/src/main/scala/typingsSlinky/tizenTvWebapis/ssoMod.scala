...
object ssoMod {
  ...
  object SsoLoginState extends StObject {
    ...
    /* 1 */ val SSO_LOGIN: typingsSlinky.tizenTvWebapis.ssoMod.SsoLoginState.SSO_LOGIN with Double = js.native
    ...
    /* 0 */ val SSO_NOT_LOGIN: typingsSlinky.tizenTvWebapis.ssoMod.SsoLoginState.SSO_NOT_LOGIN with Double = js.native
  }
