...
import typingsSlinky.tizenTvWebapis.tizenTvWebapisStrings.DEV
import typingsSlinky.tizenTvWebapis.tizenTvWebapisStrings.PRD
...
object billingMod {
  ...
  object TVServerType extends StObject {
    ...
    /* "DEV" */ val DEV: typingsSlinky.tizenTvWebapis.billingMod.TVServerType.DEV with String = js.native
    
    @js.native
    sealed trait PRD extends TVServerType
    /* "PRD" */ val PRD: typingsSlinky.tizenTvWebapis.billingMod.TVServerType.PRD with String = js.native
  }
