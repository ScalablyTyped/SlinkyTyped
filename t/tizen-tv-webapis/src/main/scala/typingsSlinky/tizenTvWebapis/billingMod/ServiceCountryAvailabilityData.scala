...
@js.native
trait ServiceCountryAvailabilityData extends js.Object {
...
object ServiceCountryAvailabilityData {
  ...
  @scala.inline
  implicit class ServiceCountryAvailabilityDataOps[Self <: ServiceCountryAvailabilityData] (val x: Self) extends AnyVal {
