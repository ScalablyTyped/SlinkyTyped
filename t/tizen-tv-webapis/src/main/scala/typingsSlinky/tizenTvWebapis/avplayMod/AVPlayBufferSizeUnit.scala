...
object AVPlayBufferSizeUnit extends StObject {
  ...
  /* "PLAYER_BUFFER_SIZE_IN_BYTE" */ val PLAYER_BUFFER_SIZE_IN_BYTE: typingsSlinky.tizenTvWebapis.avplayMod.AVPlayBufferSizeUnit.PLAYER_BUFFER_SIZE_IN_BYTE with String = js.native
  
  @js.native
  sealed trait PLAYER_BUFFER_SIZE_IN_SECOND extends AVPlayBufferSizeUnit
  /* "PLAYER_BUFFER_SIZE_IN_SECOND" */ val PLAYER_BUFFER_SIZE_IN_SECOND: typingsSlinky.tizenTvWebapis.avplayMod.AVPlayBufferSizeUnit.PLAYER_BUFFER_SIZE_IN_SECOND with String = js.native
}
