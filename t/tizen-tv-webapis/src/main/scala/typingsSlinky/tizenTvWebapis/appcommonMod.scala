...
import typingsSlinky.tizenTvWebapis.anon.SCREENSAVEROFF
...
object appcommonMod {
  ...
  object AppCommonScreenSaverState extends StObject {
    ...
    /* 0 */ val SCREEN_SAVER_OFF: typingsSlinky.tizenTvWebapis.appcommonMod.AppCommonScreenSaverState.SCREEN_SAVER_OFF with Double = js.native
    ...
    /* 1 */ val SCREEN_SAVER_ON: typingsSlinky.tizenTvWebapis.appcommonMod.AppCommonScreenSaverState.SCREEN_SAVER_ON with Double = js.native
  }
