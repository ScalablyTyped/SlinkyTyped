...
import typingsSlinky.trtcJsSdk.mod.Role
import typingsSlinky.trtcJsSdk.mod.ScreenProfileString
import typingsSlinky.trtcJsSdk.mod.VideoProfileString
...
object trtcJsSdkStrings {
  ...
  @js.native
  sealed trait `connection-state-changed` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `peer-join` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `screen-sharing-stopped` extends StObject
  @scala.inline
