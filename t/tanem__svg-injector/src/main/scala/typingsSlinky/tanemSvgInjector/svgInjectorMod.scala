...
object svgInjectorMod {
  ...
  type Elements = HTMLCollectionOf[Element] | (NodeListOf[Element with Node]) | Element | Null
  ...
  object OptionalArgs {
    ...
    implicit class OptionalArgsMutableBuilder[Self <: OptionalArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAfterEach(value: (/* error */ js.Error | Null, /* svg */ js.UndefOr[SVGElement]) => Unit): Self = StObject.set(x, "afterEach", js.Any.fromFunction2(value))
