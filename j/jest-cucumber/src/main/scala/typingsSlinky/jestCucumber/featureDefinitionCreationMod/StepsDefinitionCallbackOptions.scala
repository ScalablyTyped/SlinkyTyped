package typingsSlinky.jestCucumber.featureDefinitionCreationMod
...
object StepsDefinitionCallbackOptions {
  ...
  @scala.inline
  def apply(
    and: (/* stepMatcher */ String | js.RegExp, /* stepDefinitionCallback */ js.Function1[/* repeated */ js.Any, js.Any]) => js.Any,
    but: (/* stepMatcher */ String | js.RegExp, /* stepDefinitionCallback */ js.Function1[/* repeated */ js.Any, js.Any]) => js.Any,
    defineStep: (/* stepMatcher */ String | js.RegExp, /* stepDefinitionCallback */ js.Function1[/* repeated */ js.Any, js.Any]) => js.Any,
    given: (/* stepMatcher */ String | js.RegExp, /* stepDefinitionCallback */ js.Function1[/* repeated */ js.Any, js.Any]) => js.Any,
    pending: () => Unit,
    `then`: (/* stepMatcher */ String | js.RegExp, /* stepDefinitionCallback */ js.Function1[/* repeated */ js.Any, js.Any]) => js.Any,
    when: (/* stepMatcher */ String | js.RegExp, /* stepDefinitionCallback */ js.Function1[/* repeated */ js.Any, js.Any]) => js.Any
  ...
  implicit class StepsDefinitionCallbackOptionsOps[Self <: StepsDefinitionCallbackOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnd(
      value: (/* stepMatcher */ String | js.RegExp, /* stepDefinitionCallback */ js.Function1[/* repeated */ js.Any, js.Any]) => js.Any
