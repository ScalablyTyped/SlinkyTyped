...
object generateCodeByLineNumberMod {
  ...
  object ObjectTypeEnum extends StObject {
    ...
    /* 0 */ val scenario: typingsSlinky.jestCucumber.generateCodeByLineNumberMod.ObjectTypeEnum.scenario with Double = js.native
    
    @js.native
    sealed trait scenarioOutline extends ObjectTypeEnum
    /* 1 */ val scenarioOutline: typingsSlinky.jestCucumber.generateCodeByLineNumberMod.ObjectTypeEnum.scenarioOutline with Double = js.native
    
    @js.native
    sealed trait step extends ObjectTypeEnum
    /* 2 */ val step: typingsSlinky.jestCucumber.generateCodeByLineNumberMod.ObjectTypeEnum.step with Double = js.native
  }
