package typingsSlinky.jestCucumber.anon

import typingsSlinky.jestCucumber.modelsMod.ErrorOptions
import typingsSlinky.jestCucumber.modelsMod.ScenarioNameTemplateVars
...
object Errors {
  ...
  implicit class ErrorsOps[Self <: Errors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrors(value: Boolean | ErrorOptions): Self = this.set("errors", value.asInstanceOf[js.Any])
