...
import typingsSlinky.jsonDashSchemaDashMergeDashAllof.Anon_AdditionalProperties
import typingsSlinky.jsonDashSchemaDashMergeDashAllof.jsonDashSchemaDashMergeDashAllofStrings.additionalProperties
import typingsSlinky.jsonDashSchemaDashMergeDashAllof.jsonDashSchemaDashMergeDashAllofStrings.patternProperties
...
trait Resolvers[Schema /* <: JSONSchema */] extends js.Object {
  ...
  def properties(
    ...
    Schema, 
    typingsSlinky.jsonDashSchemaDashMergeDashAllof.jsonDashSchemaDashMergeDashAllofStrings.properties | patternProperties | additionalProperties
  ] = js.native
