...
object DefaultResolver {
  @scala.inline
  def apply[/* <: typingsSlinky.jsonSchemaMergeAllof.mod.JSONSchema */ Schema](): DefaultResolver[Schema] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefaultResolver[Schema]]
  }
  @scala.inline
  implicit class DefaultResolverOps[Self <: DefaultResolver[_], /* <: typingsSlinky.jsonSchemaMergeAllof.mod.JSONSchema */ Schema] (val x: Self with DefaultResolver[Schema]) extends AnyVal {
    @scala.inline
