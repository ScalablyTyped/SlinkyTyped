...
object Options_ {
  @scala.inline
  def apply[/* <: typingsSlinky.jsonSchemaMergeAllof.mod.JSONSchema */ Schema](): Options_[Schema] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options_[Schema]]
  }
  @scala.inline
  implicit class Options_Ops[Self <: Options_[_], /* <: typingsSlinky.jsonSchemaMergeAllof.mod.JSONSchema */ Schema] (val x: Self with Options_[Schema]) extends AnyVal {
    @scala.inline
