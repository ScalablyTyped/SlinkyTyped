...
object Resolvers {
  @scala.inline
  def apply[/* <: typingsSlinky.jsonSchemaMergeAllof.mod.JSONSchema */ Schema](
    $id: (js.Array[
      /* import warning: importer.ImportType#apply Failed type conversion: std.Extract<Schema, json-schema-merge-allof.anon.Id>['$id'] */ js.Any
  ...
  @scala.inline
  implicit class ResolversOps[Self <: Resolvers[_], /* <: typingsSlinky.jsonSchemaMergeAllof.mod.JSONSchema */ Schema] (val x: Self with Resolvers[Schema]) extends AnyVal {
    @scala.inline
