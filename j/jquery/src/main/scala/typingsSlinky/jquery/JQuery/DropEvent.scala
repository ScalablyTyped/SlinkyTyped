...
object DropEvent {
  ...
  @scala.inline
  implicit class DropEventOps[Self <: DropEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (DropEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
