...
object DoubleClickEvent {
  ...
  @scala.inline
  implicit class DoubleClickEventOps[Self <: DoubleClickEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (DoubleClickEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: dblclick): Self = this.set("type", value.asInstanceOf[js.Any])
  }
