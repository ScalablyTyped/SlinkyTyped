...
object DragEventBase {
  ...
  @scala.inline
  implicit class DragEventBaseOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragEventBase[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOriginalEvent(value: org.scalajs.dom.raw.DragEvent): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
