...
trait DragEventBase[TDelegateTarget, TData, TCurrentTarget, TTarget] extends UIEventBase[TDelegateTarget, TData, TCurrentTarget, TTarget] {
  ...
  var originalEvent_DragEventBase: js.UndefOr[org.scalajs.dom.raw.DragEvent] = js.undefined
}
...
object DragEventBase {
  ...
  @scala.inline
  implicit class DragEventBaseOps[Self <: DragEventBase[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (DragEventBase[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOriginalEvent(value: org.scalajs.dom.raw.DragEvent): Self = this.set("originalEvent", value.asInstanceOf[js.Any])
    @scala.inline
