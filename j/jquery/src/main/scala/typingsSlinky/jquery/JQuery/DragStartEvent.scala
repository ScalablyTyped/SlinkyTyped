...
object DragStartEvent {
  ...
  @scala.inline
  implicit class DragStartEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragStartEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dragstart): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
