...
object BlurEvent {
  ...
  @scala.inline
  implicit class BlurEventOps[Self <: BlurEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (BlurEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: blur): Self = this.set("type", value.asInstanceOf[js.Any])
  }
