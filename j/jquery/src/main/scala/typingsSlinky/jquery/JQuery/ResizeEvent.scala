...
object ResizeEvent {
  ...
  @scala.inline
  implicit class ResizeEventOps[Self <: ResizeEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (ResizeEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: resize): Self = this.set("type", value.asInstanceOf[js.Any])
  }
