...
object DragEvent {
  ...
  @scala.inline
  implicit class DragEventOps[Self <: DragEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (DragEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
