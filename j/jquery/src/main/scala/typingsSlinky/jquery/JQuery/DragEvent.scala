...
object DragEvent {
  ...
  @scala.inline
  implicit class DragEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: drag): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
