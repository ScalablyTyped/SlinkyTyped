...
object TouchMoveEvent {
  ...
  @scala.inline
  implicit class TouchMoveEventOps[Self <: TouchMoveEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (TouchMoveEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: touchmove): Self = this.set("type", value.asInstanceOf[js.Any])
  }
