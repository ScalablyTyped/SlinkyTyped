...
import typingsSlinky.jquery.JQuery_.Coordinates
import typingsSlinky.jquery.JQuery_.CoordinatesPartial
import typingsSlinky.jquery.JQuery_.Duration
import typingsSlinky.jquery.JQuery_.EffectsOptions
import typingsSlinky.jquery.JQuery_.NameValuePair
...
import typingsSlinky.jquery.JQuery_.TypeEventHandler
import typingsSlinky.jquery.JQuery_.TypeEventHandlers
...
trait JQuery__[TElement]
  ...
  def trigger(eventType_event: typingsSlinky.jquery.JQuery_.Event): this.type = js.native
  def trigger(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: String): this.type = js.native
  def trigger(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: js.Array[_]): this.type = js.native
  def trigger(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: Boolean): this.type = js.native
  def trigger(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: Double): this.type = js.native
  def trigger(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: PlainObject[_]): this.type = js.native
  /**
  ...
  def triggerHandler(eventType_event: typingsSlinky.jquery.JQuery_.Event): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: String): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: js.Array[_]): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: Boolean): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: Double): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.jquery.JQuery_.Event, extraParameters: PlainObject[_]): js.Any = js.native
  /**
