...
trait AnonPreDispatch[TTarget]
  ...
  def preDispatch(event: typingsSlinky.jquery.JQuery_.Event): `false` | Unit = js.native
}
...
object AnonPreDispatch {
  ...
  implicit class AnonPreDispatchOps[Self[ttarget] <: AnonPreDispatch[ttarget], TTarget] (val x: Self[TTarget]) extends AnyVal {
    ...
    @scala.inline
    def withPreDispatch(value: typingsSlinky.jquery.JQuery_.Event => `false` | Unit): Self[TTarget] = {
