...
trait XHRFields extends js.Object {
  ...
  var onreadystatechange: js.UndefOr[js.ThisFunction1[/* this */ this.type, /* ev */ Event_, _]] = js.native
...
object XHRFields {
  ...
  implicit class XHRFieldsOps[Self <: XHRFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnreadystatechange(value: js.ThisFunction1[XHRFields, /* ev */ Event_, _]): Self = {
        val ret = this.duplicate
