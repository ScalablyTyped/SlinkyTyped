...
object DragLeaveEvent {
  ...
  @scala.inline
  implicit class DragLeaveEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragLeaveEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dragleave): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
