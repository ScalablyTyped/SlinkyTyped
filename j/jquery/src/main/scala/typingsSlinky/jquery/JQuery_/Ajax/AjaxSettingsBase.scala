package typingsSlinky.jquery.JQuery_.Ajax
...
object AjaxSettingsBase {
  ...
  implicit class AjaxSettingsBaseOps[Self[tcontext] <: AjaxSettingsBase[tcontext], TContext] (val x: Self[TContext]) extends AnyVal {
    ...
    @scala.inline
    def withDataType(value: xml | html | script | json | jsonp | text | String): Self[TContext] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEnctype(value: `applicationSlashx-www-form-urlencoded` | `multipartSlashform-data` | textSlashplain): Self[TContext] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enctype")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEnctype: Self[TContext] = {
        val ret = this.duplicate
