...
object ScrollEvent {
  ...
  @scala.inline
  implicit class ScrollEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: ScrollEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: scroll): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
