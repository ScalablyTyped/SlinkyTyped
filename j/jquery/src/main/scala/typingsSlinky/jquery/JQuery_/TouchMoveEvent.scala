...
object TouchMoveEvent {
  ...
  @scala.inline
  implicit class TouchMoveEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: TouchMoveEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: touchmove): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
