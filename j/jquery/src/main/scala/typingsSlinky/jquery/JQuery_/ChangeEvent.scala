...
object ChangeEvent {
  ...
  @scala.inline
  implicit class ChangeEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: ChangeEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: change): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
