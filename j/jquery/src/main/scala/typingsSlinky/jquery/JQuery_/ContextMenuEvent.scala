...
object ContextMenuEvent {
  ...
  @scala.inline
  implicit class ContextMenuEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: ContextMenuEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: contextmenu): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
