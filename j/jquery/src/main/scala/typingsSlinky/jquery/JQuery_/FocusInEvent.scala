...
object FocusInEvent {
  ...
  @scala.inline
  implicit class FocusInEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: FocusInEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: focusin): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
