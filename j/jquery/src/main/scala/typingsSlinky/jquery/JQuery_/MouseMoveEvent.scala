...
object MouseMoveEvent {
  ...
  @scala.inline
  implicit class MouseMoveEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: MouseMoveEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: mousemove): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
