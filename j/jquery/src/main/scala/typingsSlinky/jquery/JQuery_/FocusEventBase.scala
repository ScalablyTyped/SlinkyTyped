...
object FocusEventBase {
  ...
  @scala.inline
  implicit class FocusEventBaseOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: FocusEventBase[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOriginalEvent(value: org.scalajs.dom.raw.FocusEvent): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
        val ret = this.duplicate
