...
package object JQuery_ {
  /**
    ...
    */
  type AnimationHook[TElement] = js.Function1[/* fx */ typingsSlinky.jquery.JQuery_.Tween[TElement], scala.Unit]
  // #endregion
  // region CSS hooks
  // #region CSS hooks
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  type CSSHook[TElement] = typingsSlinky.std.Partial[typingsSlinky.jquery.JQuery_._CSSHook[TElement]] with (typingsSlinky.std.Pick[
    typingsSlinky.jquery.JQuery_._CSSHook[TElement], 
  ...
  org.scalablytyped.runtime.StringDictionary[typingsSlinky.jquery.JQuery_.CSSHook[org.scalajs.dom.raw.HTMLElement]]
  // #endregion
  // region Callbacks
  // #region Callbacks
  type CallbacksStatic = js.Function1[
    /* flags */ js.UndefOr[java.lang.String], 
    typingsSlinky.jquery.JQuery_.Callbacks[js.Function]
  ]
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jquery.PickCoordinatesleft
    - typingsSlinky.jquery.PickCoordinatestop
    - org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  */
  type CoordinatesPartial = typingsSlinky.jquery.JQuery_._CoordinatesPartial | org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  // #endregion
  // region Effects
  // #region Effects
  /* Rewritten from type alias, can be one of: 
  ...
  */
  type Duration = typingsSlinky.jquery.JQuery_._Duration | scala.Double
  // #endregion
  // region Easing
  // #region Easing
  type EasingMethod = js.Function1[/* percent */ scala.Double, scala.Double]
  type Easings = org.scalablytyped.runtime.StringDictionary[typingsSlinky.jquery.JQuery_.EasingMethod]
  type EventHandler[TCurrentTarget, TData] = typingsSlinky.jquery.JQuery_.EventHandlerBase[
    TCurrentTarget, 
    typingsSlinky.jquery.JQuery_.TriggeredEvent[TCurrentTarget, TData, js.Any, js.Any]
  ]
  ...
  */
  ...
  /**
    ...
    */
  type Promise[TR, TJ, TN] = typingsSlinky.jquery.JQuery_.PromiseBase[TR, TJ, TN, TR, TJ, TN, TR, TJ, TN, TR, TJ, TN]
  /**
    * This object provides a subset of the methods of the Deferred object (then, done, fail, always, pipe, progress, state and promise) to prevent users from changing the state of the Deferred.
    * @see \`{@link https://api.jquery.com/Types/#Promise }\`
    */
  type Promise2[TR, TJ, TN, UR, UJ, UN] = typingsSlinky.jquery.JQuery_.PromiseBase[
    TR, 
    TJ, 
    TN, 
    UR, 
  ...
  /**
    ...
    * @see \`{@link https://api.jquery.com/Types/#Promise }\`
    */
  type Promise3[TR, TJ, TN, UR, UJ, UN, VR, VJ, VN] = typingsSlinky.jquery.JQuery_.PromiseBase[TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, scala.Nothing, scala.Nothing, scala.Nothing]
  /**
  ...
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jquery.AnonGet[TElement]
    - typingsSlinky.jquery.AnonSet[TElement]
    - org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  */
  type PropHook[TElement] = typingsSlinky.jquery.JQuery_._PropHook[TElement] | org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  /**
    * @see \`{@link https://gist.github.com/gnarf/54829d408993526fe475#tween-hooks }\`
    * @since 1.8
    */
  type PropHooks = org.scalablytyped.runtime.StringDictionary[typingsSlinky.jquery.JQuery_.PropHook[typingsSlinky.jquery.JQuery_.Node]]
  ...
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jquery.AnonNoBubble
    - typingsSlinky.jquery.AnonBindType
    - typingsSlinky.jquery.AnonDelegateType
    - typingsSlinky.jquery.AnonSetup[TTarget, TData]
    - typingsSlinky.jquery.AnonTeardown[TTarget]
    - typingsSlinky.jquery.AnonAdd[TTarget, TData]
    - typingsSlinky.jquery.AnonRemove[TTarget, TData]
    - typingsSlinky.jquery.AnonTrigger[TTarget, TData]
    - typingsSlinky.jquery.AnonDefault[TTarget, TData]
    - typingsSlinky.jquery.AnonHandle[TTarget, TData]
    - typingsSlinky.jquery.AnonPreDispatch[TTarget]
    - typingsSlinky.jquery.AnonPostDispatch[TTarget]
    - org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  */
  type SpecialEventHook[TTarget, TData] = (typingsSlinky.jquery.JQuery_._SpecialEventHook[TTarget, TData]) | org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  type SpecialEventHooks = org.scalablytyped.runtime.StringDictionary[
    typingsSlinky.jquery.JQuery_.SpecialEventHook[org.scalajs.dom.raw.EventTarget, js.Any]
  ]
  // #endregion
  // region Speed
  // #region Speed
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jquery.AnonDuration
    - typingsSlinky.jquery.AnonEasing
    - typingsSlinky.jquery.AnonComplete[TElement]
    - org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  */
  type SpeedSettings[TElement] = typingsSlinky.jquery.JQuery_._SpeedSettings[TElement] | org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  // #endregion
  // region Deferred
  // #region Deferred
  /**
  ...
  type Tweener[TElement] = js.ThisFunction2[
    /* this */ typingsSlinky.jquery.JQuery_.Animation[TElement], 
  ...
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jquery.Anon0[TElement]
    - typingsSlinky.jquery.Anon1[TElement]
    - org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  */
  type ValHook[TElement] = typingsSlinky.jquery.JQuery_._ValHook[TElement] | org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  type ValHooks = // Set to HTMLElement to minimize breaks but should probably be Element.
  org.scalablytyped.runtime.StringDictionary[typingsSlinky.jquery.JQuery_.ValHook[org.scalajs.dom.raw.HTMLElement]]
  /**
