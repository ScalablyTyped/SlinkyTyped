...
object DragOverEvent {
  ...
  @scala.inline
  implicit class DragOverEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragOverEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dragover): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
