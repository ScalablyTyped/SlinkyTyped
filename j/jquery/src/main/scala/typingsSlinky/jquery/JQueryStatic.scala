...
import typingsSlinky.jquery.JQuery_.CSSHooks
import typingsSlinky.jquery.JQuery_.CallbacksStatic
import typingsSlinky.jquery.JQuery_.DeferredStatic
import typingsSlinky.jquery.JQuery_.Duration
import typingsSlinky.jquery.JQuery_.Easings
import typingsSlinky.jquery.JQuery_.Effects
import typingsSlinky.jquery.JQuery_.EffectsOptions
import typingsSlinky.jquery.JQuery_.EventExtensions
import typingsSlinky.jquery.JQuery_.EventStatic
import typingsSlinky.jquery.JQuery_.PlainObject
import typingsSlinky.jquery.JQuery_.Promise
import typingsSlinky.jquery.JQuery_.Promise2
import typingsSlinky.jquery.JQuery_.Promise3
import typingsSlinky.jquery.JQuery_.Queue
import typingsSlinky.jquery.JQuery_.QueueFunction
import typingsSlinky.jquery.JQuery_.Selector
import typingsSlinky.jquery.JQuery_.Selectors
import typingsSlinky.jquery.JQuery_.SpeedSettings
import typingsSlinky.jquery.JQuery_.Thenable
import typingsSlinky.jquery.JQuery_.TickFunction
import typingsSlinky.jquery.JQuery_.Transport
import typingsSlinky.jquery.JQuery_.TweenStatic
import typingsSlinky.jquery.JQuery_.TypeOrArray
import typingsSlinky.jquery.JQuery_.UrlAjaxSettings
import typingsSlinky.jquery.JQuery_.ValHooks
import typingsSlinky.jquery.JQuery_.htmlString
import typingsSlinky.jquery.JQuery_.jqXHR
import typingsSlinky.jquery.JQuery_.jqXHR.DoneCallback
...
import typingsSlinky.jquery.jqueryStrings.boolean
import typingsSlinky.jquery.jqueryStrings.date
import typingsSlinky.jquery.jqueryStrings.error
import typingsSlinky.jquery.jqueryStrings.function
import typingsSlinky.jquery.jqueryStrings.number
import typingsSlinky.jquery.jqueryStrings.regexp
import typingsSlinky.jquery.jqueryStrings.string
...
trait JQueryStatic extends js.Object {
  ...
  /**
    ...
    * @since 1.8
    */
  def Animation[TElement](element: TElement, props: PlainObject[_], opts: EffectsOptions[TElement]): typingsSlinky.jquery.JQuery_.Animation[TElement] = js.native
  def Callbacks[T /* <: js.Function */](): typingsSlinky.jquery.JQuery_.Callbacks[T] = js.native
  def Callbacks[T /* <: js.Function */](flags: String): typingsSlinky.jquery.JQuery_.Callbacks[T] = js.native
  /**
    ...
    * @since 1.5
    */
  def Deferred[TR, TJ, TN](): typingsSlinky.jquery.JQuery_.Deferred[TR, TJ, TN] = js.native
  def Deferred[TR, TJ, TN](
    beforeStart: js.ThisFunction1[
      /* this */ typingsSlinky.jquery.JQuery_.Deferred[TR, TJ, TN], 
      /* deferred */ typingsSlinky.jquery.JQuery_.Deferred[TR, TJ, TN], 
      Unit
    ]
  ): typingsSlinky.jquery.JQuery_.Deferred[TR, TJ, TN] = js.native
  /**
  ...
  /**
    ...
    * @since 1.8
    */
  def Tween[TElement](elem: TElement, options: EffectsOptions[TElement], prop: String, end: Double): typingsSlinky.jquery.JQuery_.Tween[TElement] = js.native
  def Tween[TElement](elem: TElement, options: EffectsOptions[TElement], prop: String, end: Double, easing: String): typingsSlinky.jquery.JQuery_.Tween[TElement] = js.native
  def Tween[TElement](
    elem: TElement,
    ...
    easing: String,
    unit: String
  ): typingsSlinky.jquery.JQuery_.Tween[TElement] = js.native
  /**
  ...
  def each[T](
    array: ArrayLike[T],
    callback: js.ThisFunction2[/* this */ T, /* indexInArray */ Double, /* value */ T, _]
  ...
  /**
    ...
    */
  @JSName("extend")
  def extend_true[T](deep: `true`, target: T): this.type with T = js.native
  /**
    * Merge the contents of two or more objects together into the first object.
    * @param deep If true, the merge becomes recursive (aka. deep copy). Passing false for this argument is not supported.
    * @param target The object to extend. It will receive the new properties.
  ...
  /**
    ...
    * @since 2.2
    */
  def getScript(options: UrlAjaxSettings[_]): jqXHR[js.UndefOr[String]] = js.native
  /**
    * Load a JavaScript file from the server using a GET HTTP request, then execute it.
    * @param url A string containing the URL to which the request is sent.
    * @param success A callback function that is executed if the request succeeds.
  ...
  ```
    */
  def parseHTML(data: String): js.Array[typingsSlinky.jquery.JQuery_.Node] = js.native
  def parseHTML(data: String, context_keepScripts: Boolean): js.Array[typingsSlinky.jquery.JQuery_.Node] = js.native
  def parseHTML(data: String, context_keepScripts: Document_): js.Array[typingsSlinky.jquery.JQuery_.Node] = js.native
  def parseHTML(data: String, context: js.UndefOr[scala.Nothing], keepScripts: Boolean): js.Array[typingsSlinky.jquery.JQuery_.Node] = js.native
  def parseHTML(data: String, context: Null, keepScripts: Boolean): js.Array[typingsSlinky.jquery.JQuery_.Node] = js.native
  /**
    * Parses a string into an array of DOM nodes.
    * @param data HTML string to be parsed
    ...
    * @since 1.8
    */
  def parseHTML(data: String, context: Document_, keepScripts: Boolean): js.Array[typingsSlinky.jquery.JQuery_.Node] = js.native
  /**
  ...
  def when[TR1, UR1, TJ1, UJ1](deferredT: TR1, deferredU: Promise[UR1, UJ1, _]): Promise2[TR1, TJ1, scala.Nothing, UR1, UJ1, scala.Nothing] = js.native
  ...
  def when[TR1, UR1, TJ1, UJ1](deferredT: Promise[TR1, TJ1, _], deferredU: UR1): Promise2[TR1, TJ1, scala.Nothing, UR1, UJ1, scala.Nothing] = js.native
  /**
    * Provides a way to execute callback functions based on zero or more Thenable objects, usually Deferred objects that represent asynchronous events.
    * @see \`{@link https://api.jquery.com/jQuery.when/ }\`
    * @since 1.5
  ...
  ```
    */
  def when[TR1, UR1, TJ1, UJ1](deferredT: Promise[TR1, TJ1, _], deferredU: Promise[UR1, UJ1, _]): Promise2[TR1, TJ1, scala.Nothing, UR1, UJ1, scala.Nothing] = js.native
  def when[TR1, UR1, TJ1, UJ1](deferredT: Promise[TR1, TJ1, _], deferredU: Thenable[UR1]): Promise2[TR1, TJ1, scala.Nothing, UR1, UJ1, scala.Nothing] = js.native
