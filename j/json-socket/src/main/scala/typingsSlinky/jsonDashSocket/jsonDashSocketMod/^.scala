package typingsSlinky.jsonDashSocket.jsonDashSocketMod
...
object ^ extends js.Object {
  /**
    ...
    */
  def sendSingleMessage(port: Double, host: String, message: js.Any, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  /**
  ...
  def sendSingleMessageAndReceive(
    ...
    host: String,
    message: js.Any,
    callback: js.Function2[/* err */ js.Error, /* message */ js.Any, Unit]
  ): Unit = js.native
}
