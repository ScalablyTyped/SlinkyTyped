...
object mod {
  ...
  object PeripheralType extends StObject {
    ...
    /* "gpio" */ val GPIO: typingsSlinky.j5IoTypes.mod.PeripheralType.GPIO with String = js.native
    
    @js.native
    sealed trait I2C extends PeripheralType
    /* "i2c" */ val I2C: typingsSlinky.j5IoTypes.mod.PeripheralType.I2C with String = js.native
    
    @js.native
    sealed trait PWM extends PeripheralType
    /* "pwm" */ val PWM: typingsSlinky.j5IoTypes.mod.PeripheralType.PWM with String = js.native
    
    @js.native
    sealed trait SPI extends PeripheralType
    /* "spi" */ val SPI: typingsSlinky.j5IoTypes.mod.PeripheralType.SPI with String = js.native
    
    @js.native
    sealed trait UART extends PeripheralType
    /* "uart" */ val UART: typingsSlinky.j5IoTypes.mod.PeripheralType.UART with String = js.native
  }
  ...
  object Value extends StObject {
    ...
    /* 1 */ val HIGH: typingsSlinky.j5IoTypes.mod.Value.HIGH with Double = js.native
    
    @js.native
    sealed trait LOW extends Value
    /* 0 */ val LOW: typingsSlinky.j5IoTypes.mod.Value.LOW with Double = js.native
  }
  
  type I2CReadBufferCallback = js.Function2[/* err */ Null | js.Error | String, /* data */ Null | Buffer, Unit]
  
  type I2CReadNumberCallback = js.Function2[/* err */ Null | js.Error | String, /* data */ Null | Double, Unit]
  
  type I2CWriteCallback = js.Function1[/* err */ Null | js.Error | String, Unit]
  ...
  type SerialErrorCallback = js.Function1[/* err */ js.UndefOr[js.Error | String], Unit]
}
