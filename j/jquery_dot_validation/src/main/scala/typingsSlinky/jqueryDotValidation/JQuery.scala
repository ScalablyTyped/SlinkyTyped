...
import typingsSlinky.jqueryDotValidation.JQueryValidation.RulesDictionary
import typingsSlinky.jqueryDotValidation.JQueryValidation.ValidationOptions
import typingsSlinky.jqueryDotValidation.JQueryValidation.Validator
import typingsSlinky.jqueryDotValidation.jqueryDotValidationStrings.add
import typingsSlinky.jqueryDotValidation.jqueryDotValidationStrings.remove
