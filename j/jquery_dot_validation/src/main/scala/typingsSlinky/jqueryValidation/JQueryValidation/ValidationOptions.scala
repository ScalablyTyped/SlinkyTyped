...
object ValidationOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(focusCleanup)) __obj.updateDynamic("focusCleanup")(focusCleanup.get.asInstanceOf[js.Any])
    if (!js.isUndefined(focusInvalid)) __obj.updateDynamic("focusInvalid")(focusInvalid.get.asInstanceOf[js.Any])
    if (groups != null) __obj.updateDynamic("groups")(groups.asInstanceOf[js.Any])
    if (highlight != null) __obj.updateDynamic("highlight")(js.Any.fromFunction3(highlight))
    if (ignore != null) __obj.updateDynamic("ignore")(ignore.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreTitle)) __obj.updateDynamic("ignoreTitle")(ignoreTitle.get.asInstanceOf[js.Any])
