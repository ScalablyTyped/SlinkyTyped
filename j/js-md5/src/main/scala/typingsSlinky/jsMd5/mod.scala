...
object mod extends Shortcut {
  ...
  object Md5_ {
    ...
    implicit class Md5_MutableBuilder[Self <: Md5_] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBuffer(value: () => js.typedarray.ArrayBuffer): Self = StObject.set(x, "buffer", js.Any.fromFunction0(value))
  ...
  type message = String | js.Array[js.Any] | js.typedarray.Uint8Array | js.typedarray.ArrayBuffer
}
