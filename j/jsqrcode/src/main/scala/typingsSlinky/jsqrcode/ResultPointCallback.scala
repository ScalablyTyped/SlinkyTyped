...
object ResultPointCallback {
  ...
  implicit class ResultPointCallbackOps[Self <: ResultPointCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFoundPossibleResultPoint(value: FinderPattern => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("foundPossibleResultPoint")(js.Any.fromFunction1(value))
        ret
    }
  }
