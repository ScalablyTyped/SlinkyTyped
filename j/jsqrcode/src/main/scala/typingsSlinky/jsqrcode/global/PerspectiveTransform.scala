...
class PerspectiveTransform protected ()
  ...
  /* CompleteClass */
  override def buildAdjoint(): typingsSlinky.jsqrcode.PerspectiveTransform = js.native
  /* CompleteClass */
  override def times(other: typingsSlinky.jsqrcode.PerspectiveTransform): typingsSlinky.jsqrcode.PerspectiveTransform = js.native
  /* CompleteClass */
