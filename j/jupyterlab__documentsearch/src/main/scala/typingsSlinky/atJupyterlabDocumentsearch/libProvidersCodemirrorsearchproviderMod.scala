...
import typingsSlinky.atJupyterlabCodemirror.atJupyterlabCodemirrorMod.CodeMirrorEditor
import typingsSlinky.atJupyterlabDocumentsearch.atJupyterlabDocumentsearchBooleans.`false`
import typingsSlinky.atJupyterlabDocumentsearch.libInterfacesMod.ISearchMatch
...
import typingsSlinky.codemirror.codemirrorMod.Position
...
object libProvidersCodemirrorsearchproviderMod extends js.Object {
  ...
  class CodeMirrorSearchProvider () extends ISearchProvider[CMMainAreaWidget] {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def startQuery(query: js.RegExp, searchTarget: CMMainAreaWidget): js.Promise[js.Array[ISearchMatch]] = js.native
    /**
      * Initialize the search using the provided options.  Should update the UI
      * to highlight all matches and "select" whatever the first match should be.
      *
      ...
      * @returns A promise that resolves with a list of all matches
      */
    def startQuery(query: js.RegExp, searchTarget: Widget): js.Promise[js.Array[ISearchMatch]] = js.native
    /**
