...
object interfacesMod {
  ...
  object IDisplayState {
    ...
    implicit class IDisplayStateMutableBuilder[Self <: IDisplayState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setQuery(value: js.RegExp): Self = StObject.set(x, "query", value.asInstanceOf[js.Any])
  ...
  trait ISearchProvider[T /* <: Widget */] extends StObject {
    ...
    /**
      ...
      */
    def startQuery(query: js.RegExp, searchTarget: T, filters: IFiltersType): js.Promise[js.Array[ISearchMatch]] = js.native
  }
  object ISearchProvider {
    ...
    def apply[T /* <: Widget */](
      ...
      startQuery: (js.RegExp, T, IFiltersType) => js.Promise[js.Array[ISearchMatch]]
    ): ISearchProvider[T] = {
    ...
    implicit class ISearchProviderMutableBuilder[Self <: ISearchProvider[_], T /* <: Widget */] (val x: Self with ISearchProvider[T]) extends AnyVal {
      ...
      @scala.inline
      def setStartQuery(value: (js.RegExp, T, IFiltersType) => js.Promise[js.Array[ISearchMatch]]): Self = StObject.set(x, "startQuery", js.Any.fromFunction3(value))
    }
  }
