...
object APPLET {
  ...
  @scala.inline
  implicit class APPLETOps[Self <: APPLET] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAPPLET(value: Boolean): Self = this.set("APPLET", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNOEMBED(value: Boolean): Self = this.set("NOEMBED", value.asInstanceOf[js.Any])
