...
import typingsSlinky.jupyterlabDocumentsearch.jupyterlabDocumentsearchBooleans.`false`
...
object codemirrorsearchproviderMod extends js.Object {
  ...
  trait CMMainAreaWidget extends js.Object {
    ...
    /**
      ...
      */
    val toolbar: Toolbar[typingsSlinky.phosphorWidgets.mod.Widget] = js.native
    /**
  ...
  class CodeMirrorSearchProvider () extends ISearchProvider[CMMainAreaWidget] {
    ...
    /**
      ...
      * @returns A promise that resolves with a list of all matches
      */
    def startQuery(query: js.RegExp, searchTarget: typingsSlinky.phosphorWidgets.mod.Widget): js.Promise[js.Array[ISearchMatch]] = js.native
    /**
  ...
  object CodeMirrorSearchProvider extends js.Object {
    /**
      ...
      */
    def canSearchOn(domain: typingsSlinky.phosphorWidgets.mod.Widget): /* is @jupyterlab/documentsearch.@jupyterlab/documentsearch/lib/providers/codemirrorsearchprovider.CMMainAreaWidget */ Boolean = js.native
  }
