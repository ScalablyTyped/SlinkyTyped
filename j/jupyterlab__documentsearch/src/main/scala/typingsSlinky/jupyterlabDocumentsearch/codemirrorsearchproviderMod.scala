...
object codemirrorsearchproviderMod {
  ...
  trait CMMainAreaWidget extends StObject {
    ...
    /**
      ...
      */
    def children(): IIterator[typingsSlinky.luminoWidgets.widgetMod.Widget] = js.native
    ...
    /**
      ...
      */
    def contains(widget: typingsSlinky.luminoWidgets.widgetMod.Widget): Boolean = js.native
    ...
    /**
      ...
      */
    var parent: typingsSlinky.luminoWidgets.widgetMod.Widget | Null = js.native
    ...
    /**
      ...
      */
    val title: Title[typingsSlinky.luminoWidgets.widgetMod.Widget] = js.native
