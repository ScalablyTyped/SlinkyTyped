...
trait Anon_AsyncFunction extends js.Object {
...
object Anon_AsyncFunction {
  @scala.inline
  def apply(AsyncFunction: String, AsyncGeneratorFunction: String, Function: String, GeneratorFunction: String): Anon_AsyncFunction = {
    ...
    __obj.asInstanceOf[Anon_AsyncFunction]
  }
}
