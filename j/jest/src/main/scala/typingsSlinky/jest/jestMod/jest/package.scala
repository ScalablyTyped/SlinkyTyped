...
package object jest {
  ...
  import typingsSlinky.jest.Anon_Not
  import typingsSlinky.jest.Anon_Rejects
  import typingsSlinky.jest.Anon_SupportsColor
  import typingsSlinky.jest.jestStrings.not
  import typingsSlinky.jest.jestStrings.rejects
  import typingsSlinky.jest.jestStrings.resolves
  ...
  {[ K in 'not' ]: jest.jest.jest.Expect[K]}
    */ typingsSlinky.jest.jestStrings.ExpectProperties with Expect
  ...
  type ExtendedMatchers[TMatchers /* <: ExpectExtendMap */, TMatcherReturn, TActual] = (Matchers[TMatcherReturn, TActual]) with typingsSlinky.jest.jestStrings.ExtendedMatchers with TMatchers
