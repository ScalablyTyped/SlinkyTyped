...
object NodeRequire {
  ...
  implicit class NodeRequireOps[Self <: NodeRequire] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequireActual(value: String => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requireActual")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRequireMock(value: String => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requireMock")(js.Any.fromFunction1(value))
        ret
    }
  }
