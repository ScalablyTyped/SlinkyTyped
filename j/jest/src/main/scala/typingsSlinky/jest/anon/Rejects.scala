...
object Rejects {
  ...
  @scala.inline
  implicit class RejectsOps[Self <: Rejects[_], /* <: js.Object */ TPromise] (val x: Self with Rejects[TPromise]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRejects(value: typingsSlinky.jest.mod.jest.AndNot[TPromise]): Self = this.set("rejects", value.asInstanceOf[js.Any])
    @scala.inline
    def setResolves(value: typingsSlinky.jest.mod.jest.AndNot[TPromise]): Self = this.set("resolves", value.asInstanceOf[js.Any])
  }
