...
import typingsSlinky.atJupyterlabCodemirror.libEditorMod.CodeMirrorEditor.IOptions
import typingsSlinky.atJupyterlabCodemirror.libModeMod.Mode.ISpec
import typingsSlinky.atJupyterlabCodemirror.libModeMod.Mode.ISpecLoader
...
object atJupyterlabCodemirrorMod extends js.Object {
  ...
  class CodeMirrorEditor protected ()
    extends typingsSlinky.atJupyterlabCodemirror.libEditorMod.CodeMirrorEditor {
    /**
  ...
  class CodeMirrorEditorFactory ()
    extends typingsSlinky.atJupyterlabCodemirror.libFactoryMod.CodeMirrorEditorFactory {
    def this(defaults: Partial[IConfig]) = this()
  }
  
  @js.native
  class CodeMirrorMimeTypeService ()
    extends typingsSlinky.atJupyterlabCodemirror.libMimetypeMod.CodeMirrorMimeTypeService
  
  @js.native
  class EditorSyntaxStatus protected ()
    extends typingsSlinky.atJupyterlabCodemirror.libSyntaxstatusMod.EditorSyntaxStatus {
    /**
      * Construct a new VDomRenderer for the status item.
      */
    def this(opts: typingsSlinky.atJupyterlabCodemirror.libSyntaxstatusMod.EditorSyntaxStatus.IOptions) = this()
  }
  ...
  object EditorSyntaxStatus extends js.Object {
    ...
    @js.native
    class Model ()
      extends typingsSlinky.atJupyterlabCodemirror.libSyntaxstatusMod.EditorSyntaxStatus.Model
