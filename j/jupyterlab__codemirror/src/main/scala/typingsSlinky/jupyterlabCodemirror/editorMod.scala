  ...
  object CodeMirrorEditor {
    ...
    object IConfig {
      ...
      def apply(
        ...
        lineNumbers: Boolean,
        lineWrap: typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.off | typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.on | typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.wordWrapColumn | typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.bounded,
