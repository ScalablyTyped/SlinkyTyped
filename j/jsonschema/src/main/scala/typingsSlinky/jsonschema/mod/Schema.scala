...
object Schema {
  ...
  implicit class SchemaOps[Self <: Schema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdditionalItems(value: Boolean | Schema): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withAdditionalProperties(value: Boolean | Schema): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withAnyOf(value: js.Array[Schema]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDependencies(value: StringDictionary[Schema | js.Array[String]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOneOf(value: js.Array[Schema]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPatternProperties(value: StringDictionary[Schema]): Self = {
        val ret = this.duplicate
