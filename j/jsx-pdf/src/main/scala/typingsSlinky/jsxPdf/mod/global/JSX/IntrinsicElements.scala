...
object IntrinsicElements {
  ...
  implicit class IntrinsicElementsOps[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContent(value: typingsSlinky.jsxPdf.anon.Ele): Self = this.set("content", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDocument(value: EleOmitTDocumentDefinitio): Self = this.set("document", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFooter(value: typingsSlinky.jsxPdf.anon.Ele): Self = this.set("footer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHeader(value: typingsSlinky.jsxPdf.anon.Ele): Self = this.set("header", value.asInstanceOf[js.Any])
