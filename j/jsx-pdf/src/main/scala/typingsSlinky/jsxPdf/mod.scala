...
import typingsSlinky.jsxPdf.anon.Content
import typingsSlinky.jsxPdf.anon.EleNoChidlrenOmitContentI
import typingsSlinky.jsxPdf.anon.EleNoChidlrenOmitContentQ
import typingsSlinky.jsxPdf.anon.EleOmitContentColumnscolu
import typingsSlinky.jsxPdf.anon.EleOmitContentOrderedList
import typingsSlinky.jsxPdf.anon.EleOmitContentStackstack
import typingsSlinky.jsxPdf.anon.EleOmitContentTabletableO
import typingsSlinky.jsxPdf.anon.EleOmitContentTexttext
import typingsSlinky.jsxPdf.anon.EleOmitContentUnorderedLi
import typingsSlinky.jsxPdf.anon.EleOmitTDocumentDefinitio
import typingsSlinky.jsxPdf.anon.Elewidthnumberstring
  ...
  object global {
    ...
    object JSX {
      ...
      trait IntrinsicElements extends StObject {
        ...
        var content: typingsSlinky.jsxPdf.anon.Ele = js.native
        
        var document: EleOmitTDocumentDefinitio = js.native
        
        var footer: typingsSlinky.jsxPdf.anon.Ele = js.native
        
        var header: typingsSlinky.jsxPdf.anon.Ele = js.native
      ...
      object IntrinsicElements {
        ...
        def apply(
          ...
          content: typingsSlinky.jsxPdf.anon.Ele,
          document: EleOmitTDocumentDefinitio,
          footer: typingsSlinky.jsxPdf.anon.Ele,
          header: typingsSlinky.jsxPdf.anon.Ele,
        ...
        implicit class IntrinsicElementsMutableBuilder[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setContent(value: typingsSlinky.jsxPdf.anon.Ele): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setDocument(value: EleOmitTDocumentDefinitio): Self = StObject.set(x, "document", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setFooter(value: typingsSlinky.jsxPdf.anon.Ele): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setHeader(value: typingsSlinky.jsxPdf.anon.Ele): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
