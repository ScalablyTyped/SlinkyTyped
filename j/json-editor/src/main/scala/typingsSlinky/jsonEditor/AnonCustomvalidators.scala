...
trait AnonCustomvalidators extends js.Object {
  ...
  var editors: AnonArray = js.native
...
object AnonCustomvalidators {
  ...
  @scala.inline
  implicit class AnonCustomvalidatorsOps[Self <: AnonCustomvalidators] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEditors(value: AnonArray): Self = {
        val ret = this.duplicate
