...
object DatepickerOptions {
  ...
  implicit class DatepickerOptionsMutableBuilder[Self <: DatepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBeforeShowDay(value: /* date */ js.Date => js.Array[_]): Self = StObject.set(x, "beforeShowDay", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setCalculateWeek(value: /* date */ js.Date => String): Self = StObject.set(x, "calculateWeek", js.Any.fromFunction1(value))
