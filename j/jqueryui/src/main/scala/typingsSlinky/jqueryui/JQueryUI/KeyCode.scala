...
object KeyCode {
  ...
  implicit class KeyCodeOps[Self <: KeyCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNUMPAD_ADD(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NUMPAD_ADD")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNUMPAD_DECIMAL(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NUMPAD_DECIMAL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNUMPAD_SUBTRACT(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NUMPAD_SUBTRACT")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
