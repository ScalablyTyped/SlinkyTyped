...
import typingsSlinky.atJupyterlabNotebook.libModelMod.NotebookModel.IOptions
...
/**
  ...
  */
class NotebookModel ()
  extends typingsSlinky.atJupyterlabNotebook.libModelMod.NotebookModel {
...
object NotebookModel extends js.Object {
  ...
  class ContentFactory protected ()
    extends typingsSlinky.atJupyterlabNotebook.libModelMod.NotebookModel.ContentFactory {
    /**
  ...
  /**
    ...
    */
  val defaultContentFactory: typingsSlinky.atJupyterlabNotebook.libModelMod.NotebookModel.ContentFactory = js.native
  /**
