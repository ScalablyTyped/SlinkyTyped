...
import typingsSlinky.atJupyterlabNotebook.libWidgetMod.StaticNotebook.IContentFactory
...
import typingsSlinky.atJupyterlabNotebook.libWidgetMod.StaticNotebook.IOptions
...
class StaticNotebook protected ()
  extends typingsSlinky.atJupyterlabNotebook.libWidgetMod.StaticNotebook {
  /**
