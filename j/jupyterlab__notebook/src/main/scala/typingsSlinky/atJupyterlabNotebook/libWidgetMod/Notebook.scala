package typingsSlinky.atJupyterlabNotebook.libWidgetMod
...
import typingsSlinky.atJupyterlabNotebook.Anon_Anchor
import typingsSlinky.atJupyterlabNotebook.libWidgetMod.Notebook.IOptions
...
object Notebook extends js.Object {
  ...
  object ContentFactory extends js.Object {
    /**
      ...
      */
    type IOptions = typingsSlinky.atJupyterlabNotebook.libWidgetMod.StaticNotebook.ContentFactory.IOptions
  }
  
  /**
    * The content factory for the notebook widget.
    */
  type IContentFactory = typingsSlinky.atJupyterlabNotebook.libWidgetMod.StaticNotebook.IContentFactory
  /**
    * An options object for initializing a notebook widget.
    */
  type IOptions = typingsSlinky.atJupyterlabNotebook.libWidgetMod.StaticNotebook.IOptions
}
