package typingsSlinky.atJupyterlabNotebook.libModelfactoryMod.NotebookModelFactory
...
trait IOptions extends js.Object {
  ...
  /**
    ...
    */
  var contentFactory: js.UndefOr[typingsSlinky.atJupyterlabNotebook.libModelMod.NotebookModel.IContentFactory] = js.undefined
}
...
object IOptions {
  ...
  def apply(
    ...
    contentFactory: typingsSlinky.atJupyterlabNotebook.libModelMod.NotebookModel.IContentFactory = null
  ): IOptions = {
