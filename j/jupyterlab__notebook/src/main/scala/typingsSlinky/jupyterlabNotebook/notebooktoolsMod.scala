  ...
  object NotebookTools {
    ...
    object KeySelector {
      ...
      object IOptions {
        ...
        @scala.inline
        def apply(key: String, optionsMap: ReadonlyPartialJSONObject): typingsSlinky.jupyterlabNotebook.notebooktoolsMod.NotebookTools.KeySelector.IOptions = {
          val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], optionsMap = optionsMap.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsSlinky.jupyterlabNotebook.notebooktoolsMod.NotebookTools.KeySelector.IOptions]
        }
        
        @scala.inline
        implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabNotebook.notebooktoolsMod.NotebookTools.KeySelector.IOptions] (val x: Self) extends AnyVal {
    ...
    object MetadataEditorTool {
      ...
      object IOptions {
        ...
        ): typingsSlinky.jupyterlabNotebook.notebooktoolsMod.NotebookTools.MetadataEditorTool.IOptions = {
          val __obj = js.Dynamic.literal(editorFactory = js.Any.fromFunction1(editorFactory))
          __obj.asInstanceOf[typingsSlinky.jupyterlabNotebook.notebooktoolsMod.NotebookTools.MetadataEditorTool.IOptions]
        }
        
        @scala.inline
        implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabNotebook.notebooktoolsMod.NotebookTools.MetadataEditorTool.IOptions] (val x: Self) extends AnyVal {
