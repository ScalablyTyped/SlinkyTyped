...
object IOptions {
  ...
  implicit class IOptionsOps[Self <: IOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentFactory(value: typingsSlinky.jupyterlabNotebook.modelMod.NotebookModel.IContentFactory): Self = this.set("contentFactory", value.asInstanceOf[js.Any])
