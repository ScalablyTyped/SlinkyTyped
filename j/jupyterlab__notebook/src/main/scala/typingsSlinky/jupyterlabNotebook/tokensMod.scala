...
object tokensMod {
  ...
  object INotebookTools extends Shortcut {
    ...
    object IAddOptions {
      ...
      @scala.inline
      def apply(tool: ITool): typingsSlinky.jupyterlabNotebook.tokensMod.INotebookTools.IAddOptions = {
        val __obj = js.Dynamic.literal(tool = tool.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.jupyterlabNotebook.tokensMod.INotebookTools.IAddOptions]
      }
      
      @scala.inline
      implicit class IAddOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabNotebook.tokensMod.INotebookTools.IAddOptions] (val x: Self) extends AnyVal {
