...
import typingsSlinky.jupyterlabNotebook.jupyterlabNotebookStrings.bounded
import typingsSlinky.jupyterlabNotebook.jupyterlabNotebookStrings.off
import typingsSlinky.jupyterlabNotebook.jupyterlabNotebookStrings.on
import typingsSlinky.jupyterlabNotebook.jupyterlabNotebookStrings.wordWrapColumn
...
object anon {
  ...
  object Cell {
    ...
    implicit class CellMutableBuilder[Self <: Cell] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCell(value: typingsSlinky.jupyterlabCells.mod.Cell): Self = StObject.set(x, "cell", value.asInstanceOf[js.Any])
