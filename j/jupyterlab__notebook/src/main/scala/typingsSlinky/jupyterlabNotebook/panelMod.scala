  ...
  object NotebookPanel {
    ...
    trait IContentFactory
      ...
      /**
        ...
        */
      def createNotebook(options: typingsSlinky.jupyterlabNotebook.widgetMod.Notebook.IOptions): Notebook = js.native
    }
    object IContentFactory {
      ...
      implicit class IContentFactoryMutableBuilder[Self <: IContentFactory] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreateNotebook(value: typingsSlinky.jupyterlabNotebook.widgetMod.Notebook.IOptions => Notebook): Self = StObject.set(x, "createNotebook", js.Any.fromFunction1(value))
      }
    }
