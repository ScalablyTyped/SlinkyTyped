...
import typingsSlinky.jupyterlabNotebook.anon.Anchor
import typingsSlinky.jupyterlabNotebook.anon.Head
...
object widgetMod {
  ...
  object Notebook {
    ...
    object ContentFactory {
      ...
      /**
        ...
        */
      type IOptions = typingsSlinky.jupyterlabNotebook.widgetMod.StaticNotebook.ContentFactory.IOptions
    }
    ...
    /**
      ...
      */
    type IContentFactory = typingsSlinky.jupyterlabNotebook.widgetMod.StaticNotebook.IContentFactory
    
    /**
      * An options object for initializing a notebook widget.
      */
    type IOptions = typingsSlinky.jupyterlabNotebook.widgetMod.StaticNotebook.IOptions
  }
  ...
  class StaticNotebook protected () extends Widget {
    ...
    /* protected */ def onMetadataChanged(
      ...
      args: typingsSlinky.jupyterlabObservables.observablemapMod.IObservableMap.IChangedArgs[ReadonlyPartialJSONValue]
    ): Unit = js.native
  ...
  object StaticNotebook {
    ...
    trait IContentFactory
      ...
      /**
        ...
        */
      def createCodeCell(options: typingsSlinky.jupyterlabCells.widgetMod.CodeCell.IOptions, parent: StaticNotebook): CodeCell = js.native
      
      /**
        * Create a new markdown cell widget.
        */
      def createMarkdownCell(options: typingsSlinky.jupyterlabCells.widgetMod.MarkdownCell.IOptions, parent: StaticNotebook): MarkdownCell = js.native
      
      /**
        * Create a new raw cell widget.
        */
      def createRawCell(options: typingsSlinky.jupyterlabCells.widgetMod.RawCell.IOptions, parent: StaticNotebook): RawCell = js.native
    }
    object IContentFactory {
      ...
      def apply(
        ...
        createCodeCell: (typingsSlinky.jupyterlabCells.widgetMod.CodeCell.IOptions, StaticNotebook) => CodeCell,
        createInputPrompt: () => IInputPrompt,
        createMarkdownCell: (typingsSlinky.jupyterlabCells.widgetMod.MarkdownCell.IOptions, StaticNotebook) => MarkdownCell,
        createOutputPrompt: () => IOutputPrompt,
        createRawCell: (typingsSlinky.jupyterlabCells.widgetMod.RawCell.IOptions, StaticNotebook) => RawCell,
      ...
      implicit class IContentFactoryMutableBuilder[Self <: IContentFactory] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreateCodeCell(value: (typingsSlinky.jupyterlabCells.widgetMod.CodeCell.IOptions, StaticNotebook) => CodeCell): Self = StObject.set(x, "createCodeCell", js.Any.fromFunction2(value))
        
        @scala.inline
        def setCreateMarkdownCell(
          value: (typingsSlinky.jupyterlabCells.widgetMod.MarkdownCell.IOptions, StaticNotebook) => MarkdownCell
        ): Self = StObject.set(x, "createMarkdownCell", js.Any.fromFunction2(value))
        
        @scala.inline
        def setCreateRawCell(value: (typingsSlinky.jupyterlabCells.widgetMod.RawCell.IOptions, StaticNotebook) => RawCell): Self = StObject.set(x, "createRawCell", js.Any.fromFunction2(value))
      }
    }
    ...
    object IOptions {
      ...
      @scala.inline
      def apply(mimeTypeService: IEditorMimeTypeService, rendermime: IRenderMimeRegistry): typingsSlinky.jupyterlabNotebook.widgetMod.StaticNotebook.IOptions = {
        ...
        __obj.asInstanceOf[typingsSlinky.jupyterlabNotebook.widgetMod.StaticNotebook.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabNotebook.widgetMod.StaticNotebook.IOptions] (val x: Self) extends AnyVal {
