...
import typingsSlinky.jestUtil.jestUtilStrings.`SpaceSinglerightpointinganglequotationmark `
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait TypeofspecialChars extends js.Object {
  val ARROW: `SpaceSinglerightpointinganglequotationmark `
  val CLEAR: String
  val ICONS: AnonFailed
}
