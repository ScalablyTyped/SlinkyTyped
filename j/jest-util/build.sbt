...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jest-message-util" % "24.9.0-40990d",
  "org.scalablytyped.slinky" %%% "jest-mock" % "24.9.0-663935",
  "org.scalablytyped.slinky" %%% "jest__console" % "24.9.0-b71e66",
  "org.scalablytyped.slinky" %%% "jest__fake-timers" % "24.9.0-0c9076",
  ...
  "org.scalablytyped.slinky" %%% "stack-utils" % "2.0-dt-20200921Z-794ad8",
