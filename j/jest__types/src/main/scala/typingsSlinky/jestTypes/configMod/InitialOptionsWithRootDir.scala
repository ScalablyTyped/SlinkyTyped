...
@js.native
trait InitialOptionsWithRootDir extends js.Object {
...
object InitialOptionsWithRootDir {
  ...
  @scala.inline
  implicit class InitialOptionsWithRootDirOps[Self <: InitialOptionsWithRootDir] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRootDir(value: js.UndefOr[Path] with Path): Self = this.set("rootDir", value.asInstanceOf[js.Any])
