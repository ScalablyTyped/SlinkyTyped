...
package object configMod {
  ...
  type CoverageReporters = js.Array[
    typingsSlinky.jestTypes.configMod.CoverageReporterName | typingsSlinky.jestTypes.configMod.CoverageReporterWithOptions[typingsSlinky.jestTypes.configMod.CoverageReporterName]
  ]
