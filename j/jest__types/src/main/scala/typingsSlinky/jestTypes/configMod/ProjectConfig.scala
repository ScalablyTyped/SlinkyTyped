...
object ProjectConfig {
  ...
  def apply(
    ...
    snapshotResolver: js.UndefOr[Null | Path] = js.undefined,
    unmockedModulePathPatterns: js.UndefOr[Null | js.Array[String]] = js.undefined
  ): ProjectConfig = {
    ...
    if (!js.isUndefined(snapshotResolver)) __obj.updateDynamic("snapshotResolver")(snapshotResolver.asInstanceOf[js.Any])
    if (!js.isUndefined(unmockedModulePathPatterns)) __obj.updateDynamic("unmockedModulePathPatterns")(unmockedModulePathPatterns.asInstanceOf[js.Any])
