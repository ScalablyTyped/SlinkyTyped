...
trait InitialOptions extends js.Object {
  ...
  var coverageThreshold: js.UndefOr[AnonGlobal] = js.native
...
object InitialOptions {
  ...
  implicit class InitialOptionsOps[Self <: InitialOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withScriptPreprocessor(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWatchPlugins(value: js.Array[String | (js.Tuple2[String, Record[String, _]])]): Self = {
        val ret = this.duplicate
