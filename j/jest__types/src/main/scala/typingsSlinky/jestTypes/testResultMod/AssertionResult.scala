package typingsSlinky.jestTypes.testResultMod
...
object AssertionResult {
  ...
  implicit class AssertionResultOps[Self <: AssertionResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFailureDetailsVarargs(value: js.Any*): Self = this.set("failureDetails", js.Array(value :_*))
    
    @scala.inline
    def setFailureDetails(value: js.Array[_]): Self = this.set("failureDetails", value.asInstanceOf[js.Any])
