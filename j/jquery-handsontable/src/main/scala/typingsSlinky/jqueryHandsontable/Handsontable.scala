package typingsSlinky.jqueryHandsontable

import org.scalajs.dom.raw.KeyboardEvent
import org.scalajs.dom.raw.MouseEvent
import typingsSlinky.jqueryHandsontable.jqueryHandsontableStrings.insert_col
import typingsSlinky.jqueryHandsontable.jqueryHandsontableStrings.insert_row
import typingsSlinky.jqueryHandsontable.jqueryHandsontableStrings.remove_col
import typingsSlinky.jqueryHandsontable.jqueryHandsontableStrings.remove_row
...
object Handsontable {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAfterChange(value: (/* changes */ js.Array[_], /* source */ String) => Unit): Self = StObject.set(x, "afterChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setAutoComplete(value: js.Array[_]): Self = StObject.set(x, "autoComplete", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setBeforeChange(value: (/* changes */ js.Array[js.Array[_]], /* source */ String) => Unit): Self = StObject.set(x, "beforeChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setBeforeSetRangeEnd(value: /* coords */ js.Array[_] => Unit): Self = StObject.set(x, "beforeSetRangeEnd", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnBeforeChange(value: (/* changes */ js.Array[_], /* source */ String) => Unit): Self = StObject.set(x, "onBeforeChange", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnBeforeChangeUndefined: Self = StObject.set(x, "onBeforeChange", js.undefined)
      
      @scala.inline
      def setOnChange(value: (/* changes */ js.Array[_], /* source */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
