package typingsSlinky.jwtDecode.mod
...
@js.native
trait JwtDecodeOptions extends js.Object {
...
object JwtDecodeOptions {
  ...
  @scala.inline
  implicit class JwtDecodeOptionsOps[Self <: JwtDecodeOptions] (val x: Self) extends AnyVal {
