...
object settingregistryMod {
  ...
  object Settings {
    ...
    object IOptions {
      ...
      @scala.inline
      def apply(plugin: IPlugin, registry: ISettingRegistry): typingsSlinky.jupyterlabSettingregistry.settingregistryMod.Settings.IOptions = {
        val __obj = js.Dynamic.literal(plugin = plugin.asInstanceOf[js.Any], registry = registry.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.jupyterlabSettingregistry.settingregistryMod.Settings.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabSettingregistry.settingregistryMod.Settings.IOptions] (val x: Self) extends AnyVal {
