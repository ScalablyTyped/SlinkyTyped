package typingsSlinky.jupyterlabSettingregistry.tokensMod.ISettingRegistry.IPlugin
...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.jupyterlabSettingregistry.jupyterlabSettingregistryStrings.compose
