...
object jupyterlabCodeeditorStrings {
  ...
  @scala.inline
  def handlePaste: handlePaste = "handlePaste".asInstanceOf[handlePaste]
  ...
  @js.native
  sealed trait bottom extends EdgeLocation
  ...
  @js.native
  sealed trait handlePaste extends js.Object
  ...
  @js.native
  sealed trait top extends EdgeLocation
  
  @js.native
  sealed trait topLine extends EdgeLocation
