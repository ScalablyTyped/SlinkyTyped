...
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.autoClosingBrackets
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.bounded
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.codeFolding
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.fontFamily
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.fontSize
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.handlePaste
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.insertSpaces
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.lineNumbers
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.lineWrap
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.matchBrackets
...
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.readOnly
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.rulers
import typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.tabSize
...
import typingsSlinky.std.ClientRect
...
object CodeEditor {
  ...
  object Model {
    ...
    object IOptions {
      ...
      @scala.inline
      def apply(): typingsSlinky.jupyterlabCodeeditor.editorMod.CodeEditor.Model.IOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.jupyterlabCodeeditor.editorMod.CodeEditor.Model.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabCodeeditor.editorMod.CodeEditor.Model.IOptions] (val x: Self) extends AnyVal {
  ...
  */
  ...
  trait IEditor
    ...
    @JSName("getOption")
    def getOption_lineHeight(option: typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.lineHeight): Double | Null = js.native
    @JSName("getOption")
    ...
    @JSName("setOption")
    def setOption_lineHeight(option: typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.lineHeight): Unit = js.native
    @JSName("setOption")
    def setOption_lineHeight(option: typingsSlinky.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.lineHeight, value: Double): Unit = js.native
    @JSName("setOption")
