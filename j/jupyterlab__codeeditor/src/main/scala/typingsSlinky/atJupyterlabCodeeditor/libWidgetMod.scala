...
import typingsSlinky.atPhosphorWidgets.atPhosphorWidgetsMod.Widget.ResizeMessage
  ...
  object CodeEditorWrapper extends js.Object {
    ...
    trait IOptions extends js.Object {
      ...
      /**
        ...
        * object because it needs to provide its own node as the host.
        */
      def factory(options: typingsSlinky.atJupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions): IEditor = js.native
    }
