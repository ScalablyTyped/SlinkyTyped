...
import typingsSlinky.jsData.collectionMod.CollectionOpts
import typingsSlinky.jsData.collectionMod.default
import typingsSlinky.jsData.componentMod.ComponentOpts
import typingsSlinky.jsData.dataStoreMod.DataStoreOpts
import typingsSlinky.jsData.mapperMod.MapperOpts
import typingsSlinky.jsData.mindexMod.IndexOpts
...
object mod extends js.Object {
  ...
  @js.native
  class Container ()
    extends typingsSlinky.jsData.containerMod.Container {
    def this(opts: js.Object) = this()
  }
  
  @js.native
  class DataStore ()
    extends typingsSlinky.jsData.dataStoreMod.default {
    def this(opts: DataStoreOpts) = this()
  }
  
  @js.native
  class Index ()
    extends typingsSlinky.jsData.mindexMod.default {
  ...
  class LinkedCollection protected ()
    extends typingsSlinky.jsData.linkedCollectionMod.default {
    def this(records: js.Any, opts: js.Any) = this()
  }
  
  @js.native
  class Mapper ()
    extends typingsSlinky.jsData.mapperMod.default {
