package typingsSlinky.jsData.mapperMod

import org.scalablytyped.runtime.Instantiable1
import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.jsData.anon.TypeofRecord
import typingsSlinky.jsData.jsDataStrings.skip
import typingsSlinky.jsData.schemaMod.PropertyDefinition
import typingsSlinky.jsData.schemaMod.SchemaDefinition
...
trait MapperOpts
  ...
  var schema: js.UndefOr[SchemaDefinition | typingsSlinky.jsData.schemaMod.default] = js.native
...
object MapperOpts {
  ...
  implicit class MapperOptsOps[Self <: MapperOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSchema(value: SchemaDefinition | typingsSlinky.jsData.schemaMod.default): Self = this.set("schema", value.asInstanceOf[js.Any])
