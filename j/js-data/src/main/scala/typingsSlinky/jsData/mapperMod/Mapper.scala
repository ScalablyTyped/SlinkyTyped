...
import typingsSlinky.jsData.anon.Count
import typingsSlinky.jsData.anon.TypeofRecord
import typingsSlinky.jsData.jsDataBooleans.`false`
...
trait Mapper
  ...
  /**
    ...
    * @since 3.0.0
    */
  def createRecord(): typingsSlinky.jsData.recordMod.default | js.Array[typingsSlinky.jsData.recordMod.default] | js.Any = js.native
