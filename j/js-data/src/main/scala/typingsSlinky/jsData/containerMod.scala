...
import typingsSlinky.jsData.componentMod.default
...
object containerMod extends js.Object {
  ...
  class Container () extends default {
    ...
    /**
      ...
      * @since 3.0.0
      */
    def defineMapper(): typingsSlinky.jsData.mapperMod.default = js.native
    def defineMapper(name: js.UndefOr[scala.Nothing], opts: MapperOpts): typingsSlinky.jsData.mapperMod.default = js.native
    def defineMapper(name: String): typingsSlinky.jsData.mapperMod.default = js.native
    def defineMapper(name: String, opts: MapperOpts): typingsSlinky.jsData.mapperMod.default = js.native
    def defineMapper(name: js.Any): typingsSlinky.jsData.mapperMod.default = js.native
