...
object IOptions {
  ...
  implicit class IOptionsOps[Self <: IOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFactory(value: /* options */ typingsSlinky.jupyterlabCodeeditor.editorMod.CodeEditor.IOptions => IEditor): Self = this.set("factory", js.Any.fromFunction1(value))
