...
import typingsSlinky.jspdf.Anon_Align
import typingsSlinky.jspdf.Anon_Anticlockwise
import typingsSlinky.jspdf.Anon_Collections
import typingsSlinky.jspdf.Anon_GetContext
import typingsSlinky.jspdf.Anon_ReturnPromise
