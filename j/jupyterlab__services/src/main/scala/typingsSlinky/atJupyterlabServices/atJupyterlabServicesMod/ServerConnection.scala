...
object ServerConnection extends js.Object {
  ...
  class NetworkError protected ()
    extends typingsSlinky.atJupyterlabServices.libServerconnectionMod.ServerConnection.NetworkError {
    /**
  ...
  class ResponseError protected ()
    extends typingsSlinky.atJupyterlabServices.libServerconnectionMod.ServerConnection.ResponseError {
    /**
