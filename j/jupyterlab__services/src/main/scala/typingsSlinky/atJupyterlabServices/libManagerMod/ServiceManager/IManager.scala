package typingsSlinky.atJupyterlabServices.libManagerMod.ServiceManager
...
trait IManager extends IDisposable {
  /**
    ...
    */
  val builder: typingsSlinky.atJupyterlabServices.libBuilderMod.Builder.IManager
  /**
  ...
  /**
    ...
    */
  val contents: typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IManager
  /**
  ...
  /**
    ...
    */
  val nbconvert: typingsSlinky.atJupyterlabServices.libNbconvertMod.NbConvert.IManager
  /**
  ...
  /**
    ...
    */
  val sessions: typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IManager
  /**
    * The setting manager for the manager.
    */
  val settings: typingsSlinky.atJupyterlabServices.libSettingMod.Setting.IManager
  /**
  ...
  /**
    ...
    */
  val terminals: typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IManager
  /**
    * The workspace manager for the manager.
    */
  val workspaces: typingsSlinky.atJupyterlabServices.libWorkspaceMod.Workspace.IManager
}

object IManager {
  @scala.inline
  def apply(
    builder: typingsSlinky.atJupyterlabServices.libBuilderMod.Builder.IManager,
    connectionFailure: ISignal[IManager, js.Error],
    contents: typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IManager,
    dispose: () => Unit,
    isDisposed: Boolean,
    isReady: Boolean,
    nbconvert: typingsSlinky.atJupyterlabServices.libNbconvertMod.NbConvert.IManager,
    ready: js.Promise[Unit],
    serverSettings: ISettings,
    sessions: typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IManager,
    settings: typingsSlinky.atJupyterlabServices.libSettingMod.Setting.IManager,
    specsChanged: ISignal[IManager, ISpecModels],
    terminals: typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IManager,
    workspaces: typingsSlinky.atJupyterlabServices.libWorkspaceMod.Workspace.IManager,
