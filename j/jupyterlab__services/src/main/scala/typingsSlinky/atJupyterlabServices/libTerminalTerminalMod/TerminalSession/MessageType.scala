...
object MessageType {
  ...
  @scala.inline
  def disconnect: typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.disconnect = this.cast("disconnect")
  @scala.inline
  def set_size: typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.set_size = this.cast("set_size")
  @scala.inline
  def stdin: typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.stdin = this.cast("stdin")
  @scala.inline
  def stdout: typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.stdout = this.cast("stdout")
}
