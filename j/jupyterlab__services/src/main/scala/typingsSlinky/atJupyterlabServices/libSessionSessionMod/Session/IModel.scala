...
trait IModel extends JSONObject {
  /**
    ...
    */
  val id: String
  val kernel: typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.IModel
  val name: String
  val path: String
  val `type`: String
}
...
object IModel {
  ...
  def apply(
    id: String,
    kernel: typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.IModel,
    name: String,
    path: String,
    `type`: String
  ): IModel = {
