package typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session

import typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.`type`
import typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.name
import typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.path
...
trait ISession extends IDisposable {
  ...
  /**
    ...
    */
  def changeKernel(options: Partial[typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.IModel]): js.Promise[IKernelConnection]
  /**
...
object ISession {
  ...
  def apply(
    ...
    changeKernel: Partial[typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.IModel] => js.Promise[IKernelConnection],
    dispose: () => Unit,
    id: String,
