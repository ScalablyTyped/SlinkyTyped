...
import typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.IAnyMessageArgs
...
import typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.Status
import typingsSlinky.atJupyterlabServices.libKernelMessagesMod.KernelMessage.IIOPubMessage
import typingsSlinky.atJupyterlabServices.libKernelMessagesMod.KernelMessage.IMessage
import typingsSlinky.atJupyterlabServices.libKernelMessagesMod.KernelMessage.IOPubMessageType
...
import typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IKernelChangedArgs
import typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IOptions
...
@js.native
object libSessionDefaultMod extends js.Object {
  @js.native
  class DefaultSession protected () extends ISession {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val model: typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel = js.native
    /**
    ...
    override val propertyChanged: ISignal[
        this.type, 
        typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.path | typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.name | typingsSlinky.atJupyterlabServices.atJupyterlabServicesStrings.`type`
      ] = js.native
    /**
    ...
    /**
      ...
      */
    def update(model: typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel): Unit = js.native
  }
  ...
  object DefaultSession extends js.Object {
    /**
      ...
      */
    def connectTo(model: typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel): ISession = js.native
    def connectTo(model: typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel, settings: ISettings): ISession = js.native
    /**
      * Find a session by id.
      */
    def findById(id: String): js.Promise[typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    def findById(id: String, settings: ISettings): js.Promise[typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    /**
      * Find a session by path.
      */
    def findByPath(path: String): js.Promise[typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    def findByPath(path: String, settings: ISettings): js.Promise[typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    /**
      * List the running sessions.
      */
    def listRunning(): js.Promise[js.Array[typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel]] = js.native
    def listRunning(settings: ISettings): js.Promise[js.Array[typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel]] = js.native
    /**
