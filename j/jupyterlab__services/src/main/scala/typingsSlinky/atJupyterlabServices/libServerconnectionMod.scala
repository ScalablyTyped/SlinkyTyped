...
@js.native
object libServerconnectionMod extends js.Object {
  @js.native
  object ServerConnection extends js.Object {
    ...
    trait ISettings extends js.Object {
      /**
        ...
        */
      val Headers: Anon_InitHeaders = js.native
      /**
        * The `Request` object constructor.
        */
      val Request: Anon_Init = js.native
      /**
        * The `WebSocket` object constructor.
        */
      val WebSocket: Anon_CLOSED = js.native
      /**
