...
import typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.IComm
...
import typingsSlinky.atPhosphorDisposable.atPhosphorDisposableMod.DisposableDelegate
