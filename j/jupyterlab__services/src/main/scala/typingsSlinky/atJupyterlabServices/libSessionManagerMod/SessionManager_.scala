package typingsSlinky.atJupyterlabServices.libSessionManagerMod
...
import typingsSlinky.atJupyterlabServices.libSessionManagerMod.SessionManager.IOptions
...
class SessionManager_ () extends IManager {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def startNew(options: typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IOptions): js.Promise[ISession] = js.native
  /**
