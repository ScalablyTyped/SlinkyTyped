...
@js.native
object libTerminalMod extends js.Object {
  @js.native
  /**
    * Construct a new terminal manager.
    */
  class TerminalManager ()
    extends typingsSlinky.atJupyterlabServices.libTerminalManagerMod.TerminalManager {
  ...
  object TerminalSession extends js.Object {
    ...
    def startNew(options: typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IOptions): js.Promise[ISession] = js.native
  }
