...
import typingsSlinky.atJupyterlabServices.libContentsMod.Contents.ContentType
import typingsSlinky.atJupyterlabServices.libContentsMod.Contents.FileFormat
import typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.Status
import typingsSlinky.atJupyterlabServices.libKernelMessagesMod.KernelMessage.Channel
...
object atJupyterlabServicesStrings {
  ...
  sealed trait disconnect
    extends typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.MessageType
  ...
  sealed trait stdin
    extends Channel
       with typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.MessageType
