package typingsSlinky.atJupyterlabServices.libTerminalManagerMod

import typingsSlinky.atJupyterlabServices.libTerminalManagerMod.TerminalManager.IOptions
import typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IManager
import typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IModel
...
class TerminalManager_ () extends IManager {
  ...
  def connectTo(
    name: String,
    options: typingsSlinky.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IOptions
