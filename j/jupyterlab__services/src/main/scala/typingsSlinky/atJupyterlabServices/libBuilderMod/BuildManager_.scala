...
import typingsSlinky.atJupyterlabServices.libBuilderMod.BuildManager.IOptions
import typingsSlinky.atJupyterlabServices.libBuilderMod.BuildManager.IStatus
