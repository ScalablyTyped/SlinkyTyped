package typingsSlinky.atJupyterlabServices.libWorkspaceMod
...
import typingsSlinky.atJupyterlabServices.libWorkspaceMod.Workspace.IWorkspace
import typingsSlinky.atJupyterlabServices.libWorkspaceMod.WorkspaceManager.IOptions
