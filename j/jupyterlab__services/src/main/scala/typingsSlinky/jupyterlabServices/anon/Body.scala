...
import typingsSlinky.jupyterlabServices.jupyterlabServicesStrings.response
...
object Body {
  ...
  implicit class BodyOps[Self <: Body] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequest_seq(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("request_seq")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withType(value: response): Self = {
        val ret = this.duplicate
