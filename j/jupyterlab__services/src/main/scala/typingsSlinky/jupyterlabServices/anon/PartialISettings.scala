...
trait PartialISettings extends js.Object {
  ...
  var Headers: js.UndefOr[Instantiable with Instantiable0[org.scalajs.dom.experimental.Headers]] = js.native
  
  var Request: js.UndefOr[
    InstantiableRequest with (Instantiable1[/* input */ RequestInfo, org.scalajs.dom.experimental.Request])
  ] = js.native
  
  var WebSocket: js.UndefOr[CLOSED with (Instantiable1[/* url */ String, org.scalajs.dom.raw.WebSocket])] = js.native
