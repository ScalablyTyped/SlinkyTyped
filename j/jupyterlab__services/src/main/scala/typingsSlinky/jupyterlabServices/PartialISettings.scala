...
trait PartialISettings extends js.Object {
  var Headers: js.UndefOr[AnonInstantiable] = js.native
  var Request: js.UndefOr[AnonInstantiableRequest] = js.native
  var WebSocket: js.UndefOr[AnonCLOSED] = js.native
...
object PartialISettings {
  ...
  implicit class PartialISettingsOps[Self <: PartialISettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHeaders(value: AnonInstantiable): Self = {
    ...
    @scala.inline
    def withRequest(value: AnonInstantiableRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWebSocket(value: AnonCLOSED): Self = {
        val ret = this.duplicate
