...
object contentsMod {
  ...
  object Drive {
    ...
    object IOptions {
      ...
      @scala.inline
      def apply(): typingsSlinky.jupyterlabServices.contentsMod.Drive.IOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.jupyterlabServices.contentsMod.Drive.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabServices.contentsMod.Drive.IOptions] (val x: Self) extends AnyVal {
