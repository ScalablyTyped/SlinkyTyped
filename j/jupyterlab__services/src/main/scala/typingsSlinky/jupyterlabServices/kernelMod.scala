...
object kernelMod extends js.Object {
  ...
  /**
    ...
    */
  class KernelManager ()
    extends typingsSlinky.jupyterlabServices.managerMod.KernelManager {
  ...
  object Kernel extends js.Object {
    ...
    def startNew(options: typingsSlinky.jupyterlabServices.kernelKernelMod.Kernel.IOptions): js.Promise[IKernel] = js.native
  }
  ...
  object KernelMessage extends js.Object {
    ...
    @JSName("createMessage")
    def createMessage_T_ICommCloseMsgiopub[T /* <: ICommCloseMsg[iopub] */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICommCloseMsgshell[T /* <: ICommCloseMsg[shell] */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICommInfoReplyMsg[T /* <: ICommInfoReplyMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICommInfoRequestMsg[T /* <: ICommInfoRequestMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICommMsgMsgiopub[T /* <: ICommMsgMsg[iopub] */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICommMsgMsgshell[T /* <: ICommMsgMsg[shell] */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICommOpenMsgiopub[T /* <: ICommOpenMsg[iopub] */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICommOpenMsgshell[T /* <: ICommOpenMsg[shell] */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICompleteReplyMsg[T /* <: ICompleteReplyMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_ICompleteRequestMsg[T /* <: ICompleteRequestMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    /**
      * @hidden
      * #### Notes
      ...
      */
    @JSName("createMessage")
    def createMessage_T_IDebugEventMsg[T /* <: IDebugEventMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    /**
      * @hidden
      * #### Notes
      * Debug messages are experimental messages that are not in the official
      ...
      */
    @JSName("createMessage")
    def createMessage_T_IDebugReplyMsg[T /* <: IDebugReplyMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    /**
      * @hidden
      * #### Notes
      * Debug messages are experimental messages that are not in the official
    ...
    @JSName("createMessage")
    def createMessage_T_IExecuteReplyMsg[T /* <: IExecuteReplyMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IExecuteRequestMsg[T /* <: IExecuteRequestMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IExecuteResultMsg[T /* <: IExecuteResultMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IHistoryReplyMsg[T /* <: IHistoryReplyMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    ...
    @JSName("createMessage")
    def createMessage_T_IInputRequestMsg[T /* <: IInputRequestMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IInspectReplyMsg[T /* <: IInspectReplyMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IInspectRequestMsg[T /* <: IInspectRequestMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IIsCompleteReplyMsg[T /* <: IIsCompleteReplyMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IIsCompleteRequestMsg[T /* <: IIsCompleteRequestMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IStatusMsg[T /* <: IStatusMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IStreamMsg[T /* <: IStreamMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    @JSName("createMessage")
    def createMessage_T_IUpdateDisplayDataMsg[T /* <: IUpdateDisplayDataMsg */](options: typingsSlinky.jupyterlabServices.messagesMod.KernelMessage.IOptions[T]): T = js.native
    /**
