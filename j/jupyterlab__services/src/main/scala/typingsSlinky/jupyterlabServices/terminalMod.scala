...
object terminalMod extends js.Object {
  ...
  class TerminalManager ()
    extends typingsSlinky.jupyterlabServices.terminalManagerMod.TerminalManager {
  ...
  object TerminalSession extends js.Object {
    ...
    def startNew(options: typingsSlinky.jupyterlabServices.terminalTerminalMod.TerminalSession.IOptions): js.Promise[ISession] = js.native
  }
