...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.jupyterlabServices.jupyterlabServicesStrings.terminating
...
object Status {
  ...
  @scala.inline
  def terminating: typingsSlinky.jupyterlabServices.jupyterlabServicesStrings.terminating = "terminating".asInstanceOf[typingsSlinky.jupyterlabServices.jupyterlabServicesStrings.terminating]
