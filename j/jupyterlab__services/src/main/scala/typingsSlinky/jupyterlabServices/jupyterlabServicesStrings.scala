...
object jupyterlabServicesStrings {
  ...
  sealed trait disconnect
    extends typingsSlinky.jupyterlabServices.terminalTerminalMod.TerminalSession.MessageType
  ...
  sealed trait stdin
    extends Channel
       with typingsSlinky.jupyterlabServices.terminalTerminalMod.TerminalSession.MessageType
