...
import typingsSlinky.jupyterlabServices.terminalTerminalMod.ConnectionStatus
...
object jupyterlabServicesStrings {
  ...
  sealed trait connected
    extends ConnectionStatus
       with typingsSlinky.jupyterlabServices.kernelKernelMod.ConnectionStatus
  ...
  sealed trait disconnect
    extends typingsSlinky.jupyterlabServices.terminalTerminalMod.MessageType
  ...
  sealed trait stdin
    extends Channel
       with typingsSlinky.jupyterlabServices.terminalTerminalMod.MessageType
