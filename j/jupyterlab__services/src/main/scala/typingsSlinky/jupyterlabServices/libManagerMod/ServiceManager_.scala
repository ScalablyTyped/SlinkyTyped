...
class ServiceManager_ () extends IManager {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val builder: typingsSlinky.jupyterlabServices.builderMod.Builder.IManager = js.native
  /**
    * The builder for the manager.
    */
  @JSName("builder")
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val contents: typingsSlinky.jupyterlabServices.contentsMod.Contents.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val nbconvert: typingsSlinky.jupyterlabServices.nbconvertMod.NbConvert.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val sessions: typingsSlinky.jupyterlabServices.sessionSessionMod.Session.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val settings: typingsSlinky.jupyterlabServices.settingMod.Setting.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val terminals: typingsSlinky.jupyterlabServices.terminalTerminalMod.TerminalSession.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val workspaces: typingsSlinky.jupyterlabServices.workspaceMod.Workspace.IManager = js.native
  /**
