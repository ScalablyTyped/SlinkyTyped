package typingsSlinky.japaneseHolidays
...
object mod {
  ...
  @js.native
  def isHoliday(date: js.Date): js.UndefOr[String] = js.native
  @JSImport("japanese-holidays", "isHoliday")
  @js.native
  def isHoliday(date: js.Date, furikae: Boolean): js.UndefOr[String] = js.native
  
  @JSImport("japanese-holidays", "isHolidayAt")
  @js.native
  def isHolidayAt(date: js.Date): js.UndefOr[String] = js.native
  @JSImport("japanese-holidays", "isHolidayAt")
  @js.native
  def isHolidayAt(date: js.Date, furikae: Boolean): js.UndefOr[String] = js.native
