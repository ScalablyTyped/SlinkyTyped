package typingsSlinky.jsToJava
...
object mod {
  ...
  object array {
    ...
    @js.native
    def Currency(value: js.Array[Null | String | typingsSlinky.jsToJava.mod.Currency]): js.Object = js.native
  ...
  @js.native
  def exception(error: js.Error, className: String): js.Object = js.native
