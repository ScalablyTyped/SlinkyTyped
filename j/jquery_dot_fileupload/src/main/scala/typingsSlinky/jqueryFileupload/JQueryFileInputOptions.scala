...
object JQueryFileInputOptions {
  ...
  implicit class JQueryFileInputOptionsMutableBuilder[Self <: JQueryFileInputOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFileInputElement(value: Element): Self = StObject.set(x, "fileInput", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPasteZoneElement(value: Element): Self = StObject.set(x, "pasteZone", value.asInstanceOf[js.Any])
