...
object JQueryFileInputOptions {
  ...
  implicit class JQueryFileInputOptionsOps[Self <: JQueryFileInputOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFileInputElement(value: Element): Self = this.set("fileInput", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPasteZoneElement(value: Element): Self = this.set("pasteZone", value.asInstanceOf[js.Any])
