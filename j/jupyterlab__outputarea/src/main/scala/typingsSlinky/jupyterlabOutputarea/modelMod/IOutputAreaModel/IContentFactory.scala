...
object IContentFactory {
  ...
  implicit class IContentFactoryOps[Self <: IContentFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateOutputModel(value: typingsSlinky.jupyterlabRendermime.outputmodelMod.IOutputModel.IOptions => IOutputModel): Self = this.set("createOutputModel", js.Any.fromFunction1(value))
  }
}
