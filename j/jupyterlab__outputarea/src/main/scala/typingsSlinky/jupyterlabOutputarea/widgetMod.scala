  ...
  object OutputArea {
    ...
    object IContentFactory {
      ...
      implicit class IContentFactoryMutableBuilder[Self <: IContentFactory] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreateStdin(value: typingsSlinky.jupyterlabOutputarea.widgetMod.Stdin.IOptions => IStdin): Self = StObject.set(x, "createStdin", js.Any.fromFunction1(value))
      }
    }
  ...
  object Stdin {
    ...
    object IOptions {
      ...
      def apply(
        ...
        password: Boolean,
        prompt: String
      ): typingsSlinky.jupyterlabOutputarea.widgetMod.Stdin.IOptions = {
        ...
        __obj.asInstanceOf[typingsSlinky.jupyterlabOutputarea.widgetMod.Stdin.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabOutputarea.widgetMod.Stdin.IOptions] (val x: Self) extends AnyVal {
