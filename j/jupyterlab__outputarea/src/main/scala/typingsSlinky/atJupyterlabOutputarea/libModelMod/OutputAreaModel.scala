...
import typingsSlinky.atJupyterlabOutputarea.Anon_LastModel
...
object OutputAreaModel extends js.Object {
  ...
  class ContentFactory () extends IContentFactory {
    /**
      ...
      */
    /* CompleteClass */
    override def createOutputModel(options: typingsSlinky.atJupyterlabRendermime.libOutputmodelMod.IOutputModel.IOptions): IOutputModel = js.native
  }
