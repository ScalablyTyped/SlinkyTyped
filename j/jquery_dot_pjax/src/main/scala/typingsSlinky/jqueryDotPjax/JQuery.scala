package typingsSlinky.jqueryDotPjax

import typingsSlinky.jqueryDotPjax.jqueryDotPjaxStrings.`pjax:popstate`
...
trait JQuery extends js.Object {
  @JSName("on")
  def on_pjaxpopstate(event: `pjax:popstate`, handler: js.Function1[/* e */ PjaxPopStateEventObject, Unit]): this.type = js.native
  /**
