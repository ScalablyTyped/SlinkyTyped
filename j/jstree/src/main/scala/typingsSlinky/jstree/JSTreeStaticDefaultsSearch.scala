...
object JSTreeStaticDefaultsSearch {
  ...
  implicit class JSTreeStaticDefaultsSearchOps[Self <: JSTreeStaticDefaultsSearch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClose_opened_onclear(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("close_opened_onclear")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSearch_callback(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("search_callback")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSearch_leaves_only(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("search_leaves_only")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withShow_only_matches(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("show_only_matches")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withShow_only_matches_children(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("show_only_matches_children")(value.asInstanceOf[js.Any])
        ret
    }
  }
