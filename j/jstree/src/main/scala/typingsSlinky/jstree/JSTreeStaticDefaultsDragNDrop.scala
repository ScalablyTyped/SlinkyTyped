...
object JSTreeStaticDefaultsDragNDrop {
  ...
  implicit class JSTreeStaticDefaultsDragNDropOps[Self <: JSTreeStaticDefaultsDragNDrop] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlways_copy(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("always_copy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCheck_while_dragging(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check_while_dragging")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withDrag_selection(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("drag_selection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withInside_pos(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("inside_pos")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIs_draggable(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_draggable")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLarge_drag_target(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("large_drag_target")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLarge_drop_target(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("large_drop_target")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUse_html5(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("use_html5")(value.asInstanceOf[js.Any])
        ret
    }
  }
