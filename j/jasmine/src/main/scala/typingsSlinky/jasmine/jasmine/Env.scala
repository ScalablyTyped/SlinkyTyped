...
trait Env extends js.Object {
  ...
  def afterAll(afterAllFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def afterAll(afterAllFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
  def afterEach(afterEachFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def afterEach(afterEachFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
  def allowRespy(allow: Boolean): Unit = js.native
  def beforeAll(beforeAllFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def beforeAll(beforeAllFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
  // ddescribe(description: string, specDefinitions: () => void): Suite; Not a part of jasmine. Angular team adds these
  def beforeEach(beforeEachFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def beforeEach(beforeEachFunction: typingsSlinky.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
