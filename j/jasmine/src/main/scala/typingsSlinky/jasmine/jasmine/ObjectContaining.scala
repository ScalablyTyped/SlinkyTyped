...
trait ObjectContaining[T]
  ...
  {[ K in keyof T ]:? any}
    */ /* sample */ typingsSlinky.jasmine.jasmineStrings.ObjectContaining with js.Any, 
      /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof T ]:? any}
    */ typingsSlinky.jasmine.jasmineStrings.ObjectContaining with js.Any
    ]
  ] = js.undefined
...
object ObjectContaining {
  ...
  {[ K in keyof T ]:? any}
    */ /* sample */ typingsSlinky.jasmine.jasmineStrings.ObjectContaining with js.Any => /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof T ]:? any}
    */ typingsSlinky.jasmine.jasmineStrings.ObjectContaining with js.Any = null
  ): ObjectContaining[T] = {
...
object objectContaining extends js.Object {
  def apply[T](sample: Partial[T]): ObjectContaining[T] = js.native
}
