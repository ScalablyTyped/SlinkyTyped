package typingsSlinky.jqueryDashJcrop

import typingsSlinky.jqueryDashJcrop.JQuery.Jcrop.CardinalDirection
import typingsSlinky.jqueryDashJcrop.JQuery.Jcrop.IntermediateDirection
