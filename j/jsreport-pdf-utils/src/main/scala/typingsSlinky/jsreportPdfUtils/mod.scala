package typingsSlinky.jsreportPdfUtils

import typingsSlinky.jsreportCore.mod.ExtensionDefinition
import typingsSlinky.jsreportCore.mod.Template
import typingsSlinky.jsreportPdfUtils.anon.Contrent
import typingsSlinky.jsreportPdfUtils.jsreportPdfUtilsBooleans.`true`
import typingsSlinky.jsreportPdfUtils.jsreportPdfUtilsStrings.HighResolution
import typingsSlinky.jsreportPdfUtils.jsreportPdfUtilsStrings.LowResolution
import typingsSlinky.jsreportPdfUtils.jsreportPdfUtilsStrings.NotAllowed
import typingsSlinky.jsreportPdfUtils.jsreportPdfUtilsStrings.append
import typingsSlinky.jsreportPdfUtils.jsreportPdfUtilsStrings.merge
import typingsSlinky.jsreportPdfUtils.jsreportPdfUtilsStrings.prepend
import typingsSlinky.jsreportPdfUtils.mod.JsReportPdfUtils.PdfMeta
import typingsSlinky.jsreportPdfUtils.mod.JsReportPdfUtils.PdfOperation
import typingsSlinky.jsreportPdfUtils.mod.JsReportPdfUtils.PdfPassword
import typingsSlinky.jsreportPdfUtils.mod.JsReportPdfUtils.PdfSign
...
object mod {
  ...
  object jsreportCoreAugmentingMod {
    ...
    object Template {
      ...
      @scala.inline
      def apply(): typingsSlinky.jsreportPdfUtils.mod.jsreportCoreAugmentingMod.Template = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.jsreportPdfUtils.mod.jsreportCoreAugmentingMod.Template]
      }
      
      @scala.inline
      implicit class TemplateMutableBuilder[Self <: typingsSlinky.jsreportPdfUtils.mod.jsreportCoreAugmentingMod.Template] (val x: Self) extends AnyVal {
