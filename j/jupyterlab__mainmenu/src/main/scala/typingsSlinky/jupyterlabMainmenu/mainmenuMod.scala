...
object mainmenuMod extends js.Object {
  ...
  class MainMenu protected ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def addMenu(menu: typingsSlinky.luminoWidgets.mod.Menu): Unit = js.native
    /* InferMemberOverrides */
    override def addMenu(menu: typingsSlinky.luminoWidgets.mod.Menu, options: IAddOptions): Unit = js.native
