...
import typingsSlinky.phosphorWidgets.mod.MenuBar
...
object mainmenuMod extends js.Object {
  ...
  class MainMenu protected ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def addMenu(menu: typingsSlinky.phosphorWidgets.mod.Menu): Unit = js.native
    /* InferMemberOverrides */
    override def addMenu(menu: typingsSlinky.phosphorWidgets.mod.Menu, options: IAddOptions): Unit = js.native
    /**
