...
import typingsSlinky.jestMessageUtil.typesMod.Frame
...
object mod {
  ...
  @JSImport("jest-message-util", "formatExecError")
  @js.native
  def formatExecError(error: js.Error, config: PickProjectConfigrootDirt, options: StackTraceOptions): String = js.native
  @JSImport("jest-message-util", "formatExecError")
  @js.native
  def formatExecError(
    error: js.Error,
  ...
  @JSImport("jest-message-util", "formatExecError")
  @js.native
  def formatExecError(error: js.Error, config: PickProjectConfigrootDirt, options: StackTraceOptions, testPath: String): String = js.native
  @JSImport("jest-message-util", "formatExecError")
  @js.native
  def formatExecError(
    error: js.Error,
