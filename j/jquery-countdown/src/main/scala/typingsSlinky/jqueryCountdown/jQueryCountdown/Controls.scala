...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.jqueryCountdown.jqueryCountdownStrings.start
  - typingsSlinky.jqueryCountdown.jqueryCountdownStrings.stop
  - typingsSlinky.jqueryCountdown.jqueryCountdownStrings.pause
  - typingsSlinky.jqueryCountdown.jqueryCountdownStrings.resume
*/
