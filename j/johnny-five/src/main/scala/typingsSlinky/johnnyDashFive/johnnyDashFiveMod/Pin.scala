...
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.analog
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.data
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.digital
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.high
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.low
