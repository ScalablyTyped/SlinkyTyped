...
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.DEFAULT
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.FORWARD
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.FORWARD_REVERSE
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.FORWARD_REVERSE_BRAKE
import typingsSlinky.johnnyDashFive.johnnyDashFiveStrings.PCA9685
