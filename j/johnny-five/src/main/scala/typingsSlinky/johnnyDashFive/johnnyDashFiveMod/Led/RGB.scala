package typingsSlinky.johnnyDashFive.johnnyDashFiveMod.Led
...
class RGB protected () extends js.Object {
  ...
  var blue: typingsSlinky.johnnyDashFive.johnnyDashFiveMod.Led = js.native
  var green: typingsSlinky.johnnyDashFive.johnnyDashFiveMod.Led = js.native
  val isAnode: Boolean = js.native
  var red: typingsSlinky.johnnyDashFive.johnnyDashFiveMod.Led = js.native
