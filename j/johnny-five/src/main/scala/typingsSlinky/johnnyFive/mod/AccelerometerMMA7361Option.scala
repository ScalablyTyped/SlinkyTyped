...
object AccelerometerMMA7361Option {
  ...
  implicit class AccelerometerMMA7361OptionOps[Self <: AccelerometerMMA7361Option] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSleepPin(value: Double | String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sleepPin")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSleepPin: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sleepPin")(js.undefined)
        ret
    }
  }
