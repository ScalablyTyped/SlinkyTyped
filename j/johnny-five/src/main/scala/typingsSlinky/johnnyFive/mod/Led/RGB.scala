...
class RGB protected () extends js.Object {
  ...
  var blue: typingsSlinky.johnnyFive.mod.Led = js.native
  var green: typingsSlinky.johnnyFive.mod.Led = js.native
  val isAnode: Boolean = js.native
  var red: typingsSlinky.johnnyFive.mod.Led = js.native
