...
object FileSystem {
  ...
  implicit class FileSystemOps[Self <: FileSystem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLstat(value: (String, Callback[typingsSlinky.node.fsMod.Stats]) => Unit): Self = this.set("lstat", js.Any.fromFunction2(value))
    
    @scala.inline
    def setReaddir(value: (String, Callback[js.Array[String]]) => Unit): Self = this.set("readdir", js.Any.fromFunction2(value))
    
    @scala.inline
    def setStat(value: (String, Callback[typingsSlinky.node.fsMod.Stats]) => Unit): Self = this.set("stat", js.Any.fromFunction2(value))
  }
}
