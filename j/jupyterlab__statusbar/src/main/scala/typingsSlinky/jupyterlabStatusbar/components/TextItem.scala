...
import typingsSlinky.jupyterlabStatusbar.textMod.TextItem.IProps
...
object TextItem {
  ...
  def withProps(p: IProps with HTMLAttributes[HTMLSpanElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(source: String | Double): Builder = {
    val __props = js.Dynamic.literal(source = source.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[IProps with HTMLAttributes[HTMLSpanElement]]))
  }
}
