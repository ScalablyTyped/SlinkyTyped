...
import typingsSlinky.jqueryRateit.jqueryRateitStrings.ispreset
import typingsSlinky.jqueryRateit.jqueryRateitStrings.max
import typingsSlinky.jqueryRateit.jqueryRateitStrings.min
