...
import typingsSlinky.jqueryDotMmenu.JQuery
import typingsSlinky.jqueryDotMmenu.jqueryDotMmenuStrings.closeAllPanels
import typingsSlinky.jqueryDotMmenu.jqueryDotMmenuStrings.closePanel
import typingsSlinky.jqueryDotMmenu.jqueryDotMmenuStrings.getInstance
import typingsSlinky.jqueryDotMmenu.jqueryDotMmenuStrings.init
import typingsSlinky.jqueryDotMmenu.jqueryDotMmenuStrings.openPanel
import typingsSlinky.jqueryDotMmenu.jqueryDotMmenuStrings.setSelected
import typingsSlinky.jqueryDotMmenu.jqueryDotMmenuStrings.update
