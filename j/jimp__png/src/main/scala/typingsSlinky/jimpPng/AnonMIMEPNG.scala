...
import typingsSlinky.jimpPng.jimpPngNumbers.`0`
import typingsSlinky.jimpPng.jimpPngNumbers.`1`
...
object AnonMIMEPNG {
  ...
  @scala.inline
  implicit class AnonMIMEPNGOps[Self <: AnonMIMEPNG] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPNG_FILTER_NONE(value: `0`): Self = {
        val ret = this.duplicate
