package typingsSlinky.jqueryDotPrettyphoto

import typingsSlinky.jqueryDotPrettyphoto.scaron_prettyPhoto.PrettyPhotoSettings
import typingsSlinky.jqueryDotPrettyphoto.scaron_prettyPhoto.moduleJQuery
