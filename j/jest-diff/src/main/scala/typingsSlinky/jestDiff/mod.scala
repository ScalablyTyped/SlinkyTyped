...
object mod extends js.Object {
  ...
  def diffLinesRaw(aLines: js.Array[String], bLines: js.Array[String]): js.Array[typingsSlinky.jestDiff.cleanupSemanticMod.Diff] = js.native
  ...
  def diffStringsRaw(a: String, b: String, cleanup: Boolean): js.Array[typingsSlinky.jestDiff.cleanupSemanticMod.Diff] = js.native
  ...
  class Diff protected ()
    extends typingsSlinky.jestDiff.cleanupSemanticMod.Diff {
