package typingsSlinky.atJupyterlabApplication.libLabMod.JupyterLab

import typingsSlinky.atJupyterlabApplication.libFrontendMod.JupyterFrontEnd.IPaths
import typingsSlinky.atJupyterlabApplication.libShellMod.LabShell
import typingsSlinky.atJupyterlabApputils.atJupyterlabApputilsMod.CommandLinker
...
import typingsSlinky.atPhosphorWidgets.libMenuMod.Menu.IRenderer
...
- Dropped {[ P in keyof @jupyterlab/application.@jupyterlab/application/lib/lab.JupyterLab.IInfo ]:? @jupyterlab/application.@jupyterlab/application/lib/lab.JupyterLab.IInfo[P]} */ trait IOptions
  extends typingsSlinky.atJupyterlabApplication.libFrontendMod.JupyterFrontEnd.IOptions[LabShell, js.Any] {
