...
import typingsSlinky.atJupyterlabApplication.libLayoutrestorerMod.LayoutRestorer.IOptions
...
class LayoutRestorer_ protected () extends ILayoutRestorer {
  ...
  override def restore(
    ...
    options: typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IRestorable.IOptions[IObservableDisposable]
  ...
  override def restore[T /* <: Widget */](
    ...
    options: typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IRestorer.IOptions[T]
