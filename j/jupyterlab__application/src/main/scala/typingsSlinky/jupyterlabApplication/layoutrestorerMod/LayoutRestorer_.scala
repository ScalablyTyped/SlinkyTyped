...
import typingsSlinky.jupyterlabApplication.layoutrestorerMod.LayoutRestorer.IOptions
import typingsSlinky.jupyterlabApplication.shellMod.ILabShell.ILayout
...
class LayoutRestorer_ protected () extends ILayoutRestorer {
  ...
  override def restore(
    ...
    options: typingsSlinky.jupyterlabCoreutils.interfacesMod.IRestorable.IOptions[IObservableDisposable]
  ...
  override def restore[T /* <: Widget */](
    ...
    options: typingsSlinky.jupyterlabCoreutils.interfacesMod.IRestorer.IOptions[T]
