...
object layoutrestorerMod {
  ...
  object LayoutRestorer {
    ...
    object IOptions {
      ...
      def apply(
      ...
      ): typingsSlinky.jupyterlabApplication.layoutrestorerMod.LayoutRestorer.IOptions = {
        ...
        __obj.asInstanceOf[typingsSlinky.jupyterlabApplication.layoutrestorerMod.LayoutRestorer.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabApplication.layoutrestorerMod.LayoutRestorer.IOptions] (val x: Self) extends AnyVal {
