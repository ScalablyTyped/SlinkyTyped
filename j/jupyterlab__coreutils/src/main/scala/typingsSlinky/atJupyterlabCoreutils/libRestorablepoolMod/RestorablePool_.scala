package typingsSlinky.atJupyterlabCoreutils.libRestorablepoolMod

import typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IObjectPool
import typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IRestorable
import typingsSlinky.atJupyterlabCoreutils.libRestorablepoolMod.RestorablePool.IOptions
...
class RestorablePool_[T /* <: IObservableDisposable */] protected ()
  ...
  override def restore(options: typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IRestorable.IOptions[T]): js.Promise[js.Any] = js.native
  /**
