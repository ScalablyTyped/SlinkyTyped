package typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IRestorable
...
trait IOptions[T /* <: IObservableDisposable */]
  extends typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IRestorer.IOptions[T] {
  /**
