...
import typingsSlinky.atJupyterlabCoreutils.Anon_Composite
...
import typingsSlinky.atJupyterlabCoreutils.libTokensMod.ISettingRegistry.ISchema
...
class SettingRegistry_ protected () extends ISettingRegistry {
  ...
  {[ phase in @jupyterlab/coreutils.@jupyterlab/coreutils/lib/tokens.ISettingRegistry.IPlugin.Phase ]:? @jupyterlab/coreutils.@jupyterlab/coreutils/lib/tokens.ISettingRegistry.IPlugin.Transform}
    */ typingsSlinky.atJupyterlabCoreutils.atJupyterlabCoreutilsStrings.SettingRegistry with js.Any
  ...
  override def transform(
    ...
    transforms: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ phase in @jupyterlab/coreutils.@jupyterlab/coreutils/lib/tokens.ISettingRegistry.IPlugin.Phase ]:? @jupyterlab/coreutils.@jupyterlab/coreutils/lib/tokens.ISettingRegistry.IPlugin.Transform}
    */ typingsSlinky.atJupyterlabCoreutils.atJupyterlabCoreutilsStrings.ISettingRegistry with js.Any
  ): IDisposable = js.native
  /**
