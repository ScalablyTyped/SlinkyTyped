...
import typingsSlinky.atJupyterlabCoreutils.libActivitymonitorMod.ActivityMonitor.IOptions
...
class ActivityMonitor[Sender, Args] protected ()
  extends typingsSlinky.atJupyterlabCoreutils.libActivitymonitorMod.ActivityMonitor[Sender, Args] {
  /**
