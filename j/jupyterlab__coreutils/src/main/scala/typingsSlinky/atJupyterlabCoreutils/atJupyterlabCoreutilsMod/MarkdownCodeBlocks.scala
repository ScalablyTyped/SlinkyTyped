...
import typingsSlinky.atJupyterlabCoreutils.atJupyterlabCoreutilsStrings.GraveaccentGraveaccentGraveaccent
...
object MarkdownCodeBlocks extends js.Object {
  ...
  class MarkdownCodeBlock protected ()
    extends typingsSlinky.atJupyterlabCoreutils.libMarkdowncodeblocksMod.MarkdownCodeBlocks.MarkdownCodeBlock {
  ...
  def findMarkdownCodeBlocks(text: String): js.Array[
    typingsSlinky.atJupyterlabCoreutils.libMarkdowncodeblocksMod.MarkdownCodeBlocks.MarkdownCodeBlock
  ] = js.native
  /**
