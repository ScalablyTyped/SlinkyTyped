...
object EventName {
  @scala.inline
  def apply[/* <: typingsSlinky.jimp.mod.ListenableName */ T](eventName: T, methodName: clone | ChangeName | constructor): EventName[T] = {
    val __obj = js.Dynamic.literal(eventName = eventName.asInstanceOf[js.Any], methodName = methodName.asInstanceOf[js.Any])
    __obj.asInstanceOf[EventName[T]]
  }
  @scala.inline
  implicit class EventNameOps[Self <: EventName[_], /* <: typingsSlinky.jimp.mod.ListenableName */ T] (val x: Self with EventName[T]) extends AnyVal {
    @scala.inline
