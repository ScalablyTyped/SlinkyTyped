...
import typingsSlinky.jimp.Anon_AutoGreyscale
import typingsSlinky.jimp.Anon_B
import typingsSlinky.jimp.Anon_CropOnlyFrames
import typingsSlinky.jimp.Anon_Idx
import typingsSlinky.jimp.Anon_Image
import typingsSlinky.jimp.Anon_Opacity
import typingsSlinky.jimp.Anon_R
import typingsSlinky.jimp.Anon_Radius
...
import typingsSlinky.jimp.jimpStrings.`image/bmp`
import typingsSlinky.jimp.jimpStrings.`image/gif`
import typingsSlinky.jimp.jimpStrings.`image/jgd`
import typingsSlinky.jimp.jimpStrings.`image/jpeg`
import typingsSlinky.jimp.jimpStrings.`image/png`
import typingsSlinky.jimp.jimpStrings.`image/tiff`
import typingsSlinky.jimp.jimpStrings.`image/x-ms-bmp`
...
Instantiable1[
  ...
  def autocrop(options: Anon_CropOnlyFrames, cb: ImageCallback[_]): this.type = js.native
  ...
  def circle(options: Anon_Radius): this.type = js.native
  def circle(options: Anon_Radius, cb: ImageCallback[_]): this.type = js.native
  ...
  def diff(img1: this.type, img2: this.type): Anon_Image = js.native
  def diff(img1: this.type, img2: this.type, threshold: Double): Anon_Image = js.native
  ...
  def fishEye(opts: Anon_R): this.type = js.native
  def fishEye(opts: Anon_R, cb: ImageCallback[_]): this.type = js.native
  ...
  def scanIterator(x: Double, y: Double, w: Double, h: Double): IterableIterator[Anon_Idx] = js.native
  def scanQuiet(
    x: Double,
    y: Double,
    w: Double,
  ...
  def shadow(options: Anon_Opacity): this.type = js.native
  def shadow(options: Anon_Opacity, cb: ImageCallback[_]): this.type = js.native
  def threshold(opts: Anon_AutoGreyscale): this.type = js.native
  def threshold(opts: Anon_AutoGreyscale, cb: ImageCallback[_]): this.type = js.native
