package typingsSlinky.atJupyterlabLogconsole.libLoggerMod.LoggerOutputAreaModel
...
trait IOptions
  extends typingsSlinky.atJupyterlabOutputarea.libModelMod.IOutputAreaModel.IOptions {
  /**
