...
import typingsSlinky.jupyterlabLogconsole.jupyterlabLogconsoleStrings.append
import typingsSlinky.jupyterlabLogconsole.jupyterlabLogconsoleStrings.html
import typingsSlinky.jupyterlabLogconsole.jupyterlabLogconsoleStrings.level
import typingsSlinky.jupyterlabLogconsole.jupyterlabLogconsoleStrings.output
import typingsSlinky.jupyterlabLogconsole.jupyterlabLogconsoleStrings.rendermime
...
object tokensMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jupyterlabLogconsole.jupyterlabLogconsoleStrings.append
    - typingsSlinky.jupyterlabLogconsole.jupyterlabLogconsoleStrings.clear
  */
  ...
  */
  ...
  object ILogPayload {
    ...
    @scala.inline
    def IHtmlLog(data: String, level: LogLevel, `type`: html): typingsSlinky.jupyterlabLogconsole.tokensMod.IHtmlLog = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], level = level.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jupyterlabLogconsole.tokensMod.IHtmlLog]
    }
    
    @scala.inline
    def IOutputLog(data: IOutput, level: LogLevel, `type`: output): typingsSlinky.jupyterlabLogconsole.tokensMod.IOutputLog = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], level = level.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jupyterlabLogconsole.tokensMod.IOutputLog]
    }
    
    @scala.inline
    def ITextLog(data: String, level: LogLevel, `type`: text): typingsSlinky.jupyterlabLogconsole.tokensMod.ITextLog = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], level = level.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jupyterlabLogconsole.tokensMod.ITextLog]
    }
  }
