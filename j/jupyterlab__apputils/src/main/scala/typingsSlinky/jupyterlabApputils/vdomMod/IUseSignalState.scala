...
object IUseSignalState {
  ...
  @scala.inline
  implicit class IUseSignalStateOps[Self <: IUseSignalState[_, _], SENDER, ARGS] (val x: Self with (IUseSignalState[SENDER, ARGS])) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: js.Tuple2[js.UndefOr[SENDER], js.UndefOr[ARGS]]): Self = this.set("value", value.asInstanceOf[js.Any])
  }
}
