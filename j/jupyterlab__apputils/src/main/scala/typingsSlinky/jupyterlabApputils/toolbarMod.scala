...
object toolbarMod {
  ...
  object ToolbarButtonComponent {
    ...
    object IProps {
      ...
      @scala.inline
      def apply(): typingsSlinky.jupyterlabApputils.toolbarMod.ToolbarButtonComponent.IProps = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.jupyterlabApputils.toolbarMod.ToolbarButtonComponent.IProps]
      }
      
      @scala.inline
      implicit class IPropsMutableBuilder[Self <: typingsSlinky.jupyterlabApputils.toolbarMod.ToolbarButtonComponent.IProps] (val x: Self) extends AnyVal {
