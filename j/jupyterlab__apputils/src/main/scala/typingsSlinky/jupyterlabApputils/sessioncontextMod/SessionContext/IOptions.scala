...
trait IOptions extends js.Object {
  ...
  /**
    ...
    */
  var specsManager: typingsSlinky.jupyterlabServices.kernelspecKernelspecMod.IManager = js.native
...
object IOptions {
  ...
  def apply(
    ...
    specsManager: typingsSlinky.jupyterlabServices.kernelspecKernelspecMod.IManager
  ): IOptions = {
  ...
  implicit class IOptionsOps[Self <: IOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpecsManager(value: typingsSlinky.jupyterlabServices.kernelspecKernelspecMod.IManager): Self = this.set("specsManager", value.asInstanceOf[js.Any])
