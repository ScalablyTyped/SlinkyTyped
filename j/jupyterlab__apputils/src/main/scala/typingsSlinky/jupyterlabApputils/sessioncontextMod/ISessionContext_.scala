...
import typingsSlinky.jupyterlabApputils.jupyterlabApputilsStrings.kernel
...
import typingsSlinky.jupyterlabServices.sessionSessionMod.IManager
...
trait ISessionContext_ extends IObservableDisposable {
  ...
  /**
    ...
    */
  val specsManager: typingsSlinky.jupyterlabServices.kernelspecKernelspecMod.IManager = js.native
