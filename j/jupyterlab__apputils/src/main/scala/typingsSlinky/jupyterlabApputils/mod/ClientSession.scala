...
import typingsSlinky.jupyterlabApputils.clientsessionMod.ClientSession.IKernelSearch
...
class ClientSession protected ()
  extends typingsSlinky.jupyterlabApputils.clientsessionMod.ClientSession {
  /**
