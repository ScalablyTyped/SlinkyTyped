package typingsSlinky.atJupyterlabApputils.libClientsessionMod

import typingsSlinky.atJupyterlabApputils.libClientsessionMod.ClientSession.IOptions
import typingsSlinky.atJupyterlabApputils.libClientsessionMod.IClientSession.IKernelPreference
...
import typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IManager
...
class ClientSession_ protected () extends IClientSession {
  ...
  override val propertyChanged: ISignal[
    this.type, 
    typingsSlinky.atJupyterlabApputils.atJupyterlabApputilsStrings.path | typingsSlinky.atJupyterlabApputils.atJupyterlabApputilsStrings.name | typingsSlinky.atJupyterlabApputils.atJupyterlabApputilsStrings.`type`
  ] = js.native
  /**
