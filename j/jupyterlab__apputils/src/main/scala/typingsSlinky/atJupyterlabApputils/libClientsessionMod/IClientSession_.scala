...
import typingsSlinky.atJupyterlabApputils.atJupyterlabApputilsStrings.`type`
import typingsSlinky.atJupyterlabApputils.atJupyterlabApputilsStrings.name
import typingsSlinky.atJupyterlabApputils.atJupyterlabApputilsStrings.path
