package typingsSlinky.atJupyterlabApputils.libMainareawidgetMod

import typingsSlinky.atJupyterlabApputils.libMainareawidgetMod.MainAreaWidget.IOptions
...
class MainAreaWidget_[T /* <: Widget */] protected ()
  ...
  /**
    ...
    */
  /* InferMemberOverrides */
  override def children(): IIterator[typingsSlinky.atPhosphorWidgets.libWidgetMod.Widget] = js.native
  /**
  ...
  /**
    ...
    */
  /* InferMemberOverrides */
  override def contains(widget: typingsSlinky.atPhosphorWidgets.libWidgetMod.Widget): Boolean = js.native
  /**
