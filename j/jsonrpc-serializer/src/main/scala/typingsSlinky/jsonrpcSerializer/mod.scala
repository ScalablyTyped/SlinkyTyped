  ...
  object err {
    ...
    */
    ...
    object ErrorName {
      ...
      @scala.inline
      def InvalidParamsError: typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.InvalidParamsError = "InvalidParamsError".asInstanceOf[typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.InvalidParamsError]
      
      @scala.inline
      def InvalidRequestError: typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.InvalidRequestError = "InvalidRequestError".asInstanceOf[typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.InvalidRequestError]
      
      @scala.inline
      def JsonRpcError: typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.JsonRpcError = "JsonRpcError".asInstanceOf[typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.JsonRpcError]
      
      @scala.inline
      def MethodNotFoundError: typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.MethodNotFoundError = "MethodNotFoundError".asInstanceOf[typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.MethodNotFoundError]
      
      @scala.inline
      def ParseError: typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.ParseError = "ParseError".asInstanceOf[typingsSlinky.jsonrpcSerializer.jsonrpcSerializerStrings.ParseError]
    }
  }
