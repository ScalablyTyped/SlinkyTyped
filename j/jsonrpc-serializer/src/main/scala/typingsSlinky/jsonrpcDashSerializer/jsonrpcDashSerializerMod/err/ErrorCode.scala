package typingsSlinky.jsonrpcDashSerializer.jsonrpcDashSerializerMod.err
...
object ErrorCode {
  @scala.inline
  def `-32600`: typingsSlinky.jsonrpcDashSerializer.jsonrpcDashSerializerNumbers.`-32600` = this.cast(-32600)
  @scala.inline
  def `-32601`: typingsSlinky.jsonrpcDashSerializer.jsonrpcDashSerializerNumbers.`-32601` = this.cast(-32601)
  @scala.inline
  def `-32602`: typingsSlinky.jsonrpcDashSerializer.jsonrpcDashSerializerNumbers.`-32602` = this.cast(-32602)
  @scala.inline
  def `-32603`: typingsSlinky.jsonrpcDashSerializer.jsonrpcDashSerializerNumbers.`-32603` = this.cast(-32603)
  @scala.inline
  def `-32700`: typingsSlinky.jsonrpcDashSerializer.jsonrpcDashSerializerNumbers.`-32700` = this.cast(-32700)
  @scala.inline
