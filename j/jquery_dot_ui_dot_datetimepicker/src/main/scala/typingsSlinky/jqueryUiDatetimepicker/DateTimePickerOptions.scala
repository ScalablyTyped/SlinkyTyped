...
object DateTimePickerOptions {
  ...
  implicit class DateTimePickerOptionsOps[Self <: DateTimePickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxDateTime(value: js.Date): Self = this.set("maxDateTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDateTime(value: js.Date): Self = this.set("minDateTime", value.asInstanceOf[js.Any])
