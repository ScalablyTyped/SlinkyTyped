...
object DateTimePickerOptions {
  ...
  implicit class DateTimePickerOptionsMutableBuilder[Self <: DateTimePickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxDateTime(value: js.Date): Self = StObject.set(x, "maxDateTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDateTime(value: js.Date): Self = StObject.set(x, "minDateTime", value.asInstanceOf[js.Any])
