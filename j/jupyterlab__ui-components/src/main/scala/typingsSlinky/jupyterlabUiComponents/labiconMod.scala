...
import typingsSlinky.jupyterlabUiComponents.anon.IIconPartialIRenderer
...
import typingsSlinky.jupyterlabUiComponents.labiconMod.LabIcon.ILabIcon
...
object labiconMod {
  ...
  object LabIcon {
    ...
    @js.native
    trait IProps
      extends typingsSlinky.jupyterlabUiComponents.styleIconMod.LabIconStyle.IProps {
    ...
    /**
      ...
      */
    type IReactRef = ReactRef[SVGElement]
