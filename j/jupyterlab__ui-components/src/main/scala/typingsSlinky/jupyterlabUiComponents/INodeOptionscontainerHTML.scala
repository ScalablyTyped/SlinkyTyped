...
@js.native
trait INodeOptionscontainerHTML extends js.Object {
  /**
...
object INodeOptionscontainerHTML {
  @scala.inline
  def apply(name: String): INodeOptionscontainerHTML = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[INodeOptionscontainerHTML]
  }
  @scala.inline
  implicit class INodeOptionscontainerHTMLOps[Self <: INodeOptionscontainerHTML] (val x: Self) extends AnyVal {
    @scala.inline
