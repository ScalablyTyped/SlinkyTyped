...
import typingsSlinky.jupyterlabUiComponents.htmlselectMod.IOptionProps
...
object HTMLSelect {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.jupyterlabUiComponents.mod.HTMLSelect] {
    ...
    @scala.inline
    def defaultStyle(value: Boolean): this.type = set("defaultStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def icon(value: LabIcon): this.type = set("icon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def iconProps(value: IProps): this.type = set("iconProps", value.asInstanceOf[js.Any])
