...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def `type`(value: button | submit | reset): this.type = set("type", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: IButtonProps with DOMAttributes[js.Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
