...
trait IResolverProps extends js.Object {
  ...
  var fallback: js.UndefOr[typingsSlinky.jupyterlabUiComponents.labiconMod.LabIcon] = js.native
...
object IResolverProps {
  ...
  implicit class IResolverPropsOps[Self <: IResolverProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFallback(value: typingsSlinky.jupyterlabUiComponents.labiconMod.LabIcon): Self = this.set("fallback", value.asInstanceOf[js.Any])
