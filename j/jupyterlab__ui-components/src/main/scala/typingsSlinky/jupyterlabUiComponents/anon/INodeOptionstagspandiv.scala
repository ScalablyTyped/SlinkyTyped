...
/* Inlined @jupyterlab/ui-components.@jupyterlab/ui-components/lib/icon/interfaces.Icon.INodeOptions & {  tag ? :'span' | 'div'} */
@js.native
trait INodeOptionstagspandiv extends js.Object {
  /**
  ...
  var tag: js.UndefOr[span | div] = js.native
  /**
...
object INodeOptionstagspandiv {
  @scala.inline
  def apply(name: String): INodeOptionstagspandiv = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[INodeOptionstagspandiv]
  }
  @scala.inline
  implicit class INodeOptionstagspandivOps[Self <: INodeOptionstagspandiv] (val x: Self) extends AnyVal {
    @scala.inline
