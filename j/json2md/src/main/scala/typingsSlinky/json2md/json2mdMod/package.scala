...
package object json2mdMod {
  import typingsSlinky.json2md.json2mdMod.DefaultConverters.Converters

  type ConverterCallback[TInput] = js.Function2[/* input */ TInput, /* json2md */ typingsSlinky.json2md.json2mdMod.json2md, String]
  ...
  {[ TConverter in 'blockquote' | 'code' | 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'img' | 'ol' | 'p' | 'table' | 'ul' ]: json2md.json2md.ConverterCallback<json2md.json2md.DefaultConverters.Converters[TConverter]>}
    */ typingsSlinky.json2md.json2mdStrings.ConvertersMethods with Converters
  ...
  {[ TConverter in 'blockquote' | 'code' | 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'img' | 'ol' | 'p' | 'table' | 'ul' ]:? json2md.json2md.DefaultConverters.Converters[TConverter]}
    */ typingsSlinky.json2md.json2mdStrings.DataObject with Converters
