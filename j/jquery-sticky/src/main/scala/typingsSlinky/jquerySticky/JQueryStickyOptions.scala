...
object JQueryStickyOptions {
  @scala.inline
  def apply(
    bottomSpacing: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(bottomSpacing)) __obj.updateDynamic("bottomSpacing")(bottomSpacing.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(widthFromWrapper)) __obj.updateDynamic("widthFromWrapper")(widthFromWrapper.get.asInstanceOf[js.Any])
