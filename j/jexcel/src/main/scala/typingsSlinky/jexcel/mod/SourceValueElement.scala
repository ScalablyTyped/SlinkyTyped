...
object SourceValueElement {
  @scala.inline
  def apply[/* <: typingsSlinky.jexcel.mod.CellValue */ T](id: T, name: CellValue): SourceValueElement[T] = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[SourceValueElement[T]]
  }
  @scala.inline
  implicit class SourceValueElementOps[Self <: SourceValueElement[_], /* <: typingsSlinky.jexcel.mod.CellValue */ T] (val x: Self with SourceValueElement[T]) extends AnyVal {
    @scala.inline
