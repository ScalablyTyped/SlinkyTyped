...
@js.native
trait AnonColspan extends js.Object {
...
object AnonColspan {
  @scala.inline
  def apply(): AnonColspan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonColspan]
  }
  @scala.inline
  implicit class AnonColspanOps[Self <: AnonColspan] (val x: Self) extends AnyVal {
    @scala.inline
