...
object Imagegif {
  ...
  implicit class ImagegifOps[Self <: Imagegif] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImageSlashgifVarargs(value: String*): Self = this.set("image/gif", js.Array(value :_*))
    
    @scala.inline
    def setImageSlashgif(value: js.Array[String]): Self = this.set("image/gif", value.asInstanceOf[js.Any])
  }
}
