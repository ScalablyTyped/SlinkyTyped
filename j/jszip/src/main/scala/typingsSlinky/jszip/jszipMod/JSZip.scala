...
import typingsSlinky.jszip.Anon_Dir
import typingsSlinky.jszip.Anon_Promise
...
Instantiable0[JSZip]
  ...
  var external: Anon_Promise = js.native
  ...
  /**
    ...
    */
  def file(path: String): JSZipObject = js.native
  /**
  ...
  def file(path: String, data: Null, options: JSZipFileOptions with Anon_Dir): this.type = js.native
  ...
  @JSName("file")
  def file_This(path: String): this.type = js.native
  /**
