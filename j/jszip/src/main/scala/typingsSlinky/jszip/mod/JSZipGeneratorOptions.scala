...
object JSZipGeneratorOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.jszip.mod.OutputType */ T](): JSZipGeneratorOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[JSZipGeneratorOptions[T]]
  }
  @scala.inline
  implicit class JSZipGeneratorOptionsOps[Self <: JSZipGeneratorOptions[_], /* <: typingsSlinky.jszip.mod.OutputType */ T] (val x: Self with JSZipGeneratorOptions[T]) extends AnyVal {
    @scala.inline
