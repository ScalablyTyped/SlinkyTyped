...
object OutputByType {
  ...
  implicit class OutputByTypeOps[Self <: OutputByType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArraybuffer(value: js.typedarray.ArrayBuffer): Self = this.set("arraybuffer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUint8array(value: js.typedarray.Uint8Array): Self = this.set("uint8array", value.asInstanceOf[js.Any])
  }
}
