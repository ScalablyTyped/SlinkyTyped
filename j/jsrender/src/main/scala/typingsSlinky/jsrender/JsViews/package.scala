...
package object JsViews {
  ...
  type TagSetter = typingsSlinky.jsrender.JsViews.TagOptions | java.lang.String | (js.Function1[/* repeated */ js.Any, js.Any])
  
  type TemplateSetter = typingsSlinky.jsrender.JsViews.TemplateOptions | java.lang.String
}
