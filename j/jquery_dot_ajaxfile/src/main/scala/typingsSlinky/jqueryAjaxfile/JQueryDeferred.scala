...
trait JQueryDeferred[T] extends JQueryGenericPromise[T] {
  /**
    ...
    */
  def always(): JQueryDeferred[T] = js.native
  def always(
  ...
  /**
    ...
    */
  def done(): JQueryDeferred[T] = js.native
  def done(
  ...
  /**
    ...
    */
  def fail(): JQueryDeferred[T] = js.native
  def fail(
  ...
  /**
    ...
    */
  def notifyWith(context: js.Any): JQueryDeferred[T] = js.native
  ...
  /**
    ...
    */
  def progress(): JQueryDeferred[T] = js.native
  def progress(
  ...
  /**
    ...
    */
  def reject(): JQueryDeferred[T] = js.native
  ...
  /**
    ...
    */
  def rejectWith(context: js.Any): JQueryDeferred[T] = js.native
  ...
  /**
    ...
    */
  def resolve(): JQueryDeferred[T] = js.native
  ...
  /**
    ...
    */
  def resolveWith(context: js.Any): JQueryDeferred[T] = js.native
