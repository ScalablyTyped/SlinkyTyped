...
import typingsSlinky.jqueryAjaxfile.JQueryDeferred
...
object IAjaxFileJQueryExtension {
  ...
  implicit class IAjaxFileJQueryExtensionOps[Self <: IAjaxFileJQueryExtension] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAjaxWithFile(value: IJQueryOption => JQueryDeferred[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ajaxWithFile")(js.Any.fromFunction1(value))
        ret
    }
  }
