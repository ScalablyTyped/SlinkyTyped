...
trait KnockoutBindingHandlers extends /* bindingHandler */ StringDictionary[KnockoutBindingHandler] {
  ...
  var file: KnockoutBindingHandler = js.native
...
object KnockoutBindingHandlers {
  ...
  implicit class KnockoutBindingHandlersMutableBuilder[Self <: KnockoutBindingHandlers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFile(value: KnockoutBindingHandler): Self = StObject.set(x, "file", value.asInstanceOf[js.Any])
