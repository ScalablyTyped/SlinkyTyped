...
trait JQueryStatic extends js.Object {
  ...
  /**
    ...
    */
  def queue(element: org.scalajs.dom.raw.Element, queueName: String, callback: js.Function): JQuery = js.native
  /**
    * Manipulate the queue of functions to be executed on the matched element.
    *
    ...
    */
  def queue(element: org.scalajs.dom.raw.Element, queueName: String, newQueue: js.Array[js.Function]): JQuery = js.native
  /**
    ...
    */
  def removeData(element: org.scalajs.dom.raw.Element): JQuery = js.native
  def removeData(element: org.scalajs.dom.raw.Element, name: String): JQuery = js.native
  /**
