...
trait Nargs extends js.Object {
  ...
  val nargs: typingsSlinky.jestCli.jestCliNumbers.`1` = js.native
  val `type`: string = js.native
}

object Nargs {
  @scala.inline
  def apply(description: java.lang.String, nargs: typingsSlinky.jestCli.jestCliNumbers.`1`, `type`: string): Nargs = {
  ...
  implicit class NargsOps[Self <: Nargs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNargs(value: typingsSlinky.jestCli.jestCliNumbers.`1`): Self = this.set("nargs", value.asInstanceOf[js.Any])
    @scala.inline
