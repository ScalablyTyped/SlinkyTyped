...
import typingsSlinky.jestCli.jestCliStrings.`Automock all files by defaultDot`
...
trait Description extends js.Object {
  ...
  val description: `Automock all files by defaultDot` = js.native
...
object Description {
  ...
  implicit class DescriptionOps[Self <: Description] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDescription(value: `Automock all files by defaultDot`): Self = this.set("description", value.asInstanceOf[js.Any])
