...
trait PartialInitialOptions extends js.Object {
  ...
  var changedSince: js.UndefOr[java.lang.String] = js.native
  ...
  var coverageDirectory: js.UndefOr[java.lang.String] = js.native
  ...
  var dependencyExtractor: js.UndefOr[java.lang.String] = js.native
  ...
  var extraGlobals: js.UndefOr[js.Array[java.lang.String]] = js.native
  ...
  var globalSetup: js.UndefOr[java.lang.String | Null] = js.native
  
  var globalTeardown: js.UndefOr[java.lang.String | Null] = js.native
  ...
  var maxWorkers: js.UndefOr[Double | java.lang.String] = js.native
  
  var moduleDirectories: js.UndefOr[js.Array[java.lang.String]] = js.native
  
  var moduleFileExtensions: js.UndefOr[js.Array[java.lang.String]] = js.native
  ...
  var modulePaths: js.UndefOr[js.Array[java.lang.String]] = js.native
  
  var name: js.UndefOr[java.lang.String] = js.native
  
  var noStackTrace: js.UndefOr[Boolean] = js.native
  
  var notifyMode: js.UndefOr[java.lang.String] = js.native
  ...
  var preset: js.UndefOr[java.lang.String | Null] = js.native
  
  var prettierPath: js.UndefOr[java.lang.String | Null] = js.native
  
  var projects: js.UndefOr[js.Array[Glob]] = js.native
  
  var replname: js.UndefOr[java.lang.String | Null] = js.native
  
  var reporters: js.UndefOr[js.Array[java.lang.String | ReporterConfig]] = js.native
  ...
  var runner: js.UndefOr[java.lang.String] = js.native
  
  var scriptPreprocessor: js.UndefOr[java.lang.String] = js.native
  ...
  var testEnvironment: js.UndefOr[java.lang.String] = js.native
  
  var testEnvironmentOptions: js.UndefOr[Record[java.lang.String, _]] = js.native
  
  var testFailureExitCode: js.UndefOr[java.lang.String | Double] = js.native
  
  var testLocationInResults: js.UndefOr[Boolean] = js.native
  
  var testMatch: js.UndefOr[js.Array[Glob]] = js.native
  
  var testNamePattern: js.UndefOr[java.lang.String] = js.native
  
  var testPathDirs: js.UndefOr[js.Array[Path]] = js.native
  
  var testPathIgnorePatterns: js.UndefOr[js.Array[java.lang.String]] = js.native
  ...
  var testSequencer: js.UndefOr[java.lang.String] = js.native
  ...
  var unmockedModulePathPatterns: js.UndefOr[js.Array[java.lang.String]] = js.native
  ...
  var watchPathIgnorePatterns: js.UndefOr[js.Array[java.lang.String]] = js.native
...
object PartialInitialOptions {
  ...
  @scala.inline
  def apply(): PartialInitialOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInitialOptions]
  }
  
  @scala.inline
  implicit class PartialInitialOptionsOps[Self <: PartialInitialOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChangedSince(value: java.lang.String): Self = this.set("changedSince", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCoverageDirectory(value: java.lang.String): Self = this.set("coverageDirectory", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCoverageDirectory: Self = this.set("coverageDirectory", js.undefined)
    
    @scala.inline
    def setCoveragePathIgnorePatternsVarargs(value: java.lang.String*): Self = this.set("coveragePathIgnorePatterns", js.Array(value :_*))
    
    @scala.inline
    def setCoveragePathIgnorePatterns(value: js.Array[java.lang.String]): Self = this.set("coveragePathIgnorePatterns", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDependencyExtractor(value: java.lang.String): Self = this.set("dependencyExtractor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setExtraGlobalsVarargs(value: java.lang.String*): Self = this.set("extraGlobals", js.Array(value :_*))
    
    @scala.inline
    def setExtraGlobals(value: js.Array[java.lang.String]): Self = this.set("extraGlobals", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGlobalSetup(value: java.lang.String): Self = this.set("globalSetup", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGlobalTeardown(value: java.lang.String): Self = this.set("globalTeardown", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxWorkers(value: Double | java.lang.String): Self = this.set("maxWorkers", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaxWorkers: Self = this.set("maxWorkers", js.undefined)
    
    @scala.inline
    def setModuleDirectoriesVarargs(value: java.lang.String*): Self = this.set("moduleDirectories", js.Array(value :_*))
    
    @scala.inline
    def setModuleDirectories(value: js.Array[java.lang.String]): Self = this.set("moduleDirectories", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteModuleDirectories: Self = this.set("moduleDirectories", js.undefined)
    
    @scala.inline
    def setModuleFileExtensionsVarargs(value: java.lang.String*): Self = this.set("moduleFileExtensions", js.Array(value :_*))
    
    @scala.inline
    def setModuleFileExtensions(value: js.Array[java.lang.String]): Self = this.set("moduleFileExtensions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModulePathIgnorePatternsVarargs(value: java.lang.String*): Self = this.set("modulePathIgnorePatterns", js.Array(value :_*))
    
    @scala.inline
    def setModulePathIgnorePatterns(value: js.Array[java.lang.String]): Self = this.set("modulePathIgnorePatterns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteModulePathIgnorePatterns: Self = this.set("modulePathIgnorePatterns", js.undefined)
    
    @scala.inline
    def setModulePathsVarargs(value: java.lang.String*): Self = this.set("modulePaths", js.Array(value :_*))
    
    @scala.inline
    def setModulePaths(value: js.Array[java.lang.String]): Self = this.set("modulePaths", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNotifyMode(value: java.lang.String): Self = this.set("notifyMode", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPreset(value: java.lang.String): Self = this.set("preset", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrettierPath(value: java.lang.String): Self = this.set("prettierPath", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReplname(value: java.lang.String): Self = this.set("replname", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReportersVarargs(value: (java.lang.String | ReporterConfig)*): Self = this.set("reporters", js.Array(value :_*))
    
    @scala.inline
    def setReporters(value: js.Array[java.lang.String | ReporterConfig]): Self = this.set("reporters", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRunner(value: java.lang.String): Self = this.set("runner", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRunner: Self = this.set("runner", js.undefined)
    
    @scala.inline
    def setScriptPreprocessor(value: java.lang.String): Self = this.set("scriptPreprocessor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTestEnvironment(value: java.lang.String): Self = this.set("testEnvironment", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTestEnvironment: Self = this.set("testEnvironment", js.undefined)
    
    @scala.inline
    def setTestEnvironmentOptions(value: Record[java.lang.String, _]): Self = this.set("testEnvironmentOptions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTestEnvironmentOptions: Self = this.set("testEnvironmentOptions", js.undefined)
    
    @scala.inline
    def setTestFailureExitCode(value: java.lang.String | Double): Self = this.set("testFailureExitCode", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTestNamePattern(value: java.lang.String): Self = this.set("testNamePattern", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTestPathIgnorePatternsVarargs(value: java.lang.String*): Self = this.set("testPathIgnorePatterns", js.Array(value :_*))
    
    @scala.inline
    def setTestPathIgnorePatterns(value: js.Array[java.lang.String]): Self = this.set("testPathIgnorePatterns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTestPathIgnorePatterns: Self = this.set("testPathIgnorePatterns", js.undefined)
    
    @scala.inline
    def setTestRegexVarargs(value: java.lang.String*): Self = this.set("testRegex", js.Array(value :_*))
    
    @scala.inline
    def setTestRegex(value: java.lang.String | js.Array[java.lang.String]): Self = this.set("testRegex", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTestRegex: Self = this.set("testRegex", js.undefined)
    
    @scala.inline
    def setTestResultsProcessor(value: java.lang.String): Self = this.set("testResultsProcessor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTestSequencer(value: java.lang.String): Self = this.set("testSequencer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTestURL(value: java.lang.String): Self = this.set("testURL", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUnmockedModulePathPatternsVarargs(value: java.lang.String*): Self = this.set("unmockedModulePathPatterns", js.Array(value :_*))
    
    @scala.inline
    def setUnmockedModulePathPatterns(value: js.Array[java.lang.String]): Self = this.set("unmockedModulePathPatterns", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWatchPathIgnorePatternsVarargs(value: java.lang.String*): Self = this.set("watchPathIgnorePatterns", js.Array(value :_*))
    
    @scala.inline
    def setWatchPathIgnorePatterns(value: js.Array[java.lang.String]): Self = this.set("watchPathIgnorePatterns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteWatchPathIgnorePatterns: Self = this.set("watchPathIgnorePatterns", js.undefined)
    
    @scala.inline
    def setWatchPluginsVarargs(value: (java.lang.String | (js.Tuple2[java.lang.String, Record[java.lang.String, js.Any]]))*): Self = this.set("watchPlugins", js.Array(value :_*))
    
    @scala.inline
    def setWatchPlugins(value: js.Array[java.lang.String | (js.Tuple2[java.lang.String, Record[java.lang.String, _]])]): Self = this.set("watchPlugins", value.asInstanceOf[js.Any])
