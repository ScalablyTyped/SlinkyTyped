...
import typingsSlinky.jestCli.jestCliStrings.`Select between Babel and V8 to collect coverage`
import typingsSlinky.jestCli.jestCliStrings.babel
import typingsSlinky.jestCli.jestCliStrings.v8
