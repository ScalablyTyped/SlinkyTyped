...
trait DescriptionStringType extends js.Object {
  ...
  val default: typingsSlinky.jestCli.jestCliNumbers.`5` = js.native
...
object DescriptionStringType {
  ...
  @scala.inline
  def apply(default: typingsSlinky.jestCli.jestCliNumbers.`5`, description: java.lang.String, `type`: number): DescriptionStringType = {
  ...
  implicit class DescriptionStringTypeOps[Self <: DescriptionStringType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefault(value: typingsSlinky.jestCli.jestCliNumbers.`5`): Self = this.set("default", value.asInstanceOf[js.Any])
