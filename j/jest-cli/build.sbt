...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jest-changed-files" % "24.9.0-300045",
  ...
  "org.scalablytyped.slinky" %%% "prompts" % "2.0-dt-20200515Z-33570b",
