...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jest-changed-files" % "24.9.0-d5001b",
  ...
  "org.scalablytyped.slinky" %%% "prompts" % "2.0-dt-20200423Z-462dea",
