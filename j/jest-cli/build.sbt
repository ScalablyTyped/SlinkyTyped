...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jest-changed-files" % "24.9.0-b974e0",
  ...
  "org.scalablytyped.slinky" %%% "jest-runner" % "24.9.0-7fc68e",
  "org.scalablytyped.slinky" %%% "jest-runtime" % "24.9.0-67116f",
  "org.scalablytyped.slinky" %%% "jest__console" % "24.9.0-7a9b1d",
  "org.scalablytyped.slinky" %%% "jest__core" % "24.9.0-ebe47f",
  "org.scalablytyped.slinky" %%% "jest__environment" % "24.9.0-092fb2",
  "org.scalablytyped.slinky" %%% "jest__fake-timers" % "24.9.0-b764a0",
  "org.scalablytyped.slinky" %%% "jest__reporters" % "24.9.0-7abee7",
  ...
  "org.scalablytyped.slinky" %%% "prompts" % "2.0-dt-20191106Z-70590e",
