...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jest-changed-files" % "24.9.0-e7ea13",
  ...
  "org.scalablytyped.slinky" %%% "prompts" % "2.0-dt-20191106Z-181b8d",
