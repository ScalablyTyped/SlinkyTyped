...
object mod {
  ...
  object AsyncLoader {
    ...
    @scala.inline
    def apply(load: String => js.Promise[_], test: js.RegExp): AsyncLoader = {
  ...
  object MultiLoader {
    ...
    @scala.inline
    def apply(load: String => js.Promise[_], loadSync: String => js.Any, test: js.RegExp): MultiLoader = {
