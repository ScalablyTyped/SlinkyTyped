package typingsSlinky.joycon.mod
...
object SyncLoader {
  ...
  @scala.inline
  def apply(loadSync: String => js.Any, test: js.RegExp): SyncLoader = {
  ...
  implicit class SyncLoaderOps[Self <: SyncLoader] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTest(value: js.RegExp): Self = this.set("test", value.asInstanceOf[js.Any])
