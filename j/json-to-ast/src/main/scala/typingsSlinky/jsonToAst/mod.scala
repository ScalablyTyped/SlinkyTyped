package typingsSlinky.jsonToAst

import typingsSlinky.jsonToAst.jsonToAstStrings.Array
import typingsSlinky.jsonToAst.jsonToAstStrings.Identifier
...
object mod {
  ...
  */
  ...
  object ValueNode {
    ...
    @scala.inline
    def ArrayNode(children: js.Array[ValueNode], `type`: Array): typingsSlinky.jsonToAst.mod.ArrayNode = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonToAst.mod.ArrayNode]
    }
    
    @scala.inline
    def LiteralNode(raw: String, `type`: Literal): typingsSlinky.jsonToAst.mod.LiteralNode = {
      val __obj = js.Dynamic.literal(raw = raw.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonToAst.mod.LiteralNode]
    }
    
    @scala.inline
    def ObjectNode(children: js.Array[PropertyNode], `type`: Object): typingsSlinky.jsonToAst.mod.ObjectNode = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonToAst.mod.ObjectNode]
    }
  }
}
