...
@js.native
trait P8pubkeyhex extends js.Object {
  var p8pubkeyhex: String = js.native
}

object P8pubkeyhex {
  @scala.inline
  def apply(p8pubkeyhex: String): P8pubkeyhex = {
    val __obj = js.Dynamic.literal(p8pubkeyhex = p8pubkeyhex.asInstanceOf[js.Any])
    __obj.asInstanceOf[P8pubkeyhex]
  }
  @scala.inline
  implicit class P8pubkeyhexOps[Self <: P8pubkeyhex] (val x: Self) extends AnyVal {
    @scala.inline
