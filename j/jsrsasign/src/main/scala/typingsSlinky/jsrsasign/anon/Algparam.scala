...
@js.native
trait Algparam extends js.Object {
...
object Algparam {
  @scala.inline
  def apply(algoid: String, algparam: String, key: String): Algparam = {
    ...
    __obj.asInstanceOf[Algparam]
  }
  @scala.inline
  implicit class AlgparamOps[Self <: Algparam] (val x: Self) extends AnyVal {
    @scala.inline
