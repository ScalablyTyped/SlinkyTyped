...
object tsp {
  ...
  object TSPUtil {
    ...
    /**
      ...
      * @example
      */
    @JSGlobal("jsrsasign.KJUR.asn1.tsp.TSPUtil.newTimeStampToken")
    @js.native
  ...
  /**
    ...
    */
  @JSGlobal("jsrsasign.KJUR.asn1.tsp.parseMessageImprint")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("jsrsasign.KJUR.asn1.tsp.parseTimeStampReq")
  @js.native
