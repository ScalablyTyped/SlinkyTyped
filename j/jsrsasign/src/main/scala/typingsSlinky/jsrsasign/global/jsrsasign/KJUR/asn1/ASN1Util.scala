...
import typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.ASNObject
...
@js.native
class ASN1Util ()
  extends typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.ASN1Util {
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def newObject(param: ASNObject): typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.ASN1Object = js.native
}
