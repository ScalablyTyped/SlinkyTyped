...
import typingsSlinky.jsrsasign.jsrsasign.PublicKeyInfoPropOfCertPEMResult
...
@js.native
class X509 ()
  extends typingsSlinky.jsrsasign.jsrsasign.X509
/* static members */
@JSGlobal("jsrsasign.X509")
@js.native
object X509 extends js.Object {
  ...
  /**
    ...
    */
  def getPublicKeyFromCertHex(h: String): typingsSlinky.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  ...
  /**
    ...
    */
  def getPublicKeyFromCertPEM(sCertPEM: String): typingsSlinky.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
