...
object cades {
  ...
  object CAdESUtil {
    ...
    /**
      ...
      * sd = info.obj;
      */
    @JSGlobal("jsrsasign.KJUR.asn1.cades.CAdESUtil.parseSignedDataForAddingUnsigned")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("jsrsasign.KJUR.asn1.cades.CAdESUtil.parseSignerInfoForAddingUnsigned")
    @js.native
