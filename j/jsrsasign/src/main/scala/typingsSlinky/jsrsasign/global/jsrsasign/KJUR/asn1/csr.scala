...
object csr {
  ...
  object CSRUtil {
    ...
    /**
      ...
      */
    @JSGlobal("jsrsasign.KJUR.asn1.csr.CSRUtil.getInfo")
    @js.native
    ...
    /**
      ...
      * });
      */
    @JSGlobal("jsrsasign.KJUR.asn1.csr.CSRUtil.newCSRPEM")
    @js.native
  ...
  class CertificationRequestInfo ()
    extends typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.csr.CertificationRequestInfo
}
