package typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.cades
...
object OtherCertID {
  ...
  implicit class OtherCertIDOps[Self <: OtherCertID] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetByCertPEM(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setByCertPEM")(js.Any.fromFunction1(value))
        ret
    }
  }
