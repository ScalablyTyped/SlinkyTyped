...
object TBSRequest {
  ...
  implicit class TBSRequestOps[Self <: TBSRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetRequestListByParam(value: js.Array[CertificateRequest] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setRequestListByParam")(js.Any.fromFunction1(value))
        ret
    }
  }
