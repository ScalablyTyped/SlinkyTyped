...
package object cades {
  /**
    ...
    * ```
    */
  type OtherHashAlgAndValue = typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.ASN1Object
  /**
    ...
    * });
    */
  type SignaturePolicyIdentifier = typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.cms.Attribute
  /**
    ...
    * ```
    */
  type SignatureTimeStamp = typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.cms.Attribute
}
