...
import typingsSlinky.jsrsasign.anon.`0`
...
import typingsSlinky.jsrsasign.jsrsasignStrings.SIGN
import typingsSlinky.jsrsasign.jsrsasignStrings.VERIFY
...
object crypto extends js.Object {
  ...
  @js.native
  class DSA ()
    extends typingsSlinky.jsrsasign.jsrsasign.KJUR.crypto.DSA
