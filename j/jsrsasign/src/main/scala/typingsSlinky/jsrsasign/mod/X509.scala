...
object X509 {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("jsrsasign", "X509.getPublicKeyFromCertHex")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("jsrsasign", "X509.getPublicKeyFromCertPEM")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("jsrsasign", "X509.getPublicKeyInfoPropOfCertPEM")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("jsrsasign", "X509.hex2attrTypeValue")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("jsrsasign", "X509.hex2dn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("jsrsasign", "X509.hex2rdn")
  @js.native
  def hex2rdn(hex: String, idx: Double): String = js.native
  
  /* static member */
  @JSImport("jsrsasign", "X509.version")
  @js.native
