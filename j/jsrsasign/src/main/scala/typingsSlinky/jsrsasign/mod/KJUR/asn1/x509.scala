...
import typingsSlinky.jsrsasign.anon.AnyExtendedKeyUsage
...
import typingsSlinky.jsrsasign.anon.BusinessCategory
...
object x509 {
  ...
  @js.native
  class RDN ()
    extends typingsSlinky.jsrsasign.jsrsasign.KJUR.asn1.x509.RDN {
    def this(params: StringParam) = this()
  }
  object RDN {
