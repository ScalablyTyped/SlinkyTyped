package typingsSlinky.jsrsasign.jsrsasignMod
...
object KEYUTIL extends js.Object {
  ...
  def getKey(param: Anon_E): typingsSlinky.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  def getKey(param: Anon_E, passcode: String): typingsSlinky.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  def getKey(param: Anon_E, passcode: String, hextype: String): typingsSlinky.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  def getKey(param: Anon_E, passcode: Null, hextype: String): typingsSlinky.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
