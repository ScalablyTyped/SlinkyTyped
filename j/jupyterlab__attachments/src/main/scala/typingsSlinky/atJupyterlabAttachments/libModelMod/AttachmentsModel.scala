...
import typingsSlinky.atJupyterlabAttachments.libModelMod.AttachmentsModel.ContentFactory
...
object AttachmentsModel extends js.Object {
  ...
  class ContentFactory () extends IContentFactory {
    /**
      ...
      */
    /* CompleteClass */
    override def createAttachmentModel(options: typingsSlinky.atJupyterlabRendermime.libAttachmentmodelMod.IAttachmentModel.IOptions): IAttachmentModel = js.native
  }
