...
import typingsSlinky.jestDashJasmine2.buildJasmineJsApiReporterMod.default
import typingsSlinky.jestDashJasmine2.buildJasmineSuiteMod.Attributes
...
trait Anon_AddMatchers extends js.Object {
  ...
  var ReportDispatcher: Instantiable1[
    ...
    typingsSlinky.jestDashJasmine2.buildJasmineReportDispatcherMod.default
  ] = js.native
  var Spec: TypeofClassSpec = js.native
  var SpyRegistry: Instantiable1[
    js.UndefOr[/* hasCurrentSpies */ Anon_CurrentSpies], 
    typingsSlinky.jestDashJasmine2.buildJasmineSpyRegistryMod.default
  ] = js.native
  var Suite: Instantiable1[
    /* attrs */ Attributes, 
    typingsSlinky.jestDashJasmine2.buildJasmineSuiteMod.default
  ] = js.native
  var Timer: Instantiable1[
    js.UndefOr[/* options */ Anon_Now], 
    typingsSlinky.jestDashJasmine2.buildJasmineTimerMod.default
  ] = js.native
