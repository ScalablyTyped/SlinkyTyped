...
import typingsSlinky.jestDashJasmine2.jestDashJasmine2Strings.finished
...
trait Suite extends js.Object {
  ...
  var children: js.Array[Suite | typingsSlinky.jestDashJasmine2.buildJasmineSpecMod.default] = js.native
  ...
  def addChild(child: typingsSlinky.jestDashJasmine2.buildJasmineSpecMod.default): Unit = js.native
  ...
  def onException(
    /* import warning: parser.TsParser#functionParam $anonfun Dropping repeated marker of param args because its type Parameters<Spec['onException']> is not an array type */ args: Parameters[
      js.Function1[
        /* error */ typingsSlinky.jestDashJasmine2.buildExpectationFailedMod.default | AssertionErrorWithStack, 
        Unit
      ]
    ]
  ): Unit = js.native
