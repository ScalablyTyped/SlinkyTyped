...
import typingsSlinky.jestDashJasmine2.buildJasmineSuiteMod.default
import typingsSlinky.jestDashJasmine2.buildTypesMod.AssertionErrorWithStack
import typingsSlinky.jestDashJasmine2.buildTypesMod.Reporter
...
trait Anon_AccessType extends js.Object {
  ...
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit]
  ): typingsSlinky.jestDashJasmine2.buildJasmineSpecMod.default = js.native
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit],
    timeout: Double
  ...
  def specFilter(spec: typingsSlinky.jestDashJasmine2.buildJasmineSpecMod.default): Boolean = js.native
  ...
  def todo(): typingsSlinky.jestDashJasmine2.buildJasmineSpecMod.default = js.native
