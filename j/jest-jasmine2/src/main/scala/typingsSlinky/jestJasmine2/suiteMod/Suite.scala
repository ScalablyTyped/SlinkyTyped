...
import typingsSlinky.jestJasmine2.jestJasmine2Strings.finished
...
trait Suite extends js.Object {
  ...
  var children: js.Array[Suite | typingsSlinky.jestJasmine2.specMod.default] = js.native
  ...
  def addChild(child: typingsSlinky.jestJasmine2.specMod.default): Unit = js.native
  ...
  def onException(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<Spec['onException']> is not an array type */ args: Parameters[
      js.Function1[
        /* error */ typingsSlinky.jestJasmine2.expectationFailedMod.default | AssertionErrorWithStack, 
        Unit
      ]
    ]
  ): Unit = js.native
