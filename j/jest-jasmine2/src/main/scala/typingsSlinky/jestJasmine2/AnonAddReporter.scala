...
import typingsSlinky.jestJasmine2.suiteMod.default
...
@js.native
trait AnonAddReporter extends js.Object {
  ...
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit]
  ): typingsSlinky.jestJasmine2.specMod.default = js.native
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit],
    timeout: Double
  ...
  def specFilter(spec: typingsSlinky.jestJasmine2.specMod.default): Boolean = js.native
  ...
  def todo(): typingsSlinky.jestJasmine2.specMod.default = js.native
