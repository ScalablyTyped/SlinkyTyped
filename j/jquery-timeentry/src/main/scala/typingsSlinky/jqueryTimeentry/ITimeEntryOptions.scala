...
object ITimeEntryOptions {
  ...
  implicit class ITimeEntryOptionsMutableBuilder[Self <: ITimeEntryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultTime(value: js.Date | Double | String): Self = StObject.set(x, "defaultTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxTime(value: js.Date | Double | js.Array[Double] | String): Self = StObject.set(x, "maxTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaxTimeDate(value: js.Date): Self = StObject.set(x, "maxTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinTime(value: js.Date | Double | js.Array[Double] | String): Self = StObject.set(x, "minTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinTimeDate(value: js.Date): Self = StObject.set(x, "minTime", value.asInstanceOf[js.Any])
