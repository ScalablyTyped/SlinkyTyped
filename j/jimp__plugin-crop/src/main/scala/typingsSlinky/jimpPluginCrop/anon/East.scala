...
object East {
  ...
  implicit class EastOps[Self <: East] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEast(value: Boolean): Self = this.set("east", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNorth(value: Boolean): Self = this.set("north", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSouth(value: Boolean): Self = this.set("south", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWest(value: Boolean): Self = this.set("west", value.asInstanceOf[js.Any])
  }
}
