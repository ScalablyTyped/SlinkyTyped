...
import typingsSlinky.atJupyterlabVega4DashExtension.atJupyterlabVega4DashExtensionStrings.`application/vndDOTvegaDOTv4+json`
import typingsSlinky.atJupyterlabVega4DashExtension.atJupyterlabVega4DashExtensionStrings.`application/vndDOTvegaliteDOTv2+json`
