package typingsSlinky.atJupyterlabDocmanager.libWidgetmanagerMod

import typingsSlinky.atJupyterlabDocmanager.libWidgetmanagerMod.DocumentWidgetManager.IOptions
...
import typingsSlinky.atPhosphorMessaging.atPhosphorMessagingMod.IMessageHandler
