...
import typingsSlinky.atJupyterlabServices.libContentsMod.Contents.ICreateOptions
...
object libTokensMod extends js.Object {
  ...
  trait IDocumentManager extends IDisposable {
    ...
    /**
      ...
      */
    def copy(fromFile: String, toDir: String): js.Promise[typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IModel] = js.native
    /**
    ...
    /**
      ...
      */
    def newUntitled(options: ICreateOptions): js.Promise[typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IModel] = js.native
    /**
    ...
    /**
      ...
      */
    def overwrite(oldPath: String, newPath: String): js.Promise[typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IModel] = js.native
    /**
