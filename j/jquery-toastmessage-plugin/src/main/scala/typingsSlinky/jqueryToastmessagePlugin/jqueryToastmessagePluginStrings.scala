...
import typingsSlinky.jqueryToastmessagePlugin.JQueryToastmessage.ToastPosition
import typingsSlinky.jqueryToastmessagePlugin.JQueryToastmessage.ToastType
