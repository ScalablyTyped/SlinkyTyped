...
object widgetMod extends js.Object {
  ...
  class ImageViewer protected ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def children(): IIterator[typingsSlinky.phosphorWidgets.widgetMod.Widget] = js.native
    /**
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def contains(widget: typingsSlinky.phosphorWidgets.widgetMod.Widget): Boolean = js.native
    /**
