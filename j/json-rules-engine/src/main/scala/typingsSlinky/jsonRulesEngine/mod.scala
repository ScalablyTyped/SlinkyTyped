...
object mod {
  ...
  object ConditionProperties {
    ...
    implicit class ConditionPropertiesMutableBuilder[Self <: ConditionProperties] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValue(value: typingsSlinky.jsonRulesEngine.anon.Fact | js.Any): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  ...
  */
  ...
  object NestedCondition {
    ...
    @scala.inline
    def AllConditions(all: js.Array[NestedCondition]): typingsSlinky.jsonRulesEngine.mod.AllConditions = {
      val __obj = js.Dynamic.literal(all = all.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonRulesEngine.mod.AllConditions]
    }
    
    @scala.inline
    def AnyConditions(any: js.Array[NestedCondition]): typingsSlinky.jsonRulesEngine.mod.AnyConditions = {
      val __obj = js.Dynamic.literal(any = any.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonRulesEngine.mod.AnyConditions]
    }
    
    @scala.inline
    def ConditionProperties(fact: String, operator: String, value: typingsSlinky.jsonRulesEngine.anon.Fact | js.Any): typingsSlinky.jsonRulesEngine.mod.ConditionProperties = {
      val __obj = js.Dynamic.literal(fact = fact.asInstanceOf[js.Any], operator = operator.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonRulesEngine.mod.ConditionProperties]
    }
  }
