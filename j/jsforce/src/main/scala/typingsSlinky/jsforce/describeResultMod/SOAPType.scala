...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.jsforce.jsforceStrings.tnsColonID
  - typingsSlinky.jsforce.jsforceStrings.xsdColonanyType
  - typingsSlinky.jsforce.jsforceStrings.xsdColonbase64Binary
  - typingsSlinky.jsforce.jsforceStrings.xsdColonboolean
  - typingsSlinky.jsforce.jsforceStrings.xsdColondate
  - typingsSlinky.jsforce.jsforceStrings.xsdColondateTime
  - typingsSlinky.jsforce.jsforceStrings.xsdColondouble
  - typingsSlinky.jsforce.jsforceStrings.xsdColonint
  - typingsSlinky.jsforce.jsforceStrings.xsdColonstring
  - typingsSlinky.jsforce.jsforceStrings.xsdColontime
  - typingsSlinky.jsforce.jsforceStrings.urnColonaddress
  - typingsSlinky.jsforce.jsforceStrings.urnColonJunctionIdListNames
  - typingsSlinky.jsforce.jsforceStrings.urnColonlocation
  - typingsSlinky.jsforce.jsforceStrings.urnColonRecordTypesSupported
  - typingsSlinky.jsforce.jsforceStrings.urnColonRelationshipReferenceTo
  - typingsSlinky.jsforce.jsforceStrings.urnColonSearchLayoutButtonsDisplayed
  - typingsSlinky.jsforce.jsforceStrings.urnColonSearchLayoutFieldsDisplayed
*/
