...
import typingsSlinky.jsforce.Anon_CallbackClearApprovalLayoutInfo
import typingsSlinky.jsforce.Anon_CallbackClearCompactLayoutInfo
import typingsSlinky.jsforce.Anon_CallbackClearDescribeSObjectResult
import typingsSlinky.jsforce.Anon_CallbackClearLayoutName
import typingsSlinky.jsforce.Anon_ExtIdField
...
import typingsSlinky.jsforce.quickDashActionMod.QuickActionInfo
...
class SObject[T] () extends js.Object {
  ...
  var approvalLayouts$_Original: Anon_CallbackClearApprovalLayoutInfo = js.native
  @JSName("compactLayouts$")
  var compactLayouts$_Original: Anon_CallbackClearCompactLayoutInfo = js.native
  @JSName("describe$")
  var describe$_Original: Anon_CallbackClearDescribeSObjectResult = js.native
  /** Returns a value from the cache if it exists, otherwise calls SObject.layouts */
  @JSName("layouts$")
  var layouts$_Original: Anon_CallbackClearLayoutName = js.native
  ...
  def bulkload(operation: String, options: Anon_ExtIdField): Batch = js.native
  def bulkload(operation: String, options: Anon_ExtIdField, input: String): Batch = js.native
  def bulkload(
    operation: String,
    options: Anon_ExtIdField,
    input: String,
    callback: Callback[js.Array[RecordResult]]
  ): Batch = js.native
  def bulkload(operation: String, options: Anon_ExtIdField, input: js.Array[Record[T]]): Batch = js.native
  def bulkload(
    operation: String,
    options: Anon_ExtIdField,
  ...
  def bulkload(operation: String, options: Anon_ExtIdField, input: Stream): Batch = js.native
  def bulkload(
    operation: String,
    options: Anon_ExtIdField,
    input: Stream,
  ...
  def quickAction(actionName: String): typingsSlinky.jsforce.quickDashActionMod.QuickAction = js.native
