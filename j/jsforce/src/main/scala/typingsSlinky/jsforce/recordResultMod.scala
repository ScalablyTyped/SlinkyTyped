...
object recordResultMod {
  ...
  */
  ...
  object RecordResult {
    ...
    @scala.inline
    def ErrorResult(errors: js.Array[String], success: `false`): typingsSlinky.jsforce.recordResultMod.ErrorResult = {
      val __obj = js.Dynamic.literal(errors = errors.asInstanceOf[js.Any], success = success.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsforce.recordResultMod.ErrorResult]
    }
    
    @scala.inline
    def SuccessResult(id: SalesforceId, success: `true`): typingsSlinky.jsforce.recordResultMod.SuccessResult = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], success = success.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsforce.recordResultMod.SuccessResult]
    }
  }
