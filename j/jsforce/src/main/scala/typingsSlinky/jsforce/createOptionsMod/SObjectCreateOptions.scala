...
object SObjectCreateOptions {
  ...
  implicit class SObjectCreateOptionsOps[Self <: SObjectCreateOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastActivityDate(value: js.Date): Self = this.set("LastActivityDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastReferencedDate(value: js.Date): Self = this.set("LastReferencedDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLastReferencedDate: Self = this.set("LastReferencedDate", js.undefined)
    
    @scala.inline
    def setLastViewedDate(value: js.Date): Self = this.set("LastViewedDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSystemModstamp(value: js.Date): Self = this.set("SystemModstamp", value.asInstanceOf[js.Any])
