...
trait LimitsInfo extends js.Object {
  ...
  var DailyApiRequests: typingsSlinky.jsforce.limitsDashInfoMod.DailyApiRequests
  ...
  var PermissionSets: typingsSlinky.jsforce.limitsDashInfoMod.PermissionSets
