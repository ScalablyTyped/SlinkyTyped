...
package object mod {
  ...
  type AnchorContinuousSpec = typingsSlinky.jsplumb.mod.AnchorContinuousId | (js.Tuple2[typingsSlinky.jsplumb.mod.AnchorContinuousId, typingsSlinky.jsplumb.AnonFaces])
  ...
  */
  ...
  type AnchorPerimeterSpec = typingsSlinky.jsplumb.mod.AnchorPerimeterId | (js.Tuple2[typingsSlinky.jsplumb.mod.AnchorPerimeterId, typingsSlinky.jsplumb.AnonAnchorCount])
