...
trait Uri extends js.Object {
  /**
    ...
    */
  def addQueryParam(key: String, `val`: Primitive): Uri = js.native
  def addQueryParam(key: String, `val`: Primitive, index: Double): Uri = js.native
  /**
  ...
  /**
    ...
    * @return {Uri}            returns self for fluent chaining
    */
  def deleteQueryParam(key: String): Uri = js.native
  def deleteQueryParam(key: String, `val`: String): Uri = js.native
  /**
  ...
  /**
    ...
    * @return {Uri}                returns self for fluent chaining
    */
  def replaceQueryParam(key: String, newVal: Primitive): Uri = js.native
  def replaceQueryParam(key: String, newVal: Primitive, oldVal: Primitive): Uri = js.native
  /**
    * Scheme name, colon and doubleslash, as required
    * @return {string} http:// or possibly just //
    */
  def scheme(): String = js.native
  def setAnchor(`val`: String): Uri = js.native
  def setHasAuthorityPrefix(`val`: Boolean): Uri = js.native
  def setHost(`val`: String): Uri = js.native
  def setIsColonUri(`val`: Boolean): Uri = js.native
  def setPath(`val`: String): Uri = js.native
  def setPort(`val`: Double): Uri = js.native
  /**
    * Define fluent setter methods (setProtocol, setHasAuthorityPrefix, etc)
    */
  def setProtocol(`val`: String): Uri = js.native
  def setQuery(`val`: String): Uri = js.native
  def setUserInfo(`val`: String): Uri = js.native
