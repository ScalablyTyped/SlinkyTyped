...
object Repo {
  ...
  implicit class RepoOps[Self <: Repo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFetch(value: (Remote, js.Object, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fetch")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetHead(value: js.Function2[/* err */ js.Any, /* ref_name */ String, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getHead")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withLoad(value: (String, js.Function2[/* err */ js.Any, /* git_object */ GitObject, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("load")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withLoadAs(value: (String, String, js.Function2[/* err */ js.Any, /* body */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadAs")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withLogWalk(value: (String, js.Function2[/* err */ js.Any, /* log_stream */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("logWalk")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withRemove(value: (String, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remove")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withResolveHashish(value: (String, js.Function2[/* err */ js.Any, /* hash */ String, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolveHashish")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSave(value: (GitObject, js.Function2[/* err */ js.Any, /* hash */ String, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("save")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSaveAs(value: (String, js.Any, js.Function2[/* err */ js.Any, /* hash */ String, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("saveAs")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withSetHead(value: (String, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setHead")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withTreeWalk(value: (String, js.Function2[/* err */ js.Any, /* file_stream */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("treeWalk")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withUnpack(value: (js.Any, js.Object, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unpack")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withUpdateHead(value: (String, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateHead")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withWalk(value: (js.Any, js.Any, js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("walk")(js.Any.fromFunction4(value))
        ret
    }
  }
