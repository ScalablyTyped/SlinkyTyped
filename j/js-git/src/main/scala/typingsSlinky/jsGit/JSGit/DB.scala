...
object DB {
  ...
  implicit class DBOps[Self <: DB] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClear(value: js.Function1[/* err */ js.Any, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clear")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDel(value: (String, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("del")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGet(value: (String, js.Function2[/* err */ js.Any, /* value */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withHas(value: (String, js.Function2[/* err */ js.Any, /* hasKey */ Boolean, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("has")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withInit(value: js.Function1[/* err */ js.Any, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("init")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withKeys(value: (String, js.Function2[/* err */ js.Any, /* keys */ js.Array[String], Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("keys")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSet(value: (String, js.Any, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
