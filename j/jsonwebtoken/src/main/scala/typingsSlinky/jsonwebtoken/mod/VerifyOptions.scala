...
object VerifyOptions {
  ...
  implicit class VerifyOptionsOps[Self <: VerifyOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAudienceVarargs(value: (String | js.RegExp)*): Self = this.set("audience", js.Array(value :_*))
    
    @scala.inline
    def setAudienceRegExp(value: js.RegExp): Self = this.set("audience", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAudience(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = this.set("audience", value.asInstanceOf[js.Any])
