...
object SignOptions {
  ...
  implicit class SignOptionsOps[Self <: SignOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMutatePayload(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mutatePayload")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMutatePayload: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mutatePayload")(js.undefined)
        ret
    }
    @scala.inline
