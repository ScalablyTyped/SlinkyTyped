...
import typingsSlinky.jsonwebtoken.anon.DecodeOptionsjsontrue
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS256
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS384
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS512
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS256
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS384
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS512
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES256
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES384
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES512
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS256
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS384
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS512
    - typingsSlinky.jsonwebtoken.jsonwebtokenStrings.none
  */
  trait Algorithm extends StObject
  object Algorithm {
    
    @scala.inline
    def ES256: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES256 = "ES256".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES256]
    
    @scala.inline
    def ES384: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES384 = "ES384".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES384]
    
    @scala.inline
    def ES512: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES512 = "ES512".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.ES512]
    
    @scala.inline
    def HS256: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS256 = "HS256".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS256]
    
    @scala.inline
    def HS384: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS384 = "HS384".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS384]
    
    @scala.inline
    def HS512: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS512 = "HS512".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.HS512]
    
    @scala.inline
    def PS256: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS256 = "PS256".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS256]
    
    @scala.inline
    def PS384: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS384 = "PS384".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS384]
    
    @scala.inline
    def PS512: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS512 = "PS512".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.PS512]
    
    @scala.inline
    def RS256: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS256 = "RS256".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS256]
    
    @scala.inline
    def RS384: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS384 = "RS384".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS384]
    
    @scala.inline
    def RS512: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS512 = "RS512".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.RS512]
    
    @scala.inline
    def none: typingsSlinky.jsonwebtoken.jsonwebtokenStrings.none = "none".asInstanceOf[typingsSlinky.jsonwebtoken.jsonwebtokenStrings.none]
  }
  ...
  type SignCallback = js.Function2[/* err */ js.Error | Null, /* encoded */ js.UndefOr[String], Unit]
  ...
  */
  ...
  trait VerifyOptions extends StObject {
    ...
    var audience: js.UndefOr[String | js.RegExp | (js.Array[String | js.RegExp])] = js.native
  ...
  object VerifyOptions {
    ...
    implicit class VerifyOptionsMutableBuilder[Self <: VerifyOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAudience(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = StObject.set(x, "audience", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAudienceRegExp(value: js.RegExp): Self = StObject.set(x, "audience", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAudienceUndefined: Self = StObject.set(x, "audience", js.undefined)
      
      @scala.inline
      def setAudienceVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "audience", js.Array(value :_*))
