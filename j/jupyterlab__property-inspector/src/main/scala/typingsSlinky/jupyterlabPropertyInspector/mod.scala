...
object mod {
  ...
  @js.native
  val IPropertyInspectorProvider: Token[typingsSlinky.jupyterlabPropertyInspector.tokenMod.IPropertyInspectorProvider] = js.native
  ...
  trait PropertyInspectorProvider
    extends Widget
       with typingsSlinky.jupyterlabPropertyInspector.tokenMod.IPropertyInspectorProvider {
