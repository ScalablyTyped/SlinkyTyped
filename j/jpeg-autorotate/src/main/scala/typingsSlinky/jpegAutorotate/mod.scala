...
object mod {
  ...
  object errors extends StObject {
    ...
    /* "correct_orientation" */ val correct_orientation: typingsSlinky.jpegAutorotate.mod.errors.correct_orientation with String = js.native
    
    @js.native
    sealed trait no_orientation extends errors
    /* "no_orientation" */ val no_orientation: typingsSlinky.jpegAutorotate.mod.errors.no_orientation with String = js.native
    
    @js.native
    sealed trait read_exif extends errors
    /* "read_exif" */ val read_exif: typingsSlinky.jpegAutorotate.mod.errors.read_exif with String = js.native
    
    @js.native
    sealed trait read_file extends errors
    /* "read_file" */ val read_file: typingsSlinky.jpegAutorotate.mod.errors.read_file with String = js.native
    
    @js.native
    sealed trait rotate_file extends errors
    /* "rotate_file" */ val rotate_file: typingsSlinky.jpegAutorotate.mod.errors.rotate_file with String = js.native
    
    @js.native
    sealed trait unknown_orientation extends errors
    /* "unknown_orientation" */ val unknown_orientation: typingsSlinky.jpegAutorotate.mod.errors.unknown_orientation with String = js.native
  }
  ...
  @JSImport("jpeg-autorotate", "rotate")
  @js.native
  def rotate_Promise(path_or_buffer: String, options: RotateOptions): js.Promise[typingsSlinky.jpegAutorotate.anon.Buffer] = js.native
  @JSImport("jpeg-autorotate", "rotate")
  @js.native
  def rotate_Promise(path_or_buffer: Buffer, options: RotateOptions): js.Promise[typingsSlinky.jpegAutorotate.anon.Buffer] = js.native
