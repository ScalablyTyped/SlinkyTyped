...
import typingsSlinky.jqueryDotBbq.jqueryDotBbqMod._Global_.JQueryBbq.JQueryDeparam
...
trait JQueryStatic extends js.Object {
  var bbq: typingsSlinky.jqueryDotBbq.jqueryDotBbqMod._Global_.JQueryBbq.JQuery = js.native
  @JSName("deparam")
