...
object constantsMod {
  ...
  object KEYS {
    ...
    @JSImport("jest-watcher/build/constants", "KEYS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("jest-watcher/build/constants", "KEYS.ARROW_DOWN")
    @js.native
    ...
    @JSImport("jest-watcher/build/constants", "KEYS.ARROW_LEFT")
    @js.native
    ...
    @JSImport("jest-watcher/build/constants", "KEYS.ARROW_RIGHT")
    @js.native
    ...
    @JSImport("jest-watcher/build/constants", "KEYS.ARROW_UP")
    @js.native
    ...
    @JSImport("jest-watcher/build/constants", "KEYS.BACKSPACE")
    @js.native
    ...
    @JSImport("jest-watcher/build/constants", "KEYS.CONTROL_C")
    @js.native
    ...
    @JSImport("jest-watcher/build/constants", "KEYS.CONTROL_D")
    @js.native
