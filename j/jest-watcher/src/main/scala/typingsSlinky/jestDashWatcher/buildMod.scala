...
import typingsSlinky.jestDashWatcher.buildBaseWatchPluginMod.default
...
object buildMod extends js.Object {
  ...
  @js.native
  class JestHook ()
    extends typingsSlinky.jestDashWatcher.buildJestHooksMod.default
  
  @js.native
  class PatternPrompt protected ()
    extends typingsSlinky.jestDashWatcher.buildPatternPromptMod.default {
    def this(pipe: WritableStream, prompt: typingsSlinky.jestDashWatcher.buildLibPromptMod.default) = this()
  }
  
  @js.native
  class Prompt ()
    extends typingsSlinky.jestDashWatcher.buildLibPromptMod.default
