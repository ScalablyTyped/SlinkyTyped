...
trait SummaryOptions extends js.Object {
  var currentTestCases: js.UndefOr[js.Array[typingsSlinky.jestReporters.anon.Test]] = js.native
...
object SummaryOptions {
  ...
  implicit class SummaryOptionsOps[Self <: SummaryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentTestCasesVarargs(value: typingsSlinky.jestReporters.anon.Test*): Self = this.set("currentTestCases", js.Array(value :_*))
    @scala.inline
    def setCurrentTestCases(value: js.Array[typingsSlinky.jestReporters.anon.Test]): Self = this.set("currentTestCases", value.asInstanceOf[js.Any])
    @scala.inline
