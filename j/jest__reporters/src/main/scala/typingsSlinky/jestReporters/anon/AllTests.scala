...
trait AllTests extends js.Object {
  ...
  var tests: js.Array[typingsSlinky.jestReporters.typesMod.Test] = js.native
  var total: Double = js.native
}

object AllTests {
  @scala.inline
  def apply(allTests: Double, tests: js.Array[typingsSlinky.jestReporters.typesMod.Test], total: Double): AllTests = {
  ...
  implicit class AllTestsOps[Self <: AllTests] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTestsVarargs(value: typingsSlinky.jestReporters.typesMod.Test*): Self = this.set("tests", js.Array(value :_*))
    @scala.inline
    def setTests(value: js.Array[typingsSlinky.jestReporters.typesMod.Test]): Self = this.set("tests", value.asInstanceOf[js.Any])
    @scala.inline
