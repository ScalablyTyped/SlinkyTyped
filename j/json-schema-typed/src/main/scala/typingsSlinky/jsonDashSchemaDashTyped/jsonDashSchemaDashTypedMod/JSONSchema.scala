...
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`date-time`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`full-date`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`full-time`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`idn-email`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`idn-hostname`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`iri-reference`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`json-pointer-uri-fragment`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`json-pointer`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`relative-json-pointer`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`uri-reference`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`uri-template`
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.date
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.email
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.hostname
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.ipv4
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.ipv6
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.iri
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.regex
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.time
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.uri
import typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.uuid
