...
object JSONSchemaFormat extends js.Object {
  ...
  /* "date" */ val Date: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.Date with String = js.native
  /* "date-time" */ val DateTime: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.DateTime with String = js.native
  /* "email" */ val Email: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.Email with String = js.native
  /* "hostname" */ val Hostname: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.Hostname with String = js.native
  /* "idn-email" */ val IDNEmail: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.IDNEmail with String = js.native
  /* "idn-hostname" */ val IDNHostname: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.IDNHostname with String = js.native
  /* "ipv4" */ val IPv4: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.IPv4 with String = js.native
  /* "ipv6" */ val IPv6: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.IPv6 with String = js.native
  /* "iri" */ val IRI: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.IRI with String = js.native
  /* "iri-reference" */ val IRIReference: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.IRIReference with String = js.native
  /* "json-pointer" */ val JSONPointer: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.JSONPointer with String = js.native
  /* "json-pointer-uri-fragment" */ val JSONPointerURIFragment: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.JSONPointerURIFragment with String = js.native
  /* "regex" */ val RegEx: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.RegEx with String = js.native
  /* "relative-json-pointer" */ val RelativeJSONPointer: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.RelativeJSONPointer with String = js.native
  /* "time" */ val Time: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.Time with String = js.native
  /* "uri" */ val URI: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.URI with String = js.native
  /* "uri-reference" */ val URIReference: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.URIReference with String = js.native
  /* "uri-template" */ val URITemplate: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.URITemplate with String = js.native
  /* "uuid" */ val UUID: typingsSlinky.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedMod.JSONSchemaFormat.UUID with String = js.native
  @JSBracketAccess
