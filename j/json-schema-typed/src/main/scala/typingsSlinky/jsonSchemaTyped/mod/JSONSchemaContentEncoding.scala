...
object JSONSchemaContentEncoding extends StObject {
  ...
  /* "7bit" */ val `7bit`: typingsSlinky.jsonSchemaTyped.mod.JSONSchemaContentEncoding.`7bit` with String = js.native
  ...
  /* "8bit" */ val `8bit`: typingsSlinky.jsonSchemaTyped.mod.JSONSchemaContentEncoding.`8bit` with String = js.native
  ...
  /* "base64" */ val Base64: typingsSlinky.jsonSchemaTyped.mod.JSONSchemaContentEncoding.Base64 with String = js.native
  ...
  /* "binary" */ val Binary: typingsSlinky.jsonSchemaTyped.mod.JSONSchemaContentEncoding.Binary with String = js.native
  ...
  /* "ietf-token" */ val IETFToken: typingsSlinky.jsonSchemaTyped.mod.JSONSchemaContentEncoding.IETFToken with String = js.native
  ...
  /* "quoted-printable" */ val QuotedPrintable: typingsSlinky.jsonSchemaTyped.mod.JSONSchemaContentEncoding.QuotedPrintable with String = js.native
  ...
  /* "x-token" */ val XToken: typingsSlinky.jsonSchemaTyped.mod.JSONSchemaContentEncoding.XToken with String = js.native
}
