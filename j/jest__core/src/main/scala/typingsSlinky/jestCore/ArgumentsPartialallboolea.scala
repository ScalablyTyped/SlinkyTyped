...
/* argName */ StringDictionary[js.Any] {
  ...
  var maxWorkers: js.UndefOr[String | Double] = js.native
...
object ArgumentsPartialallboolea {
  @scala.inline
  def apply($0: String, _underscore: js.Array[String]): ArgumentsPartialallboolea = {
  ...
  implicit class ArgumentsPartialallbooleaOps[Self <: ArgumentsPartialallboolea] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxWorkers(value: String | Double): Self = {
        val ret = this.duplicate
