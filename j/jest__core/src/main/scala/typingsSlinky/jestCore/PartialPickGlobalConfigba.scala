...
import typingsSlinky.jestCore.jestCoreStrings.`json-summary`
import typingsSlinky.jestCore.jestCoreStrings.`text-lcov`
import typingsSlinky.jestCore.jestCoreStrings.`text-summary`
import typingsSlinky.jestCore.jestCoreStrings.clover
import typingsSlinky.jestCore.jestCoreStrings.cobertura
import typingsSlinky.jestCore.jestCoreStrings.html
import typingsSlinky.jestCore.jestCoreStrings.json
import typingsSlinky.jestCore.jestCoreStrings.lcovonly
import typingsSlinky.jestCore.jestCoreStrings.none
import typingsSlinky.jestCore.jestCoreStrings.teamcity
import typingsSlinky.jestCore.jestCoreStrings.text
import typingsSlinky.jestCore.jestCoreStrings.watch
import typingsSlinky.jestCore.jestCoreStrings.watchAll
...
trait PartialPickGlobalConfigba extends js.Object {
  ...
  @JSName("notify")
  var notify_FPartialPickGlobalConfigba: js.UndefOr[Boolean] = js.native
...
object PartialPickGlobalConfigba {
  @scala.inline
  def apply(): PartialPickGlobalConfigba = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPickGlobalConfigba]
  }
  @scala.inline
  implicit class PartialPickGlobalConfigbaOps[Self <: PartialPickGlobalConfigba] (val x: Self) extends AnyVal {
    @scala.inline
