...
object TestNamePatternPlugin {
  ...
  @scala.inline
  implicit class TestNamePatternPluginOps[Self <: TestNamePatternPlugin] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def with_prompt(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Prompt */ js.Any
    ): Self = {
