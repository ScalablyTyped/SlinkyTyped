...
trait ChangedFilesPromise extends js.Object {
  ...
  var contexts: js.Array[typingsSlinky.jestRuntime.typesMod.Context] = js.native
...
object ChangedFilesPromise {
  ...
  implicit class ChangedFilesPromiseOps[Self <: ChangedFilesPromise] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContexts(value: js.Array[typingsSlinky.jestRuntime.typesMod.Context]): Self = {
    ...
    @scala.inline
    def withStartRun(value: typingsSlinky.jestTypes.configMod.GlobalConfig => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFilter(value: /* testPaths */ js.Array[String] => js.Promise[Filtered]): Self = {
        val ret = this.duplicate
