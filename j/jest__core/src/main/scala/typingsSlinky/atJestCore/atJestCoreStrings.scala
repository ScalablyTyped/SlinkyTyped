...
object atJestCoreStrings {
  ...
  @js.native
  sealed trait noSCM extends js.Object
  ...
  @js.native
  sealed trait passWithNoTests extends js.Object
  ...
  @scala.inline
  def noSCM: noSCM = "noSCM".asInstanceOf[noSCM]
  @scala.inline
  ...
  @scala.inline
  def passWithNoTests: passWithNoTests = "passWithNoTests".asInstanceOf[passWithNoTests]
  @scala.inline
