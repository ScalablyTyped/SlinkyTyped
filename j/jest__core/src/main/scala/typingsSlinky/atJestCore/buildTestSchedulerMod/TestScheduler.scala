...
trait TestScheduler extends js.Object {
  ...
  def scheduleTests(tests: js.Array[Test], watcher: typingsSlinky.atJestCore.buildTestWatcherMod.default): js.Promise[AggregatedResult]
}
...
object TestScheduler {
  ...
  def apply(
    ...
    scheduleTests: (js.Array[Test], typingsSlinky.atJestCore.buildTestWatcherMod.default) => js.Promise[AggregatedResult]
  ): TestScheduler = {
