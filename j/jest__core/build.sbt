...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "collect-v8-coverage" % "1.0.1-854a5f",
  "org.scalablytyped.slinky" %%% "emittery" % "0.7.1-77da48",
  "org.scalablytyped.slinky" %%% "istanbul-lib-coverage" % "2.0-dt-20200609Z-5d64c8",
  "org.scalablytyped.slinky" %%% "istanbul-lib-report" % "3.0-dt-20200515Z-db6784",
  "org.scalablytyped.slinky" %%% "jest-changed-files" % "26.2.0-6d5c3e",
  ...
  "org.scalablytyped.slinky" %%% "jest-runner" % "26.2.2-88f8b9",
  "org.scalablytyped.slinky" %%% "jest-runtime" % "26.2.2-14c911",
  "org.scalablytyped.slinky" %%% "jest-watcher" % "26.2.0-c3470d",
  "org.scalablytyped.slinky" %%% "jest__console" % "24.9.0-1f0e7f",
  "org.scalablytyped.slinky" %%% "jest__environment" % "26.2.0-ae3bd5",
  "org.scalablytyped.slinky" %%% "jest__reporters" % "26.2.2-e89efb",
