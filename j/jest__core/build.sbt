...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "collect-v8-coverage" % "1.0.1-604998",
  ...
  "org.scalablytyped.slinky" %%% "jest-changed-files" % "26.6.2-0ce938",
