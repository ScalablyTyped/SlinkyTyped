package typingsSlinky.javascriptDashObfuscator.srcInterfacesCustomDashNodesICustomNodeMod

import typingsSlinky.javascriptDashObfuscator.srcInterfacesIInitializableMod.IInitializable
import typingsSlinky.javascriptDashObfuscator.srcTypesNodeTStatementMod.TStatement
