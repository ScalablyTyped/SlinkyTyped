...
object SourceType {
  ...
  @scala.inline
  def module: typingsSlinky.javascriptDashObfuscator.javascriptDashObfuscatorStrings.module = this.cast("module")
  @scala.inline
  def script: typingsSlinky.javascriptDashObfuscator.javascriptDashObfuscatorStrings.script = this.cast("script")
}
