...
object BlendMode {
  ...
  implicit class BlendModeOps[Self <: BlendMode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOpacityDest(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("opacityDest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOpacitySource(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("opacitySource")(value.asInstanceOf[js.Any])
        ret
    }
  }
