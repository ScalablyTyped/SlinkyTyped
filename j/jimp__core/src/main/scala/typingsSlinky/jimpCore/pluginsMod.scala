...
import typingsSlinky.jimpCore.anon.Class
...
import typingsSlinky.jimpCore.jimpCoreStrings.`class`
import typingsSlinky.jimpCore.jimpCoreStrings.constants
import typingsSlinky.jimpCore.utilsMod.Omit
