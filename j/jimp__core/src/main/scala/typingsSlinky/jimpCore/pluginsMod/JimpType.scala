...
object JimpType {
  @scala.inline
  def apply[/* <: typingsSlinky.jimpCore.etcMod.Image */ T](mime: js.UndefOr[StringDictionary[js.Array[String]]] with StringDictionary[js.Array[String]]): JimpType[T] = {
    val __obj = js.Dynamic.literal(mime = mime.asInstanceOf[js.Any])
    __obj.asInstanceOf[JimpType[T]]
  }
  @scala.inline
  implicit class JimpTypeOps[Self <: JimpType[_], /* <: typingsSlinky.jimpCore.etcMod.Image */ T] (val x: Self with JimpType[T]) extends AnyVal {
    @scala.inline
