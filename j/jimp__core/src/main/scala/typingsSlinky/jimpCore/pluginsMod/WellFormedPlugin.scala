...
object WellFormedPlugin {
  @scala.inline
  def apply[/* <: typingsSlinky.jimpCore.etcMod.Image */ ImageType](): WellFormedPlugin[ImageType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WellFormedPlugin[ImageType]]
  }
  @scala.inline
  implicit class WellFormedPluginOps[Self <: WellFormedPlugin[_], /* <: typingsSlinky.jimpCore.etcMod.Image */ ImageType] (val x: Self with WellFormedPlugin[ImageType]) extends AnyVal {
    @scala.inline
