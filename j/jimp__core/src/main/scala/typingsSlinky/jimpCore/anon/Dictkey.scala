...
object Dictkey {
  @scala.inline
  def apply[/* <: typingsSlinky.jimpCore.etcMod.ListenableName */ T](eventName: `before-change` | changed, methodName: T): Dictkey[T] = {
    val __obj = js.Dynamic.literal(eventName = eventName.asInstanceOf[js.Any], methodName = methodName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Dictkey[T]]
  }
  @scala.inline
  implicit class DictkeyOps[Self <: Dictkey[_], /* <: typingsSlinky.jimpCore.etcMod.ListenableName */ T] (val x: Self with Dictkey[T]) extends AnyVal {
    @scala.inline
