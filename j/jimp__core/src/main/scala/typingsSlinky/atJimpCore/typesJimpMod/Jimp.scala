package typingsSlinky.atJimpCore.typesJimpMod

import typingsSlinky.atJimpCore.atJimpCoreNumbers.`-1`
import typingsSlinky.atJimpCore.atJimpCoreNumbers.`16`
import typingsSlinky.atJimpCore.atJimpCoreNumbers.`1`
import typingsSlinky.atJimpCore.atJimpCoreNumbers.`2`
import typingsSlinky.atJimpCore.atJimpCoreNumbers.`32`
import typingsSlinky.atJimpCore.atJimpCoreNumbers.`3`
import typingsSlinky.atJimpCore.atJimpCoreNumbers.`4`
import typingsSlinky.atJimpCore.atJimpCoreNumbers.`8`
import typingsSlinky.atJimpCore.typesEtcMod.Bitmap
import typingsSlinky.atJimpCore.typesEtcMod.BlendMode
import typingsSlinky.atJimpCore.typesEtcMod.GenericCallback
...
import typingsSlinky.atJimpCore.typesEtcMod.RGB
import typingsSlinky.atJimpCore.typesEtcMod.RGBA
