...
import typingsSlinky.jsonld.jsonldSpecMod.JsonLdProcessor
...
object mod {
  ...
  @js.native
  def JsonLdProcessor: typingsSlinky.jsonld.jsonldSpecMod.JsonLdProcessor = js.native
  @scala.inline
  ...
  @JSImport("jsonld", "frame")
  @js.native
  def frame(input: Document, frame: Frame, options: typingsSlinky.jsonld.mod.Options.Frame): js.Promise[JsonLdObj] = js.native
  @JSImport("jsonld", "frame")
  @js.native
  def frame(
    input: Document,
  ...
  object Options {
    ...
    object Frame {
      ...
      @scala.inline
      def apply(): typingsSlinky.jsonld.mod.Options.Frame = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.jsonld.mod.Options.Frame]
      }
      
      @scala.inline
      implicit class FrameMutableBuilder[Self <: typingsSlinky.jsonld.mod.Options.Frame] (val x: Self) extends AnyVal {
