...
import typingsSlinky.jweixin.AnonAccuracy
...
trait IgetLocation extends BaseParams {
  ...
  @JSName("success")
  def success_MIgetLocation(res: AnonAccuracy): Unit = js.native
}

object IgetLocation {
  @scala.inline
  def apply(success: AnonAccuracy => Unit, `type`: wgs84 | gcj02): IgetLocation = {
  ...
  implicit class IgetLocationOps[Self <: IgetLocation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSuccess(value: AnonAccuracy => Unit): Self = {
