...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.jweixin.jweixinStrings.menuItemColoneditTag
  - typingsSlinky.jweixin.jweixinStrings.menuItemColondelete
  - typingsSlinky.jweixin.jweixinStrings.menuItemColoncopyUrl
  - typingsSlinky.jweixin.jweixinStrings.menuItemColonoriginPage
  - typingsSlinky.jweixin.jweixinStrings.menuItemColonreadMode
  - typingsSlinky.jweixin.jweixinStrings.menuItemColonopenWithQQBrowser
  - typingsSlinky.jweixin.jweixinStrings.menuItemColonopenWithSafari
  - typingsSlinky.jweixin.jweixinStrings.menuItemColonshareColonemail
  - typingsSlinky.jweixin.jweixinStrings.menuItemColonshareColonbrand
*/
