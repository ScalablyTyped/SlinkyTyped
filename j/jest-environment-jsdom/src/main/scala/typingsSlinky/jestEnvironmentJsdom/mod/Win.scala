...
import typingsSlinky.jestEnvironmentJsdom.AnonStackTraceLimit
...
import typingsSlinky.jestTypes.ItBaseconcurrentItConcurr
...
trait Win
  ...
  val console: Console_ with typingsSlinky.node.Console_ = js.native
