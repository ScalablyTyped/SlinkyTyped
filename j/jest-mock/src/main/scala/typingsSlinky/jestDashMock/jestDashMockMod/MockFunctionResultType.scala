...
object MockFunctionResultType {
  ...
  @scala.inline
  def incomplete: typingsSlinky.jestDashMock.jestDashMockStrings.incomplete = this.cast("incomplete")
  @scala.inline
  def `return`: typingsSlinky.jestDashMock.jestDashMockStrings.`return` = this.cast("return")
  @scala.inline
  def `throw`: typingsSlinky.jestDashMock.jestDashMockStrings.`throw` = this.cast("throw")
}
