...
version := "0.0-dt-20200515Z-2ab69e"
scalaVersion := "2.13.3"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.6",
  "org.scalablytyped.slinky" %%% "ace" % "0.0-unknown-dt-20200515Z-a91b68",
  "org.scalablytyped.slinky" %%% "ajv" % "6.12.3-ca1ff8",
  "org.scalablytyped.slinky" %%% "csstype" % "3.0.2-fce754",
  "org.scalablytyped.slinky" %%% "jsoneditor" % "8.6-dt-20200522Z-652072",
