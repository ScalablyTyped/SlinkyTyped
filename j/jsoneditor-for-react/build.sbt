...
version := "0.0-dt-20180803Z-3efc50"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.2",
  "org.scalablytyped.slinky" %%% "ace" % "0.0-unknown-dt-20190322Z-cee837",
  "org.scalablytyped.slinky" %%% "ajv" % "6.10.2-edb28d",
  "org.scalablytyped.slinky" %%% "csstype" % "2.6.6-f22bc8",
  "org.scalablytyped.slinky" %%% "jsoneditor" % "v5.28.2-dt-20191216Z-f8bdbf",
