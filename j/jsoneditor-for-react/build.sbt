...
version := "0.0-dt-20200515Z-d70e3e"
scalaVersion := "2.13.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.5",
  "org.scalablytyped.slinky" %%% "ace" % "0.0-unknown-dt-20200515Z-3cd700",
  "org.scalablytyped.slinky" %%% "ajv" % "6.12.2-fc1794",
  "org.scalablytyped.slinky" %%% "csstype" % "2.6.6-6e65be",
  "org.scalablytyped.slinky" %%% "jsoneditor" % "8.6-dt-20200413Z-368be9",
