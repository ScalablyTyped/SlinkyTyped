...
import typingsSlinky.joi.anon.Alternatives
...
trait Root extends StObject {
  ...
  var ValidationError: Instantiable3[
    ...
    /* details */ js.Any, 
    /* original */ js.Any, 
    typingsSlinky.joi.mod.ValidationError
  ] = js.native
  ...
  def assert(value: js.Any, schema: Schema, message: js.Error): Unit = js.native
  def assert(value: js.Any, schema: Schema, message: js.Error, options: ValidationOptions): Unit = js.native
  ...
  def attempt(value: js.Any, schema: Schema, message: js.Error): js.Any = js.native
  def attempt(value: js.Any, schema: Schema, message: js.Error, options: ValidationOptions): js.Any = js.native
