...
import typingsSlinky.joi.anon.Build
import typingsSlinky.joi.anon.To
...
trait Extension extends StObject {
  ...
  var `type`: String | js.RegExp = js.native
...
object Extension {
  ...
  @scala.inline
  def apply(`type`: String | js.RegExp): Extension = {
  ...
  implicit class ExtensionMutableBuilder[Self <: Extension] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | js.RegExp): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTypeRegExp(value: js.RegExp): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
