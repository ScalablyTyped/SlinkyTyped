...
object Extension {
  ...
  implicit class ExtensionOps[Self <: Extension] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeRegExp(value: js.RegExp): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setType(value: String | js.RegExp): Self = this.set("type", value.asInstanceOf[js.Any])
