package typingsSlinky.jsonexport.mod
...
object ^ extends js.Object {
  ...
  def apply(json: js.Array[js.Object], cb: js.Function2[/* err */ js.Error, /* csv */ String, Unit]): Unit = js.native
  ...
  def apply(json: js.Object, cb: js.Function2[/* err */ js.Error, /* csv */ String, Unit]): Unit = js.native
