...
object mod {
  ...
  */
  ...
  object BinaryQueryCondition {
    ...
    @scala.inline
    def AndQueryCondition[T]($and: js.Array[Query[T]]): typingsSlinky.jsonquery.mod.AndQueryCondition[T] = {
      val __obj = js.Dynamic.literal($and = $and.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonquery.mod.AndQueryCondition[T]]
    }
    
    @scala.inline
    def OrQueryCondition[T]($or: js.Array[Query[T]]): typingsSlinky.jsonquery.mod.OrQueryCondition[T] = {
      val __obj = js.Dynamic.literal($or = $or.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jsonquery.mod.OrQueryCondition[T]]
    }
  }
  ...
  {[ P in keyof T ]:? T[P] | jsonquery.jsonquery.BaseCondition<T[P]>}
    */ typingsSlinky.jsonquery.jsonqueryStrings.QueryValue with TopLevel[js.Any]
