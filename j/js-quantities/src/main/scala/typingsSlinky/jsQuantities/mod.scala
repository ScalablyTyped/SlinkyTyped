...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.jsQuantities.jsQuantitiesNumbers.`-1`
    - typingsSlinky.jsQuantities.jsQuantitiesNumbers.`0`
    - typingsSlinky.jsQuantities.jsQuantitiesNumbers.`1`
  */
  ...
  object ComparisonResult {
    ...
    @scala.inline
    def `-1`: typingsSlinky.jsQuantities.jsQuantitiesNumbers.`-1` = -1.asInstanceOf[typingsSlinky.jsQuantities.jsQuantitiesNumbers.`-1`]
    
    @scala.inline
    def `0`: typingsSlinky.jsQuantities.jsQuantitiesNumbers.`0` = 0.asInstanceOf[typingsSlinky.jsQuantities.jsQuantitiesNumbers.`0`]
