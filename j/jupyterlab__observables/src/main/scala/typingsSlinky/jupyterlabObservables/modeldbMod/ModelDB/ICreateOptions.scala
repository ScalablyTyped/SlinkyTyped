...
trait ICreateOptions extends js.Object {
  /**
    ...
    */
  var baseDB: js.UndefOr[typingsSlinky.jupyterlabObservables.modeldbMod.ModelDB] = js.undefined
  /**
...
object ICreateOptions {
  @scala.inline
  def apply(baseDB: typingsSlinky.jupyterlabObservables.modeldbMod.ModelDB = null, basePath: String = null): ICreateOptions = {
