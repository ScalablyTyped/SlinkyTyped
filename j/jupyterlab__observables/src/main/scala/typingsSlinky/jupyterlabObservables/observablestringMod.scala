...
object observablestringMod {
  ...
  trait IObservableString extends IObservable {
    ...
    /**
      ...
      */
    @JSName("type")
    var type_IObservableString: typingsSlinky.jupyterlabObservables.jupyterlabObservablesStrings.String = js.native
  }
  object IObservableString {
    ...
    */
    ...
    implicit class IObservableStringMutableBuilder[Self <: IObservableString] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: typingsSlinky.jupyterlabObservables.jupyterlabObservablesStrings.String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
}
