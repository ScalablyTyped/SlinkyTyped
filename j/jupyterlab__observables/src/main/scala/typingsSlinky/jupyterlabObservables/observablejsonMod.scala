...
object observablejsonMod {
  ...
  object IObservableJSON {
    ...
    def apply(
      changed: ISignal[
          IObservableJSON, 
          typingsSlinky.jupyterlabObservables.observablemapMod.IObservableMap.IChangedArgs[js.UndefOr[ReadonlyPartialJSONValue]]
        ],
      clear: () => Unit,
      delete: String => js.UndefOr[ReadonlyPartialJSONValue],
      dispose: () => Unit,
      get: String => js.UndefOr[ReadonlyPartialJSONValue],
      has: String => Boolean,
      isDisposed: Boolean,
      keys: () => js.Array[String],
      set: (String, js.UndefOr[ReadonlyPartialJSONValue]) => js.UndefOr[ReadonlyPartialJSONValue],
      size: Double,
