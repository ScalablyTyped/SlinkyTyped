package typingsSlinky.atJupyterlabObservables.libModeldbMod.ModelDB
...
trait ICreateOptions extends js.Object {
  /**
    ...
    */
  var baseDB: js.UndefOr[typingsSlinky.atJupyterlabObservables.libModeldbMod.ModelDB] = js.undefined
  /**
...
object ICreateOptions {
  @scala.inline
  def apply(
    baseDB: typingsSlinky.atJupyterlabObservables.libModeldbMod.ModelDB = null,
