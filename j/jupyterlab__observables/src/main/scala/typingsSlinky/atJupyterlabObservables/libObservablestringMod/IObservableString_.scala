...
trait IObservableString_ extends IObservable {
  ...
  /**
    ...
    */
  @JSName("type")
  var type_IObservableString_ : typingsSlinky.atJupyterlabObservables.atJupyterlabObservablesStrings.String
  /**
...
object IObservableString_ {
  ...
  def apply(
    ...
    text: String,
    `type`: typingsSlinky.atJupyterlabObservables.atJupyterlabObservablesStrings.String
  ): IObservableString_ = {
