package typingsSlinky.atJupyterlabObservables.libObservablestringMod

import typingsSlinky.atJupyterlabObservables.libModeldbMod.ObservableType
import typingsSlinky.atJupyterlabObservables.libObservablestringMod.IObservableString.IChangedArgs
...
class ObservableString () extends IObservableString {
  ...
  /* CompleteClass */
  @JSName("type")
  override var type_IObservableString_ : typingsSlinky.atJupyterlabObservables.atJupyterlabObservablesStrings.String = js.native
  /**
