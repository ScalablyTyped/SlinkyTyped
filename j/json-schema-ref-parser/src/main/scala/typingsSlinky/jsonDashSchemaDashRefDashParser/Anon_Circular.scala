...
import typingsSlinky.jsonDashSchemaDashRefDashParser.jsonDashSchemaDashRefDashParserStrings.ignore
...
object Anon_Circular {
  @scala.inline
  def apply(circular: Boolean | ignore = null): Anon_Circular = {
