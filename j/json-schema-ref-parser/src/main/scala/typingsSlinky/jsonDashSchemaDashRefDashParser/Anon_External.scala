...
import typingsSlinky.jsonDashSchemaDashRefDashParser.jsonDashSchemaDashRefDashParserMod.HTTPResolverOptions
import typingsSlinky.jsonDashSchemaDashRefDashParser.jsonDashSchemaDashRefDashParserMod.ResolverOptions
