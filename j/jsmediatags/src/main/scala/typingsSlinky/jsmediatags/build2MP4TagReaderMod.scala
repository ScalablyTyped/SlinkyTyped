...
import typingsSlinky.jsmediatags.build2MP4TagReaderMod.MP4TagReader
...
object build2MP4TagReaderMod extends js.Object {
  ...
  trait MP4TagReader
    ...
    def _readMetadataAtom(data: typingsSlinky.jsmediatags.build2MediaFileReaderMod.default, offset: Double): TagFrame = js.native
  }
