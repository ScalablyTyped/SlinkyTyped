package typingsSlinky.jsmediatags.jsmediatagsMod

import typingsSlinky.jsmediatags.TypeofClassMediaFileReader
import typingsSlinky.jsmediatags.TypeofClassMediaTagReader
