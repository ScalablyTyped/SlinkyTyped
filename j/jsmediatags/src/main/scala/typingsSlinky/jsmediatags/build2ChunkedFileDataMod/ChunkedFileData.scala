package typingsSlinky.jsmediatags.build2ChunkedFileDataMod

import typingsSlinky.jsmediatags.Anon_EndIx
...
trait ChunkedFileData extends js.Object {
  ...
  def _getChunkRange(offsetStart: Double, offsetEnd: Double): Anon_EndIx
...
object ChunkedFileData {
  ...
  def apply(
    ...
    _getChunkRange: (Double, Double) => Anon_EndIx,
