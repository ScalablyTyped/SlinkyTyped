package typingsSlinky.javascriptDashStateDashMachine.javascriptDashStateDashMachineMod
...
object StateMachineConfig {
  ...
  def apply(
    ...
    error: (/* eventName */ js.UndefOr[String], /* from */ js.UndefOr[String], /* to */ js.UndefOr[String], /* args */ js.UndefOr[js.Array[js.Any]], /* errorCode */ js.UndefOr[Double], /* errorMessage */ js.UndefOr[String], /* ex */ js.UndefOr[js.Error]) => Unit = null,
