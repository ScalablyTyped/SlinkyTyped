...
import typingsSlinky.jupyterlabCsvviewer.widgetMod.CSVDocumentWidget.IOptions
...
object widgetMod {
  ...
  object CSVViewer {
    ...
    object IOptions {
      ...
      @scala.inline
      def apply(context: Context): typingsSlinky.jupyterlabCsvviewer.widgetMod.CSVViewer.IOptions = {
        val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.jupyterlabCsvviewer.widgetMod.CSVViewer.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabCsvviewer.widgetMod.CSVViewer.IOptions] (val x: Self) extends AnyVal {
