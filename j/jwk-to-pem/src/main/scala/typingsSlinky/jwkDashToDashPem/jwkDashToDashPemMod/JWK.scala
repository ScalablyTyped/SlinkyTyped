...
/* Rewritten from type alias, can be one of: 
  - typings.jwkDashToDashPem.jwkDashToDashPemMod.EC
  - typings.jwkDashToDashPem.jwkDashToDashPemMod.ECPrivate
  - typings.jwkDashToDashPem.jwkDashToDashPemMod.RSA
*/
trait JWK extends js.Object

object JWK {
  @scala.inline
  def EC(crv: String, kty: typingsSlinky.jwkDashToDashPem.jwkDashToDashPemStrings.EC, x: String, y: String): JWK = {
  ...
  def ECPrivate(
    crv: String,
    d: String,
    kty: typingsSlinky.jwkDashToDashPem.jwkDashToDashPemStrings.EC,
    x: String = null,
    y: String = null
  ): JWK = {
