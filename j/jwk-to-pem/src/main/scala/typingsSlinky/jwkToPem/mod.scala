...
object mod {
  ...
  object EC {
    ...
    implicit class ECMutableBuilder[Self <: EC] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKty(value: typingsSlinky.jwkToPem.jwkToPemStrings.EC): Self = StObject.set(x, "kty", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object JWK {
    ...
    @scala.inline
    def EC(crv: String, kty: typingsSlinky.jwkToPem.jwkToPemStrings.EC, x: String, y: String): typingsSlinky.jwkToPem.mod.EC = {
      val __obj = js.Dynamic.literal(crv = crv.asInstanceOf[js.Any], kty = kty.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jwkToPem.mod.EC]
    }
    
    @scala.inline
    def ECPrivate(crv: String, d: String, kty: typingsSlinky.jwkToPem.jwkToPemStrings.EC): typingsSlinky.jwkToPem.mod.ECPrivate = {
      val __obj = js.Dynamic.literal(crv = crv.asInstanceOf[js.Any], d = d.asInstanceOf[js.Any], kty = kty.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jwkToPem.mod.ECPrivate]
    }
    
    @scala.inline
    def RSA(e: String, kty: typingsSlinky.jwkToPem.jwkToPemStrings.RSA, n: String): typingsSlinky.jwkToPem.mod.RSA = {
      val __obj = js.Dynamic.literal(e = e.asInstanceOf[js.Any], kty = kty.asInstanceOf[js.Any], n = n.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jwkToPem.mod.RSA]
    }
  }
  ...
  trait RSA extends JWK {
    ...
    var kty: typingsSlinky.jwkToPem.jwkToPemStrings.RSA = js.native
  ...
  object RSA {
    ...
    @scala.inline
    def apply(e: String, kty: typingsSlinky.jwkToPem.jwkToPemStrings.RSA, n: String): RSA = {
      val __obj = js.Dynamic.literal(e = e.asInstanceOf[js.Any], kty = kty.asInstanceOf[js.Any], n = n.asInstanceOf[js.Any])
    ...
    implicit class RSAMutableBuilder[Self <: RSA] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKty(value: typingsSlinky.jwkToPem.jwkToPemStrings.RSA): Self = StObject.set(x, "kty", value.asInstanceOf[js.Any])
