...
object TestResult {
  ...
  implicit class TestResultOps[Self <: TestResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOpenHandlesVarargs(value: js.Error*): Self = this.set("openHandles", js.Array(value :_*))
    @scala.inline
    def setOpenHandles(value: js.Array[js.Error]): Self = this.set("openHandles", value.asInstanceOf[js.Any])
    @scala.inline
