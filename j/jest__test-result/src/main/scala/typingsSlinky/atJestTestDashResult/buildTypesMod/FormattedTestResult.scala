...
import typingsSlinky.atJestTestDashResult.atJestTestDashResultStrings.failed
import typingsSlinky.atJestTestDashResult.atJestTestDashResultStrings.passed
