...
object PrintOrientation extends StObject {
  ...
  /* 1 */ val Landscape: typingsSlinky.jsprintmanager.mod.JSPM.PrintOrientation.Landscape with Double = js.native
  
  @js.native
  sealed trait Portrait extends PrintOrientation
  /* 0 */ val Portrait: typingsSlinky.jsprintmanager.mod.JSPM.PrintOrientation.Portrait with Double = js.native
}
