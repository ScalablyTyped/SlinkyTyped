...
object TextAlignment extends StObject {
  ...
  /* 1 */ val Center: typingsSlinky.jsprintmanager.mod.JSPM.TextAlignment.Center with Double = js.native
  
  @js.native
  sealed trait Justify extends TextAlignment
  /* 3 */ val Justify: typingsSlinky.jsprintmanager.mod.JSPM.TextAlignment.Justify with Double = js.native
  
  @js.native
  sealed trait Left extends TextAlignment
  /* 0 */ val Left: typingsSlinky.jsprintmanager.mod.JSPM.TextAlignment.Left with Double = js.native
  
  @js.native
  sealed trait Right extends TextAlignment
  /* 2 */ val Right: typingsSlinky.jsprintmanager.mod.JSPM.TextAlignment.Right with Double = js.native
}
