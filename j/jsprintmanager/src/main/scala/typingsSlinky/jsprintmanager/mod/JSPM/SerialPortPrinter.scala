...
import typingsSlinky.jsprintmanager.mod.JSPM.Serial.Handshake
import typingsSlinky.jsprintmanager.mod.JSPM.Serial.Parity
import typingsSlinky.jsprintmanager.mod.JSPM.Serial.StopBits
