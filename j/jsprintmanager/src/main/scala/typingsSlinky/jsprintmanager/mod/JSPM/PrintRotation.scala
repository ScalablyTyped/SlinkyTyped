...
object PrintRotation extends StObject {
  ...
  /* 3 */ val None: typingsSlinky.jsprintmanager.mod.JSPM.PrintRotation.None with Double = js.native
  
  @js.native
  sealed trait Rot180 extends PrintRotation
  /* 6 */ val Rot180: typingsSlinky.jsprintmanager.mod.JSPM.PrintRotation.Rot180 with Double = js.native
  
  @js.native
  sealed trait Rot270 extends PrintRotation
  /* 4 */ val Rot270: typingsSlinky.jsprintmanager.mod.JSPM.PrintRotation.Rot270 with Double = js.native
  
  @js.native
  sealed trait Rot90 extends PrintRotation
  /* 5 */ val Rot90: typingsSlinky.jsprintmanager.mod.JSPM.PrintRotation.Rot90 with Double = js.native
}
