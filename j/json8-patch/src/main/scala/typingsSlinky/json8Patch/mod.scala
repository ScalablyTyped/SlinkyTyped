...
object mod {
  ...
  @js.native
  def patch(doc: js.Any, patch: JsonPatch): PatchResultWithRevert = js.native
  @JSImport("json8-patch", "patch")
  @js.native
  ...
  @JSImport("json8-patch", "patch")
  @js.native
  def patch_PatchResult(doc: js.Any, patch: JsonPatch): PatchResult = js.native
  ...
  */
  ...
  object JsonPatchOperation {
    ...
    @scala.inline
    def AddOperation(op: add, path: String, value: js.Any): typingsSlinky.json8Patch.mod.AddOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.json8Patch.mod.AddOperation]
    }
    
    @scala.inline
    def CopyOperation(from: js.Any, op: copy, path: String): typingsSlinky.json8Patch.mod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.json8Patch.mod.CopyOperation]
    }
    
    @scala.inline
    def MoveOperation(from: js.Any, op: move, path: String): typingsSlinky.json8Patch.mod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.json8Patch.mod.MoveOperation]
    }
    
    @scala.inline
    def RemoveOperation(op: remove, path: String): typingsSlinky.json8Patch.mod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.json8Patch.mod.RemoveOperation]
    }
    
    @scala.inline
    def ReplaceOperation(op: replace, path: String, value: js.Any): typingsSlinky.json8Patch.mod.ReplaceOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.json8Patch.mod.ReplaceOperation]
    }
    
    @scala.inline
    def TestOperation(op: test, path: String, value: js.Any): typingsSlinky.json8Patch.mod.TestOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.json8Patch.mod.TestOperation]
    }
  }
