package typingsSlinky.jose.anon
...
@js.native
trait VerifyOptionscompletetrueAudience extends js.Object {
...
object VerifyOptionscompletetrueAudience {
  ...
  @scala.inline
  implicit class VerifyOptionscompletetrueAudienceOps[Self <: VerifyOptionscompletetrueAudience] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNow(value: js.Date): Self = this.set("now", value.asInstanceOf[js.Any])
