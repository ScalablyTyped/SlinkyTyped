...
object JWK {
  ...
  @js.native
  val EmbeddedJWK: typingsSlinky.jose.mod.JWK.EmbeddedJWK = js.native
  ...
  @js.native
  val EmbeddedX5C: typingsSlinky.jose.mod.JWK.EmbeddedX5C = js.native
  
  @JSImport("jose", "JWK.None")
  @js.native
  val None: typingsSlinky.jose.mod.JWK.NoneKey = js.native
