...
object mod {
  ...
  @js.native
  val ERROR_NO_COMMAND: typingsSlinky.jestDevServer.jestDevServerStrings.ERROR_NO_COMMAND = js.native
  
  @JSImport("jest-dev-server", "ERROR_PORT_USED")
  @js.native
  val ERROR_PORT_USED: typingsSlinky.jestDevServer.jestDevServerStrings.ERROR_PORT_USED = js.native
  
  @JSImport("jest-dev-server", "ERROR_TIMEOUT")
  @js.native
  val ERROR_TIMEOUT: typingsSlinky.jestDevServer.jestDevServerStrings.ERROR_TIMEOUT = js.native
