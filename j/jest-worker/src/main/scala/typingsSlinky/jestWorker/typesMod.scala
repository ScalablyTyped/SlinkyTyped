...
import typingsSlinky.jestWorker.anon.PostMessage
import typingsSlinky.jestWorker.anon.TypeofEventEmitter
import typingsSlinky.jestWorker.jestWorkerNumbers.`0`
import typingsSlinky.jestWorker.jestWorkerNumbers.`1`
import typingsSlinky.jestWorker.jestWorkerNumbers.`2`
...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.jestWorker.jestWorkerNumbers.`2`
  */
