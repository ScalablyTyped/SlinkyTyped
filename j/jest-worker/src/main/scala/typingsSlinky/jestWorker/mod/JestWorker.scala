...
object JestWorker {
  ...
  implicit class JestWorkerOps[Self <: JestWorker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_bindExposedWorkerMethods(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_bindExposedWorkerMethods")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_callFunctionWithArgs(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_callFunctionWithArgs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_ending(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_ending")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with_farm(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_farm")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def with_workerPool(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_workerPool")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
