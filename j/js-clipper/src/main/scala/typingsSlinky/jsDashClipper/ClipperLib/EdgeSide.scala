...
object EdgeSide extends js.Object {
  ...
  /* 0 */ val esLeft: typingsSlinky.jsDashClipper.ClipperLib.EdgeSide.esLeft with Double = js.native
  /* 1 */ val esRight: typingsSlinky.jsDashClipper.ClipperLib.EdgeSide.esRight with Double = js.native
  @JSBracketAccess
