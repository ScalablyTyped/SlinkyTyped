...
object IELangSearchDefaults {
  ...
  implicit class IELangSearchDefaultsOps[Self <: IELangSearchDefaults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExpressionsLabel(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expressionsLabel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withExpressionsTooltip(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expressionsTooltip")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMeaningsLabel(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("meaningsLabel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMeaningsTooltip(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("meaningsTooltip")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSearchButtonLabel(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("searchButtonLabel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSearchFieldHtml(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("searchFieldHtml")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSearchFormHtml(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("searchFormHtml")(value.asInstanceOf[js.Any])
        ret
    }
  }
