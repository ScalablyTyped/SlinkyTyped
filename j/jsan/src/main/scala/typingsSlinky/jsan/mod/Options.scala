...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInfinity(value: Boolean): Self = this.set("infinity", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNan(value: Boolean): Self = this.set("nan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNan: Self = this.set("nan", js.undefined)
    
    @scala.inline
    def setRefs(value: Boolean): Self = this.set("refs", value.asInstanceOf[js.Any])
