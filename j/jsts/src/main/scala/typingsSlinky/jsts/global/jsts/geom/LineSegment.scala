...
import typingsSlinky.jsts.jstsNumbers.`-1`
import typingsSlinky.jsts.jstsNumbers.`0`
import typingsSlinky.jsts.jstsNumbers.`1`
...
class LineSegment protected ()
  ...
  /* CompleteClass */
  override var p0: typingsSlinky.jsts.jsts.geom.Coordinate = js.native
  /* CompleteClass */
  override var p1: typingsSlinky.jsts.jsts.geom.Coordinate = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def closestPoint(p: typingsSlinky.jsts.jsts.geom.Coordinate): typingsSlinky.jsts.jsts.geom.Coordinate = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def closestPoints(line: typingsSlinky.jsts.jsts.geom.LineSegment): js.Tuple2[typingsSlinky.jsts.jsts.geom.Coordinate, typingsSlinky.jsts.jsts.geom.Coordinate] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def compareTo(o: typingsSlinky.jsts.jsts.geom.LineSegment): Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def distance1(ls: typingsSlinky.jsts.jsts.geom.LineSegment): Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def distance2(p: typingsSlinky.jsts.jsts.geom.Coordinate): Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def distancePerpendicular(p: typingsSlinky.jsts.jsts.geom.Coordinate): Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equals(o: typingsSlinky.jsts.jsts.geom.LineSegment): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equalsTopo(other: typingsSlinky.jsts.jsts.geom.LineSegment): Boolean = js.native
  /**
    * @param {number} i
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def intersection(line: typingsSlinky.jsts.jsts.geom.LineSegment): typingsSlinky.jsts.jsts.geom.Coordinate | Null = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def lineIntersection(line: typingsSlinky.jsts.jsts.geom.LineSegment): typingsSlinky.jsts.jsts.geom.Coordinate | Null = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def midPoint(): typingsSlinky.jsts.jsts.geom.Coordinate = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def orientationIndex1(seg: typingsSlinky.jsts.jsts.geom.LineSegment): `1` | `-1` | `0` = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def orientationIndex2(p: typingsSlinky.jsts.jsts.geom.Coordinate): `1` | `-1` | `0` = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def pointAlong(segmentLengthFraction: Double): typingsSlinky.jsts.jsts.geom.Coordinate = js.native
  /**
    * Computes the {@link Coordinate} that lies a given
    ...
    */
  /* CompleteClass */
  override def pointAlongOffset(segmentLengthFraction: Double, offsetDistance: Double): typingsSlinky.jsts.jsts.geom.Coordinate = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def project1(p: typingsSlinky.jsts.jsts.geom.Coordinate): typingsSlinky.jsts.jsts.geom.Coordinate = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def project2(seg: typingsSlinky.jsts.jsts.geom.LineSegment): typingsSlinky.jsts.jsts.geom.LineSegment = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def projectionFactor(p: typingsSlinky.jsts.jsts.geom.Coordinate): Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def segmentFraction(inputPt: typingsSlinky.jsts.jsts.geom.Coordinate): Double = js.native
  /* CompleteClass */
  override def setCoordinates(ls: typingsSlinky.jsts.jsts.geom.LineSegment): Unit = js.native
  /* CompleteClass */
  override def setCoordinates2(p0: typingsSlinky.jsts.jsts.geom.Coordinate, p1: typingsSlinky.jsts.jsts.geom.Coordinate): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def toGeometry(geomFactory: typingsSlinky.jsts.jsts.geom.GeometryFactory): typingsSlinky.jsts.jsts.geom.LineString = js.native
}
