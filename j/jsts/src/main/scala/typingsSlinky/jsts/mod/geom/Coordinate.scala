...
class Coordinate protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def compareTo(other: typingsSlinky.jsts.jsts.geom.Coordinate): Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def distance(p: typingsSlinky.jsts.jsts.geom.Coordinate): Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equals(other: typingsSlinky.jsts.jsts.geom.Coordinate): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equals2D(other: typingsSlinky.jsts.jsts.geom.Coordinate): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def setCoordinate(other: typingsSlinky.jsts.jsts.geom.Coordinate): Unit = js.native
}
