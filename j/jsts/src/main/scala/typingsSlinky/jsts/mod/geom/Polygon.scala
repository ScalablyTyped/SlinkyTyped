...
class Polygon protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getExteriorRing(): typingsSlinky.jsts.jsts.geom.LinearRing = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getInteriorRingN(n: Double): typingsSlinky.jsts.jsts.geom.LinearRing = js.native
  /**
