...
import typingsSlinky.jsts.jsts.algorithm.BoundaryNodeRule
...
object operation {
  ...
  class GeometryGraphOperation protected ()
    extends typingsSlinky.jsts.jsts.operation.GeometryGraphOperation {
  ...
  object buffer {
    ...
    class BufferOp protected ()
      extends typingsSlinky.jsts.jsts.operation.buffer.BufferOp {
      /**
        ...
        * @constructor
        */
      def this(g: Geometry, bufParams: typingsSlinky.jsts.jsts.operation.buffer.BufferParameters) = this()
    }
    /* static members */
    object BufferOp {
      ...
      @js.native
      def bufferOp2(g: Geometry, distance: Double, params: typingsSlinky.jsts.jsts.operation.buffer.BufferParameters): Geometry = js.native
    ...
    class BufferParameters ()
      extends typingsSlinky.jsts.jsts.operation.buffer.BufferParameters {
  ...
  object relate {
    ...
    class RelateOp protected ()
      extends typingsSlinky.jsts.jsts.operation.relate.RelateOp {
