...
object LineString {
  ...
  implicit class LineStringOps[Self <: LineString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetCoordinateN(value: Double => Coordinate): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCoordinateN")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetEndPoint(value: () => Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getEndPoint")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetPointN(value: Double => Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPointN")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetStartPoint(value: () => Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStartPoint")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsRing(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isRing")(js.Any.fromFunction0(value))
        ret
    }
  }
