...
object Polygon {
  ...
  implicit class PolygonOps[Self <: Polygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetExteriorRing(value: () => LinearRing): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getExteriorRing")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetInteriorRingN(value: Double => LinearRing): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getInteriorRingN")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetNumInteriorRing(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getNumInteriorRing")(js.Any.fromFunction0(value))
        ret
    }
  }
