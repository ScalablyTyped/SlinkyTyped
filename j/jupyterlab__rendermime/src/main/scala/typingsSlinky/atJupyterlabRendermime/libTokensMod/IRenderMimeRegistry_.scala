package typingsSlinky.atJupyterlabRendermime.libTokensMod

import typingsSlinky.atJupyterlabApputils.libSanitizerMod.ISanitizer
import typingsSlinky.atJupyterlabRendermime.atJupyterlabRendermimeStrings.any
import typingsSlinky.atJupyterlabRendermime.atJupyterlabRendermimeStrings.ensure
import typingsSlinky.atJupyterlabRendermime.atJupyterlabRendermimeStrings.prefer
import typingsSlinky.atJupyterlabRendermime.libMimemodelMod.MimeModel
import typingsSlinky.atJupyterlabRendermime.libMimemodelMod.MimeModel.IOptions
import typingsSlinky.atJupyterlabRendermime.libTokensMod.IRenderMimeRegistry.ICloneOptions
...
trait IRenderMimeRegistry_ extends js.Object {
  /**
    ...
    */
  val latexTypesetter: typingsSlinky.atJupyterlabRendermimeDashInterfaces.atJupyterlabRendermimeDashInterfacesMod.IRenderMime.ILatexTypesetter | Null = js.native
  /**
