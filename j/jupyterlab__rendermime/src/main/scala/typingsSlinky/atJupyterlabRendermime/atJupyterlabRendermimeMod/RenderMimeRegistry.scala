...
import typingsSlinky.atJupyterlabRendermime.libRegistryMod.RenderMimeRegistry.IOptions
import typingsSlinky.atJupyterlabRendermime.libRegistryMod.RenderMimeRegistry.IUrlResolverOptions
...
class RenderMimeRegistry ()
  extends typingsSlinky.atJupyterlabRendermime.libRegistryMod.RenderMimeRegistry {
...
object RenderMimeRegistry extends js.Object {
  ...
  class UrlResolver protected ()
    extends typingsSlinky.atJupyterlabRendermime.libRegistryMod.RenderMimeRegistry.UrlResolver {
    /**
