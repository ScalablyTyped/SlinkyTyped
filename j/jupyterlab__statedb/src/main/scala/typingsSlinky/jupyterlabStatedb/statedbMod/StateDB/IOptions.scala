...
object IOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoCoreutils.jsonMod.ReadonlyPartialJSONValue */ T](): IOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IOptions[T]]
  }
  @scala.inline
  implicit class IOptionsOps[Self <: IOptions[_], /* <: typingsSlinky.luminoCoreutils.jsonMod.ReadonlyPartialJSONValue */ T] (val x: Self with IOptions[T]) extends AnyVal {
    @scala.inline
