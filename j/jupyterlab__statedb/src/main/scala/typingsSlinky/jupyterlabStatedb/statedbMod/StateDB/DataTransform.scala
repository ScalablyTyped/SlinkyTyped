...
object DataTransform {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoCoreutils.jsonMod.ReadonlyPartialJSONValue */ T](`type`: cancel | clear | merge | overwrite): DataTransform[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DataTransform[T]]
  }
  @scala.inline
  implicit class DataTransformOps[Self <: DataTransform[_], /* <: typingsSlinky.luminoCoreutils.jsonMod.ReadonlyPartialJSONValue */ T] (val x: Self with DataTransform[T]) extends AnyVal {
    @scala.inline
