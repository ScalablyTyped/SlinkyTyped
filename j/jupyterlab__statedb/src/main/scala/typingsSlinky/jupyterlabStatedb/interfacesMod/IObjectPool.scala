...
object IObjectPool {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ T](
  ...
  @scala.inline
  implicit class IObjectPoolOps[Self <: IObjectPool[_], /* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ T] (val x: Self with IObjectPool[T]) extends AnyVal {
    @scala.inline
