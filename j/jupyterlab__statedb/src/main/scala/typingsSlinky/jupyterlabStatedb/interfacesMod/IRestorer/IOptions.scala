package typingsSlinky.jupyterlabStatedb.interfacesMod.IRestorer
...
object IOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ T](command: String, name: T => String): IOptions[T] = {
    val __obj = js.Dynamic.literal(command = command.asInstanceOf[js.Any], name = js.Any.fromFunction1(name))
    __obj.asInstanceOf[IOptions[T]]
  }
  @scala.inline
  implicit class IOptionsOps[Self <: IOptions[_], /* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ T] (val x: Self with IOptions[T]) extends AnyVal {
    @scala.inline
