package typingsSlinky.jupyterlabStatedb.interfacesMod
...
object IRestorable_ {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ T, U](restore: IOptions[T] => js.Promise[U], restored: js.Promise[U]): IRestorable_[T, U] = {
  ...
  @scala.inline
  implicit class IRestorable_Ops[Self <: IRestorable_[_, _], /* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ T, U] (val x: Self with (IRestorable_[T, U])) extends AnyVal {
    @scala.inline
