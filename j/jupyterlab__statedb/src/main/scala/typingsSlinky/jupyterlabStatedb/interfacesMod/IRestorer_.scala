...
object IRestorer_ {
  @scala.inline
  def apply[/* <: typingsSlinky.jupyterlabStatedb.interfacesMod.IRestorable[U, _] */ T, /* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ U, V](restore: (T, IOptions[U]) => js.Promise[V], restored: js.Promise[V]): IRestorer_[T, U, V] = {
  ...
  @scala.inline
  implicit class IRestorer_Ops[Self <: IRestorer_[_, _, _], /* <: typingsSlinky.jupyterlabStatedb.interfacesMod.IRestorable[U, _] */ T, /* <: typingsSlinky.luminoDisposable.mod.IObservableDisposable */ U, V] (val x: Self with (IRestorer_[T, U, V])) extends AnyVal {
    @scala.inline
