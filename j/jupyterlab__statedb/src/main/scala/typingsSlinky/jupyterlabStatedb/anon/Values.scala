...
object Values {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoCoreutils.jsonMod.ReadonlyPartialJSONValue */ T](ids: js.Array[String], values: js.Array[T]): Values[T] = {
    val __obj = js.Dynamic.literal(ids = ids.asInstanceOf[js.Any], values = values.asInstanceOf[js.Any])
    __obj.asInstanceOf[Values[T]]
  }
  @scala.inline
  implicit class ValuesOps[Self <: Values[_], /* <: typingsSlinky.luminoCoreutils.jsonMod.ReadonlyPartialJSONValue */ T] (val x: Self with Values[T]) extends AnyVal {
    @scala.inline
