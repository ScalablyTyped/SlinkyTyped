...
import typingsSlinky.jupyterlabCompleter.handlerMod.CompletionHandler.IOptions
...
import typingsSlinky.jupyterlabCompleter.widgetMod.Completer.ITextState
...
object handlerMod {
  ...
  object CompletionHandler {
    ...
    @js.native
    val ICompletionItemsResponseType: typingsSlinky.jupyterlabCompleter.jupyterlabCompleterStrings.ICompletionItemsReply = js.native
    ...
    trait ICompleterConnecterResponseType extends StObject {
      ...
      var responseType: typingsSlinky.jupyterlabCompleter.jupyterlabCompleterStrings.ICompletionItemsReply = js.native
    }
    object ICompleterConnecterResponseType {
      
      @scala.inline
      def apply(responseType: typingsSlinky.jupyterlabCompleter.jupyterlabCompleterStrings.ICompletionItemsReply): ICompleterConnecterResponseType = {
      ...
      implicit class ICompleterConnecterResponseTypeMutableBuilder[Self <: ICompleterConnecterResponseType] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setResponseType(value: typingsSlinky.jupyterlabCompleter.jupyterlabCompleterStrings.ICompletionItemsReply): Self = StObject.set(x, "responseType", value.asInstanceOf[js.Any])
      }
    }
