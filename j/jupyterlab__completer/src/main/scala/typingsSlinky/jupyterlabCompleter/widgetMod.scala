...
import typingsSlinky.jupyterlabCompleter.handlerMod.CompletionHandler.ICompletionItem
import typingsSlinky.jupyterlabCompleter.handlerMod.CompletionHandler.ICompletionItems
