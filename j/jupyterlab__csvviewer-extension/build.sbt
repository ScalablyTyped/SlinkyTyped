...
version := "1.2.2-be951e"
scalaVersion := "2.13.1"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.4",
  "org.scalablytyped.slinky" %%% "codemirror" % "0.0-unknown-dt-20200227Z-a27c50",
  "org.scalablytyped.slinky" %%% "csstype" % "2.6.6-89abae",
  "org.scalablytyped.slinky" %%% "estree" % "0.0-unknown-dt-20200225Z-7e1416",
  "org.scalablytyped.slinky" %%% "jupyterlab__application" % "1.2.1-ee409f",
  "org.scalablytyped.slinky" %%% "jupyterlab__apputils" % "1.2.1-ae94fc",
  "org.scalablytyped.slinky" %%% "jupyterlab__attachments" % "1.2.1-72cc59",
  "org.scalablytyped.slinky" %%% "jupyterlab__cells" % "1.2.2-ef0c8a",
  "org.scalablytyped.slinky" %%% "jupyterlab__codeeditor" % "1.2.0-bda77c",
  "org.scalablytyped.slinky" %%% "jupyterlab__codemirror" % "1.2.1-7ffff4",
  "org.scalablytyped.slinky" %%% "jupyterlab__coreutils" % "3.2.0-e6afe6",
  "org.scalablytyped.slinky" %%% "jupyterlab__csvviewer" % "1.2.1-184104",
  "org.scalablytyped.slinky" %%% "jupyterlab__docregistry" % "1.2.1-a28323",
  "org.scalablytyped.slinky" %%% "jupyterlab__documentsearch" % "1.2.2-8e5a3c",
  "org.scalablytyped.slinky" %%% "jupyterlab__fileeditor" % "1.2.1-4e3afb",
  "org.scalablytyped.slinky" %%% "jupyterlab__notebook" % "1.2.2-339722",
  "org.scalablytyped.slinky" %%% "jupyterlab__observables" % "2.4.0-2bae43",
  "org.scalablytyped.slinky" %%% "jupyterlab__outputarea" % "1.2.2-a3553f",
  "org.scalablytyped.slinky" %%% "jupyterlab__rendermime" % "1.2.1-a4d061",
  ...
  "org.scalablytyped.slinky" %%% "phosphor__application" % "1.7.3-dbb392",
  "org.scalablytyped.slinky" %%% "phosphor__commands" % "1.7.2-916dfd",
  "org.scalablytyped.slinky" %%% "phosphor__coreutils" % "1.3.1-033be8",
  "org.scalablytyped.slinky" %%% "phosphor__datagrid" % "0.1.11-101d4f",
  ...
  "org.scalablytyped.slinky" %%% "tern" % "0.23-dt-20191126Z-03ba32")
