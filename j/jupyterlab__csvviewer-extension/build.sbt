...
version := "2.2.7-7e3c1d"
scalaVersion := "2.13.3"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.6",
  "org.scalablytyped.slinky" %%% "codemirror" % "0.0-unknown-dt-20201121Z-033468",
  ...
  "org.scalablytyped.slinky" %%% "jupyterlab__attachments" % "2.2.4-f4984c",
  "org.scalablytyped.slinky" %%% "jupyterlab__cells" % "2.2.7-2f5957",
  "org.scalablytyped.slinky" %%% "jupyterlab__codeeditor" % "2.2.5-1323d8",
  "org.scalablytyped.slinky" %%% "jupyterlab__codemirror" % "2.2.4-28aff9",
  "org.scalablytyped.slinky" %%% "jupyterlab__coreutils" % "4.2.5-5b6788",
  "org.scalablytyped.slinky" %%% "jupyterlab__csvviewer" % "2.2.4-972a7c",
  "org.scalablytyped.slinky" %%% "jupyterlab__docregistry" % "2.2.4-80b2b2",
  "org.scalablytyped.slinky" %%% "jupyterlab__documentsearch" % "2.2.7-8be1b8",
  "org.scalablytyped.slinky" %%% "jupyterlab__fileeditor" % "2.2.4-a20f71",
  "org.scalablytyped.slinky" %%% "jupyterlab__nbformat" % "2.2.5-a224d9",
  "org.scalablytyped.slinky" %%% "jupyterlab__notebook" % "2.2.7-0c6566",
  "org.scalablytyped.slinky" %%% "jupyterlab__observables" % "3.2.5-73ba47",
  "org.scalablytyped.slinky" %%% "jupyterlab__outputarea" % "2.2.4-a18d70",
  ...
  "org.scalablytyped.slinky" %%% "lumino__datagrid" % "0.6.0-306f29",
  ...
  "org.scalablytyped.slinky" %%% "tern" % "0.23-dt-20200515Z-f508c6",
