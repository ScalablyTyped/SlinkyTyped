...
version := "1.2.2-9e7156"
scalaVersion := "2.13.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.5",
  "org.scalablytyped.slinky" %%% "codemirror" % "0.0-unknown-dt-20200410Z-de4b14",
  "org.scalablytyped.slinky" %%% "csstype" % "2.6.6-e9335f",
  "org.scalablytyped.slinky" %%% "estree" % "0.0-unknown-dt-20200320Z-9738bf",
  "org.scalablytyped.slinky" %%% "jupyterlab__application" % "1.2.1-5f5496",
  "org.scalablytyped.slinky" %%% "jupyterlab__apputils" % "1.2.1-669753",
  "org.scalablytyped.slinky" %%% "jupyterlab__attachments" % "1.2.1-517fd5",
  "org.scalablytyped.slinky" %%% "jupyterlab__cells" % "1.2.2-37841b",
  "org.scalablytyped.slinky" %%% "jupyterlab__codeeditor" % "1.2.0-36ba60",
  "org.scalablytyped.slinky" %%% "jupyterlab__codemirror" % "1.2.1-357975",
  "org.scalablytyped.slinky" %%% "jupyterlab__coreutils" % "3.2.0-8bed14",
  "org.scalablytyped.slinky" %%% "jupyterlab__csvviewer" % "1.2.1-2ca7cc",
  "org.scalablytyped.slinky" %%% "jupyterlab__docregistry" % "1.2.1-4413ca",
  "org.scalablytyped.slinky" %%% "jupyterlab__documentsearch" % "1.2.2-9ab0ff",
  "org.scalablytyped.slinky" %%% "jupyterlab__fileeditor" % "1.2.1-cd6345",
  "org.scalablytyped.slinky" %%% "jupyterlab__notebook" % "1.2.2-4ada7f",
  "org.scalablytyped.slinky" %%% "jupyterlab__observables" % "2.4.0-b19348",
  "org.scalablytyped.slinky" %%% "jupyterlab__outputarea" % "1.2.2-c0f8fd",
  ...
  "org.scalablytyped.slinky" %%% "phosphor__application" % "1.7.3-c5f73e",
  "org.scalablytyped.slinky" %%% "phosphor__commands" % "1.7.2-549aa2",
  "org.scalablytyped.slinky" %%% "phosphor__coreutils" % "1.3.1-c22335",
  "org.scalablytyped.slinky" %%% "phosphor__datagrid" % "0.1.11-5bd0e6",
  ...
  "org.scalablytyped.slinky" %%% "tern" % "0.23-dt-20191126Z-8ea2f4")
