...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jupyterlab__csvviewer" % "1.2.1-bc0378",
  "org.scalablytyped.slinky" %%% "jupyterlab__docregistry" % "1.2.1-f88e7d",
  "org.scalablytyped.slinky" %%% "jupyterlab__documentsearch" % "1.2.2-2c80cf",
  ...
  "org.scalablytyped.slinky" %%% "phosphor__datagrid" % "0.1.11-96828f",
