...
object global {
  ...
  object JSONEditor {
    ...
    @js.native
    def focusNode: typingsSlinky.jsoneditoronline.JSONEditorNode = js.native
    @scala.inline
    def focusNode_=(x: typingsSlinky.jsoneditoronline.JSONEditorNode): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("focusNode")(x.asInstanceOf[js.Any])
