package typingsSlinky.jqueryDotFiltertable

import typingsSlinky.jqueryDotFiltertable.FilterTable.FilterTableOptions
import typingsSlinky.jqueryDotFiltertable.FilterTable.FilterTableStatic
