...
object JQueryWindow {
  ...
  object StaticOptions {
    ...
    implicit class StaticOptionsMutableBuilder[Self <: StaticOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDockAreaHTMLElement(value: HTMLElement): Self = StObject.set(x, "dockArea", value.asInstanceOf[js.Any])
  ...
  object WindowOptions {
    ...
    implicit class WindowOptionsMutableBuilder[Self <: WindowOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFooterContentHTMLElement(value: HTMLElement): Self = StObject.set(x, "footerContent", value.asInstanceOf[js.Any])
