...
import typingsSlinky.jshamcrest.Anon_AttachAssertions
import typingsSlinky.jshamcrest.Anon_Scope
...
object Integration extends js.Object {
  ...
  def JsTestDriver(params: Anon_Scope): Unit = js.native
  def JsUnitTest(): Unit = js.native
  def JsUnitTest(params: Anon_Scope): Unit = js.native
  def Nodeunit(): Unit = js.native
  def Nodeunit(params: Anon_Scope): Unit = js.native
  def QUnit(): Unit = js.native
  def QUnit(params: Anon_Scope): Unit = js.native
  def Rhino(): Unit = js.native
  def WebBrowser(): Unit = js.native
  def YUITest(): Unit = js.native
  def YUITest(params: Anon_Scope): Unit = js.native
  ...
  def jasmine(params: Anon_Scope): Unit = js.native
  def jsUnity(): Unit = js.native
  def jsUnity(params: Anon_AttachAssertions): Unit = js.native
  def screwunit(): Unit = js.native
  def screwunit(params: Anon_Scope): Unit = js.native
}
