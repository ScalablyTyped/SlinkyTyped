package typingsSlinky.atJupyterlabFilebrowser.libModelMod

import org.scalajs.dom.raw.File
import typingsSlinky.atJupyterlabDocmanager.libTokensMod.IDocumentManager
import typingsSlinky.atJupyterlabFilebrowser.libModelMod.FileBrowserModel.IOptions
import typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IChangedArgs
...
class FileBrowserModel_ protected () extends IDisposable {
  ...
  /**
    ...
    */
  val connectionFailure: ISignal[this.type, js.Error] = js.native
  /**
  ...
  val uploadChanged: ISignal[
    this.type, 
    typingsSlinky.atJupyterlabCoreutils.libInterfacesMod.IChangedArgs[IUploadModel, String]
  ] = js.native
  /**
    * Change directory.
    *
  ...
  /**
    ...
    */
  def sessions(): IIterator[typingsSlinky.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
  /**
