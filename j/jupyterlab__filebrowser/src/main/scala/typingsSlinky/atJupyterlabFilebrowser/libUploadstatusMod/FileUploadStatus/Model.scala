package typingsSlinky.atJupyterlabFilebrowser.libUploadstatusMod.FileUploadStatus
...
import typingsSlinky.atJupyterlabFilebrowser.libUploadstatusMod.IFileUploadItem
