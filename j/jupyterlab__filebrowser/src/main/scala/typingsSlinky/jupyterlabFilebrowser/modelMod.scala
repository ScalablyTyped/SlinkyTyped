...
object modelMod {
  ...
  object FilterFileBrowserModel {
    ...
    object IOptions {
      ...
      @scala.inline
      def apply(manager: IDocumentManager): typingsSlinky.jupyterlabFilebrowser.modelMod.FilterFileBrowserModel.IOptions = {
        val __obj = js.Dynamic.literal(manager = manager.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.jupyterlabFilebrowser.modelMod.FilterFileBrowserModel.IOptions]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabFilebrowser.modelMod.FilterFileBrowserModel.IOptions] (val x: Self) extends AnyVal {
