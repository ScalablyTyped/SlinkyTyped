...
class FileBrowserModel_ protected () extends IDisposable {
  ...
  val uploadChanged: ISignal[
    this.type, 
    typingsSlinky.jupyterlabCoreutils.interfacesMod.IChangedArgs[IUploadModel, String]
  ] = js.native
  /**
    * Change directory.
    *
  ...
  /**
    ...
    */
  def sessions(): IIterator[typingsSlinky.jupyterlabServices.sessionSessionMod.Session.IModel] = js.native
  /**
