...
trait JQuerySteps extends js.Object {
  /**
    ...
    */
  def add(step: Step): typingsSlinky.jqueryDashSteps.JQuerySteps.JQuerySteps
  /**
  ...
  /**
    ...
    */
  def insert(index: Double, step: Step): typingsSlinky.jqueryDashSteps.JQuerySteps.JQuerySteps
  /**
...
object JQuerySteps {
  @scala.inline
  def apply(
    add: Step => typingsSlinky.jqueryDashSteps.JQuerySteps.JQuerySteps,
    destroy: () => Unit,
    finish: () => Unit,
    getCurrentIndex: () => Double,
    getCurrentStep: () => Step,
    getStep: Double => Step,
    insert: (Double, Step) => typingsSlinky.jqueryDashSteps.JQuerySteps.JQuerySteps,
    next: () => Boolean,
    previous: () => Boolean,
