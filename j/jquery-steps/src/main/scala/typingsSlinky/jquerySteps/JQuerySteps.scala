...
object JQuerySteps {
  ...
  object JQuerySteps {
    ...
    def apply(
      ...
      skip: Double => Boolean
    ): typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps = {
      ...
      __obj.asInstanceOf[typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps]
    }
    
    @scala.inline
    implicit class JQueryStepsMutableBuilder[Self <: typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAdd(value: Step => typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps): Self = StObject.set(x, "add", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setInsert(value: (Double, Step) => typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps): Self = StObject.set(x, "insert", js.Any.fromFunction2(value))
