...
trait JQuerySteps extends js.Object {
  /**
    ...
    */
  def add(step: Step): typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps
  /**
  ...
  /**
    ...
    */
  def insert(index: Double, step: Step): typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps
  /**
