...
object JQuerySteps {
  ...
  implicit class JQueryStepsOps[Self <: typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdd(value: Step => typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps): Self = this.set("add", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setInsert(value: (Double, Step) => typingsSlinky.jquerySteps.JQuerySteps.JQuerySteps): Self = this.set("insert", js.Any.fromFunction2(value))
