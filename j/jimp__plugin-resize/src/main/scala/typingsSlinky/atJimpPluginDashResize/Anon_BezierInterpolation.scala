package typingsSlinky.atJimpPluginDashResize

import typingsSlinky.atJimpPluginDashResize.atJimpPluginDashResizeStrings.bezierInterpolation
import typingsSlinky.atJimpPluginDashResize.atJimpPluginDashResizeStrings.bicubicInterpolation
import typingsSlinky.atJimpPluginDashResize.atJimpPluginDashResizeStrings.bilinearInterpolation
import typingsSlinky.atJimpPluginDashResize.atJimpPluginDashResizeStrings.hermiteInterpolation
import typingsSlinky.atJimpPluginDashResize.atJimpPluginDashResizeStrings.nearestNeighbor
