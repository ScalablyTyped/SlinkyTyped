...
import typingsSlinky.jointjs.jointjsStrings.addClass
import typingsSlinky.jointjs.jointjsStrings.opacity
import typingsSlinky.jointjs.jointjsStrings.stroke
...
object highlighters {
  ...
  @js.native
  def addClass: GenericHighlighter[typingsSlinky.jointjs.jointjsStrings.addClass] = js.native
  @scala.inline
  ...
  @js.native
  def opacity: GenericHighlighter[typingsSlinky.jointjs.jointjsStrings.opacity] = js.native
  @scala.inline
  ...
  @js.native
  def stroke: GenericHighlighter[typingsSlinky.jointjs.jointjsStrings.stroke] = js.native
  @scala.inline
  ...
  */
  ...
  object HighlighterArguments {
    ...
    @scala.inline
    def attrs: typingsSlinky.jointjs.jointjsStrings.attrs = "attrs".asInstanceOf[typingsSlinky.jointjs.jointjsStrings.attrs]
    
    @scala.inline
    def className: typingsSlinky.jointjs.jointjsStrings.className = "className".asInstanceOf[typingsSlinky.jointjs.jointjsStrings.className]
    ...
    @scala.inline
    def rx: typingsSlinky.jointjs.jointjsStrings.rx = "rx".asInstanceOf[typingsSlinky.jointjs.jointjsStrings.rx]
    
    @scala.inline
    def ry: typingsSlinky.jointjs.jointjsStrings.ry = "ry".asInstanceOf[typingsSlinky.jointjs.jointjsStrings.ry]
  }
