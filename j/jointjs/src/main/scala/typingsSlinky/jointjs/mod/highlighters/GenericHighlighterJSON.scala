...
object GenericHighlighterJSON {
  @scala.inline
  def apply[/* <: typingsSlinky.jointjs.mod.highlighters.HighlighterType */ K](name: K): GenericHighlighterJSON[K] = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[GenericHighlighterJSON[K]]
  }
  @scala.inline
  implicit class GenericHighlighterJSONOps[Self <: GenericHighlighterJSON[_], /* <: typingsSlinky.jointjs.mod.highlighters.HighlighterType */ K] (val x: Self with GenericHighlighterJSON[K]) extends AnyVal {
    @scala.inline
