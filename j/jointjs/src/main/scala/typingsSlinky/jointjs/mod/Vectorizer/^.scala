...
object ^ extends js.Object {
  ...
  def convertCircleToPathData(circle: typingsSlinky.jointjs.mod.Vectorizer): String = js.native
  ...
  def ensureId(node: typingsSlinky.jointjs.mod.Vectorizer): String = js.native
  ...
  def getPointsFromSvgNode(node: typingsSlinky.jointjs.mod.Vectorizer): js.Array[SVGPoint] = js.native
  ...
  def toNode(el: typingsSlinky.jointjs.mod.Vectorizer): SVGElement = js.native
