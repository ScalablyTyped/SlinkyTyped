...
import typingsSlinky.jointjs.jointjsStrings.connectionClosest
import typingsSlinky.jointjs.jointjsStrings.connectionLength
import typingsSlinky.jointjs.jointjsStrings.connectionPerpendicular
import typingsSlinky.jointjs.jointjsStrings.connectionRatio
...
object linkAnchors {
  ...
  @js.native
  def connectionClosest: GenericAnchor[typingsSlinky.jointjs.jointjsStrings.connectionClosest] = js.native
  @scala.inline
  ...
  @js.native
  def connectionLength: GenericAnchor[typingsSlinky.jointjs.jointjsStrings.connectionLength] = js.native
  @scala.inline
  ...
  @js.native
  def connectionPerpendicular: GenericAnchor[typingsSlinky.jointjs.jointjsStrings.connectionPerpendicular] = js.native
  @scala.inline
  ...
  @js.native
  def connectionRatio: GenericAnchor[typingsSlinky.jointjs.jointjsStrings.connectionRatio] = js.native
  @scala.inline
