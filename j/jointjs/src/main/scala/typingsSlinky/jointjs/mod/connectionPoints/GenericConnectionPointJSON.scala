...
object GenericConnectionPointJSON {
  @scala.inline
  def apply[/* <: typingsSlinky.jointjs.mod.connectionPoints.ConnectionPointType */ K](name: K): GenericConnectionPointJSON[K] = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[GenericConnectionPointJSON[K]]
  }
  @scala.inline
  implicit class GenericConnectionPointJSONOps[Self <: GenericConnectionPointJSON[_], /* <: typingsSlinky.jointjs.mod.connectionPoints.ConnectionPointType */ K] (val x: Self with GenericConnectionPointJSON[K]) extends AnyVal {
    @scala.inline
