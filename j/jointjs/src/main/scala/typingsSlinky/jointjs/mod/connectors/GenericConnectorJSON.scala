...
object GenericConnectorJSON {
  @scala.inline
  def apply[/* <: typingsSlinky.jointjs.mod.connectors.ConnectorType */ K](name: K): GenericConnectorJSON[K] = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[GenericConnectorJSON[K]]
  }
  @scala.inline
  implicit class GenericConnectorJSONOps[Self <: GenericConnectorJSON[_], /* <: typingsSlinky.jointjs.mod.connectors.ConnectorType */ K] (val x: Self with GenericConnectorJSON[K]) extends AnyVal {
    @scala.inline
