...
class Element_ () extends Cell {
  ...
  def portProp(portId: String, path: js.Any): Element = js.native
  def portProp(portId: String, path: js.Any, value: js.Any): Element = js.native
  def portProp(portId: String, path: js.Any, value: js.Any, opt: typingsSlinky.jointjs.mod.dia.Cell.Options): Element = js.native
