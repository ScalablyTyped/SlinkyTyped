...
import typingsSlinky.jointjs.anon.Ellipsis
import typingsSlinky.jointjs.anon.Height
import typingsSlinky.jointjs.anon.Margin
import typingsSlinky.jointjs.anon.Scale
import typingsSlinky.jointjs.anon.Y
import typingsSlinky.jointjs.jointjsStrings.blur
import typingsSlinky.jointjs.jointjsStrings.brightness
import typingsSlinky.jointjs.jointjsStrings.contrast
import typingsSlinky.jointjs.jointjsStrings.dropShadow
import typingsSlinky.jointjs.jointjsStrings.grayscale
import typingsSlinky.jointjs.jointjsStrings.highlight
import typingsSlinky.jointjs.jointjsStrings.hueRotate
import typingsSlinky.jointjs.jointjsStrings.invert
import typingsSlinky.jointjs.jointjsStrings.outline
import typingsSlinky.jointjs.jointjsStrings.saturate
import typingsSlinky.jointjs.jointjsStrings.sepia
...
import typingsSlinky.jointjs.mod.dia.PaddingJSON
...
object util {
  ...
  object filter {
    ...
    @js.native
    def blur: FilterFunction[typingsSlinky.jointjs.jointjsStrings.blur] = js.native
    @scala.inline
    ...
    @js.native
    def brightness: FilterFunction[typingsSlinky.jointjs.jointjsStrings.brightness] = js.native
    @scala.inline
    ...
    @js.native
    def contrast: FilterFunction[typingsSlinky.jointjs.jointjsStrings.contrast] = js.native
    @scala.inline
    ...
    @js.native
    def dropShadow: FilterFunction[typingsSlinky.jointjs.jointjsStrings.dropShadow] = js.native
    @scala.inline
    ...
    @js.native
    def grayscale: FilterFunction[typingsSlinky.jointjs.jointjsStrings.grayscale] = js.native
    @scala.inline
    ...
    @js.native
    def highlight: FilterFunction[typingsSlinky.jointjs.jointjsStrings.highlight] = js.native
    @scala.inline
    ...
    @js.native
    def hueRotate: FilterFunction[typingsSlinky.jointjs.jointjsStrings.hueRotate] = js.native
    @scala.inline
    ...
    @js.native
    def invert: FilterFunction[typingsSlinky.jointjs.jointjsStrings.invert] = js.native
    @scala.inline
    ...
    @js.native
    def outline: FilterFunction[typingsSlinky.jointjs.jointjsStrings.outline] = js.native
    @scala.inline
    ...
    @js.native
    def saturate: FilterFunction[typingsSlinky.jointjs.jointjsStrings.saturate] = js.native
    @scala.inline
    ...
    @js.native
    def sepia: FilterFunction[typingsSlinky.jointjs.jointjsStrings.sepia] = js.native
    @scala.inline
  ...
  @js.native
  def imageToDataUri(url: String, callback: js.Function2[/* err */ js.Error | Null, /* dataUri */ String, Unit]): Unit = js.native
  ...
  @js.native
  def parseCssNumeric(`val`: js.Any, restrictUnits: String): typingsSlinky.jointjs.anon.Unit | Null = js.native
  @JSImport("jointjs", "util.parseCssNumeric")
  @js.native
  def parseCssNumeric(`val`: js.Any, restrictUnits: js.Array[String]): typingsSlinky.jointjs.anon.Unit | Null = js.native
