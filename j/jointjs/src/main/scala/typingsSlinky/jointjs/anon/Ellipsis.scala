...
object Ellipsis {
  ...
  implicit class EllipsisMutableBuilder[Self <: Ellipsis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHyphen(value: String | js.RegExp): Self = StObject.set(x, "hyphen", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHyphenRegExp(value: js.RegExp): Self = StObject.set(x, "hyphen", value.asInstanceOf[js.Any])
