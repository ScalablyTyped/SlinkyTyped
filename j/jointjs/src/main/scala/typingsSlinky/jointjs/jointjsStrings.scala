...
import typingsSlinky.jointjs.mod.dia.Direction
import typingsSlinky.jointjs.mod.dia.LinkEnd
import typingsSlinky.jointjs.mod.dia.OrthogonalDirection
import typingsSlinky.jointjs.mod.g.CardinalDirection
import typingsSlinky.jointjs.mod.g.RectangleSide
import typingsSlinky.jointjs.mod.g.SegmentType
import typingsSlinky.jointjs.mod.highlighters.HighlighterArguments
import typingsSlinky.jointjs.mod.highlighters.HighlighterType
