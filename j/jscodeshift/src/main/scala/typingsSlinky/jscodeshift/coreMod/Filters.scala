...
object Filters {
  ...
  implicit class FiltersOps[Self <: Filters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVariableDeclarator(value: typingsSlinky.jscodeshift.variableDeclaratorMod.FilterMethods): Self = this.set("VariableDeclarator", value.asInstanceOf[js.Any])
  }
}
