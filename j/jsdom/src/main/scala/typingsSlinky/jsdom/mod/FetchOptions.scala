...
object FetchOptions {
  ...
  implicit class FetchOptionsOps[Self <: FetchOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElementHTMLScriptElement(value: HTMLScriptElement): Self = this.set("element", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setElementHTMLImageElement(value: HTMLImageElement): Self = this.set("element", value.asInstanceOf[js.Any])
    @scala.inline
    def setElementHTMLLinkElement(value: HTMLLinkElement): Self = this.set("element", value.asInstanceOf[js.Any])
    @scala.inline
    def setElementHTMLIFrameElement(value: HTMLIFrameElement): Self = this.set("element", value.asInstanceOf[js.Any])
    @scala.inline
