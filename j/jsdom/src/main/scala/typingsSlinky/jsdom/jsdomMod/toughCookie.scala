...
object toughCookie extends js.Object {
  ...
  object MemoryCookieStore
    extends TopLevel[
          Instantiable0[typingsSlinky.toughDashCookie.toughDashCookieMod.MemoryCookieStore]
        ]
  
  @js.native
  object Store
    extends TopLevel[Instantiable0[typingsSlinky.toughDashCookie.toughDashCookieMod.Store]]
