...
import typingsSlinky.jsdom.TypeofClassCookie
import typingsSlinky.jsdom.TypeofClassCookieJar
import typingsSlinky.toughDashCookie.toughDashCookieMod.Cookie
...
object toughCookie extends js.Object {
  ...
  class MemoryCookieStore ()
    extends typingsSlinky.toughDashCookie.toughDashCookieMod.MemoryCookieStore
  
  @js.native
  class Store ()
    extends typingsSlinky.toughDashCookie.toughDashCookieMod.Store
  
  var Cookie: js.Any | TypeofClassCookie = js.native
  var CookieJar: js.Any | TypeofClassCookieJar = js.native
  var MemoryCookieStore: Instantiable0[typingsSlinky.toughDashCookie.toughDashCookieMod.MemoryCookieStore] = js.native
  var Store: Instantiable0[typingsSlinky.toughDashCookie.toughDashCookieMod.Store] = js.native
