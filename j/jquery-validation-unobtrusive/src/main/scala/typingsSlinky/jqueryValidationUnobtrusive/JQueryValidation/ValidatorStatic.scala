package typingsSlinky.jqueryValidationUnobtrusive.JQueryValidation
...
object ValidatorStatic {
  ...
  implicit class ValidatorStaticOps[Self <: ValidatorStatic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUnobtrusive(value: Validator): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unobtrusive")(value.asInstanceOf[js.Any])
        ret
    }
  }
