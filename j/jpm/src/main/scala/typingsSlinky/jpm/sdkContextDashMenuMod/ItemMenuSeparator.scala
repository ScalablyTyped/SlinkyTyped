package typingsSlinky.jpm.sdkContextDashMenuMod
...
/* Rewritten from type alias, can be one of: 
  - typings.jpm.sdkContextDashMenuMod.Item
  - typings.jpm.sdkContextDashMenuMod.Menu
  - typings.jpm.sdkContextDashMenuMod.Separator
*/
...
object ItemMenuSeparator {
  ...
  def Menu(
    ...
    parentMenu: typingsSlinky.jpm.sdkContextDashMenuMod.Menu = null
  ): ItemMenuSeparator = {
