...
object AnonBadge {
  @scala.inline
  def apply(icon: Icon, id: String, label: String): AnonBadge = {
  ...
  implicit class AnonBadgeOps[Self <: AnonBadge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnChange(value: /* state */ ActionButtonState => _): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnClick(value: /* state */ ActionButton => _): Self = {
        val ret = this.duplicate
