...
object contextMenuMod {
  ...
  object Item {
    ...
    implicit class ItemMutableBuilder[Self <: Item] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setImageURL(value: URL): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object ItemMenuSeparator {
    ...
    @scala.inline
    def Item(context: ItemContext, data: js.Any, destroy: () => Unit, image: String | URL, label: String): typingsSlinky.jpm.contextMenuMod.Item = {
      ...
      __obj.asInstanceOf[typingsSlinky.jpm.contextMenuMod.Item]
    }
    ...
    def Menu(
      ...
      __obj.asInstanceOf[typingsSlinky.jpm.contextMenuMod.Menu]
    }
    
    @scala.inline
    def Separator(destroy: () => Unit, parentMenu: Menu): typingsSlinky.jpm.contextMenuMod.Separator = {
      val __obj = js.Dynamic.literal(destroy = js.Any.fromFunction0(destroy), parentMenu = parentMenu.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.jpm.contextMenuMod.Separator]
    }
  }
}
