...
object CredentialonCompleteanyon {
  @scala.inline
  def apply(password: String, username: String): CredentialonCompleteanyon = {
    val __obj = js.Dynamic.literal(password = password.asInstanceOf[js.Any], username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[CredentialonCompleteanyon]
  }
  @scala.inline
  implicit class CredentialonCompleteanyonOps[Self <: CredentialonCompleteanyon] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOnComplete(value: () => _): Self = {
        val ret = this.duplicate
