...
object currencyMod extends Shortcut {
  ...
  @JSImport("js-money/lib/currency", JSImport.Namespace)
  @js.native
  ...
  object Currencies {
    ...
    def apply(
      ...
      val __obj = js.Dynamic.literal(AED = AED.asInstanceOf[js.Any], AFN = AFN.asInstanceOf[js.Any], ALL = ALL.asInstanceOf[js.Any], AMD = AMD.asInstanceOf[js.Any], ARS = ARS.asInstanceOf[js.Any], AUD = AUD.asInstanceOf[js.Any], AZN = AZN.asInstanceOf[js.Any], BAM = BAM.asInstanceOf[js.Any], BDT = BDT.asInstanceOf[js.Any], BGN = BGN.asInstanceOf[js.Any], BHD = BHD.asInstanceOf[js.Any], BIF = BIF.asInstanceOf[js.Any], BND = BND.asInstanceOf[js.Any], BOB = BOB.asInstanceOf[js.Any], BRL = BRL.asInstanceOf[js.Any], BTC = BTC.asInstanceOf[js.Any], BWP = BWP.asInstanceOf[js.Any], BYR = BYR.asInstanceOf[js.Any], BZD = BZD.asInstanceOf[js.Any], CAD = CAD.asInstanceOf[js.Any], CDF = CDF.asInstanceOf[js.Any], CHF = CHF.asInstanceOf[js.Any], CLP = CLP.asInstanceOf[js.Any], CNY = CNY.asInstanceOf[js.Any], COP = COP.asInstanceOf[js.Any], CRC = CRC.asInstanceOf[js.Any], CVE = CVE.asInstanceOf[js.Any], CZK = CZK.asInstanceOf[js.Any], DJF = DJF.asInstanceOf[js.Any], DKK = DKK.asInstanceOf[js.Any], DOP = DOP.asInstanceOf[js.Any], DZD = DZD.asInstanceOf[js.Any], EEK = EEK.asInstanceOf[js.Any], EGP = EGP.asInstanceOf[js.Any], ERN = ERN.asInstanceOf[js.Any], ETB = ETB.asInstanceOf[js.Any], EUR = EUR.asInstanceOf[js.Any], GBP = GBP.asInstanceOf[js.Any], GEL = GEL.asInstanceOf[js.Any], GHS = GHS.asInstanceOf[js.Any], GNF = GNF.asInstanceOf[js.Any], GTQ = GTQ.asInstanceOf[js.Any], HKD = HKD.asInstanceOf[js.Any], HNL = HNL.asInstanceOf[js.Any], HRK = HRK.asInstanceOf[js.Any], HUF = HUF.asInstanceOf[js.Any], IDR = IDR.asInstanceOf[js.Any], ILS = ILS.asInstanceOf[js.Any], INR = INR.asInstanceOf[js.Any], IQD = IQD.asInstanceOf[js.Any], IRR = IRR.asInstanceOf[js.Any], ISK = ISK.asInstanceOf[js.Any], JMD = JMD.asInstanceOf[js.Any], JOD = JOD.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], KES = KES.asInstanceOf[js.Any], KHR = KHR.asInstanceOf[js.Any], KMF = KMF.asInstanceOf[js.Any], KRW = KRW.asInstanceOf[js.Any], KWD = KWD.asInstanceOf[js.Any], KZT = KZT.asInstanceOf[js.Any], LAK = LAK.asInstanceOf[js.Any], LBP = LBP.asInstanceOf[js.Any], LKR = LKR.asInstanceOf[js.Any], LTL = LTL.asInstanceOf[js.Any], LVL = LVL.asInstanceOf[js.Any], LYD = LYD.asInstanceOf[js.Any], MAD = MAD.asInstanceOf[js.Any], MDL = MDL.asInstanceOf[js.Any], MGA = MGA.asInstanceOf[js.Any], MKD = MKD.asInstanceOf[js.Any], MMK = MMK.asInstanceOf[js.Any], MOP = MOP.asInstanceOf[js.Any], MUR = MUR.asInstanceOf[js.Any], MXN = MXN.asInstanceOf[js.Any], MYR = MYR.asInstanceOf[js.Any], MZN = MZN.asInstanceOf[js.Any], NAD = NAD.asInstanceOf[js.Any], NGN = NGN.asInstanceOf[js.Any], NIO = NIO.asInstanceOf[js.Any], NOK = NOK.asInstanceOf[js.Any], NPR = NPR.asInstanceOf[js.Any], NZD = NZD.asInstanceOf[js.Any], OMR = OMR.asInstanceOf[js.Any], PAB = PAB.asInstanceOf[js.Any], PEN = PEN.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], PKR = PKR.asInstanceOf[js.Any], PLN = PLN.asInstanceOf[js.Any], PYG = PYG.asInstanceOf[js.Any], QAR = QAR.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], RSD = RSD.asInstanceOf[js.Any], RUB = RUB.asInstanceOf[js.Any], RWF = RWF.asInstanceOf[js.Any], SAR = SAR.asInstanceOf[js.Any], SDG = SDG.asInstanceOf[js.Any], SEK = SEK.asInstanceOf[js.Any], SGD = SGD.asInstanceOf[js.Any], SOS = SOS.asInstanceOf[js.Any], SYP = SYP.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TND = TND.asInstanceOf[js.Any], TOP = TOP.asInstanceOf[js.Any], TRY = TRY.asInstanceOf[js.Any], TTD = TTD.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], TZS = TZS.asInstanceOf[js.Any], UAH = UAH.asInstanceOf[js.Any], UGX = UGX.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], UYU = UYU.asInstanceOf[js.Any], UZS = UZS.asInstanceOf[js.Any], VEF = VEF.asInstanceOf[js.Any], VND = VND.asInstanceOf[js.Any], XAF = XAF.asInstanceOf[js.Any], XOF = XOF.asInstanceOf[js.Any], YER = YER.asInstanceOf[js.Any], ZAR = ZAR.asInstanceOf[js.Any], ZMK = ZMK.asInstanceOf[js.Any])
