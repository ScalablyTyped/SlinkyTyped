package typingsSlinky.jestDashHasteDashMap.buildLibFSEventsWatcherMod

import typingsSlinky.jestDashHasteDashMap.Anon_Dot
...
class ^ protected () extends FSEventsWatcher {
  def this(dir: String, opts: Anon_Dot) = this()
}
