...
object HasteMap {
  ...
  def apply(
    ...
    _whitelist: js.Any,
    _worker: js.Any,
    build: () => js.Promise[typingsSlinky.jestHasteMap.typesMod.HasteMap],
    end: () => js.Promise[Unit],
  ...
  implicit class HasteMapOps[Self <: HasteMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBuild(value: () => js.Promise[typingsSlinky.jestHasteMap.typesMod.HasteMap]): Self = this.set("build", js.Any.fromFunction0(value))
    @scala.inline
