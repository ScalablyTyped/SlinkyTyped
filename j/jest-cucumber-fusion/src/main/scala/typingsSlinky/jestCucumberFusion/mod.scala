package typingsSlinky.jestCucumberFusion
...
object mod extends js.Object {
  ...
  def Given(name: js.RegExp, callback: CallBack): Unit = js.native
  
  def Then(name: String, callback: CallBack): Unit = js.native
  def Then(name: js.RegExp, callback: CallBack): Unit = js.native
  
  def When(name: String, callback: CallBack): Unit = js.native
  def When(name: js.RegExp, callback: CallBack): Unit = js.native
