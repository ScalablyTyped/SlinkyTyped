...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.mn
...
object mnMod extends Shortcut {
  ...
  @JSImport("javascript-time-ago/locale/mn", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: mn): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `mnMod.foo` */
