package typingsSlinky.javascriptTimeAgo.svMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.sv
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: sv): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
