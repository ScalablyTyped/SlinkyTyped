package typingsSlinky.javascriptTimeAgo.zuMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.zu
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: zu): Self = this.set("locale", value.asInstanceOf[js.Any])
