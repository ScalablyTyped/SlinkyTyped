package typingsSlinky.javascriptTimeAgo.arMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.ar
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ar): Self = this.set("locale", value.asInstanceOf[js.Any])
