package typingsSlinky.javascriptTimeAgo.hiMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.few
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.hi
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: hi): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
