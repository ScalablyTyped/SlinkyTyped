package typingsSlinky.javascriptTimeAgo.seMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.se
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: se): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
