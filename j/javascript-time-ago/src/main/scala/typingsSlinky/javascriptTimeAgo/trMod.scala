...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.tr
...
object trMod extends Shortcut {
  ...
  @JSImport("javascript-time-ago/locale/tr", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: tr): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `trMod.foo` */
