package typingsSlinky.javascriptTimeAgo.brMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.br
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: br): Self = this.set("locale", value.asInstanceOf[js.Any])
