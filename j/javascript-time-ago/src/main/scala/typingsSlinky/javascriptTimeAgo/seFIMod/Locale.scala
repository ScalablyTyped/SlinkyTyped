package typingsSlinky.javascriptTimeAgo.seFIMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.`se-FI`
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: `se-FI`): Self = this.set("locale", value.asInstanceOf[js.Any])
