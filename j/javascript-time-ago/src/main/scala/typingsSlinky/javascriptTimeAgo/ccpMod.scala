...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.ccp
...
object ccpMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/ccp", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: ccp): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `ccpMod.foo` */
