package typingsSlinky.javascriptTimeAgo.asMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.as
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: as): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
