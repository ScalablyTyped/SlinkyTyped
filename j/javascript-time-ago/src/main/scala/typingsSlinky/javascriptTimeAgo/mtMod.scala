...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.mt
...
object mtMod extends Shortcut {
  ...
  @JSImport("javascript-time-ago/locale/mt", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: mt): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `mtMod.foo` */
