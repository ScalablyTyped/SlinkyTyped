...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.sw
...
object swMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/sw", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: sw): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `swMod.foo` */
