...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.bn
...
object bnMod extends Shortcut {
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: bn): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `bnMod.foo` */
