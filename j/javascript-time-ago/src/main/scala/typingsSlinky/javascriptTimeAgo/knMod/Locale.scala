...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.kn
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: kn): Self = this.set("locale", value.asInstanceOf[js.Any])
