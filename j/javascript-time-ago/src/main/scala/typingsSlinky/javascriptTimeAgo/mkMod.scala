...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.mk
...
object mkMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/mk", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: mk): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `mkMod.foo` */
