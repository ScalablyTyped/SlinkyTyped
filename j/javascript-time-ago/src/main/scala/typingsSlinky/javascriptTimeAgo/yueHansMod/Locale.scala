package typingsSlinky.javascriptTimeAgo.yueHansMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.`yue-Hans`
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: `yue-Hans`): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
