package typingsSlinky.javascriptTimeAgo.slMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.sl
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: sl): Self = this.set("locale", value.asInstanceOf[js.Any])
