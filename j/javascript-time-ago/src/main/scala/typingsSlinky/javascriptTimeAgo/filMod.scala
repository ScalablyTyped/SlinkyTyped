...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.fil
...
object filMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/fil", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: fil): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `filMod.foo` */
