...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.gu
...
object guMod extends Shortcut {
  ...
  @JSImport("javascript-time-ago/locale/gu", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: gu): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `guMod.foo` */
