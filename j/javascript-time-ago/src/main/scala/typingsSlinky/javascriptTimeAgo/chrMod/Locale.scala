package typingsSlinky.javascriptTimeAgo.chrMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.chr
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: chr): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
