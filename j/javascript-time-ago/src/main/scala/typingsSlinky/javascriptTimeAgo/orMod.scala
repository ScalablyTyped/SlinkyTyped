...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.or
...
object orMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/or", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: or): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `orMod.foo` */
