package typingsSlinky.javascriptTimeAgo.ptMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.pt
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: pt): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
