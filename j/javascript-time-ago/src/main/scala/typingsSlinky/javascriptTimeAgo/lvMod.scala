...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.lv
...
object lvMod extends Shortcut {
  ...
  @JSImport("javascript-time-ago/locale/lv", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: lv): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `lvMod.foo` */
