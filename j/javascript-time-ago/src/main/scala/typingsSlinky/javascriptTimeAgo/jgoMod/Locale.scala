package typingsSlinky.javascriptTimeAgo.jgoMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.few
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.jgo
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: jgo): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
