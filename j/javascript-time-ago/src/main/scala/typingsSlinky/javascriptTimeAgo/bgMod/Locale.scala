package typingsSlinky.javascriptTimeAgo.bgMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.bg
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: bg): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
