...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.`zh-Hant`
...
object zhHantMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/zh-Hant", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: `zh-Hant`): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `zhHantMod.foo` */
