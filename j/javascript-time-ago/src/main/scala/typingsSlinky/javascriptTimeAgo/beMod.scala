...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.be
...
object beMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/be", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: be): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `beMod.foo` */
