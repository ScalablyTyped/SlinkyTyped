...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.ti
...
object tiMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/ti", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: ti): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `tiMod.foo` */
