...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.sr
...
object srMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/sr", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: sr): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `srMod.foo` */
