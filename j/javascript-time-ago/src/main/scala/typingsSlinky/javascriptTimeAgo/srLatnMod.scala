...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.`sr-Latn`
...
object srLatnMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/sr-Latn", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: `sr-Latn`): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `srLatnMod.foo` */
