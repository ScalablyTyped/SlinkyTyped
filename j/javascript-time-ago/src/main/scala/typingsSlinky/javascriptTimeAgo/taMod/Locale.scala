package typingsSlinky.javascriptTimeAgo.taMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.ta
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ta): Self = this.set("locale", value.asInstanceOf[js.Any])
