package typingsSlinky.javascriptTimeAgo.roMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.ro
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ro): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
