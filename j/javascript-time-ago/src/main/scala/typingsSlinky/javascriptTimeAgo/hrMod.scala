...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.hr
...
object hrMod extends Shortcut {
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: hr): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `hrMod.foo` */
