...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.fur
...
object furMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/fur", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: fur): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `furMod.foo` */
