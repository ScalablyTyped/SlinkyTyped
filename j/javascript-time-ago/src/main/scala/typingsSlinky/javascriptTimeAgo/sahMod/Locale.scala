package typingsSlinky.javascriptTimeAgo.sahMod
...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.sah
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: sah): Self = this.set("locale", value.asInstanceOf[js.Any])
