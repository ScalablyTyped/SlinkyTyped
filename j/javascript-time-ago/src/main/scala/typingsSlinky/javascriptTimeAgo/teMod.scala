...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.te
...
object teMod extends Shortcut {
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: te): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
