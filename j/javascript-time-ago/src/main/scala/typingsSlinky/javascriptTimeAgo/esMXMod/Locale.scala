package typingsSlinky.javascriptTimeAgo.esMXMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.`es-MX`
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: `es-MX`): Self = this.set("locale", value.asInstanceOf[js.Any])
