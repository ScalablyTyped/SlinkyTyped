...
import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.gd
...
object gdMod extends Shortcut {
  ...
  @JSImport("javascript-time-ago/locale/gd", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    implicit class LocaleMutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocale(value: gd): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `gdMod.foo` */
