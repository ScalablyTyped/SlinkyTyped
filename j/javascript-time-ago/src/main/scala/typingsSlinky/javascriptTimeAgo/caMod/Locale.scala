package typingsSlinky.javascriptTimeAgo.caMod

import typingsSlinky.javascriptTimeAgo.javascriptTimeAgoStrings.ca
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ca): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
