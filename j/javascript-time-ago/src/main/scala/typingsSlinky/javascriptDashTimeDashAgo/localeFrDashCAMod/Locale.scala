package typingsSlinky.javascriptDashTimeDashAgo.localeFrDashCAMod

import typingsSlinky.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`fr-CA`
