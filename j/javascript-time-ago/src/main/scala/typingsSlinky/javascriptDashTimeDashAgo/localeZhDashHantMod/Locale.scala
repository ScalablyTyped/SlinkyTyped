package typingsSlinky.javascriptDashTimeDashAgo.localeZhDashHantMod

import typingsSlinky.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`zh-Hant`
