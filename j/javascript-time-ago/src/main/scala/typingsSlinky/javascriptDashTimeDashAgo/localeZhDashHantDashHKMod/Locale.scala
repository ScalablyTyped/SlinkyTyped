package typingsSlinky.javascriptDashTimeDashAgo.localeZhDashHantDashHKMod

import typingsSlinky.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`zh-Hant-HK`
