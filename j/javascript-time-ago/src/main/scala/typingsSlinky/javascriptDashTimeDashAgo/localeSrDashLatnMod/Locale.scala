package typingsSlinky.javascriptDashTimeDashAgo.localeSrDashLatnMod

import typingsSlinky.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`sr-Latn`
