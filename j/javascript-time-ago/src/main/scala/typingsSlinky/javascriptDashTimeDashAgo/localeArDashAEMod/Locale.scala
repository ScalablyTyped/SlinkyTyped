package typingsSlinky.javascriptDashTimeDashAgo.localeArDashAEMod

import typingsSlinky.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`ar-AE`
