package typingsSlinky.javascriptDashTimeDashAgo.localeUrDashINMod

import typingsSlinky.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`ur-IN`
