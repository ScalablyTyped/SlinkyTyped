...
import typingsSlinky.jiraDashClient.jiraDashClientStrings.`false`
import typingsSlinky.jiraDashClient.jiraDashClientStrings.`true`
import typingsSlinky.jiraDashClient.jiraDashClientStrings.active
import typingsSlinky.jiraDashClient.jiraDashClientStrings.closed
import typingsSlinky.jiraDashClient.jiraDashClientStrings.future
