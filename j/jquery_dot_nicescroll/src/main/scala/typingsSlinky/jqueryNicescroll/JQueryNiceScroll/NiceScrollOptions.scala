...
object NiceScrollOptions {
  ...
  def apply(
    ...
    cursordragspeed: js.UndefOr[Double] = js.undefined,
    cursorfixedheight: js.UndefOr[Double] = js.undefined,
    cursorminheight: js.UndefOr[Double] = js.undefined,
    cursoropacitymax: js.UndefOr[Double] = js.undefined,
    cursoropacitymin: js.UndefOr[Double] = js.undefined,
    cursorwidth: String = null,
    dblclickzoom: js.UndefOr[Boolean] = js.undefined,
    directionlockdeadzone: js.UndefOr[Double] = js.undefined,
    ...
    hidecursordelay: js.UndefOr[Double] = js.undefined,
    ...
    mousescrollstep: js.UndefOr[Double] = js.undefined,
    ...
    railhoffset: Boolean | Left = null,
    railoffset: Boolean | Left = null,
    railpadding: Bottom = null,
    ...
    if (!js.isUndefined(bouncescroll)) __obj.updateDynamic("bouncescroll")(bouncescroll.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(cursordragontouch)) __obj.updateDynamic("cursordragontouch")(cursordragontouch.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cursordragspeed)) __obj.updateDynamic("cursordragspeed")(cursordragspeed.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cursorfixedheight)) __obj.updateDynamic("cursorfixedheight")(cursorfixedheight.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cursorminheight)) __obj.updateDynamic("cursorminheight")(cursorminheight.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cursoropacitymax)) __obj.updateDynamic("cursoropacitymax")(cursoropacitymax.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cursoropacitymin)) __obj.updateDynamic("cursoropacitymin")(cursoropacitymin.get.asInstanceOf[js.Any])
    if (cursorwidth != null) __obj.updateDynamic("cursorwidth")(cursorwidth.asInstanceOf[js.Any])
    if (!js.isUndefined(dblclickzoom)) __obj.updateDynamic("dblclickzoom")(dblclickzoom.get.asInstanceOf[js.Any])
    if (!js.isUndefined(directionlockdeadzone)) __obj.updateDynamic("directionlockdeadzone")(directionlockdeadzone.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(disableoutline)) __obj.updateDynamic("disableoutline")(disableoutline.get.asInstanceOf[js.Any])
    if (!js.isUndefined(emulatetouch)) __obj.updateDynamic("emulatetouch")(emulatetouch.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablekeyboard)) __obj.updateDynamic("enablekeyboard")(enablekeyboard.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablemouselockapi)) __obj.updateDynamic("enablemouselockapi")(enablemouselockapi.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablemousewheel)) __obj.updateDynamic("enablemousewheel")(enablemousewheel.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableobserver)) __obj.updateDynamic("enableobserver")(enableobserver.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablescrollonselection)) __obj.updateDynamic("enablescrollonselection")(enablescrollonselection.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enabletranslate3d)) __obj.updateDynamic("enabletranslate3d")(enabletranslate3d.get.asInstanceOf[js.Any])
    if (!js.isUndefined(gesturezoom)) __obj.updateDynamic("gesturezoom")(gesturezoom.get.asInstanceOf[js.Any])
    if (!js.isUndefined(grabcursorenabled)) __obj.updateDynamic("grabcursorenabled")(grabcursorenabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hidecursordelay)) __obj.updateDynamic("hidecursordelay")(hidecursordelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(horizrailenabled)) __obj.updateDynamic("horizrailenabled")(horizrailenabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hwacceleration)) __obj.updateDynamic("hwacceleration")(hwacceleration.get.asInstanceOf[js.Any])
    if (!js.isUndefined(iframeautoresize)) __obj.updateDynamic("iframeautoresize")(iframeautoresize.get.asInstanceOf[js.Any])
    if (!js.isUndefined(mousescrollstep)) __obj.updateDynamic("mousescrollstep")(mousescrollstep.get.asInstanceOf[js.Any])
    if (!js.isUndefined(nativeparentscrolling)) __obj.updateDynamic("nativeparentscrolling")(nativeparentscrolling.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(preservenativescrolling)) __obj.updateDynamic("preservenativescrolling")(preservenativescrolling.get.asInstanceOf[js.Any])
    if (!js.isUndefined(preventmultitouchscrolling)) __obj.updateDynamic("preventmultitouchscrolling")(preventmultitouchscrolling.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(sensitiverail)) __obj.updateDynamic("sensitiverail")(sensitiverail.get.asInstanceOf[js.Any])
    if (!js.isUndefined(smoothscroll)) __obj.updateDynamic("smoothscroll")(smoothscroll.get.asInstanceOf[js.Any])
    if (!js.isUndefined(spacebarenabled)) __obj.updateDynamic("spacebarenabled")(spacebarenabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(touchbehavior)) __obj.updateDynamic("touchbehavior")(touchbehavior.get.asInstanceOf[js.Any])
