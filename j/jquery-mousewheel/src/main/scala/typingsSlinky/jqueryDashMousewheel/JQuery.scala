...
import typingsSlinky.jqueryDashMousewheel.JQueryMousewheel.JQueryMousewheelEventObject
import typingsSlinky.jqueryDashMousewheel.jqueryDashMousewheelStrings.mousewheel
