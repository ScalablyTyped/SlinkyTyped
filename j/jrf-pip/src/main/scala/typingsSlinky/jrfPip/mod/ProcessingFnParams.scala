...
@js.native
trait ProcessingFnParams[T] extends js.Object {
...
object ProcessingFnParams {
  ...
  @scala.inline
  implicit class ProcessingFnParamsOps[Self <: ProcessingFnParams[_], T] (val x: Self with ProcessingFnParams[T]) extends AnyVal {
