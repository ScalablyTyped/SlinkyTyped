...
object JenkinsClientOptions {
  ...
  implicit class JenkinsClientOptionsOps[Self <: JenkinsClientOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPromisifyFunction1(value: /* repeated */ js.Any => _): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("promisify")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPromisify(value: Boolean | (js.Function1[/* repeated */ js.Any, _])): Self = {
        val ret = this.duplicate
