...
object Cancel {
  ...
  implicit class CancelOps[Self <: Cancel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCancel(value: (Double, js.Function1[/* err */ js.Error, Unit]) => Unit): Self = this.set("cancel", js.Any.fromFunction2(value))
    
    @scala.inline
    def setItem(value: (Double, js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]) => Unit): Self = this.set("item", js.Any.fromFunction2(value))
    
    @scala.inline
    def setList(value: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit] => Unit): Self = this.set("list", js.Any.fromFunction1(value))
  }
}
