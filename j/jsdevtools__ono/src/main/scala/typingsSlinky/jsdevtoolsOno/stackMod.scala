...
import typingsSlinky.jsdevtoolsOno.jsdevtoolsOnoBooleans.`true`
...
object stackMod {
  ...
  @JSImport("@jsdevtools/ono/esm/stack", "isLazyStack")
  @js.native
  def isLazyStack(stackProp: js.PropertyDescriptor): /* is @jsdevtools/ono.@jsdevtools/ono/esm/stack.LazyStack */ Boolean = js.native
  ...
  @JSImport("@jsdevtools/ono/esm/stack", "isWritableStack")
  @js.native
  def isWritableStack(stackProp: js.PropertyDescriptor): Boolean = js.native
