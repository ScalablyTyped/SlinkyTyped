package typingsSlinky.jsdevtoolsOno.anon
...
object Message {
  @scala.inline
  def apply[/* <: typingsSlinky.jsdevtoolsOno.typesMod.ErrorLike */ E, /* <: js.Object */ P](message: String): Message[E, P] = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[Message[E, P]]
  }
  @scala.inline
  implicit class MessageOps[Self <: Message[_, _], /* <: typingsSlinky.jsdevtoolsOno.typesMod.ErrorLike */ E, /* <: js.Object */ P] (val x: Self with (Message[E, P])) extends AnyVal {
    @scala.inline
