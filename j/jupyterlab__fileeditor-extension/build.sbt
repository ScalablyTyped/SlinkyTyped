...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jupyterlab__console" % "2.2.7-9399a5",
  "org.scalablytyped.slinky" %%% "jupyterlab__coreutils" % "4.2.5-5b6788",
  "org.scalablytyped.slinky" %%% "jupyterlab__docmanager" % "2.2.4-0754ce",
  "org.scalablytyped.slinky" %%% "jupyterlab__docregistry" % "2.2.4-80b2b2",
  "org.scalablytyped.slinky" %%% "jupyterlab__filebrowser" % "2.2.5-bc5635",
  "org.scalablytyped.slinky" %%% "jupyterlab__fileeditor" % "2.2.4-a20f71",
  "org.scalablytyped.slinky" %%% "jupyterlab__launcher" % "2.2.6-d25fee",
  "org.scalablytyped.slinky" %%% "jupyterlab__mainmenu" % "2.2.4-a20879",
