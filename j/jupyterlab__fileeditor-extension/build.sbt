...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "jupyterlab__console" % "1.2.2-de5c44",
  "org.scalablytyped.slinky" %%% "jupyterlab__coreutils" % "3.2.0-c162bd",
  "org.scalablytyped.slinky" %%% "jupyterlab__docmanager" % "1.2.1-da5ded",
  "org.scalablytyped.slinky" %%% "jupyterlab__docregistry" % "1.2.1-dfe435",
  "org.scalablytyped.slinky" %%% "jupyterlab__filebrowser" % "1.2.1-64431b",
  "org.scalablytyped.slinky" %%% "jupyterlab__fileeditor" % "1.2.1-510022",
  "org.scalablytyped.slinky" %%% "jupyterlab__launcher" % "1.2.1-fda331",
  "org.scalablytyped.slinky" %%% "jupyterlab__mainmenu" % "1.2.1-5b2fc9",
  ...
  "org.scalablytyped.slinky" %%% "jupyterlab__ui-components" % "1.2.1-4ba428",
