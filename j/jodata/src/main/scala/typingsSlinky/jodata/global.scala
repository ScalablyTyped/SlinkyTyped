...
object global {
  ...
  object jo {
    ...
    @js.native
    def loadLocal: js.Function1[/* key */ js.UndefOr[String], typingsSlinky.jodata.jo] = js.native
    @scala.inline
    def loadLocal_=(x: js.Function1[/* key */ js.UndefOr[String], typingsSlinky.jodata.jo]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("loadLocal")(x.asInstanceOf[js.Any])
