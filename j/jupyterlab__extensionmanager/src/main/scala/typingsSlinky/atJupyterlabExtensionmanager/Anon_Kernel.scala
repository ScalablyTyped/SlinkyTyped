...
import typingsSlinky.atJupyterlabExtensionmanager.libCompanionsMod.IInstallInfo
import typingsSlinky.atJupyterlabExtensionmanager.libCompanionsMod.IKernelInstallInfo
