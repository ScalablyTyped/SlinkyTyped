package typingsSlinky.atJupyterlabExtensionmanager.libQueryMod

import typingsSlinky.atJupyterlabExtensionmanager.libCompanionsMod.IJupyterLabPackageData
