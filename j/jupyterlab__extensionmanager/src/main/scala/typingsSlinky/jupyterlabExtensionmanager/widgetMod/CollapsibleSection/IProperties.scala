...
object IProperties {
  ...
  implicit class IPropertiesOps[Self <: IProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeaderElementsReactElement(value: ReactElement): Self = this.set("headerElements", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHeaderElements(value: ReactElement): Self = this.set("headerElements", value.asInstanceOf[js.Any])
