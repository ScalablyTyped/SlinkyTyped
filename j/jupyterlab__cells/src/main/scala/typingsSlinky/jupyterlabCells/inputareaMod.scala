  ...
  object InputArea {
    ...
    object ContentFactory {
      ...
      object IOptions {
        ...
        @scala.inline
        def apply(): typingsSlinky.jupyterlabCells.inputareaMod.InputArea.ContentFactory.IOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsSlinky.jupyterlabCells.inputareaMod.InputArea.ContentFactory.IOptions]
        }
        
        @scala.inline
        implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabCells.inputareaMod.InputArea.ContentFactory.IOptions] (val x: Self) extends AnyVal {
