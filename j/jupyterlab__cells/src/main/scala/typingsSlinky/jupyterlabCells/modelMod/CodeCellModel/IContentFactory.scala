...
object IContentFactory {
  ...
  implicit class IContentFactoryOps[Self <: IContentFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateOutputArea(value: typingsSlinky.jupyterlabOutputarea.modelMod.IOutputAreaModel.IOptions => IOutputAreaModel): Self = this.set("createOutputArea", js.Any.fromFunction1(value))
  }
}
