...
object CellDragUtils extends js.Object {
  /**
    ...
    */
  def createCellDragImage(activeCell: typingsSlinky.atJupyterlabCells.libWidgetMod.Cell, selectedCells: js.Array[ICell]): HTMLElement = js.native
  /**
    ...
    */
  def detectTargetArea(cell: typingsSlinky.atJupyterlabCells.libWidgetMod.Cell, target: HTMLElement): ICellTargetArea = js.native
  /**
  ...
  def findCell(
    node: HTMLElement,
    cells: IterableOrArrayLike[typingsSlinky.atJupyterlabCells.libWidgetMod.Cell],
