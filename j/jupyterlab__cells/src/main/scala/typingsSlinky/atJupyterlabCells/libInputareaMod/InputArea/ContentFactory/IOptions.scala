package typingsSlinky.atJupyterlabCells.libInputareaMod.InputArea.ContentFactory
...
object IOptions {
  @scala.inline
  def apply(
    editorFactory: /* options */ typingsSlinky.atJupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions => IEditor = null
  ): IOptions = {
