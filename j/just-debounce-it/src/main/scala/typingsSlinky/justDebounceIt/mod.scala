package typingsSlinky.justDebounceIt

import typingsSlinky.justDebounceIt.justDebounceItBooleans.`false`
import typingsSlinky.justDebounceIt.justDebounceItBooleans.`true`
import typingsSlinky.justDebounceIt.justDebounceItNumbers.`0`
