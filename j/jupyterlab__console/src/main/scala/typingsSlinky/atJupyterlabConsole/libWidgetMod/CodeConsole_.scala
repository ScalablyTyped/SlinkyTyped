package typingsSlinky.atJupyterlabConsole.libWidgetMod
...
import typingsSlinky.atJupyterlabConsole.libWidgetMod.CodeConsole.IModelFactory
import typingsSlinky.atJupyterlabConsole.libWidgetMod.CodeConsole.IOptions
import typingsSlinky.atJupyterlabCoreutils.libNbformatMod.nbformat.ICodeCell
import typingsSlinky.atJupyterlabObservables.libObservablelistMod.IObservableList
...
class CodeConsole_ protected () extends Widget {
  ...
  /**
    ...
    */
  val executed: ISignal[this.type, js.Date] = js.native
  /**
