  ...
  object ConsolePanel {
    ...
    object IContentFactory {
      ...
      implicit class IContentFactoryMutableBuilder[Self <: IContentFactory] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreateConsole(value: typingsSlinky.jupyterlabConsole.widgetMod.CodeConsole.IOptions => CodeConsole): Self = StObject.set(x, "createConsole", js.Any.fromFunction1(value))
      }
    }
