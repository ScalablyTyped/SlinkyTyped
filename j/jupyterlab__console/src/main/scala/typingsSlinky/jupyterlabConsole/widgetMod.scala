...
import typingsSlinky.jupyterlabNbformat.mod.ICodeCell
  ...
  object CodeConsole {
    ...
    object IContentFactory {
      ...
      implicit class IContentFactoryMutableBuilder[Self <: IContentFactory] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreateCodeCell(value: typingsSlinky.jupyterlabCells.widgetMod.CodeCell.IOptions => CodeCell): Self = StObject.set(x, "createCodeCell", js.Any.fromFunction1(value))
        
        @scala.inline
        def setCreateRawCell(value: typingsSlinky.jupyterlabCells.widgetMod.RawCell.IOptions => RawCell): Self = StObject.set(x, "createRawCell", js.Any.fromFunction1(value))
      }
    }
