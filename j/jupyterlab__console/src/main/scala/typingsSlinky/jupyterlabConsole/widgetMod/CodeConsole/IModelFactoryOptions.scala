...
trait IModelFactoryOptions extends js.Object {
  /**
    ...
    */
  var codeCellContentFactory: js.UndefOr[typingsSlinky.jupyterlabCells.modelMod.CodeCellModel.IContentFactory] = js.undefined
}

object IModelFactoryOptions {
  @scala.inline
  def apply(
    codeCellContentFactory: typingsSlinky.jupyterlabCells.modelMod.CodeCellModel.IContentFactory = null
