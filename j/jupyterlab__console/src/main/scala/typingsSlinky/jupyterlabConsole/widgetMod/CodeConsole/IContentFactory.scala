...
object IContentFactory {
  ...
  implicit class IContentFactoryOps[Self <: IContentFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateCodeCell(value: typingsSlinky.jupyterlabCells.widgetMod.CodeCell.IOptions => CodeCell): Self = this.set("createCodeCell", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCreateRawCell(value: typingsSlinky.jupyterlabCells.widgetMod.RawCell.IOptions => RawCell): Self = this.set("createRawCell", js.Any.fromFunction1(value))
  }
}
