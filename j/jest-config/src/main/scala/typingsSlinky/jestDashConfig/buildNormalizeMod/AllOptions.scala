package typingsSlinky.jestDashConfig.buildNormalizeMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atJestTypes.Anon_Config
import typingsSlinky.atJestTypes.buildConfigMod.ConfigGlobals
import typingsSlinky.atJestTypes.buildConfigMod.CoverageThreshold
import typingsSlinky.atJestTypes.buildConfigMod.DisplayName
import typingsSlinky.atJestTypes.buildConfigMod.Glob
import typingsSlinky.atJestTypes.buildConfigMod.HasteConfig
import typingsSlinky.atJestTypes.buildConfigMod.NotifyMode
import typingsSlinky.atJestTypes.buildConfigMod.Path
import typingsSlinky.atJestTypes.buildConfigMod.ReporterConfig
import typingsSlinky.atJestTypes.buildConfigMod.SnapshotUpdateState
import typingsSlinky.jestDashConfig.jestDashConfigStrings.`json-summary`
import typingsSlinky.jestDashConfig.jestDashConfigStrings.`text-lcov`
import typingsSlinky.jestDashConfig.jestDashConfigStrings.`text-summary`
import typingsSlinky.jestDashConfig.jestDashConfigStrings.clover
import typingsSlinky.jestDashConfig.jestDashConfigStrings.cobertura
import typingsSlinky.jestDashConfig.jestDashConfigStrings.fake
import typingsSlinky.jestDashConfig.jestDashConfigStrings.html
import typingsSlinky.jestDashConfig.jestDashConfigStrings.json_
import typingsSlinky.jestDashConfig.jestDashConfigStrings.lcovonly
import typingsSlinky.jestDashConfig.jestDashConfigStrings.none
import typingsSlinky.jestDashConfig.jestDashConfigStrings.real
import typingsSlinky.jestDashConfig.jestDashConfigStrings.teamcity
import typingsSlinky.jestDashConfig.jestDashConfigStrings.text
