...
object defaultMod {
  ...
  - typingsSlinky.jupyterlabDocregistry.registryMod.DocumentRegistry.ICodeModel because var conflicts: mimeType, mimeTypeChanged. Inlined  */ @JSImport("@jupyterlab/docregistry/lib/default", "DocumentModel")
  @js.native
  /**
