...
object contextMod {
  ...
  class Context[T /* <: IModel */] protected () extends IContext[T] {
    ...
    def contentsModel_MContext: typingsSlinky.jupyterlabServices.contentsMod.Contents.IModel | Null = js.native
    ...
    /**
      ...
      */
    @JSName("fileChanged")
    def fileChanged_MContext: ISignal[this.type, typingsSlinky.jupyterlabServices.contentsMod.Contents.IModel] = js.native
