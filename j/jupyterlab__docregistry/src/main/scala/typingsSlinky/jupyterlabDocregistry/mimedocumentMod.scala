...
import typingsSlinky.jupyterlabDocregistry.defaultMod.DocumentWidget
...
object mimedocumentMod {
  ...
  class MimeDocument protected () extends DocumentWidget[MimeContent, IModel] {
    def this(options: typingsSlinky.jupyterlabDocregistry.defaultMod.DocumentWidget.IOptions[MimeContent, IModel]) = this()
  }
  ...
  class MimeDocumentFactory protected () extends ABCWidgetFactory[MimeDocument, IModel] {
    /**
      ...
      */
    def this(options: typingsSlinky.jupyterlabDocregistry.mimedocumentMod.MimeDocumentFactory.IOptions[MimeDocument]) = this()
  ...
  object MimeDocumentFactory {
    ...
    object IOptions {
      ...
      @scala.inline
      def apply[T /* <: MimeDocument */](fileTypes: js.Array[String], name: String, rendermime: IRenderMimeRegistry): typingsSlinky.jupyterlabDocregistry.mimedocumentMod.MimeDocumentFactory.IOptions[T] = {
        ...
        __obj.asInstanceOf[typingsSlinky.jupyterlabDocregistry.mimedocumentMod.MimeDocumentFactory.IOptions[T]]
      }
      
      @scala.inline
      implicit class IOptionsMutableBuilder[Self <: typingsSlinky.jupyterlabDocregistry.mimedocumentMod.MimeDocumentFactory.IOptions[_], T /* <: MimeDocument */] (val x: Self with typingsSlinky.jupyterlabDocregistry.mimedocumentMod.MimeDocumentFactory.IOptions[T]) extends AnyVal {
