package typingsSlinky.jupyterlabDocregistry.contextMod

import typingsSlinky.jupyterlabApputils.mod.SessionContext
...
class Context_[T /* <: IModel */] protected () extends IContext[T] {
  ...
  def contentsModel_MContext_ : typingsSlinky.jupyterlabServices.contentsMod.Contents.IModel | Null = js.native
  ...
  /**
    ...
    */
  @JSName("fileChanged")
  def fileChanged_MContext_ : ISignal[this.type, typingsSlinky.jupyterlabServices.contentsMod.Contents.IModel] = js.native
