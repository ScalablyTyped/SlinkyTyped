...
object IModel {
  ...
  implicit class IModelOps[Self <: IModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStateChanged(value: ISignal[IModel, typingsSlinky.jupyterlabCoreutils.interfacesMod.IChangedArgs[_, _, String]]): Self = this.set("stateChanged", value.asInstanceOf[js.Any])
