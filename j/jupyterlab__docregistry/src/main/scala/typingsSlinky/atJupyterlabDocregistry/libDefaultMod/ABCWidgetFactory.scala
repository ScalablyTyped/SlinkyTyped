package typingsSlinky.atJupyterlabDocregistry.libDefaultMod
...
import typingsSlinky.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.IWidgetFactory
