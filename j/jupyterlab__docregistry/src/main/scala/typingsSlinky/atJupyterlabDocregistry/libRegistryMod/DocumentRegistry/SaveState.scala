...
object SaveState {
  ...
  @scala.inline
  def completed: typingsSlinky.atJupyterlabDocregistry.atJupyterlabDocregistryStrings.completed = this.cast("completed")
  @scala.inline
  def failed: typingsSlinky.atJupyterlabDocregistry.atJupyterlabDocregistryStrings.failed = this.cast("failed")
  @scala.inline
  def started: typingsSlinky.atJupyterlabDocregistry.atJupyterlabDocregistryStrings.started = this.cast("started")
}
