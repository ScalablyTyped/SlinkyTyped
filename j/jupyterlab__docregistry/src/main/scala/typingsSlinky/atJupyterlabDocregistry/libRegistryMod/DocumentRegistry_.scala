package typingsSlinky.atJupyterlabDocregistry.libRegistryMod

import typingsSlinky.atJupyterlabApputils.libClientsessionMod.IClientSession.IKernelPreference
import typingsSlinky.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.IChangedArgs
import typingsSlinky.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.IFileType
import typingsSlinky.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.IOptions
import typingsSlinky.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.ModelFactory
import typingsSlinky.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.WidgetExtension
import typingsSlinky.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.WidgetFactory
...
class DocumentRegistry_ () extends IDisposable {
  ...
  def getKernelPreference(
    path: String,
    widgetName: String,
    kernel: Partial[typingsSlinky.atJupyterlabServices.libKernelKernelMod.Kernel.IModel]
