...
trait IContext[T /* <: IModel */] extends IDisposable {
  /**
    ...
    */
  val contentsModel: typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IModel | Null = js.native
  /**
  ...
  /**
    ...
    */
  var fileChanged: ISignal[this.type, typingsSlinky.atJupyterlabServices.libContentsMod.Contents.IModel] = js.native
  /**
