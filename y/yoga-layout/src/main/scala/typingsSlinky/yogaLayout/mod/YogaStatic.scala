...
object YogaStatic {
  ...
  implicit class YogaStaticOps[Self <: YogaStatic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfig(value: ConfigStatic): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Config")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNode(value: NodeStatic): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Node")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetInstanceCount(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getInstanceCount")(js.Any.fromFunction0(value))
        ret
    }
  }
