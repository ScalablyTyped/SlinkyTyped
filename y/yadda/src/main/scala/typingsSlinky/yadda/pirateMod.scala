...
object pirateMod extends Shortcut {
  
  @JSImport("yadda/lib/localisation/Pirate", JSImport.Namespace)
  @js.native
  ...
  /* This means you don't have to write `^`, but can instead just say `pirateMod.foo` */
