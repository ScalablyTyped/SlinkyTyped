package typingsSlinky.yadda.libLibraryMod

import typingsSlinky.std.Error
import typingsSlinky.std.RegExp
import typingsSlinky.yadda.libMacroMod.Options
...
@js.native
trait Library
  extends typingsSlinky.yadda.libLocalisationLanguageMod.Library {
  ...
  def define(
    ...
    macro_context: typingsSlinky.yadda.libContextMod.^
  ): this.type = js.native
  def define(
    signatures: String,
    fn: js.ThisFunction0[/* this */ StepFn, Unit],
