...
object ICircleOptions {
  ...
  implicit class ICircleOptionsOps[Self <: ICircleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCircleOverlayFunction3(
      value: (/* geometry */ IPixelCircleGeometry, /* data */ js.Object, /* options */ js.Object) => js.Promise[IOverlay]
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("circleOverlay")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withCircleOverlay(
      value: String | (js.Function3[
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("circleOverlay")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCircleOverlay: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("circleOverlay")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStrokeColor(value: (js.Array[js.Array[String] | String]) | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStrokeOpacity(value: (js.Array[js.Array[Double] | Double]) | Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStrokeWidth(value: (js.Array[js.Array[Double] | Double]) | Double): Self = {
        val ret = this.duplicate
