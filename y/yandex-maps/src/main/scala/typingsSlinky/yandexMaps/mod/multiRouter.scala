...
object multiRouter {
  ...
  object masstransit {
    ...
    class PathModel () extends IEventEmitter {
      ...
      var route: typingsSlinky.yandexMaps.mod.multiRouter.masstransit.RouteModel = js.native
    ...
    class Route () extends IGeoObject[IGeometry] {
      ...
      var model: typingsSlinky.yandexMaps.mod.multiRouter.masstransit.RouteModel = js.native
