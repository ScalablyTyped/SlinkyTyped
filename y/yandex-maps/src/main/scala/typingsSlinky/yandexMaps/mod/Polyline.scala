...
class Polyline protected ()
  ...
  def this(geometry: js.Array[js.Array[Double]], properties: js.Object) = this()
  def this(geometry: js.Array[js.Array[Double]], properties: IDataManager) = this()
  ...
  def this(
    geometry: js.Array[js.Array[Double]],
  ...
  def this(geometry: js.Object, properties: js.UndefOr[scala.Nothing], options: IPolylineOptions) = this()
  ...
  def this(geometry: ILineStringGeometry, properties: js.UndefOr[scala.Nothing], options: IPolylineOptions) = this()
