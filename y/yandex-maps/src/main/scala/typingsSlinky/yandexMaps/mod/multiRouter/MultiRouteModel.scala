...
import typingsSlinky.yandexMaps.mod.multiRouter.driving.RouteModel
...
class MultiRouteModel protected () extends IEventEmitter {
  ...
  def getRoutes(): js.Array[RouteModel | typingsSlinky.yandexMaps.mod.multiRouter.masstransit.RouteModel] = js.native
