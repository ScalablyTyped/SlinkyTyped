...
object IMapCheckZoomRangeOptions {
  ...
  implicit class IMapCheckZoomRangeOptionsOps[Self <: IMapCheckZoomRangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckZoomRange(value: Boolean): Self = this.set("checkZoomRange", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCheckZoomRange: Self = this.set("checkZoomRange", js.undefined)
  }
