...
import typingsSlinky.yandexDashMaps.yandexDashMapsStrings.yandexNumbersignairPanorama
import typingsSlinky.yandexDashMaps.yandexDashMapsStrings.yandexNumbersignpanorama
