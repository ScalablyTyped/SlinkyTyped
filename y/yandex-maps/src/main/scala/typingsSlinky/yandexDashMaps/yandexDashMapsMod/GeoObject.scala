...
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.event.Manager
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.geoObject.Hint
...
class GeoObject () extends IGeoObject {
  ...
  var balloon: typingsSlinky.yandexDashMaps.yandexDashMapsMod.geoObject.Balloon = js.native
  ...
  @JSName("options")
  var options_GeoObject: typingsSlinky.yandexDashMaps.yandexDashMapsMod.option.Manager = js.native
  @JSName("properties")
  var properties_GeoObject: typingsSlinky.yandexDashMaps.yandexDashMapsMod.data.Manager = js.native
  @JSName("state")
  var state_GeoObject: typingsSlinky.yandexDashMaps.yandexDashMapsMod.data.Manager = js.native
  /* CompleteClass */
