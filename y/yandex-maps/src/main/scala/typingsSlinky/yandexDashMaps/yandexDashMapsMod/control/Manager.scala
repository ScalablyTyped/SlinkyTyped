...
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.ControlKey
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.IControl
...
class Manager protected () extends js.Object {
  ...
  var events: typingsSlinky.yandexDashMaps.yandexDashMapsMod.event.Manager = js.native
  var options: typingsSlinky.yandexDashMaps.yandexDashMapsMod.option.Manager = js.native
