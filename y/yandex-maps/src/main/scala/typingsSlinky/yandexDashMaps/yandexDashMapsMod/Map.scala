...
import typingsSlinky.yandexDashMaps.Anon_TrafficImageZIndex
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.Container
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.Converter
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.Copyrights
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.GeoObjects
...
class Map protected () extends IEventEmitter {
  ...
  var balloon: typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.Balloon = js.native
  var behaviors: typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.behavior.Manager = js.native
  var container: Container = js.native
  var controls: typingsSlinky.yandexDashMaps.yandexDashMapsMod.control.Manager = js.native
  var converter: Converter = js.native
  var copyrights: Copyrights = js.native
  var cursors: typingsSlinky.yandexDashMaps.yandexDashMapsMod.util.cursor.Manager = js.native
  /* CompleteClass */
  override var events: IEventManager = js.native
  @JSName("events")
  var events_Map: typingsSlinky.yandexDashMaps.yandexDashMapsMod.event.Manager = js.native
  var geoObjects: GeoObjects = js.native
  var hint: Hint = js.native
  var layers: typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.layer.Manager = js.native
  var margin: typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.margin.Manager = js.native
  var options: typingsSlinky.yandexDashMaps.yandexDashMapsMod.option.Manager = js.native
  var panes: typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.pane.Manager = js.native
  ...
  def getPanoramaManager(): js.Promise[typingsSlinky.yandexDashMaps.yandexDashMapsMod.panorama.Manager] = js.native
...
object map extends js.Object {
  ...
  class Balloon protected ()
    extends IBalloonManager[typingsSlinky.yandexDashMaps.yandexDashMapsMod.map.Balloon] {
