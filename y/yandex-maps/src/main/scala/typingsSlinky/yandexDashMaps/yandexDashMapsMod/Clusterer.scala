...
import typingsSlinky.yandexDashMaps.yandexDashMapsMod.clusterer.Hint
...
class Clusterer ()
  ...
  var balloon: typingsSlinky.yandexDashMaps.yandexDashMapsMod.clusterer.Balloon = js.native
  /* CompleteClass */
