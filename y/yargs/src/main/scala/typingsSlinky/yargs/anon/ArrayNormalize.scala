...
@js.native
trait ArrayNormalize extends js.Object {
...
object ArrayNormalize {
  @scala.inline
  def apply(array: `true`, normalize: `true`): ArrayNormalize = {
  ...
  @scala.inline
  implicit class ArrayNormalizeOps[Self <: ArrayNormalize] (val x: Self) extends AnyVal {
    @scala.inline
