...
package object yargsMod {
  ...
  type Defined[T, K /* <: String */] = (Omit[T, K]) with typingsSlinky.yargs.yargsStrings.Defined with T
  ...
  type ParseCallback[T] = js.Function3[/* err */ js.UndefOr[js.Error], /* argv */ Arguments[T], /* output */ String, Unit]
