package typingsSlinky.yauzlDashPromise
...
object yauzlDashPromiseMod extends js.Object {
  @js.native
  class Entry ()
    extends typingsSlinky.yauzl.yauzlMod.Entry {
  ...
  abstract class RandomAccessReader ()
    extends typingsSlinky.yauzl.yauzlMod.RandomAccessReader
  
  @js.native
  class ZipFile protected () extends EventEmitter {
    def this(
      reader: typingsSlinky.yauzl.yauzlMod.RandomAccessReader,
  ...
  def fromRandomAccessReader(reader: typingsSlinky.yauzl.yauzlMod.RandomAccessReader, totalSize: Double): js.Promise[ZipFile] = js.native
  def fromRandomAccessReader(reader: typingsSlinky.yauzl.yauzlMod.RandomAccessReader, totalSize: Double, options: Options): js.Promise[ZipFile] = js.native
