package typingsSlinky.yeomanDashAssert.yeomanDashAssertMod
...
object assertMod extends js.Object {
  ...
  /**
    ...
    * assert.fileContent('models/user.js', 'App.User = DS.Model.extend');
    */
  def fileContent(file: String | js.Array[String], reg: String | js.RegExp): Unit = js.native
  /**
  ...
  /**
    ...
    * assert.noFileContent('models/user.js', 'App.User = DS.Model.extend');
    */
  def noFileContent(file: String | js.Array[String], reg: js.RegExp | String): Unit = js.native
  /**
