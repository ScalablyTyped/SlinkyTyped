...
object mod extends Shortcut {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var array: js.UndefOr[js.Array[typingsSlinky.yargsParser.anon.Boolean | String]] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArray(value: js.Array[typingsSlinky.yargsParser.anon.Boolean | String]): Self = StObject.set(x, "array", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setArrayUndefined: Self = StObject.set(x, "array", js.undefined)
      
      @scala.inline
      def setArrayVarargs(value: (typingsSlinky.yargsParser.anon.Boolean | String)*): Self = StObject.set(x, "array", js.Array(value :_*))
