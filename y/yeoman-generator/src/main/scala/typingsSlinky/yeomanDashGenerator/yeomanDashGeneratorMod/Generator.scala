...
import typingsSlinky.yeomanDashGenerator.Anon_Adapter
import typingsSlinky.yeomanDashGenerator.Anon_Git
import typingsSlinky.yeomanDashGenerator.Anon_Link
