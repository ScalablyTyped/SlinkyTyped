...
object ArgumentConfig {
  ...
  implicit class ArgumentConfigOps[Self <: ArgumentConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(
      value: (StringConstructor with Instantiable0[typingsSlinky.std.global.String]) | (NumberConstructor with Instantiable0[Number]) | (ArrayConstructor with (Instantiable1[/* arrayLength */ Double, js.Array[js.Object]])) | (ObjectConstructor with Instantiable0[js.Object])
