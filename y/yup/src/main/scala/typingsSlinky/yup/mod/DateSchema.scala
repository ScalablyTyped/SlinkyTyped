...
@js.native
trait DateSchema[T /* <: js.UndefOr[js.Date | String | Null] */, C] extends Schema[T, C] {
  ...
  def max(limit: js.Date): DateSchema[T, C] = js.native
  def max(limit: js.Date, message: js.UndefOr[TestOptionsMessage[`1`, _]]): DateSchema[T, C] = js.native
  ...
  def min(limit: js.Date): DateSchema[T, C] = js.native
  def min(limit: js.Date, message: js.UndefOr[TestOptionsMessage[`0`, _]]): DateSchema[T, C] = js.native
