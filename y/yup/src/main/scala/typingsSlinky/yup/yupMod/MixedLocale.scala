...
import typingsSlinky.yup.Anon_Values
...
trait MixedLocale extends js.Object {
  ...
  var notOneOf: js.UndefOr[TestOptionsMessage[Anon_Values, _]] = js.undefined
  var notType: js.UndefOr[LocaleValue] = js.undefined
  var oneOf: js.UndefOr[TestOptionsMessage[Anon_Values, _]] = js.undefined
...
object MixedLocale {
  ...
  def apply(
    ...
    notOneOf: TestOptionsMessage[Anon_Values, _] = null,
    notType: LocaleValue = null,
    oneOf: TestOptionsMessage[Anon_Values, _] = null,
