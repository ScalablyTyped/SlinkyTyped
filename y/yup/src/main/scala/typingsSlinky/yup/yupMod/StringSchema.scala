...
import typingsSlinky.yup.Anon_ExcludeEmptyString
import typingsSlinky.yup.Anon_Length
...
trait StringSchema[T /* <: js.UndefOr[String | Null] */] extends Schema[T] {
  ...
  def matches(regex: js.RegExp, messageOrOptions: Anon_ExcludeEmptyString): StringSchema[T] = js.native
  def matches(regex: js.RegExp, messageOrOptions: TestOptionsMessage[Anon_Regex, _]): StringSchema[T] = js.native
