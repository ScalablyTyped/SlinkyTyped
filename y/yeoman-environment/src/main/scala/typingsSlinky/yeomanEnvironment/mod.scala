...
import typingsSlinky.yeomanEnvironment.anon.FnCall
import typingsSlinky.yeomanEnvironment.anon.LoggerDefaultCategories
import typingsSlinky.yeomanGenerator.mod.GeneratorConstructor
...
object mod {
  ...
  object util {
    ...
    @js.native
    def duplicateEnv(initialEnv: typingsSlinky.yeomanEnvironment.mod.^[Options]): typingsSlinky.yeomanEnvironment.mod.^[Options] = js.native
  ...
  trait Environment[TOptions /* <: Options */] extends EventEmitter {
    ...
    /**
      ...
      */
    var adapter: typingsSlinky.yeomanEnvironment.adapterMod.^ = js.native
    ...
    /**
      ...
      */
    def create[TOptions /* <: GeneratorOptions */](namespaceOrPath: String): typingsSlinky.yeomanGenerator.mod.^[TOptions] | js.Error = js.native
    def create[TOptions /* <: GeneratorOptions */](namespaceOrPath: String, options: InstantiateOptions[TOptions]): typingsSlinky.yeomanGenerator.mod.^[TOptions] | js.Error = js.native
    ...
    def error(error: js.Error, verifyListener: Boolean): js.Error = js.native
    def error(error: js.Object): js.Error = js.native
    def error(error: js.Object, verifyListener: Boolean): js.Error = js.native
    ...
    def get(namespaceOrPath: String): js.UndefOr[
        Instantiable2[
          ...
          typingsSlinky.yeomanGenerator.mod.^[GeneratorOptions]
        ]
      ] = js.native
    ...
    /**
      ...
      * @param options The options to pass to the generator.
      */
    def instantiate(name: GeneratorConstructor, options: InstantiateOptions[GeneratorOptions]): typingsSlinky.yeomanGenerator.mod.^[GeneratorOptions] = js.native
    ...
    def lookup(options: js.UndefOr[scala.Nothing], cb: js.Function1[/* err */ Null | js.Error, Unit]): js.Array[LookupGeneratorMeta] = js.native
    def lookup(options: LookupOptions): js.Array[LookupGeneratorMeta] = js.native
    def lookup(options: LookupOptions, cb: js.Function1[/* err */ Null | js.Error, Unit]): js.Array[LookupGeneratorMeta] = js.native
    ...
    /**
      ...
      */
    def rootGenerator(): typingsSlinky.yeomanGenerator.mod.^[GeneratorOptions] = js.native
    ...
    /**
      ...
      */
    def runGenerator(generator: typingsSlinky.yeomanGenerator.mod.^[GeneratorOptions]): js.Promise[Unit] = js.native
    def runGenerator(generator: typingsSlinky.yeomanGenerator.mod.^[GeneratorOptions], callback: Callback): js.Promise[Unit] = js.native
    ...
    /**
      ...
      */
    var store: typingsSlinky.yeomanGenerator.storageMod.^ = js.native
  }
