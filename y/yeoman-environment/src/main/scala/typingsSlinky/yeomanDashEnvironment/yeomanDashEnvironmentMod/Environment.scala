...
import typingsSlinky.yeomanDashGenerator.yeomanDashGeneratorMod.Storage
...
trait Environment[O /* <: Options */] extends EventEmitter {
  ...
  def get(namespace: String): typingsSlinky.yeomanDashGenerator.yeomanDashGeneratorMod.^  | Null = js.native
  def getByPath(path: String): typingsSlinky.yeomanDashGenerator.yeomanDashGeneratorMod.^  | Null = js.native
  ...
  def instantiate(name: String, options: InstantiateOptions): typingsSlinky.yeomanDashGenerator.yeomanDashGeneratorMod.^ = js.native
  ...
  def registerStub(Generator: typingsSlinky.yeomanDashGenerator.yeomanDashGeneratorMod.^, namespace: String): this.type = js.native
