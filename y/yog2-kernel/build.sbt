...
name := "yog2-kernel"
version := "1.9-dt-20200515Z-7167cf"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "node-ral" % "0.18-dt-20200515Z-b3e529",
  ...
  "org.scalablytyped.slinky" %%% "yog-bigpipe" % "0.4-dt-20200515Z-12eb22",
  "org.scalablytyped.slinky" %%% "yog-log" % "0.1-dt-20200515Z-514ffc")
