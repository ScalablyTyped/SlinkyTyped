...
name := "yog2-kernel"
version := "1.9-dt-20200515Z-573e25"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "node-ral" % "0.18-dt-20200515Z-b96e5b",
  ...
  "org.scalablytyped.slinky" %%% "yog-bigpipe" % "0.4-dt-20200515Z-ae6bbc",
  "org.scalablytyped.slinky" %%% "yog-log" % "0.1-dt-20200515Z-cb2dbf")
