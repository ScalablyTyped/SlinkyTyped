...
name := "yog2-kernel"
version := "1.9-dt-20200225Z-39a47a"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "node-ral" % "0.18-dt-20200225Z-b816f2",
  ...
  "org.scalablytyped.slinky" %%% "yog-bigpipe" % "0.4-dt-20190819Z-327c9d",
  "org.scalablytyped.slinky" %%% "yog-log" % "0.1-dt-20200225Z-896638")
