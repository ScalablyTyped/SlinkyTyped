...
name := "yog2-kernel"
version := "1.9-dt-20200225Z-73c869"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "node-ral" % "0.18-dt-20200225Z-6e6d13",
  ...
  "org.scalablytyped.slinky" %%% "yog-bigpipe" % "0.4-dt-20190819Z-1df182",
  "org.scalablytyped.slinky" %%% "yog-log" % "0.1-dt-20200225Z-419251")
