...
name := "yog2-kernel"
version := "1.9-dt-20200515Z-d30922"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "node-ral" % "0.18-dt-20200515Z-a82a4b",
  ...
  "org.scalablytyped.slinky" %%% "yog-bigpipe" % "0.4-dt-20200515Z-7930f0",
  "org.scalablytyped.slinky" %%% "yog-log" % "0.1-dt-20200515Z-106ba2")
