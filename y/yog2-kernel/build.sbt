...
name := "yog2-kernel"
version := "1.9-dt-20200515Z-434ab4"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "node-ral" % "0.18-dt-20200515Z-b081a1",
  ...
  "org.scalablytyped.slinky" %%% "yog-bigpipe" % "0.4-dt-20200515Z-8772c4",
  "org.scalablytyped.slinky" %%% "yog-log" % "0.1-dt-20200515Z-4b5f23")
