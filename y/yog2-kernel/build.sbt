...
name := "yog2-kernel"
version := "1.9-dt-20200515Z-933afe"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "node-ral" % "0.18-dt-20200515Z-db88ad",
  ...
  "org.scalablytyped.slinky" %%% "yog-bigpipe" % "0.4-dt-20200515Z-9c5688",
  "org.scalablytyped.slinky" %%% "yog-log" % "0.1-dt-20200515Z-6f79e7")
