...
import typingsSlinky.yog2DashKernel.Anon_CleanCache
import typingsSlinky.yog2DashKernel.TypeofRAL
import typingsSlinky.yog2DashKernel.TypeofRALPromise
import typingsSlinky.yog2DashKernel.Typeofexpress
import typingsSlinky.yogDashLog.yogDashLogMod.Logger
...
trait Yog extends js.Object {
  ...
  var express_Original: (js.Function0[
    typingsSlinky.expressDashServeDashStaticDashCore.expressDashServeDashStaticDashCoreMod.Express
  ...
  def express(): typingsSlinky.expressDashServeDashStaticDashCore.expressDashServeDashStaticDashCoreMod.Express = js.native
}
