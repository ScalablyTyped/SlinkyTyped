package typingsSlinky.yandexMoneySdk.YandexMoneySDK
...
object Wallet {
  ...
  object OperationHistoryOptions {
    ...
    implicit class OperationHistoryOptionsMutableBuilder[Self <: OperationHistoryOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFrom(value: String | js.Date): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTill(value: String | js.Date): Self = StObject.set(x, "till", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTillDate(value: js.Date): Self = StObject.set(x, "till", value.asInstanceOf[js.Any])
