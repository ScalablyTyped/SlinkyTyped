...
object OperationHistoryOptions {
  ...
  implicit class OperationHistoryOptionsOps[Self <: OperationHistoryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrom(value: String | js.Date): Self = this.set("from", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTillDate(value: js.Date): Self = this.set("till", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTill(value: String | js.Date): Self = this.set("till", value.asInstanceOf[js.Any])
