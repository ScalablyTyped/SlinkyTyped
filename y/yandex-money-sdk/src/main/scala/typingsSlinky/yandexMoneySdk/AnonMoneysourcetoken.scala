...
object AnonMoneysourcetoken {
  @scala.inline
  def apply(payment_card_type: String, `type`: String): AnonMoneysourcetoken = {
  ...
  @scala.inline
  implicit class AnonMoneysourcetokenOps[Self <: AnonMoneysourcetoken] (val x: Self) extends AnyVal {
    @scala.inline
