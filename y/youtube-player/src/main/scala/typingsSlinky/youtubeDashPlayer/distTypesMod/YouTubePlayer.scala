...
import typingsSlinky.youtubeDashPlayer.Anon_Data
import typingsSlinky.youtubeDashPlayer.Anon_EndSeconds
import typingsSlinky.youtubeDashPlayer.Anon_EndSecondsMediaContentUrl
import typingsSlinky.youtubeDashPlayer.Anon_Index
...
import typingsSlinky.youtubeDashPlayer.youtubeDashPlayerStrings.stateChange
...
trait YouTubePlayer extends js.Object {
  ...
  @JSName("on")
  def on_stateChange(eventType: stateChange, listener: js.Function1[/* event */ CustomEvent with Anon_Data, Unit]): Unit = js.native
