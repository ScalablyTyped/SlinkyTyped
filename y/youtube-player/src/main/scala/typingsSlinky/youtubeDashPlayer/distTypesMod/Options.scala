package typingsSlinky.youtubeDashPlayer.distTypesMod

import typingsSlinky.youtubeDashPlayer.Anon_0
...
trait Options extends js.Object {
  ...
  {[ eventType in youtube-player.youtube-player/dist/eventNames.EventType ]: (event : std.CustomEvent<any>): void}
    */ typingsSlinky.youtubeDashPlayer.youtubeDashPlayerStrings.Options with js.Any
  ] = js.undefined
...
object Options {
  ...
  {[ eventType in youtube-player.youtube-player/dist/eventNames.EventType ]: (event : std.CustomEvent<any>): void}
    */ typingsSlinky.youtubeDashPlayer.youtubeDashPlayerStrings.Options with js.Any = null,
