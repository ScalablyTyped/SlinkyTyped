...
object eventTypeinEventTypeevent {
  ...
  implicit class eventTypeinEventTypeeventOps[Self <: eventTypeinEventTypeevent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiChange(value: /* event */ CustomEvent => Unit): Self = this.set("apiChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteApiChange: Self = this.set("apiChange", js.undefined)
    
    @scala.inline
    def setError(value: /* event */ CustomEvent => Unit): Self = this.set("error", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteError: Self = this.set("error", js.undefined)
    
    @scala.inline
    def setPlaybackQualityChange(value: /* event */ CustomEvent => Unit): Self = this.set("playbackQualityChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deletePlaybackQualityChange: Self = this.set("playbackQualityChange", js.undefined)
    
    @scala.inline
    def setPlaybackRateChange(value: /* event */ CustomEvent => Unit): Self = this.set("playbackRateChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setStateChange(value: /* event */ CustomEvent => Unit): Self = this.set("stateChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteStateChange: Self = this.set("stateChange", js.undefined)
    
    @scala.inline
    def setVolumeChange(value: /* event */ CustomEvent => Unit): Self = this.set("volumeChange", js.Any.fromFunction1(value))
