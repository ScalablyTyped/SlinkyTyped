...
object mod {
  ...
  @JSImport("youtube-player", JSImport.Default)
  @js.native
  ...
  @JSImport("youtube-player", JSImport.Default)
  @js.native
  def default(maybeElementId: HTMLElement, options: js.UndefOr[scala.Nothing], strictState: Boolean): YouTubePlayer = js.native
  @JSImport("youtube-player", JSImport.Default)
  @js.native
  ...
  @JSImport("youtube-player", JSImport.Default)
  @js.native
  def default(maybeElementId: YouTubePlayer, options: js.UndefOr[scala.Nothing], strictState: Boolean): YouTubePlayer = js.native
  @JSImport("youtube-player", JSImport.Default)
  @js.native
