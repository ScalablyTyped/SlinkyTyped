...
object eventTypeinEventTypeevent {
  @scala.inline
  def apply(
    apiChange: /* event */ CustomEvent => Unit = null,
    error: /* event */ CustomEvent => Unit = null,
    playbackQualityChange: /* event */ CustomEvent => Unit = null,
    playbackRateChange: /* event */ CustomEvent => Unit = null,
    ready: /* event */ CustomEvent => Unit = null,
    stateChange: /* event */ CustomEvent => Unit = null,
    volumeChange: /* event */ CustomEvent => Unit = null
