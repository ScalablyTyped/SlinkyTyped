...
object AnonContentKeyName {
  @scala.inline
  def apply[contentKeyName](contentKeyName: contentKeyName): AnonContentKeyName[contentKeyName] = {
  ...
  @scala.inline
  implicit class AnonContentKeyNameOps[Self[contentkeyname] <: AnonContentKeyName[contentkeyname], contentKeyName] (val x: Self[contentKeyName]) extends AnyVal {
    @scala.inline
