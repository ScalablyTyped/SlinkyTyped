...
import typingsSlinky.yaml.yamlStrings.`yaml-1Dot1`
import typingsSlinky.yaml.yamlStrings.core
import typingsSlinky.yaml.yamlStrings.failsafe
import typingsSlinky.yaml.yamlStrings.json
