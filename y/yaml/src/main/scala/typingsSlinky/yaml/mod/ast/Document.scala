...
import typingsSlinky.yaml.mod.YAMLError
import typingsSlinky.yaml.mod.YAMLWarning
...
trait Document extends js.Object {
  ...
  /**
    ...
    */
  var cstNode: js.UndefOr[typingsSlinky.yaml.mod.cst.Document] = js.undefined
  /**
  ...
  /**
    ...
    */
  def parse(cst: typingsSlinky.yaml.mod.cst.Document): this.type
  /**
...
object Document {
  ...
  def apply(
    ...
    parse: typingsSlinky.yaml.mod.cst.Document => Document,
    schema: Schema,
    ...
    cstNode: typingsSlinky.yaml.mod.cst.Document = null,
