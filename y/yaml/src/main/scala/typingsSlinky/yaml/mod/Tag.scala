...
trait Tag extends js.Object {
  ...
  /**
    ...
    */
  def resolve(doc: typingsSlinky.yaml.mod.ast.Document, cstNode: Node): typingsSlinky.yaml.mod.ast.Node = js.native
  def resolve(`match`: String*): typingsSlinky.yaml.mod.ast.Node = js.native
  /**
    ...
    */
  def stringify(item: typingsSlinky.yaml.mod.ast.Node, ctx: StringifyContext, onComment: js.Function0[Unit]): String = js.native
}
