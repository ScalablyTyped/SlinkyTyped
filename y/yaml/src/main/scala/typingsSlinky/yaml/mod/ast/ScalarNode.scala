...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.yaml.mod.ast.BlockFolded
  - typingsSlinky.yaml.mod.ast.BlockLiteral
  - typingsSlinky.yaml.mod.ast.PlainValue
  - typingsSlinky.yaml.mod.ast.QuoteDouble
  - typingsSlinky.yaml.mod.ast.QuoteSingle
*/
