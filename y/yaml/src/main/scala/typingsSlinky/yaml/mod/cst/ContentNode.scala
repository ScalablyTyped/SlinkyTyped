...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.yaml.mod.cst.Alias
  - typingsSlinky.yaml.mod.cst.Scalar
  - typingsSlinky.yaml.mod.cst.Map
  - typingsSlinky.yaml.mod.cst.Seq
  - typingsSlinky.yaml.mod.cst.FlowCollection
*/
...
object ContentNode {
  ...
  def FlowCollection(
    ...
    hasProps: Boolean,
    items: js.Array[
      FlowChar | BlankLine | Comment | Alias | Scalar | typingsSlinky.yaml.mod.cst.FlowCollection
    ],
    jsonLike: Boolean,
    props: js.Array[Range],
