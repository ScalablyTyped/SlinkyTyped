...
import typingsSlinky.yaml.mod.Document.Parsed
...
import typingsSlinky.yaml.typesMod.Schema
...
object mod {
  ...
  class Document () extends Collection {
    ...
    @JSName("cstNode")
    var cstNode_Document: js.UndefOr[typingsSlinky.yaml.parseCstMod.CST.Document] = js.native
  ...
  object scalarOptions {
    ...
    object Null {
      ...
      @scala.inline
      def apply(nullStr: String): typingsSlinky.yaml.mod.scalarOptions.Null = {
        val __obj = js.Dynamic.literal(nullStr = nullStr.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.yaml.mod.scalarOptions.Null]
      }
      
      @scala.inline
      implicit class NullMutableBuilder[Self <: typingsSlinky.yaml.mod.scalarOptions.Null] (val x: Self) extends AnyVal {
    ...
    @js.native
    val `null`: typingsSlinky.yaml.mod.scalarOptions.Null = js.native
  }
