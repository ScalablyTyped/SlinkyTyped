...
trait Tag extends js.Object {
  ...
  /**
    ...
    */
  def resolve(doc: typingsSlinky.yaml.yamlMod.ast.Document, cstNode: Node): typingsSlinky.yaml.yamlMod.ast.Node = js.native
  def resolve(`match`: String*): typingsSlinky.yaml.yamlMod.ast.Node = js.native
  /**
    ...
    */
  def stringify(item: typingsSlinky.yaml.yamlMod.ast.Node, ctx: StringifyContext, onComment: js.Function0[Unit]): String = js.native
}
