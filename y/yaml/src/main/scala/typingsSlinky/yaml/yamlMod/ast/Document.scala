...
import typingsSlinky.yaml.yamlMod.YAMLError
import typingsSlinky.yaml.yamlMod.YAMLWarning
import typingsSlinky.yaml.yamlStrings.DOCUMENT
...
trait Document extends js.Object {
  ...
  /**
    ...
    */
  var cstNode: js.UndefOr[typingsSlinky.yaml.yamlMod.cst.Document] = js.undefined
  /**
  ...
  /**
    ...
    */
  def parse(cst: typingsSlinky.yaml.yamlMod.cst.Document): this.type
  /**
...
object Document {
  ...
  def apply(
    ...
    parse: typingsSlinky.yaml.yamlMod.cst.Document => typingsSlinky.yaml.yamlMod.ast.Document,
    schema: Schema,
    ...
    cstNode: typingsSlinky.yaml.yamlMod.cst.Document = null,
