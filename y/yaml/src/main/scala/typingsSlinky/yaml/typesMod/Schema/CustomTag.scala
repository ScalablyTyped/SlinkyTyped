...
trait CustomTag
  ...
  /**
    ...
    */
  def resolve(doc: Document, cstNode: Node): typingsSlinky.yaml.typesMod.Node | js.Any = js.native
}
...
object CustomTag {
  ...
  implicit class CustomTagOps[Self <: CustomTag] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResolve(value: (Document, Node) => typingsSlinky.yaml.typesMod.Node | js.Any): Self = this.set("resolve", js.Any.fromFunction2(value))
    @scala.inline
