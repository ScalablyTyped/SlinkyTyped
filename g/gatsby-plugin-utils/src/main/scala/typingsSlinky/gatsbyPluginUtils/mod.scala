...
import typingsSlinky.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.PluginOptionsSchemaJoi
import typingsSlinky.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.ValidationError
