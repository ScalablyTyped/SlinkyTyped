...
import typingsSlinky.gatsbyPluginUtils.anon.Override
import typingsSlinky.gatsbyPluginUtils.gatsbyPluginUtilsStrings.map
import typingsSlinky.gatsbyPluginUtils.gatsbyPluginUtilsStrings.number
