...
import typingsSlinky.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.GuidVersions
import typingsSlinky.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.PresenceMode
import typingsSlinky.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.Types
