...
import typingsSlinky.googlePicker.google.picker.Picker
  ...
  object google extends js.Object {
    ...
    object picker extends js.Object {
      ...
      class DocsUploadView ()
        ...
        /* CompleteClass */
        override def setIncludeFolders(included: Boolean): typingsSlinky.googlePicker.google.picker.DocsUploadView = js.native
        // Sets the upload destination to the specified folder. This overrides ".setIncludeFolders" to false.
        /* CompleteClass */
        override def setParent(parentId: String): typingsSlinky.googlePicker.google.picker.DocsUploadView = js.native
      }
      ...
      class PickerBuilder ()
        ...
        /* CompleteClass */
        override def addView(viewOrId: js.Any): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Add a ViewGroup to the top-level navigation pane.
        /* CompleteClass */
        override def addViewGroup(viewGroup: js.Any): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Construct the Picker object. The Picker object is returned.
        /* CompleteClass */
        override def build(): Picker = js.native
        // Disable a picker feature.
        /* CompleteClass */
        override def disableFeature(feature: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Enable a picker feature.
        /* CompleteClass */
        override def enableFeature(feature: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def hideTitleBar(): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def setAppId(appId: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def setCallback(method: js.Function): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def setDeveloperKey(key: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Set the document.
        /* CompleteClass */
        override def setDocument(document: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def setLocale(locale: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Sets the maximum number of items a user can pick.
        /* CompleteClass */
        override def setMaxItems(max: Double): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def setOAuthToken(token: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def setOrigin(origin: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Set the relay URL, used for gadgets.rpc.
        /* CompleteClass */
        override def setRelayUrl(url: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Set the list of MIME types which will be selectable. Use commas to separate MIME types if more than one is required.
        /* CompleteClass */
        override def setSelectableMimeTypes(`type`: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        ...
        /* CompleteClass */
        override def setSize(width: Double, height: Double): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Set the dialog title.
        /* CompleteClass */
        override def setTitle(title: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
        // Specify an album ID for photo uploads. See Picasa Web Albums Data API documentation for more information about albums.
        /* CompleteClass */
        override def setUploadToAlbumId(albumId: String): typingsSlinky.googlePicker.google.picker.PickerBuilder = js.native
