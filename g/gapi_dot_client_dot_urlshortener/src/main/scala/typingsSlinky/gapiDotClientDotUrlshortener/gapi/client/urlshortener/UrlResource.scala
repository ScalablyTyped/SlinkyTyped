package typingsSlinky.gapiDotClientDotUrlshortener.gapi.client.urlshortener

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotUrlshortener.Anon_Alt
import typingsSlinky.gapiDotClientDotUrlshortener.Anon_AltFields
import typingsSlinky.gapiDotClientDotUrlshortener.Anon_AltFieldsKey
