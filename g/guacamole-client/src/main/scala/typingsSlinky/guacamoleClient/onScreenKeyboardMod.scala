...
object onScreenKeyboardMod {
  ...
  object OnScreenKeyboard {
    ...
    type Key = Instantiable2[
        /* template */ typingsSlinky.guacamoleClient.onScreenKeyboardMod.Key, 
        /* name */ js.UndefOr[String], 
        typingsSlinky.guacamoleClient.onScreenKeyboardMod.Key
      ]
    
    type Layout = Instantiable1[
        /* template */ typingsSlinky.guacamoleClient.onScreenKeyboardMod.Layout, 
        typingsSlinky.guacamoleClient.onScreenKeyboardMod.Layout
      ]
  }
