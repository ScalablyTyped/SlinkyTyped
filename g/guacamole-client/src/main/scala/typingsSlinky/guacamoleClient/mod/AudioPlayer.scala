...
@js.native
class AudioPlayer ()
  extends typingsSlinky.guacamoleClient.audioPlayerMod.AudioPlayer
/* static members */
@JSImport("guacamole-client", "AudioPlayer")
@js.native
object AudioPlayer extends js.Object {
  ...
  /**
    ...
    */
  def getInstance(stream: typingsSlinky.guacamoleClient.inputStreamMod.InputStream, mimetype: Mimetype): typingsSlinky.guacamoleClient.audioPlayerMod.AudioPlayer | Null = js.native
