...
class RawAudioRecorder protected ()
  extends typingsSlinky.guacamoleClient.rawAudioRecorderMod.RawAudioRecorder {
  /**
    ...
    */
  def this(stream: typingsSlinky.guacamoleClient.outputStreamMod.OutputStream, mimetype: Mimetype) = this()
}
/* static members */
@JSImport("guacamole-client", "RawAudioRecorder")
@js.native
