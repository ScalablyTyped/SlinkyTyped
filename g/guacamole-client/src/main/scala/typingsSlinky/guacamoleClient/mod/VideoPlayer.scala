...
@js.native
class VideoPlayer ()
  extends typingsSlinky.guacamoleClient.videoPlayerMod.VideoPlayer
/* static members */
object VideoPlayer {
  ...
  @js.native
  def getInstance(
    stream: typingsSlinky.guacamoleClient.inputStreamMod.InputStream,
    layer: typingsSlinky.guacamoleClient.visibleLayerMod.VisibleLayer,
    mimetype: MimeType
  ): typingsSlinky.guacamoleClient.videoPlayerMod.VideoPlayer | Null = js.native
