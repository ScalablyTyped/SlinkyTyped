...
object ShaderDefinition {
  ...
  implicit class ShaderDefinitionOps[Self <: ShaderDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFrag(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("frag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVert(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vert")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutVert: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vert")(js.undefined)
        ret
    }
  }
