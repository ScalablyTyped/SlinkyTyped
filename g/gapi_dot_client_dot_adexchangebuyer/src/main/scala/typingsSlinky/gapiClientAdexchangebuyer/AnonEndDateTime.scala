...
object AnonEndDateTime {
  @scala.inline
  def apply(accountId: String, endDateTime: String, startDateTime: String): AnonEndDateTime = {
  ...
  @scala.inline
  implicit class AnonEndDateTimeOps[Self <: AnonEndDateTime] (val x: Self) extends AnyVal {
    @scala.inline
