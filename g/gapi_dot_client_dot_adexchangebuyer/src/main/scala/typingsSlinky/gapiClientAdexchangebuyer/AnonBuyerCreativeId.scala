...
@js.native
trait AnonBuyerCreativeId extends js.Object {
...
object AnonBuyerCreativeId {
  @scala.inline
  def apply(accountId: Double, buyerCreativeId: String, dealId: String): AnonBuyerCreativeId = {
    ...
    __obj.asInstanceOf[AnonBuyerCreativeId]
  }
  @scala.inline
  implicit class AnonBuyerCreativeIdOps[Self <: AnonBuyerCreativeId] (val x: Self) extends AnyVal {
    @scala.inline
