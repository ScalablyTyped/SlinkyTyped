package typingsSlinky.gapiClientAdexchangebuyer.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientAdexchangebuyer.gapiClientAdexchangebuyerStrings.adexchangebuyer,
    version: v1Dot4
