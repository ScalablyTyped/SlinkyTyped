...
@js.native
trait AnonConfirmUnsafeAccountChange extends js.Object {
...
object AnonConfirmUnsafeAccountChange {
  @scala.inline
  def apply(id: Double): AnonConfirmUnsafeAccountChange = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonConfirmUnsafeAccountChange]
  }
  @scala.inline
  implicit class AnonConfirmUnsafeAccountChangeOps[Self <: AnonConfirmUnsafeAccountChange] (val x: Self) extends AnyVal {
    @scala.inline
