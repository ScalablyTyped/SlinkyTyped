...
object AnonProposalId {
  @scala.inline
  def apply(proposalId: String, revisionNumber: String, updateAction: String): AnonProposalId = {
  ...
  @scala.inline
  implicit class AnonProposalIdOps[Self <: AnonProposalId] (val x: Self) extends AnyVal {
    @scala.inline
