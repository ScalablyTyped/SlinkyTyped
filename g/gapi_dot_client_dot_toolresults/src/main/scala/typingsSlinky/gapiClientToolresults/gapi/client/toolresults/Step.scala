...
object Step {
  ...
  implicit class StepOps[Self <: Step] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeviceUsageDuration(value: Duration): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDimensionValue(value: js.Array[StepDimensionValueEntry]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabels(value: js.Array[StepLabelsEntry]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRunDuration(value: Duration): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTestExecutionStep(value: TestExecutionStep): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withToolExecutionStep(value: ToolExecutionStep): Self = {
        val ret = this.duplicate
