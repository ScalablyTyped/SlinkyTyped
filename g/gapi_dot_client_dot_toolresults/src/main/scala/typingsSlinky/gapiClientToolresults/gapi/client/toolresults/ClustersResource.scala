...
import typingsSlinky.gapiClientToolresults.anon.Alt
...
object ClustersResource {
  ...
  implicit class ClustersResourceOps[Self <: ClustersResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: Alt => Request[ScreenshotCluster]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: ExecutionId => Request[ListScreenshotClustersResponse]): Self = {
        val ret = this.duplicate
