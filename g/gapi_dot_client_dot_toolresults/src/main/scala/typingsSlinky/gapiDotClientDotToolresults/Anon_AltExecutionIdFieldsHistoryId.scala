...
trait Anon_AltExecutionIdFieldsHistoryId extends js.Object {
...
object Anon_AltExecutionIdFieldsHistoryId {
  @scala.inline
  def apply(
    executionId: String,
    historyId: String,
    ...
    userIp: String = null
  ): Anon_AltExecutionIdFieldsHistoryId = {
    ...
    __obj.asInstanceOf[Anon_AltExecutionIdFieldsHistoryId]
  }
}
