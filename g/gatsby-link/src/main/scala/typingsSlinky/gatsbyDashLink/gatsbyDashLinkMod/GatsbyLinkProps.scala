package typingsSlinky.gatsbyDashLink.gatsbyDashLinkMod
...
trait GatsbyLinkProps[TState] extends LinkProps[TState] {
  ...
  var onClick: js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLAnchorElement], Unit]] = js.undefined
...
object GatsbyLinkProps {
  ...
  def apply[TState](
    ...
    onClick: /* event */ SyntheticMouseEvent[HTMLAnchorElement] => Unit = null,
