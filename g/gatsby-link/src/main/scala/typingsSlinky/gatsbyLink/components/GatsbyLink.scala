package typingsSlinky.gatsbyLink.components
...
object GatsbyLink
  ...
  def apply[TState](
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.gatsbyLink.mod.default[js.Any]]]
  }
