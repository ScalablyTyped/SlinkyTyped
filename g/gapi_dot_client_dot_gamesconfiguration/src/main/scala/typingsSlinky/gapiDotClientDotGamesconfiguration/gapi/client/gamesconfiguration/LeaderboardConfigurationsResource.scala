...
import typingsSlinky.gapiDotClientDotGamesconfiguration.Anon_Alt
import typingsSlinky.gapiDotClientDotGamesconfiguration.Anon_AltApplicationId
import typingsSlinky.gapiDotClientDotGamesconfiguration.Anon_AltFieldsKey
