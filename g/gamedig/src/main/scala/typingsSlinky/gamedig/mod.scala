...
object mod {
  ...
  object QueryOptions {
    ...
    implicit class QueryOptionsMutableBuilder[Self <: QueryOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttemptTimeout(value: Double): Self = StObject.set(x, "attemptTimeout", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAttemptTimeoutUndefined: Self = StObject.set(x, "attemptTimeout", js.undefined)
      ...
      @scala.inline
      def setGivenPortOnly(value: Boolean): Self = StObject.set(x, "givenPortOnly", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGivenPortOnlyUndefined: Self = StObject.set(x, "givenPortOnly", js.undefined)
  ...
  object QueryResult {
    ...
    implicit class QueryResultMutableBuilder[Self <: QueryResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBots(value: js.Array[Player]): Self = StObject.set(x, "bots", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBotsVarargs(value: Player*): Self = StObject.set(x, "bots", js.Array(value :_*))
      ...
      @scala.inline
      def setMaxplayers(value: Double): Self = StObject.set(x, "maxplayers", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPlayers(value: js.Array[Player]): Self = StObject.set(x, "players", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPlayersVarargs(value: Player*): Self = StObject.set(x, "players", js.Array(value :_*))
      
      @scala.inline
      def setRaw(value: js.Object): Self = StObject.set(x, "raw", value.asInstanceOf[js.Any])
