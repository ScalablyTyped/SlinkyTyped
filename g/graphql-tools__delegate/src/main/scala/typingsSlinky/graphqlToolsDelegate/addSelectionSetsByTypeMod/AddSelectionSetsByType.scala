...
@js.native
trait AddSelectionSetsByType
  extends Transform[Record[String, js.Any]] {
  val mapping: js.Any = js.native
  val targetSchema: js.Any = js.native
  @JSName("transformRequest")
  def transformRequest_MAddSelectionSetsByType(originalRequest: Request): Request = js.native
}

object AddSelectionSetsByType {
  @scala.inline
  def apply(mapping: js.Any, targetSchema: js.Any, transformRequest: Request => Request): AddSelectionSetsByType = {
    ...
    __obj.asInstanceOf[AddSelectionSetsByType]
  }
  @scala.inline
  implicit class AddSelectionSetsByTypeOps[Self <: AddSelectionSetsByType] (val x: Self) extends AnyVal {
    @scala.inline
