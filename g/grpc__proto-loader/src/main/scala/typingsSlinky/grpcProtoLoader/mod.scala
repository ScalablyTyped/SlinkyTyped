...
import typingsSlinky.protobufjs.descriptorMod.IFileDescriptorSet
  ...
  */
  ...
  object _AnyDefinition {
    ...
    def EnumTypeDefinition(
      ...
      val __obj = js.Dynamic.literal(fileDescriptorProtos = fileDescriptorProtos.asInstanceOf[js.Any], format = format.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.grpcProtoLoader.mod.EnumTypeDefinition]
    }
    ...
    def MessageTypeDefinition(
      ...
      val __obj = js.Dynamic.literal(fileDescriptorProtos = fileDescriptorProtos.asInstanceOf[js.Any], format = format.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.grpcProtoLoader.mod.MessageTypeDefinition]
    }
  }
