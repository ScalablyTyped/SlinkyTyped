package typingsSlinky.atGrpcProtoDashLoader
...
package object atGrpcProtoDashLoaderMod {
  ...
  import typingsSlinky.atGrpcProtoDashLoader.Anon_IncludeDirs
  import typingsSlinky.node.Buffer
  import typingsSlinky.protobufjs.protobufjsMod.IConversionOptions
  import typingsSlinky.protobufjs.protobufjsMod.IParseOptions
