...
object channels {
  ...
  implicit class channelsOps[Self <: channels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withList(value: ForUsername => HttpRequest[GoogleApiYouTubePaginationInfo[GoogleApiYouTubeChannelResource]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdate(value: RequestBody => HttpRequest[GoogleApiYouTubeChannelResource]): Self = {
        val ret = this.duplicate
