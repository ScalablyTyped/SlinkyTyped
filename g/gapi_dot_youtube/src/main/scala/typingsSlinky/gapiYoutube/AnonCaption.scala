...
trait AnonCaption extends js.Object {
  ...
  /**
    ...
    */
  var contentRating: AnonAcbRating = js.native
  /**
  ...
  /**
    ...
    */
  var regionRestriction: AnonAllowed = js.native
}
...
object AnonCaption {
  ...
  implicit class AnonCaptionOps[Self <: AnonCaption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContentRating(value: AnonAcbRating): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRegionRestriction(value: AnonAllowed): Self = {
        val ret = this.duplicate
