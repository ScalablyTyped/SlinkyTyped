...
@js.native
trait AnonDefaultTab extends js.Object {
  /**
...
object AnonDefaultTab {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonDefaultTab]
  }
  @scala.inline
  implicit class AnonDefaultTabOps[Self <: AnonDefaultTab] (val x: Self) extends AnyVal {
    @scala.inline
