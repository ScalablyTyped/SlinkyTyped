...
trait AnonBackgroundImageUrl extends js.Object {
  /**
    ...
    */
  var backgroundImageUrl: AnonDefault = js.native
  /**
  ...
  /**
    ...
    */
  var largeBrandedBannerImageImapScript: AnonDefault = js.native
  /**
    * The URL for the 854px by 70px image that appears below the video player in the expanded video view of the video watch page.
    */
  var largeBrandedBannerImageUrl: AnonDefault = js.native
  /**
    ...
    */
  var smallBrandedBannerImageImapScript: AnonDefault = js.native
  /**
    * The URL for the 640px by 70px banner image that appears below the video player in the default view of the video watch page.
    */
  var smallBrandedBannerImageUrl: AnonDefault = js.native
  /**
...
object AnonBackgroundImageUrl {
  ...
  @scala.inline
  implicit class AnonBackgroundImageUrlOps[Self <: AnonBackgroundImageUrl] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBackgroundImageUrl(value: AnonDefault): Self = {
