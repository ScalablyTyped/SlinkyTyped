...
trait AnonAudioStreams extends js.Object {
  /**
    ...
    */
  var audioStreams: js.Array[AnonBitrateBps] = js.native
  /**
  ...
  /**
    ...
    */
  var recordingLocation: AnonElevation = js.native
  /**
    * A list of video streams contained in the uploaded video file. Each item in the list contains detailed metadata about a video stream.
    */
  var videoStreams: js.Array[AnonAspectRatio] = js.native
}
...
object AnonAudioStreams {
  ...
  @scala.inline
  implicit class AnonAudioStreamsOps[Self <: AnonAudioStreams] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAudioStreams(value: js.Array[AnonBitrateBps]): Self = {
    ...
    @scala.inline
    def withRecordingLocation(value: AnonElevation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("recordingLocation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVideoStreams(value: js.Array[AnonAspectRatio]): Self = {
        val ret = this.duplicate
