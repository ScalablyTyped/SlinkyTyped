...
import typingsSlinky.gapiDotClientDotSpanner.Anon_AccesstokenAltBearertokenCallbackFields
import typingsSlinky.gapiDotClientDotSpanner.Anon_AccesstokenAltBearertokenCallbackFieldsFilter
import typingsSlinky.gapiDotClientDotSpanner.Anon_AccesstokenAltBearertokenCallbackFieldsKey
...
trait InstancesResource extends js.Object {
  ...
  def get(request: Anon_Accesstoken): Request[Instance]
  /**
  ...
  def list(request: Anon_AccesstokenAltBearertokenCallbackFieldsFilter): Request[ListInstancesResponse]
  /**
    ...
    * resource name.
    */
  def patch(request: Anon_Accesstoken): Request[Operation]
  /**
...
object InstancesResource {
  ...
  def apply(
    ...
    get: Anon_Accesstoken => Request[Instance],
    getIamPolicy: Anon_AccesstokenAltBearertokenCallbackFieldsKey => Request[Policy],
    list: Anon_AccesstokenAltBearertokenCallbackFieldsFilter => Request[ListInstancesResponse],
    operations: OperationsResource,
    patch: Anon_Accesstoken => Request[Operation],
