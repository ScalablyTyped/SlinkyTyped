...
object DatabasesResource {
  ...
  implicit class DatabasesResourceOps[Self <: DatabasesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDropDatabase(value: typingsSlinky.gapiClientSpanner.anon.Database => Request[js.Object]): Self = this.set("dropDatabase", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGet(value: Accesstoken => Request[Database]): Self = this.set("get", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetDdl(value: typingsSlinky.gapiClientSpanner.anon.Database => Request[GetDatabaseDdlResponse]): Self = this.set("getDdl", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setUpdateDdl(value: typingsSlinky.gapiClientSpanner.anon.Database => Request[Operation]): Self = this.set("updateDdl", js.Any.fromFunction1(value))
  }
}
