...
object ListAvailableOrgPolicyConstraintsRequest {
  @scala.inline
  def apply(): ListAvailableOrgPolicyConstraintsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListAvailableOrgPolicyConstraintsRequest]
  }
  @scala.inline
  implicit class ListAvailableOrgPolicyConstraintsRequestOps[Self <: ListAvailableOrgPolicyConstraintsRequest] (val x: Self) extends AnyVal {
    @scala.inline
