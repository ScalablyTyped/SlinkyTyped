package typingsSlinky.gapiDotClientDotCloudresourcemanager.gapi.client.cloudresourcemanager

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotCloudresourcemanager.Anon_AccesstokenAlt
import typingsSlinky.gapiDotClientDotCloudresourcemanager.Anon_AccesstokenAltBearertoken
import typingsSlinky.gapiDotClientDotCloudresourcemanager.Anon_AccesstokenAltBearertokenCallback
