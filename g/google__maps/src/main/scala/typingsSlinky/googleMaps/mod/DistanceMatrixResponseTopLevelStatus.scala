...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.googleMaps.googleMapsStrings.MAX_ELEMENTS_EXCEEDED
...
object DistanceMatrixResponseTopLevelStatus {
  ...
  @scala.inline
  def MAX_ELEMENTS_EXCEEDED: typingsSlinky.googleMaps.googleMapsStrings.MAX_ELEMENTS_EXCEEDED = "MAX_ELEMENTS_EXCEEDED".asInstanceOf[typingsSlinky.googleMaps.googleMapsStrings.MAX_ELEMENTS_EXCEEDED]
  @scala.inline
