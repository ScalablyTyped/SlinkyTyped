...
object DirectionsReponseStatus {
  ...
  @scala.inline
  def MAX_WAYPOINTS_EXCEEDED: typingsSlinky.googleMaps.googleMapsStrings.MAX_WAYPOINTS_EXCEEDED = "MAX_WAYPOINTS_EXCEEDED".asInstanceOf[typingsSlinky.googleMaps.googleMapsStrings.MAX_WAYPOINTS_EXCEEDED]
