...
object DirectionsRequest {
  ...
  implicit class DirectionsRequestMutableBuilder[Self <: DirectionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrival_time(value: js.Date | Double): Self = StObject.set(x, "arrival_time", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setArrival_timeDate(value: js.Date): Self = StObject.set(x, "arrival_time", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeparture_time(value: js.Date | Double | now): Self = StObject.set(x, "departure_time", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeparture_timeDate(value: js.Date): Self = StObject.set(x, "departure_time", value.asInstanceOf[js.Any])
