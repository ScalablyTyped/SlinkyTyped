...
import typingsSlinky.googleMaps.mod.AddressType
import typingsSlinky.googleMaps.mod.AspectRatingType
import typingsSlinky.googleMaps.mod.DirectionsReponseStatus
import typingsSlinky.googleMaps.mod.DistanceMatrixResponseElementLevelStatus
import typingsSlinky.googleMaps.mod.DistanceMatrixResponseTopLevelStatus
import typingsSlinky.googleMaps.mod.ElevationResponseStatus
import typingsSlinky.googleMaps.mod.GeocodedWaypointStatus
import typingsSlinky.googleMaps.mod.GeocodingAddressComponentType
import typingsSlinky.googleMaps.mod.GeocodingResponseStatus
import typingsSlinky.googleMaps.mod.GeolocationErrorReason
import typingsSlinky.googleMaps.mod.Language
import typingsSlinky.googleMaps.mod.LocationType
import typingsSlinky.googleMaps.mod.Maneuver
import typingsSlinky.googleMaps.mod.PlaceAutocompleteResponseStatus
import typingsSlinky.googleMaps.mod.PlaceAutocompleteType
import typingsSlinky.googleMaps.mod.PlaceDetailsRequestField
import typingsSlinky.googleMaps.mod.PlaceDetailsResponseStatus
...
import typingsSlinky.googleMaps.mod.PlacesNearbyRanking
import typingsSlinky.googleMaps.mod.QueryAutocompleteResponseStatus
import typingsSlinky.googleMaps.mod.RadioType
import typingsSlinky.googleMaps.mod.ReverseGeocodingLocationType
import typingsSlinky.googleMaps.mod.ReverseGeocodingResponseStatus
import typingsSlinky.googleMaps.mod.SearchResponseStatus
import typingsSlinky.googleMaps.mod.SpeedLimitUnit
import typingsSlinky.googleMaps.mod.TimeZoneResponseStatus
import typingsSlinky.googleMaps.mod.TrafficModel
import typingsSlinky.googleMaps.mod.TransitMode
import typingsSlinky.googleMaps.mod.TransitRoutingPreference
import typingsSlinky.googleMaps.mod.TravelMode
import typingsSlinky.googleMaps.mod.TravelRestriction
import typingsSlinky.googleMaps.mod.UnitSystem
import typingsSlinky.googleMaps.mod.VehicleType
