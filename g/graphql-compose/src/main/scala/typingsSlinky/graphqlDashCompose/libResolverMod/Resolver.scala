...
import typingsSlinky.graphqlDashCompose.Anon_Params
import typingsSlinky.graphqlDashCompose.Anon_ProjectionProjectionType
...
import typingsSlinky.graphqlDashCompose.libObjectTypeComposerMod.ComposeArgumentConfigAsObject
