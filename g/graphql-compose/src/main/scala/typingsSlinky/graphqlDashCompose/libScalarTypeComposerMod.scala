...
import typingsSlinky.graphqlDashCompose.libScalarTypeComposerMod.ComposeScalarTypeConfig
import typingsSlinky.graphqlDashCompose.libScalarTypeComposerMod.GraphQLScalarTypeExtended
