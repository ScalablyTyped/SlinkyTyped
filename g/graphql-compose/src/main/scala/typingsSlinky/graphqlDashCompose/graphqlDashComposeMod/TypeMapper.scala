...
class TypeMapper[TContext] protected ()
  extends typingsSlinky.graphqlDashCompose.libTypeMapperMod.TypeMapper[TContext] {
  def this(schemaComposer: typingsSlinky.graphqlDashCompose.libSchemaComposerMod.SchemaComposer[TContext]) = this()
}
