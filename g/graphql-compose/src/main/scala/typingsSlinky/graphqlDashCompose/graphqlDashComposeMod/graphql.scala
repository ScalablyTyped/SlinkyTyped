...
import typingsSlinky.graphql.Anon_Description
...
object graphql extends js.Object {
  ...
  class GraphQLDirective protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLDirective {
    def this(config: GraphQLDirectiveConfig) = this()
  }
  
  @js.native
  class GraphQLEnumType protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLEnumType {
    def this(config: GraphQLEnumTypeConfig) = this()
  }
  
  @js.native
  class GraphQLError protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLError {
    def this(
      message: String,
  ...
  class GraphQLInputObjectType protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLInputObjectType {
    def this(config: GraphQLInputObjectTypeConfig) = this()
  }
  
  @js.native
  class GraphQLInterfaceType protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLInterfaceType {
    def this(config: GraphQLInterfaceTypeConfig[_, _, StringDictionary[_]]) = this()
  }
  
  @js.native
  class GraphQLListCls protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLListCls {
    def this(`type`: GraphQLType) = this()
  }
  
  @js.native
  class GraphQLNonNullCls protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLNonNullCls {
    def this(`type`: GraphQLNullableType) = this()
  }
  
  @js.native
  class GraphQLObjectType[TSource, TContext, TArgs] protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLObjectType[TSource, TContext, TArgs] {
    def this(config: GraphQLObjectTypeConfig[TSource, TContext, TArgs]) = this()
  }
  
  @js.native
  class GraphQLScalarType protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLScalarType {
    def this(config: GraphQLScalarTypeConfig[_, _]) = this()
  }
  
  @js.native
  class GraphQLSchema protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLSchema {
    def this(config: GraphQLSchemaConfig) = this()
  }
  
  @js.native
  class GraphQLUnionType protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.GraphQLUnionType {
    def this(config: GraphQLUnionTypeConfig[_, _]) = this()
  }
  
  @js.native
  class Source protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.Source {
  ...
  class TypeInfo protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.TypeInfo {
  ...
  class ValidationContext protected ()
    extends typingsSlinky.graphqlDashCompose.libGraphqlMod.ValidationContext {
    def this(
      schema: typingsSlinky.graphql.typeSchemaMod.GraphQLSchema,
      ast: DocumentNode,
