...
object graphql extends js.Object {
  ...
  class GraphQLDirective protected ()
    extends typingsSlinky.graphqlCompose.graphqlMod.GraphQLDirective {
  ...
  class GraphQLListCls protected ()
    extends typingsSlinky.graphqlCompose.graphqlMod.GraphQLListCls {
    def this(`type`: GraphQLType) = this()
  }
  
  @js.native
  class GraphQLNonNullCls protected ()
    extends typingsSlinky.graphqlCompose.graphqlMod.GraphQLNonNullCls {
    def this(`type`: GraphQLNullableType) = this()
  }
  
  @js.native
  class GraphQLObjectType[TSource, TContext, TArgs] protected ()
    extends typingsSlinky.graphqlCompose.graphqlMod.GraphQLObjectType[TSource, TContext, TArgs] {
  ...
  class GraphQLUnionType protected ()
    extends typingsSlinky.graphqlCompose.graphqlMod.GraphQLUnionType {
