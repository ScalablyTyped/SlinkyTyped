...
import typingsSlinky.gm.mod.ChannelOperator
import typingsSlinky.gm.mod.ChannelType
import typingsSlinky.gm.mod.ColorSpace
import typingsSlinky.gm.mod.ComposeOperator
import typingsSlinky.gm.mod.CompressionType
import typingsSlinky.gm.mod.DisposeMethod
import typingsSlinky.gm.mod.Encoding
import typingsSlinky.gm.mod.EndianType
import typingsSlinky.gm.mod.FilterType
import typingsSlinky.gm.mod.GravityDirection
import typingsSlinky.gm.mod.HighlightStyle
import typingsSlinky.gm.mod.ImageType
import typingsSlinky.gm.mod.IntentType
import typingsSlinky.gm.mod.InterlaceType
import typingsSlinky.gm.mod.LimitType
import typingsSlinky.gm.mod.ListType
import typingsSlinky.gm.mod.NamedColor
import typingsSlinky.gm.mod.NoiseType
import typingsSlinky.gm.mod.OperationMode
import typingsSlinky.gm.mod.PreviewType
import typingsSlinky.gm.mod.ResizeOption
import typingsSlinky.gm.mod.SetDrawMethod
import typingsSlinky.gm.mod.SetDrawProperty
import typingsSlinky.gm.mod.UnitType
import typingsSlinky.gm.mod.VirtualPixelMethod
import typingsSlinky.gm.mod.VisualType
