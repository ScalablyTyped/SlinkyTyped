...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.gm.gmStrings.Point
  - typingsSlinky.gm.gmStrings.Box
  - typingsSlinky.gm.gmStrings.Triangle
  - typingsSlinky.gm.gmStrings.Hermite
  - typingsSlinky.gm.gmStrings.Hanning
  - typingsSlinky.gm.gmStrings.Hamming
  - typingsSlinky.gm.gmStrings.Blackman
  - typingsSlinky.gm.gmStrings.Gaussian
  - typingsSlinky.gm.gmStrings.Quadratic
  - typingsSlinky.gm.gmStrings.Cubic
  - typingsSlinky.gm.gmStrings.Catrom
  - typingsSlinky.gm.gmStrings.Mitchell
  - typingsSlinky.gm.gmStrings.Lanczos
  - typingsSlinky.gm.gmStrings.Bessel
  - typingsSlinky.gm.gmStrings.Sinc
*/
