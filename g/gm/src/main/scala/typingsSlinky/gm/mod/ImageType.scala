...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.gm.gmStrings.Bilevel
  - typingsSlinky.gm.gmStrings.Grayscale_
  - typingsSlinky.gm.gmStrings.Palette
  - typingsSlinky.gm.gmStrings.PaletteMatte
  - typingsSlinky.gm.gmStrings.TrueColor
  - typingsSlinky.gm.gmStrings.TrueColorMatte
  - typingsSlinky.gm.gmStrings.ColorSeparation
  - typingsSlinky.gm.gmStrings.ColorSeparationMatte
  - typingsSlinky.gm.gmStrings.Optimize
*/
