...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.gm.gmStrings.AdobeCustom
  - typingsSlinky.gm.gmStrings.AdobeExpert
  - typingsSlinky.gm.gmStrings.AdobeStandard
  - typingsSlinky.gm.gmStrings.AppleRoman
  - typingsSlinky.gm.gmStrings.BIG5
  - typingsSlinky.gm.gmStrings.GB2312
  - typingsSlinky.gm.gmStrings.`Latin 2`
  - typingsSlinky.gm.gmStrings.None
  - typingsSlinky.gm.gmStrings.SJIScode
  - typingsSlinky.gm.gmStrings.Symbol
  - typingsSlinky.gm.gmStrings.Unicode
  - typingsSlinky.gm.gmStrings.Wansung
*/
