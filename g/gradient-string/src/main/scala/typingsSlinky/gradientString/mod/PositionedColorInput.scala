package typingsSlinky.gradientString.mod

import typingsSlinky.tinycolor2.mod.ColorInput
...
object PositionedColorInput {
  ...
  @scala.inline
  implicit class PositionedColorInputOps[Self <: PositionedColorInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: ColorInput): Self = this.set("color", value.asInstanceOf[js.Any])
