package typingsSlinky.gapiDotClientDotOslogin.gapi.client.oslogin

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotOslogin.Anon_Accesstoken
import typingsSlinky.gapiDotClientDotOslogin.Anon_AccesstokenAltBearertoken
