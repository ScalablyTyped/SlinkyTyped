...
import typingsSlinky.graygelf.mod.GelfMessage
...
object anon {
  ...
  trait A extends StObject {
    ...
    def a(short_message: js.Error, full_message: js.UndefOr[scala.Nothing], customFields: GelfMessage): GelfMessage = js.native
