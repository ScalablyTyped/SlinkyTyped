...
import typingsSlinky.gitlab.anon.forkedFromIdnumberundefin
import typingsSlinky.gitlab.anon.metadataUploadMetadataund
import typingsSlinky.gitlab.anon.userIdnumberundefinedBase
import typingsSlinky.gitlab.baseServiceMod.BaseServiceOptions
import typingsSlinky.gitlab.eventsMod.EventOptions
import typingsSlinky.gitlab.groupsMod.GroupSchema
...
object projectsMod {
  ...
  trait ProjectSchema extends StObject {
    ...
    var last_activity_at: js.Date = js.native
  ...
  object ProjectSchema {
    ...
    implicit class ProjectSchemaMutableBuilder[Self <: ProjectSchema] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLast_activity_at(value: js.Date): Self = StObject.set(x, "last_activity_at", value.asInstanceOf[js.Any])
