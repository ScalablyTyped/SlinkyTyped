...
package object mod {
  type Gitlab = typingsSlinky.std.InstanceType[
    typingsSlinky.gitlab.utilsMod.Bundle[
  ...
  type GroupsBundle = typingsSlinky.std.InstanceType[
    typingsSlinky.gitlab.utilsMod.Bundle[
      typingsSlinky.gitlab.anon.EpicIssues, 
