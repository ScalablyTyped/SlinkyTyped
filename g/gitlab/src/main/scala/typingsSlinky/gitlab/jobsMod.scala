...
import typingsSlinky.gitlab.anon.scopeJobScopeundefinedSud
import typingsSlinky.gitlab.anon.streambooleanundefinedBas
import typingsSlinky.gitlab.baseServiceMod.BaseServiceOptions
import typingsSlinky.gitlab.commitsMod.CommitSchema
import typingsSlinky.gitlab.infrastructureMod.BaseService
import typingsSlinky.gitlab.pipelinesMod.PipelineSchema
import typingsSlinky.gitlab.requestHelperMod.GetResponse
import typingsSlinky.gitlab.requestHelperMod.PaginatedRequestOptions
import typingsSlinky.gitlab.requestHelperMod.Sudo
import typingsSlinky.gitlab.runnersMod.RunnerSchema
import typingsSlinky.gitlab.usersMod.UserSchema
...
object jobsMod {
  ...
  trait JobSchema extends StObject {
    ...
    var artifacts_expire_at: js.UndefOr[js.Date] = js.native
    ...
    var finished_at: js.UndefOr[js.Date] = js.native
    ...
    var started_at: js.UndefOr[js.Date] = js.native
  ...
  object JobSchema {
    ...
    implicit class JobSchemaMutableBuilder[Self <: JobSchema] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArtifacts_expire_at(value: js.Date): Self = StObject.set(x, "artifacts_expire_at", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFinished_at(value: js.Date): Self = StObject.set(x, "finished_at", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStarted_at(value: js.Date): Self = StObject.set(x, "started_at", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object JobScope {
    ...
    @scala.inline
    def canceled: typingsSlinky.gitlab.gitlabStrings.canceled = "canceled".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.canceled]
    
    @scala.inline
    def created: typingsSlinky.gitlab.gitlabStrings.created = "created".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.created]
    
    @scala.inline
    def failed: typingsSlinky.gitlab.gitlabStrings.failed = "failed".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.failed]
    
    @scala.inline
    def manual: typingsSlinky.gitlab.gitlabStrings.manual = "manual".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.manual]
    
    @scala.inline
    def pending: typingsSlinky.gitlab.gitlabStrings.pending = "pending".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.pending]
    
    @scala.inline
    def running: typingsSlinky.gitlab.gitlabStrings.running = "running".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.running]
    
    @scala.inline
    def skipped: typingsSlinky.gitlab.gitlabStrings.skipped = "skipped".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.skipped]
    
    @scala.inline
    def success: typingsSlinky.gitlab.gitlabStrings.success = "success".asInstanceOf[typingsSlinky.gitlab.gitlabStrings.success]
  }
}
