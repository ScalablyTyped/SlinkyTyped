...
@js.native
trait AnonEpicDiscussions extends js.Object {
...
object AnonEpicDiscussions {
  ...
  @scala.inline
  implicit class AnonEpicDiscussionsOps[Self <: AnonEpicDiscussions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withEpicDiscussions(value: Instantiable1[js.UndefOr[/* options */ BaseServiceOptions], EpicDiscussions]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EpicDiscussions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEpicIssues(value: Instantiable0[EpicIssues]): Self = {
        val ret = this.duplicate
