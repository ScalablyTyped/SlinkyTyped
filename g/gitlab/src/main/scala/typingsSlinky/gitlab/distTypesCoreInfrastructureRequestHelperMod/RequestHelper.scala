package typingsSlinky.gitlab.distTypesCoreInfrastructureRequestHelperMod

import typingsSlinky.gitlab.distTypesCoreInfrastructureBaseServiceMod.BaseService
