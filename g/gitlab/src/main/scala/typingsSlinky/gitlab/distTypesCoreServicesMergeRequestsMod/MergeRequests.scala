package typingsSlinky.gitlab.distTypesCoreServicesMergeRequestsMod

import typingsSlinky.gitlab.Anon_GroupIdNumber
import typingsSlinky.gitlab.Anon_MergerequestIId
import typingsSlinky.gitlab.Anon_ProjectIdNumber
import typingsSlinky.gitlab.Anon_Sha
