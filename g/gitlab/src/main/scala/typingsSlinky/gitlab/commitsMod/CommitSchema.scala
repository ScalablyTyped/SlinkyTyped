...
object CommitSchema {
  ...
  implicit class CommitSchemaOps[Self <: CommitSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthored_date(value: js.Date): Self = this.set("authored_date", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAuthored_date: Self = this.set("authored_date", js.undefined)
    
    @scala.inline
    def setCommitted_date(value: js.Date): Self = this.set("committed_date", value.asInstanceOf[js.Any])
