...
object JobSchema {
  ...
  implicit class JobSchemaOps[Self <: JobSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArtifacts_expire_at(value: js.Date): Self = this.set("artifacts_expire_at", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFinished_at(value: js.Date): Self = this.set("finished_at", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFinished_at: Self = this.set("finished_at", js.undefined)
    
    @scala.inline
    def setStarted_at(value: js.Date): Self = this.set("started_at", value.asInstanceOf[js.Any])
