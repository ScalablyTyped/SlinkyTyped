...
@js.native
trait AnonCurrentDocumentexists extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCurrentDocumentexists {
  @scala.inline
  def apply(name: String): AnonCurrentDocumentexists = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCurrentDocumentexists]
  }
  @scala.inline
  implicit class AnonCurrentDocumentexistsOps[Self <: AnonCurrentDocumentexists] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUpdateMaskDotfieldPaths(value: String): Self = {
        val ret = this.duplicate
