...
object GraphQLSchemaextensionsEnAstNode {
  ...
  @scala.inline
  implicit class GraphQLSchemaextensionsEnAstNodeOps[Self <: GraphQLSchemaextensionsEnAstNode] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def with_extensionsEnabled(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_extensionsEnabled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def without_extensionsEnabled: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_extensionsEnabled")(js.undefined)
        ret
    }
    @scala.inline
