...
import typingsSlinky.grammarkdown.diagnosticsMod.Diagnostic
...
object diagnosticsGeneratedMod {
  ...
  object Diagnostics {
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Cannot_find_name_0_")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Constant_expected")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Digit_expected")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Duplicate_identifier_0_")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Duplicate_terminal_0_")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.HTML_trivia_not_allowed_here")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Invalid_character")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Invalid_escape_sequence")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Obsolete_0_")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Parameter_0_is_unused")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Production_0_does_not_have_a_parameter_named_1_")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Production_0_is_missing_parameter_1_All_definitions_of_production_0_must_specify_the_same_formal_parameters")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Production_expected")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.There_is_no_argument_given_for_parameter_0_")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Unexpected_token_0_")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Unterminated_identifier_literal")
    @js.native
    ...
    @JSImport("grammarkdown/dist/diagnostics.generated", "Diagnostics.Unterminated_string_literal")
    @js.native
