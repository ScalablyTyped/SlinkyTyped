...
import typingsSlinky.grammarkdown.anon.PartialKnownOptionAliasFor
...
object optionsMod {
  ...
  object EmitFormat extends StObject {
    ...
    /* 2 */ val ecmarkup: typingsSlinky.grammarkdown.optionsMod.EmitFormat.ecmarkup with Double = js.native
    ...
    /* 1 */ val html: typingsSlinky.grammarkdown.optionsMod.EmitFormat.html with Double = js.native
    ...
    /* 0 */ val markdown: typingsSlinky.grammarkdown.optionsMod.EmitFormat.markdown with Double = js.native
  }
  ...
  object NewLineKind extends StObject {
    ...
    /* 1 */ val CarriageReturnLineFeed: typingsSlinky.grammarkdown.optionsMod.NewLineKind.CarriageReturnLineFeed with Double = js.native
    ...
    /* 0 */ val LineFeed: typingsSlinky.grammarkdown.optionsMod.NewLineKind.LineFeed with Double = js.native
  }
