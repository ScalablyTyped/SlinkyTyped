...
import typingsSlinky.grammarkdown.Anon_Detailed
import typingsSlinky.grammarkdown.Anon_DetailedMessage
import typingsSlinky.grammarkdown.distCoreMod.Range
...
class DiagnosticMessages () extends js.Object {
  ...
  def getDiagnosticInfo(diagnosticIndex: Double, options: Anon_DetailedMessage): js.UndefOr[DiagnosticInfo] = js.native
  def getDiagnosticInfos(): js.Array[DiagnosticInfo] = js.native
  def getDiagnosticInfos(options: Anon_DetailedMessage): js.Array[DiagnosticInfo] = js.native
  def getDiagnosticInfosForSourceFile(sourceFile: SourceFile): js.Array[DiagnosticInfo] = js.native
  def getDiagnosticInfosForSourceFile(sourceFile: SourceFile, options: Anon_DetailedMessage): js.Array[DiagnosticInfo] = js.native
  ...
  def getMessage(diagnosticIndex: Double, options: Anon_Detailed): String = js.native
