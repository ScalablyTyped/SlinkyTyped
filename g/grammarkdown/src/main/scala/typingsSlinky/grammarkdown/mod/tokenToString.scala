...
object tokenToString extends js.Object {
  ...
  def apply(kind: typingsSlinky.grammarkdown.tokensMod.SyntaxKind): String = js.native
  def apply(kind: typingsSlinky.grammarkdown.tokensMod.SyntaxKind, quoted: Boolean): String = js.native
}
