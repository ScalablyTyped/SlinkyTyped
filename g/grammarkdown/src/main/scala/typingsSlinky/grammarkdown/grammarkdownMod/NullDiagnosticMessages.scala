...
class NullDiagnosticMessages ()
  extends typingsSlinky.grammarkdown.distDiagnosticsMod.NullDiagnosticMessages
...
object NullDiagnosticMessages extends js.Object {
  ...
  val instance: typingsSlinky.grammarkdown.distDiagnosticsMod.NullDiagnosticMessages = js.native
}
