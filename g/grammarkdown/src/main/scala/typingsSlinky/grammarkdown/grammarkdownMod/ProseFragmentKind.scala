...
/* keyof grammarkdown.grammarkdown/dist/grammarkdown.ProseFragmentTypes */ /* Rewritten from type alias, can be one of: 
  - typingsSlinky.grammarkdown.grammarkdownStrings.`52`
  - typingsSlinky.grammarkdown.grammarkdownStrings.`49`
