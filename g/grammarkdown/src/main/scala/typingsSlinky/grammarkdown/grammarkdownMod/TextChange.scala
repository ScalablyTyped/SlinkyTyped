...
object TextChange {
  ...
  @js.native
  def clone_(change: TextChange): typingsSlinky.grammarkdown.anon.Range = js.native
  
  @JSImport("grammarkdown/dist/grammarkdown", "TextChange.create")
  @js.native
  def create(text: String, range: Range2): typingsSlinky.grammarkdown.anon.Range = js.native
