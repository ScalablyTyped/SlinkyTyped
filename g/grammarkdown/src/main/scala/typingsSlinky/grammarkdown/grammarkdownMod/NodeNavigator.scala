...
class NodeNavigator protected () extends StObject {
  ...
  def getNode(): Node2[SyntaxKind] = js.native
  ...
  def moveToAncestor(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  ...
  def moveToFirstChild(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToFirstElement(): Boolean = js.native
  def moveToFirstElement(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToFirstSibling(): Boolean = js.native
  def moveToFirstSibling(name: String): Boolean = js.native
  def moveToFirstSibling(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToLastChild(): Boolean = js.native
  def moveToLastChild(name: String): Boolean = js.native
  def moveToLastChild(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToLastElement(): Boolean = js.native
  def moveToLastElement(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToLastSibling(): Boolean = js.native
  def moveToLastSibling(name: String): Boolean = js.native
  def moveToLastSibling(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToName(): Boolean = js.native
  
  def moveToNextElement(): Boolean = js.native
  def moveToNextElement(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToNextSibling(): Boolean = js.native
  def moveToNextSibling(name: String): Boolean = js.native
  def moveToNextSibling(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  
  def moveToParent(): Boolean = js.native
  def moveToParent(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
  ...
  def moveToPreviousSibling(predicate: js.Function1[/* node */ Node2[SyntaxKind], Boolean]): Boolean = js.native
