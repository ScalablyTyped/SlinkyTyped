...
abstract class NodeVisitor () extends StObject {
  ...
  def visit[T /* <: Node2[SyntaxKind] */](node: T): js.UndefOr[T] = js.native
  ...
  def visitEach[T /* <: Node2[SyntaxKind] */](nodes: js.Array[T]): js.UndefOr[js.Array[T]] = js.native
  @JSName("visitEach")
  def visitEach_T_Node2SyntaxKind_Array[T /* <: Node2[SyntaxKind] */](nodes: js.Array[T]): js.Array[T] = js.native
  ...
  @JSName("visit")
  def visit_T_Node2SyntaxKind_T[T /* <: Node2[SyntaxKind] */](node: T): T = js.native
}
