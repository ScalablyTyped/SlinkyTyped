...
object tokenToString extends js.Object {
  ...
  def apply(kind: typingsSlinky.grammarkdown.distTokensMod.SyntaxKind): String = js.native
  def apply(kind: typingsSlinky.grammarkdown.distTokensMod.SyntaxKind, quoted: Boolean): String = js.native
}
