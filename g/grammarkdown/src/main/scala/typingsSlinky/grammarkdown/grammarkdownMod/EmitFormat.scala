...
object EmitFormat extends StObject {
  ...
  /* 2 */ val ecmarkup: typingsSlinky.grammarkdown.grammarkdownMod.EmitFormat.ecmarkup with Double = js.native
  
  @js.native
  sealed trait html extends EmitFormat
  /* 1 */ val html: typingsSlinky.grammarkdown.grammarkdownMod.EmitFormat.html with Double = js.native
  
  @js.native
  sealed trait markdown extends EmitFormat
  /* 0 */ val markdown: typingsSlinky.grammarkdown.grammarkdownMod.EmitFormat.markdown with Double = js.native
}
