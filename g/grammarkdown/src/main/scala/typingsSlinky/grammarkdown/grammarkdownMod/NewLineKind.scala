...
object NewLineKind extends StObject {
  ...
  /* 1 */ val CarriageReturnLineFeed: typingsSlinky.grammarkdown.grammarkdownMod.NewLineKind.CarriageReturnLineFeed with Double = js.native
  
  @js.native
  sealed trait LineFeed extends NewLineKind
  /* 0 */ val LineFeed: typingsSlinky.grammarkdown.grammarkdownMod.NewLineKind.LineFeed with Double = js.native
}
