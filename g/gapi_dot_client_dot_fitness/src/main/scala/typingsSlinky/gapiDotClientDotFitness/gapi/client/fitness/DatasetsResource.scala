...
import typingsSlinky.gapiDotClientDotFitness.Anon_AltCurrentTimeMillis
import typingsSlinky.gapiDotClientDotFitness.Anon_AltCurrentTimeMillisDataSourceId
import typingsSlinky.gapiDotClientDotFitness.Anon_AltDataSourceId
