...
object AnonDataSourceId {
  @scala.inline
  def apply(dataSourceId: String, datasetId: String, userId: String): AnonDataSourceId = {
  ...
  @scala.inline
  implicit class AnonDataSourceIdOps[Self <: AnonDataSourceId] (val x: Self) extends AnyVal {
    @scala.inline
