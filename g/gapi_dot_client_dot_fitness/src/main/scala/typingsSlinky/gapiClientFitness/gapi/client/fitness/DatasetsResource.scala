...
import typingsSlinky.gapiClientFitness.AnonCurrentTimeMillis
import typingsSlinky.gapiClientFitness.AnonDataSourceId
import typingsSlinky.gapiClientFitness.AnonDatasetId
...
trait DatasetsResource extends js.Object {
  /**
    ...
    * deleted.
    */
  def delete(request: AnonCurrentTimeMillis): Request_[Unit] = js.native
  /**
    ...
    */
  def get(request: AnonDataSourceId): Request_[Dataset] = js.native
  /**
...
object DatasetsResource {
  ...
  implicit class DatasetsResourceOps[Self <: DatasetsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDelete(value: AnonCurrentTimeMillis => Request_[Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("delete")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGet(value: AnonDataSourceId => Request_[Dataset]): Self = {
        val ret = this.duplicate
