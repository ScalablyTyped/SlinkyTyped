...
import typingsSlinky.gapiClientFitness.anon.DataTypeName
import typingsSlinky.gapiClientFitness.anon.Fields
import typingsSlinky.gapiClientFitness.anon.Key
...
object DataSourcesResource {
  ...
  implicit class DataSourcesResourceOps[Self <: DataSourcesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: Fields => Request[DataSource]): Self = {
    ...
    @scala.inline
    def withDelete(value: Key => Request[DataSource]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("delete")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGet(value: Key => Request[DataSource]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: DataTypeName => Request[ListDataSourcesResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: Key => Request[DataSource]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("patch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdate(value: Key => Request[DataSource]): Self = {
        val ret = this.duplicate
