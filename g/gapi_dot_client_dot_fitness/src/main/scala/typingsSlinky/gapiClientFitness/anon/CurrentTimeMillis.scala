...
@js.native
trait CurrentTimeMillis extends js.Object {
...
object CurrentTimeMillis {
  @scala.inline
  def apply(dataSourceId: String, datasetId: String, userId: String): CurrentTimeMillis = {
    ...
    __obj.asInstanceOf[CurrentTimeMillis]
  }
  @scala.inline
  implicit class CurrentTimeMillisOps[Self <: CurrentTimeMillis] (val x: Self) extends AnyVal {
    @scala.inline
