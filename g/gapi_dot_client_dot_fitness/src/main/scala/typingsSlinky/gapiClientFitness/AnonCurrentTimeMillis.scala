...
object AnonCurrentTimeMillis {
  @scala.inline
  def apply(dataSourceId: String, datasetId: String, userId: String): AnonCurrentTimeMillis = {
  ...
  @scala.inline
  implicit class AnonCurrentTimeMillisOps[Self <: AnonCurrentTimeMillis] (val x: Self) extends AnyVal {
    @scala.inline
