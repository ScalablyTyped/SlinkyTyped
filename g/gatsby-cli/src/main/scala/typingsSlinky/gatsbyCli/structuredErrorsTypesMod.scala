...
import typingsSlinky.gatsbyCli.anon.Dictkey
...
object structuredErrorsTypesMod {
  ...
  object Level extends StObject {
    ...
    /* "DEBUG" */ val DEBUG: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Level.DEBUG with String = js.native
    
    @js.native
    sealed trait ERROR extends Level
    /* "ERROR" */ val ERROR: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Level.ERROR with String = js.native
    
    @js.native
    sealed trait INFO extends Level
    /* "INFO" */ val INFO: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Level.INFO with String = js.native
    
    @js.native
    sealed trait WARNING extends Level
    /* "WARNING" */ val WARNING: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Level.WARNING with String = js.native
  }
  ...
  object Type extends StObject {
    ...
    /* "CONFIG" */ val CONFIG: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Type.CONFIG with String = js.native
    
    @js.native
    sealed trait GRAPHQL extends Type
    /* "GRAPHQL" */ val GRAPHQL: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Type.GRAPHQL with String = js.native
    
    @js.native
    sealed trait PLUGIN extends Type
    /* "PLUGIN" */ val PLUGIN: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Type.PLUGIN with String = js.native
    
    @js.native
    sealed trait WEBPACK extends Type
    /* "WEBPACK" */ val WEBPACK: typingsSlinky.gatsbyCli.structuredErrorsTypesMod.Type.WEBPACK with String = js.native
  }
