...
object Dictkey {
  ...
  implicit class DictkeyMutableBuilder[Self <: Dictkey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContext(value: Record[String, String]): Self = StObject.set(x, "context", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setId(value: ErrorId): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
