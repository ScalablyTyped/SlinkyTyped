...
import typingsSlinky.gatsbyCli.gatsbyCliBooleans.`false`
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgBlack
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgBlackBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgBlue
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgBlueBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgCyan
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgCyanBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgGray
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgGreen
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgGreenBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgGrey
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgMagenta
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgMagentaBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgRed
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgRedBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgWhite
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgWhiteBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgYellow
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bgYellowBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.black
import typingsSlinky.gatsbyCli.gatsbyCliStrings.blackBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.blue
import typingsSlinky.gatsbyCli.gatsbyCliStrings.blueBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.bold
import typingsSlinky.gatsbyCli.gatsbyCliStrings.cyan
import typingsSlinky.gatsbyCli.gatsbyCliStrings.cyanBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.dim
import typingsSlinky.gatsbyCli.gatsbyCliStrings.gray
import typingsSlinky.gatsbyCli.gatsbyCliStrings.green
import typingsSlinky.gatsbyCli.gatsbyCliStrings.greenBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.grey
import typingsSlinky.gatsbyCli.gatsbyCliStrings.hidden
import typingsSlinky.gatsbyCli.gatsbyCliStrings.inverse
import typingsSlinky.gatsbyCli.gatsbyCliStrings.italic
import typingsSlinky.gatsbyCli.gatsbyCliStrings.magenta
import typingsSlinky.gatsbyCli.gatsbyCliStrings.magentaBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.red
import typingsSlinky.gatsbyCli.gatsbyCliStrings.redBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.reset
import typingsSlinky.gatsbyCli.gatsbyCliStrings.strikethrough
import typingsSlinky.gatsbyCli.gatsbyCliStrings.underline
import typingsSlinky.gatsbyCli.gatsbyCliStrings.visible
import typingsSlinky.gatsbyCli.gatsbyCliStrings.white
import typingsSlinky.gatsbyCli.gatsbyCliStrings.whiteBright
import typingsSlinky.gatsbyCli.gatsbyCliStrings.yellow
import typingsSlinky.gatsbyCli.gatsbyCliStrings.yellowBright
...
/* Inlined chalk.chalk.Chalk & chalk.chalk.ChalkFunction & {  supportsColor :false | chalk.chalk.ColorSupport,   Level :chalk.chalk.Level,   Color :'red' | 'white' | 'black' | 'green' | 'yellow' | 'blue' | 'magenta' | 'cyan' | 'gray' | 'grey' | 'blackBright' | 'redBright' | 'greenBright' | 'yellowBright' | 'blueBright' | 'magentaBright' | 'cyanBright' | 'whiteBright' | 'bgBlack' | 'bgRed' | 'bgGreen' | 'bgYellow' | 'bgBlue' | 'bgMagenta' | 'bgCyan' | 'bgWhite' | 'bgGray' | 'bgGrey' | 'bgBlackBright' | 'bgRedBright' | 'bgGreenBright' | 'bgYellowBright' | 'bgBlueBright' | 'bgMagentaBright' | 'bgCyanBright' | 'bgWhiteBright',   ForegroundColor :'red' | 'white' | 'black' | 'green' | 'yellow' | 'blue' | 'magenta' | 'cyan' | 'gray' | 'grey' | 'blackBright' | 'redBright' | 'greenBright' | 'yellowBright' | 'blueBright' | 'magentaBright' | 'cyanBright' | 'whiteBright',   BackgroundColor :'bgBlack' | 'bgRed' | 'bgGreen' | 'bgYellow' | 'bgBlue' | 'bgMagenta' | 'bgCyan' | 'bgWhite' | 'bgGray' | 'bgGrey' | 'bgBlackBright' | 'bgRedBright' | 'bgGreenBright' | 'bgYellowBright' | 'bgBlueBright' | 'bgMagentaBright' | 'bgCyanBright' | 'bgWhiteBright',   Modifiers :'reset' | 'bold' | 'dim' | 'italic' | 'underline' | 'inverse' | 'hidden' | 'strikethrough' | 'visible',   stderr :chalk.chalk.Chalk & {  supportsColor :false | chalk.chalk.ColorSupport}} */
@js.native
trait ChalkChalkFunctionsupport extends StObject {
  ...
  var BackgroundColor: bgBlack | bgRed | bgGreen | bgYellow | bgBlue | bgMagenta | bgCyan | bgWhite | bgGray | bgGrey | bgBlackBright | bgRedBright | bgGreenBright | bgYellowBright | bgBlueBright | bgMagentaBright | bgCyanBright | bgWhiteBright = js.native
  ...
  var ForegroundColor: red | white | black | green | yellow | blue | magenta | cyan | gray | grey | blackBright | redBright | greenBright | yellowBright | blueBright | magentaBright | cyanBright | whiteBright = js.native
  ...
  var Level: typingsSlinky.chalk.mod.Level = js.native
  
  var Modifiers: reset | bold | dim | italic | underline | inverse | hidden | strikethrough | visible = js.native
  ...
  var stderr: ChalksupportsColorfalseCo = js.native
  ...
  var supportsColor: `false` | ColorSupport = js.native
