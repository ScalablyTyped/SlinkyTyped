package typingsSlinky.gapiClientConsumersurveys.anon
...
object Alt {
  ...
  implicit class AltOps[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPanelId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("panelId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
