...
import typingsSlinky.googleDashDriveDashRealtimeDashApi.gapi.drive.realtime.Document
import typingsSlinky.googleDashDriveDashRealtimeDashApi.gapi.drive.realtime.Model
