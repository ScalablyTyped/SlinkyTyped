...
import typingsSlinky.googleDriveRealtimeApi.gapi.drive.realtime.CollaborativeObjectType
import typingsSlinky.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType
import typingsSlinky.googleDriveRealtimeApi.gapi.drive.realtime.EventType
