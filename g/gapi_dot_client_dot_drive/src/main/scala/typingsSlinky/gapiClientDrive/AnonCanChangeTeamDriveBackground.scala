...
object AnonCanChangeTeamDriveBackground {
  @scala.inline
  def apply(): AnonCanChangeTeamDriveBackground = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCanChangeTeamDriveBackground]
  }
  @scala.inline
  implicit class AnonCanChangeTeamDriveBackgroundOps[Self <: AnonCanChangeTeamDriveBackground] (val x: Self) extends AnyVal {
    @scala.inline
