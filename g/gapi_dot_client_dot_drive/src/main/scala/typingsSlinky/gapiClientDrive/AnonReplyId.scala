...
@js.native
trait AnonReplyId extends js.Object {
...
object AnonReplyId {
  @scala.inline
  def apply(commentId: String, fileId: String, replyId: String): AnonReplyId = {
    ...
    __obj.asInstanceOf[AnonReplyId]
  }
  @scala.inline
  implicit class AnonReplyIdOps[Self <: AnonReplyId] (val x: Self) extends AnyVal {
    @scala.inline
