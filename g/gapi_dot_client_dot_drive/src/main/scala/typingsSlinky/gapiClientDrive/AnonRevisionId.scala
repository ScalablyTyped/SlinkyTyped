...
@js.native
trait AnonRevisionId extends js.Object {
...
object AnonRevisionId {
  @scala.inline
  def apply(fileId: String, revisionId: String): AnonRevisionId = {
    val __obj = js.Dynamic.literal(fileId = fileId.asInstanceOf[js.Any], revisionId = revisionId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonRevisionId]
  }
  @scala.inline
  implicit class AnonRevisionIdOps[Self <: AnonRevisionId] (val x: Self) extends AnyVal {
    @scala.inline
