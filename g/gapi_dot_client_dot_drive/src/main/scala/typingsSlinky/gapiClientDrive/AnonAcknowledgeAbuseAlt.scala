...
object AnonAcknowledgeAbuseAlt {
  @scala.inline
  def apply(fileId: String, revisionId: String): AnonAcknowledgeAbuseAlt = {
  ...
  @scala.inline
  implicit class AnonAcknowledgeAbuseAltOps[Self <: AnonAcknowledgeAbuseAlt] (val x: Self) extends AnyVal {
    @scala.inline
