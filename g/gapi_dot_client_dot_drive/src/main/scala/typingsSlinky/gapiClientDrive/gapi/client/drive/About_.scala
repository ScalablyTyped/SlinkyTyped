...
import typingsSlinky.gapiClientDrive.AnonBackgroundImageLink
import typingsSlinky.gapiClientDrive.AnonLimit
...
object About_ {
  ...
  @scala.inline
  implicit class About_Ops[Self <: About_] (val x: Self) extends AnyVal {
    @scala.inline
