...
import typingsSlinky.gapiClientDrive.anon.CanAddMyDriveParent
import typingsSlinky.gapiClientDrive.anon.DurationMillis
import typingsSlinky.gapiClientDrive.anon.IndexableText
import typingsSlinky.gapiClientDrive.anon.TargetId
...
trait File extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.gapiClientDrive.gapiClientDriveStrings.File with TopLevel[js.Any]
  ] = js.native
  /** Capabilities the current user has on this file. Each capability corresponds to a fine-grained action that a user may take. */
  var capabilities: js.UndefOr[CanAddMyDriveParent] = js.native
...
object File {
  ...
  implicit class FileOps[Self <: File] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCapabilities(value: CanAddMyDriveParent): Self = this.set("capabilities", value.asInstanceOf[js.Any])
    @scala.inline
