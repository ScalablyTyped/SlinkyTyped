...
import typingsSlinky.gapiClientDrive.anon.CanChangeCopyRequiresWriterPermissionRestriction
import typingsSlinky.gapiClientDrive.anon.CopyRequiresWriterPermission
