...
object AnonUseDomainAdminAccess {
  @scala.inline
  def apply(teamDriveId: String): AnonUseDomainAdminAccess = {
    val __obj = js.Dynamic.literal(teamDriveId = teamDriveId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonUseDomainAdminAccess]
  }
  @scala.inline
  implicit class AnonUseDomainAdminAccessOps[Self <: AnonUseDomainAdminAccess] (val x: Self) extends AnyVal {
    @scala.inline
