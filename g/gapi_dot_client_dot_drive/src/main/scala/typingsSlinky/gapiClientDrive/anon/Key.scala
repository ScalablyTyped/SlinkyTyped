...
object Key {
  ...
  implicit class KeyOps[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStartModifiedTime(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startModifiedTime")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStartModifiedTime: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startModifiedTime")(js.undefined)
        ret
    }
    @scala.inline
