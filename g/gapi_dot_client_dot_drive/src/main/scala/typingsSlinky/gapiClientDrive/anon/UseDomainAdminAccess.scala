...
object UseDomainAdminAccess {
  @scala.inline
  def apply(driveId: String): UseDomainAdminAccess = {
    val __obj = js.Dynamic.literal(driveId = driveId.asInstanceOf[js.Any])
    __obj.asInstanceOf[UseDomainAdminAccess]
  }
  @scala.inline
  implicit class UseDomainAdminAccessOps[Self <: UseDomainAdminAccess] (val x: Self) extends AnyVal {
    @scala.inline
