...
object AnonQuotaUser {
  @scala.inline
  def apply(fileId: String, permissionId: String): AnonQuotaUser = {
  ...
  @scala.inline
  implicit class AnonQuotaUserOps[Self <: AnonQuotaUser] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRemoveExpiration(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeExpiration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRemoveExpiration: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeExpiration")(js.undefined)
        ret
    }
    @scala.inline
