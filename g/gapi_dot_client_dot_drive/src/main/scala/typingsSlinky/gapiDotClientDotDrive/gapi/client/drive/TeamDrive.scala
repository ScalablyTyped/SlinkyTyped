...
import typingsSlinky.gapiDotClientDotDrive.Anon_CanAddChildrenCanChangeTeamDriveBackground
import typingsSlinky.gapiDotClientDotDrive.Anon_Id
...
trait TeamDrive extends js.Object {
  /**
    ...
    */
  var backgroundImageFile: js.UndefOr[Anon_Id] = js.undefined
  /** A short-lived link to this Team Drive's background image. */
  var backgroundImageLink: js.UndefOr[String] = js.undefined
  /** Capabilities the current user has on this Team Drive. */
  var capabilities: js.UndefOr[Anon_CanAddChildrenCanChangeTeamDriveBackground] = js.undefined
...
object TeamDrive {
  @scala.inline
  def apply(
    backgroundImageFile: Anon_Id = null,
    backgroundImageLink: String = null,
    capabilities: Anon_CanAddChildrenCanChangeTeamDriveBackground = null,
