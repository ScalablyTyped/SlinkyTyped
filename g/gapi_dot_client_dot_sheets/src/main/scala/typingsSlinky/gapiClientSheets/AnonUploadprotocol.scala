...
import typingsSlinky.gapiClientSheets.gapi.client.sheets.BatchUpdateSpreadsheetRequest
...
object AnonUploadprotocol {
  @scala.inline
  def apply(resource: BatchUpdateSpreadsheetRequest, spreadsheetId: String): AnonUploadprotocol = {
  ...
  implicit class AnonUploadprotocolOps[Self <: AnonUploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchUpdateSpreadsheetRequest): Self = {
