...
object AnonMajorDimension {
  @scala.inline
  def apply(range: String, spreadsheetId: String): AnonMajorDimension = {
    val __obj = js.Dynamic.literal(range = range.asInstanceOf[js.Any], spreadsheetId = spreadsheetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonMajorDimension]
  }
  @scala.inline
  implicit class AnonMajorDimensionOps[Self <: AnonMajorDimension] (val x: Self) extends AnyVal {
    @scala.inline
