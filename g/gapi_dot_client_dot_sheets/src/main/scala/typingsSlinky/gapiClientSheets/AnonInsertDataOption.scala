...
object AnonInsertDataOption {
  @scala.inline
  def apply(range: String, spreadsheetId: String): AnonInsertDataOption = {
  ...
  @scala.inline
  implicit class AnonInsertDataOptionOps[Self <: AnonInsertDataOption] (val x: Self) extends AnyVal {
    @scala.inline
