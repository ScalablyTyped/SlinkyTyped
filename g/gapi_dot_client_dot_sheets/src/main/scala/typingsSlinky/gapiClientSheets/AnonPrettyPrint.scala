...
import typingsSlinky.gapiClientSheets.gapi.client.sheets.BatchClearValuesByDataFilterRequest
...
object AnonPrettyPrint {
  @scala.inline
  def apply(resource: BatchClearValuesByDataFilterRequest, spreadsheetId: String): AnonPrettyPrint = {
  ...
  implicit class AnonPrettyPrintOps[Self <: AnonPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchClearValuesByDataFilterRequest): Self = {
