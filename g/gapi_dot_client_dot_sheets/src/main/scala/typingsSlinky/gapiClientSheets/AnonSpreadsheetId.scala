...
object AnonSpreadsheetId {
  @scala.inline
  def apply(resource: BatchUpdateValuesByDataFilterRequest, spreadsheetId: String): AnonSpreadsheetId = {
  ...
  @scala.inline
  implicit class AnonSpreadsheetIdOps[Self <: AnonSpreadsheetId] (val x: Self) extends AnyVal {
    @scala.inline
