...
object AnonResponseDateTimeRenderOption {
  @scala.inline
  def apply(range: String, resource: ValueRange, spreadsheetId: String): AnonResponseDateTimeRenderOption = {
  ...
  @scala.inline
  implicit class AnonResponseDateTimeRenderOptionOps[Self <: AnonResponseDateTimeRenderOption] (val x: Self) extends AnyVal {
    @scala.inline
