...
object AnonAltCallback {
  @scala.inline
  def apply(resource: GetSpreadsheetByDataFilterRequest, spreadsheetId: String): AnonAltCallback = {
  ...
  @scala.inline
  implicit class AnonAltCallbackOps[Self <: AnonAltCallback] (val x: Self) extends AnyVal {
    @scala.inline
