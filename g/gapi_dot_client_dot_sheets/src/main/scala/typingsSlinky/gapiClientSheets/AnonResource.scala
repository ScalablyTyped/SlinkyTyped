...
import typingsSlinky.gapiClientSheets.gapi.client.sheets.BatchUpdateValuesRequest
...
object AnonResource {
  @scala.inline
  def apply(resource: BatchUpdateValuesRequest, spreadsheetId: String): AnonResource = {
  ...
  implicit class AnonResourceOps[Self <: AnonResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchUpdateValuesRequest): Self = {
