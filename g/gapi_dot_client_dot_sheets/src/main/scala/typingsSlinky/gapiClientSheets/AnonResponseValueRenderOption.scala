...
@js.native
trait AnonResponseValueRenderOption extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonResponseValueRenderOption {
  @scala.inline
  def apply(range: String, spreadsheetId: String): AnonResponseValueRenderOption = {
    val __obj = js.Dynamic.literal(range = range.asInstanceOf[js.Any], spreadsheetId = spreadsheetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonResponseValueRenderOption]
  }
  @scala.inline
  implicit class AnonResponseValueRenderOptionOps[Self <: AnonResponseValueRenderOption] (val x: Self) extends AnyVal {
    @scala.inline
