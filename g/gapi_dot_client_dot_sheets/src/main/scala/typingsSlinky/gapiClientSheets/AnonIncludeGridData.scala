...
object AnonIncludeGridData {
  @scala.inline
  def apply(spreadsheetId: String): AnonIncludeGridData = {
    val __obj = js.Dynamic.literal(spreadsheetId = spreadsheetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIncludeGridData]
  }
  @scala.inline
  implicit class AnonIncludeGridDataOps[Self <: AnonIncludeGridData] (val x: Self) extends AnyVal {
    @scala.inline
