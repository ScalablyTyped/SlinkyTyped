...
import typingsSlinky.gapiClientSheets.gapi.client.sheets.BatchGetValuesByDataFilterRequest
...
object AnonQuotaUser {
  @scala.inline
  def apply(resource: BatchGetValuesByDataFilterRequest, spreadsheetId: String): AnonQuotaUser = {
  ...
  implicit class AnonQuotaUserOps[Self <: AnonQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchGetValuesByDataFilterRequest): Self = {
