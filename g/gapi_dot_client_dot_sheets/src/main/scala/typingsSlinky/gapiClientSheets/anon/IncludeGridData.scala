...
@js.native
trait IncludeGridData extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object IncludeGridData {
  @scala.inline
  def apply(spreadsheetId: String): IncludeGridData = {
    val __obj = js.Dynamic.literal(spreadsheetId = spreadsheetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[IncludeGridData]
  }
  @scala.inline
  implicit class IncludeGridDataOps[Self <: IncludeGridData] (val x: Self) extends AnyVal {
    @scala.inline
