...
import typingsSlinky.gapiClientSheets.gapi.client.sheets.GetSpreadsheetByDataFilterRequest
...
object AltCallback {
  ...
  implicit class AltCallbackOps[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: GetSpreadsheetByDataFilterRequest): Self = {
