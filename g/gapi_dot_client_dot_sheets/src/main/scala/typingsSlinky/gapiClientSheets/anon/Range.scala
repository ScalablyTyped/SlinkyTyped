...
import typingsSlinky.gapiClientSheets.gapi.client.sheets.ClearValuesRequest
...
object Range {
  @scala.inline
  def apply(range: String, resource: ClearValuesRequest, spreadsheetId: String): Range = {
  ...
  implicit class RangeOps[Self <: Range] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ClearValuesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
    @scala.inline
