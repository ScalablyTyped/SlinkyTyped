...
import typingsSlinky.gapiClientSheets.gapi.client.sheets.BatchClearValuesRequest
...
trait AnonOauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: BatchClearValuesRequest = js.native
...
object AnonOauthtoken {
  @scala.inline
  def apply(resource: BatchClearValuesRequest, spreadsheetId: String): AnonOauthtoken = {
  ...
  implicit class AnonOauthtokenOps[Self <: AnonOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchClearValuesRequest): Self = {
