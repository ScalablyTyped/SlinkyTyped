...
trait SheetsResource extends js.Object {
  /**
    ...
    */
  def copyTo(request: Anon_AccesstokenAltCallback): typingsSlinky.gapiDotClient.gapi.client.Request[SheetProperties]
}

object SheetsResource {
  @scala.inline
  def apply(
    copyTo: Anon_AccesstokenAltCallback => typingsSlinky.gapiDotClient.gapi.client.Request[SheetProperties]
  ): SheetsResource = {
