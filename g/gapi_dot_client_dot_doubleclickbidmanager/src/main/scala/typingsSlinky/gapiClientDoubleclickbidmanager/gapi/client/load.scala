package typingsSlinky.gapiClientDoubleclickbidmanager.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientDoubleclickbidmanager.gapiClientDoubleclickbidmanagerStrings.doubleclickbidmanager,
    version: v1
