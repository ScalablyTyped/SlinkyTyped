package typingsSlinky.gapiClientIdentitytoolkit.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientIdentitytoolkit.gapiClientIdentitytoolkitStrings.identitytoolkit,
    version: v3
