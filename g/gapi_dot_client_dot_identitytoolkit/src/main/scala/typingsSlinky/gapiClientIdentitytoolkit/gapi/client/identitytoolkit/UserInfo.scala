...
object UserInfo {
  ...
  implicit class UserInfoOps[Self <: UserInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProviderUserInfoVarargs(value: Email*): Self = this.set("providerUserInfo", js.Array(value :_*))
    @scala.inline
    def setProviderUserInfo(value: js.Array[Email]): Self = this.set("providerUserInfo", value.asInstanceOf[js.Any])
    @scala.inline
