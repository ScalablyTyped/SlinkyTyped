...
@js.native
trait AnonDelegatedProjectNumber extends js.Object {
...
object AnonDelegatedProjectNumber {
  @scala.inline
  def apply(): AnonDelegatedProjectNumber = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDelegatedProjectNumber]
  }
  @scala.inline
  implicit class AnonDelegatedProjectNumberOps[Self <: AnonDelegatedProjectNumber] (val x: Self) extends AnyVal {
    @scala.inline
