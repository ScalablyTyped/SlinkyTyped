...
import typingsSlinky.gulp.Fn_File
...
@js.native
trait Gulp
  extends typingsSlinky.undertaker.undertakerMod.^ {
  /**
  ...
  def watch(globs: Globs, fn: typingsSlinky.undertaker.undertakerMod.TaskFunction): FSWatcher = js.native
  def watch(globs: Globs, opts: WatchOptions): FSWatcher = js.native
  def watch(globs: Globs, opts: WatchOptions, fn: typingsSlinky.undertaker.undertakerMod.TaskFunction): FSWatcher = js.native
}
