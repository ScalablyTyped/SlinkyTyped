...
import typingsSlinky.gapiClientPlusdomains.anon.Image
import typingsSlinky.gapiClientPlusdomains.anon.Time
...
object Media {
  ...
  implicit class MediaOps[Self <: Media] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAuthor(value: Image): Self = {
