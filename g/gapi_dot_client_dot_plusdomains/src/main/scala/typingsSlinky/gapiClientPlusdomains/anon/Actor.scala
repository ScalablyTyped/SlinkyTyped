...
object Actor {
  ...
  implicit class ActorOps[Self <: Actor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPlusoners(value: SelfLink): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReplies(value: SelfLink): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withResharers(value: SelfLink): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStatusForViewer(value: CanComment): Self = {
        val ret = this.duplicate
