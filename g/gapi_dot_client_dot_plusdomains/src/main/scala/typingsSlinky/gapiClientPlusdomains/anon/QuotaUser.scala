...
object QuotaUser {
  @scala.inline
  def apply(circleId: String): QuotaUser = {
  ...
  implicit class QuotaUserOps[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCircleId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("circleId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
