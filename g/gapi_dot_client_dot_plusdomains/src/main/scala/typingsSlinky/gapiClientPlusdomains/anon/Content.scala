...
object Content {
  ...
  implicit class ContentOps[Self <: Content] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFullImage(value: Height): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreviewThumbnails(value: js.Array[Url]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withThumbnails(value: js.Array[Description]): Self = {
        val ret = this.duplicate
