...
@js.native
trait CircleId extends js.Object {
...
object CircleId {
  ...
  @scala.inline
  def apply(circleId: String): CircleId = {
    val __obj = js.Dynamic.literal(circleId = circleId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CircleId]
  }
  
  @scala.inline
  implicit class CircleIdOps[Self <: CircleId] (val x: Self) extends AnyVal {
