...
object AnonPageToken {
  @scala.inline
  def apply(activityId: String, collection: String): AnonPageToken = {
    val __obj = js.Dynamic.literal(activityId = activityId.asInstanceOf[js.Any], collection = collection.asInstanceOf[js.Any])
