...
import typingsSlinky.graphqlDashRequest.distSrcTypesMod.GraphQLRequestContext
import typingsSlinky.graphqlDashRequest.distSrcTypesMod.GraphQLResponse
import typingsSlinky.graphqlDashRequest.distSrcTypesMod.Headers
import typingsSlinky.graphqlDashRequest.distSrcTypesMod.Options
import typingsSlinky.graphqlDashRequest.distSrcTypesMod.Variables
import typingsSlinky.graphqlDashRequest.graphqlDashRequestMod.GraphQLClient
...
object graphqlDashRequestMod extends js.Object {
  ...
  class ClientError protected ()
    extends typingsSlinky.graphqlDashRequest.distSrcTypesMod.ClientError {
