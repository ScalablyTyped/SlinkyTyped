...
object MergeSchemasConfig {
  @scala.inline
  def apply[/* <: typingsSlinky.graphqlToolsUtils.interfacesMod.IResolvers[_, _, typingsSlinky.std.Record[java.lang.String, _], _] */ Resolvers](schemas: js.Array[GraphQLSchema]): MergeSchemasConfig[Resolvers] = {
    val __obj = js.Dynamic.literal(schemas = schemas.asInstanceOf[js.Any])
    __obj.asInstanceOf[MergeSchemasConfig[Resolvers]]
  }
  @scala.inline
  implicit class MergeSchemasConfigOps[Self <: MergeSchemasConfig[_], /* <: typingsSlinky.graphqlToolsUtils.interfacesMod.IResolvers[_, _, typingsSlinky.std.Record[java.lang.String, _], _] */ Resolvers] (val x: Self with MergeSchemasConfig[Resolvers]) extends AnyVal {
    @scala.inline
