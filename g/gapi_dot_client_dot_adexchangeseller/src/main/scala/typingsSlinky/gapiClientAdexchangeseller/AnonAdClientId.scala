...
object AnonAdClientId {
  @scala.inline
  def apply(accountId: String, adClientId: String, customChannelId: String): AnonAdClientId = {
  ...
  @scala.inline
  implicit class AnonAdClientIdOps[Self <: AnonAdClientId] (val x: Self) extends AnyVal {
    @scala.inline
