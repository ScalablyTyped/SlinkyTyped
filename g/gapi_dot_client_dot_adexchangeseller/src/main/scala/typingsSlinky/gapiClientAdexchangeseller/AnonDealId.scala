...
@js.native
trait AnonDealId extends js.Object {
...
object AnonDealId {
  @scala.inline
  def apply(accountId: String, dealId: String): AnonDealId = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], dealId = dealId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDealId]
  }
  @scala.inline
  implicit class AnonDealIdOps[Self <: AnonDealId] (val x: Self) extends AnyVal {
    @scala.inline
