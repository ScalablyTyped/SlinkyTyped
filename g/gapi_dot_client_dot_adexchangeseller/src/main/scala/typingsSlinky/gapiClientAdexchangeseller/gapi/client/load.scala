package typingsSlinky.gapiClientAdexchangeseller.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientAdexchangeseller.gapiClientAdexchangesellerStrings.adexchangeseller,
    version: v2Dot0
