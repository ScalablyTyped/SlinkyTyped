package typingsSlinky.gapiDotClientDotAdexchangeseller.gapi.client.adexchangeseller

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotAdexchangeseller.Anon_AccountIdAdClientIdAlt
