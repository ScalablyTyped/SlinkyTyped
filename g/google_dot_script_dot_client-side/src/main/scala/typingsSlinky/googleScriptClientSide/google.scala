  ...
  object script {
    ...
    object Runner {
      ...
      implicit class RunnerMutableBuilder[Self <: Runner] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setWithFailureHandler(value: js.Function2[/* error */ js.Error, /* object */ js.UndefOr[js.Any], Unit] => Runner): Self = StObject.set(x, "withFailureHandler", js.Any.fromFunction1(value))
