...
import typingsSlinky.gapi.gapi.CallbackOrConfig
import typingsSlinky.gapi.gapi.client.RequestOptions
import typingsSlinky.gapi.gapi.client.RpcRequest
...
object global {
  ...
  object gapi {
    ...
    object client {
      ...
      @js.native
      class HttpBatch ()
        extends typingsSlinky.gapi.gapi.client.HttpBatch
      ...
      class HttpRequestPromise[T] ()
        extends typingsSlinky.gapi.gapi.client.HttpRequestPromise[T]
      ...
      @js.native
      def request(args: RequestOptions): typingsSlinky.gapi.gapi.client.HttpRequest[_] = js.native
