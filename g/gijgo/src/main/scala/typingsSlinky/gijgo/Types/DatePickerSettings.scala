...
object DatePickerSettings {
  ...
  implicit class DatePickerSettingsMutableBuilder[Self <: DatePickerSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxDate(value: js.Date | String | js.Function): Self = StObject.set(x, "maxDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDate(value: js.Date | String | js.Function): Self = StObject.set(x, "minDate", value.asInstanceOf[js.Any])
