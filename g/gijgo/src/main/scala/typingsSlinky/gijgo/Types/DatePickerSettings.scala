...
object DatePickerSettings {
  ...
  implicit class DatePickerSettingsOps[Self <: DatePickerSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxDate(value: js.Date | String | js.Function): Self = this.set("maxDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMaxDate: Self = this.set("maxDate", js.undefined)
    @scala.inline
    def setMinDateDate(value: js.Date): Self = this.set("minDate", value.asInstanceOf[js.Any])
    @scala.inline
    def setMinDate(value: js.Date | String | js.Function): Self = this.set("minDate", value.asInstanceOf[js.Any])
    @scala.inline
