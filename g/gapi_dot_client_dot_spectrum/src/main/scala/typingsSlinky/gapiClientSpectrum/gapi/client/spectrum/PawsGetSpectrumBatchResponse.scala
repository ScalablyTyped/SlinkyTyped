...
object PawsGetSpectrumBatchResponse {
  ...
  implicit class PawsGetSpectrumBatchResponseOps[Self <: PawsGetSpectrumBatchResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGeoSpectrumSchedules(value: js.Array[GeoSpectrumSchedule]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("geoSpectrumSchedules")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutGeoSpectrumSchedules: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("geoSpectrumSchedules")(js.undefined)
        ret
    }
    @scala.inline
