...
trait MapOptions extends js.Object {
  ...
  var fullscreenControlOptions: js.UndefOr[typingsSlinky.googleMapReact.anon.Position] = js.undefined
  ...
  var panControlOptions: js.UndefOr[typingsSlinky.googleMapReact.anon.Position] = js.undefined
  var rotateControl: js.UndefOr[Boolean] = js.undefined
  var rotateControlOptions: js.UndefOr[typingsSlinky.googleMapReact.anon.Position] = js.undefined
  ...
  var streetViewControlOptions: js.UndefOr[typingsSlinky.googleMapReact.anon.Position] = js.undefined
  ...
  var zoomControlOptions: js.UndefOr[typingsSlinky.googleMapReact.anon.Position] = js.undefined
}
...
object MapOptions {
  ...
  def apply(
    ...
    fullscreenControlOptions: typingsSlinky.googleMapReact.anon.Position = null,
    ...
    panControlOptions: typingsSlinky.googleMapReact.anon.Position = null,
    rotateControl: js.UndefOr[Boolean] = js.undefined,
    rotateControlOptions: typingsSlinky.googleMapReact.anon.Position = null,
    ...
    streetViewControlOptions: typingsSlinky.googleMapReact.anon.Position = null,
    styles: js.Array[MapTypeStyle] = null,
    tilt: js.UndefOr[Double] = js.undefined,
    zoomControl: js.UndefOr[Boolean] = js.undefined,
    zoomControlOptions: typingsSlinky.googleMapReact.anon.Position = null
  ): MapOptions = {
