...
object MapOptions {
  ...
  implicit class MapOptionsMutableBuilder[Self <: MapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFullscreenControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = StObject.set(x, "fullscreenControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPanControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = StObject.set(x, "panControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRotateControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = StObject.set(x, "rotateControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStreetViewControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = StObject.set(x, "streetViewControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setZoomControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = StObject.set(x, "zoomControlOptions", value.asInstanceOf[js.Any])
