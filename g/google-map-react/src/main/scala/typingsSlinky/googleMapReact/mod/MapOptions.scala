...
object MapOptions {
  ...
  implicit class MapOptionsOps[Self <: MapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFullscreenControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = this.set("fullscreenControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPanControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = this.set("panControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRotateControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = this.set("rotateControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStreetViewControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = this.set("streetViewControlOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setZoomControlOptions(value: typingsSlinky.googleMapReact.anon.Position): Self = this.set("zoomControlOptions", value.asInstanceOf[js.Any])
