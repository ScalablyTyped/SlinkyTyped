...
object Ne {
  ...
  implicit class NeOps[Self <: Ne] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNe(value: typingsSlinky.googleMapReact.mod.Coords): Self = this.set("ne", value.asInstanceOf[js.Any])
    @scala.inline
    def setSw(value: typingsSlinky.googleMapReact.mod.Coords): Self = this.set("sw", value.asInstanceOf[js.Any])
  }
