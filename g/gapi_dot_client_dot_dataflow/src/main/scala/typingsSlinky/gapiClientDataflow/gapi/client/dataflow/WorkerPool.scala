...
trait WorkerPool extends js.Object {
  ...
  var poolArgs: js.UndefOr[Record[String, _]] = js.native
  /**
...
object WorkerPool {
  ...
  implicit class WorkerPoolOps[Self <: WorkerPool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAutoscalingSettings(value: AutoscalingSettings): Self = {
    ...
    @scala.inline
    def withDataDisks(value: js.Array[Disk]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoolArgs(value: Record[String, _]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTaskrunnerSettings(value: TaskRunnerSettings): Self = {
        val ret = this.duplicate
