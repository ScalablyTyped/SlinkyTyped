...
object AnonValidateOnly {
  @scala.inline
  def apply(projectId: String): AnonValidateOnly = {
    val __obj = js.Dynamic.literal(projectId = projectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonValidateOnly]
  }
  @scala.inline
  implicit class AnonValidateOnlyOps[Self <: AnonValidateOnly] (val x: Self) extends AnyVal {
    @scala.inline
