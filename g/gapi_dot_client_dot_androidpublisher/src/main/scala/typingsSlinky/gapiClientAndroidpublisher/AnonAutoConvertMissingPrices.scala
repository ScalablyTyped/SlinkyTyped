...
@js.native
trait AnonAutoConvertMissingPrices extends js.Object {
...
object AnonAutoConvertMissingPrices {
  @scala.inline
  def apply(packageName: String): AnonAutoConvertMissingPrices = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAutoConvertMissingPrices]
  }
  @scala.inline
  implicit class AnonAutoConvertMissingPricesOps[Self <: AnonAutoConvertMissingPrices] (val x: Self) extends AnyVal {
    @scala.inline
