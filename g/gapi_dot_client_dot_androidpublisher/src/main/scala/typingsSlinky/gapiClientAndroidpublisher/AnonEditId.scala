...
@js.native
trait AnonEditId extends js.Object {
...
object AnonEditId {
  @scala.inline
  def apply(editId: String, packageName: String): AnonEditId = {
    val __obj = js.Dynamic.literal(editId = editId.asInstanceOf[js.Any], packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonEditId]
  }
  @scala.inline
  implicit class AnonEditIdOps[Self <: AnonEditId] (val x: Self) extends AnyVal {
    @scala.inline
