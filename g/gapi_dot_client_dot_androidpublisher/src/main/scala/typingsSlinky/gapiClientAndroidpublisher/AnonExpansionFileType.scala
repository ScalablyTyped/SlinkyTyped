...
@js.native
trait AnonExpansionFileType extends js.Object {
...
object AnonExpansionFileType {
  @scala.inline
  def apply(apkVersionCode: Double, editId: String, expansionFileType: String, packageName: String): AnonExpansionFileType = {
    ...
    __obj.asInstanceOf[AnonExpansionFileType]
  }
  @scala.inline
  implicit class AnonExpansionFileTypeOps[Self <: AnonExpansionFileType] (val x: Self) extends AnyVal {
    @scala.inline
