...
object AnonImageType {
  @scala.inline
  def apply(editId: String, imageType: String, language: String, packageName: String): AnonImageType = {
  ...
  @scala.inline
  implicit class AnonImageTypeOps[Self <: AnonImageType] (val x: Self) extends AnyVal {
    @scala.inline
