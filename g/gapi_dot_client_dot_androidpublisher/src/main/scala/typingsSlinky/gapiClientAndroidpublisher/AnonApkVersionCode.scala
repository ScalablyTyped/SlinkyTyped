...
object AnonApkVersionCode {
  @scala.inline
  def apply(apkVersionCode: Double, editId: String, packageName: String): AnonApkVersionCode = {
  ...
  @scala.inline
  implicit class AnonApkVersionCodeOps[Self <: AnonApkVersionCode] (val x: Self) extends AnyVal {
    @scala.inline
