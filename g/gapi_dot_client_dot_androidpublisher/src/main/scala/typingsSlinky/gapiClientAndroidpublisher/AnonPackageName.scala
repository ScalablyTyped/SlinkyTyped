...
@js.native
trait AnonPackageName extends js.Object {
...
object AnonPackageName {
  @scala.inline
  def apply(packageName: String): AnonPackageName = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonPackageName]
  }
  @scala.inline
  implicit class AnonPackageNameOps[Self <: AnonPackageName] (val x: Self) extends AnyVal {
    @scala.inline
