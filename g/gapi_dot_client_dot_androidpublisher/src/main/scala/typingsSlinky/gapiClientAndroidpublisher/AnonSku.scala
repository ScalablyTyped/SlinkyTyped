...
@js.native
trait AnonSku extends js.Object {
...
object AnonSku {
  @scala.inline
  def apply(packageName: String, sku: String): AnonSku = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any], sku = sku.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSku]
  }
  @scala.inline
  implicit class AnonSkuOps[Self <: AnonSku] (val x: Self) extends AnyVal {
    @scala.inline
