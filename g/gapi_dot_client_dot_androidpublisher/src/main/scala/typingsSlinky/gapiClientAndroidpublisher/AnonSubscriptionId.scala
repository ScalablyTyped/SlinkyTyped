...
@js.native
trait AnonSubscriptionId extends js.Object {
...
object AnonSubscriptionId {
  @scala.inline
  def apply(packageName: String, subscriptionId: String, token: String): AnonSubscriptionId = {
    ...
    __obj.asInstanceOf[AnonSubscriptionId]
  }
  @scala.inline
  implicit class AnonSubscriptionIdOps[Self <: AnonSubscriptionId] (val x: Self) extends AnyVal {
    @scala.inline
