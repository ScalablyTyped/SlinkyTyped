...
@js.native
trait AnonDeobfuscationFileType extends js.Object {
  /** Data format for the response. */
  var alt: js.UndefOr[String] = js.native
  /** The version code of the APK whose deobfuscation file is being uploaded. */
  var apkVersionCode: Double = js.native
  var deobfuscationFileType: String = js.native
...
object AnonDeobfuscationFileType {
  @scala.inline
  def apply(apkVersionCode: Double, deobfuscationFileType: String, editId: String, packageName: String): AnonDeobfuscationFileType = {
    val __obj = js.Dynamic.literal(apkVersionCode = apkVersionCode.asInstanceOf[js.Any], deobfuscationFileType = deobfuscationFileType.asInstanceOf[js.Any], editId = editId.asInstanceOf[js.Any], packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDeobfuscationFileType]
  }
  @scala.inline
  implicit class AnonDeobfuscationFileTypeOps[Self <: AnonDeobfuscationFileType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDeobfuscationFileType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deobfuscationFileType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
