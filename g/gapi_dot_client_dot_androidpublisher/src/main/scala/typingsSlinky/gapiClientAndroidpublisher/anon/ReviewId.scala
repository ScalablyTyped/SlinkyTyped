package typingsSlinky.gapiClientAndroidpublisher.anon
...
object ReviewId {
  @scala.inline
  def apply(packageName: String, reviewId: String): ReviewId = {
  ...
  @scala.inline
  implicit class ReviewIdOps[Self <: ReviewId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTranslationLanguage(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("translationLanguage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTranslationLanguage: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("translationLanguage")(js.undefined)
        ret
    }
    @scala.inline
