...
trait Anon_AltAutoConvertMissingPrices extends js.Object {
...
object Anon_AltAutoConvertMissingPrices {
  @scala.inline
  def apply(
    packageName: String,
    alt: String = null,
    ...
    userIp: String = null
  ): Anon_AltAutoConvertMissingPrices = {
    ...
    __obj.asInstanceOf[Anon_AltAutoConvertMissingPrices]
  }
}
