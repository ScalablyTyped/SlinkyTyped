package typingsSlinky.greekUtils
...
object mod {
  ...
  @JSImport("greek-utils", "sanitizeDiacritics")
  @js.native
  ...
  @JSImport("greek-utils", "toGreeklish")
  @js.native
  ...
  @JSImport("greek-utils", "toPhoneticLatin")
  @js.native
  ...
  @JSImport("greek-utils", "toTransliteratedLatin")
  @js.native
