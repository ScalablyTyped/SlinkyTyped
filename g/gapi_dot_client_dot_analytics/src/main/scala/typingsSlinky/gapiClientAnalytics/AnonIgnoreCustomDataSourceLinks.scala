...
object AnonIgnoreCustomDataSourceLinks {
  @scala.inline
  def apply(accountId: String, customDimensionId: String, webPropertyId: String): AnonIgnoreCustomDataSourceLinks = {
  ...
  @scala.inline
  implicit class AnonIgnoreCustomDataSourceLinksOps[Self <: AnonIgnoreCustomDataSourceLinks] (val x: Self) extends AnyVal {
    @scala.inline
