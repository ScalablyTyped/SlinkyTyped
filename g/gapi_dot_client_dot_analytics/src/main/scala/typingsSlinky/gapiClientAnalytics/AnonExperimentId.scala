...
@js.native
trait AnonExperimentId extends js.Object {
...
object AnonExperimentId {
  @scala.inline
  def apply(accountId: String, experimentId: String, profileId: String, webPropertyId: String): AnonExperimentId = {
    ...
    __obj.asInstanceOf[AnonExperimentId]
  }
  @scala.inline
  implicit class AnonExperimentIdOps[Self <: AnonExperimentId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withExperimentId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("experimentId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
