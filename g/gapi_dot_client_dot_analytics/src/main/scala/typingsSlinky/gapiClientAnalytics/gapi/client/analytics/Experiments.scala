...
object Experiments {
  ...
  @scala.inline
  implicit class ExperimentsOps[Self <: Experiments] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Experiment*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Experiment]): Self = this.set("items", value.asInstanceOf[js.Any])
