...
object CustomMetricsResource {
  ...
  implicit class CustomMetricsResourceOps[Self <: CustomMetricsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: CustomMetricId => Request[CustomMetric]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsert(value: QuotaUser => Request[CustomMetric]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insert")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: PrettyPrint => Request[CustomMetrics]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: UserIp => Request[CustomMetric]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("patch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdate(value: UserIp => Request[CustomMetric]): Self = {
        val ret = this.duplicate
