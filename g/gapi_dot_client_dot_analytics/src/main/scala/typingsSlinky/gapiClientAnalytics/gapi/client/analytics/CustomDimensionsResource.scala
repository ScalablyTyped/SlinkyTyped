...
import typingsSlinky.gapiClientAnalytics.anon.CustomDimensionId
import typingsSlinky.gapiClientAnalytics.anon.IgnoreCustomDataSourceLinks
...
object CustomDimensionsResource {
  ...
  implicit class CustomDimensionsResourceOps[Self <: CustomDimensionsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: CustomDimensionId => Request[CustomDimension]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsert(value: QuotaUser => Request[CustomDimension]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insert")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: PrettyPrint => Request[CustomDimensions]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: IgnoreCustomDataSourceLinks => Request[CustomDimension]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("patch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdate(value: IgnoreCustomDataSourceLinks => Request[CustomDimension]): Self = {
        val ret = this.duplicate
