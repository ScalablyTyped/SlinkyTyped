...
trait RemarketingAudience extends js.Object {
  ...
  var audienceDefinition: js.UndefOr[typingsSlinky.gapiClientAnalytics.anon.IncludeConditions] = js.undefined
...
object RemarketingAudience {
  ...
  def apply(
    ...
    audienceDefinition: typingsSlinky.gapiClientAnalytics.anon.IncludeConditions = null,
