...
import typingsSlinky.gapiClientAnalytics.AnonEnddate
...
trait McfResource extends js.Object {
  ...
  def get(request: AnonEnddate): Request_[McfData] = js.native
}
...
object McfResource {
  ...
  implicit class McfResourceOps[Self <: McfResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: AnonEnddate => Request_[McfData]): Self = {
