...
@js.native
trait AnonLinkId extends js.Object {
...
object AnonLinkId {
  @scala.inline
  def apply(accountId: String, linkId: String): AnonLinkId = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], linkId = linkId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLinkId]
  }
  @scala.inline
  implicit class AnonLinkIdOps[Self <: AnonLinkId] (val x: Self) extends AnyVal {
    @scala.inline
