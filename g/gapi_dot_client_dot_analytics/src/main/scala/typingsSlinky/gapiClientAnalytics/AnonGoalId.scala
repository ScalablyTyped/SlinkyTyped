...
@js.native
trait AnonGoalId extends js.Object {
...
object AnonGoalId {
  @scala.inline
  def apply(accountId: String, goalId: String, profileId: String, webPropertyId: String): AnonGoalId = {
    ...
    __obj.asInstanceOf[AnonGoalId]
  }
  @scala.inline
  implicit class AnonGoalIdOps[Self <: AnonGoalId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withGoalId(value: String): Self = {
        val ret = this.duplicate
