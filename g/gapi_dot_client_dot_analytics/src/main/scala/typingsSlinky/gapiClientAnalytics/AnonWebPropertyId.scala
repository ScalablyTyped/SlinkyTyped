...
@js.native
trait AnonWebPropertyId extends js.Object {
...
object AnonWebPropertyId {
  @scala.inline
  def apply(accountId: String, linkId: String, profileId: String, webPropertyId: String): AnonWebPropertyId = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], linkId = linkId.asInstanceOf[js.Any], profileId = profileId.asInstanceOf[js.Any], webPropertyId = webPropertyId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonWebPropertyId]
  }
  @scala.inline
  implicit class AnonWebPropertyIdOps[Self <: AnonWebPropertyId] (val x: Self) extends AnyVal {
    @scala.inline
