...
object AnonUserIp {
  @scala.inline
  def apply(accountId: String, customMetricId: String, webPropertyId: String): AnonUserIp = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], customMetricId = customMetricId.asInstanceOf[js.Any], webPropertyId = webPropertyId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonUserIp]
  }
  @scala.inline
  implicit class AnonUserIpOps[Self <: AnonUserIp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCustomMetricId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("customMetricId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
