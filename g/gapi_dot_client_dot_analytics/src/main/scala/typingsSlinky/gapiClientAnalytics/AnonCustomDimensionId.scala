...
object AnonCustomDimensionId {
  @scala.inline
  def apply(accountId: String, customDimensionId: String, webPropertyId: String): AnonCustomDimensionId = {
  ...
  @scala.inline
  implicit class AnonCustomDimensionIdOps[Self <: AnonCustomDimensionId] (val x: Self) extends AnyVal {
    @scala.inline
