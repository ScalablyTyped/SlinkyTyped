...
object AnonCustomDataSourceId {
  @scala.inline
  def apply(accountId: String, customDataSourceId: String, webPropertyId: String): AnonCustomDataSourceId = {
  ...
  @scala.inline
  implicit class AnonCustomDataSourceIdOps[Self <: AnonCustomDataSourceId] (val x: Self) extends AnyVal {
    @scala.inline
