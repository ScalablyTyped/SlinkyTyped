...
@js.native
trait CustomDimensionId extends js.Object {
...
object CustomDimensionId {
  
  @scala.inline
  def apply(accountId: String, customDimensionId: String, webPropertyId: String): CustomDimensionId = {
    ...
    __obj.asInstanceOf[CustomDimensionId]
  }
  
  @scala.inline
  implicit class CustomDimensionIdOps[Self <: CustomDimensionId] (val x: Self) extends AnyVal {
