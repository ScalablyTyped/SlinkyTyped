...
object WebPropertyRef {
  ...
  implicit class WebPropertyRefOps[Self <: WebPropertyRef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWebPropertyRef(value: typingsSlinky.gapiClientAnalytics.gapi.client.analytics.WebPropertyRef): Self = this.set("webPropertyRef", value.asInstanceOf[js.Any])
    @scala.inline
