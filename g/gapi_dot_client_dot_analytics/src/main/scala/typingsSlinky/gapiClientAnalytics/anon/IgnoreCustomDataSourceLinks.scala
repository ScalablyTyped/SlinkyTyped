...
@js.native
trait IgnoreCustomDataSourceLinks extends js.Object {
...
object IgnoreCustomDataSourceLinks {
  ...
  @scala.inline
  def apply(accountId: String, customDimensionId: String, webPropertyId: String): IgnoreCustomDataSourceLinks = {
  ...
  @scala.inline
  implicit class IgnoreCustomDataSourceLinksOps[Self <: IgnoreCustomDataSourceLinks] (val x: Self) extends AnyVal {
