...
object ExcludeConditions {
  ...
  implicit class ExcludeConditionsOps[Self <: ExcludeConditions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeConditions(value: typingsSlinky.gapiClientAnalytics.gapi.client.analytics.IncludeConditions): Self = this.set("includeConditions", value.asInstanceOf[js.Any])
    @scala.inline
