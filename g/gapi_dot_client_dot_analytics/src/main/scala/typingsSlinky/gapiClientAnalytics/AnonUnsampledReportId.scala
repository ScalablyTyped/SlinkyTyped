...
@js.native
trait AnonUnsampledReportId extends js.Object {
  ...
  var unsampledReportId: String = js.native
...
object AnonUnsampledReportId {
  @scala.inline
  def apply(accountId: String, profileId: String, unsampledReportId: String, webPropertyId: String): AnonUnsampledReportId = {
    ...
    __obj.asInstanceOf[AnonUnsampledReportId]
  }
  @scala.inline
  implicit class AnonUnsampledReportIdOps[Self <: AnonUnsampledReportId] (val x: Self) extends AnyVal {
    @scala.inline
