...
trait Anon_AccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId extends js.Object {
...
object Anon_AccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId {
  @scala.inline
  def apply(
    accountId: String,
    profileId: String,
    ...
    userIp: String = null
  ): Anon_AccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId = {
    ...
    __obj.asInstanceOf[Anon_AccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId]
  }
}
