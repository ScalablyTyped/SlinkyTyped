...
trait Anon_AccountIdAltCustomDimensionId extends js.Object {
...
object Anon_AccountIdAltCustomDimensionId {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): Anon_AccountIdAltCustomDimensionId = {
    ...
    __obj.asInstanceOf[Anon_AccountIdAltCustomDimensionId]
  }
}
