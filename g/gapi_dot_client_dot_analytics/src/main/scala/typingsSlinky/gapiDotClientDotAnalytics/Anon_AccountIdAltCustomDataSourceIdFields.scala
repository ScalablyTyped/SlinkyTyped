...
trait Anon_AccountIdAltCustomDataSourceIdFields extends js.Object {
...
object Anon_AccountIdAltCustomDataSourceIdFields {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): Anon_AccountIdAltCustomDataSourceIdFields = {
    ...
    __obj.asInstanceOf[Anon_AccountIdAltCustomDataSourceIdFields]
  }
}
