...
import typingsSlinky.gatsbyTelemetry.telemetryMod.IAggregateStats
import typingsSlinky.gatsbyTelemetry.telemetryMod.IAnalyticsTrackerConstructorParameters
import typingsSlinky.gatsbyTelemetry.telemetryMod.IDefaultTelemetryTagsPayload
import typingsSlinky.gatsbyTelemetry.telemetryMod.ITelemetryOptsPayload
import typingsSlinky.gatsbyTelemetry.telemetryMod.ITelemetryTagsPayload
...
object mod {
  ...
  class AnalyticsTracker ()
    extends typingsSlinky.gatsbyTelemetry.telemetryMod.AnalyticsTracker {
