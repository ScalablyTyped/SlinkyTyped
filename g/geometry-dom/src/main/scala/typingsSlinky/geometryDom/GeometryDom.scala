...
object GeometryDom {
  ...
  object DOMRectList {
    ...
    @scala.inline
    def apply(item: Double => DOMRect, length: Double): typingsSlinky.geometryDom.GeometryDom.DOMRectList = {
      val __obj = js.Dynamic.literal(item = js.Any.fromFunction1(item), length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.geometryDom.GeometryDom.DOMRectList]
    }
    
    @scala.inline
    implicit class DOMRectListMutableBuilder[Self <: typingsSlinky.geometryDom.GeometryDom.DOMRectList] (val x: Self) extends AnyVal {
