...
@js.native
class DOMQuad ()
  extends typingsSlinky.geometryDashDom.GeometryDom.DOMQuad {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var bounds: typingsSlinky.geometryDashDom.GeometryDom.DOMRectReadOnly = js.native
  /**
    * a DOMPoint that represents p1 of the quadrilateral
    */
  /* CompleteClass */
  override var p1: typingsSlinky.geometryDashDom.GeometryDom.DOMPoint = js.native
  /**
    * a DOMPoint that represents p2 of the quadrilateral
    */
  /* CompleteClass */
  override var p2: typingsSlinky.geometryDashDom.GeometryDom.DOMPoint = js.native
  /**
    * a DOMPoint that represents p3 of the quadrilateral
    */
  /* CompleteClass */
  override var p3: typingsSlinky.geometryDashDom.GeometryDom.DOMPoint = js.native
  /**
    * a DOMPoint that represents p4 of the quadrilateral
    */
  /* CompleteClass */
  override var p4: typingsSlinky.geometryDashDom.GeometryDom.DOMPoint = js.native
}
