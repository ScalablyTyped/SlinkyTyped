...
import typingsSlinky.googleapisDashCommon.buildSrcDiscoveryMod.DiscoveryOptions
import typingsSlinky.googleapisDashCommon.googleapisDashCommonStrings.httpsColonSlashSlashoauth2DotgoogleapisDotcomSlashtokeninfo
...
object googleapisDashCommonMod extends js.Object {
  @js.native
  class AuthPlus ()
    extends typingsSlinky.googleapisDashCommon.buildSrcAuthplusMod.AuthPlus
  
  @js.native
  class Discovery protected ()
    extends typingsSlinky.googleapisDashCommon.buildSrcDiscoveryMod.Discovery {
    /**
  ...
  class Endpoint protected ()
    extends typingsSlinky.googleapisDashCommon.buildSrcEndpointMod.Endpoint {
  ...
  /**
    ...
    */
  class OAuth2Client ()
    extends typingsSlinky.googleDashAuthDashLibrary.googleDashAuthDashLibraryMod.OAuth2Client {
