...
import typingsSlinky.graphqlReact.anon.Query
import typingsSlinky.graphqlReact.anon.Variables
...
object mod {
  ...
  @js.native
  def ssr(grapphql: GraphQL, node: ReactElement): Unit = js.native
  @JSImport("graphql-react", "ssr")
  @js.native
  def ssr(grapphql: GraphQL, node: ReactElement, render: js.Function1[/* element */ ReactElement, String]): Unit = js.native
