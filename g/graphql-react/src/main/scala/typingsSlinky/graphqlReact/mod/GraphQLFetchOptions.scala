...
object GraphQLFetchOptions {
  ...
  def apply(body: String | FormData, headers: Headers, url: String, credentials: String = null): GraphQLFetchOptions = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], credentials = credentials.asInstanceOf[js.Any])
