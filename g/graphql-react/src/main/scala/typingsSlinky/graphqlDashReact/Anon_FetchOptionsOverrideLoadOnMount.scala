...
import typingsSlinky.graphqlDashReact.graphqlDashReactMod.GraphQLFetchOptions
import typingsSlinky.graphqlDashReact.graphqlDashReactMod.GraphQLFetchOptionsOverride
import typingsSlinky.graphqlDashReact.graphqlDashReactMod.GraphQLOperation
