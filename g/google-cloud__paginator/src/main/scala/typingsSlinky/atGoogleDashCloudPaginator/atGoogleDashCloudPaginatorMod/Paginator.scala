...
class Paginator () extends js.Object {
  ...
  /**
    ...
    */
  def runAsStream_[T](parsedArguments: ParsedArguments, originalMethod: js.Function): typingsSlinky.atGoogleDashCloudPaginator.buildSrcResourceDashStreamMod.ResourceStream[T] = js.native
  /**
  ...
  def streamify[T](methodName: String): js.ThisFunction1[
    ...
    /* repeated */ js.Any, 
    typingsSlinky.atGoogleDashCloudPaginator.buildSrcResourceDashStreamMod.ResourceStream[T]
  ] = js.native
}
