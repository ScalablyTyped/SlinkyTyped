...
object mod {
  ...
  class Paginator_ () extends StObject {
    ...
    /**
      ...
      */
    def runAsStream_[T](parsedArguments: ParsedArguments, originalMethod: js.Function): typingsSlinky.googleCloudPaginator.resourceStreamMod.ResourceStream[T] = js.native
    ...
    def streamify[T](methodName: String): js.ThisFunction1[
        ...
        /* repeated */ js.Any, 
        typingsSlinky.googleCloudPaginator.resourceStreamMod.ResourceStream[T]
      ] = js.native
  }
  ...
  class ResourceStream[T] protected ()
    extends typingsSlinky.googleCloudPaginator.resourceStreamMod.ResourceStream[T] {
