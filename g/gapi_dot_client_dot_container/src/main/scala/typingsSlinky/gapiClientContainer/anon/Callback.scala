package typingsSlinky.gapiClientContainer.anon
...
object Callback {
  @scala.inline
  def apply(operationId: String, projectId: String, zone: String): Callback = {
    val __obj = js.Dynamic.literal(operationId = operationId.asInstanceOf[js.Any], projectId = projectId.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
