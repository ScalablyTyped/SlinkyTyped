...
object UpdateMasterRequest {
  ...
  implicit class UpdateMasterRequestOps[Self <: UpdateMasterRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMasterVersion(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("masterVersion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMasterVersion: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("masterVersion")(js.undefined)
        ret
    }
  }
