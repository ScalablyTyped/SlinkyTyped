...
object messageMod extends Shortcut {
  ...
  object globalizeDistGlobalizeAugmentingMod {
    ...
    object Static {
      ...
      @scala.inline
      def apply(loadMessages: js.Object => Unit): typingsSlinky.globalize.messageMod.globalizeDistGlobalizeAugmentingMod.Static = {
        val __obj = js.Dynamic.literal(loadMessages = js.Any.fromFunction1(loadMessages))
        __obj.asInstanceOf[typingsSlinky.globalize.messageMod.globalizeDistGlobalizeAugmentingMod.Static]
      }
      
      @scala.inline
      implicit class StaticMutableBuilder[Self <: typingsSlinky.globalize.messageMod.globalizeDistGlobalizeAugmentingMod.Static] (val x: Self) extends AnyVal {
