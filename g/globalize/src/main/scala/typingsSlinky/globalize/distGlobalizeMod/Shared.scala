...
import typingsSlinky.cldrjs.cldrjsMod.CldrStatic
...
trait Shared extends js.Object {
  ...
  def currencyFormatter(
    currency: String,
    options: typingsSlinky.globalize.distGlobalizeCurrencyMod.distGlobalizeMod.CurrencyFormatterOptions
  ...
  def dateFormatter(options: typingsSlinky.globalize.distGlobalizeDateMod.distGlobalizeMod.DateFormatterOptions): js.Function1[/* value */ js.Date, String] = js.native
  ...
  def dateParser(options: typingsSlinky.globalize.distGlobalizeDateMod.distGlobalizeMod.DateFormatterOptions): js.Function1[/* value */ String, js.Date] = js.native
  /**
  ...
  def formatDate(
    value: js.Date,
    options: typingsSlinky.globalize.distGlobalizeDateMod.distGlobalizeMod.DateFormatterOptions
  ): String = js.native
  /**
  ...
  def formatNumber(
    value: Double,
    options: typingsSlinky.globalize.distGlobalizeNumberMod.distGlobalizeMod.NumberFormatterOptions
  ): String = js.native
  /**
  ...
  def formatRelativeTime(
    value: Double,
    unit: String,
    options: typingsSlinky.globalize.distGlobalizeRelativeDashTimeMod.distGlobalizeMod.RelativeTimeFormatterOptions
  ): String = js.native
  /**
  ...
  def formatUnit(
    value: Double,
    unit: String,
    options: typingsSlinky.globalize.distGlobalizeUnitMod.distGlobalizeMod.UnitFormatterOptions
  ): String = js.native
  /**
  ...
  def numberFormatter(options: typingsSlinky.globalize.distGlobalizeNumberMod.distGlobalizeMod.NumberFormatterOptions): js.Function1[/* value */ Double, String] = js.native
  /**
  ...
  def numberParser(options: typingsSlinky.globalize.distGlobalizeNumberMod.distGlobalizeMod.NumberParserOptions): js.Function1[/* value */ String, Double] = js.native
  /**
  ...
  def parseNumber(
    value: String,
    options: typingsSlinky.globalize.distGlobalizeNumberMod.distGlobalizeMod.NumberParserOptions
  ): Double = js.native
  /**
  ...
  def plural(
    value: Double,
    options: typingsSlinky.globalize.distGlobalizePluralMod.distGlobalizeMod.PluralGeneratorOptions
  ): String = js.native
  /**
  ...
  def pluralGenerator(options: typingsSlinky.globalize.distGlobalizePluralMod.distGlobalizeMod.PluralGeneratorOptions): js.Function1[/* value */ Double, String] = js.native
  /**
