...
import typingsSlinky.globalize.globalizeMod.DateFormatPartTypes
...
object globalizeStrings {
  ...
  sealed trait day
    extends DateFormatPartTypes
       with typingsSlinky.globalize.dateMod.globalizeDistGlobalizeAugmentingMod.DateFormatPartTypes
