...
object DateFormatPart {
  ...
  implicit class DateFormatPartOps[Self <: DateFormatPart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.globalize.dateMod.globalizeDistGlobalizeAugmentingMod.DateFormatPartTypes): Self = this.set("type", value.asInstanceOf[js.Any])
