package typingsSlinky.globalize.messageMod.globalizeDistGlobalizeAugmentingMod
...
object Static {
  ...
  implicit class StaticOps[Self <: Static] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLoadMessages(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadMessages")(js.Any.fromFunction1(value))
        ret
    }
  }
