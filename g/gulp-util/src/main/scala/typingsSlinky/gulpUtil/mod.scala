...
import typingsSlinky.gulpUtil.anon.File
import typingsSlinky.gulpUtil.anon.Typeof
...
import typingsSlinky.vinyl.mod.FileConstructor
import typingsSlinky.vinyl.mod.NullFile
...
object mod {
  ...
  @JSImport("gulp-util", "buffer")
  @js.native
  def buffer(cb: js.Function2[/* err */ js.Error, /* data */ js.Array[_], Unit]): ReadWriteStream = js.native
