...
object GoogleCloudVideointelligenceV1beta1LabelAnnotation {
  ...
  implicit class GoogleCloudVideointelligenceV1beta1LabelAnnotationOps[Self <: GoogleCloudVideointelligenceV1beta1LabelAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocationsVarargs(value: GoogleCloudVideointelligenceV1beta1LabelLocation*): Self = this.set("locations", js.Array(value :_*))
    @scala.inline
    def setLocations(value: js.Array[GoogleCloudVideointelligenceV1beta1LabelLocation]): Self = this.set("locations", value.asInstanceOf[js.Any])
    @scala.inline
