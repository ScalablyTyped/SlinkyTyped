...
object GoogleCloudVideointelligenceV1VideoAnnotationResults {
  ...
  implicit class GoogleCloudVideointelligenceV1VideoAnnotationResultsOps[Self <: GoogleCloudVideointelligenceV1VideoAnnotationResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabelAnnotations(value: js.Array[GoogleCloudVideointelligenceV1LabelAnnotation]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSafeSearchAnnotations(value: js.Array[GoogleCloudVideointelligenceV1SafeSearchAnnotation]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShotAnnotations(value: js.Array[GoogleCloudVideointelligenceV1VideoSegment]): Self = {
        val ret = this.duplicate
