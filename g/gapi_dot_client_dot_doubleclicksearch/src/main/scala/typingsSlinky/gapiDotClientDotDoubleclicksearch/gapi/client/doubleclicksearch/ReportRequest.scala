package typingsSlinky.gapiDotClientDotDoubleclicksearch.gapi.client.doubleclicksearch

import typingsSlinky.gapiDotClientDotDoubleclicksearch.Anon_AdGroupId
import typingsSlinky.gapiDotClientDotDoubleclicksearch.Anon_ChangedAttributesSinceTimestamp
import typingsSlinky.gapiDotClientDotDoubleclicksearch.Anon_Column
import typingsSlinky.gapiDotClientDotDoubleclicksearch.Anon_ColumnSortOrder
