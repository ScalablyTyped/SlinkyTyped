package typingsSlinky.gapiClientDoubleclicksearch.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientDoubleclicksearch.gapiClientDoubleclicksearchStrings.doubleclicksearch,
    version: v2
