...
@js.native
trait AnonAgencyId extends js.Object {
...
object AnonAgencyId {
  @scala.inline
  def apply(advertiserId: String, agencyId: String): AnonAgencyId = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], agencyId = agencyId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAgencyId]
  }
  @scala.inline
  implicit class AnonAgencyIdOps[Self <: AnonAgencyId] (val x: Self) extends AnyVal {
    @scala.inline
