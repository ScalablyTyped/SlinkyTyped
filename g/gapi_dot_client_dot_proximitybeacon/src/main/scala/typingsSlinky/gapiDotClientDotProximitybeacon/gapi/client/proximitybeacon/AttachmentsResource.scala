...
import typingsSlinky.gapiDotClientDotProximitybeacon.Anon_AccesstokenAlt
import typingsSlinky.gapiDotClientDotProximitybeacon.Anon_AccesstokenAltAttachmentName
