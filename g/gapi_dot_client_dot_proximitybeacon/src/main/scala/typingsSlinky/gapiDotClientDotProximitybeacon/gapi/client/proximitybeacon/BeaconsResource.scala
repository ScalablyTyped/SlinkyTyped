...
import typingsSlinky.gapiDotClientDotProximitybeacon.Anon_AccesstokenAltBeaconName
import typingsSlinky.gapiDotClientDotProximitybeacon.Anon_AccesstokenAltBearertoken
