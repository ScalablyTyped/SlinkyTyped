...
@js.native
trait AlertFilter extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AlertFilter {
  @scala.inline
  def apply(beaconName: String): AlertFilter = {
    val __obj = js.Dynamic.literal(beaconName = beaconName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AlertFilter]
  }
  @scala.inline
  implicit class AlertFilterOps[Self <: AlertFilter] (val x: Self) extends AnyVal {
    @scala.inline
