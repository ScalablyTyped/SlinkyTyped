...
@js.native
trait AttachmentName extends js.Object {
...
object AttachmentName {
  ...
  @scala.inline
  def apply(attachmentName: String): AttachmentName = {
    val __obj = js.Dynamic.literal(attachmentName = attachmentName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AttachmentName]
  }
  
  @scala.inline
  implicit class AttachmentNameOps[Self <: AttachmentName] (val x: Self) extends AnyVal {
