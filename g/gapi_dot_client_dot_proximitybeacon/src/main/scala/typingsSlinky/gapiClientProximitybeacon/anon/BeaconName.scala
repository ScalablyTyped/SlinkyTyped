...
@js.native
trait BeaconName extends js.Object {
...
object BeaconName {
  ...
  @scala.inline
  def apply(beaconName: String): BeaconName = {
    val __obj = js.Dynamic.literal(beaconName = beaconName.asInstanceOf[js.Any])
    __obj.asInstanceOf[BeaconName]
  }
  
  @scala.inline
  implicit class BeaconNameOps[Self <: BeaconName] (val x: Self) extends AnyVal {
