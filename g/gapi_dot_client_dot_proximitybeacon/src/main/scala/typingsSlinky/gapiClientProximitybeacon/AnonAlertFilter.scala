...
object AnonAlertFilter {
  @scala.inline
  def apply(beaconName: String): AnonAlertFilter = {
    val __obj = js.Dynamic.literal(beaconName = beaconName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAlertFilter]
  }
  @scala.inline
  implicit class AnonAlertFilterOps[Self <: AnonAlertFilter] (val x: Self) extends AnyVal {
    @scala.inline
