...
@js.native
trait AnonChangeId extends js.Object {
...
object AnonChangeId {
  @scala.inline
  def apply(changeId: String, managedZone: String, project: String): AnonChangeId = {
    ...
    __obj.asInstanceOf[AnonChangeId]
  }
  @scala.inline
  implicit class AnonChangeIdOps[Self <: AnonChangeId] (val x: Self) extends AnyVal {
    @scala.inline
