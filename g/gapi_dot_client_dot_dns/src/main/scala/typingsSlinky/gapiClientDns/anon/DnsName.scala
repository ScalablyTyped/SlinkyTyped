package typingsSlinky.gapiClientDns.anon
...
@js.native
trait DnsName extends js.Object {
...
object DnsName {
  @scala.inline
  def apply(project: String): DnsName = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[DnsName]
  }
  @scala.inline
  implicit class DnsNameOps[Self <: DnsName] (val x: Self) extends AnyVal {
    @scala.inline
