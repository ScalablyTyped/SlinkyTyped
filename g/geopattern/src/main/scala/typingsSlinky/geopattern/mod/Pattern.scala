...
object Pattern {
  ...
  implicit class PatternOps[Self <: Pattern] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withToBase64(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("toBase64")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withToDataUri(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("toDataUri")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
