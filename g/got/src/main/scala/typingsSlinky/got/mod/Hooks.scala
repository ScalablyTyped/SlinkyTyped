...
object Hooks {
  @scala.inline
  def apply[Options, /* <: typingsSlinky.node.Buffer | java.lang.String | js.Object */ Body](): Hooks[Options, Body] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Hooks[Options, Body]]
  }
  @scala.inline
  implicit class HooksOps[Self <: Hooks[_, _], Options, /* <: typingsSlinky.node.Buffer | java.lang.String | js.Object */ Body] (val x: Self with (Hooks[Options, Body])) extends AnyVal {
    @scala.inline
