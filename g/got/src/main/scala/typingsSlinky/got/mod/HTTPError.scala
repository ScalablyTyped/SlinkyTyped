...
trait HTTPError
  ...
  @JSName("name")
  var name_HTTPError: typingsSlinky.got.gotStrings.HTTPError = js.native
...
object HTTPError {
  ...
  implicit class HTTPErrorMutableBuilder[Self <: HTTPError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.got.gotStrings.HTTPError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
