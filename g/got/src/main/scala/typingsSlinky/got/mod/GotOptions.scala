...
object GotOptions {
  @scala.inline
  def apply[/* <: java.lang.String | scala.Null */ E](): GotOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GotOptions[E]]
  }
  @scala.inline
  implicit class GotOptionsOps[Self <: GotOptions[_], /* <: java.lang.String | scala.Null */ E] (val x: Self with GotOptions[E]) extends AnyVal {
    @scala.inline
