...
object RequestError {
  @scala.inline
  def apply(message: String, name: typingsSlinky.got.gotStrings.RequestError): RequestError = {
  ...
  implicit class RequestErrorOps[Self <: RequestError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.got.gotStrings.RequestError): Self = this.set("name", value.asInstanceOf[js.Any])
  }
