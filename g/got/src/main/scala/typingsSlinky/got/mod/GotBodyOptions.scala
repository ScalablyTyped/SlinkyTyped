...
object GotBodyOptions {
  @scala.inline
  def apply[/* <: java.lang.String | scala.Null */ E](): GotBodyOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GotBodyOptions[E]]
  }
  @scala.inline
  implicit class GotBodyOptionsOps[Self <: GotBodyOptions[_], /* <: java.lang.String | scala.Null */ E] (val x: Self with GotBodyOptions[E]) extends AnyVal {
    @scala.inline
