...
import typingsSlinky.gapiClientPhotoslibrary.gapi.client.photoslibrary.SearchMediaItemsRequest
...
object AnonResource {
  @scala.inline
  def apply(resource: SearchMediaItemsRequest): AnonResource = {
  ...
  implicit class AnonResourceOps[Self <: AnonResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: SearchMediaItemsRequest): Self = {
