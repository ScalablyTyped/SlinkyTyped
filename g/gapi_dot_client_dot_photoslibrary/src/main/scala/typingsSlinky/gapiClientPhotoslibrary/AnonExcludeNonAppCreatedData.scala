...
@js.native
trait AnonExcludeNonAppCreatedData extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonExcludeNonAppCreatedData {
  @scala.inline
  def apply(): AnonExcludeNonAppCreatedData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonExcludeNonAppCreatedData]
  }
  @scala.inline
  implicit class AnonExcludeNonAppCreatedDataOps[Self <: AnonExcludeNonAppCreatedData] (val x: Self) extends AnyVal {
    @scala.inline
