...
@js.native
trait ExcludeNonAppCreatedData extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object ExcludeNonAppCreatedData {
  @scala.inline
  def apply(): ExcludeNonAppCreatedData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExcludeNonAppCreatedData]
  }
  @scala.inline
  implicit class ExcludeNonAppCreatedDataOps[Self <: ExcludeNonAppCreatedData] (val x: Self) extends AnyVal {
    @scala.inline
