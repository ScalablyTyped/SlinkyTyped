...
object Filters {
  ...
  def apply(
    ...
    if (!js.isUndefined(excludeNonAppCreatedData)) __obj.updateDynamic("excludeNonAppCreatedData")(excludeNonAppCreatedData.get.asInstanceOf[js.Any])
    if (featureFilter != null) __obj.updateDynamic("featureFilter")(featureFilter.asInstanceOf[js.Any])
    if (!js.isUndefined(includeArchivedMedia)) __obj.updateDynamic("includeArchivedMedia")(includeArchivedMedia.get.asInstanceOf[js.Any])
