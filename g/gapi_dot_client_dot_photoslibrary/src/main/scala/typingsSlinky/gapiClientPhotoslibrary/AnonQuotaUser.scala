...
import typingsSlinky.gapiClientPhotoslibrary.gapi.client.photoslibrary.BatchCreateMediaItemsRequest
...
object AnonQuotaUser {
  @scala.inline
  def apply(resource: BatchCreateMediaItemsRequest): AnonQuotaUser = {
  ...
  implicit class AnonQuotaUserOps[Self <: AnonQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchCreateMediaItemsRequest): Self = {
