...
object AnonMediaItemIds {
  @scala.inline
  def apply(): AnonMediaItemIds = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonMediaItemIds]
  }
  @scala.inline
  implicit class AnonMediaItemIdsOps[Self <: AnonMediaItemIds] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMediaItemIds(value: String | js.Array[String]): Self = {
        val ret = this.duplicate
