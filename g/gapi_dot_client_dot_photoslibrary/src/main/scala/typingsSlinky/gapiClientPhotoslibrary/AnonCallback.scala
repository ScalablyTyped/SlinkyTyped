...
import typingsSlinky.gapiClientPhotoslibrary.gapi.client.photoslibrary.BatchRemoveMediaItemsFromAlbumRequest
...
object AnonCallback {
  @scala.inline
  def apply(albumId: String, resource: BatchRemoveMediaItemsFromAlbumRequest): AnonCallback = {
  ...
  implicit class AnonCallbackOps[Self <: AnonCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchRemoveMediaItemsFromAlbumRequest): Self = {
        val ret = this.duplicate
