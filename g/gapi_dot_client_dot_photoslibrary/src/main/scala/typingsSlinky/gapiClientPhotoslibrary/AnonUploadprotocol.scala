...
import typingsSlinky.gapiClientPhotoslibrary.gapi.client.photoslibrary.LeaveSharedAlbumRequest
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonUploadprotocol extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
  ...
  /** Request body */
  var resource: LeaveSharedAlbumRequest = js.native
...
object AnonUploadprotocol {
  @scala.inline
  def apply(resource: LeaveSharedAlbumRequest): AnonUploadprotocol = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonUploadprotocol]
  }
  @scala.inline
  implicit class AnonUploadprotocolOps[Self <: AnonUploadprotocol] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withResource(value: LeaveSharedAlbumRequest): Self = {
