...
@js.native
trait AnonMediaItemId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
  ...
  var mediaItemId: String = js.native
...
object AnonMediaItemId {
  @scala.inline
  def apply(mediaItemId: String): AnonMediaItemId = {
    val __obj = js.Dynamic.literal(mediaItemId = mediaItemId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonMediaItemId]
  }
  @scala.inline
  implicit class AnonMediaItemIdOps[Self <: AnonMediaItemId] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withMediaItemId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mediaItemId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
