...
import typingsSlinky.gapiClientPhotoslibrary.gapi.client.photoslibrary.JoinSharedAlbumRequest
...
trait AnonUploadType extends js.Object {
  ...
  /** Request body */
  var resource: JoinSharedAlbumRequest = js.native
...
object AnonUploadType {
  @scala.inline
  def apply(resource: JoinSharedAlbumRequest): AnonUploadType = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonUploadType]
  }
  @scala.inline
  implicit class AnonUploadTypeOps[Self <: AnonUploadType] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withResource(value: JoinSharedAlbumRequest): Self = {
