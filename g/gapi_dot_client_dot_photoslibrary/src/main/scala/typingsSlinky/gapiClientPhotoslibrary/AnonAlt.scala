...
import typingsSlinky.gapiClientPhotoslibrary.gapi.client.photoslibrary.BatchAddMediaItemsToAlbumRequest
...
object AnonAlt {
  @scala.inline
  def apply(albumId: String, resource: BatchAddMediaItemsToAlbumRequest): AnonAlt = {
  ...
  implicit class AnonAltOps[Self <: AnonAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: BatchAddMediaItemsToAlbumRequest): Self = {
        val ret = this.duplicate
