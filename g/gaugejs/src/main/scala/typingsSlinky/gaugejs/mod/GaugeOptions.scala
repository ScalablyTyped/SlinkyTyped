...
import typingsSlinky.gaugejs.anon.Color
import typingsSlinky.gaugejs.anon.DivColor
import typingsSlinky.gaugejs.anon.PointerOptionsiconPathstr
import typingsSlinky.gaugejs.anon.StaticZoneOptionsheightnu
