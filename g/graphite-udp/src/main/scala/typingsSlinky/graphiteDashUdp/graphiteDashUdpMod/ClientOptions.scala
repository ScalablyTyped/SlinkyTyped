...
import typingsSlinky.graphiteDashUdp.graphiteDashUdpStrings.udp4
import typingsSlinky.graphiteDashUdp.graphiteDashUdpStrings.udp6
...
object ClientOptions {
  @scala.inline
  def apply(
    callback: (/* error */ js.Error, /* metrics */ js.Any) => Unit = null,
    host: String = null,
