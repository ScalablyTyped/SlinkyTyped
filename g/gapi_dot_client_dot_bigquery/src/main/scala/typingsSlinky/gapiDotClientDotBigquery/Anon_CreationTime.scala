package typingsSlinky.gapiDotClientDotBigquery

import typingsSlinky.gapiDotClientDotBigquery.gapi.client.bigquery.TableReference
import typingsSlinky.gapiDotClientDotBigquery.gapi.client.bigquery.TimePartitioning
