...
object AnonAlt {
  @scala.inline
  def apply(datasetId: String, projectId: String): AnonAlt = {
  ...
  implicit class AnonAltOps[Self <: AnonAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeleteContents(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteContents")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDeleteContents: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteContents")(js.undefined)
        ret
    }
    @scala.inline
