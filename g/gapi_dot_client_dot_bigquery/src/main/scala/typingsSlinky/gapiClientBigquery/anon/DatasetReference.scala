...
trait DatasetReference extends js.Object {
  ...
  var datasetReference: js.UndefOr[typingsSlinky.gapiClientBigquery.gapi.client.bigquery.DatasetReference] = js.undefined
...
object DatasetReference {
  @scala.inline
  def apply(
    datasetReference: typingsSlinky.gapiClientBigquery.gapi.client.bigquery.DatasetReference = null,
