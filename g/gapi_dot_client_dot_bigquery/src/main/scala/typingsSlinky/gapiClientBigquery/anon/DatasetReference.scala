...
trait DatasetReference extends js.Object {
  ...
  var datasetReference: js.UndefOr[typingsSlinky.gapiClientBigquery.gapi.client.bigquery.DatasetReference] = js.native
...
object DatasetReference {
  ...
  implicit class DatasetReferenceOps[Self <: DatasetReference] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDatasetReference(value: typingsSlinky.gapiClientBigquery.gapi.client.bigquery.DatasetReference): Self = this.set("datasetReference", value.asInstanceOf[js.Any])
    @scala.inline
