...
object TableList {
  ...
  implicit class TableListOps[Self <: TableList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTablesVarargs(value: CreationTime*): Self = this.set("tables", js.Array(value :_*))
    @scala.inline
    def setTables(value: js.Array[CreationTime]): Self = this.set("tables", value.asInstanceOf[js.Any])
    @scala.inline
