...
trait DatasetList extends js.Object {
  /**
    ...
    */
  var datasets: js.UndefOr[js.Array[typingsSlinky.gapiClientBigquery.anon.DatasetReference]] = js.undefined
...
object DatasetList {
  @scala.inline
  def apply(
    datasets: js.Array[typingsSlinky.gapiClientBigquery.anon.DatasetReference] = null,
    etag: String = null,
    kind: String = null,
