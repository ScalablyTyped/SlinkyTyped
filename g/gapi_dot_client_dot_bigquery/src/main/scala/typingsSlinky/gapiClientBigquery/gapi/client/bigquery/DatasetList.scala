...
trait DatasetList extends js.Object {
  ...
  /**
    ...
    */
  var datasets: js.UndefOr[js.Array[typingsSlinky.gapiClientBigquery.anon.DatasetReference]] = js.native
...
object DatasetList {
  ...
  implicit class DatasetListOps[Self <: DatasetList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDatasetsVarargs(value: typingsSlinky.gapiClientBigquery.anon.DatasetReference*): Self = this.set("datasets", js.Array(value :_*))
    
    @scala.inline
    def setDatasets(value: js.Array[typingsSlinky.gapiClientBigquery.anon.DatasetReference]): Self = this.set("datasets", value.asInstanceOf[js.Any])
