...
object AnonAlt {
  ...
  implicit class AnonAltOps[Self <: AnonAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNumStates(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("numStates")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNumStates: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("numStates")(js.undefined)
        ret
    }
    @scala.inline
