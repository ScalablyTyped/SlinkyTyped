...
object GLViewDOM
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.glReactDom.glviewdomMod.GLViewDOM] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.glReactDom.glviewdomMod.GLViewDOM] = {
