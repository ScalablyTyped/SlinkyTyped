package typingsSlinky.glDashReactDashDom.glDashReactDashDomMod
...
- typings.glDashReactDashDom.gLViewDOMMod.GLViewDOMProps because var conflicts: style. Inlined onContextCreate, onContextFailure, onContextLost, onContextRestored, webglContextAttributes, pixelRatio, width, height, debug */ trait SurfaceProps
