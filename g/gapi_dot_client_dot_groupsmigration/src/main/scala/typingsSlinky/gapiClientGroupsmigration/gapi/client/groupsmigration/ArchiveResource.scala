...
import typingsSlinky.gapiClientGroupsmigration.AnonAlt
...
trait ArchiveResource extends js.Object {
  ...
  def insert(request: AnonAlt): Request_[Groups] = js.native
}
...
object ArchiveResource {
  ...
  implicit class ArchiveResourceOps[Self <: ArchiveResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInsert(value: AnonAlt => Request_[Groups]): Self = {
