...
object AdministrativeBody {
  ...
  implicit class AdministrativeBodyOps[Self <: AdministrativeBody] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCorrespondenceAddress(value: SimpleAddressType): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withElectionOfficials(value: js.Array[ElectionOfficial]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPhysicalAddress(value: SimpleAddressType): Self = {
        val ret = this.duplicate
