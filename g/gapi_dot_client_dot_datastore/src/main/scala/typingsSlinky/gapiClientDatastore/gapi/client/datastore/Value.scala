...
object Value {
  ...
  implicit class ValueOps[Self <: Value] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntityValue(value: Entity): Self = this.set("entityValue", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setKeyValue(value: Key): Self = this.set("keyValue", value.asInstanceOf[js.Any])
    @scala.inline
