...
import typingsSlinky.gapiClientDatastore.AnonAccesstoken
import typingsSlinky.gapiClientDatastore.AnonAlt
...
trait OperationsResource extends js.Object {
  ...
  /**
    ...
    */
  def list(request: AnonAlt): Request_[GoogleLongrunningListOperationsResponse] = js.native
}
...
object OperationsResource {
  ...
  def apply(
    ...
    list: AnonAlt => Request_[GoogleLongrunningListOperationsResponse]
  ): OperationsResource = {
  ...
  implicit class OperationsResourceOps[Self <: OperationsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withList(value: AnonAlt => Request_[GoogleLongrunningListOperationsResponse]): Self = {
        val ret = this.duplicate
