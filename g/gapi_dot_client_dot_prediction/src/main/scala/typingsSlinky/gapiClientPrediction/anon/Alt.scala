...
trait Alt extends js.Object {
  ...
  var hostedModelName: String = js.native
...
object Alt {
  @scala.inline
  def apply(hostedModelName: String, project: String): Alt = {
  ...
  implicit class AltOps[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHostedModelName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hostedModelName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
