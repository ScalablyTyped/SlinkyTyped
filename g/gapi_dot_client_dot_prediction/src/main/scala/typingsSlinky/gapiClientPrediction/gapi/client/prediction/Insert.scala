...
trait Insert extends js.Object {
  ...
  var trainingInstances: js.UndefOr[js.Array[typingsSlinky.gapiClientPrediction.anon.Output]] = js.undefined
...
object Insert {
  ...
  def apply(
    ...
    trainingInstances: js.Array[typingsSlinky.gapiClientPrediction.anon.Output] = null,
