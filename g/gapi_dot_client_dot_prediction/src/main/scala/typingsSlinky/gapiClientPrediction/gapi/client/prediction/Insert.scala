...
object Insert {
  ...
  implicit class InsertOps[Self <: Insert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTrainingInstancesVarargs(value: typingsSlinky.gapiClientPrediction.anon.Output*): Self = this.set("trainingInstances", js.Array(value :_*))
    @scala.inline
    def setTrainingInstances(value: js.Array[typingsSlinky.gapiClientPrediction.anon.Output]): Self = this.set("trainingInstances", value.asInstanceOf[js.Any])
    @scala.inline
