...
import typingsSlinky.gapiDotClientDotPrediction.Anon_AltFields
import typingsSlinky.gapiDotClientDotPrediction.Anon_AltFieldsKey
import typingsSlinky.gapiDotClientDotPrediction.Anon_AltFieldsKeyMaxResults
