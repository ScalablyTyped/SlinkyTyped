...
@js.native
trait AnonLanguageCode extends js.Object {
...
object AnonLanguageCode {
  @scala.inline
  def apply(enterpriseId: String, productId: String): AnonLanguageCode = {
    val __obj = js.Dynamic.literal(enterpriseId = enterpriseId.asInstanceOf[js.Any], productId = productId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLanguageCode]
  }
  @scala.inline
  implicit class AnonLanguageCodeOps[Self <: AnonLanguageCode] (val x: Self) extends AnyVal {
    @scala.inline
