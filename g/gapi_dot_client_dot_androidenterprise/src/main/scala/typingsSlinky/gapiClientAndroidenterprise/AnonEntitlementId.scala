...
object AnonEntitlementId {
  @scala.inline
  def apply(enterpriseId: String, entitlementId: String, userId: String): AnonEntitlementId = {
  ...
  @scala.inline
  implicit class AnonEntitlementIdOps[Self <: AnonEntitlementId] (val x: Self) extends AnyVal {
    @scala.inline
