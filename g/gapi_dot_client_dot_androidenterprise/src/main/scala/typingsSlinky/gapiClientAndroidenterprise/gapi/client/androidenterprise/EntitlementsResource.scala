...
trait EntitlementsResource extends js.Object {
  ...
  def patch(request: typingsSlinky.gapiClientAndroidenterprise.anon.Install): Request[Entitlement]
  /** Adds or updates an entitlement to an app for a user. */
  def update(request: typingsSlinky.gapiClientAndroidenterprise.anon.Install): Request[Entitlement]
}
