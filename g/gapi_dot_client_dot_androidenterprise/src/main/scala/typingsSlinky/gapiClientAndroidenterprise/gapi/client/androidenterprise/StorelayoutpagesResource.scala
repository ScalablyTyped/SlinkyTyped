...
trait StorelayoutpagesResource extends js.Object {
  ...
  def get(request: AnonPageId): Request_[StorePage] = js.native
  /** Inserts a new store page. */
  def insert(request: AnonKey): Request_[StorePage] = js.native
  /** Retrieves the details of all pages in the store. */
  def list(request: AnonKey): Request_[StoreLayoutPagesListResponse] = js.native
  /** Updates the content of a store page. This method supports patch semantics. */
  def patch(request: AnonPageId): Request_[StorePage] = js.native
  /** Updates the content of a store page. */
  def update(request: AnonPageId): Request_[StorePage] = js.native
}
...
object StorelayoutpagesResource {
  ...
  implicit class StorelayoutpagesResourceOps[Self <: StorelayoutpagesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: AnonPageId => Request_[StorePage]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsert(value: AnonKey => Request_[StorePage]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insert")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: AnonKey => Request_[StoreLayoutPagesListResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: AnonPageId => Request_[StorePage]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("patch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdate(value: AnonPageId => Request_[StorePage]): Self = {
        val ret = this.duplicate
