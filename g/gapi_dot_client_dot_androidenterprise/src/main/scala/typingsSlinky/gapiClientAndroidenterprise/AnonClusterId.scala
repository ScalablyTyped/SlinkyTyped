...
@js.native
trait AnonClusterId extends js.Object {
...
object AnonClusterId {
  @scala.inline
  def apply(clusterId: String, enterpriseId: String, pageId: String): AnonClusterId = {
    ...
    __obj.asInstanceOf[AnonClusterId]
  }
  @scala.inline
  implicit class AnonClusterIdOps[Self <: AnonClusterId] (val x: Self) extends AnyVal {
    @scala.inline
