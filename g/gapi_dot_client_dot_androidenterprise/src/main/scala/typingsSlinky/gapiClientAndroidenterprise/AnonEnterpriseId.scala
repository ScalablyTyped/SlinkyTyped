...
@js.native
trait AnonEnterpriseId extends js.Object {
...
object AnonEnterpriseId {
  @scala.inline
  def apply(enterpriseId: String, userId: String): AnonEnterpriseId = {
    val __obj = js.Dynamic.literal(enterpriseId = enterpriseId.asInstanceOf[js.Any], userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonEnterpriseId]
  }
  @scala.inline
  implicit class AnonEnterpriseIdOps[Self <: AnonEnterpriseId] (val x: Self) extends AnyVal {
    @scala.inline
