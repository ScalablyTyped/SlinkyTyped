...
@js.native
trait AnonManagedConfigurationForDeviceId extends js.Object {
  ...
  var managedConfigurationForDeviceId: String = js.native
...
object AnonManagedConfigurationForDeviceId {
  @scala.inline
  def apply(deviceId: String, enterpriseId: String, managedConfigurationForDeviceId: String, userId: String): AnonManagedConfigurationForDeviceId = {
    ...
    __obj.asInstanceOf[AnonManagedConfigurationForDeviceId]
  }
  @scala.inline
  implicit class AnonManagedConfigurationForDeviceIdOps[Self <: AnonManagedConfigurationForDeviceId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withManagedConfigurationForDeviceId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("managedConfigurationForDeviceId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
