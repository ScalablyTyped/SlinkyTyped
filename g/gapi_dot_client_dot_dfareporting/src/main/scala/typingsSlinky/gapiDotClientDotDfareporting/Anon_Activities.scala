...
import typingsSlinky.gapiDotClientDotDfareporting.gapi.client.dfareporting.Activities
import typingsSlinky.gapiDotClientDotDfareporting.gapi.client.dfareporting.CustomRichMediaEvents
