...
@js.native
trait AnonFloodlightActivityId extends js.Object {
...
object AnonFloodlightActivityId {
  @scala.inline
  def apply(profileId: String): AnonFloodlightActivityId = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFloodlightActivityId]
  }
  @scala.inline
  implicit class AnonFloodlightActivityIdOps[Self <: AnonFloodlightActivityId] (val x: Self) extends AnyVal {
    @scala.inline
