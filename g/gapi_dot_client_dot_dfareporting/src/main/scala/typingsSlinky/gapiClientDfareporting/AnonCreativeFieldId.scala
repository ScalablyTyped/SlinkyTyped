...
object AnonCreativeFieldId {
  @scala.inline
  def apply(creativeFieldId: String, id: String, profileId: String): AnonCreativeFieldId = {
  ...
  @scala.inline
  implicit class AnonCreativeFieldIdOps[Self <: AnonCreativeFieldId] (val x: Self) extends AnyVal {
    @scala.inline
