...
object AnonFloodlightActivityGroupIds {
  @scala.inline
  def apply(profileId: String): AnonFloodlightActivityGroupIds = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFloodlightActivityGroupIds]
  }
  @scala.inline
  implicit class AnonFloodlightActivityGroupIdsOps[Self <: AnonFloodlightActivityGroupIds] (val x: Self) extends AnyVal {
    @scala.inline
