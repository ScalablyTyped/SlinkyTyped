...
@js.native
trait AnonSynchronous extends js.Object {
...
object AnonSynchronous {
  @scala.inline
  def apply(profileId: String, reportId: String): AnonSynchronous = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any], reportId = reportId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSynchronous]
  }
  @scala.inline
  implicit class AnonSynchronousOps[Self <: AnonSynchronous] (val x: Self) extends AnyVal {
    @scala.inline
