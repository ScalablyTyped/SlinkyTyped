...
object AnonActiveAdvertiserId {
  @scala.inline
  def apply(advertiserId: String, profileId: String): AnonActiveAdvertiserId = {
  ...
  @scala.inline
  implicit class AnonActiveAdvertiserIdOps[Self <: AnonActiveAdvertiserId] (val x: Self) extends AnyVal {
    @scala.inline
