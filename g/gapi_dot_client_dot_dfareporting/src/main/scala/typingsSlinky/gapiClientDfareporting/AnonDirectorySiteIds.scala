...
@js.native
trait AnonDirectorySiteIds extends js.Object {
...
object AnonDirectorySiteIds {
  @scala.inline
  def apply(profileId: String): AnonDirectorySiteIds = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDirectorySiteIds]
  }
  @scala.inline
  implicit class AnonDirectorySiteIdsOps[Self <: AnonDirectorySiteIds] (val x: Self) extends AnyVal {
    @scala.inline
