...
@js.native
trait AnonAcceptsInStreamVideoPlacements extends js.Object {
...
object AnonAcceptsInStreamVideoPlacements {
  @scala.inline
  def apply(profileId: String): AnonAcceptsInStreamVideoPlacements = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAcceptsInStreamVideoPlacements]
  }
  @scala.inline
  implicit class AnonAcceptsInStreamVideoPlacementsOps[Self <: AnonAcceptsInStreamVideoPlacements] (val x: Self) extends AnyVal {
    @scala.inline
