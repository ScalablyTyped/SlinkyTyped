...
object AnonAcceptsInterstitialPlacements {
  @scala.inline
  def apply(profileId: String): AnonAcceptsInterstitialPlacements = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAcceptsInterstitialPlacements]
  }
  @scala.inline
  implicit class AnonAcceptsInterstitialPlacementsOps[Self <: AnonAcceptsInterstitialPlacements] (val x: Self) extends AnyVal {
    @scala.inline
