...
@js.native
trait AdvertiserIdAlt extends js.Object {
...
object AdvertiserIdAlt {
  @scala.inline
  def apply(profileId: String): AdvertiserIdAlt = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AdvertiserIdAlt]
  }
  @scala.inline
  implicit class AdvertiserIdAltOps[Self <: AdvertiserIdAlt] (val x: Self) extends AnyVal {
    @scala.inline
