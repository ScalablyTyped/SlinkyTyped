...
trait Alt extends js.Object {
  ...
  /** Account ID. */
  var summaryAccountId: String = js.native
...
object Alt {
  @scala.inline
  def apply(profileId: String, summaryAccountId: String): Alt = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any], summaryAccountId = summaryAccountId.asInstanceOf[js.Any])
  ...
  implicit class AltOps[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSummaryAccountId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("summaryAccountId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
