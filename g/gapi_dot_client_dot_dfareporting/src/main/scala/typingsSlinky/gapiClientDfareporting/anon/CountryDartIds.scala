...
object CountryDartIds {
  ...
  implicit class CountryDartIdsOps[Self <: CountryDartIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCountryDartIds(value: String): Self = this.set("countryDartIds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCountryDartIds: Self = this.set("countryDartIds", js.undefined)
    
    @scala.inline
    def setDartIds(value: String): Self = this.set("dartIds", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRegionDartIds(value: String): Self = this.set("regionDartIds", value.asInstanceOf[js.Any])
