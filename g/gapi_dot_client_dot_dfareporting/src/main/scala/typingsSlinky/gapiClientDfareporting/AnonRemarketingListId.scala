...
@js.native
trait AnonRemarketingListId extends js.Object {
...
object AnonRemarketingListId {
  @scala.inline
  def apply(profileId: String, remarketingListId: String): AnonRemarketingListId = {
    ...
    __obj.asInstanceOf[AnonRemarketingListId]
  }
  @scala.inline
  implicit class AnonRemarketingListIdOps[Self <: AnonRemarketingListId] (val x: Self) extends AnyVal {
    @scala.inline
