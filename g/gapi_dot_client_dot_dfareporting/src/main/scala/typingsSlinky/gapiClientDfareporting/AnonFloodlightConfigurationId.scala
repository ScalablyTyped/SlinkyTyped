...
object AnonFloodlightConfigurationId {
  @scala.inline
  def apply(profileId: String): AnonFloodlightConfigurationId = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFloodlightConfigurationId]
  }
  @scala.inline
  implicit class AnonFloodlightConfigurationIdOps[Self <: AnonFloodlightConfigurationId] (val x: Self) extends AnyVal {
    @scala.inline
