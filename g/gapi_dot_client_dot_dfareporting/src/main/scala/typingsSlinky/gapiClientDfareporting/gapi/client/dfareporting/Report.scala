...
object Report {
  ...
  implicit class ReportOps[Self <: Report] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCriteria(value: typingsSlinky.gapiClientDfareporting.anon.Activities): Self = this.set("criteria", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFloodlightCriteria(value: typingsSlinky.gapiClientDfareporting.anon.CustomRichMediaEvents): Self = this.set("floodlightCriteria", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setReachCriteria(value: typingsSlinky.gapiClientDfareporting.anon.DateRange): Self = this.set("reachCriteria", value.asInstanceOf[js.Any])
    @scala.inline
