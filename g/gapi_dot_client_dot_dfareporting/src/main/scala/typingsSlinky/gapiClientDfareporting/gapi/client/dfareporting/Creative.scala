...
trait Creative extends js.Object {
  ...
  /**
    ...
    */
  var backupImageClickThroughUrl: js.UndefOr[String] = js.native
  ...
  var videoDescription: js.UndefOr[String] = js.native
...
object Creative {
  ...
  implicit class CreativeOps[Self <: Creative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackupImageClickThroughUrl(value: String): Self = this.set("backupImageClickThroughUrl", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVideoDescription(value: String): Self = this.set("videoDescription", value.asInstanceOf[js.Any])
