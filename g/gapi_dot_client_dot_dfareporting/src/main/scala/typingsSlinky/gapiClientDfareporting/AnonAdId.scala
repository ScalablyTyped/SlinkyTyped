...
@js.native
trait AnonAdId extends js.Object {
  ...
  /**
    ...
    */
  var eventTagTypes: js.UndefOr[String] = js.native
...
object AnonAdId {
  @scala.inline
  def apply(profileId: String): AnonAdId = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAdId]
  }
  @scala.inline
  implicit class AnonAdIdOps[Self <: AnonAdId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEventTagTypes(value: String): Self = {
        val ret = this.duplicate
