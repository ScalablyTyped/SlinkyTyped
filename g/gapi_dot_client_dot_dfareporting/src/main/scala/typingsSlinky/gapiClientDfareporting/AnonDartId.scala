...
@js.native
trait AnonDartId extends js.Object {
...
object AnonDartId {
  @scala.inline
  def apply(dartId: String, profileId: String): AnonDartId = {
    val __obj = js.Dynamic.literal(dartId = dartId.asInstanceOf[js.Any], profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDartId]
  }
  @scala.inline
  implicit class AnonDartIdOps[Self <: AnonDartId] (val x: Self) extends AnyVal {
    @scala.inline
