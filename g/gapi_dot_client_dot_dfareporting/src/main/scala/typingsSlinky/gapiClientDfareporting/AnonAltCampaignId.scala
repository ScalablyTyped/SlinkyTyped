...
@js.native
trait AnonAltCampaignId extends js.Object {
...
object AnonAltCampaignId {
  @scala.inline
  def apply(campaignId: String, id: String, profileId: String): AnonAltCampaignId = {
    ...
    __obj.asInstanceOf[AnonAltCampaignId]
  }
  @scala.inline
  implicit class AnonAltCampaignIdOps[Self <: AnonAltCampaignId] (val x: Self) extends AnyVal {
    @scala.inline
