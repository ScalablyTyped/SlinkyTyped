...
import typingsSlinky.gulpDashFileDashInclude.gulpDashFileDashIncludeStrings.`@file`
import typingsSlinky.gulpDashFileDashInclude.gulpDashFileDashIncludeStrings.`@root`
