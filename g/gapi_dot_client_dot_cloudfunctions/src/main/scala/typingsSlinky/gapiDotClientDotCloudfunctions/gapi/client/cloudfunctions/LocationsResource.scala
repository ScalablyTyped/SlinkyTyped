package typingsSlinky.gapiDotClientDotCloudfunctions.gapi.client.cloudfunctions

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotCloudfunctions.Anon_AccesstokenAltBearertoken
