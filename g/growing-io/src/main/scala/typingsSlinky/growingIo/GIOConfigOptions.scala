...
object GIOConfigOptions {
  ...
  def apply(dataCollect: js.UndefOr[Boolean] = js.undefined, hashtag: js.UndefOr[Boolean] = js.undefined): GIOConfigOptions = {
    ...
    if (!js.isUndefined(dataCollect)) __obj.updateDynamic("dataCollect")(dataCollect.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hashtag)) __obj.updateDynamic("hashtag")(hashtag.get.asInstanceOf[js.Any])
