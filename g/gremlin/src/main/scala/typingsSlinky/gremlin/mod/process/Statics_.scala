...
object Statics_ {
  @scala.inline
  def apply[/* <: typingsSlinky.gremlin.mod.process.GraphTraversal */ T](
    V: /* repeated */ js.Any => T,
  ...
  @scala.inline
  implicit class Statics_Ops[Self <: Statics_[_], /* <: typingsSlinky.gremlin.mod.process.GraphTraversal */ T] (val x: Self with Statics_[T]) extends AnyVal {
    @scala.inline
