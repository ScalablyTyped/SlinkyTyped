...
import typingsSlinky.getenv.getenvStrings.bool
import typingsSlinky.getenv.getenvStrings.boolish
import typingsSlinky.getenv.getenvStrings.float
import typingsSlinky.getenv.getenvStrings.int
import typingsSlinky.getenv.getenvStrings.string
import typingsSlinky.getenv.getenvStrings.url
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.getenv.getenvStrings.string
    - typingsSlinky.getenv.getenvStrings.int
    - typingsSlinky.getenv.getenvStrings.float
    - typingsSlinky.getenv.getenvStrings.bool
    - typingsSlinky.getenv.getenvStrings.boolish
    - typingsSlinky.getenv.getenvStrings.url
  */
