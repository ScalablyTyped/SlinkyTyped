...
object mod extends Shortcut {
  ...
  trait GlobuleStatic extends StObject {
    ...
    def isMatch(patterns: String, filepaths: String, options: typingsSlinky.minimatch.mod.IOptions): Boolean = js.native
    def isMatch(patterns: String, filepaths: js.Array[String]): Boolean = js.native
    def isMatch(patterns: String, filepaths: js.Array[String], options: typingsSlinky.minimatch.mod.IOptions): Boolean = js.native
    def isMatch(patterns: js.Array[String], filepaths: String): Boolean = js.native
    def isMatch(patterns: js.Array[String], filepaths: String, options: typingsSlinky.minimatch.mod.IOptions): Boolean = js.native
    ...
    def isMatch(
      ...
      options: typingsSlinky.minimatch.mod.IOptions
    ): Boolean = js.native
    ...
    def `match`(patterns: String, filepaths: String, options: typingsSlinky.minimatch.mod.IOptions): js.Array[String] = js.native
    def `match`(patterns: String, filepaths: js.Array[String]): js.Array[String] = js.native
    def `match`(patterns: String, filepaths: js.Array[String], options: typingsSlinky.minimatch.mod.IOptions): js.Array[String] = js.native
    def `match`(patterns: js.Array[String], filepaths: String): js.Array[String] = js.native
    def `match`(patterns: js.Array[String], filepaths: String, options: typingsSlinky.minimatch.mod.IOptions): js.Array[String] = js.native
