...
object mod {
  ...
  @JSImport("git-repo-name", JSImport.Namespace)
  @js.native
  def apply(callback: js.Function2[/* err */ js.Error | Null, /* repoName */ String, Unit]): Unit = js.native
  @JSImport("git-repo-name", JSImport.Namespace)
  @js.native
  def apply(options: String): js.Promise[String] = js.native
  @JSImport("git-repo-name", JSImport.Namespace)
  @js.native
  def apply(options: String, callback: js.Function2[/* err */ js.Error | Null, /* repoName */ String, Unit]): Unit = js.native
  @JSImport("git-repo-name", JSImport.Namespace)
  @js.native
  def apply(options: Options): js.Promise[String] = js.native
  @JSImport("git-repo-name", JSImport.Namespace)
  @js.native
  def apply(options: Options, callback: js.Function2[/* err */ js.Error | Null, /* repoName */ String, Unit]): Unit = js.native
