...
import typingsSlinky.npm.mod.NPM.Commands
import typingsSlinky.npm.mod.NPM.Config
import typingsSlinky.npm.mod.NPM.ConfigOptions
import typingsSlinky.npm.mod.NPM.Dictionary
import typingsSlinky.npm.mod.NPM.SimpleCallback
import typingsSlinky.npm.mod.NPM.Spinner
