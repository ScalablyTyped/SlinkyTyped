...
object mod {
  ...
  class DatastoreRequest ()
    extends typingsSlinky.googleCloudDatastore.requestMod.DatastoreRequest
  /* static member */
  @JSImport("@google-cloud/datastore", "DatastoreRequest")
  @js.native
  ...
  class Query protected ()
    extends typingsSlinky.googleCloudDatastore.queryMod.Query {
  ...
  trait Datastore
    ...
    def createQuery(kind: String): typingsSlinky.googleCloudDatastore.queryMod.Query = js.native
    // tslint:disable-next-line unified-signatures (Arg is semantically different)
    def createQuery(namespace: String, kind: String): typingsSlinky.googleCloudDatastore.queryMod.Query = js.native
