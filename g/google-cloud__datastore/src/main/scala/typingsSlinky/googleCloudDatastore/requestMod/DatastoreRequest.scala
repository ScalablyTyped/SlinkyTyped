...
import typingsSlinky.googleCloudDatastore.entityMod.OneOrMany
import typingsSlinky.googleCloudDatastore.queryMod.Query
import typingsSlinky.googleCloudDatastore.queryMod.QueryCallback
import typingsSlinky.googleCloudDatastore.queryMod.QueryOptions
import typingsSlinky.googleCloudDatastore.queryMod.QueryResult
