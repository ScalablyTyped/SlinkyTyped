...
import typingsSlinky.atGoogleDashCloudDatastore.entityMod.DatastoreCoords
import typingsSlinky.atGoogleDashCloudDatastore.entityMod.DatastoreDouble
import typingsSlinky.atGoogleDashCloudDatastore.entityMod.DatastoreGeopoint
import typingsSlinky.atGoogleDashCloudDatastore.entityMod.DatastoreInt
import typingsSlinky.atGoogleDashCloudDatastore.entityMod.DatastoreKey
import typingsSlinky.atGoogleDashCloudDatastore.entityMod.DatastoreKeyOptions
import typingsSlinky.atGoogleDashCloudDatastore.entityMod.DatastoreKeyPath
