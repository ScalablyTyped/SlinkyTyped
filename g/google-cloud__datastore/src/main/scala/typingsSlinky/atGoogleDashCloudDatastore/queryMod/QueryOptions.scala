package typingsSlinky.atGoogleDashCloudDatastore.queryMod

import typingsSlinky.atGoogleDashCloudDatastore.atGoogleDashCloudDatastoreStrings.eventual
import typingsSlinky.atGoogleDashCloudDatastore.atGoogleDashCloudDatastoreStrings.strong
