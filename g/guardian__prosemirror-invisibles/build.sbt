...
version := "1.2-dt-20190213Z-b65d1c"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "prosemirror-state" % "1.2-dt-20200225Z-711850",
  "org.scalablytyped.slinky" %%% "prosemirror-transform" % "1.1-dt-20191101Z-225c47",
  "org.scalablytyped.slinky" %%% "prosemirror-view" % "1.11-dt-20200416Z-7b5b26",
