...
object AnonInheritResolversFromInterfaces {
  @scala.inline
  def apply(schemas: js.Array[String | GraphQLSchema | DocumentNode | js.Array[GraphQLNamedType]]): AnonInheritResolversFromInterfaces = {
    val __obj = js.Dynamic.literal(schemas = schemas.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonInheritResolversFromInterfaces]
  }
  @scala.inline
  implicit class AnonInheritResolversFromInterfacesOps[Self <: AnonInheritResolversFromInterfaces] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    def withOnTypeConflict(
      value: (/* left */ GraphQLNamedType, /* right */ GraphQLNamedType, /* info */ js.UndefOr[AnonLeft]) => GraphQLNamedType
    ): Self = {
        val ret = this.duplicate
