...
object DocumentNodedefinitionsAr {
  @scala.inline
  def apply(definitions: js.Array[DefinitionNode], kind: Document): DocumentNodedefinitionsAr = {
  ...
  @scala.inline
  implicit class DocumentNodedefinitionsArOps[Self <: DocumentNodedefinitionsAr] (val x: Self) extends AnyVal {
    @scala.inline
