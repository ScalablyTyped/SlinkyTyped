...
object observableToAsyncIterableMod extends js.Object {
  def observableToAsyncIterable[T](observable: Observable[T]): (AsyncIterator[T, _, js.UndefOr[scala.Nothing]]) with typingsSlinky.graphqlTools.anon.AsyncIterator[T] = js.native
}
