...
object TokenizationType {
  @scala.inline
  def DIRECT: typingsSlinky.googlepay.googlepayStrings.DIRECT = this.cast("DIRECT")
  @scala.inline
  def PAYMENT_GATEWAY: typingsSlinky.googlepay.googlepayStrings.PAYMENT_GATEWAY = this.cast("PAYMENT_GATEWAY")
  @scala.inline
