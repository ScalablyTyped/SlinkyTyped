...
object AnonCountries {
  @scala.inline
  def apply(accountId: String): AnonCountries = {
  ...
  implicit class AnonCountriesOps[Self <: AnonCountries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutMids: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mids")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSeasonIds(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("seasonIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSeasonIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("seasonIds")(js.undefined)
        ret
    }
    @scala.inline
