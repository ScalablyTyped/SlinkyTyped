...
object Countries {
  @scala.inline
  def apply(accountId: String): Countries = {
  ...
  implicit class CountriesOps[Self <: Countries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCountries(value: String): Self = this.set("countries", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def deleteMids: Self = this.set("mids", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setSeasonIds(value: String): Self = this.set("seasonIds", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSeasonIds: Self = this.set("seasonIds", js.undefined)
    @scala.inline
