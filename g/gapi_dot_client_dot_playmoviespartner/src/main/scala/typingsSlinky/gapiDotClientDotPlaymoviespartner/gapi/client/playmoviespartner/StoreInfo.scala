...
object StoreInfo {
  ...
  def apply(
    ...
    if (!js.isUndefined(hasAudio51)) __obj.updateDynamic("hasAudio51")(hasAudio51.asInstanceOf[js.Any])
    if (!js.isUndefined(hasEstOffer)) __obj.updateDynamic("hasEstOffer")(hasEstOffer.asInstanceOf[js.Any])
    if (!js.isUndefined(hasHdOffer)) __obj.updateDynamic("hasHdOffer")(hasHdOffer.asInstanceOf[js.Any])
    if (!js.isUndefined(hasInfoCards)) __obj.updateDynamic("hasInfoCards")(hasInfoCards.asInstanceOf[js.Any])
    if (!js.isUndefined(hasSdOffer)) __obj.updateDynamic("hasSdOffer")(hasSdOffer.asInstanceOf[js.Any])
    if (!js.isUndefined(hasVodOffer)) __obj.updateDynamic("hasVodOffer")(hasVodOffer.asInstanceOf[js.Any])
