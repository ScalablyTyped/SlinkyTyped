...
object ModelsResource {
  ...
  implicit class ModelsResourceOps[Self <: ModelsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: Alt => Request[GoogleCloudMlV1Model]): Self = {
    ...
    @scala.inline
    def withGet(value: Accesstoken => Request[GoogleCloudMlV1Model]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withList(value: Fields => Request[GoogleCloudMlV1ListModelsResponse]): Self = {
        val ret = this.duplicate
