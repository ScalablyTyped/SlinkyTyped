...
object WhereFilterOp {
  ...
  @scala.inline
  def `array-contains-any`: typingsSlinky.atGoogleDashCloudFirestore.atGoogleDashCloudFirestoreStrings.`array-contains-any` = this.cast("array-contains-any")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def in: typingsSlinky.atGoogleDashCloudFirestore.atGoogleDashCloudFirestoreStrings.in = this.cast("in")
}
