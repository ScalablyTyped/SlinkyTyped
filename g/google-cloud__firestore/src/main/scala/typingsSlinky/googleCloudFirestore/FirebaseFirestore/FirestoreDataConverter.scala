...
trait FirestoreDataConverter[T] extends js.Object {
  /**
    ...
    * type T.
    */
  def fromFirestore(data: DocumentData): T = js.native
  /**
...
object FirestoreDataConverter {
  ...
  implicit class FirestoreDataConverterOps[Self[t] <: FirestoreDataConverter[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withFromFirestore(value: DocumentData => T): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fromFirestore")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
