...
class Util_ () extends StObject {
  ...
  var PartialFailureError: Instantiable1[
    /* b */ GoogleErrorBody, 
    typingsSlinky.googleCloudCommon.utilMod.PartialFailureError
  ] = js.native
  ...
  def handleResp(err: js.Error, resp: js.UndefOr[scala.Nothing], body: ResponseBody): Unit = js.native
  def handleResp(err: js.Error, resp: js.UndefOr[scala.Nothing], body: ResponseBody, callback: BodyResponseCallback): Unit = js.native
  def handleResp(err: js.Error, resp: Null, body: js.UndefOr[scala.Nothing], callback: BodyResponseCallback): Unit = js.native
