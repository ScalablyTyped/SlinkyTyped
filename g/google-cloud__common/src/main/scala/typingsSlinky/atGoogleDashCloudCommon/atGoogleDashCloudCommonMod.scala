...
import typingsSlinky.atGoogleDashCloudCommon.buildSrcServiceMod.ServiceConfig
import typingsSlinky.atGoogleDashCloudCommon.buildSrcServiceMod.ServiceOptions
import typingsSlinky.atGoogleDashCloudCommon.buildSrcUtilMod.GoogleErrorBody
import typingsSlinky.atGoogleDashCloudCommon.buildSrcUtilMod.GoogleInnerError
import typingsSlinky.atGoogleDashCloudCommon.buildSrcUtilMod.Util
...
object atGoogleDashCloudCommonMod extends js.Object {
  ...
  class ApiError protected ()
    extends typingsSlinky.atGoogleDashCloudCommon.buildSrcUtilMod.ApiError {
  ...
  class Operation[T] protected ()
    extends typingsSlinky.atGoogleDashCloudCommon.buildSrcOperationMod.Operation[T] {
    /**
  ...
  class Service protected ()
    extends typingsSlinky.atGoogleDashCloudCommon.buildSrcServiceMod.Service {
    /**
  ...
  class ServiceObject[T] protected ()
    extends typingsSlinky.atGoogleDashCloudCommon.buildSrcServiceDashObjectMod.ServiceObject[T] {
    def this(config: ServiceObjectConfig) = this()
  }
  ...
  object util extends TopLevel[Util] {
    ...
    class PartialFailureError protected ()
      extends typingsSlinky.atGoogleDashCloudCommon.buildSrcUtilMod.PartialFailureError {
