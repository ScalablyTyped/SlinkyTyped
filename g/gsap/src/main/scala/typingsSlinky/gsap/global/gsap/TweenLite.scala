...
object TweenLite {
  ...
  @js.native
  def defaultEase: typingsSlinky.gsap.gsap.Ease = js.native
  @scala.inline
  def defaultEase_=(x: typingsSlinky.gsap.gsap.Ease): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultEase")(x.asInstanceOf[js.Any])
