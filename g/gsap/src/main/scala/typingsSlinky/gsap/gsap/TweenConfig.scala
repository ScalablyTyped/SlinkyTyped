...
object TweenConfig {
  ...
  def apply(
    ...
    if (onReverseCompleteParams != null) __obj.updateDynamic("onReverseCompleteParams")(onReverseCompleteParams.asInstanceOf[js.Any])
    if (onReverseCompleteScope != null) __obj.updateDynamic("onReverseCompleteScope")(onReverseCompleteScope.asInstanceOf[js.Any])
