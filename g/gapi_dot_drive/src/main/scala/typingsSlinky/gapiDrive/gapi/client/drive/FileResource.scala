...
object FileResource {
  ...
  implicit class FileResourceMutableBuilder[Self <: FileResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastViewedByMeDate(value: js.Date): Self = StObject.set(x, "lastViewedByMeDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarkedViewedByMeDate(value: js.Date): Self = StObject.set(x, "markedViewedByMeDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModifiedByMeDate(value: js.Date): Self = StObject.set(x, "modifiedByMeDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSharedWithMeDate(value: js.Date): Self = StObject.set(x, "sharedWithMeDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrashedDate(value: js.Date): Self = StObject.set(x, "trashedDate", value.asInstanceOf[js.Any])
