...
object FileResource {
  ...
  implicit class FileResourceOps[Self <: FileResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastViewedByMeDate(value: js.Date): Self = this.set("lastViewedByMeDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarkedViewedByMeDate(value: js.Date): Self = this.set("markedViewedByMeDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModifiedByMeDate(value: js.Date): Self = this.set("modifiedByMeDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSharedWithMeDate(value: js.Date): Self = this.set("sharedWithMeDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrashedDate(value: js.Date): Self = this.set("trashedDate", value.asInstanceOf[js.Any])
