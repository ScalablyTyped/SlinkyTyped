...
object latlonEllipsoidalDatumMod {
  ...
  object default {
    ...
    @JSImport("geodesy/latlon-ellipsoidal-datum", "default.parse")
    @js.native
  ...
  object Dms {
    ...
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.compassPoint")
    @js.native
    ...
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.fromLocale")
    @js.native
    def fromLocale(str: String): String = js.native
    
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.parse")
    @js.native
    ...
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.toBrng")
    @js.native
    ...
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.toDms")
    @js.native
    ...
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.toLat")
    @js.native
    ...
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.toLocale")
    @js.native
    def toLocale(str: String): String = js.native
    
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.toLon")
    @js.native
    ...
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.wrap360")
    @js.native
    def wrap360(degrees: Double): String = js.native
    
    /* static member */
    @JSImport("geodesy/latlon-ellipsoidal-datum", "Dms.wrap90")
    @js.native
