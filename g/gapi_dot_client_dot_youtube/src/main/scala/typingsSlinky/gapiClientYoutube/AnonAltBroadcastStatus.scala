...
object AnonAltBroadcastStatus {
  @scala.inline
  def apply(broadcastStatus: String, id: String, part: String): AnonAltBroadcastStatus = {
    ...
    __obj.asInstanceOf[AnonAltBroadcastStatus]
  }
  @scala.inline
  implicit class AnonAltBroadcastStatusOps[Self <: AnonAltBroadcastStatus] (val x: Self) extends AnyVal {
    @scala.inline
