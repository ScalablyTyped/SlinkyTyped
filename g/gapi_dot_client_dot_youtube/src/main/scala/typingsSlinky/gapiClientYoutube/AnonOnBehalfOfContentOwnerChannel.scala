...
object AnonOnBehalfOfContentOwnerChannel {
  @scala.inline
  def apply(part: String): AnonOnBehalfOfContentOwnerChannel = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOnBehalfOfContentOwnerChannel]
  }
  @scala.inline
  implicit class AnonOnBehalfOfContentOwnerChannelOps[Self <: AnonOnBehalfOfContentOwnerChannel] (val x: Self) extends AnyVal {
    @scala.inline
