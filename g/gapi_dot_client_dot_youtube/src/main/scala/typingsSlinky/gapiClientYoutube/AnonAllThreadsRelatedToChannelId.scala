...
@js.native
trait AnonAllThreadsRelatedToChannelId extends js.Object {
  /**
...
object AnonAllThreadsRelatedToChannelId {
  @scala.inline
  def apply(part: String): AnonAllThreadsRelatedToChannelId = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAllThreadsRelatedToChannelId]
  }
  @scala.inline
  implicit class AnonAllThreadsRelatedToChannelIdOps[Self <: AnonAllThreadsRelatedToChannelId] (val x: Self) extends AnyVal {
    @scala.inline
