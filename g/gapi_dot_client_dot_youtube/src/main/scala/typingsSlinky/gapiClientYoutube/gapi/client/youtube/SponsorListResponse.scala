...
object SponsorListResponse {
  ...
  @scala.inline
  implicit class SponsorListResponseOps[Self <: SponsorListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Sponsor*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Sponsor]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
