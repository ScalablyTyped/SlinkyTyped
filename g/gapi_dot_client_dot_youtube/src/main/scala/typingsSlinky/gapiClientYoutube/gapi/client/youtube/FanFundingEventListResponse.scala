...
trait FanFundingEventListResponse extends js.Object {
  ...
  var items: js.UndefOr[js.Array[FanFundingEvent]] = js.native
...
object FanFundingEventListResponse {
  @scala.inline
  def apply(): FanFundingEventListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FanFundingEventListResponse]
  }
  @scala.inline
  implicit class FanFundingEventListResponseOps[Self <: FanFundingEventListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: FanFundingEvent*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[FanFundingEvent]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
