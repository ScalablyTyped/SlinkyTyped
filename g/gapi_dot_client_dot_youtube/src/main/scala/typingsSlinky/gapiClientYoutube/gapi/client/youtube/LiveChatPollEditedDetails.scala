...
object LiveChatPollEditedDetails {
  ...
  @scala.inline
  implicit class LiveChatPollEditedDetailsOps[Self <: LiveChatPollEditedDetails] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[LiveChatPollItem]): Self = {
        val ret = this.duplicate
