...
@js.native
trait BroadcastStatus extends js.Object {
...
object BroadcastStatus {
  @scala.inline
  def apply(part: String): BroadcastStatus = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[BroadcastStatus]
  }
  @scala.inline
  implicit class BroadcastStatusOps[Self <: BroadcastStatus] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withBroadcastStatus(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("broadcastStatus")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBroadcastStatus: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("broadcastStatus")(js.undefined)
        ret
    }
    @scala.inline
    def withBroadcastType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("broadcastType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBroadcastType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("broadcastType")(js.undefined)
        ret
    }
    @scala.inline
