...
object AnonId {
  ...
  implicit class AnonIdOps[Self <: AnonId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTfmt(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tfmt")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTfmt: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tfmt")(js.undefined)
        ret
    }
    @scala.inline
    def withTlang(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tlang")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTlang: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tlang")(js.undefined)
        ret
    }
    @scala.inline
