...
@js.native
trait AnonBanAuthor extends js.Object {
...
object AnonBanAuthor {
  @scala.inline
  def apply(id: String, moderationStatus: String): AnonBanAuthor = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], moderationStatus = moderationStatus.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBanAuthor]
  }
  @scala.inline
  implicit class AnonBanAuthorOps[Self <: AnonBanAuthor] (val x: Self) extends AnyVal {
    @scala.inline
