...
trait Anon_AltFieldsIdKeyOauthtoken extends js.Object {
...
object Anon_AltFieldsIdKeyOauthtoken {
  @scala.inline
  def apply(
    id: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AltFieldsIdKeyOauthtoken]
  }
}
