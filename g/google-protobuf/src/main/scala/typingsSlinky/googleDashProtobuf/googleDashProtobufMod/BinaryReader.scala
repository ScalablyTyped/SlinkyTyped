package typingsSlinky.googleDashProtobuf.googleDashProtobufMod

import typingsSlinky.googleDashProtobuf.googleDashProtobufMod.BinaryConstants.FieldType
import typingsSlinky.googleDashProtobuf.googleDashProtobufMod.BinaryConstants.WireType
