...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.OneofDescriptorProto = js.native
  def deserializeBinaryFromReader(
    message: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.OneofDescriptorProto,
    reader: BinaryReader
  ): typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.OneofDescriptorProto = js.native
  ...
  def toObject(
    ...
    msg: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.OneofDescriptorProto
  ): AsObject = js.native
}
