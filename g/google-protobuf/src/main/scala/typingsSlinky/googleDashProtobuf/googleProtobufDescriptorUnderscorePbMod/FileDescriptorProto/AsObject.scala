package typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FileDescriptorProto
...
trait AsObject extends js.Object {
  ...
  var messageTypeList: js.Array[
    typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.DescriptorProto.AsObject
  ]
  var name: js.UndefOr[String] = js.undefined
  var options: js.UndefOr[
    typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FileOptions.AsObject
  ] = js.undefined
  var pb_package: js.UndefOr[String] = js.undefined
  var publicDependencyList: js.Array[Double]
  var serviceList: js.Array[
    typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.ServiceDescriptorProto.AsObject
  ]
  var sourceCodeInfo: js.UndefOr[
    typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.SourceCodeInfo.AsObject
  ] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    name: String = null,
    options: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FileOptions.AsObject = null,
    pb_package: String = null,
    sourceCodeInfo: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.SourceCodeInfo.AsObject = null,
    syntax: String = null
  ): AsObject = {
