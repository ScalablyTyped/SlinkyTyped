...
import typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldDescriptorProto.Label
import typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldDescriptorProto.Type
