...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FileOptions = js.native
  def deserializeBinaryFromReader(
    message: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FileOptions,
    reader: BinaryReader
  ): typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FileOptions = js.native
  ...
  def toObject(
    ...
    msg: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FileOptions
  ): AsObject = js.native
}
