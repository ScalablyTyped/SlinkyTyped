...
trait AsObject extends js.Object {
  ...
  var options: js.UndefOr[
    typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldOptions.AsObject
  ] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    options: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldOptions.AsObject = null,
    `type`: Type = null,
