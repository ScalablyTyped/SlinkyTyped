...
import typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldOptions.CType
import typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldOptions.JSType
