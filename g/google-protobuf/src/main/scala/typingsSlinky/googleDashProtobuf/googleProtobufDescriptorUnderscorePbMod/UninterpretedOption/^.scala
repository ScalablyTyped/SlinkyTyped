...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.UninterpretedOption = js.native
  def deserializeBinaryFromReader(
    message: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.UninterpretedOption,
    reader: BinaryReader
  ): typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.UninterpretedOption = js.native
  ...
  def toObject(
    ...
    msg: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.UninterpretedOption
  ): AsObject = js.native
}
