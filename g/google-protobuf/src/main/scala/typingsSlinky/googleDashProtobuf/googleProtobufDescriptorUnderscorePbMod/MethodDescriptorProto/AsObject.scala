...
trait AsObject extends js.Object {
  ...
  var options: js.UndefOr[
    typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.MethodOptions.AsObject
  ] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    name: String = null,
    options: typingsSlinky.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.MethodOptions.AsObject = null,
