...
import typingsSlinky.googleDashProtobuf.googleDashProtobufMod.FieldValue
import typingsSlinky.googleDashProtobuf.googleDashProtobufMod.Map
...
@js.native
trait TypeofClassMessageAddToRepeatedField extends Instantiable0[Message] {
