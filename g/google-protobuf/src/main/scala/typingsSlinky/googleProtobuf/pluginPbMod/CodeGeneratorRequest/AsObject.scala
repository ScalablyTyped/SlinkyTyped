...
trait AsObject extends js.Object {
  var compilerVersion: js.UndefOr[typingsSlinky.googleProtobuf.pluginPbMod.Version.AsObject] = js.undefined
  var fileToGenerateList: js.Array[String]
  var parameter: js.UndefOr[String] = js.undefined
  var protoFileList: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject]
}
...
object AsObject {
  ...
  def apply(
    ...
    compilerVersion: typingsSlinky.googleProtobuf.pluginPbMod.Version.AsObject = null,
