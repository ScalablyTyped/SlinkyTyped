...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProtoFileListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject*): Self = this.set("protoFileList", js.Array(value :_*))
    @scala.inline
    def setProtoFileList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject]): Self = this.set("protoFileList", value.asInstanceOf[js.Any])
    @scala.inline
    def setCompilerVersion(value: typingsSlinky.googleProtobuf.pluginPbMod.Version.AsObject): Self = this.set("compilerVersion", value.asInstanceOf[js.Any])
    @scala.inline
