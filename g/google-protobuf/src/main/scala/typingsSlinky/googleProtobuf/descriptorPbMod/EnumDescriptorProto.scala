...
object EnumDescriptorProto {
  ...
  object EnumReservedRange {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): EnumReservedRange = js.native
    ...
    @js.native
    def toObject(includeInstance: Boolean, msg: EnumReservedRange): typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject = js.native
    ...
    object AsObject {
      ...
      @scala.inline
      def apply(): typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject]
      }
      
      @scala.inline
      implicit class AsObjectMutableBuilder[Self <: typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject] (val x: Self) extends AnyVal {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): EnumDescriptorProto = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.EnumOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setReservedRangeListVarargs(
        value: typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject*
      ): Self = StObject.set(x, "reservedRangeList", js.Array(value :_*))
      
      @scala.inline
      def setValueList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.EnumValueDescriptorProto.AsObject]): Self = StObject.set(x, "valueList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValueListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.EnumValueDescriptorProto.AsObject*): Self = StObject.set(x, "valueList", js.Array(value :_*))
    }
  }
}
