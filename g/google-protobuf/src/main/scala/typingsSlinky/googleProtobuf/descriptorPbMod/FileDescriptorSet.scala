...
object FileDescriptorSet {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): FileDescriptorSet = js.native
  ...
  trait AsObject extends StObject {
    ...
    var fileList: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject] = js.native
  }
  object AsObject {
    
    @scala.inline
    def apply(fileList: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject]): AsObject = {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFileList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject]): Self = StObject.set(x, "fileList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFileListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject*): Self = StObject.set(x, "fileList", js.Array(value :_*))
    }
  }
}
