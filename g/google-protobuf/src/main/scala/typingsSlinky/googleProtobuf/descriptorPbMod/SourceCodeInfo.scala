...
import typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location
...
object SourceCodeInfo {
  ...
  object Location {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Location = js.native
    ...
    @js.native
    def toObject(includeInstance: Boolean, msg: Location): typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location.AsObject = js.native
    ...
    object AsObject {
      ...
      def apply(
      ...
      ): typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location.AsObject = {
        ...
        __obj.asInstanceOf[typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location.AsObject]
      }
      
      @scala.inline
      implicit class AsObjectMutableBuilder[Self <: typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location.AsObject] (val x: Self) extends AnyVal {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): SourceCodeInfo = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocationList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location.AsObject]): Self = StObject.set(x, "locationList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLocationListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location.AsObject*): Self = StObject.set(x, "locationList", js.Array(value :_*))
    }
  }
}
