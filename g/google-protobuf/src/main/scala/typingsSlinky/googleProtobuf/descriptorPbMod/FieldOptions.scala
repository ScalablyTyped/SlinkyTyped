...
object FieldOptions {
  ...
  object CType extends StObject {
    ...
    /* 1 */ val CORD: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.CType.CORD with Double = js.native
    
    @js.native
    sealed trait STRING extends CType
    /* 0 */ val STRING: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.CType.STRING with Double = js.native
    
    @js.native
    sealed trait STRING_PIECE extends CType
    /* 2 */ val STRING_PIECE: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.CType.STRING_PIECE with Double = js.native
  }
  ...
  object JSType extends StObject {
    ...
    /* 0 */ val JS_NORMAL: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.JSType.JS_NORMAL with Double = js.native
    
    @js.native
    sealed trait JS_NUMBER extends JSType
    /* 2 */ val JS_NUMBER: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.JSType.JS_NUMBER with Double = js.native
    
    @js.native
    sealed trait JS_STRING extends JSType
    /* 1 */ val JS_STRING: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.JSType.JS_STRING with Double = js.native
  }
  
  @JSImport("google-protobuf/google/protobuf/descriptor_pb", "FieldOptions.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): FieldOptions = js.native
