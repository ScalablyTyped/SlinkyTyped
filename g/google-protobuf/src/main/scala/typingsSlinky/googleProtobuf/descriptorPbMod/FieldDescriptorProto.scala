...
import typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Label
import typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type
...
object FieldDescriptorProto {
  ...
  object Label extends StObject {
    ...
    /* 1 */ val LABEL_OPTIONAL: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Label.LABEL_OPTIONAL with Double = js.native
    
    @js.native
    sealed trait LABEL_REPEATED extends Label
    /* 3 */ val LABEL_REPEATED: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Label.LABEL_REPEATED with Double = js.native
    
    @js.native
    sealed trait LABEL_REQUIRED extends Label
    /* 2 */ val LABEL_REQUIRED: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Label.LABEL_REQUIRED with Double = js.native
  }
  ...
  object Type extends StObject {
    ...
    /* 8 */ val TYPE_BOOL: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_BOOL with Double = js.native
    
    @js.native
    sealed trait TYPE_BYTES extends Type
    /* 12 */ val TYPE_BYTES: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_BYTES with Double = js.native
    
    @js.native
    sealed trait TYPE_DOUBLE extends Type
    /* 1 */ val TYPE_DOUBLE: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_DOUBLE with Double = js.native
    
    @js.native
    sealed trait TYPE_ENUM extends Type
    /* 14 */ val TYPE_ENUM: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_ENUM with Double = js.native
    
    @js.native
    sealed trait TYPE_FIXED32 extends Type
    /* 7 */ val TYPE_FIXED32: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_FIXED32 with Double = js.native
    
    @js.native
    sealed trait TYPE_FIXED64 extends Type
    /* 6 */ val TYPE_FIXED64: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_FIXED64 with Double = js.native
    
    @js.native
    sealed trait TYPE_FLOAT extends Type
    /* 2 */ val TYPE_FLOAT: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_FLOAT with Double = js.native
    
    @js.native
    sealed trait TYPE_GROUP extends Type
    /* 10 */ val TYPE_GROUP: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_GROUP with Double = js.native
    
    @js.native
    sealed trait TYPE_INT32 extends Type
    /* 5 */ val TYPE_INT32: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_INT32 with Double = js.native
    
    @js.native
    sealed trait TYPE_INT64 extends Type
    /* 3 */ val TYPE_INT64: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_INT64 with Double = js.native
    
    @js.native
    sealed trait TYPE_MESSAGE extends Type
    /* 11 */ val TYPE_MESSAGE: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_MESSAGE with Double = js.native
    
    @js.native
    sealed trait TYPE_SFIXED32 extends Type
    /* 15 */ val TYPE_SFIXED32: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_SFIXED32 with Double = js.native
    
    @js.native
    sealed trait TYPE_SFIXED64 extends Type
    /* 16 */ val TYPE_SFIXED64: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_SFIXED64 with Double = js.native
    
    @js.native
    sealed trait TYPE_SINT32 extends Type
    /* 17 */ val TYPE_SINT32: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_SINT32 with Double = js.native
    
    @js.native
    sealed trait TYPE_SINT64 extends Type
    /* 18 */ val TYPE_SINT64: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_SINT64 with Double = js.native
    
    @js.native
    sealed trait TYPE_STRING extends Type
    /* 9 */ val TYPE_STRING: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_STRING with Double = js.native
    
    @js.native
    sealed trait TYPE_UINT32 extends Type
    /* 13 */ val TYPE_UINT32: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_UINT32 with Double = js.native
    
    @js.native
    sealed trait TYPE_UINT64 extends Type
    /* 4 */ val TYPE_UINT64: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type.TYPE_UINT64 with Double = js.native
  }
  
  @JSImport("google-protobuf/google/protobuf/descriptor_pb", "FieldDescriptorProto.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): FieldDescriptorProto = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
