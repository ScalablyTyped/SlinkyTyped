...
object GeneratedCodeInfo {
  ...
  object Annotation {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Annotation = js.native
    ...
    @js.native
    def toObject(includeInstance: Boolean, msg: Annotation): typingsSlinky.googleProtobuf.descriptorPbMod.GeneratedCodeInfo.Annotation.AsObject = js.native
    ...
    object AsObject {
      ...
      @scala.inline
      def apply(pathList: js.Array[Double]): typingsSlinky.googleProtobuf.descriptorPbMod.GeneratedCodeInfo.Annotation.AsObject = {
        val __obj = js.Dynamic.literal(pathList = pathList.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.googleProtobuf.descriptorPbMod.GeneratedCodeInfo.Annotation.AsObject]
      }
      
      @scala.inline
      implicit class AsObjectMutableBuilder[Self <: typingsSlinky.googleProtobuf.descriptorPbMod.GeneratedCodeInfo.Annotation.AsObject] (val x: Self) extends AnyVal {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): GeneratedCodeInfo = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAnnotationListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.GeneratedCodeInfo.Annotation.AsObject*): Self = StObject.set(x, "annotationList", js.Array(value :_*))
    }
  }
}
