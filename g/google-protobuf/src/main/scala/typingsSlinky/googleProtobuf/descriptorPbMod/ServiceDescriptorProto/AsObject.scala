...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMethodListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.MethodDescriptorProto.AsObject*): Self = this.set("methodList", js.Array(value :_*))
    @scala.inline
    def setMethodList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.MethodDescriptorProto.AsObject]): Self = this.set("methodList", value.asInstanceOf[js.Any])
    @scala.inline
    def setName(value: String): Self = this.set("name", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteName: Self = this.set("name", js.undefined)
    @scala.inline
    def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.ServiceOptions.AsObject): Self = this.set("options", value.asInstanceOf[js.Any])
    @scala.inline
