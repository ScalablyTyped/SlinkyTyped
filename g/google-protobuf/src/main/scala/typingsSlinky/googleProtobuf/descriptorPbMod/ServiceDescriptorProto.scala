...
object ServiceDescriptorProto {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): ServiceDescriptorProto = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMethodList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.MethodDescriptorProto.AsObject]): Self = StObject.set(x, "methodList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMethodListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.MethodDescriptorProto.AsObject*): Self = StObject.set(x, "methodList", js.Array(value :_*))
      ...
      @scala.inline
      def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.ServiceOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
