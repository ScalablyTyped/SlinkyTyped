...
object EnumValueDescriptorProto {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): EnumValueDescriptorProto = js.native
  ...
  trait AsObject extends StObject {
    ...
    var options: js.UndefOr[typingsSlinky.googleProtobuf.descriptorPbMod.EnumValueOptions.AsObject] = js.native
  }
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.EnumValueOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
