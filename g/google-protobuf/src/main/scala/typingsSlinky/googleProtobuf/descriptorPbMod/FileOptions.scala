...
import typingsSlinky.googleProtobuf.descriptorPbMod.FileOptions.OptimizeMode
...
object FileOptions {
  ...
  object OptimizeMode extends StObject {
    ...
    /* 2 */ val CODE_SIZE: typingsSlinky.googleProtobuf.descriptorPbMod.FileOptions.OptimizeMode.CODE_SIZE with Double = js.native
    
    @js.native
    sealed trait LITE_RUNTIME extends OptimizeMode
    /* 3 */ val LITE_RUNTIME: typingsSlinky.googleProtobuf.descriptorPbMod.FileOptions.OptimizeMode.LITE_RUNTIME with Double = js.native
    
    @js.native
    sealed trait SPEED extends OptimizeMode
    /* 1 */ val SPEED: typingsSlinky.googleProtobuf.descriptorPbMod.FileOptions.OptimizeMode.SPEED with Double = js.native
  }
  
  @JSImport("google-protobuf/google/protobuf/descriptor_pb", "FileOptions.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): FileOptions = js.native
