...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNameListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.UninterpretedOption.NamePart.AsObject*): Self = this.set("nameList", js.Array(value :_*))
    @scala.inline
    def setNameList(
      value: js.Array[
          typingsSlinky.googleProtobuf.descriptorPbMod.UninterpretedOption.NamePart.AsObject
        ]
    ): Self = this.set("nameList", value.asInstanceOf[js.Any])
    @scala.inline
    def setStringValueUint8Array(value: js.typedarray.Uint8Array): Self = this.set("stringValue", value.asInstanceOf[js.Any])
    @scala.inline
    def setStringValue(value: js.typedarray.Uint8Array | String): Self = this.set("stringValue", value.asInstanceOf[js.Any])
    @scala.inline
