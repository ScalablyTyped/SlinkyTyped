...
object MethodOptions {
  ...
  object IdempotencyLevel extends StObject {
    ...
    /* 0 */ val IDEMPOTENCY_UNKNOWN: typingsSlinky.googleProtobuf.descriptorPbMod.MethodOptions.IdempotencyLevel.IDEMPOTENCY_UNKNOWN with Double = js.native
    
    @js.native
    sealed trait IDEMPOTENT extends IdempotencyLevel
    /* 2 */ val IDEMPOTENT: typingsSlinky.googleProtobuf.descriptorPbMod.MethodOptions.IdempotencyLevel.IDEMPOTENT with Double = js.native
    
    @js.native
    sealed trait NO_SIDE_EFFECTS extends IdempotencyLevel
    /* 1 */ val NO_SIDE_EFFECTS: typingsSlinky.googleProtobuf.descriptorPbMod.MethodOptions.IdempotencyLevel.NO_SIDE_EFFECTS with Double = js.native
  }
  
  @JSImport("google-protobuf/google/protobuf/descriptor_pb", "MethodOptions.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): MethodOptions = js.native
