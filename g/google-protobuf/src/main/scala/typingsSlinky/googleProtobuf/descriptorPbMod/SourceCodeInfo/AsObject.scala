...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLocationList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.Location.AsObject]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("locationList")(value.asInstanceOf[js.Any])
        ret
    }
  }
