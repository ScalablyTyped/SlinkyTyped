...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnumTypeListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.AsObject*): Self = this.set("enumTypeList", js.Array(value :_*))
    @scala.inline
    def setEnumTypeList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.AsObject]): Self = this.set("enumTypeList", value.asInstanceOf[js.Any])
    @scala.inline
    def setExtensionListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.AsObject*): Self = this.set("extensionList", js.Array(value :_*))
    @scala.inline
    def setExtensionList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.AsObject]): Self = this.set("extensionList", value.asInstanceOf[js.Any])
    @scala.inline
    def setExtensionRangeListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.ExtensionRange.AsObject*): Self = this.set("extensionRangeList", js.Array(value :_*))
    @scala.inline
    def setExtensionRangeList(
      value: js.Array[
          typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.ExtensionRange.AsObject
        ]
    ): Self = this.set("extensionRangeList", value.asInstanceOf[js.Any])
    @scala.inline
    def setFieldListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.AsObject*): Self = this.set("fieldList", js.Array(value :_*))
    @scala.inline
    def setFieldList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.AsObject]): Self = this.set("fieldList", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOneofDeclListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.OneofDescriptorProto.AsObject*): Self = this.set("oneofDeclList", js.Array(value :_*))
    @scala.inline
    def setOneofDeclList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.OneofDescriptorProto.AsObject]): Self = this.set("oneofDeclList", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setReservedRangeListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.ReservedRange.AsObject*): Self = this.set("reservedRangeList", js.Array(value :_*))
    @scala.inline
    ...
    @scala.inline
    def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.MessageOptions.AsObject): Self = this.set("options", value.asInstanceOf[js.Any])
    @scala.inline
