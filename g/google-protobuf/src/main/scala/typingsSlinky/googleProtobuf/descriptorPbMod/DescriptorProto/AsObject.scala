...
trait AsObject extends js.Object {
  var enumTypeList: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.EnumDescriptorProto.AsObject]
  var extensionList: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.AsObject]
  var extensionRangeList: js.Array[
    typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.ExtensionRange.AsObject
  ]
  var fieldList: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FieldDescriptorProto.AsObject]
  var name: js.UndefOr[String] = js.undefined
  var nestedTypeList: js.Array[AsObject]
  var oneofDeclList: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.OneofDescriptorProto.AsObject]
  var options: js.UndefOr[typingsSlinky.googleProtobuf.descriptorPbMod.MessageOptions.AsObject] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    name: String = null,
    options: typingsSlinky.googleProtobuf.descriptorPbMod.MessageOptions.AsObject = null
  ): AsObject = {
