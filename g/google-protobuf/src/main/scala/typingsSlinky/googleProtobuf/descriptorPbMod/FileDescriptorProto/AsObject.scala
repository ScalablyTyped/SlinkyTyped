...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessageTypeListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.AsObject*): Self = this.set("messageTypeList", js.Array(value :_*))
    
    @scala.inline
    def setMessageTypeList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.AsObject]): Self = this.set("messageTypeList", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setServiceListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.ServiceDescriptorProto.AsObject*): Self = this.set("serviceList", js.Array(value :_*))
    
    @scala.inline
    def setServiceList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.ServiceDescriptorProto.AsObject]): Self = this.set("serviceList", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.FileOptions.AsObject): Self = this.set("options", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceCodeInfo(value: typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.AsObject): Self = this.set("sourceCodeInfo", value.asInstanceOf[js.Any])
