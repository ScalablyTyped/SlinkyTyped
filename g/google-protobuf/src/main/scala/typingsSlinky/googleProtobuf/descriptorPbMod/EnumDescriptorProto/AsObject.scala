...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("reservedRangeList", js.Array(value :_*))
    @scala.inline
    ...
    @scala.inline
    def setValueListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.EnumValueDescriptorProto.AsObject*): Self = this.set("valueList", js.Array(value :_*))
    @scala.inline
    def setValueList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.EnumValueDescriptorProto.AsObject]): Self = this.set("valueList", value.asInstanceOf[js.Any])
    @scala.inline
    def setName(value: String): Self = this.set("name", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteName: Self = this.set("name", js.undefined)
    @scala.inline
    def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.EnumOptions.AsObject): Self = this.set("options", value.asInstanceOf[js.Any])
    @scala.inline
