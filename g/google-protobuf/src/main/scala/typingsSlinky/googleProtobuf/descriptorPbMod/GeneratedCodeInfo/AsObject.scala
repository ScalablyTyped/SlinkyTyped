...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnotationListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.GeneratedCodeInfo.Annotation.AsObject*): Self = this.set("annotationList", js.Array(value :_*))
    @scala.inline
    def setAnnotationList(
      value: js.Array[
          typingsSlinky.googleProtobuf.descriptorPbMod.GeneratedCodeInfo.Annotation.AsObject
        ]
    ): Self = this.set("annotationList", value.asInstanceOf[js.Any])
  }
