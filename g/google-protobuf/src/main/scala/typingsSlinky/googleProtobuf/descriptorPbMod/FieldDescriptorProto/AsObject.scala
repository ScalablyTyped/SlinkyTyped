...
trait AsObject extends js.Object {
  ...
  var options: js.UndefOr[typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.AsObject] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    options: typingsSlinky.googleProtobuf.descriptorPbMod.FieldOptions.AsObject = null,
    `type`: Type = null,
