...
object FileDescriptorProto {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): FileDescriptorProto = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMessageTypeList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.AsObject]): Self = StObject.set(x, "messageTypeList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMessageTypeListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.DescriptorProto.AsObject*): Self = StObject.set(x, "messageTypeList", js.Array(value :_*))
      ...
      @scala.inline
      def setOptions(value: typingsSlinky.googleProtobuf.descriptorPbMod.FileOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setServiceList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.ServiceDescriptorProto.AsObject]): Self = StObject.set(x, "serviceList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setServiceListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.ServiceDescriptorProto.AsObject*): Self = StObject.set(x, "serviceList", js.Array(value :_*))
      
      @scala.inline
      def setSourceCodeInfo(value: typingsSlinky.googleProtobuf.descriptorPbMod.SourceCodeInfo.AsObject): Self = StObject.set(x, "sourceCodeInfo", value.asInstanceOf[js.Any])
