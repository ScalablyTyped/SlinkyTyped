...
object UninterpretedOption {
  ...
  object NamePart {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): NamePart = js.native
    ...
    @js.native
    def toObject(includeInstance: Boolean, msg: NamePart): typingsSlinky.googleProtobuf.descriptorPbMod.UninterpretedOption.NamePart.AsObject = js.native
    ...
    object AsObject {
      ...
      @scala.inline
      def apply(): typingsSlinky.googleProtobuf.descriptorPbMod.UninterpretedOption.NamePart.AsObject = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.googleProtobuf.descriptorPbMod.UninterpretedOption.NamePart.AsObject]
      }
      
      @scala.inline
      implicit class AsObjectMutableBuilder[Self <: typingsSlinky.googleProtobuf.descriptorPbMod.UninterpretedOption.NamePart.AsObject] (val x: Self) extends AnyVal {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): UninterpretedOption = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNameListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.UninterpretedOption.NamePart.AsObject*): Self = StObject.set(x, "nameList", js.Array(value :_*))
