...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldsMapVarargs(value: (js.Tuple2[String, typingsSlinky.googleProtobuf.structPbMod.Value.AsObject])*): Self = this.set("fieldsMap", js.Array(value :_*))
    @scala.inline
    def setFieldsMap(value: js.Array[js.Tuple2[String, typingsSlinky.googleProtobuf.structPbMod.Value.AsObject]]): Self = this.set("fieldsMap", value.asInstanceOf[js.Any])
  }
