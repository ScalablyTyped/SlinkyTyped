...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setListValue(value: typingsSlinky.googleProtobuf.structPbMod.ListValue.AsObject): Self = this.set("listValue", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteListValue: Self = this.set("listValue", js.undefined)
    @scala.inline
    def setStructValue(value: typingsSlinky.googleProtobuf.structPbMod.Struct.AsObject): Self = this.set("structValue", value.asInstanceOf[js.Any])
    @scala.inline
