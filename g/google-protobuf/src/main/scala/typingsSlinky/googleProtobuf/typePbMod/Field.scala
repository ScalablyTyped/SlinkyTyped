...
object Field {
  ...
  object Cardinality extends StObject {
    ...
    /* 1 */ val CARDINALITY_OPTIONAL: typingsSlinky.googleProtobuf.typePbMod.Field.Cardinality.CARDINALITY_OPTIONAL with Double = js.native
    
    @js.native
    sealed trait CARDINALITY_REPEATED extends Cardinality
    /* 3 */ val CARDINALITY_REPEATED: typingsSlinky.googleProtobuf.typePbMod.Field.Cardinality.CARDINALITY_REPEATED with Double = js.native
    
    @js.native
    sealed trait CARDINALITY_REQUIRED extends Cardinality
    /* 2 */ val CARDINALITY_REQUIRED: typingsSlinky.googleProtobuf.typePbMod.Field.Cardinality.CARDINALITY_REQUIRED with Double = js.native
    
    @js.native
    sealed trait CARDINALITY_UNKNOWN extends Cardinality
    /* 0 */ val CARDINALITY_UNKNOWN: typingsSlinky.googleProtobuf.typePbMod.Field.Cardinality.CARDINALITY_UNKNOWN with Double = js.native
  }
  ...
  object Kind extends StObject {
    ...
    /* 8 */ val TYPE_BOOL: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_BOOL with Double = js.native
    
    @js.native
    sealed trait TYPE_BYTES extends Kind
    /* 12 */ val TYPE_BYTES: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_BYTES with Double = js.native
    
    @js.native
    sealed trait TYPE_DOUBLE extends Kind
    /* 1 */ val TYPE_DOUBLE: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_DOUBLE with Double = js.native
    
    @js.native
    sealed trait TYPE_ENUM extends Kind
    /* 14 */ val TYPE_ENUM: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_ENUM with Double = js.native
    
    @js.native
    sealed trait TYPE_FIXED32 extends Kind
    /* 7 */ val TYPE_FIXED32: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_FIXED32 with Double = js.native
    
    @js.native
    sealed trait TYPE_FIXED64 extends Kind
    /* 6 */ val TYPE_FIXED64: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_FIXED64 with Double = js.native
    
    @js.native
    sealed trait TYPE_FLOAT extends Kind
    /* 2 */ val TYPE_FLOAT: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_FLOAT with Double = js.native
    
    @js.native
    sealed trait TYPE_GROUP extends Kind
    /* 10 */ val TYPE_GROUP: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_GROUP with Double = js.native
    
    @js.native
    sealed trait TYPE_INT32 extends Kind
    /* 5 */ val TYPE_INT32: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_INT32 with Double = js.native
    
    @js.native
    sealed trait TYPE_INT64 extends Kind
    /* 3 */ val TYPE_INT64: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_INT64 with Double = js.native
    
    @js.native
    sealed trait TYPE_MESSAGE extends Kind
    /* 11 */ val TYPE_MESSAGE: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_MESSAGE with Double = js.native
    
    @js.native
    sealed trait TYPE_SFIXED32 extends Kind
    /* 15 */ val TYPE_SFIXED32: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_SFIXED32 with Double = js.native
    
    @js.native
    sealed trait TYPE_SFIXED64 extends Kind
    /* 16 */ val TYPE_SFIXED64: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_SFIXED64 with Double = js.native
    
    @js.native
    sealed trait TYPE_SINT32 extends Kind
    /* 17 */ val TYPE_SINT32: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_SINT32 with Double = js.native
    
    @js.native
    sealed trait TYPE_SINT64 extends Kind
    /* 18 */ val TYPE_SINT64: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_SINT64 with Double = js.native
    
    @js.native
    sealed trait TYPE_STRING extends Kind
    /* 9 */ val TYPE_STRING: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_STRING with Double = js.native
    
    @js.native
    sealed trait TYPE_UINT32 extends Kind
    /* 13 */ val TYPE_UINT32: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_UINT32 with Double = js.native
    
    @js.native
    sealed trait TYPE_UINT64 extends Kind
    /* 4 */ val TYPE_UINT64: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_UINT64 with Double = js.native
    
    @js.native
    sealed trait TYPE_UNKNOWN extends Kind
    /* 0 */ val TYPE_UNKNOWN: typingsSlinky.googleProtobuf.typePbMod.Field.Kind.TYPE_UNKNOWN with Double = js.native
  }
  
  @JSImport("google-protobuf/google/protobuf/type_pb", "Field.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): Field = js.native
