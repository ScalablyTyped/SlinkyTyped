...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldsListVarargs(value: typingsSlinky.googleProtobuf.typePbMod.Field.AsObject*): Self = this.set("fieldsList", js.Array(value :_*))
    
    @scala.inline
    def setFieldsList(value: js.Array[typingsSlinky.googleProtobuf.typePbMod.Field.AsObject]): Self = this.set("fieldsList", value.asInstanceOf[js.Any])
