...
object Syntax extends StObject {
  ...
  /* 0 */ val SYNTAX_PROTO2: typingsSlinky.googleProtobuf.typePbMod.Syntax.SYNTAX_PROTO2 with Double = js.native
  
  @js.native
  sealed trait SYNTAX_PROTO3 extends Syntax
  /* 1 */ val SYNTAX_PROTO3: typingsSlinky.googleProtobuf.typePbMod.Syntax.SYNTAX_PROTO3 with Double = js.native
}
