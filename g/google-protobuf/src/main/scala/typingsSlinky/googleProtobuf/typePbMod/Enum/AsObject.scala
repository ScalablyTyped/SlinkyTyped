...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnumvalueListVarargs(value: typingsSlinky.googleProtobuf.typePbMod.EnumValue.AsObject*): Self = this.set("enumvalueList", js.Array(value :_*))
    
    @scala.inline
    def setEnumvalueList(value: js.Array[typingsSlinky.googleProtobuf.typePbMod.EnumValue.AsObject]): Self = this.set("enumvalueList", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceContext(value: typingsSlinky.googleProtobuf.sourceContextPbMod.SourceContext.AsObject): Self = this.set("sourceContext", value.asInstanceOf[js.Any])
