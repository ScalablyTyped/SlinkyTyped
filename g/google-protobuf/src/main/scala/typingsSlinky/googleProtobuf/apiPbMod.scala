...
object apiPbMod {
  ...
  object Api {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Api = js.native
    ...
    object AsObject {
      ...
      implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setMethodsList(value: js.Array[typingsSlinky.googleProtobuf.apiPbMod.Method.AsObject]): Self = StObject.set(x, "methodsList", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setMethodsListVarargs(value: typingsSlinky.googleProtobuf.apiPbMod.Method.AsObject*): Self = StObject.set(x, "methodsList", js.Array(value :_*))
        
        @scala.inline
        def setMixinsList(value: js.Array[typingsSlinky.googleProtobuf.apiPbMod.Mixin.AsObject]): Self = StObject.set(x, "mixinsList", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setMixinsListVarargs(value: typingsSlinky.googleProtobuf.apiPbMod.Mixin.AsObject*): Self = StObject.set(x, "mixinsList", js.Array(value :_*))
  ...
  object Method {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Method = js.native
  ...
  object Mixin {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Mixin = js.native
