...
import typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto
...
object pluginPbMod {
  ...
  object CodeGeneratorRequest {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): CodeGeneratorRequest = js.native
    ...
    object AsObject {
      ...
      implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCompilerVersion(value: typingsSlinky.googleProtobuf.pluginPbMod.Version.AsObject): Self = StObject.set(x, "compilerVersion", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setProtoFileList(value: js.Array[typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject]): Self = StObject.set(x, "protoFileList", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setProtoFileListVarargs(value: typingsSlinky.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject*): Self = StObject.set(x, "protoFileList", js.Array(value :_*))
      }
    }
  }
  ...
  object CodeGeneratorResponse {
    ...
    object File {
      ...
      @js.native
      def deserializeBinary(bytes: js.typedarray.Uint8Array): File = js.native
      ...
      @js.native
      def toObject(includeInstance: Boolean, msg: File): typingsSlinky.googleProtobuf.pluginPbMod.CodeGeneratorResponse.File.AsObject = js.native
      ...
      object AsObject {
        ...
        @scala.inline
        def apply(): typingsSlinky.googleProtobuf.pluginPbMod.CodeGeneratorResponse.File.AsObject = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsSlinky.googleProtobuf.pluginPbMod.CodeGeneratorResponse.File.AsObject]
        }
        
        @scala.inline
        implicit class AsObjectMutableBuilder[Self <: typingsSlinky.googleProtobuf.pluginPbMod.CodeGeneratorResponse.File.AsObject] (val x: Self) extends AnyVal {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): CodeGeneratorResponse = js.native
    ...
    object AsObject {
      ...
      implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setFileList(value: js.Array[typingsSlinky.googleProtobuf.pluginPbMod.CodeGeneratorResponse.File.AsObject]): Self = StObject.set(x, "fileList", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setFileListVarargs(value: typingsSlinky.googleProtobuf.pluginPbMod.CodeGeneratorResponse.File.AsObject*): Self = StObject.set(x, "fileList", js.Array(value :_*))
      }
    }
  }
  ...
  object Version {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Version = js.native
