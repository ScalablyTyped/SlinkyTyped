...
object structPbMod {
  ...
  object ListValue {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): ListValue = js.native
    ...
    object AsObject {
      ...
      implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setValuesList(value: js.Array[typingsSlinky.googleProtobuf.structPbMod.Value.AsObject]): Self = StObject.set(x, "valuesList", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setValuesListVarargs(value: typingsSlinky.googleProtobuf.structPbMod.Value.AsObject*): Self = StObject.set(x, "valuesList", js.Array(value :_*))
      }
    }
  }
  ...
  object NullValue extends StObject {
    ...
    /* 0 */ val NULL_VALUE: typingsSlinky.googleProtobuf.structPbMod.NullValue.NULL_VALUE with Double = js.native
  }
  ...
  object Struct {
    ...
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Struct = js.native
    ...
    object AsObject {
      ...
      implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setFieldsMap(value: js.Array[js.Tuple2[String, typingsSlinky.googleProtobuf.structPbMod.Value.AsObject]]): Self = StObject.set(x, "fieldsMap", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setFieldsMapVarargs(value: (js.Tuple2[String, typingsSlinky.googleProtobuf.structPbMod.Value.AsObject])*): Self = StObject.set(x, "fieldsMap", js.Array(value :_*))
      }
    }
  }
  ...
  object Value {
    ...
    object KindCase extends StObject {
      ...
      /* 4 */ val BOOL_VALUE: typingsSlinky.googleProtobuf.structPbMod.Value.KindCase.BOOL_VALUE with Double = js.native
      
      @js.native
      sealed trait KIND_NOT_SET extends KindCase
      /* 0 */ val KIND_NOT_SET: typingsSlinky.googleProtobuf.structPbMod.Value.KindCase.KIND_NOT_SET with Double = js.native
      
      @js.native
      sealed trait LIST_VALUE extends KindCase
      /* 6 */ val LIST_VALUE: typingsSlinky.googleProtobuf.structPbMod.Value.KindCase.LIST_VALUE with Double = js.native
      
      @js.native
      sealed trait NULL_VALUE extends KindCase
      /* 1 */ val NULL_VALUE: typingsSlinky.googleProtobuf.structPbMod.Value.KindCase.NULL_VALUE with Double = js.native
      
      @js.native
      sealed trait NUMBER_VALUE extends KindCase
      /* 2 */ val NUMBER_VALUE: typingsSlinky.googleProtobuf.structPbMod.Value.KindCase.NUMBER_VALUE with Double = js.native
      
      @js.native
      sealed trait STRING_VALUE extends KindCase
      /* 3 */ val STRING_VALUE: typingsSlinky.googleProtobuf.structPbMod.Value.KindCase.STRING_VALUE with Double = js.native
      
      @js.native
      sealed trait STRUCT_VALUE extends KindCase
      /* 5 */ val STRUCT_VALUE: typingsSlinky.googleProtobuf.structPbMod.Value.KindCase.STRUCT_VALUE with Double = js.native
    }
    
    @JSImport("google-protobuf/google/protobuf/struct_pb", "Value.deserializeBinary")
    @js.native
    def deserializeBinary(bytes: js.typedarray.Uint8Array): Value = js.native
    ...
    object AsObject {
      ...
      implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setListValue(value: typingsSlinky.googleProtobuf.structPbMod.ListValue.AsObject): Self = StObject.set(x, "listValue", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setStructValue(value: typingsSlinky.googleProtobuf.structPbMod.Struct.AsObject): Self = StObject.set(x, "structValue", value.asInstanceOf[js.Any])
