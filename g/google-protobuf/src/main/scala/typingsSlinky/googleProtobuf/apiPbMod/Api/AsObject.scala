...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMethodsListVarargs(value: typingsSlinky.googleProtobuf.apiPbMod.Method.AsObject*): Self = this.set("methodsList", js.Array(value :_*))
    @scala.inline
    def setMethodsList(value: js.Array[typingsSlinky.googleProtobuf.apiPbMod.Method.AsObject]): Self = this.set("methodsList", value.asInstanceOf[js.Any])
    @scala.inline
    def setMixinsListVarargs(value: typingsSlinky.googleProtobuf.apiPbMod.Mixin.AsObject*): Self = this.set("mixinsList", js.Array(value :_*))
    @scala.inline
    def setMixinsList(value: js.Array[typingsSlinky.googleProtobuf.apiPbMod.Mixin.AsObject]): Self = this.set("mixinsList", value.asInstanceOf[js.Any])
    @scala.inline
