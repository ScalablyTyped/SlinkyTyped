...
import typingsSlinky.googlemaps.googlemapsStrings.closeclick
import typingsSlinky.googlemaps.googlemapsStrings.content_changed
import typingsSlinky.googlemaps.googlemapsStrings.domready
