...
object visualization {
  ...
  object MouseEvent {
    ...
    @scala.inline
    def apply(stop: () => Unit): typingsSlinky.googlemaps.google.maps.visualization.MouseEvent = {
      val __obj = js.Dynamic.literal(stop = js.Any.fromFunction0(stop))
      __obj.asInstanceOf[typingsSlinky.googlemaps.google.maps.visualization.MouseEvent]
    }
    
    @scala.inline
    implicit class MouseEventMutableBuilder[Self <: typingsSlinky.googlemaps.google.maps.visualization.MouseEvent] (val x: Self) extends AnyVal {
