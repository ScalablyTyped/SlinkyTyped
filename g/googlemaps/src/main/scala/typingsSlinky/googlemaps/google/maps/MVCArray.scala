...
import typingsSlinky.googlemaps.googlemapsStrings.insert_at
import typingsSlinky.googlemaps.googlemapsStrings.remove_at
import typingsSlinky.googlemaps.googlemapsStrings.set_at
