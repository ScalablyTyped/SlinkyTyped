...
object TransitRoutePreference extends js.Object {
  ...
  /* "FEWER_TRANSFERS" */ val FEWER_TRANSFERS: typingsSlinky.googlemaps.google.maps.TransitRoutePreference.FEWER_TRANSFERS with String = js.native
  /* "LESS_WALKING" */ val LESS_WALKING: typingsSlinky.googlemaps.google.maps.TransitRoutePreference.LESS_WALKING with String = js.native
  @JSBracketAccess
