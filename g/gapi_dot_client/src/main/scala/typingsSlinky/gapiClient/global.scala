...
import typingsSlinky.gapiClient.anon.Body
import typingsSlinky.gapiClient.anon.Clientid
import typingsSlinky.gapiClient.gapi.auth.GoogleApiOAuth2TokenObject
import typingsSlinky.gapiClient.gapi.client.Batch
