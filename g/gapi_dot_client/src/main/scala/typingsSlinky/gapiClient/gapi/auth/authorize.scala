package typingsSlinky.gapiClient.gapi.auth

import typingsSlinky.gapiClient.AnonClientid
...
object authorize extends js.Object {
  /**
    ...
    */
  def apply(params: AnonClientid, callback: js.Function1[/* authResult */ GoogleApiOAuth2TokenObject, Unit]): Unit = js.native
}
