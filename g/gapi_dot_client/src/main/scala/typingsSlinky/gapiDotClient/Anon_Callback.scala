package typingsSlinky.gapiDotClient

import typingsSlinky.gapiDotClient.gapi.client.Response
...
object Anon_Callback {
  @scala.inline
  def apply[T](callback: (Response[T], String) => js.Any, id: String): Anon_Callback[T] = {
