...
object SendAsResource {
  ...
  implicit class SendAsResourceOps[Self <: SendAsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: Alt => Request[SendAs]): Self = {
    ...
    @scala.inline
    def withGet(value: PrettyPrint => Request[SendAs]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: Alt => Request[ListSendAsResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: PrettyPrint => Request[SendAs]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUpdate(value: PrettyPrint => Request[SendAs]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("update")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withVerify(value: PrettyPrint => Request[Unit]): Self = {
        val ret = this.duplicate
