...
object AnonHistoryTypes {
  @scala.inline
  def apply(userId: String): AnonHistoryTypes = {
    val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHistoryTypes]
  }
  @scala.inline
  implicit class AnonHistoryTypesOps[Self <: AnonHistoryTypes] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withHistoryTypes(value: String): Self = {
        val ret = this.duplicate
