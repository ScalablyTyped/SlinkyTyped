...
class List[T] () extends Iterable[T] {
  ...
  /**
    ...
    * @param {*} val
    */
  def indexOf(`val`: T): Double = js.native
  ...
  /**
    ...
    * @param {*} val
    */
  def insertAt(i: Double, `val`: T): Unit = js.native
  ...
  /**
    ...
    * @param {number} from
    */
  def removeRange(to: Double, from: Double): Unit = js.native
  ...
  /**
    ...
    * @param {*} val
    */
  def set(i: Double, `val`: T): Unit = js.native
  ...
  /**
    ...
    * @param {*} val
    */
  def setElt(i: Double, `val`: T): Unit = js.native
