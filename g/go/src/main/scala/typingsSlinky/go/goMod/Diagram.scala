...
import typingsSlinky.go.Anon_Background
import typingsSlinky.go.Anon_BackgroundDocument
...
class Diagram () extends js.Object {
  ...
  def makeImage(properties: Anon_Background): HTMLImageElement = js.native
  /**
  ...
  def makeImageData(properties: Anon_Background): String = js.native
  /**
  ...
  def makeSvg(properties: Anon_BackgroundDocument): SVGElement = js.native
    // undocumented
