...
import typingsSlinky.atGoogleDashCloudStorage.buildSrcBucketMod.BucketOptions
import typingsSlinky.atGoogleDashCloudStorage.buildSrcFileMod.FileOptions
import typingsSlinky.atGoogleDashCloudStorage.buildSrcHmacKeyMod.HmacKeyOptions
import typingsSlinky.atGoogleDashCloudStorage.buildSrcStorageMod.StorageOptions
...
@js.native
object atGoogleDashCloudStorageMod extends js.Object {
  /**
  ...
  class Bucket protected ()
    extends typingsSlinky.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket {
    def this(storage: typingsSlinky.atGoogleDashCloudStorage.buildSrcStorageMod.Storage, name: String) = this()
    def this(
      storage: typingsSlinky.atGoogleDashCloudStorage.buildSrcStorageMod.Storage,
      name: String,
  ...
  class Channel protected ()
    extends typingsSlinky.atGoogleDashCloudStorage.buildSrcChannelMod.Channel {
    def this(
      storage: typingsSlinky.atGoogleDashCloudStorage.buildSrcStorageMod.Storage,
      id: String,
      resourceId: String
  ...
  class File protected ()
    extends typingsSlinky.atGoogleDashCloudStorage.buildSrcFileMod.File {
    /**
    ...
    /**
      ...
      */
    def this(bucket: typingsSlinky.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket, name: String) = this()
    def this(
      bucket: typingsSlinky.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket,
      name: String,
      options: FileOptions
    ) = this()
  }
  ...
  class HmacKey protected ()
    extends typingsSlinky.atGoogleDashCloudStorage.buildSrcHmacKeyMod.HmacKey {
    /**
    ...
    /**
      ...
      */
    def this(storage: typingsSlinky.atGoogleDashCloudStorage.buildSrcStorageMod.Storage, accessId: String) = this()
    def this(
      storage: typingsSlinky.atGoogleDashCloudStorage.buildSrcStorageMod.Storage,
      accessId: String,
  ...
  @js.native
  class Iam protected ()
    extends typingsSlinky.atGoogleDashCloudStorage.buildSrcIamMod.Iam {
    def this(bucket: typingsSlinky.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket) = this()
  }
  ...
  class Notification protected ()
    extends typingsSlinky.atGoogleDashCloudStorage.buildSrcNotificationMod.Notification {
    def this(bucket: typingsSlinky.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket, id: String) = this()
  }
  ...
  /**
    ...
    */
  class Storage ()
    extends typingsSlinky.atGoogleDashCloudStorage.buildSrcStorageMod.Storage {
  ...
  object Storage extends js.Object {
    ...
    var Bucket: Instantiable3[
        ...
        typingsSlinky.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket
      ] = js.native
    /**
      * {@link Channel} class.
      *
    ...
    var Channel: Instantiable3[
        ...
        /* id */ String, 
        /* resourceId */ String, 
        typingsSlinky.atGoogleDashCloudStorage.buildSrcChannelMod.Channel
      ] = js.native
    /**
      * {@link File} class.
      *
    ...
    var File: Instantiable3[
        ...
        typingsSlinky.atGoogleDashCloudStorage.buildSrcFileMod.File
      ] = js.native
    /**
      * {@link HmacKey} class.
      *
    ...
    var HmacKey: Instantiable3[
        ...
        typingsSlinky.atGoogleDashCloudStorage.buildSrcHmacKeyMod.HmacKey
      ] = js.native
    /**
      ...
      * });
      */
    var acl: Anon_OWNERROLE = js.native
  }
