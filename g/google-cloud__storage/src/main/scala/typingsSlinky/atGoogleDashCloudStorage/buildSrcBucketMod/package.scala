...
package object buildSrcBucketMod {
  ...
  import typingsSlinky.atGoogleDashCloudCommon.atGoogleDashCloudCommonMod.ApiError
  import typingsSlinky.atGoogleDashCloudCommon.buildSrcServiceDashObjectMod.ExistsCallback
