...
object ActionToHTTPMethod extends js.Object {
  ...
  /* "DELETE" */ val delete: typingsSlinky.atGoogleDashCloudStorage.buildSrcFileMod.ActionToHTTPMethod.delete with String = js.native
  /* "GET" */ val read: typingsSlinky.atGoogleDashCloudStorage.buildSrcFileMod.ActionToHTTPMethod.read with String = js.native
  /* "POST" */ val resumable: typingsSlinky.atGoogleDashCloudStorage.buildSrcFileMod.ActionToHTTPMethod.resumable with String = js.native
  /* "PUT" */ val write: typingsSlinky.atGoogleDashCloudStorage.buildSrcFileMod.ActionToHTTPMethod.write with String = js.native
  @JSBracketAccess
