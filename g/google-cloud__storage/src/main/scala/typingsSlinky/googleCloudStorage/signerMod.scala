...
import typingsSlinky.googleCloudStorage.googleCloudStorageStrings.GET
import typingsSlinky.googleCloudStorage.googleCloudStorageStrings.POST
import typingsSlinky.googleCloudStorage.googleCloudStorageStrings.PUT
...
object signerMod {
  ...
  object GetSignedUrlConfigInternal {
    ...
    implicit class GetSignedUrlConfigInternalMutableBuilder[Self <: GetSignedUrlConfigInternal] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessibleAt(value: js.Date): Self = StObject.set(x, "accessibleAt", value.asInstanceOf[js.Any])
  ...
  object SignerGetSignedUrlConfig {
    ...
    @scala.inline
    def apply(expires: String | Double | js.Date, method: GET | PUT | DELETE | POST): SignerGetSignedUrlConfig = {
