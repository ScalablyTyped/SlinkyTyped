...
import typingsSlinky.googleCloudStorage.fileMod.File
import typingsSlinky.googleCloudStorage.fileMod.FileOptions
import typingsSlinky.googleCloudStorage.hmacKeyMod.HmacKey
...
object storageMod {
  ...
  object Storage {
    ...
    def Bucket: Instantiable3[
        /* storage */ Storage, 
        /* name */ String, 
        /* options */ js.UndefOr[typingsSlinky.googleCloudStorage.bucketMod.BucketOptions], 
