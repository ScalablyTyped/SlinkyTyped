...
object DatabasesResource {
  ...
  implicit class DatabasesResourceOps[Self <: DatabasesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientSqladmin.anon.Database => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    @scala.inline
    def setGet(value: typingsSlinky.gapiClientSqladmin.anon.Database => Request[Database]): Self = this.set("get", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setPatch(value: typingsSlinky.gapiClientSqladmin.anon.Database => Request[Operation]): Self = this.set("patch", js.Any.fromFunction1(value))
    @scala.inline
    def setUpdate(value: typingsSlinky.gapiClientSqladmin.anon.Database => Request[Operation]): Self = this.set("update", js.Any.fromFunction1(value))
  }
