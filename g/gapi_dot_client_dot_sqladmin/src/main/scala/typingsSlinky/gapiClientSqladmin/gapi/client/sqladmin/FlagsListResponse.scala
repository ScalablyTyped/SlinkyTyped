...
object FlagsListResponse {
  ...
  @scala.inline
  implicit class FlagsListResponseOps[Self <: FlagsListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Flag*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Flag]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
