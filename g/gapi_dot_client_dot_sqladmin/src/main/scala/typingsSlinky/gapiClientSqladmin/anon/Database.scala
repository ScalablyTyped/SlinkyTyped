...
object Database {
  @scala.inline
  def apply(database: String, instance: String, project: String): Database = {
    val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any], instance = instance.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
