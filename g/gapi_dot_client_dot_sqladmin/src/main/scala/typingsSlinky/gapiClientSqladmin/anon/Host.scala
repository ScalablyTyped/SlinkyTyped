...
object Host {
  ...
  @scala.inline
  def apply(host: String, instance: String, name: String, project: String): Host = {
    val __obj = js.Dynamic.literal(host = host.asInstanceOf[js.Any], instance = instance.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
