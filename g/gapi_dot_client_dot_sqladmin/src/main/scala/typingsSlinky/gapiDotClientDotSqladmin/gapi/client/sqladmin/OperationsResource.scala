package typingsSlinky.gapiDotClientDotSqladmin.gapi.client.sqladmin

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotSqladmin.Anon_AltFieldsInstance
import typingsSlinky.gapiDotClientDotSqladmin.Anon_AltFieldsKeyOauthtoken
