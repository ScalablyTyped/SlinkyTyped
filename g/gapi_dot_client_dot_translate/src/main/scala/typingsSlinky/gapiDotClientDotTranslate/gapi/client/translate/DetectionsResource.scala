package typingsSlinky.gapiDotClientDotTranslate.gapi.client.translate

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotTranslate.Anon_AccesstokenAltBearertoken
import typingsSlinky.gapiDotClientDotTranslate.Anon_AccesstokenAltBearertokenCallback
