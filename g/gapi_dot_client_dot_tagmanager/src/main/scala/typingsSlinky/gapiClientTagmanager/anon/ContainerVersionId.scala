package typingsSlinky.gapiClientTagmanager.anon
...
@js.native
trait ContainerVersionId extends js.Object {
...
object ContainerVersionId {
  @scala.inline
  def apply(path: String): ContainerVersionId = {
    val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
    __obj.asInstanceOf[ContainerVersionId]
  }
  @scala.inline
  implicit class ContainerVersionIdOps[Self <: ContainerVersionId] (val x: Self) extends AnyVal {
    @scala.inline
