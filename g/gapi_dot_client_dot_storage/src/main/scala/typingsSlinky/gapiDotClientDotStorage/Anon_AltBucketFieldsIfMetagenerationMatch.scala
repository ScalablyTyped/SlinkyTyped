...
trait Anon_AltBucketFieldsIfMetagenerationMatch extends js.Object {
...
object Anon_AltBucketFieldsIfMetagenerationMatch {
  @scala.inline
  def apply(
    bucket: String,
    alt: String = null,
  ...
  ): Anon_AltBucketFieldsIfMetagenerationMatch = {
    ...
    __obj.asInstanceOf[Anon_AltBucketFieldsIfMetagenerationMatch]
  }
}
