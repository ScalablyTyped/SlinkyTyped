...
object BucketAccessControlsResource {
  ...
  implicit class BucketAccessControlsResourceOps[Self <: BucketAccessControlsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInsert(value: typingsSlinky.gapiClientStorage.anon.Bucket => Request[BucketAccessControl]): Self = this.set("insert", js.Any.fromFunction1(value))
    @scala.inline
    def setList(value: typingsSlinky.gapiClientStorage.anon.Bucket => Request[BucketAccessControls]): Self = this.set("list", js.Any.fromFunction1(value))
    @scala.inline
