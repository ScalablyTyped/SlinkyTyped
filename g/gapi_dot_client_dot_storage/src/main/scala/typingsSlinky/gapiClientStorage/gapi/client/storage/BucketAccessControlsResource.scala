...
trait BucketAccessControlsResource extends js.Object {
  ...
  def insert(request: typingsSlinky.gapiClientStorage.anon.Bucket): Request[BucketAccessControl]
  /** Retrieves ACL entries on the specified bucket. */
  def list(request: typingsSlinky.gapiClientStorage.anon.Bucket): Request[BucketAccessControls]
