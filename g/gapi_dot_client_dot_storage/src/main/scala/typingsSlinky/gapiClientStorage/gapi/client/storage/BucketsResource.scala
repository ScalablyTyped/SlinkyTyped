...
object BucketsResource {
  ...
  implicit class BucketsResourceOps[Self <: BucketsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetIamPolicy(value: typingsSlinky.gapiClientStorage.anon.Bucket => Request[Policy]): Self = this.set("getIamPolicy", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetIamPolicy(value: typingsSlinky.gapiClientStorage.anon.Bucket => Request[Policy]): Self = this.set("setIamPolicy", js.Any.fromFunction1(value))
