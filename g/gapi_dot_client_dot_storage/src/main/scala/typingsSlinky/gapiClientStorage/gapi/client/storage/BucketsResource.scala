...
trait BucketsResource extends js.Object {
  ...
  def getIamPolicy(request: typingsSlinky.gapiClientStorage.anon.Bucket): Request[Policy]
  ...
  def setIamPolicy(request: typingsSlinky.gapiClientStorage.anon.Bucket): Request[Policy]
