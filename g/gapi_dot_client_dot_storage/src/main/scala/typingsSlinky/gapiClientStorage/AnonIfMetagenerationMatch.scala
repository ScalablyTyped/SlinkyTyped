...
trait AnonIfMetagenerationMatch extends js.Object {
...
object AnonIfMetagenerationMatch {
  @scala.inline
  def apply(
    bucket: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonIfMetagenerationMatch]
  }
}
