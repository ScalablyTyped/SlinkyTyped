...
object AnonIfMetagenerationNotMatch {
  @scala.inline
  def apply(bucket: String): AnonIfMetagenerationNotMatch = {
    val __obj = js.Dynamic.literal(bucket = bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIfMetagenerationNotMatch]
  }
  @scala.inline
  implicit class AnonIfMetagenerationNotMatchOps[Self <: AnonIfMetagenerationNotMatch] (val x: Self) extends AnyVal {
    @scala.inline
