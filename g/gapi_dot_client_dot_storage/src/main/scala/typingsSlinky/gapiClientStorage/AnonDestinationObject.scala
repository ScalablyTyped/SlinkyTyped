...
object AnonDestinationObject {
  @scala.inline
  def apply(destinationBucket: String, destinationObject: String, sourceBucket: String, sourceObject: String): AnonDestinationObject = {
  ...
  @scala.inline
  implicit class AnonDestinationObjectOps[Self <: AnonDestinationObject] (val x: Self) extends AnyVal {
    @scala.inline
