...
@js.native
trait AnonDestinationKmsKeyName extends js.Object {
...
object AnonDestinationKmsKeyName {
  @scala.inline
  def apply(destinationBucket: String, destinationObject: String, sourceBucket: String, sourceObject: String): AnonDestinationKmsKeyName = {
    ...
    __obj.asInstanceOf[AnonDestinationKmsKeyName]
  }
  @scala.inline
  implicit class AnonDestinationKmsKeyNameOps[Self <: AnonDestinationKmsKeyName] (val x: Self) extends AnyVal {
    @scala.inline
