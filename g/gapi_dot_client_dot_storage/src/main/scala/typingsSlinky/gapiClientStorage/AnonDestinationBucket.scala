...
@js.native
trait AnonDestinationBucket extends js.Object {
...
object AnonDestinationBucket {
  @scala.inline
  def apply(destinationBucket: String, destinationObject: String): AnonDestinationBucket = {
    ...
    __obj.asInstanceOf[AnonDestinationBucket]
  }
  @scala.inline
  implicit class AnonDestinationBucketOps[Self <: AnonDestinationBucket] (val x: Self) extends AnyVal {
    @scala.inline
