...
object AnonIfGenerationNotMatch {
  @scala.inline
  def apply(bucket: String, `object`: String): AnonIfGenerationNotMatch = {
    val __obj = js.Dynamic.literal(bucket = bucket.asInstanceOf[js.Any])
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIfGenerationNotMatch]
  }
  @scala.inline
  implicit class AnonIfGenerationNotMatchOps[Self <: AnonIfGenerationNotMatch] (val x: Self) extends AnyVal {
    @scala.inline
