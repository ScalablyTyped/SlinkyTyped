package typingsSlinky.gapiClientAnalyticsreporting.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientAnalyticsreporting.gapiClientAnalyticsreportingStrings.analyticsreporting,
    version: v4
