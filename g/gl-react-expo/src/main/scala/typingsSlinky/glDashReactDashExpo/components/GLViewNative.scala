...
object GLViewNative
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.glDashReactDashExpo.gLViewNativeMod.GLViewNative] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.glDashReactDashExpo.gLViewNativeMod.GLViewNative](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
