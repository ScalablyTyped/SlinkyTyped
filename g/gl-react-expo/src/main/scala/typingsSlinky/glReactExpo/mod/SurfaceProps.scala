package typingsSlinky.glReactExpo.mod
...
- typingsSlinky.glReactExpo.glviewnativeMod.GLViewNativeProps because var conflicts: children, style. Inlined onContextCreate */ trait SurfaceProps
