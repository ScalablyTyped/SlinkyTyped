...
object GatsbyImage {
  ...
  def withProps(p: GatsbyImageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: GatsbyImage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
