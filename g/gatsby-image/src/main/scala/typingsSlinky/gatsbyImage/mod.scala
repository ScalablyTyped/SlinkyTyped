...
object mod {
  ...
  type GatsbyImage = ReactComponentClass[GatsbyImageProps]
  ...
  */
  ...
  object GatsbyImageProps {
    ...
    @scala.inline
    def GatsbyImageFixedProps(fixed: FixedObject | js.Array[FixedObject]): typingsSlinky.gatsbyImage.mod.GatsbyImageFixedProps = {
      val __obj = js.Dynamic.literal(fixed = fixed.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.gatsbyImage.mod.GatsbyImageFixedProps]
    }
    
    @scala.inline
    def GatsbyImageFluidProps(fluid: FluidObject | js.Array[FluidObject]): typingsSlinky.gatsbyImage.mod.GatsbyImageFluidProps = {
      val __obj = js.Dynamic.literal(fluid = fluid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.gatsbyImage.mod.GatsbyImageFluidProps]
    }
  }
}
