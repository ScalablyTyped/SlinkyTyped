...
object mod {
  ...
  @JSImport("geoip-country", "startWatchingDataUpdate")
  @js.native
  def startWatchingDataUpdate(cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.geoipCountry.geoipCountryNumbers.`1`
    - typingsSlinky.geoipCountry.geoipCountryNumbers.`-1`
    - typingsSlinky.geoipCountry.geoipCountryNumbers.`0`
    - scala.Null
  */
