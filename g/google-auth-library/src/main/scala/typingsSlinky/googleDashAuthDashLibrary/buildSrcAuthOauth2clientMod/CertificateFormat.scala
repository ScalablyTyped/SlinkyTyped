...
object CertificateFormat extends js.Object {
  ...
  /* "JWK" */ val JWK: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthOauth2clientMod.CertificateFormat.JWK with String = js.native
  /* "PEM" */ val PEM: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthOauth2clientMod.CertificateFormat.PEM with String = js.native
  @JSBracketAccess
