...
import typingsSlinky.googleDashAuthDashLibrary.Anon_Headers
import typingsSlinky.googleDashAuthDashLibrary.Anon_HeadersUri
import typingsSlinky.googleDashAuthDashLibrary.TypeofClassDefaultTransporter
import typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthComputeclientMod.Compute
...
import typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthEnvDetectMod.GCPEnv
...
import typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthOauth2clientMod.RefreshOptions
import typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthRefreshclientMod.UserRefreshClient
import typingsSlinky.googleDashAuthDashLibrary.buildSrcTransportersMod.Transporter
...
class GoogleAuth () extends js.Object {
  ...
  /**
    ...
    */
  def authorizeRequest(opts: Anon_Headers): js.Promise[Anon_HeadersUri] = js.native
  /**
