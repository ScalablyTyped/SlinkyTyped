...
import typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthComputeclientMod.ComputeOptions
...
object googleDashAuthDashLibraryMod extends js.Object {
  ...
  /**
    ...
    */
  class Compute ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthComputeclientMod.Compute {
    def this(options: ComputeOptions) = this()
  }
  
  @js.native
  class DefaultTransporter ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcTransportersMod.DefaultTransporter
  
  @js.native
  class GoogleAuth ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthGoogleauthMod.GoogleAuth {
    def this(opts: GoogleAuthOptions) = this()
  }
  
  @js.native
  class IAMAuth protected ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthIamMod.IAMAuth {
    /**
      * IAM credentials.
      *
  ...
  @js.native
  class JWT protected ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthJwtclientMod.JWT {
    /**
  ...
  /**
    ...
    */
  class JWTAccess ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthJwtaccessMod.JWTAccess {
  ...
  /**
    ...
    */
  class OAuth2Client ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthOauth2clientMod.OAuth2Client {
  ...
  class UserRefreshClient ()
    extends typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthRefreshclientMod.UserRefreshClient {
    def this(clientId: String) = this()
  ...
  val auth: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthGoogleauthMod.GoogleAuth = js.native
  @js.native
  object CodeChallengeMethod extends js.Object {
    /* "plain" */ val Plain: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthOauth2clientMod.CodeChallengeMethod.Plain with String = js.native
    /* "S256" */ val S256: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthOauth2clientMod.CodeChallengeMethod.S256 with String = js.native
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthOauth2clientMod.CodeChallengeMethod with String
      ] = js.native
  }
  ...
  object GCPEnv extends js.Object {
    /* "APP_ENGINE" */ val APP_ENGINE: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthEnvDetectMod.GCPEnv.APP_ENGINE with String = js.native
    /* "CLOUD_FUNCTIONS" */ val CLOUD_FUNCTIONS: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthEnvDetectMod.GCPEnv.CLOUD_FUNCTIONS with String = js.native
    /* "COMPUTE_ENGINE" */ val COMPUTE_ENGINE: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthEnvDetectMod.GCPEnv.COMPUTE_ENGINE with String = js.native
    /* "KUBERNETES_ENGINE" */ val KUBERNETES_ENGINE: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthEnvDetectMod.GCPEnv.KUBERNETES_ENGINE with String = js.native
    /* "NONE" */ val NONE: typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthEnvDetectMod.GCPEnv.NONE with String = js.native
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthEnvDetectMod.GCPEnv with String
      ] = js.native
  }
