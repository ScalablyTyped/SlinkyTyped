package typingsSlinky.googleDashAuthDashLibrary.buildSrcAuthLoginticketMod

import typingsSlinky.googleDashAuthDashLibrary.Anon_Envelope
...
class LoginTicket () extends js.Object {
  ...
  /**
    ...
    */
  def getAttributes(): Anon_Envelope = js.native
