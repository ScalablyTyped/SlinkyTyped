...
object mod {
  ...
  object auth extends Shortcut {
    ...
    @js.native
    val ^ : typingsSlinky.googleAuthLibrary.googleauthMod.GoogleAuth = js.native
    ...
    type _To = typingsSlinky.googleAuthLibrary.googleauthMod.GoogleAuth
    
    /* This means you don't have to write `^`, but can instead just say `auth.foo` */
    override def _to: typingsSlinky.googleAuthLibrary.googleauthMod.GoogleAuth = ^
  }
}
