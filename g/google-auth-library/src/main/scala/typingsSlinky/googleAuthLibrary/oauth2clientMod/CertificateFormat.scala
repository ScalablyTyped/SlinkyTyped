...
object CertificateFormat extends StObject {
  ...
  /* "JWK" */ val JWK: typingsSlinky.googleAuthLibrary.oauth2clientMod.CertificateFormat.JWK with String = js.native
  
  @js.native
  sealed trait PEM extends CertificateFormat
  /* "PEM" */ val PEM: typingsSlinky.googleAuthLibrary.oauth2clientMod.CertificateFormat.PEM with String = js.native
}
