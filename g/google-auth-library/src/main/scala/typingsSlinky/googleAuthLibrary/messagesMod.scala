...
object messagesMod {
  ...
  object WarningTypes extends StObject {
    ...
    /* "DeprecationWarning" */ val DEPRECATION: typingsSlinky.googleAuthLibrary.messagesMod.WarningTypes.DEPRECATION with String = js.native
    
    @js.native
    sealed trait WARNING extends WarningTypes
    /* "Warning" */ val WARNING: typingsSlinky.googleAuthLibrary.messagesMod.WarningTypes.WARNING with String = js.native
  }
