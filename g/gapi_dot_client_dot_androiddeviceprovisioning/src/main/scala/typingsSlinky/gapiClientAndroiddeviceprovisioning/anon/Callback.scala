package typingsSlinky.gapiClientAndroiddeviceprovisioning.anon
...
object Callback {
  @scala.inline
  def apply(deviceId: String, metadataOwnerId: String): Callback = {
  ...
  implicit class CallbackOps[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMetadataOwnerId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("metadataOwnerId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
