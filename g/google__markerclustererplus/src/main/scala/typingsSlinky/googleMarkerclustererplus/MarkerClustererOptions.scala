...
object MarkerClustererOptions {
  ...
  implicit class MarkerClustererOptionsOps[Self <: MarkerClustererOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBatchSizeIE(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("batchSizeIE")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBatchSizeIE: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("batchSizeIE")(js.undefined)
        ret
    }
    @scala.inline
    def withCalculator(value: (/* markers */ js.Array[Marker], /* clusterIconStylesCount */ Double) => ClusterIconInfo): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("calculator")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutCalculator: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("calculator")(js.undefined)
        ret
    }
    @scala.inline
    def withClusterClass(value: java.lang.String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clusterClass")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutClusterClass: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clusterClass")(js.undefined)
        ret
    }
    @scala.inline
    def withEnableRetinaIcons(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enableRetinaIcons")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEnableRetinaIcons: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enableRetinaIcons")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withImageExtension(value: java.lang.String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageExtension")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutImageExtension: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageExtension")(js.undefined)
        ret
    }
    @scala.inline
    def withImagePath(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImageSizes(value: js.Array[Double]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStyles(value: js.Array[ClusterIconStyle]): Self = {
        val ret = this.duplicate
