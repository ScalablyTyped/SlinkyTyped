...
@js.native
trait AnonActorIpAddress extends js.Object {
...
object AnonActorIpAddress {
  @scala.inline
  def apply(applicationName: String, userKey: String): AnonActorIpAddress = {
    val __obj = js.Dynamic.literal(applicationName = applicationName.asInstanceOf[js.Any], userKey = userKey.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonActorIpAddress]
  }
  @scala.inline
  implicit class AnonActorIpAddressOps[Self <: AnonActorIpAddress] (val x: Self) extends AnyVal {
    @scala.inline
