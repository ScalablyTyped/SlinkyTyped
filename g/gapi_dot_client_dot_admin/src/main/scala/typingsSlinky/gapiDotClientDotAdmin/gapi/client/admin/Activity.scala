...
import typingsSlinky.gapiDotClientDotAdmin.Anon_ApplicationName
import typingsSlinky.gapiDotClientDotAdmin.Anon_CallerType
import typingsSlinky.gapiDotClientDotAdmin.Anon_Name
