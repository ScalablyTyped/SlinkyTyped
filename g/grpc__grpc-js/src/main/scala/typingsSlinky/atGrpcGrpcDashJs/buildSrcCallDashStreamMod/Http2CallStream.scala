...
import typingsSlinky.atGrpcGrpcDashJs.Anon_Callback
...
import typingsSlinky.atGrpcGrpcDashJs.buildSrcChannelMod.ChannelImplementation
...
import typingsSlinky.atGrpcGrpcDashJs.buildSrcFilterDashStackMod.FilterStackFactory
...
import typingsSlinky.atGrpcGrpcDashJs.buildSrcObjectDashStreamMod.WriteCallback
...
class Http2CallStream protected ()
  ...
  @JSName("addListener")
  def addListener_data(event: typingsSlinky.node.nodeStrings.data, listener: js.Function1[/* chunk */ js.Any, Unit]): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_data(event: typingsSlinky.node.nodeStrings.data, chunk: js.Any): Boolean = js.native
  @JSName("emit")
  ...
  @JSName("on")
  def on_data(event: typingsSlinky.node.nodeStrings.data, listener: js.Function1[/* chunk */ js.Any, Unit]): this.type = js.native
  @JSName("on")
  ...
  @JSName("once")
  def once_data(event: typingsSlinky.node.nodeStrings.data, listener: js.Function1[/* chunk */ js.Any, Unit]): this.type = js.native
  @JSName("once")
  ...
  def prependListener_data(event: typingsSlinky.node.nodeStrings.data, listener: js.Function1[/* chunk */ js.Any, Unit]): this.type = js.native
  @JSName("prependListener")
  ...
  def prependOnceListener_data(event: typingsSlinky.node.nodeStrings.data, listener: js.Function1[/* chunk */ js.Any, Unit]): this.type = js.native
  @JSName("prependOnceListener")
  ...
  def removeListener_data(event: typingsSlinky.node.nodeStrings.data, listener: js.Function1[/* chunk */ js.Any, Unit]): this.type = js.native
  @JSName("removeListener")
