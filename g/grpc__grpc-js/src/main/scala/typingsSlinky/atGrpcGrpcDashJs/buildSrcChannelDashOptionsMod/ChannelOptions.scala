package typingsSlinky.atGrpcGrpcDashJs.buildSrcChannelDashOptionsMod
...
object ChannelOptions {
  ...
  def apply(
    ...
    grpcDotinitial_reconnect_backoff_ms: Int | Double = null,
    grpcDotkeepalive_time_ms: Int | Double = null,
    grpcDotkeepalive_timeout_ms: Int | Double = null,
    grpcDotmax_concurrent_streams: Int | Double = null,
    grpcDotmax_reconnect_backoff_ms: Int | Double = null,
    ...
    grpcDotuse_local_subchannel_pool: Int | Double = null
  ): ChannelOptions = {
    ...
    if (grpcDotinitial_reconnect_backoff_ms != null) __obj.updateDynamic("grpc.initial_reconnect_backoff_ms")(grpcDotinitial_reconnect_backoff_ms.asInstanceOf[js.Any])
    ...
    if (grpcDotmax_concurrent_streams != null) __obj.updateDynamic("grpc.max_concurrent_streams")(grpcDotmax_concurrent_streams.asInstanceOf[js.Any])
    if (grpcDotmax_reconnect_backoff_ms != null) __obj.updateDynamic("grpc.max_reconnect_backoff_ms")(grpcDotmax_reconnect_backoff_ms.asInstanceOf[js.Any])
    ...
    if (grpcDotuse_local_subchannel_pool != null) __obj.updateDynamic("grpc.use_local_subchannel_pool")(grpcDotuse_local_subchannel_pool.asInstanceOf[js.Any])
