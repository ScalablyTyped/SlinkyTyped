...
object FilterFactory {
  @scala.inline
  def apply[/* <: typingsSlinky.grpcGrpcJs.filterMod.Filter */ T](createFilter: Call => T): FilterFactory[T] = {
    val __obj = js.Dynamic.literal(createFilter = js.Any.fromFunction1(createFilter))
    __obj.asInstanceOf[FilterFactory[T]]
  }
  @scala.inline
  implicit class FilterFactoryOps[Self <: FilterFactory[_], /* <: typingsSlinky.grpcGrpcJs.filterMod.Filter */ T] (val x: Self with FilterFactory[T]) extends AnyVal {
    @scala.inline
