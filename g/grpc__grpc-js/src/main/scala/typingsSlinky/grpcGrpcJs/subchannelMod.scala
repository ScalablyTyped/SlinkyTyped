...
object subchannelMod {
  ...
  */
  ...
  object SubchannelAddress {
    ...
    @scala.inline
    def IpcSubchannelAddress(path: String): typingsSlinky.grpcGrpcJs.subchannelMod.IpcSubchannelAddress = {
      val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.grpcGrpcJs.subchannelMod.IpcSubchannelAddress]
    }
    
    @scala.inline
    def TcpSubchannelAddress(host: String, port: Double): typingsSlinky.grpcGrpcJs.subchannelMod.TcpSubchannelAddress = {
      val __obj = js.Dynamic.literal(host = host.asInstanceOf[js.Any], port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.grpcGrpcJs.subchannelMod.TcpSubchannelAddress]
    }
  }
