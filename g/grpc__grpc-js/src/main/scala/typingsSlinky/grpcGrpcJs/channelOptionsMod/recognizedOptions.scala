package typingsSlinky.grpcGrpcJs.channelOptionsMod
...
object recognizedOptions extends js.Object {
  ...
  var grpcDotkeepalive_time_ms: Boolean = js.native
  ...
  var grpcDotsecondary_user_agent: Boolean = js.native
  @JSName("grpc.service_config")
  var grpcDotservice_config: Boolean = js.native
  @JSName("grpc.ssl_target_name_override")
  var grpcDotssl_target_name_override: Boolean = js.native
  @JSName("grpc.use_local_subchannel_pool")
  var grpcDotuse_local_subchannel_pool: Boolean = js.native
}
