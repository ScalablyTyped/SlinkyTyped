package typingsSlinky.gapiClientAppstate.anon
...
@js.native
trait CurrentStateVersion extends js.Object {
...
object CurrentStateVersion {
  @scala.inline
  def apply(stateKey: Double): CurrentStateVersion = {
    val __obj = js.Dynamic.literal(stateKey = stateKey.asInstanceOf[js.Any])
    __obj.asInstanceOf[CurrentStateVersion]
  }
  @scala.inline
  implicit class CurrentStateVersionOps[Self <: CurrentStateVersion] (val x: Self) extends AnyVal {
    @scala.inline
