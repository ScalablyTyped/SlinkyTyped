...
import typingsSlinky.gapiDotClientDotAppstate.Anon_Alt
import typingsSlinky.gapiDotClientDotAppstate.Anon_AltCurrentStateVersion
import typingsSlinky.gapiDotClientDotAppstate.Anon_AltFields
import typingsSlinky.gapiDotClientDotAppstate.Anon_AltFieldsIncludeData
