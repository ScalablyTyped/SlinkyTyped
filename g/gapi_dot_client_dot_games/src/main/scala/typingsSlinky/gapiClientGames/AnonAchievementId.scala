...
object AnonAchievementId {
  @scala.inline
  def apply(achievementId: String, stepsToIncrement: Double): AnonAchievementId = {
  ...
  @scala.inline
  implicit class AnonAchievementIdOps[Self <: AnonAchievementId] (val x: Self) extends AnyVal {
    @scala.inline
