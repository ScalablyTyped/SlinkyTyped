...
@js.native
trait AnonQuestId extends js.Object {
...
object AnonQuestId {
  @scala.inline
  def apply(questId: String): AnonQuestId = {
    val __obj = js.Dynamic.literal(questId = questId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonQuestId]
  }
  @scala.inline
  implicit class AnonQuestIdOps[Self <: AnonQuestId] (val x: Self) extends AnyVal {
    @scala.inline
