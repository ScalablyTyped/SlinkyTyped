...
@js.native
trait AnonMatchId extends js.Object {
...
object AnonMatchId {
  @scala.inline
  def apply(matchId: String): AnonMatchId = {
    val __obj = js.Dynamic.literal(matchId = matchId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonMatchId]
  }
  @scala.inline
  implicit class AnonMatchIdOps[Self <: AnonMatchId] (val x: Self) extends AnyVal {
    @scala.inline
