...
object AnonTimeSpan {
  @scala.inline
  def apply(collection: String, leaderboardId: String, timeSpan: String): AnonTimeSpan = {
  ...
  @scala.inline
  implicit class AnonTimeSpanOps[Self <: AnonTimeSpan] (val x: Self) extends AnyVal {
    @scala.inline
