...
@js.native
trait AnonSnapshotId extends js.Object {
...
object AnonSnapshotId {
  @scala.inline
  def apply(snapshotId: String): AnonSnapshotId = {
    val __obj = js.Dynamic.literal(snapshotId = snapshotId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSnapshotId]
  }
  @scala.inline
  implicit class AnonSnapshotIdOps[Self <: AnonSnapshotId] (val x: Self) extends AnyVal {
    @scala.inline
