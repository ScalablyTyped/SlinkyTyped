...
object AnonMilestoneId {
  @scala.inline
  def apply(milestoneId: String, questId: String, requestId: String): AnonMilestoneId = {
  ...
  @scala.inline
  implicit class AnonMilestoneIdOps[Self <: AnonMilestoneId] (val x: Self) extends AnyVal {
    @scala.inline
