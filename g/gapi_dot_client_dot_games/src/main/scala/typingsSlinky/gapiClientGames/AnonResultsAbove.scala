...
object AnonResultsAbove {
  @scala.inline
  def apply(collection: String, leaderboardId: String, timeSpan: String): AnonResultsAbove = {
  ...
  @scala.inline
  implicit class AnonResultsAboveOps[Self <: AnonResultsAbove] (val x: Self) extends AnyVal {
    @scala.inline
