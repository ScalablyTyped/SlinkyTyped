...
@js.native
trait QuestId extends js.Object {
...
object QuestId {
  @scala.inline
  def apply(questId: String): QuestId = {
    val __obj = js.Dynamic.literal(questId = questId.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuestId]
  }
  @scala.inline
  implicit class QuestIdOps[Self <: QuestId] (val x: Self) extends AnyVal {
    @scala.inline
