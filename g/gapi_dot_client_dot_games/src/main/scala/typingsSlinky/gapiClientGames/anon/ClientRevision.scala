...
@js.native
trait ClientRevision extends js.Object {
  ...
  /**
    ...
    */
  var clientRevision: String = js.native
...
object ClientRevision {
  @scala.inline
  def apply(clientRevision: String): ClientRevision = {
    val __obj = js.Dynamic.literal(clientRevision = clientRevision.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClientRevision]
  }
  @scala.inline
  implicit class ClientRevisionOps[Self <: ClientRevision] (val x: Self) extends AnyVal {
    @scala.inline
