...
@js.native
trait ConsistencyToken extends js.Object {
...
object ConsistencyToken {
  @scala.inline
  def apply(playerId: String): ConsistencyToken = {
    val __obj = js.Dynamic.literal(playerId = playerId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ConsistencyToken]
  }
  @scala.inline
  implicit class ConsistencyTokenOps[Self <: ConsistencyToken] (val x: Self) extends AnyVal {
    @scala.inline
