...
@js.native
trait AnonMatchVersion extends js.Object {
...
object AnonMatchVersion {
  @scala.inline
  def apply(matchId: String, matchVersion: Double): AnonMatchVersion = {
    val __obj = js.Dynamic.literal(matchId = matchId.asInstanceOf[js.Any], matchVersion = matchVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonMatchVersion]
  }
  @scala.inline
  implicit class AnonMatchVersionOps[Self <: AnonMatchVersion] (val x: Self) extends AnyVal {
    @scala.inline
