...
object TurnBasedMatch {
  ...
  implicit class TurnBasedMatchOps[Self <: TurnBasedMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreationDetails(value: TurnBasedMatchModification): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withData(value: TurnBasedMatchData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLastUpdateDetails(value: TurnBasedMatchModification): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withParticipants(value: js.Array[TurnBasedMatchParticipant]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreviousMatchData(value: TurnBasedMatchData): Self = {
        val ret = this.duplicate
