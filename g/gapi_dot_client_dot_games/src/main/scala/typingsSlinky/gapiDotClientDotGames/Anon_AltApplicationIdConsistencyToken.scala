...
trait Anon_AltApplicationIdConsistencyToken extends js.Object {
...
object Anon_AltApplicationIdConsistencyToken {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltApplicationIdConsistencyToken]
  }
}
