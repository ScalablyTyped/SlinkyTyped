...
import typingsSlinky.gapiDotClientDotPartners.Anon_AccesstokenAltBearertokenCallbackFieldsKey
import typingsSlinky.gapiDotClientDotPartners.Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtoken
