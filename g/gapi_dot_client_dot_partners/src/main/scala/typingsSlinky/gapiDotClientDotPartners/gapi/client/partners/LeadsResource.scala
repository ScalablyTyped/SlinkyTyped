...
import typingsSlinky.gapiDotClientDotPartners.Anon_AccesstokenAltBearertoken
import typingsSlinky.gapiDotClientDotPartners.Anon_AccesstokenAltBearertokenCallback
