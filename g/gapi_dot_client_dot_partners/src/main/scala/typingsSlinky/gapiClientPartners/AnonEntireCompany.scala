...
object AnonEntireCompany {
  @scala.inline
  def apply(): AnonEntireCompany = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonEntireCompany]
  }
  @scala.inline
  implicit class AnonEntireCompanyOps[Self <: AnonEntireCompany] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEntireCompany(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("entireCompany")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEntireCompany: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("entireCompany")(js.undefined)
        ret
    }
    @scala.inline
