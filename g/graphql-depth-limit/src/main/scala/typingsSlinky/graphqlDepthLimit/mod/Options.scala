...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreVarargs(value: (String | js.RegExp | (js.Function1[/* queryDepths */ js.Array[js.Any], Boolean]))*): Self = this.set("ignore", js.Array(value :_*))
    
    @scala.inline
    def setIgnore(value: js.Array[String | js.RegExp | (js.Function1[/* queryDepths */ js.Array[_], Boolean])]): Self = this.set("ignore", value.asInstanceOf[js.Any])
  }
}
