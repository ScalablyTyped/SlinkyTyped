...
@js.native
trait AnonReferenceSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
  ...
  var referenceSetId: String = js.native
...
object AnonReferenceSetId {
  @scala.inline
  def apply(referenceSetId: String): AnonReferenceSetId = {
    val __obj = js.Dynamic.literal(referenceSetId = referenceSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonReferenceSetId]
  }
  @scala.inline
  implicit class AnonReferenceSetIdOps[Self <: AnonReferenceSetId] (val x: Self) extends AnyVal {
    @scala.inline
