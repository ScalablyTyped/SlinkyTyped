...
@js.native
trait AnonAnnotationSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonAnnotationSetId {
  @scala.inline
  def apply(annotationSetId: String): AnonAnnotationSetId = {
    val __obj = js.Dynamic.literal(annotationSetId = annotationSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAnnotationSetId]
  }
  @scala.inline
  implicit class AnonAnnotationSetIdOps[Self <: AnonAnnotationSetId] (val x: Self) extends AnyVal {
    @scala.inline
