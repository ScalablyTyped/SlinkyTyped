...
@js.native
trait AnnotationId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnnotationId {
  @scala.inline
  def apply(annotationId: String): AnnotationId = {
    val __obj = js.Dynamic.literal(annotationId = annotationId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnnotationId]
  }
  @scala.inline
  implicit class AnnotationIdOps[Self <: AnnotationId] (val x: Self) extends AnyVal {
    @scala.inline
