package typingsSlinky.gapiClientGenomics.anon
...
object End {
  ...
  @scala.inline
  def apply(readGroupSetId: String): End = {
  ...
  implicit class EndOps[Self <: End] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetBucketWidth(value: String): Self = this.set("targetBucketWidth", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTargetBucketWidth: Self = this.set("targetBucketWidth", js.undefined)
