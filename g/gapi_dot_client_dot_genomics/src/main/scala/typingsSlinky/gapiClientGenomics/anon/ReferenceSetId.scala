...
@js.native
trait ReferenceSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object ReferenceSetId {
  @scala.inline
  def apply(referenceSetId: String): ReferenceSetId = {
    val __obj = js.Dynamic.literal(referenceSetId = referenceSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReferenceSetId]
  }
  @scala.inline
  implicit class ReferenceSetIdOps[Self <: ReferenceSetId] (val x: Self) extends AnyVal {
    @scala.inline
