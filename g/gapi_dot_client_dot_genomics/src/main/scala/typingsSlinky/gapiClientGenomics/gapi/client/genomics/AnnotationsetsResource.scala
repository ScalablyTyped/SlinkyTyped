...
import typingsSlinky.gapiClientGenomics.anon.AnnotationSetId
import typingsSlinky.gapiClientGenomics.anon.Bearertoken
...
object AnnotationsetsResource {
  ...
  implicit class AnnotationsetsResourceOps[Self <: AnnotationsetsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: Accesstoken => Request[AnnotationSet]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("create")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDelete(value: AnnotationSetId => Request[js.Object]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("delete")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGet(value: AnnotationSetId => Request[AnnotationSet]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSearch(value: Accesstoken => Request[SearchAnnotationSetsResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("search")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdate(value: Bearertoken => Request[AnnotationSet]): Self = {
        val ret = this.duplicate
