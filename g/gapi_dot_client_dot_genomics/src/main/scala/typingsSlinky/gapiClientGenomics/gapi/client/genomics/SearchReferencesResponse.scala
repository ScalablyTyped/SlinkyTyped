...
trait SearchReferencesResponse extends js.Object {
  ...
  var references: js.UndefOr[js.Array[Reference]] = js.native
}

object SearchReferencesResponse {
  @scala.inline
  def apply(): SearchReferencesResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SearchReferencesResponse]
  }
  @scala.inline
  implicit class SearchReferencesResponseOps[Self <: SearchReferencesResponse] (val x: Self) extends AnyVal {
    @scala.inline
