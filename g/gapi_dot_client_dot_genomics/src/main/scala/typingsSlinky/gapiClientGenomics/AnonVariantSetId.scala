...
@js.native
trait AnonVariantSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonVariantSetId {
  @scala.inline
  def apply(variantSetId: String): AnonVariantSetId = {
    val __obj = js.Dynamic.literal(variantSetId = variantSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonVariantSetId]
  }
  @scala.inline
  implicit class AnonVariantSetIdOps[Self <: AnonVariantSetId] (val x: Self) extends AnyVal {
    @scala.inline
