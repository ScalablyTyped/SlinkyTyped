package typingsSlinky.gapiDotClientDotTasks.gapi.client.tasks

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotTasks.Anon_Alt
import typingsSlinky.gapiDotClientDotTasks.Anon_AltFields
import typingsSlinky.gapiDotClientDotTasks.Anon_AltFieldsKey
