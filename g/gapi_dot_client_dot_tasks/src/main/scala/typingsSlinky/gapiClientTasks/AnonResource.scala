...
import typingsSlinky.gapiClientTasks.gapi.client.tasks.Task
...
object AnonResource {
  @scala.inline
  def apply(resource: Task, task: String, tasklist: String): AnonResource = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any], task = task.asInstanceOf[js.Any], tasklist = tasklist.asInstanceOf[js.Any])
  ...
  implicit class AnonResourceOps[Self <: AnonResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: Task): Self = {
