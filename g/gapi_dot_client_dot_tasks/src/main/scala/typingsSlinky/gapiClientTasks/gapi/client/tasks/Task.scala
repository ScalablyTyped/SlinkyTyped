...
object Task {
  ...
  implicit class TaskOps[Self <: Task] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLinksVarargs(value: Description*): Self = this.set("links", js.Array(value :_*))
    @scala.inline
    def setLinks(value: js.Array[Description]): Self = this.set("links", value.asInstanceOf[js.Any])
    @scala.inline
