package typingsSlinky.gapiClientTasks.anon

import typingsSlinky.gapiClientTasks.gapi.client.tasks.TaskList
...
trait Oauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: TaskList = js.native
...
object Oauthtoken {
  @scala.inline
  def apply(resource: TaskList, tasklist: String): Oauthtoken = {
  ...
  implicit class OauthtokenOps[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TaskList): Self = this.set("resource", value.asInstanceOf[js.Any])
    @scala.inline
