...
@js.native
class GEView ()
  extends typingsSlinky.googleEarth.google.earth.GEView {
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsCamera(altitudeMode: KmlAltitudeModeEnum): typingsSlinky.googleEarth.google.earth.KmlCamera = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsLookAt(altitudeMode: KmlAltitudeModeEnum): typingsSlinky.googleEarth.google.earth.KmlLookAt = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getViewportGlobeBounds(): typingsSlinky.googleEarth.google.earth.KmlLatLonBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def hitTest(x: Double, xUnits: KmlUnitsEnum, y: Double, yUnits: KmlUnitsEnum, mode: GEHitTestModeEnum): typingsSlinky.googleEarth.google.earth.GEHitTestResult = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def project(lat: Double, lng: Double, alt: Double, altitudeMode: KmlAltitudeModeEnum): typingsSlinky.googleEarth.google.earth.KmlVec2 = js.native
  /**
    * Sets the camera that views the scene in Google Earth.
    */
  /* CompleteClass */
  override def setAbstractView(view: typingsSlinky.googleEarth.google.earth.KmlAbstractView): Unit = js.native
}
