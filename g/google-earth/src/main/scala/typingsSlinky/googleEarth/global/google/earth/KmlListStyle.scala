...
@js.native
class KmlListStyle ()
  extends typingsSlinky.googleEarth.google.earth.KmlListStyle {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBgColor(): typingsSlinky.googleEarth.google.earth.KmlColor = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getListItemType(): KmlListItemTypeEnum = js.native
  /**
    * Maximum number of lines of text for the Snippet.
    */
  /* CompleteClass */
  override def getMaxSnippetLines(): Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setMaxSnippetLines(maxSnippetLines: Double): Unit = js.native
}
