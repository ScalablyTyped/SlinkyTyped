...
@js.native
class KmlStyle ()
  extends typingsSlinky.googleEarth.google.earth.KmlStyle {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBalloonStyle(): typingsSlinky.googleEarth.google.earth.KmlBalloonStyle = js.native
  /**
    * Specifies how icons for point placemarks are drawn in Google Earth.
    */
  /* CompleteClass */
  override def getIconStyle(): typingsSlinky.googleEarth.google.earth.KmlIconStyle = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLabelStyle(): typingsSlinky.googleEarth.google.earth.KmlLabelStyle = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getLineStyle(): typingsSlinky.googleEarth.google.earth.KmlLineStyle = js.native
  /**
    * Specifies the style for list geometry.
    */
  /* CompleteClass */
  override def getListStyle(): typingsSlinky.googleEarth.google.earth.KmlListStyle = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getPolyStyle(): typingsSlinky.googleEarth.google.earth.KmlPolyStyle = js.native
  /**
