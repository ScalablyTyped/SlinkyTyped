...
class KmlGroundOverlay ()
  extends typingsSlinky.googleEarth.google.earth.KmlGroundOverlay {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLatLonBox(): typingsSlinky.googleEarth.google.earth.KmlLatLonBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLatLonBox(latLonBox: typingsSlinky.googleEarth.google.earth.KmlLatLonBox): Unit = js.native
  /**
    * User-defined text displayed in the plugin as the label for the object (for example, for a Placemark).
    */
  /* CompleteClass */
