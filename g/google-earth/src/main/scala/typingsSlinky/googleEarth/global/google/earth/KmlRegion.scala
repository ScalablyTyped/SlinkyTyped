...
@js.native
class KmlRegion ()
  extends typingsSlinky.googleEarth.google.earth.KmlRegion {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLatLonAltBox(): typingsSlinky.googleEarth.google.earth.KmlLatLonAltBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getLod(): typingsSlinky.googleEarth.google.earth.KmlLod = js.native
  /**
  ...
  /* CompleteClass */
  override def set(
    latLonAltBox: typingsSlinky.googleEarth.google.earth.KmlLatLonAltBox,
    lod: typingsSlinky.googleEarth.google.earth.KmlLod
  ): Unit = js.native
  /**
    * A bounding box that describes an area of interest defined by geographic coordinates and altitudes.
    */
  /* CompleteClass */
  override def setLatLonAltBox(latLonAltBox: typingsSlinky.googleEarth.google.earth.KmlLatLonAltBox): Unit = js.native
  /**
    * LOD is an abbreviation for Level of Detail.
    * Lod describes the size of the projected region on the screen that is required in order for the region to be considered "active.
    * " Also specifies the size of the pixel ramp used for fading in (from transparent to opaque) and fading out (from opaque to transparent).
    */
  /* CompleteClass */
  override def setLod(lod: typingsSlinky.googleEarth.google.earth.KmlLod): Unit = js.native
}
