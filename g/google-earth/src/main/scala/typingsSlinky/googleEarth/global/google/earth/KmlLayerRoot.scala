...
@js.native
class KmlLayerRoot ()
  extends typingsSlinky.googleEarth.google.earth.KmlLayerRoot {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLayerById(id: String): typingsSlinky.googleEarth.google.earth.KmlLayer = js.native
  /**
