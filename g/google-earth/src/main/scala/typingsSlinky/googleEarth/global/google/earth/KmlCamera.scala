...
@js.native
class KmlCamera ()
  extends typingsSlinky.googleEarth.google.earth.KmlCamera {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsCamera(): typingsSlinky.googleEarth.google.earth.KmlCamera = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsLookAt(): typingsSlinky.googleEarth.google.earth.KmlLookAt = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getViewerOptions(): typingsSlinky.googleEarth.google.earth.KmlViewerOptions = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setViewerOptions(viewerOptions: typingsSlinky.googleEarth.google.earth.KmlViewerOptions): Unit = js.native
}
