...
@js.native
class KmlDocument ()
  extends typingsSlinky.googleEarth.google.earth.KmlDocument {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getAbstractView(): typingsSlinky.googleEarth.google.earth.KmlAbstractView = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getComputedStyle(): typingsSlinky.googleEarth.google.earth.KmlStyle = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getElementsByStyleUrl(styleUrl: String): typingsSlinky.googleEarth.google.earth.KmlObjectList[typingsSlinky.googleEarth.google.earth.KmlObject] = js.native
  /**
    * Get an element by type.
    */
  /* CompleteClass */
  override def getElementsByType(`type`: String): typingsSlinky.googleEarth.google.earth.KmlObjectList[typingsSlinky.googleEarth.google.earth.KmlObject] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getNextSibling(): typingsSlinky.googleEarth.google.earth.KmlFeature = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getPreviousSibling(): typingsSlinky.googleEarth.google.earth.KmlFeature = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getRegion(): typingsSlinky.googleEarth.google.earth.KmlRegion = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getStyleSelector(): typingsSlinky.googleEarth.google.earth.KmlStyleSelector = js.native
  /**
    * Returns an array containing the style selectors present in the KML document.
    */
  /* CompleteClass */
  override def getStyleSelectors(): typingsSlinky.googleEarth.google.earth.GEStyleSelectorContainer = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getTimePrimitive(): typingsSlinky.googleEarth.google.earth.KmlTimePrimitive = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setAbstractView(abstractView: typingsSlinky.googleEarth.google.earth.KmlAbstractView): Unit = js.native
  /**
    * Specifies a value representing an unstructured address written as a standard street, city, state address, and/or as a postal code.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setRegion(region: typingsSlinky.googleEarth.google.earth.KmlRegion): Unit = js.native
  /**
    * Specifies a short description of the feature.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setStyleSelector(styleSelector: typingsSlinky.googleEarth.google.earth.KmlStyleSelector): Unit = js.native
  /**
    * URI of a Style or StyleMap defined in a Document.
    * It refers to a Plug-in intitiated object.
    */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setTimePrimitive(timePrimitive: typingsSlinky.googleEarth.google.earth.KmlTimePrimitive): Unit = js.native
  /**
    * Specifies whether the feature is drawn in the plugin.
    * In order for a feature to be visible, the visibility of all its ancestors must also be set to true.
    * In the Google Earth List View, each feature has a checkbox that allows the user to control visibility of the feature.
