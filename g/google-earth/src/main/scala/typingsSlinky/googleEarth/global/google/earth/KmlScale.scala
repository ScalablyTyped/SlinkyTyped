...
@js.native
class KmlScale ()
  extends typingsSlinky.googleEarth.google.earth.KmlScale {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def set(x: Double, y: Double, z: Double): Unit = js.native
  /**
    * Indicates the x coordinate.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setZ(z: Double): Unit = js.native
}
