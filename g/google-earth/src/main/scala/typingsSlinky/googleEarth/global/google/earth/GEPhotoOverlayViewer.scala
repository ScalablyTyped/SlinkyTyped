...
class GEPhotoOverlayViewer ()
  extends typingsSlinky.googleEarth.google.earth.GEPhotoOverlayViewer {
  /**
    ...
    */
  /* CompleteClass */
  override def setPhotoOverlay(photoOverlay: typingsSlinky.googleEarth.google.earth.KmlPhotoOverlay): Unit = js.native
}
