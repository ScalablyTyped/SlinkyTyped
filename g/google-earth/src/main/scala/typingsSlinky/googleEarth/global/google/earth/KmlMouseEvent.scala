...
@js.native
class KmlMouseEvent ()
  extends typingsSlinky.googleEarth.google.earth.KmlMouseEvent {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getRelatedTarget(): typingsSlinky.googleEarth.google.earth.GEEventEmitter = js.native
  /**
