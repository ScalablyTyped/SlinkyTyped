...
import typingsSlinky.googleEarth.google.earth.GEHitTestModeEnum
import typingsSlinky.googleEarth.google.earth.GEMapTypeEnum
import typingsSlinky.googleEarth.google.earth.GENavigationControlEnum
import typingsSlinky.googleEarth.google.earth.GEViewerOptionsTypeEnum
import typingsSlinky.googleEarth.google.earth.GEViewerOptionsValueEnum
import typingsSlinky.googleEarth.google.earth.GEVisibilityEnum
import typingsSlinky.googleEarth.google.earth.KmlAltitudeModeEnum
import typingsSlinky.googleEarth.google.earth.KmlColorModeEnum
import typingsSlinky.googleEarth.google.earth.KmlListItemTypeEnum
import typingsSlinky.googleEarth.google.earth.KmlRefreshModeEnum
import typingsSlinky.googleEarth.google.earth.KmlUnitsEnum
import typingsSlinky.googleEarth.google.earth.KmlViewRefreshModeEnum
...
@js.native
class GEPlugin ()
  extends typingsSlinky.googleEarth.google.earth.GEPlugin {
  /**
    ...
    */
  /* CompleteClass */
  override var ALTITUDE_ABSOLUTE: KmlAltitudeModeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var ALTITUDE_CLAMP_TO_GROUND: KmlAltitudeModeEnum = js.native
  /**
    * Specifies that altitudes are at sea floor level.
    */
  /* CompleteClass */
  override var ALTITUDE_CLAMP_TO_SEA_FLOOR: KmlAltitudeModeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var ALTITUDE_RELATIVE_TO_GROUND: KmlAltitudeModeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var ALTITUDE_RELATIVE_TO_SEA_FLOOR: KmlAltitudeModeEnum = js.native
  /**
    * Inherit the color mode from ancestor styles.
    */
  /* CompleteClass */
  override var COLOR_INHERIT: KmlColorModeEnum = js.native
  /**
    * Apply no color mode effect, i.e. use the base color as is.
    */
  /* CompleteClass */
  override var COLOR_NORMAL: KmlColorModeEnum = js.native
  /**
    * Apply a random linear scale to the base color. See the KML <colorMode> documentation for more details.
    */
  /* CompleteClass */
  override var COLOR_RANDOM: KmlColorModeEnum = js.native
  /**
    * When using the GEView.hitTest method, this mode samples 3D buildings.
    */
  /* CompleteClass */
  override var HIT_TEST_BUILDINGS: GEHitTestModeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var HIT_TEST_GLOBE: GEHitTestModeEnum = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var LIST_ITEM_CHECK_HIDE_CHILDREN: KmlListItemTypeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var LIST_ITEM_CHECK_OFF_ONLY: KmlListItemTypeEnum = js.native
  /**
    * When specified for a container (a folder or a document), only one of the container's items should be visible at a time.
    */
  /* CompleteClass */
  override var LIST_ITEM_RADIO_FOLDER: KmlListItemTypeEnum = js.native
  /**
    * The Earth map type, used with GEOptions' setMapType.
    */
  /* CompleteClass */
  override var MAP_TYPE_EARTH: GEMapTypeEnum = js.native
  /**
    * The Sky map type, used with GEOptions' setMapType.
    */
  /* CompleteClass */
  override var MAP_TYPE_SKY: GEMapTypeEnum = js.native
  /**
    * The large navigation control type, used with GENavigationControl.setControlType().
    */
  /* CompleteClass */
  override var NAVIGATION_CONTROL_LARGE: GENavigationControlEnum = js.native
  /**
    * The small navigation control type, used with GENavigationControl.setControlType().
    */
  /* CompleteClass */
  override var NAVIGATION_CONTROL_SMALL: GENavigationControlEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var OPTION_HISTORICAL_IMAGERY: GEViewerOptionsTypeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var OPTION_STATE_DEFAULT: GEViewerOptionsValueEnum = js.native
  /**
    * Set the render state to off. Passed to the KmlViewerOptions.setOption method.
    */
  /* CompleteClass */
  override var OPTION_STATE_DISABLED: GEViewerOptionsValueEnum = js.native
  /**
    * Set the render state to on. Passed to the KmlViewerOptions.setOption method.
    */
  /* CompleteClass */
  override var OPTION_STATE_ENABLED: GEViewerOptionsValueEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var OPTION_STREET_VIEW: GEViewerOptionsTypeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var OPTION_SUNLIGHT: GEViewerOptionsTypeEnum = js.native
  /**
    * Refresh when the file is loaded and whenever the Link parameters change. This refresh mode is the default.
    */
  /* CompleteClass */
  override var REFRESH_ON_CHANGE: KmlRefreshModeEnum = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var REFRESH_ON_EXPIRE: KmlRefreshModeEnum = js.native
  /**
    * Refresh every n seconds (specified in refreshInterval).
    */
  /* CompleteClass */
  override var REFRESH_ON_INTERVAL: KmlRefreshModeEnum = js.native
  /**
    * Specifies that fly-to should happen immediately, without a smooth transition.
    */
  /* CompleteClass */
  override var SPEED_TELEPORT: Double = js.native
  /**
    * Screen coordinates are to be interpreted as a fraction of an item, like an image or Google Earth window.
    */
  /* CompleteClass */
  override var UNITS_FRACTION: KmlUnitsEnum = js.native
  /**
    * Screen coordinates are to be interpreted as pixels from the top or right edge.
    */
  /* CompleteClass */
  override var UNITS_INSET_PIXELS: KmlUnitsEnum = js.native
  /**
    * Screen coordinates are to be interpreted as pixels from the left or bottom edge.
    */
  /* CompleteClass */
  override var UNITS_PIXELS: KmlUnitsEnum = js.native
  /**
    * Ignore changes in the view. Also ignore viewFormat parameters, if any.
    * This view refresh mode is the default.
    */
  /* CompleteClass */
  override var VIEW_REFRESH_NEVER: KmlViewRefreshModeEnum = js.native
  /**
    * Refresh only when the feature's Region becomes active.
    */
  /* CompleteClass */
  override var VIEW_REFRESH_ON_REGION: KmlViewRefreshModeEnum = js.native
  /**
    * Refresh the file only when the user explicitly requests it.
    */
  /* CompleteClass */
  override var VIEW_REFRESH_ON_REQUEST: KmlViewRefreshModeEnum = js.native
  /**
    * Refresh n seconds after movement stops, where n is specified in viewRefreshTime.
    */
  /* CompleteClass */
  override var VIEW_REFRESH_ON_STOP: KmlViewRefreshModeEnum = js.native
  /**
    * Automatically show or hide the UI element depending on user interaction.
    */
  /* CompleteClass */
  override var VISIBILITY_AUTO: GEVisibilityEnum = js.native
  /**
    * Hide the UI element.
    */
  /* CompleteClass */
  override var VISIBILITY_HIDE: GEVisibilityEnum = js.native
  /**
    * Show the UI element always.
    */
  /* CompleteClass */
  override var VISIBILITY_SHOW: GEVisibilityEnum = js.native
  /**
    * Creates a new Camera.
    * This element positions the camera relative to the Earth's surface and defines the view direction.
    */
  /* CompleteClass */
  override def createCamera(id: String): typingsSlinky.googleEarth.google.earth.KmlCamera = js.native
  /**
    * Creates a Document. A Document is a container for features and styles.
    */
  /* CompleteClass */
  override def createDocument(id: String): typingsSlinky.googleEarth.google.earth.KmlDocument = js.native
  /**
    * Creates a Feature balloon.
    */
  /* CompleteClass */
  override def createFeatureBalloon(id: String): typingsSlinky.googleEarth.google.earth.GEFeatureBalloon = js.native
  /**
    * Creates a folder. 
    ...
    */
  /* CompleteClass */
  override def createFolder(id: String): typingsSlinky.googleEarth.google.earth.KmlFolder = js.native
  /**
    * Creates a GroundOverlay.
    * A GroundOverlay draws an image overlay draped onto the terrain.
    */
  /* CompleteClass */
  override def createGroundOverlay(id: String): typingsSlinky.googleEarth.google.earth.KmlGroundOverlay = js.native
  /**
    * Creates an Html Div Balloon.
    */
  /* CompleteClass */
  override def createHtmlDivBalloon(id: String): typingsSlinky.googleEarth.google.earth.GEHtmlDivBalloon = js.native
  /**
    * Creates an HTML string balloon.
    */
  /* CompleteClass */
  override def createHtmlStringBalloon(id: String): typingsSlinky.googleEarth.google.earth.GEHtmlStringBalloon = js.native
  /**
    * Creates an Icon. An icon defines an image associated with an Icon style or overlay.
    */
  /* CompleteClass */
  override def createIcon(id: String): typingsSlinky.googleEarth.google.earth.KmlIcon = js.native
  /**
    * Creates a LatLonAltBox, a bounding box that describes an area of interest defined by geographic coordinates and altitudes.
    */
  /* CompleteClass */
  override def createLatLonAltBox(id: String): typingsSlinky.googleEarth.google.earth.KmlLatLonAltBox = js.native
  /**
    * Creates a LatLonBox, a bounding box that describes an area of interest defined by geographic coordinates and altitudes.
    */
  /* CompleteClass */
  override def createLatLonBox(id: String): typingsSlinky.googleEarth.google.earth.KmlLatLonBox = js.native
  /**
    * Creates a line string on Google Earth.
    */
  /* CompleteClass */
  override def createLineString(id: String): typingsSlinky.googleEarth.google.earth.KmlLineString = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def createLinearRing(id: String): typingsSlinky.googleEarth.google.earth.KmlLinearRing = js.native
  /**
    * Creates a Link.
    ...
    */
  /* CompleteClass */
  override def createLink(id: String): typingsSlinky.googleEarth.google.earth.KmlLink = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def createLocation(id: String): typingsSlinky.googleEarth.google.earth.KmlLocation = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def createLod(id: String): typingsSlinky.googleEarth.google.earth.KmlLod = js.native
  /**
    * Creates a new LookAt.
    * A LookAt element positions the camera view in relation to an object that is being viewed.
    */
  /* CompleteClass */
  override def createLookAt(id: String): typingsSlinky.googleEarth.google.earth.KmlLookAt = js.native
  /**
    * Creates a model.
    ...
    */
  /* CompleteClass */
  override def createModel(id: String): typingsSlinky.googleEarth.google.earth.KmlModel = js.native
  /**
    * Creates a container for one or more geometry primitives associated with the same feature.
    */
  /* CompleteClass */
  override def createMultiGeometry(id: String): typingsSlinky.googleEarth.google.earth.KmlMultiGeometry = js.native
  /**
    * Creates a NetworkLink.
    * A NetworkLink references a KML file or KMZ archive on a local or remote network.
    */
  /* CompleteClass */
  override def createNetworkLink(id: String): typingsSlinky.googleEarth.google.earth.KmlNetworkLink = js.native
  /**
    * Sets the rotation of a 3D model's coordinate system to position the object in Google Earth.
    */
  /* CompleteClass */
  override def createOrientation(id: String): typingsSlinky.googleEarth.google.earth.KmlOrientation = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def createPlacemark(id: String): typingsSlinky.googleEarth.google.earth.KmlPlacemark = js.native
  /**
    * Creates a point on the globe. Specifies the geographic location defined by longitude, latitude, and (optional) altitude.
    */
  /* CompleteClass */
  override def createPoint(id: String): typingsSlinky.googleEarth.google.earth.KmlPoint = js.native
  /**
    * Creates a Polygon. A Polygon is defined by an outer boundary and 0 or more inner boundaries.
    */
  /* CompleteClass */
  override def createPolygon(id: String): typingsSlinky.googleEarth.google.earth.KmlPolygon = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def createRegion(id: String): typingsSlinky.googleEarth.google.earth.KmlRegion = js.native
  /**
    * Sets the scale of a model along the x, y, and z axes in the model's coordinate space.
    */
  /* CompleteClass */
  override def createScale(id: String): typingsSlinky.googleEarth.google.earth.KmlScale = js.native
  /**
    * Creates a ScreenOverlay.
    * A ScreenOverlay draws an image overlay fixed to the screen.
    */
  /* CompleteClass */
  override def createScreenOverlay(id: String): typingsSlinky.googleEarth.google.earth.KmlScreenOverlay = js.native
  /**
    * A Style defines an addressable style group that can be referenced by StyleMaps and features.
    */
  /* CompleteClass */
  override def createStyle(id: String): typingsSlinky.googleEarth.google.earth.KmlStyle = js.native
  /**
    * Creates a StyleMap.
    ...
    */
  /* CompleteClass */
  override def createStyleMap(id: String): typingsSlinky.googleEarth.google.earth.KmlStyleMap = js.native
  /**
    * Create a KmlTimeSpan object.
    * For more information, refer to the Time chapter of the Google Earth API developer's guide.
    */
  /* CompleteClass */
  override def createTimeSpan(id: String): typingsSlinky.googleEarth.google.earth.KmlTimeSpan = js.native
  /**
    * Create a KmlTimeStamp object.
    * For more information, refer to the Time chapter of the Google Earth API developer's guide.
    */
  /* CompleteClass */
  override def createTimeStamp(id: String): typingsSlinky.googleEarth.google.earth.KmlTimeStamp = js.native
  /**
    * Creates a new viewer options object.
    */
  /* CompleteClass */
  override def createViewerOptions(id: String): typingsSlinky.googleEarth.google.earth.KmlViewerOptions = js.native
  /**
    * Returns the currently active balloon, or null.
    */
  /* CompleteClass */
  override def getBalloon(): typingsSlinky.googleEarth.google.earth.GEAbstractBalloon = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getElementById(id: String): typingsSlinky.googleEarth.google.earth.KmlObject = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getElementByUrl(url: String): typingsSlinky.googleEarth.google.earth.KmlObject = js.native
  /**
    * Get a list of elements by type.
    */
  /* CompleteClass */
  override def getElementsByType(): typingsSlinky.googleEarth.google.earth.KmlObjectList[typingsSlinky.googleEarth.google.earth.KmlObject] = js.native
  /**
    * The top-level features currently in the Earth object.
    */
  /* CompleteClass */
  override def getFeatures(): typingsSlinky.googleEarth.google.earth.GEFeatureContainer = js.native
  /**
    * Controls the globe behavior.
    */
  /* CompleteClass */
  override def getGlobe(): typingsSlinky.googleEarth.google.earth.GEGlobe = js.native
  /**
    * Controls built-in layer behavior.
    */
  /* CompleteClass */
  override def getLayerRoot(): typingsSlinky.googleEarth.google.earth.KmlLayerRoot = js.native
  /**
    * Controls the navigation controls on the globe.
    */
  /* CompleteClass */
  override def getNavigationControl(): typingsSlinky.googleEarth.google.earth.GENavigationControl = js.native
  /**
    * The options used to manipulate the behavior of the Google Earth plugin.
    */
  /* CompleteClass */
  override def getOptions(): typingsSlinky.googleEarth.google.earth.GEOptions = js.native
  /**
    * Exposes functionality for interacting with photo overlays.
    */
  /* CompleteClass */
  override def getPhotoOverlayViewer(): typingsSlinky.googleEarth.google.earth.GEPhotoOverlayViewer = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSun(): typingsSlinky.googleEarth.google.earth.GESun = js.native
  /**
    * The time class used to manipulate the behavior of the Google Earth plugin time.
    */
  /* CompleteClass */
  override def getTime(): typingsSlinky.googleEarth.google.earth.GETime = js.native
  /**
    * Exposes functionality for interacting with KML tours.
    */
  /* CompleteClass */
  override def getTourPlayer(): typingsSlinky.googleEarth.google.earth.GETourPlayer = js.native
  /**
    * Controls the plugin viewport.
    */
  /* CompleteClass */
  override def getView(): typingsSlinky.googleEarth.google.earth.GEView = js.native
  /**
    * Controls the window options.
    */
  /* CompleteClass */
  override def getWindow(): typingsSlinky.googleEarth.google.earth.GEWindow = js.native
  /**
    * Parse a string of KML and return a handle to the root of the KML object structure that was created.
    */
  /* CompleteClass */
  override def parseKml(kml: String): typingsSlinky.googleEarth.google.earth.KmlObject = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def setBalloon(newActiveBalloon: typingsSlinky.googleEarth.google.earth.GEAbstractBalloon): Unit = js.native
}
