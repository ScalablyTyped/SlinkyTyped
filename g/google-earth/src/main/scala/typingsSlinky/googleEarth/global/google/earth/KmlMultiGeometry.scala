...
class KmlMultiGeometry ()
  extends typingsSlinky.googleEarth.google.earth.KmlMultiGeometry {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getGeometries(): typingsSlinky.googleEarth.google.earth.GEGeometryContainer = js.native
  /**
