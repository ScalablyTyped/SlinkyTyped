...
@js.native
class GEHtmlDivBalloon ()
  extends typingsSlinky.googleEarth.google.earth.GEHtmlDivBalloon {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getFeature(): typingsSlinky.googleEarth.google.earth.KmlFeature = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setFeature(feature: typingsSlinky.googleEarth.google.earth.KmlFeature): Unit = js.native
  /**
    * The color of the text in the balloon.
    * This must be set using the HTML hex format #RRGGBB.
    * If not set, it is interpreted as #000000.
