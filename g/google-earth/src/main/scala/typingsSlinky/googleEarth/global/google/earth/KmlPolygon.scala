...
@js.native
class KmlPolygon ()
  extends typingsSlinky.googleEarth.google.earth.KmlPolygon {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getInnerBoundaries(): typingsSlinky.googleEarth.google.earth.GELinearRingContainer = js.native
  /**
    * Contains a LinearRing element.
    */
  /* CompleteClass */
  override def getOuterBoundary(): typingsSlinky.googleEarth.google.earth.KmlLinearRing = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setOuterBoundary(outerBoundary: typingsSlinky.googleEarth.google.earth.KmlLinearRing): Unit = js.native
  /**
    * Specifies whether to allow the geometry to follow the terrain elevation.
    */
  /* CompleteClass */
