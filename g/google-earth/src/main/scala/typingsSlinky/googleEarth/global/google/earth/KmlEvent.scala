...
import typingsSlinky.googleEarth.google.earth.GEEventPhaseEnum
...
@js.native
class KmlEvent ()
  extends typingsSlinky.googleEarth.google.earth.KmlEvent {
  /**
    * The target whose event listeners are currently being processed.
    */
  /* CompleteClass */
  override var getCurrentTarget: typingsSlinky.googleEarth.google.earth.GEEventEmitter = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getTarget(): typingsSlinky.googleEarth.google.earth.GEEventEmitter = js.native
  /**
