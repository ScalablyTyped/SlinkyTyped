...
@js.native
class GETime ()
  extends typingsSlinky.googleEarth.google.earth.GETime {
  /**
    * Returns the GETimeControl object; this is the time slider.
    */
  /* CompleteClass */
  override def getControl(): typingsSlinky.googleEarth.google.earth.GETimeControl = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSystemTime(): typingsSlinky.googleEarth.google.earth.KmlTimeStamp = js.native
  /**
