...
@js.native
class KmlIconStyle ()
  extends typingsSlinky.googleEarth.google.earth.KmlIconStyle {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getColor(): typingsSlinky.googleEarth.google.earth.KmlColor = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getHotSpot(): typingsSlinky.googleEarth.google.earth.KmlVec2 = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getIcon(): typingsSlinky.googleEarth.google.earth.KmlIcon = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setIcon(icon: typingsSlinky.googleEarth.google.earth.KmlIcon): Unit = js.native
  /**
    * Resizes the icon.
    */
  /* CompleteClass */
