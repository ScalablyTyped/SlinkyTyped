...
@js.native
class GETimeControl ()
  extends typingsSlinky.googleEarth.google.earth.GETimeControl {
  /**
    * Returns an array containing the KmlTimeStamp objects associated with the historical imagery available in this view.
    */
  /* CompleteClass */
  override def getAvailableImageDates(): typingsSlinky.googleEarth.google.earth.KmlObjectList[typingsSlinky.googleEarth.google.earth.KmlTimeStamp] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getExtents(): typingsSlinky.googleEarth.google.earth.KmlTimeSpan = js.native
  /**
