...
@js.native
class KmlLinearRing ()
  extends typingsSlinky.googleEarth.google.earth.KmlLineString {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getCoordinates(): typingsSlinky.googleEarth.google.earth.KmlCoordArray = js.native
  /**
