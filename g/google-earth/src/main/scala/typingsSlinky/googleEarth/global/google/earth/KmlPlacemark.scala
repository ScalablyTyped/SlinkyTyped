...
@js.native
class KmlPlacemark ()
  extends typingsSlinky.googleEarth.google.earth.KmlPlacemark {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getGeometry(): typingsSlinky.googleEarth.google.earth.KmlGeometry = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setGeometry(geometry: typingsSlinky.googleEarth.google.earth.KmlGeometry): Unit = js.native
  /**
    * User-defined text displayed in the plugin as the label for the object (for example, for a Placemark).
    */
  /* CompleteClass */
