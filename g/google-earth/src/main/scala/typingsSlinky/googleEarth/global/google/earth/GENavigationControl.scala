...
@js.native
class GENavigationControl ()
  extends typingsSlinky.googleEarth.google.earth.GENavigationControl {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getScreenXY(): typingsSlinky.googleEarth.google.earth.KmlVec2 = js.native
  /**
