...
@js.native
class KmlStyleMap ()
  extends typingsSlinky.googleEarth.google.earth.KmlStyleMap {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getHighlightStyle(): typingsSlinky.googleEarth.google.earth.KmlStyle = js.native
  /**
    * Defines highlighted styles for a placemark, so that the highlighted version appears when the user mouses over the icon in Google Earth.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getNormalStyle(): typingsSlinky.googleEarth.google.earth.KmlStyle = js.native
  /**
    * Defines a normal style for a placemark.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setHighlightStyle(highlightStyle: typingsSlinky.googleEarth.google.earth.KmlStyle): Unit = js.native
  /**
    * Defines highlighted styles for a placemark, so that the highlighted version appears when the user mouses over the icon in Google Earth.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setNormalStyle(normalStyle: typingsSlinky.googleEarth.google.earth.KmlStyle): Unit = js.native
  /**
    * Defines a normal style for a placemark.
    */
  /* CompleteClass */
  ...
  override def setStyle(
    normalStyle: typingsSlinky.googleEarth.google.earth.KmlStyle,
    highlightStyle: typingsSlinky.googleEarth.google.earth.KmlStyle
  ): Unit = js.native
  /**
