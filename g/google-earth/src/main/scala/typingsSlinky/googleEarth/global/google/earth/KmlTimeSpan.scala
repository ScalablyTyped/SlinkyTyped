...
@js.native
class KmlTimeSpan ()
  extends typingsSlinky.googleEarth.google.earth.KmlTimeSpan {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBegin(): typingsSlinky.googleEarth.google.earth.KmlDateTime = js.native
  /**
    * Describes the ending instant of a time period.
    * If absent, the end of the period is unbounded.
    */
  /* CompleteClass */
  override def getEnd(): typingsSlinky.googleEarth.google.earth.KmlDateTime = js.native
  /**
