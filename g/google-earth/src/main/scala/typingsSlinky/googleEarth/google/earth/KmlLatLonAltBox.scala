...
object KmlLatLonAltBox {
  ...
  implicit class KmlLatLonAltBoxOps[Self <: KmlLatLonAltBox] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetMaxAltitude(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMaxAltitude")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetMinAltitude(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMinAltitude")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetAltBox(value: (Double, Double, Double, Double, Double, Double, Double, KmlAltitudeModeEnum) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setAltBox")(js.Any.fromFunction8(value))
        ret
    }
    @scala.inline
    def withSetAltitudeMode(value: KmlAltitudeModeEnum => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setAltitudeMode")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetMaxAltitude(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setMaxAltitude")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetMinAltitude(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setMinAltitude")(js.Any.fromFunction1(value))
        ret
    }
  }
