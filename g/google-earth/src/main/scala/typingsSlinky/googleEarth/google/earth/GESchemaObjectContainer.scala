...
object GESchemaObjectContainer {
  @scala.inline
  def apply[/* <: typingsSlinky.googleEarth.google.earth.KmlObject */ T](
    appendChild: T => Unit,
  ...
  @scala.inline
  implicit class GESchemaObjectContainerOps[Self <: GESchemaObjectContainer[_], /* <: typingsSlinky.googleEarth.google.earth.KmlObject */ T] (val x: Self with GESchemaObjectContainer[T]) extends AnyVal {
    @scala.inline
