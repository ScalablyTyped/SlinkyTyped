...
object GEHtmlDivBalloon {
  ...
  implicit class GEHtmlDivBalloonOps[Self <: GEHtmlDivBalloon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetContentDiv(value: () => HTMLDivElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getContentDiv")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetContentDiv(value: HTMLElement => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setContentDiv")(js.Any.fromFunction1(value))
        ret
    }
  }
