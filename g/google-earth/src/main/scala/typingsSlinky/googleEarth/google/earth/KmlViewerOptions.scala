...
object KmlViewerOptions {
  ...
  implicit class KmlViewerOptionsOps[Self <: KmlViewerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetOption(value: GEViewerOptionsValueEnum => GEViewerOptionsValueEnum): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOption")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetOption(value: (GEViewerOptionsTypeEnum, GEViewerOptionsValueEnum) => Unit): Self = {
        val ret = this.duplicate
