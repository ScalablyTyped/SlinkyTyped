...
object KmlObjectList {
  @scala.inline
  def apply[/* <: typingsSlinky.googleEarth.google.earth.KmlObject */ T](getLength: () => Double, item: Double => T): KmlObjectList[T] = {
  ...
  @scala.inline
  implicit class KmlObjectListOps[Self <: KmlObjectList[_], /* <: typingsSlinky.googleEarth.google.earth.KmlObject */ T] (val x: Self with KmlObjectList[T]) extends AnyVal {
    @scala.inline
