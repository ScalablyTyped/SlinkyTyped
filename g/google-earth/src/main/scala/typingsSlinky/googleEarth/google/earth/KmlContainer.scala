...
object KmlContainer {
  ...
  implicit class KmlContainerOps[Self <: KmlContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetElementsByType(value: String => KmlObjectList[KmlObject]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getElementsByType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
