...
object KmlDocument {
  ...
  implicit class KmlDocumentOps[Self <: KmlDocument] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetElementsByStyleUrl(value: String => KmlObjectList[KmlObject]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getElementsByStyleUrl")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetStyleSelectors(value: () => GEStyleSelectorContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStyleSelectors")(js.Any.fromFunction0(value))
        ret
    }
  }
