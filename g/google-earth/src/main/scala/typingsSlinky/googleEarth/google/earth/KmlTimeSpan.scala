...
object KmlTimeSpan {
  ...
  implicit class KmlTimeSpanOps[Self <: KmlTimeSpan] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetBegin(value: () => KmlDateTime): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getBegin")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetEnd(value: () => KmlDateTime): Self = {
        val ret = this.duplicate
