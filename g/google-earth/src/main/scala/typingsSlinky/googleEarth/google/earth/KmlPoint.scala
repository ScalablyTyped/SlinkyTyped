...
object KmlPoint {
  ...
  implicit class KmlPointOps[Self <: KmlPoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSet(value: (Double, Double, Double, KmlAltitudeModeEnum, Boolean, Boolean) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetLatLng(value: (Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setLatLng")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
