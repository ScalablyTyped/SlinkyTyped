...
object KmlLineString {
  ...
  implicit class KmlLineStringOps[Self <: KmlLineString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAltitudeOffset(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAltitudeOffset")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetCoordinates(value: () => KmlCoordArray): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCoordinates")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetAltitudeOffset(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setAltitudeOffset")(js.Any.fromFunction1(value))
        ret
    }
  }
