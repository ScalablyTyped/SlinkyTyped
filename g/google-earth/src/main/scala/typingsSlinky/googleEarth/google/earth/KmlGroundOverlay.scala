...
object KmlGroundOverlay {
  ...
  implicit class KmlGroundOverlayOps[Self <: KmlGroundOverlay] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetLatLonBox(value: () => KmlLatLonBox): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLatLonBox")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetLatLonBox(value: KmlLatLonBox => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setLatLonBox")(js.Any.fromFunction1(value))
        ret
    }
  }
