...
import typingsSlinky.glidejsGlide.mod.Events
import typingsSlinky.glidejsGlide.mod.Type
import typingsSlinky.glidejsGlide.mod._Pattern
...
object glidejsGlideStrings {
  ...
  @js.native
  sealed trait rtr extends js.Object
