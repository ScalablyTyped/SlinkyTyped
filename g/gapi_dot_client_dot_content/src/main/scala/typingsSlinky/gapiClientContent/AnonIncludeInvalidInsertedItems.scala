...
@js.native
trait AnonIncludeInvalidInsertedItems extends js.Object {
...
object AnonIncludeInvalidInsertedItems {
  @scala.inline
  def apply(merchantId: String): AnonIncludeInvalidInsertedItems = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIncludeInvalidInsertedItems]
  }
  @scala.inline
  implicit class AnonIncludeInvalidInsertedItemsOps[Self <: AnonIncludeInvalidInsertedItems] (val x: Self) extends AnyVal {
    @scala.inline
