...
@js.native
trait DatafeedId extends js.Object {
...
object DatafeedId {
  @scala.inline
  def apply(datafeedId: String, merchantId: String): DatafeedId = {
    val __obj = js.Dynamic.literal(datafeedId = datafeedId.asInstanceOf[js.Any], merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DatafeedId]
  }
  @scala.inline
  implicit class DatafeedIdOps[Self <: DatafeedId] (val x: Self) extends AnyVal {
    @scala.inline
