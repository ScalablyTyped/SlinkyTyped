...
@js.native
trait MerchantOrderId extends js.Object {
  ...
  var merchantOrderId: String = js.native
...
object MerchantOrderId {
  @scala.inline
  def apply(merchantId: String, merchantOrderId: String): MerchantOrderId = {
    ...
    __obj.asInstanceOf[MerchantOrderId]
  }
  @scala.inline
  implicit class MerchantOrderIdOps[Self <: MerchantOrderId] (val x: Self) extends AnyVal {
    @scala.inline
