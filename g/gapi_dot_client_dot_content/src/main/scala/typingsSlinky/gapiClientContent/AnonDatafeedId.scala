...
@js.native
trait AnonDatafeedId extends js.Object {
...
object AnonDatafeedId {
  @scala.inline
  def apply(datafeedId: String, merchantId: String): AnonDatafeedId = {
    val __obj = js.Dynamic.literal(datafeedId = datafeedId.asInstanceOf[js.Any], merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDatafeedId]
  }
  @scala.inline
  implicit class AnonDatafeedIdOps[Self <: AnonDatafeedId] (val x: Self) extends AnyVal {
    @scala.inline
