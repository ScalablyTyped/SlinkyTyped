...
object AnonMerchantOrderId {
  @scala.inline
  def apply(merchantId: String, merchantOrderId: String): AnonMerchantOrderId = {
  ...
  @scala.inline
  implicit class AnonMerchantOrderIdOps[Self <: AnonMerchantOrderId] (val x: Self) extends AnyVal {
    @scala.inline
