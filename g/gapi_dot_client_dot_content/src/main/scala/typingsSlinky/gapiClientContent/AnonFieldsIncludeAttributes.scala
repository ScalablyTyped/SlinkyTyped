...
@js.native
trait AnonFieldsIncludeAttributes extends js.Object {
...
object AnonFieldsIncludeAttributes {
  @scala.inline
  def apply(merchantId: String, productId: String): AnonFieldsIncludeAttributes = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any], productId = productId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFieldsIncludeAttributes]
  }
  @scala.inline
  implicit class AnonFieldsIncludeAttributesOps[Self <: AnonFieldsIncludeAttributes] (val x: Self) extends AnyVal {
    @scala.inline
