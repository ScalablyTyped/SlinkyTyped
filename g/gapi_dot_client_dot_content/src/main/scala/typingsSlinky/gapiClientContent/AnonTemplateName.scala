...
@js.native
trait AnonTemplateName extends js.Object {
...
object AnonTemplateName {
  @scala.inline
  def apply(merchantId: String, templateName: String): AnonTemplateName = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any], templateName = templateName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonTemplateName]
  }
  @scala.inline
  implicit class AnonTemplateNameOps[Self <: AnonTemplateName] (val x: Self) extends AnyVal {
    @scala.inline
