...
@js.native
trait AnonMerchantId extends js.Object {
...
object AnonMerchantId {
  @scala.inline
  def apply(merchantId: String): AnonMerchantId = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonMerchantId]
  }
  @scala.inline
  implicit class AnonMerchantIdOps[Self <: AnonMerchantId] (val x: Self) extends AnyVal {
    @scala.inline
