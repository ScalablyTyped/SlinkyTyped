...
object OrderPromotion {
  ...
  implicit class OrderPromotionOps[Self <: OrderPromotion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBenefitsVarargs(value: OrderPromotionBenefit*): Self = this.set("benefits", js.Array(value :_*))
    
    @scala.inline
    def setBenefits(value: js.Array[OrderPromotionBenefit]): Self = this.set("benefits", value.asInstanceOf[js.Any])
