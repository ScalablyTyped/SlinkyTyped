...
object OrdersListResponse {
  ...
  implicit class OrdersListResponseOps[Self <: OrdersListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourcesVarargs(value: Order*): Self = this.set("resources", js.Array(value :_*))
    
    @scala.inline
    def setResources(value: js.Array[Order]): Self = this.set("resources", value.asInstanceOf[js.Any])
