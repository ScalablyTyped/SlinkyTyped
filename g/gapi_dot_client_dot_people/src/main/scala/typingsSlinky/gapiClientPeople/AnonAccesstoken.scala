...
import typingsSlinky.gapiClientPeople.gapi.client.people.ModifyContactGroupMembersRequest
...
object AnonAccesstoken {
  @scala.inline
  def apply(resource: ModifyContactGroupMembersRequest, resourceName: String): AnonAccesstoken = {
  ...
  implicit class AnonAccesstokenOps[Self <: AnonAccesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: ModifyContactGroupMembersRequest): Self = {
