...
@js.native
trait AnonRequestMaskincludeField extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonRequestMaskincludeField {
  @scala.inline
  def apply(resourceName: String): AnonRequestMaskincludeField = {
    val __obj = js.Dynamic.literal(resourceName = resourceName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonRequestMaskincludeField]
  }
  @scala.inline
  implicit class AnonRequestMaskincludeFieldOps[Self <: AnonRequestMaskincludeField] (val x: Self) extends AnyVal {
    @scala.inline
