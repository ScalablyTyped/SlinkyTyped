...
trait DeleteContacts extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object DeleteContacts {
  ...
  def apply(
    ...
    deleteContacts: js.UndefOr[Boolean] = js.undefined,
    fields: String = null,
    key: String = null,
    ...
    if (!js.isUndefined(deleteContacts)) __obj.updateDynamic("deleteContacts")(deleteContacts.get.asInstanceOf[js.Any])
