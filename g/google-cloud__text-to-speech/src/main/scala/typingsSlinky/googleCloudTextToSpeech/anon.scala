...
import typingsSlinky.googleCloudTextToSpeech.v1Mod.TextToSpeechClient
...
object anon {
  ...
  trait TypeofTextToSpeechClientInstantiable
    extends Instantiable0[typingsSlinky.googleCloudTextToSpeech.v1beta1Mod.TextToSpeechClient]
       with Instantiable1[
          /* opts */ ClientOptions, 
          typingsSlinky.googleCloudTextToSpeech.v1beta1Mod.TextToSpeechClient
        ] {
