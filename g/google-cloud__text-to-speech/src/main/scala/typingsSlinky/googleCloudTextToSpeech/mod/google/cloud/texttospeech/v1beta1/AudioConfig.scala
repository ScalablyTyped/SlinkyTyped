...
object AudioConfig {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.create")
  @js.native
  ...
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array): AudioConfig = js.native
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): AudioConfig = js.native
  /**
  ...
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.decodeDelimited")
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): AudioConfig = js.native
  /**
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.fromObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.toObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.AudioConfig.verify")
  @js.native
