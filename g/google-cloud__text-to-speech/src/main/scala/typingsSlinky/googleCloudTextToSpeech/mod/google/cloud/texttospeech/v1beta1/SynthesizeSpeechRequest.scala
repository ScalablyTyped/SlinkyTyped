...
import typingsSlinky.googleCloudTextToSpeech.mod.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType
...
object SynthesizeSpeechRequest {
  ...
  object TimepointType extends StObject {
    ...
    /* 1 */ val SSML_MARK: typingsSlinky.googleCloudTextToSpeech.mod.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType.SSML_MARK with Double = js.native
    
    @js.native
    sealed trait TIMEPOINT_TYPE_UNSPECIFIED extends TimepointType
    /* 0 */ val TIMEPOINT_TYPE_UNSPECIFIED: typingsSlinky.googleCloudTextToSpeech.mod.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType.TIMEPOINT_TYPE_UNSPECIFIED with Double = js.native
  }
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): SynthesizeSpeechRequest = js.native
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SynthesizeSpeechRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): SynthesizeSpeechRequest = js.native
  /**
