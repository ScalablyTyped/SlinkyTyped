...
import typingsSlinky.googleCloudTextToSpeech.mod.google.cloud.texttospeech.v1.TextToSpeech.ListVoicesCallback
import typingsSlinky.googleCloudTextToSpeech.mod.google.cloud.texttospeech.v1.TextToSpeech.SynthesizeSpeechCallback
