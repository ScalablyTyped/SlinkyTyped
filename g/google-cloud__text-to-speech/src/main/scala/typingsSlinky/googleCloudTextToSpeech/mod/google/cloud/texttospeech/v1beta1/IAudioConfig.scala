...
trait IAudioConfig extends StObject {
  ...
  var audioEncoding: js.UndefOr[
    AudioEncoding | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.texttospeech.v1beta1.AudioEncoding * / any */ String) | Null
  ] = js.native
...
object IAudioConfig {
  ...
  implicit class IAudioConfigMutableBuilder[Self <: IAudioConfig] (val x: Self) extends AnyVal {
    ...
    def setAudioEncoding(
      value: AudioEncoding | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.texttospeech.v1beta1.AudioEncoding * / any */ String)
