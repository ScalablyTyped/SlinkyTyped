...
object ListVoicesRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ListVoicesRequest = js.native
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.ListVoicesRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListVoicesRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListVoicesRequest = js.native
  /**
