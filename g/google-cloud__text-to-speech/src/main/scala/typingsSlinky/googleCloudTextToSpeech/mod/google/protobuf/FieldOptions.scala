package typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.CType
import typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.JSType
...
object FieldOptions {
  ...
  object CType extends StObject {
    ...
    /* 1 */ val CORD: typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.CType.CORD with Double = js.native
    
    @js.native
    sealed trait STRING extends CType
    /* 0 */ val STRING: typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.CType.STRING with Double = js.native
    
    @js.native
    sealed trait STRING_PIECE extends CType
    /* 2 */ val STRING_PIECE: typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.CType.STRING_PIECE with Double = js.native
  }
  ...
  object JSType extends StObject {
    ...
    /* 0 */ val JS_NORMAL: typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.JSType.JS_NORMAL with Double = js.native
    
    @js.native
    sealed trait JS_NUMBER extends JSType
    /* 2 */ val JS_NUMBER: typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.JSType.JS_NUMBER with Double = js.native
    
    @js.native
    sealed trait JS_STRING extends JSType
    /* 1 */ val JS_STRING: typingsSlinky.googleCloudTextToSpeech.mod.google.protobuf.FieldOptions.JSType.JS_STRING with Double = js.native
  }
