...
object Timepoint {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): Timepoint = js.native
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.Timepoint.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Timepoint = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): Timepoint = js.native
  /**
