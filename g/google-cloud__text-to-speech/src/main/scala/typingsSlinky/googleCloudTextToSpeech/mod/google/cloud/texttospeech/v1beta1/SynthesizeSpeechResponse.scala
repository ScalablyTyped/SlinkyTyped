...
object SynthesizeSpeechResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): SynthesizeSpeechResponse = js.native
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1beta1.SynthesizeSpeechResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SynthesizeSpeechResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): SynthesizeSpeechResponse = js.native
  /**
