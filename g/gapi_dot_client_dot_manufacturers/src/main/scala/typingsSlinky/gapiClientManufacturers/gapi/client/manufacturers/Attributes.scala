...
object Attributes {
  ...
  implicit class AttributesOps[Self <: Attributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetAccountId(value: String): Self = this.set("targetAccountId", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTargetAccountId: Self = this.set("targetAccountId", js.undefined)
    @scala.inline
