package typingsSlinky.gapiDotAuth2.gapi.auth2

import typingsSlinky.gapiDotAuth2.gapiDotAuth2Strings.popup
import typingsSlinky.gapiDotAuth2.gapiDotAuth2Strings.redirect
