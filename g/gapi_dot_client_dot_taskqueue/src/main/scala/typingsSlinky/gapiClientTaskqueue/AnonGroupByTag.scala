...
object AnonGroupByTag {
  @scala.inline
  def apply(leaseSecs: Double, numTasks: Double, project: String, taskqueue: String): AnonGroupByTag = {
  ...
  @scala.inline
  implicit class AnonGroupByTagOps[Self <: AnonGroupByTag] (val x: Self) extends AnyVal {
    @scala.inline
