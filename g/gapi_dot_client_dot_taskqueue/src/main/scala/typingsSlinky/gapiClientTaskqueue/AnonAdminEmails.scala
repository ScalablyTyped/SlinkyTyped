...
@js.native
trait AnonAdminEmails extends js.Object {
...
object AnonAdminEmails {
  @scala.inline
  def apply(): AnonAdminEmails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAdminEmails]
  }
  @scala.inline
  implicit class AnonAdminEmailsOps[Self <: AnonAdminEmails] (val x: Self) extends AnyVal {
    @scala.inline
