...
object AnonFields {
  @scala.inline
  def apply(project: String, task: String, taskqueue: String): AnonFields = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], task = task.asInstanceOf[js.Any], taskqueue = taskqueue.asInstanceOf[js.Any])
