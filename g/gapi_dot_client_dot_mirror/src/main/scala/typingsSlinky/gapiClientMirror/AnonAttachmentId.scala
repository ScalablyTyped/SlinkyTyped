...
@js.native
trait AnonAttachmentId extends js.Object {
...
object AnonAttachmentId {
  @scala.inline
  def apply(attachmentId: String, itemId: String): AnonAttachmentId = {
    val __obj = js.Dynamic.literal(attachmentId = attachmentId.asInstanceOf[js.Any], itemId = itemId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAttachmentId]
  }
  @scala.inline
  implicit class AnonAttachmentIdOps[Self <: AnonAttachmentId] (val x: Self) extends AnyVal {
    @scala.inline
