...
object AnonAccountName {
  @scala.inline
  def apply(accountName: String, accountType: String, userToken: String): AnonAccountName = {
  ...
  @scala.inline
  implicit class AnonAccountNameOps[Self <: AnonAccountName] (val x: Self) extends AnyVal {
    @scala.inline
