...
@js.native
trait AnonItemId extends js.Object {
...
object AnonItemId {
  @scala.inline
  def apply(itemId: String): AnonItemId = {
    val __obj = js.Dynamic.literal(itemId = itemId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonItemId]
  }
  @scala.inline
  implicit class AnonItemIdOps[Self <: AnonItemId] (val x: Self) extends AnyVal {
    @scala.inline
