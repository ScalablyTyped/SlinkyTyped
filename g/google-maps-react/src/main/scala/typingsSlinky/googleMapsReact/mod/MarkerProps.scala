...
trait MarkerProps extends js.Object {
  ...
  var map: js.UndefOr[typingsSlinky.googlemaps.google.maps.Map[Element] | StreetViewPanorama] = js.undefined
...
object MarkerProps {
  ...
  def apply(
    ...
    map: typingsSlinky.googlemaps.google.maps.Map[Element] | StreetViewPanorama = null,
    mapCenter: LatLng | LatLngLiteral = null,
    onClick: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onDblclick: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onDragend: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMousedown: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMouseout: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMouseover: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMouseup: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onRecenter: (/* props */ js.UndefOr[MarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
