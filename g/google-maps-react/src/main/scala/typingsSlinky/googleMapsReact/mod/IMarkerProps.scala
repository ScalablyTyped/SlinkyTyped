...
object IMarkerProps {
  ...
  def apply(
    ...
    onClick: (/* props */ js.UndefOr[IMarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMouseover: (/* props */ js.UndefOr[IMarkerProps], /* marker */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Marker], /* event */ js.UndefOr[js.Any]) => js.Any = null,
