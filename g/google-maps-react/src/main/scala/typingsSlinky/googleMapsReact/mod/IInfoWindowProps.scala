...
object IInfoWindowProps {
  ...
  implicit class IInfoWindowPropsOps[Self <: IInfoWindowProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMap(value: typingsSlinky.googlemaps.google.maps.Map[Element]): Self = this.set("map", value.asInstanceOf[js.Any])
    @scala.inline
    def setMarker(value: typingsSlinky.googlemaps.google.maps.Marker): Self = this.set("marker", value.asInstanceOf[js.Any])
    @scala.inline
