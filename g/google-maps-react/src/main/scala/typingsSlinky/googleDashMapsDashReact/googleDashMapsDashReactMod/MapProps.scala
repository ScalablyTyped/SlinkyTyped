...
object MapProps {
  ...
  def apply(
    ...
    onBoundsChanged: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onCenterChanged: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onClick: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onDblclick: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onDragend: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onDragstart: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onHeadingChange: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onIdle: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMaptypeidChanged: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMousemove: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMouseout: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onMouseover: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onProjectionChanged: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onReady: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onRecenter: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onResize: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onRightclick: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onTilesloaded: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onTiltChanged: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
    onZoomChanged: (/* mapProps */ js.UndefOr[MapProps], /* map */ js.UndefOr[typingsSlinky.googlemaps.google.maps.Map], /* event */ js.UndefOr[js.Any]) => js.Any = null,
