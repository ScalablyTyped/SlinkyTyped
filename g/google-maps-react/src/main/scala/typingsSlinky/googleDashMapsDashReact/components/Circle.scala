package typingsSlinky.googleDashMapsDashReact.components
...
object Circle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.googleDashMapsDashReact.googleDashMapsDashReactMod.Circle] {
