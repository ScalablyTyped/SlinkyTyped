...
import typingsSlinky.googleDashMapsDashReact.googleDashMapsDashReactMod.GoogleAPI
import typingsSlinky.googleDashMapsDashReact.googleDashMapsDashReactMod.MapProps
...
object Map
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.googleDashMapsDashReact.googleDashMapsDashReactMod.Map] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.googleDashMapsDashReact.googleDashMapsDashReactMod.Map] = {
