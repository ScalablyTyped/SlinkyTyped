...
object LogEntry {
  ...
  implicit class LogEntryOps[Self <: LogEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHttpRequest(value: HttpRequest): Self = {
    ...
    @scala.inline
    def withJsonPayload(value: Record[String, _]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOperation(value: LogEntryOperation): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSourceLocation(value: LogEntrySourceLocation): Self = {
        val ret = this.duplicate
