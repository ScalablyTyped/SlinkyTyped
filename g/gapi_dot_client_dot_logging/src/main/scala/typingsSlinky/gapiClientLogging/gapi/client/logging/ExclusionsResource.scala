...
import typingsSlinky.gapiClientLogging.anon.Alt
import typingsSlinky.gapiClientLogging.anon.Bearertoken
import typingsSlinky.gapiClientLogging.anon.Callback
...
object ExclusionsResource {
  ...
  implicit class ExclusionsResourceOps[Self <: ExclusionsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: Accesstoken => Request[LogExclusion]): Self = {
    ...
    @scala.inline
    def withGet(value: Alt => Request[LogExclusion]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: Bearertoken => Request[ListExclusionsResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: Callback => Request[LogExclusion]): Self = {
        val ret = this.duplicate
