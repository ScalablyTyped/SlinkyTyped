package typingsSlinky.gapiClientLogging.anon
...
@js.native
trait MetricName extends js.Object {
...
object MetricName {
  ...
  @scala.inline
  def apply(metricName: String): MetricName = {
    val __obj = js.Dynamic.literal(metricName = metricName.asInstanceOf[js.Any])
    __obj.asInstanceOf[MetricName]
  }
  
  @scala.inline
  implicit class MetricNameOps[Self <: MetricName] (val x: Self) extends AnyVal {
