package typingsSlinky.gapiClientPagespeedonline.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientPagespeedonline.gapiClientPagespeedonlineStrings.pagespeedonline,
    version: v2
