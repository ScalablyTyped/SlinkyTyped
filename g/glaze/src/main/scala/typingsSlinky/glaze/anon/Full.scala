...
import typingsSlinky.glaze.glazeNumbers.`9999`
import typingsSlinky.glaze.glazeStrings.Dot125rem
import typingsSlinky.glaze.glazeStrings.Dot25rem
import typingsSlinky.glaze.glazeStrings.Dot5rem
