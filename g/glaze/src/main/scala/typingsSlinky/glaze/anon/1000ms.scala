...
import typingsSlinky.glaze.glazeStrings.Dot15s
import typingsSlinky.glaze.glazeStrings.Dot1s
import typingsSlinky.glaze.glazeStrings.Dot2s
import typingsSlinky.glaze.glazeStrings.Dot3s
import typingsSlinky.glaze.glazeStrings.Dot5s
import typingsSlinky.glaze.glazeStrings.Dot7s
import typingsSlinky.glaze.glazeStrings.`1s`
import typingsSlinky.glaze.glazeStrings.`75ms`
...
trait `1000ms` extends js.Object {
  ...
  val `75ms`: typingsSlinky.glaze.glazeStrings.`75ms` = js.native
}
object `1000ms` {
