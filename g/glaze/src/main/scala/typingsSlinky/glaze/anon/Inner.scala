...
object Inner {
  ...
  @scala.inline
  implicit class InnerMutableBuilder[Self <: Inner] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setInner(value: `inset 0 2px 4px 0 rgbaLeftparenthesis0Comma0Comma0CommaDot06Rightparenthesis`): Self = StObject.set(x, "inner", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOutline(value: `0 0 0 3px rgbaLeftparenthesis66Comma153Comma225CommaDot5Rightparenthesis`): Self = StObject.set(x, "outline", value.asInstanceOf[js.Any])
