...
import typingsSlinky.glaze.glazeStrings.`0 0 0 3px rgbaLeftparenthesis66Comma153Comma225CommaDot5Rightparenthesis`
import typingsSlinky.glaze.glazeStrings.`0 10px 15px -3px rgbaLeftparenthesis0Comma0Comma0CommaDot1RightparenthesisComma0 4px 6px -2px rgbaLeftparenthesis0Comma0Comma0CommaDot05Rightparenthesis`
import typingsSlinky.glaze.glazeStrings.`0 1px 3px 0 rgbaLeftparenthesis0Comma0Comma0CommaDot1RightparenthesisComma0 1px 2px 0 rgbaLeftparenthesis0Comma0Comma0CommaDot06Rightparenthesis`
import typingsSlinky.glaze.glazeStrings.`0 20px 25px -5px rgbaLeftparenthesis0Comma0Comma0CommaDot1RightparenthesisComma0 10px 10px -5px rgbaLeftparenthesis0Comma0Comma0CommaDot04Rightparenthesis`
import typingsSlinky.glaze.glazeStrings.`0 4px 6px -1px rgbaLeftparenthesis0Comma0Comma0CommaDot1RightparenthesisComma0 2px 4px -1px rgbaLeftparenthesis0Comma0Comma0CommaDot06Rightparenthesis`
import typingsSlinky.glaze.glazeStrings.`inset 0 2px 4px 0 rgbaLeftparenthesis0Comma0Comma0CommaDot06Rightparenthesis`
...
object Inner {
  ...
  @scala.inline
  implicit class InnerOps[Self <: Inner] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInner(value: `inset 0 2px 4px 0 rgbaLeftparenthesis0Comma0Comma0CommaDot06Rightparenthesis`): Self = this.set("inner", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("lg", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("md", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOutline(value: `0 0 0 3px rgbaLeftparenthesis66Comma153Comma225CommaDot5Rightparenthesis`): Self = this.set("outline", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("sm", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("xl", value.asInstanceOf[js.Any])
  }
}
