...
import typingsSlinky.glaze.glazeStrings.scales
...
@js.native
trait propertyinkeyofCSSPropert extends js.Object {
...
object propertyinkeyofCSSPropert {
  ...
  @scala.inline
  def apply(): propertyinkeyofCSSPropert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[propertyinkeyofCSSPropert]
  }
  
  @scala.inline
  implicit class propertyinkeyofCSSPropertOps[Self <: propertyinkeyofCSSPropert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWebkitRubyPosition(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: keyof this['scales'] */ js.Any) | Tokens[scales]
    ): Self = this.set("WebkitRubyPosition", value.asInstanceOf[js.Any])
    ...
    def setAzimuth(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: keyof this['scales'] */ js.Any) | Tokens[scales]
    ): Self = this.set("azimuth", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMsJustifySelf(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: keyof this['scales'] */ js.Any) | Tokens[scales]
    ): Self = this.set("msJustifySelf", value.asInstanceOf[js.Any])
