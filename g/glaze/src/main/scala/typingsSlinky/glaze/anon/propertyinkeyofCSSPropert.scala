...
object propertyinkeyofCSSPropert {
  ...
  @scala.inline
  implicit class propertyinkeyofCSSPropertMutableBuilder[Self <: propertyinkeyofCSSPropert] (val x: Self) extends AnyVal {
    ...
    def setTextCombineHorizontal(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: keyof this['scales'] */ js.Any) | Tokens[scales]
    ): Self = StObject.set(x, "textCombineHorizontal", value.asInstanceOf[js.Any])
