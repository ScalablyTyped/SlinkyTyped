...
import typingsSlinky.glaze.glazeStrings.Dot025em
import typingsSlinky.glaze.glazeStrings.Dot05em
import typingsSlinky.glaze.glazeStrings.Dot1em
import typingsSlinky.glaze.glazeStrings.`-0Dot025em`
import typingsSlinky.glaze.glazeStrings.`-0Dot05em`
...
trait Normal extends StObject {
  ...
  val normal: typingsSlinky.glaze.glazeNumbers.`0` = js.native
...
object Normal {
  ...
  @scala.inline
  def apply(
    normal: typingsSlinky.glaze.glazeNumbers.`0`,
    tight: `-0Dot025em`,
    tighter: `-0Dot05em`,
    wide: Dot025em,
    wider: Dot05em,
  ...
  implicit class NormalMutableBuilder[Self <: Normal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNormal(value: typingsSlinky.glaze.glazeNumbers.`0`): Self = StObject.set(x, "normal", value.asInstanceOf[js.Any])
