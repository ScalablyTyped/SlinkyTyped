...
object Base {
  ...
  implicit class BaseOps[Self <: Base] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set1(value: typingsSlinky.glaze.glazeNumbers.`1`): Self = this.set("1", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBase(value: `1.5`): Self = this.set("base", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLoose(value: typingsSlinky.glaze.glazeNumbers.`2`): Self = this.set("loose", value.asInstanceOf[js.Any])
