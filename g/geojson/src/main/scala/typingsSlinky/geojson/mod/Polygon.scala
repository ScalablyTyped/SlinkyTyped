...
trait Polygon
  ...
  @JSName("type")
  var type_Polygon: typingsSlinky.geojson.geojsonStrings.Polygon
}
...
object Polygon {
  ...
  implicit class PolygonOps[Self <: Polygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.geojson.geojsonStrings.Polygon): Self = this.set("type", value.asInstanceOf[js.Any])
  }
