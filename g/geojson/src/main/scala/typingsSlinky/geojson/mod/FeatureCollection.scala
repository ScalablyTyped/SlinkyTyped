...
trait FeatureCollection[G /* <: Geometry | Null */, P] extends GeoJsonObject {
  ...
  @JSName("type")
  var type_FeatureCollection: typingsSlinky.geojson.geojsonStrings.FeatureCollection
}

object FeatureCollection {
  @scala.inline
  def apply[/* <: typingsSlinky.geojson.mod.Geometry | scala.Null */ G, P](features: js.Array[Feature[G, P]], `type`: typingsSlinky.geojson.geojsonStrings.FeatureCollection): FeatureCollection[G, P] = {
    val __obj = js.Dynamic.literal(features = features.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[FeatureCollection[G, P]]
  }
  @scala.inline
  implicit class FeatureCollectionOps[Self <: FeatureCollection[_, _], /* <: typingsSlinky.geojson.mod.Geometry | scala.Null */ G, P] (val x: Self with (FeatureCollection[G, P])) extends AnyVal {
    @scala.inline
