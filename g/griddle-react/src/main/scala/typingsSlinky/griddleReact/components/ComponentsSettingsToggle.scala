...
object ComponentsSettingsToggle {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, SettingsToggle] {
    @scala.inline
  ...
  implicit def make(companion: ComponentsSettingsToggle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
