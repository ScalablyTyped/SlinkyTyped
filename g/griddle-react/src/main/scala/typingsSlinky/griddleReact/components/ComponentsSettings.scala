...
object ComponentsSettings {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, Settings] {
    @scala.inline
  ...
  implicit def make(companion: ComponentsSettings.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
