...
object ComponentsTableHeadingCell {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, TableHeadingCell] {
    @scala.inline
  ...
  implicit def make(companion: ComponentsTableHeadingCell.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
