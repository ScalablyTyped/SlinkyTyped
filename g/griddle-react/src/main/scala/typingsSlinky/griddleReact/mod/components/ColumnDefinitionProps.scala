...
object ColumnDefinitionProps {
  ...
  implicit class ColumnDefinitionPropsMutableBuilder[Self <: ColumnDefinitionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomComponentComponentClass(value: ReactComponentClass[CellProps with js.Any]): Self = StObject.set(x, "customComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomComponentFunctionComponent(value: ReactComponentClass[CellProps with js.Any]): Self = StObject.set(x, "customComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCustomHeadingComponentComponentClass(value: ReactComponentClass[TableHeadingCellProps with js.Any]): Self = StObject.set(x, "customHeadingComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomHeadingComponentFunctionComponent(value: ReactComponentClass[TableHeadingCellProps with js.Any]): Self = StObject.set(x, "customHeadingComponent", value.asInstanceOf[js.Any])
