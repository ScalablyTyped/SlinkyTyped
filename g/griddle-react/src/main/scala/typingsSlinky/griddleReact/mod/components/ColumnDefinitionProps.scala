...
object ColumnDefinitionProps {
  ...
  implicit class ColumnDefinitionPropsOps[Self <: ColumnDefinitionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomComponentFunctionComponent(value: ReactComponentClass[CellProps with js.Any]): Self = this.set("customComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomComponentComponentClass(value: ReactComponentClass[CellProps with js.Any]): Self = this.set("customComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCustomHeadingComponentFunctionComponent(value: ReactComponentClass[TableHeadingCellProps with js.Any]): Self = this.set("customHeadingComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomHeadingComponentComponentClass(value: ReactComponentClass[TableHeadingCellProps with js.Any]): Self = this.set("customHeadingComponent", value.asInstanceOf[js.Any])
    @scala.inline
