...
import typingsSlinky.griddleDashReact.griddleDashReactMod.components.RowDefinition
...
object ComponentsRowDefinition
  ...
  typingsSlinky.griddleDashReact.griddleDashReactMod.components.RowDefinition](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
