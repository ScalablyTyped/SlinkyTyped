...
trait Anon_AltBlogIdEndDateFetchBodiesFetchImages extends js.Object {
...
object Anon_AltBlogIdEndDateFetchBodiesFetchImages {
  @scala.inline
  def apply(
    blogId: String,
    alt: String = null,
    ...
    userIp: String = null,
    view: String = null
  ): Anon_AltBlogIdEndDateFetchBodiesFetchImages = {
    ...
    __obj.asInstanceOf[Anon_AltBlogIdEndDateFetchBodiesFetchImages]
  }
}
