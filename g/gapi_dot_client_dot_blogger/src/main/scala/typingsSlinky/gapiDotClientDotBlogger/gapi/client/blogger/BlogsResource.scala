...
import typingsSlinky.gapiDotClientDotBlogger.Anon_AltBlogId
import typingsSlinky.gapiDotClientDotBlogger.Anon_AltFetchUserInfo
import typingsSlinky.gapiDotClientDotBlogger.Anon_AltFields
