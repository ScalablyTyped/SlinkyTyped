...
@js.native
trait AnonBlogId extends js.Object {
...
object AnonBlogId {
  @scala.inline
  def apply(blogId: String): AnonBlogId = {
    val __obj = js.Dynamic.literal(blogId = blogId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBlogId]
  }
  @scala.inline
  implicit class AnonBlogIdOps[Self <: AnonBlogId] (val x: Self) extends AnyVal {
    @scala.inline
