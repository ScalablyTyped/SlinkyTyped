...
@js.native
trait IsDraft extends js.Object {
...
object IsDraft {
  @scala.inline
  def apply(blogId: String): IsDraft = {
    val __obj = js.Dynamic.literal(blogId = blogId.asInstanceOf[js.Any])
    __obj.asInstanceOf[IsDraft]
  }
  @scala.inline
  implicit class IsDraftOps[Self <: IsDraft] (val x: Self) extends AnyVal {
    @scala.inline
