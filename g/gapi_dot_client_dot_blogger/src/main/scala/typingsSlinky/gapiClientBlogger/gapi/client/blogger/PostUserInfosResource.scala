...
import typingsSlinky.gapiClientBlogger.anon.Labels
import typingsSlinky.gapiClientBlogger.anon.MaxComments
...
object PostUserInfosResource {
  ...
  implicit class PostUserInfosResourceOps[Self <: PostUserInfosResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: MaxComments => Request[PostUserInfo]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: Labels => Request[PostUserInfosList]): Self = {
        val ret = this.duplicate
