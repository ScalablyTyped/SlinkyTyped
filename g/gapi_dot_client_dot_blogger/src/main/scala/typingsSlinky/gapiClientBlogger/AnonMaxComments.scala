...
@js.native
trait AnonMaxComments extends js.Object {
...
object AnonMaxComments {
  @scala.inline
  def apply(blogId: String, postId: String, userId: String): AnonMaxComments = {
    ...
    __obj.asInstanceOf[AnonMaxComments]
  }
  @scala.inline
  implicit class AnonMaxCommentsOps[Self <: AnonMaxComments] (val x: Self) extends AnyVal {
    @scala.inline
