...
object GCStatistics {
  ...
  implicit class GCStatisticsOps[Self <: GCStatistics] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAfter(value: MemoryStatistics): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("after")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBefore(value: MemoryStatistics): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("before")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDiff(value: MemoryStatistics): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGctype(value: `1` | `2` | `4` | `8` | `15`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gctype")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPauseMS(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pauseMS")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
