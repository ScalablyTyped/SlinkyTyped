...
trait Anon_AltBackendService extends js.Object {
...
object Anon_AltBackendService {
  ...
  def apply(
    ...
    userIp: String = null
  ): Anon_AltBackendService = {
    val __obj = js.Dynamic.literal(backendService = backendService.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[Anon_AltBackendService]
  }
}
