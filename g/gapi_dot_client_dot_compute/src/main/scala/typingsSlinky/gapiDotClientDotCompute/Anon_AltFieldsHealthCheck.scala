...
trait Anon_AltFieldsHealthCheck extends js.Object {
...
object Anon_AltFieldsHealthCheck {
  @scala.inline
  def apply(
    healthCheck: String,
    project: String,
    ...
    __obj.asInstanceOf[Anon_AltFieldsHealthCheck]
  }
}
