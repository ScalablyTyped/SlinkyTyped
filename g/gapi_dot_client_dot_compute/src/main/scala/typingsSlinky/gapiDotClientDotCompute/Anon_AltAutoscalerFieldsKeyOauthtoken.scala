...
trait Anon_AltAutoscalerFieldsKeyOauthtoken extends js.Object {
...
object Anon_AltAutoscalerFieldsKeyOauthtoken {
  @scala.inline
  def apply(
    autoscaler: String,
    project: String,
    ...
    userIp: String = null
  ): Anon_AltAutoscalerFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[Anon_AltAutoscalerFieldsKeyOauthtoken]
  }
}
