...
trait Anon_AltFieldsFilterInstanceGroup extends js.Object {
...
object Anon_AltFieldsFilterInstanceGroup {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): Anon_AltFieldsFilterInstanceGroup = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsFilterInstanceGroup]
  }
}
