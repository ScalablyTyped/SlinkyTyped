...
trait Anon_AltFieldsForceCreate extends js.Object {
...
object Anon_AltFieldsForceCreate {
  @scala.inline
  def apply(
    project: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AltFieldsForceCreate]
  }
}
