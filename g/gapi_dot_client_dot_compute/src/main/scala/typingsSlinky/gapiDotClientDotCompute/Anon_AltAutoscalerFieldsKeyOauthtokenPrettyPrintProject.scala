...
trait Anon_AltAutoscalerFieldsKeyOauthtokenPrettyPrintProject extends js.Object {
...
object Anon_AltAutoscalerFieldsKeyOauthtokenPrettyPrintProject {
  @scala.inline
  def apply(
    project: String,
    region: String,
    ...
    __obj.asInstanceOf[Anon_AltAutoscalerFieldsKeyOauthtokenPrettyPrintProject]
  }
}
