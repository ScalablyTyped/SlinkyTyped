...
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsHttpHealthCheck
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsHttpHealthCheckKey
