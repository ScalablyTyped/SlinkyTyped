...
import typingsSlinky.gapiDotClientDotCompute.Anon_AltAutoscaler
import typingsSlinky.gapiDotClientDotCompute.Anon_AltAutoscalerFields
import typingsSlinky.gapiDotClientDotCompute.Anon_AltAutoscalerFieldsKey
