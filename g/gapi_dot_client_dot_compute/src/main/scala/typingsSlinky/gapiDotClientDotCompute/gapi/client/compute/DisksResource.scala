...
import typingsSlinky.gapiDotClientDotCompute.Anon_AltDisk
import typingsSlinky.gapiDotClientDotCompute.Anon_AltDiskFields
import typingsSlinky.gapiDotClientDotCompute.Anon_AltDiskFieldsKey
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFields
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsKeyOauthtokenPrettyPrintProject
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser
