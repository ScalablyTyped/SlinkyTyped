...
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsHttpsHealthCheck
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsHttpsHealthCheckKey
