...
trait DiskTypeAggregatedList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  /** A list of DiskTypesScopedList resources. */
  var items: js.UndefOr[Record[String, DiskTypesScopedList]] = js.undefined
...
object DiskTypeAggregatedList {
  @scala.inline
  def apply(
    id: String = null,
    items: Record[String, DiskTypesScopedList] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[DiskTypeAggregatedList]
  }
}
