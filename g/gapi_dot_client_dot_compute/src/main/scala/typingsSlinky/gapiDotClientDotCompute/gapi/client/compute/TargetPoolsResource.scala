...
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFailoverRatio
...
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdTargetPool
import typingsSlinky.gapiDotClientDotCompute.Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionTargetPool
