...
trait Anon_AltFieldsHttpsHealthCheck extends js.Object {
...
object Anon_AltFieldsHttpsHealthCheck {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): Anon_AltFieldsHttpsHealthCheck = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsHttpsHealthCheck]
  }
}
