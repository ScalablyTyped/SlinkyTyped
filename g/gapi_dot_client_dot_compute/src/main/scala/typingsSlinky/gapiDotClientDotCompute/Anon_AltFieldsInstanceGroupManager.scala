...
trait Anon_AltFieldsInstanceGroupManager extends js.Object {
...
object Anon_AltFieldsInstanceGroupManager {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltFieldsInstanceGroupManager]
  }
}
