...
@js.native
trait AnonNetwork extends js.Object {
...
object AnonNetwork {
  @scala.inline
  def apply(network: String, project: String): AnonNetwork = {
    val __obj = js.Dynamic.literal(network = network.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonNetwork]
  }
  @scala.inline
  implicit class AnonNetworkOps[Self <: AnonNetwork] (val x: Self) extends AnyVal {
    @scala.inline
