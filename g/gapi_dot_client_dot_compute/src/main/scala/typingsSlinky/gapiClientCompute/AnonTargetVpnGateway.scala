...
object AnonTargetVpnGateway {
  @scala.inline
  def apply(project: String, region: String, targetVpnGateway: String): AnonTargetVpnGateway = {
  ...
  @scala.inline
  implicit class AnonTargetVpnGatewayOps[Self <: AnonTargetVpnGateway] (val x: Self) extends AnyVal {
    @scala.inline
