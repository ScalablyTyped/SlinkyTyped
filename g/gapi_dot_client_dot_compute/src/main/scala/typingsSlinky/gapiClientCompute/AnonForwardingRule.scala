...
@js.native
trait AnonForwardingRule extends js.Object {
...
object AnonForwardingRule {
  @scala.inline
  def apply(forwardingRule: String, project: String, region: String): AnonForwardingRule = {
    val __obj = js.Dynamic.literal(forwardingRule = forwardingRule.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonForwardingRule]
  }
  @scala.inline
  implicit class AnonForwardingRuleOps[Self <: AnonForwardingRule] (val x: Self) extends AnyVal {
    @scala.inline
