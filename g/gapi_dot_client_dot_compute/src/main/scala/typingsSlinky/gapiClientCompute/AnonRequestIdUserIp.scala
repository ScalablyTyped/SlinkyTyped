...
object AnonRequestIdUserIp {
  @scala.inline
  def apply(instanceGroup: String, project: String, region: String): AnonRequestIdUserIp = {
  ...
  @scala.inline
  implicit class AnonRequestIdUserIpOps[Self <: AnonRequestIdUserIp] (val x: Self) extends AnyVal {
    @scala.inline
