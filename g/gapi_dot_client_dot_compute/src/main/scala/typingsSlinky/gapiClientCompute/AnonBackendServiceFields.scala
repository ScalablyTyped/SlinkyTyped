...
@js.native
trait AnonBackendServiceFields extends js.Object {
...
object AnonBackendServiceFields {
  @scala.inline
  def apply(backendService: String, project: String, region: String): AnonBackendServiceFields = {
    ...
    __obj.asInstanceOf[AnonBackendServiceFields]
  }
  @scala.inline
  implicit class AnonBackendServiceFieldsOps[Self <: AnonBackendServiceFields] (val x: Self) extends AnyVal {
    @scala.inline
