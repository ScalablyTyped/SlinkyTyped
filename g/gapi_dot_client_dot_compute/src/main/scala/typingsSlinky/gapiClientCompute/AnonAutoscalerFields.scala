...
object AnonAutoscalerFields {
  @scala.inline
  def apply(autoscaler: String, project: String, region: String): AnonAutoscalerFields = {
  ...
  @scala.inline
  implicit class AnonAutoscalerFieldsOps[Self <: AnonAutoscalerFields] (val x: Self) extends AnyVal {
    @scala.inline
