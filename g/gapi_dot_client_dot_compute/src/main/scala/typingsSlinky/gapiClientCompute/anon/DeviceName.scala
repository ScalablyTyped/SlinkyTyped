...
@js.native
trait DeviceName extends js.Object {
...
object DeviceName {
  @scala.inline
  def apply(deviceName: String, instance: String, project: String, zone: String): DeviceName = {
    val __obj = js.Dynamic.literal(deviceName = deviceName.asInstanceOf[js.Any], instance = instance.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeviceName]
  }
  @scala.inline
  implicit class DeviceNameOps[Self <: DeviceName] (val x: Self) extends AnyVal {
    @scala.inline
