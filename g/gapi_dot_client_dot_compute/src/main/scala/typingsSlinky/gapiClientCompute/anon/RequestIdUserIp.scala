...
@js.native
trait RequestIdUserIp extends js.Object {
...
object RequestIdUserIp {
  @scala.inline
  def apply(instanceGroup: String, project: String, region: String): RequestIdUserIp = {
    ...
    __obj.asInstanceOf[RequestIdUserIp]
  }
  @scala.inline
  implicit class RequestIdUserIpOps[Self <: RequestIdUserIp] (val x: Self) extends AnyVal {
    @scala.inline
