...
@js.native
trait AutoscalerFields extends js.Object {
...
object AutoscalerFields {
  @scala.inline
  def apply(autoscaler: String, project: String, region: String): AutoscalerFields = {
    ...
    __obj.asInstanceOf[AutoscalerFields]
  }
  @scala.inline
  implicit class AutoscalerFieldsOps[Self <: AutoscalerFields] (val x: Self) extends AnyVal {
    @scala.inline
