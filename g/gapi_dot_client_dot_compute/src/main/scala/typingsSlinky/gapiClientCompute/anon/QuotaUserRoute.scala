...
@js.native
trait QuotaUserRoute extends js.Object {
...
object QuotaUserRoute {
  @scala.inline
  def apply(project: String, route: String): QuotaUserRoute = {
  ...
  @scala.inline
  implicit class QuotaUserRouteOps[Self <: QuotaUserRoute] (val x: Self) extends AnyVal {
    @scala.inline
