...
@js.native
trait OrderBy_ extends js.Object {
...
object OrderBy_ {
  @scala.inline
  def apply(instanceGroup: String, project: String, zone: String): OrderBy_ = {
  ...
  @scala.inline
  implicit class OrderBy_Ops[Self <: OrderBy_] (val x: Self) extends AnyVal {
    @scala.inline
