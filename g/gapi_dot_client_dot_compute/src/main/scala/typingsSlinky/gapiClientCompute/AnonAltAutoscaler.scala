...
object AnonAltAutoscaler {
  @scala.inline
  def apply(autoscaler: String, project: String, region: String): AnonAltAutoscaler = {
  ...
  @scala.inline
  implicit class AnonAltAutoscalerOps[Self <: AnonAltAutoscaler] (val x: Self) extends AnyVal {
    @scala.inline
