...
@js.native
trait AnonPrettyPrintProject extends js.Object {
...
object AnonPrettyPrintProject {
  @scala.inline
  def apply(project: String, region: String): AnonPrettyPrintProject = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonPrettyPrintProject]
  }
  @scala.inline
  implicit class AnonPrettyPrintProjectOps[Self <: AnonPrettyPrintProject] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAutoscaler(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autoscaler")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAutoscaler: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autoscaler")(js.undefined)
        ret
    }
    @scala.inline
