...
object AnonSslCertificate {
  @scala.inline
  def apply(project: String, sslCertificate: String): AnonSslCertificate = {
  ...
  @scala.inline
  implicit class AnonSslCertificateOps[Self <: AnonSslCertificate] (val x: Self) extends AnyVal {
    @scala.inline
