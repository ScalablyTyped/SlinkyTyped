...
@js.native
trait AnonHttpHealthCheck extends js.Object {
...
object AnonHttpHealthCheck {
  @scala.inline
  def apply(httpHealthCheck: String, project: String): AnonHttpHealthCheck = {
    val __obj = js.Dynamic.literal(httpHealthCheck = httpHealthCheck.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHttpHealthCheck]
  }
  @scala.inline
  implicit class AnonHttpHealthCheckOps[Self <: AnonHttpHealthCheck] (val x: Self) extends AnyVal {
    @scala.inline
