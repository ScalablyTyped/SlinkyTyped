...
@js.native
trait AnonAccessConfig extends js.Object {
...
object AnonAccessConfig {
  @scala.inline
  def apply(accessConfig: String, instance: String, networkInterface: String, project: String, zone: String): AnonAccessConfig = {
    ...
    __obj.asInstanceOf[AnonAccessConfig]
  }
  @scala.inline
  implicit class AnonAccessConfigOps[Self <: AnonAccessConfig] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAccessConfig(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accessConfig")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
