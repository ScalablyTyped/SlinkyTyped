...
object AnonTargetTcpProxy {
  @scala.inline
  def apply(project: String, targetTcpProxy: String): AnonTargetTcpProxy = {
  ...
  @scala.inline
  implicit class AnonTargetTcpProxyOps[Self <: AnonTargetTcpProxy] (val x: Self) extends AnyVal {
    @scala.inline
