...
@js.native
trait AnonBackendService extends js.Object {
...
object AnonBackendService {
  @scala.inline
  def apply(backendService: String, project: String): AnonBackendService = {
    val __obj = js.Dynamic.literal(backendService = backendService.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBackendService]
  }
  @scala.inline
  implicit class AnonBackendServiceOps[Self <: AnonBackendService] (val x: Self) extends AnyVal {
    @scala.inline
