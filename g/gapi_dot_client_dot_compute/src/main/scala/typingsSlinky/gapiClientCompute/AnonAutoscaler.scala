...
@js.native
trait AnonAutoscaler extends js.Object {
...
object AnonAutoscaler {
  @scala.inline
  def apply(autoscaler: String, project: String, zone: String): AnonAutoscaler = {
    ...
    __obj.asInstanceOf[AnonAutoscaler]
  }
  @scala.inline
  implicit class AnonAutoscalerOps[Self <: AnonAutoscaler] (val x: Self) extends AnyVal {
    @scala.inline
