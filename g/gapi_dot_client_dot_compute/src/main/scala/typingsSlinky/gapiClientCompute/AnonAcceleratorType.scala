...
@js.native
trait AnonAcceleratorType extends js.Object {
...
object AnonAcceleratorType {
  @scala.inline
  def apply(acceleratorType: String, project: String, zone: String): AnonAcceleratorType = {
    ...
    __obj.asInstanceOf[AnonAcceleratorType]
  }
  @scala.inline
  implicit class AnonAcceleratorTypeOps[Self <: AnonAcceleratorType] (val x: Self) extends AnyVal {
    @scala.inline
