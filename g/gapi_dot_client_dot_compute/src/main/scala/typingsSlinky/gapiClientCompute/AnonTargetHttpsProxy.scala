...
@js.native
trait AnonTargetHttpsProxy extends js.Object {
...
object AnonTargetHttpsProxy {
  @scala.inline
  def apply(project: String, targetHttpsProxy: String): AnonTargetHttpsProxy = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], targetHttpsProxy = targetHttpsProxy.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonTargetHttpsProxy]
  }
  @scala.inline
  implicit class AnonTargetHttpsProxyOps[Self <: AnonTargetHttpsProxy] (val x: Self) extends AnyVal {
    @scala.inline
