...
object AnonTargetHttpProxy {
  @scala.inline
  def apply(project: String, targetHttpProxy: String): AnonTargetHttpProxy = {
  ...
  @scala.inline
  implicit class AnonTargetHttpProxyOps[Self <: AnonTargetHttpProxy] (val x: Self) extends AnyVal {
    @scala.inline
