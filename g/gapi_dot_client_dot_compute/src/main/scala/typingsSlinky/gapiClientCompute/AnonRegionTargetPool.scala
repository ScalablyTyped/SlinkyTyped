...
object AnonRegionTargetPool {
  @scala.inline
  def apply(project: String, region: String, targetPool: String): AnonRegionTargetPool = {
  ...
  @scala.inline
  implicit class AnonRegionTargetPoolOps[Self <: AnonRegionTargetPool] (val x: Self) extends AnyVal {
    @scala.inline
