...
@js.native
trait AnonOrderBy_ extends js.Object {
...
object AnonOrderBy_ {
  @scala.inline
  def apply(instanceGroup: String, project: String, zone: String): AnonOrderBy_ = {
    ...
    __obj.asInstanceOf[AnonOrderBy_]
  }
  @scala.inline
  implicit class AnonOrderBy_Ops[Self <: AnonOrderBy_] (val x: Self) extends AnyVal {
    @scala.inline
