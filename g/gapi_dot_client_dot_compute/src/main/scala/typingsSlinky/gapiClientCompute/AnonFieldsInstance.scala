...
object AnonFieldsInstance {
  @scala.inline
  def apply(instance: String, project: String, zone: String): AnonFieldsInstance = {
  ...
  @scala.inline
  implicit class AnonFieldsInstanceOps[Self <: AnonFieldsInstance] (val x: Self) extends AnyVal {
    @scala.inline
