...
@js.native
trait AnonBackendBucket extends js.Object {
  /** Data format for the response. */
  var alt: js.UndefOr[String] = js.native
  /** Name of the BackendBucket resource to update. */
  var backendBucket: String = js.native
...
object AnonBackendBucket {
  @scala.inline
  def apply(backendBucket: String, project: String): AnonBackendBucket = {
    val __obj = js.Dynamic.literal(backendBucket = backendBucket.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBackendBucket]
  }
  @scala.inline
  implicit class AnonBackendBucketOps[Self <: AnonBackendBucket] (val x: Self) extends AnyVal {
    @scala.inline
