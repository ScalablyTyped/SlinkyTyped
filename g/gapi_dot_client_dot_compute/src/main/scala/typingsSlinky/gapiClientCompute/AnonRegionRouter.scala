...
object AnonRegionRouter {
  @scala.inline
  def apply(project: String, region: String, router: String): AnonRegionRouter = {
  ...
  @scala.inline
  implicit class AnonRegionRouterOps[Self <: AnonRegionRouter] (val x: Self) extends AnyVal {
    @scala.inline
