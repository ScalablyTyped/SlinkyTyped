...
object AnonTargetSslProxy {
  @scala.inline
  def apply(project: String, targetSslProxy: String): AnonTargetSslProxy = {
  ...
  @scala.inline
  implicit class AnonTargetSslProxyOps[Self <: AnonTargetSslProxy] (val x: Self) extends AnyVal {
    @scala.inline
