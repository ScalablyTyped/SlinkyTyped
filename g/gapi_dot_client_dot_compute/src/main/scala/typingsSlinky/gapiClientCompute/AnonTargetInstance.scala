...
object AnonTargetInstance {
  @scala.inline
  def apply(project: String, targetInstance: String, zone: String): AnonTargetInstance = {
  ...
  @scala.inline
  implicit class AnonTargetInstanceOps[Self <: AnonTargetInstance] (val x: Self) extends AnyVal {
    @scala.inline
