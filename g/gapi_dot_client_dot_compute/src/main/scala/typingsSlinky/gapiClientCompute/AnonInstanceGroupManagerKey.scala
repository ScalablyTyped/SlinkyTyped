...
@js.native
trait AnonInstanceGroupManagerKey extends js.Object {
...
object AnonInstanceGroupManagerKey {
  @scala.inline
  def apply(instanceGroupManager: String, project: String, region: String): AnonInstanceGroupManagerKey = {
    ...
    __obj.asInstanceOf[AnonInstanceGroupManagerKey]
  }
  @scala.inline
  implicit class AnonInstanceGroupManagerKeyOps[Self <: AnonInstanceGroupManagerKey] (val x: Self) extends AnyVal {
    @scala.inline
