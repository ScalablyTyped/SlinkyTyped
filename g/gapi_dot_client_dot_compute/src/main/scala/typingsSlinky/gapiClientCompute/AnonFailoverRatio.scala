...
object AnonFailoverRatio {
  @scala.inline
  def apply(project: String, region: String, targetPool: String): AnonFailoverRatio = {
  ...
  @scala.inline
  implicit class AnonFailoverRatioOps[Self <: AnonFailoverRatio] (val x: Self) extends AnyVal {
    @scala.inline
