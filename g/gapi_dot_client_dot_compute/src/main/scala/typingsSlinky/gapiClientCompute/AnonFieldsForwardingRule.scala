...
@js.native
trait AnonFieldsForwardingRule extends js.Object {
...
object AnonFieldsForwardingRule {
  @scala.inline
  def apply(forwardingRule: String, project: String): AnonFieldsForwardingRule = {
    val __obj = js.Dynamic.literal(forwardingRule = forwardingRule.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFieldsForwardingRule]
  }
  @scala.inline
  implicit class AnonFieldsForwardingRuleOps[Self <: AnonFieldsForwardingRule] (val x: Self) extends AnyVal {
    @scala.inline
