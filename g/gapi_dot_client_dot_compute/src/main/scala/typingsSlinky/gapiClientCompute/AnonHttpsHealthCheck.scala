...
@js.native
trait AnonHttpsHealthCheck extends js.Object {
...
object AnonHttpsHealthCheck {
  @scala.inline
  def apply(httpsHealthCheck: String, project: String): AnonHttpsHealthCheck = {
    val __obj = js.Dynamic.literal(httpsHealthCheck = httpsHealthCheck.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHttpsHealthCheck]
  }
  @scala.inline
  implicit class AnonHttpsHealthCheckOps[Self <: AnonHttpsHealthCheck] (val x: Self) extends AnyVal {
    @scala.inline
