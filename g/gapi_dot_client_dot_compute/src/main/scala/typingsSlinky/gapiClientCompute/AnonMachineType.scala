...
@js.native
trait AnonMachineType extends js.Object {
...
object AnonMachineType {
  @scala.inline
  def apply(machineType: String, project: String, zone: String): AnonMachineType = {
    ...
    __obj.asInstanceOf[AnonMachineType]
  }
  @scala.inline
  implicit class AnonMachineTypeOps[Self <: AnonMachineType] (val x: Self) extends AnyVal {
    @scala.inline
