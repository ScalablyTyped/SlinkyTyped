...
object AnonFieldsFilter {
  @scala.inline
  def apply(instanceGroup: String, project: String, region: String): AnonFieldsFilter = {
  ...
  @scala.inline
  implicit class AnonFieldsFilterOps[Self <: AnonFieldsFilter] (val x: Self) extends AnyVal {
    @scala.inline
