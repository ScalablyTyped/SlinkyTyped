...
@js.native
trait AnonInstanceGroup extends js.Object {
...
object AnonInstanceGroup {
  @scala.inline
  def apply(instanceGroup: String, project: String, zone: String): AnonInstanceGroup = {
    ...
    __obj.asInstanceOf[AnonInstanceGroup]
  }
  @scala.inline
  implicit class AnonInstanceGroupOps[Self <: AnonInstanceGroup] (val x: Self) extends AnyVal {
    @scala.inline
