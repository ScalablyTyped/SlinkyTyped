...
@js.native
trait AnonHealthCheck extends js.Object {
...
object AnonHealthCheck {
  @scala.inline
  def apply(healthCheck: String, project: String): AnonHealthCheck = {
    val __obj = js.Dynamic.literal(healthCheck = healthCheck.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHealthCheck]
  }
  @scala.inline
  implicit class AnonHealthCheckOps[Self <: AnonHealthCheck] (val x: Self) extends AnyVal {
    @scala.inline
