...
@js.native
trait AnonInstanceKey extends js.Object {
...
object AnonInstanceKey {
  @scala.inline
  def apply(instance: String, project: String, zone: String): AnonInstanceKey = {
    ...
    __obj.asInstanceOf[AnonInstanceKey]
  }
  @scala.inline
  implicit class AnonInstanceKeyOps[Self <: AnonInstanceKey] (val x: Self) extends AnyVal {
    @scala.inline
