...
@js.native
trait AnonInstanceTemplate extends js.Object {
...
object AnonInstanceTemplate {
  @scala.inline
  def apply(instanceTemplate: String, project: String): AnonInstanceTemplate = {
    val __obj = js.Dynamic.literal(instanceTemplate = instanceTemplate.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonInstanceTemplate]
  }
  @scala.inline
  implicit class AnonInstanceTemplateOps[Self <: AnonInstanceTemplate] (val x: Self) extends AnyVal {
    @scala.inline
