...
@js.native
trait AnonInstanceGroupManager extends js.Object {
...
object AnonInstanceGroupManager {
  @scala.inline
  def apply(instanceGroupManager: String, project: String, zone: String): AnonInstanceGroupManager = {
    ...
    __obj.asInstanceOf[AnonInstanceGroupManager]
  }
  @scala.inline
  implicit class AnonInstanceGroupManagerOps[Self <: AnonInstanceGroupManager] (val x: Self) extends AnyVal {
    @scala.inline
