...
@js.native
trait AnonQuotaUserSnapshot extends js.Object {
...
object AnonQuotaUserSnapshot {
  @scala.inline
  def apply(project: String, snapshot: String): AnonQuotaUserSnapshot = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], snapshot = snapshot.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonQuotaUserSnapshot]
  }
  @scala.inline
  implicit class AnonQuotaUserSnapshotOps[Self <: AnonQuotaUserSnapshot] (val x: Self) extends AnyVal {
    @scala.inline
