...
@js.native
trait AnonRegionSubnetwork extends js.Object {
...
object AnonRegionSubnetwork {
  @scala.inline
  def apply(project: String, region: String, subnetwork: String): AnonRegionSubnetwork = {
    ...
    __obj.asInstanceOf[AnonRegionSubnetwork]
  }
  @scala.inline
  implicit class AnonRegionSubnetworkOps[Self <: AnonRegionSubnetwork] (val x: Self) extends AnyVal {
    @scala.inline
