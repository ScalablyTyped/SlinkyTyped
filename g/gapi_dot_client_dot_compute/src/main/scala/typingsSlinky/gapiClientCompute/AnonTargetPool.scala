...
@js.native
trait AnonTargetPool extends js.Object {
...
object AnonTargetPool {
  @scala.inline
  def apply(project: String, region: String, targetPool: String): AnonTargetPool = {
    ...
    __obj.asInstanceOf[AnonTargetPool]
  }
  @scala.inline
  implicit class AnonTargetPoolOps[Self <: AnonTargetPool] (val x: Self) extends AnyVal {
    @scala.inline
