...
import typingsSlinky.gapiClientCompute.AnonInstanceGroupManagerKey
import typingsSlinky.gapiClientCompute.AnonPageToken
import typingsSlinky.gapiClientCompute.AnonPrettyPrint
import typingsSlinky.gapiClientCompute.AnonQuotaUserRegion
import typingsSlinky.gapiClientCompute.AnonRegionRequestId
...
object RegionInstanceGroupManagersResource {
  @scala.inline
  def apply(
    abandonInstances: AnonInstanceGroupManagerKey => Request_[Operation],
    delete: AnonInstanceGroupManagerKey => Request_[Operation],
    deleteInstances: AnonInstanceGroupManagerKey => Request_[Operation],
    get: AnonQuotaUserRegion => Request_[InstanceGroupManager],
    insert: AnonPrettyPrint => Request_[Operation],
    list: AnonFilter => Request_[RegionInstanceGroupManagerList],
    listManagedInstances: AnonPageToken => Request_[RegionInstanceGroupManagersListInstancesResponse],
    recreateInstances: AnonInstanceGroupManagerKey => Request_[Operation],
    resize: AnonRegionRequestId => Request_[Operation],
    setInstanceTemplate: AnonInstanceGroupManagerKey => Request_[Operation],
