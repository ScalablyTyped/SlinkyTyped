...
@js.native
trait CommitmentList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  /** A list of Commitment resources. */
  var items: js.UndefOr[js.Array[Commitment]] = js.native
...
object CommitmentList {
  @scala.inline
  def apply(): CommitmentList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommitmentList]
  }
  @scala.inline
  implicit class CommitmentListOps[Self <: CommitmentList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Commitment*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Commitment]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
