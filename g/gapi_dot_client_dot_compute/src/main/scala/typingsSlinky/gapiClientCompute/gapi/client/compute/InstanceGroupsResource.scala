...
trait InstanceGroupsResource extends js.Object {
  /**
    ...
    */
  def addInstances(request: typingsSlinky.gapiClientCompute.anon.InstanceGroup): Request[Operation]
  /** Retrieves the list of instance groups and sorts them by zone. */
  def aggregatedList(request: Alt): Request[InstanceGroupAggregatedList]
  /**
    ...
    */
  def delete(request: typingsSlinky.gapiClientCompute.anon.InstanceGroup): Request[Operation]
  /** Returns the specified instance group. Get a list of available instance groups by making a list() request. */
  def get(request: FieldsInstanceGroup): Request[InstanceGroup]
  /** Creates an instance group in the specified project using the parameters that are included in the request. */
  def insert(request: QuotaUser): Request[Operation]
  /** Retrieves the list of instance groups that are located in the specified project and zone. */
  def list(request: Fields): Request[InstanceGroupList]
  /** Lists the instances in the specified instance group. */
  def listInstances(request: OrderBy_): Request[InstanceGroupsListInstances]
  /**
    ...
    */
  def removeInstances(request: typingsSlinky.gapiClientCompute.anon.InstanceGroup): Request[Operation]
  /** Sets the named ports for the specified instance group. */
  def setNamedPorts(request: typingsSlinky.gapiClientCompute.anon.InstanceGroup): Request[Operation]
}
