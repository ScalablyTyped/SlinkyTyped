...
trait AddressAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, AddressesScopedList]] = js.native
...
object AddressAggregatedList {
  @scala.inline
  def apply(): AddressAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AddressAggregatedList]
  }
  @scala.inline
  implicit class AddressAggregatedListOps[Self <: AddressAggregatedList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: Record[String, AddressesScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
