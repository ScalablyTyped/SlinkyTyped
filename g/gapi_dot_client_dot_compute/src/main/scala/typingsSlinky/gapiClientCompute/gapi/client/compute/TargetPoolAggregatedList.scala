...
trait TargetPoolAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, TargetPoolsScopedList]] = js.native
...
object TargetPoolAggregatedList {
  ...
  implicit class TargetPoolAggregatedListOps[Self <: TargetPoolAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, TargetPoolsScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
