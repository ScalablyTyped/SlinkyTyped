...
object ForwardingRulesResource {
  ...
  implicit class ForwardingRulesResourceOps[Self <: ForwardingRulesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.ForwardingRule => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGet(value: typingsSlinky.gapiClientCompute.anon.Region => Request[ForwardingRule]): Self = this.set("get", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetTarget(value: typingsSlinky.gapiClientCompute.anon.ForwardingRule => Request[Operation]): Self = this.set("setTarget", js.Any.fromFunction1(value))
  }
}
