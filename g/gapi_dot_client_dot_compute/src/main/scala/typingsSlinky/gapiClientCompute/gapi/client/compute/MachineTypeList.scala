...
object MachineTypeList {
  ...
  @scala.inline
  implicit class MachineTypeListOps[Self <: MachineTypeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: MachineType*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[MachineType]): Self = this.set("items", value.asInstanceOf[js.Any])
