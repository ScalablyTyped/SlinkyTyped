...
@js.native
trait InstanceList extends js.Object {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of Instance resources. */
  var items: js.UndefOr[js.Array[Instance]] = js.native
...
object InstanceList {
  ...
  @scala.inline
  def apply(): InstanceList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceList]
  }
  
  @scala.inline
  implicit class InstanceListOps[Self <: InstanceList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Instance*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Instance]): Self = this.set("items", value.asInstanceOf[js.Any])
