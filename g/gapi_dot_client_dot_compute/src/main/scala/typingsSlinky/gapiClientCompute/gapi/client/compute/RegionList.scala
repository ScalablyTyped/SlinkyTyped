...
trait RegionList extends js.Object {
  ...
  var items: js.UndefOr[js.Array[Region]] = js.native
...
object RegionList {
  @scala.inline
  def apply(): RegionList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RegionList]
  }
  @scala.inline
  implicit class RegionListOps[Self <: RegionList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Region*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Region]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
