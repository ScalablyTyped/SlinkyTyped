...
trait TargetHttpsProxyList extends js.Object {
  ...
  var items: js.UndefOr[js.Array[TargetHttpsProxy]] = js.native
...
object TargetHttpsProxyList {
  @scala.inline
  def apply(): TargetHttpsProxyList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetHttpsProxyList]
  }
  @scala.inline
  implicit class TargetHttpsProxyListOps[Self <: TargetHttpsProxyList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: TargetHttpsProxy*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[TargetHttpsProxy]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
