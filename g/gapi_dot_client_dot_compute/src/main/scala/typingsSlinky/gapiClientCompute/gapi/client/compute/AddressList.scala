...
trait AddressList extends js.Object {
  ...
  var items: js.UndefOr[js.Array[Address]] = js.native
...
object AddressList {
  ...
  implicit class AddressListOps[Self <: AddressList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Address*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Address]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
