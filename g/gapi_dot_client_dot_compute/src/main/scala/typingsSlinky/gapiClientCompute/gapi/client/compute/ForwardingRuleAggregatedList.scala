...
trait ForwardingRuleAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, ForwardingRulesScopedList]] = js.native
...
object ForwardingRuleAggregatedList {
  ...
  implicit class ForwardingRuleAggregatedListOps[Self <: ForwardingRuleAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, ForwardingRulesScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
