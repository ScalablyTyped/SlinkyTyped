...
@js.native
trait AutoscalerAggregatedList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  /** A list of AutoscalersScopedList resources. */
  var items: js.UndefOr[Record[String, AutoscalersScopedList]] = js.native
...
object AutoscalerAggregatedList {
  @scala.inline
  def apply(): AutoscalerAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AutoscalerAggregatedList]
  }
  @scala.inline
  implicit class AutoscalerAggregatedListOps[Self <: AutoscalerAggregatedList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: Record[String, AutoscalersScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
