...
trait InstancesResource extends js.Object {
  ...
  def addAccessConfig(request: typingsSlinky.gapiClientCompute.anon.Instance): Request[Operation]
  /** Retrieves aggregated list of instances. */
  def aggregatedList(request: Alt): Request[InstanceAggregatedList]
  /**
    ...
    */
  def attachDisk(request: FieldsInstance): Request[Operation]
  /** Deletes the specified Instance resource. For more information, see Stopping or Deleting an Instance. */
  def delete(request: FieldsInstance): Request[Operation]
  /** Deletes an access config from an instance's network interface. */
  def deleteAccessConfig(request: typingsSlinky.gapiClientCompute.anon.AccessConfig): Request[Operation]
  /** Detaches a disk from an instance. */
  def detachDisk(request: DeviceName): Request[Operation]
  /** Returns the specified Instance resource. Get a list of available instances by making a list() request. */
  def get(request: InstanceKey): Request[Instance]
  /** Returns the specified instance's serial port output. */
  def getSerialPortOutput(request: Port): Request[SerialPortOutput]
  /** Creates an instance resource in the specified project using the data included in the request. */
  def insert(request: QuotaUser): Request[Operation]
  /** Retrieves the list of instances contained within the specified zone. */
  def list(request: Fields): Request[InstanceList]
  /** Performs a reset on the instance. For more information, see Resetting an instance. */
  def reset(request: FieldsInstance): Request[Operation]
  /** Sets the auto-delete flag for a disk attached to an instance. */
  def setDiskAutoDelete(request: AutoDelete): Request[Operation]
  /** Sets labels on an instance. To learn more about labels, read the Labeling Resources documentation. */
  def setLabels(request: FieldsInstance): Request[Operation]
  /** Changes the number and/or type of accelerator for a stopped instance to the values specified in the request. */
  def setMachineResources(request: FieldsInstance): Request[Operation]
  /** Changes the machine type for a stopped instance to the machine type specified in the request. */
  def setMachineType(request: FieldsInstance): Request[Operation]
  /** Sets metadata for the specified instance to the data included in the request. */
  def setMetadata(request: FieldsInstance): Request[Operation]
  /**
    ...
    */
  def setMinCpuPlatform(request: FieldsInstance): Request[Operation]
  /** Sets an instance's scheduling options. */
  def setScheduling(request: FieldsInstance): Request[Operation]
  /** Sets the service account on the instance. For more information, read Changing the service account and access scopes for an instance. */
  def setServiceAccount(request: FieldsInstance): Request[Operation]
  /** Sets tags for the specified instance to the data included in the request. */
  def setTags(request: FieldsInstance): Request[Operation]
  ...
  def start(request: FieldsInstance): Request[Operation]
  /** Starts an instance that was stopped using the using the instances().stop method. For more information, see Restart an instance. */
  def startWithEncryptionKey(request: FieldsInstance): Request[Operation]
  /**
    ...
    */
  def stop(request: FieldsInstance): Request[Operation]
}
