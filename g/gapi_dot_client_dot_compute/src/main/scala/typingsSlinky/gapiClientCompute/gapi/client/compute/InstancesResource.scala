...
object InstancesResource {
  ...
  implicit class InstancesResourceOps[Self <: InstancesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddAccessConfig(value: typingsSlinky.gapiClientCompute.anon.Instance => Request[Operation]): Self = this.set("addAccessConfig", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setDeleteAccessConfig(value: typingsSlinky.gapiClientCompute.anon.AccessConfig => Request[Operation]): Self = this.set("deleteAccessConfig", js.Any.fromFunction1(value))
