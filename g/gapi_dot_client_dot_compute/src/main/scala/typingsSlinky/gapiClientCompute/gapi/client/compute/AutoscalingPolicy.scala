...
object AutoscalingPolicy {
  ...
  implicit class AutoscalingPolicyOps[Self <: AutoscalingPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCpuUtilization(value: AutoscalingPolicyCpuUtilization): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCustomMetricUtilizations(value: js.Array[AutoscalingPolicyCustomMetricUtilization]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLoadBalancingUtilization(value: AutoscalingPolicyLoadBalancingUtilization): Self = {
        val ret = this.duplicate
