...
object TargetPoolsResource {
  ...
  implicit class TargetPoolsResourceOps[Self <: TargetPoolsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddHealthCheck(value: typingsSlinky.gapiClientCompute.anon.TargetPool => Request[Operation]): Self = this.set("addHealthCheck", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAddInstance(value: typingsSlinky.gapiClientCompute.anon.TargetPool => Request[Operation]): Self = this.set("addInstance", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAggregatedList(value: Alt => Request[TargetPoolAggregatedList]): Self = this.set("aggregatedList", js.Any.fromFunction1(value))
    
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.TargetPool => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRemoveHealthCheck(value: typingsSlinky.gapiClientCompute.anon.TargetPool => Request[Operation]): Self = this.set("removeHealthCheck", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRemoveInstance(value: typingsSlinky.gapiClientCompute.anon.TargetPool => Request[Operation]): Self = this.set("removeInstance", js.Any.fromFunction1(value))
