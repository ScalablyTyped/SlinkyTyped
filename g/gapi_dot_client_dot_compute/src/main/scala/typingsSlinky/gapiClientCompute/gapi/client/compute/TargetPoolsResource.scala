...
trait TargetPoolsResource extends js.Object {
  ...
  def addHealthCheck(request: typingsSlinky.gapiClientCompute.anon.TargetPool): Request[Operation]
  /** Adds an instance to a target pool. */
  def addInstance(request: typingsSlinky.gapiClientCompute.anon.TargetPool): Request[Operation]
  /** Retrieves an aggregated list of target pools. */
  def aggregatedList(request: Alt): Request[TargetPoolAggregatedList]
  /** Deletes the specified target pool. */
  def delete(request: typingsSlinky.gapiClientCompute.anon.TargetPool): Request[Operation]
  ...
  def removeHealthCheck(request: typingsSlinky.gapiClientCompute.anon.TargetPool): Request[Operation]
  /** Removes instance URL from a target pool. */
  def removeInstance(request: typingsSlinky.gapiClientCompute.anon.TargetPool): Request[Operation]
