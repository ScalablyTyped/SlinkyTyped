...
import typingsSlinky.gapiClientCompute.anon.QuotaUserTargetInstance
...
object TargetInstancesResource {
  ...
  def apply(
    ...
    delete: typingsSlinky.gapiClientCompute.anon.TargetInstance => Request[Operation],
  ...
  implicit class TargetInstancesResourceOps[Self <: TargetInstancesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.TargetInstance => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
