...
object DisksResource {
  ...
  implicit class DisksResourceOps[Self <: DisksResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateSnapshot(value: typingsSlinky.gapiClientCompute.anon.Disk => Request[Operation]): Self = this.set("createSnapshot", js.Any.fromFunction1(value))
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.Zone => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setResize(value: typingsSlinky.gapiClientCompute.anon.Zone => Request[Operation]): Self = this.set("resize", js.Any.fromFunction1(value))
    @scala.inline
