...
trait TargetHttpsProxiesResource extends js.Object {
  ...
  def delete(request: typingsSlinky.gapiClientCompute.anon.TargetHttpsProxy): Request[Operation]
  ...
  def setSslCertificates(request: typingsSlinky.gapiClientCompute.anon.TargetHttpsProxy): Request[Operation]
  /** Changes the URL map for TargetHttpsProxy. */
  def setUrlMap(request: typingsSlinky.gapiClientCompute.anon.TargetHttpsProxy): Request[Operation]
}
