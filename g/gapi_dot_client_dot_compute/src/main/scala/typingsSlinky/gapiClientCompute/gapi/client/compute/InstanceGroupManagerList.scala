...
object InstanceGroupManagerList {
  @scala.inline
  def apply(): InstanceGroupManagerList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupManagerList]
  }
  @scala.inline
  implicit class InstanceGroupManagerListOps[Self <: InstanceGroupManagerList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[InstanceGroupManager]): Self = {
        val ret = this.duplicate
