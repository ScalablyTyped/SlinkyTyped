...
@js.native
trait InstanceAggregatedList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  /** A list of InstancesScopedList resources. */
  var items: js.UndefOr[Record[String, InstancesScopedList]] = js.native
...
object InstanceAggregatedList {
  ...
  @scala.inline
  implicit class InstanceAggregatedListOps[Self <: InstanceAggregatedList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: Record[String, InstancesScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
