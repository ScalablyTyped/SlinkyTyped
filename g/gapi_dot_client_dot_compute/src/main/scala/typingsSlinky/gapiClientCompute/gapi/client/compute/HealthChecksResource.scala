...
import typingsSlinky.gapiClientCompute.anon.FieldsHealthCheck
...
trait HealthChecksResource extends js.Object {
  ...
  def delete(request: typingsSlinky.gapiClientCompute.anon.HealthCheck): Request[Operation] = js.native
  ...
  /**
    ...
    */
  def patch(request: typingsSlinky.gapiClientCompute.anon.HealthCheck): Request[Operation] = js.native
  
  /** Updates a HealthCheck resource in the specified project using the data included in the request. */
  def update(request: typingsSlinky.gapiClientCompute.anon.HealthCheck): Request[Operation] = js.native
}
object HealthChecksResource {
  
  @scala.inline
  def apply(
    delete: typingsSlinky.gapiClientCompute.anon.HealthCheck => Request[Operation],
    get: FieldsHealthCheck => Request[HealthCheck],
    insert: AltFields => Request[Operation],
    list: Alt => Request[HealthCheckList],
    patch: typingsSlinky.gapiClientCompute.anon.HealthCheck => Request[Operation],
    update: typingsSlinky.gapiClientCompute.anon.HealthCheck => Request[Operation]
  ...
  implicit class HealthChecksResourceOps[Self <: HealthChecksResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.HealthCheck => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPatch(value: typingsSlinky.gapiClientCompute.anon.HealthCheck => Request[Operation]): Self = this.set("patch", js.Any.fromFunction1(value))
    
    @scala.inline
    def setUpdate(value: typingsSlinky.gapiClientCompute.anon.HealthCheck => Request[Operation]): Self = this.set("update", js.Any.fromFunction1(value))
  }
}
