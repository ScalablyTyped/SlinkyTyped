...
trait BackendBucketsResource extends js.Object {
  ...
  def delete(request: typingsSlinky.gapiClientCompute.anon.BackendBucket): Request[Operation]
  ...
  /**
    ...
    */
  def patch(request: typingsSlinky.gapiClientCompute.anon.BackendBucket): Request[Operation]
  /** Updates the specified BackendBucket resource with the data included in the request. */
  def update(request: typingsSlinky.gapiClientCompute.anon.BackendBucket): Request[Operation]
}
