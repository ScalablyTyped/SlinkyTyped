...
@js.native
trait SnapshotList extends js.Object {
...
object SnapshotList {
  @scala.inline
  def apply(): SnapshotList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SnapshotList]
  }
  @scala.inline
  implicit class SnapshotListOps[Self <: SnapshotList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[Snapshot]): Self = {
        val ret = this.duplicate
