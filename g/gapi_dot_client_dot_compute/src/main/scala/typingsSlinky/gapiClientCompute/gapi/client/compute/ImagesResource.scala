...
trait ImagesResource extends js.Object {
  ...
  def delete(request: typingsSlinky.gapiClientCompute.anon.Image): Request[Operation]
  /**
    * Sets the deprecation status of an image.
    *
    * If an empty request body is given, clears the deprecation status instead.
    */
  def deprecate(request: typingsSlinky.gapiClientCompute.anon.Image): Request[Operation]
