...
object ImagesResource {
  ...
  implicit class ImagesResourceOps[Self <: ImagesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.Image => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    @scala.inline
    def setDeprecate(value: typingsSlinky.gapiClientCompute.anon.Image => Request[Operation]): Self = this.set("deprecate", js.Any.fromFunction1(value))
    @scala.inline
