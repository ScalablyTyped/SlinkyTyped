...
trait BackendServiceAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, BackendServicesScopedList]] = js.native
...
object BackendServiceAggregatedList {
  ...
  @scala.inline
  def apply(): BackendServiceAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackendServiceAggregatedList]
  }
  
  @scala.inline
  implicit class BackendServiceAggregatedListOps[Self <: BackendServiceAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, BackendServicesScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
