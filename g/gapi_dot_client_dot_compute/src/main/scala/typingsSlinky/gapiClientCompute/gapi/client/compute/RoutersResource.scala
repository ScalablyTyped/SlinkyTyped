...
import typingsSlinky.gapiClientCompute.anon.RegionRouter
...
object RoutersResource {
  ...
  def apply(
    ...
    delete: typingsSlinky.gapiClientCompute.anon.Router => Request[Operation],
    ...
    patch: typingsSlinky.gapiClientCompute.anon.Router => Request[Operation],
    preview: RegionRouter => Request[RoutersPreviewResponse],
    update: typingsSlinky.gapiClientCompute.anon.Router => Request[Operation]
  ): RoutersResource = {
  ...
  implicit class RoutersResourceOps[Self <: RoutersResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.Router => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPatch(value: typingsSlinky.gapiClientCompute.anon.Router => Request[Operation]): Self = this.set("patch", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPreview(value: RegionRouter => Request[RoutersPreviewResponse]): Self = this.set("preview", js.Any.fromFunction1(value))
    
    @scala.inline
    def setUpdate(value: typingsSlinky.gapiClientCompute.anon.Router => Request[Operation]): Self = this.set("update", js.Any.fromFunction1(value))
  }
}
