...
object HealthCheck {
  ...
  implicit class HealthCheckOps[Self <: HealthCheck] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHttpHealthCheck(value: HTTPHealthCheck_): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHttpsHealthCheck(value: HTTPSHealthCheck_): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSslHealthCheck(value: SSLHealthCheck): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTcpHealthCheck(value: TCPHealthCheck): Self = {
        val ret = this.duplicate
