...
object TargetInstance {
  ...
  implicit class TargetInstanceOps[Self <: TargetInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNatPolicy(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("natPolicy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNatPolicy: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("natPolicy")(js.undefined)
        ret
    }
    @scala.inline
