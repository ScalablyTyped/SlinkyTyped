...
trait TargetHttpProxiesResource extends js.Object {
  ...
  def delete(request: typingsSlinky.gapiClientCompute.anon.TargetHttpProxy): Request[Operation]
  ...
  def setUrlMap(request: typingsSlinky.gapiClientCompute.anon.TargetHttpProxy): Request[Operation]
}
