...
trait OperationAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, OperationsScopedList]] = js.native
...
object OperationAggregatedList {
  ...
  implicit class OperationAggregatedListOps[Self <: OperationAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, OperationsScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
