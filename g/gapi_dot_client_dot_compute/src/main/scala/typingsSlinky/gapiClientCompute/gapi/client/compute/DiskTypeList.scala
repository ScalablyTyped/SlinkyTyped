...
@js.native
trait DiskTypeList extends js.Object {
...
object DiskTypeList {
  @scala.inline
  def apply(): DiskTypeList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiskTypeList]
  }
  @scala.inline
  implicit class DiskTypeListOps[Self <: DiskTypeList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[DiskType]): Self = {
        val ret = this.duplicate
