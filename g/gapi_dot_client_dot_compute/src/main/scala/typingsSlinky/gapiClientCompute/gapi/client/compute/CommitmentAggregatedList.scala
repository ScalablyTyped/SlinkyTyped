...
trait CommitmentAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, CommitmentsScopedList]] = js.native
...
object CommitmentAggregatedList {
  ...
  implicit class CommitmentAggregatedListOps[Self <: CommitmentAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, CommitmentsScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
