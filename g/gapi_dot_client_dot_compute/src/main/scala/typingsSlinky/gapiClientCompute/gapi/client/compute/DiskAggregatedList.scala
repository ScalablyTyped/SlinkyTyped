...
trait DiskAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, DisksScopedList]] = js.native
...
object DiskAggregatedList {
  @scala.inline
  def apply(): DiskAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiskAggregatedList]
  }
  @scala.inline
  implicit class DiskAggregatedListOps[Self <: DiskAggregatedList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: Record[String, DisksScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
