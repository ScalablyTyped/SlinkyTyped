...
trait InstanceGroupManagersResource extends js.Object {
  /**
    ...
    */
  def abandonInstances(request: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager): Request[Operation]
  ...
  /**
    ...
    */
  def delete(request: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager): Request[Operation]
  /**
    ...
    * You can specify a maximum of 1000 instances with this method per request.
    */
  def deleteInstances(request: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager): Request[Operation]
  ...
  /**
    ...
    * You can specify a maximum of 1000 instances with this method per request.
    */
  def recreateInstances(request: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager): Request[Operation]
  /**
  ...
  /**
    ...
    */
  def setInstanceTemplate(request: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager): Request[Operation]
  /**
    ...
    */
  def setTargetPools(request: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager): Request[Operation]
}
