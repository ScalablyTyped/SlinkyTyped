...
object InstanceGroupManagersResource {
  ...
  implicit class InstanceGroupManagersResourceOps[Self <: InstanceGroupManagersResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAbandonInstances(value: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager => Request[Operation]): Self = this.set("abandonInstances", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    @scala.inline
    def setDeleteInstances(value: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager => Request[Operation]): Self = this.set("deleteInstances", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRecreateInstances(value: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager => Request[Operation]): Self = this.set("recreateInstances", js.Any.fromFunction1(value))
    @scala.inline
    def setResize(value: Size => Request[Operation]): Self = this.set("resize", js.Any.fromFunction1(value))
    @scala.inline
    def setSetInstanceTemplate(value: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager => Request[Operation]): Self = this.set("setInstanceTemplate", js.Any.fromFunction1(value))
    @scala.inline
    def setSetTargetPools(value: typingsSlinky.gapiClientCompute.anon.InstanceGroupManager => Request[Operation]): Self = this.set("setTargetPools", js.Any.fromFunction1(value))
  }
