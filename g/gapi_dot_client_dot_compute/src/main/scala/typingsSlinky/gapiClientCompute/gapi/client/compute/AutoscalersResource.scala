...
import typingsSlinky.gapiClientCompute.anon.RequestId
...
trait AutoscalersResource extends js.Object {
  ...
  def delete(request: typingsSlinky.gapiClientCompute.anon.Autoscaler): Request[Operation] = js.native
  /** Returns the specified autoscaler resource. Get a list of available autoscalers by making a list() request. */
  def get(request: typingsSlinky.gapiClientCompute.anon.Project): Request[Autoscaler] = js.native
...
object AutoscalersResource {
  ...
  def apply(
    ...
    delete: typingsSlinky.gapiClientCompute.anon.Autoscaler => Request[Operation],
    get: typingsSlinky.gapiClientCompute.anon.Project => Request[Autoscaler],
  ...
  implicit class AutoscalersResourceOps[Self <: AutoscalersResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAggregatedList(value: Alt => Request[AutoscalerAggregatedList]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("aggregatedList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDelete(value: typingsSlinky.gapiClientCompute.anon.Autoscaler => Request[Operation]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("delete")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGet(value: typingsSlinky.gapiClientCompute.anon.Project => Request[Autoscaler]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withList(value: Fields => Request[AutoscalerList]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: RequestId => Request[Operation]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("patch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdate(value: RequestId => Request[Operation]): Self = {
        val ret = this.duplicate
