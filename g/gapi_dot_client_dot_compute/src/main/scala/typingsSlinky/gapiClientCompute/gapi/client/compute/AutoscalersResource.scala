...
trait AutoscalersResource extends js.Object {
  ...
  def delete(request: typingsSlinky.gapiClientCompute.anon.Autoscaler): Request[Operation]
  /** Returns the specified autoscaler resource. Get a list of available autoscalers by making a list() request. */
  def get(request: typingsSlinky.gapiClientCompute.anon.Project): Request[Autoscaler]
