...
object AutoscalersResource {
  ...
  implicit class AutoscalersResourceOps[Self <: AutoscalersResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typingsSlinky.gapiClientCompute.anon.Autoscaler => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    @scala.inline
    def setGet(value: typingsSlinky.gapiClientCompute.anon.Project => Request[Autoscaler]): Self = this.set("get", js.Any.fromFunction1(value))
    @scala.inline
