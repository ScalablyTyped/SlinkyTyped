...
@js.native
trait AnonCommitment extends js.Object {
...
object AnonCommitment {
  @scala.inline
  def apply(commitment: String, project: String, region: String): AnonCommitment = {
    val __obj = js.Dynamic.literal(commitment = commitment.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommitment]
  }
  @scala.inline
  implicit class AnonCommitmentOps[Self <: AnonCommitment] (val x: Self) extends AnyVal {
    @scala.inline
