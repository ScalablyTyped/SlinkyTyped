...
object AnonFieldsInstanceGroupManager {
  @scala.inline
  def apply(instanceGroupManager: String, project: String, zone: String): AnonFieldsInstanceGroupManager = {
  ...
  @scala.inline
  implicit class AnonFieldsInstanceGroupManagerOps[Self <: AnonFieldsInstanceGroupManager] (val x: Self) extends AnyVal {
    @scala.inline
