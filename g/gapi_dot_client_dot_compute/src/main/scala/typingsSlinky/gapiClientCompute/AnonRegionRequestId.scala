...
object AnonRegionRequestId {
  @scala.inline
  def apply(instanceGroupManager: String, project: String, region: String, size: Double): AnonRegionRequestId = {
  ...
  @scala.inline
  implicit class AnonRegionRequestIdOps[Self <: AnonRegionRequestId] (val x: Self) extends AnyVal {
    @scala.inline
