package typingsSlinky.gherkin.tokenMod
...
trait Token extends js.Object {
  ...
  val line: typingsSlinky.gherkin.gherkinLineMod.default = js.native
  ...
  var matchedItems: js.Array[typingsSlinky.gherkin.gherkinLineMod.default] = js.native
...
object Token {
  ...
  def apply(
    ...
    isEof: Boolean,
    line: typingsSlinky.gherkin.gherkinLineMod.default,
    location: ILocation,
    matchedGherkinDialect: String,
    matchedIndent: Double,
    matchedItems: js.Array[typingsSlinky.gherkin.gherkinLineMod.default],
  ...
  implicit class TokenOps[Self <: Token] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLine(value: typingsSlinky.gherkin.gherkinLineMod.default): Self = this.set("line", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMatchedItemsVarargs(value: typingsSlinky.gherkin.gherkinLineMod.default*): Self = this.set("matchedItems", js.Array(value :_*))
    
    @scala.inline
    def setMatchedItems(value: js.Array[typingsSlinky.gherkin.gherkinLineMod.default]): Self = this.set("matchedItems", value.asInstanceOf[js.Any])
