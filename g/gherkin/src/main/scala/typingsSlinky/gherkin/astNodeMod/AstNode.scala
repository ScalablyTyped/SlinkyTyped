package typingsSlinky.gherkin.astNodeMod

import typingsSlinky.gherkin.parserMod.RuleType
import typingsSlinky.gherkin.parserMod.TokenType
...
trait AstNode extends js.Object {
  ...
  def getTokens(tokenType: TokenType): js.Array[typingsSlinky.gherkin.tokenMod.default] = js.native
...
object AstNode {
  ...
  def apply(
    ...
    getTokens: TokenType => js.Array[typingsSlinky.gherkin.tokenMod.default],
    ruleType: RuleType,
    subItems: js.Any
  ): AstNode = {
  ...
  implicit class AstNodeOps[Self <: AstNode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetTokens(value: TokenType => js.Array[typingsSlinky.gherkin.tokenMod.default]): Self = this.set("getTokens", js.Any.fromFunction1(value))
