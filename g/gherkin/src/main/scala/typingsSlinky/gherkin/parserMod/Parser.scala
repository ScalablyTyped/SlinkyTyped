...
trait Parser extends StObject {
  ...
  def parse(tokenScanner: String, tokenMatcher: typingsSlinky.gherkin.tokenMatcherMod.default): js.Any = js.native
  def parse(tokenScanner: typingsSlinky.gherkin.tokenScannerMod.default): js.Any = js.native
  def parse(
    tokenScanner: typingsSlinky.gherkin.tokenScannerMod.default,
    tokenMatcher: typingsSlinky.gherkin.tokenMatcherMod.default
  ): js.Any = js.native
