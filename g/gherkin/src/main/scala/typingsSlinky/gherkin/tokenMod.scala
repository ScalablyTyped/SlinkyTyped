...
object tokenMod {
  ...
  object Token {
    ...
    implicit class TokenMutableBuilder[Self <: Token] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLine(value: typingsSlinky.gherkin.gherkinLineMod.default): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMatchedItems(value: js.Array[typingsSlinky.gherkin.gherkinLineMod.default]): Self = StObject.set(x, "matchedItems", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMatchedItemsVarargs(value: typingsSlinky.gherkin.gherkinLineMod.default*): Self = StObject.set(x, "matchedItems", js.Array(value :_*))
