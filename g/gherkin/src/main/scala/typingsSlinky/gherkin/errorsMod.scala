...
object errorsMod {
  ...
  object CompositeParserException {
    ...
    @js.native
    def create(errors: js.Array[js.Error]): CompositeParserException = js.native
  }
  ...
  object GherkinException {
    ...
    @scala.inline
    def apply(errors: js.Array[js.Error], location: ILocation, message: String, name: String): GherkinException = {
