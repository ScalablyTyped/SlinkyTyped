package typingsSlinky.gherkin.tokenFormatterBuilderMod
...
object TokenFormatterBuilder {
  ...
  implicit class TokenFormatterBuilderOps[Self <: TokenFormatterBuilder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBuild(value: typingsSlinky.gherkin.tokenMod.default => Unit): Self = this.set("build", js.Any.fromFunction1(value))
    
    @scala.inline
    def setEndRule(value: RuleType => Unit): Self = this.set("endRule", js.Any.fromFunction1(value))
    
    @scala.inline
    def setFormatToken(value: typingsSlinky.gherkin.tokenMod.default => String): Self = this.set("formatToken", js.Any.fromFunction1(value))
