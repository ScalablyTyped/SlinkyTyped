...
object global {
  ...
  object Giraffe {
    ...
    @js.native
    class Collection[TModel /* <: typingsSlinky.giraffe.Giraffe.Model */] ()
      extends typingsSlinky.giraffe.Giraffe.Collection[TModel]
    ...
    @js.native
    class Model ()
      extends typingsSlinky.giraffe.Giraffe.Model
    
    @JSGlobal("Giraffe.Router")
    @js.native
    class Router ()
      extends typingsSlinky.giraffe.Giraffe.Router
    ...
    @js.native
    def views: ViewMap[typingsSlinky.giraffe.Giraffe.Model] = js.native
    @scala.inline
    def views_=(x: ViewMap[typingsSlinky.giraffe.Giraffe.Model]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("views")(x.asInstanceOf[js.Any])
