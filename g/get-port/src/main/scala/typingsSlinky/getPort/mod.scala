...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPort(value: Double | js.Iterable[Double]): Self = StObject.set(x, "port", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPortIterable(value: js.Iterable[Double]): Self = StObject.set(x, "port", value.asInstanceOf[js.Any])
