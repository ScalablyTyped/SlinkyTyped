...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPortIterable(value: js.Iterable[Double]): Self = this.set("port", value.asInstanceOf[js.Any])
    @scala.inline
    def setPort(value: Double | js.Iterable[Double]): Self = this.set("port", value.asInstanceOf[js.Any])
    @scala.inline
