...
trait VisitorKeyMapASTKindToNod extends js.Object {
  var Argument: js.Array[_]
  var BooleanValue: js.Array[_]
  var Directive: js.Array[_]
  var DirectiveDefinition: js.Array[_]
  var Document: js.Array[_]
  var EnumTypeDefinition: js.Array[_]
  var EnumTypeExtension: js.Array[_]
  var EnumValue: js.Array[_]
  var EnumValueDefinition: js.Array[_]
  var Field: js.Array[_]
  var FieldDefinition: js.Array[_]
  var FloatValue: js.Array[_]
  var FragmentDefinition: js.Array[_]
  var FragmentSpread: js.Array[_]
  var InlineFragment: js.Array[_]
  var InputObjectTypeDefinition: js.Array[_]
  var InputObjectTypeExtension: js.Array[_]
  var InputValueDefinition: js.Array[_]
  var IntValue: js.Array[_]
  var InterfaceTypeDefinition: js.Array[_]
  var InterfaceTypeExtension: js.Array[_]
  var ListType: js.Array[_]
  var ListValue: js.Array[_]
  var Name: js.Array[_]
  var NamedType: js.Array[_]
  var NonNullType: js.Array[_]
  var NullValue: js.Array[_]
  var ObjectField: js.Array[_]
  var ObjectTypeDefinition: js.Array[_]
  var ObjectTypeExtension: js.Array[_]
  var ObjectValue: js.Array[_]
  var OperationDefinition: js.Array[_]
  var OperationTypeDefinition: js.Array[_]
  var ScalarTypeDefinition: js.Array[_]
  var ScalarTypeExtension: js.Array[_]
  var SchemaDefinition: js.Array[_]
  var SchemaExtension: js.Array[_]
  var SelectionSet: js.Array[_]
  var StringValue: js.Array[_]
  var UnionTypeDefinition: js.Array[_]
  var UnionTypeExtension: js.Array[_]
  var Variable: js.Array[_]
  var VariableDefinition: js.Array[_]
}
...
object VisitorKeyMapASTKindToNod {
  ...
  def apply(
    Argument: js.Array[_],
    BooleanValue: js.Array[_],
    Directive: js.Array[_],
    DirectiveDefinition: js.Array[_],
    Document: js.Array[_],
    EnumTypeDefinition: js.Array[_],
    EnumTypeExtension: js.Array[_],
    EnumValue: js.Array[_],
    EnumValueDefinition: js.Array[_],
    Field: js.Array[_],
    FieldDefinition: js.Array[_],
    FloatValue: js.Array[_],
    FragmentDefinition: js.Array[_],
    FragmentSpread: js.Array[_],
    InlineFragment: js.Array[_],
    InputObjectTypeDefinition: js.Array[_],
    InputObjectTypeExtension: js.Array[_],
    InputValueDefinition: js.Array[_],
    IntValue: js.Array[_],
    InterfaceTypeDefinition: js.Array[_],
    InterfaceTypeExtension: js.Array[_],
    ListType: js.Array[_],
    ListValue: js.Array[_],
    Name: js.Array[_],
    NamedType: js.Array[_],
    NonNullType: js.Array[_],
    NullValue: js.Array[_],
    ObjectField: js.Array[_],
    ObjectTypeDefinition: js.Array[_],
    ObjectTypeExtension: js.Array[_],
    ObjectValue: js.Array[_],
    OperationDefinition: js.Array[_],
    OperationTypeDefinition: js.Array[_],
    ScalarTypeDefinition: js.Array[_],
    ScalarTypeExtension: js.Array[_],
    SchemaDefinition: js.Array[_],
    SchemaExtension: js.Array[_],
    SelectionSet: js.Array[_],
    StringValue: js.Array[_],
    UnionTypeDefinition: js.Array[_],
    UnionTypeExtension: js.Array[_],
    Variable: js.Array[_],
    VariableDefinition: js.Array[_]
  ): VisitorKeyMapASTKindToNod = {
