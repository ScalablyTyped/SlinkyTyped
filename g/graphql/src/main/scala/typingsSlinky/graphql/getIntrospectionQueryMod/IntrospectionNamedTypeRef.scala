...
object IntrospectionNamedTypeRef {
  @scala.inline
  def apply[/* <: typingsSlinky.graphql.getIntrospectionQueryMod.IntrospectionType */ T](
  ...
  @scala.inline
  implicit class IntrospectionNamedTypeRefOps[Self <: IntrospectionNamedTypeRef[_], /* <: typingsSlinky.graphql.getIntrospectionQueryMod.IntrospectionType */ T] (val x: Self with IntrospectionNamedTypeRef[T]) extends AnyVal {
    @scala.inline
