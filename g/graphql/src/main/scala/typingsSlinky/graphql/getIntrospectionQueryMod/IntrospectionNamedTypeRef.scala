...
object IntrospectionNamedTypeRef {
  ...
  @scala.inline
  implicit class IntrospectionNamedTypeRefOps[Self <: IntrospectionNamedTypeRef[_], T /* <: IntrospectionType */] (val x: Self with IntrospectionNamedTypeRef[T]) extends AnyVal {
