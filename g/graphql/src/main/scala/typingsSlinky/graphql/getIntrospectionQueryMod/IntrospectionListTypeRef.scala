...
object IntrospectionListTypeRef {
  ...
  @scala.inline
  implicit class IntrospectionListTypeRefOps[Self <: IntrospectionListTypeRef[_], T /* <: IntrospectionTypeRef */] (val x: Self with IntrospectionListTypeRef[T]) extends AnyVal {
