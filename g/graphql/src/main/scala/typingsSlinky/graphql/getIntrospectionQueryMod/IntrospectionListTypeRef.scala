...
object IntrospectionListTypeRef {
  @scala.inline
  def apply[/* <: typingsSlinky.graphql.getIntrospectionQueryMod.IntrospectionTypeRef */ T](kind: LIST, ofType: T): IntrospectionListTypeRef[T] = {
  ...
  @scala.inline
  implicit class IntrospectionListTypeRefOps[Self <: IntrospectionListTypeRef[_], /* <: typingsSlinky.graphql.getIntrospectionQueryMod.IntrospectionTypeRef */ T] (val x: Self with IntrospectionListTypeRef[T]) extends AnyVal {
    @scala.inline
