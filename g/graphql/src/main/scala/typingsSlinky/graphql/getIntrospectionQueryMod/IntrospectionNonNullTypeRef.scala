...
object IntrospectionNonNullTypeRef {
  @scala.inline
  def apply[/* <: typingsSlinky.graphql.getIntrospectionQueryMod.IntrospectionTypeRef */ T](kind: NON_NULL, ofType: T): IntrospectionNonNullTypeRef[T] = {
  ...
  @scala.inline
  implicit class IntrospectionNonNullTypeRefOps[Self <: IntrospectionNonNullTypeRef[_], /* <: typingsSlinky.graphql.getIntrospectionQueryMod.IntrospectionTypeRef */ T] (val x: Self with IntrospectionNonNullTypeRef[T]) extends AnyVal {
    @scala.inline
