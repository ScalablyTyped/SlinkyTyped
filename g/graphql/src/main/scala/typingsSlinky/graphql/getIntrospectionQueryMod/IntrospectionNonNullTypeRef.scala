...
object IntrospectionNonNullTypeRef {
  ...
  @scala.inline
  implicit class IntrospectionNonNullTypeRefOps[Self <: IntrospectionNonNullTypeRef[_], T /* <: IntrospectionTypeRef */] (val x: Self with IntrospectionNonNullTypeRef[T]) extends AnyVal {
