...
object getNullableType extends js.Object {
  ...
  def apply[T /* <: (typingsSlinky.graphql.definitionMod.GraphQLObjectType[_, _, StringDictionary[_]]) | typingsSlinky.graphql.definitionMod.GraphQLList[_] */](`type`: T): T = js.native
  def apply[T /* <: GraphQLNullableType */](`type`: typingsSlinky.graphql.definitionMod.GraphQLNonNull[T]): T = js.native
}
