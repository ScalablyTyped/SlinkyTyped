...
trait _BreakingChangeType extends js.Object {
  var ARG_CHANGED_KIND: typingsSlinky.graphql.graphqlStrings.ARG_CHANGED_KIND
  var ARG_REMOVED: typingsSlinky.graphql.graphqlStrings.ARG_REMOVED
  var DIRECTIVE_ARG_REMOVED: typingsSlinky.graphql.graphqlStrings.DIRECTIVE_ARG_REMOVED
  var DIRECTIVE_LOCATION_REMOVED: typingsSlinky.graphql.graphqlStrings.DIRECTIVE_LOCATION_REMOVED
  var DIRECTIVE_REMOVED: typingsSlinky.graphql.graphqlStrings.DIRECTIVE_REMOVED
  var FIELD_CHANGED_KIND: typingsSlinky.graphql.graphqlStrings.FIELD_CHANGED_KIND
  var FIELD_REMOVED: typingsSlinky.graphql.graphqlStrings.FIELD_REMOVED
  var INTERFACE_REMOVED_FROM_OBJECT: typingsSlinky.graphql.graphqlStrings.INTERFACE_REMOVED_FROM_OBJECT
  var REQUIRED_ARG_ADDED: typingsSlinky.graphql.graphqlStrings.REQUIRED_ARG_ADDED
  var REQUIRED_DIRECTIVE_ARG_ADDED: typingsSlinky.graphql.graphqlStrings.REQUIRED_DIRECTIVE_ARG_ADDED
  var REQUIRED_INPUT_FIELD_ADDED: typingsSlinky.graphql.graphqlStrings.REQUIRED_INPUT_FIELD_ADDED
  var TYPE_CHANGED_KIND: typingsSlinky.graphql.graphqlStrings.TYPE_CHANGED_KIND
  var TYPE_REMOVED: typingsSlinky.graphql.graphqlStrings.TYPE_REMOVED
  var TYPE_REMOVED_FROM_UNION: typingsSlinky.graphql.graphqlStrings.TYPE_REMOVED_FROM_UNION
  var VALUE_REMOVED_FROM_ENUM: typingsSlinky.graphql.graphqlStrings.VALUE_REMOVED_FROM_ENUM
}
