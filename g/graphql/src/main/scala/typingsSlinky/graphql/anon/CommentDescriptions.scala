...
@js.native
trait CommentDescriptions extends js.Object {
  var commentDescriptions: js.UndefOr[Boolean] = js.native
}

object CommentDescriptions {
  @scala.inline
  def apply(): CommentDescriptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommentDescriptions]
  }
  @scala.inline
  implicit class CommentDescriptionsOps[Self <: CommentDescriptions] (val x: Self) extends AnyVal {
    @scala.inline
