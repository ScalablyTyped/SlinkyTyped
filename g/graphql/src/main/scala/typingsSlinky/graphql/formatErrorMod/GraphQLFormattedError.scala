...
object GraphQLFormattedError {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ TExtensions](message: String): GraphQLFormattedError[TExtensions] = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphQLFormattedError[TExtensions]]
  }
  @scala.inline
  implicit class GraphQLFormattedErrorOps[Self <: GraphQLFormattedError[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ TExtensions] (val x: Self with GraphQLFormattedError[TExtensions]) extends AnyVal {
    @scala.inline
