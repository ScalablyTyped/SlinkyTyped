...
object GraphQLFormattedError {
  ...
  @scala.inline
  def apply[TExtensions /* <: Record[String, _] */](message: String): GraphQLFormattedError[TExtensions] = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphQLFormattedError[TExtensions]]
  }
  
  @scala.inline
  implicit class GraphQLFormattedErrorOps[Self <: GraphQLFormattedError[_], TExtensions /* <: Record[String, _] */] (val x: Self with GraphQLFormattedError[TExtensions]) extends AnyVal {
