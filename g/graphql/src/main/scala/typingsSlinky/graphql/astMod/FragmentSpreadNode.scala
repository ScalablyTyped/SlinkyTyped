...
trait FragmentSpreadNode
  ...
  val kind: FragmentSpread = js.native
...
object FragmentSpreadNode {
  ...
  @scala.inline
  def apply(kind: FragmentSpread, name: NameNode): FragmentSpreadNode = {
    val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[FragmentSpreadNode]
  }
  
  @scala.inline
  implicit class FragmentSpreadNodeOps[Self <: FragmentSpreadNode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: FragmentSpread): Self = this.set("kind", value.asInstanceOf[js.Any])
