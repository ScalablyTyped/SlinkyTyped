...
trait _DangerousChangeType extends js.Object {
  var ARG_DEFAULT_VALUE_CHANGE: typingsSlinky.graphql.graphqlStrings.ARG_DEFAULT_VALUE_CHANGE
  var INTERFACE_ADDED_TO_OBJECT: typingsSlinky.graphql.graphqlStrings.INTERFACE_ADDED_TO_OBJECT
  var OPTIONAL_ARG_ADDED: typingsSlinky.graphql.graphqlStrings.OPTIONAL_ARG_ADDED
  var OPTIONAL_INPUT_FIELD_ADDED: typingsSlinky.graphql.graphqlStrings.OPTIONAL_INPUT_FIELD_ADDED
  var TYPE_ADDED_TO_UNION: typingsSlinky.graphql.graphqlStrings.TYPE_ADDED_TO_UNION
  var VALUE_ADDED_TO_ENUM: typingsSlinky.graphql.graphqlStrings.VALUE_ADDED_TO_ENUM
}
