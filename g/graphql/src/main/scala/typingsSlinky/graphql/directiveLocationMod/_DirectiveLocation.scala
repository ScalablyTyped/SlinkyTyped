...
trait _DirectiveLocation extends js.Object {
  var ARGUMENT_DEFINITION: typingsSlinky.graphql.graphqlStrings.ARGUMENT_DEFINITION
  var ENUM: typingsSlinky.graphql.graphqlStrings.ENUM
  var ENUM_VALUE: typingsSlinky.graphql.graphqlStrings.ENUM_VALUE
  var FIELD: typingsSlinky.graphql.graphqlStrings.FIELD
  var FIELD_DEFINITION: typingsSlinky.graphql.graphqlStrings.FIELD_DEFINITION
  var FRAGMENT_DEFINITION: typingsSlinky.graphql.graphqlStrings.FRAGMENT_DEFINITION
  var FRAGMENT_SPREAD: typingsSlinky.graphql.graphqlStrings.FRAGMENT_SPREAD
  var INLINE_FRAGMENT: typingsSlinky.graphql.graphqlStrings.INLINE_FRAGMENT
  var INPUT_FIELD_DEFINITION: typingsSlinky.graphql.graphqlStrings.INPUT_FIELD_DEFINITION
  var INPUT_OBJECT: typingsSlinky.graphql.graphqlStrings.INPUT_OBJECT
  var INTERFACE: typingsSlinky.graphql.graphqlStrings.INTERFACE
  var MUTATION: typingsSlinky.graphql.graphqlStrings.MUTATION
  var OBJECT: typingsSlinky.graphql.graphqlStrings.OBJECT
  // Request Definitions
  var QUERY: typingsSlinky.graphql.graphqlStrings.QUERY
  var SCALAR: typingsSlinky.graphql.graphqlStrings.SCALAR
  // Type System Definitions
  var SCHEMA: typingsSlinky.graphql.graphqlStrings.SCHEMA
  var SUBSCRIPTION: typingsSlinky.graphql.graphqlStrings.SUBSCRIPTION
  var UNION: typingsSlinky.graphql.graphqlStrings.UNION
  var VARIABLE_DEFINITION: typingsSlinky.graphql.graphqlStrings.VARIABLE_DEFINITION
}
