...
@js.native
trait AnonConsumerId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonConsumerId {
  @scala.inline
  def apply(): AnonConsumerId = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonConsumerId]
  }
  @scala.inline
  implicit class AnonConsumerIdOps[Self <: AnonConsumerId] (val x: Self) extends AnyVal {
    @scala.inline
