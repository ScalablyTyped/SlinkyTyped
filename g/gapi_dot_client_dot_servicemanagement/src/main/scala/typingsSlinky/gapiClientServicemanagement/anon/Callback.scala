package typingsSlinky.gapiClientServicemanagement.anon
...
object Callback {
  @scala.inline
  def apply(configId: String, serviceName: String): Callback = {
    val __obj = js.Dynamic.literal(configId = configId.asInstanceOf[js.Any], serviceName = serviceName.asInstanceOf[js.Any])
