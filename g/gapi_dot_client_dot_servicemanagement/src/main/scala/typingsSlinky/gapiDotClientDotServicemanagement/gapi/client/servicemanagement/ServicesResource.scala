...
import typingsSlinky.gapiDotClientDotServicemanagement.Anon_AccesstokenAltBearertoken
import typingsSlinky.gapiDotClientDotServicemanagement.Anon_AccesstokenAltBearertokenCallbackConfigId
import typingsSlinky.gapiDotClientDotServicemanagement.Anon_AccesstokenAltBearertokenCallbackConsumerId
import typingsSlinky.gapiDotClientDotServicemanagement.Anon_AccesstokenAltBearertokenCallbackFieldsKey
import typingsSlinky.gapiDotClientDotServicemanagement.Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPp
