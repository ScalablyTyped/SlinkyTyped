package typingsSlinky.gapiClientDataproc.anon
...
@js.native
trait ClusterName extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object ClusterName {
  @scala.inline
  def apply(projectId: String, region: String): ClusterName = {
    val __obj = js.Dynamic.literal(projectId = projectId.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClusterName]
  }
  @scala.inline
  implicit class ClusterNameOps[Self <: ClusterName] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withJobStateMatcher(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("jobStateMatcher")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutJobStateMatcher: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("jobStateMatcher")(js.undefined)
        ret
    }
    @scala.inline
