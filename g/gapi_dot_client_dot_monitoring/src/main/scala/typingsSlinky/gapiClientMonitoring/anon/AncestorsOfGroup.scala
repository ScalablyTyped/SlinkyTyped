package typingsSlinky.gapiClientMonitoring.anon
...
@js.native
trait AncestorsOfGroup extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AncestorsOfGroup {
  ...
  @scala.inline
  implicit class AncestorsOfGroupOps[Self <: AncestorsOfGroup] (val x: Self) extends AnyVal {
    @scala.inline
