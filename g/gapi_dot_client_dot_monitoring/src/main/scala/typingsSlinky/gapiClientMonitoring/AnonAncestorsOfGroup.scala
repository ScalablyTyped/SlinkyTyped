...
@js.native
trait AnonAncestorsOfGroup extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonAncestorsOfGroup {
  @scala.inline
  def apply(name: String): AnonAncestorsOfGroup = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAncestorsOfGroup]
  }
  @scala.inline
  implicit class AnonAncestorsOfGroupOps[Self <: AnonAncestorsOfGroup] (val x: Self) extends AnyVal {
    @scala.inline
