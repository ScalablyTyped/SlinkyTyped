package typingsSlinky.gapiDotClientDotCloudmonitoring.gapi.client.cloudmonitoring

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotCloudmonitoring.Anon_Aggregator
import typingsSlinky.gapiDotClientDotCloudmonitoring.Anon_Alt
