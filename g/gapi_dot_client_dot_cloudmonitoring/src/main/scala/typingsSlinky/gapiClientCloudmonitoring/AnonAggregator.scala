...
@js.native
trait AnonAggregator extends js.Object {
  /**
...
object AnonAggregator {
  @scala.inline
  def apply(metric: String, project: String, youngest: String): AnonAggregator = {
    ...
    __obj.asInstanceOf[AnonAggregator]
  }
  @scala.inline
  implicit class AnonAggregatorOps[Self <: AnonAggregator] (val x: Self) extends AnyVal {
    @scala.inline
