package typingsSlinky.gapiClientCloudmonitoring.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientCloudmonitoring.gapiClientCloudmonitoringStrings.cloudmonitoring,
    version: v2beta2
