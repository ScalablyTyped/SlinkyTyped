...
trait TimeseriesResource extends js.Object {
  /**
    ...
    */
  def list(request: AnonAggregator): Request_[ListTimeseriesResponse] = js.native
  /**
    ...
    */
  def write(request: AnonAlt): Request_[WriteTimeseriesResponse] = js.native
}
...
object TimeseriesResource {
  ...
  implicit class TimeseriesResourceOps[Self <: TimeseriesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withList(value: AnonAggregator => Request_[ListTimeseriesResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWrite(value: AnonAlt => Request_[WriteTimeseriesResponse]): Self = {
        val ret = this.duplicate
