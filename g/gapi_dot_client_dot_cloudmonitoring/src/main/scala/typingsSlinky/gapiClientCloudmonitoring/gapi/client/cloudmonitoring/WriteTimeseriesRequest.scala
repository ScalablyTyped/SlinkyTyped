...
object WriteTimeseriesRequest {
  ...
  implicit class WriteTimeseriesRequestOps[Self <: WriteTimeseriesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCommonLabels(value: Record[String, String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("commonLabels")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCommonLabels: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("commonLabels")(js.undefined)
        ret
    }
    @scala.inline
    def withTimeseries(value: js.Array[TimeseriesPoint]): Self = {
        val ret = this.duplicate
