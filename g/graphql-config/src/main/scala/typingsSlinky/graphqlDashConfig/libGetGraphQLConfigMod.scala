...
import typingsSlinky.graphqlDashConfig.libGraphQLConfigMod.GraphQLConfig
import typingsSlinky.graphqlDashConfig.libGraphQLProjectConfigMod.GraphQLProjectConfig
