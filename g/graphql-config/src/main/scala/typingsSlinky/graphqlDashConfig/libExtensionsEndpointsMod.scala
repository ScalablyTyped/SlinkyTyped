...
object libExtensionsEndpointsMod extends js.Object {
  ...
  class GraphQLEndpoint protected ()
    extends typingsSlinky.graphqlDashConfig.libExtensionsEndpointsEndpointsExtensionMod.GraphQLEndpoint {
    def this(resolvedConfig: GraphQLConfigEnpointConfig) = this()
  }
  
  @js.native
  class GraphQLEndpointsExtension protected ()
    extends typingsSlinky.graphqlDashConfig.libExtensionsEndpointsEndpointsExtensionMod.GraphQLEndpointsExtension {
