...
object libExtensionsMod extends js.Object {
  ...
  class GraphQLEndpoint protected ()
    extends typingsSlinky.graphqlDashConfig.libExtensionsEndpointsMod.GraphQLEndpoint {
    def this(resolvedConfig: GraphQLConfigEnpointConfig) = this()
  }
  
  @js.native
  class GraphQLEndpointsExtension protected ()
    extends typingsSlinky.graphqlDashConfig.libExtensionsEndpointsMod.GraphQLEndpointsExtension {
