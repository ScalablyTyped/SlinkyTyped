...
trait JsonSchema extends js.Object {
  ...
  var properties: js.UndefOr[Record[String, JsonSchema]] = js.native
  /**
...
object JsonSchema {
  ...
  implicit class JsonSchemaOps[Self <: JsonSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdditionalProperties(value: JsonSchema): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItems(value: JsonSchema): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withProperties(value: Record[String, JsonSchema]): Self = {
        val ret = this.duplicate
