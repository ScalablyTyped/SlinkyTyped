package typingsSlinky.gapiDotClientDotDiscovery.gapi.client.discovery

import typingsSlinky.gapiDotClientDotDiscovery.Anon_Accept
import typingsSlinky.gapiDotClientDotDiscovery.Anon_ParameterName
import typingsSlinky.gapiDotClientDotDiscovery.Anon_RefString
