...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "google-cloud__precise-date" % "1.0.1-71e2ae",
  "org.scalablytyped.slinky" %%% "google-gax" % "1.7.5-44d2fc",
  ...
  "org.scalablytyped.slinky" %%% "p-defer" % "3.0.0-13e6c6",
