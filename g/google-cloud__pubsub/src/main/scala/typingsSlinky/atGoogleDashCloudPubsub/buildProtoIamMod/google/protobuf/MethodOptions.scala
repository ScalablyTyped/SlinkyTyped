...
object MethodOptions extends js.Object {
  ...
  object IdempotencyLevel extends js.Object {
    ...
    /* 0 */ val IDEMPOTENCY_UNKNOWN: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.MethodOptions.IdempotencyLevel.IDEMPOTENCY_UNKNOWN with Double = js.native
    /* 2 */ val IDEMPOTENT: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.MethodOptions.IdempotencyLevel.IDEMPOTENT with Double = js.native
    /* 1 */ val NO_SIDE_EFFECTS: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.MethodOptions.IdempotencyLevel.NO_SIDE_EFFECTS with Double = js.native
    @JSBracketAccess
