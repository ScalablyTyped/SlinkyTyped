...
import typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.CType
import typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.JSType
...
@JSImport("@google-cloud/pubsub/build/proto/iam", "google.protobuf.FieldOptions")
@js.native
/**
...
object FieldOptions extends js.Object {
  ...
  object CType extends js.Object {
    ...
    /* 1 */ val CORD: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.CType.CORD with Double = js.native
    /* 0 */ val STRING: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.CType.STRING with Double = js.native
    /* 2 */ val STRING_PIECE: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.CType.STRING_PIECE with Double = js.native
    @JSBracketAccess
  ...
  object JSType extends js.Object {
    ...
    /* 0 */ val JS_NORMAL: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.JSType.JS_NORMAL with Double = js.native
    /* 2 */ val JS_NUMBER: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.JSType.JS_NUMBER with Double = js.native
    /* 1 */ val JS_STRING: typingsSlinky.atGoogleDashCloudPubsub.buildProtoIamMod.google.protobuf.FieldOptions.JSType.JS_STRING with Double = js.native
    @JSBracketAccess
