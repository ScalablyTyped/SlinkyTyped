package typingsSlinky.atGoogleDashCloudPubsub.buildProtoPubsubMod.google.pubsub.v1
...
@JSImport("@google-cloud/pubsub/build/proto/pubsub", "google.pubsub.v1.UpdateSubscriptionRequest")
@js.native
/**
