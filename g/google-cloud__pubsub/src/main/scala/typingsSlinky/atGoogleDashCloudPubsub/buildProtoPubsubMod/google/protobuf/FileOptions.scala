...
object FileOptions extends js.Object {
  ...
  object OptimizeMode extends js.Object {
    ...
    /* 2 */ val CODE_SIZE: typingsSlinky.atGoogleDashCloudPubsub.buildProtoPubsubMod.google.protobuf.FileOptions.OptimizeMode.CODE_SIZE with Double = js.native
    /* 3 */ val LITE_RUNTIME: typingsSlinky.atGoogleDashCloudPubsub.buildProtoPubsubMod.google.protobuf.FileOptions.OptimizeMode.LITE_RUNTIME with Double = js.native
    /* 1 */ val SPEED: typingsSlinky.atGoogleDashCloudPubsub.buildProtoPubsubMod.google.protobuf.FileOptions.OptimizeMode.SPEED with Double = js.native
    @JSBracketAccess
