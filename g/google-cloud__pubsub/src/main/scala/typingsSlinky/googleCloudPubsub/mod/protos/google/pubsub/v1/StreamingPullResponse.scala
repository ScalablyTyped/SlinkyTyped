...
import typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.IStreamingPullResponse
...
class StreamingPullResponse ()
  extends typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse {
...
object StreamingPullResponse extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  def create(properties: IStreamingPullResponse): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  def decode(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  /**
  ...
  /**
    ...
    * @returns StreamingPullResponse
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse = js.native
  /**
    ...
    */
  def toObject(message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullResponse,
