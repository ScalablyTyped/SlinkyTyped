...
import typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.IStreamingPullRequest
...
class StreamingPullRequest ()
  extends typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest {
...
object StreamingPullRequest extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  def create(properties: IStreamingPullRequest): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  def decode(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  /**
  ...
  /**
    ...
    * @returns StreamingPullRequest
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest = js.native
  /**
    ...
    */
  def toObject(message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.StreamingPullRequest,
