...
/**
  ...
  */
class PubsubMessage ()
  extends typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage {
...
object PubsubMessage extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  def create(properties: IPubsubMessage): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  def decode(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  /**
  ...
  /**
    ...
    * @returns PubsubMessage
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage = js.native
  /**
    ...
    */
  def toObject(message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PubsubMessage,
