...
class ReceivedMessage ()
  extends typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage {
...
object ReceivedMessage extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  def create(properties: IReceivedMessage): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  def decode(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  /**
  ...
  /**
    ...
    * @returns ReceivedMessage
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage = js.native
  /**
    ...
    */
  def toObject(message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.ReceivedMessage,
