...
import typingsSlinky.googleCloudPubsub.messageBatchMod.MessageBatch
import typingsSlinky.googleCloudPubsub.publishErrorMod.PublishError
...
@js.native
object publisherMessageQueuesMod extends js.Object {
  @js.native
