...
trait IPolicy extends js.Object {
  ...
  /** Policy etag */
  var etag: js.UndefOr[js.typedarray.Uint8Array | String | Null] = js.native
  /** Policy version */
...
object IPolicy {
  ...
  implicit class IPolicyOps[Self <: IPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEtagUint8Array(value: js.typedarray.Uint8Array): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("etag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEtag(value: js.typedarray.Uint8Array | String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("etag")(value.asInstanceOf[js.Any])
        ret
    }
