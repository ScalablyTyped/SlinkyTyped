...
object IFileOptions {
  ...
  implicit class IFileOptionsOps[Self <: IFileOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDotgoogleDotapiDotresourceDefinition(value: js.Array[IResourceDescriptor]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic(".google.api.resourceDefinition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDotgoogleDotapiDotresourceDefinition: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic(".google.api.resourceDefinition")(js.undefined)
        ret
    }
    @scala.inline
    def withDotgoogleDotapiDotresourceDefinitionNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic(".google.api.resourceDefinition")(null)
        ret
    }
    @scala.inline
