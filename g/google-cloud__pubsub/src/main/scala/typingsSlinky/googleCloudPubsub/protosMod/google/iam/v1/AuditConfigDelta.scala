...
import typingsSlinky.googleCloudPubsub.protosMod.google.iam.v1.AuditConfigDelta.Action
...
@JSImport("@google-cloud/pubsub/build/protos/protos", "google.iam.v1.AuditConfigDelta")
@js.native
/**
