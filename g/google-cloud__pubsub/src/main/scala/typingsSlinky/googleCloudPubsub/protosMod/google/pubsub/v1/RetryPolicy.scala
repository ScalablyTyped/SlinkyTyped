...
object RetryPolicy {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): RetryPolicy = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.RetryPolicy.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): RetryPolicy = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): RetryPolicy = js.native
  /**
