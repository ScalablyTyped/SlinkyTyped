...
object CreateSnapshotRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): CreateSnapshotRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): CreateSnapshotRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): CreateSnapshotRequest = js.native
  /**
