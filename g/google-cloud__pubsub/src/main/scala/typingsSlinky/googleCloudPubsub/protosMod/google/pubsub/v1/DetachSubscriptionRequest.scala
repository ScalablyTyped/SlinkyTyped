...
object DetachSubscriptionRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): DetachSubscriptionRequest = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DetachSubscriptionRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): DetachSubscriptionRequest = js.native
  /**
