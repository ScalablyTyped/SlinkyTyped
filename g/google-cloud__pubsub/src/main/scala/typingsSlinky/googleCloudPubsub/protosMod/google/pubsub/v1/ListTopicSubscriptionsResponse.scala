...
object ListTopicSubscriptionsResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ListTopicSubscriptionsResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListTopicSubscriptionsResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListTopicSubscriptionsResponse = js.native
  /**
