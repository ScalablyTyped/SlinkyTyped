...
object Topic {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): Topic = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.Topic.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Topic = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): Topic = js.native
  /**
