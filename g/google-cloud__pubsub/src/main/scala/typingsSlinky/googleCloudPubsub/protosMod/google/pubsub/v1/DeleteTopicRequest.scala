...
object DeleteTopicRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): DeleteTopicRequest = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DeleteTopicRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeleteTopicRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeleteTopicRequest = js.native
  /**
