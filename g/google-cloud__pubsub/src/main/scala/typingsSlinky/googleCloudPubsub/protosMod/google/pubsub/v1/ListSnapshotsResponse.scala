...
object ListSnapshotsResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ListSnapshotsResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListSnapshotsResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListSnapshotsResponse = js.native
  /**
