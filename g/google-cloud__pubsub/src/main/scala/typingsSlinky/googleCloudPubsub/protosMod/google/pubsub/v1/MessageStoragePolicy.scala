...
object MessageStoragePolicy extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): MessageStoragePolicy = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): MessageStoragePolicy = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): MessageStoragePolicy = js.native
  /**
