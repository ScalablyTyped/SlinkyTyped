...
object PushConfig {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): PushConfig = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.PushConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): PushConfig = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): PushConfig = js.native
  /**
