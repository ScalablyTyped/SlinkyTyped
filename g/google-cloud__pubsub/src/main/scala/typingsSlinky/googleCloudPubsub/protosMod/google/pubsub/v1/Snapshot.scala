...
object Snapshot {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): Snapshot = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.Snapshot.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Snapshot = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): Snapshot = js.native
  /**
