...
object ListSubscriptionsResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ListSubscriptionsResponse = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.ListSubscriptionsResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListSubscriptionsResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListSubscriptionsResponse = js.native
  /**
