...
object StreamingPullResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): StreamingPullResponse = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.StreamingPullResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): StreamingPullResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): StreamingPullResponse = js.native
  /**
