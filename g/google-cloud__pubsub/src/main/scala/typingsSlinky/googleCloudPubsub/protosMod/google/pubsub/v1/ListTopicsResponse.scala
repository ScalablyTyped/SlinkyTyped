...
object ListTopicsResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ListTopicsResponse = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.ListTopicsResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListTopicsResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListTopicsResponse = js.native
  /**
