...
@JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto")
@js.native
/**
...
object MethodDescriptorProto {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.create")
  @js.native
  ...
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array): MethodDescriptorProto = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): MethodDescriptorProto = js.native
  /**
  ...
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.decodeDelimited")
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): MethodDescriptorProto = js.native
  /**
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.fromObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.toObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.protobuf.MethodDescriptorProto.verify")
  @js.native
