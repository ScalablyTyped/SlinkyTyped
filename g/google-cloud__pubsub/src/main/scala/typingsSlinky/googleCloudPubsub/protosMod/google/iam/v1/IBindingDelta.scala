...
import typingsSlinky.googleCloudPubsub.protosMod.google.iam.v1.BindingDelta.Action
...
object IBindingDelta {
  ...
  def apply(
    action: js.UndefOr[
      Null | Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.iam.v1.BindingDelta.Action * / any */ String)
    ] = js.undefined,
