...
object ExpirationPolicy extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ExpirationPolicy = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ExpirationPolicy = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ExpirationPolicy = js.native
  /**
