...
object DetachSubscriptionResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): DetachSubscriptionResponse = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DetachSubscriptionResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): DetachSubscriptionResponse = js.native
  /**
