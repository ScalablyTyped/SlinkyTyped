package typingsSlinky.googleCloudPubsub.protosMod.google.pubsub.v1.PushConfig
...
object OidcToken extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): OidcToken = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): OidcToken = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): OidcToken = js.native
  /**
