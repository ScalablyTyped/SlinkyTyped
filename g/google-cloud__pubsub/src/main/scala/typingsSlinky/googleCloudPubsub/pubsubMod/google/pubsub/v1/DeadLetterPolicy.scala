...
@JSImport("@google-cloud/pubsub/build/proto/pubsub", "google.pubsub.v1.DeadLetterPolicy")
@js.native
/**
...
object DeadLetterPolicy extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): DeadLetterPolicy = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeadLetterPolicy = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeadLetterPolicy = js.native
  /**
