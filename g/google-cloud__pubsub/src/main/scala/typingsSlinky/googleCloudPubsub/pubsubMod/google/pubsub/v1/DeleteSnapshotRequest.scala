...
object DeleteSnapshotRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): DeleteSnapshotRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeleteSnapshotRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeleteSnapshotRequest = js.native
  /**
