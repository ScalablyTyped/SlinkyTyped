...
object Subscription extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Subscription = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Subscription = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Subscription = js.native
  /**
