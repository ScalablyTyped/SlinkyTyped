...
object ModifyPushConfigRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ModifyPushConfigRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ModifyPushConfigRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ModifyPushConfigRequest = js.native
  /**
