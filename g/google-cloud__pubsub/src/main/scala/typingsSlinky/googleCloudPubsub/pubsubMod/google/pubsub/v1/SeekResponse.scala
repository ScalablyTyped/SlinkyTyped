...
object SeekResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): SeekResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SeekResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): SeekResponse = js.native
  /**
