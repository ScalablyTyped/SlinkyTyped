...
object ModifyAckDeadlineRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ModifyAckDeadlineRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ModifyAckDeadlineRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ModifyAckDeadlineRequest = js.native
  /**
