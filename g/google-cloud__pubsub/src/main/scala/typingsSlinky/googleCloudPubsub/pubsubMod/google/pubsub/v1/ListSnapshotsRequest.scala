...
@JSImport("@google-cloud/pubsub/build/proto/pubsub", "google.pubsub.v1.ListSnapshotsRequest")
@js.native
/**
...
object ListSnapshotsRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ListSnapshotsRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListSnapshotsRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListSnapshotsRequest = js.native
  /**
