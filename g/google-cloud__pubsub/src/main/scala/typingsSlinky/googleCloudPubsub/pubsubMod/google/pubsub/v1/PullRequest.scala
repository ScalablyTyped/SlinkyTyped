...
@JSImport("@google-cloud/pubsub/build/proto/pubsub", "google.pubsub.v1.PullRequest")
@js.native
/**
...
object PullRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): PullRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): PullRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): PullRequest = js.native
  /**
