...
object GetSnapshotRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): GetSnapshotRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GetSnapshotRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): GetSnapshotRequest = js.native
  /**
