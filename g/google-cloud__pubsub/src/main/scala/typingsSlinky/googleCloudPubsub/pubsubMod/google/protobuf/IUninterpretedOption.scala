...
trait IUninterpretedOption extends js.Object {
  ...
  var negativeIntValue: js.UndefOr[Double | Long | Null] = js.native
  /** UninterpretedOption positiveIntValue */
  var positiveIntValue: js.UndefOr[Double | Long | Null] = js.native
...
object IUninterpretedOption {
  ...
  implicit class IUninterpretedOptionOps[Self <: IUninterpretedOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNegativeIntValue(value: Double | Long): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPositiveIntValue(value: Double | Long): Self = {
        val ret = this.duplicate
