...
object PublishRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): PublishRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): PublishRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): PublishRequest = js.native
  /**
