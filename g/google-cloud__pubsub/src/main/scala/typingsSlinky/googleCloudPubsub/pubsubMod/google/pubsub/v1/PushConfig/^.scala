...
object ^ extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def create(properties: IPushConfig): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decode(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
  ...
  /**
    ...
    * @returns PushConfig
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
    ...
    */
  def toObject(message: typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsSlinky.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig,
