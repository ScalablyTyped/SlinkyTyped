...
object DeleteSubscriptionRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): DeleteSubscriptionRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeleteSubscriptionRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeleteSubscriptionRequest = js.native
  /**
