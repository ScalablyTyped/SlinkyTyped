...
@JSImport("@google-cloud/pubsub/build/proto/pubsub", "google.pubsub.v1.ListTopicsRequest")
@js.native
/**
...
object ListTopicsRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ListTopicsRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListTopicsRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListTopicsRequest = js.native
  /**
