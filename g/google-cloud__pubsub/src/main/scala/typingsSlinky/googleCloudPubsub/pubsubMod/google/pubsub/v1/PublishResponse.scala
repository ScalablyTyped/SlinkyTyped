...
object PublishResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): PublishResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): PublishResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): PublishResponse = js.native
  /**
