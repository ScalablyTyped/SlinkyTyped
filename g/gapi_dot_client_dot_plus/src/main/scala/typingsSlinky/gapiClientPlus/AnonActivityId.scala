...
@js.native
trait AnonActivityId extends js.Object {
...
object AnonActivityId {
  @scala.inline
  def apply(activityId: String): AnonActivityId = {
    val __obj = js.Dynamic.literal(activityId = activityId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonActivityId]
  }
  @scala.inline
  implicit class AnonActivityIdOps[Self <: AnonActivityId] (val x: Self) extends AnyVal {
    @scala.inline
