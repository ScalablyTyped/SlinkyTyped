...
import typingsSlinky.gapiClientPlus.anon.DisplayName
import typingsSlinky.gapiClientPlus.anon.Id
import typingsSlinky.gapiClientPlus.anon.ObjectType
import typingsSlinky.gapiClientPlus.anon.TotalItems
