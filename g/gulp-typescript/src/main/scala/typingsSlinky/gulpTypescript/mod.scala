...
import typingsSlinky.gulpTypescript.projectMod.ICompileStream
...
object mod {
  ...
  @JSImport("gulp-typescript", JSImport.Namespace)
  @js.native
  def apply(proj: typingsSlinky.gulpTypescript.projectMod.Project): CompileStream = js.native
  @JSImport("gulp-typescript", JSImport.Namespace)
  @js.native
  def apply(proj: typingsSlinky.gulpTypescript.projectMod.Project, theReporter: Reporter): CompileStream = js.native
  @JSImport("gulp-typescript", JSImport.Namespace)
  @js.native
  ...
  type Project = typingsSlinky.gulpTypescript.projectMod.Project
