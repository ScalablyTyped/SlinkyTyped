...
object inputMod {
  ...
  object FileChangeState extends StObject {
    ...
    /* 3 */ val Deleted: typingsSlinky.gulpTypescript.inputMod.FileChangeState.Deleted with Double = js.native
    
    @js.native
    sealed trait Equal extends FileChangeState
    /* 1 */ val Equal: typingsSlinky.gulpTypescript.inputMod.FileChangeState.Equal with Double = js.native
    
    @js.native
    sealed trait Modified extends FileChangeState
    /* 2 */ val Modified: typingsSlinky.gulpTypescript.inputMod.FileChangeState.Modified with Double = js.native
    
    @js.native
    sealed trait New extends FileChangeState
    /* 0 */ val New: typingsSlinky.gulpTypescript.inputMod.FileChangeState.New with Double = js.native
    
    @js.native
    sealed trait NotFound extends FileChangeState
    /* 4 */ val NotFound: typingsSlinky.gulpTypescript.inputMod.FileChangeState.NotFound with Double = js.native
  }
  ...
  object FileKind extends StObject {
    ...
    /* 1 */ val Config: typingsSlinky.gulpTypescript.inputMod.FileKind.Config with Double = js.native
    
    @js.native
    sealed trait Source extends FileKind
    /* 0 */ val Source: typingsSlinky.gulpTypescript.inputMod.FileKind.Source with Double = js.native
  }
