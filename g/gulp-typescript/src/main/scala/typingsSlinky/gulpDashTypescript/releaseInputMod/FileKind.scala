...
object FileKind extends js.Object {
  ...
  /* 1 */ val Config: typingsSlinky.gulpDashTypescript.releaseInputMod.FileKind.Config with Double = js.native
  /* 0 */ val Source: typingsSlinky.gulpDashTypescript.releaseInputMod.FileKind.Source with Double = js.native
  @JSBracketAccess
