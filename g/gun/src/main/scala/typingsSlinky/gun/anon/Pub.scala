...
object Pub {
  ...
  @scala.inline
  def apply(ok: typingsSlinky.gun.gunNumbers.`0`, pub: String): Pub = {
  ...
  implicit class PubMutableBuilder[Self <: Pub] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOk(value: typingsSlinky.gun.gunNumbers.`0`): Self = StObject.set(x, "ok", value.asInstanceOf[js.Any])
