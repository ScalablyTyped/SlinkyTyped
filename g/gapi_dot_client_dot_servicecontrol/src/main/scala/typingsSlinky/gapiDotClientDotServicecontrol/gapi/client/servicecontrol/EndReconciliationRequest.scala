package typingsSlinky.gapiDotClientDotServicecontrol.gapi.client.servicecontrol
...
object EndReconciliationRequest {
  @scala.inline
  def apply(reconciliationOperation: QuotaOperation = null, serviceConfigId: String = null): EndReconciliationRequest = {
