...
@js.native
trait AnonEnterpriseToken extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonEnterpriseToken {
  @scala.inline
  def apply(): AnonEnterpriseToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonEnterpriseToken]
  }
  @scala.inline
  implicit class AnonEnterpriseTokenOps[Self <: AnonEnterpriseToken] (val x: Self) extends AnyVal {
    @scala.inline
