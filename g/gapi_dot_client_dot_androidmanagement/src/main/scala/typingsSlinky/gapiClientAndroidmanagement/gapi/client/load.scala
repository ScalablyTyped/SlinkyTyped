package typingsSlinky.gapiClientAndroidmanagement.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientAndroidmanagement.gapiClientAndroidmanagementStrings.androidmanagement,
    version: v1
