...
@js.native
trait AnonCallbackUrl extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCallbackUrl {
  @scala.inline
  def apply(): AnonCallbackUrl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCallbackUrl]
  }
  @scala.inline
  implicit class AnonCallbackUrlOps[Self <: AnonCallbackUrl] (val x: Self) extends AnyVal {
    @scala.inline
