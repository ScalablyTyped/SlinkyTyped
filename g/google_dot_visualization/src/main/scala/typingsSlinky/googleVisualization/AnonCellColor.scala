...
@js.native
trait AnonCellColor extends js.Object {
...
object AnonCellColor {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonCellColor]
  }
  @scala.inline
  implicit class AnonCellColorOps[Self <: AnonCellColor] (val x: Self) extends AnyVal {
    @scala.inline
