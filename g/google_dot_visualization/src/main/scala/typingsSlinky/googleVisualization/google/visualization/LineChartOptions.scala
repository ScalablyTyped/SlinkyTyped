...
object LineChartOptions {
  ...
  implicit class LineChartOptionsOps[Self <: LineChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutDomainAxis: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("domainAxis")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSeries(value: js.Array[LineChartSeriesOptions] | NumberDictionary[LineChartSeriesOptions]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTrendlines(value: NumberDictionary[ChartTrendlineOptions]): Self = {
        val ret = this.duplicate
