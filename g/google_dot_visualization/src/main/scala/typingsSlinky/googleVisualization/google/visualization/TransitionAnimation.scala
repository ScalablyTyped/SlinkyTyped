...
object TransitionAnimation {
  ...
  implicit class TransitionAnimationOps[Self <: TransitionAnimation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStartup(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startup")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStartup: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startup")(js.undefined)
        ret
    }
  }
