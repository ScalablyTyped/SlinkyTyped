...
object AnnotationChartOptions {
  ...
  implicit class AnnotationChartOptionsOps[Self <: AnnotationChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setZoomEndTime(value: js.Date): Self = this.set("zoomEndTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteZoomEndTime: Self = this.set("zoomEndTime", js.undefined)
    @scala.inline
    def setZoomStartTime(value: js.Date): Self = this.set("zoomStartTime", value.asInstanceOf[js.Any])
    @scala.inline
