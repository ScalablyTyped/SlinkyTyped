...
object AnnotationChartOptions {
  ...
  implicit class AnnotationChartOptionsMutableBuilder[Self <: AnnotationChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setZoomEndTime(value: js.Date): Self = StObject.set(x, "zoomEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setZoomEndTimeUndefined: Self = StObject.set(x, "zoomEndTime", js.undefined)
    
    @scala.inline
    def setZoomStartTime(value: js.Date): Self = StObject.set(x, "zoomStartTime", value.asInstanceOf[js.Any])
