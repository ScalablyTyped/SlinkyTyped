...
object GanttOptions {
  ...
  implicit class GanttOptionsOps[Self <: GanttOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultStartDateDate(value: js.Date): Self = this.set("defaultStartDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultStartDate(value: js.Date | Double): Self = this.set("defaultStartDate", value.asInstanceOf[js.Any])
