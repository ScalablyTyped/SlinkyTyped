...
trait GanttOptions extends StObject {
  ...
  var defaultStartDate: js.UndefOr[js.Date | Double] = js.native
...
object GanttOptions {
  ...
  implicit class GanttOptionsMutableBuilder[Self <: GanttOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultStartDate(value: js.Date | Double): Self = StObject.set(x, "defaultStartDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultStartDateDate(value: js.Date): Self = StObject.set(x, "defaultStartDate", value.asInstanceOf[js.Any])
