...
object ChartAxis {
  ...
  implicit class ChartAxisMutableBuilder[Self <: ChartAxis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxValue(value: Double | js.Date | js.Array[Double]): Self = StObject.set(x, "maxValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaxValueDate(value: js.Date): Self = StObject.set(x, "maxValue", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinValue(value: Double | js.Date | js.Array[Double]): Self = StObject.set(x, "minValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinValueDate(value: js.Date): Self = StObject.set(x, "minValue", value.asInstanceOf[js.Any])
