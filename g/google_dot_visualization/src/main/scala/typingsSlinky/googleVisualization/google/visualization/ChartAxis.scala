...
object ChartAxis {
  ...
  implicit class ChartAxisOps[Self <: ChartAxis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxValueDate(value: js.Date): Self = this.set("maxValue", value.asInstanceOf[js.Any])
    @scala.inline
    def setMaxValue(value: Double | js.Date | js.Array[Double]): Self = this.set("maxValue", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMinValueDate(value: js.Date): Self = this.set("minValue", value.asInstanceOf[js.Any])
    @scala.inline
    def setMinValue(value: Double | js.Date | js.Array[Double]): Self = this.set("minValue", value.asInstanceOf[js.Any])
    @scala.inline
