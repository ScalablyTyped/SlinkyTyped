...
object BarChartOptions {
  ...
  implicit class BarChartOptionsOps[Self <: BarChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHAxes(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hAxes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHAxes: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hAxes")(js.undefined)
        ret
    }
    @scala.inline
