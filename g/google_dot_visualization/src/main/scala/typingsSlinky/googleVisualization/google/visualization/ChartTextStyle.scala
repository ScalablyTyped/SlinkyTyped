...
object ChartTextStyle {
  ...
  implicit class ChartTextStyleOps[Self <: ChartTextStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAuraColor(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("auraColor")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAuraColor: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("auraColor")(js.undefined)
        ret
    }
    @scala.inline
