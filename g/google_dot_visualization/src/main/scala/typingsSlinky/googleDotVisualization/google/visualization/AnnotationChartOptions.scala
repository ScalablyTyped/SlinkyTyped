...
import typingsSlinky.googleDotVisualization.googleDotVisualizationStrings.newRow
import typingsSlinky.googleDotVisualization.googleDotVisualizationStrings.sameRow
