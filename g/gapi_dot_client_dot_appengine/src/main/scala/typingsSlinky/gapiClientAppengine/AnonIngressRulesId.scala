...
object AnonIngressRulesId {
  @scala.inline
  def apply(appsId: String, ingressRulesId: String): AnonIngressRulesId = {
  ...
  @scala.inline
  implicit class AnonIngressRulesIdOps[Self <: AnonIngressRulesId] (val x: Self) extends AnyVal {
    @scala.inline
