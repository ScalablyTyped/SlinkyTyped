...
@js.native
trait AnonDomainMappingsId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonDomainMappingsId {
  @scala.inline
  def apply(appsId: String, domainMappingsId: String): AnonDomainMappingsId = {
    val __obj = js.Dynamic.literal(appsId = appsId.asInstanceOf[js.Any], domainMappingsId = domainMappingsId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDomainMappingsId]
  }
  @scala.inline
  implicit class AnonDomainMappingsIdOps[Self <: AnonDomainMappingsId] (val x: Self) extends AnyVal {
    @scala.inline
