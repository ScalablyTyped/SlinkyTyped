...
object AnonAuthorizedCertificatesId {
  @scala.inline
  def apply(appsId: String, authorizedCertificatesId: String): AnonAuthorizedCertificatesId = {
  ...
  @scala.inline
  implicit class AnonAuthorizedCertificatesIdOps[Self <: AnonAuthorizedCertificatesId] (val x: Self) extends AnyVal {
    @scala.inline
