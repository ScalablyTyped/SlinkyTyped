...
object AnonInstancesId {
  @scala.inline
  def apply(appsId: String, instancesId: String, servicesId: String, versionsId: String): AnonInstancesId = {
    ...
    __obj.asInstanceOf[AnonInstancesId]
  }
  @scala.inline
  implicit class AnonInstancesIdOps[Self <: AnonInstancesId] (val x: Self) extends AnyVal {
    @scala.inline
