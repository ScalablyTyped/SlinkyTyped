...
@js.native
trait AnonLocationsId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonLocationsId {
  @scala.inline
  def apply(appsId: String, locationsId: String): AnonLocationsId = {
    val __obj = js.Dynamic.literal(appsId = appsId.asInstanceOf[js.Any], locationsId = locationsId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLocationsId]
  }
  @scala.inline
  implicit class AnonLocationsIdOps[Self <: AnonLocationsId] (val x: Self) extends AnyVal {
    @scala.inline
