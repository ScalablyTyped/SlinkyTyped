...
@js.native
trait AnonServicesId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonServicesId {
  @scala.inline
  def apply(appsId: String, servicesId: String, versionsId: String): AnonServicesId = {
    ...
    __obj.asInstanceOf[AnonServicesId]
  }
  @scala.inline
  implicit class AnonServicesIdOps[Self <: AnonServicesId] (val x: Self) extends AnyVal {
    @scala.inline
