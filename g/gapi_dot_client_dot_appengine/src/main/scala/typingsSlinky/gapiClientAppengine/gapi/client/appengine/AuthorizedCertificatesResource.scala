...
import typingsSlinky.gapiClientAppengine.anon.Alt
import typingsSlinky.gapiClientAppengine.anon.AppsId
import typingsSlinky.gapiClientAppengine.anon.AuthorizedCertificatesId
import typingsSlinky.gapiClientAppengine.anon.Bearertoken
...
object AuthorizedCertificatesResource {
  ...
  implicit class AuthorizedCertificatesResourceOps[Self <: AuthorizedCertificatesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: Accesstoken => Request[AuthorizedCertificate]): Self = {
    ...
    @scala.inline
    def withGet(value: AppsId => Request[AuthorizedCertificate]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withList(value: Bearertoken => Request[ListAuthorizedCertificatesResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("list")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPatch(value: AuthorizedCertificatesId => Request[AuthorizedCertificate]): Self = {
        val ret = this.duplicate
