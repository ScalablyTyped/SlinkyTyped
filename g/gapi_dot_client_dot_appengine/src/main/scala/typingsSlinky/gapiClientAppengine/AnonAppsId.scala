...
@js.native
trait AnonAppsId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonAppsId {
  @scala.inline
  def apply(appsId: String, authorizedCertificatesId: String): AnonAppsId = {
    ...
    __obj.asInstanceOf[AnonAppsId]
  }
  @scala.inline
  implicit class AnonAppsIdOps[Self <: AnonAppsId] (val x: Self) extends AnyVal {
    @scala.inline
