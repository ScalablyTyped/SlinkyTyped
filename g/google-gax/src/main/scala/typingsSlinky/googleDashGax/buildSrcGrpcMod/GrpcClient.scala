...
import typingsSlinky.atGrpcProtoDashLoader.atGrpcProtoDashLoaderMod.Options
import typingsSlinky.googleDashAuthDashLibrary.googleDashAuthDashLibraryMod.GoogleAuth
import typingsSlinky.googleDashGax.Anon_Encode
...
class GrpcClient () extends js.Object {
  ...
  def metadataBuilder(headers: OutgoingHttpHeaders): js.Function2[
    ...
    typingsSlinky.atGrpcGrpcDashJs.atGrpcGrpcDashJsMod.Metadata
  ] = js.native
}
...
object GrpcClient extends js.Object {
  ...
  /**
    ...
    *   for an object.
    */
  def createByteLengthFunction(message: Anon_Encode): js.Function1[/* obj */ js.Object, Double] = js.native
}
