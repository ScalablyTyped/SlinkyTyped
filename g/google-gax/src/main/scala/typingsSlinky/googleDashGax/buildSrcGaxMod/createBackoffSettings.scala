...
@js.native
object createBackoffSettings extends js.Object {
  def apply(initialRetryDelayMillis: Double, retryDelayMultiplier: Double, maxRetryDelayMillis: Double): BackoffSettings = js.native
  def apply(
