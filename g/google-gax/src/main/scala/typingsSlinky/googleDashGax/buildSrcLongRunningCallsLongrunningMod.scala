...
import typingsSlinky.googleDashGax.buildSrcGrpcMod.Metadata
...
@js.native
object buildSrcLongRunningCallsLongrunningMod extends js.Object {
  @js.native
  ...
  def operation(op: LROOperation, longrunningDescriptor: LongRunningDescriptor, backoffSettings: BackoffSettings): Operation = js.native
  def operation(
    op: LROOperation,
    longrunningDescriptor: LongRunningDescriptor,
    backoffSettings: BackoffSettings,
  ...
  type LROOperation = typingsSlinky.googleDashGax.buildProtosOperationsMod.google.longrunning.Operation
}
