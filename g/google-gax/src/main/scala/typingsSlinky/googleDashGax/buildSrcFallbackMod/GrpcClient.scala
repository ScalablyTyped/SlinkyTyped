...
import typingsSlinky.googleDashGax.Anon_Auth
...
import typingsSlinky.protobufjs.protobufjsMod.Service
...
class GrpcClient () extends js.Object {
  ...
  /**
    ...
    */
  def createStub(service: Service, opts: ClientStubOptions): js.Promise[typingsSlinky.protobufjs.protobufjsMod.rpc.Service] = js.native
  /**
