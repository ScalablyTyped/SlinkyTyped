...
@JSImport("google-gax", "protobufMinimal.Namespace")
@js.native
class Namespace protected ()
  extends typingsSlinky.protobufjs.minimalMod.Namespace {
  /**
...
object Namespace {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobufMinimal.Namespace.arrayToJSON")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobufMinimal.Namespace.fromJSON")
  @js.native
  def fromJSON(name: String, json: StringDictionary[js.Any]): typingsSlinky.protobufjs.mod.Namespace = js.native
  
  @JSImport("google-gax", "protobufMinimal.Namespace.isReservedId")
  @js.native
  ...
  @JSImport("google-gax", "protobufMinimal.Namespace.isReservedName")
  @js.native
