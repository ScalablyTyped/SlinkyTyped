...
object Type {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobufMinimal.Type.d")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobufMinimal.Type.fromJSON")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobufMinimal.Type.generateConstructor")
  @js.native
