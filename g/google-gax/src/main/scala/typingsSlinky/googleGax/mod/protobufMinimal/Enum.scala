...
import typingsSlinky.protobufjs.mod.IEnum
...
class Enum protected ()
  extends typingsSlinky.protobufjs.minimalMod.Enum {
  /**
...
object Enum {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobufMinimal.Enum.fromJSON")
  @js.native
  def fromJSON(name: String, json: IEnum): typingsSlinky.protobufjs.mod.Enum = js.native
}
