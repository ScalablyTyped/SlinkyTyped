...
@JSImport("google-gax", "fallback.protobufMinimal.Root")
@js.native
/**
  ...
  */
class Root ()
  extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.Root {
...
object Root {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Root.fromJSON")
  @js.native
