...
class OneOf protected ()
  extends typingsSlinky.googleGax.fallbackMod.protobuf.OneOf {
  /**
...
object OneOf {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobuf.OneOf.d")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobuf.OneOf.fromJSON")
  @js.native
