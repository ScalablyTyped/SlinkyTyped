...
@JSImport("google-gax", "fallback.protobufMinimal.Method")
@js.native
class Method protected ()
  extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.Method {
  /**
...
object Method {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Method.fromJSON")
  @js.native
