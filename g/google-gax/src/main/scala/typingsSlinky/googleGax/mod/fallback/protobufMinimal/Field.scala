...
class Field protected ()
  extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.Field {
  /**
...
object Field {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Field.d")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Field.fromJSON")
  @js.native
