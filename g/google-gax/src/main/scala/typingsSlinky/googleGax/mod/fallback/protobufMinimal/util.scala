...
object util {
  ...
  class Array protected ()
    extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.util.Array {
  ...
  class Buffer protected ()
    extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.util.Buffer {
    def this(params: js.Any*) = this()
  }
  ...
  class EventEmitter ()
    extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.util.EventEmitter
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.Long")
  @js.native
  class Long protected ()
    extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.util.Long {
    def this(params: js.Any*) = this()
  }
  ...
  class LongBits protected ()
    extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.util.LongBits {
    /**
  ...
  class ProtocolError[T /* <: typingsSlinky.protobufjs.mod.Message[T] */] protected ()
    extends typingsSlinky.googleGax.fallbackMod.protobufMinimal.util.ProtocolError[T] {
    /**
