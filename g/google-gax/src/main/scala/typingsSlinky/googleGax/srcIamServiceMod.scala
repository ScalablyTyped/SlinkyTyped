...
import typingsSlinky.googleGax.iamServiceMod.google.iam.v1.GetIamPolicyRequest
import typingsSlinky.googleGax.iamServiceMod.google.iam.v1.Policy
import typingsSlinky.googleGax.iamServiceMod.google.iam.v1.SetIamPolicyRequest
import typingsSlinky.googleGax.iamServiceMod.google.iam.v1.TestIamPermissionsRequest
import typingsSlinky.googleGax.iamServiceMod.google.iam.v1.TestIamPermissionsResponse
...
object srcIamServiceMod {
  ...
  class IamClient protected () extends StObject {
    ...
    def this(gaxGrpc: typingsSlinky.googleGax.grpcMod.GrpcClient, options: ClientOptions) = this()
    ...
    var gaxGrpc: typingsSlinky.googleGax.grpcMod.GrpcClient | GrpcClient = js.native
