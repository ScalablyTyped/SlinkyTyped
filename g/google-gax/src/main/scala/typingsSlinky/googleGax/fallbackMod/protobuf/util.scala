...
object util {
  ...
  class Array protected ()
    extends typingsSlinky.protobufjs.mod.util.Array {
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.Buffer")
  @js.native
  class Buffer protected ()
    extends typingsSlinky.protobufjs.mod.util.Buffer {
    def this(params: js.Any*) = this()
  }
  ...
  @JSImport("google-gax/build/src/fallback", "protobuf.util.EventEmitter")
  @js.native
  /** Constructs a new event emitter instance. */
  class EventEmitter ()
    extends typingsSlinky.protobufjs.mod.util.EventEmitter
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.Long")
  @js.native
  class Long protected ()
    extends typingsSlinky.protobufjs.mod.util.Long {
    def this(params: js.Any*) = this()
  }
  ...
  class LongBits protected ()
    extends typingsSlinky.protobufjs.mod.util.LongBits {
    /**
  ...
  object LongBits {
    ...
    @JSImport("google-gax/build/src/fallback", "protobuf.util.LongBits.from")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.LongBits.fromHash")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.LongBits.fromNumber")
    @js.native
    def fromNumber(value: Double): typingsSlinky.protobufjs.mod.util.LongBits = js.native
    
    /** Zero bits. */
    /* static member */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.LongBits.zero")
    @js.native
    def zero: typingsSlinky.protobufjs.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.LongBits.zeroHash")
    @js.native
  ...
  class ProtocolError[T /* <: typingsSlinky.protobufjs.mod.Message[T] */] protected ()
    extends typingsSlinky.protobufjs.mod.util.ProtocolError[T] {
    /**
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.asPromise")
  @js.native
  ...
  object base64 {
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.base64.decode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.base64.encode")
    @js.native
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.base64.length")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.base64.test")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.camelCase")
  @js.native
  ...
  object codegen {
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.codegen")
    @js.native
    ...
    @JSImport("google-gax/build/src/fallback", "protobuf.util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.compareFieldsById")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.decorateEnum")
  @js.native
  def decorateEnum(`object`: js.Object): typingsSlinky.protobufjs.mod.Enum = js.native
  
  /** Decorator root (TypeScript). */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.decorateRoot")
  @js.native
  ...
  @JSImport("google-gax/build/src/fallback", "protobuf.util.emptyArray")
  @js.native
  val emptyArray: js.Array[js.Any] = js.native
  
  /** An immutable empty object. */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.emptyObject")
  @js.native
  ...
  object float {
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.readDoubleBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.readDoubleLE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.readFloatBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.readFloatLE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.writeDoubleBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.writeDoubleLE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.writeFloatBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.float.writeFloatLE")
    @js.native
    def writeFloatLE(`val`: Double, buf: js.typedarray.Uint8Array, pos: Double): Unit = js.native
  }
  
  /** Global object reference. */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.global")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.isInteger")
  @js.native
  def isInteger(value: js.Any): Boolean = js.native
  
  /** Whether running within node or not. */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.isNode")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.isObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.isSet")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.isString")
  @js.native
  ...
  @JSImport("google-gax/build/src/fallback", "protobuf.util.key2Re")
  @js.native
  val key2Re: js.RegExp = js.native
  
  /** Regular expression used to verify 32 bit (`int32` etc.) map keys. */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.key32Re")
  @js.native
  val key32Re: js.RegExp = js.native
  
  /** Regular expression used to verify 64 bit (`int64` etc.) map keys. */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.key64Re")
  @js.native
  ...
  @JSImport("google-gax/build/src/fallback", "protobuf.util.longToHash")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.merge")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.newError")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.oneOfSetter")
  @js.native
  ...
  object path {
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.path.isAbsolute")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.path.normalize")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.path.resolve")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.pool")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.safeProp")
  @js.native
  ...
  /**
    ...
    * @returns Destination object
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.setProperty")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.toArray")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("google-gax/build/src/fallback", "protobuf.util.ucFirst")
  @js.native
  ...
  object utf8 {
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.utf8.length")
    @js.native
    def length(string: String): Double = js.native
    ...
    /**
      ...
      * @returns String read
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.utf8.read")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax/build/src/fallback", "protobuf.util.utf8.write")
    @js.native
