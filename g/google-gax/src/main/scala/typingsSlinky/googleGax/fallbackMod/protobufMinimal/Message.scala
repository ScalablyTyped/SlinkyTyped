...
object Message {
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.create")
  @js.native
  ...
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.decode")
  @js.native
  ...
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.decodeDelimited")
  @js.native
  ...
  /**
    ...
    * @returns Writer
    */
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.encode")
  @js.native
  ...
  /**
    ...
    * @returns Writer
    */
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.encodeDelimited")
  @js.native
  ...
  /**
    ...
    * @returns Message instance
    */
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.fromObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.toObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/fallback", "protobufMinimal.Message.verify")
  @js.native
