package typingsSlinky.googleGax.operationsMod.google.protobuf.FieldDescriptorProto
...
/** Label enum. */
@JSImport("google-gax/build/protos/operations", "google.protobuf.FieldDescriptorProto.Label")
@js.native
