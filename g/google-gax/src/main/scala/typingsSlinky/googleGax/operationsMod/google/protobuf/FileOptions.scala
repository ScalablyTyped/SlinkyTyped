...
import typingsSlinky.googleGax.operationsMod.google.protobuf.FileOptions.OptimizeMode
...
object FileOptions {
  ...
  /** OptimizeMode enum. */
  @JSImport("google-gax/build/protos/operations", "google.protobuf.FileOptions.OptimizeMode")
  @js.native
  object OptimizeMode extends StObject {
    ...
    /* 2 */ val CODE_SIZE: typingsSlinky.googleGax.operationsMod.google.protobuf.FileOptions.OptimizeMode.CODE_SIZE with Double = js.native
    
    @js.native
    sealed trait LITE_RUNTIME extends OptimizeMode
    /* 3 */ val LITE_RUNTIME: typingsSlinky.googleGax.operationsMod.google.protobuf.FileOptions.OptimizeMode.LITE_RUNTIME with Double = js.native
    
    @js.native
    sealed trait SPEED extends OptimizeMode
    /* 1 */ val SPEED: typingsSlinky.googleGax.operationsMod.google.protobuf.FileOptions.OptimizeMode.SPEED with Double = js.native
  }
