...
import typingsSlinky.gridstack.anon.TypeofUtils
import typingsSlinky.gridstack.gridstackEngineMod.onChangeCB
import typingsSlinky.gridstack.gridstackNumbers.`-1`
import typingsSlinky.gridstack.gridstackNumbers.`1`
import typingsSlinky.gridstack.typesMod.ColumnOptions
...
import typingsSlinky.gridstack.typesMod.GridStackWidget
...
object mod {
  ...
  class GridStack protected () extends StObject {
    ...
    var dd: typingsSlinky.gridstack.gridstackDdMod.GridStackDD = js.native
    ...
    var engine: typingsSlinky.gridstack.gridstackEngineMod.GridStackEngine = js.native
  ...
  object GridStack {
    ...
    def Engine: Instantiable5[
        ...
        typingsSlinky.gridstack.gridstackEngineMod.GridStackEngine
      ] = js.native
    @scala.inline
    def Engine_=(
      x: Instantiable5[
  ...
  class GridStackDDJQueryUI protected ()
    extends typingsSlinky.gridstack.gridstackDdJqueryuiMod.GridStackDDJQueryUI {
    def this(grid: GridStack) = this()
  }
  ...
  class GridStackEngine ()
    extends typingsSlinky.gridstack.gridstackEngineMod.GridStackEngine {
  ...
  @js.native
  class Utils ()
    extends typingsSlinky.gridstack.utilsMod.Utils
  /* static members */
  object Utils {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.gridstack.gridstackStrings.resizestop
  */
  trait GridStackEvent extends StObject
  object GridStackEvent {
    
    @scala.inline
    def added: typingsSlinky.gridstack.gridstackStrings.added = "added".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.added]
    
    @scala.inline
    def change: typingsSlinky.gridstack.gridstackStrings.change = "change".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.change]
    
    @scala.inline
    def disable: typingsSlinky.gridstack.gridstackStrings.disable = "disable".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.disable]
    
    @scala.inline
    def dragstart: typingsSlinky.gridstack.gridstackStrings.dragstart = "dragstart".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.dragstart]
    
    @scala.inline
    def dragstop: typingsSlinky.gridstack.gridstackStrings.dragstop = "dragstop".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.dragstop]
    
    @scala.inline
    def dropped: typingsSlinky.gridstack.gridstackStrings.dropped = "dropped".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.dropped]
    
    @scala.inline
    def enable: typingsSlinky.gridstack.gridstackStrings.enable = "enable".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.enable]
    
    @scala.inline
    def removed: typingsSlinky.gridstack.gridstackStrings.removed = "removed".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.removed]
    
    @scala.inline
    def resizestart: typingsSlinky.gridstack.gridstackStrings.resizestart = "resizestart".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.resizestart]
    
    @scala.inline
    def resizestop: typingsSlinky.gridstack.gridstackStrings.resizestop = "resizestop".asInstanceOf[typingsSlinky.gridstack.gridstackStrings.resizestop]
  }
