...
object mod {
  ...
  @js.native
  def withRouter(component: ReactComponentClass[_]): js.Function1[/* props */ js.Any, ReactElement] = js.native
  ...
  object SwitchProps {
    ...
    implicit class SwitchPropsMutableBuilder[Self <: SwitchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNotFound(value: js.Function0[_] | ReactComponentClass[_]): Self = StObject.set(x, "notFound", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNotFoundComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "notFound", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNotFoundFunction0(value: () => _): Self = StObject.set(x, "notFound", js.Any.fromFunction0(value))
      
      @scala.inline
      def setNotFoundFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "notFound", value.asInstanceOf[js.Any])
