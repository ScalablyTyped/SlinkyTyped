...
object Params {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](params: T, path: String): Params[T] = {
    val __obj = js.Dynamic.literal(params = params.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
    __obj.asInstanceOf[Params[T]]
  }
  @scala.inline
  implicit class ParamsOps[Self <: Params[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with Params[T]) extends AnyVal {
    @scala.inline
