...
object Pp {
  ...
  @scala.inline
  def apply(accountId: String, filterSetId: String): Pp = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], filterSetId = filterSetId.asInstanceOf[js.Any])
