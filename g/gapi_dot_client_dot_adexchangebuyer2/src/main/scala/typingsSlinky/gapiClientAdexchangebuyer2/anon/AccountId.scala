...
object AccountId {
  @scala.inline
  def apply(accountId: String, clientAccountId: String, invitationId: String): AccountId = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], clientAccountId = clientAccountId.asInstanceOf[js.Any], invitationId = invitationId.asInstanceOf[js.Any])
