package typingsSlinky.gapiClientAdexchangebuyer2.anon
...
@js.native
trait DuplicateIdMode extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object DuplicateIdMode {
  @scala.inline
  def apply(accountId: String): DuplicateIdMode = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DuplicateIdMode]
  }
  @scala.inline
  implicit class DuplicateIdModeOps[Self <: DuplicateIdMode] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDuplicateIdMode(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("duplicateIdMode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDuplicateIdMode: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("duplicateIdMode")(js.undefined)
        ret
    }
    @scala.inline
