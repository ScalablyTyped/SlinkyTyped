...
@js.native
trait AnonCreativeId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCreativeId {
  @scala.inline
  def apply(accountId: String, creativeId: String): AnonCreativeId = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], creativeId = creativeId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCreativeId]
  }
  @scala.inline
  implicit class AnonCreativeIdOps[Self <: AnonCreativeId] (val x: Self) extends AnyVal {
    @scala.inline
