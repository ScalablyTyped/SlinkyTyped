...
@js.native
trait AnonDuplicateIdMode extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonDuplicateIdMode {
  @scala.inline
  def apply(accountId: String): AnonDuplicateIdMode = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDuplicateIdMode]
  }
  @scala.inline
  implicit class AnonDuplicateIdModeOps[Self <: AnonDuplicateIdMode] (val x: Self) extends AnyVal {
    @scala.inline
