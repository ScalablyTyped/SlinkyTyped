...
object Creative {
  ...
  implicit class CreativeOps[Self <: Creative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCorrections(value: js.Array[Correction]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFilteringStats(value: FilteringStats): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHtml(value: HtmlContent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNative(value: NativeContent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withServingRestrictions(value: js.Array[ServingRestriction]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVideo(value: VideoContent): Self = {
        val ret = this.duplicate
