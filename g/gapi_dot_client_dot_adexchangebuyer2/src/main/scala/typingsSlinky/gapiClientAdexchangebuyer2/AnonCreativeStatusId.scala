...
@js.native
trait AnonCreativeStatusId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCreativeStatusId {
  @scala.inline
  def apply(accountId: String, creativeStatusId: Double, filterSetId: String): AnonCreativeStatusId = {
    ...
    __obj.asInstanceOf[AnonCreativeStatusId]
  }
  @scala.inline
  implicit class AnonCreativeStatusIdOps[Self <: AnonCreativeStatusId] (val x: Self) extends AnyVal {
    @scala.inline
