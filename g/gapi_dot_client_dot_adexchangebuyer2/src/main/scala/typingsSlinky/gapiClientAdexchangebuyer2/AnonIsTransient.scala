...
@js.native
trait AnonIsTransient extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonIsTransient {
  @scala.inline
  def apply(accountId: String): AnonIsTransient = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIsTransient]
  }
  @scala.inline
  implicit class AnonIsTransientOps[Self <: AnonIsTransient] (val x: Self) extends AnyVal {
    @scala.inline
