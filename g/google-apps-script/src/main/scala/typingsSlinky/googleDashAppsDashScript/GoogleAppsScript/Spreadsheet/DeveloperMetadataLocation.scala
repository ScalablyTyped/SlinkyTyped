...
trait DeveloperMetadataLocation extends js.Object {
  ...
  def getSpreadsheet(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet | Null
}
...
object DeveloperMetadataLocation {
  ...
  def apply(
    ...
    getRow: () => Range | Null,
    getSheet: () => Sheet | Null,
    getSpreadsheet: () => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet | Null
