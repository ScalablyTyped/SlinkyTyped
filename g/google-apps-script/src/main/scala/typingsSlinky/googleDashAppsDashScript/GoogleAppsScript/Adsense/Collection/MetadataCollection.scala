...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.Metadata.DimensionsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.Metadata.MetricsCollection
