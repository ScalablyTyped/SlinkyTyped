...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.ColorType
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.RgbColor
