...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.AccountsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.AccountstatusesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.AccounttaxCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.DatafeedsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.DatafeedstatusesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.InventoryCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.LiasettingsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderinvoicesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderpaymentsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderreportsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderreturnsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrdersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.PosCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.ProductsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.ProductstatusesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.ShippingsettingsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Account
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountAddress
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountAdwordsLink
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountBusinessInformation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountCustomerService
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountGoogleMyBusinessLink
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountTax
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountTaxTaxRule
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountUser
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountYouTubeChannelLink
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsCustomBatchRequestEntryLinkRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsLinkRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountstatusesCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountstatusesCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccounttaxCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccounttaxCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Amount
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CarrierRate
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CustomAttribute
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CustomGroup
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CutoffTime
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Datafeed
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedFetchSchedule
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedFormat
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedTarget
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedsCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedsCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedstatusesCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedstatusesCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DeliveryTime
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Error
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Headers
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.HolidayCutoff
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Installment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Inventory
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventoryCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventoryCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventoryPickup
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventorySetRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InvoiceSummary
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InvoiceSummaryAdditionalChargeSummary
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaAboutPageSettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaCountrySettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaInventorySettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaOnDisplayToOrderSettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaPosDataProvider
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaSettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiasettingsCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiasettingsCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LocationIdSet
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LoyaltyPoints
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLegacyPromotion
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLegacyPromotionBenefit
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemProductVariantAttribute
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemReturnInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemShippingDetails
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemShippingDetailsMethod
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderMerchantProvidedAnnotation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderShipmentLineItemShipment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderinvoicesCreateChargeInvoiceRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderinvoicesCreateRefundInvoiceRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceRefundOption
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceReturnOption
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderpaymentsNotifyAuthApprovedRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderpaymentsNotifyAuthDeclinedRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderpaymentsNotifyChargeRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderpaymentsNotifyRefundRequest
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryCancel
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryCancelLineItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryCreateTestReturnReturnItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryInStoreRefundLineItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryRefund
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryRejectReturnLineItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryReturnLineItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryReturnRefundLineItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntrySetLineItemMetadata
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryShipLineItems
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryShipLineItemsShipmentInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryUpdateLineItemShippingDetails
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryUpdateShipment
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosInventory
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosInventoryRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosSale
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosSaleRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosStore
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PostalCodeGroup
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PostalCodeRange
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Price
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Product
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductAspect
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductDestination
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductShipping
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductShippingDimension
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductShippingWeight
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductTax
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductUnitPricingBaseMeasure
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductUnitPricingMeasure
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductsCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductsCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductstatusesCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductstatusesCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Promotion
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.RateGroup
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Row
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Service
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShipmentInvoice
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShipmentInvoiceLineItemInvoice
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingSettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingsettingsCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingsettingsCustomBatchRequestEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Table
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrder
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderCustomer
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderCustomerMarketingRightsInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderLineItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderLineItemProduct
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderPaymentMethod
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TransitTable
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TransitTableTransitTimeRow
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TransitTableTransitTimeRowTransitTimeValue
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.UnitInvoice
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.UnitInvoiceAdditionalCharge
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.UnitInvoiceTaxLine
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Value
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Weight
