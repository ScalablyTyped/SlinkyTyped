...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingsettingsCustomBatchResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingsettingsGetSupportedCarriersResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingsettingsGetSupportedHolidaysResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingsettingsListResponse
