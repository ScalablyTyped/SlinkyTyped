...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.Subscription
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.SubscriptionsListResponse
