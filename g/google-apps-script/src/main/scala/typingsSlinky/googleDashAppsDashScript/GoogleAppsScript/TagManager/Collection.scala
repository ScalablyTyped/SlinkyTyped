package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager

import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.EnvironmentsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Version_headersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.VersionsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.Built_in_variablesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.FoldersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.TagsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.TriggersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.VariablesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.ZonesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.WorkspacesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.ContainersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Collection.Accounts.User_permissionsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Account
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Container
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ContainerVersion
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ContainerVersionHeader
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.CreateBuiltInVariableResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.CreateContainerVersionRequestVersionOptions
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.CreateContainerVersionResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Entity
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Environment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Folder
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.FolderEntities
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.GetWorkspaceStatusResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListAccountsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListContainerVersionsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListContainersResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListEnabledBuiltInVariablesResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListEnvironmentsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListFoldersResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListTagsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListTriggersResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListUserPermissionsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListVariablesResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListWorkspacesResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.ListZonesResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.PublishContainerVersionResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.QuickPreviewResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.RevertBuiltInVariableResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.RevertFolderResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.RevertTagResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.RevertTriggerResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.RevertVariableResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.RevertZoneResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.SyncWorkspaceResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Tag
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Trigger
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.UserPermission
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Variable
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Workspace
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.TagManager.Schema.Zone
