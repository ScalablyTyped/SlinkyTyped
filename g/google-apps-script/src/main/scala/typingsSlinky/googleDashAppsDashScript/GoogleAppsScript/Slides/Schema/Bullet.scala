...
trait Bullet extends js.Object {
  var bulletStyle: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextStyle] = js.undefined
...
object Bullet {
  @scala.inline
  def apply(
    bulletStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextStyle = null,
    glyph: String = null,
    listId: String = null,
