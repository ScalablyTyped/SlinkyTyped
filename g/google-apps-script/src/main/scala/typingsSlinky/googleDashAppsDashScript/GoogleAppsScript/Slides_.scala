...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Collection.PresentationsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.AffineTransform
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.AutoText
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.BatchUpdatePresentationRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Bullet
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ColorScheme
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ColorStop
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateImageRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateLineRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateParagraphBulletsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateShapeRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateSheetsChartRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateSlideRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateTableRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateVideoRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CropProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteObjectRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteParagraphBulletsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteTableColumnRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteTableRowRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteTextRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Dimension
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DuplicateObjectRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Group
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.GroupObjectsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Image
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ImageProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.InsertTableColumnsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.InsertTableRowsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.InsertTextRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LayoutPlaceholderIdMapping
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LayoutProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LayoutReference
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Line
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineConnection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Link
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.MasterProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.MergeTableCellsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.NotesProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.OpaqueColor
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.OptionalColor
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Outline
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.OutlineFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageBackgroundFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageElement
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageElementProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ParagraphMarker
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ParagraphStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Placeholder
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Presentation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Range
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Recolor
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.RefreshSheetsChartRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceAllShapesWithImageRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceAllShapesWithSheetsChartRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceAllTextRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceImageRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Request
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.RerouteLineRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.RgbColor
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Shadow
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Shape
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ShapeBackgroundFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ShapeProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SheetsChart
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SheetsChartProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Size
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SlideProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SolidFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.StretchedPictureFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SubstringMatchCriteria
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Table
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderCell
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderRow
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCell
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCellBackgroundFill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCellLocation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCellProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableColumnProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRange
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRow
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRowProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextContent
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextElement
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextRun
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ThemeColorPair
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UngroupObjectsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UnmergeTableCellsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateImagePropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateLineCategoryRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateLinePropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePageElementAltTextRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePageElementTransformRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePageElementsZOrderRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePagePropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateParagraphStyleRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateShapePropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateSlidesPositionRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableBorderPropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableCellPropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableColumnPropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableRowPropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTextStyleRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateVideoPropertiesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Video
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.VideoProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.WeightedFontFamily
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.WordArt
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.WriteControl
