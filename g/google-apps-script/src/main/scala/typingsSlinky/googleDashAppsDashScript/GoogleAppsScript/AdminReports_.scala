...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminReports.Collection.ActivitiesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminReports.Collection.ChannelsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminReports.Collection.CustomerUsageReportsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminReports.Collection.EntityUsageReportsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminReports.Collection.UserUsageReportCollection
