...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Schema.AdsenseReportsGenerateResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Schema.SavedReports
