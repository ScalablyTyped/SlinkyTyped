package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Cache
...
trait CacheService extends js.Object {
  def getDocumentCache(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Cache.Cache | Null
  def getScriptCache(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Cache.Cache | Null
  def getUserCache(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Cache.Cache | Null
}

object CacheService {
  @scala.inline
  def apply(
    getDocumentCache: () => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Cache.Cache | Null,
    getScriptCache: () => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Cache.Cache | Null,
    getUserCache: () => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Cache.Cache | Null
  ): CacheService = {
