...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Collection.ContactGroupsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Collection.PeopleCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Address
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.AgeRangeType
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Biography
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Birthday
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.BraggingRights
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.ContactGroup
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.ContactGroupMembership
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.ContactGroupMetadata
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.CoverPhoto
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.CreateContactGroupRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Date
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.DomainMembership
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.EmailAddress
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Event
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.FieldMetadata
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Gender
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.ImClient
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Interest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Locale
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Membership
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.ModifyContactGroupMembersRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Name
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Nickname
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Occupation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Organization
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Person
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.PersonMetadata
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.PhoneNumber
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Photo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.ProfileMetadata
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Relation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.RelationshipInterest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.RelationshipStatus
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Residence
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.SipAddress
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Skill
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Source
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Tagline
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.UpdateContactGroupRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.Url
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.UserDefined
