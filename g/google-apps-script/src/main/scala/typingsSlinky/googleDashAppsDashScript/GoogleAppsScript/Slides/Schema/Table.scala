...
trait Table extends js.Object {
  ...
  var tableRows: js.UndefOr[
    js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRow]
  ] = js.undefined
...
object Table {
  ...
  def apply(
    ...
    tableRows: js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRow] = null,
