...
object FeedbackType extends js.Object {
  ...
  /* 0 */ val CORRECT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Forms.FeedbackType.CORRECT with Double = js.native
  /* 2 */ val GENERAL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Forms.FeedbackType.GENERAL with Double = js.native
  /* 1 */ val INCORRECT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Forms.FeedbackType.INCORRECT with Double = js.native
  @JSBracketAccess
