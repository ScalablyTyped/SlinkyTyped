...
object PageType extends js.Object {
  ...
  /* 2 */ val ANNOUNCEMENT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Sites.PageType.ANNOUNCEMENT with Double = js.native
  /* 3 */ val ANNOUNCEMENTS_PAGE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Sites.PageType.ANNOUNCEMENTS_PAGE with Double = js.native
  /* 4 */ val FILE_CABINET_PAGE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Sites.PageType.FILE_CABINET_PAGE with Double = js.native
  /* 1 */ val LIST_PAGE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Sites.PageType.LIST_PAGE with Double = js.native
  /* 0 */ val WEB_PAGE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Sites.PageType.WEB_PAGE with Double = js.native
  @JSBracketAccess
