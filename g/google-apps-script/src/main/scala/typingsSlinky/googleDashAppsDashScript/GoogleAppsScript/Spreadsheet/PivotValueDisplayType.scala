...
object PivotValueDisplayType extends js.Object {
  ...
  /* 0 */ val DEFAULT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.PivotValueDisplayType.DEFAULT with Double = js.native
  /* 2 */ val PERCENT_OF_COLUMN_TOTAL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.PivotValueDisplayType.PERCENT_OF_COLUMN_TOTAL with Double = js.native
  /* 3 */ val PERCENT_OF_GRAND_TOTAL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.PivotValueDisplayType.PERCENT_OF_GRAND_TOTAL with Double = js.native
  /* 1 */ val PERCENT_OF_ROW_TOTAL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.PivotValueDisplayType.PERCENT_OF_ROW_TOTAL with Double = js.native
  @JSBracketAccess
