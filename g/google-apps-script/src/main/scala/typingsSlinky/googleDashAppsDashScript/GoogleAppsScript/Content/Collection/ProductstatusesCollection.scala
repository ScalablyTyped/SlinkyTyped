...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductStatus
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductstatusesCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductstatusesCustomBatchResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductstatusesListResponse
