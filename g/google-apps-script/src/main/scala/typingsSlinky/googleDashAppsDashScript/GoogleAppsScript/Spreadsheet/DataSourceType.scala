...
object DataSourceType extends js.Object {
  ...
  /* 1 */ val BIGQUERY: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DataSourceType.BIGQUERY with Double = js.native
  /* 0 */ val DATA_SOURCE_TYPE_UNSUPPORTED: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DataSourceType.DATA_SOURCE_TYPE_UNSUPPORTED with Double = js.native
  @JSBracketAccess
