...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ContentOwner
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ContentOwnerListResponse
