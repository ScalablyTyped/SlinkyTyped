...
object BigQueryParameterType extends js.Object {
  ...
  /* 2 */ val BOOL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Data_Studio.BigQueryParameterType.BOOL with Double = js.native
  /* 3 */ val FLOAT64: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Data_Studio.BigQueryParameterType.FLOAT64 with Double = js.native
  /* 1 */ val INT64: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Data_Studio.BigQueryParameterType.INT64 with Double = js.native
  /* 0 */ val STRING: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Data_Studio.BigQueryParameterType.STRING with Double = js.native
  @JSBracketAccess
