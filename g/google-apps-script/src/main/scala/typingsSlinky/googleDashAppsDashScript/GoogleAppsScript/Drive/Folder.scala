...
trait Folder extends js.Object {
  ...
  def addEditor(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): Folder = js.native
  ...
  def addViewer(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): Folder = js.native
  ...
  def removeEditor(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): Folder = js.native
  ...
  def removeViewer(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): Folder = js.native
  def revokePermissions(user: String): Folder = js.native
  def revokePermissions(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): Folder = js.native
  ...
  def setOwner(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): Folder = js.native
