...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Collection.AccountsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Collection.ContactsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Collection.LocationsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Collection.SettingsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Collection.SubscriptionsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Collection.TimelineCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.Account
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.Attachment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.AuthToken
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.Command
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.MenuItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.MenuValue
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.Notification
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.NotificationConfig
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.UserAction
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.UserData
