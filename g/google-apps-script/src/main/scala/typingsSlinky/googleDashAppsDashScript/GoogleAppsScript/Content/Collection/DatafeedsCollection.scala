...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedsCustomBatchResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedsFetchNowResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedsListResponse
