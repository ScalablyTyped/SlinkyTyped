package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Tasks
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Tasks.Schema.TaskLists
...
object Collection extends js.Object {
  ...
  trait TasksCollection extends js.Object {
    ...
    def list(tasklist: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Tasks.Schema.Tasks = js.native
    // Returns all tasks in the specified task list.
    def list(tasklist: String, optionalArgs: js.Object): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Tasks.Schema.Tasks = js.native
