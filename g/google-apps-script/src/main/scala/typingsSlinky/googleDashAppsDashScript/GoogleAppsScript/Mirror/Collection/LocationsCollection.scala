...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.Location
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.LocationsListResponse
