...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Acl
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.AclRule
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.CalendarList
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Settings
...
object Collection extends js.Object {
  ...
  trait CalendarsCollection extends js.Object {
    ...
    def get(calendarId: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Returns metadata for a calendar.
    def get(calendarId: String, optionalArgs: js.Object, headers: js.Object): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Creates a secondary calendar.
    def insert(resource: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Creates a secondary calendar.
    def insert(
      resource: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar,
      optionalArgs: js.Object,
      headers: js.Object
    ): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
