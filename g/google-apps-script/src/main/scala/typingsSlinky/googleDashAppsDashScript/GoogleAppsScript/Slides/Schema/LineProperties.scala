...
trait LineProperties extends js.Object {
  ...
  var lineFill: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineFill] = js.undefined
  var link: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Link] = js.undefined
...
object LineProperties {
  ...
  def apply(
    ...
    lineFill: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineFill = null,
    link: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Link = null,
