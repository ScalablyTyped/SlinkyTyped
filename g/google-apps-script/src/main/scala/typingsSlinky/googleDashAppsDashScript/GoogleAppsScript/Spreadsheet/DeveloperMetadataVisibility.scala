...
object DeveloperMetadataVisibility extends js.Object {
  ...
  /* 0 */ val DOCUMENT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DeveloperMetadataVisibility.DOCUMENT with Double = js.native
  /* 1 */ val PROJECT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DeveloperMetadataVisibility.PROJECT with Double = js.native
  @JSBracketAccess
