...
object SelectionType extends js.Object {
  ...
  /* 6 */ val CURRENT_PAGE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SelectionType.CURRENT_PAGE with Double = js.native
  /* 1 */ val NONE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SelectionType.NONE with Double = js.native
  /* 4 */ val PAGE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SelectionType.PAGE with Double = js.native
  /* 5 */ val PAGE_ELEMENT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SelectionType.PAGE_ELEMENT with Double = js.native
  /* 3 */ val TABLE_CELL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SelectionType.TABLE_CELL with Double = js.native
  /* 2 */ val TEXT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SelectionType.TEXT with Double = js.native
  /* 0 */ val UNSUPPORTED: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SelectionType.UNSUPPORTED with Double = js.native
  @JSBracketAccess
