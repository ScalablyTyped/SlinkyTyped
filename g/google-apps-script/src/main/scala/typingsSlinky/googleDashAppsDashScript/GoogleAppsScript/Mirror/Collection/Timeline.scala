...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.Attachment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Mirror.Schema.AttachmentsListResponse
