...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Collection.ColumnCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Collection.QueryCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Collection.StyleCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Collection.TableCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Collection.TaskCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Collection.TemplateCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.Bucket
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.Column
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.ColumnBaseColumn
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.LineStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.PointStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.PolygonStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.StyleFunction
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.StyleFunctionGradient
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.FusionTables.Schema.StyleFunctionGradientColors
