...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.AccountsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.AdclientsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.AdunitsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.AlertsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.CustomchannelsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.MetadataCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.PaymentsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.ReportsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.SavedadstylesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Adsense.Collection.UrlchannelsCollection
