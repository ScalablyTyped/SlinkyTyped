...
trait XmlService extends js.Object {
  ...
  def createDocument(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.XML_Service.Document = js.native
  def createDocument(rootElement: Element): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.XML_Service.Document = js.native
  ...
  def parse(xml: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.XML_Service.Document = js.native
}
