...
object ContentAlignment extends js.Object {
  ...
  /* 3 */ val BOTTOM: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.ContentAlignment.BOTTOM with Double = js.native
  /* 2 */ val MIDDLE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.ContentAlignment.MIDDLE with Double = js.native
  /* 1 */ val TOP: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.ContentAlignment.TOP with Double = js.native
  /* 0 */ val UNSUPPORTED: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.ContentAlignment.UNSUPPORTED with Double = js.native
  @JSBracketAccess
