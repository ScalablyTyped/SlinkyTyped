package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.Groups

import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Alias
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Aliases
