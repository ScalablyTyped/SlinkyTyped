...
import typingsSlinky.googleDashAppsDashScript.Anon_ContentsOnly
...
trait Sheet extends js.Object {
  ...
  def copyTo(spreadsheet: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet): Sheet = js.native
  ...
  def getParent(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
