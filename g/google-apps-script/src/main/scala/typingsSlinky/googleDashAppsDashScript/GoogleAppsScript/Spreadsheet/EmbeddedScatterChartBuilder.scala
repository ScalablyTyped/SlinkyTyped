...
trait EmbeddedScatterChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedScatterChartBuilder
  ...
  def setTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedScatterChartBuilder
  ...
  def setXAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedScatterChartBuilder
  def setXAxisTitle(title: String): EmbeddedScatterChartBuilder
  def setXAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedScatterChartBuilder
  def setYAxisLogScale(): EmbeddedScatterChartBuilder
  def setYAxisRange(start: Double, end: Double): EmbeddedScatterChartBuilder
  def setYAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedScatterChartBuilder
  def setYAxisTitle(title: String): EmbeddedScatterChartBuilder
  def setYAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedScatterChartBuilder
}
...
object EmbeddedScatterChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedScatterChartBuilder,
    ...
    setTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedScatterChartBuilder,
    ...
    setXAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedScatterChartBuilder,
    setXAxisTitle: String => EmbeddedScatterChartBuilder,
    setXAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedScatterChartBuilder,
    setYAxisLogScale: () => EmbeddedScatterChartBuilder,
    setYAxisRange: (Double, Double) => EmbeddedScatterChartBuilder,
    setYAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedScatterChartBuilder,
    setYAxisTitle: String => EmbeddedScatterChartBuilder,
    setYAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedScatterChartBuilder
