package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Collection

import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Guardian
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.GuardianInvitation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.ListGuardianInvitationsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.ListGuardiansResponse
