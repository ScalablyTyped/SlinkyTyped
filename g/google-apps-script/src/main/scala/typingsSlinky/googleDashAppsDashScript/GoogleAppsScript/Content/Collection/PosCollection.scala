...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosCustomBatchResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosInventoryRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosInventoryResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosListResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosSaleRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosSaleResponse
