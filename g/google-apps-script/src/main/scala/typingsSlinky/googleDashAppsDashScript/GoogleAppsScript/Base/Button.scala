...
object Button extends js.Object {
  ...
  /* 2 */ val CANCEL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.Button.CANCEL with Double = js.native
  /* 0 */ val CLOSE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.Button.CLOSE with Double = js.native
  /* 4 */ val NO: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.Button.NO with Double = js.native
  /* 1 */ val OK: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.Button.OK with Double = js.native
  /* 3 */ val YES: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.Button.YES with Double = js.native
  @JSBracketAccess
