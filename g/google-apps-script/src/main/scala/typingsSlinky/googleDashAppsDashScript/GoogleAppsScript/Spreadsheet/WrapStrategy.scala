...
object WrapStrategy extends js.Object {
  ...
  /* 2 */ val CLIP: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.WrapStrategy.CLIP with Double = js.native
  /* 1 */ val OVERFLOW: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.WrapStrategy.OVERFLOW with Double = js.native
  /* 0 */ val WRAP: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.WrapStrategy.WRAP with Double = js.native
  @JSBracketAccess
