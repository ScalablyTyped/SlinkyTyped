...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.DriveActivity.Collection.ActivityCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.DriveActivity.Schema.ConsolidationStrategy
