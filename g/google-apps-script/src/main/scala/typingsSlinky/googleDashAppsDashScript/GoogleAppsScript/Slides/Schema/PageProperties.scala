...
trait PageProperties extends js.Object {
  var colorScheme: js.UndefOr[
    typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ColorScheme
  ] = js.undefined
...
object PageProperties {
  @scala.inline
  def apply(
    colorScheme: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ColorScheme = null,
