...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.Project
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.ProjectsListResponse
