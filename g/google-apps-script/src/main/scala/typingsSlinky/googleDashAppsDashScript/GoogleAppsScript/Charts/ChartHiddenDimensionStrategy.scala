...
object ChartHiddenDimensionStrategy extends js.Object {
  ...
  /* 0 */ val IGNORE_BOTH: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.ChartHiddenDimensionStrategy.IGNORE_BOTH with Double = js.native
  /* 2 */ val IGNORE_COLUMNS: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.ChartHiddenDimensionStrategy.IGNORE_COLUMNS with Double = js.native
  /* 1 */ val IGNORE_ROWS: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.ChartHiddenDimensionStrategy.IGNORE_ROWS with Double = js.native
  /* 3 */ val SHOW_BOTH: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.ChartHiddenDimensionStrategy.SHOW_BOTH with Double = js.native
  @JSBracketAccess
