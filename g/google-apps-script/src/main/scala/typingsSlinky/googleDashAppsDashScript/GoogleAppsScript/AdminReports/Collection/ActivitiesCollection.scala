...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminReports.Schema.Activities
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminReports.Schema.Channel
