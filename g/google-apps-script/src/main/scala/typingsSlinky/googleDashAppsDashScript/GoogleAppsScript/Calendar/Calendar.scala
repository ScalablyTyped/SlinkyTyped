...
trait Calendar extends js.Object {
  ...
  def setColor(color: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setDescription(description: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setHidden(hidden: Boolean): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setName(name: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setSelected(selected: Boolean): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setTimeZone(timeZone: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
