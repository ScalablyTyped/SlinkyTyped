...
trait Revision extends js.Object {
  ...
  var lastModifyingUser: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Drive.Schema.User] = js.undefined
...
object Revision {
  ...
  def apply(
    ...
    id: String = null,
    kind: String = null,
    lastModifyingUser: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Drive.Schema.User = null,
