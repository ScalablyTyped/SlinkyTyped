...
object ButtonSet extends js.Object {
  ...
  /* 0 */ val OK: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.ButtonSet.OK with Double = js.native
  /* 1 */ val OK_CANCEL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.ButtonSet.OK_CANCEL with Double = js.native
  /* 2 */ val YES_NO: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.ButtonSet.YES_NO with Double = js.native
  /* 3 */ val YES_NO_CANCEL: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.ButtonSet.YES_NO_CANCEL with Double = js.native
  @JSBracketAccess
