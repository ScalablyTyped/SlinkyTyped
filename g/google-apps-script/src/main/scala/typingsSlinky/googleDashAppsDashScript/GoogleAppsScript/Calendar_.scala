...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.AclCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.CalendarListCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.CalendarsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.ChannelsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.ColorsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.EventsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.FreebusyCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Collection.SettingsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.AclRule
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.AclRuleScope
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.CalendarListEntry
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.CalendarListEntryNotificationSettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.CalendarNotification
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Channel
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.ConferenceData
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.ConferenceParameters
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.ConferenceParametersAddOnParameters
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.ConferenceProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.ConferenceRequestStatus
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.ConferenceSolution
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.ConferenceSolutionKey
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.CreateConferenceRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EntryPoint
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Event
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventAttachment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventAttendee
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventCreator
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventDateTime
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventExtendedProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventGadget
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventOrganizer
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventReminder
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventReminders
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.EventSource
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.FreeBusyRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.FreeBusyRequestItem
...
trait Calendar_ extends js.Object {
  ...
  def newCalendar(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar
...
object Calendar_ {
  ...
  def apply(
    ...
    newCalendar: () => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Schema.Calendar,
