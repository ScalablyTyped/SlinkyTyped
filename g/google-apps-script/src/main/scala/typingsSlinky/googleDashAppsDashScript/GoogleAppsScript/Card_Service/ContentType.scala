...
object ContentType extends js.Object {
  ...
  /* 2 */ val IMMUTABLE_HTML: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Card_Service.ContentType.IMMUTABLE_HTML with Double = js.native
  /* 1 */ val MUTABLE_HTML: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Card_Service.ContentType.MUTABLE_HTML with Double = js.native
  /* 0 */ val TEXT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Card_Service.ContentType.TEXT with Double = js.native
  @JSBracketAccess
