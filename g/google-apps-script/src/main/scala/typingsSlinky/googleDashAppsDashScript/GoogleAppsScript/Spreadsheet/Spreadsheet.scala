...
import typingsSlinky.googleDashAppsDashScript.Anon_FunctionName
import typingsSlinky.googleDashAppsDashScript.Anon_Template
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.HTML.HtmlOutput
...
trait Spreadsheet extends js.Object {
  def addDeveloperMetadata(key: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, value: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, value: String, visibility: DeveloperMetadataVisibility): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, visibility: DeveloperMetadataVisibility): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addEditor(emailAddress: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addEditor(user: User): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addEditors(emailAddresses: js.Array[String]): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addMenu(name: String, subMenus: js.Array[Anon_FunctionName | Null]): Unit = js.native
  def addViewer(emailAddress: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addViewer(user: User): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addViewers(emailAddresses: js.Array[String]): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def appendRow(rowContents: js.Array[_]): Sheet = js.native
  def autoResizeColumn(columnPosition: Integer): Sheet = js.native
  def copy(name: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def removeEditor(emailAddress: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeEditor(user: User): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeMenu(name: String): Unit = js.native
  def removeNamedRange(name: String): Unit = js.native
  def removeViewer(emailAddress: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeViewer(user: User): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def setIterativeCalculationConvergenceThreshold(minThreshold: Double): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def setIterativeCalculationEnabled(isEnabled: Boolean): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def setMaxIterativeCalculationCycles(maxIterations: Integer): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def setNamedRange(name: String, range: Range): Unit = js.native
  def setRecalculationInterval(recalculationInterval: RecalculationInterval): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
