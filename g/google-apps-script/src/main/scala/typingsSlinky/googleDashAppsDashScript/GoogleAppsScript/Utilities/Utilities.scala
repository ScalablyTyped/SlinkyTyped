...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.BlobSource
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.Date
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Byte
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Char
...
trait Utilities extends js.Object {
  ...
  def base64Decode(
    encoded: String,
    charset: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.Charset
  ): js.Array[Byte] = js.native
  def base64DecodeWebSafe(encoded: String): js.Array[Byte] = js.native
  def base64DecodeWebSafe(
    encoded: String,
    charset: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.Charset
  ): js.Array[Byte] = js.native
  def base64Encode(data: String): String = js.native
  def base64Encode(data: String, charset: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.Charset): String = js.native
  def base64Encode(data: js.Array[Byte]): String = js.native
  def base64EncodeWebSafe(data: String): String = js.native
  def base64EncodeWebSafe(data: String, charset: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.Charset): String = js.native
  def base64EncodeWebSafe(data: js.Array[Byte]): String = js.native
  def computeDigest(
    algorithm: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.DigestAlgorithm,
    value: String
  ): js.Array[Byte] = js.native
  def computeDigest(
    algorithm: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.DigestAlgorithm,
  ...
  def computeHmacSignature(
    algorithm: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.MacAlgorithm,
    value: String,
    key: String
  ): js.Array[Byte] = js.native
  def computeHmacSignature(
  ...
  def computeRsaSignature(
    algorithm: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Utilities.RsaAlgorithm,
    value: String,
    key: String
  ): js.Array[Byte] = js.native
  def computeRsaSignature(
