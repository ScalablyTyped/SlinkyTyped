...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.Ui
...
trait DocumentApp extends js.Object {
  ...
  def create(name: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document
  def getActiveDocument(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document
  def getUi(): Ui
  def openById(id: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document
  def openByUrl(url: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document
}
...
object DocumentApp {
  ...
  def apply(
    ...
    create: String => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document,
    getActiveDocument: () => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document,
    getUi: () => Ui,
    openById: String => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document,
    openByUrl: String => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Document.Document
  ): DocumentApp = {
