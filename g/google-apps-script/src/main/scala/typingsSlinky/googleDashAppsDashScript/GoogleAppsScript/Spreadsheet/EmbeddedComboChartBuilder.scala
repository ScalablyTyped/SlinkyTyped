...
trait EmbeddedComboChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  ...
  def setTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder
  def setXAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setXAxisTitle(title: String): EmbeddedComboChartBuilder
  def setXAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setYAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setYAxisTitle(title: String): EmbeddedComboChartBuilder
  def setYAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
...
object EmbeddedComboChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    ...
    setTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setXAxisTitle: String => EmbeddedComboChartBuilder,
    setXAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setYAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setYAxisTitle: String => EmbeddedComboChartBuilder,
    setYAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
