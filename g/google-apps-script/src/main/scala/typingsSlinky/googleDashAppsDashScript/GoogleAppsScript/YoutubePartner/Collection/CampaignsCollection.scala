...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Campaign
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.CampaignList
