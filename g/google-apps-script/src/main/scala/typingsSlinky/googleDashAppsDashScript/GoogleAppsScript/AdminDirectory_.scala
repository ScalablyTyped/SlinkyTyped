...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.AspsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.ChannelsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.ChromeosdevicesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.CustomersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.DomainAliasesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.DomainsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.GroupsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.MembersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.MobiledevicesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.NotificationsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.OrgunitsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.PrivilegesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.ResolvedAppAccessSettingsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.ResourcesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.RoleAssignmentsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.RolesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.SchemasCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.TokensCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.UsersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.VerificationCodesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Alias
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Building
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.BuildingAddress
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.BuildingCoordinates
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.CalendarResource
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Channel
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDevice
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceAction
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceActiveTimeRanges
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceCpuStatusReports
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceCpuStatusReportsCpuTemperatureInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceDeviceFiles
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceDiskVolumeReports
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceDiskVolumeReportsVolumeInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceRecentUsers
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceSystemRamFreeReports
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDeviceTpmVersionInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsMoveDevicesToOu
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Customer
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.CustomerPostalAddress
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.DomainAlias
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Domains
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Feature
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.FeatureRename
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Group
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Member
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.MobileDeviceAction
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Notification
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.OrgUnit
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Role
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.RoleAssignment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.RoleRolePrivileges
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Schema
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.SchemaFieldSpec
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.SchemaFieldSpecNumericIndexingSpec
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.User
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.UserMakeAdmin
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.UserName
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.UserPhoto
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.UserUndelete
