...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.CreativeGroup
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.CreativeGroupsListResponse
