...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analytics.Schema.GaData
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analytics.Schema.McfData
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analytics.Schema.RealtimeData
