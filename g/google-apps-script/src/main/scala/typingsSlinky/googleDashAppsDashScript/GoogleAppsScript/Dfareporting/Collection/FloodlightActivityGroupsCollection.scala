...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.FloodlightActivityGroup
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.FloodlightActivityGroupsListResponse
