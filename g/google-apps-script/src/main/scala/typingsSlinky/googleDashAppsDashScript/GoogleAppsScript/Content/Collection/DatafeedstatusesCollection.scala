...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedStatus
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedstatusesCustomBatchRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedstatusesCustomBatchResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedstatusesListResponse
