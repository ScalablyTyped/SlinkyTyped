package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery

import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.Dataset
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.DatasetList
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.GetQueryResultsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.GetServiceAccountResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.Job
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.JobCancelResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.JobList
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.ProjectList
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.QueryRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.QueryResponse
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.TableDataInsertAllResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.TableDataList
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Bigquery.Schema.TableList
