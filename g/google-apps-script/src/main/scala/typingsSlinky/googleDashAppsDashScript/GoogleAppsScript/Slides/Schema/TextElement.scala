...
trait TextElement extends js.Object {
  var autoText: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.AutoText] = js.undefined
...
object TextElement {
  @scala.inline
  def apply(
    autoText: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.AutoText = null,
