...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.ChartType
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.CurveStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.PointStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.Position
...
trait EmbeddedLineChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedLineChartBuilder
  ...
  def setTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedLineChartBuilder
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder
  def setXAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedLineChartBuilder
  def setXAxisTitle(title: String): EmbeddedLineChartBuilder
  def setXAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedLineChartBuilder
  def setYAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedLineChartBuilder
  def setYAxisTitle(title: String): EmbeddedLineChartBuilder
  def setYAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedLineChartBuilder
...
object EmbeddedLineChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedLineChartBuilder,
    ...
    setTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedLineChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedLineChartBuilder,
    setXAxisTitle: String => EmbeddedLineChartBuilder,
    setXAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedLineChartBuilder,
    setYAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedLineChartBuilder,
    setYAxisTitle: String => EmbeddedLineChartBuilder,
    setYAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedLineChartBuilder,
