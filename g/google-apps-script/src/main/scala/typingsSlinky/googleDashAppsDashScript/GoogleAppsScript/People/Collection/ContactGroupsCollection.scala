...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Collection.ContactGroups.MembersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.BatchGetContactGroupsResponse
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.ListContactGroupsResponse
