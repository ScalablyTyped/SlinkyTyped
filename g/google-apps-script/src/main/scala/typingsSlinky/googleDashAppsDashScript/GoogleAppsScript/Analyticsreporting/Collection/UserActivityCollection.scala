package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analyticsreporting.Collection

import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analyticsreporting.Schema.SearchUserActivityRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analyticsreporting.Schema.SearchUserActivityResponse
