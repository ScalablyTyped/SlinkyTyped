...
trait About extends js.Object {
  ...
  var user: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Drive.Schema.User] = js.undefined
}
...
object About {
  ...
  def apply(
    ...
    user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Drive.Schema.User = null
  ): About = {
