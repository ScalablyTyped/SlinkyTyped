...
trait CalendarApp extends js.Object {
  ...
  def createCalendar(name: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def createCalendar(name: String, options: StringDictionary[js.Any]): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  ...
  def getAllCalendars(): js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  def getAllOwnedCalendars(): js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  def getCalendarById(id: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def getCalendarsByName(name: String): js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  def getColor(): String = js.native
  def getDefaultCalendar(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  ...
  def getOwnedCalendarById(id: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def getOwnedCalendarsByName(name: String): js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  ...
  def subscribeToCalendar(id: String): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def subscribeToCalendar(id: String, options: StringDictionary[js.Any]): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
}
