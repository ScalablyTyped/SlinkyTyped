...
trait FileList extends js.Object {
  ...
  var items: js.UndefOr[
    js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Drive.Schema.File]
  ] = js.undefined
...
object FileList {
  ...
  def apply(
    ...
    items: js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Drive.Schema.File] = null,
    kind: String = null,
