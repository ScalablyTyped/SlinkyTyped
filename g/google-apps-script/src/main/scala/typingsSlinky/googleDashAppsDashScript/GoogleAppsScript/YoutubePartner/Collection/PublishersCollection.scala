...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Publisher
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.PublisherList
