...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTube.Schema.PlaylistItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTube.Schema.PlaylistItemListResponse
