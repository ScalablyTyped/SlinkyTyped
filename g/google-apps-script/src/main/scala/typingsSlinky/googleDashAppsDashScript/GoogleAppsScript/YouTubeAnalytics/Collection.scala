package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTubeAnalytics

import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTubeAnalytics.Schema.EmptyResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTubeAnalytics.Schema.Group
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTubeAnalytics.Schema.GroupItem
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTubeAnalytics.Schema.ListGroupItemsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTubeAnalytics.Schema.ListGroupsResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YouTubeAnalytics.Schema.QueryResponse
