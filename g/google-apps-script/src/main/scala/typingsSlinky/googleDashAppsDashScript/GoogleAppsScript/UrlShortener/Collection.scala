package typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener

import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener.Schema.Url
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener.Schema.UrlHistory
