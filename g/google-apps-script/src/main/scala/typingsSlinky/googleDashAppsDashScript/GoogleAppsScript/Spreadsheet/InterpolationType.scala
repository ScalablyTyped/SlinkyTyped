...
object InterpolationType extends js.Object {
  ...
  /* 4 */ val MAX: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.InterpolationType.MAX with Double = js.native
  /* 3 */ val MIN: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.InterpolationType.MIN with Double = js.native
  /* 0 */ val NUMBER: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.InterpolationType.NUMBER with Double = js.native
  /* 1 */ val PERCENT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.InterpolationType.PERCENT with Double = js.native
  /* 2 */ val PERCENTILE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.InterpolationType.PERCENTILE with Double = js.native
  @JSBracketAccess
