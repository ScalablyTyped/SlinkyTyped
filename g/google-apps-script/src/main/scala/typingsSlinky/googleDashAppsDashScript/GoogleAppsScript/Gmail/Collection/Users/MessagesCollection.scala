...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Gmail.Collection.Users.Messages.AttachmentsCollection
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Gmail.Schema.ListMessagesResponse
