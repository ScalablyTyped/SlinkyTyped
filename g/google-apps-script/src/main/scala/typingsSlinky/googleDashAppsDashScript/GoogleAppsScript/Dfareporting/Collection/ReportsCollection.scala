...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Collection.Reports.CompatibleFieldsCollection
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.ReportList
...
trait ReportsCollection extends js.Object {
  ...
  var Files: js.UndefOr[
    typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Collection.Reports.FilesCollection
  ] = js.native
