...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener.Collection.UrlCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener.Schema.AnalyticsSnapshot
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener.Schema.AnalyticsSummary
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener.Schema.StringCount
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.UrlShortener.Schema.Url
