...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Collection.People.ConnectionsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.People.Schema.GetPeopleResponse
