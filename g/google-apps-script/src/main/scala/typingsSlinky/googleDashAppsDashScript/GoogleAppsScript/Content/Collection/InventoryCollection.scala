...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventoryCustomBatchResponse
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventorySetRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventorySetResponse
