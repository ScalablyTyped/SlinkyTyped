...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.AssetLabelsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.AssetMatchPolicyCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.AssetRelationshipsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.AssetSearchCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.AssetSharesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.AssetsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.CampaignsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ClaimHistoryCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ClaimSearchCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ClaimsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ContentOwnerAdvertisingOptionsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ContentOwnersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.LiveCuepointsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.MetadataHistoryCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.OrdersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.OwnershipCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.OwnershipHistoryCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.PackageCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.PoliciesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.PublishersCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ReferenceConflictsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ReferencesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.SpreadsheetTemplateCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.UploaderCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.ValidatorCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.VideoAdvertisingOptionsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Collection.WhitelistsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.AdBreak
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.AdSlot
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.AllowedAdvertisingOptions
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Asset
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.AssetLabel
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.AssetMatchPolicy
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.AssetRelationship
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Campaign
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.CampaignData
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.CampaignSource
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.CampaignTargetLink
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Claim
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ClaimMatchInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ClaimMatchInfoLongestMatch
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ClaimMatchInfoTotalMatch
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ClaimOrigin
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ClaimedVideoDefaults
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Conditions
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ConflictingOwnership
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ContentOwnerAdvertisingOption
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.CuepointSettings
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Date
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.DateRange
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ExcludedInterval
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.IntervalCondition
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.LiveCuepoint
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.MatchSegment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Metadata
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Order
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Origination
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.OwnershipConflicts
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Package
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Policy
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.PolicyRule
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.PromotedContent
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Rating
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Reference
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Requirements
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.RightsOwnership
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Segment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.ShowDetails
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.StateCompleted
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.StatusReport
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.TerritoryCondition
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.TerritoryConflicts
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.TerritoryOwners
...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.Whitelist
