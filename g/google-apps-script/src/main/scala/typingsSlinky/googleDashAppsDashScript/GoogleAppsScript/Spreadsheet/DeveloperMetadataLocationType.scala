...
object DeveloperMetadataLocationType extends js.Object {
  ...
  /* 3 */ val COLUMN: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DeveloperMetadataLocationType.COLUMN with Double = js.native
  /* 2 */ val ROW: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DeveloperMetadataLocationType.ROW with Double = js.native
  /* 1 */ val SHEET: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DeveloperMetadataLocationType.SHEET with Double = js.native
  /* 0 */ val SPREADSHEET: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.DeveloperMetadataLocationType.SPREADSHEET with Double = js.native
  @JSBracketAccess
