...
object ComposedEmailType extends js.Object {
  ...
  /* 0 */ val REPLY_AS_DRAFT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Card_Service.ComposedEmailType.REPLY_AS_DRAFT with Double = js.native
  /* 1 */ val STANDALONE_DRAFT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Card_Service.ComposedEmailType.STANDALONE_DRAFT with Double = js.native
  @JSBracketAccess
