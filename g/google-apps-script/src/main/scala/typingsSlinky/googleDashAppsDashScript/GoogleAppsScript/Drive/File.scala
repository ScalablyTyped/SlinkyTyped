...
trait File extends js.Object {
  ...
  def addCommenter(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
  def addCommenters(emailAddresses: js.Array[String]): File = js.native
  def addEditor(emailAddress: String): File = js.native
  def addEditor(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
  def addEditors(emailAddresses: js.Array[String]): File = js.native
  def addViewer(emailAddress: String): File = js.native
  def addViewer(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
  def addViewers(emailAddresses: js.Array[String]): File = js.native
  def getAccess(email: String): Permission = js.native
  def getAccess(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): Permission = js.native
  ...
  def removeCommenter(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
  def removeEditor(emailAddress: String): File = js.native
  def removeEditor(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
  def removeViewer(emailAddress: String): File = js.native
  def removeViewer(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
  def revokePermissions(user: String): File = js.native
  def revokePermissions(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
  ...
  def setOwner(user: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Base.User): File = js.native
