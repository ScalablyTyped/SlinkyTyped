...
trait SlideProperties extends js.Object {
  ...
  var notesPage: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page] = js.undefined
}
...
object SlideProperties {
  ...
  def apply(
    ...
    notesPage: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page = null
  ): SlideProperties = {
