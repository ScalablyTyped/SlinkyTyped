...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analytics.Schema.Upload
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Analytics.Schema.Uploads
