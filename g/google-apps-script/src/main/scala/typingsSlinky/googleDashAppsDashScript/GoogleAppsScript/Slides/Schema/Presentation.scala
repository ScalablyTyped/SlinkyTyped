...
trait Presentation extends js.Object {
  var layouts: js.UndefOr[
    js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page]
  ] = js.undefined
  var locale: js.UndefOr[String] = js.undefined
  var masters: js.UndefOr[
    js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page]
  ] = js.undefined
  var notesMaster: js.UndefOr[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page] = js.undefined
...
object Presentation {
  @scala.inline
  def apply(
    layouts: js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page] = null,
    locale: String = null,
    masters: js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page] = null,
    notesMaster: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page = null,
    pageSize: Size = null,
    presentationId: String = null,
    revisionId: String = null,
    slides: js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page] = null,
    title: String = null
  ): Presentation = {
