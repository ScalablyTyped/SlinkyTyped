...
object TextDirection extends js.Object {
  ...
  /* 1 */ val LEFT_TO_RIGHT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.TextDirection.LEFT_TO_RIGHT with Double = js.native
  /* 2 */ val RIGHT_TO_LEFT: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.TextDirection.RIGHT_TO_LEFT with Double = js.native
  /* 0 */ val UNSUPPORTED: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.TextDirection.UNSUPPORTED with Double = js.native
  @JSBracketAccess
