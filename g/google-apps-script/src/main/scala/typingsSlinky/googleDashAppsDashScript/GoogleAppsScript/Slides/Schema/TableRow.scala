...
trait TableRow extends js.Object {
  ...
  var tableCells: js.UndefOr[
    js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCell]
  ] = js.undefined
...
object TableRow {
  ...
  def apply(
    ...
    tableCells: js.Array[typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCell] = null,
