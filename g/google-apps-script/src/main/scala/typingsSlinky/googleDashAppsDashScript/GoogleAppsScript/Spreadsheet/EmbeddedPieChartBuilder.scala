...
trait EmbeddedPieChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedPieChartBuilder
  ...
  def setTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedPieChartBuilder
...
object EmbeddedPieChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedPieChartBuilder,
    ...
    setTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedPieChartBuilder,
