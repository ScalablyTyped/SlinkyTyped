...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.MerchantOrderReturn
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderreturnsListResponse
