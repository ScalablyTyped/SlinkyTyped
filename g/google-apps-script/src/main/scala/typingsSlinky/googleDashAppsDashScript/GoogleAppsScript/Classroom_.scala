...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Collection.CoursesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Collection.InvitationsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Collection.RegistrationsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Collection.UserProfilesCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Announcement
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Assignment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.AssignmentSubmission
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Attachment
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.CloudPubsubTopic
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Course
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.CourseAlias
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.CourseMaterial
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.CourseMaterialSet
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.CourseRosterChangesInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.CourseWork
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.CourseWorkChangesInfo
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Date
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.DriveFile
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.DriveFolder
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Feed
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Form
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.GlobalPermission
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.GradeHistory
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.GuardianInvitation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.IndividualStudentsOptions
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Invitation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Link
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Material
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.ModifyAnnouncementAssigneesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.ModifyAttachmentsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.ModifyCourseWorkAssigneesRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.ModifyIndividualStudentsOptions
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.MultipleChoiceQuestion
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.MultipleChoiceSubmission
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Name
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Registration
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.SharedDriveFile
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.ShortAnswerSubmission
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.StateHistory
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Student
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.StudentSubmission
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.SubmissionHistory
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.Teacher
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.TimeOfDay
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.UserProfile
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Classroom.Schema.YouTubeVideo
