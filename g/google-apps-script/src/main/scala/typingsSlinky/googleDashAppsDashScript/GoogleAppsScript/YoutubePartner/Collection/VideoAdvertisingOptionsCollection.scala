...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.VideoAdvertisingOption
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.YoutubePartner.Schema.VideoAdvertisingOptionGetEnabledAdsResponse
