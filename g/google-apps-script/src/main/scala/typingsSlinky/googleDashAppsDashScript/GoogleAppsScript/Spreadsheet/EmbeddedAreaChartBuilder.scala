...
trait EmbeddedAreaChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  ...
  def setTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder
  def setXAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setXAxisTitle(title: String): EmbeddedAreaChartBuilder
  def setXAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setYAxisTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setYAxisTitle(title: String): EmbeddedAreaChartBuilder
  def setYAxisTitleTextStyle(textStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
...
object EmbeddedAreaChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    ...
    setTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setXAxisTitle: String => EmbeddedAreaChartBuilder,
    setXAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setYAxisTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setYAxisTitle: String => EmbeddedAreaChartBuilder,
    setYAxisTitleTextStyle: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
