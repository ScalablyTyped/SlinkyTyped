...
object Gender extends js.Object {
  ...
  /* 1 */ val FEMALE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Contacts.Gender.FEMALE with Double = js.native
  /* 0 */ val MALE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Contacts.Gender.MALE with Double = js.native
  @JSBracketAccess
