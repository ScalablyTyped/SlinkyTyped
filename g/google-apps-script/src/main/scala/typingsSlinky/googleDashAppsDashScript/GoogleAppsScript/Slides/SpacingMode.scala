...
object SpacingMode extends js.Object {
  ...
  /* 2 */ val COLLAPSE_LISTS: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SpacingMode.COLLAPSE_LISTS with Double = js.native
  /* 1 */ val NEVER_COLLAPSE: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SpacingMode.NEVER_COLLAPSE with Double = js.native
  /* 0 */ val UNSUPPORTED: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Slides.SpacingMode.UNSUPPORTED with Double = js.native
  @JSBracketAccess
