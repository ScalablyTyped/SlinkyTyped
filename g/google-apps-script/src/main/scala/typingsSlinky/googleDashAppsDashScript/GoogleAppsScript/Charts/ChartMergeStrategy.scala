...
object ChartMergeStrategy extends js.Object {
  ...
  /* 0 */ val MERGE_COLUMNS: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.ChartMergeStrategy.MERGE_COLUMNS with Double = js.native
  /* 1 */ val MERGE_ROWS: typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Charts.ChartMergeStrategy.MERGE_ROWS with Double = js.native
  @JSBracketAccess
