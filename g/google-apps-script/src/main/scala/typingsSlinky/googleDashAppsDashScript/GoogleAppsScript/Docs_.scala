...
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Collection.DocumentsCollection
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.AutoText
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Background
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.BatchUpdateDocumentRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Body
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Bullet
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Color
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.ColumnBreak
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.CreateNamedRangeRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.CreateParagraphBulletsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.DeleteContentRangeRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.DeleteNamedRangeRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.DeleteParagraphBulletsRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.DeletePositionedObjectRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.DeleteTableColumnRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.DeleteTableRowRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Dimension
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.DocumentStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.EndOfSegmentLocation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Equation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.FootnoteReference
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.HorizontalRule
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.InlineObjectElement
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.InsertInlineImageRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.InsertPageBreakRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.InsertTableRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.InsertTableRowRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.InsertTextRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Link
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Location
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.NamedStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.NamedStyles
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.OptionalColor
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.PageBreak
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Paragraph
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.ParagraphBorder
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.ParagraphElement
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.ParagraphStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Range
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.ReplaceAllTextRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Request
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.RgbColor
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.SectionBreak
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.SectionColumnProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.SectionStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Shading
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Size
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.StructuralElement
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.SubstringMatchCriteria
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TabStop
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Table
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableCell
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableCellBorder
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableCellLocation
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableCellStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableColumnProperties
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableOfContents
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableRow
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableRowStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TableStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TextRun
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.TextStyle
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.UpdateParagraphStyleRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.UpdateTextStyleRequest
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.WeightedFontFamily
import typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.WriteControl
...
trait Docs_ extends js.Object {
  ...
  def newDocument(): typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Document
...
object Docs_ {
  ...
  def apply(
    ...
    newDocument: () => typingsSlinky.googleDashAppsDashScript.GoogleAppsScript.Docs.Schema.Document,
