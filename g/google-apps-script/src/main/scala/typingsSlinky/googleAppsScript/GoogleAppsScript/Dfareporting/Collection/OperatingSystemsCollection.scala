...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.OperatingSystemsListResponse
...
object OperatingSystemsCollection {
  ...
  implicit class OperatingSystemsCollectionOps[Self <: OperatingSystemsCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: (String, String) => OperatingSystem): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withList(value: String => OperatingSystemsListResponse): Self = {
        val ret = this.duplicate
