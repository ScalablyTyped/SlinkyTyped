...
object I18nRegionListResponse {
  ...
  @scala.inline
  implicit class I18nRegionListResponseOps[Self <: I18nRegionListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: I18nRegion*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[I18nRegion]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
