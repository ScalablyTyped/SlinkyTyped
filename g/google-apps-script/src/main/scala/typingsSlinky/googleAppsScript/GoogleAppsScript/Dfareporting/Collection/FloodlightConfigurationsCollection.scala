...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.FloodlightConfiguration
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.FloodlightConfigurationsListResponse
