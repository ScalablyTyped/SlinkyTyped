...
object Lock {
  ...
  object Lock {
    ...
    def apply(
    ...
    ): typingsSlinky.googleAppsScript.GoogleAppsScript.Lock.Lock = {
      ...
      __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.Lock.Lock]
    }
    
    @scala.inline
    implicit class LockMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.Lock.Lock] (val x: Self) extends AnyVal {
  ...
  object LockService {
    ...
    implicit class LockServiceMutableBuilder[Self <: LockService] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetDocumentLock(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Lock.Lock): Self = StObject.set(x, "getDocumentLock", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetScriptLock(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Lock.Lock): Self = StObject.set(x, "getScriptLock", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetUserLock(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Lock.Lock): Self = StObject.set(x, "getUserLock", js.Any.fromFunction0(value))
    }
  }
}
