...
object Calendar_ {
  ...
  implicit class Calendar_Ops[Self <: Calendar_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewCalendar(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar): Self = this.set("newCalendar", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setNewConferenceData(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData): Self = this.set("newConferenceData", js.Any.fromFunction0(value))
