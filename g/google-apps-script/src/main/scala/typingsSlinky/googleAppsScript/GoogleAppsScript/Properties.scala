...
object Properties {
  ...
  trait Properties extends StObject {
    ...
    def deleteAllProperties(): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties = js.native
    
    def deleteProperty(key: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties = js.native
    ...
    def setProperties(properties: StringDictionary[String]): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties = js.native
    def setProperties(properties: StringDictionary[String], deleteAllOthers: Boolean): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties = js.native
    
    def setProperty(key: String, value: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties = js.native
  }
  ...
  object PropertiesService {
    ...
    implicit class PropertiesServiceMutableBuilder[Self <: PropertiesService] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetDocumentProperties(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties): Self = StObject.set(x, "getDocumentProperties", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetScriptProperties(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties): Self = StObject.set(x, "getScriptProperties", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetUserProperties(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties): Self = StObject.set(x, "getUserProperties", js.Any.fromFunction0(value))
    }
  }
