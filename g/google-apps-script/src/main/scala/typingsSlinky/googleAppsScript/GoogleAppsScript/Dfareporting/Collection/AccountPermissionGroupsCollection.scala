...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AccountPermissionGroup
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AccountPermissionGroupsListResponse
...
object AccountPermissionGroupsCollection {
  ...
  implicit class AccountPermissionGroupsCollectionOps[Self <: AccountPermissionGroupsCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: (String, String) => AccountPermissionGroup): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withList(value: String => AccountPermissionGroupsListResponse): Self = {
        val ret = this.duplicate
