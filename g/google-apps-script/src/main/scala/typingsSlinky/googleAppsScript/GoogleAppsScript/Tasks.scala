...
object Tasks {
  ...
  object Schema {
    ...
    object Tasks {
      ...
      @scala.inline
      def apply(): typingsSlinky.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks]
      }
      
      @scala.inline
      implicit class TasksMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks] (val x: Self) extends AnyVal {
