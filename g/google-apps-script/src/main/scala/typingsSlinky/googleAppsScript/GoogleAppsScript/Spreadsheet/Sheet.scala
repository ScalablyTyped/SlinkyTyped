...
trait Sheet extends js.Object {
  ...
  def copyTo(spreadsheet: typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet): Sheet = js.native
  ...
  def getParent(): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
