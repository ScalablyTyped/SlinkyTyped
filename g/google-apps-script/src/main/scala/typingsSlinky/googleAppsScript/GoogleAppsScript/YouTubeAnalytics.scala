...
import typingsSlinky.googleAppsScript.GoogleAppsScript.YouTubeAnalytics.Schema.EmptyResponse
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.YouTubeAnalytics.Schema.ListGroupItemsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.YouTubeAnalytics.Schema.ListGroupsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.YouTubeAnalytics.Schema.QueryResponse
