...
object CardService {
  ...
  def apply(
  ...
  ): typingsSlinky.googleAppsScript.GoogleAppsScript.CardService.CardService = {
    ...
    __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.CardService.CardService]
  }
  
  @scala.inline
  implicit class CardServiceMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.CardService.CardService] (val x: Self) extends AnyVal {
