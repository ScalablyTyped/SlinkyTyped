...
trait ReferenceListResponse extends js.Object {
  var items: js.UndefOr[js.Array[Reference]] = js.native
...
object ReferenceListResponse {
  @scala.inline
  def apply(): ReferenceListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReferenceListResponse]
  }
  @scala.inline
  implicit class ReferenceListResponseOps[Self <: ReferenceListResponse] (val x: Self) extends AnyVal {
    @scala.inline
