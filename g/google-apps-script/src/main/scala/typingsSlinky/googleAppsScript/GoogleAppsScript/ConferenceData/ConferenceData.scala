package typingsSlinky.googleAppsScript.GoogleAppsScript.ConferenceData
...
object ConferenceData {
  ...
  @scala.inline
  implicit class ConferenceDataOps[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.ConferenceData.ConferenceData] (val x: Self) extends AnyVal {
