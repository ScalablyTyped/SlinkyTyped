...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Analyticsreporting.Schema.GetReportsResponse
...
object ReportsCollection {
  ...
  implicit class ReportsCollectionOps[Self <: ReportsCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBatchGet(value: GetReportsRequest => GetReportsResponse): Self = {
