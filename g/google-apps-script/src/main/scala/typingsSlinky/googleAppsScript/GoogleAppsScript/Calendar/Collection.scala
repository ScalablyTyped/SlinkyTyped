...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Acl
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.AclRule
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.CalendarList
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Colors
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Event
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.FreeBusyRequest
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.FreeBusyResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Setting
import typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Settings
...
object Collection extends js.Object {
  ...
  trait CalendarsCollection extends js.Object {
    ...
    def get(calendarId: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Returns metadata for a calendar.
    def get(calendarId: String, optionalArgs: js.Object, headers: js.Object): typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    
    // Creates a secondary calendar.
    def insert(resource: typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar): typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Creates a secondary calendar.
    def insert(
      resource: typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar,
      optionalArgs: js.Object,
      headers: js.Object
    ): typingsSlinky.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
