...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.Reports.SavedCollection
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Schema.Accounts
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Schema.UrlChannels
  ...
  object Collection {
    ...
    object Accounts {
      ...
      object PaymentsCollection {
        ...
        @scala.inline
        def apply(list: String => Payments): typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.PaymentsCollection = {
          val __obj = js.Dynamic.literal(list = js.Any.fromFunction1(list))
          __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.PaymentsCollection]
        }
        
        @scala.inline
        implicit class PaymentsCollectionMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.PaymentsCollection] (val x: Self) extends AnyVal {
    ...
    object Metadata {
      ...
      object DimensionsCollection {
        ...
        @scala.inline
        def apply(list: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Schema.Metadata): DimensionsCollection = {
        ...
        implicit class DimensionsCollectionMutableBuilder[Self <: DimensionsCollection] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setList(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Schema.Metadata): Self = StObject.set(x, "list", js.Any.fromFunction0(value))
        }
      }
    ...
    trait ReportsCollection extends StObject {
      ...
      var Saved: js.UndefOr[
            typingsSlinky.googleAppsScript.GoogleAppsScript.Adsense.Collection.Reports.SavedCollection
          ] = js.native
