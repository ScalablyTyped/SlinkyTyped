...
trait Spreadsheet extends js.Object {
  ...
  def addDeveloperMetadata(key: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, value: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, value: String, visibility: DeveloperMetadataVisibility): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, visibility: DeveloperMetadataVisibility): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def copy(name: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def removeEditor(emailAddress: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeEditor(user: User): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def removeMenu(name: String): Unit = js.native
  
  def removeNamedRange(name: String): Unit = js.native
  
  def removeViewer(emailAddress: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeViewer(user: User): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def setIterativeCalculationConvergenceThreshold(minThreshold: Double): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def setIterativeCalculationEnabled(isEnabled: Boolean): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def setMaxIterativeCalculationCycles(maxIterations: Integer): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def setNamedRange(name: String, range: Range): Unit = js.native
  
  def setRecalculationInterval(recalculationInterval: RecalculationInterval): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
