...
import typingsSlinky.googleAppsScript.GoogleAppsScript.UrlShortener.Collection.UrlCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.AnalyticsSnapshot
import typingsSlinky.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.AnalyticsSummary
import typingsSlinky.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.StringCount
