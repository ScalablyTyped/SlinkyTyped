...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.PlacementGroup
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.PlacementGroupsListResponse
