...
object OpenLink {
  ...
  implicit class OpenLinkOps[Self <: OpenLink] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetOnClose(value: OnClose => OpenLink): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setOnClose")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetOpenAs(value: OpenAs => OpenLink): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setOpenAs")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetUrl(value: String => OpenLink): Self = {
        val ret = this.duplicate
