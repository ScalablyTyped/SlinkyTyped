...
object DocumentApp {
  ...
  implicit class DocumentAppMutableBuilder[Self <: DocumentApp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreate(value: String => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = StObject.set(x, "create", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setGetActiveDocument(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = StObject.set(x, "getActiveDocument", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setOpenById(value: String => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = StObject.set(x, "openById", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOpenByUrl(value: String => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = StObject.set(x, "openByUrl", js.Any.fromFunction1(value))
