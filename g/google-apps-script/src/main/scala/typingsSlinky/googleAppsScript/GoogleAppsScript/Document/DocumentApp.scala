...
object DocumentApp {
  ...
  implicit class DocumentAppOps[Self <: DocumentApp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreate(value: String => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = this.set("create", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetActiveDocument(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = this.set("getActiveDocument", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetUi(value: () => Ui): Self = this.set("getUi", js.Any.fromFunction0(value))
    
    @scala.inline
    def setOpenById(value: String => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = this.set("openById", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOpenByUrl(value: String => typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document): Self = this.set("openByUrl", js.Any.fromFunction1(value))
  }
}
