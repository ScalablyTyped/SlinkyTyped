...
trait DocumentApp extends js.Object {
  ...
  def create(name: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document
  def getActiveDocument(): typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document
  def getUi(): Ui
  def openById(id: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document
  def openByUrl(url: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Document.Document
}
