...
trait ClaimListResponse extends js.Object {
  ...
  var items: js.UndefOr[js.Array[Claim]] = js.native
...
object ClaimListResponse {
  ...
  @scala.inline
  def apply(): ClaimListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClaimListResponse]
  }
  
  @scala.inline
  implicit class ClaimListResponseOps[Self <: ClaimListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Claim*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Claim]): Self = this.set("items", value.asInstanceOf[js.Any])
