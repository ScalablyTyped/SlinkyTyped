...
object EmbeddedBarChartBuilder {
  ...
  implicit class EmbeddedBarChartBuilderMutableBuilder[Self <: EmbeddedBarChartBuilder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetLegendTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = StObject.set(x, "setLegendTextStyle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetTitleTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = StObject.set(x, "setTitleTextStyle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetXAxisTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = StObject.set(x, "setXAxisTextStyle", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetXAxisTitle(value: String => EmbeddedBarChartBuilder): Self = StObject.set(x, "setXAxisTitle", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetXAxisTitleTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = StObject.set(x, "setXAxisTitleTextStyle", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetYAxisTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = StObject.set(x, "setYAxisTextStyle", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetYAxisTitle(value: String => EmbeddedBarChartBuilder): Self = StObject.set(x, "setYAxisTitle", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetYAxisTitleTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = StObject.set(x, "setYAxisTitleTextStyle", js.Any.fromFunction1(value))
