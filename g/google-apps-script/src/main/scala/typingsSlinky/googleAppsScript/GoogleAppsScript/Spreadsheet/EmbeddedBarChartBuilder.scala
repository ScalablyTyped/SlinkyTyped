...
object EmbeddedBarChartBuilder {
  ...
  implicit class EmbeddedBarChartBuilderOps[Self <: EmbeddedBarChartBuilder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetLegendTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = this.set("setLegendTextStyle", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSetTitleTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = this.set("setTitleTextStyle", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSetXAxisTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = this.set("setXAxisTextStyle", js.Any.fromFunction1(value))
    @scala.inline
    def setSetXAxisTitle(value: String => EmbeddedBarChartBuilder): Self = this.set("setXAxisTitle", js.Any.fromFunction1(value))
    @scala.inline
    def setSetXAxisTitleTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = this.set("setXAxisTitleTextStyle", js.Any.fromFunction1(value))
    @scala.inline
    def setSetYAxisTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = this.set("setYAxisTextStyle", js.Any.fromFunction1(value))
    @scala.inline
    def setSetYAxisTitle(value: String => EmbeddedBarChartBuilder): Self = this.set("setYAxisTitle", js.Any.fromFunction1(value))
    @scala.inline
    def setSetYAxisTitleTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder): Self = this.set("setYAxisTitleTextStyle", js.Any.fromFunction1(value))
    @scala.inline
