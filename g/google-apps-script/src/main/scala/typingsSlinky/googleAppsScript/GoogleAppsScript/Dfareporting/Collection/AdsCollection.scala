...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.Ad
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AdsListResponse
