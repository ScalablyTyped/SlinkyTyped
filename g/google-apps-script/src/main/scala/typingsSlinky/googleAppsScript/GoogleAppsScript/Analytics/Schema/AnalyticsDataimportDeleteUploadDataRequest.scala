...
object AnalyticsDataimportDeleteUploadDataRequest {
  ...
  implicit class AnalyticsDataimportDeleteUploadDataRequestOps[Self <: AnalyticsDataimportDeleteUploadDataRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCustomDataImportUids(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("customDataImportUids")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCustomDataImportUids: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("customDataImportUids")(js.undefined)
        ret
    }
  }
