...
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Collection.ColumnCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Collection.QueryCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Collection.StyleCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Collection.TableCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Collection.TaskCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Collection.TemplateCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Bucket
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Column
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.ColumnBaseColumn
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.LineStyle
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.PointStyle
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.PolygonStyle
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.StyleFunction
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.StyleFunctionGradient
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.StyleFunctionGradientColors
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.StyleSetting
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Table
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Template
