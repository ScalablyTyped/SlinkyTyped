package typingsSlinky.googleAppsScript.GoogleAppsScript.Docs

import typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.BatchUpdateDocumentRequest
import typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.BatchUpdateDocumentResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document
