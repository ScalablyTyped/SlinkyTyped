...
@js.native
trait OrdersInStoreRefundLineItemResponse extends js.Object {
...
object OrdersInStoreRefundLineItemResponse {
  ...
  @scala.inline
  def apply(): OrdersInStoreRefundLineItemResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrdersInStoreRefundLineItemResponse]
  }
  
  @scala.inline
  implicit class OrdersInStoreRefundLineItemResponseOps[Self <: OrdersInStoreRefundLineItemResponse] (val x: Self) extends AnyVal {
