...
object Schemas {
  ...
  implicit class SchemasOps[Self <: Schemas] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSchemasVarargs(value: typingsSlinky.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema*): Self = this.set("schemas", js.Array(value :_*))
    
    @scala.inline
    def setSchemas(value: js.Array[typingsSlinky.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema]): Self = this.set("schemas", value.asInstanceOf[js.Any])
