package typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery

import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.Dataset
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.DatasetList
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.GetQueryResultsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.GetServiceAccountResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.Job
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.JobCancelResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.JobList
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.ProjectList
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.QueryRequest
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.QueryResponse
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.TableDataInsertAllResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.TableDataList
import typingsSlinky.googleAppsScript.GoogleAppsScript.Bigquery.Schema.TableList
