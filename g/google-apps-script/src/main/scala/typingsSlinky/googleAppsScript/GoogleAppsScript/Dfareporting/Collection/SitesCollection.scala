...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.Site
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.SitesListResponse
