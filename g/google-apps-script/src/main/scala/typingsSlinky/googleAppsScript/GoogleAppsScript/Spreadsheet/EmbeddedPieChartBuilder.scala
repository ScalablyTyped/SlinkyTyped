...
object EmbeddedPieChartBuilder {
  ...
  implicit class EmbeddedPieChartBuilderOps[Self <: EmbeddedPieChartBuilder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetLegendTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedPieChartBuilder): Self = this.set("setLegendTextStyle", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSetTitleTextStyle(value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedPieChartBuilder): Self = this.set("setTitleTextStyle", js.Any.fromFunction1(value))
    @scala.inline
