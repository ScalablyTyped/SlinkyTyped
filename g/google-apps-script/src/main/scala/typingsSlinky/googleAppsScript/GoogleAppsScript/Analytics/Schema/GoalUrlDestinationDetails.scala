...
object GoalUrlDestinationDetails {
  ...
  implicit class GoalUrlDestinationDetailsOps[Self <: GoalUrlDestinationDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStepsVarargs(value: GoalUrlDestinationDetailsSteps*): Self = this.set("steps", js.Array(value :_*))
    @scala.inline
    def setSteps(value: js.Array[GoalUrlDestinationDetailsSteps]): Self = this.set("steps", value.asInstanceOf[js.Any])
    @scala.inline
