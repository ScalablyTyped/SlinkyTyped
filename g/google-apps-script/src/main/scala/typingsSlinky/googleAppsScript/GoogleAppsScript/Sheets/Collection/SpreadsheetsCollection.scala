package typingsSlinky.googleAppsScript.GoogleAppsScript.Sheets.Collection
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet
