...
object DeveloperMetadataLocation {
  ...
  implicit class DeveloperMetadataLocationOps[Self <: DeveloperMetadataLocation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetSpreadsheet(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet | Null): Self = this.set("getSpreadsheet", js.Any.fromFunction0(value))
  }
