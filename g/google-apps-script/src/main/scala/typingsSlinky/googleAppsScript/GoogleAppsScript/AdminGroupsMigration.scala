...
object AdminGroupsMigration {
  ...
  object Collection {
    ...
    trait ArchiveCollection extends StObject {
      ...
      def insert(groupId: String): typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsMigration.Schema.Groups = js.native
      // Inserts a new mail into the archive of the Google group.
      def insert(groupId: String, mediaData: js.Any): typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsMigration.Schema.Groups = js.native
    }
  }
  ...
  object Schema {
    ...
    object Groups {
      ...
      @scala.inline
      def apply(): typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsMigration.Schema.Groups = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsMigration.Schema.Groups]
      }
      
      @scala.inline
      implicit class GroupsMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsMigration.Schema.Groups] (val x: Self) extends AnyVal {
