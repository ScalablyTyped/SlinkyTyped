...
object CommentReplyList {
  ...
  @scala.inline
  implicit class CommentReplyListOps[Self <: CommentReplyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: CommentReply*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[CommentReply]): Self = this.set("items", value.asInstanceOf[js.Any])
