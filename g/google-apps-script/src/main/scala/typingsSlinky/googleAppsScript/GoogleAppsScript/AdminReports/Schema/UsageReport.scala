...
object UsageReport {
  ...
  implicit class UsageReportOps[Self <: UsageReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntity(value: UsageReportEntity): Self = this.set("entity", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParametersVarargs(value: UsageReportParameters*): Self = this.set("parameters", js.Array(value :_*))
    
    @scala.inline
    def setParameters(value: js.Array[UsageReportParameters]): Self = this.set("parameters", value.asInstanceOf[js.Any])
