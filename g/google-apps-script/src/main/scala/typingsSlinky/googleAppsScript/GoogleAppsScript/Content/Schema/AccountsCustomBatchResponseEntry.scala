...
object AccountsCustomBatchResponseEntry {
  ...
  implicit class AccountsCustomBatchResponseEntryOps[Self <: AccountsCustomBatchResponseEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLinkStatus(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("linkStatus")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLinkStatus: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("linkStatus")(js.undefined)
        ret
    }
  }
