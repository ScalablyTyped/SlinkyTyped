...
object AdminGroupsSettings {
  ...
  @scala.inline
  def apply(newGroups: () => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups): AdminGroupsSettings = {
  ...
  implicit class AdminGroupsSettingsMutableBuilder[Self <: AdminGroupsSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewGroups(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups): Self = StObject.set(x, "newGroups", js.Any.fromFunction0(value))
  }
  ...
  object Collection {
    ...
    trait GroupsCollection extends StObject {
      ...
      def get(groupUniqueId: String): typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups = js.native
      
      // Updates an existing resource. This method supports patch semantics.
      def patch(
        resource: typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups,
        groupUniqueId: String
      ): typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups = js.native
    ...
    object GroupsCollection {
      ...
      @scala.inline
      def apply(
        get: String => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups,
        patch: (typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups, String) => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups,
        update: (typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups, String) => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups
      ): GroupsCollection = {
      ...
      implicit class GroupsCollectionMutableBuilder[Self <: GroupsCollection] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setGet(value: String => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups): Self = StObject.set(x, "get", js.Any.fromFunction1(value))
        
        @scala.inline
        def setPatch(
          value: (typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups, String) => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups
  ...
  object Schema {
    ...
    object Groups {
      ...
      @scala.inline
      def apply(): typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups]
      }
      
      @scala.inline
      implicit class GroupsMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups] (val x: Self) extends AnyVal {
