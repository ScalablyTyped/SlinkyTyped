...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.FloodlightActivityGroup
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.FloodlightActivityGroupsListResponse
