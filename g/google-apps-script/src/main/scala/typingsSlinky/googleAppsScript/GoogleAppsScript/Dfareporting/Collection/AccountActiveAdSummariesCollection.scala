...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AccountActiveAdSummary
...
object AccountActiveAdSummariesCollection {
  ...
  implicit class AccountActiveAdSummariesCollectionOps[Self <: AccountActiveAdSummariesCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: (String, String) => AccountActiveAdSummary): Self = {
