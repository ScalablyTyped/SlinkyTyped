...
object Docs {
  ...
  object Collection {
    ...
    trait DocumentsCollection extends StObject {
      ...
      def create(resource: typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document): typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = js.native
      
      // Gets the latest version of the specified document.
      def get(documentId: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = js.native
      // Gets the latest version of the specified document.
      def get(documentId: String, optionalArgs: js.Object): typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = js.native
    }
  }
  ...
  implicit class DocsMutableBuilder[Self <: Docs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewDocument(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document): Self = StObject.set(x, "newDocument", js.Any.fromFunction0(value))
  ...
  object Schema {
    ...
    object Document {
      ...
      @scala.inline
      def apply(): typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document]
      }
      
      @scala.inline
      implicit class DocumentMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.Docs.Schema.Document] (val x: Self) extends AnyVal {
