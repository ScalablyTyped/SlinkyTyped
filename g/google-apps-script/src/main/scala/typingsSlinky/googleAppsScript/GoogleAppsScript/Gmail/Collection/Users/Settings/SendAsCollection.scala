...
trait SendAsCollection extends js.Object {
  ...
  def create(resource: typingsSlinky.googleAppsScript.GoogleAppsScript.Gmail.Schema.SendAs, userId: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Gmail.Schema.SendAs
  // Gets the specified send-as alias. Fails with an HTTP 404 error if the specified address is not a member of the collection.
  def get(userId: String, sendAsEmail: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Gmail.Schema.SendAs
  ...
  def patch(
    ...
    userId: String,
    sendAsEmail: String
  ): typingsSlinky.googleAppsScript.GoogleAppsScript.Gmail.Schema.SendAs
