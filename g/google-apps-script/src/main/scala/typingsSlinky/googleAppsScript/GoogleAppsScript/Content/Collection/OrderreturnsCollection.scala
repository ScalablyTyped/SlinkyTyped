...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Content.Schema.MerchantOrderReturn
import typingsSlinky.googleAppsScript.GoogleAppsScript.Content.Schema.OrderreturnsListResponse
