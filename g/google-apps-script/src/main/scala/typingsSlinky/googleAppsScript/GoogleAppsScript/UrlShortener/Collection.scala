package typingsSlinky.googleAppsScript.GoogleAppsScript.UrlShortener

import typingsSlinky.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.Url
import typingsSlinky.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.UrlHistory
