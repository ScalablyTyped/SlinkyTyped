package typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager

import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.EnvironmentsCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.VersionHeadersCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.VersionsCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.BuiltInVariablesCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.FoldersCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.TagsCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.TriggersCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.VariablesCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.ZonesCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.WorkspacesCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.ContainersCollection
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.UserPermissionsCollection
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ContainerVersionHeader
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.CreateBuiltInVariableResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.CreateContainerVersionRequestVersionOptions
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.CreateContainerVersionResponse
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.FolderEntities
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.GetWorkspaceStatusResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListAccountsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListContainerVersionsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListContainersResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListEnabledBuiltInVariablesResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListEnvironmentsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListFoldersResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListTagsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListTriggersResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListUserPermissionsResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListVariablesResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListWorkspacesResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListZonesResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.PublishContainerVersionResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.QuickPreviewResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertBuiltInVariableResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertFolderResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertTagResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertTriggerResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertVariableResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertZoneResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.TagManager.Schema.SyncWorkspaceResponse
