...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Content.Schema.InventoryCustomBatchResponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.Content.Schema.InventorySetRequest
import typingsSlinky.googleAppsScript.GoogleAppsScript.Content.Schema.InventorySetResponse
