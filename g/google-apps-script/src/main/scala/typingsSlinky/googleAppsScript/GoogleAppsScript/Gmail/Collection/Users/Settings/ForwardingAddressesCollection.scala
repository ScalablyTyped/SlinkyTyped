...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Gmail.Schema.ListForwardingAddressesResponse
...
object ForwardingAddressesCollection {
  ...
  implicit class ForwardingAddressesCollectionOps[Self <: ForwardingAddressesCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: (ForwardingAddress, String) => ForwardingAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("create")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGet(value: (String, String) => ForwardingAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withList(value: String => ListForwardingAddressesResponse): Self = {
        val ret = this.duplicate
