package typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables

import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Column
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.ColumnList
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Import
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Sqlresponse
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.StyleSetting
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.StyleSettingList
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Table
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.TableList
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Task
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.TaskList
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.Template
import typingsSlinky.googleAppsScript.GoogleAppsScript.FusionTables.Schema.TemplateList
