...
trait SpreadsheetApp extends js.Object {
  ...
  def create(name: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def create(name: String, rows: Integer, columns: Integer): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def enableAllDataSourcesExecution(): Unit = js.native
  def enableBigQueryExecution(): Unit = js.native
  def flush(): Unit = js.native
  def getActive(): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def getActiveRange(): Range = js.native
  def getActiveRangeList(): RangeList = js.native
  def getActiveSheet(): Sheet = js.native
  def getActiveSpreadsheet(): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def open(file: File): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def openById(id: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def openByUrl(url: String): typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def setActiveSpreadsheet(newActiveSpreadsheet: typingsSlinky.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet): Unit = js.native
