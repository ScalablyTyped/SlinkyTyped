...
trait PermissionList extends js.Object {
  ...
  var items: js.UndefOr[js.Array[Permission]] = js.native
...
object PermissionList {
  ...
  implicit class PermissionListOps[Self <: PermissionList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Permission*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Permission]): Self = this.set("items", value.asInstanceOf[js.Any])
