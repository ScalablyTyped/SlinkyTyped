...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Mirror.Schema.AttachmentsListResponse
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Mirror.Schema.LocationsListResponse
