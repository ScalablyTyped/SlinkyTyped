...
trait CacheService extends js.Object {
  def getDocumentCache(): typingsSlinky.googleAppsScript.GoogleAppsScript.Cache.Cache | Null
  def getScriptCache(): typingsSlinky.googleAppsScript.GoogleAppsScript.Cache.Cache | Null
  def getUserCache(): typingsSlinky.googleAppsScript.GoogleAppsScript.Cache.Cache | Null
}
