...
object CacheService {
  ...
  implicit class CacheServiceOps[Self <: CacheService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetDocumentCache(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Cache.Cache | Null): Self = this.set("getDocumentCache", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetScriptCache(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Cache.Cache | Null): Self = this.set("getScriptCache", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetUserCache(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Cache.Cache | Null): Self = this.set("getUserCache", js.Any.fromFunction0(value))
  }
}
