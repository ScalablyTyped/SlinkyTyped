...
object YouTube_ {
  ...
  def apply(
    ...
    Captions: CaptionsCollection = null,
    ChannelBanners: ChannelBannersCollection = null,
    ChannelSections: ChannelSectionsCollection = null,
    Channels: ChannelsCollection = null,
    CommentThreads: CommentThreadsCollection = null,
    Comments: CommentsCollection = null,
    GuideCategories: GuideCategoriesCollection = null,
    I18nLanguages: I18nLanguagesCollection = null,
    I18nRegions: I18nRegionsCollection = null,
    LiveBroadcasts: LiveBroadcastsCollection = null,
    LiveChatBans: LiveChatBansCollection = null,
    LiveChatMessages: LiveChatMessagesCollection = null,
    LiveChatModerators: LiveChatModeratorsCollection = null,
    LiveStreams: LiveStreamsCollection = null,
    PlaylistItems: PlaylistItemsCollection = null,
    Playlists: PlaylistsCollection = null,
    Search: SearchCollection = null,
    Sponsors: SponsorsCollection = null,
    Subscriptions: SubscriptionsCollection = null,
    SuperChatEvents: SuperChatEventsCollection = null,
    Thumbnails: ThumbnailsCollection = null,
    VideoAbuseReportReasons: VideoAbuseReportReasonsCollection = null,
    VideoCategories: VideoCategoriesCollection = null,
    Videos: VideosCollection = null,
    Watermarks: WatermarksCollection = null
  ): YouTube_ = {
    ...
    if (ChannelBanners != null) __obj.updateDynamic("ChannelBanners")(ChannelBanners.asInstanceOf[js.Any])
    if (ChannelSections != null) __obj.updateDynamic("ChannelSections")(ChannelSections.asInstanceOf[js.Any])
    if (Channels != null) __obj.updateDynamic("Channels")(Channels.asInstanceOf[js.Any])
    if (CommentThreads != null) __obj.updateDynamic("CommentThreads")(CommentThreads.asInstanceOf[js.Any])
    if (Comments != null) __obj.updateDynamic("Comments")(Comments.asInstanceOf[js.Any])
    if (GuideCategories != null) __obj.updateDynamic("GuideCategories")(GuideCategories.asInstanceOf[js.Any])
    if (I18nLanguages != null) __obj.updateDynamic("I18nLanguages")(I18nLanguages.asInstanceOf[js.Any])
    if (I18nRegions != null) __obj.updateDynamic("I18nRegions")(I18nRegions.asInstanceOf[js.Any])
    if (LiveBroadcasts != null) __obj.updateDynamic("LiveBroadcasts")(LiveBroadcasts.asInstanceOf[js.Any])
    if (LiveChatBans != null) __obj.updateDynamic("LiveChatBans")(LiveChatBans.asInstanceOf[js.Any])
    if (LiveChatMessages != null) __obj.updateDynamic("LiveChatMessages")(LiveChatMessages.asInstanceOf[js.Any])
    if (LiveChatModerators != null) __obj.updateDynamic("LiveChatModerators")(LiveChatModerators.asInstanceOf[js.Any])
    if (LiveStreams != null) __obj.updateDynamic("LiveStreams")(LiveStreams.asInstanceOf[js.Any])
    if (PlaylistItems != null) __obj.updateDynamic("PlaylistItems")(PlaylistItems.asInstanceOf[js.Any])
    if (Playlists != null) __obj.updateDynamic("Playlists")(Playlists.asInstanceOf[js.Any])
    if (Search != null) __obj.updateDynamic("Search")(Search.asInstanceOf[js.Any])
    if (Sponsors != null) __obj.updateDynamic("Sponsors")(Sponsors.asInstanceOf[js.Any])
    if (Subscriptions != null) __obj.updateDynamic("Subscriptions")(Subscriptions.asInstanceOf[js.Any])
    if (SuperChatEvents != null) __obj.updateDynamic("SuperChatEvents")(SuperChatEvents.asInstanceOf[js.Any])
    if (Thumbnails != null) __obj.updateDynamic("Thumbnails")(Thumbnails.asInstanceOf[js.Any])
    if (VideoAbuseReportReasons != null) __obj.updateDynamic("VideoAbuseReportReasons")(VideoAbuseReportReasons.asInstanceOf[js.Any])
    if (VideoCategories != null) __obj.updateDynamic("VideoCategories")(VideoCategories.asInstanceOf[js.Any])
