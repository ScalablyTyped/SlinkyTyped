...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.Campaign
import typingsSlinky.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.CampaignsListResponse
