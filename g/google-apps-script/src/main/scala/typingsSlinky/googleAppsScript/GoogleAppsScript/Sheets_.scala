...
object Sheets_ {
  ...
  implicit class Sheets_Ops[Self <: Sheets_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewSpreadsheet(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet): Self = this.set("newSpreadsheet", js.Any.fromFunction0(value))
    @scala.inline
