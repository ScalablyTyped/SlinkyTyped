...
object AdminGroupsSettings_ {
  ...
  implicit class AdminGroupsSettings_Ops[Self <: AdminGroupsSettings_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewGroups(value: () => typingsSlinky.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups): Self = this.set("newGroups", js.Any.fromFunction0(value))
    @scala.inline
