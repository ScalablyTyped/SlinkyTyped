...
import typingsSlinky.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Buildings
import typingsSlinky.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.CalendarResource
import typingsSlinky.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.CalendarResources
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Features
