...
object Gmail_ {
  ...
  implicit class Gmail_Ops[Self <: Gmail_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewAutoForwarding(value: () => AutoForwarding): Self = this.set("newAutoForwarding", js.Any.fromFunction0(value))
    @scala.inline
    def setNewBatchDeleteMessagesRequest(value: () => BatchDeleteMessagesRequest): Self = this.set("newBatchDeleteMessagesRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewBatchModifyMessagesRequest(value: () => BatchModifyMessagesRequest): Self = this.set("newBatchModifyMessagesRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDelegate(value: () => Delegate): Self = this.set("newDelegate", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDraft(value: () => Draft): Self = this.set("newDraft", js.Any.fromFunction0(value))
    @scala.inline
    def setNewFilter(value: () => Filter): Self = this.set("newFilter", js.Any.fromFunction0(value))
    @scala.inline
    def setNewFilterAction(value: () => FilterAction): Self = this.set("newFilterAction", js.Any.fromFunction0(value))
    @scala.inline
    def setNewFilterCriteria(value: () => FilterCriteria): Self = this.set("newFilterCriteria", js.Any.fromFunction0(value))
    @scala.inline
    def setNewForwardingAddress(value: () => ForwardingAddress): Self = this.set("newForwardingAddress", js.Any.fromFunction0(value))
    @scala.inline
    def setNewImapSettings(value: () => ImapSettings): Self = this.set("newImapSettings", js.Any.fromFunction0(value))
    @scala.inline
    def setNewLabel(value: () => Label): Self = this.set("newLabel", js.Any.fromFunction0(value))
    @scala.inline
    def setNewLabelColor(value: () => LabelColor): Self = this.set("newLabelColor", js.Any.fromFunction0(value))
    @scala.inline
    def setNewMessage(value: () => Message): Self = this.set("newMessage", js.Any.fromFunction0(value))
    @scala.inline
    def setNewMessagePart(value: () => MessagePart): Self = this.set("newMessagePart", js.Any.fromFunction0(value))
    @scala.inline
    def setNewMessagePartBody(value: () => MessagePartBody): Self = this.set("newMessagePartBody", js.Any.fromFunction0(value))
    @scala.inline
    def setNewMessagePartHeader(value: () => MessagePartHeader): Self = this.set("newMessagePartHeader", js.Any.fromFunction0(value))
    @scala.inline
    def setNewModifyMessageRequest(value: () => ModifyMessageRequest): Self = this.set("newModifyMessageRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewModifyThreadRequest(value: () => ModifyThreadRequest): Self = this.set("newModifyThreadRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewPopSettings(value: () => PopSettings): Self = this.set("newPopSettings", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSendAs(value: () => SendAs): Self = this.set("newSendAs", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSmimeInfo(value: () => SmimeInfo): Self = this.set("newSmimeInfo", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSmtpMsa(value: () => SmtpMsa): Self = this.set("newSmtpMsa", js.Any.fromFunction0(value))
    @scala.inline
    def setNewVacationSettings(value: () => VacationSettings): Self = this.set("newVacationSettings", js.Any.fromFunction0(value))
    @scala.inline
    def setNewWatchRequest(value: () => WatchRequest): Self = this.set("newWatchRequest", js.Any.fromFunction0(value))
    @scala.inline
