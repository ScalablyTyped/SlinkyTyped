...
trait PropertiesService extends js.Object {
  def getDocumentProperties(): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties
  def getScriptProperties(): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties
  def getUserProperties(): typingsSlinky.googleAppsScript.GoogleAppsScript.Properties.Properties
}
