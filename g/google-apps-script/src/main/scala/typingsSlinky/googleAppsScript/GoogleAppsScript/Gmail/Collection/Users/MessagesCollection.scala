...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Gmail.Collection.Users.Messages.AttachmentsCollection
...
import typingsSlinky.googleAppsScript.GoogleAppsScript.Gmail.Schema.ListMessagesResponse
