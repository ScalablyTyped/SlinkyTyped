...
trait EmbeddedAreaChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder = js.native
  ...
  def setTitleTextStyle(textStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder = js.native
  
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder = js.native
  
  def setXAxisTextStyle(textStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder = js.native
  
  def setXAxisTitle(title: String): EmbeddedAreaChartBuilder = js.native
  
  def setXAxisTitleTextStyle(textStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder = js.native
  
  def setYAxisTextStyle(textStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder = js.native
  
  def setYAxisTitle(title: String): EmbeddedAreaChartBuilder = js.native
  
  def setYAxisTitleTextStyle(textStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder = js.native
...
object EmbeddedAreaChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    ...
    setTitleTextStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setXAxisTitle: String => EmbeddedAreaChartBuilder,
    setXAxisTitleTextStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setYAxisTextStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setYAxisTitle: String => EmbeddedAreaChartBuilder,
    setYAxisTitleTextStyle: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
  ...
  @scala.inline
  implicit class EmbeddedAreaChartBuilderOps[Self <: EmbeddedAreaChartBuilder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReverseCategories(value: () => EmbeddedAreaChartBuilder): Self = this.set("reverseCategories", js.Any.fromFunction0(value))
    
    @scala.inline
    def setSetBackgroundColor(value: String => EmbeddedAreaChartBuilder): Self = this.set("setBackgroundColor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetChartType(value: ChartType => EmbeddedChartBuilder): Self = this.set("setChartType", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetColors(value: js.Array[String] => EmbeddedAreaChartBuilder): Self = this.set("setColors", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetLegendPosition(value: Position => EmbeddedAreaChartBuilder): Self = this.set("setLegendPosition", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetLegendTextStyle(
      value: typingsSlinky.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder
    ...
    @scala.inline
    def setSetPointStyle(value: PointStyle => EmbeddedAreaChartBuilder): Self = this.set("setPointStyle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetRange(value: (Double, Double) => EmbeddedAreaChartBuilder): Self = this.set("setRange", js.Any.fromFunction2(value))
    
    @scala.inline
    def setSetStacked(value: () => EmbeddedAreaChartBuilder): Self = this.set("setStacked", js.Any.fromFunction0(value))
    
    @scala.inline
    def setSetTitle(value: String => EmbeddedAreaChartBuilder): Self = this.set("setTitle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetXAxisTitle(value: String => EmbeddedAreaChartBuilder): Self = this.set("setXAxisTitle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetYAxisTitle(value: String => EmbeddedAreaChartBuilder): Self = this.set("setYAxisTitle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setUseLogScale(value: () => EmbeddedAreaChartBuilder): Self = this.set("useLogScale", js.Any.fromFunction0(value))
  }
}
