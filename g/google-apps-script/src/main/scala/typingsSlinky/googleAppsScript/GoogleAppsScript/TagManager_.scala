...
object TagManager_ {
  ...
  implicit class TagManager_Ops[Self <: TagManager_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewAccountAccess(value: () => AccountAccess): Self = this.set("newAccountAccess", js.Any.fromFunction0(value))
    @scala.inline
    def setNewBuiltInVariable(value: () => BuiltInVariable): Self = this.set("newBuiltInVariable", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCondition(value: () => Condition): Self = this.set("newCondition", js.Any.fromFunction0(value))
    @scala.inline
    def setNewContainer(value: () => Container): Self = this.set("newContainer", js.Any.fromFunction0(value))
    @scala.inline
    def setNewContainerAccess(value: () => ContainerAccess): Self = this.set("newContainerAccess", js.Any.fromFunction0(value))
    @scala.inline
    def setNewContainerVersion(value: () => ContainerVersion): Self = this.set("newContainerVersion", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCreateContainerVersionRequestVersionOptions(value: () => CreateContainerVersionRequestVersionOptions): Self = this.set("newCreateContainerVersionRequestVersionOptions", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCustomTemplate(value: () => CustomTemplate): Self = this.set("newCustomTemplate", js.Any.fromFunction0(value))
    @scala.inline
    def setNewEntity(value: () => Entity): Self = this.set("newEntity", js.Any.fromFunction0(value))
    @scala.inline
    def setNewEnvironment(value: () => Environment): Self = this.set("newEnvironment", js.Any.fromFunction0(value))
    @scala.inline
    def setNewFolder(value: () => Folder): Self = this.set("newFolder", js.Any.fromFunction0(value))
    @scala.inline
    def setNewParameter(value: () => Parameter): Self = this.set("newParameter", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSetupTag(value: () => SetupTag): Self = this.set("newSetupTag", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTag(value: () => Tag): Self = this.set("newTag", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTeardownTag(value: () => TeardownTag): Self = this.set("newTeardownTag", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTimestamp(value: () => Timestamp): Self = this.set("newTimestamp", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTrigger(value: () => Trigger): Self = this.set("newTrigger", js.Any.fromFunction0(value))
    @scala.inline
    def setNewUserPermission(value: () => UserPermission): Self = this.set("newUserPermission", js.Any.fromFunction0(value))
    @scala.inline
    def setNewVariable(value: () => Variable): Self = this.set("newVariable", js.Any.fromFunction0(value))
    @scala.inline
    def setNewVariableFormatValue(value: () => VariableFormatValue): Self = this.set("newVariableFormatValue", js.Any.fromFunction0(value))
    @scala.inline
    def setNewWorkspace(value: () => Workspace): Self = this.set("newWorkspace", js.Any.fromFunction0(value))
    @scala.inline
    def setNewZone(value: () => Zone): Self = this.set("newZone", js.Any.fromFunction0(value))
    @scala.inline
    def setNewZoneBoundary(value: () => ZoneBoundary): Self = this.set("newZoneBoundary", js.Any.fromFunction0(value))
    @scala.inline
    def setNewZoneChildContainer(value: () => ZoneChildContainer): Self = this.set("newZoneChildContainer", js.Any.fromFunction0(value))
    @scala.inline
    def setNewZoneTypeRestriction(value: () => ZoneTypeRestriction): Self = this.set("newZoneTypeRestriction", js.Any.fromFunction0(value))
    @scala.inline
