...
object DriveActivity {
  ...
  object Schema {
    ...
    object DriveActivity {
      ...
      @scala.inline
      def apply(): typingsSlinky.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity]
      }
      
      @scala.inline
      implicit class DriveActivityMutableBuilder[Self <: typingsSlinky.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity] (val x: Self) extends AnyVal {
    ...
    trait QueryDriveActivityResponse extends StObject {
      ...
      var activities: js.UndefOr[
            js.Array[
              typingsSlinky.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity
            ]
          ] = js.native
    ...
    object QueryDriveActivityResponse {
      ...
      implicit class QueryDriveActivityResponseMutableBuilder[Self <: QueryDriveActivityResponse] (val x: Self) extends AnyVal {
        ...
        ): Self = StObject.set(x, "activities", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setActivitiesUndefined: Self = StObject.set(x, "activities", js.undefined)
        
        @scala.inline
        def setActivitiesVarargs(value: typingsSlinky.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity*): Self = StObject.set(x, "activities", js.Array(value :_*))
