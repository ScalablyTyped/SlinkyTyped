...
object ListContainersResponse {
  ...
  @scala.inline
  implicit class ListContainersResponseOps[Self <: ListContainersResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainerVarargs(value: Container*): Self = this.set("container", js.Array(value :_*))
    
    @scala.inline
    def setContainer(value: js.Array[Container]): Self = this.set("container", value.asInstanceOf[js.Any])
