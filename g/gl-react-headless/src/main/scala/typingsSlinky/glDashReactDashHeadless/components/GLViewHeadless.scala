package typingsSlinky.glDashReactDashHeadless.components
...
object GLViewHeadless
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.glDashReactDashHeadless.gLViewHeadlessMod.GLViewHeadless] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.glDashReactDashHeadless.gLViewHeadlessMod.GLViewHeadless] = {
