...
object Surface
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.glDashReactDashHeadless.glDashReactDashHeadlessMod.Surface] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.glDashReactDashHeadless.glDashReactDashHeadlessMod.Surface] = {
