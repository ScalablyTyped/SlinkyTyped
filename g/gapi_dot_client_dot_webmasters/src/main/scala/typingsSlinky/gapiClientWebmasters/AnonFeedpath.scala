...
@js.native
trait AnonFeedpath extends js.Object {
...
object AnonFeedpath {
  @scala.inline
  def apply(feedpath: String, siteUrl: String): AnonFeedpath = {
    val __obj = js.Dynamic.literal(feedpath = feedpath.asInstanceOf[js.Any], siteUrl = siteUrl.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFeedpath]
  }
  @scala.inline
  implicit class AnonFeedpathOps[Self <: AnonFeedpath] (val x: Self) extends AnyVal {
    @scala.inline
