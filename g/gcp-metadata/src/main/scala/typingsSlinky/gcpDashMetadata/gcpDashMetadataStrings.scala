package typingsSlinky.gcpDashMetadata

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object gcpDashMetadataStrings {
  @js.native
  sealed trait `/computeMetadata/v1` extends js.Object
  ...
  @scala.inline
  def `/computeMetadata/v1`: `/computeMetadata/v1` = "/computeMetadata/v1".asInstanceOf[`/computeMetadata/v1`]
  @scala.inline
