...
import typingsSlinky.gapiDotCalendar.Anon_AdditionalGuestsComment
import typingsSlinky.gapiDotCalendar.Anon_Date
import typingsSlinky.gapiDotCalendar.Anon_DateDateTimeTimeZone
import typingsSlinky.gapiDotCalendar.Anon_DisplayHeight
import typingsSlinky.gapiDotCalendar.Anon_DisplayName
import typingsSlinky.gapiDotCalendar.Anon_FileId
import typingsSlinky.gapiDotCalendar.Anon_Key
import typingsSlinky.gapiDotCalendar.Anon_OverridesUseDefault
import typingsSlinky.gapiDotCalendar.Anon_Title
import typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.calendarNumbersignevent
...
class Event () extends js.Object {
  ...
  var etag: typingsSlinky.gapiDotCalendar.gapi.client.calendar.etag = js.native
