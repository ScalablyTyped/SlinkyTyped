...
object EventVisibility {
  ...
  @scala.inline
  def confidential: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.confidential = this.cast("confidential")
  @scala.inline
  def default: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.default = this.cast("default")
  @scala.inline
  def `private`: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.`private` = this.cast("private")
  @scala.inline
  def public: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.public = this.cast("public")
}
