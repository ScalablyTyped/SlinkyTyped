...
object GadgetDisplayMode {
  ...
  @scala.inline
  def chip: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.chip = this.cast("chip")
  @scala.inline
  def icon: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.icon = this.cast("icon")
}
