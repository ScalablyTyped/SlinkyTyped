...
object EventTransparency {
  ...
  @scala.inline
  def opaque: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.opaque = this.cast("opaque")
  @scala.inline
  def transparent: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.transparent = this.cast("transparent")
}
