...
object EventsOrder {
  ...
  @scala.inline
  def startTime: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.startTime = this.cast("startTime")
  @scala.inline
  def updated: typingsSlinky.gapiDotCalendar.gapiDotCalendarStrings.updated = this.cast("updated")
}
