...
@js.native
trait AnonKeyTypes extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
  ...
  /**
    ...
    */
  var keyTypes: js.UndefOr[String] = js.native
  /**
...
object AnonKeyTypes {
  @scala.inline
  def apply(name: String): AnonKeyTypes = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonKeyTypes]
  }
  @scala.inline
  implicit class AnonKeyTypesOps[Self <: AnonKeyTypes] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyTypes(value: String): Self = {
        val ret = this.duplicate
