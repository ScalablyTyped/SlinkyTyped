...
import typingsSlinky.gatsby.gatsbyStrings.`initial-resolvableExtensions`
...
trait ResolvableExtensionsArgs extends ParentSpanPluginArgs {
  var traceId: `initial-resolvableExtensions` = js.native
}
...
object ResolvableExtensionsArgs {
  ...
  @scala.inline
  implicit class ResolvableExtensionsArgsOps[Self <: ResolvableExtensionsArgs] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withTraceId(value: `initial-resolvableExtensions`): Self = {
