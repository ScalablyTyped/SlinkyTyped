...
trait GatsbyConfig extends js.Object {
  ...
  var plugins: js.UndefOr[js.Array[String | AnonOptions]] = js.undefined
  ...
  /**
    ...
    * */
  var proxy: js.UndefOr[AnonPrefix] = js.undefined
...
object GatsbyConfig {
  ...
  def apply(
    ...
    plugins: js.Array[String | AnonOptions] = null,
    polyfill: js.UndefOr[Boolean] = js.undefined,
    proxy: AnonPrefix = null,
