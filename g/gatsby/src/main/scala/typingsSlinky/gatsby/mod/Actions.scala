...
import typingsSlinky.gatsby.anon.Args
import typingsSlinky.gatsby.anon.Child
import typingsSlinky.gatsby.anon.Dictkey
import typingsSlinky.gatsby.anon.FieldName
import typingsSlinky.gatsby.anon.Id
import typingsSlinky.gatsby.anon.NameOptions
import typingsSlinky.gatsby.anon.NodeIdString
import typingsSlinky.gatsby.anon.Path
import typingsSlinky.gatsby.anon.Schema
...
trait Actions extends js.Object {
  ...
  def deleteNode(options: typingsSlinky.gatsby.anon.Node): Unit = js.native
  def deleteNode(options: typingsSlinky.gatsby.anon.Node, plugin: ActionPlugin): Unit = js.native
  def deleteNode(options: typingsSlinky.gatsby.anon.Node, plugin: ActionPlugin, option: ActionOptions): Unit = js.native
  /**
    * @deprecated
