...
object Link
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.gatsby.mod.Link[js.Any]] {
  ...
  def apply[TState](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.gatsby.mod.Link[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.gatsby.mod.Link[js.Any]]]
  }
