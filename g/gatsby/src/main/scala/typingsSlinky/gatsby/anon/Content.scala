...
trait Content extends js.Object {
  ...
  var contentDigest: String = js.native
...
object Content {
  @scala.inline
  def apply(contentDigest: String, `type`: String): Content = {
  ...
  implicit class ContentOps[Self <: Content] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContentDigest(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contentDigest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
