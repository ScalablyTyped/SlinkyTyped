...
import typingsSlinky.gatsby.Anon_InitialcreatePages
import typingsSlinky.gatsby.Anon_InitialcreatePagesStatefully
...
trait GatsbyNode extends js.Object {
  ...
  var createPages: js.UndefOr[
    js.Function3[
      /* args */ CreatePagesArgs with Anon_InitialcreatePages, 
  ...
  var createPagesStatefully: js.UndefOr[
    js.Function3[
      /* args */ CreatePagesArgs with Anon_InitialcreatePagesStatefully, 
      /* options */ js.UndefOr[PluginOptions], 
      /* callback */ js.UndefOr[PluginCallback], 
      Unit
    ]
...
object GatsbyNode {
  @scala.inline
  def apply(
    createPages: (/* args */ CreatePagesArgs with Anon_InitialcreatePages, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => Unit = null,
    createPagesStatefully: (/* args */ CreatePagesArgs with Anon_InitialcreatePagesStatefully, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => Unit = null,
