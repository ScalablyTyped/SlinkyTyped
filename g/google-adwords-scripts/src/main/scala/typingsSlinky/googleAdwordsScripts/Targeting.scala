...
object Targeting {
  ...
  implicit class TargetingOps[Self <: Targeting] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAudiences(value: () => AdWordsSelector[SearchCampaignAudience]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("audiences")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withExcludedAudiences(value: () => AdWordsSelector[SearchCampaignExcludedAudience]): Self = {
        val ret = this.duplicate
