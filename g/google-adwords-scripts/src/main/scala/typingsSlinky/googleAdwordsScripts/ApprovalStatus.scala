...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.FAMILY_SAFE
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.NON_FAMILY_SAFE
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.PORN
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.UNCHECKED
*/
