...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.EXPANDED_TEXT_AD
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.IMAGE_AD
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.MOBILE_AD
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.MOBILE_IMAGE_AD
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.PRODUCT_AD
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.RICH_MEDIA_AD
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.TEMPLATE_AD
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.TEXT_AD
*/
