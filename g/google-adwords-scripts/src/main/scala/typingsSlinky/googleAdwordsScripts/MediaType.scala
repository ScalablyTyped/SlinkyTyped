...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.AUDIO
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.DYNAMIC_IMAGE
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.ICON
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.IMAGE
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.STANDARD_ICON
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.VIDEO
  - typingsSlinky.googleAdwordsScripts.googleAdwordsScriptsStrings.MEDIA_BUNDLE
*/
