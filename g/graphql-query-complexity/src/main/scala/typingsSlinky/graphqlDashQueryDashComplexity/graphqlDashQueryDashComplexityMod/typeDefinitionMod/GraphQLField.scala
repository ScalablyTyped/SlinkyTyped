package typingsSlinky.graphqlDashQueryDashComplexity.graphqlDashQueryDashComplexityMod.typeDefinitionMod

import typingsSlinky.graphqlDashQueryDashComplexity.distQueryComplexityMod.Complexity
