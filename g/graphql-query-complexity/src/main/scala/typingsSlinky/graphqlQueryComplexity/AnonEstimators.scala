...
object AnonEstimators {
  @scala.inline
  def apply(estimators: js.Array[ComplexityEstimator], query: DocumentNode, schema: GraphQLSchema): AnonEstimators = {
  ...
  @scala.inline
  implicit class AnonEstimatorsOps[Self <: AnonEstimators] (val x: Self) extends AnyVal {
    @scala.inline
