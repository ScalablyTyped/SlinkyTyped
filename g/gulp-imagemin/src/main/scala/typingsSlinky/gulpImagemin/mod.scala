...
object mod {
  ...
  @js.native
  val gifsicle: PluginFactory[typingsSlinky.imageminGifsicle.mod.Options] = js.native
  
  @JSImport("gulp-imagemin", "mozjpeg")
  @js.native
  val mozjpeg: PluginFactory[typingsSlinky.imageminMozjpeg.mod.Options] = js.native
  
  @JSImport("gulp-imagemin", "optipng")
  @js.native
  val optipng: PluginFactory[typingsSlinky.imageminOptipng.mod.Options] = js.native
  
  @JSImport("gulp-imagemin", "svgo")
  @js.native
  val svgo: PluginFactory[typingsSlinky.imageminSvgo.mod.Options] = js.native
