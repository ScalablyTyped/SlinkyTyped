...
object AttestationFormat extends StObject {
  ...
  /* 0 */ val ATTESTATION_FORMAT_UNSPECIFIED: typingsSlinky.googleCloudKms.mod.v1.AttestationFormat.ATTESTATION_FORMAT_UNSPECIFIED with Double = js.native
  
  // Cavium HSM attestation compressed with gzip. Note that this format is
  // defined by Cavium and subject to change at any time.
  @js.native
  sealed trait CAVIUM_V1_COMPRESSED extends AttestationFormat
  /* 3 */ val CAVIUM_V1_COMPRESSED: typingsSlinky.googleCloudKms.mod.v1.AttestationFormat.CAVIUM_V1_COMPRESSED with Double = js.native
}
