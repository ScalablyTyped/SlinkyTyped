...
object CryptoKeyPurpose extends StObject {
  ...
  /* 6 */ val ASYMMETRIC_DECRYPT: typingsSlinky.googleCloudKms.mod.v1.CryptoKeyPurpose.ASYMMETRIC_DECRYPT with Double = js.native
  ...
  /* 5 */ val ASYMMETRIC_SIGN: typingsSlinky.googleCloudKms.mod.v1.CryptoKeyPurpose.ASYMMETRIC_SIGN with Double = js.native
  
  // Not specified.
  @js.native
  sealed trait CRYPTO_KEY_PURPOSE_UNSPECIFIED extends CryptoKeyPurpose
  /* 0 */ val CRYPTO_KEY_PURPOSE_UNSPECIFIED: typingsSlinky.googleCloudKms.mod.v1.CryptoKeyPurpose.CRYPTO_KEY_PURPOSE_UNSPECIFIED with Double = js.native
  ...
  /* 1 */ val ENCRYPT_DECRYPT: typingsSlinky.googleCloudKms.mod.v1.CryptoKeyPurpose.ENCRYPT_DECRYPT with Double = js.native
}
