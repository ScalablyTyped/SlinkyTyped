...
object ProtectionLevel extends StObject {
  ...
  /* 2 */ val HSM: typingsSlinky.googleCloudKms.mod.v1.ProtectionLevel.HSM with Double = js.native
  
  // Not specified.
  @js.native
  sealed trait PROTECTION_LEVEL_UNSPECIFIED extends ProtectionLevel
  /* 0 */ val PROTECTION_LEVEL_UNSPECIFIED: typingsSlinky.googleCloudKms.mod.v1.ProtectionLevel.PROTECTION_LEVEL_UNSPECIFIED with Double = js.native
  
  // Crypto operations are performed in software.
  @js.native
  sealed trait SOFTWARE extends ProtectionLevel
  /* 1 */ val SOFTWARE: typingsSlinky.googleCloudKms.mod.v1.ProtectionLevel.SOFTWARE with Double = js.native
}
