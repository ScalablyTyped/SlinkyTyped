...
object CryptoKeyPurpose extends js.Object {
  ...
  /* 6 */ val ASYMMETRIC_DECRYPT: typingsSlinky.atGoogleDashCloudKms.atGoogleDashCloudKmsMod.v1.CryptoKeyPurpose.ASYMMETRIC_DECRYPT with Double = js.native
  /* 5 */ val ASYMMETRIC_SIGN: typingsSlinky.atGoogleDashCloudKms.atGoogleDashCloudKmsMod.v1.CryptoKeyPurpose.ASYMMETRIC_SIGN with Double = js.native
  /* 0 */ val CRYPTO_KEY_PURPOSE_UNSPECIFIED: typingsSlinky.atGoogleDashCloudKms.atGoogleDashCloudKmsMod.v1.CryptoKeyPurpose.CRYPTO_KEY_PURPOSE_UNSPECIFIED with Double = js.native
  /* 1 */ val ENCRYPT_DECRYPT: typingsSlinky.atGoogleDashCloudKms.atGoogleDashCloudKmsMod.v1.CryptoKeyPurpose.ENCRYPT_DECRYPT with Double = js.native
  @JSBracketAccess
