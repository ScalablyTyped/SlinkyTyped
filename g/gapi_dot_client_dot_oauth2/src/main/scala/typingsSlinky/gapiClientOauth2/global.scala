...
import typingsSlinky.gapiClientOauth2.gapi.client.oauth2.UserinfoResource
import typingsSlinky.gapiClientOauth2.gapiClientOauth2Strings.oauth2
import typingsSlinky.gapiClientOauth2.gapiClientOauth2Strings.v2
