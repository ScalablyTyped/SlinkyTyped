package typingsSlinky.gapiClientClouderrorreporting.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientClouderrorreporting.gapiClientClouderrorreportingStrings.clouderrorreporting,
    version: v1beta1
