...
import typingsSlinky.gapiClientLanguage.anon.Accesstoken
...
object DocumentsResource {
  ...
  implicit class DocumentsResourceOps[Self <: DocumentsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnalyzeEntities(value: Accesstoken => Request[AnalyzeEntitiesResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("analyzeEntities")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAnalyzeEntitySentiment(value: Accesstoken => Request[AnalyzeEntitySentimentResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("analyzeEntitySentiment")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAnalyzeSentiment(value: Accesstoken => Request[AnalyzeSentimentResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("analyzeSentiment")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAnalyzeSyntax(value: Accesstoken => Request[AnalyzeSyntaxResponse]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("analyzeSyntax")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAnnotateText(value: Accesstoken => Request[AnnotateTextResponse]): Self = {
        val ret = this.duplicate
