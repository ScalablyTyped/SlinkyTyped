...
object PresentationsResource {
  ...
  implicit class PresentationsResourceOps[Self <: PresentationsResource] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("batchUpdate", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCreate(value: Callback => typingsSlinky.gapiClient.gapi.client.Request[Presentation]): Self = this.set("create", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGet(value: Bearertoken => typingsSlinky.gapiClient.gapi.client.Request[Presentation]): Self = this.set("get", js.Any.fromFunction1(value))
