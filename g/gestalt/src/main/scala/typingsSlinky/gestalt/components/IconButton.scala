...
import typingsSlinky.gestalt.gestaltMod.IconButtonProps
...
object IconButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.gestalt.gestaltMod.IconButton] {
  @JSImport("gestalt", "IconButton")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: disabled, onClick */
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.gestalt.gestaltMod.IconButton] = {
