...
object Button {
  ...
  def apply(p: PropsWithoutRef[ButtonProps] with (RefAttributes[HTMLButtonElement | HTMLAnchorElement])): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
