...
import typingsSlinky.gestalt.gestaltMod.TooltipProps
...
object Tooltip
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.gestalt.gestaltMod.Tooltip] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.gestalt.gestaltMod.Tooltip] = {
