...
import typingsSlinky.gestalt.Anon_EventHTMLDivElementKeyboardEvent
import typingsSlinky.gestalt.gestaltMod.TouchableProps
...
object Touchable
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.gestalt.gestaltMod.Touchable] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.gestalt.gestaltMod.Touchable] = {
