...
import typingsSlinky.gestalt.gestaltMod.ColumnProps
...
object Column
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.gestalt.gestaltMod.Column] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.gestalt.gestaltMod.Column] = {
