...
import typingsSlinky.gestalt.gestaltMod.GroupAvatarProps
...
object GroupAvatar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.gestalt.gestaltMod.GroupAvatar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.gestalt.gestaltMod.GroupAvatar] = {
