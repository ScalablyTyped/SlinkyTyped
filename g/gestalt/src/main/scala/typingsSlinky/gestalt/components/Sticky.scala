...
object Sticky
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.gestalt.gestaltMod.Sticky] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.gestalt.gestaltMod.Sticky](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
