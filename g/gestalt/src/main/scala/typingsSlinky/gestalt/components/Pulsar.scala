...
object Pulsar
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.gestalt.gestaltMod.Pulsar] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.gestalt.gestaltMod.Pulsar](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
