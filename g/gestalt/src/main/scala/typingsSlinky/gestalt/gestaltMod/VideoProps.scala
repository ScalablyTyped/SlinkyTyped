...
import typingsSlinky.gestalt.Anon_Duration
import typingsSlinky.gestalt.Anon_EventFullscreen
import typingsSlinky.gestalt.Anon_EventHTMLDivElementSyntheticEvent
...
import typingsSlinky.gestalt.Anon_EventVolume
