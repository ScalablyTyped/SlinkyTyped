...
trait CheckedEvent extends js.Object {
  ...
  var event: slinky.core.SyntheticEvent[org.scalajs.dom.raw.Event, SyntheticMouseEvent[HTMLInputElement]] = js.native
}
...
object CheckedEvent {
  ...
  implicit class CheckedEventOps[Self <: CheckedEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvent(
      value: slinky.core.SyntheticEvent[org.scalajs.dom.raw.Event, SyntheticMouseEvent[HTMLInputElement]]
