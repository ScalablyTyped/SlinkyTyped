...
object SyntheticEvent {
  ...
  implicit class SyntheticEventOps[Self <: SyntheticEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSyntheticEvent(value: slinky.core.SyntheticEvent[org.scalajs.dom.raw.Event, HTMLInputElement]): Self = this.set("syntheticEvent", value.asInstanceOf[js.Any])
    @scala.inline
