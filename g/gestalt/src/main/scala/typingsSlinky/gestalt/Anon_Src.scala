...
import typingsSlinky.gestalt.gestaltStrings.`video/m3u8`
import typingsSlinky.gestalt.gestaltStrings.`video/mp4`
import typingsSlinky.gestalt.gestaltStrings.`video/ogg`
