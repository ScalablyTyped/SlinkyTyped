...
object TabsProps {
  ...
  implicit class TabsPropsMutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTabs(value: js.Array[typingsSlinky.gestalt.anon.Text]): Self = StObject.set(x, "tabs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTabsVarargs(value: typingsSlinky.gestalt.anon.Text*): Self = StObject.set(x, "tabs", js.Array(value :_*))
