...
trait CollageProps extends StObject {
  ...
  def renderImage(args: Height): ReactElement = js.native
...
object CollageProps {
  ...
  @scala.inline
  def apply(columns: Double, height: Double, renderImage: Height => ReactElement, width: Double): CollageProps = {
  ...
  implicit class CollagePropsMutableBuilder[Self <: CollageProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderImage(value: Height => ReactElement): Self = StObject.set(x, "renderImage", js.Any.fromFunction1(value))
