...
object SelectListProps {
  ...
  implicit class SelectListPropsMutableBuilder[Self <: SelectListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions(value: js.Array[typingsSlinky.gestalt.anon.Label]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOptionsVarargs(value: typingsSlinky.gestalt.anon.Label*): Self = StObject.set(x, "options", js.Array(value :_*))
