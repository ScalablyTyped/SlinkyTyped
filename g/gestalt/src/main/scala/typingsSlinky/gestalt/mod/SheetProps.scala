...
import typingsSlinky.gestalt.anon.OnDismissStart
...
object SheetProps {
  ...
  implicit class SheetPropsMutableBuilder[Self <: SheetProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenFunction1(value: /* prop */ OnDismissStart => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setFooterFunction1(value: /* prop */ OnDismissStart => ReactElement): Self = StObject.set(x, "footer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSubHeadingFunction1(value: /* prop */ OnDismissStart => ReactElement): Self = StObject.set(x, "subHeading", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSubHeadingReactElement(value: ReactElement): Self = StObject.set(x, "subHeading", value.asInstanceOf[js.Any])
