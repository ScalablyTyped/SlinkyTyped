...
object SheetProps {
  ...
  implicit class SheetPropsOps[Self <: SheetProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenFunction1(value: /* prop */ OnDismissStart => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setFooterFunction1(value: /* prop */ OnDismissStart => ReactElement): Self = this.set("footer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSubHeadingReactElement(value: ReactElement): Self = this.set("subHeading", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubHeadingFunction1(value: /* prop */ OnDismissStart => ReactElement): Self = this.set("subHeading", js.Any.fromFunction1(value))
