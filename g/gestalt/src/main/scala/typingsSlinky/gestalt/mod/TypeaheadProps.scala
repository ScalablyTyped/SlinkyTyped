...
import typingsSlinky.gestalt.anon.EventFocusEvent
import typingsSlinky.gestalt.anon.EventSyntheticEventValueString
import typingsSlinky.gestalt.anon.EventValueString
import typingsSlinky.gestalt.anon.Item
...
object TypeaheadProps {
  ...
  @scala.inline
  def apply(id: String, noResultText: String, options: js.Array[typingsSlinky.gestalt.anon.Label]): TypeaheadProps = {
