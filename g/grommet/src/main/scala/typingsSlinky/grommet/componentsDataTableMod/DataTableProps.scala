...
trait DataTableProps extends js.Object {
  ...
  var background: js.UndefOr[String | Anon_Body] = js.undefined
  var border: js.UndefOr[
    Boolean | top | left | bottom | right | horizontal | vertical | all | Anon_AllBody
  ] = js.undefined
...
object DataTableProps {
  ...
  def apply(
    ...
    background: String | Anon_Body = null,
    border: Boolean | top | left | bottom | right | horizontal | vertical | all | Anon_AllBody = null,
