...
trait AnonPanel extends js.Object {
  ...
  var header: js.UndefOr[AnonBackgroundExtend] = js.native
  var panel: js.UndefOr[AnonExtend] = js.native
}
...
object AnonPanel {
  ...
  implicit class AnonPanelOps[Self <: AnonPanel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHeader(value: AnonBackgroundExtend): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPanel(value: AnonExtend): Self = {
        val ret = this.duplicate
