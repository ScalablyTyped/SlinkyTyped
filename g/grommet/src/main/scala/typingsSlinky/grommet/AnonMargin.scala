...
trait AnonMargin extends js.Object {
  var active: js.UndefOr[AnonBackgroundBackgroundType] = js.native
  var background: js.UndefOr[BackgroundType] = js.native
  var border: js.UndefOr[AnonHover] = js.native
  var color: js.UndefOr[ColorType] = js.native
  var extend: js.UndefOr[ExtendType] = js.native
  var hover: js.UndefOr[AnonBackgroundColorExtend] = js.native
...
object AnonMargin {
  ...
  implicit class AnonMarginOps[Self <: AnonMargin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActive(value: AnonBackgroundBackgroundType): Self = {
    ...
    @scala.inline
    def withBorder(value: AnonHover): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHover(value: AnonBackgroundColorExtend): Self = {
        val ret = this.duplicate
