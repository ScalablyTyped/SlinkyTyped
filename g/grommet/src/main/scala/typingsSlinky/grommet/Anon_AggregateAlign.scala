...
trait Anon_AggregateAlign extends js.Object {
  ...
  var footer: js.UndefOr[TagMod[Any] | Anon_Aggregate] = js.undefined
  var header: js.UndefOr[String | TagMod[Any] | Anon_Aggregate] = js.undefined
...
object Anon_AggregateAlign {
  ...
  def apply(
    ...
    footer: TagMod[Any] | Anon_Aggregate = null,
    header: String | TagMod[Any] | Anon_Aggregate = null,
