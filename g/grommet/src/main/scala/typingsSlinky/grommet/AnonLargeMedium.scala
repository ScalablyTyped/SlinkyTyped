...
trait AnonLargeMedium extends js.Object {
  var large: js.UndefOr[AnonBorderPad] = js.native
  var medium: js.UndefOr[AnonBorderPad] = js.native
  var small: js.UndefOr[AnonBorderPad] = js.native
}

object AnonLargeMedium {
  @scala.inline
  def apply(): AnonLargeMedium = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonLargeMedium]
  }
  @scala.inline
  implicit class AnonLargeMediumOps[Self <: AnonLargeMedium] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withLarge(value: AnonBorderPad): Self = {
    ...
    @scala.inline
    def withMedium(value: AnonBorderPad): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSmall(value: AnonBorderPad): Self = {
        val ret = this.duplicate
