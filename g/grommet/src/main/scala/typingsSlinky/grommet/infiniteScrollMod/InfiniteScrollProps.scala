...
object InfiniteScrollProps {
  ...
  implicit class InfiniteScrollPropsOps[Self <: InfiniteScrollProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScrollableAncestorReactElement(value: ReactElement): Self = this.set("scrollableAncestor", value.asInstanceOf[js.Any])
    @scala.inline
    def setScrollableAncestor(value: ReactElement | window): Self = this.set("scrollableAncestor", value.asInstanceOf[js.Any])
    @scala.inline
