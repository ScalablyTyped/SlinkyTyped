...
trait SelectProps extends js.Object {
  ...
  var icon: js.UndefOr[Boolean | (js.Function1[/* repeated */ js.Any, _]) | TagMod[Any]] = js.undefined
  ...
  var options: js.Array[String | Boolean | Double | ReactElement | js.Object]
  ...
  var value: js.UndefOr[String | ReactElement | js.Object | (js.Array[String | js.Object])] = js.undefined
  var valueKey: js.UndefOr[String | Key | (js.Function1[/* repeated */ js.Any, _])] = js.undefined
  var valueLabel: js.UndefOr[TagMod[Any]] = js.undefined
}
