...
object SelectProps {
  ...
  implicit class SelectPropsOps[Self <: SelectProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptionsVarargs(value: (String | Boolean | Double | ReactElement | js.Object)*): Self = this.set("options", js.Array(value :_*))
    
    @scala.inline
    def setOptions(value: js.Array[String | Boolean | Double | ReactElement | js.Object]): Self = this.set("options", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIcon(value: Boolean | (js.Function1[/* repeated */ js.Any, _]) | ReactElement): Self = this.set("icon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValueLabelReactElement(value: ReactElement): Self = this.set("valueLabel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValueLabel(value: ReactElement): Self = this.set("valueLabel", value.asInstanceOf[js.Any])
