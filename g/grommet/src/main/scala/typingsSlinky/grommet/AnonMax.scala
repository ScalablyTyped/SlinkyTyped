...
object AnonMax {
  ...
  implicit class AnonMaxOps[Self <: AnonMax] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMax(value: xxsmall | xsmall | small | medium | large | xlarge | xxlarge | String): Self = {
    ...
    @scala.inline
    def withMin(value: xxsmall | xsmall | small | medium | large | xlarge | xxlarge | String): Self = {
        val ret = this.duplicate
