...
trait Control extends js.Object {
  ...
  var container: js.UndefOr[Extend] = js.native
  var control: js.UndefOr[Open] = js.native
  var extend: js.UndefOr[ExtendType] = js.native
  var icons: js.UndefOr[DownMargin] = js.native
...
object Control {
  ...
  implicit class ControlOps[Self <: Control] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContainer(value: Extend): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withControl(value: Open): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIcons(value: DownMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOptions(value: ContainerText): Self = {
        val ret = this.duplicate
