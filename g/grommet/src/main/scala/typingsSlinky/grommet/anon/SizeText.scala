...
@js.native
trait SizeText extends js.Object {
...
object SizeText {
  ...
  @scala.inline
  implicit class SizeTextOps[Self <: SizeText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setText(value: ExtendFontWeight): Self = this.set("text", value.asInstanceOf[js.Any])
