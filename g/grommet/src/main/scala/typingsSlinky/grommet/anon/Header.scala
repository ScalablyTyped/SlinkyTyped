...
trait Header extends js.Object {
  var body: js.UndefOr[none | xxsmall | xsmall | small | medium | large | xlarge | Bottom] = js.native
  var bottom: js.UndefOr[xxsmall | xsmall | small | medium | large | xlarge | String] = js.native
  var footer: js.UndefOr[none | xxsmall | xsmall | small | medium | large | xlarge | Bottom] = js.native
  var header: js.UndefOr[none | xxsmall | xsmall | small | medium | large | xlarge | Bottom] = js.native
...
object Header {
  ...
  implicit class HeaderOps[Self <: Header] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBody(value: none | xxsmall | xsmall | small | medium | large | xlarge | Bottom): Self = {
    ...
    @scala.inline
    def withFooter(value: none | xxsmall | xsmall | small | medium | large | xlarge | Bottom): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHeader(value: none | xxsmall | xsmall | small | medium | large | xlarge | Bottom): Self = {
        val ret = this.duplicate
