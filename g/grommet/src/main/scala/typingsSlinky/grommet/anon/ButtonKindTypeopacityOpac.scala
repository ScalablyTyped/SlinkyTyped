...
/* Inlined grommet.grommet/es6/themes/base.ButtonKindType & {  opacity :grommet.grommet/es6/utils.OpacityType | undefined} */
@js.native
trait ButtonKindTypeopacityOpac extends js.Object {
...
object ButtonKindTypeopacityOpac {
  ...
  @scala.inline
  implicit class ButtonKindTypeopacityOpacOps[Self <: ButtonKindTypeopacityOpac] (val x: Self) extends AnyVal {
