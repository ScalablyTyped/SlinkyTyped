...
trait Body extends js.Object {
  var body: js.UndefOr[String | Dark | js.Array[String]] = js.native
  var color: js.UndefOr[String] = js.native
  var dark: js.UndefOr[String] = js.native
  var footer: js.UndefOr[String | Dark] = js.native
  var header: js.UndefOr[String | Dark] = js.native
...
object Body {
  ...
  implicit class BodyOps[Self <: Body] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBody(value: String | Dark | js.Array[String]): Self = {
    ...
    @scala.inline
    def withFooter(value: String | Dark): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHeader(value: String | Dark): Self = {
        val ret = this.duplicate
