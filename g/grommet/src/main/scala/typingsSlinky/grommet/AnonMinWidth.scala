...
trait AnonMinWidth extends js.Object {
  var border: js.UndefOr[AnonColorRadius] = js.native
  var disabled: js.UndefOr[Anon3] = js.native
  var extend: js.UndefOr[ExtendType] = js.native
  var maxWidth: js.UndefOr[String] = js.native
  var minWidth: js.UndefOr[String] = js.native
  var padding: js.UndefOr[AnonVertical] = js.native
  var primary: js.UndefOr[Anon0] = js.native
  var size: js.UndefOr[AnonLargeMedium] = js.native
  var transition: js.UndefOr[AnonProperties] = js.native
}
...
object AnonMinWidth {
  ...
  implicit class AnonMinWidthOps[Self <: AnonMinWidth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: AnonColorRadius): Self = {
    ...
    @scala.inline
    def withDisabled(value: Anon3): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: AnonVertical): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPrimary(value: Anon0): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSize(value: AnonLargeMedium): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTransition(value: AnonProperties): Self = {
        val ret = this.duplicate
