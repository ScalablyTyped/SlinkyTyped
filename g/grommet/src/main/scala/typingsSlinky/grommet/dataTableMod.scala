...
object dataTableMod {
  ...
  object ColumnConfig {
    ...
    implicit class ColumnConfigMutableBuilder[Self <: ColumnConfig[_], TRowType] (val x: Self with ColumnConfig[TRowType]) extends AnyVal {
      ...
      @scala.inline
      def setFooter(value: ReactElement | Aggregate): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHeader(value: String | ReactElement | Aggregate): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRender(value: /* datum */ TRowType => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  */
  ...
  object ColumnSizeType {
    ...
    @scala.inline
    def `1Slash2`: typingsSlinky.grommet.grommetStrings.`1Slash2` = "1/2".asInstanceOf[typingsSlinky.grommet.grommetStrings.`1Slash2`]
    
    @scala.inline
    def `1Slash3`: typingsSlinky.grommet.grommetStrings.`1Slash3` = "1/3".asInstanceOf[typingsSlinky.grommet.grommetStrings.`1Slash3`]
    
    @scala.inline
    def `1Slash4`: typingsSlinky.grommet.grommetStrings.`1Slash4` = "1/4".asInstanceOf[typingsSlinky.grommet.grommetStrings.`1Slash4`]
    
    @scala.inline
    def `2Slash3`: typingsSlinky.grommet.grommetStrings.`2Slash3` = "2/3".asInstanceOf[typingsSlinky.grommet.grommetStrings.`2Slash3`]
    
    @scala.inline
    def `2Slash4`: typingsSlinky.grommet.grommetStrings.`2Slash4` = "2/4".asInstanceOf[typingsSlinky.grommet.grommetStrings.`2Slash4`]
    
    @scala.inline
    def `3Slash4`: typingsSlinky.grommet.grommetStrings.`3Slash4` = "3/4".asInstanceOf[typingsSlinky.grommet.grommetStrings.`3Slash4`]
  ...
  trait KeyPress[TRowType] extends StObject {
    ...
    var nativeEvent: KeyboardEvent = js.native
  ...
  object KeyPress {
    ...
    implicit class KeyPressMutableBuilder[Self <: KeyPress[_], TRowType] (val x: Self with KeyPress[TRowType]) extends AnyVal {
      ...
      @scala.inline
      def setNativeEvent(value: KeyboardEvent): Self = StObject.set(x, "nativeEvent", value.asInstanceOf[js.Any])
