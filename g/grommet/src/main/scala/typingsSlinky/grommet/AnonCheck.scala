...
trait AnonCheck extends js.Object {
  ...
  var check: js.UndefOr[AnonThickness] = js.native
  var color: js.UndefOr[ColorType] = js.native
  var extend: js.UndefOr[ExtendType] = js.native
  var gap: js.UndefOr[GapType] = js.native
  var hover: js.UndefOr[AnonBorderAnon0] = js.native
  var icon: js.UndefOr[AnonExtendSize] = js.native
  var icons: js.UndefOr[AnonChecked] = js.native
  var size: js.UndefOr[String] = js.native
  var toggle: js.UndefOr[AnonKnob] = js.native
}
...
object AnonCheck {
  ...
  @scala.inline
  implicit class AnonCheckOps[Self <: AnonCheck] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCheck(value: AnonThickness): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIcon(value: AnonExtendSize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIcons(value: AnonChecked): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withToggle(value: AnonKnob): Self = {
        val ret = this.duplicate
