...
object grommetStrings {
  ...
  @js.native
  sealed trait Asia extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait rotateLeft extends StObject
  @scala.inline
  def rotateLeft: rotateLeft = "rotateLeft".asInstanceOf[rotateLeft]
  
  @js.native
  sealed trait rotateRight extends StObject
  @scala.inline
