...
trait AnonSizeAnonDictxLarge extends js.Object {
  ...
  var size: js.UndefOr[AnonDictxLarge] = js.native
}

object AnonSizeAnonDictxLarge {
  @scala.inline
  def apply(): AnonSizeAnonDictxLarge = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonSizeAnonDictxLarge]
  }
  @scala.inline
  implicit class AnonSizeAnonDictxLargeOps[Self <: AnonSizeAnonDictxLarge] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSize(value: AnonDictxLarge): Self = {
        val ret = this.duplicate
