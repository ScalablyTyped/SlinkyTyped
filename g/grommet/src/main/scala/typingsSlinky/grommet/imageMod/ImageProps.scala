...
trait ImageProps extends js.Object {
  ...
  var fillProp: js.UndefOr[Boolean] = js.native
...
object ImageProps {
  ...
  implicit class ImagePropsOps[Self <: ImageProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFillProp(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fillProp")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFillProp: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fillProp")(js.undefined)
        ret
    }
    @scala.inline
