...
trait AnonContent extends js.Object {
  ...
  var content: js.UndefOr[AnonPad] = js.native
  var disabled: js.UndefOr[Anon1] = js.native
  var error: js.UndefOr[AnonColorMargin] = js.native
  var help: js.UndefOr[AnonMarginMarginType] = js.native
...
object AnonContent {
  ...
  implicit class AnonContentOps[Self <: AnonContent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContent(value: AnonPad): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDisabled(value: Anon1): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withError(value: AnonColorMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHelp(value: AnonMarginMarginType): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: TextProps): Self = {
        val ret = this.duplicate
