...
trait AnonAlign extends js.Object {
  ...
  var footer: js.UndefOr[TagMod[Any] | AnonAggregate] = js.native
  var header: js.UndefOr[String | TagMod[Any] | AnonAggregate] = js.native
...
object AnonAlign {
  @scala.inline
  def apply(property: String): AnonAlign = {
  ...
  implicit class AnonAlignOps[Self <: AnonAlign] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFooter(value: TagMod[Any] | AnonAggregate): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("footer")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withHeader(value: String | TagMod[Any] | AnonAggregate): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("header")(value.asInstanceOf[js.Any])
        ret
    }
