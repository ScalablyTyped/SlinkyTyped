...
trait FormFieldProps extends js.Object {
  ...
  var error: js.UndefOr[String | TagMod[Any]] = js.native
  var help: js.UndefOr[String | TagMod[Any]] = js.native
  var htmlFor: js.UndefOr[String] = js.native
  var info: js.UndefOr[String | TagMod[Any]] = js.native
...
object FormFieldProps {
  ...
  implicit class FormFieldPropsOps[Self <: FormFieldProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withError(value: String | TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("error")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withHelp(value: String | TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("help")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withInfo(value: String | TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("info")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withPad(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withValidateFunction1(value: /* repeated */ js.Any => _): Self = {
        val ret = this.duplicate
