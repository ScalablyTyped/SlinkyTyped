...
object WorldMap {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.WorldMap] {
    @scala.inline
    ...
    @scala.inline
    def continents(value: js.Array[AnonName]): this.type = set("continents", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def hoverColor(value: String | AnonLight): this.type = set("hoverColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onSelectPlace(value: /* place */ js.Array[Double] => Unit): this.type = set("onSelectPlace", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def places(value: js.Array[AnonLocation]): this.type = set("places", value.asInstanceOf[js.Any])
    @scala.inline
