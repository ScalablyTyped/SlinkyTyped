...
object Tabs {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def alignControls(value: AlignSelfType): this.type = set("alignControls", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def flex(value: grow | shrink | Boolean): this.type = set("flex", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def justify(value: start | center | end): this.type = set("justify", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def messages(value: TabContents): this.type = set("messages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def onAbort(value: SyntheticEvent[Event, HTMLDivElement] => Unit): this.type = set("onAbort", js.Any.fromFunction1(value))
    
    @scala.inline
    def onActive(value: /* index */ Double => Unit): this.type = set("onActive", js.Any.fromFunction1(value))
  ...
  def withProps(p: TabsProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
