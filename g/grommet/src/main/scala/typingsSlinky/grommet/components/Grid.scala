...
object Grid {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def align(value: start | center | end | stretch): this.type = set("align", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def areas(value: js.Array[AnonEnd | js.Array[String]]): this.type = set("areas", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def gap(value: GapType | AnonColumn): this.type = set("gap", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def justify(value: start | center | end | stretch): this.type = set("justify", value.asInstanceOf[js.Any])
    @scala.inline
    def justifyContent(value: JustifyContentType): this.type = set("justifyContent", value.asInstanceOf[js.Any])
    @scala.inline
