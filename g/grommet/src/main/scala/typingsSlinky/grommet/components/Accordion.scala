...
object Accordion {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onActive(value: /* activeIndexes */ js.Array[Double] => Unit): this.type = set("onActive", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: AccordionProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
