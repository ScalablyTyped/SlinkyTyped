...
object Carousel {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.Carousel] {
    @scala.inline
    ...
    @scala.inline
    def controls(value: Boolean | arrows | selectors): this.type = set("controls", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def initialChild(value: Double): this.type = set("initialChild", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def play(value: Double): this.type = set("play", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: CarouselProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
