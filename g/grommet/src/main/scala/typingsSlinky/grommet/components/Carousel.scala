...
object Carousel
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Carousel] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Carousel] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Carousel] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Carousel](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CarouselProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
}
