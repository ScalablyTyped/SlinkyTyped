...
object RangeSelector
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.RangeSelector] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.RangeSelector] = {
