...
object RangeSelector {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.RangeSelector] {
    @scala.inline
    ...
    @scala.inline
    def direction(
      value: typingsSlinky.grommet.grommetStrings.horizontal | typingsSlinky.grommet.grommetStrings.vertical
    ...
    @scala.inline
    def messages(value: AnonLower): this.type = set("messages", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def opacity(value: weak | medium | strong | String | Boolean): this.type = set("opacity", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def round(value: xsmall | small | medium | large | full | String): this.type = set("round", value.asInstanceOf[js.Any])
    @scala.inline
    def security(value: String): this.type = set("security", value.asInstanceOf[js.Any])
    @scala.inline
    def size(value: xxsmall | xsmall | small | medium | large | xlarge | full | String): this.type = set("size", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(
    p: RangeSelectorProps with (Omit[DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement], color])
  ): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(values: js.Array[Double]): Builder = {
    val __props = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RangeSelectorProps with (Omit[DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement], color])]))
  }
}
