...
object Collapsible
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Collapsible] {
  ...
  def apply(
    ...
    direction: typingsSlinky.grommet.grommetStrings.horizontal | typingsSlinky.grommet.grommetStrings.vertical = null,
    inlist: js.Any = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Collapsible] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Collapsible] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Collapsible](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
