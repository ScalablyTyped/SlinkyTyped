...
object Layer {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.Layer] {
    ...
    @scala.inline
    def animate(value: AnimateType): this.type = set("animate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def animation(value: none | slide | fadeIn | Boolean): this.type = set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `aria-autocomplete`(value: typingsSlinky.react.reactStrings.none | `inline` | list | both): this.type = set("aria-autocomplete", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `aria-dropeffect`(value: typingsSlinky.react.reactStrings.none | copy | execute | link | move | popup): this.type = set("aria-dropeffect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `aria-sort`(value: typingsSlinky.react.reactStrings.none | ascending | descending | other): this.type = set("aria-sort", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("full", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def inputMode(
      value: typingsSlinky.react.reactStrings.none | text | tel | url | email | numeric | decimal | search
    ...
    @scala.inline
    def onClickOutside(value: /* repeated */ js.Any => _): this.type = set("onClickOutside", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def position(value: LayerPositionType): this.type = set("position", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def target(value: js.Object): this.type = set("target", value.asInstanceOf[js.Any])
  ...
  def withProps(p: LayerProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
