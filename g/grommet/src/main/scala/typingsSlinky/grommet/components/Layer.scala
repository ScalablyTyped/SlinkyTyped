...
object Layer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Layer] {
  ...
  def apply(
    ...
    `aria-autocomplete`: typingsSlinky.react.reactStrings.none | `inline` | list | both = null,
    ...
    `aria-dropeffect`: typingsSlinky.react.reactStrings.none | copy | execute | link | move | popup = null,
    ...
    `aria-sort`: typingsSlinky.react.reactStrings.none | ascending | descending | other = null,
    ...
    full: Boolean | typingsSlinky.grommet.grommetStrings.vertical | typingsSlinky.grommet.grommetStrings.horizontal = null,
    inlist: js.Any = null,
    inputMode: typingsSlinky.react.reactStrings.none | text | tel | url | email | numeric | decimal | search = null,
    is: String = null,
    itemID: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Layer] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Layer] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Layer](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
