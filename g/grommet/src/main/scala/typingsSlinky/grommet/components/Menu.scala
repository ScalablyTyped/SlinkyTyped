...
object Menu {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def dropAlign(value: AnonTop): this.type = set("dropAlign", value.asInstanceOf[js.Any])
    @scala.inline
    def dropBackground(value: String | AnonOpacity): this.type = set("dropBackground", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def messages(value: AnonCloseMenu): this.type = set("messages", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: MenuProps with (Omit[ButtonType, icon])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(items: js.Array[js.Object]): Builder = {
    val __props = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MenuProps with (Omit[ButtonType, icon])]))
  }
}
