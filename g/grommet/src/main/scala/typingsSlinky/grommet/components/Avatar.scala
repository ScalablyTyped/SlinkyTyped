...
object Avatar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def size(value: xsmall | small | medium | large | xlarge | String): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  def withProps(
    p: BoxProps with AvatarProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
