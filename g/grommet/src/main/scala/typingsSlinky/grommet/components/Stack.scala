...
object Stack {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    ): this.type = set("anchor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def guidingChild(value: Double | first | last): this.type = set("guidingChild", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def interactiveChild(value: Double | first | last): this.type = set("interactiveChild", value.asInstanceOf[js.Any])
  ...
  def withProps(p: StackProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
