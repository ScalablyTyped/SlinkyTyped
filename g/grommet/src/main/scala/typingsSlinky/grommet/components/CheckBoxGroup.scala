...
import typingsSlinky.grommet.checkBoxGroupMod.CheckBoxType
import typingsSlinky.grommet.checkBoxGroupMod.OnChangeEvent
...
object CheckBoxGroup {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.grommet.mod.CheckBoxGroup] {
    ...
    @scala.inline
    def onChange(value: /* event */ js.UndefOr[OnChangeEvent] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
