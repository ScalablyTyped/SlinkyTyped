...
object Distribution
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Distribution] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Distribution] = {
