...
object Drop {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.Drop] {
    ...
    @scala.inline
    def restrictFocus(value: Boolean): this.type = set("restrictFocus", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def stretch(value: Boolean | align): this.type = set("stretch", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Drop.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DropProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
