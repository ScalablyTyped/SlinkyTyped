...
object Drop
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Drop] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Drop] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Drop] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Drop](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
