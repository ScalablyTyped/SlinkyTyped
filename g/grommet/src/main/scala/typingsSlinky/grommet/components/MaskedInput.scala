...
object MaskedInput
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.MaskedInput] {
  @JSImport("grommet", "MaskedInput")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: id, name */
  def apply(
    about: String = null,
    ...
    onBlur: /* event */ SyntheticFocusEvent[org.scalajs.dom.raw.Element] => _ = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.MaskedInput] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.MaskedInput] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.MaskedInput](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
