...
object MaskedInput {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.MaskedInput] {
    @scala.inline
    ...
    @scala.inline
    def mask(value: js.Array[AnonFixed]): this.type = set("mask", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onBlur(value: /* event */ SyntheticFocusEvent[Element] => _): this.type = set("onBlur", js.Any.fromFunction1(value))
    @scala.inline
