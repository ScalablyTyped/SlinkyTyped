...
object RadioButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.RadioButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.RadioButton] = {
