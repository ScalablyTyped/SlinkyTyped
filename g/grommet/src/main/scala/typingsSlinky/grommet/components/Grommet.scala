...
object Grommet
  extends ExternalComponentWithAttributesWithRefType[tag.type, Grommet_] {
  ...
  ): BuildingComponent[tag.type, Grommet_] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Grommet_] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Grommet_](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
