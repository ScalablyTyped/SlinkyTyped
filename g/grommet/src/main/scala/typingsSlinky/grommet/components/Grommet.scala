...
import typingsSlinky.grommet.mod.Grommet_
...
object Grommet {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, Grommet_] {
    ...
    @scala.inline
    def containerTarget(value: HTMLElement): this.type = set("containerTarget", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def cssVars(value: Boolean): this.type = set("cssVars", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def dir(value: rtl): this.type = set("dir", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def themeMode(value: dark | light): this.type = set("themeMode", value.asInstanceOf[js.Any])
  ...
  def withProps(p: GrommetProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
