...
object Form {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def messages(value: Invalid): this.type = set("messages", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onReset(value: /* event */ SyntheticEvent[Event, Element] => _): this.type = set("onReset", js.Any.fromFunction1(value))
    @scala.inline
