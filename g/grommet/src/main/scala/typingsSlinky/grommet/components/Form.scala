...
object Form
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Form] {
  @JSImport("grommet", "Form")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: onSubmit */
  def apply(
    about: String = null,
    ...
    onChange: /* event */ ChangeEvent[org.scalajs.dom.raw.Element] => Unit = null,
    ...
    onReset: /* event */ SyntheticEvent[Event_, org.scalajs.dom.raw.Element] => _ = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Form] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Form] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Form](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
