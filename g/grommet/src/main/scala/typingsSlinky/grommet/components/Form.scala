...
object Form {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.Form] {
    @scala.inline
    ...
    @scala.inline
    def errors(value: js.Object): this.type = set("errors", value.asInstanceOf[js.Any])
    @scala.inline
    def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    @scala.inline
    def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def infos(value: js.Object): this.type = set("infos", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def messages(value: AnonInvalid): this.type = set("messages", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onReset(value: /* event */ SyntheticEvent[Event_, Element] => _): this.type = set("onReset", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def validate(value: blur | submit): this.type = set("validate", value.asInstanceOf[js.Any])
    @scala.inline
    def value(value: js.Object): this.type = set("value", value.asInstanceOf[js.Any])
    @scala.inline
