...
object AccordionPanel
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.AccordionPanel] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.AccordionPanel] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.AccordionPanel] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.AccordionPanel](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
