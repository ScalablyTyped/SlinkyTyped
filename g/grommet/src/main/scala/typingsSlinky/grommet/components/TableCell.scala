...
object TableCell {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.div.tag.type, LegacyRef[js.Any]] {
    @scala.inline
    ...
    @scala.inline
    def scope(value: col | row): this.type = set("scope", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def valign(value: top | middle | bottom | typingsSlinky.react.reactStrings.baseline): this.type = set("valign", value.asInstanceOf[js.Any])
    @scala.inline
    def verticalAlign(
      value: typingsSlinky.grommet.grommetStrings.top | typingsSlinky.grommet.grommetStrings.middle | typingsSlinky.grommet.grommetStrings.bottom
  ...
  def withProps(
    p: TableCellProps with BoxTypes with (DetailedHTMLProps[TdHTMLAttributes[HTMLTableDataCellElement], HTMLTableDataCellElement])
