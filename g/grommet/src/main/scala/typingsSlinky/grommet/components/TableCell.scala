...
object TableCell
  ...
  def apply(
    ...
    valign: top | middle | bottom | typingsSlinky.react.reactStrings.baseline = null,
    verticalAlign: typingsSlinky.grommet.grommetStrings.top | typingsSlinky.grommet.grommetStrings.middle | typingsSlinky.grommet.grommetStrings.bottom = null,
    vocab: String = null,
