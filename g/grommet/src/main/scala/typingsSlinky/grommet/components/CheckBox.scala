...
object CheckBox {
  ...
  def withProps(p: CheckBoxProps with (DetailedHTMLProps[InputHTMLAttributes[HTMLInputElement], HTMLInputElement])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
