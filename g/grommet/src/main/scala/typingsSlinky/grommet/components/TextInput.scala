...
object TextInput
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.TextInput] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.TextInput] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.TextInput] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.TextInput](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
