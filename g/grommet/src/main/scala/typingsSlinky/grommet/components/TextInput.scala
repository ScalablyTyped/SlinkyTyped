...
object TextInput {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def messages(value: EnterSelect): this.type = set("messages", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onSelect(value: /* x */ Suggestion => Unit): this.type = set("onSelect", js.Any.fromFunction1(value))
