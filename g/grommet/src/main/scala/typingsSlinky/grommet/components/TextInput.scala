...
object TextInput {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.TextInput] {
    @scala.inline
    ...
    @scala.inline
    def messages(value: AnonEnterSelect): this.type = set("messages", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onSelect(value: /* x */ AnonSuggestion => Unit): this.type = set("onSelect", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def suggestions(value: js.Array[AnonLabelValue | String]): this.type = set("suggestions", value.asInstanceOf[js.Any])
    @scala.inline
