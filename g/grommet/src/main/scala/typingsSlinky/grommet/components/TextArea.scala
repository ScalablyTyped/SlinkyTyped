...
object TextArea
  ...
  /* The following DOM/SVG props were specified: id, name, placeholder */
  def apply(
    about: String = null,
    ...
    onInput: SyntheticEvent[EventTarget with HTMLTextAreaElement, Event_] => Unit = null,
    ...
    resize: typingsSlinky.grommet.grommetStrings.vertical | typingsSlinky.grommet.grommetStrings.horizontal | Boolean = null,
  ...
  type Props = TextAreaProps with (DetailedHTMLProps[TextareaHTMLAttributes[HTMLTextAreaElement], HTMLTextAreaElement])
}
