...
object TextArea {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def resize(
      value: typingsSlinky.grommet.grommetStrings.vertical | typingsSlinky.grommet.grommetStrings.horizontal | Boolean
    ): this.type = set("resize", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(
    p: TextAreaProps with (DetailedHTMLProps[TextareaHTMLAttributes[HTMLTextAreaElement], HTMLTextAreaElement])
