...
object CardHeader {
  ...
  implicit def make(companion: CardHeader.type): SharedBuilder_BoxTypes_1397625506[HTMLDivElement] = new SharedBuilder_BoxTypes_1397625506[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
