...
object DropButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.DropButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.DropButton] = {
