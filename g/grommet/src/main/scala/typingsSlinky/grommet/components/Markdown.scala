...
object Markdown
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Markdown] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Markdown] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Markdown] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Markdown](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
