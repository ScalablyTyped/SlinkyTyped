...
object FormField {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.FormField] {
    ...
    @scala.inline
    def contentProps(value: BoxProps): this.type = set("contentProps", value.asInstanceOf[js.Any])
