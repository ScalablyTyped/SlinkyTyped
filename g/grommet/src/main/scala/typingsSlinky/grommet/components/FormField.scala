...
object FormField
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.FormField] {
  @JSImport("grommet", "FormField")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: htmlFor, name, required */
  def apply(
    about: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.FormField] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.FormField] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.FormField](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
