...
object Calendar {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.grommet.mod.Calendar] {
    @scala.inline
    ...
    @scala.inline
    def header(value: /* repeated */ js.Any => _): this.type = set("header", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onReference(value: /* reference */ String => Unit): this.type = set("onReference", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def reference(value: String): this.type = set("reference", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def showAdjacentDays(value: Boolean): this.type = set("showAdjacentDays", value.asInstanceOf[js.Any])
    @scala.inline
    def size(value: small | medium | large | String): this.type = set("size", value.asInstanceOf[js.Any])
    @scala.inline
