...
object Calendar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommet.mod.Calendar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Calendar] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.grommet.mod.Calendar] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.grommet.mod.Calendar](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CalendarProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
}
