...
object selectMod {
  ...
  trait SelectProps extends StObject {
    ...
    var icon: js.UndefOr[Boolean | (js.Function1[/* repeated */ js.Any, _]) | ReactElement] = js.native
  ...
  object SelectProps {
    ...
    implicit class SelectPropsMutableBuilder[Self <: SelectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIcon(value: Boolean | (js.Function1[/* repeated */ js.Any, _]) | ReactElement): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOptions(value: js.Array[String | Boolean | Double | ReactElement | js.Object]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOptionsVarargs(value: (String | Boolean | Double | ReactElement | js.Object)*): Self = StObject.set(x, "options", js.Array(value :_*))
      ...
      @scala.inline
      def setValue(value: String | ReactElement | js.Object | (js.Array[String | Double | js.Object])): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValueLabel(value: ReactElement): Self = StObject.set(x, "valueLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValueLabelReactElement(value: ReactElement): Self = StObject.set(x, "valueLabel", value.asInstanceOf[js.Any])
