...
trait AnonBody extends js.Object {
  var body: js.UndefOr[String | AnonDark | js.Array[String]] = js.native
  var color: js.UndefOr[String] = js.native
  var dark: js.UndefOr[String] = js.native
  var footer: js.UndefOr[String | AnonDark] = js.native
  var header: js.UndefOr[String | AnonDark] = js.native
...
object AnonBody {
  ...
  implicit class AnonBodyOps[Self <: AnonBody] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBody(value: String | AnonDark | js.Array[String]): Self = {
    ...
    @scala.inline
    def withFooter(value: String | AnonDark): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHeader(value: String | AnonDark): Self = {
        val ret = this.duplicate
