...
trait AnonHeading extends js.Object {
  ...
  var icons: js.UndefOr[AnonPrevious] = js.native
  var large: js.UndefOr[AnonDaySize] = js.native
  var medium: js.UndefOr[AnonDaySize] = js.native
  var small: js.UndefOr[AnonDaySize] = js.native
}

object AnonHeading {
  @scala.inline
  def apply(): AnonHeading = {
  ...
  implicit class AnonHeadingOps[Self <: AnonHeading] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIcons(value: AnonPrevious): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLarge(value: AnonDaySize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMedium(value: AnonDaySize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSmall(value: AnonDaySize): Self = {
        val ret = this.duplicate
