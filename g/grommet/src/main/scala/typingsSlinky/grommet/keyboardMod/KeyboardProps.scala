...
object KeyboardProps {
  ...
  implicit class KeyboardPropsOps[Self <: KeyboardProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBackspace(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onBackspace", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnBackspace: Self = this.set("onBackspace", js.undefined)
    
    @scala.inline
    def setOnComma(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onComma", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnComma: Self = this.set("onComma", js.undefined)
    
    @scala.inline
    def setOnDown(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onDown", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnDown: Self = this.set("onDown", js.undefined)
    
    @scala.inline
    def setOnEnter(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onEnter", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnLeft(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onLeft", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnLeft: Self = this.set("onLeft", js.undefined)
    
    @scala.inline
    def setOnRight(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onRight", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnRight: Self = this.set("onRight", js.undefined)
    
    @scala.inline
    def setOnShift(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onShift", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnShift: Self = this.set("onShift", js.undefined)
    
    @scala.inline
    def setOnSpace(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onSpace", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnSpace: Self = this.set("onSpace", js.undefined)
    
    @scala.inline
    def setOnTab(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onTab", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnTab: Self = this.set("onTab", js.undefined)
    
    @scala.inline
    def setOnUp(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => Unit): Self = this.set("onUp", js.Any.fromFunction1(value))
