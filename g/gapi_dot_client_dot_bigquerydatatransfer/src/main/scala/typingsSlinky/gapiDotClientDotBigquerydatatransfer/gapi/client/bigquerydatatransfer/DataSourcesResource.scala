package typingsSlinky.gapiDotClientDotBigquerydatatransfer.gapi.client.bigquerydatatransfer

import typingsSlinky.gapiDotClient.gapi.client.Request
import typingsSlinky.gapiDotClientDotBigquerydatatransfer.Anon_Accesstoken
import typingsSlinky.gapiDotClientDotBigquerydatatransfer.Anon_AccesstokenAlt
