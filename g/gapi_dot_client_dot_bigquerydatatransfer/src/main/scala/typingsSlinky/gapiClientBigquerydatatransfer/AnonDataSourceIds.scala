...
object AnonDataSourceIds {
  @scala.inline
  def apply(parent: String): AnonDataSourceIds = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDataSourceIds]
  }
  @scala.inline
  implicit class AnonDataSourceIdsOps[Self <: AnonDataSourceIds] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDataSourceIds(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataSourceIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDataSourceIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataSourceIds")(js.undefined)
        ret
    }
    @scala.inline
