...
object AnonIncludeInactive {
  @scala.inline
  def apply(accountId: String, adClientId: String): AnonIncludeInactive = {
  ...
  @scala.inline
  implicit class AnonIncludeInactiveOps[Self <: AnonIncludeInactive] (val x: Self) extends AnyVal {
    @scala.inline
