...
object AnonCustomChannelId {
  @scala.inline
  def apply(accountId: String, adClientId: String, customChannelId: String): AnonCustomChannelId = {
  ...
  @scala.inline
  implicit class AnonCustomChannelIdOps[Self <: AnonCustomChannelId] (val x: Self) extends AnyVal {
    @scala.inline
