...
trait Anon_AccountIdAdClientIdAltFields extends js.Object {
...
object Anon_AccountIdAdClientIdAltFields {
  @scala.inline
  def apply(
    accountId: String,
    adClientId: String,
    ...
    userIp: String = null
  ): Anon_AccountIdAdClientIdAltFields = {
    ...
    __obj.asInstanceOf[Anon_AccountIdAdClientIdAltFields]
  }
}
