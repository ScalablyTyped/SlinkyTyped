...
object Format {
  ...
  implicit class FormatOps[Self <: Format] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withListState(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("listState")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutListState: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("listState")(js.undefined)
        ret
    }
    @scala.inline
