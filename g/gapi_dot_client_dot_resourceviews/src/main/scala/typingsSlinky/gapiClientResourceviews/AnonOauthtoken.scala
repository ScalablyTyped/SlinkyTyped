...
object AnonOauthtoken {
  @scala.inline
  def apply(project: String, resourceView: String, zone: String): AnonOauthtoken = {
  ...
  implicit class AnonOauthtokenOps[Self <: AnonOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceView(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resourceView")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
