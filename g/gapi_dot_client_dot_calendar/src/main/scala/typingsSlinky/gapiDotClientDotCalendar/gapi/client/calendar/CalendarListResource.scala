...
import typingsSlinky.gapiDotClientDotCalendar.Anon_AltCalendarIdColorRgbFormat
import typingsSlinky.gapiDotClientDotCalendar.Anon_AltColorRgbFormat
import typingsSlinky.gapiDotClientDotCalendar.Anon_AltFields
