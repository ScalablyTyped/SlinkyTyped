...
@js.native
trait AnonColorRgbFormat extends js.Object {
...
object AnonColorRgbFormat {
  @scala.inline
  def apply(): AnonColorRgbFormat = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonColorRgbFormat]
  }
  @scala.inline
  implicit class AnonColorRgbFormatOps[Self <: AnonColorRgbFormat] (val x: Self) extends AnyVal {
    @scala.inline
