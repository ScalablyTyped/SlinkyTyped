...
@js.native
trait AnonICalUID extends js.Object {
...
object AnonICalUID {
  @scala.inline
  def apply(calendarId: String): AnonICalUID = {
    val __obj = js.Dynamic.literal(calendarId = calendarId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonICalUID]
  }
  @scala.inline
  implicit class AnonICalUIDOps[Self <: AnonICalUID] (val x: Self) extends AnyVal {
    @scala.inline
