...
@js.native
trait AnonMaxAttendees extends js.Object {
...
object AnonMaxAttendees {
  @scala.inline
  def apply(calendarId: String): AnonMaxAttendees = {
    val __obj = js.Dynamic.literal(calendarId = calendarId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonMaxAttendees]
  }
  @scala.inline
  implicit class AnonMaxAttendeesOps[Self <: AnonMaxAttendees] (val x: Self) extends AnyVal {
    @scala.inline
