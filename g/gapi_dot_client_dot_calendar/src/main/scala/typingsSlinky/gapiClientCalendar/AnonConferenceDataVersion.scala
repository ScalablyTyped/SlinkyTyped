...
@js.native
trait AnonConferenceDataVersion extends js.Object {
...
object AnonConferenceDataVersion {
  @scala.inline
  def apply(calendarId: String): AnonConferenceDataVersion = {
    val __obj = js.Dynamic.literal(calendarId = calendarId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonConferenceDataVersion]
  }
  @scala.inline
  implicit class AnonConferenceDataVersionOps[Self <: AnonConferenceDataVersion] (val x: Self) extends AnyVal {
    @scala.inline
