...
@js.native
trait AnonAlwaysIncludeEmail extends js.Object {
...
object AnonAlwaysIncludeEmail {
  @scala.inline
  def apply(calendarId: String, eventId: String): AnonAlwaysIncludeEmail = {
    val __obj = js.Dynamic.literal(calendarId = calendarId.asInstanceOf[js.Any], eventId = eventId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAlwaysIncludeEmail]
  }
  @scala.inline
  implicit class AnonAlwaysIncludeEmailOps[Self <: AnonAlwaysIncludeEmail] (val x: Self) extends AnyVal {
    @scala.inline
