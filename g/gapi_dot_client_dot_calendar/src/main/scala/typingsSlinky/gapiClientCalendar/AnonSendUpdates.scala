...
@js.native
trait AnonSendUpdates extends js.Object {
...
object AnonSendUpdates {
  @scala.inline
  def apply(calendarId: String, text: String): AnonSendUpdates = {
    val __obj = js.Dynamic.literal(calendarId = calendarId.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSendUpdates]
  }
  @scala.inline
  implicit class AnonSendUpdatesOps[Self <: AnonSendUpdates] (val x: Self) extends AnyVal {
    @scala.inline
