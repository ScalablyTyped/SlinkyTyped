...
import typingsSlinky.gapiClientCalendar.gapi.client.calendar.CalendarListEntry
...
trait ColorRgbFormat extends js.Object {
  ...
  /** Request body */
  var resource: CalendarListEntry = js.native
...
object ColorRgbFormat {
  ...
  @scala.inline
  def apply(resource: CalendarListEntry): ColorRgbFormat = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ColorRgbFormat]
  }
  
  @scala.inline
  implicit class ColorRgbFormatOps[Self <: ColorRgbFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CalendarListEntry): Self = this.set("resource", value.asInstanceOf[js.Any])
