...
@js.native
trait AnonSetting extends js.Object {
...
object AnonSetting {
  @scala.inline
  def apply(setting: String): AnonSetting = {
    val __obj = js.Dynamic.literal(setting = setting.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSetting]
  }
  @scala.inline
  implicit class AnonSettingOps[Self <: AnonSetting] (val x: Self) extends AnyVal {
    @scala.inline
