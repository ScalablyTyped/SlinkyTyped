...
import typingsSlinky.gapiDotClientDotStoragetransfer.Anon_AccesstokenAlt
import typingsSlinky.gapiDotClientDotStoragetransfer.Anon_AccesstokenAltBearertoken
import typingsSlinky.gapiDotClientDotStoragetransfer.Anon_AccesstokenAltBearertokenCallback
import typingsSlinky.gapiDotClientDotStoragetransfer.Anon_AccesstokenAltBearertokenCallbackFields
