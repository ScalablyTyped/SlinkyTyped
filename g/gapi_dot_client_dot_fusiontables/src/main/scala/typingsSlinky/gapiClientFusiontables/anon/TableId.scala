...
@js.native
trait TableId extends js.Object {
...
object TableId {
  ...
  @scala.inline
  def apply(tableId: String, taskId: String): TableId = {
    val __obj = js.Dynamic.literal(tableId = tableId.asInstanceOf[js.Any], taskId = taskId.asInstanceOf[js.Any])
    __obj.asInstanceOf[TableId]
  }
  
  @scala.inline
  implicit class TableIdOps[Self <: TableId] (val x: Self) extends AnyVal {
