...
object AnonOauthtoken {
  @scala.inline
  def apply(styleId: Double, tableId: String): AnonOauthtoken = {
    val __obj = js.Dynamic.literal(styleId = styleId.asInstanceOf[js.Any], tableId = tableId.asInstanceOf[js.Any])
