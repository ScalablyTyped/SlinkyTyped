...
@js.native
trait AnonCopyPresentation extends js.Object {
...
object AnonCopyPresentation {
  @scala.inline
  def apply(tableId: String): AnonCopyPresentation = {
    val __obj = js.Dynamic.literal(tableId = tableId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCopyPresentation]
  }
  @scala.inline
  implicit class AnonCopyPresentationOps[Self <: AnonCopyPresentation] (val x: Self) extends AnyVal {
    @scala.inline
