...
@js.native
trait AnonCustomerAuthToken extends js.Object {
...
object AnonCustomerAuthToken {
  @scala.inline
  def apply(): AnonCustomerAuthToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCustomerAuthToken]
  }
  @scala.inline
  implicit class AnonCustomerAuthTokenOps[Self <: AnonCustomerAuthToken] (val x: Self) extends AnyVal {
    @scala.inline
