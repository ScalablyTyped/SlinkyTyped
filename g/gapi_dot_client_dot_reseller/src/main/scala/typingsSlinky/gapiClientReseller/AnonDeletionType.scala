...
object AnonDeletionType {
  @scala.inline
  def apply(customerId: String, deletionType: String, subscriptionId: String): AnonDeletionType = {
  ...
  @scala.inline
  implicit class AnonDeletionTypeOps[Self <: AnonDeletionType] (val x: Self) extends AnyVal {
    @scala.inline
