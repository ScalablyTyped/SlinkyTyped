...
@js.native
trait AnonCid extends js.Object {
  /**
...
object AnonCid {
  @scala.inline
  def apply(q: js.Array[String], target: String): AnonCid = {
    val __obj = js.Dynamic.literal(q = q.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCid]
  }
  @scala.inline
  implicit class AnonCidOps[Self <: AnonCid] (val x: Self) extends AnyVal {
    @scala.inline
