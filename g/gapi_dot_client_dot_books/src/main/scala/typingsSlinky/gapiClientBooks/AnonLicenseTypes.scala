...
object AnonLicenseTypes {
  @scala.inline
  def apply(cpksver: String, nonce: String, source: String, volumeId: String): AnonLicenseTypes = {
  ...
  @scala.inline
  implicit class AnonLicenseTypesOps[Self <: AnonLicenseTypes] (val x: Self) extends AnyVal {
    @scala.inline
