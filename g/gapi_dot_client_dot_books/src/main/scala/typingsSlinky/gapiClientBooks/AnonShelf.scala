...
@js.native
trait AnonShelf extends js.Object {
...
object AnonShelf {
  @scala.inline
  def apply(shelf: String, volumeId: String, volumePosition: Double): AnonShelf = {
    ...
    __obj.asInstanceOf[AnonShelf]
  }
  @scala.inline
  implicit class AnonShelfOps[Self <: AnonShelf] (val x: Self) extends AnyVal {
    @scala.inline
