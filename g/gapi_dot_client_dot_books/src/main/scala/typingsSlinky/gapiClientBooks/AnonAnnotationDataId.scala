...
@js.native
trait AnonAnnotationDataId extends js.Object {
...
object AnonAnnotationDataId {
  @scala.inline
  def apply(contentVersion: String, layerId: String, volumeId: String): AnonAnnotationDataId = {
    ...
    __obj.asInstanceOf[AnonAnnotationDataId]
  }
  @scala.inline
  implicit class AnonAnnotationDataIdOps[Self <: AnonAnnotationDataId] (val x: Self) extends AnyVal {
    @scala.inline
