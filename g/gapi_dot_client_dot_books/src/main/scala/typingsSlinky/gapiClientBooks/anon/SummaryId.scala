...
@js.native
trait SummaryId extends js.Object {
  ...
  var summaryId: String = js.native
...
object SummaryId {
  @scala.inline
  def apply(summaryId: String, volumeId: String): SummaryId = {
    val __obj = js.Dynamic.literal(summaryId = summaryId.asInstanceOf[js.Any], volumeId = volumeId.asInstanceOf[js.Any])
    __obj.asInstanceOf[SummaryId]
  }
  @scala.inline
  implicit class SummaryIdOps[Self <: SummaryId] (val x: Self) extends AnyVal {
    @scala.inline
