...
@js.native
trait Drivedocumentid extends js.Object {
...
object Drivedocumentid {
  @scala.inline
  def apply(): Drivedocumentid = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Drivedocumentid]
  }
  @scala.inline
  implicit class DrivedocumentidOps[Self <: Drivedocumentid] (val x: Self) extends AnyVal {
    @scala.inline
