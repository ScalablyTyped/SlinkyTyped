...
object LicenseTypes {
  ...
  @scala.inline
  def apply(cpksver: String, nonce: String, source: String, volumeId: String): LicenseTypes = {
  ...
  @scala.inline
  implicit class LicenseTypesOps[Self <: LicenseTypes] (val x: Self) extends AnyVal {
