...
@js.native
trait AnonSeriesid extends js.Object {
  ...
  var series_id: String = js.native
...
object AnonSeriesid {
  @scala.inline
  def apply(series_id: String): AnonSeriesid = {
    val __obj = js.Dynamic.literal(series_id = series_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSeriesid]
  }
  @scala.inline
  implicit class AnonSeriesidOps[Self <: AnonSeriesid] (val x: Self) extends AnyVal {
    @scala.inline
