...
object AnonRating {
  @scala.inline
  def apply(rating: String, volumeId: String): AnonRating = {
    val __obj = js.Dynamic.literal(rating = rating.asInstanceOf[js.Any], volumeId = volumeId.asInstanceOf[js.Any])
