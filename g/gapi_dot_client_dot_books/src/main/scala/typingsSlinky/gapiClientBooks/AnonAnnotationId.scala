...
object AnonAnnotationId {
  @scala.inline
  def apply(annotationId: String, layerId: String, volumeId: String): AnonAnnotationId = {
  ...
  @scala.inline
  implicit class AnonAnnotationIdOps[Self <: AnonAnnotationId] (val x: Self) extends AnyVal {
    @scala.inline
