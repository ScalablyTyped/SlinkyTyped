...
object AnonAllowWebDefinitions {
  @scala.inline
  def apply(annotationDataId: String, contentVersion: String, layerId: String, volumeId: String): AnonAllowWebDefinitions = {
  ...
  @scala.inline
  implicit class AnonAllowWebDefinitionsOps[Self <: AnonAllowWebDefinitions] (val x: Self) extends AnyVal {
    @scala.inline
