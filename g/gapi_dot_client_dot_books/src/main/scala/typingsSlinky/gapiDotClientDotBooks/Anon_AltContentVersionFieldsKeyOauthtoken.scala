...
trait Anon_AltContentVersionFieldsKeyOauthtoken extends js.Object {
...
object Anon_AltContentVersionFieldsKeyOauthtoken {
  @scala.inline
  def apply(
    volumeId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AltContentVersionFieldsKeyOauthtoken]
  }
}
