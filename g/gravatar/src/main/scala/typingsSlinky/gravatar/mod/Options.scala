...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForcedefault(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forcedefault")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutForcedefault: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forcedefault")(js.undefined)
        ret
    }
    @scala.inline
