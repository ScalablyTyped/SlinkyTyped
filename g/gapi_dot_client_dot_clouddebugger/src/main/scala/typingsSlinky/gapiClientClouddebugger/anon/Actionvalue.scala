package typingsSlinky.gapiClientClouddebugger.anon
...
object Actionvalue {
  ...
  def apply(
    ...
    if (!js.isUndefined(includeAllUsers)) __obj.updateDynamic("includeAllUsers")(includeAllUsers.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(stripResults)) __obj.updateDynamic("stripResults")(stripResults.get.asInstanceOf[js.Any])
