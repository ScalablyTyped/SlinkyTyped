...
object methodTypes extends StObject {
  ...
  /* 3 */ val BIDI_STREAMING: typingsSlinky.grpc.mod.methodTypes.BIDI_STREAMING with Double = js.native
  
  @js.native
  sealed trait CLIENT_STREAMING extends methodTypes
  /* 1 */ val CLIENT_STREAMING: typingsSlinky.grpc.mod.methodTypes.CLIENT_STREAMING with Double = js.native
  
  @js.native
  sealed trait SERVER_STREAMING extends methodTypes
  /* 2 */ val SERVER_STREAMING: typingsSlinky.grpc.mod.methodTypes.SERVER_STREAMING with Double = js.native
  
  @js.native
  sealed trait UNARY extends methodTypes
  /* 0 */ val UNARY: typingsSlinky.grpc.mod.methodTypes.UNARY with Double = js.native
}
