...
object writeFlags extends StObject {
  ...
  /* 1 */ val BUFFER_HINT: typingsSlinky.grpc.mod.writeFlags.BUFFER_HINT with Double = js.native
  ...
  /* 0 */ val NO_COMPRESS: typingsSlinky.grpc.mod.writeFlags.NO_COMPRESS with Double = js.native
}
