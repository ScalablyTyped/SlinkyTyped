...
object GoogleOAuth2Client {
  ...
  implicit class GoogleOAuth2ClientMutableBuilder[Self <: GoogleOAuth2Client] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetRequestMetadata(value: (String, js.Function2[/* err */ js.Error, /* headers */ js.Any, Unit]) => Unit): Self = StObject.set(x, "getRequestMetadata", js.Any.fromFunction2(value))
  }
}
