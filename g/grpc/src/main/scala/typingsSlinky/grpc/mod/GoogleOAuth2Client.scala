...
trait GoogleOAuth2Client extends js.Object {
  def getRequestMetadata(optUri: String, metadataCallback: js.Function2[/* err */ js.Error, /* headers */ js.Any, Unit]): Unit = js.native
}
...
object GoogleOAuth2Client {
  ...
  implicit class GoogleOAuth2ClientOps[Self <: GoogleOAuth2Client] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetRequestMetadata(value: (String, js.Function2[/* err */ js.Error, /* headers */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRequestMetadata")(js.Any.fromFunction2(value))
        ret
    }
  }
