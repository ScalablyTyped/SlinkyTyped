...
object writeFlags extends js.Object {
  ...
  /* 1 */ val BUFFER_HINT: typingsSlinky.grpc.grpcMod.writeFlags.BUFFER_HINT with Double = js.native
  /* 0 */ val NO_COMPRESS: typingsSlinky.grpc.grpcMod.writeFlags.NO_COMPRESS with Double = js.native
  @JSBracketAccess
