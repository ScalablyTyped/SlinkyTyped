package typingsSlinky.gapiClientYoutubeanalytics.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientYoutubeanalytics.gapiClientYoutubeanalyticsStrings.youtubeanalytics,
    version: v1
