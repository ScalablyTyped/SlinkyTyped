...
object AnonHostCustomChannelId {
  @scala.inline
  def apply(accountId: String, adClientId: String, adUnitId: String): AnonHostCustomChannelId = {
  ...
  @scala.inline
  implicit class AnonHostCustomChannelIdOps[Self <: AnonHostCustomChannelId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withHostCustomChannelId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hostCustomChannelId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHostCustomChannelId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hostCustomChannelId")(js.undefined)
        ret
    }
    @scala.inline
