...
import typingsSlinky.gapiDotClientDotClassroom.Anon_AccesstokenAltBearertokenCallbackFieldsKey
...
trait RegistrationsResource extends js.Object {
  /**
    ...
    */
  def create(request: Anon_AccesstokenAltBearertokenCallbackFields): Request[Registration]
  /**
...
object RegistrationsResource {
  @scala.inline
  def apply(
    create: Anon_AccesstokenAltBearertokenCallbackFields => Request[Registration],
