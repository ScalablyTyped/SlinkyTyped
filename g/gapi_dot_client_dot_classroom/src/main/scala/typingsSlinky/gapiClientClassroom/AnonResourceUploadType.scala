...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.Invitation
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonResourceUploadType extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonResourceUploadType {
  @scala.inline
  def apply(resource: Invitation): AnonResourceUploadType = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonResourceUploadType]
  }
  @scala.inline
  implicit class AnonResourceUploadTypeOps[Self <: AnonResourceUploadType] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withResource(value: Invitation): Self = {
