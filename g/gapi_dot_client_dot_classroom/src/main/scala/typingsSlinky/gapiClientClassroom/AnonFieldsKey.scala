...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.Topic
...
object AnonFieldsKey {
  @scala.inline
  def apply(courseId: String, resource: Topic): AnonFieldsKey = {
  ...
  implicit class AnonFieldsKeyOps[Self <: AnonFieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: Topic): Self = {
        val ret = this.duplicate
