...
object AnonCourseWorkStates {
  @scala.inline
  def apply(courseId: String): AnonCourseWorkStates = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCourseWorkStates]
  }
  @scala.inline
  implicit class AnonCourseWorkStatesOps[Self <: AnonCourseWorkStates] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCourseWorkStates(value: String | js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("courseWorkStates")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCourseWorkStates: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("courseWorkStates")(js.undefined)
        ret
    }
    @scala.inline
