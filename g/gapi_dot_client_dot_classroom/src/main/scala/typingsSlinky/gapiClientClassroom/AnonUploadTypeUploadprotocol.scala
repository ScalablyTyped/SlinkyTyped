...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.Registration
...
object AnonUploadTypeUploadprotocol {
  @scala.inline
  def apply(resource: Registration): AnonUploadTypeUploadprotocol = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonUploadTypeUploadprotocol]
  }
  @scala.inline
  implicit class AnonUploadTypeUploadprotocolOps[Self <: AnonUploadTypeUploadprotocol] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withResource(value: Registration): Self = {
