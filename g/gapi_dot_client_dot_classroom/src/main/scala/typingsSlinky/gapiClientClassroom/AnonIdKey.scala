...
@js.native
trait AnonIdKey extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonIdKey {
  @scala.inline
  def apply(id: String): AnonIdKey = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIdKey]
  }
  @scala.inline
  implicit class AnonIdKeyOps[Self <: AnonIdKey] (val x: Self) extends AnyVal {
    @scala.inline
