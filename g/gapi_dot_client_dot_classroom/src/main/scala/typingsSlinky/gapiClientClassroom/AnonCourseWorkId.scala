...
object AnonCourseWorkId {
  @scala.inline
  def apply(courseId: String, courseWorkId: String, id: String): AnonCourseWorkId = {
  ...
  @scala.inline
  implicit class AnonCourseWorkIdOps[Self <: AnonCourseWorkId] (val x: Self) extends AnyVal {
    @scala.inline
