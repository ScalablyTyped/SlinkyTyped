...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.ModifyAttachmentsRequest
...
object AnonPrettyPrint {
  @scala.inline
  def apply(courseId: String, courseWorkId: String, id: String, resource: ModifyAttachmentsRequest): AnonPrettyPrint = {
  ...
  implicit class AnonPrettyPrintOps[Self <: AnonPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: ModifyAttachmentsRequest): Self = {
        val ret = this.duplicate
