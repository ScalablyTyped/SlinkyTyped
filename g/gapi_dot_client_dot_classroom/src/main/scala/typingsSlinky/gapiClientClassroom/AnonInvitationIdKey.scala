...
object AnonInvitationIdKey {
  @scala.inline
  def apply(invitationId: String, studentId: String): AnonInvitationIdKey = {
  ...
  @scala.inline
  implicit class AnonInvitationIdKeyOps[Self <: AnonInvitationIdKey] (val x: Self) extends AnyVal {
    @scala.inline
