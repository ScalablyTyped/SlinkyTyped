...
object AnonStudentId {
  @scala.inline
  def apply(resource: GuardianInvitation, studentId: String): AnonStudentId = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any], studentId = studentId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonStudentId]
  }
  @scala.inline
  implicit class AnonStudentIdOps[Self <: AnonStudentId] (val x: Self) extends AnyVal {
    @scala.inline
