...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.Teacher
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonCourseIdFields extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCourseIdFields {
  @scala.inline
  def apply(courseId: String, resource: Teacher): AnonCourseIdFields = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCourseIdFields]
  }
  @scala.inline
  implicit class AnonCourseIdFieldsOps[Self <: AnonCourseIdFields] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResource(value: Teacher): Self = {
        val ret = this.duplicate
