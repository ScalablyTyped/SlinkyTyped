...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.Course
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonOauthtokenPrettyPrint extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonOauthtokenPrettyPrint {
  @scala.inline
  def apply(id: String, resource: Course): AnonOauthtokenPrettyPrint = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOauthtokenPrettyPrint]
  }
  @scala.inline
  implicit class AnonOauthtokenPrettyPrintOps[Self <: AnonOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResource(value: Course): Self = {
        val ret = this.duplicate
