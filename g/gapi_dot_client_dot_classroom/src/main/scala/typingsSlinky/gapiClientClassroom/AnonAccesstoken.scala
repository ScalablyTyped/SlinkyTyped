...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.CourseAlias
...
object AnonAccesstoken {
  @scala.inline
  def apply(courseId: String, resource: CourseAlias): AnonAccesstoken = {
  ...
  implicit class AnonAccesstokenOps[Self <: AnonAccesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: CourseAlias): Self = {
        val ret = this.duplicate
