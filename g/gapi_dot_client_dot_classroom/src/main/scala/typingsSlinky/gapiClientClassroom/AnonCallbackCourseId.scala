...
@js.native
trait AnonCallbackCourseId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCallbackCourseId {
  @scala.inline
  def apply(courseId: String): AnonCallbackCourseId = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCallbackCourseId]
  }
  @scala.inline
  implicit class AnonCallbackCourseIdOps[Self <: AnonCallbackCourseId] (val x: Self) extends AnyVal {
    @scala.inline
