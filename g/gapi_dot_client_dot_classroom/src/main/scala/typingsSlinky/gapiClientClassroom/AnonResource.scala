...
object AnonResource {
  @scala.inline
  def apply(courseId: String, courseWorkId: String, id: String, resource: ReclaimStudentSubmissionRequest): AnonResource = {
  ...
  implicit class AnonResourceOps[Self <: AnonResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: ReclaimStudentSubmissionRequest): Self = {
        val ret = this.duplicate
