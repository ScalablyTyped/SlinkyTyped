...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.ReturnStudentSubmissionRequest
...
object AnonUploadType {
  @scala.inline
  def apply(courseId: String, courseWorkId: String, id: String, resource: ReturnStudentSubmissionRequest): AnonUploadType = {
  ...
  implicit class AnonUploadTypeOps[Self <: AnonUploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: ReturnStudentSubmissionRequest): Self = {
        val ret = this.duplicate
