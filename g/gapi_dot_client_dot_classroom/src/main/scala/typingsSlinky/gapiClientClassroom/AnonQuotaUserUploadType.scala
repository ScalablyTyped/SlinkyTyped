...
object AnonQuotaUserUploadType {
  @scala.inline
  def apply(userId: String): AnonQuotaUserUploadType = {
    val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonQuotaUserUploadType]
  }
  @scala.inline
  implicit class AnonQuotaUserUploadTypeOps[Self <: AnonQuotaUserUploadType] (val x: Self) extends AnyVal {
    @scala.inline
