...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.ModifyAnnouncementAssigneesRequest
...
object AnonId {
  @scala.inline
  def apply(courseId: String, id: String, resource: ModifyAnnouncementAssigneesRequest): AnonId = {
  ...
  implicit class AnonIdOps[Self <: AnonId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: ModifyAnnouncementAssigneesRequest): Self = {
        val ret = this.duplicate
