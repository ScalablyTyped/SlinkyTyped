...
@js.native
trait AnonQuotaUserResource extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonQuotaUserResource {
  @scala.inline
  def apply(id: String, resource: Course): AnonQuotaUserResource = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonQuotaUserResource]
  }
  @scala.inline
  implicit class AnonQuotaUserResourceOps[Self <: AnonQuotaUserResource] (val x: Self) extends AnyVal {
    @scala.inline
