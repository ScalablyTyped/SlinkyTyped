...
object AnonRegistrationId {
  @scala.inline
  def apply(registrationId: String): AnonRegistrationId = {
    val __obj = js.Dynamic.literal(registrationId = registrationId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonRegistrationId]
  }
  @scala.inline
  implicit class AnonRegistrationIdOps[Self <: AnonRegistrationId] (val x: Self) extends AnyVal {
    @scala.inline
