...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.ModifyCourseWorkAssigneesRequest
...
object AnonAccesstokenAlt {
  @scala.inline
  def apply(courseId: String, id: String, resource: ModifyCourseWorkAssigneesRequest): AnonAccesstokenAlt = {
  ...
  implicit class AnonAccesstokenAltOps[Self <: AnonAccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: ModifyCourseWorkAssigneesRequest): Self = {
        val ret = this.duplicate
