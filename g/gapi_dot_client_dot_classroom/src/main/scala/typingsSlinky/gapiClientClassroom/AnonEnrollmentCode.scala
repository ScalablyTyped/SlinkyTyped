...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.Student
...
object AnonEnrollmentCode {
  @scala.inline
  def apply(courseId: String, resource: Student): AnonEnrollmentCode = {
  ...
  @scala.inline
  implicit class AnonEnrollmentCodeOps[Self <: AnonEnrollmentCode] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResource(value: Student): Self = {
        val ret = this.duplicate
