...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.TurnInStudentSubmissionRequest
...
object Uploadprotocol {
  ...
  implicit class UploadprotocolOps[Self <: Uploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResource(value: TurnInStudentSubmissionRequest): Self = {
        val ret = this.duplicate
