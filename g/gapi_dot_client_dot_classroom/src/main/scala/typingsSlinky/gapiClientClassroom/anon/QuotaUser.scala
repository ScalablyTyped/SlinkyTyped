...
import typingsSlinky.gapiClientClassroom.gapi.client.classroom.StudentSubmission
...
object QuotaUser {
  @scala.inline
  def apply(courseId: String, courseWorkId: String, id: String, resource: StudentSubmission): QuotaUser = {
  ...
  implicit class QuotaUserOps[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: StudentSubmission): Self = this.set("resource", value.asInstanceOf[js.Any])
    @scala.inline
