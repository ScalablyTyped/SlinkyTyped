...
@js.native
trait AnonCourseId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCourseId {
  @scala.inline
  def apply(courseId: String, resource: Announcement): AnonCourseId = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCourseId]
  }
  @scala.inline
  implicit class AnonCourseIdOps[Self <: AnonCourseId] (val x: Self) extends AnyVal {
    @scala.inline
