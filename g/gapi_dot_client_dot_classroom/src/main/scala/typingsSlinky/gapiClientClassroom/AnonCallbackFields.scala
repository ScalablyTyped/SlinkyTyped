...
@js.native
trait AnonCallbackFields extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonCallbackFields {
  @scala.inline
  def apply(resource: Course): AnonCallbackFields = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCallbackFields]
  }
  @scala.inline
  implicit class AnonCallbackFieldsOps[Self <: AnonCallbackFields] (val x: Self) extends AnyVal {
    @scala.inline
