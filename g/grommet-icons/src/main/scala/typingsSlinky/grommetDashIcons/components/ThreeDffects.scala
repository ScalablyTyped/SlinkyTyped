...
object ThreeDffects
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.ThreeDffects] {
  @JSImport("grommet-icons/icons", "ThreeDffects")
  @js.native
