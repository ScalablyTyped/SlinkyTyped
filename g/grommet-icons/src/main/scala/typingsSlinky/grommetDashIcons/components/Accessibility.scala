...
object Accessibility
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.Accessibility] {
  @JSImport("grommet-icons/icons", "Accessibility")
  @js.native
