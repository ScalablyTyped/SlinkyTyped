...
object Organization
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.Organization] {
  @JSImport("grommet-icons/icons", "Organization")
  @js.native
