...
object DocumentVideo
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.DocumentVideo] {
  @JSImport("grommet-icons/icons", "DocumentVideo")
  @js.native
