...
object StatusUnknownSmall
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.StatusUnknownSmall] {
  @JSImport("grommet-icons/icons", "StatusUnknownSmall")
  @js.native
