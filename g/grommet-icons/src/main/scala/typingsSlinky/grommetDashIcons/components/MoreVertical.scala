...
object MoreVertical
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.MoreVertical] {
  @JSImport("grommet-icons/icons", "MoreVertical")
  @js.native
