...
object SubtractCircle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.SubtractCircle] {
  @JSImport("grommet-icons/icons", "SubtractCircle")
  @js.native
