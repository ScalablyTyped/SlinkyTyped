...
object DocumentOutlook
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.DocumentOutlook] {
  @JSImport("grommet-icons/icons", "DocumentOutlook")
  @js.native
