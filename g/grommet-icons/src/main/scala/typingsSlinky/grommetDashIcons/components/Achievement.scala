...
object Achievement
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.Achievement] {
  @JSImport("grommet-icons/icons", "Achievement")
  @js.native
