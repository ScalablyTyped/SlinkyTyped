...
object DocumentWord
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.DocumentWord] {
  @JSImport("grommet-icons/icons", "DocumentWord")
  @js.native
