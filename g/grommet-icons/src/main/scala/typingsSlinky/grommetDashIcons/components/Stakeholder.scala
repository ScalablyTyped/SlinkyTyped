...
object Stakeholder
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.Stakeholder] {
  @JSImport("grommet-icons/icons", "Stakeholder")
  @js.native
