...
object CloudUpload
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.grommetDashIcons.iconsMod.CloudUpload] {
  @JSImport("grommet-icons/icons", "CloudUpload")
  @js.native
