...
object CaretUpFill {
  ...
  @JSImport("grommet-icons/es6", "CaretUpFill")
  @js.native
  ...
  implicit def make(companion: CaretUpFill.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
