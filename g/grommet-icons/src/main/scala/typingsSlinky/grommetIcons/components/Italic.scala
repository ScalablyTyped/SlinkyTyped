...
object Italic {
  ...
  @JSImport("grommet-icons/es6", "Italic")
  @js.native
  ...
  implicit def make(companion: Italic.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
