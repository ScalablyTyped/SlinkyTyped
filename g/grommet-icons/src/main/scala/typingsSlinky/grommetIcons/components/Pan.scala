...
object Pan {
  @JSImport("grommet-icons/es6", "Pan")
  @js.native
  ...
  implicit def make(companion: Pan.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
