...
object Car {
  ...
  @JSImport("grommet-icons/es6", "Car")
  @js.native
  ...
  implicit def make(companion: Car.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
