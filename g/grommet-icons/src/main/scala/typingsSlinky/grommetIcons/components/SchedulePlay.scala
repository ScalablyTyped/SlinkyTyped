...
object SchedulePlay {
  ...
  @JSImport("grommet-icons/es6", "SchedulePlay")
  @js.native
  ...
  implicit def make(companion: SchedulePlay.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
