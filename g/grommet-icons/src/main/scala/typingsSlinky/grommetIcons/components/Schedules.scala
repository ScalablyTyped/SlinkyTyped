...
object Schedules {
  ...
  @JSImport("grommet-icons/es6", "Schedules")
  @js.native
  ...
  implicit def make(companion: Schedules.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
