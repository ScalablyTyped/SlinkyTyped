...
object Instagram {
  @JSImport("grommet-icons/es6", "Instagram")
  @js.native
  ...
  implicit def make(companion: Instagram.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
