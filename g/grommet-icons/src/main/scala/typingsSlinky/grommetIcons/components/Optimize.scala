...
object Optimize {
  ...
  @JSImport("grommet-icons/es6", "Optimize")
  @js.native
  ...
  implicit def make(companion: Optimize.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
