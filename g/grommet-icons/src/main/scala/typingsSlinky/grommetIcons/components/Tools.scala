...
object Tools {
  @JSImport("grommet-icons/es6", "Tools")
  @js.native
  ...
  implicit def make(companion: Tools.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
