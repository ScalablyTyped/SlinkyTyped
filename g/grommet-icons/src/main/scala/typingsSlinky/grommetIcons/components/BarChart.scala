...
object BarChart {
  ...
  @JSImport("grommet-icons/es6", "BarChart")
  @js.native
  ...
  implicit def make(companion: BarChart.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
