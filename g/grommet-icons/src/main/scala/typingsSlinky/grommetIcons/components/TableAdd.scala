...
object TableAdd {
  @JSImport("grommet-icons/es6", "TableAdd")
  @js.native
  ...
  implicit def make(companion: TableAdd.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
