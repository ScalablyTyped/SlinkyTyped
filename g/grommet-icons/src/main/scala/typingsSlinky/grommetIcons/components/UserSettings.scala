...
object UserSettings {
  @JSImport("grommet-icons/es6", "UserSettings")
  @js.native
  ...
  implicit def make(companion: UserSettings.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
