...
object Workshop {
  ...
  @JSImport("grommet-icons/es6", "Workshop")
  @js.native
  ...
  implicit def make(companion: Workshop.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
