...
object Network {
  ...
  @JSImport("grommet-icons/es6", "Network")
  @js.native
  ...
  implicit def make(companion: Network.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
