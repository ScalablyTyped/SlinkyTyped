...
object Scorecard {
  @JSImport("grommet-icons/es6", "Scorecard")
  @js.native
  ...
  implicit def make(companion: Scorecard.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
