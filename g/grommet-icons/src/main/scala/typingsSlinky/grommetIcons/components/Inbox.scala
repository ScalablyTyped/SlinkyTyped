...
object Inbox {
  @JSImport("grommet-icons/es6", "Inbox")
  @js.native
  ...
  implicit def make(companion: Inbox.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
