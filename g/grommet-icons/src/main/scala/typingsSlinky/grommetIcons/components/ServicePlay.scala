...
object ServicePlay {
  @JSImport("grommet-icons/es6", "ServicePlay")
  @js.native
  ...
  implicit def make(companion: ServicePlay.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
