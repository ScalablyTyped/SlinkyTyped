...
object GoogleWallet {
  ...
  @JSImport("grommet-icons/es6", "GoogleWallet")
  @js.native
  ...
  implicit def make(companion: GoogleWallet.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
