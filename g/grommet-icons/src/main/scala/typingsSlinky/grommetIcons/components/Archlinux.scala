...
object Archlinux {
  @JSImport("grommet-icons/es6", "Archlinux")
  @js.native
  ...
  implicit def make(companion: Archlinux.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
