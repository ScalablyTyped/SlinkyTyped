...
object Bitcoin {
  ...
  @JSImport("grommet-icons/es6", "Bitcoin")
  @js.native
  ...
  implicit def make(companion: Bitcoin.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
