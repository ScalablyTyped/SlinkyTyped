...
object CheckboxSelected {
  @JSImport("grommet-icons/es6", "CheckboxSelected")
  @js.native
  ...
  implicit def make(companion: CheckboxSelected.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
