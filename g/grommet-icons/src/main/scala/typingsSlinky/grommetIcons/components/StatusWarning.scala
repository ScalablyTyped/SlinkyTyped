...
object StatusWarning {
  @JSImport("grommet-icons/es6", "StatusWarning")
  @js.native
  ...
  implicit def make(companion: StatusWarning.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
