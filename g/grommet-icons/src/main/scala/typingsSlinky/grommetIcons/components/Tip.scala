...
object Tip {
  @JSImport("grommet-icons/es6", "Tip")
  @js.native
  ...
  implicit def make(companion: Tip.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
