...
object Ascending {
  ...
  @JSImport("grommet-icons", "Ascending")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Ascending.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
