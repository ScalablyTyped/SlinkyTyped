...
object Folder {
  @JSImport("grommet-icons/es6", "Folder")
  @js.native
  ...
  implicit def make(companion: Folder.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
