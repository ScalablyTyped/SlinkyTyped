...
object Cafeteria {
  @JSImport("grommet-icons/es6", "Cafeteria")
  @js.native
  ...
  implicit def make(companion: Cafeteria.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
