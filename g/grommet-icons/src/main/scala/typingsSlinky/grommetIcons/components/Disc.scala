...
object Disc {
  ...
  @JSImport("grommet-icons/es6", "Disc")
  @js.native
  ...
  implicit def make(companion: Disc.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
