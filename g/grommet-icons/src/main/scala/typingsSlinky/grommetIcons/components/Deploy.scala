...
object Deploy {
  ...
  @JSImport("grommet-icons/es6", "Deploy")
  @js.native
  ...
  implicit def make(companion: Deploy.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
