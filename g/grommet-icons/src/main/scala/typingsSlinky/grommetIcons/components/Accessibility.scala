...
object Accessibility {
  ...
  @JSImport("grommet-icons/es6", "Accessibility")
  @js.native
  ...
  implicit def make(companion: Accessibility.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
