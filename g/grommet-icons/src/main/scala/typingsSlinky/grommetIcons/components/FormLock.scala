...
object FormLock {
  @JSImport("grommet-icons/es6", "FormLock")
  @js.native
  ...
  implicit def make(companion: FormLock.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
