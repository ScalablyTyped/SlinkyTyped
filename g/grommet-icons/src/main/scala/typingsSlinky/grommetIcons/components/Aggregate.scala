...
object Aggregate {
  @JSImport("grommet-icons/es6", "Aggregate")
  @js.native
  ...
  implicit def make(companion: Aggregate.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
