...
object Cli {
  @JSImport("grommet-icons/es6", "Cli")
  @js.native
  ...
  implicit def make(companion: Cli.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
