...
object Return {
  ...
  @JSImport("grommet-icons/es6", "Return")
  @js.native
  ...
  implicit def make(companion: Return.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
