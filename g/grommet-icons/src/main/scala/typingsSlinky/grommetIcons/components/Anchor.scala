...
object Anchor {
  ...
  @JSImport("grommet-icons/es6", "Anchor")
  @js.native
  ...
  implicit def make(companion: Anchor.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
