...
object DocumentRtf {
  ...
  @JSImport("grommet-icons/es6", "DocumentRtf")
  @js.native
  ...
  implicit def make(companion: DocumentRtf.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
