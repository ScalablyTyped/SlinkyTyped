...
object Bold {
  ...
  @JSImport("grommet-icons/es6", "Bold")
  @js.native
  ...
  implicit def make(companion: Bold.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
