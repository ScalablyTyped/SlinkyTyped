...
object Restaurant {
  ...
  @JSImport("grommet-icons/es6", "Restaurant")
  @js.native
  ...
  implicit def make(companion: Restaurant.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
