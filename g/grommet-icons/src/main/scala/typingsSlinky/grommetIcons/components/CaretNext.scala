...
object CaretNext {
  ...
  @JSImport("grommet-icons/es6", "CaretNext")
  @js.native
  ...
  implicit def make(companion: CaretNext.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
