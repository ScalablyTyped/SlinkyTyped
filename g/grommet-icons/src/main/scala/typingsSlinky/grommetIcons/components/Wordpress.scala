...
object Wordpress {
  @JSImport("grommet-icons/es6", "Wordpress")
  @js.native
  ...
  implicit def make(companion: Wordpress.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
