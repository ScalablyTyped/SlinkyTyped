...
object FormNextLink {
  ...
  @JSImport("grommet-icons/es6", "FormNextLink")
  @js.native
  ...
  implicit def make(companion: FormNextLink.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
