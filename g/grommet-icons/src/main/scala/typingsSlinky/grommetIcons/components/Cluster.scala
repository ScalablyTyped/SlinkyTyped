...
object Cluster {
  ...
  @JSImport("grommet-icons/es6", "Cluster")
  @js.native
  ...
  implicit def make(companion: Cluster.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
