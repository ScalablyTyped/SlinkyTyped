...
object DocumentTransfer {
  ...
  @JSImport("grommet-icons/es6", "DocumentTransfer")
  @js.native
  ...
  implicit def make(companion: DocumentTransfer.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
