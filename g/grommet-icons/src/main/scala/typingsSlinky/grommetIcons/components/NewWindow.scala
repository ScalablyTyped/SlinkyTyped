...
object NewWindow {
  ...
  @JSImport("grommet-icons/es6", "NewWindow")
  @js.native
  ...
  implicit def make(companion: NewWindow.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
