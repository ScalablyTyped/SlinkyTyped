...
object Monitor {
  ...
  @JSImport("grommet-icons/es6", "Monitor")
  @js.native
  ...
  implicit def make(companion: Monitor.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
