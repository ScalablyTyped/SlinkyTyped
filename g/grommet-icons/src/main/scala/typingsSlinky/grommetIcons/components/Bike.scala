...
object Bike {
  @JSImport("grommet-icons/es6", "Bike")
  @js.native
  ...
  implicit def make(companion: Bike.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
