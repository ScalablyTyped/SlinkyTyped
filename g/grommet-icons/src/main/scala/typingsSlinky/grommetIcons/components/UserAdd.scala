...
object UserAdd {
  @JSImport("grommet-icons/es6", "UserAdd")
  @js.native
  ...
  implicit def make(companion: UserAdd.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
