...
object Gateway {
  ...
  @JSImport("grommet-icons/es6", "Gateway")
  @js.native
  ...
  implicit def make(companion: Gateway.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
