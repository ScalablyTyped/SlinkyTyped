...
object Node {
  ...
  @JSImport("grommet-icons/es6", "Node")
  @js.native
  ...
  implicit def make(companion: Node.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
