...
object TextAlignRight {
  ...
  @JSImport("grommet-icons/es6", "TextAlignRight")
  @js.native
  ...
  implicit def make(companion: TextAlignRight.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
