...
object ChapterPrevious {
  ...
  @JSImport("grommet-icons/es6", "ChapterPrevious")
  @js.native
  ...
  implicit def make(companion: ChapterPrevious.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
