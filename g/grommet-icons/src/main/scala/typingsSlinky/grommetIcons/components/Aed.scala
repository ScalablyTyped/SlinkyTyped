...
object Aed {
  @JSImport("grommet-icons/es6", "Aed")
  @js.native
  ...
  implicit def make(companion: Aed.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
