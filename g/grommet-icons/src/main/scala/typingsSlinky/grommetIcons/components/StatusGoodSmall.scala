...
object StatusGoodSmall {
  @JSImport("grommet-icons/es6", "StatusGoodSmall")
  @js.native
  ...
  implicit def make(companion: StatusGoodSmall.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
