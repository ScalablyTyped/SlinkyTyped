...
object Magic {
  ...
  @JSImport("grommet-icons/es6", "Magic")
  @js.native
  ...
  implicit def make(companion: Magic.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
