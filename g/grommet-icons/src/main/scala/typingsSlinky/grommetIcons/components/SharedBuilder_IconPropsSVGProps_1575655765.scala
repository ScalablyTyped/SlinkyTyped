...
@scala.inline
class SharedBuilder_IconPropsSVGProps_1575655765[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
     with StBuildingComponent[tag.type, R] {
  @scala.inline
  def a11yTitle(value: String): this.type = set("a11yTitle", value.asInstanceOf[js.Any])
  @scala.inline
