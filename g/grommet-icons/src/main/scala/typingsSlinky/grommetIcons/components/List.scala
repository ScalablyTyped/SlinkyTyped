...
object List {
  @JSImport("grommet-icons/es6", "List")
  @js.native
  ...
  implicit def make(companion: List.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
