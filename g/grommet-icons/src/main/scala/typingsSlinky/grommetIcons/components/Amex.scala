...
object Amex {
  ...
  @JSImport("grommet-icons/es6", "Amex")
  @js.native
  ...
  implicit def make(companion: Amex.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
