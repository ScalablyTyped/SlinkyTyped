...
object Compare {
  ...
  @JSImport("grommet-icons/es6", "Compare")
  @js.native
  ...
  implicit def make(companion: Compare.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
