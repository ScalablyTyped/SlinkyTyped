...
object Ascend {
  ...
  @JSImport("grommet-icons/es6", "Ascend")
  @js.native
  ...
  implicit def make(companion: Ascend.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
