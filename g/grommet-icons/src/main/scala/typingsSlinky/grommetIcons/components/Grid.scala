...
object Grid {
  ...
  @JSImport("grommet-icons/es6", "Grid")
  @js.native
  ...
  implicit def make(companion: Grid.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
