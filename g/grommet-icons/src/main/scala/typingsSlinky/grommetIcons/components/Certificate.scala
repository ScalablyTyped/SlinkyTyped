...
object Certificate {
  ...
  @JSImport("grommet-icons/es6", "Certificate")
  @js.native
  ...
  implicit def make(companion: Certificate.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
