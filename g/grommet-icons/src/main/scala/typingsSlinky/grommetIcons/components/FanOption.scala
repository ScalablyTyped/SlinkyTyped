...
object FanOption {
  ...
  @JSImport("grommet-icons/es6", "FanOption")
  @js.native
  ...
  implicit def make(companion: FanOption.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
