...
object StrikeThrough {
  ...
  @JSImport("grommet-icons/es6", "StrikeThrough")
  @js.native
  ...
  implicit def make(companion: StrikeThrough.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
