...
object GraphQl {
  @JSImport("grommet-icons/es6", "GraphQl")
  @js.native
  ...
  implicit def make(companion: GraphQl.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
