...
object Split {
  @JSImport("grommet-icons/es6", "Split")
  @js.native
  ...
  implicit def make(companion: Split.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
