...
object Help {
  @JSImport("grommet-icons/es6", "Help")
  @js.native
  ...
  implicit def make(companion: Help.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
