...
object Volume {
  @JSImport("grommet-icons/es6", "Volume")
  @js.native
  ...
  implicit def make(companion: Volume.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
