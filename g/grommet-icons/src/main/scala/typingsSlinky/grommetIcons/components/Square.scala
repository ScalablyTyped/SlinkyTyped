...
object Square {
  @JSImport("grommet-icons/es6", "Square")
  @js.native
  ...
  implicit def make(companion: Square.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
