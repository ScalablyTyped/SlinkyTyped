...
object Bundle {
  @JSImport("grommet-icons/es6", "Bundle")
  @js.native
  ...
  implicit def make(companion: Bundle.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
