...
object PersonalComputer {
  ...
  @JSImport("grommet-icons/es6", "PersonalComputer")
  @js.native
  ...
  implicit def make(companion: PersonalComputer.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
