...
object Deliver {
  @JSImport("grommet-icons/es6", "Deliver")
  @js.native
  ...
  implicit def make(companion: Deliver.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
