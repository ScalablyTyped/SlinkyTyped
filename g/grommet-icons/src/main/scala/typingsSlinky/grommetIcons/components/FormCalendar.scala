...
object FormCalendar {
  @JSImport("grommet-icons/es6", "FormCalendar")
  @js.native
  ...
  implicit def make(companion: FormCalendar.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
