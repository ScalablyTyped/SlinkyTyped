...
object Plug {
  ...
  @JSImport("grommet-icons/es6", "Plug")
  @js.native
  ...
  implicit def make(companion: Plug.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
