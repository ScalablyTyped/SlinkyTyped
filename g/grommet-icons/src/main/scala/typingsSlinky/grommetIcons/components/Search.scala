...
object Search {
  @JSImport("grommet-icons/es6", "Search")
  @js.native
  ...
  implicit def make(companion: Search.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
