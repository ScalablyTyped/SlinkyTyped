...
object Money {
  @JSImport("grommet-icons/es6", "Money")
  @js.native
  ...
  implicit def make(companion: Money.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
