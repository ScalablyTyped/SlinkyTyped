...
object Cubes {
  @JSImport("grommet-icons/es6", "Cubes")
  @js.native
  ...
  implicit def make(companion: Cubes.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
