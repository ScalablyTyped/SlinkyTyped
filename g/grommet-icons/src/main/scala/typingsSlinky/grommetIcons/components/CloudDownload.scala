...
object CloudDownload {
  @JSImport("grommet-icons/es6", "CloudDownload")
  @js.native
  ...
  implicit def make(companion: CloudDownload.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
