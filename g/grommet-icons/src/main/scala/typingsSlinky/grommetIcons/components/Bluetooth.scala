...
object Bluetooth {
  @JSImport("grommet-icons/es6", "Bluetooth")
  @js.native
  ...
  implicit def make(companion: Bluetooth.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
