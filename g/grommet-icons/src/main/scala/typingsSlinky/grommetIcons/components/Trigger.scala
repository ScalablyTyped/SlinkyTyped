...
object Trigger {
  @JSImport("grommet-icons/es6", "Trigger")
  @js.native
  ...
  implicit def make(companion: Trigger.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
