...
object Tasks {
  ...
  @JSImport("grommet-icons/es6", "Tasks")
  @js.native
  ...
  implicit def make(companion: Tasks.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
