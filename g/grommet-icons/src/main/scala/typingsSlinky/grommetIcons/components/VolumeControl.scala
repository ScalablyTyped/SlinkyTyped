...
object VolumeControl {
  ...
  @JSImport("grommet-icons/es6", "VolumeControl")
  @js.native
  ...
  implicit def make(companion: VolumeControl.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
