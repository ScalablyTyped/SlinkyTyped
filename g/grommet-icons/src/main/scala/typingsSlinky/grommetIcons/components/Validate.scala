...
object Validate {
  ...
  @JSImport("grommet-icons/es6", "Validate")
  @js.native
  ...
  implicit def make(companion: Validate.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
