...
object Ticket {
  @JSImport("grommet-icons/es6", "Ticket")
  @js.native
  ...
  implicit def make(companion: Ticket.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
