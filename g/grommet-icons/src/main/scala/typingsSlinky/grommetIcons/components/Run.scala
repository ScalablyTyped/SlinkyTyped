...
object Run {
  @JSImport("grommet-icons/es6", "Run")
  @js.native
  ...
  implicit def make(companion: Run.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
