...
object FormSubtract {
  ...
  @JSImport("grommet-icons/es6", "FormSubtract")
  @js.native
  ...
  implicit def make(companion: FormSubtract.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
