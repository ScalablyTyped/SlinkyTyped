...
object DocumentImage {
  ...
  @JSImport("grommet-icons/es6", "DocumentImage")
  @js.native
  ...
  implicit def make(companion: DocumentImage.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
