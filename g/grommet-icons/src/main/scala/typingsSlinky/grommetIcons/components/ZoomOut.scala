...
object ZoomOut {
  @JSImport("grommet-icons/es6", "ZoomOut")
  @js.native
  ...
  implicit def make(companion: ZoomOut.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
