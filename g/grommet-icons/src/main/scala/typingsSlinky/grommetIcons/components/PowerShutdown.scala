...
object PowerShutdown {
  @JSImport("grommet-icons/es6", "PowerShutdown")
  @js.native
  ...
  implicit def make(companion: PowerShutdown.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
