...
object Mouse {
  ...
  @JSImport("grommet-icons/es6", "Mouse")
  @js.native
  ...
  implicit def make(companion: Mouse.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
