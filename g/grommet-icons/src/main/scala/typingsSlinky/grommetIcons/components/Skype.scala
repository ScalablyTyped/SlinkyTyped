...
object Skype {
  ...
  @JSImport("grommet-icons/es6", "Skype")
  @js.native
  ...
  implicit def make(companion: Skype.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
