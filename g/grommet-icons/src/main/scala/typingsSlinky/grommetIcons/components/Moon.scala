...
object Moon {
  ...
  @JSImport("grommet-icons/es6", "Moon")
  @js.native
  ...
  implicit def make(companion: Moon.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
