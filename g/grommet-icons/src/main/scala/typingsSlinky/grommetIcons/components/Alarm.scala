...
object Alarm {
  @JSImport("grommet-icons/es6", "Alarm")
  @js.native
  ...
  implicit def make(companion: Alarm.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
