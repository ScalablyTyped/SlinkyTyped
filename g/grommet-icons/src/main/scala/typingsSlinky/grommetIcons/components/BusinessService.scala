...
object BusinessService {
  @JSImport("grommet-icons/es6", "BusinessService")
  @js.native
  ...
  implicit def make(companion: BusinessService.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
