...
object Paypal {
  @JSImport("grommet-icons/es6", "Paypal")
  @js.native
  ...
  implicit def make(companion: Paypal.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
