...
object Print {
  ...
  @JSImport("grommet-icons/es6", "Print")
  @js.native
  ...
  implicit def make(companion: Print.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
