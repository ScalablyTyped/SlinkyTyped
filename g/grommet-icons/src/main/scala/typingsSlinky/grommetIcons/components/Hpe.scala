...
object Hpe {
  @JSImport("grommet-icons/es6", "Hpe")
  @js.native
  ...
  implicit def make(companion: Hpe.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
