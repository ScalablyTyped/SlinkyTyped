...
object Monospace {
  @JSImport("grommet-icons/es6", "Monospace")
  @js.native
  ...
  implicit def make(companion: Monospace.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
