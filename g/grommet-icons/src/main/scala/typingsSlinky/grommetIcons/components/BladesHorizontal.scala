...
object BladesHorizontal {
  ...
  @JSImport("grommet-icons", "BladesHorizontal")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: BladesHorizontal.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
