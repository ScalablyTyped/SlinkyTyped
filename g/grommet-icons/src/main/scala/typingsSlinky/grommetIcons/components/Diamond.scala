...
object Diamond {
  @JSImport("grommet-icons/es6", "Diamond")
  @js.native
  ...
  implicit def make(companion: Diamond.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
