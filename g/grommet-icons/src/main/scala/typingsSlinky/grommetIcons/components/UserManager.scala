...
object UserManager {
  ...
  @JSImport("grommet-icons/es6", "UserManager")
  @js.native
  ...
  implicit def make(companion: UserManager.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
