...
object ScheduleNew {
  @JSImport("grommet-icons/es6", "ScheduleNew")
  @js.native
  ...
  implicit def make(companion: ScheduleNew.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
