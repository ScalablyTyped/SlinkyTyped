...
object Webcam {
  ...
  @JSImport("grommet-icons", "Webcam")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Webcam.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
