...
object CloudComputer {
  @JSImport("grommet-icons/es6", "CloudComputer")
  @js.native
  ...
  implicit def make(companion: CloudComputer.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
