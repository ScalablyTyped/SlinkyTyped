...
object Connect {
  ...
  @JSImport("grommet-icons/es6", "Connect")
  @js.native
  ...
  implicit def make(companion: Connect.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
