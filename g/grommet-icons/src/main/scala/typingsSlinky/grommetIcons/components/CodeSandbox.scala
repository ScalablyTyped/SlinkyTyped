...
object CodeSandbox {
  ...
  @JSImport("grommet-icons/es6", "CodeSandbox")
  @js.native
  ...
  implicit def make(companion: CodeSandbox.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
