...
object DocumentNotes {
  @JSImport("grommet-icons/es6", "DocumentNotes")
  @js.native
  ...
  implicit def make(companion: DocumentNotes.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
