...
object Docker {
  @JSImport("grommet-icons/es6", "Docker")
  @js.native
  ...
  implicit def make(companion: Docker.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
