...
object AidOption {
  ...
  @JSImport("grommet-icons/es6", "AidOption")
  @js.native
  ...
  implicit def make(companion: AidOption.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
