...
object Upload {
  ...
  @JSImport("grommet-icons/es6", "Upload")
  @js.native
  ...
  implicit def make(companion: Upload.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
