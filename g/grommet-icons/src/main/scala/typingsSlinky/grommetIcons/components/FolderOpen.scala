...
object FolderOpen {
  @JSImport("grommet-icons/es6", "FolderOpen")
  @js.native
  ...
  implicit def make(companion: FolderOpen.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
