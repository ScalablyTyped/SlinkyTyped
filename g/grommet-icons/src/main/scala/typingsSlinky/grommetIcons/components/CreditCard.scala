...
object CreditCard {
  ...
  @JSImport("grommet-icons/es6", "CreditCard")
  @js.native
  ...
  implicit def make(companion: CreditCard.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
