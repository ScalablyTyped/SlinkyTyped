...
object Note {
  ...
  @JSImport("grommet-icons/es6", "Note")
  @js.native
  ...
  implicit def make(companion: Note.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
