...
object StepsOption {
  @JSImport("grommet-icons/es6", "StepsOption")
  @js.native
  ...
  implicit def make(companion: StepsOption.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
