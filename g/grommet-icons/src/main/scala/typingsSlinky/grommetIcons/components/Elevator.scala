...
object Elevator {
  @JSImport("grommet-icons/es6", "Elevator")
  @js.native
  ...
  implicit def make(companion: Elevator.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
