...
object Integration {
  ...
  @JSImport("grommet-icons/es6", "Integration")
  @js.native
  ...
  implicit def make(companion: Integration.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
