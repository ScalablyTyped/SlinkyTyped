...
object HomeOption {
  ...
  @JSImport("grommet-icons", "HomeOption")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: HomeOption.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
