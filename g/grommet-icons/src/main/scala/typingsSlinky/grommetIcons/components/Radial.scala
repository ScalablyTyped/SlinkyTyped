...
object Radial {
  ...
  @JSImport("grommet-icons/es6", "Radial")
  @js.native
  ...
  implicit def make(companion: Radial.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
