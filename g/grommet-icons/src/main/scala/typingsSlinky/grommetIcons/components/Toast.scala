...
object Toast {
  ...
  @JSImport("grommet-icons/es6", "Toast")
  @js.native
  ...
  implicit def make(companion: Toast.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
