...
object Gift {
  ...
  @JSImport("grommet-icons/es6", "Gift")
  @js.native
  ...
  implicit def make(companion: Gift.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
