...
object Expand {
  ...
  @JSImport("grommet-icons/es6", "Expand")
  @js.native
  ...
  implicit def make(companion: Expand.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
