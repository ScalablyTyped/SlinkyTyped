...
object Bus {
  @JSImport("grommet-icons/es6", "Bus")
  @js.native
  ...
  implicit def make(companion: Bus.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
