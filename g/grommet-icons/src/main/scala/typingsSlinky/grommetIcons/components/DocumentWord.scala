...
object DocumentWord {
  @JSImport("grommet-icons/es6", "DocumentWord")
  @js.native
  ...
  implicit def make(companion: DocumentWord.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
