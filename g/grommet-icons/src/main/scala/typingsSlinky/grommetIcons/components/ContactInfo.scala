...
object ContactInfo {
  @JSImport("grommet-icons/es6", "ContactInfo")
  @js.native
  ...
  implicit def make(companion: ContactInfo.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
