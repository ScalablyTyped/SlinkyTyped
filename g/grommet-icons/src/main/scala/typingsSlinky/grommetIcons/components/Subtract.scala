...
object Subtract {
  ...
  @JSImport("grommet-icons/es6", "Subtract")
  @js.native
  ...
  implicit def make(companion: Subtract.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
