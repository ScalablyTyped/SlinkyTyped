...
object Task {
  ...
  @JSImport("grommet-icons/es6", "Task")
  @js.native
  ...
  implicit def make(companion: Task.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
