...
object Fireball {
  @JSImport("grommet-icons/es6", "Fireball")
  @js.native
  ...
  implicit def make(companion: Fireball.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
