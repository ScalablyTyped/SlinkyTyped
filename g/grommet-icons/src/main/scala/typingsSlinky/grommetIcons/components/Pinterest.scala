...
object Pinterest {
  ...
  @JSImport("grommet-icons/es6", "Pinterest")
  @js.native
  ...
  implicit def make(companion: Pinterest.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
