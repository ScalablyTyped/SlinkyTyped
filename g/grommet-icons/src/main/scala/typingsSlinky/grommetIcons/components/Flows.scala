...
object Flows {
  ...
  @JSImport("grommet-icons/es6", "Flows")
  @js.native
  ...
  implicit def make(companion: Flows.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
