...
object Medium {
  ...
  @JSImport("grommet-icons/es6", "Medium")
  @js.native
  ...
  implicit def make(companion: Medium.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
