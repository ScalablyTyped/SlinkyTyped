...
object Storage {
  ...
  @JSImport("grommet-icons/es6", "Storage")
  @js.native
  ...
  implicit def make(companion: Storage.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
