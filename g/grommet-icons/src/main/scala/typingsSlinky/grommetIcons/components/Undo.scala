...
object Undo {
  @JSImport("grommet-icons/es6", "Undo")
  @js.native
  ...
  implicit def make(companion: Undo.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
