...
object Descend {
  ...
  @JSImport("grommet-icons/es6", "Descend")
  @js.native
  ...
  implicit def make(companion: Descend.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
