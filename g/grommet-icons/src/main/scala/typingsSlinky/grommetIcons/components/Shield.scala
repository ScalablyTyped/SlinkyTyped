...
object Shield {
  ...
  @JSImport("grommet-icons/es6", "Shield")
  @js.native
  ...
  implicit def make(companion: Shield.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
