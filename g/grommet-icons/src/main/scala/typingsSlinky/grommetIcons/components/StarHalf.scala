...
object StarHalf {
  ...
  @JSImport("grommet-icons/es6", "StarHalf")
  @js.native
  ...
  implicit def make(companion: StarHalf.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
