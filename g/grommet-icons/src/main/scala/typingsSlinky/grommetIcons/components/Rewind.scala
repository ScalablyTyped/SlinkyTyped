...
object Rewind {
  @JSImport("grommet-icons/es6", "Rewind")
  @js.native
  ...
  implicit def make(companion: Rewind.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
