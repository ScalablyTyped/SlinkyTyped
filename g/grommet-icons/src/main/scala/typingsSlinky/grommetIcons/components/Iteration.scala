...
object Iteration {
  @JSImport("grommet-icons/es6", "Iteration")
  @js.native
  ...
  implicit def make(companion: Iteration.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
