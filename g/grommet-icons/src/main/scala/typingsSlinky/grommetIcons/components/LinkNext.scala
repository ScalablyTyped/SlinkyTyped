...
object LinkNext {
  ...
  @JSImport("grommet-icons/es6", "LinkNext")
  @js.native
  ...
  implicit def make(companion: LinkNext.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
