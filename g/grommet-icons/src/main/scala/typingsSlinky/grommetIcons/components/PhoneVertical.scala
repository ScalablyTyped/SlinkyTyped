...
object PhoneVertical {
  
  @JSImport("grommet-icons/es6", "PhoneVertical")
  @js.native
  ...
  implicit def make(companion: PhoneVertical.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
