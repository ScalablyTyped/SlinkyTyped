...
object Announce {
  @JSImport("grommet-icons/es6", "Announce")
  @js.native
  ...
  implicit def make(companion: Announce.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
