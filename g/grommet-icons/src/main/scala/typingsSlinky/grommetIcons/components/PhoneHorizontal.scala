...
object PhoneHorizontal {
  
  @JSImport("grommet-icons/es6", "PhoneHorizontal")
  @js.native
  ...
  implicit def make(companion: PhoneHorizontal.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
