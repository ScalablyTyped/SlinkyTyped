...
object WheelchairActive {
  ...
  @JSImport("grommet-icons/es6", "WheelchairActive")
  @js.native
  ...
  implicit def make(companion: WheelchairActive.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
