...
object DocumentCloud {
  @JSImport("grommet-icons/es6", "DocumentCloud")
  @js.native
  ...
  implicit def make(companion: DocumentCloud.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
