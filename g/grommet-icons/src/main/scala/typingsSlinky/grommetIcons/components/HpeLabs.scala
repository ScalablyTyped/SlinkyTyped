...
object HpeLabs {
  @JSImport("grommet-icons/es6", "HpeLabs")
  @js.native
  ...
  implicit def make(companion: HpeLabs.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
