...
object Action {
  @JSImport("grommet-icons/es6", "Action")
  @js.native
  ...
  implicit def make(companion: Action.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
