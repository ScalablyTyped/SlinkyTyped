...
object Test {
  ...
  @JSImport("grommet-icons/es6", "Test")
  @js.native
  ...
  implicit def make(companion: Test.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
