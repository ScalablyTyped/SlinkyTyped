...
object Blog {
  ...
  @JSImport("grommet-icons/es6", "Blog")
  @js.native
  ...
  implicit def make(companion: Blog.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
