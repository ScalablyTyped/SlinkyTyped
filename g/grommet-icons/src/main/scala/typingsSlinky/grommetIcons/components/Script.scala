...
object Script {
  ...
  @JSImport("grommet-icons/es6", "Script")
  @js.native
  ...
  implicit def make(companion: Script.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
