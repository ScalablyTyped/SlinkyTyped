...
object Descending {
  ...
  @JSImport("grommet-icons/es6", "Descending")
  @js.native
  ...
  implicit def make(companion: Descending.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
