...
object Dropbox {
  ...
  @JSImport("grommet-icons/es6", "Dropbox")
  @js.native
  ...
  implicit def make(companion: Dropbox.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
