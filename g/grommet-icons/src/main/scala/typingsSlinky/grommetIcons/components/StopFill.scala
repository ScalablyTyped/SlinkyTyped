...
object StopFill {
  ...
  @JSImport("grommet-icons/es6", "StopFill")
  @js.native
  ...
  implicit def make(companion: StopFill.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
