...
object DocumentZip {
  ...
  @JSImport("grommet-icons/es6", "DocumentZip")
  @js.native
  ...
  implicit def make(companion: DocumentZip.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
