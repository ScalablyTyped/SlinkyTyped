...
object Layer {
  ...
  @JSImport("grommet-icons/es6", "Layer")
  @js.native
  ...
  implicit def make(companion: Layer.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
