...
object Resources {
  ...
  @JSImport("grommet-icons/es6", "Resources")
  @js.native
  ...
  implicit def make(companion: Resources.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
