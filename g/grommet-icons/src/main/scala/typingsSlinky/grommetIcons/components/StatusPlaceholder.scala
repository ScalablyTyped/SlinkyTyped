...
object StatusPlaceholder {
  @JSImport("grommet-icons/es6", "StatusPlaceholder")
  @js.native
  ...
  implicit def make(companion: StatusPlaceholder.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
