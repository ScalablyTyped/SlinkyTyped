...
object VolumeMute {
  @JSImport("grommet-icons/es6", "VolumeMute")
  @js.native
  ...
  implicit def make(companion: VolumeMute.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
