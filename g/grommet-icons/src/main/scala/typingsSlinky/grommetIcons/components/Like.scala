...
object Like {
  @JSImport("grommet-icons/es6", "Like")
  @js.native
  ...
  implicit def make(companion: Like.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
