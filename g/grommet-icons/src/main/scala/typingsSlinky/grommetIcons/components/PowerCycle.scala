...
object PowerCycle {
  @JSImport("grommet-icons/es6", "PowerCycle")
  @js.native
  ...
  implicit def make(companion: PowerCycle.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
