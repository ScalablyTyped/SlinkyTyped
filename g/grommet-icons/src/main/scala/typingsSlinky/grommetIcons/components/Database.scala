...
object Database {
  @JSImport("grommet-icons/es6", "Database")
  @js.native
  ...
  implicit def make(companion: Database.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
