...
object Linkedin {
  @JSImport("grommet-icons/es6", "Linkedin")
  @js.native
  ...
  implicit def make(companion: Linkedin.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
