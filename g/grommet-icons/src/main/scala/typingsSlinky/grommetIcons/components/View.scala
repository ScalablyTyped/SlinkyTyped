...
object View {
  ...
  @JSImport("grommet-icons/es6", "View")
  @js.native
  ...
  implicit def make(companion: View.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
