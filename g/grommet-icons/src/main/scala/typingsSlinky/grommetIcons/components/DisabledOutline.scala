...
object DisabledOutline {
  
  @JSImport("grommet-icons/es6", "DisabledOutline")
  @js.native
  ...
  implicit def make(companion: DisabledOutline.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
