...
object ForwardTen {
  @JSImport("grommet-icons/es6", "ForwardTen")
  @js.native
  ...
  implicit def make(companion: ForwardTen.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
