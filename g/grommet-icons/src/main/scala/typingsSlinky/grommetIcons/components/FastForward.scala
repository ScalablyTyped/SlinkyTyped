...
object FastForward {
  @JSImport("grommet-icons/es6", "FastForward")
  @js.native
  ...
  implicit def make(companion: FastForward.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
