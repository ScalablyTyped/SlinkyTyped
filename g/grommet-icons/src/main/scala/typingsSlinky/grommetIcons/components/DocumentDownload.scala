...
object DocumentDownload {
  ...
  @JSImport("grommet-icons/es6", "DocumentDownload")
  @js.native
  ...
  implicit def make(companion: DocumentDownload.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
