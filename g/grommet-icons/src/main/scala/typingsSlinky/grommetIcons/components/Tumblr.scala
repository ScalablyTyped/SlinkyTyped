...
object Tumblr {
  @JSImport("grommet-icons/es6", "Tumblr")
  @js.native
  ...
  implicit def make(companion: Tumblr.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
