...
object Server {
  ...
  @JSImport("grommet-icons/es6", "Server")
  @js.native
  ...
  implicit def make(companion: Server.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
