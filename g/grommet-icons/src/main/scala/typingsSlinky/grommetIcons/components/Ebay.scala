...
object Ebay {
  ...
  @JSImport("grommet-icons/es6", "Ebay")
  @js.native
  ...
  implicit def make(companion: Ebay.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
