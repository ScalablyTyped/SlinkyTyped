...
object TopCorner {
  @JSImport("grommet-icons/es6", "TopCorner")
  @js.native
  ...
  implicit def make(companion: TopCorner.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
