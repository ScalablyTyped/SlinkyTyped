...
object Waypoint {
  @JSImport("grommet-icons/es6", "Waypoint")
  @js.native
  ...
  implicit def make(companion: Waypoint.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
