...
object TextAlignLeft {
  @JSImport("grommet-icons/es6", "TextAlignLeft")
  @js.native
  ...
  implicit def make(companion: TextAlignLeft.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
