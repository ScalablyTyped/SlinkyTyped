...
object Impact {
  @JSImport("grommet-icons/es6", "Impact")
  @js.native
  ...
  implicit def make(companion: Impact.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
