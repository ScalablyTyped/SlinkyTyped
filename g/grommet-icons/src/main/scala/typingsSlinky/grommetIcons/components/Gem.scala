...
object Gem {
  ...
  @JSImport("grommet-icons/es6", "Gem")
  @js.native
  ...
  implicit def make(companion: Gem.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
