...
object CoatCheck {
  ...
  @JSImport("grommet-icons/es6", "CoatCheck")
  @js.native
  ...
  implicit def make(companion: CoatCheck.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
