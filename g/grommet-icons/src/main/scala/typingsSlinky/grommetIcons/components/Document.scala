...
object Document {
  ...
  @JSImport("grommet-icons/es6", "Document")
  @js.native
  ...
  implicit def make(companion: Document.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
