...
object StatusUnknownSmall {
  ...
  @JSImport("grommet-icons/es6", "StatusUnknownSmall")
  @js.native
  ...
  implicit def make(companion: StatusUnknownSmall.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
