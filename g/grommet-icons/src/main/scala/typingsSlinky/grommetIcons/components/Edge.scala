...
object Edge {
  @JSImport("grommet-icons/es6", "Edge")
  @js.native
  ...
  implicit def make(companion: Edge.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
