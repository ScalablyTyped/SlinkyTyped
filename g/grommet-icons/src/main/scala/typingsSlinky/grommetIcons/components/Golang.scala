...
object Golang {
  @JSImport("grommet-icons/es6", "Golang")
  @js.native
  ...
  implicit def make(companion: Golang.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
