...
object Ezmeral {
  ...
  @JSImport("grommet-icons/es6", "Ezmeral")
  @js.native
  ...
  implicit def make(companion: Ezmeral.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
