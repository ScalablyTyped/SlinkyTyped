...
object DocumentWindows {
  ...
  @JSImport("grommet-icons/es6", "DocumentWindows")
  @js.native
  ...
  implicit def make(companion: DocumentWindows.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
