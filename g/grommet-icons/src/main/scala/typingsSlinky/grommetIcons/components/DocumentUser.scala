...
object DocumentUser {
  @JSImport("grommet-icons/es6", "DocumentUser")
  @js.native
  ...
  implicit def make(companion: DocumentUser.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
