...
object Inspect {
  ...
  @JSImport("grommet-icons/es6", "Inspect")
  @js.native
  ...
  implicit def make(companion: Inspect.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
