...
object Codepen {
  @JSImport("grommet-icons/es6", "Codepen")
  @js.native
  ...
  implicit def make(companion: Codepen.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
