...
object Bookmark {
  @JSImport("grommet-icons/es6", "Bookmark")
  @js.native
  ...
  implicit def make(companion: Bookmark.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
