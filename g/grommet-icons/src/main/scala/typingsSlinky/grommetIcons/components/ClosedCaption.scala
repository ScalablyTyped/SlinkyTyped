...
object ClosedCaption {
  @JSImport("grommet-icons/es6", "ClosedCaption")
  @js.native
  ...
  implicit def make(companion: ClosedCaption.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
