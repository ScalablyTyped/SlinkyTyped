...
object UnorderedList {
  @JSImport("grommet-icons/es6", "UnorderedList")
  @js.native
  ...
  implicit def make(companion: UnorderedList.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
