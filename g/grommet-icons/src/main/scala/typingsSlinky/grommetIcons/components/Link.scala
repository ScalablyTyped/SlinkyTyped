...
object Link {
  ...
  @JSImport("grommet-icons/es6", "Link")
  @js.native
  ...
  implicit def make(companion: Link.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
