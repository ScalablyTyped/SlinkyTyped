...
object Vend {
  ...
  @JSImport("grommet-icons/es6", "Vend")
  @js.native
  ...
  implicit def make(companion: Vend.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
