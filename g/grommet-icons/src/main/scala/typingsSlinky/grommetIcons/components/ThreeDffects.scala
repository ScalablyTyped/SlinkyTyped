...
object ThreeDffects {
  ...
  @JSImport("grommet-icons/es6", "ThreeDffects")
  @js.native
  ...
  implicit def make(companion: ThreeDffects.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
