...
object StatusInfoSmall {
  @JSImport("grommet-icons/es6", "StatusInfoSmall")
  @js.native
  ...
  implicit def make(companion: StatusInfoSmall.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
