...
object ObjectGroup {
  @JSImport("grommet-icons/es6", "ObjectGroup")
  @js.native
  ...
  implicit def make(companion: ObjectGroup.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
