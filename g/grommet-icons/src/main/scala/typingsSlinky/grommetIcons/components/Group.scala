...
object Group {
  @JSImport("grommet-icons/es6", "Group")
  @js.native
  ...
  implicit def make(companion: Group.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
