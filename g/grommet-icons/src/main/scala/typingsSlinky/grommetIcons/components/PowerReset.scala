...
object PowerReset {
  ...
  @JSImport("grommet-icons/es6", "PowerReset")
  @js.native
  ...
  implicit def make(companion: PowerReset.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
