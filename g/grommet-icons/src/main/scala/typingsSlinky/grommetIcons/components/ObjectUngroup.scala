...
object ObjectUngroup {
  ...
  @JSImport("grommet-icons/es6", "ObjectUngroup")
  @js.native
  ...
  implicit def make(companion: ObjectUngroup.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
