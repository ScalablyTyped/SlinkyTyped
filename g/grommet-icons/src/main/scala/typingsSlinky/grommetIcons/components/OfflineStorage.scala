...
object OfflineStorage {
  @JSImport("grommet-icons/es6", "OfflineStorage")
  @js.native
  ...
  implicit def make(companion: OfflineStorage.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
