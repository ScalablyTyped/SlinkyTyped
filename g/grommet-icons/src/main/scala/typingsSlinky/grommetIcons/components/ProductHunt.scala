...
object ProductHunt {
  @JSImport("grommet-icons/es6", "ProductHunt")
  @js.native
  ...
  implicit def make(companion: ProductHunt.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
