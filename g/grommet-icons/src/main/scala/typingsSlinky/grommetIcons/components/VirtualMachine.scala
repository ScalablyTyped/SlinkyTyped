...
object VirtualMachine {
  ...
  @JSImport("grommet-icons/es6", "VirtualMachine")
  @js.native
  ...
  implicit def make(companion: VirtualMachine.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
