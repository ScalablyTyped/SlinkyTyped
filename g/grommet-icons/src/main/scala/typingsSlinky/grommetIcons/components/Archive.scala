...
object Archive {
  @JSImport("grommet-icons/es6", "Archive")
  @js.native
  ...
  implicit def make(companion: Archive.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
