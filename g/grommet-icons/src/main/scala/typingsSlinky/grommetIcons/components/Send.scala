...
object Send {
  ...
  @JSImport("grommet-icons/es6", "Send")
  @js.native
  ...
  implicit def make(companion: Send.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
