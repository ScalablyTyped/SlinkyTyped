...
object Unlink {
  @JSImport("grommet-icons/es6", "Unlink")
  @js.native
  ...
  implicit def make(companion: Unlink.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
