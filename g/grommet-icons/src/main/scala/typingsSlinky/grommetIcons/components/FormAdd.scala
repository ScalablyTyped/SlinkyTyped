...
object FormAdd {
  @JSImport("grommet-icons/es6", "FormAdd")
  @js.native
  ...
  implicit def make(companion: FormAdd.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
