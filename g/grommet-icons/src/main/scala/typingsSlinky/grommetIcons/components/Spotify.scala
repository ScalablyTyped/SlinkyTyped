...
object Spotify {
  @JSImport("grommet-icons/es6", "Spotify")
  @js.native
  ...
  implicit def make(companion: Spotify.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
