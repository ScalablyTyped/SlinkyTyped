...
object Secure {
  @JSImport("grommet-icons/es6", "Secure")
  @js.native
  ...
  implicit def make(companion: Secure.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
