...
object Fan {
  @JSImport("grommet-icons/es6", "Fan")
  @js.native
  ...
  implicit def make(companion: Fan.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
