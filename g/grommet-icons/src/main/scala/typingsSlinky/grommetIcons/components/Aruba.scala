...
object Aruba {
  ...
  @JSImport("grommet-icons/es6", "Aruba")
  @js.native
  ...
  implicit def make(companion: Aruba.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
