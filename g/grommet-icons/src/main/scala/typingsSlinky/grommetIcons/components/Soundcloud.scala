...
object Soundcloud {
  ...
  @JSImport("grommet-icons/es6", "Soundcloud")
  @js.native
  ...
  implicit def make(companion: Soundcloud.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
