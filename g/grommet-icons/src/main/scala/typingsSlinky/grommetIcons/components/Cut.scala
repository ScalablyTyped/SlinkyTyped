...
object Cut {
  ...
  @JSImport("grommet-icons/es6", "Cut")
  @js.native
  ...
  implicit def make(companion: Cut.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
