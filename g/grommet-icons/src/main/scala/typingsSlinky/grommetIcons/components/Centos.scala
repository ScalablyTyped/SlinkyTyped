...
object Centos {
  ...
  @JSImport("grommet-icons/es6", "Centos")
  @js.native
  ...
  implicit def make(companion: Centos.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
