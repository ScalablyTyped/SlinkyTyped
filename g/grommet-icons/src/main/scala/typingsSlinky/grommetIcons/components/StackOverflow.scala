...
object StackOverflow {
  @JSImport("grommet-icons/es6", "StackOverflow")
  @js.native
  ...
  implicit def make(companion: StackOverflow.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
