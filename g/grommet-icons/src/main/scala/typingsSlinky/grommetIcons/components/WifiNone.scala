...
object WifiNone {
  ...
  @JSImport("grommet-icons/es6", "WifiNone")
  @js.native
  ...
  implicit def make(companion: WifiNone.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
