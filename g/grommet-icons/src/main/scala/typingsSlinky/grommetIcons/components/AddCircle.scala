...
object AddCircle {
  @JSImport("grommet-icons/es6", "AddCircle")
  @js.native
  ...
  implicit def make(companion: AddCircle.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
