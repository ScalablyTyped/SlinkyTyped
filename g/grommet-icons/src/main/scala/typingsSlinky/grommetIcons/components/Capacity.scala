...
object Capacity {
  ...
  @JSImport("grommet-icons/es6", "Capacity")
  @js.native
  ...
  implicit def make(companion: Capacity.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
