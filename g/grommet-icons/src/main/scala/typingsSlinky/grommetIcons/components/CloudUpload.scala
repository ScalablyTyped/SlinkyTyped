...
object CloudUpload {
  @JSImport("grommet-icons/es6", "CloudUpload")
  @js.native
  ...
  implicit def make(companion: CloudUpload.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
