...
object UserPolice {
  @JSImport("grommet-icons/es6", "UserPolice")
  @js.native
  ...
  implicit def make(companion: UserPolice.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
