...
object RestroomWomen {
  ...
  @JSImport("grommet-icons/es6", "RestroomWomen")
  @js.native
  ...
  implicit def make(companion: RestroomWomen.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
