...
object Pin {
  ...
  @JSImport("grommet-icons/es6", "Pin")
  @js.native
  ...
  implicit def make(companion: Pin.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
