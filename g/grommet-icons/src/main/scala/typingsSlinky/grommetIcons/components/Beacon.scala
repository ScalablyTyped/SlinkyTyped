...
object Beacon {
  ...
  @JSImport("grommet-icons/es6", "Beacon")
  @js.native
  ...
  implicit def make(companion: Beacon.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
