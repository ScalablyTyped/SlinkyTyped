...
object Memory {
  ...
  @JSImport("grommet-icons/es6", "Memory")
  @js.native
  ...
  implicit def make(companion: Memory.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
