...
object LineChart {
  @JSImport("grommet-icons/es6", "LineChart")
  @js.native
  ...
  implicit def make(companion: LineChart.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
