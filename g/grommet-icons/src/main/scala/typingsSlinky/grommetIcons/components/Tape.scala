...
object Tape {
  @JSImport("grommet-icons/es6", "Tape")
  @js.native
  ...
  implicit def make(companion: Tape.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
