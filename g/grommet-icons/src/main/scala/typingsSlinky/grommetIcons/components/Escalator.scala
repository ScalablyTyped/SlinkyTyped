...
object Escalator {
  ...
  @JSImport("grommet-icons/es6", "Escalator")
  @js.native
  ...
  implicit def make(companion: Escalator.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
