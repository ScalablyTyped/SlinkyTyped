...
object BottomCorner {
  ...
  @JSImport("grommet-icons/es6", "BottomCorner")
  @js.native
  ...
  implicit def make(companion: BottomCorner.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
