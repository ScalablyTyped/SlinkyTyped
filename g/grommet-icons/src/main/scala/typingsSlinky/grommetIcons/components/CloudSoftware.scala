...
object CloudSoftware {
  ...
  @JSImport("grommet-icons/es6", "CloudSoftware")
  @js.native
  ...
  implicit def make(companion: CloudSoftware.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
