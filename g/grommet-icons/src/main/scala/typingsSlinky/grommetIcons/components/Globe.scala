...
object Globe {
  ...
  @JSImport("grommet-icons/es6", "Globe")
  @js.native
  ...
  implicit def make(companion: Globe.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
