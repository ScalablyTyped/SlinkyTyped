...
object Brush {
  ...
  @JSImport("grommet-icons/es6", "Brush")
  @js.native
  ...
  implicit def make(companion: Brush.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
