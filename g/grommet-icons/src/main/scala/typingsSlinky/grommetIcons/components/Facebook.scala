...
object Facebook {
  ...
  @JSImport("grommet-icons/es6", "Facebook")
  @js.native
  ...
  implicit def make(companion: Facebook.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
