...
object Onedrive {
  @JSImport("grommet-icons/es6", "Onedrive")
  @js.native
  ...
  implicit def make(companion: Onedrive.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
