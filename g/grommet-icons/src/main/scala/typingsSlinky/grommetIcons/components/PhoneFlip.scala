...
object PhoneFlip {
  ...
  @JSImport("grommet-icons/es6", "PhoneFlip")
  @js.native
  ...
  implicit def make(companion: PhoneFlip.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
