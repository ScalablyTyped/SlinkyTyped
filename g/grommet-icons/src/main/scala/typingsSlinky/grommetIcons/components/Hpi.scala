...
object Hpi {
  ...
  @JSImport("grommet-icons/es6", "Hpi")
  @js.native
  ...
  implicit def make(companion: Hpi.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
