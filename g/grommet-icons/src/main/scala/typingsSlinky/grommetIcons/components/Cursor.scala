...
object Cursor {
  @JSImport("grommet-icons/es6", "Cursor")
  @js.native
  ...
  implicit def make(companion: Cursor.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
