...
object LinkTop {
  @JSImport("grommet-icons/es6", "LinkTop")
  @js.native
  ...
  implicit def make(companion: LinkTop.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
