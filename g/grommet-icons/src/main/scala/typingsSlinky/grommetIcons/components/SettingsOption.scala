...
object SettingsOption {
  @JSImport("grommet-icons/es6", "SettingsOption")
  @js.native
  ...
  implicit def make(companion: SettingsOption.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
