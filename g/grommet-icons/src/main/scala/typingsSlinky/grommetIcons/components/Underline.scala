...
object Underline {
  @JSImport("grommet-icons/es6", "Underline")
  @js.native
  ...
  implicit def make(companion: Underline.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
