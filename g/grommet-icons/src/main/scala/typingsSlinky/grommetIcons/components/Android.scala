...
object Android {
  ...
  @JSImport("grommet-icons/es6", "Android")
  @js.native
  ...
  implicit def make(companion: Android.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
