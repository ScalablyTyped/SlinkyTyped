...
object UploadOption {
  ...
  @JSImport("grommet-icons/es6", "UploadOption")
  @js.native
  ...
  implicit def make(companion: UploadOption.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
