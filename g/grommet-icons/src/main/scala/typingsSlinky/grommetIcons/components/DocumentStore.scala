...
object DocumentStore {
  ...
  @JSImport("grommet-icons/es6", "DocumentStore")
  @js.native
  ...
  implicit def make(companion: DocumentStore.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
