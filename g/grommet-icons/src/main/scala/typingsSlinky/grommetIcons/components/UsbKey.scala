...
object UsbKey {
  ...
  @JSImport("grommet-icons/es6", "UsbKey")
  @js.native
  ...
  implicit def make(companion: UsbKey.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
