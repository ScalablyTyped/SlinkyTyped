...
object Rss {
  ...
  @JSImport("grommet-icons/es6", "Rss")
  @js.native
  ...
  implicit def make(companion: Rss.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
