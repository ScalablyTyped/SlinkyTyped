...
object Mandriva {
  ...
  @JSImport("grommet-icons/es6", "Mandriva")
  @js.native
  ...
  implicit def make(companion: Mandriva.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
