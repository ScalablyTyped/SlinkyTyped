...
object TextAlignFull {
  ...
  @JSImport("grommet-icons/es6", "TextAlignFull")
  @js.native
  ...
  implicit def make(companion: TextAlignFull.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
