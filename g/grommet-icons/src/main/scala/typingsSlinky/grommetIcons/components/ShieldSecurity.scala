...
object ShieldSecurity {
  ...
  @JSImport("grommet-icons/es6", "ShieldSecurity")
  @js.native
  ...
  implicit def make(companion: ShieldSecurity.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
