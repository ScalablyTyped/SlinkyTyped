...
object StatusGood {
  @JSImport("grommet-icons/es6", "StatusGood")
  @js.native
  ...
  implicit def make(companion: StatusGood.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
