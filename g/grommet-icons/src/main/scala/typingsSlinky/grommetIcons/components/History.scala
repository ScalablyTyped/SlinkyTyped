...
object History {
  @JSImport("grommet-icons/es6", "History")
  @js.native
  ...
  implicit def make(companion: History.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
