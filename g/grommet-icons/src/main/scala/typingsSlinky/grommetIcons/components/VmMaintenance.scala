...
object VmMaintenance {
  @JSImport("grommet-icons/es6", "VmMaintenance")
  @js.native
  ...
  implicit def make(companion: VmMaintenance.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
