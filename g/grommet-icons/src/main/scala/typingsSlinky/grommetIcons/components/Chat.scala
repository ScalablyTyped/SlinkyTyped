...
object Chat {
  @JSImport("grommet-icons/es6", "Chat")
  @js.native
  ...
  implicit def make(companion: Chat.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
