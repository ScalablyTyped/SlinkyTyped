...
object Flag {
  ...
  @JSImport("grommet-icons/es6", "Flag")
  @js.native
  ...
  implicit def make(companion: Flag.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
