...
object Cpu {
  ...
  @JSImport("grommet-icons/es6", "Cpu")
  @js.native
  ...
  implicit def make(companion: Cpu.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
