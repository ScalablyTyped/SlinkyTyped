...
object DocumentOutlook {
  ...
  @JSImport("grommet-icons/es6", "DocumentOutlook")
  @js.native
  ...
  implicit def make(companion: DocumentOutlook.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
