...
object FormPreviousLink {
  @JSImport("grommet-icons/es6", "FormPreviousLink")
  @js.native
  ...
  implicit def make(companion: FormPreviousLink.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
