...
object Performance {
  ...
  @JSImport("grommet-icons/es6", "Performance")
  @js.native
  ...
  implicit def make(companion: Performance.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
