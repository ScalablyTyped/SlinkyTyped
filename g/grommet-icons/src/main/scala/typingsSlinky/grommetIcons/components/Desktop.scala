...
object Desktop {
  ...
  @JSImport("grommet-icons/es6", "Desktop")
  @js.native
  ...
  implicit def make(companion: Desktop.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
