...
object Reactjs {
  ...
  @JSImport("grommet-icons/es6", "Reactjs")
  @js.native
  ...
  implicit def make(companion: Reactjs.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
