...
object Transaction {
  ...
  @JSImport("grommet-icons/es6", "Transaction")
  @js.native
  ...
  implicit def make(companion: Transaction.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
