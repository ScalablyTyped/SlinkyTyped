...
object Calendar {
  @JSImport("grommet-icons/es6", "Calendar")
  @js.native
  ...
  implicit def make(companion: Calendar.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
