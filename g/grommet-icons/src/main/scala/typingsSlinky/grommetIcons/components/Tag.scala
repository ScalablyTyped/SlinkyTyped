...
object Tag {
  @JSImport("grommet-icons/es6", "Tag")
  @js.native
  ...
  implicit def make(companion: Tag.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
