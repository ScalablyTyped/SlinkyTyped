...
object MoreVertical {
  @JSImport("grommet-icons/es6", "MoreVertical")
  @js.native
  ...
  implicit def make(companion: MoreVertical.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
