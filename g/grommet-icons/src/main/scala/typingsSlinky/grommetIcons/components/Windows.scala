...
object Windows {
  @JSImport("grommet-icons/es6", "Windows")
  @js.native
  ...
  implicit def make(companion: Windows.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
