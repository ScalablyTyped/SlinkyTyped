...
object Baby {
  ...
  @JSImport("grommet-icons/es6", "Baby")
  @js.native
  ...
  implicit def make(companion: Baby.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
