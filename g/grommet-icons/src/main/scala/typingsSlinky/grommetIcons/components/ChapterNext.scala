...
object ChapterNext {
  ...
  @JSImport("grommet-icons/es6", "ChapterNext")
  @js.native
  ...
  implicit def make(companion: ChapterNext.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
