...
object Dxc {
  @JSImport("grommet-icons/es6", "Dxc")
  @js.native
  ...
  implicit def make(companion: Dxc.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
