...
object FormUpload {
  @JSImport("grommet-icons/es6", "FormUpload")
  @js.native
  ...
  implicit def make(companion: FormUpload.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
