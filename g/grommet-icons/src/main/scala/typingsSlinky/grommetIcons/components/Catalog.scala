...
object Catalog {
  ...
  @JSImport("grommet-icons/es6", "Catalog")
  @js.native
  ...
  implicit def make(companion: Catalog.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
