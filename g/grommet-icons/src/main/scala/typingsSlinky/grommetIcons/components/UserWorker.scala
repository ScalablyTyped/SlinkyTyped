...
object UserWorker {
  ...
  @JSImport("grommet-icons/es6", "UserWorker")
  @js.native
  ...
  implicit def make(companion: UserWorker.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
