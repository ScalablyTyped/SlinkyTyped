...
object Microfocus {
  @JSImport("grommet-icons/es6", "Microfocus")
  @js.native
  ...
  implicit def make(companion: Microfocus.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
