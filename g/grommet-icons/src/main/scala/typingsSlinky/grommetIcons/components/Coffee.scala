...
object Coffee {
  @JSImport("grommet-icons/es6", "Coffee")
  @js.native
  ...
  implicit def make(companion: Coffee.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
