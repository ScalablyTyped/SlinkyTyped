...
object BackTen {
  @JSImport("grommet-icons/es6", "BackTen")
  @js.native
  ...
  implicit def make(companion: BackTen.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
