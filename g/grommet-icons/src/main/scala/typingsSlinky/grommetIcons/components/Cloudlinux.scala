...
object Cloudlinux {
  @JSImport("grommet-icons/es6", "Cloudlinux")
  @js.native
  ...
  implicit def make(companion: Cloudlinux.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
