...
object DocumentUpload {
  ...
  @JSImport("grommet-icons/es6", "DocumentUpload")
  @js.native
  ...
  implicit def make(companion: DocumentUpload.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
