...
object DocumentLocked {
  @JSImport("grommet-icons/es6", "DocumentLocked")
  @js.native
  ...
  implicit def make(companion: DocumentLocked.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
