...
object CaretPrevious {
  ...
  @JSImport("grommet-icons/es6", "CaretPrevious")
  @js.native
  ...
  implicit def make(companion: CaretPrevious.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
