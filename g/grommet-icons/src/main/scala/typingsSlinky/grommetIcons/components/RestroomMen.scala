...
object RestroomMen {
  @JSImport("grommet-icons/es6", "RestroomMen")
  @js.native
  ...
  implicit def make(companion: RestroomMen.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
