...
object Install {
  @JSImport("grommet-icons/es6", "Install")
  @js.native
  ...
  implicit def make(companion: Install.type): SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps443126004[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
