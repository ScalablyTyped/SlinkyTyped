package typingsSlinky.gapiClientDeploymentmanager.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typingsSlinky.gapiClientDeploymentmanager.gapiClientDeploymentmanagerStrings.deploymentmanager,
    version: v2
