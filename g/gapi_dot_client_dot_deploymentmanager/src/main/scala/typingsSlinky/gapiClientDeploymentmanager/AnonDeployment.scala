...
object AnonDeployment {
  @scala.inline
  def apply(deployment: String, manifest: String, project: String): AnonDeployment = {
  ...
  @scala.inline
  implicit class AnonDeploymentOps[Self <: AnonDeployment] (val x: Self) extends AnyVal {
    @scala.inline
