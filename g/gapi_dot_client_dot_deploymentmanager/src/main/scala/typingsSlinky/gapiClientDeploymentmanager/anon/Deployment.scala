...
object Deployment {
  @scala.inline
  def apply(deployment: String, manifest: String, project: String): Deployment = {
    val __obj = js.Dynamic.literal(deployment = deployment.asInstanceOf[js.Any], manifest = manifest.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
