...
trait TypeofwriteFile extends js.Object {
  ...
  def __promisify__(path: Double, data: String): js.Promise[Unit] = js.native
  def __promisify__(path: Double, data: String, options: WriteFileOptions): js.Promise[Unit] = js.native
  def __promisify__(path: Double, data: ArrayBufferView): js.Promise[Unit] = js.native
  def __promisify__(path: Double, data: ArrayBufferView, options: WriteFileOptions): js.Promise[Unit] = js.native
  /**
    ...
    */
  def __promisify__(path: PathLike, data: String): js.Promise[Unit] = js.native
  def __promisify__(path: PathLike, data: String, options: WriteFileOptions): js.Promise[Unit] = js.native
  def __promisify__(path: PathLike, data: ArrayBufferView): js.Promise[Unit] = js.native
  def __promisify__(path: PathLike, data: ArrayBufferView, options: WriteFileOptions): js.Promise[Unit] = js.native
}
