...
import typingsSlinky.gregorianDashCalendar.Anon_Locale
...
trait DateTimeFormat extends js.Object {
  ...
  /**
    ...
    */
  def format(calendar: typingsSlinky.gregorianDashCalendar.gregorianDashCalendarMod.^): String = js.native
  /**
  ...
  /**
    ...
    */
  def parse(dateString: String, hasLocale: Anon_Locale): typingsSlinky.gregorianDashCalendar.gregorianDashCalendarMod.^ = js.native
}
