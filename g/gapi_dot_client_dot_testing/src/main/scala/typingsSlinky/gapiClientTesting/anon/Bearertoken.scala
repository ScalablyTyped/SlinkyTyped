package typingsSlinky.gapiClientTesting.anon
...
object Bearertoken {
  @scala.inline
  def apply(environmentType: String): Bearertoken = {
  ...
  implicit class BearertokenOps[Self <: Bearertoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnvironmentType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("environmentType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
