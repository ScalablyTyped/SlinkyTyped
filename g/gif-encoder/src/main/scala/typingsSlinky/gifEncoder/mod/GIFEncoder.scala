package typingsSlinky.gifEncoder.mod

import typingsSlinky.gifEncoder.anon.IndexedPixels
import typingsSlinky.gifEncoder.gifEncoderNumbers.`0`
import typingsSlinky.gifEncoder.gifEncoderNumbers.`1`
import typingsSlinky.gifEncoder.gifEncoderNumbers.`2`
import typingsSlinky.gifEncoder.gifEncoderNumbers.`3`
import typingsSlinky.gifEncoder.gifEncoderStrings.close
import typingsSlinky.gifEncoder.gifEncoderStrings.data
import typingsSlinky.gifEncoder.gifEncoderStrings.end
import typingsSlinky.gifEncoder.gifEncoderStrings.error
import typingsSlinky.gifEncoder.gifEncoderStrings.finishNumbersignstart
import typingsSlinky.gifEncoder.gifEncoderStrings.finishNumbersignstop
import typingsSlinky.gifEncoder.gifEncoderStrings.frameNumbersignstart
import typingsSlinky.gifEncoder.gifEncoderStrings.frameNumbersignstop
import typingsSlinky.gifEncoder.gifEncoderStrings.pause
import typingsSlinky.gifEncoder.gifEncoderStrings.readable
import typingsSlinky.gifEncoder.gifEncoderStrings.resume
import typingsSlinky.gifEncoder.gifEncoderStrings.writeHeaderNumbersignstart
import typingsSlinky.gifEncoder.gifEncoderStrings.writeHeaderNumbersignstop
