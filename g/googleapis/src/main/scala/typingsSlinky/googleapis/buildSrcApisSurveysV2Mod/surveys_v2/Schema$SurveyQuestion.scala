...
/**
  ...
  */
@js.native
trait Schema$SurveyQuestion extends js.Object {
  /**
  ...
  var images: js.UndefOr[js.Array[Schema$SurveyQuestionImage]] = js.native
  /**
...
object Schema$SurveyQuestion {
  ...
  def apply(
    ...
    images: js.Array[Schema$SurveyQuestionImage] = null,
    ...
    __obj.asInstanceOf[Schema$SurveyQuestion]
  }
}
