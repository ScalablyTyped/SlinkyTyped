...
trait Schema$Device extends js.Object {
  ...
  /**
    ...
    * policy.
    */
  var applicationReports: js.UndefOr[js.Array[Schema$ApplicationReport]] = js.native
  /**
  ...
  /**
    ...
    */
  var deviceSettings: js.UndefOr[Schema$DeviceSettings] = js.native
  /**
    ...
    */
  var disabledReason: js.UndefOr[Schema$UserFacingMessage] = js.native
  /**
    ...
    */
  var displays: js.UndefOr[js.Array[Schema$Display]] = js.native
  /**
  ...
  /**
    ...
    */
  var hardwareInfo: js.UndefOr[Schema$HardwareInfo] = js.native
  /**
    ...
    */
  var hardwareStatusSamples: js.UndefOr[js.Array[Schema$HardwareStatus]] = js.native
  /**
    * Deprecated.
    */
  ...
  /**
    ...
    * device&#39;s policy.
    */
  var memoryEvents: js.UndefOr[js.Array[Schema$MemoryEvent]] = js.native
  /**
  ...
  /**
    ...
    */
  var networkInfo: js.UndefOr[Schema$NetworkInfo] = js.native
  /**
    * Details about policy settings that the device is not compliant with.
    */
  var nonComplianceDetails: js.UndefOr[js.Array[Schema$NonComplianceDetail]] = js.native
  /**
  ...
  /**
    ...
    * the device&#39;s policy.
    */
  var powerManagementEvents: js.UndefOr[js.Array[Schema$PowerManagementEvent]] = js.native
  /**
  ...
  /**
    ...
    */
  var softwareInfo: js.UndefOr[Schema$SoftwareInfo] = js.native
  /**
...
object Schema$Device {
  ...
  def apply(
    ...
    applicationReports: js.Array[Schema$ApplicationReport] = null,
    appliedPolicyName: String = null,
    appliedPolicyVersion: String = null,
    appliedState: String = null,
    deviceSettings: Schema$DeviceSettings = null,
    disabledReason: Schema$UserFacingMessage = null,
    displays: js.Array[Schema$Display] = null,
    enrollmentTime: String = null,
    enrollmentTokenData: String = null,
    enrollmentTokenName: String = null,
    hardwareInfo: Schema$HardwareInfo = null,
    hardwareStatusSamples: js.Array[Schema$HardwareStatus] = null,
    lastPolicyComplianceReportTime: String = null,
    lastPolicySyncTime: String = null,
    lastStatusReportTime: String = null,
    managementMode: String = null,
    memoryEvents: js.Array[Schema$MemoryEvent] = null,
    memoryInfo: Schema$MemoryInfo = null,
    name: String = null,
    networkInfo: Schema$NetworkInfo = null,
    nonComplianceDetails: js.Array[Schema$NonComplianceDetail] = null,
    policyCompliant: js.UndefOr[Boolean] = js.undefined,
    policyName: String = null,
    powerManagementEvents: js.Array[Schema$PowerManagementEvent] = null,
    previousDeviceNames: js.Array[String] = null,
    softwareInfo: Schema$SoftwareInfo = null,
    state: String = null,
