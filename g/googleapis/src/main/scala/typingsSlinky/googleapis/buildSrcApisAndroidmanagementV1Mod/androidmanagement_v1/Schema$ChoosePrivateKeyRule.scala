...
/**
  ...
  */
@js.native
trait Schema$ChoosePrivateKeyRule extends js.Object {
  /**
...
object Schema$ChoosePrivateKeyRule {
  @scala.inline
  def apply(packageNames: js.Array[String] = null, privateKeyAlias: String = null, urlPattern: String = null): Schema$ChoosePrivateKeyRule = {
    ...
    __obj.asInstanceOf[Schema$ChoosePrivateKeyRule]
  }
}
