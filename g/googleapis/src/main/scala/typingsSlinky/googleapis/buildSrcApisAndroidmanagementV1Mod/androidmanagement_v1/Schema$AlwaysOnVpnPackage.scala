...
/**
  ...
  */
@js.native
trait Schema$AlwaysOnVpnPackage extends js.Object {
  /**
...
object Schema$AlwaysOnVpnPackage {
  @scala.inline
  def apply(lockdownEnabled: js.UndefOr[Boolean] = js.undefined, packageName: String = null): Schema$AlwaysOnVpnPackage = {
    ...
    __obj.asInstanceOf[Schema$AlwaysOnVpnPackage]
  }
}
