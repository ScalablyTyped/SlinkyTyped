...
object ParamsResourceProjectsServiceaccountsGenerateidentitybindingaccesstoken {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsServiceaccountsGenerateidentitybindingaccesstokenOps[Self <: ParamsResourceProjectsServiceaccountsGenerateidentitybindingaccesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGenerateIdentityBindingAccessTokenRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
