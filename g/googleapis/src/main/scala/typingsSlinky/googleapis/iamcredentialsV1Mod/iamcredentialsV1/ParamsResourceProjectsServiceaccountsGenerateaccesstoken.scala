...
object ParamsResourceProjectsServiceaccountsGenerateaccesstoken {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsServiceaccountsGenerateaccesstokenOps[Self <: ParamsResourceProjectsServiceaccountsGenerateaccesstoken] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGenerateAccessTokenRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
