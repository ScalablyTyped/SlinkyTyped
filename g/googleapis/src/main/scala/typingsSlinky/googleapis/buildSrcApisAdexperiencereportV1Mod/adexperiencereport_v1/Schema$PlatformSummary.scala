package typingsSlinky.googleapis.buildSrcApisAdexperiencereportV1Mod.adexperiencereport_v1
...
/**
  ...
  */
@js.native
trait Schema$PlatformSummary extends js.Object {
  /**
...
object Schema$PlatformSummary {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$PlatformSummary]
  }
}
