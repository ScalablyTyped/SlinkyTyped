...
object ParamsResourceBucketaccesscontrolsInsert {
  @scala.inline
  def apply(): ParamsResourceBucketaccesscontrolsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBucketaccesscontrolsInsert]
  }
  @scala.inline
  implicit class ParamsResourceBucketaccesscontrolsInsertOps[Self <: ParamsResourceBucketaccesscontrolsInsert] (val x: Self) extends AnyVal {
    @scala.inline
