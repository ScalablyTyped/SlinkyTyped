...
@js.native
trait ParamsResourceBucketaccesscontrolsPatch extends StandardParameters {
  /**
...
object ParamsResourceBucketaccesscontrolsPatch {
  @scala.inline
  def apply(): ParamsResourceBucketaccesscontrolsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBucketaccesscontrolsPatch]
  }
  @scala.inline
  implicit class ParamsResourceBucketaccesscontrolsPatchOps[Self <: ParamsResourceBucketaccesscontrolsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaBucketAccessControl): Self = {
        val ret = this.duplicate
