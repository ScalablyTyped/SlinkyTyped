package typingsSlinky.googleapis.buildSrcApisCloudresourcemanagerV1Mod.cloudresourcemanager_v1
...
/**
  ...
  */
@js.native
trait Schema$Constraint extends js.Object {
  /**
    * Defines this constraint as being a BooleanConstraint.
    */
  var booleanConstraint: js.UndefOr[Schema$BooleanConstraint] = js.native
  /**
  ...
  /**
    ...
    */
  var listConstraint: js.UndefOr[Schema$ListConstraint] = js.native
  /**
...
object Schema$Constraint {
  @scala.inline
  def apply(
    booleanConstraint: Schema$BooleanConstraint = null,
    constraintDefault: String = null,
    description: String = null,
    displayName: String = null,
    listConstraint: Schema$ListConstraint = null,
    name: String = null,
    ...
    __obj.asInstanceOf[Schema$Constraint]
  }
}
