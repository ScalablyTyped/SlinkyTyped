...
object SchemaPosCustomBatchResponse {
  ...
  implicit class SchemaPosCustomBatchResponseOps[Self <: SchemaPosCustomBatchResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: SchemaPosCustomBatchResponseEntry*): Self = this.set("entries", js.Array(value :_*))
    @scala.inline
    def setEntries(value: js.Array[SchemaPosCustomBatchResponseEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
    @scala.inline
