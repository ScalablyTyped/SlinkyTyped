...
object SchemaDatafeedsCustomBatchRequest {
  ...
  implicit class SchemaDatafeedsCustomBatchRequestOps[Self <: SchemaDatafeedsCustomBatchRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: SchemaDatafeedsCustomBatchRequestEntry*): Self = this.set("entries", js.Array(value :_*))
    @scala.inline
    def setEntries(value: js.Array[SchemaDatafeedsCustomBatchRequestEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
    @scala.inline
