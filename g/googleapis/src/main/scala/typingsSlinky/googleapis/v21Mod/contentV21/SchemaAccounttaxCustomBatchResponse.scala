...
object SchemaAccounttaxCustomBatchResponse {
  ...
  implicit class SchemaAccounttaxCustomBatchResponseOps[Self <: SchemaAccounttaxCustomBatchResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: SchemaAccounttaxCustomBatchResponseEntry*): Self = this.set("entries", js.Array(value :_*))
    
    @scala.inline
    def setEntries(value: js.Array[SchemaAccounttaxCustomBatchResponseEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
