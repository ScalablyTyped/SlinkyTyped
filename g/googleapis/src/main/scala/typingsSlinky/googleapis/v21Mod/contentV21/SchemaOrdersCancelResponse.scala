...
@js.native
trait SchemaOrdersCancelResponse extends js.Object {
  /**
...
object SchemaOrdersCancelResponse {
  @scala.inline
  def apply(): SchemaOrdersCancelResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrdersCancelResponse]
  }
  @scala.inline
  implicit class SchemaOrdersCancelResponseOps[Self <: SchemaOrdersCancelResponse] (val x: Self) extends AnyVal {
    @scala.inline
