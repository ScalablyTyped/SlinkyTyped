...
object ParamsResourceAccounttaxCustombatch {
  ...
  @scala.inline
  implicit class ParamsResourceAccounttaxCustombatchOps[Self <: ParamsResourceAccounttaxCustombatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaAccounttaxCustomBatchRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
