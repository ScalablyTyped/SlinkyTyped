...
object SchemaAccountAdsLink {
  ...
  implicit class SchemaAccountAdsLinkOps[Self <: SchemaAccountAdsLink] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdsId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("adsId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAdsId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("adsId")(js.undefined)
        ret
    }
    @scala.inline
