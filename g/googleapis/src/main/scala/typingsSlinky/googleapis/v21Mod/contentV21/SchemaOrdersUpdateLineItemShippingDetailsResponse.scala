...
@js.native
trait SchemaOrdersUpdateLineItemShippingDetailsResponse extends StObject {
...
object SchemaOrdersUpdateLineItemShippingDetailsResponse {
  ...
  @scala.inline
  def apply(): SchemaOrdersUpdateLineItemShippingDetailsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrdersUpdateLineItemShippingDetailsResponse]
  }
  
  @scala.inline
  implicit class SchemaOrdersUpdateLineItemShippingDetailsResponseMutableBuilder[Self <: SchemaOrdersUpdateLineItemShippingDetailsResponse] (val x: Self) extends AnyVal {
