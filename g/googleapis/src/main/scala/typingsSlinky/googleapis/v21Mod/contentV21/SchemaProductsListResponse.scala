...
object SchemaProductsListResponse {
  ...
  implicit class SchemaProductsListResponseOps[Self <: SchemaProductsListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourcesVarargs(value: SchemaProduct*): Self = this.set("resources", js.Array(value :_*))
    @scala.inline
    def setResources(value: js.Array[SchemaProduct]): Self = this.set("resources", value.asInstanceOf[js.Any])
    @scala.inline
