...
@js.native
trait SchemaPosInventoryResponse extends js.Object {
  /**
...
object SchemaPosInventoryResponse {
  ...
  @scala.inline
  implicit class SchemaPosInventoryResponseOps[Self <: SchemaPosInventoryResponse] (val x: Self) extends AnyVal {
    @scala.inline
