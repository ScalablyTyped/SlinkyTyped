package typingsSlinky.googleapis.buildSrcApisSpeechV1Mod.speech_v1
...
/**
  ...
  */
@js.native
trait Schema$SpeechRecognitionAlternative extends js.Object {
  /**
  ...
  /**
    ...
    */
  var words: js.UndefOr[js.Array[Schema$WordInfo]] = js.native
}

object Schema$SpeechRecognitionAlternative {
  @scala.inline
  def apply(
    confidence: Int | Double = null,
    transcript: String = null,
    words: js.Array[Schema$WordInfo] = null
    ...
    __obj.asInstanceOf[Schema$SpeechRecognitionAlternative]
  }
}
