...
import typingsSlinky.googleapis.buildSrcApisCivicinfoV2Mod.civicinfo_v2.Civicinfo
import typingsSlinky.googleapis.buildSrcApisCivicinfoV2Mod.civicinfo_v2.Options
...
@JSImport("googleapis/build/src/apis/civicinfo", JSImport.Namespace)
@js.native
object buildSrcApisCivicinfoMod extends js.Object {
  def civicinfo(options: Options): Civicinfo = js.native
  @JSName("civicinfo")
  def civicinfo_v2(version: v2): Civicinfo = js.native
  @js.native
  object VERSIONS extends js.Object {
    @js.native
    class v2 protected () extends Civicinfo {
