...
/**
  ...
  */
@js.native
trait Schema$Election extends js.Object {
  /**
...
object Schema$Election {
  @scala.inline
  def apply(electionDay: String = null, id: String = null, name: String = null, ocdDivisionId: String = null): Schema$Election = {
    ...
    __obj.asInstanceOf[Schema$Election]
  }
}
