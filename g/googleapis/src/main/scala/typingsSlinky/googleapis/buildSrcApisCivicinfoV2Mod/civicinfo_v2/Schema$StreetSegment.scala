...
@js.native
trait Schema$StreetSegment extends js.Object {
  ...
  var geocodedPoint: js.UndefOr[Schema$PointProto] = js.native
  ...
  var provenances: js.UndefOr[js.Array[Schema$Provenance]] = js.native
...
object Schema$StreetSegment {
  ...
  def apply(
    ...
    geocodedPoint: Schema$PointProto = null,
    ...
    provenances: js.Array[Schema$Provenance] = null,
    ...
    __obj.asInstanceOf[Schema$StreetSegment]
  }
}
