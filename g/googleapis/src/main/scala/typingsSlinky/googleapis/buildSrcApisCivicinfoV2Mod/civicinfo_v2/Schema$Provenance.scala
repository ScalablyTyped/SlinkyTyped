...
@js.native
trait Schema$Provenance extends js.Object {
  var collidedSegmentSource: js.UndefOr[Schema$StreetSegmentList] = js.native
...
object Schema$Provenance {
  @scala.inline
  def apply(
    collidedSegmentSource: Schema$StreetSegmentList = null,
    ...
    __obj.asInstanceOf[Schema$Provenance]
  }
}
