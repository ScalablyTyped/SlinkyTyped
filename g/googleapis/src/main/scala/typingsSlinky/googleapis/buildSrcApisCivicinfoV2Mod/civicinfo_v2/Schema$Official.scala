...
/**
  ...
  */
@js.native
trait Schema$Official extends js.Object {
  /**
    * Addresses at which to contact the official.
    */
  var address: js.UndefOr[js.Array[Schema$SimpleAddressType]] = js.native
  /**
...
object Schema$Official {
  @scala.inline
  def apply(
    address: js.Array[Schema$SimpleAddressType] = null,
    ...
    __obj.asInstanceOf[Schema$Official]
  }
}
