...
/**
  ...
  */
@js.native
trait Schema$ReplaceAllShapesWithSheetsChartRequest extends js.Object {
  /**
...
object Schema$ReplaceAllShapesWithSheetsChartRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ReplaceAllShapesWithSheetsChartRequest]
  }
}
