...
/**
  ...
  */
@js.native
trait Schema$NotesProperties extends js.Object {
  /**
...
object Schema$NotesProperties {
  @scala.inline
  def apply(speakerNotesObjectId: String = null): Schema$NotesProperties = {
    val __obj = js.Dynamic.literal()
    if (speakerNotesObjectId != null) __obj.updateDynamic("speakerNotesObjectId")(speakerNotesObjectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$NotesProperties]
  }
}
