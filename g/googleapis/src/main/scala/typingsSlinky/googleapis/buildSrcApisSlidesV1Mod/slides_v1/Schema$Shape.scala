...
/**
  ...
  */
@js.native
trait Schema$Shape extends js.Object {
  /**
    ...
    */
  var placeholder: js.UndefOr[Schema$Placeholder] = js.native
  /**
...
object Schema$Shape {
  ...
  def apply(
    ...
    shapeProperties: Schema$ShapeProperties = null,
    ...
    __obj.asInstanceOf[Schema$Shape]
  }
}
