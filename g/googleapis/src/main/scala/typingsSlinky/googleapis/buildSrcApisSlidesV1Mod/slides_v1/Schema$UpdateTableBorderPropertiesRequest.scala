...
/**
  ...
  */
@js.native
trait Schema$UpdateTableBorderPropertiesRequest extends js.Object {
  /**
...
object Schema$UpdateTableBorderPropertiesRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$UpdateTableBorderPropertiesRequest = {
    ...
    __obj.asInstanceOf[Schema$UpdateTableBorderPropertiesRequest]
  }
}
