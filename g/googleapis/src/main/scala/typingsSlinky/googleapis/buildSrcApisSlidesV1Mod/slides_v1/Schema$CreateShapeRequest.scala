...
/**
  ...
  */
@js.native
trait Schema$CreateShapeRequest extends js.Object {
  /**
...
object Schema$CreateShapeRequest {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$CreateShapeRequest]
  }
}
