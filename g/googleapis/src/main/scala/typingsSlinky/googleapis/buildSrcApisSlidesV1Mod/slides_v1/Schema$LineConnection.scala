...
/**
  ...
  */
@js.native
trait Schema$LineConnection extends js.Object {
  /**
...
object Schema$LineConnection {
  @scala.inline
  def apply(connectedObjectId: String = null, connectionSiteIndex: Int | Double = null): Schema$LineConnection = {
    ...
    __obj.asInstanceOf[Schema$LineConnection]
  }
}
