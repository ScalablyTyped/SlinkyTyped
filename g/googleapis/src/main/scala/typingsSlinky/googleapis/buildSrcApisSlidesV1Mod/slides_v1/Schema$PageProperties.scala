...
/**
  ...
  */
@js.native
trait Schema$PageProperties extends js.Object {
  /**
    ...
    */
  var colorScheme: js.UndefOr[Schema$ColorScheme] = js.native
  /**
    ...
    * editor.
    */
  var pageBackgroundFill: js.UndefOr[Schema$PageBackgroundFill] = js.native
}

object Schema$PageProperties {
  @scala.inline
  def apply(colorScheme: Schema$ColorScheme = null, pageBackgroundFill: Schema$PageBackgroundFill = null): Schema$PageProperties = {
    ...
    __obj.asInstanceOf[Schema$PageProperties]
  }
}
