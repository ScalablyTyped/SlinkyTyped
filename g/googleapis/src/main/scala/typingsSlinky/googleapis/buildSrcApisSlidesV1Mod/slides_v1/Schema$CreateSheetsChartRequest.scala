...
/**
  ...
  */
@js.native
trait Schema$CreateSheetsChartRequest extends js.Object {
  /**
...
object Schema$CreateSheetsChartRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$CreateSheetsChartRequest = {
    ...
    __obj.asInstanceOf[Schema$CreateSheetsChartRequest]
  }
}
