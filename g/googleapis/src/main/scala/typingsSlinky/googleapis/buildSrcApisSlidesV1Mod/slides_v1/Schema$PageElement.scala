...
/**
  ...
  */
@js.native
trait Schema$PageElement extends js.Object {
  /**
  ...
  /**
    ...
    */
  var elementGroup: js.UndefOr[Schema$Group] = js.native
  /**
  ...
  /**
    * A line page element.
    */
  var line: js.UndefOr[Schema$Line] = js.native
  /**
  ...
  /**
    * A generic shape.
    */
  var shape: js.UndefOr[Schema$Shape] = js.native
  /**
    * A linked chart embedded from Google Sheets. Unlinked charts are
    * represented as images.
    */
  var sheetsChart: js.UndefOr[Schema$SheetsChart] = js.native
  /**
  ...
  /**
    ...
    */
  var video: js.UndefOr[Schema$Video] = js.native
  /**
    * A word art page element.
    */
  var wordArt: js.UndefOr[Schema$WordArt] = js.native
}

object Schema$PageElement {
  @scala.inline
  def apply(
    description: String = null,
    elementGroup: Schema$Group = null,
    image: Schema$Image = null,
    line: Schema$Line = null,
    objectId: String = null,
    shape: Schema$Shape = null,
    sheetsChart: Schema$SheetsChart = null,
    size: Schema$Size = null,
    table: Schema$Table = null,
    title: String = null,
    transform: Schema$AffineTransform = null,
    video: Schema$Video = null,
    wordArt: Schema$WordArt = null
  ): Schema$PageElement = {
    ...
    __obj.asInstanceOf[Schema$PageElement]
  }
}
