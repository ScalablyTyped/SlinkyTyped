...
/**
  ...
  */
@js.native
trait Schema$UpdateTextStyleRequest extends js.Object {
  /**
...
object Schema$UpdateTextStyleRequest {
  @scala.inline
  def apply(
    cellLocation: Schema$TableCellLocation = null,
    fields: String = null,
    objectId: String = null,
    style: Schema$TextStyle = null,
    ...
    __obj.asInstanceOf[Schema$UpdateTextStyleRequest]
  }
}
