...
/**
  ...
  */
@js.native
trait Schema$DuplicateObjectRequest extends js.Object {
  /**
...
object Schema$DuplicateObjectRequest {
  @scala.inline
  def apply(objectId: String = null, objectIds: StringDictionary[String] = null): Schema$DuplicateObjectRequest = {
    val __obj = js.Dynamic.literal()
    if (objectId != null) __obj.updateDynamic("objectId")(objectId.asInstanceOf[js.Any])
    if (objectIds != null) __obj.updateDynamic("objectIds")(objectIds.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$DuplicateObjectRequest]
  }
}
