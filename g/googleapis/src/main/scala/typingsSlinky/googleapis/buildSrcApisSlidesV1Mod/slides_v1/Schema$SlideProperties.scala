...
/**
  ...
  */
@js.native
trait Schema$SlideProperties extends js.Object {
  /**
  ...
  /**
    ...
    * read-only.
    */
  var notesPage: js.UndefOr[Schema$Page] = js.native
}

object Schema$SlideProperties {
  @scala.inline
  def apply(layoutObjectId: String = null, masterObjectId: String = null, notesPage: Schema$Page = null): Schema$SlideProperties = {
    ...
    __obj.asInstanceOf[Schema$SlideProperties]
  }
}
