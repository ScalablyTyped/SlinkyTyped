...
/**
  ...
  */
@js.native
trait Schema$SheetsChart extends js.Object {
  /**
  ...
  /**
    ...
    */
  var sheetsChartProperties: js.UndefOr[Schema$SheetsChartProperties] = js.native
  /**
...
object Schema$SheetsChart {
  @scala.inline
  def apply(
    chartId: Int | Double = null,
    contentUrl: String = null,
    sheetsChartProperties: Schema$SheetsChartProperties = null,
    ...
    __obj.asInstanceOf[Schema$SheetsChart]
  }
}
