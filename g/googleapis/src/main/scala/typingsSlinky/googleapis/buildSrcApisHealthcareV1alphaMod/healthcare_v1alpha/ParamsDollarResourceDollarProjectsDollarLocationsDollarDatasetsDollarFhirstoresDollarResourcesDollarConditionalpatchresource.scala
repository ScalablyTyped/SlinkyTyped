...
@js.native
trait ParamsDollarResourceDollarProjectsDollarLocationsDollarDatasetsDollarFhirstoresDollarResourcesDollarConditionalpatchresource extends StandardParameters {
  /**
