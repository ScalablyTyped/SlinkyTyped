...
object ParamsResourceSubnetworksPatch {
  ...
  implicit class ParamsResourceSubnetworksPatchOps[Self <: ParamsResourceSubnetworksPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDrainTimeoutSeconds(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("drainTimeoutSeconds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDrainTimeoutSeconds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("drainTimeoutSeconds")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaSubnetwork): Self = {
        val ret = this.duplicate
