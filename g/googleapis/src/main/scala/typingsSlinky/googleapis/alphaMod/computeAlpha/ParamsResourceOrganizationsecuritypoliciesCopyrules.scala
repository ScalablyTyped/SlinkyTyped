...
object ParamsResourceOrganizationsecuritypoliciesCopyrules {
  ...
  implicit class ParamsResourceOrganizationsecuritypoliciesCopyrulesOps[Self <: ParamsResourceOrganizationsecuritypoliciesCopyrules] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSourceSecurityPolicy(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sourceSecurityPolicy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSourceSecurityPolicy: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sourceSecurityPolicy")(js.undefined)
        ret
    }
  }
