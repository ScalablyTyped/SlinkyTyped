...
object ParamsResourceRegionhealthcheckservicesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceRegionhealthcheckservicesDeleteMutableBuilder[Self <: ParamsResourceRegionhealthcheckservicesDelete] (val x: Self) extends AnyVal {
