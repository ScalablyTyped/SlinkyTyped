...
object ParamsResourceRegionurlmapsValidate {
  ...
  @scala.inline
  implicit class ParamsResourceRegionurlmapsValidateOps[Self <: ParamsResourceRegionurlmapsValidate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRegionUrlMapsValidateRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
