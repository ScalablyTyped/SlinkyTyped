...
/**
  ...
  */
@js.native
trait SchemaSnapshotList extends StObject {
...
object SchemaSnapshotList {
  
  @scala.inline
  def apply(): SchemaSnapshotList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSnapshotList]
  }
  
  @scala.inline
  implicit class SchemaSnapshotListMutableBuilder[Self <: SchemaSnapshotList] (val x: Self) extends AnyVal {
