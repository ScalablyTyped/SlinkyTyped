...
object ParamsResourceNetworkendpointgroupsDetachnetworkendpoints {
  ...
  @scala.inline
  implicit class ParamsResourceNetworkendpointgroupsDetachnetworkendpointsOps[Self <: ParamsResourceNetworkendpointgroupsDetachnetworkendpoints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaNetworkEndpointGroupsDetachEndpointsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
