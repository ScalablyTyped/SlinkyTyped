...
object ParamsResourceNetworkendpointgroupsDetachnetworkendpoints {
  ...
  @scala.inline
  def apply(): ParamsResourceNetworkendpointgroupsDetachnetworkendpoints = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkendpointgroupsDetachnetworkendpoints]
  }
  
  @scala.inline
  implicit class ParamsResourceNetworkendpointgroupsDetachnetworkendpointsMutableBuilder[Self <: ParamsResourceNetworkendpointgroupsDetachnetworkendpoints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaNetworkEndpointGroupsDetachEndpointsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
