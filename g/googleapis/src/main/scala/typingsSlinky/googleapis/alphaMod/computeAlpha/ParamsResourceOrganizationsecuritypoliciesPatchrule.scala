...
object ParamsResourceOrganizationsecuritypoliciesPatchrule {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsecuritypoliciesPatchruleMutableBuilder[Self <: ParamsResourceOrganizationsecuritypoliciesPatchrule] (val x: Self) extends AnyVal {
