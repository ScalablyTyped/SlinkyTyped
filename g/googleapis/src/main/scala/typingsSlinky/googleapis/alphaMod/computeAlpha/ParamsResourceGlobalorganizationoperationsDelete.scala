...
@js.native
trait ParamsResourceGlobalorganizationoperationsDelete extends StandardParameters {
  /**
...
object ParamsResourceGlobalorganizationoperationsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceGlobalorganizationoperationsDeleteOps[Self <: ParamsResourceGlobalorganizationoperationsDelete] (val x: Self) extends AnyVal {
    @scala.inline
