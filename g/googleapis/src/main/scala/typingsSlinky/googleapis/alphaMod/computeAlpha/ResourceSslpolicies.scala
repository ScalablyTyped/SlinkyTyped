...
@js.native
class ResourceSslpolicies protected () extends StObject {
  ...
  def testIamPermissions(params: ParamsResourceSslpoliciesTestiampermissions, options: MethodOptions): GaxiosPromise[SchemaTestPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsResourceSslpoliciesTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaTestPermissionsResponse]
