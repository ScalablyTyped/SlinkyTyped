...
object SchemaInstance {
  ...
  implicit class SchemaInstanceOps[Self <: SchemaInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreservedStateSizeGb(value: String): Self = this.set("preservedStateSizeGb", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePreservedStateSizeGb: Self = this.set("preservedStateSizeGb", js.undefined)
    ...
    @scala.inline
    def setSourceMachineImageEncryptionKey(value: SchemaCustomerEncryptionKey): Self = this.set("sourceMachineImageEncryptionKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSourceMachineImageEncryptionKey: Self = this.set("sourceMachineImageEncryptionKey", js.undefined)
