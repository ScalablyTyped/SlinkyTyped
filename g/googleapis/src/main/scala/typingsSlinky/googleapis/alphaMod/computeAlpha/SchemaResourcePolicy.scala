...
object SchemaResourcePolicy {
  ...
  implicit class SchemaResourcePolicyOps[Self <: SchemaResourcePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupPlacementPolicy(value: SchemaResourcePolicyGroupPlacementPolicy): Self = this.set("groupPlacementPolicy", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVmMaintenancePolicy(value: SchemaResourcePolicyVmMaintenancePolicy): Self = this.set("vmMaintenancePolicy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteVmMaintenancePolicy: Self = this.set("vmMaintenancePolicy", js.undefined)
  }
}
