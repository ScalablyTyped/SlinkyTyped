...
@js.native
trait ParamsResourceOrganizationsecuritypoliciesGetrule extends StandardParameters {
  /**
...
object ParamsResourceOrganizationsecuritypoliciesGetrule {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsecuritypoliciesGetruleOps[Self <: ParamsResourceOrganizationsecuritypoliciesGetrule] (val x: Self) extends AnyVal {
    @scala.inline
