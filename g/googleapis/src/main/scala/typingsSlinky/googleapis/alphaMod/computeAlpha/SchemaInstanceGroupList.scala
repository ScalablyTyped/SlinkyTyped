...
/**
  ...
  */
@js.native
trait SchemaInstanceGroupList extends StObject {
...
object SchemaInstanceGroupList {
  ...
  @scala.inline
  implicit class SchemaInstanceGroupListMutableBuilder[Self <: SchemaInstanceGroupList] (val x: Self) extends AnyVal {
