...
object SchemaSslPolicy {
  ...
  implicit class SchemaSslPolicyOps[Self <: SchemaSslPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTlsSettings(value: SchemaServerTlsSettings): Self = this.set("tlsSettings", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTlsSettings: Self = this.set("tlsSettings", js.undefined)
    @scala.inline
