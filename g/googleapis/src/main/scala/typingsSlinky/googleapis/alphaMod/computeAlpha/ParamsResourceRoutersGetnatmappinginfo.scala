...
object ParamsResourceRoutersGetnatmappinginfo {
  ...
  implicit class ParamsResourceRoutersGetnatmappinginfoOps[Self <: ParamsResourceRoutersGetnatmappinginfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNatName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("natName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNatName: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("natName")(js.undefined)
        ret
    }
    @scala.inline
