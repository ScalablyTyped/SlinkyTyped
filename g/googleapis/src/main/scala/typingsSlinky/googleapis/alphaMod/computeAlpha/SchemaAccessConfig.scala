...
object SchemaAccessConfig {
  ...
  implicit class SchemaAccessConfigOps[Self <: SchemaAccessConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetPublicDns(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setPublicDns")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSetPublicDns: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setPublicDns")(js.undefined)
        ret
    }
    @scala.inline
