...
@js.native
trait ParamsResourceBackendbucketsPatch extends StandardParameters {
  /**
...
object ParamsResourceBackendbucketsPatch {
  @scala.inline
  def apply(): ParamsResourceBackendbucketsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendbucketsPatch]
  }
  @scala.inline
  implicit class ParamsResourceBackendbucketsPatchOps[Self <: ParamsResourceBackendbucketsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaBackendBucket): Self = {
        val ret = this.duplicate
