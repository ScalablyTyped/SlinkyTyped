...
object SchemaRouterBgpPeer {
  ...
  implicit class SchemaRouterBgpPeerOps[Self <: SchemaRouterBgpPeer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBfd(value: SchemaRouterBgpPeerBfd): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bfd")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBfd: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bfd")(js.undefined)
        ret
    }
    @scala.inline
    def withEnable(value: String): Self = {
        val ret = this.duplicate
