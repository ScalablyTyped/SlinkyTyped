...
object ParamsResourceRegiontargethttpsproxiesSeturlmap {
  ...
  @scala.inline
  implicit class ParamsResourceRegiontargethttpsproxiesSeturlmapMutableBuilder[Self <: ParamsResourceRegiontargethttpsproxiesSeturlmap] (val x: Self) extends AnyVal {
