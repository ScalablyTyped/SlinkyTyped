...
@js.native
trait ParamsResourceForwardingrulesDelete extends StandardParameters {
...
object ParamsResourceForwardingrulesDelete {
  
  @scala.inline
  def apply(): ParamsResourceForwardingrulesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceForwardingrulesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceForwardingrulesDeleteMutableBuilder[Self <: ParamsResourceForwardingrulesDelete] (val x: Self) extends AnyVal {
