...
object ParamsResourceInstancesSetmachineresources {
  ...
  @scala.inline
  implicit class ParamsResourceInstancesSetmachineresourcesMutableBuilder[Self <: ParamsResourceInstancesSetmachineresources] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstancesSetMachineResourcesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
