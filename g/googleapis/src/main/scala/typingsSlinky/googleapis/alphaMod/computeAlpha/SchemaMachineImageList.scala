...
object SchemaMachineImageList {
  ...
  @scala.inline
  implicit class SchemaMachineImageListOps[Self <: SchemaMachineImageList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaMachineImage*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaMachineImage]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
