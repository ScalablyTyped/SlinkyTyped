...
object ParamsResourceOrganizationsecuritypoliciesAddrule {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsecuritypoliciesAddruleMutableBuilder[Self <: ParamsResourceOrganizationsecuritypoliciesAddrule] (val x: Self) extends AnyVal {
