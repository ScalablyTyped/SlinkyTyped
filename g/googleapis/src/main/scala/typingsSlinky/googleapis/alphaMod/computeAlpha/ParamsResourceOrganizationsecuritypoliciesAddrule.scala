...
@js.native
trait ParamsResourceOrganizationsecuritypoliciesAddrule extends StandardParameters {
  /**
...
object ParamsResourceOrganizationsecuritypoliciesAddrule {
  @scala.inline
  def apply(): ParamsResourceOrganizationsecuritypoliciesAddrule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsecuritypoliciesAddrule]
  }
  @scala.inline
  implicit class ParamsResourceOrganizationsecuritypoliciesAddruleOps[Self <: ParamsResourceOrganizationsecuritypoliciesAddrule] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaSecurityPolicyRule): Self = {
        val ret = this.duplicate
