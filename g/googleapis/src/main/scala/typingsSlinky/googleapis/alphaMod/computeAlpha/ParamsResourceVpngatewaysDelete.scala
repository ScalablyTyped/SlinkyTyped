...
@js.native
trait ParamsResourceVpngatewaysDelete extends StandardParameters {
...
object ParamsResourceVpngatewaysDelete {
  
  @scala.inline
  def apply(): ParamsResourceVpngatewaysDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceVpngatewaysDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceVpngatewaysDeleteMutableBuilder[Self <: ParamsResourceVpngatewaysDelete] (val x: Self) extends AnyVal {
