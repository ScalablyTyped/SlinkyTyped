...
object SchemaTargetPool {
  ...
  implicit class SchemaTargetPoolOps[Self <: SchemaTargetPool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackupPool(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("backupPool")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBackupPool: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("backupPool")(js.undefined)
        ret
    }
    @scala.inline
