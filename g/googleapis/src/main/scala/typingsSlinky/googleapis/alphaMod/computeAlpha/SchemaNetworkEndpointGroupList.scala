...
object SchemaNetworkEndpointGroupList {
  ...
  @scala.inline
  implicit class SchemaNetworkEndpointGroupListOps[Self <: SchemaNetworkEndpointGroupList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaNetworkEndpointGroup*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaNetworkEndpointGroup]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
