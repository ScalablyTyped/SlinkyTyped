...
object SchemaTargetHttpProxy {
  ...
  implicit class SchemaTargetHttpProxyOps[Self <: SchemaTargetHttpProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProxyBind(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("proxyBind")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutProxyBind: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("proxyBind")(js.undefined)
        ret
    }
    @scala.inline
