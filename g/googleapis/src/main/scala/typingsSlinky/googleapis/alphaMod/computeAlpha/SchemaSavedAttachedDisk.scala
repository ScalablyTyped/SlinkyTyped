...
object SchemaSavedAttachedDisk {
  ...
  implicit class SchemaSavedAttachedDiskOps[Self <: SchemaSavedAttachedDisk] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInitializeParams(value: SchemaAttachedDiskInitializeParams): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSavedState(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("savedState")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSavedState: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("savedState")(js.undefined)
        ret
    }
    @scala.inline
