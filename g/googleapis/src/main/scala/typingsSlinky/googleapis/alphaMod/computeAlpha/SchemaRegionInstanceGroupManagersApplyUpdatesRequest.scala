...
object SchemaRegionInstanceGroupManagersApplyUpdatesRequest {
  ...
  implicit class SchemaRegionInstanceGroupManagersApplyUpdatesRequestOps[Self <: SchemaRegionInstanceGroupManagersApplyUpdatesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaximalAction(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maximalAction")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMaximalAction: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maximalAction")(js.undefined)
        ret
    }
    @scala.inline
