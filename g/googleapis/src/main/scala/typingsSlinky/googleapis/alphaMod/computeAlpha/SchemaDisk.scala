...
object SchemaDisk {
  ...
  implicit class SchemaDiskOps[Self <: SchemaDisk] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMultiWriter(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multiWriter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMultiWriter: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multiWriter")(js.undefined)
        ret
    }
    @scala.inline
