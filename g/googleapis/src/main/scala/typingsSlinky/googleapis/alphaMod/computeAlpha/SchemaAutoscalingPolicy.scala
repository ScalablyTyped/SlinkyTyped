...
object SchemaAutoscalingPolicy {
  ...
  implicit class SchemaAutoscalingPolicyOps[Self <: SchemaAutoscalingPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQueueBasedScaling(value: SchemaAutoscalingPolicyQueueBasedScaling): Self = this.set("queueBasedScaling", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteQueueBasedScaling: Self = this.set("queueBasedScaling", js.undefined)
  }
}
