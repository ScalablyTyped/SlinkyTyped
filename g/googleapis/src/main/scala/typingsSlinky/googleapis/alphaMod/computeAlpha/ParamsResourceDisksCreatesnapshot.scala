...
object ParamsResourceDisksCreatesnapshot {
  @scala.inline
  def apply(): ParamsResourceDisksCreatesnapshot = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDisksCreatesnapshot]
  }
  @scala.inline
  implicit class ParamsResourceDisksCreatesnapshotOps[Self <: ParamsResourceDisksCreatesnapshot] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaSnapshot): Self = {
        val ret = this.duplicate
