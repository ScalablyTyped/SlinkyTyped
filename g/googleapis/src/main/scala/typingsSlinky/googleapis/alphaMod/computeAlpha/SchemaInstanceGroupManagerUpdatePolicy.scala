...
object SchemaInstanceGroupManagerUpdatePolicy {
  ...
  implicit class SchemaInstanceGroupManagerUpdatePolicyOps[Self <: SchemaInstanceGroupManagerUpdatePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInstanceRedistributionType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("instanceRedistributionType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutInstanceRedistributionType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("instanceRedistributionType")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withReplacementMethod(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("replacementMethod")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutReplacementMethod: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("replacementMethod")(js.undefined)
        ret
    }
    @scala.inline
