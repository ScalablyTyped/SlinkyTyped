...
object SchemaNotificationEndpoint {
  ...
  implicit class SchemaNotificationEndpointOps[Self <: SchemaNotificationEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGrpcSettings(value: SchemaNotificationEndpointGrpcSettings): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("grpcSettings")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutGrpcSettings: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("grpcSettings")(js.undefined)
        ret
    }
    @scala.inline
