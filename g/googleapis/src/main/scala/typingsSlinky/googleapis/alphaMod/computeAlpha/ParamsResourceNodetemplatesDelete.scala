...
@js.native
trait ParamsResourceNodetemplatesDelete extends StandardParameters {
...
object ParamsResourceNodetemplatesDelete {
  
  @scala.inline
  def apply(): ParamsResourceNodetemplatesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodetemplatesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceNodetemplatesDeleteMutableBuilder[Self <: ParamsResourceNodetemplatesDelete] (val x: Self) extends AnyVal {
