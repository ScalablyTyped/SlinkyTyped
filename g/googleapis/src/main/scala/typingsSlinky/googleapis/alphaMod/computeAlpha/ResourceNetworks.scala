...
@js.native
class ResourceNetworks protected () extends StObject {
  ...
  def listIpAddresses(
    ...
    callback: BodyResponseCallback[SchemaIpAddressesList]
  ): Unit = js.native
  def listIpAddresses(
    params: ParamsResourceNetworksListipaddresses,
    options: BodyResponseCallback[SchemaIpAddressesList],
    callback: BodyResponseCallback[SchemaIpAddressesList]
  ): Unit = js.native
  def listIpAddresses(params: ParamsResourceNetworksListipaddresses, options: MethodOptions): GaxiosPromise[SchemaIpAddressesList] = js.native
  def listIpAddresses(
    params: ParamsResourceNetworksListipaddresses,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaIpAddressesList]
  ...
  def listIpOwners(
    params: ParamsResourceNetworksListipowners,
    options: BodyResponseCallback[SchemaIpOwnerList],
    callback: BodyResponseCallback[SchemaIpOwnerList]
  ): Unit = js.native
  def listIpOwners(params: ParamsResourceNetworksListipowners, options: MethodOptions): GaxiosPromise[SchemaIpOwnerList] = js.native
  def listIpOwners(
    params: ParamsResourceNetworksListipowners,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaIpOwnerList]
