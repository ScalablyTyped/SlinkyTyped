...
@js.native
trait ParamsDollarResourceDollarCreativesDollarListdeals extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCreativesDollarListdeals {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCreativesDollarListdeals = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCreativesDollarListdeals]
  }
}
