...
@js.native
trait Schema$UpdatePrivateAuctionProposalRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var note: js.UndefOr[Schema$MarketplaceNote] = js.native
  /**
...
object Schema$UpdatePrivateAuctionProposalRequest {
  @scala.inline
  def apply(
    externalDealId: String = null,
    note: Schema$MarketplaceNote = null,
    proposalRevisionNumber: String = null,
    updateAction: String = null
  ): Schema$UpdatePrivateAuctionProposalRequest = {
    ...
    __obj.asInstanceOf[Schema$UpdatePrivateAuctionProposalRequest]
  }
}
