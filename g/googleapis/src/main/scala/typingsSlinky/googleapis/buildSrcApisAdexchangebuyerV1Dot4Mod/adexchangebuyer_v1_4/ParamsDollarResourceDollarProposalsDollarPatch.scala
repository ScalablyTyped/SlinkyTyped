...
@js.native
trait ParamsDollarResourceDollarProposalsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarProposalsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarProposalsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarProposalsDollarPatch]
  }
}
