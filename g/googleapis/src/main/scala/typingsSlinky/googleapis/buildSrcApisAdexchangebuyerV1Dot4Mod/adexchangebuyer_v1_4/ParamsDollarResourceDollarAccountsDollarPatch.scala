...
@js.native
trait ParamsDollarResourceDollarAccountsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarPatch]
  }
}
