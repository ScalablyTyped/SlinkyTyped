...
@js.native
trait Schema$PublisherProfileApiProto extends js.Object {
  /**
  ...
  /**
    ...
    */
  var publisherProvidedForecast: js.UndefOr[Schema$PublisherProvidedForecast] = js.native
  /**
...
object Schema$PublisherProfileApiProto {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$PublisherProfileApiProto]
  }
}
