...
@js.native
trait ParamsDollarResourceDollarProposalsDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Proposal] = js.native
  /**
...
object ParamsDollarResourceDollarProposalsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Proposal = null,
    revisionNumber: String = null,
    updateAction: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarProposalsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarProposalsDollarUpdate]
  }
}
