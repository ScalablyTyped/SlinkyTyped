...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress extends js.Object {
  /**
...
object SchemaGoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress {
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress]
  }
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgressOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress] (val x: Self) extends AnyVal {
    @scala.inline
