...
object SchemaGoogleCloudVideointelligenceV1NormalizedBoundingPoly {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1NormalizedBoundingPolyMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1NormalizedBoundingPoly] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setVertices(value: js.Array[SchemaGoogleCloudVideointelligenceV1NormalizedVertex]): Self = StObject.set(x, "vertices", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVerticesUndefined: Self = StObject.set(x, "vertices", js.undefined)
    
    @scala.inline
    def setVerticesVarargs(value: SchemaGoogleCloudVideointelligenceV1NormalizedVertex*): Self = StObject.set(x, "vertices", js.Array(value :_*))
  }
}
