...
object SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBox {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBoxMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBox] (val x: Self) extends AnyVal {
