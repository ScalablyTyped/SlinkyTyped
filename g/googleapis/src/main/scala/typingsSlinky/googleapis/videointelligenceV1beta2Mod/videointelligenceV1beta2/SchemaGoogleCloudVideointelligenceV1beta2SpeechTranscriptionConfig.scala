...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig extends js.Object {
  /**
...
object SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig {
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig]
  }
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1beta2SpeechContext*): Self = this.set("speechContexts", js.Array(value :_*))
    @scala.inline
    def setSpeechContexts(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2SpeechContext]): Self = this.set("speechContexts", value.asInstanceOf[js.Any])
    @scala.inline
