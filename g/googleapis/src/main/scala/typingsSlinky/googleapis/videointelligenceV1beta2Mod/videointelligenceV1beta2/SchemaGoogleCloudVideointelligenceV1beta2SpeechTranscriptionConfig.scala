...
object SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpeechContexts(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2SpeechContext]): Self = StObject.set(x, "speechContexts", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpeechContextsUndefined: Self = StObject.set(x, "speechContexts", js.undefined)
    
    @scala.inline
    def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1beta2SpeechContext*): Self = StObject.set(x, "speechContexts", js.Array(value :_*))
  }
}
