...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress extends js.Object {
  /**
...
object SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgressOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress] (val x: Self) extends AnyVal {
    @scala.inline
