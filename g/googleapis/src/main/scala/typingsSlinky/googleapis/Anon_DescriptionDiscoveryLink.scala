...
@js.native
trait Anon_DescriptionDiscoveryLink extends js.Object {
...
object Anon_DescriptionDiscoveryLink {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_DescriptionDiscoveryLink]
  }
}
