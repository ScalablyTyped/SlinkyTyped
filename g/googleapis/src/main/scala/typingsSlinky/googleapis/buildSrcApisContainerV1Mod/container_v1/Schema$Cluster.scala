...
trait Schema$Cluster extends js.Object {
  ...
  /**
    ...
    */
  var conditions: js.UndefOr[js.Array[Schema$StatusCondition]] = js.native
  /**
  ...
  /**
    ...
    */
  var ipAllocationPolicy: js.UndefOr[Schema$IPAllocationPolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var legacyAbac: js.UndefOr[Schema$LegacyAbac] = js.native
  /**
  ...
  /**
    ...
    * issued.
    */
  var masterAuth: js.UndefOr[Schema$MasterAuth] = js.native
  /**
    * The configuration options for master authorized networks feature.
    */
  var masterAuthorizedNetworksConfig: js.UndefOr[Schema$MasterAuthorizedNetworksConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var networkConfig: js.UndefOr[Schema$NetworkConfig] = js.native
  /**
    * Configuration options for the NetworkPolicy feature.
    */
  var networkPolicy: js.UndefOr[Schema$NetworkPolicy] = js.native
  /**
    ...
    */
  var nodeConfig: js.UndefOr[Schema$NodeConfig] = js.native
  /**
...
object Schema$Cluster {
  ...
  def apply(
    ...
    conditions: js.Array[Schema$StatusCondition] = null,
    ...
    ipAllocationPolicy: Schema$IPAllocationPolicy = null,
    labelFingerprint: String = null,
    legacyAbac: Schema$LegacyAbac = null,
    location: String = null,
    locations: js.Array[String] = null,
    loggingService: String = null,
    maintenancePolicy: Schema$MaintenancePolicy = null,
    masterAuth: Schema$MasterAuth = null,
    masterAuthorizedNetworksConfig: Schema$MasterAuthorizedNetworksConfig = null,
    monitoringService: String = null,
    name: String = null,
    network: String = null,
    networkConfig: Schema$NetworkConfig = null,
    networkPolicy: Schema$NetworkPolicy = null,
    nodeConfig: Schema$NodeConfig = null,
    nodeIpv4CidrSize: Int | Double = null,
    nodePools: js.Array[Schema$NodePool] = null,
