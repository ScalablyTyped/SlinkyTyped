...
/**
  ...
  */
@js.native
trait Schema$SetNodePoolManagementRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var management: js.UndefOr[Schema$NodeManagement] = js.native
  /**
...
object Schema$SetNodePoolManagementRequest {
  @scala.inline
  def apply(
    clusterId: String = null,
    management: Schema$NodeManagement = null,
    name: String = null,
    ...
    __obj.asInstanceOf[Schema$SetNodePoolManagementRequest]
  }
}
