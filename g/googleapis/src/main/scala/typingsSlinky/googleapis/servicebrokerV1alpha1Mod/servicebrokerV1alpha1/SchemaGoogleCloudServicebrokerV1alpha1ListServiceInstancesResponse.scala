...
object SchemaGoogleCloudServicebrokerV1alpha1ListServiceInstancesResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1alpha1ListServiceInstancesResponseOps[Self <: SchemaGoogleCloudServicebrokerV1alpha1ListServiceInstancesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstancesVarargs(value: SchemaGoogleCloudServicebrokerV1alpha1ServiceInstance*): Self = this.set("instances", js.Array(value :_*))
    
    @scala.inline
    def setInstances(value: js.Array[SchemaGoogleCloudServicebrokerV1alpha1ServiceInstance]): Self = this.set("instances", value.asInstanceOf[js.Any])
