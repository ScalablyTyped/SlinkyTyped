...
object ParamsResourceProjectsBrokersInstancesServiceBindingsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsBrokersInstancesServiceBindingsListOps[Self <: ParamsResourceProjectsBrokersInstancesServiceBindingsList] (val x: Self) extends AnyVal {
    @scala.inline
