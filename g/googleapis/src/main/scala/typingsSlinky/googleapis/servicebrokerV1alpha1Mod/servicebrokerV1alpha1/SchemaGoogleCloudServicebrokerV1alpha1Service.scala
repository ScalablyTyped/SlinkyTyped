...
object SchemaGoogleCloudServicebrokerV1alpha1Service {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1alpha1ServiceMutableBuilder[Self <: SchemaGoogleCloudServicebrokerV1alpha1Service] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDashboard_client(value: SchemaGoogleCloudServicebrokerV1alpha1DashboardClient): Self = StObject.set(x, "dashboard_client", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInstance_retrievable(value: Boolean): Self = StObject.set(x, "instance_retrievable", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInstance_retrievableUndefined: Self = StObject.set(x, "instance_retrievable", js.undefined)
    ...
    @scala.inline
    def setPlans(value: js.Array[SchemaGoogleCloudServicebrokerV1alpha1Plan]): Self = StObject.set(x, "plans", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlansUndefined: Self = StObject.set(x, "plans", js.undefined)
    
    @scala.inline
    def setPlansVarargs(value: SchemaGoogleCloudServicebrokerV1alpha1Plan*): Self = StObject.set(x, "plans", js.Array(value :_*))
