...
object SchemaGoogleCloudServicebrokerV1alpha1UpdateServiceInstanceResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1alpha1UpdateServiceInstanceResponseOps[Self <: SchemaGoogleCloudServicebrokerV1alpha1UpdateServiceInstanceResponse] (val x: Self) extends AnyVal {
    @scala.inline
