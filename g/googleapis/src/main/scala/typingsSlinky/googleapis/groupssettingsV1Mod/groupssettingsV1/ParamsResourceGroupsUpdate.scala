...
object ParamsResourceGroupsUpdate {
  ...
  implicit class ParamsResourceGroupsUpdateOps[Self <: ParamsResourceGroupsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def deleteGroupUniqueId: Self = this.set("groupUniqueId", js.undefined)
    @scala.inline
    def setRequestBody(value: SchemaGroups): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
