...
object ParamsResourceGroupsUpdate {
  ...
  implicit class ParamsResourceGroupsUpdateOps[Self <: ParamsResourceGroupsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGroupUniqueId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("groupUniqueId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutGroupUniqueId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("groupUniqueId")(js.undefined)
        ret
    }
    @scala.inline
    def withRequestBody(value: SchemaGroups): Self = {
        val ret = this.duplicate
