...
@js.native
trait ParamsDollarResourceDollarSettingsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSettingsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSettingsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSettingsDollarGet]
  }
}
