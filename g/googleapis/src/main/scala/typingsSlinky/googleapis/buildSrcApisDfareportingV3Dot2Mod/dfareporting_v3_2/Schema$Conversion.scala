...
/**
  ...
  */
@js.native
trait Schema$Conversion extends js.Object {
  /**
  ...
  /**
    ...
    */
  var customVariables: js.UndefOr[js.Array[Schema$CustomFloodlightVariable]] = js.native
  /**
...
object Schema$Conversion {
  ...
  def apply(
    ...
    customVariables: js.Array[Schema$CustomFloodlightVariable] = null,
    ...
    __obj.asInstanceOf[Schema$Conversion]
  }
}
