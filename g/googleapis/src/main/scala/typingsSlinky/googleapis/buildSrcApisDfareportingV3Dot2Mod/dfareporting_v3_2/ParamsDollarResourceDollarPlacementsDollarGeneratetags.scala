...
@js.native
trait ParamsDollarResourceDollarPlacementsDollarGeneratetags extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlacementsDollarGeneratetags {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPlacementsDollarGeneratetags = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlacementsDollarGeneratetags]
  }
}
