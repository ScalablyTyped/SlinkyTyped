...
@js.native
trait ParamsDollarResourceDollarCitiesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCitiesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCitiesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCitiesDollarList]
  }
}
