...
@js.native
trait ParamsDollarResourceDollarUserrolesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUserrolesDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarUserrolesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUserrolesDollarList]
  }
}
