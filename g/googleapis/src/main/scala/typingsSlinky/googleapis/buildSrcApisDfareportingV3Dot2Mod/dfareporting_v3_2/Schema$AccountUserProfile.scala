...
/**
  ...
  */
@js.native
trait Schema$AccountUserProfile extends js.Object {
  /**
  ...
  /**
    ...
    */
  var advertiserFilter: js.UndefOr[Schema$ObjectFilter] = js.native
  /**
    * Filter that describes which campaigns are visible to the user profile.
    */
  var campaignFilter: js.UndefOr[Schema$ObjectFilter] = js.native
  /**
  ...
  /**
    ...
    */
  var siteFilter: js.UndefOr[Schema$ObjectFilter] = js.native
  /**
  ...
  /**
    ...
    */
  var userRoleFilter: js.UndefOr[Schema$ObjectFilter] = js.native
  /**
...
object Schema$AccountUserProfile {
  @scala.inline
  def apply(
    accountId: String = null,
    active: js.UndefOr[Boolean] = js.undefined,
    advertiserFilter: Schema$ObjectFilter = null,
    campaignFilter: Schema$ObjectFilter = null,
    ...
    locale: String = null,
    name: String = null,
    siteFilter: Schema$ObjectFilter = null,
    subaccountId: String = null,
    traffickerType: String = null,
    userAccessType: String = null,
    userRoleFilter: Schema$ObjectFilter = null,
    userRoleId: String = null
  ): Schema$AccountUserProfile = {
    ...
    __obj.asInstanceOf[Schema$AccountUserProfile]
  }
}
