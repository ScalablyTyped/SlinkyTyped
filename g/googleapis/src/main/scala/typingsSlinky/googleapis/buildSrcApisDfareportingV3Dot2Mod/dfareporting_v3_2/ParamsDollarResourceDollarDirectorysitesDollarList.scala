...
@js.native
trait ParamsDollarResourceDollarDirectorysitesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDirectorysitesDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDirectorysitesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDirectorysitesDollarList]
  }
}
