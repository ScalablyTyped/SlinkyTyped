...
@js.native
trait ParamsDollarResourceDollarEventtagsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEventtagsDollarList {
  @scala.inline
  def apply(
    adId: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEventtagsDollarList = {
    ...
    if (!js.isUndefined(definitionsOnly)) __obj.updateDynamic("definitionsOnly")(definitionsOnly.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEventtagsDollarList]
  }
}
