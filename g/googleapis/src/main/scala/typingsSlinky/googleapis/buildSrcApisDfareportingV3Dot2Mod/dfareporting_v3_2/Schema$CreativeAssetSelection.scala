...
/**
  ...
  */
@js.native
trait Schema$CreativeAssetSelection extends js.Object {
  /**
...
object Schema$CreativeAssetSelection {
  @scala.inline
  def apply(defaultAssetId: String = null, rules: js.Array[Schema$Rule] = null): Schema$CreativeAssetSelection = {
    val __obj = js.Dynamic.literal()
    if (defaultAssetId != null) __obj.updateDynamic("defaultAssetId")(defaultAssetId.asInstanceOf[js.Any])
    if (rules != null) __obj.updateDynamic("rules")(rules.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$CreativeAssetSelection]
  }
}
