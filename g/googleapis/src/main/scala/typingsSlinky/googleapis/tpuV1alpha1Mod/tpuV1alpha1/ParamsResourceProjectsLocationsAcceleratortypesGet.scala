...
object ParamsResourceProjectsLocationsAcceleratortypesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsAcceleratortypesGetOps[Self <: ParamsResourceProjectsLocationsAcceleratortypesGet] (val x: Self) extends AnyVal {
