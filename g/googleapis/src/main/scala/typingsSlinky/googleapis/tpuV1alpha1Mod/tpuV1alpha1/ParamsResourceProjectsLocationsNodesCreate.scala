...
object ParamsResourceProjectsLocationsNodesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsNodesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsNodesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsNodesCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsNodesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaNode): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
