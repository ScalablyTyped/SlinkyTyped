...
object ParamsResourceProjectsLocationsNodesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsNodesCreateOps[Self <: ParamsResourceProjectsLocationsNodesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaNode): Self = this.set("requestBody", value.asInstanceOf[js.Any])
