...
object ParamsResourceProjectsLocationsAcceleratortypesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsAcceleratortypesListMutableBuilder[Self <: ParamsResourceProjectsLocationsAcceleratortypesList] (val x: Self) extends AnyVal {
