...
import typingsSlinky.googleapis.gamesV1Mod.gamesV1.Options
...
object gamesMod {
  ...
  object VERSIONS {
    ...
    @js.native
    class v1 protected () extends Games {
    ...
    @scala.inline
    def v1_=(x: Instantiable2[/* options */ GlobalOptions, /* google */ js.UndefOr[GoogleConfigurable], Games]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("v1")(x.asInstanceOf[js.Any])
  }
  ...
  object auth extends Shortcut {
    ...
    object DefaultTransporter {
      ...
      @JSImport("googleapis/build/src/apis/games", "auth.DefaultTransporter.constructor")
      @js.native
  ...
  @JSImport("googleapis/build/src/apis/games", "games")
  @js.native
  def games(options: Options): Games = js.native
  @JSImport("googleapis/build/src/apis/games", "games")
  @js.native
