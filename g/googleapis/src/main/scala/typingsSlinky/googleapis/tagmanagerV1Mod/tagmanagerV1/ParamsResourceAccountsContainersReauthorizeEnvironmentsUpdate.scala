...
@js.native
trait ParamsResourceAccountsContainersReauthorizeEnvironmentsUpdate extends StandardParameters {
  /**
    * The GTM Account ID.
    */
...
object ParamsResourceAccountsContainersReauthorizeEnvironmentsUpdate {
  @scala.inline
  def apply(): ParamsResourceAccountsContainersReauthorizeEnvironmentsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersReauthorizeEnvironmentsUpdate]
  }
  @scala.inline
  implicit class ParamsResourceAccountsContainersReauthorizeEnvironmentsUpdateOps[Self <: ParamsResourceAccountsContainersReauthorizeEnvironmentsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaEnvironment): Self = {
        val ret = this.duplicate
