...
@js.native
trait ParamsResourceAccountsContainersFoldersCreate extends StandardParameters {
...
object ParamsResourceAccountsContainersFoldersCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersFoldersCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersFoldersCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersFoldersCreateMutableBuilder[Self <: ParamsResourceAccountsContainersFoldersCreate] (val x: Self) extends AnyVal {
