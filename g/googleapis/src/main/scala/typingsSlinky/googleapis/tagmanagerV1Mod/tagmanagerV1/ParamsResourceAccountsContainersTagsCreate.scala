...
object ParamsResourceAccountsContainersTagsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersTagsCreateOps[Self <: ParamsResourceAccountsContainersTagsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaTag): Self = {
        val ret = this.duplicate
