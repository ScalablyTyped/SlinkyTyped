...
@js.native
trait ParamsResourceAccountsContainersFoldersDelete extends StandardParameters {
...
object ParamsResourceAccountsContainersFoldersDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersFoldersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersFoldersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersFoldersDeleteMutableBuilder[Self <: ParamsResourceAccountsContainersFoldersDelete] (val x: Self) extends AnyVal {
