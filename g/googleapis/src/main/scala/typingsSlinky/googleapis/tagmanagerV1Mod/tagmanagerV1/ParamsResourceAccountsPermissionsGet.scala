...
@js.native
trait ParamsResourceAccountsPermissionsGet extends StandardParameters {
...
object ParamsResourceAccountsPermissionsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsPermissionsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsPermissionsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsPermissionsGetMutableBuilder[Self <: ParamsResourceAccountsPermissionsGet] (val x: Self) extends AnyVal {
