...
object ParamsResourceAccountsContainersTriggersGet {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersTriggersGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersTriggersGet]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersTriggersGetMutableBuilder[Self <: ParamsResourceAccountsContainersTriggersGet] (val x: Self) extends AnyVal {
