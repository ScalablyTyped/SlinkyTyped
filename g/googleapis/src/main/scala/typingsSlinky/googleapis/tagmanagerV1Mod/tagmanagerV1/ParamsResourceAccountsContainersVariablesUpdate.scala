...
object ParamsResourceAccountsContainersVariablesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersVariablesUpdateMutableBuilder[Self <: ParamsResourceAccountsContainersVariablesUpdate] (val x: Self) extends AnyVal {
