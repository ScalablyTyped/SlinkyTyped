...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechRecognitionAlternative extends js.Object {
  /**
  ...
  /**
    ...
    */
  var words: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_WordInfo]] = js.native
}

object Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechRecognitionAlternative {
  @scala.inline
  def apply(
    confidence: Int | Double = null,
    transcript: String = null,
    words: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_WordInfo] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechRecognitionAlternative]
  }
}
