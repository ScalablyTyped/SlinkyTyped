...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_VideoAnnotationProgress extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1beta2_VideoAnnotationProgress {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_VideoAnnotationProgress]
  }
}
