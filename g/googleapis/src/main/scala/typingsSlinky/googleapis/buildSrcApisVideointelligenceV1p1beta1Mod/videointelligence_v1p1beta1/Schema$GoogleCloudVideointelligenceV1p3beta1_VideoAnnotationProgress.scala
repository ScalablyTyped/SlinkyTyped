...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgress extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgress {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgress]
  }
}
