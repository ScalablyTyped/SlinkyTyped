...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1_VideoAnnotationProgress extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1_VideoAnnotationProgress {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1_VideoAnnotationProgress]
  }
}
