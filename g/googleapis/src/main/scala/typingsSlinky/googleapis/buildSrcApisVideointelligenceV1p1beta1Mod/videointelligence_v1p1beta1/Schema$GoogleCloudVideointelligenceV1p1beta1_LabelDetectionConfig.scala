...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p1beta1_LabelDetectionConfig extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1p1beta1_LabelDetectionConfig {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p1beta1_LabelDetectionConfig]
  }
}
