...
/**
  ...
  */
@js.native
trait Schema$GoogleLongrunning_Operation extends js.Object {
  /**
...
object Schema$GoogleLongrunning_Operation {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleLongrunning_Operation = {
    ...
    __obj.asInstanceOf[Schema$GoogleLongrunning_Operation]
  }
}
