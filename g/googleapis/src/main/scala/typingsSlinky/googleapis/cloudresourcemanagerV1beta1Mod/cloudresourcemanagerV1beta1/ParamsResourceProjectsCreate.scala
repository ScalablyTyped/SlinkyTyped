...
object ParamsResourceProjectsCreate {
  ...
  implicit class ParamsResourceProjectsCreateOps[Self <: ParamsResourceProjectsCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequestBody(value: SchemaProject): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUseLegacyStack(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("useLegacyStack")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutUseLegacyStack: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("useLegacyStack")(js.undefined)
        ret
    }
  }
