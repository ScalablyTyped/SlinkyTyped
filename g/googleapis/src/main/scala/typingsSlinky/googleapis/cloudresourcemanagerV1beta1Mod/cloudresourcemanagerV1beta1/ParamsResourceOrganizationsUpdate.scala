...
object ParamsResourceOrganizationsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsUpdateOps[Self <: ParamsResourceOrganizationsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrganization): Self = this.set("requestBody", value.asInstanceOf[js.Any])
