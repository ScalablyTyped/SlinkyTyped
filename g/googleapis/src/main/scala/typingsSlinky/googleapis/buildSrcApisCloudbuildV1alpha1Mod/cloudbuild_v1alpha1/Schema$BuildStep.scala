...
/**
  ...
  */
@js.native
trait Schema$BuildStep extends js.Object {
  /**
  ...
  /**
    ...
    * builder image only.
    */
  var pullTiming: js.UndefOr[Schema$TimeSpan] = js.native
  /**
...
object Schema$BuildStep {
  ...
  def apply(
    ...
    id: String = null,
    name: String = null,
    pullTiming: Schema$TimeSpan = null,
    secretEnv: js.Array[String] = null,
    status: String = null,
    timeout: String = null,
    timing: Schema$TimeSpan = null,
    ...
    __obj.asInstanceOf[Schema$BuildStep]
  }
}
