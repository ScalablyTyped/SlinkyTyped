...
/**
  ...
  */
@js.native
trait Schema$ExecuteBatchDmlResponse extends js.Object {
  /**
    ...
    */
  var resultSets: js.UndefOr[js.Array[Schema$ResultSet]] = js.native
  /**
...
object Schema$ExecuteBatchDmlResponse {
  @scala.inline
  def apply(resultSets: js.Array[Schema$ResultSet] = null, status: Schema$Status = null): Schema$ExecuteBatchDmlResponse = {
    val __obj = js.Dynamic.literal()
    if (resultSets != null) __obj.updateDynamic("resultSets")(resultSets.asInstanceOf[js.Any])
    if (status != null) __obj.updateDynamic("status")(status.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ExecuteBatchDmlResponse]
  }
}
