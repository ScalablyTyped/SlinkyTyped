...
trait Schema$TransactionOptions extends js.Object {
  /**
    ...
    */
  var partitionedDml: js.UndefOr[Schema$PartitionedDml] = js.native
  /**
...
object Schema$TransactionOptions {
  @scala.inline
  def apply(
    partitionedDml: Schema$PartitionedDml = null,
    readOnly: Schema$ReadOnly = null,
    readWrite: Schema$ReadWrite = null
  ): Schema$TransactionOptions = {
    val __obj = js.Dynamic.literal()
    if (partitionedDml != null) __obj.updateDynamic("partitionedDml")(partitionedDml.asInstanceOf[js.Any])
