...
/**
  ...
  */
@js.native
trait Schema$PlanNode extends js.Object {
  /**
    * List of child node `index`es and their relationship to this parent.
    */
  var childLinks: js.UndefOr[js.Array[Schema$ChildLink]] = js.native
  /**
  ...
  /**
    ...
    */
  var shortRepresentation: js.UndefOr[Schema$ShortRepresentation] = js.native
}

object Schema$PlanNode {
  @scala.inline
  def apply(
    childLinks: js.Array[Schema$ChildLink] = null,
    displayName: String = null,
    executionStats: StringDictionary[js.Any] = null,
    index: Int | Double = null,
    kind: String = null,
    metadata: StringDictionary[js.Any] = null,
    shortRepresentation: Schema$ShortRepresentation = null
  ): Schema$PlanNode = {
    ...
    __obj.asInstanceOf[Schema$PlanNode]
  }
}
