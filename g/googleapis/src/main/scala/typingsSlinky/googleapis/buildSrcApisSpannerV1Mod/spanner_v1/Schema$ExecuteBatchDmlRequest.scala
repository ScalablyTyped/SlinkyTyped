...
/**
  ...
  */
@js.native
trait Schema$ExecuteBatchDmlRequest extends js.Object {
  /**
...
object Schema$ExecuteBatchDmlRequest {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$ExecuteBatchDmlRequest]
  }
}
