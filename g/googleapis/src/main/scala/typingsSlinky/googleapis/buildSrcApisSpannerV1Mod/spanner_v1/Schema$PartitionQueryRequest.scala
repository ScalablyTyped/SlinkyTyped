...
/**
  ...
  */
@js.native
trait Schema$PartitionQueryRequest extends js.Object {
  /**
    ...
    */
  var paramTypes: js.UndefOr[StringDictionary[Schema$Type]] = js.native
  /**
...
object Schema$PartitionQueryRequest {
  @scala.inline
  def apply(
    paramTypes: StringDictionary[Schema$Type] = null,
    ...
    __obj.asInstanceOf[Schema$PartitionQueryRequest]
  }
}
