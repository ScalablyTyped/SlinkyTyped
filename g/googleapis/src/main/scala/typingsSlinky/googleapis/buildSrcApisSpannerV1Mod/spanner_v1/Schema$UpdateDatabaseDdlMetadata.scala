...
/**
  ...
  */
@js.native
trait Schema$UpdateDatabaseDdlMetadata extends js.Object {
  /**
...
object Schema$UpdateDatabaseDdlMetadata {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$UpdateDatabaseDdlMetadata]
  }
}
