...
/**
  ...
  */
@js.native
trait Schema$NotificationChannelDescriptor extends js.Object {
  /**
...
object Schema$NotificationChannelDescriptor {
  @scala.inline
  def apply(
    ...
    `type`: String = null
  ): Schema$NotificationChannelDescriptor = {
    ...
    __obj.asInstanceOf[Schema$NotificationChannelDescriptor]
  }
}
