...
/**
  ...
  */
@js.native
trait Schema$TemplateParameter extends js.Object {
  /**
  ...
  /**
    ...
    */
  var validation: js.UndefOr[Schema$ParameterValidation] = js.native
}

object Schema$TemplateParameter {
  @scala.inline
  def apply(
    description: String = null,
    fields: js.Array[String] = null,
    name: String = null,
    validation: Schema$ParameterValidation = null
    ...
    __obj.asInstanceOf[Schema$TemplateParameter]
  }
}
