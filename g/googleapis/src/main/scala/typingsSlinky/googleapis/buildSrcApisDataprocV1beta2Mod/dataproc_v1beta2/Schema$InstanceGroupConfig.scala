...
/**
  ...
  */
@js.native
trait Schema$InstanceGroupConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var diskConfig: js.UndefOr[Schema$DiskConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var managedGroupConfig: js.UndefOr[Schema$ManagedGroupConfig] = js.native
  /**
...
object Schema$InstanceGroupConfig {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$InstanceGroupConfig]
  }
}
