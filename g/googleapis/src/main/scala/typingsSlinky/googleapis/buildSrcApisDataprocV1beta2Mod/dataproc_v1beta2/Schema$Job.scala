...
trait Schema$Job extends js.Object {
  ...
  /**
    * Job is a Presto job
    */
  var prestoJob: js.UndefOr[Schema$PrestoJob] = js.native
  /**
  ...
  /**
    * Job is a SparkR job.
    */
  var sparkRJob: js.UndefOr[Schema$SparkRJob] = js.native
  /**
...
object Schema$Job {
  ...
  def apply(
    ...
    prestoJob: Schema$PrestoJob = null,
    ...
    sparkRJob: Schema$SparkRJob = null,
    ...
    if (prestoJob != null) __obj.updateDynamic("prestoJob")(prestoJob.asInstanceOf[js.Any])
    ...
    if (sparkRJob != null) __obj.updateDynamic("sparkRJob")(sparkRJob.asInstanceOf[js.Any])
