...
/**
  ...
  */
@js.native
trait Schema$WorkflowTemplate extends js.Object {
  /**
  ...
  /**
    ...
    */
  var jobs: js.UndefOr[js.Array[Schema$OrderedJob]] = js.native
  /**
  ...
  /**
    ...
    * instantiated.
    */
  var parameters: js.UndefOr[js.Array[Schema$TemplateParameter]] = js.native
  /**
    * Required. WorkflowTemplate scheduling information.
    */
  var placement: js.UndefOr[Schema$WorkflowTemplatePlacement] = js.native
  /**
...
object Schema$WorkflowTemplate {
  @scala.inline
  def apply(
    createTime: String = null,
    id: String = null,
    jobs: js.Array[Schema$OrderedJob] = null,
    labels: StringDictionary[String] = null,
    name: String = null,
    parameters: js.Array[Schema$TemplateParameter] = null,
    placement: Schema$WorkflowTemplatePlacement = null,
    ...
    __obj.asInstanceOf[Schema$WorkflowTemplate]
  }
}
