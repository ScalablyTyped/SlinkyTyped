...
/**
  ...
  */
@js.native
trait Schema$BasicYarnAutoscalingConfig extends js.Object {
  /**
...
object Schema$BasicYarnAutoscalingConfig {
  @scala.inline
  def apply(
  ...
  ): Schema$BasicYarnAutoscalingConfig = {
    ...
    __obj.asInstanceOf[Schema$BasicYarnAutoscalingConfig]
  }
}
