...
trait ParamsResourceProjectsJobsCreate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaCreateJobRequest] = js.native
}
object ParamsResourceProjectsJobsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsJobsCreateOps[Self <: ParamsResourceProjectsJobsCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateJobRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
