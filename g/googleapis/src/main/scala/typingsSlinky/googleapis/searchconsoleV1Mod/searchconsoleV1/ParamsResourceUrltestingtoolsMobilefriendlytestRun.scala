...
object ParamsResourceUrltestingtoolsMobilefriendlytestRun {
  ...
  @scala.inline
  implicit class ParamsResourceUrltestingtoolsMobilefriendlytestRunOps[Self <: ParamsResourceUrltestingtoolsMobilefriendlytestRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRunMobileFriendlyTestRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
