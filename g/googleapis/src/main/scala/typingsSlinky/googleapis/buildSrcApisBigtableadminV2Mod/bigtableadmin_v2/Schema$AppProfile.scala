...
/**
  ...
  */
@js.native
trait Schema$AppProfile extends js.Object {
  /**
  ...
  /**
    ...
    */
  var multiClusterRoutingUseAny: js.UndefOr[Schema$MultiClusterRoutingUseAny] = js.native
  /**
  ...
  /**
    ...
    */
  var singleClusterRouting: js.UndefOr[Schema$SingleClusterRouting] = js.native
}

object Schema$AppProfile {
  @scala.inline
  def apply(
    description: String = null,
    etag: String = null,
    multiClusterRoutingUseAny: Schema$MultiClusterRoutingUseAny = null,
    name: String = null,
    singleClusterRouting: Schema$SingleClusterRouting = null
  ): Schema$AppProfile = {
    ...
    __obj.asInstanceOf[Schema$AppProfile]
  }
}
