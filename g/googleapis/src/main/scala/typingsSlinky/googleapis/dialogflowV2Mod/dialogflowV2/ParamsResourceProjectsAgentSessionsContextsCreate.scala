...
object ParamsResourceProjectsAgentSessionsContextsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentSessionsContextsCreateOps[Self <: ParamsResourceProjectsAgentSessionsContextsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaGoogleCloudDialogflowV2Context): Self = {
        val ret = this.duplicate
