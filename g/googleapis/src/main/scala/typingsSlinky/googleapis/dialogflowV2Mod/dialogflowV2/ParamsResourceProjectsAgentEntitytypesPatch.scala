...
object ParamsResourceProjectsAgentEntitytypesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEntitytypesPatchOps[Self <: ParamsResourceProjectsAgentEntitytypesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudDialogflowV2EntityType): Self = this.set("requestBody", value.asInstanceOf[js.Any])
