...
object ParamsResourceProjectsAgentEntitytypesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEntitytypesCreateMutableBuilder[Self <: ParamsResourceProjectsAgentEntitytypesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudDialogflowV2EntityType): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
