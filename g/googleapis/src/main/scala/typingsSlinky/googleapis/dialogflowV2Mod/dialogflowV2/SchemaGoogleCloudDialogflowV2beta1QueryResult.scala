...
object SchemaGoogleCloudDialogflowV2beta1QueryResult {
  ...
  implicit class SchemaGoogleCloudDialogflowV2beta1QueryResultOps[Self <: SchemaGoogleCloudDialogflowV2beta1QueryResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFulfillmentMessages(value: js.Array[SchemaGoogleCloudDialogflowV2beta1IntentMessage]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIntent(value: SchemaGoogleCloudDialogflowV2beta1Intent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKnowledgeAnswers(value: SchemaGoogleCloudDialogflowV2beta1KnowledgeAnswers): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSentimentAnalysisResult(value: SchemaGoogleCloudDialogflowV2beta1SentimentAnalysisResult): Self = {
        val ret = this.duplicate
