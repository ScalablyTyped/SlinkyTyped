...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudDialogflowV2ImportAgentRequest extends js.Object {
...
object SchemaGoogleCloudDialogflowV2ImportAgentRequest {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudDialogflowV2ImportAgentRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2ImportAgentRequest]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2ImportAgentRequestOps[Self <: SchemaGoogleCloudDialogflowV2ImportAgentRequest] (val x: Self) extends AnyVal {
