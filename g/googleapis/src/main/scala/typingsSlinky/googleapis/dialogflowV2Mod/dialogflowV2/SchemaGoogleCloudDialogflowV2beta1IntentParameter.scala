...
object SchemaGoogleCloudDialogflowV2beta1IntentParameter {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2beta1IntentParameterMutableBuilder[Self <: SchemaGoogleCloudDialogflowV2beta1IntentParameter] (val x: Self) extends AnyVal {
