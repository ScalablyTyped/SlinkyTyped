...
object ParamsResourceProjectsAttestorsSetiampolicy {
  
  @scala.inline
  def apply(): ParamsResourceProjectsAttestorsSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAttestorsSetiampolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsAttestorsSetiampolicyMutableBuilder[Self <: ParamsResourceProjectsAttestorsSetiampolicy] (val x: Self) extends AnyVal {
