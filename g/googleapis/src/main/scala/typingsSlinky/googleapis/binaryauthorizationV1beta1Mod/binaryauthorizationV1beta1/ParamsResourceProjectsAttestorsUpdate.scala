...
object ParamsResourceProjectsAttestorsUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsAttestorsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAttestorsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsAttestorsUpdateOps[Self <: ParamsResourceProjectsAttestorsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAttestor): Self = this.set("requestBody", value.asInstanceOf[js.Any])
