...
@js.native
trait ParamsResourceDatabasesUpdate extends StandardParameters {
  /**
...
object ParamsResourceDatabasesUpdate {
  @scala.inline
  def apply(): ParamsResourceDatabasesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDatabasesUpdate]
  }
  @scala.inline
  implicit class ParamsResourceDatabasesUpdateOps[Self <: ParamsResourceDatabasesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaDatabase): Self = {
        val ret = this.duplicate
