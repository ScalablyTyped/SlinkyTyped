...
object ParamsResourceInstancesTruncatelog {
  ...
  @scala.inline
  implicit class ParamsResourceInstancesTruncatelogOps[Self <: ParamsResourceInstancesTruncatelog] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstancesTruncateLogRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
