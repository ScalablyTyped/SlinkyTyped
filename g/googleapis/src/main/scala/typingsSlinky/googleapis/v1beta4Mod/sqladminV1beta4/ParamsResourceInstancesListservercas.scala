...
@js.native
trait ParamsResourceInstancesListservercas extends StandardParameters {
  /**
...
object ParamsResourceInstancesListservercas {
  ...
  @scala.inline
  implicit class ParamsResourceInstancesListservercasOps[Self <: ParamsResourceInstancesListservercas] (val x: Self) extends AnyVal {
    @scala.inline
