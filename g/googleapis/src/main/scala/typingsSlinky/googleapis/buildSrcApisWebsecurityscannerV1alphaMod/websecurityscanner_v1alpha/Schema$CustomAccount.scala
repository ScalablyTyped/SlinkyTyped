...
/**
  ...
  */
@js.native
trait Schema$CustomAccount extends js.Object {
  /**
...
object Schema$CustomAccount {
  @scala.inline
  def apply(loginUrl: String = null, password: String = null, username: String = null): Schema$CustomAccount = {
    val __obj = js.Dynamic.literal()
    if (loginUrl != null) __obj.updateDynamic("loginUrl")(loginUrl.asInstanceOf[js.Any])
    if (password != null) __obj.updateDynamic("password")(password.asInstanceOf[js.Any])
    if (username != null) __obj.updateDynamic("username")(username.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$CustomAccount]
  }
}
