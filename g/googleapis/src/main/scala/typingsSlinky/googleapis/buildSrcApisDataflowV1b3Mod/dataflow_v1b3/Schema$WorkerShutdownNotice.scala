...
/**
  ...
  */
@js.native
trait Schema$WorkerShutdownNotice extends js.Object {
  /**
...
object Schema$WorkerShutdownNotice {
  @scala.inline
  def apply(reason: String = null): Schema$WorkerShutdownNotice = {
    val __obj = js.Dynamic.literal()
    if (reason != null) __obj.updateDynamic("reason")(reason.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$WorkerShutdownNotice]
  }
}
