...
/**
  ...
  */
@js.native
trait Schema$InstructionInput extends js.Object {
  /**
...
object Schema$InstructionInput {
  @scala.inline
  def apply(outputNum: Int | Double = null, producerInstructionIndex: Int | Double = null): Schema$InstructionInput = {
    ...
    __obj.asInstanceOf[Schema$InstructionInput]
  }
}
