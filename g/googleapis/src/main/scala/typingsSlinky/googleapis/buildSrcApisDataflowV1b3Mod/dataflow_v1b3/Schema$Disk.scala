...
/**
  ...
  */
@js.native
trait Schema$Disk extends js.Object {
  /**
...
object Schema$Disk {
  @scala.inline
  def apply(diskType: String = null, mountPoint: String = null, sizeGb: Int | Double = null): Schema$Disk = {
    ...
    __obj.asInstanceOf[Schema$Disk]
  }
}
