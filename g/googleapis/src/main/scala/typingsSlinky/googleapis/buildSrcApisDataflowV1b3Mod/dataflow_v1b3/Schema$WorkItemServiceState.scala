...
/**
  ...
  */
@js.native
trait Schema$WorkItemServiceState extends js.Object {
  /**
  ...
  /**
    ...
    */
  var metricShortId: js.UndefOr[js.Array[Schema$MetricShortId]] = js.native
  /**
  ...
  /**
    ...
    */
  var splitRequest: js.UndefOr[Schema$ApproximateSplitRequest] = js.native
  /**
    * DEPRECATED in favor of split_request.
    */
  var suggestedStopPoint: js.UndefOr[Schema$ApproximateProgress] = js.native
  /**
    * Obsolete, always empty.
    */
  var suggestedStopPosition: js.UndefOr[Schema$Position] = js.native
}

object Schema$WorkItemServiceState {
  @scala.inline
  def apply(
    harnessData: StringDictionary[js.Any] = null,
    leaseExpireTime: String = null,
    metricShortId: js.Array[Schema$MetricShortId] = null,
    nextReportIndex: String = null,
    reportStatusInterval: String = null,
    splitRequest: Schema$ApproximateSplitRequest = null,
    suggestedStopPoint: Schema$ApproximateProgress = null,
    suggestedStopPosition: Schema$Position = null
  ): Schema$WorkItemServiceState = {
    ...
    __obj.asInstanceOf[Schema$WorkItemServiceState]
  }
}
