...
/**
  ...
  */
@js.native
trait Schema$AutoscalingEvent extends js.Object {
  /**
  ...
  /**
    ...
    */
  var description: js.UndefOr[Schema$StructuredMessage] = js.native
  /**
...
object Schema$AutoscalingEvent {
  @scala.inline
  def apply(
    currentNumWorkers: String = null,
    description: Schema$StructuredMessage = null,
    eventType: String = null,
    targetNumWorkers: String = null,
    time: String = null,
    workerPool: String = null
  ): Schema$AutoscalingEvent = {
    ...
    __obj.asInstanceOf[Schema$AutoscalingEvent]
  }
}
