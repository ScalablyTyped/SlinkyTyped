...
/**
  ...
  */
@js.native
trait Schema$CounterStructuredName extends js.Object {
  /**
...
object Schema$CounterStructuredName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$CounterStructuredName]
  }
}
