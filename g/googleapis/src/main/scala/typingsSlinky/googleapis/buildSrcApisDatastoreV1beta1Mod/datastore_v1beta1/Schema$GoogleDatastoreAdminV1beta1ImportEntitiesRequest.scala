...
/**
  ...
  */
@js.native
trait Schema$GoogleDatastoreAdminV1beta1ImportEntitiesRequest extends js.Object {
  /**
...
object Schema$GoogleDatastoreAdminV1beta1ImportEntitiesRequest {
  @scala.inline
  def apply(
    entityFilter: Schema$GoogleDatastoreAdminV1beta1EntityFilter = null,
    inputUrl: String = null,
    labels: StringDictionary[String] = null
  ): Schema$GoogleDatastoreAdminV1beta1ImportEntitiesRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleDatastoreAdminV1beta1ImportEntitiesRequest]
  }
}
