...
/**
  ...
  */
@js.native
trait Schema$DocumentStyle extends js.Object {
  /**
    * The background of the document.
    */
  var background: js.UndefOr[Schema$Background] = js.native
  /**
...
object Schema$DocumentStyle {
  @scala.inline
  def apply(
    background: Schema$Background = null,
    ...
    __obj.asInstanceOf[Schema$DocumentStyle]
  }
}
