...
/**
  ...
  */
@js.native
trait Schema$EmbeddedObjectBorderSuggestionState extends js.Object {
  /**
...
object Schema$EmbeddedObjectBorderSuggestionState {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$EmbeddedObjectBorderSuggestionState]
  }
}
