...
/**
  ...
  */
@js.native
trait Schema$PositionedObject extends js.Object {
  /**
  ...
  /**
    ...
    * suggestion ID.
    */
  var suggestedPositionedObjectPropertiesChanges: js.UndefOr[StringDictionary[Schema$SuggestedPositionedObjectProperties]] = js.native
}

object Schema$PositionedObject {
  @scala.inline
  def apply(
    ...
    suggestedPositionedObjectPropertiesChanges: StringDictionary[Schema$SuggestedPositionedObjectProperties] = null
  ): Schema$PositionedObject = {
    ...
    __obj.asInstanceOf[Schema$PositionedObject]
  }
}
