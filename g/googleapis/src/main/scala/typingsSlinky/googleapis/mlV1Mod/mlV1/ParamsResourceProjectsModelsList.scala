...
object ParamsResourceProjectsModelsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsModelsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsModelsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsModelsListMutableBuilder[Self <: ParamsResourceProjectsModelsList] (val x: Self) extends AnyVal {
