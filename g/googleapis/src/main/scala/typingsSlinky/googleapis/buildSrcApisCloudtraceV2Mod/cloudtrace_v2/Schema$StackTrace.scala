package typingsSlinky.googleapis.buildSrcApisCloudtraceV2Mod.cloudtrace_v2
...
trait Schema$StackTrace extends js.Object {
  /**
    ...
    */
  var stackFrames: js.UndefOr[Schema$StackFrames] = js.native
  /**
...
object Schema$StackTrace {
  @scala.inline
  def apply(stackFrames: Schema$StackFrames = null, stackTraceHashId: String = null): Schema$StackTrace = {
