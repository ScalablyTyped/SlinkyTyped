...
/**
  ...
  */
@js.native
trait Schema$TruncatableString extends js.Object {
  /**
...
object Schema$TruncatableString {
  @scala.inline
  def apply(truncatedByteCount: Int | Double = null, value: String = null): Schema$TruncatableString = {
    ...
    __obj.asInstanceOf[Schema$TruncatableString]
  }
}
