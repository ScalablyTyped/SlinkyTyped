...
object SchemaQueryResponse {
  ...
  implicit class SchemaQueryResponseOps[Self <: SchemaQueryResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnHeadersVarargs(value: SchemaResultTableColumnHeader*): Self = this.set("columnHeaders", js.Array(value :_*))
    
    @scala.inline
    def setColumnHeaders(value: js.Array[SchemaResultTableColumnHeader]): Self = this.set("columnHeaders", value.asInstanceOf[js.Any])
