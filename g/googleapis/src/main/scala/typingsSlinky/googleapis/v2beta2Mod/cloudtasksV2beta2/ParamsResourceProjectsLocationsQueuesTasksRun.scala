...
object ParamsResourceProjectsLocationsQueuesTasksRun {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksRunOps[Self <: ParamsResourceProjectsLocationsQueuesTasksRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRunTaskRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
