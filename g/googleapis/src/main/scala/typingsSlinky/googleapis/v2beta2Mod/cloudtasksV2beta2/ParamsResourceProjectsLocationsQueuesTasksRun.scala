...
object ParamsResourceProjectsLocationsQueuesTasksRun {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsQueuesTasksRun = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsQueuesTasksRun]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksRunMutableBuilder[Self <: ParamsResourceProjectsLocationsQueuesTasksRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRunTaskRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
