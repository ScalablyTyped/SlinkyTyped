...
object ParamsResourceProjectsLocationsQueuesPause {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsQueuesPause = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsQueuesPause]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesPauseMutableBuilder[Self <: ParamsResourceProjectsLocationsQueuesPause] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPauseQueueRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
