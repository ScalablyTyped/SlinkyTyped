...
object ParamsResourceProjectsLocationsQueuesPause {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesPauseOps[Self <: ParamsResourceProjectsLocationsQueuesPause] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaPauseQueueRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
