...
object ParamsResourceProjectsLocationsQueuesTasksRenewlease {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsQueuesTasksRenewlease = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsQueuesTasksRenewlease]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksRenewleaseMutableBuilder[Self <: ParamsResourceProjectsLocationsQueuesTasksRenewlease] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRenewLeaseRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
