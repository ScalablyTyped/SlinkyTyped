...
object ParamsResourceProjectsLocationsQueuesTasksRenewlease {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksRenewleaseOps[Self <: ParamsResourceProjectsLocationsQueuesTasksRenewlease] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaRenewLeaseRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
