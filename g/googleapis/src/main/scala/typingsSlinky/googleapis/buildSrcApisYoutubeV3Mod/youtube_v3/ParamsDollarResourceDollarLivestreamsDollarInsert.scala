...
@js.native
trait ParamsDollarResourceDollarLivestreamsDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivestreamsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivestreamsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivestreamsDollarInsert]
  }
}
