...
@js.native
trait Schema$VideoListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$Video]] = js.native
  /**
...
object Schema$VideoListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$Video] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$VideoListResponse]
  }
}
