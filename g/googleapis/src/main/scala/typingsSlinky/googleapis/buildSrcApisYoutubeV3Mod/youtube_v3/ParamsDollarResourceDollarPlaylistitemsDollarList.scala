...
@js.native
trait ParamsDollarResourceDollarPlaylistitemsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlaylistitemsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    videoId: String = null
  ): ParamsDollarResourceDollarPlaylistitemsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlaylistitemsDollarList]
  }
}
