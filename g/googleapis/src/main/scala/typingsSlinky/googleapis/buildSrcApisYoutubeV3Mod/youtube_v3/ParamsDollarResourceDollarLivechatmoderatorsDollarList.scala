...
@js.native
trait ParamsDollarResourceDollarLivechatmoderatorsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivechatmoderatorsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivechatmoderatorsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivechatmoderatorsDollarList]
  }
}
