...
@js.native
trait Schema$LiveChatMessageAuthorDetails extends js.Object {
  /**
...
object Schema$LiveChatMessageAuthorDetails {
  @scala.inline
  def apply(
  ...
  ): Schema$LiveChatMessageAuthorDetails = {
    ...
    __obj.asInstanceOf[Schema$LiveChatMessageAuthorDetails]
  }
}
