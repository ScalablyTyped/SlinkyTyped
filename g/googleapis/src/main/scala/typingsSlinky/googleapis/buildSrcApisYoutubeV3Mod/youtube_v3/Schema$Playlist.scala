...
/**
  ...
  */
@js.native
trait Schema$Playlist extends js.Object {
  /**
    * The contentDetails object contains information like video count.
    */
  var contentDetails: js.UndefOr[Schema$PlaylistContentDetails] = js.native
  /**
  ...
  /**
    ...
    */
  var localizations: js.UndefOr[StringDictionary[Schema$PlaylistLocalization]] = js.native
  /**
    * The player object contains information that you would use to play the
    * playlist in an embedded player.
    */
  var player: js.UndefOr[Schema$PlaylistPlayer] = js.native
  /**
    * The snippet object contains basic details about the playlist, such as its
    * title and description.
    */
  var snippet: js.UndefOr[Schema$PlaylistSnippet] = js.native
  /**
    * The status object contains status information for the playlist.
    */
  var status: js.UndefOr[Schema$PlaylistStatus] = js.native
}

object Schema$Playlist {
  @scala.inline
  def apply(
    contentDetails: Schema$PlaylistContentDetails = null,
    etag: String = null,
    id: String = null,
    kind: String = null,
    localizations: StringDictionary[Schema$PlaylistLocalization] = null,
    player: Schema$PlaylistPlayer = null,
    snippet: Schema$PlaylistSnippet = null,
    status: Schema$PlaylistStatus = null
  ): Schema$Playlist = {
    ...
    __obj.asInstanceOf[Schema$Playlist]
  }
}
