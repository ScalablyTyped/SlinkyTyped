...
@js.native
trait ParamsDollarResourceDollarCaptionsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCaptionsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCaptionsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCaptionsDollarDelete]
  }
}
