...
/**
  ...
  */
@js.native
trait Schema$VideoCategory extends js.Object {
  /**
  ...
  /**
    ...
    * including its title.
    */
  var snippet: js.UndefOr[Schema$VideoCategorySnippet] = js.native
}

object Schema$VideoCategory {
  @scala.inline
  def apply(
    etag: String = null,
    id: String = null,
    kind: String = null,
    snippet: Schema$VideoCategorySnippet = null
    ...
    __obj.asInstanceOf[Schema$VideoCategory]
  }
}
