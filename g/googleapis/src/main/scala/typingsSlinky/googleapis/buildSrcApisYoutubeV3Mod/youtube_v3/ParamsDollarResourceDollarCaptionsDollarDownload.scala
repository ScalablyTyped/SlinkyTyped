...
@js.native
trait ParamsDollarResourceDollarCaptionsDollarDownload extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCaptionsDollarDownload {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    tlang: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarCaptionsDollarDownload = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCaptionsDollarDownload]
  }
}
