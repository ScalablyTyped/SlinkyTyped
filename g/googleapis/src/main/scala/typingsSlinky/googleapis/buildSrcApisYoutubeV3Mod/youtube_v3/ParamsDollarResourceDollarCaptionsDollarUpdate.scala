...
@js.native
trait ParamsDollarResourceDollarCaptionsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCaptionsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCaptionsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCaptionsDollarUpdate]
  }
}
