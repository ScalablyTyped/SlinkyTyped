...
@js.native
trait ParamsDollarResourceDollarChannelsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChannelsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChannelsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChannelsDollarList]
  }
}
