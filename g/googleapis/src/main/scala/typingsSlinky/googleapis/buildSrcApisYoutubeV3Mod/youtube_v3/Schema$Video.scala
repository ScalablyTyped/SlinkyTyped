...
trait Schema$Video extends js.Object {
  /**
    ...
    */
  var ageGating: js.UndefOr[Schema$VideoAgeGating] = js.native
  /**
    * The contentDetails object contains information about the video content,
    * including the length of the video and its aspect ratio.
    */
  var contentDetails: js.UndefOr[Schema$VideoContentDetails] = js.native
  /**
  ...
  /**
    ...
    * retrieved by the video owner.
    */
  var fileDetails: js.UndefOr[Schema$VideoFileDetails] = js.native
  /**
  ...
  /**
    ...
    */
  var liveStreamingDetails: js.UndefOr[Schema$VideoLiveStreamingDetails] = js.native
  /**
    * List with all localizations.
    */
  var localizations: js.UndefOr[StringDictionary[Schema$VideoLocalization]] = js.native
  /**
    * The monetizationDetails object encapsulates information about the
    * monetization status of the video.
    */
  var monetizationDetails: js.UndefOr[Schema$VideoMonetizationDetails] = js.native
  /**
    * The player object contains information that you would use to play the
    * video in an embedded player.
    */
  var player: js.UndefOr[Schema$VideoPlayer] = js.native
  /**
  ...
  /**
    ...
    */
  var suggestions: js.UndefOr[Schema$VideoSuggestions] = js.native
  /**
    * The topicDetails object encapsulates information about Freebase topics
    * associated with the video.
    */
  var topicDetails: js.UndefOr[Schema$VideoTopicDetails] = js.native
}

object Schema$Video {
  @scala.inline
  def apply(
    ageGating: Schema$VideoAgeGating = null,
    contentDetails: Schema$VideoContentDetails = null,
    etag: String = null,
    fileDetails: Schema$VideoFileDetails = null,
    id: String = null,
    kind: String = null,
    liveStreamingDetails: Schema$VideoLiveStreamingDetails = null,
    localizations: StringDictionary[Schema$VideoLocalization] = null,
    monetizationDetails: Schema$VideoMonetizationDetails = null,
    player: Schema$VideoPlayer = null,
    processingDetails: Schema$VideoProcessingDetails = null,
    projectDetails: Schema$VideoProjectDetails = null,
    recordingDetails: Schema$VideoRecordingDetails = null,
    snippet: Schema$VideoSnippet = null,
    statistics: Schema$VideoStatistics = null,
    status: Schema$VideoStatus = null,
    suggestions: Schema$VideoSuggestions = null,
    topicDetails: Schema$VideoTopicDetails = null
  ): Schema$Video = {
