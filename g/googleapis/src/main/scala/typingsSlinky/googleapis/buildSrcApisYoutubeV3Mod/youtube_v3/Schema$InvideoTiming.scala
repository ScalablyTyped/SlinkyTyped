...
/**
  ...
  */
@js.native
trait Schema$InvideoTiming extends js.Object {
  /**
...
object Schema$InvideoTiming {
  @scala.inline
  def apply(durationMs: String = null, offsetMs: String = null, `type`: String = null): Schema$InvideoTiming = {
    ...
    __obj.asInstanceOf[Schema$InvideoTiming]
  }
}
