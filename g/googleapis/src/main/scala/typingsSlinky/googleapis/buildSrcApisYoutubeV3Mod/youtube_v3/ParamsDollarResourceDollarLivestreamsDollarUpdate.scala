...
@js.native
trait ParamsDollarResourceDollarLivestreamsDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$LiveStream] = js.native
}

object ParamsDollarResourceDollarLivestreamsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$LiveStream = null,
    userIp: String = null
  ): ParamsDollarResourceDollarLivestreamsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivestreamsDollarUpdate]
  }
}
