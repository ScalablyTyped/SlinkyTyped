...
@js.native
trait Schema$SuperChatEventListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$SuperChatEvent]] = js.native
  /**
...
object Schema$SuperChatEventListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$SuperChatEvent] = null,
    kind: String = null,
    nextPageToken: String = null,
    pageInfo: Schema$PageInfo = null,
    tokenPagination: Schema$TokenPagination = null,
    visitorId: String = null
  ): Schema$SuperChatEventListResponse = {
    ...
    __obj.asInstanceOf[Schema$SuperChatEventListResponse]
  }
}
