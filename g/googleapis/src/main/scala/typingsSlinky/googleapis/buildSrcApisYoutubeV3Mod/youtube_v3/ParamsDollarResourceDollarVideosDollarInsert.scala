...
@js.native
trait ParamsDollarResourceDollarVideosDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVideosDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarVideosDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVideosDollarInsert]
  }
}
