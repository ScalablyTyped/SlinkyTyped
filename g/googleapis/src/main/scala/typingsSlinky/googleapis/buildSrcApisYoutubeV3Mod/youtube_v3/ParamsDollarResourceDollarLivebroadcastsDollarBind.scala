...
@js.native
trait ParamsDollarResourceDollarLivebroadcastsDollarBind extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivebroadcastsDollarBind {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivebroadcastsDollarBind = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivebroadcastsDollarBind]
  }
}
