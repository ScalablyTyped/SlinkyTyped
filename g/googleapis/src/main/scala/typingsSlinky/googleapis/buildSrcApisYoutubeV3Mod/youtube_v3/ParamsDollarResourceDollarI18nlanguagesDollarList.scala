...
@js.native
trait ParamsDollarResourceDollarI18nlanguagesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarI18nlanguagesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarI18nlanguagesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarI18nlanguagesDollarList]
  }
}
