...
/**
  ...
  */
@js.native
trait Schema$IngestionInfo extends js.Object {
  /**
...
object Schema$IngestionInfo {
  @scala.inline
  def apply(backupIngestionAddress: String = null, ingestionAddress: String = null, streamName: String = null): Schema$IngestionInfo = {
    ...
    __obj.asInstanceOf[Schema$IngestionInfo]
  }
}
