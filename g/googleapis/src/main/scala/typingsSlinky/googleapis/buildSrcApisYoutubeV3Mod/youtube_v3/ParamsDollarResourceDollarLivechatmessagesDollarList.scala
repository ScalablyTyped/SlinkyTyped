...
@js.native
trait ParamsDollarResourceDollarLivechatmessagesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivechatmessagesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivechatmessagesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivechatmessagesDollarList]
  }
}
