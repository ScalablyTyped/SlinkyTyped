...
@js.native
trait ParamsDollarResourceDollarSponsorsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSponsorsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSponsorsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSponsorsDollarList]
  }
}
