...
@js.native
trait ParamsDollarResourceDollarVideosDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVideosDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarVideosDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVideosDollarDelete]
  }
}
