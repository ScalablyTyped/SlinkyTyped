...
@js.native
trait ParamsDollarResourceDollarLivebroadcastsDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$LiveBroadcast] = js.native
}

object ParamsDollarResourceDollarLivebroadcastsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$LiveBroadcast = null,
    userIp: String = null
  ): ParamsDollarResourceDollarLivebroadcastsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivebroadcastsDollarInsert]
  }
}
