...
/**
  ...
  */
@js.native
trait Schema$ChannelSnippet extends js.Object {
  /**
  ...
  /**
    ...
    */
  var localized: js.UndefOr[Schema$ChannelLocalization] = js.native
  /**
...
object Schema$ChannelSnippet {
  ...
  def apply(
    ...
    localized: Schema$ChannelLocalization = null,
    ...
    __obj.asInstanceOf[Schema$ChannelSnippet]
  }
}
