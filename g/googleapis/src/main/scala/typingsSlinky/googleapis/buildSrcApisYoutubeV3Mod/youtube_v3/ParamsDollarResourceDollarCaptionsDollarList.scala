...
@js.native
trait ParamsDollarResourceDollarCaptionsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCaptionsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    videoId: String = null
  ): ParamsDollarResourceDollarCaptionsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCaptionsDollarList]
  }
}
