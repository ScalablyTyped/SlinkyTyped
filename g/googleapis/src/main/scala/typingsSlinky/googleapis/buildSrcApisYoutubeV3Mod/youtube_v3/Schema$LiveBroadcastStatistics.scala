...
/**
  ...
  */
@js.native
trait Schema$LiveBroadcastStatistics extends js.Object {
  /**
...
object Schema$LiveBroadcastStatistics {
  @scala.inline
  def apply(concurrentViewers: String = null, totalChatCount: String = null): Schema$LiveBroadcastStatistics = {
    ...
    __obj.asInstanceOf[Schema$LiveBroadcastStatistics]
  }
}
