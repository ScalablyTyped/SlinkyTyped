...
/**
  ...
  */
@js.native
trait Schema$VideoContentDetails extends js.Object {
  /**
  ...
  /**
    ...
    * schemes.
    */
  var contentRating: js.UndefOr[Schema$ContentRating] = js.native
  /**
    * The countryRestriction object contains information about the countries
    * where a video is (or is not) viewable.
    */
  var countryRestriction: js.UndefOr[Schema$AccessPolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var regionRestriction: js.UndefOr[Schema$VideoContentDetailsRegionRestriction] = js.native
}

object Schema$VideoContentDetails {
  @scala.inline
  def apply(
    caption: String = null,
    contentRating: Schema$ContentRating = null,
    countryRestriction: Schema$AccessPolicy = null,
    ...
    regionRestriction: Schema$VideoContentDetailsRegionRestriction = null
    ...
    __obj.asInstanceOf[Schema$VideoContentDetails]
  }
}
