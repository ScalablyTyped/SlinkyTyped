...
@js.native
trait ParamsDollarResourceDollarLivestreamsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivestreamsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivestreamsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivestreamsDollarDelete]
  }
}
