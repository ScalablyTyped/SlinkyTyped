...
@js.native
trait ParamsDollarResourceDollarLivebroadcastsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivebroadcastsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivebroadcastsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivebroadcastsDollarList]
  }
}
