...
@js.native
trait ParamsDollarResourceDollarChannelsectionsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChannelsectionsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChannelsectionsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChannelsectionsDollarUpdate]
  }
}
