...
/**
  ...
  */
@js.native
trait Schema$PlaylistSnippet extends js.Object {
  /**
  ...
  /**
    ...
    */
  var localized: js.UndefOr[Schema$PlaylistLocalization] = js.native
  /**
...
object Schema$PlaylistSnippet {
  ...
  def apply(
    ...
    localized: Schema$PlaylistLocalization = null,
    ...
    __obj.asInstanceOf[Schema$PlaylistSnippet]
  }
}
