...
@js.native
trait Schema$PlaylistListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$Playlist]] = js.native
  /**
...
object Schema$PlaylistListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$Playlist] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$PlaylistListResponse]
  }
}
