...
@js.native
trait ParamsDollarResourceDollarVideosDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVideosDollarList {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarVideosDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVideosDollarList]
  }
}
