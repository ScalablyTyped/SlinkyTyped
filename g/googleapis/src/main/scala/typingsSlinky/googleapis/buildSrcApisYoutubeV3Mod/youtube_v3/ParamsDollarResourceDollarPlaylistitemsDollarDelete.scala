...
@js.native
trait ParamsDollarResourceDollarPlaylistitemsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlaylistitemsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPlaylistitemsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlaylistitemsDollarDelete]
  }
}
