...
/**
  ...
  */
@js.native
trait Schema$VideoFileDetailsVideoStream extends js.Object {
  /**
...
object Schema$VideoFileDetailsVideoStream {
  @scala.inline
  def apply(
  ...
  ): Schema$VideoFileDetailsVideoStream = {
    ...
    __obj.asInstanceOf[Schema$VideoFileDetailsVideoStream]
  }
}
