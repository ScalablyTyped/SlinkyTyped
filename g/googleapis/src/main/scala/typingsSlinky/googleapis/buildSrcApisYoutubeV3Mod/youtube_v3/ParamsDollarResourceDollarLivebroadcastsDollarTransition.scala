...
@js.native
trait ParamsDollarResourceDollarLivebroadcastsDollarTransition extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivebroadcastsDollarTransition {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivebroadcastsDollarTransition = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivebroadcastsDollarTransition]
  }
}
