...
@js.native
trait ParamsDollarResourceDollarVideosDollarGetrating extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVideosDollarGetrating {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarVideosDollarGetrating = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVideosDollarGetrating]
  }
}
