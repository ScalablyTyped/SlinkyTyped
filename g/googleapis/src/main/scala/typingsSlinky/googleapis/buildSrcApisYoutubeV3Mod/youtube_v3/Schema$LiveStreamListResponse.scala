...
@js.native
trait Schema$LiveStreamListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$LiveStream]] = js.native
  /**
...
object Schema$LiveStreamListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$LiveStream] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$LiveStreamListResponse]
  }
}
