...
@js.native
trait Schema$SubscriptionListResponse extends js.Object {
  /**
...
object Schema$SubscriptionListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$Subscription] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$SubscriptionListResponse]
  }
}
