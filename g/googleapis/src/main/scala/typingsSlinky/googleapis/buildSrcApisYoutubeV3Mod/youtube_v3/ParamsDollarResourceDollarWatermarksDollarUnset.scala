...
@js.native
trait ParamsDollarResourceDollarWatermarksDollarUnset extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarWatermarksDollarUnset {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarWatermarksDollarUnset = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarWatermarksDollarUnset]
  }
}
