...
@js.native
trait ParamsDollarResourceDollarCommentthreadsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCommentthreadsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null,
    videoId: String = null
  ): ParamsDollarResourceDollarCommentthreadsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCommentthreadsDollarList]
  }
}
