...
/**
  ...
  */
@js.native
trait Schema$VideoFileDetails extends js.Object {
  /**
    ...
    */
  var audioStreams: js.UndefOr[js.Array[Schema$VideoFileDetailsAudioStream]] = js.native
  /**
  ...
  /**
    ...
    */
  var videoStreams: js.UndefOr[js.Array[Schema$VideoFileDetailsVideoStream]] = js.native
}

object Schema$VideoFileDetails {
  @scala.inline
  def apply(
    audioStreams: js.Array[Schema$VideoFileDetailsAudioStream] = null,
    ...
    videoStreams: js.Array[Schema$VideoFileDetailsVideoStream] = null
  ): Schema$VideoFileDetails = {
    ...
    __obj.asInstanceOf[Schema$VideoFileDetails]
  }
}
