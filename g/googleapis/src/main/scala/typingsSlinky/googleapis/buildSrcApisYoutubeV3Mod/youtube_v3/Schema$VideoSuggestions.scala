...
/**
  ...
  */
@js.native
trait Schema$VideoSuggestions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var tagSuggestions: js.UndefOr[js.Array[Schema$VideoSuggestionsTagSuggestion]] = js.native
}

object Schema$VideoSuggestions {
  @scala.inline
  def apply(
    ...
    tagSuggestions: js.Array[Schema$VideoSuggestionsTagSuggestion] = null
  ): Schema$VideoSuggestions = {
    ...
    __obj.asInstanceOf[Schema$VideoSuggestions]
  }
}
