...
@js.native
class Resource$Superchatevents protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$SuperChatEventListResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$SuperChatEventListResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarSuperchateventsDollarList): GaxiosPromise[Schema$SuperChatEventListResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarSuperchateventsDollarList,
    callback: BodyResponseCallback[Schema$SuperChatEventListResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarSuperchateventsDollarList,
    options: BodyResponseCallback[Schema$SuperChatEventListResponse],
    callback: BodyResponseCallback[Schema$SuperChatEventListResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarSuperchateventsDollarList, options: MethodOptions): GaxiosPromise[Schema$SuperChatEventListResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarSuperchateventsDollarList,
