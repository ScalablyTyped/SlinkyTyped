...
@js.native
trait Schema$SearchListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$SearchResult]] = js.native
  /**
...
object Schema$SearchListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$SearchResult] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$SearchListResponse]
  }
}
