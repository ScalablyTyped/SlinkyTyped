...
@js.native
trait ParamsDollarResourceDollarPlaylistsDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlaylistsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPlaylistsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlaylistsDollarInsert]
  }
}
