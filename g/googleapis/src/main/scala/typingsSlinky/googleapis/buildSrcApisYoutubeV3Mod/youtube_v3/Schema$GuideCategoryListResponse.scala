...
@js.native
trait Schema$GuideCategoryListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$GuideCategory]] = js.native
  /**
...
object Schema$GuideCategoryListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$GuideCategory] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$GuideCategoryListResponse]
  }
}
