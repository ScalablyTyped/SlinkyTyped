...
@js.native
trait ParamsDollarResourceDollarPlaylistitemsDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$PlaylistItem] = js.native
}

object ParamsDollarResourceDollarPlaylistitemsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$PlaylistItem = null,
    userIp: String = null
  ): ParamsDollarResourceDollarPlaylistitemsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlaylistitemsDollarUpdate]
  }
}
