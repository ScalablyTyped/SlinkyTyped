...
@js.native
class Resource$Search protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$SearchListResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$SearchListResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarSearchDollarList): GaxiosPromise[Schema$SearchListResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarSearchDollarList,
    callback: BodyResponseCallback[Schema$SearchListResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarSearchDollarList,
    options: BodyResponseCallback[Schema$SearchListResponse],
    callback: BodyResponseCallback[Schema$SearchListResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarSearchDollarList, options: MethodOptions): GaxiosPromise[Schema$SearchListResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarSearchDollarList,
