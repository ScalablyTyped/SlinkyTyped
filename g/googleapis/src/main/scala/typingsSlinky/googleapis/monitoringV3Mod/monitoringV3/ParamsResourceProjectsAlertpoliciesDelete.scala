...
@js.native
trait ParamsResourceProjectsAlertpoliciesDelete extends StandardParameters {
  /**
...
object ParamsResourceProjectsAlertpoliciesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAlertpoliciesDeleteOps[Self <: ParamsResourceProjectsAlertpoliciesDelete] (val x: Self) extends AnyVal {
    @scala.inline
