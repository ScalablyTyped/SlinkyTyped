...
object ParamsResourceProjectsCollectdtimeseriesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsCollectdtimeseriesCreateOps[Self <: ParamsResourceProjectsCollectdtimeseriesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateCollectdTimeSeriesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
