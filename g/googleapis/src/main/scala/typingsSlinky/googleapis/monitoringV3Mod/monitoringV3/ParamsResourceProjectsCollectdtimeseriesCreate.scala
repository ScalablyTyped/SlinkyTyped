...
object ParamsResourceProjectsCollectdtimeseriesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsCollectdtimeseriesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsCollectdtimeseriesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsCollectdtimeseriesCreateMutableBuilder[Self <: ParamsResourceProjectsCollectdtimeseriesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateCollectdTimeSeriesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
