...
object ParamsResourceProjectsNotificationchannelsCreate {
  @scala.inline
  def apply(): ParamsResourceProjectsNotificationchannelsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsNotificationchannelsCreate]
  }
  @scala.inline
  implicit class ParamsResourceProjectsNotificationchannelsCreateOps[Self <: ParamsResourceProjectsNotificationchannelsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaNotificationChannel): Self = {
        val ret = this.duplicate
