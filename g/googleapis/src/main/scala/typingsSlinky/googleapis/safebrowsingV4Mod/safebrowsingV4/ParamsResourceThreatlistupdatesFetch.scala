...
object ParamsResourceThreatlistupdatesFetch {
  ...
  @scala.inline
  implicit class ParamsResourceThreatlistupdatesFetchOps[Self <: ParamsResourceThreatlistupdatesFetch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaFetchThreatListUpdatesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
