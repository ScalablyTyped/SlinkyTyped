package typingsSlinky.googleapis.buildSrcApisStoragetransferV1Mod.storagetransfer_v1
...
@js.native
class Resource$Googleserviceaccounts protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(): GaxiosPromise[Schema$GoogleServiceAccount] = js.native
  def get(callback: BodyResponseCallback[Schema$GoogleServiceAccount]): Unit = js.native
  def get(params: ParamsDollarResourceDollarGoogleserviceaccountsDollarGet): GaxiosPromise[Schema$GoogleServiceAccount] = js.native
  def get(
    params: ParamsDollarResourceDollarGoogleserviceaccountsDollarGet,
    callback: BodyResponseCallback[Schema$GoogleServiceAccount]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarGoogleserviceaccountsDollarGet,
    options: BodyResponseCallback[Schema$GoogleServiceAccount],
    callback: BodyResponseCallback[Schema$GoogleServiceAccount]
  ): Unit = js.native
  def get(params: ParamsDollarResourceDollarGoogleserviceaccountsDollarGet, options: MethodOptions): GaxiosPromise[Schema$GoogleServiceAccount] = js.native
  def get(
    params: ParamsDollarResourceDollarGoogleserviceaccountsDollarGet,
