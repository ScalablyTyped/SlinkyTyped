...
/**
  ...
  */
@js.native
trait Schema$DownloadLineItemsRequest extends js.Object {
  /**
...
object Schema$DownloadLineItemsRequest {
  @scala.inline
  def apply(
    ...
    format: String = null
  ): Schema$DownloadLineItemsRequest = {
    ...
    __obj.asInstanceOf[Schema$DownloadLineItemsRequest]
  }
}
