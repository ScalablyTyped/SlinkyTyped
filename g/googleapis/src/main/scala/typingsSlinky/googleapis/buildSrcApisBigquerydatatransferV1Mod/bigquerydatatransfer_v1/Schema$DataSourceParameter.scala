...
/**
  ...
  */
@js.native
trait Schema$DataSourceParameter extends js.Object {
  /**
  ...
  /**
    ...
    */
  var fields: js.UndefOr[js.Array[Schema$DataSourceParameter]] = js.native
  /**
...
object Schema$DataSourceParameter {
  @scala.inline
  def apply(
    allowedValues: js.Array[String] = null,
    description: String = null,
    displayName: String = null,
    fields: js.Array[Schema$DataSourceParameter] = null,
    ...
    __obj.asInstanceOf[Schema$DataSourceParameter]
  }
}
