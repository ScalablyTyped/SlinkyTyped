...
class ResourceDollarProjectsDollarLocations protected () extends js.Object {
  ...
  var dataSources: ResourceDollarProjectsDollarLocationsDollarDatasources = js.native
  var transferConfigs: ResourceDollarProjectsDollarLocationsDollarTransferconfigs = js.native
  /**
