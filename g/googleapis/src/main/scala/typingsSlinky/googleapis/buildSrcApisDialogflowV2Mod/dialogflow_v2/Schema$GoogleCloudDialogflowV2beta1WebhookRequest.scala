...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1WebhookRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var originalDetectIntentRequest: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1OriginalDetectIntentRequest] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2beta1WebhookRequest {
  @scala.inline
  def apply(
    alternativeQueryResults: js.Array[Schema$GoogleCloudDialogflowV2beta1QueryResult] = null,
    originalDetectIntentRequest: Schema$GoogleCloudDialogflowV2beta1OriginalDetectIntentRequest = null,
    queryResult: Schema$GoogleCloudDialogflowV2beta1QueryResult = null,
    responseId: String = null,
    session: String = null
  ): Schema$GoogleCloudDialogflowV2beta1WebhookRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1WebhookRequest]
  }
}
