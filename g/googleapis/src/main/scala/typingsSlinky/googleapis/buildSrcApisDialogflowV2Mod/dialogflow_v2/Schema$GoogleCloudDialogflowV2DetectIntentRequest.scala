...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2DetectIntentRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var queryInput: js.UndefOr[Schema$GoogleCloudDialogflowV2QueryInput] = js.native
  /**
    * Optional. The parameters of this query.
    */
  var queryParams: js.UndefOr[Schema$GoogleCloudDialogflowV2QueryParameters] = js.native
}

object Schema$GoogleCloudDialogflowV2DetectIntentRequest {
  @scala.inline
  def apply(
    inputAudio: String = null,
    outputAudioConfig: Schema$GoogleCloudDialogflowV2OutputAudioConfig = null,
    queryInput: Schema$GoogleCloudDialogflowV2QueryInput = null,
    queryParams: Schema$GoogleCloudDialogflowV2QueryParameters = null
  ): Schema$GoogleCloudDialogflowV2DetectIntentRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2DetectIntentRequest]
  }
}
