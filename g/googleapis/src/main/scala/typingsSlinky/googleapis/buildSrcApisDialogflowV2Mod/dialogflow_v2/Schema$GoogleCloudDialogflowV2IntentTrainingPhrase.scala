...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2IntentTrainingPhrase extends js.Object {
  /**
  ...
  /**
    ...
    */
  var parts: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2IntentTrainingPhrasePart]] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2IntentTrainingPhrase {
  @scala.inline
  def apply(
    name: String = null,
    parts: js.Array[Schema$GoogleCloudDialogflowV2IntentTrainingPhrasePart] = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2IntentTrainingPhrase]
  }
}
