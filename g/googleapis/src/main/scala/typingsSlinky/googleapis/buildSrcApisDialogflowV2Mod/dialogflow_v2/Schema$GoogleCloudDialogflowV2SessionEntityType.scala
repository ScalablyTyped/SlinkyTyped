...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2SessionEntityType extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2SessionEntityType {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2SessionEntityType]
  }
}
