...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2OutputAudioConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var synthesizeSpeechConfig: js.UndefOr[Schema$GoogleCloudDialogflowV2SynthesizeSpeechConfig] = js.native
}

object Schema$GoogleCloudDialogflowV2OutputAudioConfig {
  @scala.inline
  def apply(
    audioEncoding: String = null,
    sampleRateHertz: Int | Double = null,
    synthesizeSpeechConfig: Schema$GoogleCloudDialogflowV2SynthesizeSpeechConfig = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2OutputAudioConfig]
  }
}
