...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2SynthesizeSpeechConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var voice: js.UndefOr[Schema$GoogleCloudDialogflowV2VoiceSelectionParams] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2SynthesizeSpeechConfig {
  @scala.inline
  def apply(
    effectsProfileId: js.Array[String] = null,
    pitch: Int | Double = null,
    speakingRate: Int | Double = null,
    voice: Schema$GoogleCloudDialogflowV2VoiceSelectionParams = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2SynthesizeSpeechConfig]
  }
}
