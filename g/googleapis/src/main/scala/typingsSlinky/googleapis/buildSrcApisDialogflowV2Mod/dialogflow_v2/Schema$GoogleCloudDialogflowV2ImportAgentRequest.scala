...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2ImportAgentRequest extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2ImportAgentRequest {
  @scala.inline
  def apply(agentContent: String = null, agentUri: String = null): Schema$GoogleCloudDialogflowV2ImportAgentRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2ImportAgentRequest]
  }
}
