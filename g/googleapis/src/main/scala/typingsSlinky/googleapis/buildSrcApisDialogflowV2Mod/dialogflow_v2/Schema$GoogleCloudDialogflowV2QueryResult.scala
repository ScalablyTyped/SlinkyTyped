...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2QueryResult extends js.Object {
  /**
  ...
  /**
    ...
    */
  var intent: js.UndefOr[Schema$GoogleCloudDialogflowV2Intent] = js.native
  /**
  ...
  /**
    ...
    */
  var sentimentAnalysisResult: js.UndefOr[Schema$GoogleCloudDialogflowV2SentimentAnalysisResult] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2QueryResult {
  @scala.inline
  def apply(
    action: String = null,
    ...
    intent: Schema$GoogleCloudDialogflowV2Intent = null,
    ...
    sentimentAnalysisResult: Schema$GoogleCloudDialogflowV2SentimentAnalysisResult = null,
    speechRecognitionConfidence: Int | Double = null,
    webhookPayload: StringDictionary[js.Any] = null,
    webhookSource: String = null
  ): Schema$GoogleCloudDialogflowV2QueryResult = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2QueryResult]
  }
}
