...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1IntentMessageTelephonyPlayAudio extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1IntentMessageTelephonyPlayAudio {
  @scala.inline
  def apply(audioUri: String = null): Schema$GoogleCloudDialogflowV2beta1IntentMessageTelephonyPlayAudio = {
    val __obj = js.Dynamic.literal()
    if (audioUri != null) __obj.updateDynamic("audioUri")(audioUri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1IntentMessageTelephonyPlayAudio]
  }
}
