...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2ExportAgentResponse extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2ExportAgentResponse {
  @scala.inline
  def apply(agentContent: String = null, agentUri: String = null): Schema$GoogleCloudDialogflowV2ExportAgentResponse = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2ExportAgentResponse]
  }
}
