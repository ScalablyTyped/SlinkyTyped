...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1Intent extends js.Object {
  /**
  ...
  /**
    ...
    * output.
    */
  var followupIntentInfo: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo]] = js.native
  /**
  ...
  /**
    ...
    */
  var messages: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2beta1IntentMessage]] = js.native
  /**
  ...
  /**
    ...
    */
  var parameters: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2beta1IntentParameter]] = js.native
  /**
  ...
  /**
    ...
    */
  var trainingPhrases: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrase]] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2beta1Intent {
  @scala.inline
  def apply(
    action: String = null,
    ...
    followupIntentInfo: js.Array[Schema$GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo] = null,
    inputContextNames: js.Array[String] = null,
    isFallback: js.UndefOr[Boolean] = js.undefined,
    messages: js.Array[Schema$GoogleCloudDialogflowV2beta1IntentMessage] = null,
    ...
    parameters: js.Array[Schema$GoogleCloudDialogflowV2beta1IntentParameter] = null,
    parentFollowupIntentName: String = null,
    priority: Int | Double = null,
    resetContexts: js.UndefOr[Boolean] = js.undefined,
    rootFollowupIntentName: String = null,
    trainingPhrases: js.Array[Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrase] = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1Intent]
  }
}
