...
object AnonReachByFrequencyMetricNames {
  @scala.inline
  def apply(): AnonReachByFrequencyMetricNames = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonReachByFrequencyMetricNames]
  }
  @scala.inline
  implicit class AnonReachByFrequencyMetricNamesOps[Self <: AnonReachByFrequencyMetricNames] (val x: Self) extends AnyVal {
    @scala.inline
