...
object SchemaGoogleFirestoreAdminV1beta1Index {
  ...
  implicit class SchemaGoogleFirestoreAdminV1beta1IndexOps[Self <: SchemaGoogleFirestoreAdminV1beta1Index] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldsVarargs(value: SchemaGoogleFirestoreAdminV1beta1IndexField*): Self = this.set("fields", js.Array(value :_*))
    @scala.inline
    def setFields(value: js.Array[SchemaGoogleFirestoreAdminV1beta1IndexField]): Self = this.set("fields", value.asInstanceOf[js.Any])
    @scala.inline
