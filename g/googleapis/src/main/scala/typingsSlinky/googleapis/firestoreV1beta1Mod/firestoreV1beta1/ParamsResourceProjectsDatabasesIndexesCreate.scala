...
object ParamsResourceProjectsDatabasesIndexesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesIndexesCreateOps[Self <: ParamsResourceProjectsDatabasesIndexesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleFirestoreAdminV1beta1Index): Self = this.set("requestBody", value.asInstanceOf[js.Any])
