...
object ParamsResourceProjectsDatabasesIndexesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsDatabasesIndexesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDatabasesIndexesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesIndexesCreateMutableBuilder[Self <: ParamsResourceProjectsDatabasesIndexesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleFirestoreAdminV1beta1Index): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
