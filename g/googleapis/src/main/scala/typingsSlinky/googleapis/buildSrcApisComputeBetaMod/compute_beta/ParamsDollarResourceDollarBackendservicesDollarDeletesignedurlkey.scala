...
@js.native
trait ParamsDollarResourceDollarBackendservicesDollarDeletesignedurlkey extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarBackendservicesDollarDeletesignedurlkey {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarBackendservicesDollarDeletesignedurlkey = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarBackendservicesDollarDeletesignedurlkey]
  }
}
