...
@js.native
trait Schema$InstanceGroupManagersResizeAdvancedRequest extends js.Object {
  /**
...
object Schema$InstanceGroupManagersResizeAdvancedRequest {
  @scala.inline
  def apply(noCreationRetries: js.UndefOr[Boolean] = js.undefined, targetSize: Int | Double = null): Schema$InstanceGroupManagersResizeAdvancedRequest = {
    ...
    __obj.asInstanceOf[Schema$InstanceGroupManagersResizeAdvancedRequest]
  }
}
