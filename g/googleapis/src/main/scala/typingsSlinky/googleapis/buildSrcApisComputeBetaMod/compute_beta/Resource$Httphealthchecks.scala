...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Httphealthchecks")
@js.native
class Resource$Httphealthchecks protected () extends js.Object {
  ...
  /**
    ...
    *   };
    *
    *   compute.httpHealthChecks.testIamPermissions(request, function(err,
