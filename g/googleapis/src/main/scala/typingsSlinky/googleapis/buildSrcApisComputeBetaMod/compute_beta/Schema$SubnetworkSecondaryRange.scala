...
/**
  ...
  */
@js.native
trait Schema$SubnetworkSecondaryRange extends js.Object {
  /**
...
object Schema$SubnetworkSecondaryRange {
  @scala.inline
  def apply(ipCidrRange: String = null, rangeName: String = null): Schema$SubnetworkSecondaryRange = {
    ...
    __obj.asInstanceOf[Schema$SubnetworkSecondaryRange]
  }
}
