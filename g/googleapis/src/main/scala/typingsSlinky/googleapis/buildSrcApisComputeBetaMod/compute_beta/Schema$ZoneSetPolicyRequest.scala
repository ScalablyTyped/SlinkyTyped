...
@js.native
trait Schema$ZoneSetPolicyRequest extends js.Object {
  /**
...
object Schema$ZoneSetPolicyRequest {
  @scala.inline
  def apply(bindings: js.Array[Schema$Binding] = null, etag: String = null, policy: Schema$Policy = null): Schema$ZoneSetPolicyRequest = {
    val __obj = js.Dynamic.literal()
    if (bindings != null) __obj.updateDynamic("bindings")(bindings.asInstanceOf[js.Any])
    if (etag != null) __obj.updateDynamic("etag")(etag.asInstanceOf[js.Any])
    if (policy != null) __obj.updateDynamic("policy")(policy.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ZoneSetPolicyRequest]
  }
}
