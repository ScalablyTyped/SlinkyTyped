...
@js.native
trait Schema$InstanceGroupManagersSetTargetPoolsRequest extends js.Object {
  /**
...
object Schema$InstanceGroupManagersSetTargetPoolsRequest {
  @scala.inline
  def apply(fingerprint: String = null, targetPools: js.Array[String] = null): Schema$InstanceGroupManagersSetTargetPoolsRequest = {
    val __obj = js.Dynamic.literal()
    if (fingerprint != null) __obj.updateDynamic("fingerprint")(fingerprint.asInstanceOf[js.Any])
    if (targetPools != null) __obj.updateDynamic("targetPools")(targetPools.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$InstanceGroupManagersSetTargetPoolsRequest]
  }
}
