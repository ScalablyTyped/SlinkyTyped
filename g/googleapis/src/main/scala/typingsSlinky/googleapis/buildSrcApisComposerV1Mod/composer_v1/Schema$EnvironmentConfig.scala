package typingsSlinky.googleapis.buildSrcApisComposerV1Mod.composer_v1
...
/**
  ...
  */
@js.native
trait Schema$EnvironmentConfig extends js.Object {
  /**
...
object Schema$EnvironmentConfig {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$EnvironmentConfig]
  }
}
