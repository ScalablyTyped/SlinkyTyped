...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingAnnotation extends js.Object {
  /**
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingFrame]] = js.native
  /**
...
object Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingAnnotation {
  @scala.inline
  def apply(
    confidence: Int | Double = null,
    entity: Schema$GoogleCloudVideointelligenceV1p3beta1_Entity = null,
    frames: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingFrame] = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingAnnotation]
  }
}
