...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_WordInfo extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1beta2_WordInfo {
  @scala.inline
  def apply(
    ...
    word: String = null
  ): Schema$GoogleCloudVideointelligenceV1beta2_WordInfo = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_WordInfo]
  }
}
