...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_SpeechContext extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1beta2_SpeechContext {
  @scala.inline
  def apply(phrases: js.Array[String] = null): Schema$GoogleCloudVideointelligenceV1beta2_SpeechContext = {
    val __obj = js.Dynamic.literal()
    if (phrases != null) __obj.updateDynamic("phrases")(phrases.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_SpeechContext]
  }
}
