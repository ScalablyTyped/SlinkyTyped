...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p2beta1_WordInfo extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1p2beta1_WordInfo {
  @scala.inline
  def apply(
    ...
    word: String = null
  ): Schema$GoogleCloudVideointelligenceV1p2beta1_WordInfo = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p2beta1_WordInfo]
  }
}
