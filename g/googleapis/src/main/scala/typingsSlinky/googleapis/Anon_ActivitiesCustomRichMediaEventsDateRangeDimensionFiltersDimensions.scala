...
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot3Mod.dfareporting_v3_3.Schema$Activities
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot3Mod.dfareporting_v3_3.Schema$CustomRichMediaEvents
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot3Mod.dfareporting_v3_3.Schema$DateRange
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot3Mod.dfareporting_v3_3.Schema$DimensionValue
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot3Mod.dfareporting_v3_3.Schema$SortedDimension
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions extends js.Object {
...
object Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions {
  @scala.inline
  def apply(
  ...
  ): Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions = {
    ...
    __obj.asInstanceOf[Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions]
  }
}
