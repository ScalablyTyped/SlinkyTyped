...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesGroupsDevicesListMutableBuilder[Self <: ParamsResourceProjectsLocationsRegistriesGroupsDevicesList] (val x: Self) extends AnyVal {
