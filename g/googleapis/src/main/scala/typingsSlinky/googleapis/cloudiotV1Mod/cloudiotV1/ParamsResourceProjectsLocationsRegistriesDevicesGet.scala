...
object ParamsResourceProjectsLocationsRegistriesDevicesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesDevicesGetOps[Self <: ParamsResourceProjectsLocationsRegistriesDevicesGet] (val x: Self) extends AnyVal {
