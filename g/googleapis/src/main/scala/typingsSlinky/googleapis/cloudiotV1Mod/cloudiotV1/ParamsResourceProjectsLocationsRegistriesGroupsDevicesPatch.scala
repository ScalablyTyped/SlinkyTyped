...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesGroupsDevicesPatchOps[Self <: ParamsResourceProjectsLocationsRegistriesGroupsDevicesPatch] (val x: Self) extends AnyVal {
    @scala.inline
