...
object ParamsResourceProjectsLocationsRegistriesUnbinddevicefromgateway {
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsRegistriesUnbinddevicefromgateway = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRegistriesUnbinddevicefromgateway]
  }
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesUnbinddevicefromgatewayOps[Self <: ParamsResourceProjectsLocationsRegistriesUnbinddevicefromgateway] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaUnbindDeviceFromGatewayRequest): Self = {
        val ret = this.duplicate
