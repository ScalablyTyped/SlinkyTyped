...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesSendcommandtodevice {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesGroupsDevicesSendcommandtodeviceOps[Self <: ParamsResourceProjectsLocationsRegistriesGroupsDevicesSendcommandtodevice] (val x: Self) extends AnyVal {
    @scala.inline
