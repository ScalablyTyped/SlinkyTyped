...
import typingsSlinky.googleapis.Anon_CommitmentInterval
import typingsSlinky.googleapis.Anon_IsInTrial
import typingsSlinky.googleapis.Anon_MinimumTransferableSeats
...
trait Schema$Subscription extends js.Object {
  ...
  /**
    ...
    * the API concepts.
    */
  var plan: js.UndefOr[Anon_CommitmentInterval] = js.native
  /**
  ...
  /**
    ...
    */
  var renewalSettings: js.UndefOr[Schema$RenewalSettings] = js.native
  /**
  ...
  /**
    ...
    * in the plan.
    */
  var seats: js.UndefOr[Schema$Seats] = js.native
  /**
  ...
  /**
    ...
    */
  var transferInfo: js.UndefOr[Anon_MinimumTransferableSeats] = js.native
  /**
    ...
    */
  var trialSettings: js.UndefOr[Anon_IsInTrial] = js.native
}
...
object Schema$Subscription {
  ...
  def apply(
    ...
    kind: String = null,
    plan: Anon_CommitmentInterval = null,
    purchaseOrderId: String = null,
    renewalSettings: Schema$RenewalSettings = null,
    resourceUiUrl: String = null,
    seats: Schema$Seats = null,
    skuId: String = null,
    skuName: String = null,
    status: String = null,
    subscriptionId: String = null,
    suspensionReasons: js.Array[String] = null,
    transferInfo: Anon_MinimumTransferableSeats = null,
    trialSettings: Anon_IsInTrial = null
  ): Schema$Subscription = {
