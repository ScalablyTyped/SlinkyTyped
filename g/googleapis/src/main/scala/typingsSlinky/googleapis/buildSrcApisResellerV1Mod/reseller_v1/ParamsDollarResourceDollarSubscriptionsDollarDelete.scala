...
@js.native
trait ParamsDollarResourceDollarSubscriptionsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSubscriptionsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSubscriptionsDollarDelete = {
    val __obj = js.Dynamic.literal()
    if (alt != null) __obj.updateDynamic("alt")(alt.asInstanceOf[js.Any])
    if (auth != null) __obj.updateDynamic("auth")(auth.asInstanceOf[js.Any])
    if (customerId != null) __obj.updateDynamic("customerId")(customerId.asInstanceOf[js.Any])
    if (deletionType != null) __obj.updateDynamic("deletionType")(deletionType.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubscriptionsDollarDelete]
  }
}
