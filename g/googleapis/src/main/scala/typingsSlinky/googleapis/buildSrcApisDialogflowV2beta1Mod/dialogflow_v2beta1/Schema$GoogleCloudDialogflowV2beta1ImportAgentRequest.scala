...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1ImportAgentRequest extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1ImportAgentRequest {
  @scala.inline
  def apply(agentContent: String = null, agentUri: String = null): Schema$GoogleCloudDialogflowV2beta1ImportAgentRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1ImportAgentRequest]
  }
}
