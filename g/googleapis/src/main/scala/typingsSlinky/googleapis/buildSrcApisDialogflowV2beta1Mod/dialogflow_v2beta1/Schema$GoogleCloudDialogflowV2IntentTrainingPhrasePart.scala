...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2IntentTrainingPhrasePart extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2IntentTrainingPhrasePart {
  @scala.inline
  def apply(
    alias: String = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2IntentTrainingPhrasePart]
  }
}
