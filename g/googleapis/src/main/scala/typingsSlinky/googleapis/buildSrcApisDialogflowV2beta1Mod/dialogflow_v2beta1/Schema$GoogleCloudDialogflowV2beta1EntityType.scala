...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1EntityType extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1EntityType {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1EntityType]
  }
}
