...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2EntityTypeEntity extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2EntityTypeEntity {
  @scala.inline
  def apply(synonyms: js.Array[String] = null, value: String = null): Schema$GoogleCloudDialogflowV2EntityTypeEntity = {
    val __obj = js.Dynamic.literal()
    if (synonyms != null) __obj.updateDynamic("synonyms")(synonyms.asInstanceOf[js.Any])
    if (value != null) __obj.updateDynamic("value")(value.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2EntityTypeEntity]
  }
}
