...
@js.native
trait ParamsDollarResourceDollarProjectsDollarAgentDollarEnvironmentsDollarUsersDollarSessionsDollarEntitytypesDollarCreate extends StandardParameters {
  /**
