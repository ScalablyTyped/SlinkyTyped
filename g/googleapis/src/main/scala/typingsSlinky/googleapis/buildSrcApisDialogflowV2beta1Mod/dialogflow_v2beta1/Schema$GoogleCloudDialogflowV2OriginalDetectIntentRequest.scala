...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2OriginalDetectIntentRequest extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2OriginalDetectIntentRequest {
  @scala.inline
  def apply(payload: StringDictionary[js.Any] = null, source: String = null, version: String = null): Schema$GoogleCloudDialogflowV2OriginalDetectIntentRequest = {
    val __obj = js.Dynamic.literal()
    if (payload != null) __obj.updateDynamic("payload")(payload.asInstanceOf[js.Any])
    if (source != null) __obj.updateDynamic("source")(source.asInstanceOf[js.Any])
    if (version != null) __obj.updateDynamic("version")(version.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2OriginalDetectIntentRequest]
  }
}
