...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1OutputAudioConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var synthesizeSpeechConfig: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig] = js.native
}

object Schema$GoogleCloudDialogflowV2beta1OutputAudioConfig {
  @scala.inline
  def apply(
    audioEncoding: String = null,
    sampleRateHertz: Int | Double = null,
    synthesizeSpeechConfig: Schema$GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1OutputAudioConfig]
  }
}
