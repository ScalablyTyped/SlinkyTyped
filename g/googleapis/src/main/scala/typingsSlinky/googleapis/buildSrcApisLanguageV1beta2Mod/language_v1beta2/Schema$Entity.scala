package typingsSlinky.googleapis.buildSrcApisLanguageV1beta2Mod.language_v1beta2
...
trait Schema$Entity extends js.Object {
  /**
    ...
    */
  var mentions: js.UndefOr[js.Array[Schema$EntityMention]] = js.native
  /**
...
object Schema$Entity {
  @scala.inline
  def apply(
    mentions: js.Array[Schema$EntityMention] = null,
    metadata: StringDictionary[String] = null,
    name: String = null,
    salience: Int | Double = null,
    sentiment: Schema$Sentiment = null,
    `type`: String = null
  ): Schema$Entity = {
