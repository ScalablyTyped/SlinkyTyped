...
object ParamsResourceUsersEnvironmentsAuthorize {
  ...
  @scala.inline
  implicit class ParamsResourceUsersEnvironmentsAuthorizeMutableBuilder[Self <: ParamsResourceUsersEnvironmentsAuthorize] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAuthorizeEnvironmentRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
