...
@js.native
trait ParamsResourceAchievementconfigurationsInsert extends StandardParameters {
  /**
...
object ParamsResourceAchievementconfigurationsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceAchievementconfigurationsInsertOps[Self <: ParamsResourceAchievementconfigurationsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaAchievementConfiguration): Self = {
        val ret = this.duplicate
