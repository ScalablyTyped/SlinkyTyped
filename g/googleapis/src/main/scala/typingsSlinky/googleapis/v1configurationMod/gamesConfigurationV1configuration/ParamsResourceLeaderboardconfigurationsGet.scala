...
@js.native
trait ParamsResourceLeaderboardconfigurationsGet extends StandardParameters {
...
object ParamsResourceLeaderboardconfigurationsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceLeaderboardconfigurationsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLeaderboardconfigurationsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceLeaderboardconfigurationsGetMutableBuilder[Self <: ParamsResourceLeaderboardconfigurationsGet] (val x: Self) extends AnyVal {
