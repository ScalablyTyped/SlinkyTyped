...
@js.native
trait ParamsResourceAchievementconfigurationsDelete extends StandardParameters {
...
object ParamsResourceAchievementconfigurationsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceAchievementconfigurationsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAchievementconfigurationsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceAchievementconfigurationsDeleteMutableBuilder[Self <: ParamsResourceAchievementconfigurationsDelete] (val x: Self) extends AnyVal {
