...
object ParamsResourceAchievementconfigurationsList {
  ...
  @scala.inline
  def apply(): ParamsResourceAchievementconfigurationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAchievementconfigurationsList]
  }
  
  @scala.inline
  implicit class ParamsResourceAchievementconfigurationsListMutableBuilder[Self <: ParamsResourceAchievementconfigurationsList] (val x: Self) extends AnyVal {
