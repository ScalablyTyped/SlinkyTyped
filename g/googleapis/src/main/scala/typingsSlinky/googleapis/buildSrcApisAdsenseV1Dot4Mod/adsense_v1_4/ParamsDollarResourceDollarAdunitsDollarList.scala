...
@js.native
trait ParamsDollarResourceDollarAdunitsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAdunitsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAdunitsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAdunitsDollarList]
  }
}
