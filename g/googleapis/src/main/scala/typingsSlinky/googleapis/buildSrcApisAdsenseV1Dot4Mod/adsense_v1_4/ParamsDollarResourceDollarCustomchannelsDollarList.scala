...
@js.native
trait ParamsDollarResourceDollarCustomchannelsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCustomchannelsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCustomchannelsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCustomchannelsDollarList]
  }
}
