...
@js.native
class ResourceDollarAccountsDollarReportsDollarSaved protected () extends js.Object {
  ...
  def generate(params: ParamsDollarResourceDollarAccountsDollarReportsDollarSavedDollarGenerate): GaxiosPromise[Schema$AdsenseReportsGenerateResponse] = js.native
  def generate(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarSavedDollarGenerate,
  ...
  ): GaxiosPromise[Schema$AdsenseReportsGenerateResponse] = js.native
  def generate(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarSavedDollarGenerate,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$AdsenseReportsGenerateResponse]
  ...
  def list(params: ParamsDollarResourceDollarAccountsDollarReportsDollarSavedDollarList): GaxiosPromise[Schema$SavedReports] = js.native
  def list(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarSavedDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarSavedDollarList,
    options: MethodOptions
  ): GaxiosPromise[Schema$SavedReports] = js.native
  def list(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarSavedDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$SavedReports]
