...
@js.native
trait ParamsDollarResourceDollarAccountsDollarUrlchannelsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarUrlchannelsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarUrlchannelsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarUrlchannelsDollarList]
  }
}
