...
object ParamsDollarResourceDollarAlertsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAlertsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAlertsDollarList]
  }
}
