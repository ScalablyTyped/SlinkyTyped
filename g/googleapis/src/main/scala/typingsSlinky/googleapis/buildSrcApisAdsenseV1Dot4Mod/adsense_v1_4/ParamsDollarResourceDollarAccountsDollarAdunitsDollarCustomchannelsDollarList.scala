...
@js.native
trait ParamsDollarResourceDollarAccountsDollarAdunitsDollarCustomchannelsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarAdunitsDollarCustomchannelsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarAdunitsDollarCustomchannelsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarAdunitsDollarCustomchannelsDollarList]
  }
}
