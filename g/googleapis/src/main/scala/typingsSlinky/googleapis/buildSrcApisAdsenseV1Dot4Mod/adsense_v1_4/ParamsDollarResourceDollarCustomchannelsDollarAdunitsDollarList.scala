...
@js.native
trait ParamsDollarResourceDollarCustomchannelsDollarAdunitsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCustomchannelsDollarAdunitsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCustomchannelsDollarAdunitsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCustomchannelsDollarAdunitsDollarList]
  }
}
