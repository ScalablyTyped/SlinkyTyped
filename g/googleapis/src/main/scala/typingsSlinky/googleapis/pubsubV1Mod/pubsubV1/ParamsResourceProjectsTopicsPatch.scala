...
object ParamsResourceProjectsTopicsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsTopicsPatchOps[Self <: ParamsResourceProjectsTopicsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateTopicRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
