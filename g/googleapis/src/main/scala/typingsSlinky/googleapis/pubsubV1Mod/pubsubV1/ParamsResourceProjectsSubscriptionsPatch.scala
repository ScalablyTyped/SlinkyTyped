...
object ParamsResourceProjectsSubscriptionsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsSubscriptionsPatchOps[Self <: ParamsResourceProjectsSubscriptionsPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateSubscriptionRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
