...
class ResourceProjectsSubscriptions protected () extends js.Object {
  ...
  def patch(params: js.UndefOr[scala.Nothing], options: MethodOptions): GaxiosPromise[SchemaSubscription] = js.native
  ...
  def seek(params: js.UndefOr[scala.Nothing], options: MethodOptions): GaxiosPromise[SchemaSeekResponse] = js.native
