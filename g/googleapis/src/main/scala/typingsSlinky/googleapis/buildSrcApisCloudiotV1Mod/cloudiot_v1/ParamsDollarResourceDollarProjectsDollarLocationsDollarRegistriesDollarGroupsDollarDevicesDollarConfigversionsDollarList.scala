...
@js.native
trait ParamsDollarResourceDollarProjectsDollarLocationsDollarRegistriesDollarGroupsDollarDevicesDollarConfigversionsDollarList extends StandardParameters {
  /**
