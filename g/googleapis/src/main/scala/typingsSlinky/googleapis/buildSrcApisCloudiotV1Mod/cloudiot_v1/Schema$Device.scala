...
trait Schema$Device extends js.Object {
  ...
  /**
    ...
    */
  var config: js.UndefOr[Schema$DeviceConfig] = js.native
  /**
    ...
    */
  var credentials: js.UndefOr[js.Array[Schema$DeviceCredential]] = js.native
  /**
    * Gateway-related configuration and state.
    */
  var gatewayConfig: js.UndefOr[Schema$GatewayConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var lastErrorStatus: js.UndefOr[Schema$Status] = js.native
  /**
  ...
  /**
    ...
    */
  var state: js.UndefOr[Schema$DeviceState] = js.native
}
...
object Schema$Device {
  ...
  def apply(
    ...
    config: Schema$DeviceConfig = null,
    credentials: js.Array[Schema$DeviceCredential] = null,
    gatewayConfig: Schema$GatewayConfig = null,
    id: String = null,
    lastConfigAckTime: String = null,
    lastConfigSendTime: String = null,
    lastErrorStatus: Schema$Status = null,
