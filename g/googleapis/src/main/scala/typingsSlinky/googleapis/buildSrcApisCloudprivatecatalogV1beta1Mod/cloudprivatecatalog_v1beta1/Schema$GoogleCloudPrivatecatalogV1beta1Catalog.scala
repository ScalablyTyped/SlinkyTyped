...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudPrivatecatalogV1beta1Catalog extends js.Object {
  /**
...
object Schema$GoogleCloudPrivatecatalogV1beta1Catalog {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudPrivatecatalogV1beta1Catalog = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudPrivatecatalogV1beta1Catalog]
  }
}
