...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudPrivatecatalogV1beta1Version extends js.Object {
  /**
...
object Schema$GoogleCloudPrivatecatalogV1beta1Version {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudPrivatecatalogV1beta1Version = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudPrivatecatalogV1beta1Version]
  }
}
