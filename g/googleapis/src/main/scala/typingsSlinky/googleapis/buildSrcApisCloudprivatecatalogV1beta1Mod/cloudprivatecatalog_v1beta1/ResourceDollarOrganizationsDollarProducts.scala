...
@js.native
class ResourceDollarOrganizationsDollarProducts protected () extends js.Object {
  ...
  def search(params: ParamsDollarResourceDollarOrganizationsDollarProductsDollarSearch): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchProductsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarOrganizationsDollarProductsDollarSearch,
  ...
  def search(params: ParamsDollarResourceDollarOrganizationsDollarProductsDollarSearch, options: MethodOptions): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchProductsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarOrganizationsDollarProductsDollarSearch,
