...
@js.native
class ResourceDollarOrganizationsDollarCatalogs protected () extends js.Object {
  ...
  def search(params: ParamsDollarResourceDollarOrganizationsDollarCatalogsDollarSearch): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchCatalogsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarOrganizationsDollarCatalogsDollarSearch,
  ...
  def search(params: ParamsDollarResourceDollarOrganizationsDollarCatalogsDollarSearch, options: MethodOptions): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchCatalogsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarOrganizationsDollarCatalogsDollarSearch,
