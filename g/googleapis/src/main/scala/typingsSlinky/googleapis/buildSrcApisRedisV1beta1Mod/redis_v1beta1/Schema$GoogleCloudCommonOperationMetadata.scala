...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudCommonOperationMetadata extends js.Object {
  /**
...
object Schema$GoogleCloudCommonOperationMetadata {
  @scala.inline
  def apply(
    ...
    target: String = null,
    verb: String = null
  ): Schema$GoogleCloudCommonOperationMetadata = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudCommonOperationMetadata]
  }
}
