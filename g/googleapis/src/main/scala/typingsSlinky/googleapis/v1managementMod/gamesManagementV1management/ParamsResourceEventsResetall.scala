...
@js.native
trait ParamsResourceEventsResetall extends StandardParameters {
...
object ParamsResourceEventsResetall {
  ...
  @scala.inline
  implicit class ParamsResourceEventsResetallOps[Self <: ParamsResourceEventsResetall] (val x: Self) extends AnyVal {
