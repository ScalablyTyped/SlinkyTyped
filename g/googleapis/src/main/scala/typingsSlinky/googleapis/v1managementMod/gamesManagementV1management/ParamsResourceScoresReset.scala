...
@js.native
trait ParamsResourceScoresReset extends StandardParameters {
...
object ParamsResourceScoresReset {
  ...
  @scala.inline
  implicit class ParamsResourceScoresResetOps[Self <: ParamsResourceScoresReset] (val x: Self) extends AnyVal {
