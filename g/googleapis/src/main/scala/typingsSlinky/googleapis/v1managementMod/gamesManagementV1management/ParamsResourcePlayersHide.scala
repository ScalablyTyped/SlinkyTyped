...
@js.native
trait ParamsResourcePlayersHide extends StandardParameters {
...
object ParamsResourcePlayersHide {
  ...
  @scala.inline
  def apply(): ParamsResourcePlayersHide = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlayersHide]
  }
  
  @scala.inline
  implicit class ParamsResourcePlayersHideMutableBuilder[Self <: ParamsResourcePlayersHide] (val x: Self) extends AnyVal {
