...
@js.native
trait ParamsResourceTurnbasedmatchesResetforallplayers extends StandardParameters {
  /**
...
object ParamsResourceTurnbasedmatchesResetforallplayers {
  ...
  @scala.inline
  implicit class ParamsResourceTurnbasedmatchesResetforallplayersOps[Self <: ParamsResourceTurnbasedmatchesResetforallplayers] (val x: Self) extends AnyVal {
    @scala.inline
