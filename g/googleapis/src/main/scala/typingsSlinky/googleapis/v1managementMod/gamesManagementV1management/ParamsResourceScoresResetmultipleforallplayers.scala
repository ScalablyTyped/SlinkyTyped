...
object ParamsResourceScoresResetmultipleforallplayers {
  ...
  @scala.inline
  implicit class ParamsResourceScoresResetmultipleforallplayersOps[Self <: ParamsResourceScoresResetmultipleforallplayers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaScoresResetMultipleForAllRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
