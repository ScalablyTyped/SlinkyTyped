...
object ParamsResourceQuestsResetmultipleforallplayers {
  ...
  @scala.inline
  implicit class ParamsResourceQuestsResetmultipleforallplayersOps[Self <: ParamsResourceQuestsResetmultipleforallplayers] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaQuestsResetMultipleForAllRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
