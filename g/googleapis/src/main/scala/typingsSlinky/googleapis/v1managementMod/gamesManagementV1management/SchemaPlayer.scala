...
import typingsSlinky.googleapis.anon.FamilyName
...
object SchemaPlayer {
  ...
  implicit class SchemaPlayerOps[Self <: SchemaPlayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExperienceInfo(value: SchemaGamesPlayerExperienceInfoResource): Self = this.set("experienceInfo", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastPlayedWith(value: SchemaGamesPlayedResource): Self = this.set("lastPlayedWith", value.asInstanceOf[js.Any])
    @scala.inline
