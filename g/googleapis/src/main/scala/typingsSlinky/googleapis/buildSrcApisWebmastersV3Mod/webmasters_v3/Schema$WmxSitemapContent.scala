...
/**
  ...
  */
@js.native
trait Schema$WmxSitemapContent extends js.Object {
  /**
...
object Schema$WmxSitemapContent {
  @scala.inline
  def apply(indexed: String = null, submitted: String = null, `type`: String = null): Schema$WmxSitemapContent = {
    ...
    __obj.asInstanceOf[Schema$WmxSitemapContent]
  }
}
