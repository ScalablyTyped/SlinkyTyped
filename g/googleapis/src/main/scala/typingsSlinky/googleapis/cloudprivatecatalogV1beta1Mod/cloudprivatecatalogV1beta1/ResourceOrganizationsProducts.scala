...
@JSImport("googleapis/build/src/apis/cloudprivatecatalog/v1beta1", "cloudprivatecatalog_v1beta1.Resource$Organizations$Products")
@js.native
class ResourceOrganizationsProducts protected () extends js.Object {
  ...
  def search(params: ParamsResourceOrganizationsProductsSearch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPrivatecatalogV1beta1SearchProductsResponse] = js.native
  def search(
    params: ParamsResourceOrganizationsProductsSearch,
