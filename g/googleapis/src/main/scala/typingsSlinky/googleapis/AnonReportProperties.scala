...
@js.native
trait AnonReportProperties extends js.Object {
...
object AnonReportProperties {
  @scala.inline
  def apply(): AnonReportProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonReportProperties]
  }
  @scala.inline
  implicit class AnonReportPropertiesOps[Self <: AnonReportProperties] (val x: Self) extends AnyVal {
    @scala.inline
