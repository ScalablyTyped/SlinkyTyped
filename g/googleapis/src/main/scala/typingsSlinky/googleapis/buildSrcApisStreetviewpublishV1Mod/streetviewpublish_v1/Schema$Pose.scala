...
/**
  ...
  */
@js.native
trait Schema$Pose extends js.Object {
  /**
  ...
  /**
    ...
    * process to fail.
    */
  var latLngPair: js.UndefOr[Schema$LatLng] = js.native
  /**
    * Level (the floor in a building) used to configure vertical navigation.
    */
  var level: js.UndefOr[Schema$Level] = js.native
  /**
...
object Schema$Pose {
  ...
  def apply(
    ...
    latLngPair: Schema$LatLng = null,
    level: Schema$Level = null,
    ...
    __obj.asInstanceOf[Schema$Pose]
  }
}
