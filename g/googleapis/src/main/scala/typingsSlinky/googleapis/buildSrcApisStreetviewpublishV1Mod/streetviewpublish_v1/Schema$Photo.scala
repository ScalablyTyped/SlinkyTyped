package typingsSlinky.googleapis.buildSrcApisStreetviewpublishV1Mod.streetviewpublish_v1
...
trait Schema$Photo extends js.Object {
  ...
  /**
    ...
    */
  var photoId: js.UndefOr[Schema$PhotoId] = js.native
  /**
    * Places where this photo belongs.
    */
  var places: js.UndefOr[js.Array[Schema$Place]] = js.native
  /**
    * Pose of the photo.
    */
  var pose: js.UndefOr[Schema$Pose] = js.native
  /**
  ...
  /**
    ...
    */
  var uploadReference: js.UndefOr[Schema$UploadRef] = js.native
  /**
...
object Schema$Photo {
  ...
  def apply(
    ...
    connections: js.Array[Schema$Connection] = null,
    downloadUrl: String = null,
    mapsPublishStatus: String = null,
    photoId: Schema$PhotoId = null,
    places: js.Array[Schema$Place] = null,
    pose: Schema$Pose = null,
    shareLink: String = null,
    thumbnailUrl: String = null,
    transferStatus: String = null,
    uploadReference: Schema$UploadRef = null,
