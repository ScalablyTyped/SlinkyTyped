...
@js.native
trait ParamsResourceV1Batchgetassetshistory extends StandardParameters {
...
object ParamsResourceV1Batchgetassetshistory {
  ...
  @scala.inline
  def apply(): ParamsResourceV1Batchgetassetshistory = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceV1Batchgetassetshistory]
  }
  
  @scala.inline
  implicit class ParamsResourceV1BatchgetassetshistoryMutableBuilder[Self <: ParamsResourceV1Batchgetassetshistory] (val x: Self) extends AnyVal {
