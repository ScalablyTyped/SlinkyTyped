...
/**
  ...
  */
@js.native
trait Schema$ExplicitBuckets extends js.Object {
  /**
...
object Schema$ExplicitBuckets {
  @scala.inline
  def apply(bounds: js.Array[Double] = null): Schema$ExplicitBuckets = {
    val __obj = js.Dynamic.literal()
    if (bounds != null) __obj.updateDynamic("bounds")(bounds.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ExplicitBuckets]
  }
}
