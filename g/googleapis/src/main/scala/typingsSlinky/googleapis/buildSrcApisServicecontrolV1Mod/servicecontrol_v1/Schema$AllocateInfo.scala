...
@js.native
trait Schema$AllocateInfo extends js.Object {
  /**
...
object Schema$AllocateInfo {
  @scala.inline
  def apply(unusedArguments: js.Array[String] = null): Schema$AllocateInfo = {
    val __obj = js.Dynamic.literal()
    if (unusedArguments != null) __obj.updateDynamic("unusedArguments")(unusedArguments.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$AllocateInfo]
  }
}
