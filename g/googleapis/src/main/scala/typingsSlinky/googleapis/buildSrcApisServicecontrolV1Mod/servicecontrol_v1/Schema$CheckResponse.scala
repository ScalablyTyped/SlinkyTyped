package typingsSlinky.googleapis.buildSrcApisServicecontrolV1Mod.servicecontrol_v1
...
/**
  ...
  */
@js.native
trait Schema$CheckResponse extends js.Object {
  /**
    ...
    */
  var checkErrors: js.UndefOr[js.Array[Schema$CheckError]] = js.native
  /**
    * Feedback data returned from the server during processing a Check request.
    */
  var checkInfo: js.UndefOr[Schema$CheckInfo] = js.native
  /**
...
object Schema$CheckResponse {
  @scala.inline
  def apply(
    checkErrors: js.Array[Schema$CheckError] = null,
    checkInfo: Schema$CheckInfo = null,
    operationId: String = null,
    quotaInfo: Schema$QuotaInfo = null,
    ...
    __obj.asInstanceOf[Schema$CheckResponse]
  }
}
