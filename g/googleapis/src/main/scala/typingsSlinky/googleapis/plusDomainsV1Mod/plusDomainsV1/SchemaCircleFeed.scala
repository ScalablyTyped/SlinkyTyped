...
object SchemaCircleFeed {
  ...
  implicit class SchemaCircleFeedOps[Self <: SchemaCircleFeed] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaCircle*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaCircle]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
