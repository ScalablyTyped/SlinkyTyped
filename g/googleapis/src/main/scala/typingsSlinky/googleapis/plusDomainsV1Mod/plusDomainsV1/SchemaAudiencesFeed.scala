...
object SchemaAudiencesFeed {
  ...
  @scala.inline
  implicit class SchemaAudiencesFeedOps[Self <: SchemaAudiencesFeed] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaAudience*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaAudience]): Self = this.set("items", value.asInstanceOf[js.Any])
