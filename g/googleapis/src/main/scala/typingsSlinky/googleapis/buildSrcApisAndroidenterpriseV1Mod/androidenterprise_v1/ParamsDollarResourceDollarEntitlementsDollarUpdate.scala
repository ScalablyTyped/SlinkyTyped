...
@js.native
trait ParamsDollarResourceDollarEntitlementsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEntitlementsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarEntitlementsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEntitlementsDollarUpdate]
  }
}
