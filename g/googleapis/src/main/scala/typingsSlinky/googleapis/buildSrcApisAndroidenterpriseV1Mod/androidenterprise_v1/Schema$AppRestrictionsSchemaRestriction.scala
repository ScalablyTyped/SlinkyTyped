...
/**
  ...
  */
@js.native
trait Schema$AppRestrictionsSchemaRestriction extends js.Object {
  /**
    * The default value of the restriction. bundle and bundleArray restrictions
    * never have a default value.
    */
  var defaultValue: js.UndefOr[Schema$AppRestrictionsSchemaRestrictionRestrictionValue] = js.native
  /**
  ...
  /**
    ...
    */
  var nestedRestriction: js.UndefOr[js.Array[Schema$AppRestrictionsSchemaRestriction]] = js.native
  /**
...
object Schema$AppRestrictionsSchemaRestriction {
  @scala.inline
  def apply(
    defaultValue: Schema$AppRestrictionsSchemaRestrictionRestrictionValue = null,
    description: String = null,
    entry: js.Array[String] = null,
    entryValue: js.Array[String] = null,
    key: String = null,
    nestedRestriction: js.Array[Schema$AppRestrictionsSchemaRestriction] = null,
    restrictionType: String = null,
    title: String = null
  ): Schema$AppRestrictionsSchemaRestriction = {
    ...
    __obj.asInstanceOf[Schema$AppRestrictionsSchemaRestriction]
  }
}
