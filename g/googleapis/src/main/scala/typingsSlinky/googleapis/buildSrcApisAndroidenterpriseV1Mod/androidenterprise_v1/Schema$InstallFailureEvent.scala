...
/**
  ...
  */
@js.native
trait Schema$InstallFailureEvent extends js.Object {
  /**
...
object Schema$InstallFailureEvent {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$InstallFailureEvent]
  }
}
