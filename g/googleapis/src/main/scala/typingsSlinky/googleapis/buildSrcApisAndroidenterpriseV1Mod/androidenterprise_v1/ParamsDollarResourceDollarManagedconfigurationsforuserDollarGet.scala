...
@js.native
trait ParamsDollarResourceDollarManagedconfigurationsforuserDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagedconfigurationsforuserDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarManagedconfigurationsforuserDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagedconfigurationsforuserDollarGet]
  }
}
