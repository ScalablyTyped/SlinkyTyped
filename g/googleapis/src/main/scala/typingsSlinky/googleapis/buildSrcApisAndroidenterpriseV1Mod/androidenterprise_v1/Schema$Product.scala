...
trait Schema$Product extends js.Object {
  /**
    ...
    */
  var appTracks: js.UndefOr[js.Array[Schema$TrackInfo]] = js.native
  /**
    * App versions currently available for this product.
    */
  var appVersion: js.UndefOr[js.Array[Schema$AppVersion]] = js.native
  /**
  ...
  /**
    ...
    */
  var permissions: js.UndefOr[js.Array[Schema$ProductPermission]] = js.native
  /**
  ...
  /**
    ...
    */
  var signingCertificate: js.UndefOr[Schema$ProductSigningCertificate] = js.native
  /**
...
object Schema$Product {
  @scala.inline
  def apply(
    appTracks: js.Array[Schema$TrackInfo] = null,
    appVersion: js.Array[Schema$AppVersion] = null,
    ...
    permissions: js.Array[Schema$ProductPermission] = null,
    ...
    signingCertificate: Schema$ProductSigningCertificate = null,
