...
@js.native
trait ParamsDollarResourceDollarProjectsDollarServiceaccountsDollarGenerateaccesstoken extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$GenerateAccessTokenRequest] = js.native
}
