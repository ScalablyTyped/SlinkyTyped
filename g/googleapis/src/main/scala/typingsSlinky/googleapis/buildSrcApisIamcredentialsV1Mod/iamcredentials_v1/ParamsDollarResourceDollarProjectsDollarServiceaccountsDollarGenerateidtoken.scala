...
@js.native
trait ParamsDollarResourceDollarProjectsDollarServiceaccountsDollarGenerateidtoken extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$GenerateIdTokenRequest] = js.native
}
