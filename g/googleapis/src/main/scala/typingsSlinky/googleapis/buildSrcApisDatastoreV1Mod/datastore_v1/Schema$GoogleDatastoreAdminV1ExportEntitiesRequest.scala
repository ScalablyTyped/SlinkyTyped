...
/**
  ...
  */
@js.native
trait Schema$GoogleDatastoreAdminV1ExportEntitiesRequest extends js.Object {
  /**
...
object Schema$GoogleDatastoreAdminV1ExportEntitiesRequest {
  @scala.inline
  def apply(
    entityFilter: Schema$GoogleDatastoreAdminV1EntityFilter = null,
    labels: StringDictionary[String] = null,
    outputUrlPrefix: String = null
  ): Schema$GoogleDatastoreAdminV1ExportEntitiesRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleDatastoreAdminV1ExportEntitiesRequest]
  }
}
