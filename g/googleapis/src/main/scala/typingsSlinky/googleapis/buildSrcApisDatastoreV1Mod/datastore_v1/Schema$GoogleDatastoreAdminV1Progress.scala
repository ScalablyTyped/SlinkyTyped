...
/**
  ...
  */
@js.native
trait Schema$GoogleDatastoreAdminV1Progress extends js.Object {
  /**
...
object Schema$GoogleDatastoreAdminV1Progress {
  @scala.inline
  def apply(workCompleted: String = null, workEstimated: String = null): Schema$GoogleDatastoreAdminV1Progress = {
    ...
    __obj.asInstanceOf[Schema$GoogleDatastoreAdminV1Progress]
  }
}
