...
/**
  ...
  */
@js.native
trait Schema$GoogleDatastoreAdminV1ImportEntitiesRequest extends js.Object {
  /**
...
object Schema$GoogleDatastoreAdminV1ImportEntitiesRequest {
  @scala.inline
  def apply(
    entityFilter: Schema$GoogleDatastoreAdminV1EntityFilter = null,
    inputUrl: String = null,
    labels: StringDictionary[String] = null
  ): Schema$GoogleDatastoreAdminV1ImportEntitiesRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleDatastoreAdminV1ImportEntitiesRequest]
  }
}
