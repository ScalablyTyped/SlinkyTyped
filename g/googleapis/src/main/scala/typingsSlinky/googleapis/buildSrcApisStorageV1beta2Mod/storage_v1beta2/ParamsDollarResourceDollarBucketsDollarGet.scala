...
@js.native
trait ParamsDollarResourceDollarBucketsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarBucketsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarBucketsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarBucketsDollarGet]
  }
}
