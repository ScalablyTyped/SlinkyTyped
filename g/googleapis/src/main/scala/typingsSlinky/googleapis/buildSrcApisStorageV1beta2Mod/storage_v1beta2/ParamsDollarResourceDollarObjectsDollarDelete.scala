...
@js.native
trait ParamsDollarResourceDollarObjectsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarObjectsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarObjectsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarObjectsDollarDelete]
  }
}
