...
@js.native
trait ParamsResourceServicesConsumersGetiampolicy extends StandardParameters {
...
object ParamsResourceServicesConsumersGetiampolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceServicesConsumersGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServicesConsumersGetiampolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceServicesConsumersGetiampolicyMutableBuilder[Self <: ParamsResourceServicesConsumersGetiampolicy] (val x: Self) extends AnyVal {
