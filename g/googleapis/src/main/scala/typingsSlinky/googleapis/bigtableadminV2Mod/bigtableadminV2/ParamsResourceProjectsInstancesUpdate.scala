...
object ParamsResourceProjectsInstancesUpdate {
  
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesUpdateMutableBuilder[Self <: ParamsResourceProjectsInstancesUpdate] (val x: Self) extends AnyVal {
