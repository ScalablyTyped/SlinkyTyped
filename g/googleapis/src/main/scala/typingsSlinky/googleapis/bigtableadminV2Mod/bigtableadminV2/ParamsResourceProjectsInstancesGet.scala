...
@js.native
trait ParamsResourceProjectsInstancesGet extends StandardParameters {
...
object ParamsResourceProjectsInstancesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesGetOps[Self <: ParamsResourceProjectsInstancesGet] (val x: Self) extends AnyVal {
