...
object ParamsResourceProjectsInstancesAppprofilesCreate {
  ...
  def apply(
    ...
    requestBody: SchemaAppProfile = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsInstancesAppprofilesCreate = {
    val __obj = js.Dynamic.literal()
    if ($Dotxgafv != null) __obj.updateDynamic("$.xgafv")($Dotxgafv.asInstanceOf[js.Any])
    if (access_token != null) __obj.updateDynamic("access_token")(access_token.asInstanceOf[js.Any])
    if (alt != null) __obj.updateDynamic("alt")(alt.asInstanceOf[js.Any])
    if (appProfileId != null) __obj.updateDynamic("appProfileId")(appProfileId.asInstanceOf[js.Any])
