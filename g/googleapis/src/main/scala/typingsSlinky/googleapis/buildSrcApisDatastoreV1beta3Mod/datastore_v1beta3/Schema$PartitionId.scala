...
/**
  ...
  */
@js.native
trait Schema$PartitionId extends js.Object {
  /**
...
object Schema$PartitionId {
  @scala.inline
  def apply(namespaceId: String = null, projectId: String = null): Schema$PartitionId = {
    val __obj = js.Dynamic.literal()
    if (namespaceId != null) __obj.updateDynamic("namespaceId")(namespaceId.asInstanceOf[js.Any])
    if (projectId != null) __obj.updateDynamic("projectId")(projectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$PartitionId]
  }
}
