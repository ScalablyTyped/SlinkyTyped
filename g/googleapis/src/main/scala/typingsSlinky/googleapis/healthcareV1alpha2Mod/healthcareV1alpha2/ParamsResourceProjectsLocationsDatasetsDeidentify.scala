...
object ParamsResourceProjectsLocationsDatasetsDeidentify {
  ...
  def apply(
    ...
    requestBody: SchemaDeidentifyDatasetRequest = null,
    sourceDataset: String = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsDatasetsDeidentify = {
    ...
    if (sourceDataset != null) __obj.updateDynamic("sourceDataset")(sourceDataset.asInstanceOf[js.Any])
