...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatchOps[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatch] (val x: Self) extends AnyVal {
    @scala.inline
