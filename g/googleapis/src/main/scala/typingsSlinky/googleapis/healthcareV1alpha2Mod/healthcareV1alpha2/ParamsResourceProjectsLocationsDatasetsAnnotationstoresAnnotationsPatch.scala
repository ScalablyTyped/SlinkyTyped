...
@js.native
trait ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatch extends StandardParameters {
...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatchMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsPatch] (val x: Self) extends AnyVal {
