...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudyOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudy] (val x: Self) extends AnyVal {
    @scala.inline
