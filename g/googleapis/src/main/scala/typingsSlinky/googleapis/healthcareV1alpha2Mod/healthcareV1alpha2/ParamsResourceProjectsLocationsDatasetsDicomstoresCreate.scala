...
object ParamsResourceProjectsLocationsDatasetsDicomstoresCreate {
  ...
  def apply(
    ...
    requestBody: SchemaDicomStore = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsDatasetsDicomstoresCreate = {
    ...
    if (dicomStoreId != null) __obj.updateDynamic("dicomStoreId")(dicomStoreId.asInstanceOf[js.Any])
