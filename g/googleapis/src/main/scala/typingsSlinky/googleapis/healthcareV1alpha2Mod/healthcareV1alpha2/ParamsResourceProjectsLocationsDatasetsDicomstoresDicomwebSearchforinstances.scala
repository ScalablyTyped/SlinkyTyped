...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstances {
  
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstances]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstancesMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstances] (val x: Self) extends AnyVal {
