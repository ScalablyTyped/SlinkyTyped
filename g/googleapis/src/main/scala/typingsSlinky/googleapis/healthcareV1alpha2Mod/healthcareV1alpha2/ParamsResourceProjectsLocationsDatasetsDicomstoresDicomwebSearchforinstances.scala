...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstances {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstancesOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebSearchforinstances] (val x: Self) extends AnyVal {
    @scala.inline
