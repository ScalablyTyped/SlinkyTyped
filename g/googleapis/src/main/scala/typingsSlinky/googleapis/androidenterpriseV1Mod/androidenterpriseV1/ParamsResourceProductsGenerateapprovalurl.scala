...
@js.native
trait ParamsResourceProductsGenerateapprovalurl extends StandardParameters {
...
object ParamsResourceProductsGenerateapprovalurl {
  ...
  @scala.inline
  def apply(): ParamsResourceProductsGenerateapprovalurl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProductsGenerateapprovalurl]
  }
  
  @scala.inline
  implicit class ParamsResourceProductsGenerateapprovalurlMutableBuilder[Self <: ParamsResourceProductsGenerateapprovalurl] (val x: Self) extends AnyVal {
