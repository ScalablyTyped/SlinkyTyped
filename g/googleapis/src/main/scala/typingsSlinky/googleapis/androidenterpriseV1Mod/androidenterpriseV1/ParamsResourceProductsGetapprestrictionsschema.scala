...
@js.native
trait ParamsResourceProductsGetapprestrictionsschema extends StandardParameters {
...
object ParamsResourceProductsGetapprestrictionsschema {
  ...
  @scala.inline
  implicit class ParamsResourceProductsGetapprestrictionsschemaOps[Self <: ParamsResourceProductsGetapprestrictionsschema] (val x: Self) extends AnyVal {
