...
@js.native
trait ParamsResourceStorelayoutpagesPatch extends StandardParameters {
  /**
...
object ParamsResourceStorelayoutpagesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceStorelayoutpagesPatchOps[Self <: ParamsResourceStorelayoutpagesPatch] (val x: Self) extends AnyVal {
    @scala.inline
