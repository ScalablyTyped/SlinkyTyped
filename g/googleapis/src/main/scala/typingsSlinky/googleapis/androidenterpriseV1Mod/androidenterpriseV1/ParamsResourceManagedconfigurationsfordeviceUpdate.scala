...
object ParamsResourceManagedconfigurationsfordeviceUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceManagedconfigurationsfordeviceUpdateOps[Self <: ParamsResourceManagedconfigurationsfordeviceUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withoutManagedConfigurationForDeviceId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("managedConfigurationForDeviceId")(js.undefined)
        ret
    }
    @scala.inline
