...
object ParamsResourceStorelayoutpagesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceStorelayoutpagesUpdateOps[Self <: ParamsResourceStorelayoutpagesUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaStorePage): Self = this.set("requestBody", value.asInstanceOf[js.Any])
