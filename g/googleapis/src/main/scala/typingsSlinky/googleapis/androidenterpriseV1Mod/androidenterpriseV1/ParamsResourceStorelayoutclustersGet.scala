...
object ParamsResourceStorelayoutclustersGet {
  ...
  @scala.inline
  def apply(): ParamsResourceStorelayoutclustersGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStorelayoutclustersGet]
  }
  
  @scala.inline
  implicit class ParamsResourceStorelayoutclustersGetMutableBuilder[Self <: ParamsResourceStorelayoutclustersGet] (val x: Self) extends AnyVal {
