...
@js.native
trait ParamsResourceStorelayoutpagesList extends StandardParameters {
...
object ParamsResourceStorelayoutpagesList {
  ...
  @scala.inline
  def apply(): ParamsResourceStorelayoutpagesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStorelayoutpagesList]
  }
  
  @scala.inline
  implicit class ParamsResourceStorelayoutpagesListMutableBuilder[Self <: ParamsResourceStorelayoutpagesList] (val x: Self) extends AnyVal {
