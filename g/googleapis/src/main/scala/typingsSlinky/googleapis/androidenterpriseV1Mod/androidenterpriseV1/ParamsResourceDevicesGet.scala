...
@js.native
trait ParamsResourceDevicesGet extends StandardParameters {
...
object ParamsResourceDevicesGet {
  ...
  @scala.inline
  def apply(): ParamsResourceDevicesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDevicesGet]
  }
  
  @scala.inline
  implicit class ParamsResourceDevicesGetMutableBuilder[Self <: ParamsResourceDevicesGet] (val x: Self) extends AnyVal {
