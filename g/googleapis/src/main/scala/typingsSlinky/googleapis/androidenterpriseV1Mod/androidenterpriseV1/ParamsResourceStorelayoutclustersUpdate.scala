...
object ParamsResourceStorelayoutclustersUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceStorelayoutclustersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStorelayoutclustersUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceStorelayoutclustersUpdateMutableBuilder[Self <: ParamsResourceStorelayoutclustersUpdate] (val x: Self) extends AnyVal {
