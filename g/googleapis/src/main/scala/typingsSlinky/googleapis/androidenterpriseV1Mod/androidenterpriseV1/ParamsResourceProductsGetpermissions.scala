...
object ParamsResourceProductsGetpermissions {
  ...
  @scala.inline
  def apply(): ParamsResourceProductsGetpermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProductsGetpermissions]
  }
  
  @scala.inline
  implicit class ParamsResourceProductsGetpermissionsMutableBuilder[Self <: ParamsResourceProductsGetpermissions] (val x: Self) extends AnyVal {
