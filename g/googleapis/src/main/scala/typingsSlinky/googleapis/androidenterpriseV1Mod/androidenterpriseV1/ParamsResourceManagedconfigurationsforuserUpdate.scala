...
object ParamsResourceManagedconfigurationsforuserUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceManagedconfigurationsforuserUpdateMutableBuilder[Self <: ParamsResourceManagedconfigurationsforuserUpdate] (val x: Self) extends AnyVal {
