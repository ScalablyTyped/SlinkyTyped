...
@js.native
trait ParamsResourceManagedconfigurationsforuserList extends StandardParameters {
...
object ParamsResourceManagedconfigurationsforuserList {
  ...
  @scala.inline
  def apply(): ParamsResourceManagedconfigurationsforuserList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagedconfigurationsforuserList]
  }
  
  @scala.inline
  implicit class ParamsResourceManagedconfigurationsforuserListMutableBuilder[Self <: ParamsResourceManagedconfigurationsforuserList] (val x: Self) extends AnyVal {
