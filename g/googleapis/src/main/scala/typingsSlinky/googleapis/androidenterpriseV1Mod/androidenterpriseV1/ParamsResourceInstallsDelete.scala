...
@js.native
trait ParamsResourceInstallsDelete extends StandardParameters {
  /**
...
object ParamsResourceInstallsDelete {
  @scala.inline
  def apply(): ParamsResourceInstallsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstallsDelete]
  }
  @scala.inline
  implicit class ParamsResourceInstallsDeleteOps[Self <: ParamsResourceInstallsDelete] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInstallId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("installId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutInstallId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("installId")(js.undefined)
        ret
    }
    @scala.inline
