...
object ParamsResourceEnterprisesSendtestpushnotification {
  ...
  @scala.inline
  def apply(): ParamsResourceEnterprisesSendtestpushnotification = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEnterprisesSendtestpushnotification]
  }
  
  @scala.inline
  implicit class ParamsResourceEnterprisesSendtestpushnotificationMutableBuilder[Self <: ParamsResourceEnterprisesSendtestpushnotification] (val x: Self) extends AnyVal {
