...
@js.native
trait ParamsResourceGrouplicensesList extends StandardParameters {
...
object ParamsResourceGrouplicensesList {
  ...
  @scala.inline
  def apply(): ParamsResourceGrouplicensesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceGrouplicensesList]
  }
  
  @scala.inline
  implicit class ParamsResourceGrouplicensesListMutableBuilder[Self <: ParamsResourceGrouplicensesList] (val x: Self) extends AnyVal {
