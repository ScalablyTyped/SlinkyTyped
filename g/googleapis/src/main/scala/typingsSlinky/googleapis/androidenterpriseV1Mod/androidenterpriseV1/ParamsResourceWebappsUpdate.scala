...
object ParamsResourceWebappsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceWebappsUpdateOps[Self <: ParamsResourceWebappsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaWebApp): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWebAppId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("webAppId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWebAppId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("webAppId")(js.undefined)
        ret
    }
  }
