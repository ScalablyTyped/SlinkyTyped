...
@js.native
trait ParamsResourceStorelayoutclustersList extends StandardParameters {
...
object ParamsResourceStorelayoutclustersList {
  ...
  @scala.inline
  implicit class ParamsResourceStorelayoutclustersListOps[Self <: ParamsResourceStorelayoutclustersList] (val x: Self) extends AnyVal {
