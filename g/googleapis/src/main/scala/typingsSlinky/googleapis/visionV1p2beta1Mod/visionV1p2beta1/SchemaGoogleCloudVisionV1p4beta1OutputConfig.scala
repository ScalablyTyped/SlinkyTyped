...
object SchemaGoogleCloudVisionV1p4beta1OutputConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1OutputConfigOps[Self <: SchemaGoogleCloudVisionV1p4beta1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: SchemaGoogleCloudVisionV1p4beta1GcsDestination): Self = this.set("gcsDestination", value.asInstanceOf[js.Any])
