...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse extends StObject {
...
object SchemaGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponseMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setOutputConfig(value: SchemaGoogleCloudVisionV1p3beta1OutputConfig): Self = StObject.set(x, "outputConfig", value.asInstanceOf[js.Any])
