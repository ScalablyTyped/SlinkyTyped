...
object SchemaGoogleCloudVisionV1p4beta1WebDetectionWebPage {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1WebDetectionWebPageOps[Self <: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebPage] (val x: Self) extends AnyVal {
    @scala.inline
