...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1GcsSource extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p1beta1GcsSource {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1GcsSourceOps[Self <: SchemaGoogleCloudVisionV1p1beta1GcsSource] (val x: Self) extends AnyVal {
    @scala.inline
