...
object SchemaGoogleCloudVisionV1p1beta1FaceAnnotationLandmark {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1FaceAnnotationLandmarkMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1FaceAnnotationLandmark] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setPosition(value: SchemaGoogleCloudVisionV1p1beta1Position): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
