...
object SchemaGoogleCloudVisionV1p1beta1ProductSearchResultsResult {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1ProductSearchResultsResultMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1ProductSearchResultsResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProduct(value: SchemaGoogleCloudVisionV1p1beta1Product): Self = StObject.set(x, "product", value.asInstanceOf[js.Any])
