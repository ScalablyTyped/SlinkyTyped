...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1FaceAnnotation extends js.Object {
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[SchemaGoogleCloudVisionV1p1beta1BoundingPoly] = js.native
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p1beta1FaceAnnotationLandmark]] = js.native
...
object SchemaGoogleCloudVisionV1p1beta1FaceAnnotation {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p1beta1FaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1FaceAnnotation]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1FaceAnnotationOps[Self <: SchemaGoogleCloudVisionV1p1beta1FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: SchemaGoogleCloudVisionV1p1beta1BoundingPoly): Self = this.set("fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarksVarargs(value: SchemaGoogleCloudVisionV1p1beta1FaceAnnotationLandmark*): Self = this.set("landmarks", js.Array(value :_*))
    
    @scala.inline
    def setLandmarks(value: js.Array[SchemaGoogleCloudVisionV1p1beta1FaceAnnotationLandmark]): Self = this.set("landmarks", value.asInstanceOf[js.Any])
