...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1ImageAnnotationContext extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p3beta1ImageAnnotationContext {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1ImageAnnotationContextOps[Self <: SchemaGoogleCloudVisionV1p3beta1ImageAnnotationContext] (val x: Self) extends AnyVal {
    @scala.inline
