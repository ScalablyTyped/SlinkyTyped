...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1WebDetectionWebEntity extends StObject {
...
object SchemaGoogleCloudVisionV1p3beta1WebDetectionWebEntity {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1WebDetectionWebEntityMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebEntity] (val x: Self) extends AnyVal {
