...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1Vertex extends StObject {
...
object SchemaGoogleCloudVisionV1p3beta1Vertex {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1VertexMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1Vertex] (val x: Self) extends AnyVal {
