...
object SchemaGoogleCloudVisionV1p3beta1Paragraph {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1ParagraphOps[Self <: SchemaGoogleCloudVisionV1p3beta1Paragraph] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVisionV1p3beta1Word*): Self = this.set("words", js.Array(value :_*))
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Word]): Self = this.set("words", value.asInstanceOf[js.Any])
    @scala.inline
