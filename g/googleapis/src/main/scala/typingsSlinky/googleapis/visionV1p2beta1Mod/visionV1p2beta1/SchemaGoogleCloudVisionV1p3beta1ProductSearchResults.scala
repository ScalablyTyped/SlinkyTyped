...
object SchemaGoogleCloudVisionV1p3beta1ProductSearchResults {
  ...
  implicit class SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsOps[Self <: SchemaGoogleCloudVisionV1p3beta1ProductSearchResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProductGroupedResults(value: js.Array[SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withResults(value: js.Array[SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsResult]): Self = {
        val ret = this.duplicate
