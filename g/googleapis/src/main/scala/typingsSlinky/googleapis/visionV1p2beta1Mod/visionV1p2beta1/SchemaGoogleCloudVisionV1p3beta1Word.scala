...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1Word extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p3beta1Word {
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p3beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1Word]
  }
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1WordOps[Self <: SchemaGoogleCloudVisionV1p3beta1Word] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBoundingBox(value: SchemaGoogleCloudVisionV1p3beta1BoundingPoly): Self = {
    ...
    @scala.inline
    def withProperty(value: SchemaGoogleCloudVisionV1p3beta1TextAnnotationTextProperty): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSymbols(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Symbol]): Self = {
        val ret = this.duplicate
