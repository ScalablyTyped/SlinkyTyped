...
object SchemaGoogleCloudVisionV1p4beta1NormalizedVertex {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p4beta1NormalizedVertex = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p4beta1NormalizedVertex]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1NormalizedVertexMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1NormalizedVertex] (val x: Self) extends AnyVal {
