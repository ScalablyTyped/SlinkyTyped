...
object SchemaGoogleCloudVisionV1p2beta1Page {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1PageMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1Page] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBlocks(value: js.Array[SchemaGoogleCloudVisionV1p2beta1Block]): Self = StObject.set(x, "blocks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBlocksUndefined: Self = StObject.set(x, "blocks", js.undefined)
    
    @scala.inline
    def setBlocksVarargs(value: SchemaGoogleCloudVisionV1p2beta1Block*): Self = StObject.set(x, "blocks", js.Array(value :_*))
