...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1CropHintsParams extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p2beta1CropHintsParams {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1CropHintsParamsOps[Self <: SchemaGoogleCloudVisionV1p2beta1CropHintsParams] (val x: Self) extends AnyVal {
    @scala.inline
