package typingsSlinky.googleapis.buildSrcApisServicebrokerV1alpha1Mod.servicebroker_v1alpha1
...
class ResourceDollarProjectsDollarBrokersDollarV2DollarCatalog protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$GoogleCloudServicebrokerV1alpha1__ListCatalogResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1alpha1__ListCatalogResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarBrokersDollarV2DollarCatalogDollarList): GaxiosPromise[Schema$GoogleCloudServicebrokerV1alpha1__ListCatalogResponse] = js.native
  def list(
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarV2DollarCatalogDollarList,
    options: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1alpha1__ListCatalogResponse],
    callback: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1alpha1__ListCatalogResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarV2DollarCatalogDollarList,
    options: MethodOptions
  ): GaxiosPromise[Schema$GoogleCloudServicebrokerV1alpha1__ListCatalogResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarV2DollarCatalogDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1alpha1__ListCatalogResponse]
