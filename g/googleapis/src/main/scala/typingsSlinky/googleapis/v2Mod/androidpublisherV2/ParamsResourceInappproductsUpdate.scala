...
@js.native
trait ParamsResourceInappproductsUpdate extends StandardParameters {
...
object ParamsResourceInappproductsUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceInappproductsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInappproductsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceInappproductsUpdateMutableBuilder[Self <: ParamsResourceInappproductsUpdate] (val x: Self) extends AnyVal {
