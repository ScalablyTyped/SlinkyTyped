...
@js.native
trait ParamsResourceEditsTestersPatch extends StandardParameters {
...
object ParamsResourceEditsTestersPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceEditsTestersPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsTestersPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsTestersPatchMutableBuilder[Self <: ParamsResourceEditsTestersPatch] (val x: Self) extends AnyVal {
