...
@js.native
trait ParamsResourceEditsImagesDeleteall extends StandardParameters {
  /**
...
object ParamsResourceEditsImagesDeleteall {
  ...
  @scala.inline
  implicit class ParamsResourceEditsImagesDeleteallOps[Self <: ParamsResourceEditsImagesDeleteall] (val x: Self) extends AnyVal {
    @scala.inline
