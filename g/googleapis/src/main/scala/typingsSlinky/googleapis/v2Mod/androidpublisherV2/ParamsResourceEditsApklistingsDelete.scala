...
@js.native
trait ParamsResourceEditsApklistingsDelete extends StandardParameters {
...
object ParamsResourceEditsApklistingsDelete {
  
  @scala.inline
  def apply(): ParamsResourceEditsApklistingsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsApklistingsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsApklistingsDeleteMutableBuilder[Self <: ParamsResourceEditsApklistingsDelete] (val x: Self) extends AnyVal {
