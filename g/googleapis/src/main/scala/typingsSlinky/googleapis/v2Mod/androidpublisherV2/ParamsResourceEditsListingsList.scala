...
@js.native
trait ParamsResourceEditsListingsList extends StandardParameters {
  /**
...
object ParamsResourceEditsListingsList {
  ...
  @scala.inline
  implicit class ParamsResourceEditsListingsListOps[Self <: ParamsResourceEditsListingsList] (val x: Self) extends AnyVal {
    @scala.inline
