...
@js.native
trait ParamsResourceEditsApklistingsUpdate extends StandardParameters {
  /**
...
object ParamsResourceEditsApklistingsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceEditsApklistingsUpdateOps[Self <: ParamsResourceEditsApklistingsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
