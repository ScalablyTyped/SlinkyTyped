...
object ParamsResourceEditsImagesUpload {
  ...
  @scala.inline
  def apply(): ParamsResourceEditsImagesUpload = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsImagesUpload]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsImagesUploadMutableBuilder[Self <: ParamsResourceEditsImagesUpload] (val x: Self) extends AnyVal {
