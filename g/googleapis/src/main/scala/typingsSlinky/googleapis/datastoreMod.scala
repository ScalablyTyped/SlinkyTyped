...
import typingsSlinky.googleapis.datastoreV1Mod.datastoreV1.Options
...
object datastoreMod {
  ...
  object VERSIONS {
    ...
    def v1beta1: Instantiable2[
        ...
        typingsSlinky.googleapis.datastoreV1beta1Mod.datastoreV1beta1.Datastore
      ] = js.native
    @scala.inline
    def v1beta1_=(
      x: Instantiable2[
    ...
    def v1beta3: Instantiable2[
        /* options */ GlobalOptions, 
        /* google */ js.UndefOr[GoogleConfigurable], 
        typingsSlinky.googleapis.v1beta3Mod.datastoreV1beta3.Datastore
      ] = js.native
    @scala.inline
    def v1beta3_=(
      x: Instantiable2[
  ...
  object auth extends Shortcut {
    ...
    object DefaultTransporter {
      ...
      @JSImport("googleapis/build/src/apis/datastore", "auth.DefaultTransporter.constructor")
      @js.native
  ...
  @JSImport("googleapis/build/src/apis/datastore", "datastore")
  @js.native
