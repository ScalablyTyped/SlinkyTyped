...
object SchemaGoogleCloudVideointelligenceV1p2beta1LabelSegment {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1LabelSegmentOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1LabelSegment] (val x: Self) extends AnyVal {
