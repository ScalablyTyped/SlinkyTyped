...
object SchemaGoogleCloudVideointelligenceV1SpeechRecognitionAlternative {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1SpeechRecognitionAlternativeOps[Self <: SchemaGoogleCloudVideointelligenceV1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVideointelligenceV1WordInfo*): Self = this.set("words", js.Array(value :_*))
    
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVideointelligenceV1WordInfo]): Self = this.set("words", value.asInstanceOf[js.Any])
