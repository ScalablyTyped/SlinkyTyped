...
object SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame {
  @scala.inline
  def apply(
    normalizedBoundingBox: SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox = null,
    timeOffset: String = null
  ): SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame = {
