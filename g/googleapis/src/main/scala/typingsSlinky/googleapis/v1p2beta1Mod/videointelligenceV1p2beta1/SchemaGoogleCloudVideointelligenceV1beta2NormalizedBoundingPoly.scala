...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1beta2NormalizedBoundingPoly extends js.Object {
...
object SchemaGoogleCloudVideointelligenceV1beta2NormalizedBoundingPoly {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1beta2NormalizedBoundingPolyOps[Self <: SchemaGoogleCloudVideointelligenceV1beta2NormalizedBoundingPoly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVerticesVarargs(value: SchemaGoogleCloudVideointelligenceV1beta2NormalizedVertex*): Self = this.set("vertices", js.Array(value :_*))
    
    @scala.inline
    def setVertices(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2NormalizedVertex]): Self = this.set("vertices", value.asInstanceOf[js.Any])
