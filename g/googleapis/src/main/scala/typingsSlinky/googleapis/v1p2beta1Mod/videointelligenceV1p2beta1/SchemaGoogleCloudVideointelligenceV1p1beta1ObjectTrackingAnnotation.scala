...
object SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation {
  ...
  def apply(
    ...
    frames: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame] = null,
    segment: SchemaGoogleCloudVideointelligenceV1p1beta1VideoSegment = null,
    trackId: String = null
  ): SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation = {
