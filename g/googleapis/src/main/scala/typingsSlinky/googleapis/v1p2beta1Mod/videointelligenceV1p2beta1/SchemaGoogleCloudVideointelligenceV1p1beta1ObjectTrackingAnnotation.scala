...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation extends StObject {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame]] = js.native
...
object SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotationMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    @scala.inline
    def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
