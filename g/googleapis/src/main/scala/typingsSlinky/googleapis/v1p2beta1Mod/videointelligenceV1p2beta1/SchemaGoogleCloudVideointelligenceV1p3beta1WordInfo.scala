...
object SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1WordInfoOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSpeakerTag(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("speakerTag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSpeakerTag: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("speakerTag")(js.undefined)
        ret
    }
    @scala.inline
