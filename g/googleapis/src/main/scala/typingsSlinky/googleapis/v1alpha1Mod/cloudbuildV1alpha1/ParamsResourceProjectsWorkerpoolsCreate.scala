...
object ParamsResourceProjectsWorkerpoolsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsWorkerpoolsCreateMutableBuilder[Self <: ParamsResourceProjectsWorkerpoolsCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaWorkerPool): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
