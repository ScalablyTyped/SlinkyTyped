...
@js.native
class ResourceDollarProjectsDollarGroupstats protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListGroupStatsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListGroupStatsResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarGroupstatsDollarList): GaxiosPromise[Schema$ListGroupStatsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarGroupstatsDollarList,
    callback: BodyResponseCallback[Schema$ListGroupStatsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarGroupstatsDollarList,
    options: BodyResponseCallback[Schema$ListGroupStatsResponse],
    callback: BodyResponseCallback[Schema$ListGroupStatsResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarGroupstatsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListGroupStatsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarGroupstatsDollarList,
