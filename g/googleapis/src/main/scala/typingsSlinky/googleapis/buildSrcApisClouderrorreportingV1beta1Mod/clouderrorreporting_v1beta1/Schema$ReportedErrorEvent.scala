...
/**
  ...
  */
@js.native
trait Schema$ReportedErrorEvent extends js.Object {
  /**
...
object Schema$ReportedErrorEvent {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ReportedErrorEvent]
  }
}
