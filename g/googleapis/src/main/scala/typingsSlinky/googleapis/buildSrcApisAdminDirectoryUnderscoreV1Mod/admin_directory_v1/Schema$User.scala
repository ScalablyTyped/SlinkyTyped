...
trait Schema$User extends js.Object {
  ...
  /**
    ...
    */
  var customSchemas: js.UndefOr[StringDictionary[Schema$UserCustomProperties]] = js.native
  /**
  ...
  /**
    * User&#39;s name
    */
  var name: js.UndefOr[Schema$UserName] = js.native
  /**
...
object Schema$User {
  ...
  def apply(
    ...
    customSchemas: StringDictionary[Schema$UserCustomProperties] = null,
