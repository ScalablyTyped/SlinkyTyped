...
@js.native
trait ParamsDollarResourceDollarNotificationsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarNotificationsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarNotificationsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarNotificationsDollarDelete]
  }
}
