...
@js.native
trait ParamsDollarResourceDollarResourcesDollarBuildingsDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Building] = js.native
}

object ParamsDollarResourceDollarResourcesDollarBuildingsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Building = null,
    userIp: String = null
  ): ParamsDollarResourceDollarResourcesDollarBuildingsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarResourcesDollarBuildingsDollarPatch]
  }
}
