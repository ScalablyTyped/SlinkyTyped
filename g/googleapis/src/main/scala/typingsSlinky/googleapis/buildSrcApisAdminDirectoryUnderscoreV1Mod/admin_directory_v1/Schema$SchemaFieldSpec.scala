...
import typingsSlinky.googleapis.Anon_MaxValue
...
/**
  ...
  */
@js.native
trait Schema$SchemaFieldSpec extends js.Object {
  /**
  ...
  /**
    ...
    */
  var numericIndexingSpec: js.UndefOr[Anon_MaxValue] = js.native
  /**
...
object Schema$SchemaFieldSpec {
  ...
  def apply(
    ...
    numericIndexingSpec: Anon_MaxValue = null,
    ...
    __obj.asInstanceOf[Schema$SchemaFieldSpec]
  }
}
