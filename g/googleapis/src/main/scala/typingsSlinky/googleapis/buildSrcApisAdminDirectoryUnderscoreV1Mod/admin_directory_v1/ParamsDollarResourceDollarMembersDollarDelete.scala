...
@js.native
trait ParamsDollarResourceDollarMembersDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMembersDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarMembersDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMembersDollarDelete]
  }
}
