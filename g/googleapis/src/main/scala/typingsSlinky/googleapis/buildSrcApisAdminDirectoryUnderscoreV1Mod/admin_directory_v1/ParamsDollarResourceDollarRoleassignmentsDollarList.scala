...
@js.native
trait ParamsDollarResourceDollarRoleassignmentsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRoleassignmentsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    userKey: String = null
  ): ParamsDollarResourceDollarRoleassignmentsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRoleassignmentsDollarList]
  }
}
