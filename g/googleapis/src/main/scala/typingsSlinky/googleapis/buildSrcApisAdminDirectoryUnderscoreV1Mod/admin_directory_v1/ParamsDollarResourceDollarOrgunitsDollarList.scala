...
@js.native
trait ParamsDollarResourceDollarOrgunitsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrgunitsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    `type`: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarOrgunitsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrgunitsDollarList]
  }
}
