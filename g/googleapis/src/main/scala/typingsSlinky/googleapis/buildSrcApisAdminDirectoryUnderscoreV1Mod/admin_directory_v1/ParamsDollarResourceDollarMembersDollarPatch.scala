...
@js.native
trait ParamsDollarResourceDollarMembersDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMembersDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarMembersDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMembersDollarPatch]
  }
}
