...
/**
  ...
  */
@js.native
trait Schema$Building extends js.Object {
  /**
    ...
    */
  var address: js.UndefOr[Schema$BuildingAddress] = js.native
  /**
  ...
  /**
    ...
    */
  var coordinates: js.UndefOr[Schema$BuildingCoordinates] = js.native
  /**
...
object Schema$Building {
  @scala.inline
  def apply(
    address: Schema$BuildingAddress = null,
    buildingId: String = null,
    buildingName: String = null,
    coordinates: Schema$BuildingCoordinates = null,
    ...
    __obj.asInstanceOf[Schema$Building]
  }
}
