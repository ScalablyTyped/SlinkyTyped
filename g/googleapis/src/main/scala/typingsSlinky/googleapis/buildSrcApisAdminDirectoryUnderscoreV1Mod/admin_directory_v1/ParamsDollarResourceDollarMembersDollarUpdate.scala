...
@js.native
trait ParamsDollarResourceDollarMembersDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMembersDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarMembersDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMembersDollarUpdate]
  }
}
