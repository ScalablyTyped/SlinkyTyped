...
@js.native
trait ParamsDollarResourceDollarMembersDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMembersDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarMembersDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMembersDollarGet]
  }
}
