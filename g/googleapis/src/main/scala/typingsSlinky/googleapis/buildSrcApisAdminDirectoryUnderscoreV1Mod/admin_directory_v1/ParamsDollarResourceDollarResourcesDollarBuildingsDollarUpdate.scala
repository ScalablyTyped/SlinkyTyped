...
@js.native
trait ParamsDollarResourceDollarResourcesDollarBuildingsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarResourcesDollarBuildingsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarResourcesDollarBuildingsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarResourcesDollarBuildingsDollarUpdate]
  }
}
