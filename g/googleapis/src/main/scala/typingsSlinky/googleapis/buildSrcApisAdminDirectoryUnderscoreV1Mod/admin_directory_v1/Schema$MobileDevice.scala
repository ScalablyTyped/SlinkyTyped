...
import typingsSlinky.googleapis.Anon_DisplayName
...
/**
  ...
  */
@js.native
trait Schema$MobileDevice extends js.Object {
  /**
  ...
  /**
    ...
    */
  var applications: js.UndefOr[js.Array[Anon_DisplayName]] = js.native
  /**
...
object Schema$MobileDevice {
  @scala.inline
  def apply(
    adbStatus: js.UndefOr[Boolean] = js.undefined,
    applications: js.Array[Anon_DisplayName] = null,
    ...
    __obj.asInstanceOf[Schema$MobileDevice]
  }
}
