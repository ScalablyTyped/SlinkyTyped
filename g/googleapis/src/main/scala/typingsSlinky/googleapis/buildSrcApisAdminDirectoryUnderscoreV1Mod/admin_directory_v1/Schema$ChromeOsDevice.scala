...
import typingsSlinky.googleapis.Anon_ActiveTime
import typingsSlinky.googleapis.Anon_CpuTemperatureInfo
import typingsSlinky.googleapis.Anon_CreateTime
import typingsSlinky.googleapis.Anon_Email
import typingsSlinky.googleapis.Anon_Family
import typingsSlinky.googleapis.Anon_ReportTime
import typingsSlinky.googleapis.Anon_VolumeInfo
...
/**
  ...
  */
@js.native
trait Schema$ChromeOsDevice extends js.Object {
  /**
    * List of active time ranges (Read-only)
    */
  var activeTimeRanges: js.UndefOr[js.Array[Anon_ActiveTime]] = js.native
  /**
  ...
  /**
    ...
    */
  var cpuStatusReports: js.UndefOr[js.Array[Anon_CpuTemperatureInfo]] = js.native
  /**
    * List of device files to download (Read-only)
    */
  var deviceFiles: js.UndefOr[js.Array[Anon_CreateTime]] = js.native
  /**
  ...
  /**
    ...
    */
  var diskVolumeReports: js.UndefOr[js.Array[Anon_VolumeInfo]] = js.native
  /**
  ...
  /**
    ...
    * (Read-only)
    */
  var recentUsers: js.UndefOr[js.Array[Anon_Email]] = js.native
  /**
  ...
  /**
    ...
    */
  var systemRamFreeReports: js.UndefOr[js.Array[Anon_ReportTime]] = js.native
  /**
  ...
  /**
    ...
    */
  var tpmVersionInfo: js.UndefOr[Anon_Family] = js.native
  /**
...
object Schema$ChromeOsDevice {
  @scala.inline
  def apply(
    activeTimeRanges: js.Array[Anon_ActiveTime] = null,
    annotatedAssetId: String = null,
    annotatedLocation: String = null,
    annotatedUser: String = null,
    bootMode: String = null,
    cpuStatusReports: js.Array[Anon_CpuTemperatureInfo] = null,
    deviceFiles: js.Array[Anon_CreateTime] = null,
    deviceId: String = null,
    diskVolumeReports: js.Array[Anon_VolumeInfo] = null,
    etag: String = null,
    ...
    recentUsers: js.Array[Anon_Email] = null,
    serialNumber: String = null,
    status: String = null,
    supportEndDate: String = null,
    systemRamFreeReports: js.Array[Anon_ReportTime] = null,
    systemRamTotal: String = null,
    tpmVersionInfo: Anon_Family = null,
    willAutoRenew: js.UndefOr[Boolean] = js.undefined
  ): Schema$ChromeOsDevice = {
    ...
    __obj.asInstanceOf[Schema$ChromeOsDevice]
  }
}
