...
@js.native
trait ParamsDollarResourceDollarSchemasDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSchemasDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSchemasDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSchemasDollarPatch]
  }
}
