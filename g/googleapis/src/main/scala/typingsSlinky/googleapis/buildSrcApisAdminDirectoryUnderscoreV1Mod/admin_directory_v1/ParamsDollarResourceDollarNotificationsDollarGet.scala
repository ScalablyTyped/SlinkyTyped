...
@js.native
trait ParamsDollarResourceDollarNotificationsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarNotificationsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarNotificationsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarNotificationsDollarGet]
  }
}
