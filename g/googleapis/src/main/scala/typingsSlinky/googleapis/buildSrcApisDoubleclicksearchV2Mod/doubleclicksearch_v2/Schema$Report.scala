...
import typingsSlinky.googleapis.Anon_ByteCount
...
trait Schema$Report extends js.Object {
  /**
    ...
    */
  var files: js.UndefOr[js.Array[Anon_ByteCount]] = js.native
  /**
  ...
  /**
    ...
    */
  var request: js.UndefOr[Schema$ReportRequest] = js.native
  /**
...
object Schema$Report {
  ...
  def apply(
    ...
    kind: String = null,
    request: Schema$ReportRequest = null,
