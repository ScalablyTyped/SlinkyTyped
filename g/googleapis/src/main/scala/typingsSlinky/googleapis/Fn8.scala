...
trait Fn8 extends js.Object {
  ...
  def apply(options: typingsSlinky.googleapis.v3Mod.analyticsV3.Options): typingsSlinky.googleapis.v3Mod.analyticsV3.Analytics = js.native
  def apply(version: v2Dot4): Analytics = js.native
  def apply(version: v3): typingsSlinky.googleapis.v3Mod.analyticsV3.Analytics = js.native
}
