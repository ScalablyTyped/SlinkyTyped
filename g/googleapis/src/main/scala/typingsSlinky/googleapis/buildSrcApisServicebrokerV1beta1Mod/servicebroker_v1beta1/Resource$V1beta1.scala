...
class Resource$V1beta1 protected () extends js.Object {
  ...
  def getIamPolicy(params: ParamsDollarResourceDollarV1beta1DollarGetiampolicy): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def getIamPolicy(
  ...
  def getIamPolicy(params: ParamsDollarResourceDollarV1beta1DollarGetiampolicy, options: MethodOptions): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def getIamPolicy(
    params: ParamsDollarResourceDollarV1beta1DollarGetiampolicy,
  ...
  def setIamPolicy(params: ParamsDollarResourceDollarV1beta1DollarSetiampolicy): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def setIamPolicy(
  ...
  def setIamPolicy(params: ParamsDollarResourceDollarV1beta1DollarSetiampolicy, options: MethodOptions): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def setIamPolicy(
    params: ParamsDollarResourceDollarV1beta1DollarSetiampolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleIamV1__Policy]
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarV1beta1DollarTestiampermissions): GaxiosPromise[Schema$GoogleIamV1__TestIamPermissionsResponse] = js.native
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarV1beta1DollarTestiampermissions, options: MethodOptions): GaxiosPromise[Schema$GoogleIamV1__TestIamPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarV1beta1DollarTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleIamV1__TestIamPermissionsResponse]
