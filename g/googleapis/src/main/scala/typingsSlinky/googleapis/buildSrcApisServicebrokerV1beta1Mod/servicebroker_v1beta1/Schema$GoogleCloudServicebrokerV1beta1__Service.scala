...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1beta1__Service extends js.Object {
  /**
  ...
  /**
    ...
    */
  var dashboard_client: js.UndefOr[Schema$GoogleCloudServicebrokerV1beta1__DashboardClient] = js.native
  /**
  ...
  /**
    ...
    */
  var plans: js.UndefOr[js.Array[Schema$GoogleCloudServicebrokerV1beta1__Plan]] = js.native
  /**
...
object Schema$GoogleCloudServicebrokerV1beta1__Service {
  @scala.inline
  def apply(
    ...
    dashboard_client: Schema$GoogleCloudServicebrokerV1beta1__DashboardClient = null,
    ...
    plans: js.Array[Schema$GoogleCloudServicebrokerV1beta1__Plan] = null,
    tags: js.Array[String] = null
  ): Schema$GoogleCloudServicebrokerV1beta1__Service = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1beta1__Service]
  }
}
