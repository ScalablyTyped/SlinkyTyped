...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1beta1__CreateBindingResponse extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1beta1__CreateBindingResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1beta1__CreateBindingResponse]
  }
}
