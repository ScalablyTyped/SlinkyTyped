...
class ResourceDollarProjectsDollarBrokersDollarInstances protected () extends js.Object {
  ...
  var bindings: ResourceDollarProjectsDollarBrokersDollarInstancesDollarBindings = js.native
  ...
  def get(params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarGet): GaxiosPromise[Schema$GoogleCloudServicebrokerV1beta1__ServiceInstance] = js.native
  def get(
  ...
  def getLast_operation(params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarGetlast_operation): GaxiosPromise[Schema$GoogleCloudServicebrokerV1beta1__Operation] = js.native
  def getLast_operation(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarGetlast_operation,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse] = js.native
  def list(
    callback: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarList): GaxiosPromise[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarList,
    callback: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarList,
    options: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse],
    callback: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarList,
    options: MethodOptions
  ): GaxiosPromise[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarBrokersDollarInstancesDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleCloudServicebrokerV1beta1__ListServiceInstancesResponse]
