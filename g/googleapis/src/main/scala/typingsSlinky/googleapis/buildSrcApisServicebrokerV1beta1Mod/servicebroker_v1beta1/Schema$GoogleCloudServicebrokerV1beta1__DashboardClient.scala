...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1beta1__DashboardClient extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1beta1__DashboardClient {
  @scala.inline
  def apply(id: String = null, redirect_uri: String = null, secret: String = null): Schema$GoogleCloudServicebrokerV1beta1__DashboardClient = {
    val __obj = js.Dynamic.literal()
    if (id != null) __obj.updateDynamic("id")(id.asInstanceOf[js.Any])
    if (redirect_uri != null) __obj.updateDynamic("redirect_uri")(redirect_uri.asInstanceOf[js.Any])
    if (secret != null) __obj.updateDynamic("secret")(secret.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1beta1__DashboardClient]
  }
}
