...
object ParamsResourceAccountsList {
  ...
  implicit class ParamsResourceAccountsListOps[Self <: ParamsResourceAccountsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFilterAdClientId(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("filterAdClientId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFilterAdClientId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("filterAdClientId")(js.undefined)
        ret
    }
  }
