...
object ParamsResourceOrderreturnsList {
  ...
  implicit class ParamsResourceOrderreturnsListOps[Self <: ParamsResourceOrderreturnsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreatedEndDate(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createdEndDate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCreatedEndDate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createdEndDate")(js.undefined)
        ret
    }
    @scala.inline
    def withCreatedStartDate(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createdStartDate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCreatedStartDate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createdStartDate")(js.undefined)
        ret
    }
    @scala.inline
