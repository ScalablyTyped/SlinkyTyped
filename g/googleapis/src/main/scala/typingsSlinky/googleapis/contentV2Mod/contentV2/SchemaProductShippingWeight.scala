...
object SchemaProductShippingWeight {
  ...
  @scala.inline
  def apply(): SchemaProductShippingWeight = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaProductShippingWeight]
  }
  
  @scala.inline
  implicit class SchemaProductShippingWeightMutableBuilder[Self <: SchemaProductShippingWeight] (val x: Self) extends AnyVal {
