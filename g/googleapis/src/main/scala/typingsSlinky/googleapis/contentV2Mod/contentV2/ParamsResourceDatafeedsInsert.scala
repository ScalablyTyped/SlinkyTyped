...
@js.native
trait ParamsResourceDatafeedsInsert extends StandardParameters {
  /**
...
object ParamsResourceDatafeedsInsert {
  @scala.inline
  def apply(): ParamsResourceDatafeedsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDatafeedsInsert]
  }
  @scala.inline
  implicit class ParamsResourceDatafeedsInsertOps[Self <: ParamsResourceDatafeedsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaDatafeed): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
