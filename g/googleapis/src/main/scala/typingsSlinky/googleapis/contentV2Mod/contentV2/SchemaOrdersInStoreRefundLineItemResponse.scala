...
@js.native
trait SchemaOrdersInStoreRefundLineItemResponse extends StObject {
...
object SchemaOrdersInStoreRefundLineItemResponse {
  ...
  @scala.inline
  implicit class SchemaOrdersInStoreRefundLineItemResponseMutableBuilder[Self <: SchemaOrdersInStoreRefundLineItemResponse] (val x: Self) extends AnyVal {
