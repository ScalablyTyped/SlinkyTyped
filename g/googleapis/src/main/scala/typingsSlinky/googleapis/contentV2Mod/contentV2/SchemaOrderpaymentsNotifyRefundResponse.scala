...
@js.native
trait SchemaOrderpaymentsNotifyRefundResponse extends StObject {
...
object SchemaOrderpaymentsNotifyRefundResponse {
  ...
  @scala.inline
  implicit class SchemaOrderpaymentsNotifyRefundResponseMutableBuilder[Self <: SchemaOrderpaymentsNotifyRefundResponse] (val x: Self) extends AnyVal {
