...
object SchemaShippingsettingsListResponse {
  ...
  implicit class SchemaShippingsettingsListResponseOps[Self <: SchemaShippingsettingsListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourcesVarargs(value: SchemaShippingSettings*): Self = this.set("resources", js.Array(value :_*))
    @scala.inline
    def setResources(value: js.Array[SchemaShippingSettings]): Self = this.set("resources", value.asInstanceOf[js.Any])
    @scala.inline
