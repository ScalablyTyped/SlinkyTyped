...
object SchemaProduct {
  ...
  implicit class SchemaProductOps[Self <: SchemaProduct] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAspects(value: js.Array[SchemaProductAspect]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCustomGroups(value: js.Array[SchemaCustomGroup]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDestinations(value: js.Array[SchemaProductDestination]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWarnings(value: js.Array[SchemaError]): Self = {
        val ret = this.duplicate
