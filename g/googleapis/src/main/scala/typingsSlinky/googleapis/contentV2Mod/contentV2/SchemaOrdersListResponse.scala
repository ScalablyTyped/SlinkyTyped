...
object SchemaOrdersListResponse {
  ...
  implicit class SchemaOrdersListResponseMutableBuilder[Self <: SchemaOrdersListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResources(value: js.Array[SchemaOrder]): Self = StObject.set(x, "resources", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourcesUndefined: Self = StObject.set(x, "resources", js.undefined)
    
    @scala.inline
    def setResourcesVarargs(value: SchemaOrder*): Self = StObject.set(x, "resources", js.Array(value :_*))
  }
}
