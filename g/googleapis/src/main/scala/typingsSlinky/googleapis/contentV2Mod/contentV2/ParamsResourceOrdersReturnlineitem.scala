...
object ParamsResourceOrdersReturnlineitem {
  ...
  @scala.inline
  def apply(): ParamsResourceOrdersReturnlineitem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrdersReturnlineitem]
  }
  
  @scala.inline
  implicit class ParamsResourceOrdersReturnlineitemMutableBuilder[Self <: ParamsResourceOrdersReturnlineitem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrdersReturnLineItemRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
