...
object ParamsResourceOrdersReturnlineitem {
  ...
  @scala.inline
  implicit class ParamsResourceOrdersReturnlineitemOps[Self <: ParamsResourceOrdersReturnlineitem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrdersReturnLineItemRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
