...
/**
  ...
  */
@js.native
trait Schema$DeviceClaim extends js.Object {
  /**
...
object Schema$DeviceClaim {
  @scala.inline
  def apply(ownerCompanyId: String = null, resellerId: String = null, sectionType: String = null): Schema$DeviceClaim = {
    ...
    __obj.asInstanceOf[Schema$DeviceClaim]
  }
}
