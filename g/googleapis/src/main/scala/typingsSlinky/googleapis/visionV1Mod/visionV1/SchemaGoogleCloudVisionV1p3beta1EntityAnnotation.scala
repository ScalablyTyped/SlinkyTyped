...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1EntityAnnotation extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p3beta1EntityAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1EntityAnnotationOps[Self <: SchemaGoogleCloudVisionV1p3beta1EntityAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLocationsVarargs(value: SchemaGoogleCloudVisionV1p3beta1LocationInfo*): Self = this.set("locations", js.Array(value :_*))
    @scala.inline
    def setLocations(value: js.Array[SchemaGoogleCloudVisionV1p3beta1LocationInfo]): Self = this.set("locations", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPropertiesVarargs(value: SchemaGoogleCloudVisionV1p3beta1Property*): Self = this.set("properties", js.Array(value :_*))
    @scala.inline
    def setProperties(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Property]): Self = this.set("properties", value.asInstanceOf[js.Any])
    @scala.inline
