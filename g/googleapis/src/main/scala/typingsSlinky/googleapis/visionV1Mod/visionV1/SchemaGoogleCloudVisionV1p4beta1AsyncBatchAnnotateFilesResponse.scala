...
object SchemaGoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse {
  @scala.inline
  def apply(responses: js.Array[SchemaGoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse] = null): SchemaGoogleCloudVisionV1p4beta1AsyncBatchAnnotateFilesResponse = {
