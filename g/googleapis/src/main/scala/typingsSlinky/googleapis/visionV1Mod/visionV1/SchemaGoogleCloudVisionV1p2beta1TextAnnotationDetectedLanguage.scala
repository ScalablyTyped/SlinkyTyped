...
object SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguageOps[Self <: SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage] (val x: Self) extends AnyVal {
    @scala.inline
