...
object SchemaGoogleCloudVisionV1p2beta1AnnotateImageResponse {
  @scala.inline
  def apply(
    context: SchemaGoogleCloudVisionV1p2beta1ImageAnnotationContext = null,
    cropHintsAnnotation: SchemaGoogleCloudVisionV1p2beta1CropHintsAnnotation = null,
    error: SchemaStatus = null,
    faceAnnotations: js.Array[SchemaGoogleCloudVisionV1p2beta1FaceAnnotation] = null,
    fullTextAnnotation: SchemaGoogleCloudVisionV1p2beta1TextAnnotation = null,
    imagePropertiesAnnotation: SchemaGoogleCloudVisionV1p2beta1ImageProperties = null,
    labelAnnotations: js.Array[SchemaGoogleCloudVisionV1p2beta1EntityAnnotation] = null,
    landmarkAnnotations: js.Array[SchemaGoogleCloudVisionV1p2beta1EntityAnnotation] = null,
    localizedObjectAnnotations: js.Array[SchemaGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation] = null,
    logoAnnotations: js.Array[SchemaGoogleCloudVisionV1p2beta1EntityAnnotation] = null,
    productSearchResults: SchemaGoogleCloudVisionV1p2beta1ProductSearchResults = null,
    safeSearchAnnotation: SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation = null,
    textAnnotations: js.Array[SchemaGoogleCloudVisionV1p2beta1EntityAnnotation] = null,
    webDetection: SchemaGoogleCloudVisionV1p2beta1WebDetection = null
  ): SchemaGoogleCloudVisionV1p2beta1AnnotateImageResponse = {
