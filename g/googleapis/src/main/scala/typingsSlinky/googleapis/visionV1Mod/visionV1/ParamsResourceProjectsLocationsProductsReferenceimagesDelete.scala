...
object ParamsResourceProjectsLocationsProductsReferenceimagesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsReferenceimagesDeleteOps[Self <: ParamsResourceProjectsLocationsProductsReferenceimagesDelete] (val x: Self) extends AnyVal {
