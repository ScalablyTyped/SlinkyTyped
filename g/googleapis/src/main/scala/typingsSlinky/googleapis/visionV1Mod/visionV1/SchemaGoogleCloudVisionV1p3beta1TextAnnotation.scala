...
object SchemaGoogleCloudVisionV1p3beta1TextAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1TextAnnotationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1TextAnnotation] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setPages(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Page]): Self = StObject.set(x, "pages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPagesUndefined: Self = StObject.set(x, "pages", js.undefined)
    
    @scala.inline
    def setPagesVarargs(value: SchemaGoogleCloudVisionV1p3beta1Page*): Self = StObject.set(x, "pages", js.Array(value :_*))
