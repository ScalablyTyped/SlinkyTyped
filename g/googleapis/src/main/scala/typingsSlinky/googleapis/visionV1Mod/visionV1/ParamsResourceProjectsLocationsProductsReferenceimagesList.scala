...
object ParamsResourceProjectsLocationsProductsReferenceimagesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsReferenceimagesListOps[Self <: ParamsResourceProjectsLocationsProductsReferenceimagesList] (val x: Self) extends AnyVal {
