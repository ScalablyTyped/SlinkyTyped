...
object SchemaImportProductSetsGcsSource {
  ...
  implicit class SchemaImportProductSetsGcsSourceOps[Self <: SchemaImportProductSetsGcsSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCsvFileUri(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("csvFileUri")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCsvFileUri: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("csvFileUri")(js.undefined)
        ret
    }
  }
