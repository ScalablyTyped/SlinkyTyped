...
object SchemaGoogleCloudVisionV1p2beta1Product {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1ProductMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductLabels(value: js.Array[SchemaGoogleCloudVisionV1p2beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    @scala.inline
    def setProductLabelsVarargs(value: SchemaGoogleCloudVisionV1p2beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value :_*))
  }
}
