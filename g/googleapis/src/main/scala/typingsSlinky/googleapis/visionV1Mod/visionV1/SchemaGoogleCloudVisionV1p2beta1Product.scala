...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1Product extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p2beta1Product {
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1Product = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1Product]
  }
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1ProductOps[Self <: SchemaGoogleCloudVisionV1p2beta1Product] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setProductLabelsVarargs(value: SchemaGoogleCloudVisionV1p2beta1ProductKeyValue*): Self = this.set("productLabels", js.Array(value :_*))
    @scala.inline
    def setProductLabels(value: js.Array[SchemaGoogleCloudVisionV1p2beta1ProductKeyValue]): Self = this.set("productLabels", value.asInstanceOf[js.Any])
    @scala.inline
