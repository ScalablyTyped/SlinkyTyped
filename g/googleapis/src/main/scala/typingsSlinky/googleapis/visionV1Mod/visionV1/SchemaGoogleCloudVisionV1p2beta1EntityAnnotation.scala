...
object SchemaGoogleCloudVisionV1p2beta1EntityAnnotation {
  ...
  def apply(
    ...
    locale: String = null,
    locations: js.Array[SchemaGoogleCloudVisionV1p2beta1LocationInfo] = null,
    mid: String = null,
    properties: js.Array[SchemaGoogleCloudVisionV1p2beta1Property] = null,
    score: js.UndefOr[Double] = js.undefined,
    topicality: js.UndefOr[Double] = js.undefined
  ): SchemaGoogleCloudVisionV1p2beta1EntityAnnotation = {
