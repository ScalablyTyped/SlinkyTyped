...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1Position extends js.Object {
  /**
    * X coordinate.
    */
...
object SchemaGoogleCloudVisionV1p3beta1Position {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1PositionOps[Self <: SchemaGoogleCloudVisionV1p3beta1Position] (val x: Self) extends AnyVal {
    @scala.inline
