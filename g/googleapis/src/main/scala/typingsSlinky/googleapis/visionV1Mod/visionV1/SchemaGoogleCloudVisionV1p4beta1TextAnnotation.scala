...
object SchemaGoogleCloudVisionV1p4beta1TextAnnotation {
  ...
  implicit class SchemaGoogleCloudVisionV1p4beta1TextAnnotationOps[Self <: SchemaGoogleCloudVisionV1p4beta1TextAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPagesVarargs(value: SchemaGoogleCloudVisionV1p4beta1Page*): Self = this.set("pages", js.Array(value :_*))
    @scala.inline
    def setPages(value: js.Array[SchemaGoogleCloudVisionV1p4beta1Page]): Self = this.set("pages", value.asInstanceOf[js.Any])
    @scala.inline
