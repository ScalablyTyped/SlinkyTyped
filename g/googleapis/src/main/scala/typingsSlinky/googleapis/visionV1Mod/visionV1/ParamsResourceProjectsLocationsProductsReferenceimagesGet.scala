...
object ParamsResourceProjectsLocationsProductsReferenceimagesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsReferenceimagesGetOps[Self <: ParamsResourceProjectsLocationsProductsReferenceimagesGet] (val x: Self) extends AnyVal {
    @scala.inline
