...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1Word extends StObject {
...
object SchemaGoogleCloudVisionV1p2beta1Word {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1Word]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1WordMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1Word] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSymbols(value: js.Array[SchemaGoogleCloudVisionV1p2beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    @scala.inline
    def setSymbolsVarargs(value: SchemaGoogleCloudVisionV1p2beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value :_*))
  }
}
