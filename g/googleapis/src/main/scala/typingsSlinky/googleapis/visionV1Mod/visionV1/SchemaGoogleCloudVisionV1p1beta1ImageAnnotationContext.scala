...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1ImageAnnotationContext extends StObject {
...
object SchemaGoogleCloudVisionV1p1beta1ImageAnnotationContext {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1ImageAnnotationContextMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1ImageAnnotationContext] (val x: Self) extends AnyVal {
