...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p4beta1Property extends StObject {
...
object SchemaGoogleCloudVisionV1p4beta1Property {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p4beta1Property = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p4beta1Property]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1PropertyMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1Property] (val x: Self) extends AnyVal {
