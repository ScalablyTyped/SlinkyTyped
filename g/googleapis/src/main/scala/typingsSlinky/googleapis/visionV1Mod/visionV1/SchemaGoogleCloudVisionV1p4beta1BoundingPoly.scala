...
object SchemaGoogleCloudVisionV1p4beta1BoundingPoly {
  ...
  implicit class SchemaGoogleCloudVisionV1p4beta1BoundingPolyOps[Self <: SchemaGoogleCloudVisionV1p4beta1BoundingPoly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNormalizedVertices(value: js.Array[SchemaGoogleCloudVisionV1p4beta1NormalizedVertex]): Self = {
    ...
    @scala.inline
    def withVertices(value: js.Array[SchemaGoogleCloudVisionV1p4beta1Vertex]): Self = {
        val ret = this.duplicate
