...
/**
  ...
  */
@js.native
trait SchemaFaceAnnotation extends StObject {
...
object SchemaFaceAnnotation {
  ...
  @scala.inline
  implicit class SchemaFaceAnnotationMutableBuilder[Self <: SchemaFaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: SchemaBoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarks(value: js.Array[SchemaLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    @scala.inline
    def setLandmarksVarargs(value: SchemaLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
