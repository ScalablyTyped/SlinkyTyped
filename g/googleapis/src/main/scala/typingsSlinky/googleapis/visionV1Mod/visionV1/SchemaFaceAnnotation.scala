...
object SchemaFaceAnnotation {
  ...
  implicit class SchemaFaceAnnotationOps[Self <: SchemaFaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: SchemaBoundingPoly): Self = this.set("fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarksVarargs(value: SchemaLandmark*): Self = this.set("landmarks", js.Array(value :_*))
    
    @scala.inline
    def setLandmarks(value: js.Array[SchemaLandmark]): Self = this.set("landmarks", value.asInstanceOf[js.Any])
