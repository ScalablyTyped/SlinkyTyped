...
object ParamsResourceProjectsLocationsProductsetsRemoveproduct {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsProductsetsRemoveproduct = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsProductsetsRemoveproduct]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsetsRemoveproductMutableBuilder[Self <: ParamsResourceProjectsLocationsProductsetsRemoveproduct] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRemoveProductFromProductSetRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
