...
object ParamsResourceProjectsLocationsProductsetsRemoveproduct {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsetsRemoveproductOps[Self <: ParamsResourceProjectsLocationsProductsetsRemoveproduct] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaRemoveProductFromProductSetRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
