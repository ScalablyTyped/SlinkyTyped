...
object ParamsResourceProjectsLocationsProductsetsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsProductsetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsProductsetsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsetsListMutableBuilder[Self <: ParamsResourceProjectsLocationsProductsetsList] (val x: Self) extends AnyVal {
