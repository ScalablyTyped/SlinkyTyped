...
object SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreakOps[Self <: SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak] (val x: Self) extends AnyVal {
    @scala.inline
