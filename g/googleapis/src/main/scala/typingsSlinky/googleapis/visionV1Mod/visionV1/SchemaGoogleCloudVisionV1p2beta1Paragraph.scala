...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1Paragraph extends js.Object {
  /**
  ...
  /**
    ...
    */
  var words: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p2beta1Word]] = js.native
}
...
object SchemaGoogleCloudVisionV1p2beta1Paragraph {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1ParagraphOps[Self <: SchemaGoogleCloudVisionV1p2beta1Paragraph] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVisionV1p2beta1Word*): Self = this.set("words", js.Array(value :_*))
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVisionV1p2beta1Word]): Self = this.set("words", value.asInstanceOf[js.Any])
    @scala.inline
