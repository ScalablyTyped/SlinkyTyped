...
object ParamsResourceProjectsLocationsProductsetsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsProductsetsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsProductsetsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsetsPatchMutableBuilder[Self <: ParamsResourceProjectsLocationsProductsetsPatch] (val x: Self) extends AnyVal {
