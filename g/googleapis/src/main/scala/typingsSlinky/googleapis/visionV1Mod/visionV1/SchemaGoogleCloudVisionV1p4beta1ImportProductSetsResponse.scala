...
object SchemaGoogleCloudVisionV1p4beta1ImportProductSetsResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1ImportProductSetsResponseMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1ImportProductSetsResponse] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setReferenceImages(value: js.Array[SchemaGoogleCloudVisionV1p4beta1ReferenceImage]): Self = StObject.set(x, "referenceImages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReferenceImagesUndefined: Self = StObject.set(x, "referenceImages", js.undefined)
    
    @scala.inline
    def setReferenceImagesVarargs(value: SchemaGoogleCloudVisionV1p4beta1ReferenceImage*): Self = StObject.set(x, "referenceImages", js.Array(value :_*))
