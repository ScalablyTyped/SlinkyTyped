...
object clouderrorreportingMod {
  ...
  object VERSIONS {
    ...
    @JSImport("googleapis/build/src/apis/clouderrorreporting", "VERSIONS")
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/clouderrorreporting", "VERSIONS.v1beta1")
    @js.native
  ...
  object auth extends Shortcut {
    ...
    @JSImport("googleapis/build/src/apis/clouderrorreporting", "auth")
    @js.native
    val ^ : AuthPlus = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/clouderrorreporting", "auth.Compute")
    @js.native
    /**
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/clouderrorreporting", "auth.JWT")
    @js.native
    class JWT protected ()
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/clouderrorreporting", "auth.OAuth2")
    @js.native
    /**
