...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsGetOps[Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsGet] (val x: Self) extends AnyVal {
    @scala.inline
