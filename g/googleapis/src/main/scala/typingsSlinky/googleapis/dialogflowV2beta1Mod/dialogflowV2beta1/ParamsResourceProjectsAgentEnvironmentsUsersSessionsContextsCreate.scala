...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsCreateOps[Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaGoogleCloudDialogflowV2beta1Context): Self = {
        val ret = this.duplicate
