...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatchMutableBuilder[Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatch] (val x: Self) extends AnyVal {
