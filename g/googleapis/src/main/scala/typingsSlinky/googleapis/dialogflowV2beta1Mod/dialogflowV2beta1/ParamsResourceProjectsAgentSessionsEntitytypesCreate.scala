...
object ParamsResourceProjectsAgentSessionsEntitytypesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentSessionsEntitytypesCreateOps[Self <: ParamsResourceProjectsAgentSessionsEntitytypesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaGoogleCloudDialogflowV2beta1SessionEntityType): Self = {
        val ret = this.duplicate
