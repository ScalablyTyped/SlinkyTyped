...
object ParamsResourceProjectsKnowledgebasesDocumentsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsKnowledgebasesDocumentsCreateMutableBuilder[Self <: ParamsResourceProjectsKnowledgebasesDocumentsCreate] (val x: Self) extends AnyVal {
