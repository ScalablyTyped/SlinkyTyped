...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDeleteOps[Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDelete] (val x: Self) extends AnyVal {
    @scala.inline
