...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDeleteMutableBuilder[Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesDelete] (val x: Self) extends AnyVal {
