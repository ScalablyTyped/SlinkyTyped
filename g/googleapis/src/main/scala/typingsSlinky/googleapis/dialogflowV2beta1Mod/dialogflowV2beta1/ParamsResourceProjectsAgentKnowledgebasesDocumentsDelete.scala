...
object ParamsResourceProjectsAgentKnowledgebasesDocumentsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentKnowledgebasesDocumentsDeleteOps[Self <: ParamsResourceProjectsAgentKnowledgebasesDocumentsDelete] (val x: Self) extends AnyVal {
    @scala.inline
