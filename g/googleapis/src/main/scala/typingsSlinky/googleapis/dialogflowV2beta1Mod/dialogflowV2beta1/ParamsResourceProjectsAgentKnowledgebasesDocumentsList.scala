...
object ParamsResourceProjectsAgentKnowledgebasesDocumentsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentKnowledgebasesDocumentsListMutableBuilder[Self <: ParamsResourceProjectsAgentKnowledgebasesDocumentsList] (val x: Self) extends AnyVal {
