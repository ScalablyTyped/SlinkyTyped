...
class ResourceProjectsAgent protected () extends StObject {
  ...
  def search(params: js.UndefOr[scala.Nothing], options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1SearchAgentsResponse] = js.native
  ...
  def search(
    params: ParamsResourceProjectsAgentSearch,
    options: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1SearchAgentsResponse],
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1SearchAgentsResponse]
  ): Unit = js.native
