...
object ParamsResourceProjectsKnowledgebasesDocumentsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsKnowledgebasesDocumentsPatchOps[Self <: ParamsResourceProjectsKnowledgebasesDocumentsPatch] (val x: Self) extends AnyVal {
    @scala.inline
