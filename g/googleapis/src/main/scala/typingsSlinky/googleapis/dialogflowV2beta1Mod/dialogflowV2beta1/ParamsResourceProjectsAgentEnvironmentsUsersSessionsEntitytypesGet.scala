...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesGetOps[Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesGet] (val x: Self) extends AnyVal {
    @scala.inline
