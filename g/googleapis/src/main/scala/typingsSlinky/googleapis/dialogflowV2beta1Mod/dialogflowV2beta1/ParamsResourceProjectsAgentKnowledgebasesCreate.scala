...
object ParamsResourceProjectsAgentKnowledgebasesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentKnowledgebasesCreateMutableBuilder[Self <: ParamsResourceProjectsAgentKnowledgebasesCreate] (val x: Self) extends AnyVal {
