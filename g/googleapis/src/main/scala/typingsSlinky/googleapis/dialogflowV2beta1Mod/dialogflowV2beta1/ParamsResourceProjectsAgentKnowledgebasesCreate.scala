...
object ParamsResourceProjectsAgentKnowledgebasesCreate {
  @scala.inline
  def apply(): ParamsResourceProjectsAgentKnowledgebasesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentKnowledgebasesCreate]
  }
  @scala.inline
  implicit class ParamsResourceProjectsAgentKnowledgebasesCreateOps[Self <: ParamsResourceProjectsAgentKnowledgebasesCreate] (val x: Self) extends AnyVal {
    @scala.inline
