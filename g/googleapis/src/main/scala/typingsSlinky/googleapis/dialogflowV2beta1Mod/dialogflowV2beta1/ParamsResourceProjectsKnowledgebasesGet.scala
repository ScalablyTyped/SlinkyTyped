...
@js.native
trait ParamsResourceProjectsKnowledgebasesGet extends StandardParameters {
...
object ParamsResourceProjectsKnowledgebasesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsKnowledgebasesGetOps[Self <: ParamsResourceProjectsKnowledgebasesGet] (val x: Self) extends AnyVal {
