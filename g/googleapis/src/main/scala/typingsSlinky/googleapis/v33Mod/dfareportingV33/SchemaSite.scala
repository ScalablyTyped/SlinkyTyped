...
object SchemaSite {
  ...
  implicit class SchemaSiteOps[Self <: SchemaSite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSiteContacts(value: js.Array[SchemaSiteContact]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSiteSettings(value: SchemaSiteSettings): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVideoSettings(value: SchemaSiteVideoSettings): Self = {
        val ret = this.duplicate
