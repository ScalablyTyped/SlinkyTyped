...
@js.native
trait ParamsResourcePlacementstrategiesList extends StandardParameters {
...
object ParamsResourcePlacementstrategiesList {
  ...
  @scala.inline
  def apply(): ParamsResourcePlacementstrategiesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlacementstrategiesList]
  }
  
  @scala.inline
  implicit class ParamsResourcePlacementstrategiesListMutableBuilder[Self <: ParamsResourcePlacementstrategiesList] (val x: Self) extends AnyVal {
