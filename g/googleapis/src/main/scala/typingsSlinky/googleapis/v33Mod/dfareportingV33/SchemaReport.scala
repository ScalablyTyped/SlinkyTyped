...
import typingsSlinky.googleapis.AnonCustomFloodlightVariables
import typingsSlinky.googleapis.AnonMessage
import typingsSlinky.googleapis.AnonMetricNames
import typingsSlinky.googleapis.AnonOverlapMetricNames
import typingsSlinky.googleapis.AnonReachByFrequencyMetricNames
import typingsSlinky.googleapis.AnonReportProperties
...
object SchemaReport {
  ...
  implicit class SchemaReportOps[Self <: SchemaReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCriteria(value: AnonMetricNames): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCrossDimensionReachCriteria(value: AnonOverlapMetricNames): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDelivery(value: AnonMessage): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFloodlightCriteria(value: AnonReportProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPathToConversionCriteria(value: AnonCustomFloodlightVariables): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReachCriteria(value: AnonReachByFrequencyMetricNames): Self = {
        val ret = this.duplicate
