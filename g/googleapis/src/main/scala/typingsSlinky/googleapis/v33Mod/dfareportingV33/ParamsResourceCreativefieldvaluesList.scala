...
@js.native
trait ParamsResourceCreativefieldvaluesList extends StandardParameters {
...
object ParamsResourceCreativefieldvaluesList {
  ...
  @scala.inline
  def apply(): ParamsResourceCreativefieldvaluesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCreativefieldvaluesList]
  }
  
  @scala.inline
  implicit class ParamsResourceCreativefieldvaluesListMutableBuilder[Self <: ParamsResourceCreativefieldvaluesList] (val x: Self) extends AnyVal {
