...
object ParamsResourceCampaigncreativeassociationsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceCampaigncreativeassociationsInsertOps[Self <: ParamsResourceCampaigncreativeassociationsInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCampaignCreativeAssociation): Self = this.set("requestBody", value.asInstanceOf[js.Any])
