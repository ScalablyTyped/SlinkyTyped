...
object SchemaWatchVariableRequest {
  ...
  implicit class SchemaWatchVariableRequestOps[Self <: SchemaWatchVariableRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNewerThan(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("newerThan")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNewerThan: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("newerThan")(js.undefined)
        ret
    }
  }
