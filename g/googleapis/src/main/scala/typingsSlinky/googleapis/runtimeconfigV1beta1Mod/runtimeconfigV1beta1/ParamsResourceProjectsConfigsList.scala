...
object ParamsResourceProjectsConfigsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsConfigsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsConfigsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsConfigsListMutableBuilder[Self <: ParamsResourceProjectsConfigsList] (val x: Self) extends AnyVal {
