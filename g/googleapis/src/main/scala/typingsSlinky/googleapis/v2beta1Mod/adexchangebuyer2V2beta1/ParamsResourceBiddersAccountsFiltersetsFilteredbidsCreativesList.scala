...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidsCreativesList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsFilteredbidsCreativesListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidsCreativesList] (val x: Self) extends AnyVal {
