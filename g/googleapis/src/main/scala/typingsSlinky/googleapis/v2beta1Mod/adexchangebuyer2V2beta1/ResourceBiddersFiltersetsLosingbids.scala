...
@js.native
class ResourceBiddersFiltersetsLosingbids protected () extends StObject {
  ...
  def list(params: ParamsResourceBiddersFiltersetsLosingbidsList): GaxiosPromise[SchemaListLosingBidsResponse] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsLosingbidsList,
  ...
  def list(params: ParamsResourceBiddersFiltersetsLosingbidsList, options: MethodOptions): GaxiosPromise[SchemaListLosingBidsResponse] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsLosingbidsList,
