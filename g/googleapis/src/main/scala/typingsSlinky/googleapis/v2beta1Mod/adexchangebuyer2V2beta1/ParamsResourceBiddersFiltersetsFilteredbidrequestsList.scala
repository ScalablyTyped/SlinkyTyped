...
@js.native
trait ParamsResourceBiddersFiltersetsFilteredbidrequestsList extends StandardParameters {
...
object ParamsResourceBiddersFiltersetsFilteredbidrequestsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersFiltersetsFilteredbidrequestsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsFilteredbidrequestsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsFilteredbidrequestsListMutableBuilder[Self <: ParamsResourceBiddersFiltersetsFilteredbidrequestsList] (val x: Self) extends AnyVal {
