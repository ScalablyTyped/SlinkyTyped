...
object ParamsResourceBiddersFiltersetsFilteredbidrequestsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsFilteredbidrequestsListOps[Self <: ParamsResourceBiddersFiltersetsFilteredbidrequestsList] (val x: Self) extends AnyVal {
    @scala.inline
