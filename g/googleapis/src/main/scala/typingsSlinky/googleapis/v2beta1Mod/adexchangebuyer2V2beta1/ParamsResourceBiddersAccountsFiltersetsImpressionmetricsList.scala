...
object ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsImpressionmetricsListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList] (val x: Self) extends AnyVal {
