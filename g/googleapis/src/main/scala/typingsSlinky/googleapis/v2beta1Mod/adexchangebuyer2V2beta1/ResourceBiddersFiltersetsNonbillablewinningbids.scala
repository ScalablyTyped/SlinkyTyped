...
@js.native
class ResourceBiddersFiltersetsNonbillablewinningbids protected () extends js.Object {
  ...
  def list(params: ParamsResourceBiddersFiltersetsNonbillablewinningbidsList, options: MethodOptions): GaxiosPromise[SchemaListNonBillableWinningBidsResponse] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsNonbillablewinningbidsList,
