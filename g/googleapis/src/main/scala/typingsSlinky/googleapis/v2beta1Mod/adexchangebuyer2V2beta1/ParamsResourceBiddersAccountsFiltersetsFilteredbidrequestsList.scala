...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsList] (val x: Self) extends AnyVal {
