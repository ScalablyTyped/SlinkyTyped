...
@js.native
class ResourceBiddersAccountsFiltersetsImpressionmetrics protected () extends js.Object {
  ...
  def list(params: js.UndefOr[scala.Nothing], options: MethodOptions): GaxiosPromise[SchemaListImpressionMetricsResponse] = js.native
  def list(params: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList): GaxiosPromise[SchemaListImpressionMetricsResponse] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList,
    callback: BodyResponseCallback[SchemaListImpressionMetricsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList,
    options: BodyResponseCallback[SchemaListImpressionMetricsResponse],
    callback: BodyResponseCallback[SchemaListImpressionMetricsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList, options: MethodOptions): GaxiosPromise[SchemaListImpressionMetricsResponse] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList,
