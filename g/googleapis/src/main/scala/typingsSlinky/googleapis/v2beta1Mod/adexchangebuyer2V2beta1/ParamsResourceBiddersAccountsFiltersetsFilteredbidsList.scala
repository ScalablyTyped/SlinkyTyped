...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersAccountsFiltersetsFilteredbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsFilteredbidsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsFilteredbidsListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidsList] (val x: Self) extends AnyVal {
