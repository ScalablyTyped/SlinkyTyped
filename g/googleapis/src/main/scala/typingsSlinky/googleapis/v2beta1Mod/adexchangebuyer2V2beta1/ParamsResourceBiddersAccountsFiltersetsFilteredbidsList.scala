...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsFilteredbidsListOps[Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidsList] (val x: Self) extends AnyVal {
