...
object ParamsResourceAccountsFinalizedproposalsList {
  ...
  def apply(
  ...
  ): ParamsResourceAccountsFinalizedproposalsList = {
    ...
    if (filterSyntax != null) __obj.updateDynamic("filterSyntax")(filterSyntax.asInstanceOf[js.Any])
