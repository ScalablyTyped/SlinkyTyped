...
object ParamsResourceAccountsProposalsResume {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsProposalsResume = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsProposalsResume]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsProposalsResumeMutableBuilder[Self <: ParamsResourceAccountsProposalsResume] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaResumeProposalRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
