...
object ParamsResourceBiddersFiltersetsBidmetricsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsBidmetricsListMutableBuilder[Self <: ParamsResourceBiddersFiltersetsBidmetricsList] (val x: Self) extends AnyVal {
