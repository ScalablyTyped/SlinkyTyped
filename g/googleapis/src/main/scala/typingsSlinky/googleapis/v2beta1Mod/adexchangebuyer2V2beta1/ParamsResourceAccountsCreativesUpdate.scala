...
object ParamsResourceAccountsCreativesUpdate {
  @scala.inline
  def apply(): ParamsResourceAccountsCreativesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsCreativesUpdate]
  }
  @scala.inline
  implicit class ParamsResourceAccountsCreativesUpdateOps[Self <: ParamsResourceAccountsCreativesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
