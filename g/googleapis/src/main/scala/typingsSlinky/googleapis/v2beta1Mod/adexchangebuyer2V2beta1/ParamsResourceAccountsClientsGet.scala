...
@js.native
trait ParamsResourceAccountsClientsGet extends StandardParameters {
...
object ParamsResourceAccountsClientsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsClientsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsClientsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsClientsGetMutableBuilder[Self <: ParamsResourceAccountsClientsGet] (val x: Self) extends AnyVal {
