...
object ParamsResourceAccountsProposalsList {
  ...
  implicit class ParamsResourceAccountsProposalsListOps[Self <: ParamsResourceAccountsProposalsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFilterSyntax(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("filterSyntax")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFilterSyntax: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("filterSyntax")(js.undefined)
        ret
    }
    @scala.inline
