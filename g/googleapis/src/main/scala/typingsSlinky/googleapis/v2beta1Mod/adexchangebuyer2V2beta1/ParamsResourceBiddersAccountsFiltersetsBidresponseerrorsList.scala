...
object ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList] (val x: Self) extends AnyVal {
