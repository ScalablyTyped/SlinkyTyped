...
@js.native
trait ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList extends StandardParameters {
  /**
...
object ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList {
  @scala.inline
  def apply(): ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList]
  }
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsListOps[Self <: ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList] (val x: Self) extends AnyVal {
    @scala.inline
