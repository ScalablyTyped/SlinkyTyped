...
@js.native
trait ParamsDollarResourceDollarLayersDollarVolumeannotationsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLayersDollarVolumeannotationsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarLayersDollarVolumeannotationsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLayersDollarVolumeannotationsDollarList]
  }
}
