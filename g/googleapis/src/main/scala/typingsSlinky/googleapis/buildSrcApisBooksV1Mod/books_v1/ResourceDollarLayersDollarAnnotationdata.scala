package typingsSlinky.googleapis.buildSrcApisBooksV1Mod.books_v1
...
@js.native
class ResourceDollarLayersDollarAnnotationdata protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(): GaxiosPromise[Schema$Annotationdata] = js.native
  def get(callback: BodyResponseCallback[Schema$Annotationdata]): Unit = js.native
  def get(params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet): GaxiosPromise[Schema$Annotationdata] = js.native
  def get(
    params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet,
    callback: BodyResponseCallback[Schema$Annotationdata]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet,
    options: BodyResponseCallback[Schema$Annotationdata],
    callback: BodyResponseCallback[Schema$Annotationdata]
  ): Unit = js.native
  def get(params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet, options: MethodOptions): GaxiosPromise[Schema$Annotationdata] = js.native
  def get(
    params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$Annotationsdata] = js.native
  def list(callback: BodyResponseCallback[Schema$Annotationsdata]): Unit = js.native
  def list(params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarList): GaxiosPromise[Schema$Annotationsdata] = js.native
  def list(
    params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarList,
    callback: BodyResponseCallback[Schema$Annotationsdata]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarList,
    options: BodyResponseCallback[Schema$Annotationsdata],
    callback: BodyResponseCallback[Schema$Annotationsdata]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarList, options: MethodOptions): GaxiosPromise[Schema$Annotationsdata] = js.native
  def list(
    params: ParamsDollarResourceDollarLayersDollarAnnotationdataDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Annotationsdata]
