...
@js.native
trait ParamsDollarResourceDollarVolumesDollarAssociatedDollarList extends StandardParameters {
  /**
    * Association type.
    */
...
object ParamsDollarResourceDollarVolumesDollarAssociatedDollarList {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarVolumesDollarAssociatedDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVolumesDollarAssociatedDollarList]
  }
}
