...
@js.native
trait ParamsDollarResourceDollarOnboardingDollarListcategoryvolumes extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOnboardingDollarListcategoryvolumes {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOnboardingDollarListcategoryvolumes = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOnboardingDollarListcategoryvolumes]
  }
}
