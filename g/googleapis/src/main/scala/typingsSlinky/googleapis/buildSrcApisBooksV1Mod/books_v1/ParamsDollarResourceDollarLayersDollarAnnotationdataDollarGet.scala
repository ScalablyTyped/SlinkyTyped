...
@js.native
trait ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet {
  @scala.inline
  def apply(
    ...
    w: Int | Double = null
  ): ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLayersDollarAnnotationdataDollarGet]
  }
}
