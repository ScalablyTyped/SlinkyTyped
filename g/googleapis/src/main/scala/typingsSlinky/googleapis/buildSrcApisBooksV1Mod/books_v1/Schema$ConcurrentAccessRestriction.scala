...
@js.native
trait Schema$ConcurrentAccessRestriction extends js.Object {
  /**
...
object Schema$ConcurrentAccessRestriction {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ConcurrentAccessRestriction]
  }
}
