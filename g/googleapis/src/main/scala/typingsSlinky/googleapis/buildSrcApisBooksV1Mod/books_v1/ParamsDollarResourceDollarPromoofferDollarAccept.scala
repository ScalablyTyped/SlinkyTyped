...
@js.native
trait ParamsDollarResourceDollarPromoofferDollarAccept extends StandardParameters {
  /**
    * device android_id
    */
...
object ParamsDollarResourceDollarPromoofferDollarAccept {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarPromoofferDollarAccept = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPromoofferDollarAccept]
  }
}
