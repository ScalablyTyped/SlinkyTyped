...
@js.native
trait ParamsDollarResourceDollarCloudloadingDollarAddbook extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCloudloadingDollarAddbook {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCloudloadingDollarAddbook = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCloudloadingDollarAddbook]
  }
}
