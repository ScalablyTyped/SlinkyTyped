...
@js.native
trait ParamsDollarResourceDollarMyconfigDollarSyncvolumelicenses extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMyconfigDollarSyncvolumelicenses {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarMyconfigDollarSyncvolumelicenses = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMyconfigDollarSyncvolumelicenses]
  }
}
