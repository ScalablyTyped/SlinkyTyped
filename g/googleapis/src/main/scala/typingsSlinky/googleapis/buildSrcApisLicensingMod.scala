...
import typingsSlinky.googleapis.buildSrcApisLicensingV1Mod.licensing_v1.Licensing
import typingsSlinky.googleapis.buildSrcApisLicensingV1Mod.licensing_v1.Options
