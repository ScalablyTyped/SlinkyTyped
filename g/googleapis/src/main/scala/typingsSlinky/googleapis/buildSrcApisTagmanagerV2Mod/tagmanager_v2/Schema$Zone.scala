...
trait Schema$Zone extends js.Object {
  ...
  /**
    ...
    */
  var boundary: js.UndefOr[Schema$ZoneBoundary] = js.native
  /**
    * Containers that are children of this Zone.
    */
  var childContainer: js.UndefOr[js.Array[Schema$ZoneChildContainer]] = js.native
  /**
    * GTM Container ID.
    */
  ...
  /**
    ...
    */
  var typeRestriction: js.UndefOr[Schema$ZoneTypeRestriction] = js.native
  /**
    * GTM Workspace ID.
    */
...
object Schema$Zone {
  ...
  def apply(
    ...
    boundary: Schema$ZoneBoundary = null,
    childContainer: js.Array[Schema$ZoneChildContainer] = null,
    ...
    typeRestriction: Schema$ZoneTypeRestriction = null,
