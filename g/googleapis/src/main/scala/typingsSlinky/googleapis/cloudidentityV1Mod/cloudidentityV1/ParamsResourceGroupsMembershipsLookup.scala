...
object ParamsResourceGroupsMembershipsLookup {
  ...
  implicit class ParamsResourceGroupsMembershipsLookupOps[Self <: ParamsResourceGroupsMembershipsLookup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMemberKeyDotid(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("memberKey.id")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMemberKeyDotid: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("memberKey.id")(js.undefined)
        ret
    }
    @scala.inline
    def withMemberKeyDotnamespace(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("memberKey.namespace")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMemberKeyDotnamespace: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("memberKey.namespace")(js.undefined)
        ret
    }
    @scala.inline
