...
object ParamsResourceAlertsUndelete {
  ...
  @scala.inline
  implicit class ParamsResourceAlertsUndeleteOps[Self <: ParamsResourceAlertsUndelete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUndeleteAlertRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
