...
/**
  ...
  */
@js.native
trait Schema$RemarketingAudiences extends js.Object {
  /**
    * A list of remarketing audiences.
    */
  var items: js.UndefOr[js.Array[Schema$RemarketingAudience]] = js.native
  /**
...
object Schema$RemarketingAudiences {
  @scala.inline
  def apply(
    items: js.Array[Schema$RemarketingAudience] = null,
    ...
    __obj.asInstanceOf[Schema$RemarketingAudiences]
  }
}
