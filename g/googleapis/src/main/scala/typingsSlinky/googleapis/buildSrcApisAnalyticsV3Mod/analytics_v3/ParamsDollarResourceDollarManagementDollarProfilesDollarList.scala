...
@js.native
trait ParamsDollarResourceDollarManagementDollarProfilesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarProfilesDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarProfilesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarProfilesDollarList]
  }
}
