...
/**
  ...
  */
@js.native
trait Schema$AccountSummaries extends js.Object {
  /**
    * A list of AccountSummaries.
    */
  var items: js.UndefOr[js.Array[Schema$AccountSummary]] = js.native
  /**
...
object Schema$AccountSummaries {
  @scala.inline
  def apply(
    items: js.Array[Schema$AccountSummary] = null,
    ...
    __obj.asInstanceOf[Schema$AccountSummaries]
  }
}
