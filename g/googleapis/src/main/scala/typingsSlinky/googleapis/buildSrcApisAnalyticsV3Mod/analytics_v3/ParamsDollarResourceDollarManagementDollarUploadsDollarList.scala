...
@js.native
trait ParamsDollarResourceDollarManagementDollarUploadsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarUploadsDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarUploadsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarUploadsDollarList]
  }
}
