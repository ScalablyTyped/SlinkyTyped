...
/**
  ...
  */
@js.native
trait Schema$Experiments extends js.Object {
  /**
    * A list of experiments.
    */
  var items: js.UndefOr[js.Array[Schema$Experiment]] = js.native
  /**
...
object Schema$Experiments {
  @scala.inline
  def apply(
    items: js.Array[Schema$Experiment] = null,
    ...
    __obj.asInstanceOf[Schema$Experiments]
  }
}
