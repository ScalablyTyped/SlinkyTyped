...
import typingsSlinky.googleapis.Anon_Effective
...
/**
  ...
  */
@js.native
trait Schema$Webproperty extends js.Object {
  /**
...
object Schema$Webproperty {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$Webproperty]
  }
}
