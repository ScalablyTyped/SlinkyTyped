...
@js.native
trait ParamsDollarResourceDollarDataDollarMcfDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDataDollarMcfDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDataDollarMcfDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDataDollarMcfDollarGet]
  }
}
