...
/**
  ...
  */
@js.native
trait Schema$ProfileFilterLinks extends js.Object {
  /**
    * A list of profile filter links.
    */
  var items: js.UndefOr[js.Array[Schema$ProfileFilterLink]] = js.native
  /**
...
object Schema$ProfileFilterLinks {
  @scala.inline
  def apply(
    items: js.Array[Schema$ProfileFilterLink] = null,
    ...
    __obj.asInstanceOf[Schema$ProfileFilterLinks]
  }
}
