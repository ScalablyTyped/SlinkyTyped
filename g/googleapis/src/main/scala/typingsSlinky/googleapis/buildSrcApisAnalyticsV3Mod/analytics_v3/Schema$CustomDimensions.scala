...
/**
  ...
  */
@js.native
trait Schema$CustomDimensions extends js.Object {
  /**
    * Collection of custom dimensions.
    */
  var items: js.UndefOr[js.Array[Schema$CustomDimension]] = js.native
  /**
...
object Schema$CustomDimensions {
  @scala.inline
  def apply(
    items: js.Array[Schema$CustomDimension] = null,
    ...
    __obj.asInstanceOf[Schema$CustomDimensions]
  }
}
