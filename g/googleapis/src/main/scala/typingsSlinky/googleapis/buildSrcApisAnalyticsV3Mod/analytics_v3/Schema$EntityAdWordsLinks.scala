...
/**
  ...
  */
@js.native
trait Schema$EntityAdWordsLinks extends js.Object {
  /**
    * A list of entity Google Ads links.
    */
  var items: js.UndefOr[js.Array[Schema$EntityAdWordsLink]] = js.native
  /**
...
object Schema$EntityAdWordsLinks {
  @scala.inline
  def apply(
    items: js.Array[Schema$EntityAdWordsLink] = null,
    ...
    __obj.asInstanceOf[Schema$EntityAdWordsLinks]
  }
}
