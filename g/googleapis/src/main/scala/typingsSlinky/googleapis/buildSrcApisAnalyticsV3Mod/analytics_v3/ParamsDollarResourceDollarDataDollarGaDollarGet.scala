...
@js.native
trait ParamsDollarResourceDollarDataDollarGaDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDataDollarGaDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDataDollarGaDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDataDollarGaDollarGet]
  }
}
