...
@js.native
trait ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarPatch {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarPatch]
  }
}
