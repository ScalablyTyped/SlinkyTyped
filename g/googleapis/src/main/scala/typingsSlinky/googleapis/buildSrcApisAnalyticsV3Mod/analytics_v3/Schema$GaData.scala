...
import typingsSlinky.googleapis.Anon_AccountId
import typingsSlinky.googleapis.Anon_Cols
import typingsSlinky.googleapis.Anon_ColumnType
import typingsSlinky.googleapis.Anon_Dimensions
...
/**
  ...
  */
@js.native
trait Schema$GaData extends js.Object {
  /**
  ...
  var dataTable: js.UndefOr[Anon_Cols] = js.native
  /**
...
object Schema$GaData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$GaData]
  }
}
