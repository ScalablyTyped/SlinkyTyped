...
/**
  ...
  */
@js.native
trait Schema$EntityUserLinks extends js.Object {
  /**
    * A list of entity user links.
    */
  var items: js.UndefOr[js.Array[Schema$EntityUserLink]] = js.native
  /**
...
object Schema$EntityUserLinks {
  @scala.inline
  def apply(
    items: js.Array[Schema$EntityUserLink] = null,
    ...
    __obj.asInstanceOf[Schema$EntityUserLinks]
  }
}
