...
@js.native
trait ParamsDollarResourceDollarManagementDollarAccountuserlinksDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarAccountuserlinksDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagementDollarAccountuserlinksDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarAccountuserlinksDollarList]
  }
}
