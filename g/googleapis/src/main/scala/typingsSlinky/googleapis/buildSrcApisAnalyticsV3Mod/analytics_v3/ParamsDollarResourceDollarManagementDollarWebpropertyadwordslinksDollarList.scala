...
@js.native
trait ParamsDollarResourceDollarManagementDollarWebpropertyadwordslinksDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarWebpropertyadwordslinksDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarWebpropertyadwordslinksDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarWebpropertyadwordslinksDollarList]
  }
}
