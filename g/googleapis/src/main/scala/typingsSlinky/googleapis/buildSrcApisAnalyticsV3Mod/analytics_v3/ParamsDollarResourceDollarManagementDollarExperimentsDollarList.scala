...
@js.native
trait ParamsDollarResourceDollarManagementDollarExperimentsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarExperimentsDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarExperimentsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarExperimentsDollarList]
  }
}
