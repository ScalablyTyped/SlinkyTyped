...
object ParamsResourceTestenvironmentcatalogGet {
  ...
  @scala.inline
  implicit class ParamsResourceTestenvironmentcatalogGetOps[Self <: ParamsResourceTestenvironmentcatalogGet] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withoutEnvironmentType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("environmentType")(js.undefined)
        ret
    }
    @scala.inline
