...
object SchemaCertificateInfo {
  ...
  implicit class SchemaCertificateInfoOps[Self <: SchemaCertificateInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSha256Fingerprint(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sha256Fingerprint")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSha256Fingerprint: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sha256Fingerprint")(js.undefined)
        ret
    }
  }
