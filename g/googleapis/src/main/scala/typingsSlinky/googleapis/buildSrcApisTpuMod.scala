...
import typingsSlinky.googleapis.buildSrcApisTpuV1Mod.tpu_v1.Options
import typingsSlinky.googleapis.buildSrcApisTpuV1Mod.tpu_v1.Tpu
...
object buildSrcApisTpuMod extends js.Object {
  ...
  def tpu(options: typingsSlinky.googleapis.buildSrcApisTpuV1alpha1Mod.tpu_v1alpha1.Options): typingsSlinky.googleapis.buildSrcApisTpuV1alpha1Mod.tpu_v1alpha1.Tpu = js.native
  @JSName("tpu")
  def tpu_v1(version: v1): Tpu = js.native
  @JSName("tpu")
  def tpu_v1alpha1(version: v1alpha1): typingsSlinky.googleapis.buildSrcApisTpuV1alpha1Mod.tpu_v1alpha1.Tpu = js.native
  @js.native
  object VERSIONS extends js.Object {
    ...
    class v1alpha1 protected ()
      extends typingsSlinky.googleapis.buildSrcApisTpuV1alpha1Mod.tpu_v1alpha1.Tpu {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v1alpha1
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisTpuV1alpha1Mod.tpu_v1alpha1.Tpu
              ]
            ]
