...
/**
  ...
  */
@js.native
trait Schema$BatchUpdateValuesResponse extends js.Object {
  /**
    * One UpdateValuesResponse per requested range, in the same order as the
    * requests appeared.
    */
  var responses: js.UndefOr[js.Array[Schema$UpdateValuesResponse]] = js.native
  /**
...
object Schema$BatchUpdateValuesResponse {
  @scala.inline
  def apply(
    responses: js.Array[Schema$UpdateValuesResponse] = null,
    ...
    __obj.asInstanceOf[Schema$BatchUpdateValuesResponse]
  }
}
