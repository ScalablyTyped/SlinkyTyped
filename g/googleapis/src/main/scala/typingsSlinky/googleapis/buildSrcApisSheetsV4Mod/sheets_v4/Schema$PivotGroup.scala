...
/**
  ...
  */
@js.native
trait Schema$PivotGroup extends js.Object {
  /**
    * The group rule to apply to this row/column group.
    */
  var groupRule: js.UndefOr[Schema$PivotGroupRule] = js.native
  /**
  ...
  /**
    ...
    */
  var valueBucket: js.UndefOr[Schema$PivotGroupSortValueBucket] = js.native
  /**
    * Metadata about values in the grouping.
    */
  var valueMetadata: js.UndefOr[js.Array[Schema$PivotGroupValueMetadata]] = js.native
}

object Schema$PivotGroup {
  @scala.inline
  def apply(
    groupRule: Schema$PivotGroupRule = null,
    label: String = null,
    ...
    valueBucket: Schema$PivotGroupSortValueBucket = null,
    valueMetadata: js.Array[Schema$PivotGroupValueMetadata] = null
  ): Schema$PivotGroup = {
    ...
    __obj.asInstanceOf[Schema$PivotGroup]
  }
}
