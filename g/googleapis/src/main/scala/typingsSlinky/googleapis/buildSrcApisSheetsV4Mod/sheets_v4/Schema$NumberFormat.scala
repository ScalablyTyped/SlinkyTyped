...
/**
  ...
  */
@js.native
trait Schema$NumberFormat extends js.Object {
  /**
...
object Schema$NumberFormat {
  @scala.inline
  def apply(pattern: String = null, `type`: String = null): Schema$NumberFormat = {
    val __obj = js.Dynamic.literal()
    if (pattern != null) __obj.updateDynamic("pattern")(pattern.asInstanceOf[js.Any])
    if (`type` != null) __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$NumberFormat]
  }
}
