...
/**
  ...
  */
@js.native
trait Schema$TextRotation extends js.Object {
  /**
...
object Schema$TextRotation {
  @scala.inline
  def apply(angle: Int | Double = null, vertical: js.UndefOr[Boolean] = js.undefined): Schema$TextRotation = {
    val __obj = js.Dynamic.literal()
    if (angle != null) __obj.updateDynamic("angle")(angle.asInstanceOf[js.Any])
    if (!js.isUndefined(vertical)) __obj.updateDynamic("vertical")(vertical.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$TextRotation]
  }
}
