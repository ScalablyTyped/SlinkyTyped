...
/**
  ...
  */
@js.native
trait Schema$SpreadsheetProperties extends js.Object {
  /**
  ...
  /**
    ...
    */
  var defaultFormat: js.UndefOr[Schema$CellFormat] = js.native
  /**
    ...
    */
  var iterativeCalculationSettings: js.UndefOr[Schema$IterativeCalculationSettings] = js.native
  /**
...
object Schema$SpreadsheetProperties {
  @scala.inline
  def apply(
    autoRecalc: String = null,
    defaultFormat: Schema$CellFormat = null,
    iterativeCalculationSettings: Schema$IterativeCalculationSettings = null,
    locale: String = null,
    timeZone: String = null,
    title: String = null
  ): Schema$SpreadsheetProperties = {
    ...
    __obj.asInstanceOf[Schema$SpreadsheetProperties]
  }
}
