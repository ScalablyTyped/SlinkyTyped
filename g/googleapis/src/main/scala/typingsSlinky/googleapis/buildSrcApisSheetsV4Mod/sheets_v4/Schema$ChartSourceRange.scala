...
/**
  ...
  */
@js.native
trait Schema$ChartSourceRange extends js.Object {
  /**
    ...
    */
  var sources: js.UndefOr[js.Array[Schema$GridRange]] = js.native
}

object Schema$ChartSourceRange {
  @scala.inline
  def apply(sources: js.Array[Schema$GridRange] = null): Schema$ChartSourceRange = {
    val __obj = js.Dynamic.literal()
    if (sources != null) __obj.updateDynamic("sources")(sources.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ChartSourceRange]
  }
}
