...
/**
  ...
  */
@js.native
trait Schema$WaterfallChartCustomSubtotal extends js.Object {
  /**
...
object Schema$WaterfallChartCustomSubtotal {
  @scala.inline
  def apply(
    dataIsSubtotal: js.UndefOr[Boolean] = js.undefined,
    label: String = null,
    subtotalIndex: Int | Double = null
  ): Schema$WaterfallChartCustomSubtotal = {
    ...
    __obj.asInstanceOf[Schema$WaterfallChartCustomSubtotal]
  }
}
