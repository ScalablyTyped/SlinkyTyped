...
/**
  ...
  */
@js.native
trait Schema$TreemapChartSpec extends js.Object {
  /**
    ...
    * background colors.
    */
  var colorData: js.UndefOr[Schema$ChartData] = js.native
  /**
    ...
    */
  var colorScale: js.UndefOr[Schema$TreemapChartColorScale] = js.native
  /**
  ...
  /**
    ...
    */
  var sizeData: js.UndefOr[Schema$ChartData] = js.native
  /**
...
object Schema$TreemapChartSpec {
  @scala.inline
  def apply(
    colorData: Schema$ChartData = null,
    colorScale: Schema$TreemapChartColorScale = null,
    ...
    sizeData: Schema$ChartData = null,
    textFormat: Schema$TextFormat = null
  ): Schema$TreemapChartSpec = {
    ...
    __obj.asInstanceOf[Schema$TreemapChartSpec]
  }
}
