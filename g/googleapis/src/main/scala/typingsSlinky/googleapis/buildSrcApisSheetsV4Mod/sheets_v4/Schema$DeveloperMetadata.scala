...
/**
  ...
  */
@js.native
trait Schema$DeveloperMetadata extends js.Object {
  /**
    * The location where the metadata is associated.
    */
  var location: js.UndefOr[Schema$DeveloperMetadataLocation] = js.native
  /**
...
object Schema$DeveloperMetadata {
  @scala.inline
  def apply(
    location: Schema$DeveloperMetadataLocation = null,
    metadataId: Int | Double = null,
    metadataKey: String = null,
    metadataValue: String = null,
    visibility: String = null
  ): Schema$DeveloperMetadata = {
    ...
    __obj.asInstanceOf[Schema$DeveloperMetadata]
  }
}
