...
/**
  ...
  */
@js.native
trait Schema$HistogramRule extends js.Object {
  /**
...
object Schema$HistogramRule {
  @scala.inline
  def apply(end: Int | Double = null, interval: Int | Double = null, start: Int | Double = null): Schema$HistogramRule = {
    val __obj = js.Dynamic.literal()
    if (end != null) __obj.updateDynamic("end")(end.asInstanceOf[js.Any])
    if (interval != null) __obj.updateDynamic("interval")(interval.asInstanceOf[js.Any])
    if (start != null) __obj.updateDynamic("start")(start.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$HistogramRule]
  }
}
