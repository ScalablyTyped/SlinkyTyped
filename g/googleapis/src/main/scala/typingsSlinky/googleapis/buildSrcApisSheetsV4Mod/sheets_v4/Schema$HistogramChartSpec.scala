...
/**
  ...
  */
@js.native
trait Schema$HistogramChartSpec extends js.Object {
  /**
  ...
  /**
    ...
    */
  var series: js.UndefOr[js.Array[Schema$HistogramSeries]] = js.native
  /**
...
object Schema$HistogramChartSpec {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$HistogramChartSpec]
  }
}
