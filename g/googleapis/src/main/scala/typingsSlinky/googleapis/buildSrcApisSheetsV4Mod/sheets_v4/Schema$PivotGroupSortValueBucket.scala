...
/**
  ...
  */
@js.native
trait Schema$PivotGroupSortValueBucket extends js.Object {
  /**
    ...
    */
  var buckets: js.UndefOr[js.Array[Schema$ExtendedValue]] = js.native
  /**
...
object Schema$PivotGroupSortValueBucket {
  @scala.inline
  def apply(buckets: js.Array[Schema$ExtendedValue] = null, valuesIndex: Int | Double = null): Schema$PivotGroupSortValueBucket = {
    ...
    __obj.asInstanceOf[Schema$PivotGroupSortValueBucket]
  }
}
