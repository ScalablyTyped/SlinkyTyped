...
/**
  ...
  */
@js.native
trait Schema$BasicChartSpec extends js.Object {
  /**
    * The axis on the chart.
    */
  var axis: js.UndefOr[js.Array[Schema$BasicChartAxis]] = js.native
  /**
  ...
  /**
    ...
    */
  var domains: js.UndefOr[js.Array[Schema$BasicChartDomain]] = js.native
  /**
  ...
  /**
    ...
    */
  var series: js.UndefOr[js.Array[Schema$BasicChartSeries]] = js.native
  /**
...
object Schema$BasicChartSpec {
  @scala.inline
  def apply(
    axis: js.Array[Schema$BasicChartAxis] = null,
    chartType: String = null,
    compareMode: String = null,
    domains: js.Array[Schema$BasicChartDomain] = null,
    ...
    __obj.asInstanceOf[Schema$BasicChartSpec]
  }
}
