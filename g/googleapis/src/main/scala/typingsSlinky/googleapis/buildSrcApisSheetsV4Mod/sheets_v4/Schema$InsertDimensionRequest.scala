...
/**
  ...
  */
@js.native
trait Schema$InsertDimensionRequest extends js.Object {
  /**
...
object Schema$InsertDimensionRequest {
  @scala.inline
  def apply(inheritFromBefore: js.UndefOr[Boolean] = js.undefined, range: Schema$DimensionRange = null): Schema$InsertDimensionRequest = {
    ...
    __obj.asInstanceOf[Schema$InsertDimensionRequest]
  }
}
