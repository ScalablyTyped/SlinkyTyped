...
/**
  ...
  */
@js.native
trait Schema$BatchUpdateValuesByDataFilterRequest extends js.Object {
  /**
    * The new values to apply to the spreadsheet.  If more than one range is
    * matched by the specified DataFilter the specified values will be applied
    * to all of those ranges.
    */
  var data: js.UndefOr[js.Array[Schema$DataFilterValueRange]] = js.native
  /**
...
object Schema$BatchUpdateValuesByDataFilterRequest {
  @scala.inline
  def apply(
    data: js.Array[Schema$DataFilterValueRange] = null,
  ...
  ): Schema$BatchUpdateValuesByDataFilterRequest = {
    ...
    __obj.asInstanceOf[Schema$BatchUpdateValuesByDataFilterRequest]
  }
}
