...
/**
  ...
  */
@js.native
trait Schema$ExtendedValue extends js.Object {
  /**
  ...
  /**
    ...
    */
  var errorValue: js.UndefOr[Schema$ErrorValue] = js.native
  /**
...
object Schema$ExtendedValue {
  @scala.inline
  def apply(
    boolValue: js.UndefOr[Boolean] = js.undefined,
    errorValue: Schema$ErrorValue = null,
    ...
    __obj.asInstanceOf[Schema$ExtendedValue]
  }
}
