...
/**
  ...
  */
@js.native
trait Schema$FindReplaceRequest extends js.Object {
  /**
...
object Schema$FindReplaceRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$FindReplaceRequest]
  }
}
