...
/**
  ...
  */
@js.native
trait Schema$FindReplaceResponse extends js.Object {
  /**
...
object Schema$FindReplaceResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$FindReplaceResponse]
  }
}
