...
/**
  ...
  */
@js.native
trait Schema$ManualRuleGroup extends js.Object {
  /**
    * The group name, which must be a string. Each group in a given ManualRule
    * must have a unique group name.
    */
  var groupName: js.UndefOr[Schema$ExtendedValue] = js.native
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$ExtendedValue]] = js.native
}

object Schema$ManualRuleGroup {
  @scala.inline
  def apply(groupName: Schema$ExtendedValue = null, items: js.Array[Schema$ExtendedValue] = null): Schema$ManualRuleGroup = {
    val __obj = js.Dynamic.literal()
    if (groupName != null) __obj.updateDynamic("groupName")(groupName.asInstanceOf[js.Any])
    if (items != null) __obj.updateDynamic("items")(items.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ManualRuleGroup]
  }
}
