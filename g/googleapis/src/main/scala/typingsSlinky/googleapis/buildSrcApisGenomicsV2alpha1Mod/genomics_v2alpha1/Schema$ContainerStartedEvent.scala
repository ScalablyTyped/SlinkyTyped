...
/**
  ...
  */
@js.native
trait Schema$ContainerStartedEvent extends js.Object {
  /**
...
object Schema$ContainerStartedEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$ContainerStartedEvent]
  }
}
