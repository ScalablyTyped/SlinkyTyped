...
trait Schema$Action extends js.Object {
  ...
  /**
    ...
    */
  var credentials: js.UndefOr[Schema$Secret] = js.native
  /**
  ...
  /**
    ...
    * output.&lt;/li&gt; &lt;/ul&gt;
    */
  var mounts: js.UndefOr[js.Array[Schema$Mount]] = js.native
  /**
