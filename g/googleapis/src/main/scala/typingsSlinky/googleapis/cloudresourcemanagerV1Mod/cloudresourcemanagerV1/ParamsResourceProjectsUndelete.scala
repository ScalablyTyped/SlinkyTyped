...
object ParamsResourceProjectsUndelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsUndeleteOps[Self <: ParamsResourceProjectsUndelete] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUndeleteProjectRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
