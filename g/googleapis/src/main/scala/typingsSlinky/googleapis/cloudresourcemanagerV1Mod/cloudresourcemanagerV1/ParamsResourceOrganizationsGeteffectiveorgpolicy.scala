...
object ParamsResourceOrganizationsGeteffectiveorgpolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsGeteffectiveorgpolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsGeteffectiveorgpolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsGeteffectiveorgpolicyMutableBuilder[Self <: ParamsResourceOrganizationsGeteffectiveorgpolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGetEffectiveOrgPolicyRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
