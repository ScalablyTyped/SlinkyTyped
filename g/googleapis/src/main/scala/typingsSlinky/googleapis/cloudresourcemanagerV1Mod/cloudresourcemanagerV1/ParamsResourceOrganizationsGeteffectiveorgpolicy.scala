...
object ParamsResourceOrganizationsGeteffectiveorgpolicy {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsGeteffectiveorgpolicyOps[Self <: ParamsResourceOrganizationsGeteffectiveorgpolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGetEffectiveOrgPolicyRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
