...
object ParamsResourceFoldersListorgpolicies {
  ...
  @scala.inline
  implicit class ParamsResourceFoldersListorgpoliciesOps[Self <: ParamsResourceFoldersListorgpolicies] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaListOrgPoliciesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
