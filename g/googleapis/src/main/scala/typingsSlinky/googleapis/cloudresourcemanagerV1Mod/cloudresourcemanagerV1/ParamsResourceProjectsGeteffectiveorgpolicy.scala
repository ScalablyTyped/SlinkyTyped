...
object ParamsResourceProjectsGeteffectiveorgpolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsGeteffectiveorgpolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsGeteffectiveorgpolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsGeteffectiveorgpolicyMutableBuilder[Self <: ParamsResourceProjectsGeteffectiveorgpolicy] (val x: Self) extends AnyVal {
