...
/**
  ...
  */
@js.native
trait Schema$InstantiateWorkflowTemplateRequest extends js.Object {
  /**
...
object Schema$InstantiateWorkflowTemplateRequest {
  @scala.inline
  def apply(
    parameters: StringDictionary[String] = null,
    requestId: String = null,
    version: Int | Double = null
  ): Schema$InstantiateWorkflowTemplateRequest = {
    val __obj = js.Dynamic.literal()
    if (parameters != null) __obj.updateDynamic("parameters")(parameters.asInstanceOf[js.Any])
    if (requestId != null) __obj.updateDynamic("requestId")(requestId.asInstanceOf[js.Any])
    if (version != null) __obj.updateDynamic("version")(version.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$InstantiateWorkflowTemplateRequest]
  }
}
