package typingsSlinky.googleapis.buildSrcApisJobsV3p1beta1Mod.jobs_v3p1beta1
...
/**
  ...
  */
@js.native
trait Schema$SearchJobsRequest extends js.Object {
  /**
    * Optional.  Controls over how job documents get ranked on top of existing
    * relevance score (determined by API algorithm).
    */
  var customRankingInfo: js.UndefOr[Schema$CustomRankingInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var histogramFacets: js.UndefOr[Schema$HistogramFacets] = js.native
  /**
    * Optional.  Expression based histogram requests for jobs matching
    * JobQuery.
    */
  var histogramQueries: js.UndefOr[js.Array[Schema$HistogramQuery]] = js.native
  /**
    * Optional.  Query used to search against jobs, such as keyword, location
    * filters, etc.
    */
  var jobQuery: js.UndefOr[Schema$JobQuery] = js.native
  /**
...
object Schema$SearchJobsRequest {
  @scala.inline
  def apply(
    customRankingInfo: Schema$CustomRankingInfo = null,
    ...
    histogramFacets: Schema$HistogramFacets = null,
    histogramQueries: js.Array[Schema$HistogramQuery] = null,
    jobQuery: Schema$JobQuery = null,
    jobView: String = null,
    ...
    __obj.asInstanceOf[Schema$SearchJobsRequest]
  }
}
