...
/**
  ...
  */
@js.native
trait Schema$CommuteFilter extends js.Object {
  /**
  ...
  /**
    ...
    */
  var departureTime: js.UndefOr[Schema$TimeOfDay] = js.native
  /**
  ...
  /**
    ...
    */
  var startCoordinates: js.UndefOr[Schema$LatLng] = js.native
  /**
...
object Schema$CommuteFilter {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$CommuteFilter]
  }
}
