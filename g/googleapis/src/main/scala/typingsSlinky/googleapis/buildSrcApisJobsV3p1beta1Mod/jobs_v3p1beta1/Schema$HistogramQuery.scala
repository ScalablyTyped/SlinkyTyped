...
/**
  ...
  */
@js.native
trait Schema$HistogramQuery extends js.Object {
  /**
...
object Schema$HistogramQuery {
  @scala.inline
  def apply(histogramQuery: String = null): Schema$HistogramQuery = {
    val __obj = js.Dynamic.literal()
    if (histogramQuery != null) __obj.updateDynamic("histogramQuery")(histogramQuery.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$HistogramQuery]
  }
}
