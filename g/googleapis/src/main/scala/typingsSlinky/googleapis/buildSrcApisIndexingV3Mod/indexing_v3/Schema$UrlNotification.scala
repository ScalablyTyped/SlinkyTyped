package typingsSlinky.googleapis.buildSrcApisIndexingV3Mod.indexing_v3
...
/**
  ...
  */
@js.native
trait Schema$UrlNotification extends js.Object {
  /**
...
object Schema$UrlNotification {
  @scala.inline
  def apply(notifyTime: String = null, `type`: String = null, url: String = null): Schema$UrlNotification = {
    val __obj = js.Dynamic.literal()
    if (notifyTime != null) __obj.updateDynamic("notifyTime")(notifyTime.asInstanceOf[js.Any])
    if (`type` != null) __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    if (url != null) __obj.updateDynamic("url")(url.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$UrlNotification]
  }
}
