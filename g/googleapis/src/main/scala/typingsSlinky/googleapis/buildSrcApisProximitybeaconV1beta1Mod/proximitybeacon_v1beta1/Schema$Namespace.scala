...
/**
  ...
  */
@js.native
trait Schema$Namespace extends js.Object {
  /**
...
object Schema$Namespace {
  @scala.inline
  def apply(namespaceName: String = null, servingVisibility: String = null): Schema$Namespace = {
    ...
    __obj.asInstanceOf[Schema$Namespace]
  }
}
