...
/**
  ...
  */
@js.native
trait Schema$EphemeralIdRegistration extends js.Object {
  /**
...
object Schema$EphemeralIdRegistration {
  @scala.inline
  def apply(
  ...
  ): Schema$EphemeralIdRegistration = {
    ...
    __obj.asInstanceOf[Schema$EphemeralIdRegistration]
  }
}
