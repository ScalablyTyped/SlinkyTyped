...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1Vertex extends js.Object {
  /**
    * X coordinate.
    */
...
object SchemaGoogleCloudVisionV1p2beta1Vertex {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1VertexOps[Self <: SchemaGoogleCloudVisionV1p2beta1Vertex] (val x: Self) extends AnyVal {
    @scala.inline
