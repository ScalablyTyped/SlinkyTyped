...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1Symbol extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p1beta1Symbol {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1SymbolOps[Self <: SchemaGoogleCloudVisionV1p1beta1Symbol] (val x: Self) extends AnyVal {
    @scala.inline
