...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1Symbol extends StObject {
...
object SchemaGoogleCloudVisionV1p1beta1Symbol {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p1beta1Symbol = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1Symbol]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1SymbolMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1Symbol] (val x: Self) extends AnyVal {
