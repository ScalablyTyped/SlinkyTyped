...
object SchemaGoogleCloudVisionV1p3beta1WebDetectionWebLabel {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1WebDetectionWebLabelMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebLabel] (val x: Self) extends AnyVal {
