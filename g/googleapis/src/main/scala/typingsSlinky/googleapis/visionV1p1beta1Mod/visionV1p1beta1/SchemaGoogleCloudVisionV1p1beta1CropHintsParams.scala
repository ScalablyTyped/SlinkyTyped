...
object SchemaGoogleCloudVisionV1p1beta1CropHintsParams {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1CropHintsParamsMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1CropHintsParams] (val x: Self) extends AnyVal {
