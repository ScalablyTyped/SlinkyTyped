...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1Block extends js.Object {
...
object SchemaGoogleCloudVisionV1p1beta1Block {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1BlockOps[Self <: SchemaGoogleCloudVisionV1p1beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParagraphsVarargs(value: SchemaGoogleCloudVisionV1p1beta1Paragraph*): Self = this.set("paragraphs", js.Array(value :_*))
    
    @scala.inline
    def setParagraphs(value: js.Array[SchemaGoogleCloudVisionV1p1beta1Paragraph]): Self = this.set("paragraphs", value.asInstanceOf[js.Any])
