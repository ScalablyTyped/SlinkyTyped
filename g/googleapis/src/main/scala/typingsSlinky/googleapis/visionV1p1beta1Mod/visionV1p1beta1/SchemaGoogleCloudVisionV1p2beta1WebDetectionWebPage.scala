...
object SchemaGoogleCloudVisionV1p2beta1WebDetectionWebPage {
  ...
  implicit class SchemaGoogleCloudVisionV1p2beta1WebDetectionWebPageOps[Self <: SchemaGoogleCloudVisionV1p2beta1WebDetectionWebPage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFullMatchingImages(value: js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebImage]): Self = {
    ...
    @scala.inline
    def withPartialMatchingImages(value: js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebImage]): Self = {
        val ret = this.duplicate
