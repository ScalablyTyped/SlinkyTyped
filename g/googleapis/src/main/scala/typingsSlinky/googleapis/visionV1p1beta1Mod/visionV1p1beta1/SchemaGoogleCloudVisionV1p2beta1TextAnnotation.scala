...
object SchemaGoogleCloudVisionV1p2beta1TextAnnotation {
  ...
  implicit class SchemaGoogleCloudVisionV1p2beta1TextAnnotationOps[Self <: SchemaGoogleCloudVisionV1p2beta1TextAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPagesVarargs(value: SchemaGoogleCloudVisionV1p2beta1Page*): Self = this.set("pages", js.Array(value :_*))
    
    @scala.inline
    def setPages(value: js.Array[SchemaGoogleCloudVisionV1p2beta1Page]): Self = this.set("pages", value.asInstanceOf[js.Any])
