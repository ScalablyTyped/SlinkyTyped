...
object SchemaGoogleCloudVisionV1p1beta1TextAnnotationTextProperty {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1TextAnnotationTextPropertyOps[Self <: SchemaGoogleCloudVisionV1p1beta1TextAnnotationTextProperty] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDetectedBreak(value: SchemaGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak): Self = this.set("detectedBreak", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDetectedBreak: Self = this.set("detectedBreak", js.undefined)
    
    @scala.inline
    def setDetectedLanguagesVarargs(value: SchemaGoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage*): Self = this.set("detectedLanguages", js.Array(value :_*))
    
    @scala.inline
    def setDetectedLanguages(value: js.Array[SchemaGoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage]): Self = this.set("detectedLanguages", value.asInstanceOf[js.Any])
