...
trait SchemaGoogleCloudVisionV1p1beta1ImageContext extends js.Object {
  /**
    ...
    */
  var cropHintsParams: js.UndefOr[SchemaGoogleCloudVisionV1p1beta1CropHintsParams] = js.native
  /**
  ...
  /**
    * Not used.
    */
  var latLongRect: js.UndefOr[SchemaGoogleCloudVisionV1p1beta1LatLongRect] = js.native
  /**
    * Parameters for product search.
    */
  var productSearchParams: js.UndefOr[SchemaGoogleCloudVisionV1p1beta1ProductSearchParams] = js.native
  /**
    * Parameters for web detection.
    */
  var webDetectionParams: js.UndefOr[SchemaGoogleCloudVisionV1p1beta1WebDetectionParams] = js.native
}
