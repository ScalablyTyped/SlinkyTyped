...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1Word extends StObject {
  ...
  /**
    ...
    * reading order.
    */
  var symbols: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p1beta1Symbol]] = js.native
}
object SchemaGoogleCloudVisionV1p1beta1Word {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p1beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1Word]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1WordMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1Word] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBoundingBox(value: SchemaGoogleCloudVisionV1p1beta1BoundingPoly): Self = StObject.set(x, "boundingBox", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSymbols(value: js.Array[SchemaGoogleCloudVisionV1p1beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    @scala.inline
    def setSymbolsVarargs(value: SchemaGoogleCloudVisionV1p1beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value :_*))
  }
}
