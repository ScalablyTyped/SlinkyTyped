...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1FaceAnnotation extends js.Object {
  /**
    * Anger likelihood.
    */
...
object SchemaGoogleCloudVisionV1p3beta1FaceAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1FaceAnnotationOps[Self <: SchemaGoogleCloudVisionV1p3beta1FaceAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFdBoundingPoly(value: SchemaGoogleCloudVisionV1p3beta1BoundingPoly): Self = this.set("fdBoundingPoly", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLandmarksVarargs(value: SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark*): Self = this.set("landmarks", js.Array(value :_*))
    @scala.inline
    def setLandmarks(value: js.Array[SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark]): Self = this.set("landmarks", value.asInstanceOf[js.Any])
    @scala.inline
