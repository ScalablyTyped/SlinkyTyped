...
object SchemaGoogleCloudVisionV1p3beta1FaceAnnotation {
  ...
  def apply(
    ...
    fdBoundingPoly: SchemaGoogleCloudVisionV1p3beta1BoundingPoly = null,
    headwearLikelihood: String = null,
    joyLikelihood: String = null,
    landmarkingConfidence: js.UndefOr[Double] = js.undefined,
    landmarks: js.Array[SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark] = null,
  ...
  ): SchemaGoogleCloudVisionV1p3beta1FaceAnnotation = {
