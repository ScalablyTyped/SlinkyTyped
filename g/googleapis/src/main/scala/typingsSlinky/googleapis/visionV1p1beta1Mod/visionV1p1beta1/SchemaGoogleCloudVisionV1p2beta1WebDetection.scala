...
object SchemaGoogleCloudVisionV1p2beta1WebDetection {
  ...
  implicit class SchemaGoogleCloudVisionV1p2beta1WebDetectionOps[Self <: SchemaGoogleCloudVisionV1p2beta1WebDetection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBestGuessLabels(value: js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebLabel]): Self = {
    ...
    @scala.inline
    def withPagesWithMatchingImages(value: js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebPage]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVisuallySimilarImages(value: js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebImage]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWebEntities(value: js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebEntity]): Self = {
        val ret = this.duplicate
