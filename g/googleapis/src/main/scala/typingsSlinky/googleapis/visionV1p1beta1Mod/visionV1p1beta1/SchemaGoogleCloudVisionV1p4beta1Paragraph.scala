...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p4beta1Paragraph extends StObject {
  ...
  /**
    ...
    */
  var words: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p4beta1Word]] = js.native
}
object SchemaGoogleCloudVisionV1p4beta1Paragraph {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1ParagraphMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1Paragraph] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVisionV1p4beta1Word]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVisionV1p4beta1Word*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
