...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1Page extends StObject {
...
object SchemaGoogleCloudVisionV1p3beta1Page {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p3beta1Page = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1Page]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1PageMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1Page] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBlocks(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Block]): Self = StObject.set(x, "blocks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBlocksUndefined: Self = StObject.set(x, "blocks", js.undefined)
    
    @scala.inline
    def setBlocksVarargs(value: SchemaGoogleCloudVisionV1p3beta1Block*): Self = StObject.set(x, "blocks", js.Array(value :_*))
