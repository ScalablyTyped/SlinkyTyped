...
object SchemaGoogleCloudVisionV1p3beta1Page {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1PageOps[Self <: SchemaGoogleCloudVisionV1p3beta1Page] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlocksVarargs(value: SchemaGoogleCloudVisionV1p3beta1Block*): Self = this.set("blocks", js.Array(value :_*))
    
    @scala.inline
    def setBlocks(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Block]): Self = this.set("blocks", value.asInstanceOf[js.Any])
