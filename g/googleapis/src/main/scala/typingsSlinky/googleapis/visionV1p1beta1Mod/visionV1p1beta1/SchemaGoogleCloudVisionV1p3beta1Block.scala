...
object SchemaGoogleCloudVisionV1p3beta1Block {
  ...
  implicit class SchemaGoogleCloudVisionV1p3beta1BlockOps[Self <: SchemaGoogleCloudVisionV1p3beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParagraphsVarargs(value: SchemaGoogleCloudVisionV1p3beta1Paragraph*): Self = this.set("paragraphs", js.Array(value :_*))
    @scala.inline
    def setParagraphs(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Paragraph]): Self = this.set("paragraphs", value.asInstanceOf[js.Any])
    @scala.inline
