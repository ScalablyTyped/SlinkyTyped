...
object SchemaGoogleCloudVisionV1p2beta1OutputConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1OutputConfigOps[Self <: SchemaGoogleCloudVisionV1p2beta1OutputConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setGcsDestination(value: SchemaGoogleCloudVisionV1p2beta1GcsDestination): Self = this.set("gcsDestination", value.asInstanceOf[js.Any])
    @scala.inline
