...
object SchemaGoogleCloudVisionV1p2beta1OutputConfig {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1OutputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1OutputConfig]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1OutputConfigMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: SchemaGoogleCloudVisionV1p2beta1GcsDestination): Self = StObject.set(x, "gcsDestination", value.asInstanceOf[js.Any])
