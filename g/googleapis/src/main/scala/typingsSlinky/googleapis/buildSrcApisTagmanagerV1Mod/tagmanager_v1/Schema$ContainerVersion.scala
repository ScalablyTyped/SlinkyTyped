...
/**
  ...
  */
@js.native
trait Schema$ContainerVersion extends js.Object {
  /**
    * GTM Account ID.
    */
  ...
  /**
    ...
    */
  var container: js.UndefOr[Schema$Container] = js.native
  /**
    * GTM Container ID.
    */
  ...
  /**
    ...
    */
  var `macro`: js.UndefOr[js.Array[Schema$Macro]] = js.native
  /**
  ...
  /**
    ...
    */
  var rule: js.UndefOr[js.Array[Schema$Rule]] = js.native
  /**
...
object Schema$ContainerVersion {
  @scala.inline
  def apply(
    accountId: String = null,
    container: Schema$Container = null,
    containerId: String = null,
    containerVersionId: String = null,
    deleted: js.UndefOr[Boolean] = js.undefined,
    fingerprint: String = null,
    folder: js.Array[Schema$Folder] = null,
    `macro`: js.Array[Schema$Macro] = null,
    name: String = null,
    notes: String = null,
    rule: js.Array[Schema$Rule] = null,
    tag: js.Array[Schema$Tag] = null,
    trigger: js.Array[Schema$Trigger] = null,
    variable: js.Array[Schema$Variable] = null
  ): Schema$ContainerVersion = {
    ...
    __obj.asInstanceOf[Schema$ContainerVersion]
  }
}
