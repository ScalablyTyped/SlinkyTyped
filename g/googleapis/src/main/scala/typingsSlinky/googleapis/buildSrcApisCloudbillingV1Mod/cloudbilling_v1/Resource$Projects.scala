...
class Resource$Projects protected () extends js.Object {
  ...
  /**
    ...
    */
  def getBillingInfo(): GaxiosPromise[Schema$ProjectBillingInfo] = js.native
  def getBillingInfo(callback: BodyResponseCallback[Schema$ProjectBillingInfo]): Unit = js.native
  def getBillingInfo(params: ParamsDollarResourceDollarProjectsDollarGetbillinginfo): GaxiosPromise[Schema$ProjectBillingInfo] = js.native
  def getBillingInfo(
    params: ParamsDollarResourceDollarProjectsDollarGetbillinginfo,
    callback: BodyResponseCallback[Schema$ProjectBillingInfo]
  ): Unit = js.native
  def getBillingInfo(
    params: ParamsDollarResourceDollarProjectsDollarGetbillinginfo,
    options: BodyResponseCallback[Schema$ProjectBillingInfo],
    callback: BodyResponseCallback[Schema$ProjectBillingInfo]
  ): Unit = js.native
  def getBillingInfo(params: ParamsDollarResourceDollarProjectsDollarGetbillinginfo, options: MethodOptions): GaxiosPromise[Schema$ProjectBillingInfo] = js.native
  def getBillingInfo(
    params: ParamsDollarResourceDollarProjectsDollarGetbillinginfo,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def updateBillingInfo(): GaxiosPromise[Schema$ProjectBillingInfo] = js.native
  def updateBillingInfo(callback: BodyResponseCallback[Schema$ProjectBillingInfo]): Unit = js.native
  def updateBillingInfo(params: ParamsDollarResourceDollarProjectsDollarUpdatebillinginfo): GaxiosPromise[Schema$ProjectBillingInfo] = js.native
  def updateBillingInfo(
    params: ParamsDollarResourceDollarProjectsDollarUpdatebillinginfo,
    callback: BodyResponseCallback[Schema$ProjectBillingInfo]
  ): Unit = js.native
  def updateBillingInfo(
    params: ParamsDollarResourceDollarProjectsDollarUpdatebillinginfo,
  ...
  def updateBillingInfo(params: ParamsDollarResourceDollarProjectsDollarUpdatebillinginfo, options: MethodOptions): GaxiosPromise[Schema$ProjectBillingInfo] = js.native
  def updateBillingInfo(
    params: ParamsDollarResourceDollarProjectsDollarUpdatebillinginfo,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ProjectBillingInfo]
