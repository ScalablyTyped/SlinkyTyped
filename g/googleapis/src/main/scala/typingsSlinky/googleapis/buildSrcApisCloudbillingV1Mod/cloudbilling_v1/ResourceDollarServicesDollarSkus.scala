...
@js.native
class ResourceDollarServicesDollarSkus protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListSkusResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListSkusResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarServicesDollarSkusDollarList): GaxiosPromise[Schema$ListSkusResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarServicesDollarSkusDollarList,
    callback: BodyResponseCallback[Schema$ListSkusResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarServicesDollarSkusDollarList,
    options: BodyResponseCallback[Schema$ListSkusResponse],
    callback: BodyResponseCallback[Schema$ListSkusResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarServicesDollarSkusDollarList, options: MethodOptions): GaxiosPromise[Schema$ListSkusResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarServicesDollarSkusDollarList,
