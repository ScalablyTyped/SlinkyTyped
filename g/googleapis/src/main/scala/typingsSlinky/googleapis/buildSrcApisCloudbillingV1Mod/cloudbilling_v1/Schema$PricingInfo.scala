...
/**
  ...
  */
@js.native
trait Schema$PricingInfo extends js.Object {
  /**
    * Aggregation Info. This can be left unspecified if the pricing expression
    * doesn&#39;t require aggregation.
    */
  var aggregationInfo: js.UndefOr[Schema$AggregationInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var pricingExpression: js.UndefOr[Schema$PricingExpression] = js.native
  /**
...
object Schema$PricingInfo {
  @scala.inline
  def apply(
    aggregationInfo: Schema$AggregationInfo = null,
    currencyConversionRate: Int | Double = null,
    effectiveTime: String = null,
    pricingExpression: Schema$PricingExpression = null,
    summary: String = null
  ): Schema$PricingInfo = {
    ...
    __obj.asInstanceOf[Schema$PricingInfo]
  }
}
