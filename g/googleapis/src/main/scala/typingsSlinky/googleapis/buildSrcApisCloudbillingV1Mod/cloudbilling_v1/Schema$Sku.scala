...
/**
  ...
  */
@js.native
trait Schema$Sku extends js.Object {
  /**
    * The category hierarchy of this SKU, purely for organizational purpose.
    */
  var category: js.UndefOr[Schema$Category] = js.native
  /**
  ...
  /**
    ...
    */
  var pricingInfo: js.UndefOr[js.Array[Schema$PricingInfo]] = js.native
  /**
...
object Schema$Sku {
  ...
  def apply(
    ...
    name: String = null,
    pricingInfo: js.Array[Schema$PricingInfo] = null,
