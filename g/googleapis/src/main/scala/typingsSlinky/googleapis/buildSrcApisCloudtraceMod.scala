...
import typingsSlinky.googleapis.buildSrcApisCloudtraceV1Mod.cloudtrace_v1.Cloudtrace
import typingsSlinky.googleapis.buildSrcApisCloudtraceV1Mod.cloudtrace_v1.Options
...
object buildSrcApisCloudtraceMod extends js.Object {
  ...
  def cloudtrace(options: typingsSlinky.googleapis.buildSrcApisCloudtraceV2Mod.cloudtrace_v2.Options): typingsSlinky.googleapis.buildSrcApisCloudtraceV2Mod.cloudtrace_v2.Cloudtrace = js.native
  @JSName("cloudtrace")
  def cloudtrace_v1(version: v1): Cloudtrace = js.native
  @JSName("cloudtrace")
  def cloudtrace_v2(version: v2): typingsSlinky.googleapis.buildSrcApisCloudtraceV2Mod.cloudtrace_v2.Cloudtrace = js.native
  @js.native
    ...
    object v2
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisCloudtraceV2Mod.cloudtrace_v2.Cloudtrace
              ]
            ]
