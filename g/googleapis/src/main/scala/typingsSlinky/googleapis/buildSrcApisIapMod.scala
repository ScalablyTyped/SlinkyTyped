...
@js.native
object buildSrcApisIapMod extends js.Object {
  def iap(options: Options): Iap = js.native
  def iap(options: typingsSlinky.googleapis.buildSrcApisIapV1beta1Mod.iap_v1beta1.Options): typingsSlinky.googleapis.buildSrcApisIapV1beta1Mod.iap_v1beta1.Iap = js.native
  @JSName("iap")
  def iap_v1(version: v1): Iap = js.native
  @JSName("iap")
  def iap_v1beta1(version: v1beta1): typingsSlinky.googleapis.buildSrcApisIapV1beta1Mod.iap_v1beta1.Iap = js.native
  @js.native
  object VERSIONS extends js.Object {
    ...
    class v1beta1 protected ()
      extends typingsSlinky.googleapis.buildSrcApisIapV1beta1Mod.iap_v1beta1.Iap {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v1beta1
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisIapV1beta1Mod.iap_v1beta1.Iap
              ]
            ]
