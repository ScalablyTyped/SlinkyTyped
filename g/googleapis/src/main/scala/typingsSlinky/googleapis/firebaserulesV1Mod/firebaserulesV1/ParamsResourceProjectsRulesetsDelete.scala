...
object ParamsResourceProjectsRulesetsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsRulesetsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRulesetsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsRulesetsDeleteMutableBuilder[Self <: ParamsResourceProjectsRulesetsDelete] (val x: Self) extends AnyVal {
