...
object ParamsResourceProjectsReleasesCreate {
  @scala.inline
  def apply(): ParamsResourceProjectsReleasesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsReleasesCreate]
  }
  @scala.inline
  implicit class ParamsResourceProjectsReleasesCreateOps[Self <: ParamsResourceProjectsReleasesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaRelease): Self = {
        val ret = this.duplicate
