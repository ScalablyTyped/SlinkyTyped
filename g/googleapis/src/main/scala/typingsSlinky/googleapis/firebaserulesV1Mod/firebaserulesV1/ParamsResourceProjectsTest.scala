...
object ParamsResourceProjectsTest {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsTestMutableBuilder[Self <: ParamsResourceProjectsTest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTestRulesetRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
