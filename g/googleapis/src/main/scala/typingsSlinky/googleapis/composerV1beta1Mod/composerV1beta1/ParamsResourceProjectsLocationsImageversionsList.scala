...
object ParamsResourceProjectsLocationsImageversionsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsImageversionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsImageversionsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsImageversionsListMutableBuilder[Self <: ParamsResourceProjectsLocationsImageversionsList] (val x: Self) extends AnyVal {
