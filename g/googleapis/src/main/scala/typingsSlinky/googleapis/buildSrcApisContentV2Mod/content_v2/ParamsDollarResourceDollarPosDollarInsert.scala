...
@js.native
trait ParamsDollarResourceDollarPosDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$PosStore] = js.native
  /**
...
object ParamsDollarResourceDollarPosDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$PosStore = null,
    targetMerchantId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarPosDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPosDollarInsert]
  }
}
