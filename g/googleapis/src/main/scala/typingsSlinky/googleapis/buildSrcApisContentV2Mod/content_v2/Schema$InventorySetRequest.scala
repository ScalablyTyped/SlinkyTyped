...
@js.native
trait Schema$InventorySetRequest extends js.Object {
  /**
  ...
  /**
    ...
    * supported&quot;.
    */
  var pickup: js.UndefOr[Schema$InventoryPickup] = js.native
  /**
...
object Schema$InventorySetRequest {
  @scala.inline
  def apply(
    ...
    pickup: Schema$InventoryPickup = null,
    ...
    __obj.asInstanceOf[Schema$InventorySetRequest]
  }
}
