...
class Resource$Datafeeds protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def patch(): GaxiosPromise[Schema$Datafeed] = js.native
  def patch(callback: BodyResponseCallback[Schema$Datafeed]): Unit = js.native
  def patch(params: ParamsDollarResourceDollarDatafeedsDollarPatch): GaxiosPromise[Schema$Datafeed] = js.native
  def patch(
    params: ParamsDollarResourceDollarDatafeedsDollarPatch,
    callback: BodyResponseCallback[Schema$Datafeed]
  ): Unit = js.native
  def patch(
    params: ParamsDollarResourceDollarDatafeedsDollarPatch,
  ...
  def patch(params: ParamsDollarResourceDollarDatafeedsDollarPatch, options: MethodOptions): GaxiosPromise[Schema$Datafeed] = js.native
  def patch(
    params: ParamsDollarResourceDollarDatafeedsDollarPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Datafeed]
