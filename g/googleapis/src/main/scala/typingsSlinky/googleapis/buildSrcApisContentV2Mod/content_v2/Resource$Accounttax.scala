...
class Resource$Accounttax protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def patch(): GaxiosPromise[Schema$AccountTax] = js.native
  def patch(callback: BodyResponseCallback[Schema$AccountTax]): Unit = js.native
  def patch(params: ParamsDollarResourceDollarAccounttaxDollarPatch): GaxiosPromise[Schema$AccountTax] = js.native
  def patch(
    params: ParamsDollarResourceDollarAccounttaxDollarPatch,
    callback: BodyResponseCallback[Schema$AccountTax]
  ): Unit = js.native
  def patch(
    params: ParamsDollarResourceDollarAccounttaxDollarPatch,
  ...
  def patch(params: ParamsDollarResourceDollarAccounttaxDollarPatch, options: MethodOptions): GaxiosPromise[Schema$AccountTax] = js.native
  def patch(
    params: ParamsDollarResourceDollarAccounttaxDollarPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$AccountTax]
