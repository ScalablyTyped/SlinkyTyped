...
@js.native
trait Schema$OrdersShipLineItemsResponse extends js.Object {
  /**
...
object Schema$OrdersShipLineItemsResponse {
  @scala.inline
  def apply(executionStatus: String = null, kind: String = null): Schema$OrdersShipLineItemsResponse = {
    val __obj = js.Dynamic.literal()
    if (executionStatus != null) __obj.updateDynamic("executionStatus")(executionStatus.asInstanceOf[js.Any])
    if (kind != null) __obj.updateDynamic("kind")(kind.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$OrdersShipLineItemsResponse]
  }
}
