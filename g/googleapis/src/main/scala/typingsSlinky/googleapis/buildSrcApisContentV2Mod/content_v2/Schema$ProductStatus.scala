...
trait Schema$ProductStatus extends js.Object {
  ...
  /**
    ...
    */
  var dataQualityIssues: js.UndefOr[js.Array[Schema$ProductStatusDataQualityIssue]] = js.native
  /**
...
object Schema$ProductStatus {
  ...
  def apply(
    ...
    dataQualityIssues: js.Array[Schema$ProductStatusDataQualityIssue] = null,
