...
@js.native
trait Schema$OrdersCustomBatchRequestEntryRejectReturnLineItem extends js.Object {
  /**
...
object Schema$OrdersCustomBatchRequestEntryRejectReturnLineItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$OrdersCustomBatchRequestEntryRejectReturnLineItem]
  }
}
