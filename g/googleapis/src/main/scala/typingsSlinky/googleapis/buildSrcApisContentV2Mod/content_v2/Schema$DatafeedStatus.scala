...
/**
  ...
  */
@js.native
trait Schema$DatafeedStatus extends js.Object {
  /**
  ...
  /**
    ...
    */
  var errors: js.UndefOr[js.Array[Schema$DatafeedStatusError]] = js.native
  /**
  ...
  /**
    * The list of errors occurring in the feed.
    */
  var warnings: js.UndefOr[js.Array[Schema$DatafeedStatusError]] = js.native
}

object Schema$DatafeedStatus {
  @scala.inline
  def apply(
    country: String = null,
    datafeedId: String = null,
    errors: js.Array[Schema$DatafeedStatusError] = null,
    ...
    warnings: js.Array[Schema$DatafeedStatusError] = null
  ): Schema$DatafeedStatus = {
    ...
    __obj.asInstanceOf[Schema$DatafeedStatus]
  }
}
