...
/**
  ...
  */
@js.native
trait Schema$Datafeed extends js.Object {
  /**
  ...
  /**
    ...
    */
  var fetchSchedule: js.UndefOr[Schema$DatafeedFetchSchedule] = js.native
  /**
  ...
  /**
    ...
    */
  var format: js.UndefOr[Schema$DatafeedFormat] = js.native
  /**
  ...
  /**
    ...
    */
  var targets: js.UndefOr[js.Array[Schema$DatafeedTarget]] = js.native
}

object Schema$Datafeed {
  @scala.inline
  def apply(
    attributeLanguage: String = null,
    contentLanguage: String = null,
    contentType: String = null,
    fetchSchedule: Schema$DatafeedFetchSchedule = null,
    fileName: String = null,
    format: Schema$DatafeedFormat = null,
    id: String = null,
    intendedDestinations: js.Array[String] = null,
    kind: String = null,
    name: String = null,
    targetCountry: String = null,
    targets: js.Array[Schema$DatafeedTarget] = null
  ): Schema$Datafeed = {
    ...
    __obj.asInstanceOf[Schema$Datafeed]
  }
}
