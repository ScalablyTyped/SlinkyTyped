...
@js.native
trait Schema$ProductAspect extends js.Object {
  /**
...
object Schema$ProductAspect {
  @scala.inline
  def apply(aspectName: String = null, destinationName: String = null, intention: String = null): Schema$ProductAspect = {
    ...
    __obj.asInstanceOf[Schema$ProductAspect]
  }
}
