...
@js.native
trait Schema$OrdersRejectReturnLineItemRequest extends js.Object {
  /**
...
object Schema$OrdersRejectReturnLineItemRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$OrdersRejectReturnLineItemRequest = {
    ...
    __obj.asInstanceOf[Schema$OrdersRejectReturnLineItemRequest]
  }
}
