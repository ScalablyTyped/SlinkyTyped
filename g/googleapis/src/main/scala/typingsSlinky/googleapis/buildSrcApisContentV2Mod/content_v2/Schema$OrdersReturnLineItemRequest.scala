...
@js.native
trait Schema$OrdersReturnLineItemRequest extends js.Object {
  /**
...
object Schema$OrdersReturnLineItemRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$OrdersReturnLineItemRequest = {
    ...
    __obj.asInstanceOf[Schema$OrdersReturnLineItemRequest]
  }
}
