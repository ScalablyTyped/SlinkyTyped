...
@js.native
trait ParamsDollarResourceDollarOrderreportsDollarListdisbursements extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrderreportsDollarListdisbursements {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOrderreportsDollarListdisbursements = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrderreportsDollarListdisbursements]
  }
}
