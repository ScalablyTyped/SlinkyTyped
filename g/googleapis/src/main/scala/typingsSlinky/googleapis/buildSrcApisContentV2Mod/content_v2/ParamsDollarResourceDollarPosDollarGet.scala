...
@js.native
trait ParamsDollarResourceDollarPosDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPosDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPosDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPosDollarGet]
  }
}
