...
/**
  ...
  */
@js.native
trait Schema$AccounttaxCustomBatchRequestEntry extends js.Object {
  /**
...
object Schema$AccounttaxCustomBatchRequestEntry {
  @scala.inline
  def apply(
    ...
    method: String = null
  ): Schema$AccounttaxCustomBatchRequestEntry = {
    ...
    __obj.asInstanceOf[Schema$AccounttaxCustomBatchRequestEntry]
  }
}
