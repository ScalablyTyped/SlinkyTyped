...
@js.native
trait ParamsDollarResourceDollarInventoryDollarSet extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$InventorySetRequest] = js.native
  /**
...
object ParamsDollarResourceDollarInventoryDollarSet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$InventorySetRequest = null,
    storeCode: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarInventoryDollarSet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInventoryDollarSet]
  }
}
