...
@js.native
trait ParamsDollarResourceDollarAccountsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarDelete {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarDelete]
  }
}
