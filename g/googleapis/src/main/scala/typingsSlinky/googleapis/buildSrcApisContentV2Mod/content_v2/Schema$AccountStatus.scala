...
trait Schema$AccountStatus extends js.Object {
  ...
  /**
    ...
    */
  var dataQualityIssues: js.UndefOr[js.Array[Schema$AccountStatusDataQualityIssue]] = js.native
  /**
...
object Schema$AccountStatus {
  ...
  def apply(
    ...
    dataQualityIssues: js.Array[Schema$AccountStatusDataQualityIssue] = null,
    kind: String = null,
