...
@js.native
trait Schema$OrdersCustomBatchRequestEntryUpdateShipment extends js.Object {
  /**
...
object Schema$OrdersCustomBatchRequestEntryUpdateShipment {
  @scala.inline
  def apply(
    carrier: String = null,
  ...
  ): Schema$OrdersCustomBatchRequestEntryUpdateShipment = {
    ...
    __obj.asInstanceOf[Schema$OrdersCustomBatchRequestEntryUpdateShipment]
  }
}
