...
@js.native
trait Schema$AccountYouTubeChannelLink extends js.Object {
  /**
    * Channel ID.
    */
...
object Schema$AccountYouTubeChannelLink {
  @scala.inline
  def apply(channelId: String = null, status: String = null): Schema$AccountYouTubeChannelLink = {
    val __obj = js.Dynamic.literal()
    if (channelId != null) __obj.updateDynamic("channelId")(channelId.asInstanceOf[js.Any])
    if (status != null) __obj.updateDynamic("status")(status.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$AccountYouTubeChannelLink]
  }
}
