...
@js.native
trait ParamsDollarResourceDollarOrderreportsDollarListtransactions extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrderreportsDollarListtransactions {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOrderreportsDollarListtransactions = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrderreportsDollarListtransactions]
  }
}
