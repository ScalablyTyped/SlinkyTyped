...
@js.native
trait Schema$LoyaltyPoints extends js.Object {
  /**
...
object Schema$LoyaltyPoints {
  @scala.inline
  def apply(name: String = null, pointsValue: String = null, ratio: Int | Double = null): Schema$LoyaltyPoints = {
    val __obj = js.Dynamic.literal()
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (pointsValue != null) __obj.updateDynamic("pointsValue")(pointsValue.asInstanceOf[js.Any])
    if (ratio != null) __obj.updateDynamic("ratio")(ratio.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$LoyaltyPoints]
  }
}
