...
import typingsSlinky.googleapis.tagmanagerV1Mod.tagmanagerV1.Options
...
object tagmanagerMod {
  ...
  object VERSIONS {
    ...
    def v2: Instantiable2[
        ...
        typingsSlinky.googleapis.tagmanagerV2Mod.tagmanagerV2.Tagmanager
      ] = js.native
    @scala.inline
    def v2_=(
      x: Instantiable2[
  ...
  object auth extends Shortcut {
    ...
    object DefaultTransporter {
      ...
      @JSImport("googleapis/build/src/apis/tagmanager", "auth.DefaultTransporter.constructor")
      @js.native
  ...
  @JSImport("googleapis/build/src/apis/tagmanager", "tagmanager")
  @js.native
