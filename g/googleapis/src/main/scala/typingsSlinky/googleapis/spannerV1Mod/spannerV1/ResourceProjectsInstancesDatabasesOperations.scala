...
class ResourceProjectsInstancesDatabasesOperations protected () extends StObject {
  ...
  def cancel(params: ParamsResourceProjectsInstancesDatabasesOperationsCancel, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def cancel(
    params: ParamsResourceProjectsInstancesDatabasesOperationsCancel,
  ...
  def delete(params: ParamsResourceProjectsInstancesDatabasesOperationsDelete, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def delete(
    params: ParamsResourceProjectsInstancesDatabasesOperationsDelete,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaEmpty]
  ...
  def get(params: ParamsResourceProjectsInstancesDatabasesOperationsGet, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def get(
    params: ParamsResourceProjectsInstancesDatabasesOperationsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  def list(params: ParamsResourceProjectsInstancesDatabasesOperationsList, options: MethodOptions): GaxiosPromise[SchemaListOperationsResponse] = js.native
  def list(
    params: ParamsResourceProjectsInstancesDatabasesOperationsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListOperationsResponse]
