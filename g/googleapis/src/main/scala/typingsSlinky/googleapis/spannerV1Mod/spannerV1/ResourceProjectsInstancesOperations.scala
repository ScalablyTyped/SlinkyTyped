...
@js.native
class ResourceProjectsInstancesOperations protected () extends StObject {
  ...
  def cancel(params: ParamsResourceProjectsInstancesOperationsCancel): GaxiosPromise[SchemaEmpty] = js.native
  def cancel(
    params: ParamsResourceProjectsInstancesOperationsCancel,
  ...
  def cancel(params: ParamsResourceProjectsInstancesOperationsCancel, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def cancel(
    params: ParamsResourceProjectsInstancesOperationsCancel,
  ...
  def delete(params: ParamsResourceProjectsInstancesOperationsDelete): GaxiosPromise[SchemaEmpty] = js.native
  def delete(
    params: ParamsResourceProjectsInstancesOperationsDelete,
    callback: BodyResponseCallback[SchemaEmpty]
  ): Unit = js.native
  def delete(
    params: ParamsResourceProjectsInstancesOperationsDelete,
  ...
  def delete(params: ParamsResourceProjectsInstancesOperationsDelete, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def delete(
    params: ParamsResourceProjectsInstancesOperationsDelete,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaEmpty]
  ...
  def get(params: ParamsResourceProjectsInstancesOperationsGet): GaxiosPromise[SchemaOperation] = js.native
  def get(
    params: ParamsResourceProjectsInstancesOperationsGet,
  ...
  def get(params: ParamsResourceProjectsInstancesOperationsGet, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def get(
    params: ParamsResourceProjectsInstancesOperationsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  def list(params: ParamsResourceProjectsInstancesOperationsList): GaxiosPromise[SchemaListOperationsResponse] = js.native
  def list(
    params: ParamsResourceProjectsInstancesOperationsList,
  ...
  def list(params: ParamsResourceProjectsInstancesOperationsList, options: MethodOptions): GaxiosPromise[SchemaListOperationsResponse] = js.native
  def list(
    params: ParamsResourceProjectsInstancesOperationsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListOperationsResponse]
