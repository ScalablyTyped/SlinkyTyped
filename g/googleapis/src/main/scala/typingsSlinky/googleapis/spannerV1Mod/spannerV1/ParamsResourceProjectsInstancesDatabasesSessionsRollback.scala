...
object ParamsResourceProjectsInstancesDatabasesSessionsRollback {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSessionsRollbackOps[Self <: ParamsResourceProjectsInstancesDatabasesSessionsRollback] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaRollbackRequest): Self = {
        val ret = this.duplicate
