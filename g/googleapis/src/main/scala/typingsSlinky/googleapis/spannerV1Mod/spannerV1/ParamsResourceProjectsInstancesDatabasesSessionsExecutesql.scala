...
object ParamsResourceProjectsInstancesDatabasesSessionsExecutesql {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSessionsExecutesqlMutableBuilder[Self <: ParamsResourceProjectsInstancesDatabasesSessionsExecutesql] (val x: Self) extends AnyVal {
