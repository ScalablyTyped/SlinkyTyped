...
object ParamsResourceProjectsInstancesDatabasesTestiampermissions {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesTestiampermissionsOps[Self <: ParamsResourceProjectsInstancesDatabasesTestiampermissions] (val x: Self) extends AnyVal {
    @scala.inline
