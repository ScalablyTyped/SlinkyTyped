...
object ParamsResourceProjectsInstancesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesPatchOps[Self <: ParamsResourceProjectsInstancesPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateInstanceRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
