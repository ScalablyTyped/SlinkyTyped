...
object ParamsResourceProjectsInstancesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesPatchMutableBuilder[Self <: ParamsResourceProjectsInstancesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateInstanceRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
