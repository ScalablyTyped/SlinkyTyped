...
object ParamsResourceProjectsInstancesDatabasesList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesDatabasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesDatabasesList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesListMutableBuilder[Self <: ParamsResourceProjectsInstancesDatabasesList] (val x: Self) extends AnyVal {
