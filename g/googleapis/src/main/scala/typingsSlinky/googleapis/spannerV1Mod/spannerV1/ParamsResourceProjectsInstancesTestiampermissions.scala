...
@js.native
trait ParamsResourceProjectsInstancesTestiampermissions extends StandardParameters {
  /**
...
object ParamsResourceProjectsInstancesTestiampermissions {
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesTestiampermissions]
  }
  @scala.inline
  implicit class ParamsResourceProjectsInstancesTestiampermissionsOps[Self <: ParamsResourceProjectsInstancesTestiampermissions] (val x: Self) extends AnyVal {
    @scala.inline
