...
object ParamsResourceProjectsInstancesTestiampermissions {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesTestiampermissionsMutableBuilder[Self <: ParamsResourceProjectsInstancesTestiampermissions] (val x: Self) extends AnyVal {
