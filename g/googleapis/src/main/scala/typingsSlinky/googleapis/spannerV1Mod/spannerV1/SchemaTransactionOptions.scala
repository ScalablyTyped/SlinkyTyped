...
object SchemaTransactionOptions {
  ...
  implicit class SchemaTransactionOptionsOps[Self <: SchemaTransactionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPartitionedDml(value: SchemaPartitionedDml): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("partitionedDml")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPartitionedDml: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("partitionedDml")(js.undefined)
        ret
    }
    @scala.inline
