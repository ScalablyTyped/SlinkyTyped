...
object ParamsResourceProjectsInstancesDatabasesSessionsExecutestreamingsql {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSessionsExecutestreamingsqlOps[Self <: ParamsResourceProjectsInstancesDatabasesSessionsExecutestreamingsql] (val x: Self) extends AnyVal {
    @scala.inline
