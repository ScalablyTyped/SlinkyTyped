...
object ParamsResourceCatalogsProductsVersionsList {
  ...
  @scala.inline
  def apply(): ParamsResourceCatalogsProductsVersionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCatalogsProductsVersionsList]
  }
  
  @scala.inline
  implicit class ParamsResourceCatalogsProductsVersionsListMutableBuilder[Self <: ParamsResourceCatalogsProductsVersionsList] (val x: Self) extends AnyVal {
