...
object ParamsResourceCatalogsAssociationsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceCatalogsAssociationsCreateOps[Self <: ParamsResourceCatalogsAssociationsCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudPrivatecatalogproducerV1beta1CreateAssociationRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
