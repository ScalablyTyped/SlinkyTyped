...
object ParamsResourceCatalogsUndelete {
  ...
  @scala.inline
  implicit class ParamsResourceCatalogsUndeleteOps[Self <: ParamsResourceCatalogsUndelete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudPrivatecatalogproducerV1beta1UndeleteCatalogRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
