...
object ParamsResourceCatalogsAssociationsList {
  
  @scala.inline
  def apply(): ParamsResourceCatalogsAssociationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCatalogsAssociationsList]
  }
  
  @scala.inline
  implicit class ParamsResourceCatalogsAssociationsListMutableBuilder[Self <: ParamsResourceCatalogsAssociationsList] (val x: Self) extends AnyVal {
