package typingsSlinky.googleapis.buildSrcApisIapV1Mod.iap_v1
...
class Resource$V1 protected () extends js.Object {
  ...
  def getIamPolicy(params: ParamsDollarResourceDollarV1DollarGetiampolicy): GaxiosPromise[Schema$Policy] = js.native
  def getIamPolicy(
  ...
  def getIamPolicy(params: ParamsDollarResourceDollarV1DollarGetiampolicy, options: MethodOptions): GaxiosPromise[Schema$Policy] = js.native
  def getIamPolicy(
    params: ParamsDollarResourceDollarV1DollarGetiampolicy,
  ...
  def setIamPolicy(params: ParamsDollarResourceDollarV1DollarSetiampolicy): GaxiosPromise[Schema$Policy] = js.native
  def setIamPolicy(
  ...
  def setIamPolicy(params: ParamsDollarResourceDollarV1DollarSetiampolicy, options: MethodOptions): GaxiosPromise[Schema$Policy] = js.native
  def setIamPolicy(
    params: ParamsDollarResourceDollarV1DollarSetiampolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Policy]
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarV1DollarTestiampermissions): GaxiosPromise[Schema$TestIamPermissionsResponse] = js.native
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarV1DollarTestiampermissions, options: MethodOptions): GaxiosPromise[Schema$TestIamPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarV1DollarTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$TestIamPermissionsResponse]
