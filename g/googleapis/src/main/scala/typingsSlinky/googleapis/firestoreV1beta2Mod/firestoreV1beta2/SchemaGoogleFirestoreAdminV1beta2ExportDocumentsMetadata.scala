...
object SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadata {
  ...
  implicit class SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadataOps[Self <: SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProgressBytes(value: SchemaGoogleFirestoreAdminV1beta2Progress): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withProgressDocuments(value: SchemaGoogleFirestoreAdminV1beta2Progress): Self = {
        val ret = this.duplicate
