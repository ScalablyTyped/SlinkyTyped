...
object SchemaGoogleFirestoreAdminV1beta2Index {
  ...
  implicit class SchemaGoogleFirestoreAdminV1beta2IndexOps[Self <: SchemaGoogleFirestoreAdminV1beta2Index] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFields(value: js.Array[SchemaGoogleFirestoreAdminV1beta2IndexField]): Self = {
    ...
    @scala.inline
    def withQueryScope(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryScope")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutQueryScope: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryScope")(js.undefined)
        ret
    }
    @scala.inline
