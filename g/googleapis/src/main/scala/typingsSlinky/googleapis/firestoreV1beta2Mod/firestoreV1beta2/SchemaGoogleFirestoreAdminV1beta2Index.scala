...
/**
  ...
  */
@js.native
trait SchemaGoogleFirestoreAdminV1beta2Index extends StObject {
...
object SchemaGoogleFirestoreAdminV1beta2Index {
  ...
  @scala.inline
  implicit class SchemaGoogleFirestoreAdminV1beta2IndexMutableBuilder[Self <: SchemaGoogleFirestoreAdminV1beta2Index] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFields(value: js.Array[SchemaGoogleFirestoreAdminV1beta2IndexField]): Self = StObject.set(x, "fields", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFieldsUndefined: Self = StObject.set(x, "fields", js.undefined)
    
    @scala.inline
    def setFieldsVarargs(value: SchemaGoogleFirestoreAdminV1beta2IndexField*): Self = StObject.set(x, "fields", js.Array(value :_*))
