...
object ParamsResourceProjectsDatabasesCollectiongroupsIndexesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesCollectiongroupsIndexesDeleteOps[Self <: ParamsResourceProjectsDatabasesCollectiongroupsIndexesDelete] (val x: Self) extends AnyVal {
