...
object ParamsResourceProjectsDatabasesCollectiongroupsIndexesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsDatabasesCollectiongroupsIndexesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDatabasesCollectiongroupsIndexesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesCollectiongroupsIndexesDeleteMutableBuilder[Self <: ParamsResourceProjectsDatabasesCollectiongroupsIndexesDelete] (val x: Self) extends AnyVal {
