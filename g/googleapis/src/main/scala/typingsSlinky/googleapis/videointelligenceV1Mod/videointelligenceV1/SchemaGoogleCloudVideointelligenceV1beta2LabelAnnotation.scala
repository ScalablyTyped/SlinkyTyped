...
object SchemaGoogleCloudVideointelligenceV1beta2LabelAnnotation {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1beta2LabelAnnotationOps[Self <: SchemaGoogleCloudVideointelligenceV1beta2LabelAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCategoryEntities(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2Entity]): Self = {
    ...
    @scala.inline
    def withEntity(value: SchemaGoogleCloudVideointelligenceV1beta2Entity): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2LabelFrame]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSegments(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2LabelSegment]): Self = {
        val ret = this.duplicate
