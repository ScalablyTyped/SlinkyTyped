...
object SchemaGoogleCloudVideointelligenceV1ExplicitContentDetectionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1ExplicitContentDetectionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1ExplicitContentDetectionConfig] (val x: Self) extends AnyVal {
    @scala.inline
