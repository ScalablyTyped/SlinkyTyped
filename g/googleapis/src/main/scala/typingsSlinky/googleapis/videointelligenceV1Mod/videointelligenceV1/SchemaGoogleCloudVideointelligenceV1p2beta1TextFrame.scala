...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame extends js.Object {
  
  /**
    * Bounding polygon of the detected text for this frame.
    */
  var rotatedBoundingBox: js.UndefOr[SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingPoly] = js.native
...
object SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1TextFrameOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRotatedBoundingBox(value: SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingPoly): Self = this.set("rotatedBoundingBox", value.asInstanceOf[js.Any])
