...
object SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1TextFrameMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setRotatedBoundingBox(value: SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingPoly): Self = StObject.set(x, "rotatedBoundingBox", value.asInstanceOf[js.Any])
