...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p3beta1LabelFrame extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p3beta1LabelFrame {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1LabelFrameMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1LabelFrame] (val x: Self) extends AnyVal {
