...
object SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedVertex {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedVertexMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedVertex] (val x: Self) extends AnyVal {
