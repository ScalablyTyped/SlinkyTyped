...
object SchemaGoogleCloudVideointelligenceV1beta2NormalizedBoundingBox {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1beta2NormalizedBoundingBoxMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1beta2NormalizedBoundingBox] (val x: Self) extends AnyVal {
