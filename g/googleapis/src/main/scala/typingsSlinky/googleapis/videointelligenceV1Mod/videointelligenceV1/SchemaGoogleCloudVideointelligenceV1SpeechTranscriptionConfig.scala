...
object SchemaGoogleCloudVideointelligenceV1SpeechTranscriptionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1SpeechTranscriptionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1SpeechTranscriptionConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpeechContexts(value: js.Array[SchemaGoogleCloudVideointelligenceV1SpeechContext]): Self = StObject.set(x, "speechContexts", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpeechContextsUndefined: Self = StObject.set(x, "speechContexts", js.undefined)
    
    @scala.inline
    def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1SpeechContext*): Self = StObject.set(x, "speechContexts", js.Array(value :_*))
  }
}
