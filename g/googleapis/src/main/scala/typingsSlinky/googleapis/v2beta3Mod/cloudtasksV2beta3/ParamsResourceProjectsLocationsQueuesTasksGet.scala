...
object ParamsResourceProjectsLocationsQueuesTasksGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksGetMutableBuilder[Self <: ParamsResourceProjectsLocationsQueuesTasksGet] (val x: Self) extends AnyVal {
