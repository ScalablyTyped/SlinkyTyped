...
/**
  ...
  */
@js.native
trait Schema$BuildBazelRemoteExecutionV2PlatformProperty extends js.Object {
  /**
    * The property name.
    */
...
object Schema$BuildBazelRemoteExecutionV2PlatformProperty {
  @scala.inline
  def apply(name: String = null, value: String = null): Schema$BuildBazelRemoteExecutionV2PlatformProperty = {
    val __obj = js.Dynamic.literal()
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (value != null) __obj.updateDynamic("value")(value.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BuildBazelRemoteExecutionV2PlatformProperty]
  }
}
