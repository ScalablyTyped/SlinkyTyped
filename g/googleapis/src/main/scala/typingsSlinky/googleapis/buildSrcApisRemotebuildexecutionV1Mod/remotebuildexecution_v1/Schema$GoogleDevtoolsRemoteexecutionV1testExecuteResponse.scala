package typingsSlinky.googleapis.buildSrcApisRemotebuildexecutionV1Mod.remotebuildexecution_v1
...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemoteexecutionV1testExecuteResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var result: js.UndefOr[Schema$GoogleDevtoolsRemoteexecutionV1testActionResult] = js.native
  /**
    ...
    */
  var serverLogs: js.UndefOr[StringDictionary[Schema$GoogleDevtoolsRemoteexecutionV1testLogFile]] = js.native
  /**
...
object Schema$GoogleDevtoolsRemoteexecutionV1testExecuteResponse {
  @scala.inline
  def apply(
    cachedResult: js.UndefOr[Boolean] = js.undefined,
    result: Schema$GoogleDevtoolsRemoteexecutionV1testActionResult = null,
    serverLogs: StringDictionary[Schema$GoogleDevtoolsRemoteexecutionV1testLogFile] = null,
    status: Schema$GoogleRpcStatus = null
  ): Schema$GoogleDevtoolsRemoteexecutionV1testExecuteResponse = {
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemoteexecutionV1testExecuteResponse]
  }
}
