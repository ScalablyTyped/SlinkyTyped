...
import typingsSlinky.googleapis.buildSrcApisContainerV1Mod.container_v1.Container
import typingsSlinky.googleapis.buildSrcApisContainerV1Mod.container_v1.Options
...
object buildSrcApisContainerMod extends js.Object {
  ...
  def container(options: typingsSlinky.googleapis.buildSrcApisContainerV1beta1Mod.container_v1beta1.Options): typingsSlinky.googleapis.buildSrcApisContainerV1beta1Mod.container_v1beta1.Container = js.native
  @JSName("container")
  def container_v1(version: v1): Container = js.native
  @JSName("container")
  def container_v1beta1(version: v1beta1): typingsSlinky.googleapis.buildSrcApisContainerV1beta1Mod.container_v1beta1.Container = js.native
  @js.native
  object VERSIONS extends js.Object {
    ...
    class v1beta1 protected ()
      extends typingsSlinky.googleapis.buildSrcApisContainerV1beta1Mod.container_v1beta1.Container {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v1beta1
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisContainerV1beta1Mod.container_v1beta1.Container
              ]
            ]
