...
object ParamsResourceProjectsLookup {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLookup = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLookup]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLookupMutableBuilder[Self <: ParamsResourceProjectsLookup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaLookupRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
