...
object ParamsResourceProjectsLookup {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLookupOps[Self <: ParamsResourceProjectsLookup] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaLookupRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
