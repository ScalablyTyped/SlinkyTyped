...
object SchemaListTransferJobsResponse {
  ...
  implicit class SchemaListTransferJobsResponseOps[Self <: SchemaListTransferJobsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransferJobsVarargs(value: SchemaTransferJob*): Self = this.set("transferJobs", js.Array(value :_*))
    
    @scala.inline
    def setTransferJobs(value: js.Array[SchemaTransferJob]): Self = this.set("transferJobs", value.asInstanceOf[js.Any])
