...
/**
  ...
  */
@js.native
trait Schema$SegmentFilter extends js.Object {
  /**
  ...
  /**
    ...
    */
  var sequenceSegment: js.UndefOr[Schema$SequenceSegment] = js.native
  /**
    * A Simple segment conditions consist of one or more dimension/metric
    * conditions that can be combined
    */
  var simpleSegment: js.UndefOr[Schema$SimpleSegment] = js.native
}

object Schema$SegmentFilter {
  @scala.inline
  def apply(
    not: js.UndefOr[Boolean] = js.undefined,
    sequenceSegment: Schema$SequenceSegment = null,
    simpleSegment: Schema$SimpleSegment = null
  ): Schema$SegmentFilter = {
    ...
    __obj.asInstanceOf[Schema$SegmentFilter]
  }
}
