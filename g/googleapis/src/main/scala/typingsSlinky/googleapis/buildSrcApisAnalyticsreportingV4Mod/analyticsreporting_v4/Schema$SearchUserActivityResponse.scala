...
/**
  ...
  */
@js.native
trait Schema$SearchUserActivityResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var sessions: js.UndefOr[js.Array[Schema$UserActivitySession]] = js.native
  /**
...
object Schema$SearchUserActivityResponse {
  @scala.inline
  def apply(
    nextPageToken: String = null,
    sampleRate: Int | Double = null,
    sessions: js.Array[Schema$UserActivitySession] = null,
    totalRows: Int | Double = null
  ): Schema$SearchUserActivityResponse = {
    ...
    __obj.asInstanceOf[Schema$SearchUserActivityResponse]
  }
}
