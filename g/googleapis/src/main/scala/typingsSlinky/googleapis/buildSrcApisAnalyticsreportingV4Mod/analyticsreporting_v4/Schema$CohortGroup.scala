...
/**
  ...
  */
@js.native
trait Schema$CohortGroup extends js.Object {
  /**
    * The definition for the cohort.
    */
  var cohorts: js.UndefOr[js.Array[Schema$Cohort]] = js.native
  /**
...
object Schema$CohortGroup {
  @scala.inline
  def apply(cohorts: js.Array[Schema$Cohort] = null, lifetimeValue: js.UndefOr[Boolean] = js.undefined): Schema$CohortGroup = {
    ...
    __obj.asInstanceOf[Schema$CohortGroup]
  }
}
