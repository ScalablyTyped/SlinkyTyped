...
object ParamsResourceOrganizationsInspecttemplatesList {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsInspecttemplatesListMutableBuilder[Self <: ParamsResourceOrganizationsInspecttemplatesList] (val x: Self) extends AnyVal {
