...
object SchemaGooglePrivacyDlpV2Schedule {
  ...
  implicit class SchemaGooglePrivacyDlpV2ScheduleOps[Self <: SchemaGooglePrivacyDlpV2Schedule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRecurrencePeriodDuration(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("recurrencePeriodDuration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRecurrencePeriodDuration: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("recurrencePeriodDuration")(js.undefined)
        ret
    }
  }
