...
object ParamsResourceOrganizationsInspecttemplatesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsInspecttemplatesPatchMutableBuilder[Self <: ParamsResourceOrganizationsInspecttemplatesPatch] (val x: Self) extends AnyVal {
