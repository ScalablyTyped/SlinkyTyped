...
object ParamsResourceOrganizationsDeidentifytemplatesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsDeidentifytemplatesDeleteOps[Self <: ParamsResourceOrganizationsDeidentifytemplatesDelete] (val x: Self) extends AnyVal {
    @scala.inline
