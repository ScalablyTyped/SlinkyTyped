...
object SchemaGooglePrivacyDlpV2DeidentifyConfig {
  ...
  implicit class SchemaGooglePrivacyDlpV2DeidentifyConfigOps[Self <: SchemaGooglePrivacyDlpV2DeidentifyConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInfoTypeTransformations(value: SchemaGooglePrivacyDlpV2InfoTypeTransformations): Self = {
    ...
    @scala.inline
    def withRecordTransformations(value: SchemaGooglePrivacyDlpV2RecordTransformations): Self = {
        val ret = this.duplicate
