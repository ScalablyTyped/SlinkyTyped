...
object ParamsResourceOrganizationsInspecttemplatesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsInspecttemplatesDeleteMutableBuilder[Self <: ParamsResourceOrganizationsInspecttemplatesDelete] (val x: Self) extends AnyVal {
