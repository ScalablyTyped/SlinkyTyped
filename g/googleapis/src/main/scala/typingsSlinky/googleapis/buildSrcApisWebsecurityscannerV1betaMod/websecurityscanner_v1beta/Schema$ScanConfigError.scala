package typingsSlinky.googleapis.buildSrcApisWebsecurityscannerV1betaMod.websecurityscanner_v1beta
...
/**
  ...
  */
@js.native
trait Schema$ScanConfigError extends js.Object {
  /**
...
object Schema$ScanConfigError {
  @scala.inline
  def apply(code: String = null, fieldName: String = null): Schema$ScanConfigError = {
    val __obj = js.Dynamic.literal()
    if (code != null) __obj.updateDynamic("code")(code.asInstanceOf[js.Any])
    if (fieldName != null) __obj.updateDynamic("fieldName")(fieldName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ScanConfigError]
  }
}
