...
@js.native
trait ParamsResourceManagedzonesCreate extends StandardParameters {
  /**
...
object ParamsResourceManagedzonesCreate {
  @scala.inline
  def apply(): ParamsResourceManagedzonesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagedzonesCreate]
  }
  @scala.inline
  implicit class ParamsResourceManagedzonesCreateOps[Self <: ParamsResourceManagedzonesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaManagedZone): Self = {
        val ret = this.duplicate
