...
/**
  ...
  */
@js.native
trait Schema$GoogleIamV1AuditLogConfig extends js.Object {
  /**
...
object Schema$GoogleIamV1AuditLogConfig {
  @scala.inline
  def apply(exemptedMembers: js.Array[String] = null, logType: String = null): Schema$GoogleIamV1AuditLogConfig = {
    ...
    __obj.asInstanceOf[Schema$GoogleIamV1AuditLogConfig]
  }
}
