...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudPrivatecatalogproducerV1beta1Association extends js.Object {
  /**
...
object Schema$GoogleCloudPrivatecatalogproducerV1beta1Association {
  @scala.inline
  def apply(createTime: String = null, name: String = null, resource: String = null): Schema$GoogleCloudPrivatecatalogproducerV1beta1Association = {
    val __obj = js.Dynamic.literal()
    if (createTime != null) __obj.updateDynamic("createTime")(createTime.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (resource != null) __obj.updateDynamic("resource")(resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudPrivatecatalogproducerV1beta1Association]
  }
}
