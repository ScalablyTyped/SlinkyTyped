package typingsSlinky.googleapis.buildSrcApisDigitalassetlinksV1Mod.digitalassetlinks_v1
...
/**
  ...
  */
@js.native
trait Schema$CertificateInfo extends js.Object {
  /**
...
object Schema$CertificateInfo {
  @scala.inline
  def apply(sha256Fingerprint: String = null): Schema$CertificateInfo = {
    val __obj = js.Dynamic.literal()
    if (sha256Fingerprint != null) __obj.updateDynamic("sha256Fingerprint")(sha256Fingerprint.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$CertificateInfo]
  }
}
