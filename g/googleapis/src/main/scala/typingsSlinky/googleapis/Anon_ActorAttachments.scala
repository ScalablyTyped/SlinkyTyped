...
@js.native
trait Anon_ActorAttachments extends js.Object {
  var actor: js.UndefOr[Anon_ClientSpecificActorInfoDisplayName] = js.native
  var attachments: js.UndefOr[js.Array[Anon_ContentDisplayName]] = js.native
  ...
  var statusForViewer: js.UndefOr[Anon_CanComment] = js.native
  var url: js.UndefOr[String] = js.native
}

object Anon_ActorAttachments {
  @scala.inline
  def apply(
    actor: Anon_ClientSpecificActorInfoDisplayName = null,
    attachments: js.Array[Anon_ContentDisplayName] = null,
    content: String = null,
    id: String = null,
    ...
    __obj.asInstanceOf[Anon_ActorAttachments]
  }
}
