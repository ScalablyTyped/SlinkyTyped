...
object SchemaObjectAccessControls {
  ...
  implicit class SchemaObjectAccessControlsOps[Self <: SchemaObjectAccessControls] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaObjectAccessControl*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaObjectAccessControl]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
