...
@js.native
trait ParamsResourceObjectaccesscontrolsGet extends StandardParameters {
...
object ParamsResourceObjectaccesscontrolsGet {
  
  @scala.inline
  def apply(): ParamsResourceObjectaccesscontrolsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceObjectaccesscontrolsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceObjectaccesscontrolsGetMutableBuilder[Self <: ParamsResourceObjectaccesscontrolsGet] (val x: Self) extends AnyVal {
