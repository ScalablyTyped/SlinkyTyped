...
/**
  ...
  */
@js.native
trait Schema$OperationMetadataV1Beta extends js.Object {
  var createVersionMetadata: js.UndefOr[Schema$CreateVersionMetadataV1Beta] = js.native
  /**
...
object Schema$OperationMetadataV1Beta {
  @scala.inline
  def apply(
    createVersionMetadata: Schema$CreateVersionMetadataV1Beta = null,
    endTime: String = null,
  ...
  ): Schema$OperationMetadataV1Beta = {
    ...
    __obj.asInstanceOf[Schema$OperationMetadataV1Beta]
  }
}
