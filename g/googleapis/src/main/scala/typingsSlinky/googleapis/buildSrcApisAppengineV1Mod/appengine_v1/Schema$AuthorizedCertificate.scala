...
/**
  ...
  */
@js.native
trait Schema$AuthorizedCertificate extends js.Object {
  /**
    ...
    */
  var certificateRawData: js.UndefOr[Schema$CertificateRawData] = js.native
  /**
  ...
  /**
    ...
    * empty.@OutputOnly
    */
  var managedCertificate: js.UndefOr[Schema$ManagedCertificate] = js.native
  /**
...
object Schema$AuthorizedCertificate {
  @scala.inline
  def apply(
    certificateRawData: Schema$CertificateRawData = null,
    displayName: String = null,
    domainMappingsCount: Int | Double = null,
    domainNames: js.Array[String] = null,
    expireTime: String = null,
    id: String = null,
    managedCertificate: Schema$ManagedCertificate = null,
    name: String = null,
    visibleDomainMappings: js.Array[String] = null
  ): Schema$AuthorizedCertificate = {
    ...
    __obj.asInstanceOf[Schema$AuthorizedCertificate]
  }
}
