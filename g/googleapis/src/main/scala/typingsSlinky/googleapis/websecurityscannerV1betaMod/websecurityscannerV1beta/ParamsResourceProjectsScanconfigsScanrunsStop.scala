...
object ParamsResourceProjectsScanconfigsScanrunsStop {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsScanconfigsScanrunsStopOps[Self <: ParamsResourceProjectsScanconfigsScanrunsStop] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaStopScanRunRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
