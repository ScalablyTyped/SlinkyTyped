...
object ParamsResourceProjectsScanconfigsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsScanconfigsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsScanconfigsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsScanconfigsDeleteMutableBuilder[Self <: ParamsResourceProjectsScanconfigsDelete] (val x: Self) extends AnyVal {
