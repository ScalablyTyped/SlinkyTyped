...
object SchemaScanRun {
  ...
  implicit class SchemaScanRunOps[Self <: SchemaScanRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorTrace(value: SchemaScanRunErrorTrace): Self = this.set("errorTrace", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWarningTracesVarargs(value: SchemaScanRunWarningTrace*): Self = this.set("warningTraces", js.Array(value :_*))
    @scala.inline
    def setWarningTraces(value: js.Array[SchemaScanRunWarningTrace]): Self = this.set("warningTraces", value.asInstanceOf[js.Any])
    @scala.inline
