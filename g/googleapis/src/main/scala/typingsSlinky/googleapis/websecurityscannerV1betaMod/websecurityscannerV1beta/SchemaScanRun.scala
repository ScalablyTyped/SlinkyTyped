...
object SchemaScanRun {
  ...
  implicit class SchemaScanRunMutableBuilder[Self <: SchemaScanRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorTrace(value: SchemaScanRunErrorTrace): Self = StObject.set(x, "errorTrace", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWarningTraces(value: js.Array[SchemaScanRunWarningTrace]): Self = StObject.set(x, "warningTraces", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWarningTracesUndefined: Self = StObject.set(x, "warningTraces", js.undefined)
    
    @scala.inline
    def setWarningTracesVarargs(value: SchemaScanRunWarningTrace*): Self = StObject.set(x, "warningTraces", js.Array(value :_*))
  }
}
