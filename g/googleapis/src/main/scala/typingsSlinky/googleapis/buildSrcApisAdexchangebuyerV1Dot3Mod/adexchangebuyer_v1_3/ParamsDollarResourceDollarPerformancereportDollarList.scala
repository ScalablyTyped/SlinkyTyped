...
@js.native
trait ParamsDollarResourceDollarPerformancereportDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPerformancereportDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPerformancereportDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPerformancereportDollarList]
  }
}
