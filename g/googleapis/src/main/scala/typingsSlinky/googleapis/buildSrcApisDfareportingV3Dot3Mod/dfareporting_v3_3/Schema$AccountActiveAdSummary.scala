...
/**
  ...
  */
@js.native
trait Schema$AccountActiveAdSummary extends js.Object {
  /**
    * ID of the account.
    */
...
object Schema$AccountActiveAdSummary {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$AccountActiveAdSummary]
  }
}
