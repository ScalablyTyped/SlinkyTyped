...
@js.native
trait ParamsDollarResourceDollarContentcategoriesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarContentcategoriesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarContentcategoriesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarContentcategoriesDollarList]
  }
}
