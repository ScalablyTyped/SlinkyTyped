...
/**
  ...
  */
@js.native
trait Schema$GeoTargeting extends js.Object {
  /**
  ...
  /**
    ...
    * the region.
    */
  var regions: js.UndefOr[js.Array[Schema$Region]] = js.native
}

object Schema$GeoTargeting {
  @scala.inline
  def apply(
    cities: js.Array[Schema$City] = null,
    countries: js.Array[Schema$Country] = null,
    excludeCountries: js.UndefOr[Boolean] = js.undefined,
    metros: js.Array[Schema$Metro] = null,
    postalCodes: js.Array[Schema$PostalCode] = null,
    regions: js.Array[Schema$Region] = null
  ): Schema$GeoTargeting = {
    ...
    __obj.asInstanceOf[Schema$GeoTargeting]
  }
}
