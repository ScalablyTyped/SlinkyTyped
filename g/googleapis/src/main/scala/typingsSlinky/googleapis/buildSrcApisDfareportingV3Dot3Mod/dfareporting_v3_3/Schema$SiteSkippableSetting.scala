...
/**
  ...
  */
@js.native
trait Schema$SiteSkippableSetting extends js.Object {
  /**
...
object Schema$SiteSkippableSetting {
  @scala.inline
  def apply(
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$SiteSkippableSetting]
  }
}
