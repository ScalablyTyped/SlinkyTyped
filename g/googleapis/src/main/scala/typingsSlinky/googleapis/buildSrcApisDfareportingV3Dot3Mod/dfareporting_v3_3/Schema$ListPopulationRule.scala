...
/**
  ...
  */
@js.native
trait Schema$ListPopulationRule extends js.Object {
  /**
  ...
  /**
    ...
    */
  var listPopulationClauses: js.UndefOr[js.Array[Schema$ListPopulationClause]] = js.native
}

object Schema$ListPopulationRule {
  @scala.inline
  def apply(
    floodlightActivityId: String = null,
    floodlightActivityName: String = null,
    listPopulationClauses: js.Array[Schema$ListPopulationClause] = null
  ): Schema$ListPopulationRule = {
    ...
    __obj.asInstanceOf[Schema$ListPopulationRule]
  }
}
