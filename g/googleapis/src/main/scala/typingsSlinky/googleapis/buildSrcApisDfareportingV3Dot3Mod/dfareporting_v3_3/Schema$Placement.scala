...
/**
  ...
  */
@js.native
trait Schema$Placement extends js.Object {
  /**
  ...
  /**
    ...
    * auto-generated field.
    */
  var placementGroupIdDimensionValue: js.UndefOr[Schema$DimensionValue] = js.native
  /**
  ...
  /**
    ...
    */
  var publisherUpdateInfo: js.UndefOr[Schema$LastModifiedInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var videoSettings: js.UndefOr[Schema$VideoSettings] = js.native
  /**
...
object Schema$Placement {
  ...
  def apply(
    ...
    placementGroupIdDimensionValue: Schema$DimensionValue = null,
    placementStrategyId: String = null,
    pricingSchedule: Schema$PricingSchedule = null,
    primary: js.UndefOr[Boolean] = js.undefined,
    publisherUpdateInfo: Schema$LastModifiedInfo = null,
    siteId: String = null,
    ...
    videoSettings: Schema$VideoSettings = null,
    ...
    __obj.asInstanceOf[Schema$Placement]
  }
}
