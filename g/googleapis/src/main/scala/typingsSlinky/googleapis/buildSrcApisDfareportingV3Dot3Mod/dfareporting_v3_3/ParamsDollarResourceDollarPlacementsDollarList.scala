...
@js.native
trait ParamsDollarResourceDollarPlacementsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlacementsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPlacementsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlacementsDollarList]
  }
}
