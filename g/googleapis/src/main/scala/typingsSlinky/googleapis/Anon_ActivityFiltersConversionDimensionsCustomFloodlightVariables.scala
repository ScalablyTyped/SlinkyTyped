...
@js.native
trait Anon_ActivityFiltersConversionDimensionsCustomFloodlightVariables extends js.Object {
...
object Anon_ActivityFiltersConversionDimensionsCustomFloodlightVariables {
  @scala.inline
  def apply(
  ...
  ): Anon_ActivityFiltersConversionDimensionsCustomFloodlightVariables = {
    ...
    __obj.asInstanceOf[Anon_ActivityFiltersConversionDimensionsCustomFloodlightVariables]
  }
}
