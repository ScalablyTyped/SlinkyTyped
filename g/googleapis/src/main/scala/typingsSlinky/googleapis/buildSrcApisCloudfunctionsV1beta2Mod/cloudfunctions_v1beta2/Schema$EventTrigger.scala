...
/**
  ...
  */
@js.native
trait Schema$EventTrigger extends js.Object {
  /**
  ...
  /**
    ...
    */
  var failurePolicy: js.UndefOr[Schema$FailurePolicy] = js.native
  /**
...
object Schema$EventTrigger {
  @scala.inline
  def apply(
    eventType: String = null,
    failurePolicy: Schema$FailurePolicy = null,
    ...
    __obj.asInstanceOf[Schema$EventTrigger]
  }
}
