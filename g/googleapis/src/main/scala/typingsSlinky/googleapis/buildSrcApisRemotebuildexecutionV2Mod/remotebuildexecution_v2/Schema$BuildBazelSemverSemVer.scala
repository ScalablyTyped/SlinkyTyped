...
/**
  ...
  */
@js.native
trait Schema$BuildBazelSemverSemVer extends js.Object {
  /**
...
object Schema$BuildBazelSemverSemVer {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$BuildBazelSemverSemVer]
  }
}
