...
@js.native
class Resource$Actions protected () extends js.Object {
  ...
  /**
    ...
    */
  def execute(): GaxiosPromise[Schema$GoogleLongrunningOperation] = js.native
  def execute(callback: BodyResponseCallback[Schema$GoogleLongrunningOperation]): Unit = js.native
  def execute(params: ParamsDollarResourceDollarActionsDollarExecute): GaxiosPromise[Schema$GoogleLongrunningOperation] = js.native
  def execute(
    params: ParamsDollarResourceDollarActionsDollarExecute,
  ...
  def execute(params: ParamsDollarResourceDollarActionsDollarExecute, options: MethodOptions): GaxiosPromise[Schema$GoogleLongrunningOperation] = js.native
  def execute(
    params: ParamsDollarResourceDollarActionsDollarExecute,
