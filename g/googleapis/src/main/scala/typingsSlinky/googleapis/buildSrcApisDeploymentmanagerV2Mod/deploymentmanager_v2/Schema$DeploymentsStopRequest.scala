...
@js.native
trait Schema$DeploymentsStopRequest extends js.Object {
  /**
...
object Schema$DeploymentsStopRequest {
  @scala.inline
  def apply(fingerprint: String = null): Schema$DeploymentsStopRequest = {
    val __obj = js.Dynamic.literal()
    if (fingerprint != null) __obj.updateDynamic("fingerprint")(fingerprint.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$DeploymentsStopRequest]
  }
}
