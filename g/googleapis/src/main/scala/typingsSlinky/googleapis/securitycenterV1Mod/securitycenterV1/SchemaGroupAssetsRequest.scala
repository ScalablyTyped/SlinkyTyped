...
object SchemaGroupAssetsRequest {
  ...
  implicit class SchemaGroupAssetsRequestOps[Self <: SchemaGroupAssetsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCompareDuration(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("compareDuration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCompareDuration: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("compareDuration")(js.undefined)
        ret
    }
    @scala.inline
