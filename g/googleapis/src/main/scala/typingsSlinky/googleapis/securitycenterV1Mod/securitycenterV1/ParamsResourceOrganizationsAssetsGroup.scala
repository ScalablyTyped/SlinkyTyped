...
object ParamsResourceOrganizationsAssetsGroup {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsAssetsGroup = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsAssetsGroup]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsAssetsGroupMutableBuilder[Self <: ParamsResourceOrganizationsAssetsGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGroupAssetsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
