...
object ParamsResourceOrganizationsAssetsGroup {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsAssetsGroupOps[Self <: ParamsResourceOrganizationsAssetsGroup] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGroupAssetsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
