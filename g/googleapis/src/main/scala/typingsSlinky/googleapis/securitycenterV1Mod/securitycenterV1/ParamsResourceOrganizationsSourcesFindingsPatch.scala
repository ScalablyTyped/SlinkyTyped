...
object ParamsResourceOrganizationsSourcesFindingsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsSourcesFindingsPatchOps[Self <: ParamsResourceOrganizationsSourcesFindingsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaFinding): Self = {
        val ret = this.duplicate
