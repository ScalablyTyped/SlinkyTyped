...
object ParamsResourceOrganizationsGetorganizationsettings {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsGetorganizationsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsGetorganizationsettings]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsGetorganizationsettingsMutableBuilder[Self <: ParamsResourceOrganizationsGetorganizationsettings] (val x: Self) extends AnyVal {
