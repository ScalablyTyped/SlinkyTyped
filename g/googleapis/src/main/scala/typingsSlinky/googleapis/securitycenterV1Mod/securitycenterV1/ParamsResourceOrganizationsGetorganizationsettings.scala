...
object ParamsResourceOrganizationsGetorganizationsettings {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsGetorganizationsettingsOps[Self <: ParamsResourceOrganizationsGetorganizationsettings] (val x: Self) extends AnyVal {
