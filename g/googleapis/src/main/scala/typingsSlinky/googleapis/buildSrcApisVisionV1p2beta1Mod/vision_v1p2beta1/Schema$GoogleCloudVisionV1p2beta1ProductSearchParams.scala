...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1ProductSearchParams extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p2beta1ProductSearchParams {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudVisionV1p2beta1ProductSearchParams = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p2beta1ProductSearchParams]
  }
}
