...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1ImageContext extends js.Object {
  /**
    * Parameters for crop hints annotation request.
    */
  var cropHintsParams: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1CropHintsParams] = js.native
  /**
  ...
  /**
    * Not used.
    */
  var latLongRect: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1LatLongRect] = js.native
  /**
    * Parameters for product search.
    */
  var productSearchParams: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1ProductSearchParams] = js.native
  /**
    * Parameters for web detection.
    */
  var webDetectionParams: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1WebDetectionParams] = js.native
}

object Schema$GoogleCloudVisionV1p2beta1ImageContext {
  @scala.inline
  def apply(
    cropHintsParams: Schema$GoogleCloudVisionV1p2beta1CropHintsParams = null,
    languageHints: js.Array[String] = null,
    latLongRect: Schema$GoogleCloudVisionV1p2beta1LatLongRect = null,
    productSearchParams: Schema$GoogleCloudVisionV1p2beta1ProductSearchParams = null,
    webDetectionParams: Schema$GoogleCloudVisionV1p2beta1WebDetectionParams = null
  ): Schema$GoogleCloudVisionV1p2beta1ImageContext = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p2beta1ImageContext]
  }
}
