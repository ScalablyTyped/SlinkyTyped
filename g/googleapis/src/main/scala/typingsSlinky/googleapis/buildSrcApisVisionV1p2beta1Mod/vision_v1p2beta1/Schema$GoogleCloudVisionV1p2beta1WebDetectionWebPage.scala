...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1WebDetectionWebPage extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p2beta1WebDetectionWebPage {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p2beta1WebDetectionWebPage]
  }
}
