...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1OutputConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var gcsDestination: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1GcsDestination] = js.native
}

object Schema$GoogleCloudVisionV1p2beta1OutputConfig {
  @scala.inline
  def apply(
    batchSize: Int | Double = null,
    gcsDestination: Schema$GoogleCloudVisionV1p2beta1GcsDestination = null
  ): Schema$GoogleCloudVisionV1p2beta1OutputConfig = {
    val __obj = js.Dynamic.literal()
    if (batchSize != null) __obj.updateDynamic("batchSize")(batchSize.asInstanceOf[js.Any])
    if (gcsDestination != null) __obj.updateDynamic("gcsDestination")(gcsDestination.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p2beta1OutputConfig]
  }
}
