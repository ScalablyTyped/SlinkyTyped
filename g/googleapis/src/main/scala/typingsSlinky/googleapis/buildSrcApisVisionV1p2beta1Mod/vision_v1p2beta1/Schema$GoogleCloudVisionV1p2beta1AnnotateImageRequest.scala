...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1AnnotateImageRequest extends js.Object {
  /**
    * Requested features.
    */
  ...
  /**
    ...
    */
  var image: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1Image] = js.native
  /**
