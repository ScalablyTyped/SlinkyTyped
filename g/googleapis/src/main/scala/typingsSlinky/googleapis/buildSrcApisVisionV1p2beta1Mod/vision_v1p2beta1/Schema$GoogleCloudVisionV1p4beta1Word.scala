...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1Word extends js.Object {
  /**
  ...
  /**
    ...
    * reading order.
    */
  var symbols: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p4beta1Symbol]] = js.native
}

object Schema$GoogleCloudVisionV1p4beta1Word {
  @scala.inline
  def apply(
    ...
    symbols: js.Array[Schema$GoogleCloudVisionV1p4beta1Symbol] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1Word]
  }
}
