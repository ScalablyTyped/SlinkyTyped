...
@js.native
trait ParamsDollarResourceDollarTasksDollarMove extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTasksDollarMove {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTasksDollarMove = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTasksDollarMove]
  }
}
