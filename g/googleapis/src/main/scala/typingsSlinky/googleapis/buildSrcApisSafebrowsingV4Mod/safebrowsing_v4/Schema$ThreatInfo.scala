...
/**
  ...
  */
@js.native
trait Schema$ThreatInfo extends js.Object {
  /**
  ...
  /**
    ...
    */
  var threatEntries: js.UndefOr[js.Array[Schema$ThreatEntry]] = js.native
  /**
...
object Schema$ThreatInfo {
  @scala.inline
  def apply(
    platformTypes: js.Array[String] = null,
    threatEntries: js.Array[Schema$ThreatEntry] = null,
    ...
    __obj.asInstanceOf[Schema$ThreatInfo]
  }
}
