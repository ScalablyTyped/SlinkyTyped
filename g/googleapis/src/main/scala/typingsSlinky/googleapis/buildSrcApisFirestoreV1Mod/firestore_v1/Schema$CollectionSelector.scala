...
/**
  ...
  */
@js.native
trait Schema$CollectionSelector extends js.Object {
  /**
...
object Schema$CollectionSelector {
  @scala.inline
  def apply(allDescendants: js.UndefOr[Boolean] = js.undefined, collectionId: String = null): Schema$CollectionSelector = {
    ...
    __obj.asInstanceOf[Schema$CollectionSelector]
  }
}
