...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1ImportDocumentsRequest extends js.Object {
  /**
...
object Schema$GoogleFirestoreAdminV1ImportDocumentsRequest {
  @scala.inline
  def apply(collectionIds: js.Array[String] = null, inputUriPrefix: String = null): Schema$GoogleFirestoreAdminV1ImportDocumentsRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1ImportDocumentsRequest]
  }
}
