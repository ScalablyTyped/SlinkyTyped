...
trait Schema$WriteResult extends js.Object {
  /**
    ...
    * same order.
    */
  var transformResults: js.UndefOr[js.Array[Schema$Value]] = js.native
  /**
...
object Schema$WriteResult {
  @scala.inline
  def apply(transformResults: js.Array[Schema$Value] = null, updateTime: String = null): Schema$WriteResult = {
