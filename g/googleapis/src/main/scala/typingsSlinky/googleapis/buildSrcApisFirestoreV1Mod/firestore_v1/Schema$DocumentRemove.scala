...
/**
  ...
  */
@js.native
trait Schema$DocumentRemove extends js.Object {
  /**
...
object Schema$DocumentRemove {
  @scala.inline
  def apply(document: String = null, readTime: String = null, removedTargetIds: js.Array[Double] = null): Schema$DocumentRemove = {
    ...
    __obj.asInstanceOf[Schema$DocumentRemove]
  }
}
