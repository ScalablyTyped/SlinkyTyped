...
@js.native
class ResourceDollarBillingaccountsDollarLogs protected () extends js.Object {
  ...
  def delete(params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarDelete): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarDelete,
  ...
  def delete(params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarDelete, options: MethodOptions): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarDelete,
  ...
  def list(params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarList): GaxiosPromise[Schema$ListLogsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarList,
  ...
  def list(params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListLogsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBillingaccountsDollarLogsDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListLogsResponse]
