...
@js.native
class Resource$Logs protected () extends js.Object {
  ...
  def delete(params: ParamsDollarResourceDollarLogsDollarDelete): GaxiosPromise[Schema$Empty] = js.native
  def delete(params: ParamsDollarResourceDollarLogsDollarDelete, callback: BodyResponseCallback[Schema$Empty]): Unit = js.native
  def delete(
    params: ParamsDollarResourceDollarLogsDollarDelete,
    options: BodyResponseCallback[Schema$Empty],
    callback: BodyResponseCallback[Schema$Empty]
  ): Unit = js.native
  def delete(params: ParamsDollarResourceDollarLogsDollarDelete, options: MethodOptions): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarLogsDollarDelete,
  ...
  def list(params: ParamsDollarResourceDollarLogsDollarList): GaxiosPromise[Schema$ListLogsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarLogsDollarList,
  ...
  def list(params: ParamsDollarResourceDollarLogsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListLogsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarLogsDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListLogsResponse]
