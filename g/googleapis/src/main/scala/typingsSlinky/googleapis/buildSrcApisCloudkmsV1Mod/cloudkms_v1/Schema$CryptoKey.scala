...
/**
  ...
  */
@js.native
trait Schema$CryptoKey extends js.Object {
  /**
  ...
  /**
    ...
    */
  var primary: js.UndefOr[Schema$CryptoKeyVersion] = js.native
  /**
  ...
  /**
    ...
    */
  var versionTemplate: js.UndefOr[Schema$CryptoKeyVersionTemplate] = js.native
}

object Schema$CryptoKey {
  @scala.inline
  def apply(
    ...
    primary: Schema$CryptoKeyVersion = null,
    purpose: String = null,
    rotationPeriod: String = null,
    versionTemplate: Schema$CryptoKeyVersionTemplate = null
  ): Schema$CryptoKey = {
    ...
    __obj.asInstanceOf[Schema$CryptoKey]
  }
}
