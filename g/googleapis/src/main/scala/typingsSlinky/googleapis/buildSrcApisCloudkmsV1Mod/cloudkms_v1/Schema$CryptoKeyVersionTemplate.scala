...
/**
  ...
  */
@js.native
trait Schema$CryptoKeyVersionTemplate extends js.Object {
  /**
...
object Schema$CryptoKeyVersionTemplate {
  @scala.inline
  def apply(algorithm: String = null, protectionLevel: String = null): Schema$CryptoKeyVersionTemplate = {
    val __obj = js.Dynamic.literal()
    if (algorithm != null) __obj.updateDynamic("algorithm")(algorithm.asInstanceOf[js.Any])
    if (protectionLevel != null) __obj.updateDynamic("protectionLevel")(protectionLevel.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$CryptoKeyVersionTemplate]
  }
}
