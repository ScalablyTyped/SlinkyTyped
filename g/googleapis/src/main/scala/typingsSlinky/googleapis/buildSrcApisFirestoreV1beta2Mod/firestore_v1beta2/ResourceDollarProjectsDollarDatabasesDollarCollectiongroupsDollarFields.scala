package typingsSlinky.googleapis.buildSrcApisFirestoreV1beta2Mod.firestore_v1beta2
...
@js.native
class ResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFields protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2Field] = js.native
  def get(callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2Field]): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet
  ): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2Field] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet,
  ...
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet,
    options: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2Field],
    callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2Field]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2ListFieldsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2ListFieldsResponse]): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList
  ): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2ListFieldsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList,
    options: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2ListFieldsResponse],
    callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2ListFieldsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList,
  ...
  def patch(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarPatch
