...
class ResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexes protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def get(): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2Index] = js.native
  def get(callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2Index]): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarGet
  ): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2Index] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarGet,
  ...
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarGet,
    options: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2Index],
    callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2Index]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarGet,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2ListIndexesResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2ListIndexesResponse]): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarList
  ): GaxiosPromise[Schema$GoogleFirestoreAdminV1beta2ListIndexesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarList,
    options: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2ListIndexesResponse],
    callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1beta2ListIndexesResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarIndexesDollarList,
