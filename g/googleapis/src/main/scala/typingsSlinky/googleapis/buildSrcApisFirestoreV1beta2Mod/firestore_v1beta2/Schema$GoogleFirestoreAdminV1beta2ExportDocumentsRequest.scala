...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta2ExportDocumentsRequest extends js.Object {
  /**
...
object Schema$GoogleFirestoreAdminV1beta2ExportDocumentsRequest {
  @scala.inline
  def apply(collectionIds: js.Array[String] = null, outputUriPrefix: String = null): Schema$GoogleFirestoreAdminV1beta2ExportDocumentsRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta2ExportDocumentsRequest]
  }
}
