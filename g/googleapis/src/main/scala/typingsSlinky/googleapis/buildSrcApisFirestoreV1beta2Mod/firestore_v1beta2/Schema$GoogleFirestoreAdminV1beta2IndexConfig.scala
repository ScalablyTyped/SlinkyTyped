...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta2IndexConfig extends js.Object {
  /**
...
object Schema$GoogleFirestoreAdminV1beta2IndexConfig {
  @scala.inline
  def apply(
    ancestorField: String = null,
    indexes: js.Array[Schema$GoogleFirestoreAdminV1beta2Index] = null,
    reverting: js.UndefOr[Boolean] = js.undefined,
    usesAncestorConfig: js.UndefOr[Boolean] = js.undefined
  ): Schema$GoogleFirestoreAdminV1beta2IndexConfig = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta2IndexConfig]
  }
}
