...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta2IndexField extends js.Object {
  /**
...
object Schema$GoogleFirestoreAdminV1beta2IndexField {
  @scala.inline
  def apply(arrayConfig: String = null, fieldPath: String = null, order: String = null): Schema$GoogleFirestoreAdminV1beta2IndexField = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta2IndexField]
  }
}
