...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta2ExportDocumentsMetadata extends js.Object {
  /**
...
object Schema$GoogleFirestoreAdminV1beta2ExportDocumentsMetadata {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleFirestoreAdminV1beta2ExportDocumentsMetadata = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta2ExportDocumentsMetadata]
  }
}
