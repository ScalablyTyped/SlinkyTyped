...
@js.native
trait ParamsResourceGroupsCreate extends StandardParameters {
...
object ParamsResourceGroupsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceGroupsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceGroupsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceGroupsCreateMutableBuilder[Self <: ParamsResourceGroupsCreate] (val x: Self) extends AnyVal {
