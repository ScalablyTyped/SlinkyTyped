...
object ParamsResourceEnterprisesWebappsPatch {
  @scala.inline
  def apply(): ParamsResourceEnterprisesWebappsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEnterprisesWebappsPatch]
  }
  @scala.inline
  implicit class ParamsResourceEnterprisesWebappsPatchOps[Self <: ParamsResourceEnterprisesWebappsPatch] (val x: Self) extends AnyVal {
    @scala.inline
