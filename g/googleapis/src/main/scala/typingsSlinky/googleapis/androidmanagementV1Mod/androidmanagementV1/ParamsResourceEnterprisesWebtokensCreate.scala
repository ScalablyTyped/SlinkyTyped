...
object ParamsResourceEnterprisesWebtokensCreate {
  ...
  @scala.inline
  implicit class ParamsResourceEnterprisesWebtokensCreateMutableBuilder[Self <: ParamsResourceEnterprisesWebtokensCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaWebToken): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
