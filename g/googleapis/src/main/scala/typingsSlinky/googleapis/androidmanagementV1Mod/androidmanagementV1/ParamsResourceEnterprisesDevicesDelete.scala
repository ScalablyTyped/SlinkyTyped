...
object ParamsResourceEnterprisesDevicesDelete {
  ...
  def apply(
    ...
    wipeDataFlags: js.Array[String] = null
  ): ParamsResourceEnterprisesDevicesDelete = {
    ...
    if (wipeDataFlags != null) __obj.updateDynamic("wipeDataFlags")(wipeDataFlags.asInstanceOf[js.Any])
