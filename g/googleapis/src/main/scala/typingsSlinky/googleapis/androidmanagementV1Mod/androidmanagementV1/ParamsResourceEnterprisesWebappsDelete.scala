...
@js.native
trait ParamsResourceEnterprisesWebappsDelete extends StandardParameters {
...
object ParamsResourceEnterprisesWebappsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceEnterprisesWebappsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEnterprisesWebappsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceEnterprisesWebappsDeleteMutableBuilder[Self <: ParamsResourceEnterprisesWebappsDelete] (val x: Self) extends AnyVal {
