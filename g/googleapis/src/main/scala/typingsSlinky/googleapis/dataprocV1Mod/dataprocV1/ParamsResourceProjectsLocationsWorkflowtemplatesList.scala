...
@js.native
trait ParamsResourceProjectsLocationsWorkflowtemplatesList extends StandardParameters {
  /**
...
object ParamsResourceProjectsLocationsWorkflowtemplatesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsWorkflowtemplatesListOps[Self <: ParamsResourceProjectsLocationsWorkflowtemplatesList] (val x: Self) extends AnyVal {
    @scala.inline
