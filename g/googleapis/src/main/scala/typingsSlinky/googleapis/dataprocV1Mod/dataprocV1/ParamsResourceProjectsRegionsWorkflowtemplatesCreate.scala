...
object ParamsResourceProjectsRegionsWorkflowtemplatesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsWorkflowtemplatesCreateMutableBuilder[Self <: ParamsResourceProjectsRegionsWorkflowtemplatesCreate] (val x: Self) extends AnyVal {
