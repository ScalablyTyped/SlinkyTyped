...
/**
  ...
  */
@js.native
trait Schema$AppEngineRouting extends js.Object {
  /**
...
object Schema$AppEngineRouting {
  @scala.inline
  def apply(host: String = null, instance: String = null, service: String = null, version: String = null): Schema$AppEngineRouting = {
    val __obj = js.Dynamic.literal()
    if (host != null) __obj.updateDynamic("host")(host.asInstanceOf[js.Any])
    if (instance != null) __obj.updateDynamic("instance")(instance.asInstanceOf[js.Any])
    if (service != null) __obj.updateDynamic("service")(service.asInstanceOf[js.Any])
    if (version != null) __obj.updateDynamic("version")(version.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$AppEngineRouting]
  }
}
