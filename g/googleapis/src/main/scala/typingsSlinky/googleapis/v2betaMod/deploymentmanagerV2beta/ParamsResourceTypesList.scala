...
@js.native
trait ParamsResourceTypesList extends StandardParameters {
...
object ParamsResourceTypesList {
  ...
  @scala.inline
  def apply(): ParamsResourceTypesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTypesList]
  }
  
  @scala.inline
  implicit class ParamsResourceTypesListMutableBuilder[Self <: ParamsResourceTypesList] (val x: Self) extends AnyVal {
