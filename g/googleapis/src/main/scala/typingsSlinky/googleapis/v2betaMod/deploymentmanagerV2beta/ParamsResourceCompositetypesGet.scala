...
object ParamsResourceCompositetypesGet {
  ...
  @scala.inline
  implicit class ParamsResourceCompositetypesGetOps[Self <: ParamsResourceCompositetypesGet] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCompositeType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("compositeType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCompositeType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("compositeType")(js.undefined)
        ret
    }
    @scala.inline
