...
@js.native
trait ParamsDollarResourceDollarUsersDollarDraftsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUsersDollarDraftsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUsersDollarDraftsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUsersDollarDraftsDollarList]
  }
}
