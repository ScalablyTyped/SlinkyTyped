...
/**
  ...
  */
@js.native
trait Schema$SendAs extends js.Object {
  /**
  ...
  /**
    ...
    */
  var smtpMsa: js.UndefOr[Schema$SmtpMsa] = js.native
  /**
...
object Schema$SendAs {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$SendAs]
  }
}
