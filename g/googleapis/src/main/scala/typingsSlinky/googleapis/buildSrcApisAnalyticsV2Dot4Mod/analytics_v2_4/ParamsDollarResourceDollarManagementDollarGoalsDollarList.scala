...
@js.native
trait ParamsDollarResourceDollarManagementDollarGoalsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarGoalsDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarGoalsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarGoalsDollarList]
  }
}
