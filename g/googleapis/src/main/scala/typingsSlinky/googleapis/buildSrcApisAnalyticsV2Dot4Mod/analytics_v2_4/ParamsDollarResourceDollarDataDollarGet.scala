...
@js.native
trait ParamsDollarResourceDollarDataDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDataDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDataDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDataDollarGet]
  }
}
