...
object ParamsResourceServicesBatchenable {
  ...
  @scala.inline
  implicit class ParamsResourceServicesBatchenableOps[Self <: ParamsResourceServicesBatchenable] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchEnableServicesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
