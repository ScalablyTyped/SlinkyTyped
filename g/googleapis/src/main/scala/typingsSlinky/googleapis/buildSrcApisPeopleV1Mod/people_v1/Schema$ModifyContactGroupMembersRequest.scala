...
/**
  ...
  */
@js.native
trait Schema$ModifyContactGroupMembersRequest extends js.Object {
  /**
...
object Schema$ModifyContactGroupMembersRequest {
  @scala.inline
  def apply(resourceNamesToAdd: js.Array[String] = null, resourceNamesToRemove: js.Array[String] = null): Schema$ModifyContactGroupMembersRequest = {
    ...
    __obj.asInstanceOf[Schema$ModifyContactGroupMembersRequest]
  }
}
