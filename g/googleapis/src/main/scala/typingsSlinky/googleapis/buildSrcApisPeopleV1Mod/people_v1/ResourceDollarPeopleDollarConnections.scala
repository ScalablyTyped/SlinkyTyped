...
@js.native
class ResourceDollarPeopleDollarConnections protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarPeopleDollarConnectionsDollarList): GaxiosPromise[Schema$ListConnectionsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarPeopleDollarConnectionsDollarList,
  ...
  def list(params: ParamsDollarResourceDollarPeopleDollarConnectionsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListConnectionsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarPeopleDollarConnectionsDollarList,
