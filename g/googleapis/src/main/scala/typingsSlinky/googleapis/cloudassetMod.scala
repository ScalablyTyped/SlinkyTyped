...
object cloudassetMod {
  
  object VERSIONS {
    
    @JSImport("googleapis/build/src/apis/cloudasset", "VERSIONS")
    @js.native
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudasset", "VERSIONS.v1beta1")
    @js.native
  ...
  object auth extends Shortcut {
    ...
    @JSImport("googleapis/build/src/apis/cloudasset", "auth")
    @js.native
    val ^ : AuthPlus = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudasset", "auth.Compute")
    @js.native
    /**
    ...
    /**
      ...
      */
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudasset", "auth.DefaultTransporter")
    @js.native
    ...
    object DefaultTransporter {
      ...
      @JSImport("googleapis/build/src/apis/cloudasset", "auth.DefaultTransporter.constructor")
      @js.native
      def constructor(): js.Any = js.native
    }
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudasset", "auth.JWT")
    @js.native
    class JWT protected ()
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudasset", "auth.OAuth2")
    @js.native
    /**
  ...
  @JSImport("googleapis/build/src/apis/cloudasset", "cloudasset")
  @js.native
