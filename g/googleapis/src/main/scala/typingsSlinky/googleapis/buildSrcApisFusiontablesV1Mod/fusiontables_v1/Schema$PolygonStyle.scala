...
/**
  ...
  */
@js.native
trait Schema$PolygonStyle extends js.Object {
  /**
  ...
  /**
    ...
    */
  var fillColorStyler: js.UndefOr[Schema$StyleFunction] = js.native
  /**
...
object Schema$PolygonStyle {
  @scala.inline
  def apply(
    fillColor: String = null,
    fillColorStyler: Schema$StyleFunction = null,
    ...
    __obj.asInstanceOf[Schema$PolygonStyle]
  }
}
