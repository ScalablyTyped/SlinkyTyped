...
object ParamsResourcePromoofferGet {
  ...
  @scala.inline
  def apply(): ParamsResourcePromoofferGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePromoofferGet]
  }
  
  @scala.inline
  implicit class ParamsResourcePromoofferGetMutableBuilder[Self <: ParamsResourcePromoofferGet] (val x: Self) extends AnyVal {
