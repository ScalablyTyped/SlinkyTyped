...
object ParamsResourceCloudloadingAddbook {
  ...
  implicit class ParamsResourceCloudloadingAddbookOps[Self <: ParamsResourceCloudloadingAddbook] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDrive_document_id(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("drive_document_id")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDrive_document_id: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("drive_document_id")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUpload_client_token(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("upload_client_token")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutUpload_client_token: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("upload_client_token")(js.undefined)
        ret
    }
  }
