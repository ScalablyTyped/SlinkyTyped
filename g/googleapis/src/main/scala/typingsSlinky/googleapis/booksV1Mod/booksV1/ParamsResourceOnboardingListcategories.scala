...
@js.native
trait ParamsResourceOnboardingListcategories extends StandardParameters {
  /**
...
object ParamsResourceOnboardingListcategories {
  ...
  @scala.inline
  implicit class ParamsResourceOnboardingListcategoriesOps[Self <: ParamsResourceOnboardingListcategories] (val x: Self) extends AnyVal {
    @scala.inline
