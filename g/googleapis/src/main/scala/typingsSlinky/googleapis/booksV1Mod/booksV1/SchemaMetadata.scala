...
import typingsSlinky.googleapis.anon.Downloadurl
...
object SchemaMetadata {
  ...
  implicit class SchemaMetadataOps[Self <: SchemaMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Downloadurl*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Downloadurl]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
