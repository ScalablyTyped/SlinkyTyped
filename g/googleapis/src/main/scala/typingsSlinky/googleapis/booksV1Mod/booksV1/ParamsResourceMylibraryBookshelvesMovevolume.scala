...
object ParamsResourceMylibraryBookshelvesMovevolume {
  ...
  @scala.inline
  implicit class ParamsResourceMylibraryBookshelvesMovevolumeOps[Self <: ParamsResourceMylibraryBookshelvesMovevolume] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withVolumePosition(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("volumePosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutVolumePosition: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("volumePosition")(js.undefined)
        ret
    }
  }
