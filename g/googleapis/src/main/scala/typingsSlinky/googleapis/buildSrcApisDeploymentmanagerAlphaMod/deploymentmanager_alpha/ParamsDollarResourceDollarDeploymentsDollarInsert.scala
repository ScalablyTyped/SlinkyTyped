...
@js.native
trait ParamsDollarResourceDollarDeploymentsDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDeploymentsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDeploymentsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDeploymentsDollarInsert]
  }
}
