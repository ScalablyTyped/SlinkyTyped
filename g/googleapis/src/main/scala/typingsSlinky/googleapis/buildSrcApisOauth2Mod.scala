...
import typingsSlinky.googleapis.buildSrcApisOauth2V1Mod.oauth2_v1.Oauth2
import typingsSlinky.googleapis.buildSrcApisOauth2V1Mod.oauth2_v1.Options
...
@js.native
object buildSrcApisOauth2Mod extends js.Object {
  def oauth2(options: Options): Oauth2 = js.native
  def oauth2(options: typingsSlinky.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Options): typingsSlinky.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Oauth2 = js.native
  @JSName("oauth2")
  def oauth2_v1(version: v1): Oauth2 = js.native
  @JSName("oauth2")
  def oauth2_v2(version: v2): typingsSlinky.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Oauth2 = js.native
  @js.native
  object VERSIONS extends js.Object {
    ...
    @js.native
    class v2 protected ()
      extends typingsSlinky.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Oauth2 {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v2
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Oauth2
              ]
            ]
