...
object ParamsResourceProjectsLocationsInstancesFailover {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsInstancesFailoverMutableBuilder[Self <: ParamsResourceProjectsLocationsInstancesFailover] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaFailoverInstanceRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
