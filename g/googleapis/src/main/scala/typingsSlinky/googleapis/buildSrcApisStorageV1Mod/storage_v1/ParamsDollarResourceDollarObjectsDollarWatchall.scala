...
@js.native
trait ParamsDollarResourceDollarObjectsDollarWatchall extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarObjectsDollarWatchall {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarObjectsDollarWatchall = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarObjectsDollarWatchall]
  }
}
