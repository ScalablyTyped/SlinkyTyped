...
@js.native
trait ParamsDollarResourceDollarObjectsDollarCopy extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarObjectsDollarCopy {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarObjectsDollarCopy = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarObjectsDollarCopy]
  }
}
