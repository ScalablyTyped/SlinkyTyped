...
import typingsSlinky.googleapis.Anon_EncryptionAlgorithm
import typingsSlinky.googleapis.Anon_Entity
...
trait Schema$Object extends js.Object {
  ...
  /**
    ...
    * by such a key.
    */
  var customerEncryption: js.UndefOr[Anon_EncryptionAlgorithm] = js.native
  /**
