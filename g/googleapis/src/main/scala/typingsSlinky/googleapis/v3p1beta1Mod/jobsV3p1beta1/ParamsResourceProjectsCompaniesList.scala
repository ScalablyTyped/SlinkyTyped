...
object ParamsResourceProjectsCompaniesList {
  ...
  def apply(
    ...
    requireOpenJobs: js.UndefOr[Boolean] = js.undefined,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsCompaniesList = {
    ...
    if (!js.isUndefined(requireOpenJobs)) __obj.updateDynamic("requireOpenJobs")(requireOpenJobs.get.asInstanceOf[js.Any])
