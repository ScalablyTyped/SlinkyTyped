...
object SchemaJobQuery {
  ...
  implicit class SchemaJobQueryOps[Self <: SchemaJobQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCommuteFilter(value: SchemaCommuteFilter): Self = {
    ...
    @scala.inline
    def withCompanyDisplayNames(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("companyDisplayNames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCompanyDisplayNames: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("companyDisplayNames")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withExcludedJobs(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("excludedJobs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutExcludedJobs: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("excludedJobs")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPublishTimeRange(value: SchemaTimestampRange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("publishTimeRange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPublishTimeRange: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("publishTimeRange")(js.undefined)
        ret
    }
    @scala.inline
