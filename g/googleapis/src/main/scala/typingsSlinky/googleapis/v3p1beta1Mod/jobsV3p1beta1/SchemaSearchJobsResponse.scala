...
object SchemaSearchJobsResponse {
  ...
  implicit class SchemaSearchJobsResponseOps[Self <: SchemaSearchJobsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHistogramQueryResults(value: js.Array[SchemaHistogramQueryResult]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("histogramQueryResults")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHistogramQueryResults: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("histogramQueryResults")(js.undefined)
        ret
    }
    @scala.inline
