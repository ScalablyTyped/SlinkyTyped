...
object ParamsResourceProjectsTemplatesCreate {
  @scala.inline
  def apply(): ParamsResourceProjectsTemplatesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTemplatesCreate]
  }
  @scala.inline
  implicit class ParamsResourceProjectsTemplatesCreateOps[Self <: ParamsResourceProjectsTemplatesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaCreateJobFromTemplateRequest): Self = {
        val ret = this.duplicate
