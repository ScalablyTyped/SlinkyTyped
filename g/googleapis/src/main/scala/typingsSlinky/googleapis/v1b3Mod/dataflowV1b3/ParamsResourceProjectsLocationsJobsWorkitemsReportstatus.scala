...
object ParamsResourceProjectsLocationsJobsWorkitemsReportstatus {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsJobsWorkitemsReportstatusMutableBuilder[Self <: ParamsResourceProjectsLocationsJobsWorkitemsReportstatus] (val x: Self) extends AnyVal {
