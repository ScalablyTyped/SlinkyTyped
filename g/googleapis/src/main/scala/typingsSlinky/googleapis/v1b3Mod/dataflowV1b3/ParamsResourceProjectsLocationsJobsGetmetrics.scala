...
object ParamsResourceProjectsLocationsJobsGetmetrics {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsJobsGetmetrics = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsJobsGetmetrics]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsJobsGetmetricsMutableBuilder[Self <: ParamsResourceProjectsLocationsJobsGetmetrics] (val x: Self) extends AnyVal {
