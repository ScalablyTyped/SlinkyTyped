...
object ParamsResourceProjectsGetmetrics {
  ...
  def apply(
    ...
    fields: String = null,
    key: String = null,
    metricsFilterDotdeploymentId: String = null,
    metricsGranularity: String = null,
  ...
  ): ParamsResourceProjectsGetmetrics = {
    ...
    if (metricsFilterDotdeploymentId != null) __obj.updateDynamic("metricsFilter.deploymentId")(metricsFilterDotdeploymentId.asInstanceOf[js.Any])
