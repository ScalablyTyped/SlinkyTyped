...
@js.native
trait AnonOverlapMetricNames extends js.Object {
...
object AnonOverlapMetricNames {
  @scala.inline
  def apply(): AnonOverlapMetricNames = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonOverlapMetricNames]
  }
  @scala.inline
  implicit class AnonOverlapMetricNamesOps[Self <: AnonOverlapMetricNames] (val x: Self) extends AnyVal {
    @scala.inline
