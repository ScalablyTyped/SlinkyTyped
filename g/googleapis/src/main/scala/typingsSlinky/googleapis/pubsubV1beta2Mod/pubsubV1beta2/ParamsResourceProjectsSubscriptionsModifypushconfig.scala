...
object ParamsResourceProjectsSubscriptionsModifypushconfig {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsSubscriptionsModifypushconfigOps[Self <: ParamsResourceProjectsSubscriptionsModifypushconfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaModifyPushConfigRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
