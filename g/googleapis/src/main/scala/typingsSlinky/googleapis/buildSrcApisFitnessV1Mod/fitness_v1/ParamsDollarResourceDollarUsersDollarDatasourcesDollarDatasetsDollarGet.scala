...
@js.native
trait ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarGet]
  }
}
