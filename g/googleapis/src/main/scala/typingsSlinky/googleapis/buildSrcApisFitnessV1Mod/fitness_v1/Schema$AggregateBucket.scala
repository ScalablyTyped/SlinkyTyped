...
@js.native
trait Schema$AggregateBucket extends js.Object {
  /**
  ...
  /**
    ...
    */
  var dataset: js.UndefOr[js.Array[Schema$Dataset]] = js.native
  /**
...
object Schema$AggregateBucket {
  @scala.inline
  def apply(
    activity: Int | Double = null,
    dataset: js.Array[Schema$Dataset] = null,
    ...
    __obj.asInstanceOf[Schema$AggregateBucket]
  }
}
