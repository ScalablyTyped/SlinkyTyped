...
/**
  ...
  */
@js.native
trait Schema$DataPoint extends js.Object {
  /**
  ...
  /**
    ...
    */
  var value: js.UndefOr[js.Array[Schema$Value]] = js.native
}

object Schema$DataPoint {
  @scala.inline
  def apply(
    ...
    value: js.Array[Schema$Value] = null
  ): Schema$DataPoint = {
    ...
    __obj.asInstanceOf[Schema$DataPoint]
  }
}
