...
@js.native
trait ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUsersDollarDatasourcesDollarDatasetsDollarDelete]
  }
}
