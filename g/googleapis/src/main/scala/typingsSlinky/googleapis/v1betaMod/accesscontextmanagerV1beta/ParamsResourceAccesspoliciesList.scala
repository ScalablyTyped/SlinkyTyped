...
object ParamsResourceAccesspoliciesList {
  ...
  @scala.inline
  def apply(): ParamsResourceAccesspoliciesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccesspoliciesList]
  }
  
  @scala.inline
  implicit class ParamsResourceAccesspoliciesListMutableBuilder[Self <: ParamsResourceAccesspoliciesList] (val x: Self) extends AnyVal {
