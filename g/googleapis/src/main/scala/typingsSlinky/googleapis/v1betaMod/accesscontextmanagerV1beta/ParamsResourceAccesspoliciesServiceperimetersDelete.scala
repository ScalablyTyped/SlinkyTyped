...
object ParamsResourceAccesspoliciesServiceperimetersDelete {
  ...
  @scala.inline
  implicit class ParamsResourceAccesspoliciesServiceperimetersDeleteOps[Self <: ParamsResourceAccesspoliciesServiceperimetersDelete] (val x: Self) extends AnyVal {
