...
@js.native
trait ParamsDollarResourceDollarCommentsDollarMarkasspam extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCommentsDollarMarkasspam {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCommentsDollarMarkasspam = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCommentsDollarMarkasspam]
  }
}
