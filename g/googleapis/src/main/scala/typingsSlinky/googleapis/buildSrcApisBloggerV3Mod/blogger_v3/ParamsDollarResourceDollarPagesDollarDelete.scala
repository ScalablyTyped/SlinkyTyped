...
object ParamsDollarResourceDollarPagesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPagesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPagesDollarDelete]
  }
}
