...
@js.native
trait ParamsDollarResourceDollarCommentsDollarRemovecontent extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCommentsDollarRemovecontent {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCommentsDollarRemovecontent = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCommentsDollarRemovecontent]
  }
}
