...
@js.native
trait ParamsDollarResourceDollarPagesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPagesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    view: String = null
  ): ParamsDollarResourceDollarPagesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPagesDollarGet]
  }
}
