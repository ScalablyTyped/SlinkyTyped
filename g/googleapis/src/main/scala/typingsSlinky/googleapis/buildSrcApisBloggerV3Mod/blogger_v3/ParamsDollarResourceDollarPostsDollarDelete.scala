...
@js.native
trait ParamsDollarResourceDollarPostsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPostsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPostsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPostsDollarDelete]
  }
}
