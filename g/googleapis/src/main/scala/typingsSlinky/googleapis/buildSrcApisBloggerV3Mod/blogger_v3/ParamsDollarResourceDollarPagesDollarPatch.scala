...
@js.native
trait ParamsDollarResourceDollarPagesDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPagesDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPagesDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPagesDollarPatch]
  }
}
