...
trait ParamsDollarResourceDollarPagesDollarUpdate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Page] = js.native
  /**
...
object ParamsDollarResourceDollarPagesDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Page = null,
    revert: js.UndefOr[Boolean] = js.undefined,
    userIp: String = null
  ): ParamsDollarResourceDollarPagesDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPagesDollarUpdate]
  }
}
