...
@js.native
trait Anon_ActivityFiltersConversionDimensions extends js.Object {
...
object Anon_ActivityFiltersConversionDimensions {
  @scala.inline
  def apply(
  ...
  ): Anon_ActivityFiltersConversionDimensions = {
    ...
    __obj.asInstanceOf[Anon_ActivityFiltersConversionDimensions]
  }
}
