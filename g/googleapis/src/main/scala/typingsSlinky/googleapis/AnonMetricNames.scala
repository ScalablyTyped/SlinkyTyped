...
import typingsSlinky.googleapis.v33Mod.dfareportingV33.SchemaActivities
import typingsSlinky.googleapis.v33Mod.dfareportingV33.SchemaCustomRichMediaEvents
...
object AnonMetricNames {
  @scala.inline
  def apply(): AnonMetricNames = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonMetricNames]
  }
  @scala.inline
  implicit class AnonMetricNamesOps[Self <: AnonMetricNames] (val x: Self) extends AnyVal {
    @scala.inline
