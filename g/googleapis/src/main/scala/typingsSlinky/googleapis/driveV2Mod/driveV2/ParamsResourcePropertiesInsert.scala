...
@js.native
trait ParamsResourcePropertiesInsert extends StandardParameters {
...
object ParamsResourcePropertiesInsert {
  ...
  @scala.inline
  def apply(): ParamsResourcePropertiesInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePropertiesInsert]
  }
  
  @scala.inline
  implicit class ParamsResourcePropertiesInsertMutableBuilder[Self <: ParamsResourcePropertiesInsert] (val x: Self) extends AnyVal {
