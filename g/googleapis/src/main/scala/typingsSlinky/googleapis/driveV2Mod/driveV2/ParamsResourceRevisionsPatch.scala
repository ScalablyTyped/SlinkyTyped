...
object ParamsResourceRevisionsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceRevisionsPatchOps[Self <: ParamsResourceRevisionsPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRevision): Self = this.set("requestBody", value.asInstanceOf[js.Any])
