...
object ParamsResourcePropertiesPatch {
  ...
  implicit class ParamsResourcePropertiesPatchOps[Self <: ParamsResourcePropertiesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPropertyKey(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("propertyKey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPropertyKey: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("propertyKey")(js.undefined)
        ret
    }
    @scala.inline
    def withRequestBody(value: SchemaProperty): Self = {
        val ret = this.duplicate
