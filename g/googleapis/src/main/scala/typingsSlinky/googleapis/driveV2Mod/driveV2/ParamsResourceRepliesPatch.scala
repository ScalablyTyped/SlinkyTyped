...
@js.native
trait ParamsResourceRepliesPatch extends StandardParameters {
...
object ParamsResourceRepliesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceRepliesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRepliesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceRepliesPatchOps[Self <: ParamsResourceRepliesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCommentReply): Self = this.set("requestBody", value.asInstanceOf[js.Any])
