...
object ParamsResourcePermissionsInsert {
  ...
  implicit class ParamsResourcePermissionsInsertOps[Self <: ParamsResourcePermissionsInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSendNotificationEmails(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sendNotificationEmails")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSendNotificationEmails: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sendNotificationEmails")(js.undefined)
        ret
    }
    @scala.inline
