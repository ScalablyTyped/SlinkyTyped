...
@js.native
trait ParamsResourcePropertiesUpdate extends StandardParameters {
  /**
...
object ParamsResourcePropertiesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourcePropertiesUpdateOps[Self <: ParamsResourcePropertiesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
