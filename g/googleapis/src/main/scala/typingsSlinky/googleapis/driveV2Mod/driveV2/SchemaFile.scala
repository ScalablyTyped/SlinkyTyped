...
import typingsSlinky.googleapis.anon.Aperture
import typingsSlinky.googleapis.anon.CanAddChildren
import typingsSlinky.googleapis.anon.DurationMillis
import typingsSlinky.googleapis.anon.Hidden
import typingsSlinky.googleapis.anon.MimeType
import typingsSlinky.googleapis.anon.Text
