...
@js.native
trait Anon_AdminManagedRestrictions extends js.Object {
...
object Anon_AdminManagedRestrictions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AdminManagedRestrictions]
  }
}
