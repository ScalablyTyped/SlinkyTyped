...
object ParamsResourceSpreadsheetsValuesBatchupdatebydatafilter {
  ...
  @scala.inline
  implicit class ParamsResourceSpreadsheetsValuesBatchupdatebydatafilterOps[Self <: ParamsResourceSpreadsheetsValuesBatchupdatebydatafilter] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchUpdateValuesByDataFilterRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
