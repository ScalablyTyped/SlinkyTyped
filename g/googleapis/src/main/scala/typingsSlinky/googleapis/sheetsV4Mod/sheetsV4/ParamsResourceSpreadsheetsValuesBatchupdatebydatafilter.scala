...
object ParamsResourceSpreadsheetsValuesBatchupdatebydatafilter {
  ...
  @scala.inline
  def apply(): ParamsResourceSpreadsheetsValuesBatchupdatebydatafilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSpreadsheetsValuesBatchupdatebydatafilter]
  }
  
  @scala.inline
  implicit class ParamsResourceSpreadsheetsValuesBatchupdatebydatafilterMutableBuilder[Self <: ParamsResourceSpreadsheetsValuesBatchupdatebydatafilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchUpdateValuesByDataFilterRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
