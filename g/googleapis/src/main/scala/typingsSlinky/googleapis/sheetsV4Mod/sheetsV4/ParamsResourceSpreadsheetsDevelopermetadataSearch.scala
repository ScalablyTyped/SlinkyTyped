...
object ParamsResourceSpreadsheetsDevelopermetadataSearch {
  ...
  @scala.inline
  implicit class ParamsResourceSpreadsheetsDevelopermetadataSearchOps[Self <: ParamsResourceSpreadsheetsDevelopermetadataSearch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSearchDeveloperMetadataRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
