...
trait Schema$ExportResourcesRequest extends js.Object {
  /**
    ...
    */
  var bigqueryDestination: js.UndefOr[Schema$GoogleCloudHealthcareV1alpha2FhirBigQueryDestination] = js.native
  /**
    ...
    */
  var gcsDestination: js.UndefOr[Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsDestination] = js.native
}

object Schema$ExportResourcesRequest {
  @scala.inline
  def apply(
    bigqueryDestination: Schema$GoogleCloudHealthcareV1alpha2FhirBigQueryDestination = null,
    gcsDestination: Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsDestination = null
