...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsSource extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsSource {
  @scala.inline
  def apply(uri: String = null): Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsSource = {
    val __obj = js.Dynamic.literal()
    if (uri != null) __obj.updateDynamic("uri")(uri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsSource]
  }
}
