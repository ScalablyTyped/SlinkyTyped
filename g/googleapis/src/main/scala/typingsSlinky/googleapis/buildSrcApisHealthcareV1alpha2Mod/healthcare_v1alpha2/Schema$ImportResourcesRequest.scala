...
trait Schema$ImportResourcesRequest extends js.Object {
  ...
  /**
    ...
    */
  var gcsErrorDestination: js.UndefOr[Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsErrorDestination] = js.native
  /**
    ...
    */
  var gcsSource: js.UndefOr[Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsSource] = js.native
}
...
object Schema$ImportResourcesRequest {
  ...
  def apply(
    ...
    gcsErrorDestination: Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsErrorDestination = null,
    gcsSource: Schema$GoogleCloudHealthcareV1alpha2FhirRestGcsSource = null
