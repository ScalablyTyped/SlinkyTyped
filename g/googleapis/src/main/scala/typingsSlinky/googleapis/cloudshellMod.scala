...
import typingsSlinky.googleapis.cloudshellV1Mod.cloudshellV1.Options
...
object cloudshellMod {
  ...
  object VERSIONS {
    ...
    class v1alpha1 protected ()
      extends typingsSlinky.googleapis.cloudshellV1alpha1Mod.cloudshellV1alpha1.Cloudshell {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    @JSImport("googleapis/build/src/apis/cloudshell", "VERSIONS.v1alpha1")
    ...
    def v1alpha1: Instantiable2[
        ...
        typingsSlinky.googleapis.cloudshellV1alpha1Mod.cloudshellV1alpha1.Cloudshell
      ] = js.native
    @scala.inline
    def v1alpha1_=(
      x: Instantiable2[
  ...
  object auth extends Shortcut {
    ...
    object DefaultTransporter {
      ...
      @JSImport("googleapis/build/src/apis/cloudshell", "auth.DefaultTransporter.constructor")
      @js.native
  ...
  @JSImport("googleapis/build/src/apis/cloudshell", "cloudshell")
  @js.native
