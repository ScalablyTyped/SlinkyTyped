...
object ParamsResourceAccesspoliciesAccesslevelsCreate {
  @scala.inline
  def apply(): ParamsResourceAccesspoliciesAccesslevelsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccesspoliciesAccesslevelsCreate]
  }
  @scala.inline
  implicit class ParamsResourceAccesspoliciesAccesslevelsCreateOps[Self <: ParamsResourceAccesspoliciesAccesslevelsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaAccessLevel): Self = {
        val ret = this.duplicate
