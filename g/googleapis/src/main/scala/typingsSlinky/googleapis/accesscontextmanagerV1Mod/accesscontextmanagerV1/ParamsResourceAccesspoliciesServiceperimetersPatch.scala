...
object ParamsResourceAccesspoliciesServiceperimetersPatch {
  ...
  @scala.inline
  implicit class ParamsResourceAccesspoliciesServiceperimetersPatchOps[Self <: ParamsResourceAccesspoliciesServiceperimetersPatch] (val x: Self) extends AnyVal {
