...
object ParamsResourceAccesspoliciesServiceperimetersPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceAccesspoliciesServiceperimetersPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccesspoliciesServiceperimetersPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceAccesspoliciesServiceperimetersPatchMutableBuilder[Self <: ParamsResourceAccesspoliciesServiceperimetersPatch] (val x: Self) extends AnyVal {
