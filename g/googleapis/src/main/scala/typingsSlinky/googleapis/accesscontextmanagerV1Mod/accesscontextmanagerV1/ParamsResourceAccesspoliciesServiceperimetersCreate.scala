...
object ParamsResourceAccesspoliciesServiceperimetersCreate {
  ...
  @scala.inline
  implicit class ParamsResourceAccesspoliciesServiceperimetersCreateOps[Self <: ParamsResourceAccesspoliciesServiceperimetersCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaServicePerimeter): Self = this.set("requestBody", value.asInstanceOf[js.Any])
