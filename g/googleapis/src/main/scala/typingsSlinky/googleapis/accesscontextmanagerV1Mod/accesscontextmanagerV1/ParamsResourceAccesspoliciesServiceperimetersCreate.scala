...
object ParamsResourceAccesspoliciesServiceperimetersCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceAccesspoliciesServiceperimetersCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccesspoliciesServiceperimetersCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceAccesspoliciesServiceperimetersCreateMutableBuilder[Self <: ParamsResourceAccesspoliciesServiceperimetersCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaServicePerimeter): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
