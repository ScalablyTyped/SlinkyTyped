...
object ParamsResourceAccesspoliciesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceAccesspoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccesspoliciesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceAccesspoliciesPatchMutableBuilder[Self <: ParamsResourceAccesspoliciesPatch] (val x: Self) extends AnyVal {
