...
class Resource$V1 protected () extends js.Object {
  ...
  def batchGetAssetsHistory(params: ParamsDollarResourceDollarV1DollarBatchgetassetshistory): GaxiosPromise[Schema$BatchGetAssetsHistoryResponse] = js.native
  def batchGetAssetsHistory(
    params: ParamsDollarResourceDollarV1DollarBatchgetassetshistory,
  ...
  def batchGetAssetsHistory(params: ParamsDollarResourceDollarV1DollarBatchgetassetshistory, options: MethodOptions): GaxiosPromise[Schema$BatchGetAssetsHistoryResponse] = js.native
  def batchGetAssetsHistory(
    params: ParamsDollarResourceDollarV1DollarBatchgetassetshistory,
  ...
  def exportAssets(params: ParamsDollarResourceDollarV1DollarExportassets): GaxiosPromise[Schema$Operation] = js.native
  def exportAssets(
    params: ParamsDollarResourceDollarV1DollarExportassets,
  ...
  def exportAssets(params: ParamsDollarResourceDollarV1DollarExportassets, options: MethodOptions): GaxiosPromise[Schema$Operation] = js.native
  def exportAssets(
    params: ParamsDollarResourceDollarV1DollarExportassets,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Operation]
