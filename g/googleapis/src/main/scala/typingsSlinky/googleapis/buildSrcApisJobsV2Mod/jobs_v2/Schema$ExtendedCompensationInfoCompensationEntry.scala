...
/**
  ...
  */
@js.native
trait Schema$ExtendedCompensationInfoCompensationEntry extends js.Object {
  /**
    * Optional.  Monetary amount.
    */
  var amount: js.UndefOr[Schema$ExtendedCompensationInfoDecimal] = js.native
  /**
  ...
  /**
    ...
    * MONTHLY: 12 - ANNUAL: 1
    */
  var expectedUnitsPerYear: js.UndefOr[Schema$ExtendedCompensationInfoDecimal] = js.native
  /**
    * Optional.  Compensation range.
    */
  var range: js.UndefOr[Schema$ExtendedCompensationInfoCompensationRange] = js.native
  /**
...
object Schema$ExtendedCompensationInfoCompensationEntry {
  @scala.inline
  def apply(
    amount: Schema$ExtendedCompensationInfoDecimal = null,
    description: String = null,
    expectedUnitsPerYear: Schema$ExtendedCompensationInfoDecimal = null,
    range: Schema$ExtendedCompensationInfoCompensationRange = null,
    `type`: String = null,
    unit: String = null,
    unspecified: js.UndefOr[Boolean] = js.undefined
  ): Schema$ExtendedCompensationInfoCompensationEntry = {
    ...
    __obj.asInstanceOf[Schema$ExtendedCompensationInfoCompensationEntry]
  }
}
