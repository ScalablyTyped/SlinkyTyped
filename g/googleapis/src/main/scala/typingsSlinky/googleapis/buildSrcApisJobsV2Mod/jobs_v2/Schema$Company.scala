...
trait Schema$Company extends js.Object {
  ...
  /**
    ...
    */
  var companyInfoSources: js.UndefOr[js.Array[Schema$CompanyInfoSource]] = js.native
  /**
  ...
  /**
    ...
    */
  var structuredCompanyHqLocation: js.UndefOr[Schema$JobLocation] = js.native
  /**
...
object Schema$Company {
  ...
  def apply(
    ...
    companyInfoSources: js.Array[Schema$CompanyInfoSource] = null,
    ...
    name: String = null,
    structuredCompanyHqLocation: Schema$JobLocation = null,
