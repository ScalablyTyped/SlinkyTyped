...
/**
  ...
  */
@js.native
trait Schema$CommutePreference extends js.Object {
  /**
  ...
  /**
    ...
    */
  var startLocation: js.UndefOr[Schema$LatLng] = js.native
  /**
...
object Schema$CommutePreference {
  @scala.inline
  def apply(
    ...
    startLocation: Schema$LatLng = null,
    travelTime: String = null
  ): Schema$CommutePreference = {
    ...
    __obj.asInstanceOf[Schema$CommutePreference]
  }
}
