package typingsSlinky.googleapis.buildSrcApisPlusV1Mod.plus_v1

import typingsSlinky.googleapis.Anon_CoverInfo
import typingsSlinky.googleapis.Anon_Department
import typingsSlinky.googleapis.Anon_FamilyNameFormatted
import typingsSlinky.googleapis.Anon_IsDefault
import typingsSlinky.googleapis.Anon_LabelType
import typingsSlinky.googleapis.Anon_MaxMin
import typingsSlinky.googleapis.Anon_Primary
import typingsSlinky.googleapis.Anon_TypeValue
...
trait Schema$Person extends js.Object {
  ...
  /**
    ...
    */
  var ageRange: js.UndefOr[Anon_MaxMin] = js.native
  /**
