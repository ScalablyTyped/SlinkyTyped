...
@js.native
trait Schema$PlusAclentryResource extends js.Object {
  /**
...
object Schema$PlusAclentryResource {
  @scala.inline
  def apply(displayName: String = null, id: String = null, `type`: String = null): Schema$PlusAclentryResource = {
    val __obj = js.Dynamic.literal()
    if (displayName != null) __obj.updateDynamic("displayName")(displayName.asInstanceOf[js.Any])
    if (id != null) __obj.updateDynamic("id")(id.asInstanceOf[js.Any])
    if (`type` != null) __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$PlusAclentryResource]
  }
}
