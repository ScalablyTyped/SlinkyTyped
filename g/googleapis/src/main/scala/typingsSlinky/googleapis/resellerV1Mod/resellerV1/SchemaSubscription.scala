...
import typingsSlinky.googleapis.AnonCommitmentInterval
import typingsSlinky.googleapis.AnonIsInTrial
import typingsSlinky.googleapis.AnonMinimumTransferableSeats
...
object SchemaSubscription {
  ...
  implicit class SchemaSubscriptionOps[Self <: SchemaSubscription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRenewalSettings(value: SchemaRenewalSettings): Self = {
        val ret = this.duplicate
