...
object ParamsResourceSubscriptionsDelete {
  ...
  implicit class ParamsResourceSubscriptionsDeleteOps[Self <: ParamsResourceSubscriptionsDelete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeletionType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deletionType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDeletionType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deletionType")(js.undefined)
        ret
    }
    @scala.inline
