...
object ParamsResourceSubscriptionsChangerenewalsettings {
  ...
  @scala.inline
  implicit class ParamsResourceSubscriptionsChangerenewalsettingsOps[Self <: ParamsResourceSubscriptionsChangerenewalsettings] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaRenewalSettings): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
