...
@js.native
trait ParamsResourceSubscriptionsStartpaidservice extends StandardParameters {
...
object ParamsResourceSubscriptionsStartpaidservice {
  
  @scala.inline
  def apply(): ParamsResourceSubscriptionsStartpaidservice = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubscriptionsStartpaidservice]
  }
  
  @scala.inline
  implicit class ParamsResourceSubscriptionsStartpaidserviceMutableBuilder[Self <: ParamsResourceSubscriptionsStartpaidservice] (val x: Self) extends AnyVal {
