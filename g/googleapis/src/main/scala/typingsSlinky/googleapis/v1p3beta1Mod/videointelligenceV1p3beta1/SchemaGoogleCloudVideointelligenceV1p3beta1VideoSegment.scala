...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p3beta1VideoSegment extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p3beta1VideoSegment {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1VideoSegmentMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1VideoSegment] (val x: Self) extends AnyVal {
