...
object SchemaGoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig] (val x: Self) extends AnyVal {
    @scala.inline
