...
object SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContextMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext] (val x: Self) extends AnyVal {
