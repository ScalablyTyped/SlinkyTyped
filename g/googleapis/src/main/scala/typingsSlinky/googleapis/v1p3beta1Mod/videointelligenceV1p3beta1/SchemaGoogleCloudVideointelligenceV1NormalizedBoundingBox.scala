...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBox extends js.Object {
...
object SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBox {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBox = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBox]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBoxOps[Self <: SchemaGoogleCloudVideointelligenceV1NormalizedBoundingBox] (val x: Self) extends AnyVal {
