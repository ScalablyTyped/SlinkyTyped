...
object SchemaGoogleCloudVideointelligenceV1p2beta1TextAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1TextAnnotationMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1TextAnnotation] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setSegments(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1TextSegment]): Self = StObject.set(x, "segments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSegmentsUndefined: Self = StObject.set(x, "segments", js.undefined)
    
    @scala.inline
    def setSegmentsVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1TextSegment*): Self = StObject.set(x, "segments", js.Array(value :_*))
