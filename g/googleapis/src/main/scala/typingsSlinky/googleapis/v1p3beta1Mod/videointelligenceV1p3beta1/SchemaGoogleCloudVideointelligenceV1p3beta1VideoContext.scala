...
object SchemaGoogleCloudVideointelligenceV1p3beta1VideoContext {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1VideoContextOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1VideoContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExplicitContentDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig): Self = {
    ...
    @scala.inline
    def withLabelDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p3beta1LabelDetectionConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSegments(value: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1VideoSegment]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShotChangeDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpeechTranscriptionConfig(value: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig): Self = {
        val ret = this.duplicate
