...
object SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrameMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setNormalizedBoundingBox(value: SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox): Self = StObject.set(x, "normalizedBoundingBox", value.asInstanceOf[js.Any])
