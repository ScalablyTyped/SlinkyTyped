package typingsSlinky.googleapis.buildSrcApisAccesscontextmanagerV1Mod.accesscontextmanager_v1
...
/**
  ...
  */
@js.native
trait Schema$OsConstraint extends js.Object {
  /**
...
object Schema$OsConstraint {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$OsConstraint]
  }
}
