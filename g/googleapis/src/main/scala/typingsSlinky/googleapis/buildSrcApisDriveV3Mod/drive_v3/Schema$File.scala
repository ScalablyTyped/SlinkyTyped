...
import typingsSlinky.googleapis.Anon_ApertureCameraMake
import typingsSlinky.googleapis.Anon_CanAddChildrenCanChangeCopyRequiresWriterPermission
import typingsSlinky.googleapis.Anon_DurationMillis
import typingsSlinky.googleapis.Anon_IndexableText
...
trait Schema$File extends js.Object {
  ...
  /**
    ...
    */
  var capabilities: js.UndefOr[Anon_CanAddChildrenCanChangeCopyRequiresWriterPermission] = js.native
  /**
    * Additional information about the content of the file. These fields are
    * never populated in responses.
    */
  var contentHints: js.UndefOr[Anon_IndexableText] = js.native
  /**
  ...
  /**
    ...
    */
  var imageMediaMetadata: js.UndefOr[Anon_ApertureCameraMake] = js.native
  /**
...
object Schema$File {
  ...
  def apply(
    ...
    capabilities: Anon_CanAddChildrenCanChangeCopyRequiresWriterPermission = null,
    contentHints: Anon_IndexableText = null,
    ...
    id: String = null,
    imageMediaMetadata: Anon_ApertureCameraMake = null,
