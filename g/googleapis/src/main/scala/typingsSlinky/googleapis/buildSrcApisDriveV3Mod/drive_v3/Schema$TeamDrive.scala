package typingsSlinky.googleapis.buildSrcApisDriveV3Mod.drive_v3

import typingsSlinky.googleapis.Anon_AdminManagedRestrictions
import typingsSlinky.googleapis.Anon_CanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction
import typingsSlinky.googleapis.Anon_IdWidth
...
trait Schema$TeamDrive extends js.Object {
  /**
    ...
    */
  var backgroundImageFile: js.UndefOr[Anon_IdWidth] = js.native
  /**
  ...
  /**
    ...
    */
  var capabilities: js.UndefOr[Anon_CanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction] = js.native
  /**
  ...
  /**
    ...
    * Team Drive.
    */
  var restrictions: js.UndefOr[Anon_AdminManagedRestrictions] = js.native
  /**
...
object Schema$TeamDrive {
  @scala.inline
  def apply(
    backgroundImageFile: Anon_IdWidth = null,
    backgroundImageLink: String = null,
    capabilities: Anon_CanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction = null,
    colorRgb: String = null,
    createdTime: String = null,
    id: String = null,
    kind: String = null,
    name: String = null,
    restrictions: Anon_AdminManagedRestrictions = null,
    themeId: String = null
  ): Schema$TeamDrive = {
