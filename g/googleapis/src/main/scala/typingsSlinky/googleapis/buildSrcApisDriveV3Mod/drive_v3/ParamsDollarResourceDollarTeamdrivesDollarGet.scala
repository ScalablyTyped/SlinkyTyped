...
@js.native
trait ParamsDollarResourceDollarTeamdrivesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTeamdrivesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTeamdrivesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTeamdrivesDollarGet]
  }
}
