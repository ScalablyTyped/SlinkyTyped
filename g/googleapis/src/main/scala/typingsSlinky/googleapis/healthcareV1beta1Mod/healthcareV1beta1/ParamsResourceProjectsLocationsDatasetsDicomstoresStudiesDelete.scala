...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesDeleteOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesDelete] (val x: Self) extends AnyVal {
    @scala.inline
