...
object SchemaFhirStore {
  ...
  implicit class SchemaFhirStoreOps[Self <: SchemaFhirStore] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnableHistoryImport(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enableHistoryImport")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEnableHistoryImport: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enableHistoryImport")(js.undefined)
        ret
    }
    @scala.inline
