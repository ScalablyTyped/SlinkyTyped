...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrievemetadata {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrievemetadataOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrievemetadata] (val x: Self) extends AnyVal {
