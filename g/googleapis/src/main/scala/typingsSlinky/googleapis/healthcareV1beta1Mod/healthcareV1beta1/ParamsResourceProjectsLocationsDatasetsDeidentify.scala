...
object ParamsResourceProjectsLocationsDatasetsDeidentify {
  ...
  implicit class ParamsResourceProjectsLocationsDatasetsDeidentifyOps[Self <: ParamsResourceProjectsLocationsDatasetsDeidentify] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequestBody(value: SchemaDeidentifyDatasetRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSourceDataset(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sourceDataset")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSourceDataset: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sourceDataset")(js.undefined)
        ret
    }
  }
