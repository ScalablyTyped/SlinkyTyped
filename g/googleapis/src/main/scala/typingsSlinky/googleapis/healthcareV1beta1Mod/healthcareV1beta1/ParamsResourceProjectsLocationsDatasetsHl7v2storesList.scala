...
object ParamsResourceProjectsLocationsDatasetsHl7v2storesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsHl7v2storesListOps[Self <: ParamsResourceProjectsLocationsDatasetsHl7v2storesList] (val x: Self) extends AnyVal {
