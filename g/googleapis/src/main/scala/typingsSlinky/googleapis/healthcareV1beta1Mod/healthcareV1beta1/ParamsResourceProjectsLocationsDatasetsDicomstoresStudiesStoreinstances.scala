...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesStoreinstances {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesStoreinstancesMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesStoreinstances] (val x: Self) extends AnyVal {
