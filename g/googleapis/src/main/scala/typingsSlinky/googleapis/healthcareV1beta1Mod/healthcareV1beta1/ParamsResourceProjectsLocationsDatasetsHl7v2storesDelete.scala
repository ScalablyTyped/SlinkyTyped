...
object ParamsResourceProjectsLocationsDatasetsHl7v2storesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsHl7v2storesDeleteOps[Self <: ParamsResourceProjectsLocationsDatasetsHl7v2storesDelete] (val x: Self) extends AnyVal {
