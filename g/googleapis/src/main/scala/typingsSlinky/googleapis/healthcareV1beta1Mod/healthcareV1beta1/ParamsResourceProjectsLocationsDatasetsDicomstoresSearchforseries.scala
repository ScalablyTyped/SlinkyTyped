...
object ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseries {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseriesOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseries] (val x: Self) extends AnyVal {
    @scala.inline
