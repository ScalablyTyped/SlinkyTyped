...
@js.native
trait ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances extends StandardParameters {
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances {
  
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstancesMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances] (val x: Self) extends AnyVal {
