...
object SchemaExportDicomDataRequest {
  @scala.inline
  def apply(
    bigqueryDestination: SchemaGoogleCloudHealthcareV1beta1DicomBigQueryDestination = null,
    gcsDestination: SchemaGoogleCloudHealthcareV1beta1DicomGcsDestination = null
