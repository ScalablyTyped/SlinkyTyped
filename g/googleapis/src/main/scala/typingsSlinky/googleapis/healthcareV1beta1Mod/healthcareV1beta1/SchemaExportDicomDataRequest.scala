...
object SchemaExportDicomDataRequest {
  ...
  implicit class SchemaExportDicomDataRequestOps[Self <: SchemaExportDicomDataRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBigqueryDestination(value: SchemaGoogleCloudHealthcareV1beta1DicomBigQueryDestination): Self = {
    ...
    @scala.inline
    def withGcsDestination(value: SchemaGoogleCloudHealthcareV1beta1DicomGcsDestination): Self = {
        val ret = this.duplicate
