...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievemetadata {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievemetadataMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievemetadata] (val x: Self) extends AnyVal {
