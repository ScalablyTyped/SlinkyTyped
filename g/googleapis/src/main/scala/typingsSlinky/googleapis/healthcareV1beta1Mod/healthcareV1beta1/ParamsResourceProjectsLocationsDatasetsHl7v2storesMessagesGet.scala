...
object ParamsResourceProjectsLocationsDatasetsHl7v2storesMessagesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsHl7v2storesMessagesGetOps[Self <: ParamsResourceProjectsLocationsDatasetsHl7v2storesMessagesGet] (val x: Self) extends AnyVal {
