...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesSearchforinstances {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesSearchforinstancesOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesSearchforinstances] (val x: Self) extends AnyVal {
