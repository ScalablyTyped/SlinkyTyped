...
@js.native
trait ParamsDollarResourceDollarGroupsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarGroupsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarGroupsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarGroupsDollarDelete]
  }
}
