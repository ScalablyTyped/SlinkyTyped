...
@JSImport("googleapis/build/src/apis/youtubeAnalytics/v1", "youtubeAnalytics_v1.Resource$Reports")
@js.native
class Resource$Reports protected () extends js.Object {
  ...
  /**
    ...
    */
  def query(): GaxiosPromise[Schema$ResultTable] = js.native
  def query(callback: BodyResponseCallback[Schema$ResultTable]): Unit = js.native
  def query(params: ParamsDollarResourceDollarReportsDollarQuery): GaxiosPromise[Schema$ResultTable] = js.native
  def query(
    params: ParamsDollarResourceDollarReportsDollarQuery,
    callback: BodyResponseCallback[Schema$ResultTable]
  ): Unit = js.native
  def query(
    params: ParamsDollarResourceDollarReportsDollarQuery,
    options: BodyResponseCallback[Schema$ResultTable],
    callback: BodyResponseCallback[Schema$ResultTable]
  ): Unit = js.native
  def query(params: ParamsDollarResourceDollarReportsDollarQuery, options: MethodOptions): GaxiosPromise[Schema$ResultTable] = js.native
  def query(
    params: ParamsDollarResourceDollarReportsDollarQuery,
