...
object ParamsDollarResourceDollarGroupsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarGroupsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarGroupsDollarUpdate]
  }
}
