...
@js.native
trait ParamsDollarResourceDollarChildrenDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$ChildReference] = js.native
  /**
...
object ParamsDollarResourceDollarChildrenDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$ChildReference = null,
    supportsTeamDrives: js.UndefOr[Boolean] = js.undefined,
    userIp: String = null
  ): ParamsDollarResourceDollarChildrenDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChildrenDollarInsert]
  }
}
