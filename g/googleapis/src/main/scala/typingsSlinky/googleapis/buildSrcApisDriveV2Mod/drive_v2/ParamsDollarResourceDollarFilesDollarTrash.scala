...
@js.native
trait ParamsDollarResourceDollarFilesDollarTrash extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarFilesDollarTrash {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarFilesDollarTrash = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarFilesDollarTrash]
  }
}
