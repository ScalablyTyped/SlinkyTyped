...
@js.native
trait ParamsDollarResourceDollarFilesDollarTouch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarFilesDollarTouch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarFilesDollarTouch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarFilesDollarTouch]
  }
}
