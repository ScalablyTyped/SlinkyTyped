...
@js.native
trait ParamsDollarResourceDollarTeamdrivesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTeamdrivesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTeamdrivesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTeamdrivesDollarList]
  }
}
