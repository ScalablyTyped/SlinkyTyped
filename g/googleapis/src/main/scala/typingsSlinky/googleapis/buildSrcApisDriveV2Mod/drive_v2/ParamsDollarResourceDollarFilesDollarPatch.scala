...
@js.native
trait ParamsDollarResourceDollarFilesDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarFilesDollarPatch {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarFilesDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarFilesDollarPatch]
  }
}
