...
@js.native
trait ParamsDollarResourceDollarFilesDollarWatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarFilesDollarWatch {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarFilesDollarWatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarFilesDollarWatch]
  }
}
