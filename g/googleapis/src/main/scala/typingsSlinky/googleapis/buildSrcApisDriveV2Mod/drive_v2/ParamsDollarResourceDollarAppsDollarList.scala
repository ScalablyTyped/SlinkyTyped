...
@js.native
trait ParamsDollarResourceDollarAppsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAppsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAppsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAppsDollarList]
  }
}
