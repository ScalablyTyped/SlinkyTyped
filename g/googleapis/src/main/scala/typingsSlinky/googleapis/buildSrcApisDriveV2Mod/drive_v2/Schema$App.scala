...
import typingsSlinky.googleapis.Anon_Category
...
/**
  ...
  */
@js.native
trait Schema$App extends js.Object {
  /**
  ...
  /**
    ...
    */
  var icons: js.UndefOr[js.Array[Anon_Category]] = js.native
  /**
    * The ID of the app.
    */
...
object Schema$App {
  ...
  def apply(
    ...
    icons: js.Array[Anon_Category] = null,
    id: String = null,
