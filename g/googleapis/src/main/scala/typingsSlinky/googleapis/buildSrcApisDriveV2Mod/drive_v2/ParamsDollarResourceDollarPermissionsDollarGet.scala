...
@js.native
trait ParamsDollarResourceDollarPermissionsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPermissionsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPermissionsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPermissionsDollarGet]
  }
}
