...
@js.native
trait ParamsDollarResourceDollarChildrenDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChildrenDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChildrenDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChildrenDollarDelete]
  }
}
