...
@js.native
trait ParamsDollarResourceDollarTeamdrivesDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTeamdrivesDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTeamdrivesDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTeamdrivesDollarInsert]
  }
}
