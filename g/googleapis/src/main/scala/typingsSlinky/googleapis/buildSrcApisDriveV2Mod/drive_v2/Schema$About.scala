...
import typingsSlinky.googleapis.Anon_BytesUsed
import typingsSlinky.googleapis.Anon_FeatureName
import typingsSlinky.googleapis.Anon_RoleSets
import typingsSlinky.googleapis.Anon_Size
import typingsSlinky.googleapis.Anon_SourceTargets
...
trait Schema$About extends js.Object {
  /**
    ...
    */
  var additionalRoleInfo: js.UndefOr[js.Array[Anon_RoleSets]] = js.native
  /**
  ...
  /**
    ...
    */
  var exportFormats: js.UndefOr[js.Array[Anon_SourceTargets]] = js.native
  /**
    * List of additional features enabled on this account.
    */
  var features: js.UndefOr[js.Array[Anon_FeatureName]] = js.native
  /**
  ...
  /**
    ...
    */
  var importFormats: js.UndefOr[js.Array[Anon_SourceTargets]] = js.native
  /**
  ...
  /**
    ...
    * precedence.
    */
  var maxUploadSizes: js.UndefOr[js.Array[Anon_Size]] = js.native
  /**
  ...
  /**
    ...
    */
  var quotaBytesByService: js.UndefOr[js.Array[Anon_BytesUsed]] = js.native
  /**
...
object Schema$About {
  @scala.inline
  def apply(
    additionalRoleInfo: js.Array[Anon_RoleSets] = null,
    canCreateTeamDrives: js.UndefOr[Boolean] = js.undefined,
    domainSharingPolicy: String = null,
    etag: String = null,
    exportFormats: js.Array[Anon_SourceTargets] = null,
    features: js.Array[Anon_FeatureName] = null,
    folderColorPalette: js.Array[String] = null,
    importFormats: js.Array[Anon_SourceTargets] = null,
    isCurrentAppInstalled: js.UndefOr[Boolean] = js.undefined,
    kind: String = null,
    languageCode: String = null,
    largestChangeId: String = null,
    maxUploadSizes: js.Array[Anon_Size] = null,
    name: String = null,
    permissionId: String = null,
    quotaBytesByService: js.Array[Anon_BytesUsed] = null,
