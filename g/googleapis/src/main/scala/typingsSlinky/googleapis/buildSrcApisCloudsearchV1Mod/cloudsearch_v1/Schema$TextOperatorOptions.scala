...
/**
  ...
  */
@js.native
trait Schema$TextOperatorOptions extends js.Object {
  /**
...
object Schema$TextOperatorOptions {
  @scala.inline
  def apply(exactMatchWithOperator: js.UndefOr[Boolean] = js.undefined, operatorName: String = null): Schema$TextOperatorOptions = {
    ...
    __obj.asInstanceOf[Schema$TextOperatorOptions]
  }
}
