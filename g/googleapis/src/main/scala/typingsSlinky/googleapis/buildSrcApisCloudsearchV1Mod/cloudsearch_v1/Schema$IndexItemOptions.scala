...
@js.native
trait Schema$IndexItemOptions extends js.Object {
  /**
...
object Schema$IndexItemOptions {
  @scala.inline
  def apply(allowUnknownGsuitePrincipals: js.UndefOr[Boolean] = js.undefined): Schema$IndexItemOptions = {
    ...
    __obj.asInstanceOf[Schema$IndexItemOptions]
  }
}
