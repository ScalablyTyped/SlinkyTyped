...
/**
  ...
  */
@js.native
trait Schema$SourceCrowdingConfig extends js.Object {
  /**
...
object Schema$SourceCrowdingConfig {
  @scala.inline
  def apply(
    field: String = null,
    ...
    __obj.asInstanceOf[Schema$SourceCrowdingConfig]
  }
}
