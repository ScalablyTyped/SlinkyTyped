...
@js.native
trait ParamsDollarResourceDollarDebugDollarDatasourcesDollarItemsDollarCheckaccess extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Principal] = js.native
}
