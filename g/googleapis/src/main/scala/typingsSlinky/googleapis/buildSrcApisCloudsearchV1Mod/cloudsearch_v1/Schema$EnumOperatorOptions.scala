...
/**
  ...
  */
@js.native
trait Schema$EnumOperatorOptions extends js.Object {
  /**
...
object Schema$EnumOperatorOptions {
  @scala.inline
  def apply(operatorName: String = null): Schema$EnumOperatorOptions = {
    val __obj = js.Dynamic.literal()
    if (operatorName != null) __obj.updateDynamic("operatorName")(operatorName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$EnumOperatorOptions]
  }
}
