...
/**
  ...
  */
@js.native
trait Schema$ItemAcl extends js.Object {
  /**
  ...
  /**
    ...
    */
  var deniedReaders: js.UndefOr[js.Array[Schema$Principal]] = js.native
  /**
  ...
  /**
    ...
    * elements is 5.
    */
  var owners: js.UndefOr[js.Array[Schema$Principal]] = js.native
  /**
    ...
    */
  var readers: js.UndefOr[js.Array[Schema$Principal]] = js.native
}

object Schema$ItemAcl {
  @scala.inline
  def apply(
    aclInheritanceType: String = null,
    deniedReaders: js.Array[Schema$Principal] = null,
    inheritAclFrom: String = null,
    owners: js.Array[Schema$Principal] = null,
    readers: js.Array[Schema$Principal] = null
  ): Schema$ItemAcl = {
    ...
    __obj.asInstanceOf[Schema$ItemAcl]
  }
}
