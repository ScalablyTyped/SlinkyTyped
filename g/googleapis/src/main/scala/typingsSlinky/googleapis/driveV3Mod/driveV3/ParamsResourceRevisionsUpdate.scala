...
object ParamsResourceRevisionsUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceRevisionsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRevisionsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceRevisionsUpdateMutableBuilder[Self <: ParamsResourceRevisionsUpdate] (val x: Self) extends AnyVal {
