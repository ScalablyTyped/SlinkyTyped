...
import typingsSlinky.googleapis.AnonInheritedFrom
...
trait SchemaPermission extends js.Object {
  ...
  /**
    ...
    */
  var teamDrivePermissionDetails: js.UndefOr[js.Array[AnonInheritedFrom]] = js.native
  /**
...
object SchemaPermission {
  ...
  implicit class SchemaPermissionOps[Self <: SchemaPermission] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTeamDrivePermissionDetails(value: js.Array[AnonInheritedFrom]): Self = {
        val ret = this.duplicate
