...
import typingsSlinky.googleapis.AnonCameraMake
import typingsSlinky.googleapis.AnonCanChangeCopyRequiresWriterPermission
import typingsSlinky.googleapis.AnonDurationMillis
import typingsSlinky.googleapis.AnonIndexableText
...
object SchemaFile {
  ...
  implicit class SchemaFileOps[Self <: SchemaFile] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAppProperties(value: StringDictionary[String]): Self = {
    ...
    @scala.inline
    def withCapabilities(value: AnonCanChangeCopyRequiresWriterPermission): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImageMediaMetadata(value: AnonCameraMake): Self = {
        val ret = this.duplicate
