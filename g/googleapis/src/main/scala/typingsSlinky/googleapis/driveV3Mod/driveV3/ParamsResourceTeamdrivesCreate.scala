...
object ParamsResourceTeamdrivesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceTeamdrivesCreateOps[Self <: ParamsResourceTeamdrivesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaTeamDrive): Self = {
        val ret = this.duplicate
