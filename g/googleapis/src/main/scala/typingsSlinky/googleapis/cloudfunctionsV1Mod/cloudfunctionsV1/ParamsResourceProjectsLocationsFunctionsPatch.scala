...
object ParamsResourceProjectsLocationsFunctionsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsFunctionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsFunctionsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsFunctionsPatchMutableBuilder[Self <: ParamsResourceProjectsLocationsFunctionsPatch] (val x: Self) extends AnyVal {
