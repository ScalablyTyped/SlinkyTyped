...
@js.native
trait ParamsResourceResourcepoliciesGet extends StandardParameters {
  /**
...
object ParamsResourceResourcepoliciesGet {
  ...
  @scala.inline
  implicit class ParamsResourceResourcepoliciesGetOps[Self <: ParamsResourceResourcepoliciesGet] (val x: Self) extends AnyVal {
    @scala.inline
