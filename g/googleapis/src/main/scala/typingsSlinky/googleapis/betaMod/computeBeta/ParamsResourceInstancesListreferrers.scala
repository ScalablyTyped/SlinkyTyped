...
object ParamsResourceInstancesListreferrers {
  ...
  @scala.inline
  def apply(): ParamsResourceInstancesListreferrers = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancesListreferrers]
  }
  
  @scala.inline
  implicit class ParamsResourceInstancesListreferrersMutableBuilder[Self <: ParamsResourceInstancesListreferrers] (val x: Self) extends AnyVal {
