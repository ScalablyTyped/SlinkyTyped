...
@js.native
trait ParamsResourceUrlmapsDelete extends StandardParameters {
...
object ParamsResourceUrlmapsDelete {
  
  @scala.inline
  def apply(): ParamsResourceUrlmapsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUrlmapsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceUrlmapsDeleteMutableBuilder[Self <: ParamsResourceUrlmapsDelete] (val x: Self) extends AnyVal {
