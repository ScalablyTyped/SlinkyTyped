...
@js.native
trait ParamsResourceRoutersPreview extends StandardParameters {
  /**
...
object ParamsResourceRoutersPreview {
  @scala.inline
  def apply(): ParamsResourceRoutersPreview = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRoutersPreview]
  }
  @scala.inline
  implicit class ParamsResourceRoutersPreviewOps[Self <: ParamsResourceRoutersPreview] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaRouter): Self = {
        val ret = this.duplicate
