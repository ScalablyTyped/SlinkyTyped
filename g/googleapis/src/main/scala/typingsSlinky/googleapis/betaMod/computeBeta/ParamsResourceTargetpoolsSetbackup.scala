...
object ParamsResourceTargetpoolsSetbackup {
  @scala.inline
  def apply(): ParamsResourceTargetpoolsSetbackup = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargetpoolsSetbackup]
  }
  @scala.inline
  implicit class ParamsResourceTargetpoolsSetbackupOps[Self <: ParamsResourceTargetpoolsSetbackup] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaTargetReference): Self = {
        val ret = this.duplicate
