...
object SchemaVpnGatewayAggregatedList {
  ...
  @scala.inline
  implicit class SchemaVpnGatewayAggregatedListOps[Self <: SchemaVpnGatewayAggregatedList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: StringDictionary[SchemaVpnGatewaysScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
