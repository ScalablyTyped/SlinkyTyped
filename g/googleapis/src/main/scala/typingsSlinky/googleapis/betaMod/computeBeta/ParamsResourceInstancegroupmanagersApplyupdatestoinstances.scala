...
object ParamsResourceInstancegroupmanagersApplyupdatestoinstances {
  ...
  @scala.inline
  implicit class ParamsResourceInstancegroupmanagersApplyupdatestoinstancesOps[Self <: ParamsResourceInstancegroupmanagersApplyupdatestoinstances] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaInstanceGroupManagersApplyUpdatesRequest): Self = {
        val ret = this.duplicate
