...
@js.native
trait ParamsResourceBackendservicesUpdate extends StandardParameters {
  /**
...
object ParamsResourceBackendservicesUpdate {
  @scala.inline
  def apply(): ParamsResourceBackendservicesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendservicesUpdate]
  }
  @scala.inline
  implicit class ParamsResourceBackendservicesUpdateOps[Self <: ParamsResourceBackendservicesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
