...
object SchemaResourcePolicyList {
  ...
  @scala.inline
  implicit class SchemaResourcePolicyListOps[Self <: SchemaResourcePolicyList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaResourcePolicy*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaResourcePolicy]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
