...
@js.native
trait ParamsResourceRoutersGetrouterstatus extends StandardParameters {
  /**
...
object ParamsResourceRoutersGetrouterstatus {
  ...
  @scala.inline
  implicit class ParamsResourceRoutersGetrouterstatusOps[Self <: ParamsResourceRoutersGetrouterstatus] (val x: Self) extends AnyVal {
    @scala.inline
