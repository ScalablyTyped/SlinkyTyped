...
object SchemaVpnGateway {
  ...
  implicit class SchemaVpnGatewayOps[Self <: SchemaVpnGateway] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withVpnInterfaces(value: js.Array[SchemaVpnGatewayVpnGatewayInterface]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vpnInterfaces")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutVpnInterfaces: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vpnInterfaces")(js.undefined)
        ret
    }
  }
