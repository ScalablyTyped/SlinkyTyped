...
@js.native
trait ParamsResourceInstancegroupsDelete extends StandardParameters {
...
object ParamsResourceInstancegroupsDelete {
  
  @scala.inline
  def apply(): ParamsResourceInstancegroupsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceInstancegroupsDeleteMutableBuilder[Self <: ParamsResourceInstancegroupsDelete] (val x: Self) extends AnyVal {
