...
@js.native
trait ParamsResourceInstancesAddaccessconfig extends StandardParameters {
  /**
...
object ParamsResourceInstancesAddaccessconfig {
  @scala.inline
  def apply(): ParamsResourceInstancesAddaccessconfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancesAddaccessconfig]
  }
  @scala.inline
  implicit class ParamsResourceInstancesAddaccessconfigOps[Self <: ParamsResourceInstancesAddaccessconfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaAccessConfig): Self = {
        val ret = this.duplicate
