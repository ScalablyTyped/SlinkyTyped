...
trait Schema$Creative extends js.Object {
  ...
  /**
    ...
    */
  var corrections: js.UndefOr[js.Array[Schema$Correction]] = js.native
  /**
  ...
  /**
    ...
    */
  var filteringStats: js.UndefOr[Schema$FilteringStats] = js.native
  /**
    * An HTML creative.
    */
  var html: js.UndefOr[Schema$HtmlContent] = js.native
  /**
  ...
  /**
    * A native creative.
    */
  var native: js.UndefOr[Schema$NativeContent] = js.native
  /**
  ...
  /**
    ...
    * auction).
    */
  var servingRestrictions: js.UndefOr[js.Array[Schema$ServingRestriction]] = js.native
  /**
  ...
  /**
    * A video creative.
    */
  var video: js.UndefOr[Schema$VideoContent] = js.native
}
...
object Schema$Creative {
  ...
  def apply(
    ...
    corrections: js.Array[Schema$Correction] = null,
    ...
    filteringStats: Schema$FilteringStats = null,
    html: Schema$HtmlContent = null,
    impressionTrackingUrls: js.Array[String] = null,
    native: Schema$NativeContent = null,
    openAuctionStatus: String = null,
    restrictedCategories: js.Array[String] = null,
    servingRestrictions: js.Array[Schema$ServingRestriction] = null,
    vendorIds: js.Array[Double] = null,
    version: Int | Double = null,
    video: Schema$VideoContent = null
  ): Schema$Creative = {
