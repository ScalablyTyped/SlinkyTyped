...
@js.native
class ResourceDollarBiddersDollarFiltersetsDollarFilteredbids protected () extends js.Object {
  def this(context: APIRequestContext) = this()
  var context: APIRequestContext = js.native
  var creatives: ResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarCreatives = js.native
  var details: ResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarDetails = js.native
  /**
  ...
  def list(params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarList): GaxiosPromise[Schema$ListFilteredBidsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarList,
