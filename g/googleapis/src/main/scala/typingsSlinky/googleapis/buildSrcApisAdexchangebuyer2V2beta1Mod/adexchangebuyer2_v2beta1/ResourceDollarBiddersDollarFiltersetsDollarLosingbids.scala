...
@js.native
class ResourceDollarBiddersDollarFiltersetsDollarLosingbids protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListLosingBidsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListLosingBidsResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarLosingbidsDollarList): GaxiosPromise[Schema$ListLosingBidsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarLosingbidsDollarList,
    callback: BodyResponseCallback[Schema$ListLosingBidsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarLosingbidsDollarList,
    options: BodyResponseCallback[Schema$ListLosingBidsResponse],
    callback: BodyResponseCallback[Schema$ListLosingBidsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarLosingbidsDollarList,
    options: MethodOptions
  ): GaxiosPromise[Schema$ListLosingBidsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarLosingbidsDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListLosingBidsResponse]
