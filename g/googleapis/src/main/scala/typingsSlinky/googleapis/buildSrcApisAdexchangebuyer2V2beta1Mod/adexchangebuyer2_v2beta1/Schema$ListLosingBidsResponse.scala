...
/**
  ...
  */
@js.native
trait Schema$ListLosingBidsResponse extends js.Object {
  /**
...
object Schema$ListLosingBidsResponse {
  @scala.inline
  def apply(creativeStatusRows: js.Array[Schema$CreativeStatusRow] = null, nextPageToken: String = null): Schema$ListLosingBidsResponse = {
    ...
    __obj.asInstanceOf[Schema$ListLosingBidsResponse]
  }
}
