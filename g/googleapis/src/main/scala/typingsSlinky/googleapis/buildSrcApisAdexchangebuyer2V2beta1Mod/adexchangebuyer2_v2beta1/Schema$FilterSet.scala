...
/**
  ...
  */
@js.native
trait Schema$FilterSet extends js.Object {
  /**
    * An absolute date range, defined by a start date and an end date.
    * Interpreted relative to Pacific time zone.
    */
  var absoluteDateRange: js.UndefOr[Schema$AbsoluteDateRange] = js.native
  /**
  ...
  /**
    ...
    * timestamp.
    */
  var realtimeTimeRange: js.UndefOr[Schema$RealtimeTimeRange] = js.native
  /**
    * A relative date range, defined by an offset from today and a duration.
    * Interpreted relative to Pacific time zone.
    */
  var relativeDateRange: js.UndefOr[Schema$RelativeDateRange] = js.native
  /**
...
object Schema$FilterSet {
  @scala.inline
  def apply(
    absoluteDateRange: Schema$AbsoluteDateRange = null,
    ...
    realtimeTimeRange: Schema$RealtimeTimeRange = null,
    relativeDateRange: Schema$RelativeDateRange = null,
    ...
    __obj.asInstanceOf[Schema$FilterSet]
  }
}
