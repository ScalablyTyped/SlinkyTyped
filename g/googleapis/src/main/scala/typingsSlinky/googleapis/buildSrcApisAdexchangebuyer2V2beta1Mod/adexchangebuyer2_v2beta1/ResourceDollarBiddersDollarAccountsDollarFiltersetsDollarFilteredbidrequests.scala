...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidrequests protected () extends js.Object {
  ...
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidrequestsDollarList
