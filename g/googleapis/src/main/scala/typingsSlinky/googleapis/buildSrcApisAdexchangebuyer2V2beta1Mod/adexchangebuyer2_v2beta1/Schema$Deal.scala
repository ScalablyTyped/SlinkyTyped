...
/**
  ...
  */
@js.native
trait Schema$Deal extends js.Object {
  /**
  ...
  /**
    ...
    * Manager. @OutputOnly
    */
  var creativeRestrictions: js.UndefOr[Schema$CreativeRestrictions] = js.native
  /**
  ...
  /**
    ...
    */
  var dealTerms: js.UndefOr[Schema$DealTerms] = js.native
  /**
  ...
  /**
    ...
    */
  var targeting: js.UndefOr[Schema$MarketplaceTargeting] = js.native
  /**
...
object Schema$Deal {
  ...
  def apply(
    ...
    targeting: Schema$MarketplaceTargeting = null,
    ...
    __obj.asInstanceOf[Schema$Deal]
  }
}
