...
@js.native
trait ParamsDollarResourceDollarAccountsDollarProposalsDollarAddnote extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$AddNoteRequest] = js.native
}
