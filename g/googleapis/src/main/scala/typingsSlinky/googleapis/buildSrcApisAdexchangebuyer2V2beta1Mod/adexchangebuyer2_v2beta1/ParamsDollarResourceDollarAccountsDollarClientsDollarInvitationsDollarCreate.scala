...
@js.native
trait ParamsDollarResourceDollarAccountsDollarClientsDollarInvitationsDollarCreate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$ClientUserInvitation] = js.native
}
