...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbids protected () extends js.Object {
  def this(context: APIRequestContext) = this()
  var context: APIRequestContext = js.native
  var creatives: ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarCreatives = js.native
  var details: ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarDetails = js.native
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListFilteredBidsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListFilteredBidsResponse]): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarList
  ): GaxiosPromise[Schema$ListFilteredBidsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarList,
    options: BodyResponseCallback[Schema$ListFilteredBidsResponse],
    callback: BodyResponseCallback[Schema$ListFilteredBidsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarList,
