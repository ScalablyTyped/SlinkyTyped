...
@js.native
class ResourceDollarBiddersDollarFiltersetsDollarImpressionmetrics protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarImpressionmetricsDollarList): GaxiosPromise[Schema$ListImpressionMetricsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarImpressionmetricsDollarList,
