...
/**
  ...
  */
@js.native
trait Schema$NativeContent extends js.Object {
  /**
  ...
  /**
    ...
    */
  var appIcon: js.UndefOr[Schema$Image] = js.native
  /**
  ...
  /**
    ...
    */
  var logo: js.UndefOr[Schema$Image] = js.native
  /**
...
object Schema$NativeContent {
  @scala.inline
  def apply(
    advertiserName: String = null,
    appIcon: Schema$Image = null,
    body: String = null,
    ...
    logo: Schema$Image = null,
    priceDisplayText: String = null,
    starRating: Int | Double = null,
    storeUrl: String = null,
    videoUrl: String = null
  ): Schema$NativeContent = {
    ...
    __obj.asInstanceOf[Schema$NativeContent]
  }
}
