...
/**
  ...
  */
@js.native
trait Schema$RelativeDateRange extends js.Object {
  /**
...
object Schema$RelativeDateRange {
  @scala.inline
  def apply(durationDays: Int | Double = null, offsetDays: Int | Double = null): Schema$RelativeDateRange = {
    ...
    __obj.asInstanceOf[Schema$RelativeDateRange]
  }
}
