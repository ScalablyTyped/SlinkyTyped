...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidresponseswithoutbids protected () extends js.Object {
  ...
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidresponseswithoutbidsDollarList
