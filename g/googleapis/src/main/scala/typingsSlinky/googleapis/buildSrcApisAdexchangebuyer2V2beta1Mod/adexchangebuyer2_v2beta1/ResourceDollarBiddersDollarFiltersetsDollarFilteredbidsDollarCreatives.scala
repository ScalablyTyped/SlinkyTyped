...
@JSImport("googleapis/build/src/apis/adexchangebuyer2/v2beta1", "adexchangebuyer2_v2beta1.Resource$Bidders$Filtersets$Filteredbids$Creatives")
@js.native
class ResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarCreatives protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListCreativeStatusBreakdownByCreativeResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListCreativeStatusBreakdownByCreativeResponse]): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarCreativesDollarList
  ): GaxiosPromise[Schema$ListCreativeStatusBreakdownByCreativeResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarCreativesDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarCreativesDollarList,
    options: BodyResponseCallback[Schema$ListCreativeStatusBreakdownByCreativeResponse],
    callback: BodyResponseCallback[Schema$ListCreativeStatusBreakdownByCreativeResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarCreativesDollarList,
