...
@js.native
trait ParamsDollarResourceDollarAccountsDollarProposalsDollarCancelnegotiation extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$CancelNegotiationRequest] = js.native
}
