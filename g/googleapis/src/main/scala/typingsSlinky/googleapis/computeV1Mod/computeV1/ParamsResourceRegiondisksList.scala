...
object ParamsResourceRegiondisksList {
  ...
  @scala.inline
  def apply(): ParamsResourceRegiondisksList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegiondisksList]
  }
  
  @scala.inline
  implicit class ParamsResourceRegiondisksListMutableBuilder[Self <: ParamsResourceRegiondisksList] (val x: Self) extends AnyVal {
