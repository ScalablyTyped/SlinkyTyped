...
@js.native
trait ParamsResourceSecuritypoliciesGet extends StandardParameters {
...
object ParamsResourceSecuritypoliciesGet {
  ...
  @scala.inline
  implicit class ParamsResourceSecuritypoliciesGetOps[Self <: ParamsResourceSecuritypoliciesGet] (val x: Self) extends AnyVal {
