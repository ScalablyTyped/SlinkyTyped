...
@js.native
trait ParamsResourceRegionautoscalersInsert extends StandardParameters {
  /**
...
object ParamsResourceRegionautoscalersInsert {
  ...
  @scala.inline
  implicit class ParamsResourceRegionautoscalersInsertOps[Self <: ParamsResourceRegionautoscalersInsert] (val x: Self) extends AnyVal {
    @scala.inline
