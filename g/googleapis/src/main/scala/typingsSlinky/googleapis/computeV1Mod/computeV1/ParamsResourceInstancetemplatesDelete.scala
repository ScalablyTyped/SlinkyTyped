...
@js.native
trait ParamsResourceInstancetemplatesDelete extends StandardParameters {
...
object ParamsResourceInstancetemplatesDelete {
  
  @scala.inline
  def apply(): ParamsResourceInstancetemplatesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancetemplatesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceInstancetemplatesDeleteMutableBuilder[Self <: ParamsResourceInstancetemplatesDelete] (val x: Self) extends AnyVal {
