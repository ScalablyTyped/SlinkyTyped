...
@js.native
trait ParamsResourceSubnetworksGet extends StandardParameters {
...
object ParamsResourceSubnetworksGet {
  ...
  @scala.inline
  def apply(): ParamsResourceSubnetworksGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubnetworksGet]
  }
  
  @scala.inline
  implicit class ParamsResourceSubnetworksGetMutableBuilder[Self <: ParamsResourceSubnetworksGet] (val x: Self) extends AnyVal {
