...
object ParamsResourceBackendservicesAddsignedurlkey {
  ...
  @scala.inline
  implicit class ParamsResourceBackendservicesAddsignedurlkeyOps[Self <: ParamsResourceBackendservicesAddsignedurlkey] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaSignedUrlKey): Self = {
        val ret = this.duplicate
