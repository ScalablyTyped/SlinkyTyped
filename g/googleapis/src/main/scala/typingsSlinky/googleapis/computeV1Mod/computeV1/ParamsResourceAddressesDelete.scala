...
object ParamsResourceAddressesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceAddressesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAddressesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceAddressesDeleteMutableBuilder[Self <: ParamsResourceAddressesDelete] (val x: Self) extends AnyVal {
