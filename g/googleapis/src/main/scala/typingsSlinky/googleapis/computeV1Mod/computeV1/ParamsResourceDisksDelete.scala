...
@js.native
trait ParamsResourceDisksDelete extends StandardParameters {
...
object ParamsResourceDisksDelete {
  
  @scala.inline
  def apply(): ParamsResourceDisksDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDisksDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceDisksDeleteMutableBuilder[Self <: ParamsResourceDisksDelete] (val x: Self) extends AnyVal {
