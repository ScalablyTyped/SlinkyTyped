...
@js.native
trait ParamsResourceUrlmapsUpdate extends StandardParameters {
  /**
...
object ParamsResourceUrlmapsUpdate {
  @scala.inline
  def apply(): ParamsResourceUrlmapsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUrlmapsUpdate]
  }
  @scala.inline
  implicit class ParamsResourceUrlmapsUpdateOps[Self <: ParamsResourceUrlmapsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
