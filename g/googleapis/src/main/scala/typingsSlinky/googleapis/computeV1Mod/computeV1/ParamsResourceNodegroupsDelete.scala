...
@js.native
trait ParamsResourceNodegroupsDelete extends StandardParameters {
  /**
...
object ParamsResourceNodegroupsDelete {
  @scala.inline
  def apply(): ParamsResourceNodegroupsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodegroupsDelete]
  }
  @scala.inline
  implicit class ParamsResourceNodegroupsDeleteOps[Self <: ParamsResourceNodegroupsDelete] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withNodeGroup(value: String): Self = {
        val ret = this.duplicate
