...
object SchemaInterconnectAttachmentPrivateInfo {
  ...
  implicit class SchemaInterconnectAttachmentPrivateInfoOps[Self <: SchemaInterconnectAttachmentPrivateInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTag8021q(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tag8021q")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTag8021q: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tag8021q")(js.undefined)
        ret
    }
  }
