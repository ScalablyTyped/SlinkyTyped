...
object ParamsResourceInterconnectattachmentsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceInterconnectattachmentsInsertOps[Self <: ParamsResourceInterconnectattachmentsInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaInterconnectAttachment): Self = this.set("requestBody", value.asInstanceOf[js.Any])
