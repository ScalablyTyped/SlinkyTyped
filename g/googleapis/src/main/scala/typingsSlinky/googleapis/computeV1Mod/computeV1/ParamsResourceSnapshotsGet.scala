...
@js.native
trait ParamsResourceSnapshotsGet extends StandardParameters {
  /**
...
object ParamsResourceSnapshotsGet {
  ...
  @scala.inline
  implicit class ParamsResourceSnapshotsGetOps[Self <: ParamsResourceSnapshotsGet] (val x: Self) extends AnyVal {
    @scala.inline
