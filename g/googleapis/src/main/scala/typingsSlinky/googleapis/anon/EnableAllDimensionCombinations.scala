...
@js.native
trait EnableAllDimensionCombinations extends js.Object {
...
object EnableAllDimensionCombinations {
  ...
  @scala.inline
  implicit class EnableAllDimensionCombinationsOps[Self <: EnableAllDimensionCombinations] (val x: Self) extends AnyVal {
