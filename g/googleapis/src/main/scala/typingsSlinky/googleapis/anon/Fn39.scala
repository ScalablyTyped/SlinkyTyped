...
trait Fn39 extends js.Object {
  ...
  def apply(options: typingsSlinky.googleapis.cloudresourcemanagerV2Mod.cloudresourcemanagerV2.Options): typingsSlinky.googleapis.cloudresourcemanagerV2Mod.cloudresourcemanagerV2.Cloudresourcemanager = js.native
  def apply(
  ...
  def apply(version: v1beta1): typingsSlinky.googleapis.cloudresourcemanagerV1beta1Mod.cloudresourcemanagerV1beta1.Cloudresourcemanager = js.native
  def apply(version: v2): typingsSlinky.googleapis.cloudresourcemanagerV2Mod.cloudresourcemanagerV2.Cloudresourcemanager = js.native
  def apply(version: v2beta1): typingsSlinky.googleapis.cloudresourcemanagerV2beta1Mod.cloudresourcemanagerV2beta1.Cloudresourcemanager = js.native
}
