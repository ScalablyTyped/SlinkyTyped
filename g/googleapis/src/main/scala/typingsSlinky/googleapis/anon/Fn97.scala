...
trait Fn97 extends js.Object {
  ...
  def apply(version: v1): typingsSlinky.googleapis.oauth2V1Mod.oauth2V1.Oauth2 = js.native
  def apply(version: v2): typingsSlinky.googleapis.oauth2V2Mod.oauth2V2.Oauth2 = js.native
}
