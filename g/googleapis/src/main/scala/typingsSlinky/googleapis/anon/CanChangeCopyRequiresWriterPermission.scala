...
@js.native
trait CanChangeCopyRequiresWriterPermission extends js.Object {
...
object CanChangeCopyRequiresWriterPermission {
  ...
  @scala.inline
  implicit class CanChangeCopyRequiresWriterPermissionOps[Self <: CanChangeCopyRequiresWriterPermission] (val x: Self) extends AnyVal {
