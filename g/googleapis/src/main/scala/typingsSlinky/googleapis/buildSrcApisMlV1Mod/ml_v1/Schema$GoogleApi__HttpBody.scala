...
/**
  ...
  */
@js.native
trait Schema$GoogleApi__HttpBody extends js.Object {
  /**
...
object Schema$GoogleApi__HttpBody {
  @scala.inline
  def apply(contentType: String = null, data: String = null, extensions: js.Array[StringDictionary[_]] = null): Schema$GoogleApi__HttpBody = {
    val __obj = js.Dynamic.literal()
    if (contentType != null) __obj.updateDynamic("contentType")(contentType.asInstanceOf[js.Any])
    if (data != null) __obj.updateDynamic("data")(data.asInstanceOf[js.Any])
    if (extensions != null) __obj.updateDynamic("extensions")(extensions.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleApi__HttpBody]
  }
}
