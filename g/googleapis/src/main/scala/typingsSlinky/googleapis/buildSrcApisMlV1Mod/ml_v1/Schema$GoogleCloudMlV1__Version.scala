...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudMlV1__Version extends js.Object {
  /**
    ...
    */
  var autoScaling: js.UndefOr[Schema$GoogleCloudMlV1__AutoScaling] = js.native
  /**
  ...
  /**
    ...
    * number of nodes.
    */
  var manualScaling: js.UndefOr[Schema$GoogleCloudMlV1__ManualScaling] = js.native
  /**
...
object Schema$GoogleCloudMlV1__Version {
  @scala.inline
  def apply(
    autoScaling: Schema$GoogleCloudMlV1__AutoScaling = null,
    ...
    manualScaling: Schema$GoogleCloudMlV1__ManualScaling = null,
    name: String = null,
    pythonVersion: String = null,
    runtimeVersion: String = null,
    state: String = null
  ): Schema$GoogleCloudMlV1__Version = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudMlV1__Version]
  }
}
