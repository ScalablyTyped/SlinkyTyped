...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudMlV1__PredictionInput extends js.Object {
  /**
...
object Schema$GoogleCloudMlV1__PredictionInput {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudMlV1__PredictionInput = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudMlV1__PredictionInput]
  }
}
