...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudMlV1__ParameterSpec extends js.Object {
  /**
...
object Schema$GoogleCloudMlV1__ParameterSpec {
  @scala.inline
  def apply(
    ...
    `type`: String = null
  ): Schema$GoogleCloudMlV1__ParameterSpec = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudMlV1__ParameterSpec]
  }
}
