...
/**
  ...
  */
@js.native
trait Schema$GoogleIamV1__AuditLogConfig extends js.Object {
  /**
...
object Schema$GoogleIamV1__AuditLogConfig {
  @scala.inline
  def apply(exemptedMembers: js.Array[String] = null, logType: String = null): Schema$GoogleIamV1__AuditLogConfig = {
    ...
    __obj.asInstanceOf[Schema$GoogleIamV1__AuditLogConfig]
  }
}
