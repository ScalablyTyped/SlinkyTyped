...
object ParamsResourceProjectsProfilesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsProfilesCreateOps[Self <: ParamsResourceProjectsProfilesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateProfileRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
