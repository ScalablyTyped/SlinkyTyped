...
object ParamsResourceProjectsProfilesCreateoffline {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsProfilesCreateofflineOps[Self <: ParamsResourceProjectsProfilesCreateoffline] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaProfile): Self = {
        val ret = this.duplicate
