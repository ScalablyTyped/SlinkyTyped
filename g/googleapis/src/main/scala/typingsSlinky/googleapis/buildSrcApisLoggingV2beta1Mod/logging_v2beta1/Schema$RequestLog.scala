...
/**
  ...
  */
@js.native
trait Schema$RequestLog extends js.Object {
  /**
  ...
  /**
    ...
    * request.
    */
  var line: js.UndefOr[js.Array[Schema$LogLine]] = js.native
  /**
  ...
  /**
    ...
    */
  var sourceReference: js.UndefOr[js.Array[Schema$SourceReference]] = js.native
  /**
...
object Schema$RequestLog {
  ...
  def apply(
    ...
    ip: String = null,
    latency: String = null,
    line: js.Array[Schema$LogLine] = null,
    ...
    sourceReference: js.Array[Schema$SourceReference] = null,
    ...
    __obj.asInstanceOf[Schema$RequestLog]
  }
}
