...
object fileV1beta1 {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.fileV1beta1Mod.fileV1beta1.ResourceProjects {
  ...
  class ResourceProjectsLocations protected ()
    extends typingsSlinky.googleapis.fileV1beta1Mod.fileV1beta1.ResourceProjectsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsInstances protected ()
    extends typingsSlinky.googleapis.fileV1beta1Mod.fileV1beta1.ResourceProjectsLocationsInstances {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsOperations protected ()
    extends typingsSlinky.googleapis.fileV1beta1Mod.fileV1beta1.ResourceProjectsLocationsOperations {
    def this(context: APIRequestContext) = this()
  }
}
