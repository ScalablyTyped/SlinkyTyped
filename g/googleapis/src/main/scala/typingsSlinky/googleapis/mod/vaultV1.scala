...
object vaultV1 {
  ...
  class ResourceMatters protected ()
    extends typingsSlinky.googleapis.vaultV1Mod.vaultV1.ResourceMatters {
  ...
  class ResourceMattersExports protected ()
    extends typingsSlinky.googleapis.vaultV1Mod.vaultV1.ResourceMattersExports {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceMattersHolds protected ()
    extends typingsSlinky.googleapis.vaultV1Mod.vaultV1.ResourceMattersHolds {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceMattersHoldsAccounts protected ()
    extends typingsSlinky.googleapis.vaultV1Mod.vaultV1.ResourceMattersHoldsAccounts {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceMattersSavedqueries protected ()
    extends typingsSlinky.googleapis.vaultV1Mod.vaultV1.ResourceMattersSavedqueries {
    def this(context: APIRequestContext) = this()
  }
