...
object replicapoolV1beta1 {
  ...
  class Replicapool protected ()
    extends typingsSlinky.googleapis.replicapoolV1beta1Mod.replicapoolV1beta1.Replicapool {
  ...
  class ResourcePools protected ()
    extends typingsSlinky.googleapis.replicapoolV1beta1Mod.replicapoolV1beta1.ResourcePools {
  ...
  class ResourceReplicas protected ()
    extends typingsSlinky.googleapis.replicapoolV1beta1Mod.replicapoolV1beta1.ResourceReplicas {
    def this(context: APIRequestContext) = this()
  }
}
