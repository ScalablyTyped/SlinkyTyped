...
object deploymentmanagerV2beta {
  ...
  class ResourceCompositetypes protected ()
    extends typingsSlinky.googleapis.v2betaMod.deploymentmanagerV2beta.ResourceCompositetypes {
  ...
  class ResourceDeployments protected ()
    extends typingsSlinky.googleapis.v2betaMod.deploymentmanagerV2beta.ResourceDeployments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceManifests protected ()
    extends typingsSlinky.googleapis.v2betaMod.deploymentmanagerV2beta.ResourceManifests {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.v2betaMod.deploymentmanagerV2beta.ResourceOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceResources protected ()
    extends typingsSlinky.googleapis.v2betaMod.deploymentmanagerV2beta.ResourceResources {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceTypeproviders protected ()
    extends typingsSlinky.googleapis.v2betaMod.deploymentmanagerV2beta.ResourceTypeproviders {
    def this(context: APIRequestContext) = this()
  }
