...
object bloggerV3 {
  ...
  class ResourceBlogs protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourceBlogs {
  ...
  class ResourceBloguserinfos protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourceBloguserinfos {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceComments protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourceComments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePages protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourcePages {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePageviews protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourcePageviews {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePosts protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourcePosts {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePostuserinfos protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourcePostuserinfos {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUsers protected ()
    extends typingsSlinky.googleapis.bloggerV3Mod.bloggerV3.ResourceUsers {
    def this(context: APIRequestContext) = this()
  }
}
