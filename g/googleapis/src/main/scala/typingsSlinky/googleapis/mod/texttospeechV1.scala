...
object texttospeechV1 {
  ...
  class ResourceText protected ()
    extends typingsSlinky.googleapis.texttospeechV1Mod.texttospeechV1.ResourceText {
  ...
  class ResourceVoices protected ()
    extends typingsSlinky.googleapis.texttospeechV1Mod.texttospeechV1.ResourceVoices {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Texttospeech protected ()
    extends typingsSlinky.googleapis.texttospeechV1Mod.texttospeechV1.Texttospeech {
