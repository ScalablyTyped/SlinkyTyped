...
object websecurityscannerV1alpha {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1alphaMod.websecurityscannerV1alpha.ResourceProjects {
  ...
  class ResourceProjectsScanconfigs protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1alphaMod.websecurityscannerV1alpha.ResourceProjectsScanconfigs {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsScanconfigsScanruns protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1alphaMod.websecurityscannerV1alpha.ResourceProjectsScanconfigsScanruns {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsScanconfigsScanrunsCrawledurls protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1alphaMod.websecurityscannerV1alpha.ResourceProjectsScanconfigsScanrunsCrawledurls {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsScanconfigsScanrunsFindings protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1alphaMod.websecurityscannerV1alpha.ResourceProjectsScanconfigsScanrunsFindings {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsScanconfigsScanrunsFindingtypestats protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1alphaMod.websecurityscannerV1alpha.ResourceProjectsScanconfigsScanrunsFindingtypestats {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Websecurityscanner protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1alphaMod.websecurityscannerV1alpha.Websecurityscanner {
