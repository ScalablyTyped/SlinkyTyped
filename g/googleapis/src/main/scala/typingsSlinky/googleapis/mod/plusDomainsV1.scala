...
object plusDomainsV1 {
  ...
  class Plusdomains protected ()
    extends typingsSlinky.googleapis.plusDomainsV1Mod.plusDomainsV1.Plusdomains {
  ...
  class ResourceActivities protected ()
    extends typingsSlinky.googleapis.plusDomainsV1Mod.plusDomainsV1.ResourceActivities {
  ...
  class ResourceAudiences protected ()
    extends typingsSlinky.googleapis.plusDomainsV1Mod.plusDomainsV1.ResourceAudiences {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCircles protected ()
    extends typingsSlinky.googleapis.plusDomainsV1Mod.plusDomainsV1.ResourceCircles {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceComments protected ()
    extends typingsSlinky.googleapis.plusDomainsV1Mod.plusDomainsV1.ResourceComments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceMedia protected ()
    extends typingsSlinky.googleapis.plusDomainsV1Mod.plusDomainsV1.ResourceMedia {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePeople protected ()
    extends typingsSlinky.googleapis.plusDomainsV1Mod.plusDomainsV1.ResourcePeople {
    def this(context: APIRequestContext) = this()
  }
}
