...
object appengineV1beta {
  ...
  class ResourceAppsAuthorizeddomains protected ()
    extends typingsSlinky.googleapis.appengineV1betaMod.appengineV1beta.ResourceAppsAuthorizeddomains {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceAppsFirewall protected ()
    extends typingsSlinky.googleapis.appengineV1betaMod.appengineV1beta.ResourceAppsFirewall {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceAppsServicesVersions protected ()
    extends typingsSlinky.googleapis.appengineV1betaMod.appengineV1beta.ResourceAppsServicesVersions {
    def this(context: APIRequestContext) = this()
  }
