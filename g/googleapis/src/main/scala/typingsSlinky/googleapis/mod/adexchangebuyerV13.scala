...
object adexchangebuyerV13 {
  ...
  class ResourceAccounts protected ()
    extends typingsSlinky.googleapis.v13Mod.adexchangebuyerV13.ResourceAccounts {
  ...
  class ResourceBillinginfo protected ()
    extends typingsSlinky.googleapis.v13Mod.adexchangebuyerV13.ResourceBillinginfo {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCreatives protected ()
    extends typingsSlinky.googleapis.v13Mod.adexchangebuyerV13.ResourceCreatives {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceDirectdeals protected ()
    extends typingsSlinky.googleapis.v13Mod.adexchangebuyerV13.ResourceDirectdeals {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePerformancereport protected ()
    extends typingsSlinky.googleapis.v13Mod.adexchangebuyerV13.ResourcePerformancereport {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePretargetingconfig protected ()
    extends typingsSlinky.googleapis.v13Mod.adexchangebuyerV13.ResourcePretargetingconfig {
    def this(context: APIRequestContext) = this()
  }
}
