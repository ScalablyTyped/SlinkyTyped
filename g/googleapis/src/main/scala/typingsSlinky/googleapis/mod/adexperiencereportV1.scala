...
object adexperiencereportV1 {
  ...
  class Adexperiencereport protected ()
    extends typingsSlinky.googleapis.adexperiencereportV1Mod.adexperiencereportV1.Adexperiencereport {
  ...
  class ResourceSites protected ()
    extends typingsSlinky.googleapis.adexperiencereportV1Mod.adexperiencereportV1.ResourceSites {
