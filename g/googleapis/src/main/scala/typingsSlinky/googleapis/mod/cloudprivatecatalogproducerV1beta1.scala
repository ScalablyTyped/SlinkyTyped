...
object cloudprivatecatalogproducerV1beta1 {
  ...
  class Cloudprivatecatalogproducer protected ()
    extends typingsSlinky.googleapis.cloudprivatecatalogproducerV1beta1Mod.cloudprivatecatalogproducerV1beta1.Cloudprivatecatalogproducer {
  ...
  class ResourceCatalogs protected ()
    extends typingsSlinky.googleapis.cloudprivatecatalogproducerV1beta1Mod.cloudprivatecatalogproducerV1beta1.ResourceCatalogs {
  ...
  class ResourceCatalogsProducts protected ()
    extends typingsSlinky.googleapis.cloudprivatecatalogproducerV1beta1Mod.cloudprivatecatalogproducerV1beta1.ResourceCatalogsProducts {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCatalogsProductsIcons protected ()
    extends typingsSlinky.googleapis.cloudprivatecatalogproducerV1beta1Mod.cloudprivatecatalogproducerV1beta1.ResourceCatalogsProductsIcons {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCatalogsProductsVersions protected ()
    extends typingsSlinky.googleapis.cloudprivatecatalogproducerV1beta1Mod.cloudprivatecatalogproducerV1beta1.ResourceCatalogsProductsVersions {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.cloudprivatecatalogproducerV1beta1Mod.cloudprivatecatalogproducerV1beta1.ResourceOperations {
    def this(context: APIRequestContext) = this()
  }
}
