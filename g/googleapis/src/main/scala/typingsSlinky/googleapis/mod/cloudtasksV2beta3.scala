...
object cloudtasksV2beta3 {
  ...
  class ResourceProjectsLocations protected ()
    extends typingsSlinky.googleapis.v2beta3Mod.cloudtasksV2beta3.ResourceProjectsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsQueuesTasks protected ()
    extends typingsSlinky.googleapis.v2beta3Mod.cloudtasksV2beta3.ResourceProjectsLocationsQueuesTasks {
    def this(context: APIRequestContext) = this()
  }
}
