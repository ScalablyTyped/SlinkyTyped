package typingsSlinky.googleapis.mod.firebasehostingV1beta1
...
class Firebasehosting protected ()
  extends typingsSlinky.googleapis.firebasehostingV1beta1Mod.firebasehostingV1beta1.Firebasehosting {
