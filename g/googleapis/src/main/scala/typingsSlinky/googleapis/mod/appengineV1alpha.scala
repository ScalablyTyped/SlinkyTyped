...
object appengineV1alpha {
  ...
  class ResourceApps protected ()
    extends typingsSlinky.googleapis.v1alphaMod.appengineV1alpha.ResourceApps {
  ...
  class ResourceAppsAuthorizedcertificates protected ()
    extends typingsSlinky.googleapis.v1alphaMod.appengineV1alpha.ResourceAppsAuthorizedcertificates {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceAppsAuthorizeddomains protected ()
    extends typingsSlinky.googleapis.v1alphaMod.appengineV1alpha.ResourceAppsAuthorizeddomains {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceAppsDomainmappings protected ()
    extends typingsSlinky.googleapis.v1alphaMod.appengineV1alpha.ResourceAppsDomainmappings {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceAppsLocations protected ()
    extends typingsSlinky.googleapis.v1alphaMod.appengineV1alpha.ResourceAppsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceAppsOperations protected ()
    extends typingsSlinky.googleapis.v1alphaMod.appengineV1alpha.ResourceAppsOperations {
    def this(context: APIRequestContext) = this()
  }
}
