...
object dialogflowV2 {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjects {
  ...
  class ResourceProjectsAgent protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjectsAgent {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsAgentEntitytypes protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjectsAgentEntitytypes {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsAgentEntitytypesEntities protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjectsAgentEntitytypesEntities {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsAgentIntents protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjectsAgentIntents {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsAgentSessions protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjectsAgentSessions {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsAgentSessionsContexts protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjectsAgentSessionsContexts {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsAgentSessionsEntitytypes protected ()
    extends typingsSlinky.googleapis.dialogflowV2Mod.dialogflowV2.ResourceProjectsAgentSessionsEntitytypes {
    def this(context: APIRequestContext) = this()
  }
