...
object gamesManagementV1management {
  ...
  class Gamesmanagement protected ()
    extends typingsSlinky.googleapis.v1managementMod.gamesManagementV1management.Gamesmanagement {
  ...
  class ResourceAchievements protected ()
    extends typingsSlinky.googleapis.v1managementMod.gamesManagementV1management.ResourceAchievements {
  ...
  class ResourceEvents protected ()
    extends typingsSlinky.googleapis.v1managementMod.gamesManagementV1management.ResourceEvents {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePlayers protected ()
    extends typingsSlinky.googleapis.v1managementMod.gamesManagementV1management.ResourcePlayers {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceRooms protected ()
    extends typingsSlinky.googleapis.v1managementMod.gamesManagementV1management.ResourceRooms {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceScores protected ()
    extends typingsSlinky.googleapis.v1managementMod.gamesManagementV1management.ResourceScores {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceTurnbasedmatches protected ()
    extends typingsSlinky.googleapis.v1managementMod.gamesManagementV1management.ResourceTurnbasedmatches {
    def this(context: APIRequestContext) = this()
  }
}
