...
object alertcenterV1beta1 {
  ...
  class ResourceAlerts protected ()
    extends typingsSlinky.googleapis.v1beta1Mod.alertcenterV1beta1.ResourceAlerts {
  ...
  class ResourceAlertsFeedback protected ()
    extends typingsSlinky.googleapis.v1beta1Mod.alertcenterV1beta1.ResourceAlertsFeedback {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceV1beta1 protected ()
    extends typingsSlinky.googleapis.v1beta1Mod.alertcenterV1beta1.ResourceV1beta1 {
    def this(context: APIRequestContext) = this()
  }
}
