...
object libraryagentV1 {
  ...
  class Libraryagent protected ()
    extends typingsSlinky.googleapis.libraryagentV1Mod.libraryagentV1.Libraryagent {
  ...
  class ResourceShelvesBooks protected ()
    extends typingsSlinky.googleapis.libraryagentV1Mod.libraryagentV1.ResourceShelvesBooks {
    def this(context: APIRequestContext) = this()
  }
}
