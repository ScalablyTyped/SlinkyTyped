...
object cloudtasksV2 {
  ...
  class Cloudtasks protected ()
    extends typingsSlinky.googleapis.cloudtasksV2Mod.cloudtasksV2.Cloudtasks {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.cloudtasksV2Mod.cloudtasksV2.ResourceProjects {
  ...
  class ResourceProjectsLocations protected ()
    extends typingsSlinky.googleapis.cloudtasksV2Mod.cloudtasksV2.ResourceProjectsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsQueues protected ()
    extends typingsSlinky.googleapis.cloudtasksV2Mod.cloudtasksV2.ResourceProjectsLocationsQueues {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsQueuesTasks protected ()
    extends typingsSlinky.googleapis.cloudtasksV2Mod.cloudtasksV2.ResourceProjectsLocationsQueuesTasks {
    def this(context: APIRequestContext) = this()
  }
}
