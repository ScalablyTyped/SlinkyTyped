...
object fitnessV1 {
  ...
  class ResourceUsers protected ()
    extends typingsSlinky.googleapis.fitnessV1Mod.fitnessV1.ResourceUsers {
  ...
  class ResourceUsersDataset protected ()
    extends typingsSlinky.googleapis.fitnessV1Mod.fitnessV1.ResourceUsersDataset {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUsersDatasources protected ()
    extends typingsSlinky.googleapis.fitnessV1Mod.fitnessV1.ResourceUsersDatasources {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUsersDatasourcesDatapointchanges protected ()
    extends typingsSlinky.googleapis.fitnessV1Mod.fitnessV1.ResourceUsersDatasourcesDatapointchanges {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUsersDatasourcesDatasets protected ()
    extends typingsSlinky.googleapis.fitnessV1Mod.fitnessV1.ResourceUsersDatasourcesDatasets {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUsersSessions protected ()
    extends typingsSlinky.googleapis.fitnessV1Mod.fitnessV1.ResourceUsersSessions {
    def this(context: APIRequestContext) = this()
  }
}
