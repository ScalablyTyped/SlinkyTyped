...
object speechV1p1beta1 {
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.v1p1beta1Mod.speechV1p1beta1.ResourceOperations {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.v1p1beta1Mod.speechV1p1beta1.ResourceProjects {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocations protected ()
    extends typingsSlinky.googleapis.v1p1beta1Mod.speechV1p1beta1.ResourceProjectsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsOperations protected ()
    extends typingsSlinky.googleapis.v1p1beta1Mod.speechV1p1beta1.ResourceProjectsLocationsOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsOperations protected ()
    extends typingsSlinky.googleapis.v1p1beta1Mod.speechV1p1beta1.ResourceProjectsOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsOperationsManualrecognitiontasks protected ()
    extends typingsSlinky.googleapis.v1p1beta1Mod.speechV1p1beta1.ResourceProjectsOperationsManualrecognitiontasks {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceSpeech protected ()
    extends typingsSlinky.googleapis.v1p1beta1Mod.speechV1p1beta1.ResourceSpeech {
    def this(context: APIRequestContext) = this()
  }
