package typingsSlinky.googleapis.mod.abusiveexperiencereportV1
...
class Abusiveexperiencereport protected ()
  extends typingsSlinky.googleapis.v1Mod.abusiveexperiencereportV1.Abusiveexperiencereport {
