...
object driveV2 {
  ...
  class ResourceAbout protected ()
    extends typingsSlinky.googleapis.driveV2Mod.driveV2.ResourceAbout {
  ...
  class ResourceChildren protected ()
    extends typingsSlinky.googleapis.driveV2Mod.driveV2.ResourceChildren {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceParents protected ()
    extends typingsSlinky.googleapis.driveV2Mod.driveV2.ResourceParents {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePermissions protected ()
    extends typingsSlinky.googleapis.driveV2Mod.driveV2.ResourcePermissions {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceTeamdrives protected ()
    extends typingsSlinky.googleapis.driveV2Mod.driveV2.ResourceTeamdrives {
    def this(context: APIRequestContext) = this()
  }
}
