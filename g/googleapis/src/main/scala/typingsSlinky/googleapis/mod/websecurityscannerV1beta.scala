...
object websecurityscannerV1beta {
  ...
  class ResourceProjectsScanconfigs protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1betaMod.websecurityscannerV1beta.ResourceProjectsScanconfigs {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsScanconfigsScanrunsCrawledurls protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1betaMod.websecurityscannerV1beta.ResourceProjectsScanconfigsScanrunsCrawledurls {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsScanconfigsScanrunsFindings protected ()
    extends typingsSlinky.googleapis.websecurityscannerV1betaMod.websecurityscannerV1beta.ResourceProjectsScanconfigsScanrunsFindings {
    def this(context: APIRequestContext) = this()
  }
