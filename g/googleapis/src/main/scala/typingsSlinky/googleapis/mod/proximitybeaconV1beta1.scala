...
object proximitybeaconV1beta1 {
  ...
  class Proximitybeacon protected ()
    extends typingsSlinky.googleapis.proximitybeaconV1beta1Mod.proximitybeaconV1beta1.Proximitybeacon {
  ...
  class ResourceBeaconinfo protected ()
    extends typingsSlinky.googleapis.proximitybeaconV1beta1Mod.proximitybeaconV1beta1.ResourceBeaconinfo {
  ...
  class ResourceBeacons protected ()
    extends typingsSlinky.googleapis.proximitybeaconV1beta1Mod.proximitybeaconV1beta1.ResourceBeacons {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceBeaconsAttachments protected ()
    extends typingsSlinky.googleapis.proximitybeaconV1beta1Mod.proximitybeaconV1beta1.ResourceBeaconsAttachments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceBeaconsDiagnostics protected ()
    extends typingsSlinky.googleapis.proximitybeaconV1beta1Mod.proximitybeaconV1beta1.ResourceBeaconsDiagnostics {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceNamespaces protected ()
    extends typingsSlinky.googleapis.proximitybeaconV1beta1Mod.proximitybeaconV1beta1.ResourceNamespaces {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceV1beta1 protected ()
    extends typingsSlinky.googleapis.proximitybeaconV1beta1Mod.proximitybeaconV1beta1.ResourceV1beta1 {
    def this(context: APIRequestContext) = this()
  }
}
