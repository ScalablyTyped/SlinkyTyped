...
object adminReportsV1 {
  ...
  class ResourceActivities protected ()
    extends typingsSlinky.googleapis.reportsV1Mod.adminReportsV1.ResourceActivities {
  ...
  class ResourceCustomerusagereports protected ()
    extends typingsSlinky.googleapis.reportsV1Mod.adminReportsV1.ResourceCustomerusagereports {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceEntityusagereports protected ()
    extends typingsSlinky.googleapis.reportsV1Mod.adminReportsV1.ResourceEntityusagereports {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUserusagereport protected ()
    extends typingsSlinky.googleapis.reportsV1Mod.adminReportsV1.ResourceUserusagereport {
    def this(context: APIRequestContext) = this()
  }
}
