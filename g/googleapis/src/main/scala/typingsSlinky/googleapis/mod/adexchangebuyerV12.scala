...
object adexchangebuyerV12 {
  ...
  class Adexchangebuyer protected ()
    extends typingsSlinky.googleapis.v12Mod.adexchangebuyerV12.Adexchangebuyer {
  ...
  class ResourceAccounts protected ()
    extends typingsSlinky.googleapis.v12Mod.adexchangebuyerV12.ResourceAccounts {
  ...
  class ResourceCreatives protected ()
    extends typingsSlinky.googleapis.v12Mod.adexchangebuyerV12.ResourceCreatives {
    def this(context: APIRequestContext) = this()
  }
}
