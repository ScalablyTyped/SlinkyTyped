...
object osloginV1beta {
  ...
  class ResourceUsers protected ()
    extends typingsSlinky.googleapis.osloginV1betaMod.osloginV1beta.ResourceUsers {
  ...
  class ResourceUsersProjects protected ()
    extends typingsSlinky.googleapis.osloginV1betaMod.osloginV1beta.ResourceUsersProjects {
    def this(context: APIRequestContext) = this()
  }
