...
object visionV1p1beta1 {
  ...
  class ResourceFiles protected ()
    extends typingsSlinky.googleapis.visionV1p1beta1Mod.visionV1p1beta1.ResourceFiles {
  ...
  class ResourceImages protected ()
    extends typingsSlinky.googleapis.visionV1p1beta1Mod.visionV1p1beta1.ResourceImages {
    def this(context: APIRequestContext) = this()
  }
