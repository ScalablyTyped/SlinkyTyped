...
object bigqueryV2 {
  ...
  class ResourceDatasets protected ()
    extends typingsSlinky.googleapis.bigqueryV2Mod.bigqueryV2.ResourceDatasets {
  ...
  class ResourceJobs protected ()
    extends typingsSlinky.googleapis.bigqueryV2Mod.bigqueryV2.ResourceJobs {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceModels protected ()
    extends typingsSlinky.googleapis.bigqueryV2Mod.bigqueryV2.ResourceModels {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.bigqueryV2Mod.bigqueryV2.ResourceProjects {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceTabledata protected ()
    extends typingsSlinky.googleapis.bigqueryV2Mod.bigqueryV2.ResourceTabledata {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceTables protected ()
    extends typingsSlinky.googleapis.bigqueryV2Mod.bigqueryV2.ResourceTables {
    def this(context: APIRequestContext) = this()
  }
}
