...
object remotebuildexecutionV2 {
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.remotebuildexecutionV2Mod.remotebuildexecutionV2.ResourceOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceV2 protected ()
    extends typingsSlinky.googleapis.remotebuildexecutionV2Mod.remotebuildexecutionV2.ResourceV2 {
    def this(context: APIRequestContext) = this()
  }
}
