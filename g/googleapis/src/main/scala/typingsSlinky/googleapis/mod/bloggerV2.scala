...
object bloggerV2 {
  ...
  class ResourceBlogs protected ()
    extends typingsSlinky.googleapis.bloggerV2Mod.bloggerV2.ResourceBlogs {
  ...
  class ResourceComments protected ()
    extends typingsSlinky.googleapis.bloggerV2Mod.bloggerV2.ResourceComments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePages protected ()
    extends typingsSlinky.googleapis.bloggerV2Mod.bloggerV2.ResourcePages {
    def this(context: APIRequestContext) = this()
  }
