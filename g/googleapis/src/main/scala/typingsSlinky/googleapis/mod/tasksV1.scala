...
object tasksV1 {
  ...
  class ResourceTasklists protected ()
    extends typingsSlinky.googleapis.tasksV1Mod.tasksV1.ResourceTasklists {
  ...
  class ResourceTasks protected ()
    extends typingsSlinky.googleapis.tasksV1Mod.tasksV1.ResourceTasks {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Tasks protected ()
    extends typingsSlinky.googleapis.tasksV1Mod.tasksV1.Tasks {
