...
object storageV1beta2 {
  ...
  class ResourceBucketaccesscontrols protected ()
    extends typingsSlinky.googleapis.storageV1beta2Mod.storageV1beta2.ResourceBucketaccesscontrols {
  ...
  class ResourceBuckets protected ()
    extends typingsSlinky.googleapis.storageV1beta2Mod.storageV1beta2.ResourceBuckets {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceChannels protected ()
    extends typingsSlinky.googleapis.storageV1beta2Mod.storageV1beta2.ResourceChannels {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceDefaultobjectaccesscontrols protected ()
    extends typingsSlinky.googleapis.storageV1beta2Mod.storageV1beta2.ResourceDefaultobjectaccesscontrols {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceObjectaccesscontrols protected ()
    extends typingsSlinky.googleapis.storageV1beta2Mod.storageV1beta2.ResourceObjectaccesscontrols {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceObjects protected ()
    extends typingsSlinky.googleapis.storageV1beta2Mod.storageV1beta2.ResourceObjects {
    def this(context: APIRequestContext) = this()
  }
