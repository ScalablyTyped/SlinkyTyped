...
object cloudbuildV1 {
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.cloudbuildV1Mod.cloudbuildV1.ResourceOperations {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.cloudbuildV1Mod.cloudbuildV1.ResourceProjects {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsBuilds protected ()
    extends typingsSlinky.googleapis.cloudbuildV1Mod.cloudbuildV1.ResourceProjectsBuilds {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsTriggers protected ()
    extends typingsSlinky.googleapis.cloudbuildV1Mod.cloudbuildV1.ResourceProjectsTriggers {
    def this(context: APIRequestContext) = this()
  }
}
