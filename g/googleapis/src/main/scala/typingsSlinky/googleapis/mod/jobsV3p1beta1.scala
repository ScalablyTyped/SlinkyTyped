...
object jobsV3p1beta1 {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.v3p1beta1Mod.jobsV3p1beta1.ResourceProjects {
  ...
  class ResourceProjectsCompanies protected ()
    extends typingsSlinky.googleapis.v3p1beta1Mod.jobsV3p1beta1.ResourceProjectsCompanies {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsJobs protected ()
    extends typingsSlinky.googleapis.v3p1beta1Mod.jobsV3p1beta1.ResourceProjectsJobs {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsOperations protected ()
    extends typingsSlinky.googleapis.v3p1beta1Mod.jobsV3p1beta1.ResourceProjectsOperations {
    def this(context: APIRequestContext) = this()
  }
}
