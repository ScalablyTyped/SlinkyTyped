...
object androidmanagementV1 {
  ...
  class Androidmanagement protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.Androidmanagement {
  ...
  class ResourceEnterprises protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.ResourceEnterprises {
  ...
  class ResourceEnterprisesApplications protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.ResourceEnterprisesApplications {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceEnterprisesDevices protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.ResourceEnterprisesDevices {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceEnterprisesDevicesOperations protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.ResourceEnterprisesDevicesOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceEnterprisesEnrollmenttokens protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.ResourceEnterprisesEnrollmenttokens {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceEnterprisesWebtokens protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.ResourceEnterprisesWebtokens {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceSignupurls protected ()
    extends typingsSlinky.googleapis.androidmanagementV1Mod.androidmanagementV1.ResourceSignupurls {
    def this(context: APIRequestContext) = this()
  }
}
