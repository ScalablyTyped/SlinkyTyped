...
object androiddeviceprovisioningV1 {
  ...
  class ResourceCustomers protected ()
    extends typingsSlinky.googleapis.androiddeviceprovisioningV1Mod.androiddeviceprovisioningV1.ResourceCustomers {
  ...
  class ResourceCustomersConfigurations protected ()
    extends typingsSlinky.googleapis.androiddeviceprovisioningV1Mod.androiddeviceprovisioningV1.ResourceCustomersConfigurations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePartners protected ()
    extends typingsSlinky.googleapis.androiddeviceprovisioningV1Mod.androiddeviceprovisioningV1.ResourcePartners {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePartnersCustomers protected ()
    extends typingsSlinky.googleapis.androiddeviceprovisioningV1Mod.androiddeviceprovisioningV1.ResourcePartnersCustomers {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourcePartnersVendorsCustomers protected ()
    extends typingsSlinky.googleapis.androiddeviceprovisioningV1Mod.androiddeviceprovisioningV1.ResourcePartnersVendorsCustomers {
    def this(context: APIRequestContext) = this()
  }
}
