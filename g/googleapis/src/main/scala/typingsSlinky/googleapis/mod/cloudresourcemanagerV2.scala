...
object cloudresourcemanagerV2 {
  ...
  class ResourceFolders protected ()
    extends typingsSlinky.googleapis.cloudresourcemanagerV2Mod.cloudresourcemanagerV2.ResourceFolders {
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.cloudresourcemanagerV2Mod.cloudresourcemanagerV2.ResourceOperations {
    def this(context: APIRequestContext) = this()
  }
}
