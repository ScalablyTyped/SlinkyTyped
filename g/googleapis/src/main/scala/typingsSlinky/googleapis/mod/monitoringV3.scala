...
object monitoringV3 {
  ...
  class Monitoring protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.Monitoring {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjects {
  ...
  class ResourceProjectsAlertpolicies protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsAlertpolicies {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsCollectdtimeseries protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsCollectdtimeseries {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsGroups protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsGroups {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsGroupsMembers protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsGroupsMembers {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsMetricdescriptors protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsMetricdescriptors {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsMonitoredresourcedescriptors protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsMonitoredresourcedescriptors {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsNotificationchanneldescriptors protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsNotificationchanneldescriptors {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsNotificationchannels protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsNotificationchannels {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsTimeseries protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsTimeseries {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsUptimecheckconfigs protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceProjectsUptimecheckconfigs {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUptimecheckips protected ()
    extends typingsSlinky.googleapis.monitoringV3Mod.monitoringV3.ResourceUptimecheckips {
    def this(context: APIRequestContext) = this()
  }
}
