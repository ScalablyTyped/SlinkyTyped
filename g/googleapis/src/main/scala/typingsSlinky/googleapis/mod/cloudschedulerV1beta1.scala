...
object cloudschedulerV1beta1 {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.cloudschedulerV1beta1Mod.cloudschedulerV1beta1.ResourceProjects {
  ...
  class ResourceProjectsLocations protected ()
    extends typingsSlinky.googleapis.cloudschedulerV1beta1Mod.cloudschedulerV1beta1.ResourceProjectsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsJobs protected ()
    extends typingsSlinky.googleapis.cloudschedulerV1beta1Mod.cloudschedulerV1beta1.ResourceProjectsLocationsJobs {
    def this(context: APIRequestContext) = this()
  }
}
