...
object classroomV1 {
  ...
  class ResourceCourses protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCourses {
  ...
  class ResourceCoursesAliases protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCoursesAliases {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCoursesAnnouncements protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCoursesAnnouncements {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCoursesCoursework protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCoursesCoursework {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCoursesCourseworkStudentsubmissions protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCoursesCourseworkStudentsubmissions {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCoursesStudents protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCoursesStudents {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCoursesTeachers protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCoursesTeachers {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCoursesTopics protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceCoursesTopics {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceInvitations protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceInvitations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceRegistrations protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceRegistrations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUserprofiles protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceUserprofiles {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUserprofilesGuardianinvitations protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceUserprofilesGuardianinvitations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUserprofilesGuardians protected ()
    extends typingsSlinky.googleapis.classroomV1Mod.classroomV1.ResourceUserprofilesGuardians {
    def this(context: APIRequestContext) = this()
  }
}
