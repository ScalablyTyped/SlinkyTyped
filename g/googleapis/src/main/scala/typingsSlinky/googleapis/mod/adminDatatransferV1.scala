...
object adminDatatransferV1 {
  ...
  class ResourceApplications protected ()
    extends typingsSlinky.googleapis.datatransferV1Mod.adminDatatransferV1.ResourceApplications {
  ...
  class ResourceTransfers protected ()
    extends typingsSlinky.googleapis.datatransferV1Mod.adminDatatransferV1.ResourceTransfers {
    def this(context: APIRequestContext) = this()
  }
}
