...
object calendarV3 {
  ...
  class ResourceAcl protected ()
    extends typingsSlinky.googleapis.calendarV3Mod.calendarV3.ResourceAcl {
  ...
  class ResourceCalendarlist protected ()
    extends typingsSlinky.googleapis.calendarV3Mod.calendarV3.ResourceCalendarlist {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceCalendars protected ()
    extends typingsSlinky.googleapis.calendarV3Mod.calendarV3.ResourceCalendars {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceChannels protected ()
    extends typingsSlinky.googleapis.calendarV3Mod.calendarV3.ResourceChannels {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceColors protected ()
    extends typingsSlinky.googleapis.calendarV3Mod.calendarV3.ResourceColors {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceEvents protected ()
    extends typingsSlinky.googleapis.calendarV3Mod.calendarV3.ResourceEvents {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceSettings protected ()
    extends typingsSlinky.googleapis.calendarV3Mod.calendarV3.ResourceSettings {
    def this(context: APIRequestContext) = this()
  }
}
