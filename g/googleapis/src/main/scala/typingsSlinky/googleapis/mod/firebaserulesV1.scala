...
object firebaserulesV1 {
  ...
  class Firebaserules protected ()
    extends typingsSlinky.googleapis.firebaserulesV1Mod.firebaserulesV1.Firebaserules {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.firebaserulesV1Mod.firebaserulesV1.ResourceProjects {
  ...
  class ResourceProjectsReleases protected ()
    extends typingsSlinky.googleapis.firebaserulesV1Mod.firebaserulesV1.ResourceProjectsReleases {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsRulesets protected ()
    extends typingsSlinky.googleapis.firebaserulesV1Mod.firebaserulesV1.ResourceProjectsRulesets {
    def this(context: APIRequestContext) = this()
  }
}
