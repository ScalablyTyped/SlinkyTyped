...
object composerV1beta1 {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.composerV1beta1Mod.composerV1beta1.ResourceProjects {
  ...
  class ResourceProjectsLocations protected ()
    extends typingsSlinky.googleapis.composerV1beta1Mod.composerV1beta1.ResourceProjectsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsEnvironments protected ()
    extends typingsSlinky.googleapis.composerV1beta1Mod.composerV1beta1.ResourceProjectsLocationsEnvironments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsImageversions protected ()
    extends typingsSlinky.googleapis.composerV1beta1Mod.composerV1beta1.ResourceProjectsLocationsImageversions {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsOperations protected ()
    extends typingsSlinky.googleapis.composerV1beta1Mod.composerV1beta1.ResourceProjectsLocationsOperations {
    def this(context: APIRequestContext) = this()
  }
}
