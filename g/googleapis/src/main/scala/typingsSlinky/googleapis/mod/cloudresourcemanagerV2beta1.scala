...
object cloudresourcemanagerV2beta1 {
  ...
  class ResourceFolders protected ()
    extends typingsSlinky.googleapis.cloudresourcemanagerV2beta1Mod.cloudresourcemanagerV2beta1.ResourceFolders {
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.cloudresourcemanagerV2beta1Mod.cloudresourcemanagerV2beta1.ResourceOperations {
    def this(context: APIRequestContext) = this()
  }
}
