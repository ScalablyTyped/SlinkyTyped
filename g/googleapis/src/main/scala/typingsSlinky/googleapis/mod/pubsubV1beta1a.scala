...
object pubsubV1beta1a {
  ...
  class ResourceSubscriptions protected ()
    extends typingsSlinky.googleapis.v1beta1aMod.pubsubV1beta1a.ResourceSubscriptions {
  ...
  class ResourceTopics protected ()
    extends typingsSlinky.googleapis.v1beta1aMod.pubsubV1beta1a.ResourceTopics {
    def this(context: APIRequestContext) = this()
  }
}
