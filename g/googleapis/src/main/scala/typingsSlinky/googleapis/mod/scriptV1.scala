...
object scriptV1 {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.scriptV1Mod.scriptV1.ResourceProjects {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsDeployments protected ()
    extends typingsSlinky.googleapis.scriptV1Mod.scriptV1.ResourceProjectsDeployments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceScripts protected ()
    extends typingsSlinky.googleapis.scriptV1Mod.scriptV1.ResourceScripts {
    def this(context: APIRequestContext) = this()
  }
