...
object manufacturersV1 {
  ...
  class Manufacturers protected ()
    extends typingsSlinky.googleapis.manufacturersV1Mod.manufacturersV1.Manufacturers {
  ...
  class ResourceAccounts protected ()
    extends typingsSlinky.googleapis.manufacturersV1Mod.manufacturersV1.ResourceAccounts {
  ...
  class ResourceAccountsProducts protected ()
    extends typingsSlinky.googleapis.manufacturersV1Mod.manufacturersV1.ResourceAccountsProducts {
    def this(context: APIRequestContext) = this()
  }
}
