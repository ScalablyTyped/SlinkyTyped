...
object bigtableadminV2 {
  ...
  class Bigtableadmin protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.Bigtableadmin {
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceOperations {
  ...
  class ResourceOperationsProjects protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceOperationsProjects {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceOperationsProjectsOperations protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceOperationsProjectsOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceProjects {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsInstances protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceProjectsInstances {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsInstancesAppprofiles protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceProjectsInstancesAppprofiles {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsInstancesClusters protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceProjectsInstancesClusters {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsInstancesTables protected ()
    extends typingsSlinky.googleapis.bigtableadminV2Mod.bigtableadminV2.ResourceProjectsInstancesTables {
    def this(context: APIRequestContext) = this()
  }
}
