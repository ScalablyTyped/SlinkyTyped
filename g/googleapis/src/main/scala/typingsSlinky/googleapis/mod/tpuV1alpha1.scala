...
object tpuV1alpha1 {
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.tpuV1alpha1Mod.tpuV1alpha1.ResourceProjects {
  ...
  class ResourceProjectsLocations protected ()
    extends typingsSlinky.googleapis.tpuV1alpha1Mod.tpuV1alpha1.ResourceProjectsLocations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsAcceleratortypes protected ()
    extends typingsSlinky.googleapis.tpuV1alpha1Mod.tpuV1alpha1.ResourceProjectsLocationsAcceleratortypes {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsNodes protected ()
    extends typingsSlinky.googleapis.tpuV1alpha1Mod.tpuV1alpha1.ResourceProjectsLocationsNodes {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsOperations protected ()
    extends typingsSlinky.googleapis.tpuV1alpha1Mod.tpuV1alpha1.ResourceProjectsLocationsOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsTensorflowversions protected ()
    extends typingsSlinky.googleapis.tpuV1alpha1Mod.tpuV1alpha1.ResourceProjectsLocationsTensorflowversions {
    def this(context: APIRequestContext) = this()
  }
