...
object resellerV1 {
  ...
  class ResourceResellernotify protected ()
    extends typingsSlinky.googleapis.resellerV1Mod.resellerV1.ResourceResellernotify {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceSubscriptions protected ()
    extends typingsSlinky.googleapis.resellerV1Mod.resellerV1.ResourceSubscriptions {
    def this(context: APIRequestContext) = this()
  }
}
