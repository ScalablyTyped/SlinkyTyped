package typingsSlinky.googleapis.mod.androiddeviceprovisioningV1
...
class Androiddeviceprovisioning protected ()
  extends typingsSlinky.googleapis.androiddeviceprovisioningV1Mod.androiddeviceprovisioningV1.Androiddeviceprovisioning {
