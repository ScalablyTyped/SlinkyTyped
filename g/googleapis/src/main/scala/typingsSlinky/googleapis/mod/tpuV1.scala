...
object tpuV1 {
  ...
  class ResourceProjectsLocationsAcceleratortypes protected ()
    extends typingsSlinky.googleapis.tpuV1Mod.tpuV1.ResourceProjectsLocationsAcceleratortypes {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsNodes protected ()
    extends typingsSlinky.googleapis.tpuV1Mod.tpuV1.ResourceProjectsLocationsNodes {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsLocationsTensorflowversions protected ()
    extends typingsSlinky.googleapis.tpuV1Mod.tpuV1.ResourceProjectsLocationsTensorflowversions {
    def this(context: APIRequestContext) = this()
  }
