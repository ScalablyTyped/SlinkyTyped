...
object sqladminV1beta4 {
  ...
  class ResourceBackupruns protected ()
    extends typingsSlinky.googleapis.v1beta4Mod.sqladminV1beta4.ResourceBackupruns {
  ...
  class ResourceDatabases protected ()
    extends typingsSlinky.googleapis.v1beta4Mod.sqladminV1beta4.ResourceDatabases {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceInstances protected ()
    extends typingsSlinky.googleapis.v1beta4Mod.sqladminV1beta4.ResourceInstances {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceOperations protected ()
    extends typingsSlinky.googleapis.v1beta4Mod.sqladminV1beta4.ResourceOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUsers protected ()
    extends typingsSlinky.googleapis.v1beta4Mod.sqladminV1beta4.ResourceUsers {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Sqladmin protected ()
    extends typingsSlinky.googleapis.v1beta4Mod.sqladminV1beta4.Sqladmin {
