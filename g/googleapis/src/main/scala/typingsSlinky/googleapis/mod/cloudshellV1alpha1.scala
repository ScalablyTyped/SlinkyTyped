...
object cloudshellV1alpha1 {
  ...
  class ResourceUsers protected ()
    extends typingsSlinky.googleapis.cloudshellV1alpha1Mod.cloudshellV1alpha1.ResourceUsers {
  ...
  class ResourceUsersEnvironments protected ()
    extends typingsSlinky.googleapis.cloudshellV1alpha1Mod.cloudshellV1alpha1.ResourceUsersEnvironments {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceUsersEnvironmentsPublickeys protected ()
    extends typingsSlinky.googleapis.cloudshellV1alpha1Mod.cloudshellV1alpha1.ResourceUsersEnvironmentsPublickeys {
    def this(context: APIRequestContext) = this()
  }
}
