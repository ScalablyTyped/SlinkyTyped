...
object dnsV2beta1 {
  ...
  class ResourceChanges protected ()
    extends typingsSlinky.googleapis.dnsV2beta1Mod.dnsV2beta1.ResourceChanges {
  ...
  class ResourceDnskeys protected ()
    extends typingsSlinky.googleapis.dnsV2beta1Mod.dnsV2beta1.ResourceDnskeys {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceManagedzoneoperations protected ()
    extends typingsSlinky.googleapis.dnsV2beta1Mod.dnsV2beta1.ResourceManagedzoneoperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceManagedzones protected ()
    extends typingsSlinky.googleapis.dnsV2beta1Mod.dnsV2beta1.ResourceManagedzones {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjects protected ()
    extends typingsSlinky.googleapis.dnsV2beta1Mod.dnsV2beta1.ResourceProjects {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceResourcerecordsets protected ()
    extends typingsSlinky.googleapis.dnsV2beta1Mod.dnsV2beta1.ResourceResourcerecordsets {
    def this(context: APIRequestContext) = this()
  }
}
