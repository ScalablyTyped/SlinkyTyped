...
object runtimeconfigV1beta1 {
  ...
  class ResourceProjectsConfigs protected ()
    extends typingsSlinky.googleapis.runtimeconfigV1beta1Mod.runtimeconfigV1beta1.ResourceProjectsConfigs {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsConfigsOperations protected ()
    extends typingsSlinky.googleapis.runtimeconfigV1beta1Mod.runtimeconfigV1beta1.ResourceProjectsConfigsOperations {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsConfigsVariables protected ()
    extends typingsSlinky.googleapis.runtimeconfigV1beta1Mod.runtimeconfigV1beta1.ResourceProjectsConfigsVariables {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceProjectsConfigsWaiters protected ()
    extends typingsSlinky.googleapis.runtimeconfigV1beta1Mod.runtimeconfigV1beta1.ResourceProjectsConfigsWaiters {
    def this(context: APIRequestContext) = this()
  }
