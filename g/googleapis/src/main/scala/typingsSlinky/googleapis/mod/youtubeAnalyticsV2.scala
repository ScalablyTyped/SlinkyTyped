...
object youtubeAnalyticsV2 {
  ...
  class ResourceGroupitems protected ()
    extends typingsSlinky.googleapis.youtubeAnalyticsV2Mod.youtubeAnalyticsV2.ResourceGroupitems {
  ...
  class ResourceGroups protected ()
    extends typingsSlinky.googleapis.youtubeAnalyticsV2Mod.youtubeAnalyticsV2.ResourceGroups {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceReports protected ()
    extends typingsSlinky.googleapis.youtubeAnalyticsV2Mod.youtubeAnalyticsV2.ResourceReports {
    def this(context: APIRequestContext) = this()
  }
