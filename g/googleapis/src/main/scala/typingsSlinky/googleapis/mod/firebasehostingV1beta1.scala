...
object firebasehostingV1beta1 {
  ...
  class ResourceSitesDomains protected ()
    extends typingsSlinky.googleapis.firebasehostingV1beta1Mod.firebasehostingV1beta1.ResourceSitesDomains {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceSitesReleases protected ()
    extends typingsSlinky.googleapis.firebasehostingV1beta1Mod.firebasehostingV1beta1.ResourceSitesReleases {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceSitesVersions protected ()
    extends typingsSlinky.googleapis.firebasehostingV1beta1Mod.firebasehostingV1beta1.ResourceSitesVersions {
    def this(context: APIRequestContext) = this()
  }
  ...
  class ResourceSitesVersionsFiles protected ()
    extends typingsSlinky.googleapis.firebasehostingV1beta1Mod.firebasehostingV1beta1.ResourceSitesVersionsFiles {
    def this(context: APIRequestContext) = this()
  }
}
