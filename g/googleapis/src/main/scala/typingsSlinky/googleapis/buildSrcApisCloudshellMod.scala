...
import typingsSlinky.googleapis.buildSrcApisCloudshellV1Mod.cloudshell_v1.Cloudshell
import typingsSlinky.googleapis.buildSrcApisCloudshellV1Mod.cloudshell_v1.Options
...
object buildSrcApisCloudshellMod extends js.Object {
  ...
  def cloudshell(options: typingsSlinky.googleapis.buildSrcApisCloudshellV1alpha1Mod.cloudshell_v1alpha1.Options): typingsSlinky.googleapis.buildSrcApisCloudshellV1alpha1Mod.cloudshell_v1alpha1.Cloudshell = js.native
  @JSName("cloudshell")
  def cloudshell_v1(version: v1): Cloudshell = js.native
  @JSName("cloudshell")
  def cloudshell_v1alpha1(version: v1alpha1): typingsSlinky.googleapis.buildSrcApisCloudshellV1alpha1Mod.cloudshell_v1alpha1.Cloudshell = js.native
  @js.native
  object VERSIONS extends js.Object {
    ...
    class v1alpha1 protected ()
      extends typingsSlinky.googleapis.buildSrcApisCloudshellV1alpha1Mod.cloudshell_v1alpha1.Cloudshell {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v1alpha1
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisCloudshellV1alpha1Mod.cloudshell_v1alpha1.Cloudshell
              ]
            ]
