...
import typingsSlinky.googleapis.Anon_Available
...
/**
  ...
  */
@js.native
trait Schema$DatabaseInstance extends js.Object {
  /**
  ...
  /**
    ...
    */
  var diskEncryptionConfiguration: js.UndefOr[Schema$DiskEncryptionConfiguration] = js.native
  /**
    * Disk encryption status specific to an instance. Applies only to Second
    * Generation instances.
    */
  var diskEncryptionStatus: js.UndefOr[Schema$DiskEncryptionStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var failoverReplica: js.UndefOr[Anon_Available] = js.native
  /**
  ...
  /**
    ...
    */
  var ipAddresses: js.UndefOr[js.Array[Schema$IpMapping]] = js.native
  /**
  ...
  /**
    ...
    */
  var onPremisesConfiguration: js.UndefOr[Schema$OnPremisesConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var replicaConfiguration: js.UndefOr[Schema$ReplicaConfiguration] = js.native
  /**
  ...
  /**
    * The user settings.
    */
  var settings: js.UndefOr[Schema$Settings] = js.native
  /**
...
object Schema$DatabaseInstance {
  @scala.inline
  def apply(
    ...
    diskEncryptionConfiguration: Schema$DiskEncryptionConfiguration = null,
    diskEncryptionStatus: Schema$DiskEncryptionStatus = null,
    etag: String = null,
    failoverReplica: Anon_Available = null,
    gceZone: String = null,
    instanceType: String = null,
    ipAddresses: js.Array[Schema$IpMapping] = null,
    ipv6Address: String = null,
    kind: String = null,
    masterInstanceName: String = null,
    maxDiskSize: String = null,
    name: String = null,
    onPremisesConfiguration: Schema$OnPremisesConfiguration = null,
    project: String = null,
    region: String = null,
    replicaConfiguration: Schema$ReplicaConfiguration = null,
    ...
    __obj.asInstanceOf[Schema$DatabaseInstance]
  }
}
