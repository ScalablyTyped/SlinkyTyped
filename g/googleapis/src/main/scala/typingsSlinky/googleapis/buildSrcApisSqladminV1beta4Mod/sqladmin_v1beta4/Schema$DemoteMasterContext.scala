...
/**
  ...
  */
@js.native
trait Schema$DemoteMasterContext extends js.Object {
  /**
  ...
  /**
    ...
    * master.
    */
  var replicaConfiguration: js.UndefOr[Schema$DemoteMasterConfiguration] = js.native
  /**
...
object Schema$DemoteMasterContext {
  @scala.inline
  def apply(
    kind: String = null,
    masterInstanceName: String = null,
    replicaConfiguration: Schema$DemoteMasterConfiguration = null,
    verifyGtidConsistency: js.UndefOr[Boolean] = js.undefined
  ): Schema$DemoteMasterContext = {
    ...
    __obj.asInstanceOf[Schema$DemoteMasterContext]
  }
}
