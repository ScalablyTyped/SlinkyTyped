...
/**
  ...
  */
@js.native
trait Schema$MySqlReplicaConfiguration extends js.Object {
  /**
...
object Schema$MySqlReplicaConfiguration {
  @scala.inline
  def apply(
  ...
  ): Schema$MySqlReplicaConfiguration = {
    ...
    __obj.asInstanceOf[Schema$MySqlReplicaConfiguration]
  }
}
