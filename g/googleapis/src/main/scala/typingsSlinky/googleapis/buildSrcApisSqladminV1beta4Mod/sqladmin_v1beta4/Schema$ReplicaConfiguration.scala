...
/**
  ...
  */
@js.native
trait Schema$ReplicaConfiguration extends js.Object {
  /**
  ...
  /**
    ...
    * directory.
    */
  var mysqlReplicaConfiguration: js.UndefOr[Schema$MySqlReplicaConfiguration] = js.native
}

object Schema$ReplicaConfiguration {
  @scala.inline
  def apply(
    failoverTarget: js.UndefOr[Boolean] = js.undefined,
    kind: String = null,
    mysqlReplicaConfiguration: Schema$MySqlReplicaConfiguration = null
  ): Schema$ReplicaConfiguration = {
    ...
    __obj.asInstanceOf[Schema$ReplicaConfiguration]
  }
}
