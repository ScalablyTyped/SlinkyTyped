...
@js.native
trait ParamsDollarResourceDollarFlagsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarFlagsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarFlagsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarFlagsDollarList]
  }
}
