...
@js.native
trait ParamsDollarResourceDollarSslcertsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSslcertsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSslcertsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSslcertsDollarGet]
  }
}
