...
/**
  ...
  */
@js.native
trait Schema$DemoteMasterMySqlReplicaConfiguration extends js.Object {
  /**
...
object Schema$DemoteMasterMySqlReplicaConfiguration {
  @scala.inline
  def apply(
  ...
  ): Schema$DemoteMasterMySqlReplicaConfiguration = {
    ...
    __obj.asInstanceOf[Schema$DemoteMasterMySqlReplicaConfiguration]
  }
}
