...
trait Schema$Settings extends js.Object {
  ...
  /**
    ...
    */
  var backupConfiguration: js.UndefOr[Schema$BackupConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var databaseFlags: js.UndefOr[js.Array[Schema$DatabaseFlags]] = js.native
  /**
    * Configuration specific to read replica instances. Indicates whether
  ...
  /**
    ...
    * instances.
    */
  var ipConfiguration: js.UndefOr[Schema$IpConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var locationPreference: js.UndefOr[Schema$LocationPreference] = js.native
  /**
    ...
    * Generation instances.
    */
  var maintenanceWindow: js.UndefOr[Schema$MaintenanceWindow] = js.native
  /**
...
object Schema$Settings {
  ...
  def apply(
    ...
    backupConfiguration: Schema$BackupConfiguration = null,
    crashSafeReplicationEnabled: js.UndefOr[Boolean] = js.undefined,
    dataDiskSizeGb: String = null,
    dataDiskType: String = null,
    databaseFlags: js.Array[Schema$DatabaseFlags] = null,
    databaseReplicationEnabled: js.UndefOr[Boolean] = js.undefined,
    ipConfiguration: Schema$IpConfiguration = null,
    kind: String = null,
    locationPreference: Schema$LocationPreference = null,
    maintenanceWindow: Schema$MaintenanceWindow = null,
