...
import typingsSlinky.googleapis.buildSrcApisIndexingV3Mod.indexing_v3.Indexing
import typingsSlinky.googleapis.buildSrcApisIndexingV3Mod.indexing_v3.Options
...
@JSImport("googleapis/build/src/apis/indexing", JSImport.Namespace)
@js.native
object buildSrcApisIndexingMod extends js.Object {
  def indexing(options: Options): Indexing = js.native
  @JSName("indexing")
  def indexing_v3(version: v3): Indexing = js.native
  @js.native
  object VERSIONS extends js.Object {
    @js.native
    class v3 protected () extends Indexing {
