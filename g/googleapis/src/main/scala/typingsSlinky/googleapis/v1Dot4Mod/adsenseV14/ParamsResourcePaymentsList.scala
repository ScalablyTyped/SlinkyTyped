...
@js.native
trait ParamsResourcePaymentsList extends StandardParameters {
  /**
...
object ParamsResourcePaymentsList {
  ...
  @scala.inline
  implicit class ParamsResourcePaymentsListOps[Self <: ParamsResourcePaymentsList] (val x: Self) extends AnyVal {
    @scala.inline
