...
object ParamsResourceAccountsReportsSavedGenerate {
  ...
  implicit class ParamsResourceAccountsReportsSavedGenerateOps[Self <: ParamsResourceAccountsReportsSavedGenerate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSavedReportId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("savedReportId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSavedReportId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("savedReportId")(js.undefined)
        ret
    }
    @scala.inline
