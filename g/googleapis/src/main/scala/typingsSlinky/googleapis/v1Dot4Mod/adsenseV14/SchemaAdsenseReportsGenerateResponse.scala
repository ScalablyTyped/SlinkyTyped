...
import typingsSlinky.googleapis.AnonCurrency
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait SchemaAdsenseReportsGenerateResponse extends js.Object {
  /**
...
object SchemaAdsenseReportsGenerateResponse {
  ...
  @scala.inline
  implicit class SchemaAdsenseReportsGenerateResponseOps[Self <: SchemaAdsenseReportsGenerateResponse] (val x: Self) extends AnyVal {
    @scala.inline
