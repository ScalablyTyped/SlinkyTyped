...
object SchemaAdClients {
  ...
  implicit class SchemaAdClientsOps[Self <: SchemaAdClients] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaAdClient*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaAdClient]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
