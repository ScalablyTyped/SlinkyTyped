...
object AnonEnableAllDimensionCombinations {
  @scala.inline
  def apply(): AnonEnableAllDimensionCombinations = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonEnableAllDimensionCombinations]
  }
  @scala.inline
  implicit class AnonEnableAllDimensionCombinationsOps[Self <: AnonEnableAllDimensionCombinations] (val x: Self) extends AnyVal {
    @scala.inline
