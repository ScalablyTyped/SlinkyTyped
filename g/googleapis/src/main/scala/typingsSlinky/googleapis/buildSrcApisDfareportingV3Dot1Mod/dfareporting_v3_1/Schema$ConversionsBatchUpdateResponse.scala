...
/**
  ...
  */
@js.native
trait Schema$ConversionsBatchUpdateResponse extends js.Object {
  /**
...
object Schema$ConversionsBatchUpdateResponse {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$ConversionsBatchUpdateResponse]
  }
}
