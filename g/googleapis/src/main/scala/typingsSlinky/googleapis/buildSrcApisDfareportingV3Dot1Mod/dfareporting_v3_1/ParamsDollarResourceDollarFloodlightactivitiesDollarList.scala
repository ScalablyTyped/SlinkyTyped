...
@js.native
trait ParamsDollarResourceDollarFloodlightactivitiesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarFloodlightactivitiesDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarFloodlightactivitiesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarFloodlightactivitiesDollarList]
  }
}
