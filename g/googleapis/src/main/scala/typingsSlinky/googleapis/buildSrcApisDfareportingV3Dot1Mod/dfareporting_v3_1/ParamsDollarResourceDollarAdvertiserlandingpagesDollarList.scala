...
@js.native
trait ParamsDollarResourceDollarAdvertiserlandingpagesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAdvertiserlandingpagesDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAdvertiserlandingpagesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAdvertiserlandingpagesDollarList]
  }
}
