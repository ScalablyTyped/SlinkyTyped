...
@js.native
trait ParamsDollarResourceDollarTargetingtemplatesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTargetingtemplatesDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTargetingtemplatesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTargetingtemplatesDollarList]
  }
}
