package typingsSlinky.googleapis.buildSrcApisTestingV1Mod.testing_v1
...
/**
  ...
  */
@js.native
trait Schema$AndroidInstrumentationTest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var testApk: js.UndefOr[Schema$FileReference] = js.native
  /**
...
object Schema$AndroidInstrumentationTest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$AndroidInstrumentationTest]
  }
}
