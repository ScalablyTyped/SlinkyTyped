...
/**
  ...
  */
@js.native
trait Schema$AutoUpgradeOptions extends js.Object {
  /**
...
object Schema$AutoUpgradeOptions {
  @scala.inline
  def apply(autoUpgradeStartTime: String = null, description: String = null): Schema$AutoUpgradeOptions = {
    ...
    __obj.asInstanceOf[Schema$AutoUpgradeOptions]
  }
}
