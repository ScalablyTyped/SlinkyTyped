...
/**
  ...
  */
@js.native
trait Schema$NodePool extends js.Object {
  /**
  ...
  /**
    ...
    */
  var config: js.UndefOr[Schema$NodeConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var maxPodsConstraint: js.UndefOr[Schema$MaxPodsConstraint] = js.native
  /**
...
object Schema$NodePool {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$NodePool]
  }
}
