...
@js.native
trait ParamsDollarResourceDollarProjectsDollarLocationsDollarClustersDollarSetlegacyabac extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$SetLegacyAbacRequest] = js.native
}
