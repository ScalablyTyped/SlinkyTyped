...
/**
  ...
  */
@js.native
trait Schema$MasterAuth extends js.Object {
  /**
  ...
  /**
    ...
    */
  var clientCertificateConfig: js.UndefOr[Schema$ClientCertificateConfig] = js.native
  /**
...
object Schema$MasterAuth {
  @scala.inline
  def apply(
    clientCertificate: String = null,
    clientCertificateConfig: Schema$ClientCertificateConfig = null,
    ...
    __obj.asInstanceOf[Schema$MasterAuth]
  }
}
