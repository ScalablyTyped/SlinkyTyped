...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2HotwordRule extends js.Object {
  /**
    * Regular expression pattern defining what qualifies as a hotword.
    */
  var hotwordRegex: js.UndefOr[Schema$GooglePrivacyDlpV2Regex] = js.native
  /**
    * Likelihood adjustment to apply to all matching findings.
    */
  var likelihoodAdjustment: js.UndefOr[Schema$GooglePrivacyDlpV2LikelihoodAdjustment] = js.native
  /**
    ...
    */
  var proximity: js.UndefOr[Schema$GooglePrivacyDlpV2Proximity] = js.native
}

object Schema$GooglePrivacyDlpV2HotwordRule {
  @scala.inline
  def apply(
    hotwordRegex: Schema$GooglePrivacyDlpV2Regex = null,
    likelihoodAdjustment: Schema$GooglePrivacyDlpV2LikelihoodAdjustment = null,
    proximity: Schema$GooglePrivacyDlpV2Proximity = null
  ): Schema$GooglePrivacyDlpV2HotwordRule = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2HotwordRule]
  }
}
