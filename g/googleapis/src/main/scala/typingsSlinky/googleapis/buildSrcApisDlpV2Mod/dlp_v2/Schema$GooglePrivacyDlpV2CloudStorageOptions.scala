...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2CloudStorageOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var fileSet: js.UndefOr[Schema$GooglePrivacyDlpV2FileSet] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2CloudStorageOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2CloudStorageOptions]
  }
}
