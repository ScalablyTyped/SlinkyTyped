...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2CryptoDeterministicConfig extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2CryptoDeterministicConfig {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2CryptoDeterministicConfig]
  }
}
