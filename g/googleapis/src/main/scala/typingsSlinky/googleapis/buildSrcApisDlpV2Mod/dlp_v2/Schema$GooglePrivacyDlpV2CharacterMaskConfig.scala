...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2CharacterMaskConfig extends js.Object {
  /**
    ...
    */
  var charactersToIgnore: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2CharsToIgnore]] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2CharacterMaskConfig {
  @scala.inline
  def apply(
    charactersToIgnore: js.Array[Schema$GooglePrivacyDlpV2CharsToIgnore] = null,
    maskingCharacter: String = null,
    numberToMask: Int | Double = null,
    reverseOrder: js.UndefOr[Boolean] = js.undefined
  ): Schema$GooglePrivacyDlpV2CharacterMaskConfig = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2CharacterMaskConfig]
  }
}
