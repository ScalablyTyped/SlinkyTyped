...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2InspectTemplate extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2InspectTemplate {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2InspectTemplate]
  }
}
