...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2AuxiliaryTable extends js.Object {
  /**
    * Quasi-identifier columns. [required]
    */
  var quasiIds: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2QuasiIdField]] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2AuxiliaryTable {
  @scala.inline
  def apply(
    quasiIds: js.Array[Schema$GooglePrivacyDlpV2QuasiIdField] = null,
    relativeFrequency: Schema$GooglePrivacyDlpV2FieldId = null,
    table: Schema$GooglePrivacyDlpV2BigQueryTable = null
  ): Schema$GooglePrivacyDlpV2AuxiliaryTable = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2AuxiliaryTable]
  }
}
