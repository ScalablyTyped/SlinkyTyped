...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2TimespanConfig extends js.Object {
  /**
  ...
  /**
    ...
    * empty or invalid.
    */
  var timestampField: js.UndefOr[Schema$GooglePrivacyDlpV2FieldId] = js.native
}

object Schema$GooglePrivacyDlpV2TimespanConfig {
  @scala.inline
  def apply(
    enableAutoPopulationOfTimespanConfig: js.UndefOr[Boolean] = js.undefined,
    endTime: String = null,
    startTime: String = null,
    timestampField: Schema$GooglePrivacyDlpV2FieldId = null
  ): Schema$GooglePrivacyDlpV2TimespanConfig = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2TimespanConfig]
  }
}
