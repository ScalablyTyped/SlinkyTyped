...
@js.native
trait Schema$GooglePrivacyDlpV2KAnonymityHistogramBucket extends js.Object {
  /**
  ...
  /**
    ...
    */
  var bucketValues: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2KAnonymityEquivalenceClass]] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2KAnonymityHistogramBucket {
  @scala.inline
  def apply(
    bucketSize: String = null,
    bucketValueCount: String = null,
    bucketValues: js.Array[Schema$GooglePrivacyDlpV2KAnonymityEquivalenceClass] = null,
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2KAnonymityHistogramBucket]
  }
}
