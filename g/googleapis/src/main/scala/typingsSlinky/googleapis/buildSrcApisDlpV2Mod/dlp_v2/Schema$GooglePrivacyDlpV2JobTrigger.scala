...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2JobTrigger extends js.Object {
  /**
  ...
  /**
    ...
    */
  var triggers: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2Trigger]] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2JobTrigger {
  @scala.inline
  def apply(
    ...
    name: String = null,
    status: String = null,
    triggers: js.Array[Schema$GooglePrivacyDlpV2Trigger] = null,
    updateTime: String = null
  ): Schema$GooglePrivacyDlpV2JobTrigger = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2JobTrigger]
  }
}
