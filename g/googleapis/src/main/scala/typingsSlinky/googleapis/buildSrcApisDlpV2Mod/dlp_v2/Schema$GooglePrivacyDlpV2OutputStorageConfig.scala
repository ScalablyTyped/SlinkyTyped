...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2OutputStorageConfig extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2OutputStorageConfig {
  @scala.inline
  def apply(outputSchema: String = null, table: Schema$GooglePrivacyDlpV2BigQueryTable = null): Schema$GooglePrivacyDlpV2OutputStorageConfig = {
    val __obj = js.Dynamic.literal()
    if (outputSchema != null) __obj.updateDynamic("outputSchema")(outputSchema.asInstanceOf[js.Any])
    if (table != null) __obj.updateDynamic("table")(table.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2OutputStorageConfig]
  }
}
