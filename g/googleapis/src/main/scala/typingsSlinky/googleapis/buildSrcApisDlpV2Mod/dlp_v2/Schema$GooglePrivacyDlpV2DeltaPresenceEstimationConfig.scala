...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2DeltaPresenceEstimationConfig extends js.Object {
  /**
    * Several auxiliary tables can be used in the analysis. Each custom_tag
    * used to tag a quasi-identifiers field must appear in exactly one field of
    * one auxiliary table.
    */
  var auxiliaryTables: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2StatisticalTable]] = js.native
  /**
    * Fields considered to be quasi-identifiers. No two fields can have the
    * same tag. [required]
    */
  var quasiIds: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2QuasiId]] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2DeltaPresenceEstimationConfig {
  @scala.inline
  def apply(
    auxiliaryTables: js.Array[Schema$GooglePrivacyDlpV2StatisticalTable] = null,
    quasiIds: js.Array[Schema$GooglePrivacyDlpV2QuasiId] = null,
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2DeltaPresenceEstimationConfig]
  }
}
