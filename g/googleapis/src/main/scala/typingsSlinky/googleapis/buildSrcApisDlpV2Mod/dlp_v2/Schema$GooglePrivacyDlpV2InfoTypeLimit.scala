...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2InfoTypeLimit extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2InfoTypeLimit {
  @scala.inline
  def apply(infoType: Schema$GooglePrivacyDlpV2InfoType = null, maxFindings: Int | Double = null): Schema$GooglePrivacyDlpV2InfoTypeLimit = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2InfoTypeLimit]
  }
}
