...
@js.native
trait Schema$GooglePrivacyDlpV2FindingLimits extends js.Object {
  /**
    * Configuration of findings limit given for specified infoTypes.
    */
  var maxFindingsPerInfoType: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2InfoTypeLimit]] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2FindingLimits {
  @scala.inline
  def apply(
    maxFindingsPerInfoType: js.Array[Schema$GooglePrivacyDlpV2InfoTypeLimit] = null,
    maxFindingsPerItem: Int | Double = null,
    maxFindingsPerRequest: Int | Double = null
  ): Schema$GooglePrivacyDlpV2FindingLimits = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2FindingLimits]
  }
}
