...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2QuasiId extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2QuasiId {
  @scala.inline
  def apply(
  ...
  ): Schema$GooglePrivacyDlpV2QuasiId = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2QuasiId]
  }
}
