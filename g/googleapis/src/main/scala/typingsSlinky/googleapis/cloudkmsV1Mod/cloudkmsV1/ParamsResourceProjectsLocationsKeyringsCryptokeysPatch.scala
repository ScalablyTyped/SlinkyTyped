...
object ParamsResourceProjectsLocationsKeyringsCryptokeysPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsKeyringsCryptokeysPatchOps[Self <: ParamsResourceProjectsLocationsKeyringsCryptokeysPatch] (val x: Self) extends AnyVal {
    @scala.inline
