...
object ParamsResourceProjectsLocationsKeyringsCryptokeysGetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsKeyringsCryptokeysGetiampolicyOps[Self <: ParamsResourceProjectsLocationsKeyringsCryptokeysGetiampolicy] (val x: Self) extends AnyVal {
