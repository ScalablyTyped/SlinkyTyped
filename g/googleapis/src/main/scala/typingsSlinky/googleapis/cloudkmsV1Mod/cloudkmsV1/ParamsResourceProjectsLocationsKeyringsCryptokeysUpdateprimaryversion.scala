...
object ParamsResourceProjectsLocationsKeyringsCryptokeysUpdateprimaryversion {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsKeyringsCryptokeysUpdateprimaryversionOps[Self <: ParamsResourceProjectsLocationsKeyringsCryptokeysUpdateprimaryversion] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateCryptoKeyPrimaryVersionRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
