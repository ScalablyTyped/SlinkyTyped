...
object ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsCreateOps[Self <: ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCryptoKeyVersion): Self = this.set("requestBody", value.asInstanceOf[js.Any])
