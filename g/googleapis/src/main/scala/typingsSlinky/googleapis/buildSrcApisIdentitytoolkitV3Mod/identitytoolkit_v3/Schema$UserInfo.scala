...
import typingsSlinky.googleapis.Anon_DisplayNameEmailFederatedId
...
trait Schema$UserInfo extends js.Object {
  ...
  /**
    * The IDP of the user.
    */
  var providerUserInfo: js.UndefOr[js.Array[Anon_DisplayNameEmailFederatedId]] = js.native
  /**
...
object Schema$UserInfo {
  ...
  def apply(
    ...
    providerUserInfo: js.Array[Anon_DisplayNameEmailFederatedId] = null,
