...
/**
  ...
  */
@js.native
trait Schema$CreateAuthUriResponse extends js.Object {
  /**
...
object Schema$CreateAuthUriResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$CreateAuthUriResponse]
  }
}
