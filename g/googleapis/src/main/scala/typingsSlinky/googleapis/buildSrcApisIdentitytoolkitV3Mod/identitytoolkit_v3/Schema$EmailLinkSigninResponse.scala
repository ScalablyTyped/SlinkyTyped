...
/**
  ...
  */
@js.native
trait Schema$EmailLinkSigninResponse extends js.Object {
  /**
    * The user&#39;s email.
    */
...
object Schema$EmailLinkSigninResponse {
  @scala.inline
  def apply(
    email: String = null,
  ...
  ): Schema$EmailLinkSigninResponse = {
    ...
    __obj.asInstanceOf[Schema$EmailLinkSigninResponse]
  }
}
