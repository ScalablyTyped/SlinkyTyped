...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyGetProjectConfigResponse extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartyGetProjectConfigResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyGetProjectConfigResponse]
  }
}
