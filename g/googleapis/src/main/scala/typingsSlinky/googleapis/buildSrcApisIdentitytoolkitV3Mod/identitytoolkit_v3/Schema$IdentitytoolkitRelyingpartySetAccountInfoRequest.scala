...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartySetAccountInfoRequest extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartySetAccountInfoRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$IdentitytoolkitRelyingpartySetAccountInfoRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartySetAccountInfoRequest]
  }
}
