...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyGetAccountInfoRequest extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartyGetAccountInfoRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$IdentitytoolkitRelyingpartyGetAccountInfoRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyGetAccountInfoRequest]
  }
}
