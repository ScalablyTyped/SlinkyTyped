...
/**
  ...
  */
@js.native
trait Schema$VerifyAssertionResponse extends js.Object {
  /**
    * The action code.
    */
...
object Schema$VerifyAssertionResponse {
  @scala.inline
  def apply(
    action: String = null,
  ...
  ): Schema$VerifyAssertionResponse = {
    ...
    __obj.asInstanceOf[Schema$VerifyAssertionResponse]
  }
}
