...
import typingsSlinky.googleapis.Anon_DisplayNameFederatedId
...
/**
  ...
  */
@js.native
trait Schema$SetAccountInfoResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var providerUserInfo: js.UndefOr[js.Array[Anon_DisplayNameFederatedId]] = js.native
  /**
...
object Schema$SetAccountInfoResponse {
  @scala.inline
  def apply(
    ...
    providerUserInfo: js.Array[Anon_DisplayNameFederatedId] = null,
    refreshToken: String = null
  ): Schema$SetAccountInfoResponse = {
    ...
    __obj.asInstanceOf[Schema$SetAccountInfoResponse]
  }
}
