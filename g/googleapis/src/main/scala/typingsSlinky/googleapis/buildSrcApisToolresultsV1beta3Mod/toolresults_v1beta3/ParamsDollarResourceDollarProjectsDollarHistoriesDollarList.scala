...
@js.native
trait ParamsDollarResourceDollarProjectsDollarHistoriesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarProjectsDollarHistoriesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarProjectsDollarHistoriesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarProjectsDollarHistoriesDollarList]
  }
}
