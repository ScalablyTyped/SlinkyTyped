...
/**
  ...
  */
@js.native
trait Schema$GraphicsStats extends js.Object {
  /**
    * Histogram of frame render times. There should be 154 buckets ranging from
    * [5ms, 6ms) to [4950ms, infinity)
    */
  var buckets: js.UndefOr[js.Array[Schema$GraphicsStatsBucket]] = js.native
  /**
...
object Schema$GraphicsStats {
  @scala.inline
  def apply(
    buckets: js.Array[Schema$GraphicsStatsBucket] = null,
    ...
    __obj.asInstanceOf[Schema$GraphicsStats]
  }
}
