...
object ParamsResourceBlobsBatchupdate {
  ...
  @scala.inline
  implicit class ParamsResourceBlobsBatchupdateOps[Self <: ParamsResourceBlobsBatchupdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBuildBazelRemoteExecutionV2BatchUpdateBlobsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
