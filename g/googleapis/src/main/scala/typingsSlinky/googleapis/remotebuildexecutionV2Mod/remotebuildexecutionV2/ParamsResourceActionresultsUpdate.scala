...
object ParamsResourceActionresultsUpdate {
  ...
  implicit class ParamsResourceActionresultsUpdateOps[Self <: ParamsResourceActionresultsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequestBody(value: SchemaBuildBazelRemoteExecutionV2ActionResult): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withResultsCachePolicyDotpriority(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resultsCachePolicy.priority")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutResultsCachePolicyDotpriority: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resultsCachePolicy.priority")(js.undefined)
        ret
    }
    @scala.inline
