...
object ParamsResourceOperationsWaitexecution {
  ...
  @scala.inline
  implicit class ParamsResourceOperationsWaitexecutionOps[Self <: ParamsResourceOperationsWaitexecution] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaBuildBazelRemoteExecutionV2WaitExecutionRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
