...
object ParamsResourceOperationsWaitexecution {
  ...
  @scala.inline
  def apply(): ParamsResourceOperationsWaitexecution = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOperationsWaitexecution]
  }
  
  @scala.inline
  implicit class ParamsResourceOperationsWaitexecutionMutableBuilder[Self <: ParamsResourceOperationsWaitexecution] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBuildBazelRemoteExecutionV2WaitExecutionRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
