...
object ParamsResourceActionsExecute {
  ...
  @scala.inline
  implicit class ParamsResourceActionsExecuteOps[Self <: ParamsResourceActionsExecute] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaBuildBazelRemoteExecutionV2ExecuteRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
