...
object ParamsResourceCompaniesList {
  ...
  def apply(
    ...
    fields: String = null,
    key: String = null,
    mustHaveOpenJobs: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(mustHaveOpenJobs)) __obj.updateDynamic("mustHaveOpenJobs")(mustHaveOpenJobs.get.asInstanceOf[js.Any])
