...
object ParamsResourceCompaniesPatch {
  ...
  implicit class ParamsResourceCompaniesPatchOps[Self <: ParamsResourceCompaniesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUpdateCompanyFields(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateCompanyFields")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutUpdateCompanyFields: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateCompanyFields")(js.undefined)
        ret
    }
  }
