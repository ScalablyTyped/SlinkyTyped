...
class Resource$Services protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def get(): GaxiosPromise[Schema$GoogleApiServiceusageV1Service] = js.native
  def get(callback: BodyResponseCallback[Schema$GoogleApiServiceusageV1Service]): Unit = js.native
  def get(params: ParamsDollarResourceDollarServicesDollarGet): GaxiosPromise[Schema$GoogleApiServiceusageV1Service] = js.native
  def get(
  ...
  def get(
    params: ParamsDollarResourceDollarServicesDollarGet,
    options: BodyResponseCallback[Schema$GoogleApiServiceusageV1Service],
    callback: BodyResponseCallback[Schema$GoogleApiServiceusageV1Service]
  ): Unit = js.native
  def get(params: ParamsDollarResourceDollarServicesDollarGet, options: MethodOptions): GaxiosPromise[Schema$GoogleApiServiceusageV1Service] = js.native
  def get(
    params: ParamsDollarResourceDollarServicesDollarGet,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleApiServiceusageV1Service]
