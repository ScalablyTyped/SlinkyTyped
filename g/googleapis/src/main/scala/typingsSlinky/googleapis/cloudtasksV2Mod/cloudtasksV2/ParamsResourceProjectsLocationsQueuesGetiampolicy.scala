...
object ParamsResourceProjectsLocationsQueuesGetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesGetiampolicyMutableBuilder[Self <: ParamsResourceProjectsLocationsQueuesGetiampolicy] (val x: Self) extends AnyVal {
