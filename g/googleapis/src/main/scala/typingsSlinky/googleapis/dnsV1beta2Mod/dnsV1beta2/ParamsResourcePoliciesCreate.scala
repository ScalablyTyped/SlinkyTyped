...
@js.native
trait ParamsResourcePoliciesCreate extends StandardParameters {
  /**
...
object ParamsResourcePoliciesCreate {
  @scala.inline
  def apply(): ParamsResourcePoliciesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePoliciesCreate]
  }
  @scala.inline
  implicit class ParamsResourcePoliciesCreateOps[Self <: ParamsResourcePoliciesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaPolicy): Self = {
        val ret = this.duplicate
