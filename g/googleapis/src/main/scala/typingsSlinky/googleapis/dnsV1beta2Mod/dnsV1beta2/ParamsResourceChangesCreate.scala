...
@js.native
trait ParamsResourceChangesCreate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaChange] = js.native
}
object ParamsResourceChangesCreate {
  
  @scala.inline
  def apply(): ParamsResourceChangesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceChangesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceChangesCreateMutableBuilder[Self <: ParamsResourceChangesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaChange): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
