...
object ParamsResourceChangesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceChangesCreateOps[Self <: ParamsResourceChangesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaChange): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
