...
/**
  ...
  */
@js.native
trait Schema$SslSettings extends js.Object {
  /**
...
object Schema$SslSettings {
  @scala.inline
  def apply(certificateId: String = null, isManagedCertificate: js.UndefOr[Boolean] = js.undefined): Schema$SslSettings = {
    ...
    __obj.asInstanceOf[Schema$SslSettings]
  }
}
