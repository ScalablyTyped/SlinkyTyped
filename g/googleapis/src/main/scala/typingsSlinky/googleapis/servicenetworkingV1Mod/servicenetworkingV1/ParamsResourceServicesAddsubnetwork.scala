...
object ParamsResourceServicesAddsubnetwork {
  ...
  @scala.inline
  implicit class ParamsResourceServicesAddsubnetworkOps[Self <: ParamsResourceServicesAddsubnetwork] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaAddSubnetworkRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
