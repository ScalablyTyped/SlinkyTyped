...
@js.native
trait ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachments extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaModifyAttachmentsRequest] = js.native
}
...
object ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachments {
  ...
  @scala.inline
  implicit class ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachmentsOps[Self <: ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachments] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaModifyAttachmentsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
