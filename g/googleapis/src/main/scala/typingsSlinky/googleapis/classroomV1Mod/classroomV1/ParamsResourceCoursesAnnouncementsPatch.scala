...
object ParamsResourceCoursesAnnouncementsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceCoursesAnnouncementsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCoursesAnnouncementsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceCoursesAnnouncementsPatchMutableBuilder[Self <: ParamsResourceCoursesAnnouncementsPatch] (val x: Self) extends AnyVal {
