...
@js.native
trait ParamsResourceCoursesAnnouncementsGet extends StandardParameters {
...
object ParamsResourceCoursesAnnouncementsGet {
  ...
  @scala.inline
  implicit class ParamsResourceCoursesAnnouncementsGetOps[Self <: ParamsResourceCoursesAnnouncementsGet] (val x: Self) extends AnyVal {
