...
@js.native
trait ParamsResourceCoursesStudentsGet extends StandardParameters {
...
object ParamsResourceCoursesStudentsGet {
  
  @scala.inline
  def apply(): ParamsResourceCoursesStudentsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCoursesStudentsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceCoursesStudentsGetMutableBuilder[Self <: ParamsResourceCoursesStudentsGet] (val x: Self) extends AnyVal {
