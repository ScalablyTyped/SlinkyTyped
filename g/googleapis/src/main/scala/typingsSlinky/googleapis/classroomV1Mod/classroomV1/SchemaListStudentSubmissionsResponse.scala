...
object SchemaListStudentSubmissionsResponse {
  ...
  implicit class SchemaListStudentSubmissionsResponseOps[Self <: SchemaListStudentSubmissionsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStudentSubmissionsVarargs(value: SchemaStudentSubmission*): Self = this.set("studentSubmissions", js.Array(value :_*))
    
    @scala.inline
    def setStudentSubmissions(value: js.Array[SchemaStudentSubmission]): Self = this.set("studentSubmissions", value.asInstanceOf[js.Any])
