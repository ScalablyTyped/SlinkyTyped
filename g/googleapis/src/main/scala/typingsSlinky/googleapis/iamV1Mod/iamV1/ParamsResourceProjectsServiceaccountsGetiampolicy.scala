...
@js.native
trait ParamsResourceProjectsServiceaccountsGetiampolicy extends StandardParameters {
  /**
...
object ParamsResourceProjectsServiceaccountsGetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsServiceaccountsGetiampolicyOps[Self <: ParamsResourceProjectsServiceaccountsGetiampolicy] (val x: Self) extends AnyVal {
    @scala.inline
