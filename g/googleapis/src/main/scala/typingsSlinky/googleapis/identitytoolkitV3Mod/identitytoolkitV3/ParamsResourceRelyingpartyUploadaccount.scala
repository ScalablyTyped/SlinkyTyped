...
object ParamsResourceRelyingpartyUploadaccount {
  ...
  @scala.inline
  implicit class ParamsResourceRelyingpartyUploadaccountOps[Self <: ParamsResourceRelyingpartyUploadaccount] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaIdentitytoolkitRelyingpartyUploadAccountRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
