...
object SchemaSignupNewUserResponse {
  ...
  @scala.inline
  def apply(): SchemaSignupNewUserResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSignupNewUserResponse]
  }
  
  @scala.inline
  implicit class SchemaSignupNewUserResponseMutableBuilder[Self <: SchemaSignupNewUserResponse] (val x: Self) extends AnyVal {
