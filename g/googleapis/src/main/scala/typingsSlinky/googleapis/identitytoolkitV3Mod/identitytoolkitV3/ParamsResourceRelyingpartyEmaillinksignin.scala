...
object ParamsResourceRelyingpartyEmaillinksignin {
  ...
  @scala.inline
  implicit class ParamsResourceRelyingpartyEmaillinksigninOps[Self <: ParamsResourceRelyingpartyEmaillinksignin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaIdentitytoolkitRelyingpartyEmailLinkSigninRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
