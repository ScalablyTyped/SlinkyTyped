...
@js.native
trait ParamsResourceRelyingpartyGetpublickeys extends StandardParameters {
  /**
...
object ParamsResourceRelyingpartyGetpublickeys {
  ...
  @scala.inline
  implicit class ParamsResourceRelyingpartyGetpublickeysOps[Self <: ParamsResourceRelyingpartyGetpublickeys] (val x: Self) extends AnyVal {
    @scala.inline
