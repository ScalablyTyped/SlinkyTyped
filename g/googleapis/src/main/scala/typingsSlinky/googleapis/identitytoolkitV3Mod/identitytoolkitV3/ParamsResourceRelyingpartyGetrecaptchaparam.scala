...
@js.native
trait ParamsResourceRelyingpartyGetrecaptchaparam extends StandardParameters {
  /**
...
object ParamsResourceRelyingpartyGetrecaptchaparam {
  ...
  @scala.inline
  implicit class ParamsResourceRelyingpartyGetrecaptchaparamOps[Self <: ParamsResourceRelyingpartyGetrecaptchaparam] (val x: Self) extends AnyVal {
    @scala.inline
