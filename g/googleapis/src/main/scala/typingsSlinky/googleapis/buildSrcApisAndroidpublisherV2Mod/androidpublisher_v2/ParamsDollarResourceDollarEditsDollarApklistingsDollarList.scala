...
@js.native
trait ParamsDollarResourceDollarEditsDollarApklistingsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarApklistingsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarApklistingsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarApklistingsDollarList]
  }
}
