...
@js.native
trait ParamsDollarResourceDollarEditsDollarImagesDollarDeleteall extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarImagesDollarDeleteall {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarImagesDollarDeleteall = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarImagesDollarDeleteall]
  }
}
