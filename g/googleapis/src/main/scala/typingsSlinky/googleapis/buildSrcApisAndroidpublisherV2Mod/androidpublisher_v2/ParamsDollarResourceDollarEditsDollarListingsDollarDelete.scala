...
@js.native
trait ParamsDollarResourceDollarEditsDollarListingsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarListingsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarListingsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarListingsDollarDelete]
  }
}
