...
@js.native
trait ParamsDollarResourceDollarEditsDollarApklistingsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarApklistingsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarApklistingsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarApklistingsDollarGet]
  }
}
