...
@js.native
trait ParamsDollarResourceDollarEditsDollarApklistingsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarApklistingsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarApklistingsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarApklistingsDollarUpdate]
  }
}
