...
@js.native
trait ParamsDollarResourceDollarInappproductsDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInappproductsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarInappproductsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInappproductsDollarInsert]
  }
}
