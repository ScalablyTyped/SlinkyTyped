package typingsSlinky.googleapis.buildSrcApisServicenetworkingV1Mod.servicenetworking_v1
...
class Resource$Services protected () extends js.Object {
  ...
  var connections: ResourceDollarServicesDollarConnections = js.native
  ...
  /**
    ...
    */
  def addSubnetwork(): GaxiosPromise[Schema$Operation] = js.native
  def addSubnetwork(callback: BodyResponseCallback[Schema$Operation]): Unit = js.native
  def addSubnetwork(params: ParamsDollarResourceDollarServicesDollarAddsubnetwork): GaxiosPromise[Schema$Operation] = js.native
  def addSubnetwork(
    params: ParamsDollarResourceDollarServicesDollarAddsubnetwork,
  ...
  def addSubnetwork(params: ParamsDollarResourceDollarServicesDollarAddsubnetwork, options: MethodOptions): GaxiosPromise[Schema$Operation] = js.native
  def addSubnetwork(
    params: ParamsDollarResourceDollarServicesDollarAddsubnetwork,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def searchRange(): GaxiosPromise[Schema$Operation] = js.native
  def searchRange(callback: BodyResponseCallback[Schema$Operation]): Unit = js.native
  def searchRange(params: ParamsDollarResourceDollarServicesDollarSearchrange): GaxiosPromise[Schema$Operation] = js.native
  def searchRange(
    params: ParamsDollarResourceDollarServicesDollarSearchrange,
    callback: BodyResponseCallback[Schema$Operation]
  ): Unit = js.native
  def searchRange(
    params: ParamsDollarResourceDollarServicesDollarSearchrange,
  ...
  def searchRange(params: ParamsDollarResourceDollarServicesDollarSearchrange, options: MethodOptions): GaxiosPromise[Schema$Operation] = js.native
  def searchRange(
    params: ParamsDollarResourceDollarServicesDollarSearchrange,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Operation]
