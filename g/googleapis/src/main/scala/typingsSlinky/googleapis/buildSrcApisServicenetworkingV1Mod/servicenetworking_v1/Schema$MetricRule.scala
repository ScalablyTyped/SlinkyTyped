...
/**
  ...
  */
@js.native
trait Schema$MetricRule extends js.Object {
  /**
...
object Schema$MetricRule {
  @scala.inline
  def apply(metricCosts: StringDictionary[String] = null, selector: String = null): Schema$MetricRule = {
    val __obj = js.Dynamic.literal()
    if (metricCosts != null) __obj.updateDynamic("metricCosts")(metricCosts.asInstanceOf[js.Any])
    if (selector != null) __obj.updateDynamic("selector")(selector.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$MetricRule]
  }
}
