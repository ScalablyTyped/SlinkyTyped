...
/**
  ...
  */
@js.native
trait Schema$HttpRule extends js.Object {
  /**
    * Additional HTTP bindings for the selector. Nested bindings must not
    * contain an `additional_bindings` field themselves (that is, the nesting
    * may only be one level deep).
    */
  var additionalBindings: js.UndefOr[js.Array[Schema$HttpRule]] = js.native
  /**
  ...
  /**
    ...
    */
  var custom: js.UndefOr[Schema$CustomHttpPattern] = js.native
  /**
...
object Schema$HttpRule {
  @scala.inline
  def apply(
    additionalBindings: js.Array[Schema$HttpRule] = null,
    body: String = null,
    custom: Schema$CustomHttpPattern = null,
    delete: String = null,
    get: String = null,
    patch: String = null,
    post: String = null,
    ...
    __obj.asInstanceOf[Schema$HttpRule]
  }
}
