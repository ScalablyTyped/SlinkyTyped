...
object kgsearchMod {
  ...
  object VERSIONS {
    ...
    @JSImport("googleapis/build/src/apis/kgsearch", "VERSIONS")
    @js.native
  ...
  object auth extends Shortcut {
    ...
    @JSImport("googleapis/build/src/apis/kgsearch", "auth")
    @js.native
    val ^ : AuthPlus = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/kgsearch", "auth.Compute")
    @js.native
    /**
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/kgsearch", "auth.JWT")
    @js.native
    class JWT protected ()
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/kgsearch", "auth.OAuth2")
    @js.native
    /**
