...
@js.native
trait ParamsResourceSearchanalyticsQuery extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaSearchAnalyticsQueryRequest] = js.native
...
object ParamsResourceSearchanalyticsQuery {
  ...
  @scala.inline
  implicit class ParamsResourceSearchanalyticsQueryOps[Self <: ParamsResourceSearchanalyticsQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSearchAnalyticsQueryRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
