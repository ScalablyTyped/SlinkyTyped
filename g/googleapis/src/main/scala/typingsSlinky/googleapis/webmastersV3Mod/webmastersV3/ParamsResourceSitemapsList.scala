...
@js.native
trait ParamsResourceSitemapsList extends StandardParameters {
  /**
...
object ParamsResourceSitemapsList {
  ...
  @scala.inline
  implicit class ParamsResourceSitemapsListOps[Self <: ParamsResourceSitemapsList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSitemapIndex(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sitemapIndex")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSitemapIndex: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sitemapIndex")(js.undefined)
        ret
    }
  }
