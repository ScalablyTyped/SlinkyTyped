...
@js.native
trait ParamsResourceSitemapsSubmit extends StandardParameters {
  /**
...
object ParamsResourceSitemapsSubmit {
  @scala.inline
  def apply(): ParamsResourceSitemapsSubmit = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitemapsSubmit]
  }
  @scala.inline
  implicit class ParamsResourceSitemapsSubmitOps[Self <: ParamsResourceSitemapsSubmit] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFeedpath(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("feedpath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFeedpath: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("feedpath")(js.undefined)
        ret
    }
    @scala.inline
