...
import typingsSlinky.googleapis.buildSrcApisAnalyticsV3Mod.analytics_v3.Schema$AccountRef
import typingsSlinky.googleapis.buildSrcApisAnalyticsV3Mod.analytics_v3.Schema$ProfileRef
import typingsSlinky.googleapis.buildSrcApisAnalyticsV3Mod.analytics_v3.Schema$WebPropertyRef
