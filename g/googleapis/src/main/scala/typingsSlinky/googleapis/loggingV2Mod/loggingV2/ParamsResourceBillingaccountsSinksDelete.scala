...
@js.native
trait ParamsResourceBillingaccountsSinksDelete extends StandardParameters {
...
object ParamsResourceBillingaccountsSinksDelete {
  ...
  @scala.inline
  implicit class ParamsResourceBillingaccountsSinksDeleteOps[Self <: ParamsResourceBillingaccountsSinksDelete] (val x: Self) extends AnyVal {
