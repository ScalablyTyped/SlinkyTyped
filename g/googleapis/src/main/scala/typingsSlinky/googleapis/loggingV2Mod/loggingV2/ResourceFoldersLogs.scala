...
@js.native
class ResourceFoldersLogs protected () extends StObject {
  ...
  def delete(
    params: ParamsResourceFoldersLogsDelete,
    options: BodyResponseCallback[SchemaEmpty],
    callback: BodyResponseCallback[SchemaEmpty]
  ): Unit = js.native
  def delete(params: ParamsResourceFoldersLogsDelete, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def delete(
    params: ParamsResourceFoldersLogsDelete,
  ...
  def list(
    params: ParamsResourceFoldersLogsList,
    options: BodyResponseCallback[SchemaListLogsResponse],
    callback: BodyResponseCallback[SchemaListLogsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceFoldersLogsList, options: MethodOptions): GaxiosPromise[SchemaListLogsResponse] = js.native
  def list(
    params: ParamsResourceFoldersLogsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListLogsResponse]
