...
@js.native
trait ParamsResourceOrganizationsExclusionsDelete extends StandardParameters {
  /**
...
object ParamsResourceOrganizationsExclusionsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsExclusionsDeleteOps[Self <: ParamsResourceOrganizationsExclusionsDelete] (val x: Self) extends AnyVal {
    @scala.inline
