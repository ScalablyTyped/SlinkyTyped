...
object ParamsResourceSinksUpdate {
  
  @scala.inline
  def apply(): ParamsResourceSinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSinksUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceSinksUpdateMutableBuilder[Self <: ParamsResourceSinksUpdate] (val x: Self) extends AnyVal {
