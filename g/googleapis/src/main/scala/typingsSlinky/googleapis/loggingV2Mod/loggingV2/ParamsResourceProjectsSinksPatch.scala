...
object ParamsResourceProjectsSinksPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsSinksPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSinksPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsSinksPatchMutableBuilder[Self <: ParamsResourceProjectsSinksPatch] (val x: Self) extends AnyVal {
