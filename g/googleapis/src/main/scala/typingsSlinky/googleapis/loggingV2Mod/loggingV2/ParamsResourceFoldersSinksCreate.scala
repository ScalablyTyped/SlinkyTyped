...
@js.native
trait ParamsResourceFoldersSinksCreate extends StandardParameters {
...
object ParamsResourceFoldersSinksCreate {
  
  @scala.inline
  def apply(): ParamsResourceFoldersSinksCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersSinksCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersSinksCreateMutableBuilder[Self <: ParamsResourceFoldersSinksCreate] (val x: Self) extends AnyVal {
