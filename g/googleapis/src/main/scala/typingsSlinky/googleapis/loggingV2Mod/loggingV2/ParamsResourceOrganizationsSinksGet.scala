...
@js.native
trait ParamsResourceOrganizationsSinksGet extends StandardParameters {
...
object ParamsResourceOrganizationsSinksGet {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsSinksGetOps[Self <: ParamsResourceOrganizationsSinksGet] (val x: Self) extends AnyVal {
