...
@js.native
trait ParamsResourceSinksCreate extends StandardParameters {
...
object ParamsResourceSinksCreate {
  
  @scala.inline
  def apply(): ParamsResourceSinksCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSinksCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceSinksCreateMutableBuilder[Self <: ParamsResourceSinksCreate] (val x: Self) extends AnyVal {
