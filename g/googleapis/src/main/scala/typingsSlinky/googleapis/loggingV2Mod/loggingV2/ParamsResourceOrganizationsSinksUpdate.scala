...
object ParamsResourceOrganizationsSinksUpdate {
  
  @scala.inline
  def apply(): ParamsResourceOrganizationsSinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSinksUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsSinksUpdateMutableBuilder[Self <: ParamsResourceOrganizationsSinksUpdate] (val x: Self) extends AnyVal {
