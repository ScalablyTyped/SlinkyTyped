...
@js.native
trait ParamsResourceBillingaccountsSinksUpdate extends StandardParameters {
...
object ParamsResourceBillingaccountsSinksUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceBillingaccountsSinksUpdateMutableBuilder[Self <: ParamsResourceBillingaccountsSinksUpdate] (val x: Self) extends AnyVal {
