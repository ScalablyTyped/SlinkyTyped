...
object ParamsResourceProjectsExclusionsCreate {
  
  @scala.inline
  def apply(): ParamsResourceProjectsExclusionsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsExclusionsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsExclusionsCreateMutableBuilder[Self <: ParamsResourceProjectsExclusionsCreate] (val x: Self) extends AnyVal {
