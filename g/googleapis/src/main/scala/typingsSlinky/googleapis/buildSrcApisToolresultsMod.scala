...
import typingsSlinky.googleapis.buildSrcApisToolresultsV1beta3Mod.toolresults_v1beta3.Options
import typingsSlinky.googleapis.buildSrcApisToolresultsV1beta3Mod.toolresults_v1beta3.Toolresults
