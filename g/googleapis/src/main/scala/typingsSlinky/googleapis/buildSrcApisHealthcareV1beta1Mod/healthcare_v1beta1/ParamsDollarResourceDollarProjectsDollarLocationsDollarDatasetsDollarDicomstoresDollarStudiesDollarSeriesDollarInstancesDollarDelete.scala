...
@js.native
trait ParamsDollarResourceDollarProjectsDollarLocationsDollarDatasetsDollarDicomstoresDollarStudiesDollarSeriesDollarInstancesDollarDelete extends StandardParameters {
  /**
