...
/**
  ...
  */
@js.native
trait Schema$ProgressCounter extends js.Object {
  /**
...
object Schema$ProgressCounter {
  @scala.inline
  def apply(failure: String = null, pending: String = null, success: String = null): Schema$ProgressCounter = {
    ...
    __obj.asInstanceOf[Schema$ProgressCounter]
  }
}
