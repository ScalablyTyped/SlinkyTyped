...
trait Schema$ExportDicomDataRequest extends js.Object {
  /**
    ...
    */
  var bigqueryDestination: js.UndefOr[Schema$GoogleCloudHealthcareV1beta1DicomBigQueryDestination] = js.native
  /**
    * The Cloud Storage output destination.  The Cloud Storage location
    * requires the `roles/storage.objectAdmin` Cloud IAM role.
    */
  var gcsDestination: js.UndefOr[Schema$GoogleCloudHealthcareV1beta1DicomGcsDestination] = js.native
}

object Schema$ExportDicomDataRequest {
  @scala.inline
  def apply(
    bigqueryDestination: Schema$GoogleCloudHealthcareV1beta1DicomBigQueryDestination = null,
    gcsDestination: Schema$GoogleCloudHealthcareV1beta1DicomGcsDestination = null
