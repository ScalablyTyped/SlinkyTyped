...
object ParamsResourceUsersUndelete {
  ...
  @scala.inline
  implicit class ParamsResourceUsersUndeleteMutableBuilder[Self <: ParamsResourceUsersUndelete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUserUndelete): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
