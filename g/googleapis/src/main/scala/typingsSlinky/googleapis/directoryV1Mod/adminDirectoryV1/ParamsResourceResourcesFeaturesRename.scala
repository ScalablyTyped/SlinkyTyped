...
object ParamsResourceResourcesFeaturesRename {
  ...
  @scala.inline
  implicit class ParamsResourceResourcesFeaturesRenameOps[Self <: ParamsResourceResourcesFeaturesRename] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaFeatureRename): Self = this.set("requestBody", value.asInstanceOf[js.Any])
