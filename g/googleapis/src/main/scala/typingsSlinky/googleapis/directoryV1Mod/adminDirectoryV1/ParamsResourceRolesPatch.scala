...
@js.native
trait ParamsResourceRolesPatch extends StandardParameters {
  /**
...
object ParamsResourceRolesPatch {
  @scala.inline
  def apply(): ParamsResourceRolesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRolesPatch]
  }
  @scala.inline
  implicit class ParamsResourceRolesPatchOps[Self <: ParamsResourceRolesPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaRole): Self = {
        val ret = this.duplicate
