...
object ParamsResourceMobiledevicesAction {
  ...
  @scala.inline
  implicit class ParamsResourceMobiledevicesActionMutableBuilder[Self <: ParamsResourceMobiledevicesAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaMobileDeviceAction): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
