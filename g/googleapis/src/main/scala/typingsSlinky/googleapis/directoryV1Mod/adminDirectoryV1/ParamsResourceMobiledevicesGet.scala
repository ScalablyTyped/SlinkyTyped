...
@js.native
trait ParamsResourceMobiledevicesGet extends StandardParameters {
...
object ParamsResourceMobiledevicesGet {
  ...
  @scala.inline
  implicit class ParamsResourceMobiledevicesGetOps[Self <: ParamsResourceMobiledevicesGet] (val x: Self) extends AnyVal {
