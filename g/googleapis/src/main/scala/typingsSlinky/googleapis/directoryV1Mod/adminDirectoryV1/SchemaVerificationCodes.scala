...
object SchemaVerificationCodes {
  ...
  implicit class SchemaVerificationCodesOps[Self <: SchemaVerificationCodes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaVerificationCode*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaVerificationCode]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
