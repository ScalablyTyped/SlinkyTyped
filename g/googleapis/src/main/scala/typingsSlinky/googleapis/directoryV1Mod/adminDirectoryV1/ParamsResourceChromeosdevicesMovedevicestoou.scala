...
object ParamsResourceChromeosdevicesMovedevicestoou {
  ...
  @scala.inline
  implicit class ParamsResourceChromeosdevicesMovedevicestoouOps[Self <: ParamsResourceChromeosdevicesMovedevicestoou] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaChromeOsMoveDevicesToOu): Self = this.set("requestBody", value.asInstanceOf[js.Any])
