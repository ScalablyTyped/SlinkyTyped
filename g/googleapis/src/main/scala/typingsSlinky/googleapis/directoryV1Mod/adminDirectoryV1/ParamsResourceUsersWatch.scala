...
@js.native
trait ParamsResourceUsersWatch extends StandardParameters {
...
object ParamsResourceUsersWatch {
  ...
  @scala.inline
  implicit class ParamsResourceUsersWatchOps[Self <: ParamsResourceUsersWatch] (val x: Self) extends AnyVal {
