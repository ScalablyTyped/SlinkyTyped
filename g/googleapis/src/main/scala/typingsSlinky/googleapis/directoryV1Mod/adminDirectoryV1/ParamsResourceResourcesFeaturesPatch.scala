...
object ParamsResourceResourcesFeaturesPatch {
  ...
  implicit class ParamsResourceResourcesFeaturesPatchOps[Self <: ParamsResourceResourcesFeaturesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFeatureKey(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("featureKey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFeatureKey: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("featureKey")(js.undefined)
        ret
    }
    @scala.inline
