...
@js.native
trait ParamsResourceVerificationcodesInvalidate extends StandardParameters {
  /**
...
object ParamsResourceVerificationcodesInvalidate {
  ...
  @scala.inline
  implicit class ParamsResourceVerificationcodesInvalidateOps[Self <: ParamsResourceVerificationcodesInvalidate] (val x: Self) extends AnyVal {
    @scala.inline
