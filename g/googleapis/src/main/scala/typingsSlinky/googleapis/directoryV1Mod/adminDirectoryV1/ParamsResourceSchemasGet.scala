...
object ParamsResourceSchemasGet {
  ...
  @scala.inline
  implicit class ParamsResourceSchemasGetOps[Self <: ParamsResourceSchemasGet] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSchemaKey(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("schemaKey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSchemaKey: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("schemaKey")(js.undefined)
        ret
    }
  }
