...
object ParamsResourceResourcesCalendarsInsert {
  @scala.inline
  def apply(): ParamsResourceResourcesCalendarsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcesCalendarsInsert]
  }
  @scala.inline
  implicit class ParamsResourceResourcesCalendarsInsertOps[Self <: ParamsResourceResourcesCalendarsInsert] (val x: Self) extends AnyVal {
    @scala.inline
