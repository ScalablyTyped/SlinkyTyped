...
object ParamsResourceUsersAliasesInsert {
  ...
  @scala.inline
  implicit class ParamsResourceUsersAliasesInsertOps[Self <: ParamsResourceUsersAliasesInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaAlias): Self = {
        val ret = this.duplicate
