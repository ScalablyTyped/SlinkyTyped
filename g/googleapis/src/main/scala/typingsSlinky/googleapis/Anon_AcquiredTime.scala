...
import typingsSlinky.googleapis.buildSrcApisBooksV1Mod.books_v1.Schema$ReadingPosition
import typingsSlinky.googleapis.buildSrcApisBooksV1Mod.books_v1.Schema$Review
