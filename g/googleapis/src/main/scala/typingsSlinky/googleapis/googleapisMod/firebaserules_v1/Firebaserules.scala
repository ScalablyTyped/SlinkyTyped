package typingsSlinky.googleapis.googleapisMod.firebaserules_v1
...
class Firebaserules protected ()
  extends typingsSlinky.googleapis.buildSrcApisFirebaserulesV1Mod.firebaserules_v1.Firebaserules {
