package typingsSlinky.googleapis.googleapisMod.servicenetworking_v1
...
class Servicenetworking protected ()
  extends typingsSlinky.googleapis.buildSrcApisServicenetworkingV1Mod.servicenetworking_v1.Servicenetworking {
