...
object factchecktools_v1alpha1 extends js.Object {
  ...
  class Factchecktools protected ()
    extends typingsSlinky.googleapis.buildSrcApisFactchecktoolsV1alpha1Mod.factchecktools_v1alpha1.Factchecktools {
  ...
  class Resource$Claims protected ()
    extends typingsSlinky.googleapis.buildSrcApisFactchecktoolsV1alpha1Mod.factchecktools_v1alpha1.Resource$Claims {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Pages protected ()
    extends typingsSlinky.googleapis.buildSrcApisFactchecktoolsV1alpha1Mod.factchecktools_v1alpha1.Resource$Pages {
    def this(context: APIRequestContext) = this()
  }
