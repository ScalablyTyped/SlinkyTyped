...
object indexing_v3 extends js.Object {
  ...
  class Indexing protected ()
    extends typingsSlinky.googleapis.buildSrcApisIndexingV3Mod.indexing_v3.Indexing {
  ...
  class Resource$Urlnotifications protected ()
    extends typingsSlinky.googleapis.buildSrcApisIndexingV3Mod.indexing_v3.Resource$Urlnotifications {
