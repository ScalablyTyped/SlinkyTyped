...
object remotebuildexecution_v2 extends js.Object {
  ...
  class Resource$Actionresults protected ()
    extends typingsSlinky.googleapis.buildSrcApisRemotebuildexecutionV2Mod.remotebuildexecution_v2.Resource$Actionresults {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Actions protected ()
    extends typingsSlinky.googleapis.buildSrcApisRemotebuildexecutionV2Mod.remotebuildexecution_v2.Resource$Actions {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Blobs protected ()
    extends typingsSlinky.googleapis.buildSrcApisRemotebuildexecutionV2Mod.remotebuildexecution_v2.Resource$Blobs {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisRemotebuildexecutionV2Mod.remotebuildexecution_v2.Resource$Operations {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$V2 protected ()
    extends typingsSlinky.googleapis.buildSrcApisRemotebuildexecutionV2Mod.remotebuildexecution_v2.Resource$V2 {
    def this(context: APIRequestContext) = this()
  }
