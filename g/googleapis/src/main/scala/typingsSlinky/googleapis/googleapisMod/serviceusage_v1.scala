...
object serviceusage_v1 extends js.Object {
  ...
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisServiceusageV1Mod.serviceusage_v1.Resource$Operations {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Services protected ()
    extends typingsSlinky.googleapis.buildSrcApisServiceusageV1Mod.serviceusage_v1.Resource$Services {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Serviceusage protected ()
    extends typingsSlinky.googleapis.buildSrcApisServiceusageV1Mod.serviceusage_v1.Serviceusage {
