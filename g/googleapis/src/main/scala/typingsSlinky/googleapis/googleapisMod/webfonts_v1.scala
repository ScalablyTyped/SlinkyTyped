...
object webfonts_v1 extends js.Object {
  ...
  class Resource$Webfonts protected ()
    extends typingsSlinky.googleapis.buildSrcApisWebfontsV1Mod.webfonts_v1.Resource$Webfonts {
  ...
  class Webfonts protected ()
    extends typingsSlinky.googleapis.buildSrcApisWebfontsV1Mod.webfonts_v1.Webfonts {
