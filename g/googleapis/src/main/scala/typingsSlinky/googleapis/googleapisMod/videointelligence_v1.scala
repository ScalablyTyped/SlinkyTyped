...
object videointelligence_v1 extends js.Object {
  ...
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisVideointelligenceV1Mod.videointelligence_v1.Resource$Operations {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Videos protected ()
    extends typingsSlinky.googleapis.buildSrcApisVideointelligenceV1Mod.videointelligence_v1.Resource$Videos {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Videointelligence protected ()
    extends typingsSlinky.googleapis.buildSrcApisVideointelligenceV1Mod.videointelligence_v1.Videointelligence {
