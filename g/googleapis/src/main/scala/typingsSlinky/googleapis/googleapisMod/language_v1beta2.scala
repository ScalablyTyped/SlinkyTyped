...
object language_v1beta2 extends js.Object {
  ...
  class Language protected ()
    extends typingsSlinky.googleapis.buildSrcApisLanguageV1beta2Mod.language_v1beta2.Language {
  ...
  class Resource$Documents protected ()
    extends typingsSlinky.googleapis.buildSrcApisLanguageV1beta2Mod.language_v1beta2.Resource$Documents {
