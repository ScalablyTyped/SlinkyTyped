...
object cloudresourcemanager_v2 extends js.Object {
  ...
  class Resource$Folders protected ()
    extends typingsSlinky.googleapis.buildSrcApisCloudresourcemanagerV2Mod.cloudresourcemanager_v2.Resource$Folders {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisCloudresourcemanagerV2Mod.cloudresourcemanager_v2.Resource$Operations {
    def this(context: APIRequestContext) = this()
  }
