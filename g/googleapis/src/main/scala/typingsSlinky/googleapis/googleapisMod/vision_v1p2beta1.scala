...
object vision_v1p2beta1 extends js.Object {
  ...
  class Resource$Files protected ()
    extends typingsSlinky.googleapis.buildSrcApisVisionV1p2beta1Mod.vision_v1p2beta1.Resource$Files {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Images protected ()
    extends typingsSlinky.googleapis.buildSrcApisVisionV1p2beta1Mod.vision_v1p2beta1.Resource$Images {
    def this(context: APIRequestContext) = this()
  }
