...
object cloudasset_v1 extends js.Object {
  ...
  class Cloudasset protected ()
    extends typingsSlinky.googleapis.buildSrcApisCloudassetV1Mod.cloudasset_v1.Cloudasset {
  ...
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisCloudassetV1Mod.cloudasset_v1.Resource$Operations {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$V1 protected ()
    extends typingsSlinky.googleapis.buildSrcApisCloudassetV1Mod.cloudasset_v1.Resource$V1 {
    def this(context: APIRequestContext) = this()
  }
