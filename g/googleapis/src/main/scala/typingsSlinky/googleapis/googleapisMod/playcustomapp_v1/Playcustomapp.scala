package typingsSlinky.googleapis.googleapisMod.playcustomapp_v1
...
class Playcustomapp protected ()
  extends typingsSlinky.googleapis.buildSrcApisPlaycustomappV1Mod.playcustomapp_v1.Playcustomapp {
