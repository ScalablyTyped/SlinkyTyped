...
object servicebroker_v1 extends js.Object {
  ...
  class Resource$V1 protected ()
    extends typingsSlinky.googleapis.buildSrcApisServicebrokerV1Mod.servicebroker_v1.Resource$V1 {
  ...
  class Servicebroker protected ()
    extends typingsSlinky.googleapis.buildSrcApisServicebrokerV1Mod.servicebroker_v1.Servicebroker {
