...
object groupssettings_v1 extends js.Object {
  ...
  class Groupssettings protected ()
    extends typingsSlinky.googleapis.buildSrcApisGroupssettingsV1Mod.groupssettings_v1.Groupssettings {
  ...
  class Resource$Groups protected ()
    extends typingsSlinky.googleapis.buildSrcApisGroupssettingsV1Mod.groupssettings_v1.Resource$Groups {
