...
object identitytoolkit_v3 extends js.Object {
  ...
  class Identitytoolkit protected ()
    extends typingsSlinky.googleapis.buildSrcApisIdentitytoolkitV3Mod.identitytoolkit_v3.Identitytoolkit {
  ...
  class Resource$Relyingparty protected ()
    extends typingsSlinky.googleapis.buildSrcApisIdentitytoolkitV3Mod.identitytoolkit_v3.Resource$Relyingparty {
