package typingsSlinky.googleapis.googleapisMod.bigtableadmin_v1
...
class Bigtableadmin protected ()
  extends typingsSlinky.googleapis.buildSrcApisBigtableadminV1Mod.bigtableadmin_v1.Bigtableadmin {
