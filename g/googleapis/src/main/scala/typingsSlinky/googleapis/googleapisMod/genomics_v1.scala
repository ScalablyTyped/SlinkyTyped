...
object genomics_v1 extends js.Object {
  ...
  class Genomics protected ()
    extends typingsSlinky.googleapis.buildSrcApisGenomicsV1Mod.genomics_v1.Genomics {
  ...
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisGenomicsV1Mod.genomics_v1.Resource$Operations {
