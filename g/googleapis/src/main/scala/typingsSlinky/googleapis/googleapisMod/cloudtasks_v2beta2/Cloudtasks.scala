package typingsSlinky.googleapis.googleapisMod.cloudtasks_v2beta2
...
class Cloudtasks protected ()
  extends typingsSlinky.googleapis.buildSrcApisCloudtasksV2beta2Mod.cloudtasks_v2beta2.Cloudtasks {
