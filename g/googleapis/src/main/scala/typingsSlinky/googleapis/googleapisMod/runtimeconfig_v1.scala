...
object runtimeconfig_v1 extends js.Object {
  ...
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisRuntimeconfigV1Mod.runtimeconfig_v1.Resource$Operations {
  ...
  class Runtimeconfig protected ()
    extends typingsSlinky.googleapis.buildSrcApisRuntimeconfigV1Mod.runtimeconfig_v1.Runtimeconfig {
