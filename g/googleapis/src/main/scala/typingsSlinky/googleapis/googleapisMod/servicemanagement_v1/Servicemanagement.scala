package typingsSlinky.googleapis.googleapisMod.servicemanagement_v1
...
class Servicemanagement protected ()
  extends typingsSlinky.googleapis.buildSrcApisServicemanagementV1Mod.servicemanagement_v1.Servicemanagement {
