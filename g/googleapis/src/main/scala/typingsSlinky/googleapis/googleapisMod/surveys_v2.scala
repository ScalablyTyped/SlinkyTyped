...
object surveys_v2 extends js.Object {
  ...
  class Resource$Results protected ()
    extends typingsSlinky.googleapis.buildSrcApisSurveysV2Mod.surveys_v2.Resource$Results {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Surveys protected ()
    extends typingsSlinky.googleapis.buildSrcApisSurveysV2Mod.surveys_v2.Resource$Surveys {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Surveys protected ()
    extends typingsSlinky.googleapis.buildSrcApisSurveysV2Mod.surveys_v2.Surveys {
