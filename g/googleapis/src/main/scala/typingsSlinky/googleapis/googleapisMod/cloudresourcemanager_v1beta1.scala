...
object cloudresourcemanager_v1beta1 extends js.Object {
  ...
  class Resource$Organizations protected ()
    extends typingsSlinky.googleapis.buildSrcApisCloudresourcemanagerV1beta1Mod.cloudresourcemanager_v1beta1.Resource$Organizations {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Projects protected ()
    extends typingsSlinky.googleapis.buildSrcApisCloudresourcemanagerV1beta1Mod.cloudresourcemanager_v1beta1.Resource$Projects {
    def this(context: APIRequestContext) = this()
  }
