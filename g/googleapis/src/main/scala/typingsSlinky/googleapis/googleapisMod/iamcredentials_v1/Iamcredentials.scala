package typingsSlinky.googleapis.googleapisMod.iamcredentials_v1
...
class Iamcredentials protected ()
  extends typingsSlinky.googleapis.buildSrcApisIamcredentialsV1Mod.iamcredentials_v1.Iamcredentials {
