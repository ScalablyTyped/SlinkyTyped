...
object youtubeAnalytics_v1beta1 extends js.Object {
  ...
  class Resource$Groupitems protected ()
    extends typingsSlinky.googleapis.buildSrcApisYoutubeAnalyticsV1beta1Mod.youtubeAnalytics_v1beta1.Resource$Groupitems {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Groups protected ()
    extends typingsSlinky.googleapis.buildSrcApisYoutubeAnalyticsV1beta1Mod.youtubeAnalytics_v1beta1.Resource$Groups {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Reports protected ()
    extends typingsSlinky.googleapis.buildSrcApisYoutubeAnalyticsV1beta1Mod.youtubeAnalytics_v1beta1.Resource$Reports {
    def this(context: APIRequestContext) = this()
  }
