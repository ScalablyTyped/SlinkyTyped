...
object discovery_v1 extends js.Object {
  ...
  class Discovery protected ()
    extends typingsSlinky.googleapis.buildSrcApisDiscoveryV1Mod.discovery_v1.Discovery {
  ...
  class Resource$Apis protected ()
    extends typingsSlinky.googleapis.buildSrcApisDiscoveryV1Mod.discovery_v1.Resource$Apis {
