...
object servicecontrol_v1 extends js.Object {
  ...
  class Resource$Services protected ()
    extends typingsSlinky.googleapis.buildSrcApisServicecontrolV1Mod.servicecontrol_v1.Resource$Services {
  ...
  class Servicecontrol protected ()
    extends typingsSlinky.googleapis.buildSrcApisServicecontrolV1Mod.servicecontrol_v1.Servicecontrol {
