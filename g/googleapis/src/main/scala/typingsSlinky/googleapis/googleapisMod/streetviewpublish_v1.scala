...
object streetviewpublish_v1 extends js.Object {
  ...
  class Resource$Photo protected ()
    extends typingsSlinky.googleapis.buildSrcApisStreetviewpublishV1Mod.streetviewpublish_v1.Resource$Photo {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Photos protected ()
    extends typingsSlinky.googleapis.buildSrcApisStreetviewpublishV1Mod.streetviewpublish_v1.Resource$Photos {
    def this(context: APIRequestContext) = this()
  }
  ...
  class Streetviewpublish protected ()
    extends typingsSlinky.googleapis.buildSrcApisStreetviewpublishV1Mod.streetviewpublish_v1.Streetviewpublish {
