...
object licensing_v1 extends js.Object {
  ...
  class Licensing protected ()
    extends typingsSlinky.googleapis.buildSrcApisLicensingV1Mod.licensing_v1.Licensing {
  ...
  class Resource$Licenseassignments protected ()
    extends typingsSlinky.googleapis.buildSrcApisLicensingV1Mod.licensing_v1.Resource$Licenseassignments {
