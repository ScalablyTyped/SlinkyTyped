package typingsSlinky.googleapis.googleapisMod.youtubereporting_v1
...
class Youtubereporting protected ()
  extends typingsSlinky.googleapis.buildSrcApisYoutubereportingV1Mod.youtubereporting_v1.Youtubereporting {
