...
object deploymentmanager_v2 extends js.Object {
  ...
  class Resource$Deployments protected ()
    extends typingsSlinky.googleapis.buildSrcApisDeploymentmanagerV2Mod.deploymentmanager_v2.Resource$Deployments {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Manifests protected ()
    extends typingsSlinky.googleapis.buildSrcApisDeploymentmanagerV2Mod.deploymentmanager_v2.Resource$Manifests {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Operations protected ()
    extends typingsSlinky.googleapis.buildSrcApisDeploymentmanagerV2Mod.deploymentmanager_v2.Resource$Operations {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Resources protected ()
    extends typingsSlinky.googleapis.buildSrcApisDeploymentmanagerV2Mod.deploymentmanager_v2.Resource$Resources {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Types protected ()
    extends typingsSlinky.googleapis.buildSrcApisDeploymentmanagerV2Mod.deploymentmanager_v2.Resource$Types {
    def this(context: APIRequestContext) = this()
  }
