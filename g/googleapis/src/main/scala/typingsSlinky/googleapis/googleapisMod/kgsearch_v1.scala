...
object kgsearch_v1 extends js.Object {
  ...
  class Kgsearch protected ()
    extends typingsSlinky.googleapis.buildSrcApisKgsearchV1Mod.kgsearch_v1.Kgsearch {
  ...
  class Resource$Entities protected ()
    extends typingsSlinky.googleapis.buildSrcApisKgsearchV1Mod.kgsearch_v1.Resource$Entities {
