package typingsSlinky.googleapis.googleapisMod.cloudidentity_v1
...
class Cloudidentity protected ()
  extends typingsSlinky.googleapis.buildSrcApisCloudidentityV1Mod.cloudidentity_v1.Cloudidentity {
