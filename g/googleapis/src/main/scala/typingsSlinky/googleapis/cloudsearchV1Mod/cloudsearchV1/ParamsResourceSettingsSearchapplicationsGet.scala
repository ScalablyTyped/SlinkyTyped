...
@js.native
trait ParamsResourceSettingsSearchapplicationsGet extends StandardParameters {
...
object ParamsResourceSettingsSearchapplicationsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceSettingsSearchapplicationsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSettingsSearchapplicationsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceSettingsSearchapplicationsGetMutableBuilder[Self <: ParamsResourceSettingsSearchapplicationsGet] (val x: Self) extends AnyVal {
