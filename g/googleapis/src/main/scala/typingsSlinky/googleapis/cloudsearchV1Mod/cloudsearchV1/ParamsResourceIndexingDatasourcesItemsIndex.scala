...
object ParamsResourceIndexingDatasourcesItemsIndex {
  ...
  @scala.inline
  implicit class ParamsResourceIndexingDatasourcesItemsIndexOps[Self <: ParamsResourceIndexingDatasourcesItemsIndex] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaIndexItemRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
