...
object ParamsResourceIndexingDatasourcesItemsIndex {
  ...
  @scala.inline
  def apply(): ParamsResourceIndexingDatasourcesItemsIndex = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceIndexingDatasourcesItemsIndex]
  }
  
  @scala.inline
  implicit class ParamsResourceIndexingDatasourcesItemsIndexMutableBuilder[Self <: ParamsResourceIndexingDatasourcesItemsIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaIndexItemRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
