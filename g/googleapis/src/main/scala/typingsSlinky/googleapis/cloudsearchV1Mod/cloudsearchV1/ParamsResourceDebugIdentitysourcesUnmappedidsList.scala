...
object ParamsResourceDebugIdentitysourcesUnmappedidsList {
  ...
  @scala.inline
  implicit class ParamsResourceDebugIdentitysourcesUnmappedidsListMutableBuilder[Self <: ParamsResourceDebugIdentitysourcesUnmappedidsList] (val x: Self) extends AnyVal {
