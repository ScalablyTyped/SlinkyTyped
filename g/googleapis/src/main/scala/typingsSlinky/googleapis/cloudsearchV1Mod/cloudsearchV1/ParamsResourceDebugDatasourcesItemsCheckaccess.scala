...
object ParamsResourceDebugDatasourcesItemsCheckaccess {
  ...
  @scala.inline
  implicit class ParamsResourceDebugDatasourcesItemsCheckaccessMutableBuilder[Self <: ParamsResourceDebugDatasourcesItemsCheckaccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPrincipal): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
