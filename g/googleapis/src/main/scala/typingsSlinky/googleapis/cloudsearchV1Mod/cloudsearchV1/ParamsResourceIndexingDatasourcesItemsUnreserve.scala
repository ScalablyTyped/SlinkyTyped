...
object ParamsResourceIndexingDatasourcesItemsUnreserve {
  ...
  @scala.inline
  implicit class ParamsResourceIndexingDatasourcesItemsUnreserveOps[Self <: ParamsResourceIndexingDatasourcesItemsUnreserve] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUnreserveItemsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
