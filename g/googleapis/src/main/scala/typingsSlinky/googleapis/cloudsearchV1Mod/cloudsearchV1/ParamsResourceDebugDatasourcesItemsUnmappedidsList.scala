...
object ParamsResourceDebugDatasourcesItemsUnmappedidsList {
  ...
  @scala.inline
  implicit class ParamsResourceDebugDatasourcesItemsUnmappedidsListOps[Self <: ParamsResourceDebugDatasourcesItemsUnmappedidsList] (val x: Self) extends AnyVal {
