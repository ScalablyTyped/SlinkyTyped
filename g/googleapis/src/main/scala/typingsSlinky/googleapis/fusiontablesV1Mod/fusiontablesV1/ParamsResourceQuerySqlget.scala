...
object ParamsResourceQuerySqlget {
  ...
  implicit class ParamsResourceQuerySqlgetOps[Self <: ParamsResourceQuerySqlget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHdrs(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hdrs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHdrs: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hdrs")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTyped(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("typed")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTyped: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("typed")(js.undefined)
        ret
    }
  }
