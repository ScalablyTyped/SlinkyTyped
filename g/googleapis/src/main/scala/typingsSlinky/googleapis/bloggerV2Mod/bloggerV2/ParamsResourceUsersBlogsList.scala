...
@js.native
trait ParamsResourceUsersBlogsList extends StandardParameters {
...
object ParamsResourceUsersBlogsList {
  ...
  @scala.inline
  implicit class ParamsResourceUsersBlogsListOps[Self <: ParamsResourceUsersBlogsList] (val x: Self) extends AnyVal {
