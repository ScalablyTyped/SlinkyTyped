...
object SchemaGoogleDatastoreAdminV1beta1ExportEntitiesRequest {
  ...
  @scala.inline
  implicit class SchemaGoogleDatastoreAdminV1beta1ExportEntitiesRequestMutableBuilder[Self <: SchemaGoogleDatastoreAdminV1beta1ExportEntitiesRequest] (val x: Self) extends AnyVal {
