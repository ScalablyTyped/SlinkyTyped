...
/**
  ...
  */
@js.native
trait Schema$BindingDelta extends js.Object {
  /**
...
object Schema$BindingDelta {
  @scala.inline
  def apply(action: String = null, condition: Schema$Expr = null, member: String = null, role: String = null): Schema$BindingDelta = {
    val __obj = js.Dynamic.literal()
    if (action != null) __obj.updateDynamic("action")(action.asInstanceOf[js.Any])
    if (condition != null) __obj.updateDynamic("condition")(condition.asInstanceOf[js.Any])
    if (member != null) __obj.updateDynamic("member")(member.asInstanceOf[js.Any])
    if (role != null) __obj.updateDynamic("role")(role.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BindingDelta]
  }
}
