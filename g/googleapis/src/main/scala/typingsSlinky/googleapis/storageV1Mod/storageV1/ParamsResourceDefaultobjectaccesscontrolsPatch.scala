...
object ParamsResourceDefaultobjectaccesscontrolsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceDefaultobjectaccesscontrolsPatchOps[Self <: ParamsResourceDefaultobjectaccesscontrolsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaObjectAccessControl): Self = {
        val ret = this.duplicate
