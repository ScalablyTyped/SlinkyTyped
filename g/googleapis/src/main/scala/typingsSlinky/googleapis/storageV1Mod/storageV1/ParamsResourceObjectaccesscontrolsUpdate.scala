...
object ParamsResourceObjectaccesscontrolsUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceObjectaccesscontrolsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceObjectaccesscontrolsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceObjectaccesscontrolsUpdateMutableBuilder[Self <: ParamsResourceObjectaccesscontrolsUpdate] (val x: Self) extends AnyVal {
