...
@js.native
trait ParamsResourceConversionUpdate extends StandardParameters {
...
object ParamsResourceConversionUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceConversionUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceConversionUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceConversionUpdateMutableBuilder[Self <: ParamsResourceConversionUpdate] (val x: Self) extends AnyVal {
