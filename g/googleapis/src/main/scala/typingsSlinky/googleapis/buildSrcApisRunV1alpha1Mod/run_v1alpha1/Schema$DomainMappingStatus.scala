...
/**
  ...
  */
@js.native
trait Schema$DomainMappingStatus extends js.Object {
  /**
    * Array of observed DomainMappingConditions, indicating the current state
    * of the DomainMapping.
    */
  var conditions: js.UndefOr[js.Array[Schema$DomainMappingCondition]] = js.native
  /**
...
object Schema$DomainMappingStatus {
  @scala.inline
  def apply(
    conditions: js.Array[Schema$DomainMappingCondition] = null,
    mappedRouteName: String = null,
    observedGeneration: Int | Double = null,
    resourceRecords: js.Array[Schema$ResourceRecord] = null
  ): Schema$DomainMappingStatus = {
    ...
    __obj.asInstanceOf[Schema$DomainMappingStatus]
  }
}
