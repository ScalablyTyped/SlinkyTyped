...
/**
  ...
  */
@js.native
trait Schema$ConfigurationCondition extends js.Object {
  /**
...
object Schema$ConfigurationCondition {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ConfigurationCondition]
  }
}
