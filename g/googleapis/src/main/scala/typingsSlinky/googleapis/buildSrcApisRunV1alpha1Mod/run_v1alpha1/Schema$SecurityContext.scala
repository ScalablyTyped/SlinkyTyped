...
trait Schema$SecurityContext extends js.Object {
  ...
  /**
    ...
    */
  var capabilities: js.UndefOr[Schema$Capabilities] = js.native
  /**
  ...
  /**
    ...
    * SecurityContext takes precedence. +optional
    */
  var seLinuxOptions: js.UndefOr[Schema$SELinuxOptions] = js.native
}
...
object Schema$SecurityContext {
  ...
  def apply(
    ...
    seLinuxOptions: Schema$SELinuxOptions = null
