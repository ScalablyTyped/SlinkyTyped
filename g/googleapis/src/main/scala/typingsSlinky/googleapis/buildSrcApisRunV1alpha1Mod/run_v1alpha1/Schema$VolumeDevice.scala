...
/**
  ...
  */
@js.native
trait Schema$VolumeDevice extends js.Object {
  /**
...
object Schema$VolumeDevice {
  @scala.inline
  def apply(devicePath: String = null, name: String = null): Schema$VolumeDevice = {
    val __obj = js.Dynamic.literal()
    if (devicePath != null) __obj.updateDynamic("devicePath")(devicePath.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$VolumeDevice]
  }
}
