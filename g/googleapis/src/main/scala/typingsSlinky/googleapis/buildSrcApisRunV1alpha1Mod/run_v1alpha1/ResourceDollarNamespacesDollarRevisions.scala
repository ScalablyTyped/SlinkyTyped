...
@js.native
class ResourceDollarNamespacesDollarRevisions protected () extends js.Object {
  ...
  def delete(params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarDelete): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarDelete,
  ...
  def delete(params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarDelete, options: MethodOptions): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarDelete,
  ...
  def get(params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarGet): GaxiosPromise[Schema$Revision] = js.native
  def get(
    params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarGet,
  ...
  def get(params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarGet, options: MethodOptions): GaxiosPromise[Schema$Revision] = js.native
  def get(
    params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarGet,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Revision]
  ...
  def list(params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarList): GaxiosPromise[Schema$ListRevisionsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarList,
  ...
  def list(params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListRevisionsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarNamespacesDollarRevisionsDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListRevisionsResponse]
