...
/**
  ...
  */
@js.native
trait Schema$Lifecycle extends js.Object {
  /**
    ...
    * +optional
    */
  var postStart: js.UndefOr[Schema$Handler] = js.native
  /**
    ...
    * +optional
    */
  var preStop: js.UndefOr[Schema$Handler] = js.native
}

object Schema$Lifecycle {
  @scala.inline
  def apply(postStart: Schema$Handler = null, preStop: Schema$Handler = null): Schema$Lifecycle = {
    ...
    __obj.asInstanceOf[Schema$Lifecycle]
  }
}
