...
@js.native
class ResourceDollarProjectsDollarLocationsDollarConfigurations protected () extends js.Object {
  ...
  def get(params: ParamsDollarResourceDollarProjectsDollarLocationsDollarConfigurationsDollarGet): GaxiosPromise[Schema$Configuration] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarConfigurationsDollarGet,
  ...
  def list(params: ParamsDollarResourceDollarProjectsDollarLocationsDollarConfigurationsDollarList): GaxiosPromise[Schema$ListConfigurationsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarConfigurationsDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarConfigurationsDollarList,
    options: MethodOptions
  ): GaxiosPromise[Schema$ListConfigurationsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarConfigurationsDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListConfigurationsResponse]
