...
@js.native
trait ParamsDollarResourceDollarQueryDollarSql extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarQueryDollarSql {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarQueryDollarSql = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarQueryDollarSql]
  }
}
