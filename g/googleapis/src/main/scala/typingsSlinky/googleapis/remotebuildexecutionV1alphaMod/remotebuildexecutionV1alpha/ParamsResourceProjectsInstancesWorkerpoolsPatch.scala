...
object ParamsResourceProjectsInstancesWorkerpoolsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesWorkerpoolsPatchOps[Self <: ParamsResourceProjectsInstancesWorkerpoolsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
