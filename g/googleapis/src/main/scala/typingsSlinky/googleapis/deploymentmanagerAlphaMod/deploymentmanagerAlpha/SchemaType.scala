...
object SchemaType {
  ...
  implicit class SchemaTypeOps[Self <: SchemaType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfigurableService(value: SchemaConfigurableService): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configurableService")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutConfigurableService: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configurableService")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLabels(value: js.Array[SchemaTypeLabelEntry]): Self = {
        val ret = this.duplicate
