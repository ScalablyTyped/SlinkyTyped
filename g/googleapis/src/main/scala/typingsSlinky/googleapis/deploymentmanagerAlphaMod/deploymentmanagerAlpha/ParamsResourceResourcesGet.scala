...
@js.native
trait ParamsResourceResourcesGet extends StandardParameters {
  /**
...
object ParamsResourceResourcesGet {
  ...
  @scala.inline
  implicit class ParamsResourceResourcesGetOps[Self <: ParamsResourceResourcesGet] (val x: Self) extends AnyVal {
    @scala.inline
