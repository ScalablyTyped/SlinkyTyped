...
@js.native
trait ParamsResourcePagesDelete extends StandardParameters {
  /**
...
object ParamsResourcePagesDelete {
  ...
  @scala.inline
  implicit class ParamsResourcePagesDeleteOps[Self <: ParamsResourcePagesDelete] (val x: Self) extends AnyVal {
    @scala.inline
