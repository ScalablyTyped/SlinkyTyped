...
@js.native
trait ParamsResourceDetectionsList extends StandardParameters {
...
object ParamsResourceDetectionsList {
  ...
  @scala.inline
  implicit class ParamsResourceDetectionsListOps[Self <: ParamsResourceDetectionsList] (val x: Self) extends AnyVal {
