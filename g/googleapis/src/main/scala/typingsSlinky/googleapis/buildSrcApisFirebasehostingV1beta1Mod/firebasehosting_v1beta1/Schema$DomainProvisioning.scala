...
/**
  ...
  */
@js.native
trait Schema$DomainProvisioning extends js.Object {
  /**
  ...
  /**
    ...
    */
  var certChallengeDns: js.UndefOr[Schema$CertDnsChallenge] = js.native
  /**
    * The HTTP challenge for generating a certificate.
    */
  var certChallengeHttp: js.UndefOr[Schema$CertHttpChallenge] = js.native
  /**
...
object Schema$DomainProvisioning {
  @scala.inline
  def apply(
    certChallengeDiscoveredTxt: js.Array[String] = null,
    certChallengeDns: Schema$CertDnsChallenge = null,
    certChallengeHttp: Schema$CertHttpChallenge = null,
    ...
    __obj.asInstanceOf[Schema$DomainProvisioning]
  }
}
