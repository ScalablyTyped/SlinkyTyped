...
/**
  ...
  */
@js.native
trait Schema$Rewrite extends js.Object {
  /**
  ...
  /**
    ...
    */
  var run: js.UndefOr[Schema$CloudRunRewrite] = js.native
}

object Schema$Rewrite {
  @scala.inline
  def apply(
    ...
    glob: String = null,
    path: String = null,
    run: Schema$CloudRunRewrite = null
  ): Schema$Rewrite = {
    ...
    __obj.asInstanceOf[Schema$Rewrite]
  }
}
