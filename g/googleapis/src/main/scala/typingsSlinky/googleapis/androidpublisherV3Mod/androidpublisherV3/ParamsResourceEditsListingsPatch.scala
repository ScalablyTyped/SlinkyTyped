...
@js.native
trait ParamsResourceEditsListingsPatch extends StandardParameters {
  /**
...
object ParamsResourceEditsListingsPatch {
  @scala.inline
  def apply(): ParamsResourceEditsListingsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsListingsPatch]
  }
  @scala.inline
  implicit class ParamsResourceEditsListingsPatchOps[Self <: ParamsResourceEditsListingsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaListing): Self = {
        val ret = this.duplicate
