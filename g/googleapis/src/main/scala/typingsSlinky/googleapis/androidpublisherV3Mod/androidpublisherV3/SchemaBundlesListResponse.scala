...
object SchemaBundlesListResponse {
  ...
  implicit class SchemaBundlesListResponseOps[Self <: SchemaBundlesListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBundlesVarargs(value: SchemaBundle*): Self = this.set("bundles", js.Array(value :_*))
    @scala.inline
    def setBundles(value: js.Array[SchemaBundle]): Self = this.set("bundles", value.asInstanceOf[js.Any])
    @scala.inline
