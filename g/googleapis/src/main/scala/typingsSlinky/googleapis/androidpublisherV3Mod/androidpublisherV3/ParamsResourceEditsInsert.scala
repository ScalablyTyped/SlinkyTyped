...
object ParamsResourceEditsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceEditsInsertOps[Self <: ParamsResourceEditsInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAppEdit): Self = this.set("requestBody", value.asInstanceOf[js.Any])
