...
object SchemaListingsListResponse {
  ...
  implicit class SchemaListingsListResponseOps[Self <: SchemaListingsListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setListingsVarargs(value: SchemaListing*): Self = this.set("listings", js.Array(value :_*))
    
    @scala.inline
    def setListings(value: js.Array[SchemaListing]): Self = this.set("listings", value.asInstanceOf[js.Any])
