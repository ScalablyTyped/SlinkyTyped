...
object ParamsResourceEditsTestersUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceEditsTestersUpdateOps[Self <: ParamsResourceEditsTestersUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTesters): Self = this.set("requestBody", value.asInstanceOf[js.Any])
