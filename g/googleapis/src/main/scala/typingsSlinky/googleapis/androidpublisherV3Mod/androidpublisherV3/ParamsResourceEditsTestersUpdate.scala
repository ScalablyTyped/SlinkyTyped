...
@js.native
trait ParamsResourceEditsTestersUpdate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaTesters] = js.native
...
object ParamsResourceEditsTestersUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceEditsTestersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsTestersUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsTestersUpdateMutableBuilder[Self <: ParamsResourceEditsTestersUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTesters): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
