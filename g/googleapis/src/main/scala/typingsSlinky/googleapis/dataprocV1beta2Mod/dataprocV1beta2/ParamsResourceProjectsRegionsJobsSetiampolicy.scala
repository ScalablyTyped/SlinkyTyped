...
object ParamsResourceProjectsRegionsJobsSetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsJobsSetiampolicyMutableBuilder[Self <: ParamsResourceProjectsRegionsJobsSetiampolicy] (val x: Self) extends AnyVal {
