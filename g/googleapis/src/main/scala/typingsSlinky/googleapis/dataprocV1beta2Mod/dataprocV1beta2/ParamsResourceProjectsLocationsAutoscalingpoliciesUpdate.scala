...
object ParamsResourceProjectsLocationsAutoscalingpoliciesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsAutoscalingpoliciesUpdateOps[Self <: ParamsResourceProjectsLocationsAutoscalingpoliciesUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAutoscalingPolicy): Self = this.set("requestBody", value.asInstanceOf[js.Any])
