...
object SchemaLoggingConfig {
  ...
  implicit class SchemaLoggingConfigOps[Self <: SchemaLoggingConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDriverLogLevels(value: StringDictionary[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("driverLogLevels")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDriverLogLevels: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("driverLogLevels")(js.undefined)
        ret
    }
  }
