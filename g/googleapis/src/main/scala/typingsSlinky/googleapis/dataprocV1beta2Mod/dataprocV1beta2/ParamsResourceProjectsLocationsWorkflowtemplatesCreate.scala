...
object ParamsResourceProjectsLocationsWorkflowtemplatesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsWorkflowtemplatesCreateOps[Self <: ParamsResourceProjectsLocationsWorkflowtemplatesCreate] (val x: Self) extends AnyVal {
    @scala.inline
