...
@js.native
trait ParamsResourceProjectsLocationsAutoscalingpoliciesGet extends StandardParameters {
  /**
...
object ParamsResourceProjectsLocationsAutoscalingpoliciesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsAutoscalingpoliciesGetOps[Self <: ParamsResourceProjectsLocationsAutoscalingpoliciesGet] (val x: Self) extends AnyVal {
    @scala.inline
