...
object ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicyMutableBuilder[Self <: ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicy] (val x: Self) extends AnyVal {
