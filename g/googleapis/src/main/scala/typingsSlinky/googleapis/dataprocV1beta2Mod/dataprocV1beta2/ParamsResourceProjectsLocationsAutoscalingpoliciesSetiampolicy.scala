...
object ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicyOps[Self <: ParamsResourceProjectsLocationsAutoscalingpoliciesSetiampolicy] (val x: Self) extends AnyVal {
    @scala.inline
