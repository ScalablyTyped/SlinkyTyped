...
object ParamsResourceProjectsRegionsWorkflowtemplatesUpdate {
  @scala.inline
  def apply(): ParamsResourceProjectsRegionsWorkflowtemplatesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRegionsWorkflowtemplatesUpdate]
  }
  @scala.inline
  implicit class ParamsResourceProjectsRegionsWorkflowtemplatesUpdateOps[Self <: ParamsResourceProjectsRegionsWorkflowtemplatesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
