...
object ParamsResourceProjectsRegionsWorkflowtemplatesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsWorkflowtemplatesUpdateMutableBuilder[Self <: ParamsResourceProjectsRegionsWorkflowtemplatesUpdate] (val x: Self) extends AnyVal {
