...
object ParamsResourceProjectsRegionsAutoscalingpoliciesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsRegionsAutoscalingpoliciesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRegionsAutoscalingpoliciesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsRegionsAutoscalingpoliciesCreateMutableBuilder[Self <: ParamsResourceProjectsRegionsAutoscalingpoliciesCreate] (val x: Self) extends AnyVal {
