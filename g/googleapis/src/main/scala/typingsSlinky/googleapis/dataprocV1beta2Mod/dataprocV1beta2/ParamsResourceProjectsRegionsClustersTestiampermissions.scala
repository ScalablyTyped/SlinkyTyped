...
object ParamsResourceProjectsRegionsClustersTestiampermissions {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsClustersTestiampermissionsMutableBuilder[Self <: ParamsResourceProjectsRegionsClustersTestiampermissions] (val x: Self) extends AnyVal {
