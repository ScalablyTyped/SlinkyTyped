...
object ParamsResourceProjectsLocationsWorkflowtemplatesInstantiate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsWorkflowtemplatesInstantiateMutableBuilder[Self <: ParamsResourceProjectsLocationsWorkflowtemplatesInstantiate] (val x: Self) extends AnyVal {
