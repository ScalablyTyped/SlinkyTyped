...
/**
  ...
  */
@js.native
trait Schema$AchievementResetResponse extends js.Object {
  /**
...
object Schema$AchievementResetResponse {
  @scala.inline
  def apply(
  ...
  ): Schema$AchievementResetResponse = {
    ...
    __obj.asInstanceOf[Schema$AchievementResetResponse]
  }
}
