...
/**
  ...
  */
@js.native
trait Schema$GamesPlayedResource extends js.Object {
  /**
...
object Schema$GamesPlayedResource {
  @scala.inline
  def apply(autoMatched: js.UndefOr[Boolean] = js.undefined, timeMillis: String = null): Schema$GamesPlayedResource = {
    ...
    __obj.asInstanceOf[Schema$GamesPlayedResource]
  }
}
