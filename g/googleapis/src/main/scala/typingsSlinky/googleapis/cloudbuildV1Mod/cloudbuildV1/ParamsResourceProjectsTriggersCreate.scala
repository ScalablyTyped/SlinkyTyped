...
object ParamsResourceProjectsTriggersCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsTriggersCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTriggersCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsTriggersCreateMutableBuilder[Self <: ParamsResourceProjectsTriggersCreate] (val x: Self) extends AnyVal {
