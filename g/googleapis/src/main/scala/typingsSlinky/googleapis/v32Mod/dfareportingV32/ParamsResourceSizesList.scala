...
object ParamsResourceSizesList {
  @scala.inline
  def apply(): ParamsResourceSizesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSizesList]
  }
  @scala.inline
  implicit class ParamsResourceSizesListOps[Self <: ParamsResourceSizesList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withIabStandard(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iabStandard")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIabStandard: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iabStandard")(js.undefined)
        ret
    }
    @scala.inline
