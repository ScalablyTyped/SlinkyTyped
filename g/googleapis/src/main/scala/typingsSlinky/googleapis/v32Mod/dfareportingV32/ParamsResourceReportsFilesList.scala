...
object ParamsResourceReportsFilesList {
  ...
  @scala.inline
  def apply(): ParamsResourceReportsFilesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceReportsFilesList]
  }
  
  @scala.inline
  implicit class ParamsResourceReportsFilesListMutableBuilder[Self <: ParamsResourceReportsFilesList] (val x: Self) extends AnyVal {
