...
object ParamsResourceCampaignsInsert {
  @scala.inline
  def apply(): ParamsResourceCampaignsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCampaignsInsert]
  }
  @scala.inline
  implicit class ParamsResourceCampaignsInsertOps[Self <: ParamsResourceCampaignsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaCampaign): Self = {
        val ret = this.duplicate
