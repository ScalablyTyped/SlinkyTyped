...
import typingsSlinky.googleapis.anon.ConversionDimensions
import typingsSlinky.googleapis.anon.Dimension
import typingsSlinky.googleapis.anon.DimensionFilters
import typingsSlinky.googleapis.anon.EmailOwnerDeliveryType
import typingsSlinky.googleapis.anon.EnableAllDimensionCombinations
import typingsSlinky.googleapis.anon.FloodlightConfigId
...
object SchemaReport {
  ...
  implicit class SchemaReportOps[Self <: SchemaReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCriteria(value: DimensionFilters): Self = this.set("criteria", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCriteria: Self = this.set("criteria", js.undefined)
    
    @scala.inline
    def setCrossDimensionReachCriteria(value: Dimension): Self = this.set("crossDimensionReachCriteria", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCrossDimensionReachCriteria: Self = this.set("crossDimensionReachCriteria", js.undefined)
    
    @scala.inline
    def setDelivery(value: EmailOwnerDeliveryType): Self = this.set("delivery", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFloodlightCriteria(value: FloodlightConfigId): Self = this.set("floodlightCriteria", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReachCriteria(value: EnableAllDimensionCombinations): Self = this.set("reachCriteria", value.asInstanceOf[js.Any])
