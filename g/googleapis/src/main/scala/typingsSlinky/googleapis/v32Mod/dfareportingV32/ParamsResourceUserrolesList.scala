...
object ParamsResourceUserrolesList {
  ...
  implicit class ParamsResourceUserrolesListOps[Self <: ParamsResourceUserrolesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAccountUserRoleOnly(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accountUserRoleOnly")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAccountUserRoleOnly: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accountUserRoleOnly")(js.undefined)
        ret
    }
    @scala.inline
