...
@js.native
trait ParamsResourceRemarketinglistsPatch extends StandardParameters {
  /**
...
object ParamsResourceRemarketinglistsPatch {
  @scala.inline
  def apply(): ParamsResourceRemarketinglistsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRemarketinglistsPatch]
  }
  @scala.inline
  implicit class ParamsResourceRemarketinglistsPatchOps[Self <: ParamsResourceRemarketinglistsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaRemarketingList): Self = {
        val ret = this.duplicate
