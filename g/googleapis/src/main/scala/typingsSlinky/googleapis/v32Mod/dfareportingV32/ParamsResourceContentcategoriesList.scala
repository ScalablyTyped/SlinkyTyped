...
@js.native
trait ParamsResourceContentcategoriesList extends StandardParameters {
...
object ParamsResourceContentcategoriesList {
  ...
  @scala.inline
  def apply(): ParamsResourceContentcategoriesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceContentcategoriesList]
  }
  
  @scala.inline
  implicit class ParamsResourceContentcategoriesListMutableBuilder[Self <: ParamsResourceContentcategoriesList] (val x: Self) extends AnyVal {
