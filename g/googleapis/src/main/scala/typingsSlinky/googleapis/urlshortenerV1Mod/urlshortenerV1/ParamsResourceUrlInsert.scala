...
object ParamsResourceUrlInsert {
  ...
  @scala.inline
  implicit class ParamsResourceUrlInsertOps[Self <: ParamsResourceUrlInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUrl): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
