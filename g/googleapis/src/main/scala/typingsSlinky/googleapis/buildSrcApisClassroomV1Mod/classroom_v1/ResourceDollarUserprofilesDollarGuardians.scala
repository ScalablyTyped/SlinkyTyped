...
@js.native
class ResourceDollarUserprofilesDollarGuardians protected () extends js.Object {
  ...
  def delete(params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarDelete): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarDelete,
  ...
  def delete(params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarDelete, options: MethodOptions): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarDelete,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def get(): GaxiosPromise[Schema$Guardian] = js.native
  def get(callback: BodyResponseCallback[Schema$Guardian]): Unit = js.native
  def get(params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarGet): GaxiosPromise[Schema$Guardian] = js.native
  def get(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarGet,
    callback: BodyResponseCallback[Schema$Guardian]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarGet,
    options: BodyResponseCallback[Schema$Guardian],
    callback: BodyResponseCallback[Schema$Guardian]
  ): Unit = js.native
  def get(params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarGet, options: MethodOptions): GaxiosPromise[Schema$Guardian] = js.native
  def get(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarGet,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Guardian]
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$ListGuardiansResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListGuardiansResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarList): GaxiosPromise[Schema$ListGuardiansResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarList,
    callback: BodyResponseCallback[Schema$ListGuardiansResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarList,
    options: BodyResponseCallback[Schema$ListGuardiansResponse],
    callback: BodyResponseCallback[Schema$ListGuardiansResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarList, options: MethodOptions): GaxiosPromise[Schema$ListGuardiansResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarUserprofilesDollarGuardiansDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListGuardiansResponse]
