...
object ParamsResourceUsersImportsshpublickey {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersImportsshpublickey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersImportsshpublickey]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersImportsshpublickeyOps[Self <: ParamsResourceUsersImportsshpublickey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSshPublicKey): Self = this.set("requestBody", value.asInstanceOf[js.Any])
