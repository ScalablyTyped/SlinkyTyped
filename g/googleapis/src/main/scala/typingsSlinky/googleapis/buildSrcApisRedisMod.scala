...
import typingsSlinky.googleapis.buildSrcApisRedisV1Mod.redis_v1.Options
import typingsSlinky.googleapis.buildSrcApisRedisV1Mod.redis_v1.Redis
...
@js.native
object buildSrcApisRedisMod extends js.Object {
  def redis(options: Options): Redis = js.native
  def redis(options: typingsSlinky.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Options): typingsSlinky.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Redis = js.native
  @JSName("redis")
  def redis_v1(version: v1): Redis = js.native
  @JSName("redis")
  def redis_v1beta1(version: v1beta1): typingsSlinky.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Redis = js.native
  @js.native
    ...
    object v1beta1
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Redis
              ]
            ]
