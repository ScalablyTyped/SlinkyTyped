...
@js.native
trait ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpost extends StandardParameters {
  /**
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpost {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpostOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpost] (val x: Self) extends AnyVal {
    @scala.inline
