...
object ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresource {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresourceOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresource] (val x: Self) extends AnyVal {
