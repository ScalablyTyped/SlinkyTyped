...
object ParamsResourceProjectsLocationsDatasetsHl7v2storesMessagesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsHl7v2storesMessagesDeleteOps[Self <: ParamsResourceProjectsLocationsDatasetsHl7v2storesMessagesDelete] (val x: Self) extends AnyVal {
