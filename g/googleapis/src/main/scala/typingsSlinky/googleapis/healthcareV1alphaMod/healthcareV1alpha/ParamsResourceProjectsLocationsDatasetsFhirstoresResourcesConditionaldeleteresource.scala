...
object ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionaldeleteresource {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionaldeleteresourceOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionaldeleteresource] (val x: Self) extends AnyVal {
