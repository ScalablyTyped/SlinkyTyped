...
object ParamsResourceProjectsLocationsDatasetsHl7v2storesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsHl7v2storesPatchMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsHl7v2storesPatch] (val x: Self) extends AnyVal {
