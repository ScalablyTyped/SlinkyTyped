...
/**
  ...
  */
@js.native
trait Schema$TargetChange extends js.Object {
  /**
    * The error that resulted in this change, if applicable.
    */
  var cause: js.UndefOr[Schema$Status] = js.native
  /**
...
object Schema$TargetChange {
  @scala.inline
  def apply(
    cause: Schema$Status = null,
    ...
    __obj.asInstanceOf[Schema$TargetChange]
  }
}
