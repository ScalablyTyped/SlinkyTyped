...
/**
  ...
  */
@js.native
trait Schema$ExternallyHostedApk extends js.Object {
  /**
  ...
  /**
    ...
    */
  var usesPermissions: js.UndefOr[js.Array[Schema$ExternallyHostedApkUsesPermission]] = js.native
  /**
...
object Schema$ExternallyHostedApk {
  @scala.inline
  def apply(
    ...
    usesPermissions: js.Array[Schema$ExternallyHostedApkUsesPermission] = null,
    versionCode: Int | Double = null,
    versionName: String = null
  ): Schema$ExternallyHostedApk = {
    ...
    __obj.asInstanceOf[Schema$ExternallyHostedApk]
  }
}
