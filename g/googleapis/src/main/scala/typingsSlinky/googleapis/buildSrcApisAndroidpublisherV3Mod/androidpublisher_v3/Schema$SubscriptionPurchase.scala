package typingsSlinky.googleapis.buildSrcApisAndroidpublisherV3Mod.androidpublisher_v3
...
/**
  ...
  */
@js.native
trait Schema$SubscriptionPurchase extends js.Object {
  /**
  ...
  /**
    ...
    */
  var cancelSurveyResult: js.UndefOr[Schema$SubscriptionCancelSurveyResult] = js.native
  /**
  ...
  /**
    ...
    */
  var priceChange: js.UndefOr[Schema$SubscriptionPriceChange] = js.native
  /**
...
object Schema$SubscriptionPurchase {
  ...
  def apply(
    ...
    priceChange: Schema$SubscriptionPriceChange = null,
    ...
    __obj.asInstanceOf[Schema$SubscriptionPurchase]
  }
}
