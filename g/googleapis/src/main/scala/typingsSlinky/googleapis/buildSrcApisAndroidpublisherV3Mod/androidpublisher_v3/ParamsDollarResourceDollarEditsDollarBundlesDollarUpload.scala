...
import typingsSlinky.googleapis.Anon_Body
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait ParamsDollarResourceDollarEditsDollarBundlesDollarUpload extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarBundlesDollarUpload {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarBundlesDollarUpload = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarBundlesDollarUpload]
  }
}
