...
@js.native
trait ParamsDollarResourceDollarEditsDollarDeobfuscationfilesDollarUpload extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarDeobfuscationfilesDollarUpload {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarDeobfuscationfilesDollarUpload = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarDeobfuscationfilesDollarUpload]
  }
}
