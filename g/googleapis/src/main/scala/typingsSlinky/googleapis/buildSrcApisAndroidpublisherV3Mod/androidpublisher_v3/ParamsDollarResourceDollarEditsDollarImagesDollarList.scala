...
@js.native
trait ParamsDollarResourceDollarEditsDollarImagesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarImagesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarImagesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarImagesDollarList]
  }
}
