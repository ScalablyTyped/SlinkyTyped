...
@js.native
trait ParamsResourceI18nregionsList extends StandardParameters {
...
object ParamsResourceI18nregionsList {
  ...
  @scala.inline
  def apply(): ParamsResourceI18nregionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceI18nregionsList]
  }
  
  @scala.inline
  implicit class ParamsResourceI18nregionsListMutableBuilder[Self <: ParamsResourceI18nregionsList] (val x: Self) extends AnyVal {
