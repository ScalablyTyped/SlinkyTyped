...
object ParamsResourceChannelbannersInsert {
  ...
  @scala.inline
  implicit class ParamsResourceChannelbannersInsertMutableBuilder[Self <: ParamsResourceChannelbannersInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaChannelBannerResource): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
