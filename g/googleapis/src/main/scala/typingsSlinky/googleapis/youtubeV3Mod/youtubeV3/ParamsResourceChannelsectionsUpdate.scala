...
@js.native
trait ParamsResourceChannelsectionsUpdate extends StandardParameters {
...
object ParamsResourceChannelsectionsUpdate {
  
  @scala.inline
  def apply(): ParamsResourceChannelsectionsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceChannelsectionsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceChannelsectionsUpdateMutableBuilder[Self <: ParamsResourceChannelsectionsUpdate] (val x: Self) extends AnyVal {
