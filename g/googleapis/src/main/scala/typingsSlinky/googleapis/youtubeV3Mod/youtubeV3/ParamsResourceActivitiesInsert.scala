...
object ParamsResourceActivitiesInsert {
  ...
  @scala.inline
  implicit class ParamsResourceActivitiesInsertOps[Self <: ParamsResourceActivitiesInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaActivity): Self = this.set("requestBody", value.asInstanceOf[js.Any])
