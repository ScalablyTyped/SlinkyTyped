...
object SchemaVideoAbuseReportReasonListResponse {
  ...
  @scala.inline
  implicit class SchemaVideoAbuseReportReasonListResponseOps[Self <: SchemaVideoAbuseReportReasonListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaVideoAbuseReportReason*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaVideoAbuseReportReason]): Self = this.set("items", value.asInstanceOf[js.Any])
