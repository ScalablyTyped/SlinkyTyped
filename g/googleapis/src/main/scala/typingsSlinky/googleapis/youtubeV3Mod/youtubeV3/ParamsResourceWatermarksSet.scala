...
object ParamsResourceWatermarksSet {
  ...
  @scala.inline
  implicit class ParamsResourceWatermarksSetOps[Self <: ParamsResourceWatermarksSet] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaInvideoBranding): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
