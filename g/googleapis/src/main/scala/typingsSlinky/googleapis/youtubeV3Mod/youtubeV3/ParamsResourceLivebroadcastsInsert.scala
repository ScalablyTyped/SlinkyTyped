...
@js.native
trait ParamsResourceLivebroadcastsInsert extends StandardParameters {
  /**
...
object ParamsResourceLivebroadcastsInsert {
  @scala.inline
  def apply(): ParamsResourceLivebroadcastsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLivebroadcastsInsert]
  }
  @scala.inline
  implicit class ParamsResourceLivebroadcastsInsertOps[Self <: ParamsResourceLivebroadcastsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaLiveBroadcast): Self = {
        val ret = this.duplicate
