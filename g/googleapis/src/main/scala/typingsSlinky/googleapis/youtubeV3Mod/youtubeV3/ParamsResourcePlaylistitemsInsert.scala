...
object ParamsResourcePlaylistitemsInsert {
  ...
  @scala.inline
  implicit class ParamsResourcePlaylistitemsInsertOps[Self <: ParamsResourcePlaylistitemsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaPlaylistItem): Self = {
        val ret = this.duplicate
