...
@js.native
trait ParamsResourceVideosGetrating extends StandardParameters {
...
object ParamsResourceVideosGetrating {
  
  @scala.inline
  def apply(): ParamsResourceVideosGetrating = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceVideosGetrating]
  }
  
  @scala.inline
  implicit class ParamsResourceVideosGetratingMutableBuilder[Self <: ParamsResourceVideosGetrating] (val x: Self) extends AnyVal {
