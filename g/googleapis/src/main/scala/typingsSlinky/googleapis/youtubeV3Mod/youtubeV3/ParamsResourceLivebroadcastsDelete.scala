...
@js.native
trait ParamsResourceLivebroadcastsDelete extends StandardParameters {
...
object ParamsResourceLivebroadcastsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceLivebroadcastsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLivebroadcastsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceLivebroadcastsDeleteMutableBuilder[Self <: ParamsResourceLivebroadcastsDelete] (val x: Self) extends AnyVal {
