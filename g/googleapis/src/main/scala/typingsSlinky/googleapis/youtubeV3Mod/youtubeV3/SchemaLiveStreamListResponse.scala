...
object SchemaLiveStreamListResponse {
  ...
  @scala.inline
  implicit class SchemaLiveStreamListResponseOps[Self <: SchemaLiveStreamListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaLiveStream*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaLiveStream]): Self = this.set("items", value.asInstanceOf[js.Any])
