...
@js.native
trait SchemaLiveStreamListResponse extends StObject {
...
object SchemaLiveStreamListResponse {
  ...
  @scala.inline
  def apply(): SchemaLiveStreamListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLiveStreamListResponse]
  }
  
  @scala.inline
  implicit class SchemaLiveStreamListResponseMutableBuilder[Self <: SchemaLiveStreamListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaLiveStream]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaLiveStream*): Self = StObject.set(x, "items", js.Array(value :_*))
