...
@js.native
trait ParamsResourcePlaylistitemsDelete extends StandardParameters {
...
object ParamsResourcePlaylistitemsDelete {
  
  @scala.inline
  def apply(): ParamsResourcePlaylistitemsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlaylistitemsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourcePlaylistitemsDeleteMutableBuilder[Self <: ParamsResourcePlaylistitemsDelete] (val x: Self) extends AnyVal {
