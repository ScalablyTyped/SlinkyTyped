...
object ParamsResourcePlaylistsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourcePlaylistsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlaylistsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourcePlaylistsDeleteMutableBuilder[Self <: ParamsResourcePlaylistsDelete] (val x: Self) extends AnyVal {
