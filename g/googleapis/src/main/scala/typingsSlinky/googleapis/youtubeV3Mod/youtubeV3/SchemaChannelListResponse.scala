...
@js.native
trait SchemaChannelListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaChannel]] = js.native
  /**
...
object SchemaChannelListResponse {
  @scala.inline
  def apply(): SchemaChannelListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaChannelListResponse]
  }
  @scala.inline
  implicit class SchemaChannelListResponseOps[Self <: SchemaChannelListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaChannel*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaChannel]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
