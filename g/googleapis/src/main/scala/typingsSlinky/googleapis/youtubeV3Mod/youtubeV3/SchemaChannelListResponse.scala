...
object SchemaChannelListResponse {
  ...
  @scala.inline
  implicit class SchemaChannelListResponseMutableBuilder[Self <: SchemaChannelListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaChannel]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaChannel*): Self = StObject.set(x, "items", js.Array(value :_*))
