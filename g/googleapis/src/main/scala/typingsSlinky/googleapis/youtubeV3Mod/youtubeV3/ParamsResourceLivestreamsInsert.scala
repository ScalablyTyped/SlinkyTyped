...
@js.native
trait ParamsResourceLivestreamsInsert extends StandardParameters {
  /**
...
object ParamsResourceLivestreamsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceLivestreamsInsertOps[Self <: ParamsResourceLivestreamsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaLiveStream): Self = {
        val ret = this.duplicate
