...
object SchemaPlaylist {
  ...
  implicit class SchemaPlaylistOps[Self <: SchemaPlaylist] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContentDetails(value: SchemaPlaylistContentDetails): Self = {
    ...
    @scala.inline
    def withLocalizations(value: StringDictionary[SchemaPlaylistLocalization]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPlayer(value: SchemaPlaylistPlayer): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSnippet(value: SchemaPlaylistSnippet): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStatus(value: SchemaPlaylistStatus): Self = {
        val ret = this.duplicate
