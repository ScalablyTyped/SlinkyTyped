...
object ParamsResourceCommentthreadsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceCommentthreadsUpdateMutableBuilder[Self <: ParamsResourceCommentthreadsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCommentThread): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
