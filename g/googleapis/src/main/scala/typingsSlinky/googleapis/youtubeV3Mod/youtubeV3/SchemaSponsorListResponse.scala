...
@js.native
trait SchemaSponsorListResponse extends js.Object {
...
object SchemaSponsorListResponse {
  ...
  @scala.inline
  implicit class SchemaSponsorListResponseOps[Self <: SchemaSponsorListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaSponsor*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaSponsor]): Self = this.set("items", value.asInstanceOf[js.Any])
