...
@js.native
trait SchemaSuperChatEventListResponse extends StObject {
...
object SchemaSuperChatEventListResponse {
  ...
  @scala.inline
  implicit class SchemaSuperChatEventListResponseMutableBuilder[Self <: SchemaSuperChatEventListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaSuperChatEvent]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaSuperChatEvent*): Self = StObject.set(x, "items", js.Array(value :_*))
