...
object ParamsResourceLivechatmessagesInsert {
  ...
  @scala.inline
  implicit class ParamsResourceLivechatmessagesInsertOps[Self <: ParamsResourceLivechatmessagesInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaLiveChatMessage): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
