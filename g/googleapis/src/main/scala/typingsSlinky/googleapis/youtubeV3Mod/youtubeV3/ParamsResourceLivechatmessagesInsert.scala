...
object ParamsResourceLivechatmessagesInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceLivechatmessagesInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLivechatmessagesInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceLivechatmessagesInsertMutableBuilder[Self <: ParamsResourceLivechatmessagesInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaLiveChatMessage): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
