...
@js.native
trait SchemaVideoCategoryListResponse extends StObject {
...
object SchemaVideoCategoryListResponse {
  ...
  @scala.inline
  def apply(): SchemaVideoCategoryListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaVideoCategoryListResponse]
  }
  
  @scala.inline
  implicit class SchemaVideoCategoryListResponseMutableBuilder[Self <: SchemaVideoCategoryListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaVideoCategory]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaVideoCategory*): Self = StObject.set(x, "items", js.Array(value :_*))
