...
object SchemaVideoCategoryListResponse {
  ...
  @scala.inline
  implicit class SchemaVideoCategoryListResponseOps[Self <: SchemaVideoCategoryListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaVideoCategory*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaVideoCategory]): Self = this.set("items", value.asInstanceOf[js.Any])
