...
@js.native
trait ParamsDollarResourceDollarAccountsDollarAdunitsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarAdunitsDollarGet {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarAdunitsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarAdunitsDollarGet]
  }
}
