...
@js.native
trait ParamsDollarResourceDollarAssociationsessionsDollarStart extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAssociationsessionsDollarStart {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarAssociationsessionsDollarStart = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAssociationsessionsDollarStart]
  }
}
