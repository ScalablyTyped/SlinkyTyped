...
@js.native
trait ParamsDollarResourceDollarCustomchannelsDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCustomchannelsDollarInsert {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCustomchannelsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCustomchannelsDollarInsert]
  }
}
