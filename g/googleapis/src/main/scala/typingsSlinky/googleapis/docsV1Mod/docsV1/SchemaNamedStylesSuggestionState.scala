...
object SchemaNamedStylesSuggestionState {
  ...
  implicit class SchemaNamedStylesSuggestionStateOps[Self <: SchemaNamedStylesSuggestionState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStylesSuggestionStates(value: js.Array[SchemaNamedStyleSuggestionState]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stylesSuggestionStates")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStylesSuggestionStates: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stylesSuggestionStates")(js.undefined)
        ret
    }
  }
