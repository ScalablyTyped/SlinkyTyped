...
@js.native
trait ParamsDollarResourceDollarUrlmapsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUrlmapsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    urlMap: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUrlmapsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUrlmapsDollarDelete]
  }
}
