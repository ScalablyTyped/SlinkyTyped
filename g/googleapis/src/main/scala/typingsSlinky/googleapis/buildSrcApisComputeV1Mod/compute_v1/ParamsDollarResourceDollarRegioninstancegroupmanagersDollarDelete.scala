...
@js.native
trait ParamsDollarResourceDollarRegioninstancegroupmanagersDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRegioninstancegroupmanagersDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarRegioninstancegroupmanagersDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRegioninstancegroupmanagersDollarDelete]
  }
}
