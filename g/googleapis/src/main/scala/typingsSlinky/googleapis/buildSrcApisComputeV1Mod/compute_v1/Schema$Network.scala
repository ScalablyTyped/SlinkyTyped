...
trait Schema$Network extends js.Object {
  ...
  /**
    ...
    */
  var peerings: js.UndefOr[js.Array[Schema$NetworkPeering]] = js.native
  /**
    ...
    * enforce.
    */
  var routingConfig: js.UndefOr[Schema$NetworkRoutingConfig] = js.native
  /**
...
object Schema$Network {
  ...
  def apply(
    ...
    kind: String = null,
    name: String = null,
    peerings: js.Array[Schema$NetworkPeering] = null,
    routingConfig: Schema$NetworkRoutingConfig = null,
