...
@js.native
trait Schema$RegionInstanceGroupsSetNamedPortsRequest extends js.Object {
  /**
...
object Schema$RegionInstanceGroupsSetNamedPortsRequest {
  @scala.inline
  def apply(fingerprint: String = null, namedPorts: js.Array[Schema$NamedPort] = null): Schema$RegionInstanceGroupsSetNamedPortsRequest = {
    val __obj = js.Dynamic.literal()
    if (fingerprint != null) __obj.updateDynamic("fingerprint")(fingerprint.asInstanceOf[js.Any])
    if (namedPorts != null) __obj.updateDynamic("namedPorts")(namedPorts.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$RegionInstanceGroupsSetNamedPortsRequest]
  }
}
