...
trait Schema$Project extends js.Object {
  /**
    ...
    */
  var commonInstanceMetadata: js.UndefOr[Schema$Metadata] = js.native
  /**
  ...
  /**
    ...
    */
  var usageExportLocation: js.UndefOr[Schema$UsageExportLocation] = js.native
  /**
...
object Schema$Project {
  @scala.inline
  def apply(
    commonInstanceMetadata: Schema$Metadata = null,
    ...
    usageExportLocation: Schema$UsageExportLocation = null,
