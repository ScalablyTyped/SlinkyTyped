...
@js.native
trait ParamsDollarResourceDollarTargetvpngatewaysDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTargetvpngatewaysDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTargetvpngatewaysDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTargetvpngatewaysDollarDelete]
  }
}
