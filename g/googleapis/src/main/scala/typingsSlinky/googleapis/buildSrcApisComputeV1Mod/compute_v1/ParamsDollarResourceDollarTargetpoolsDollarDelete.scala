...
@js.native
trait ParamsDollarResourceDollarTargetpoolsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTargetpoolsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTargetpoolsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTargetpoolsDollarDelete]
  }
}
