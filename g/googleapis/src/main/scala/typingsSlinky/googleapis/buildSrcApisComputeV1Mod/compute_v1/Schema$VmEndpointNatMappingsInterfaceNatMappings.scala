...
/**
  ...
  */
@js.native
trait Schema$VmEndpointNatMappingsInterfaceNatMappings extends js.Object {
  /**
...
object Schema$VmEndpointNatMappingsInterfaceNatMappings {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$VmEndpointNatMappingsInterfaceNatMappings]
  }
}
