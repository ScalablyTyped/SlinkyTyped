...
@js.native
trait ParamsDollarResourceDollarInstancesDollarDeleteaccessconfig extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstancesDollarDeleteaccessconfig {
  @scala.inline
  def apply(
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarInstancesDollarDeleteaccessconfig = {
    val __obj = js.Dynamic.literal()
    if (accessConfig != null) __obj.updateDynamic("accessConfig")(accessConfig.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstancesDollarDeleteaccessconfig]
  }
}
