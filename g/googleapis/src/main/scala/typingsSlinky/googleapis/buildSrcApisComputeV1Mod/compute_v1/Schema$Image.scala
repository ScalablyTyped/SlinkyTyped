...
import typingsSlinky.googleapis.Anon_ContainerType
...
trait Schema$Image extends js.Object {
  ...
  /**
    ...
    */
  var imageEncryptionKey: js.UndefOr[Schema$CustomerEncryptionKey] = js.native
  /**
  ...
  /**
    ...
    */
  var rawDisk: js.UndefOr[Anon_ContainerType] = js.native
  /**
  ...
  /**
    ...
    */
  var sourceDiskEncryptionKey: js.UndefOr[Schema$CustomerEncryptionKey] = js.native
  /**
...
object Schema$Image {
  ...
  def apply(
    ...
    id: String = null,
    imageEncryptionKey: Schema$CustomerEncryptionKey = null,
    kind: String = null,
    ...
    sourceDiskEncryptionKey: Schema$CustomerEncryptionKey = null,
