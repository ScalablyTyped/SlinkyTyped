...
@js.native
trait AnonCanChangeCopyRequiresWriterPermissionRestriction extends js.Object {
...
object AnonCanChangeCopyRequiresWriterPermissionRestriction {
  @scala.inline
  def apply(): AnonCanChangeCopyRequiresWriterPermissionRestriction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCanChangeCopyRequiresWriterPermissionRestriction]
  }
  @scala.inline
  implicit class AnonCanChangeCopyRequiresWriterPermissionRestrictionOps[Self <: AnonCanChangeCopyRequiresWriterPermissionRestriction] (val x: Self) extends AnyVal {
    @scala.inline
