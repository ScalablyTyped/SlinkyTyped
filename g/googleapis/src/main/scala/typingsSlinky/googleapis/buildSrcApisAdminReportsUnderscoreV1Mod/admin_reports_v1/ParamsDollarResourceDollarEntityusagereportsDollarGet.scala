package typingsSlinky.googleapis.buildSrcApisAdminReportsUnderscoreV1Mod.admin_reports_v1
...
@js.native
trait ParamsDollarResourceDollarEntityusagereportsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEntityusagereportsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEntityusagereportsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEntityusagereportsDollarGet]
  }
}
