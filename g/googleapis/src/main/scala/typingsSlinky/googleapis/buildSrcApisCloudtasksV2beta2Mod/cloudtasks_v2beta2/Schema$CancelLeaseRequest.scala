...
/**
  ...
  */
@js.native
trait Schema$CancelLeaseRequest extends js.Object {
  /**
...
object Schema$CancelLeaseRequest {
  @scala.inline
  def apply(responseView: String = null, scheduleTime: String = null): Schema$CancelLeaseRequest = {
    ...
    __obj.asInstanceOf[Schema$CancelLeaseRequest]
  }
}
