...
trait Schema$Task extends js.Object {
  ...
  /**
    ...
    */
  var pullMessage: js.UndefOr[Schema$PullMessage] = js.native
  /**
  ...
  /**
    ...
    */
  var status: js.UndefOr[Schema$TaskStatus] = js.native
  /**
...
object Schema$Task {
  ...
  def apply(
    ...
    name: String = null,
    pullMessage: Schema$PullMessage = null,
    scheduleTime: String = null,
    status: Schema$TaskStatus = null,
    view: String = null
  ): Schema$Task = {
