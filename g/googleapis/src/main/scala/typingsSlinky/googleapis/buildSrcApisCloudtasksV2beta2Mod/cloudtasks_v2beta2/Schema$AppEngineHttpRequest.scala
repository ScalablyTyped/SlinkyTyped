...
/**
  ...
  */
@js.native
trait Schema$AppEngineHttpRequest extends js.Object {
  /**
    ...
    */
  var appEngineRouting: js.UndefOr[Schema$AppEngineRouting] = js.native
  /**
...
object Schema$AppEngineHttpRequest {
  @scala.inline
  def apply(
    appEngineRouting: Schema$AppEngineRouting = null,
    ...
    __obj.asInstanceOf[Schema$AppEngineHttpRequest]
  }
}
