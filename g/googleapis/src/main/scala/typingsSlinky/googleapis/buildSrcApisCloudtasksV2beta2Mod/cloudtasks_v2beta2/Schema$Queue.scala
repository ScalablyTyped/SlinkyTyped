...
/**
  ...
  */
@js.native
trait Schema$Queue extends js.Object {
  /**
    * App Engine HTTP target.  An App Engine queue is a queue that has an
    * AppEngineHttpTarget.
    */
  var appEngineHttpTarget: js.UndefOr[Schema$AppEngineHttpTarget] = js.native
  /**
  ...
  /**
    ...
    */
  var pullTarget: js.UndefOr[Schema$PullTarget] = js.native
  /**
  ...
  /**
    ...
    */
  var rateLimits: js.UndefOr[Schema$RateLimits] = js.native
  /**
    ...
    */
  var retryConfig: js.UndefOr[Schema$RetryConfig] = js.native
  /**
...
object Schema$Queue {
  @scala.inline
  def apply(
    appEngineHttpTarget: Schema$AppEngineHttpTarget = null,
    name: String = null,
    pullTarget: Schema$PullTarget = null,
    purgeTime: String = null,
    rateLimits: Schema$RateLimits = null,
    retryConfig: Schema$RetryConfig = null,
    state: String = null
  ): Schema$Queue = {
    ...
    __obj.asInstanceOf[Schema$Queue]
  }
}
