...
object ParamsResourceTransfersGet {
  ...
  implicit class ParamsResourceTransfersGetOps[Self <: ParamsResourceTransfersGet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDataTransferId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataTransferId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDataTransferId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataTransferId")(js.undefined)
        ret
    }
  }
