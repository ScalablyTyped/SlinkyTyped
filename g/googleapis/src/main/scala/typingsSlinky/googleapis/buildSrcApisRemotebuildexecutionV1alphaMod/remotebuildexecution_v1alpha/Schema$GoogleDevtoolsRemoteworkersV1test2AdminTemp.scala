...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemoteworkersV1test2AdminTemp extends js.Object {
  /**
...
object Schema$GoogleDevtoolsRemoteworkersV1test2AdminTemp {
  @scala.inline
  def apply(arg: String = null, command: String = null): Schema$GoogleDevtoolsRemoteworkersV1test2AdminTemp = {
    val __obj = js.Dynamic.literal()
    if (arg != null) __obj.updateDynamic("arg")(arg.asInstanceOf[js.Any])
    if (command != null) __obj.updateDynamic("command")(command.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemoteworkersV1test2AdminTemp]
  }
}
