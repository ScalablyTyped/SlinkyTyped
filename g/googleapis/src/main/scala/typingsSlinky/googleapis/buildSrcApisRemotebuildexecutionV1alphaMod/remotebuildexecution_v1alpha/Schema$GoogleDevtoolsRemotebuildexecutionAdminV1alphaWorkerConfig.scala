...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig extends js.Object {
  /**
...
object Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig]
  }
}
