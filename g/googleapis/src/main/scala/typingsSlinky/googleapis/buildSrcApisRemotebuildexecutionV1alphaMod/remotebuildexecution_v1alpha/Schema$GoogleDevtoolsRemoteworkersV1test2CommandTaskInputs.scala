package typingsSlinky.googleapis.buildSrcApisRemotebuildexecutionV1alphaMod.remotebuildexecution_v1alpha
...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs extends js.Object {
  /**
  ...
  var environmentVariables: js.UndefOr[
    js.Array[Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable]
  ] = js.native
  /**
    ...
    */
  var files: js.UndefOr[js.Array[Schema$GoogleDevtoolsRemoteworkersV1test2Digest]] = js.native
  /**
    ...
    */
  var inlineBlobs: js.UndefOr[js.Array[Schema$GoogleDevtoolsRemoteworkersV1test2Blob]] = js.native
  /**
...
object Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs {
  @scala.inline
  def apply(
    arguments: js.Array[String] = null,
    environmentVariables: js.Array[Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable] = null,
    files: js.Array[Schema$GoogleDevtoolsRemoteworkersV1test2Digest] = null,
    inlineBlobs: js.Array[Schema$GoogleDevtoolsRemoteworkersV1test2Blob] = null,
    workingDirectory: String = null
  ): Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs = {
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs]
  }
}
