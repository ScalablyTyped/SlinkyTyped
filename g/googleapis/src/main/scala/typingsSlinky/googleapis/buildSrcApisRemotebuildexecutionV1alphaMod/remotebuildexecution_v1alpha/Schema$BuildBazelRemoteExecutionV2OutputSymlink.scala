...
/**
  ...
  */
@js.native
trait Schema$BuildBazelRemoteExecutionV2OutputSymlink extends js.Object {
  /**
...
object Schema$BuildBazelRemoteExecutionV2OutputSymlink {
  @scala.inline
  def apply(path: String = null, target: String = null): Schema$BuildBazelRemoteExecutionV2OutputSymlink = {
    val __obj = js.Dynamic.literal()
    if (path != null) __obj.updateDynamic("path")(path.asInstanceOf[js.Any])
    if (target != null) __obj.updateDynamic("target")(target.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BuildBazelRemoteExecutionV2OutputSymlink]
  }
}
