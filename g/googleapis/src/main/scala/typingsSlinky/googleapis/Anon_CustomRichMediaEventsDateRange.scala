...
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot2Mod.dfareporting_v3_2.Schema$DateRange
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot2Mod.dfareporting_v3_2.Schema$DimensionValue
import typingsSlinky.googleapis.buildSrcApisDfareportingV3Dot2Mod.dfareporting_v3_2.Schema$SortedDimension
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Anon_CustomRichMediaEventsDateRange extends js.Object {
...
object Anon_CustomRichMediaEventsDateRange {
  @scala.inline
  def apply(
  ...
  ): Anon_CustomRichMediaEventsDateRange = {
    ...
    __obj.asInstanceOf[Anon_CustomRichMediaEventsDateRange]
  }
}
