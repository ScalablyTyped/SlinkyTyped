...
object SchemaDiscovery {
  ...
  implicit class SchemaDiscoveryOps[Self <: SchemaDiscovery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnalysisKind(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("analysisKind")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAnalysisKind: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("analysisKind")(js.undefined)
        ret
    }
  }
