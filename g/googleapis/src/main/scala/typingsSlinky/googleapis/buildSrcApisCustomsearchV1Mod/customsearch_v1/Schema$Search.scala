...
import typingsSlinky.googleapis.Anon_CorrectedQuery
import typingsSlinky.googleapis.Anon_FormattedSearchTime
import typingsSlinky.googleapis.Anon_Template
