...
@js.native
class ResourceDollarCseDollarSiterestrict protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarCseDollarSiterestrictDollarList): GaxiosPromise[Schema$Search] = js.native
  def list(
    params: ParamsDollarResourceDollarCseDollarSiterestrictDollarList,
  ...
  def list(params: ParamsDollarResourceDollarCseDollarSiterestrictDollarList, options: MethodOptions): GaxiosPromise[Schema$Search] = js.native
  def list(
    params: ParamsDollarResourceDollarCseDollarSiterestrictDollarList,
