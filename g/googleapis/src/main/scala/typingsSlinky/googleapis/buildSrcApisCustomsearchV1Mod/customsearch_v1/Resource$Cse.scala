package typingsSlinky.googleapis.buildSrcApisCustomsearchV1Mod.customsearch_v1
...
@js.native
class Resource$Cse protected () extends js.Object {
  def this(context: APIRequestContext) = this()
  var context: APIRequestContext = js.native
  var siterestrict: ResourceDollarCseDollarSiterestrict = js.native
  /**
    * search.cse.list
    ...
    */
  def list(): GaxiosPromise[Schema$Search] = js.native
  def list(callback: BodyResponseCallback[Schema$Search]): Unit = js.native
  def list(params: ParamsDollarResourceDollarCseDollarList): GaxiosPromise[Schema$Search] = js.native
  def list(params: ParamsDollarResourceDollarCseDollarList, callback: BodyResponseCallback[Schema$Search]): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarCseDollarList,
    options: BodyResponseCallback[Schema$Search],
    callback: BodyResponseCallback[Schema$Search]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarCseDollarList, options: MethodOptions): GaxiosPromise[Schema$Search] = js.native
  def list(
    params: ParamsDollarResourceDollarCseDollarList,
