...
object ParamsResourceFoldersUndelete {
  ...
  @scala.inline
  def apply(): ParamsResourceFoldersUndelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersUndelete]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersUndeleteMutableBuilder[Self <: ParamsResourceFoldersUndelete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUndeleteFolderRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
