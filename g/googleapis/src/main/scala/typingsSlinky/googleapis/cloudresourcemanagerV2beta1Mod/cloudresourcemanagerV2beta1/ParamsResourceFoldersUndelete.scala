...
object ParamsResourceFoldersUndelete {
  ...
  @scala.inline
  implicit class ParamsResourceFoldersUndeleteOps[Self <: ParamsResourceFoldersUndelete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUndeleteFolderRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
