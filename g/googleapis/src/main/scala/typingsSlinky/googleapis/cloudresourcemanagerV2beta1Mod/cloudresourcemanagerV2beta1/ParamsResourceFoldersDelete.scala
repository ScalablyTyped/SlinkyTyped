...
object ParamsResourceFoldersDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceFoldersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersDeleteMutableBuilder[Self <: ParamsResourceFoldersDelete] (val x: Self) extends AnyVal {
