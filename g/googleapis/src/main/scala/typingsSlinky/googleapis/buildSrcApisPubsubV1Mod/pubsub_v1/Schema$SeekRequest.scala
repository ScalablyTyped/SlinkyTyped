...
/**
  ...
  */
@js.native
trait Schema$SeekRequest extends js.Object {
  /**
...
object Schema$SeekRequest {
  @scala.inline
  def apply(snapshot: String = null, time: String = null): Schema$SeekRequest = {
    val __obj = js.Dynamic.literal()
    if (snapshot != null) __obj.updateDynamic("snapshot")(snapshot.asInstanceOf[js.Any])
    if (time != null) __obj.updateDynamic("time")(time.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$SeekRequest]
  }
}
