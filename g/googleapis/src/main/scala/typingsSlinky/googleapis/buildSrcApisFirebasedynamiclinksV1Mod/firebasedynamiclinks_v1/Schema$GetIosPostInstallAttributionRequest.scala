...
/**
  ...
  */
@js.native
trait Schema$GetIosPostInstallAttributionRequest extends js.Object {
  /**
  ...
  /**
    * Device information.
    */
  var device: js.UndefOr[Schema$DeviceInfo] = js.native
  /**
...
object Schema$GetIosPostInstallAttributionRequest {
  @scala.inline
  def apply(
    appInstallationTime: String = null,
    bundleId: String = null,
    device: Schema$DeviceInfo = null,
    iosVersion: String = null,
    retrievalMethod: String = null,
    sdkVersion: String = null,
    uniqueMatchLinkToCheck: String = null,
    visualStyle: String = null
  ): Schema$GetIosPostInstallAttributionRequest = {
    ...
    __obj.asInstanceOf[Schema$GetIosPostInstallAttributionRequest]
  }
}
