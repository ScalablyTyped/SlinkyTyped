...
/**
  ...
  */
@js.native
trait Schema$GooglePlayAnalytics extends js.Object {
  /**
    * [AdWords autotagging
...
object Schema$GooglePlayAnalytics {
  @scala.inline
  def apply(
    gclid: String = null,
    ...
    __obj.asInstanceOf[Schema$GooglePlayAnalytics]
  }
}
