...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p1beta1_NormalizedBoundingBox extends js.Object {
  /**
    * Bottom Y coordinate.
    */
...
object Schema$GoogleCloudVideointelligenceV1p1beta1_NormalizedBoundingBox {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p1beta1_NormalizedBoundingBox]
  }
}
