...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechTranscriptionConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechContext]] = js.native
}

object Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechTranscriptionConfig {
  @scala.inline
  def apply(
    ...
    speechContexts: js.Array[Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechContext] = null
  ): Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechTranscriptionConfig = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechTranscriptionConfig]
  }
}
