...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedBoundingPoly extends js.Object {
  /**
    * Normalized vertices of the bounding polygon.
    */
  var vertices: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedVertex]] = js.native
}

object Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedBoundingPoly {
  @scala.inline
  def apply(vertices: js.Array[Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedVertex] = null): Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedBoundingPoly = {
    val __obj = js.Dynamic.literal()
    if (vertices != null) __obj.updateDynamic("vertices")(vertices.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedBoundingPoly]
  }
}
