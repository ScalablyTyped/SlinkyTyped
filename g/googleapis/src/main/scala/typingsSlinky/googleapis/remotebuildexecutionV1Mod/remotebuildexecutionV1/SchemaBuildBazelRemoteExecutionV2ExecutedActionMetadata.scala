...
object SchemaBuildBazelRemoteExecutionV2ExecutedActionMetadata {
  ...
  @scala.inline
  implicit class SchemaBuildBazelRemoteExecutionV2ExecutedActionMetadataMutableBuilder[Self <: SchemaBuildBazelRemoteExecutionV2ExecutedActionMetadata] (val x: Self) extends AnyVal {
