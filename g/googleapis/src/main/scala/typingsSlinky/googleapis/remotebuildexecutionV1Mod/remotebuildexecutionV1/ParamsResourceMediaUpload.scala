...
object ParamsResourceMediaUpload {
  ...
  @scala.inline
  implicit class ParamsResourceMediaUploadOps[Self <: ParamsResourceMediaUpload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleBytestreamMedia): Self = this.set("requestBody", value.asInstanceOf[js.Any])
