...
object ParamsResourceProjectsTransferconfigsRunsTransferlogsList {
  ...
  def apply(
    ...
    fields: String = null,
    key: String = null,
    messageTypes: js.Array[String] = null,
  ...
  ): ParamsResourceProjectsTransferconfigsRunsTransferlogsList = {
    ...
    if (messageTypes != null) __obj.updateDynamic("messageTypes")(messageTypes.asInstanceOf[js.Any])
