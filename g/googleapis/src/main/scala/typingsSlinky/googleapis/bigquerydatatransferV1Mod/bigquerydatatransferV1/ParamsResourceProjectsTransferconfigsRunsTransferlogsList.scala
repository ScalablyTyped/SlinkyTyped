...
object ParamsResourceProjectsTransferconfigsRunsTransferlogsList {
  ...
  implicit class ParamsResourceProjectsTransferconfigsRunsTransferlogsListOps[Self <: ParamsResourceProjectsTransferconfigsRunsTransferlogsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMessageTypes(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("messageTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMessageTypes: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("messageTypes")(js.undefined)
        ret
    }
    @scala.inline
