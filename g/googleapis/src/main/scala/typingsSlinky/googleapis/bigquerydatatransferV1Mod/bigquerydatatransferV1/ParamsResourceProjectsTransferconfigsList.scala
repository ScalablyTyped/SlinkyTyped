...
object ParamsResourceProjectsTransferconfigsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsTransferconfigsListOps[Self <: ParamsResourceProjectsTransferconfigsList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDataSourceIds(value: js.Array[String]): Self = {
        val ret = this.duplicate
