...
@js.native
class ResourceProjectsLocationsTransferconfigsRunsTransferlogs protected () extends js.Object {
  ...
  def list(params: ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList, options: MethodOptions): GaxiosPromise[SchemaListTransferLogsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList,
