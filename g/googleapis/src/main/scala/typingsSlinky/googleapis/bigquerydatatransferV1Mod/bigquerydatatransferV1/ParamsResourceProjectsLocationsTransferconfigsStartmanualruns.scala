...
object ParamsResourceProjectsLocationsTransferconfigsStartmanualruns {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsTransferconfigsStartmanualruns = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTransferconfigsStartmanualruns]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsStartmanualrunsMutableBuilder[Self <: ParamsResourceProjectsLocationsTransferconfigsStartmanualruns] (val x: Self) extends AnyVal {
