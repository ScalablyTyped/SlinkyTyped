...
object ParamsResourceProjectsLocationsTransferconfigsStartmanualruns {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsStartmanualrunsOps[Self <: ParamsResourceProjectsLocationsTransferconfigsStartmanualruns] (val x: Self) extends AnyVal {
