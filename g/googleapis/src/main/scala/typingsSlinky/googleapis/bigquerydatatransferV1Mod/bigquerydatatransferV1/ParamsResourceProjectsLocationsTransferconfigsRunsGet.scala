...
object ParamsResourceProjectsLocationsTransferconfigsRunsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsTransferconfigsRunsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTransferconfigsRunsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsRunsGetMutableBuilder[Self <: ParamsResourceProjectsLocationsTransferconfigsRunsGet] (val x: Self) extends AnyVal {
