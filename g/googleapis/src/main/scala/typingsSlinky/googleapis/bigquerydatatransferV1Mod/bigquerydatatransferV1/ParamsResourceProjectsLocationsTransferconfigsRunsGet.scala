...
object ParamsResourceProjectsLocationsTransferconfigsRunsGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsRunsGetOps[Self <: ParamsResourceProjectsLocationsTransferconfigsRunsGet] (val x: Self) extends AnyVal {
