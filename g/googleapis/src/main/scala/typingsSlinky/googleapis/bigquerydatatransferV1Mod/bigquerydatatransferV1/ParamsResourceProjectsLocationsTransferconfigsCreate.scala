...
object ParamsResourceProjectsLocationsTransferconfigsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsTransferconfigsCreate] (val x: Self) extends AnyVal {
