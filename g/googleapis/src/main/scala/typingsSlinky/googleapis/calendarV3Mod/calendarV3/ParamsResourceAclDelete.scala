...
@js.native
trait ParamsResourceAclDelete extends StandardParameters {
...
object ParamsResourceAclDelete {
  
  @scala.inline
  def apply(): ParamsResourceAclDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAclDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceAclDeleteMutableBuilder[Self <: ParamsResourceAclDelete] (val x: Self) extends AnyVal {
