...
object ParamsResourceCalendarlistPatch {
  ...
  @scala.inline
  implicit class ParamsResourceCalendarlistPatchOps[Self <: ParamsResourceCalendarlistPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaCalendarListEntry): Self = {
        val ret = this.duplicate
