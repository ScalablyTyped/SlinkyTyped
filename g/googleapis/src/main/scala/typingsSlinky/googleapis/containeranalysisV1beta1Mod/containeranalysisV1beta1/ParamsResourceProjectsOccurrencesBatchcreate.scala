...
object ParamsResourceProjectsOccurrencesBatchcreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsOccurrencesBatchcreateOps[Self <: ParamsResourceProjectsOccurrencesBatchcreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchCreateOccurrencesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
