...
object SchemaBuildProvenance {
  ...
  implicit class SchemaBuildProvenanceOps[Self <: SchemaBuildProvenance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLogsUri(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("logsUri")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLogsUri: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("logsUri")(js.undefined)
        ret
    }
    @scala.inline
