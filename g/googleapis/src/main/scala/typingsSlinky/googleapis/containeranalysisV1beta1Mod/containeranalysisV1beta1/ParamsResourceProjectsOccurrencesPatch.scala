...
object ParamsResourceProjectsOccurrencesPatch {
  @scala.inline
  def apply(): ParamsResourceProjectsOccurrencesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsOccurrencesPatch]
  }
  @scala.inline
  implicit class ParamsResourceProjectsOccurrencesPatchOps[Self <: ParamsResourceProjectsOccurrencesPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaOccurrence): Self = {
        val ret = this.duplicate
