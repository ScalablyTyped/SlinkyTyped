...
object ParamsResourceProjectsOccurrencesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsOccurrencesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsOccurrencesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsOccurrencesDeleteMutableBuilder[Self <: ParamsResourceProjectsOccurrencesDelete] (val x: Self) extends AnyVal {
