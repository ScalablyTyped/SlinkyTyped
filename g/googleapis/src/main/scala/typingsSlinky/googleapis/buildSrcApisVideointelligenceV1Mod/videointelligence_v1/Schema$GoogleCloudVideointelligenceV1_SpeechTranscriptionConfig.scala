...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1_SpeechTranscriptionConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1_SpeechContext]] = js.native
}

object Schema$GoogleCloudVideointelligenceV1_SpeechTranscriptionConfig {
  @scala.inline
  def apply(
    ...
    speechContexts: js.Array[Schema$GoogleCloudVideointelligenceV1_SpeechContext] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1_SpeechTranscriptionConfig]
  }
}
