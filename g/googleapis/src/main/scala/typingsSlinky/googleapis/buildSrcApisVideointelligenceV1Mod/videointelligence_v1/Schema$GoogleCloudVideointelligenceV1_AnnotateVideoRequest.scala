...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1_AnnotateVideoRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var videoContext: js.UndefOr[Schema$GoogleCloudVideointelligenceV1_VideoContext] = js.native
}

object Schema$GoogleCloudVideointelligenceV1_AnnotateVideoRequest {
  @scala.inline
  def apply(
    ...
    videoContext: Schema$GoogleCloudVideointelligenceV1_VideoContext = null
  ): Schema$GoogleCloudVideointelligenceV1_AnnotateVideoRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1_AnnotateVideoRequest]
  }
}
