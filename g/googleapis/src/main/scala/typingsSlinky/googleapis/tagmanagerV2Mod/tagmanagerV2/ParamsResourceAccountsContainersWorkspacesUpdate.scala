...
object ParamsResourceAccountsContainersWorkspacesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesUpdateOps[Self <: ParamsResourceAccountsContainersWorkspacesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaWorkspace): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
