...
object ParamsResourceAccountsContainersWorkspacesFoldersRevert {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesFoldersRevertMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesFoldersRevert] (val x: Self) extends AnyVal {
