...
object ParamsResourceAccountsContainersWorkspacesZonesRevert {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesZonesRevertOps[Self <: ParamsResourceAccountsContainersWorkspacesZonesRevert] (val x: Self) extends AnyVal {
    @scala.inline
