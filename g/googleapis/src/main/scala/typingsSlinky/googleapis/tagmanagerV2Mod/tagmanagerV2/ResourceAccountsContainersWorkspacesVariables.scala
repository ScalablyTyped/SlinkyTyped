...
@js.native
class ResourceAccountsContainersWorkspacesVariables protected () extends StObject {
  ...
  def revert(params: js.UndefOr[scala.Nothing], options: MethodOptions): GaxiosPromise[SchemaRevertVariableResponse] = js.native
