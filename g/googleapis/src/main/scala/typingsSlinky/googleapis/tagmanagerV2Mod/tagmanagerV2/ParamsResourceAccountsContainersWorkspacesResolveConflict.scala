...
object ParamsResourceAccountsContainersWorkspacesResolveConflict {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesResolveConflictOps[Self <: ParamsResourceAccountsContainersWorkspacesResolveConflict] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaEntity): Self = this.set("requestBody", value.asInstanceOf[js.Any])
