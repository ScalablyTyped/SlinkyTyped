...
object ParamsResourceAccountsContainersWorkspacesZonesGet {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesZonesGetOps[Self <: ParamsResourceAccountsContainersWorkspacesZonesGet] (val x: Self) extends AnyVal {
