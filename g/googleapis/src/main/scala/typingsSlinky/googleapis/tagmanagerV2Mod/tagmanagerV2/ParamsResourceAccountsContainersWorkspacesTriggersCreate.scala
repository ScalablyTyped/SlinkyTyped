...
object ParamsResourceAccountsContainersWorkspacesTriggersCreate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesTriggersCreateMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesTriggersCreate] (val x: Self) extends AnyVal {
