...
object ParamsResourceAccountsContainersWorkspacesZonesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesZonesDeleteOps[Self <: ParamsResourceAccountsContainersWorkspacesZonesDelete] (val x: Self) extends AnyVal {
    @scala.inline
