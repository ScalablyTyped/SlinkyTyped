...
object ParamsResourceAccountsContainersEnvironmentsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersEnvironmentsCreateMutableBuilder[Self <: ParamsResourceAccountsContainersEnvironmentsCreate] (val x: Self) extends AnyVal {
