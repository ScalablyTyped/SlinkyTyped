...
object ParamsResourceAccountsContainersVersionHeadersList {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersVersionHeadersListOps[Self <: ParamsResourceAccountsContainersVersionHeadersList] (val x: Self) extends AnyVal {
    @scala.inline
