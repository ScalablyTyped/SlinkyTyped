...
object ParamsResourceAccountsContainersWorkspacesTriggersRevert {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesTriggersRevertOps[Self <: ParamsResourceAccountsContainersWorkspacesTriggersRevert] (val x: Self) extends AnyVal {
    @scala.inline
