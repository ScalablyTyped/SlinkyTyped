...
@js.native
trait ParamsResourceAccountsContainersWorkspacesVariablesDelete extends StandardParameters {
  /**
...
object ParamsResourceAccountsContainersWorkspacesVariablesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesVariablesDeleteOps[Self <: ParamsResourceAccountsContainersWorkspacesVariablesDelete] (val x: Self) extends AnyVal {
    @scala.inline
