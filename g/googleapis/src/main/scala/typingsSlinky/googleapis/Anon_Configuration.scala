...
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$ErrorProto
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$JobConfiguration
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$JobReference
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$JobStatistics
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$JobStatus
