...
@js.native
trait ParamsDollarResourceDollarPoolsDollarResize extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPoolsDollarResize {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarPoolsDollarResize = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPoolsDollarResize]
  }
}
