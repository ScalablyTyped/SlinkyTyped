...
@js.native
trait ParamsDollarResourceDollarReplicasDollarRestart extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarReplicasDollarRestart {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarReplicasDollarRestart = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReplicasDollarRestart]
  }
}
