package typingsSlinky.googleapis.buildSrcApisReplicapoolV1beta1Mod.replicapool_v1beta1
...
@js.native
trait ParamsDollarResourceDollarReplicasDollarDelete extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$ReplicasDeleteRequest] = js.native
  /**
...
object ParamsDollarResourceDollarReplicasDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$ReplicasDeleteRequest = null,
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarReplicasDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReplicasDollarDelete]
  }
}
