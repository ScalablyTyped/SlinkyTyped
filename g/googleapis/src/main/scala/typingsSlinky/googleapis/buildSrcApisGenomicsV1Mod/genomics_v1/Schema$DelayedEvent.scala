...
/**
  ...
  */
@js.native
trait Schema$DelayedEvent extends js.Object {
  /**
...
object Schema$DelayedEvent {
  @scala.inline
  def apply(cause: String = null, metrics: js.Array[String] = null): Schema$DelayedEvent = {
    val __obj = js.Dynamic.literal()
    if (cause != null) __obj.updateDynamic("cause")(cause.asInstanceOf[js.Any])
    if (metrics != null) __obj.updateDynamic("metrics")(metrics.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$DelayedEvent]
  }
}
