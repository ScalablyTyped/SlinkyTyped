...
/**
  ...
  */
@js.native
trait SchemaOperationMetadataV1Alpha extends StObject {
...
object SchemaOperationMetadataV1Alpha {
  ...
  @scala.inline
  implicit class SchemaOperationMetadataV1AlphaMutableBuilder[Self <: SchemaOperationMetadataV1Alpha] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCreateVersionMetadata(value: SchemaCreateVersionMetadataV1Alpha): Self = StObject.set(x, "createVersionMetadata", value.asInstanceOf[js.Any])
