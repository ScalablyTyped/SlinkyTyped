...
object ParamsResourceAppsOperationsGet {
  ...
  implicit class ParamsResourceAppsOperationsGetOps[Self <: ParamsResourceAppsOperationsGet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOperationsId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("operationsId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOperationsId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("operationsId")(js.undefined)
        ret
    }
  }
