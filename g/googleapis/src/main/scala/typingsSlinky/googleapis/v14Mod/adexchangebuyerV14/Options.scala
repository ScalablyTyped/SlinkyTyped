...
import typingsSlinky.gaxios.commonMod.Headers
import typingsSlinky.gaxios.commonMod.RetryConfig
...
import typingsSlinky.googleapis.googleapisStrings.v1_4
import typingsSlinky.googleapisCommon.apiMod.GlobalOptions
import typingsSlinky.googleapisCommon.apiMod.UserAgentDirective
