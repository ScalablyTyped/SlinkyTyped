...
object ParamsResourceMarketplacenotesInsert {
  ...
  @scala.inline
  implicit class ParamsResourceMarketplacenotesInsertOps[Self <: ParamsResourceMarketplacenotesInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaAddOrderNotesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
