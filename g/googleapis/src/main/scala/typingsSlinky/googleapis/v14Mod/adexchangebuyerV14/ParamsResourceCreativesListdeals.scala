...
@js.native
trait ParamsResourceCreativesListdeals extends StandardParameters {
  /**
...
object ParamsResourceCreativesListdeals {
  ...
  @scala.inline
  implicit class ParamsResourceCreativesListdealsOps[Self <: ParamsResourceCreativesListdeals] (val x: Self) extends AnyVal {
    @scala.inline
