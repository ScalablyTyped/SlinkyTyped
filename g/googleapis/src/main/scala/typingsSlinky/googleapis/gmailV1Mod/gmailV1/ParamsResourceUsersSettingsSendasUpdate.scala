...
@js.native
trait ParamsResourceUsersSettingsSendasUpdate extends StandardParameters {
  /**
...
object ParamsResourceUsersSettingsSendasUpdate {
  @scala.inline
  def apply(): ParamsResourceUsersSettingsSendasUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersSettingsSendasUpdate]
  }
  @scala.inline
  implicit class ParamsResourceUsersSettingsSendasUpdateOps[Self <: ParamsResourceUsersSettingsSendasUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaSendAs): Self = {
        val ret = this.duplicate
