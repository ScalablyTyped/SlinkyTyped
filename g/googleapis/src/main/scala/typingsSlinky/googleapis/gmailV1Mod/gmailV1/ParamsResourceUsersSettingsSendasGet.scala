...
@js.native
trait ParamsResourceUsersSettingsSendasGet extends StandardParameters {
...
object ParamsResourceUsersSettingsSendasGet {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersSettingsSendasGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersSettingsSendasGet]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersSettingsSendasGetMutableBuilder[Self <: ParamsResourceUsersSettingsSendasGet] (val x: Self) extends AnyVal {
