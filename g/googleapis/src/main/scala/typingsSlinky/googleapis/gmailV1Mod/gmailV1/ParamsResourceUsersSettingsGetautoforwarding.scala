...
@js.native
trait ParamsResourceUsersSettingsGetautoforwarding extends StandardParameters {
  /**
...
object ParamsResourceUsersSettingsGetautoforwarding {
  ...
  @scala.inline
  implicit class ParamsResourceUsersSettingsGetautoforwardingOps[Self <: ParamsResourceUsersSettingsGetautoforwarding] (val x: Self) extends AnyVal {
    @scala.inline
