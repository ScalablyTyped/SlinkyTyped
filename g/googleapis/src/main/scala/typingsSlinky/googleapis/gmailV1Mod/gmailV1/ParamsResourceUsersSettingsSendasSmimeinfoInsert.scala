...
@js.native
trait ParamsResourceUsersSettingsSendasSmimeinfoInsert extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaSmimeInfo] = js.native
...
object ParamsResourceUsersSettingsSendasSmimeinfoInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersSettingsSendasSmimeinfoInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersSettingsSendasSmimeinfoInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersSettingsSendasSmimeinfoInsertMutableBuilder[Self <: ParamsResourceUsersSettingsSendasSmimeinfoInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSmimeInfo): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
