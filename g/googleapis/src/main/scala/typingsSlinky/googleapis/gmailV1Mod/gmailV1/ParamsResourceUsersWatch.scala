...
trait ParamsResourceUsersWatch extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaWatchRequest] = js.native
...
object ParamsResourceUsersWatch {
  ...
  implicit class ParamsResourceUsersWatchMutableBuilder[Self <: ParamsResourceUsersWatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaWatchRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
