...
@js.native
trait ParamsResourceUsersSettingsDelegatesDelete extends StandardParameters {
...
object ParamsResourceUsersSettingsDelegatesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersSettingsDelegatesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersSettingsDelegatesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersSettingsDelegatesDeleteMutableBuilder[Self <: ParamsResourceUsersSettingsDelegatesDelete] (val x: Self) extends AnyVal {
