...
object ParamsResourceUsersDraftsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceUsersDraftsUpdateOps[Self <: ParamsResourceUsersDraftsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaDraft): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
