...
@js.native
trait Schema$SiteVerificationWebResourceGettokenResponse extends js.Object {
  /**
...
object Schema$SiteVerificationWebResourceGettokenResponse {
  @scala.inline
  def apply(method: String = null, token: String = null): Schema$SiteVerificationWebResourceGettokenResponse = {
    val __obj = js.Dynamic.literal()
    if (method != null) __obj.updateDynamic("method")(method.asInstanceOf[js.Any])
    if (token != null) __obj.updateDynamic("token")(token.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$SiteVerificationWebResourceGettokenResponse]
  }
}
