...
/**
  ...
  */
@js.native
trait Schema$Breakpoint extends js.Object {
  /**
  ...
  /**
    ...
    */
  var evaluatedExpressions: js.UndefOr[js.Array[Schema$Variable]] = js.native
  /**
  ...
  /**
    ...
    */
  var stackFrames: js.UndefOr[js.Array[Schema$StackFrame]] = js.native
  /**
    ...
    * condition
    */
  var status: js.UndefOr[Schema$StatusMessage] = js.native
  /**
  ...
  /**
    ...
    */
  var variableTable: js.UndefOr[js.Array[Schema$Variable]] = js.native
}

object Schema$Breakpoint {
  @scala.inline
  def apply(
    action: String = null,
    condition: String = null,
    createTime: String = null,
    evaluatedExpressions: js.Array[Schema$Variable] = null,
    ...
    stackFrames: js.Array[Schema$StackFrame] = null,
    status: Schema$StatusMessage = null,
    userEmail: String = null,
    variableTable: js.Array[Schema$Variable] = null
  ): Schema$Breakpoint = {
    ...
    __obj.asInstanceOf[Schema$Breakpoint]
  }
}
