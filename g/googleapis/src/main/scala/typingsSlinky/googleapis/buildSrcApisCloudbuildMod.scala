...
import typingsSlinky.googleapis.buildSrcApisCloudbuildV1Mod.cloudbuild_v1.Cloudbuild
import typingsSlinky.googleapis.buildSrcApisCloudbuildV1Mod.cloudbuild_v1.Options
...
object buildSrcApisCloudbuildMod extends js.Object {
  ...
  def cloudbuild(options: typingsSlinky.googleapis.buildSrcApisCloudbuildV1alpha1Mod.cloudbuild_v1alpha1.Options): typingsSlinky.googleapis.buildSrcApisCloudbuildV1alpha1Mod.cloudbuild_v1alpha1.Cloudbuild = js.native
  @JSName("cloudbuild")
  def cloudbuild_v1(version: v1): Cloudbuild = js.native
  @JSName("cloudbuild")
  def cloudbuild_v1alpha1(version: v1alpha1): typingsSlinky.googleapis.buildSrcApisCloudbuildV1alpha1Mod.cloudbuild_v1alpha1.Cloudbuild = js.native
  @js.native
  object VERSIONS extends js.Object {
    ...
    class v1alpha1 protected ()
      extends typingsSlinky.googleapis.buildSrcApisCloudbuildV1alpha1Mod.cloudbuild_v1alpha1.Cloudbuild {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v1alpha1
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisCloudbuildV1alpha1Mod.cloudbuild_v1alpha1.Cloudbuild
              ]
            ]
