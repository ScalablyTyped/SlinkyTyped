...
import typingsSlinky.googleapis.binaryauthorizationV1beta1Mod.binaryauthorizationV1beta1.Options
...
object binaryauthorizationMod {
  ...
  object VERSIONS {
    ...
    @JSImport("googleapis/build/src/apis/binaryauthorization", "VERSIONS")
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/binaryauthorization", "VERSIONS.v1beta1")
    @js.native
  ...
  object auth extends Shortcut {
    ...
    @JSImport("googleapis/build/src/apis/binaryauthorization", "auth")
    @js.native
    val ^ : AuthPlus = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/binaryauthorization", "auth.Compute")
    @js.native
    /**
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/binaryauthorization", "auth.JWT")
    @js.native
    class JWT protected ()
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/binaryauthorization", "auth.OAuth2")
    @js.native
    /**
