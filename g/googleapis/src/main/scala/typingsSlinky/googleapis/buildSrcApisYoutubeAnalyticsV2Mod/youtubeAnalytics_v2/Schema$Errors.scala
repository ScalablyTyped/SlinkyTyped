...
trait Schema$Errors extends js.Object {
  ...
  /**
    ...
    */
  var error: js.UndefOr[js.Array[Schema$ErrorProto]] = js.native
  /**
...
object Schema$Errors {
  @scala.inline
  def apply(code: String = null, error: js.Array[Schema$ErrorProto] = null, requestId: String = null): Schema$Errors = {
