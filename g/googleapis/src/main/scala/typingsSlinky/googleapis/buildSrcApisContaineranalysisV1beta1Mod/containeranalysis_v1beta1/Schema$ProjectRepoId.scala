...
/**
  ...
  */
@js.native
trait Schema$ProjectRepoId extends js.Object {
  /**
...
object Schema$ProjectRepoId {
  @scala.inline
  def apply(projectId: String = null, repoName: String = null): Schema$ProjectRepoId = {
    val __obj = js.Dynamic.literal()
    if (projectId != null) __obj.updateDynamic("projectId")(projectId.asInstanceOf[js.Any])
    if (repoName != null) __obj.updateDynamic("repoName")(repoName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ProjectRepoId]
  }
}
