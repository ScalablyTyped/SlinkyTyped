...
@js.native
trait ParamsDollarResourceDollarProjectsDollarOccurrencesDollarBatchcreate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$BatchCreateOccurrencesRequest] = js.native
}
