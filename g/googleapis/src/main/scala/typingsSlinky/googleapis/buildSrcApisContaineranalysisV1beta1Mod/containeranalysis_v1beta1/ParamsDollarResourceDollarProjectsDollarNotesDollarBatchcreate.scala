...
@js.native
trait ParamsDollarResourceDollarProjectsDollarNotesDollarBatchcreate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$BatchCreateNotesRequest] = js.native
}
