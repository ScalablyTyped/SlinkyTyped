...
object ParamsResourceProjectsLocationsClustersSetlocations {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsClustersSetlocations = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClustersSetlocations]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersSetlocationsMutableBuilder[Self <: ParamsResourceProjectsLocationsClustersSetlocations] (val x: Self) extends AnyVal {
