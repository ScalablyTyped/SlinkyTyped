...
/**
  ...
  */
@js.native
trait SchemaSetLegacyAbacRequest extends StObject {
...
object SchemaSetLegacyAbacRequest {
  ...
  @scala.inline
  implicit class SchemaSetLegacyAbacRequestMutableBuilder[Self <: SchemaSetLegacyAbacRequest] (val x: Self) extends AnyVal {
