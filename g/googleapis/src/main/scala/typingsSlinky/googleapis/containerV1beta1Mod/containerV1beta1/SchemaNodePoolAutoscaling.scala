...
object SchemaNodePoolAutoscaling {
  ...
  implicit class SchemaNodePoolAutoscalingOps[Self <: SchemaNodePoolAutoscaling] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAutoprovisioned(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autoprovisioned")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAutoprovisioned: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autoprovisioned")(js.undefined)
        ret
    }
    @scala.inline
