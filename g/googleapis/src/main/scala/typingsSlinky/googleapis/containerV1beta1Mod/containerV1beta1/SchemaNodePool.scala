...
object SchemaNodePool {
  ...
  implicit class SchemaNodePoolOps[Self <: SchemaNodePool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxPodsConstraint(value: SchemaMaxPodsConstraint): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxPodsConstraint")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMaxPodsConstraint: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxPodsConstraint")(js.undefined)
        ret
    }
    @scala.inline
