...
@js.native
trait ParamsResourceProjectsLocationsClustersNodepoolsGet extends StandardParameters {
...
object ParamsResourceProjectsLocationsClustersNodepoolsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsClustersNodepoolsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClustersNodepoolsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsGetMutableBuilder[Self <: ParamsResourceProjectsLocationsClustersNodepoolsGet] (val x: Self) extends AnyVal {
