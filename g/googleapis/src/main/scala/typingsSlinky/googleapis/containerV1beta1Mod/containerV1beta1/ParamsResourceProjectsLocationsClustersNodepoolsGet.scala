...
object ParamsResourceProjectsLocationsClustersNodepoolsGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsGetOps[Self <: ParamsResourceProjectsLocationsClustersNodepoolsGet] (val x: Self) extends AnyVal {
