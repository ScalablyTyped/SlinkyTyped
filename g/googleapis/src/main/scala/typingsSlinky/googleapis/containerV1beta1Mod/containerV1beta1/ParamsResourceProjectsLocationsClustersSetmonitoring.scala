...
@js.native
trait ParamsResourceProjectsLocationsClustersSetmonitoring extends StandardParameters {
  /**
...
object ParamsResourceProjectsLocationsClustersSetmonitoring {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersSetmonitoringOps[Self <: ParamsResourceProjectsLocationsClustersSetmonitoring] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSetMonitoringServiceRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
