...
object ParamsResourceProjectsLocationsClustersSetresourcelabels {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersSetresourcelabelsMutableBuilder[Self <: ParamsResourceProjectsLocationsClustersSetresourcelabels] (val x: Self) extends AnyVal {
