...
object ParamsResourceProjectsLocationsClustersSetmasterauth {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsClustersSetmasterauth = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClustersSetmasterauth]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersSetmasterauthMutableBuilder[Self <: ParamsResourceProjectsLocationsClustersSetmasterauth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSetMasterAuthRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
