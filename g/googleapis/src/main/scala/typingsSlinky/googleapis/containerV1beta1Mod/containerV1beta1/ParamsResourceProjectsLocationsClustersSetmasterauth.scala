...
object ParamsResourceProjectsLocationsClustersSetmasterauth {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersSetmasterauthOps[Self <: ParamsResourceProjectsLocationsClustersSetmasterauth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSetMasterAuthRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
