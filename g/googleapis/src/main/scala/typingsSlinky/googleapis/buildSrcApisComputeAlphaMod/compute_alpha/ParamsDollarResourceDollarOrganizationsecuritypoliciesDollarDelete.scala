...
@js.native
trait ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarDelete]
  }
}
