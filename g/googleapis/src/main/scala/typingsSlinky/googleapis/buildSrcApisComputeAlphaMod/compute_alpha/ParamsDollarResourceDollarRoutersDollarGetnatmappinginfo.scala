...
@js.native
trait ParamsDollarResourceDollarRoutersDollarGetnatmappinginfo extends StandardParameters {
  /**
  ...
  /**
    ...
    * to RFC1035.
    */
  var natName: js.UndefOr[String] = js.native
  /**
...
object ParamsDollarResourceDollarRoutersDollarGetnatmappinginfo {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    router: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarRoutersDollarGetnatmappinginfo = {
    ...
    if (natName != null) __obj.updateDynamic("natName")(natName.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRoutersDollarGetnatmappinginfo]
  }
}
