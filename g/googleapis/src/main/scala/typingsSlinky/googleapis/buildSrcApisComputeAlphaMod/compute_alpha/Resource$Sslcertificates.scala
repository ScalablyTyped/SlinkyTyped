...
class Resource$Sslcertificates protected () extends js.Object {
  ...
  /**
    ...
    */
  def aggregatedList(): GaxiosPromise[Schema$SslCertificateAggregatedList] = js.native
  def aggregatedList(callback: BodyResponseCallback[Schema$SslCertificateAggregatedList]): Unit = js.native
  def aggregatedList(params: ParamsDollarResourceDollarSslcertificatesDollarAggregatedlist): GaxiosPromise[Schema$SslCertificateAggregatedList] = js.native
  def aggregatedList(
    params: ParamsDollarResourceDollarSslcertificatesDollarAggregatedlist,
    callback: BodyResponseCallback[Schema$SslCertificateAggregatedList]
  ): Unit = js.native
  def aggregatedList(
    params: ParamsDollarResourceDollarSslcertificatesDollarAggregatedlist,
    options: BodyResponseCallback[Schema$SslCertificateAggregatedList],
    callback: BodyResponseCallback[Schema$SslCertificateAggregatedList]
  ): Unit = js.native
  def aggregatedList(params: ParamsDollarResourceDollarSslcertificatesDollarAggregatedlist, options: MethodOptions): GaxiosPromise[Schema$SslCertificateAggregatedList] = js.native
  def aggregatedList(
    params: ParamsDollarResourceDollarSslcertificatesDollarAggregatedlist,
