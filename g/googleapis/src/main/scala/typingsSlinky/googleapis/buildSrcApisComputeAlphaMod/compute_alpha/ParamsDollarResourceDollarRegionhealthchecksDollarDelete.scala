...
@js.native
trait ParamsDollarResourceDollarRegionhealthchecksDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRegionhealthchecksDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarRegionhealthchecksDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRegionhealthchecksDollarDelete]
  }
}
