...
@js.native
trait ParamsDollarResourceDollarNetworksDollarListipaddresses extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarNetworksDollarListipaddresses {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    types: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarNetworksDollarListipaddresses = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarNetworksDollarListipaddresses]
  }
}
