...
/**
  ...
  */
@js.native
trait Schema$AutoscalingPolicyQueueBasedScaling extends js.Object {
  /**
  ...
  /**
    ...
    */
  var cloudPubSub: js.UndefOr[Schema$AutoscalingPolicyQueueBasedScalingCloudPubSub] = js.native
  /**
...
object Schema$AutoscalingPolicyQueueBasedScaling {
  @scala.inline
  def apply(
    acceptableBacklogPerInstance: Int | Double = null,
    cloudPubSub: Schema$AutoscalingPolicyQueueBasedScalingCloudPubSub = null,
    singleWorkerThroughputPerSec: Int | Double = null
  ): Schema$AutoscalingPolicyQueueBasedScaling = {
    ...
    __obj.asInstanceOf[Schema$AutoscalingPolicyQueueBasedScaling]
  }
}
