...
@js.native
trait ParamsDollarResourceDollarRegiondisksDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRegiondisksDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarRegiondisksDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRegiondisksDollarDelete]
  }
}
