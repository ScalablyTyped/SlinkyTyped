...
/**
  ...
  */
@js.native
trait Schema$OutlierDetection extends js.Object {
  /**
    * The base time that a host is ejected for. The real time is equal to the
    * base time multiplied by the number of times the host has been ejected.
    * Defaults to 30000ms or 30s.
    */
  var baseEjectionTime: js.UndefOr[Schema$Duration] = js.native
  /**
  ...
  /**
    ...
    * seconds.
    */
  var interval: js.UndefOr[Schema$Duration] = js.native
  /**
...
object Schema$OutlierDetection {
  @scala.inline
  def apply(
    baseEjectionTime: Schema$Duration = null,
    ...
    __obj.asInstanceOf[Schema$OutlierDetection]
  }
}
