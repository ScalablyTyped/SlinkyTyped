...
/**
  ...
  */
@js.native
trait Schema$SslPolicy extends js.Object {
  /**
  ...
  /**
    ...
    */
  var tlsSettings: js.UndefOr[Schema$ServerTlsSettings] = js.native
  /**
...
object Schema$SslPolicy {
  ...
  def apply(
    ...
    tlsSettings: Schema$ServerTlsSettings = null,
    ...
    __obj.asInstanceOf[Schema$SslPolicy]
  }
}
