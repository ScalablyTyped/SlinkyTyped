...
/**
  ...
  */
@js.native
trait Schema$SslCertificateSelfManagedSslCertificate extends js.Object {
  /**
...
object Schema$SslCertificateSelfManagedSslCertificate {
  @scala.inline
  def apply(certificate: String = null, privateKey: String = null): Schema$SslCertificateSelfManagedSslCertificate = {
    val __obj = js.Dynamic.literal()
    if (certificate != null) __obj.updateDynamic("certificate")(certificate.asInstanceOf[js.Any])
    if (privateKey != null) __obj.updateDynamic("privateKey")(privateKey.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$SslCertificateSelfManagedSslCertificate]
  }
}
