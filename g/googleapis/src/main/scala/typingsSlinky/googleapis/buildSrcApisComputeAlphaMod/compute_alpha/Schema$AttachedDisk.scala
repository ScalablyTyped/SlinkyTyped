...
/**
  ...
  */
@js.native
trait Schema$AttachedDisk extends js.Object {
  /**
  ...
  /**
    ...
    */
  var initializeParams: js.UndefOr[Schema$AttachedDiskInitializeParams] = js.native
  /**
  ...
  /**
    ...
    */
  var shieldedInstanceInitialState: js.UndefOr[Schema$InitialStateConfig] = js.native
  /**
...
object Schema$AttachedDisk {
  @scala.inline
  def apply(
    autoDelete: js.UndefOr[Boolean] = js.undefined,
    boot: js.UndefOr[Boolean] = js.undefined,
    deviceName: String = null,
    diskEncryptionKey: Schema$CustomerEncryptionKey = null,
    diskSizeGb: String = null,
    guestOsFeatures: js.Array[Schema$GuestOsFeature] = null,
    index: Int | Double = null,
    initializeParams: Schema$AttachedDiskInitializeParams = null,
    interface: String = null,
    kind: String = null,
    licenses: js.Array[String] = null,
    mode: String = null,
    savedState: String = null,
    shieldedInstanceInitialState: Schema$InitialStateConfig = null,
    source: String = null,
    `type`: String = null
  ): Schema$AttachedDisk = {
    ...
    __obj.asInstanceOf[Schema$AttachedDisk]
  }
}
