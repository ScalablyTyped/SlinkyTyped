...
/**
  ...
  */
@js.native
trait Schema$ServerTlsSettings extends js.Object {
  /**
    * Configures the mechanism to obtain security certificates and identity
    * information.
    */
  var proxyTlsContext: js.UndefOr[Schema$TlsContext] = js.native
  /**
...
object Schema$ServerTlsSettings {
  @scala.inline
  def apply(
    proxyTlsContext: Schema$TlsContext = null,
    subjectAltNames: js.Array[String] = null,
    tlsMode: String = null
  ): Schema$ServerTlsSettings = {
    ...
    __obj.asInstanceOf[Schema$ServerTlsSettings]
  }
}
