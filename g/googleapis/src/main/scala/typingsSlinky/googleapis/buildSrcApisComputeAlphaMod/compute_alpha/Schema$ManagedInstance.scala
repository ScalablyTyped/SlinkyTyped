...
/**
  ...
  */
@js.native
trait Schema$ManagedInstance extends js.Object {
  /**
  ...
  /**
    ...
    */
  var instanceHealth: js.UndefOr[js.Array[Schema$ManagedInstanceInstanceHealth]] = js.native
  /**
  ...
  /**
    ...
    * instance.
    */
  var lastAttempt: js.UndefOr[Schema$ManagedInstanceLastAttempt] = js.native
  /**
  ...
  /**
    ...
    * instance.
    */
  var preservedStateFromConfig: js.UndefOr[Schema$PreservedState] = js.native
  /**
    * [Output Only] Preserved state generated based on stateful policy for this
    * instance.
    */
  var preservedStateFromPolicy: js.UndefOr[Schema$PreservedState] = js.native
  /**
  ...
  /**
    ...
    */
  var version: js.UndefOr[Schema$ManagedInstanceVersion] = js.native
}

object Schema$ManagedInstance {
  @scala.inline
  def apply(
    currentAction: String = null,
    id: String = null,
    instance: String = null,
    instanceHealth: js.Array[Schema$ManagedInstanceInstanceHealth] = null,
    instanceStatus: String = null,
    instanceTemplate: String = null,
    lastAttempt: Schema$ManagedInstanceLastAttempt = null,
    `override`: Schema$ManagedInstanceOverride = null,
    preservedStateFromConfig: Schema$PreservedState = null,
    preservedStateFromPolicy: Schema$PreservedState = null,
    tag: String = null,
    version: Schema$ManagedInstanceVersion = null
    ...
    __obj.asInstanceOf[Schema$ManagedInstance]
  }
}
