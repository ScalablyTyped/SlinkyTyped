...
@js.native
trait ParamsDollarResourceDollarRoutersDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRoutersDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    router: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarRoutersDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRoutersDollarUpdate]
  }
}
