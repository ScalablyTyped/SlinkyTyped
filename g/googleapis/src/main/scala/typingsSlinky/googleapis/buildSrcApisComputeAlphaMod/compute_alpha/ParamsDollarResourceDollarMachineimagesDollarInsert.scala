...
@js.native
trait ParamsDollarResourceDollarMachineimagesDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$MachineImage] = js.native
  /**
...
object ParamsDollarResourceDollarMachineimagesDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$MachineImage = null,
    requestId: String = null,
    sourceInstance: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarMachineimagesDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMachineimagesDollarInsert]
  }
}
