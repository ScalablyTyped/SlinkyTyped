...
/**
  ...
  */
@js.native
trait Schema$BackendService extends js.Object {
  /**
  ...
  /**
    ...
    */
  var appEngineBackend: js.UndefOr[Schema$BackendServiceAppEngineBackend] = js.native
  /**
    * The list of backends that serve this BackendService.
    */
  var backends: js.UndefOr[js.Array[Schema$Backend]] = js.native
  /**
    * Cloud CDN configuration for this BackendService.
    */
  var cdnPolicy: js.UndefOr[Schema$BackendServiceCdnPolicy] = js.native
  /**
    ...
    */
  var circuitBreakers: js.UndefOr[Schema$CircuitBreakers] = js.native
  /**
    * Directs request to a cloud function. appEngineBackend and backends[] must
    * be empty if this is set.
    */
  var cloudFunctionBackend: js.UndefOr[Schema$BackendServiceCloudFunctionBackend] = js.native
  var connectionDraining: js.UndefOr[Schema$ConnectionDraining] = js.native
  /**
    ...
    * load_balancing_scheme set to INTERNAL_SELF_MANAGED.
    */
  var consistentHash: js.UndefOr[Schema$ConsistentHashLoadBalancerSettings] = js.native
  /**
  ...
  var failoverPolicy: js.UndefOr[Schema$BackendServiceFailoverPolicy] = js.native
  /**
  ...
  var iap: js.UndefOr[Schema$BackendServiceIAP] = js.native
  /**
  ...
  /**
    ...
    */
  var logConfig: js.UndefOr[Schema$BackendServiceLogConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var outlierDetection: js.UndefOr[Schema$OutlierDetection] = js.native
  /**
  ...
  /**
    ...
    * service with the load_balancing_scheme set to INTERNAL_SELF_MANAGED.
    */
  var securitySettings: js.UndefOr[Schema$SecuritySettings] = js.native
  /**
...
object Schema$BackendService {
  @scala.inline
  def apply(
    affinityCookieTtlSec: Int | Double = null,
    appEngineBackend: Schema$BackendServiceAppEngineBackend = null,
    backends: js.Array[Schema$Backend] = null,
    cdnPolicy: Schema$BackendServiceCdnPolicy = null,
    circuitBreakers: Schema$CircuitBreakers = null,
    cloudFunctionBackend: Schema$BackendServiceCloudFunctionBackend = null,
    connectionDraining: Schema$ConnectionDraining = null,
    consistentHash: Schema$ConsistentHashLoadBalancerSettings = null,
    creationTimestamp: String = null,
    customRequestHeaders: js.Array[String] = null,
    description: String = null,
    enableCDN: js.UndefOr[Boolean] = js.undefined,
    failoverPolicy: Schema$BackendServiceFailoverPolicy = null,
    fingerprint: String = null,
    healthChecks: js.Array[String] = null,
    iap: Schema$BackendServiceIAP = null,
    id: String = null,
    kind: String = null,
    loadBalancingScheme: String = null,
    localityLbPolicy: String = null,
    logConfig: Schema$BackendServiceLogConfig = null,
    name: String = null,
    outlierDetection: Schema$OutlierDetection = null,
    port: Int | Double = null,
    portName: String = null,
    protocol: String = null,
    region: String = null,
    securityPolicy: String = null,
    securitySettings: Schema$SecuritySettings = null,
    ...
    __obj.asInstanceOf[Schema$BackendService]
  }
}
