...
@js.native
trait Schema$InstanceGroupManagerActionsSummary extends js.Object {
  /**
...
object Schema$InstanceGroupManagerActionsSummary {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$InstanceGroupManagerActionsSummary]
  }
}
