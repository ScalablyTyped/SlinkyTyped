...
/**
  ...
  */
@js.native
trait Schema$Jwt extends js.Object {
  /**
  ...
  /**
    ...
    */
  var jwtHeaders: js.UndefOr[js.Array[Schema$JwtHeader]] = js.native
  /**
...
object Schema$Jwt {
  ...
  def apply(
    ...
    jwtHeaders: js.Array[Schema$JwtHeader] = null,
