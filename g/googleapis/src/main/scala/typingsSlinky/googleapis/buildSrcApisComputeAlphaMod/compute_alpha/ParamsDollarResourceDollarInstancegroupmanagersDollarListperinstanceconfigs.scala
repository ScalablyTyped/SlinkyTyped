...
@js.native
trait ParamsDollarResourceDollarInstancegroupmanagersDollarListperinstanceconfigs extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstancegroupmanagersDollarListperinstanceconfigs {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarInstancegroupmanagersDollarListperinstanceconfigs = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstancegroupmanagersDollarListperinstanceconfigs]
  }
}
