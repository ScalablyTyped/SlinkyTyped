...
/**
  ...
  */
@js.native
trait Schema$BackendServiceIAP extends js.Object {
  ...
  /**
    ...
    * for IAP.
    */
  var oauth2ClientInfo: js.UndefOr[Schema$BackendServiceIAPOAuth2ClientInfo] = js.native
...
object Schema$BackendServiceIAP {
  @scala.inline
  def apply(
    enabled: js.UndefOr[Boolean] = js.undefined,
    oauth2ClientId: String = null,
    oauth2ClientInfo: Schema$BackendServiceIAPOAuth2ClientInfo = null,
    ...
    __obj.asInstanceOf[Schema$BackendServiceIAP]
  }
}
