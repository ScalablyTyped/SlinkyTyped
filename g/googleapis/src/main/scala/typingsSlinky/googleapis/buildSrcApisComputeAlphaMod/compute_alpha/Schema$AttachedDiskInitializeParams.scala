...
/**
  ...
  */
@js.native
trait Schema$AttachedDiskInitializeParams extends js.Object {
  /**
  ...
  /**
    ...
    */
  var guestOsFeatures: js.UndefOr[js.Array[Schema$GuestOsFeature]] = js.native
  /**
  ...
  /**
    ...
    */
  var sourceImageEncryptionKey: js.UndefOr[Schema$CustomerEncryptionKey] = js.native
  /**
  ...
  /**
    ...
    */
  var sourceSnapshotEncryptionKey: js.UndefOr[Schema$CustomerEncryptionKey] = js.native
}

object Schema$AttachedDiskInitializeParams {
  @scala.inline
  def apply(
    ...
    guestOsFeatures: js.Array[Schema$GuestOsFeature] = null,
    labels: StringDictionary[String] = null,
    replicaZones: js.Array[String] = null,
    sourceImage: String = null,
    sourceImageEncryptionKey: Schema$CustomerEncryptionKey = null,
    sourceSnapshot: String = null,
    sourceSnapshotEncryptionKey: Schema$CustomerEncryptionKey = null
    ...
    __obj.asInstanceOf[Schema$AttachedDiskInitializeParams]
  }
}
