...
class Resource$Targettcpproxies protected () extends js.Object {
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarTargettcpproxiesDollarTestiampermissions): GaxiosPromise[Schema$TestPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarTargettcpproxiesDollarTestiampermissions,
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarTargettcpproxiesDollarTestiampermissions, options: MethodOptions): GaxiosPromise[Schema$TestPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarTargettcpproxiesDollarTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$TestPermissionsResponse]
