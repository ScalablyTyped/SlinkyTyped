...
/**
  ...
  */
@js.native
trait Schema$HttpRetryPolicy extends js.Object {
  /**
  ...
  /**
    ...
    */
  var perTryTimeout: js.UndefOr[Schema$Duration] = js.native
  /**
...
object Schema$HttpRetryPolicy {
  @scala.inline
  def apply(
    numRetries: Int | Double = null,
    perTryTimeout: Schema$Duration = null,
    ...
    __obj.asInstanceOf[Schema$HttpRetryPolicy]
  }
}
