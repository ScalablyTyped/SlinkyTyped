...
/**
  ...
  */
@js.native
trait Schema$ConsistentHashLoadBalancerSettings extends js.Object {
  /**
    ...
    */
  var httpCookie: js.UndefOr[Schema$ConsistentHashLoadBalancerSettingsHttpCookie] = js.native
  /**
...
object Schema$ConsistentHashLoadBalancerSettings {
  @scala.inline
  def apply(
    httpCookie: Schema$ConsistentHashLoadBalancerSettingsHttpCookie = null,
    ...
    __obj.asInstanceOf[Schema$ConsistentHashLoadBalancerSettings]
  }
}
