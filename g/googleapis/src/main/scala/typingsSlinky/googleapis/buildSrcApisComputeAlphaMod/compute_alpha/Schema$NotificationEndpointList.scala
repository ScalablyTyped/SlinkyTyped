...
@js.native
trait Schema$NotificationEndpointList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$NotificationEndpoint]] = js.native
  /**
...
object Schema$NotificationEndpointList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[Schema$NotificationEndpoint] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$NotificationEndpointList]
  }
}
