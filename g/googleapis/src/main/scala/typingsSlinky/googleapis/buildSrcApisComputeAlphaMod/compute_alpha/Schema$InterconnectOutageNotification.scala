...
/**
  ...
  */
@js.native
trait Schema$InterconnectOutageNotification extends js.Object {
  /**
...
object Schema$InterconnectOutageNotification {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$InterconnectOutageNotification]
  }
}
