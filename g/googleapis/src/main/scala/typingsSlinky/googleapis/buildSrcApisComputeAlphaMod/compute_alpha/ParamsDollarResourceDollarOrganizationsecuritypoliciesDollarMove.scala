...
@js.native
trait ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarMove extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarMove {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarMove = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrganizationsecuritypoliciesDollarMove]
  }
}
