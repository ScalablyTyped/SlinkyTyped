...
@js.native
trait ParamsDollarResourceDollarTargetpoolsDollarSetbackup extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTargetpoolsDollarSetbackup {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTargetpoolsDollarSetbackup = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTargetpoolsDollarSetbackup]
  }
}
