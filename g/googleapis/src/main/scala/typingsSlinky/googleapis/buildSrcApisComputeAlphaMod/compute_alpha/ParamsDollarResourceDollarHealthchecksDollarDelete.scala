...
@js.native
trait ParamsDollarResourceDollarHealthchecksDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarHealthchecksDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarHealthchecksDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarHealthchecksDollarDelete]
  }
}
