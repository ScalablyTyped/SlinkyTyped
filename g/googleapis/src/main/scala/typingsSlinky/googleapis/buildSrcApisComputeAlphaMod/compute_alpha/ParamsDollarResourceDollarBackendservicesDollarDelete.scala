...
@js.native
trait ParamsDollarResourceDollarBackendservicesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarBackendservicesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarBackendservicesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarBackendservicesDollarDelete]
  }
}
