...
/**
  ...
  */
@js.native
trait Schema$RouterNat extends js.Object {
  /**
  ...
  /**
    ...
    */
  var logConfig: js.UndefOr[Schema$RouterNatLogConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var subnetworks: js.UndefOr[js.Array[Schema$RouterNatSubnetworkToNat]] = js.native
  /**
...
object Schema$RouterNat {
  ...
  def apply(
    ...
    subnetworks: js.Array[Schema$RouterNatSubnetworkToNat] = null,
    ...
    __obj.asInstanceOf[Schema$RouterNat]
  }
}
