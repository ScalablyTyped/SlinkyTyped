...
import typingsSlinky.googleapis.gmailV1Mod.gmailV1.Options
...
object gmailMod {
  ...
  object VERSIONS {
    ...
    @scala.inline
    def v1_=(x: Instantiable2[/* options */ GlobalOptions, /* google */ js.UndefOr[GoogleConfigurable], Gmail]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("v1")(x.asInstanceOf[js.Any])
  }
  ...
  object auth extends Shortcut {
    ...
    object DefaultTransporter {
      ...
      @JSImport("googleapis/build/src/apis/gmail", "auth.DefaultTransporter.constructor")
      @js.native
  ...
  @JSImport("googleapis/build/src/apis/gmail", "gmail")
  @js.native
