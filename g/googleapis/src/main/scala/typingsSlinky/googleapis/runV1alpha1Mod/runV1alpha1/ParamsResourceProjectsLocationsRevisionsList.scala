...
@js.native
trait ParamsResourceProjectsLocationsRevisionsList extends StandardParameters {
  /**
...
object ParamsResourceProjectsLocationsRevisionsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRevisionsListOps[Self <: ParamsResourceProjectsLocationsRevisionsList] (val x: Self) extends AnyVal {
    @scala.inline
