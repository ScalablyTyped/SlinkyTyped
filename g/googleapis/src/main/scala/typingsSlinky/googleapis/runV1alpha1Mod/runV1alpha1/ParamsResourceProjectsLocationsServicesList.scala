...
@js.native
trait ParamsResourceProjectsLocationsServicesList extends StandardParameters {
...
object ParamsResourceProjectsLocationsServicesList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsServicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicesList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsServicesListMutableBuilder[Self <: ParamsResourceProjectsLocationsServicesList] (val x: Self) extends AnyVal {
