...
@js.native
trait ParamsResourceNamespacesRevisionsList extends StandardParameters {
...
object ParamsResourceNamespacesRevisionsList {
  
  @scala.inline
  def apply(): ParamsResourceNamespacesRevisionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesRevisionsList]
  }
  
  @scala.inline
  implicit class ParamsResourceNamespacesRevisionsListMutableBuilder[Self <: ParamsResourceNamespacesRevisionsList] (val x: Self) extends AnyVal {
