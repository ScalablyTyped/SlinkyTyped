...
@js.native
class ResourceNamespacesRevisions protected () extends StObject {
  ...
  def delete(params: ParamsResourceNamespacesRevisionsDelete, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def delete(
    params: ParamsResourceNamespacesRevisionsDelete,
