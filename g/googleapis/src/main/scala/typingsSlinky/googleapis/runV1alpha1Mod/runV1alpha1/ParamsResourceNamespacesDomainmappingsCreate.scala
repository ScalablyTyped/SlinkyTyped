...
object ParamsResourceNamespacesDomainmappingsCreate {
  
  @scala.inline
  def apply(): ParamsResourceNamespacesDomainmappingsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesDomainmappingsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceNamespacesDomainmappingsCreateMutableBuilder[Self <: ParamsResourceNamespacesDomainmappingsCreate] (val x: Self) extends AnyVal {
