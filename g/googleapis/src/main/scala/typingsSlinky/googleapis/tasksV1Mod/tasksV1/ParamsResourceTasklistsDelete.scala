...
@js.native
trait ParamsResourceTasklistsDelete extends StandardParameters {
  /**
...
object ParamsResourceTasklistsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceTasklistsDeleteOps[Self <: ParamsResourceTasklistsDelete] (val x: Self) extends AnyVal {
    @scala.inline
