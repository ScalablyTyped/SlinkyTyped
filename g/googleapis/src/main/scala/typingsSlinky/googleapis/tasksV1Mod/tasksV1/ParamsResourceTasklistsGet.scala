...
@js.native
trait ParamsResourceTasklistsGet extends StandardParameters {
...
object ParamsResourceTasklistsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceTasklistsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTasklistsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceTasklistsGetMutableBuilder[Self <: ParamsResourceTasklistsGet] (val x: Self) extends AnyVal {
