...
@js.native
trait ParamsResourceCreativefieldvaluesDelete extends StandardParameters {
...
object ParamsResourceCreativefieldvaluesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceCreativefieldvaluesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCreativefieldvaluesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceCreativefieldvaluesDeleteMutableBuilder[Self <: ParamsResourceCreativefieldvaluesDelete] (val x: Self) extends AnyVal {
