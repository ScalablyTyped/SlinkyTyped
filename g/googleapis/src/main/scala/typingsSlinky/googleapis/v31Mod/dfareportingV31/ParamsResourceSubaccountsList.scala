...
@js.native
trait ParamsResourceSubaccountsList extends StandardParameters {
...
object ParamsResourceSubaccountsList {
  ...
  @scala.inline
  def apply(): ParamsResourceSubaccountsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubaccountsList]
  }
  
  @scala.inline
  implicit class ParamsResourceSubaccountsListMutableBuilder[Self <: ParamsResourceSubaccountsList] (val x: Self) extends AnyVal {
