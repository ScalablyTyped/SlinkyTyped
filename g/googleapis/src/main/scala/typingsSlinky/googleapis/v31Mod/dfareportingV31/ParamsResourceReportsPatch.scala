...
@js.native
trait ParamsResourceReportsPatch extends StandardParameters {
...
object ParamsResourceReportsPatch {
  
  @scala.inline
  def apply(): ParamsResourceReportsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceReportsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceReportsPatchMutableBuilder[Self <: ParamsResourceReportsPatch] (val x: Self) extends AnyVal {
