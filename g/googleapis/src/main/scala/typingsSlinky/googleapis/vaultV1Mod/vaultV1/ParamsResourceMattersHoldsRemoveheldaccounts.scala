...
object ParamsResourceMattersHoldsRemoveheldaccounts {
  ...
  @scala.inline
  implicit class ParamsResourceMattersHoldsRemoveheldaccountsOps[Self <: ParamsResourceMattersHoldsRemoveheldaccounts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRemoveHeldAccountsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
