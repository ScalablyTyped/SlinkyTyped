...
object ParamsResourceMattersHoldsRemoveheldaccounts {
  ...
  @scala.inline
  def apply(): ParamsResourceMattersHoldsRemoveheldaccounts = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMattersHoldsRemoveheldaccounts]
  }
  
  @scala.inline
  implicit class ParamsResourceMattersHoldsRemoveheldaccountsMutableBuilder[Self <: ParamsResourceMattersHoldsRemoveheldaccounts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRemoveHeldAccountsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
