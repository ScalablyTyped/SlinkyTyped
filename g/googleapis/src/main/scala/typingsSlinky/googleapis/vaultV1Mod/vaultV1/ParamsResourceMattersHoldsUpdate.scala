...
@js.native
trait ParamsResourceMattersHoldsUpdate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaHold] = js.native
}
object ParamsResourceMattersHoldsUpdate {
  
  @scala.inline
  def apply(): ParamsResourceMattersHoldsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMattersHoldsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceMattersHoldsUpdateMutableBuilder[Self <: ParamsResourceMattersHoldsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaHold): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
