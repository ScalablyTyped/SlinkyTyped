...
object ParamsResourceMattersHoldsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceMattersHoldsUpdateOps[Self <: ParamsResourceMattersHoldsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaHold): Self = this.set("requestBody", value.asInstanceOf[js.Any])
