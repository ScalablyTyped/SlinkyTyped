...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechContext extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechContext {
  @scala.inline
  def apply(phrases: js.Array[String] = null): Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechContext = {
    val __obj = js.Dynamic.literal()
    if (phrases != null) __obj.updateDynamic("phrases")(phrases.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechContext]
  }
}
