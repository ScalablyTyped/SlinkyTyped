...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationResults extends js.Object {
  /**
  ...
  /**
    ...
    * unique label.
    */
  var frameLabelAnnotations: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_LabelAnnotation]] = js.native
  /**
  ...
  /**
    ...
    */
  var segmentLabelAnnotations: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_LabelAnnotation]] = js.native
  /**
  ...
  /**
    ...
    * unique label.
    */
  var shotLabelAnnotations: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_LabelAnnotation]] = js.native
  /**
    * Speech transcription.
    */
  var speechTranscriptions: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechTranscription]] = js.native
  /**
    ...
    */
  var textAnnotations: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_TextAnnotation]] = js.native
}

object Schema$GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationResults {
  @scala.inline
  def apply(
    ...
    frameLabelAnnotations: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_LabelAnnotation] = null,
    inputUri: String = null,
    objectAnnotations: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingAnnotation] = null,
    segmentLabelAnnotations: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_LabelAnnotation] = null,
    shotAnnotations: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_VideoSegment] = null,
    shotLabelAnnotations: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_LabelAnnotation] = null,
    speechTranscriptions: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechTranscription] = null,
    textAnnotations: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_TextAnnotation] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationResults]
  }
}
