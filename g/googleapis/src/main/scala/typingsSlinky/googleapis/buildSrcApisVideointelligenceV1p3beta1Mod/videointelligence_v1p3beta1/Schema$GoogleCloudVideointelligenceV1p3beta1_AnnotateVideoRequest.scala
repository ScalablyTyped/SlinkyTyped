...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var videoContext: js.UndefOr[Schema$GoogleCloudVideointelligenceV1p3beta1_VideoContext] = js.native
}

object Schema$GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest {
  @scala.inline
  def apply(
    ...
    videoContext: Schema$GoogleCloudVideointelligenceV1p3beta1_VideoContext = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest]
  }
}
