...
/**
  ...
  */
@js.native
trait Schema$PgpSignedAttestation extends js.Object {
  /**
...
object Schema$PgpSignedAttestation {
  @scala.inline
  def apply(contentType: String = null, pgpKeyId: String = null, signature: String = null): Schema$PgpSignedAttestation = {
    val __obj = js.Dynamic.literal()
    if (contentType != null) __obj.updateDynamic("contentType")(contentType.asInstanceOf[js.Any])
    if (pgpKeyId != null) __obj.updateDynamic("pgpKeyId")(pgpKeyId.asInstanceOf[js.Any])
    if (signature != null) __obj.updateDynamic("signature")(signature.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$PgpSignedAttestation]
  }
}
