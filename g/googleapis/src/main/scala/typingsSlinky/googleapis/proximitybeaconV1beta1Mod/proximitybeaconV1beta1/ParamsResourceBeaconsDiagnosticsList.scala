...
object ParamsResourceBeaconsDiagnosticsList {
  ...
  implicit class ParamsResourceBeaconsDiagnosticsListOps[Self <: ParamsResourceBeaconsDiagnosticsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlertFilter(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("alertFilter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAlertFilter: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("alertFilter")(js.undefined)
        ret
    }
    @scala.inline
