...
/**
  ...
  */
@js.native
trait SchemaCompleteIPRotationRequest extends js.Object {
...
object SchemaCompleteIPRotationRequest {
  ...
  @scala.inline
  def apply(): SchemaCompleteIPRotationRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCompleteIPRotationRequest]
  }
  
  @scala.inline
  implicit class SchemaCompleteIPRotationRequestOps[Self <: SchemaCompleteIPRotationRequest] (val x: Self) extends AnyVal {
