...
object ParamsResourceProjectsLocationsClustersNodepoolsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsDeleteMutableBuilder[Self <: ParamsResourceProjectsLocationsClustersNodepoolsDelete] (val x: Self) extends AnyVal {
