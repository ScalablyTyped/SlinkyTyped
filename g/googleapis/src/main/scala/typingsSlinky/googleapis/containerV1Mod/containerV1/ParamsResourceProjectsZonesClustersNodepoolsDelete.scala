...
object ParamsResourceProjectsZonesClustersNodepoolsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsZonesClustersNodepoolsDeleteMutableBuilder[Self <: ParamsResourceProjectsZonesClustersNodepoolsDelete] (val x: Self) extends AnyVal {
