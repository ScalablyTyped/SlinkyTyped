...
object ParamsResourceProjectsZonesClustersStartiprotation {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsZonesClustersStartiprotationMutableBuilder[Self <: ParamsResourceProjectsZonesClustersStartiprotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaStartIPRotationRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
