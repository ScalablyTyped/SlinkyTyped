...
object ParamsResourceProjectsLocationsClustersNodepoolsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsUpdateOps[Self <: ParamsResourceProjectsLocationsClustersNodepoolsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaUpdateNodePoolRequest): Self = {
        val ret = this.duplicate
