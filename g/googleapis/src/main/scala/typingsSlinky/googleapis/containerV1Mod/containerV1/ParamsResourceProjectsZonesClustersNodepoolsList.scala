...
object ParamsResourceProjectsZonesClustersNodepoolsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsZonesClustersNodepoolsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersNodepoolsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsZonesClustersNodepoolsListMutableBuilder[Self <: ParamsResourceProjectsZonesClustersNodepoolsList] (val x: Self) extends AnyVal {
