...
object ParamsResourceProjectsHistoriesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesCreateMutableBuilder[Self <: ParamsResourceProjectsHistoriesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaHistory): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
