...
object ParamsResourceProjectsHistoriesExecutionsStepsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsStepsCreateOps[Self <: ParamsResourceProjectsHistoriesExecutionsStepsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaStep): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
