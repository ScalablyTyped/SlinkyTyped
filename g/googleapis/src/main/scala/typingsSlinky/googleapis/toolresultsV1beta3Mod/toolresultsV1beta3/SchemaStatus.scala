...
object SchemaStatus {
  ...
  implicit class SchemaStatusOps[Self <: SchemaStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDetailsVarargs(value: SchemaAny*): Self = this.set("details", js.Array(value :_*))
    
    @scala.inline
    def setDetails(value: js.Array[SchemaAny]): Self = this.set("details", value.asInstanceOf[js.Any])
