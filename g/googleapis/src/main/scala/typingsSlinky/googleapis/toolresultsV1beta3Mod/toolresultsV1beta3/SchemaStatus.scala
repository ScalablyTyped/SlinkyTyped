...
object SchemaStatus {
  ...
  implicit class SchemaStatusMutableBuilder[Self <: SchemaStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDetails(value: js.Array[SchemaAny]): Self = StObject.set(x, "details", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDetailsUndefined: Self = StObject.set(x, "details", js.undefined)
    
    @scala.inline
    def setDetailsVarargs(value: SchemaAny*): Self = StObject.set(x, "details", js.Array(value :_*))
