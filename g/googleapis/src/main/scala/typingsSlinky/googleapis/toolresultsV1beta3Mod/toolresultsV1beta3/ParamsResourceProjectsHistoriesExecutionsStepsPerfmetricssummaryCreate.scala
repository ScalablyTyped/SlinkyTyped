...
@js.native
trait ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaPerfMetricsSummary] = js.native
...
object ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreateMutableBuilder[Self <: ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPerfMetricsSummary): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
