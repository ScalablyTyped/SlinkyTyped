...
object ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreateOps[Self <: ParamsResourceProjectsHistoriesExecutionsStepsPerfmetricssummaryCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaPerfMetricsSummary): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
