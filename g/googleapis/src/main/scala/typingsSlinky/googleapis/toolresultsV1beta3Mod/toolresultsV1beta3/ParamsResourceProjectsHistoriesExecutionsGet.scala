...
object ParamsResourceProjectsHistoriesExecutionsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsHistoriesExecutionsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsHistoriesExecutionsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsGetMutableBuilder[Self <: ParamsResourceProjectsHistoriesExecutionsGet] (val x: Self) extends AnyVal {
