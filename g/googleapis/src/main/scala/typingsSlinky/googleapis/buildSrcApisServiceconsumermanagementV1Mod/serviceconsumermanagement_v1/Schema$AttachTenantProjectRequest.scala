...
/**
  ...
  */
@js.native
trait Schema$AttachTenantProjectRequest extends js.Object {
  /**
...
object Schema$AttachTenantProjectRequest {
  @scala.inline
  def apply(externalResource: String = null, reservedResource: String = null, tag: String = null): Schema$AttachTenantProjectRequest = {
    ...
    __obj.asInstanceOf[Schema$AttachTenantProjectRequest]
  }
}
