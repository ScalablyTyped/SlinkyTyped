...
/**
  ...
  */
@js.native
trait Schema$AuthRequirement extends js.Object {
  /**
...
object Schema$AuthRequirement {
  @scala.inline
  def apply(audiences: String = null, providerId: String = null): Schema$AuthRequirement = {
    ...
    __obj.asInstanceOf[Schema$AuthRequirement]
  }
}
