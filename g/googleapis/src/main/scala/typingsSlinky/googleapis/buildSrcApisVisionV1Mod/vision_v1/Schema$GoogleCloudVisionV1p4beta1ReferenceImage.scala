...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1ReferenceImage extends js.Object {
  /**
    ...
    */
  var boundingPolys: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p4beta1BoundingPoly]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p4beta1ReferenceImage {
  @scala.inline
  def apply(
    boundingPolys: js.Array[Schema$GoogleCloudVisionV1p4beta1BoundingPoly] = null,
    name: String = null,
    uri: String = null
  ): Schema$GoogleCloudVisionV1p4beta1ReferenceImage = {
    val __obj = js.Dynamic.literal()
    if (boundingPolys != null) __obj.updateDynamic("boundingPolys")(boundingPolys.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (uri != null) __obj.updateDynamic("uri")(uri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1ReferenceImage]
  }
}
