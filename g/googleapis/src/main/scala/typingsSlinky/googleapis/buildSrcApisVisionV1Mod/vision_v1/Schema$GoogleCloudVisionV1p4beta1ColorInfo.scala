...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1ColorInfo extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p4beta1ColorInfo {
  @scala.inline
  def apply(color: Schema$Color = null, pixelFraction: Int | Double = null, score: Int | Double = null): Schema$GoogleCloudVisionV1p4beta1ColorInfo = {
    val __obj = js.Dynamic.literal()
    if (color != null) __obj.updateDynamic("color")(color.asInstanceOf[js.Any])
    if (pixelFraction != null) __obj.updateDynamic("pixelFraction")(pixelFraction.asInstanceOf[js.Any])
    if (score != null) __obj.updateDynamic("score")(score.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1ColorInfo]
  }
}
