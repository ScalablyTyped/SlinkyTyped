...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p3beta1Word extends js.Object {
  /**
  ...
  /**
    ...
    * reading order.
    */
  var symbols: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p3beta1Symbol]] = js.native
}

object Schema$GoogleCloudVisionV1p3beta1Word {
  @scala.inline
  def apply(
    ...
    symbols: js.Array[Schema$GoogleCloudVisionV1p3beta1Symbol] = null
  ): Schema$GoogleCloudVisionV1p3beta1Word = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p3beta1Word]
  }
}
