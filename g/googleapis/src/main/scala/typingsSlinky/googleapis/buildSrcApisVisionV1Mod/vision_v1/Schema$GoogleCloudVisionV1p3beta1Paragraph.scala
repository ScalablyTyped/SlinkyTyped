...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p3beta1Paragraph extends js.Object {
  /**
  ...
  /**
    ...
    */
  var words: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p3beta1Word]] = js.native
}

object Schema$GoogleCloudVisionV1p3beta1Paragraph {
  @scala.inline
  def apply(
    ...
    words: js.Array[Schema$GoogleCloudVisionV1p3beta1Word] = null
  ): Schema$GoogleCloudVisionV1p3beta1Paragraph = {
    val __obj = js.Dynamic.literal()
    if (boundingBox != null) __obj.updateDynamic("boundingBox")(boundingBox.asInstanceOf[js.Any])
    if (confidence != null) __obj.updateDynamic("confidence")(confidence.asInstanceOf[js.Any])
    if (property != null) __obj.updateDynamic("property")(property.asInstanceOf[js.Any])
    if (words != null) __obj.updateDynamic("words")(words.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p3beta1Paragraph]
  }
}
