...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p3beta1Symbol extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p3beta1Symbol {
  @scala.inline
  def apply(
    ...
    text: String = null
  ): Schema$GoogleCloudVisionV1p3beta1Symbol = {
    val __obj = js.Dynamic.literal()
    if (boundingBox != null) __obj.updateDynamic("boundingBox")(boundingBox.asInstanceOf[js.Any])
    if (confidence != null) __obj.updateDynamic("confidence")(confidence.asInstanceOf[js.Any])
    if (property != null) __obj.updateDynamic("property")(property.asInstanceOf[js.Any])
    if (text != null) __obj.updateDynamic("text")(text.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p3beta1Symbol]
  }
}
