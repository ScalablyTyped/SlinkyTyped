...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1Product extends js.Object {
  /**
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p4beta1ProductKeyValue]] = js.native
}

object Schema$GoogleCloudVisionV1p4beta1Product {
  @scala.inline
  def apply(
    ...
    productLabels: js.Array[Schema$GoogleCloudVisionV1p4beta1ProductKeyValue] = null
  ): Schema$GoogleCloudVisionV1p4beta1Product = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1Product]
  }
}
