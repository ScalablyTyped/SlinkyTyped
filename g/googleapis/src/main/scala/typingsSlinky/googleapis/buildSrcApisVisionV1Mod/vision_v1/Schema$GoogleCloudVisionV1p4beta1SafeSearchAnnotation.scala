...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1SafeSearchAnnotation extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p4beta1SafeSearchAnnotation {
  @scala.inline
  def apply(
    adult: String = null,
    medical: String = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1SafeSearchAnnotation]
  }
}
