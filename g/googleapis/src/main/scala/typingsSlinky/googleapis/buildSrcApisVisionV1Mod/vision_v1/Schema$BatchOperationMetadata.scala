...
/**
  ...
  */
@js.native
trait Schema$BatchOperationMetadata extends js.Object {
  /**
...
object Schema$BatchOperationMetadata {
  @scala.inline
  def apply(endTime: String = null, state: String = null, submitTime: String = null): Schema$BatchOperationMetadata = {
    val __obj = js.Dynamic.literal()
    if (endTime != null) __obj.updateDynamic("endTime")(endTime.asInstanceOf[js.Any])
    if (state != null) __obj.updateDynamic("state")(state.asInstanceOf[js.Any])
    if (submitTime != null) __obj.updateDynamic("submitTime")(submitTime.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BatchOperationMetadata]
  }
}
