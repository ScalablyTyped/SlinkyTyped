...
/**
  ...
  */
@js.native
trait Schema$CropHintsParams extends js.Object {
  /**
...
object Schema$CropHintsParams {
  @scala.inline
  def apply(aspectRatios: js.Array[Double] = null): Schema$CropHintsParams = {
    val __obj = js.Dynamic.literal()
    if (aspectRatios != null) __obj.updateDynamic("aspectRatios")(aspectRatios.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$CropHintsParams]
  }
}
