...
/**
  ...
  */
@js.native
trait Schema$ImageContext extends js.Object {
  /**
    * Parameters for crop hints annotation request.
    */
  var cropHintsParams: js.UndefOr[Schema$CropHintsParams] = js.native
  /**
  ...
  /**
    * Not used.
    */
  var latLongRect: js.UndefOr[Schema$LatLongRect] = js.native
  /**
    * Parameters for product search.
    */
  var productSearchParams: js.UndefOr[Schema$ProductSearchParams] = js.native
  /**
    * Parameters for web detection.
    */
  var webDetectionParams: js.UndefOr[Schema$WebDetectionParams] = js.native
}

object Schema$ImageContext {
  @scala.inline
  def apply(
    cropHintsParams: Schema$CropHintsParams = null,
    languageHints: js.Array[String] = null,
    latLongRect: Schema$LatLongRect = null,
    productSearchParams: Schema$ProductSearchParams = null,
    webDetectionParams: Schema$WebDetectionParams = null
  ): Schema$ImageContext = {
    ...
    __obj.asInstanceOf[Schema$ImageContext]
  }
}
