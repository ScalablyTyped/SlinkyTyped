...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation]
  }
}
