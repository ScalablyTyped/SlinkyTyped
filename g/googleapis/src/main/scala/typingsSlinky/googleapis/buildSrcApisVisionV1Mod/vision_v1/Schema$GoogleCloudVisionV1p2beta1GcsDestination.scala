...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1GcsDestination extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p2beta1GcsDestination {
  @scala.inline
  def apply(uri: String = null): Schema$GoogleCloudVisionV1p2beta1GcsDestination = {
    val __obj = js.Dynamic.literal()
    if (uri != null) __obj.updateDynamic("uri")(uri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p2beta1GcsDestination]
  }
}
