...
class Resource$Organizations protected () extends js.Object {
  ...
  def batchGetAssetsHistory(params: ParamsDollarResourceDollarOrganizationsDollarBatchgetassetshistory): GaxiosPromise[Schema$BatchGetAssetsHistoryResponse] = js.native
  def batchGetAssetsHistory(
    params: ParamsDollarResourceDollarOrganizationsDollarBatchgetassetshistory,
  ...
  def batchGetAssetsHistory(params: ParamsDollarResourceDollarOrganizationsDollarBatchgetassetshistory, options: MethodOptions): GaxiosPromise[Schema$BatchGetAssetsHistoryResponse] = js.native
  def batchGetAssetsHistory(
    params: ParamsDollarResourceDollarOrganizationsDollarBatchgetassetshistory,
  ...
  def exportAssets(params: ParamsDollarResourceDollarOrganizationsDollarExportassets): GaxiosPromise[Schema$Operation] = js.native
  def exportAssets(
    params: ParamsDollarResourceDollarOrganizationsDollarExportassets,
  ...
  def exportAssets(params: ParamsDollarResourceDollarOrganizationsDollarExportassets, options: MethodOptions): GaxiosPromise[Schema$Operation] = js.native
  def exportAssets(
    params: ParamsDollarResourceDollarOrganizationsDollarExportassets,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Operation]
