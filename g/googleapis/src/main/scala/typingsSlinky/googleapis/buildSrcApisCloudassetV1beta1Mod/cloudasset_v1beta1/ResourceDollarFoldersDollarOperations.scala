package typingsSlinky.googleapis.buildSrcApisCloudassetV1beta1Mod.cloudasset_v1beta1
...
@js.native
class ResourceDollarFoldersDollarOperations protected () extends js.Object {
  ...
  def get(params: ParamsDollarResourceDollarFoldersDollarOperationsDollarGet): GaxiosPromise[Schema$Operation] = js.native
  def get(
    params: ParamsDollarResourceDollarFoldersDollarOperationsDollarGet,
  ...
  def get(params: ParamsDollarResourceDollarFoldersDollarOperationsDollarGet, options: MethodOptions): GaxiosPromise[Schema$Operation] = js.native
  def get(
    params: ParamsDollarResourceDollarFoldersDollarOperationsDollarGet,
