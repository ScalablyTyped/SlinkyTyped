...
object ParamsResourceOrganizationsUpdateorganizationsettings {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsUpdateorganizationsettingsOps[Self <: ParamsResourceOrganizationsUpdateorganizationsettings] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrganizationSettings): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
