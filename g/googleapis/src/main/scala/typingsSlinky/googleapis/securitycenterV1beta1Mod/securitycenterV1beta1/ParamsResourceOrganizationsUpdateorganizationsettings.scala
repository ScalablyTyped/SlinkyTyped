...
object ParamsResourceOrganizationsUpdateorganizationsettings {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsUpdateorganizationsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsUpdateorganizationsettings]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsUpdateorganizationsettingsMutableBuilder[Self <: ParamsResourceOrganizationsUpdateorganizationsettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrganizationSettings): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
