...
object ParamsResourceOrganizationsSourcesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsSourcesCreateOps[Self <: ParamsResourceOrganizationsSourcesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSource): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
