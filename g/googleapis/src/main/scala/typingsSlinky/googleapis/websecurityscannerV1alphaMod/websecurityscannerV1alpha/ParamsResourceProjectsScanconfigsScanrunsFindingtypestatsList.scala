...
object ParamsResourceProjectsScanconfigsScanrunsFindingtypestatsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsScanconfigsScanrunsFindingtypestatsListOps[Self <: ParamsResourceProjectsScanconfigsScanrunsFindingtypestatsList] (val x: Self) extends AnyVal {
    @scala.inline
