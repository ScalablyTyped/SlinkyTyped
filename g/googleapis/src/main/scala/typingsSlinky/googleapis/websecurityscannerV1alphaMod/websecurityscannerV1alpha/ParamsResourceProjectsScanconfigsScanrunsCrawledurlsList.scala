...
object ParamsResourceProjectsScanconfigsScanrunsCrawledurlsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsScanconfigsScanrunsCrawledurlsListOps[Self <: ParamsResourceProjectsScanconfigsScanrunsCrawledurlsList] (val x: Self) extends AnyVal {
    @scala.inline
