...
object ParamsResourceServicesEnable {
  ...
  @scala.inline
  implicit class ParamsResourceServicesEnableOps[Self <: ParamsResourceServicesEnable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaEnableServiceRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
