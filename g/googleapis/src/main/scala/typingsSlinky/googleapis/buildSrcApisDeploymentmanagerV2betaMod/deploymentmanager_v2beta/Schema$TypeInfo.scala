...
/**
  ...
  */
@js.native
trait Schema$TypeInfo extends js.Object {
  /**
  ...
  /**
    ...
    */
  var schema: js.UndefOr[Schema$TypeInfoSchemaInfo] = js.native
  /**
...
object Schema$TypeInfo {
  ...
  def apply(
    ...
    kind: String = null,
    name: String = null,
    schema: Schema$TypeInfoSchemaInfo = null,
    ...
    __obj.asInstanceOf[Schema$TypeInfo]
  }
}
