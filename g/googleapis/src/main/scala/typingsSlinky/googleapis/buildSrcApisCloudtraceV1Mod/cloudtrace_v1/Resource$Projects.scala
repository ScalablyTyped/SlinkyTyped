...
class Resource$Projects protected () extends js.Object {
  ...
  /**
    ...
    */
  def patchTraces(): GaxiosPromise[Schema$Empty] = js.native
  def patchTraces(callback: BodyResponseCallback[Schema$Empty]): Unit = js.native
  def patchTraces(params: ParamsDollarResourceDollarProjectsDollarPatchtraces): GaxiosPromise[Schema$Empty] = js.native
  def patchTraces(
    params: ParamsDollarResourceDollarProjectsDollarPatchtraces,
  ...
  def patchTraces(params: ParamsDollarResourceDollarProjectsDollarPatchtraces, options: MethodOptions): GaxiosPromise[Schema$Empty] = js.native
  def patchTraces(
    params: ParamsDollarResourceDollarProjectsDollarPatchtraces,
