...
class ResourceDollarProjectsDollarTraces protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(): GaxiosPromise[Schema$Trace] = js.native
  def get(callback: BodyResponseCallback[Schema$Trace]): Unit = js.native
  def get(params: ParamsDollarResourceDollarProjectsDollarTracesDollarGet): GaxiosPromise[Schema$Trace] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarTracesDollarGet,
    callback: BodyResponseCallback[Schema$Trace]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarTracesDollarGet,
    options: BodyResponseCallback[Schema$Trace],
    callback: BodyResponseCallback[Schema$Trace]
  ): Unit = js.native
  def get(params: ParamsDollarResourceDollarProjectsDollarTracesDollarGet, options: MethodOptions): GaxiosPromise[Schema$Trace] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarTracesDollarGet,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$ListTracesResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListTracesResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarTracesDollarList): GaxiosPromise[Schema$ListTracesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarTracesDollarList,
    callback: BodyResponseCallback[Schema$ListTracesResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarTracesDollarList,
    options: BodyResponseCallback[Schema$ListTracesResponse],
    callback: BodyResponseCallback[Schema$ListTracesResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarTracesDollarList, options: MethodOptions): GaxiosPromise[Schema$ListTracesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarTracesDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListTracesResponse]
