...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p1beta1ProductSearchResults extends js.Object {
  /**
  ...
  /**
    ...
    */
  var productGroupedResults: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult]] = js.native
  /**
    * List of results, one for each product match.
    */
  var results: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p1beta1ProductSearchResultsResult]] = js.native
}

object Schema$GoogleCloudVisionV1p1beta1ProductSearchResults {
  @scala.inline
  def apply(
    indexTime: String = null,
    productGroupedResults: js.Array[Schema$GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult] = null,
    results: js.Array[Schema$GoogleCloudVisionV1p1beta1ProductSearchResultsResult] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p1beta1ProductSearchResults]
  }
}
