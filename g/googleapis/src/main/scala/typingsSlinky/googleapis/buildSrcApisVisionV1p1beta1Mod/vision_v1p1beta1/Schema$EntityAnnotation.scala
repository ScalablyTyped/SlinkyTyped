...
/**
  ...
  */
@js.native
trait Schema$EntityAnnotation extends js.Object {
  /**
  ...
  /**
    ...
    */
  var locations: js.UndefOr[js.Array[Schema$LocationInfo]] = js.native
  /**
...
object Schema$EntityAnnotation {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$EntityAnnotation]
  }
}
