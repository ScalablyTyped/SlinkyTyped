...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1ProductSearchResults extends js.Object {
  /**
  ...
  /**
    ...
    */
  var productGroupedResults: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p4beta1ProductSearchResults {
  @scala.inline
  def apply(
    indexTime: String = null,
    productGroupedResults: js.Array[Schema$GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult] = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1ProductSearchResults]
  }
}
