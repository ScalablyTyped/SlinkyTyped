...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p1beta1CropHintsParams extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p1beta1CropHintsParams {
  @scala.inline
  def apply(aspectRatios: js.Array[Double] = null): Schema$GoogleCloudVisionV1p1beta1CropHintsParams = {
    val __obj = js.Dynamic.literal()
    if (aspectRatios != null) __obj.updateDynamic("aspectRatios")(aspectRatios.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p1beta1CropHintsParams]
  }
}
