...
/**
  ...
  */
@js.native
trait Schema$Word extends js.Object {
  /**
  ...
  /**
    ...
    * reading order.
    */
  var symbols: js.UndefOr[js.Array[Schema$Symbol]] = js.native
}
...
object Schema$Word {
  ...
  def apply(
    ...
    symbols: js.Array[Schema$Symbol] = null
  ): Schema$Word = {
    ...
    __obj.asInstanceOf[Schema$Word]
  }
}
