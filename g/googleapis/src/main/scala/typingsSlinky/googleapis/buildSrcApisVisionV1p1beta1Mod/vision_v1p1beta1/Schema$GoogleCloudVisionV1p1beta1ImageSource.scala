...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p1beta1ImageSource extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p1beta1ImageSource {
  @scala.inline
  def apply(gcsImageUri: String = null, imageUri: String = null): Schema$GoogleCloudVisionV1p1beta1ImageSource = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p1beta1ImageSource]
  }
}
