...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p3beta1EntityAnnotation extends js.Object {
  /**
  ...
  /**
    ...
    */
  var locations: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p3beta1LocationInfo]] = js.native
  /**
  ...
  /**
    ...
    */
  var properties: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p3beta1Property]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p3beta1EntityAnnotation {
  @scala.inline
  def apply(
    ...
    locale: String = null,
    locations: js.Array[Schema$GoogleCloudVisionV1p3beta1LocationInfo] = null,
    mid: String = null,
    properties: js.Array[Schema$GoogleCloudVisionV1p3beta1Property] = null,
    score: Int | Double = null,
    topicality: Int | Double = null
  ): Schema$GoogleCloudVisionV1p3beta1EntityAnnotation = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p3beta1EntityAnnotation]
  }
}
