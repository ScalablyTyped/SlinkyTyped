...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p1beta1LatLongRect extends js.Object {
  /**
    * Max lat/long pair.
    */
...
object Schema$GoogleCloudVisionV1p1beta1LatLongRect {
  @scala.inline
  def apply(maxLatLng: Schema$LatLng = null, minLatLng: Schema$LatLng = null): Schema$GoogleCloudVisionV1p1beta1LatLongRect = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p1beta1LatLongRect]
  }
}
