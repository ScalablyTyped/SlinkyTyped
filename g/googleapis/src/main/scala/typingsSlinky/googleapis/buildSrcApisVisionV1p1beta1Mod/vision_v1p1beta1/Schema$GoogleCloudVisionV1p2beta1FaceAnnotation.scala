...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1FaceAnnotation extends js.Object {
  /**
    * Anger likelihood.
    */
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1BoundingPoly] = js.native
  /**
    * Headwear likelihood.
    */
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p2beta1FaceAnnotation {
  @scala.inline
  def apply(
    ...
    fdBoundingPoly: Schema$GoogleCloudVisionV1p2beta1BoundingPoly = null,
    headwearLikelihood: String = null,
    joyLikelihood: String = null,
    landmarkingConfidence: Int | Double = null,
    landmarks: js.Array[Schema$GoogleCloudVisionV1p2beta1FaceAnnotationLandmark] = null,
  ...
  ): Schema$GoogleCloudVisionV1p2beta1FaceAnnotation = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p2beta1FaceAnnotation]
  }
}
