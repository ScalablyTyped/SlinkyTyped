...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1ImportProductSetsResponse extends js.Object {
  /**
    * The list of reference_images that are imported successfully.
    */
  var referenceImages: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p4beta1ReferenceImage]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p4beta1ImportProductSetsResponse {
  @scala.inline
  def apply(
    referenceImages: js.Array[Schema$GoogleCloudVisionV1p4beta1ReferenceImage] = null,
    statuses: js.Array[Schema$Status] = null
  ): Schema$GoogleCloudVisionV1p4beta1ImportProductSetsResponse = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1ImportProductSetsResponse]
  }
}
