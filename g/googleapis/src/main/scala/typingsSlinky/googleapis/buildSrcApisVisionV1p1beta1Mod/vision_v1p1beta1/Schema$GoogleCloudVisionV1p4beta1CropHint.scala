...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1CropHint extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p4beta1CropHint {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1CropHint]
  }
}
