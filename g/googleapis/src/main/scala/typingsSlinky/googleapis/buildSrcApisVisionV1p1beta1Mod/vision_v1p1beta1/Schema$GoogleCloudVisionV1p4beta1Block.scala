...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p4beta1Block extends js.Object {
  /**
  ...
  /**
    ...
    */
  var boundingBox: js.UndefOr[Schema$GoogleCloudVisionV1p4beta1BoundingPoly] = js.native
  /**
  ...
  /**
    ...
    */
  var paragraphs: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p4beta1Paragraph]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p4beta1Block {
  @scala.inline
  def apply(
    blockType: String = null,
    boundingBox: Schema$GoogleCloudVisionV1p4beta1BoundingPoly = null,
    confidence: Int | Double = null,
    paragraphs: js.Array[Schema$GoogleCloudVisionV1p4beta1Paragraph] = null,
    property: Schema$GoogleCloudVisionV1p4beta1TextAnnotationTextProperty = null
  ): Schema$GoogleCloudVisionV1p4beta1Block = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p4beta1Block]
  }
}
