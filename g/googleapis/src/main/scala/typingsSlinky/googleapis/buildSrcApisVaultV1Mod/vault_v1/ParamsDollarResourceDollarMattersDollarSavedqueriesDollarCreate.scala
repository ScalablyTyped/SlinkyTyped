...
@js.native
trait ParamsDollarResourceDollarMattersDollarSavedqueriesDollarCreate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$SavedQuery] = js.native
}
