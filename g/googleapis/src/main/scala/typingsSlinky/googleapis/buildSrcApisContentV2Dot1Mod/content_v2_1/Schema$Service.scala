...
trait Schema$Service extends js.Object {
  ...
  /**
    ...
    * Required.
    */
  var deliveryTime: js.UndefOr[Schema$DeliveryTime] = js.native
  /**
  ...
  /**
    ...
    */
  var minimumOrderValue: js.UndefOr[Schema$Price] = js.native
  /**
  ...
  /**
    ...
    */
  var rateGroups: js.UndefOr[js.Array[Schema$RateGroup]] = js.native
}
...
object Schema$Service {
  ...
  def apply(
    ...
    deliveryTime: Schema$DeliveryTime = null,
    eligibility: String = null,
    minimumOrderValue: Schema$Price = null,
    name: String = null,
    rateGroups: js.Array[Schema$RateGroup] = null
  ): Schema$Service = {
