...
/**
  ...
  */
@js.native
trait Schema$DatafeedFetchSchedule extends js.Object {
  /**
...
object Schema$DatafeedFetchSchedule {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$DatafeedFetchSchedule]
  }
}
