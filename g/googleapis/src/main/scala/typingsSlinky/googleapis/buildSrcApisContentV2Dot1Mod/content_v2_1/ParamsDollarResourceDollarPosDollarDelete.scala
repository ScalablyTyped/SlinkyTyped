...
@js.native
trait ParamsDollarResourceDollarPosDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPosDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPosDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPosDollarDelete]
  }
}
