...
@js.native
trait ParamsDollarResourceDollarAccountstatusesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountstatusesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountstatusesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountstatusesDollarList]
  }
}
