...
trait Schema$DeliveryTime extends js.Object {
  ...
  /**
    ...
    */
  var transitTimeTable: js.UndefOr[Schema$TransitTable] = js.native
}

object Schema$DeliveryTime {
  @scala.inline
  def apply(
    cutoffTime: Schema$CutoffTime = null,
    holidayCutoffs: js.Array[Schema$HolidayCutoff] = null,
    ...
    transitTimeTable: Schema$TransitTable = null
  ): Schema$DeliveryTime = {
    ...
    __obj.asInstanceOf[Schema$DeliveryTime]
  }
}
