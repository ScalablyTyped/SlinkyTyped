...
@js.native
trait Schema$AccountStatusItemLevelIssue extends js.Object {
  /**
...
object Schema$AccountStatusItemLevelIssue {
  @scala.inline
  def apply(
  ...
  ): Schema$AccountStatusItemLevelIssue = {
    ...
    __obj.asInstanceOf[Schema$AccountStatusItemLevelIssue]
  }
}
