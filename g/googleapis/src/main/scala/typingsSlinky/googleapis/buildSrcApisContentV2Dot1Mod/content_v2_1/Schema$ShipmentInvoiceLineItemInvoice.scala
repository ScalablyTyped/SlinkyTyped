...
@js.native
trait Schema$ShipmentInvoiceLineItemInvoice extends js.Object {
  /**
  ...
  /**
    ...
    */
  var unitInvoice: js.UndefOr[Schema$UnitInvoice] = js.native
}

object Schema$ShipmentInvoiceLineItemInvoice {
  @scala.inline
  def apply(
    lineItemId: String = null,
    productId: String = null,
    shipmentUnitIds: js.Array[String] = null,
    unitInvoice: Schema$UnitInvoice = null
  ): Schema$ShipmentInvoiceLineItemInvoice = {
    ...
    __obj.asInstanceOf[Schema$ShipmentInvoiceLineItemInvoice]
  }
}
