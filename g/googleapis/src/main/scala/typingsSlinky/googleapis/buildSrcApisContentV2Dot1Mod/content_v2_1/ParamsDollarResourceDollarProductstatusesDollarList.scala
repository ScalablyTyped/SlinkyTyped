...
@js.native
trait ParamsDollarResourceDollarProductstatusesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarProductstatusesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarProductstatusesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarProductstatusesDollarList]
  }
}
