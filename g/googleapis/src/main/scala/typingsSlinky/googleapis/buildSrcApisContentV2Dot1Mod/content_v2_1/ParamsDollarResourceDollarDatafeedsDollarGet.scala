...
@js.native
trait ParamsDollarResourceDollarDatafeedsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDatafeedsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDatafeedsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDatafeedsDollarGet]
  }
}
