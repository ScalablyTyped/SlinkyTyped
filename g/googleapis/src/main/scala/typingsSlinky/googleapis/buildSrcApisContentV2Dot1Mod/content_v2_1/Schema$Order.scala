...
trait Schema$Order extends js.Object {
  ...
  /**
    ...
    * be $80.
    */
  var netPriceAmount: js.UndefOr[Schema$Price] = js.native
  /**
    ...
    */
  var netTaxAmount: js.UndefOr[Schema$Price] = js.native
  /**
...
object Schema$Order {
  ...
  def apply(
    ...
    netPriceAmount: Schema$Price = null,
    netTaxAmount: Schema$Price = null,
