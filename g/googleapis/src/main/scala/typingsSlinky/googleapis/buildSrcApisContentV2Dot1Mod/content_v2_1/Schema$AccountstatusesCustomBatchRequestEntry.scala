...
/**
  ...
  */
@js.native
trait Schema$AccountstatusesCustomBatchRequestEntry extends js.Object {
  /**
...
object Schema$AccountstatusesCustomBatchRequestEntry {
  @scala.inline
  def apply(
    ...
    method: String = null
  ): Schema$AccountstatusesCustomBatchRequestEntry = {
    ...
    __obj.asInstanceOf[Schema$AccountstatusesCustomBatchRequestEntry]
  }
}
