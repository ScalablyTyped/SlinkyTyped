...
@js.native
trait ParamsDollarResourceDollarDatafeedsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDatafeedsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDatafeedsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDatafeedsDollarDelete]
  }
}
