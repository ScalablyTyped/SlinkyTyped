...
/**
  ...
  */
@js.native
trait Schema$GoogleAppsScriptTypeAddOnEntryPoint extends js.Object {
  /**
...
object Schema$GoogleAppsScriptTypeAddOnEntryPoint {
  @scala.inline
  def apply(
    ...
    title: String = null
  ): Schema$GoogleAppsScriptTypeAddOnEntryPoint = {
    ...
    __obj.asInstanceOf[Schema$GoogleAppsScriptTypeAddOnEntryPoint]
  }
}
