...
/**
  ...
  */
@js.native
trait Schema$GoogleAppsScriptTypeProcess extends js.Object {
  /**
...
object Schema$GoogleAppsScriptTypeProcess {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleAppsScriptTypeProcess = {
    ...
    __obj.asInstanceOf[Schema$GoogleAppsScriptTypeProcess]
  }
}
