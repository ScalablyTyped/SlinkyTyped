...
@js.native
trait Schema$DestinationTableProperties extends js.Object {
  /**
...
object Schema$DestinationTableProperties {
  @scala.inline
  def apply(description: String = null, friendlyName: String = null, labels: StringDictionary[String] = null): Schema$DestinationTableProperties = {
    val __obj = js.Dynamic.literal()
    if (description != null) __obj.updateDynamic("description")(description.asInstanceOf[js.Any])
    if (friendlyName != null) __obj.updateDynamic("friendlyName")(friendlyName.asInstanceOf[js.Any])
    if (labels != null) __obj.updateDynamic("labels")(labels.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$DestinationTableProperties]
  }
}
