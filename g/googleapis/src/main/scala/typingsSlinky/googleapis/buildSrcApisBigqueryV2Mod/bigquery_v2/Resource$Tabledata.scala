package typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2
...
@js.native
class Resource$Tabledata protected () extends js.Object {
  ...
  /**
    ...
    */
  def insertAll(): GaxiosPromise[Schema$TableDataInsertAllResponse] = js.native
  def insertAll(callback: BodyResponseCallback[Schema$TableDataInsertAllResponse]): Unit = js.native
  def insertAll(params: ParamsDollarResourceDollarTabledataDollarInsertall): GaxiosPromise[Schema$TableDataInsertAllResponse] = js.native
  def insertAll(
    params: ParamsDollarResourceDollarTabledataDollarInsertall,
    callback: BodyResponseCallback[Schema$TableDataInsertAllResponse]
  ): Unit = js.native
  def insertAll(
    params: ParamsDollarResourceDollarTabledataDollarInsertall,
    options: BodyResponseCallback[Schema$TableDataInsertAllResponse],
    callback: BodyResponseCallback[Schema$TableDataInsertAllResponse]
  ): Unit = js.native
  def insertAll(params: ParamsDollarResourceDollarTabledataDollarInsertall, options: MethodOptions): GaxiosPromise[Schema$TableDataInsertAllResponse] = js.native
  def insertAll(
    params: ParamsDollarResourceDollarTabledataDollarInsertall,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$TableDataList] = js.native
  def list(callback: BodyResponseCallback[Schema$TableDataList]): Unit = js.native
  def list(params: ParamsDollarResourceDollarTabledataDollarList): GaxiosPromise[Schema$TableDataList] = js.native
  def list(
    params: ParamsDollarResourceDollarTabledataDollarList,
    callback: BodyResponseCallback[Schema$TableDataList]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarTabledataDollarList,
    options: BodyResponseCallback[Schema$TableDataList],
    callback: BodyResponseCallback[Schema$TableDataList]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarTabledataDollarList, options: MethodOptions): GaxiosPromise[Schema$TableDataList] = js.native
  def list(
    params: ParamsDollarResourceDollarTabledataDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$TableDataList]
