...
import typingsSlinky.googleapis.Anon_InsertId
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Schema$TableDataInsertAllRequest extends js.Object {
  /**
  ...
  /**
    * The rows to insert.
    */
  var rows: js.UndefOr[js.Array[Anon_InsertId]] = js.native
  /**
...
object Schema$TableDataInsertAllRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$TableDataInsertAllRequest]
  }
}
