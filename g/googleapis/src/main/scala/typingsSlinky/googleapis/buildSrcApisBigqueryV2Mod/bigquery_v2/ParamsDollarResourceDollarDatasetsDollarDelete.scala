...
@js.native
trait ParamsDollarResourceDollarDatasetsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDatasetsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDatasetsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDatasetsDollarDelete]
  }
}
