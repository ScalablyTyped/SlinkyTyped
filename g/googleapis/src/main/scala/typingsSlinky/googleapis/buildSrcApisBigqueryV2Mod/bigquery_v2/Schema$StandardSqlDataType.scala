...
/**
  ...
  */
@js.native
trait Schema$StandardSqlDataType extends js.Object {
  /**
    * The type of the array&#39;s elements, if type_kind = &quot;ARRAY&quot;.
    */
  var arrayElementType: js.UndefOr[Schema$StandardSqlDataType] = js.native
  /**
    * The fields of this struct, in order, if type_kind = &quot;STRUCT&quot;.
    */
  var structType: js.UndefOr[Schema$StandardSqlStructType] = js.native
  /**
...
object Schema$StandardSqlDataType {
  @scala.inline
  def apply(
    arrayElementType: Schema$StandardSqlDataType = null,
    structType: Schema$StandardSqlStructType = null,
    ...
    __obj.asInstanceOf[Schema$StandardSqlDataType]
  }
}
