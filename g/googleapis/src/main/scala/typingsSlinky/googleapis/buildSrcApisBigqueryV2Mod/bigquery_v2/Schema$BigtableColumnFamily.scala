...
@js.native
trait Schema$BigtableColumnFamily extends js.Object {
  /**
    ...
    */
  var columns: js.UndefOr[js.Array[Schema$BigtableColumn]] = js.native
  /**
...
object Schema$BigtableColumnFamily {
  @scala.inline
  def apply(
    columns: js.Array[Schema$BigtableColumn] = null,
    ...
    __obj.asInstanceOf[Schema$BigtableColumnFamily]
  }
}
