...
@js.native
trait Schema$GoogleSheetsOptions extends js.Object {
  /**
...
object Schema$GoogleSheetsOptions {
  @scala.inline
  def apply(range: String = null, skipLeadingRows: String = null): Schema$GoogleSheetsOptions = {
    val __obj = js.Dynamic.literal()
    if (range != null) __obj.updateDynamic("range")(range.asInstanceOf[js.Any])
    if (skipLeadingRows != null) __obj.updateDynamic("skipLeadingRows")(skipLeadingRows.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleSheetsOptions]
  }
}
