...
@js.native
trait Schema$Clustering extends js.Object {
  /**
...
object Schema$Clustering {
  @scala.inline
  def apply(fields: js.Array[String] = null): Schema$Clustering = {
    val __obj = js.Dynamic.literal()
    if (fields != null) __obj.updateDynamic("fields")(fields.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$Clustering]
  }
}
