...
@js.native
trait Schema$Streamingbuffer extends js.Object {
  /**
...
object Schema$Streamingbuffer {
  @scala.inline
  def apply(estimatedBytes: String = null, estimatedRows: String = null, oldestEntryTime: String = null): Schema$Streamingbuffer = {
    ...
    __obj.asInstanceOf[Schema$Streamingbuffer]
  }
}
