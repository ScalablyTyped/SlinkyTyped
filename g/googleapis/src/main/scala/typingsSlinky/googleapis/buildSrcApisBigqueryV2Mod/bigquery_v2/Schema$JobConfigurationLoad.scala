...
@js.native
trait Schema$JobConfigurationLoad extends js.Object {
  /**
  ...
  /**
    ...
    * if it is new.
    */
  var destinationTableProperties: js.UndefOr[Schema$DestinationTableProperties] = js.native
  /**
...
object Schema$JobConfigurationLoad {
  @scala.inline
  def apply(
    ...
    destinationTableProperties: Schema$DestinationTableProperties = null,
    ...
    __obj.asInstanceOf[Schema$JobConfigurationLoad]
  }
}
