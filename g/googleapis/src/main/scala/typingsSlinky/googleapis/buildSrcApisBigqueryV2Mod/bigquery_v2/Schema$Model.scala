...
@js.native
trait Schema$Model extends js.Object {
  /**
  ...
  /**
    ...
    */
  var featureColumns: js.UndefOr[js.Array[Schema$StandardSqlField]] = js.native
  /**
  ...
  /**
    ...
    */
  var labelColumns: js.UndefOr[js.Array[Schema$StandardSqlField]] = js.native
  /**
  ...
  /**
    ...
    */
  var modelReference: js.UndefOr[Schema$ModelReference] = js.native
  /**
  ...
  /**
    ...
    * start_time.
    */
  var trainingRuns: js.UndefOr[js.Array[Schema$TrainingRun]] = js.native
}
...
object Schema$Model {
  ...
  def apply(
    ...
    featureColumns: js.Array[Schema$StandardSqlField] = null,
    friendlyName: String = null,
    labelColumns: js.Array[Schema$StandardSqlField] = null,
    labels: StringDictionary[String] = null,
    lastModifiedTime: String = null,
    location: String = null,
    modelReference: Schema$ModelReference = null,
    modelType: String = null,
    trainingRuns: js.Array[Schema$TrainingRun] = null
  ): Schema$Model = {
    ...
    __obj.asInstanceOf[Schema$Model]
  }
}
