...
@js.native
trait Schema$ExternalDataConfiguration extends js.Object {
  /**
  ...
  /**
    ...
    */
  var bigtableOptions: js.UndefOr[Schema$BigtableOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var csvOptions: js.UndefOr[Schema$CsvOptions] = js.native
  /**
    * [Optional] Additional options if sourceFormat is set to GOOGLE_SHEETS.
    */
  var googleSheetsOptions: js.UndefOr[Schema$GoogleSheetsOptions] = js.native
  /**
...
object Schema$ExternalDataConfiguration {
  @scala.inline
  def apply(
    autodetect: js.UndefOr[Boolean] = js.undefined,
    bigtableOptions: Schema$BigtableOptions = null,
    compression: String = null,
    csvOptions: Schema$CsvOptions = null,
    googleSheetsOptions: Schema$GoogleSheetsOptions = null,
    ...
    __obj.asInstanceOf[Schema$ExternalDataConfiguration]
  }
}
