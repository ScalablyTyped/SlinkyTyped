...
object ParamsResourceProjectsLocationsJobsRun {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsJobsRun = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsJobsRun]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsJobsRunMutableBuilder[Self <: ParamsResourceProjectsLocationsJobsRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRunJobRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
