...
object ParamsResourceProjectsLocationsJobsRun {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsJobsRunOps[Self <: ParamsResourceProjectsLocationsJobsRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRunJobRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
