package typingsSlinky.googleapis.buildSrcApisFactchecktoolsV1alpha1Mod.factchecktools_v1alpha1
...
/**
  ...
  */
@js.native
trait Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup extends js.Object {
  /**
  ...
  /**
    ...
    */
  var claimAuthor: js.UndefOr[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimAuthor] = js.native
  /**
  ...
  /**
    ...
    */
  var rating: js.UndefOr[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating] = js.native
  /**
...
object Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup {
  @scala.inline
  def apply(
    claimAppearances: js.Array[String] = null,
    claimAuthor: Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimAuthor = null,
    claimDate: String = null,
    claimFirstAppearance: String = null,
    claimLocation: String = null,
    claimReviewed: String = null,
    rating: Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating = null,
    url: String = null
    ...
    __obj.asInstanceOf[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup]
  }
}
