...
/**
  ...
  */
@js.native
trait Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating extends js.Object {
  /**
...
object Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating = {
    ...
    __obj.asInstanceOf[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating]
  }
}
