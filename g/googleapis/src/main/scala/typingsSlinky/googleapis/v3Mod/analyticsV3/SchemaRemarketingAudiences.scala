...
/**
  ...
  */
@js.native
trait SchemaRemarketingAudiences extends js.Object {
...
object SchemaRemarketingAudiences {
  ...
  @scala.inline
  implicit class SchemaRemarketingAudiencesOps[Self <: SchemaRemarketingAudiences] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaRemarketingAudience*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaRemarketingAudience]): Self = this.set("items", value.asInstanceOf[js.Any])
