...
object ParamsResourceManagementWebpropertyadwordslinksUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceManagementWebpropertyadwordslinksUpdateOps[Self <: ParamsResourceManagementWebpropertyadwordslinksUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaEntityAdWordsLink): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWebPropertyAdWordsLinkId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("webPropertyAdWordsLinkId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWebPropertyAdWordsLinkId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("webPropertyAdWordsLinkId")(js.undefined)
        ret
    }
    @scala.inline
