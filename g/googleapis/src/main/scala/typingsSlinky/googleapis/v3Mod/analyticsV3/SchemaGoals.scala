...
/**
  ...
  */
@js.native
trait SchemaGoals extends StObject {
...
object SchemaGoals {
  ...
  @scala.inline
  implicit class SchemaGoalsMutableBuilder[Self <: SchemaGoals] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setItems(value: js.Array[SchemaGoal]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaGoal*): Self = StObject.set(x, "items", js.Array(value :_*))
