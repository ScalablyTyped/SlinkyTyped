...
object ParamsResourceManagementWebpropertyuserlinksDelete {
  ...
  @scala.inline
  implicit class ParamsResourceManagementWebpropertyuserlinksDeleteMutableBuilder[Self <: ParamsResourceManagementWebpropertyuserlinksDelete] (val x: Self) extends AnyVal {
