...
@js.native
trait ParamsResourceManagementAccountuserlinksList extends StandardParameters {
...
object ParamsResourceManagementAccountuserlinksList {
  ...
  @scala.inline
  def apply(): ParamsResourceManagementAccountuserlinksList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementAccountuserlinksList]
  }
  
  @scala.inline
  implicit class ParamsResourceManagementAccountuserlinksListMutableBuilder[Self <: ParamsResourceManagementAccountuserlinksList] (val x: Self) extends AnyVal {
