...
object ParamsResourceManagementProfilefilterlinksPatch {
  ...
  @scala.inline
  implicit class ParamsResourceManagementProfilefilterlinksPatchMutableBuilder[Self <: ParamsResourceManagementProfilefilterlinksPatch] (val x: Self) extends AnyVal {
