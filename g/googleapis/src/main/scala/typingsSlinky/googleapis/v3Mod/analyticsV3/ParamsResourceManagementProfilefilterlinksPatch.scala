...
object ParamsResourceManagementProfilefilterlinksPatch {
  @scala.inline
  def apply(): ParamsResourceManagementProfilefilterlinksPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementProfilefilterlinksPatch]
  }
  @scala.inline
  implicit class ParamsResourceManagementProfilefilterlinksPatchOps[Self <: ParamsResourceManagementProfilefilterlinksPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRequestBody(value: SchemaProfileFilterLink): Self = {
        val ret = this.duplicate
