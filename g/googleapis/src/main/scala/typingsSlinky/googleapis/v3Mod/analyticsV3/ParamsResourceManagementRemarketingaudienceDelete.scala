...
object ParamsResourceManagementRemarketingaudienceDelete {
  ...
  @scala.inline
  implicit class ParamsResourceManagementRemarketingaudienceDeleteMutableBuilder[Self <: ParamsResourceManagementRemarketingaudienceDelete] (val x: Self) extends AnyVal {
