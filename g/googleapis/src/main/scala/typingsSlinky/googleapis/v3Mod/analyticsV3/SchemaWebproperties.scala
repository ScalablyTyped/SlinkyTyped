...
/**
  ...
  */
@js.native
trait SchemaWebproperties extends js.Object {
  
  /**
    * A list of web properties.
    */
  var items: js.UndefOr[js.Array[SchemaWebproperty]] = js.native
...
object SchemaWebproperties {
  ...
  @scala.inline
  implicit class SchemaWebpropertiesOps[Self <: SchemaWebproperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaWebproperty*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaWebproperty]): Self = this.set("items", value.asInstanceOf[js.Any])
