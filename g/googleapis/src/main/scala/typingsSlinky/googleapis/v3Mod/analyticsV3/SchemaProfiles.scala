...
object SchemaProfiles {
  ...
  @scala.inline
  implicit class SchemaProfilesOps[Self <: SchemaProfiles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaProfile*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaProfile]): Self = this.set("items", value.asInstanceOf[js.Any])
