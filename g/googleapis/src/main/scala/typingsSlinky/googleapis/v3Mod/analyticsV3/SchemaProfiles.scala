...
/**
  ...
  */
@js.native
trait SchemaProfiles extends StObject {
...
object SchemaProfiles {
  ...
  @scala.inline
  def apply(): SchemaProfiles = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaProfiles]
  }
  
  @scala.inline
  implicit class SchemaProfilesMutableBuilder[Self <: SchemaProfiles] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setItems(value: js.Array[SchemaProfile]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaProfile*): Self = StObject.set(x, "items", js.Array(value :_*))
