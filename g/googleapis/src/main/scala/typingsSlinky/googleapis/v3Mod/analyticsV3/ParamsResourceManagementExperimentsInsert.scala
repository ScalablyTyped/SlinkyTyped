...
object ParamsResourceManagementExperimentsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceManagementExperimentsInsertMutableBuilder[Self <: ParamsResourceManagementExperimentsInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaExperiment): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
