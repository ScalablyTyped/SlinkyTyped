...
@js.native
trait ParamsResourceManagementAccountuserlinksUpdate extends StandardParameters {
  /**
...
object ParamsResourceManagementAccountuserlinksUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceManagementAccountuserlinksUpdateOps[Self <: ParamsResourceManagementAccountuserlinksUpdate] (val x: Self) extends AnyVal {
    @scala.inline
