...
@js.native
trait ParamsResourceManagementProfileuserlinksInsert extends StandardParameters {
  /**
...
object ParamsResourceManagementProfileuserlinksInsert {
  @scala.inline
  def apply(): ParamsResourceManagementProfileuserlinksInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementProfileuserlinksInsert]
  }
  @scala.inline
  implicit class ParamsResourceManagementProfileuserlinksInsertOps[Self <: ParamsResourceManagementProfileuserlinksInsert] (val x: Self) extends AnyVal {
    @scala.inline
