...
object SchemaExperiments {
  ...
  implicit class SchemaExperimentsOps[Self <: SchemaExperiments] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaExperiment*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaExperiment]): Self = this.set("items", value.asInstanceOf[js.Any])
