...
object ParamsResourceManagementUnsampledreportsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceManagementUnsampledreportsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementUnsampledreportsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceManagementUnsampledreportsGetMutableBuilder[Self <: ParamsResourceManagementUnsampledreportsGet] (val x: Self) extends AnyVal {
