...
/**
  ...
  */
@js.native
trait SchemaUploads extends StObject {
...
object SchemaUploads {
  ...
  @scala.inline
  implicit class SchemaUploadsMutableBuilder[Self <: SchemaUploads] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setItems(value: js.Array[SchemaUpload]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaUpload*): Self = StObject.set(x, "items", js.Array(value :_*))
