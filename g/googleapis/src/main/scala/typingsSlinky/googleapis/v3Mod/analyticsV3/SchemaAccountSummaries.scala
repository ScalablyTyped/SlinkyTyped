...
/**
  ...
  */
@js.native
trait SchemaAccountSummaries extends StObject {
...
object SchemaAccountSummaries {
  ...
  @scala.inline
  implicit class SchemaAccountSummariesMutableBuilder[Self <: SchemaAccountSummaries] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setItems(value: js.Array[SchemaAccountSummary]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaAccountSummary*): Self = StObject.set(x, "items", js.Array(value :_*))
