...
object SchemaEntityUserLinks {
  ...
  @scala.inline
  implicit class SchemaEntityUserLinksOps[Self <: SchemaEntityUserLinks] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaEntityUserLink*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaEntityUserLink]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
