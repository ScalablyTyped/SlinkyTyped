...
@js.native
trait ParamsResourcePartnersVendorsList extends StandardParameters {
...
object ParamsResourcePartnersVendorsList {
  ...
  @scala.inline
  implicit class ParamsResourcePartnersVendorsListOps[Self <: ParamsResourcePartnersVendorsList] (val x: Self) extends AnyVal {
