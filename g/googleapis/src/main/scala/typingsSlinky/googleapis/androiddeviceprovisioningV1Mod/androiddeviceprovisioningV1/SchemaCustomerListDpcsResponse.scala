...
object SchemaCustomerListDpcsResponse {
  ...
  implicit class SchemaCustomerListDpcsResponseOps[Self <: SchemaCustomerListDpcsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDpcs(value: js.Array[SchemaDpc]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dpcs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDpcs: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dpcs")(js.undefined)
        ret
    }
  }
