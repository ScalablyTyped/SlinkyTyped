...
@js.native
trait ParamsResourcePartnersDevicesGet extends StandardParameters {
...
object ParamsResourcePartnersDevicesGet {
  ...
  @scala.inline
  def apply(): ParamsResourcePartnersDevicesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePartnersDevicesGet]
  }
  
  @scala.inline
  implicit class ParamsResourcePartnersDevicesGetMutableBuilder[Self <: ParamsResourcePartnersDevicesGet] (val x: Self) extends AnyVal {
