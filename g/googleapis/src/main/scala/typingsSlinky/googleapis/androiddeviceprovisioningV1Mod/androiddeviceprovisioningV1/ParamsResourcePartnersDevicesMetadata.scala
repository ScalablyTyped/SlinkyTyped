...
object ParamsResourcePartnersDevicesMetadata {
  ...
  implicit class ParamsResourcePartnersDevicesMetadataOps[Self <: ParamsResourcePartnersDevicesMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutMetadataOwnerId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("metadataOwnerId")(js.undefined)
        ret
    }
    @scala.inline
    def withRequestBody(value: SchemaUpdateDeviceMetadataRequest): Self = {
        val ret = this.duplicate
