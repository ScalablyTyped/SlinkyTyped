...
object ParamsResourcePartnersCustomersCreate {
  ...
  @scala.inline
  def apply(): ParamsResourcePartnersCustomersCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePartnersCustomersCreate]
  }
  
  @scala.inline
  implicit class ParamsResourcePartnersCustomersCreateMutableBuilder[Self <: ParamsResourcePartnersCustomersCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateCustomerRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
