...
object ParamsResourcePartnersCustomersCreate {
  ...
  @scala.inline
  implicit class ParamsResourcePartnersCustomersCreateOps[Self <: ParamsResourcePartnersCustomersCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateCustomerRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
