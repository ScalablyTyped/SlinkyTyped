...
@js.native
trait ParamsResourceCustomersDevicesGet extends StandardParameters {
...
object ParamsResourceCustomersDevicesGet {
  ...
  @scala.inline
  def apply(): ParamsResourceCustomersDevicesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersDevicesGet]
  }
  
  @scala.inline
  implicit class ParamsResourceCustomersDevicesGetMutableBuilder[Self <: ParamsResourceCustomersDevicesGet] (val x: Self) extends AnyVal {
