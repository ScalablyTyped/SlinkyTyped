...
object ParamsResourceAchievementsUpdatemultiple {
  ...
  implicit class ParamsResourceAchievementsUpdatemultipleOps[Self <: ParamsResourceAchievementsUpdatemultiple] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBuiltinGameId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("builtinGameId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBuiltinGameId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("builtinGameId")(js.undefined)
        ret
    }
    @scala.inline
    def withRequestBody(value: SchemaAchievementUpdateMultipleRequest): Self = {
        val ret = this.duplicate
