...
@js.native
trait ParamsResourceMetagameListcategoriesbyplayer extends StandardParameters {
...
object ParamsResourceMetagameListcategoriesbyplayer {
  ...
  @scala.inline
  def apply(): ParamsResourceMetagameListcategoriesbyplayer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMetagameListcategoriesbyplayer]
  }
  
  @scala.inline
  implicit class ParamsResourceMetagameListcategoriesbyplayerMutableBuilder[Self <: ParamsResourceMetagameListcategoriesbyplayer] (val x: Self) extends AnyVal {
