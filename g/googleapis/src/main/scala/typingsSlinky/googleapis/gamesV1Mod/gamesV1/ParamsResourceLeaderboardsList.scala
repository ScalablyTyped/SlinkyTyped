...
@js.native
trait ParamsResourceLeaderboardsList extends StandardParameters {
...
object ParamsResourceLeaderboardsList {
  ...
  @scala.inline
  def apply(): ParamsResourceLeaderboardsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLeaderboardsList]
  }
  
  @scala.inline
  implicit class ParamsResourceLeaderboardsListMutableBuilder[Self <: ParamsResourceLeaderboardsList] (val x: Self) extends AnyVal {
