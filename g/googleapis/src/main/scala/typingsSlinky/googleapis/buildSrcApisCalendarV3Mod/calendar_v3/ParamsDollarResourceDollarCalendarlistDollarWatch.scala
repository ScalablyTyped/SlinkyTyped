...
@js.native
trait ParamsDollarResourceDollarCalendarlistDollarWatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCalendarlistDollarWatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCalendarlistDollarWatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCalendarlistDollarWatch]
  }
}
