...
@js.native
trait ParamsDollarResourceDollarSettingsDollarWatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSettingsDollarWatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSettingsDollarWatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSettingsDollarWatch]
  }
}
