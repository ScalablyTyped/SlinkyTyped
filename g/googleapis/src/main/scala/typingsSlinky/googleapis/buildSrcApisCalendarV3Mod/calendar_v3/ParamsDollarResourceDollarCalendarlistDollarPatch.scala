...
@js.native
trait ParamsDollarResourceDollarCalendarlistDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCalendarlistDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCalendarlistDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCalendarlistDollarPatch]
  }
}
