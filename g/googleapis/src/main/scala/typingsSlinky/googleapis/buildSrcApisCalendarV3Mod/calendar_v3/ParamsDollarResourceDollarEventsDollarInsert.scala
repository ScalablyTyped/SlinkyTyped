...
@js.native
trait ParamsDollarResourceDollarEventsDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Event] = js.native
  /**
...
object ParamsDollarResourceDollarEventsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEventsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEventsDollarInsert]
  }
}
