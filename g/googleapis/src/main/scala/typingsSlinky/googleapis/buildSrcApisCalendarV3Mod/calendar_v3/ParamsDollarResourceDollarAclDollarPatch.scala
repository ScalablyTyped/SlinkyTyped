...
@js.native
trait ParamsDollarResourceDollarAclDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAclDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAclDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAclDollarPatch]
  }
}
