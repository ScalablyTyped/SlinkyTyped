...
@js.native
trait ParamsDollarResourceDollarCalendarlistDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCalendarlistDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCalendarlistDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCalendarlistDollarUpdate]
  }
}
