...
@js.native
trait ParamsDollarResourceDollarAclDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAclDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAclDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAclDollarUpdate]
  }
}
