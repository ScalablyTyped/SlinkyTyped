...
@js.native
trait ParamsDollarResourceDollarEventsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEventsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEventsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEventsDollarPatch]
  }
}
