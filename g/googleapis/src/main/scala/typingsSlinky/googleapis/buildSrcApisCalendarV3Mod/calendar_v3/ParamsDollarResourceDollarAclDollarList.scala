...
@js.native
trait ParamsDollarResourceDollarAclDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAclDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAclDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAclDollarList]
  }
}
