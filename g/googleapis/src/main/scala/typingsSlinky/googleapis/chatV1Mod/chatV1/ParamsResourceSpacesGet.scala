...
@js.native
trait ParamsResourceSpacesGet extends StandardParameters {
...
object ParamsResourceSpacesGet {
  ...
  @scala.inline
  implicit class ParamsResourceSpacesGetOps[Self <: ParamsResourceSpacesGet] (val x: Self) extends AnyVal {
