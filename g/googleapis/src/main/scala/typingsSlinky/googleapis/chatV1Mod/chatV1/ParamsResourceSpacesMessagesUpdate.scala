...
object ParamsResourceSpacesMessagesUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceSpacesMessagesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSpacesMessagesUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceSpacesMessagesUpdateMutableBuilder[Self <: ParamsResourceSpacesMessagesUpdate] (val x: Self) extends AnyVal {
