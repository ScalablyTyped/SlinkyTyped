...
object SchemaValueMapValEntry {
  ...
  @scala.inline
  implicit class SchemaValueMapValEntryOps[Self <: SchemaValueMapValEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: SchemaMapValue): Self = this.set("value", value.asInstanceOf[js.Any])
