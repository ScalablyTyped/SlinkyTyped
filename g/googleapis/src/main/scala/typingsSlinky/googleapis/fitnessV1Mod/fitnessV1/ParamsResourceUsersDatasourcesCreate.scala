...
@js.native
trait ParamsResourceUsersDatasourcesCreate extends StandardParameters {
...
object ParamsResourceUsersDatasourcesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersDatasourcesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersDatasourcesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersDatasourcesCreateMutableBuilder[Self <: ParamsResourceUsersDatasourcesCreate] (val x: Self) extends AnyVal {
