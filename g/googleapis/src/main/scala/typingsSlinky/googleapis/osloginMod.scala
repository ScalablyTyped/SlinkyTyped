...
import typingsSlinky.googleapis.osloginV1Mod.osloginV1.Options
...
object osloginMod {
  ...
  object VERSIONS {
    ...
    def v1alpha: Instantiable2[
        ...
        typingsSlinky.googleapis.osloginV1alphaMod.osloginV1alpha.Oslogin
      ] = js.native
    @scala.inline
    def v1alpha_=(
      x: Instantiable2[
    ...
    def v1beta: Instantiable2[
        /* options */ GlobalOptions, 
        /* google */ js.UndefOr[GoogleConfigurable], 
        typingsSlinky.googleapis.osloginV1betaMod.osloginV1beta.Oslogin
      ] = js.native
    @scala.inline
    def v1beta_=(
      x: Instantiable2[
