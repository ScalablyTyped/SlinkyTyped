...
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$Clustering
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$TableReference
import typingsSlinky.googleapis.buildSrcApisBigqueryV2Mod.bigquery_v2.Schema$TimePartitioning
