...
object SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponse {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponse]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponseMutableBuilder[Self <: SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponse] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBindings(value: js.Array[SchemaGoogleCloudServicebrokerV1beta1Binding]): Self = StObject.set(x, "bindings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBindingsUndefined: Self = StObject.set(x, "bindings", js.undefined)
    
    @scala.inline
    def setBindingsVarargs(value: SchemaGoogleCloudServicebrokerV1beta1Binding*): Self = StObject.set(x, "bindings", js.Array(value :_*))
