...
object SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponseOps[Self <: SchemaGoogleCloudServicebrokerV1beta1ListBindingsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBindingsVarargs(value: SchemaGoogleCloudServicebrokerV1beta1Binding*): Self = this.set("bindings", js.Array(value :_*))
    
    @scala.inline
    def setBindings(value: js.Array[SchemaGoogleCloudServicebrokerV1beta1Binding]): Self = this.set("bindings", value.asInstanceOf[js.Any])
