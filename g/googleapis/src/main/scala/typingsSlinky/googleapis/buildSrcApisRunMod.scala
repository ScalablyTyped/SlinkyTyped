...
import typingsSlinky.googleapis.buildSrcApisRunV1Mod.run_v1.Options
import typingsSlinky.googleapis.buildSrcApisRunV1Mod.run_v1.Run
...
object buildSrcApisRunMod extends js.Object {
  ...
  def run(options: typingsSlinky.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Options): typingsSlinky.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Run = js.native
  @JSName("run")
  def run_v1(version: v1): Run = js.native
  @JSName("run")
  def run_v1alpha1(version: v1alpha1): typingsSlinky.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Run = js.native
  @js.native
    ...
    object v1alpha1
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Run
              ]
            ]
