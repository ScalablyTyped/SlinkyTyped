...
/**
  ...
  */
@js.native
trait Schema$EventRecordRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var timePeriods: js.UndefOr[js.Array[Schema$EventPeriodUpdate]] = js.native
}

object Schema$EventRecordRequest {
  @scala.inline
  def apply(
    currentTimeMillis: String = null,
    kind: String = null,
    requestId: String = null,
    timePeriods: js.Array[Schema$EventPeriodUpdate] = null
  ): Schema$EventRecordRequest = {
    ...
    __obj.asInstanceOf[Schema$EventRecordRequest]
  }
}
