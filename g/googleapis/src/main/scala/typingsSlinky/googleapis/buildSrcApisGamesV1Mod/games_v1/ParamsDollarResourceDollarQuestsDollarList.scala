...
@js.native
trait ParamsDollarResourceDollarQuestsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarQuestsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarQuestsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarQuestsDollarList]
  }
}
