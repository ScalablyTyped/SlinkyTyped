...
@js.native
trait ParamsDollarResourceDollarQuestmilestonesDollarClaim extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarQuestmilestonesDollarClaim {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarQuestmilestonesDollarClaim = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarQuestmilestonesDollarClaim]
  }
}
