...
@js.native
trait ParamsDollarResourceDollarTurnbasedmatchesDollarLeaveturn extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTurnbasedmatchesDollarLeaveturn {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTurnbasedmatchesDollarLeaveturn = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTurnbasedmatchesDollarLeaveturn]
  }
}
