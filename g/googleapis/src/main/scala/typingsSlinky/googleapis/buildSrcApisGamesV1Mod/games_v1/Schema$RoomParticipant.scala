...
/**
  ...
  */
@js.native
trait Schema$RoomParticipant extends js.Object {
  /**
  ...
  /**
    ...
    */
  var autoMatchedPlayer: js.UndefOr[Schema$AnonymousPlayer] = js.native
  /**
...
object Schema$RoomParticipant {
  @scala.inline
  def apply(
    autoMatched: js.UndefOr[Boolean] = js.undefined,
    autoMatchedPlayer: Schema$AnonymousPlayer = null,
    ...
    __obj.asInstanceOf[Schema$RoomParticipant]
  }
}
