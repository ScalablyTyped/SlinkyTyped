...
/**
  ...
  */
@js.native
trait Schema$PlayerScoreResponse extends js.Object {
  /**
  ...
  /**
    ...
    * spans.
    */
  var unbeatenScores: js.UndefOr[js.Array[Schema$PlayerScore]] = js.native
}

object Schema$PlayerScoreResponse {
  @scala.inline
  def apply(
    ...
    unbeatenScores: js.Array[Schema$PlayerScore] = null
  ): Schema$PlayerScoreResponse = {
    ...
    __obj.asInstanceOf[Schema$PlayerScoreResponse]
  }
}
