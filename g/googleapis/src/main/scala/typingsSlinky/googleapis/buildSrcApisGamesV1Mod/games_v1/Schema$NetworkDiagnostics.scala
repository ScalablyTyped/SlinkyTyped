...
/**
  ...
  */
@js.native
trait Schema$NetworkDiagnostics extends js.Object {
  /**
...
object Schema$NetworkDiagnostics {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$NetworkDiagnostics]
  }
}
