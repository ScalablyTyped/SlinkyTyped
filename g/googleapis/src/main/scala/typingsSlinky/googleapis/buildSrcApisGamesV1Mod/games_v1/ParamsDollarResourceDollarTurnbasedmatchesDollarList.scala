...
@js.native
trait ParamsDollarResourceDollarTurnbasedmatchesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTurnbasedmatchesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTurnbasedmatchesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTurnbasedmatchesDollarList]
  }
}
