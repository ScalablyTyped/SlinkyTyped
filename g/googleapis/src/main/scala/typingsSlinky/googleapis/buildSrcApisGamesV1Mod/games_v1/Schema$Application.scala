...
trait Schema$Application extends js.Object {
  ...
  /**
    ...
    */
  var assets: js.UndefOr[js.Array[Schema$ImageAsset]] = js.native
  /**
  ...
  /**
    ...
    */
  var category: js.UndefOr[Schema$ApplicationCategory] = js.native
  /**
...
object Schema$Application {
  ...
  def apply(
    ...
    assets: js.Array[Schema$ImageAsset] = null,
    author: String = null,
    category: Schema$ApplicationCategory = null,
