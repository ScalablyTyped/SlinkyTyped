...
/**
  ...
  */
@js.native
trait Schema$TurnBasedMatchParticipant extends js.Object {
  /**
...
object Schema$TurnBasedMatchParticipant {
  @scala.inline
  def apply(
    ...
    status: String = null
  ): Schema$TurnBasedMatchParticipant = {
    ...
    __obj.asInstanceOf[Schema$TurnBasedMatchParticipant]
  }
}
