...
/**
  ...
  */
@js.native
trait Schema$TurnBasedMatchCreateRequest extends js.Object {
  /**
...
object Schema$TurnBasedMatchCreateRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$TurnBasedMatchCreateRequest = {
    ...
    __obj.asInstanceOf[Schema$TurnBasedMatchCreateRequest]
  }
}
