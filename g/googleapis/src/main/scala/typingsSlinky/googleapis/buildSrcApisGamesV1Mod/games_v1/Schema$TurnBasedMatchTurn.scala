...
/**
  ...
  */
@js.native
trait Schema$TurnBasedMatchTurn extends js.Object {
  /**
...
object Schema$TurnBasedMatchTurn {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$TurnBasedMatchTurn]
  }
}
