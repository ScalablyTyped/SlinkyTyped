...
/**
  ...
  */
@js.native
trait Schema$LeaderboardScores extends js.Object {
  /**
    * The scores in the leaderboard.
    */
  var items: js.UndefOr[js.Array[Schema$LeaderboardEntry]] = js.native
  /**
  ...
  /**
    ...
    * not be present.
    */
  var playerScore: js.UndefOr[Schema$LeaderboardEntry] = js.native
  /**
...
object Schema$LeaderboardScores {
  @scala.inline
  def apply(
    items: js.Array[Schema$LeaderboardEntry] = null,
    kind: String = null,
    nextPageToken: String = null,
    numScores: String = null,
    playerScore: Schema$LeaderboardEntry = null,
    prevPageToken: String = null
  ): Schema$LeaderboardScores = {
    ...
    __obj.asInstanceOf[Schema$LeaderboardScores]
  }
}
