...
@js.native
trait ParamsDollarResourceDollarScoresDollarSubmit extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarScoresDollarSubmit {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarScoresDollarSubmit = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarScoresDollarSubmit]
  }
}
