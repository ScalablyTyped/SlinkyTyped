...
/**
  ...
  */
@js.native
trait Schema$EventDefinition extends js.Object {
  /**
    * A list of events that are a child of this event.
    */
  var childEvents: js.UndefOr[js.Array[Schema$EventChild]] = js.native
  /**
...
object Schema$EventDefinition {
  @scala.inline
  def apply(
    childEvents: js.Array[Schema$EventChild] = null,
    ...
    __obj.asInstanceOf[Schema$EventDefinition]
  }
}
