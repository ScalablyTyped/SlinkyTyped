...
import typingsSlinky.googleapis.Anon_FamilyName
...
trait Schema$Player extends js.Object {
  ...
  /**
    ...
    */
  var experienceInfo: js.UndefOr[Schema$PlayerExperienceInfo] = js.native
  /**
  ...
  /**
    ...
    * collection members.
    */
  var lastPlayedWith: js.UndefOr[Schema$Played] = js.native
  /**
...
object Schema$Player {
  ...
  def apply(
    ...
    experienceInfo: Schema$PlayerExperienceInfo = null,
    kind: String = null,
    lastPlayedWith: Schema$Played = null,
