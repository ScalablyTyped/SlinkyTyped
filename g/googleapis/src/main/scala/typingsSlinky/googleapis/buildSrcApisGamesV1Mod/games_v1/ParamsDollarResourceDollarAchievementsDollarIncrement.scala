...
@js.native
trait ParamsDollarResourceDollarAchievementsDollarIncrement extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAchievementsDollarIncrement {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAchievementsDollarIncrement = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAchievementsDollarIncrement]
  }
}
