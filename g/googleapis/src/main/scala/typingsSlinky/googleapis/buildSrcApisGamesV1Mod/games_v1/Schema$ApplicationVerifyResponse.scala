...
/**
  ...
  */
@js.native
trait Schema$ApplicationVerifyResponse extends js.Object {
  /**
...
object Schema$ApplicationVerifyResponse {
  @scala.inline
  def apply(alternate_player_id: String = null, kind: String = null, player_id: String = null): Schema$ApplicationVerifyResponse = {
    ...
    __obj.asInstanceOf[Schema$ApplicationVerifyResponse]
  }
}
