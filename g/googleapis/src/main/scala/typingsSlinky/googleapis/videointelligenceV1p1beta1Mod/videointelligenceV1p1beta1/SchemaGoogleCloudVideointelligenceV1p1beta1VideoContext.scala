...
object SchemaGoogleCloudVideointelligenceV1p1beta1VideoContext {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1VideoContextOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1VideoContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExplicitContentDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p1beta1ExplicitContentDetectionConfig): Self = {
    ...
    @scala.inline
    def withLabelDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSegments(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1VideoSegment]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShotChangeDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p1beta1ShotChangeDetectionConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpeechTranscriptionConfig(value: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p1beta1TextDetectionConfig): Self = {
        val ret = this.duplicate
