...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox extends js.Object {
  /**
    * Bottom Y coordinate.
    */
...
object SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBoxOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox] (val x: Self) extends AnyVal {
    @scala.inline
