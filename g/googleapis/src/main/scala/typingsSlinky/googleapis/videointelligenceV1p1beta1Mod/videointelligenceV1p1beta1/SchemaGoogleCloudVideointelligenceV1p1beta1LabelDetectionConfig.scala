...
object SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig] (val x: Self) extends AnyVal {
