...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig] (val x: Self) extends AnyVal {
