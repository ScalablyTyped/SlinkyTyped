...
object SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotationOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEntity(value: SchemaGoogleCloudVideointelligenceV1p1beta1Entity): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame]): Self = {
        val ret = this.duplicate
