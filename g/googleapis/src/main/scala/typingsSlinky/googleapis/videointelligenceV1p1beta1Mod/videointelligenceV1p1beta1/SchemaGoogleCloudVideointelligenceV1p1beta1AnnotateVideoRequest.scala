...
object SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVideoContext(value: SchemaGoogleCloudVideointelligenceV1p1beta1VideoContext): Self = StObject.set(x, "videoContext", value.asInstanceOf[js.Any])
