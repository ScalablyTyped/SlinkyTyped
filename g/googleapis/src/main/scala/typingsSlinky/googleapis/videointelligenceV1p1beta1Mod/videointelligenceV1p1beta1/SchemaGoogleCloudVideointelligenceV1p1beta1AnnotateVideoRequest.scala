...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest extends js.Object {
  ...
  /**
    ...
    */
  var videoContext: js.UndefOr[SchemaGoogleCloudVideointelligenceV1p1beta1VideoContext] = js.native
}
object SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVideoContext(value: SchemaGoogleCloudVideointelligenceV1p1beta1VideoContext): Self = this.set("videoContext", value.asInstanceOf[js.Any])
