...
object SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponseMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAnnotationResults(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationResults]): Self = StObject.set(x, "annotationResults", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAnnotationResultsUndefined: Self = StObject.set(x, "annotationResults", js.undefined)
    
    @scala.inline
    def setAnnotationResultsVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationResults*): Self = StObject.set(x, "annotationResults", js.Array(value :_*))
  }
}
