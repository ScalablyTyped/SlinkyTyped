...
object SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse {
  @scala.inline
  def apply(
    annotationResults: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationResults] = null
  ): SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse = {
