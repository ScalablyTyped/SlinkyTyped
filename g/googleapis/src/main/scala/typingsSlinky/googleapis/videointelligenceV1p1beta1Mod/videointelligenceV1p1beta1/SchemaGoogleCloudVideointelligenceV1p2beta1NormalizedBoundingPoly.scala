...
object SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingPoly {
  @scala.inline
  def apply(vertices: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedVertex] = null): SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingPoly = {
