...
object SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotation {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotationOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCategoryEntities(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1Entity]): Self = {
    ...
    @scala.inline
    def withFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1LabelFrame]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSegments(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1LabelSegment]): Self = {
        val ret = this.duplicate
