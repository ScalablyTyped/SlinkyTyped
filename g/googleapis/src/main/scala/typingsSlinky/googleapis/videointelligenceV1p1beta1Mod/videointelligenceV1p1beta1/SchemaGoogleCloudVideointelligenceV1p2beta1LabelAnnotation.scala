...
object SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotationOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCategoryEntitiesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1Entity*): Self = this.set("categoryEntities", js.Array(value :_*))
    
    @scala.inline
    def setCategoryEntities(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1Entity]): Self = this.set("categoryEntities", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1LabelFrame*): Self = this.set("frames", js.Array(value :_*))
    
    @scala.inline
    def setFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1LabelFrame]): Self = this.set("frames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFrames: Self = this.set("frames", js.undefined)
    
    @scala.inline
    def setSegmentsVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1LabelSegment*): Self = this.set("segments", js.Array(value :_*))
    
    @scala.inline
    def setSegments(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1LabelSegment]): Self = this.set("segments", value.asInstanceOf[js.Any])
