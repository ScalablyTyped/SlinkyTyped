...
import typingsSlinky.googleapis.buildSrcApisTagmanagerV1Mod.tagmanager_v1.Options
import typingsSlinky.googleapis.buildSrcApisTagmanagerV1Mod.tagmanager_v1.Tagmanager
...
object buildSrcApisTagmanagerMod extends js.Object {
  ...
  def tagmanager(options: typingsSlinky.googleapis.buildSrcApisTagmanagerV2Mod.tagmanager_v2.Options): typingsSlinky.googleapis.buildSrcApisTagmanagerV2Mod.tagmanager_v2.Tagmanager = js.native
  @JSName("tagmanager")
  def tagmanager_v1(version: v1): Tagmanager = js.native
  @JSName("tagmanager")
  def tagmanager_v2(version: v2): typingsSlinky.googleapis.buildSrcApisTagmanagerV2Mod.tagmanager_v2.Tagmanager = js.native
  @js.native
    ...
    object v2
      extends TopLevel[
              Instantiable2[
                ...
                typingsSlinky.googleapis.buildSrcApisTagmanagerV2Mod.tagmanager_v2.Tagmanager
              ]
            ]
