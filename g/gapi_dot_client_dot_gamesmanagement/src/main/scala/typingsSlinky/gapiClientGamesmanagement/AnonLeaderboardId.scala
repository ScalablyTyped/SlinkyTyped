...
@js.native
trait AnonLeaderboardId extends js.Object {
...
object AnonLeaderboardId {
  @scala.inline
  def apply(leaderboardId: String): AnonLeaderboardId = {
    val __obj = js.Dynamic.literal(leaderboardId = leaderboardId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLeaderboardId]
  }
  @scala.inline
  implicit class AnonLeaderboardIdOps[Self <: AnonLeaderboardId] (val x: Self) extends AnyVal {
    @scala.inline
