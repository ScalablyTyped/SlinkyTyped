...
import typingsSlinky.gapiClientGamesmanagement.anon.FamilyName
...
object Player {
  ...
  implicit class PlayerOps[Self <: Player] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastPlayedWith(value: GamesPlayedResource): Self = this.set("lastPlayedWith", value.asInstanceOf[js.Any])
    @scala.inline
