...
| 5443 | [file-loader](./f/file-loader) | A file loader module for webpack
...
| 4872 | [eslint-plugin-react](./e/eslint-plugin-react) | React specific linting rules for ESLint
...
| 1392 | [nodemon](./n/nodemon) | Simple monitor script for use during development o
...
| 1218 | [web3](./w/web3) | Ethereum JavaScript API
...
| 896 | [camelcase](./c/camelcase) | Convert a dash/dot/underscore/space separated stri
...
| 795 | [validate-npm-package-name](./v/validate-npm-package-name) | Give me a string and I'll tell you if it's a valid
...
| 748 | [dayjs](./d/dayjs) | 2KB immutable date time library alternative to Mom
...
| 650 | [metalsmith](./m/metalsmith) | An extremely simple, pluggable static site generat
...
| 624 | [rollup-plugin-commonjs](./r/rollup-plugin-commonjs) | Convert CommonJS modules to ES2015
...
| 517 | [requireindex](./r/requireindex) | Write minimal node index.js files that require and
...
| 478 | [slugify](./s/slugify) | Slugifies a String
...
| 446 | [ethers](./e/ethers) | Ethereum wallet library.
...
| 408 | [highland](./h/highland) | The high-level streams library
| 407 | [https-proxy-agent](./h/https-proxy-agent) | An HTTP(s) proxy http.Agent implementation for HTT
...
| 372 | [rc-util](./r/rc-util) | Common Utils For React Component
...
| 350 | [class-validator](./c/class-validator) | Class-based validation with Typescript / ES6 / ES5
...
| 296 | [reactstrap](./r/reactstrap) | React Bootstrap 4 components
...
| 288 | [babel-plugin-macros](./b/babel-plugin-macros) | Allows you to build compile-time libraries
...
| 242 | [ionicons](./i/ionicons) | Premium icons for Ionic.
...
| 237 | [address](./a/address) | Get current machine IP, MAC and DNS servers.
...
| 218 | [expect](./e/expect) | This package exports the expect function used in 
...
| 213 | [js-sha256](./j/js-sha256) | A simple SHA-256 / SHA-224 hash function for JavaS
...
| 209 | [react-immutable-proptypes](./r/react-immutable-proptypes) | PropType validators that work with Immutable.js.
...
| 190 | [gulp-header](./g/gulp-header) | Gulp extension to add header to file(s) in the pip
...
| 182 | [rc-checkbox](./r/rc-checkbox) | checkbox ui component for react
...
| 176 | [rc-menu](./r/rc-menu) | menu ui component for react
...
| 174 | [rc-table](./r/rc-table) | table ui component for react
...
| 167 | [throat](./t/throat) | Throttle the parallelism of an asynchronous (promi
...
| 150 | [write](./w/write) | Write data to a file, replacing the file if it alr
| 149 | [downshift](./d/downshift) | A set of primitives to build simple, flexible, WAI
| 149 | [queue](./q/queue) | asynchronous function queue with adjustable concur
...
| 147 | [ajv-keywords](./a/ajv-keywords) | Custom JSON-Schema keywords for Ajv validator
...
| 146 | [formik](./f/formik) | Forms in React, without tears
...
| 145 | [postcss-load-config](./p/postcss-load-config) | Autoload Config for PostCSS
...
| 143 | [isstream](./i/isstream) | Determine if an object is a Stream
...
| 135 | [jss-preset-default](./j/jss-preset-default) | Default preset for JSS with selected plugins.
...
| 117 | [sade](./s/sade) | Smooth (CLI) operator 🎶
...
| 107 | [xml-crypto](./x/xml-crypto) | Xml digital signature and encryption library for N
...
| 104 | [ping](./p/ping) | a simple wrapper for ping
...
| 93 | [react-sizeme](./r/react-sizeme) | Make your React Components aware of their dimensio
...
| 88 | [imurmurhash](./i/imurmurhash) | An incremental implementation of MurmurHash3
...
| 86 | [postcss-modules-values](./p/postcss-modules-values) | PostCSS plugin for CSS Modules to pass arbitrary v
...
| 84 | [react-clone-referenced-el](./r/react-clone-referenced-element) | Clones a React element while preserving its origin
...
| 82 | [cytoscape](./c/cytoscape) | Graph theory (a.k.a. network) library for analysis
...
| 82 | [rc-drawer](./r/rc-drawer) | drawer component for react
...
| 80 | [passport-google-oauth20](./p/passport-google-oauth20) | Google (OAuth 2.0) authentication strategy for Pas
...
| 78 | [numeric](./n/numeric) | Numerical analysis in javascript
...
| 76 | [cacache](./c/cacache) | Fast, fault-tolerant, cross-platform, disk-based, 
...
| 76 | [registry-url](./r/registry-url) | Get the set npm registry URL
...
| 69 | [esquery](./e/esquery) | A query library for ECMAScript AST using a CSS sel
...
| 69 | [web3-eth-abi](./w/web3-eth-abi) | Web3 module encode and decode EVM in/output.
...
| 68 | [md5-hex](./m/md5-hex) | Create a MD5 hash with hex encoding
| 68 | [parse-domain](./p/parse-domain) | Splits an url into sub-domain, domain and effectiv
...
| 67 | [abab](./a/abab) | WHATWG spec-compliant implementations of window.at
...
| 67 | [phaser](./p/phaser) | A fast, free and fun HTML5 Game Framework for Desk
...
| 65 | [google-map-react](./g/google-map-react) | isomorphic google map react component, allows rend
...
| 64 | [react-inspector](./r/react-inspector) | Power of Browser DevTools inspectors right inside 
...
| 63 | [array-union](./a/array-union) | Create an array of unique values, in order, from t
| 63 | [detect-newline](./d/detect-newline) | Detect the dominant newline character of a string
| 63 | [dom-align](./d/dom-align) | Align DOM Node Flexibly
...
| 62 | [os-utils](./o/os-utils) | an operating-system utility library
...
| 61 | [define-properties](./d/define-properties) | Define multiple non-enumerable properties at once.
...
| 61 | [intersperse](./i/intersperse) | Add an object to an array between each element
...
| 59 | [stdout-stream](./s/stdout-stream) | Non-blocking stdout stream
...
| 59 | [xml-escape](./x/xml-escape) | Escape XML
| 58 | [chownr](./c/chownr) | like chown -R
| 58 | [color-string](./c/color-string) | Parser and generator for CSS color strings
| 58 | [css-mediaquery](./c/css-mediaquery) | Parses and determines if a given CSS Media Query m
| 58 | [dom-serializer](./d/dom-serializer) | render dom nodes to string
...
| 58 | [level-js](./l/level-js) | An abstract-leveldown compliant store on top of In
...
| 57 | [spotify-web-api-node](./s/spotify-web-api-node) | A Node.js wrapper for Spotify's Web API
...
| 52 | [import-fresh](./i/import-fresh) | Import a module while bypassing the cache
...
| 52 | [stats-lite](./s/stats-lite) | A light statistical package that operates on numer
...
| 51 | [emoji-js](./e/emoji-js) | A JS Emoji conversion library
...
| 51 | [jaeger-client](./j/jaeger-client) | Jaeger binding for OpenTracing Node
...
| 50 | [intl-messageformat-parser](./i/intl-messageformat-parser) | Parses ICU Message strings into an AST via JavaScr
...
| 49 | [is-path-inside](./i/is-path-inside) | Check if a path is inside another path
...
| 49 | [tiny-warning](./t/tiny-warning) | A tiny warning function
| 49 | [webidl-conversions](./w/webidl-conversions) | Implements the WebIDL algorithms for converting to
...
| 45 | [jest-message-util](./j/jest-message-util) | -
...
| 44 | [react-native-video](./r/react-native-video) | A  element for react-native
...
| 44 | [store2](./s/store2) | Better localStorage
...
| 42 | [clsx](./c/clsx) | A tiny (223B) utility for constructing className s
...
| 42 | [graphviz](./g/graphviz) | Node.js interface to the GraphViz graphing tool
...
| 42 | [temp-dir](./t/temp-dir) | Get the real path of the system temp directory
...
| 41 | [ci-info](./c/ci-info) | Get details about the current Continuous Integrati
...
| 40 | [proxy-from-env](./p/proxy-from-env) | Offers getProxyForUrl to get the proxy URL for a U
...
| 39 | [eccrypto](./e/eccrypto) | JavaScript Elliptic curve cryptography library
...
| 39 | [labeled-stream-splicer](./l/labeled-stream-splicer) | stream splicer with labels
...
| 38 | [flat-cache](./f/flat-cache) | A stupidly simple key/value storage using files to
...
| 38 | [storybook__components](./s/storybook__components) | Core Storybook Components
...
| 34 | [react-pdf](./r/react-pdf) | Display PDFs in your React app as easily as if the
...
| 34 | [yeast](./y/yeast) | Tiny but linear growing unique id generator
...
| 33 | [icss-utils](./i/icss-utils) | ICSS utils for postcss ast
...
| 32 | [ember-data](./e/ember-data) | A data layer for your Ember applications.
...
| 32 | [loglevel-plugin-prefix](./l/loglevel-plugin-prefix) | Plugin for loglevel message prefixing
...
| 30 | [tunnel-ssh](./t/tunnel-ssh) | Easy extendable SSH tunnel
...
| 28 | [fast-text-encoding](./f/fast-text-encoding) | Fast polyfill for TextEncoder and TextDecoder, onl
...
| 28 | [react-loader-spinner](./r/react-loader-spinner) | react-spinner-loader provides simple React.js spin
...
| 28 | [rollup-plugin-url](./r/rollup-plugin-url) | Inline import files as data-URIs, or copy them to 
...
| 27 | [chalk-pipe](./c/chalk-pipe) | Apply a color scheme in a style pipe
...
| 27 | [jest-regex-util](./j/jest-regex-util) | -
...
| 26 | [electron-localshortcut](./e/electron-localshortcut) | register/unregister a keyboard shortcut locally to
...
| 26 | [ignore-walk](./i/ignore-walk) | Nested/recursive .gitignore/.npmignore parsing and
...
| 26 | [json-file-plus](./j/json-file-plus) | Read from and write to a JSON file, minimizing dif
| 26 | [koa-basic-auth](./k/koa-basic-auth) | Blanket basic auth middleware for koa
| 26 | [ky](./k/ky) | Tiny and elegant HTTP client based on the browser 
...
| 25 | [random-useragent](./r/random-useragent) | Get a random useragent (with an optional filter)
...
| 25 | [wordpress__element](./w/wordpress__element) | Element React module for WordPress.
...
| 24 | [express-request-id](./e/express-request-id) | Generate UUID for request and add it to headers
...
| 24 | [ffmpeg](./f/ffmpeg) | Utility for managing video streams using ffmpeg
...
| 24 | [wordpress__i18n](./w/wordpress__i18n) | WordPress internationalization (i18n) library.
| 23 | [apollo-server-caching](./a/apollo-server-caching) | -
...
| 23 | [is-npm](./i/is-npm) | Check if your code is running as an npm script
...
| 23 | [random](./r/random) | Seedable random number generator supporting many c
...
| 23 | [rollup-plugin-progress](./r/rollup-plugin-progress) | Rollup Progress Plugin
...
| 22 | [difflib](./d/difflib) | text diff library ported from Python's difflib mod
...
| 21 | [apollo-datasource](./a/apollo-datasource) | -
...
| 21 | [jsonpack](./j/jsonpack) | A compression algorithm for JSON
...
| 21 | [tsscmp](./t/tsscmp) | Timing safe string compare using double HMAC
...
| 20 | [futoin-hkdf](./f/futoin-hkdf) | RFC5869: HMAC-based Extract-and-Expand Key Derivat
...
| 20 | [git-revision-webpack-plug](./g/git-revision-webpack-plugin) | Simple webpack plugin that generates VERSION and C
...
| 20 | [nivo__colors](./n/nivo__colors) | -
...
| 20 | [trust__webcrypto](./t/trust__webcrypto) | WebCrypto API for Node.js
...
| 19 | [num2fraction](./n/num2fraction) | Convert number to fraction
...
| 18 | [graphql-upload](./g/graphql-upload) | Middleware and an Upload scalar to add support for
...
| 18 | [html-webpack-tags-plugin](./h/html-webpack-tags-plugin) | lets you define html tags to inject with html-webp
| 18 | [http-link-header](./h/http-link-header) | Parse & format HTTP link headers according to RFC 
| 18 | [jest-jasmine2](./j/jest-jasmine2) | -
| 18 | [jest__test-result](./j/jest__test-result) | -
...
| 18 | [node-easy-cert](./n/node-easy-cert) | A tool for managing self-signed certifications
...
| 16 | [btoa-lite](./b/btoa-lite) | Smallest/simplest possible means of using btoa wit
...
| 16 | [es-to-primitive](./e/es-to-primitive) | ECMAScript “ToPrimitive” algorithm. Provides ES5 a
...
| 16 | [styled-system__should-for](./s/styled-system__should-forward-prop) | Utility for filtering Styled System props with Emo
...
| 16 | [wordpress__data](./w/wordpress__data) | Data module for WordPress.
...
| 15 | [pickadate](./p/pickadate) | The mobile-friendly, responsive, and lightweight j
...
| 15 | [react-navigation__core](./r/react-navigation__core) | Core utilities for the react-navigation framework
...
| 15 | [sentry__webpack-plugin](./s/sentry__webpack-plugin) | Official webpack plugin for Sentry
...
| 15 | [styletron-react](./s/styletron-react) | React bindings for Styletron
...
| 14 | [ember-modal-dialog](./e/ember-modal-dialog) | An ember-cli addon for implementing modal dialogs
...
| 14 | [passport-oauth2-refresh](./p/passport-oauth2-refresh) | A passport.js add-on to provide automatic OAuth 2.
...
| 14 | [strip-bom-buf](./s/strip-bom-buf) | Strip UTF-8 byte order mark (BOM) from a buffer
...
| 14 | [vue2-editor](./v/vue2-editor) | HTML editor using Vue.js 2, and Quill.js, an open 
...
| 13 | [check-error](./c/check-error) | Error comparison and information related utility f
...
| 13 | [just-snake-case](./j/just-snake-case) | convert a string to snake case
...
| 13 | [use-deep-compare-effect](./u/use-deep-compare-effect) | It's react's useEffect hook, except using deep com
...
| 12 | [styletron-engine-atomic](./s/styletron-engine-atomic) | Universal, high-performance JavaScript styles
...
| 11 | [jss-plugin-nested](./j/jss-plugin-nested) | JSS plugin that enables support for nested selecto
...
| 10 | [proper-url-join](./p/proper-url-join) | Like path.join but for a URL
...
| 10 | [webpack-blocks](./w/webpack-blocks) | Convenience package that includes all the most com
...
| 9 | [honeybadger](./h/honeybadger) | A node.js notifier for honeybadger.io
...
| 9 | [jss-plugin-global](./j/jss-plugin-global) | Global styles for JSS
| 9 | [jss-plugin-rule-value-fun](./j/jss-plugin-rule-value-function) | JSS plugin for function value and rule syntax
...
| 9 | [rc-resize-observer](./r/rc-resize-observer) | Resize observer for React
...
| 9 | [styled-system__css](./s/styled-system__css) | Styled System for the css prop
...
| 9 | [unist-util-stringify-posi](./u/unist-util-stringify-position) | Stringify a Unist node, position, or point
...
| 8 | [jss-plugin-camel-case](./j/jss-plugin-camel-case) | JSS plugin that allows to write camel cased rule p
| 8 | [jss-plugin-default-unit](./j/jss-plugin-default-unit) | JSS plugin that adds default custom unit to numeri
| 8 | [jss-plugin-props-sort](./j/jss-plugin-props-sort) | JSS plugin that ensures style properties extend ea
...
| 8 | [receptacle](./r/receptacle) | In memory cache lru cache with ttl support.
...
| 7 | [octokit__request](./o/octokit__request) | Send parameterized requests to GitHub’s APIs with 
...
| 7 | [rate-limit-redis](./r/rate-limit-redis) | Provides a Redis store for the express-rate-limit 
...
| 6 | [ant-design__colors](./a/ant-design__colors) | Color palettes calculator of Ant Design
...
| 6 | [aria-query](./a/aria-query) | Programmatic access to the ARIA specification
...
| 6 | [camelcase-keys-deep](./c/camelcase-keys-deep) | Deeply convert the keys of an object to camelCase
...
| 6 | [esfx__disposable](./e/esfx__disposable) | A low-level API for defining explicit resource man
...
| 6 | [jss-plugin-vendor-prefixe](./j/jss-plugin-vendor-prefixer) | JSS plugin that handles vendor prefixes in the bro
...
| 6 | [log-process-errors](./l/log-process-errors) | Show some ❤️ to process errors
...
| 6 | [which-pm-runs](./w/which-pm-runs) | Detects what package manager executes the process
...
| 5 | [googleapis-common](./g/googleapis-common) | A common tooling library used by the googleapis np
...
| 5 | [jest__console](./j/jest__console) | -
...
| 5 | [styletron-standard](./s/styletron-standard) | Standard interfaces for Styletron
...
| 5 | [sylvester-es6](./s/sylvester-es6) | Fork of the famous Sylvester vector, matrix and ge
...
| 4 | [atob-lite](./a/atob-lite) | Smallest/simplest possible means of using atob wit
...
| 4 | [jss-plugin-expand](./j/jss-plugin-expand) | JSS plugin that gives you a better syntax than CSS
...
| 4 | [rollup-plugin-delete](./r/rollup-plugin-delete) | Delete files and folders using Rollup
...
| 4 | [storybook-react-router](./s/storybook-react-router) | A storybook decorator that allows you to use routi
| 4 | [storybook__html](./s/storybook__html) | Storybook for HTML: View HTML snippets in isolatio
...
| 4 | [wx-server-sdk](./w/wx-server-sdk) | mini program cloud server sdk
...
| 3 | [hookrouter](./h/hookrouter) | A hook based router for React
...
| 3 | [jupyterlab__logconsole](./j/jupyterlab__logconsole) | JupyterLab - Log Console
...
| 3 | [merge-anything](./m/merge-anything) | Merge objects & other types recursively. A simple 
...
| 3 | [octokit__request-error](./o/octokit__request-error) | Error class for Octokit request errors
...
| 2 | [deprecation](./d/deprecation) | Log a deprecation message with stack
...
| 2 | [file-path-filter](./f/file-path-filter) | Filters file paths using globs, regular expression
| 2 | [firebase__analytics](./f/firebase__analytics) | A analytics package for new firebase packages
| 2 | [firebase__remote-config](./f/firebase__remote-config) | The Remote Config package of the Firebase JS SDK
...
| 2 | [integrate-adaptive-simpso](./i/integrate-adaptive-simpson) | Integrate a system of ODEs using the Second Order 
...
| 2 | [tdweb](./t/tdweb) | Javascript interface for TDLib (telegram library)
...
| 1 | [ethereum-bloom-filters](./e/ethereum-bloom-filters) | Ability to test bloom filters for ethereum.
...
| 1 | [react-gtm-module](./r/react-gtm-module) | React Google Tag Manager Module
...
| 1 | [sisteransi](./s/sisteransi) | ANSI escape codes for some terminal swag
...
| 1 | [vanilla-swipe](./v/vanilla-swipe) | Tiny vanilla JS library to detect swipe direction.
