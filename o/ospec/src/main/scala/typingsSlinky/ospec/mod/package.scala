...
package object mod {
  ...
  type Definer = js.Function2[
    /* done */ js.Function1[/* error */ js.UndefOr[js.Error | scala.Null], scala.Unit], 
  ...
  type Reporter = js.Function1[/* results */ js.Array[typingsSlinky.ospec.mod.Result], scala.Double]
}
