...
object RecipientType extends js.Object {
  ...
  /* "distributionList" */ val DistributionList: typingsSlinky.officeDashJs.Office.MailboxEnums.RecipientType.DistributionList with String = js.native
  /* "externalUser" */ val ExternalUser: typingsSlinky.officeDashJs.Office.MailboxEnums.RecipientType.ExternalUser with String = js.native
  /* "other" */ val Other: typingsSlinky.officeDashJs.Office.MailboxEnums.RecipientType.Other with String = js.native
  /* "user" */ val User: typingsSlinky.officeDashJs.Office.MailboxEnums.RecipientType.User with String = js.native
  @JSBracketAccess
