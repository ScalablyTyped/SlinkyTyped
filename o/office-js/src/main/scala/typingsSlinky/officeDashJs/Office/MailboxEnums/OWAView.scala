...
object OWAView extends js.Object {
  ...
  /* "OneColumn" */ val OneColumn: typingsSlinky.officeDashJs.Office.MailboxEnums.OWAView.OneColumn with String = js.native
  /* "ThreeColumns" */ val ThreeColumns: typingsSlinky.officeDashJs.Office.MailboxEnums.OWAView.ThreeColumns with String = js.native
  /* "TwoColumns" */ val TwoColumns: typingsSlinky.officeDashJs.Office.MailboxEnums.OWAView.TwoColumns with String = js.native
  @JSBracketAccess
