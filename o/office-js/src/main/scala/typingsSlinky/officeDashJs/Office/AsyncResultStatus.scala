...
object AsyncResultStatus extends js.Object {
  ...
  /* 1 */ val Failed: typingsSlinky.officeDashJs.Office.AsyncResultStatus.Failed with Double = js.native
  /* 0 */ val Succeeded: typingsSlinky.officeDashJs.Office.AsyncResultStatus.Succeeded with Double = js.native
  @JSBracketAccess
