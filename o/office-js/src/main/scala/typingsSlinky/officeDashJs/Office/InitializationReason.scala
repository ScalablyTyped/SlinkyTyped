...
object InitializationReason extends js.Object {
  ...
  /* 1 */ val DocumentOpened: typingsSlinky.officeDashJs.Office.InitializationReason.DocumentOpened with Double = js.native
  /* 0 */ val Inserted: typingsSlinky.officeDashJs.Office.InitializationReason.Inserted with Double = js.native
  @JSBracketAccess
