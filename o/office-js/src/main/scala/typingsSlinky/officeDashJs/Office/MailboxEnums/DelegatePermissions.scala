...
object DelegatePermissions extends js.Object {
  ...
  /* 8 */ val DeleteAll: typingsSlinky.officeDashJs.Office.MailboxEnums.DelegatePermissions.DeleteAll with Double = js.native
  /* 4 */ val DeleteOwn: typingsSlinky.officeDashJs.Office.MailboxEnums.DelegatePermissions.DeleteOwn with Double = js.native
  /* 32 */ val EditAll: typingsSlinky.officeDashJs.Office.MailboxEnums.DelegatePermissions.EditAll with Double = js.native
  /* 16 */ val EditOwn: typingsSlinky.officeDashJs.Office.MailboxEnums.DelegatePermissions.EditOwn with Double = js.native
  /* 1 */ val Read: typingsSlinky.officeDashJs.Office.MailboxEnums.DelegatePermissions.Read with Double = js.native
  /* 2 */ val Write: typingsSlinky.officeDashJs.Office.MailboxEnums.DelegatePermissions.Write with Double = js.native
  @JSBracketAccess
