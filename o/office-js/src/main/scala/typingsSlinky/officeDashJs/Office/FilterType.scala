...
object FilterType extends js.Object {
  ...
  /* 0 */ val All: typingsSlinky.officeDashJs.Office.FilterType.All with Double = js.native
  /* 1 */ val OnlyVisible: typingsSlinky.officeDashJs.Office.FilterType.OnlyVisible with Double = js.native
  @JSBracketAccess
