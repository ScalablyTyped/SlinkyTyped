...
object BindingType extends js.Object {
  ...
  /* 1 */ val Matrix: typingsSlinky.officeDashJs.Office.BindingType.Matrix with Double = js.native
  /* 2 */ val Table: typingsSlinky.officeDashJs.Office.BindingType.Table with Double = js.native
  /* 0 */ val Text: typingsSlinky.officeDashJs.Office.BindingType.Text with Double = js.native
  @JSBracketAccess
