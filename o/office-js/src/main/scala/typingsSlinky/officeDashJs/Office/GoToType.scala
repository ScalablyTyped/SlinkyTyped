...
object GoToType extends js.Object {
  ...
  /* 0 */ @js.native
  object Binding
    extends TopLevel[typingsSlinky.officeDashJs.Office.GoToType.Binding with Double]
  
  /* 3 */ @js.native
  object Index
    extends TopLevel[typingsSlinky.officeDashJs.Office.GoToType.Index with Double]
