...
object GoToType extends js.Object {
  ...
  /* 0 */ val Binding: typingsSlinky.officeDashJs.Office.GoToType.Binding with Double = js.native
  /* 3 */ val Index: typingsSlinky.officeDashJs.Office.GoToType.Index with Double = js.native
  /* 1 */ val NamedItem: typingsSlinky.officeDashJs.Office.GoToType.NamedItem with Double = js.native
  /* 2 */ val Slide: typingsSlinky.officeDashJs.Office.GoToType.Slide with Double = js.native
  @JSBracketAccess
