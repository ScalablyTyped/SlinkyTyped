...
object ResponseType extends js.Object {
  ...
  /* "accepted" */ val Accepted: typingsSlinky.officeDashJs.Office.MailboxEnums.ResponseType.Accepted with String = js.native
  /* "declined" */ val Declined: typingsSlinky.officeDashJs.Office.MailboxEnums.ResponseType.Declined with String = js.native
  /* "none" */ val None: typingsSlinky.officeDashJs.Office.MailboxEnums.ResponseType.None with String = js.native
  /* "organizer" */ val Organizer: typingsSlinky.officeDashJs.Office.MailboxEnums.ResponseType.Organizer with String = js.native
  /* "tentative" */ val Tentative: typingsSlinky.officeDashJs.Office.MailboxEnums.ResponseType.Tentative with String = js.native
  @JSBracketAccess
