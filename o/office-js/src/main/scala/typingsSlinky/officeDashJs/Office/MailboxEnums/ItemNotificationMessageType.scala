...
object ItemNotificationMessageType extends js.Object {
  ...
  /* "errorMessage" */ val ErrorMessage: typingsSlinky.officeDashJs.Office.MailboxEnums.ItemNotificationMessageType.ErrorMessage with String = js.native
  /* "informationalMessage" */ val InformationalMessage: typingsSlinky.officeDashJs.Office.MailboxEnums.ItemNotificationMessageType.InformationalMessage with String = js.native
  /* "progressIndicator" */ val ProgressIndicator: typingsSlinky.officeDashJs.Office.MailboxEnums.ItemNotificationMessageType.ProgressIndicator with String = js.native
  @JSBracketAccess
