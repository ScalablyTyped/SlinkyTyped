...
object AttachmentContentFormat extends js.Object {
  ...
  /* "base64" */ val Base64: typingsSlinky.officeDashJs.Office.MailboxEnums.AttachmentContentFormat.Base64 with String = js.native
  /* "eml" */ val Eml: typingsSlinky.officeDashJs.Office.MailboxEnums.AttachmentContentFormat.Eml with String = js.native
  /* "iCalendar" */ val ICalendar: typingsSlinky.officeDashJs.Office.MailboxEnums.AttachmentContentFormat.ICalendar with String = js.native
  /* "url" */ val Url: typingsSlinky.officeDashJs.Office.MailboxEnums.AttachmentContentFormat.Url with String = js.native
  @JSBracketAccess
