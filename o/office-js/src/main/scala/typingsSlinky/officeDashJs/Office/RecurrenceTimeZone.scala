...
trait RecurrenceTimeZone extends js.Object {
  /**
    ...
    */
  var name: typingsSlinky.officeDashJs.Office.MailboxEnums.RecurrenceTimeZone | String
  /**
...
object RecurrenceTimeZone {
  @scala.inline
  def apply(name: typingsSlinky.officeDashJs.Office.MailboxEnums.RecurrenceTimeZone | String, offset: Double): RecurrenceTimeZone = {
