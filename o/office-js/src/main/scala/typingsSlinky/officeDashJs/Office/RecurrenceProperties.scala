...
import typingsSlinky.officeDashJs.Office.MailboxEnums.Days
import typingsSlinky.officeDashJs.Office.MailboxEnums.Month
import typingsSlinky.officeDashJs.Office.MailboxEnums.WeekNumber
