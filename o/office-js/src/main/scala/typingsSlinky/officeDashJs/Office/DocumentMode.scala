...
object DocumentMode extends js.Object {
  ...
  /* 0 */ val ReadOnly: typingsSlinky.officeDashJs.Office.DocumentMode.ReadOnly with Double = js.native
  /* 1 */ val ReadWrite: typingsSlinky.officeDashJs.Office.DocumentMode.ReadWrite with Double = js.native
  @JSBracketAccess
