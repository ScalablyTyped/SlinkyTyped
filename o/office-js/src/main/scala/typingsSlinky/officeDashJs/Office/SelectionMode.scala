...
object SelectionMode extends js.Object {
  ...
  /* 0 */ val Default: typingsSlinky.officeDashJs.Office.SelectionMode.Default with Double = js.native
  /* 2 */ val None: typingsSlinky.officeDashJs.Office.SelectionMode.None with Double = js.native
  /* 1 */ val Selected: typingsSlinky.officeDashJs.Office.SelectionMode.Selected with Double = js.native
  @JSBracketAccess
