...
object ItemType extends js.Object {
  ...
  /* "appointment" */ val Appointment: typingsSlinky.officeDashJs.Office.MailboxEnums.ItemType.Appointment with String = js.native
  /* "message" */ val Message: typingsSlinky.officeDashJs.Office.MailboxEnums.ItemType.Message with String = js.native
  @JSBracketAccess
