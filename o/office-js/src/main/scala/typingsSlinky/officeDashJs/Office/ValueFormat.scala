...
object ValueFormat extends js.Object {
  ...
  /* 1 */ val Formatted: typingsSlinky.officeDashJs.Office.ValueFormat.Formatted with Double = js.native
  /* 0 */ val Unformatted: typingsSlinky.officeDashJs.Office.ValueFormat.Unformatted with Double = js.native
  @JSBracketAccess
