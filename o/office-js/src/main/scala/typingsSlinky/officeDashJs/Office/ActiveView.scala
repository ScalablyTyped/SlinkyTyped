...
object ActiveView extends js.Object {
  ...
  /* 1 */ val Edit: typingsSlinky.officeDashJs.Office.ActiveView.Edit with Double = js.native
  /* 0 */ val Read: typingsSlinky.officeDashJs.Office.ActiveView.Read with Double = js.native
  @JSBracketAccess
