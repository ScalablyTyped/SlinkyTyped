...
object FileType extends js.Object {
  ...
  /* 1 */ val Compressed: typingsSlinky.officeDashJs.Office.FileType.Compressed with Double = js.native
  /* 2 */ val Pdf: typingsSlinky.officeDashJs.Office.FileType.Pdf with Double = js.native
  /* 0 */ val Text: typingsSlinky.officeDashJs.Office.FileType.Text with Double = js.native
  @JSBracketAccess
