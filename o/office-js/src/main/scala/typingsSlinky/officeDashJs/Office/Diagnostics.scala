...
import typingsSlinky.officeDashJs.Office.MailboxEnums.OWAView
import typingsSlinky.officeDashJs.officeDashJsStrings.OneColumn
import typingsSlinky.officeDashJs.officeDashJsStrings.ThreeColumns
import typingsSlinky.officeDashJs.officeDashJsStrings.TwoColumns
...
trait Diagnostics extends js.Object {
  /**
    ...
    * **{@link https://docs.microsoft.com/outlook/add-ins/#extension-points | Applicable Outlook mode}**: Compose or Read
    */
  var OWAView: typingsSlinky.officeDashJs.Office.MailboxEnums.OWAView | OneColumn | TwoColumns | ThreeColumns
  /**
