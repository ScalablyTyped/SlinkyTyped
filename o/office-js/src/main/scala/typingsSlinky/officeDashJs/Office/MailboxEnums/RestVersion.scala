package typingsSlinky.officeDashJs.Office.MailboxEnums
...
object RestVersion extends js.Object {
  ...
  /* "beta" */ val Beta: typingsSlinky.officeDashJs.Office.MailboxEnums.RestVersion.Beta with String = js.native
  /* "v1.0" */ val v1_0: typingsSlinky.officeDashJs.Office.MailboxEnums.RestVersion.v1_0 with String = js.native
  /* "v2.0" */ val v2_0: typingsSlinky.officeDashJs.Office.MailboxEnums.RestVersion.v2_0 with String = js.native
  @JSBracketAccess
