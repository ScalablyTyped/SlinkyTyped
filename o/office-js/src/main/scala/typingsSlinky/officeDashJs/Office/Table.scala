...
object Table extends js.Object {
  ...
  /* 0 */ val All: typingsSlinky.officeDashJs.Office.Table.All with Double = js.native
  /* 1 */ val Data: typingsSlinky.officeDashJs.Office.Table.Data with Double = js.native
  /* 2 */ val Headers: typingsSlinky.officeDashJs.Office.Table.Headers with Double = js.native
  @JSBracketAccess
