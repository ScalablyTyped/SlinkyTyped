...
object SourceProperty extends js.Object {
  ...
  /* 0 */ val Body: typingsSlinky.officeDashJs.Office.SourceProperty.Body with Double = js.native
  /* 1 */ val Subject: typingsSlinky.officeDashJs.Office.SourceProperty.Subject with Double = js.native
  @JSBracketAccess
