...
object SourceProperty extends js.Object {
  ...
  /* 0 */ @js.native
  object Body
    extends TopLevel[typingsSlinky.officeDashJs.Office.SourceProperty.Body with Double]
  
  /* 1 */ @js.native
  object Subject
    extends TopLevel[typingsSlinky.officeDashJs.Office.SourceProperty.Subject with Double]
