...
object ToolBarType extends js.Object {
  ...
  /* "CommandBar" */ val commandBar: typingsSlinky.officeDashJs.Visio.ToolBarType.commandBar with String = js.native
  /* "PageNavigationBar" */ val pageNavigationBar: typingsSlinky.officeDashJs.Visio.ToolBarType.pageNavigationBar with String = js.native
  /* "StatusBar" */ val statusBar: typingsSlinky.officeDashJs.Visio.ToolBarType.statusBar with String = js.native
  @JSBracketAccess
