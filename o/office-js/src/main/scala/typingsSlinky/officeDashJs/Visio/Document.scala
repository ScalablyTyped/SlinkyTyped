...
import typingsSlinky.officeDashJs.Visio.Interfaces.DocumentData
import typingsSlinky.officeDashJs.Visio.Interfaces.DocumentLoadOptions
import typingsSlinky.officeDashJs.Visio.Interfaces.DocumentUpdateData
