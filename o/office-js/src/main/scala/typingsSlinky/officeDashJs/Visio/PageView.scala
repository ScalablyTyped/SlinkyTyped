...
import typingsSlinky.officeDashJs.Visio.Interfaces.PageViewData
import typingsSlinky.officeDashJs.Visio.Interfaces.PageViewLoadOptions
import typingsSlinky.officeDashJs.Visio.Interfaces.PageViewUpdateData
...
class PageView () extends ClientObject {
  ...
  def load(option: Anon_Expand): PageView = js.native
