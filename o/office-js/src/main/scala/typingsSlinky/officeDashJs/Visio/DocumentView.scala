...
import typingsSlinky.officeDashJs.Visio.Interfaces.DocumentViewData
import typingsSlinky.officeDashJs.Visio.Interfaces.DocumentViewLoadOptions
import typingsSlinky.officeDashJs.Visio.Interfaces.DocumentViewUpdateData
