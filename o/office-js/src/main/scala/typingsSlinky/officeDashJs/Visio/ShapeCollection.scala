...
import typingsSlinky.officeDashJs.Visio.Interfaces.CollectionLoadOptions
import typingsSlinky.officeDashJs.Visio.Interfaces.ShapeCollectionData
import typingsSlinky.officeDashJs.Visio.Interfaces.ShapeCollectionLoadOptions
