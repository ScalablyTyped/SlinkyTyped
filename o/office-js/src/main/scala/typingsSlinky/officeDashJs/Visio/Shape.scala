...
import typingsSlinky.officeDashJs.Visio.Interfaces.ShapeData
import typingsSlinky.officeDashJs.Visio.Interfaces.ShapeLoadOptions
import typingsSlinky.officeDashJs.Visio.Interfaces.ShapeUpdateData
