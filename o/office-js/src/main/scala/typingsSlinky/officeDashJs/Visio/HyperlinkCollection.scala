...
import typingsSlinky.officeDashJs.Visio.Interfaces.HyperlinkCollectionData
import typingsSlinky.officeDashJs.Visio.Interfaces.HyperlinkCollectionLoadOptions
