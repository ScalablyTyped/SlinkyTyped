...
object ChartTickLabelAlignment extends js.Object {
  ...
  /* "Center" */ val center: typingsSlinky.officeDashJs.Excel.ChartTickLabelAlignment.center with String = js.native
  /* "Left" */ val left: typingsSlinky.officeDashJs.Excel.ChartTickLabelAlignment.left with String = js.native
  /* "Right" */ val right: typingsSlinky.officeDashJs.Excel.ChartTickLabelAlignment.right with String = js.native
  @JSBracketAccess
