...
import typingsSlinky.officeDashJs.officeDashJsStrings.BeginsWith
import typingsSlinky.officeDashJs.officeDashJsStrings.Contains
import typingsSlinky.officeDashJs.officeDashJsStrings.EndsWith
import typingsSlinky.officeDashJs.officeDashJsStrings.Invalid
import typingsSlinky.officeDashJs.officeDashJsStrings.NotContains
