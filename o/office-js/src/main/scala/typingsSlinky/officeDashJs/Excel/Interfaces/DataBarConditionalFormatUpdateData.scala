...
import typingsSlinky.officeDashJs.Excel.ConditionalDataBarAxisFormat
import typingsSlinky.officeDashJs.Excel.ConditionalDataBarDirection
import typingsSlinky.officeDashJs.Excel.ConditionalDataBarRule
