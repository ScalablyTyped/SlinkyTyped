...
object CalculationState extends js.Object {
  ...
  /* "Calculating" */ val calculating: typingsSlinky.officeDashJs.Excel.CalculationState.calculating with String = js.native
  /* "Done" */ val done: typingsSlinky.officeDashJs.Excel.CalculationState.done with String = js.native
  /* "Pending" */ val pending: typingsSlinky.officeDashJs.Excel.CalculationState.pending with String = js.native
  @JSBracketAccess
