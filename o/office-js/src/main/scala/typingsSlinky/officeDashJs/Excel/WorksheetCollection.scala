...
import typingsSlinky.officeDashJs.Excel.Interfaces.WorksheetCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.WorksheetCollectionLoadOptions
