...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartTrendlineLabelData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartTrendlineLabelLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartTrendlineLabelUpdateData
