...
object ConnectorType extends js.Object {
  ...
  /* "Curve" */ val curve: typingsSlinky.officeDashJs.Excel.ConnectorType.curve with String = js.native
  /* "Elbow" */ val elbow: typingsSlinky.officeDashJs.Excel.ConnectorType.elbow with String = js.native
  /* "Straight" */ val straight: typingsSlinky.officeDashJs.Excel.ConnectorType.straight with String = js.native
  @JSBracketAccess
