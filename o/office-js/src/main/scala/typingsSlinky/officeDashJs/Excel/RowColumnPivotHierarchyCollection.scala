...
import typingsSlinky.officeDashJs.Excel.Interfaces.RowColumnPivotHierarchyCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.RowColumnPivotHierarchyCollectionLoadOptions
