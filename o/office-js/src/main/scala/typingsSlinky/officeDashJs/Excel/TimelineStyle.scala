...
import typingsSlinky.officeDashJs.Excel.Interfaces.TimelineStyleData
import typingsSlinky.officeDashJs.Excel.Interfaces.TimelineStyleLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.TimelineStyleUpdateData
