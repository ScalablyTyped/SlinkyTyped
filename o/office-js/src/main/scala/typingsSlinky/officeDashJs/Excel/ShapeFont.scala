...
import typingsSlinky.officeDashJs.Excel.Interfaces.ShapeFontData
import typingsSlinky.officeDashJs.Excel.Interfaces.ShapeFontLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ShapeFontUpdateData
...
class ShapeFont () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  var underline: ShapeFontUnderlineStyle | None | Single | typingsSlinky.officeDashJs.officeDashJsStrings.Double | Heavy | Dotted | DottedHeavy | Dash | DashHeavy | DashLong | DashLongHeavy | DotDash | DotDashHeavy | DotDotDash | DotDotDashHeavy | Wavy | WavyHeavy | WavyDouble = js.native
  /**
