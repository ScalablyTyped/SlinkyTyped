...
object ChartAxisTickLabelPosition extends js.Object {
  ...
  /* "High" */ val high: typingsSlinky.officeDashJs.Excel.ChartAxisTickLabelPosition.high with String = js.native
  /* "Low" */ val low: typingsSlinky.officeDashJs.Excel.ChartAxisTickLabelPosition.low with String = js.native
  /* "NextToAxis" */ val nextToAxis: typingsSlinky.officeDashJs.Excel.ChartAxisTickLabelPosition.nextToAxis with String = js.native
  /* "None" */ val none: typingsSlinky.officeDashJs.Excel.ChartAxisTickLabelPosition.none with String = js.native
  @JSBracketAccess
