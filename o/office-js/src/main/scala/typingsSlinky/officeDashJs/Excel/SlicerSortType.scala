...
object SlicerSortType extends js.Object {
  ...
  /* "Ascending" */ val ascending: typingsSlinky.officeDashJs.Excel.SlicerSortType.ascending with String = js.native
  /* "DataSourceOrder" */ val dataSourceOrder: typingsSlinky.officeDashJs.Excel.SlicerSortType.dataSourceOrder with String = js.native
  /* "Descending" */ val descending: typingsSlinky.officeDashJs.Excel.SlicerSortType.descending with String = js.native
  @JSBracketAccess
