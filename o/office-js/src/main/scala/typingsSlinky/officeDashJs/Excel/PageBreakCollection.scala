...
import typingsSlinky.officeDashJs.Excel.Interfaces.PageBreakCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.PageBreakCollectionLoadOptions
