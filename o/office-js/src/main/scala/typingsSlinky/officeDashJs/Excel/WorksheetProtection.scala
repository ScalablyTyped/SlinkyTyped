...
import typingsSlinky.officeDashJs.Excel.Interfaces.WorksheetProtectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.WorksheetProtectionLoadOptions
