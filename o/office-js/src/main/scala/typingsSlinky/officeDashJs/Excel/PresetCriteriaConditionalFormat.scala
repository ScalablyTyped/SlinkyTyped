...
import typingsSlinky.officeDashJs.Excel.Interfaces.PresetCriteriaConditionalFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.PresetCriteriaConditionalFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.PresetCriteriaConditionalFormatUpdateData
