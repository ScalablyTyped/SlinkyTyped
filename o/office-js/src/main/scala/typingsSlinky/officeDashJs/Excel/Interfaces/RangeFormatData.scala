...
import typingsSlinky.officeDashJs.Excel.HorizontalAlignment
import typingsSlinky.officeDashJs.Excel.ReadingOrder
import typingsSlinky.officeDashJs.Excel.VerticalAlignment
