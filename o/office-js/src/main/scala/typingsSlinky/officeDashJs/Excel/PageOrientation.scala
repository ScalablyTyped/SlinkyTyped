...
object PageOrientation extends js.Object {
  ...
  /* "Landscape" */ val landscape: typingsSlinky.officeDashJs.Excel.PageOrientation.landscape with String = js.native
  /* "Portrait" */ val portrait: typingsSlinky.officeDashJs.Excel.PageOrientation.portrait with String = js.native
  @JSBracketAccess
