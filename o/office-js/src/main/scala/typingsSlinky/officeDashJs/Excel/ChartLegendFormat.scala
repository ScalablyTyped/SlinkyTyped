...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendFormatUpdateData
