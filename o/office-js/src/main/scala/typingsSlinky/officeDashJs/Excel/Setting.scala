...
import typingsSlinky.officeDashJs.Excel.Interfaces.SettingData
import typingsSlinky.officeDashJs.Excel.Interfaces.SettingLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.SettingUpdateData
