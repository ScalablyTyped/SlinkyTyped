...
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerStyleData
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerStyleLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerStyleUpdateData
