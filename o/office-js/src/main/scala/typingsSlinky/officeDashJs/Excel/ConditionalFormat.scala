...
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatUpdateData
...
class ConditionalFormat () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.6]
    */
  val `type`: ConditionalFormatType | Custom | DataBar | ColorScale | typingsSlinky.officeDashJs.officeDashJsStrings.IconSet | TopBottom | PresetCriteria | ContainsText | CellValue = js.native
  /**
    *
