...
import typingsSlinky.officeDashJs.Excel.Interfaces.IterativeCalculationData
import typingsSlinky.officeDashJs.Excel.Interfaces.IterativeCalculationLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.IterativeCalculationUpdateData
...
class IterativeCalculation () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): IterativeCalculation = js.native
