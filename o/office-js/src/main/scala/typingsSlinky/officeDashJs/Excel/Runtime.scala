...
import typingsSlinky.officeDashJs.Excel.Interfaces.RuntimeData
import typingsSlinky.officeDashJs.Excel.Interfaces.RuntimeLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.RuntimeUpdateData
