...
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatCollectionLoadOptions
...
class ConditionalFormatCollection () extends ClientObject {
  ...
  @JSName("add")
  def add_IconSet(`type`: typingsSlinky.officeDashJs.officeDashJsStrings.IconSet): ConditionalFormat = js.native
  @JSName("add")
