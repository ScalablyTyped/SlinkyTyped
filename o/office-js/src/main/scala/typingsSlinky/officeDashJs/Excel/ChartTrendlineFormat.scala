...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartTrendlineFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartTrendlineFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartTrendlineFormatUpdateData
