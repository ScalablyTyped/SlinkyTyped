...
object SortMethod extends js.Object {
  ...
  /* "PinYin" */ val pinYin: typingsSlinky.officeDashJs.Excel.SortMethod.pinYin with String = js.native
  /* "StrokeCount" */ val strokeCount: typingsSlinky.officeDashJs.Excel.SortMethod.strokeCount with String = js.native
  @JSBracketAccess
