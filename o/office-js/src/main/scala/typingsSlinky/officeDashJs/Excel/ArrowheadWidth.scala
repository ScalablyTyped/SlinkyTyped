...
object ArrowheadWidth extends js.Object {
  ...
  /* "Medium" */ val medium: typingsSlinky.officeDashJs.Excel.ArrowheadWidth.medium with String = js.native
  /* "Narrow" */ val narrow: typingsSlinky.officeDashJs.Excel.ArrowheadWidth.narrow with String = js.native
  /* "Wide" */ val wide: typingsSlinky.officeDashJs.Excel.ArrowheadWidth.wide with String = js.native
  @JSBracketAccess
