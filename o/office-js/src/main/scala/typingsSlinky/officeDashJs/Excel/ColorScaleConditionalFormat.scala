...
import typingsSlinky.officeDashJs.Excel.Interfaces.ColorScaleConditionalFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.ColorScaleConditionalFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ColorScaleConditionalFormatUpdateData
