...
import typingsSlinky.officeDashJs.Excel.CalculationMode
import typingsSlinky.officeDashJs.officeDashJsStrings.Automatic
import typingsSlinky.officeDashJs.officeDashJsStrings.AutomaticExceptTables
import typingsSlinky.officeDashJs.officeDashJsStrings.Manual
