...
import typingsSlinky.officeDashJs.Excel.Interfaces.ShapeData
import typingsSlinky.officeDashJs.Excel.Interfaces.ShapeLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ShapeUpdateData
...
import typingsSlinky.officeDashJs.officeDashJsStrings.BringForward
import typingsSlinky.officeDashJs.officeDashJsStrings.BringToFront
import typingsSlinky.officeDashJs.officeDashJsStrings.CurrentSize
...
import typingsSlinky.officeDashJs.officeDashJsStrings.OriginalSize
import typingsSlinky.officeDashJs.officeDashJsStrings.PNG
import typingsSlinky.officeDashJs.officeDashJsStrings.SVG
import typingsSlinky.officeDashJs.officeDashJsStrings.ScaleFromBottomRight
import typingsSlinky.officeDashJs.officeDashJsStrings.ScaleFromMiddle
import typingsSlinky.officeDashJs.officeDashJsStrings.ScaleFromTopLeft
import typingsSlinky.officeDashJs.officeDashJsStrings.SendBackward
import typingsSlinky.officeDashJs.officeDashJsStrings.SendToBack
...
class Shape () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  val `type`: ShapeType | Unsupported | typingsSlinky.officeDashJs.officeDashJsStrings.Image | typingsSlinky.officeDashJs.officeDashJsStrings.GeometricShape | Group | typingsSlinky.officeDashJs.officeDashJsStrings.Line = js.native
  /**
    *
