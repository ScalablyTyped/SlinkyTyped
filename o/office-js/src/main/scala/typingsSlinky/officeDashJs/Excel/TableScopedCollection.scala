...
import typingsSlinky.officeDashJs.Excel.Interfaces.TableScopedCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.TableScopedCollectionLoadOptions
