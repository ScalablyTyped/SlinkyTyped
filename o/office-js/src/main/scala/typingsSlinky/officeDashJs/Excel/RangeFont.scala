...
import typingsSlinky.officeDashJs.Excel.Interfaces.RangeFontData
import typingsSlinky.officeDashJs.Excel.Interfaces.RangeFontLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.RangeFontUpdateData
...
class RangeFont () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  var underline: RangeUnderlineStyle | None | Single | typingsSlinky.officeDashJs.officeDashJsStrings.Double | SingleAccountant | DoubleAccountant = js.native
  /**
