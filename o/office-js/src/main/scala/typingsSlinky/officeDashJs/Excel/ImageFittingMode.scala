...
object ImageFittingMode extends js.Object {
  ...
  /* "Fill" */ val fill: typingsSlinky.officeDashJs.Excel.ImageFittingMode.fill with String = js.native
  /* "Fit" */ val fit: typingsSlinky.officeDashJs.Excel.ImageFittingMode.fit with String = js.native
  /* "FitAndCenter" */ val fitAndCenter: typingsSlinky.officeDashJs.Excel.ImageFittingMode.fitAndCenter with String = js.native
  @JSBracketAccess
