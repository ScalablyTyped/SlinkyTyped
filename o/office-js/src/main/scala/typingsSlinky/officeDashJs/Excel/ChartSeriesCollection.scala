...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartSeriesCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartSeriesCollectionLoadOptions
