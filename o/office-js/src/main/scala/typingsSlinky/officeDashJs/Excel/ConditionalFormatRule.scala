...
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatRuleData
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatRuleLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalFormatRuleUpdateData
