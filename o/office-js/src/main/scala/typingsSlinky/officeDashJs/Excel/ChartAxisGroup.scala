...
object ChartAxisGroup extends js.Object {
  ...
  /* "Primary" */ val primary: typingsSlinky.officeDashJs.Excel.ChartAxisGroup.primary with String = js.native
  /* "Secondary" */ val secondary: typingsSlinky.officeDashJs.Excel.ChartAxisGroup.secondary with String = js.native
  @JSBracketAccess
