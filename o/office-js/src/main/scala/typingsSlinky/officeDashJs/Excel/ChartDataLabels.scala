...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartDataLabelsData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartDataLabelsLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartDataLabelsUpdateData
