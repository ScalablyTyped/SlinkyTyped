...
import typingsSlinky.officeDashJs.Excel.Interfaces.FormatProtectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.FormatProtectionLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.FormatProtectionUpdateData
