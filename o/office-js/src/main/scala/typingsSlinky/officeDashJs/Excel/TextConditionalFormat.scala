...
import typingsSlinky.officeDashJs.Excel.Interfaces.TextConditionalFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.TextConditionalFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.TextConditionalFormatUpdateData
