...
object ChartPlotBy extends js.Object {
  ...
  /* "Columns" */ val columns: typingsSlinky.officeDashJs.Excel.ChartPlotBy.columns with String = js.native
  /* "Rows" */ val rows: typingsSlinky.officeDashJs.Excel.ChartPlotBy.rows with String = js.native
  @JSBracketAccess
