...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartSeriesData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartSeriesLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartSeriesUpdateData
