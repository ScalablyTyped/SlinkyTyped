...
object CalculationMode extends js.Object {
  ...
  /* "Automatic" */ val automatic: typingsSlinky.officeDashJs.Excel.CalculationMode.automatic with String = js.native
  /* "AutomaticExceptTables" */ val automaticExceptTables: typingsSlinky.officeDashJs.Excel.CalculationMode.automaticExceptTables with String = js.native
  /* "Manual" */ val manual: typingsSlinky.officeDashJs.Excel.CalculationMode.manual with String = js.native
  @JSBracketAccess
