...
import typingsSlinky.officeDashJs.Excel.Interfaces.PageBreakData
import typingsSlinky.officeDashJs.Excel.Interfaces.PageBreakLoadOptions
...
class PageBreak () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): PageBreak = js.native
