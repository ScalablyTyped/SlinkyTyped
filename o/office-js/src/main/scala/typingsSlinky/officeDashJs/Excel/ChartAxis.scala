...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartAxisData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartAxisLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartAxisUpdateData
...
class ChartAxis () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartAxis = js.native
