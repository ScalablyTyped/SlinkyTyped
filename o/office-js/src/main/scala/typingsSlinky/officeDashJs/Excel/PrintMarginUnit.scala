...
object PrintMarginUnit extends js.Object {
  ...
  /* "Centimeters" */ val centimeters: typingsSlinky.officeDashJs.Excel.PrintMarginUnit.centimeters with String = js.native
  /* "Inches" */ val inches: typingsSlinky.officeDashJs.Excel.PrintMarginUnit.inches with String = js.native
  /* "Points" */ val points: typingsSlinky.officeDashJs.Excel.PrintMarginUnit.points with String = js.native
  @JSBracketAccess
