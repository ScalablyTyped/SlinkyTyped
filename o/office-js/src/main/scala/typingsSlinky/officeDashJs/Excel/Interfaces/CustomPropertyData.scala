...
import typingsSlinky.officeDashJs.Excel.DocumentPropertyType
import typingsSlinky.officeDashJs.officeDashJsStrings.Boolean
import typingsSlinky.officeDashJs.officeDashJsStrings.Date
import typingsSlinky.officeDashJs.officeDashJsStrings.Float
...
trait CustomPropertyData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    DocumentPropertyType | Number | Boolean | Date | typingsSlinky.officeDashJs.officeDashJsStrings.String | Float
  ] = js.undefined
  /**
    *
...
object CustomPropertyData {
  ...
  def apply(
    key: String = null,
    `type`: DocumentPropertyType | Number | Boolean | Date | typingsSlinky.officeDashJs.officeDashJsStrings.String | Float = null,
    value: js.Any = null
  ): CustomPropertyData = {
