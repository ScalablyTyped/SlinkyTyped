...
import typingsSlinky.officeDashJs.Excel.SlicerSortType
import typingsSlinky.officeDashJs.officeDashJsStrings.Ascending
import typingsSlinky.officeDashJs.officeDashJsStrings.DataSourceOrder
import typingsSlinky.officeDashJs.officeDashJsStrings.Descending
