...
import typingsSlinky.officeDashJs.officeDashJsStrings.Information
import typingsSlinky.officeDashJs.officeDashJsStrings.Stop
import typingsSlinky.officeDashJs.officeDashJsStrings.Warning
