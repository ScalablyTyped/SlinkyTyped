...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendEntryData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendEntryLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendEntryUpdateData
