...
import typingsSlinky.officeDashJs.Excel.Interfaces.TableRowData
import typingsSlinky.officeDashJs.Excel.Interfaces.TableRowLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.TableRowUpdateData
