...
object BindingType extends js.Object {
  ...
  /* "Range" */ val range: typingsSlinky.officeDashJs.Excel.BindingType.range with String = js.native
  /* "Table" */ val table: typingsSlinky.officeDashJs.Excel.BindingType.table with String = js.native
  /* "Text" */ val text: typingsSlinky.officeDashJs.Excel.BindingType.text with String = js.native
  @JSBracketAccess
