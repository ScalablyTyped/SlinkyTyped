...
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotItemData
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotItemLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotItemUpdateData
...
class PivotItem () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): PivotItem = js.native
