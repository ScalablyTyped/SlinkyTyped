...
object ConditionalRangeBorderIndex extends js.Object {
  ...
  /* "EdgeBottom" */ val edgeBottom: typingsSlinky.officeDashJs.Excel.ConditionalRangeBorderIndex.edgeBottom with String = js.native
  /* "EdgeLeft" */ val edgeLeft: typingsSlinky.officeDashJs.Excel.ConditionalRangeBorderIndex.edgeLeft with String = js.native
  /* "EdgeRight" */ val edgeRight: typingsSlinky.officeDashJs.Excel.ConditionalRangeBorderIndex.edgeRight with String = js.native
  /* "EdgeTop" */ val edgeTop: typingsSlinky.officeDashJs.Excel.ConditionalRangeBorderIndex.edgeTop with String = js.native
  @JSBracketAccess
