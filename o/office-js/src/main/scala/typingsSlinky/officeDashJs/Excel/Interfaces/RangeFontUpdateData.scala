...
import typingsSlinky.officeDashJs.Excel.RangeUnderlineStyle
import typingsSlinky.officeDashJs.officeDashJsStrings.DoubleAccountant
import typingsSlinky.officeDashJs.officeDashJsStrings.None
import typingsSlinky.officeDashJs.officeDashJsStrings.Single
import typingsSlinky.officeDashJs.officeDashJsStrings.SingleAccountant
...
trait RangeFontUpdateData extends js.Object {
  ...
  var underline: js.UndefOr[
    RangeUnderlineStyle | None | Single | typingsSlinky.officeDashJs.officeDashJsStrings.Double | SingleAccountant | DoubleAccountant
  ] = js.undefined
}
...
object RangeFontUpdateData {
  ...
  def apply(
    ...
    underline: RangeUnderlineStyle | None | Single | typingsSlinky.officeDashJs.officeDashJsStrings.Double | SingleAccountant | DoubleAccountant = null
  ): RangeFontUpdateData = {
