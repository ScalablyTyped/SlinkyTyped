...
object ChartAxisTimeUnit extends js.Object {
  ...
  /* "Days" */ val days: typingsSlinky.officeDashJs.Excel.ChartAxisTimeUnit.days with String = js.native
  /* "Months" */ val months: typingsSlinky.officeDashJs.Excel.ChartAxisTimeUnit.months with String = js.native
  /* "Years" */ val years: typingsSlinky.officeDashJs.Excel.ChartAxisTimeUnit.years with String = js.native
  @JSBracketAccess
