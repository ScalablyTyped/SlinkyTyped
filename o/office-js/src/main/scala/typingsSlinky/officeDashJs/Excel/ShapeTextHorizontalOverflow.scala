...
object ShapeTextHorizontalOverflow extends js.Object {
  ...
  /* "Clip" */ val clip: typingsSlinky.officeDashJs.Excel.ShapeTextHorizontalOverflow.clip with String = js.native
  /* "Overflow" */ val overflow: typingsSlinky.officeDashJs.Excel.ShapeTextHorizontalOverflow.overflow with String = js.native
  @JSBracketAccess
