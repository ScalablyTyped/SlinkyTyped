...
import typingsSlinky.officeDashJs.Excel.Interfaces.DocumentPropertiesData
import typingsSlinky.officeDashJs.Excel.Interfaces.DocumentPropertiesLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.DocumentPropertiesUpdateData
