...
object ReadingOrder extends js.Object {
  ...
  /* "Context" */ val context: typingsSlinky.officeDashJs.Excel.ReadingOrder.context with String = js.native
  /* "LeftToRight" */ val leftToRight: typingsSlinky.officeDashJs.Excel.ReadingOrder.leftToRight with String = js.native
  /* "RightToLeft" */ val rightToLeft: typingsSlinky.officeDashJs.Excel.ReadingOrder.rightToLeft with String = js.native
  @JSBracketAccess
