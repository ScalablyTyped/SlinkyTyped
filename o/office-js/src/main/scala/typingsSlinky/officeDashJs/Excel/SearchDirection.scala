...
object SearchDirection extends js.Object {
  ...
  /* "Backwards" */ val backwards: typingsSlinky.officeDashJs.Excel.SearchDirection.backwards with String = js.native
  /* "Forward" */ val forward: typingsSlinky.officeDashJs.Excel.SearchDirection.forward with String = js.native
  @JSBracketAccess
