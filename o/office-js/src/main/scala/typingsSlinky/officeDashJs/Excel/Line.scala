...
import typingsSlinky.officeDashJs.Excel.Interfaces.LineData
import typingsSlinky.officeDashJs.Excel.Interfaces.LineLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.LineUpdateData
