...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartPointFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartPointFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartPointFormatUpdateData
