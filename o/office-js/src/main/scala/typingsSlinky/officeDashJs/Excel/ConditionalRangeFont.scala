...
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalRangeFontData
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalRangeFontLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalRangeFontUpdateData
