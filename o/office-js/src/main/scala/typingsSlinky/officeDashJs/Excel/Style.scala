...
import typingsSlinky.officeDashJs.Excel.Interfaces.StyleData
import typingsSlinky.officeDashJs.Excel.Interfaces.StyleLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.StyleUpdateData
