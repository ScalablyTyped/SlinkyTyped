...
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotTableStyleData
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotTableStyleLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotTableStyleUpdateData
