...
import typingsSlinky.officeDashJs.Excel.Interfaces.NamedItemArrayValuesData
import typingsSlinky.officeDashJs.Excel.Interfaces.NamedItemArrayValuesLoadOptions
