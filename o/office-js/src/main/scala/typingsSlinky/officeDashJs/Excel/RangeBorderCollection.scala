...
import typingsSlinky.officeDashJs.Excel.Interfaces.RangeBorderCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.RangeBorderCollectionLoadOptions
