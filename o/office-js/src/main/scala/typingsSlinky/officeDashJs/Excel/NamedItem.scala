...
import typingsSlinky.officeDashJs.Excel.Interfaces.NamedItemData
import typingsSlinky.officeDashJs.Excel.Interfaces.NamedItemLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.NamedItemUpdateData
...
class NamedItem () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.4]
    */
  val scope: NamedItemScope | typingsSlinky.officeDashJs.officeDashJsStrings.Worksheet | typingsSlinky.officeDashJs.officeDashJsStrings.Workbook = js.native
  /**
    *
    ...
    */
  val `type`: NamedItemType | typingsSlinky.officeDashJs.officeDashJsStrings.String | Integer | Double | Boolean | typingsSlinky.officeDashJs.officeDashJsStrings.Range | Error | Array = js.native
  /**
    *
