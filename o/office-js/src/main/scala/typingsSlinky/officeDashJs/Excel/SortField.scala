...
import typingsSlinky.officeDashJs.officeDashJsStrings.TextAsNumber
...
trait SortField extends js.Object {
  ...
  var sortOn: js.UndefOr[
    SortOn | Value | CellColor | FontColor | typingsSlinky.officeDashJs.officeDashJsStrings.Icon
  ] = js.undefined
  /**
    *
...
object SortField {
  ...
  def apply(
    ...
    icon: Icon = null,
    sortOn: SortOn | Value | CellColor | FontColor | typingsSlinky.officeDashJs.officeDashJsStrings.Icon = null,
