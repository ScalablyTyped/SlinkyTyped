...
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalRangeFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalRangeFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ConditionalRangeFormatUpdateData
...
class ConditionalRangeFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ConditionalRangeFormat = js.native
