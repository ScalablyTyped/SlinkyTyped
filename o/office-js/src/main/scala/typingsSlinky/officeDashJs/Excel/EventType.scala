...
object EventType extends js.Object {
  ...
  /* "AgaveVisualUpdate" */ val agaveVisualUpdate: typingsSlinky.officeDashJs.Excel.EventType.agaveVisualUpdate with String = js.native
  /* "ChartActivated" */ val chartActivated: typingsSlinky.officeDashJs.Excel.EventType.chartActivated with String = js.native
  /* "ChartAdded" */ val chartAdded: typingsSlinky.officeDashJs.Excel.EventType.chartAdded with String = js.native
  /* "ChartDeactivated" */ val chartDeactivated: typingsSlinky.officeDashJs.Excel.EventType.chartDeactivated with String = js.native
  /* "ChartDeleted" */ val chartDeleted: typingsSlinky.officeDashJs.Excel.EventType.chartDeleted with String = js.native
  /* "RibbonCommandExecuted" */ val ribbonCommandExecuted: typingsSlinky.officeDashJs.Excel.EventType.ribbonCommandExecuted with String = js.native
  /* "ShapeActivated" */ val shapeActivated: typingsSlinky.officeDashJs.Excel.EventType.shapeActivated with String = js.native
  /* "ShapeDeactivated" */ val shapeDeactivated: typingsSlinky.officeDashJs.Excel.EventType.shapeDeactivated with String = js.native
  /* "TableAdded" */ val tableAdded: typingsSlinky.officeDashJs.Excel.EventType.tableAdded with String = js.native
  /* "TableChanged" */ val tableChanged: typingsSlinky.officeDashJs.Excel.EventType.tableChanged with String = js.native
  /* "TableDeleted" */ val tableDeleted: typingsSlinky.officeDashJs.Excel.EventType.tableDeleted with String = js.native
  /* "TableFiltered" */ val tableFiltered: typingsSlinky.officeDashJs.Excel.EventType.tableFiltered with String = js.native
  /* "TableSelectionChanged" */ val tableSelectionChanged: typingsSlinky.officeDashJs.Excel.EventType.tableSelectionChanged with String = js.native
  /* "VisualChange" */ val visualChange: typingsSlinky.officeDashJs.Excel.EventType.visualChange with String = js.native
  /* "VisualSelectionChanged" */ val visualSelectionChanged: typingsSlinky.officeDashJs.Excel.EventType.visualSelectionChanged with String = js.native
  /* "WACOperationEvent" */ val wacoperationEvent: typingsSlinky.officeDashJs.Excel.EventType.wacoperationEvent with String = js.native
  /* "WorkbookAutoSaveSettingChanged" */ val workbookAutoSaveSettingChanged: typingsSlinky.officeDashJs.Excel.EventType.workbookAutoSaveSettingChanged with String = js.native
  /* "WorksheetActivated" */ val worksheetActivated: typingsSlinky.officeDashJs.Excel.EventType.worksheetActivated with String = js.native
  /* "WorksheetAdded" */ val worksheetAdded: typingsSlinky.officeDashJs.Excel.EventType.worksheetAdded with String = js.native
  /* "WorksheetCalculated" */ val worksheetCalculated: typingsSlinky.officeDashJs.Excel.EventType.worksheetCalculated with String = js.native
  /* "WorksheetChanged" */ val worksheetChanged: typingsSlinky.officeDashJs.Excel.EventType.worksheetChanged with String = js.native
  /* "WorksheetColumnSorted" */ val worksheetColumnSorted: typingsSlinky.officeDashJs.Excel.EventType.worksheetColumnSorted with String = js.native
  /* "WorksheetDeactivated" */ val worksheetDeactivated: typingsSlinky.officeDashJs.Excel.EventType.worksheetDeactivated with String = js.native
  /* "WorksheetDeleted" */ val worksheetDeleted: typingsSlinky.officeDashJs.Excel.EventType.worksheetDeleted with String = js.native
  /* "WorksheetFiltered" */ val worksheetFiltered: typingsSlinky.officeDashJs.Excel.EventType.worksheetFiltered with String = js.native
  /* "WorksheetFormatChanged" */ val worksheetFormatChanged: typingsSlinky.officeDashJs.Excel.EventType.worksheetFormatChanged with String = js.native
  /* "WorksheetRowHiddenChanged" */ val worksheetRowHiddenChanged: typingsSlinky.officeDashJs.Excel.EventType.worksheetRowHiddenChanged with String = js.native
  /* "WorksheetRowSorted" */ val worksheetRowSorted: typingsSlinky.officeDashJs.Excel.EventType.worksheetRowSorted with String = js.native
  /* "WorksheetSelectionChanged" */ val worksheetSelectionChanged: typingsSlinky.officeDashJs.Excel.EventType.worksheetSelectionChanged with String = js.native
  /* "WorksheetSingleClicked" */ val worksheetSingleClicked: typingsSlinky.officeDashJs.Excel.EventType.worksheetSingleClicked with String = js.native
  @JSBracketAccess
