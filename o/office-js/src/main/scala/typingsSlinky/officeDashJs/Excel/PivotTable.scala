...
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotTableData
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotTableLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.PivotTableUpdateData
