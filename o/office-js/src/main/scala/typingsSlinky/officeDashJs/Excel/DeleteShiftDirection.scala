...
object DeleteShiftDirection extends js.Object {
  ...
  /* "Left" */ val left: typingsSlinky.officeDashJs.Excel.DeleteShiftDirection.left with String = js.native
  /* "Up" */ val up: typingsSlinky.officeDashJs.Excel.DeleteShiftDirection.up with String = js.native
  @JSBracketAccess
