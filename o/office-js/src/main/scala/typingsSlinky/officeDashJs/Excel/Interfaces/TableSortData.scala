...
import typingsSlinky.officeDashJs.Excel.SortField
import typingsSlinky.officeDashJs.Excel.SortMethod
import typingsSlinky.officeDashJs.officeDashJsStrings.PinYin
import typingsSlinky.officeDashJs.officeDashJsStrings.StrokeCount
