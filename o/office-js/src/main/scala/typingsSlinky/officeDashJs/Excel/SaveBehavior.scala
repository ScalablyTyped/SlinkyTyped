...
object SaveBehavior extends js.Object {
  ...
  /* "Prompt" */ val prompt: typingsSlinky.officeDashJs.Excel.SaveBehavior.prompt with String = js.native
  /* "Save" */ val save: typingsSlinky.officeDashJs.Excel.SaveBehavior.save with String = js.native
  @JSBracketAccess
