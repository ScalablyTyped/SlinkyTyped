...
object ConditionalDataBarDirection extends js.Object {
  ...
  /* "Context" */ val context: typingsSlinky.officeDashJs.Excel.ConditionalDataBarDirection.context with String = js.native
  /* "LeftToRight" */ val leftToRight: typingsSlinky.officeDashJs.Excel.ConditionalDataBarDirection.leftToRight with String = js.native
  /* "RightToLeft" */ val rightToLeft: typingsSlinky.officeDashJs.Excel.ConditionalDataBarDirection.rightToLeft with String = js.native
  @JSBracketAccess
