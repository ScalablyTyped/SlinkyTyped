...
object ShapeScaleType extends js.Object {
  ...
  /* "CurrentSize" */ val currentSize: typingsSlinky.officeDashJs.Excel.ShapeScaleType.currentSize with String = js.native
  /* "OriginalSize" */ val originalSize: typingsSlinky.officeDashJs.Excel.ShapeScaleType.originalSize with String = js.native
  @JSBracketAccess
