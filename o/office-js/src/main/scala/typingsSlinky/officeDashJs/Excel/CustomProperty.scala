...
import typingsSlinky.officeDashJs.Excel.Interfaces.CustomPropertyData
import typingsSlinky.officeDashJs.Excel.Interfaces.CustomPropertyLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.CustomPropertyUpdateData
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  val `type`: DocumentPropertyType | Number | Boolean | Date | typingsSlinky.officeDashJs.officeDashJsStrings.String | Float = js.native
  /**
    *
