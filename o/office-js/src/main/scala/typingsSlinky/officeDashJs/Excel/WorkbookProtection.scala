...
import typingsSlinky.officeDashJs.Excel.Interfaces.WorkbookProtectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.WorkbookProtectionLoadOptions
