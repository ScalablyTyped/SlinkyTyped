...
import typingsSlinky.officeDashJs.Excel.Interfaces.GroupShapeCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.GroupShapeCollectionLoadOptions
