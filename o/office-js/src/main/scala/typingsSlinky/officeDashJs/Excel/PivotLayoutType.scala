...
object PivotLayoutType extends js.Object {
  ...
  /* "Compact" */ val compact: typingsSlinky.officeDashJs.Excel.PivotLayoutType.compact with String = js.native
  /* "Outline" */ val outline: typingsSlinky.officeDashJs.Excel.PivotLayoutType.outline with String = js.native
  /* "Tabular" */ val tabular: typingsSlinky.officeDashJs.Excel.PivotLayoutType.tabular with String = js.native
  @JSBracketAccess
