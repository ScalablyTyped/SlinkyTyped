...
object ChartAxisCategoryType extends js.Object {
  ...
  /* "Automatic" */ val automatic: typingsSlinky.officeDashJs.Excel.ChartAxisCategoryType.automatic with String = js.native
  /* "DateAxis" */ val dateAxis: typingsSlinky.officeDashJs.Excel.ChartAxisCategoryType.dateAxis with String = js.native
  /* "TextAxis" */ val textAxis: typingsSlinky.officeDashJs.Excel.ChartAxisCategoryType.textAxis with String = js.native
  @JSBracketAccess
