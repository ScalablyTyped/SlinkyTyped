...
object ShapeTextReadingOrder extends js.Object {
  ...
  /* "LeftToRight" */ val leftToRight: typingsSlinky.officeDashJs.Excel.ShapeTextReadingOrder.leftToRight with String = js.native
  /* "RightToLeft" */ val rightToLeft: typingsSlinky.officeDashJs.Excel.ShapeTextReadingOrder.rightToLeft with String = js.native
  @JSBracketAccess
