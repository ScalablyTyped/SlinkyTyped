...
import typingsSlinky.officeDashJs.Excel.Interfaces.WorkbookData
import typingsSlinky.officeDashJs.Excel.Interfaces.WorkbookLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.WorkbookUpdateData
