...
import typingsSlinky.officeDashJs.Excel.Interfaces.HeaderFooterData
import typingsSlinky.officeDashJs.Excel.Interfaces.HeaderFooterLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.HeaderFooterUpdateData
