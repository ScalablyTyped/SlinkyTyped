...
import typingsSlinky.officeDashJs.Excel.Interfaces.HeaderFooterGroupData
import typingsSlinky.officeDashJs.Excel.Interfaces.HeaderFooterGroupLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.HeaderFooterGroupUpdateData
