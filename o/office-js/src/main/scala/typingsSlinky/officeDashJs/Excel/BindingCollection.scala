...
import typingsSlinky.officeDashJs.Excel.Interfaces.BindingCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.BindingCollectionLoadOptions
...
class BindingCollection () extends ClientObject {
  ...
  def addFromNamedItem_Range(name: String, bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Range, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  def addFromNamedItem_Table(name: String, bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Table, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  ...
  def addFromSelection_Range(bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Range, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Table(bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Table, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Text(bindingType: Text, id: String): Binding = js.native
  @JSName("add")
  def add_Range(range: String, bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Range, id: String): Binding = js.native
  /**
    *
    * Add a new binding to a particular Range.
    *
    ...
    */
  @JSName("add")
  def add_Range(range: Range, bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Range, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: String, bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Table, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: Range, bindingType: typingsSlinky.officeDashJs.officeDashJsStrings.Table, id: String): Binding = js.native
  @JSName("add")
