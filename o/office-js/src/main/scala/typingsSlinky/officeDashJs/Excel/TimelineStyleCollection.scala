...
import typingsSlinky.officeDashJs.Excel.Interfaces.TimelineStyleCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.TimelineStyleCollectionLoadOptions
