...
import typingsSlinky.officeDashJs.Excel.Interfaces.CustomPropertyCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.CustomPropertyCollectionLoadOptions
