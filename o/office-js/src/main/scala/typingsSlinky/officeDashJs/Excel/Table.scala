...
import typingsSlinky.officeDashJs.Excel.Interfaces.TableData
import typingsSlinky.officeDashJs.Excel.Interfaces.TableLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.TableUpdateData
