...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartDataLabelFormatData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartDataLabelFormatLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartDataLabelFormatUpdateData
...
class ChartDataLabelFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartDataLabelFormat = js.native
