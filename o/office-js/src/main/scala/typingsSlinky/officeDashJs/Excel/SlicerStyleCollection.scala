...
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerStyleCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerStyleCollectionLoadOptions
