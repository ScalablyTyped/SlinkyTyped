...
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendData
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.ChartLegendUpdateData
