...
object ConditionalIconCriterionOperator extends js.Object {
  ...
  /* "GreaterThan" */ val greaterThan: typingsSlinky.officeDashJs.Excel.ConditionalIconCriterionOperator.greaterThan with String = js.native
  /* "GreaterThanOrEqual" */ val greaterThanOrEqual: typingsSlinky.officeDashJs.Excel.ConditionalIconCriterionOperator.greaterThanOrEqual with String = js.native
  /* "Invalid" */ val invalid: typingsSlinky.officeDashJs.Excel.ConditionalIconCriterionOperator.invalid with String = js.native
  @JSBracketAccess
