...
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerData
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerLoadOptions
import typingsSlinky.officeDashJs.Excel.Interfaces.SlicerUpdateData
