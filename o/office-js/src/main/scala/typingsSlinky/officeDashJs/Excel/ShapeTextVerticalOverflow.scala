...
object ShapeTextVerticalOverflow extends js.Object {
  ...
  /* "Clip" */ val clip: typingsSlinky.officeDashJs.Excel.ShapeTextVerticalOverflow.clip with String = js.native
  /* "Ellipsis" */ val ellipsis: typingsSlinky.officeDashJs.Excel.ShapeTextVerticalOverflow.ellipsis with String = js.native
  /* "Overflow" */ val overflow: typingsSlinky.officeDashJs.Excel.ShapeTextVerticalOverflow.overflow with String = js.native
  @JSBracketAccess
