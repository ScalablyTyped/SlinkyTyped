...
import typingsSlinky.officeDashJs.Excel.Interfaces.DataPivotHierarchyCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.DataPivotHierarchyCollectionLoadOptions
