...
import typingsSlinky.officeDashJs.Excel.Interfaces.SettingCollectionData
import typingsSlinky.officeDashJs.Excel.Interfaces.SettingCollectionLoadOptions
