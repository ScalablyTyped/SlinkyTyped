...
import typingsSlinky.officeDashJs.Excel.Interfaces.BindingData
import typingsSlinky.officeDashJs.Excel.Interfaces.BindingLoadOptions
...
import typingsSlinky.officeDashJs.OfficeExtension.EventHandlers
...
class Binding () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  val `type`: BindingType | typingsSlinky.officeDashJs.officeDashJsStrings.Range | typingsSlinky.officeDashJs.officeDashJsStrings.Table | Text = js.native
  /**
    *
    * Deletes the binding.
    *
