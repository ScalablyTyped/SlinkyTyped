...
import typingsSlinky.officeDashJs.Word.Interfaces.ContentControlCollectionData
import typingsSlinky.officeDashJs.Word.Interfaces.ContentControlCollectionLoadOptions
