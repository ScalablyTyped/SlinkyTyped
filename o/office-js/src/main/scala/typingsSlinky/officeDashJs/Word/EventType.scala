...
object EventType extends js.Object {
  ...
  /* "AnnotationAdded" */ val annotationAdded: typingsSlinky.officeDashJs.Word.EventType.annotationAdded with String = js.native
  /* "AnnotationChanged" */ val annotationChanged: typingsSlinky.officeDashJs.Word.EventType.annotationChanged with String = js.native
  /* "AnnotationDeleted" */ val annotationDeleted: typingsSlinky.officeDashJs.Word.EventType.annotationDeleted with String = js.native
  /* "ContentControlAdded" */ val contentControlAdded: typingsSlinky.officeDashJs.Word.EventType.contentControlAdded with String = js.native
  /* "ContentControlDataChanged" */ val contentControlDataChanged: typingsSlinky.officeDashJs.Word.EventType.contentControlDataChanged with String = js.native
  /* "ContentControlDeleted" */ val contentControlDeleted: typingsSlinky.officeDashJs.Word.EventType.contentControlDeleted with String = js.native
  /* "ContentControlSelectionChanged" */ val contentControlSelectionChanged: typingsSlinky.officeDashJs.Word.EventType.contentControlSelectionChanged with String = js.native
  @JSBracketAccess
