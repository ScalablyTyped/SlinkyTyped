...
import typingsSlinky.officeDashJs.Word.Interfaces.CustomPropertyData
import typingsSlinky.officeDashJs.Word.Interfaces.CustomPropertyLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.CustomPropertyUpdateData
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: DocumentPropertyType | typingsSlinky.officeDashJs.officeDashJsStrings.String | Number | Date | Boolean = js.native
  /**
    *
