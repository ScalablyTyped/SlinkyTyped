...
import typingsSlinky.officeDashJs.Word.Interfaces.BodyData
import typingsSlinky.officeDashJs.Word.Interfaces.BodyLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.BodyUpdateData
...
class Body () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typingsSlinky.officeDashJs.officeDashJsStrings.Section | Header | Footer | typingsSlinky.officeDashJs.officeDashJsStrings.TableCell = js.native
  /**
    *
