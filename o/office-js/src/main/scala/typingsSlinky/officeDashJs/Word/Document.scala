...
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentData
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentUpdateData
