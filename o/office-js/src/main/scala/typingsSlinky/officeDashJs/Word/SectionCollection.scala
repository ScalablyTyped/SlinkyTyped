...
import typingsSlinky.officeDashJs.Word.Interfaces.CollectionLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.SectionCollectionData
import typingsSlinky.officeDashJs.Word.Interfaces.SectionCollectionLoadOptions
