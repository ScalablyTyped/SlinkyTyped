...
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentPropertiesData
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentPropertiesLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentPropertiesUpdateData
