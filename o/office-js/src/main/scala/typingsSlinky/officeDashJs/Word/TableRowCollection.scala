...
import typingsSlinky.officeDashJs.Word.Interfaces.TableRowCollectionData
import typingsSlinky.officeDashJs.Word.Interfaces.TableRowCollectionLoadOptions
