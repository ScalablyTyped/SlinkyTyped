...
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentCreatedData
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentCreatedLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.DocumentCreatedUpdateData
