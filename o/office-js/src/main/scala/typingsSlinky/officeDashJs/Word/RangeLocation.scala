...
object RangeLocation extends js.Object {
  ...
  /* "After" */ val after: typingsSlinky.officeDashJs.Word.RangeLocation.after with String = js.native
  /* "Before" */ val before: typingsSlinky.officeDashJs.Word.RangeLocation.before with String = js.native
  /* "Content" */ val content: typingsSlinky.officeDashJs.Word.RangeLocation.content with String = js.native
  /* "End" */ val end: typingsSlinky.officeDashJs.Word.RangeLocation.end with String = js.native
  /* "Start" */ val start: typingsSlinky.officeDashJs.Word.RangeLocation.start with String = js.native
  /* "Whole" */ val whole: typingsSlinky.officeDashJs.Word.RangeLocation.whole with String = js.native
  @JSBracketAccess
