...
import typingsSlinky.officeDashJs.officeDashJsStrings.Word
...
trait FontUpdateData extends js.Object {
  ...
  var underline: js.UndefOr[
    UnderlineType | Mixed | None | Hidden | DotLine | Single | Word | typingsSlinky.officeDashJs.officeDashJsStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble
  ] = js.undefined
}
...
object FontUpdateData {
  ...
  def apply(
    ...
    underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | Word | typingsSlinky.officeDashJs.officeDashJsStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = null
  ): FontUpdateData = {
