...
import typingsSlinky.officeDashJs.Word.UnderlineType
import typingsSlinky.officeDashJs.officeDashJsStrings.DashLine
import typingsSlinky.officeDashJs.officeDashJsStrings.DashLineHeavy
import typingsSlinky.officeDashJs.officeDashJsStrings.DashLineLong
import typingsSlinky.officeDashJs.officeDashJsStrings.DashLineLongHeavy
import typingsSlinky.officeDashJs.officeDashJsStrings.DotDashLine
import typingsSlinky.officeDashJs.officeDashJsStrings.DotDashLineHeavy
import typingsSlinky.officeDashJs.officeDashJsStrings.DotLine
...
import typingsSlinky.officeDashJs.officeDashJsStrings.TwoDotDashLine
import typingsSlinky.officeDashJs.officeDashJsStrings.TwoDotDashLineHeavy
import typingsSlinky.officeDashJs.officeDashJsStrings.Wave
import typingsSlinky.officeDashJs.officeDashJsStrings.WaveDouble
import typingsSlinky.officeDashJs.officeDashJsStrings.WaveHeavy
...
trait FontUpdateData extends js.Object {
  ...
  var underline: js.UndefOr[
    UnderlineType | Mixed | None | Hidden | DotLine | Single | typingsSlinky.officeDashJs.officeDashJsStrings.Word | typingsSlinky.officeDashJs.officeDashJsStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble
  ] = js.undefined
}
...
object FontUpdateData {
  ...
  def apply(
    ...
    underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | typingsSlinky.officeDashJs.officeDashJsStrings.Word | typingsSlinky.officeDashJs.officeDashJsStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = null
  ): FontUpdateData = {
