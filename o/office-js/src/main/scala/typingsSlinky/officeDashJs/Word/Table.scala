...
import typingsSlinky.officeDashJs.Word.Interfaces.TableData
import typingsSlinky.officeDashJs.Word.Interfaces.TableLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.TableUpdateData
