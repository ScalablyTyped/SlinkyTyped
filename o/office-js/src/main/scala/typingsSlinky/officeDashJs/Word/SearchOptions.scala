...
import typingsSlinky.officeDashJs.Word.Interfaces.SearchOptionsData
import typingsSlinky.officeDashJs.Word.Interfaces.SearchOptionsLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.SearchOptionsUpdateData
