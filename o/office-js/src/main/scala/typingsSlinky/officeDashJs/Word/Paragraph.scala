...
import typingsSlinky.officeDashJs.Word.Interfaces.ParagraphData
import typingsSlinky.officeDashJs.Word.Interfaces.ParagraphLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.ParagraphUpdateData
import typingsSlinky.officeDashJs.officeDashJsStrings.After
import typingsSlinky.officeDashJs.officeDashJsStrings.Before
import typingsSlinky.officeDashJs.officeDashJsStrings.Centered
import typingsSlinky.officeDashJs.officeDashJsStrings.Content
import typingsSlinky.officeDashJs.officeDashJsStrings.End
import typingsSlinky.officeDashJs.officeDashJsStrings.Justified
