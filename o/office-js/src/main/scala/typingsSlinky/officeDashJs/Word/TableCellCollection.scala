...
import typingsSlinky.officeDashJs.Word.Interfaces.TableCellCollectionData
import typingsSlinky.officeDashJs.Word.Interfaces.TableCellCollectionLoadOptions
