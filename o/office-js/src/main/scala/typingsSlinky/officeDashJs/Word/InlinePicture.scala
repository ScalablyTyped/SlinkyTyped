...
import typingsSlinky.officeDashJs.Word.Interfaces.InlinePictureData
import typingsSlinky.officeDashJs.Word.Interfaces.InlinePictureLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.InlinePictureUpdateData
