...
import typingsSlinky.officeDashJs.Word.Interfaces.TableBorderData
import typingsSlinky.officeDashJs.Word.Interfaces.TableBorderLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.TableBorderUpdateData
