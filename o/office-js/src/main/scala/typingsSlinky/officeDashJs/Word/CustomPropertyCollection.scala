...
import typingsSlinky.officeDashJs.Word.Interfaces.CustomPropertyCollectionData
import typingsSlinky.officeDashJs.Word.Interfaces.CustomPropertyCollectionLoadOptions
