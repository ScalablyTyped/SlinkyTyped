...
object FileContentFormat extends js.Object {
  ...
  /* "Base64" */ val base64: typingsSlinky.officeDashJs.Word.FileContentFormat.base64 with String = js.native
  /* "Html" */ val html: typingsSlinky.officeDashJs.Word.FileContentFormat.html with String = js.native
  /* "Ooxml" */ val ooxml: typingsSlinky.officeDashJs.Word.FileContentFormat.ooxml with String = js.native
  @JSBracketAccess
