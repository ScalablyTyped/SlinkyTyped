...
object ContentControlAppearance extends js.Object {
  ...
  /* "BoundingBox" */ val boundingBox: typingsSlinky.officeDashJs.Word.ContentControlAppearance.boundingBox with String = js.native
  /* "Hidden" */ val hidden: typingsSlinky.officeDashJs.Word.ContentControlAppearance.hidden with String = js.native
  /* "Tags" */ val tags: typingsSlinky.officeDashJs.Word.ContentControlAppearance.tags with String = js.native
  @JSBracketAccess
