...
import typingsSlinky.officeDashJs.Word.Interfaces.ParagraphCollectionData
import typingsSlinky.officeDashJs.Word.Interfaces.ParagraphCollectionLoadOptions
