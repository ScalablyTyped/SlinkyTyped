...
import typingsSlinky.officeDashJs.Word.Interfaces.FontData
import typingsSlinky.officeDashJs.Word.Interfaces.FontLoadOptions
import typingsSlinky.officeDashJs.Word.Interfaces.FontUpdateData
...
class Font () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.1]
    */
  var underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | typingsSlinky.officeDashJs.officeDashJsStrings.Word | typingsSlinky.officeDashJs.officeDashJsStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = js.native
  /**
