...
import typingsSlinky.officeDashJs.Word.DocumentPropertyType
...
trait CustomPropertyData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    DocumentPropertyType | typingsSlinky.officeDashJs.officeDashJsStrings.String | Number | Date | Boolean
  ] = js.undefined
  /**
    *
...
object CustomPropertyData {
  ...
  def apply(
    key: String = null,
    `type`: DocumentPropertyType | typingsSlinky.officeDashJs.officeDashJsStrings.String | Number | Date | Boolean = null,
    value: js.Any = null
  ): CustomPropertyData = {
