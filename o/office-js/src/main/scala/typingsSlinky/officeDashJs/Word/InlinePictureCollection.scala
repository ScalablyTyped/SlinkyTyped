...
import typingsSlinky.officeDashJs.Word.Interfaces.InlinePictureCollectionData
import typingsSlinky.officeDashJs.Word.Interfaces.InlinePictureCollectionLoadOptions
