...
import typingsSlinky.officeDashJs.OneNote.Interfaces.ParagraphData
import typingsSlinky.officeDashJs.OneNote.Interfaces.ParagraphLoadOptions
import typingsSlinky.officeDashJs.OneNote.Interfaces.ParagraphUpdateData
...
class Paragraph () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: ParagraphType | typingsSlinky.officeDashJs.officeDashJsStrings.RichText | typingsSlinky.officeDashJs.officeDashJsStrings.Image | typingsSlinky.officeDashJs.officeDashJsStrings.Table | Ink | Other = js.native
  def addNoteTag(
