...
import typingsSlinky.officeDashJs.OneNote.Interfaces.FloatingInkData
import typingsSlinky.officeDashJs.OneNote.Interfaces.FloatingInkLoadOptions
...
class FloatingInk () extends ClientObject {
  ...
  def load(option: Anon_Expand): FloatingInk = js.native
