...
import typingsSlinky.officeDashJs.OneNote.Interfaces.TableRowCollectionData
import typingsSlinky.officeDashJs.OneNote.Interfaces.TableRowCollectionLoadOptions
