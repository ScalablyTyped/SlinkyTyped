...
import typingsSlinky.officeDashJs.OneNote.Interfaces.PageContentData
import typingsSlinky.officeDashJs.OneNote.Interfaces.PageContentLoadOptions
import typingsSlinky.officeDashJs.OneNote.Interfaces.PageContentUpdateData
...
class PageContent () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typingsSlinky.officeDashJs.officeDashJsStrings.Outline | typingsSlinky.officeDashJs.officeDashJsStrings.Image | Ink | Other = js.native
  /**
    *
