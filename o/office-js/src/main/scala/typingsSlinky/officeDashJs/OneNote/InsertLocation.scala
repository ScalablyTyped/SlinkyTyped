...
object InsertLocation extends js.Object {
  ...
  /* "After" */ val after: typingsSlinky.officeDashJs.OneNote.InsertLocation.after with String = js.native
  /* "Before" */ val before: typingsSlinky.officeDashJs.OneNote.InsertLocation.before with String = js.native
  @JSBracketAccess
