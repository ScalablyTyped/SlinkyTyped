...
import typingsSlinky.officeDashJs.OneNote.Interfaces.SectionCollectionData
import typingsSlinky.officeDashJs.OneNote.Interfaces.SectionCollectionLoadOptions
