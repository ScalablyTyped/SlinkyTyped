...
import typingsSlinky.officeDashJs.OneNote.Interfaces.InkAnalysisData
import typingsSlinky.officeDashJs.OneNote.Interfaces.InkAnalysisLoadOptions
import typingsSlinky.officeDashJs.OneNote.Interfaces.InkAnalysisUpdateData
