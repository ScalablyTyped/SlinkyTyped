...
import typingsSlinky.officeDashJs.OneNote.PageContentType
...
trait PageContentData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    PageContentType | typingsSlinky.officeDashJs.officeDashJsStrings.Outline | typingsSlinky.officeDashJs.officeDashJsStrings.Image | Ink | Other
  ] = js.undefined
}
...
object PageContentData {
  ...
  def apply(
    ...
    top: Int | Double = null,
    `type`: PageContentType | typingsSlinky.officeDashJs.officeDashJsStrings.Outline | typingsSlinky.officeDashJs.officeDashJsStrings.Image | Ink | Other = null
  ): PageContentData = {
