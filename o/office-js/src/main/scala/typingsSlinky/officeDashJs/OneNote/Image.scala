...
import typingsSlinky.officeDashJs.OneNote.Interfaces.ImageData
import typingsSlinky.officeDashJs.OneNote.Interfaces.ImageLoadOptions
import typingsSlinky.officeDashJs.OneNote.Interfaces.ImageUpdateData
