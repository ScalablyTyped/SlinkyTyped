...
import typingsSlinky.officeDashJs.OneNote.Interfaces.TableCellCollectionData
import typingsSlinky.officeDashJs.OneNote.Interfaces.TableCellCollectionLoadOptions
