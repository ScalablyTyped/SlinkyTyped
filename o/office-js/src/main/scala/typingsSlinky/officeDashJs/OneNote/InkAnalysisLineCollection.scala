...
import typingsSlinky.officeDashJs.OneNote.Interfaces.CollectionLoadOptions
import typingsSlinky.officeDashJs.OneNote.Interfaces.InkAnalysisLineCollectionData
import typingsSlinky.officeDashJs.OneNote.Interfaces.InkAnalysisLineCollectionLoadOptions
