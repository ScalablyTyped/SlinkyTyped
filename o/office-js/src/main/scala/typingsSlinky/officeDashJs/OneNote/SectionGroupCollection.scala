...
import typingsSlinky.officeDashJs.OneNote.Interfaces.SectionGroupCollectionData
import typingsSlinky.officeDashJs.OneNote.Interfaces.SectionGroupCollectionLoadOptions
