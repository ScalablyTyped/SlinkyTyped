...
import typingsSlinky.officeDashJs.OneNote.Interfaces.TableData
import typingsSlinky.officeDashJs.OneNote.Interfaces.TableLoadOptions
import typingsSlinky.officeDashJs.OneNote.Interfaces.TableUpdateData
