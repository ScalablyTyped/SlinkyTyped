...
object ListType extends js.Object {
  ...
  /* "Bullet" */ val bullet: typingsSlinky.officeDashJs.OneNote.ListType.bullet with String = js.native
  /* "None" */ val none: typingsSlinky.officeDashJs.OneNote.ListType.none with String = js.native
  /* "Number" */ val number: typingsSlinky.officeDashJs.OneNote.ListType.number with String = js.native
  @JSBracketAccess
