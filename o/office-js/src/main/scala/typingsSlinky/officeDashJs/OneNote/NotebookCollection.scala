...
import typingsSlinky.officeDashJs.OneNote.Interfaces.NotebookCollectionData
import typingsSlinky.officeDashJs.OneNote.Interfaces.NotebookCollectionLoadOptions
