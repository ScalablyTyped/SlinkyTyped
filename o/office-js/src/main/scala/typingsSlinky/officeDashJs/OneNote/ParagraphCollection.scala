...
import typingsSlinky.officeDashJs.OneNote.Interfaces.ParagraphCollectionData
import typingsSlinky.officeDashJs.OneNote.Interfaces.ParagraphCollectionLoadOptions
