...
import typingsSlinky.officeJs.Office.MailboxEnums.Days
import typingsSlinky.officeJs.Office.MailboxEnums.Month
import typingsSlinky.officeJs.Office.MailboxEnums.WeekNumber
