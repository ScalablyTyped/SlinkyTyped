...
import typingsSlinky.officeJs.Office.MailboxEnums.OWAView
import typingsSlinky.officeJs.officeJsStrings.OneColumn
import typingsSlinky.officeJs.officeJsStrings.ThreeColumns
import typingsSlinky.officeJs.officeJsStrings.TwoColumns
...
trait Diagnostics extends js.Object {
  /**
    ...
    * **{@link https://docs.microsoft.com/office/dev/add-ins/outlook/outlook-add-ins-overview#extension-points | Applicable Outlook mode}**: Compose or Read
    */
  var OWAView: typingsSlinky.officeJs.Office.MailboxEnums.OWAView | OneColumn | TwoColumns | ThreeColumns = js.native
  /**
