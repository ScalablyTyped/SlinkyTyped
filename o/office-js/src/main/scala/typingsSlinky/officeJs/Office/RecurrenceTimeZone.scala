...
trait RecurrenceTimeZone extends js.Object {
  /**
    ...
    */
  var name: typingsSlinky.officeJs.Office.MailboxEnums.RecurrenceTimeZone | String
  /**
...
object RecurrenceTimeZone {
  @scala.inline
  def apply(name: typingsSlinky.officeJs.Office.MailboxEnums.RecurrenceTimeZone | String, offset: Double): RecurrenceTimeZone = {
