...
import typingsSlinky.officeJs.officeJsStrings.olkEnhancedLocationsChanged
...
object EnhancedLocationsChangedEventArgs {
  ...
  implicit class EnhancedLocationsChangedEventArgsOps[Self <: EnhancedLocationsChangedEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnhancedLocations(value: js.Array[LocationDetails]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enhancedLocations")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: olkEnhancedLocationsChanged): Self = {
        val ret = this.duplicate
