...
object UpdateOptions {
  ...
  implicit class UpdateOptionsOps[Self <: UpdateOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withThrowOnReadOnly(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("throwOnReadOnly")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutThrowOnReadOnly: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("throwOnReadOnly")(js.undefined)
        ret
    }
  }
