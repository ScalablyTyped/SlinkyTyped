...
package object OneNote {
  ...
  /**
    ...
    */
  @scala.inline
  def run[T](batch: js.Function1[/* context */ typingsSlinky.officeJs.OneNote.RequestContext, js.Promise[T]]): js.Promise[T] = typingsSlinky.officeJs.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
  /**
  ...
  ): js.Promise[T] = (typingsSlinky.officeJs.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(objects.asInstanceOf[js.Any], batch.asInstanceOf[js.Any])).asInstanceOf[js.Promise[T]]
  /**
  ...
  def run[T](
    ...
    batch: js.Function1[/* context */ typingsSlinky.officeJs.OneNote.RequestContext, js.Promise[T]]
  ): js.Promise[T] = (typingsSlinky.officeJs.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(`object`.asInstanceOf[js.Any], batch.asInstanceOf[js.Any])).asInstanceOf[js.Promise[T]]
}
