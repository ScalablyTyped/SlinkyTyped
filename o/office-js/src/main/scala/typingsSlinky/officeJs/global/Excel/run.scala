...
import typingsSlinky.officeJs.Excel.RunOptions
...
object run extends js.Object {
  /**
    ...
    */
  def apply[T](batch: js.Function1[/* context */ typingsSlinky.officeJs.Excel.RequestContext, js.Promise[T]]): js.Promise[T] = js.native
  /**
