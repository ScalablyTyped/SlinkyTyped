...
object EventType extends js.Object {
  ...
  /* 7 */ val DocumentSelectionChanged: typingsSlinky.officeJs.Office.EventType.DocumentSelectionChanged with Double = js.native
  /* 8 */ val EnhancedLocationsChanged: typingsSlinky.officeJs.Office.EventType.EnhancedLocationsChanged with Double = js.native
  /* 9 */ val ItemChanged: typingsSlinky.officeJs.Office.EventType.ItemChanged with Double = js.native
  /* 10 */ val NodeDeleted: typingsSlinky.officeJs.Office.EventType.NodeDeleted with Double = js.native
  /* 11 */ val NodeInserted: typingsSlinky.officeJs.Office.EventType.NodeInserted with Double = js.native
  /* 12 */ val NodeReplaced: typingsSlinky.officeJs.Office.EventType.NodeReplaced with Double = js.native
  /* 13 */ val RecipientsChanged: typingsSlinky.officeJs.Office.EventType.RecipientsChanged with Double = js.native
  /* 14 */ val RecurrenceChanged: typingsSlinky.officeJs.Office.EventType.RecurrenceChanged with Double = js.native
  /* 15 */ val ResourceSelectionChanged: typingsSlinky.officeJs.Office.EventType.ResourceSelectionChanged with Double = js.native
  /* 16 */ val SettingsChanged: typingsSlinky.officeJs.Office.EventType.SettingsChanged with Double = js.native
  /* 17 */ val TaskSelectionChanged: typingsSlinky.officeJs.Office.EventType.TaskSelectionChanged with Double = js.native
  /* 18 */ val ViewSelectionChanged: typingsSlinky.officeJs.Office.EventType.ViewSelectionChanged with Double = js.native
  @JSBracketAccess
