...
import typingsSlinky.officeJs.Office.IPromiseConstructor
import typingsSlinky.officeJs.OfficeExtension.DebugInfo
import typingsSlinky.officeJs.OfficeExtension.EmbeddedOptions
import typingsSlinky.officeJs.OfficeExtension.EventInfo
...
object OfficeExtension extends js.Object {
  ...
  @js.native
  class ClientObject ()
    extends typingsSlinky.officeJs.OfficeExtension.ClientObject {
    /** The request context associated with the object */
    /* CompleteClass */
    override var context: typingsSlinky.officeJs.OfficeExtension.ClientRequestContext = js.native
    /**
  ...
  class ClientRequestContext ()
    extends typingsSlinky.officeJs.OfficeExtension.ClientRequestContext {
  ...
  class ClientResult[T] ()
    extends typingsSlinky.officeJs.OfficeExtension.ClientResult[T] {
  ...
  class EmbeddedSession protected ()
    extends typingsSlinky.officeJs.OfficeExtension.EmbeddedSession {
    def this(url: String) = this()
  ...
  @js.native
  class Error ()
    extends typingsSlinky.officeJs.OfficeExtension.Error {
    ...
    /* CompleteClass */
    override var innerError: typingsSlinky.officeJs.OfficeExtension.Error = js.native
  ...
  @js.native
  class ErrorCodes ()
    extends typingsSlinky.officeJs.OfficeExtension.ErrorCodes
  
  @js.native
  class EventHandlerResult[T] protected ()
    extends typingsSlinky.officeJs.OfficeExtension.EventHandlerResult[T] {
    def this(
      context: typingsSlinky.officeJs.OfficeExtension.ClientRequestContext,
      handlers: typingsSlinky.officeJs.OfficeExtension.EventHandlers[T],
  ...
  class EventHandlers[T] protected ()
    extends typingsSlinky.officeJs.OfficeExtension.EventHandlers[T] {
    def this(
      context: typingsSlinky.officeJs.OfficeExtension.ClientRequestContext,
      parentObject: typingsSlinky.officeJs.OfficeExtension.ClientObject,
      name: String,
      eventInfo: EventInfo[T]
    ) = this()
    /* CompleteClass */
    override def add(handler: js.Function1[T, js.Promise[_]]): typingsSlinky.officeJs.OfficeExtension.EventHandlerResult[T] = js.native
    /* CompleteClass */
  ...
  class TrackedObjects ()
    extends typingsSlinky.officeJs.OfficeExtension.TrackedObjects
