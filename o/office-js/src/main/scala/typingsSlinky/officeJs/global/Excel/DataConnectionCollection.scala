...
class DataConnectionCollection ()
  extends typingsSlinky.officeJs.Excel.DataConnectionCollection {
  ...
  /* CompleteClass */
  @JSName("context")
  override var context_DataConnectionCollection: typingsSlinky.officeJs.Excel.RequestContext = js.native
  /**
