...
object run extends js.Object {
  ...
  /**
    ...
    */
  def apply[T](batch: js.Function1[/* context */ typingsSlinky.officeJs.OneNote.RequestContext, js.Promise[T]]): js.Promise[T] = js.native
  /**
  ...
  def apply[T](
    ...
    batch: js.Function1[/* context */ typingsSlinky.officeJs.OneNote.RequestContext, js.Promise[T]]
