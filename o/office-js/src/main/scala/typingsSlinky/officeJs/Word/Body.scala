...
import typingsSlinky.officeJs.officeJsStrings.End
import typingsSlinky.officeJs.officeJsStrings.Footer
import typingsSlinky.officeJs.officeJsStrings.Header
import typingsSlinky.officeJs.officeJsStrings.Line
import typingsSlinky.officeJs.officeJsStrings.MainDoc
import typingsSlinky.officeJs.officeJsStrings.Next
import typingsSlinky.officeJs.officeJsStrings.Page
import typingsSlinky.officeJs.officeJsStrings.Replace
import typingsSlinky.officeJs.officeJsStrings.SectionContinuous
import typingsSlinky.officeJs.officeJsStrings.SectionEven
import typingsSlinky.officeJs.officeJsStrings.SectionNext
import typingsSlinky.officeJs.officeJsStrings.SectionOdd
import typingsSlinky.officeJs.officeJsStrings.Select
import typingsSlinky.officeJs.officeJsStrings.Start
import typingsSlinky.officeJs.officeJsStrings.Unknown_
import typingsSlinky.officeJs.officeJsStrings.Whole
...
trait Body extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typingsSlinky.officeJs.officeJsStrings.Section | Header | Footer | typingsSlinky.officeJs.officeJsStrings.TableCell = js.native
  /**
    *
