...
import typingsSlinky.officeJs.Word.Interfaces.TableRowData
import typingsSlinky.officeJs.Word.Interfaces.TableRowLoadOptions
import typingsSlinky.officeJs.Word.Interfaces.TableRowUpdateData
