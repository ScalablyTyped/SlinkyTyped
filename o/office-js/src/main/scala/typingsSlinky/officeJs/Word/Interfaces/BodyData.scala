...
import typingsSlinky.officeJs.Word.BodyType
...
import typingsSlinky.officeJs.officeJsStrings.Section
import typingsSlinky.officeJs.officeJsStrings.TableCell
