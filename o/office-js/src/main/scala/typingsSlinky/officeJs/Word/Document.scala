...
import typingsSlinky.officeJs.Word.Interfaces.DocumentData
import typingsSlinky.officeJs.Word.Interfaces.DocumentLoadOptions
import typingsSlinky.officeJs.Word.Interfaces.DocumentUpdateData
