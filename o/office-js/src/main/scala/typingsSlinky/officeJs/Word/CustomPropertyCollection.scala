...
import typingsSlinky.officeJs.Word.Interfaces.CustomPropertyCollectionData
import typingsSlinky.officeJs.Word.Interfaces.CustomPropertyCollectionLoadOptions
