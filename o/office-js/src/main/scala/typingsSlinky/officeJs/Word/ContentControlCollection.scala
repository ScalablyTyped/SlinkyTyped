...
import typingsSlinky.officeJs.Word.Interfaces.ContentControlCollectionData
import typingsSlinky.officeJs.Word.Interfaces.ContentControlCollectionLoadOptions
