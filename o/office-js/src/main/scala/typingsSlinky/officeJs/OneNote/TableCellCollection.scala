...
import typingsSlinky.officeJs.OneNote.Interfaces.TableCellCollectionData
import typingsSlinky.officeJs.OneNote.Interfaces.TableCellCollectionLoadOptions
