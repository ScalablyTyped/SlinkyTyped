...
import typingsSlinky.officeJs.OneNote.Interfaces.ImageData
import typingsSlinky.officeJs.OneNote.Interfaces.ImageLoadOptions
import typingsSlinky.officeJs.OneNote.Interfaces.ImageUpdateData
