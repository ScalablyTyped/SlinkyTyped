...
import typingsSlinky.officeJs.OneNote.Interfaces.PageData
import typingsSlinky.officeJs.OneNote.Interfaces.PageLoadOptions
import typingsSlinky.officeJs.OneNote.Interfaces.PageUpdateData
