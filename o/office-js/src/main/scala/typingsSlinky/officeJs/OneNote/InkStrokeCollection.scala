...
import typingsSlinky.officeJs.OneNote.Interfaces.InkStrokeCollectionData
import typingsSlinky.officeJs.OneNote.Interfaces.InkStrokeCollectionLoadOptions
