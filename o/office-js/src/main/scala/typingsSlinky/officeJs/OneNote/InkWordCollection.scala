...
import typingsSlinky.officeJs.OneNote.Interfaces.InkWordCollectionData
import typingsSlinky.officeJs.OneNote.Interfaces.InkWordCollectionLoadOptions
...
/**
  ...
  */
@js.native
trait InkWordCollection extends ClientObject {
