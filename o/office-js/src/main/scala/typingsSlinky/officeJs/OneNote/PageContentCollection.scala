...
import typingsSlinky.officeJs.OneNote.Interfaces.PageContentCollectionData
import typingsSlinky.officeJs.OneNote.Interfaces.PageContentCollectionLoadOptions
