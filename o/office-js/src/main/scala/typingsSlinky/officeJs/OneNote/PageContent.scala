...
import typingsSlinky.officeJs.OneNote.Interfaces.PageContentData
import typingsSlinky.officeJs.OneNote.Interfaces.PageContentLoadOptions
import typingsSlinky.officeJs.OneNote.Interfaces.PageContentUpdateData
...
trait PageContent extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typingsSlinky.officeJs.officeJsStrings.Outline | typingsSlinky.officeJs.officeJsStrings.Image | Ink | Other = js.native
  /**
    *
