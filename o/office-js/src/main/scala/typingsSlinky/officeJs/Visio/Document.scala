...
import typingsSlinky.officeJs.Visio.Interfaces.DocumentData
import typingsSlinky.officeJs.Visio.Interfaces.DocumentLoadOptions
import typingsSlinky.officeJs.Visio.Interfaces.DocumentUpdateData
