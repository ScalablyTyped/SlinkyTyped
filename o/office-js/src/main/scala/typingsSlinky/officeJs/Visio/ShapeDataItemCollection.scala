...
import typingsSlinky.officeJs.Visio.Interfaces.ShapeDataItemCollectionData
import typingsSlinky.officeJs.Visio.Interfaces.ShapeDataItemCollectionLoadOptions
