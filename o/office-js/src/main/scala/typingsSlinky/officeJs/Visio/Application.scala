...
import typingsSlinky.officeJs.Visio.Interfaces.ApplicationData
import typingsSlinky.officeJs.Visio.Interfaces.ApplicationLoadOptions
import typingsSlinky.officeJs.Visio.Interfaces.ApplicationUpdateData
