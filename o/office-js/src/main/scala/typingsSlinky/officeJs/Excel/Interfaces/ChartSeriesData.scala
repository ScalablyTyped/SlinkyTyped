...
object ChartSeriesData {
  ...
  implicit class ChartSeriesDataOps[Self <: ChartSeriesData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBinOptions(value: ChartBinOptionsData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withBoxwhiskerOptions(value: ChartBoxwhiskerOptionsData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDataLabels(value: ChartDataLabelsData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFormat(value: ChartSeriesFormatData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMapOptions(value: ChartMapOptionsData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoints(value: js.Array[ChartPointData]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTrendlines(value: js.Array[ChartTrendlineData]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withXErrorBars(value: ChartErrorBarsData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withYErrorBars(value: ChartErrorBarsData): Self = {
        val ret = this.duplicate
