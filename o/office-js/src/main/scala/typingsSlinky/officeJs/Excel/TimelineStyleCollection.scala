...
import typingsSlinky.officeJs.Excel.Interfaces.TimelineStyleCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.TimelineStyleCollectionLoadOptions
