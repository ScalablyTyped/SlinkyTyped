...
object ChartData {
  ...
  implicit class ChartDataOps[Self <: ChartData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAxes(value: ChartAxesData): Self = {
    ...
    @scala.inline
    def withFormat(value: ChartAreaFormatData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLegend(value: ChartLegendData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPivotOptions(value: ChartPivotOptionsData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPlotArea(value: ChartPlotAreaData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSeries(value: js.Array[ChartSeriesData]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitle(value: ChartTitleData): Self = {
        val ret = this.duplicate
