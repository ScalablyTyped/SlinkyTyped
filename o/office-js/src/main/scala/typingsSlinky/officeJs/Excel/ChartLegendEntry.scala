...
import typingsSlinky.officeJs.Excel.Interfaces.ChartLegendEntryData
import typingsSlinky.officeJs.Excel.Interfaces.ChartLegendEntryLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.ChartLegendEntryUpdateData
