...
import typingsSlinky.officeJs.Excel.Interfaces.StyleData
import typingsSlinky.officeJs.Excel.Interfaces.StyleLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.StyleUpdateData
