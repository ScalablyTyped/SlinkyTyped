...
import typingsSlinky.officeJs.Excel.Interfaces.CustomPropertyCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.CustomPropertyCollectionLoadOptions
