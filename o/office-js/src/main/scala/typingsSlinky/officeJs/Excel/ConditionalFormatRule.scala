...
import typingsSlinky.officeJs.Excel.Interfaces.ConditionalFormatRuleData
import typingsSlinky.officeJs.Excel.Interfaces.ConditionalFormatRuleLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.ConditionalFormatRuleUpdateData
