...
import typingsSlinky.officeJs.Excel.Interfaces.TableStyleData
import typingsSlinky.officeJs.Excel.Interfaces.TableStyleLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.TableStyleUpdateData
