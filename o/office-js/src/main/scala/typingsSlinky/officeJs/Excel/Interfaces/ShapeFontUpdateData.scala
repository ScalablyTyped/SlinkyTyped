...
object ShapeFontUpdateData {
  ...
  def apply(
    ...
    underline: ShapeFontUnderlineStyle | None | Single | typingsSlinky.officeJs.officeJsStrings.Double | Heavy | Dotted | DottedHeavy | Dash | DashHeavy | DashLong | DashLongHeavy | DotDash | DotDashHeavy | DotDotDash | DotDotDashHeavy | Wavy | WavyHeavy | WavyDouble = null
  ): ShapeFontUpdateData = {
