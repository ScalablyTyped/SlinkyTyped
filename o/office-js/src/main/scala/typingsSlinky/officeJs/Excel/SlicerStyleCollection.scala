...
import typingsSlinky.officeJs.Excel.Interfaces.SlicerStyleCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.SlicerStyleCollectionLoadOptions
