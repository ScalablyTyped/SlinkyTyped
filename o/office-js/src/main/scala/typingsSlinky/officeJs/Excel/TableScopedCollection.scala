...
import typingsSlinky.officeJs.Excel.Interfaces.TableScopedCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.TableScopedCollectionLoadOptions
