...
import typingsSlinky.officeJs.Excel.Interfaces.PivotTableStyleCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.PivotTableStyleCollectionLoadOptions
