...
import typingsSlinky.officeJs.Excel.Interfaces.SettingData
import typingsSlinky.officeJs.Excel.Interfaces.SettingLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.SettingUpdateData
