...
object StyleCollectionData {
  ...
  @scala.inline
  implicit class StyleCollectionDataOps[Self <: StyleCollectionData] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: StyleData*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[StyleData]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
