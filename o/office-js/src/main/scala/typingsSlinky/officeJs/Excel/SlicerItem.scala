...
import typingsSlinky.officeJs.Excel.Interfaces.SlicerItemData
import typingsSlinky.officeJs.Excel.Interfaces.SlicerItemLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.SlicerItemUpdateData
