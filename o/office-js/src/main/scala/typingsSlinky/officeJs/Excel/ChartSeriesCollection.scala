...
import typingsSlinky.officeJs.Excel.Interfaces.ChartSeriesCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.ChartSeriesCollectionLoadOptions
