...
import typingsSlinky.officeJs.Excel.Interfaces.CustomConditionalFormatData
import typingsSlinky.officeJs.Excel.Interfaces.CustomConditionalFormatLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.CustomConditionalFormatUpdateData
