...
import typingsSlinky.officeJs.Excel.Interfaces.TextFrameData
import typingsSlinky.officeJs.Excel.Interfaces.TextFrameLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.TextFrameUpdateData
