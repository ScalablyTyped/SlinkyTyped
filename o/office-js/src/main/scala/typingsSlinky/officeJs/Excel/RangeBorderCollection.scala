...
import typingsSlinky.officeJs.Excel.Interfaces.RangeBorderCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.RangeBorderCollectionLoadOptions
