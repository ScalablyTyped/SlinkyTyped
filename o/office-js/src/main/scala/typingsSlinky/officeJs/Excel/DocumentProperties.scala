...
import typingsSlinky.officeJs.Excel.Interfaces.DocumentPropertiesData
import typingsSlinky.officeJs.Excel.Interfaces.DocumentPropertiesLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.DocumentPropertiesUpdateData
