...
import typingsSlinky.officeJs.Excel.Interfaces.FilterPivotHierarchyCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.FilterPivotHierarchyCollectionLoadOptions
