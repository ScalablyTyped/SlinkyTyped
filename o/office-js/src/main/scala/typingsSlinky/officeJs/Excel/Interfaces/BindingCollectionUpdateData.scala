...
object BindingCollectionUpdateData {
  ...
  implicit class BindingCollectionUpdateDataOps[Self <: BindingCollectionUpdateData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: BindingData*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[BindingData]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
