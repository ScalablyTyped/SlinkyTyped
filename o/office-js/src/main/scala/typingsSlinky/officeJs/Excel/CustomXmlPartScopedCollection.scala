...
import typingsSlinky.officeJs.Excel.Interfaces.CustomXmlPartScopedCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.CustomXmlPartScopedCollectionLoadOptions
