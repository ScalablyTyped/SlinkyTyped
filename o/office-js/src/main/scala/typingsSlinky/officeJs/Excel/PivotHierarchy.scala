...
import typingsSlinky.officeJs.Excel.Interfaces.PivotHierarchyData
import typingsSlinky.officeJs.Excel.Interfaces.PivotHierarchyLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.PivotHierarchyUpdateData
