...
object DateTimeDataValidation {
  ...
  implicit class DateTimeDataValidationOps[Self <: DateTimeDataValidation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormula1Date(value: js.Date): Self = this.set("formula1", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFormula1(value: String | js.Date | Range): Self = this.set("formula1", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormula2Date(value: js.Date): Self = this.set("formula2", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFormula2(value: String | js.Date | Range): Self = this.set("formula2", value.asInstanceOf[js.Any])
