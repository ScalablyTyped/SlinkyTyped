...
import typingsSlinky.officeJs.Excel.Interfaces.ShapeFillData
import typingsSlinky.officeJs.Excel.Interfaces.ShapeFillLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.ShapeFillUpdateData
