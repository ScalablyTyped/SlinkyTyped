...
import typingsSlinky.officeJs.Excel.Interfaces.WorksheetCustomPropertyData
import typingsSlinky.officeJs.Excel.Interfaces.WorksheetCustomPropertyLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.WorksheetCustomPropertyUpdateData
