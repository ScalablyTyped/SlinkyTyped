...
import typingsSlinky.officeJs.Excel.Interfaces.TableColumnCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.TableColumnCollectionLoadOptions
