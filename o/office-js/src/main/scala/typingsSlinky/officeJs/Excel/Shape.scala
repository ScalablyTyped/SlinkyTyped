...
import typingsSlinky.officeJs.officeJsStrings.BringToFront
import typingsSlinky.officeJs.officeJsStrings.CurrentSize
import typingsSlinky.officeJs.officeJsStrings.GIF
import typingsSlinky.officeJs.officeJsStrings.Group
import typingsSlinky.officeJs.officeJsStrings.JPEG
import typingsSlinky.officeJs.officeJsStrings.OneCell
import typingsSlinky.officeJs.officeJsStrings.OriginalSize
import typingsSlinky.officeJs.officeJsStrings.PNG
import typingsSlinky.officeJs.officeJsStrings.SVG
import typingsSlinky.officeJs.officeJsStrings.ScaleFromBottomRight
import typingsSlinky.officeJs.officeJsStrings.ScaleFromMiddle
import typingsSlinky.officeJs.officeJsStrings.ScaleFromTopLeft
import typingsSlinky.officeJs.officeJsStrings.SendBackward
import typingsSlinky.officeJs.officeJsStrings.SendToBack
import typingsSlinky.officeJs.officeJsStrings.TwoCell
import typingsSlinky.officeJs.officeJsStrings.UNKNOWN
import typingsSlinky.officeJs.officeJsStrings.Unsupported
...
class Shape () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  val `type`: ShapeType | Unsupported | typingsSlinky.officeJs.officeJsStrings.Image | typingsSlinky.officeJs.officeJsStrings.GeometricShape | Group | typingsSlinky.officeJs.officeJsStrings.Line = js.native
  /**
    *
