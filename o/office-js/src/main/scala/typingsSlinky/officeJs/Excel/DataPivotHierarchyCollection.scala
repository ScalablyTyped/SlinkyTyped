...
import typingsSlinky.officeJs.Excel.Interfaces.DataPivotHierarchyCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.DataPivotHierarchyCollectionLoadOptions
