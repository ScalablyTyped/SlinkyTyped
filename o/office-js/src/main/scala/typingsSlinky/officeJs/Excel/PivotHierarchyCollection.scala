...
import typingsSlinky.officeJs.Excel.Interfaces.PivotHierarchyCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.PivotHierarchyCollectionLoadOptions
