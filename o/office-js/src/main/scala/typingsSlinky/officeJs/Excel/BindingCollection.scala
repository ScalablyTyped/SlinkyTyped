...
import typingsSlinky.officeJs.Excel.Interfaces.BindingCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.BindingCollectionLoadOptions
...
trait BindingCollection extends ClientObject {
  ...
  def addFromNamedItem_Range(name: String, bindingType: typingsSlinky.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  def addFromNamedItem_Table(name: String, bindingType: typingsSlinky.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  ...
  def addFromSelection_Range(bindingType: typingsSlinky.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Table(bindingType: typingsSlinky.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Text(bindingType: Text, id: String): Binding = js.native
  
  @JSName("add")
  def add_Range(range: String, bindingType: typingsSlinky.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  /**
    * Add a new binding to a particular Range.
    *
    * [Api set: ExcelApi 1.3]
    ...
    */
  @JSName("add")
  def add_Range(range: Range, bindingType: typingsSlinky.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: String, bindingType: typingsSlinky.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: Range, bindingType: typingsSlinky.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("add")
