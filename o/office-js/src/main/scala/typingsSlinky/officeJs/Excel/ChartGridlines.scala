...
import typingsSlinky.officeJs.Excel.Interfaces.ChartGridlinesData
import typingsSlinky.officeJs.Excel.Interfaces.ChartGridlinesLoadOptions
import typingsSlinky.officeJs.Excel.Interfaces.ChartGridlinesUpdateData
