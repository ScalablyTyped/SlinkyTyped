...
import typingsSlinky.officeJs.Excel.Interfaces.CustomXmlPartCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.CustomXmlPartCollectionLoadOptions
