...
import typingsSlinky.officeJs.Excel.Interfaces.ConditionalFormatCollectionData
import typingsSlinky.officeJs.Excel.Interfaces.ConditionalFormatCollectionLoadOptions
...
trait ConditionalFormatCollection extends ClientObject {
  ...
  @JSName("add")
  def add_IconSet(`type`: typingsSlinky.officeJs.officeJsStrings.IconSet): ConditionalFormat = js.native
  @JSName("add")
