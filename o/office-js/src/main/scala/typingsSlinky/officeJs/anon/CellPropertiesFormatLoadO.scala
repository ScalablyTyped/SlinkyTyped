package typingsSlinky.officeJs.anon

import typingsSlinky.officeJs.Excel.CellPropertiesBorderLoadOptions
import typingsSlinky.officeJs.Excel.CellPropertiesFillLoadOptions
import typingsSlinky.officeJs.Excel.CellPropertiesFontLoadOptions
