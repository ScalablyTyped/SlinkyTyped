...
object OpenAPIFrameworkArgs {
  ...
  implicit class OpenAPIFrameworkArgsOps[Self <: OpenAPIFrameworkArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiDoc(value: Document | typingsSlinky.openapiTypes.mod.OpenAPIV3.Document | String): Self = this.set("apiDoc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPathsIgnore(value: js.RegExp): Self = this.set("pathsIgnore", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRoutesIndexFileRegExp(value: js.RegExp): Self = this.set("routesIndexFileRegExp", value.asInstanceOf[js.Any])
