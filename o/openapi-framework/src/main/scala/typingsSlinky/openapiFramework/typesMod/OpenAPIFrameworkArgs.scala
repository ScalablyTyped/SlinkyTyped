...
trait OpenAPIFrameworkArgs extends js.Object {
  var apiDoc: Document | typingsSlinky.openapiTypes.mod.OpenAPIV3.Document | String
  ...
  var externalSchemas: js.UndefOr[typingsSlinky.openapiFramework.anon.String] = js.undefined
...
object OpenAPIFrameworkArgs {
  ...
  def apply(
    ...
    externalSchemas: typingsSlinky.openapiFramework.anon.String = null,
    logger: Logger = null,
