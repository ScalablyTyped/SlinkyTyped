...
object mod {
  ...
  class BasePath protected ()
    extends typingsSlinky.openapiFramework.basePathMod.default {
  ...
  object OpenAPIFramework {
    ...
    implicit class OpenAPIFrameworkMutableBuilder[Self <: OpenAPIFramework] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBasePaths(value: js.Array[typingsSlinky.openapiFramework.basePathMod.default]): Self = StObject.set(x, "basePaths", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBasePathsVarargs(value: typingsSlinky.openapiFramework.basePathMod.default*): Self = StObject.set(x, "basePaths", js.Array(value :_*))
