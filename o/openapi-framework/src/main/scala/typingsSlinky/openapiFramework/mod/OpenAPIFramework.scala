...
object OpenAPIFramework {
  ...
  implicit class OpenAPIFrameworkOps[Self <: OpenAPIFramework] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBasePathsVarargs(value: typingsSlinky.openapiFramework.basePathMod.default*): Self = this.set("basePaths", js.Array(value :_*))
    
    @scala.inline
    def setBasePaths(value: js.Array[typingsSlinky.openapiFramework.basePathMod.default]): Self = this.set("basePaths", value.asInstanceOf[js.Any])
