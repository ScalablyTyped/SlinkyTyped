package typingsSlinky.openapiDashFramework.openapiDashFrameworkMod

import typingsSlinky.openapiDashFramework.distSrcTypesMod.IOpenAPIFramework
import typingsSlinky.openapiDashFramework.distSrcTypesMod.OpenAPIFrameworkConstructorArgs
import typingsSlinky.openapiDashFramework.distSrcTypesMod.OpenAPIFrameworkVisitor
...
trait OpenAPIFramework extends IOpenAPIFramework {
  ...
  val basePaths: js.Array[typingsSlinky.openapiDashFramework.distSrcBasePathMod.default]
...
object OpenAPIFramework {
  ...
  def apply(
    ...
    basePaths: js.Array[typingsSlinky.openapiDashFramework.distSrcBasePathMod.default],
