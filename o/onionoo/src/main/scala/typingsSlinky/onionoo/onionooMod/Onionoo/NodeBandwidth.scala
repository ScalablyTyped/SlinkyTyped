...
import typingsSlinky.onionoo.onionooStrings.`1_month`
import typingsSlinky.onionoo.onionooStrings.`1_week`
import typingsSlinky.onionoo.onionooStrings.`1_year`
import typingsSlinky.onionoo.onionooStrings.`3_days`
import typingsSlinky.onionoo.onionooStrings.`5_years`
import typingsSlinky.onionoo.onionooStrings.`6_months`
