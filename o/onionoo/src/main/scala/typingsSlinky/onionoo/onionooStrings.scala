...
object onionooStrings {
  @js.native
  sealed trait `1_month` extends js.Object
  
  @js.native
  sealed trait `1_week` extends js.Object
  
  @js.native
  sealed trait `1_year` extends js.Object
  
  @js.native
  sealed trait `3_days` extends js.Object
  
  @js.native
  sealed trait `5_years` extends js.Object
  
  @js.native
  sealed trait `6_months` extends js.Object
