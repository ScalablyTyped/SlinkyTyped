...
import typingsSlinky.openfin.openfinStrings.`layout-initialized`
import typingsSlinky.openfin.openfinStrings.`layout-ready`
...
/* key */ StringDictionary[js.Any] {
  var `auth-requested`: WindowAuthRequestedEvent[window, typingsSlinky.openfin.openfinStrings.`auth-requested`]
  var `begin-user-bounds-changing`: WindowBeginBoundsChangingEvent[window, typingsSlinky.openfin.openfinStrings.`begin-user-bounds-changing`]
  var blurred: WindowEvent[window, typingsSlinky.openfin.openfinStrings.blurred]
  var `bounds-changed`: WindowBoundsChange[window, typingsSlinky.openfin.openfinStrings.`bounds-changed`]
  var `bounds-changing`: WindowBoundsChange[window, typingsSlinky.openfin.openfinStrings.`bounds-changing`]
  var `certificate-error`: CertificateErrorEvent[String, String]
  var `close-requested`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`close-requested`]
  var closed: WindowEvent[window, typingsSlinky.openfin.openfinStrings.closed]
  var closing: WindowEvent[window, typingsSlinky.openfin.openfinStrings.closing]
  var crashed: CrashedEvent with (WindowEvent[String, String])
  var `did-change-theme-color`: WindowEvent[String, String]
  var `disabled-movement-bounds-changed`: WindowBoundsChange[window, typingsSlinky.openfin.openfinStrings.`disabled-movement-bounds-changed`]
  var `disabled-movement-bounds-changing`: WindowBoundsChange[window, typingsSlinky.openfin.openfinStrings.`disabled-movement-bounds-changing`]
  var embedded: WindowEvent[window, typingsSlinky.openfin.openfinStrings.embedded]
  var `end-user-bounds-changing`: WindowEndBoundsChangingEvent[window, typingsSlinky.openfin.openfinStrings.`end-user-bounds-changing`]
  var `external-process-exited`: WindowExternalProcessExitedEvent[window, typingsSlinky.openfin.openfinStrings.`external-process-exited`]
  var `external-process-started`: WindowExternalProcessStartedEvent[window, typingsSlinky.openfin.openfinStrings.`external-process-started`]
  var focused: WindowEvent[window, typingsSlinky.openfin.openfinStrings.focused]
  var `found-in-page`: WindowEvent[String, String]
  var `group-changed`: WindowGroupChanged[window, typingsSlinky.openfin.openfinStrings.`group-changed`]
  var hidden: WindowHiddenEvent[window, typingsSlinky.openfin.openfinStrings.hidden]
  var hotkey: InputEvent with (WindowEvent[window, typingsSlinky.openfin.openfinStrings.hotkey])
  var initialized: WindowEvent[window, typingsSlinky.openfin.openfinStrings.initialized]
  var `layout-initialized`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`layout-initialized`]
  var `layout-ready`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`layout-ready`]
  var listenerRemoved: String
  var maximized: WindowEvent[window, typingsSlinky.openfin.openfinStrings.maximized]
  var minimized: WindowEvent[window, typingsSlinky.openfin.openfinStrings.minimized]
  var `navigation-rejected`: WindowNavigationRejectedEvent[String, String]
  var newListener: String
  var `options-changed`: WindowOptionsChangedEvent[window, typingsSlinky.openfin.openfinStrings.`options-changed`]
  var `page-favicon-updated`: WindowEvent[String, String]
  var `page-title-updated`: PageTitleUpdatedEvent[String, String]
  var `performance-report`: WindowPerformanceReport[window, typingsSlinky.openfin.openfinStrings.`performance-report`]
  var `preload-scripts-state-changed`: WindowPreloadScriptsStateChangeEvent[window, typingsSlinky.openfin.openfinStrings.`preload-scripts-state-changed`]
  var `preload-scripts-state-changing`: WindowPreloadScriptsStateChangeEvent[window, typingsSlinky.openfin.openfinStrings.`preload-scripts-state-changing`]
  var reloaded: WindowReloadedEvent[window, typingsSlinky.openfin.openfinStrings.reloaded]
  ...
  var restored: WindowEvent[window, typingsSlinky.openfin.openfinStrings.restored]
  var `show-requested`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`show-requested`]
  var shown: WindowEvent[window, typingsSlinky.openfin.openfinStrings.shown]
  var `user-movement-disabled`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`user-movement-disabled`]
  var `user-movement-enabled`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`user-movement-enabled`]
  var `view-attached`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`view-attached`]
  ...
  var `view-detached`: ViewDetached[window, typingsSlinky.openfin.openfinStrings.`view-detached`]
  ...
  var `will-move`: WillMoveOrResize[window, typingsSlinky.openfin.openfinStrings.`will-move`]
  var `will-resize`: WillMoveOrResize[window, typingsSlinky.openfin.openfinStrings.`will-resize`]
}
