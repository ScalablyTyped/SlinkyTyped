...
/* key */ StringDictionary[js.Any] {
  ...
  var hotkey: InputEvent with (WindowEvent[window, typingsSlinky.openfin.openfinStrings.hotkey]) = js.native
  
  var initialized: WindowEvent[window, typingsSlinky.openfin.openfinStrings.initialized] = js.native
  
  var `layout-initialized`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`layout-initialized`] = js.native
  
  var `layout-ready`: WindowEvent[window, typingsSlinky.openfin.openfinStrings.`layout-ready`] = js.native
  ...
  var `view-detached`: ViewDetached[window, typingsSlinky.openfin.openfinStrings.`view-detached`] = js.native
