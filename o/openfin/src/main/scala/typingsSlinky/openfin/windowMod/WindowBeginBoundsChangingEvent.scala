...
object WindowBeginBoundsChangingEvent {
  ...
  @scala.inline
  implicit class WindowBeginBoundsChangingEventOps[Self[topic, `type`] <: WindowBeginBoundsChangingEvent[topic, `type`], Topic, Type] (val x: Self[Topic, Type]) extends AnyVal {
    @scala.inline
