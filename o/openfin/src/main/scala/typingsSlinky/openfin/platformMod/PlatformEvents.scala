...
trait PlatformEvents extends js.Object {
  ...
  var `platform-api-ready`: ApplicationEvent[application, typingsSlinky.openfin.openfinStrings.`platform-api-ready`]
  var `platform-snapshot-applied`: ApplicationEvent[application, typingsSlinky.openfin.openfinStrings.`platform-snapshot-applied`]
  ...
  var `window-performance-report`: (WindowPerformanceReport[application, typingsSlinky.openfin.openfinStrings.`window-performance-report`]) with (WindowPerformanceReport[String, String])
