...
trait PropagatedPlatformEvents[Topic] extends js.Object {
  ...
  var `platform-api-ready`: ApplicationEvent[Topic, typingsSlinky.openfin.openfinStrings.`platform-api-ready`]
  var `platform-snapshot-applied`: ApplicationEvent[Topic, typingsSlinky.openfin.openfinStrings.`platform-snapshot-applied`]
