...
trait BrowserWindow extends js.Object {
  ...
  /**
    ...
    */
  def getGlInstance(): typingsSlinky.openfin.GoldenLayout.GoldenLayout = js.native
  /**
...
object BrowserWindow {
  ...
  implicit class BrowserWindowOps[Self <: BrowserWindow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetGlInstance(value: () => typingsSlinky.openfin.GoldenLayout.GoldenLayout): Self = this.set("getGlInstance", js.Any.fromFunction0(value))
    @scala.inline
