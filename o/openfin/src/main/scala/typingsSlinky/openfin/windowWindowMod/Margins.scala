...
trait Margins extends js.Object {
  ...
  var marginType: js.UndefOr[typingsSlinky.openfin.openfinStrings.default | none | printableArea | custom] = js.undefined
...
object Margins {
  ...
  def apply(
    ...
    marginType: typingsSlinky.openfin.openfinStrings.default | none | printableArea | custom = null,
