...
import typingsSlinky.openfin.openfinStrings.app
import typingsSlinky.openfin.openfinStrings.default
...
object contextChannelsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.openfin.contextChannelsMod.DefaultChannel_
    - typingsSlinky.openfin.contextChannelsMod.SystemChannel
    - typingsSlinky.openfin.contextChannelsMod.AppChannel
  */
  ...
  - typingsSlinky.openfin.mainMod.Listener because Already inherited */ @js.native
