...
object wireMod {
  ...
  object READY_STATE extends StObject {
    ...
    /* 3 */ val CLOSED: typingsSlinky.openfin.wireMod.READY_STATE.CLOSED with Double = js.native
    
    @js.native
    sealed trait CLOSING extends READY_STATE
    /* 2 */ val CLOSING: typingsSlinky.openfin.wireMod.READY_STATE.CLOSING with Double = js.native
    
    @js.native
    sealed trait CONNECTING extends READY_STATE
    /* 0 */ val CONNECTING: typingsSlinky.openfin.wireMod.READY_STATE.CONNECTING with Double = js.native
    
    @js.native
    sealed trait OPEN extends READY_STATE
    /* 1 */ val OPEN: typingsSlinky.openfin.wireMod.READY_STATE.OPEN with Double = js.native
  }
  ...
  */
  ...
  object _ConnectConfig {
    ...
    @scala.inline
    def ExistingConnectConfig(address: String, uuid: String): typingsSlinky.openfin.wireMod.ExistingConnectConfig = {
      val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], uuid = uuid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.wireMod.ExistingConnectConfig]
    }
    
    @scala.inline
    def ExternalConfig(manifestUrl: String): typingsSlinky.openfin.wireMod.ExternalConfig = {
      val __obj = js.Dynamic.literal(manifestUrl = manifestUrl.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.wireMod.ExternalConfig]
    }
  }
}
