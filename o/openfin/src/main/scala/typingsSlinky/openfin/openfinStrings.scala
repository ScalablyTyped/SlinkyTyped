...
import typingsSlinky.openfin.apiGlobalHotkeyMod.nonHotkeyEvents
import typingsSlinky.openfin.frameFrameMod.EntityType
import typingsSlinky.openfin.logMod.LogLevel
import typingsSlinky.openfin.mod.fin.OpenFinApplicationEventType
import typingsSlinky.openfin.mod.fin.OpenFinExternalApplicationEventType
import typingsSlinky.openfin.mod.fin.OpenFinExternalWindowEventType
import typingsSlinky.openfin.mod.fin.OpenFinGlobalHotkeyEventType
import typingsSlinky.openfin.mod.fin.OpenFinSystemEventType
import typingsSlinky.openfin.mod.fin.OpenFinWindowEventType
import typingsSlinky.openfin.shapesMod.AnchorType
...
object openfinStrings {
  ...
  @js.native
  sealed trait `application-connected` extends js.Object
  ...
  @js.native
  sealed trait `application-initialized` extends js.Object
  
  @js.native
  sealed trait `application-manifest-changed` extends js.Object
  
  @js.native
  sealed trait `application-not-responding` extends js.Object
  
  @js.native
  sealed trait `application-responding` extends js.Object
  
  @js.native
  sealed trait `application-started` extends OpenFinSystemEventType
  
  @js.native
  sealed trait `application-tray-icon-clicked` extends js.Object
  ...
  @js.native
  sealed trait `external-window` extends js.Object
  
  @js.native
  sealed trait `external-window-closed` extends js.Object
  
  @js.native
  sealed trait `external-window-created` extends js.Object
  
  @js.native
  sealed trait `external-window-hidden` extends js.Object
  
  @js.native
  sealed trait `external-window-shown` extends js.Object
  
  @js.native
  sealed trait externalapplication extends js.Object
  ...
  @js.native
  sealed trait `load-failed` extends js.Object
  
  @js.native
  sealed trait `load-started` extends js.Object
  
  @js.native
  sealed trait `load-succeeded` extends js.Object
  ...
  @js.native
  sealed trait `normal-termination` extends js.Object
  ...
  @js.native
  sealed trait `preload-scripts-state-changing` extends js.Object
  
  @js.native
  sealed trait printableArea extends js.Object
  
  @js.native
  sealed trait `process-desktop-event` extends js.Object
  
  @js.native
  sealed trait `process-notification-event` extends js.Object
  ...
  @js.native
  sealed trait reloaded extends js.Object
  
  @js.native
  sealed trait `remote-connect` extends js.Object
  
  @js.native
  sealed trait `remote-disconnect` extends js.Object
  
  @js.native
  sealed trait `request-external-authorization` extends js.Object
  ...
  @js.native
  sealed trait `still-running` extends js.Object
  
  @js.native
  sealed trait styleSheet extends js.Object
  
  @js.native
  sealed trait subFrame extends js.Object
  ...
  @js.native
  sealed trait `target-changed` extends js.Object
  ...
  @js.native
  sealed trait `view-created` extends js.Object
  
  @js.native
  sealed trait `view-destroyed` extends js.Object
  
  @js.native
  sealed trait `view-detached` extends js.Object
  ...
  @js.native
  sealed trait `view-page-favicon-updated` extends js.Object
  
  @js.native
  sealed trait `view-page-title-updated` extends js.Object
  
  @js.native
  sealed trait `view-resource-load-failed` extends js.Object
  
  @js.native
  sealed trait `view-resource-response-received` extends js.Object
  
  @js.native
  sealed trait `view-shown` extends js.Object
  
  @js.native
  sealed trait `view-target-changed` extends js.Object
  ...
  @js.native
  sealed trait `window-begin-user-bounds-changing` extends js.Object
  
  @js.native
  sealed trait `window-blurred` extends js.Object
  
  @js.native
  sealed trait `window-bounds-changed` extends js.Object
  
  @js.native
  sealed trait `window-bounds-changing` extends js.Object
  
  @js.native
  sealed trait `window-closed` extends OpenFinApplicationEventType
  
  @js.native
  sealed trait `window-closing` extends js.Object
  
  @js.native
  sealed trait `window-crashed` extends js.Object
  
  @js.native
  sealed trait `window-created` extends OpenFinApplicationEventType
  
  @js.native
  sealed trait `window-did-change-theme-color` extends js.Object
  
  @js.native
  sealed trait `window-disabled-movement-bounds-changed` extends js.Object
  
  @js.native
  sealed trait `window-disabled-movement-bounds-changing` extends js.Object
  
  @js.native
  sealed trait `window-embedded` extends js.Object
  
  @js.native
  sealed trait `window-end-load` extends OpenFinApplicationEventType
  
  @js.native
  sealed trait `window-end-user-bounds-changing` extends js.Object
  
  @js.native
  sealed trait `window-external-process-exited` extends js.Object
  
  @js.native
  sealed trait `window-external-process-started` extends js.Object
  
  @js.native
  sealed trait `window-focused` extends js.Object
  
  @js.native
  sealed trait `window-group-changed` extends js.Object
  ...
  @js.native
  sealed trait `window-minimized` extends js.Object
  
  @js.native
  sealed trait `window-navigation-rejected` extends OpenFinApplicationEventType
  
  @js.native
  sealed trait `window-not-responding` extends js.Object
  
  @js.native
  sealed trait `window-options-changed` extends js.Object
  
  @js.native
  sealed trait `window-page-favicon-updated` extends js.Object
  
  @js.native
  sealed trait `window-page-title-updated` extends js.Object
  
  @js.native
  sealed trait `window-performance-report` extends js.Object
  
  @js.native
  sealed trait `window-preload-scripts-state-changed` extends js.Object
  
  @js.native
  sealed trait `window-preload-scripts-state-changing` extends js.Object
  ...
  @js.native
  sealed trait `window-resource-response-received` extends js.Object
  
  @js.native
  sealed trait `window-responding` extends js.Object
  
  @js.native
  sealed trait `window-restored` extends js.Object
  
  @js.native
  sealed trait `window-show-requested` extends OpenFinApplicationEventType
  
  @js.native
  sealed trait `window-shown` extends js.Object
  
  @js.native
  sealed trait `window-start-load` extends OpenFinApplicationEventType
  
  @js.native
  sealed trait `window-user-movement-disabled` extends js.Object
  
  @js.native
  sealed trait `window-user-movement-enabled` extends js.Object
  
  @js.native
  sealed trait `window-will-move` extends js.Object
  
  @js.native
  sealed trait `window-will-resize` extends js.Object
