...
object HostSpecs {
  ...
  def apply(
    ...
    if (!js.isUndefined(aeroGlassEnabled)) __obj.updateDynamic("aeroGlassEnabled")(aeroGlassEnabled.asInstanceOf[js.Any])
    if (!js.isUndefined(screenSaver)) __obj.updateDynamic("screenSaver")(screenSaver.asInstanceOf[js.Any])
