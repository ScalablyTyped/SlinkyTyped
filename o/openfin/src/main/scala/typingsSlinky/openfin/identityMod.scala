...
object identityMod {
  ...
  */
  ...
  object ExternalWindowIdentity {
    ...
    @scala.inline
    def NativeIdOptional(uuid: String): typingsSlinky.openfin.identityMod.NativeIdOptional = {
      val __obj = js.Dynamic.literal(uuid = uuid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.identityMod.NativeIdOptional]
    }
    
    @scala.inline
    def UuidOptional(nativeId: String): typingsSlinky.openfin.identityMod.UuidOptional = {
      val __obj = js.Dynamic.literal(nativeId = nativeId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.identityMod.UuidOptional]
    }
  }
