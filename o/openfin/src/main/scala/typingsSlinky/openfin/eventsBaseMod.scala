...
object eventsBaseMod {
  ...
  */
  ...
  object RuntimeEvent {
    ...
    @scala.inline
    def ApplicationEvent[Topic, Type](topic: Topic, `type`: Type, uuid: String): typingsSlinky.openfin.eventsBaseMod.ApplicationEvent[Topic, Type] = {
      val __obj = js.Dynamic.literal(topic = topic.asInstanceOf[js.Any], uuid = uuid.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.eventsBaseMod.ApplicationEvent[Topic, Type]]
    }
    
    @scala.inline
    def BaseEvent[Topic, Type](topic: Topic, `type`: Type): typingsSlinky.openfin.eventsBaseMod.BaseEvent[Topic, Type] = {
      val __obj = js.Dynamic.literal(topic = topic.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.eventsBaseMod.BaseEvent[Topic, Type]]
    }
    
    @scala.inline
    def FrameEvent[Type](entityType: iframe, frameName: String, name: String, topic: frame, `type`: Type, uuid: String): typingsSlinky.openfin.frameMod.FrameEvent[Type] = {
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.frameMod.FrameEvent[Type]]
    }
    
    @scala.inline
    def WindowEvent[Topic, Type](name: String, topic: Topic, `type`: Type, uuid: String): typingsSlinky.openfin.eventsBaseMod.WindowEvent[Topic, Type] = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], topic = topic.asInstanceOf[js.Any], uuid = uuid.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.eventsBaseMod.WindowEvent[Topic, Type]]
    }
  }
