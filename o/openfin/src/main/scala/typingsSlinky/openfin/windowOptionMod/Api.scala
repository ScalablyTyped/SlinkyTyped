...
import typingsSlinky.openfin.AnonCrossOriginInjection
...
trait Api extends js.Object {
  var iframe: js.UndefOr[AnonCrossOriginInjection] = js.native
}
...
object Api {
  ...
  implicit class ApiOps[Self <: Api] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIframe(value: AnonCrossOriginInjection): Self = {
