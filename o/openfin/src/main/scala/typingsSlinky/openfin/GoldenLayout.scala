...
object GoldenLayout {
  ...
  object BrowserWindow {
    ...
    implicit class BrowserWindowMutableBuilder[Self <: BrowserWindow] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetGlInstance(value: () => typingsSlinky.openfin.GoldenLayout.GoldenLayout): Self = StObject.set(x, "getGlInstance", js.Any.fromFunction0(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.openfin.GoldenLayout.ItemConfig
    - typingsSlinky.openfin.GoldenLayout.ComponentConfig
    - typingsSlinky.openfin.GoldenLayout.ReactComponentConfig
  */
  trait ItemConfigType extends StObject
  object ItemConfigType {
    
    @scala.inline
    def ComponentConfig(componentName: String, `type`: String): typingsSlinky.openfin.GoldenLayout.ComponentConfig = {
      val __obj = js.Dynamic.literal(componentName = componentName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.GoldenLayout.ComponentConfig]
    }
    
    @scala.inline
    def ItemConfig(`type`: String): typingsSlinky.openfin.GoldenLayout.ItemConfig = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.GoldenLayout.ItemConfig]
    }
    
    @scala.inline
    def ReactComponentConfig(component: String, `type`: String): typingsSlinky.openfin.GoldenLayout.ReactComponentConfig = {
      val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openfin.GoldenLayout.ReactComponentConfig]
    }
  }
