...
import typingsSlinky.openfin.openfinStrings.`process-desktop-event`
import typingsSlinky.openfin.openfinStrings.`process-notification-event`
...
import typingsSlinky.openfin.wireMod.WireConstructor
