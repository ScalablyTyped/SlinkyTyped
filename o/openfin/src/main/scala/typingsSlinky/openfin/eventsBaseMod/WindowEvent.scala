...
object WindowEvent {
  ...
  @scala.inline
  implicit class WindowEventOps[Self[topic, `type`] <: WindowEvent[topic, `type`], Topic, Type] (val x: Self[Topic, Type]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withName(value: String): Self[Topic, Type] = {
