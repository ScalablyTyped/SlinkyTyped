...
package object fdc3 {
  ...
  type AppChannel = typingsSlinky.openfin.mainMod.AppChannel
  ...
  type ChannelBase = typingsSlinky.openfin.contextChannelsMod.ChannelBase
  ...
  type FDC3Error = typingsSlinky.openfin.mainMod.FDC3Error
  ...
  type SystemChannel = typingsSlinky.openfin.contextChannelsMod.SystemChannel
}
