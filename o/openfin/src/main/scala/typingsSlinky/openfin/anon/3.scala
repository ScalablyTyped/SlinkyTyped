...
object `3` {
  ...
  implicit class `3MutableBuilder`[Self <: `3`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewVal(value: Config): Self = StObject.set(x, "newVal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNewValUndefined: Self = StObject.set(x, "newVal", js.undefined)
    
    @scala.inline
    def setOldVal(value: Config): Self = StObject.set(x, "oldVal", value.asInstanceOf[js.Any])
