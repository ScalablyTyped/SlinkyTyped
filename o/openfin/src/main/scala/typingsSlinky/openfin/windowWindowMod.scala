...
import typingsSlinky.openfin.applicationMod.Application
import typingsSlinky.openfin.baseMod.Base
import typingsSlinky.openfin.externalWindowExternalWindowMod.ExternalWindow
...
import typingsSlinky.openfin.shapesMod.Transition
import typingsSlinky.openfin.shapesMod.TransitionOptions
...
object windowWindowMod {
  ...
  object Margins {
    ...
    implicit class MarginsMutableBuilder[Self <: Margins] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMarginType(value: typingsSlinky.openfin.openfinStrings.default | none | printableArea | custom): Self = StObject.set(x, "marginType", value.asInstanceOf[js.Any])
