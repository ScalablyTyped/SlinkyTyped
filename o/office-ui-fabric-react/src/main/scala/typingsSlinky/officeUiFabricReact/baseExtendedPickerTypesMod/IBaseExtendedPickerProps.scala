...
object IBaseExtendedPickerProps {
  ...
  implicit class IBaseExtendedPickerPropsOps[Self <: IBaseExtendedPickerProps[_], T] (val x: Self with IBaseExtendedPickerProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnRenderFloatingPicker(value: ReactComponentClass[IBaseFloatingPickerProps[T]]): Self = this.set("onRenderFloatingPicker", value.asInstanceOf[js.Any])
    @scala.inline
    def setOnRenderSelectedItems(value: ReactComponentClass[IBaseSelectedItemsListProps[T]]): Self = this.set("onRenderSelectedItems", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IBaseExtendedPicker[T]]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHeaderComponent(value: ReactElement): Self = this.set("headerComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnBlur(value: SyntheticFocusEvent[HTMLInputElement | Autofill] => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnFocus(value: SyntheticFocusEvent[HTMLInputElement | Autofill] => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
    @scala.inline
