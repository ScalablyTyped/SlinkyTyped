...
trait IPanelProps extends HTMLAttributes[PanelBase] {
  ...
  /**
    ...
    */
  var onDismiss: js.UndefOr[js.Function1[/* ev */ js.UndefOr[SyntheticEvent[Event_, HTMLElement]], Unit]] = js.undefined
  /**
...
object IPanelProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[PanelBase] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[PanelBase] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[PanelBase] => Unit = null,
    onAuxClick: SyntheticMouseEvent[PanelBase] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with PanelBase, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[PanelBase] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onChange: SyntheticEvent[EventTarget with PanelBase, Event_] => Unit = null,
    onClick: SyntheticMouseEvent[PanelBase] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[PanelBase] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[PanelBase] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[PanelBase] => Unit = null,
    onContextMenu: SyntheticMouseEvent[PanelBase] => Unit = null,
    onCopy: SyntheticClipboardEvent[PanelBase] => Unit = null,
    onCut: SyntheticClipboardEvent[PanelBase] => Unit = null,
    onDismiss: /* ev */ js.UndefOr[SyntheticEvent[Event_, HTMLElement]] => Unit = null,
    onDismissed: () => Unit = null,
    onDoubleClick: SyntheticMouseEvent[PanelBase] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onEmptied: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onEnded: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onError: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onFocus: SyntheticFocusEvent[PanelBase] => Unit = null,
    onInput: SyntheticEvent[EventTarget with PanelBase, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with PanelBase, Event_] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[PanelBase] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[PanelBase] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[PanelBase] => Unit = null,
    onLightDismissClick: () => Unit = null,
    onLoad: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onMouseDown: SyntheticMouseEvent[PanelBase] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[PanelBase] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[PanelBase] => Unit = null,
    onMouseMove: SyntheticMouseEvent[PanelBase] => Unit = null,
    onMouseOut: SyntheticMouseEvent[PanelBase] => Unit = null,
    onMouseOver: SyntheticMouseEvent[PanelBase] => Unit = null,
    onMouseUp: SyntheticMouseEvent[PanelBase] => Unit = null,
    onOpen: () => Unit = null,
    onOpened: () => Unit = null,
    onOuterClick: () => Unit = null,
    onPaste: SyntheticClipboardEvent[PanelBase] => Unit = null,
    onPause: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onPlay: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onPlaying: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[PanelBase] => Unit = null,
    onPointerDown: SyntheticPointerEvent[PanelBase] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[PanelBase] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[PanelBase] => Unit = null,
    onPointerMove: SyntheticPointerEvent[PanelBase] => Unit = null,
    onPointerOut: SyntheticPointerEvent[PanelBase] => Unit = null,
    onPointerOver: SyntheticPointerEvent[PanelBase] => Unit = null,
    onPointerUp: SyntheticPointerEvent[PanelBase] => Unit = null,
    onProgress: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onRateChange: SyntheticEvent[Event_, PanelBase] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with PanelBase, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[PanelBase] => Unit = null,
    onSeeked: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onSeeking: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onSelect: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onStalled: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with PanelBase, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[PanelBase] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[PanelBase] => Unit = null,
    onTouchMove: SyntheticTouchEvent[PanelBase] => Unit = null,
    onTouchStart: SyntheticTouchEvent[PanelBase] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[PanelBase] => Unit = null,
    onVolumeChange: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onWaiting: SyntheticEvent[Event_, PanelBase] => Unit = null,
    onWheel: SyntheticWheelEvent[PanelBase] => Unit = null,
