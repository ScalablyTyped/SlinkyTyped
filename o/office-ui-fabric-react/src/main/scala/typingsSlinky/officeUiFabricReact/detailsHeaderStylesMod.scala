...
object detailsHeaderStylesMod {
  ...
  @JSImport("office-ui-fabric-react/lib/components/DetailsList/DetailsHeader.styles", "getCellStyles")
  @js.native
  def getCellStyles(props: CellStyleProps): IStyle = js.native
  
  @JSImport("office-ui-fabric-react/lib/components/DetailsList/DetailsHeader.styles", "getStyles")
  @js.native
