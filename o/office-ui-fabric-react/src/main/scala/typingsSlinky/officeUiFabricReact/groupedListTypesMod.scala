...
object groupedListTypesMod {
  ...
  object IGroupDividerProps {
    ...
    implicit class IGroupDividerPropsMutableBuilder[Self <: IGroupDividerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnGroupHeaderKeyUp(value: (/* ev */ SyntheticKeyboardEvent[HTMLElement], /* group */ IGroup) => Unit): Self = StObject.set(x, "onGroupHeaderKeyUp", js.Any.fromFunction2(value))
