...
object CheckboxVisibility {
  ...
  implicit class CheckboxVisibilityOps[Self <: CheckboxVisibility] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckboxVisibility(value: typingsSlinky.officeUiFabricReact.detailsListTypesMod.CheckboxVisibility): Self = this.set("checkboxVisibility", value.asInstanceOf[js.Any])
