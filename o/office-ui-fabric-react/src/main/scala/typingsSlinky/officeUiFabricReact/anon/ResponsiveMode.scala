...
object ResponsiveMode {
  ...
  implicit class ResponsiveModeMutableBuilder[Self <: ResponsiveMode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsiveMode(value: typingsSlinky.officeUiFabricReact.withResponsiveModeMod.ResponsiveMode): Self = StObject.set(x, "responsiveMode", value.asInstanceOf[js.Any])
