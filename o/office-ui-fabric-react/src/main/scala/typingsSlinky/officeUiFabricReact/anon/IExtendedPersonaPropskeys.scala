...
object IExtendedPersonaPropskeys {
  @scala.inline
  def apply(isValid: Boolean, key: js.UndefOr[typingsSlinky.react.mod.Key] with (String | Double)): IExtendedPersonaPropskeys = {
  ...
  implicit class IExtendedPersonaPropskeysOps[Self <: IExtendedPersonaPropskeys] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKey(value: js.UndefOr[typingsSlinky.react.mod.Key] with (String | Double)): Self = this.set("key", value.asInstanceOf[js.Any])
    @scala.inline
