...
object ReadonlyIColorPickerProps {
  ...
  implicit class ReadonlyIColorPickerPropsMutableBuilder[Self <: ReadonlyIColorPickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IColorPicker]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* ev */ SyntheticEvent[Event, HTMLElement], /* color */ IColor) => scala.Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
