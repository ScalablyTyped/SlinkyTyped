...
/* Inlined office-ui-fabric-react.office-ui-fabric-react/lib/Button.IButtonProps & {[key: string] : string | number | boolean} */
trait IButtonPropskeystringstri extends /* key */ StringDictionary[String | Double | Boolean] {
  // RDFa Attributes
