...
@js.native
trait PartialIStackProps extends StObject {
...
object PartialIStackProps {
  ...
  @scala.inline
  implicit class PartialIStackPropsMutableBuilder[Self <: PartialIStackProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget with HTMLElement, Event] => scala.Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
