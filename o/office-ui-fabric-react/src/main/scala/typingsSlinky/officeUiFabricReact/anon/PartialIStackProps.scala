...
object PartialIStackProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLElement] => scala.Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLElement] => scala.Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLElement] => scala.Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLElement, Event] => scala.Unit = null,
    onBlur: SyntheticFocusEvent[HTMLElement] => scala.Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLElement, Event] => scala.Unit = null,
    onClick: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLElement] => scala.Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLElement] => scala.Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLElement] => scala.Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLElement] => scala.Unit = null,
    onCut: SyntheticClipboardEvent[HTMLElement] => scala.Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onEnded: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onError: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onFocus: SyntheticFocusEvent[HTMLElement] => scala.Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLElement, Event] => scala.Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLElement, Event] => scala.Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLElement] => scala.Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLElement] => scala.Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLElement] => scala.Unit = null,
    onLoad: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLElement] => scala.Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLElement] => scala.Unit = null,
    onPause: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onPlay: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLElement] => scala.Unit = null,
    onProgress: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLElement, Event] => scala.Unit = null,
    onScroll: SyntheticUIEvent[HTMLElement] => scala.Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onSelect: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onStalled: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLElement, Event] => scala.Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLElement] => scala.Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLElement] => scala.Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLElement] => scala.Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLElement] => scala.Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLElement] => scala.Unit = null,
    onVolumeChange: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLElement] => scala.Unit = null,
    onWheel: SyntheticWheelEvent[HTMLElement] => scala.Unit = null,
  ...
  {[ key in 'root' | 'inner' ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<office-ui-fabric-react.office-ui-fabric-react/lib/components/Stack/Stack.types.IStackSlots[key]>>}
    */ typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.PartialIStackProps with TopLevel[IStackSlots] = null,
