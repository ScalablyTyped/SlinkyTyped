...
object PartialICoachmarkProps {
  ...
  implicit class PartialICoachmarkPropsOps[Self <: PartialICoachmarkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComponentRefFunction1(value: /* ref */ ICoachmark | Null => scala.Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnAnimationOpenEnd(value: () => scala.Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnAnimationOpenStart(value: () => scala.Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnDismiss(value: /* ev */ js.UndefOr[js.Any] => scala.Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnMouseMove(value: /* e */ MouseEvent => scala.Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRefFunction1(value: /* instance */ CoachmarkBase | Null => scala.Unit): Self = {
        val ret = this.duplicate
