...
object PartialICoachmarkProps {
  ...
  implicit class PartialICoachmarkPropsOps[Self <: PartialICoachmarkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[ICoachmark]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[CoachmarkBase]): Self = this.set("ref", value.asInstanceOf[js.Any])
