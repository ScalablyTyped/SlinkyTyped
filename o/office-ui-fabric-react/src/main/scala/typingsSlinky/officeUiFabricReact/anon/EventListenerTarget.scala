...
@js.native
trait EventListenerTarget extends js.Object {
  var eventListenerTarget: Null = js.native
  var target: Null = js.native
}

object EventListenerTarget {
  @scala.inline
  def apply(eventListenerTarget: Null, target: Null): EventListenerTarget = {
    ...
    __obj.asInstanceOf[EventListenerTarget]
  }
  @scala.inline
  implicit class EventListenerTargetOps[Self <: EventListenerTarget] (val x: Self) extends AnyVal {
    @scala.inline
