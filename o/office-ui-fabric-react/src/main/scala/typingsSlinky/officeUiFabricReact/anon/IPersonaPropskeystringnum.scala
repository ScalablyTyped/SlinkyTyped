...
object IPersonaPropskeystringnum {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onAnimationStart: SyntheticAnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onAuxClick: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => scala.Unit = null,
    onBlur: SyntheticFocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCanPlay: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onChange: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => scala.Unit = null,
    onClick: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCompositionStart: SyntheticCompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onContextMenu: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCopy: SyntheticClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCut: SyntheticClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDoubleClick: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onEmptied: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onEncrypted: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onEnded: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onError: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onFocus: SyntheticFocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onInput: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => scala.Unit = null,
    onInvalid: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => scala.Unit = null,
    onKeyDown: SyntheticKeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onKeyPress: SyntheticKeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onKeyUp: SyntheticKeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onLoad: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onLoadStart: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onLoadedData: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onMouseDown: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onMouseEnter: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onMouseLeave: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onMouseMove: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onMouseOut: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onMouseOver: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onMouseUp: SyntheticMouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPaste: SyntheticClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPause: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPhotoLoadingStateChange: /* newImageLoadState */ ImageLoadState => scala.Unit = null,
    onPlay: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPlaying: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerCancel: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerDown: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerEnter: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerLeave: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerMove: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerOut: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerOver: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerUp: SyntheticPointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onProgress: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onRateChange: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => scala.Unit = null,
    onScroll: SyntheticUIEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onSeeked: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onSeeking: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onSelect: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onStalled: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onSubmit: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => scala.Unit = null,
    onSuspend: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTimeUpdate: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTouchCancel: SyntheticTouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTouchEnd: SyntheticTouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTouchMove: SyntheticTouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTouchStart: SyntheticTouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onVolumeChange: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onWaiting: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onWheel: SyntheticWheelEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
