...
object PartialIKeytipProps {
  ...
  def apply(
    ...
    offset: Point = null,
    onExecute: (/* executeTarget */ HTMLElement | Null, /* target */ HTMLElement | Null) => scala.Unit = null,
    onReturn: (/* executeTarget */ HTMLElement | Null, /* target */ HTMLElement | Null) => scala.Unit = null,
