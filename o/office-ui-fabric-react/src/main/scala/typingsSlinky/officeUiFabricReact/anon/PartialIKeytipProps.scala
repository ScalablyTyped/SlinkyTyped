...
object PartialIKeytipProps {
  ...
  implicit class PartialIKeytipPropsOps[Self <: PartialIKeytipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnExecute(value: (/* executeTarget */ HTMLElement | Null, /* target */ HTMLElement | Null) => scala.Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnReturn(value: (/* executeTarget */ HTMLElement | Null, /* target */ HTMLElement | Null) => scala.Unit): Self = {
        val ret = this.duplicate
