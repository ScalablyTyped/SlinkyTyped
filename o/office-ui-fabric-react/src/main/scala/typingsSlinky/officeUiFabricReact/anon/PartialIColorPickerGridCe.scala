...
object PartialIColorPickerGridCe {
  ...
  implicit class PartialIColorPickerGridCeOps[Self <: PartialIColorPickerGridCe] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnKeyDown(value: /* ev */ SyntheticKeyboardEvent[HTMLButtonElement] => scala.Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnMouseLeave(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => scala.Unit): Self = this.set("onMouseLeave", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnWheel(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => scala.Unit): Self = this.set("onWheel", js.Any.fromFunction1(value))
