...
trait PartialIColorPickerGridCe extends js.Object {
  ...
  var onKeyDown: js.UndefOr[js.Function1[/* ev */ SyntheticKeyboardEvent[HTMLButtonElement], scala.Unit]] = js.undefined
  var onMouseEnter: js.UndefOr[js.Function1[/* ev */ SyntheticMouseEvent[HTMLButtonElement], Boolean]] = js.undefined
  var onMouseLeave: js.UndefOr[js.Function1[/* ev */ SyntheticMouseEvent[HTMLButtonElement], scala.Unit]] = js.undefined
  var onMouseMove: js.UndefOr[js.Function1[/* ev */ SyntheticMouseEvent[HTMLButtonElement], Boolean]] = js.undefined
  var onWheel: js.UndefOr[js.Function1[/* ev */ SyntheticMouseEvent[HTMLButtonElement], scala.Unit]] = js.undefined
...
object PartialIColorPickerGridCe {
  ...
  def apply(
    ...
    onKeyDown: /* ev */ SyntheticKeyboardEvent[HTMLButtonElement] => scala.Unit = null,
    onMouseEnter: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Boolean = null,
    onMouseLeave: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => scala.Unit = null,
    onMouseMove: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Boolean = null,
    onWheel: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => scala.Unit = null,
