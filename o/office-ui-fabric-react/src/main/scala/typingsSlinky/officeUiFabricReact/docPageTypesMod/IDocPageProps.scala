...
object IDocPageProps {
  ...
  implicit class IDocPagePropsOps[Self <: IDocPageProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExampleKnobs(value: ReactElement): Self = this.set("exampleKnobs", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRelated(value: ReactElement): Self = this.set("related", value.asInstanceOf[js.Any])
    @scala.inline
