...
trait IDocPageProps extends js.Object {
  ...
  var exampleKnobs: js.UndefOr[ReactElement] = js.undefined
  ...
  /**
    ...
    */
  var related: js.UndefOr[ReactElement] = js.undefined
...
object IDocPageProps {
  ...
  def apply(
    ...
    donts: String = null,
    dos: String = null,
    exampleKnobs: ReactElement = null,
