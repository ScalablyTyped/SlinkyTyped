...
object shimmerTypesMod {
  ...
  trait IShimmerProps extends AllHTMLAttributes[HTMLElement] {
    ...
    /**
      ...
      */
    var customElementsGroup: js.UndefOr[ReactElement] = js.native
  ...
  object IShimmerProps {
    ...
    implicit class IShimmerPropsMutableBuilder[Self <: IShimmerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IShimmer]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentRefUndefined: Self = StObject.set(x, "componentRef", js.undefined)
      
      @scala.inline
      def setCustomElementsGroup(value: ReactElement): Self = StObject.set(x, "customElementsGroup", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomElementsGroupReactElement(value: ReactElement): Self = StObject.set(x, "customElementsGroup", value.asInstanceOf[js.Any])
