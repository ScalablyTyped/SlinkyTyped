...
object inputMaskMod {
  ...
  @JSImport("office-ui-fabric-react/lib/components/TextField/MaskedTextField/inputMask", "parseMask")
  @js.native
  def parseMask(mask: js.UndefOr[scala.Nothing], formatChars: StringDictionary[js.RegExp]): js.Array[IMaskValue] = js.native
  @JSImport("office-ui-fabric-react/lib/components/TextField/MaskedTextField/inputMask", "parseMask")
  @js.native
  def parseMask(mask: String): js.Array[IMaskValue] = js.native
  @JSImport("office-ui-fabric-react/lib/components/TextField/MaskedTextField/inputMask", "parseMask")
  @js.native
  def parseMask(mask: String, formatChars: StringDictionary[js.RegExp]): js.Array[IMaskValue] = js.native
