...
object teachingBubbleTypesMod {
  ...
  object ITeachingBubbleProps {
    ...
    implicit class ITeachingBubblePropsMutableBuilder[Self <: ITeachingBubbleProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[ITeachingBubble]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFooterContent(value: String | ReactElement): Self = StObject.set(x, "footerContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFooterContentReactElement(value: ReactElement): Self = StObject.set(x, "footerContent", value.asInstanceOf[js.Any])
