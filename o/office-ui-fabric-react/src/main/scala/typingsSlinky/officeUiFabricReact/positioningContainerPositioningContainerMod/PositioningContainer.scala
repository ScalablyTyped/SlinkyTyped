...
class PositioningContainer protected () extends BaseComponent[IPositioningContainerProps, IPositioningContainerState] {
  ...
  def dismiss(ev: typingsSlinky.react.mod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
  def dismiss(ev: Event_): Unit = js.native
  def onResize(): Unit = js.native
  def onResize(ev: KeyboardEvent[HTMLElement]): Unit = js.native
  def onResize(ev: typingsSlinky.react.mod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
