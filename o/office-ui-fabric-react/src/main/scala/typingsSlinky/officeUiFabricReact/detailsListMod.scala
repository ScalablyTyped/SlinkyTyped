...
object detailsListMod extends js.Object {
  ...
  class DetailsColumnBase protected ()
    extends typingsSlinky.officeUiFabricReact.detailsColumnBaseMod.DetailsColumnBase {
    def this(props: IDetailsColumnProps) = this()
  }
  
  @js.native
  class DetailsHeaderBase protected ()
    extends typingsSlinky.officeUiFabricReact.detailsHeaderBaseMod.DetailsHeaderBase {
    def this(props: IDetailsHeaderBaseProps) = this()
  }
  
  @js.native
  class DetailsListBase protected ()
    extends typingsSlinky.officeUiFabricReact.detailsListBaseMod.DetailsListBase {
