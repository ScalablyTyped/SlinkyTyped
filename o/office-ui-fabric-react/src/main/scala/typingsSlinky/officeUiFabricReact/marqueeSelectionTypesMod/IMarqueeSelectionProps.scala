...
object IMarqueeSelectionProps {
  ...
  def apply(
    ...
    styles: IMarqueeSelectionStyleProps => DeepPartial[IMarqueeSelectionStyles] = null,
    ...
    if (!js.isUndefined(isDraggingConstrainedToRoot)) __obj.updateDynamic("isDraggingConstrainedToRoot")(isDraggingConstrainedToRoot.get.asInstanceOf[js.Any])
