...
object IColumn {
  ...
  def apply(
    ...
    onRenderDivider: (/* props */ js.UndefOr[IDetailsColumnProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IDetailsColumnProps], ReactElement | Null]]) => ReactElement | Null = null,
