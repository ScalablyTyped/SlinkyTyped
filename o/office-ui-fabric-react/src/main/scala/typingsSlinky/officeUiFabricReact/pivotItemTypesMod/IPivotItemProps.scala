...
object IPivotItemProps {
  ...
  def apply(
    ...
    onRenderItemLink: (/* props */ js.UndefOr[IPivotItemProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPivotItemProps], ReactElement | Null]]) => ReactElement | Null = null,
