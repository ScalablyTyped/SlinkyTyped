package typingsSlinky.officeUiFabricReact.buttonGridTypesMod
...
object IButtonGridProps {
  ...
  implicit class IButtonGridPropsOps[Self <: IButtonGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnRenderItem(value: (js.Any, Double) => ReactElement): Self = this.set("onRenderItem", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IButtonGrid]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
