...
object IToggleProps {
  ...
  implicit class ITogglePropsOps[Self <: IToggleProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[HTMLAttributes[HTMLElement]]]): Self = this.set("as", value.asInstanceOf[js.Any])
    @scala.inline
    def setAsComponentClass(value: ReactComponentClass[IComponentAsProps[HTMLAttributes[HTMLElement]]]): Self = this.set("as", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IToggle]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* checked */ js.UndefOr[Boolean]) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    @scala.inline
