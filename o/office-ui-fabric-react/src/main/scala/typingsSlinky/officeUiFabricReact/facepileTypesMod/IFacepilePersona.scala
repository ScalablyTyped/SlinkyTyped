...
object IFacepilePersona {
  ...
  def apply(
    ...
    lang: String = null,
    name: String = null,
    onAbort: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with (HTMLButtonElement | HTMLDivElement), Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with (HTMLButtonElement | HTMLDivElement), Event] => Unit = null,
    onClick: (/* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]], /* persona */ js.UndefOr[IFacepilePersona]) => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with (HTMLButtonElement | HTMLDivElement), Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with (HTMLButtonElement | HTMLDivElement), Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onLoad: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    ...
    onMouseOver: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPause: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onProgress: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with (HTMLButtonElement | HTMLDivElement), Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with (HTMLButtonElement | HTMLDivElement), Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLButtonElement | HTMLDivElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLButtonElement | HTMLDivElement] => Unit = null,
