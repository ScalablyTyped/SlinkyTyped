...
object IBaseSelectedItemsListProps {
  ...
  implicit class IBaseSelectedItemsListPropsOps[Self <: IBaseSelectedItemsListProps[_], T] (val x: Self with IBaseSelectedItemsListProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IBaseSelectedItemsList[T]]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnRenderItem(value: /* props */ ISelectedItemProps[T] => ReactElement): Self = this.set("onRenderItem", js.Any.fromFunction1(value))
