...
trait IBaseSelectedItemsListProps[T]
  ...
  /**
    ...
    */
  var onRenderItem: js.UndefOr[js.Function1[/* props */ ISelectedItemProps[T], ReactElement]] = js.undefined
  /**
...
object IBaseSelectedItemsListProps {
  ...
  def apply[T](
    ...
    onRenderItem: /* props */ ISelectedItemProps[T] => ReactElement = null,
