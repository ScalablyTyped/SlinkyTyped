...
trait IContextualMenuItemWrapperProps extends ClassAttributes[IContextualMenuItem] {
  ...
  /**
    ...
    */
  var contextualMenuItemAs: js.UndefOr[ReactComponentClass[IContextualMenuItemProps]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onTap: js.UndefOr[js.Function1[/* ev */ SyntheticTouchEvent[HTMLElement] | PointerEvent, Unit]] = js.undefined
  /**
