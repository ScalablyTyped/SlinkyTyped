...
object IContextualMenuItemWrapperProps {
  ...
  implicit class IContextualMenuItemWrapperPropsOps[Self <: IContextualMenuItemWrapperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[ContextualMenuItemWrapper]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setContextualMenuItemAsFunctionComponent(value: ReactComponentClass[IContextualMenuItemProps]): Self = this.set("contextualMenuItemAs", value.asInstanceOf[js.Any])
    @scala.inline
    def setContextualMenuItemAsComponentClass(value: ReactComponentClass[IContextualMenuItemProps]): Self = this.set("contextualMenuItemAs", value.asInstanceOf[js.Any])
    @scala.inline
    def setContextualMenuItemAs(value: ReactComponentClass[IContextualMenuItemProps]): Self = this.set("contextualMenuItemAs", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnItemKeyDown(value: (/* item */ IContextualMenuItem, /* ev */ SyntheticKeyboardEvent[HTMLElement]) => Unit): Self = this.set("onItemKeyDown", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnItemKeyDown: Self = this.set("onItemKeyDown", js.undefined)
    @scala.inline
    def setOnItemMouseDown(value: (/* item */ IContextualMenuItem, /* ev */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onItemMouseDown", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setOnItemMouseLeave(value: (/* item */ IContextualMenuItem, /* ev */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onItemMouseLeave", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setOnTap(value: /* ev */ SyntheticTouchEvent[HTMLElement] | PointerEvent => Unit): Self = this.set("onTap", js.Any.fromFunction1(value))
    @scala.inline
