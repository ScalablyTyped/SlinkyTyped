...
object swatchColorPickerStylesMod {
  ...
  @JSImport("office-ui-fabric-react/lib/components/SwatchColorPicker/SwatchColorPicker.styles", "getStyles")
  @js.native
  def getStyles(props: ISwatchColorPickerStyleProps): ISwatchColorPickerStyles = js.native
}
