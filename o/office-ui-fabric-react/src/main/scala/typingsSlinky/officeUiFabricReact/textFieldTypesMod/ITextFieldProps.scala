...
object ITextFieldProps {
  ...
  implicit class ITextFieldPropsOps[Self <: ITextFieldProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[ITextField]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaskFormat(value: StringDictionary[js.RegExp]): Self = this.set("maskFormat", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("onGetErrorMessage", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnGetErrorMessage: Self = this.set("onGetErrorMessage", js.undefined)
    
    @scala.inline
    def setOnNotifyValidationResult(value: (/* errorMessage */ String | ReactElement, /* value */ js.UndefOr[String]) => Unit): Self = this.set("onNotifyValidationResult", js.Any.fromFunction2(value))
