...
trait ITextFieldProps extends AllHTMLAttributes[HTMLInputElement | HTMLTextAreaElement] {
  ...
  /**
    ...
    */
  var errorMessage: js.UndefOr[String | ReactElement] = js.undefined
  /**
...
object ITextFieldProps {
  ...
  def apply(
    ...
    onChange: (SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event], /* newValue */ js.UndefOr[String]) => Unit = null,
