...
object commandBarTypesMod {
  ...
  object ICommandBarItemProps {
    ...
    implicit class ICommandBarItemPropsMutableBuilder[Self <: ICommandBarItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCommandBarButtonAsComponentClass(value: ReactComponentClass[IComponentAsProps[ICommandBarItemProps]]): Self = StObject.set(x, "commandBarButtonAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCommandBarButtonAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[ICommandBarItemProps]]): Self = StObject.set(x, "commandBarButtonAs", value.asInstanceOf[js.Any])
  ...
  object ICommandBarProps {
    ...
    implicit class ICommandBarPropsMutableBuilder[Self <: ICommandBarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setButtonAsComponentClass(value: ReactComponentClass[IComponentAsProps[IButtonProps]]): Self = StObject.set(x, "buttonAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[IButtonProps]]): Self = StObject.set(x, "buttonAs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[ICommandBar]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
