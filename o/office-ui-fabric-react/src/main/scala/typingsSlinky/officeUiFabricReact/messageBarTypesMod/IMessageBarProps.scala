...
object IMessageBarProps {
  ...
  implicit class IMessageBarPropsOps[Self <: IMessageBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IMessageBar]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnDismiss(value: /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement | BaseButton | Button]] => _): Self = this.set("onDismiss", js.Any.fromFunction1(value))
    @scala.inline
