package typingsSlinky.officeUiFabricReact.datePickerFormatExampleMod
...
object IDatePickerFormatExampleState {
  @scala.inline
  def apply(): IDatePickerFormatExampleState = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IDatePickerFormatExampleState]
  }
  @scala.inline
  implicit class IDatePickerFormatExampleStateOps[Self <: IDatePickerFormatExampleState] (val x: Self) extends AnyVal {
    @scala.inline
