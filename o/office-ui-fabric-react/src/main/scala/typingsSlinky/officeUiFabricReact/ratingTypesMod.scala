...
object ratingTypesMod {
  ...
  object IRatingProps {
    ...
    implicit class IRatingPropsMutableBuilder[Self <: IRatingProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IRating]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* event */ SyntheticFocusEvent[HTMLElement], /* rating */ js.UndefOr[Double]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
