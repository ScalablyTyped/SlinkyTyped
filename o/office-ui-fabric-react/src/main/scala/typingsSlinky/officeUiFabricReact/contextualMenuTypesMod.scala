...
object contextualMenuTypesMod {
  ...
  /* propertyName */ StringDictionary[js.Any] {
    ...
    var onMouseDown: js.UndefOr[
        js.Function2[/* item */ this.type, /* event */ SyntheticMouseEvent[HTMLElement], Unit]
      ] = js.native
  ...
  object IContextualMenuItem {
    ...
    implicit class IContextualMenuItemMutableBuilder[Self <: IContextualMenuItem] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnMouseDown(value: (IContextualMenuItem, /* event */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnRender(
        value: (/* item */ js.Any, /* dismissMenu */ js.Function2[/* ev */ js.UndefOr[js.Any], /* dismissAll */ js.UndefOr[Boolean], Unit]) => ReactElement
  ...
  object IContextualMenuListProps {
    ...
    implicit class IContextualMenuListPropsMutableBuilder[Self <: IContextualMenuListProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultMenuItemRenderer(value: IContextualMenuItemRenderProps => ReactElement): Self = StObject.set(x, "defaultMenuItemRenderer", js.Any.fromFunction1(value))
