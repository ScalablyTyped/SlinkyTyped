...
object documentCardLocationTypesMod {
  ...
  object IDocumentCardLocationProps {
    ...
    implicit class IDocumentCardLocationPropsMutableBuilder[Self <: IDocumentCardLocationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IDocumentCardLocation]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnClick(value: /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
