package typingsSlinky.officeUiFabricReact.focusTrapCalloutTypesMod
...
object IFocusTrapCalloutProps {
  ...
  implicit class IFocusTrapCalloutPropsOps[Self <: IFocusTrapCalloutProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFocusTrapProps(value: IFocusTrapZoneProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("focusTrapProps")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFocusTrapProps: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("focusTrapProps")(js.undefined)
        ret
    }
  }
