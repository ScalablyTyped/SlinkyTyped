...
object calendarCalendarMod {
  ...
  object ICalendarState {
    ...
    implicit class ICalendarStateMutableBuilder[Self <: ICalendarState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNavigatedDayDate(value: js.Date): Self = StObject.set(x, "navigatedDayDate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavigatedDayDateUndefined: Self = StObject.set(x, "navigatedDayDate", js.undefined)
      
      @scala.inline
      def setNavigatedMonthDate(value: js.Date): Self = StObject.set(x, "navigatedMonthDate", value.asInstanceOf[js.Any])
