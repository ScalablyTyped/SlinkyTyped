...
object IBasePickerSuggestionsProps {
  ...
  implicit class IBasePickerSuggestionsPropsOps[Self <: IBasePickerSuggestionsProps[_], T] (val x: Self with IBasePickerSuggestionsProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setResultsFooter(value: /* props */ ISuggestionsProps[T] => ReactElement): Self = this.set("resultsFooter", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteResultsFooter: Self = this.set("resultsFooter", js.undefined)
    
    @scala.inline
    def setResultsFooterFull(value: /* props */ ISuggestionsProps[T] => ReactElement): Self = this.set("resultsFooterFull", js.Any.fromFunction1(value))
