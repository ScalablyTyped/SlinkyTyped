...
object colorPickerGridCellTypesMod {
  ...
  object IColorPickerGridCellProps {
    ...
    implicit class IColorPickerGridCellPropsMutableBuilder[Self <: IColorPickerGridCellProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnKeyDown(value: /* ev */ SyntheticKeyboardEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnMouseLeave(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnWheel(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onWheel", js.Any.fromFunction1(value))
