...
object detailsRowTypesMod {
  ...
  object IDetailsRowBaseProps {
    ...
    implicit class IDetailsRowBasePropsMutableBuilder[Self <: IDetailsRowBaseProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IDetailsRow]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnRenderCheck(value: /* props */ IDetailsRowCheckProps => ReactElement): Self = StObject.set(x, "onRenderCheck", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRowFieldsAs(value: ReactComponentClass[IDetailsRowFieldsProps]): Self = StObject.set(x, "rowFieldsAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRowFieldsAsComponentClass(value: ReactComponentClass[IDetailsRowFieldsProps]): Self = StObject.set(x, "rowFieldsAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRowFieldsAsFunctionComponent(value: ReactComponentClass[IDetailsRowFieldsProps]): Self = StObject.set(x, "rowFieldsAs", value.asInstanceOf[js.Any])
