...
- typingsSlinky.uifabricFoundation.libIcomponentMod.IStyleableComponentProps because var conflicts: className. Inlined styles, theme, tokens */ trait IStackProps
...
object IStackProps {
  ...
  def apply(
    ...
    color: String = null,
    contentEditable: Booleanish | typingsSlinky.react.reactStrings.inherit = null,
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typingsSlinky.uifabricFoundation.uifabricFoundationStrings.Slots with TopLevel[IStackSlots] = null,
