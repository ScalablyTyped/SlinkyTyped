...
object IPopupProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, Popup] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with Popup, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[Popup] => Unit = null,
    onCanPlay: SyntheticEvent[Event, Popup] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, Popup] => Unit = null,
    onChange: SyntheticEvent[EventTarget with Popup, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, Popup] => Unit = null,
    onEmptied: SyntheticEvent[Event, Popup] => Unit = null,
    onEncrypted: SyntheticEvent[Event, Popup] => Unit = null,
    onEnded: SyntheticEvent[Event, Popup] => Unit = null,
    onError: SyntheticEvent[Event, Popup] => Unit = null,
    onFocus: SyntheticFocusEvent[Popup] => Unit = null,
    onInput: SyntheticEvent[EventTarget with Popup, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with Popup, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, Popup] => Unit = null,
    onLoadStart: SyntheticEvent[Event, Popup] => Unit = null,
    onLoadedData: SyntheticEvent[Event, Popup] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, Popup] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, Popup] => Unit = null,
    onPlay: SyntheticEvent[Event, Popup] => Unit = null,
    onPlaying: SyntheticEvent[Event, Popup] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, Popup] => Unit = null,
    onRateChange: SyntheticEvent[Event, Popup] => Unit = null,
    onReset: SyntheticEvent[EventTarget with Popup, Event] => Unit = null,
    onRestoreFocus: /* options */ ContainsFocus => Unit = null,
    onScroll: SyntheticUIEvent[Popup] => Unit = null,
    onSeeked: SyntheticEvent[Event, Popup] => Unit = null,
    onSeeking: SyntheticEvent[Event, Popup] => Unit = null,
    onSelect: SyntheticEvent[Event, Popup] => Unit = null,
    onStalled: SyntheticEvent[Event, Popup] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with Popup, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, Popup] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, Popup] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, Popup] => Unit = null,
    onWaiting: SyntheticEvent[Event, Popup] => Unit = null,
