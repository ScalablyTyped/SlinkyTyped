...
object IDetailsColumnProps {
  ...
  implicit class IDetailsColumnPropsOps[Self <: IDetailsColumnProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnColumnClick(value: (/* ev */ SyntheticMouseEvent[HTMLElement], /* column */ IColumn) => Unit): Self = this.set("onColumnClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnColumnClick: Self = this.set("onColumnClick", js.undefined)
    
    @scala.inline
    def setOnColumnContextMenu(value: (/* column */ IColumn, /* ev */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onColumnContextMenu", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setUpdateDragInfo(value: (/* props */ ItemIndex, /* event */ js.UndefOr[MouseEvent]) => Unit): Self = this.set("updateDragInfo", js.Any.fromFunction2(value))
