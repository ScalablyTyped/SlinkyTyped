...
object IDetailsColumnRenderTooltipProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with (HTMLDivElement | TooltipHostBase), Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onChange: SyntheticEvent[EventTarget with (HTMLDivElement | TooltipHostBase), Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onError: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onInput: SyntheticEvent[EventTarget with (HTMLDivElement | TooltipHostBase), Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with (HTMLDivElement | TooltipHostBase), Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onReset: SyntheticEvent[EventTarget with (HTMLDivElement | TooltipHostBase), Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with (HTMLDivElement | TooltipHostBase), Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLDivElement | TooltipHostBase] => Unit = null,
    ...
    if (!js.isUndefined(setAriaDescribedBy)) __obj.updateDynamic("setAriaDescribedBy")(setAriaDescribedBy.get.asInstanceOf[js.Any])
