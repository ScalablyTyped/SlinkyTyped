...
object hoverCardMod extends js.Object {
  ...
  class ExpandingCardBase protected ()
    extends typingsSlinky.officeUiFabricReact.expandingCardBaseMod.ExpandingCardBase {
    def this(props: IExpandingCardProps) = this()
  }
  
  @js.native
  class HoverCardBase protected ()
    extends typingsSlinky.officeUiFabricReact.hoverCardBaseMod.HoverCardBase {
