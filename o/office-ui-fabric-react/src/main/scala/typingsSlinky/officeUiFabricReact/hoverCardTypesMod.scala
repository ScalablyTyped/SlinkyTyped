...
object hoverCardTypesMod {
  ...
  object IHoverCardProps {
    ...
    implicit class IHoverCardPropsMutableBuilder[Self <: IHoverCardProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IHoverCard]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEventListenerTargetHTMLElement(value: HTMLElement): Self = StObject.set(x, "eventListenerTarget", value.asInstanceOf[js.Any])
