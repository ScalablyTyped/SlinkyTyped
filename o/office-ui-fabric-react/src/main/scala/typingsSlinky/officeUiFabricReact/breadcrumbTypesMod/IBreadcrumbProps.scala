...
object IBreadcrumbProps {
  ...
  def apply(
    ...
    lang: String = null,
    maxDisplayedItems: js.UndefOr[Double] = js.undefined,
    ...
    overflowIndex: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(maxDisplayedItems)) __obj.updateDynamic("maxDisplayedItems")(maxDisplayedItems.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(overflowIndex)) __obj.updateDynamic("overflowIndex")(overflowIndex.get.asInstanceOf[js.Any])
