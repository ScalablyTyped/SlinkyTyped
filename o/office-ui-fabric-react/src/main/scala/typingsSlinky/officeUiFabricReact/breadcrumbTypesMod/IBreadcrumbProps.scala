...
object IBreadcrumbProps {
  ...
  implicit class IBreadcrumbPropsOps[Self <: IBreadcrumbProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IBreadcrumb]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentRef(value: IRefObject[IBreadcrumb]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteComponentRef: Self = this.set("componentRef", js.undefined)
    @scala.inline
    def setDividerAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[IDividerAsProps]]): Self = this.set("dividerAs", value.asInstanceOf[js.Any])
    @scala.inline
    def setDividerAsComponentClass(value: ReactComponentClass[IComponentAsProps[IDividerAsProps]]): Self = this.set("dividerAs", value.asInstanceOf[js.Any])
    @scala.inline
