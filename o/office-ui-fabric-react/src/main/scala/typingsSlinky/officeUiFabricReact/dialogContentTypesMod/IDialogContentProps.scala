...
object IDialogContentProps {
  ...
  implicit class IDialogContentPropsOps[Self <: IDialogContentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IDialogContent]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnDismiss(value: /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLButtonElement]] => _): Self = this.set("onDismiss", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnDismiss: Self = this.set("onDismiss", js.undefined)
    @scala.inline
    def setResponsiveMode(value: typingsSlinky.officeUiFabricReact.withResponsiveModeMod.ResponsiveMode): Self = this.set("responsiveMode", value.asInstanceOf[js.Any])
    @scala.inline
