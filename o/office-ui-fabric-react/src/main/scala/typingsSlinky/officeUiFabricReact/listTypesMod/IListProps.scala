...
object IListProps {
  ...
  def apply[T](
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[List[T] | HTMLDivElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[List[T] | HTMLDivElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[List[T] | HTMLDivElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with (List[T] | HTMLDivElement), Event] => Unit = null,
    onBlur: SyntheticFocusEvent[List[T] | HTMLDivElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with (List[T] | HTMLDivElement), Event] => Unit = null,
    onClick: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[List[T] | HTMLDivElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[List[T] | HTMLDivElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[List[T] | HTMLDivElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[List[T] | HTMLDivElement] => Unit = null,
    onCut: SyntheticClipboardEvent[List[T] | HTMLDivElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onEnded: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onError: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onFocus: SyntheticFocusEvent[List[T] | HTMLDivElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with (List[T] | HTMLDivElement), Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with (List[T] | HTMLDivElement), Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[List[T] | HTMLDivElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[List[T] | HTMLDivElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[List[T] | HTMLDivElement] => Unit = null,
    onLoad: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[List[T] | HTMLDivElement] => Unit = null,
    onPageAdded: /* page */ IPage[T] => Unit = null,
    onPageRemoved: /* page */ IPage[T] => Unit = null,
    onPagesUpdated: /* pages */ js.Array[IPage[T]] => Unit = null,
    onPaste: SyntheticClipboardEvent[List[T] | HTMLDivElement] => Unit = null,
    onPause: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onPlay: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[List[T] | HTMLDivElement] => Unit = null,
    onProgress: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onRenderCell: (/* item */ js.UndefOr[T], /* index */ js.UndefOr[Double], /* isScrolling */ js.UndefOr[Boolean]) => TagMod[Any] = null,
    onRenderPage: (/* props */ js.UndefOr[IPageProps[T]], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPageProps[T]], ReactElement | Null]]) => ReactElement | Null = null,
    onRenderRoot: (/* props */ js.UndefOr[IListOnRenderRootProps[T]], /* defaultRender */ js.UndefOr[
    ...
    onReset: SyntheticEvent[EventTarget with (List[T] | HTMLDivElement), Event] => Unit = null,
    onScroll: SyntheticUIEvent[List[T] | HTMLDivElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onSelect: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onShouldVirtualize: /* props */ IListProps[T] => Boolean = null,
    onStalled: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with (List[T] | HTMLDivElement), Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[List[T] | HTMLDivElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[List[T] | HTMLDivElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[List[T] | HTMLDivElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[List[T] | HTMLDivElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[List[T] | HTMLDivElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, List[T] | HTMLDivElement] => Unit = null,
    onWheel: SyntheticWheelEvent[List[T] | HTMLDivElement] => Unit = null,
