...
object IListOnRenderRootProps {
  ...
  implicit class IListOnRenderRootPropsOps[Self <: IListOnRenderRootProps[_], T] (val x: Self with IListOnRenderRootProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setRootRefRefObject(value: ReactRef[HTMLDivElement]): Self = this.set("rootRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSurfaceElement(value: ReactElement): Self = this.set("surfaceElement", value.asInstanceOf[js.Any])
