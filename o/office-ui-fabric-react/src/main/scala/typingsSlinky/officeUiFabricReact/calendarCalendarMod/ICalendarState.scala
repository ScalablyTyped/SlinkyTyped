...
object ICalendarState {
  ...
  implicit class ICalendarStateOps[Self <: ICalendarState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNavigatedDayDate(value: js.Date): Self = this.set("navigatedDayDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteNavigatedDayDate: Self = this.set("navigatedDayDate", js.undefined)
    @scala.inline
    def setNavigatedMonthDate(value: js.Date): Self = this.set("navigatedMonthDate", value.asInstanceOf[js.Any])
    @scala.inline
