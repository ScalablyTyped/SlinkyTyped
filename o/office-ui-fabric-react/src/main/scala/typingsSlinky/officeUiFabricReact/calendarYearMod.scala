...
object calendarYearMod {
  ...
  trait ICalendarYearProps extends StObject {
    ...
    var onRenderTitle: js.UndefOr[js.Function1[/* props */ ICalendarYearHeaderProps, ReactElement]] = js.native
    
    var onRenderYear: js.UndefOr[js.Function1[/* year */ Double, ReactElement]] = js.native
  ...
  object ICalendarYearProps {
    ...
    implicit class ICalendarYearPropsMutableBuilder[Self <: ICalendarYearProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnRenderTitle(value: /* props */ ICalendarYearHeaderProps => ReactElement): Self = StObject.set(x, "onRenderTitle", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnRenderTitleUndefined: Self = StObject.set(x, "onRenderTitle", js.undefined)
      
      @scala.inline
      def setOnRenderYear(value: /* year */ Double => ReactElement): Self = StObject.set(x, "onRenderYear", js.Any.fromFunction1(value))
