...
object IRatingProps {
  ...
  implicit class IRatingPropsOps[Self <: IRatingProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IRating]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* event */ SyntheticFocusEvent[HTMLElement], /* rating */ js.UndefOr[Double]) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
