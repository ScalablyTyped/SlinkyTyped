...
object buttonGridTypesMod {
  ...
  object IButtonGridProps {
    ...
    @scala.inline
    def apply(columnCount: Double, items: js.Array[_], onRenderItem: (js.Any, Double) => ReactElement): IButtonGridProps = {
    ...
    implicit class IButtonGridPropsMutableBuilder[Self <: IButtonGridProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IButtonGrid]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnRenderItem(value: (js.Any, Double) => ReactElement): Self = StObject.set(x, "onRenderItem", js.Any.fromFunction2(value))
