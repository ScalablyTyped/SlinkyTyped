...
object IDocumentCardLocationProps {
  ...
  implicit class IDocumentCardLocationPropsOps[Self <: IDocumentCardLocationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IDocumentCardLocation]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClick(value: /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
