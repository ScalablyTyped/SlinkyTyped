...
object suggestionsItemTypesMod {
  ...
  object ISuggestionItemProps {
    ...
    implicit class ISuggestionItemPropsMutableBuilder[Self <: ISuggestionItemProps[_], T] (val x: Self with ISuggestionItemProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[ISuggestionsItem]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnRemoveItem(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "onRemoveItem", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRenderSuggestion(value: (T, ISuggestionItemProps[T]) => ReactElement): Self = StObject.set(x, "RenderSuggestion", js.Any.fromFunction2(value))
