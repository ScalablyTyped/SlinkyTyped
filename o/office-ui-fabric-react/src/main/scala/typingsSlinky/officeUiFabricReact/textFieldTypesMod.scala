...
object textFieldTypesMod {
  ...
  object ITextFieldProps {
    ...
    implicit class ITextFieldPropsMutableBuilder[Self <: ITextFieldProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[ITextField]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMaskFormat(value: StringDictionary[js.RegExp]): Self = StObject.set(x, "maskFormat", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnGetErrorMessage(
        value: /* value */ String => js.UndefOr[String | ReactElement | (js.Thenable[String | ReactElement])]
      ): Self = StObject.set(x, "onGetErrorMessage", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnGetErrorMessageUndefined: Self = StObject.set(x, "onGetErrorMessage", js.undefined)
      
      @scala.inline
      def setOnNotifyValidationResult(value: (/* errorMessage */ String | ReactElement, /* value */ js.UndefOr[String]) => Unit): Self = StObject.set(x, "onNotifyValidationResult", js.Any.fromFunction2(value))
