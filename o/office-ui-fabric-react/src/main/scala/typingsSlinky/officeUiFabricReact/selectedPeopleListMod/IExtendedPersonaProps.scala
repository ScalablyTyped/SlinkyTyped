...
object IExtendedPersonaProps {
  ...
  def apply(
    ...
    key: Key = null,
    lang: String = null,
    onAbort: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => Unit = null,
    onBlur: SyntheticFocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onEnded: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onError: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onFocus: SyntheticFocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPhotoLoadingStateChange: /* newImageLoadState */ ImageLoadState => Unit = null,
    onPlay: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => Unit = null,
    onScroll: SyntheticUIEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onSelect: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onStalled: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with (PersonaBase | PersonaCoinBase | HTMLDivElement), Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    ...
    if (!js.isUndefined(blockRecipientRemoval)) __obj.updateDynamic("blockRecipientRemoval")(blockRecipientRemoval.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(shouldBlockSelection)) __obj.updateDynamic("shouldBlockSelection")(shouldBlockSelection.get.asInstanceOf[js.Any])
