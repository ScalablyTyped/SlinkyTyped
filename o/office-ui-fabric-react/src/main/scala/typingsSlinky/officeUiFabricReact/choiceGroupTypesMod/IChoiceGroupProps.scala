...
object IChoiceGroupProps {
  ...
  def apply(
    ...
    onChange: (/* ev */ js.UndefOr[SyntheticEvent[EventTarget with (HTMLElement | HTMLInputElement), Event]], /* option */ js.UndefOr[IChoiceGroupOption]) => Unit = null,
    onChanged: (/* option */ IChoiceGroupOption, /* evt */ js.UndefOr[SyntheticEvent[EventTarget with (HTMLElement | HTMLInputElement), Event]]) => Unit = null,
