...
object INavProps {
  ...
  implicit class INavPropsOps[Self <: INavProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[INav]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLinkAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[INavButtonProps]]): Self = this.set("linkAs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLinkAsComponentClass(value: ReactComponentClass[IComponentAsProps[INavButtonProps]]): Self = this.set("linkAs", value.asInstanceOf[js.Any])
