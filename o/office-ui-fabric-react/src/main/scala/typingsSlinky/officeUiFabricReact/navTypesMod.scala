...
object navTypesMod {
  ...
  object INavProps {
    ...
    implicit class INavPropsMutableBuilder[Self <: INavProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[INav]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLinkAsComponentClass(value: ReactComponentClass[IComponentAsProps[INavButtonProps]]): Self = StObject.set(x, "linkAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLinkAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[INavButtonProps]]): Self = StObject.set(x, "linkAs", value.asInstanceOf[js.Any])
