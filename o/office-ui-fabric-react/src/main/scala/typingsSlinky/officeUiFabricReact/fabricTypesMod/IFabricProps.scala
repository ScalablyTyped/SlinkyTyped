...
object IFabricProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(applyTheme)) __obj.updateDynamic("applyTheme")(applyTheme.get.asInstanceOf[js.Any])
    if (!js.isUndefined(applyThemeToBody)) __obj.updateDynamic("applyThemeToBody")(applyThemeToBody.get.asInstanceOf[js.Any])
