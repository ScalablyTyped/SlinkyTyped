...
object IPersonaCoinProps {
  ...
  implicit class IPersonaCoinPropsOps[Self <: IPersonaCoinProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStylesFunction1(value: IPersonaCoinStyleProps => Partial[IPersonaCoinStyles]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("styles")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withStyles(value: IStyleFunctionOrObject[IPersonaCoinStyleProps, IPersonaCoinStyles]): Self = {
        val ret = this.duplicate
