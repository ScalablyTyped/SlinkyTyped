...
object IImageStyleProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(isCenter)) __obj.updateDynamic("isCenter")(isCenter.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isCenterContain)) __obj.updateDynamic("isCenterContain")(isCenterContain.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isCenterCover)) __obj.updateDynamic("isCenterCover")(isCenterCover.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isContain)) __obj.updateDynamic("isContain")(isContain.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isCover)) __obj.updateDynamic("isCover")(isCover.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isLoaded)) __obj.updateDynamic("isLoaded")(isLoaded.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isNone)) __obj.updateDynamic("isNone")(isNone.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isNotImageFit)) __obj.updateDynamic("isNotImageFit")(isNotImageFit.get.asInstanceOf[js.Any])
    if (!js.isUndefined(maximizeFrame)) __obj.updateDynamic("maximizeFrame")(maximizeFrame.get.asInstanceOf[js.Any])
    if (!js.isUndefined(shouldFadeIn)) __obj.updateDynamic("shouldFadeIn")(shouldFadeIn.get.asInstanceOf[js.Any])
    if (!js.isUndefined(shouldStartVisible)) __obj.updateDynamic("shouldStartVisible")(shouldStartVisible.get.asInstanceOf[js.Any])
