...
import typingsSlinky.officeUiFabricReact.anon.Dictkey
...
object calendarMonthMod {
  ...
  object ICalendarMonthProps {
    ...
    implicit class ICalendarMonthPropsMutableBuilder[Self <: ICalendarMonthProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[ICalendarMonth]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnNavigateDate(value: (js.Date, Boolean) => Unit): Self = StObject.set(x, "onNavigateDate", js.Any.fromFunction2(value))
