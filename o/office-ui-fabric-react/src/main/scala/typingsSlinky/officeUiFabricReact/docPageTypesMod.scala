...
import typingsSlinky.officeUiFabricReact.anon.Value
import typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.defaultValue
import typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.kind
...
import typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.required
import typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.typeTokens
import typingsSlinky.uifabricMergeStyles.deepPartialMod.DeepPartial
import typingsSlinky.uifabricMergeStyles.istylefunctionMod.IStyleFunctionOrObject
import typingsSlinky.uifabricMergeStyles.istylesetMod.Omit
...
object docPageTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.interface
    - typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.enum
    - typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.`class`
    - typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.typeAlias
  */
  ...
  object IDocPageProps {
    ...
    implicit class IDocPagePropsMutableBuilder[Self <: IDocPageProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExampleKnobs(value: ReactElement): Self = StObject.set(x, "exampleKnobs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRelated(value: ReactElement): Self = StObject.set(x, "related", value.asInstanceOf[js.Any])
  ...
  object IExample {
    ...
    implicit class IExampleMutableBuilder[Self <: IExample] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: ReactElement): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.References
    - typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.Components
  */
  trait PageKind extends StObject
  object PageKind {
    
    @scala.inline
    def Components: typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.Components = "Components".asInstanceOf[typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.Components]
    
    @scala.inline
    def References: typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.References = "References".asInstanceOf[typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.References]
  }
}
