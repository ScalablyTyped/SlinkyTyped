...
object linkTypesMod {
  ...
  object ILinkProps {
    ...
    implicit class ILinkPropsMutableBuilder[Self <: ILinkProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAs(value: String | ReactComponentClass[js.Object]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAsComponentClass(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAsFunctionComponent(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[ILink]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
