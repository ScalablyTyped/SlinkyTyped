...
trait ICalendarProps
  ...
  /**
    ...
    */
  var dateRangeType: js.UndefOr[typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.DateRangeType] = js.native
  ...
  /**
    ...
    */
  var firstDayOfWeek: js.UndefOr[typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.DayOfWeek] = js.native
  ...
  /**
    ...
    */
  var firstWeekOfYear: js.UndefOr[typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.FirstWeekOfYear] = js.native
  ...
  /**
    ...
    */
  var workWeekDays: js.UndefOr[js.Array[typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.DayOfWeek]] = js.native
...
object ICalendarProps {
  ...
  implicit class ICalendarPropsOps[Self <: ICalendarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateRangeType(value: typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.DateRangeType): Self = this.set("dateRangeType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFirstDayOfWeek(value: typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.DayOfWeek): Self = this.set("firstDayOfWeek", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFirstDayOfWeek: Self = this.set("firstDayOfWeek", js.undefined)
    
    @scala.inline
    def setFirstWeekOfYear(value: typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.FirstWeekOfYear): Self = this.set("firstWeekOfYear", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnSelectDate(value: (/* date */ js.Date, /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => Unit): Self = this.set("onSelectDate", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setWorkWeekDaysVarargs(value: typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.DayOfWeek*): Self = this.set("workWeekDays", js.Array(value :_*))
    
    @scala.inline
    def setWorkWeekDays(value: js.Array[typingsSlinky.fluentuiDateTimeUtilities.dateValuesMod.DayOfWeek]): Self = this.set("workWeekDays", value.asInstanceOf[js.Any])
