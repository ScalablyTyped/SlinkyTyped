...
object iconTypesMod {
  ...
  object IIconProps {
    ...
    implicit class IIconPropsMutableBuilder[Self <: IIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setImageErrorAs(value: ReactComponentClass[IImageProps]): Self = StObject.set(x, "imageErrorAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setImageErrorAsComponentClass(value: ReactComponentClass[IImageProps]): Self = StObject.set(x, "imageErrorAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setImageErrorAsFunctionComponent(value: ReactComponentClass[IImageProps]): Self = StObject.set(x, "imageErrorAs", value.asInstanceOf[js.Any])
