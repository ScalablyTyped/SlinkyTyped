...
object sliderMod {
  ...
  @JSImport("office-ui-fabric-react/lib/components/Slider", "ONKEYDOWN_TIMEOUT_DURATION")
  @js.native
  val ONKEYDOWN_TIMEOUT_DURATION: /* 1000 */ Double = js.native
  
  @JSImport("office-ui-fabric-react/lib/components/Slider", "Slider")
  @js.native
  val Slider: ReactComponentClass[ISliderProps] = js.native
  
  @JSImport("office-ui-fabric-react/lib/components/Slider", "SliderBase")
  @js.native
