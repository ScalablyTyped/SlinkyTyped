...
object dialogFooterStylesMod {
  ...
  @JSImport("office-ui-fabric-react/lib/components/Dialog/DialogFooter.styles", "getStyles")
  @js.native
  def getStyles(props: IDialogFooterStyleProps): IDialogFooterStyles = js.native
}
