package typingsSlinky.officeUiFabricReact.buttonGridCellTypesMod
...
object IButtonGridCellProps {
  ...
  @scala.inline
  def apply[T](id: String, item: T, onRenderItem: T => ReactElement): IButtonGridCellProps[T] = {
  ...
  implicit class IButtonGridCellPropsOps[Self <: IButtonGridCellProps[_], T] (val x: Self with IButtonGridCellProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnRenderItem(value: T => ReactElement): Self = this.set("onRenderItem", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnKeyDown(value: /* ev */ SyntheticKeyboardEvent[HTMLButtonElement] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnKeyDown: Self = this.set("onKeyDown", js.undefined)
    
    @scala.inline
    def setOnMouseEnter(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Boolean): Self = this.set("onMouseEnter", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMouseLeave: Self = this.set("onMouseLeave", js.undefined)
    
    @scala.inline
    def setOnMouseMove(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Boolean): Self = this.set("onMouseMove", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMouseMove: Self = this.set("onMouseMove", js.undefined)
    
    @scala.inline
    def setOnWheel(value: /* ev */ SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("onWheel", js.Any.fromFunction1(value))
