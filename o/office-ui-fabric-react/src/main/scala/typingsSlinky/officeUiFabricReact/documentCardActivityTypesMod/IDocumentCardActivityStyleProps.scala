...
object IDocumentCardActivityStyleProps {
  ...
  implicit class IDocumentCardActivityStylePropsOps[Self <: IDocumentCardActivityStyleProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMultiplePeople(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multiplePeople")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMultiplePeople: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multiplePeople")(js.undefined)
        ret
    }
  }
