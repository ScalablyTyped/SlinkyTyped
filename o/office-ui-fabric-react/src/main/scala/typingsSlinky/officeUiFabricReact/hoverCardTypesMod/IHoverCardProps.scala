...
object IHoverCardProps {
  ...
  implicit class IHoverCardPropsOps[Self <: IHoverCardProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IHoverCard]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEventListenerTargetHTMLElement(value: HTMLElement): Self = this.set("eventListenerTarget", value.asInstanceOf[js.Any])
