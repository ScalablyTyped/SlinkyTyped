...
trait IActivityItemProps extends AllHTMLAttributes[HTMLElement] {
  /**
    ...
    */
  var activityDescription: js.UndefOr[js.Array[TagMod[Any]] | TagMod[Any]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var activityIcon: js.UndefOr[TagMod[Any]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var comments: js.UndefOr[js.Array[TagMod[Any]] | TagMod[Any]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var timeStamp: js.UndefOr[String | js.Array[TagMod[Any]] | TagMod[Any]] = js.undefined
}
...
object IActivityItemProps {
  ...
  def apply(
    ...
    activityDescription: js.Array[TagMod[Any]] | TagMod[Any] = null,
    activityDescriptionText: String = null,
    activityIcon: TagMod[Any] = null,
    ...
    comments: js.Array[TagMod[Any]] | TagMod[Any] = null,
    isCompact: js.UndefOr[Boolean] = js.undefined,
    onRenderActivityDescription: (/* props */ js.UndefOr[IActivityItemProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IActivityItemProps], ReactElement | Null]]) => ReactElement | Null = null,
    onRenderComments: (/* props */ js.UndefOr[IActivityItemProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IActivityItemProps], ReactElement | Null]]) => ReactElement | Null = null,
    onRenderIcon: (/* props */ js.UndefOr[IActivityItemProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IActivityItemProps], ReactElement | Null]]) => ReactElement | Null = null,
    onRenderTimeStamp: (/* props */ js.UndefOr[IActivityItemProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IActivityItemProps], ReactElement | Null]]) => ReactElement | Null = null,
    styles: IActivityItemStyles = null,
    timeStamp: String | js.Array[TagMod[Any]] | TagMod[Any] = null
  ): IActivityItemProps = {
