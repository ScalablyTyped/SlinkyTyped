...
trait IActivityItemProps extends AllHTMLAttributes[HTMLElement] {
  ...
  /**
    ...
    */
  var activityDescription: js.UndefOr[js.Array[ReactElement] | ReactElement] = js.native
  ...
  /**
    ...
    */
  var activityIcon: js.UndefOr[ReactElement] = js.native
  ...
  /**
    ...
    */
  var comments: js.UndefOr[js.Array[ReactElement] | ReactElement] = js.native
  ...
  /**
    ...
    */
  var timeStamp: js.UndefOr[String | js.Array[ReactElement] | ReactElement] = js.native
}
object IActivityItemProps {
  ...
  implicit class IActivityItemPropsOps[Self <: IActivityItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActivityDescriptionReactElement(value: ReactElement): Self = this.set("activityDescription", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActivityDescriptionVarargs(value: ReactElement*): Self = this.set("activityDescription", js.Array(value :_*))
    
    @scala.inline
    def setActivityDescription(value: js.Array[ReactElement] | ReactElement): Self = this.set("activityDescription", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setActivityIconReactElement(value: ReactElement): Self = this.set("activityIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActivityIcon(value: ReactElement): Self = this.set("activityIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCommentsReactElement(value: ReactElement): Self = this.set("comments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCommentsVarargs(value: ReactElement*): Self = this.set("comments", js.Array(value :_*))
    
    @scala.inline
    def setComments(value: js.Array[ReactElement] | ReactElement): Self = this.set("comments", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTimeStampReactElement(value: ReactElement): Self = this.set("timeStamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTimeStampVarargs(value: ReactElement*): Self = this.set("timeStamp", js.Array(value :_*))
    
    @scala.inline
    def setTimeStamp(value: String | js.Array[ReactElement] | ReactElement): Self = this.set("timeStamp", value.asInstanceOf[js.Any])
