...
object IDialogFooterProps {
  ...
  implicit class IDialogFooterPropsOps[Self <: IDialogFooterProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComponentRefFunction1(value: /* ref */ IDialogFooter | Null => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("componentRef")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withComponentRefRefObject(value: ReactRef[IDialogFooter]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("componentRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponentRef(value: IRefObject[IDialogFooter]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("componentRef")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withStylesFunction1(value: IDialogFooterStyleProps => Partial[IDialogFooterStyles]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("styles")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withStyles(value: IStyleFunctionOrObject[IDialogFooterStyleProps, IDialogFooterStyles]): Self = {
        val ret = this.duplicate
