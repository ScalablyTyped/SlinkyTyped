...
trait IDropdownProps extends ISelectableDroppableTextProps[IDropdown, HTMLDivElement] {
  ...
  var onChange_IDropdownProps: js.UndefOr[
    js.Function3[
      SyntheticEvent[EventTarget with org.scalajs.dom.raw.HTMLDivElement, Event_], 
...
object IDropdownProps {
  ...
  def apply(
    ...
    onChange: (SyntheticEvent[EventTarget with org.scalajs.dom.raw.HTMLDivElement, Event_], /* option */ js.UndefOr[IDropdownOption], /* index */ js.UndefOr[Double]) => Unit = null,
