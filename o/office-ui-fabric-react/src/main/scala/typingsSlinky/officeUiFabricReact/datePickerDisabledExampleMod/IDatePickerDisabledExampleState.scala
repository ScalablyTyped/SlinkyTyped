...
object IDatePickerDisabledExampleState {
  @scala.inline
  def apply(): IDatePickerDisabledExampleState = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IDatePickerDisabledExampleState]
  }
  @scala.inline
  implicit class IDatePickerDisabledExampleStateOps[Self <: IDatePickerDisabledExampleState] (val x: Self) extends AnyVal {
    @scala.inline
