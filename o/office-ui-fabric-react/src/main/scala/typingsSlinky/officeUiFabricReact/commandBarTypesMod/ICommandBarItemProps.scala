...
object ICommandBarItemProps {
  ...
  implicit class ICommandBarItemPropsOps[Self <: ICommandBarItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommandBarButtonAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[ICommandBarItemProps]]): Self = this.set("commandBarButtonAs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCommandBarButtonAsComponentClass(value: ReactComponentClass[IComponentAsProps[ICommandBarItemProps]]): Self = this.set("commandBarButtonAs", value.asInstanceOf[js.Any])
