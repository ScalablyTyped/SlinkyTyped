...
import typingsSlinky.officeUiFabricReact.contextualMenuTypesMod.ContextualMenuItemType
...
import typingsSlinky.officeUiFabricReact.contextualMenuTypesMod.IContextualMenuSection
...
object ICommandBarItemProps {
  ...
  def apply(
    ...
    onRenderIcon: (/* props */ js.UndefOr[IContextualMenuItemProps], /* defaultRender */ js.UndefOr[
    ...
    if (!js.isUndefined(renderedInOverflow)) __obj.updateDynamic("renderedInOverflow")(renderedInOverflow.get.asInstanceOf[js.Any])
