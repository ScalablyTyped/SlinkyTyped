...
object ICommandBarProps {
  ...
  implicit class ICommandBarPropsOps[Self <: ICommandBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[IButtonProps]]): Self = this.set("buttonAs", value.asInstanceOf[js.Any])
    @scala.inline
    def setButtonAsComponentClass(value: ReactComponentClass[IComponentAsProps[IButtonProps]]): Self = this.set("buttonAs", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[ICommandBar]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
