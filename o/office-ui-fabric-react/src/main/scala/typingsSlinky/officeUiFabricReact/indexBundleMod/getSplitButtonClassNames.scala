...
@JSImport("office-ui-fabric-react/lib/index.bundle", "getSplitButtonClassNames")
@js.native
object getSplitButtonClassNames extends js.Object {
  
  def apply(styles: IButtonStyles, disabled: Boolean, expanded: Boolean, checked: Boolean): ISplitButtonClassNames = js.native
  def apply(
