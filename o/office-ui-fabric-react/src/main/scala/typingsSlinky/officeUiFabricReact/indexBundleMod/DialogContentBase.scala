...
@JSImport("office-ui-fabric-react/lib/index.bundle", "DialogContentBase")
@js.native
class DialogContentBase protected ()
  extends typingsSlinky.officeUiFabricReact.mod.DialogContentBase {
...
object DialogContentBase {
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "DialogContentBase.defaultProps")
  @js.native
