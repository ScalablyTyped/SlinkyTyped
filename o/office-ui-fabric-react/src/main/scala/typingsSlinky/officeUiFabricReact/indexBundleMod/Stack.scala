...
object Stack {
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "Stack.Item")
  @js.native
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "Stack.contextTypes")
  @js.native
  def contextTypes: js.UndefOr[ValidationMap[js.Any]] = js.native
  @scala.inline
  def contextTypes_=(x: js.UndefOr[ValidationMap[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("contextTypes")(x.asInstanceOf[js.Any])
  
  @JSImport("office-ui-fabric-react/lib/index.bundle", "Stack.defaultProps")
  @js.native
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "Stack.displayName")
  @js.native
  def displayName: js.UndefOr[String] = js.native
  @scala.inline
  def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("office-ui-fabric-react/lib/index.bundle", "Stack.propTypes")
  @js.native
