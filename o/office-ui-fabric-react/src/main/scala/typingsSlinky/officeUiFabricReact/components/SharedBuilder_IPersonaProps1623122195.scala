...
@scala.inline
class SharedBuilder_IPersonaProps1623122195 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  ): this.type = set("onRenderOptionalText", js.Any.fromFunction2(value))
  @scala.inline
  def onRenderPersonaCoin(
    value: (/* props */ js.UndefOr[IPersonaSharedProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPersonaSharedProps], ReactElement | Null]]) => ReactElement | Null
  ): this.type = set("onRenderPersonaCoin", js.Any.fromFunction2(value))
  @scala.inline
  def onRenderPrimaryText(
    value: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPersonaProps], ReactElement | Null]]) => ReactElement | Null
  ): this.type = set("onRenderPrimaryText", js.Any.fromFunction2(value))
  @scala.inline
  def onRenderSecondaryText(
    value: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPersonaProps], ReactElement | Null]]) => ReactElement | Null
  ): this.type = set("onRenderSecondaryText", js.Any.fromFunction2(value))
  @scala.inline
  def onRenderTertiaryText(
    value: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPersonaProps], ReactElement | Null]]) => ReactElement | Null
  ): this.type = set("onRenderTertiaryText", js.Any.fromFunction2(value))
  @scala.inline
  def onReset(
    value: SyntheticEvent[
      EventTarget with (typingsSlinky.officeUiFabricReact.personaBaseMod.PersonaBase | typingsSlinky.officeUiFabricReact.personaCoinBaseMod.PersonaCoinBase | HTMLDivElement), 
  ...
  @scala.inline
  def stylesFunction1(value: IPersonaStyleProps => Partial[IPersonaStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  @scala.inline
