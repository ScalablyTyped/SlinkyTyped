...
import typingsSlinky.officeUiFabricReact.buttonGridTypesMod.IButtonGridStyleProps
import typingsSlinky.officeUiFabricReact.buttonGridTypesMod.IButtonGridStyles
...
@scala.inline
class SharedBuilder_IButtonGridProps2062964594 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def componentRefFunction1(value: /* ref */ IButtonGrid | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
  
  @scala.inline
  def componentRefRefObject(value: ReactRef[IButtonGrid]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  @scala.inline
  def componentRef(value: IRefObject[IButtonGrid]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def stylesFunction1(value: IButtonGridStyleProps => DeepPartial[IButtonGridStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  
  @scala.inline
  def styles(value: IStyleFunctionOrObject[IButtonGridStyleProps, IButtonGridStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
