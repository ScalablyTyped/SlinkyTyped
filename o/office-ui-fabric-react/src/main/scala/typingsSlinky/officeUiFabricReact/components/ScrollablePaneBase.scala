...
object ScrollablePaneBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ScrollablePaneBase] {
    @scala.inline
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IScrollablePane | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[IScrollablePane]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[IScrollablePane]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def initialScrollPosition(value: Double): this.type = set("initialScrollPosition", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def scrollbarVisibility(value: ScrollbarVisibility): this.type = set("scrollbarVisibility", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IScrollablePaneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ScrollablePaneBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
