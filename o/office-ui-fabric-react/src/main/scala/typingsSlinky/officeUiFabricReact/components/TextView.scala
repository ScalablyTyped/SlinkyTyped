...
object TextView {
  ...
  def withProps(p: /* props */ PropsWithChildren[ITextProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: TextView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
