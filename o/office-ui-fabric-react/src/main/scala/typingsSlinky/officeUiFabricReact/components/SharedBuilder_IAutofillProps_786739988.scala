...
@scala.inline
class SharedBuilder_IAutofillProps_786739988[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def onInputChange(value: (/* value */ String, /* composing */ Boolean) => String): this.type = set("onInputChange", js.Any.fromFunction2(value))
  @scala.inline
  def onInputValueChange(value: (/* newValue */ js.UndefOr[String], /* composing */ js.UndefOr[Boolean]) => Unit): this.type = set("onInputValueChange", js.Any.fromFunction2(value))
  @scala.inline
  def onInvalid(
    value: SyntheticEvent[
      EventTarget with (HTMLInputElement | typingsSlinky.officeUiFabricReact.autofillAutofillMod.Autofill), 
  ...
  @scala.inline
  def preventValueSelection(value: Boolean): this.type = set("preventValueSelection", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def shouldSelectFullInputValueInComponentDidUpdate(value: () => Boolean): this.type = set("shouldSelectFullInputValueInComponentDidUpdate", js.Any.fromFunction0(value))
  @scala.inline
  ...
  @scala.inline
  def suggestedDisplayValue(value: String): this.type = set("suggestedDisplayValue", value.asInstanceOf[js.Any])
  @scala.inline
