...
abstract class SharedApply_ITeachingBubbleProps_903823985[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    footerContent: String | ReactElement = null,
