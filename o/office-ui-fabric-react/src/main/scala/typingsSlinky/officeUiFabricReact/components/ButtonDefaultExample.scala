...
import typingsSlinky.officeUiFabricReact.buttonDefaultExampleMod.IButtonExampleProps
...
object ButtonDefaultExample {
  ...
  implicit def make(companion: ButtonDefaultExample.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
