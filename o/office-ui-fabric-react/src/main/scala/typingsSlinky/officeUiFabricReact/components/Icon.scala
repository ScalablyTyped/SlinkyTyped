...
import typingsSlinky.officeUiFabricReact.iconTypesMod.IconType
...
object Icon {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def iconName(value: String): this.type = set("iconName", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IIconStyleProps => Partial[IIconStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
