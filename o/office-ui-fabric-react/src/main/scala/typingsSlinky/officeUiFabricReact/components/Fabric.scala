...
object Fabric {
  ...
  @JSImport("office-ui-fabric-react", "Fabric")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.fabricBaseMod.FabricBase] {
  ...
  def withProps(p: IFabricProps with RefAttributes[typingsSlinky.officeUiFabricReact.fabricBaseMod.FabricBase]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Fabric.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
