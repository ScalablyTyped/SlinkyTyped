...
object ResizeGroupBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ResizeGroupBase] {
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IResizeGroupStyleProps => Partial[IResizeGroupStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: IResizeGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(data: js.Any, onReduceData: js.Any => js.Any, onRenderData: js.Any => ReactElement): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[IResizeGroupProps]))
  }
}
