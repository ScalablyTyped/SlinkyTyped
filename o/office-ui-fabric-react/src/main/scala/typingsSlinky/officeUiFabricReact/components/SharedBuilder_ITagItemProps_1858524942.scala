...
@scala.inline
class SharedBuilder_ITagItemProps_1858524942 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def enableTagFocusInDisabledPicker(value: Boolean): this.type = set("enableTagFocusInDisabledPicker", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def onItemChange(value: (ITag, /* index */ Double) => Unit): this.type = set("onItemChange", js.Any.fromFunction2(value))
