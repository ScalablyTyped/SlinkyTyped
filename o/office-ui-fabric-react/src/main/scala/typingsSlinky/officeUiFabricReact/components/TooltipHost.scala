...
object TooltipHost {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def stylesFunction1(value: ITooltipHostStyleProps => Partial[ITooltipHostStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
  ...
  implicit def make(companion: TooltipHost.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
