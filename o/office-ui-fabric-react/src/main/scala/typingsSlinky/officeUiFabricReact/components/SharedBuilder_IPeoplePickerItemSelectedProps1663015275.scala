...
@scala.inline
class SharedBuilder_IPeoplePickerItemSelectedProps1663015275 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def onItemChange(value: (IPersonaPropsValidationSt, /* index */ Double) => Unit): this.type = set("onItemChange", js.Any.fromFunction2(value))
  @scala.inline
