...
object GroupHeaderBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.groupHeaderBaseMod.GroupHeaderBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.groupHeaderBaseMod.GroupHeaderBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.groupHeaderBaseMod.GroupHeaderBase] = new slinky.core.BuildingComponent[
  slinky.web.html.button.tag.type, 
  typingsSlinky.officeUiFabricReact.groupHeaderBaseMod.GroupHeaderBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
