...
import typingsSlinky.officeUiFabricReact.resizeGroupTypesMod.IResizeGroup
import typingsSlinky.officeUiFabricReact.resizeGroupTypesMod.IResizeGroupStyleProps
import typingsSlinky.officeUiFabricReact.resizeGroupTypesMod.IResizeGroupStyles
import typingsSlinky.officeUiFabricReact.resizeGroupTypesMod.ResizeGroupDirection
...
@scala.inline
class SharedBuilder_IResizeGroupProps1800450644[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def componentRef(value: IRefObject[IResizeGroup]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  @scala.inline
  def componentRefFunction1(value: /* ref */ IResizeGroup | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
  
  @scala.inline
  def componentRefRefObject(value: ReactRef[IResizeGroup]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def dataDidRender(value: /* renderedData */ js.Any => Unit): this.type = set("dataDidRender", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def direction(value: ResizeGroupDirection): this.type = set("direction", value.asInstanceOf[js.Any])
  ...
  def onAbort(
    value: SyntheticEvent[
      Event, 
      typingsSlinky.officeUiFabricReact.resizeGroupBaseMod.ResizeGroupBase | HTMLElement
    ] => Unit
  ...
  def onBeforeInput(
    value: SyntheticEvent[
      EventTarget with (typingsSlinky.officeUiFabricReact.resizeGroupBaseMod.ResizeGroupBase | HTMLElement), 
      Event
    ] => Unit
  ...
  @scala.inline
  def onGrowData(value: /* prevData */ js.Any => _): this.type = set("onGrowData", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def styles(value: IStyleFunctionOrObject[IResizeGroupStyleProps, IResizeGroupStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  @scala.inline
  def stylesFunction1(value: IResizeGroupStyleProps => DeepPartial[IResizeGroupStyles]): this.type = set("styles", js.Any.fromFunction1(value))
