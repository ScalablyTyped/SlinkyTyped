...
import typingsSlinky.officeUiFabricReact.labelTypesMod.ILabel
...
object LabelBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.LabelBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LabelBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LabelBase] = new slinky.core.BuildingComponent[slinky.web.html.label.tag.type, typingsSlinky.officeUiFabricReact.mod.LabelBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
