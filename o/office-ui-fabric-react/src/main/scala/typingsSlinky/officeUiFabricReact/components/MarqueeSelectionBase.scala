...
import typingsSlinky.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelection
import typingsSlinky.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionProps
import typingsSlinky.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionStyleProps
import typingsSlinky.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionStyles
...
object MarqueeSelectionBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[
          tag.type, 
          typingsSlinky.officeUiFabricReact.marqueeSelectionBaseMod.MarqueeSelectionBase
        ] {
    @scala.inline
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IMarqueeSelection | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[IMarqueeSelection]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[IMarqueeSelection]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isDraggingConstrainedToRoot(value: Boolean): this.type = set("isDraggingConstrainedToRoot", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onShouldStartSelection(value: /* ev */ MouseEvent => Boolean): this.type = set("onShouldStartSelection", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: IMarqueeSelectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(selection: ISelection[IObjectWithKey]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[IMarqueeSelectionProps]))
  }
}
