...
object TeachingBubbleCondensedExample {
  ...
  implicit def make(companion: TeachingBubbleCondensedExample.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
