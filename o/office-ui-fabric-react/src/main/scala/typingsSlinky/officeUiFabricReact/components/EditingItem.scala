...
object EditingItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.editingItemMod.EditingItem] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.editingItemMod.EditingItem] = {
