...
import typingsSlinky.officeUiFabricReact.ratingTypesMod.IRating
import typingsSlinky.officeUiFabricReact.ratingTypesMod.IRatingProps
import typingsSlinky.officeUiFabricReact.ratingTypesMod.IRatingStyleProps
import typingsSlinky.officeUiFabricReact.ratingTypesMod.IRatingStyles
import typingsSlinky.officeUiFabricReact.ratingTypesMod.RatingSize
...
object RatingBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.RatingBase] {
    ...
    @scala.inline
    def allowZeroStars(value: Boolean): this.type = set("allowZeroStars", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def ariaLabelId(value: String): this.type = set("ariaLabelId", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IRating | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def componentRefRefObject(value: ReactRef[IRating]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def componentRef(value: IRefObject[IRating]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def getAriaLabel(value: (/* rating */ Double, /* max */ Double) => String): this.type = set("getAriaLabel", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def onChange(value: (/* event */ SyntheticFocusEvent[HTMLElement], /* rating */ js.UndefOr[Double]) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def onChanged(value: /* rating */ Double => Unit): this.type = set("onChanged", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def size(value: RatingSize): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def stylesFunction1(value: IRatingStyleProps => DeepPartial[IRatingStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    
    @scala.inline
    def styles(value: IStyleFunctionOrObject[IRatingStyleProps, IRatingStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def unselectedIcon(value: String): this.type = set("unselectedIcon", value.asInstanceOf[js.Any])
