...
object ListScrollingExample {
  ...
  implicit def make(companion: ListScrollingExample.type): SharedBuilder_Object_159303587[js.Object] = new SharedBuilder_Object_159303587[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
