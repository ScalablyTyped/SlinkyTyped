...
object ListScrollingExample
  ...
  typingsSlinky.officeUiFabricReact.listScrollingExampleMod.ListScrollingExample](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
