...
object Spinner
  ...
  def apply(
    ...
    ariaLive: typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.assertive | typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.polite | typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.off = null,
