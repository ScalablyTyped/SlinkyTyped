...
import typingsSlinky.officeUiFabricReact.spinnerTypesMod.ISpinner
...
import typingsSlinky.officeUiFabricReact.spinnerTypesMod.ISpinnerStyles
import typingsSlinky.officeUiFabricReact.spinnerTypesMod.SpinnerLabelPosition
import typingsSlinky.officeUiFabricReact.spinnerTypesMod.SpinnerSize
import typingsSlinky.officeUiFabricReact.spinnerTypesMod.SpinnerType
...
object Spinner {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def ariaLive(
      value: typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.assertive | typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.polite | typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.off
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ ISpinner | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[ISpinner]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[ISpinner]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def labelPosition(value: SpinnerLabelPosition): this.type = set("labelPosition", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: ISpinnerStyleProps => DeepPartial[ISpinnerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[ISpinnerStyleProps, ISpinnerStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `type`(value: SpinnerType): this.type = set("type", value.asInstanceOf[js.Any])
    @scala.inline
