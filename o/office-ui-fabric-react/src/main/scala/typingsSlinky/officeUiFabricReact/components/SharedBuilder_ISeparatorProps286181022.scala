...
import typingsSlinky.officeUiFabricReact.separatorTypesMod.ISeparatorStyleProps
import typingsSlinky.officeUiFabricReact.separatorTypesMod.ISeparatorStyles
...
@scala.inline
class SharedBuilder_ISeparatorProps286181022 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def alignContent(value: start | center | end): this.type = set("alignContent", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def stylesFunction1(value: ISeparatorStyleProps => Partial[ISeparatorStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  @scala.inline
