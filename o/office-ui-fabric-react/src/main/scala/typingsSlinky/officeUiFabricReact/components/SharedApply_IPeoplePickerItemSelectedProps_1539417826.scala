...
abstract class SharedApply_IPeoplePickerItemSelectedProps_1539417826 (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    index: Double,
    item: IPersonaPropsValidationSt,
    about: String = null,
    ...
    onItemChange: (IPersonaPropsValidationSt, /* index */ Double) => Unit = null,
