...
object AnnouncedBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.AnnouncedBase] {
    @scala.inline
  ...
  implicit def make(companion: AnnouncedBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
