...
object LayerBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LayerBase] {
    @scala.inline
  ...
  implicit def make(companion: LayerBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
