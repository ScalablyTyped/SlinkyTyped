...
object ImageBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.ImageBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ImageBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ImageBase] = new slinky.core.BuildingComponent[slinky.web.html.img.tag.type, typingsSlinky.officeUiFabricReact.mod.ImageBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
