...
import typingsSlinky.officeUiFabricReact.personaTypesMod.IPersonaCoinStyles
...
object PersonaCoinBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.PersonaCoinBase] {
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[
      EventTarget with (typingsSlinky.officeUiFabricReact.personaBaseMod.PersonaBase | typingsSlinky.officeUiFabricReact.personaCoinBaseMod.PersonaCoinBase | HTMLDivElement), 
      Event_
    ] => Unit = null,
    ...
    prefix: String = null,
    presence: typingsSlinky.officeUiFabricReact.personaTypesMod.PersonaPresence = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PersonaCoinBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PersonaCoinBase] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.officeUiFabricReact.mod.PersonaCoinBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IPersonaCoinProps
}
