...
object PersonaCoinBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PersonaCoinBase] {
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IPersonaCoinStyleProps => Partial[IPersonaCoinStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
