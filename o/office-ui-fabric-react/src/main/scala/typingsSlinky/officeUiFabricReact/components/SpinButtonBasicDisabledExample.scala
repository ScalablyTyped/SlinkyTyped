...
object SpinButtonBasicDisabledExample {
  ...
  def apply(p: js.Any): Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.spinButtonBasicDisabledExampleMod.SpinButtonBasicDisabledExample
  ] = new Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.spinButtonBasicDisabledExampleMod.SpinButtonBasicDisabledExample
  ](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: SpinButtonBasicDisabledExample.type): Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.spinButtonBasicDisabledExampleMod.SpinButtonBasicDisabledExample
  ] = new Default[
    tag.type, 
