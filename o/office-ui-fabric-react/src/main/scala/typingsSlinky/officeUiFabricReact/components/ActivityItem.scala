...
object ActivityItem {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def animateBeaconSignal(value: Boolean): this.type = set("animateBeaconSignal", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def isCompact(value: Boolean): this.type = set("isCompact", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onRenderActivityDescription(
    ...
    @scala.inline
    def styles(value: IActivityItemStyles): this.type = set("styles", value.asInstanceOf[js.Any])
