...
object LayerHost {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LayerHost] {
    @scala.inline
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ ILayerHost | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[ILayerHost]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[ILayerHost]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
