...
import typingsSlinky.officeUiFabricReact.layerHostTypesMod.ILayerHost
...
object LayerHost
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.LayerHost] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LayerHost] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LayerHost] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.officeUiFabricReact.mod.LayerHost](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
