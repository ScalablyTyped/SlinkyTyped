...
import typingsSlinky.officeUiFabricReact.pickerItemTypesMod.IPickerItem
...
object ExtendedSelectedItem {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ExtendedSelectedItem] {
    @scala.inline
    ...
    @scala.inline
    def onExpandItem(value: () => Unit): this.type = set("onExpandItem", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def onItemChange(value: (IExtendedPersonaProps, /* index */ Double) => Unit): this.type = set("onItemChange", js.Any.fromFunction2(value))
    @scala.inline
    ...
    ): this.type = set("renderPersonaCoin", js.Any.fromFunction2(value))
    @scala.inline
    def renderPrimaryText(
      value: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPersonaProps], ReactElement | Null]]) => ReactElement | Null
    ): this.type = set("renderPrimaryText", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps(p: ISelectedPeopleItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(index: Double, item: IExtendedPersonaProps, onCopyItem: IExtendedPersonaProps => Unit): Builder = {
    val __props = js.Dynamic.literal(index = index.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], onCopyItem = js.Any.fromFunction1(onCopyItem))
    new Builder(js.Array(this.component, __props.asInstanceOf[ISelectedPeopleItemProps]))
  }
}
