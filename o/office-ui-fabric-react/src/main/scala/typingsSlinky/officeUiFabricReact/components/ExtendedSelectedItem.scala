...
object ExtendedSelectedItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.ExtendedSelectedItem] {
  ...
  def apply(
    ...
    onItemChange: (IExtendedPersonaProps, /* index */ Double) => Unit = null,
    ...
    renderPersonaCoin: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPersonaProps], ReactElement | Null]]) => ReactElement | Null = null,
    renderPrimaryText: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPersonaProps], ReactElement | Null]]) => ReactElement | Null = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ExtendedSelectedItem] = {
    val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], onCopyItem = js.Any.fromFunction1(onCopyItem))
  ...
  type Props = ISelectedPeopleItemProps
}
