...
object ModalBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ModalBase] {
  ...
  implicit def make(companion: ModalBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
