...
object Calendar {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.Calendar] {
    @scala.inline
    ...
    @scala.inline
    def autoNavigateOnSelection(value: Boolean): this.type = set("autoNavigateOnSelection", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def dateRangeType(value: DateRangeType): this.type = set("dateRangeType", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onSelectDate(value: (/* date */ js.Date, /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => Unit): this.type = set("onSelectDate", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def selectDateOnClick(value: Boolean): this.type = set("selectDateOnClick", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def strings(value: ICalendarStrings): this.type = set("strings", value.asInstanceOf[js.Any])
    @scala.inline
    def stringsNull: this.type = set("strings", null)
    @scala.inline
