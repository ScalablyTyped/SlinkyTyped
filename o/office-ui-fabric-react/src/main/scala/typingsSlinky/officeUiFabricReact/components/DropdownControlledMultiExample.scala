...
object DropdownControlledMultiExample {
  ...
  implicit def make(companion: DropdownControlledMultiExample.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
