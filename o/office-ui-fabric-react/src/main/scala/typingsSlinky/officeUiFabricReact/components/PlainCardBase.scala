...
object PlainCardBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PlainCardBase] {
    @scala.inline
  ...
  implicit def make(companion: PlainCardBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
