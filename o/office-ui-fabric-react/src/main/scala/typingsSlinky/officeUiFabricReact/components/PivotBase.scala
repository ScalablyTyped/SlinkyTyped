...
import typingsSlinky.officeUiFabricReact.pivotTypesMod.IPivot
import typingsSlinky.officeUiFabricReact.pivotTypesMod.IPivotProps
import typingsSlinky.officeUiFabricReact.pivotTypesMod.IPivotStyleProps
import typingsSlinky.officeUiFabricReact.pivotTypesMod.IPivotStyles
import typingsSlinky.officeUiFabricReact.pivotTypesMod.PivotLinkFormat
import typingsSlinky.officeUiFabricReact.pivotTypesMod.PivotLinkSize
...
object PivotBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PivotBase] {
    @scala.inline
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IPivot | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[IPivot]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[IPivot]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def defaultSelectedKey(value: String): this.type = set("defaultSelectedKey", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def getTabId(value: (/* itemKey */ String, /* index */ Double) => String): this.type = set("getTabId", js.Any.fromFunction2(value))
    @scala.inline
    def headersOnly(value: Boolean): this.type = set("headersOnly", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def linkFormat(value: PivotLinkFormat): this.type = set("linkFormat", value.asInstanceOf[js.Any])
    @scala.inline
    def linkSize(value: PivotLinkSize): this.type = set("linkSize", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onLinkClick(
      value: (/* item */ js.UndefOr[typingsSlinky.officeUiFabricReact.pivotItemMod.PivotItem], /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]]) => Unit
    ...
    @scala.inline
    def stylesFunction1(value: IPivotStyleProps => DeepPartial[IPivotStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[IPivotStyleProps, IPivotStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IPivotProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: PivotBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
