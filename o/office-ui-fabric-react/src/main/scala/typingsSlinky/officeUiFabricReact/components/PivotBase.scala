...
object PivotBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.PivotBase] {
  ...
  def apply(
    ...
    onLinkClick: (/* item */ js.UndefOr[typingsSlinky.officeUiFabricReact.pivotItemMod.PivotItem], /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]]) => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PivotBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PivotBase] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.officeUiFabricReact.mod.PivotBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
