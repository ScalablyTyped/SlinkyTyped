...
object TextFieldBorderlessExample {
  ...
  implicit def make(companion: TextFieldBorderlessExample.type): SharedBuilder_Object_159303587[js.Object] = new SharedBuilder_Object_159303587[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
