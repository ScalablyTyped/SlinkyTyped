...
object HorizontalStackShrinkExample {
  ...
  implicit def make(companion: HorizontalStackShrinkExample.type): SharedBuilder_Object_159303587[js.Object] = new SharedBuilder_Object_159303587[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
