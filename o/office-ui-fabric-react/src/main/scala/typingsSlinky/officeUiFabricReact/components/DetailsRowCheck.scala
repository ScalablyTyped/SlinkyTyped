...
object DetailsRowCheck
  ...
  /* The following DOM/SVG props were specified: className, contentEditable, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, draggable, hidden, id, lang, placeholder, selected, spellCheck, style, suppressContentEditableWarning, tabIndex, title */
  def apply(
    canSelect: Boolean,
    about: String = null,
