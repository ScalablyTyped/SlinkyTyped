...
object DetailsRowCheck {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def anySelected(value: Boolean): this.type = set("anySelected", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def checkClassName(value: String): this.type = set("checkClassName", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isHeader(value: Boolean): this.type = set("isHeader", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IDetailsRowCheckStyleProps => DeepPartial[IDetailsRowCheckStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[IDetailsRowCheckStyleProps, IDetailsRowCheckStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  @scala.inline
  def apply(canSelect: Boolean): Builder = {
