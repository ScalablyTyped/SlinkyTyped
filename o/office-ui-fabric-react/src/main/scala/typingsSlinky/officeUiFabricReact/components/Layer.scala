...
object Layer {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onAbort(
      value: SyntheticEvent[Event_, HTMLDivElement | typingsSlinky.officeUiFabricReact.layerBaseMod.LayerBase] => Unit
    ...
    @scala.inline
    def stylesFunction1(value: ILayerStyleProps => Partial[ILayerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
