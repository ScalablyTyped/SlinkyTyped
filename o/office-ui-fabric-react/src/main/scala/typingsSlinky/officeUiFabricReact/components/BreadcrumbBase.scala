...
object BreadcrumbBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.BreadcrumbBase] {
    @scala.inline
    ...
    @scala.inline
    def maxDisplayedItems(value: Double): this.type = set("maxDisplayedItems", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onReduceData(value: /* data */ IBreadcrumbData => js.UndefOr[IBreadcrumbData]): this.type = set("onReduceData", js.Any.fromFunction1(value))
    @scala.inline
    def onRenderItem(
    ...
    @scala.inline
    def tooltipHostProps(value: ITooltipHostProps): this.type = set("tooltipHostProps", value.asInstanceOf[js.Any])
    @scala.inline
