...
import typingsSlinky.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbStyleProps
import typingsSlinky.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbStyles
import typingsSlinky.officeUiFabricReact.breadcrumbTypesMod.IDividerAsProps
...
object BreadcrumbBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.BreadcrumbBase] {
  ...
  def apply(
    ...
    onRenderItem: (/* props */ js.UndefOr[IBreadcrumbItem], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IBreadcrumbItem], ReactElement | Null]]) => ReactElement | Null = null,
    onRenderOverflowIcon: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IButtonProps], ReactElement | Null]]) => ReactElement | Null = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.BreadcrumbBase] = {
