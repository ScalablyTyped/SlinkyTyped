...
object OverlayBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.OverlayBase] {
  ...
  implicit def make(companion: OverlayBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
