...
import typingsSlinky.officeUiFabricReact.textTypesMod.ITextSlots
import typingsSlinky.officeUiFabricReact.textTypesMod.ITextStyles
...
import typingsSlinky.uifabricFoundation.uifabricFoundationStrings.AnonSlots
...
object Text {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
      */ AnonSlots with TopLevel[ITextSlots]
    ): this.type = set("slots", value.asInstanceOf[js.Any])
    @scala.inline
    def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    @scala.inline
    def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    @scala.inline
    def stylesFunction3(value: (ITextProps, /* theme */ ITheme, ITextTokens) => ITextStyles): this.type = set("styles", js.Any.fromFunction3(value))
    @scala.inline
    def styles(value: IStylesFunctionOrObject[ITextProps, ITextTokens, ITextStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def tokens(value: ITokenFunctionOrObject[ITextProps, ITextTokens]): this.type = set("tokens", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
