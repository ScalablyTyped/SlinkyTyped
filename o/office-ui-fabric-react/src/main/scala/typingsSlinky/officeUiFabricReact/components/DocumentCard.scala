...
object DocumentCard {
  @JSImport("office-ui-fabric-react", "DocumentCard")
  @js.native
  ...
  implicit def make(companion: DocumentCard.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
