...
import typingsSlinky.officeUiFabricReact.draggableZoneTypesMod.ICoordinates
import typingsSlinky.officeUiFabricReact.draggableZoneTypesMod.IDragData
...
object DraggableZone
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.draggableZoneMod.DraggableZone] {
  ...
  def apply(
    ...
    onDragChange: (/* event */ SyntheticMouseEvent[HTMLElement] with SyntheticTouchEvent[HTMLElement], /* dragData */ IDragData) => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLDivElement, Event_] => Unit = null,
    onStart: (/* event */ SyntheticMouseEvent[HTMLElement] with SyntheticTouchEvent[HTMLElement], /* dragData */ IDragData) => Unit = null,
    onStop: (/* event */ SyntheticMouseEvent[HTMLElement] with SyntheticTouchEvent[HTMLElement], /* dragData */ IDragData) => Unit = null,
    placeholder: String = null,
    position: ICoordinates = null,
    prefix: String = null,
    preventDragSelector: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.draggableZoneMod.DraggableZone] = {
    ...
    if (handleSelector != null) __obj.updateDynamic("handleSelector")(handleSelector.asInstanceOf[js.Any])
    ...
    if (onDragChange != null) __obj.updateDynamic("onDragChange")(js.Any.fromFunction2(onDragChange))
    ...
    if (preventDragSelector != null) __obj.updateDynamic("preventDragSelector")(preventDragSelector.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.draggableZoneMod.DraggableZone] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.officeUiFabricReact.draggableZoneMod.DraggableZone](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IDraggableZoneProps
}
