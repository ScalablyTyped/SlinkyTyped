...
object DraggableZone {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.draggableZoneMod.DraggableZone] {
    @scala.inline
    ...
    @scala.inline
    def handleSelector(value: String): this.type = set("handleSelector", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): this.type = set("onDragChange", js.Any.fromFunction2(value))
    @scala.inline
    ...
    def onStart(
      value: (/* event */ SyntheticMouseEvent[HTMLElement] with SyntheticTouchEvent[HTMLElement], /* dragData */ IDragData) => Unit
    ): this.type = set("onStart", js.Any.fromFunction2(value))
    @scala.inline
    def onStop(
      value: (/* event */ SyntheticMouseEvent[HTMLElement] with SyntheticTouchEvent[HTMLElement], /* dragData */ IDragData) => Unit
    ): this.type = set("onStop", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def position(value: ICoordinates): this.type = set("position", value.asInstanceOf[js.Any])
    @scala.inline
    def prefix(value: String): this.type = set("prefix", value.asInstanceOf[js.Any])
    @scala.inline
    def preventDragSelector(value: String): this.type = set("preventDragSelector", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IDraggableZoneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: DraggableZone.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
