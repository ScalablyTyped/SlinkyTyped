...
object ImageIcon {
  ...
  def withProps(p: IImageIconProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(imageProps: IImageProps): Builder = {
    val __props = js.Dynamic.literal(imageProps = imageProps.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[IImageIconProps]))
  }
}
