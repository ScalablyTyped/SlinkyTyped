...
import typingsSlinky.officeUiFabricReact.gridTypesMod.IGridStyleProps
...
object GridBase {
  @JSImport("office-ui-fabric-react/lib/utilities/grid/Grid.base", "GridBase")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.gridBaseMod.GridBase] {
    @scala.inline
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IGrid | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[IGrid]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[IGrid]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IGridStyleProps => DeepPartial[IGridStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[IGridStyleProps, IGridStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IGridProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(columnCount: Double, items: js.Array[_], onRenderItem: (js.Any, Double) => ReactElement): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[IGridProps]))
  }
}
