...
object GridBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.gridBaseMod.GridBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.gridBaseMod.GridBase] = {
