...
object SpinButton
  ...
  def apply(
    ...
    onValidate: (/* value */ String, /* event */ js.UndefOr[SyntheticEvent[Event_, HTMLElement]]) => String | Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.SpinButton] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.SpinButton] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.officeUiFabricReact.mod.SpinButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ISpinButtonProps
}
