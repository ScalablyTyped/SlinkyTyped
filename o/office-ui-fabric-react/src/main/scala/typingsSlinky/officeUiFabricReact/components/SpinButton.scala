...
import typingsSlinky.officeUiFabricReact.spinButtonTypesMod.ISpinButtonClassNames
...
object SpinButton {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.SpinButton] {
    ...
    @scala.inline
    def ariaValueNow(value: Double): this.type = set("ariaValueNow", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ ISpinButton | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def componentRefRefObject(value: ReactRef[ISpinButton]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def componentRef(value: IRefObject[ISpinButton]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def decrementButtonAriaLabel(value: String): this.type = set("decrementButtonAriaLabel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def decrementButtonIcon(value: IIconProps): this.type = set("decrementButtonIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def downArrowButtonStyles(value: PartialIButtonStyles): this.type = set("downArrowButtonStyles", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("getClassNames", js.Any.fromFunction6(value))
    ...
    @scala.inline
    def incrementButtonAriaLabel(value: String): this.type = set("incrementButtonAriaLabel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def incrementButtonIcon(value: IIconProps): this.type = set("incrementButtonIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def inputProps(value: InputHTMLAttributes[HTMLElement | HTMLInputElement]): this.type = set("inputProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def labelPosition(value: Position): this.type = set("labelPosition", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onValidate", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def styles(value: PartialISpinButtonStyles): this.type = set("styles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def upArrowButtonStyles(value: PartialIButtonStyles): this.type = set("upArrowButtonStyles", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ISpinButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SpinButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
