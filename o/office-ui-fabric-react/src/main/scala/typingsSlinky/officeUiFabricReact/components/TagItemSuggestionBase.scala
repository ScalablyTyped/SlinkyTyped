...
object TagItemSuggestionBase {
  ...
  implicit def make(companion: TagItemSuggestionBase.type): SharedBuilder_ITagItemSuggestionProps1112815244 = new SharedBuilder_ITagItemSuggestionProps1112815244(js.Array(this.component, js.Dictionary.empty))()
}
