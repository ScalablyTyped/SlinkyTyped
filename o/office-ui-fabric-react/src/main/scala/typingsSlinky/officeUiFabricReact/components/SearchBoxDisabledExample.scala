...
object SearchBoxDisabledExample {
  ...
  def apply(p: js.Any): Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.searchBoxDisabledExampleMod.SearchBoxDisabledExample
  ] = new Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.searchBoxDisabledExampleMod.SearchBoxDisabledExample
  ](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: SearchBoxDisabledExample.type): Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.searchBoxDisabledExampleMod.SearchBoxDisabledExample
  ] = new Default[
    tag.type, 
