...
import typingsSlinky.officeUiFabricReact.personaTypesMod.IPersonaPresenceStyleProps
import typingsSlinky.officeUiFabricReact.personaTypesMod.IPersonaPresenceStyles
...
object PersonaPresenceBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeUiFabricReact.libPersonaPresenceMod.PersonaPresenceBase
    ] {
  ...
  typingsSlinky.officeUiFabricReact.libPersonaPresenceMod.PersonaPresenceBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IPersonaPresenceProps
}
