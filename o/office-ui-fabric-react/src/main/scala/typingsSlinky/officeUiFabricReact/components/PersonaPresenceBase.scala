...
object PersonaPresenceBase {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def presenceColors(value: AnonAvailable): this.type = set("presenceColors", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IPersonaPresenceStyleProps => Partial[IPersonaPresenceStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[IPersonaPresenceStyleProps, IPersonaPresenceStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IPersonaPresenceProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: PersonaPresenceBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
