...
object BaseButton {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def allowDisabledFocus(value: Boolean): this.type = set("allowDisabledFocus", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def ariaHidden(value: Boolean): this.type = set("ariaHidden", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def description(value: IStyle): this.type = set("description", value.asInstanceOf[js.Any])
    
    @scala.inline
    def descriptionNull: this.type = set("description", null)
    ...
    @scala.inline
    def menuProps(value: IContextualMenuProps): this.type = set("menuProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def menuTriggerKeyCode(value: KeyCodes): this.type = set("menuTriggerKeyCode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def menuTriggerKeyCodeNull: this.type = set("menuTriggerKeyCode", null)
    ...
    @scala.inline
    def onMenuClick(
      value: (/* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement] | SyntheticKeyboardEvent[HTMLElement]], /* button */ js.UndefOr[IBaseButtonProps]) => Unit
    ): this.type = set("onMenuClick", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def primaryActionButtonProps(value: IButtonProps): this.type = set("primaryActionButtonProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def primaryDisabled(value: Boolean): this.type = set("primaryDisabled", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def renderPersistedMenuHiddenOnMount(value: Boolean): this.type = set("renderPersistedMenuHiddenOnMount", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def rootProps(value: ButtonHTMLAttributes[HTMLButtonElement] | AnchorHTMLAttributes[HTMLAnchorElement]): this.type = set("rootProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def splitButtonAriaLabel(value: String): this.type = set("splitButtonAriaLabel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def splitButtonMenuProps(value: IButtonProps): this.type = set("splitButtonMenuProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def styles(value: IButtonStyles): this.type = set("styles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def uniqueId(value: String | Double): this.type = set("uniqueId", value.asInstanceOf[js.Any])
