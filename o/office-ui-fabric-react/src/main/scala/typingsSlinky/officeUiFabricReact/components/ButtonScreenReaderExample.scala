...
import typingsSlinky.officeUiFabricReact.buttonScreenReaderExampleMod.IButtonExampleProps
...
object ButtonScreenReaderExample {
  ...
  implicit def make(companion: ButtonScreenReaderExample.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
