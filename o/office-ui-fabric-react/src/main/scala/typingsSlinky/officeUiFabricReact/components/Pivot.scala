...
object Pivot {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.pivotBaseMod.PivotBase] {
  ...
  implicit def make(companion: Pivot.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
