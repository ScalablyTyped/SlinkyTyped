...
@scala.inline
class SharedBuilder_ICalloutProps988608940[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def calloutMaxWidth(value: Double): this.type = set("calloutMaxWidth", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def hideOverflow(value: Boolean): this.type = set("hideOverflow", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def onPositioned(value: /* positions */ js.UndefOr[ICalloutPositionedInfo] => Unit): this.type = set("onPositioned", js.Any.fromFunction1(value))
  ...
  @scala.inline
  def preventDismissOnResize(value: Boolean): this.type = set("preventDismissOnResize", value.asInstanceOf[js.Any])
