...
import typingsSlinky.officeUiFabricReact.buttonCommandExampleMod.IButtonExampleProps
...
object ButtonCommandExample {
  ...
  implicit def make(companion: ButtonCommandExample.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
