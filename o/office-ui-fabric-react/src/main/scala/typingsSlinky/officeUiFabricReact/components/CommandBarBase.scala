...
object CommandBarBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.CommandBarBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.CommandBarBase] = {
