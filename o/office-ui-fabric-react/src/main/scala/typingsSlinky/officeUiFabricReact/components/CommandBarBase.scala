...
object CommandBarBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.CommandBarBase] {
    @scala.inline
    ...
    @scala.inline
    def onDataGrown(value: /* movedItem */ ICommandBarItemProps => Unit): this.type = set("onDataGrown", js.Any.fromFunction1(value))
    @scala.inline
    def onDataReduced(value: /* movedItem */ ICommandBarItemProps => Unit): this.type = set("onDataReduced", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onGrowData(value: /* data */ ICommandBarData => js.UndefOr[ICommandBarData]): this.type = set("onGrowData", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onReduceData(value: /* data */ ICommandBarData => js.UndefOr[ICommandBarData]): this.type = set("onReduceData", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def shiftOnReduce(value: Boolean): this.type = set("shiftOnReduce", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: ICommandBarStyleProps => Partial[ICommandBarStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
