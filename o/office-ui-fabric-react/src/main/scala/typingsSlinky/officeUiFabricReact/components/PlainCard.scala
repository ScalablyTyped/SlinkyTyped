...
import typingsSlinky.officeUiFabricReact.plainCardTypesMod.IPlainCard
import typingsSlinky.officeUiFabricReact.plainCardTypesMod.IPlainCardProps
import typingsSlinky.officeUiFabricReact.plainCardTypesMod.IPlainCardStyleProps
...
object PlainCard {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IPlainCard | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[IPlainCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[IPlainCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(
      value: IPlainCardStyleProps => Partial[
