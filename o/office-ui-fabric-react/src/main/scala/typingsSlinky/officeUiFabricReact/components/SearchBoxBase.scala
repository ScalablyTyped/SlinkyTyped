...
import typingsSlinky.officeUiFabricReact.searchBoxTypesMod.ISearchBox
...
object SearchBoxBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.SearchBoxBase] {
    @scala.inline
    ...
    @scala.inline
    def clearButtonProps(value: IButtonProps): this.type = set("clearButtonProps", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRefFunction1(value: /* ref */ ISearchBox | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[ISearchBox]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[ISearchBox]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def iconProps(value: PickIIconPropsExcludekeyo): this.type = set("iconProps", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def labelText(value: String): this.type = set("labelText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChanged(value: /* newValue */ js.Any => Unit): this.type = set("onChanged", js.Any.fromFunction1(value))
    @scala.inline
    def onClear(value: /* ev */ js.UndefOr[js.Any] => Unit): this.type = set("onClear", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onEscape(value: /* ev */ js.UndefOr[js.Any] => Unit): this.type = set("onEscape", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onSearch(value: /* newValue */ js.Any => Unit): this.type = set("onSearch", js.Any.fromFunction1(value))
    @scala.inline
