...
object SearchBoxBase
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.SearchBoxBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.SearchBoxBase] = new slinky.core.BuildingComponent[
  slinky.web.html.input.tag.type, 
  typingsSlinky.officeUiFabricReact.mod.SearchBoxBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
