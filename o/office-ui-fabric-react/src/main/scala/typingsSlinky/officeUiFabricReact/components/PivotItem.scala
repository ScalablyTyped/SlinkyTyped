...
object PivotItem {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PivotItem] {
    @scala.inline
    ...
    @scala.inline
    def itemCount(value: Double | String): this.type = set("itemCount", value.asInstanceOf[js.Any])
    @scala.inline
    def itemID(value: String): this.type = set("itemID", value.asInstanceOf[js.Any])
    @scala.inline
    def itemIcon(value: String): this.type = set("itemIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def itemKey(value: String): this.type = set("itemKey", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): this.type = set("onRenderItemLink", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps(p: IPivotItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: PivotItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
