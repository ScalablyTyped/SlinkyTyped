...
import typingsSlinky.officeUiFabricReact.shimmerGapTypesMod.IShimmerGap
...
@scala.inline
class SharedBuilder_IShimmerGapProps_1862428348 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def componentRefFunction1(value: /* ref */ IShimmerGap | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
  @scala.inline
  def componentRefRefObject(value: ReactRef[IShimmerGap]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  @scala.inline
  def componentRef(value: IRefObject[IShimmerGap]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def stylesFunction1(value: IShimmerGapStyleProps => DeepPartial[IShimmerGapStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  @scala.inline
  def styles(value: IStyleFunctionOrObject[IShimmerGapStyleProps, IShimmerGapStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  @scala.inline
