...
object BasePickerListBelow {
  ...
  implicit def make[T, /* <: typingsSlinky.officeUiFabricReact.basePickerTypesMod.IBasePickerProps[T] */ P](companion: BasePickerListBelow.type): Builder[T, P] = new Builder[T, P](js.Array(this.component, js.Dictionary.empty))()
}
