...
object DatePickerBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.DatePickerBase] {
    @scala.inline
    ...
    @scala.inline
    def allowTextInput(value: Boolean): this.type = set("allowTextInput", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def firstWeekOfYear(value: FirstWeekOfYear): this.type = set("firstWeekOfYear", value.asInstanceOf[js.Any])
    @scala.inline
    def formatDate(value: /* date */ js.UndefOr[js.Date] => String): this.type = set("formatDate", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def initialPickerDate(value: js.Date): this.type = set("initialPickerDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onAfterMenuDismiss(value: () => Unit): this.type = set("onAfterMenuDismiss", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def onSelectDate(value: /* date */ js.UndefOr[js.Date | Null] => Unit): this.type = set("onSelectDate", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def parseDateFromString(value: /* dateStr */ String => js.Date | Null): this.type = set("parseDateFromString", js.Any.fromFunction1(value))
    @scala.inline
    def pickerAriaLabel(value: String): this.type = set("pickerAriaLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def strings(value: IDatePickerStrings): this.type = set("strings", value.asInstanceOf[js.Any])
    @scala.inline
    def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    @scala.inline
    def stylesFunction1(value: IDatePickerStyleProps => Partial[IDatePickerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def textField(value: ITextFieldProps): this.type = set("textField", value.asInstanceOf[js.Any])
    @scala.inline
