...
import typingsSlinky.officeUiFabricReact.expandingCardTypesMod.IExpandingCard
import typingsSlinky.officeUiFabricReact.expandingCardTypesMod.IExpandingCardProps
import typingsSlinky.officeUiFabricReact.expandingCardTypesMod.IExpandingCardStyleProps
import typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.IBaseCardProps
...
object ExpandingCard {
  @JSImport("office-ui-fabric-react", "ExpandingCard")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def expandedCardHeight(value: Double): this.type = set("expandedCardHeight", value.asInstanceOf[js.Any])
    @scala.inline
    def firstFocus(value: Boolean): this.type = set("firstFocus", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def mode(value: ExpandingCardMode): this.type = set("mode", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onEnter(value: /* ev */ js.UndefOr[js.Any] => Unit): this.type = set("onEnter", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onLeave(value: /* ev */ js.UndefOr[js.Any] => Unit): this.type = set("onLeave", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onRenderCompactCard(
      value: (/* props */ js.UndefOr[_], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[_], ReactElement | Null]]) => ReactElement | Null
    ): this.type = set("onRenderCompactCard", js.Any.fromFunction2(value))
    @scala.inline
    def onRenderExpandedCard(
      value: (/* props */ js.UndefOr[_], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[_], ReactElement | Null]]) => ReactElement | Null
    ): this.type = set("onRenderExpandedCard", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def renderData(value: js.Any): this.type = set("renderData", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(
      value: IExpandingCardStyleProps => Partial[
    ...
    @scala.inline
    def targetElement(value: HTMLElement): this.type = set("targetElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def trapFocus(value: Boolean): this.type = set("trapFocus", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: ExpandingCard.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
