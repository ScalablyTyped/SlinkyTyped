...
object ExpandingCard
  ...
  def apply(
    ...
    onRenderCompactCard: (/* props */ js.UndefOr[_], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[_], ReactElement | Null]]) => ReactElement | Null = null,
    onRenderExpandedCard: (/* props */ js.UndefOr[_], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[_], ReactElement | Null]]) => ReactElement | Null = null,
