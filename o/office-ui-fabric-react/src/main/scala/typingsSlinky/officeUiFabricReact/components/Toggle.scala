...
object Toggle {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def inlineLabel(value: Boolean): this.type = set("inlineLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def offAriaLabel(value: String): this.type = set("offAriaLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onAriaLabel(value: String): this.type = set("onAriaLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* checked */ js.UndefOr[Boolean]) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    @scala.inline
    def onChanged(value: /* checked */ Boolean => Unit): this.type = set("onChanged", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def role(value: checkbox | switch | menuitemcheckbox): this.type = set("role", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IToggleStyleProps => Partial[IToggleStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
