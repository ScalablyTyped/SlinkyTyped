...
object Toggle
  ...
  /* The following DOM/SVG props were specified: checked, className, contentEditable, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, id, lang, placeholder, spellCheck, style, suppressContentEditableWarning, tabIndex, title */
  def apply(
    about: String = null,
    ...
    onChange: (/* event */ SyntheticMouseEvent[HTMLElement], /* checked */ js.UndefOr[Boolean]) => Unit = null,
    ...
    if (offAriaLabel != null) __obj.updateDynamic("offAriaLabel")(offAriaLabel.asInstanceOf[js.Any])
    ...
    if (onAriaLabel != null) __obj.updateDynamic("onAriaLabel")(onAriaLabel.asInstanceOf[js.Any])
