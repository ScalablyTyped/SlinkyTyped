...
object Announced {
  @JSImport("office-ui-fabric-react", "Announced")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.announcedBaseMod.AnnouncedBase] {
    @scala.inline
    ...
    @scala.inline
    def `aria-live`(value: off | polite | assertive): this.type = set("aria-live", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def unselectable(value: on | typingsSlinky.react.reactStrings.off): this.type = set("unselectable", value.asInstanceOf[js.Any])
    @scala.inline
    def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: IAnnouncedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Announced.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
