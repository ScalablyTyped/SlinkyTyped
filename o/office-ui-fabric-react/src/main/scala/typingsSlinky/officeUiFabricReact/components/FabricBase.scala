...
object FabricBase
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.FabricBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.FabricBase] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.officeUiFabricReact.mod.FabricBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IFabricProps
}
