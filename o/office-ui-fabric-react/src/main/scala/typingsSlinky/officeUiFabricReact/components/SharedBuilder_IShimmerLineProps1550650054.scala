...
import typingsSlinky.officeUiFabricReact.shimmerLineTypesMod.IShimmerLine
import typingsSlinky.officeUiFabricReact.shimmerLineTypesMod.IShimmerLineStyleProps
import typingsSlinky.officeUiFabricReact.shimmerLineTypesMod.IShimmerLineStyles
...
@scala.inline
class SharedBuilder_IShimmerLineProps1550650054 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def borderStyle(value: IRawStyle): this.type = set("borderStyle", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def componentRefFunction1(value: /* ref */ IShimmerLine | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
  @scala.inline
  def componentRefRefObject(value: ReactRef[IShimmerLine]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  @scala.inline
  def componentRef(value: IRefObject[IShimmerLine]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def stylesFunction1(value: IShimmerLineStyleProps => Partial[IShimmerLineStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  @scala.inline
  def styles(value: IStyleFunctionOrObject[IShimmerLineStyleProps, IShimmerLineStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  @scala.inline
