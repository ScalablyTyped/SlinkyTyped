...
abstract class SharedApply_IPeopleFloatingPickerProps75271359[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    onChange: IPersonaProps => Unit = null,
