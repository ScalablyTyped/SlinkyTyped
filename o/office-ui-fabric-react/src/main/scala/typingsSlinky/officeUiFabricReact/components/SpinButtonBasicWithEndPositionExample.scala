...
object SpinButtonBasicWithEndPositionExample {
  ...
  def apply(p: js.Any): Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.spinButtonBasicWithEndPositionExampleMod.SpinButtonBasicWithEndPositionExample
  ] = new Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.spinButtonBasicWithEndPositionExampleMod.SpinButtonBasicWithEndPositionExample
  ](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: SpinButtonBasicWithEndPositionExample.type): Default[
    tag.type, 
    typingsSlinky.officeUiFabricReact.spinButtonBasicWithEndPositionExampleMod.SpinButtonBasicWithEndPositionExample
  ] = new Default[
    tag.type, 
