...
import typingsSlinky.officeUiFabricReact.hoverCardTypesMod.IHoverCardStyleProps
import typingsSlinky.officeUiFabricReact.hoverCardTypesMod.IHoverCardStyles
...
object HoverCardBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.HoverCardBase] {
    @scala.inline
    ...
    @scala.inline
    def cardDismissDelay(value: Double): this.type = set("cardDismissDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def cardOpenDelay(value: Double): this.type = set("cardOpenDelay", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def expandedCardOpenDelay(value: Double): this.type = set("expandedCardOpenDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def expandingCardProps(value: IExpandingCardProps): this.type = set("expandingCardProps", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def instantOpenOnClick(value: Boolean): this.type = set("instantOpenOnClick", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onCardExpand(value: () => Unit): this.type = set("onCardExpand", js.Any.fromFunction0(value))
    @scala.inline
    def onCardHide(value: () => Unit): this.type = set("onCardHide", js.Any.fromFunction0(value))
    @scala.inline
    def onCardVisible(value: () => Unit): this.type = set("onCardVisible", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def openHotKey(value: KeyCodes): this.type = set("openHotKey", value.asInstanceOf[js.Any])
    @scala.inline
    def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    @scala.inline
    def plainCardProps(value: IPlainCardProps): this.type = set("plainCardProps", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def shouldBlockHoverCard(value: () => Unit): this.type = set("shouldBlockHoverCard", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IHoverCardStyleProps => Partial[IHoverCardStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def `type`(value: HoverCardType): this.type = set("type", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: HoverCardBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
