...
object HoverCardBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.HoverCardBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.HoverCardBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.HoverCardBase] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.officeUiFabricReact.mod.HoverCardBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IHoverCardProps
}
