...
object PositioningContainer
  ...
  typingsSlinky.officeUiFabricReact.positioningContainerPositioningContainerMod.PositioningContainer](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
