...
object PersonaBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.PersonaBase] {
    @scala.inline
  ...
  def withProps(p: IPersonaProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: PersonaBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
