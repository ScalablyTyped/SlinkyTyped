...
object FocusTrapZone
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.FocusTrapZone] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.FocusTrapZone] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.FocusTrapZone] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.officeUiFabricReact.mod.FocusTrapZone](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IFocusTrapZoneProps
}
