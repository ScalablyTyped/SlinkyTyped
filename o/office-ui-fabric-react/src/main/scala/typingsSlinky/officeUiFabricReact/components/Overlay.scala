...
import typingsSlinky.officeUiFabricReact.overlayTypesMod.IOverlay
import typingsSlinky.officeUiFabricReact.overlayTypesMod.IOverlayProps
import typingsSlinky.officeUiFabricReact.overlayTypesMod.IOverlayStyleProps
import typingsSlinky.officeUiFabricReact.overlayTypesMod.IOverlayStyles
...
object Overlay {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IOverlay | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[IOverlay]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[IOverlay]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isDarkThemed(value: Boolean): this.type = set("isDarkThemed", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IOverlayStyleProps => DeepPartial[IOverlayStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[IOverlayStyleProps, IOverlayStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
