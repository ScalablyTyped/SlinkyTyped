...
abstract class SharedApply_IShimmerElementsGroupProps_255856475 (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = IShimmerElementsGroupProps
}
