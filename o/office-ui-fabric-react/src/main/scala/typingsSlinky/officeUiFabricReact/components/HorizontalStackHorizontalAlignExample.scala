...
object HorizontalStackHorizontalAlignExample {
  ...
  implicit def make(companion: HorizontalStackHorizontalAlignExample.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
