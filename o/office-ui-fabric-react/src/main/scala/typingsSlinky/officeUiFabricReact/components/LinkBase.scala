...
object LinkBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LinkBase] {
    @scala.inline
    ...
    @scala.inline
    def asFunctionComponent(value: ReactComponentClass[js.Object]): this.type = set("as", value.asInstanceOf[js.Any])
    @scala.inline
    def asComponentClass(value: ReactComponentClass[js.Object]): this.type = set("as", value.asInstanceOf[js.Any])
    @scala.inline
    def as(value: String | ReactComponentClass[js.Object]): this.type = set("as", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ ILink | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[ILink]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[ILink]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    def onAbort(
      value: SyntheticEvent[
          Event, 
          HTMLAnchorElement | HTMLButtonElement | HTMLElement | typingsSlinky.officeUiFabricReact.linkBaseMod.LinkBase
        ] => Unit
    ...
    def onBeforeInput(
      value: SyntheticEvent[
          EventTarget with (HTMLAnchorElement | HTMLButtonElement | HTMLElement | typingsSlinky.officeUiFabricReact.linkBaseMod.LinkBase), 
          Event
        ] => Unit
    ...
    @scala.inline
    def stylesFunction1(value: ILinkStyleProps => DeepPartial[ILinkStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[ILinkStyleProps, ILinkStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: ILinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: LinkBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
