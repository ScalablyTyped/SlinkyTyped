...
object LinkBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.LinkBase] {
  @JSImport("office-ui-fabric-react", "LinkBase")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: className, contentEditable, dangerouslySetInnerHTML, dir, disabled, draggable, form, hidden, id, lang, name, spellCheck, style, suppressContentEditableWarning, tabIndex, title, value */
  def apply(
    about: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LinkBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.LinkBase] = new slinky.core.BuildingComponent[slinky.web.html.button.tag.type, typingsSlinky.officeUiFabricReact.mod.LinkBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
