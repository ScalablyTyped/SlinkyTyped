...
@scala.inline
class SharedBuilder_IGroupShowAllProps_1085117924 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def stylesFunction1(value: IGroupShowAllStyleProps => Partial[IGroupShowAllStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  @scala.inline
