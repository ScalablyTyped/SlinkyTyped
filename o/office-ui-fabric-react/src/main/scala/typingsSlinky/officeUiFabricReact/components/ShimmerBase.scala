...
object ShimmerBase {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def isDataLoaded(value: Boolean): this.type = set("isDataLoaded", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IShimmerStyleProps => Partial[IShimmerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
