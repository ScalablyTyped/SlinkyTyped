...
import typingsSlinky.officeUiFabricReact.shimmerTypesMod.IShimmer
import typingsSlinky.officeUiFabricReact.shimmerTypesMod.IShimmerColors
...
import typingsSlinky.officeUiFabricReact.shimmerTypesMod.IShimmerStyleProps
import typingsSlinky.officeUiFabricReact.shimmerTypesMod.IShimmerStyles
...
object ShimmerBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.mod.ShimmerBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ShimmerBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.mod.ShimmerBase] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.officeUiFabricReact.mod.ShimmerBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
