...
import typingsSlinky.officeUiFabricReact.peoplePickerItemTypesMod.IPersonaWithMenu
...
object SelectedItemWithMenu
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeUiFabricReact.selectedItemWithMenuMod.SelectedItemWithMenu
    ] {
