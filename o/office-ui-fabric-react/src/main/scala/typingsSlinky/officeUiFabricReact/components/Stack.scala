...
object Stack {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def gap(value: Double | String): this.type = set("gap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def grow(
      value: Boolean | Double | typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.inherit | initial | unset
    ): this.type = set("grow", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def horizontalAlign(value: Alignment): this.type = set("horizontalAlign", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def inner(value: IHTMLSlot): this.type = set("inner", value.asInstanceOf[js.Any])
    ...
    {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
      */ Slots with TopLevel[IStackSlots]
    ...
    @scala.inline
    def tokens(value: ITokenFunctionOrObject[IStackProps, IStackTokens]): this.type = set("tokens", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def verticalAlign(value: Alignment): this.type = set("verticalAlign", value.asInstanceOf[js.Any])
