...
object DocumentCardBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeUiFabricReact.documentCardBaseMod.DocumentCardBase] {
  ...
  def apply(
    ...
    onClick: /* ev */ js.UndefOr[SyntheticEvent[Event_, HTMLElement]] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.documentCardBaseMod.DocumentCardBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.documentCardBaseMod.DocumentCardBase] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.officeUiFabricReact.documentCardBaseMod.DocumentCardBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IDocumentCardProps
}
