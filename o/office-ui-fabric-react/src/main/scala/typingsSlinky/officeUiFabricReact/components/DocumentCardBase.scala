...
import typingsSlinky.officeUiFabricReact.documentCardTypesMod.DocumentCardType
...
import typingsSlinky.officeUiFabricReact.documentCardTypesMod.IDocumentCardStyleProps
import typingsSlinky.officeUiFabricReact.documentCardTypesMod.IDocumentCardStyles
...
object DocumentCardBase {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.officeUiFabricReact.documentCardBaseMod.DocumentCardBase] {
    @scala.inline
    ...
    @scala.inline
    def componentRefFunction1(value: /* ref */ IDocumentCard | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def componentRefRefObject(value: ReactRef[IDocumentCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    def componentRef(value: IRefObject[IDocumentCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onClick(value: /* ev */ js.UndefOr[SyntheticEvent[Event_, HTMLElement]] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def stylesFunction1(value: IDocumentCardStyleProps => Partial[IDocumentCardStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def styles(value: IStyleFunctionOrObject[IDocumentCardStyleProps, IDocumentCardStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `type`(value: DocumentCardType): this.type = set("type", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IDocumentCardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: DocumentCardBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
