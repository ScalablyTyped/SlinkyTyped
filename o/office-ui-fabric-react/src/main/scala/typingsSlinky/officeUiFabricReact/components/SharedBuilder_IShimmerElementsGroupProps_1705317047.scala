...
import typingsSlinky.officeUiFabricReact.shimmerElementsGroupTypesMod.IShimmerElementsGroup
import typingsSlinky.officeUiFabricReact.shimmerElementsGroupTypesMod.IShimmerElementsGroupStyleProps
import typingsSlinky.officeUiFabricReact.shimmerElementsGroupTypesMod.IShimmerElementsGroupStyles
...
@scala.inline
class SharedBuilder_IShimmerElementsGroupProps_1705317047 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def componentRefFunction1(value: /* ref */ IShimmerElementsGroup | Null => Unit): this.type = set("componentRef", js.Any.fromFunction1(value))
  @scala.inline
  def componentRefRefObject(value: ReactRef[IShimmerElementsGroup]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  @scala.inline
  def componentRef(value: IRefObject[IShimmerElementsGroup]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def flexWrap(value: Boolean): this.type = set("flexWrap", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def stylesFunction1(value: IShimmerElementsGroupStyleProps => Partial[IShimmerElementsGroupStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  @scala.inline
  def styles(value: IStyleFunctionOrObject[IShimmerElementsGroupStyleProps, IShimmerElementsGroupStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  @scala.inline
