...
object ICalendarYearProps {
  ...
  implicit class ICalendarYearPropsOps[Self <: ICalendarYearProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnRenderTitle(value: /* props */ ICalendarYearHeaderProps => ReactElement): Self = this.set("onRenderTitle", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnRenderTitle: Self = this.set("onRenderTitle", js.undefined)
    
    @scala.inline
    def setOnRenderYear(value: /* year */ Double => ReactElement): Self = this.set("onRenderYear", js.Any.fromFunction1(value))
