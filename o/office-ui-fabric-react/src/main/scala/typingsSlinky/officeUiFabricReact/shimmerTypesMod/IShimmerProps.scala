...
object IShimmerProps {
  ...
  implicit class IShimmerPropsOps[Self <: IShimmerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IShimmer]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCustomElementsGroupReactElement(value: ReactElement): Self = this.set("customElementsGroup", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomElementsGroup(value: ReactElement): Self = this.set("customElementsGroup", value.asInstanceOf[js.Any])
