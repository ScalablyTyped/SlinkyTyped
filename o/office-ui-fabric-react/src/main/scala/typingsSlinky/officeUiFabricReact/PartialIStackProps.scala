...
trait PartialIStackProps extends js.Object {
  ...
  var as: js.UndefOr[ReactComponentClass[HTMLAttributes[HTMLElement]]] = js.undefined
  ...
  {[ key in 'root' | 'inner' ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<office-ui-fabric-react.office-ui-fabric-react/lib/components/Stack/Stack.types.IStackSlots[key]>>}
    */ typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.PartialIStackProps with IStackSlots
  ] = js.undefined
...
object PartialIStackProps {
  ...
  def apply(
    ...
    as: ReactComponentClass[HTMLAttributes[HTMLElement]] = null,
  ...
  {[ key in 'root' | 'inner' ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<office-ui-fabric-react.office-ui-fabric-react/lib/components/Stack/Stack.types.IStackSlots[key]>>}
    */ typingsSlinky.officeUiFabricReact.officeUiFabricReactStrings.PartialIStackProps with IStackSlots = null,
