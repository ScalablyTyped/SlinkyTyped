...
object modalTypesMod {
  ...
  object IDragOptions {
    ...
    implicit class IDragOptionsMutableBuilder[Self <: IDragOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMenu(value: ReactComponentClass[IContextualMenuProps]): Self = StObject.set(x, "menu", value.asInstanceOf[js.Any])
  ...
  object IModalProps {
    ...
    implicit class IModalPropsMutableBuilder[Self <: IModalProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IModal]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
