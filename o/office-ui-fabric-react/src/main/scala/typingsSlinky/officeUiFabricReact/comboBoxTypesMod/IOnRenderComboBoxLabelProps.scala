...
object IOnRenderComboBoxLabelProps {
  ...
  implicit class IOnRenderComboBoxLabelPropsOps[Self <: IOnRenderComboBoxLabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProps(value: IComboBoxProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("props")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMultiselectAccessibleText(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multiselectAccessibleText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMultiselectAccessibleText: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multiselectAccessibleText")(js.undefined)
        ret
    }
  }
