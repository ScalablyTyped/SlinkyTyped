...
object IComboBoxProps {
  ...
  def apply(
    ...
    onChange: (SyntheticEvent[EventTarget with IComboBox, Event], /* option */ js.UndefOr[IComboBoxOption], /* index */ js.UndefOr[Double], /* value */ js.UndefOr[String]) => Unit = null,
    ...
    onItemClick: (SyntheticEvent[EventTarget with IComboBox, Event], /* option */ js.UndefOr[IComboBoxOption], /* index */ js.UndefOr[Double]) => Unit = null,
