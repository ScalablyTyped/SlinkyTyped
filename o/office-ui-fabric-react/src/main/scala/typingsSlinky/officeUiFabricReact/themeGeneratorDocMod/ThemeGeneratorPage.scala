...
class ThemeGeneratorPage protected ()
  ...
  var _fabricSlotWidget: js.Any = js.native
  var _makeNewTheme: js.Any = js.native
  var _onSwatchClick: js.Any = js.native
  var _outputSection: js.Any = js.native
  var _semanticSlotColorChangeTimeout: js.Any = js.native
  var _semanticSlotRuleChanged: js.Any = js.native
  var _slotWidget: js.Any = js.native
  @JSName("componentWillUnmount")
  def componentWillUnmount_MThemeGeneratorPage(): Unit = js.native
}
