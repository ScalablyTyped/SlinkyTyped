...
- typingsSlinky.officeUiFabricReact.withResponsiveModeMod.IWithResponsiveModeState because var conflicts: responsiveMode. Inlined  */ trait IDropdownInternalProps extends IDropdownProps
...
object IDropdownInternalProps {
  ...
  def apply(
    ...
    onChange: (SyntheticEvent[EventTarget with HTMLDivElement, Event], /* option */ js.UndefOr[IDropdownOption], /* index */ js.UndefOr[Double]) => Unit = null,
