...
object labelTypesMod {
  ...
  object ILabelProps {
    ...
    implicit class ILabelPropsMutableBuilder[Self <: ILabelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAsComponentClass(value: ReactComponentClass[IComponentAsProps[AllHTMLAttributes[HTMLElement]]]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[AllHTMLAttributes[HTMLElement]]]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[ILabel]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
