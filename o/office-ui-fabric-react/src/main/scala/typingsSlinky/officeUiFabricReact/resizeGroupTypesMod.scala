...
object resizeGroupTypesMod {
  ...
  object IResizeGroupProps {
    ...
    implicit class IResizeGroupPropsMutableBuilder[Self <: IResizeGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IResizeGroup]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnRenderData(value: js.Any => ReactElement): Self = StObject.set(x, "onRenderData", js.Any.fromFunction1(value))
