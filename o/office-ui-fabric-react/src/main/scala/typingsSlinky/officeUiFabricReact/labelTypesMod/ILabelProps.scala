...
object ILabelProps {
  ...
  implicit class ILabelPropsOps[Self <: ILabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[AllHTMLAttributes[HTMLElement]]]): Self = this.set("as", value.asInstanceOf[js.Any])
    @scala.inline
    def setAsComponentClass(value: ReactComponentClass[IComponentAsProps[AllHTMLAttributes[HTMLElement]]]): Self = this.set("as", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[ILabel]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
