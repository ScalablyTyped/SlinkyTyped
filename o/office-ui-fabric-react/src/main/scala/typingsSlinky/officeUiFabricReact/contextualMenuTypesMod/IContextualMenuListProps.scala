...
trait IContextualMenuListProps extends js.Object {
  ...
  def defaultMenuItemRenderer(item: IContextualMenuItemRenderProps): ReactElement = js.native
...
object IContextualMenuListProps {
  ...
  @scala.inline
  def apply(
    defaultMenuItemRenderer: IContextualMenuItemRenderProps => ReactElement,
  ...
  implicit class IContextualMenuListPropsOps[Self <: IContextualMenuListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultMenuItemRenderer(value: IContextualMenuItemRenderProps => ReactElement): Self = this.set("defaultMenuItemRenderer", js.Any.fromFunction1(value))
