...
import typingsSlinky.officeUiFabricReact.AnonHasCondensedHeadline
...
class TeachingBubbleContentBase protected ()
  extends typingsSlinky.officeUiFabricReact.libTeachingBubbleMod.TeachingBubbleContentBase {
