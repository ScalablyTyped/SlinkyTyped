...
object ISuggestionItemProps {
  ...
  implicit class ISuggestionItemPropsOps[Self <: ISuggestionItemProps[_], T] (val x: Self with ISuggestionItemProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setRenderSuggestion(value: (T, ISuggestionItemProps[T]) => ReactElement): Self = this.set("RenderSuggestion", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnClick(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnRemoveItem(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("onRemoveItem", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[ISuggestionsItem]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
