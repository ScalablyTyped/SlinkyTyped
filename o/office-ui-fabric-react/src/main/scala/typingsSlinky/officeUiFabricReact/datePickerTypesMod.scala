...
object datePickerTypesMod {
  ...
  object IDatePickerProps {
    ...
    implicit class IDatePickerPropsMutableBuilder[Self <: IDatePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCalendarAsComponentClass(value: ReactComponentClass[IComponentAsProps[ICalendarProps]]): Self = StObject.set(x, "calendarAs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCalendarAsFunctionComponent(value: ReactComponentClass[IComponentAsProps[ICalendarProps]]): Self = StObject.set(x, "calendarAs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFormatDate(value: /* date */ js.UndefOr[js.Date] => String): Self = StObject.set(x, "formatDate", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setInitialPickerDate(value: js.Date): Self = StObject.set(x, "initialPickerDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnSelectDate(value: /* date */ js.UndefOr[js.Date | Null] => Unit): Self = StObject.set(x, "onSelectDate", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnSelectDateUndefined: Self = StObject.set(x, "onSelectDate", js.undefined)
      
      @scala.inline
      def setParseDateFromString(value: /* dateStr */ String => js.Date | Null): Self = StObject.set(x, "parseDateFromString", js.Any.fromFunction1(value))
