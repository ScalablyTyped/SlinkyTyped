...
object IContextualMenuItemProps {
  ...
  implicit class IContextualMenuItemPropsOps[Self <: IContextualMenuItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnCheckmarkClick(value: (/* item */ IContextualMenuItem, /* ev */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onCheckmarkClick", js.Any.fromFunction2(value))
