...
object IResizeGroupProps {
  ...
  implicit class IResizeGroupPropsOps[Self <: IResizeGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnRenderData(value: js.Any => ReactElement): Self = this.set("onRenderData", js.Any.fromFunction1(value))
    
    @scala.inline
    def setComponentRefFunction1(value: /* ref */ IResizeGroup | Null => Unit): Self = this.set("componentRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IResizeGroup]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
