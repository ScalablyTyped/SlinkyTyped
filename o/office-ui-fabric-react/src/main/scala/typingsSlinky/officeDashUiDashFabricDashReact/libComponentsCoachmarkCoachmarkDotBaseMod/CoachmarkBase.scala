package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCoachmarkCoachmarkDotBaseMod
...
class CoachmarkBase protected ()
  ...
  @JSName("dismiss")
  def dismiss_MCoachmarkBase(ev: typingsSlinky.react.reactMod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
  @JSName("dismiss")
