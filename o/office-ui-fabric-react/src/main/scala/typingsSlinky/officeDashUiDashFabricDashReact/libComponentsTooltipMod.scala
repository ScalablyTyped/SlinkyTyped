...
@js.native
object libComponentsTooltipMod extends js.Object {
  @js.native
  class TooltipBase ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotBaseMod.TooltipBase
  
  @js.native
  class TooltipHostBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotBaseMod.TooltipHostBase {
