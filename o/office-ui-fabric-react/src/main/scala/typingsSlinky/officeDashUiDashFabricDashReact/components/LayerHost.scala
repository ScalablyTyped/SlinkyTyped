...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerHostDotTypesMod.ILayerHost
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerHostDotTypesMod.ILayerHostProps
...
object LayerHost
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerHost] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerHost] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerHost] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerHost](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ILayerHostProps
}
