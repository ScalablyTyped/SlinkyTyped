...
object CalendarButtonExample
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCalendarExamplesCalendarDotButtonDotExampleMod.CalendarButtonExample](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
