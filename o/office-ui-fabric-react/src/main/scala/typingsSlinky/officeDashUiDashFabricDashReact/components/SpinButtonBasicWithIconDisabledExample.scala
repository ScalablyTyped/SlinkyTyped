...
object SpinButtonBasicWithIconDisabledExample
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSpinButtonExamplesSpinButtonDotBasicWithIconDisabledDotExampleMod.SpinButtonBasicWithIconDisabledExample
    ] {
