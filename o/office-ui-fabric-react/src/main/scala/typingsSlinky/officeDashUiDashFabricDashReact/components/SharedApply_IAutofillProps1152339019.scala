...
abstract class SharedApply_IAutofillProps1152339019[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLInputElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsAutofillAutofillMod.Autofill
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLInputElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsAutofillAutofillMod.Autofill), 
      Event
    ] => Unit = null,
