...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsMessageBarMessageBarDotTypesMod.IMessageBar
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsMessageBarMessageBarDotTypesMod.IMessageBarProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsMessageBarMessageBarDotTypesMod.IMessageBarStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsMessageBarMessageBarDotTypesMod.IMessageBarStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsMessageBarMessageBarDotTypesMod.MessageBarType
...
object MessageBarBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libMessageBarMod.MessageBarBase
    ] {
  ...
  def apply(
    ...
    actions: typingsSlinky.react.reactMod._Global_.JSX.Element = null,
    ...
    onDismiss: /* ev */ js.UndefOr[
      SyntheticMouseEvent[
        HTMLElement | typingsSlinky.officeDashUiDashFabricDashReact.libButtonMod.BaseButton | typingsSlinky.officeDashUiDashFabricDashReact.libButtonMod.Button
      ]
    ] => _ = null,
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libMessageBarMod.MessageBarBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
