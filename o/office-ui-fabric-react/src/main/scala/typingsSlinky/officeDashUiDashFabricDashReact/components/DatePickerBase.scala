...
object DatePickerBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libDatePickerMod.DatePickerBase
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libDatePickerMod.DatePickerBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
