...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsGroupedListGroupHeaderDotTypesMod.IGroupHeaderStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsGroupedListGroupHeaderDotTypesMod.IGroupHeaderStyles
...
object GroupHeaderBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsGroupedListGroupHeaderDotBaseMod.GroupHeaderBase
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsGroupedListGroupHeaderDotBaseMod.GroupHeaderBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
