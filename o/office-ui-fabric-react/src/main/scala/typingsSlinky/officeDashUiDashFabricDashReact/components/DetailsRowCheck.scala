...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListDetailsRowCheckDotTypesMod.IDetailsRowCheckStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListDetailsRowCheckDotTypesMod.IDetailsRowCheckStyles
...
object DetailsRowCheck
  ...
  def apply(
    ...
    if (checkClassName != null) __obj.updateDynamic("checkClassName")(checkClassName.asInstanceOf[js.Any])
  ...
  type Props = IDetailsRowCheckProps
}
