...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotTypesMod.IPersona
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotTypesMod.IPersonaStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotTypesMod.IPersonaStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotTypesMod.PersonaInitialsColor
...
abstract class SharedApply_IPersonaProps1002921275 (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotBaseMod.PersonaBase | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaCoinPersonaCoinDotBaseMod.PersonaCoinBase | HTMLDivElement
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotBaseMod.PersonaBase | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaCoinPersonaCoinDotBaseMod.PersonaCoinBase | HTMLDivElement), 
      Event
    ] => Unit = null,
    ...
    prefix: String = null,
    presence: typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotTypesMod.PersonaPresence = null,
