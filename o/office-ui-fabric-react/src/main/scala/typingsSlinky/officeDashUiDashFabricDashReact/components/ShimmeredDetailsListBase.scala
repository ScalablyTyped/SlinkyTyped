...
object ShimmeredDetailsListBase
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libIndexDotBundleMod.ShimmeredDetailsListBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
