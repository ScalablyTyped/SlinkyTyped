...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerCircleShimmerCircleDotTypesMod.IShimmerCircle
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerCircleShimmerCircleDotTypesMod.IShimmerCircleStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerCircleShimmerCircleDotTypesMod.IShimmerCircleStyles
...
abstract class SharedApply_IShimmerCircleProps_1278154878 (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = IShimmerCircleProps
}
