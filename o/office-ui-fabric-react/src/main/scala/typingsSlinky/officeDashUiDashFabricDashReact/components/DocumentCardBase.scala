...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotTypesMod.DocumentCardType
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotTypesMod.IDocumentCard
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotTypesMod.IDocumentCardProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotTypesMod.IDocumentCardStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotTypesMod.IDocumentCardStyles
...
object DocumentCardBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotBaseMod.DocumentCardBase
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotBaseMod.DocumentCardBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
