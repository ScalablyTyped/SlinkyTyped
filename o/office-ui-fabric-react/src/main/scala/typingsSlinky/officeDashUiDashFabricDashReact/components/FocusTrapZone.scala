...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusTrapZoneFocusTrapZoneDotTypesMod.IFocusTrapZone
...
object FocusTrapZone
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libFocusTrapZoneMod.FocusTrapZone
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libFocusTrapZoneMod.FocusTrapZone](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
