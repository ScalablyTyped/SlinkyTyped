...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerDotTypesMod.ILayer
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerDotTypesMod.ILayerProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerDotTypesMod.ILayerStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerDotTypesMod.ILayerStyles
...
object LayerBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerBase] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerDotBaseMod.LayerBase
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLayerLayerDotBaseMod.LayerBase), 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerBase] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libLayerMod.LayerBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ILayerProps
}
