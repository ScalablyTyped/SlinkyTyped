...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusZoneFocusZoneDotTypesMod.FocusZoneDirection
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusZoneFocusZoneDotTypesMod.FocusZoneTabbableElements
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusZoneFocusZoneDotTypesMod.IFocusZone
...
object FocusZone
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusZoneFocusZoneMod.FocusZone
    ] => Unit = null,
    onBeforeFocus: /* childElement */ js.UndefOr[HTMLElement] => Boolean = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusZoneFocusZoneMod.FocusZone), 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libFocusZoneMod.FocusZone] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libFocusZoneMod.FocusZone] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libFocusZoneMod.FocusZone](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IFocusZoneProps
}
