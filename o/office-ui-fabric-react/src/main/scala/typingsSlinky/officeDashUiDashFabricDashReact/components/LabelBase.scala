...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLabelLabelDotTypesMod.ILabel
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLabelLabelDotTypesMod.ILabelProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLabelLabelDotTypesMod.ILabelStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLabelLabelDotTypesMod.ILabelStyles
...
object LabelBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLabelMod.LabelBase] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libLabelMod.LabelBase] = {
