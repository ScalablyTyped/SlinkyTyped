...
abstract class SharedApply_IPeoplePickerItemSelectedProps_469588862 (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    index: Double,
    item: IPersonaProps with Anon_ValidationState,
    about: String = null,
    ...
    onItemChange: (IPersonaProps with Anon_ValidationState, /* index */ Double) => Unit = null,
  ...
  type Props = IPeoplePickerItemSelectedProps
}
