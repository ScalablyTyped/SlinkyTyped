...
abstract class SharedApply_IButtonProps_2021318183[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ComponentRef] = new slinky.core.BuildingComponent[slinky.web.html.a.tag.type, ComponentRef](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
