...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsBreadcrumbBreadcrumbDotTypesMod.IBreadcrumb
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsBreadcrumbBreadcrumbDotTypesMod.IBreadcrumbData
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsBreadcrumbBreadcrumbDotTypesMod.IBreadcrumbItem
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsBreadcrumbBreadcrumbDotTypesMod.IBreadcrumbProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsBreadcrumbBreadcrumbDotTypesMod.IBreadcrumbStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsBreadcrumbBreadcrumbDotTypesMod.IBreadcrumbStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsBreadcrumbBreadcrumbDotTypesMod.IDividerAsProps
...
object BreadcrumbBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libBreadcrumbMod.BreadcrumbBase
    ] {
  ...
  def apply(
    ...
    onRenderItem: (/* props */ js.UndefOr[IBreadcrumbItem], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IBreadcrumbItem], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderOverflowIcon: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
