...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersPeoplePickerPeoplePickerItemsPeoplePickerItemDotTypesMod.IPeoplePickerItemWithMenuProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersPeoplePickerPeoplePickerItemsPeoplePickerItemDotTypesMod.IPersonaWithMenu
...
object SelectedItemWithMenu
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersPeoplePickerPeoplePickerItemsSelectedItemWithMenuMod.SelectedItemWithMenu
    ] {
  ...
  def apply(
    ...
    onItemChange: (IPersonaWithMenu, /* index */ Double) => Unit = null,
  ...
  type Props = IPeoplePickerItemWithMenuProps
}
