...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsButtonButtonDotTypesMod.ButtonType
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsButtonSplitButtonSplitButtonDotClassNamesMod.ISplitButtonClassNames
...
object BaseButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libButtonMod.BaseButton] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLAnchorElement | HTMLButtonElement | HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsButtonBaseButtonMod.BaseButton | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsButtonButtonMod.Button | HTMLSpanElement
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLAnchorElement | HTMLButtonElement | HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsButtonBaseButtonMod.BaseButton | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsButtonButtonMod.Button | HTMLSpanElement), 
      Event
    ] => Unit = null,
    ...
    onRenderAriaDescription: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderChildren: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderDescription: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderIcon: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderMenu: (/* props */ js.UndefOr[IContextualMenuProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IContextualMenuProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderMenuIcon: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderText: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libButtonMod.BaseButton] = {
