...
object ColorSliderBase
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsColorPickerColorSliderColorSliderDotBaseMod.ColorSliderBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
