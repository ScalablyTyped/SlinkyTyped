...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLinkLinkDotTypesMod.ILink
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLinkLinkDotTypesMod.ILinkProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLinkLinkDotTypesMod.ILinkStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLinkLinkDotTypesMod.ILinkStyles
...
object Link
  ...
  def apply(
    ...
    as: String | ReactComponentClass[js.Object] = null,
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLAnchorElement | HTMLButtonElement | HTMLElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLinkLinkDotBaseMod.LinkBase
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLAnchorElement | HTMLButtonElement | HTMLElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsLinkLinkDotBaseMod.LinkBase), 
      Event
    ] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, js.Object] = new slinky.core.BuildingComponent[slinky.web.html.a.tag.type, js.Object](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
