...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsRatingRatingDotTypesMod.IRating
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsRatingRatingDotTypesMod.IRatingProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsRatingRatingDotTypesMod.IRatingStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsRatingRatingDotTypesMod.IRatingStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsRatingRatingDotTypesMod.RatingSize
...
object RatingBase
  ...
  def apply(
    ...
    onChange: (/* event */ SyntheticFocusEvent[HTMLElement], /* rating */ js.UndefOr[Double]) => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libRatingMod.RatingBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libRatingMod.RatingBase] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libRatingMod.RatingBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
