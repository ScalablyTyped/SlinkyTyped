...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardCardCalloutCardCalloutMod.ICardCalloutProps
...
object CardCallout
  ...
  def apply(
    ...
    content: typingsSlinky.react.reactMod._Global_.JSX.Element = null,
