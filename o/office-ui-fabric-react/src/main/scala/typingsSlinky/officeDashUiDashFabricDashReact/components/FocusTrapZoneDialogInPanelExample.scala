...
object FocusTrapZoneDialogInPanelExample
  extends ExternalComponentNoPropsWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusTrapZoneExamplesFocusTrapZoneDotDialogInPanelDotExampleMod.FocusTrapZoneDialogInPanelExample
    ] {
