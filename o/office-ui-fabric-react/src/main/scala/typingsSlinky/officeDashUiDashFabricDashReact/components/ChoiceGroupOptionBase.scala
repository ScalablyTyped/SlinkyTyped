...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsChoiceGroupChoiceGroupOptionChoiceGroupOptionDotTypesMod.IChoiceGroupOptionStyleProps
...
object ChoiceGroupOptionBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsChoiceGroupChoiceGroupOptionChoiceGroupOptionDotBaseMod.ChoiceGroupOptionBase
    ] {
  ...
  type Props = IChoiceGroupOptionProps
}
