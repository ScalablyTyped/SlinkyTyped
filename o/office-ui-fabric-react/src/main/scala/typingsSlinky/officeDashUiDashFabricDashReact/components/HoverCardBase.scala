...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardHoverCardDotTypesMod.HoverCardType
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardHoverCardDotTypesMod.IHoverCard
...
object HoverCardBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libHoverCardMod.HoverCardBase
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libHoverCardMod.HoverCardBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
