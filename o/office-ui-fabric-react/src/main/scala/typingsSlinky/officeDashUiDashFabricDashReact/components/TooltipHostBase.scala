...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotTypesMod.TooltipDelay
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotTypesMod.ITooltipHost
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotTypesMod.ITooltipHostProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotTypesMod.ITooltipHostStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotTypesMod.ITooltipHostStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotTypesMod.TooltipOverflowMode
...
object TooltipHostBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libTooltipMod.TooltipHostBase
    ] {
  ...
  def apply(
    ...
    content: String | typingsSlinky.react.reactMod._Global_.JSX.Element | js.Array[typingsSlinky.react.reactMod._Global_.JSX.Element] = null,
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotBaseMod.TooltipHostBase
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipHostDotBaseMod.TooltipHostBase), 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libTooltipMod.TooltipHostBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
