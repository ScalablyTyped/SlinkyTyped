...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCalendarCalendarDotTypesMod.ICalendar
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCalendarCalendarDotTypesMod.ICalendarProps
...
object Calendar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libCalendarMod.Calendar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libCalendarMod.Calendar] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libCalendarMod.Calendar] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libCalendarMod.Calendar](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
