...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotTypesMod.ITooltip
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotTypesMod.ITooltipProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotTypesMod.ITooltipStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotTypesMod.ITooltipStyles
...
object TooltipBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libTooltipMod.TooltipBase] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotBaseMod.TooltipBase
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLDivElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTooltipTooltipDotBaseMod.TooltipBase), 
      Event
    ] => Unit = null,
    onRenderContent: (/* props */ js.UndefOr[ITooltipProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[ITooltipProps], 
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libTooltipMod.TooltipBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libTooltipMod.TooltipBase] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libTooltipMod.TooltipBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
