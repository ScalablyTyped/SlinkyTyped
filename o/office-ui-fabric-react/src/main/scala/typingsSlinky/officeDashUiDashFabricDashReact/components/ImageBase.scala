...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsImageImageDotTypesMod.IImageStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsImageImageDotTypesMod.IImageStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsImageImageDotTypesMod.ImageCoverStyle
...
object ImageBase
  ...
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libImageMod.ImageBase] = {
    ...
    if (coverStyle != null) __obj.updateDynamic("coverStyle")(coverStyle.asInstanceOf[js.Any])
    if (crossOrigin != null) __obj.updateDynamic("crossOrigin")(crossOrigin.asInstanceOf[js.Any])
    if (datatype != null) __obj.updateDynamic("datatype")(datatype.asInstanceOf[js.Any])
    if (decoding != null) __obj.updateDynamic("decoding")(decoding.asInstanceOf[js.Any])
    if (errorSrc != null) __obj.updateDynamic("errorSrc")(errorSrc.asInstanceOf[js.Any])
