...
object PivotItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotItem] {
  ...
  def apply(
    ...
    onRenderItemLink: (/* props */ js.UndefOr[IPivotItemProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IPivotItemProps], 
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotItem] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotItem] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotItem](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IPivotItemProps
}
