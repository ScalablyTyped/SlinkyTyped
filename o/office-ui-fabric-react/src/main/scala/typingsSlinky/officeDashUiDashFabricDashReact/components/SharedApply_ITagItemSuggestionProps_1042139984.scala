...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersTagPickerTagPickerDotTypesMod.ITagItemSuggestionStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersTagPickerTagPickerDotTypesMod.ITagItemSuggestionStyles
...
abstract class SharedApply_ITagItemSuggestionProps_1042139984 (implicit pw: ExternalPropsWriterProvider)
  ...
  type Props = ITagItemSuggestionProps
}
