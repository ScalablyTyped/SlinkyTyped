...
object ScrollablePaneBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libScrollablePaneMod.ScrollablePaneBase
    ] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[
      HTMLElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsScrollablePaneScrollablePaneDotBaseMod.ScrollablePaneBase
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (HTMLElement | typingsSlinky.officeDashUiDashFabricDashReact.libComponentsScrollablePaneScrollablePaneDotBaseMod.ScrollablePaneBase), 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libScrollablePaneMod.ScrollablePaneBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
