...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListDetailsListDotTypesMod.IDetailsGroupRenderProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListDetailsListDotTypesMod.IDetailsList
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListDetailsListDotTypesMod.IDetailsListCheckboxProps
...
object DetailsListBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libDetailsListMod.DetailsListBase
    ] {
  ...
  def apply(
    ...
    onDidUpdate: /* detailsList */ js.UndefOr[
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListDetailsListDotBaseMod.DetailsListBase
    ] => Unit = null,
    ...
    onRenderDetailsFooter: (/* props */ js.UndefOr[IDetailsFooterProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IDetailsFooterProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderDetailsHeader: (/* props */ js.UndefOr[IDetailsHeaderProps], /* defaultRender */ js.UndefOr[
      js.Function1[
    ...
    onRenderRow: (/* props */ js.UndefOr[IDetailsRowProps], /* defaultRender */ js.UndefOr[
      js.Function1[
