...
object Popup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPopupMod.Popup] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPopupPopupMod.Popup] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPopupPopupMod.Popup, 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPopupMod.Popup] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPopupMod.Popup] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libPopupMod.Popup](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
