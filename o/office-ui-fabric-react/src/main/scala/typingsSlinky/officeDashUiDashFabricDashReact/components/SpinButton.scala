...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSpinButtonSpinButtonDotClassNamesMod.ISpinButtonClassNames
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSpinButtonSpinButtonDotTypesMod.ISpinButton
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSpinButtonSpinButtonDotTypesMod.ISpinButtonProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSpinButtonSpinButtonDotTypesMod.ISpinButtonStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSpinButtonSpinButtonMod.KeyboardSpinDirection
import typingsSlinky.officeDashUiDashFabricDashReact.libUtilitiesPositioningPositioningDotTypesMod.Position
...
object SpinButton
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libSpinButtonMod.SpinButton
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libSpinButtonMod.SpinButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
