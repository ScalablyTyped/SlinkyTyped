...
object PanelBase
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPanelPanelDotBaseMod.PanelBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
