...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFloatingPickerSuggestionsSuggestionsDotTypesMod.ISuggestionsHeaderFooterProps
...
object SuggestionsControl
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libFloatingPickerMod.SuggestionsControl[js.Any]
    ] {
  ...
  def apply[T](
    ...
    onRenderSuggestion: (T, /* suggestionItemProps */ ISuggestionItemProps[T]) => typingsSlinky.react.reactMod._Global_.JSX.Element = null,
