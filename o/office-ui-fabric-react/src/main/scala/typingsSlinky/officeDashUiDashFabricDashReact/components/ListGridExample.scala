...
object ListGridExample
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListExamplesListDotGridDotExampleMod.ListGridExample](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
