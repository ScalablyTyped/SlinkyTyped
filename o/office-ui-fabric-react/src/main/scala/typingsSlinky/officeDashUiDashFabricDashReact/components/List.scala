...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListListDotTypesMod.IList
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListListDotTypesMod.IListProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListListDotTypesMod.IPage
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListListDotTypesMod.IPageProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListListDotTypesMod.IPageSpecification
...
object List
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libListMod.List[js.Any]] {
  ...
  def apply[T](
    ...
    getKey: (T, /* index */ js.UndefOr[Double]) => String = null,
    ...
    onAuxClick: SyntheticMouseEvent[
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListListMod.List[T] | HTMLDivElement
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListListMod.List[T] | HTMLDivElement), 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libListMod.List[js.Any]] = {
