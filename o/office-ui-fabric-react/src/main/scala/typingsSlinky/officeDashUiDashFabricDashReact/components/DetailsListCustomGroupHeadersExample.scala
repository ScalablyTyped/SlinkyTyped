...
object DetailsListCustomGroupHeadersExample
  extends ExternalComponentNoPropsWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListExamplesDetailsListDotCustomGroupHeadersDotExampleMod.DetailsListCustomGroupHeadersExample
    ] {
