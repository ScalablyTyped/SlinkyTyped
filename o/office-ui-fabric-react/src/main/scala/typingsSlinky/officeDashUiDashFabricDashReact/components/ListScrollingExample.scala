...
object ListScrollingExample
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListExamplesListDotScrollingDotExampleMod.ListScrollingExample](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
