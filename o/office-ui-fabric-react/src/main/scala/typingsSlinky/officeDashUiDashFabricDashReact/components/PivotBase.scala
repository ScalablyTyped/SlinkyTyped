...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotTypesMod.IPivot
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotTypesMod.IPivotProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotTypesMod.IPivotStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotTypesMod.IPivotStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotTypesMod.PivotLinkFormat
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotTypesMod.PivotLinkSize
...
object PivotBase
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotBase] {
  ...
  def apply(
    ...
    onLinkClick: (/* item */ js.UndefOr[
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotItemMod.PivotItem
    ], /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]]) => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotBase] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libPivotMod.PivotBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IPivotProps
}
