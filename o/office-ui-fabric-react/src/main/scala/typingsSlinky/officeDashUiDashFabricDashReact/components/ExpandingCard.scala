...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardExpandingCardDotTypesMod.IExpandingCardStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.IBaseCardProps
...
object ExpandingCard
  ...
  def apply(
    ...
    onRenderCompactCard: (/* props */ js.UndefOr[_], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[_], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderExpandedCard: (/* props */ js.UndefOr[_], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[_], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
