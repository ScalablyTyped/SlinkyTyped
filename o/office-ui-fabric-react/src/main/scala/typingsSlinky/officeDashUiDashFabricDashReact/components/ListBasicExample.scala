...
object ListBasicExample
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libComponentsListExamplesListDotBasicDotExampleMod.ListBasicExample](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
