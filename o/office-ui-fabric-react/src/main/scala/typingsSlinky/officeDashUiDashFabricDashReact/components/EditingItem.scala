...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSelectedItemsListSelectedPeopleListItemsEditingItemMod.IEditingSelectedPeopleItemProps
...
object EditingItem
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSelectedItemsListSelectedPeopleListItemsEditingItemMod.EditingItem
    ] {
  ...
  def apply(
    ...
    renderPersonaCoin: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[
      js.Function1[
    ...
    renderPrimaryText: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IPersonaProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ...
    val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], onCopyItem = js.Any.fromFunction1(onCopyItem), onEditingComplete = js.Any.fromFunction2(onEditingComplete))
  ...
  type Props = IEditingSelectedPeopleItemProps
}
