...
object CheckboxBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libCheckboxMod.CheckboxBase
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libCheckboxMod.CheckboxBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
