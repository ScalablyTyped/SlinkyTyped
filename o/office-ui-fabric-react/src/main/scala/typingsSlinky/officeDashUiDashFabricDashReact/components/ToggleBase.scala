...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsToggleToggleDotTypesMod.IToggleStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsToggleToggleDotTypesMod.IToggleStyles
import typingsSlinky.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.checkbox
import typingsSlinky.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.switch
...
object ToggleBase
  ...
  def apply(
    ...
    label: String | typingsSlinky.react.reactMod._Global_.JSX.Element = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libToggleMod.ToggleBase] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.officeDashUiDashFabricDashReact.libToggleMod.ToggleBase] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.officeDashUiDashFabricDashReact.libToggleMod.ToggleBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
