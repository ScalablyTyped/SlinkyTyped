...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupResizeGroupDotTypesMod.IResizeGroup
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupResizeGroupDotTypesMod.IResizeGroupProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupResizeGroupDotTypesMod.IResizeGroupStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupResizeGroupDotTypesMod.IResizeGroupStyles
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupResizeGroupDotTypesMod.ResizeGroupDirection
...
object ResizeGroupBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libResizeGroupMod.ResizeGroupBase
    ] {
  ...
  def apply(
    ...
    onRenderData: js.Any => typingsSlinky.react.reactMod._Global_.JSX.Element,
    about: String = null,
    ...
    onAuxClick: SyntheticMouseEvent[
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupResizeGroupDotBaseMod.ResizeGroupBase | HTMLElement
    ] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with (typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupResizeGroupDotBaseMod.ResizeGroupBase | HTMLElement), 
      Event
    ] => Unit = null,
