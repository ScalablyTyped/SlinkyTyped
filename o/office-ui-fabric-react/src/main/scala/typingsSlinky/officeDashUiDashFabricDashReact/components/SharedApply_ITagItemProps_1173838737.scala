...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersPickerItemDotTypesMod.IPickerItem
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersTagPickerTagPickerDotTypesMod.ITagItemStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersTagPickerTagPickerDotTypesMod.ITagItemStyles
...
abstract class SharedApply_ITagItemProps_1173838737 (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    onItemChange: (ITag, /* index */ Double) => Unit = null,
