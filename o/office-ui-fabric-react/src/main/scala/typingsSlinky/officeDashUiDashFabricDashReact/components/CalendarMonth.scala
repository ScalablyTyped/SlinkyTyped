...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCalendarCalendarMonthMod.ICalendarMonth
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCalendarCalendarMonthMod.ICalendarMonthProps
...
object CalendarMonth
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCalendarCalendarMonthMod.CalendarMonth
    ] {
