...
object DialogFooterBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libDialogMod.DialogFooterBase
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libDialogMod.DialogFooterBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
