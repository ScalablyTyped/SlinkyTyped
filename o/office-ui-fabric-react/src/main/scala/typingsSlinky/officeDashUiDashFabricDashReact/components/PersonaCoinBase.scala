...
object PersonaCoinBase
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.officeDashUiDashFabricDashReact.libPersonaMod.PersonaCoinBase
    ] {
  ...
  typingsSlinky.officeDashUiDashFabricDashReact.libPersonaMod.PersonaCoinBase](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
