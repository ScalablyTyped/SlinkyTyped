...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTextFieldTextFieldDotTypesMod.ITextField
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTextFieldTextFieldDotTypesMod.ITextFieldProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTextFieldTextFieldDotTypesMod.ITextFieldStyleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTextFieldTextFieldDotTypesMod.ITextFieldStyles
...
abstract class SharedApply_ITextFieldProps_1436080444[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    encType: String = null,
    errorMessage: String | typingsSlinky.react.reactMod._Global_.JSX.Element = null,
    form: String = null,
    ...
    onAuxClick: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event] => Unit = null,
    onChange: (/* event */ FormEvent[HTMLInputElement | HTMLTextAreaElement], /* newValue */ js.UndefOr[String]) => Unit = null,
    onGetErrorMessage: /* value */ String => js.UndefOr[
      String | typingsSlinky.react.reactMod._Global_.JSX.Element | (js.Thenable[String | typingsSlinky.react.reactMod._Global_.JSX.Element])
    ] = null,
    onNotifyValidationResult: (/* errorMessage */ String | typingsSlinky.react.reactMod._Global_.JSX.Element, /* value */ js.UndefOr[String]) => Unit = null,
    onRenderDescription: (/* props */ js.UndefOr[ITextFieldProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[ITextFieldProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderLabel: (/* props */ js.UndefOr[ITextFieldProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[ITextFieldProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderPrefix: (/* props */ js.UndefOr[ITextFieldProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[ITextFieldProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onRenderSuffix: (/* props */ js.UndefOr[ITextFieldProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[ITextFieldProps], 
        typingsSlinky.react.reactMod._Global_.JSX.Element | Null
      ]
    ]) => typingsSlinky.react.reactMod._Global_.JSX.Element | Null = null,
    onReset: SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event] => Unit = null,
