package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsExtendedPickerBaseExtendedPickerDotTypesMod
...
trait IBaseExtendedPickerProps[T] extends js.Object {
  ...
  /**
    ...
    */
  var onRenderFloatingPicker: ReactComponentClass[IBaseFloatingPickerProps[T]]
  /**
    * Function that specifies how the floating picker will appear.
    */
  var onRenderSelectedItems: ReactComponentClass[IBaseSelectedItemsListProps[T]]
  /**
...
object IBaseExtendedPickerProps {
  ...
  def apply[T](
    ...
    onBlur: SyntheticFocusEvent[HTMLInputElement | Autofill] => Unit = null,
    onChange: /* items */ js.UndefOr[js.Array[T]] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLInputElement | Autofill] => Unit = null,
