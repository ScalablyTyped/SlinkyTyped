...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotBaseMod.PivotBase
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotItemMod.PivotItem
...
object IPivotProps {
  ...
  def apply(
    ...
    onLinkClick: (/* item */ js.UndefOr[PivotItem], /* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]]) => Unit = null,
