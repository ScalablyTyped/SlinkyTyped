...
import typingsSlinky.officeDashUiDashFabricDashReact.libUtilitiesDecoratorsWithResponsiveModeMod.IWithResponsiveModeState
...
trait IContextualMenuProps
  ...
  var directionalHint: js.UndefOr[
    typingsSlinky.officeDashUiDashFabricDashReact.libCommonDirectionalHintMod.DirectionalHint
  ] = js.undefined
  /**
...
object IContextualMenuProps {
  ...
  def apply(
    ...
    directionalHint: typingsSlinky.officeDashUiDashFabricDashReact.libCommonDirectionalHintMod.DirectionalHint = null,
    directionalHintFixed: js.UndefOr[Boolean] = js.undefined,
    directionalHintForRTL: typingsSlinky.officeDashUiDashFabricDashReact.libCommonDirectionalHintMod.DirectionalHint = null,
    ...
    onDismiss: (/* ev */ js.UndefOr[SyntheticMouseEvent[Element] | SyntheticKeyboardEvent[Element]], /* dismissAll */ js.UndefOr[Boolean]) => Unit = null,
