package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsActivityItemActivityItemDotClassNamesMod

import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsActivityItemActivityItemDotTypesMod.IActivityItemStyles
