...
@js.native
object libComponentsDialogMod extends js.Object {
  @js.native
  class DialogBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDialogDialogDotBaseMod.DialogBase {
    def this(props: IDialogProps) = this()
  }
  
  @js.native
  class DialogContentBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDialogDialogContentDotBaseMod.DialogContentBase {
