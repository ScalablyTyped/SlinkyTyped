package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsResizeGroupExamplesResizeGroupDotOverflowSetDotExampleMod
...
trait IResizeGroupOverflowSetExampleState extends js.Object {
  var buttonsChecked: Boolean
  var cachingEnabled: Boolean
  var numberOfItems: Double
  var onGrowDataEnabled: Boolean
  var short: Boolean
}
