package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCommandBarCommandBarDotBaseMod

import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCommandBarCommandBarDotTypesMod.ICommandBarItemProps
