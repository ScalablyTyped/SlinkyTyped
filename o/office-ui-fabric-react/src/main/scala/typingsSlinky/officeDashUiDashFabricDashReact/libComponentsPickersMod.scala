...
object libComponentsPickersMod extends js.Object {
  ...
  class Autofill protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersAutoFillBaseAutoFillMod.Autofill {
  ...
  class BasePicker[T, P /* <: IBasePickerProps[T] */] protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersBasePickerMod.BasePicker[T, P] {
  ...
  class CompactPeoplePickerBase ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersPeoplePickerPeoplePickerMod.CompactPeoplePickerBase
  
  @js.native
  class ListPeoplePickerBase ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersPeoplePickerPeoplePickerMod.ListPeoplePickerBase
  ...
  class NormalPeoplePickerBase ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersPeoplePickerPeoplePickerMod.NormalPeoplePickerBase
  
  @js.native
  class Suggestions[T] protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersSuggestionsSuggestionsMod.Suggestions[T] {
    def this(suggestionsProps: ISuggestionsProps[T]) = this()
  }
  
  @js.native
  class SuggestionsController[T] ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersSuggestionsSuggestionsControllerMod.SuggestionsController[T]
  ...
  @js.native
  class TagPickerBase ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersTagPickerTagPickerMod.TagPickerBase
