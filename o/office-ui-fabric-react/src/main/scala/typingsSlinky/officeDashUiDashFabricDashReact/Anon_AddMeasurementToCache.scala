...
trait Anon_AddMeasurementToCache extends js.Object {
  /**
...
object Anon_AddMeasurementToCache {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Anon_AddMeasurementToCache]
  }
}
