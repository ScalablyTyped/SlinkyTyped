...
object libFacepileMod extends js.Object {
  ...
  class FacepileBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFacepileMod.FacepileBase {
  ...
  object OverflowButtonType extends js.Object {
    ...
    def apply(value: Double): js.UndefOr[
        typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFacepileFacepileDotTypesMod.OverflowButtonType with Double
      ] = js.native
  }
