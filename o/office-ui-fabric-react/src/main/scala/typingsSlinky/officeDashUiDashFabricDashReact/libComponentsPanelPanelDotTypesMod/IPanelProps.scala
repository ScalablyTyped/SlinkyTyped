...
trait IPanelProps extends HTMLAttributes[PanelBase] {
  ...
  /**
    ...
    */
  var onDismiss: js.UndefOr[js.Function1[/* ev */ js.UndefOr[SyntheticEvent[Event, HTMLElement]], Unit]] = js.undefined
  /**
...
object IPanelProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event, PanelBase] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with PanelBase, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[PanelBase] => Unit = null,
    onCanPlay: SyntheticEvent[Event, PanelBase] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, PanelBase] => Unit = null,
    onChange: SyntheticEvent[EventTarget with PanelBase, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, PanelBase] => Unit = null,
    onEmptied: SyntheticEvent[Event, PanelBase] => Unit = null,
    onEncrypted: SyntheticEvent[Event, PanelBase] => Unit = null,
    onEnded: SyntheticEvent[Event, PanelBase] => Unit = null,
    onError: SyntheticEvent[Event, PanelBase] => Unit = null,
    onFocus: SyntheticFocusEvent[PanelBase] => Unit = null,
    onInput: SyntheticEvent[EventTarget with PanelBase, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with PanelBase, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, PanelBase] => Unit = null,
    onLoadStart: SyntheticEvent[Event, PanelBase] => Unit = null,
    onLoadedData: SyntheticEvent[Event, PanelBase] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, PanelBase] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, PanelBase] => Unit = null,
    onPlay: SyntheticEvent[Event, PanelBase] => Unit = null,
    onPlaying: SyntheticEvent[Event, PanelBase] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, PanelBase] => Unit = null,
    onRateChange: SyntheticEvent[Event, PanelBase] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with PanelBase, Event] => Unit = null,
    onScroll: SyntheticUIEvent[PanelBase] => Unit = null,
    onSeeked: SyntheticEvent[Event, PanelBase] => Unit = null,
    onSeeking: SyntheticEvent[Event, PanelBase] => Unit = null,
    onSelect: SyntheticEvent[Event, PanelBase] => Unit = null,
    onStalled: SyntheticEvent[Event, PanelBase] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with PanelBase, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, PanelBase] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, PanelBase] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, PanelBase] => Unit = null,
    onWaiting: SyntheticEvent[Event, PanelBase] => Unit = null,
