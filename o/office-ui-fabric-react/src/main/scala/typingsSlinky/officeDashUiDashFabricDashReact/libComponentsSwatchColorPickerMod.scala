...
object libComponentsSwatchColorPickerMod extends js.Object {
  ...
  class ColorPickerGridCellBase ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSwatchColorPickerColorPickerGridCellDotBaseMod.ColorPickerGridCellBase
  
  @js.native
  class SwatchColorPickerBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSwatchColorPickerSwatchColorPickerDotBaseMod.SwatchColorPickerBase {
