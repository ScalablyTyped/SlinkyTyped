...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDialogDialogContentDotBaseMod.DialogContentBase
...
trait IDialogContentProps extends ClassAttributes[DialogContentBase] {
  ...
  /**
    ...
    */
  var onDismiss: js.UndefOr[js.Function1[/* ev */ js.UndefOr[SyntheticMouseEvent[HTMLButtonElement]], _]] = js.undefined
  /**
