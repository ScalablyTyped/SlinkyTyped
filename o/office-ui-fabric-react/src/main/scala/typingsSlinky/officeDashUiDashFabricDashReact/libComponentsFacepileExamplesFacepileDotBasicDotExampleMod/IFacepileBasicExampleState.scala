package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFacepileExamplesFacepileDotBasicDotExampleMod
...
trait IFacepileBasicExampleState extends js.Object {
  var imagesFadeIn: Boolean
  var numberOfFaces: js.Any
  var personaSize: PersonaSize
}
