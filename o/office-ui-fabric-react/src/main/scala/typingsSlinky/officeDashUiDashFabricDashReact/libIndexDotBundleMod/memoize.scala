...
@JSImport("office-ui-fabric-react/lib/index.bundle", "memoize")
@js.native
object memoize extends js.Object {
  def apply[T /* <: js.Function */](target: js.Any, key: String, descriptor: TypedPropertyDescriptor[T]): Anon_Configurable[T] = js.native
}
