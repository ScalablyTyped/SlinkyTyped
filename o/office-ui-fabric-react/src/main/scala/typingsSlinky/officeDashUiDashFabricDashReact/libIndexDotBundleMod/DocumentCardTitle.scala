...
@JSImport("office-ui-fabric-react/lib/index.bundle", "DocumentCardTitle")
@js.native
object DocumentCardTitle extends TopLevel[StatelessComponent[IDocumentCardTitleProps]]
