...
@JSImport("office-ui-fabric-react/lib/components/Check", JSImport.Namespace)
@js.native
object libComponentsCheckMod extends js.Object {
  val Check: ReactComponentClass[ICheckProps] = js.native
  val CheckBase: ReactComponentClass[ICheckProps] = js.native
