...
@js.native
object libComponentsStackStackUtilsMod extends js.Object {
  def parseGap(gap: js.UndefOr[scala.Nothing], theme: ITheme): Anon_ColumnGap = js.native
  def parseGap(gap: String, theme: ITheme): Anon_ColumnGap = js.native
  def parseGap(gap: Double, theme: ITheme): Anon_ColumnGap = js.native
