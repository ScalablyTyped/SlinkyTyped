...
import typingsSlinky.officeDashUiDashFabricDashReact.Anon_Key
...
@JSImport("office-ui-fabric-react", "createGenericItem")
@js.native
object createGenericItem extends js.Object {
  def apply(
    name: String,
    currentValidationState: typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPickersBasePickerDotTypesMod.ValidationState
