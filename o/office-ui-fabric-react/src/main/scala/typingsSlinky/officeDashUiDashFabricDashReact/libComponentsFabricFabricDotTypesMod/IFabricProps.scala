package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFabricFabricDotTypesMod
...
import typingsSlinky.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.ltr
import typingsSlinky.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.rtl
...
object IFabricProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(applyThemeToBody)) __obj.updateDynamic("applyThemeToBody")(applyThemeToBody.asInstanceOf[js.Any])
