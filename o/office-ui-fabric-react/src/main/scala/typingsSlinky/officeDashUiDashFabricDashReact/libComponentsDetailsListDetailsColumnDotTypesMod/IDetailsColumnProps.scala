...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListDetailsColumnDotBaseMod.DetailsColumnBase
...
trait IDetailsColumnProps extends ClassAttributes[DetailsColumnBase] {
  ...
  var updateDragInfo: js.UndefOr[
    js.Function2[/* props */ Anon_ItemIndex, /* event */ js.UndefOr[MouseEvent], Unit]
  ] = js.undefined
  /**
