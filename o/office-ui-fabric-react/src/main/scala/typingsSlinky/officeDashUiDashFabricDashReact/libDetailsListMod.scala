...
object libDetailsListMod extends js.Object {
  ...
  class DetailsColumnBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.DetailsColumnBase {
    def this(props: IDetailsColumnProps) = this()
  }
  
  @js.native
  class DetailsHeaderBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.DetailsHeaderBase {
    def this(props: IDetailsHeaderBaseProps) = this()
  }
  
  @js.native
  class DetailsListBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.DetailsListBase {
    def this(props: IDetailsListProps) = this()
  }
  
  @js.native
  class DetailsRowBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.DetailsRowBase {
    def this(props: IDetailsRowBaseProps) = this()
  }
  
  @js.native
  class Selection ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.Selection {
