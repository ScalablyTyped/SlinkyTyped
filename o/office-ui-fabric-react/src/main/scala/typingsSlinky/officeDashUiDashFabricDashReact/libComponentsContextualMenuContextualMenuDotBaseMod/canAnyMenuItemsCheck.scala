package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsContextualMenuContextualMenuDotBaseMod
...
@js.native
object canAnyMenuItemsCheck extends js.Object {
  def apply(items: js.Array[IContextualMenuItem]): Boolean = js.native
}
