package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardCardCalloutCardCalloutMod
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardBaseCardDotTypesMod.IBaseCardProps
...
object ICardCalloutProps {
  ...
  {[ P in keyof TStyles ]: @uifabric/merge-styles.@uifabric/merge-styles/lib/IStyle.IStyle}
    */ typingsSlinky.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.IBaseCardProps with js.Any
    ] = null,
