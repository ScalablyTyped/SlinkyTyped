...
import typingsSlinky.officeDashUiDashFabricDashReact.libCommonIAccessiblePopupPropsMod.IAccessiblePopupProps
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDialogDialogDotBaseMod.DialogBase
