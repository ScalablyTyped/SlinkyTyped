...
object libHoverCardMod extends js.Object {
  ...
  class ExpandingCardBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardMod.ExpandingCardBase {
    def this(props: IExpandingCardProps) = this()
  }
  
  @js.native
  class HoverCardBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsHoverCardMod.HoverCardBase {
