package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusTrapZoneExamplesFocusTrapZoneDotNestedDotExampleMod
...
trait IFocusTrapZoneNestedExampleState extends js.Object {
  var activeStates: NumberDictionary[Boolean]
}
