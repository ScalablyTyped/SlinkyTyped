package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsFocusTrapZoneFocusTrapZoneDotTypesMod
...
object IFocusTrapZoneProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableFirstFocus)) __obj.updateDynamic("disableFirstFocus")(disableFirstFocus.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(focusPreviouslyFocusedInnerElement)) __obj.updateDynamic("focusPreviouslyFocusedInnerElement")(focusPreviouslyFocusedInnerElement.asInstanceOf[js.Any])
