...
import typingsSlinky.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.`ms-Fabric--isFocusVisible`
...
object libUtilitiesMod extends js.Object {
  @js.native
  class Async ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.Async {
  ...
  class AutoScroll protected ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.AutoScroll {
    def this(element: HTMLElement) = this()
  }
  
  @js.native
  class BaseComponent[TProps /* <: IBaseProps[_] */, TState] protected ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.BaseComponent[TProps, TState] {
    /**
  ...
  class Customizations ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.Customizations
  ...
  class DelayedRender protected ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.DelayedRender {
    def this(props: IDelayedRenderProps) = this()
  }
  
  @js.native
  class EventGroup protected ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.EventGroup {
  ...
  class FabricPerformance ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.FabricPerformance
  
  @js.native
  class GlobalSettings ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.GlobalSettings
  
  @js.native
  class Rectangle ()
    extends typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.Rectangle {
