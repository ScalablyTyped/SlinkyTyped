...
@js.native
object libComponentsPivotMod extends js.Object {
  @js.native
  class PivotBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotDotBaseMod.PivotBase {
    def this(props: IPivotProps) = this()
  }
  
  @js.native
  class PivotItem protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsPivotPivotItemMod.PivotItem {
