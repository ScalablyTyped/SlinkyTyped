package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsAnnouncedExamplesAnnouncedDotSearchResultsDotExampleMod
...
trait IAnnouncedSearchResultsExampleState extends js.Object {
  var emptyInput: Boolean
  var numberOfSuggestions: Double
  var seconds: Double
}
