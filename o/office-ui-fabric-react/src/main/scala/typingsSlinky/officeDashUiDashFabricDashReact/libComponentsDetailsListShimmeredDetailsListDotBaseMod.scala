...
@JSImport("office-ui-fabric-react/lib/components/DetailsList/ShimmeredDetailsList.base", JSImport.Namespace)
@js.native
object libComponentsDetailsListShimmeredDetailsListDotBaseMod extends js.Object {
  @js.native
