package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDropdownDropdownDotTypesMod
...
trait IDropdownProps extends ISelectableDroppableTextProps[IDropdown, HTMLDivElement] {
  ...
  var onChange_IDropdownProps: js.UndefOr[
    js.Function3[
      /* event */ FormEvent[org.scalajs.dom.raw.HTMLDivElement], 
  ...
  var responsiveMode: js.UndefOr[
    typingsSlinky.officeDashUiDashFabricDashReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode
  ] = js.undefined
  /**
...
object IDropdownProps {
  ...
  def apply(
    ...
    color: String = null,
    componentRef: IRefObject[IDropdown] = null,
    ...
    onAbort: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with org.scalajs.dom.raw.HTMLDivElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onChange: (/* event */ FormEvent[org.scalajs.dom.raw.HTMLDivElement], /* option */ js.UndefOr[IDropdownOption], /* index */ js.UndefOr[Double]) => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onEnded: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onError: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onFocus: SyntheticFocusEvent[org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with org.scalajs.dom.raw.HTMLDivElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with org.scalajs.dom.raw.HTMLDivElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onPlay: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    ...
    onRenderContainer: (/* props */ js.UndefOr[ISelectableDroppableTextProps[IDropdown, org.scalajs.dom.raw.HTMLDivElement]], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[ISelectableDroppableTextProps[IDropdown, org.scalajs.dom.raw.HTMLDivElement]], 
        Element | Null
      ]
    ]) => Element | Null = null,
    ...
    onRenderList: (/* props */ js.UndefOr[ISelectableDroppableTextProps[IDropdown, org.scalajs.dom.raw.HTMLDivElement]], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[ISelectableDroppableTextProps[IDropdown, org.scalajs.dom.raw.HTMLDivElement]], 
        Element | Null
      ]
    ...
    onReset: SyntheticEvent[EventTarget with org.scalajs.dom.raw.HTMLDivElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onSelect: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onStalled: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with org.scalajs.dom.raw.HTMLDivElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
    ...
    responsiveMode: typingsSlinky.officeDashUiDashFabricDashReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = null,
    ...
    if (multiSelectDelimiter != null) __obj.updateDynamic("multiSelectDelimiter")(multiSelectDelimiter.asInstanceOf[js.Any])
    if (!js.isUndefined(notifyOnReselect)) __obj.updateDynamic("notifyOnReselect")(notifyOnReselect.asInstanceOf[js.Any])
