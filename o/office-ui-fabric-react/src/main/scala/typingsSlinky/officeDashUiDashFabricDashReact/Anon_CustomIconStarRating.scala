...
trait Anon_CustomIconStarRating extends js.Object {
...
object Anon_CustomIconStarRating {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_CustomIconStarRating]
  }
}
