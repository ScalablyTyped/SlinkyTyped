...
object libSelectedItemsListMod extends js.Object {
  ...
  class BaseSelectedItemsList[T, P /* <: IBaseSelectedItemsListProps[T] */] protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSelectedItemsListMod.BaseSelectedItemsList[T, P] {
    def this(basePickerProps: P) = this()
  }
  
  @js.native
  class ExtendedSelectedItem protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSelectedItemsListMod.ExtendedSelectedItem {
    def this(props: ISelectedPeopleItemProps) = this()
  }
  
  @js.native
  class SelectedPeopleList ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsSelectedItemsListMod.SelectedPeopleList
