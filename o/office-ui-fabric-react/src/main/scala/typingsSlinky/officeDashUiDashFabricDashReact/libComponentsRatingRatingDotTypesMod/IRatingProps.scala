...
trait IRatingProps extends AllHTMLAttributes[HTMLElement] {
  ...
  var onChange_IRatingProps: js.UndefOr[
    js.Function2[
      /* event */ SyntheticFocusEvent[org.scalajs.dom.raw.HTMLElement], 
...
object IRatingProps {
  ...
  def apply(
    ...
    max: Int | Double = null,
    min: Int | Double = null,
    onChange: (/* event */ SyntheticFocusEvent[org.scalajs.dom.raw.HTMLElement], /* rating */ js.UndefOr[Double]) => Unit = null,
