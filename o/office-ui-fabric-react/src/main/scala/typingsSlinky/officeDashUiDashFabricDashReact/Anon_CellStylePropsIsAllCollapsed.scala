...
trait Anon_CellStylePropsIsAllCollapsed extends js.Object {
...
object Anon_CellStylePropsIsAllCollapsed {
  @scala.inline
  def apply(
  ...
  ): Anon_CellStylePropsIsAllCollapsed = {
    ...
    __obj.asInstanceOf[Anon_CellStylePropsIsAllCollapsed]
  }
}
