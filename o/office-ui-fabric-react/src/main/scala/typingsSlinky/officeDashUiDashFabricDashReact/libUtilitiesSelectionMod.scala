...
object libUtilitiesSelectionMod extends js.Object {
  @js.native
  class Selection ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libUtilitiesSelectionSelectionMod.Selection {
    def this(options: ISelectionOptions) = this()
  }
  
  @js.native
  class SelectionZone protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libUtilitiesSelectionSelectionZoneMod.SelectionZone {
