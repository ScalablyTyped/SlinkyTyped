package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardLocationDotTypesMod
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardLocationDotBaseMod.DocumentCardLocationBase
...
trait IDocumentCardLocationProps extends ClassAttributes[DocumentCardLocationBase] {
  ...
  /**
    ...
    */
  var onClick: js.UndefOr[js.Function1[/* ev */ js.UndefOr[SyntheticMouseEvent[HTMLElement]], Unit]] = js.undefined
  /**
