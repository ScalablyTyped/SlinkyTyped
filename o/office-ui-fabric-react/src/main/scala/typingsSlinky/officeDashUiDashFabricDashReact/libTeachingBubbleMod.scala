...
object libTeachingBubbleMod extends js.Object {
  ...
  class TeachingBubbleBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTeachingBubbleMod.TeachingBubbleBase {
    def this(props: ITeachingBubbleProps) = this()
  }
  
  @js.native
  class TeachingBubbleContentBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTeachingBubbleMod.TeachingBubbleContentBase {
    def this(props: ITeachingBubbleProps) = this()
  }
