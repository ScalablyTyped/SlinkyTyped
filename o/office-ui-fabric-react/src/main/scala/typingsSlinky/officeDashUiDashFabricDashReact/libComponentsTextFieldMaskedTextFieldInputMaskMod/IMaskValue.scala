package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTextFieldMaskedTextFieldInputMaskMod
...
object IMaskValue {
  @scala.inline
  def apply(displayIndex: Double, format: js.RegExp, value: String = null): IMaskValue = {
