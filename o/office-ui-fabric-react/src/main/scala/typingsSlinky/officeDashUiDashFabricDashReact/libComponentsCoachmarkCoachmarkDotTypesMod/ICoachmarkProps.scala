package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCoachmarkCoachmarkDotTypesMod
...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCoachmarkCoachmarkDotBaseMod.CoachmarkBase
