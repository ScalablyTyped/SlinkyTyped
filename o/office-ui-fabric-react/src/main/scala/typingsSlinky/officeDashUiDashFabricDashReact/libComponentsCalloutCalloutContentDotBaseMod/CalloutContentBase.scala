package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsCalloutCalloutContentDotBaseMod

import org.scalajs.dom.raw.Event
import typingsSlinky.officeDashUiDashFabricDashReact.Anon_7
...
class CalloutContentBase protected ()
  ...
  def dismiss(ev: typingsSlinky.react.reactMod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
  def dismiss(ev: typingsSlinky.std.Event): Unit = js.native
...
object CalloutContentBase extends js.Object {
  var defaultProps: Anon_7 = js.native
}
