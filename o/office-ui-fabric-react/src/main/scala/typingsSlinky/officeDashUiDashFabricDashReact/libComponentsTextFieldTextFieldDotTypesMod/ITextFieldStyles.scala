package typingsSlinky.officeDashUiDashFabricDashReact.libComponentsTextFieldTextFieldDotTypesMod
...
@js.native
trait ITextFieldStyles extends IStyleSet[ITextFieldStyles] {
  /**
  ...
  /**
    ...
    */
  @JSName("subComponentStyles")
  var subComponentStyles_ITextFieldStyles: ITextFieldSubComponentStyles = js.native
  /**
