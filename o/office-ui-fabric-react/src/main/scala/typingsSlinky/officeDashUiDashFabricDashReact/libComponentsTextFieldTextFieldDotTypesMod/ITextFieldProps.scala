...
trait ITextFieldProps extends AllHTMLAttributes[HTMLInputElement | HTMLTextAreaElement] {
  ...
  var onChange_ITextFieldProps: js.UndefOr[
    js.Function2[
      /* event */ FormEvent[org.scalajs.dom.raw.HTMLInputElement | org.scalajs.dom.raw.HTMLTextAreaElement], 
...
object ITextFieldProps {
  ...
  def apply(
    ...
    onChange: (/* event */ FormEvent[org.scalajs.dom.raw.HTMLInputElement | org.scalajs.dom.raw.HTMLTextAreaElement], /* newValue */ js.UndefOr[String]) => Unit = null,
