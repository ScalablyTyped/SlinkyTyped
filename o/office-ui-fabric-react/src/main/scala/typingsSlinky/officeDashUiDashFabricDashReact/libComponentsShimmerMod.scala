...
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerCircleShimmerCircleDotTypesMod.IShimmerCircleProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerDotTypesMod.IShimmerProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerElementsGroupShimmerElementsGroupDotTypesMod.IShimmerElementsGroupProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerGapShimmerGapDotTypesMod.IShimmerGapProps
import typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerLineShimmerLineDotTypesMod.IShimmerLineProps
...
@js.native
object libComponentsShimmerMod extends js.Object {
  @js.native
  class ShimmerBase protected ()
    extends typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerDotBaseMod.ShimmerBase {
  ...
  object ShimmerElementsDefaultHeights extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.officeDashUiDashFabricDashReact.libComponentsShimmerShimmerDotTypesMod.ShimmerElementsDefaultHeights with Double
      ] = js.native
  }
