...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fluentui__date-time-utilities" % "7.9.0-d77152",
  "org.scalablytyped.slinky" %%% "fluentui__dom-utilities" % "1.1.1-f54b85",
  "org.scalablytyped.slinky" %%% "fluentui__react-focus" % "7.16.18-0b5fe1",
  "org.scalablytyped.slinky" %%% "fluentui__react-window-provider" % "1.0.1-5bf610",
  ...
  "org.scalablytyped.slinky" %%% "uifabric__foundation" % "7.9.20-154ba2",
  "org.scalablytyped.slinky" %%% "uifabric__icons" % "7.5.17-f0f50a",
  "org.scalablytyped.slinky" %%% "uifabric__merge-styles" % "7.19.1-2fb0f9",
  "org.scalablytyped.slinky" %%% "uifabric__react-hooks" % "7.13.9-57c2e7",
