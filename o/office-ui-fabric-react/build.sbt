...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fluentui__date-time-utilities" % "7.3.0-422456",
  "org.scalablytyped.slinky" %%% "fluentui__react-focus" % "7.12.26-72ab5f",
  ...
  "org.scalablytyped.slinky" %%% "uifabric__foundation" % "7.7.40-a1a742",
  "org.scalablytyped.slinky" %%% "uifabric__icons" % "7.3.66-174c22",
