...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fluentui__date-time-utilities" % "7.9.0-e1bba2",
  "org.scalablytyped.slinky" %%% "fluentui__dom-utilities" % "1.1.1-34d1ca",
  "org.scalablytyped.slinky" %%% "fluentui__react-focus" % "7.16.18-3802da",
  "org.scalablytyped.slinky" %%% "fluentui__react-window-provider" % "1.0.1-90ed1f",
  ...
  "org.scalablytyped.slinky" %%% "uifabric__foundation" % "7.9.20-e78952",
  "org.scalablytyped.slinky" %%% "uifabric__icons" % "7.5.17-bd78f6",
  "org.scalablytyped.slinky" %%% "uifabric__merge-styles" % "7.19.1-fe3810",
  "org.scalablytyped.slinky" %%% "uifabric__react-hooks" % "7.13.9-0dc126",
