...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fluentui__date-time-utilities" % "7.3.0-f0277a",
  "org.scalablytyped.slinky" %%% "fluentui__react-focus" % "7.12.26-78e706",
  ...
  "org.scalablytyped.slinky" %%% "uifabric__foundation" % "7.7.40-bdce01",
  "org.scalablytyped.slinky" %%% "uifabric__icons" % "7.3.66-5f2a2a",
