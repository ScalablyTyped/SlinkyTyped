package typingsSlinky.openlayers.openlayersMod.style

import typingsSlinky.openlayers.openlayersMod.Color
import typingsSlinky.openlayers.openlayersMod.olx.style.StrokeOptions
...
class Stroke () extends js.Object {
  ...
  /**
    ...
    * @api
    */
  def getColor(): Color | String = js.native
  /**
