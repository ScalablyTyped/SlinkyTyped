...
import typingsSlinky.openlayers.openlayersMod.olx.format.EsriJSONOptions
...
class EsriJSON () extends JSONFeature {
  ...
  /**
    ...
    * @api
    */
  def readFeature(source: ArrayBuffer): typingsSlinky.openlayers.openlayersMod.Feature = js.native
  def readFeature(source: ArrayBuffer, opt_options: ReadOptions): typingsSlinky.openlayers.openlayersMod.Feature = js.native
  ...
  /**
    ...
    * @api
    */
  def writeFeatureObject(feature: typingsSlinky.openlayers.openlayersMod.Feature): GlobalObject = js.native
  def writeFeatureObject(feature: typingsSlinky.openlayers.openlayersMod.Feature, opt_options: WriteOptions): GlobalObject = js.native
  /**
  ...
  /**
    ...
    * @api
    */
  def writeFeaturesObject(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature]): GlobalObject = js.native
  def writeFeaturesObject(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature], opt_options: WriteOptions): GlobalObject = js.native
  /**
