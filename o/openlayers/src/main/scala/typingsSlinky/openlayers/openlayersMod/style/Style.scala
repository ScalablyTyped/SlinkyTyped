...
import typingsSlinky.openlayers.openlayersMod.olx.style.StyleOptions
...
class Style () extends js.Object {
  ...
  /**
    ...
    * @api
    */
  def getImage(): typingsSlinky.openlayers.openlayersMod.style.Image = js.native
  /**
  ...
  /**
    ...
    * @api
    */
  def setImage(image: typingsSlinky.openlayers.openlayersMod.style.Image): Unit = js.native
  /**
