...
trait DefaultsOptions extends js.Object {
  ...
  var attributionOptions: js.UndefOr[typingsSlinky.openlayers.openlayersMod.olx.control.AttributionOptions] = js.undefined
...
object DefaultsOptions {
  ...
  def apply(
    ...
    attributionOptions: typingsSlinky.openlayers.openlayersMod.olx.control.AttributionOptions = null,
