...
package object openlayersMod {
  ...
  type Color = (js.Tuple4[Double, Double, Double, Double]) | scala.scalajs.js.typedarray.Uint8Array | scala.scalajs.js.typedarray.Uint8ClampedArray
  ...
  type StyleGeometryFunction = js.Function1[
    /* feature */ Feature | typingsSlinky.openlayers.openlayersMod.render.Feature, 
    Geometry | typingsSlinky.openlayers.openlayersMod.render.Feature
  ]
