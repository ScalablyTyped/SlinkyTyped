...
import typingsSlinky.openlayers.openlayersMod.SelectFilterFunction
...
object SelectOptions {
  ...
  def apply(
    ...
    filter: (/* feature */ Feature | typingsSlinky.openlayers.openlayersMod.render.Feature, /* layer */ Layer) => Boolean = null,
