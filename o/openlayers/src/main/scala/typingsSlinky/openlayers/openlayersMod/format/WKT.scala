...
import typingsSlinky.openlayers.openlayersMod.geom.Geometry
import typingsSlinky.openlayers.openlayersMod.olx.format.ReadOptions
import typingsSlinky.openlayers.openlayersMod.olx.format.WKTOptions
...
class WKT () extends TextFeature {
  ...
  /**
    ...
    * @api stable
    */
  def writeFeature(feature: typingsSlinky.openlayers.openlayersMod.Feature): String = js.native
  def writeFeature(feature: typingsSlinky.openlayers.openlayersMod.Feature, opt_options: WriteOptions): String = js.native
  /**
