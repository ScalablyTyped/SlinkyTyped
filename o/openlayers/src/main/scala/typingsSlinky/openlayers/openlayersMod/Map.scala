...
import typingsSlinky.openlayers.openlayersMod.control.Control
import typingsSlinky.openlayers.openlayersMod.interaction.Interaction
import typingsSlinky.openlayers.openlayersMod.layer.Base
import typingsSlinky.openlayers.openlayersMod.layer.Group
import typingsSlinky.openlayers.openlayersMod.layer.Layer
import typingsSlinky.openlayers.openlayersMod.olx.AtPixelOptions
import typingsSlinky.openlayers.openlayersMod.olx.MapOptions
...
class Map protected () extends Object {
  ...
  def forEachFeatureAtPixel[T](
    ...
    callback: js.Function2[
      /* feature */ Feature | typingsSlinky.openlayers.openlayersMod.render.Feature, 
      /* layer */ Layer, 
      T
    ]
  ): T = js.native
  ...
  /**
    ...
    * @api stable
    */
  def getFeaturesAtPixel(pixel: Pixel): (js.Array[Feature | typingsSlinky.openlayers.openlayersMod.render.Feature]) | Null = js.native
  def getFeaturesAtPixel(pixel: Pixel, opt_options: AtPixelOptions): (js.Array[Feature | typingsSlinky.openlayers.openlayersMod.render.Feature]) | Null = js.native
  /**
