...
import typingsSlinky.openlayers.openlayersMod.geom.SimpleGeometry
import typingsSlinky.openlayers.openlayersMod.olx.ViewOptions
import typingsSlinky.openlayers.openlayersMod.olx.animation.AnimateCallback
import typingsSlinky.openlayers.openlayersMod.olx.animation.AnimateOptions
import typingsSlinky.openlayers.openlayersMod.olx.view.FitOptions
