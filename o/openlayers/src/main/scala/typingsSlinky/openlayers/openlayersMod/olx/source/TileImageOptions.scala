...
import typingsSlinky.openlayers.openlayersMod.ImageTile
import typingsSlinky.openlayers.openlayersMod.ProjectionLike
import typingsSlinky.openlayers.openlayersMod.Tile
import typingsSlinky.openlayers.openlayersMod.TileCoord
...
object TileImageOptions {
  ...
  def apply(
    ...
    state: State = null,
    tileClass: (/* n */ ImageTile, /* coords */ TileCoord, /* state */ typingsSlinky.openlayers.openlayersMod.Tile.State, /* s1 */ String, /* s2 */ String, /* type */ TileLoadFunctionType) => _ = null,
