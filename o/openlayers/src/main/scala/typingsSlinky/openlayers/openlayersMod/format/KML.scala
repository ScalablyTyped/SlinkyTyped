...
import typingsSlinky.openlayers.openlayersMod.olx.format.KMLOptions
import typingsSlinky.openlayers.openlayersMod.olx.format.ReadOptions
import typingsSlinky.openlayers.openlayersMod.olx.format.WriteOptions
...
class KML () extends XMLFeature {
  ...
  /**
    ...
    * @api stable
    */
  def writeFeatures(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature]): String = js.native
  def writeFeatures(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature], opt_options: WriteOptions): String = js.native
  /**
    ...
    * @api
    */
  def writeFeaturesNode(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature]): org.scalajs.dom.raw.Node = js.native
  def writeFeaturesNode(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature], opt_options: WriteOptions): org.scalajs.dom.raw.Node = js.native
}
