...
import typingsSlinky.openlayers.openlayersMod.layer.Vector
import typingsSlinky.openlayers.openlayersMod.olx.interaction.SelectOptions
...
class Select () extends Interaction {
  ...
  def getLayer(feature: typingsSlinky.openlayers.openlayersMod.render.Feature): Vector = js.native
  /**
