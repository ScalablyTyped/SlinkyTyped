...
import typingsSlinky.openlayers.openlayersMod.olx.format.GeoJSONOptions
...
class GeoJSON () extends JSONFeature {
  ...
  /**
    ...
    * @api stable
    */
  def writeFeatureObject(feature: typingsSlinky.openlayers.openlayersMod.Feature): GeoJSONFeature = js.native
  def writeFeatureObject(feature: typingsSlinky.openlayers.openlayersMod.Feature, opt_options: WriteOptions): GeoJSONFeature = js.native
  /**
  ...
  /**
    ...
    * @api stable
    */
  def writeFeaturesObject(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature]): GeoJSONFeatureCollection = js.native
  def writeFeaturesObject(features: js.Array[typingsSlinky.openlayers.openlayersMod.Feature], opt_options: WriteOptions): GeoJSONFeatureCollection = js.native
  /**
