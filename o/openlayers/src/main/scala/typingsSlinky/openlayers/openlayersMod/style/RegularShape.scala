...
import typingsSlinky.openlayers.openlayersMod.olx.style.RegularShapeOptions
...
class RegularShape protected ()
  extends typingsSlinky.openlayers.openlayersMod.style.Image {
  /**
    * @classdesc
    * Set regular shape style for vector features. The resulting shape will be
    * a regular polygon when `radius` is provided, or a star when `radius1` and
  ...
  /**
    ...
    * @api
    */
  def getImage(pixelRatio: Double): HTMLCanvasElement | HTMLVideoElement | typingsSlinky.openlayers.openlayersMod.style.Image = js.native
  /**
    * @inheritDoc
    * @api
    */
