...
import typingsSlinky.openlayers.openlayersMod.FeatureUrlFunction
import typingsSlinky.openlayers.openlayersMod.olx.source.VectorOptions
...
class Vector () extends Source {
  ...
  /**
    ...
    * @api
    */
  def getFormat(): typingsSlinky.openlayers.openlayersMod.format.Feature = js.native
  /**
