...
import typingsSlinky.openlayers.mod.olx.tilegrid.TileGridOptions
import typingsSlinky.openlayers.mod.olx.tilegrid.WMTSOptions
import typingsSlinky.openlayers.mod.olx.tilegrid.XYZOptions
