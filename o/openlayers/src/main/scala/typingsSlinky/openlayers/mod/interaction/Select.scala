...
import typingsSlinky.openlayers.mod.layer.Vector
import typingsSlinky.openlayers.mod.olx.interaction.SelectOptions
...
class Select () extends Interaction {
  ...
  def getLayer(feature: typingsSlinky.openlayers.mod.render.Feature): Vector = js.native
