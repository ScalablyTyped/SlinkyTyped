...
object ZoomOptions {
  ...
  implicit class ZoomOptionsOps[Self <: ZoomOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setZoomInLabelNode(value: Node): Self = this.set("zoomInLabel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setZoomOutLabelNode(value: Node): Self = this.set("zoomOutLabel", value.asInstanceOf[js.Any])
