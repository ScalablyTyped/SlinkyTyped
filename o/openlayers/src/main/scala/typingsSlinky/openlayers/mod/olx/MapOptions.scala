...
object MapOptions {
  ...
  implicit class MapOptionsOps[Self <: MapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeyboardEventTargetElement(value: Element): Self = this.set("keyboardEventTarget", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLogoElement(value: Element): Self = this.set("logo", value.asInstanceOf[js.Any])
    @scala.inline
