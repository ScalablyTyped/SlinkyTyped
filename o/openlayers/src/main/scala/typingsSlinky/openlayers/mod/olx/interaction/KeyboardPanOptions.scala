...
object KeyboardPanOptions {
  ...
  implicit class KeyboardPanOptionsOps[Self <: KeyboardPanOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPixelDelta(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pixelDelta")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPixelDelta: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pixelDelta")(js.undefined)
        ret
    }
  }
