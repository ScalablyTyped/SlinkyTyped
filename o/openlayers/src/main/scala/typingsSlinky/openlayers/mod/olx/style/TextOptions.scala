...
object TextOptions {
  ...
  implicit class TextOptionsOps[Self <: TextOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundFill(value: Fill): Self = this.set("backgroundFill", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBackgroundFill: Self = this.set("backgroundFill", js.undefined)
    @scala.inline
    def setBackgroundStroke(value: Stroke): Self = this.set("backgroundStroke", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMaxAngle(value: Boolean): Self = this.set("maxAngle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPlacement(value: TextPlacement): Self = this.set("placement", value.asInstanceOf[js.Any])
    @scala.inline
