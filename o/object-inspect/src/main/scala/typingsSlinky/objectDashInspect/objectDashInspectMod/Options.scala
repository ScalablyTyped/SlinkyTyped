package typingsSlinky.objectDashInspect.objectDashInspectMod

import typingsSlinky.objectDashInspect.objectDashInspectStrings.double
import typingsSlinky.objectDashInspect.objectDashInspectStrings.single
