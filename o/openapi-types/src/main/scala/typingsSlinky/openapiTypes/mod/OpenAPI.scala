...
import typingsSlinky.openapiTypes.mod.OpenAPIV3.CallbackObject
...
import typingsSlinky.openapiTypes.mod.OpenAPIV3.ResponsesObject
...
object OpenAPI {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.openapiTypes.mod.OpenAPIV2.OperationObject
    - typingsSlinky.openapiTypes.mod.OpenAPIV3.OperationObject
  */
  ...
  */
  ...
  object Parameter {
    ...
    @scala.inline
    def ParameterObject(in: String, name: String): typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject = {
      val __obj = js.Dynamic.literal(in = in.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject]
    }
    
    @scala.inline
    def ReferenceObject($ref: String): typingsSlinky.openapiTypes.mod.OpenAPIV2.ReferenceObject = {
      val __obj = js.Dynamic.literal($ref = $ref.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.openapiTypes.mod.OpenAPIV2.ReferenceObject]
    }
  }
  
  type Parameters = js.Array[
    typingsSlinky.openapiTypes.mod.OpenAPIV2.Parameter | ParameterObject | ReferenceObject | typingsSlinky.openapiTypes.mod.OpenAPIV2.ReferenceObject
  ]
