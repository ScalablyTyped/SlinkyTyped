...
trait NonArraySchemaObject
  extends BaseSchemaObject
     with SchemaObject {
  var `type`: NonArraySchemaObjectType = js.native
}

object NonArraySchemaObject {
  @scala.inline
  def apply(`type`: NonArraySchemaObjectType): NonArraySchemaObject = {
  ...
  implicit class NonArraySchemaObjectOps[Self <: NonArraySchemaObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: NonArraySchemaObjectType): Self = {
