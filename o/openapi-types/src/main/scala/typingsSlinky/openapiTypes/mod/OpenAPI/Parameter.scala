...
import typingsSlinky.openapiTypes.mod.OpenAPIV2.ItemsObject
import typingsSlinky.openapiTypes.mod.OpenAPIV2.Schema
import typingsSlinky.openapiTypes.mod.OpenAPIV3.ExampleObject
import typingsSlinky.openapiTypes.mod.OpenAPIV3.MediaTypeObject
