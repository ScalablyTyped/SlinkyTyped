...
import typingsSlinky.octokitTypes.endpointsMod.TeamsAddOrUpdateRepoPermissionsLegacyEndpoint
import typingsSlinky.octokitTypes.endpointsMod.TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions
