...
import typingsSlinky.octokitTypes.endpointsMod.TeamsRemoveProjectLegacyEndpoint
import typingsSlinky.octokitTypes.endpointsMod.TeamsRemoveProjectLegacyRequestOptions
