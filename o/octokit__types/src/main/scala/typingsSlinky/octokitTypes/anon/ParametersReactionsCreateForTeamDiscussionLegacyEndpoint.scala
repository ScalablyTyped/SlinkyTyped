...
import typingsSlinky.octokitTypes.endpointsMod.ReactionsCreateForTeamDiscussionLegacyEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ReactionsCreateForTeamDiscussionLegacyRequestOptions
import typingsSlinky.octokitTypes.endpointsMod.ReactionsCreateForTeamDiscussionLegacyResponseData
