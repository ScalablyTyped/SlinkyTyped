...
import typingsSlinky.octokitTypes.endpointsMod.TeamsListDiscussionCommentsInOrgRequestOptions
...
trait ParametersTeamsListDiscussionCommentsInOrgEndpoint extends js.Object {
  ...
  var request: TeamsListDiscussionCommentsInOrgRequestOptions = js.native
