...
import typingsSlinky.octokitTypes.endpointsMod.EnterpriseAdminRemoveSelfHostedRunnerFromGroupForEnterpriseEndpoint
import typingsSlinky.octokitTypes.endpointsMod.EnterpriseAdminRemoveSelfHostedRunnerFromGroupForEnterpriseRequestOptions
