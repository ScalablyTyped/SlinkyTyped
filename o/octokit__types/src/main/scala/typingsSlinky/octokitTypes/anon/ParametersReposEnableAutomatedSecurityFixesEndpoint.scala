...
import typingsSlinky.octokitTypes.endpointsMod.ReposEnableAutomatedSecurityFixesEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ReposEnableAutomatedSecurityFixesRequestOptions
