...
object ParametersMigrationsUnlockRepoForOrgEndpoint {
  ...
  @scala.inline
  implicit class ParametersMigrationsUnlockRepoForOrgEndpointOps[Self <: ParametersMigrationsUnlockRepoForOrgEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: MigrationsUnlockRepoForOrgEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
    def setRequest(value: MigrationsUnlockRepoForOrgRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
