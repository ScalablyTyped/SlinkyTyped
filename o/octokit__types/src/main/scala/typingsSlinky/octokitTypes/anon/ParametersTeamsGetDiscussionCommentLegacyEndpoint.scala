...
import typingsSlinky.octokitTypes.endpointsMod.TeamsGetDiscussionCommentLegacyEndpoint
import typingsSlinky.octokitTypes.endpointsMod.TeamsGetDiscussionCommentLegacyRequestOptions
import typingsSlinky.octokitTypes.endpointsMod.TeamsGetDiscussionCommentLegacyResponseData
