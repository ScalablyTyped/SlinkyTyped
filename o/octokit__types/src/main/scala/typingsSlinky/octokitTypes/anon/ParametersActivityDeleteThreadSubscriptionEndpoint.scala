...
import typingsSlinky.octokitTypes.endpointsMod.ActivityDeleteThreadSubscriptionEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActivityDeleteThreadSubscriptionRequestOptions
