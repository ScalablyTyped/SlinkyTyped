...
import typingsSlinky.octokitTypes.endpointsMod.MigrationsListReposForUserRequestOptions
...
object ParametersMigrationsListReposForUserEndpoint {
  ...
  implicit class ParametersMigrationsListReposForUserEndpointOps[Self <: ParametersMigrationsListReposForUserEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequest(value: MigrationsListReposForUserRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
