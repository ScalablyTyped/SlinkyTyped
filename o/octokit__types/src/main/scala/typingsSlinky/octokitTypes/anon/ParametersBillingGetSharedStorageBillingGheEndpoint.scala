...
import typingsSlinky.octokitTypes.endpointsMod.BillingGetSharedStorageBillingGheEndpoint
import typingsSlinky.octokitTypes.endpointsMod.BillingGetSharedStorageBillingGheRequestOptions
import typingsSlinky.octokitTypes.endpointsMod.BillingGetSharedStorageBillingGheResponseData
