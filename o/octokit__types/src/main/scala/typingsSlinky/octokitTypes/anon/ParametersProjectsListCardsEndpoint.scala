...
import typingsSlinky.octokitTypes.endpointsMod.ProjectsListCardsRequestOptions
...
object ParametersProjectsListCardsEndpoint {
  ...
  implicit class ParametersProjectsListCardsEndpointOps[Self <: ParametersProjectsListCardsEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequest(value: ProjectsListCardsRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
