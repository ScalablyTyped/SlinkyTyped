...
import typingsSlinky.octokitTypes.endpointsMod.ActionsRemoveRepoAccessToSelfHostedRunnerGroupInOrgEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActionsRemoveRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions
