...
object ParametersAppsRemoveRepoFromInstallationEndpoint {
  ...
  @scala.inline
  implicit class ParametersAppsRemoveRepoFromInstallationEndpointOps[Self <: ParametersAppsRemoveRepoFromInstallationEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: AppsRemoveRepoFromInstallationEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
    def setRequest(value: AppsRemoveRepoFromInstallationRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
