...
import typingsSlinky.octokitTypes.endpointsMod.ActionsDownloadJobLogsForWorkflowRunEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActionsDownloadJobLogsForWorkflowRunRequestOptions
