...
object ParametersReposCheckCollaboratorEndpoint {
  ...
  @scala.inline
  implicit class ParametersReposCheckCollaboratorEndpointOps[Self <: ParametersReposCheckCollaboratorEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: ReposCheckCollaboratorEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
    def setRequest(value: ReposCheckCollaboratorRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
