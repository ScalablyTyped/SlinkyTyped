...
import typingsSlinky.octokitTypes.endpointsMod.OauthAuthorizationsDeleteGrantEndpoint
import typingsSlinky.octokitTypes.endpointsMod.OauthAuthorizationsDeleteGrantRequestOptions
