...
import typingsSlinky.octokitTypes.endpointsMod.TeamsDeleteDiscussionCommentLegacyEndpoint
import typingsSlinky.octokitTypes.endpointsMod.TeamsDeleteDiscussionCommentLegacyRequestOptions
