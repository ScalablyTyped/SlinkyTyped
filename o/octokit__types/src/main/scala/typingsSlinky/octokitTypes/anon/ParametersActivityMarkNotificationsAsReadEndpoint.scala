...
import typingsSlinky.octokitTypes.endpointsMod.ActivityMarkNotificationsAsReadEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActivityMarkNotificationsAsReadRequestOptions
