...
import typingsSlinky.octokitTypes.endpointsMod.ProjectsDeleteColumnRequestOptions
...
object ParametersProjectsDeleteColumnEndpoint {
  ...
  @scala.inline
  implicit class ParametersProjectsDeleteColumnEndpointOps[Self <: ParametersProjectsDeleteColumnEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: ProjectsDeleteColumnEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
    def setRequest(value: ProjectsDeleteColumnRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
