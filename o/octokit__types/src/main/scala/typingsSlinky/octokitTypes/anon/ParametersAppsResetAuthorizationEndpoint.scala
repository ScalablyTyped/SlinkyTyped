...
import typingsSlinky.octokitTypes.endpointsMod.AppsResetAuthorizationEndpoint
import typingsSlinky.octokitTypes.endpointsMod.AppsResetAuthorizationRequestOptions
import typingsSlinky.octokitTypes.endpointsMod.AppsResetAuthorizationResponseData
