...
import typingsSlinky.octokitTypes.endpointsMod.EnterpriseAdminSetOrgAccessToSelfHostedRunnerGroupInEnterpriseEndpoint
import typingsSlinky.octokitTypes.endpointsMod.EnterpriseAdminSetOrgAccessToSelfHostedRunnerGroupInEnterpriseRequestOptions
