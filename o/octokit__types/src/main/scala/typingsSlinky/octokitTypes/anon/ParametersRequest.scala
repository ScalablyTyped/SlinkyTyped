...
import typingsSlinky.octokitTypes.endpointsMod.AppsRevokeGrantForApplicationEndpoint
import typingsSlinky.octokitTypes.endpointsMod.AppsRevokeGrantForApplicationRequestOptions
