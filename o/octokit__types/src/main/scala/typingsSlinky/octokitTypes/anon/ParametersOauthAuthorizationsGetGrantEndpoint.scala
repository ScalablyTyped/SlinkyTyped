...
import typingsSlinky.octokitTypes.endpointsMod.OauthAuthorizationsGetGrantEndpoint
import typingsSlinky.octokitTypes.endpointsMod.OauthAuthorizationsGetGrantRequestOptions
import typingsSlinky.octokitTypes.endpointsMod.OauthAuthorizationsGetGrantResponseData
