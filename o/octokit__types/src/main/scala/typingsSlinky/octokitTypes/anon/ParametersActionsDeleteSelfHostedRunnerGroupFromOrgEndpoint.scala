...
import typingsSlinky.octokitTypes.endpointsMod.ActionsDeleteSelfHostedRunnerGroupFromOrgEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActionsDeleteSelfHostedRunnerGroupFromOrgRequestOptions
