...
import typingsSlinky.octokitTypes.endpointsMod.ReposCreateDispatchEventEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ReposCreateDispatchEventRequestOptions
