...
import typingsSlinky.octokitTypes.endpointsMod.ActionsDeleteSelfHostedRunnerFromOrgEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActionsDeleteSelfHostedRunnerFromOrgRequestOptions
