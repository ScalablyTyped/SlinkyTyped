...
import typingsSlinky.octokitTypes.endpointsMod.TeamsDeleteDiscussionLegacyEndpoint
import typingsSlinky.octokitTypes.endpointsMod.TeamsDeleteDiscussionLegacyRequestOptions
