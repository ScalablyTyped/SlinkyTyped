...
import typingsSlinky.octokitTypes.endpointsMod.ChecksListForRefRequestOptions
...
object ParametersChecksListForRefEndpoint {
  ...
  implicit class ParametersChecksListForRefEndpointOps[Self <: ParametersChecksListForRefEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequest(value: ChecksListForRefRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
