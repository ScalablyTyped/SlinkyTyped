...
import typingsSlinky.octokitTypes.endpointsMod.TeamsCreateOrUpdateIdPGroupConnectionsInOrgEndpoint
import typingsSlinky.octokitTypes.endpointsMod.TeamsCreateOrUpdateIdPGroupConnectionsInOrgRequestOptions
import typingsSlinky.octokitTypes.endpointsMod.TeamsCreateOrUpdateIdPGroupConnectionsInOrgResponseData
