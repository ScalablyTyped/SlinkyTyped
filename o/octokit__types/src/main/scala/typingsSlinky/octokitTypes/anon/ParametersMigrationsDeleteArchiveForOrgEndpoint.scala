...
import typingsSlinky.octokitTypes.endpointsMod.MigrationsDeleteArchiveForOrgEndpoint
import typingsSlinky.octokitTypes.endpointsMod.MigrationsDeleteArchiveForOrgRequestOptions
