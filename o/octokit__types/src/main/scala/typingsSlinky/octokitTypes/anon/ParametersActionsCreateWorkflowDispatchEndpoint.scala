...
@js.native
trait ParametersActionsCreateWorkflowDispatchEndpoint extends js.Object {
...
object ParametersActionsCreateWorkflowDispatchEndpoint {
  ...
  @scala.inline
  implicit class ParametersActionsCreateWorkflowDispatchEndpointOps[Self <: ParametersActionsCreateWorkflowDispatchEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: ActionsCreateWorkflowDispatchEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
    def setRequest(value: ActionsCreateWorkflowDispatchRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
