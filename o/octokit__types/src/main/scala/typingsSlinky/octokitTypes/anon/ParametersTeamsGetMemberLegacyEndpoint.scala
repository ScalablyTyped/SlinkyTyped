...
import typingsSlinky.octokitTypes.endpointsMod.TeamsGetMemberLegacyEndpoint
import typingsSlinky.octokitTypes.endpointsMod.TeamsGetMemberLegacyRequestOptions
