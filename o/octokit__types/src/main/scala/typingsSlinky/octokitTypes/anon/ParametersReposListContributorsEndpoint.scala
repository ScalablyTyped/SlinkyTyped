...
import typingsSlinky.octokitTypes.endpointsMod.ReposListContributorsRequestOptions
...
object ParametersReposListContributorsEndpoint {
  ...
  implicit class ParametersReposListContributorsEndpointOps[Self <: ParametersReposListContributorsEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequest(value: ReposListContributorsRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
