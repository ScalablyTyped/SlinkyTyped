...
import typingsSlinky.octokitTypes.endpointsMod.IssuesListEventsForTimelineRequestOptions
...
object ParametersIssuesListEventsForTimelineEndpoint {
  ...
  implicit class ParametersIssuesListEventsForTimelineEndpointOps[Self <: ParametersIssuesListEventsForTimelineEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequest(value: IssuesListEventsForTimelineRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
