...
import typingsSlinky.octokitTypes.endpointsMod.PullsCheckIfMergedEndpoint
import typingsSlinky.octokitTypes.endpointsMod.PullsCheckIfMergedRequestOptions
