...
import typingsSlinky.octokitTypes.endpointsMod.ActivityListReceivedEventsForUserEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActivityListReceivedEventsForUserRequestOptions
