...
import typingsSlinky.octokitTypes.endpointsMod.ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgEndpoint
import typingsSlinky.octokitTypes.endpointsMod.ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions
