...
import typingsSlinky.octokitTypes.endpointsMod.EnterpriseAdminGetSelfHostedRunnerForEnterpriseEndpoint
import typingsSlinky.octokitTypes.endpointsMod.EnterpriseAdminGetSelfHostedRunnerForEnterpriseRequestOptions
import typingsSlinky.octokitTypes.endpointsMod.EnterpriseAdminGetSelfHostedRunnerForEnterpriseResponseData
