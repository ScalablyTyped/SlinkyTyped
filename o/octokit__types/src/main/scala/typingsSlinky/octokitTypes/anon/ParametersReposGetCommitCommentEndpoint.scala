...
object ParametersReposGetCommitCommentEndpoint {
  ...
  @scala.inline
  implicit class ParametersReposGetCommitCommentEndpointOps[Self <: ParametersReposGetCommitCommentEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: ReposGetCommitCommentEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRequest(value: ReposGetCommitCommentRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
