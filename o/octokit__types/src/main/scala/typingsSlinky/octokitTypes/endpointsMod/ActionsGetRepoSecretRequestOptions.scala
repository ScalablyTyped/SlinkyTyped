...
@js.native
trait ActionsGetRepoSecretRequestOptions extends js.Object {
...
object ActionsGetRepoSecretRequestOptions {
  ...
  @scala.inline
  implicit class ActionsGetRepoSecretRequestOptionsOps[Self <: ActionsGetRepoSecretRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
