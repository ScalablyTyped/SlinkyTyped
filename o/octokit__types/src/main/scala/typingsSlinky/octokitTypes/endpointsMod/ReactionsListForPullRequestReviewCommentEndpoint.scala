...
@js.native
trait ReactionsListForPullRequestReviewCommentEndpoint extends StObject {
...
object ReactionsListForPullRequestReviewCommentEndpoint {
  ...
  @scala.inline
  def apply(comment_id: Double, mediaType: `9`, owner: String, repo: String): ReactionsListForPullRequestReviewCommentEndpoint = {
  ...
  @scala.inline
  implicit class ReactionsListForPullRequestReviewCommentEndpointMutableBuilder[Self <: ReactionsListForPullRequestReviewCommentEndpoint] (val x: Self) extends AnyVal {
