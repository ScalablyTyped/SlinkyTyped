...
object UsersListPublicEmailsForAuthenticatedRequestOptions {
  ...
  @scala.inline
  implicit class UsersListPublicEmailsForAuthenticatedRequestOptionsOps[Self <: UsersListPublicEmailsForAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashpublic_emails): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
