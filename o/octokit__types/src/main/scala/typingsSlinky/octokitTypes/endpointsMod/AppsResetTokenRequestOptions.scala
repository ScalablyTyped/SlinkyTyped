...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashapplicationsSlashColonclient_idSlashtoken
...
@js.native
trait AppsResetTokenRequestOptions extends js.Object {
...
object AppsResetTokenRequestOptions {
  ...
  @scala.inline
  implicit class AppsResetTokenRequestOptionsOps[Self <: AppsResetTokenRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
