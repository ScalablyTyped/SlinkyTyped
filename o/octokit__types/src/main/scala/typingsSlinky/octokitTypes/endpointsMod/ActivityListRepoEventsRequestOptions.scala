...
@js.native
trait ActivityListRepoEventsRequestOptions extends js.Object {
...
object ActivityListRepoEventsRequestOptions {
  ...
  @scala.inline
  implicit class ActivityListRepoEventsRequestOptionsOps[Self <: ActivityListRepoEventsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashevents): Self = this.set("url", value.asInstanceOf[js.Any])
  }
