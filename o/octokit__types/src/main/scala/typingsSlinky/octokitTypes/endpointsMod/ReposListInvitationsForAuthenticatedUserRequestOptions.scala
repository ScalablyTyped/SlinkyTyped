...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashrepository_invitations
...
object ReposListInvitationsForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ReposListInvitationsForAuthenticatedUserRequestOptionsOps[Self <: ReposListInvitationsForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashrepository_invitations): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
