...
import typingsSlinky.octokitTypes.anon.Apps
import typingsSlinky.octokitTypes.anon.Contextsurl
import typingsSlinky.octokitTypes.anon.Dismissalrestrictions
import typingsSlinky.octokitTypes.anon.EnabledBoolean
import typingsSlinky.octokitTypes.anon.EnabledUrl
