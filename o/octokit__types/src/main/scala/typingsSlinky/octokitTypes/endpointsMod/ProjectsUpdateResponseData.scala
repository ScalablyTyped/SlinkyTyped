...
@js.native
trait ProjectsUpdateResponseData extends js.Object {
...
object ProjectsUpdateResponseData {
  ...
  @scala.inline
  implicit class ProjectsUpdateResponseDataOps[Self <: ProjectsUpdateResponseData] (val x: Self) extends AnyVal {
    @scala.inline
