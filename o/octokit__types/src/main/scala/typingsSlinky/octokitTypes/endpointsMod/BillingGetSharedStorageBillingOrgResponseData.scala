...
@js.native
trait BillingGetSharedStorageBillingOrgResponseData extends js.Object {
...
object BillingGetSharedStorageBillingOrgResponseData {
  ...
  @scala.inline
  implicit class BillingGetSharedStorageBillingOrgResponseDataOps[Self <: BillingGetSharedStorageBillingOrgResponseData] (val x: Self) extends AnyVal {
