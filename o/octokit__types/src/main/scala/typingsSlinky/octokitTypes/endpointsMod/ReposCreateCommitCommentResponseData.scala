...
@js.native
trait ReposCreateCommitCommentResponseData extends StObject {
...
object ReposCreateCommitCommentResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateCommitCommentResponseData]
  }
  
  @scala.inline
  implicit class ReposCreateCommitCommentResponseDataMutableBuilder[Self <: ReposCreateCommitCommentResponseData] (val x: Self) extends AnyVal {
