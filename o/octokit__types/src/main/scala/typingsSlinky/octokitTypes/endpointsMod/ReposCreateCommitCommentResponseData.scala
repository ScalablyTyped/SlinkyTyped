...
@js.native
trait ReposCreateCommitCommentResponseData extends js.Object {
...
object ReposCreateCommitCommentResponseData {
  ...
  @scala.inline
  implicit class ReposCreateCommitCommentResponseDataOps[Self <: ReposCreateCommitCommentResponseData] (val x: Self) extends AnyVal {
