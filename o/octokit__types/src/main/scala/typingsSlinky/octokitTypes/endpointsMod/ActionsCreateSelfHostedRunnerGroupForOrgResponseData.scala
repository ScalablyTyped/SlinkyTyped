...
@js.native
trait ActionsCreateSelfHostedRunnerGroupForOrgResponseData extends js.Object {
...
object ActionsCreateSelfHostedRunnerGroupForOrgResponseData {
  ...
  @scala.inline
  implicit class ActionsCreateSelfHostedRunnerGroupForOrgResponseDataOps[Self <: ActionsCreateSelfHostedRunnerGroupForOrgResponseData] (val x: Self) extends AnyVal {
