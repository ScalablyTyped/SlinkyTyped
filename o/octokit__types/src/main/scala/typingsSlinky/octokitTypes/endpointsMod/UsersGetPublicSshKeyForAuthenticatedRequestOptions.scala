...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashkeysSlashColonkey_id
...
trait UsersGetPublicSshKeyForAuthenticatedRequestOptions extends js.Object {
  ...
  var url: SlashuserSlashkeysSlashColonkey_id = js.native
}
...
object UsersGetPublicSshKeyForAuthenticatedRequestOptions {
  ...
  @scala.inline
  implicit class UsersGetPublicSshKeyForAuthenticatedRequestOptionsOps[Self <: UsersGetPublicSshKeyForAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashkeysSlashColonkey_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
