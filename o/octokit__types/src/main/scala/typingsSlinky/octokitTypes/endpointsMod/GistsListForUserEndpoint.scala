...
@js.native
trait GistsListForUserEndpoint extends StObject {
...
object GistsListForUserEndpoint {
  
  @scala.inline
  def apply(username: String): GistsListForUserEndpoint = {
    val __obj = js.Dynamic.literal(username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[GistsListForUserEndpoint]
  }
  
  @scala.inline
  implicit class GistsListForUserEndpointMutableBuilder[Self <: GistsListForUserEndpoint] (val x: Self) extends AnyVal {
