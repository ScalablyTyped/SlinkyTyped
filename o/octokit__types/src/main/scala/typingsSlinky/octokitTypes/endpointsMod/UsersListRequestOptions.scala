...
import typingsSlinky.octokitTypes.octokitTypesStrings.Slashusers
...
object UsersListRequestOptions {
  ...
  @scala.inline
  implicit class UsersListRequestOptionsOps[Self <: UsersListRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashusers): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
