...
object ReactionsCreateForTeamDiscussionInOrgRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionInOrgRequestOptionsOps[Self <: ReactionsCreateForTeamDiscussionInOrgRequestOptions] (val x: Self) extends AnyVal {
