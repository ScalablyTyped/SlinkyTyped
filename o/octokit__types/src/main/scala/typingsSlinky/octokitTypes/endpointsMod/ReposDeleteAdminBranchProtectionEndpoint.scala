...
@js.native
trait ReposDeleteAdminBranchProtectionEndpoint extends js.Object {
...
object ReposDeleteAdminBranchProtectionEndpoint {
  ...
  @scala.inline
  implicit class ReposDeleteAdminBranchProtectionEndpointOps[Self <: ReposDeleteAdminBranchProtectionEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
