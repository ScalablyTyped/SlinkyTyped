...
@js.native
trait PullsGetReviewCommentEndpoint extends StObject {
...
object PullsGetReviewCommentEndpoint {
  ...
  @scala.inline
  implicit class PullsGetReviewCommentEndpointMutableBuilder[Self <: PullsGetReviewCommentEndpoint] (val x: Self) extends AnyVal {
