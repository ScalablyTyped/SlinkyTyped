...
import typingsSlinky.octokitTypes.anon.Checks
...
@js.native
trait AppsGetRepoInstallationResponseData extends StObject {
...
object AppsGetRepoInstallationResponseData {
  ...
  @scala.inline
  implicit class AppsGetRepoInstallationResponseDataMutableBuilder[Self <: AppsGetRepoInstallationResponseData] (val x: Self) extends AnyVal {
