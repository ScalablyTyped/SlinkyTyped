...
import typingsSlinky.octokitTypes.anon.Pullrequest
...
@js.native
trait PullsDeletePendingReviewResponseData extends StObject {
...
object PullsDeletePendingReviewResponseData {
  ...
  @scala.inline
  implicit class PullsDeletePendingReviewResponseDataMutableBuilder[Self <: PullsDeletePendingReviewResponseData] (val x: Self) extends AnyVal {
