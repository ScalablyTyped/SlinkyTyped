...
object CodesOfConductGetForRepoEndpoint {
  ...
  @scala.inline
  def apply(mediaType: `4`, owner: String, repo: String): CodesOfConductGetForRepoEndpoint = {
  ...
  @scala.inline
  implicit class CodesOfConductGetForRepoEndpointOps[Self <: CodesOfConductGetForRepoEndpoint] (val x: Self) extends AnyVal {
