...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreactionsSlashColonreaction_id
...
trait ReactionsDeleteLegacyRequestOptions extends js.Object {
  ...
  var url: SlashreactionsSlashColonreaction_id = js.native
}
object ReactionsDeleteLegacyRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsDeleteLegacyRequestOptionsOps[Self <: ReactionsDeleteLegacyRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreactionsSlashColonreaction_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
