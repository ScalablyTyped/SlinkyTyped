...
@js.native
trait AppsResetAuthorizationEndpoint extends js.Object {
...
object AppsResetAuthorizationEndpoint {
  ...
  @scala.inline
  implicit class AppsResetAuthorizationEndpointOps[Self <: AppsResetAuthorizationEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
