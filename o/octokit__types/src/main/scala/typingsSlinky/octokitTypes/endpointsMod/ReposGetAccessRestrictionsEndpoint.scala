...
@js.native
trait ReposGetAccessRestrictionsEndpoint extends js.Object {
...
object ReposGetAccessRestrictionsEndpoint {
  ...
  @scala.inline
  implicit class ReposGetAccessRestrictionsEndpointOps[Self <: ReposGetAccessRestrictionsEndpoint] (val x: Self) extends AnyVal {
