...
@js.native
trait UsersUnblockRequestOptions extends StObject {
...
object UsersUnblockRequestOptions {
  ...
  @scala.inline
  implicit class UsersUnblockRequestOptionsMutableBuilder[Self <: UsersUnblockRequestOptions] (val x: Self) extends AnyVal {
