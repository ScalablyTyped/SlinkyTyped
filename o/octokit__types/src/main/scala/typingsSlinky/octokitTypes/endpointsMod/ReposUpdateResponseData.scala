...
@js.native
trait ReposUpdateResponseData extends StObject {
...
object ReposUpdateResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateResponseData]
  }
  
  @scala.inline
  implicit class ReposUpdateResponseDataMutableBuilder[Self <: ReposUpdateResponseData] (val x: Self) extends AnyVal {
