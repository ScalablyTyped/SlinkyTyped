...
@js.native
trait TeamsUpdateDiscussionLegacyResponseData extends StObject {
...
object TeamsUpdateDiscussionLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionLegacyResponseDataMutableBuilder[Self <: TeamsUpdateDiscussionLegacyResponseData] (val x: Self) extends AnyVal {
