...
@js.native
trait PullsUpdateReviewCommentResponseData extends StObject {
...
object PullsUpdateReviewCommentResponseData {
  ...
  def apply(
    ...
    url: String,
    user: Avatarurl
  ): PullsUpdateReviewCommentResponseData = {
    ...
    __obj.asInstanceOf[PullsUpdateReviewCommentResponseData]
  }
  
  @scala.inline
  implicit class PullsUpdateReviewCommentResponseDataMutableBuilder[Self <: PullsUpdateReviewCommentResponseData] (val x: Self) extends AnyVal {
