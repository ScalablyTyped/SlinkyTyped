...
@js.native
trait PullsUpdateReviewCommentResponseData extends js.Object {
...
object PullsUpdateReviewCommentResponseData {
  ...
  @scala.inline
  implicit class PullsUpdateReviewCommentResponseDataOps[Self <: PullsUpdateReviewCommentResponseData] (val x: Self) extends AnyVal {
