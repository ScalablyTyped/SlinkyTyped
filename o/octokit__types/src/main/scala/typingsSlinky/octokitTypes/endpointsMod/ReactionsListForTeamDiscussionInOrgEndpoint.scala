...
object ReactionsListForTeamDiscussionInOrgEndpoint {
  @scala.inline
  def apply(discussion_number: Double, mediaType: `12`, org_ : String, team_slug: String): ReactionsListForTeamDiscussionInOrgEndpoint = {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionInOrgEndpointOps[Self <: ReactionsListForTeamDiscussionInOrgEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
