...
@js.native
trait OrgsCreateWebhookRequestOptions extends js.Object {
...
object OrgsCreateWebhookRequestOptions {
  ...
  @scala.inline
  implicit class OrgsCreateWebhookRequestOptionsOps[Self <: OrgsCreateWebhookRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashhooks): Self = this.set("url", value.asInstanceOf[js.Any])
  }
