...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashreviews
...
object PullsCreateReviewRequestOptions {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestOptionsOps[Self <: PullsCreateReviewRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
