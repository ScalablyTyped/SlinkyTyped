...
import typingsSlinky.octokitTypes.octokitTypesStrings.Slashorganizations
...
trait OrgsListRequestOptions extends js.Object {
  ...
  var url: Slashorganizations = js.native
}
...
object OrgsListRequestOptions {
  ...
  @scala.inline
  implicit class OrgsListRequestOptionsOps[Self <: OrgsListRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: Slashorganizations): Self = this.set("url", value.asInstanceOf[js.Any])
  }
