...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashprojectsSlashcolumnsSlashColoncolumn_idSlashmoves
...
object ProjectsMoveColumnRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsMoveColumnRequestOptionsOps[Self <: ProjectsMoveColumnRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashprojectsSlashcolumnsSlashColoncolumn_idSlashmoves): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
