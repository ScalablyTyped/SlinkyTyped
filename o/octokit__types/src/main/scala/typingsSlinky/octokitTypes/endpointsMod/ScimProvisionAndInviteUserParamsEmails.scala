...
@js.native
trait ScimProvisionAndInviteUserParamsEmails extends js.Object {
...
object ScimProvisionAndInviteUserParamsEmails {
  ...
  @scala.inline
  implicit class ScimProvisionAndInviteUserParamsEmailsOps[Self <: ScimProvisionAndInviteUserParamsEmails] (val x: Self) extends AnyVal {
