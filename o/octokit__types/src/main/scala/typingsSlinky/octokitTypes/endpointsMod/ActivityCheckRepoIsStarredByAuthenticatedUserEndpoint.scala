...
object ActivityCheckRepoIsStarredByAuthenticatedUserEndpoint {
  ...
  @scala.inline
  implicit class ActivityCheckRepoIsStarredByAuthenticatedUserEndpointOps[Self <: ActivityCheckRepoIsStarredByAuthenticatedUserEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
