...
object AppsListReposAccessibleToInstallationRequestOptions {
  ...
  @scala.inline
  implicit class AppsListReposAccessibleToInstallationRequestOptionsOps[Self <: AppsListReposAccessibleToInstallationRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashinstallationSlashrepositories): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
