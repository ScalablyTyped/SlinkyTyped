...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashactionsSlashsecretsSlashColonsecret_nameSlashrepositories
...
object ActionsSetSelectedReposForOrgSecretRequestOptions {
  ...
  @scala.inline
  implicit class ActionsSetSelectedReposForOrgSecretRequestOptionsOps[Self <: ActionsSetSelectedReposForOrgSecretRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
