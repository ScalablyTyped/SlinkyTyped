...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashscimSlashv2SlashenterprisesSlashColonenterpriseSlashUsersSlashColonscim_user_id
...
@js.native
trait EnterpriseAdminGetProvisioningInformationForEnterpriseUserRequestOptions extends js.Object {
...
object EnterpriseAdminGetProvisioningInformationForEnterpriseUserRequestOptions {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetProvisioningInformationForEnterpriseUserRequestOptionsOps[Self <: EnterpriseAdminGetProvisioningInformationForEnterpriseUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
