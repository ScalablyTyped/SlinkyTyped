...
object AppsGetAuthenticatedRequestOptions {
  ...
  @scala.inline
  implicit class AppsGetAuthenticatedRequestOptionsOps[Self <: AppsGetAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashapp): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
