...
@js.native
trait ScimSetInformationForProvisionedUserParamsName extends js.Object {
...
object ScimSetInformationForProvisionedUserParamsName {
  ...
  @scala.inline
  implicit class ScimSetInformationForProvisionedUserParamsNameOps[Self <: ScimSetInformationForProvisionedUserParamsName] (val x: Self) extends AnyVal {
