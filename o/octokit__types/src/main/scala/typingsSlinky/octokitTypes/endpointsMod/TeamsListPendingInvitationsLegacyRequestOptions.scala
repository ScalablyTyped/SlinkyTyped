...
@js.native
trait TeamsListPendingInvitationsLegacyRequestOptions extends js.Object {
...
object TeamsListPendingInvitationsLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsListPendingInvitationsLegacyRequestOptionsOps[Self <: TeamsListPendingInvitationsLegacyRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashteamsSlashColonteam_idSlashinvitations): Self = this.set("url", value.asInstanceOf[js.Any])
  }
