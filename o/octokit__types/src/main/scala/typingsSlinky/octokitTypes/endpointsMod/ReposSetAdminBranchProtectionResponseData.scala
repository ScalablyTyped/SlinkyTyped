...
@js.native
trait ReposSetAdminBranchProtectionResponseData extends js.Object {
...
object ReposSetAdminBranchProtectionResponseData {
  ...
  @scala.inline
  implicit class ReposSetAdminBranchProtectionResponseDataOps[Self <: ReposSetAdminBranchProtectionResponseData] (val x: Self) extends AnyVal {
