...
@js.native
trait GitCreateBlobRequestOptions extends StObject {
...
object GitCreateBlobRequestOptions {
  ...
  @scala.inline
  implicit class GitCreateBlobRequestOptionsMutableBuilder[Self <: GitCreateBlobRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashgitSlashblobs): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
