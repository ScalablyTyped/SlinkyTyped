...
@js.native
trait AppsResetTokenResponseData extends StObject {
...
object AppsResetTokenResponseData {
  ...
  @scala.inline
  implicit class AppsResetTokenResponseDataMutableBuilder[Self <: AppsResetTokenResponseData] (val x: Self) extends AnyVal {
