...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashpublic_membersSlashColonusername
...
object OrgsRemovePublicMembershipForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class OrgsRemovePublicMembershipForAuthenticatedUserRequestOptionsOps[Self <: OrgsRemovePublicMembershipForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashpublic_membersSlashColonusername): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
