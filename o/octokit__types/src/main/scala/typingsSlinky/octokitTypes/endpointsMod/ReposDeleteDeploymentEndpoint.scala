...
@js.native
trait ReposDeleteDeploymentEndpoint extends js.Object {
...
object ReposDeleteDeploymentEndpoint {
  ...
  @scala.inline
  implicit class ReposDeleteDeploymentEndpointOps[Self <: ReposDeleteDeploymentEndpoint] (val x: Self) extends AnyVal {
