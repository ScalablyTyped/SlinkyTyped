...
@js.native
trait TeamsUpdateDiscussionInOrgRequestOptions extends js.Object {
...
object TeamsUpdateDiscussionInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionInOrgRequestOptionsOps[Self <: TeamsUpdateDiscussionInOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
