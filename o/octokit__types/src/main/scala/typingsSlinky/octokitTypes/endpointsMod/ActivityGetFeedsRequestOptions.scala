...
object ActivityGetFeedsRequestOptions {
  ...
  @scala.inline
  implicit class ActivityGetFeedsRequestOptionsOps[Self <: ActivityGetFeedsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: Slashfeeds): Self = this.set("url", value.asInstanceOf[js.Any])
  }
