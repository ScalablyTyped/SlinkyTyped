...
@js.native
trait MigrationsGetStatusForOrgResponseData extends js.Object {
...
object MigrationsGetStatusForOrgResponseData {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForOrgResponseDataOps[Self <: MigrationsGetStatusForOrgResponseData] (val x: Self) extends AnyVal {
    @scala.inline
