...
@js.native
trait TeamsCheckPermissionsForRepoLegacyRequestOptions extends js.Object {
...
object TeamsCheckPermissionsForRepoLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCheckPermissionsForRepoLegacyRequestOptionsOps[Self <: TeamsCheckPermissionsForRepoLegacyRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
