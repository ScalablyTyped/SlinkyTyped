...
@js.native
trait ReposGetPullRequestReviewProtectionRequestOptions extends js.Object {
...
object ReposGetPullRequestReviewProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetPullRequestReviewProtectionRequestOptionsOps[Self <: ReposGetPullRequestReviewProtectionRequestOptions] (val x: Self) extends AnyVal {
