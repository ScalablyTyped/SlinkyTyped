...
import typingsSlinky.octokitTypes.anon.Annotationsurl
import typingsSlinky.octokitTypes.anon.Base
import typingsSlinky.octokitTypes.anon.Events
import typingsSlinky.octokitTypes.anon.IdNumber
...
object ChecksGetResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ChecksGetResponseData]
  }
