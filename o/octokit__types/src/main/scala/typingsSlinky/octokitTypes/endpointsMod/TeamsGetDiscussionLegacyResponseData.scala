...
@js.native
trait TeamsGetDiscussionLegacyResponseData extends js.Object {
...
object TeamsGetDiscussionLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionLegacyResponseDataOps[Self <: TeamsGetDiscussionLegacyResponseData] (val x: Self) extends AnyVal {
