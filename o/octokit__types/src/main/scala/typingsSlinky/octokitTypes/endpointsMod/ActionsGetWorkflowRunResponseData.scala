...
import typingsSlinky.octokitTypes.anon.Assigneesurl
import typingsSlinky.octokitTypes.anon.Author
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait ActionsGetWorkflowRunResponseData extends js.Object {
...
object ActionsGetWorkflowRunResponseData {
  ...
  @scala.inline
  implicit class ActionsGetWorkflowRunResponseDataOps[Self <: ActionsGetWorkflowRunResponseData] (val x: Self) extends AnyVal {
