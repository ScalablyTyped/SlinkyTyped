...
@js.native
trait TeamsGetMembershipForUserLegacyResponseData extends StObject {
...
object TeamsGetMembershipForUserLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsGetMembershipForUserLegacyResponseDataMutableBuilder[Self <: TeamsGetMembershipForUserLegacyResponseData] (val x: Self) extends AnyVal {
