...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashgistsSlashColongist_idSlashcommentsSlashColoncomment_id
...
@js.native
trait GistsDeleteCommentRequestOptions extends StObject {
...
object GistsDeleteCommentRequestOptions {
  ...
  @scala.inline
  implicit class GistsDeleteCommentRequestOptionsMutableBuilder[Self <: GistsDeleteCommentRequestOptions] (val x: Self) extends AnyVal {
