...
object RateLimitGetRequestOptions {
  ...
  @scala.inline
  implicit class RateLimitGetRequestOptionsOps[Self <: RateLimitGetRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: Slashrate_limit): Self = this.set("url", value.asInstanceOf[js.Any])
  }
