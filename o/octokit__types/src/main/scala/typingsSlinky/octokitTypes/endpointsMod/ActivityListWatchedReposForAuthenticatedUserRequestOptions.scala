...
object ActivityListWatchedReposForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ActivityListWatchedReposForAuthenticatedUserRequestOptionsOps[Self <: ActivityListWatchedReposForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashsubscriptions): Self = this.set("url", value.asInstanceOf[js.Any])
  }
