...
import typingsSlinky.octokitTypes.octokitTypesStrings.Slashgists
...
object GistsCreateRequestOptions {
  ...
  @scala.inline
  implicit class GistsCreateRequestOptionsMutableBuilder[Self <: GistsCreateRequestOptions] (val x: Self) extends AnyVal {
