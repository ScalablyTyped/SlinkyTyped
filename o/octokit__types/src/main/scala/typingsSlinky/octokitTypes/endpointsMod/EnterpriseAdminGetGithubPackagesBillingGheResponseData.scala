...
@js.native
trait EnterpriseAdminGetGithubPackagesBillingGheResponseData extends js.Object {
...
object EnterpriseAdminGetGithubPackagesBillingGheResponseData {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetGithubPackagesBillingGheResponseDataOps[Self <: EnterpriseAdminGetGithubPackagesBillingGheResponseData] (val x: Self) extends AnyVal {
