...
@js.native
trait PullsGetReviewCommentRequestOptions extends js.Object {
...
object PullsGetReviewCommentRequestOptions {
  ...
  @scala.inline
  implicit class PullsGetReviewCommentRequestOptionsOps[Self <: PullsGetReviewCommentRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
