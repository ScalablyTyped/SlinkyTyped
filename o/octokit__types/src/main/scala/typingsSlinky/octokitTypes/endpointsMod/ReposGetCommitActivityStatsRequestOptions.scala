...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashstatsSlashcommit_activity
...
object ReposGetCommitActivityStatsRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetCommitActivityStatsRequestOptionsMutableBuilder[Self <: ReposGetCommitActivityStatsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashstatsSlashcommit_activity): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
