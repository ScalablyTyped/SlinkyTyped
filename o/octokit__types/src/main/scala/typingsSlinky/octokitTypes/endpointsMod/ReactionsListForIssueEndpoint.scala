...
@js.native
trait ReactionsListForIssueEndpoint extends StObject {
...
object ReactionsListForIssueEndpoint {
  ...
  @scala.inline
  implicit class ReactionsListForIssueEndpointMutableBuilder[Self <: ReactionsListForIssueEndpoint] (val x: Self) extends AnyVal {
