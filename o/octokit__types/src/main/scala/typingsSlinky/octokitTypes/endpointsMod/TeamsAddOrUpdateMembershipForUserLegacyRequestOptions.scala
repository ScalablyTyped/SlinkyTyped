...
object TeamsAddOrUpdateMembershipForUserLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateMembershipForUserLegacyRequestOptionsOps[Self <: TeamsAddOrUpdateMembershipForUserLegacyRequestOptions] (val x: Self) extends AnyVal {
