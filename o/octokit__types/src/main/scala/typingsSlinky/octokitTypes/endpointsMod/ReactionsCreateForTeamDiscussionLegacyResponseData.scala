...
object ReactionsCreateForTeamDiscussionLegacyResponseData {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionLegacyResponseDataOps[Self <: ReactionsCreateForTeamDiscussionLegacyResponseData] (val x: Self) extends AnyVal {
