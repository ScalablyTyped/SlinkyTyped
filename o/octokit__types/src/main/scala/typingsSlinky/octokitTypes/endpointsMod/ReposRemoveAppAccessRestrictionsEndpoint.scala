...
@js.native
trait ReposRemoveAppAccessRestrictionsEndpoint extends js.Object {
  /**
    * apps parameter
    */
...
object ReposRemoveAppAccessRestrictionsEndpoint {
  ...
  @scala.inline
  implicit class ReposRemoveAppAccessRestrictionsEndpointOps[Self <: ReposRemoveAppAccessRestrictionsEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
