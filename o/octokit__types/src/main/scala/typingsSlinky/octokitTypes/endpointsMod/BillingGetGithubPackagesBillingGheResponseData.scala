...
@js.native
trait BillingGetGithubPackagesBillingGheResponseData extends js.Object {
  /**
...
object BillingGetGithubPackagesBillingGheResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BillingGetGithubPackagesBillingGheResponseData]
  }
  @scala.inline
  implicit class BillingGetGithubPackagesBillingGheResponseDataOps[Self <: BillingGetGithubPackagesBillingGheResponseData] (val x: Self) extends AnyVal {
    @scala.inline
