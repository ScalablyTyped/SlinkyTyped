...
object UsersSetPrimaryEmailVisibilityForAuthenticatedRequestOptions {
  ...
  @scala.inline
  implicit class UsersSetPrimaryEmailVisibilityForAuthenticatedRequestOptionsOps[Self <: UsersSetPrimaryEmailVisibilityForAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashemailSlashvisibility): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
