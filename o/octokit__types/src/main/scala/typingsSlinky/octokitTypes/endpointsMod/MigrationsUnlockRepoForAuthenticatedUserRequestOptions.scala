...
object MigrationsUnlockRepoForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class MigrationsUnlockRepoForAuthenticatedUserRequestOptionsOps[Self <: MigrationsUnlockRepoForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashmigrationsSlashColonmigration_idSlashreposSlashColonrepo_nameSlashlock): Self = this.set("url", value.asInstanceOf[js.Any])
  }
