...
@js.native
trait GistsGetCommentRequestOptions extends StObject {
...
object GistsGetCommentRequestOptions {
  ...
  @scala.inline
  implicit class GistsGetCommentRequestOptionsMutableBuilder[Self <: GistsGetCommentRequestOptions] (val x: Self) extends AnyVal {
