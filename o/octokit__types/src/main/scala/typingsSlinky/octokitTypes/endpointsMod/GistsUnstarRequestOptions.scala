...
@js.native
trait GistsUnstarRequestOptions extends StObject {
...
object GistsUnstarRequestOptions {
  ...
  @scala.inline
  implicit class GistsUnstarRequestOptionsMutableBuilder[Self <: GistsUnstarRequestOptions] (val x: Self) extends AnyVal {
