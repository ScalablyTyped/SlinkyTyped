...
object GistsUnstarRequestOptions {
  ...
  @scala.inline
  implicit class GistsUnstarRequestOptionsOps[Self <: GistsUnstarRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashgistsSlashColongist_idSlashstar): Self = this.set("url", value.asInstanceOf[js.Any])
  }
