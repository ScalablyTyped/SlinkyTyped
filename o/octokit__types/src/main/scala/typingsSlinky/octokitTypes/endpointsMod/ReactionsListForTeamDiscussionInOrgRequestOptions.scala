...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashdiscussionsSlashColondiscussion_numberSlashreactions
...
@js.native
trait ReactionsListForTeamDiscussionInOrgRequestOptions extends StObject {
...
object ReactionsListForTeamDiscussionInOrgRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionInOrgRequestOptionsMutableBuilder[Self <: ReactionsListForTeamDiscussionInOrgRequestOptions] (val x: Self) extends AnyVal {
