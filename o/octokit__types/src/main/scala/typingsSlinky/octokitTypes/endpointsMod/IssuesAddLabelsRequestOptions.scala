...
@js.native
trait IssuesAddLabelsRequestOptions extends StObject {
...
object IssuesAddLabelsRequestOptions {
  ...
  @scala.inline
  implicit class IssuesAddLabelsRequestOptionsMutableBuilder[Self <: IssuesAddLabelsRequestOptions] (val x: Self) extends AnyVal {
