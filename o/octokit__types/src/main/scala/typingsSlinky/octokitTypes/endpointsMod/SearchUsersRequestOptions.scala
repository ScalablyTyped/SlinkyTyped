...
object SearchUsersRequestOptions {
  ...
  @scala.inline
  implicit class SearchUsersRequestOptionsOps[Self <: SearchUsersRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashsearchSlashusers): Self = this.set("url", value.asInstanceOf[js.Any])
  }
