...
@js.native
trait TeamsGetMembershipForUserInOrgResponseData extends js.Object {
...
object TeamsGetMembershipForUserInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsGetMembershipForUserInOrgResponseDataOps[Self <: TeamsGetMembershipForUserInOrgResponseData] (val x: Self) extends AnyVal {
