...
@js.native
trait PullsRemoveRequestedReviewersRequestOptions extends js.Object {
...
object PullsRemoveRequestedReviewersRequestOptions {
  ...
  @scala.inline
  implicit class PullsRemoveRequestedReviewersRequestOptionsOps[Self <: PullsRemoveRequestedReviewersRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
