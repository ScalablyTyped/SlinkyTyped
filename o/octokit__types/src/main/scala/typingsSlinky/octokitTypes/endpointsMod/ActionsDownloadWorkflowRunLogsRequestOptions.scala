...
@js.native
trait ActionsDownloadWorkflowRunLogsRequestOptions extends js.Object {
...
object ActionsDownloadWorkflowRunLogsRequestOptions {
  ...
  @scala.inline
  implicit class ActionsDownloadWorkflowRunLogsRequestOptionsOps[Self <: ActionsDownloadWorkflowRunLogsRequestOptions] (val x: Self) extends AnyVal {
