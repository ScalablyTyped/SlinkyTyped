...
@js.native
trait ReposCreateWebhookParamsConfig extends js.Object {
...
object ReposCreateWebhookParamsConfig {
  @scala.inline
  def apply(url: String): ReposCreateWebhookParamsConfig = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposCreateWebhookParamsConfig]
  }
  @scala.inline
  implicit class ReposCreateWebhookParamsConfigOps[Self <: ReposCreateWebhookParamsConfig] (val x: Self) extends AnyVal {
    @scala.inline
