...
@js.native
trait ReposGetCommitRequestOptions extends js.Object {
...
object ReposGetCommitRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetCommitRequestOptionsOps[Self <: ReposGetCommitRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashcommitsSlashColonref): Self = this.set("url", value.asInstanceOf[js.Any])
  }
