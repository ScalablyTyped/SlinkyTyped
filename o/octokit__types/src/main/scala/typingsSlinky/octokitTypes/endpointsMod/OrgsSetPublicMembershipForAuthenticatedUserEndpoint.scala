...
object OrgsSetPublicMembershipForAuthenticatedUserEndpoint {
  ...
  @scala.inline
  implicit class OrgsSetPublicMembershipForAuthenticatedUserEndpointOps[Self <: OrgsSetPublicMembershipForAuthenticatedUserEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
