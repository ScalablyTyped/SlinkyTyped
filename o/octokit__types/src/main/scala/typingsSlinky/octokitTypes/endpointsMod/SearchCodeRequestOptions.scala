...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashsearchSlashcode
...
trait SearchCodeRequestOptions extends js.Object {
  ...
  var url: SlashsearchSlashcode = js.native
}
object SearchCodeRequestOptions {
  ...
  @scala.inline
  implicit class SearchCodeRequestOptionsOps[Self <: SearchCodeRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashsearchSlashcode): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
