...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashauthorizationsSlashclientsSlashColonclient_id
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppRequestOptions {
  ...
  @scala.inline
  implicit class OauthAuthorizationsGetOrCreateAuthorizationForAppRequestOptionsOps[Self <: OauthAuthorizationsGetOrCreateAuthorizationForAppRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashauthorizationsSlashclientsSlashColonclient_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
