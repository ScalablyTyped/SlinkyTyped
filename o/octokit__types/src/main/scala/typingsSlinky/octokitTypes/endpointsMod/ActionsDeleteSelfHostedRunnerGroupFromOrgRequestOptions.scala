...
import typingsSlinky.octokitTypes.octokitTypesStrings.`SlashorgsSlashColonorgSlashactionsSlashrunner-groupsSlashColonrunner_group_id`
...
@js.native
trait ActionsDeleteSelfHostedRunnerGroupFromOrgRequestOptions extends js.Object {
...
object ActionsDeleteSelfHostedRunnerGroupFromOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsDeleteSelfHostedRunnerGroupFromOrgRequestOptionsOps[Self <: ActionsDeleteSelfHostedRunnerGroupFromOrgRequestOptions] (val x: Self) extends AnyVal {
