...
@js.native
trait ActivityCheckRepoIsStarredByAuthenticatedUserRequestOptions extends StObject {
...
object ActivityCheckRepoIsStarredByAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ActivityCheckRepoIsStarredByAuthenticatedUserRequestOptionsMutableBuilder[Self <: ActivityCheckRepoIsStarredByAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
