...
object ActivityCheckRepoIsStarredByAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ActivityCheckRepoIsStarredByAuthenticatedUserRequestOptionsOps[Self <: ActivityCheckRepoIsStarredByAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
