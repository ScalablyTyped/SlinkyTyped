...
@js.native
trait ActionsRemoveSelfHostedRunnerFromGroupForOrgEndpoint extends StObject {
...
object ActionsRemoveSelfHostedRunnerFromGroupForOrgEndpoint {
  ...
  @scala.inline
  implicit class ActionsRemoveSelfHostedRunnerFromGroupForOrgEndpointMutableBuilder[Self <: ActionsRemoveSelfHostedRunnerFromGroupForOrgEndpoint] (val x: Self) extends AnyVal {
