...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashprojects
...
trait ProjectsCreateForAuthenticatedUserRequestOptions extends StObject {
  ...
  var url: SlashuserSlashprojects = js.native
}
object ProjectsCreateForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsCreateForAuthenticatedUserRequestOptionsMutableBuilder[Self <: ProjectsCreateForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashprojects): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
