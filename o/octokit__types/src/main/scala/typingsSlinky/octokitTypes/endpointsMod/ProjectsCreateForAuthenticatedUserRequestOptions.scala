...
object ProjectsCreateForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsCreateForAuthenticatedUserRequestOptionsOps[Self <: ProjectsCreateForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashprojects): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
