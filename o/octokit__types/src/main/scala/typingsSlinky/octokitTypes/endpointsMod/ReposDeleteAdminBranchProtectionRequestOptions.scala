...
@js.native
trait ReposDeleteAdminBranchProtectionRequestOptions extends js.Object {
...
object ReposDeleteAdminBranchProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposDeleteAdminBranchProtectionRequestOptionsOps[Self <: ReposDeleteAdminBranchProtectionRequestOptions] (val x: Self) extends AnyVal {
