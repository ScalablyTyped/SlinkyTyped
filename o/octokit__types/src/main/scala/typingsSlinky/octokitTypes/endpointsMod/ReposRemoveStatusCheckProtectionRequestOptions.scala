...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashbranchesSlashColonbranchSlashprotectionSlashrequired_status_checks
...
@js.native
trait ReposRemoveStatusCheckProtectionRequestOptions extends js.Object {
...
object ReposRemoveStatusCheckProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposRemoveStatusCheckProtectionRequestOptionsOps[Self <: ReposRemoveStatusCheckProtectionRequestOptions] (val x: Self) extends AnyVal {
