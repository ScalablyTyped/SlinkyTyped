...
@js.native
trait ReposSetTeamAccessRestrictionsRequestOptions extends js.Object {
...
object ReposSetTeamAccessRestrictionsRequestOptions {
  ...
  @scala.inline
  implicit class ReposSetTeamAccessRestrictionsRequestOptionsOps[Self <: ReposSetTeamAccessRestrictionsRequestOptions] (val x: Self) extends AnyVal {
