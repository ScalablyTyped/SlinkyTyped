...
@js.native
trait OrgsCheckPublicMembershipForUserRequestOptions extends StObject {
...
object OrgsCheckPublicMembershipForUserRequestOptions {
  ...
  @scala.inline
  implicit class OrgsCheckPublicMembershipForUserRequestOptionsMutableBuilder[Self <: OrgsCheckPublicMembershipForUserRequestOptions] (val x: Self) extends AnyVal {
