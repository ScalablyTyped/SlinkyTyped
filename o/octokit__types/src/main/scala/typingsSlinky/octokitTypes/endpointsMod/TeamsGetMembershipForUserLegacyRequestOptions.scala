...
@js.native
trait TeamsGetMembershipForUserLegacyRequestOptions extends js.Object {
...
object TeamsGetMembershipForUserLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsGetMembershipForUserLegacyRequestOptionsOps[Self <: TeamsGetMembershipForUserLegacyRequestOptions] (val x: Self) extends AnyVal {
