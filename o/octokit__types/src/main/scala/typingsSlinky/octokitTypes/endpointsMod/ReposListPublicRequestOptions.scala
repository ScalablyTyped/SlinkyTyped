...
object ReposListPublicRequestOptions {
  ...
  @scala.inline
  implicit class ReposListPublicRequestOptionsOps[Self <: ReposListPublicRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashrepositories): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
