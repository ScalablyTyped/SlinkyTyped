...
import typingsSlinky.octokitTypes.octokitTypesStrings.Slashrepositories
...
trait ReposListPublicRequestOptions extends StObject {
  ...
  var url: Slashrepositories = js.native
}
object ReposListPublicRequestOptions {
  ...
  @scala.inline
  implicit class ReposListPublicRequestOptionsMutableBuilder[Self <: ReposListPublicRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashrepositories): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
