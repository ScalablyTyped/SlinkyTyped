...
@js.native
trait TeamsDeleteDiscussionLegacyRequestOptions extends StObject {
...
object TeamsDeleteDiscussionLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsDeleteDiscussionLegacyRequestOptionsMutableBuilder[Self <: TeamsDeleteDiscussionLegacyRequestOptions] (val x: Self) extends AnyVal {
