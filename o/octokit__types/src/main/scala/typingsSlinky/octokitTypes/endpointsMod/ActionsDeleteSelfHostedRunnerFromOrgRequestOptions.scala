...
@js.native
trait ActionsDeleteSelfHostedRunnerFromOrgRequestOptions extends js.Object {
...
object ActionsDeleteSelfHostedRunnerFromOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsDeleteSelfHostedRunnerFromOrgRequestOptionsOps[Self <: ActionsDeleteSelfHostedRunnerFromOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
