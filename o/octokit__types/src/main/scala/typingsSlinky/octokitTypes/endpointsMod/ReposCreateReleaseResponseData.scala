...
@js.native
trait ReposCreateReleaseResponseData extends js.Object {
...
object ReposCreateReleaseResponseData {
  ...
  @scala.inline
  implicit class ReposCreateReleaseResponseDataOps[Self <: ReposCreateReleaseResponseData] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAssetsVarargs(value: js.Any*): Self = this.set("assets", js.Array(value :_*))
    @scala.inline
    def setAssets(value: js.Array[_]): Self = this.set("assets", value.asInstanceOf[js.Any])
    @scala.inline
