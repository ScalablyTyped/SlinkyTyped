...
@js.native
trait ScimProvisionAndInviteUserParamsName extends js.Object {
...
object ScimProvisionAndInviteUserParamsName {
  ...
  @scala.inline
  implicit class ScimProvisionAndInviteUserParamsNameOps[Self <: ScimProvisionAndInviteUserParamsName] (val x: Self) extends AnyVal {
    @scala.inline
