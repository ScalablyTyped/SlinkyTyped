...
@js.native
trait EnterpriseAdminGetGithubPackagesBillingGheDeprecatedEnterpriseIdEndpoint extends js.Object {
...
object EnterpriseAdminGetGithubPackagesBillingGheDeprecatedEnterpriseIdEndpoint {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetGithubPackagesBillingGheDeprecatedEnterpriseIdEndpointOps[Self <: EnterpriseAdminGetGithubPackagesBillingGheDeprecatedEnterpriseIdEndpoint] (val x: Self) extends AnyVal {
