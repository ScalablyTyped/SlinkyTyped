...
@js.native
trait MigrationsSetLfsPreferenceResponseData extends js.Object {
...
object MigrationsSetLfsPreferenceResponseData {
  ...
  @scala.inline
  implicit class MigrationsSetLfsPreferenceResponseDataOps[Self <: MigrationsSetLfsPreferenceResponseData] (val x: Self) extends AnyVal {
    @scala.inline
