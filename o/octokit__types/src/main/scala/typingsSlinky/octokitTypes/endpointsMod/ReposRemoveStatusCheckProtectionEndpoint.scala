...
@js.native
trait ReposRemoveStatusCheckProtectionEndpoint extends js.Object {
...
object ReposRemoveStatusCheckProtectionEndpoint {
  ...
  @scala.inline
  implicit class ReposRemoveStatusCheckProtectionEndpointOps[Self <: ReposRemoveStatusCheckProtectionEndpoint] (val x: Self) extends AnyVal {
