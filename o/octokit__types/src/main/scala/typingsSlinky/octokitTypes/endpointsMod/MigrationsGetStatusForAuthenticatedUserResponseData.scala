...
@js.native
trait MigrationsGetStatusForAuthenticatedUserResponseData extends StObject {
...
object MigrationsGetStatusForAuthenticatedUserResponseData {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForAuthenticatedUserResponseDataMutableBuilder[Self <: MigrationsGetStatusForAuthenticatedUserResponseData] (val x: Self) extends AnyVal {
