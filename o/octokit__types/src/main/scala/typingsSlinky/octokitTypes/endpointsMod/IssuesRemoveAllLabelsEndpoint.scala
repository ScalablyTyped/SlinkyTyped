...
@js.native
trait IssuesRemoveAllLabelsEndpoint extends js.Object {
...
object IssuesRemoveAllLabelsEndpoint {
  ...
  @scala.inline
  implicit class IssuesRemoveAllLabelsEndpointOps[Self <: IssuesRemoveAllLabelsEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
