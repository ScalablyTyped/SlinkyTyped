...
@js.native
trait AppsCheckTokenResponseData extends js.Object {
...
object AppsCheckTokenResponseData {
  ...
  @scala.inline
  implicit class AppsCheckTokenResponseDataOps[Self <: AppsCheckTokenResponseData] (val x: Self) extends AnyVal {
    @scala.inline
