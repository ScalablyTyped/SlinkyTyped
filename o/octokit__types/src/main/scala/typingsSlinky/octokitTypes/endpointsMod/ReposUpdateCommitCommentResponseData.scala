...
@js.native
trait ReposUpdateCommitCommentResponseData extends js.Object {
...
object ReposUpdateCommitCommentResponseData {
  ...
  @scala.inline
  implicit class ReposUpdateCommitCommentResponseDataOps[Self <: ReposUpdateCommitCommentResponseData] (val x: Self) extends AnyVal {
