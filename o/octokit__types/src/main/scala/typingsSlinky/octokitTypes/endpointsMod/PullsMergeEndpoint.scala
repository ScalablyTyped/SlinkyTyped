...
import typingsSlinky.octokitTypes.octokitTypesStrings.merge
import typingsSlinky.octokitTypes.octokitTypesStrings.rebase
import typingsSlinky.octokitTypes.octokitTypesStrings.squash
