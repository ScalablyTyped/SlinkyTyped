...
import typingsSlinky.octokitTypes.octokitTypesStrings.Slashcodes_of_conduct
...
object CodesOfConductGetAllCodesOfConductRequestOptions {
  ...
  @scala.inline
  implicit class CodesOfConductGetAllCodesOfConductRequestOptionsOps[Self <: CodesOfConductGetAllCodesOfConductRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: Slashcodes_of_conduct): Self = this.set("url", value.asInstanceOf[js.Any])
  }
