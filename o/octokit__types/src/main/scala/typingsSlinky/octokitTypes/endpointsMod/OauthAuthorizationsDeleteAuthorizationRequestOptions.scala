...
@js.native
trait OauthAuthorizationsDeleteAuthorizationRequestOptions extends StObject {
...
object OauthAuthorizationsDeleteAuthorizationRequestOptions {
  ...
  @scala.inline
  implicit class OauthAuthorizationsDeleteAuthorizationRequestOptionsMutableBuilder[Self <: OauthAuthorizationsDeleteAuthorizationRequestOptions] (val x: Self) extends AnyVal {
