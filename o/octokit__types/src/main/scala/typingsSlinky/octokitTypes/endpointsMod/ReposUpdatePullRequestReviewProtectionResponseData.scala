...
@js.native
trait ReposUpdatePullRequestReviewProtectionResponseData extends js.Object {
...
object ReposUpdatePullRequestReviewProtectionResponseData {
  ...
  @scala.inline
  implicit class ReposUpdatePullRequestReviewProtectionResponseDataOps[Self <: ReposUpdatePullRequestReviewProtectionResponseData] (val x: Self) extends AnyVal {
