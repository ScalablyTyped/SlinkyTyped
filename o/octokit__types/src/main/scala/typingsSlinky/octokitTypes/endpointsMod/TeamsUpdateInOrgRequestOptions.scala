...
@js.native
trait TeamsUpdateInOrgRequestOptions extends StObject {
...
object TeamsUpdateInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsUpdateInOrgRequestOptionsMutableBuilder[Self <: TeamsUpdateInOrgRequestOptions] (val x: Self) extends AnyVal {
