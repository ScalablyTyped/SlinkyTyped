...
@js.native
trait BillingGetGithubActionsBillingGheResponseData extends js.Object {
...
object BillingGetGithubActionsBillingGheResponseData {
  ...
  def apply(
  ...
  ): BillingGetGithubActionsBillingGheResponseData = {
    ...
    __obj.asInstanceOf[BillingGetGithubActionsBillingGheResponseData]
  }
  
  @scala.inline
  implicit class BillingGetGithubActionsBillingGheResponseDataOps[Self <: BillingGetGithubActionsBillingGheResponseData] (val x: Self) extends AnyVal {
