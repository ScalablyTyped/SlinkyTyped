...
@js.native
trait AppsResetAuthorizationResponseData extends js.Object {
...
object AppsResetAuthorizationResponseData {
  ...
  @scala.inline
  implicit class AppsResetAuthorizationResponseDataOps[Self <: AppsResetAuthorizationResponseData] (val x: Self) extends AnyVal {
    @scala.inline
