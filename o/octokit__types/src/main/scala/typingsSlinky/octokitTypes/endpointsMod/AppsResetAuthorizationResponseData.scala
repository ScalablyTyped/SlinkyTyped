...
@js.native
trait AppsResetAuthorizationResponseData extends StObject {
...
object AppsResetAuthorizationResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AppsResetAuthorizationResponseData]
  }
  
  @scala.inline
  implicit class AppsResetAuthorizationResponseDataMutableBuilder[Self <: AppsResetAuthorizationResponseData] (val x: Self) extends AnyVal {
