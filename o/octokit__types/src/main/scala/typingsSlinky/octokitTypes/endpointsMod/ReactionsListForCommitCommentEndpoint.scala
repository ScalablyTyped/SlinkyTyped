...
object ReactionsListForCommitCommentEndpoint {
  @scala.inline
  def apply(comment_id: Double, mediaType: `12`, owner: String, repo: String): ReactionsListForCommitCommentEndpoint = {
  ...
  @scala.inline
  implicit class ReactionsListForCommitCommentEndpointOps[Self <: ReactionsListForCommitCommentEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
