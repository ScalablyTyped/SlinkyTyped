...
object OauthAuthorizationsListGrantsRequestOptions {
  ...
  @scala.inline
  implicit class OauthAuthorizationsListGrantsRequestOptionsOps[Self <: OauthAuthorizationsListGrantsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashapplicationsSlashgrants): Self = this.set("url", value.asInstanceOf[js.Any])
  }
