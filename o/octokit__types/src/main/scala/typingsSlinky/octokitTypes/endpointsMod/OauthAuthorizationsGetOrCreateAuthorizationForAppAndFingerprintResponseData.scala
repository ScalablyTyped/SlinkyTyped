...
import typingsSlinky.octokitTypes.anon.Clientid
...
@js.native
trait OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponseData extends StObject {
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponseData]
  }
  
  @scala.inline
  implicit class OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponseDataMutableBuilder[Self <: OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponseData] (val x: Self) extends AnyVal {
