...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashrepos
...
object TeamsListReposInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsListReposInOrgRequestOptionsOps[Self <: TeamsListReposInOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashrepos): Self = this.set("url", value.asInstanceOf[js.Any])
  }
