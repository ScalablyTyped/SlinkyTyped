...
@js.native
trait ReposSetAdminBranchProtectionRequestOptions extends js.Object {
...
object ReposSetAdminBranchProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposSetAdminBranchProtectionRequestOptionsOps[Self <: ReposSetAdminBranchProtectionRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
