...
@js.native
trait ReactionsCreateForCommitCommentResponseData extends StObject {
...
object ReactionsCreateForCommitCommentResponseData {
  ...
  @scala.inline
  def apply(content: String, created_at: String, id: Double, node_id: String, user: Avatarurl): ReactionsCreateForCommitCommentResponseData = {
  ...
  @scala.inline
  implicit class ReactionsCreateForCommitCommentResponseDataMutableBuilder[Self <: ReactionsCreateForCommitCommentResponseData] (val x: Self) extends AnyVal {
