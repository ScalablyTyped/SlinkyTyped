...
@js.native
trait ReposCreateCommitStatusResponseData extends js.Object {
...
object ReposCreateCommitStatusResponseData {
  ...
  @scala.inline
  implicit class ReposCreateCommitStatusResponseDataOps[Self <: ReposCreateCommitStatusResponseData] (val x: Self) extends AnyVal {
    @scala.inline
