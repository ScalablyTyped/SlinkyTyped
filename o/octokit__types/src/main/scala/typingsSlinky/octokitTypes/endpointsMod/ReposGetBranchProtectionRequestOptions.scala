...
@js.native
trait ReposGetBranchProtectionRequestOptions extends StObject {
...
object ReposGetBranchProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionRequestOptionsMutableBuilder[Self <: ReposGetBranchProtectionRequestOptions] (val x: Self) extends AnyVal {
