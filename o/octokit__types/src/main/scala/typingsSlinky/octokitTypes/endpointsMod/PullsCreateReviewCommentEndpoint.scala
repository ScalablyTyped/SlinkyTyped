...
import typingsSlinky.octokitTypes.octokitTypesStrings.LEFT
import typingsSlinky.octokitTypes.octokitTypesStrings.RIGHT
import typingsSlinky.octokitTypes.octokitTypesStrings.side
