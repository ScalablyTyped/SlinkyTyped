...
@js.native
trait ActionsListWorkflowRunsForRepoRequestOptions extends js.Object {
...
object ActionsListWorkflowRunsForRepoRequestOptions {
  ...
  @scala.inline
  implicit class ActionsListWorkflowRunsForRepoRequestOptionsOps[Self <: ActionsListWorkflowRunsForRepoRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashactionsSlashruns): Self = this.set("url", value.asInstanceOf[js.Any])
  }
