...
@js.native
trait PullsSubmitReviewResponseData extends StObject {
...
object PullsSubmitReviewResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PullsSubmitReviewResponseData]
  }
  
  @scala.inline
  implicit class PullsSubmitReviewResponseDataMutableBuilder[Self <: PullsSubmitReviewResponseData] (val x: Self) extends AnyVal {
