...
@js.native
trait PullsSubmitReviewResponseData extends js.Object {
...
object PullsSubmitReviewResponseData {
  ...
  @scala.inline
  implicit class PullsSubmitReviewResponseDataOps[Self <: PullsSubmitReviewResponseData] (val x: Self) extends AnyVal {
