...
import typingsSlinky.octokitTypes.octokitTypesStrings.`SlashreposSlashColonownerSlashColonrepoSlashcheck-suitesSlashColoncheck_suite_idSlashrerequest`
...
trait ChecksRerequestSuiteRequestOptions extends js.Object {
  ...
  var url: `SlashreposSlashColonownerSlashColonrepoSlashcheck-suitesSlashColoncheck_suite_idSlashrerequest` = js.native
}
object ChecksRerequestSuiteRequestOptions {
  ...
  @scala.inline
  implicit class ChecksRerequestSuiteRequestOptionsOps[Self <: ChecksRerequestSuiteRequestOptions] (val x: Self) extends AnyVal {
