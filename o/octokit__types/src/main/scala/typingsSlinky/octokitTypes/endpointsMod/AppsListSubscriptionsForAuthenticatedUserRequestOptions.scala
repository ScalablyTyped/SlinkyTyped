...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashmarketplace_purchases
...
object AppsListSubscriptionsForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class AppsListSubscriptionsForAuthenticatedUserRequestOptionsOps[Self <: AppsListSubscriptionsForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashmarketplace_purchases): Self = this.set("url", value.asInstanceOf[js.Any])
  }
