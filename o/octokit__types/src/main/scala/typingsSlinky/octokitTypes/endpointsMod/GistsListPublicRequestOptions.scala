...
object GistsListPublicRequestOptions {
  ...
  @scala.inline
  implicit class GistsListPublicRequestOptionsOps[Self <: GistsListPublicRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashgistsSlashpublic): Self = this.set("url", value.asInstanceOf[js.Any])
  }
