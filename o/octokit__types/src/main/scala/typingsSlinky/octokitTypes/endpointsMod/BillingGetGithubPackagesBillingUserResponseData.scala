...
object BillingGetGithubPackagesBillingUserResponseData {
  ...
  @scala.inline
  implicit class BillingGetGithubPackagesBillingUserResponseDataMutableBuilder[Self <: BillingGetGithubPackagesBillingUserResponseData] (val x: Self) extends AnyVal {
