...
@js.native
trait OauthAuthorizationsUpdateAuthorizationResponseData extends js.Object {
...
object OauthAuthorizationsUpdateAuthorizationResponseData {
  ...
  @scala.inline
  implicit class OauthAuthorizationsUpdateAuthorizationResponseDataOps[Self <: OauthAuthorizationsUpdateAuthorizationResponseData] (val x: Self) extends AnyVal {
    @scala.inline
