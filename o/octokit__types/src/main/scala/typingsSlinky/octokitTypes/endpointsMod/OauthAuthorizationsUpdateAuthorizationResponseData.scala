...
@js.native
trait OauthAuthorizationsUpdateAuthorizationResponseData extends StObject {
...
object OauthAuthorizationsUpdateAuthorizationResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsUpdateAuthorizationResponseData]
  }
  
  @scala.inline
  implicit class OauthAuthorizationsUpdateAuthorizationResponseDataMutableBuilder[Self <: OauthAuthorizationsUpdateAuthorizationResponseData] (val x: Self) extends AnyVal {
