...
@js.native
trait TeamsAddOrUpdateProjectPermissionsLegacyResponseData extends js.Object {
...
object TeamsAddOrUpdateProjectPermissionsLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateProjectPermissionsLegacyResponseDataOps[Self <: TeamsAddOrUpdateProjectPermissionsLegacyResponseData] (val x: Self) extends AnyVal {
    @scala.inline
