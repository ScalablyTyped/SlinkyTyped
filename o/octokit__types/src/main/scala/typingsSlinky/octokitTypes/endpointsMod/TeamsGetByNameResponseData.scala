...
@js.native
trait TeamsGetByNameResponseData extends StObject {
...
object TeamsGetByNameResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetByNameResponseData]
  }
  
  @scala.inline
  implicit class TeamsGetByNameResponseDataMutableBuilder[Self <: TeamsGetByNameResponseData] (val x: Self) extends AnyVal {
