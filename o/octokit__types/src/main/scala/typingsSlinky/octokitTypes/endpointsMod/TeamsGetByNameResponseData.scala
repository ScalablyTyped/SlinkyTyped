...
@js.native
trait TeamsGetByNameResponseData extends js.Object {
...
object TeamsGetByNameResponseData {
  ...
  @scala.inline
  implicit class TeamsGetByNameResponseDataOps[Self <: TeamsGetByNameResponseData] (val x: Self) extends AnyVal {
