...
@js.native
trait ActionsAddSelfHostedRunnerToGroupForOrgEndpoint extends js.Object {
...
object ActionsAddSelfHostedRunnerToGroupForOrgEndpoint {
  ...
  @scala.inline
  implicit class ActionsAddSelfHostedRunnerToGroupForOrgEndpointOps[Self <: ActionsAddSelfHostedRunnerToGroupForOrgEndpoint] (val x: Self) extends AnyVal {
