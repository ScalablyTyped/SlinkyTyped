...
@js.native
trait IssuesListEventsForTimelineRequestOptions extends StObject {
...
object IssuesListEventsForTimelineRequestOptions {
  ...
  @scala.inline
  implicit class IssuesListEventsForTimelineRequestOptionsMutableBuilder[Self <: IssuesListEventsForTimelineRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashissuesSlashColonissue_numberSlashtimeline): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
