...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashreviewsSlashColonreview_id
...
@js.native
trait PullsDeletePendingReviewRequestOptions extends js.Object {
...
object PullsDeletePendingReviewRequestOptions {
  ...
  @scala.inline
  implicit class PullsDeletePendingReviewRequestOptionsOps[Self <: PullsDeletePendingReviewRequestOptions] (val x: Self) extends AnyVal {
