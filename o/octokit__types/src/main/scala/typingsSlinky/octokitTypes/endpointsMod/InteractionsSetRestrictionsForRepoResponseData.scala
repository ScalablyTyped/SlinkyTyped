...
@js.native
trait InteractionsSetRestrictionsForRepoResponseData extends js.Object {
...
object InteractionsSetRestrictionsForRepoResponseData {
  ...
  @scala.inline
  def apply(expires_at: String, limit: String, origin: String): InteractionsSetRestrictionsForRepoResponseData = {
    ...
    __obj.asInstanceOf[InteractionsSetRestrictionsForRepoResponseData]
  }
  
  @scala.inline
  implicit class InteractionsSetRestrictionsForRepoResponseDataOps[Self <: InteractionsSetRestrictionsForRepoResponseData] (val x: Self) extends AnyVal {
