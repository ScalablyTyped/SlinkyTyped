...
object InteractionsSetRestrictionsForRepoResponseData {
  ...
  @scala.inline
  implicit class InteractionsSetRestrictionsForRepoResponseDataMutableBuilder[Self <: InteractionsSetRestrictionsForRepoResponseData] (val x: Self) extends AnyVal {
