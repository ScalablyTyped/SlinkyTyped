...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashcollaboratorsSlashColonusername
...
@js.native
trait ReposAddCollaboratorRequestOptions extends js.Object {
...
object ReposAddCollaboratorRequestOptions {
  ...
  @scala.inline
  implicit class ReposAddCollaboratorRequestOptionsOps[Self <: ReposAddCollaboratorRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashcollaboratorsSlashColonusername): Self = this.set("url", value.asInstanceOf[js.Any])
  }
