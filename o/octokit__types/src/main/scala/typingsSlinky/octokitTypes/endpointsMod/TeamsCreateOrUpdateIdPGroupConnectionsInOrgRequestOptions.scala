...
object TeamsCreateOrUpdateIdPGroupConnectionsInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCreateOrUpdateIdPGroupConnectionsInOrgRequestOptionsOps[Self <: TeamsCreateOrUpdateIdPGroupConnectionsInOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
