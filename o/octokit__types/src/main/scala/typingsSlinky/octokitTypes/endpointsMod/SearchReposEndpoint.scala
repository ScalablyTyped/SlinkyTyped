...
import typingsSlinky.octokitTypes.octokitTypesStrings.`help-wanted-issues`
...
import typingsSlinky.octokitTypes.octokitTypesStrings.stars
...
object SearchReposEndpoint {
  ...
  @scala.inline
  implicit class SearchReposEndpointOps[Self <: SearchReposEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSort(value: stars | forks | `help-wanted-issues` | updated): Self = this.set("sort", value.asInstanceOf[js.Any])
    @scala.inline
