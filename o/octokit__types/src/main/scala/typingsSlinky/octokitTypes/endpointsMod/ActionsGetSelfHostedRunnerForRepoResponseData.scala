...
object ActionsGetSelfHostedRunnerForRepoResponseData {
  ...
  @scala.inline
  implicit class ActionsGetSelfHostedRunnerForRepoResponseDataMutableBuilder[Self <: ActionsGetSelfHostedRunnerForRepoResponseData] (val x: Self) extends AnyVal {
