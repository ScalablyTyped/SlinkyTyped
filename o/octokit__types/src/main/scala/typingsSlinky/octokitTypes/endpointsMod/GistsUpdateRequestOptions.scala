...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashgistsSlashColongist_id
...
object GistsUpdateRequestOptions {
  ...
  @scala.inline
  implicit class GistsUpdateRequestOptionsOps[Self <: GistsUpdateRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashgistsSlashColongist_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
