...
@js.native
trait GistsUpdateRequestOptions extends StObject {
...
object GistsUpdateRequestOptions {
  ...
  @scala.inline
  implicit class GistsUpdateRequestOptionsMutableBuilder[Self <: GistsUpdateRequestOptions] (val x: Self) extends AnyVal {
