...
@js.native
trait EnterpriseAdminProvisionAndInviteEnterpriseUserResponseData extends StObject {
...
object EnterpriseAdminProvisionAndInviteEnterpriseUserResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EnterpriseAdminProvisionAndInviteEnterpriseUserResponseData]
  }
  
  @scala.inline
  implicit class EnterpriseAdminProvisionAndInviteEnterpriseUserResponseDataMutableBuilder[Self <: EnterpriseAdminProvisionAndInviteEnterpriseUserResponseData] (val x: Self) extends AnyVal {
