...
@js.native
trait PullsCreateReviewCommentResponseData extends js.Object {
...
object PullsCreateReviewCommentResponseData {
  ...
  @scala.inline
  implicit class PullsCreateReviewCommentResponseDataOps[Self <: PullsCreateReviewCommentResponseData] (val x: Self) extends AnyVal {
