...
@js.native
trait PullsCreateReviewCommentResponseData extends StObject {
...
object PullsCreateReviewCommentResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateReviewCommentResponseData]
  }
  
  @scala.inline
  implicit class PullsCreateReviewCommentResponseDataMutableBuilder[Self <: PullsCreateReviewCommentResponseData] (val x: Self) extends AnyVal {
