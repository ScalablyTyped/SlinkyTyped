...
@js.native
trait UsersCheckPersonIsFollowedByAuthenticatedRequestOptions extends StObject {
...
object UsersCheckPersonIsFollowedByAuthenticatedRequestOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[UsersCheckPersonIsFollowedByAuthenticatedRequestOptions]
  }
  
  @scala.inline
  implicit class UsersCheckPersonIsFollowedByAuthenticatedRequestOptionsMutableBuilder[Self <: UsersCheckPersonIsFollowedByAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
