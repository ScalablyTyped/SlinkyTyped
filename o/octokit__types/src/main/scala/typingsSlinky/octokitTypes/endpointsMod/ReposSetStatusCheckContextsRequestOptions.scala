...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashbranchesSlashColonbranchSlashprotectionSlashrequired_status_checksSlashcontexts
...
@js.native
trait ReposSetStatusCheckContextsRequestOptions extends js.Object {
...
object ReposSetStatusCheckContextsRequestOptions {
  ...
  @scala.inline
  implicit class ReposSetStatusCheckContextsRequestOptionsOps[Self <: ReposSetStatusCheckContextsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
