...
@js.native
trait IssuesAddAssigneesResponseData extends js.Object {
...
object IssuesAddAssigneesResponseData {
  ...
  @scala.inline
  implicit class IssuesAddAssigneesResponseDataOps[Self <: IssuesAddAssigneesResponseData] (val x: Self) extends AnyVal {
