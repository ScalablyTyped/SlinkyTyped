...
@js.native
trait PullsRequestReviewersRequestOptions extends js.Object {
...
object PullsRequestReviewersRequestOptions {
  ...
  @scala.inline
  implicit class PullsRequestReviewersRequestOptionsOps[Self <: PullsRequestReviewersRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
