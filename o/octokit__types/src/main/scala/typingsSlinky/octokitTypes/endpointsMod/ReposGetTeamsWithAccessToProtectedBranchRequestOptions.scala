...
object ReposGetTeamsWithAccessToProtectedBranchRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetTeamsWithAccessToProtectedBranchRequestOptionsOps[Self <: ReposGetTeamsWithAccessToProtectedBranchRequestOptions] (val x: Self) extends AnyVal {
