...
@js.native
trait TeamsListDiscussionsInOrgEndpoint extends js.Object {
...
object TeamsListDiscussionsInOrgEndpoint {
  ...
  @scala.inline
  implicit class TeamsListDiscussionsInOrgEndpointOps[Self <: TeamsListDiscussionsInOrgEndpoint] (val x: Self) extends AnyVal {
