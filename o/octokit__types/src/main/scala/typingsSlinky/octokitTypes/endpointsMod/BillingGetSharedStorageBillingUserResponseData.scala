...
@js.native
trait BillingGetSharedStorageBillingUserResponseData extends js.Object {
...
object BillingGetSharedStorageBillingUserResponseData {
  ...
  @scala.inline
  implicit class BillingGetSharedStorageBillingUserResponseDataOps[Self <: BillingGetSharedStorageBillingUserResponseData] (val x: Self) extends AnyVal {
