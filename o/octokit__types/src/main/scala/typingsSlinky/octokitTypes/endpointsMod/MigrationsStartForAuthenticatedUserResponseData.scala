...
object MigrationsStartForAuthenticatedUserResponseData {
  ...
  @scala.inline
  implicit class MigrationsStartForAuthenticatedUserResponseDataMutableBuilder[Self <: MigrationsStartForAuthenticatedUserResponseData] (val x: Self) extends AnyVal {
