...
@js.native
trait MigrationsStartForAuthenticatedUserResponseData extends js.Object {
...
object MigrationsStartForAuthenticatedUserResponseData {
  ...
  @scala.inline
  implicit class MigrationsStartForAuthenticatedUserResponseDataOps[Self <: MigrationsStartForAuthenticatedUserResponseData] (val x: Self) extends AnyVal {
