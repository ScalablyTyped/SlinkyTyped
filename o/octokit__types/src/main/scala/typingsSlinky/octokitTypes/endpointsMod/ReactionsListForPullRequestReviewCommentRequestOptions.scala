...
@js.native
trait ReactionsListForPullRequestReviewCommentRequestOptions extends StObject {
...
object ReactionsListForPullRequestReviewCommentRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsListForPullRequestReviewCommentRequestOptionsMutableBuilder[Self <: ReactionsListForPullRequestReviewCommentRequestOptions] (val x: Self) extends AnyVal {
