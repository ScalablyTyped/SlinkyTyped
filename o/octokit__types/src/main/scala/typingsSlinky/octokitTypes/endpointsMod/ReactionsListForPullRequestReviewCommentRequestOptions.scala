...
object ReactionsListForPullRequestReviewCommentRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsListForPullRequestReviewCommentRequestOptionsOps[Self <: ReactionsListForPullRequestReviewCommentRequestOptions] (val x: Self) extends AnyVal {
