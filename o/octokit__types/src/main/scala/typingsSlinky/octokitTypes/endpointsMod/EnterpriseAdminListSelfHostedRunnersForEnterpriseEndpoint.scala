...
@js.native
trait EnterpriseAdminListSelfHostedRunnersForEnterpriseEndpoint extends js.Object {
...
object EnterpriseAdminListSelfHostedRunnersForEnterpriseEndpoint {
  ...
  @scala.inline
  implicit class EnterpriseAdminListSelfHostedRunnersForEnterpriseEndpointOps[Self <: EnterpriseAdminListSelfHostedRunnersForEnterpriseEndpoint] (val x: Self) extends AnyVal {
