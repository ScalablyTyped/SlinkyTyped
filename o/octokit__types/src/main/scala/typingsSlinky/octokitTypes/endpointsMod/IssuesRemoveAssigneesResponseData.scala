...
@js.native
trait IssuesRemoveAssigneesResponseData extends js.Object {
...
object IssuesRemoveAssigneesResponseData {
  ...
  @scala.inline
  implicit class IssuesRemoveAssigneesResponseDataOps[Self <: IssuesRemoveAssigneesResponseData] (val x: Self) extends AnyVal {
    @scala.inline
