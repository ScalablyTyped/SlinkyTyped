...
@js.native
trait IssuesRemoveAssigneesResponseData extends StObject {
...
object IssuesRemoveAssigneesResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IssuesRemoveAssigneesResponseData]
  }
  
  @scala.inline
  implicit class IssuesRemoveAssigneesResponseDataMutableBuilder[Self <: IssuesRemoveAssigneesResponseData] (val x: Self) extends AnyVal {
