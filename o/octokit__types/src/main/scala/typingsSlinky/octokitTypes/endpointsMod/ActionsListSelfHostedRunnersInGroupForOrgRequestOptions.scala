...
@js.native
trait ActionsListSelfHostedRunnersInGroupForOrgRequestOptions extends js.Object {
...
object ActionsListSelfHostedRunnersInGroupForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsListSelfHostedRunnersInGroupForOrgRequestOptionsOps[Self <: ActionsListSelfHostedRunnersInGroupForOrgRequestOptions] (val x: Self) extends AnyVal {
