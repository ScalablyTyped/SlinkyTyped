...
@js.native
trait ActionsListSelfHostedRunnersInGroupForOrgRequestOptions extends StObject {
...
object ActionsListSelfHostedRunnersInGroupForOrgRequestOptions {
  ...
  ): ActionsListSelfHostedRunnersInGroupForOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActionsListSelfHostedRunnersInGroupForOrgRequestOptions]
  }
  
  @scala.inline
  implicit class ActionsListSelfHostedRunnersInGroupForOrgRequestOptionsMutableBuilder[Self <: ActionsListSelfHostedRunnersInGroupForOrgRequestOptions] (val x: Self) extends AnyVal {
