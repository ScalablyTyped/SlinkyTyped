...
@js.native
trait ProjectsCreateForRepoResponseData extends js.Object {
...
object ProjectsCreateForRepoResponseData {
  ...
  @scala.inline
  implicit class ProjectsCreateForRepoResponseDataOps[Self <: ProjectsCreateForRepoResponseData] (val x: Self) extends AnyVal {
    @scala.inline
