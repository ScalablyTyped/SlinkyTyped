...
import typingsSlinky.octokitTypes.octokitTypesStrings.Slashmarketplace_listingSlashaccountsSlashColonaccount_id
...
object AppsGetSubscriptionPlanForAccountRequestOptions {
  ...
  @scala.inline
  implicit class AppsGetSubscriptionPlanForAccountRequestOptionsOps[Self <: AppsGetSubscriptionPlanForAccountRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashmarketplace_listingSlashaccountsSlashColonaccount_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
