...
object EnterpriseAdminUpdateAttributeForEnterpriseUserRequestOptions {
  ...
  @scala.inline
  implicit class EnterpriseAdminUpdateAttributeForEnterpriseUserRequestOptionsMutableBuilder[Self <: EnterpriseAdminUpdateAttributeForEnterpriseUserRequestOptions] (val x: Self) extends AnyVal {
