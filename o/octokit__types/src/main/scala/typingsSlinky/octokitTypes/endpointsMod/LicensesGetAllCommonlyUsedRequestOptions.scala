...
object LicensesGetAllCommonlyUsedRequestOptions {
  ...
  @scala.inline
  implicit class LicensesGetAllCommonlyUsedRequestOptionsOps[Self <: LicensesGetAllCommonlyUsedRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashlicenses): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
