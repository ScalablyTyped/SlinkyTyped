...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashapplicationsSlashColonclient_idSlashgrantsSlashColonaccess_token
...
object AppsRevokeGrantForApplicationRequestOptions {
  ...
  @scala.inline
  implicit class AppsRevokeGrantForApplicationRequestOptionsOps[Self <: AppsRevokeGrantForApplicationRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashapplicationsSlashColonclient_idSlashgrantsSlashColonaccess_token): Self = this.set("url", value.asInstanceOf[js.Any])
  }
