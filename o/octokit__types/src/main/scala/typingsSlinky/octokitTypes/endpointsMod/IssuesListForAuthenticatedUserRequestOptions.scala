...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashissues
...
trait IssuesListForAuthenticatedUserRequestOptions extends StObject {
  ...
  var url: SlashuserSlashissues = js.native
}
object IssuesListForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserRequestOptionsMutableBuilder[Self <: IssuesListForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashissues): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
