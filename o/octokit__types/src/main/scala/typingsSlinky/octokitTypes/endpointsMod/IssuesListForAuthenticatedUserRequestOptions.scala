...
object IssuesListForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserRequestOptionsOps[Self <: IssuesListForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashissues): Self = this.set("url", value.asInstanceOf[js.Any])
  }
