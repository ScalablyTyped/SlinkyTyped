...
import typingsSlinky.octokitTypes.anon.Collaborators
...
@js.native
trait UsersUpdateAuthenticatedResponseData extends StObject {
...
object UsersUpdateAuthenticatedResponseData {
  ...
  @scala.inline
  implicit class UsersUpdateAuthenticatedResponseDataMutableBuilder[Self <: UsersUpdateAuthenticatedResponseData] (val x: Self) extends AnyVal {
