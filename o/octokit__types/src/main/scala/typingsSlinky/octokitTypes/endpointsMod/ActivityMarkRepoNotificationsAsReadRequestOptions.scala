...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashnotifications
...
object ActivityMarkRepoNotificationsAsReadRequestOptions {
  ...
  @scala.inline
  implicit class ActivityMarkRepoNotificationsAsReadRequestOptionsOps[Self <: ActivityMarkRepoNotificationsAsReadRequestOptions] (val x: Self) extends AnyVal {
