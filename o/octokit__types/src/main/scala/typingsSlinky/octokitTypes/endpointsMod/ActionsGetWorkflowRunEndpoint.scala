...
@js.native
trait ActionsGetWorkflowRunEndpoint extends js.Object {
...
object ActionsGetWorkflowRunEndpoint {
  ...
  @scala.inline
  implicit class ActionsGetWorkflowRunEndpointOps[Self <: ActionsGetWorkflowRunEndpoint] (val x: Self) extends AnyVal {
