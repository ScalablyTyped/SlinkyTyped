...
object ReactionsListForIssueCommentEndpoint {
  @scala.inline
  def apply(comment_id: Double, mediaType: `12`, owner: String, repo: String): ReactionsListForIssueCommentEndpoint = {
  ...
  @scala.inline
  implicit class ReactionsListForIssueCommentEndpointOps[Self <: ReactionsListForIssueCommentEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
