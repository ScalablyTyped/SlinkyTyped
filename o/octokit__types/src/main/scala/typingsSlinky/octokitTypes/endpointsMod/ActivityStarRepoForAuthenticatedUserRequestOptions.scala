...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashstarredSlashColonownerSlashColonrepo
...
@js.native
trait ActivityStarRepoForAuthenticatedUserRequestOptions extends js.Object {
...
object ActivityStarRepoForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ActivityStarRepoForAuthenticatedUserRequestOptionsOps[Self <: ActivityStarRepoForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashstarredSlashColonownerSlashColonrepo): Self = this.set("url", value.asInstanceOf[js.Any])
  }
