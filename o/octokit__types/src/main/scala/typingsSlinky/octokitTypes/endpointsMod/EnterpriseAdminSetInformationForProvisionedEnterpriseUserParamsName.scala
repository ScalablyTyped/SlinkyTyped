...
@js.native
trait EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsName extends js.Object {
...
object EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsName {
  ...
  @scala.inline
  implicit class EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsNameOps[Self <: EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsName] (val x: Self) extends AnyVal {
    @scala.inline
