...
@js.native
trait OrgsListInvitationTeamsEndpoint extends StObject {
...
object OrgsListInvitationTeamsEndpoint {
  ...
  @scala.inline
  implicit class OrgsListInvitationTeamsEndpointMutableBuilder[Self <: OrgsListInvitationTeamsEndpoint] (val x: Self) extends AnyVal {
