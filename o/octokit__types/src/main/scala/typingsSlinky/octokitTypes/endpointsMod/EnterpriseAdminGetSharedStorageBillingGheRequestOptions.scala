...
@js.native
trait EnterpriseAdminGetSharedStorageBillingGheRequestOptions extends js.Object {
...
object EnterpriseAdminGetSharedStorageBillingGheRequestOptions {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetSharedStorageBillingGheRequestOptionsOps[Self <: EnterpriseAdminGetSharedStorageBillingGheRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashenterprisesSlashColonenterpriseSlashsettingsSlashbillingSlashshared-storage`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
