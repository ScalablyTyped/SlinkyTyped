...
@js.native
trait ReposUpdateWebhookRequestOptions extends StObject {
...
object ReposUpdateWebhookRequestOptions {
  ...
  @scala.inline
  implicit class ReposUpdateWebhookRequestOptionsMutableBuilder[Self <: ReposUpdateWebhookRequestOptions] (val x: Self) extends AnyVal {
