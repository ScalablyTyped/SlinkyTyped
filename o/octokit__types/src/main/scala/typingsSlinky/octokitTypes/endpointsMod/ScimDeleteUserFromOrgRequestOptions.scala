...
@js.native
trait ScimDeleteUserFromOrgRequestOptions extends StObject {
...
object ScimDeleteUserFromOrgRequestOptions {
  ...
  @scala.inline
  implicit class ScimDeleteUserFromOrgRequestOptionsMutableBuilder[Self <: ScimDeleteUserFromOrgRequestOptions] (val x: Self) extends AnyVal {
