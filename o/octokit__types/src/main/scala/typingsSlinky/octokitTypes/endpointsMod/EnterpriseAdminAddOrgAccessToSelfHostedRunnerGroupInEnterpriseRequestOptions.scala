...
import typingsSlinky.octokitTypes.octokitTypesStrings.`SlashenterprisesSlashColonenterpriseSlashactionsSlashrunner-groupsSlashColonrunner_group_idSlashorganizationsSlashColonorg_id`
...
@js.native
trait EnterpriseAdminAddOrgAccessToSelfHostedRunnerGroupInEnterpriseRequestOptions extends js.Object {
...
object EnterpriseAdminAddOrgAccessToSelfHostedRunnerGroupInEnterpriseRequestOptions {
  ...
  @scala.inline
  implicit class EnterpriseAdminAddOrgAccessToSelfHostedRunnerGroupInEnterpriseRequestOptionsOps[Self <: EnterpriseAdminAddOrgAccessToSelfHostedRunnerGroupInEnterpriseRequestOptions] (val x: Self) extends AnyVal {
