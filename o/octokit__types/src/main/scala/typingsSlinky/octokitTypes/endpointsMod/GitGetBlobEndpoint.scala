...
object GitGetBlobEndpoint {
  ...
  @scala.inline
  implicit class GitGetBlobEndpointOps[Self <: GitGetBlobEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFile_sha(value: String): Self = this.set("file_sha", value.asInstanceOf[js.Any])
