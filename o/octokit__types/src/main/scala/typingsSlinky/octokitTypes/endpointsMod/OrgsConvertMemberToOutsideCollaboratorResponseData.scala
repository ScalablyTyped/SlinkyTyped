...
@js.native
trait OrgsConvertMemberToOutsideCollaboratorResponseData extends js.Object {
...
object OrgsConvertMemberToOutsideCollaboratorResponseData {
  ...
  @scala.inline
  implicit class OrgsConvertMemberToOutsideCollaboratorResponseDataOps[Self <: OrgsConvertMemberToOutsideCollaboratorResponseData] (val x: Self) extends AnyVal {
    @scala.inline
