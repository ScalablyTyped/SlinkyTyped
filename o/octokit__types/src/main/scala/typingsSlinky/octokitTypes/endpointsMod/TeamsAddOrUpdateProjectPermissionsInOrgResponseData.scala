...
@js.native
trait TeamsAddOrUpdateProjectPermissionsInOrgResponseData extends js.Object {
...
object TeamsAddOrUpdateProjectPermissionsInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateProjectPermissionsInOrgResponseDataOps[Self <: TeamsAddOrUpdateProjectPermissionsInOrgResponseData] (val x: Self) extends AnyVal {
