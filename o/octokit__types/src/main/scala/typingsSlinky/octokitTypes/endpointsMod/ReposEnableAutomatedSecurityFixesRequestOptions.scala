...
object ReposEnableAutomatedSecurityFixesRequestOptions {
  ...
  @scala.inline
  implicit class ReposEnableAutomatedSecurityFixesRequestOptionsMutableBuilder[Self <: ReposEnableAutomatedSecurityFixesRequestOptions] (val x: Self) extends AnyVal {
