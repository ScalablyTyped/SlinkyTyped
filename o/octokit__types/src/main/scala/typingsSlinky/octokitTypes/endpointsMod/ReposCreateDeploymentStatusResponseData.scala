...
@js.native
trait ReposCreateDeploymentStatusResponseData extends js.Object {
...
object ReposCreateDeploymentStatusResponseData {
  ...
  @scala.inline
  implicit class ReposCreateDeploymentStatusResponseDataOps[Self <: ReposCreateDeploymentStatusResponseData] (val x: Self) extends AnyVal {
    @scala.inline
