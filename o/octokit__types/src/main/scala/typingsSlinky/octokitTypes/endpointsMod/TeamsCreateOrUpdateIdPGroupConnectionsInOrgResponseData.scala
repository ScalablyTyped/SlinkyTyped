...
@js.native
trait TeamsCreateOrUpdateIdPGroupConnectionsInOrgResponseData extends js.Object {
...
object TeamsCreateOrUpdateIdPGroupConnectionsInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsCreateOrUpdateIdPGroupConnectionsInOrgResponseDataOps[Self <: TeamsCreateOrUpdateIdPGroupConnectionsInOrgResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroups(value: Groupdescription): Self = this.set("groups", value.asInstanceOf[js.Any])
  }
}
