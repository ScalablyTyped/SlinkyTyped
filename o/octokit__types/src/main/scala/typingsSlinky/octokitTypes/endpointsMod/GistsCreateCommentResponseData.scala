...
@js.native
trait GistsCreateCommentResponseData extends js.Object {
...
object GistsCreateCommentResponseData {
  ...
  @scala.inline
  implicit class GistsCreateCommentResponseDataOps[Self <: GistsCreateCommentResponseData] (val x: Self) extends AnyVal {
    @scala.inline
