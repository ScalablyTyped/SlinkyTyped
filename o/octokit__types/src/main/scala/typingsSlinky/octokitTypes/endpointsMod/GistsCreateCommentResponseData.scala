...
@js.native
trait GistsCreateCommentResponseData extends StObject {
...
object GistsCreateCommentResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[GistsCreateCommentResponseData]
  }
  
  @scala.inline
  implicit class GistsCreateCommentResponseDataMutableBuilder[Self <: GistsCreateCommentResponseData] (val x: Self) extends AnyVal {
