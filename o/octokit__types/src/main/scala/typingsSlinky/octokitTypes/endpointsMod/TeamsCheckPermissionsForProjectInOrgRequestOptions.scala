...
object TeamsCheckPermissionsForProjectInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCheckPermissionsForProjectInOrgRequestOptionsMutableBuilder[Self <: TeamsCheckPermissionsForProjectInOrgRequestOptions] (val x: Self) extends AnyVal {
