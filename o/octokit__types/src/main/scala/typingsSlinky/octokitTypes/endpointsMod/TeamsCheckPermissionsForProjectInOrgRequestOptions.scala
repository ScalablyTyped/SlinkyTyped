...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashprojectsSlashColonproject_id
...
@js.native
trait TeamsCheckPermissionsForProjectInOrgRequestOptions extends js.Object {
...
object TeamsCheckPermissionsForProjectInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCheckPermissionsForProjectInOrgRequestOptionsOps[Self <: TeamsCheckPermissionsForProjectInOrgRequestOptions] (val x: Self) extends AnyVal {
