...
@js.native
trait OrgsUnblockUserRequestOptions extends StObject {
...
object OrgsUnblockUserRequestOptions {
  ...
  @scala.inline
  implicit class OrgsUnblockUserRequestOptionsMutableBuilder[Self <: OrgsUnblockUserRequestOptions] (val x: Self) extends AnyVal {
