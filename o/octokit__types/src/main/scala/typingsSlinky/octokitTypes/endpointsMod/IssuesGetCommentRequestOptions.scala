...
@js.native
trait IssuesGetCommentRequestOptions extends js.Object {
...
object IssuesGetCommentRequestOptions {
  ...
  @scala.inline
  implicit class IssuesGetCommentRequestOptionsOps[Self <: IssuesGetCommentRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
