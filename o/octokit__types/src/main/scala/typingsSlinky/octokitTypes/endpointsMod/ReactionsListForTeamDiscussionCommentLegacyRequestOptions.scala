...
object ReactionsListForTeamDiscussionCommentLegacyRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentLegacyRequestOptionsMutableBuilder[Self <: ReactionsListForTeamDiscussionCommentLegacyRequestOptions] (val x: Self) extends AnyVal {
