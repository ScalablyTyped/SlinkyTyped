...
object ReactionsListForTeamDiscussionCommentLegacyRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentLegacyRequestOptionsOps[Self <: ReactionsListForTeamDiscussionCommentLegacyRequestOptions] (val x: Self) extends AnyVal {
