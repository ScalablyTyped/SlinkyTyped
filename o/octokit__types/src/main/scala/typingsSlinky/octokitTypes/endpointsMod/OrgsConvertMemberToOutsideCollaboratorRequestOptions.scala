...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashoutside_collaboratorsSlashColonusername
...
object OrgsConvertMemberToOutsideCollaboratorRequestOptions {
  ...
  @scala.inline
  implicit class OrgsConvertMemberToOutsideCollaboratorRequestOptionsOps[Self <: OrgsConvertMemberToOutsideCollaboratorRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
