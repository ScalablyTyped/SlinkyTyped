...
@js.native
trait ReposAddUserAccessRestrictionsRequestOptions extends js.Object {
...
object ReposAddUserAccessRestrictionsRequestOptions {
  ...
  @scala.inline
  implicit class ReposAddUserAccessRestrictionsRequestOptionsOps[Self <: ReposAddUserAccessRestrictionsRequestOptions] (val x: Self) extends AnyVal {
