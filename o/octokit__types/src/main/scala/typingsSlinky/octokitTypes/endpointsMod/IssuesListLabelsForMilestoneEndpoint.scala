...
object IssuesListLabelsForMilestoneEndpoint {
  ...
  @scala.inline
  def apply(milestone_number: Double, owner: String, repo: String): IssuesListLabelsForMilestoneEndpoint = {
  ...
  @scala.inline
  implicit class IssuesListLabelsForMilestoneEndpointMutableBuilder[Self <: IssuesListLabelsForMilestoneEndpoint] (val x: Self) extends AnyVal {
