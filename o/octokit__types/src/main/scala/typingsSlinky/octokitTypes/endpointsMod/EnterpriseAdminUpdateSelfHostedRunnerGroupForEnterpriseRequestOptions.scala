...
import typingsSlinky.octokitTypes.octokitTypesStrings.`SlashenterprisesSlashColonenterpriseSlashactionsSlashrunner-groupsSlashColonrunner_group_id`
...
@js.native
trait EnterpriseAdminUpdateSelfHostedRunnerGroupForEnterpriseRequestOptions extends js.Object {
...
object EnterpriseAdminUpdateSelfHostedRunnerGroupForEnterpriseRequestOptions {
  ...
  @scala.inline
  implicit class EnterpriseAdminUpdateSelfHostedRunnerGroupForEnterpriseRequestOptionsOps[Self <: EnterpriseAdminUpdateSelfHostedRunnerGroupForEnterpriseRequestOptions] (val x: Self) extends AnyVal {
