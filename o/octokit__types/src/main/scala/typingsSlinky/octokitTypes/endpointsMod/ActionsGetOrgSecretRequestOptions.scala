...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashactionsSlashsecretsSlashColonsecret_name
...
@js.native
trait ActionsGetOrgSecretRequestOptions extends js.Object {
...
object ActionsGetOrgSecretRequestOptions {
  ...
  @scala.inline
  implicit class ActionsGetOrgSecretRequestOptionsOps[Self <: ActionsGetOrgSecretRequestOptions] (val x: Self) extends AnyVal {
