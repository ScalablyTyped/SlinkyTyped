...
import typingsSlinky.octokitTypes.anon.Read
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait TeamsCheckPermissionsForProjectInOrgResponseData extends js.Object {
...
object TeamsCheckPermissionsForProjectInOrgResponseData {
  ...
  def apply(
    ...
    updated_at: String,
    url: String
  ): TeamsCheckPermissionsForProjectInOrgResponseData = {
    ...
    __obj.asInstanceOf[TeamsCheckPermissionsForProjectInOrgResponseData]
  }
  
  @scala.inline
  implicit class TeamsCheckPermissionsForProjectInOrgResponseDataOps[Self <: TeamsCheckPermissionsForProjectInOrgResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPermissions(value: Read): Self = this.set("permissions", value.asInstanceOf[js.Any])
