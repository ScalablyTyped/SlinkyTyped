...
@js.native
trait TeamsCheckPermissionsForProjectInOrgResponseData extends StObject {
...
object TeamsCheckPermissionsForProjectInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsCheckPermissionsForProjectInOrgResponseDataMutableBuilder[Self <: TeamsCheckPermissionsForProjectInOrgResponseData] (val x: Self) extends AnyVal {
