...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashnotificationsSlashthreadsSlashColonthread_id
...
object ActivityMarkThreadAsReadRequestOptions {
  ...
  @scala.inline
  implicit class ActivityMarkThreadAsReadRequestOptionsOps[Self <: ActivityMarkThreadAsReadRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
