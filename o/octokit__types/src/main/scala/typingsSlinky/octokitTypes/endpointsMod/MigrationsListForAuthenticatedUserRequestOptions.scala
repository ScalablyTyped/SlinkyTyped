...
object MigrationsListForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class MigrationsListForAuthenticatedUserRequestOptionsMutableBuilder[Self <: MigrationsListForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
