...
import typingsSlinky.octokitTypes.octokitTypesStrings.`SlashorgsSlashColonorgSlashcredential-authorizationsSlashColoncredential_id`
...
object OrgsRemoveSamlSsoAuthorizationRequestOptions {
  ...
  @scala.inline
  implicit class OrgsRemoveSamlSsoAuthorizationRequestOptionsMutableBuilder[Self <: OrgsRemoveSamlSsoAuthorizationRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashorgsSlashColonorgSlashcredential-authorizationsSlashColoncredential_id`): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
