...
object OrgsRemoveSamlSsoAuthorizationRequestOptions {
  ...
  @scala.inline
  implicit class OrgsRemoveSamlSsoAuthorizationRequestOptionsOps[Self <: OrgsRemoveSamlSsoAuthorizationRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashorgsSlashColonorgSlashcredential-authorizationsSlashColoncredential_id`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
