...
@js.native
trait GistsGetCommentResponseData extends StObject {
...
object GistsGetCommentResponseData {
  ...
  @scala.inline
  implicit class GistsGetCommentResponseDataMutableBuilder[Self <: GistsGetCommentResponseData] (val x: Self) extends AnyVal {
