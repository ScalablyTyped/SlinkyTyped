...
@js.native
trait ReposRemoveTeamAccessRestrictionsEndpoint extends js.Object {
...
object ReposRemoveTeamAccessRestrictionsEndpoint {
  ...
  @scala.inline
  implicit class ReposRemoveTeamAccessRestrictionsEndpointOps[Self <: ReposRemoveTeamAccessRestrictionsEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
