...
object EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptions {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptionsMutableBuilder[Self <: EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptions] (val x: Self) extends AnyVal {
