...
@js.native
trait EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptions extends js.Object {
...
object EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptions {
  ...
  ): EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptions]
  }
  
  @scala.inline
  implicit class EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptionsOps[Self <: EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseRequestOptions] (val x: Self) extends AnyVal {
