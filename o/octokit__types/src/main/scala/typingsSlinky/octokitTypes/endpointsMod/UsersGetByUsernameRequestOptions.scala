...
@js.native
trait UsersGetByUsernameRequestOptions extends js.Object {
...
object UsersGetByUsernameRequestOptions {
  ...
  @scala.inline
  implicit class UsersGetByUsernameRequestOptionsOps[Self <: UsersGetByUsernameRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashusersSlashColonusername): Self = this.set("url", value.asInstanceOf[js.Any])
  }
