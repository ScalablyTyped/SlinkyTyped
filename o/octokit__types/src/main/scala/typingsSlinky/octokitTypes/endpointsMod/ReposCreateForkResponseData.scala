...
@js.native
trait ReposCreateForkResponseData extends js.Object {
...
object ReposCreateForkResponseData {
  ...
  @scala.inline
  implicit class ReposCreateForkResponseDataOps[Self <: ReposCreateForkResponseData] (val x: Self) extends AnyVal {
