...
import typingsSlinky.octokitTypes.anon.Admin
...
@js.native
trait ReposCreateForkResponseData extends StObject {
...
object ReposCreateForkResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateForkResponseData]
  }
  
  @scala.inline
  implicit class ReposCreateForkResponseDataMutableBuilder[Self <: ReposCreateForkResponseData] (val x: Self) extends AnyVal {
