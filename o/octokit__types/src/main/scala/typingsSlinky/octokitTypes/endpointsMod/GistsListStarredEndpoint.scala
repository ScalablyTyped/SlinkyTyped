...
@js.native
trait GistsListStarredEndpoint extends js.Object {
...
object GistsListStarredEndpoint {
  ...
  @scala.inline
  def apply(): GistsListStarredEndpoint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GistsListStarredEndpoint]
  }
  
  @scala.inline
  implicit class GistsListStarredEndpointOps[Self <: GistsListStarredEndpoint] (val x: Self) extends AnyVal {
