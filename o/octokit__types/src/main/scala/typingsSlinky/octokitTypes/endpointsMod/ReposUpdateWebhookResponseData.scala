...
@js.native
trait ReposUpdateWebhookResponseData extends js.Object {
...
object ReposUpdateWebhookResponseData {
  ...
  @scala.inline
  implicit class ReposUpdateWebhookResponseDataOps[Self <: ReposUpdateWebhookResponseData] (val x: Self) extends AnyVal {
