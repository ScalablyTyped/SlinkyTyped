...
@js.native
trait ActionsDeleteRepoSecretRequestOptions extends StObject {
...
object ActionsDeleteRepoSecretRequestOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ActionsDeleteRepoSecretRequestOptions]
  }
  
  @scala.inline
  implicit class ActionsDeleteRepoSecretRequestOptionsMutableBuilder[Self <: ActionsDeleteRepoSecretRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashactionsSlashsecretsSlashColonsecret_name): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
