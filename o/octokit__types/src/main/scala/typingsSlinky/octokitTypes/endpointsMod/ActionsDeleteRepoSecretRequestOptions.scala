...
@js.native
trait ActionsDeleteRepoSecretRequestOptions extends js.Object {
...
object ActionsDeleteRepoSecretRequestOptions {
  ...
  @scala.inline
  implicit class ActionsDeleteRepoSecretRequestOptionsOps[Self <: ActionsDeleteRepoSecretRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
