...
@js.native
trait ActivityGetRepoSubscriptionRequestOptions extends js.Object {
...
object ActivityGetRepoSubscriptionRequestOptions {
  ...
  @scala.inline
  implicit class ActivityGetRepoSubscriptionRequestOptionsOps[Self <: ActivityGetRepoSubscriptionRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
