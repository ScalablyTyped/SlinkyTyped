...
@js.native
trait IssuesGetCommentEndpoint extends StObject {
...
object IssuesGetCommentEndpoint {
  ...
  @scala.inline
  implicit class IssuesGetCommentEndpointMutableBuilder[Self <: IssuesGetCommentEndpoint] (val x: Self) extends AnyVal {
