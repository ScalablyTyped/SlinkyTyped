...
@js.native
trait TeamsUpdateInOrgResponseData extends StObject {
...
object TeamsUpdateInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsUpdateInOrgResponseDataMutableBuilder[Self <: TeamsUpdateInOrgResponseData] (val x: Self) extends AnyVal {
