...
object InteractionsRemoveRestrictionsForOrgRequestOptions {
  ...
  @scala.inline
  implicit class InteractionsRemoveRestrictionsForOrgRequestOptionsOps[Self <: InteractionsRemoveRestrictionsForOrgRequestOptions] (val x: Self) extends AnyVal {
