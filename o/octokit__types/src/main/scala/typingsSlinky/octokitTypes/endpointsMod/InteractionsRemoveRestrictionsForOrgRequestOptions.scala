...
@js.native
trait InteractionsRemoveRestrictionsForOrgRequestOptions extends StObject {
...
object InteractionsRemoveRestrictionsForOrgRequestOptions {
  ...
  @scala.inline
  implicit class InteractionsRemoveRestrictionsForOrgRequestOptionsMutableBuilder[Self <: InteractionsRemoveRestrictionsForOrgRequestOptions] (val x: Self) extends AnyVal {
