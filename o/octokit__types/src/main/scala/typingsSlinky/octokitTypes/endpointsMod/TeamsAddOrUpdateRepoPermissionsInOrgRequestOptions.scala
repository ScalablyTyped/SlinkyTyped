...
object TeamsAddOrUpdateRepoPermissionsInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateRepoPermissionsInOrgRequestOptionsOps[Self <: TeamsAddOrUpdateRepoPermissionsInOrgRequestOptions] (val x: Self) extends AnyVal {
