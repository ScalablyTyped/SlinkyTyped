...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashbranchesSlashColonbranchSlashprotectionSlashrestrictionsSlashteams
...
@js.native
trait ReposRemoveTeamAccessRestrictionsRequestOptions extends js.Object {
  var headers: RequestHeaders = js.native
  var method: DELETE = js.native
  var request: RequestRequestOptions = js.native
  var url: SlashreposSlashColonownerSlashColonrepoSlashbranchesSlashColonbranchSlashprotectionSlashrestrictionsSlashteams = js.native
}
...
object ReposRemoveTeamAccessRestrictionsRequestOptions {
  ...
  @scala.inline
  implicit class ReposRemoveTeamAccessRestrictionsRequestOptionsOps[Self <: ReposRemoveTeamAccessRestrictionsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
