...
object MarkdownRenderRawRequestOptions {
  ...
  @scala.inline
  implicit class MarkdownRenderRawRequestOptionsOps[Self <: MarkdownRenderRawRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashmarkdownSlashraw): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
