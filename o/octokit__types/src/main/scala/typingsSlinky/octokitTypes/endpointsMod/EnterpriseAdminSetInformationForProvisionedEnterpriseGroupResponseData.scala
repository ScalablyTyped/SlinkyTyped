...
@js.native
trait EnterpriseAdminSetInformationForProvisionedEnterpriseGroupResponseData extends StObject {
...
object EnterpriseAdminSetInformationForProvisionedEnterpriseGroupResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EnterpriseAdminSetInformationForProvisionedEnterpriseGroupResponseData]
  }
  
  @scala.inline
  implicit class EnterpriseAdminSetInformationForProvisionedEnterpriseGroupResponseDataMutableBuilder[Self <: EnterpriseAdminSetInformationForProvisionedEnterpriseGroupResponseData] (val x: Self) extends AnyVal {
