...
@js.native
trait ReactionsListForCommitCommentRequestOptions extends js.Object {
...
object ReactionsListForCommitCommentRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsListForCommitCommentRequestOptionsOps[Self <: ReactionsListForCommitCommentRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashcommentsSlashColoncomment_idSlashreactions): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
