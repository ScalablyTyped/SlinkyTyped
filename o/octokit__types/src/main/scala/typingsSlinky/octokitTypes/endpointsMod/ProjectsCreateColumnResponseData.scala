...
@js.native
trait ProjectsCreateColumnResponseData extends js.Object {
...
object ProjectsCreateColumnResponseData {
  ...
  @scala.inline
  implicit class ProjectsCreateColumnResponseDataOps[Self <: ProjectsCreateColumnResponseData] (val x: Self) extends AnyVal {
