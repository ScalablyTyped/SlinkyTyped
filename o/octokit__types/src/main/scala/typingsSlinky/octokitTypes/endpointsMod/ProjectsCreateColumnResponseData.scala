...
@js.native
trait ProjectsCreateColumnResponseData extends StObject {
...
object ProjectsCreateColumnResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProjectsCreateColumnResponseData]
  }
  
  @scala.inline
  implicit class ProjectsCreateColumnResponseDataMutableBuilder[Self <: ProjectsCreateColumnResponseData] (val x: Self) extends AnyVal {
