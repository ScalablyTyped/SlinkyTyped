...
@js.native
trait IssuesCreateMilestoneResponseData extends StObject {
...
object IssuesCreateMilestoneResponseData {
  ...
  @scala.inline
  implicit class IssuesCreateMilestoneResponseDataMutableBuilder[Self <: IssuesCreateMilestoneResponseData] (val x: Self) extends AnyVal {
