...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashmigrationsSlashColonmigration_idSlashrepositories
...
object MigrationsListReposForUserRequestOptions {
  ...
  @scala.inline
  implicit class MigrationsListReposForUserRequestOptionsOps[Self <: MigrationsListReposForUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashmigrationsSlashColonmigration_idSlashrepositories): Self = this.set("url", value.asInstanceOf[js.Any])
  }
