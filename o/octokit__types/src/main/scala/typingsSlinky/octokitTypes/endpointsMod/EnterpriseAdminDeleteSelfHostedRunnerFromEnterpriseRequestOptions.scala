...
@js.native
trait EnterpriseAdminDeleteSelfHostedRunnerFromEnterpriseRequestOptions extends js.Object {
...
object EnterpriseAdminDeleteSelfHostedRunnerFromEnterpriseRequestOptions {
  ...
  @scala.inline
  implicit class EnterpriseAdminDeleteSelfHostedRunnerFromEnterpriseRequestOptionsOps[Self <: EnterpriseAdminDeleteSelfHostedRunnerFromEnterpriseRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashenterprisesSlashColonenterpriseSlashactionsSlashrunnersSlashColonrunner_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
