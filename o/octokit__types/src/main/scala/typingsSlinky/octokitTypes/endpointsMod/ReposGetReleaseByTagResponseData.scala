...
import typingsSlinky.octokitTypes.anon.Browserdownloadurl
...
@js.native
trait ReposGetReleaseByTagResponseData extends StObject {
...
object ReposGetReleaseByTagResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposGetReleaseByTagResponseData]
  }
  
  @scala.inline
  implicit class ReposGetReleaseByTagResponseDataMutableBuilder[Self <: ReposGetReleaseByTagResponseData] (val x: Self) extends AnyVal {
