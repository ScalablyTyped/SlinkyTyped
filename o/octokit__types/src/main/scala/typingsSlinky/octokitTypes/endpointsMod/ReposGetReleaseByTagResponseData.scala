...
@js.native
trait ReposGetReleaseByTagResponseData extends js.Object {
...
object ReposGetReleaseByTagResponseData {
  ...
  @scala.inline
  implicit class ReposGetReleaseByTagResponseDataOps[Self <: ReposGetReleaseByTagResponseData] (val x: Self) extends AnyVal {
    @scala.inline
