...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashgpg_keysSlashColongpg_key_id
...
object UsersDeleteGpgKeyForAuthenticatedRequestOptions {
  ...
  @scala.inline
  implicit class UsersDeleteGpgKeyForAuthenticatedRequestOptionsOps[Self <: UsersDeleteGpgKeyForAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
