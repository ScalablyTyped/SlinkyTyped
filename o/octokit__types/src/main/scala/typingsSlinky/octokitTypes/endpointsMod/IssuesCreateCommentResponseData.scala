...
@js.native
trait IssuesCreateCommentResponseData extends js.Object {
...
object IssuesCreateCommentResponseData {
  ...
  @scala.inline
  implicit class IssuesCreateCommentResponseDataOps[Self <: IssuesCreateCommentResponseData] (val x: Self) extends AnyVal {
