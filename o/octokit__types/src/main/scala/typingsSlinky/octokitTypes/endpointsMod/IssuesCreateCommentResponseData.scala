...
@js.native
trait IssuesCreateCommentResponseData extends StObject {
...
object IssuesCreateCommentResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IssuesCreateCommentResponseData]
  }
  
  @scala.inline
  implicit class IssuesCreateCommentResponseDataMutableBuilder[Self <: IssuesCreateCommentResponseData] (val x: Self) extends AnyVal {
