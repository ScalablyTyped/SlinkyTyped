...
object MarkdownRenderRequestOptions {
  ...
  @scala.inline
  implicit class MarkdownRenderRequestOptionsOps[Self <: MarkdownRenderRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashmarkdown): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
