...
@js.native
trait ReposCreateInOrgResponseData extends js.Object {
...
object ReposCreateInOrgResponseData {
  ...
  @scala.inline
  implicit class ReposCreateInOrgResponseDataOps[Self <: ReposCreateInOrgResponseData] (val x: Self) extends AnyVal {
    @scala.inline
