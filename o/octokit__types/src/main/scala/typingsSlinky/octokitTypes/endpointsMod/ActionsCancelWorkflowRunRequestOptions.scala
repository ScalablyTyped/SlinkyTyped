...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashreposSlashColonownerSlashColonrepoSlashactionsSlashrunsSlashColonrun_idSlashcancel
...
object ActionsCancelWorkflowRunRequestOptions {
  ...
  @scala.inline
  implicit class ActionsCancelWorkflowRunRequestOptionsOps[Self <: ActionsCancelWorkflowRunRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashactionsSlashrunsSlashColonrun_idSlashcancel): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
