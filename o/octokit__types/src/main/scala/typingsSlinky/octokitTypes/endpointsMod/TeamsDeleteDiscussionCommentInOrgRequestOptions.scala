...
@js.native
trait TeamsDeleteDiscussionCommentInOrgRequestOptions extends StObject {
...
object TeamsDeleteDiscussionCommentInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsDeleteDiscussionCommentInOrgRequestOptionsMutableBuilder[Self <: TeamsDeleteDiscussionCommentInOrgRequestOptions] (val x: Self) extends AnyVal {
