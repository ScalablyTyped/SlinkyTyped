...
@js.native
trait IssuesRemoveAllLabelsRequestOptions extends StObject {
...
object IssuesRemoveAllLabelsRequestOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IssuesRemoveAllLabelsRequestOptions]
  }
  
  @scala.inline
  implicit class IssuesRemoveAllLabelsRequestOptionsMutableBuilder[Self <: IssuesRemoveAllLabelsRequestOptions] (val x: Self) extends AnyVal {
