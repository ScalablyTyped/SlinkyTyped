...
@js.native
trait ReposGetStatusChecksProtectionRequestOptions extends js.Object {
...
object ReposGetStatusChecksProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetStatusChecksProtectionRequestOptionsOps[Self <: ReposGetStatusChecksProtectionRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
