...
object ActionsGetSelfHostedRunnerForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsGetSelfHostedRunnerForOrgRequestOptionsOps[Self <: ActionsGetSelfHostedRunnerForOrgRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashactionsSlashrunnersSlashColonrunner_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
