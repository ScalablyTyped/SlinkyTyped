...
object ReactionsListForTeamDiscussionCommentInOrgEndpoint {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentInOrgEndpointOps[Self <: ReactionsListForTeamDiscussionCommentInOrgEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
