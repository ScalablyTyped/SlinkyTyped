...
@js.native
trait MigrationsStartForOrgResponseData extends StObject {
...
object MigrationsStartForOrgResponseData {
  ...
  @scala.inline
  implicit class MigrationsStartForOrgResponseDataMutableBuilder[Self <: MigrationsStartForOrgResponseData] (val x: Self) extends AnyVal {
