...
@js.native
trait OauthAuthorizationsGetAuthorizationResponseData extends js.Object {
...
object OauthAuthorizationsGetAuthorizationResponseData {
  ...
  @scala.inline
  implicit class OauthAuthorizationsGetAuthorizationResponseDataOps[Self <: OauthAuthorizationsGetAuthorizationResponseData] (val x: Self) extends AnyVal {
    @scala.inline
