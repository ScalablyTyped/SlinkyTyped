...
@js.native
trait OauthAuthorizationsGetAuthorizationResponseData extends StObject {
...
object OauthAuthorizationsGetAuthorizationResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetAuthorizationResponseData]
  }
  
  @scala.inline
  implicit class OauthAuthorizationsGetAuthorizationResponseDataMutableBuilder[Self <: OauthAuthorizationsGetAuthorizationResponseData] (val x: Self) extends AnyVal {
