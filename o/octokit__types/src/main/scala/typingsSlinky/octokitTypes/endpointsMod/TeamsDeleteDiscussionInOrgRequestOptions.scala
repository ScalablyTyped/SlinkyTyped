...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashdiscussionsSlashColondiscussion_number
...
@js.native
trait TeamsDeleteDiscussionInOrgRequestOptions extends StObject {
...
object TeamsDeleteDiscussionInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsDeleteDiscussionInOrgRequestOptionsMutableBuilder[Self <: TeamsDeleteDiscussionInOrgRequestOptions] (val x: Self) extends AnyVal {
