...
@js.native
trait BillingGetGithubActionsBillingUserResponseData extends js.Object {
...
object BillingGetGithubActionsBillingUserResponseData {
  ...
  @scala.inline
  implicit class BillingGetGithubActionsBillingUserResponseDataOps[Self <: BillingGetGithubActionsBillingUserResponseData] (val x: Self) extends AnyVal {
