...
@js.native
trait TeamsUpdateDiscussionCommentLegacyResponseData extends js.Object {
...
object TeamsUpdateDiscussionCommentLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentLegacyResponseDataOps[Self <: TeamsUpdateDiscussionCommentLegacyResponseData] (val x: Self) extends AnyVal {
