...
@js.native
trait TeamsCreateDiscussionInOrgResponseData extends StObject {
...
object TeamsCreateDiscussionInOrgResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionInOrgResponseData]
  }
  
  @scala.inline
  implicit class TeamsCreateDiscussionInOrgResponseDataMutableBuilder[Self <: TeamsCreateDiscussionInOrgResponseData] (val x: Self) extends AnyVal {
