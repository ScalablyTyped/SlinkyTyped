...
@js.native
trait TeamsCreateDiscussionInOrgResponseData extends js.Object {
...
object TeamsCreateDiscussionInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionInOrgResponseDataOps[Self <: TeamsCreateDiscussionInOrgResponseData] (val x: Self) extends AnyVal {
    @scala.inline
