...
object ProjectsCreateForAuthenticatedUserResponseData {
  ...
  @scala.inline
  implicit class ProjectsCreateForAuthenticatedUserResponseDataMutableBuilder[Self <: ProjectsCreateForAuthenticatedUserResponseData] (val x: Self) extends AnyVal {
