...
@js.native
trait ProjectsCreateForAuthenticatedUserResponseData extends js.Object {
...
object ProjectsCreateForAuthenticatedUserResponseData {
  ...
  @scala.inline
  implicit class ProjectsCreateForAuthenticatedUserResponseDataOps[Self <: ProjectsCreateForAuthenticatedUserResponseData] (val x: Self) extends AnyVal {
    @scala.inline
