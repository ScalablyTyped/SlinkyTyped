...
@js.native
trait ReposGetUsersWithAccessToProtectedBranchRequestOptions extends StObject {
...
object ReposGetUsersWithAccessToProtectedBranchRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetUsersWithAccessToProtectedBranchRequestOptionsMutableBuilder[Self <: ReposGetUsersWithAccessToProtectedBranchRequestOptions] (val x: Self) extends AnyVal {
