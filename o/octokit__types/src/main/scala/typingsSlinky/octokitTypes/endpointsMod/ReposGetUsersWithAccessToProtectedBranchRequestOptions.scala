...
object ReposGetUsersWithAccessToProtectedBranchRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetUsersWithAccessToProtectedBranchRequestOptionsOps[Self <: ReposGetUsersWithAccessToProtectedBranchRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
