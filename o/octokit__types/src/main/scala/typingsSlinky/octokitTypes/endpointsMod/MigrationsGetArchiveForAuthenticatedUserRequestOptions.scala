...
object MigrationsGetArchiveForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class MigrationsGetArchiveForAuthenticatedUserRequestOptionsOps[Self <: MigrationsGetArchiveForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
