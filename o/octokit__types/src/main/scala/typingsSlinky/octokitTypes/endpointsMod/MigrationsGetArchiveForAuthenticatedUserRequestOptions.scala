...
import typingsSlinky.octokitTypes.octokitTypesStrings.SlashuserSlashmigrationsSlashColonmigration_idSlasharchive
...
@js.native
trait MigrationsGetArchiveForAuthenticatedUserRequestOptions extends StObject {
...
object MigrationsGetArchiveForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class MigrationsGetArchiveForAuthenticatedUserRequestOptionsMutableBuilder[Self <: MigrationsGetArchiveForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
