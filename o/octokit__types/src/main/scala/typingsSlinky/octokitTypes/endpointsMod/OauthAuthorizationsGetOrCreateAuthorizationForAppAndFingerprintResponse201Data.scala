...
@js.native
trait OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponse201Data extends StObject {
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponse201Data {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponse201Data]
  }
  
  @scala.inline
  implicit class OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponse201DataMutableBuilder[Self <: OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintResponse201Data] (val x: Self) extends AnyVal {
