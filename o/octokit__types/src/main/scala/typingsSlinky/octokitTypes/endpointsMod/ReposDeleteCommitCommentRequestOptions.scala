...
@js.native
trait ReposDeleteCommitCommentRequestOptions extends js.Object {
...
object ReposDeleteCommitCommentRequestOptions {
  ...
  @scala.inline
  implicit class ReposDeleteCommitCommentRequestOptionsOps[Self <: ReposDeleteCommitCommentRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
