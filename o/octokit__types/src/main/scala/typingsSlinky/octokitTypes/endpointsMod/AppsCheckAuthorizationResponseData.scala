...
@js.native
trait AppsCheckAuthorizationResponseData extends StObject {
...
object AppsCheckAuthorizationResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AppsCheckAuthorizationResponseData]
  }
  
  @scala.inline
  implicit class AppsCheckAuthorizationResponseDataMutableBuilder[Self <: AppsCheckAuthorizationResponseData] (val x: Self) extends AnyVal {
