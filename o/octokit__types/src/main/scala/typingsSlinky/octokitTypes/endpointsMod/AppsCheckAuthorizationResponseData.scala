...
@js.native
trait AppsCheckAuthorizationResponseData extends js.Object {
...
object AppsCheckAuthorizationResponseData {
  ...
  @scala.inline
  implicit class AppsCheckAuthorizationResponseDataOps[Self <: AppsCheckAuthorizationResponseData] (val x: Self) extends AnyVal {
