...
@js.native
trait PullsListReviewCommentsEndpoint extends js.Object {
...
object PullsListReviewCommentsEndpoint {
  ...
  @scala.inline
  implicit class PullsListReviewCommentsEndpointOps[Self <: PullsListReviewCommentsEndpoint] (val x: Self) extends AnyVal {
