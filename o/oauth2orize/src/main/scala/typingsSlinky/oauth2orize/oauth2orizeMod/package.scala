...
package object oauth2orizeMod {
  ...
  type DecisionParseFunction = js.Function2[
    ...
    /* done */ js.Function2[/* err */ js.Error | Null, /* params */ js.Any, Unit], 
    Unit
  ]
  type DeserializeClientDoneFunction = js.Function2[/* err */ js.Error | Null, /* client */ js.UndefOr[js.Any | Boolean], Unit]
