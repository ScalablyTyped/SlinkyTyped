...
object TestResult {
  ...
  implicit class TestResultOps[Self <: TestResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFailedTests(value: js.Array[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("failedTests")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsPassphrase(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isPassphrase")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOptionalTestErrors(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("optionalTestErrors")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOptionalTestsPassed(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("optionalTestsPassed")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPassedTests(value: js.Array[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("passedTests")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRequiredTestErrors(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requiredTestErrors")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
