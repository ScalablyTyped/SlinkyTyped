...
import typingsSlinky.atOctokitRest.atOctokitRestStrings.collaborators_only
import typingsSlinky.atOctokitRest.atOctokitRestStrings.contributors_only
import typingsSlinky.atOctokitRest.atOctokitRestStrings.existing_users
