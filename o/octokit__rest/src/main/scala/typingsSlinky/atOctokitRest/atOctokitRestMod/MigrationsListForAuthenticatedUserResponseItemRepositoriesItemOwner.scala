...
trait MigrationsListForAuthenticatedUserResponseItemRepositoriesItemOwner extends js.Object {
...
object MigrationsListForAuthenticatedUserResponseItemRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsListForAuthenticatedUserResponseItemRepositoriesItemOwner]
  }
}
