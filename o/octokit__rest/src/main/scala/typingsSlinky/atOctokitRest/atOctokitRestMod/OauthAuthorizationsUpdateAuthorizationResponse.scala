...
trait OauthAuthorizationsUpdateAuthorizationResponse extends js.Object {
  var app: OauthAuthorizationsUpdateAuthorizationResponseApp
...
object OauthAuthorizationsUpdateAuthorizationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsUpdateAuthorizationResponse]
  }
}
