...
trait IssuesAddAssigneesResponseLabelsItem extends js.Object {
  var color: String
  var default: Boolean
...
object IssuesAddAssigneesResponseLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[IssuesAddAssigneesResponseLabelsItem]
  }
}
