...
trait ChecksListSuitesForRefResponseCheckSuitesItemRepositoryOwner extends js.Object {
...
object ChecksListSuitesForRefResponseCheckSuitesItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ChecksListSuitesForRefResponseCheckSuitesItemRepositoryOwner]
  }
}
