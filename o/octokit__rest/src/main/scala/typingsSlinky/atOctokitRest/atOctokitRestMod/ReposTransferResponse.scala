...
trait ReposTransferResponse extends js.Object {
  ...
  var owner: ReposTransferResponseOwner
  var permissions: ReposTransferResponsePermissions
  var `private`: Boolean
...
object ReposTransferResponse {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposTransferResponse]
  }
}
