...
trait AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePendingChangePlan extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePendingChangePlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePendingChangePlan]
  }
}
