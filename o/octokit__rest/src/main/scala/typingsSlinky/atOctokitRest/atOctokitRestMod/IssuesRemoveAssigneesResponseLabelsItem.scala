...
trait IssuesRemoveAssigneesResponseLabelsItem extends js.Object {
  var color: String
  var default: Boolean
...
object IssuesRemoveAssigneesResponseLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[IssuesRemoveAssigneesResponseLabelsItem]
  }
}
