...
import typingsSlinky.atOctokitRest.atOctokitRestStrings.APPROVE
import typingsSlinky.atOctokitRest.atOctokitRestStrings.COMMENT
import typingsSlinky.atOctokitRest.atOctokitRestStrings.REQUEST_CHANGES
