...
import typingsSlinky.atOctokitRest.atOctokitRestStrings.followers
import typingsSlinky.atOctokitRest.atOctokitRestStrings.joined
import typingsSlinky.atOctokitRest.atOctokitRestStrings.repositories
