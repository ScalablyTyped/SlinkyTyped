...
trait SearchCommitsResponseItemsItemAuthor extends js.Object {
...
object SearchCommitsResponseItemsItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[SearchCommitsResponseItemsItemAuthor]
  }
}
