...
import typingsSlinky.atOctokitRest.atOctokitRestStrings.failure
import typingsSlinky.atOctokitRest.atOctokitRestStrings.notice
import typingsSlinky.atOctokitRest.atOctokitRestStrings.warning
