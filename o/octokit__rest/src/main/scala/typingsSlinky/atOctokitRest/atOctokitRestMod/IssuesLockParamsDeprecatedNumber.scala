...
import typingsSlinky.atOctokitRest.atOctokitRestStrings.`off-topic`
import typingsSlinky.atOctokitRest.atOctokitRestStrings.`too heated`
import typingsSlinky.atOctokitRest.atOctokitRestStrings.resolved
import typingsSlinky.atOctokitRest.atOctokitRestStrings.spam
