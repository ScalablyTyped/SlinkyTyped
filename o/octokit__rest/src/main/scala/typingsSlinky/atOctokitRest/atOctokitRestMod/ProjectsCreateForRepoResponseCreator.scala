...
trait ProjectsCreateForRepoResponseCreator extends js.Object {
...
object ProjectsCreateForRepoResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsCreateForRepoResponseCreator]
  }
}
