...
trait PullsCreateReviewRequestResponseMilestoneCreator extends js.Object {
...
object PullsCreateReviewRequestResponseMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseMilestoneCreator]
  }
}
