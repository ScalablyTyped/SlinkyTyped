...
trait PullsListResponseItemHeadRepo extends js.Object {
  ...
  var owner: PullsListResponseItemHeadRepoOwner
  var permissions: PullsListResponseItemHeadRepoPermissions
  var `private`: Boolean
...
object PullsListResponseItemHeadRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListResponseItemHeadRepo]
  }
}
