...
trait AppsCheckAuthorizationResponseUser extends js.Object {
...
object AppsCheckAuthorizationResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsCheckAuthorizationResponseUser]
  }
}
