...
trait GistsGetRevisionResponseFilesHelloWorldRb extends js.Object {
  var content: String
  var filename: String
  var language: String
  var raw_url: String
...
object GistsGetRevisionResponseFilesHelloWorldRb {
  @scala.inline
  def apply(
    content: String,
    filename: String,
    ...
    __obj.asInstanceOf[GistsGetRevisionResponseFilesHelloWorldRb]
  }
}
