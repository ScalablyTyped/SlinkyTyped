...
trait SearchIssuesAndPullRequestsResponseItemsItemUser extends js.Object {
...
object SearchIssuesAndPullRequestsResponseItemsItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[SearchIssuesAndPullRequestsResponseItemsItemUser]
  }
}
