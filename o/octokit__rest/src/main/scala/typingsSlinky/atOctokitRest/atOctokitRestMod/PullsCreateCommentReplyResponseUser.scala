...
trait PullsCreateCommentReplyResponseUser extends js.Object {
...
object PullsCreateCommentReplyResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateCommentReplyResponseUser]
  }
}
