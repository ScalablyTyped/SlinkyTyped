...
import typingsSlinky.atOctokitRest.atOctokitRestStrings.blob
import typingsSlinky.atOctokitRest.atOctokitRestStrings.commit
import typingsSlinky.atOctokitRest.atOctokitRestStrings.tree
