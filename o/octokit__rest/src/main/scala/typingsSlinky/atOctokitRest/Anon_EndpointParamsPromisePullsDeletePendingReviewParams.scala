...
import typingsSlinky.atOctokitRest.atOctokitRestMod.PullsDeletePendingReviewParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.PullsDeletePendingReviewParamsDeprecatedNumber
import typingsSlinky.atOctokitRest.atOctokitRestMod.PullsDeletePendingReviewResponse
