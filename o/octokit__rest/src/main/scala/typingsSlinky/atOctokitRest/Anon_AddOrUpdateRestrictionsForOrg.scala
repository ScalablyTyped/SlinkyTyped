...
import typingsSlinky.atOctokitRest.atOctokitRestMod.InteractionsAddOrUpdateRestrictionsForOrgParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.InteractionsAddOrUpdateRestrictionsForOrgResponse
