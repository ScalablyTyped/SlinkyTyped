...
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposGetParticipationStatsParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposGetParticipationStatsResponse
