...
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposUpdateInvitationParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposUpdateInvitationResponse
