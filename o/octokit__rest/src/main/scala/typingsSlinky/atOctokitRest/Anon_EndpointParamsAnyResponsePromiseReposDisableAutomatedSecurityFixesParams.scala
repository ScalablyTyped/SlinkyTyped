...
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposDisableAutomatedSecurityFixesParams
...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposDisableAutomatedSecurityFixesParams extends js.Object {
  @JSName("endpoint")
