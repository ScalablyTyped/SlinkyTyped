...
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposUpdateCommitCommentParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposUpdateCommitCommentResponse
