...
import typingsSlinky.atOctokitRest.atOctokitRestMod.PullsCreateFromIssueParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.PullsCreateFromIssueResponse
