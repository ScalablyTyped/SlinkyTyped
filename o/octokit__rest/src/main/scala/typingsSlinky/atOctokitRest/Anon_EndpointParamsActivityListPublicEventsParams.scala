...
import typingsSlinky.atOctokitRest.atOctokitRestMod.ActivityListPublicEventsParams
...
@js.native
trait Anon_EndpointParamsActivityListPublicEventsParams extends js.Object {
  @JSName("endpoint")
