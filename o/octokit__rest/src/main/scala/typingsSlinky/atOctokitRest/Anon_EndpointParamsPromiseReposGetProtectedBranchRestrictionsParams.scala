...
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposGetProtectedBranchRestrictionsParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposGetProtectedBranchRestrictionsResponse
