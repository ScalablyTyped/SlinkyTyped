...
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposListTeamsWithAccessToProtectedBranchParams
import typingsSlinky.atOctokitRest.atOctokitRestMod.ReposListTeamsWithAccessToProtectedBranchResponse
