...
trait AcceptInvitation extends js.Object {
  ...
  var acceptInvitation_Original: `341` = js.native
  /**
  ...
  var addCollaborator_Original: `342` = js.native
  /**
    * Here's how you can create a read-only deploy key:
    */
  @JSName("addDeployKey")
  var addDeployKey_Original: `343` = js.native
  /**
  ...
  var addProtectedBranchAdminEnforcement_Original: `344` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var addProtectedBranchAppRestrictions_Original: `345` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var addProtectedBranchRequiredSignatures_Original: `346` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("addProtectedBranchRequiredStatusChecksContexts")
  var addProtectedBranchRequiredStatusChecksContexts_Original: `347` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var addProtectedBranchTeamRestrictions_Original: `348` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var addProtectedBranchUserRestrictions_Original: `349` = js.native
  /**
  ...
  var checkCollaborator_Original: `350` = js.native
  /**
  ...
  var checkVulnerabilityAlerts_Original: `351` = js.native
  /**
  ...
  var compareCommits_Original: `352` = js.native
  /**
  ...
  var createCommitComment_Original: `353` = js.native
  /**
  ...
  var createDeploymentStatus_Original: `355` = js.native
  /**
  ...
  var createDeployment_Original: `354` = js.native
  /**
  ...
  var createDispatchEvent_Original: `356` = js.native
  /**
    * Creates a new file or updates an existing file in a repository.
    * @deprecated octokit.repos.createFile() has been renamed to octokit.repos.createOrUpdateFile() (2019-06-07)
    */
  @JSName("createFile")
  var createFile_Original: `357` = js.native
  /**
  ...
  var createForAuthenticatedUser_Original: `358` = js.native
  /**
    ...
    */
  @JSName("createFork")
  var createFork_Original: `359` = js.native
  /**
    ...
    */
  @JSName("createHook")
  var createHook_Original: `360` = js.native
  /**
    * Creates a new repository for the authenticated user.
    *
    * **OAuth scope requirements**
    ...
    */
  @JSName("createInOrg")
  var createInOrg_Original: `361` = js.native
  /**
    * Creates a new file or updates an existing file in a repository.
    */
  @JSName("createOrUpdateFile")
  var createOrUpdateFile_Original: `362` = js.native
  /**
  ...
  var createRelease_Original: `363` = js.native
  /**
    ...
    */
  @JSName("createStatus")
  var createStatus_Original: `364` = js.native
  /**
  ...
  var createUsingTemplate_Original: `365` = js.native
  @JSName("declineInvitation")
  var declineInvitation_Original: `366` = js.native
  @JSName("deleteCommitComment")
  var deleteCommitComment_Original: `368` = js.native
  @JSName("deleteDownload")
  var deleteDownload_Original: `369` = js.native
  /**
    ...
    */
  @JSName("deleteFile")
  var deleteFile_Original: `370` = js.native
  @JSName("deleteHook")
  var deleteHook_Original: `371` = js.native
  @JSName("deleteInvitation")
  var deleteInvitation_Original: `372` = js.native
  ...
  /**
    ...
    */
  @JSName("delete")
  var delete_Original: `367` = js.native
  /**
  ...
  var disableAutomatedSecurityFixes_Original: `375` = js.native
  @JSName("disablePagesSite")
  var disablePagesSite_Original: `376` = js.native
  /**
  ...
  var enableAutomatedSecurityFixes_Original: `378` = js.native
  @JSName("enablePagesSite")
  var enablePagesSite_Original: `379` = js.native
  /**
  ...
  var getAppsWithAccessToProtectedBranch_Original: `382` = js.native
  /**
  ...
  var getArchiveLink_Original: `383` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getBranchProtection")
  var getBranchProtection_Original: `385` = js.native
  @JSName("getBranch")
  var getBranch_Original: `384` = js.native
  /**
    * Get the total number of clones and breakdown per day or week for the last 14 days. Timestamps are aligned to UTC midnight of the beginning of the day or week. Week begins on Monday.
    */
  @JSName("getClones")
  var getClones_Original: `386` = js.native
  /**
    * Returns a weekly aggregate of the number of additions and deletions pushed to a repository.
    */
  @JSName("getCodeFrequencyStats")
  var getCodeFrequencyStats_Original: `387` = js.native
  /**
    * Possible values for the `permission` key: `admin`, `write`, `read`, `none`.
    */
  @JSName("getCollaboratorPermissionLevel")
  var getCollaboratorPermissionLevel_Original: `388` = js.native
  /**
  ...
  var getCombinedStatusForRef_Original: `389` = js.native
  /**
    * Returns the last year of commit activity grouped by week. The `days` array is a group of commits per day, starting on `Sunday`.
    */
  @JSName("getCommitActivityStats")
  var getCommitActivityStats_Original: `391` = js.native
  @JSName("getCommitComment")
  var getCommitComment_Original: `392` = js.native
  /**
  ...
  var getCommitRefSha_Original: `393` = js.native
  /**
    ...
    */
  @JSName("getCommit")
  var getCommit_Original: `390` = js.native
  /**
    ...
    */
  @JSName("getContents")
  var getContents_Original: `394` = js.native
  /**
  ...
  var getContributorsStats_Original: `395` = js.native
  @JSName("getDeployKey")
  var getDeployKey_Original: `396` = js.native
  /**
    * Users with pull access can view a deployment status for a deployment:
    */
  @JSName("getDeploymentStatus")
  var getDeploymentStatus_Original: `398` = js.native
  @JSName("getDeployment")
  var getDeployment_Original: `397` = js.native
  @JSName("getDownload")
  var getDownload_Original: `399` = js.native
  @JSName("getHook")
  var getHook_Original: `400` = js.native
  @JSName("getLatestPagesBuild")
  var getLatestPagesBuild_Original: `401` = js.native
  /**
  ...
  var getLatestRelease_Original: `402` = js.native
  @JSName("getPagesBuild")
  var getPagesBuild_Original: `404` = js.native
  @JSName("getPages")
  var getPages_Original: `403` = js.native
  /**
  ...
  var getParticipationStats_Original: `405` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getProtectedBranchAdminEnforcement")
  var getProtectedBranchAdminEnforcement_Original: `406` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getProtectedBranchPullRequestReviewEnforcement")
  var getProtectedBranchPullRequestReviewEnforcement_Original: `407` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getProtectedBranchRequiredSignatures_Original: `408` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getProtectedBranchRequiredStatusChecks")
  var getProtectedBranchRequiredStatusChecks_Original: `409` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getProtectedBranchRestrictions_Original: `410` = js.native
  /**
  ...
  var getPunchCardStats_Original: `411` = js.native
  /**
    ...
    */
  @JSName("getReadme")
  var getReadme_Original: `412` = js.native
  /**
  ...
  var getReleaseAsset_Original: `414` = js.native
  /**
    * Get a published release with the specified tag.
    */
  @JSName("getReleaseByTag")
  var getReleaseByTag_Original: `415` = js.native
  /**
    * **Note:** This returns an `upload_url` key corresponding to the endpoint for uploading release assets. This key is a [hypermedia resource](https://developer.github.com/v3/#hypermedia).
    */
  @JSName("getRelease")
  var getRelease_Original: `413` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getTeamsWithAccessToProtectedBranch_Original: `416` = js.native
  /**
    * Get the top 10 popular contents over the last 14 days.
    */
  @JSName("getTopPaths")
  var getTopPaths_Original: `417` = js.native
  /**
    * Get the top 10 referrers over the last 14 days.
    */
  @JSName("getTopReferrers")
  var getTopReferrers_Original: `418` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getUsersWithAccessToProtectedBranch_Original: `419` = js.native
  /**
    * Get the total number of views and breakdown per day or week for the last 14 days. Timestamps are aligned to UTC midnight of the beginning of the day or week. Week begins on Monday.
    */
  @JSName("getViews")
  var getViews_Original: `420` = js.native
  /**
  ...
  var listAppsWithAccessToProtectedBranch_Original: `422` = js.native
  @JSName("listAssetsForRelease")
  var listAssetsForRelease_Original: `423` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var listCommitComments_Original: `428` = js.native
  /**
    * **Signature verification object**
    *
    * The response will include a `verification` object that describes the result of verifying the commit's signature. The following fields are included in the `verification` object:
    ...
    */
  @JSName("listCommits")
  var listCommits_Original: `429` = js.native
  /**
  ...
  var listContributors_Original: `430` = js.native
  @JSName("listDeployKeys")
  var listDeployKeys_Original: `431` = js.native
  /**
    * Users with pull access can view deployment statuses for a deployment:
    */
  @JSName("listDeploymentStatuses")
  var listDeploymentStatuses_Original: `432` = js.native
  /**
    * Simple filtering of deployments is available via query parameters:
    */
  @JSName("listDeployments")
  var listDeployments_Original: `433` = js.native
  @JSName("listDownloads")
  var listDownloads_Original: `434` = js.native
  /**
    * Lists repositories for the specified organization.
    */
  @JSName("listForOrg")
  var listForOrg_Original: `435` = js.native
  /**
    * Lists public repositories for the specified user.
    */
  @JSName("listForUser")
  var listForUser_Original: `436` = js.native
  @JSName("listForks")
  var listForks_Original: `437` = js.native
  @JSName("listHooks")
  var listHooks_Original: `438` = js.native
  /**
  ...
  var listProtectedBranchRequiredStatusChecksContexts_Original: `443` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
    * Lists the teams who have push access to this branch. The list includes child teams.
  ...
  var listProtectedBranchTeamRestrictions_Original: `444` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
    * Lists the people who have push access to this branch.
  ...
  var listProtectedBranchUserRestrictions_Original: `445` = js.native
  /**
    ...
    */
  @JSName("listPublic")
  var listPublic_Original: `446` = js.native
  /**
  ...
  var listPullRequestsAssociatedWithCommit_Original: `447` = js.native
  /**
    ...
    */
  @JSName("listReleases")
  var listReleases_Original: `448` = js.native
  /**
  ...
  var listStatusesForRef_Original: `449` = js.native
  @JSName("listTags")
  var listTags_Original: `450` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
    * Lists the teams who have push access to this branch. The list includes child teams.
  ...
  var listTeamsWithAccessToProtectedBranch_Original: `452` = js.native
  @JSName("listTeams")
  var listTeams_Original: `451` = js.native
  @JSName("listTopics")
  var listTopics_Original: `453` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
    * Lists the people who have push access to this branch.
  ...
  var listUsersWithAccessToProtectedBranch_Original: `454` = js.native
  /**
    ...
    */
  @JSName("list")
  var list_Original: `421` = js.native
  @JSName("merge")
  var merge_Original: `455` = js.native
  /**
    * This will trigger a [ping event](https://developer.github.com/webhooks/#ping-event) to be sent to the hook.
    */
  @JSName("pingHook")
  var pingHook_Original: `456` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeBranchProtection")
  var removeBranchProtection_Original: `457` = js.native
  @JSName("removeCollaborator")
  var removeCollaborator_Original: `458` = js.native
  @JSName("removeDeployKey")
  var removeDeployKey_Original: `459` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchAdminEnforcement_Original: `460` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchAppRestrictions_Original: `461` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeProtectedBranchPullRequestReviewEnforcement")
  var removeProtectedBranchPullRequestReviewEnforcement_Original: `462` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchRequiredSignatures_Original: `463` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeProtectedBranchRequiredStatusChecksContexts")
  var removeProtectedBranchRequiredStatusChecksContexts_Original: `465` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeProtectedBranchRequiredStatusChecks")
  var removeProtectedBranchRequiredStatusChecks_Original: `464` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchRestrictions_Original: `466` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchTeamRestrictions_Original: `467` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchUserRestrictions_Original: `468` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var replaceProtectedBranchAppRestrictions_Original: `469` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("replaceProtectedBranchRequiredStatusChecksContexts")
  var replaceProtectedBranchRequiredStatusChecksContexts_Original: `470` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var replaceProtectedBranchTeamRestrictions_Original: `471` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var replaceProtectedBranchUserRestrictions_Original: `472` = js.native
  @JSName("replaceTopics")
  var replaceTopics_Original: `473` = js.native
  /**
  ...
  var requestPageBuild_Original: `474` = js.native
  /**
  ...
  var retrieveCommunityProfileMetrics_Original: `475` = js.native
  /**
    ...
    */
  @JSName("testPushHook")
  var testPushHook_Original: `476` = js.native
  /**
    * A transfer request will need to be accepted by the new owner when transferring a personal repository to another user. The response will contain the original `owner`, and the transfer will continue asynchronously. For more details on the requirements to transfer personal and organization-owned repositories, see [about repository transfers](https://help.github.com/articles/about-repository-transfers/).
    */
  @JSName("transfer")
  var transfer_Original: `477` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var updateBranchProtection_Original: `479` = js.native
  @JSName("updateCommitComment")
  var updateCommitComment_Original: `480` = js.native
  /**
    * Creates a new file or updates an existing file in a repository.
    * @deprecated octokit.repos.updateFile() has been renamed to octokit.repos.createOrUpdateFile() (2019-06-07)
    */
  @JSName("updateFile")
  var updateFile_Original: `481` = js.native
  @JSName("updateHook")
  var updateHook_Original: `482` = js.native
  @JSName("updateInformationAboutPagesSite")
  var updateInformationAboutPagesSite_Original: `483` = js.native
  @JSName("updateInvitation")
  var updateInvitation_Original: `484` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var updateProtectedBranchPullRequestReviewEnforcement_Original: `485` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free, and in public and private repositories with GitHub Pro, GitHub Team, and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var updateProtectedBranchRequiredStatusChecks_Original: `486` = js.native
  /**
    * Users with push access to the repository can edit a release asset.
    */
  @JSName("updateReleaseAsset")
  var updateReleaseAsset_Original: `488` = js.native
  /**
    * Users with push access to the repository can edit a release.
    */
  @JSName("updateRelease")
  var updateRelease_Original: `487` = js.native
  /**
    ...
    */
  @JSName("update")
  var update_Original: `478` = js.native
  /**
  ...
  var uploadReleaseAsset_Original: `489` = js.native
