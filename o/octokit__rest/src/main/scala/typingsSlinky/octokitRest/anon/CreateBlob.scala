...
import typingsSlinky.octokitRest.mod.Octokit.GitCreateBlobParams
import typingsSlinky.octokitRest.mod.Octokit.GitCreateBlobResponse
...
import typingsSlinky.octokitRest.mod.Octokit.GitCreateRefParams
import typingsSlinky.octokitRest.mod.Octokit.GitCreateRefResponse
import typingsSlinky.octokitRest.mod.Octokit.GitCreateTagParams
import typingsSlinky.octokitRest.mod.Octokit.GitCreateTagResponse
import typingsSlinky.octokitRest.mod.Octokit.GitCreateTreeParams
import typingsSlinky.octokitRest.mod.Octokit.GitCreateTreeResponse
import typingsSlinky.octokitRest.mod.Octokit.GitDeleteRefParams
import typingsSlinky.octokitRest.mod.Octokit.GitGetBlobParams
import typingsSlinky.octokitRest.mod.Octokit.GitGetBlobResponse
import typingsSlinky.octokitRest.mod.Octokit.GitGetCommitParams
import typingsSlinky.octokitRest.mod.Octokit.GitGetCommitResponse
import typingsSlinky.octokitRest.mod.Octokit.GitGetRefParams
import typingsSlinky.octokitRest.mod.Octokit.GitGetRefResponse
import typingsSlinky.octokitRest.mod.Octokit.GitGetTagParams
import typingsSlinky.octokitRest.mod.Octokit.GitGetTagResponse
import typingsSlinky.octokitRest.mod.Octokit.GitGetTreeParams
import typingsSlinky.octokitRest.mod.Octokit.GitGetTreeResponse
import typingsSlinky.octokitRest.mod.Octokit.GitListMatchingRefsParams
import typingsSlinky.octokitRest.mod.Octokit.GitListMatchingRefsResponse
import typingsSlinky.octokitRest.mod.Octokit.GitListRefsParams
import typingsSlinky.octokitRest.mod.Octokit.GitUpdateRefParams
import typingsSlinky.octokitRest.mod.Octokit.GitUpdateRefResponse
...
trait CreateBlob extends js.Object {
  @JSName("createBlob")
  var createBlob_Original: `124` = js.native
  /**
    ...
    */
  @JSName("createCommit")
  var createCommit_Original: `125` = js.native
  /**
    * Creates a reference for your repository. You are unable to create new references for empty repositories, even if the commit SHA-1 hash used exists. Empty repositories are repositories without branches.
    */
  @JSName("createRef")
  var createRef_Original: `126` = js.native
  /**
    ...
    */
  @JSName("createTag")
  var createTag_Original: `127` = js.native
  /**
    ...
    */
  @JSName("createTree")
  var createTree_Original: `128` = js.native
  /**
    * ```
    ...
    */
  @JSName("deleteRef")
  var deleteRef_Original: `129` = js.native
  /**
    ...
    */
  @JSName("getBlob")
  var getBlob_Original: `130` = js.native
  /**
    ...
    */
  @JSName("getCommit")
  var getCommit_Original: `131` = js.native
  /**
    ...
    */
  @JSName("getRef")
  var getRef_Original: `132` = js.native
  /**
    * **Signature verification object**
    *
    * The response will include a `verification` object that describes the result of verifying the commit's signature. The following fields are included in the `verification` object:
    ...
    */
  @JSName("getTag")
  var getTag_Original: `133` = js.native
  /**
    ...
    */
  @JSName("getTree")
  var getTree_Original: `134` = js.native
  /**
  ...
  var listMatchingRefs_Original: `135` = js.native
  /**
    ...
    */
  @JSName("listRefs")
  var listRefs_Original: `136` = js.native
  @JSName("updateRef")
  var updateRef_Original: `137` = js.native
