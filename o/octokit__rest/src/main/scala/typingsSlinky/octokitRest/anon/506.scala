...
import typingsSlinky.octokitRest.mod.Octokit.TeamsAddOrUpdateMembershipLegacyParams
import typingsSlinky.octokitRest.mod.Octokit.TeamsAddOrUpdateMembershipLegacyResponse
