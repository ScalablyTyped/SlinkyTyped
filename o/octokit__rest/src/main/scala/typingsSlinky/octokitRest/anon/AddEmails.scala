...
trait AddEmails extends js.Object {
  /**
    ...
    */
  @JSName("addEmails")
  var addEmails_Original: `592` = js.native
  @JSName("block")
  var block_Original: `593` = js.native
  /**
    ...
    */
  @JSName("checkBlocked")
  var checkBlocked_Original: `594` = js.native
  @JSName("checkFollowingForUser")
  var checkFollowingForUser_Original: `596` = js.native
  @JSName("checkFollowing")
  var checkFollowing_Original: `595` = js.native
  /**
    * Adds a GPG key to the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth, or OAuth with at least `write:gpg_key` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    */
  @JSName("createGpgKey")
  var createGpgKey_Original: `597` = js.native
  /**
    * Adds a public SSH key to the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth, or OAuth with at least `write:public_key` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    */
  @JSName("createPublicKey")
  var createPublicKey_Original: `598` = js.native
  /**
    * This endpoint is accessible with the `user` scope.
    */
  @JSName("deleteEmails")
  var deleteEmails_Original: `599` = js.native
  /**
    ...
    */
  @JSName("deleteGpgKey")
  var deleteGpgKey_Original: `600` = js.native
  /**
  ...
  var deletePublicKey_Original: `601` = js.native
  /**
    ...
    */
  @JSName("follow")
  var follow_Original: `602` = js.native
  /**
  ...
  var getAuthenticated_Original: `603` = js.native
  /**
  ...
  var getByUsername_Original: `604` = js.native
  /**
  ...
  var getContextForUser_Original: `605` = js.native
  /**
    ...
    */
  @JSName("getGpgKey")
  var getGpgKey_Original: `606` = js.native
  /**
    ...
    */
  @JSName("getPublicKey")
  var getPublicKey_Original: `607` = js.native
  /**
    * List the users you've blocked on your personal account.
    */
  @JSName("listBlocked")
  var listBlocked_Original: `609` = js.native
  /**
    * Lists all of your email addresses, and specifies which one is visible to the public. This endpoint is accessible with the `user:email` scope.
    */
  @JSName("listEmails")
  var listEmails_Original: `610` = js.native
  @JSName("listFollowersForAuthenticatedUser")
  var listFollowersForAuthenticatedUser_Original: `611` = js.native
  @JSName("listFollowersForUser")
  var listFollowersForUser_Original: `612` = js.native
  @JSName("listFollowingForAuthenticatedUser")
  var listFollowingForAuthenticatedUser_Original: `613` = js.native
  @JSName("listFollowingForUser")
  var listFollowingForUser_Original: `614` = js.native
  /**
    * Lists the GPG keys for a user. This information is accessible by anyone.
    */
  @JSName("listGpgKeysForUser")
  var listGpgKeysForUser_Original: `616` = js.native
  /**
    ...
    */
  @JSName("listGpgKeys")
  var listGpgKeys_Original: `615` = js.native
  /**
  ...
  var listPublicEmails_Original: `617` = js.native
  /**
    * Lists the _verified_ public SSH keys for a user. This is accessible by anyone.
    */
  @JSName("listPublicKeysForUser")
  var listPublicKeysForUser_Original: `619` = js.native
  /**
  ...
  var listPublicKeys_Original: `618` = js.native
  /**
    ...
    */
  @JSName("list")
  var list_Original: `608` = js.native
  /**
    * Sets the visibility for your primary email addresses.
    */
  @JSName("togglePrimaryEmailVisibility")
  var togglePrimaryEmailVisibility_Original: `620` = js.native
  @JSName("unblock")
  var unblock_Original: `621` = js.native
  /**
    * Unfollowing a user requires the user to be logged in and authenticated with basic auth or OAuth with the `user:follow` scope.
    */
  @JSName("unfollow")
  var unfollow_Original: `622` = js.native
  /**
    * **Note:** If your email is set to private and you send an `email` parameter as part of this request to update your profile, your privacy settings are still enforced: the email address will not be displayed on your public profile or via the API.
    */
  @JSName("updateAuthenticated")
  var updateAuthenticated_Original: `623` = js.native
  /**
    * This endpoint is accessible with the `user` scope.
    */
