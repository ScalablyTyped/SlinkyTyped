...
import typingsSlinky.octokitRest.mod.Octokit.TeamsListPendingInvitationsParams
import typingsSlinky.octokitRest.mod.Octokit.TeamsListPendingInvitationsResponse
