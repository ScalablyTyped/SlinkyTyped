...
trait CheckStarringRepo extends js.Object {
  ...
  var checkStarringRepo_Original: `20` = js.native
  /**
    * Requires for the user to be authenticated.
    */
  @JSName("checkWatchingRepoLegacy")
  var checkWatchingRepoLegacy_Original: `21` = js.native
  /**
  ...
  var deleteRepoSubscription_Original: `22` = js.native
  /**
  ...
  var deleteThreadSubscription_Original: `23` = js.native
  @JSName("getRepoSubscription")
  var getRepoSubscription_Original: `24` = js.native
  /**
  ...
  var getThreadSubscription_Original: `26` = js.native
  @JSName("getThread")
  var getThread_Original: `25` = js.native
  /**
    * This is the user's organization dashboard. You must be authenticated as the user to view this.
    */
  @JSName("listEventsForOrg")
  var listEventsForOrg_Original: `27` = js.native
  /**
    * If you are authenticated as the given user, you will see your private events. Otherwise, you'll only see public events.
    */
  @JSName("listEventsForUser")
  var listEventsForUser_Original: `28` = js.native
  /**
    ...
    */
  @JSName("listFeeds")
  var listFeeds_Original: `29` = js.native
  /**
    * List all notifications for the current user.
    */
  @JSName("listNotificationsForRepo")
  var listNotificationsForRepo_Original: `31` = js.native
  /**
  ...
  var listNotifications_Original: `30` = js.native
  @JSName("listPublicEventsForOrg")
  var listPublicEventsForOrg_Original: `33` = js.native
  @JSName("listPublicEventsForRepoNetwork")
  var listPublicEventsForRepoNetwork_Original: `34` = js.native
  @JSName("listPublicEventsForUser")
  var listPublicEventsForUser_Original: `35` = js.native
  /**
    * We delay the public events feed by five minutes, which means the most recent event returned by the public events API actually occurred at least five minutes ago.
    */
  @JSName("listPublicEvents")
  var listPublicEvents_Original: `32` = js.native
  /**
    * These are events that you've received by watching repos and following users. If you are authenticated as the given user, you will see private events. Otherwise, you'll only see public events.
    */
  @JSName("listReceivedEventsForUser")
  var listReceivedEventsForUser_Original: `36` = js.native
  @JSName("listReceivedPublicEventsForUser")
  var listReceivedPublicEventsForUser_Original: `37` = js.native
  @JSName("listRepoEvents")
  var listRepoEvents_Original: `38` = js.native
  /**
    * You can also find out _when_ stars were created by passing the following custom [media type](https://developer.github.com/v3/media/) via the `Accept` header:
    */
  @JSName("listReposStarredByAuthenticatedUser")
  var listReposStarredByAuthenticatedUser_Original: `39` = js.native
  /**
    * You can also find out _when_ stars were created by passing the following custom [media type](https://developer.github.com/v3/media/) via the `Accept` header:
    */
  @JSName("listReposStarredByUser")
  var listReposStarredByUser_Original: `40` = js.native
  @JSName("listReposWatchedByUser")
  var listReposWatchedByUser_Original: `41` = js.native
  /**
    * You can also find out _when_ stars were created by passing the following custom [media type](https://developer.github.com/v3/media/) via the `Accept` header:
    */
  @JSName("listStargazersForRepo")
  var listStargazersForRepo_Original: `42` = js.native
  @JSName("listWatchedReposForAuthenticatedUser")
  var listWatchedReposForAuthenticatedUser_Original: `43` = js.native
  @JSName("listWatchersForRepo")
  var listWatchersForRepo_Original: `44` = js.native
  /**
    ...
    */
  @JSName("markAsRead")
  var markAsRead_Original: `45` = js.native
  /**
  ...
  var markNotificationsAsReadForRepo_Original: `46` = js.native
  @JSName("markThreadAsRead")
  var markThreadAsRead_Original: `47` = js.native
  /**
  ...
  var setRepoSubscription_Original: `48` = js.native
  /**
    * This lets you subscribe or unsubscribe from a conversation.
    */
  @JSName("setThreadSubscription")
  var setThreadSubscription_Original: `49` = js.native
  /**
    * Requires for the user to be authenticated.
    *
    ...
    */
  @JSName("starRepo")
  var starRepo_Original: `50` = js.native
  /**
    * Requires for the user to be authenticated.
    */
  @JSName("stopWatchingRepoLegacy")
  var stopWatchingRepoLegacy_Original: `51` = js.native
  /**
    * Requires for the user to be authenticated.
    */
  @JSName("unstarRepo")
  var unstarRepo_Original: `52` = js.native
  /**
  ...
  var watchRepoLegacy_Original: `53` = js.native
  /**
    * Requires for the user to be authenticated.
    */
