...
import typingsSlinky.octokitRest.mod.Octokit.TeamsListPendingInvitationsLegacyParams
import typingsSlinky.octokitRest.mod.Octokit.TeamsListPendingInvitationsLegacyResponse
