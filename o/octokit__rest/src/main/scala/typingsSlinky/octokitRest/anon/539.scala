...
import typingsSlinky.octokitRest.mod.Octokit.TeamsGetDiscussionLegacyParams
import typingsSlinky.octokitRest.mod.Octokit.TeamsGetDiscussionLegacyResponse
