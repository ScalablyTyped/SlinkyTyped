...
trait `469` extends js.Object {
  ...
  def apply(params: RequestOptions with ReposReplaceProtectedBranchAppRestrictionsParams): js.Promise[Response[ReposReplaceProtectedBranchAppRestrictionsResponse]] = js.native
