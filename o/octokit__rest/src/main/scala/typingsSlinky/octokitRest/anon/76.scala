...
import typingsSlinky.octokitRest.mod.Octokit.AppsListInstallationReposForAuthenticatedUserParams
import typingsSlinky.octokitRest.mod.Octokit.AppsListInstallationReposForAuthenticatedUserResponse
