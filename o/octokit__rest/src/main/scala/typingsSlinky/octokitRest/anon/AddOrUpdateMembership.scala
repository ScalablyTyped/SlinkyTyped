...
import typingsSlinky.octokitRest.mod.Octokit.OrgsAddOrUpdateMembershipParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsAddOrUpdateMembershipResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsBlockUserParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsCheckBlockedUserParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsCheckMembershipParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsCheckPublicMembershipParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsConcealMembershipParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsConvertMemberToOutsideCollaboratorParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsConvertMemberToOutsideCollaboratorResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsCreateHookParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsCreateHookResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsCreateInvitationParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsCreateInvitationResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsDeleteHookParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetHookParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetHookResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetMembershipForAuthenticatedUserParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetMembershipForAuthenticatedUserResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetMembershipParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetMembershipResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsGetResponse
...
import typingsSlinky.octokitRest.mod.Octokit.OrgsListForAuthenticatedUserParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListForAuthenticatedUserResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsListForUserParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListForUserResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsListHooksParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListHooksResponse
...
import typingsSlinky.octokitRest.mod.Octokit.OrgsListInvitationTeamsParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListInvitationTeamsResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsListMembersParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListMembersResponse
...
import typingsSlinky.octokitRest.mod.Octokit.OrgsListOutsideCollaboratorsParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListOutsideCollaboratorsResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsListParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListPendingInvitationsParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListPendingInvitationsResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsListPublicMembersParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsListPublicMembersResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsListResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsPingHookParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsPublicizeMembershipParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsRemoveMemberParams
...
import typingsSlinky.octokitRest.mod.Octokit.OrgsUnblockUserParams
...
import typingsSlinky.octokitRest.mod.Octokit.OrgsUpdateMembershipParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsUpdateMembershipResponse
import typingsSlinky.octokitRest.mod.Octokit.OrgsUpdateParams
import typingsSlinky.octokitRest.mod.Octokit.OrgsUpdateParamsDeprecatedMembersAllowedRepositoryCreationType
import typingsSlinky.octokitRest.mod.Octokit.OrgsUpdateResponse
...
trait AddOrUpdateMembership extends js.Object {
  ...
  var addOrUpdateMembership_Original: `230` = js.native
  @JSName("blockUser")
  var blockUser_Original: `231` = js.native
  /**
  ...
  var checkBlockedUser_Original: `232` = js.native
  /**
    * Check if a user is, publicly or privately, a member of the organization.
    */
  @JSName("checkMembership")
  var checkMembership_Original: `233` = js.native
  @JSName("checkPublicMembership")
  var checkPublicMembership_Original: `234` = js.native
  @JSName("concealMembership")
  var concealMembership_Original: `235` = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("createHook")
  var createHook_Original: `237` = js.native
  /**
  ...
  var createInvitation_Original: `238` = js.native
  @JSName("deleteHook")
  var deleteHook_Original: `239` = js.native
  @JSName("getHook")
  var getHook_Original: `241` = js.native
  @JSName("getMembershipForAuthenticatedUser")
  var getMembershipForAuthenticatedUser_Original: `243` = js.native
  /**
    * In order to get a user's membership with an organization, the authenticated user must be an organization member.
    */
  @JSName("getMembership")
  var getMembership_Original: `242` = js.native
  /**
  ...
  var listBlockedUsers_Original: `245` = js.native
  /**
  ...
  var listForAuthenticatedUser_Original: `246` = js.native
  /**
    ...
    */
  @JSName("listForUser")
  var listForUser_Original: `247` = js.native
  @JSName("listHooks")
  var listHooks_Original: `248` = js.native
  /**
    * Lists all GitHub Apps in an organization. The installation count includes all GitHub Apps installed on repositories in the organization. You must be an organization owner with `admin:read` scope to use this endpoint.
    */
  @JSName("listInstallations")
  var listInstallations_Original: `249` = js.native
  /**
    * List all teams associated with an invitation. In order to see invitations in an organization, the authenticated user must be an organization owner.
    */
  @JSName("listInvitationTeams")
  var listInvitationTeams_Original: `250` = js.native
  /**
    * List all users who are members of an organization. If the authenticated user is also a member of this organization then both concealed and public members will be returned.
    */
  @JSName("listMembers")
  var listMembers_Original: `251` = js.native
  @JSName("listMemberships")
  var listMemberships_Original: `252` = js.native
  /**
    * List all users who are outside collaborators of an organization.
    */
  @JSName("listOutsideCollaborators")
  var listOutsideCollaborators_Original: `253` = js.native
  /**
    * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub member, the `login` field in the return hash will be `null`.
    */
  @JSName("listPendingInvitations")
  var listPendingInvitations_Original: `254` = js.native
  /**
    * Members of an organization can choose to have their membership publicized or not.
    */
  @JSName("listPublicMembers")
  var listPublicMembers_Original: `255` = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("pingHook")
  var pingHook_Original: `256` = js.native
  /**
  ...
  var publicizeMembership_Original: `257` = js.native
  /**
    * Removing a user from this list will remove them from all teams and they will no longer have any access to the organization's repositories.
    */
  @JSName("removeMember")
  var removeMember_Original: `258` = js.native
  /**
  ...
  var removeMembership_Original: `259` = js.native
  /**
    * Removing a user from this list will remove them from all the organization's repositories.
    */
  @JSName("removeOutsideCollaborator")
  var removeOutsideCollaborator_Original: `260` = js.native
  @JSName("unblockUser")
  var unblockUser_Original: `261` = js.native
  @JSName("updateHook")
  var updateHook_Original: `263` = js.native
  @JSName("updateMembership")
  var updateMembership_Original: `264` = js.native
  /**
    ...
    */
  @JSName("update")
  var update_Original: `262` = js.native
  /**
    * Only authenticated organization owners can add a member to the organization or update the member's role.
    *
    * *   If the authenticated user is _adding_ a member to the organization, the invited user will receive an email inviting them to the organization. The user's [membership status](https://developer.github.com/v3/orgs/members/#get-organization-membership) will be `pending` until they accept the invitation.
