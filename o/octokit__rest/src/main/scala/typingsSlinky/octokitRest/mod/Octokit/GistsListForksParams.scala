...
@js.native
trait GistsListForksParams extends js.Object {
...
object GistsListForksParams {
  @scala.inline
  def apply(gist_id: String): GistsListForksParams = {
    val __obj = js.Dynamic.literal(gist_id = gist_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[GistsListForksParams]
  }
  @scala.inline
  implicit class GistsListForksParamsOps[Self <: GistsListForksParams] (val x: Self) extends AnyVal {
    @scala.inline
