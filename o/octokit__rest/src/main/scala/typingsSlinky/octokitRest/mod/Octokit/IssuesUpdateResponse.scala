...
trait IssuesUpdateResponse extends js.Object {
  ...
  var assignee: IssuesUpdateResponseAssignee = js.native
  var assignees: js.Array[IssuesUpdateResponseAssigneesItem] = js.native
  var body: String = js.native
  var closed_at: Null = js.native
  var closed_by: IssuesUpdateResponseClosedBy = js.native
  ...
  var labels: js.Array[IssuesUpdateResponseLabelsItem] = js.native
  var labels_url: String = js.native
  var locked: Boolean = js.native
  var milestone: IssuesUpdateResponseMilestone = js.native
  var node_id: String = js.native
  var number: Double = js.native
  var pull_request: IssuesUpdateResponsePullRequest = js.native
  var repository_url: String = js.native
  var state: String = js.native
  var title: String = js.native
  var updated_at: String = js.native
  var url: String = js.native
  var user: IssuesUpdateResponseUser = js.native
}
...
object IssuesUpdateResponse {
  ...
  @scala.inline
  implicit class IssuesUpdateResponseOps[Self <: IssuesUpdateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAssignee(value: IssuesUpdateResponseAssignee): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("assignee")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAssignees(value: js.Array[IssuesUpdateResponseAssigneesItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClosed_by(value: IssuesUpdateResponseClosedBy): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabels(value: js.Array[IssuesUpdateResponseLabelsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMilestone(value: IssuesUpdateResponseMilestone): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPull_request(value: IssuesUpdateResponsePullRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: IssuesUpdateResponseUser): Self = {
        val ret = this.duplicate
