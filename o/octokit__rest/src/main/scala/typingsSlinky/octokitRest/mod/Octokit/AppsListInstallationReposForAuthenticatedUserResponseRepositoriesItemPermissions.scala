...
object AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemPermissionsOps[Self <: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
