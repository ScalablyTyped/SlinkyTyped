...
trait PullsDeletePendingReviewResponse extends js.Object {
  var _links: PullsDeletePendingReviewResponseLinks = js.native
  ...
  var user: PullsDeletePendingReviewResponseUser = js.native
}
...
object PullsDeletePendingReviewResponse {
  ...
  @scala.inline
  implicit class PullsDeletePendingReviewResponseOps[Self <: PullsDeletePendingReviewResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsDeletePendingReviewResponseLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsDeletePendingReviewResponseUser): Self = {
        val ret = this.duplicate
