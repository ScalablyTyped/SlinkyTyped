...
object ReposGetAppsWithAccessToProtectedBranchResponseItemOwner {
  ...
  @scala.inline
  implicit class ReposGetAppsWithAccessToProtectedBranchResponseItemOwnerOps[Self <: ReposGetAppsWithAccessToProtectedBranchResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
