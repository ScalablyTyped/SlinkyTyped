...
trait OauthAuthorizationsCheckAuthorizationResponse extends js.Object {
  var app: OauthAuthorizationsCheckAuthorizationResponseApp = js.native
  ...
  var user: OauthAuthorizationsCheckAuthorizationResponseUser = js.native
}
...
object OauthAuthorizationsCheckAuthorizationResponse {
  ...
  @scala.inline
  implicit class OauthAuthorizationsCheckAuthorizationResponseOps[Self <: OauthAuthorizationsCheckAuthorizationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: OauthAuthorizationsCheckAuthorizationResponseApp): Self = {
    ...
    @scala.inline
    def withUser(value: OauthAuthorizationsCheckAuthorizationResponseUser): Self = {
        val ret = this.duplicate
