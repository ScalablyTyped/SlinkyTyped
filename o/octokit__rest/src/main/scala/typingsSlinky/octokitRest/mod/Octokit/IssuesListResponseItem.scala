...
trait IssuesListResponseItem extends js.Object {
  ...
  var assignee: IssuesListResponseItemAssignee = js.native
  var assignees: js.Array[IssuesListResponseItemAssigneesItem] = js.native
  ...
  var labels: js.Array[IssuesListResponseItemLabelsItem] = js.native
  var labels_url: String = js.native
  var locked: Boolean = js.native
  var milestone: IssuesListResponseItemMilestone = js.native
  var node_id: String = js.native
  var number: Double = js.native
  var pull_request: IssuesListResponseItemPullRequest = js.native
  var repository: IssuesListResponseItemRepository = js.native
  var repository_url: String = js.native
  var state: String = js.native
  var title: String = js.native
  var updated_at: String = js.native
  var url: String = js.native
  var user: IssuesListResponseItemUser = js.native
}
...
object IssuesListResponseItem {
  ...
  @scala.inline
  implicit class IssuesListResponseItemOps[Self <: IssuesListResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAssignee(value: IssuesListResponseItemAssignee): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("assignee")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAssignees(value: js.Array[IssuesListResponseItemAssigneesItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabels(value: js.Array[IssuesListResponseItemLabelsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMilestone(value: IssuesListResponseItemMilestone): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPull_request(value: IssuesListResponseItemPullRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pull_request")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRepository(value: IssuesListResponseItemRepository): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: IssuesListResponseItemUser): Self = {
        val ret = this.duplicate
