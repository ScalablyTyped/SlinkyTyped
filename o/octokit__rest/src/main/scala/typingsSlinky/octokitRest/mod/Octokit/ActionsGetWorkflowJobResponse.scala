...
trait ActionsGetWorkflowJobResponse extends js.Object {
  ...
  var steps: js.Array[ActionsGetWorkflowJobResponseStepsItem] = js.native
...
object ActionsGetWorkflowJobResponse {
  ...
  @scala.inline
  implicit class ActionsGetWorkflowJobResponseOps[Self <: ActionsGetWorkflowJobResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSteps(value: js.Array[ActionsGetWorkflowJobResponseStepsItem]): Self = {
        val ret = this.duplicate
