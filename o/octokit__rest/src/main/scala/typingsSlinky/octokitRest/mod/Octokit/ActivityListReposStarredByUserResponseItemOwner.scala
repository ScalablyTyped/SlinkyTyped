...
@js.native
trait ActivityListReposStarredByUserResponseItemOwner extends js.Object {
...
object ActivityListReposStarredByUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListReposStarredByUserResponseItemOwner]
  }
  @scala.inline
  implicit class ActivityListReposStarredByUserResponseItemOwnerOps[Self <: ActivityListReposStarredByUserResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
