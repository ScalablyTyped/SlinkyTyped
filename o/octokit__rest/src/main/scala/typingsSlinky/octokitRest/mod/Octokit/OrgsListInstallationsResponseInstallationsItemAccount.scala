...
object OrgsListInstallationsResponseInstallationsItemAccount {
  ...
  @scala.inline
  implicit class OrgsListInstallationsResponseInstallationsItemAccountOps[Self <: OrgsListInstallationsResponseInstallationsItemAccount] (val x: Self) extends AnyVal {
    @scala.inline
