...
object OrgsListPendingInvitationsParams {
  @scala.inline
  def apply(org_ : String): OrgsListPendingInvitationsParams = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("org")(org_.asInstanceOf[js.Any])
    __obj.asInstanceOf[OrgsListPendingInvitationsParams]
  }
  @scala.inline
  implicit class OrgsListPendingInvitationsParamsOps[Self <: OrgsListPendingInvitationsParams] (val x: Self) extends AnyVal {
    @scala.inline
