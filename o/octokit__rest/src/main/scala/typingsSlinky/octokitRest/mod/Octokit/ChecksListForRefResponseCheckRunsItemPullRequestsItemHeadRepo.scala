...
object ChecksListForRefResponseCheckRunsItemPullRequestsItemHeadRepo {
  ...
  @scala.inline
  implicit class ChecksListForRefResponseCheckRunsItemPullRequestsItemHeadRepoOps[Self <: ChecksListForRefResponseCheckRunsItemPullRequestsItemHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
