...
@js.native
trait PullsCreateReviewRequestResponseLabelsItem extends js.Object {
...
object PullsCreateReviewRequestResponseLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseLabelsItem]
  }
  @scala.inline
  implicit class PullsCreateReviewRequestResponseLabelsItemOps[Self <: PullsCreateReviewRequestResponseLabelsItem] (val x: Self) extends AnyVal {
    @scala.inline
