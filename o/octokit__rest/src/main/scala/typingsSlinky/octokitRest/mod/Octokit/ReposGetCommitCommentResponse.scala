...
trait ReposGetCommitCommentResponse extends js.Object {
  ...
  var user: ReposGetCommitCommentResponseUser = js.native
}
...
object ReposGetCommitCommentResponse {
  ...
  @scala.inline
  implicit class ReposGetCommitCommentResponseOps[Self <: ReposGetCommitCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReposGetCommitCommentResponseUser): Self = {
        val ret = this.duplicate
