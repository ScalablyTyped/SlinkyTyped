...
@js.native
trait TeamsCreateDiscussionCommentLegacyResponseAuthor extends js.Object {
...
object TeamsCreateDiscussionCommentLegacyResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionCommentLegacyResponseAuthor]
  }
  @scala.inline
  implicit class TeamsCreateDiscussionCommentLegacyResponseAuthorOps[Self <: TeamsCreateDiscussionCommentLegacyResponseAuthor] (val x: Self) extends AnyVal {
    @scala.inline
