...
@js.native
trait PullsCreateFromIssueResponseAssigneesItem extends js.Object {
...
object PullsCreateFromIssueResponseAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseAssigneesItem]
  }
  @scala.inline
  implicit class PullsCreateFromIssueResponseAssigneesItemOps[Self <: PullsCreateFromIssueResponseAssigneesItem] (val x: Self) extends AnyVal {
    @scala.inline
