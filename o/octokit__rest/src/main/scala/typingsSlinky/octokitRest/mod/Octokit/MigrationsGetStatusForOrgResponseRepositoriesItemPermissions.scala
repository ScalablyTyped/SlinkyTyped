...
object MigrationsGetStatusForOrgResponseRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForOrgResponseRepositoriesItemPermissionsOps[Self <: MigrationsGetStatusForOrgResponseRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
