...
trait ReposListCommitsResponseItemCommit extends js.Object {
  var author: ReposListCommitsResponseItemCommitAuthor = js.native
  var comment_count: Double = js.native
  var committer: ReposListCommitsResponseItemCommitCommitter = js.native
  var message: String = js.native
  var tree: ReposListCommitsResponseItemCommitTree = js.native
  var url: String = js.native
  var verification: ReposListCommitsResponseItemCommitVerification = js.native
}
...
object ReposListCommitsResponseItemCommit {
  ...
  @scala.inline
  implicit class ReposListCommitsResponseItemCommitOps[Self <: ReposListCommitsResponseItemCommit] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: ReposListCommitsResponseItemCommitAuthor): Self = {
    ...
    @scala.inline
    def withCommitter(value: ReposListCommitsResponseItemCommitCommitter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTree(value: ReposListCommitsResponseItemCommitTree): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVerification(value: ReposListCommitsResponseItemCommitVerification): Self = {
        val ret = this.duplicate
