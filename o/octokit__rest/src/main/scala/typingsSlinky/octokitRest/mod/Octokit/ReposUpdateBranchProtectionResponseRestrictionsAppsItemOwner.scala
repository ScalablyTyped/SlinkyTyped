...
@js.native
trait ReposUpdateBranchProtectionResponseRestrictionsAppsItemOwner extends js.Object {
...
object ReposUpdateBranchProtectionResponseRestrictionsAppsItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposUpdateBranchProtectionResponseRestrictionsAppsItemOwner]
  }
  @scala.inline
  implicit class ReposUpdateBranchProtectionResponseRestrictionsAppsItemOwnerOps[Self <: ReposUpdateBranchProtectionResponseRestrictionsAppsItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
