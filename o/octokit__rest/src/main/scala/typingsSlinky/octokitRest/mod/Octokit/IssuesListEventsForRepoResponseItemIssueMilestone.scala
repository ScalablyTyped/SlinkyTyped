...
trait IssuesListEventsForRepoResponseItemIssueMilestone extends js.Object {
  ...
  var creator: IssuesListEventsForRepoResponseItemIssueMilestoneCreator = js.native
...
object IssuesListEventsForRepoResponseItemIssueMilestone {
  ...
  @scala.inline
  implicit class IssuesListEventsForRepoResponseItemIssueMilestoneOps[Self <: IssuesListEventsForRepoResponseItemIssueMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesListEventsForRepoResponseItemIssueMilestoneCreator): Self = {
        val ret = this.duplicate
