...
@js.native
trait ReposCreateInOrgResponse extends js.Object {
  ...
  var owner: ReposCreateInOrgResponseOwner = js.native
  var permissions: ReposCreateInOrgResponsePermissions = js.native
...
object ReposCreateInOrgResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateInOrgResponse]
  }
  @scala.inline
  implicit class ReposCreateInOrgResponseOps[Self <: ReposCreateInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposCreateInOrgResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposCreateInOrgResponsePermissions): Self = {
        val ret = this.duplicate
