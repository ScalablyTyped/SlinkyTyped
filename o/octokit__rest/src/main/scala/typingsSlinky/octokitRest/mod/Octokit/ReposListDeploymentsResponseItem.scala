...
trait ReposListDeploymentsResponseItem extends js.Object {
  ...
  var creator: ReposListDeploymentsResponseItemCreator = js.native
  var description: String = js.native
  var environment: String = js.native
  var id: Double = js.native
  var node_id: String = js.native
  var original_environment: String = js.native
  var payload: ReposListDeploymentsResponseItemPayload = js.native
...
object ReposListDeploymentsResponseItem {
  ...
  @scala.inline
  implicit class ReposListDeploymentsResponseItemOps[Self <: ReposListDeploymentsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ReposListDeploymentsResponseItemCreator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPayload(value: ReposListDeploymentsResponseItemPayload): Self = {
        val ret = this.duplicate
