...
trait IssuesListForAuthenticatedUserResponseItemRepository extends js.Object {
  ...
  var owner: IssuesListForAuthenticatedUserResponseItemRepositoryOwner = js.native
  var permissions: IssuesListForAuthenticatedUserResponseItemRepositoryPermissions = js.native
...
object IssuesListForAuthenticatedUserResponseItemRepository {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemRepositoryOps[Self <: IssuesListForAuthenticatedUserResponseItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: IssuesListForAuthenticatedUserResponseItemRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: IssuesListForAuthenticatedUserResponseItemRepositoryPermissions): Self = {
        val ret = this.duplicate
