...
object ReposGetBranchProtectionResponseRestrictionsAppsItemOwner {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRestrictionsAppsItemOwnerOps[Self <: ReposGetBranchProtectionResponseRestrictionsAppsItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
