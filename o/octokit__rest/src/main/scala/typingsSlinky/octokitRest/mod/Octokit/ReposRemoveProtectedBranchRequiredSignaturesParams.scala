...
object ReposRemoveProtectedBranchRequiredSignaturesParams {
  ...
  @scala.inline
  implicit class ReposRemoveProtectedBranchRequiredSignaturesParamsOps[Self <: ReposRemoveProtectedBranchRequiredSignaturesParams] (val x: Self) extends AnyVal {
    @scala.inline
