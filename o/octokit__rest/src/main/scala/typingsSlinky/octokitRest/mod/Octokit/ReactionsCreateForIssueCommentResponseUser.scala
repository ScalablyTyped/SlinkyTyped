...
@js.native
trait ReactionsCreateForIssueCommentResponseUser extends js.Object {
...
object ReactionsCreateForIssueCommentResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForIssueCommentResponseUser]
  }
  @scala.inline
  implicit class ReactionsCreateForIssueCommentResponseUserOps[Self <: ReactionsCreateForIssueCommentResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
