...
@js.native
trait TeamsListMembersLegacyResponseItem extends js.Object {
...
object TeamsListMembersLegacyResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListMembersLegacyResponseItem]
  }
  @scala.inline
  implicit class TeamsListMembersLegacyResponseItemOps[Self <: TeamsListMembersLegacyResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
