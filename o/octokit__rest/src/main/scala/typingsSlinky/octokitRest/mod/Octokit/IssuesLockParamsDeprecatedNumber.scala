...
import typingsSlinky.octokitRest.octokitRestStrings.`off-topic`
import typingsSlinky.octokitRest.octokitRestStrings.`too heated`
import typingsSlinky.octokitRest.octokitRestStrings.resolved
import typingsSlinky.octokitRest.octokitRestStrings.spam
