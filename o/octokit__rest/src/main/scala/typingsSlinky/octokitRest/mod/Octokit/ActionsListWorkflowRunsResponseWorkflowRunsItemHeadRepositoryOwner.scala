...
@js.native
trait ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner extends js.Object {
...
object ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner]
  }
  @scala.inline
  implicit class ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwnerOps[Self <: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
