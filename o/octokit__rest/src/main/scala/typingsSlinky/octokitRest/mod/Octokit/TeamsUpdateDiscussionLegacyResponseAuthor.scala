...
@js.native
trait TeamsUpdateDiscussionLegacyResponseAuthor extends js.Object {
...
object TeamsUpdateDiscussionLegacyResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionLegacyResponseAuthor]
  }
  @scala.inline
  implicit class TeamsUpdateDiscussionLegacyResponseAuthorOps[Self <: TeamsUpdateDiscussionLegacyResponseAuthor] (val x: Self) extends AnyVal {
    @scala.inline
