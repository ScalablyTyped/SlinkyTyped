...
@js.native
trait PullsCreateFromIssueResponseHeadUser extends js.Object {
...
object PullsCreateFromIssueResponseHeadUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseHeadUser]
  }
  @scala.inline
  implicit class PullsCreateFromIssueResponseHeadUserOps[Self <: PullsCreateFromIssueResponseHeadUser] (val x: Self) extends AnyVal {
    @scala.inline
