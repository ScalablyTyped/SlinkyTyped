...
trait MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemOwner = js.native
  var permissions: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemPermissions = js.native
...
object MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemOps[Self <: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
