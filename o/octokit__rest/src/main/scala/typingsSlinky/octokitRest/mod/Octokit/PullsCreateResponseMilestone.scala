...
trait PullsCreateResponseMilestone extends js.Object {
  ...
  var creator: PullsCreateResponseMilestoneCreator = js.native
...
object PullsCreateResponseMilestone {
  ...
  @scala.inline
  implicit class PullsCreateResponseMilestoneOps[Self <: PullsCreateResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: PullsCreateResponseMilestoneCreator): Self = {
        val ret = this.duplicate
