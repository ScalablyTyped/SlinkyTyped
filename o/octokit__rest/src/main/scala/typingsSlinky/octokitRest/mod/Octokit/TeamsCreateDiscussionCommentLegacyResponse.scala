...
trait TeamsCreateDiscussionCommentLegacyResponse extends js.Object {
  var author: TeamsCreateDiscussionCommentLegacyResponseAuthor = js.native
  ...
  var reactions: TeamsCreateDiscussionCommentLegacyResponseReactions = js.native
...
object TeamsCreateDiscussionCommentLegacyResponse {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionCommentLegacyResponseOps[Self <: TeamsCreateDiscussionCommentLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsCreateDiscussionCommentLegacyResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsCreateDiscussionCommentLegacyResponseReactions): Self = {
        val ret = this.duplicate
