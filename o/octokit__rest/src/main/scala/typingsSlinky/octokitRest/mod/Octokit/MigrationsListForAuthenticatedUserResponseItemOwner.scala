...
object MigrationsListForAuthenticatedUserResponseItemOwner {
  ...
  @scala.inline
  implicit class MigrationsListForAuthenticatedUserResponseItemOwnerOps[Self <: MigrationsListForAuthenticatedUserResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
