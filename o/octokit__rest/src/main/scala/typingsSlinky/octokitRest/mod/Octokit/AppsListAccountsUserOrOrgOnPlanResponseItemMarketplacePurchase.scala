...
trait AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchase extends js.Object {
  ...
  var plan: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlan = js.native
...
object AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchase {
  ...
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchaseOps[Self <: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPlan(value: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlan): Self = {
        val ret = this.duplicate
