...
object PullsCreateReviewRequestResponseBaseRepoPermissions {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseBaseRepoPermissionsOps[Self <: PullsCreateReviewRequestResponseBaseRepoPermissions] (val x: Self) extends AnyVal {
    @scala.inline
