...
object IssuesListEventsForRepoResponseItemIssueAssigneesItem {
  ...
  @scala.inline
  implicit class IssuesListEventsForRepoResponseItemIssueAssigneesItemOps[Self <: IssuesListEventsForRepoResponseItemIssueAssigneesItem] (val x: Self) extends AnyVal {
    @scala.inline
