...
trait MigrationsListForAuthenticatedUserResponseItemRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsListForAuthenticatedUserResponseItemRepositoriesItemOwner = js.native
  var permissions: MigrationsListForAuthenticatedUserResponseItemRepositoriesItemPermissions = js.native
...
object MigrationsListForAuthenticatedUserResponseItemRepositoriesItem {
  ...
  @scala.inline
  implicit class MigrationsListForAuthenticatedUserResponseItemRepositoriesItemOps[Self <: MigrationsListForAuthenticatedUserResponseItemRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsListForAuthenticatedUserResponseItemRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsListForAuthenticatedUserResponseItemRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
