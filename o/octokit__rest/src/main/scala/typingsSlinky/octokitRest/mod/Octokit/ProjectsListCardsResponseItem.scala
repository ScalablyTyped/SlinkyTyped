...
trait ProjectsListCardsResponseItem extends js.Object {
  ...
  var creator: ProjectsListCardsResponseItemCreator = js.native
...
object ProjectsListCardsResponseItem {
  ...
  @scala.inline
  implicit class ProjectsListCardsResponseItemOps[Self <: ProjectsListCardsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsListCardsResponseItemCreator): Self = {
        val ret = this.duplicate
