...
object AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChangePlan {
  ...
  @scala.inline
  implicit class AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChangePlanOps[Self <: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChangePlan] (val x: Self) extends AnyVal {
    @scala.inline
