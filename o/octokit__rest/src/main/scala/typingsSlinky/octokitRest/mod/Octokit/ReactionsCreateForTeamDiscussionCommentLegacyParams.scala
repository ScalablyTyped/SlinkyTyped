...
object ReactionsCreateForTeamDiscussionCommentLegacyParams {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionCommentLegacyParamsOps[Self <: ReactionsCreateForTeamDiscussionCommentLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
