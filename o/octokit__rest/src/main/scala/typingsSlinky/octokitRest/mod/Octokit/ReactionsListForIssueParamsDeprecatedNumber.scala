...
object ReactionsListForIssueParamsDeprecatedNumber {
  @scala.inline
  def apply(number: Double, owner: String, repo: String): ReactionsListForIssueParamsDeprecatedNumber = {
  ...
  @scala.inline
  implicit class ReactionsListForIssueParamsDeprecatedNumberOps[Self <: ReactionsListForIssueParamsDeprecatedNumber] (val x: Self) extends AnyVal {
    @scala.inline
