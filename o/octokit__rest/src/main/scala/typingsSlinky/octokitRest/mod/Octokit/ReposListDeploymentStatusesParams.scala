...
object ReposListDeploymentStatusesParams {
  @scala.inline
  def apply(deployment_id: Double, owner: String, repo: String): ReposListDeploymentStatusesParams = {
  ...
  @scala.inline
  implicit class ReposListDeploymentStatusesParamsOps[Self <: ReposListDeploymentStatusesParams] (val x: Self) extends AnyVal {
    @scala.inline
