...
trait PullsListResponseItemBase extends js.Object {
  ...
  var repo: PullsListResponseItemBaseRepo = js.native
  var sha: String = js.native
  var user: PullsListResponseItemBaseUser = js.native
}
...
object PullsListResponseItemBase {
  ...
  @scala.inline
  implicit class PullsListResponseItemBaseOps[Self <: PullsListResponseItemBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsListResponseItemBaseRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsListResponseItemBaseUser): Self = {
        val ret = this.duplicate
