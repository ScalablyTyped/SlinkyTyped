...
object ReposGetAppsWithAccessToProtectedBranchResponseItemPermissions {
  ...
  @scala.inline
  implicit class ReposGetAppsWithAccessToProtectedBranchResponseItemPermissionsOps[Self <: ReposGetAppsWithAccessToProtectedBranchResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
