...
@js.native
trait OrgsUpdateMembershipResponseUser extends js.Object {
...
object OrgsUpdateMembershipResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsUpdateMembershipResponseUser]
  }
  @scala.inline
  implicit class OrgsUpdateMembershipResponseUserOps[Self <: OrgsUpdateMembershipResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
