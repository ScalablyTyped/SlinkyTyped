...
trait ReactionsListForPullRequestReviewCommentResponseItem extends js.Object {
  ...
  var user: ReactionsListForPullRequestReviewCommentResponseItemUser = js.native
}
...
object ReactionsListForPullRequestReviewCommentResponseItem {
  ...
  @scala.inline
  implicit class ReactionsListForPullRequestReviewCommentResponseItemOps[Self <: ReactionsListForPullRequestReviewCommentResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsListForPullRequestReviewCommentResponseItemUser): Self = {
        val ret = this.duplicate
