...
trait SearchCodeResponse extends js.Object {
  ...
  var items: js.Array[SearchCodeResponseItemsItem] = js.native
...
object SearchCodeResponse {
  ...
  @scala.inline
  implicit class SearchCodeResponseOps[Self <: SearchCodeResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[SearchCodeResponseItemsItem]): Self = {
        val ret = this.duplicate
