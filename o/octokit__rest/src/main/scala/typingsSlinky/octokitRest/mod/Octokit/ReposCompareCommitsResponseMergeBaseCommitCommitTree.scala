...
object ReposCompareCommitsResponseMergeBaseCommitCommitTree {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseMergeBaseCommitCommitTreeOps[Self <: ReposCompareCommitsResponseMergeBaseCommitCommitTree] (val x: Self) extends AnyVal {
    @scala.inline
