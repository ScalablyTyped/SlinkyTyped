...
trait TeamsListDiscussionsLegacyResponseItem extends js.Object {
  var author: TeamsListDiscussionsLegacyResponseItemAuthor = js.native
  ...
  var reactions: TeamsListDiscussionsLegacyResponseItemReactions = js.native
...
object TeamsListDiscussionsLegacyResponseItem {
  ...
  @scala.inline
  implicit class TeamsListDiscussionsLegacyResponseItemOps[Self <: TeamsListDiscussionsLegacyResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsListDiscussionsLegacyResponseItemAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsListDiscussionsLegacyResponseItemReactions): Self = {
        val ret = this.duplicate
