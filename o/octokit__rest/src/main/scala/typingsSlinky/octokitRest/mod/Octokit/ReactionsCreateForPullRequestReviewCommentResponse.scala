...
trait ReactionsCreateForPullRequestReviewCommentResponse extends js.Object {
  ...
  var user: ReactionsCreateForPullRequestReviewCommentResponseUser = js.native
}
...
object ReactionsCreateForPullRequestReviewCommentResponse {
  ...
  @scala.inline
  implicit class ReactionsCreateForPullRequestReviewCommentResponseOps[Self <: ReactionsCreateForPullRequestReviewCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsCreateForPullRequestReviewCommentResponseUser): Self = {
        val ret = this.duplicate
