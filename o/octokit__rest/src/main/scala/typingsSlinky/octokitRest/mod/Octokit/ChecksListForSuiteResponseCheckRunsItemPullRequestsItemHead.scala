...
trait ChecksListForSuiteResponseCheckRunsItemPullRequestsItemHead extends js.Object {
  ...
  var repo: ChecksListForSuiteResponseCheckRunsItemPullRequestsItemHeadRepo = js.native
...
object ChecksListForSuiteResponseCheckRunsItemPullRequestsItemHead {
  ...
  @scala.inline
  implicit class ChecksListForSuiteResponseCheckRunsItemPullRequestsItemHeadOps[Self <: ChecksListForSuiteResponseCheckRunsItemPullRequestsItemHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: ChecksListForSuiteResponseCheckRunsItemPullRequestsItemHeadRepo): Self = {
        val ret = this.duplicate
