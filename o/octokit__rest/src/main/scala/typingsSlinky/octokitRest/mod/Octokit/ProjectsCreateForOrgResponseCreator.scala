...
@js.native
trait ProjectsCreateForOrgResponseCreator extends js.Object {
...
object ProjectsCreateForOrgResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsCreateForOrgResponseCreator]
  }
  @scala.inline
  implicit class ProjectsCreateForOrgResponseCreatorOps[Self <: ProjectsCreateForOrgResponseCreator] (val x: Self) extends AnyVal {
    @scala.inline
