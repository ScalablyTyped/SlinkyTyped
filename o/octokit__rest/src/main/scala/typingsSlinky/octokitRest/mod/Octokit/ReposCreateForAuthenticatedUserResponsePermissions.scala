...
object ReposCreateForAuthenticatedUserResponsePermissions {
  ...
  @scala.inline
  implicit class ReposCreateForAuthenticatedUserResponsePermissionsOps[Self <: ReposCreateForAuthenticatedUserResponsePermissions] (val x: Self) extends AnyVal {
    @scala.inline
