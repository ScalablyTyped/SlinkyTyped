...
object IssuesListEventsForRepoResponseItemIssueLabelsItem {
  ...
  @scala.inline
  implicit class IssuesListEventsForRepoResponseItemIssueLabelsItemOps[Self <: IssuesListEventsForRepoResponseItemIssueLabelsItem] (val x: Self) extends AnyVal {
    @scala.inline
