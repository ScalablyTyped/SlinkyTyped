...
object ReposListBranchesResponseItemProtectionRequiredStatusChecks {
  ...
  @scala.inline
  implicit class ReposListBranchesResponseItemProtectionRequiredStatusChecksOps[Self <: ReposListBranchesResponseItemProtectionRequiredStatusChecks] (val x: Self) extends AnyVal {
    @scala.inline
