...
object IssuesCreateLabelParams {
  @scala.inline
  def apply(color: String, name: String, owner: String, repo: String): IssuesCreateLabelParams = {
  ...
  @scala.inline
  implicit class IssuesCreateLabelParamsOps[Self <: IssuesCreateLabelParams] (val x: Self) extends AnyVal {
    @scala.inline
