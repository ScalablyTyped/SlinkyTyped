...
object ActivityListPublicEventsForRepoNetworkParams {
  @scala.inline
  def apply(owner: String, repo: String): ActivityListPublicEventsForRepoNetworkParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActivityListPublicEventsForRepoNetworkParams]
  }
  @scala.inline
  implicit class ActivityListPublicEventsForRepoNetworkParamsOps[Self <: ActivityListPublicEventsForRepoNetworkParams] (val x: Self) extends AnyVal {
    @scala.inline
