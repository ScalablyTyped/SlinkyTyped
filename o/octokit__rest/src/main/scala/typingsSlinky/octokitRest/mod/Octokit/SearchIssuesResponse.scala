...
trait SearchIssuesResponse extends js.Object {
  ...
  var items: js.Array[SearchIssuesResponseItemsItem] = js.native
...
object SearchIssuesResponse {
  ...
  @scala.inline
  implicit class SearchIssuesResponseOps[Self <: SearchIssuesResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[SearchIssuesResponseItemsItem]): Self = {
        val ret = this.duplicate
