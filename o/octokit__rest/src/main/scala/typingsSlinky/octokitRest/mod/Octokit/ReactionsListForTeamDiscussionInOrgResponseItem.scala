...
trait ReactionsListForTeamDiscussionInOrgResponseItem extends js.Object {
  ...
  var user: ReactionsListForTeamDiscussionInOrgResponseItemUser = js.native
}
...
object ReactionsListForTeamDiscussionInOrgResponseItem {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionInOrgResponseItemOps[Self <: ReactionsListForTeamDiscussionInOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsListForTeamDiscussionInOrgResponseItemUser): Self = {
        val ret = this.duplicate
