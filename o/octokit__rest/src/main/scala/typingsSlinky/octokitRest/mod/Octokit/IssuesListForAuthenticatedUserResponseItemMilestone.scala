...
trait IssuesListForAuthenticatedUserResponseItemMilestone extends js.Object {
  ...
  var creator: IssuesListForAuthenticatedUserResponseItemMilestoneCreator = js.native
...
object IssuesListForAuthenticatedUserResponseItemMilestone {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemMilestoneOps[Self <: IssuesListForAuthenticatedUserResponseItemMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesListForAuthenticatedUserResponseItemMilestoneCreator): Self = {
        val ret = this.duplicate
