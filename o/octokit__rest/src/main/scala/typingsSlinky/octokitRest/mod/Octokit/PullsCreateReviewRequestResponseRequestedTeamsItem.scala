...
object PullsCreateReviewRequestResponseRequestedTeamsItem {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseRequestedTeamsItemOps[Self <: PullsCreateReviewRequestResponseRequestedTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
