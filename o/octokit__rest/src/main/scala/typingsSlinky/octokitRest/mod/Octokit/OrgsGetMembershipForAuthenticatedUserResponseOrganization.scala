...
object OrgsGetMembershipForAuthenticatedUserResponseOrganization {
  ...
  @scala.inline
  implicit class OrgsGetMembershipForAuthenticatedUserResponseOrganizationOps[Self <: OrgsGetMembershipForAuthenticatedUserResponseOrganization] (val x: Self) extends AnyVal {
    @scala.inline
