...
object ReposGetBranchProtectionResponseRestrictionsUsersItem {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRestrictionsUsersItemOps[Self <: ReposGetBranchProtectionResponseRestrictionsUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
