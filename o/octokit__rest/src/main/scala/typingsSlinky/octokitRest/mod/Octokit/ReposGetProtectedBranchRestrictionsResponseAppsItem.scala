...
@js.native
trait ReposGetProtectedBranchRestrictionsResponseAppsItem extends js.Object {
  ...
  var owner: ReposGetProtectedBranchRestrictionsResponseAppsItemOwner = js.native
  var permissions: ReposGetProtectedBranchRestrictionsResponseAppsItemPermissions = js.native
  var slug: String = js.native
  var updated_at: String = js.native
}

object ReposGetProtectedBranchRestrictionsResponseAppsItem {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRestrictionsResponseAppsItem]
  }
  @scala.inline
  implicit class ReposGetProtectedBranchRestrictionsResponseAppsItemOps[Self <: ReposGetProtectedBranchRestrictionsResponseAppsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposGetProtectedBranchRestrictionsResponseAppsItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposGetProtectedBranchRestrictionsResponseAppsItemPermissions): Self = {
        val ret = this.duplicate
