...
trait TeamsGetDiscussionInOrgResponse extends js.Object {
  var author: TeamsGetDiscussionInOrgResponseAuthor = js.native
  ...
  var reactions: TeamsGetDiscussionInOrgResponseReactions = js.native
...
object TeamsGetDiscussionInOrgResponse {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionInOrgResponseOps[Self <: TeamsGetDiscussionInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsGetDiscussionInOrgResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsGetDiscussionInOrgResponseReactions): Self = {
        val ret = this.duplicate
