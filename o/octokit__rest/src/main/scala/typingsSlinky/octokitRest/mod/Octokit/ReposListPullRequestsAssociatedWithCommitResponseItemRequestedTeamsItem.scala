...
object ReposListPullRequestsAssociatedWithCommitResponseItemRequestedTeamsItem {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemRequestedTeamsItemOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemRequestedTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
