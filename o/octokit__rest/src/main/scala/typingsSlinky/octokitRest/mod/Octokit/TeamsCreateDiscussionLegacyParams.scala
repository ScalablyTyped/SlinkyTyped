...
object TeamsCreateDiscussionLegacyParams {
  @scala.inline
  def apply(body: String, team_id: Double, title: String): TeamsCreateDiscussionLegacyParams = {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionLegacyParamsOps[Self <: TeamsCreateDiscussionLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
