...
@js.native
trait PullsUpdateResponseMilestoneCreator extends js.Object {
...
object PullsUpdateResponseMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsUpdateResponseMilestoneCreator]
  }
  @scala.inline
  implicit class PullsUpdateResponseMilestoneCreatorOps[Self <: PullsUpdateResponseMilestoneCreator] (val x: Self) extends AnyVal {
    @scala.inline
