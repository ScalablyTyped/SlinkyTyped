...
trait OauthAuthorizationsUpdateAuthorizationResponse extends js.Object {
  var app: OauthAuthorizationsUpdateAuthorizationResponseApp = js.native
...
object OauthAuthorizationsUpdateAuthorizationResponse {
  ...
  @scala.inline
  implicit class OauthAuthorizationsUpdateAuthorizationResponseOps[Self <: OauthAuthorizationsUpdateAuthorizationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: OauthAuthorizationsUpdateAuthorizationResponseApp): Self = {
