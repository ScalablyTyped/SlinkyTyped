...
@js.native
trait IssuesRemoveAssigneesResponseAssignee extends js.Object {
...
object IssuesRemoveAssigneesResponseAssignee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesRemoveAssigneesResponseAssignee]
  }
  @scala.inline
  implicit class IssuesRemoveAssigneesResponseAssigneeOps[Self <: IssuesRemoveAssigneesResponseAssignee] (val x: Self) extends AnyVal {
    @scala.inline
