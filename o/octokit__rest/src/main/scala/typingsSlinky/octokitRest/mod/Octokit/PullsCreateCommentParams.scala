...
object PullsCreateCommentParams {
  @scala.inline
  def apply(body: String, commit_id: String, owner: String, path: String, pull_number: Double, repo: String): PullsCreateCommentParams = {
  ...
  @scala.inline
  implicit class PullsCreateCommentParamsOps[Self <: PullsCreateCommentParams] (val x: Self) extends AnyVal {
    @scala.inline
