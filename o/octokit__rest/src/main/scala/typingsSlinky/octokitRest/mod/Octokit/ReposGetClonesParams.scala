...
import typingsSlinky.octokitRest.octokitRestStrings.day
import typingsSlinky.octokitRest.octokitRestStrings.week
...
object ReposGetClonesParams {
  @scala.inline
  def apply(owner: String, repo: String): ReposGetClonesParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposGetClonesParams]
  }
  @scala.inline
  implicit class ReposGetClonesParamsOps[Self <: ReposGetClonesParams] (val x: Self) extends AnyVal {
    @scala.inline
