...
trait AppsCheckAccountIsAssociatedWithAnyStubbedResponse extends js.Object {
  ...
  var marketplace_pending_change: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePendingChange = js.native
  var marketplace_purchase: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchase = js.native
...
object AppsCheckAccountIsAssociatedWithAnyStubbedResponse {
  ...
  @scala.inline
  implicit class AppsCheckAccountIsAssociatedWithAnyStubbedResponseOps[Self <: AppsCheckAccountIsAssociatedWithAnyStubbedResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMarketplace_pending_change(value: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePendingChange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("marketplace_pending_change")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMarketplace_purchase(value: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchase): Self = {
        val ret = this.duplicate
