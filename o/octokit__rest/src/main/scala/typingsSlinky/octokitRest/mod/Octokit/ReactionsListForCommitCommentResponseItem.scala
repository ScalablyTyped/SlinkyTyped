...
trait ReactionsListForCommitCommentResponseItem extends js.Object {
  ...
  var user: ReactionsListForCommitCommentResponseItemUser = js.native
}
...
object ReactionsListForCommitCommentResponseItem {
  ...
  @scala.inline
  implicit class ReactionsListForCommitCommentResponseItemOps[Self <: ReactionsListForCommitCommentResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsListForCommitCommentResponseItemUser): Self = {
        val ret = this.duplicate
