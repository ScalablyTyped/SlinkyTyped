...
object ReposCompareCommitsResponseBaseCommitCommitVerification {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseBaseCommitCommitVerificationOps[Self <: ReposCompareCommitsResponseBaseCommitCommitVerification] (val x: Self) extends AnyVal {
    @scala.inline
