...
trait PullsGetCommentResponse extends js.Object {
  var _links: PullsGetCommentResponseLinks = js.native
  ...
  var user: PullsGetCommentResponseUser = js.native
}
...
object PullsGetCommentResponse {
  ...
  @scala.inline
  implicit class PullsGetCommentResponseOps[Self <: PullsGetCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsGetCommentResponseLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsGetCommentResponseUser): Self = {
        val ret = this.duplicate
