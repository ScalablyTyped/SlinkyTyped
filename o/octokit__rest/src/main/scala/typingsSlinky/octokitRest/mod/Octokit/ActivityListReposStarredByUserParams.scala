...
object ActivityListReposStarredByUserParams {
  @scala.inline
  def apply(username: String): ActivityListReposStarredByUserParams = {
    val __obj = js.Dynamic.literal(username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActivityListReposStarredByUserParams]
  }
  @scala.inline
  implicit class ActivityListReposStarredByUserParamsOps[Self <: ActivityListReposStarredByUserParams] (val x: Self) extends AnyVal {
    @scala.inline
