...
trait ReposRemoveProtectedBranchAppRestrictionsResponseItem extends js.Object {
  ...
  var owner: ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner = js.native
  var permissions: ReposRemoveProtectedBranchAppRestrictionsResponseItemPermissions = js.native
...
object ReposRemoveProtectedBranchAppRestrictionsResponseItem {
  ...
  @scala.inline
  implicit class ReposRemoveProtectedBranchAppRestrictionsResponseItemOps[Self <: ReposRemoveProtectedBranchAppRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposRemoveProtectedBranchAppRestrictionsResponseItemPermissions): Self = {
        val ret = this.duplicate
