...
@js.native
trait SearchCommitsResponseItemsItemRepositoryOwner extends js.Object {
...
object SearchCommitsResponseItemsItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[SearchCommitsResponseItemsItemRepositoryOwner]
  }
  @scala.inline
  implicit class SearchCommitsResponseItemsItemRepositoryOwnerOps[Self <: SearchCommitsResponseItemsItemRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
