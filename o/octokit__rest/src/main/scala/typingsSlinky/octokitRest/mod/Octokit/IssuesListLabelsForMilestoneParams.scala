...
object IssuesListLabelsForMilestoneParams {
  @scala.inline
  def apply(milestone_number: Double, owner: String, repo: String): IssuesListLabelsForMilestoneParams = {
  ...
  @scala.inline
  implicit class IssuesListLabelsForMilestoneParamsOps[Self <: IssuesListLabelsForMilestoneParams] (val x: Self) extends AnyVal {
    @scala.inline
