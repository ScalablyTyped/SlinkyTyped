...
trait IssuesGetEventResponseIssueMilestone extends js.Object {
  ...
  var creator: IssuesGetEventResponseIssueMilestoneCreator = js.native
...
object IssuesGetEventResponseIssueMilestone {
  ...
  @scala.inline
  implicit class IssuesGetEventResponseIssueMilestoneOps[Self <: IssuesGetEventResponseIssueMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesGetEventResponseIssueMilestoneCreator): Self = {
        val ret = this.duplicate
