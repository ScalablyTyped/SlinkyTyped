...
trait TeamsGetDiscussionCommentResponse extends js.Object {
  var author: TeamsGetDiscussionCommentResponseAuthor = js.native
  ...
  var reactions: TeamsGetDiscussionCommentResponseReactions = js.native
...
object TeamsGetDiscussionCommentResponse {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionCommentResponseOps[Self <: TeamsGetDiscussionCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsGetDiscussionCommentResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsGetDiscussionCommentResponseReactions): Self = {
        val ret = this.duplicate
