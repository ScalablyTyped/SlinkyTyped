...
@js.native
trait TeamsListDiscussionCommentsLegacyResponseItemAuthor extends js.Object {
...
object TeamsListDiscussionCommentsLegacyResponseItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListDiscussionCommentsLegacyResponseItemAuthor]
  }
  @scala.inline
  implicit class TeamsListDiscussionCommentsLegacyResponseItemAuthorOps[Self <: TeamsListDiscussionCommentsLegacyResponseItemAuthor] (val x: Self) extends AnyVal {
    @scala.inline
