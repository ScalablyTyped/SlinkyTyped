...
trait TeamsCheckManagesRepoLegacyResponse extends js.Object {
  ...
  var owner: TeamsCheckManagesRepoLegacyResponseOwner = js.native
  var permissions: TeamsCheckManagesRepoLegacyResponsePermissions = js.native
...
object TeamsCheckManagesRepoLegacyResponse {
  ...
  @scala.inline
  implicit class TeamsCheckManagesRepoLegacyResponseOps[Self <: TeamsCheckManagesRepoLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: TeamsCheckManagesRepoLegacyResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: TeamsCheckManagesRepoLegacyResponsePermissions): Self = {
        val ret = this.duplicate
