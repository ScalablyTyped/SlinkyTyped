...
@js.native
trait ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsTeamsItem extends js.Object {
...
object ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsTeamsItem]
  }
  @scala.inline
  implicit class ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsTeamsItemOps[Self <: ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
