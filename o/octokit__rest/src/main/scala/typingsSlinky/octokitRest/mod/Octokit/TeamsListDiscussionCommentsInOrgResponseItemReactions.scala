...
object TeamsListDiscussionCommentsInOrgResponseItemReactions {
  ...
  @scala.inline
  implicit class TeamsListDiscussionCommentsInOrgResponseItemReactionsOps[Self <: TeamsListDiscussionCommentsInOrgResponseItemReactions] (val x: Self) extends AnyVal {
    @scala.inline
