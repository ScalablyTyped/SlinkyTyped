...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner {
  ...
  @scala.inline
  implicit class ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwnerOps[Self <: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
