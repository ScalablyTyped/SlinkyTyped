...
object ReactionsListForTeamDiscussionCommentParams {
  @scala.inline
  def apply(comment_number: Double, discussion_number: Double, team_id: Double): ReactionsListForTeamDiscussionCommentParams = {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentParamsOps[Self <: ReactionsListForTeamDiscussionCommentParams] (val x: Self) extends AnyVal {
    @scala.inline
