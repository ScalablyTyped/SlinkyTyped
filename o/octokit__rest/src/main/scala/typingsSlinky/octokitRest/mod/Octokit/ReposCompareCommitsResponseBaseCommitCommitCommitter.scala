...
object ReposCompareCommitsResponseBaseCommitCommitCommitter {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseBaseCommitCommitCommitterOps[Self <: ReposCompareCommitsResponseBaseCommitCommitCommitter] (val x: Self) extends AnyVal {
    @scala.inline
