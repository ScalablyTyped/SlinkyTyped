...
@js.native
trait IssuesListForOrgResponseItemMilestoneCreator extends js.Object {
...
object IssuesListForOrgResponseItemMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForOrgResponseItemMilestoneCreator]
  }
  @scala.inline
  implicit class IssuesListForOrgResponseItemMilestoneCreatorOps[Self <: IssuesListForOrgResponseItemMilestoneCreator] (val x: Self) extends AnyVal {
    @scala.inline
