...
trait ActionsListWorkflowRunsResponse extends js.Object {
  ...
  var workflow_runs: js.Array[ActionsListWorkflowRunsResponseWorkflowRunsItem] = js.native
}
...
object ActionsListWorkflowRunsResponse {
  ...
  @scala.inline
  implicit class ActionsListWorkflowRunsResponseOps[Self <: ActionsListWorkflowRunsResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withWorkflow_runs(value: js.Array[ActionsListWorkflowRunsResponseWorkflowRunsItem]): Self = {
        val ret = this.duplicate
