...
@js.native
trait IssuesListMilestonesForRepoResponseItemCreator extends js.Object {
...
object IssuesListMilestonesForRepoResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListMilestonesForRepoResponseItemCreator]
  }
  @scala.inline
  implicit class IssuesListMilestonesForRepoResponseItemCreatorOps[Self <: IssuesListMilestonesForRepoResponseItemCreator] (val x: Self) extends AnyVal {
    @scala.inline
