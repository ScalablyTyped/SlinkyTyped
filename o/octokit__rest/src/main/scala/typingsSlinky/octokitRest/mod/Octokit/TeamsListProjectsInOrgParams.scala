...
object TeamsListProjectsInOrgParams {
  @scala.inline
  def apply(org_ : String, team_slug: String): TeamsListProjectsInOrgParams = {
  ...
  @scala.inline
  implicit class TeamsListProjectsInOrgParamsOps[Self <: TeamsListProjectsInOrgParams] (val x: Self) extends AnyVal {
    @scala.inline
