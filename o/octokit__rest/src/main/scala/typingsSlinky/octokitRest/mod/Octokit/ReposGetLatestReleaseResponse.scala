...
trait ReposGetLatestReleaseResponse extends js.Object {
  var assets: js.Array[ReposGetLatestReleaseResponseAssetsItem] = js.native
  var assets_url: String = js.native
  var author: ReposGetLatestReleaseResponseAuthor = js.native
...
object ReposGetLatestReleaseResponse {
  ...
  @scala.inline
  implicit class ReposGetLatestReleaseResponseOps[Self <: ReposGetLatestReleaseResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAssets(value: js.Array[ReposGetLatestReleaseResponseAssetsItem]): Self = {
    ...
    @scala.inline
    def withAuthor(value: ReposGetLatestReleaseResponseAuthor): Self = {
        val ret = this.duplicate
