...
object ReposGetUsersWithAccessToProtectedBranchResponseItem {
  ...
  @scala.inline
  implicit class ReposGetUsersWithAccessToProtectedBranchResponseItemOps[Self <: ReposGetUsersWithAccessToProtectedBranchResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
