...
object ChecksListAnnotationsParams {
  @scala.inline
  def apply(check_run_id: Double, owner: String, repo: String): ChecksListAnnotationsParams = {
  ...
  @scala.inline
  implicit class ChecksListAnnotationsParamsOps[Self <: ChecksListAnnotationsParams] (val x: Self) extends AnyVal {
    @scala.inline
