...
trait MigrationsListForOrgResponseItemRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsListForOrgResponseItemRepositoriesItemOwner = js.native
  var permissions: MigrationsListForOrgResponseItemRepositoriesItemPermissions = js.native
...
object MigrationsListForOrgResponseItemRepositoriesItem {
  ...
  @scala.inline
  implicit class MigrationsListForOrgResponseItemRepositoriesItemOps[Self <: MigrationsListForOrgResponseItemRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsListForOrgResponseItemRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsListForOrgResponseItemRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
