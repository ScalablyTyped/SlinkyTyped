...
object ActivityListReposStarredByAuthenticatedUserResponseItemPermissions {
  ...
  @scala.inline
  implicit class ActivityListReposStarredByAuthenticatedUserResponseItemPermissionsOps[Self <: ActivityListReposStarredByAuthenticatedUserResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
