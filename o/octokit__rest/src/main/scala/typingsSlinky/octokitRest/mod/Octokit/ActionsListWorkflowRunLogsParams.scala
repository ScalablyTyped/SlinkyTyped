...
object ActionsListWorkflowRunLogsParams {
  @scala.inline
  def apply(owner: String, repo: String, run_id: Double): ActionsListWorkflowRunLogsParams = {
  ...
  @scala.inline
  implicit class ActionsListWorkflowRunLogsParamsOps[Self <: ActionsListWorkflowRunLogsParams] (val x: Self) extends AnyVal {
    @scala.inline
