...
trait ProjectsListForUserResponseItem extends js.Object {
  ...
  var creator: ProjectsListForUserResponseItemCreator = js.native
...
object ProjectsListForUserResponseItem {
  ...
  @scala.inline
  implicit class ProjectsListForUserResponseItemOps[Self <: ProjectsListForUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsListForUserResponseItemCreator): Self = {
        val ret = this.duplicate
