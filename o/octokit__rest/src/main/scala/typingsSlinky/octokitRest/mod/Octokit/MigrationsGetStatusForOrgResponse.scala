...
trait MigrationsGetStatusForOrgResponse extends js.Object {
  ...
  var owner: MigrationsGetStatusForOrgResponseOwner = js.native
  var repositories: js.Array[MigrationsGetStatusForOrgResponseRepositoriesItem] = js.native
...
object MigrationsGetStatusForOrgResponse {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForOrgResponseOps[Self <: MigrationsGetStatusForOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsGetStatusForOrgResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRepositories(value: js.Array[MigrationsGetStatusForOrgResponseRepositoriesItem]): Self = {
        val ret = this.duplicate
