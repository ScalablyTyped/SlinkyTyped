...
object TeamsListChildInOrgParams {
  @scala.inline
  def apply(org_ : String, team_slug: String): TeamsListChildInOrgParams = {
  ...
  @scala.inline
  implicit class TeamsListChildInOrgParamsOps[Self <: TeamsListChildInOrgParams] (val x: Self) extends AnyVal {
    @scala.inline
