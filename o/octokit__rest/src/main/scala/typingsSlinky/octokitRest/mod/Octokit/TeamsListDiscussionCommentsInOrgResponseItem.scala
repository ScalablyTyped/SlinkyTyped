...
@js.native
trait TeamsListDiscussionCommentsInOrgResponseItem extends js.Object {
  var author: TeamsListDiscussionCommentsInOrgResponseItemAuthor = js.native
  ...
  var reactions: TeamsListDiscussionCommentsInOrgResponseItemReactions = js.native
  var updated_at: String = js.native
  var url: String = js.native
}

object TeamsListDiscussionCommentsInOrgResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListDiscussionCommentsInOrgResponseItem]
  }
  @scala.inline
  implicit class TeamsListDiscussionCommentsInOrgResponseItemOps[Self <: TeamsListDiscussionCommentsInOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsListDiscussionCommentsInOrgResponseItemAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsListDiscussionCommentsInOrgResponseItemReactions): Self = {
        val ret = this.duplicate
