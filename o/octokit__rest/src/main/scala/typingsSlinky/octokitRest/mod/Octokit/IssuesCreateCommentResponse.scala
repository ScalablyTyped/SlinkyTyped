...
trait IssuesCreateCommentResponse extends js.Object {
  ...
  var user: IssuesCreateCommentResponseUser = js.native
}
...
object IssuesCreateCommentResponse {
  ...
  @scala.inline
  implicit class IssuesCreateCommentResponseOps[Self <: IssuesCreateCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: IssuesCreateCommentResponseUser): Self = {
        val ret = this.duplicate
