...
trait ChecksSetSuitesPreferencesResponseRepository extends js.Object {
  ...
  var owner: ChecksSetSuitesPreferencesResponseRepositoryOwner = js.native
  var permissions: ChecksSetSuitesPreferencesResponseRepositoryPermissions = js.native
...
object ChecksSetSuitesPreferencesResponseRepository {
  ...
  @scala.inline
  implicit class ChecksSetSuitesPreferencesResponseRepositoryOps[Self <: ChecksSetSuitesPreferencesResponseRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksSetSuitesPreferencesResponseRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksSetSuitesPreferencesResponseRepositoryPermissions): Self = {
        val ret = this.duplicate
