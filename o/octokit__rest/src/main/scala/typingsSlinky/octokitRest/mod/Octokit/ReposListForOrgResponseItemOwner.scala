...
@js.native
trait ReposListForOrgResponseItemOwner extends js.Object {
...
object ReposListForOrgResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListForOrgResponseItemOwner]
  }
  @scala.inline
  implicit class ReposListForOrgResponseItemOwnerOps[Self <: ReposListForOrgResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
