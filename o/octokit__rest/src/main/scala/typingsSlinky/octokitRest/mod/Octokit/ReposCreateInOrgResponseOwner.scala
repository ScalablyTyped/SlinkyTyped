...
@js.native
trait ReposCreateInOrgResponseOwner extends js.Object {
...
object ReposCreateInOrgResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCreateInOrgResponseOwner]
  }
  @scala.inline
  implicit class ReposCreateInOrgResponseOwnerOps[Self <: ReposCreateInOrgResponseOwner] (val x: Self) extends AnyVal {
    @scala.inline
