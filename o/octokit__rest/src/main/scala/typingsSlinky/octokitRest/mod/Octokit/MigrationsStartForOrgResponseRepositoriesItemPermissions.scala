...
object MigrationsStartForOrgResponseRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class MigrationsStartForOrgResponseRepositoriesItemPermissionsOps[Self <: MigrationsStartForOrgResponseRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
