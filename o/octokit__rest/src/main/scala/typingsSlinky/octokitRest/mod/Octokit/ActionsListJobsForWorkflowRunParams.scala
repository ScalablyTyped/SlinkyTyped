...
object ActionsListJobsForWorkflowRunParams {
  @scala.inline
  def apply(owner: String, repo: String, run_id: Double): ActionsListJobsForWorkflowRunParams = {
  ...
  @scala.inline
  implicit class ActionsListJobsForWorkflowRunParamsOps[Self <: ActionsListJobsForWorkflowRunParams] (val x: Self) extends AnyVal {
    @scala.inline
