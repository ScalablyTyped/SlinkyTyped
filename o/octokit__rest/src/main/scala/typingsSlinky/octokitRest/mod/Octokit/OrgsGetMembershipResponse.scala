...
trait OrgsGetMembershipResponse extends js.Object {
  var organization: OrgsGetMembershipResponseOrganization = js.native
  var organization_url: String = js.native
  var role: String = js.native
  var state: String = js.native
  var url: String = js.native
  var user: OrgsGetMembershipResponseUser = js.native
}
...
object OrgsGetMembershipResponse {
  ...
  @scala.inline
  implicit class OrgsGetMembershipResponseOps[Self <: OrgsGetMembershipResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withOrganization(value: OrgsGetMembershipResponseOrganization): Self = {
    ...
    @scala.inline
    def withUser(value: OrgsGetMembershipResponseUser): Self = {
        val ret = this.duplicate
