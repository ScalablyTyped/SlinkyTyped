...
object IssuesListForAuthenticatedUserResponseItemRepositoryOwner {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemRepositoryOwnerOps[Self <: IssuesListForAuthenticatedUserResponseItemRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
