...
trait PullsCreateCommentResponse extends js.Object {
  var _links: PullsCreateCommentResponseLinks = js.native
  ...
  var user: PullsCreateCommentResponseUser = js.native
}
...
object PullsCreateCommentResponse {
  ...
  @scala.inline
  implicit class PullsCreateCommentResponseOps[Self <: PullsCreateCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsCreateCommentResponseLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsCreateCommentResponseUser): Self = {
        val ret = this.duplicate
