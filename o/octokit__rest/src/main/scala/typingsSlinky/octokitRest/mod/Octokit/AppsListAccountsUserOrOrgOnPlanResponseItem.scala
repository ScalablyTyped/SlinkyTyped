...
trait AppsListAccountsUserOrOrgOnPlanResponseItem extends js.Object {
  ...
  var marketplace_pending_change: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChange = js.native
  var marketplace_purchase: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchase = js.native
...
object AppsListAccountsUserOrOrgOnPlanResponseItem {
  ...
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanResponseItemOps[Self <: AppsListAccountsUserOrOrgOnPlanResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMarketplace_pending_change(value: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("marketplace_pending_change")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMarketplace_purchase(value: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchase): Self = {
        val ret = this.duplicate
