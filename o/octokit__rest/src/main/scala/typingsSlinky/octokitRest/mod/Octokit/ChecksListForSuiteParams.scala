...
import typingsSlinky.octokitRest.octokitRestStrings.latest
...
object ChecksListForSuiteParams {
  @scala.inline
  def apply(check_suite_id: Double, owner: String, repo: String): ChecksListForSuiteParams = {
  ...
  @scala.inline
  implicit class ChecksListForSuiteParamsOps[Self <: ChecksListForSuiteParams] (val x: Self) extends AnyVal {
    @scala.inline
