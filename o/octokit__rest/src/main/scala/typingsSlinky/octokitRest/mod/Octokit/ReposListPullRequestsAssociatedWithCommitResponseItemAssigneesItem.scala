...
object ReposListPullRequestsAssociatedWithCommitResponseItemAssigneesItem {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemAssigneesItemOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemAssigneesItem] (val x: Self) extends AnyVal {
    @scala.inline
