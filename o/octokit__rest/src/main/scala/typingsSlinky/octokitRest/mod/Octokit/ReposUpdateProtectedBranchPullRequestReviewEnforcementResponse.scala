...
trait ReposUpdateProtectedBranchPullRequestReviewEnforcementResponse extends js.Object {
  ...
  var dismissal_restrictions: ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictions = js.native
...
object ReposUpdateProtectedBranchPullRequestReviewEnforcementResponse {
  ...
  @scala.inline
  implicit class ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseOps[Self <: ReposUpdateProtectedBranchPullRequestReviewEnforcementResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDismissal_restrictions(value: ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictions): Self = {
        val ret = this.duplicate
