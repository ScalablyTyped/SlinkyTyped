...
trait IssuesGetResponseMilestone extends js.Object {
  ...
  var creator: IssuesGetResponseMilestoneCreator = js.native
...
object IssuesGetResponseMilestone {
  ...
  @scala.inline
  implicit class IssuesGetResponseMilestoneOps[Self <: IssuesGetResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesGetResponseMilestoneCreator): Self = {
        val ret = this.duplicate
