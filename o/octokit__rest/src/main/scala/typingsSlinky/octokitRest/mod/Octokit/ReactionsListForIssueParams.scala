...
object ReactionsListForIssueParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): ReactionsListForIssueParams = {
  ...
  @scala.inline
  implicit class ReactionsListForIssueParamsOps[Self <: ReactionsListForIssueParams] (val x: Self) extends AnyVal {
    @scala.inline
