...
trait ChecksCreateResponsePullRequestsItemHead extends js.Object {
  ...
  var repo: ChecksCreateResponsePullRequestsItemHeadRepo = js.native
...
object ChecksCreateResponsePullRequestsItemHead {
  ...
  @scala.inline
  implicit class ChecksCreateResponsePullRequestsItemHeadOps[Self <: ChecksCreateResponsePullRequestsItemHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: ChecksCreateResponsePullRequestsItemHeadRepo): Self = {
        val ret = this.duplicate
