...
@js.native
trait TeamsUpdateLegacyResponseOrganization extends js.Object {
...
object TeamsUpdateLegacyResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    blog: String,
    ...
    __obj.asInstanceOf[TeamsUpdateLegacyResponseOrganization]
  }
  @scala.inline
  implicit class TeamsUpdateLegacyResponseOrganizationOps[Self <: TeamsUpdateLegacyResponseOrganization] (val x: Self) extends AnyVal {
    @scala.inline
