...
@js.native
trait ReposListPullRequestsAssociatedWithCommitResponseItemRequestedReviewersItem extends js.Object {
...
object ReposListPullRequestsAssociatedWithCommitResponseItemRequestedReviewersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemRequestedReviewersItem]
  }
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemRequestedReviewersItemOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemRequestedReviewersItem] (val x: Self) extends AnyVal {
    @scala.inline
