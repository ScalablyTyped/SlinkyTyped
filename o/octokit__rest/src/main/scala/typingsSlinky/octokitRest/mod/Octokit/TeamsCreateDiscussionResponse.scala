...
trait TeamsCreateDiscussionResponse extends js.Object {
  var author: TeamsCreateDiscussionResponseAuthor = js.native
  ...
  var reactions: TeamsCreateDiscussionResponseReactions = js.native
...
object TeamsCreateDiscussionResponse {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionResponseOps[Self <: TeamsCreateDiscussionResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsCreateDiscussionResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsCreateDiscussionResponseReactions): Self = {
        val ret = this.duplicate
