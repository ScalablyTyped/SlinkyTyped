...
object IssuesReplaceLabelsParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesReplaceLabelsParams = {
  ...
  @scala.inline
  implicit class IssuesReplaceLabelsParamsOps[Self <: IssuesReplaceLabelsParams] (val x: Self) extends AnyVal {
    @scala.inline
