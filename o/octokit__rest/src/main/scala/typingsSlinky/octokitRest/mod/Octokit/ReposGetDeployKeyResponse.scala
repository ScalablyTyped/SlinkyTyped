...
@js.native
trait ReposGetDeployKeyResponse extends js.Object {
...
object ReposGetDeployKeyResponse {
  @scala.inline
  def apply(
    created_at: String,
    id: Double,
  ...
  @scala.inline
  implicit class ReposGetDeployKeyResponseOps[Self <: ReposGetDeployKeyResponse] (val x: Self) extends AnyVal {
    @scala.inline
