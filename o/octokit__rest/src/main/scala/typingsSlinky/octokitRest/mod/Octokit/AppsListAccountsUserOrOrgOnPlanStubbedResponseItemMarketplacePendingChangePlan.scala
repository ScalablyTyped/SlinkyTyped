...
object AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePendingChangePlan {
  ...
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePendingChangePlanOps[Self <: AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePendingChangePlan] (val x: Self) extends AnyVal {
    @scala.inline
