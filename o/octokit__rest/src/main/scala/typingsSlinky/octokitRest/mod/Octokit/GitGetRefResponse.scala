...
trait GitGetRefResponse extends js.Object {
  ...
  var `object`: GitGetRefResponseObject = js.native
...
object GitGetRefResponse {
  ...
  @scala.inline
  implicit class GitGetRefResponseOps[Self <: GitGetRefResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withObject(value: GitGetRefResponseObject): Self = {
        val ret = this.duplicate
