...
trait GistsListResponseItem extends js.Object {
  ...
  var files: GistsListResponseItemFiles = js.native
  ...
  var owner: GistsListResponseItemOwner = js.native
...
object GistsListResponseItem {
  ...
  @scala.inline
  implicit class GistsListResponseItemOps[Self <: GistsListResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsListResponseItemFiles): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsListResponseItemOwner): Self = {
        val ret = this.duplicate
