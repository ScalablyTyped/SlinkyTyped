...
@js.native
trait GistsGetResponseForksItemUser extends js.Object {
...
object GistsGetResponseForksItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[GistsGetResponseForksItemUser]
  }
  @scala.inline
  implicit class GistsGetResponseForksItemUserOps[Self <: GistsGetResponseForksItemUser] (val x: Self) extends AnyVal {
    @scala.inline
