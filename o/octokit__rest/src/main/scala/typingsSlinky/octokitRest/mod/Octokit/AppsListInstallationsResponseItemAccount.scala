...
@js.native
trait AppsListInstallationsResponseItemAccount extends js.Object {
...
object AppsListInstallationsResponseItemAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[AppsListInstallationsResponseItemAccount]
  }
  @scala.inline
  implicit class AppsListInstallationsResponseItemAccountOps[Self <: AppsListInstallationsResponseItemAccount] (val x: Self) extends AnyVal {
    @scala.inline
