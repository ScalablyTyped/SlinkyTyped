...
object IssuesUpdateParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesUpdateParams = {
  ...
  @scala.inline
  implicit class IssuesUpdateParamsOps[Self <: IssuesUpdateParams] (val x: Self) extends AnyVal {
    @scala.inline
