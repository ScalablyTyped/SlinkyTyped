...
@js.native
trait IssuesAddLabelsResponseItem extends js.Object {
...
object IssuesAddLabelsResponseItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[IssuesAddLabelsResponseItem]
  }
  @scala.inline
  implicit class IssuesAddLabelsResponseItemOps[Self <: IssuesAddLabelsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
