...
@js.native
trait GistsListPublicForUserResponseItemOwner extends js.Object {
...
object GistsListPublicForUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[GistsListPublicForUserResponseItemOwner]
  }
  @scala.inline
  implicit class GistsListPublicForUserResponseItemOwnerOps[Self <: GistsListPublicForUserResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
