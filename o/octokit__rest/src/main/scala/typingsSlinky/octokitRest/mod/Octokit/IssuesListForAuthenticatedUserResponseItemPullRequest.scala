...
object IssuesListForAuthenticatedUserResponseItemPullRequest {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemPullRequestOps[Self <: IssuesListForAuthenticatedUserResponseItemPullRequest] (val x: Self) extends AnyVal {
    @scala.inline
