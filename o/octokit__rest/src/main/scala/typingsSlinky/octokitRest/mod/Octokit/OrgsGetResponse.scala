...
object OrgsGetResponse {
  ...
  def apply(
    ...
    collaborators: js.UndefOr[Double] = js.undefined,
    default_repository_permission: String = null,
    disk_usage: js.UndefOr[Double] = js.undefined,
    ...
    owned_private_repos: js.UndefOr[Double] = js.undefined,
    private_gists: js.UndefOr[Double] = js.undefined,
    total_private_repos: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(collaborators)) __obj.updateDynamic("collaborators")(collaborators.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(disk_usage)) __obj.updateDynamic("disk_usage")(disk_usage.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(owned_private_repos)) __obj.updateDynamic("owned_private_repos")(owned_private_repos.get.asInstanceOf[js.Any])
    if (!js.isUndefined(private_gists)) __obj.updateDynamic("private_gists")(private_gists.get.asInstanceOf[js.Any])
    if (!js.isUndefined(total_private_repos)) __obj.updateDynamic("total_private_repos")(total_private_repos.get.asInstanceOf[js.Any])
    if (!js.isUndefined(two_factor_requirement_enabled)) __obj.updateDynamic("two_factor_requirement_enabled")(two_factor_requirement_enabled.get.asInstanceOf[js.Any])
