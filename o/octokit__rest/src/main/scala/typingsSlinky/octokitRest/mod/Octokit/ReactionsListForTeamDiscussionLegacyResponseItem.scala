...
trait ReactionsListForTeamDiscussionLegacyResponseItem extends js.Object {
  ...
  var user: ReactionsListForTeamDiscussionLegacyResponseItemUser = js.native
}
...
object ReactionsListForTeamDiscussionLegacyResponseItem {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionLegacyResponseItemOps[Self <: ReactionsListForTeamDiscussionLegacyResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsListForTeamDiscussionLegacyResponseItemUser): Self = {
        val ret = this.duplicate
