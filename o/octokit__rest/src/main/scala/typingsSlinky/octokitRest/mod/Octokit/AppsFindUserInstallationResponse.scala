...
@js.native
trait AppsFindUserInstallationResponse extends js.Object {
  var access_tokens_url: String = js.native
  var account: AppsFindUserInstallationResponseAccount = js.native
  var app_id: Double = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: AppsFindUserInstallationResponsePermissions = js.native
...
object AppsFindUserInstallationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindUserInstallationResponse]
  }
  @scala.inline
  implicit class AppsFindUserInstallationResponseOps[Self <: AppsFindUserInstallationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: AppsFindUserInstallationResponseAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: AppsFindUserInstallationResponsePermissions): Self = {
        val ret = this.duplicate
