...
trait GistsUpdateResponseHistoryItem extends js.Object {
  var change_status: GistsUpdateResponseHistoryItemChangeStatus = js.native
  var committed_at: String = js.native
  var url: String = js.native
  var user: GistsUpdateResponseHistoryItemUser = js.native
...
object GistsUpdateResponseHistoryItem {
  ...
  @scala.inline
  implicit class GistsUpdateResponseHistoryItemOps[Self <: GistsUpdateResponseHistoryItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withChange_status(value: GistsUpdateResponseHistoryItemChangeStatus): Self = {
    ...
    @scala.inline
    def withUser(value: GistsUpdateResponseHistoryItemUser): Self = {
        val ret = this.duplicate
