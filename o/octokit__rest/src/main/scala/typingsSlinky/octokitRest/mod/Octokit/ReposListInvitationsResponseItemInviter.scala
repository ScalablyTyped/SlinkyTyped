...
@js.native
trait ReposListInvitationsResponseItemInviter extends js.Object {
...
object ReposListInvitationsResponseItemInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListInvitationsResponseItemInviter]
  }
  @scala.inline
  implicit class ReposListInvitationsResponseItemInviterOps[Self <: ReposListInvitationsResponseItemInviter] (val x: Self) extends AnyVal {
    @scala.inline
