...
@js.native
trait TeamsListDiscussionsLegacyResponseItemAuthor extends js.Object {
...
object TeamsListDiscussionsLegacyResponseItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListDiscussionsLegacyResponseItemAuthor]
  }
  @scala.inline
  implicit class TeamsListDiscussionsLegacyResponseItemAuthorOps[Self <: TeamsListDiscussionsLegacyResponseItemAuthor] (val x: Self) extends AnyVal {
    @scala.inline
