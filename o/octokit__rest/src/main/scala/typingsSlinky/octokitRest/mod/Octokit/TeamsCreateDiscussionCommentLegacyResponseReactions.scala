...
@js.native
trait TeamsCreateDiscussionCommentLegacyResponseReactions extends js.Object {
...
object TeamsCreateDiscussionCommentLegacyResponseReactions {
  @scala.inline
  def apply(
    `-1`: Double,
    Plussign1: Double,
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionCommentLegacyResponseReactions]
  }
  @scala.inline
  implicit class TeamsCreateDiscussionCommentLegacyResponseReactionsOps[Self <: TeamsCreateDiscussionCommentLegacyResponseReactions] (val x: Self) extends AnyVal {
    @scala.inline
