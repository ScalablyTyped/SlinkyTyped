...
object ChecksCreateResponseOutput {
  ...
  def apply(
    ...
    text: String,
    title: String,
    annotations_count: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(annotations_count)) __obj.updateDynamic("annotations_count")(annotations_count.get.asInstanceOf[js.Any])
