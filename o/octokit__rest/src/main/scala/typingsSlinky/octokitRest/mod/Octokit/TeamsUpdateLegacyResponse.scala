...
@js.native
trait TeamsUpdateLegacyResponse extends js.Object {
  ...
  var organization: TeamsUpdateLegacyResponseOrganization = js.native
...
object TeamsUpdateLegacyResponse {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[TeamsUpdateLegacyResponse]
  }
  @scala.inline
  implicit class TeamsUpdateLegacyResponseOps[Self <: TeamsUpdateLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOrganization(value: TeamsUpdateLegacyResponseOrganization): Self = {
        val ret = this.duplicate
