...
object ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItem {
  ...
  @scala.inline
  implicit class ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItemOps[Self <: ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
