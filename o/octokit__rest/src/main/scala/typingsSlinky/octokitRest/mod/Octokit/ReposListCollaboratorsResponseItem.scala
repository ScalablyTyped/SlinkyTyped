...
trait ReposListCollaboratorsResponseItem extends js.Object {
  ...
  var permissions: ReposListCollaboratorsResponseItemPermissions = js.native
...
object ReposListCollaboratorsResponseItem {
  ...
  @scala.inline
  implicit class ReposListCollaboratorsResponseItemOps[Self <: ReposListCollaboratorsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPermissions(value: ReposListCollaboratorsResponseItemPermissions): Self = {
        val ret = this.duplicate
