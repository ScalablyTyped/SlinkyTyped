...
object TeamsListPendingInvitationsInOrgResponseItemInviter {
  ...
  @scala.inline
  implicit class TeamsListPendingInvitationsInOrgResponseItemInviterOps[Self <: TeamsListPendingInvitationsInOrgResponseItemInviter] (val x: Self) extends AnyVal {
    @scala.inline
