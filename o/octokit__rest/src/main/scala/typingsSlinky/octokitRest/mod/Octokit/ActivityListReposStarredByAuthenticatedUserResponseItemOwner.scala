...
@js.native
trait ActivityListReposStarredByAuthenticatedUserResponseItemOwner extends js.Object {
...
object ActivityListReposStarredByAuthenticatedUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListReposStarredByAuthenticatedUserResponseItemOwner]
  }
  @scala.inline
  implicit class ActivityListReposStarredByAuthenticatedUserResponseItemOwnerOps[Self <: ActivityListReposStarredByAuthenticatedUserResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
