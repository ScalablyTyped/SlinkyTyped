...
object TeamsListReposLegacyParams {
  @scala.inline
  def apply(team_id: Double): TeamsListReposLegacyParams = {
    val __obj = js.Dynamic.literal(team_id = team_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TeamsListReposLegacyParams]
  }
  @scala.inline
  implicit class TeamsListReposLegacyParamsOps[Self <: TeamsListReposLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
