...
object SearchIssuesAndPullRequestsParams {
  @scala.inline
  def apply(q: String): SearchIssuesAndPullRequestsParams = {
    val __obj = js.Dynamic.literal(q = q.asInstanceOf[js.Any])
    __obj.asInstanceOf[SearchIssuesAndPullRequestsParams]
  }
  @scala.inline
  implicit class SearchIssuesAndPullRequestsParamsOps[Self <: SearchIssuesAndPullRequestsParams] (val x: Self) extends AnyVal {
    @scala.inline
