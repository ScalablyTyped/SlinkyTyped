...
@js.native
trait ReposListInvitationsResponseItemRepositoryOwner extends js.Object {
...
object ReposListInvitationsResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListInvitationsResponseItemRepositoryOwner]
  }
  @scala.inline
  implicit class ReposListInvitationsResponseItemRepositoryOwnerOps[Self <: ReposListInvitationsResponseItemRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
