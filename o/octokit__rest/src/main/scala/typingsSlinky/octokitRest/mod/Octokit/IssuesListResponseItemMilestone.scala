...
trait IssuesListResponseItemMilestone extends js.Object {
  ...
  var creator: IssuesListResponseItemMilestoneCreator = js.native
...
object IssuesListResponseItemMilestone {
  ...
  @scala.inline
  implicit class IssuesListResponseItemMilestoneOps[Self <: IssuesListResponseItemMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesListResponseItemMilestoneCreator): Self = {
        val ret = this.duplicate
