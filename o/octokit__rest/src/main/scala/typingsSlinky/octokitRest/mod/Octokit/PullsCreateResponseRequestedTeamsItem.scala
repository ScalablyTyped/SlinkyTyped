...
@js.native
trait PullsCreateResponseRequestedTeamsItem extends js.Object {
...
object PullsCreateResponseRequestedTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[PullsCreateResponseRequestedTeamsItem]
  }
  @scala.inline
  implicit class PullsCreateResponseRequestedTeamsItemOps[Self <: PullsCreateResponseRequestedTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
