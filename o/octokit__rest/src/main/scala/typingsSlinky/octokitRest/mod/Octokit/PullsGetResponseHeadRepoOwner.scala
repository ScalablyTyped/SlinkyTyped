...
@js.native
trait PullsGetResponseHeadRepoOwner extends js.Object {
...
object PullsGetResponseHeadRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsGetResponseHeadRepoOwner]
  }
  @scala.inline
  implicit class PullsGetResponseHeadRepoOwnerOps[Self <: PullsGetResponseHeadRepoOwner] (val x: Self) extends AnyVal {
    @scala.inline
