...
object ReposListProtectedBranchUserRestrictionsResponseItem {
  ...
  @scala.inline
  implicit class ReposListProtectedBranchUserRestrictionsResponseItemOps[Self <: ReposListProtectedBranchUserRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
