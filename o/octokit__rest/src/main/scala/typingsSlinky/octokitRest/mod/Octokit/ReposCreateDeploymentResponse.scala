...
trait ReposCreateDeploymentResponse extends js.Object {
  ...
  var creator: ReposCreateDeploymentResponseCreator = js.native
  var description: String = js.native
  var environment: String = js.native
  var id: Double = js.native
  var node_id: String = js.native
  var original_environment: String = js.native
  var payload: ReposCreateDeploymentResponsePayload = js.native
...
object ReposCreateDeploymentResponse {
  ...
  @scala.inline
  implicit class ReposCreateDeploymentResponseOps[Self <: ReposCreateDeploymentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ReposCreateDeploymentResponseCreator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPayload(value: ReposCreateDeploymentResponsePayload): Self = {
        val ret = this.duplicate
