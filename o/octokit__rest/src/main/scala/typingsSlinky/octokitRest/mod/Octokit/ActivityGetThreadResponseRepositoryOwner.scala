...
@js.native
trait ActivityGetThreadResponseRepositoryOwner extends js.Object {
...
object ActivityGetThreadResponseRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityGetThreadResponseRepositoryOwner]
  }
  @scala.inline
  implicit class ActivityGetThreadResponseRepositoryOwnerOps[Self <: ActivityGetThreadResponseRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
