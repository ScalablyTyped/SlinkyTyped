...
trait ReactionsCreateForIssueCommentResponse extends js.Object {
  ...
  var user: ReactionsCreateForIssueCommentResponseUser = js.native
}
...
object ReactionsCreateForIssueCommentResponse {
  ...
  @scala.inline
  implicit class ReactionsCreateForIssueCommentResponseOps[Self <: ReactionsCreateForIssueCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsCreateForIssueCommentResponseUser): Self = {
        val ret = this.duplicate
