...
trait OrgsListInstallationsResponseInstallationsItem extends js.Object {
  ...
  var account: OrgsListInstallationsResponseInstallationsItemAccount = js.native
  var app_id: Double = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: OrgsListInstallationsResponseInstallationsItemPermissions = js.native
...
object OrgsListInstallationsResponseInstallationsItem {
  ...
  @scala.inline
  implicit class OrgsListInstallationsResponseInstallationsItemOps[Self <: OrgsListInstallationsResponseInstallationsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: OrgsListInstallationsResponseInstallationsItemAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: OrgsListInstallationsResponseInstallationsItemPermissions): Self = {
        val ret = this.duplicate
