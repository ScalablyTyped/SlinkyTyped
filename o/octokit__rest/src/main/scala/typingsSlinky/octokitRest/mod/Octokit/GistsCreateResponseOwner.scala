...
@js.native
trait GistsCreateResponseOwner extends js.Object {
...
object GistsCreateResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[GistsCreateResponseOwner]
  }
  @scala.inline
  implicit class GistsCreateResponseOwnerOps[Self <: GistsCreateResponseOwner] (val x: Self) extends AnyVal {
    @scala.inline
