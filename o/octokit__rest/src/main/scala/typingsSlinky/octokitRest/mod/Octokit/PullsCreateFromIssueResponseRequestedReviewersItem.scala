...
object PullsCreateFromIssueResponseRequestedReviewersItem {
  ...
  @scala.inline
  implicit class PullsCreateFromIssueResponseRequestedReviewersItemOps[Self <: PullsCreateFromIssueResponseRequestedReviewersItem] (val x: Self) extends AnyVal {
    @scala.inline
