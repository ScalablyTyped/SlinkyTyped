...
trait ReactionsCreateForTeamDiscussionLegacyResponse extends js.Object {
  ...
  var user: ReactionsCreateForTeamDiscussionLegacyResponseUser = js.native
}
...
object ReactionsCreateForTeamDiscussionLegacyResponse {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionLegacyResponseOps[Self <: ReactionsCreateForTeamDiscussionLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsCreateForTeamDiscussionLegacyResponseUser): Self = {
        val ret = this.duplicate
