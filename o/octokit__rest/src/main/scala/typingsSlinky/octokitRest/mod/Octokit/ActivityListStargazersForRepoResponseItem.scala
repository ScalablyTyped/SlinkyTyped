...
@js.native
trait ActivityListStargazersForRepoResponseItem extends js.Object {
...
object ActivityListStargazersForRepoResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListStargazersForRepoResponseItem]
  }
  @scala.inline
  implicit class ActivityListStargazersForRepoResponseItemOps[Self <: ActivityListStargazersForRepoResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
