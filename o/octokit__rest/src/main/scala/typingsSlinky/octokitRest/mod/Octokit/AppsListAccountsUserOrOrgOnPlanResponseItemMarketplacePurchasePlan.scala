...
object AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlan {
  ...
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlanOps[Self <: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlan] (val x: Self) extends AnyVal {
    @scala.inline
