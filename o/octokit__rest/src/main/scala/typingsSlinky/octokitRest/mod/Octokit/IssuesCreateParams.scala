...
object IssuesCreateParams {
  @scala.inline
  def apply(owner: String, repo: String, title: String): IssuesCreateParams = {
  ...
  @scala.inline
  implicit class IssuesCreateParamsOps[Self <: IssuesCreateParams] (val x: Self) extends AnyVal {
    @scala.inline
