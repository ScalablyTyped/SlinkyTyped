...
trait ReposGetReleaseByTagResponseAssetsItem extends js.Object {
  ...
  var uploader: ReposGetReleaseByTagResponseAssetsItemUploader = js.native
...
object ReposGetReleaseByTagResponseAssetsItem {
  ...
  @scala.inline
  implicit class ReposGetReleaseByTagResponseAssetsItemOps[Self <: ReposGetReleaseByTagResponseAssetsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposGetReleaseByTagResponseAssetsItemUploader): Self = {
        val ret = this.duplicate
