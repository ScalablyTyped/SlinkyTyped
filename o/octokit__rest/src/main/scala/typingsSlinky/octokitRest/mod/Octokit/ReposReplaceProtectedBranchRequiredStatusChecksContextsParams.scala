...
object ReposReplaceProtectedBranchRequiredStatusChecksContextsParams {
  ...
  @scala.inline
  implicit class ReposReplaceProtectedBranchRequiredStatusChecksContextsParamsOps[Self <: ReposReplaceProtectedBranchRequiredStatusChecksContextsParams] (val x: Self) extends AnyVal {
    @scala.inline
