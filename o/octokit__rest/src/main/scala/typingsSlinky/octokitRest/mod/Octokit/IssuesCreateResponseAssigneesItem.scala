...
@js.native
trait IssuesCreateResponseAssigneesItem extends js.Object {
...
object IssuesCreateResponseAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesCreateResponseAssigneesItem]
  }
  @scala.inline
  implicit class IssuesCreateResponseAssigneesItemOps[Self <: IssuesCreateResponseAssigneesItem] (val x: Self) extends AnyVal {
    @scala.inline
