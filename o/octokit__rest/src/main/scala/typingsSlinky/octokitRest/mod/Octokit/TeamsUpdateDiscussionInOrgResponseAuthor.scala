...
@js.native
trait TeamsUpdateDiscussionInOrgResponseAuthor extends js.Object {
...
object TeamsUpdateDiscussionInOrgResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionInOrgResponseAuthor]
  }
  @scala.inline
  implicit class TeamsUpdateDiscussionInOrgResponseAuthorOps[Self <: TeamsUpdateDiscussionInOrgResponseAuthor] (val x: Self) extends AnyVal {
    @scala.inline
