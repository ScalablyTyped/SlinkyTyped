...
object ReposRemoveProtectedBranchAppRestrictionsResponseItemPermissions {
  ...
  @scala.inline
  implicit class ReposRemoveProtectedBranchAppRestrictionsResponseItemPermissionsOps[Self <: ReposRemoveProtectedBranchAppRestrictionsResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
