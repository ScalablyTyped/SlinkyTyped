...
trait IssuesAddAssigneesResponseMilestone extends js.Object {
  ...
  var creator: IssuesAddAssigneesResponseMilestoneCreator = js.native
...
object IssuesAddAssigneesResponseMilestone {
  ...
  @scala.inline
  implicit class IssuesAddAssigneesResponseMilestoneOps[Self <: IssuesAddAssigneesResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesAddAssigneesResponseMilestoneCreator): Self = {
        val ret = this.duplicate
