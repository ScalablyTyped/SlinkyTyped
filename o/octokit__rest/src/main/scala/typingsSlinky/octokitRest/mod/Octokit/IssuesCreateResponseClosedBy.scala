...
@js.native
trait IssuesCreateResponseClosedBy extends js.Object {
...
object IssuesCreateResponseClosedBy {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesCreateResponseClosedBy]
  }
  @scala.inline
  implicit class IssuesCreateResponseClosedByOps[Self <: IssuesCreateResponseClosedBy] (val x: Self) extends AnyVal {
    @scala.inline
