...
trait ChecksCreateResponse extends js.Object {
  var app: ChecksCreateResponseApp = js.native
  var check_suite: ChecksCreateResponseCheckSuite = js.native
  var completed_at: Null | String = js.native
  var conclusion: Null | String = js.native
  ...
  var output: ChecksCreateResponseOutput = js.native
  var pull_requests: js.Array[ChecksCreateResponsePullRequestsItem] = js.native
...
object ChecksCreateResponse {
  ...
  @scala.inline
  implicit class ChecksCreateResponseOps[Self <: ChecksCreateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: ChecksCreateResponseApp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("app")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCheck_suite(value: ChecksCreateResponseCheckSuite): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOutput(value: ChecksCreateResponseOutput): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("output")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPull_requests(value: js.Array[ChecksCreateResponsePullRequestsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCompleted_atNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("completed_at")(null)
        ret
    }
    @scala.inline
