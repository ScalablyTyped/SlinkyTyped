...
object ReactionsListForTeamDiscussionCommentResponseItemUser {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentResponseItemUserOps[Self <: ReactionsListForTeamDiscussionCommentResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
