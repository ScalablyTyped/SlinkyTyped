...
trait TeamsListPendingInvitationsResponseItem extends js.Object {
  ...
  var inviter: TeamsListPendingInvitationsResponseItemInviter = js.native
...
object TeamsListPendingInvitationsResponseItem {
  ...
  @scala.inline
  implicit class TeamsListPendingInvitationsResponseItemOps[Self <: TeamsListPendingInvitationsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInviter(value: TeamsListPendingInvitationsResponseItemInviter): Self = {
        val ret = this.duplicate
