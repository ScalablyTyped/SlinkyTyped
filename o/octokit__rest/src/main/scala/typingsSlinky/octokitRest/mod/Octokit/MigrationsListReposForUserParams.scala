...
object MigrationsListReposForUserParams {
  @scala.inline
  def apply(migration_id: Double): MigrationsListReposForUserParams = {
  ...
  @scala.inline
  implicit class MigrationsListReposForUserParamsOps[Self <: MigrationsListReposForUserParams] (val x: Self) extends AnyVal {
    @scala.inline
