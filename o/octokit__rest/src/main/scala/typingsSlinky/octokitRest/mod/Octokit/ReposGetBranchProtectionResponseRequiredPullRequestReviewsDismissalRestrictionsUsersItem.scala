...
@js.native
trait ReposGetBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem extends js.Object {
...
object ReposGetBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem]
  }
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItemOps[Self <: ReposGetBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
