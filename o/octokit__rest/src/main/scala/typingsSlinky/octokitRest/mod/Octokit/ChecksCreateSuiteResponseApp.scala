...
@js.native
trait ChecksCreateSuiteResponseApp extends js.Object {
  ...
  var owner: ChecksCreateSuiteResponseAppOwner = js.native
  var permissions: ChecksCreateSuiteResponseAppPermissions = js.native
  var slug: String = js.native
  var updated_at: String = js.native
}

object ChecksCreateSuiteResponseApp {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ChecksCreateSuiteResponseApp]
  }
  @scala.inline
  implicit class ChecksCreateSuiteResponseAppOps[Self <: ChecksCreateSuiteResponseApp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksCreateSuiteResponseAppOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksCreateSuiteResponseAppPermissions): Self = {
        val ret = this.duplicate
