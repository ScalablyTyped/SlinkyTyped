...
trait ActivityListNotificationsForRepoResponseItemRepository extends js.Object {
  ...
  var owner: ActivityListNotificationsForRepoResponseItemRepositoryOwner = js.native
...
object ActivityListNotificationsForRepoResponseItemRepository {
  ...
  @scala.inline
  implicit class ActivityListNotificationsForRepoResponseItemRepositoryOps[Self <: ActivityListNotificationsForRepoResponseItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActivityListNotificationsForRepoResponseItemRepositoryOwner): Self = {
        val ret = this.duplicate
