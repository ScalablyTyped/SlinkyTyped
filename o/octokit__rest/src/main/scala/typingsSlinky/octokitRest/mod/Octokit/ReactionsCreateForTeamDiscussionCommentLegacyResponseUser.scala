...
object ReactionsCreateForTeamDiscussionCommentLegacyResponseUser {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionCommentLegacyResponseUserOps[Self <: ReactionsCreateForTeamDiscussionCommentLegacyResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
