...
@js.native
trait PullsListReviewRequestsResponseTeamsItem extends js.Object {
...
object PullsListReviewRequestsResponseTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[PullsListReviewRequestsResponseTeamsItem]
  }
  @scala.inline
  implicit class PullsListReviewRequestsResponseTeamsItemOps[Self <: PullsListReviewRequestsResponseTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
