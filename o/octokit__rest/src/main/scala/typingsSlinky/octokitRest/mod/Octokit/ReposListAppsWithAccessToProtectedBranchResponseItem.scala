...
trait ReposListAppsWithAccessToProtectedBranchResponseItem extends js.Object {
  ...
  var owner: ReposListAppsWithAccessToProtectedBranchResponseItemOwner = js.native
  var permissions: ReposListAppsWithAccessToProtectedBranchResponseItemPermissions = js.native
...
object ReposListAppsWithAccessToProtectedBranchResponseItem {
  ...
  @scala.inline
  implicit class ReposListAppsWithAccessToProtectedBranchResponseItemOps[Self <: ReposListAppsWithAccessToProtectedBranchResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposListAppsWithAccessToProtectedBranchResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposListAppsWithAccessToProtectedBranchResponseItemPermissions): Self = {
        val ret = this.duplicate
