...
@js.native
trait ReposAddProtectedBranchAppRestrictionsResponseItem extends js.Object {
  ...
  var owner: ReposAddProtectedBranchAppRestrictionsResponseItemOwner = js.native
  var permissions: ReposAddProtectedBranchAppRestrictionsResponseItemPermissions = js.native
  var slug: String = js.native
  var updated_at: String = js.native
}

object ReposAddProtectedBranchAppRestrictionsResponseItem {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchAppRestrictionsResponseItem]
  }
  @scala.inline
  implicit class ReposAddProtectedBranchAppRestrictionsResponseItemOps[Self <: ReposAddProtectedBranchAppRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposAddProtectedBranchAppRestrictionsResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposAddProtectedBranchAppRestrictionsResponseItemPermissions): Self = {
        val ret = this.duplicate
