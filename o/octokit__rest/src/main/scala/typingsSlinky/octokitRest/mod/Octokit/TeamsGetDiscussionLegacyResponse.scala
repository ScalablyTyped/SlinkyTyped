...
@js.native
trait TeamsGetDiscussionLegacyResponse extends js.Object {
  var author: TeamsGetDiscussionLegacyResponseAuthor = js.native
  ...
  var reactions: TeamsGetDiscussionLegacyResponseReactions = js.native
...
object TeamsGetDiscussionLegacyResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetDiscussionLegacyResponse]
  }
  @scala.inline
  implicit class TeamsGetDiscussionLegacyResponseOps[Self <: TeamsGetDiscussionLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsGetDiscussionLegacyResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsGetDiscussionLegacyResponseReactions): Self = {
        val ret = this.duplicate
