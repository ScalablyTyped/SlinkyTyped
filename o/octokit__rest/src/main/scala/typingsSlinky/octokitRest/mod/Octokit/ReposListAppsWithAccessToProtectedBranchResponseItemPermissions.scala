...
object ReposListAppsWithAccessToProtectedBranchResponseItemPermissions {
  ...
  @scala.inline
  implicit class ReposListAppsWithAccessToProtectedBranchResponseItemPermissionsOps[Self <: ReposListAppsWithAccessToProtectedBranchResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
