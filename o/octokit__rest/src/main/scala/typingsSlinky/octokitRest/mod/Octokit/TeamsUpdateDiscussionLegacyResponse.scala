...
@js.native
trait TeamsUpdateDiscussionLegacyResponse extends js.Object {
  var author: TeamsUpdateDiscussionLegacyResponseAuthor = js.native
  ...
  var reactions: TeamsUpdateDiscussionLegacyResponseReactions = js.native
...
object TeamsUpdateDiscussionLegacyResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionLegacyResponse]
  }
  @scala.inline
  implicit class TeamsUpdateDiscussionLegacyResponseOps[Self <: TeamsUpdateDiscussionLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsUpdateDiscussionLegacyResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsUpdateDiscussionLegacyResponseReactions): Self = {
        val ret = this.duplicate
