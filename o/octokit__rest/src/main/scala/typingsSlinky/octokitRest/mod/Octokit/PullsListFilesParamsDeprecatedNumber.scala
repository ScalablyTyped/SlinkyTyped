...
object PullsListFilesParamsDeprecatedNumber {
  @scala.inline
  def apply(number: Double, owner: String, repo: String): PullsListFilesParamsDeprecatedNumber = {
  ...
  @scala.inline
  implicit class PullsListFilesParamsDeprecatedNumberOps[Self <: PullsListFilesParamsDeprecatedNumber] (val x: Self) extends AnyVal {
    @scala.inline
