...
trait TeamsListReposResponseItem extends js.Object {
  ...
  var license: TeamsListReposResponseItemLicense = js.native
  ...
  var owner: TeamsListReposResponseItemOwner = js.native
  var permissions: TeamsListReposResponseItemPermissions = js.native
...
object TeamsListReposResponseItem {
  ...
  @scala.inline
  implicit class TeamsListReposResponseItemOps[Self <: TeamsListReposResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: TeamsListReposResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: TeamsListReposResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: TeamsListReposResponseItemPermissions): Self = {
        val ret = this.duplicate
