...
trait ChecksListForSuiteResponseCheckRunsItemApp extends js.Object {
  ...
  var owner: ChecksListForSuiteResponseCheckRunsItemAppOwner = js.native
  var permissions: ChecksListForSuiteResponseCheckRunsItemAppPermissions = js.native
...
object ChecksListForSuiteResponseCheckRunsItemApp {
  ...
  @scala.inline
  implicit class ChecksListForSuiteResponseCheckRunsItemAppOps[Self <: ChecksListForSuiteResponseCheckRunsItemApp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksListForSuiteResponseCheckRunsItemAppOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksListForSuiteResponseCheckRunsItemAppPermissions): Self = {
        val ret = this.duplicate
