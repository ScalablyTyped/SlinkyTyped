...
trait PullsCreateReviewRequestResponseBaseRepo extends js.Object {
  ...
  var owner: PullsCreateReviewRequestResponseBaseRepoOwner = js.native
  var permissions: PullsCreateReviewRequestResponseBaseRepoPermissions = js.native
...
object PullsCreateReviewRequestResponseBaseRepo {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseBaseRepoOps[Self <: PullsCreateReviewRequestResponseBaseRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsCreateReviewRequestResponseBaseRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsCreateReviewRequestResponseBaseRepoPermissions): Self = {
        val ret = this.duplicate
