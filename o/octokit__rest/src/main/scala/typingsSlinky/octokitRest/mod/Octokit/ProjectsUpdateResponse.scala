...
trait ProjectsUpdateResponse extends js.Object {
  ...
  var creator: ProjectsUpdateResponseCreator = js.native
...
object ProjectsUpdateResponse {
  ...
  @scala.inline
  implicit class ProjectsUpdateResponseOps[Self <: ProjectsUpdateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsUpdateResponseCreator): Self = {
        val ret = this.duplicate
