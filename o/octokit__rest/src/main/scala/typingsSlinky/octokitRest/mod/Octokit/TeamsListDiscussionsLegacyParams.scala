...
object TeamsListDiscussionsLegacyParams {
  @scala.inline
  def apply(team_id: Double): TeamsListDiscussionsLegacyParams = {
    val __obj = js.Dynamic.literal(team_id = team_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TeamsListDiscussionsLegacyParams]
  }
  @scala.inline
  implicit class TeamsListDiscussionsLegacyParamsOps[Self <: TeamsListDiscussionsLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
