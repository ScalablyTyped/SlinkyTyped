...
trait PullsGetResponseBase extends js.Object {
  ...
  var repo: PullsGetResponseBaseRepo = js.native
  var sha: String = js.native
  var user: PullsGetResponseBaseUser = js.native
}
...
object PullsGetResponseBase {
  ...
  @scala.inline
  implicit class PullsGetResponseBaseOps[Self <: PullsGetResponseBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsGetResponseBaseRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsGetResponseBaseUser): Self = {
        val ret = this.duplicate
