...
trait MigrationsListForAuthenticatedUserResponseItem extends js.Object {
  ...
  var owner: MigrationsListForAuthenticatedUserResponseItemOwner = js.native
  var repositories: js.Array[MigrationsListForAuthenticatedUserResponseItemRepositoriesItem] = js.native
...
object MigrationsListForAuthenticatedUserResponseItem {
  ...
  @scala.inline
  implicit class MigrationsListForAuthenticatedUserResponseItemOps[Self <: MigrationsListForAuthenticatedUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsListForAuthenticatedUserResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRepositories(value: js.Array[MigrationsListForAuthenticatedUserResponseItemRepositoriesItem]): Self = {
        val ret = this.duplicate
