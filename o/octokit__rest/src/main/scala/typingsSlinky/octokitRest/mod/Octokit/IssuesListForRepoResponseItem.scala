...
trait IssuesListForRepoResponseItem extends js.Object {
  ...
  var assignee: IssuesListForRepoResponseItemAssignee = js.native
  var assignees: js.Array[IssuesListForRepoResponseItemAssigneesItem] = js.native
  ...
  var labels: js.Array[IssuesListForRepoResponseItemLabelsItem] = js.native
  var labels_url: String = js.native
  var locked: Boolean = js.native
  var milestone: IssuesListForRepoResponseItemMilestone = js.native
  var node_id: String = js.native
  var number: Double = js.native
  var pull_request: IssuesListForRepoResponseItemPullRequest = js.native
  var repository_url: String = js.native
  var state: String = js.native
  var title: String = js.native
  var updated_at: String = js.native
  var url: String = js.native
  var user: IssuesListForRepoResponseItemUser = js.native
}
...
object IssuesListForRepoResponseItem {
  ...
  @scala.inline
  implicit class IssuesListForRepoResponseItemOps[Self <: IssuesListForRepoResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAssignee(value: IssuesListForRepoResponseItemAssignee): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("assignee")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAssignees(value: js.Array[IssuesListForRepoResponseItemAssigneesItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabels(value: js.Array[IssuesListForRepoResponseItemLabelsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMilestone(value: IssuesListForRepoResponseItemMilestone): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPull_request(value: IssuesListForRepoResponseItemPullRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: IssuesListForRepoResponseItemUser): Self = {
        val ret = this.duplicate
