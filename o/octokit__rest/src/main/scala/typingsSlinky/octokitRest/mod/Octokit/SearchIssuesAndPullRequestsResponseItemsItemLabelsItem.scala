...
object SearchIssuesAndPullRequestsResponseItemsItemLabelsItem {
  ...
  @scala.inline
  implicit class SearchIssuesAndPullRequestsResponseItemsItemLabelsItemOps[Self <: SearchIssuesAndPullRequestsResponseItemsItemLabelsItem] (val x: Self) extends AnyVal {
    @scala.inline
