...
trait GistsUpdateCommentResponse extends js.Object {
  ...
  var user: GistsUpdateCommentResponseUser = js.native
}
...
object GistsUpdateCommentResponse {
  ...
  @scala.inline
  implicit class GistsUpdateCommentResponseOps[Self <: GistsUpdateCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: GistsUpdateCommentResponseUser): Self = {
        val ret = this.duplicate
