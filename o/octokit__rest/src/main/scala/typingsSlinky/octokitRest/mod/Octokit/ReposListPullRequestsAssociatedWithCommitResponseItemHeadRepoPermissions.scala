...
object ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoPermissions {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoPermissionsOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoPermissions] (val x: Self) extends AnyVal {
    @scala.inline
