...
object MigrationsStartForAuthenticatedUserResponseRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class MigrationsStartForAuthenticatedUserResponseRepositoriesItemPermissionsOps[Self <: MigrationsStartForAuthenticatedUserResponseRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
