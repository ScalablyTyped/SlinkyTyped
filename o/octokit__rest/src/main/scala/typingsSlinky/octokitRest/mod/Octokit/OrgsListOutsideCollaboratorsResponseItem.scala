...
@js.native
trait OrgsListOutsideCollaboratorsResponseItem extends js.Object {
...
object OrgsListOutsideCollaboratorsResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsListOutsideCollaboratorsResponseItem]
  }
  @scala.inline
  implicit class OrgsListOutsideCollaboratorsResponseItemOps[Self <: OrgsListOutsideCollaboratorsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
