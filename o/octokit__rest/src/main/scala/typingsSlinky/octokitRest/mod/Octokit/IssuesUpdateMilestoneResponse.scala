...
@js.native
trait IssuesUpdateMilestoneResponse extends js.Object {
  var closed_at: String = js.native
  var closed_issues: Double = js.native
  var created_at: String = js.native
  var creator: IssuesUpdateMilestoneResponseCreator = js.native
...
object IssuesUpdateMilestoneResponse {
  @scala.inline
  def apply(
    closed_at: String,
    ...
    __obj.asInstanceOf[IssuesUpdateMilestoneResponse]
  }
  @scala.inline
  implicit class IssuesUpdateMilestoneResponseOps[Self <: IssuesUpdateMilestoneResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesUpdateMilestoneResponseCreator): Self = {
        val ret = this.duplicate
