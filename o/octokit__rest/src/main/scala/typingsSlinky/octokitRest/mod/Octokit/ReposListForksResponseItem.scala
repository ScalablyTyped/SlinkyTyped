...
trait ReposListForksResponseItem extends js.Object {
  ...
  var license: ReposListForksResponseItemLicense = js.native
  ...
  var owner: ReposListForksResponseItemOwner = js.native
  var permissions: ReposListForksResponseItemPermissions = js.native
...
object ReposListForksResponseItem {
  ...
  @scala.inline
  implicit class ReposListForksResponseItemOps[Self <: ReposListForksResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: ReposListForksResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: ReposListForksResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposListForksResponseItemPermissions): Self = {
        val ret = this.duplicate
