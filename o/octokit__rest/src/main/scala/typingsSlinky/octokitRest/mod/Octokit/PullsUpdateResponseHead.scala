...
trait PullsUpdateResponseHead extends js.Object {
  ...
  var repo: PullsUpdateResponseHeadRepo = js.native
  var sha: String = js.native
  var user: PullsUpdateResponseHeadUser = js.native
}
...
object PullsUpdateResponseHead {
  ...
  @scala.inline
  implicit class PullsUpdateResponseHeadOps[Self <: PullsUpdateResponseHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsUpdateResponseHeadRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsUpdateResponseHeadUser): Self = {
        val ret = this.duplicate
