...
object IssuesListForAuthenticatedUserResponseItemRepositoryPermissions {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemRepositoryPermissionsOps[Self <: IssuesListForAuthenticatedUserResponseItemRepositoryPermissions] (val x: Self) extends AnyVal {
    @scala.inline
