...
@js.native
trait PullsUpdateResponseHeadRepo extends js.Object {
  ...
  var owner: PullsUpdateResponseHeadRepoOwner = js.native
  var permissions: PullsUpdateResponseHeadRepoPermissions = js.native
...
object PullsUpdateResponseHeadRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsUpdateResponseHeadRepo]
  }
  @scala.inline
  implicit class PullsUpdateResponseHeadRepoOps[Self <: PullsUpdateResponseHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsUpdateResponseHeadRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsUpdateResponseHeadRepoPermissions): Self = {
        val ret = this.duplicate
