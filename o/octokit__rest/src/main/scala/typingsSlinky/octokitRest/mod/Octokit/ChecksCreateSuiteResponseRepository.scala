...
trait ChecksCreateSuiteResponseRepository extends js.Object {
  ...
  var owner: ChecksCreateSuiteResponseRepositoryOwner = js.native
  var permissions: ChecksCreateSuiteResponseRepositoryPermissions = js.native
...
object ChecksCreateSuiteResponseRepository {
  ...
  @scala.inline
  implicit class ChecksCreateSuiteResponseRepositoryOps[Self <: ChecksCreateSuiteResponseRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksCreateSuiteResponseRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksCreateSuiteResponseRepositoryPermissions): Self = {
        val ret = this.duplicate
