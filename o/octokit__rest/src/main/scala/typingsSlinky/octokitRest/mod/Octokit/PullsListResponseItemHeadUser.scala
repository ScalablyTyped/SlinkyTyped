...
@js.native
trait PullsListResponseItemHeadUser extends js.Object {
...
object PullsListResponseItemHeadUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsListResponseItemHeadUser]
  }
  @scala.inline
  implicit class PullsListResponseItemHeadUserOps[Self <: PullsListResponseItemHeadUser] (val x: Self) extends AnyVal {
    @scala.inline
