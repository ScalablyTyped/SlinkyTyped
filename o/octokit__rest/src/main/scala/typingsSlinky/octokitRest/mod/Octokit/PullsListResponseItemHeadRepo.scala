...
trait PullsListResponseItemHeadRepo extends js.Object {
  ...
  var owner: PullsListResponseItemHeadRepoOwner = js.native
  var permissions: PullsListResponseItemHeadRepoPermissions = js.native
...
object PullsListResponseItemHeadRepo {
  ...
  @scala.inline
  implicit class PullsListResponseItemHeadRepoOps[Self <: PullsListResponseItemHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsListResponseItemHeadRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsListResponseItemHeadRepoPermissions): Self = {
        val ret = this.duplicate
