...
@js.native
trait ReposGetCommitResponseAuthor extends js.Object {
...
object ReposGetCommitResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetCommitResponseAuthor]
  }
  @scala.inline
  implicit class ReposGetCommitResponseAuthorOps[Self <: ReposGetCommitResponseAuthor] (val x: Self) extends AnyVal {
    @scala.inline
