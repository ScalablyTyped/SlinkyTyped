...
object IssuesListLabelsForRepoParams {
  @scala.inline
  def apply(owner: String, repo: String): IssuesListLabelsForRepoParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[IssuesListLabelsForRepoParams]
  }
  @scala.inline
  implicit class IssuesListLabelsForRepoParamsOps[Self <: IssuesListLabelsForRepoParams] (val x: Self) extends AnyVal {
    @scala.inline
