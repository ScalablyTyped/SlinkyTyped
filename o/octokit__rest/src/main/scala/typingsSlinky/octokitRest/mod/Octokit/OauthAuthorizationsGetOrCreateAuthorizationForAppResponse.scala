...
trait OauthAuthorizationsGetOrCreateAuthorizationForAppResponse extends js.Object {
  var app: OauthAuthorizationsGetOrCreateAuthorizationForAppResponseApp = js.native
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppResponse {
  ...
  @scala.inline
  implicit class OauthAuthorizationsGetOrCreateAuthorizationForAppResponseOps[Self <: OauthAuthorizationsGetOrCreateAuthorizationForAppResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: OauthAuthorizationsGetOrCreateAuthorizationForAppResponseApp): Self = {
