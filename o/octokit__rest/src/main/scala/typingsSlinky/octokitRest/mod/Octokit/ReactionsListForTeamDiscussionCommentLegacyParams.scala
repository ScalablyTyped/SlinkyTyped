...
object ReactionsListForTeamDiscussionCommentLegacyParams {
  @scala.inline
  def apply(comment_number: Double, discussion_number: Double, team_id: Double): ReactionsListForTeamDiscussionCommentLegacyParams = {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentLegacyParamsOps[Self <: ReactionsListForTeamDiscussionCommentLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
