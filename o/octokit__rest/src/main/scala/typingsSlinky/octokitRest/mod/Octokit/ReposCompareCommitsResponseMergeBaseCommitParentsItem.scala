...
object ReposCompareCommitsResponseMergeBaseCommitParentsItem {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseMergeBaseCommitParentsItemOps[Self <: ReposCompareCommitsResponseMergeBaseCommitParentsItem] (val x: Self) extends AnyVal {
    @scala.inline
