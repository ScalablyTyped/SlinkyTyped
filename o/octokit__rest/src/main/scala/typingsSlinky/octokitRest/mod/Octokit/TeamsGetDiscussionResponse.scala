...
trait TeamsGetDiscussionResponse extends js.Object {
  var author: TeamsGetDiscussionResponseAuthor = js.native
  ...
  var reactions: TeamsGetDiscussionResponseReactions = js.native
...
object TeamsGetDiscussionResponse {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionResponseOps[Self <: TeamsGetDiscussionResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsGetDiscussionResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsGetDiscussionResponseReactions): Self = {
        val ret = this.duplicate
