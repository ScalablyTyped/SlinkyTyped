...
@js.native
trait PullsGetResponseMilestone extends js.Object {
  var closed_at: String = js.native
  var closed_issues: Double = js.native
  var created_at: String = js.native
  var creator: PullsGetResponseMilestoneCreator = js.native
...
object PullsGetResponseMilestone {
  @scala.inline
  def apply(
    closed_at: String,
    ...
    __obj.asInstanceOf[PullsGetResponseMilestone]
  }
  @scala.inline
  implicit class PullsGetResponseMilestoneOps[Self <: PullsGetResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: PullsGetResponseMilestoneCreator): Self = {
        val ret = this.duplicate
