...
trait MigrationsGetStatusForOrgResponseRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsGetStatusForOrgResponseRepositoriesItemOwner = js.native
  var permissions: MigrationsGetStatusForOrgResponseRepositoriesItemPermissions = js.native
...
object MigrationsGetStatusForOrgResponseRepositoriesItem {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForOrgResponseRepositoriesItemOps[Self <: MigrationsGetStatusForOrgResponseRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsGetStatusForOrgResponseRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsGetStatusForOrgResponseRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
