...
trait TeamsGetDiscussionCommentLegacyResponse extends js.Object {
  var author: TeamsGetDiscussionCommentLegacyResponseAuthor = js.native
  ...
  var reactions: TeamsGetDiscussionCommentLegacyResponseReactions = js.native
...
object TeamsGetDiscussionCommentLegacyResponse {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionCommentLegacyResponseOps[Self <: TeamsGetDiscussionCommentLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsGetDiscussionCommentLegacyResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsGetDiscussionCommentLegacyResponseReactions): Self = {
        val ret = this.duplicate
