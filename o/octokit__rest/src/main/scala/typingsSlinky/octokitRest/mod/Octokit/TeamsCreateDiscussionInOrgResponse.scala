...
trait TeamsCreateDiscussionInOrgResponse extends js.Object {
  var author: TeamsCreateDiscussionInOrgResponseAuthor = js.native
  ...
  var reactions: TeamsCreateDiscussionInOrgResponseReactions = js.native
...
object TeamsCreateDiscussionInOrgResponse {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionInOrgResponseOps[Self <: TeamsCreateDiscussionInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsCreateDiscussionInOrgResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsCreateDiscussionInOrgResponseReactions): Self = {
        val ret = this.duplicate
