...
object ChecksSetSuitesPreferencesResponseRepositoryPermissions {
  ...
  @scala.inline
  implicit class ChecksSetSuitesPreferencesResponseRepositoryPermissionsOps[Self <: ChecksSetSuitesPreferencesResponseRepositoryPermissions] (val x: Self) extends AnyVal {
    @scala.inline
