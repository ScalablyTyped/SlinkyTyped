...
object ReposReplaceProtectedBranchAppRestrictionsResponseItemPermissions {
  ...
  @scala.inline
  implicit class ReposReplaceProtectedBranchAppRestrictionsResponseItemPermissionsOps[Self <: ReposReplaceProtectedBranchAppRestrictionsResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
