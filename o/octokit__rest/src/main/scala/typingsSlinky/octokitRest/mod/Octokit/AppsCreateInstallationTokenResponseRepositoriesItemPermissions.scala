...
object AppsCreateInstallationTokenResponseRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class AppsCreateInstallationTokenResponseRepositoriesItemPermissionsOps[Self <: AppsCreateInstallationTokenResponseRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
