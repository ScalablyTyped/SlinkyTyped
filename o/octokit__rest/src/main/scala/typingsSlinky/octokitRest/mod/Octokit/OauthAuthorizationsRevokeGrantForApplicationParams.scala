...
object OauthAuthorizationsRevokeGrantForApplicationParams {
  ...
  @scala.inline
  implicit class OauthAuthorizationsRevokeGrantForApplicationParamsOps[Self <: OauthAuthorizationsRevokeGrantForApplicationParams] (val x: Self) extends AnyVal {
    @scala.inline
