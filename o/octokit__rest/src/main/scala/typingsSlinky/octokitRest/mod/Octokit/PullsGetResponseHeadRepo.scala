...
trait PullsGetResponseHeadRepo extends js.Object {
  ...
  var owner: PullsGetResponseHeadRepoOwner = js.native
  var permissions: PullsGetResponseHeadRepoPermissions = js.native
...
object PullsGetResponseHeadRepo {
  ...
  @scala.inline
  implicit class PullsGetResponseHeadRepoOps[Self <: PullsGetResponseHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsGetResponseHeadRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsGetResponseHeadRepoPermissions): Self = {
        val ret = this.duplicate
