...
@js.native
trait ReactionsCreateForTeamDiscussionLegacyResponseUser extends js.Object {
...
object ReactionsCreateForTeamDiscussionLegacyResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionLegacyResponseUser]
  }
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionLegacyResponseUserOps[Self <: ReactionsCreateForTeamDiscussionLegacyResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
