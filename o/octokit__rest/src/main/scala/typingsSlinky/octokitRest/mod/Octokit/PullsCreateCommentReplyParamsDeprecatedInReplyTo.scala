...
import typingsSlinky.octokitRest.octokitRestStrings.LEFT
import typingsSlinky.octokitRest.octokitRestStrings.RIGHT
import typingsSlinky.octokitRest.octokitRestStrings.side
...
trait PullsCreateCommentReplyParamsDeprecatedInReplyTo extends js.Object {
  ...
  /**
    ...
    */
  var in_reply_to: js.UndefOr[Double] = js.native
  /**
...
object PullsCreateCommentReplyParamsDeprecatedInReplyTo {
  @scala.inline
  def apply(body: String, commit_id: String, owner: String, path: String, pull_number: Double, repo: String): PullsCreateCommentReplyParamsDeprecatedInReplyTo = {
  ...
  @scala.inline
  implicit class PullsCreateCommentReplyParamsDeprecatedInReplyToOps[Self <: PullsCreateCommentReplyParamsDeprecatedInReplyTo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withIn_reply_to(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("in_reply_to")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIn_reply_to: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("in_reply_to")(js.undefined)
        ret
    }
    @scala.inline
