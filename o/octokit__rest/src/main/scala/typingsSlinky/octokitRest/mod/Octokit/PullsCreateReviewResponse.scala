...
trait PullsCreateReviewResponse extends js.Object {
  var _links: PullsCreateReviewResponseLinks = js.native
  ...
  var user: PullsCreateReviewResponseUser = js.native
}
...
object PullsCreateReviewResponse {
  ...
  @scala.inline
  implicit class PullsCreateReviewResponseOps[Self <: PullsCreateReviewResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsCreateReviewResponseLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsCreateReviewResponseUser): Self = {
        val ret = this.duplicate
