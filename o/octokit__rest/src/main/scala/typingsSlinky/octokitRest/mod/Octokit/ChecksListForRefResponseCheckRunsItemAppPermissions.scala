...
object ChecksListForRefResponseCheckRunsItemAppPermissions {
  ...
  @scala.inline
  implicit class ChecksListForRefResponseCheckRunsItemAppPermissionsOps[Self <: ChecksListForRefResponseCheckRunsItemAppPermissions] (val x: Self) extends AnyVal {
    @scala.inline
