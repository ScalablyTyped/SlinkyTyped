...
@js.native
trait TeamsListProjectsResponseItemCreator extends js.Object {
...
object TeamsListProjectsResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListProjectsResponseItemCreator]
  }
  @scala.inline
  implicit class TeamsListProjectsResponseItemCreatorOps[Self <: TeamsListProjectsResponseItemCreator] (val x: Self) extends AnyVal {
    @scala.inline
