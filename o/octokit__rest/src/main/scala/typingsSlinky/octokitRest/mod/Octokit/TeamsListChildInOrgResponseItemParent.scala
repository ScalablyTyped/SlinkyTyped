...
@js.native
trait TeamsListChildInOrgResponseItemParent extends js.Object {
...
object TeamsListChildInOrgResponseItemParent {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[TeamsListChildInOrgResponseItemParent]
  }
  @scala.inline
  implicit class TeamsListChildInOrgResponseItemParentOps[Self <: TeamsListChildInOrgResponseItemParent] (val x: Self) extends AnyVal {
    @scala.inline
