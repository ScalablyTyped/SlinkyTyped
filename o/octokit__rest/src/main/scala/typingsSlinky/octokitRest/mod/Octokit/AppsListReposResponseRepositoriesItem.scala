...
@js.native
trait AppsListReposResponseRepositoriesItem extends js.Object {
  ...
  var owner: AppsListReposResponseRepositoriesItemOwner = js.native
...
object AppsListReposResponseRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListReposResponseRepositoriesItem]
  }
  @scala.inline
  implicit class AppsListReposResponseRepositoriesItemOps[Self <: AppsListReposResponseRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: AppsListReposResponseRepositoriesItemOwner): Self = {
        val ret = this.duplicate
