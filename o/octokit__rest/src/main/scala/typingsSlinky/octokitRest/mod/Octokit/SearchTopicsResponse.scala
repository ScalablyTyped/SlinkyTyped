...
trait SearchTopicsResponse extends js.Object {
  ...
  var items: js.Array[SearchTopicsResponseItemsItem] = js.native
...
object SearchTopicsResponse {
  ...
  @scala.inline
  implicit class SearchTopicsResponseOps[Self <: SearchTopicsResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[SearchTopicsResponseItemsItem]): Self = {
        val ret = this.duplicate
