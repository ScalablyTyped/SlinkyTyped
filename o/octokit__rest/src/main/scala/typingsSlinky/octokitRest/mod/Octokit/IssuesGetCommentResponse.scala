...
trait IssuesGetCommentResponse extends js.Object {
  ...
  var user: IssuesGetCommentResponseUser = js.native
}
...
object IssuesGetCommentResponse {
  ...
  @scala.inline
  implicit class IssuesGetCommentResponseOps[Self <: IssuesGetCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: IssuesGetCommentResponseUser): Self = {
        val ret = this.duplicate
