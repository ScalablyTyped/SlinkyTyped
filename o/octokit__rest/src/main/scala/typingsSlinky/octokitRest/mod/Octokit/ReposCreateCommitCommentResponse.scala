...
trait ReposCreateCommitCommentResponse extends js.Object {
  ...
  var user: ReposCreateCommitCommentResponseUser = js.native
}
...
object ReposCreateCommitCommentResponse {
  ...
  @scala.inline
  implicit class ReposCreateCommitCommentResponseOps[Self <: ReposCreateCommitCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReposCreateCommitCommentResponseUser): Self = {
        val ret = this.duplicate
