...
object PullsCreateCommentParamsDeprecatedNumber {
  @scala.inline
  def apply(body: String, commit_id: String, number: Double, owner: String, path: String, repo: String): PullsCreateCommentParamsDeprecatedNumber = {
  ...
  @scala.inline
  implicit class PullsCreateCommentParamsDeprecatedNumberOps[Self <: PullsCreateCommentParamsDeprecatedNumber] (val x: Self) extends AnyVal {
    @scala.inline
