...
@js.native
trait ReposGetContributorsStatsResponseItemAuthor extends js.Object {
...
object ReposGetContributorsStatsResponseItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetContributorsStatsResponseItemAuthor]
  }
  @scala.inline
  implicit class ReposGetContributorsStatsResponseItemAuthorOps[Self <: ReposGetContributorsStatsResponseItemAuthor] (val x: Self) extends AnyVal {
    @scala.inline
