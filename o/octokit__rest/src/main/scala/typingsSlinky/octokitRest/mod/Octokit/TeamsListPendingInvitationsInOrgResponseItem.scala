...
trait TeamsListPendingInvitationsInOrgResponseItem extends js.Object {
  ...
  var inviter: TeamsListPendingInvitationsInOrgResponseItemInviter = js.native
...
object TeamsListPendingInvitationsInOrgResponseItem {
  ...
  @scala.inline
  implicit class TeamsListPendingInvitationsInOrgResponseItemOps[Self <: TeamsListPendingInvitationsInOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInviter(value: TeamsListPendingInvitationsInOrgResponseItemInviter): Self = {
        val ret = this.duplicate
