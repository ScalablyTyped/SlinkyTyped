...
@js.native
trait PullsCreateFromIssueResponseHeadRepo extends js.Object {
  ...
  var owner: PullsCreateFromIssueResponseHeadRepoOwner = js.native
  var permissions: PullsCreateFromIssueResponseHeadRepoPermissions = js.native
...
object PullsCreateFromIssueResponseHeadRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseHeadRepo]
  }
  @scala.inline
  implicit class PullsCreateFromIssueResponseHeadRepoOps[Self <: PullsCreateFromIssueResponseHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsCreateFromIssueResponseHeadRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsCreateFromIssueResponseHeadRepoPermissions): Self = {
        val ret = this.duplicate
