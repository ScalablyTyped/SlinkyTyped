...
trait ActionsGetWorkflowRunResponse extends js.Object {
  ...
  var head_commit: ActionsGetWorkflowRunResponseHeadCommit = js.native
  var head_repository: ActionsGetWorkflowRunResponseHeadRepository = js.native
  ...
  var repository: ActionsGetWorkflowRunResponseRepository = js.native
...
object ActionsGetWorkflowRunResponse {
  ...
  @scala.inline
  implicit class ActionsGetWorkflowRunResponseOps[Self <: ActionsGetWorkflowRunResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withHead_commit(value: ActionsGetWorkflowRunResponseHeadCommit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("head_commit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHead_repository(value: ActionsGetWorkflowRunResponseHeadRepository): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRepository(value: ActionsGetWorkflowRunResponseRepository): Self = {
        val ret = this.duplicate
