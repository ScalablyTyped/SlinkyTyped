...
trait PullsCreateReviewRequestResponseBase extends js.Object {
  ...
  var repo: PullsCreateReviewRequestResponseBaseRepo = js.native
  var sha: String = js.native
  var user: PullsCreateReviewRequestResponseBaseUser = js.native
}
...
object PullsCreateReviewRequestResponseBase {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseBaseOps[Self <: PullsCreateReviewRequestResponseBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsCreateReviewRequestResponseBaseRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsCreateReviewRequestResponseBaseUser): Self = {
        val ret = this.duplicate
