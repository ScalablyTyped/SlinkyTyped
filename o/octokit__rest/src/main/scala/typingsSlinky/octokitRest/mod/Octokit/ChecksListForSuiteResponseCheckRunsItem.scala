...
trait ChecksListForSuiteResponseCheckRunsItem extends js.Object {
  var app: ChecksListForSuiteResponseCheckRunsItemApp = js.native
  var check_suite: ChecksListForSuiteResponseCheckRunsItemCheckSuite = js.native
  ...
  var output: ChecksListForSuiteResponseCheckRunsItemOutput = js.native
  var pull_requests: js.Array[ChecksListForSuiteResponseCheckRunsItemPullRequestsItem] = js.native
...
object ChecksListForSuiteResponseCheckRunsItem {
  ...
  @scala.inline
  implicit class ChecksListForSuiteResponseCheckRunsItemOps[Self <: ChecksListForSuiteResponseCheckRunsItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: ChecksListForSuiteResponseCheckRunsItemApp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("app")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCheck_suite(value: ChecksListForSuiteResponseCheckRunsItemCheckSuite): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOutput(value: ChecksListForSuiteResponseCheckRunsItemOutput): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("output")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPull_requests(value: js.Array[ChecksListForSuiteResponseCheckRunsItemPullRequestsItem]): Self = {
        val ret = this.duplicate
