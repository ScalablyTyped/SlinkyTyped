...
object OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprintResponseApp {
  ...
  @scala.inline
  implicit class OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprintResponseAppOps[Self <: OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprintResponseApp] (val x: Self) extends AnyVal {
    @scala.inline
