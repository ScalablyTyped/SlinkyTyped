...
object AppsListInstallationReposForAuthenticatedUserParams {
  @scala.inline
  def apply(installation_id: Double): AppsListInstallationReposForAuthenticatedUserParams = {
  ...
  @scala.inline
  implicit class AppsListInstallationReposForAuthenticatedUserParamsOps[Self <: AppsListInstallationReposForAuthenticatedUserParams] (val x: Self) extends AnyVal {
    @scala.inline
