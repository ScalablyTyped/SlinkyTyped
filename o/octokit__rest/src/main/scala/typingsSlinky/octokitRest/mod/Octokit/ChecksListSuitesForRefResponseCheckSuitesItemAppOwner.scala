...
object ChecksListSuitesForRefResponseCheckSuitesItemAppOwner {
  ...
  @scala.inline
  implicit class ChecksListSuitesForRefResponseCheckSuitesItemAppOwnerOps[Self <: ChecksListSuitesForRefResponseCheckSuitesItemAppOwner] (val x: Self) extends AnyVal {
    @scala.inline
