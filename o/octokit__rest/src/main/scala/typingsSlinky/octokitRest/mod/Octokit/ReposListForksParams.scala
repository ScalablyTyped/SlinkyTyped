...
import typingsSlinky.octokitRest.octokitRestStrings.newest
import typingsSlinky.octokitRest.octokitRestStrings.oldest
import typingsSlinky.octokitRest.octokitRestStrings.stargazers
