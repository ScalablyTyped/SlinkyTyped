...
object TeamsAddOrUpdateMembershipLegacyParams {
  @scala.inline
  def apply(team_id: Double, username: String): TeamsAddOrUpdateMembershipLegacyParams = {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateMembershipLegacyParamsOps[Self <: TeamsAddOrUpdateMembershipLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
