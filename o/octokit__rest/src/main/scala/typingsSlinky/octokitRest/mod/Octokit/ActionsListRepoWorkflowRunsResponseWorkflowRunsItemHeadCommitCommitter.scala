...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadCommitCommitter {
  ...
  @scala.inline
  implicit class ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadCommitCommitterOps[Self <: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadCommitCommitter] (val x: Self) extends AnyVal {
    @scala.inline
