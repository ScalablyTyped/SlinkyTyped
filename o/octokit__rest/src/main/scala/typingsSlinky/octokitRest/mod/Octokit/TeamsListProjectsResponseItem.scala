...
trait TeamsListProjectsResponseItem extends js.Object {
  ...
  var creator: TeamsListProjectsResponseItemCreator = js.native
  ...
  var permissions: TeamsListProjectsResponseItemPermissions = js.native
...
object TeamsListProjectsResponseItem {
  ...
  @scala.inline
  implicit class TeamsListProjectsResponseItemOps[Self <: TeamsListProjectsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: TeamsListProjectsResponseItemCreator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: TeamsListProjectsResponseItemPermissions): Self = {
        val ret = this.duplicate
