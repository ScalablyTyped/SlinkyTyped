...
trait AppsCheckAuthorizationResponse extends js.Object {
  var app: AppsCheckAuthorizationResponseApp = js.native
  ...
  var user: AppsCheckAuthorizationResponseUser = js.native
}
...
object AppsCheckAuthorizationResponse {
  ...
  @scala.inline
  implicit class AppsCheckAuthorizationResponseOps[Self <: AppsCheckAuthorizationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: AppsCheckAuthorizationResponseApp): Self = {
    ...
    @scala.inline
    def withUser(value: AppsCheckAuthorizationResponseUser): Self = {
        val ret = this.duplicate
