...
object ReposGetProtectedBranchRequiredStatusChecksResponse {
  ...
  @scala.inline
  implicit class ReposGetProtectedBranchRequiredStatusChecksResponseOps[Self <: ReposGetProtectedBranchRequiredStatusChecksResponse] (val x: Self) extends AnyVal {
    @scala.inline
