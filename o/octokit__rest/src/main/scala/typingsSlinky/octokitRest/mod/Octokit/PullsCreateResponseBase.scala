...
trait PullsCreateResponseBase extends js.Object {
  ...
  var repo: PullsCreateResponseBaseRepo = js.native
  var sha: String = js.native
  var user: PullsCreateResponseBaseUser = js.native
}
...
object PullsCreateResponseBase {
  ...
  @scala.inline
  implicit class PullsCreateResponseBaseOps[Self <: PullsCreateResponseBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsCreateResponseBaseRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsCreateResponseBaseUser): Self = {
        val ret = this.duplicate
