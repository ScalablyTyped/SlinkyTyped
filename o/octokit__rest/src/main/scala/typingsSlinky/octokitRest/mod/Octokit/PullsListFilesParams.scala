...
object PullsListFilesParams {
  @scala.inline
  def apply(owner: String, pull_number: Double, repo: String): PullsListFilesParams = {
  ...
  @scala.inline
  implicit class PullsListFilesParamsOps[Self <: PullsListFilesParams] (val x: Self) extends AnyVal {
    @scala.inline
