...
object AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner {
  ...
  @scala.inline
  implicit class AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwnerOps[Self <: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
