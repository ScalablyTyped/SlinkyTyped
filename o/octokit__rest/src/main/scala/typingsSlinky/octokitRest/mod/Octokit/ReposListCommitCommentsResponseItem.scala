...
trait ReposListCommitCommentsResponseItem extends js.Object {
  ...
  var user: ReposListCommitCommentsResponseItemUser = js.native
}
...
object ReposListCommitCommentsResponseItem {
  ...
  @scala.inline
  implicit class ReposListCommitCommentsResponseItemOps[Self <: ReposListCommitCommentsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReposListCommitCommentsResponseItemUser): Self = {
        val ret = this.duplicate
