...
trait ReposCreateForAuthenticatedUserResponse extends js.Object {
  ...
  var owner: ReposCreateForAuthenticatedUserResponseOwner = js.native
  var permissions: ReposCreateForAuthenticatedUserResponsePermissions = js.native
...
object ReposCreateForAuthenticatedUserResponse {
  ...
  @scala.inline
  implicit class ReposCreateForAuthenticatedUserResponseOps[Self <: ReposCreateForAuthenticatedUserResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposCreateForAuthenticatedUserResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposCreateForAuthenticatedUserResponsePermissions): Self = {
        val ret = this.duplicate
