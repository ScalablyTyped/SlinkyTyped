...
@js.native
trait TeamsListChildLegacyParams extends js.Object {
  /**
...
object TeamsListChildLegacyParams {
  @scala.inline
  def apply(team_id: Double): TeamsListChildLegacyParams = {
    val __obj = js.Dynamic.literal(team_id = team_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TeamsListChildLegacyParams]
  }
  @scala.inline
  implicit class TeamsListChildLegacyParamsOps[Self <: TeamsListChildLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
