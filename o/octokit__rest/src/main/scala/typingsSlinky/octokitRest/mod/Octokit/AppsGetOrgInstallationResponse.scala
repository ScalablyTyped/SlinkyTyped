...
trait AppsGetOrgInstallationResponse extends js.Object {
  ...
  var account: AppsGetOrgInstallationResponseAccount = js.native
  var app_id: Double = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: AppsGetOrgInstallationResponsePermissions = js.native
...
object AppsGetOrgInstallationResponse {
  ...
  @scala.inline
  implicit class AppsGetOrgInstallationResponseOps[Self <: AppsGetOrgInstallationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: AppsGetOrgInstallationResponseAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: AppsGetOrgInstallationResponsePermissions): Self = {
        val ret = this.duplicate
