...
@js.native
trait ReposUpdateResponseSource extends js.Object {
  ...
  var owner: ReposUpdateResponseSourceOwner = js.native
  var permissions: ReposUpdateResponseSourcePermissions = js.native
...
object ReposUpdateResponseSource {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateResponseSource]
  }
  @scala.inline
  implicit class ReposUpdateResponseSourceOps[Self <: ReposUpdateResponseSource] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposUpdateResponseSourceOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposUpdateResponseSourcePermissions): Self = {
        val ret = this.duplicate
