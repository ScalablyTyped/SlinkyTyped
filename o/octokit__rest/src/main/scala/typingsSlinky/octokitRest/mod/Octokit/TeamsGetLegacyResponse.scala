...
trait TeamsGetLegacyResponse extends js.Object {
  ...
  var organization: TeamsGetLegacyResponseOrganization = js.native
...
object TeamsGetLegacyResponse {
  ...
  @scala.inline
  implicit class TeamsGetLegacyResponseOps[Self <: TeamsGetLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOrganization(value: TeamsGetLegacyResponseOrganization): Self = {
        val ret = this.duplicate
