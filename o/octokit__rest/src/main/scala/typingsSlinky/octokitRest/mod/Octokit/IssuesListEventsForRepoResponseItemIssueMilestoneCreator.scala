...
object IssuesListEventsForRepoResponseItemIssueMilestoneCreator {
  ...
  @scala.inline
  implicit class IssuesListEventsForRepoResponseItemIssueMilestoneCreatorOps[Self <: IssuesListEventsForRepoResponseItemIssueMilestoneCreator] (val x: Self) extends AnyVal {
    @scala.inline
