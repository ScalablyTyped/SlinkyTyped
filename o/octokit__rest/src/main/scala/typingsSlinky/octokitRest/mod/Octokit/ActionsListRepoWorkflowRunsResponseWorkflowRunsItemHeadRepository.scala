...
trait ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepository extends js.Object {
  ...
  var owner: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner = js.native
...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepository {
  ...
  @scala.inline
  implicit class ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOps[Self <: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner): Self = {
        val ret = this.duplicate
