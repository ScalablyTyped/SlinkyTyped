...
trait SearchCommitsResponseItemsItemRepository extends js.Object {
  ...
  var owner: SearchCommitsResponseItemsItemRepositoryOwner = js.native
...
object SearchCommitsResponseItemsItemRepository {
  ...
  @scala.inline
  implicit class SearchCommitsResponseItemsItemRepositoryOps[Self <: SearchCommitsResponseItemsItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: SearchCommitsResponseItemsItemRepositoryOwner): Self = {
        val ret = this.duplicate
