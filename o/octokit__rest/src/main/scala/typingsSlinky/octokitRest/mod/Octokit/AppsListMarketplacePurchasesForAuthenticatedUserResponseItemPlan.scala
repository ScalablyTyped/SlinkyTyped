...
@js.native
trait AppsListMarketplacePurchasesForAuthenticatedUserResponseItemPlan extends js.Object {
...
object AppsListMarketplacePurchasesForAuthenticatedUserResponseItemPlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsListMarketplacePurchasesForAuthenticatedUserResponseItemPlan]
  }
  @scala.inline
  implicit class AppsListMarketplacePurchasesForAuthenticatedUserResponseItemPlanOps[Self <: AppsListMarketplacePurchasesForAuthenticatedUserResponseItemPlan] (val x: Self) extends AnyVal {
    @scala.inline
