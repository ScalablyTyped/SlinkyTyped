...
trait ChecksListForRefResponseCheckRunsItemApp extends js.Object {
  ...
  var owner: ChecksListForRefResponseCheckRunsItemAppOwner = js.native
  var permissions: ChecksListForRefResponseCheckRunsItemAppPermissions = js.native
...
object ChecksListForRefResponseCheckRunsItemApp {
  ...
  @scala.inline
  implicit class ChecksListForRefResponseCheckRunsItemAppOps[Self <: ChecksListForRefResponseCheckRunsItemApp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksListForRefResponseCheckRunsItemAppOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksListForRefResponseCheckRunsItemAppPermissions): Self = {
        val ret = this.duplicate
