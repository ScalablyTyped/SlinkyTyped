...
@js.native
trait PullsCreateFromIssueResponseBaseRepoOwner extends js.Object {
...
object PullsCreateFromIssueResponseBaseRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseBaseRepoOwner]
  }
  @scala.inline
  implicit class PullsCreateFromIssueResponseBaseRepoOwnerOps[Self <: PullsCreateFromIssueResponseBaseRepoOwner] (val x: Self) extends AnyVal {
    @scala.inline
