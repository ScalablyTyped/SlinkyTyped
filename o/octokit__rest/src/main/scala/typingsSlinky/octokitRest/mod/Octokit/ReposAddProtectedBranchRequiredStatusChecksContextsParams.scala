...
object ReposAddProtectedBranchRequiredStatusChecksContextsParams {
  ...
  @scala.inline
  implicit class ReposAddProtectedBranchRequiredStatusChecksContextsParamsOps[Self <: ReposAddProtectedBranchRequiredStatusChecksContextsParams] (val x: Self) extends AnyVal {
    @scala.inline
