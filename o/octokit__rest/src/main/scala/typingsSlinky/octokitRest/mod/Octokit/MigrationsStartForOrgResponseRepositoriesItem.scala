...
@js.native
trait MigrationsStartForOrgResponseRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsStartForOrgResponseRepositoriesItemOwner = js.native
  var permissions: MigrationsStartForOrgResponseRepositoriesItemPermissions = js.native
...
object MigrationsStartForOrgResponseRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsStartForOrgResponseRepositoriesItem]
  }
  @scala.inline
  implicit class MigrationsStartForOrgResponseRepositoriesItemOps[Self <: MigrationsStartForOrgResponseRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsStartForOrgResponseRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsStartForOrgResponseRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
