...
object TeamsUpdateLegacyParams {
  @scala.inline
  def apply(name: String, team_id: Double): TeamsUpdateLegacyParams = {
  ...
  @scala.inline
  implicit class TeamsUpdateLegacyParamsOps[Self <: TeamsUpdateLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
