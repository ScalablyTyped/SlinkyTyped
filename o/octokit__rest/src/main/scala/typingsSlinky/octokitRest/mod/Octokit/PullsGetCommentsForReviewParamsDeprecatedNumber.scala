...
@js.native
trait PullsGetCommentsForReviewParamsDeprecatedNumber extends js.Object {
  /**
...
object PullsGetCommentsForReviewParamsDeprecatedNumber {
  @scala.inline
  def apply(number: Double, owner: String, repo: String, review_id: Double): PullsGetCommentsForReviewParamsDeprecatedNumber = {
    ...
    __obj.asInstanceOf[PullsGetCommentsForReviewParamsDeprecatedNumber]
  }
  @scala.inline
  implicit class PullsGetCommentsForReviewParamsDeprecatedNumberOps[Self <: PullsGetCommentsForReviewParamsDeprecatedNumber] (val x: Self) extends AnyVal {
    @scala.inline
