...
object OauthAuthorizationsRevokeAuthorizationForApplicationParams {
  ...
  @scala.inline
  implicit class OauthAuthorizationsRevokeAuthorizationForApplicationParamsOps[Self <: OauthAuthorizationsRevokeAuthorizationForApplicationParams] (val x: Self) extends AnyVal {
    @scala.inline
