...
object ReactionsListForTeamDiscussionInOrgParams {
  @scala.inline
  def apply(discussion_number: Double, org_ : String, team_slug: String): ReactionsListForTeamDiscussionInOrgParams = {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionInOrgParamsOps[Self <: ReactionsListForTeamDiscussionInOrgParams] (val x: Self) extends AnyVal {
    @scala.inline
