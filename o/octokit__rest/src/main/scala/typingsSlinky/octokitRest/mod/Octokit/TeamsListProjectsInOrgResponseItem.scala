...
@js.native
trait TeamsListProjectsInOrgResponseItem extends js.Object {
  var body: String = js.native
  var columns_url: String = js.native
  var created_at: String = js.native
  var creator: TeamsListProjectsInOrgResponseItemCreator = js.native
  ...
  var permissions: TeamsListProjectsInOrgResponseItemPermissions = js.native
...
object TeamsListProjectsInOrgResponseItem {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[TeamsListProjectsInOrgResponseItem]
  }
  @scala.inline
  implicit class TeamsListProjectsInOrgResponseItemOps[Self <: TeamsListProjectsInOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: TeamsListProjectsInOrgResponseItemCreator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: TeamsListProjectsInOrgResponseItemPermissions): Self = {
        val ret = this.duplicate
