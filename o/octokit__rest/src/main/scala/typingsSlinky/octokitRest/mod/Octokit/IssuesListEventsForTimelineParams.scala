...
object IssuesListEventsForTimelineParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesListEventsForTimelineParams = {
  ...
  @scala.inline
  implicit class IssuesListEventsForTimelineParamsOps[Self <: IssuesListEventsForTimelineParams] (val x: Self) extends AnyVal {
    @scala.inline
