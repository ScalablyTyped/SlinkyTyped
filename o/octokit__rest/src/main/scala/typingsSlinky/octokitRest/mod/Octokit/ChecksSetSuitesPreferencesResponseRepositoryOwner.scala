...
@js.native
trait ChecksSetSuitesPreferencesResponseRepositoryOwner extends js.Object {
...
object ChecksSetSuitesPreferencesResponseRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ChecksSetSuitesPreferencesResponseRepositoryOwner]
  }
  @scala.inline
  implicit class ChecksSetSuitesPreferencesResponseRepositoryOwnerOps[Self <: ChecksSetSuitesPreferencesResponseRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
