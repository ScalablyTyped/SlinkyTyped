...
trait ReposGetResponseParent extends js.Object {
  ...
  var owner: ReposGetResponseParentOwner = js.native
  var permissions: ReposGetResponseParentPermissions = js.native
...
object ReposGetResponseParent {
  ...
  @scala.inline
  implicit class ReposGetResponseParentOps[Self <: ReposGetResponseParent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposGetResponseParentOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposGetResponseParentPermissions): Self = {
        val ret = this.duplicate
