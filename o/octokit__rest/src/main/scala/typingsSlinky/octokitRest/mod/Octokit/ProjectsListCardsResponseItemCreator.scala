...
@js.native
trait ProjectsListCardsResponseItemCreator extends js.Object {
...
object ProjectsListCardsResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsListCardsResponseItemCreator]
  }
  @scala.inline
  implicit class ProjectsListCardsResponseItemCreatorOps[Self <: ProjectsListCardsResponseItemCreator] (val x: Self) extends AnyVal {
    @scala.inline
