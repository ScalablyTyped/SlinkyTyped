...
trait ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo extends js.Object {
  ...
  var owner: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoOwner = js.native
  var permissions: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoPermissions = js.native
...
object ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoPermissions): Self = {
        val ret = this.duplicate
