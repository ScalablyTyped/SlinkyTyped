...
trait IssuesCreateMilestoneResponse extends js.Object {
  ...
  var creator: IssuesCreateMilestoneResponseCreator = js.native
...
object IssuesCreateMilestoneResponse {
  ...
  @scala.inline
  implicit class IssuesCreateMilestoneResponseOps[Self <: IssuesCreateMilestoneResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesCreateMilestoneResponseCreator): Self = {
        val ret = this.duplicate
