...
@js.native
trait TeamsReviewProjectResponseCreator extends js.Object {
...
object TeamsReviewProjectResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsReviewProjectResponseCreator]
  }
  @scala.inline
  implicit class TeamsReviewProjectResponseCreatorOps[Self <: TeamsReviewProjectResponseCreator] (val x: Self) extends AnyVal {
    @scala.inline
