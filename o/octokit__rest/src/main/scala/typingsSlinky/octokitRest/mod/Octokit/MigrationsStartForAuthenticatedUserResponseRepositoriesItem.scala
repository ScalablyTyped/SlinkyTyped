...
trait MigrationsStartForAuthenticatedUserResponseRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner = js.native
  var permissions: MigrationsStartForAuthenticatedUserResponseRepositoriesItemPermissions = js.native
...
object MigrationsStartForAuthenticatedUserResponseRepositoriesItem {
  ...
  @scala.inline
  implicit class MigrationsStartForAuthenticatedUserResponseRepositoriesItemOps[Self <: MigrationsStartForAuthenticatedUserResponseRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsStartForAuthenticatedUserResponseRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
