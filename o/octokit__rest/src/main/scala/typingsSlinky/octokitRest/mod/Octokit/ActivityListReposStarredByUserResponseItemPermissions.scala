...
object ActivityListReposStarredByUserResponseItemPermissions {
  ...
  @scala.inline
  implicit class ActivityListReposStarredByUserResponseItemPermissionsOps[Self <: ActivityListReposStarredByUserResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
