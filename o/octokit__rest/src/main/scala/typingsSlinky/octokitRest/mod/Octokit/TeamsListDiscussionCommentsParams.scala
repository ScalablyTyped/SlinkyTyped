...
object TeamsListDiscussionCommentsParams {
  @scala.inline
  def apply(discussion_number: Double, team_id: Double): TeamsListDiscussionCommentsParams = {
  ...
  @scala.inline
  implicit class TeamsListDiscussionCommentsParamsOps[Self <: TeamsListDiscussionCommentsParams] (val x: Self) extends AnyVal {
    @scala.inline
