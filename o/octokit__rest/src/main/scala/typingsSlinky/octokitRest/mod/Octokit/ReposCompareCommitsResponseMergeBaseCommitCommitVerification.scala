...
object ReposCompareCommitsResponseMergeBaseCommitCommitVerification {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseMergeBaseCommitCommitVerificationOps[Self <: ReposCompareCommitsResponseMergeBaseCommitCommitVerification] (val x: Self) extends AnyVal {
    @scala.inline
