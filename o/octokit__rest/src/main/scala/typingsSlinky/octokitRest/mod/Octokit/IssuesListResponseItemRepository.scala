...
trait IssuesListResponseItemRepository extends js.Object {
  ...
  var owner: IssuesListResponseItemRepositoryOwner = js.native
  var permissions: IssuesListResponseItemRepositoryPermissions = js.native
...
object IssuesListResponseItemRepository {
  ...
  @scala.inline
  implicit class IssuesListResponseItemRepositoryOps[Self <: IssuesListResponseItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: IssuesListResponseItemRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: IssuesListResponseItemRepositoryPermissions): Self = {
        val ret = this.duplicate
