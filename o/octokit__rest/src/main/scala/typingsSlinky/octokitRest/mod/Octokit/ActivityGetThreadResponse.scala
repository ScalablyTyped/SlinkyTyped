...
trait ActivityGetThreadResponse extends js.Object {
  ...
  var repository: ActivityGetThreadResponseRepository = js.native
  var subject: ActivityGetThreadResponseSubject = js.native
...
object ActivityGetThreadResponse {
  ...
  @scala.inline
  implicit class ActivityGetThreadResponseOps[Self <: ActivityGetThreadResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepository(value: ActivityGetThreadResponseRepository): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("repository")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSubject(value: ActivityGetThreadResponseSubject): Self = {
        val ret = this.duplicate
