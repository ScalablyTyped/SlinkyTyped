...
@js.native
trait ReposListCommitsResponseItemCommitter extends js.Object {
...
object ReposListCommitsResponseItemCommitter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListCommitsResponseItemCommitter]
  }
  @scala.inline
  implicit class ReposListCommitsResponseItemCommitterOps[Self <: ReposListCommitsResponseItemCommitter] (val x: Self) extends AnyVal {
    @scala.inline
