...
object ActivityListFeedsResponseLinksCurrentUserOrganization {
  ...
  @scala.inline
  implicit class ActivityListFeedsResponseLinksCurrentUserOrganizationOps[Self <: ActivityListFeedsResponseLinksCurrentUserOrganization] (val x: Self) extends AnyVal {
    @scala.inline
