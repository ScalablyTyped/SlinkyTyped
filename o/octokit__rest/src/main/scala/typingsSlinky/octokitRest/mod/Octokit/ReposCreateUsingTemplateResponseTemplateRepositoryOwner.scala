...
@js.native
trait ReposCreateUsingTemplateResponseTemplateRepositoryOwner extends js.Object {
...
object ReposCreateUsingTemplateResponseTemplateRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCreateUsingTemplateResponseTemplateRepositoryOwner]
  }
  @scala.inline
  implicit class ReposCreateUsingTemplateResponseTemplateRepositoryOwnerOps[Self <: ReposCreateUsingTemplateResponseTemplateRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
