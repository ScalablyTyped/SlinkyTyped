...
@js.native
trait ReposGetProtectedBranchRestrictionsResponseUsersItem extends js.Object {
...
object ReposGetProtectedBranchRestrictionsResponseUsersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRestrictionsResponseUsersItem]
  }
  @scala.inline
  implicit class ReposGetProtectedBranchRestrictionsResponseUsersItemOps[Self <: ReposGetProtectedBranchRestrictionsResponseUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
