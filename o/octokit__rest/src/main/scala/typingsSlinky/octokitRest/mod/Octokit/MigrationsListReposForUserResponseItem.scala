...
trait MigrationsListReposForUserResponseItem extends js.Object {
  ...
  var license: MigrationsListReposForUserResponseItemLicense = js.native
  ...
  var owner: MigrationsListReposForUserResponseItemOwner = js.native
  var permissions: MigrationsListReposForUserResponseItemPermissions = js.native
...
object MigrationsListReposForUserResponseItem {
  ...
  @scala.inline
  implicit class MigrationsListReposForUserResponseItemOps[Self <: MigrationsListReposForUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: MigrationsListReposForUserResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: MigrationsListReposForUserResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsListReposForUserResponseItemPermissions): Self = {
        val ret = this.duplicate
