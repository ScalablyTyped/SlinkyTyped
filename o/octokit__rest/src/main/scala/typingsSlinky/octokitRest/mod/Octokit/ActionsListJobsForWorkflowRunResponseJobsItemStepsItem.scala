...
object ActionsListJobsForWorkflowRunResponseJobsItemStepsItem {
  ...
  @scala.inline
  implicit class ActionsListJobsForWorkflowRunResponseJobsItemStepsItemOps[Self <: ActionsListJobsForWorkflowRunResponseJobsItemStepsItem] (val x: Self) extends AnyVal {
    @scala.inline
