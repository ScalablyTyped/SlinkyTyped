...
trait MigrationsListReposForOrgResponseItem extends js.Object {
  ...
  var license: MigrationsListReposForOrgResponseItemLicense = js.native
  ...
  var owner: MigrationsListReposForOrgResponseItemOwner = js.native
  var permissions: MigrationsListReposForOrgResponseItemPermissions = js.native
...
object MigrationsListReposForOrgResponseItem {
  ...
  @scala.inline
  implicit class MigrationsListReposForOrgResponseItemOps[Self <: MigrationsListReposForOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: MigrationsListReposForOrgResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: MigrationsListReposForOrgResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: MigrationsListReposForOrgResponseItemPermissions): Self = {
        val ret = this.duplicate
