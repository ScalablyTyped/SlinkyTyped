...
object ReactionsListForTeamDiscussionInOrgResponseItemUser {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionInOrgResponseItemUserOps[Self <: ReactionsListForTeamDiscussionInOrgResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
