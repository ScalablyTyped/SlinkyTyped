...
object ReposReplaceProtectedBranchAppRestrictionsResponseItemOwner {
  ...
  @scala.inline
  implicit class ReposReplaceProtectedBranchAppRestrictionsResponseItemOwnerOps[Self <: ReposReplaceProtectedBranchAppRestrictionsResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
