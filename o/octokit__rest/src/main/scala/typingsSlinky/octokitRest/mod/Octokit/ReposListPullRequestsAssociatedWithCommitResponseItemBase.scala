...
trait ReposListPullRequestsAssociatedWithCommitResponseItemBase extends js.Object {
  ...
  var repo: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo = js.native
  var sha: String = js.native
  var user: ReposListPullRequestsAssociatedWithCommitResponseItemBaseUser = js.native
}
...
object ReposListPullRequestsAssociatedWithCommitResponseItemBase {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemBaseOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: ReposListPullRequestsAssociatedWithCommitResponseItemBaseUser): Self = {
        val ret = this.duplicate
