...
trait TeamsUpdateDiscussionCommentLegacyResponse extends js.Object {
  var author: TeamsUpdateDiscussionCommentLegacyResponseAuthor = js.native
  ...
  var reactions: TeamsUpdateDiscussionCommentLegacyResponseReactions = js.native
...
object TeamsUpdateDiscussionCommentLegacyResponse {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentLegacyResponseOps[Self <: TeamsUpdateDiscussionCommentLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsUpdateDiscussionCommentLegacyResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsUpdateDiscussionCommentLegacyResponseReactions): Self = {
        val ret = this.duplicate
