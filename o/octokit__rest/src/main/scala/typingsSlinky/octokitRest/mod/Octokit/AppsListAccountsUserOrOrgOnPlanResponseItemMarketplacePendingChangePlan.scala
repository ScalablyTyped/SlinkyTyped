...
object AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChangePlan {
  ...
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChangePlanOps[Self <: AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChangePlan] (val x: Self) extends AnyVal {
    @scala.inline
