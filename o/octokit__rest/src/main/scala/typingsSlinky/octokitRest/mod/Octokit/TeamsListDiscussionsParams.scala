...
object TeamsListDiscussionsParams {
  @scala.inline
  def apply(team_id: Double): TeamsListDiscussionsParams = {
    val __obj = js.Dynamic.literal(team_id = team_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TeamsListDiscussionsParams]
  }
  @scala.inline
  implicit class TeamsListDiscussionsParamsOps[Self <: TeamsListDiscussionsParams] (val x: Self) extends AnyVal {
    @scala.inline
