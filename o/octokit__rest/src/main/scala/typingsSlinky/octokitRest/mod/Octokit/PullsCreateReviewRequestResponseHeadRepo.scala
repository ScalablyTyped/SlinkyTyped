...
trait PullsCreateReviewRequestResponseHeadRepo extends js.Object {
  ...
  var owner: PullsCreateReviewRequestResponseHeadRepoOwner = js.native
  var permissions: PullsCreateReviewRequestResponseHeadRepoPermissions = js.native
...
object PullsCreateReviewRequestResponseHeadRepo {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseHeadRepoOps[Self <: PullsCreateReviewRequestResponseHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsCreateReviewRequestResponseHeadRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsCreateReviewRequestResponseHeadRepoPermissions): Self = {
        val ret = this.duplicate
