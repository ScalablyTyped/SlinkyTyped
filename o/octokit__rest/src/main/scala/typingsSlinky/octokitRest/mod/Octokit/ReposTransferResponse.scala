...
trait ReposTransferResponse extends js.Object {
  ...
  var owner: ReposTransferResponseOwner = js.native
  var permissions: ReposTransferResponsePermissions = js.native
...
object ReposTransferResponse {
  ...
  @scala.inline
  implicit class ReposTransferResponseOps[Self <: ReposTransferResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposTransferResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposTransferResponsePermissions): Self = {
        val ret = this.duplicate
