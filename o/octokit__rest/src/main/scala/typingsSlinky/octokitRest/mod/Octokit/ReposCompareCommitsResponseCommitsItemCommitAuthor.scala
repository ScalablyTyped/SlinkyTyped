...
object ReposCompareCommitsResponseCommitsItemCommitAuthor {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseCommitsItemCommitAuthorOps[Self <: ReposCompareCommitsResponseCommitsItemCommitAuthor] (val x: Self) extends AnyVal {
    @scala.inline
