...
object AppsListMarketplacePurchasesForAuthenticatedUserStubbedResponseItemPlan {
  ...
  @scala.inline
  implicit class AppsListMarketplacePurchasesForAuthenticatedUserStubbedResponseItemPlanOps[Self <: AppsListMarketplacePurchasesForAuthenticatedUserStubbedResponseItemPlan] (val x: Self) extends AnyVal {
    @scala.inline
