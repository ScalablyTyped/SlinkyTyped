...
trait ReposGetProtectedBranchPullRequestReviewEnforcementResponse extends js.Object {
  ...
  var dismissal_restrictions: ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictions = js.native
...
object ReposGetProtectedBranchPullRequestReviewEnforcementResponse {
  ...
  @scala.inline
  implicit class ReposGetProtectedBranchPullRequestReviewEnforcementResponseOps[Self <: ReposGetProtectedBranchPullRequestReviewEnforcementResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDismissal_restrictions(value: ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictions): Self = {
        val ret = this.duplicate
