...
object ReposListPullRequestsAssociatedWithCommitResponseItemLinksReviewComments {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemLinksReviewCommentsOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemLinksReviewComments] (val x: Self) extends AnyVal {
    @scala.inline
