...
trait AnonAddAssignees extends js.Object {
  /**
    ...
    */
  @JSName("addAssignees")
  var addAssignees_Original: Anon146 = js.native
  @JSName("addLabels")
  var addLabels_Original: Anon147 = js.native
  /**
  ...
  var checkAssignee_Original: Anon148 = js.native
  /**
    * This endpoint triggers [notifications](https://help.github.com/articles/about-notifications/). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://developer.github.com/v3/#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://developer.github.com/v3/guides/best-practices-for-integrators/#dealing-with-abuse-rate-limits)" for details.
    */
  @JSName("createComment")
  var createComment_Original: Anon150 = js.native
  @JSName("createLabel")
  var createLabel_Original: Anon151 = js.native
  @JSName("createMilestone")
  var createMilestone_Original: Anon152 = js.native
  /**
    ...
    */
  @JSName("create")
  var create_Original: Anon149 = js.native
  @JSName("deleteComment")
  var deleteComment_Original: Anon153 = js.native
  @JSName("deleteLabel")
  var deleteLabel_Original: Anon154 = js.native
  @JSName("deleteMilestone")
  var deleteMilestone_Original: Anon155 = js.native
  @JSName("getComment")
  var getComment_Original: Anon157 = js.native
  @JSName("getEvent")
  var getEvent_Original: Anon158 = js.native
  @JSName("getLabel")
  var getLabel_Original: Anon159 = js.native
  @JSName("getMilestone")
  var getMilestone_Original: Anon160 = js.native
  /**
    ...
    */
  @JSName("get")
  var get_Original: Anon156 = js.native
  /**
    * Lists the [available assignees](https://help.github.com/articles/assigning-issues-and-pull-requests-to-other-github-users/) for issues in a repository.
    */
  @JSName("listAssignees")
  var listAssignees_Original: Anon162 = js.native
  /**
    * By default, Issue Comments are ordered by ascending ID.
    */
  @JSName("listCommentsForRepo")
  var listCommentsForRepo_Original: Anon164 = js.native
  /**
    * Issue Comments are ordered by ascending ID.
    */
  @JSName("listComments")
  var listComments_Original: Anon163 = js.native
  @JSName("listEventsForRepo")
  var listEventsForRepo_Original: Anon166 = js.native
  @JSName("listEventsForTimeline")
  var listEventsForTimeline_Original: Anon167 = js.native
  @JSName("listEvents")
  var listEvents_Original: Anon165 = js.native
  /**
    * **Note**: GitHub's REST API v3 considers every pull request an issue, but not every issue is a pull request. For this reason, "Issues" endpoints may return both issues and pull requests in the response. You can identify pull requests by the `pull_request` key.
    *
    * Be aware that the `id` of a pull request returned from "Issues" endpoints will be an _issue id_. To find out the pull request id, use the "[List pull requests](https://developer.github.com/v3/pulls/#list-pull-requests)" endpoint.
  ...
  var listForAuthenticatedUser_Original: Anon168 = js.native
  /**
    * **Note**: GitHub's REST API v3 considers every pull request an issue, but not every issue is a pull request. For this reason, "Issues" endpoints may return both issues and pull requests in the response. You can identify pull requests by the `pull_request` key.
    *
    * Be aware that the `id` of a pull request returned from "Issues" endpoints will be an _issue id_. To find out the pull request id, use the "[List pull requests](https://developer.github.com/v3/pulls/#list-pull-requests)" endpoint.
    */
  @JSName("listForOrg")
  var listForOrg_Original: Anon169 = js.native
  /**
    * **Note**: GitHub's REST API v3 considers every pull request an issue, but not every issue is a pull request. For this reason, "Issues" endpoints may return both issues and pull requests in the response. You can identify pull requests by the `pull_request` key.
    *
    * Be aware that the `id` of a pull request returned from "Issues" endpoints will be an _issue id_. To find out the pull request id, use the "[List pull requests](https://developer.github.com/v3/pulls/#list-pull-requests)" endpoint.
    */
  @JSName("listForRepo")
  var listForRepo_Original: Anon170 = js.native
  @JSName("listLabelsForMilestone")
  var listLabelsForMilestone_Original: Anon171 = js.native
  @JSName("listLabelsForRepo")
  var listLabelsForRepo_Original: Anon172 = js.native
  @JSName("listLabelsOnIssue")
  var listLabelsOnIssue_Original: Anon173 = js.native
  @JSName("listMilestonesForRepo")
  var listMilestonesForRepo_Original: Anon174 = js.native
  /**
    * **Note**: GitHub's REST API v3 considers every pull request an issue, but not every issue is a pull request. For this reason, "Issues" endpoints may return both issues and pull requests in the response. You can identify pull requests by the `pull_request` key.
    *
    * Be aware that the `id` of a pull request returned from "Issues" endpoints will be an _issue id_. To find out the pull request id, use the "[List pull requests](https://developer.github.com/v3/pulls/#list-pull-requests)" endpoint.
    */
  @JSName("list")
  var list_Original: Anon161 = js.native
  /**
    ...
    */
  @JSName("lock")
  var lock_Original: Anon175 = js.native
  /**
  ...
  var removeAssignees_Original: Anon176 = js.native
  /**
    * Removes the specified label from the issue, and returns the remaining labels on the issue. This endpoint returns a `404 Not Found` status if the label does not exist.
    */
  @JSName("removeLabel")
  var removeLabel_Original: Anon177 = js.native
  @JSName("removeLabels")
  var removeLabels_Original: Anon178 = js.native
  @JSName("replaceLabels")
  var replaceLabels_Original: Anon179 = js.native
  /**
    * Users with push access can unlock an issue's conversation.
    */
  @JSName("unlock")
  var unlock_Original: Anon180 = js.native
  @JSName("updateComment")
  var updateComment_Original: Anon182 = js.native
  @JSName("updateLabel")
  var updateLabel_Original: Anon183 = js.native
  @JSName("updateMilestone")
  var updateMilestone_Original: Anon184 = js.native
  /**
    * Issue owners and users with push access can edit an issue.
    */
  @JSName("update")
  var update_Original: Anon181 = js.native
  /**
    * Adds up to 10 assignees to an issue. Users already assigned to an issue are not replaced.
    *
    * This example adds two assignees to the existing `octocat` assignee.
