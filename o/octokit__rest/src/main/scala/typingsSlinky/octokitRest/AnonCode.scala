...
import typingsSlinky.octokitRest.mod.Octokit.SearchCodeParams
import typingsSlinky.octokitRest.mod.Octokit.SearchCodeResponse
...
import typingsSlinky.octokitRest.mod.Octokit.SearchIssuesAndPullRequestsParams
import typingsSlinky.octokitRest.mod.Octokit.SearchIssuesAndPullRequestsResponse
...
import typingsSlinky.octokitRest.mod.Octokit.SearchLabelsParams
import typingsSlinky.octokitRest.mod.Octokit.SearchLabelsResponse
import typingsSlinky.octokitRest.mod.Octokit.SearchReposLegacyParams
import typingsSlinky.octokitRest.mod.Octokit.SearchReposLegacyResponse
...
import typingsSlinky.octokitRest.mod.Octokit.SearchTopicsParams
import typingsSlinky.octokitRest.mod.Octokit.SearchTopicsResponse
...
trait AnonCode extends js.Object {
  /**
    ...
    */
  @JSName("code")
  var code_Original: Anon490 = js.native
  /**
    ...
    */
  @JSName("commits")
  var commits_Original: Anon491 = js.native
  /**
    ...
    */
  @JSName("emailLegacy")
  var emailLegacy_Original: Anon492 = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("issues")
  var issues_Original: Anon493 = js.native
  /**
    ...
    */
  @JSName("labels")
  var labels_Original: Anon496 = js.native
  /**
    ...
    */
  @JSName("reposLegacy")
  var reposLegacy_Original: Anon498 = js.native
  /**
    ...
    */
  @JSName("repos")
  var repos_Original: Anon497 = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("users")
  var users_Original: Anon500 = js.native
  /**
    * Find file contents via various criteria. This method returns up to 100 results [per page](https://developer.github.com/v3/#pagination).
    *
    * When searching for code, you can get text match metadata for the file **content** and file **path** fields when you pass the `text-match` media type. For more details about how to receive highlighted search results, see [Text match metadata](https://developer.github.com/v3/search/#text-match-metadata).
