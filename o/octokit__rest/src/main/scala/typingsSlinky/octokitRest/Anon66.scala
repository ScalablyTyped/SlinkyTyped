...
import typingsSlinky.octokitRest.mod.Octokit.AppsFindRepoInstallationParams
import typingsSlinky.octokitRest.mod.Octokit.AppsFindRepoInstallationResponse
