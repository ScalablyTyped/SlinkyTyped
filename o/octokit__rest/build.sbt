...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "octokit__plugin-paginate-rest" % "2.6.0-a0d4e4",
  "org.scalablytyped.slinky" %%% "octokit__plugin-rest-endpoint-methods" % "4.2.1-fb7046",
