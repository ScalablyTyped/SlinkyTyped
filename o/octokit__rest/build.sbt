...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "octokit__plugin-paginate-rest" % "2.3.0-7bceee",
  "org.scalablytyped.slinky" %%% "octokit__plugin-rest-endpoint-methods" % "4.1.2-ff63fe",
