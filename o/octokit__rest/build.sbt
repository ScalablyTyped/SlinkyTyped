...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "octokit__plugin-paginate-rest" % "2.6.0-e682c6",
  "org.scalablytyped.slinky" %%% "octokit__plugin-rest-endpoint-methods" % "4.2.1-0b2163",
