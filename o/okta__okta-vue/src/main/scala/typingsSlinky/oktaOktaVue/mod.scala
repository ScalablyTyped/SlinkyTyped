...
object mod {
  ...
  object vueTypesVueAugmentingMod {
    ...
    object Vue {
      ...
      @scala.inline
      def apply($auth: AuthRedirectGuard): typingsSlinky.oktaOktaVue.mod.vueTypesVueAugmentingMod.Vue = {
        val __obj = js.Dynamic.literal($auth = $auth.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.oktaOktaVue.mod.vueTypesVueAugmentingMod.Vue]
      }
      
      @scala.inline
      implicit class VueMutableBuilder[Self <: typingsSlinky.oktaOktaVue.mod.vueTypesVueAugmentingMod.Vue] (val x: Self) extends AnyVal {
