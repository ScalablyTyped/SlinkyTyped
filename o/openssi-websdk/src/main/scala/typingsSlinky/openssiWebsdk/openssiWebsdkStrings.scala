...
import typingsSlinky.openssiWebsdk.mod.ConnectionMethod
import typingsSlinky.openssiWebsdk.mod.ConnectionState
import typingsSlinky.openssiWebsdk.mod.CredentialState
import typingsSlinky.openssiWebsdk.mod.VerificationState
