...
import typingsSlinky.openssiWebsdk.openssiWebsdkStrings.debug
import typingsSlinky.openssiWebsdk.openssiWebsdkStrings.error
import typingsSlinky.openssiWebsdk.openssiWebsdkStrings.fatal
