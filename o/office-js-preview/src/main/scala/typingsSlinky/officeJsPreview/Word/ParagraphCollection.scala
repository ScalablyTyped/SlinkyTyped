...
import typingsSlinky.officeJsPreview.Word.Interfaces.ParagraphCollectionData
import typingsSlinky.officeJsPreview.Word.Interfaces.ParagraphCollectionLoadOptions
