...
import typingsSlinky.officeJsPreview.Word.Interfaces.CustomPropertyData
import typingsSlinky.officeJsPreview.Word.Interfaces.CustomPropertyLoadOptions
import typingsSlinky.officeJsPreview.Word.Interfaces.CustomPropertyUpdateData
...
trait CustomProperty extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: DocumentPropertyType | typingsSlinky.officeJsPreview.officeJsPreviewStrings.String | Number | Date | Boolean = js.native
  /**
    *
