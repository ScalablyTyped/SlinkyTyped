...
import typingsSlinky.officeJsPreview.Word.Interfaces.ContentControlCollectionData
import typingsSlinky.officeJsPreview.Word.Interfaces.ContentControlCollectionLoadOptions
