...
import typingsSlinky.officeJsPreview.Word.Interfaces.TableData
import typingsSlinky.officeJsPreview.Word.Interfaces.TableLoadOptions
import typingsSlinky.officeJsPreview.Word.Interfaces.TableUpdateData
