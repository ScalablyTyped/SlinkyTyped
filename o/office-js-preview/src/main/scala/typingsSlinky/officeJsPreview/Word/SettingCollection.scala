...
import typingsSlinky.officeJsPreview.Word.Interfaces.SettingCollectionData
import typingsSlinky.officeJsPreview.Word.Interfaces.SettingCollectionLoadOptions
