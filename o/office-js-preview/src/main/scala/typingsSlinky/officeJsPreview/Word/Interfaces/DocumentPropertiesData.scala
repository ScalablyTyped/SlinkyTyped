...
object DocumentPropertiesData {
  ...
  implicit class DocumentPropertiesDataOps[Self <: DocumentPropertiesData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastPrintDate(value: js.Date): Self = this.set("lastPrintDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastPrintDate: Self = this.set("lastPrintDate", js.undefined)
    @scala.inline
    def setLastSaveTime(value: js.Date): Self = this.set("lastSaveTime", value.asInstanceOf[js.Any])
    @scala.inline
