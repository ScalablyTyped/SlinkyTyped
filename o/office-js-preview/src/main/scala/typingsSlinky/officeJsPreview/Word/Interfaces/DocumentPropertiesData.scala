...
object DocumentPropertiesData {
  ...
  implicit class DocumentPropertiesDataMutableBuilder[Self <: DocumentPropertiesData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastPrintDate(value: js.Date): Self = StObject.set(x, "lastPrintDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastPrintDateUndefined: Self = StObject.set(x, "lastPrintDate", js.undefined)
    
    @scala.inline
    def setLastSaveTime(value: js.Date): Self = StObject.set(x, "lastSaveTime", value.asInstanceOf[js.Any])
