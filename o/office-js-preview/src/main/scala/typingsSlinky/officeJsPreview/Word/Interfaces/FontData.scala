...
object FontData {
  ...
  def apply(
    ...
    underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | Word | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = null
  ): FontData = {
