...
import typingsSlinky.officeJsPreview.Visio.Interfaces.HyperlinkCollectionData
import typingsSlinky.officeJsPreview.Visio.Interfaces.HyperlinkCollectionLoadOptions
...
@js.native
class HyperlinkCollection () extends ClientObject {
