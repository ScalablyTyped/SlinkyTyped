...
import typingsSlinky.officeJsPreview.Visio.Interfaces.ShapeCollectionData
import typingsSlinky.officeJsPreview.Visio.Interfaces.ShapeCollectionLoadOptions
