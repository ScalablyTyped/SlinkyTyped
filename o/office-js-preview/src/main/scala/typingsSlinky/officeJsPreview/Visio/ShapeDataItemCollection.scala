...
import typingsSlinky.officeJsPreview.Visio.Interfaces.ShapeDataItemCollectionData
import typingsSlinky.officeJsPreview.Visio.Interfaces.ShapeDataItemCollectionLoadOptions
