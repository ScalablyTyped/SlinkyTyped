...
trait RecurrenceTimeZone extends js.Object {
  /**
    ...
    */
  var name: typingsSlinky.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String
  /**
...
object RecurrenceTimeZone {
  @scala.inline
  def apply(
    name: typingsSlinky.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String,
