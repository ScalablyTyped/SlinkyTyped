package typingsSlinky.officeJsPreview.Office.AddinCommands
...
object EventCompletedOptions {
  ...
  implicit class EventCompletedOptionsOps[Self <: EventCompletedOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllowEvent(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowEvent")(value.asInstanceOf[js.Any])
        ret
    }
  }
