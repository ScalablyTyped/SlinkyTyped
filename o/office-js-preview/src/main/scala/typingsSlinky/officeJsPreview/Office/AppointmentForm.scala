...
object AppointmentForm {
  ...
  implicit class AppointmentFormMutableBuilder[Self <: AppointmentForm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnd(value: Time | js.Date): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStart(value: Time | js.Date): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
