...
import typingsSlinky.officeJsPreview.Excel.CellPropertiesBorderLoadOptions
import typingsSlinky.officeJsPreview.Excel.CellPropertiesFillLoadOptions
import typingsSlinky.officeJsPreview.Excel.CellPropertiesFontLoadOptions
