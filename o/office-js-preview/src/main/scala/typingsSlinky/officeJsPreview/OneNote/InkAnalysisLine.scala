...
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkAnalysisLineData
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkAnalysisLineLoadOptions
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkAnalysisLineUpdateData
...
/**
  ...
  */
@js.native
trait InkAnalysisLine extends ClientObject {
  ...
  def load(option: Expand): InkAnalysisLine = js.native
