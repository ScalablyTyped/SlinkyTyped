...
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkAnalysisParagraphData
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkAnalysisParagraphLoadOptions
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkAnalysisParagraphUpdateData
...
@js.native
class InkAnalysisParagraph () extends ClientObject {
  ...
  def load(option: AnonExpand): InkAnalysisParagraph = js.native
