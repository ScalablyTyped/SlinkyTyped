...
trait PageContent extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Outline | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Image | Ink | Other = js.native
  /**
    *
