...
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkStrokeCollectionData
import typingsSlinky.officeJsPreview.OneNote.Interfaces.InkStrokeCollectionLoadOptions
