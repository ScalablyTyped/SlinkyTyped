...
import typingsSlinky.officeJsPreview.OneNote.Interfaces.ParagraphData
import typingsSlinky.officeJsPreview.OneNote.Interfaces.ParagraphLoadOptions
import typingsSlinky.officeJsPreview.OneNote.Interfaces.ParagraphUpdateData
...
trait Paragraph extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: ParagraphType | typingsSlinky.officeJsPreview.officeJsPreviewStrings.RichText | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Image | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Table | Ink | Other = js.native
  def addNoteTag(
