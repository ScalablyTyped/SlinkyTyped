...
trait Application extends ClientObject {
  ...
  /**
    ...
    * @eventproperty
    */
  val onNotebookChanged: EventHandlers[NotebookChangedEventArgs] = js.native
  ...
  /**
    ...
    * @eventproperty
    */
  val onPageSelectionChanged: EventHandlers[PageSelectionChangedEventArgs] = js.native
  ...
  /**
    ...
    * @eventproperty
    */
  val onSectionSelectionChanged: EventHandlers[SectionSelectionChangedEventArgs] = js.native
  ...
  /**
    ...
    * @eventproperty
    */
  val onStickyNotesContextMenuExecutedEvent: EventHandlers[StickyNotesContextMenuExecutedEventArgs] = js.native
