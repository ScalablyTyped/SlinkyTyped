...
import typingsSlinky.officeJsPreview.Excel.Interfaces.BindingData
import typingsSlinky.officeJsPreview.Excel.Interfaces.BindingLoadOptions
...
trait Binding extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  val `type`: BindingType | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Range | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Table | Text = js.native
  /**
    * Deletes the binding.
    *
