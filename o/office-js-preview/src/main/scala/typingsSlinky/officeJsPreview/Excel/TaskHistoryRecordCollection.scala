...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskHistoryRecordCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskHistoryRecordCollectionLoadOptions
