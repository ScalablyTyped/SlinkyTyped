...
import typingsSlinky.officeJsPreview.Excel.ChartGradientStyle
import typingsSlinky.officeJsPreview.Excel.ChartGradientStyleType
import typingsSlinky.officeJsPreview.Excel.ChartMarkerStyle
import typingsSlinky.officeJsPreview.Excel.ChartParentLabelStrategy
import typingsSlinky.officeJsPreview.Excel.ChartSplitType
