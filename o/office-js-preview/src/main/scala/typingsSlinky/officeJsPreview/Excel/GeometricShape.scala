...
import typingsSlinky.officeJsPreview.Excel.Interfaces.GeometricShapeData
import typingsSlinky.officeJsPreview.Excel.Interfaces.GeometricShapeLoadOptions
