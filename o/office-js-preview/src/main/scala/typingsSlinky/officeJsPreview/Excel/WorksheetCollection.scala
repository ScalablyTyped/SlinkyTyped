...
import typingsSlinky.officeJsPreview.Excel.Interfaces.WorksheetCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.WorksheetCollectionLoadOptions
