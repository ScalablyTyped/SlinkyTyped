...
import typingsSlinky.officeJsPreview.Excel.Interfaces.FormatProtectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.FormatProtectionLoadOptions
import typingsSlinky.officeJsPreview.Excel.Interfaces.FormatProtectionUpdateData
