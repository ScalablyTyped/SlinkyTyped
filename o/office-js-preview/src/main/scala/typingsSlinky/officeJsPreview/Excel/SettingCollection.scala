...
import typingsSlinky.officeJsPreview.Excel.Interfaces.SettingCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.SettingCollectionLoadOptions
