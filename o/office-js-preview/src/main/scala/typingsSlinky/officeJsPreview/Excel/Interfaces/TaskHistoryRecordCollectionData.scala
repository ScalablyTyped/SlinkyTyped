...
@js.native
trait TaskHistoryRecordCollectionData extends js.Object {
...
object TaskHistoryRecordCollectionData {
  ...
  @scala.inline
  implicit class TaskHistoryRecordCollectionDataOps[Self <: TaskHistoryRecordCollectionData] (val x: Self) extends AnyVal {
