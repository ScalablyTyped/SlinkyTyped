...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TextRangeData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TextRangeLoadOptions
import typingsSlinky.officeJsPreview.Excel.Interfaces.TextRangeUpdateData
