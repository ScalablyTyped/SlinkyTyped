...
import typingsSlinky.officeJsPreview.Excel.Interfaces.NamedSheetViewCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.NamedSheetViewCollectionLoadOptions
