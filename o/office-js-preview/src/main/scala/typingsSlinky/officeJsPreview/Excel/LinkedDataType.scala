...
import typingsSlinky.officeJsPreview.Excel.Interfaces.LinkedDataTypeData
import typingsSlinky.officeJsPreview.Excel.Interfaces.LinkedDataTypeLoadOptions
