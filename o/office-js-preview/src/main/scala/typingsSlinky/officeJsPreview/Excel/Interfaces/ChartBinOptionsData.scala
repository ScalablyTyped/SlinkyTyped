...
import typingsSlinky.officeJsPreview.Excel.ChartBinType
...
object ChartBinOptionsData {
  ...
  @scala.inline
  implicit class ChartBinOptionsDataMutableBuilder[Self <: ChartBinOptionsData] (val x: Self) extends AnyVal {
