...
import typingsSlinky.officeJsPreview.Excel.LinkedDataTypeRefreshMode
...
trait LinkedDataTypeData extends StObject {
  ...
  /**
    ...
    * @beta
    */
  var lastRefreshed: js.UndefOr[js.Date] = js.native
...
object LinkedDataTypeData {
  ...
  implicit class LinkedDataTypeDataMutableBuilder[Self <: LinkedDataTypeData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastRefreshed(value: js.Date): Self = StObject.set(x, "lastRefreshed", value.asInstanceOf[js.Any])
