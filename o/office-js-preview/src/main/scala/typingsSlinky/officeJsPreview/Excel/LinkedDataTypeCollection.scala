...
import typingsSlinky.officeJsPreview.Excel.Interfaces.LinkedDataTypeCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.LinkedDataTypeCollectionLoadOptions
