...
trait TableData extends js.Object {
  ...
  /**
    ...
    * @beta
    */
  var tableStyle: js.UndefOr[TableStyleData] = js.native
}
...
object TableData {
  ...
  implicit class TableDataOps[Self <: TableData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumns(value: js.Array[TableColumnData]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSort(value: TableSortData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTableStyle(value: TableStyleData): Self = {
        val ret = this.duplicate
