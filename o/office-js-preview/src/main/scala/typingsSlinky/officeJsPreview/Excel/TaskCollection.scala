...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskCollectionLoadOptions
...
/**
  ...
  */
@js.native
trait TaskCollection extends ClientObject {
  ...
  def load(options: TaskCollectionLoadOptions with CollectionLoadOptions): TaskCollection = js.native
