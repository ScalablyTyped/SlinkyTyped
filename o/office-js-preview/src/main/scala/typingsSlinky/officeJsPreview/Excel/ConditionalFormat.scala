...
class ConditionalFormat () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.6]
    */
  val `type`: ConditionalFormatType | Custom | DataBar | ColorScale | typingsSlinky.officeJsPreview.officeJsPreviewStrings.IconSet | TopBottom | PresetCriteria | ContainsText | CellValue = js.native
  /**
    *
