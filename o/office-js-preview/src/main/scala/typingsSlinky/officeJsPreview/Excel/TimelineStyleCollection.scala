...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TimelineStyleCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TimelineStyleCollectionLoadOptions
