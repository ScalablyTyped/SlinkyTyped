...
import typingsSlinky.officeJsPreview.Excel.Interfaces.SlicerStyleCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.SlicerStyleCollectionLoadOptions
...
@js.native
class SlicerStyleCollection () extends ClientObject {
