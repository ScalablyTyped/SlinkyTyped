...
import typingsSlinky.officeJsPreview.Excel.Interfaces.SlicerCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.SlicerCollectionLoadOptions
