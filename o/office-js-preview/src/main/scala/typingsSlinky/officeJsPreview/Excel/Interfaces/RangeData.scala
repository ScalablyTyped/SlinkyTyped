...
import typingsSlinky.officeJsPreview.Excel.LinkedDataTypeState
import typingsSlinky.officeJsPreview.Excel.NumberFormatCategory
import typingsSlinky.officeJsPreview.Excel.RangeHyperlink
...
object RangeData {
  ...
  implicit class RangeDataOps[Self <: RangeData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNumberFormatCategories(value: js.Array[js.Array[NumberFormatCategory]]): Self = {
        val ret = this.duplicate
