...
import typingsSlinky.officeJsPreview.Excel.Interfaces.PivotTableScopedCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.PivotTableScopedCollectionLoadOptions
