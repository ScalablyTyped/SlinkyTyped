...
import typingsSlinky.officeJsPreview.Excel.ChartAxisGroup
...
import typingsSlinky.officeJsPreview.Excel.ChartAxisType
...
object ChartAxisData {
  ...
  implicit class ChartAxisDataOps[Self <: ChartAxisData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCustomDisplayUnit(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFormat(value: ChartAxisFormatData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMajorGridlines(value: ChartGridlinesData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMinorGridlines(value: ChartGridlinesData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPositionAt(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitle(value: ChartAxisTitleData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: ChartAxisType | Invalid | Category | Value | Series): Self = {
        val ret = this.duplicate
