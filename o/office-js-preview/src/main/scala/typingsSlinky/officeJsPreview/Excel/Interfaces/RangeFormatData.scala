...
object RangeFormatData {
  ...
  @scala.inline
  implicit class RangeFormatDataMutableBuilder[Self <: RangeFormatData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProtection(value: FormatProtectionData): Self = StObject.set(x, "protection", value.asInstanceOf[js.Any])
