...
import typingsSlinky.officeJsPreview.Excel.Interfaces.StyleCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.StyleCollectionLoadOptions
