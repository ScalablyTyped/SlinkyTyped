...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TimelineStyleData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TimelineStyleLoadOptions
import typingsSlinky.officeJsPreview.Excel.Interfaces.TimelineStyleUpdateData
