...
import typingsSlinky.officeJsPreview.Excel.Interfaces.BindingCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.BindingCollectionLoadOptions
...
trait BindingCollection extends ClientObject {
  ...
  def addFromNamedItem_Range(name: String, bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Range, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  def addFromNamedItem_Table(name: String, bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Table, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  ...
  def addFromSelection_Range(bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Range, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Table(bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Table, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Text(bindingType: Text, id: String): Binding = js.native
  @JSName("add")
  def add_Range(range: String, bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Range, id: String): Binding = js.native
  /**
    * Add a new binding to a particular Range.
    *
    * [Api set: ExcelApi 1.3]
    ...
    */
  @JSName("add")
  def add_Range(range: Range, bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Range, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: String, bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Table, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: Range, bindingType: typingsSlinky.officeJsPreview.officeJsPreviewStrings.Table, id: String): Binding = js.native
  @JSName("add")
