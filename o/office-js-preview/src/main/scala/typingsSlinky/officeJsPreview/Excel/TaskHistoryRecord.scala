...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskHistoryRecordData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskHistoryRecordLoadOptions
...
trait TaskHistoryRecord extends ClientObject {
  ...
  /**
    ...
    * @beta
    */
  var historyRecordCreatedDate: js.Date = js.native
