...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TableScopedCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TableScopedCollectionLoadOptions
