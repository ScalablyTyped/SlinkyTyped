...
import typingsSlinky.officeJsPreview.Excel.Interfaces.PageBreakCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.PageBreakCollectionLoadOptions
