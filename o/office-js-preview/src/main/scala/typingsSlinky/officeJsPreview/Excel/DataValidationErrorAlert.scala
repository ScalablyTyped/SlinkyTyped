...
import typingsSlinky.officeJsPreview.officeJsPreviewStrings.Information
import typingsSlinky.officeJsPreview.officeJsPreviewStrings.Stop
import typingsSlinky.officeJsPreview.officeJsPreviewStrings.Warning
