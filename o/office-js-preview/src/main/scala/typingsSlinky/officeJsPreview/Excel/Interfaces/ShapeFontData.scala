...
object ShapeFontData {
  ...
  def apply(
    ...
    underline: ShapeFontUnderlineStyle | None | Single | typingsSlinky.officeJsPreview.officeJsPreviewStrings.Double | Heavy | Dotted | DottedHeavy | Dash | DashHeavy | DashLong | DashLongHeavy | DotDash | DotDashHeavy | DotDotDash | DotDotDashHeavy | Wavy | WavyHeavy | WavyDouble = null
  ): ShapeFontData = {
