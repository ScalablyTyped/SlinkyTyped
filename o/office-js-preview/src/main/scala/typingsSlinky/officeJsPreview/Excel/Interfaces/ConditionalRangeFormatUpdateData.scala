...
object ConditionalRangeFormatUpdateData {
  ...
  implicit class ConditionalRangeFormatUpdateDataOps[Self <: ConditionalRangeFormatUpdateData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorders(value: ConditionalRangeBorderCollectionUpdateData): Self = {
    ...
    @scala.inline
    def withFill(value: ConditionalRangeFillUpdateData): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFont(value: ConditionalRangeFontUpdateData): Self = {
        val ret = this.duplicate
