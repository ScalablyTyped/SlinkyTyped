...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TaskLoadOptions
...
trait Task extends ClientObject {
  ...
  /**
    ...
    */
  def setStartDateAndDueDate(startDate: js.Date, dueDate: js.Date): Unit = js.native
