...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TableRowCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TableRowCollectionLoadOptions
