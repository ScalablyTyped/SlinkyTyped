...
object ChartAxisLoadOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(baseTimeUnit)) __obj.updateDynamic("baseTimeUnit")(baseTimeUnit.get.asInstanceOf[js.Any])
    if (!js.isUndefined(categoryType)) __obj.updateDynamic("categoryType")(categoryType.get.asInstanceOf[js.Any])
    if (!js.isUndefined(crosses)) __obj.updateDynamic("crosses")(crosses.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(displayUnit)) __obj.updateDynamic("displayUnit")(displayUnit.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(majorTickMark)) __obj.updateDynamic("majorTickMark")(majorTickMark.get.asInstanceOf[js.Any])
    if (!js.isUndefined(majorTimeUnitScale)) __obj.updateDynamic("majorTimeUnitScale")(majorTimeUnitScale.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(minorTickMark)) __obj.updateDynamic("minorTickMark")(minorTickMark.get.asInstanceOf[js.Any])
    if (!js.isUndefined(minorTimeUnitScale)) __obj.updateDynamic("minorTimeUnitScale")(minorTimeUnitScale.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(scaleType)) __obj.updateDynamic("scaleType")(scaleType.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(tickLabelPosition)) __obj.updateDynamic("tickLabelPosition")(tickLabelPosition.get.asInstanceOf[js.Any])
    if (!js.isUndefined(tickLabelSpacing)) __obj.updateDynamic("tickLabelSpacing")(tickLabelSpacing.get.asInstanceOf[js.Any])
