...
import typingsSlinky.officeJsPreview.Excel.Interfaces.TableCollectionData
import typingsSlinky.officeJsPreview.Excel.Interfaces.TableCollectionLoadOptions
