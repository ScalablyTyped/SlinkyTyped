...
import typingsSlinky.officeJsPreview.Excel.CommentMention
import typingsSlinky.officeJsPreview.Excel.ContentType
...
object CommentData {
  ...
  implicit class CommentDataOps[Self <: CommentData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContentType(value: ContentType | Plain | Mention): Self = {
        val ret = this.duplicate
