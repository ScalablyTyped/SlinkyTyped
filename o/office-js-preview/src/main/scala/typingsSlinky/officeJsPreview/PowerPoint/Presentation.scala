...
import typingsSlinky.officeJsPreview.PowerPoint.Interfaces.PresentationData
import typingsSlinky.officeJsPreview.PowerPoint.Interfaces.PresentationLoadOptions
