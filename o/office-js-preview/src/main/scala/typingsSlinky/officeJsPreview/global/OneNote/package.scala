...
package object OneNote {
  ...
  ): js.Promise[T] = typingsSlinky.officeJsPreview.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
  /**
  ...
  def run[T](
    ...
    batch: js.Function1[/* context */ typingsSlinky.officeJsPreview.OneNote.RequestContext, js.Promise[T]]
  ): js.Promise[T] = (typingsSlinky.officeJsPreview.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(objects.asInstanceOf[js.Any], batch.asInstanceOf[js.Any])).asInstanceOf[js.Promise[T]]
  /**
  ...
  def run[T](
    ...
    batch: js.Function1[/* context */ typingsSlinky.officeJsPreview.OneNote.RequestContext, js.Promise[T]]
  ): js.Promise[T] = (typingsSlinky.officeJsPreview.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(`object`.asInstanceOf[js.Any], batch.asInstanceOf[js.Any])).asInstanceOf[js.Promise[T]]
}
