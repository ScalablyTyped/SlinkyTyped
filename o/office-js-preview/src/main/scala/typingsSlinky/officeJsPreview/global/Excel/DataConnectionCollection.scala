...
class DataConnectionCollection ()
  extends typingsSlinky.officeJsPreview.Excel.DataConnectionCollection {
  ...
  /* CompleteClass */
  @JSName("context")
  override var context_DataConnectionCollection: typingsSlinky.officeJsPreview.Excel.RequestContext = js.native
  /**
