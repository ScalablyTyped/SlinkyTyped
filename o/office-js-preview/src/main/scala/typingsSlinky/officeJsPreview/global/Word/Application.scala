...
@js.native
class Application ()
  extends typingsSlinky.officeJsPreview.Word.Application
...
object Application extends js.Object {
  /**
    ...
    */
  def newObject(context: ClientRequestContext): typingsSlinky.officeJsPreview.Word.Application = js.native
}
