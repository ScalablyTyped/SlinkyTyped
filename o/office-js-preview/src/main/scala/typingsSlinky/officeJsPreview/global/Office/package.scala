...
package object Office {
  ...
  /** A Promise object. Promises can be chained via ".then", and errors can be caught via ".catch".
    ...
    */
  @scala.inline
  def Promise: typingsSlinky.officeJsPreview.Office.IPromiseConstructor = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("Promise").asInstanceOf[typingsSlinky.officeJsPreview.Office.IPromiseConstructor]
  @scala.inline
  def Promise_=(x: typingsSlinky.officeJsPreview.Office.IPromiseConstructor): scala.Unit = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].updateDynamic("Promise")(x.asInstanceOf[js.Any])
  
  /**
    * Provides a method for associating action names with functions that carry out an action.
    */
  @scala.inline
  def actions: typingsSlinky.officeJsPreview.Office.Actions = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("actions").asInstanceOf[typingsSlinky.officeJsPreview.Office.Actions]
  
  /**
    * Represents the add-in.
    */
  @scala.inline
  def addin: typingsSlinky.officeJsPreview.Office.Addin = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("addin").asInstanceOf[typingsSlinky.officeJsPreview.Office.Addin]
  ...
  /**
    ...
    */
  @scala.inline
  def context: typingsSlinky.officeJsPreview.Office.Context = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("context").asInstanceOf[typingsSlinky.officeJsPreview.Office.Context]
  @scala.inline
  def context_=(x: typingsSlinky.officeJsPreview.Office.Context): scala.Unit = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].updateDynamic("context")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  @scala.inline
  def initialize(reason: typingsSlinky.officeJsPreview.Office.InitializationReason): scala.Unit = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("initialize")(reason.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def isSetSupported(name: java.lang.String): scala.Boolean = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("isSetSupported")(name.asInstanceOf[js.Any]).asInstanceOf[scala.Boolean]
  @scala.inline
  def isSetSupported(name: java.lang.String, minVersion: java.lang.String): scala.Boolean = (typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("isSetSupported")(name.asInstanceOf[js.Any], minVersion.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
  ...
  /**
    ...
    */
  @scala.inline
  def onReady(): js.Promise[typingsSlinky.officeJsPreview.anon.Host] = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("onReady")().asInstanceOf[js.Promise[typingsSlinky.officeJsPreview.anon.Host]]
  @scala.inline
  def onReady(callback: js.Function1[/* info */ typingsSlinky.officeJsPreview.anon.Host, _]): js.Promise[typingsSlinky.officeJsPreview.anon.Host] = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("onReady")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsSlinky.officeJsPreview.anon.Host]]
  
  /**
    * Represents the ribbon associated with the Office application.
    */
  @scala.inline
  def ribbon: typingsSlinky.officeJsPreview.Office.Ribbon = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("ribbon").asInstanceOf[typingsSlinky.officeJsPreview.Office.Ribbon]
  ...
  /**
    ...
    */
  @scala.inline
  def select(expression: java.lang.String): typingsSlinky.officeJsPreview.Office.Binding = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("select")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.officeJsPreview.Office.Binding]
  @scala.inline
  def select(
    expression: java.lang.String,
    callback: js.Function1[/* result */ typingsSlinky.officeJsPreview.Office.AsyncResult[_], scala.Unit]
  ): typingsSlinky.officeJsPreview.Office.Binding = (typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("select")(expression.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.officeJsPreview.Office.Binding]
  ...
  /**
    ...
    */
  @scala.inline
  def useShortNamespace(useShortNamespace: scala.Boolean): scala.Unit = typingsSlinky.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("useShortNamespace")(useShortNamespace.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
}
