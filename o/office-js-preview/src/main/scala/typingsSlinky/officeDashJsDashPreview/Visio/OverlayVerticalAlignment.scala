...
object OverlayVerticalAlignment extends js.Object {
  ...
  /* "Bottom" */ val bottom: typingsSlinky.officeDashJsDashPreview.Visio.OverlayVerticalAlignment.bottom with String = js.native
  /* "Middle" */ val middle: typingsSlinky.officeDashJsDashPreview.Visio.OverlayVerticalAlignment.middle with String = js.native
  /* "Top" */ val top: typingsSlinky.officeDashJsDashPreview.Visio.OverlayVerticalAlignment.top with String = js.native
  @JSBracketAccess
