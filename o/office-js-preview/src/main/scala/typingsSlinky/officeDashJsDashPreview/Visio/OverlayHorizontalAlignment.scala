...
object OverlayHorizontalAlignment extends js.Object {
  ...
  /* "Center" */ val center: typingsSlinky.officeDashJsDashPreview.Visio.OverlayHorizontalAlignment.center with String = js.native
  /* "Left" */ val left: typingsSlinky.officeDashJsDashPreview.Visio.OverlayHorizontalAlignment.left with String = js.native
  /* "Right" */ val right: typingsSlinky.officeDashJsDashPreview.Visio.OverlayHorizontalAlignment.right with String = js.native
  @JSBracketAccess
