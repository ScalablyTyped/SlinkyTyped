...
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.PageData
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.PageLoadOptions
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.PageUpdateData
...
class Page () extends ClientObject {
  ...
  def load(option: Anon_Expand): Page = js.native
