...
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.CollectionLoadOptions
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.ShapeDataItemCollectionData
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.ShapeDataItemCollectionLoadOptions
...
@js.native
class ShapeDataItemCollection () extends ClientObject {
