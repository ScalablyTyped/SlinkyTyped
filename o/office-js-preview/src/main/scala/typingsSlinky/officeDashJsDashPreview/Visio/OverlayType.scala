...
object OverlayType extends js.Object {
  ...
  /* "Html" */ val html: typingsSlinky.officeDashJsDashPreview.Visio.OverlayType.html with String = js.native
  /* "Image" */ val image: typingsSlinky.officeDashJsDashPreview.Visio.OverlayType.image with String = js.native
  /* "Text" */ val text: typingsSlinky.officeDashJsDashPreview.Visio.OverlayType.text with String = js.native
  @JSBracketAccess
