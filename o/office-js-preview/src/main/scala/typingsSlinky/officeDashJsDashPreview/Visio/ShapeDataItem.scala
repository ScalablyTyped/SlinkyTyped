...
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.ShapeDataItemData
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.ShapeDataItemLoadOptions
...
class ShapeDataItem () extends ClientObject {
  ...
  def load(option: Anon_Expand): ShapeDataItem = js.native
