...
object ToolBarType extends js.Object {
  ...
  /* "CommandBar" */ val commandBar: typingsSlinky.officeDashJsDashPreview.Visio.ToolBarType.commandBar with String = js.native
  /* "PageNavigationBar" */ val pageNavigationBar: typingsSlinky.officeDashJsDashPreview.Visio.ToolBarType.pageNavigationBar with String = js.native
  /* "StatusBar" */ val statusBar: typingsSlinky.officeDashJsDashPreview.Visio.ToolBarType.statusBar with String = js.native
  @JSBracketAccess
