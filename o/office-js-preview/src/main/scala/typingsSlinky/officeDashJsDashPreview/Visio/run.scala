...
import typingsSlinky.officeDashJsDashPreview.OfficeExtension.ClientRequestContext
import typingsSlinky.officeDashJsDashPreview.OfficeExtension.EmbeddedSession
...
object run extends js.Object {
  ...
  def apply[T](`object`: EmbeddedSession, batch: js.Function1[/* context */ RequestContext, js.Promise[T]]): js.Promise[T] = js.native
}
