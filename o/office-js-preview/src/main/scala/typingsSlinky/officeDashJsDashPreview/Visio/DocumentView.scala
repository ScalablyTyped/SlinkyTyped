...
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.DocumentViewData
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.DocumentViewLoadOptions
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.DocumentViewUpdateData
...
class DocumentView () extends ClientObject {
  ...
  def load(option: Anon_Expand): DocumentView = js.native
