...
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.ShapeCollectionData
import typingsSlinky.officeDashJsDashPreview.Visio.Interfaces.ShapeCollectionLoadOptions
