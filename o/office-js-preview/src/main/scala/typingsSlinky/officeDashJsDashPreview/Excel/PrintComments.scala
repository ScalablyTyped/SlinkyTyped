...
object PrintComments extends js.Object {
  ...
  /* "EndSheet" */ val endSheet: typingsSlinky.officeDashJsDashPreview.Excel.PrintComments.endSheet with String = js.native
  /* "InPlace" */ val inPlace: typingsSlinky.officeDashJsDashPreview.Excel.PrintComments.inPlace with String = js.native
  /* "NoComments" */ val noComments: typingsSlinky.officeDashJsDashPreview.Excel.PrintComments.noComments with String = js.native
  @JSBracketAccess
