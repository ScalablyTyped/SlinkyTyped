...
object ChartGradientStyle extends js.Object {
  ...
  /* "ThreePhaseColor" */ val threePhaseColor: typingsSlinky.officeDashJsDashPreview.Excel.ChartGradientStyle.threePhaseColor with String = js.native
  /* "TwoPhaseColor" */ val twoPhaseColor: typingsSlinky.officeDashJsDashPreview.Excel.ChartGradientStyle.twoPhaseColor with String = js.native
  @JSBracketAccess
