...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatUpdateData
...
class ConditionalFormat () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.6]
    */
  val `type`: ConditionalFormatType | Custom | DataBar | ColorScale | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.IconSet | TopBottom | PresetCriteria | ContainsText | CellValue = js.native
  /**
    *
