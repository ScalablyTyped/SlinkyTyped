...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotTableStyleCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotTableStyleCollectionLoadOptions
...
@js.native
class PivotTableStyleCollection () extends ClientObject {
