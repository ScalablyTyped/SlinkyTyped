...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.RangeFontData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.RangeFontLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.RangeFontUpdateData
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DoubleAccountant
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.SingleAccountant
...
class RangeFont () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  var underline: RangeUnderlineStyle | None | Single | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | SingleAccountant | DoubleAccountant = js.native
  /**
