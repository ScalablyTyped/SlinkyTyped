...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableRowCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableRowCollectionLoadOptions
