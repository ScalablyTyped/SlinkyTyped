...
object CloseBehavior extends js.Object {
  ...
  /* "Save" */ val save: typingsSlinky.officeDashJsDashPreview.Excel.CloseBehavior.save with String = js.native
  /* "SkipSave" */ val skipSave: typingsSlinky.officeDashJsDashPreview.Excel.CloseBehavior.skipSave with String = js.native
  @JSBracketAccess
