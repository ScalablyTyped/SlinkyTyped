...
object RowHiddenChangeType extends js.Object {
  ...
  /* "Hidden" */ val hidden: typingsSlinky.officeDashJsDashPreview.Excel.RowHiddenChangeType.hidden with String = js.native
  /* "Unhidden" */ val unhidden: typingsSlinky.officeDashJsDashPreview.Excel.RowHiddenChangeType.unhidden with String = js.native
  @JSBracketAccess
