...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartErrorBarsFormatData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartErrorBarsFormatLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartErrorBarsFormatUpdateData
...
class ChartErrorBarsFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartErrorBarsFormat = js.native
