...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartCollectionLoadOptions
...
@js.native
class ChartCollection () extends ClientObject {
