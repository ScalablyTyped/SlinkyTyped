...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.CultureInfoData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.CultureInfoLoadOptions
...
class CultureInfo () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): CultureInfo = js.native
