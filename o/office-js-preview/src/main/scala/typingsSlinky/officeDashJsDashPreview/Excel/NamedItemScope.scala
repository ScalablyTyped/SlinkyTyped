...
object NamedItemScope extends js.Object {
  ...
  /* "Workbook" */ val workbook: typingsSlinky.officeDashJsDashPreview.Excel.NamedItemScope.workbook with String = js.native
  /* "Worksheet" */ val worksheet: typingsSlinky.officeDashJsDashPreview.Excel.NamedItemScope.worksheet with String = js.native
  @JSBracketAccess
