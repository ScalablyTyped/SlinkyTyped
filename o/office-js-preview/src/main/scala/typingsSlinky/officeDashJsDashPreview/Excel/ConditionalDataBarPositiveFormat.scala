...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalDataBarPositiveFormatData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalDataBarPositiveFormatLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalDataBarPositiveFormatUpdateData
...
class ConditionalDataBarPositiveFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ConditionalDataBarPositiveFormat = js.native
