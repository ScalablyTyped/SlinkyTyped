...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SettingCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SettingCollectionLoadOptions
