...
object ShapeTextHorizontalOverflow extends js.Object {
  ...
  /* "Clip" */ val clip: typingsSlinky.officeDashJsDashPreview.Excel.ShapeTextHorizontalOverflow.clip with String = js.native
  /* "Overflow" */ val overflow: typingsSlinky.officeDashJsDashPreview.Excel.ShapeTextHorizontalOverflow.overflow with String = js.native
  @JSBracketAccess
