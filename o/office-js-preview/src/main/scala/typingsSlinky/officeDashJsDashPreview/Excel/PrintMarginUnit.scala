...
object PrintMarginUnit extends js.Object {
  ...
  /* "Centimeters" */ val centimeters: typingsSlinky.officeDashJsDashPreview.Excel.PrintMarginUnit.centimeters with String = js.native
  /* "Inches" */ val inches: typingsSlinky.officeDashJsDashPreview.Excel.PrintMarginUnit.inches with String = js.native
  /* "Points" */ val points: typingsSlinky.officeDashJsDashPreview.Excel.PrintMarginUnit.points with String = js.native
  @JSBracketAccess
