...
object SortMethod extends js.Object {
  ...
  /* "PinYin" */ val pinYin: typingsSlinky.officeDashJsDashPreview.Excel.SortMethod.pinYin with String = js.native
  /* "StrokeCount" */ val strokeCount: typingsSlinky.officeDashJsDashPreview.Excel.SortMethod.strokeCount with String = js.native
  @JSBracketAccess
