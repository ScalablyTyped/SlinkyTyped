...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.GeometricShapeData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.GeometricShapeLoadOptions
