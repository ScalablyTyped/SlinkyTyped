...
object CustomFunctionType extends js.Object {
  ...
  /* "Invalid" */ val invalid: typingsSlinky.officeDashJsDashPreview.Excel.CustomFunctionType.invalid with String = js.native
  /* "Script" */ val script: typingsSlinky.officeDashJsDashPreview.Excel.CustomFunctionType.script with String = js.native
  /* "WebService" */ val webService: typingsSlinky.officeDashJsDashPreview.Excel.CustomFunctionType.webService with String = js.native
  @JSBracketAccess
