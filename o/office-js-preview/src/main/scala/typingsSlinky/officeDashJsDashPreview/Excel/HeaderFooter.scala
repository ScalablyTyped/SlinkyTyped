...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterUpdateData
