...
object ContentType extends js.Object {
  ...
  /* "Mention" */ val mention: typingsSlinky.officeDashJsDashPreview.Excel.ContentType.mention with String = js.native
  /* "Plain" */ val plain: typingsSlinky.officeDashJsDashPreview.Excel.ContentType.plain with String = js.native
  @JSBracketAccess
