...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleUpdateData
...
class TimelineStyle () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): TimelineStyle = js.native
