...
object ChartAxisScaleType extends js.Object {
  ...
  /* "Linear" */ val linear: typingsSlinky.officeDashJsDashPreview.Excel.ChartAxisScaleType.linear with String = js.native
  /* "Logarithmic" */ val logarithmic: typingsSlinky.officeDashJsDashPreview.Excel.ChartAxisScaleType.logarithmic with String = js.native
  @JSBracketAccess
