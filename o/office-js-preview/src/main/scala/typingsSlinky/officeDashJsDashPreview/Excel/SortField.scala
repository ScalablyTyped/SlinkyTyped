...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.TextAsNumber
...
trait SortField extends js.Object {
  ...
  var sortOn: js.UndefOr[
    SortOn | Value | CellColor | FontColor | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Icon
  ] = js.undefined
  /**
    *
...
object SortField {
  ...
  def apply(
    ...
    icon: Icon = null,
    sortOn: SortOn | Value | CellColor | FontColor | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Icon = null,
