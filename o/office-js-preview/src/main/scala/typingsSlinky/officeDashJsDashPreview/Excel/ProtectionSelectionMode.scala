...
object ProtectionSelectionMode extends js.Object {
  ...
  /* "None" */ val none: typingsSlinky.officeDashJsDashPreview.Excel.ProtectionSelectionMode.none with String = js.native
  /* "Normal" */ val normal: typingsSlinky.officeDashJsDashPreview.Excel.ProtectionSelectionMode.normal with String = js.native
  /* "Unlocked" */ val unlocked: typingsSlinky.officeDashJsDashPreview.Excel.ProtectionSelectionMode.unlocked with String = js.native
  @JSBracketAccess
