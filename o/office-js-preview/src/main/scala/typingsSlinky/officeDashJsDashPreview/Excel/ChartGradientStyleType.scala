...
object ChartGradientStyleType extends js.Object {
  ...
  /* "ExtremeValue" */ val extremeValue: typingsSlinky.officeDashJsDashPreview.Excel.ChartGradientStyleType.extremeValue with String = js.native
  /* "Number" */ val number: typingsSlinky.officeDashJsDashPreview.Excel.ChartGradientStyleType.number with String = js.native
  /* "Percent" */ val percent: typingsSlinky.officeDashJsDashPreview.Excel.ChartGradientStyleType.percent with String = js.native
  @JSBracketAccess
