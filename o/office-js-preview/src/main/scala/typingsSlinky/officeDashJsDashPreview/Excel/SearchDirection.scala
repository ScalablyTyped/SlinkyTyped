...
object SearchDirection extends js.Object {
  ...
  /* "Backwards" */ val backwards: typingsSlinky.officeDashJsDashPreview.Excel.SearchDirection.backwards with String = js.native
  /* "Forward" */ val forward: typingsSlinky.officeDashJsDashPreview.Excel.SearchDirection.forward with String = js.native
  @JSBracketAccess
