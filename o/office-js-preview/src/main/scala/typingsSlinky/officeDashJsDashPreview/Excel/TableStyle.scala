...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableStyleData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableStyleLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableStyleUpdateData
