...
object HeaderFooterState extends js.Object {
  ...
  /* "Default" */ val default: typingsSlinky.officeDashJsDashPreview.Excel.HeaderFooterState.default with String = js.native
  /* "FirstAndDefault" */ val firstAndDefault: typingsSlinky.officeDashJsDashPreview.Excel.HeaderFooterState.firstAndDefault with String = js.native
  /* "FirstOddAndEven" */ val firstOddAndEven: typingsSlinky.officeDashJsDashPreview.Excel.HeaderFooterState.firstOddAndEven with String = js.native
  /* "OddAndEven" */ val oddAndEven: typingsSlinky.officeDashJsDashPreview.Excel.HeaderFooterState.oddAndEven with String = js.native
  @JSBracketAccess
