...
object ConditionalRangeFontUnderlineStyle extends js.Object {
  ...
  /* "Double" */ val double: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalRangeFontUnderlineStyle.double with String = js.native
  /* "None" */ val none: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalRangeFontUnderlineStyle.none with String = js.native
  /* "Single" */ val single: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalRangeFontUnderlineStyle.single with String = js.native
  @JSBracketAccess
