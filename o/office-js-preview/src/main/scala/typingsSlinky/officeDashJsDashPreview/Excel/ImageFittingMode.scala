...
object ImageFittingMode extends js.Object {
  ...
  /* "Fill" */ val fill: typingsSlinky.officeDashJsDashPreview.Excel.ImageFittingMode.fill with String = js.native
  /* "Fit" */ val fit: typingsSlinky.officeDashJsDashPreview.Excel.ImageFittingMode.fit with String = js.native
  /* "FitAndCenter" */ val fitAndCenter: typingsSlinky.officeDashJsDashPreview.Excel.ImageFittingMode.fitAndCenter with String = js.native
  @JSBracketAccess
