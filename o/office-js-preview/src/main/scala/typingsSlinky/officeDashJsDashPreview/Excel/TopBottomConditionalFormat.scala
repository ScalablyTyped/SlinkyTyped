...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TopBottomConditionalFormatData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TopBottomConditionalFormatLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TopBottomConditionalFormatUpdateData
...
class TopBottomConditionalFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): TopBottomConditionalFormat = js.native
