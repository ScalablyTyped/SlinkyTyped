...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SlicerCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SlicerCollectionLoadOptions
