...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.NamedItemArrayValuesData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.NamedItemArrayValuesLoadOptions
...
class NamedItemArrayValues () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): NamedItemArrayValues = js.native
