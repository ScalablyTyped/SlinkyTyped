...
object FilterOperator extends js.Object {
  ...
  /* "And" */ val and: typingsSlinky.officeDashJsDashPreview.Excel.FilterOperator.and with String = js.native
  /* "Or" */ val or: typingsSlinky.officeDashJsDashPreview.Excel.FilterOperator.or with String = js.native
  @JSBracketAccess
