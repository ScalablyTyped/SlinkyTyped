...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SlicerItemData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SlicerItemLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SlicerItemUpdateData
...
class SlicerItem () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): SlicerItem = js.native
