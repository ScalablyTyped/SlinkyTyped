...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.BindingCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.BindingCollectionLoadOptions
...
class BindingCollection () extends ClientObject {
  ...
  def addFromNamedItem_Range(
    name: String,
    bindingType: typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Range,
    id: String
  ): Binding = js.native
  @JSName("addFromNamedItem")
  def addFromNamedItem_Table(
    name: String,
    bindingType: typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Table,
    id: String
  ): Binding = js.native
  @JSName("addFromNamedItem")
