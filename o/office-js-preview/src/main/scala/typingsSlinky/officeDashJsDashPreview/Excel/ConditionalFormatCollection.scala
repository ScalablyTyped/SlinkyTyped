...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.CollectionLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatCollectionLoadOptions
...
import typingsSlinky.officeDashJsDashPreview.OfficeExtension.LoadOption
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.CellValue
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.ColorScale
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.ContainsText
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Custom
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DataBar
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.PresetCriteria
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.TopBottom
...
class ConditionalFormatCollection () extends ClientObject {
  ...
  @JSName("add")
  def add_IconSet(`type`: typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.IconSet): ConditionalFormat = js.native
  @JSName("add")
