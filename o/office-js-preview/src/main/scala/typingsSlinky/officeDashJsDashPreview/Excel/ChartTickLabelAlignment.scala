...
object ChartTickLabelAlignment extends js.Object {
  ...
  /* "Center" */ val center: typingsSlinky.officeDashJsDashPreview.Excel.ChartTickLabelAlignment.center with String = js.native
  /* "Left" */ val left: typingsSlinky.officeDashJsDashPreview.Excel.ChartTickLabelAlignment.left with String = js.native
  /* "Right" */ val right: typingsSlinky.officeDashJsDashPreview.Excel.ChartTickLabelAlignment.right with String = js.native
  @JSBracketAccess
