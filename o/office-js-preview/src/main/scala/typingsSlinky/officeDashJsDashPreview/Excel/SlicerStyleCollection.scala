...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SlicerStyleCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.SlicerStyleCollectionLoadOptions
