...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ShapeFontData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ShapeFontLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ShapeFontUpdateData
...
class ShapeFont () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  var underline: ShapeFontUnderlineStyle | None | Single | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | Heavy | Dotted | DottedHeavy | Dash | DashHeavy | DashLong | DashLongHeavy | DotDash | DotDashHeavy | DotDotDash | DotDotDashHeavy | Wavy | WavyHeavy | WavyDouble = js.native
  /**
