...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartAxesData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartAxesLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartAxesUpdateData
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Category
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Series
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Value
...
class ChartAxes () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartAxes = js.native
