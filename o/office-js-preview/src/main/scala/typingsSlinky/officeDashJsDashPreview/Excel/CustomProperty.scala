...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.CustomPropertyData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.CustomPropertyLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.CustomPropertyUpdateData
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Float
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  val `type`: DocumentPropertyType | Number | Boolean | Date | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.String | Float = js.native
  /**
    *
