...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.BindingData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.BindingLoadOptions
...
class Binding () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  val `type`: BindingType | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Range | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Table | Text = js.native
  /**
    *
    * Deletes the binding.
    *
