...
object SortOrientation extends js.Object {
  ...
  /* "Columns" */ val columns: typingsSlinky.officeDashJsDashPreview.Excel.SortOrientation.columns with String = js.native
  /* "Rows" */ val rows: typingsSlinky.officeDashJsDashPreview.Excel.SortOrientation.rows with String = js.native
  @JSBracketAccess
