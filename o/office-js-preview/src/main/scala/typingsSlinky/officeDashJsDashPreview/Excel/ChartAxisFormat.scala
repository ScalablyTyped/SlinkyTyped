...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartAxisFormatData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartAxisFormatLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartAxisFormatUpdateData
...
class ChartAxisFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartAxisFormat = js.native
