...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatRuleData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatRuleLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatRuleUpdateData
