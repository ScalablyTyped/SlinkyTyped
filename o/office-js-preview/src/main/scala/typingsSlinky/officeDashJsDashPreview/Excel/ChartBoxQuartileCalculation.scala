...
object ChartBoxQuartileCalculation extends js.Object {
  ...
  /* "Exclusive" */ val exclusive: typingsSlinky.officeDashJsDashPreview.Excel.ChartBoxQuartileCalculation.exclusive with String = js.native
  /* "Inclusive" */ val inclusive: typingsSlinky.officeDashJsDashPreview.Excel.ChartBoxQuartileCalculation.inclusive with String = js.native
  @JSBracketAccess
