...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartBoxwhiskerOptionsData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartBoxwhiskerOptionsLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartBoxwhiskerOptionsUpdateData
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Exclusive
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Inclusive
...
class ChartBoxwhiskerOptions () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartBoxwhiskerOptions = js.native
