...
object ChartUnderlineStyle extends js.Object {
  ...
  /* "None" */ val none: typingsSlinky.officeDashJsDashPreview.Excel.ChartUnderlineStyle.none with String = js.native
  /* "Single" */ val single: typingsSlinky.officeDashJsDashPreview.Excel.ChartUnderlineStyle.single with String = js.native
  @JSBracketAccess
