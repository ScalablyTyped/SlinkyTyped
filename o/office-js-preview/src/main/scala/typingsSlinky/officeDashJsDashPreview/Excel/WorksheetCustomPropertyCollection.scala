...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.WorksheetCustomPropertyCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.WorksheetCustomPropertyCollectionLoadOptions
