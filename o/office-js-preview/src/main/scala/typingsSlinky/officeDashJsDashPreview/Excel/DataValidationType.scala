...
object DataValidationType extends js.Object {
  ...
  /* "Custom" */ val custom: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.custom with String = js.native
  /* "Date" */ val date: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.date with String = js.native
  /* "Decimal" */ val decimal: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.decimal with String = js.native
  /* "Inconsistent" */ val inconsistent: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.inconsistent with String = js.native
  /* "List" */ val list: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.list with String = js.native
  /* "MixedCriteria" */ val mixedCriteria: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.mixedCriteria with String = js.native
  /* "None" */ val none: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.none with String = js.native
  /* "TextLength" */ val textLength: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.textLength with String = js.native
  /* "Time" */ val time: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.time with String = js.native
  /* "WholeNumber" */ val wholeNumber: typingsSlinky.officeDashJsDashPreview.Excel.DataValidationType.wholeNumber with String = js.native
  @JSBracketAccess
