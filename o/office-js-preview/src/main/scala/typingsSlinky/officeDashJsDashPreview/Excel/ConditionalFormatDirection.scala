...
object ConditionalFormatDirection extends js.Object {
  ...
  /* "Bottom" */ val bottom: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalFormatDirection.bottom with String = js.native
  /* "Top" */ val top: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalFormatDirection.top with String = js.native
  @JSBracketAccess
