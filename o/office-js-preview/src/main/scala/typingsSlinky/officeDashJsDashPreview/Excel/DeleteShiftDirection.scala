...
object DeleteShiftDirection extends js.Object {
  ...
  /* "Left" */ val left: typingsSlinky.officeDashJsDashPreview.Excel.DeleteShiftDirection.left with String = js.native
  /* "Up" */ val up: typingsSlinky.officeDashJsDashPreview.Excel.DeleteShiftDirection.up with String = js.native
  @JSBracketAccess
