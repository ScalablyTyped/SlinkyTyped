...
object SortDataOption extends js.Object {
  ...
  /* "Normal" */ val normal: typingsSlinky.officeDashJsDashPreview.Excel.SortDataOption.normal with String = js.native
  /* "TextAsNumber" */ val textAsNumber: typingsSlinky.officeDashJsDashPreview.Excel.SortDataOption.textAsNumber with String = js.native
  @JSBracketAccess
