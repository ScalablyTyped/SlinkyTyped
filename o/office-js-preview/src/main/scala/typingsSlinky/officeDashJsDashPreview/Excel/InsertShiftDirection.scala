...
object InsertShiftDirection extends js.Object {
  ...
  /* "Down" */ val down: typingsSlinky.officeDashJsDashPreview.Excel.InsertShiftDirection.down with String = js.native
  /* "Right" */ val right: typingsSlinky.officeDashJsDashPreview.Excel.InsertShiftDirection.right with String = js.native
  @JSBracketAccess
