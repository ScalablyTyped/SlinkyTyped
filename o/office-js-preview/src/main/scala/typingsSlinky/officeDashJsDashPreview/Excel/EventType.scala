...
object EventType extends js.Object {
  ...
  /* "AgaveVisualUpdate" */ val agaveVisualUpdate: typingsSlinky.officeDashJsDashPreview.Excel.EventType.agaveVisualUpdate with String = js.native
  /* "ChartActivated" */ val chartActivated: typingsSlinky.officeDashJsDashPreview.Excel.EventType.chartActivated with String = js.native
  /* "ChartAdded" */ val chartAdded: typingsSlinky.officeDashJsDashPreview.Excel.EventType.chartAdded with String = js.native
  /* "ChartDeactivated" */ val chartDeactivated: typingsSlinky.officeDashJsDashPreview.Excel.EventType.chartDeactivated with String = js.native
  /* "ChartDeleted" */ val chartDeleted: typingsSlinky.officeDashJsDashPreview.Excel.EventType.chartDeleted with String = js.native
  /* "RibbonCommandExecuted" */ val ribbonCommandExecuted: typingsSlinky.officeDashJsDashPreview.Excel.EventType.ribbonCommandExecuted with String = js.native
  /* "ShapeActivated" */ val shapeActivated: typingsSlinky.officeDashJsDashPreview.Excel.EventType.shapeActivated with String = js.native
  /* "ShapeDeactivated" */ val shapeDeactivated: typingsSlinky.officeDashJsDashPreview.Excel.EventType.shapeDeactivated with String = js.native
  /* "TableAdded" */ val tableAdded: typingsSlinky.officeDashJsDashPreview.Excel.EventType.tableAdded with String = js.native
  /* "TableChanged" */ val tableChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.tableChanged with String = js.native
  /* "TableDeleted" */ val tableDeleted: typingsSlinky.officeDashJsDashPreview.Excel.EventType.tableDeleted with String = js.native
  /* "TableFiltered" */ val tableFiltered: typingsSlinky.officeDashJsDashPreview.Excel.EventType.tableFiltered with String = js.native
  /* "TableSelectionChanged" */ val tableSelectionChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.tableSelectionChanged with String = js.native
  /* "VisualChange" */ val visualChange: typingsSlinky.officeDashJsDashPreview.Excel.EventType.visualChange with String = js.native
  /* "VisualSelectionChanged" */ val visualSelectionChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.visualSelectionChanged with String = js.native
  /* "WACOperationEvent" */ val wacoperationEvent: typingsSlinky.officeDashJsDashPreview.Excel.EventType.wacoperationEvent with String = js.native
  /* "WorkbookAutoSaveSettingChanged" */ val workbookAutoSaveSettingChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.workbookAutoSaveSettingChanged with String = js.native
  /* "WorksheetActivated" */ val worksheetActivated: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetActivated with String = js.native
  /* "WorksheetAdded" */ val worksheetAdded: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetAdded with String = js.native
  /* "WorksheetCalculated" */ val worksheetCalculated: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetCalculated with String = js.native
  /* "WorksheetChanged" */ val worksheetChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetChanged with String = js.native
  /* "WorksheetColumnSorted" */ val worksheetColumnSorted: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetColumnSorted with String = js.native
  /* "WorksheetDeactivated" */ val worksheetDeactivated: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetDeactivated with String = js.native
  /* "WorksheetDeleted" */ val worksheetDeleted: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetDeleted with String = js.native
  /* "WorksheetFiltered" */ val worksheetFiltered: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetFiltered with String = js.native
  /* "WorksheetFormatChanged" */ val worksheetFormatChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetFormatChanged with String = js.native
  /* "WorksheetRowHiddenChanged" */ val worksheetRowHiddenChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetRowHiddenChanged with String = js.native
  /* "WorksheetRowSorted" */ val worksheetRowSorted: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetRowSorted with String = js.native
  /* "WorksheetSelectionChanged" */ val worksheetSelectionChanged: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetSelectionChanged with String = js.native
  /* "WorksheetSingleClicked" */ val worksheetSingleClicked: typingsSlinky.officeDashJsDashPreview.Excel.EventType.worksheetSingleClicked with String = js.native
  @JSBracketAccess
