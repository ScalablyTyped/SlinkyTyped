...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableScopedCollectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableScopedCollectionLoadOptions
