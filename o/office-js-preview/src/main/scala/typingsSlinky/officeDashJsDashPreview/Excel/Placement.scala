...
object Placement extends js.Object {
  ...
  /* "Absolute" */ val absolute: typingsSlinky.officeDashJsDashPreview.Excel.Placement.absolute with String = js.native
  /* "OneCell" */ val oneCell: typingsSlinky.officeDashJsDashPreview.Excel.Placement.oneCell with String = js.native
  /* "TwoCell" */ val twoCell: typingsSlinky.officeDashJsDashPreview.Excel.Placement.twoCell with String = js.native
  @JSBracketAccess
