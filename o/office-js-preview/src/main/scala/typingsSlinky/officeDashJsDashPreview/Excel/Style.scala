...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.StyleData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.StyleLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.StyleUpdateData
