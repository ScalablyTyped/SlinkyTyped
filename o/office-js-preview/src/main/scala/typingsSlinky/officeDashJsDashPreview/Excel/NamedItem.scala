...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.NamedItemData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.NamedItemLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.NamedItemUpdateData
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Array
...
class NamedItem () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.4]
    */
  val scope: NamedItemScope | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Worksheet | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Workbook = js.native
  /**
    *
    ...
    */
  val `type`: NamedItemType | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.String | Integer | Double | Boolean | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Range | Error | Array = js.native
  /**
    *
  ...
  def load(propertyNamesAndPaths: Anon_Expand): NamedItem = js.native
