...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.LinkedEntityFinanceIcon
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.LinkedEntityMapIcon
