...
object ConditionalDataBarAxisFormat extends js.Object {
  ...
  /* "Automatic" */ val automatic: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.automatic with String = js.native
  /* "CellMidPoint" */ val cellMidPoint: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.cellMidPoint with String = js.native
  /* "None" */ val none: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.none with String = js.native
  @JSBracketAccess
