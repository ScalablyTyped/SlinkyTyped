...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotHierarchyData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotHierarchyLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotHierarchyUpdateData
...
class PivotHierarchy () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): PivotHierarchy = js.native
