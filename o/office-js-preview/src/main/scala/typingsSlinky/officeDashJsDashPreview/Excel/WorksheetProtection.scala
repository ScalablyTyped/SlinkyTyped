...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.WorksheetProtectionData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.WorksheetProtectionLoadOptions
