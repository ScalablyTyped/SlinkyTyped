...
object CalculationType extends js.Object {
  ...
  /* "Full" */ val full: typingsSlinky.officeDashJsDashPreview.Excel.CalculationType.full with String = js.native
  /* "FullRebuild" */ val fullRebuild: typingsSlinky.officeDashJsDashPreview.Excel.CalculationType.fullRebuild with String = js.native
  /* "Recalculate" */ val recalculate: typingsSlinky.officeDashJsDashPreview.Excel.CalculationType.recalculate with String = js.native
  @JSBracketAccess
