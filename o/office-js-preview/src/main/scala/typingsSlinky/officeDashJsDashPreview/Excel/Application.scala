...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ApplicationData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ApplicationLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ApplicationUpdateData
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.AutomaticExceptTables
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Calculating
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Done
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Full
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.FullRebuild
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Manual
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Pending
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Recalculate
...
class Application () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): Application = js.native
