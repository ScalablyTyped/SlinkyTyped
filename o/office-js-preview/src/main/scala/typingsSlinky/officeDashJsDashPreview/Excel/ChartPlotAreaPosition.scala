...
object ChartPlotAreaPosition extends js.Object {
  ...
  /* "Automatic" */ val automatic: typingsSlinky.officeDashJsDashPreview.Excel.ChartPlotAreaPosition.automatic with String = js.native
  /* "Custom" */ val custom: typingsSlinky.officeDashJsDashPreview.Excel.ChartPlotAreaPosition.custom with String = js.native
  @JSBracketAccess
