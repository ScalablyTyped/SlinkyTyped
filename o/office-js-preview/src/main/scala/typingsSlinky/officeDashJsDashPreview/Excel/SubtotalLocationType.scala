...
object SubtotalLocationType extends js.Object {
  ...
  /* "AtBottom" */ val atBottom: typingsSlinky.officeDashJsDashPreview.Excel.SubtotalLocationType.atBottom with String = js.native
  /* "AtTop" */ val atTop: typingsSlinky.officeDashJsDashPreview.Excel.SubtotalLocationType.atTop with String = js.native
  /* "Off" */ val off: typingsSlinky.officeDashJsDashPreview.Excel.SubtotalLocationType.off with String = js.native
  @JSBracketAccess
