...
import typingsSlinky.officeDashJsDashPreview.Excel.RangeUnderlineStyle
...
trait RangeFontUpdateData extends js.Object {
  ...
  var underline: js.UndefOr[
    RangeUnderlineStyle | None | Single | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | SingleAccountant | DoubleAccountant
  ] = js.undefined
}
...
object RangeFontUpdateData {
  ...
  def apply(
    ...
    underline: RangeUnderlineStyle | None | Single | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | SingleAccountant | DoubleAccountant = null
  ): RangeFontUpdateData = {
