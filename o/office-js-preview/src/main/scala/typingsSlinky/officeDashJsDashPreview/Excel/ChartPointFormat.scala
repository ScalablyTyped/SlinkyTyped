...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartPointFormatData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartPointFormatLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ChartPointFormatUpdateData
