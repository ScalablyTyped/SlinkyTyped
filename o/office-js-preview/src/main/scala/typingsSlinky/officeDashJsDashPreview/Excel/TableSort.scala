...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableSortData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.TableSortLoadOptions
