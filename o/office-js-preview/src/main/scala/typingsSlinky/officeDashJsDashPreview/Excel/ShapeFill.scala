...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ShapeFillData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ShapeFillLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.ShapeFillUpdateData
