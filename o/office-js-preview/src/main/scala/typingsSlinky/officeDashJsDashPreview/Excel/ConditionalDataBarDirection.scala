...
object ConditionalDataBarDirection extends js.Object {
  ...
  /* "Context" */ val context: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalDataBarDirection.context with String = js.native
  /* "LeftToRight" */ val leftToRight: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalDataBarDirection.leftToRight with String = js.native
  /* "RightToLeft" */ val rightToLeft: typingsSlinky.officeDashJsDashPreview.Excel.ConditionalDataBarDirection.rightToLeft with String = js.native
  @JSBracketAccess
