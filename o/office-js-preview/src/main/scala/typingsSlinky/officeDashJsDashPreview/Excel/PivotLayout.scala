...
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotLayoutData
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotLayoutLoadOptions
import typingsSlinky.officeDashJsDashPreview.Excel.Interfaces.PivotLayoutUpdateData
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Column
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Compact
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Data
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Row
...
class PivotLayout () extends ClientObject {
  ...
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Filter, cell: String): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Filter, cell: Range): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
