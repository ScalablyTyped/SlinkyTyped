...
import typingsSlinky.officeDashJsDashPreview.Word.UnderlineType
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DashLine
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DashLineHeavy
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DashLineLong
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DashLineLongHeavy
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DotDashLine
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DotDashLineHeavy
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.DotLine
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Hidden
...
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.TwoDotDashLine
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.TwoDotDashLineHeavy
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Wave
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.WaveDouble
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.WaveHeavy
...
trait FontData extends js.Object {
  ...
  var underline: js.UndefOr[
    UnderlineType | Mixed | None | Hidden | DotLine | Single | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Word | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble
  ] = js.undefined
}
...
object FontData {
  ...
  def apply(
    ...
    underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Word | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = null
  ): FontData = {
