...
object FileContentFormat extends js.Object {
  ...
  /* "Base64" */ val base64: typingsSlinky.officeDashJsDashPreview.Word.FileContentFormat.base64 with String = js.native
  /* "Html" */ val html: typingsSlinky.officeDashJsDashPreview.Word.FileContentFormat.html with String = js.native
  /* "Ooxml" */ val ooxml: typingsSlinky.officeDashJsDashPreview.Word.FileContentFormat.ooxml with String = js.native
  @JSBracketAccess
