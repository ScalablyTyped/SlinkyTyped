...
object LocationRelation extends js.Object {
  ...
  /* "AdjacentAfter" */ val adjacentAfter: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.adjacentAfter with String = js.native
  /* "AdjacentBefore" */ val adjacentBefore: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.adjacentBefore with String = js.native
  /* "After" */ val after: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.after with String = js.native
  /* "Before" */ val before: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.before with String = js.native
  /* "Contains" */ val contains: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.contains with String = js.native
  /* "ContainsEnd" */ val containsEnd: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.containsEnd with String = js.native
  /* "ContainsStart" */ val containsStart: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.containsStart with String = js.native
  /* "Equal" */ val equal: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.equal with String = js.native
  /* "Inside" */ val inside: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.inside with String = js.native
  /* "InsideEnd" */ val insideEnd: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.insideEnd with String = js.native
  /* "InsideStart" */ val insideStart: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.insideStart with String = js.native
  /* "OverlapsAfter" */ val overlapsAfter: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.overlapsAfter with String = js.native
  /* "OverlapsBefore" */ val overlapsBefore: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.overlapsBefore with String = js.native
  /* "Unrelated" */ val unrelated: typingsSlinky.officeDashJsDashPreview.Word.LocationRelation.unrelated with String = js.native
  @JSBracketAccess
