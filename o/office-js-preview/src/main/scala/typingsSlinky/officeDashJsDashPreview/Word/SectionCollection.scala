...
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.SectionCollectionData
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.SectionCollectionLoadOptions
