...
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.FontData
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.FontLoadOptions
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.FontUpdateData
...
class Font () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.1]
    */
  var underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Word | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = js.native
  /**
