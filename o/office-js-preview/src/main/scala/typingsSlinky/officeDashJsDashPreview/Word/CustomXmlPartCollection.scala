...
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.CustomXmlPartCollectionData
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.CustomXmlPartCollectionLoadOptions
