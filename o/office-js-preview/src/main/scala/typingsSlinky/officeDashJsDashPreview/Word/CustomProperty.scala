...
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.CustomPropertyData
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.CustomPropertyLoadOptions
import typingsSlinky.officeDashJsDashPreview.Word.Interfaces.CustomPropertyUpdateData
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: DocumentPropertyType | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.String | Number | Date | Boolean = js.native
  /**
    *
