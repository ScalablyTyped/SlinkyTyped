...
object ListLevelType extends js.Object {
  ...
  /* "Bullet" */ val bullet: typingsSlinky.officeDashJsDashPreview.Word.ListLevelType.bullet with String = js.native
  /* "Number" */ val number: typingsSlinky.officeDashJsDashPreview.Word.ListLevelType.number with String = js.native
  /* "Picture" */ val picture: typingsSlinky.officeDashJsDashPreview.Word.ListLevelType.picture with String = js.native
  @JSBracketAccess
