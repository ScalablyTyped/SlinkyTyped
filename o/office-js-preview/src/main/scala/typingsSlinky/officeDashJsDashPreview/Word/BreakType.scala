...
object BreakType extends js.Object {
  ...
  /* "Line" */ val line: typingsSlinky.officeDashJsDashPreview.Word.BreakType.line with String = js.native
  /* "Next" */ val next: typingsSlinky.officeDashJsDashPreview.Word.BreakType.next with String = js.native
  /* "Page" */ val page: typingsSlinky.officeDashJsDashPreview.Word.BreakType.page with String = js.native
  /* "SectionContinuous" */ val sectionContinuous: typingsSlinky.officeDashJsDashPreview.Word.BreakType.sectionContinuous with String = js.native
  /* "SectionEven" */ val sectionEven: typingsSlinky.officeDashJsDashPreview.Word.BreakType.sectionEven with String = js.native
  /* "SectionNext" */ val sectionNext: typingsSlinky.officeDashJsDashPreview.Word.BreakType.sectionNext with String = js.native
  /* "SectionOdd" */ val sectionOdd: typingsSlinky.officeDashJsDashPreview.Word.BreakType.sectionOdd with String = js.native
  @JSBracketAccess
