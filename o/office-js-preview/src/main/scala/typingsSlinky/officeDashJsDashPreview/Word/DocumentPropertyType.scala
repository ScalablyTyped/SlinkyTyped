...
object DocumentPropertyType extends js.Object {
  ...
  /* "Boolean" */ val boolean: typingsSlinky.officeDashJsDashPreview.Word.DocumentPropertyType.boolean with String = js.native
  /* "Date" */ val date: typingsSlinky.officeDashJsDashPreview.Word.DocumentPropertyType.date with String = js.native
  /* "Number" */ val number: typingsSlinky.officeDashJsDashPreview.Word.DocumentPropertyType.number with String = js.native
  /* "String" */ val string: typingsSlinky.officeDashJsDashPreview.Word.DocumentPropertyType.string with String = js.native
  @JSBracketAccess
