...
object HeaderFooterType extends js.Object {
  ...
  /* "EvenPages" */ val evenPages: typingsSlinky.officeDashJsDashPreview.Word.HeaderFooterType.evenPages with String = js.native
  /* "FirstPage" */ val firstPage: typingsSlinky.officeDashJsDashPreview.Word.HeaderFooterType.firstPage with String = js.native
  /* "Primary" */ val primary: typingsSlinky.officeDashJsDashPreview.Word.HeaderFooterType.primary with String = js.native
  @JSBracketAccess
