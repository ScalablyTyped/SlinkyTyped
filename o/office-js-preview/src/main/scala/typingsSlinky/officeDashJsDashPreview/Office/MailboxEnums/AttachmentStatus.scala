...
object AttachmentStatus extends js.Object {
  ...
  /* "added" */ val Added: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.AttachmentStatus.Added with String = js.native
  /* "removed" */ val Removed: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.AttachmentStatus.Removed with String = js.native
  @JSBracketAccess
