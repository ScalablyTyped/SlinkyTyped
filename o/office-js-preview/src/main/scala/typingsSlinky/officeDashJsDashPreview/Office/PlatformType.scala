...
object PlatformType extends js.Object {
  ...
  /* 4 */ val Android: typingsSlinky.officeDashJsDashPreview.Office.PlatformType.Android with Double = js.native
  /* 2 */ val Mac: typingsSlinky.officeDashJsDashPreview.Office.PlatformType.Mac with Double = js.native
  /* 1 */ val OfficeOnline: typingsSlinky.officeDashJsDashPreview.Office.PlatformType.OfficeOnline with Double = js.native
  /* 0 */ val PC: typingsSlinky.officeDashJsDashPreview.Office.PlatformType.PC with Double = js.native
  /* 5 */ val Universal: typingsSlinky.officeDashJsDashPreview.Office.PlatformType.Universal with Double = js.native
  /* 3 */ val iOS: typingsSlinky.officeDashJsDashPreview.Office.PlatformType.iOS with Double = js.native
  @JSBracketAccess
