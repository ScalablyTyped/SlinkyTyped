...
object HostType extends js.Object {
  ...
  /* 6 */ val Access: typingsSlinky.officeDashJsDashPreview.Office.HostType.Access with Double = js.native
  /* 1 */ val Excel: typingsSlinky.officeDashJsDashPreview.Office.HostType.Excel with Double = js.native
  /* 4 */ val OneNote: typingsSlinky.officeDashJsDashPreview.Office.HostType.OneNote with Double = js.native
  /* 3 */ val Outlook: typingsSlinky.officeDashJsDashPreview.Office.HostType.Outlook with Double = js.native
  /* 2 */ val PowerPoint: typingsSlinky.officeDashJsDashPreview.Office.HostType.PowerPoint with Double = js.native
  /* 5 */ val Project: typingsSlinky.officeDashJsDashPreview.Office.HostType.Project with Double = js.native
  /* 0 */ val Word: typingsSlinky.officeDashJsDashPreview.Office.HostType.Word with Double = js.native
  @JSBracketAccess
