...
trait RecurrenceTimeZone extends js.Object {
  /**
    ...
    */
  var name: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.RecurrenceTimeZone | String
  /**
...
object RecurrenceTimeZone {
  @scala.inline
  def apply(
    name: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.RecurrenceTimeZone | String,
    offset: Double
  ): RecurrenceTimeZone = {
