...
object LocationType extends js.Object {
  ...
  /* "custom" */ val Custom: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.LocationType.Custom with String = js.native
  /* "room" */ val Room: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.LocationType.Room with String = js.native
  @JSBracketAccess
