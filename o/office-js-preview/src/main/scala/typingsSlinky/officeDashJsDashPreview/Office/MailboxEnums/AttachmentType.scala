...
object AttachmentType extends js.Object {
  ...
  /* "cloud" */ val Cloud: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.AttachmentType.Cloud with String = js.native
  /* "file" */ val File: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.AttachmentType.File with String = js.native
  /* "item" */ val Item: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.AttachmentType.Item with String = js.native
  @JSBracketAccess
