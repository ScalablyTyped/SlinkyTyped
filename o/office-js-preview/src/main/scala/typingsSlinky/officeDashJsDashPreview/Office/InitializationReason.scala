...
object InitializationReason extends js.Object {
  ...
  /* 1 */ val DocumentOpened: typingsSlinky.officeDashJsDashPreview.Office.InitializationReason.DocumentOpened with Double = js.native
  /* 0 */ val Inserted: typingsSlinky.officeDashJsDashPreview.Office.InitializationReason.Inserted with Double = js.native
  @JSBracketAccess
