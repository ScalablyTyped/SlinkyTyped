...
import typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.RecipientType
import typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.ResponseType
