...
object BindingType extends js.Object {
  ...
  /* 1 */ val Matrix: typingsSlinky.officeDashJsDashPreview.Office.BindingType.Matrix with Double = js.native
  /* 2 */ val Table: typingsSlinky.officeDashJsDashPreview.Office.BindingType.Table with Double = js.native
  /* 0 */ val Text: typingsSlinky.officeDashJsDashPreview.Office.BindingType.Text with Double = js.native
  @JSBracketAccess
