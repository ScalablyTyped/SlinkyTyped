...
object Index extends js.Object {
  ...
  /* 0 */ val First: typingsSlinky.officeDashJsDashPreview.Office.Index.First with Double = js.native
  /* 1 */ val Last: typingsSlinky.officeDashJsDashPreview.Office.Index.Last with Double = js.native
  /* 2 */ val Next: typingsSlinky.officeDashJsDashPreview.Office.Index.Next with Double = js.native
  /* 3 */ val Previous: typingsSlinky.officeDashJsDashPreview.Office.Index.Previous with Double = js.native
  @JSBracketAccess
