...
object ItemNotificationMessageType extends js.Object {
  ...
  /* "errorMessage" */ val ErrorMessage: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.ItemNotificationMessageType.ErrorMessage with String = js.native
  /* "informationalMessage" */ val InformationalMessage: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.ItemNotificationMessageType.InformationalMessage with String = js.native
  /* "progressIndicator" */ val ProgressIndicator: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.ItemNotificationMessageType.ProgressIndicator with String = js.native
  @JSBracketAccess
