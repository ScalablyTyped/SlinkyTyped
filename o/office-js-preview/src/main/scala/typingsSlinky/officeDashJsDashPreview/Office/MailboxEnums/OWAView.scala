...
object OWAView extends js.Object {
  ...
  /* "OneColumn" */ val OneColumn: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.OWAView.OneColumn with String = js.native
  /* "ThreeColumns" */ val ThreeColumns: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.OWAView.ThreeColumns with String = js.native
  /* "TwoColumns" */ val TwoColumns: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.OWAView.TwoColumns with String = js.native
  @JSBracketAccess
