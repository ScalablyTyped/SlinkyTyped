...
object GoToType extends js.Object {
  ...
  /* 0 */ @js.native
  object Binding
    extends TopLevel[typingsSlinky.officeDashJsDashPreview.Office.GoToType.Binding with Double]
  
  /* 3 */ @js.native
  object Index
    extends TopLevel[typingsSlinky.officeDashJsDashPreview.Office.GoToType.Index with Double]
