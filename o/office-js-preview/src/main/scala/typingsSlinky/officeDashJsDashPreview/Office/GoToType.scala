...
object GoToType extends js.Object {
  ...
  /* 0 */ val Binding: typingsSlinky.officeDashJsDashPreview.Office.GoToType.Binding with Double = js.native
  /* 3 */ val Index: typingsSlinky.officeDashJsDashPreview.Office.GoToType.Index with Double = js.native
  /* 1 */ val NamedItem: typingsSlinky.officeDashJsDashPreview.Office.GoToType.NamedItem with Double = js.native
  /* 2 */ val Slide: typingsSlinky.officeDashJsDashPreview.Office.GoToType.Slide with Double = js.native
  @JSBracketAccess
