...
object SourceProperty extends js.Object {
  ...
  /* 0 */ val Body: typingsSlinky.officeDashJsDashPreview.Office.SourceProperty.Body with Double = js.native
  /* 1 */ val Subject: typingsSlinky.officeDashJsDashPreview.Office.SourceProperty.Subject with Double = js.native
  @JSBracketAccess
