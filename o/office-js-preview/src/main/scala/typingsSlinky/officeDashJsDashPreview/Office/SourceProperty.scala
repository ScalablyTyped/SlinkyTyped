...
object SourceProperty extends js.Object {
  ...
  /* 0 */ @js.native
  object Body
    extends TopLevel[typingsSlinky.officeDashJsDashPreview.Office.SourceProperty.Body with Double]
  
  /* 1 */ @js.native
  object Subject
    extends TopLevel[typingsSlinky.officeDashJsDashPreview.Office.SourceProperty.Subject with Double]
