...
import typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.OWAView
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.OneColumn
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.ThreeColumns
import typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.TwoColumns
...
trait Diagnostics extends js.Object {
  /**
    ...
    * **{@link https://docs.microsoft.com/outlook/add-ins/#extension-points | Applicable Outlook mode}**: Compose or Read
    */
  var OWAView: typingsSlinky.officeDashJsDashPreview.Office.MailboxEnums.OWAView | OneColumn | TwoColumns | ThreeColumns
  /**
