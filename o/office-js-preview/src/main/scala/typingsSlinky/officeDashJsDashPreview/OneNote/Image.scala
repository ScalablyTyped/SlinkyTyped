...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ImageData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ImageLoadOptions
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ImageUpdateData
