...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.NotebookData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.NotebookLoadOptions
...
class Notebook () extends ClientObject {
  ...
  def load(option: Anon_Expand): Notebook = js.native
