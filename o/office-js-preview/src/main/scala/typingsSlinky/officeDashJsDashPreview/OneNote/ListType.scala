...
object ListType extends js.Object {
  ...
  /* "Bullet" */ val bullet: typingsSlinky.officeDashJsDashPreview.OneNote.ListType.bullet with String = js.native
  /* "None" */ val none: typingsSlinky.officeDashJsDashPreview.OneNote.ListType.none with String = js.native
  /* "Number" */ val number: typingsSlinky.officeDashJsDashPreview.OneNote.ListType.number with String = js.native
  @JSBracketAccess
