...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.PageContentData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.PageContentLoadOptions
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.PageContentUpdateData
...
class PageContent () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Outline | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Image | Ink | Other = js.native
  /**
    *
