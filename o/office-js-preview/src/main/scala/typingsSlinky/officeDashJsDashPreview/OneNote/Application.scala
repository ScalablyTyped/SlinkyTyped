...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ApplicationData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ApplicationLoadOptions
