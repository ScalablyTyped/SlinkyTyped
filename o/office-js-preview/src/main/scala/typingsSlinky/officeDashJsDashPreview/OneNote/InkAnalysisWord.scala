...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.InkAnalysisWordData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.InkAnalysisWordLoadOptions
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.InkAnalysisWordUpdateData
...
class InkAnalysisWord () extends ClientObject {
  ...
  def load(option: Anon_Expand): InkAnalysisWord = js.native
