...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.TableData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.TableLoadOptions
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.TableUpdateData
