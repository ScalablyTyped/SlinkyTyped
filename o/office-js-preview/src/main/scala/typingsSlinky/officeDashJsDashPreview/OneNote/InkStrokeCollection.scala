...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.InkStrokeCollectionData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.InkStrokeCollectionLoadOptions
