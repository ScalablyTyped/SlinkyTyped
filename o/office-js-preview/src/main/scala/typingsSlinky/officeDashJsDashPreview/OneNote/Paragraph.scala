...
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ParagraphData
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ParagraphLoadOptions
import typingsSlinky.officeDashJsDashPreview.OneNote.Interfaces.ParagraphUpdateData
...
class Paragraph () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: ParagraphType | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.RichText | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Image | typingsSlinky.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Table | Ink | Other = js.native
  def addNoteTag(
