...
import typingsSlinky.oauth.oauthMod.OAuth
import typingsSlinky.oauth.oauthMod.dataCallback
import typingsSlinky.oauth.oauthMod.oauth1tokenCallback
import typingsSlinky.oauth.oauthMod.oauth2tokenCallback
