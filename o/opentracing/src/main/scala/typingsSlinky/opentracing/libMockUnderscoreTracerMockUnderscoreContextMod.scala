...
import typingsSlinky.opentracing.libMockUnderscoreTracerMockUnderscoreContextMod.MockContext
...
object libMockUnderscoreTracerMockUnderscoreContextMod extends js.Object {
  ...
  class MockContext protected () extends SpanContext {
    ...
    def span(): typingsSlinky.opentracing.libMockUnderscoreTracerMockUnderscoreSpanMod.default = js.native
  }
