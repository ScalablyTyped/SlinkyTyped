...
object tracerMod {
  ...
  class Tracer () extends StObject {
    ...
    /* protected */ def _extract(format: String, carrier: js.Any): typingsSlinky.opentracing.spanContextMod.default | Null = js.native
    
    /* protected */ def _inject(spanContext: typingsSlinky.opentracing.spanContextMod.default, format: String, carrier: js.Any): Unit = js.native
    
    /* protected */ def _startSpan(name: String, fields: SpanOptions): typingsSlinky.opentracing.spanMod.default = js.native
    ...
    /**
      ...
      *         be found in `carrier`
      */
    def extract(format: String, carrier: js.Any): typingsSlinky.opentracing.spanContextMod.default | Null = js.native
    ...
    /**
      ...
      */
    def inject(spanContext: typingsSlinky.opentracing.spanContextMod.default, format: String, carrier: js.Any): Unit = js.native
    def inject(spanContext: typingsSlinky.opentracing.spanMod.default, format: String, carrier: js.Any): Unit = js.native
    ...
    /**
      ...
      */
    def startSpan(name: String): typingsSlinky.opentracing.spanMod.default = js.native
    def startSpan(name: String, options: SpanOptions): typingsSlinky.opentracing.spanMod.default = js.native
  }
  ...
  object SpanOptions {
    ...
    implicit class SpanOptionsMutableBuilder[Self <: SpanOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReferences(value: js.Array[typingsSlinky.opentracing.referenceMod.default]): Self = StObject.set(x, "references", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setReferencesUndefined: Self = StObject.set(x, "references", js.undefined)
      
      @scala.inline
      def setReferencesVarargs(value: typingsSlinky.opentracing.referenceMod.default*): Self = StObject.set(x, "references", js.Array(value :_*))
