package typingsSlinky.opentracing.libMockUnderscoreTracerMockUnderscoreSpanMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.opentracing.libSpanMod.Span
...
class MockSpan protected () extends Span {
  ...
  def addReference(ref: typingsSlinky.opentracing.libReferenceMod.default): Unit = js.native
  /**
