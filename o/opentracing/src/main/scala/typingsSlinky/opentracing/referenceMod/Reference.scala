package typingsSlinky.opentracing.referenceMod
...
object Reference {
  ...
  implicit class ReferenceOps[Self <: Reference] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_referencedContext(value: typingsSlinky.opentracing.spanContextMod.default): Self = this.set("_referencedContext", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_type(value: String): Self = this.set("_type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReferencedContext(value: () => typingsSlinky.opentracing.spanContextMod.default): Self = this.set("referencedContext", js.Any.fromFunction0(value))
