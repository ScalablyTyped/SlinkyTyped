...
trait SpanOptions extends js.Object {
  ...
  /**
    ...
    */
  var references: js.UndefOr[js.Array[typingsSlinky.opentracing.referenceMod.default]] = js.undefined
  /**
...
object SpanOptions {
  @scala.inline
  def apply(
    childOf: typingsSlinky.opentracing.spanMod.default | typingsSlinky.opentracing.spanContextMod.default = null,
    references: js.Array[typingsSlinky.opentracing.referenceMod.default] = null,
