...
object SpanOptions {
  ...
  implicit class SpanOptionsOps[Self <: SpanOptions] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("childOf", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteChildOf: Self = this.set("childOf", js.undefined)
    @scala.inline
    def setReferencesVarargs(value: typingsSlinky.opentracing.referenceMod.default*): Self = this.set("references", js.Array(value :_*))
    @scala.inline
    def setReferences(value: js.Array[typingsSlinky.opentracing.referenceMod.default]): Self = this.set("references", value.asInstanceOf[js.Any])
    @scala.inline
