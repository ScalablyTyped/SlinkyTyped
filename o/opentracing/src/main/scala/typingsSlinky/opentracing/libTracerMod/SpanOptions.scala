package typingsSlinky.opentracing.libTracerMod
...
trait SpanOptions extends js.Object {
  ...
  var childOf: js.UndefOr[
    typingsSlinky.opentracing.libSpanMod.default | typingsSlinky.opentracing.libSpanUnderscoreContextMod.default
  ] = js.undefined
  /**
    ...
    */
  var references: js.UndefOr[js.Array[typingsSlinky.opentracing.libReferenceMod.default]] = js.undefined
  /**
...
object SpanOptions {
  @scala.inline
  def apply(
    childOf: typingsSlinky.opentracing.libSpanMod.default | typingsSlinky.opentracing.libSpanUnderscoreContextMod.default = null,
    references: js.Array[typingsSlinky.opentracing.libReferenceMod.default] = null,
