...
import typingsSlinky.opentracing.libMockUnderscoreTracerMockUnderscoreTracerMod.MockTracer
import typingsSlinky.opentracing.libTracerMod.Tracer
...
object libMockUnderscoreTracerMockUnderscoreTracerMod extends js.Object {
  ...
  class MockTracer () extends Tracer {
    ...
    /* protected */ def _inject(
      span: typingsSlinky.opentracing.libMockUnderscoreTracerMockUnderscoreContextMod.default,
      format: js.Any,
      carrier: js.Any
    ...
    /**
      ...
      * assertions.
      */
    def report(): typingsSlinky.opentracing.libMockUnderscoreTracerMockUnderscoreReportMod.default = js.native
  }
