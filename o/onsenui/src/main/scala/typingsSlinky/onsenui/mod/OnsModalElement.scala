...
trait OnsModalElement extends HTMLElement {
  ...
  def hide(options: ModalOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  ...
  def show(options: ModalOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def toggle(): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def toggle(options: ModalOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
