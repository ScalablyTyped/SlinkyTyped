...
trait OnsCarouselElement extends HTMLElement {
  ...
  /**
    ...
    */
  def first(): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def last(): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  
  /**
    * @description Show next ons-carousel item
    * @return Resolves to the carousel element
    */
  def next(): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def next(options: CarouselOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  ...
  /**
    ...
    * @return Resolves to the carousel element
    */
  def prev(): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def prev(options: CarouselOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  ...
  /**
    ...
    * @return Resolves to the carousel element.
    */
  def setActiveIndex(index: Double): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def setActiveIndex(index: Double, options: CarouselOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
