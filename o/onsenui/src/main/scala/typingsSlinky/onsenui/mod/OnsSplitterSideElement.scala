...
trait OnsSplitterSideElement extends HTMLElement {
  ...
  /**
    ...
    */
  def close(): js.Promise[org.scalajs.dom.raw.HTMLElement | Boolean] = js.native
  def close(options: SplitterSideOptions): js.Promise[org.scalajs.dom.raw.HTMLElement | Boolean] = js.native
  /**
  ...
  def load(page: js.Any, options: SplitterSideOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
    * @description Open menu in collapse mode.
    * @return Resolves to the splitter side element or false if not in collapse mode
    */
  def open(): js.Promise[org.scalajs.dom.raw.HTMLElement | Boolean] = js.native
  def open(options: SplitterSideOptions): js.Promise[org.scalajs.dom.raw.HTMLElement | Boolean] = js.native
  /**
    * @description Opens if it's closed. Closes if it's open.
    * @param {Object} [options]
    * @return Resolves to the splitter side element or false if not in collapse mode
    */
  def toggle(): js.Promise[org.scalajs.dom.raw.HTMLElement | Boolean] = js.native
  def toggle(options: SplitterSideOptions): js.Promise[org.scalajs.dom.raw.HTMLElement | Boolean] = js.native
}
