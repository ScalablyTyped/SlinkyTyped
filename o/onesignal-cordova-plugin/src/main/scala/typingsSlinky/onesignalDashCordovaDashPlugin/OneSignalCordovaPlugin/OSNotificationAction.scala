...
import typingsSlinky.onesignalDashCordovaDashPlugin.onesignalDashCordovaDashPluginStrings.ActionTaken
import typingsSlinky.onesignalDashCordovaDashPlugin.onesignalDashCordovaDashPluginStrings.Opened
