package typingsSlinky.onesignalDashCordovaDashPlugin.OneSignalCordovaPlugin

import typingsSlinky.onesignalDashCordovaDashPlugin.Anon_KOSSettingsKeyAutoPrompt
...
trait OneSignalBuilder extends js.Object {
  ...
  def iOSSettings(settings: Anon_KOSSettingsKeyAutoPrompt): OneSignalBuilder
...
object OneSignalBuilder {
  ...
  def apply(
    ...
    iOSSettings: Anon_KOSSettingsKeyAutoPrompt => OneSignalBuilder,
