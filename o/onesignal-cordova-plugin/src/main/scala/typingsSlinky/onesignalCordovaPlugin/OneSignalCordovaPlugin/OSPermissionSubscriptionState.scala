...
object OSPermissionSubscriptionState {
  ...
  implicit class OSPermissionSubscriptionStateOps[Self <: OSPermissionSubscriptionState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEmailSubscriptionStatus(value: OSEmailSubscriptionState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("emailSubscriptionStatus")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissionStatus(value: OSPermissionState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("permissionStatus")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSubscriptionStatus(value: OSSubscriptionState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subscriptionStatus")(value.asInstanceOf[js.Any])
        ret
    }
  }
