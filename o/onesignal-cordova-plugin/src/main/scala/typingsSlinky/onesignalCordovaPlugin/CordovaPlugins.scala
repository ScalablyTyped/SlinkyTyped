...
object CordovaPlugins {
  ...
  implicit class CordovaPluginsOps[Self <: CordovaPlugins] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOneSignal(value: typingsSlinky.onesignalCordovaPlugin.OneSignalCordovaPlugin.OneSignalCordovaPlugin): Self = this.set("OneSignal", value.asInstanceOf[js.Any])
  }
