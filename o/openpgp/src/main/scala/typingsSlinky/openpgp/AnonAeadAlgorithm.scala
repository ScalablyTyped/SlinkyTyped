...
object AnonAeadAlgorithm {
  @scala.inline
  def apply(aeadAlgorithm: String, algorithm: String, data: js.typedarray.Uint8Array): AnonAeadAlgorithm = {
  ...
  @scala.inline
  implicit class AnonAeadAlgorithmOps[Self <: AnonAeadAlgorithm] (val x: Self) extends AnyVal {
    @scala.inline
