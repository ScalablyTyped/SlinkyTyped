...
object webHash extends StObject {
  ...
  /* 2 */ val `SHA-1`: typingsSlinky.openpgp.mod.enums.webHash.`SHA-1` with Double = js.native
  
  @js.native
  sealed trait `SHA-256` extends webHash
  /* 8 */ val `SHA-256`: typingsSlinky.openpgp.mod.enums.webHash.`SHA-256` with Double = js.native
  
  @js.native
  sealed trait `SHA-384` extends webHash
  /* 9 */ val `SHA-384`: typingsSlinky.openpgp.mod.enums.webHash.`SHA-384` with Double = js.native
  
  @js.native
  sealed trait `SHA-512` extends webHash
  /* 10 */ val `SHA-512`: typingsSlinky.openpgp.mod.enums.webHash.`SHA-512` with Double = js.native
}
