...
object reasonForRevocation extends StObject {
  ...
  /* 2 */ val key_comPromised: typingsSlinky.openpgp.mod.enums.reasonForRevocation.key_comPromised with Double = js.native
  ...
  /* 3 */ val key_retired: typingsSlinky.openpgp.mod.enums.reasonForRevocation.key_retired with Double = js.native
  ...
  /* 1 */ val key_superseded: typingsSlinky.openpgp.mod.enums.reasonForRevocation.key_superseded with Double = js.native
  ...
  /* 0 */ val no_reason: typingsSlinky.openpgp.mod.enums.reasonForRevocation.no_reason with Double = js.native
  ...
  /* 32 */ val userid_invalid: typingsSlinky.openpgp.mod.enums.reasonForRevocation.userid_invalid with Double = js.native
}
