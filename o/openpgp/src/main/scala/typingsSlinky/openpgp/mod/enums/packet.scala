...
object packet extends js.Object {
  ...
  /* 11 */ @js.native
  object literal
    extends TopLevel[typingsSlinky.openpgp.mod.enums.packet.literal with Double]
  ...
  /* 6 */ @js.native
  object publicKey
    extends TopLevel[typingsSlinky.openpgp.mod.enums.packet.publicKey with Double]
  ...
  /* 2 */ @js.native
  object signature
    extends TopLevel[typingsSlinky.openpgp.mod.enums.packet.signature with Double]
