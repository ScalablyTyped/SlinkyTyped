...
object aead extends StObject {
  ...
  /* 1 */ val eax: typingsSlinky.openpgp.mod.enums.aead.eax with Double = js.native
  
  @js.native
  sealed trait experimental_gcm extends aead
  /* 100 */ val experimental_gcm: typingsSlinky.openpgp.mod.enums.aead.experimental_gcm with Double = js.native
  
  @js.native
  sealed trait ocb extends aead
  /* 2 */ val ocb: typingsSlinky.openpgp.mod.enums.aead.ocb with Double = js.native
}
