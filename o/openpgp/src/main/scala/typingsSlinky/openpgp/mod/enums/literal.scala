...
object literal extends StObject {
  ...
  /* "" */ val binary: typingsSlinky.openpgp.mod.enums.literal.binary with String = js.native
  ...
  /* "" */ val mime: typingsSlinky.openpgp.mod.enums.literal.mime with String = js.native
  ...
  /* "" */ val text: typingsSlinky.openpgp.mod.enums.literal.text with String = js.native
  ...
  /* "" */ val utf8: typingsSlinky.openpgp.mod.enums.literal.utf8 with String = js.native
}
