...
object compression extends StObject {
  ...
  /* 3 */ val bzip2: typingsSlinky.openpgp.mod.enums.compression.bzip2 with Double = js.native
  
  @js.native
  sealed trait uncompressed extends compression
  /* 0 */ val uncompressed: typingsSlinky.openpgp.mod.enums.compression.uncompressed with Double = js.native
  ...
  /* 1 */ val zip: typingsSlinky.openpgp.mod.enums.compression.zip with Double = js.native
  ...
  /* 2 */ val zlib: typingsSlinky.openpgp.mod.enums.compression.zlib with Double = js.native
}
