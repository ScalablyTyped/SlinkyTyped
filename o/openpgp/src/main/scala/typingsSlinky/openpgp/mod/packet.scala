...
object packet {
  ...
  class Signature protected () extends StObject {
    ...
    def verify(key: PublicKey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: PublicKey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
    /**
      ...
      */
    def verify(key: PublicSubkey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: PublicSubkey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
    def verify(key: SecretKey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: SecretKey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
    def verify(key: SecretSubkey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: SecretSubkey, signatureType: typingsSlinky.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
  ...
  class SymEncryptedAEADProtected () extends StObject {
    ...
    @JSName("crypt")
    def crypt_decrypt(
      fn: typingsSlinky.openpgp.openpgpStrings.decrypt,
    ...
    @JSName("crypt")
    def crypt_encrypt(
      fn: typingsSlinky.openpgp.openpgpStrings.encrypt,
      key: js.typedarray.Uint8Array,
      data: js.typedarray.Uint8Array,
      streaming: Boolean
    ): js.typedarray.Uint8Array | ReadableStream[js.typedarray.Uint8Array] = js.native
