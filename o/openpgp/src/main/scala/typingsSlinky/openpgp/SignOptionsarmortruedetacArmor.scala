...
object SignOptionsarmortruedetacArmor {
  @scala.inline
  def apply(message: CleartextMessage | Message, privateKeys: Key | js.Array[_]): SignOptionsarmortruedetacArmor = {
  ...
  @scala.inline
  implicit class SignOptionsarmortruedetacArmorOps[Self <: SignOptionsarmortruedetacArmor] (val x: Self) extends AnyVal {
    @scala.inline
