...
object SignOptionsarmortruedetac {
  @scala.inline
  def apply(message: CleartextMessage | Message, privateKeys: Key | js.Array[_]): SignOptionsarmortruedetac = {
  ...
  @scala.inline
  implicit class SignOptionsarmortruedetacOps[Self <: SignOptionsarmortruedetac] (val x: Self) extends AnyVal {
    @scala.inline
