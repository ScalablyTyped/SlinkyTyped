...
import typingsSlinky.openpgp.mod.enums.curve
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object openpgpStrings {
  @js.native
  ...
  @js.native
  sealed trait encrypt_sign extends js.Object
  ...
  @js.native
  sealed trait p251 extends curve
  ...
  @scala.inline
  def aead: aead = "aead".asInstanceOf[aead]
  @scala.inline
  def binary: binary = "binary".asInstanceOf[binary]
  @scala.inline
  def brainpoolP256r1: brainpoolP256r1 = "brainpoolP256r1".asInstanceOf[brainpoolP256r1]
  @scala.inline
  def brainpoolP384r1: brainpoolP384r1 = "brainpoolP384r1".asInstanceOf[brainpoolP384r1]
  @scala.inline
  def brainpoolP512r1: brainpoolP512r1 = "brainpoolP512r1".asInstanceOf[brainpoolP512r1]
  @scala.inline
  ...
  @scala.inline
  def encrypt_sign: encrypt_sign = "encrypt_sign".asInstanceOf[encrypt_sign]
  @scala.inline
  def mime: mime = "mime".asInstanceOf[mime]
  @scala.inline
  def node: node = "node".asInstanceOf[node]
  @scala.inline
  def p251: p251 = "p251".asInstanceOf[p251]
  @scala.inline
  def p256: p256 = "p256".asInstanceOf[p256]
  @scala.inline
