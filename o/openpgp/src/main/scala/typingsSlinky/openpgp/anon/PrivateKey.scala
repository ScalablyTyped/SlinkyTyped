...
object PrivateKey {
  ...
  implicit class PrivateKeyOps[Self <: PrivateKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrivateKey(value: typingsSlinky.openpgp.mod.key.Key): Self = this.set("privateKey", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrivateKeyArmored(value: String): Self = this.set("privateKeyArmored", value.asInstanceOf[js.Any])
    @scala.inline
    def setPublicKey(value: typingsSlinky.openpgp.mod.key.Key): Self = this.set("publicKey", value.asInstanceOf[js.Any])
    @scala.inline
