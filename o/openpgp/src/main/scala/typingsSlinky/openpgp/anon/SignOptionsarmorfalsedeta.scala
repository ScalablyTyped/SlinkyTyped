...
trait SignOptionsarmorfalsedeta extends js.Object {
  ...
  /**
    ...
    */
  var detached: js.UndefOr[Boolean with `false`] = js.native
  /**
...
object SignOptionsarmorfalsedeta {
  ...
  @scala.inline
  implicit class SignOptionsarmorfalsedetaOps[Self <: SignOptionsarmorfalsedeta] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withMessage(value: CleartextMessage | typingsSlinky.openpgp.mod.message.Message): Self = {
    ...
    @scala.inline
    def withDetached(value: Boolean with `false`): Self = {
        val ret = this.duplicate
