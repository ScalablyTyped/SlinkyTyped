...
object DecryptOptionsformatutf8 {
  ...
  @scala.inline
  def apply(format: (js.UndefOr[utf8 | binary]) with utf8, message: typingsSlinky.openpgp.mod.message.Message): DecryptOptionsformatutf8 = {
  ...
  implicit class DecryptOptionsformatutf8MutableBuilder[Self <: DecryptOptionsformatutf8] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrivateKeys(value: typingsSlinky.openpgp.mod.key.Key | js.Array[typingsSlinky.openpgp.mod.key.Key]): Self = StObject.set(x, "privateKeys", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPrivateKeysUndefined: Self = StObject.set(x, "privateKeys", js.undefined)
    
    @scala.inline
    def setPrivateKeysVarargs(value: typingsSlinky.openpgp.mod.key.Key*): Self = StObject.set(x, "privateKeys", js.Array(value :_*))
    
    @scala.inline
    def setPublicKeys(value: typingsSlinky.openpgp.mod.key.Key | js.Array[typingsSlinky.openpgp.mod.key.Key]): Self = StObject.set(x, "publicKeys", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPublicKeysUndefined: Self = StObject.set(x, "publicKeys", js.undefined)
    
    @scala.inline
    def setPublicKeysVarargs(value: typingsSlinky.openpgp.mod.key.Key*): Self = StObject.set(x, "publicKeys", js.Array(value :_*))
