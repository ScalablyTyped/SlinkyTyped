...
object DecryptOptionsformatutf8 {
  @scala.inline
  def apply(message: typingsSlinky.openpgp.mod.message.Message): DecryptOptionsformatutf8 = {
  ...
  implicit class DecryptOptionsformatutf8Ops[Self <: DecryptOptionsformatutf8] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPrivateKeys(value: typingsSlinky.openpgp.mod.key.Key | js.Array[typingsSlinky.openpgp.mod.key.Key]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPublicKeys(value: typingsSlinky.openpgp.mod.key.Key | js.Array[typingsSlinky.openpgp.mod.key.Key]): Self = {
        val ret = this.duplicate
