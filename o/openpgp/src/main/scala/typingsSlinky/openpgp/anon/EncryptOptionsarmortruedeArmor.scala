...
trait EncryptOptionsarmortruedeArmor extends js.Object {
  ...
  /**
    ...
    */
  var compression: js.UndefOr[typingsSlinky.openpgp.mod.enums.compression] = js.undefined
  /**
  ...
  /**
    ...
    */
  var privateKeys: js.UndefOr[typingsSlinky.openpgp.mod.key.Key | js.Array[_]] = js.undefined
  /**
    * (optional) array of keys or single key, used to encrypt the message
    */
  var publicKeys: js.UndefOr[typingsSlinky.openpgp.mod.key.Key | js.Array[_]] = js.undefined
  /**
...
object EncryptOptionsarmortruedeArmor {
  ...
  def apply(
    ...
    privateKeys: typingsSlinky.openpgp.mod.key.Key | js.Array[_] = null,
    publicKeys: typingsSlinky.openpgp.mod.key.Key | js.Array[_] = null,
  ...
  ): EncryptOptionsarmortruedeArmor = {
