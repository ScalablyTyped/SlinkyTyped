...
/* Inlined openpgp.openpgp.EncryptOptions & {  armor ? :true,   detached  :true} */
@js.native
trait EncryptOptionsarmortruedeArmor extends js.Object {
  /**
    * (optional) if the return values should be ascii armored or the message/signature objects
    */
  var armor: js.UndefOr[Boolean with `true`] = js.native
  /**
...
object EncryptOptionsarmortruedeArmor {
  @scala.inline
  def apply(message: typingsSlinky.openpgp.mod.message.Message): EncryptOptionsarmortruedeArmor = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[EncryptOptionsarmortruedeArmor]
  }
  @scala.inline
  implicit class EncryptOptionsarmortruedeArmorOps[Self <: EncryptOptionsarmortruedeArmor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withArmor(value: Boolean with `true`): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPrivateKeys(value: typingsSlinky.openpgp.mod.key.Key | js.Array[_]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPublicKeys(value: typingsSlinky.openpgp.mod.key.Key | js.Array[_]): Self = {
        val ret = this.duplicate
