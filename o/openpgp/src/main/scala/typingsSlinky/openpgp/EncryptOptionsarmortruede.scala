...
object EncryptOptionsarmortruede {
  @scala.inline
  def apply(message: Message): EncryptOptionsarmortruede = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[EncryptOptionsarmortruede]
  }
  @scala.inline
  implicit class EncryptOptionsarmortruedeOps[Self <: EncryptOptionsarmortruede] (val x: Self) extends AnyVal {
    @scala.inline
