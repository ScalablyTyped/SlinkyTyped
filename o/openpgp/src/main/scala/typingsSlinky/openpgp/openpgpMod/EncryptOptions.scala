...
trait EncryptOptions extends js.Object {
  ...
  /**
    ...
    */
  var compression: js.UndefOr[typingsSlinky.openpgp.openpgpMod.enums.compression] = js.undefined
  /**
  ...
  /**
    ...
    */
  var sessionKey: js.UndefOr[Anon_Algorithm] = js.undefined
  /**
...
object EncryptOptions {
  ...
  def apply(
    ...
    sessionKey: Anon_Algorithm = null,
