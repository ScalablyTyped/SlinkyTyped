...
object message extends js.Object {
  ...
  class Message protected () extends js.Object {
    ...
    /**
      ...
      */
    def decryptSessionKeys(): js.Promise[js.Array[Anon_Algorithm]] = js.native
    def decryptSessionKeys(privateKeys: js.Array[_]): js.Promise[js.Array[Anon_Algorithm]] = js.native
    def decryptSessionKeys(privateKeys: js.Array[_], passwords: js.Array[_]): js.Promise[js.Array[Anon_Algorithm]] = js.native
    /**
    ...
    /**
      ...
      */
    def verify(keys: js.Array[_]): js.Promise[js.Array[Anon_Keyid]] = js.native
    def verify(keys: js.Array[_], date: js.Date): js.Promise[js.Array[Anon_Keyid]] = js.native
    def verify(keys: js.Array[_], date: js.Date, streaming: Boolean): js.Promise[js.Array[Anon_Keyid]] = js.native
    /**
      ...
      * @returns list of signer's keyid and validity of signature
      */
    def verifyDetached(keys: js.Array[_], signature: Signature): js.Promise[js.Array[Anon_Keyid]] = js.native
    def verifyDetached(keys: js.Array[_], signature: Signature, date: js.Date): js.Promise[js.Array[Anon_Keyid]] = js.native
  }
  ...
  def createVerificationObject(
    signature: typingsSlinky.openpgp.openpgpMod.packet.Signature,
    literalDataList: js.Array[_],
    keys: js.Array[_],
    date: js.Date
  ): js.Promise[js.Array[Anon_Keyid]] = js.native
  /**
    ...
    * @returns list of signer's keyid and validity of signature
    */
  def createVerificationObjects(signatureList: js.Array[_], literalDataList: js.Array[_], keys: js.Array[_], date: js.Date): js.Promise[js.Array[Anon_Keyid]] = js.native
  /**
