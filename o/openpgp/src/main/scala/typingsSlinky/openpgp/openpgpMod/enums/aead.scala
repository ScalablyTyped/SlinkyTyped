...
object aead extends js.Object {
  ...
  /* 1 */ val eax: typingsSlinky.openpgp.openpgpMod.enums.aead.eax with Double = js.native
  /* 100 */ val experimental_gcm: typingsSlinky.openpgp.openpgpMod.enums.aead.experimental_gcm with Double = js.native
  /* 2 */ val ocb: typingsSlinky.openpgp.openpgpMod.enums.aead.ocb with Double = js.native
  @JSBracketAccess
