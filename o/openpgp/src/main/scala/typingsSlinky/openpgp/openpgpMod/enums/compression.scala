...
object compression extends js.Object {
  ...
  /* 3 */ val bzip2: typingsSlinky.openpgp.openpgpMod.enums.compression.bzip2 with Double = js.native
  /* 0 */ val uncompressed: typingsSlinky.openpgp.openpgpMod.enums.compression.uncompressed with Double = js.native
  /* 1 */ val zip: typingsSlinky.openpgp.openpgpMod.enums.compression.zip with Double = js.native
  /* 2 */ val zlib: typingsSlinky.openpgp.openpgpMod.enums.compression.zlib with Double = js.native
  @JSBracketAccess
