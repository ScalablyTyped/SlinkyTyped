...
import typingsSlinky.openpgp.Anon_KeyidUserid
import typingsSlinky.openpgp.Anon_SelfCertification
import typingsSlinky.openpgp.openpgpMod.Infinity
import typingsSlinky.openpgp.openpgpMod.`type`.keyid.Keyid
import typingsSlinky.openpgp.openpgpMod.enums.keyStatus
import typingsSlinky.openpgp.openpgpMod.packet.List
import typingsSlinky.openpgp.openpgpMod.packet.PublicKey
import typingsSlinky.openpgp.openpgpMod.packet.PublicSubkey
import typingsSlinky.openpgp.openpgpMod.packet.SecretKey
import typingsSlinky.openpgp.openpgpMod.packet.SecretSubkey
import typingsSlinky.openpgp.openpgpMod.packet.Signature
import typingsSlinky.openpgp.openpgpMod.revoke_reasonForRevocation
...
class Key protected () extends js.Object {
  ...
  /**
    ...
    */
  def getEncryptionKey(): js.Promise[Key | typingsSlinky.openpgp.openpgpMod.key.SubKey | Null] = js.native
  def getEncryptionKey(keyId: Keyid): js.Promise[Key | typingsSlinky.openpgp.openpgpMod.key.SubKey | Null] = js.native
  def getEncryptionKey(keyId: Keyid, date: js.Date): js.Promise[Key | typingsSlinky.openpgp.openpgpMod.key.SubKey | Null] = js.native
  def getEncryptionKey(keyId: Keyid, date: js.Date, userId: String): js.Promise[Key | typingsSlinky.openpgp.openpgpMod.key.SubKey | Null] = js.native
  /**
  ...
  def getExpirationTime(capabilities: js.Any): js.Promise[js.Date | Infinity | Null] = js.native
  def getExpirationTime(capabilities: js.Any, keyId: Keyid): js.Promise[js.Date | Infinity | Null] = js.native
  def getExpirationTime(capabilities: js.Any, keyId: Keyid, userId: js.Object): js.Promise[js.Date | Infinity | Null] = js.native
  /**
  ...
  def getPrimaryUser(date: js.Date): js.Promise[Anon_SelfCertification] = js.native
  def getPrimaryUser(date: js.Date, userId: js.Object): js.Promise[Anon_SelfCertification] = js.native
  /**
  ...
  /**
    ...
    */
  def getSigningKey(keyId: Keyid): js.Promise[Key | typingsSlinky.openpgp.openpgpMod.key.SubKey | Null] = js.native
  def getSigningKey(keyId: Keyid, date: js.Date): js.Promise[Key | typingsSlinky.openpgp.openpgpMod.key.SubKey | Null] = js.native
  def getSigningKey(keyId: Keyid, date: js.Date, userId: js.Object): js.Promise[Key | typingsSlinky.openpgp.openpgpMod.key.SubKey | Null] = js.native
  /**
  ...
  /**
    ...
    */
  def revoke(reasonForRevocation: revoke_reasonForRevocation, date: js.Date): js.Promise[Key] = js.native
  /**
  ...
  /**
    ...
    */
  def verifyPrimaryUser(keys: js.Array[_], date: js.Date, userId: js.Object): js.Promise[js.Array[Anon_Keyid]] = js.native
}
