...
object hash extends js.Object {
  ...
  /**
    ...
    * @returns hash value
    */
  def digest(algo: typingsSlinky.openpgp.openpgpMod.enums.hash, data: scala.scalajs.js.typedarray.Uint8Array): js.Promise[scala.scalajs.js.typedarray.Uint8Array] = js.native
  /**
    * Returns the hash size in bytes of the specified hash algorithm type
    * @param algo Hash algorithm type (See {@link https://tools.ietf.org/html/rfc4880#section-9.4|RFC 4880 9.4})
    * @returns Size in bytes of the resulting hash
    */
  def getHashByteLength(algo: typingsSlinky.openpgp.openpgpMod.enums.hash): Integer = js.native
}
