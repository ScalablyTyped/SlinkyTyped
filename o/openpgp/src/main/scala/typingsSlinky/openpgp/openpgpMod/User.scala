...
class User () extends js.Object {
  ...
  /**
    ...
    * @returns
    */
  def update(user: typingsSlinky.openpgp.openpgpMod.key.User, primaryKey: SecretKey): js.Promise[js.UndefOr[scala.Nothing]] = js.native
  def update(user: typingsSlinky.openpgp.openpgpMod.key.User, primaryKey: SecretSubkey): js.Promise[js.UndefOr[scala.Nothing]] = js.native
  ...
  def verifyAllCertifications(primaryKey: PublicKey, keys: js.Array[_], date: js.Date): js.Promise[js.Array[Anon_Keyid]] = js.native
  /**
    ...
    */
  def verifyAllCertifications(primaryKey: SecretKey, keys: js.Array[_], date: js.Date): js.Promise[js.Array[Anon_Keyid]] = js.native
