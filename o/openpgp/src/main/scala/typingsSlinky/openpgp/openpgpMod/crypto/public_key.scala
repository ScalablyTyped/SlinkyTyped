...
import typingsSlinky.openpgp.Anon_C
import typingsSlinky.openpgp.Anon_S
import typingsSlinky.openpgp.openpgpMod.Integer
import typingsSlinky.openpgp.openpgpMod.`type`.mpi.MPI
import typingsSlinky.openpgp.openpgpMod.`type`.oid.OID
import typingsSlinky.openpgp.openpgpMod.crypto.public_key.elliptic.curve.Curve
  ...
  object elliptic extends js.Object {
    ...
    object ecdh extends js.Object {
      ...
      def decrypt(
        ...
        hash_algo: typingsSlinky.openpgp.openpgpMod.enums.hash,
      ...
      /**
        ...
        */
      def genPublicEphemeralKey(curve: Curve, Q: scala.scalajs.js.typedarray.Uint8Array): js.Promise[Anon_S] = js.native
    }
