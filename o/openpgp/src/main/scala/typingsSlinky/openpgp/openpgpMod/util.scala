...
import typingsSlinky.openpgp.Anon_Comment
...
object util extends js.Object {
  ...
  /**
    ...
    */
  def Uint8Array_to_MPI(bin: scala.scalajs.js.typedarray.Uint8Array): scala.scalajs.js.typedarray.Uint8Array = js.native
  /**
    ...
    */
  def Uint8Array_to_b64(bytes: scala.scalajs.js.typedarray.Uint8Array): String = js.native
  def Uint8Array_to_b64(bytes: scala.scalajs.js.typedarray.Uint8Array, url: Boolean): String = js.native
  /**
    * Convert an array of 8-bit integers to a hex string
    * @param bytes Array of 8-bit integers to convert
    * @returns Hexadecimal representation of the array
    */
  def Uint8Array_to_hex(bytes: scala.scalajs.js.typedarray.Uint8Array): String = js.native
  /**
    * Convert an array of 8-bit integers to a string
    * @param bytes An array of 8-bit integers to convert
    * @returns String representation of the array
    */
  def Uint8Array_to_str(bytes: scala.scalajs.js.typedarray.Uint8Array): String = js.native
  /**
    ...
    */
  def b64_to_Uint8Array(base64: String): scala.scalajs.js.typedarray.Uint8Array = js.native
  /**
  ...
  /**
    ...
    */
  def encode_utf8(str: String): scala.scalajs.js.typedarray.Uint8Array | ReadableStream[String] = js.native
  def encode_utf8(str: ReadableStream[String]): scala.scalajs.js.typedarray.Uint8Array | ReadableStream[String] = js.native
  /**
  ...
  /**
    ...
    * @returns An array of 8-bit integers
    */
  def hex_to_Uint8Array(hex: String): scala.scalajs.js.typedarray.Uint8Array = js.native
  /**
  ...
  /**
    ...
    * @returns An array of 8-bit integers
    */
  def str_to_Uint8Array(str: String): scala.scalajs.js.typedarray.Uint8Array = js.native
  /**
  ...
  /**
    ...
    */
  def write_checksum(Uint8Array: scala.scalajs.js.typedarray.Uint8Array): scala.scalajs.js.typedarray.Uint8Array = js.native
}
