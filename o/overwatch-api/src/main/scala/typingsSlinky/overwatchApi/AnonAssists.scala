...
trait AnonAssists extends js.Object {
  ...
  var top_heroes: AnonCompetitiveQuickplay = js.native
}
...
object AnonAssists {
  ...
  @scala.inline
  implicit class AnonAssistsOps[Self <: AnonAssists] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTop_heroes(value: AnonCompetitiveQuickplay): Self = {
        val ret = this.duplicate
