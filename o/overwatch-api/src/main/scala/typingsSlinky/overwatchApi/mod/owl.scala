...
object owl {
  ...
  implicit class owlMutableBuilder[Self <: owl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetLiveMatch(value: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit] => Unit): Self = StObject.set(x, "getLiveMatch", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetSchedule(value: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit] => Unit): Self = StObject.set(x, "getSchedule", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetStandings(value: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit] => Unit): Self = StObject.set(x, "getStandings", js.Any.fromFunction1(value))
  }
}
