...
object owl {
  ...
  implicit class owlOps[Self <: owl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetLiveMatch(value: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit] => Unit): Self = this.set("getLiveMatch", js.Any.fromFunction1(value))
    @scala.inline
    def setGetSchedule(value: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit] => Unit): Self = this.set("getSchedule", js.Any.fromFunction1(value))
    @scala.inline
    def setGetStandings(value: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit] => Unit): Self = this.set("getStandings", js.Any.fromFunction1(value))
  }
