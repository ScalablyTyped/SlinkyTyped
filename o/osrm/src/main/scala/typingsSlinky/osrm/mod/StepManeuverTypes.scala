...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.osrm.osrmStrings.turn
  - typingsSlinky.osrm.osrmStrings.`new name`
  - typingsSlinky.osrm.osrmStrings.depart
  - typingsSlinky.osrm.osrmStrings.arrive
  - typingsSlinky.osrm.osrmStrings.merge
  - typingsSlinky.osrm.osrmStrings.ramp
  - typingsSlinky.osrm.osrmStrings.`on ramp`
  - typingsSlinky.osrm.osrmStrings.`off ramp`
  - typingsSlinky.osrm.osrmStrings.fork
  - typingsSlinky.osrm.osrmStrings.`end of road`
  - typingsSlinky.osrm.osrmStrings.`use lane`
  - typingsSlinky.osrm.osrmStrings.continue
  - typingsSlinky.osrm.osrmStrings.roundabout
  - typingsSlinky.osrm.osrmStrings.rotary
  - typingsSlinky.osrm.osrmStrings.`roundabout turn`
  - typingsSlinky.osrm.osrmStrings.notification
  - typingsSlinky.osrm.osrmStrings.`exit roundabout`
  - typingsSlinky.osrm.osrmStrings.`exit rotary`
*/
