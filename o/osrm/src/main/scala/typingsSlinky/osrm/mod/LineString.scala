...
object LineString {
  ...
  @scala.inline
  def apply(coordinates: js.Array[Coordinate], `type`: typingsSlinky.osrm.osrmStrings.LineString): LineString = {
  ...
  implicit class LineStringMutableBuilder[Self <: LineString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.osrm.osrmStrings.LineString): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
