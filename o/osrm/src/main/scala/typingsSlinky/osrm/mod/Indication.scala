...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.osrm.osrmStrings.uturn
  - typingsSlinky.osrm.osrmStrings.`sharp right`
  - typingsSlinky.osrm.osrmStrings.right
  - typingsSlinky.osrm.osrmStrings.`slight rigth`
  - typingsSlinky.osrm.osrmStrings.straight
  - typingsSlinky.osrm.osrmStrings.`slight left`
  - typingsSlinky.osrm.osrmStrings.left
  - typingsSlinky.osrm.osrmStrings.`sharp left`
*/
