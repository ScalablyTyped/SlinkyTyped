package typingsSlinky.opentelemetryContextBase
...
object mod extends js.Object {
  ...
  class Context protected ()
    extends typingsSlinky.opentelemetryContextBase.contextMod.Context
  /* static members */
  @js.native
  ...
  class NoopContextManager ()
    extends typingsSlinky.opentelemetryContextBase.noopContextManagerMod.NoopContextManager
}
