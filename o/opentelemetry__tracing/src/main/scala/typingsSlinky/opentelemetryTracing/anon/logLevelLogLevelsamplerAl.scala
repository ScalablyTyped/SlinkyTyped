package typingsSlinky.opentelemetryTracing.anon

import typingsSlinky.opentelemetryApi.loggerMod.Logger
import typingsSlinky.opentelemetryApi.samplerMod.Sampler
import typingsSlinky.opentelemetryCore.idGeneratorMod.IdGenerator
import typingsSlinky.opentelemetryCore.mod.AlwaysOnSampler
import typingsSlinky.opentelemetryCore.mod.ParentOrElseSampler
