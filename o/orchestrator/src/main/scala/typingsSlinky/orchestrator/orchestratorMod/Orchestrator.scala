...
import typingsSlinky.orchestrator.Anon_Dep
import typingsSlinky.orchestrator.Anon_MissingTasks
...
trait Orchestrator extends EventEmitter {
  ...
  def sequence(tasks: js.Array[Anon_Dep], names: js.Array[String]): Anon_MissingTasks = js.native
