...
object v11Mod {
  ...
  object authenticator extends Shortcut {
    ...
    @js.native
    val ^ : typingsSlinky.otplibPresetV11.Authenticator = js.native
    ...
    @js.native
    class HOTP ()
      extends typingsSlinky.otplibPresetV11.mod.authenticator.HOTP
    ...
    type _To = typingsSlinky.otplibPresetV11.Authenticator
    
    /* This means you don't have to write `^`, but can instead just say `authenticator.foo` */
    override def _to: typingsSlinky.otplibPresetV11.Authenticator = ^
  }
  ...
  object hotp extends Shortcut {
    ...
    @js.native
    val ^ : typingsSlinky.otplibPresetV11.HOTP = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("otplib/v11", "hotp.HOTP")
    @js.native
    class HOTP ()
      extends typingsSlinky.otplibPresetV11.mod.hotp.HOTP
    ...
    type _To = typingsSlinky.otplibPresetV11.HOTP
    
    /* This means you don't have to write `^`, but can instead just say `hotp.foo` */
    override def _to: typingsSlinky.otplibPresetV11.HOTP = ^
  }
  ...
  object totp extends Shortcut {
    ...
    @js.native
    val ^ : typingsSlinky.otplibPresetV11.TOTP = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("otplib/v11", "totp.HOTP")
    @js.native
    class HOTP ()
      extends typingsSlinky.otplibPresetV11.mod.totp.HOTP
    ...
    @js.native
    class TOTP ()
      extends typingsSlinky.otplibPresetV11.mod.totp.TOTP
    ...
    type _To = typingsSlinky.otplibPresetV11.TOTP
    
    /* This means you don't have to write `^`, but can instead just say `totp.foo` */
    override def _to: typingsSlinky.otplibPresetV11.TOTP = ^
  }
}
