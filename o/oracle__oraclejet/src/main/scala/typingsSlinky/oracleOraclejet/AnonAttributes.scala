...
object AnonAttributes {
  @scala.inline
  def apply[Kin, D, K, Din](): AnonAttributes[Kin, D, K, Din] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAttributes[Kin, D, K, Din]]
  }
  @scala.inline
  implicit class AnonAttributesOps[Self[kin, d, k, din] <: AnonAttributes[kin, d, k, din], Kin, D, K, Din] (val x: Self[Kin, D, K, Din]) extends AnyVal {
    @scala.inline
