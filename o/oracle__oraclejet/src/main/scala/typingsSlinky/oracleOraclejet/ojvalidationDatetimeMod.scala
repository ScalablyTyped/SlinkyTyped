...
object ojvalidationDatetimeMod {
  ...
  class DateTimeRangeValidator () extends Validator[String] {
    def this(options: typingsSlinky.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions) = this()
  ...
  object DateTimeRangeValidator {
    ...
    object ValidatorOptions {
      ...
      @scala.inline
      def apply(converter: DateTimeConverter): typingsSlinky.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions = {
        val __obj = js.Dynamic.literal(converter = converter.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions]
      }
      
      @scala.inline
      implicit class ValidatorOptionsMutableBuilder[Self <: typingsSlinky.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions] (val x: Self) extends AnyVal {
  ...
  trait DateTimeRangeValidatorFactory extends StObject {
    ...
    def createValidator(
      options: typingsSlinky.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions
    ): DateTimeRangeValidator = js.native
  }
}
