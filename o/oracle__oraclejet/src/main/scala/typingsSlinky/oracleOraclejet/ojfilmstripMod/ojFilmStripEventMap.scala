...
object ojFilmStripEventMap {
  ...
  implicit class ojFilmStripEventMapOps[Self <: ojFilmStripEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withArrowPlacementChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("arrowPlacementChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withArrowVisibilityChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("arrowVisibilityChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCurrentItemChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("currentItemChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLoopingChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loopingChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMaxItemsPerPageChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxItemsPerPageChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
