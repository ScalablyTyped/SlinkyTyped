...
object ojFilmStripEventMap {
  ...
  implicit class ojFilmStripEventMapOps[Self <: ojFilmStripEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrowPlacementChanged(value: CustomEvent): Self = this.set("arrowPlacementChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setArrowVisibilityChanged(value: CustomEvent): Self = this.set("arrowVisibilityChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentItemChanged(value: CustomEvent): Self = this.set("currentItemChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLoopingChanged(value: CustomEvent): Self = this.set("loopingChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaxItemsPerPageChanged(value: CustomEvent): Self = this.set("maxItemsPerPageChanged", value.asInstanceOf[js.Any])
