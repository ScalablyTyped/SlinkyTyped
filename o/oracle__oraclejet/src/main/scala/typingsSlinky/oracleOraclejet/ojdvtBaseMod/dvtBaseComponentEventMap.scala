...
object dvtBaseComponentEventMap {
  @scala.inline
  def apply[/* <: typingsSlinky.oracleOraclejet.ojdvtBaseMod.dvtBaseComponentSettableProperties */ SP](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class dvtBaseComponentEventMapOps[Self <: dvtBaseComponentEventMap[_], /* <: typingsSlinky.oracleOraclejet.ojdvtBaseMod.dvtBaseComponentSettableProperties */ SP] (val x: Self with dvtBaseComponentEventMap[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTrackResizeChanged(value: CustomEvent): Self = this.set("trackResizeChanged", value.asInstanceOf[js.Any])
  }
