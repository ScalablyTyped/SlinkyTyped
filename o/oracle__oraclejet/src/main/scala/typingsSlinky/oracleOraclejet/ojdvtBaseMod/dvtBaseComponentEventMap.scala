...
object dvtBaseComponentEventMap {
  ...
  @scala.inline
  implicit class dvtBaseComponentEventMapOps[Self[sp] <: dvtBaseComponentEventMap[sp], SP] (val x: Self[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTrackResizeChanged(value: CustomEvent): Self[SP] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trackResizeChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
