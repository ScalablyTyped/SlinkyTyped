...
object ojOptionEventMap {
  ...
  @scala.inline
  implicit class ojOptionEventMapOps[Self <: ojOptionEventMap] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDisabledChanged(value: CustomEvent): Self = this.set("disabledChanged", value.asInstanceOf[js.Any])
    @scala.inline
