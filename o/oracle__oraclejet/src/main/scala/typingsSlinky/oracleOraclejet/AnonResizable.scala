...
trait AnonResizable[K, D] extends js.Object {
  ...
  var label: AnonStyle[K, D] = js.native
  var renderer: js.UndefOr[(js.Function1[/* context */ HeaderContext[K, D], Anon1 | Unit | Null]) | Null] = js.native
  var resizable: AnonHeight[K, D] = js.native
...
object AnonResizable {
  @scala.inline
  def apply[K, D](label: AnonStyle[K, D], resizable: AnonHeight[K, D]): AnonResizable[K, D] = {
  ...
  @scala.inline
  implicit class AnonResizableOps[Self[k, d] <: AnonResizable[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    def duplicate: Self[K, D] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[K, D]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): (Self[K, D]) with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[(Self[K, D]) with Other]
    @scala.inline
    def withLabel(value: AnonStyle[K, D]): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withResizable(value: AnonHeight[K, D]): Self[K, D] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRenderer(value: /* context */ HeaderContext[K, D] => Anon1 | Unit | Null): Self[K, D] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSortableFunction1(value: /* context */ HeaderContext[K, D] => String): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sortable")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSortable(value: (js.Function1[/* context */ HeaderContext[K, D], String]) | String): Self[K, D] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSortableNull: Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sortable")(null)
        ret
    }
    @scala.inline
