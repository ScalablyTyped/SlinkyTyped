...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.animation
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.animationChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.config
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.configChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.ojTransitionEnd
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.ojTransitionStart
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.ojViewConnected
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.ojViewDisconnected
...
trait ojModule extends JetElement[ojModuleSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_configChanged(`type`: configChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_configChanged(
    `type`: configChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _],
    useCapture: Boolean
  ): Unit = js.native
  ...
  @JSName("addEventListener")
  def addEventListener_ojTransitionEnd(`type`: ojTransitionEnd, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_ojTransitionStart(`type`: ojTransitionStart, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_ojViewConnected(`type`: ojViewConnected, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_ojViewDisconnected(`type`: ojViewDisconnected, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("getProperty")
  def getProperty_config(property: config): AnonCleanupMode = js.native
  ...
  @JSName("setProperty")
  def setProperty_config(property: config, value: AnonCleanupMode): Unit = js.native
}
