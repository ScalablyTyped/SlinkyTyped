...
trait ojModuleEventMap
  ...
  var animationChanged: CustomEvent
  var configChanged: CustomEvent
  var ojTransitionEnd: CustomEvent
  var ojTransitionStart: CustomEvent
  var ojViewConnected: CustomEvent
  var ojViewDisconnected: CustomEvent
}
