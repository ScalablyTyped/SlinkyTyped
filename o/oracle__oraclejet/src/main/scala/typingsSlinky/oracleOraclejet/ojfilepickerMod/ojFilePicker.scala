...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.accept
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.acceptChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.selectOn
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.selectOnChanged
...
trait ojFilePicker extends JetElement[ojFilePickerSettableProperties] {
  ...
  var onAcceptChanged: (js.Function1[CustomEvent, _]) | Null = js.native
  var onOjSelect: (js.Function1[CustomEvent, _]) | Null = js.native
  var onSelectOnChanged: (js.Function1[CustomEvent, _]) | Null = js.native
  ...
  def addEventListener(`type`: selectOnChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  ...
  @JSName("addEventListener")
  def addEventListener_acceptChanged(`type`: acceptChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
