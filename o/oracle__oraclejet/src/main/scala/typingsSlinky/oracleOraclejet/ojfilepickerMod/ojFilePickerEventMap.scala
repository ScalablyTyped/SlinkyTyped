...
trait ojFilePickerEventMap
  ...
  var acceptChanged: CustomEvent = js.native
  var ojSelect: CustomEvent = js.native
  var selectOnChanged: CustomEvent = js.native
...
object ojFilePickerEventMap {
  ...
  implicit class ojFilePickerEventMapOps[Self <: ojFilePickerEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAcceptChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("acceptChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSelectOnChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectOnChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSelectionModeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
