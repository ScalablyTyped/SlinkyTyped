...
object ojFilePickerEventMap {
  ...
  implicit class ojFilePickerEventMapOps[Self <: ojFilePickerEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcceptChanged(value: CustomEvent): Self = this.set("acceptChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOjSelect(value: CustomEvent): Self = this.set("ojSelect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectOnChanged(value: CustomEvent): Self = this.set("selectOnChanged", value.asInstanceOf[js.Any])
