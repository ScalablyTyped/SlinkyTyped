...
@js.native
trait AnonLabelDataVisualization extends js.Object {
...
object AnonLabelDataVisualization {
  @scala.inline
  def apply(): AnonLabelDataVisualization = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonLabelDataVisualization]
  }
  @scala.inline
  implicit class AnonLabelDataVisualizationOps[Self <: AnonLabelDataVisualization] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTooltipIsolate(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipIsolate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTooltipIsolate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipIsolate")(js.undefined)
        ret
    }
    @scala.inline
    def withTooltipRestore(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipRestore")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTooltipRestore: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipRestore")(js.undefined)
        ret
    }
  }
