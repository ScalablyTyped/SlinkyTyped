...
object ojoptionMod {
  ...
  object ojOptionEventMap {
    ...
    @scala.inline
    implicit class ojOptionEventMapMutableBuilder[Self <: ojOptionEventMap] (val x: Self) extends AnyVal {
  ...
  object ojOptionSettableProperties {
    ...
    @scala.inline
    implicit class ojOptionSettablePropertiesMutableBuilder[Self <: ojOptionSettableProperties] (val x: Self) extends AnyVal {
  ...
  object ojOptionSettablePropertiesLenient {
    ...
    @scala.inline
    implicit class ojOptionSettablePropertiesLenientMutableBuilder[Self <: ojOptionSettablePropertiesLenient] (val x: Self) extends AnyVal {
