...
object AnonRangeOverflowRangeUnderflow {
  @scala.inline
  def apply(): AnonRangeOverflowRangeUnderflow = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonRangeOverflowRangeUnderflow]
  }
  @scala.inline
  implicit class AnonRangeOverflowRangeUnderflowOps[Self <: AnonRangeOverflowRangeUnderflow] (val x: Self) extends AnyVal {
    @scala.inline
