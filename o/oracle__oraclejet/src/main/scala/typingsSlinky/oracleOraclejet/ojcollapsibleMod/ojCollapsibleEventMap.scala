...
object ojCollapsibleEventMap {
  ...
  @scala.inline
  implicit class ojCollapsibleEventMapOps[Self <: ojCollapsibleEventMap] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withExpandAreaChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expandAreaChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withExpandedChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expandedChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjBeforeCollapse(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojBeforeCollapse")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjBeforeExpand(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojBeforeExpand")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjCollapse(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojCollapse")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjExpand(value: CustomEvent): Self = {
        val ret = this.duplicate
