...
object AnonEndCallback {
  @scala.inline
  def apply(action: open | close, element: Element, endCallback: () => Unit): AnonEndCallback = {
  ...
  @scala.inline
  implicit class AnonEndCallbackOps[Self <: AnonEndCallback] (val x: Self) extends AnyVal {
    @scala.inline
