...
object ojfilepickerMod {
  ...
  object ojFilePickerEventMap {
    ...
    implicit class ojFilePickerEventMapMutableBuilder[Self <: ojFilePickerEventMap] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAcceptChanged(value: CustomEvent): Self = StObject.set(x, "acceptChanged", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOjSelect(value: CustomEvent): Self = StObject.set(x, "ojSelect", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectOnChanged(value: CustomEvent): Self = StObject.set(x, "selectOnChanged", value.asInstanceOf[js.Any])
