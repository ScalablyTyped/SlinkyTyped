...
object AnonBorderRadiusBorderWidth {
  @scala.inline
  def apply(borderWidth: Double, opacity: Double, svgClassName: String): AnonBorderRadiusBorderWidth = {
  ...
  @scala.inline
  implicit class AnonBorderRadiusBorderWidthOps[Self <: AnonBorderRadiusBorderWidth] (val x: Self) extends AnyVal {
    @scala.inline
