...
object ojRefresherEventMap {
  ...
  implicit class ojRefresherEventMapOps[Self <: ojRefresherEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRefreshContentChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("refreshContentChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTargetChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withThresholdChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("thresholdChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
