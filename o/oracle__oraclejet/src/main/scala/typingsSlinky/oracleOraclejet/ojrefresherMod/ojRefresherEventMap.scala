...
object ojRefresherEventMap {
  ...
  implicit class ojRefresherEventMapOps[Self <: ojRefresherEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefreshContentChanged(value: CustomEvent): Self = this.set("refreshContentChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setTargetChanged(value: CustomEvent): Self = this.set("targetChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setTextChanged(value: CustomEvent): Self = this.set("textChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setThresholdChanged(value: CustomEvent): Self = this.set("thresholdChanged", value.asInstanceOf[js.Any])
  }
