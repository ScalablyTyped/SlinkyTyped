...
trait AnonClassNameLabel[K, D] extends js.Object {
  ...
  var label: AnonClassNameRenderer[K, D] = js.native
...
object AnonClassNameLabel {
  @scala.inline
  def apply[K, D](label: AnonClassNameRenderer[K, D], resizable: AnonHeight[K, D]): AnonClassNameLabel[K, D] = {
  ...
  @scala.inline
  implicit class AnonClassNameLabelOps[Self[k, d] <: AnonClassNameLabel[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    def duplicate: Self[K, D] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[K, D]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): (Self[K, D]) with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[(Self[K, D]) with Other]
    @scala.inline
    def withLabel(value: AnonClassNameRenderer[K, D]): Self[K, D] = {
