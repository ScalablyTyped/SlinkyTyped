...
object AnonAriaHideActionsDescription {
  @scala.inline
  def apply(): AnonAriaHideActionsDescription = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAriaHideActionsDescription]
  }
  @scala.inline
  implicit class AnonAriaHideActionsDescriptionOps[Self <: AnonAriaHideActionsDescription] (val x: Self) extends AnyVal {
    @scala.inline
