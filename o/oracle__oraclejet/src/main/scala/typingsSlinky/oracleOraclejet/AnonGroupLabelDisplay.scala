...
trait AnonGroupLabelDisplay extends js.Object {
  ...
  var header: AnonHoverBackgroundColor = js.native
...
object AnonGroupLabelDisplay {
  ...
  @scala.inline
  implicit class AnonGroupLabelDisplayOps[Self <: AnonGroupLabelDisplay] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withHeader(value: AnonHoverBackgroundColor): Self = {
        val ret = this.duplicate
