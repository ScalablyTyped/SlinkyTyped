...
object ojButtonEventMap {
  ...
  @scala.inline
  implicit class ojButtonEventMapOps[Self[sp] <: ojButtonEventMap[sp], SP] (val x: Self[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withChromingChanged(value: CustomEvent): Self[SP] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("chromingChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDisabledChanged(value: CustomEvent): Self[SP] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disabledChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDisplayChanged(value: CustomEvent): Self[SP] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("displayChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjAction(value: CustomEvent): Self[SP] = {
        val ret = this.duplicate
