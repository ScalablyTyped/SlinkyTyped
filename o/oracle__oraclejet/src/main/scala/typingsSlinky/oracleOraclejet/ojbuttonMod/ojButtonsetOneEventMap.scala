...
trait ojButtonsetOneEventMap extends baseComponentEventMap[ojButtonsetOneSettableProperties] {
  ...
  var focusManagementChanged: CustomEvent = js.native
...
object ojButtonsetOneEventMap {
  ...
  implicit class ojButtonsetOneEventMapOps[Self <: ojButtonsetOneEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChromingChanged(value: CustomEvent): Self = {
    ...
    @scala.inline
    def withFocusManagementChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("focusManagementChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
