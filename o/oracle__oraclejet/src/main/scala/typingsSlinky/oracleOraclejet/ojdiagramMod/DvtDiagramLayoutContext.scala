...
trait DvtDiagramLayoutContext extends js.Object {
  ...
  def getComponentSize(): AnonH = js.native
  def getCurrentViewport(): AnonH = js.native
  ...
  def getViewport(): AnonH = js.native
  def isLocaleR2L(): Boolean = js.native
  def setViewport(viewport: AnonH): Unit = js.native
}
...
object DvtDiagramLayoutContext {
  ...
  implicit class DvtDiagramLayoutContextOps[Self <: DvtDiagramLayoutContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetViewport(value: () => AnonH): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetViewport(value: AnonH => Unit): Self = {
        val ret = this.duplicate
