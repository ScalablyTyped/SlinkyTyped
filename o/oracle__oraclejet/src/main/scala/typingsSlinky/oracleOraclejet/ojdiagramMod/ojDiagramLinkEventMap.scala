...
object ojDiagramLinkEventMap {
  ...
  implicit class ojDiagramLinkEventMapOps[Self <: ojDiagramLinkEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndConnectorTypeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endConnectorTypeChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEndNodeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endNodeChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStartConnectorTypeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startConnectorTypeChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStartNodeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startNodeChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
