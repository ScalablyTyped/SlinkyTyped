...
object AnonSortable {
  @scala.inline
  def apply[K, D](label: AnonStyle[K, D], resizable: AnonWidth[K, D]): AnonSortable[K, D] = {
  ...
  @scala.inline
  implicit class AnonSortableOps[Self[k, d] <: AnonSortable[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
