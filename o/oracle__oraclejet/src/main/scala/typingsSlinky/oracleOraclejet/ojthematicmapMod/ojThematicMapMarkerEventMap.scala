...
trait ojThematicMapMarkerEventMap
  ...
  var borderStyleChanged: CustomEvent
  ...
  var locationChanged: CustomEvent
  var opacityChanged: CustomEvent
  var rotationChanged: CustomEvent
  var selectableChanged: CustomEvent
  var shapeChanged: CustomEvent
