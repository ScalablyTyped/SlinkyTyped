...
object ojThematicMapLinkEventMap {
  ...
  implicit class ojThematicMapLinkEventMapOps[Self <: ojThematicMapLinkEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndLocationChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endLocationChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStartLocationChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startLocationChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
