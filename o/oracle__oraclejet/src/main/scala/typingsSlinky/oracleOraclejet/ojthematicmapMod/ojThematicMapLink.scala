...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.endLocation
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.endLocationChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.startLocation
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.startLocationChanged
...
trait ojThematicMapLink extends JetElement[ojThematicMapLinkSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_endLocationChanged(`type`: endLocationChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_startLocationChanged(`type`: startLocationChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
