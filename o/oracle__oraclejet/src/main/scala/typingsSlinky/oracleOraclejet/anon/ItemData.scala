...
object ItemData {
  ...
  @scala.inline
  implicit class ItemDataOps[Self[k2, d2] <: ItemData[k2, d2], K2, D2] (val x: Self[K2, D2]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRowData(value: typingsSlinky.oracleOraclejet.ojganttMod.ojGantt.Row[K2]): Self[K2, D2] = {
        val ret = this.duplicate
