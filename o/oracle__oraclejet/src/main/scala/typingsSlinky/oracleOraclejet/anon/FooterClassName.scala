...
@js.native
trait FooterClassName[K, D] extends StObject {
...
object FooterClassName {
  ...
  @scala.inline
  implicit class FooterClassNameMutableBuilder[Self <: FooterClassName[_, _], K, D] (val x: Self with (FooterClassName[K, D])) extends AnyVal {
