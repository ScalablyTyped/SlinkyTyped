...
object HighlightedCount {
  ...
  implicit class HighlightedCountOps[Self <: HighlightedCount] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHighlightedCount(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("highlightedCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHighlightedCount: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("highlightedCount")(js.undefined)
        ret
    }
    @scala.inline
    def withLabelAdditionalData(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("labelAdditionalData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLabelAdditionalData: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("labelAdditionalData")(js.undefined)
        ret
    }
    @scala.inline
