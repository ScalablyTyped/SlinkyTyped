...
object LabelDataVisualization {
  ...
  @scala.inline
  implicit class LabelDataVisualizationMutableBuilder[Self <: LabelDataVisualization] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltipIsolate(value: String): Self = StObject.set(x, "tooltipIsolate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTooltipIsolateUndefined: Self = StObject.set(x, "tooltipIsolate", js.undefined)
    
    @scala.inline
    def setTooltipRestore(value: String): Self = StObject.set(x, "tooltipRestore", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTooltipRestoreUndefined: Self = StObject.set(x, "tooltipRestore", js.undefined)
  }
}
