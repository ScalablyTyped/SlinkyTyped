...
object DragOver {
  ...
  implicit class DragOverOps[Self <: DragOver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDragEnter(value: (/* param0 */ org.scalajs.dom.raw.Event, /* param1 */ Item) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDragLeave(value: (/* param0 */ org.scalajs.dom.raw.Event, /* param1 */ Item) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDragOver(value: (/* param0 */ org.scalajs.dom.raw.Event, /* param1 */ Item) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDrop(value: (/* param0 */ org.scalajs.dom.raw.Event, /* param1 */ ItemsDropContext) => Unit): Self = {
        val ret = this.duplicate
