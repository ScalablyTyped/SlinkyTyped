...
object BaselineScaling {
  ...
  @scala.inline
  implicit class BaselineScalingMutableBuilder[Self <: BaselineScaling] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setViewportMax(value: Double): Self = StObject.set(x, "viewportMax", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setViewportMin(value: Double): Self = StObject.set(x, "viewportMin", value.asInstanceOf[js.Any])
  }
}
