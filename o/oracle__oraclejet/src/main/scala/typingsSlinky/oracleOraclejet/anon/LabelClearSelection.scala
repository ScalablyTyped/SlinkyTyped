...
@js.native
trait LabelClearSelection extends StObject {
  ...
  var promotedLink: js.UndefOr[String] = js.native
  
  var promotedLinkAriaDesc: js.UndefOr[String] = js.native
  
  var promotedLinks: js.UndefOr[String] = js.native
...
object LabelClearSelection {
  
  @scala.inline
  def apply(): LabelClearSelection = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LabelClearSelection]
  }
  
  @scala.inline
  implicit class LabelClearSelectionMutableBuilder[Self <: LabelClearSelection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPromotedLink(value: String): Self = StObject.set(x, "promotedLink", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPromotedLinkAriaDesc(value: String): Self = StObject.set(x, "promotedLinkAriaDesc", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPromotedLinkAriaDescUndefined: Self = StObject.set(x, "promotedLinkAriaDesc", js.undefined)
    
    @scala.inline
    def setPromotedLinkUndefined: Self = StObject.set(x, "promotedLink", js.undefined)
    
    @scala.inline
    def setPromotedLinks(value: String): Self = StObject.set(x, "promotedLinks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPromotedLinksUndefined: Self = StObject.set(x, "promotedLinks", js.undefined)
