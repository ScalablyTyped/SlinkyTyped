...
@js.native
trait LabelClearSelection extends js.Object {
...
object LabelClearSelection {
  ...
  @scala.inline
  implicit class LabelClearSelectionOps[Self <: LabelClearSelection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPromotedLink(value: String): Self = this.set("promotedLink", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePromotedLink: Self = this.set("promotedLink", js.undefined)
    
    @scala.inline
    def setPromotedLinkAriaDesc(value: String): Self = this.set("promotedLinkAriaDesc", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePromotedLinkAriaDesc: Self = this.set("promotedLinkAriaDesc", js.undefined)
    
    @scala.inline
    def setPromotedLinks(value: String): Self = this.set("promotedLinks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePromotedLinks: Self = this.set("promotedLinks", js.undefined)
