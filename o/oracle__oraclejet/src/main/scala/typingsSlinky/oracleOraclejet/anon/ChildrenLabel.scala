...
@js.native
trait ChildrenLabel extends js.Object {
...
object ChildrenLabel {
  ...
  @scala.inline
  implicit class ChildrenLabelOps[Self <: ChildrenLabel] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setChildKeys(value: ChildKeysChildren): Self = this.set("childKeys", value.asInstanceOf[js.Any])
    @scala.inline
