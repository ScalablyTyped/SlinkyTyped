...
trait ConverterTooltipDisplayTooltipLabel extends js.Object {
  var converter: js.UndefOr[typingsSlinky.oracleOraclejet.ojvalidationBaseMod.Converter[Double]] = js.undefined
...
object ConverterTooltipDisplayTooltipLabel {
  @scala.inline
  def apply(
    converter: typingsSlinky.oracleOraclejet.ojvalidationBaseMod.Converter[Double] = null,
