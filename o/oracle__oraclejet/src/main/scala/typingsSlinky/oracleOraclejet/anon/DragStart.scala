...
trait DragStart extends StObject {
  ...
  var drag: js.UndefOr[js.Function1[/* param0 */ org.scalajs.dom.raw.Event, Unit]] = js.native
  
  var dragEnd: js.UndefOr[js.Function1[/* param0 */ org.scalajs.dom.raw.Event, Unit]] = js.native
  
  var dragStart: js.UndefOr[
    js.Function2[/* param0 */ org.scalajs.dom.raw.Event, /* param1 */ ItemsArray, Unit]
  ] = js.native
}
object DragStart {
  ...
  implicit class DragStartMutableBuilder[Self <: DragStart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDrag(value: /* param0 */ org.scalajs.dom.raw.Event => Unit): Self = StObject.set(x, "drag", js.Any.fromFunction1(value))
    
    @scala.inline
    def setDragEnd(value: /* param0 */ org.scalajs.dom.raw.Event => Unit): Self = StObject.set(x, "dragEnd", js.Any.fromFunction1(value))
    
    @scala.inline
    def setDragEndUndefined: Self = StObject.set(x, "dragEnd", js.undefined)
    
    @scala.inline
    def setDragStart(value: (/* param0 */ org.scalajs.dom.raw.Event, /* param1 */ ItemsArray) => Unit): Self = StObject.set(x, "dragStart", js.Any.fromFunction2(value))
