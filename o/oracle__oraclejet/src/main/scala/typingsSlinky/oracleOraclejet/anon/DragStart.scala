...
object DragStart {
  ...
  implicit class DragStartOps[Self <: DragStart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDrag(value: /* param0 */ org.scalajs.dom.raw.Event => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDragEnd(value: /* param0 */ org.scalajs.dom.raw.Event => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDragStart(value: (/* param0 */ org.scalajs.dom.raw.Event, /* param1 */ ItemsArray) => Unit): Self = {
        val ret = this.duplicate
