...
import typingsSlinky.oracleOraclejet.ojlistviewMod.ojListView.ItemContext
...
object Focusable {
  ...
  @scala.inline
  implicit class FocusableOps[Self[k, d] <: Focusable[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    def duplicate: Self[K, D] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[K, D]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): (Self[K, D]) with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[(Self[K, D]) with Other]
    @scala.inline
    def withFocusableFunction1(value: /* param0 */ ItemContext[K, D] => Boolean): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("focusable")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFocusable(value: (js.Function1[/* param0 */ ItemContext[K, D], Boolean]) | Boolean): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("focusable")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFocusable: Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("focusable")(js.undefined)
        ret
    }
    @scala.inline
    def withRenderer(value: /* param0 */ ItemContext[K, D] => js.UndefOr[Insert]): Self[K, D] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelectableFunction1(value: /* param0 */ ItemContext[K, D] => Boolean): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectable")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSelectable(value: (js.Function1[/* param0 */ ItemContext[K, D], Boolean]) | Boolean): Self[K, D] = {
        val ret = this.duplicate
