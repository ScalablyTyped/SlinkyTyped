...
object baseComponentEventMap {
  @scala.inline
  def apply[/* <: typingsSlinky.oracleOraclejet.mod.baseComponentSettableProperties */ SP](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class baseComponentEventMapOps[Self <: baseComponentEventMap[_], /* <: typingsSlinky.oracleOraclejet.mod.baseComponentSettableProperties */ SP] (val x: Self with baseComponentEventMap[SP]) extends AnyVal {
    @scala.inline
