...
object baseComponentEventMap {
  ...
  @scala.inline
  implicit class baseComponentEventMapOps[Self <: baseComponentEventMap[_], SP /* <: baseComponentSettableProperties */] (val x: Self with baseComponentEventMap[SP]) extends AnyVal {
