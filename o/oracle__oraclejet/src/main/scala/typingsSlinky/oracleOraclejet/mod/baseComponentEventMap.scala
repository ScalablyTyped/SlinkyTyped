...
object baseComponentEventMap {
  ...
  @scala.inline
  implicit class baseComponentEventMapOps[Self[sp] <: baseComponentEventMap[sp], SP] (val x: Self[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTranslationsChanged(value: CustomEvent): Self[SP] = {
