...
@js.native
trait AnonLabelClearSelection extends js.Object {
...
object AnonLabelClearSelection {
  @scala.inline
  def apply(): AnonLabelClearSelection = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonLabelClearSelection]
  }
  @scala.inline
  implicit class AnonLabelClearSelectionOps[Self <: AnonLabelClearSelection] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPromotedLink(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("promotedLink")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPromotedLink: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("promotedLink")(js.undefined)
        ret
    }
    @scala.inline
    def withPromotedLinkAriaDesc(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("promotedLinkAriaDesc")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPromotedLinkAriaDesc: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("promotedLinkAriaDesc")(js.undefined)
        ret
    }
    @scala.inline
    def withPromotedLinks(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("promotedLinks")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPromotedLinks: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("promotedLinks")(js.undefined)
        ret
    }
    @scala.inline
