...
object ojPopupEventMap {
  ...
  implicit class ojPopupEventMapOps[Self <: ojPopupEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAutoDismissChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autoDismissChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withChromeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("chromeChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withInitialFocusChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initialFocusChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTailChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tailChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
