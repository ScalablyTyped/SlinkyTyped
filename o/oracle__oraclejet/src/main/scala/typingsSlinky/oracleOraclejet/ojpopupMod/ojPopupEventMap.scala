...
trait ojPopupEventMap extends baseComponentEventMap[ojPopupSettableProperties] {
  var autoDismissChanged: CustomEvent = js.native
  var chromeChanged: CustomEvent = js.native
  var initialFocusChanged: CustomEvent = js.native
  ...
  var tailChanged: CustomEvent = js.native
}
...
object ojPopupEventMap {
  ...
  implicit class ojPopupEventMapOps[Self <: ojPopupEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutoDismissChanged(value: CustomEvent): Self = this.set("autoDismissChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setChromeChanged(value: CustomEvent): Self = this.set("chromeChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setInitialFocusChanged(value: CustomEvent): Self = this.set("initialFocusChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setModalityChanged(value: CustomEvent): Self = this.set("modalityChanged", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOjBeforeClose(value: CustomEvent): Self = this.set("ojBeforeClose", value.asInstanceOf[js.Any])
    @scala.inline
    def setOjBeforeOpen(value: CustomEvent): Self = this.set("ojBeforeOpen", value.asInstanceOf[js.Any])
    @scala.inline
    def setOjClose(value: CustomEvent): Self = this.set("ojClose", value.asInstanceOf[js.Any])
    @scala.inline
    def setOjFocus(value: CustomEvent): Self = this.set("ojFocus", value.asInstanceOf[js.Any])
    @scala.inline
    def setOjOpen(value: CustomEvent): Self = this.set("ojOpen", value.asInstanceOf[js.Any])
    @scala.inline
    def setPositionChanged(value: CustomEvent): Self = this.set("positionChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setTailChanged(value: CustomEvent): Self = this.set("tailChanged", value.asInstanceOf[js.Any])
  }
