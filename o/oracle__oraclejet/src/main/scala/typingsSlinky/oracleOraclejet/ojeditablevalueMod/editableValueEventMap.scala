...
object editableValueEventMap {
  @scala.inline
  def apply[V, /* <: typingsSlinky.oracleOraclejet.ojeditablevalueMod.editableValueSettableProperties[V, SV, RV] */ SP, SV, RV](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class editableValueEventMapOps[Self <: editableValueEventMap[_, _, _, _], V, /* <: typingsSlinky.oracleOraclejet.ojeditablevalueMod.editableValueSettableProperties[V, SV, RV] */ SP, SV, RV] (val x: Self with (editableValueEventMap[V, SP, SV, RV])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDescribedByChanged(value: CustomEvent): Self = this.set("describedByChanged", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHelpChanged(value: CustomEvent): Self = this.set("helpChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setHelpHintsChanged(value: CustomEvent): Self = this.set("helpHintsChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setLabelHintChanged(value: CustomEvent): Self = this.set("labelHintChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setMessagesCustomChanged(value: CustomEvent): Self = this.set("messagesCustomChanged", value.asInstanceOf[js.Any])
    @scala.inline
