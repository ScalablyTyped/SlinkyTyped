...
object ojDialogEventMap {
  ...
  implicit class ojDialogEventMapOps[Self <: ojDialogEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCancelBehaviorChanged(value: CustomEvent): Self = this.set("cancelBehaviorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDialogTitleChanged(value: CustomEvent): Self = this.set("dialogTitleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDragAffordanceChanged(value: CustomEvent): Self = this.set("dragAffordanceChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialVisibilityChanged(value: CustomEvent): Self = this.set("initialVisibilityChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOjResizeStart(value: CustomEvent): Self = this.set("ojResizeStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOjResizeStop(value: CustomEvent): Self = this.set("ojResizeStop", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPositionChanged(value: CustomEvent): Self = this.set("positionChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResizeBehaviorChanged(value: CustomEvent): Self = this.set("resizeBehaviorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRoleChanged(value: CustomEvent): Self = this.set("roleChanged", value.asInstanceOf[js.Any])
  }
}
