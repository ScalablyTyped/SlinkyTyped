...
trait AnonLabelColor extends js.Object {
  ...
  var tooltipCollapse: js.UndefOr[String] = js.native
  var tooltipExpand: js.UndefOr[String] = js.native
}
...
object AnonLabelColor {
  ...
  implicit class AnonLabelColorOps[Self <: AnonLabelColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTooltipCollapse(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipCollapse")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTooltipCollapse: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipCollapse")(js.undefined)
        ret
    }
    @scala.inline
    def withTooltipExpand(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipExpand")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTooltipExpand: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipExpand")(js.undefined)
        ret
    }
  }
