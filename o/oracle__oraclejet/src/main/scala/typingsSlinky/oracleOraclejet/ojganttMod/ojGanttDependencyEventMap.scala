...
trait ojGanttDependencyEventMap
  ...
  var successorTaskIdChanged: CustomEvent = js.native
...
object ojGanttDependencyEventMap {
  ...
  implicit class ojGanttDependencyEventMapOps[Self <: ojGanttDependencyEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPredecessorTaskIdChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("predecessorTaskIdChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSuccessorTaskIdChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("successorTaskIdChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
