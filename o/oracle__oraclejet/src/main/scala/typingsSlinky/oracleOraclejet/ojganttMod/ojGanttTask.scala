...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.baselineChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.progressChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.rowId
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.rowIdChanged
...
trait ojGanttTask extends JetElement[ojGanttTaskSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_baselineChanged(`type`: baselineChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_progressChanged(`type`: progressChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_rowIdChanged(`type`: rowIdChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
