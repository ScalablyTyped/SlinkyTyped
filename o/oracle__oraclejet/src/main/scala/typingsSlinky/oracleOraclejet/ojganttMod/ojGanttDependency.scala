...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.predecessorTaskId
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.predecessorTaskIdChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.successorTaskId
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.successorTaskIdChanged
...
trait ojGanttDependency extends JetElement[ojGanttDependencySettableProperties] {
  ...
  def addEventListener(`type`: successorTaskIdChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  def addEventListener(
