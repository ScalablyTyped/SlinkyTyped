...
object AnonAccessibleReorderAfterItem {
  @scala.inline
  def apply(): AnonAccessibleReorderAfterItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAccessibleReorderAfterItem]
  }
  @scala.inline
  implicit class AnonAccessibleReorderAfterItemOps[Self <: AnonAccessibleReorderAfterItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabelRemove(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("labelRemove")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLabelRemove: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("labelRemove")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOverflowItemLabel(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("overflowItemLabel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOverflowItemLabel: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("overflowItemLabel")(js.undefined)
        ret
    }
    @scala.inline
    def withRemoveCueText(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeCueText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRemoveCueText: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeCueText")(js.undefined)
        ret
    }
    @scala.inline
    def withSelectedLabel(value: String): Self = {
        val ret = this.duplicate
