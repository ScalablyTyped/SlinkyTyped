...
object ojColorPaletteEventMap {
  ...
  implicit class ojColorPaletteEventMapOps[Self <: ojColorPaletteEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelledByChanged(value: CustomEvent): Self = this.set("labelledByChanged", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPaletteChanged(value: CustomEvent): Self = this.set("paletteChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setSwatchSizeChanged(value: CustomEvent): Self = this.set("swatchSizeChanged", value.asInstanceOf[js.Any])
  }
