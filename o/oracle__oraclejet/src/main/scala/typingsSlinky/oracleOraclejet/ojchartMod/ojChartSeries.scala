...
trait ojChartSeries extends JetElement[ojChartSeriesSettableProperties] {
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.UndefOr[bar | line | area | lineWithArea | candlestick | boxPlot | auto]], 
      _
    ]
  ): Unit = js.native
  def addEventListener(
  ...
  @JSName("getProperty")
  def getProperty_boxPlot(property: boxPlot): js.UndefOr[AnonQ2Color] = js.native
  @JSName("getProperty")
  ...
  @JSName("setProperty")
  def setProperty_boxPlot(property: boxPlot, value: AnonQ2Color): Unit = js.native
  @JSName("setProperty")
