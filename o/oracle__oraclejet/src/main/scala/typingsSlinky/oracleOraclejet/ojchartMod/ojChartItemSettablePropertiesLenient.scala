...
trait ojChartItemSettablePropertiesLenient
  ...
  var groupId: js.UndefOr[js.Array[String | Double]] = js.native
  ...
  var seriesId: js.UndefOr[String | Double] = js.native
...
object ojChartItemSettablePropertiesLenient {
  ...
  @scala.inline
  def apply(): ojChartItemSettablePropertiesLenient = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ojChartItemSettablePropertiesLenient]
  }
  
  @scala.inline
  implicit class ojChartItemSettablePropertiesLenientMutableBuilder[Self <: ojChartItemSettablePropertiesLenient] (val x: Self) extends AnyVal {
