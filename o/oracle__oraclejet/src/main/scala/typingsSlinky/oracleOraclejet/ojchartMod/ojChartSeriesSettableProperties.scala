...
object ojChartSeriesSettableProperties {
  @scala.inline
  def apply(): ojChartSeriesSettableProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ojChartSeriesSettableProperties]
  }
  @scala.inline
  implicit class ojChartSeriesSettablePropertiesOps[Self <: ojChartSeriesSettableProperties] (val x: Self) extends AnyVal {
    @scala.inline
