...
object ojChartSeriesEventMap {
  ...
  implicit class ojChartSeriesEventMapMutableBuilder[Self <: ojChartSeriesEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAreaColorChanged(value: CustomEvent): Self = StObject.set(x, "areaColorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAreaSvgClassNameChanged(value: CustomEvent): Self = StObject.set(x, "areaSvgClassNameChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAreaSvgStyleChanged(value: CustomEvent): Self = StObject.set(x, "areaSvgStyleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAssignedToY2Changed(value: CustomEvent): Self = StObject.set(x, "assignedToY2Changed", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBoxPlotChanged(value: CustomEvent): Self = StObject.set(x, "boxPlotChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDisplayInLegendChanged(value: CustomEvent): Self = StObject.set(x, "displayInLegendChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDrillingChanged(value: CustomEvent): Self = StObject.set(x, "drillingChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLineStyleChanged(value: CustomEvent): Self = StObject.set(x, "lineStyleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLineTypeChanged(value: CustomEvent): Self = StObject.set(x, "lineTypeChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLineWidthChanged(value: CustomEvent): Self = StObject.set(x, "lineWidthChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarkerColorChanged(value: CustomEvent): Self = StObject.set(x, "markerColorChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMarkerSvgClassNameChanged(value: CustomEvent): Self = StObject.set(x, "markerSvgClassNameChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarkerSvgStyleChanged(value: CustomEvent): Self = StObject.set(x, "markerSvgStyleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNameChanged(value: CustomEvent): Self = StObject.set(x, "nameChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPatternChanged(value: CustomEvent): Self = StObject.set(x, "patternChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPieSliceExplodeChanged(value: CustomEvent): Self = StObject.set(x, "pieSliceExplodeChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStackCategoryChanged(value: CustomEvent): Self = StObject.set(x, "stackCategoryChanged", value.asInstanceOf[js.Any])
