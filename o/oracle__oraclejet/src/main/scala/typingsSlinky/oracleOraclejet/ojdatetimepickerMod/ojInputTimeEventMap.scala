...
trait ojInputTimeEventMap extends inputBaseEventMap[String, ojInputTimeSettableProperties, String, String] {
  ...
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojInputTimeEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojInputTimeEventMap: CustomEvent = js.native
  var pickerAttributesChanged: CustomEvent = js.native
  var renderModeChanged: CustomEvent = js.native
  var timePickerChanged: CustomEvent = js.native
}
...
object ojInputTimeEventMap {
  ...
  implicit class ojInputTimeEventMapOps[Self <: ojInputTimeEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKeyboardEditChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPickerAttributesChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pickerAttributesChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRenderModeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renderModeChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTimePickerChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("timePickerChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
