...
object ojInputDateSettablePropertiesLenient {
  ...
  @scala.inline
  def apply(): ojInputDateSettablePropertiesLenient = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ojInputDateSettablePropertiesLenient]
  }
  
  @scala.inline
  implicit class ojInputDateSettablePropertiesLenientMutableBuilder[Self <: ojInputDateSettablePropertiesLenient] (val x: Self) extends AnyVal {
