...
object ojInputTimeSettablePropertiesLenient {
  ...
  @scala.inline
  def apply(): ojInputTimeSettablePropertiesLenient = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ojInputTimeSettablePropertiesLenient]
  }
  
  @scala.inline
  implicit class ojInputTimeSettablePropertiesLenientMutableBuilder[Self <: ojInputTimeSettablePropertiesLenient] (val x: Self) extends AnyVal {
