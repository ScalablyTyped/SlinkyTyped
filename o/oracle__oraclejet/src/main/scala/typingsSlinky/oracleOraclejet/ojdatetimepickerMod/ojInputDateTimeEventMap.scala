...
trait ojInputDateTimeEventMap[SP /* <: ojInputDateTimeSettableProperties */] extends ojInputDateEventMap[SP] {
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojInputDateTimeEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojInputDateTimeEventMap: CustomEvent = js.native
  var timePickerChanged: CustomEvent = js.native
}

object ojInputDateTimeEventMap {
  @scala.inline
  def apply[/* <: typingsSlinky.oracleOraclejet.ojdatetimepickerMod.ojInputDateTimeSettableProperties */ SP](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class ojInputDateTimeEventMapOps[Self <: ojInputDateTimeEventMap[_], /* <: typingsSlinky.oracleOraclejet.ojdatetimepickerMod.ojInputDateTimeSettableProperties */ SP] (val x: Self with ojInputDateTimeEventMap[SP]) extends AnyVal {
    @scala.inline
