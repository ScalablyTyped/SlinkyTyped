...
object ojInputDateTimeEventMap {
  ...
  @scala.inline
  implicit class ojInputDateTimeEventMapOps[Self[sp] <: ojInputDateTimeEventMap[sp], SP] (val x: Self[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTimePickerChanged(value: CustomEvent): Self[SP] = {
        val ret = this.duplicate
