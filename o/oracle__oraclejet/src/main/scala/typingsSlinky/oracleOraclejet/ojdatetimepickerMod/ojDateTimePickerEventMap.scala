...
trait ojDateTimePickerEventMap extends ojInputDateTimeEventMap[ojDateTimePickerSettableProperties] {
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojDateTimePickerEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojDateTimePickerEventMap: CustomEvent = js.native
}
...
object ojDateTimePickerEventMap {
  ...
  @scala.inline
  implicit class ojDateTimePickerEventMapOps[Self <: ojDateTimePickerEventMap] (val x: Self) extends AnyVal {
    @scala.inline
