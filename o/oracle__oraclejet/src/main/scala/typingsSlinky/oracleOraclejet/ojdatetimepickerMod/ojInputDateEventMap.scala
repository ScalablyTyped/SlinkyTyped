...
object ojInputDateEventMap {
  @scala.inline
  def apply[/* <: typingsSlinky.oracleOraclejet.ojdatetimepickerMod.ojInputDateSettableProperties */ SP](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class ojInputDateEventMapOps[Self <: ojInputDateEventMap[_], /* <: typingsSlinky.oracleOraclejet.ojdatetimepickerMod.ojInputDateSettableProperties */ SP] (val x: Self with ojInputDateEventMap[SP]) extends AnyVal {
    @scala.inline
