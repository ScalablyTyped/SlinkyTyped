...
object AnonBorderWidthColor {
  @scala.inline
  def apply(borderWidth: Double, opacity: Double, svgClassName: String): AnonBorderWidthColor = {
  ...
  @scala.inline
  implicit class AnonBorderWidthColorOps[Self <: AnonBorderWidthColor] (val x: Self) extends AnyVal {
    @scala.inline
