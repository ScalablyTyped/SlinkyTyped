...
object ojAvatarEventMap {
  ...
  implicit class ojAvatarEventMapOps[Self <: ojAvatarEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialsChanged(value: CustomEvent): Self = this.set("initialsChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setSizeChanged(value: CustomEvent): Self = this.set("sizeChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setSrcChanged(value: CustomEvent): Self = this.set("srcChanged", value.asInstanceOf[js.Any])
  }
