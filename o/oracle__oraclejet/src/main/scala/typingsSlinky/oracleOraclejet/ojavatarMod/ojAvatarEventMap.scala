...
trait ojAvatarEventMap
  ...
  var initialsChanged: CustomEvent = js.native
  var sizeChanged: CustomEvent = js.native
  var srcChanged: CustomEvent = js.native
}
...
object ojAvatarEventMap {
  ...
  implicit class ojAvatarEventMapOps[Self <: ojAvatarEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInitialsChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initialsChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSrcChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("srcChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
