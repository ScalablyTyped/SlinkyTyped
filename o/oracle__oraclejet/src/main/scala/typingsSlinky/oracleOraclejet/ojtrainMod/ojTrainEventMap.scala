...
object ojTrainEventMap {
  ...
  @scala.inline
  implicit class ojTrainEventMapOps[Self <: ojTrainEventMap] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withOjBeforeDeselect(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojBeforeDeselect")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjBeforeSelect(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojBeforeSelect")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjDeselect(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojDeselect")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjSelect(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojSelect")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSelectedStepChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectedStepChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStepsChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stepsChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
