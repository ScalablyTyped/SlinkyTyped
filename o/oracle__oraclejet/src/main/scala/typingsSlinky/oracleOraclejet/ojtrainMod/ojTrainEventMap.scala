...
object ojTrainEventMap {
  ...
  implicit class ojTrainEventMapOps[Self <: ojTrainEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOjSelect(value: CustomEvent): Self = this.set("ojSelect", value.asInstanceOf[js.Any])
    @scala.inline
    def setSelectedStepChanged(value: CustomEvent): Self = this.set("selectedStepChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setStepsChanged(value: CustomEvent): Self = this.set("stepsChanged", value.asInstanceOf[js.Any])
  }
