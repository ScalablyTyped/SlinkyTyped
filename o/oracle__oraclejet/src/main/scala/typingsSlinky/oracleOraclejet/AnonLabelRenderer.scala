...
trait AnonLabelRenderer[K, D] extends js.Object {
  ...
  var resizable: AnonWidth[K, D] = js.native
...
object AnonLabelRenderer {
  @scala.inline
  def apply[K, D](label: AnonStyle[K, D], resizable: AnonWidth[K, D]): AnonLabelRenderer[K, D] = {
  ...
  @scala.inline
  implicit class AnonLabelRendererOps[Self[k, d] <: AnonLabelRenderer[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResizable(value: AnonWidth[K, D]): Self[K, D] = {
        val ret = this.duplicate
