...
@js.native
trait AnonDictpropNameCancelEdit
  extends /* key */ StringDictionary[js.Any] {
  var cancelEdit: js.Object = js.native
  var rowContext: js.Object = js.native
}

object AnonDictpropNameCancelEdit {
  @scala.inline
  def apply(cancelEdit: js.Object, rowContext: js.Object): AnonDictpropNameCancelEdit = {
    val __obj = js.Dynamic.literal(cancelEdit = cancelEdit.asInstanceOf[js.Any], rowContext = rowContext.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDictpropNameCancelEdit]
  }
  @scala.inline
  implicit class AnonDictpropNameCancelEditOps[Self <: AnonDictpropNameCancelEdit] (val x: Self) extends AnyVal {
    @scala.inline
