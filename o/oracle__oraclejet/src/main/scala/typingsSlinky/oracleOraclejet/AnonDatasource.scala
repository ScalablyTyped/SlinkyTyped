...
object AnonDatasource {
  @scala.inline
  def apply[K, D](mode: edit | navigation, status: ContextStatus[K]): AnonDatasource[K, D] = {
  ...
  @scala.inline
  implicit class AnonDatasourceOps[Self[k, d] <: AnonDatasource[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
