...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.columnSpan
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.columnSpanChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.count
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.countChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.rowSpan
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.rowSpanChanged
...
trait ojPictoChartItem extends JetElement[ojPictoChartItemSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_columnSpanChanged(`type`: columnSpanChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_countChanged(`type`: countChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_rowSpanChanged(`type`: rowSpanChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
