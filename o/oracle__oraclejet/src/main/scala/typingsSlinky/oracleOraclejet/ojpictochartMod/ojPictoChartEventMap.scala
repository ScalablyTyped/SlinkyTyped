...
object ojPictoChartEventMap {
  ...
  @scala.inline
  implicit class ojPictoChartEventMapOps[Self[k, d] <: ojPictoChartEventMap[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withColumnCountChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("columnCountChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withColumnWidthChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("columnWidthChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLayoutOriginChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("layoutOriginChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRowCountChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowCountChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRowHeightChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowHeightChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
