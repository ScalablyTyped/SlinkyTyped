...
object ojPictoChartItemEventMap {
  ...
  implicit class ojPictoChartItemEventMapOps[Self <: ojPictoChartItemEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnSpanChanged(value: CustomEvent): Self = this.set("columnSpanChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCountChanged(value: CustomEvent): Self = this.set("countChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRowSpanChanged(value: CustomEvent): Self = this.set("rowSpanChanged", value.asInstanceOf[js.Any])
