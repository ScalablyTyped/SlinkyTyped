...
object ojTimeAxisEventMap {
  ...
  @scala.inline
  implicit class ojTimeAxisEventMapOps[Self <: ojTimeAxisEventMap] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withScaleChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
