...
object ojLabelValueEventMap {
  ...
  implicit class ojLabelValueEventMapOps[Self <: ojLabelValueEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelEdgeChanged(value: CustomEvent): Self = this.set("labelEdgeChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelWidthChanged(value: CustomEvent): Self = this.set("labelWidthChanged", value.asInstanceOf[js.Any])
  }
}
