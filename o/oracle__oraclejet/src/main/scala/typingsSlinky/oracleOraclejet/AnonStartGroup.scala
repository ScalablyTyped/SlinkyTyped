...
object AnonStartGroup {
  @scala.inline
  def apply(endGroup: String, startGroup: String, xMax: Double, xMin: Double, yMax: Double, yMin: Double): AnonStartGroup = {
  ...
  @scala.inline
  implicit class AnonStartGroupOps[Self <: AnonStartGroup] (val x: Self) extends AnyVal {
    @scala.inline
