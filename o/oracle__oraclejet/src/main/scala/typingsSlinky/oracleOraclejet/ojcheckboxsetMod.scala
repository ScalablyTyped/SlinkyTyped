...
object ojcheckboxsetMod {
  ...
  trait ojCheckboxset[K, D]
    ...
    var onOjAnimateEnd_ojCheckboxset: (js.Function1[CustomEvent, _]) | Null = js.native
    
    @JSName("onOjAnimateStart")
    var onOjAnimateStart_ojCheckboxset: (js.Function1[CustomEvent, _]) | Null = js.native
    ...
    var onValueChanged_ojCheckboxset: (js.Function1[CustomEvent, _]) | Null = js.native
  ...
  trait ojCheckboxsetEventMap[K, D]
    ...
    @JSName("ojAnimateEnd")
    var ojAnimateEnd_ojCheckboxsetEventMap: CustomEvent = js.native
    
    @JSName("ojAnimateStart")
    var ojAnimateStart_ojCheckboxsetEventMap: CustomEvent = js.native
    ...
    @JSName("valueChanged")
    var valueChanged_ojCheckboxsetEventMap: CustomEvent = js.native
  }
