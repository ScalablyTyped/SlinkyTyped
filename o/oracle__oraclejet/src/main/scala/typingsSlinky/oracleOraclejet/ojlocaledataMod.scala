...
object ojlocaledataMod {
  ...
  @JSImport("@oracle/oraclejet/ojlocaledata", "getDayNames")
  @js.native
  ...
  @JSImport("@oracle/oraclejet/ojlocaledata", "getFirstDayOfWeek")
  @js.native
  def getFirstDayOfWeek(): Double = js.native
  
  @JSImport("@oracle/oraclejet/ojlocaledata", "getMonthNames")
  @js.native
  ...
  @JSImport("@oracle/oraclejet/ojlocaledata", "getWeekendEnd")
  @js.native
  def getWeekendEnd(): Double = js.native
  
  @JSImport("@oracle/oraclejet/ojlocaledata", "getWeekendStart")
  @js.native
  def getWeekendStart(): Double = js.native
  
  @JSImport("@oracle/oraclejet/ojlocaledata", "isMonthPriorToYear")
  @js.native
  def isMonthPriorToYear(): Boolean = js.native
  
  @JSImport("@oracle/oraclejet/ojlocaledata", "setBundle")
  @js.native
