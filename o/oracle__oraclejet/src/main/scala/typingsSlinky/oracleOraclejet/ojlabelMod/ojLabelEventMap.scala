...
object ojLabelEventMap {
  ...
  implicit class ojLabelEventMapOps[Self <: ojLabelEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForChanged(value: CustomEvent): Self = this.set("forChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHelpChanged(value: CustomEvent): Self = this.set("helpChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelIdChanged(value: CustomEvent): Self = this.set("labelIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShowRequiredChanged(value: CustomEvent): Self = this.set("showRequiredChanged", value.asInstanceOf[js.Any])
  }
}
