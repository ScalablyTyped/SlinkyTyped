...
object ojLabelEventMap {
  ...
  implicit class ojLabelEventMapOps[Self <: ojLabelEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHelpChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("helpChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLabelIdChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("labelIdChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withShowRequiredChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showRequiredChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
