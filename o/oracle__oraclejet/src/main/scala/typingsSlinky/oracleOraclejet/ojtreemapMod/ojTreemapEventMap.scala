...
trait ojTreemapEventMap[K, D] extends dvtBaseComponentEventMap[ojTreemapSettableProperties[K, D]] {
  ...
  var animationUpdateColorChanged: CustomEvent
  var asChanged: CustomEvent
  var colorLabelChanged: CustomEvent
  var dataChanged: CustomEvent
  var displayLevelsChanged: CustomEvent
  var drillingChanged: CustomEvent
  var groupGapsChanged: CustomEvent
  ...
  var isolatedNodeChanged: CustomEvent
  var layoutChanged: CustomEvent
  var nodeContentChanged: CustomEvent
  var nodeDefaultsChanged: CustomEvent
  var nodeSeparatorsChanged: CustomEvent
  var ojBeforeDrill: CustomEvent
  var ojDrill: CustomEvent
  var rootNodeChanged: CustomEvent
  var selectionChanged: CustomEvent
  var selectionModeChanged: CustomEvent
  var sizeLabelChanged: CustomEvent
