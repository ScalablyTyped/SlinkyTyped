...
object ojTreemapNodeEventMap {
  ...
  implicit class ojTreemapNodeEventMapOps[Self <: ojTreemapNodeEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGroupLabelDisplayChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("groupLabelDisplayChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHeaderChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabelValignChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("labelValignChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
