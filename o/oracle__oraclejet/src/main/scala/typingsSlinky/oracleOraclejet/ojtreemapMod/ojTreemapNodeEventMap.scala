...
object ojTreemapNodeEventMap {
  ...
  implicit class ojTreemapNodeEventMapOps[Self <: ojTreemapNodeEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupLabelDisplayChanged(value: CustomEvent): Self = this.set("groupLabelDisplayChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabelValignChanged(value: CustomEvent): Self = this.set("labelValignChanged", value.asInstanceOf[js.Any])
