...
object ojpopupMod {
  ...
  object ojPopupEventMap {
    ...
    implicit class ojPopupEventMapMutableBuilder[Self <: ojPopupEventMap] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAutoDismissChanged(value: CustomEvent): Self = StObject.set(x, "autoDismissChanged", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChromeChanged(value: CustomEvent): Self = StObject.set(x, "chromeChanged", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInitialFocusChanged(value: CustomEvent): Self = StObject.set(x, "initialFocusChanged", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setModalityChanged(value: CustomEvent): Self = StObject.set(x, "modalityChanged", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOjBeforeClose(value: CustomEvent): Self = StObject.set(x, "ojBeforeClose", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOjFocus(value: CustomEvent): Self = StObject.set(x, "ojFocus", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTailChanged(value: CustomEvent): Self = StObject.set(x, "tailChanged", value.asInstanceOf[js.Any])
    }
  }
