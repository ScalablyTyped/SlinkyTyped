...
object AnonPositionStyle {
  @scala.inline
  def apply(): AnonPositionStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonPositionStyle]
  }
  @scala.inline
  implicit class AnonPositionStyleOps[Self <: AnonPositionStyle] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withPosition(value: center | start | auto): Self = {
