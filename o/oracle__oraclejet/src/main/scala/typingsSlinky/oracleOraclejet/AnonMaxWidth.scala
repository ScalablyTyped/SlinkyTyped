...
trait AnonMaxWidth[K2, D2] extends js.Object {
  var label: js.UndefOr[Anon6[K2, D2]] = js.native
...
object AnonMaxWidth {
  @scala.inline
  def apply[K2, D2](): AnonMaxWidth[K2, D2] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonMaxWidth[K2, D2]]
  }
  @scala.inline
  implicit class AnonMaxWidthOps[Self[k2, d2] <: AnonMaxWidth[k2, d2], K2, D2] (val x: Self[K2, D2]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: Anon6[K2, D2]): Self[K2, D2] = {
