...
object AnonRendererSelectable {
  @scala.inline
  def apply[K, D](): AnonRendererSelectable[K, D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonRendererSelectable[K, D]]
  }
  @scala.inline
  implicit class AnonRendererSelectableOps[Self[k, d] <: AnonRendererSelectable[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
