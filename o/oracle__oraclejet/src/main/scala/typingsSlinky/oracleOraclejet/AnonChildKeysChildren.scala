...
import typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelect.OptionsKeys
...
object AnonChildKeysChildren {
  @scala.inline
  def apply(): AnonChildKeysChildren = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonChildKeysChildren]
  }
  @scala.inline
  implicit class AnonChildKeysChildrenOps[Self <: AnonChildKeysChildren] (val x: Self) extends AnyVal {
    @scala.inline
