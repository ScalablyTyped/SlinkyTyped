...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.direction
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.directionChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.labelEdge
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.labelEdgeChanged
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.labelWidth
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.labelWidthChanged
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.labelWrapping
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.labelWrappingChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.maxColumns
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.maxColumnsChanged
...
trait ojFormLayout extends JetElement[ojFormLayoutSettableProperties] {
  ...
  var onDirectionChanged: (js.Function1[CustomEvent, _]) | Null = js.native
  ...
  var onLabelWrappingChanged: (js.Function1[CustomEvent, _]) | Null = js.native
  var onMaxColumnsChanged: (js.Function1[CustomEvent, _]) | Null = js.native
  def addEventListener(`type`: directionChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  ...
  def addEventListener(`type`: labelWrappingChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  def addEventListener(
  ...
  @JSName("addEventListener")
  def addEventListener_maxColumnsChanged(`type`: maxColumnsChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
