...
object ojMasonryLayoutEventMap {
  ...
  implicit class ojMasonryLayoutEventMapOps[Self <: ojMasonryLayoutEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOjBeforeInsert(value: CustomEvent): Self = this.set("ojBeforeInsert", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOjBeforeRemove(value: CustomEvent): Self = this.set("ojBeforeRemove", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOjBeforeReorder(value: CustomEvent): Self = this.set("ojBeforeReorder", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOjBeforeResize(value: CustomEvent): Self = this.set("ojBeforeResize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOjInsert(value: CustomEvent): Self = this.set("ojInsert", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReorderHandleChanged(value: CustomEvent): Self = this.set("reorderHandleChanged", value.asInstanceOf[js.Any])
  }
}
