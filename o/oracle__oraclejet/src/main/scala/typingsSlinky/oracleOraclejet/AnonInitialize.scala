...
object AnonInitialize {
  ...
  implicit class AnonInitializeOps[Self <: AnonInitialize] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withValidateFunction2(value: (/* attributes */ js.Object, /* options */ js.UndefOr[AnonInitialize]) => Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withValidate(
      value: js.Object | String | (js.Function2[/* attributes */ js.Object, /* options */ js.UndefOr[AnonInitialize], Double])
    ): Self = {
        val ret = this.duplicate
