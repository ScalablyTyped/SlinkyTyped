...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.urlChanged
...
object ojtagcloudMod {
  ...
  trait ojTagCloudItem extends JetElement[ojTagCloudItemSettableProperties] {
    ...
    @JSName("addEventListener")
    def addEventListener_urlChanged(`type`: urlChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
    @JSName("addEventListener")
    ...
    var onUrlChanged: (js.Function1[CustomEvent, _]) | Null = js.native
  ...
  trait ojTagCloudItemEventMap extends HTMLElementEventMap {
    ...
    var urlChanged: CustomEvent = js.native
  ...
  object ojTagCloudItemEventMap {
    ...
    implicit class ojTagCloudItemEventMapMutableBuilder[Self <: ojTagCloudItemEventMap] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUrlChanged(value: CustomEvent): Self = StObject.set(x, "urlChanged", value.asInstanceOf[js.Any])
