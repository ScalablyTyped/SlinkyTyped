...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.`@firstInvalidShown`
...
object ojvalidationgroupMod {
  ...
  trait ojValidationGroup extends JetElement[ojValidationGroupSettableProperties] {
    ...
    def setProperty[T /* <: String */](property: T, value: JetSetPropertyType[T, ojValidationGroupSettableProperties]): Unit = js.native
    @JSName("setProperty")
  ...
  @js.native
  trait ojValidationGroupEventMap extends HTMLElementEventMap {
  ...
  object ojValidationGroupEventMap {
    ...
    @scala.inline
    implicit class ojValidationGroupEventMapMutableBuilder[Self <: ojValidationGroupEventMap] (val x: Self) extends AnyVal {
  ...
  object ojValidationGroupSettableProperties {
    ...
    @scala.inline
    implicit class ojValidationGroupSettablePropertiesMutableBuilder[Self <: ojValidationGroupSettableProperties] (val x: Self) extends AnyVal {
  ...
  object ojValidationGroupSettablePropertiesLenient {
    ...
    @scala.inline
    implicit class ojValidationGroupSettablePropertiesLenientMutableBuilder[Self <: ojValidationGroupSettablePropertiesLenient] (val x: Self) extends AnyVal {
