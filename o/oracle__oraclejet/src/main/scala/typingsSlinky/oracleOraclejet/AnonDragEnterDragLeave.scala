...
object AnonDragEnterDragLeave {
  @scala.inline
  def apply(dataTypes: String | js.Array[String], drop: (DragEvent, DropRowContext) => Unit): AnonDragEnterDragLeave = {
  ...
  @scala.inline
  implicit class AnonDragEnterDragLeaveOps[Self <: AnonDragEnterDragLeave] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDrop(value: (DragEvent, DropRowContext) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("drop")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withDragEnter(value: (/* param0 */ DragEvent, /* param1 */ DropRowContext) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDragLeave(value: (/* param0 */ DragEvent, /* param1 */ DropRowContext) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDragOver(value: (/* param0 */ DragEvent, /* param1 */ DropRowContext) => Unit): Self = {
        val ret = this.duplicate
