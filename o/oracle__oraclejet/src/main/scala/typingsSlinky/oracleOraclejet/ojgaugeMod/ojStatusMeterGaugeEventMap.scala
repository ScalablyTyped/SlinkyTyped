...
trait ojStatusMeterGaugeEventMap extends dvtBaseComponentEventMap[ojStatusMeterGaugeSettableProperties] {
  var angleExtentChanged: CustomEvent
  ...
  var centerChanged: CustomEvent
  var colorChanged: CustomEvent
  var indicatorSizeChanged: CustomEvent
  var innerRadiusChanged: CustomEvent
  var labelChanged: CustomEvent
  var maxChanged: CustomEvent
  var metricLabelChanged: CustomEvent
  ...
  var referenceLinesChanged: CustomEvent
  var startAngleChanged: CustomEvent
  var stepChanged: CustomEvent
  var svgClassNameChanged: CustomEvent
  var svgStyleChanged: CustomEvent
  var thresholdDisplayChanged: CustomEvent
  var thresholdsChanged: CustomEvent
