...
trait ojRatingGaugeEventMap extends dvtBaseComponentEventMap[ojRatingGaugeSettableProperties] {
  var changedChanged: CustomEvent = js.native
  var changedStateChanged: CustomEvent = js.native
  var hoverStateChanged: CustomEvent = js.native
  var maxChanged: CustomEvent = js.native
  var minChanged: CustomEvent = js.native
  var orientationChanged: CustomEvent = js.native
  var preserveAspectRatioChanged: CustomEvent = js.native
  var readonlyChanged: CustomEvent = js.native
  var selectedStateChanged: CustomEvent = js.native
  ...
  var unselectedStateChanged: CustomEvent = js.native
...
object ojRatingGaugeEventMap {
  ...
  implicit class ojRatingGaugeEventMapOps[Self <: ojRatingGaugeEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChangedChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changedChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withChangedStateChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changedStateChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHoverStateChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hoverStateChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPreserveAspectRatioChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("preserveAspectRatioChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSelectedStateChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectedStateChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUnselectedStateChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unselectedStateChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
