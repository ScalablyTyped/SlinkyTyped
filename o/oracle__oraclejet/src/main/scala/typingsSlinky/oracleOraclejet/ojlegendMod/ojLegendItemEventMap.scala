...
trait ojLegendItemEventMap
  ...
  var categoryVisibilityChanged: CustomEvent = js.native
  ...
  var symbolTypeChanged: CustomEvent = js.native
...
object ojLegendItemEventMap {
  ...
  implicit class ojLegendItemEventMapOps[Self <: ojLegendItemEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCategoryVisibilityChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("categoryVisibilityChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSymbolTypeChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("symbolTypeChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
