...
trait ojLegendSectionEventMap
  ...
  var textHalignChanged: CustomEvent = js.native
...
object ojLegendSectionEventMap {
  ...
  implicit class ojLegendSectionEventMapOps[Self <: ojLegendSectionEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCollapsibleChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapsibleChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("textChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextHalignChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("textHalignChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextStyleChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
