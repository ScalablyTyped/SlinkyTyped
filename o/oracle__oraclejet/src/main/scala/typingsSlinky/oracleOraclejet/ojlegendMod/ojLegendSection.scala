...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.collapsibleChanged
...
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.textHalign
import typingsSlinky.oracleOraclejet.oracleOraclejetStrings.textHalignChanged
...
trait ojLegendSection extends JetElement[ojLegendSectionSettableProperties] {
  ...
  def addEventListener(`type`: collapsibleChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  def addEventListener(
    `type`: collapsibleChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _],
    useCapture: Boolean
  ): Unit = js.native
  def addEventListener(`type`: textHalignChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  def addEventListener(
