...
object ojNBoxNodeEventMap {
  ...
  implicit class ojNBoxNodeEventMapOps[Self <: ojNBoxNodeEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumnChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("columnChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGroupCategoryChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("groupCategoryChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIconChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iconChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIndicatorColorChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indicatorColorChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIndicatorIconChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indicatorIconChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRowChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSecondaryLabelChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("secondaryLabelChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withXPercentageChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("xPercentageChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withYPercentageChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("yPercentageChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
