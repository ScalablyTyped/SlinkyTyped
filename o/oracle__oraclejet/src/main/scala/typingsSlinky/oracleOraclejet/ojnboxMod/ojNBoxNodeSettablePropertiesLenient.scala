...
object ojNBoxNodeSettablePropertiesLenient {
  ...
  def apply(
    ...
    xPercentage: js.UndefOr[Double] = js.undefined,
    yPercentage: js.UndefOr[Double] = js.undefined
    ...
    if (!js.isUndefined(xPercentage)) __obj.updateDynamic("xPercentage")(xPercentage.get.asInstanceOf[js.Any])
    if (!js.isUndefined(yPercentage)) __obj.updateDynamic("yPercentage")(yPercentage.get.asInstanceOf[js.Any])
