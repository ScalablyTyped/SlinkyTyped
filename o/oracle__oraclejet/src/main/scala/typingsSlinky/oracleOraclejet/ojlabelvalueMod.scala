...
object ojlabelvalueMod {
  ...
  object ojLabelValueEventMap {
    ...
    @scala.inline
    implicit class ojLabelValueEventMapMutableBuilder[Self <: ojLabelValueEventMap] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setLabelEdgeChanged(value: CustomEvent): Self = StObject.set(x, "labelEdgeChanged", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelWidthChanged(value: CustomEvent): Self = StObject.set(x, "labelWidthChanged", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ojLabelValueSettableProperties {
    ...
    @scala.inline
    implicit class ojLabelValueSettablePropertiesMutableBuilder[Self <: ojLabelValueSettableProperties] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setLabelEdge(value: start | top | inherit): Self = StObject.set(x, "labelEdge", value.asInstanceOf[js.Any])
  ...
  object ojLabelValueSettablePropertiesLenient {
    ...
    @scala.inline
    implicit class ojLabelValueSettablePropertiesLenientMutableBuilder[Self <: ojLabelValueSettablePropertiesLenient] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setLabelEdge(value: start | top | inherit): Self = StObject.set(x, "labelEdge", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelEdgeUndefined: Self = StObject.set(x, "labelEdge", js.undefined)
