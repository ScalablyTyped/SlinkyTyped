...
@js.native
trait AnonAccessibleNavigateSkipItems extends js.Object {
...
object AnonAccessibleNavigateSkipItems {
  @scala.inline
  def apply(): AnonAccessibleNavigateSkipItems = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAccessibleNavigateSkipItems]
  }
  @scala.inline
  implicit class AnonAccessibleNavigateSkipItemsOps[Self <: AnonAccessibleNavigateSkipItems] (val x: Self) extends AnyVal {
    @scala.inline
