...
object ojSunburstEventMap {
  ...
  @scala.inline
  implicit class ojSunburstEventMapOps[Self[k, d] <: ojSunburstEventMap[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOjRotateInput(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojRotateInput")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRootNodeContentChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rootNodeContentChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRotationChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartAngleChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
