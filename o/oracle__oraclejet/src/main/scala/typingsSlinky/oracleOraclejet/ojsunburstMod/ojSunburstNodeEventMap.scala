...
object ojSunburstNodeEventMap {
  ...
  implicit class ojSunburstNodeEventMapOps[Self <: ojSunburstNodeEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelHalignChanged(value: CustomEvent): Self = this.set("labelHalignChanged", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRadiusChanged(value: CustomEvent): Self = this.set("radiusChanged", value.asInstanceOf[js.Any])
    @scala.inline
