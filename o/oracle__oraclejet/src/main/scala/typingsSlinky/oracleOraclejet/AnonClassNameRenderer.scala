...
@js.native
trait AnonClassNameRenderer[K, D] extends js.Object {
  var className: js.UndefOr[
    (js.Function1[/* context */ LabelContext[K, D], String | Unit | Null]) | String | Null
  ] = js.native
  var renderer: js.UndefOr[(js.Function1[/* context */ LabelContext[K, D], Anon1 | Unit | Null]) | Null] = js.native
  var style: js.UndefOr[
    (js.Function1[/* context */ HeaderContext[K, D], String | Unit | Null]) | String | Null
  ] = js.native
}

object AnonClassNameRenderer {
  @scala.inline
  def apply[K, D](): AnonClassNameRenderer[K, D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonClassNameRenderer[K, D]]
  }
  @scala.inline
  implicit class AnonClassNameRendererOps[Self[k, d] <: AnonClassNameRenderer[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRenderer(value: /* context */ LabelContext[K, D] => Anon1 | Unit | Null): Self[K, D] = {
        val ret = this.duplicate
