...
trait ojComboboxEventMap[V, SP /* <: ojComboboxSettableProperties[V, SV, RV] */, SV, RV] extends editableValueEventMap[V, SP, SV, RV] {
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojComboboxEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojComboboxEventMap: CustomEvent = js.native
}

object ojComboboxEventMap {
  @scala.inline
  def apply[V, /* <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojComboboxSettableProperties[V, SV, RV] */ SP, SV, RV](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class ojComboboxEventMapOps[Self <: ojComboboxEventMap[_, _, _, _], V, /* <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojComboboxSettableProperties[V, SV, RV] */ SP, SV, RV] (val x: Self with (ojComboboxEventMap[V, SP, SV, RV])) extends AnyVal {
    @scala.inline
