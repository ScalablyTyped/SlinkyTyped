...
trait ojComboboxManySettableProperties[K, D]
  ...
  @JSName("translations")
  var translations_ojComboboxManySettableProperties: AnonFilterFurther = js.native
...
object ojComboboxManySettableProperties {
  ...
  implicit class ojComboboxManySettablePropertiesOps[Self[k, d] <: ojComboboxManySettableProperties[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    ...
    @scala.inline
    def withOptionsKeys(value: AnonChildren): Self[K, D] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTranslations(value: AnonFilterFurther): Self[K, D] = {
        val ret = this.duplicate
