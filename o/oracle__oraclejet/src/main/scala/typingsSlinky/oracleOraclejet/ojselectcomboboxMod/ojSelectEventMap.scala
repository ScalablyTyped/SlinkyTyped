...
object ojSelectEventMap {
  @scala.inline
  def apply[V, /* <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelectSettableProperties[V, SV] */ SP, SV](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class ojSelectEventMapOps[Self <: ojSelectEventMap[_, _, _], V, /* <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelectSettableProperties[V, SV] */ SP, SV] (val x: Self with (ojSelectEventMap[V, SP, SV])) extends AnyVal {
    @scala.inline
