...
trait ojSelectEventMap[V, SP /* <: ojSelectSettableProperties[V, SV] */, SV] extends editableValueEventMap[V, SP, SV, V] {
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojSelectEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojSelectEventMap: CustomEvent = js.native
}
...
object ojSelectEventMap {
  ...
  @scala.inline
  implicit class ojSelectEventMapOps[Self[v, sp, sv] <: ojSelectEventMap[v, sp, sv], V, SP, SV] (val x: Self[V, SP, SV]) extends AnyVal {
    @scala.inline
    def duplicate: Self[V, SP, SV] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[V, SP, SV]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): (Self[V, SP, SV]) with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[(Self[V, SP, SV]) with Other]
    @scala.inline
    def withOjAnimateEnd(value: CustomEvent): Self[V, SP, SV] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ojAnimateEnd")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOjAnimateStart(value: CustomEvent): Self[V, SP, SV] = {
        val ret = this.duplicate
