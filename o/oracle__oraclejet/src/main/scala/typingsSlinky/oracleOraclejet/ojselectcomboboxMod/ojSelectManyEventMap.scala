...
trait ojSelectManyEventMap[K, D]
  ...
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojSelectManyEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojSelectManyEventMap: CustomEvent = js.native
  ...
  @JSName("valueChanged")
  var valueChanged_ojSelectManyEventMap: CustomEvent = js.native
...
object ojSelectManyEventMap {
  ...
  @scala.inline
  implicit class ojSelectManyEventMapOps[Self[k, d] <: ojSelectManyEventMap[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
