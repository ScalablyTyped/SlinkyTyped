...
trait ojCombobox[V, SP /* <: ojComboboxSettableProperties[V, SV, RV] */, SV, RV] extends editableValue[V, SP, SV, RV] {
  ...
  var onOjAnimateEnd_ojCombobox: (js.Function1[CustomEvent, _]) | Null = js.native
  
  @JSName("onOjAnimateStart")
  var onOjAnimateStart_ojCombobox: (js.Function1[CustomEvent, _]) | Null = js.native
...
object ojCombobox {
  ...
  object Optgroup {
    ...
    def apply(
      ...
      label: String
    ): typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Optgroup = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Optgroup]
    }
    
    @scala.inline
    implicit class OptgroupMutableBuilder[Self <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Optgroup] (val x: Self) extends AnyVal {
  ...
  object Option {
    ...
    @scala.inline
    def apply(value: js.Any): typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Option = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Option]
    }
    
    @scala.inline
    implicit class OptionMutableBuilder[Self <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Option] (val x: Self) extends AnyVal {
