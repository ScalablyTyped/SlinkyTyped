...
trait ojSelectOneEventMap[K, D]
  ...
  var minimumResultsForSearchChanged: CustomEvent = js.native
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojSelectOneEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojSelectOneEventMap: CustomEvent = js.native
...
object ojSelectOneEventMap {
  ...
  @scala.inline
  implicit class ojSelectOneEventMapOps[Self[k, d] <: ojSelectOneEventMap[k, d], K, D] (val x: Self[K, D]) extends AnyVal {
    @scala.inline
    def duplicate: Self[K, D] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[K, D]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): (Self[K, D]) with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[(Self[K, D]) with Other]
    @scala.inline
    def withMinimumResultsForSearchChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minimumResultsForSearchChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRenderModeChanged(value: CustomEvent): Self[K, D] = {
        val ret = this.duplicate
