...
trait ojSelectOneEventMap[K, D]
  ...
  var minimumResultsForSearchChanged: CustomEvent
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojSelectOneEventMap: CustomEvent
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojSelectOneEventMap: CustomEvent
  ...
  var valueOptionChanged: CustomEvent
}
