...
object ojComboboxManySettablePropertiesLenient {
  ...
  @scala.inline
  implicit class ojComboboxManySettablePropertiesLenientMutableBuilder[Self <: ojComboboxManySettablePropertiesLenient[_, _], K, D] (val x: Self with (ojComboboxManySettablePropertiesLenient[K, D])) extends AnyVal {
