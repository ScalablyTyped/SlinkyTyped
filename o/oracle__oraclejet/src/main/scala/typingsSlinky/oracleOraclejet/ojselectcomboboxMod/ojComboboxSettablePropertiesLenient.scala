...
object ojComboboxSettablePropertiesLenient {
  ...
  @scala.inline
  implicit class ojComboboxSettablePropertiesLenientOps[Self[v, sv, rv] <: ojComboboxSettablePropertiesLenient[v, sv, rv], V, SV, RV] (val x: Self[V, SV, RV]) extends AnyVal {
    @scala.inline
