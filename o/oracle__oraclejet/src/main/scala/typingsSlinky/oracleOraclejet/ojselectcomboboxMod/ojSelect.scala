...
trait ojSelect[V, SP /* <: ojSelectSettableProperties[V, SV] */, SV] extends editableValue[V, SP, SV, V] {
  ...
  var onOjAnimateEnd_ojSelect: (js.Function1[CustomEvent, _]) | Null = js.native
  
  @JSName("onOjAnimateStart")
  var onOjAnimateStart_ojSelect: (js.Function1[CustomEvent, _]) | Null = js.native
...
object ojSelect {
  ...
  object Optgroup {
    ...
    def apply(
      ...
      label: String
    ): typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelect.Optgroup = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelect.Optgroup]
    }
    
    @scala.inline
    implicit class OptgroupMutableBuilder[Self <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelect.Optgroup] (val x: Self) extends AnyVal {
  ...
  object Option {
    ...
    @scala.inline
    def apply(value: js.Any): typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelect.Option = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelect.Option]
    }
    
    @scala.inline
    implicit class OptionMutableBuilder[Self <: typingsSlinky.oracleOraclejet.ojselectcomboboxMod.ojSelect.Option] (val x: Self) extends AnyVal {
