...
trait ojTextAreaEventMap
  ...
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojTextAreaEventMap: CustomEvent = js.native
  
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojTextAreaEventMap: CustomEvent = js.native
...
object ojTextAreaEventMap {
  ...
  implicit class ojTextAreaEventMapMutableBuilder[Self <: ojTextAreaEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRowsChanged(value: CustomEvent): Self = StObject.set(x, "rowsChanged", value.asInstanceOf[js.Any])
  }
}
