...
object inputBaseEventMap {
  @scala.inline
  def apply[V, /* <: typingsSlinky.oracleOraclejet.ojinputtextMod.inputBaseSettableProperties[V, SV, V] */ SP, SV, RV](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class inputBaseEventMapOps[Self <: inputBaseEventMap[_, _, _, _], V, /* <: typingsSlinky.oracleOraclejet.ojinputtextMod.inputBaseSettableProperties[V, SV, V] */ SP, SV, RV] (val x: Self with (inputBaseEventMap[V, SP, SV, RV])) extends AnyVal {
    @scala.inline
