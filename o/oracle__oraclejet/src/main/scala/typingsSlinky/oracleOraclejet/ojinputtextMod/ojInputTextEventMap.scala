...
trait ojInputTextEventMap
  ...
  var clearIconChanged: CustomEvent = js.native
  var converterChanged: CustomEvent = js.native
  var listChanged: CustomEvent = js.native
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojInputTextEventMap: CustomEvent = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojInputTextEventMap: CustomEvent = js.native
...
object ojInputTextEventMap {
  ...
  implicit class ojInputTextEventMapOps[Self <: ojInputTextEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClearIconChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearIconChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withListChanged(value: CustomEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("listChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
