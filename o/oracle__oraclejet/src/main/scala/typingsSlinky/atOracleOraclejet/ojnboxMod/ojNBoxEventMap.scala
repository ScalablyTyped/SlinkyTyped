...
trait ojNBoxEventMap[K, D] extends dvtBaseComponentEventMap[ojNBoxSettableProperties[K, D]] {
  ...
  var cellContentChanged: CustomEvent
  var cellMaximizeChanged: CustomEvent
  var cellsChanged: CustomEvent
  var columnsChanged: CustomEvent
  var columnsTitleChanged: CustomEvent
  var countLabelChanged: CustomEvent
  var dataChanged: CustomEvent
  var groupAttributesChanged: CustomEvent
  var groupBehaviorChanged: CustomEvent
  ...
  var labelTruncationChanged: CustomEvent
  var maximizedColumnChanged: CustomEvent
  var maximizedRowChanged: CustomEvent
  var otherColorChanged: CustomEvent
  var otherThresholdChanged: CustomEvent
  var rowsChanged: CustomEvent
  var rowsTitleChanged: CustomEvent
