...
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.message
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.messageChanged
...
trait ojMessage_ extends JetElement[ojMessageSettableProperties] {
  ...
  var translations: Anon_Categories = js.native
  ...
  @JSName("addEventListener")
  def addEventListener_messageChanged(`type`: messageChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("getProperty")
  def getProperty_translations(property: translations): Anon_Categories = js.native
  ...
  @JSName("setProperty")
  def setProperty_translations(property: translations, value: Anon_Categories): Unit = js.native
}
