...
import typingsSlinky.atOracleOraclejet.ojinputtextMod.inputBaseEventMap
...
trait ojInputDateEventMap[SP /* <: ojInputDateSettableProperties */] extends inputBaseEventMap[String, SP, String, String] {
  ...
  var datePickerChanged: CustomEvent
  var dayFormatterChanged: CustomEvent
  var dayMetaDataChanged: CustomEvent
  var keyboardEditChanged: CustomEvent
  var maxChanged: CustomEvent
  var minChanged: CustomEvent
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojInputDateEventMap: CustomEvent
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojInputDateEventMap: CustomEvent
  var pickerAttributesChanged: CustomEvent
  var renderModeChanged: CustomEvent
}
