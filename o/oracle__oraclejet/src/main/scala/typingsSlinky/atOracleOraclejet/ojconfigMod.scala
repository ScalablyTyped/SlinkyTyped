...
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.others
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.phone
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.tablet
