...
import typingsSlinky.atOracleOraclejet.Anon_H
import typingsSlinky.atOracleOraclejet.Anon_XY
...
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.right
