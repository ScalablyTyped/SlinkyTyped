package typingsSlinky.atOracleOraclejet.ojmodelMod

import typingsSlinky.atOracleOraclejet.Anon_AttributesData
import typingsSlinky.atOracleOraclejet.Anon_Attrs
import typingsSlinky.atOracleOraclejet.Anon_ErrorModel
import typingsSlinky.atOracleOraclejet.Anon_ErrorModelOptions
...
class Model () extends js.Object {
  ...
  def destroy(options: Anon_ErrorModel): Boolean = js.native
  def fetch(): js.Object = js.native
  def fetch(options: Anon_ErrorModelOptions): js.Object = js.native
  ...
  def save(attributes: js.Object, options: Anon_Attrs): js.Object | Boolean = js.native
