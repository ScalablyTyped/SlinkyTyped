...
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.`oj-table-footer`
import typingsSlinky.atOracleOraclejet.atOracleOraclejetStrings.`oj-table-header`
