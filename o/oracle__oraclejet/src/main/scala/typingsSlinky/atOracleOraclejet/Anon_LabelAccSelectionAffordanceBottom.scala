...
trait Anon_LabelAccSelectionAffordanceBottom extends js.Object {
...
object Anon_LabelAccSelectionAffordanceBottom {
  @scala.inline
  def apply(
  ...
  ): Anon_LabelAccSelectionAffordanceBottom = {
    ...
    __obj.asInstanceOf[Anon_LabelAccSelectionAffordanceBottom]
  }
}
