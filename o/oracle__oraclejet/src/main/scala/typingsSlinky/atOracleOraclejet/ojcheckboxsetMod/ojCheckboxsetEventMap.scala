...
import typingsSlinky.atOracleOraclejet.ojeditablevalueMod.editableValueEventMap
...
trait ojCheckboxsetEventMap[K, D]
  ...
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojCheckboxsetEventMap: CustomEvent
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojCheckboxsetEventMap: CustomEvent
  ...
  @JSName("valueChanged")
  var valueChanged_ojCheckboxsetEventMap: CustomEvent
}
