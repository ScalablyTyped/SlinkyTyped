...
trait ojGanttTaskEventMap
  ...
  var baselineChanged: CustomEvent
  var borderRadiusChanged: CustomEvent
  var endChanged: CustomEvent
  var heightChanged: CustomEvent
  var labelChanged: CustomEvent
  var labelPositionChanged: CustomEvent
  var labelStyleChanged: CustomEvent
  var progressChanged: CustomEvent
  var rowIdChanged: CustomEvent
