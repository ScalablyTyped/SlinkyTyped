...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsDeleteArchiveForAuthenticatedUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsDeleteArchiveForOrgParams
...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetArchiveForOrgParams
...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetStatusForAuthenticatedUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetStatusForOrgParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsListForAuthenticatedUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsListForOrgParams
...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsSetLfsPreferenceParams
...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsUnlockRepoForAuthenticatedUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsUnlockRepoForOrgParams
...
@js.native
trait AnonDeleteArchiveForAuthenticatedUser extends js.Object {
  /**
    * Stop an import for a repository.
    */
  @JSName("cancelImport")
  var cancelImport_Original: Anon186 = js.native
  /**
  ...
  var deleteArchiveForAuthenticatedUser_Original: Anon187 = js.native
  /**
    * Deletes a previous migration archive. Migration archives are automatically deleted after seven days.
    */
  @JSName("deleteArchiveForOrg")
  var deleteArchiveForOrg_Original: Anon188 = js.native
  /**
    * Fetches the URL to a migration archive.
    */
  @JSName("downloadArchiveForOrg")
  var downloadArchiveForOrg_Original: Anon189 = js.native
  /**
  ...
  var getArchiveForAuthenticatedUser_Original: Anon190 = js.native
  /**
    * Fetches the URL to a migration archive.
    *
    *
  ...
  var getArchiveForOrg_Original: Anon191 = js.native
  /**
  ...
  var getCommitAuthors_Original: Anon192 = js.native
  /**
  ...
  var getImportProgress_Original: Anon193 = js.native
  /**
    * List files larger than 100MB found during the import
    */
  @JSName("getLargeFiles")
  var getLargeFiles_Original: Anon194 = js.native
  /**
  ...
  var getStatusForAuthenticatedUser_Original: Anon195 = js.native
  /**
  ...
  var getStatusForOrg_Original: Anon196 = js.native
  /**
    * Lists all migrations a user has started.
    */
  @JSName("listForAuthenticatedUser")
  var listForAuthenticatedUser_Original: Anon197 = js.native
  /**
    * Lists the most recent migrations.
    */
  @JSName("listForOrg")
  var listForOrg_Original: Anon198 = js.native
  /**
    * List all the repositories for this organization migration.
    */
  @JSName("listReposForOrg")
  var listReposForOrg_Original: Anon199 = js.native
  /**
    * Lists all the repositories for this user migration.
    */
  @JSName("listReposForUser")
  var listReposForUser_Original: Anon200 = js.native
  /**
    * Update an author's identity for the import. Your application can continue updating authors any time before you push new commits to the repository.
    */
  @JSName("mapCommitAuthor")
  var mapCommitAuthor_Original: Anon201 = js.native
  /**
    * You can import repositories from Subversion, Mercurial, and TFS that include files larger than 100MB. This ability is powered by [Git LFS](https://git-lfs.github.com). You can learn more about our LFS feature and working with large files [on our help site](https://help.github.com/articles/versioning-large-files/).
    */
  @JSName("setLfsPreference")
  var setLfsPreference_Original: Anon202 = js.native
  /**
    * Initiates the generation of a user migration archive.
    */
  @JSName("startForAuthenticatedUser")
  var startForAuthenticatedUser_Original: Anon203 = js.native
  /**
    * Initiates the generation of a migration archive.
    */
  @JSName("startForOrg")
  var startForOrg_Original: Anon204 = js.native
  /**
    * Start a source import to a GitHub repository using GitHub Importer.
    */
  @JSName("startImport")
  var startImport_Original: Anon205 = js.native
  /**
  ...
  var unlockRepoForAuthenticatedUser_Original: Anon206 = js.native
  /**
  ...
  var unlockRepoForOrg_Original: Anon207 = js.native
  /**
    ...
    */
  @JSName("updateImport")
  var updateImport_Original: Anon208 = js.native
  /**
    * Stop an import for a repository.
    */
