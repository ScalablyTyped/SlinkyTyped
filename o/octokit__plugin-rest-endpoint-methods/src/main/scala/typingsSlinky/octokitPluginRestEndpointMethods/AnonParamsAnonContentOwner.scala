...
trait AnonParamsAnonContentOwner extends js.Object {
  ...
  var params: AnonContentOwner = js.native
...
object AnonParamsAnonContentOwner {
  ...
  @scala.inline
  implicit class AnonParamsAnonContentOwnerOps[Self <: AnonParamsAnonContentOwner] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonContentOwner): Self = {
        val ret = this.duplicate
