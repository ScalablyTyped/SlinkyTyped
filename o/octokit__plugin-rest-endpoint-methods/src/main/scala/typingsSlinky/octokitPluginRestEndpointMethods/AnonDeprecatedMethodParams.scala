...
trait AnonDeprecatedMethodParams extends js.Object {
  ...
  var params: AnonClientsecret = js.native
  var url: String = js.native
}

object AnonDeprecatedMethodParams {
  @scala.inline
  def apply(deprecated: String, method: String, params: AnonClientsecret, url: String): AnonDeprecatedMethodParams = {
  ...
  @scala.inline
  implicit class AnonDeprecatedMethodParamsOps[Self <: AnonDeprecatedMethodParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonClientsecret): Self = {
        val ret = this.duplicate
