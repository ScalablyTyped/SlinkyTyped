...
trait AnonParamsAnonSource extends js.Object {
  ...
  var params: AnonSource = js.native
...
object AnonParamsAnonSource {
  ...
  @scala.inline
  implicit class AnonParamsAnonSourceOps[Self <: AnonParamsAnonSource] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonSource): Self = {
        val ret = this.duplicate
