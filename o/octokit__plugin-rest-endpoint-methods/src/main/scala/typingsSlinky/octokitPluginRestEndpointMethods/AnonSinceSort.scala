...
@js.native
trait AnonSinceSort extends js.Object {
...
object AnonSinceSort {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonSinceSort]
  }
  @scala.inline
  implicit class AnonSinceSortOps[Self <: AnonSinceSort] (val x: Self) extends AnyVal {
    @scala.inline
