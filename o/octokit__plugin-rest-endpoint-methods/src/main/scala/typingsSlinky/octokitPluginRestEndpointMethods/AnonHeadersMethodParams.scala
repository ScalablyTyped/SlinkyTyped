...
object AnonHeadersMethodParams {
  ...
  @scala.inline
  implicit class AnonHeadersMethodParamsOps[Self <: AnonHeadersMethodParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonBody): Self = {
        val ret = this.duplicate
