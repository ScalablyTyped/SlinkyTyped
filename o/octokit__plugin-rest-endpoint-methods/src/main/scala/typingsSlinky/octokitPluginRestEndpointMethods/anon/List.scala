...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.LicensesGetForRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.LicensesGetParams
...
trait List extends js.Object {
  /**
    ...
    */
  @JSName("getForRepo")
  var getForRepo_Original: `183` = js.native
  @JSName("get")
  var get_Original: `182` = js.native
  @JSName("listCommonlyUsed")
  var listCommonlyUsed_Original: `29` = js.native
  /**
    * @deprecated octokit.licenses.list() has been renamed to octokit.licenses.listCommonlyUsed() (2019-03-05)
    */
  @JSName("list")
  var list_Original: `29` = js.native
  def get(): js.Promise[
