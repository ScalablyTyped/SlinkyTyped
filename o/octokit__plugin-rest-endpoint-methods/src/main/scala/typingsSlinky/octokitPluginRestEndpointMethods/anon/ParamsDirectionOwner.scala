...
trait ParamsDirectionOwner extends js.Object {
  ...
  var params: DirectionOwner = js.native
...
object ParamsDirectionOwner {
  ...
  @scala.inline
  implicit class ParamsDirectionOwnerOps[Self <: ParamsDirectionOwner] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: DirectionOwner): Self = {
        val ret = this.duplicate
