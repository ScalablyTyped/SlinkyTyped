...
trait ParamsFingerprint extends js.Object {
  ...
  var params: Fingerprint = js.native
...
object ParamsFingerprint {
  ...
  @scala.inline
  implicit class ParamsFingerprintOps[Self <: ParamsFingerprint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Fingerprint): Self = {
        val ret = this.duplicate
