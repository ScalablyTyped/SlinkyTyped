...
trait DeprecatedMethodParams extends js.Object {
  ...
  var params: Clientsecret = js.native
...
object DeprecatedMethodParams {
  ...
  @scala.inline
  implicit class DeprecatedMethodParamsOps[Self <: DeprecatedMethodParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Clientsecret): Self = {
        val ret = this.duplicate
