...
trait ParamsRepoTeamslug extends js.Object {
  ...
  var params: RepoTeamslug = js.native
...
object ParamsRepoTeamslug {
  ...
  @scala.inline
  implicit class ParamsRepoTeamslugOps[Self <: ParamsRepoTeamslug] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: RepoTeamslug): Self = {
        val ret = this.duplicate
