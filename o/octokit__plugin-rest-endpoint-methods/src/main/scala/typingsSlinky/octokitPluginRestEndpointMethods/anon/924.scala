...
object `924` {
  ...
  @scala.inline
  implicit class `924Ops`[Self <: `924`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[ReposDeleteDeploymentEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
