...
trait MethodParamsUrl extends js.Object {
  ...
  var params: Archiveformat = js.native
...
object MethodParamsUrl {
  ...
  @scala.inline
  implicit class MethodParamsUrlOps[Self <: MethodParamsUrl] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Archiveformat): Self = {
        val ret = this.duplicate
