...
trait Deprecated extends js.Object {
  ...
  var params: Accesstoken = js.native
  var url: String = js.native
}

object Deprecated {
  @scala.inline
  def apply(deprecated: String, method: String, params: Accesstoken, url: String): Deprecated = {
  ...
  implicit class DeprecatedOps[Self <: Deprecated] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withParams(value: Accesstoken): Self = {
        val ret = this.duplicate
