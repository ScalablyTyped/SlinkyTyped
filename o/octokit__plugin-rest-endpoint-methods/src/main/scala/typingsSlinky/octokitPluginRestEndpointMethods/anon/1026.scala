...
@js.native
trait `1026` extends js.Object {
  
  var parameters: RequestParameters with (Omit[SearchCommitsEndpoint, baseUrl | headers | mediaType]) = js.native
...
object `1026` {
  ...
  @scala.inline
  implicit class `1026Ops`[Self <: `1026`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[SearchCommitsEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
