...
@js.native
trait JobidOwner extends js.Object {
...
object JobidOwner {
  @scala.inline
  def apply(job_id: Required, owner: Required, page: Type, per_page: Type, repo: Required): JobidOwner = {
  ...
  @scala.inline
  implicit class JobidOwnerOps[Self <: JobidOwner] (val x: Self) extends AnyVal {
    @scala.inline
