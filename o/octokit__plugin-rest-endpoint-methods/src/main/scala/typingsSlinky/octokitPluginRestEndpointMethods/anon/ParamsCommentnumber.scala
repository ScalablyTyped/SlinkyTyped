...
@js.native
trait ParamsCommentnumber extends js.Object {
  var deprecated: String = js.native
  var headers: Accept = js.native
  var method: String = js.native
  var params: Commentnumber = js.native
  var url: String = js.native
}

object ParamsCommentnumber {
  @scala.inline
  def apply(deprecated: String, headers: Accept, method: String, params: Commentnumber, url: String): ParamsCommentnumber = {
    ...
    __obj.asInstanceOf[ParamsCommentnumber]
  }
  @scala.inline
  implicit class ParamsCommentnumberOps[Self <: ParamsCommentnumber] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Commentnumber): Self = {
        val ret = this.duplicate
