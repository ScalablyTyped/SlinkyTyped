...
trait ParamsNameRequired extends js.Object {
  ...
  var params: NameRequired = js.native
...
object ParamsNameRequired {
  ...
  @scala.inline
  implicit class ParamsNameRequiredOps[Self <: ParamsNameRequired] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: NameRequired): Self = {
        val ret = this.duplicate
