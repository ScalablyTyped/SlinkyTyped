...
trait Encryptedvalue extends js.Object {
  var encrypted_value: Type = js.native
  var key_id: Type = js.native
...
object Encryptedvalue {
  ...
  @scala.inline
  implicit class EncryptedvalueOps[Self <: Encryptedvalue] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withEncrypted_value(value: Type): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("encrypted_value")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKey_id(value: Type): Self = {
        val ret = this.duplicate
