...
trait MethodStringParamsPagePerpage extends js.Object {
  ...
  var params: PagePerpage = js.native
...
object MethodStringParamsPagePerpage {
  ...
  @scala.inline
  implicit class MethodStringParamsPagePerpageOps[Self <: MethodStringParamsPagePerpage] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: PagePerpage): Self = {
        val ret = this.duplicate
