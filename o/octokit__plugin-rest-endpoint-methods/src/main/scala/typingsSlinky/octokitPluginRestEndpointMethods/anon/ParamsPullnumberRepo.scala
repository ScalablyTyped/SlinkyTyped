...
trait ParamsPullnumberRepo extends js.Object {
  ...
  var params: PullnumberRepo = js.native
...
object ParamsPullnumberRepo {
  ...
  @scala.inline
  implicit class ParamsPullnumberRepoOps[Self <: ParamsPullnumberRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: PullnumberRepo): Self = {
        val ret = this.duplicate
