...
trait DeprecatedHeadersMethodParams extends js.Object {
  ...
  var params: UsernameRequired = js.native
...
object DeprecatedHeadersMethodParams {
  ...
  @scala.inline
  implicit class DeprecatedHeadersMethodParamsOps[Self <: DeprecatedHeadersMethodParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: UsernameRequired): Self = {
        val ret = this.duplicate
