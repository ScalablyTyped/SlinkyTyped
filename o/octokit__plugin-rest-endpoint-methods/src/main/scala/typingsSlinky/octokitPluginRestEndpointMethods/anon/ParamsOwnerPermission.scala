...
trait ParamsOwnerPermission extends js.Object {
  ...
  var params: OwnerPermission = js.native
...
object ParamsOwnerPermission {
  ...
  @scala.inline
  implicit class ParamsOwnerPermissionOps[Self <: ParamsOwnerPermission] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OwnerPermission): Self = {
        val ret = this.duplicate
