...
trait ParamsTeamidRequired extends js.Object {
  ...
  var params: TeamidRequired = js.native
...
object ParamsTeamidRequired {
  ...
  @scala.inline
  implicit class ParamsTeamidRequiredOps[Self <: ParamsTeamidRequired] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: TeamidRequired): Self = {
        val ret = this.duplicate
