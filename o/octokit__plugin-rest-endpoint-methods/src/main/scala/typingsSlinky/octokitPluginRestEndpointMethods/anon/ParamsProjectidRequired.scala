...
trait ParamsProjectidRequired extends js.Object {
  ...
  var params: ProjectidRequired = js.native
...
object ParamsProjectidRequired {
  ...
  @scala.inline
  implicit class ParamsProjectidRequiredOps[Self <: ParamsProjectidRequired] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: ProjectidRequired): Self = {
        val ret = this.duplicate
