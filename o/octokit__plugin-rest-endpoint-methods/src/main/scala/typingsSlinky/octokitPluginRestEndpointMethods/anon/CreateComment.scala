...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsCreateCommentParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsCreateParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsDeleteCommentParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsDeleteParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsForkParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsGetCommentParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsGetParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsGetRevisionParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsListCommentsParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsListCommitsParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsListForksParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsListParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsListPublicForUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsListPublicParams
...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsUnstarParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsUpdateCommentParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GistsUpdateParams
...
trait CreateComment extends js.Object {
  ...
  var checkIsStarred_Original: `102` = js.native
  @JSName("createComment")
  var createComment_Original: `104` = js.native
  /**
    ...
    */
  @JSName("create")
  var create_Original: `103` = js.native
  @JSName("deleteComment")
  var deleteComment_Original: `106` = js.native
  @JSName("delete")
  var delete_Original: `105` = js.native
  /**
    * **Note**: This was previously `/gists/:gist_id/fork`.
    */
  @JSName("fork")
  var fork_Original: `107` = js.native
  @JSName("getComment")
  var getComment_Original: `109` = js.native
  @JSName("getRevision")
  var getRevision_Original: `110` = js.native
  @JSName("get")
  var get_Original: `108` = js.native
  @JSName("listComments")
  var listComments_Original: `112` = js.native
  @JSName("listCommits")
  var listCommits_Original: `113` = js.native
  @JSName("listForks")
  var listForks_Original: `114` = js.native
  @JSName("listPublicForUser")
  var listPublicForUser_Original: `116` = js.native
  /**
    ...
    */
  @JSName("listPublic")
  var listPublic_Original: `115` = js.native
  /**
    * List the authenticated user's starred gists:
    */
  @JSName("listStarred")
  var listStarred_Original: `117` = js.native
  @JSName("list")
  var list_Original: `111` = js.native
  /**
    * Note that you'll need to set `Content-Length` to zero when calling out to this endpoint. For more information, see "[HTTP verbs](https://developer.github.com/v3/#http-verbs)."
    */
  @JSName("star")
  var star_Original: `118` = js.native
  @JSName("unstar")
  var unstar_Original: `119` = js.native
  @JSName("updateComment")
  var updateComment_Original: `121` = js.native
  /**
    * Allows you to update or delete a gist file and rename gist files. Files from the previous version of the gist that aren't explicitly changed during an edit are unchanged.
    */
  @JSName("update")
  var update_Original: `120` = js.native
