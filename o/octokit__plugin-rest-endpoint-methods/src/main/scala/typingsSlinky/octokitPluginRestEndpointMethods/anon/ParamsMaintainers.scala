...
trait ParamsMaintainers extends js.Object {
  ...
  var params: Maintainers = js.native
...
object ParamsMaintainers {
  ...
  @scala.inline
  implicit class ParamsMaintainersOps[Self <: ParamsMaintainers] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Maintainers): Self = {
        val ret = this.duplicate
