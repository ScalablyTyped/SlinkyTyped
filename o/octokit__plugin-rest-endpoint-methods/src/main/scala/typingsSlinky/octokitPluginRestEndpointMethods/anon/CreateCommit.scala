...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitCreateBlobParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitCreateCommitParams
...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitCreateTreeParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitDeleteRefParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitGetBlobParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitGetCommitParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitGetRefParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitGetTagParams
...
trait CreateCommit extends js.Object {
  @JSName("createBlob")
  var createBlob_Original: `122` = js.native
  /**
    ...
    */
  @JSName("createCommit")
  var createCommit_Original: `123` = js.native
  /**
    * Creates a reference for your repository. You are unable to create new references for empty repositories, even if the commit SHA-1 hash used exists. Empty repositories are repositories without branches.
    */
  @JSName("createRef")
  var createRef_Original: `124` = js.native
  /**
    ...
    */
  @JSName("createTag")
  var createTag_Original: `125` = js.native
  /**
    ...
    */
  @JSName("createTree")
  var createTree_Original: `126` = js.native
  /**
    * ```
    ...
    */
  @JSName("deleteRef")
  var deleteRef_Original: `127` = js.native
  /**
    ...
    */
  @JSName("getBlob")
  var getBlob_Original: `128` = js.native
  /**
    ...
    */
  @JSName("getCommit")
  var getCommit_Original: `129` = js.native
  /**
    ...
    */
  @JSName("getRef")
  var getRef_Original: `130` = js.native
  /**
    * **Signature verification object**
    *
    * The response will include a `verification` object that describes the result of verifying the commit's signature. The following fields are included in the `verification` object:
    ...
    */
  @JSName("getTag")
  var getTag_Original: `131` = js.native
  /**
    ...
    */
  @JSName("getTree")
  var getTree_Original: `132` = js.native
  /**
  ...
  var listMatchingRefs_Original: `133` = js.native
  /**
    ...
    */
  @JSName("listRefs")
  var listRefs_Original: `134` = js.native
  @JSName("updateRef")
  var updateRef_Original: `135` = js.native
