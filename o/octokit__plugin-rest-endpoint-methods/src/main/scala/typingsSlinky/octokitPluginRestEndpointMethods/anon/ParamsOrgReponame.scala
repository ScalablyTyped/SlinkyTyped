...
trait ParamsOrgReponame extends js.Object {
  ...
  var params: OrgReponame = js.native
...
object ParamsOrgReponame {
  ...
  @scala.inline
  implicit class ParamsOrgReponameOps[Self <: ParamsOrgReponame] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OrgReponame): Self = {
        val ret = this.duplicate
