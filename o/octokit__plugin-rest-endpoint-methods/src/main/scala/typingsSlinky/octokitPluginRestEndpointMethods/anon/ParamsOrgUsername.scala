...
trait ParamsOrgUsername extends js.Object {
  ...
  var params: OrgUsername = js.native
...
object ParamsOrgUsername {
  ...
  @scala.inline
  implicit class ParamsOrgUsernameOps[Self <: ParamsOrgUsername] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OrgUsername): Self = {
        val ret = this.duplicate
