...
trait ParamsOrganization extends js.Object {
  ...
  var params: Organization = js.native
...
object ParamsOrganization {
  ...
  @scala.inline
  implicit class ParamsOrganizationOps[Self <: ParamsOrganization] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Organization): Self = {
        val ret = this.duplicate
