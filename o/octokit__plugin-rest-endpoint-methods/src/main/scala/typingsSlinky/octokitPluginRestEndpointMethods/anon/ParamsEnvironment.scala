...
trait ParamsEnvironment extends js.Object {
  ...
  var params: Environment = js.native
...
object ParamsEnvironment {
  ...
  @scala.inline
  implicit class ParamsEnvironmentOps[Self <: ParamsEnvironment] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Environment): Self = {
        val ret = this.duplicate
