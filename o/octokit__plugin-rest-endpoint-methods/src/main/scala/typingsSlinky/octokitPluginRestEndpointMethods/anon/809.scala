...
object `809` {
  ...
  @scala.inline
  implicit class `809Ops`[Self <: `809`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[OrgsPingWebhookEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
