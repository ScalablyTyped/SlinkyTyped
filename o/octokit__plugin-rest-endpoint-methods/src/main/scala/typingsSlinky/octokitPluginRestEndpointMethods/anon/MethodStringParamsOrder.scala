...
object MethodStringParamsOrder {
  ...
  @scala.inline
  implicit class MethodStringParamsOrderOps[Self <: MethodStringParamsOrder] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Order): Self = {
        val ret = this.duplicate
