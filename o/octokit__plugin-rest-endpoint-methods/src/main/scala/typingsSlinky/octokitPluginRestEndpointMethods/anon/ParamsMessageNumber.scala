...
trait ParamsMessageNumber extends js.Object {
  ...
  var params: MessageNumber = js.native
...
object ParamsMessageNumber {
  ...
  @scala.inline
  implicit class ParamsMessageNumberOps[Self <: ParamsMessageNumber] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: MessageNumber): Self = {
        val ret = this.duplicate
