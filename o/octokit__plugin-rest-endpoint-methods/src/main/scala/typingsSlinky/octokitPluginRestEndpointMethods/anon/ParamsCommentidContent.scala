...
trait ParamsCommentidContent extends js.Object {
  ...
  var params: CommentidContent = js.native
...
object ParamsCommentidContent {
  ...
  @scala.inline
  implicit class ParamsCommentidContentOps[Self <: ParamsCommentidContent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: CommentidContent): Self = {
        val ret = this.duplicate
