...
object `801` {
  ...
  @scala.inline
  implicit class `801Ops`[Self <: `801`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[OrgsListPublicMembersEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
