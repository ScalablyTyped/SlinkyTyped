...
object DeprecatedStringHeadersAccept {
  ...
  @scala.inline
  implicit class DeprecatedStringHeadersAcceptOps[Self <: DeprecatedStringHeadersAccept] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OwnerRef): Self = {
        val ret = this.duplicate
