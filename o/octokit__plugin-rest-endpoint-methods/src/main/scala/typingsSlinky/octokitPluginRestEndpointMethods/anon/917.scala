...
object `917` {
  ...
  @scala.inline
  implicit class `917Ops`[Self <: `917`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[ReposDeleteDeployKeyEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
