...
trait ParamsDescription extends js.Object {
  ...
  var params: Description = js.native
...
object ParamsDescription {
  ...
  @scala.inline
  implicit class ParamsDescriptionOps[Self <: ParamsDescription] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Description): Self = {
        val ret = this.duplicate
