...
trait ParamsOrgPagePerpage extends js.Object {
  ...
  var params: OrgPagePerpage = js.native
...
object ParamsOrgPagePerpage {
  ...
  @scala.inline
  implicit class ParamsOrgPagePerpageOps[Self <: ParamsOrgPagePerpage] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OrgPagePerpage): Self = {
        val ret = this.duplicate
