...
trait `802` extends StObject {
  ...
  var parameters: RequestParameters with (Omit[OrgsListInvitationTeamsEndpoint, baseUrl | headers | mediaType]) = js.native
...
object `802` {
  ...
  implicit class `802MutableBuilder`[Self <: `802`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(
      value: RequestParameters with (Omit[OrgsListInvitationTeamsEndpoint, baseUrl | headers | mediaType])
