...
trait ParamsStateUsername extends js.Object {
  ...
  var params: StateUsername = js.native
...
object ParamsStateUsername {
  ...
  @scala.inline
  implicit class ParamsStateUsernameOps[Self <: ParamsStateUsername] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: StateUsername): Self = {
        val ret = this.duplicate
