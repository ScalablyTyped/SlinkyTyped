...
@js.native
trait ParamsDiscussionnumber extends js.Object {
  var deprecated: String = js.native
  var headers: Accept = js.native
  var method: String = js.native
  var params: Discussionnumber = js.native
  var url: String = js.native
}

object ParamsDiscussionnumber {
  @scala.inline
  def apply(deprecated: String, headers: Accept, method: String, params: Discussionnumber, url: String): ParamsDiscussionnumber = {
    ...
    __obj.asInstanceOf[ParamsDiscussionnumber]
  }
  @scala.inline
  implicit class ParamsDiscussionnumberOps[Self <: ParamsDiscussionnumber] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Discussionnumber): Self = {
        val ret = this.duplicate
