...
trait ParamsDirectionFilter extends js.Object {
  ...
  var params: DirectionFilter = js.native
...
object ParamsDirectionFilter {
  ...
  @scala.inline
  implicit class ParamsDirectionFilterOps[Self <: ParamsDirectionFilter] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: DirectionFilter): Self = {
        val ret = this.duplicate
