...
trait ParamsOrgRequired extends js.Object {
  ...
  var params: OrgRequired = js.native
...
object ParamsOrgRequired {
  ...
  @scala.inline
  implicit class ParamsOrgRequiredOps[Self <: ParamsOrgRequired] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OrgRequired): Self = {
        val ret = this.duplicate
