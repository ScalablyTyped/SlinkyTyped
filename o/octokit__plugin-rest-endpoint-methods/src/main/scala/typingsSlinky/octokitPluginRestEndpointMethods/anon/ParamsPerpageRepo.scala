...
trait ParamsPerpageRepo extends js.Object {
  ...
  var params: PerpageRepo = js.native
...
object ParamsPerpageRepo {
  ...
  @scala.inline
  implicit class ParamsPerpageRepoOps[Self <: ParamsPerpageRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: PerpageRepo): Self = {
        val ret = this.duplicate
