...
trait ParamsEmailVisibility extends js.Object {
  ...
  var params: EmailVisibility = js.native
...
object ParamsEmailVisibility {
  ...
  @scala.inline
  implicit class ParamsEmailVisibilityOps[Self <: ParamsEmailVisibility] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: EmailVisibility): Self = {
        val ret = this.duplicate
