...
trait ParamsOrgPermission extends js.Object {
  ...
  var params: OrgPermission = js.native
...
object ParamsOrgPermission {
  ...
  @scala.inline
  implicit class ParamsOrgPermissionOps[Self <: ParamsOrgPermission] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OrgPermission): Self = {
        val ret = this.duplicate
