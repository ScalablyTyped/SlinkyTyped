...
trait ParamsAffiliation extends js.Object {
  ...
  var params: Affiliation = js.native
...
object ParamsAffiliation {
  ...
  @scala.inline
  implicit class ParamsAffiliationOps[Self <: ParamsAffiliation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: Affiliation): Self = {
        val ret = this.duplicate
