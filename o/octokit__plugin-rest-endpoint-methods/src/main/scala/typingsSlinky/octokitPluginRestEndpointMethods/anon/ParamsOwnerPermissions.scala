...
trait ParamsOwnerPermissions extends js.Object {
  ...
  var params: OwnerPermissions = js.native
...
object ParamsOwnerPermissions {
  ...
  @scala.inline
  implicit class ParamsOwnerPermissionsOps[Self <: ParamsOwnerPermissions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: OwnerPermissions): Self = {
        val ret = this.duplicate
