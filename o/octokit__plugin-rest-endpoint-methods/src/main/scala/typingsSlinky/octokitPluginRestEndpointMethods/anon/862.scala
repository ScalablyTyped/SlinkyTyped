...
object `862` {
  ...
  @scala.inline
  implicit class `862Ops`[Self <: `862`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[PullsUpdateEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
