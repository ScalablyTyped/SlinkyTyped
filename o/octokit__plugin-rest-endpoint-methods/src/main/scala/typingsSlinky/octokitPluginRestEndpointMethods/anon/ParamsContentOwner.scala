...
trait ParamsContentOwner extends js.Object {
  ...
  var params: ContentOwner = js.native
...
object ParamsContentOwner {
  ...
  @scala.inline
  implicit class ParamsContentOwnerOps[Self <: ParamsContentOwner] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: ContentOwner): Self = {
        val ret = this.duplicate
