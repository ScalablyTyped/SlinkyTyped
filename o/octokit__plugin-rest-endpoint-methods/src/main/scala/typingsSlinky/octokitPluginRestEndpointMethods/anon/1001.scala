...
object `1001` {
  ...
  @scala.inline
  implicit class `1001Ops`[Self <: `1001`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[ReposListTeamsEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
