...
@js.native
trait `1001` extends StObject {
  
  var parameters: RequestParameters with (Omit[ReposListTeamsEndpoint, baseUrl | headers | mediaType]) = js.native
...
object `1001` {
  ...
  @scala.inline
  implicit class `1001MutableBuilder`[Self <: `1001`] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[ReposListTeamsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
