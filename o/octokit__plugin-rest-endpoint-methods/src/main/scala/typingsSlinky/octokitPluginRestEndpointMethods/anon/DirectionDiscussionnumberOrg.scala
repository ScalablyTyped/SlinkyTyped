...
@js.native
trait DirectionDiscussionnumberOrg extends js.Object {
...
object DirectionDiscussionnumberOrg {
  @scala.inline
  def apply(
    direction: Enum,
    ...
    per_page: Type,
    team_slug: Required
  ): DirectionDiscussionnumberOrg = {
    val __obj = js.Dynamic.literal(direction = direction.asInstanceOf[js.Any], discussion_number = discussion_number.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], per_page = per_page.asInstanceOf[js.Any], team_slug = team_slug.asInstanceOf[js.Any])
    __obj.updateDynamic("org")(org_.asInstanceOf[js.Any])
    __obj.asInstanceOf[DirectionDiscussionnumberOrg]
  }
  @scala.inline
  implicit class DirectionDiscussionnumberOrgOps[Self <: DirectionDiscussionnumberOrg] (val x: Self) extends AnyVal {
    @scala.inline
