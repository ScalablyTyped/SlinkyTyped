...
trait AnonParamsAnonPermission extends js.Object {
  ...
  var params: AnonPermission = js.native
...
object AnonParamsAnonPermission {
  ...
  @scala.inline
  implicit class AnonParamsAnonPermissionOps[Self <: AnonParamsAnonPermission] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonPermission): Self = {
        val ret = this.duplicate
