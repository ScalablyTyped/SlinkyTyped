...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksCreateParams
...
@js.native
trait AnonCreateSuite extends js.Object {
  /**
    ...
    */
  @JSName("createSuite")
  var createSuite_Original: Anon90 = js.native
  /**
    ...
    */
  @JSName("create")
  var create_Original: Anon89 = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array and a `null` value for `head_branch`.
    *
    ...
    */
  @JSName("getSuite")
  var getSuite_Original: Anon92 = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
  ...
  /**
    ...
    */
  @JSName("listForRef")
  var listForRef_Original: Anon94 = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    ...
    */
  @JSName("listForSuite")
  var listForSuite_Original: Anon95 = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array and a `null` value for `head_branch`.
    *
  ...
  var listSuitesForRef_Original: Anon96 = js.native
  /**
  ...
  var rerequestSuite_Original: Anon97 = js.native
  /**
  ...
  var setSuitesPreferences_Original: Anon98 = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    ...
    */
  @JSName("update")
  var update_Original: Anon99 = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    * Creates a new check run for a specific commit in a repository. Your GitHub App must have the `checks:write` permission to create check runs.
