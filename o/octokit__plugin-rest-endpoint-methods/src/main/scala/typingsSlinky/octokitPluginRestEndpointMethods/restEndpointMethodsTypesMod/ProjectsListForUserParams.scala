...
object ProjectsListForUserParams {
  @scala.inline
  def apply(username: String): ProjectsListForUserParams = {
    val __obj = js.Dynamic.literal(username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectsListForUserParams]
  }
  @scala.inline
  implicit class ProjectsListForUserParamsOps[Self <: ProjectsListForUserParams] (val x: Self) extends AnyVal {
    @scala.inline
