...
@js.native
trait PullsGetResponseBaseRepo extends js.Object {
  ...
  var owner: PullsGetResponseBaseRepoOwner = js.native
  var permissions: PullsGetResponseBaseRepoPermissions = js.native
...
object PullsGetResponseBaseRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsGetResponseBaseRepo]
  }
  @scala.inline
  implicit class PullsGetResponseBaseRepoOps[Self <: PullsGetResponseBaseRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsGetResponseBaseRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsGetResponseBaseRepoPermissions): Self = {
        val ret = this.duplicate
