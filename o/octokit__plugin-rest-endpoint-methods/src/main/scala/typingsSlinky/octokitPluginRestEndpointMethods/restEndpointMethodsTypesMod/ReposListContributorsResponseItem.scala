...
object ReposListContributorsResponseItem {
  ...
  @scala.inline
  implicit class ReposListContributorsResponseItemOps[Self <: ReposListContributorsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withContributions(value: Double): Self = {
        val ret = this.duplicate
