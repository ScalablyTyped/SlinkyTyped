...
object ReposCompareCommitsResponseCommitsItemCommitCommitter {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseCommitsItemCommitCommitterOps[Self <: ReposCompareCommitsResponseCommitsItemCommitCommitter] (val x: Self) extends AnyVal {
    @scala.inline
