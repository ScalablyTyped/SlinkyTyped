...
object ReposCreateDeploymentParams {
  ...
  def apply(
    ...
    if (!js.isUndefined(auto_merge)) __obj.updateDynamic("auto_merge")(auto_merge.get.asInstanceOf[js.Any])
    if (description != null) __obj.updateDynamic("description")(description.asInstanceOf[js.Any])
    if (environment != null) __obj.updateDynamic("environment")(environment.asInstanceOf[js.Any])
    if (payload != null) __obj.updateDynamic("payload")(payload.asInstanceOf[js.Any])
    if (!js.isUndefined(production_environment)) __obj.updateDynamic("production_environment")(production_environment.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(transient_environment)) __obj.updateDynamic("transient_environment")(transient_environment.get.asInstanceOf[js.Any])
