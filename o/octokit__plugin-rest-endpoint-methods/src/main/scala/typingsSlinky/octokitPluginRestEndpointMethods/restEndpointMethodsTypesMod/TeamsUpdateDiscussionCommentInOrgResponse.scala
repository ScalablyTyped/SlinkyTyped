...
@js.native
trait TeamsUpdateDiscussionCommentInOrgResponse extends js.Object {
  var author: TeamsUpdateDiscussionCommentInOrgResponseAuthor = js.native
  ...
  var reactions: TeamsUpdateDiscussionCommentInOrgResponseReactions = js.native
  var updated_at: String = js.native
  var url: String = js.native
}

object TeamsUpdateDiscussionCommentInOrgResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentInOrgResponse]
  }
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentInOrgResponseOps[Self <: TeamsUpdateDiscussionCommentInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsUpdateDiscussionCommentInOrgResponseAuthor): Self = {
    ...
    @scala.inline
    def withLast_edited_at(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReactions(value: TeamsUpdateDiscussionCommentInOrgResponseReactions): Self = {
        val ret = this.duplicate
