...
@js.native
trait IssuesUpdateCommentResponseUser extends js.Object {
...
object IssuesUpdateCommentResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesUpdateCommentResponseUser]
  }
  @scala.inline
  implicit class IssuesUpdateCommentResponseUserOps[Self <: IssuesUpdateCommentResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
