...
trait ProjectsListForRepoResponseItem extends js.Object {
  ...
  var creator: ProjectsListForRepoResponseItemCreator = js.native
...
object ProjectsListForRepoResponseItem {
  ...
  @scala.inline
  implicit class ProjectsListForRepoResponseItemOps[Self <: ProjectsListForRepoResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsListForRepoResponseItemCreator): Self = {
        val ret = this.duplicate
