...
@js.native
trait ReposGetCommitResponseCommitter extends js.Object {
...
object ReposGetCommitResponseCommitter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetCommitResponseCommitter]
  }
  @scala.inline
  implicit class ReposGetCommitResponseCommitterOps[Self <: ReposGetCommitResponseCommitter] (val x: Self) extends AnyVal {
    @scala.inline
