...
object ReposCreateCommitCommentParams {
  @scala.inline
  def apply(body: String, commit_sha: String, owner: String, repo: String): ReposCreateCommitCommentParams = {
  ...
  @scala.inline
  implicit class ReposCreateCommitCommentParamsOps[Self <: ReposCreateCommitCommentParams] (val x: Self) extends AnyVal {
    @scala.inline
