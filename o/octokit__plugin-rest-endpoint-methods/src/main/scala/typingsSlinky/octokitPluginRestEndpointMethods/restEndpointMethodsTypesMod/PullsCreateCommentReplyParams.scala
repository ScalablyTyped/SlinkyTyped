...
object PullsCreateCommentReplyParams {
  @scala.inline
  def apply(body: String, commit_id: String, owner: String, path: String, pull_number: Double, repo: String): PullsCreateCommentReplyParams = {
  ...
  @scala.inline
  implicit class PullsCreateCommentReplyParamsOps[Self <: PullsCreateCommentReplyParams] (val x: Self) extends AnyVal {
    @scala.inline
