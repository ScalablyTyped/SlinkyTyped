...
trait ReactionsListForIssueCommentResponseItem extends js.Object {
  ...
  var user: ReactionsListForIssueCommentResponseItemUser = js.native
}
...
object ReactionsListForIssueCommentResponseItem {
  ...
  @scala.inline
  implicit class ReactionsListForIssueCommentResponseItemOps[Self <: ReactionsListForIssueCommentResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsListForIssueCommentResponseItemUser): Self = {
        val ret = this.duplicate
