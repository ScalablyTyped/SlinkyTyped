...
object ReposRemoveProtectedBranchRequiredStatusChecksParams {
  ...
  @scala.inline
  implicit class ReposRemoveProtectedBranchRequiredStatusChecksParamsOps[Self <: ReposRemoveProtectedBranchRequiredStatusChecksParams] (val x: Self) extends AnyVal {
    @scala.inline
