...
object AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlan {
  ...
  @scala.inline
  implicit class AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlanOps[Self <: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlan] (val x: Self) extends AnyVal {
    @scala.inline
