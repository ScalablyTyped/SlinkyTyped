...
object ReposListInvitationsForAuthenticatedUserResponseItemInviter {
  ...
  @scala.inline
  implicit class ReposListInvitationsForAuthenticatedUserResponseItemInviterOps[Self <: ReposListInvitationsForAuthenticatedUserResponseItemInviter] (val x: Self) extends AnyVal {
    @scala.inline
