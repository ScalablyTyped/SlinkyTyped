...
@js.native
trait PullsCreateReviewRequestResponseHeadUser extends js.Object {
...
object PullsCreateReviewRequestResponseHeadUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseHeadUser]
  }
  @scala.inline
  implicit class PullsCreateReviewRequestResponseHeadUserOps[Self <: PullsCreateReviewRequestResponseHeadUser] (val x: Self) extends AnyVal {
    @scala.inline
