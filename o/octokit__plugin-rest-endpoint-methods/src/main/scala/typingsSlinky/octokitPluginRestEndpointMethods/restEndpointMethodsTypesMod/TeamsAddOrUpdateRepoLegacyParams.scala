...
object TeamsAddOrUpdateRepoLegacyParams {
  @scala.inline
  def apply(owner: String, repo: String, team_id: Double): TeamsAddOrUpdateRepoLegacyParams = {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateRepoLegacyParamsOps[Self <: TeamsAddOrUpdateRepoLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
