...
object ReposUpdateBranchProtectionResponseRestrictionsUsersItem {
  ...
  @scala.inline
  implicit class ReposUpdateBranchProtectionResponseRestrictionsUsersItemOps[Self <: ReposUpdateBranchProtectionResponseRestrictionsUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
