...
trait ChecksUpdateResponse extends js.Object {
  var app: ChecksUpdateResponseApp = js.native
  var check_suite: ChecksUpdateResponseCheckSuite = js.native
  ...
  var output: ChecksUpdateResponseOutput = js.native
  var pull_requests: js.Array[ChecksUpdateResponsePullRequestsItem] = js.native
...
object ChecksUpdateResponse {
  ...
  @scala.inline
  implicit class ChecksUpdateResponseOps[Self <: ChecksUpdateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: ChecksUpdateResponseApp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("app")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCheck_suite(value: ChecksUpdateResponseCheckSuite): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOutput(value: ChecksUpdateResponseOutput): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("output")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPull_requests(value: js.Array[ChecksUpdateResponsePullRequestsItem]): Self = {
        val ret = this.duplicate
