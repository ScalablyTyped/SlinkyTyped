...
trait ChecksGetSuiteResponseApp extends js.Object {
  ...
  var owner: ChecksGetSuiteResponseAppOwner = js.native
  var permissions: ChecksGetSuiteResponseAppPermissions = js.native
...
object ChecksGetSuiteResponseApp {
  ...
  @scala.inline
  implicit class ChecksGetSuiteResponseAppOps[Self <: ChecksGetSuiteResponseApp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksGetSuiteResponseAppOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksGetSuiteResponseAppPermissions): Self = {
        val ret = this.duplicate
