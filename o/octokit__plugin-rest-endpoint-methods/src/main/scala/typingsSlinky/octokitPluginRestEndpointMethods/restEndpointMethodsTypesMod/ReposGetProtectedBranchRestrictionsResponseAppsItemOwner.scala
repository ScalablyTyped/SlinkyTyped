...
object ReposGetProtectedBranchRestrictionsResponseAppsItemOwner {
  ...
  @scala.inline
  implicit class ReposGetProtectedBranchRestrictionsResponseAppsItemOwnerOps[Self <: ReposGetProtectedBranchRestrictionsResponseAppsItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
