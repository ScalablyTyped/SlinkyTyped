...
trait OrgsUpdateMembershipResponse extends js.Object {
  var organization: OrgsUpdateMembershipResponseOrganization = js.native
  var organization_url: String = js.native
  var role: String = js.native
  var state: String = js.native
  var url: String = js.native
  var user: OrgsUpdateMembershipResponseUser = js.native
}
...
object OrgsUpdateMembershipResponse {
  ...
  @scala.inline
  implicit class OrgsUpdateMembershipResponseOps[Self <: OrgsUpdateMembershipResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withOrganization(value: OrgsUpdateMembershipResponseOrganization): Self = {
    ...
    @scala.inline
    def withUser(value: OrgsUpdateMembershipResponseUser): Self = {
        val ret = this.duplicate
