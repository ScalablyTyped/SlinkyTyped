...
trait ReposReplaceProtectedBranchAppRestrictionsResponseItem extends js.Object {
  ...
  var owner: ReposReplaceProtectedBranchAppRestrictionsResponseItemOwner = js.native
  var permissions: ReposReplaceProtectedBranchAppRestrictionsResponseItemPermissions = js.native
...
object ReposReplaceProtectedBranchAppRestrictionsResponseItem {
  ...
  @scala.inline
  implicit class ReposReplaceProtectedBranchAppRestrictionsResponseItemOps[Self <: ReposReplaceProtectedBranchAppRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposReplaceProtectedBranchAppRestrictionsResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposReplaceProtectedBranchAppRestrictionsResponseItemPermissions): Self = {
        val ret = this.duplicate
