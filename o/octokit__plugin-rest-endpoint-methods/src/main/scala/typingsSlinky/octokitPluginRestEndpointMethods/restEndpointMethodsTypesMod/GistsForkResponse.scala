...
trait GistsForkResponse extends js.Object {
  ...
  var files: GistsForkResponseFiles = js.native
  ...
  var owner: GistsForkResponseOwner = js.native
...
object GistsForkResponse {
  ...
  @scala.inline
  implicit class GistsForkResponseOps[Self <: GistsForkResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsForkResponseFiles): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsForkResponseOwner): Self = {
        val ret = this.duplicate
