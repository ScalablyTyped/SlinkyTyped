...
@js.native
trait ReposGetCombinedStatusForRefResponseRepositoryOwner extends js.Object {
...
object ReposGetCombinedStatusForRefResponseRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetCombinedStatusForRefResponseRepositoryOwner]
  }
  @scala.inline
  implicit class ReposGetCombinedStatusForRefResponseRepositoryOwnerOps[Self <: ReposGetCombinedStatusForRefResponseRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
