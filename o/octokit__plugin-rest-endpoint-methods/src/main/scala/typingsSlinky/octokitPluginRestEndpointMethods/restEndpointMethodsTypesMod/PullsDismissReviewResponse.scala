...
trait PullsDismissReviewResponse extends js.Object {
  var _links: PullsDismissReviewResponseLinks = js.native
  ...
  var user: PullsDismissReviewResponseUser = js.native
}
...
object PullsDismissReviewResponse {
  ...
  @scala.inline
  implicit class PullsDismissReviewResponseOps[Self <: PullsDismissReviewResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsDismissReviewResponseLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsDismissReviewResponseUser): Self = {
        val ret = this.duplicate
