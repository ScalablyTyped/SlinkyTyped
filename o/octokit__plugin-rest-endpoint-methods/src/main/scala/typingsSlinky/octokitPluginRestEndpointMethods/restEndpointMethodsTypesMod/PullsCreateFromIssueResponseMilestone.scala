...
trait PullsCreateFromIssueResponseMilestone extends js.Object {
  ...
  var creator: PullsCreateFromIssueResponseMilestoneCreator = js.native
...
object PullsCreateFromIssueResponseMilestone {
  ...
  @scala.inline
  implicit class PullsCreateFromIssueResponseMilestoneOps[Self <: PullsCreateFromIssueResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: PullsCreateFromIssueResponseMilestoneCreator): Self = {
        val ret = this.duplicate
