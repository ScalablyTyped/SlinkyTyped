...
trait ReposGetContentsResponseItem extends js.Object {
  var _links: ReposGetContentsResponseItemLinks = js.native
...
object ReposGetContentsResponseItem {
  ...
  @scala.inline
  implicit class ReposGetContentsResponseItemOps[Self <: ReposGetContentsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: ReposGetContentsResponseItemLinks): Self = {
