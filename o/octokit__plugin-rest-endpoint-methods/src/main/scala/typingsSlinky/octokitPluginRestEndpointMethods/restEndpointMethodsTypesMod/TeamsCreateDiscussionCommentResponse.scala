...
trait TeamsCreateDiscussionCommentResponse extends js.Object {
  var author: TeamsCreateDiscussionCommentResponseAuthor = js.native
  ...
  var reactions: TeamsCreateDiscussionCommentResponseReactions = js.native
...
object TeamsCreateDiscussionCommentResponse {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionCommentResponseOps[Self <: TeamsCreateDiscussionCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsCreateDiscussionCommentResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsCreateDiscussionCommentResponseReactions): Self = {
        val ret = this.duplicate
