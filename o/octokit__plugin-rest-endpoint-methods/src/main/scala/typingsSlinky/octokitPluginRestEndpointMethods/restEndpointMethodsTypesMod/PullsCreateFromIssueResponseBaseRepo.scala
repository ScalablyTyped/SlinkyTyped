...
trait PullsCreateFromIssueResponseBaseRepo extends js.Object {
  ...
  var owner: PullsCreateFromIssueResponseBaseRepoOwner = js.native
  var permissions: PullsCreateFromIssueResponseBaseRepoPermissions = js.native
...
object PullsCreateFromIssueResponseBaseRepo {
  ...
  @scala.inline
  implicit class PullsCreateFromIssueResponseBaseRepoOps[Self <: PullsCreateFromIssueResponseBaseRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsCreateFromIssueResponseBaseRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsCreateFromIssueResponseBaseRepoPermissions): Self = {
        val ret = this.duplicate
