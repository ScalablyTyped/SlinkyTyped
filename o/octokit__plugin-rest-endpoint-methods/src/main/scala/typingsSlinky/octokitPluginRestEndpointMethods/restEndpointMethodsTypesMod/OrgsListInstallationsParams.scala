...
object OrgsListInstallationsParams {
  @scala.inline
  def apply(org_ : String): OrgsListInstallationsParams = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("org")(org_.asInstanceOf[js.Any])
    __obj.asInstanceOf[OrgsListInstallationsParams]
  }
  @scala.inline
  implicit class OrgsListInstallationsParamsOps[Self <: OrgsListInstallationsParams] (val x: Self) extends AnyVal {
    @scala.inline
