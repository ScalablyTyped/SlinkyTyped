...
object ReposListCommentsForCommitParams {
  @scala.inline
  def apply(commit_sha: String, owner: String, repo: String): ReposListCommentsForCommitParams = {
  ...
  @scala.inline
  implicit class ReposListCommentsForCommitParamsOps[Self <: ReposListCommentsForCommitParams] (val x: Self) extends AnyVal {
    @scala.inline
