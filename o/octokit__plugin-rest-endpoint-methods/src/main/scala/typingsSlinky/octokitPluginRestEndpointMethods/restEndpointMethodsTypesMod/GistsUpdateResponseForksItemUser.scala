...
@js.native
trait GistsUpdateResponseForksItemUser extends js.Object {
...
object GistsUpdateResponseForksItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[GistsUpdateResponseForksItemUser]
  }
  @scala.inline
  implicit class GistsUpdateResponseForksItemUserOps[Self <: GistsUpdateResponseForksItemUser] (val x: Self) extends AnyVal {
    @scala.inline
