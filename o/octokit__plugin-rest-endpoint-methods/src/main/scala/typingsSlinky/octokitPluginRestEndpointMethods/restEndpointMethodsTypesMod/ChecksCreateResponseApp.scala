...
trait ChecksCreateResponseApp extends js.Object {
  ...
  var owner: ChecksCreateResponseAppOwner = js.native
  var permissions: ChecksCreateResponseAppPermissions = js.native
...
object ChecksCreateResponseApp {
  ...
  @scala.inline
  implicit class ChecksCreateResponseAppOps[Self <: ChecksCreateResponseApp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksCreateResponseAppOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksCreateResponseAppPermissions): Self = {
        val ret = this.duplicate
