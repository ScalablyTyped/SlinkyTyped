...
trait ReposListContributorsParams extends js.Object {
  /**
    ...
    */
  var anon: js.UndefOr[String] = js.native
...
object ReposListContributorsParams {
  @scala.inline
  def apply(owner: String, repo: String): ReposListContributorsParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposListContributorsParams]
  }
  @scala.inline
  implicit class ReposListContributorsParamsOps[Self <: ReposListContributorsParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAnon(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("anon")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAnon: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("anon")(js.undefined)
        ret
    }
    @scala.inline
