...
trait ReposGetReleaseByTagResponse extends js.Object {
  var assets: js.Array[ReposGetReleaseByTagResponseAssetsItem] = js.native
  var assets_url: String = js.native
  var author: ReposGetReleaseByTagResponseAuthor = js.native
...
object ReposGetReleaseByTagResponse {
  ...
  @scala.inline
  implicit class ReposGetReleaseByTagResponseOps[Self <: ReposGetReleaseByTagResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAssets(value: js.Array[ReposGetReleaseByTagResponseAssetsItem]): Self = {
    ...
    @scala.inline
    def withAuthor(value: ReposGetReleaseByTagResponseAuthor): Self = {
        val ret = this.duplicate
