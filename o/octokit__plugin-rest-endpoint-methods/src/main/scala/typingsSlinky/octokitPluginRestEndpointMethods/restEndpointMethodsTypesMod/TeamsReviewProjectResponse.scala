...
trait TeamsReviewProjectResponse extends js.Object {
  ...
  var creator: TeamsReviewProjectResponseCreator = js.native
  ...
  var permissions: TeamsReviewProjectResponsePermissions = js.native
...
object TeamsReviewProjectResponse {
  ...
  @scala.inline
  implicit class TeamsReviewProjectResponseOps[Self <: TeamsReviewProjectResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: TeamsReviewProjectResponseCreator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: TeamsReviewProjectResponsePermissions): Self = {
        val ret = this.duplicate
