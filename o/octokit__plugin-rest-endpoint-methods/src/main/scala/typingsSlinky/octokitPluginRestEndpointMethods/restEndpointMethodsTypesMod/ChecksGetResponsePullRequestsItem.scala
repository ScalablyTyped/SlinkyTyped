...
trait ChecksGetResponsePullRequestsItem extends js.Object {
  var base: ChecksGetResponsePullRequestsItemBase = js.native
  var head: ChecksGetResponsePullRequestsItemHead = js.native
...
object ChecksGetResponsePullRequestsItem {
  ...
  @scala.inline
  implicit class ChecksGetResponsePullRequestsItemOps[Self <: ChecksGetResponsePullRequestsItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBase(value: ChecksGetResponsePullRequestsItemBase): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("base")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHead(value: ChecksGetResponsePullRequestsItemHead): Self = {
        val ret = this.duplicate
