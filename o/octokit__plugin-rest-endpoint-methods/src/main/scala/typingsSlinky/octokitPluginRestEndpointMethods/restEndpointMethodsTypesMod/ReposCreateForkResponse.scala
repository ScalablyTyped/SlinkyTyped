...
trait ReposCreateForkResponse extends js.Object {
  ...
  var owner: ReposCreateForkResponseOwner = js.native
  var permissions: ReposCreateForkResponsePermissions = js.native
...
object ReposCreateForkResponse {
  ...
  @scala.inline
  implicit class ReposCreateForkResponseOps[Self <: ReposCreateForkResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposCreateForkResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposCreateForkResponsePermissions): Self = {
        val ret = this.duplicate
