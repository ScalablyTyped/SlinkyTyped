...
trait AppsGetRepoInstallationResponse extends js.Object {
  ...
  var account: AppsGetRepoInstallationResponseAccount = js.native
  var app_id: Double = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: AppsGetRepoInstallationResponsePermissions = js.native
...
object AppsGetRepoInstallationResponse {
  ...
  @scala.inline
  implicit class AppsGetRepoInstallationResponseOps[Self <: AppsGetRepoInstallationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: AppsGetRepoInstallationResponseAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: AppsGetRepoInstallationResponsePermissions): Self = {
        val ret = this.duplicate
