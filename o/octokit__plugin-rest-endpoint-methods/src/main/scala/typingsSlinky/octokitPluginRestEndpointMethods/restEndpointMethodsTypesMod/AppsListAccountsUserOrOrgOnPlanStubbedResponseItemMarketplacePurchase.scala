...
trait AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchase extends js.Object {
  ...
  var plan: AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlan = js.native
...
object AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchase {
  ...
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchaseOps[Self <: AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPlan(value: AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlan): Self = {
        val ret = this.duplicate
