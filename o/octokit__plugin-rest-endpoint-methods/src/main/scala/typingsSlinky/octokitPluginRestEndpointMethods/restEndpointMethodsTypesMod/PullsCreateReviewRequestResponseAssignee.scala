...
@js.native
trait PullsCreateReviewRequestResponseAssignee extends js.Object {
...
object PullsCreateReviewRequestResponseAssignee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseAssignee]
  }
  @scala.inline
  implicit class PullsCreateReviewRequestResponseAssigneeOps[Self <: PullsCreateReviewRequestResponseAssignee] (val x: Self) extends AnyVal {
    @scala.inline
