...
@js.native
trait ReposGetResponseOrganization extends js.Object {
...
object ReposGetResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetResponseOrganization]
  }
  @scala.inline
  implicit class ReposGetResponseOrganizationOps[Self <: ReposGetResponseOrganization] (val x: Self) extends AnyVal {
    @scala.inline
