...
object ActionsListDownloadsForSelfHostedRunnerApplicationParams {
  ...
  @scala.inline
  implicit class ActionsListDownloadsForSelfHostedRunnerApplicationParamsOps[Self <: ActionsListDownloadsForSelfHostedRunnerApplicationParams] (val x: Self) extends AnyVal {
    @scala.inline
