...
trait PullsCreateFromIssueResponseHead extends js.Object {
  ...
  var repo: PullsCreateFromIssueResponseHeadRepo = js.native
  var sha: String = js.native
  var user: PullsCreateFromIssueResponseHeadUser = js.native
}
...
object PullsCreateFromIssueResponseHead {
  ...
  @scala.inline
  implicit class PullsCreateFromIssueResponseHeadOps[Self <: PullsCreateFromIssueResponseHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsCreateFromIssueResponseHeadRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsCreateFromIssueResponseHeadUser): Self = {
        val ret = this.duplicate
