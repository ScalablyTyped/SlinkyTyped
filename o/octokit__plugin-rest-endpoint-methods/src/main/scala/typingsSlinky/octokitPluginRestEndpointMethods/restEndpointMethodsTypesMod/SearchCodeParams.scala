...
import typingsSlinky.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.indexed
...
object SearchCodeParams {
  @scala.inline
  def apply(q: String): SearchCodeParams = {
    val __obj = js.Dynamic.literal(q = q.asInstanceOf[js.Any])
    __obj.asInstanceOf[SearchCodeParams]
  }
  @scala.inline
  implicit class SearchCodeParamsOps[Self <: SearchCodeParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSort(value: indexed): Self = {
        val ret = this.duplicate
