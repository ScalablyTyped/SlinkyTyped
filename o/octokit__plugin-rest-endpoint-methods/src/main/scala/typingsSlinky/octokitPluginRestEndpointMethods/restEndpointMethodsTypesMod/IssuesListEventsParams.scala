...
@js.native
trait IssuesListEventsParams extends js.Object {
...
object IssuesListEventsParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesListEventsParams = {
    ...
    __obj.asInstanceOf[IssuesListEventsParams]
  }
  @scala.inline
  implicit class IssuesListEventsParamsOps[Self <: IssuesListEventsParams] (val x: Self) extends AnyVal {
    @scala.inline
