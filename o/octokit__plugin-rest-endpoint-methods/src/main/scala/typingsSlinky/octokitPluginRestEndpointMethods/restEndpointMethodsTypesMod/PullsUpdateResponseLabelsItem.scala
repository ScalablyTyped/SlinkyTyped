...
@js.native
trait PullsUpdateResponseLabelsItem extends js.Object {
...
object PullsUpdateResponseLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[PullsUpdateResponseLabelsItem]
  }
  @scala.inline
  implicit class PullsUpdateResponseLabelsItemOps[Self <: PullsUpdateResponseLabelsItem] (val x: Self) extends AnyVal {
    @scala.inline
