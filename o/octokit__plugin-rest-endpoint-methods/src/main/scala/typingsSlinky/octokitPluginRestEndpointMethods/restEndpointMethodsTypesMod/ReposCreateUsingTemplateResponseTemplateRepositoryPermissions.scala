...
object ReposCreateUsingTemplateResponseTemplateRepositoryPermissions {
  ...
  @scala.inline
  implicit class ReposCreateUsingTemplateResponseTemplateRepositoryPermissionsOps[Self <: ReposCreateUsingTemplateResponseTemplateRepositoryPermissions] (val x: Self) extends AnyVal {
    @scala.inline
