...
trait ReposGetReleaseResponseAssetsItem extends js.Object {
  ...
  var uploader: ReposGetReleaseResponseAssetsItemUploader = js.native
...
object ReposGetReleaseResponseAssetsItem {
  ...
  @scala.inline
  implicit class ReposGetReleaseResponseAssetsItemOps[Self <: ReposGetReleaseResponseAssetsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposGetReleaseResponseAssetsItemUploader): Self = {
        val ret = this.duplicate
