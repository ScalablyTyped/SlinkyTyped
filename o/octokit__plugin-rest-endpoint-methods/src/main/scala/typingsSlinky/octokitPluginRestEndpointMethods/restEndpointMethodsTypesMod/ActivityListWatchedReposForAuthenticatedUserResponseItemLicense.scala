...
object ActivityListWatchedReposForAuthenticatedUserResponseItemLicense {
  ...
  @scala.inline
  implicit class ActivityListWatchedReposForAuthenticatedUserResponseItemLicenseOps[Self <: ActivityListWatchedReposForAuthenticatedUserResponseItemLicense] (val x: Self) extends AnyVal {
    @scala.inline
