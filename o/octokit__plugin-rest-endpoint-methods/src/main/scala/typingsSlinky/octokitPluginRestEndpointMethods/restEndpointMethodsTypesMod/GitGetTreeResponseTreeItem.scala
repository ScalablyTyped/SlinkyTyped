...
object GitGetTreeResponseTreeItem {
  @scala.inline
  def apply(mode: String, path: String, sha: String, `type`: String, url: String): GitGetTreeResponseTreeItem = {
  ...
  @scala.inline
  implicit class GitGetTreeResponseTreeItemOps[Self <: GitGetTreeResponseTreeItem] (val x: Self) extends AnyVal {
    @scala.inline
