...
trait TeamsListForAuthenticatedUserResponseItem extends js.Object {
  ...
  var organization: TeamsListForAuthenticatedUserResponseItemOrganization = js.native
...
object TeamsListForAuthenticatedUserResponseItem {
  ...
  @scala.inline
  implicit class TeamsListForAuthenticatedUserResponseItemOps[Self <: TeamsListForAuthenticatedUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOrganization(value: TeamsListForAuthenticatedUserResponseItemOrganization): Self = {
        val ret = this.duplicate
