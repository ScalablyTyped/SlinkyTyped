...
trait AppsGetAuthenticatedResponse extends js.Object {
  ...
  var owner: AppsGetAuthenticatedResponseOwner = js.native
  var permissions: AppsGetAuthenticatedResponsePermissions = js.native
...
object AppsGetAuthenticatedResponse {
  ...
  @scala.inline
  implicit class AppsGetAuthenticatedResponseOps[Self <: AppsGetAuthenticatedResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInstallations_count(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("installations_count")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: AppsGetAuthenticatedResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: AppsGetAuthenticatedResponsePermissions): Self = {
        val ret = this.duplicate
