...
object ProjectsListColumnsParams {
  @scala.inline
  def apply(project_id: Double): ProjectsListColumnsParams = {
    val __obj = js.Dynamic.literal(project_id = project_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectsListColumnsParams]
  }
  @scala.inline
  implicit class ProjectsListColumnsParamsOps[Self <: ProjectsListColumnsParams] (val x: Self) extends AnyVal {
    @scala.inline
