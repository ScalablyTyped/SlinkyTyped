...
@js.native
trait PullsListCommitsResponseItemAuthor extends js.Object {
...
object PullsListCommitsResponseItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsListCommitsResponseItemAuthor]
  }
  @scala.inline
  implicit class PullsListCommitsResponseItemAuthorOps[Self <: PullsListCommitsResponseItemAuthor] (val x: Self) extends AnyVal {
    @scala.inline
