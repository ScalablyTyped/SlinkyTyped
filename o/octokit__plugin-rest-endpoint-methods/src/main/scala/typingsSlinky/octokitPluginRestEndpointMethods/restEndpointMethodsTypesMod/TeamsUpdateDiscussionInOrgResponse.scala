...
trait TeamsUpdateDiscussionInOrgResponse extends js.Object {
  var author: TeamsUpdateDiscussionInOrgResponseAuthor = js.native
  ...
  var reactions: TeamsUpdateDiscussionInOrgResponseReactions = js.native
...
object TeamsUpdateDiscussionInOrgResponse {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionInOrgResponseOps[Self <: TeamsUpdateDiscussionInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsUpdateDiscussionInOrgResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsUpdateDiscussionInOrgResponseReactions): Self = {
        val ret = this.duplicate
