...
object ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwner {
  ...
  @scala.inline
  implicit class ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwnerOps[Self <: ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
