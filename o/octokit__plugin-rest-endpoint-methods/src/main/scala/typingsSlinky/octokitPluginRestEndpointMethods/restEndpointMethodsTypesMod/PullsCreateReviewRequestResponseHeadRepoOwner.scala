...
@js.native
trait PullsCreateReviewRequestResponseHeadRepoOwner extends js.Object {
...
object PullsCreateReviewRequestResponseHeadRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseHeadRepoOwner]
  }
  @scala.inline
  implicit class PullsCreateReviewRequestResponseHeadRepoOwnerOps[Self <: PullsCreateReviewRequestResponseHeadRepoOwner] (val x: Self) extends AnyVal {
    @scala.inline
