...
trait ActionsGetWorkflowRunResponseRepository extends js.Object {
  ...
  var owner: ActionsGetWorkflowRunResponseRepositoryOwner = js.native
...
object ActionsGetWorkflowRunResponseRepository {
  ...
  @scala.inline
  implicit class ActionsGetWorkflowRunResponseRepositoryOps[Self <: ActionsGetWorkflowRunResponseRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActionsGetWorkflowRunResponseRepositoryOwner): Self = {
        val ret = this.duplicate
