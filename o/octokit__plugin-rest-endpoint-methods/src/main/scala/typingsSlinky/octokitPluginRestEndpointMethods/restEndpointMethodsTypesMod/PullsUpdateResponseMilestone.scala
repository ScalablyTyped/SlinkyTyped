...
trait PullsUpdateResponseMilestone extends js.Object {
  ...
  var creator: PullsUpdateResponseMilestoneCreator = js.native
...
object PullsUpdateResponseMilestone {
  ...
  @scala.inline
  implicit class PullsUpdateResponseMilestoneOps[Self <: PullsUpdateResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: PullsUpdateResponseMilestoneCreator): Self = {
        val ret = this.duplicate
