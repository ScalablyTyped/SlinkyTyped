...
trait ReposListInvitationsResponseItemRepository extends js.Object {
  ...
  var owner: ReposListInvitationsResponseItemRepositoryOwner = js.native
...
object ReposListInvitationsResponseItemRepository {
  ...
  @scala.inline
  implicit class ReposListInvitationsResponseItemRepositoryOps[Self <: ReposListInvitationsResponseItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposListInvitationsResponseItemRepositoryOwner): Self = {
        val ret = this.duplicate
