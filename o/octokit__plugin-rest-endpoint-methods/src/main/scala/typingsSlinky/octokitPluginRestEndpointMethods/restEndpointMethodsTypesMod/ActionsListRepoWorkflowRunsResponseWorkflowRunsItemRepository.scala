...
trait ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepository extends js.Object {
  ...
  var owner: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepositoryOwner = js.native
...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepository {
  ...
  @scala.inline
  implicit class ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepositoryOps[Self <: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepositoryOwner): Self = {
        val ret = this.duplicate
