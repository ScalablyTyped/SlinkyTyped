...
@js.native
trait ReposGetLatestPagesBuildResponseError extends js.Object {
...
object ReposGetLatestPagesBuildResponseError {
  ...
  @scala.inline
  implicit class ReposGetLatestPagesBuildResponseErrorOps[Self <: ReposGetLatestPagesBuildResponseError] (val x: Self) extends AnyVal {
    @scala.inline
