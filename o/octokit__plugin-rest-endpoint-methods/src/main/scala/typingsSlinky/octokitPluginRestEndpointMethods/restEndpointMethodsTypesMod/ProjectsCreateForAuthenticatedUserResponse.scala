...
trait ProjectsCreateForAuthenticatedUserResponse extends js.Object {
  ...
  var creator: ProjectsCreateForAuthenticatedUserResponseCreator = js.native
...
object ProjectsCreateForAuthenticatedUserResponse {
  ...
  @scala.inline
  implicit class ProjectsCreateForAuthenticatedUserResponseOps[Self <: ProjectsCreateForAuthenticatedUserResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsCreateForAuthenticatedUserResponseCreator): Self = {
        val ret = this.duplicate
