...
trait ReposListAssetsForReleaseResponseItem extends js.Object {
  ...
  var uploader: ReposListAssetsForReleaseResponseItemUploader = js.native
...
object ReposListAssetsForReleaseResponseItem {
  ...
  @scala.inline
  implicit class ReposListAssetsForReleaseResponseItemOps[Self <: ReposListAssetsForReleaseResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposListAssetsForReleaseResponseItemUploader): Self = {
        val ret = this.duplicate
