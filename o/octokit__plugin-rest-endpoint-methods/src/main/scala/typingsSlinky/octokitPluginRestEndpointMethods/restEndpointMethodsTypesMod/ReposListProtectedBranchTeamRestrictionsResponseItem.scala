...
@js.native
trait ReposListProtectedBranchTeamRestrictionsResponseItem extends js.Object {
...
object ReposListProtectedBranchTeamRestrictionsResponseItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposListProtectedBranchTeamRestrictionsResponseItem]
  }
  @scala.inline
  implicit class ReposListProtectedBranchTeamRestrictionsResponseItemOps[Self <: ReposListProtectedBranchTeamRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
