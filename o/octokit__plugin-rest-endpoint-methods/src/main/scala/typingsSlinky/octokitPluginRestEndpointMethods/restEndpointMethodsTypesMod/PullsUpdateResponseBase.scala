...
trait PullsUpdateResponseBase extends js.Object {
  ...
  var repo: PullsUpdateResponseBaseRepo = js.native
  var sha: String = js.native
  var user: PullsUpdateResponseBaseUser = js.native
}
...
object PullsUpdateResponseBase {
  ...
  @scala.inline
  implicit class PullsUpdateResponseBaseOps[Self <: PullsUpdateResponseBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsUpdateResponseBaseRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsUpdateResponseBaseUser): Self = {
        val ret = this.duplicate
