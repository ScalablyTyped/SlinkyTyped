...
object ReposUpdateProtectedBranchRequiredStatusChecksResponse {
  ...
  @scala.inline
  implicit class ReposUpdateProtectedBranchRequiredStatusChecksResponseOps[Self <: ReposUpdateProtectedBranchRequiredStatusChecksResponse] (val x: Self) extends AnyVal {
    @scala.inline
