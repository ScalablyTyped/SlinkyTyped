...
trait ReactionsCreateForTeamDiscussionResponse extends js.Object {
  ...
  var user: ReactionsCreateForTeamDiscussionResponseUser = js.native
}
...
object ReactionsCreateForTeamDiscussionResponse {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionResponseOps[Self <: ReactionsCreateForTeamDiscussionResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsCreateForTeamDiscussionResponseUser): Self = {
        val ret = this.duplicate
