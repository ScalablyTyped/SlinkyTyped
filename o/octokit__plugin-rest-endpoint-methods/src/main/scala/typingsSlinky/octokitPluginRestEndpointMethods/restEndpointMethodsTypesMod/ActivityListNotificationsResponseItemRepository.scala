...
@js.native
trait ActivityListNotificationsResponseItemRepository extends js.Object {
  ...
  var owner: ActivityListNotificationsResponseItemRepositoryOwner = js.native
...
object ActivityListNotificationsResponseItemRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ActivityListNotificationsResponseItemRepository]
  }
  @scala.inline
  implicit class ActivityListNotificationsResponseItemRepositoryOps[Self <: ActivityListNotificationsResponseItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActivityListNotificationsResponseItemRepositoryOwner): Self = {
        val ret = this.duplicate
