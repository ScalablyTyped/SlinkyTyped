...
trait ReposListReleasesResponseItemAssetsItem extends js.Object {
  ...
  var uploader: ReposListReleasesResponseItemAssetsItemUploader = js.native
...
object ReposListReleasesResponseItemAssetsItem {
  ...
  @scala.inline
  implicit class ReposListReleasesResponseItemAssetsItemOps[Self <: ReposListReleasesResponseItemAssetsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposListReleasesResponseItemAssetsItemUploader): Self = {
        val ret = this.duplicate
