...
object ReposAddProtectedBranchAppRestrictionsResponseItemOwner {
  ...
  @scala.inline
  implicit class ReposAddProtectedBranchAppRestrictionsResponseItemOwnerOps[Self <: ReposAddProtectedBranchAppRestrictionsResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
