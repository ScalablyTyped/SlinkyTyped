...
object ReactionsListForPullRequestReviewCommentResponseItemUser {
  ...
  @scala.inline
  implicit class ReactionsListForPullRequestReviewCommentResponseItemUserOps[Self <: ReactionsListForPullRequestReviewCommentResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
