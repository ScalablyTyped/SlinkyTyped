...
@js.native
trait ReposCreateDeploymentResponseCreator extends js.Object {
...
object ReposCreateDeploymentResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCreateDeploymentResponseCreator]
  }
  @scala.inline
  implicit class ReposCreateDeploymentResponseCreatorOps[Self <: ReposCreateDeploymentResponseCreator] (val x: Self) extends AnyVal {
    @scala.inline
