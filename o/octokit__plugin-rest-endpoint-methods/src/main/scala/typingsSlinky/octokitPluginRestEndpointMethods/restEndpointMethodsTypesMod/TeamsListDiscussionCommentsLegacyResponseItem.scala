...
trait TeamsListDiscussionCommentsLegacyResponseItem extends js.Object {
  var author: TeamsListDiscussionCommentsLegacyResponseItemAuthor = js.native
  ...
  var reactions: TeamsListDiscussionCommentsLegacyResponseItemReactions = js.native
...
object TeamsListDiscussionCommentsLegacyResponseItem {
  ...
  @scala.inline
  implicit class TeamsListDiscussionCommentsLegacyResponseItemOps[Self <: TeamsListDiscussionCommentsLegacyResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsListDiscussionCommentsLegacyResponseItemAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsListDiscussionCommentsLegacyResponseItemReactions): Self = {
        val ret = this.duplicate
