...
trait ActivityListNotificationsForRepoResponseItem extends js.Object {
  ...
  var repository: ActivityListNotificationsForRepoResponseItemRepository = js.native
  var subject: ActivityListNotificationsForRepoResponseItemSubject = js.native
...
object ActivityListNotificationsForRepoResponseItem {
  ...
  @scala.inline
  implicit class ActivityListNotificationsForRepoResponseItemOps[Self <: ActivityListNotificationsForRepoResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepository(value: ActivityListNotificationsForRepoResponseItemRepository): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("repository")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSubject(value: ActivityListNotificationsForRepoResponseItemSubject): Self = {
        val ret = this.duplicate
