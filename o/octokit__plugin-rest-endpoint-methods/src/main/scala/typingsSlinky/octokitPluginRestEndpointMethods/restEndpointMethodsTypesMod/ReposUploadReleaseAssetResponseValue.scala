...
trait ReposUploadReleaseAssetResponseValue extends js.Object {
  ...
  var uploader: ReposUploadReleaseAssetResponseValueUploader = js.native
...
object ReposUploadReleaseAssetResponseValue {
  ...
  @scala.inline
  implicit class ReposUploadReleaseAssetResponseValueOps[Self <: ReposUploadReleaseAssetResponseValue] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposUploadReleaseAssetResponseValueUploader): Self = {
        val ret = this.duplicate
