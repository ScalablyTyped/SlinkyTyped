...
trait AppsResetAuthorizationResponse extends js.Object {
  var app: AppsResetAuthorizationResponseApp = js.native
  ...
  var user: AppsResetAuthorizationResponseUser = js.native
}
...
object AppsResetAuthorizationResponse {
  ...
  @scala.inline
  implicit class AppsResetAuthorizationResponseOps[Self <: AppsResetAuthorizationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: AppsResetAuthorizationResponseApp): Self = {
    ...
    @scala.inline
    def withUser(value: AppsResetAuthorizationResponseUser): Self = {
        val ret = this.duplicate
