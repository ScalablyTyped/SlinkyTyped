...
trait IssuesGetMilestoneResponse extends js.Object {
  ...
  var creator: IssuesGetMilestoneResponseCreator = js.native
...
object IssuesGetMilestoneResponse {
  ...
  @scala.inline
  implicit class IssuesGetMilestoneResponseOps[Self <: IssuesGetMilestoneResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesGetMilestoneResponseCreator): Self = {
        val ret = this.duplicate
