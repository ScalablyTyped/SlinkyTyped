...
@js.native
trait PullsCreateReviewRequestResponseRequestedReviewersItem extends js.Object {
...
object PullsCreateReviewRequestResponseRequestedReviewersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseRequestedReviewersItem]
  }
  @scala.inline
  implicit class PullsCreateReviewRequestResponseRequestedReviewersItemOps[Self <: PullsCreateReviewRequestResponseRequestedReviewersItem] (val x: Self) extends AnyVal {
    @scala.inline
