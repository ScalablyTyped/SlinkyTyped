...
trait IssuesListForOrgResponseItemMilestone extends js.Object {
  ...
  var creator: IssuesListForOrgResponseItemMilestoneCreator = js.native
...
object IssuesListForOrgResponseItemMilestone {
  ...
  @scala.inline
  implicit class IssuesListForOrgResponseItemMilestoneOps[Self <: IssuesListForOrgResponseItemMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesListForOrgResponseItemMilestoneCreator): Self = {
        val ret = this.duplicate
