...
trait OrgsUpdateHookResponse extends js.Object {
  ...
  var config: OrgsUpdateHookResponseConfig = js.native
...
object OrgsUpdateHookResponse {
  ...
  @scala.inline
  implicit class OrgsUpdateHookResponseOps[Self <: OrgsUpdateHookResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withConfig(value: OrgsUpdateHookResponseConfig): Self = {
        val ret = this.duplicate
