...
object MigrationsGetStatusForOrgResponseRepositoriesItemOwner {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForOrgResponseRepositoriesItemOwnerOps[Self <: MigrationsGetStatusForOrgResponseRepositoriesItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
