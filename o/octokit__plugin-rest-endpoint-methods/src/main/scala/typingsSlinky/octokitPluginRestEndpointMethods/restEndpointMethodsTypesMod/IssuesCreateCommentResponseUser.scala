...
@js.native
trait IssuesCreateCommentResponseUser extends js.Object {
...
object IssuesCreateCommentResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesCreateCommentResponseUser]
  }
  @scala.inline
  implicit class IssuesCreateCommentResponseUserOps[Self <: IssuesCreateCommentResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
