...
object PullsListReviewsParams {
  @scala.inline
  def apply(owner: String, pull_number: Double, repo: String): PullsListReviewsParams = {
  ...
  @scala.inline
  implicit class PullsListReviewsParamsOps[Self <: PullsListReviewsParams] (val x: Self) extends AnyVal {
    @scala.inline
