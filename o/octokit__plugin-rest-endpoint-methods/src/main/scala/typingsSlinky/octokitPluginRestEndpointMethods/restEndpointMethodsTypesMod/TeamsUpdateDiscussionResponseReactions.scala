...
@js.native
trait TeamsUpdateDiscussionResponseReactions extends js.Object {
...
object TeamsUpdateDiscussionResponseReactions {
  @scala.inline
  def apply(
    `-1`: Double,
    Plussign1: Double,
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionResponseReactions]
  }
  @scala.inline
  implicit class TeamsUpdateDiscussionResponseReactionsOps[Self <: TeamsUpdateDiscussionResponseReactions] (val x: Self) extends AnyVal {
    @scala.inline
