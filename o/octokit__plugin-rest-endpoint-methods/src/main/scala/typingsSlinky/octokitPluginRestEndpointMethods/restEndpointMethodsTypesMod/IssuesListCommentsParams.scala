...
object IssuesListCommentsParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesListCommentsParams = {
  ...
  @scala.inline
  implicit class IssuesListCommentsParamsOps[Self <: IssuesListCommentsParams] (val x: Self) extends AnyVal {
    @scala.inline
