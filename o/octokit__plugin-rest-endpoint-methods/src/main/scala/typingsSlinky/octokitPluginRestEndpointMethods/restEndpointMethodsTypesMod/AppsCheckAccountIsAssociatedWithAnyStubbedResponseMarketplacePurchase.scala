...
trait AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchase extends js.Object {
  ...
  var plan: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlan = js.native
...
object AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchase {
  ...
  @scala.inline
  implicit class AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchaseOps[Self <: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPlan(value: AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlan): Self = {
        val ret = this.duplicate
