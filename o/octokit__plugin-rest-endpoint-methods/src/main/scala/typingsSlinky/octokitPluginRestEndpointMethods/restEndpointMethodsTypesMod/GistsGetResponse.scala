...
trait GistsGetResponse extends js.Object {
  ...
  var files: GistsGetResponseFiles = js.native
  var forks: js.Array[GistsGetResponseForksItem] = js.native
  var forks_url: String = js.native
  var git_pull_url: String = js.native
  var git_push_url: String = js.native
  var history: js.Array[GistsGetResponseHistoryItem] = js.native
  var html_url: String = js.native
  var id: String = js.native
  var node_id: String = js.native
  var owner: GistsGetResponseOwner = js.native
...
object GistsGetResponse {
  ...
  @scala.inline
  implicit class GistsGetResponseOps[Self <: GistsGetResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsGetResponseFiles): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("files")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withForks(value: js.Array[GistsGetResponseForksItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHistory(value: js.Array[GistsGetResponseHistoryItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsGetResponseOwner): Self = {
        val ret = this.duplicate
