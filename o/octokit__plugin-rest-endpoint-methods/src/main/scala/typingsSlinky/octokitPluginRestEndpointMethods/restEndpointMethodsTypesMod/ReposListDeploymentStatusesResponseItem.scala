...
trait ReposListDeploymentStatusesResponseItem extends js.Object {
  ...
  var creator: ReposListDeploymentStatusesResponseItemCreator = js.native
...
object ReposListDeploymentStatusesResponseItem {
  ...
  @scala.inline
  implicit class ReposListDeploymentStatusesResponseItemOps[Self <: ReposListDeploymentStatusesResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ReposListDeploymentStatusesResponseItemCreator): Self = {
        val ret = this.duplicate
