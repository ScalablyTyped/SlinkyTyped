...
@js.native
trait ActivityListWatchedReposForAuthenticatedUserResponseItemOwner extends js.Object {
...
object ActivityListWatchedReposForAuthenticatedUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListWatchedReposForAuthenticatedUserResponseItemOwner]
  }
  @scala.inline
  implicit class ActivityListWatchedReposForAuthenticatedUserResponseItemOwnerOps[Self <: ActivityListWatchedReposForAuthenticatedUserResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
