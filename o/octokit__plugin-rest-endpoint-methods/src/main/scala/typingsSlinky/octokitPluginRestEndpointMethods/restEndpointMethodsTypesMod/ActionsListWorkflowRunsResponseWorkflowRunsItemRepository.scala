...
trait ActionsListWorkflowRunsResponseWorkflowRunsItemRepository extends js.Object {
  ...
  var owner: ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwner = js.native
...
object ActionsListWorkflowRunsResponseWorkflowRunsItemRepository {
  ...
  @scala.inline
  implicit class ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOps[Self <: ActionsListWorkflowRunsResponseWorkflowRunsItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwner): Self = {
        val ret = this.duplicate
