...
trait ReposListInvitationsForAuthenticatedUserResponseItemRepository extends js.Object {
  ...
  var owner: ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwner = js.native
...
object ReposListInvitationsForAuthenticatedUserResponseItemRepository {
  ...
  @scala.inline
  implicit class ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOps[Self <: ReposListInvitationsForAuthenticatedUserResponseItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwner): Self = {
        val ret = this.duplicate
