...
object ReactionsListForTeamDiscussionCommentInOrgResponseItemUser {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentInOrgResponseItemUserOps[Self <: ReactionsListForTeamDiscussionCommentInOrgResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
