...
object ActivityListNotificationsParams {
  @scala.inline
  def apply(): ActivityListNotificationsParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ActivityListNotificationsParams]
  }
  @scala.inline
  implicit class ActivityListNotificationsParamsOps[Self <: ActivityListNotificationsParams] (val x: Self) extends AnyVal {
    @scala.inline
