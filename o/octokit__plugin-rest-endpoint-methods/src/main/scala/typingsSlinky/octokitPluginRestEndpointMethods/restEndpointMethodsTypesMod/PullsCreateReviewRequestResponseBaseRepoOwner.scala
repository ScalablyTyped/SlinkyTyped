...
@js.native
trait PullsCreateReviewRequestResponseBaseRepoOwner extends js.Object {
...
object PullsCreateReviewRequestResponseBaseRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseBaseRepoOwner]
  }
  @scala.inline
  implicit class PullsCreateReviewRequestResponseBaseRepoOwnerOps[Self <: PullsCreateReviewRequestResponseBaseRepoOwner] (val x: Self) extends AnyVal {
    @scala.inline
