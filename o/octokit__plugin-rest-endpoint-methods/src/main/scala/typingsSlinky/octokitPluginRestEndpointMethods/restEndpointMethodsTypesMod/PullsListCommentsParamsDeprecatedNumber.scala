...
object PullsListCommentsParamsDeprecatedNumber {
  @scala.inline
  def apply(number: Double, owner: String, repo: String): PullsListCommentsParamsDeprecatedNumber = {
  ...
  @scala.inline
  implicit class PullsListCommentsParamsDeprecatedNumberOps[Self <: PullsListCommentsParamsDeprecatedNumber] (val x: Self) extends AnyVal {
    @scala.inline
