...
@js.native
trait ReactionsCreateForIssueResponse extends js.Object {
  var content: String = js.native
  var created_at: String = js.native
  var id: Double = js.native
  var node_id: String = js.native
  var user: ReactionsCreateForIssueResponseUser = js.native
}

object ReactionsCreateForIssueResponse {
  @scala.inline
  def apply(
    content: String,
    created_at: String,
  ...
  @scala.inline
  implicit class ReactionsCreateForIssueResponseOps[Self <: ReactionsCreateForIssueResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsCreateForIssueResponseUser): Self = {
        val ret = this.duplicate
