...
object ReposReplaceProtectedBranchUserRestrictionsResponseItem {
  ...
  @scala.inline
  implicit class ReposReplaceProtectedBranchUserRestrictionsResponseItemOps[Self <: ReposReplaceProtectedBranchUserRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
