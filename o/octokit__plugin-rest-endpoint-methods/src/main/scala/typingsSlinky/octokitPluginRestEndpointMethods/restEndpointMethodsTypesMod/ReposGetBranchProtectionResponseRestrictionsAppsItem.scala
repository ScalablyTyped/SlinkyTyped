...
trait ReposGetBranchProtectionResponseRestrictionsAppsItem extends js.Object {
  ...
  var owner: ReposGetBranchProtectionResponseRestrictionsAppsItemOwner = js.native
  var permissions: ReposGetBranchProtectionResponseRestrictionsAppsItemPermissions = js.native
...
object ReposGetBranchProtectionResponseRestrictionsAppsItem {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRestrictionsAppsItemOps[Self <: ReposGetBranchProtectionResponseRestrictionsAppsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposGetBranchProtectionResponseRestrictionsAppsItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposGetBranchProtectionResponseRestrictionsAppsItemPermissions): Self = {
        val ret = this.duplicate
