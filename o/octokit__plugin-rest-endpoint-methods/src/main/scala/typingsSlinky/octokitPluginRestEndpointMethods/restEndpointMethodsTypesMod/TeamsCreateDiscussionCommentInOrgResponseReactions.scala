...
object TeamsCreateDiscussionCommentInOrgResponseReactions {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionCommentInOrgResponseReactionsOps[Self <: TeamsCreateDiscussionCommentInOrgResponseReactions] (val x: Self) extends AnyVal {
    @scala.inline
