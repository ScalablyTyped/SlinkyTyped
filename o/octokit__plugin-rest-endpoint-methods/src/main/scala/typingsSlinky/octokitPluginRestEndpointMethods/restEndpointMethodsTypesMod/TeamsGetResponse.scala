...
trait TeamsGetResponse extends js.Object {
  ...
  var organization: TeamsGetResponseOrganization = js.native
...
object TeamsGetResponse {
  ...
  @scala.inline
  implicit class TeamsGetResponseOps[Self <: TeamsGetResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOrganization(value: TeamsGetResponseOrganization): Self = {
        val ret = this.duplicate
