...
@js.native
trait AppsFindOrgInstallationResponse extends js.Object {
  var access_tokens_url: String = js.native
  var account: AppsFindOrgInstallationResponseAccount = js.native
  var app_id: Double = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: AppsFindOrgInstallationResponsePermissions = js.native
...
object AppsFindOrgInstallationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindOrgInstallationResponse]
  }
  @scala.inline
  implicit class AppsFindOrgInstallationResponseOps[Self <: AppsFindOrgInstallationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: AppsFindOrgInstallationResponseAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: AppsFindOrgInstallationResponsePermissions): Self = {
        val ret = this.duplicate
