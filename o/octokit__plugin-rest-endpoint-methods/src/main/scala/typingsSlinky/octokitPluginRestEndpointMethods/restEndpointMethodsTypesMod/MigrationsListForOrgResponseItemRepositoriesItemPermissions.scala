...
object MigrationsListForOrgResponseItemRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class MigrationsListForOrgResponseItemRepositoriesItemPermissionsOps[Self <: MigrationsListForOrgResponseItemRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
