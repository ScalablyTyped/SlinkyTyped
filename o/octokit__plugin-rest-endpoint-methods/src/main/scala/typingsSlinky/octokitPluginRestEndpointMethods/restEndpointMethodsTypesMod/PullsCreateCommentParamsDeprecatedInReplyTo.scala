...
object PullsCreateCommentParamsDeprecatedInReplyTo {
  @scala.inline
  def apply(body: String, commit_id: String, owner: String, path: String, pull_number: Double, repo: String): PullsCreateCommentParamsDeprecatedInReplyTo = {
  ...
  @scala.inline
  implicit class PullsCreateCommentParamsDeprecatedInReplyToOps[Self <: PullsCreateCommentParamsDeprecatedInReplyTo] (val x: Self) extends AnyVal {
    @scala.inline
