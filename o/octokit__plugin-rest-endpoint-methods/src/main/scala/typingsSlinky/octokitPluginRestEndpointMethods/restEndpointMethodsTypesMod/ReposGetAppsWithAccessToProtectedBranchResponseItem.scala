...
trait ReposGetAppsWithAccessToProtectedBranchResponseItem extends js.Object {
  ...
  var owner: ReposGetAppsWithAccessToProtectedBranchResponseItemOwner = js.native
  var permissions: ReposGetAppsWithAccessToProtectedBranchResponseItemPermissions = js.native
...
object ReposGetAppsWithAccessToProtectedBranchResponseItem {
  ...
  @scala.inline
  implicit class ReposGetAppsWithAccessToProtectedBranchResponseItemOps[Self <: ReposGetAppsWithAccessToProtectedBranchResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposGetAppsWithAccessToProtectedBranchResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposGetAppsWithAccessToProtectedBranchResponseItemPermissions): Self = {
        val ret = this.duplicate
