...
trait ActivityListWatchedReposForAuthenticatedUserResponseItem extends js.Object {
  ...
  var license: ActivityListWatchedReposForAuthenticatedUserResponseItemLicense = js.native
  ...
  var owner: ActivityListWatchedReposForAuthenticatedUserResponseItemOwner = js.native
  var permissions: ActivityListWatchedReposForAuthenticatedUserResponseItemPermissions = js.native
...
object ActivityListWatchedReposForAuthenticatedUserResponseItem {
  ...
  @scala.inline
  implicit class ActivityListWatchedReposForAuthenticatedUserResponseItemOps[Self <: ActivityListWatchedReposForAuthenticatedUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: ActivityListWatchedReposForAuthenticatedUserResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: ActivityListWatchedReposForAuthenticatedUserResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ActivityListWatchedReposForAuthenticatedUserResponseItemPermissions): Self = {
        val ret = this.duplicate
