...
trait ReposGetResponseSource extends js.Object {
  ...
  var owner: ReposGetResponseSourceOwner = js.native
  var permissions: ReposGetResponseSourcePermissions = js.native
...
object ReposGetResponseSource {
  ...
  @scala.inline
  implicit class ReposGetResponseSourceOps[Self <: ReposGetResponseSource] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposGetResponseSourceOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposGetResponseSourcePermissions): Self = {
        val ret = this.duplicate
