...
trait GistsGetRevisionResponseForksItem extends js.Object {
  ...
  var user: GistsGetRevisionResponseForksItemUser = js.native
}
...
object GistsGetRevisionResponseForksItem {
  ...
  @scala.inline
  implicit class GistsGetRevisionResponseForksItemOps[Self <: GistsGetRevisionResponseForksItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: GistsGetRevisionResponseForksItemUser): Self = {
        val ret = this.duplicate
