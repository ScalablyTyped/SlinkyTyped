...
@js.native
trait ReposGetLatestReleaseResponseAssetsItem extends js.Object {
  ...
  var uploader: ReposGetLatestReleaseResponseAssetsItemUploader = js.native
  var url: String = js.native
}

object ReposGetLatestReleaseResponseAssetsItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetLatestReleaseResponseAssetsItem]
  }
  @scala.inline
  implicit class ReposGetLatestReleaseResponseAssetsItemOps[Self <: ReposGetLatestReleaseResponseAssetsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposGetLatestReleaseResponseAssetsItemUploader): Self = {
        val ret = this.duplicate
