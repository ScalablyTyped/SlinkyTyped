...
trait AppsGetBySlugResponse extends js.Object {
  ...
  var owner: AppsGetBySlugResponseOwner = js.native
  var permissions: AppsGetBySlugResponsePermissions = js.native
...
object AppsGetBySlugResponse {
  ...
  @scala.inline
  implicit class AppsGetBySlugResponseOps[Self <: AppsGetBySlugResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: AppsGetBySlugResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: AppsGetBySlugResponsePermissions): Self = {
        val ret = this.duplicate
