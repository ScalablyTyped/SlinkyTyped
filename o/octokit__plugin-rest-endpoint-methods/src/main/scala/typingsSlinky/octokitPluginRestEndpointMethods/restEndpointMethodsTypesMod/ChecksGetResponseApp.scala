...
@js.native
trait ChecksGetResponseApp extends js.Object {
  ...
  var owner: ChecksGetResponseAppOwner = js.native
  var permissions: ChecksGetResponseAppPermissions = js.native
  var slug: String = js.native
  var updated_at: String = js.native
}

object ChecksGetResponseApp {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ChecksGetResponseApp]
  }
  @scala.inline
  implicit class ChecksGetResponseAppOps[Self <: ChecksGetResponseApp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksGetResponseAppOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksGetResponseAppPermissions): Self = {
        val ret = this.duplicate
