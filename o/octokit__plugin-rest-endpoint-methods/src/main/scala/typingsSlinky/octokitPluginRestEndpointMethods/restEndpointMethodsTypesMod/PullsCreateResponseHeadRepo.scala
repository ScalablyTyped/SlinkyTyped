...
trait PullsCreateResponseHeadRepo extends js.Object {
  ...
  var owner: PullsCreateResponseHeadRepoOwner = js.native
  var permissions: PullsCreateResponseHeadRepoPermissions = js.native
...
object PullsCreateResponseHeadRepo {
  ...
  @scala.inline
  implicit class PullsCreateResponseHeadRepoOps[Self <: PullsCreateResponseHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsCreateResponseHeadRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsCreateResponseHeadRepoPermissions): Self = {
        val ret = this.duplicate
