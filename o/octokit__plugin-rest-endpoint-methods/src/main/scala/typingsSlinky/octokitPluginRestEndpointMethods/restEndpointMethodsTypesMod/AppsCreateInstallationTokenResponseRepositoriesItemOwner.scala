...
object AppsCreateInstallationTokenResponseRepositoriesItemOwner {
  ...
  @scala.inline
  implicit class AppsCreateInstallationTokenResponseRepositoriesItemOwnerOps[Self <: AppsCreateInstallationTokenResponseRepositoriesItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
