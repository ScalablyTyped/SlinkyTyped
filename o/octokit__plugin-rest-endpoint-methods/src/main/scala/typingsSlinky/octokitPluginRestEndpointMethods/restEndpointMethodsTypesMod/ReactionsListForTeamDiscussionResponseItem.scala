...
trait ReactionsListForTeamDiscussionResponseItem extends js.Object {
  ...
  var user: ReactionsListForTeamDiscussionResponseItemUser = js.native
}
...
object ReactionsListForTeamDiscussionResponseItem {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionResponseItemOps[Self <: ReactionsListForTeamDiscussionResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsListForTeamDiscussionResponseItemUser): Self = {
        val ret = this.duplicate
