...
object ReposListPullRequestsAssociatedWithCommitResponseItemBaseUser {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemBaseUserOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemBaseUser] (val x: Self) extends AnyVal {
    @scala.inline
