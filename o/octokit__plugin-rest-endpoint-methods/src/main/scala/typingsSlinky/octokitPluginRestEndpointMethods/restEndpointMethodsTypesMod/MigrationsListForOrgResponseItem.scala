...
trait MigrationsListForOrgResponseItem extends js.Object {
  ...
  var owner: MigrationsListForOrgResponseItemOwner = js.native
  var repositories: js.Array[MigrationsListForOrgResponseItemRepositoriesItem] = js.native
...
object MigrationsListForOrgResponseItem {
  ...
  @scala.inline
  implicit class MigrationsListForOrgResponseItemOps[Self <: MigrationsListForOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsListForOrgResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRepositories(value: js.Array[MigrationsListForOrgResponseItemRepositoriesItem]): Self = {
        val ret = this.duplicate
