...
trait ReposGetBranchProtectionResponseRequiredPullRequestReviews extends js.Object {
  ...
  var dismissal_restrictions: ReposGetBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictions = js.native
...
object ReposGetBranchProtectionResponseRequiredPullRequestReviews {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRequiredPullRequestReviewsOps[Self <: ReposGetBranchProtectionResponseRequiredPullRequestReviews] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDismissal_restrictions(value: ReposGetBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictions): Self = {
        val ret = this.duplicate
