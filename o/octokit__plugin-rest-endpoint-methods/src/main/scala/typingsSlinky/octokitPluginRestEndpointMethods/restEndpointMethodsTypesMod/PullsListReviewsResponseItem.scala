...
trait PullsListReviewsResponseItem extends js.Object {
  var _links: PullsListReviewsResponseItemLinks = js.native
  ...
  var user: PullsListReviewsResponseItemUser = js.native
}
...
object PullsListReviewsResponseItem {
  ...
  @scala.inline
  implicit class PullsListReviewsResponseItemOps[Self <: PullsListReviewsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsListReviewsResponseItemLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsListReviewsResponseItemUser): Self = {
        val ret = this.duplicate
