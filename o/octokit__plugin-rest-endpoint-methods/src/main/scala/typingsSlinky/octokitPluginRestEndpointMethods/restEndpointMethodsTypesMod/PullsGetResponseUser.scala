...
@js.native
trait PullsGetResponseUser extends js.Object {
...
object PullsGetResponseUser {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PullsGetResponseUser]
  }
  @scala.inline
  implicit class PullsGetResponseUserOps[Self <: PullsGetResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
