...
@js.native
trait UsersListBlockedResponseItem extends js.Object {
...
object UsersListBlockedResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[UsersListBlockedResponseItem]
  }
  @scala.inline
  implicit class UsersListBlockedResponseItemOps[Self <: UsersListBlockedResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
