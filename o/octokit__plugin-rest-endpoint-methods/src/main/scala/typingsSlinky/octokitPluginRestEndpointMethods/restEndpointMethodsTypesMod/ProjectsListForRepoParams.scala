...
object ProjectsListForRepoParams {
  @scala.inline
  def apply(owner: String, repo: String): ProjectsListForRepoParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectsListForRepoParams]
  }
  @scala.inline
  implicit class ProjectsListForRepoParamsOps[Self <: ProjectsListForRepoParams] (val x: Self) extends AnyVal {
    @scala.inline
