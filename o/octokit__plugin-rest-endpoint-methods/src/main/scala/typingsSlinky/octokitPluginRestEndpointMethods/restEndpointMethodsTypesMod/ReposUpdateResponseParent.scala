...
trait ReposUpdateResponseParent extends js.Object {
  ...
  var owner: ReposUpdateResponseParentOwner = js.native
  var permissions: ReposUpdateResponseParentPermissions = js.native
...
object ReposUpdateResponseParent {
  ...
  @scala.inline
  implicit class ReposUpdateResponseParentOps[Self <: ReposUpdateResponseParent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposUpdateResponseParentOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposUpdateResponseParentPermissions): Self = {
        val ret = this.duplicate
