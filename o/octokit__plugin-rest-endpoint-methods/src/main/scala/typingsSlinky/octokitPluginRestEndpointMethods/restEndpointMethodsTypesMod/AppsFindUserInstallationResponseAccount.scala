...
@js.native
trait AppsFindUserInstallationResponseAccount extends js.Object {
...
object AppsFindUserInstallationResponseAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsFindUserInstallationResponseAccount]
  }
  @scala.inline
  implicit class AppsFindUserInstallationResponseAccountOps[Self <: AppsFindUserInstallationResponseAccount] (val x: Self) extends AnyVal {
    @scala.inline
