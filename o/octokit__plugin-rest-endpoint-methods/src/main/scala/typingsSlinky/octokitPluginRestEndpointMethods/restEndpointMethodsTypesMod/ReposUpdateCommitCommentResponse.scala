...
trait ReposUpdateCommitCommentResponse extends js.Object {
  ...
  var user: ReposUpdateCommitCommentResponseUser = js.native
}
...
object ReposUpdateCommitCommentResponse {
  ...
  @scala.inline
  implicit class ReposUpdateCommitCommentResponseOps[Self <: ReposUpdateCommitCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReposUpdateCommitCommentResponseUser): Self = {
        val ret = this.duplicate
