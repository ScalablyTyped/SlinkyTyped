...
object AppsListInstallationsForAuthenticatedUserResponseInstallationsItemPermissions {
  ...
  @scala.inline
  implicit class AppsListInstallationsForAuthenticatedUserResponseInstallationsItemPermissionsOps[Self <: AppsListInstallationsForAuthenticatedUserResponseInstallationsItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
