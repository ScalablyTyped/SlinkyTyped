...
object ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner {
  ...
  @scala.inline
  implicit class ReposRemoveProtectedBranchAppRestrictionsResponseItemOwnerOps[Self <: ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
