...
object TeamsUpdateDiscussionParams {
  @scala.inline
  def apply(discussion_number: Double, team_id: Double): TeamsUpdateDiscussionParams = {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionParamsOps[Self <: TeamsUpdateDiscussionParams] (val x: Self) extends AnyVal {
    @scala.inline
