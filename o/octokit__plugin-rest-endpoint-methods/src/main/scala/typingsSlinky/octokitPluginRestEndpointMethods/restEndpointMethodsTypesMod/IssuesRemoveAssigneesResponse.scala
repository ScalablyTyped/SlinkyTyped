...
trait IssuesRemoveAssigneesResponse extends js.Object {
  ...
  var assignee: IssuesRemoveAssigneesResponseAssignee = js.native
  var assignees: js.Array[IssuesRemoveAssigneesResponseAssigneesItem] = js.native
  ...
  var labels: js.Array[IssuesRemoveAssigneesResponseLabelsItem] = js.native
  var labels_url: String = js.native
  var locked: Boolean = js.native
  var milestone: IssuesRemoveAssigneesResponseMilestone = js.native
  var node_id: String = js.native
  var number: Double = js.native
  var pull_request: IssuesRemoveAssigneesResponsePullRequest = js.native
  var repository_url: String = js.native
  var state: String = js.native
  var title: String = js.native
  var updated_at: String = js.native
  var url: String = js.native
  var user: IssuesRemoveAssigneesResponseUser = js.native
}
...
object IssuesRemoveAssigneesResponse {
  ...
  @scala.inline
  implicit class IssuesRemoveAssigneesResponseOps[Self <: IssuesRemoveAssigneesResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAssignee(value: IssuesRemoveAssigneesResponseAssignee): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("assignee")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAssignees(value: js.Array[IssuesRemoveAssigneesResponseAssigneesItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabels(value: js.Array[IssuesRemoveAssigneesResponseLabelsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMilestone(value: IssuesRemoveAssigneesResponseMilestone): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPull_request(value: IssuesRemoveAssigneesResponsePullRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: IssuesRemoveAssigneesResponseUser): Self = {
        val ret = this.duplicate
