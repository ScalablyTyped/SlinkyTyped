...
trait PullsSubmitReviewResponse extends js.Object {
  var _links: PullsSubmitReviewResponseLinks = js.native
  ...
  var user: PullsSubmitReviewResponseUser = js.native
}
...
object PullsSubmitReviewResponse {
  ...
  @scala.inline
  implicit class PullsSubmitReviewResponseOps[Self <: PullsSubmitReviewResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsSubmitReviewResponseLinks): Self = {
    ...
    @scala.inline
    def withSubmitted_at(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("submitted_at")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUser(value: PullsSubmitReviewResponseUser): Self = {
        val ret = this.duplicate
