...
trait TeamsListDiscussionsInOrgResponseItem extends js.Object {
  var author: TeamsListDiscussionsInOrgResponseItemAuthor = js.native
  ...
  var reactions: TeamsListDiscussionsInOrgResponseItemReactions = js.native
...
object TeamsListDiscussionsInOrgResponseItem {
  ...
  @scala.inline
  implicit class TeamsListDiscussionsInOrgResponseItemOps[Self <: TeamsListDiscussionsInOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsListDiscussionsInOrgResponseItemAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsListDiscussionsInOrgResponseItemReactions): Self = {
        val ret = this.duplicate
