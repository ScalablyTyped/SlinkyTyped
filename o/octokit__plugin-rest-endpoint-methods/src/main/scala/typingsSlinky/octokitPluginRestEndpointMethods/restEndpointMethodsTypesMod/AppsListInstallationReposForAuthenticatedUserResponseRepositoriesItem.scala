...
trait AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItem extends js.Object {
  ...
  var owner: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner = js.native
  var permissions: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemPermissions = js.native
...
object AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItem {
  ...
  @scala.inline
  implicit class AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOps[Self <: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
