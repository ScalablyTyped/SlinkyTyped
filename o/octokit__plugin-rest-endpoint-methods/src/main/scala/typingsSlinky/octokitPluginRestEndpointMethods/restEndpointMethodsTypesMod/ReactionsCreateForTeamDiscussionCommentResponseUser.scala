...
object ReactionsCreateForTeamDiscussionCommentResponseUser {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionCommentResponseUserOps[Self <: ReactionsCreateForTeamDiscussionCommentResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
