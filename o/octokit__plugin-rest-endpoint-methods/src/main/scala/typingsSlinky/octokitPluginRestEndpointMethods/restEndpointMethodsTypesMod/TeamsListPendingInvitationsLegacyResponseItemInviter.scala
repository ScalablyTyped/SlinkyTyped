...
object TeamsListPendingInvitationsLegacyResponseItemInviter {
  ...
  @scala.inline
  implicit class TeamsListPendingInvitationsLegacyResponseItemInviterOps[Self <: TeamsListPendingInvitationsLegacyResponseItemInviter] (val x: Self) extends AnyVal {
    @scala.inline
