...
object ReposCompareCommitsResponseMergeBaseCommitCommitter {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseMergeBaseCommitCommitterOps[Self <: ReposCompareCommitsResponseMergeBaseCommitCommitter] (val x: Self) extends AnyVal {
    @scala.inline
