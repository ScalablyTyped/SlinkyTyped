...
@js.native
trait PullsCreateFromIssueResponseLabelsItem extends js.Object {
...
object PullsCreateFromIssueResponseLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseLabelsItem]
  }
  @scala.inline
  implicit class PullsCreateFromIssueResponseLabelsItemOps[Self <: PullsCreateFromIssueResponseLabelsItem] (val x: Self) extends AnyVal {
    @scala.inline
