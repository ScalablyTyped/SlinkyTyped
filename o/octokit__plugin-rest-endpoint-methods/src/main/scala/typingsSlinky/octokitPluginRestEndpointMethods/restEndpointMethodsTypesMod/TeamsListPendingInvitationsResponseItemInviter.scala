...
@js.native
trait TeamsListPendingInvitationsResponseItemInviter extends js.Object {
...
object TeamsListPendingInvitationsResponseItemInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListPendingInvitationsResponseItemInviter]
  }
  @scala.inline
  implicit class TeamsListPendingInvitationsResponseItemInviterOps[Self <: TeamsListPendingInvitationsResponseItemInviter] (val x: Self) extends AnyVal {
    @scala.inline
