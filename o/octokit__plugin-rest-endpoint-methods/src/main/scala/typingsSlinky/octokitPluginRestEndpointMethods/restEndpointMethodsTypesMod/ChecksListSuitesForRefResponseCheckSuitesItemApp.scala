...
trait ChecksListSuitesForRefResponseCheckSuitesItemApp extends js.Object {
  ...
  var owner: ChecksListSuitesForRefResponseCheckSuitesItemAppOwner = js.native
  var permissions: ChecksListSuitesForRefResponseCheckSuitesItemAppPermissions = js.native
...
object ChecksListSuitesForRefResponseCheckSuitesItemApp {
  ...
  @scala.inline
  implicit class ChecksListSuitesForRefResponseCheckSuitesItemAppOps[Self <: ChecksListSuitesForRefResponseCheckSuitesItemApp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksListSuitesForRefResponseCheckSuitesItemAppOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksListSuitesForRefResponseCheckSuitesItemAppPermissions): Self = {
        val ret = this.duplicate
