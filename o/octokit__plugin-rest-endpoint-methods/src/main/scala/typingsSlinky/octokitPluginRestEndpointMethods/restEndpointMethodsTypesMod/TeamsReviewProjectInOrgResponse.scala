...
trait TeamsReviewProjectInOrgResponse extends js.Object {
  ...
  var creator: TeamsReviewProjectInOrgResponseCreator = js.native
  ...
  var permissions: TeamsReviewProjectInOrgResponsePermissions = js.native
...
object TeamsReviewProjectInOrgResponse {
  ...
  @scala.inline
  implicit class TeamsReviewProjectInOrgResponseOps[Self <: TeamsReviewProjectInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: TeamsReviewProjectInOrgResponseCreator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: TeamsReviewProjectInOrgResponsePermissions): Self = {
        val ret = this.duplicate
