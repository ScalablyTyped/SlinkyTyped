...
@js.native
trait ReposListCommentsForCommitResponseItemUser extends js.Object {
...
object ReposListCommentsForCommitResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListCommentsForCommitResponseItemUser]
  }
  @scala.inline
  implicit class ReposListCommentsForCommitResponseItemUserOps[Self <: ReposListCommentsForCommitResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
