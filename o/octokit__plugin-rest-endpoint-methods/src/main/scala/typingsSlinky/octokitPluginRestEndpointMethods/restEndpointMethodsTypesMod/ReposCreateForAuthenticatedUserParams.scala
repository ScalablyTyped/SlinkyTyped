...
object ReposCreateForAuthenticatedUserParams {
  @scala.inline
  def apply(name: String): ReposCreateForAuthenticatedUserParams = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposCreateForAuthenticatedUserParams]
  }
  @scala.inline
  implicit class ReposCreateForAuthenticatedUserParamsOps[Self <: ReposCreateForAuthenticatedUserParams] (val x: Self) extends AnyVal {
    @scala.inline
