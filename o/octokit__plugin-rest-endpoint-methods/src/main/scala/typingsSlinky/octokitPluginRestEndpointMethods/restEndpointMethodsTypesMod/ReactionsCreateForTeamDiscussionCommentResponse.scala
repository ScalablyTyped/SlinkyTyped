...
trait ReactionsCreateForTeamDiscussionCommentResponse extends js.Object {
  ...
  var user: ReactionsCreateForTeamDiscussionCommentResponseUser = js.native
}
...
object ReactionsCreateForTeamDiscussionCommentResponse {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionCommentResponseOps[Self <: ReactionsCreateForTeamDiscussionCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsCreateForTeamDiscussionCommentResponseUser): Self = {
        val ret = this.duplicate
