...
object ReposListBranchesParams {
  @scala.inline
  def apply(owner: String, repo: String): ReposListBranchesParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposListBranchesParams]
  }
  @scala.inline
  implicit class ReposListBranchesParamsOps[Self <: ReposListBranchesParams] (val x: Self) extends AnyVal {
    @scala.inline
