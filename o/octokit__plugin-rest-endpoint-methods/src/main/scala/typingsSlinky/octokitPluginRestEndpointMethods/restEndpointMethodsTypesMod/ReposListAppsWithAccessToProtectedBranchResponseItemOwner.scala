...
object ReposListAppsWithAccessToProtectedBranchResponseItemOwner {
  ...
  @scala.inline
  implicit class ReposListAppsWithAccessToProtectedBranchResponseItemOwnerOps[Self <: ReposListAppsWithAccessToProtectedBranchResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
