...
trait ActivityGetThreadResponseRepository extends js.Object {
  ...
  var owner: ActivityGetThreadResponseRepositoryOwner = js.native
...
object ActivityGetThreadResponseRepository {
  ...
  @scala.inline
  implicit class ActivityGetThreadResponseRepositoryOps[Self <: ActivityGetThreadResponseRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActivityGetThreadResponseRepositoryOwner): Self = {
        val ret = this.duplicate
