...
trait ChecksUpdateResponsePullRequestsItem extends js.Object {
  var base: ChecksUpdateResponsePullRequestsItemBase = js.native
  var head: ChecksUpdateResponsePullRequestsItemHead = js.native
...
object ChecksUpdateResponsePullRequestsItem {
  ...
  @scala.inline
  implicit class ChecksUpdateResponsePullRequestsItemOps[Self <: ChecksUpdateResponsePullRequestsItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBase(value: ChecksUpdateResponsePullRequestsItemBase): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("base")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHead(value: ChecksUpdateResponsePullRequestsItemHead): Self = {
        val ret = this.duplicate
