...
object TeamsUpdateDiscussionCommentLegacyResponseReactions {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentLegacyResponseReactionsOps[Self <: TeamsUpdateDiscussionCommentLegacyResponseReactions] (val x: Self) extends AnyVal {
    @scala.inline
