...
@js.native
trait OrgsUpdateMembershipResponseOrganization extends js.Object {
...
object OrgsUpdateMembershipResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[OrgsUpdateMembershipResponseOrganization]
  }
  @scala.inline
  implicit class OrgsUpdateMembershipResponseOrganizationOps[Self <: OrgsUpdateMembershipResponseOrganization] (val x: Self) extends AnyVal {
    @scala.inline
