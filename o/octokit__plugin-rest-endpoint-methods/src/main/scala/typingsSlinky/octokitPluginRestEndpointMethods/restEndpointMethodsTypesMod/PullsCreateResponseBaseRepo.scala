...
@js.native
trait PullsCreateResponseBaseRepo extends js.Object {
  ...
  var owner: PullsCreateResponseBaseRepoOwner = js.native
  var permissions: PullsCreateResponseBaseRepoPermissions = js.native
...
object PullsCreateResponseBaseRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateResponseBaseRepo]
  }
  @scala.inline
  implicit class PullsCreateResponseBaseRepoOps[Self <: PullsCreateResponseBaseRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsCreateResponseBaseRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsCreateResponseBaseRepoPermissions): Self = {
        val ret = this.duplicate
