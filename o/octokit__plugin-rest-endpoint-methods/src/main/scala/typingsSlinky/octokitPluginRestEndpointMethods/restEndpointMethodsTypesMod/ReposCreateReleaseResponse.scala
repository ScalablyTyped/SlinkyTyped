...
trait ReposCreateReleaseResponse extends js.Object {
  var assets: js.Array[_] = js.native
  var assets_url: String = js.native
  var author: ReposCreateReleaseResponseAuthor = js.native
...
object ReposCreateReleaseResponse {
  ...
  @scala.inline
  implicit class ReposCreateReleaseResponseOps[Self <: ReposCreateReleaseResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAssets(value: js.Array[_]): Self = {
    ...
    @scala.inline
    def withAuthor(value: ReposCreateReleaseResponseAuthor): Self = {
        val ret = this.duplicate
