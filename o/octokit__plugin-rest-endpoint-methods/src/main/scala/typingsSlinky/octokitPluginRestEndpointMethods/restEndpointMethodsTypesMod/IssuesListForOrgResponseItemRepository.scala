...
@js.native
trait IssuesListForOrgResponseItemRepository extends js.Object {
  ...
  var owner: IssuesListForOrgResponseItemRepositoryOwner = js.native
  var permissions: IssuesListForOrgResponseItemRepositoryPermissions = js.native
...
object IssuesListForOrgResponseItemRepository {
  @scala.inline
  def apply(
  ...
  @scala.inline
  implicit class IssuesListForOrgResponseItemRepositoryOps[Self <: IssuesListForOrgResponseItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: IssuesListForOrgResponseItemRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: IssuesListForOrgResponseItemRepositoryPermissions): Self = {
        val ret = this.duplicate
