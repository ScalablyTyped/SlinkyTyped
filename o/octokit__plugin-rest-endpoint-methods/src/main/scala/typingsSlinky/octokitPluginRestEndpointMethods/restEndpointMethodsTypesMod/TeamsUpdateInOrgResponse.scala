...
trait TeamsUpdateInOrgResponse extends js.Object {
  ...
  var organization: TeamsUpdateInOrgResponseOrganization = js.native
...
object TeamsUpdateInOrgResponse {
  ...
  @scala.inline
  implicit class TeamsUpdateInOrgResponseOps[Self <: TeamsUpdateInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOrganization(value: TeamsUpdateInOrgResponseOrganization): Self = {
        val ret = this.duplicate
