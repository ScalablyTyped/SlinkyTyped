...
@js.native
trait TeamsListReposInOrgResponseItemOwner extends js.Object {
...
object TeamsListReposInOrgResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListReposInOrgResponseItemOwner]
  }
  @scala.inline
  implicit class TeamsListReposInOrgResponseItemOwnerOps[Self <: TeamsListReposInOrgResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
