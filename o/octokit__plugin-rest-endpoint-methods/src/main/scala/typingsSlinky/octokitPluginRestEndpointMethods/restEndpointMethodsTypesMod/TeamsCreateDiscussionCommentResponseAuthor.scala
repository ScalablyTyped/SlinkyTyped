...
@js.native
trait TeamsCreateDiscussionCommentResponseAuthor extends js.Object {
...
object TeamsCreateDiscussionCommentResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionCommentResponseAuthor]
  }
  @scala.inline
  implicit class TeamsCreateDiscussionCommentResponseAuthorOps[Self <: TeamsCreateDiscussionCommentResponseAuthor] (val x: Self) extends AnyVal {
    @scala.inline
