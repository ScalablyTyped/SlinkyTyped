...
object PullsCreateReviewRequestResponseHeadRepoPermissions {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseHeadRepoPermissionsOps[Self <: PullsCreateReviewRequestResponseHeadRepoPermissions] (val x: Self) extends AnyVal {
    @scala.inline
