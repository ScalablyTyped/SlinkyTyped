...
object UsersListFollowersForAuthenticatedUserParams {
  @scala.inline
  def apply(): UsersListFollowersForAuthenticatedUserParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UsersListFollowersForAuthenticatedUserParams]
  }
  @scala.inline
  implicit class UsersListFollowersForAuthenticatedUserParamsOps[Self <: UsersListFollowersForAuthenticatedUserParams] (val x: Self) extends AnyVal {
    @scala.inline
