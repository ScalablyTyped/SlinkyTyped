...
@js.native
trait TeamsListDiscussionCommentsLegacyResponseItemReactions extends js.Object {
...
object TeamsListDiscussionCommentsLegacyResponseItemReactions {
  @scala.inline
  def apply(
    `-1`: Double,
    Plussign1: Double,
    ...
    __obj.asInstanceOf[TeamsListDiscussionCommentsLegacyResponseItemReactions]
  }
  @scala.inline
  implicit class TeamsListDiscussionCommentsLegacyResponseItemReactionsOps[Self <: TeamsListDiscussionCommentsLegacyResponseItemReactions] (val x: Self) extends AnyVal {
    @scala.inline
