...
trait GistsGetCommentResponse extends js.Object {
  ...
  var user: GistsGetCommentResponseUser = js.native
}
...
object GistsGetCommentResponse {
  ...
  @scala.inline
  implicit class GistsGetCommentResponseOps[Self <: GistsGetCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: GistsGetCommentResponseUser): Self = {
        val ret = this.duplicate
