...
@js.native
trait PullsCreateFromIssueResponseAssignee extends js.Object {
...
object PullsCreateFromIssueResponseAssignee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseAssignee]
  }
  @scala.inline
  implicit class PullsCreateFromIssueResponseAssigneeOps[Self <: PullsCreateFromIssueResponseAssignee] (val x: Self) extends AnyVal {
    @scala.inline
