...
object ReposGetProtectedBranchRestrictionsResponseTeamsItem {
  ...
  @scala.inline
  implicit class ReposGetProtectedBranchRestrictionsResponseTeamsItemOps[Self <: ReposGetProtectedBranchRestrictionsResponseTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
