...
trait ReposUpdateBranchProtectionResponseRequiredPullRequestReviews extends js.Object {
  ...
  var dismissal_restrictions: ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictions = js.native
...
object ReposUpdateBranchProtectionResponseRequiredPullRequestReviews {
  ...
  @scala.inline
  implicit class ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsOps[Self <: ReposUpdateBranchProtectionResponseRequiredPullRequestReviews] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDismissal_restrictions(value: ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictions): Self = {
        val ret = this.duplicate
