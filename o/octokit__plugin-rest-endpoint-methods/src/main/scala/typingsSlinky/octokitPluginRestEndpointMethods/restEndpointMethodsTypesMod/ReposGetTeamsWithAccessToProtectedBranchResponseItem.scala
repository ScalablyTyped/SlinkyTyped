...
object ReposGetTeamsWithAccessToProtectedBranchResponseItem {
  ...
  @scala.inline
  implicit class ReposGetTeamsWithAccessToProtectedBranchResponseItemOps[Self <: ReposGetTeamsWithAccessToProtectedBranchResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
