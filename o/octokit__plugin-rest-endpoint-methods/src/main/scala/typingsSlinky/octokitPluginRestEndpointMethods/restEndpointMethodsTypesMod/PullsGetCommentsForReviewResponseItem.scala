...
trait PullsGetCommentsForReviewResponseItem extends js.Object {
  var _links: PullsGetCommentsForReviewResponseItemLinks = js.native
  ...
  var user: PullsGetCommentsForReviewResponseItemUser = js.native
}
...
object PullsGetCommentsForReviewResponseItem {
  ...
  @scala.inline
  implicit class PullsGetCommentsForReviewResponseItemOps[Self <: PullsGetCommentsForReviewResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsGetCommentsForReviewResponseItemLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsGetCommentsForReviewResponseItemUser): Self = {
        val ret = this.duplicate
