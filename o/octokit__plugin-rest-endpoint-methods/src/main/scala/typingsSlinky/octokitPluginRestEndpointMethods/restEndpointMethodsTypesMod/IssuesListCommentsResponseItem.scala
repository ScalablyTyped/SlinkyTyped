...
trait IssuesListCommentsResponseItem extends js.Object {
  ...
  var user: IssuesListCommentsResponseItemUser = js.native
}
...
object IssuesListCommentsResponseItem {
  ...
  @scala.inline
  implicit class IssuesListCommentsResponseItemOps[Self <: IssuesListCommentsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: IssuesListCommentsResponseItemUser): Self = {
        val ret = this.duplicate
