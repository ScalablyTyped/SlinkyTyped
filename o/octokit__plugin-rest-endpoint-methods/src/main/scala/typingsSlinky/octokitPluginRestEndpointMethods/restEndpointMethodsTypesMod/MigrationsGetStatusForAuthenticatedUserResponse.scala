...
trait MigrationsGetStatusForAuthenticatedUserResponse extends js.Object {
  ...
  var owner: MigrationsGetStatusForAuthenticatedUserResponseOwner = js.native
  var repositories: js.Array[MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem] = js.native
...
object MigrationsGetStatusForAuthenticatedUserResponse {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForAuthenticatedUserResponseOps[Self <: MigrationsGetStatusForAuthenticatedUserResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsGetStatusForAuthenticatedUserResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRepositories(value: js.Array[MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem]): Self = {
        val ret = this.duplicate
