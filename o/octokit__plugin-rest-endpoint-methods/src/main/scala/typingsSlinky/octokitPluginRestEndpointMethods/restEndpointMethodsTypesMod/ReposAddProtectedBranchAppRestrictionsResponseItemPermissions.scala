...
object ReposAddProtectedBranchAppRestrictionsResponseItemPermissions {
  ...
  @scala.inline
  implicit class ReposAddProtectedBranchAppRestrictionsResponseItemPermissionsOps[Self <: ReposAddProtectedBranchAppRestrictionsResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
