...
trait OrgsUpdateResponse extends js.Object {
  ...
  var plan: OrgsUpdateResponsePlan = js.native
...
object OrgsUpdateResponse {
  ...
  @scala.inline
  implicit class OrgsUpdateResponseOps[Self <: OrgsUpdateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPlan(value: OrgsUpdateResponsePlan): Self = {
        val ret = this.duplicate
