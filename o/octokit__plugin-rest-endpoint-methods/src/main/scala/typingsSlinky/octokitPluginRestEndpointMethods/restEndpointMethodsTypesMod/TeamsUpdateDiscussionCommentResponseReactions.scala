...
@js.native
trait TeamsUpdateDiscussionCommentResponseReactions extends js.Object {
...
object TeamsUpdateDiscussionCommentResponseReactions {
  @scala.inline
  def apply(
    `-1`: Double,
    Plussign1: Double,
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentResponseReactions]
  }
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentResponseReactionsOps[Self <: TeamsUpdateDiscussionCommentResponseReactions] (val x: Self) extends AnyVal {
    @scala.inline
