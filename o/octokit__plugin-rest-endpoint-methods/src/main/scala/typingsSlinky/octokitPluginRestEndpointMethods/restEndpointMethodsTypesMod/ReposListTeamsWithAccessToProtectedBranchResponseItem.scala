...
object ReposListTeamsWithAccessToProtectedBranchResponseItem {
  ...
  @scala.inline
  implicit class ReposListTeamsWithAccessToProtectedBranchResponseItemOps[Self <: ReposListTeamsWithAccessToProtectedBranchResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
