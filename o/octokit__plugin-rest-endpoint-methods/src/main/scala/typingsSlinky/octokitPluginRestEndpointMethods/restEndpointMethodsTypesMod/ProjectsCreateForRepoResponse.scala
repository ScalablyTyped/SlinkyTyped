...
@js.native
trait ProjectsCreateForRepoResponse extends js.Object {
  var body: String = js.native
  var columns_url: String = js.native
  var created_at: String = js.native
  var creator: ProjectsCreateForRepoResponseCreator = js.native
...
object ProjectsCreateForRepoResponse {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[ProjectsCreateForRepoResponse]
  }
  @scala.inline
  implicit class ProjectsCreateForRepoResponseOps[Self <: ProjectsCreateForRepoResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsCreateForRepoResponseCreator): Self = {
        val ret = this.duplicate
