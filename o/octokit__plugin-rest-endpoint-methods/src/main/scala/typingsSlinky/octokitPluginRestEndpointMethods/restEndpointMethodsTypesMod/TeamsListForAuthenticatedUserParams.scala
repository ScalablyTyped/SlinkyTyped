...
object TeamsListForAuthenticatedUserParams {
  @scala.inline
  def apply(): TeamsListForAuthenticatedUserParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TeamsListForAuthenticatedUserParams]
  }
  @scala.inline
  implicit class TeamsListForAuthenticatedUserParamsOps[Self <: TeamsListForAuthenticatedUserParams] (val x: Self) extends AnyVal {
    @scala.inline
