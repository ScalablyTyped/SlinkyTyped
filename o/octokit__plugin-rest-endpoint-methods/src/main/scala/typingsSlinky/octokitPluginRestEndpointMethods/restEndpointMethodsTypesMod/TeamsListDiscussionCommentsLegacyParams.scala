...
object TeamsListDiscussionCommentsLegacyParams {
  @scala.inline
  def apply(discussion_number: Double, team_id: Double): TeamsListDiscussionCommentsLegacyParams = {
  ...
  @scala.inline
  implicit class TeamsListDiscussionCommentsLegacyParamsOps[Self <: TeamsListDiscussionCommentsLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
