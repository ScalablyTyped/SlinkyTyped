...
@js.native
trait ReposGetLatestReleaseResponseAssetsItemUploader extends js.Object {
...
object ReposGetLatestReleaseResponseAssetsItemUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetLatestReleaseResponseAssetsItemUploader]
  }
  @scala.inline
  implicit class ReposGetLatestReleaseResponseAssetsItemUploaderOps[Self <: ReposGetLatestReleaseResponseAssetsItemUploader] (val x: Self) extends AnyVal {
    @scala.inline
