...
@js.native
trait ChecksListSuitesForRefResponseCheckSuitesItemRepository extends js.Object {
  ...
  var owner: ChecksListSuitesForRefResponseCheckSuitesItemRepositoryOwner = js.native
  var permissions: ChecksListSuitesForRefResponseCheckSuitesItemRepositoryPermissions = js.native
...
object ChecksListSuitesForRefResponseCheckSuitesItemRepository {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksListSuitesForRefResponseCheckSuitesItemRepository]
  }
  @scala.inline
  implicit class ChecksListSuitesForRefResponseCheckSuitesItemRepositoryOps[Self <: ChecksListSuitesForRefResponseCheckSuitesItemRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksListSuitesForRefResponseCheckSuitesItemRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksListSuitesForRefResponseCheckSuitesItemRepositoryPermissions): Self = {
        val ret = this.duplicate
