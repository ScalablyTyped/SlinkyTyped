...
trait ChecksListSuitesForRefResponseCheckSuitesItemRepository extends js.Object {
  ...
  var owner: ChecksListSuitesForRefResponseCheckSuitesItemRepositoryOwner
  var permissions: ChecksListSuitesForRefResponseCheckSuitesItemRepositoryPermissions
  var `private`: Boolean
