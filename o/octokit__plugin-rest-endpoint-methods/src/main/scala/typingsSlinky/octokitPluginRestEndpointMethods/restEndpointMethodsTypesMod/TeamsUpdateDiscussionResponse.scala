...
trait TeamsUpdateDiscussionResponse extends js.Object {
  var author: TeamsUpdateDiscussionResponseAuthor = js.native
  ...
  var reactions: TeamsUpdateDiscussionResponseReactions = js.native
...
object TeamsUpdateDiscussionResponse {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionResponseOps[Self <: TeamsUpdateDiscussionResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsUpdateDiscussionResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsUpdateDiscussionResponseReactions): Self = {
        val ret = this.duplicate
