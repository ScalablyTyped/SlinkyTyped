...
object TeamsUpdateDiscussionCommentInOrgResponseReactions {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentInOrgResponseReactionsOps[Self <: TeamsUpdateDiscussionCommentInOrgResponseReactions] (val x: Self) extends AnyVal {
    @scala.inline
