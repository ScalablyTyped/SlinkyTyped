...
trait ReposEnablePagesSiteResponse extends js.Object {
  ...
  var source: ReposEnablePagesSiteResponseSource = js.native
...
object ReposEnablePagesSiteResponse {
  ...
  @scala.inline
  implicit class ReposEnablePagesSiteResponseOps[Self <: ReposEnablePagesSiteResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSource(value: ReposEnablePagesSiteResponseSource): Self = {
        val ret = this.duplicate
