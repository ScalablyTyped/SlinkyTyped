...
object ReposUpdateHookParamsConfig {
  @scala.inline
  def apply(url: String): ReposUpdateHookParamsConfig = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposUpdateHookParamsConfig]
  }
  @scala.inline
  implicit class ReposUpdateHookParamsConfigOps[Self <: ReposUpdateHookParamsConfig] (val x: Self) extends AnyVal {
    @scala.inline
