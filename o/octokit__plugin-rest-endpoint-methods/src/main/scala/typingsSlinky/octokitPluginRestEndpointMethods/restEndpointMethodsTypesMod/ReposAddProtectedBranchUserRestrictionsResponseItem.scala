...
object ReposAddProtectedBranchUserRestrictionsResponseItem {
  ...
  @scala.inline
  implicit class ReposAddProtectedBranchUserRestrictionsResponseItemOps[Self <: ReposAddProtectedBranchUserRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
