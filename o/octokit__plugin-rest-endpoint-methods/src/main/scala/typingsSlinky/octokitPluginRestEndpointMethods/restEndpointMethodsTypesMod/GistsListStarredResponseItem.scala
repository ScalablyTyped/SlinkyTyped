...
trait GistsListStarredResponseItem extends js.Object {
  ...
  var files: GistsListStarredResponseItemFiles = js.native
  ...
  var owner: GistsListStarredResponseItemOwner = js.native
...
object GistsListStarredResponseItem {
  ...
  @scala.inline
  implicit class GistsListStarredResponseItemOps[Self <: GistsListStarredResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsListStarredResponseItemFiles): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsListStarredResponseItemOwner): Self = {
        val ret = this.duplicate
