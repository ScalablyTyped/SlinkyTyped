...
trait ReposListHooksResponseItem extends js.Object {
  ...
  var config: ReposListHooksResponseItemConfig = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var id: Double = js.native
  var last_response: ReposListHooksResponseItemLastResponse = js.native
...
object ReposListHooksResponseItem {
  ...
  @scala.inline
  implicit class ReposListHooksResponseItemOps[Self <: ReposListHooksResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withConfig(value: ReposListHooksResponseItemConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast_response(value: ReposListHooksResponseItemLastResponse): Self = {
        val ret = this.duplicate
