...
trait ReposAddCollaboratorResponse extends js.Object {
  ...
  var invitee: ReposAddCollaboratorResponseInvitee = js.native
  var inviter: ReposAddCollaboratorResponseInviter = js.native
  var permissions: String = js.native
  var repository: ReposAddCollaboratorResponseRepository = js.native
...
object ReposAddCollaboratorResponse {
  ...
  @scala.inline
  implicit class ReposAddCollaboratorResponseOps[Self <: ReposAddCollaboratorResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInvitee(value: ReposAddCollaboratorResponseInvitee): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("invitee")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withInviter(value: ReposAddCollaboratorResponseInviter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRepository(value: ReposAddCollaboratorResponseRepository): Self = {
        val ret = this.duplicate
