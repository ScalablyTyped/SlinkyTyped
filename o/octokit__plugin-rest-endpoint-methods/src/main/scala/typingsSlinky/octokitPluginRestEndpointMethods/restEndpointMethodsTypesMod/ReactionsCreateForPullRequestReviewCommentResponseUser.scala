...
@js.native
trait ReactionsCreateForPullRequestReviewCommentResponseUser extends js.Object {
...
object ReactionsCreateForPullRequestReviewCommentResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForPullRequestReviewCommentResponseUser]
  }
  @scala.inline
  implicit class ReactionsCreateForPullRequestReviewCommentResponseUserOps[Self <: ReactionsCreateForPullRequestReviewCommentResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
