...
object PullsListReviewRequestsParams {
  @scala.inline
  def apply(owner: String, pull_number: Double, repo: String): PullsListReviewRequestsParams = {
  ...
  @scala.inline
  implicit class PullsListReviewRequestsParamsOps[Self <: PullsListReviewRequestsParams] (val x: Self) extends AnyVal {
    @scala.inline
