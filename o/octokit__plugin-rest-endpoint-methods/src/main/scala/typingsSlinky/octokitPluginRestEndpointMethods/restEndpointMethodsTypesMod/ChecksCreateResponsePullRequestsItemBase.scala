...
trait ChecksCreateResponsePullRequestsItemBase extends js.Object {
  ...
  var repo: ChecksCreateResponsePullRequestsItemBaseRepo = js.native
...
object ChecksCreateResponsePullRequestsItemBase {
  ...
  @scala.inline
  implicit class ChecksCreateResponsePullRequestsItemBaseOps[Self <: ChecksCreateResponsePullRequestsItemBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: ChecksCreateResponsePullRequestsItemBaseRepo): Self = {
        val ret = this.duplicate
