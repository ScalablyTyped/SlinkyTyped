...
trait ReactionsCreateForCommitCommentResponse extends js.Object {
  ...
  var user: ReactionsCreateForCommitCommentResponseUser = js.native
}
...
object ReactionsCreateForCommitCommentResponse {
  ...
  @scala.inline
  implicit class ReactionsCreateForCommitCommentResponseOps[Self <: ReactionsCreateForCommitCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsCreateForCommitCommentResponseUser): Self = {
        val ret = this.duplicate
