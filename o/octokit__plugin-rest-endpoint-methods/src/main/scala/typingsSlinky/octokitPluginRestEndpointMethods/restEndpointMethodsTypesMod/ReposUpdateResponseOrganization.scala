...
@js.native
trait ReposUpdateResponseOrganization extends js.Object {
...
object ReposUpdateResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateResponseOrganization]
  }
  @scala.inline
  implicit class ReposUpdateResponseOrganizationOps[Self <: ReposUpdateResponseOrganization] (val x: Self) extends AnyVal {
    @scala.inline
