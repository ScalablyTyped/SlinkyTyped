...
trait TeamsListChildResponseItem extends js.Object {
  ...
  var parent: TeamsListChildResponseItemParent = js.native
...
object TeamsListChildResponseItem {
  ...
  @scala.inline
  implicit class TeamsListChildResponseItemOps[Self <: TeamsListChildResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParent(value: TeamsListChildResponseItemParent): Self = {
        val ret = this.duplicate
