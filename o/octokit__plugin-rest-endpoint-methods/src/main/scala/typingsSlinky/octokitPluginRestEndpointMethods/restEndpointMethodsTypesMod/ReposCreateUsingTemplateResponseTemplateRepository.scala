...
trait ReposCreateUsingTemplateResponseTemplateRepository extends js.Object {
  ...
  var owner: ReposCreateUsingTemplateResponseTemplateRepositoryOwner = js.native
  var permissions: ReposCreateUsingTemplateResponseTemplateRepositoryPermissions = js.native
...
object ReposCreateUsingTemplateResponseTemplateRepository {
  ...
  @scala.inline
  implicit class ReposCreateUsingTemplateResponseTemplateRepositoryOps[Self <: ReposCreateUsingTemplateResponseTemplateRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposCreateUsingTemplateResponseTemplateRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposCreateUsingTemplateResponseTemplateRepositoryPermissions): Self = {
        val ret = this.duplicate
