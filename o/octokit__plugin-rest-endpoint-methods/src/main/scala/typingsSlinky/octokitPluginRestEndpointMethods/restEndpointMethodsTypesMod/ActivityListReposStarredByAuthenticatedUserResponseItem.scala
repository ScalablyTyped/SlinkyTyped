...
trait ActivityListReposStarredByAuthenticatedUserResponseItem extends js.Object {
  ...
  var owner: ActivityListReposStarredByAuthenticatedUserResponseItemOwner = js.native
  var permissions: ActivityListReposStarredByAuthenticatedUserResponseItemPermissions = js.native
...
object ActivityListReposStarredByAuthenticatedUserResponseItem {
  ...
  @scala.inline
  implicit class ActivityListReposStarredByAuthenticatedUserResponseItemOps[Self <: ActivityListReposStarredByAuthenticatedUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActivityListReposStarredByAuthenticatedUserResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ActivityListReposStarredByAuthenticatedUserResponseItemPermissions): Self = {
        val ret = this.duplicate
