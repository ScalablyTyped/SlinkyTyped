...
@js.native
trait ReposCompareCommitsResponseMergeBaseCommitAuthor extends js.Object {
...
object ReposCompareCommitsResponseMergeBaseCommitAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCompareCommitsResponseMergeBaseCommitAuthor]
  }
  @scala.inline
  implicit class ReposCompareCommitsResponseMergeBaseCommitAuthorOps[Self <: ReposCompareCommitsResponseMergeBaseCommitAuthor] (val x: Self) extends AnyVal {
    @scala.inline
