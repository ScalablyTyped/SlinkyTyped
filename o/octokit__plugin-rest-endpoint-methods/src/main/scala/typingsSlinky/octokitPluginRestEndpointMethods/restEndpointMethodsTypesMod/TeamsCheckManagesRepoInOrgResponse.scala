...
trait TeamsCheckManagesRepoInOrgResponse extends js.Object {
  ...
  var owner: TeamsCheckManagesRepoInOrgResponseOwner = js.native
  var permissions: TeamsCheckManagesRepoInOrgResponsePermissions = js.native
...
object TeamsCheckManagesRepoInOrgResponse {
  ...
  @scala.inline
  implicit class TeamsCheckManagesRepoInOrgResponseOps[Self <: TeamsCheckManagesRepoInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: TeamsCheckManagesRepoInOrgResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: TeamsCheckManagesRepoInOrgResponsePermissions): Self = {
        val ret = this.duplicate
