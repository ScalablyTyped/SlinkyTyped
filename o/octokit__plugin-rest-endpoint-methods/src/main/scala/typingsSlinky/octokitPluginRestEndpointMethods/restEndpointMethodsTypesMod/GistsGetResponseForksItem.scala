...
trait GistsGetResponseForksItem extends js.Object {
  ...
  var user: GistsGetResponseForksItemUser = js.native
}
...
object GistsGetResponseForksItem {
  ...
  @scala.inline
  implicit class GistsGetResponseForksItemOps[Self <: GistsGetResponseForksItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: GistsGetResponseForksItemUser): Self = {
        val ret = this.duplicate
