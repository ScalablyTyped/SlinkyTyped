...
trait IssuesCreateResponseMilestone extends js.Object {
  ...
  var creator: IssuesCreateResponseMilestoneCreator = js.native
...
object IssuesCreateResponseMilestone {
  ...
  @scala.inline
  implicit class IssuesCreateResponseMilestoneOps[Self <: IssuesCreateResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesCreateResponseMilestoneCreator): Self = {
        val ret = this.duplicate
