...
object IssuesListForAuthenticatedUserParams {
  @scala.inline
  def apply(): IssuesListForAuthenticatedUserParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IssuesListForAuthenticatedUserParams]
  }
  @scala.inline
  implicit class IssuesListForAuthenticatedUserParamsOps[Self <: IssuesListForAuthenticatedUserParams] (val x: Self) extends AnyVal {
    @scala.inline
