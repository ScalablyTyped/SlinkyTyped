...
trait ReposUpdateHookResponse extends js.Object {
  ...
  var config: ReposUpdateHookResponseConfig = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var id: Double = js.native
  var last_response: ReposUpdateHookResponseLastResponse = js.native
...
object ReposUpdateHookResponse {
  ...
  @scala.inline
  implicit class ReposUpdateHookResponseOps[Self <: ReposUpdateHookResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withConfig(value: ReposUpdateHookResponseConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast_response(value: ReposUpdateHookResponseLastResponse): Self = {
        val ret = this.duplicate
