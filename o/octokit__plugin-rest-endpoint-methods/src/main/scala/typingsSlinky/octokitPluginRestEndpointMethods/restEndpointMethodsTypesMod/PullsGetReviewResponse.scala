...
trait PullsGetReviewResponse extends js.Object {
  var _links: PullsGetReviewResponseLinks = js.native
  ...
  var user: PullsGetReviewResponseUser = js.native
}
...
object PullsGetReviewResponse {
  ...
  @scala.inline
  implicit class PullsGetReviewResponseOps[Self <: PullsGetReviewResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsGetReviewResponseLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsGetReviewResponseUser): Self = {
        val ret = this.duplicate
