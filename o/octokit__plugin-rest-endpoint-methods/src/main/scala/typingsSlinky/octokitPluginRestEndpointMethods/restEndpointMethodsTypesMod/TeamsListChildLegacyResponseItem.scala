...
trait TeamsListChildLegacyResponseItem extends js.Object {
  ...
  var parent: TeamsListChildLegacyResponseItemParent = js.native
...
object TeamsListChildLegacyResponseItem {
  ...
  @scala.inline
  implicit class TeamsListChildLegacyResponseItemOps[Self <: TeamsListChildLegacyResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParent(value: TeamsListChildLegacyResponseItemParent): Self = {
        val ret = this.duplicate
