...
@js.native
trait ReposGetReleaseAssetResponseUploader extends js.Object {
...
object ReposGetReleaseAssetResponseUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetReleaseAssetResponseUploader]
  }
  @scala.inline
  implicit class ReposGetReleaseAssetResponseUploaderOps[Self <: ReposGetReleaseAssetResponseUploader] (val x: Self) extends AnyVal {
    @scala.inline
