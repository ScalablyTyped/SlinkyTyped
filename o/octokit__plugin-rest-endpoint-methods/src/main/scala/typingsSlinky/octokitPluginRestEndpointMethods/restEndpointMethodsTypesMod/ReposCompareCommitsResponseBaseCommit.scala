...
trait ReposCompareCommitsResponseBaseCommit extends js.Object {
  var author: ReposCompareCommitsResponseBaseCommitAuthor = js.native
  var comments_url: String = js.native
  var commit: ReposCompareCommitsResponseBaseCommitCommit = js.native
  var committer: ReposCompareCommitsResponseBaseCommitCommitter = js.native
  var html_url: String = js.native
  var node_id: String = js.native
  var parents: js.Array[ReposCompareCommitsResponseBaseCommitParentsItem] = js.native
...
object ReposCompareCommitsResponseBaseCommit {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseBaseCommitOps[Self <: ReposCompareCommitsResponseBaseCommit] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: ReposCompareCommitsResponseBaseCommitAuthor): Self = {
    ...
    @scala.inline
    def withCommit(value: ReposCompareCommitsResponseBaseCommitCommit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("commit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCommitter(value: ReposCompareCommitsResponseBaseCommitCommitter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withParents(value: js.Array[ReposCompareCommitsResponseBaseCommitParentsItem]): Self = {
        val ret = this.duplicate
