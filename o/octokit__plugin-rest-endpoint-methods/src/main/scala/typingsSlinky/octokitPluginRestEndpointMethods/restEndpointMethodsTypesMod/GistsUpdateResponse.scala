...
trait GistsUpdateResponse extends js.Object {
  ...
  var files: GistsUpdateResponseFiles = js.native
  var forks: js.Array[GistsUpdateResponseForksItem] = js.native
  var forks_url: String = js.native
  var git_pull_url: String = js.native
  var git_push_url: String = js.native
  var history: js.Array[GistsUpdateResponseHistoryItem] = js.native
  var html_url: String = js.native
  var id: String = js.native
  var node_id: String = js.native
  var owner: GistsUpdateResponseOwner = js.native
...
object GistsUpdateResponse {
  ...
  @scala.inline
  implicit class GistsUpdateResponseOps[Self <: GistsUpdateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsUpdateResponseFiles): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("files")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withForks(value: js.Array[GistsUpdateResponseForksItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHistory(value: js.Array[GistsUpdateResponseHistoryItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsUpdateResponseOwner): Self = {
        val ret = this.duplicate
