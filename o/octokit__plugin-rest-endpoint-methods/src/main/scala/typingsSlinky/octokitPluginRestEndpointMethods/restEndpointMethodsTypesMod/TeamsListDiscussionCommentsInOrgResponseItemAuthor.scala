...
object TeamsListDiscussionCommentsInOrgResponseItemAuthor {
  ...
  @scala.inline
  implicit class TeamsListDiscussionCommentsInOrgResponseItemAuthorOps[Self <: TeamsListDiscussionCommentsInOrgResponseItemAuthor] (val x: Self) extends AnyVal {
    @scala.inline
