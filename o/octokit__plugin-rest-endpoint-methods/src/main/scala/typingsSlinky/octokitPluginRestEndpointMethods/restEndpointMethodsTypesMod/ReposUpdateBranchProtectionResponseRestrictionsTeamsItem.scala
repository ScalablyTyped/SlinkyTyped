...
object ReposUpdateBranchProtectionResponseRestrictionsTeamsItem {
  ...
  @scala.inline
  implicit class ReposUpdateBranchProtectionResponseRestrictionsTeamsItemOps[Self <: ReposUpdateBranchProtectionResponseRestrictionsTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
