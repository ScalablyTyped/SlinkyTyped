...
@js.native
trait AppsResetAuthorizationResponseUser extends js.Object {
...
object AppsResetAuthorizationResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsResetAuthorizationResponseUser]
  }
  @scala.inline
  implicit class AppsResetAuthorizationResponseUserOps[Self <: AppsResetAuthorizationResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
