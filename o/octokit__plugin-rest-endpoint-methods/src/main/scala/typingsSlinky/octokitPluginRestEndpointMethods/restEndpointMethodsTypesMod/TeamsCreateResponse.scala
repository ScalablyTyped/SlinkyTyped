...
trait TeamsCreateResponse extends js.Object {
  ...
  var organization: TeamsCreateResponseOrganization = js.native
...
object TeamsCreateResponse {
  ...
  @scala.inline
  implicit class TeamsCreateResponseOps[Self <: TeamsCreateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOrganization(value: TeamsCreateResponseOrganization): Self = {
        val ret = this.duplicate
