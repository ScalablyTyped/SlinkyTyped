...
@js.native
trait TeamsAddOrUpdateProjectLegacyParams extends js.Object {
  /**
...
object TeamsAddOrUpdateProjectLegacyParams {
  @scala.inline
  def apply(project_id: Double, team_id: Double): TeamsAddOrUpdateProjectLegacyParams = {
    val __obj = js.Dynamic.literal(project_id = project_id.asInstanceOf[js.Any], team_id = team_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TeamsAddOrUpdateProjectLegacyParams]
  }
  @scala.inline
  implicit class TeamsAddOrUpdateProjectLegacyParamsOps[Self <: TeamsAddOrUpdateProjectLegacyParams] (val x: Self) extends AnyVal {
    @scala.inline
