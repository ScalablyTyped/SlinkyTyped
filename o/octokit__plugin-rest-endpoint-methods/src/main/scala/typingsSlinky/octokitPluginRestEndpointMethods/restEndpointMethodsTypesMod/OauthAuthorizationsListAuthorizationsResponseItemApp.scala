...
object OauthAuthorizationsListAuthorizationsResponseItemApp {
  ...
  @scala.inline
  implicit class OauthAuthorizationsListAuthorizationsResponseItemAppOps[Self <: OauthAuthorizationsListAuthorizationsResponseItemApp] (val x: Self) extends AnyVal {
    @scala.inline
