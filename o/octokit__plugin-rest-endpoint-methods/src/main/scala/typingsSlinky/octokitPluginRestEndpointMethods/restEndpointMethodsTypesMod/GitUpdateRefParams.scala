...
object GitUpdateRefParams {
  @scala.inline
  def apply(owner: String, ref: String, repo: String, sha: String): GitUpdateRefParams = {
  ...
  @scala.inline
  implicit class GitUpdateRefParamsOps[Self <: GitUpdateRefParams] (val x: Self) extends AnyVal {
    @scala.inline
