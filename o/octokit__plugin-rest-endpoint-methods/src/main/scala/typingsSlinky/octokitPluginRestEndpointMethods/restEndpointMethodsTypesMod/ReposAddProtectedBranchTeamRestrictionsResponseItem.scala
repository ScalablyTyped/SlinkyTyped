...
object ReposAddProtectedBranchTeamRestrictionsResponseItem {
  ...
  @scala.inline
  implicit class ReposAddProtectedBranchTeamRestrictionsResponseItemOps[Self <: ReposAddProtectedBranchTeamRestrictionsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
