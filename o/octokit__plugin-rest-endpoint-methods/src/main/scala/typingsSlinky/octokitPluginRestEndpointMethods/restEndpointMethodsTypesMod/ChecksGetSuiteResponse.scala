...
trait ChecksGetSuiteResponse extends js.Object {
  ...
  var app: ChecksGetSuiteResponseApp = js.native
  ...
  var repository: ChecksGetSuiteResponseRepository = js.native
...
object ChecksGetSuiteResponse {
  ...
  @scala.inline
  implicit class ChecksGetSuiteResponseOps[Self <: ChecksGetSuiteResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withApp(value: ChecksGetSuiteResponseApp): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRepository(value: ChecksGetSuiteResponseRepository): Self = {
        val ret = this.duplicate
