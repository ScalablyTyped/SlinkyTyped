...
trait GistsListPublicResponseItem extends js.Object {
  ...
  var files: GistsListPublicResponseItemFiles = js.native
  ...
  var owner: GistsListPublicResponseItemOwner = js.native
...
object GistsListPublicResponseItem {
  ...
  @scala.inline
  implicit class GistsListPublicResponseItemOps[Self <: GistsListPublicResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsListPublicResponseItemFiles): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsListPublicResponseItemOwner): Self = {
        val ret = this.duplicate
