...
object AppsListAccountsUserOrOrgOnPlanParams {
  @scala.inline
  def apply(plan_id: Double): AppsListAccountsUserOrOrgOnPlanParams = {
    val __obj = js.Dynamic.literal(plan_id = plan_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanParams]
  }
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanParamsOps[Self <: AppsListAccountsUserOrOrgOnPlanParams] (val x: Self) extends AnyVal {
    @scala.inline
