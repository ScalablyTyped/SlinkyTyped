...
object ChecksListForSuiteResponseCheckRunsItemAppPermissions {
  ...
  @scala.inline
  implicit class ChecksListForSuiteResponseCheckRunsItemAppPermissionsOps[Self <: ChecksListForSuiteResponseCheckRunsItemAppPermissions] (val x: Self) extends AnyVal {
    @scala.inline
