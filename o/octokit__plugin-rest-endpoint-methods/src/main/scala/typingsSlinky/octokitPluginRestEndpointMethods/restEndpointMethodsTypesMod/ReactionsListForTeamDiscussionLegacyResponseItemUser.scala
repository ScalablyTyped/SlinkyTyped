...
object ReactionsListForTeamDiscussionLegacyResponseItemUser {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionLegacyResponseItemUserOps[Self <: ReactionsListForTeamDiscussionLegacyResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
