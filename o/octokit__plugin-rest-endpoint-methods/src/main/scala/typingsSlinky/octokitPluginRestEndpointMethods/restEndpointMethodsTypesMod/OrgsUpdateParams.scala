...
import typingsSlinky.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.none
...
object OrgsUpdateParams {
  @scala.inline
  def apply(org_ : String): OrgsUpdateParams = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("org")(org_.asInstanceOf[js.Any])
    __obj.asInstanceOf[OrgsUpdateParams]
  }
  @scala.inline
  implicit class OrgsUpdateParamsOps[Self <: OrgsUpdateParams] (val x: Self) extends AnyVal {
    @scala.inline
