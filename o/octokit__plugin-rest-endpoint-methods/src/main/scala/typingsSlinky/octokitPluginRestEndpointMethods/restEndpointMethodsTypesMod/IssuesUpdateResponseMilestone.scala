...
trait IssuesUpdateResponseMilestone extends js.Object {
  ...
  var creator: IssuesUpdateResponseMilestoneCreator = js.native
...
object IssuesUpdateResponseMilestone {
  ...
  @scala.inline
  implicit class IssuesUpdateResponseMilestoneOps[Self <: IssuesUpdateResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesUpdateResponseMilestoneCreator): Self = {
        val ret = this.duplicate
