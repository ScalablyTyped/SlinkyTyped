...
object ReposListProtectedBranchRequiredStatusChecksContextsParams {
  ...
  @scala.inline
  implicit class ReposListProtectedBranchRequiredStatusChecksContextsParamsOps[Self <: ReposListProtectedBranchRequiredStatusChecksContextsParams] (val x: Self) extends AnyVal {
    @scala.inline
