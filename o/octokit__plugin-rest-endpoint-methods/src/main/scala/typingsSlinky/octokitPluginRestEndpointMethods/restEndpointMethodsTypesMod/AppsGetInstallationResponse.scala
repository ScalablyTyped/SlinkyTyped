...
trait AppsGetInstallationResponse extends js.Object {
  ...
  var account: AppsGetInstallationResponseAccount = js.native
  var app_id: Double = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: AppsGetInstallationResponsePermissions = js.native
...
object AppsGetInstallationResponse {
  ...
  @scala.inline
  implicit class AppsGetInstallationResponseOps[Self <: AppsGetInstallationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: AppsGetInstallationResponseAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: AppsGetInstallationResponsePermissions): Self = {
        val ret = this.duplicate
