...
trait AppsResetTokenResponse extends js.Object {
  var app: AppsResetTokenResponseApp = js.native
  ...
  var user: AppsResetTokenResponseUser = js.native
}
...
object AppsResetTokenResponse {
  ...
  @scala.inline
  implicit class AppsResetTokenResponseOps[Self <: AppsResetTokenResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: AppsResetTokenResponseApp): Self = {
    ...
    @scala.inline
    def withUser(value: AppsResetTokenResponseUser): Self = {
        val ret = this.duplicate
