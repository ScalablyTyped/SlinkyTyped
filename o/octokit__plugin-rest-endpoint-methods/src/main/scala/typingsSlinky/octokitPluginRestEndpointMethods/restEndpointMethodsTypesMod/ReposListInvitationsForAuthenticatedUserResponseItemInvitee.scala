...
object ReposListInvitationsForAuthenticatedUserResponseItemInvitee {
  ...
  @scala.inline
  implicit class ReposListInvitationsForAuthenticatedUserResponseItemInviteeOps[Self <: ReposListInvitationsForAuthenticatedUserResponseItemInvitee] (val x: Self) extends AnyVal {
    @scala.inline
