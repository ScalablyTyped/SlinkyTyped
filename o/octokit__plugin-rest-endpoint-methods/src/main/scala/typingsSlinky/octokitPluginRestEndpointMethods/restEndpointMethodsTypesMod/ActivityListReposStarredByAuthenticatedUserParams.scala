...
object ActivityListReposStarredByAuthenticatedUserParams {
  @scala.inline
  def apply(): ActivityListReposStarredByAuthenticatedUserParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ActivityListReposStarredByAuthenticatedUserParams]
  }
  @scala.inline
  implicit class ActivityListReposStarredByAuthenticatedUserParamsOps[Self <: ActivityListReposStarredByAuthenticatedUserParams] (val x: Self) extends AnyVal {
    @scala.inline
