...
@js.native
trait PullsUpdateCommentResponse extends js.Object {
  var _links: PullsUpdateCommentResponseLinks = js.native
  ...
  var user: PullsUpdateCommentResponseUser = js.native
}

object PullsUpdateCommentResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsUpdateCommentResponse]
  }
  @scala.inline
  implicit class PullsUpdateCommentResponseOps[Self <: PullsUpdateCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsUpdateCommentResponseLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsUpdateCommentResponseUser): Self = {
        val ret = this.duplicate
