...
trait UsersCreateGpgKeyResponse extends js.Object {
  ...
  var emails: js.Array[UsersCreateGpgKeyResponseEmailsItem] = js.native
  ...
  var subkeys: js.Array[UsersCreateGpgKeyResponseSubkeysItem] = js.native
}
...
object UsersCreateGpgKeyResponse {
  ...
  @scala.inline
  implicit class UsersCreateGpgKeyResponseOps[Self <: UsersCreateGpgKeyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEmails(value: js.Array[UsersCreateGpgKeyResponseEmailsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSubkeys(value: js.Array[UsersCreateGpgKeyResponseSubkeysItem]): Self = {
        val ret = this.duplicate
