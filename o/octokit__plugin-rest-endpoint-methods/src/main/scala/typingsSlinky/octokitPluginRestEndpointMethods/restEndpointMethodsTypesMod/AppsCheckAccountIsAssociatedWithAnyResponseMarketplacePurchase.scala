...
trait AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchase extends js.Object {
  ...
  var plan: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchasePlan = js.native
...
object AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchase {
  ...
  @scala.inline
  implicit class AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchaseOps[Self <: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPlan(value: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchasePlan): Self = {
        val ret = this.duplicate
