...
trait PullsUpdateResponseBaseRepo extends js.Object {
  ...
  var owner: PullsUpdateResponseBaseRepoOwner = js.native
  var permissions: PullsUpdateResponseBaseRepoPermissions = js.native
...
object PullsUpdateResponseBaseRepo {
  ...
  @scala.inline
  implicit class PullsUpdateResponseBaseRepoOps[Self <: PullsUpdateResponseBaseRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsUpdateResponseBaseRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsUpdateResponseBaseRepoPermissions): Self = {
        val ret = this.duplicate
