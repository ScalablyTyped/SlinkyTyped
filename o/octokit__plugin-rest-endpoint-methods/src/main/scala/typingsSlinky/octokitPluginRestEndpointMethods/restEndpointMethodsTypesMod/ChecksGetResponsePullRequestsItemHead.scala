...
trait ChecksGetResponsePullRequestsItemHead extends js.Object {
  ...
  var repo: ChecksGetResponsePullRequestsItemHeadRepo = js.native
...
object ChecksGetResponsePullRequestsItemHead {
  ...
  @scala.inline
  implicit class ChecksGetResponsePullRequestsItemHeadOps[Self <: ChecksGetResponsePullRequestsItemHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: ChecksGetResponsePullRequestsItemHeadRepo): Self = {
        val ret = this.duplicate
