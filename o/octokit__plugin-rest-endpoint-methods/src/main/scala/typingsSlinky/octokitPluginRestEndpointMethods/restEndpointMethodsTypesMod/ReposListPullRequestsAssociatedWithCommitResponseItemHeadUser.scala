...
@js.native
trait ReposListPullRequestsAssociatedWithCommitResponseItemHeadUser extends js.Object {
...
object ReposListPullRequestsAssociatedWithCommitResponseItemHeadUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemHeadUser]
  }
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemHeadUserOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemHeadUser] (val x: Self) extends AnyVal {
    @scala.inline
