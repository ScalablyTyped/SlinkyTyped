...
@js.native
trait ReposGetReleaseByTagResponseAssetsItemUploader extends js.Object {
...
object ReposGetReleaseByTagResponseAssetsItemUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetReleaseByTagResponseAssetsItemUploader]
  }
  @scala.inline
  implicit class ReposGetReleaseByTagResponseAssetsItemUploaderOps[Self <: ReposGetReleaseByTagResponseAssetsItemUploader] (val x: Self) extends AnyVal {
    @scala.inline
