...
trait UsersGetGpgKeyResponse extends js.Object {
  ...
  var emails: js.Array[UsersGetGpgKeyResponseEmailsItem] = js.native
  ...
  var subkeys: js.Array[UsersGetGpgKeyResponseSubkeysItem] = js.native
}
...
object UsersGetGpgKeyResponse {
  ...
  @scala.inline
  implicit class UsersGetGpgKeyResponseOps[Self <: UsersGetGpgKeyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEmails(value: js.Array[UsersGetGpgKeyResponseEmailsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSubkeys(value: js.Array[UsersGetGpgKeyResponseSubkeysItem]): Self = {
        val ret = this.duplicate
