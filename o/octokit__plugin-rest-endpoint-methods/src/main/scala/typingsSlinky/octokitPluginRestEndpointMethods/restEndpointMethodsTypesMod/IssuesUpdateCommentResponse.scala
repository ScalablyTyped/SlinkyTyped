...
trait IssuesUpdateCommentResponse extends js.Object {
  ...
  var user: IssuesUpdateCommentResponseUser = js.native
}
...
object IssuesUpdateCommentResponse {
  ...
  @scala.inline
  implicit class IssuesUpdateCommentResponseOps[Self <: IssuesUpdateCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: IssuesUpdateCommentResponseUser): Self = {
        val ret = this.duplicate
