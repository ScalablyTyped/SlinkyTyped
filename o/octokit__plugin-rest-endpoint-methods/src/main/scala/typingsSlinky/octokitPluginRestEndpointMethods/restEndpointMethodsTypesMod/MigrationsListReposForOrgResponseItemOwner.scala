...
@js.native
trait MigrationsListReposForOrgResponseItemOwner extends js.Object {
...
object MigrationsListReposForOrgResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsListReposForOrgResponseItemOwner]
  }
  @scala.inline
  implicit class MigrationsListReposForOrgResponseItemOwnerOps[Self <: MigrationsListReposForOrgResponseItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
