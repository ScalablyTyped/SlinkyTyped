...
object ReposGetBranchProtectionResponseRestrictionsAppsItemPermissions {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRestrictionsAppsItemPermissionsOps[Self <: ReposGetBranchProtectionResponseRestrictionsAppsItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
