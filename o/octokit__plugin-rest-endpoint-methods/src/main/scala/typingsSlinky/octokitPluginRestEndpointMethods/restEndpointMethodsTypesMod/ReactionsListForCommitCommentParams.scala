...
object ReactionsListForCommitCommentParams {
  @scala.inline
  def apply(comment_id: Double, owner: String, repo: String): ReactionsListForCommitCommentParams = {
  ...
  @scala.inline
  implicit class ReactionsListForCommitCommentParamsOps[Self <: ReactionsListForCommitCommentParams] (val x: Self) extends AnyVal {
    @scala.inline
