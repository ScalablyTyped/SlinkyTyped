...
trait GistsListPublicForUserResponseItem extends js.Object {
  ...
  var files: GistsListPublicForUserResponseItemFiles = js.native
  ...
  var owner: GistsListPublicForUserResponseItemOwner = js.native
...
object GistsListPublicForUserResponseItem {
  ...
  @scala.inline
  implicit class GistsListPublicForUserResponseItemOps[Self <: GistsListPublicForUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsListPublicForUserResponseItemFiles): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsListPublicForUserResponseItemOwner): Self = {
        val ret = this.duplicate
