...
trait ActionsListWorkflowRunsResponseWorkflowRunsItem extends js.Object {
  ...
  var head_commit: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadCommit
  var head_repository: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository
  var head_sha: String
  var html_url: String
  var id: Double
  var jobs_url: String
  ...
  var repository: ActionsListWorkflowRunsResponseWorkflowRunsItemRepository
