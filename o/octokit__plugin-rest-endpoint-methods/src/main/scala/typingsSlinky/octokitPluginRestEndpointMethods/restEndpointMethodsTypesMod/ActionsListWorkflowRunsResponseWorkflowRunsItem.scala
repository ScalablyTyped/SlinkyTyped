...
@js.native
trait ActionsListWorkflowRunsResponseWorkflowRunsItem extends js.Object {
  ...
  var head_commit: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadCommit = js.native
  var head_repository: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository = js.native
  ...
  var repository: ActionsListWorkflowRunsResponseWorkflowRunsItemRepository = js.native
...
object ActionsListWorkflowRunsResponseWorkflowRunsItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActionsListWorkflowRunsResponseWorkflowRunsItem]
  }
  @scala.inline
  implicit class ActionsListWorkflowRunsResponseWorkflowRunsItemOps[Self <: ActionsListWorkflowRunsResponseWorkflowRunsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withHead_commit(value: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadCommit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("head_commit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHead_repository(value: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRepository(value: ActionsListWorkflowRunsResponseWorkflowRunsItemRepository): Self = {
        val ret = this.duplicate
