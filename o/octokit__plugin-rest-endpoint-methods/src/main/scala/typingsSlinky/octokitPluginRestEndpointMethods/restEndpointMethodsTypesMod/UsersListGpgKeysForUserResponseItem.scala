...
trait UsersListGpgKeysForUserResponseItem extends js.Object {
  ...
  var emails: js.Array[UsersListGpgKeysForUserResponseItemEmailsItem] = js.native
  var expires_at: Null = js.native
  var id: Double = js.native
  var key_id: String = js.native
  var primary_key_id: Null = js.native
  var public_key: String = js.native
  var subkeys: js.Array[UsersListGpgKeysForUserResponseItemSubkeysItem] = js.native
}
...
object UsersListGpgKeysForUserResponseItem {
  ...
  @scala.inline
  implicit class UsersListGpgKeysForUserResponseItemOps[Self <: UsersListGpgKeysForUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEmails(value: js.Array[UsersListGpgKeysForUserResponseItemEmailsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPrimary_key_id(value: Null): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSubkeys(value: js.Array[UsersListGpgKeysForUserResponseItemSubkeysItem]): Self = {
        val ret = this.duplicate
