...
@js.native
trait ReposUploadReleaseAssetResponseValueUploader extends js.Object {
...
object ReposUploadReleaseAssetResponseValueUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUploadReleaseAssetResponseValueUploader]
  }
  @scala.inline
  implicit class ReposUploadReleaseAssetResponseValueUploaderOps[Self <: ReposUploadReleaseAssetResponseValueUploader] (val x: Self) extends AnyVal {
    @scala.inline
