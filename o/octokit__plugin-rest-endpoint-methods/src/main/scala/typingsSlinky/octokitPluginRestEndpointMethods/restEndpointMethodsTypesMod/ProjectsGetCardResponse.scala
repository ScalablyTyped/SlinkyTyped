...
@js.native
trait ProjectsGetCardResponse extends js.Object {
  var archived: Boolean = js.native
  var column_url: String = js.native
  var content_url: String = js.native
  var created_at: String = js.native
  var creator: ProjectsGetCardResponseCreator = js.native
...
object ProjectsGetCardResponse {
  @scala.inline
  def apply(
    archived: Boolean,
    column_url: String,
    ...
    __obj.asInstanceOf[ProjectsGetCardResponse]
  }
  @scala.inline
  implicit class ProjectsGetCardResponseOps[Self <: ProjectsGetCardResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsGetCardResponseCreator): Self = {
        val ret = this.duplicate
