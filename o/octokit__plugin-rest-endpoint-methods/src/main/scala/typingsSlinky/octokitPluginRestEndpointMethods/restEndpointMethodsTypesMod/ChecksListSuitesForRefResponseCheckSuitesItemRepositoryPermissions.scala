...
object ChecksListSuitesForRefResponseCheckSuitesItemRepositoryPermissions {
  ...
  @scala.inline
  implicit class ChecksListSuitesForRefResponseCheckSuitesItemRepositoryPermissionsOps[Self <: ChecksListSuitesForRefResponseCheckSuitesItemRepositoryPermissions] (val x: Self) extends AnyVal {
    @scala.inline
