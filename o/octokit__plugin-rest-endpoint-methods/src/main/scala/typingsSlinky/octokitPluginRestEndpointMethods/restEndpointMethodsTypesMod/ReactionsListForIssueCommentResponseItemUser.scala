...
@js.native
trait ReactionsListForIssueCommentResponseItemUser extends js.Object {
...
object ReactionsListForIssueCommentResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForIssueCommentResponseItemUser]
  }
  @scala.inline
  implicit class ReactionsListForIssueCommentResponseItemUserOps[Self <: ReactionsListForIssueCommentResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
