...
@js.native
trait ActionsListWorkflowJobLogsParams extends js.Object {
...
object ActionsListWorkflowJobLogsParams {
  @scala.inline
  def apply(job_id: Double, owner: String, repo: String): ActionsListWorkflowJobLogsParams = {
    ...
    __obj.asInstanceOf[ActionsListWorkflowJobLogsParams]
  }
  @scala.inline
  implicit class ActionsListWorkflowJobLogsParamsOps[Self <: ActionsListWorkflowJobLogsParams] (val x: Self) extends AnyVal {
    @scala.inline
