...
trait PullsListCommentsResponseItem extends js.Object {
  var _links: PullsListCommentsResponseItemLinks = js.native
  ...
  var user: PullsListCommentsResponseItemUser = js.native
}
...
object PullsListCommentsResponseItem {
  ...
  @scala.inline
  implicit class PullsListCommentsResponseItemOps[Self <: PullsListCommentsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with_links(value: PullsListCommentsResponseItemLinks): Self = {
    ...
    @scala.inline
    def withUser(value: PullsListCommentsResponseItemUser): Self = {
        val ret = this.duplicate
