...
@js.native
trait ReactionsListForIssueResponseItemUser extends js.Object {
...
object ReactionsListForIssueResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForIssueResponseItemUser]
  }
  @scala.inline
  implicit class ReactionsListForIssueResponseItemUserOps[Self <: ReactionsListForIssueResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
