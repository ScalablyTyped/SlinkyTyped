...
trait TeamsUpdateResponse extends js.Object {
  ...
  var organization: TeamsUpdateResponseOrganization = js.native
...
object TeamsUpdateResponse {
  ...
  @scala.inline
  implicit class TeamsUpdateResponseOps[Self <: TeamsUpdateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOrganization(value: TeamsUpdateResponseOrganization): Self = {
        val ret = this.duplicate
