...
object ActivityListReposWatchedByUserResponseItemPermissions {
  ...
  @scala.inline
  implicit class ActivityListReposWatchedByUserResponseItemPermissionsOps[Self <: ActivityListReposWatchedByUserResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
