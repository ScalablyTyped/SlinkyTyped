...
trait ReposUpdateBranchProtectionResponseRestrictionsAppsItem extends js.Object {
  ...
  var owner: ReposUpdateBranchProtectionResponseRestrictionsAppsItemOwner = js.native
  var permissions: ReposUpdateBranchProtectionResponseRestrictionsAppsItemPermissions = js.native
...
object ReposUpdateBranchProtectionResponseRestrictionsAppsItem {
  ...
  @scala.inline
  implicit class ReposUpdateBranchProtectionResponseRestrictionsAppsItemOps[Self <: ReposUpdateBranchProtectionResponseRestrictionsAppsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposUpdateBranchProtectionResponseRestrictionsAppsItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposUpdateBranchProtectionResponseRestrictionsAppsItemPermissions): Self = {
        val ret = this.duplicate
