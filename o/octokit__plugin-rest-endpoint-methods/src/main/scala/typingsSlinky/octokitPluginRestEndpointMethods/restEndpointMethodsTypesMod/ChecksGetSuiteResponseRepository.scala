...
trait ChecksGetSuiteResponseRepository extends js.Object {
  ...
  var owner: ChecksGetSuiteResponseRepositoryOwner = js.native
  var permissions: ChecksGetSuiteResponseRepositoryPermissions = js.native
...
object ChecksGetSuiteResponseRepository {
  ...
  @scala.inline
  implicit class ChecksGetSuiteResponseRepositoryOps[Self <: ChecksGetSuiteResponseRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ChecksGetSuiteResponseRepositoryOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ChecksGetSuiteResponseRepositoryPermissions): Self = {
        val ret = this.duplicate
