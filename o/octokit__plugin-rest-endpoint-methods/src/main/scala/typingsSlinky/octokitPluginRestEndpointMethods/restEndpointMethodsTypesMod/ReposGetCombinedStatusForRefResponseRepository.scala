...
@js.native
trait ReposGetCombinedStatusForRefResponseRepository extends js.Object {
  ...
  var owner: ReposGetCombinedStatusForRefResponseRepositoryOwner = js.native
...
object ReposGetCombinedStatusForRefResponseRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ReposGetCombinedStatusForRefResponseRepository]
  }
  @scala.inline
  implicit class ReposGetCombinedStatusForRefResponseRepositoryOps[Self <: ReposGetCombinedStatusForRefResponseRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposGetCombinedStatusForRefResponseRepositoryOwner): Self = {
        val ret = this.duplicate
