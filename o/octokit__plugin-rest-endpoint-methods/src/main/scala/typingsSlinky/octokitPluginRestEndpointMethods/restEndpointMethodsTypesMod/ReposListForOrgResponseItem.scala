...
trait ReposListForOrgResponseItem extends js.Object {
  ...
  var license: ReposListForOrgResponseItemLicense = js.native
  ...
  var owner: ReposListForOrgResponseItemOwner = js.native
  var permissions: ReposListForOrgResponseItemPermissions = js.native
...
object ReposListForOrgResponseItem {
  ...
  @scala.inline
  implicit class ReposListForOrgResponseItemOps[Self <: ReposListForOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: ReposListForOrgResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: ReposListForOrgResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposListForOrgResponseItemPermissions): Self = {
        val ret = this.duplicate
