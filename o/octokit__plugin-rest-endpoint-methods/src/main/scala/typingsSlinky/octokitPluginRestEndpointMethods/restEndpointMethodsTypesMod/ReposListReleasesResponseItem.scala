...
trait ReposListReleasesResponseItem extends js.Object {
  var assets: js.Array[ReposListReleasesResponseItemAssetsItem] = js.native
  var assets_url: String = js.native
  var author: ReposListReleasesResponseItemAuthor = js.native
...
object ReposListReleasesResponseItem {
  ...
  @scala.inline
  implicit class ReposListReleasesResponseItemOps[Self <: ReposListReleasesResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAssets(value: js.Array[ReposListReleasesResponseItemAssetsItem]): Self = {
    ...
    @scala.inline
    def withAuthor(value: ReposListReleasesResponseItemAuthor): Self = {
        val ret = this.duplicate
