...
object ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItem {
  ...
  @scala.inline
  implicit class ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItemOps[Self <: ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
