...
trait ReactionsListForTeamDiscussionCommentResponseItem extends js.Object {
  ...
  var user: ReactionsListForTeamDiscussionCommentResponseItemUser = js.native
}
...
object ReactionsListForTeamDiscussionCommentResponseItem {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentResponseItemOps[Self <: ReactionsListForTeamDiscussionCommentResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: ReactionsListForTeamDiscussionCommentResponseItemUser): Self = {
        val ret = this.duplicate
