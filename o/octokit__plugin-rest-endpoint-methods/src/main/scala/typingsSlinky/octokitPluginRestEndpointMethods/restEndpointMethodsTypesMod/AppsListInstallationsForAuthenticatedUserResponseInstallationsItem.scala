...
trait AppsListInstallationsForAuthenticatedUserResponseInstallationsItem extends js.Object {
  ...
  var account: AppsListInstallationsForAuthenticatedUserResponseInstallationsItemAccount = js.native
  var app_id: Double = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: AppsListInstallationsForAuthenticatedUserResponseInstallationsItemPermissions = js.native
...
object AppsListInstallationsForAuthenticatedUserResponseInstallationsItem {
  ...
  @scala.inline
  implicit class AppsListInstallationsForAuthenticatedUserResponseInstallationsItemOps[Self <: AppsListInstallationsForAuthenticatedUserResponseInstallationsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: AppsListInstallationsForAuthenticatedUserResponseInstallationsItemAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: AppsListInstallationsForAuthenticatedUserResponseInstallationsItemPermissions): Self = {
        val ret = this.duplicate
