...
object ReposCompareCommitsResponseCommitsItemCommitVerification {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseCommitsItemCommitVerificationOps[Self <: ReposCompareCommitsResponseCommitsItemCommitVerification] (val x: Self) extends AnyVal {
    @scala.inline
