...
@js.native
trait ActivityListReposStarredByUserResponseItem extends js.Object {
  ...
  var owner: ActivityListReposStarredByUserResponseItemOwner = js.native
  var permissions: ActivityListReposStarredByUserResponseItemPermissions = js.native
...
object ActivityListReposStarredByUserResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListReposStarredByUserResponseItem]
  }
  @scala.inline
  implicit class ActivityListReposStarredByUserResponseItemOps[Self <: ActivityListReposStarredByUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActivityListReposStarredByUserResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ActivityListReposStarredByUserResponseItemPermissions): Self = {
        val ret = this.duplicate
