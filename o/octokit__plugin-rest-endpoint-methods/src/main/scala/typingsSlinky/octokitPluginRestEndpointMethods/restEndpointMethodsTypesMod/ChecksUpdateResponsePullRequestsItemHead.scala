...
trait ChecksUpdateResponsePullRequestsItemHead extends js.Object {
  ...
  var repo: ChecksUpdateResponsePullRequestsItemHeadRepo = js.native
...
object ChecksUpdateResponsePullRequestsItemHead {
  ...
  @scala.inline
  implicit class ChecksUpdateResponsePullRequestsItemHeadOps[Self <: ChecksUpdateResponsePullRequestsItemHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: ChecksUpdateResponsePullRequestsItemHeadRepo): Self = {
        val ret = this.duplicate
