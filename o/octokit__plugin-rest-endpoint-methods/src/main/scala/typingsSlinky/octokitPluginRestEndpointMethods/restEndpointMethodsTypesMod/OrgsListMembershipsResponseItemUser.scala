...
@js.native
trait OrgsListMembershipsResponseItemUser extends js.Object {
...
object OrgsListMembershipsResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsListMembershipsResponseItemUser]
  }
  @scala.inline
  implicit class OrgsListMembershipsResponseItemUserOps[Self <: OrgsListMembershipsResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
