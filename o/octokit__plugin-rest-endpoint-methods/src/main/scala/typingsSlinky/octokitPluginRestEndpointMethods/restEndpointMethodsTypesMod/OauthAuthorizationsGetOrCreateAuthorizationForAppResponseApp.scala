...
object OauthAuthorizationsGetOrCreateAuthorizationForAppResponseApp {
  ...
  @scala.inline
  implicit class OauthAuthorizationsGetOrCreateAuthorizationForAppResponseAppOps[Self <: OauthAuthorizationsGetOrCreateAuthorizationForAppResponseApp] (val x: Self) extends AnyVal {
    @scala.inline
