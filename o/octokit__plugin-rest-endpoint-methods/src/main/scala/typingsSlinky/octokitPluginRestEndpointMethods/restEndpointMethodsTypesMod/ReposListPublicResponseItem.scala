...
trait ReposListPublicResponseItem extends js.Object {
  ...
  var owner: ReposListPublicResponseItemOwner = js.native
...
object ReposListPublicResponseItem {
  ...
  @scala.inline
  implicit class ReposListPublicResponseItemOps[Self <: ReposListPublicResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposListPublicResponseItemOwner): Self = {
        val ret = this.duplicate
