...
object ReposGetBranchProtectionResponseRestrictionsTeamsItem {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRestrictionsTeamsItemOps[Self <: ReposGetBranchProtectionResponseRestrictionsTeamsItem] (val x: Self) extends AnyVal {
    @scala.inline
