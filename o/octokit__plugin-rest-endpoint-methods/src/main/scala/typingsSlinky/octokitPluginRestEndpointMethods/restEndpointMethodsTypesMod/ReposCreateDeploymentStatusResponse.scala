...
trait ReposCreateDeploymentStatusResponse extends js.Object {
  ...
  var creator: ReposCreateDeploymentStatusResponseCreator = js.native
...
object ReposCreateDeploymentStatusResponse {
  ...
  @scala.inline
  implicit class ReposCreateDeploymentStatusResponseOps[Self <: ReposCreateDeploymentStatusResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ReposCreateDeploymentStatusResponseCreator): Self = {
        val ret = this.duplicate
