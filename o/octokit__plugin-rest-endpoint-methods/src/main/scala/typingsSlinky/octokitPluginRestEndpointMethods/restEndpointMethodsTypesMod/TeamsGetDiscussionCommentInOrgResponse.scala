...
trait TeamsGetDiscussionCommentInOrgResponse extends js.Object {
  var author: TeamsGetDiscussionCommentInOrgResponseAuthor = js.native
  ...
  var reactions: TeamsGetDiscussionCommentInOrgResponseReactions = js.native
...
object TeamsGetDiscussionCommentInOrgResponse {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionCommentInOrgResponseOps[Self <: TeamsGetDiscussionCommentInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsGetDiscussionCommentInOrgResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsGetDiscussionCommentInOrgResponseReactions): Self = {
        val ret = this.duplicate
