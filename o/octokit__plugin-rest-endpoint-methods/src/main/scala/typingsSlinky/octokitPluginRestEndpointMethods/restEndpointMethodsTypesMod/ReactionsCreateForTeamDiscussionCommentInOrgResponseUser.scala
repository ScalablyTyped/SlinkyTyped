...
@js.native
trait ReactionsCreateForTeamDiscussionCommentInOrgResponseUser extends js.Object {
...
object ReactionsCreateForTeamDiscussionCommentInOrgResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionCommentInOrgResponseUser]
  }
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionCommentInOrgResponseUserOps[Self <: ReactionsCreateForTeamDiscussionCommentInOrgResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
