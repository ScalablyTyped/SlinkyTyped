...
object ActivityListPublicEventsForUserParams {
  @scala.inline
  def apply(username: String): ActivityListPublicEventsForUserParams = {
    val __obj = js.Dynamic.literal(username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActivityListPublicEventsForUserParams]
  }
  @scala.inline
  implicit class ActivityListPublicEventsForUserParamsOps[Self <: ActivityListPublicEventsForUserParams] (val x: Self) extends AnyVal {
    @scala.inline
