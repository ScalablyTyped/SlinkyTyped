...
trait GistsListForksResponseItem extends js.Object {
  ...
  var user: GistsListForksResponseItemUser = js.native
}
...
object GistsListForksResponseItem {
  ...
  @scala.inline
  implicit class GistsListForksResponseItemOps[Self <: GistsListForksResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: GistsListForksResponseItemUser): Self = {
        val ret = this.duplicate
