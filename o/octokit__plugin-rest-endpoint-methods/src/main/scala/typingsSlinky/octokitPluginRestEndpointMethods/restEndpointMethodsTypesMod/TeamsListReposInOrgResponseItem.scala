...
trait TeamsListReposInOrgResponseItem extends js.Object {
  ...
  var license: TeamsListReposInOrgResponseItemLicense = js.native
  ...
  var owner: TeamsListReposInOrgResponseItemOwner = js.native
  var permissions: TeamsListReposInOrgResponseItemPermissions = js.native
...
object TeamsListReposInOrgResponseItem {
  ...
  @scala.inline
  implicit class TeamsListReposInOrgResponseItemOps[Self <: TeamsListReposInOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: TeamsListReposInOrgResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: TeamsListReposInOrgResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: TeamsListReposInOrgResponseItemPermissions): Self = {
        val ret = this.duplicate
