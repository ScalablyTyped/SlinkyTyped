...
trait SearchCommitsResponse extends js.Object {
  ...
  var items: js.Array[SearchCommitsResponseItemsItem] = js.native
...
object SearchCommitsResponse {
  ...
  @scala.inline
  implicit class SearchCommitsResponseOps[Self <: SearchCommitsResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[SearchCommitsResponseItemsItem]): Self = {
        val ret = this.duplicate
