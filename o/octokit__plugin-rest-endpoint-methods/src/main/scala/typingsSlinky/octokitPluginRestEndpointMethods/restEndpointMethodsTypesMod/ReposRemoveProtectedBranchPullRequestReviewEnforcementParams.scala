...
object ReposRemoveProtectedBranchPullRequestReviewEnforcementParams {
  ...
  @scala.inline
  implicit class ReposRemoveProtectedBranchPullRequestReviewEnforcementParamsOps[Self <: ReposRemoveProtectedBranchPullRequestReviewEnforcementParams] (val x: Self) extends AnyVal {
    @scala.inline
