...
object ReposListCommitsParams {
  @scala.inline
  def apply(owner: String, repo: String): ReposListCommitsParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposListCommitsParams]
  }
  @scala.inline
  implicit class ReposListCommitsParamsOps[Self <: ReposListCommitsParams] (val x: Self) extends AnyVal {
    @scala.inline
