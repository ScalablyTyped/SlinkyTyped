...
trait TeamsListProjectsLegacyResponseItem extends js.Object {
  ...
  var creator: TeamsListProjectsLegacyResponseItemCreator = js.native
  ...
  var permissions: TeamsListProjectsLegacyResponseItemPermissions = js.native
...
object TeamsListProjectsLegacyResponseItem {
  ...
  @scala.inline
  implicit class TeamsListProjectsLegacyResponseItemOps[Self <: TeamsListProjectsLegacyResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: TeamsListProjectsLegacyResponseItemCreator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: TeamsListProjectsLegacyResponseItemPermissions): Self = {
        val ret = this.duplicate
