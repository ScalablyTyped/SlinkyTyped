...
@js.native
trait ReposUpdateInvitationResponseInviter extends js.Object {
...
object ReposUpdateInvitationResponseInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateInvitationResponseInviter]
  }
  @scala.inline
  implicit class ReposUpdateInvitationResponseInviterOps[Self <: ReposUpdateInvitationResponseInviter] (val x: Self) extends AnyVal {
    @scala.inline
