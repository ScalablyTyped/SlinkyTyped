...
object MigrationsGetStatusForAuthenticatedUserResponseOwner {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForAuthenticatedUserResponseOwnerOps[Self <: MigrationsGetStatusForAuthenticatedUserResponseOwner] (val x: Self) extends AnyVal {
    @scala.inline
