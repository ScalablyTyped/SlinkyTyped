...
@js.native
trait ReposGetCollaboratorPermissionLevelResponseUser extends js.Object {
...
object ReposGetCollaboratorPermissionLevelResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetCollaboratorPermissionLevelResponseUser]
  }
  @scala.inline
  implicit class ReposGetCollaboratorPermissionLevelResponseUserOps[Self <: ReposGetCollaboratorPermissionLevelResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
