...
@js.native
trait ProjectsUpdateColumnResponse extends js.Object {
...
object ProjectsUpdateColumnResponse {
  @scala.inline
  def apply(
    cards_url: String,
    created_at: String,
    ...
    __obj.asInstanceOf[ProjectsUpdateColumnResponse]
  }
  @scala.inline
  implicit class ProjectsUpdateColumnResponseOps[Self <: ProjectsUpdateColumnResponse] (val x: Self) extends AnyVal {
    @scala.inline
