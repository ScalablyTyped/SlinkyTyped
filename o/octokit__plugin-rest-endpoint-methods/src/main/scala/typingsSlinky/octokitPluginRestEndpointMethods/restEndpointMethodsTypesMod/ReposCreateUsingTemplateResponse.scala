...
trait ReposCreateUsingTemplateResponse extends js.Object {
  ...
  var owner: ReposCreateUsingTemplateResponseOwner = js.native
  var permissions: ReposCreateUsingTemplateResponsePermissions = js.native
  ...
  var template_repository: ReposCreateUsingTemplateResponseTemplateRepository = js.native
...
object ReposCreateUsingTemplateResponse {
  ...
  @scala.inline
  implicit class ReposCreateUsingTemplateResponseOps[Self <: ReposCreateUsingTemplateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposCreateUsingTemplateResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposCreateUsingTemplateResponsePermissions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTemplate_repository(value: ReposCreateUsingTemplateResponseTemplateRepository): Self = {
        val ret = this.duplicate
