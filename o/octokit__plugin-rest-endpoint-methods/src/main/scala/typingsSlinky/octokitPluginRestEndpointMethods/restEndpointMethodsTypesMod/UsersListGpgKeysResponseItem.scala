...
trait UsersListGpgKeysResponseItem extends js.Object {
  ...
  var emails: js.Array[UsersListGpgKeysResponseItemEmailsItem] = js.native
  ...
  var subkeys: js.Array[UsersListGpgKeysResponseItemSubkeysItem] = js.native
}
...
object UsersListGpgKeysResponseItem {
  ...
  @scala.inline
  implicit class UsersListGpgKeysResponseItemOps[Self <: UsersListGpgKeysResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEmails(value: js.Array[UsersListGpgKeysResponseItemEmailsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSubkeys(value: js.Array[UsersListGpgKeysResponseItemSubkeysItem]): Self = {
        val ret = this.duplicate
