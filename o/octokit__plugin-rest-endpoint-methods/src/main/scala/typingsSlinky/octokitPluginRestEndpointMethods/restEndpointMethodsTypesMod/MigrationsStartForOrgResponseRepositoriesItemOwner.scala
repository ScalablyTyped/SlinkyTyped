...
object MigrationsStartForOrgResponseRepositoriesItemOwner {
  ...
  @scala.inline
  implicit class MigrationsStartForOrgResponseRepositoriesItemOwnerOps[Self <: MigrationsStartForOrgResponseRepositoriesItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
