...
@js.native
trait TeamsGetDiscussionLegacyResponseAuthor extends js.Object {
...
object TeamsGetDiscussionLegacyResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsGetDiscussionLegacyResponseAuthor]
  }
  @scala.inline
  implicit class TeamsGetDiscussionLegacyResponseAuthorOps[Self <: TeamsGetDiscussionLegacyResponseAuthor] (val x: Self) extends AnyVal {
    @scala.inline
