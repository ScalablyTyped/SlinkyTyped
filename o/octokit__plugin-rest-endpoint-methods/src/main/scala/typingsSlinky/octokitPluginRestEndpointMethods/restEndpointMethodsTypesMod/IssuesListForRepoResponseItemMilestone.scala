...
trait IssuesListForRepoResponseItemMilestone extends js.Object {
  ...
  var creator: IssuesListForRepoResponseItemMilestoneCreator = js.native
...
object IssuesListForRepoResponseItemMilestone {
  ...
  @scala.inline
  implicit class IssuesListForRepoResponseItemMilestoneOps[Self <: IssuesListForRepoResponseItemMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesListForRepoResponseItemMilestoneCreator): Self = {
        val ret = this.duplicate
