...
trait AppsListMarketplacePurchasesForAuthenticatedUserResponseItem extends js.Object {
  var account: AppsListMarketplacePurchasesForAuthenticatedUserResponseItemAccount = js.native
  ...
  var plan: AppsListMarketplacePurchasesForAuthenticatedUserResponseItemPlan = js.native
...
object AppsListMarketplacePurchasesForAuthenticatedUserResponseItem {
  ...
  @scala.inline
  implicit class AppsListMarketplacePurchasesForAuthenticatedUserResponseItemOps[Self <: AppsListMarketplacePurchasesForAuthenticatedUserResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAccount(value: AppsListMarketplacePurchasesForAuthenticatedUserResponseItemAccount): Self = {
    ...
    @scala.inline
    def withPlan(value: AppsListMarketplacePurchasesForAuthenticatedUserResponseItemPlan): Self = {
        val ret = this.duplicate
