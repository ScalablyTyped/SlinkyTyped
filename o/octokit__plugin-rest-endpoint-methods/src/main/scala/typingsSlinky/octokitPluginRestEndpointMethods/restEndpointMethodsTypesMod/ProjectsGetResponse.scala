...
@js.native
trait ProjectsGetResponse extends js.Object {
  var body: String = js.native
  var columns_url: String = js.native
  var created_at: String = js.native
  var creator: ProjectsGetResponseCreator = js.native
...
object ProjectsGetResponse {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProjectsGetResponse]
  }
  @scala.inline
  implicit class ProjectsGetResponseOps[Self <: ProjectsGetResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsGetResponseCreator): Self = {
        val ret = this.duplicate
