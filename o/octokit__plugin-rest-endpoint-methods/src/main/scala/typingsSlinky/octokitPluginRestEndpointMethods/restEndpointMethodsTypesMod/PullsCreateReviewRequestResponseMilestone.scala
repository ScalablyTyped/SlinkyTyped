...
trait PullsCreateReviewRequestResponseMilestone extends js.Object {
  ...
  var creator: PullsCreateReviewRequestResponseMilestoneCreator = js.native
...
object PullsCreateReviewRequestResponseMilestone {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseMilestoneOps[Self <: PullsCreateReviewRequestResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: PullsCreateReviewRequestResponseMilestoneCreator): Self = {
        val ret = this.duplicate
