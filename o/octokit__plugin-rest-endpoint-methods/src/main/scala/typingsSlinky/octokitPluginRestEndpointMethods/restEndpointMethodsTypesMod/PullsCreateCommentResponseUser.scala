...
@js.native
trait PullsCreateCommentResponseUser extends js.Object {
...
object PullsCreateCommentResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateCommentResponseUser]
  }
  @scala.inline
  implicit class PullsCreateCommentResponseUserOps[Self <: PullsCreateCommentResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
