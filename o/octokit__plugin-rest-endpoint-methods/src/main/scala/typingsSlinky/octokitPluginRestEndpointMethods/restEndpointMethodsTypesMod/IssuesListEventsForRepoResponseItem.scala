...
trait IssuesListEventsForRepoResponseItem extends js.Object {
  var actor: IssuesListEventsForRepoResponseItemActor = js.native
  var commit_id: String = js.native
  var commit_url: String = js.native
  var created_at: String = js.native
  var event: String = js.native
  var id: Double = js.native
  var issue: IssuesListEventsForRepoResponseItemIssue = js.native
...
object IssuesListEventsForRepoResponseItem {
  ...
  @scala.inline
  implicit class IssuesListEventsForRepoResponseItemOps[Self <: IssuesListEventsForRepoResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withActor(value: IssuesListEventsForRepoResponseItemActor): Self = {
    ...
    @scala.inline
    def withIssue(value: IssuesListEventsForRepoResponseItemIssue): Self = {
        val ret = this.duplicate
