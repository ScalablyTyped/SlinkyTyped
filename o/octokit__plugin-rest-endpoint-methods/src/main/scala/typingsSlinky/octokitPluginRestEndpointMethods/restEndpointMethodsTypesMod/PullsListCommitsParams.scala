...
object PullsListCommitsParams {
  @scala.inline
  def apply(owner: String, pull_number: Double, repo: String): PullsListCommitsParams = {
  ...
  @scala.inline
  implicit class PullsListCommitsParamsOps[Self <: PullsListCommitsParams] (val x: Self) extends AnyVal {
    @scala.inline
