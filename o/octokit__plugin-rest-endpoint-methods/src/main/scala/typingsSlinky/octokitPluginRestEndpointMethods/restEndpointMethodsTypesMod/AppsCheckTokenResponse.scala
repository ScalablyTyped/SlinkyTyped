...
trait AppsCheckTokenResponse extends js.Object {
  var app: AppsCheckTokenResponseApp = js.native
  ...
  var user: AppsCheckTokenResponseUser = js.native
}
...
object AppsCheckTokenResponse {
  ...
  @scala.inline
  implicit class AppsCheckTokenResponseOps[Self <: AppsCheckTokenResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: AppsCheckTokenResponseApp): Self = {
    ...
    @scala.inline
    def withUser(value: AppsCheckTokenResponseUser): Self = {
        val ret = this.duplicate
