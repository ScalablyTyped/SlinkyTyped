...
object TeamsListPendingInvitationsParams {
  @scala.inline
  def apply(team_id: Double): TeamsListPendingInvitationsParams = {
    val __obj = js.Dynamic.literal(team_id = team_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TeamsListPendingInvitationsParams]
  }
  @scala.inline
  implicit class TeamsListPendingInvitationsParamsOps[Self <: TeamsListPendingInvitationsParams] (val x: Self) extends AnyVal {
    @scala.inline
