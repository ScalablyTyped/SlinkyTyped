...
object MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner {
  ...
  @scala.inline
  implicit class MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwnerOps[Self <: MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner] (val x: Self) extends AnyVal {
    @scala.inline
