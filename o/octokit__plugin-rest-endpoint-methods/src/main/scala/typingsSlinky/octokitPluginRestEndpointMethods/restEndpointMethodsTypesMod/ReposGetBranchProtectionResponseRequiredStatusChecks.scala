...
object ReposGetBranchProtectionResponseRequiredStatusChecks {
  ...
  @scala.inline
  implicit class ReposGetBranchProtectionResponseRequiredStatusChecksOps[Self <: ReposGetBranchProtectionResponseRequiredStatusChecks] (val x: Self) extends AnyVal {
    @scala.inline
