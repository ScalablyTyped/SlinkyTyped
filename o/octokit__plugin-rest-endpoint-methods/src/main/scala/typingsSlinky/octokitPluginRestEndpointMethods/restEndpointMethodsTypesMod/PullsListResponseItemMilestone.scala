...
@js.native
trait PullsListResponseItemMilestone extends js.Object {
  var closed_at: String = js.native
  var closed_issues: Double = js.native
  var created_at: String = js.native
  var creator: PullsListResponseItemMilestoneCreator = js.native
...
object PullsListResponseItemMilestone {
  @scala.inline
  def apply(
    closed_at: String,
    ...
    __obj.asInstanceOf[PullsListResponseItemMilestone]
  }
  @scala.inline
  implicit class PullsListResponseItemMilestoneOps[Self <: PullsListResponseItemMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: PullsListResponseItemMilestoneCreator): Self = {
        val ret = this.duplicate
