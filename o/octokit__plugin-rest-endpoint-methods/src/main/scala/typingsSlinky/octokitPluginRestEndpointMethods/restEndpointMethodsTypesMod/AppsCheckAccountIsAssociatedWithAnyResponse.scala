...
trait AppsCheckAccountIsAssociatedWithAnyResponse extends js.Object {
  ...
  var marketplace_pending_change: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChange = js.native
  var marketplace_purchase: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchase = js.native
...
object AppsCheckAccountIsAssociatedWithAnyResponse {
  ...
  @scala.inline
  implicit class AppsCheckAccountIsAssociatedWithAnyResponseOps[Self <: AppsCheckAccountIsAssociatedWithAnyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMarketplace_pending_change(value: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("marketplace_pending_change")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMarketplace_purchase(value: AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePurchase): Self = {
        val ret = this.duplicate
