...
trait ReposUpdateReleaseAssetResponse extends js.Object {
  ...
  var uploader: ReposUpdateReleaseAssetResponseUploader = js.native
...
object ReposUpdateReleaseAssetResponse {
  ...
  @scala.inline
  implicit class ReposUpdateReleaseAssetResponseOps[Self <: ReposUpdateReleaseAssetResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposUpdateReleaseAssetResponseUploader): Self = {
        val ret = this.duplicate
