...
import typingsSlinky.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.conclusion
import typingsSlinky.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.status
...
trait ActionsListRepoWorkflowRunsParams extends js.Object {
  ...
  var status: js.UndefOr[
    completed | typingsSlinky.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.status | conclusion
  ] = js.native
}

object ActionsListRepoWorkflowRunsParams {
  @scala.inline
  def apply(owner: String, repo: String): ActionsListRepoWorkflowRunsParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActionsListRepoWorkflowRunsParams]
  }
  @scala.inline
  implicit class ActionsListRepoWorkflowRunsParamsOps[Self <: ActionsListRepoWorkflowRunsParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStatus(value: completed | status | conclusion): Self = {
        val ret = this.duplicate
