...
trait SearchLabelsResponse extends js.Object {
  ...
  var items: js.Array[SearchLabelsResponseItemsItem] = js.native
...
object SearchLabelsResponse {
  ...
  @scala.inline
  implicit class SearchLabelsResponseOps[Self <: SearchLabelsResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[SearchLabelsResponseItemsItem]): Self = {
        val ret = this.duplicate
