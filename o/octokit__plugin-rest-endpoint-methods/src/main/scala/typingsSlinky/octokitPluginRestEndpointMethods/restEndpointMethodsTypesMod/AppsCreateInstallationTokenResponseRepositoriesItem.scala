...
trait AppsCreateInstallationTokenResponseRepositoriesItem extends js.Object {
  ...
  var owner: AppsCreateInstallationTokenResponseRepositoriesItemOwner = js.native
  var permissions: AppsCreateInstallationTokenResponseRepositoriesItemPermissions = js.native
...
object AppsCreateInstallationTokenResponseRepositoriesItem {
  ...
  @scala.inline
  implicit class AppsCreateInstallationTokenResponseRepositoriesItemOps[Self <: AppsCreateInstallationTokenResponseRepositoriesItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: AppsCreateInstallationTokenResponseRepositoriesItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: AppsCreateInstallationTokenResponseRepositoriesItemPermissions): Self = {
        val ret = this.duplicate
