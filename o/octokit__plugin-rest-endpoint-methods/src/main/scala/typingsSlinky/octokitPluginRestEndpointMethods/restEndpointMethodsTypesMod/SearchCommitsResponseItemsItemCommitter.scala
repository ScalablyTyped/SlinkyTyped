...
@js.native
trait SearchCommitsResponseItemsItemCommitter extends js.Object {
...
object SearchCommitsResponseItemsItemCommitter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[SearchCommitsResponseItemsItemCommitter]
  }
  @scala.inline
  implicit class SearchCommitsResponseItemsItemCommitterOps[Self <: SearchCommitsResponseItemsItemCommitter] (val x: Self) extends AnyVal {
    @scala.inline
