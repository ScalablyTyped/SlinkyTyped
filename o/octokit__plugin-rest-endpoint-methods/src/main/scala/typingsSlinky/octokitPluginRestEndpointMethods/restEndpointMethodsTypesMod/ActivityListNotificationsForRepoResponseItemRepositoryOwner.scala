...
object ActivityListNotificationsForRepoResponseItemRepositoryOwner {
  ...
  @scala.inline
  implicit class ActivityListNotificationsForRepoResponseItemRepositoryOwnerOps[Self <: ActivityListNotificationsForRepoResponseItemRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
