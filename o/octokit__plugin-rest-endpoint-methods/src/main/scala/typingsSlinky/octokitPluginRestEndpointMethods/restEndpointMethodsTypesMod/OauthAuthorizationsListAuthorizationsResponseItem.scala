...
trait OauthAuthorizationsListAuthorizationsResponseItem extends js.Object {
  var app: OauthAuthorizationsListAuthorizationsResponseItemApp = js.native
...
object OauthAuthorizationsListAuthorizationsResponseItem {
  ...
  @scala.inline
  implicit class OauthAuthorizationsListAuthorizationsResponseItemOps[Self <: OauthAuthorizationsListAuthorizationsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: OauthAuthorizationsListAuthorizationsResponseItemApp): Self = {
