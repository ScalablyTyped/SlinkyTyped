...
@js.native
trait TeamsListDiscussionsLegacyResponseItemReactions extends js.Object {
...
object TeamsListDiscussionsLegacyResponseItemReactions {
  @scala.inline
  def apply(
    `-1`: Double,
    Plussign1: Double,
    ...
    __obj.asInstanceOf[TeamsListDiscussionsLegacyResponseItemReactions]
  }
  @scala.inline
  implicit class TeamsListDiscussionsLegacyResponseItemReactionsOps[Self <: TeamsListDiscussionsLegacyResponseItemReactions] (val x: Self) extends AnyVal {
    @scala.inline
