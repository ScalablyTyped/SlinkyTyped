...
trait OrgsListPendingInvitationsResponseItem extends js.Object {
  ...
  var inviter: OrgsListPendingInvitationsResponseItemInviter = js.native
...
object OrgsListPendingInvitationsResponseItem {
  ...
  @scala.inline
  implicit class OrgsListPendingInvitationsResponseItemOps[Self <: OrgsListPendingInvitationsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInviter(value: OrgsListPendingInvitationsResponseItemInviter): Self = {
        val ret = this.duplicate
