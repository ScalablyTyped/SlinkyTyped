...
object ReposListAssetsForReleaseParams {
  @scala.inline
  def apply(owner: String, release_id: Double, repo: String): ReposListAssetsForReleaseParams = {
  ...
  @scala.inline
  implicit class ReposListAssetsForReleaseParamsOps[Self <: ReposListAssetsForReleaseParams] (val x: Self) extends AnyVal {
    @scala.inline
