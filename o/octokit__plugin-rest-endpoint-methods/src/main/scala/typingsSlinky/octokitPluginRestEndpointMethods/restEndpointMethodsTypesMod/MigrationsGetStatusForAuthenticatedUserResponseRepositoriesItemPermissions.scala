...
object MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemPermissionsOps[Self <: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
