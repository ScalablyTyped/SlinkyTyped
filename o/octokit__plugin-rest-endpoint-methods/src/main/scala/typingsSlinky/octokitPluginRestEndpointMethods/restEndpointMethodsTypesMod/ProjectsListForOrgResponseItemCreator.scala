...
@js.native
trait ProjectsListForOrgResponseItemCreator extends js.Object {
...
object ProjectsListForOrgResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsListForOrgResponseItemCreator]
  }
  @scala.inline
  implicit class ProjectsListForOrgResponseItemCreatorOps[Self <: ProjectsListForOrgResponseItemCreator] (val x: Self) extends AnyVal {
    @scala.inline
