...
trait ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository extends js.Object {
  ...
  var owner: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner = js.native
...
object ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository {
  ...
  @scala.inline
  implicit class ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOps[Self <: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner): Self = {
        val ret = this.duplicate
