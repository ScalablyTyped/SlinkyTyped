...
object ActivityListWatchedReposForAuthenticatedUserResponseItemPermissions {
  ...
  @scala.inline
  implicit class ActivityListWatchedReposForAuthenticatedUserResponseItemPermissionsOps[Self <: ActivityListWatchedReposForAuthenticatedUserResponseItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
