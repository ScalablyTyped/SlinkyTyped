...
trait TeamsListReposLegacyResponseItem extends js.Object {
  ...
  var license: TeamsListReposLegacyResponseItemLicense = js.native
  ...
  var owner: TeamsListReposLegacyResponseItemOwner = js.native
  var permissions: TeamsListReposLegacyResponseItemPermissions = js.native
...
object TeamsListReposLegacyResponseItem {
  ...
  @scala.inline
  implicit class TeamsListReposLegacyResponseItemOps[Self <: TeamsListReposLegacyResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLicense(value: TeamsListReposLegacyResponseItemLicense): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: TeamsListReposLegacyResponseItemOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: TeamsListReposLegacyResponseItemPermissions): Self = {
        val ret = this.duplicate
