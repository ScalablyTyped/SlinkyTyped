...
object IssuesListForAuthenticatedUserResponseItemAssigneesItem {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemAssigneesItemOps[Self <: IssuesListForAuthenticatedUserResponseItemAssigneesItem] (val x: Self) extends AnyVal {
    @scala.inline
