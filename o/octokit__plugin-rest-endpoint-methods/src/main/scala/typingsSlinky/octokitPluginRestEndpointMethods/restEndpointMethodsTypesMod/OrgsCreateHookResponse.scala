...
trait OrgsCreateHookResponse extends js.Object {
  ...
  var config: OrgsCreateHookResponseConfig = js.native
...
object OrgsCreateHookResponse {
  ...
  @scala.inline
  implicit class OrgsCreateHookResponseOps[Self <: OrgsCreateHookResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withConfig(value: OrgsCreateHookResponseConfig): Self = {
        val ret = this.duplicate
