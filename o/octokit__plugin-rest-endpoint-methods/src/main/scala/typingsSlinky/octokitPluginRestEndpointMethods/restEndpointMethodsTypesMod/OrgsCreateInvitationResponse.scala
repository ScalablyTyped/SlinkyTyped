...
trait OrgsCreateInvitationResponse extends js.Object {
  ...
  var inviter: OrgsCreateInvitationResponseInviter = js.native
...
object OrgsCreateInvitationResponse {
  ...
  @scala.inline
  implicit class OrgsCreateInvitationResponseOps[Self <: OrgsCreateInvitationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInviter(value: OrgsCreateInvitationResponseInviter): Self = {
        val ret = this.duplicate
