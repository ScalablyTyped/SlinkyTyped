...
object ActivityListRepoEventsParams {
  @scala.inline
  def apply(owner: String, repo: String): ActivityListRepoEventsParams = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActivityListRepoEventsParams]
  }
  @scala.inline
  implicit class ActivityListRepoEventsParamsOps[Self <: ActivityListRepoEventsParams] (val x: Self) extends AnyVal {
    @scala.inline
