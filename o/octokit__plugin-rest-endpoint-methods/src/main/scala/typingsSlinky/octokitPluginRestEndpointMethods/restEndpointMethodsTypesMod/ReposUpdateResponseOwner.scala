...
@js.native
trait ReposUpdateResponseOwner extends js.Object {
...
object ReposUpdateResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateResponseOwner]
  }
  @scala.inline
  implicit class ReposUpdateResponseOwnerOps[Self <: ReposUpdateResponseOwner] (val x: Self) extends AnyVal {
    @scala.inline
