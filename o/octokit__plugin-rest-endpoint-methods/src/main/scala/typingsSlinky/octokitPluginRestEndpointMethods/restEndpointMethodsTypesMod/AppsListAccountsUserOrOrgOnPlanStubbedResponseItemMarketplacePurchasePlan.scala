...
object AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlan {
  ...
  @scala.inline
  implicit class AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlanOps[Self <: AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlan] (val x: Self) extends AnyVal {
    @scala.inline
