...
@js.native
trait TeamsGetDiscussionCommentResponseReactions extends js.Object {
...
object TeamsGetDiscussionCommentResponseReactions {
  @scala.inline
  def apply(
    `-1`: Double,
    Plussign1: Double,
    ...
    __obj.asInstanceOf[TeamsGetDiscussionCommentResponseReactions]
  }
  @scala.inline
  implicit class TeamsGetDiscussionCommentResponseReactionsOps[Self <: TeamsGetDiscussionCommentResponseReactions] (val x: Self) extends AnyVal {
    @scala.inline
