...
object LicensesListCommonlyUsedResponseItem {
  @scala.inline
  def apply(key: String, name: String, spdx_id: String, url: String): LicensesListCommonlyUsedResponseItem = {
  ...
  @scala.inline
  implicit class LicensesListCommonlyUsedResponseItemOps[Self <: LicensesListCommonlyUsedResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
