...
trait GistsCreateResponse extends js.Object {
  ...
  var files: GistsCreateResponseFiles = js.native
  var forks: js.Array[GistsCreateResponseForksItem] = js.native
  var forks_url: String = js.native
  var git_pull_url: String = js.native
  var git_push_url: String = js.native
  var history: js.Array[GistsCreateResponseHistoryItem] = js.native
  var html_url: String = js.native
  var id: String = js.native
  var node_id: String = js.native
  var owner: GistsCreateResponseOwner = js.native
...
object GistsCreateResponse {
  ...
  @scala.inline
  implicit class GistsCreateResponseOps[Self <: GistsCreateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFiles(value: GistsCreateResponseFiles): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("files")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withForks(value: js.Array[GistsCreateResponseForksItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHistory(value: js.Array[GistsCreateResponseHistoryItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwner(value: GistsCreateResponseOwner): Self = {
        val ret = this.duplicate
