...
@js.native
trait ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepo extends js.Object {
  ...
  var owner: ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOwner = js.native
  var permissions: ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoPermissions = js.native
...
object ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepo]
  }
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoPermissions): Self = {
        val ret = this.duplicate
