...
trait OauthAuthorizationsListGrantsResponseItem extends js.Object {
  var app: OauthAuthorizationsListGrantsResponseItemApp = js.native
...
object OauthAuthorizationsListGrantsResponseItem {
  ...
  @scala.inline
  implicit class OauthAuthorizationsListGrantsResponseItemOps[Self <: OauthAuthorizationsListGrantsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: OauthAuthorizationsListGrantsResponseItemApp): Self = {
