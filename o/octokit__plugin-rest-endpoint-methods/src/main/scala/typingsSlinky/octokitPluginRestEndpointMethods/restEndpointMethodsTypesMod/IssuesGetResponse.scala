...
trait IssuesGetResponse extends js.Object {
  ...
  var assignee: IssuesGetResponseAssignee = js.native
  var assignees: js.Array[IssuesGetResponseAssigneesItem] = js.native
  var body: String = js.native
  var closed_at: Null = js.native
  var closed_by: IssuesGetResponseClosedBy = js.native
  ...
  var labels: js.Array[IssuesGetResponseLabelsItem] = js.native
  var labels_url: String = js.native
  var locked: Boolean = js.native
  var milestone: IssuesGetResponseMilestone = js.native
  var node_id: String = js.native
  var number: Double = js.native
  var pull_request: IssuesGetResponsePullRequest = js.native
  var repository_url: String = js.native
  var state: String = js.native
  var title: String = js.native
  var updated_at: String = js.native
  var url: String = js.native
  var user: IssuesGetResponseUser = js.native
}
...
object IssuesGetResponse {
  ...
  @scala.inline
  implicit class IssuesGetResponseOps[Self <: IssuesGetResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAssignee(value: IssuesGetResponseAssignee): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("assignee")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAssignees(value: js.Array[IssuesGetResponseAssigneesItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClosed_by(value: IssuesGetResponseClosedBy): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabels(value: js.Array[IssuesGetResponseLabelsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMilestone(value: IssuesGetResponseMilestone): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPull_request(value: IssuesGetResponsePullRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: IssuesGetResponseUser): Self = {
        val ret = this.duplicate
