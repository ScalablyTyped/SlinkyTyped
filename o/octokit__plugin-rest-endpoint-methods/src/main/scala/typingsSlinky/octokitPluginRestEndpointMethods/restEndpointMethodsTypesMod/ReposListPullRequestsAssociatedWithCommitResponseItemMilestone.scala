...
trait ReposListPullRequestsAssociatedWithCommitResponseItemMilestone extends js.Object {
  ...
  var creator: ReposListPullRequestsAssociatedWithCommitResponseItemMilestoneCreator = js.native
...
object ReposListPullRequestsAssociatedWithCommitResponseItemMilestone {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemMilestoneOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ReposListPullRequestsAssociatedWithCommitResponseItemMilestoneCreator): Self = {
        val ret = this.duplicate
