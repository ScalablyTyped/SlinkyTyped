...
trait ReposAddCollaboratorResponseRepository extends js.Object {
  ...
  var owner: ReposAddCollaboratorResponseRepositoryOwner = js.native
...
object ReposAddCollaboratorResponseRepository {
  ...
  @scala.inline
  implicit class ReposAddCollaboratorResponseRepositoryOps[Self <: ReposAddCollaboratorResponseRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ReposAddCollaboratorResponseRepositoryOwner): Self = {
        val ret = this.duplicate
