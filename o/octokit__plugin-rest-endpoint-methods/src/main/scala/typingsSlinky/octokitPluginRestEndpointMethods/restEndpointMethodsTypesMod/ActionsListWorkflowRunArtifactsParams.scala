...
@js.native
trait ActionsListWorkflowRunArtifactsParams extends js.Object {
...
object ActionsListWorkflowRunArtifactsParams {
  @scala.inline
  def apply(owner: String, repo: String, run_id: Double): ActionsListWorkflowRunArtifactsParams = {
    ...
    __obj.asInstanceOf[ActionsListWorkflowRunArtifactsParams]
  }
  @scala.inline
  implicit class ActionsListWorkflowRunArtifactsParamsOps[Self <: ActionsListWorkflowRunArtifactsParams] (val x: Self) extends AnyVal {
    @scala.inline
