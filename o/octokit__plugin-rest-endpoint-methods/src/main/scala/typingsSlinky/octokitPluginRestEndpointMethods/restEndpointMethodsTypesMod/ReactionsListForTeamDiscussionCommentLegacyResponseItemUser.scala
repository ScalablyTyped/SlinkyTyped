...
@js.native
trait ReactionsListForTeamDiscussionCommentLegacyResponseItemUser extends js.Object {
...
object ReactionsListForTeamDiscussionCommentLegacyResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionCommentLegacyResponseItemUser]
  }
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentLegacyResponseItemUserOps[Self <: ReactionsListForTeamDiscussionCommentLegacyResponseItemUser] (val x: Self) extends AnyVal {
    @scala.inline
