...
@js.native
trait GistsGetRevisionResponseHistoryItemUser extends js.Object {
...
object GistsGetRevisionResponseHistoryItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[GistsGetRevisionResponseHistoryItemUser]
  }
  @scala.inline
  implicit class GistsGetRevisionResponseHistoryItemUserOps[Self <: GistsGetRevisionResponseHistoryItemUser] (val x: Self) extends AnyVal {
    @scala.inline
