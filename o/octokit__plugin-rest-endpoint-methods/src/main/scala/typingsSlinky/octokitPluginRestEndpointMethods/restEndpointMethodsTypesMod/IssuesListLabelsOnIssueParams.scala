...
object IssuesListLabelsOnIssueParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesListLabelsOnIssueParams = {
  ...
  @scala.inline
  implicit class IssuesListLabelsOnIssueParamsOps[Self <: IssuesListLabelsOnIssueParams] (val x: Self) extends AnyVal {
    @scala.inline
