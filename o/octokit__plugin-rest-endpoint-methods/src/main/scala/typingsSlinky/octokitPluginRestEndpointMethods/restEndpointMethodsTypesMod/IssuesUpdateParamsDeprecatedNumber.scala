...
object IssuesUpdateParamsDeprecatedNumber {
  @scala.inline
  def apply(number: Double, owner: String, repo: String): IssuesUpdateParamsDeprecatedNumber = {
  ...
  @scala.inline
  implicit class IssuesUpdateParamsDeprecatedNumberOps[Self <: IssuesUpdateParamsDeprecatedNumber] (val x: Self) extends AnyVal {
    @scala.inline
