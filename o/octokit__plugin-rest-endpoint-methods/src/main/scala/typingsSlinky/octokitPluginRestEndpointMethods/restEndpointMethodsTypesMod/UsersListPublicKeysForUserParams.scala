...
object UsersListPublicKeysForUserParams {
  @scala.inline
  def apply(username: String): UsersListPublicKeysForUserParams = {
    val __obj = js.Dynamic.literal(username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[UsersListPublicKeysForUserParams]
  }
  @scala.inline
  implicit class UsersListPublicKeysForUserParamsOps[Self <: UsersListPublicKeysForUserParams] (val x: Self) extends AnyVal {
    @scala.inline
