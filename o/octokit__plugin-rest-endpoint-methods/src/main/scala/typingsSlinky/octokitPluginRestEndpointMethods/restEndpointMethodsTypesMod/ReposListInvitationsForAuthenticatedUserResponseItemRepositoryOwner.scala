...
object ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwner {
  ...
  @scala.inline
  implicit class ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwnerOps[Self <: ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwner] (val x: Self) extends AnyVal {
    @scala.inline
