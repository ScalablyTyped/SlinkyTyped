...
trait ReposGetReleaseAssetResponse extends js.Object {
  ...
  var uploader: ReposGetReleaseAssetResponseUploader = js.native
...
object ReposGetReleaseAssetResponse {
  ...
  @scala.inline
  implicit class ReposGetReleaseAssetResponseOps[Self <: ReposGetReleaseAssetResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUploader(value: ReposGetReleaseAssetResponseUploader): Self = {
        val ret = this.duplicate
