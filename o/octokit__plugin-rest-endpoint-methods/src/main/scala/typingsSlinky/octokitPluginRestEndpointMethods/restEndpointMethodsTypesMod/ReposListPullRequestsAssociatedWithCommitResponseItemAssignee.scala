...
object ReposListPullRequestsAssociatedWithCommitResponseItemAssignee {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemAssigneeOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemAssignee] (val x: Self) extends AnyVal {
    @scala.inline
