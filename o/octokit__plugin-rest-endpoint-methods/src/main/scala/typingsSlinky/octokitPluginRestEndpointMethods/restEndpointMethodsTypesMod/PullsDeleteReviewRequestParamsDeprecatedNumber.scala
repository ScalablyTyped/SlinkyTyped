...
object PullsDeleteReviewRequestParamsDeprecatedNumber {
  @scala.inline
  def apply(number: Double, owner: String, repo: String): PullsDeleteReviewRequestParamsDeprecatedNumber = {
  ...
  @scala.inline
  implicit class PullsDeleteReviewRequestParamsDeprecatedNumberOps[Self <: PullsDeleteReviewRequestParamsDeprecatedNumber] (val x: Self) extends AnyVal {
    @scala.inline
