...
trait AppsGetUserInstallationResponse extends js.Object {
  ...
  var account: AppsGetUserInstallationResponseAccount = js.native
  var app_id: Double = js.native
  var created_at: String = js.native
  var events: js.Array[String] = js.native
  var html_url: String = js.native
  var id: Double = js.native
  var permissions: AppsGetUserInstallationResponsePermissions = js.native
...
object AppsGetUserInstallationResponse {
  ...
  @scala.inline
  implicit class AppsGetUserInstallationResponseOps[Self <: AppsGetUserInstallationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAccount(value: AppsGetUserInstallationResponseAccount): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPermissions(value: AppsGetUserInstallationResponsePermissions): Self = {
        val ret = this.duplicate
