...
trait ReposCompareCommitsResponseCommitsItem extends js.Object {
  var author: ReposCompareCommitsResponseCommitsItemAuthor = js.native
  var comments_url: String = js.native
  var commit: ReposCompareCommitsResponseCommitsItemCommit = js.native
  var committer: ReposCompareCommitsResponseCommitsItemCommitter = js.native
  var html_url: String = js.native
  var node_id: String = js.native
  var parents: js.Array[ReposCompareCommitsResponseCommitsItemParentsItem] = js.native
...
object ReposCompareCommitsResponseCommitsItem {
  ...
  @scala.inline
  implicit class ReposCompareCommitsResponseCommitsItemOps[Self <: ReposCompareCommitsResponseCommitsItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: ReposCompareCommitsResponseCommitsItemAuthor): Self = {
    ...
    @scala.inline
    def withCommit(value: ReposCompareCommitsResponseCommitsItemCommit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("commit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCommitter(value: ReposCompareCommitsResponseCommitsItemCommitter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withParents(value: js.Array[ReposCompareCommitsResponseCommitsItemParentsItem]): Self = {
        val ret = this.duplicate
