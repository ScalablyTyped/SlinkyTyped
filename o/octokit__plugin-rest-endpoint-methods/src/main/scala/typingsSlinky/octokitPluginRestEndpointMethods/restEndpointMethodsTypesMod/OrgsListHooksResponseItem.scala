...
trait OrgsListHooksResponseItem extends js.Object {
  ...
  var config: OrgsListHooksResponseItemConfig = js.native
...
object OrgsListHooksResponseItem {
  ...
  @scala.inline
  implicit class OrgsListHooksResponseItemOps[Self <: OrgsListHooksResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withConfig(value: OrgsListHooksResponseItemConfig): Self = {
        val ret = this.duplicate
