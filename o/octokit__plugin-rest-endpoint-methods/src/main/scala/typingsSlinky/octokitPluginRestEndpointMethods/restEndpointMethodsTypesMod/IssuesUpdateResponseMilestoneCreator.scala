...
@js.native
trait IssuesUpdateResponseMilestoneCreator extends js.Object {
...
object IssuesUpdateResponseMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesUpdateResponseMilestoneCreator]
  }
  @scala.inline
  implicit class IssuesUpdateResponseMilestoneCreatorOps[Self <: IssuesUpdateResponseMilestoneCreator] (val x: Self) extends AnyVal {
    @scala.inline
