...
@js.native
trait TeamsCreateDiscussionCommentInOrgResponse extends js.Object {
  var author: TeamsCreateDiscussionCommentInOrgResponseAuthor = js.native
  ...
  var reactions: TeamsCreateDiscussionCommentInOrgResponseReactions = js.native
  var updated_at: String = js.native
  var url: String = js.native
}

object TeamsCreateDiscussionCommentInOrgResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionCommentInOrgResponse]
  }
  @scala.inline
  implicit class TeamsCreateDiscussionCommentInOrgResponseOps[Self <: TeamsCreateDiscussionCommentInOrgResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsCreateDiscussionCommentInOrgResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsCreateDiscussionCommentInOrgResponseReactions): Self = {
        val ret = this.duplicate
