...
object ReposListCommentsForCommitParamsDeprecatedRef {
  @scala.inline
  def apply(owner: String, ref: String, repo: String): ReposListCommentsForCommitParamsDeprecatedRef = {
  ...
  @scala.inline
  implicit class ReposListCommentsForCommitParamsDeprecatedRefOps[Self <: ReposListCommentsForCommitParamsDeprecatedRef] (val x: Self) extends AnyVal {
    @scala.inline
