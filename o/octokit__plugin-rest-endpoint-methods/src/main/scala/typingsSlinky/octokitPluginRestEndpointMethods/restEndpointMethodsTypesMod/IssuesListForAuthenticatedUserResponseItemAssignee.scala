...
object IssuesListForAuthenticatedUserResponseItemAssignee {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemAssigneeOps[Self <: IssuesListForAuthenticatedUserResponseItemAssignee] (val x: Self) extends AnyVal {
    @scala.inline
