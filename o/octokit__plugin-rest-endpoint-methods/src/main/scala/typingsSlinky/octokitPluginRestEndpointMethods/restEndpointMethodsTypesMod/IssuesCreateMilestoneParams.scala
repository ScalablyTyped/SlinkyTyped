...
object IssuesCreateMilestoneParams {
  @scala.inline
  def apply(owner: String, repo: String, title: String): IssuesCreateMilestoneParams = {
  ...
  @scala.inline
  implicit class IssuesCreateMilestoneParamsOps[Self <: IssuesCreateMilestoneParams] (val x: Self) extends AnyVal {
    @scala.inline
