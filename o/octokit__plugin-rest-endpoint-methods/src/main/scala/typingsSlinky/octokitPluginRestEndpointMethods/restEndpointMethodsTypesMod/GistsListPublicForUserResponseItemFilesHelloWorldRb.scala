...
object GistsListPublicForUserResponseItemFilesHelloWorldRb {
  ...
  @scala.inline
  implicit class GistsListPublicForUserResponseItemFilesHelloWorldRbOps[Self <: GistsListPublicForUserResponseItemFilesHelloWorldRb] (val x: Self) extends AnyVal {
    @scala.inline
