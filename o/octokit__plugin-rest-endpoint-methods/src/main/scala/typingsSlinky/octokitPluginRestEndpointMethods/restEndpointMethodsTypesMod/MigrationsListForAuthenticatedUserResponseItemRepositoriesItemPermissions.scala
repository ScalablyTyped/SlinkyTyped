...
object MigrationsListForAuthenticatedUserResponseItemRepositoriesItemPermissions {
  ...
  @scala.inline
  implicit class MigrationsListForAuthenticatedUserResponseItemRepositoriesItemPermissionsOps[Self <: MigrationsListForAuthenticatedUserResponseItemRepositoriesItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
