...
trait TeamsUpdateDiscussionCommentResponse extends js.Object {
  var author: TeamsUpdateDiscussionCommentResponseAuthor = js.native
  ...
  var reactions: TeamsUpdateDiscussionCommentResponseReactions = js.native
...
object TeamsUpdateDiscussionCommentResponse {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentResponseOps[Self <: TeamsUpdateDiscussionCommentResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsUpdateDiscussionCommentResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsUpdateDiscussionCommentResponseReactions): Self = {
        val ret = this.duplicate
