...
trait PullsCreateResponseHead extends js.Object {
  ...
  var repo: PullsCreateResponseHeadRepo = js.native
  var sha: String = js.native
  var user: PullsCreateResponseHeadUser = js.native
}
...
object PullsCreateResponseHead {
  ...
  @scala.inline
  implicit class PullsCreateResponseHeadOps[Self <: PullsCreateResponseHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsCreateResponseHeadRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsCreateResponseHeadUser): Self = {
        val ret = this.duplicate
