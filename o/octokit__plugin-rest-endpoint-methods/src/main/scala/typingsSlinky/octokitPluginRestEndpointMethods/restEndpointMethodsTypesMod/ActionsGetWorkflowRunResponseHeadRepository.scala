...
@js.native
trait ActionsGetWorkflowRunResponseHeadRepository extends js.Object {
  ...
  var owner: ActionsGetWorkflowRunResponseHeadRepositoryOwner = js.native
...
object ActionsGetWorkflowRunResponseHeadRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ActionsGetWorkflowRunResponseHeadRepository]
  }
  @scala.inline
  implicit class ActionsGetWorkflowRunResponseHeadRepositoryOps[Self <: ActionsGetWorkflowRunResponseHeadRepository] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: ActionsGetWorkflowRunResponseHeadRepositoryOwner): Self = {
        val ret = this.duplicate
