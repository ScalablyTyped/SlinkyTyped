...
trait IssuesGetEventResponseIssue extends js.Object {
  ...
  var assignee: IssuesGetEventResponseIssueAssignee
  var assignees: js.Array[IssuesGetEventResponseIssueAssigneesItem]
  var body: String
  var closed_at: Null
  var comments: Double
  ...
  var html_url: String
  var id: Double
  var labels: js.Array[IssuesGetEventResponseIssueLabelsItem]
  var labels_url: String
  var locked: Boolean
  var milestone: IssuesGetEventResponseIssueMilestone
  var node_id: String
  var number: Double
  var pull_request: IssuesGetEventResponseIssuePullRequest
  var repository_url: String
  var state: String
  var title: String
  var updated_at: String
  var url: String
  var user: IssuesGetEventResponseIssueUser
}
