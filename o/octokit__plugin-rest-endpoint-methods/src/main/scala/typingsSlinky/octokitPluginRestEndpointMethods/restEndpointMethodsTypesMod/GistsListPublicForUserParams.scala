...
object GistsListPublicForUserParams {
  @scala.inline
  def apply(username: String): GistsListPublicForUserParams = {
    val __obj = js.Dynamic.literal(username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[GistsListPublicForUserParams]
  }
  @scala.inline
  implicit class GistsListPublicForUserParamsOps[Self <: GistsListPublicForUserParams] (val x: Self) extends AnyVal {
    @scala.inline
