...
object ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoPermissions {
  ...
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoPermissionsOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoPermissions] (val x: Self) extends AnyVal {
    @scala.inline
