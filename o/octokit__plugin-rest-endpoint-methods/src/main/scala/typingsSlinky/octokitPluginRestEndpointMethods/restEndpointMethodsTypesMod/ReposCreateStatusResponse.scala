...
trait ReposCreateStatusResponse extends js.Object {
  ...
  var creator: ReposCreateStatusResponseCreator = js.native
...
object ReposCreateStatusResponse {
  ...
  @scala.inline
  implicit class ReposCreateStatusResponseOps[Self <: ReposCreateStatusResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ReposCreateStatusResponseCreator): Self = {
        val ret = this.duplicate
