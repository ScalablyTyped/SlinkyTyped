...
trait UsersGetByUsernameResponse extends js.Object {
  ...
  var plan: js.UndefOr[UsersGetByUsernameResponsePlan] = js.native
...
object UsersGetByUsernameResponse {
  ...
  @scala.inline
  implicit class UsersGetByUsernameResponseOps[Self <: UsersGetByUsernameResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPlan(value: UsersGetByUsernameResponsePlan): Self = {
        val ret = this.duplicate
