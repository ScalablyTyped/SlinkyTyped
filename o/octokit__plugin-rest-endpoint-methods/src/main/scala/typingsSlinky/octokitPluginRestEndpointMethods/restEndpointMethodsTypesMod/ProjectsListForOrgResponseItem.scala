...
trait ProjectsListForOrgResponseItem extends js.Object {
  ...
  var creator: ProjectsListForOrgResponseItemCreator = js.native
...
object ProjectsListForOrgResponseItem {
  ...
  @scala.inline
  implicit class ProjectsListForOrgResponseItemOps[Self <: ProjectsListForOrgResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: ProjectsListForOrgResponseItemCreator): Self = {
        val ret = this.duplicate
