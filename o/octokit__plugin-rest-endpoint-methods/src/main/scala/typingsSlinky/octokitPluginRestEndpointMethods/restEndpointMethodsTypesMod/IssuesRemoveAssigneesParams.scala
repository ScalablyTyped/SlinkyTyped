...
object IssuesRemoveAssigneesParams {
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesRemoveAssigneesParams = {
  ...
  @scala.inline
  implicit class IssuesRemoveAssigneesParamsOps[Self <: IssuesRemoveAssigneesParams] (val x: Self) extends AnyVal {
    @scala.inline
