...
@js.native
trait ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOwner extends js.Object {
...
object ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOwner]
  }
  @scala.inline
  implicit class ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOwnerOps[Self <: ReposListPullRequestsAssociatedWithCommitResponseItemHeadRepoOwner] (val x: Self) extends AnyVal {
    @scala.inline
