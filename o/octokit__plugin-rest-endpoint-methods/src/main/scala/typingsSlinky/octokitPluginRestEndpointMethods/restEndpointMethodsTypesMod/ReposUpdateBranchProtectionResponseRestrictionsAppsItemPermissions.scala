...
object ReposUpdateBranchProtectionResponseRestrictionsAppsItemPermissions {
  ...
  @scala.inline
  implicit class ReposUpdateBranchProtectionResponseRestrictionsAppsItemPermissionsOps[Self <: ReposUpdateBranchProtectionResponseRestrictionsAppsItemPermissions] (val x: Self) extends AnyVal {
    @scala.inline
