...
trait MigrationsStartForAuthenticatedUserResponse extends js.Object {
  ...
  var owner: MigrationsStartForAuthenticatedUserResponseOwner = js.native
  var repositories: js.Array[MigrationsStartForAuthenticatedUserResponseRepositoriesItem] = js.native
...
object MigrationsStartForAuthenticatedUserResponse {
  ...
  @scala.inline
  implicit class MigrationsStartForAuthenticatedUserResponseOps[Self <: MigrationsStartForAuthenticatedUserResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: MigrationsStartForAuthenticatedUserResponseOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRepositories(value: js.Array[MigrationsStartForAuthenticatedUserResponseRepositoriesItem]): Self = {
        val ret = this.duplicate
