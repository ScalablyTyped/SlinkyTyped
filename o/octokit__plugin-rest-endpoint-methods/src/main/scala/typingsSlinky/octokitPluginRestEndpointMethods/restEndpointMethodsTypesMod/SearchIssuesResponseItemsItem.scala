...
trait SearchIssuesResponseItemsItem extends js.Object {
  ...
  var labels: js.Array[SearchIssuesResponseItemsItemLabelsItem] = js.native
  var labels_url: String = js.native
  var milestone: Null = js.native
  var node_id: String = js.native
  var number: Double = js.native
  var pull_request: SearchIssuesResponseItemsItemPullRequest = js.native
  ...
  var user: SearchIssuesResponseItemsItemUser = js.native
}
...
object SearchIssuesResponseItemsItem {
  ...
  @scala.inline
  implicit class SearchIssuesResponseItemsItemOps[Self <: SearchIssuesResponseItemsItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabels(value: js.Array[SearchIssuesResponseItemsItemLabelsItem]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPull_request(value: SearchIssuesResponseItemsItemPullRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: SearchIssuesResponseItemsItemUser): Self = {
        val ret = this.duplicate
