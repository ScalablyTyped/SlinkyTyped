...
trait ChecksGetResponsePullRequestsItemBase extends js.Object {
  ...
  var repo: ChecksGetResponsePullRequestsItemBaseRepo = js.native
...
object ChecksGetResponsePullRequestsItemBase {
  ...
  @scala.inline
  implicit class ChecksGetResponsePullRequestsItemBaseOps[Self <: ChecksGetResponsePullRequestsItemBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: ChecksGetResponsePullRequestsItemBaseRepo): Self = {
        val ret = this.duplicate
