...
@js.native
trait PullsListResponseItemBaseRepo extends js.Object {
  ...
  var owner: PullsListResponseItemBaseRepoOwner = js.native
  var permissions: PullsListResponseItemBaseRepoPermissions = js.native
...
object PullsListResponseItemBaseRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListResponseItemBaseRepo]
  }
  @scala.inline
  implicit class PullsListResponseItemBaseRepoOps[Self <: PullsListResponseItemBaseRepo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOwner(value: PullsListResponseItemBaseRepoOwner): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("owner")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPermissions(value: PullsListResponseItemBaseRepoPermissions): Self = {
        val ret = this.duplicate
