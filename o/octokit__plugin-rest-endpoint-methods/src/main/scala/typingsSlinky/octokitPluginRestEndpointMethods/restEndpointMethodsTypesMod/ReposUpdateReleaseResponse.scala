...
trait ReposUpdateReleaseResponse extends js.Object {
  var assets: js.Array[ReposUpdateReleaseResponseAssetsItem] = js.native
  var assets_url: String = js.native
  var author: ReposUpdateReleaseResponseAuthor = js.native
...
object ReposUpdateReleaseResponse {
  ...
  @scala.inline
  implicit class ReposUpdateReleaseResponseOps[Self <: ReposUpdateReleaseResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAssets(value: js.Array[ReposUpdateReleaseResponseAssetsItem]): Self = {
    ...
    @scala.inline
    def withAuthor(value: ReposUpdateReleaseResponseAuthor): Self = {
        val ret = this.duplicate
