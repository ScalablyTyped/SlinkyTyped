...
object ReposUpdateBranchProtectionParams {
  ...
  def apply(
    ...
    allow_force_pushes: js.UndefOr[Null | Boolean] = js.undefined,
    enforce_admins: Boolean = null.asInstanceOf[Boolean],
    ...
    val __obj = js.Dynamic.literal(branch = branch.asInstanceOf[js.Any], owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any], enforce_admins = enforce_admins.asInstanceOf[js.Any], required_pull_request_reviews = required_pull_request_reviews.asInstanceOf[js.Any], required_status_checks = required_status_checks.asInstanceOf[js.Any], restrictions = restrictions.asInstanceOf[js.Any])
    if (!js.isUndefined(allow_deletions)) __obj.updateDynamic("allow_deletions")(allow_deletions.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allow_force_pushes)) __obj.updateDynamic("allow_force_pushes")(allow_force_pushes.asInstanceOf[js.Any])
    if (!js.isUndefined(required_linear_history)) __obj.updateDynamic("required_linear_history")(required_linear_history.get.asInstanceOf[js.Any])
