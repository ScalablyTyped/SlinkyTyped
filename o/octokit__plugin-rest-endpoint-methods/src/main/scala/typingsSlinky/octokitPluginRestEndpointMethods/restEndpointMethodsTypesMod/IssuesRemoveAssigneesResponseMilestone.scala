...
trait IssuesRemoveAssigneesResponseMilestone extends js.Object {
  ...
  var creator: IssuesRemoveAssigneesResponseMilestoneCreator = js.native
...
object IssuesRemoveAssigneesResponseMilestone {
  ...
  @scala.inline
  implicit class IssuesRemoveAssigneesResponseMilestoneOps[Self <: IssuesRemoveAssigneesResponseMilestone] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreator(value: IssuesRemoveAssigneesResponseMilestoneCreator): Self = {
        val ret = this.duplicate
