...
@js.native
trait TeamsListForAuthenticatedUserResponseItemOrganization extends js.Object {
...
object TeamsListForAuthenticatedUserResponseItemOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    blog: String,
    ...
    __obj.asInstanceOf[TeamsListForAuthenticatedUserResponseItemOrganization]
  }
  @scala.inline
  implicit class TeamsListForAuthenticatedUserResponseItemOrganizationOps[Self <: TeamsListForAuthenticatedUserResponseItemOrganization] (val x: Self) extends AnyVal {
    @scala.inline
