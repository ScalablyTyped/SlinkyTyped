...
@js.native
trait ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem extends js.Object {
...
object ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem]
  }
  @scala.inline
  implicit class ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItemOps[Self <: ReposUpdateBranchProtectionResponseRequiredPullRequestReviewsDismissalRestrictionsUsersItem] (val x: Self) extends AnyVal {
    @scala.inline
