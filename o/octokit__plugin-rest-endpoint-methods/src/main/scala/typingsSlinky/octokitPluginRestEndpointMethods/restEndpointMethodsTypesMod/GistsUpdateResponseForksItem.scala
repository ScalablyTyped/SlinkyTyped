...
trait GistsUpdateResponseForksItem extends js.Object {
  ...
  var user: GistsUpdateResponseForksItemUser = js.native
}
...
object GistsUpdateResponseForksItem {
  ...
  @scala.inline
  implicit class GistsUpdateResponseForksItemOps[Self <: GistsUpdateResponseForksItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: GistsUpdateResponseForksItemUser): Self = {
        val ret = this.duplicate
