...
@js.native
trait PullsCreateFromIssueResponseUser extends js.Object {
...
object PullsCreateFromIssueResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseUser]
  }
  @scala.inline
  implicit class PullsCreateFromIssueResponseUserOps[Self <: PullsCreateFromIssueResponseUser] (val x: Self) extends AnyVal {
    @scala.inline
