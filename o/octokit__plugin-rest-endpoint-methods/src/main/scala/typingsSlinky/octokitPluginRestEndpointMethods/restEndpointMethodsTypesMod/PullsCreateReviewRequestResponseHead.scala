...
trait PullsCreateReviewRequestResponseHead extends js.Object {
  ...
  var repo: PullsCreateReviewRequestResponseHeadRepo = js.native
  var sha: String = js.native
  var user: PullsCreateReviewRequestResponseHeadUser = js.native
}
...
object PullsCreateReviewRequestResponseHead {
  ...
  @scala.inline
  implicit class PullsCreateReviewRequestResponseHeadOps[Self <: PullsCreateReviewRequestResponseHead] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRepo(value: PullsCreateReviewRequestResponseHeadRepo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUser(value: PullsCreateReviewRequestResponseHeadUser): Self = {
        val ret = this.duplicate
