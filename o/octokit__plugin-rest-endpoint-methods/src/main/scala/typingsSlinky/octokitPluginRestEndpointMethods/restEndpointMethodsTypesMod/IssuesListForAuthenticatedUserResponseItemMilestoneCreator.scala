...
object IssuesListForAuthenticatedUserResponseItemMilestoneCreator {
  ...
  @scala.inline
  implicit class IssuesListForAuthenticatedUserResponseItemMilestoneCreatorOps[Self <: IssuesListForAuthenticatedUserResponseItemMilestoneCreator] (val x: Self) extends AnyVal {
    @scala.inline
