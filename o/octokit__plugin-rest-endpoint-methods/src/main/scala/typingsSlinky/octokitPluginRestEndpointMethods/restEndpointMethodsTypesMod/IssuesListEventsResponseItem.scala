...
trait IssuesListEventsResponseItem extends js.Object {
  var actor: IssuesListEventsResponseItemActor = js.native
...
object IssuesListEventsResponseItem {
  ...
  @scala.inline
  implicit class IssuesListEventsResponseItemOps[Self <: IssuesListEventsResponseItem] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withActor(value: IssuesListEventsResponseItemActor): Self = {
