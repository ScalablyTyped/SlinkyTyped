...
trait OauthAuthorizationsResetAuthorizationResponse extends js.Object {
  var app: OauthAuthorizationsResetAuthorizationResponseApp = js.native
  ...
  var user: OauthAuthorizationsResetAuthorizationResponseUser = js.native
}
...
object OauthAuthorizationsResetAuthorizationResponse {
  ...
  @scala.inline
  implicit class OauthAuthorizationsResetAuthorizationResponseOps[Self <: OauthAuthorizationsResetAuthorizationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApp(value: OauthAuthorizationsResetAuthorizationResponseApp): Self = {
    ...
    @scala.inline
    def withUser(value: OauthAuthorizationsResetAuthorizationResponseUser): Self = {
        val ret = this.duplicate
