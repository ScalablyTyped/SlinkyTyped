...
trait ActionsListRepoWorkflowRunsResponseWorkflowRunsItem extends js.Object {
  ...
  var head_commit: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadCommit
  var head_repository: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepository
  var head_sha: String
  var html_url: String
  var id: Double
  var jobs_url: String
  ...
  var repository: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepository
