...
trait GistsCreateResponseForksItem extends js.Object {
  ...
  var user: GistsCreateResponseForksItemUser = js.native
}
...
object GistsCreateResponseForksItem {
  ...
  @scala.inline
  implicit class GistsCreateResponseForksItemOps[Self <: GistsCreateResponseForksItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUser(value: GistsCreateResponseForksItemUser): Self = {
        val ret = this.duplicate
