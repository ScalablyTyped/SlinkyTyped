...
trait TeamsCreateDiscussionLegacyResponse extends js.Object {
  var author: TeamsCreateDiscussionLegacyResponseAuthor = js.native
  ...
  var reactions: TeamsCreateDiscussionLegacyResponseReactions = js.native
...
object TeamsCreateDiscussionLegacyResponse {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionLegacyResponseOps[Self <: TeamsCreateDiscussionLegacyResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAuthor(value: TeamsCreateDiscussionLegacyResponseAuthor): Self = {
    ...
    @scala.inline
    def withReactions(value: TeamsCreateDiscussionLegacyResponseReactions): Self = {
        val ret = this.duplicate
