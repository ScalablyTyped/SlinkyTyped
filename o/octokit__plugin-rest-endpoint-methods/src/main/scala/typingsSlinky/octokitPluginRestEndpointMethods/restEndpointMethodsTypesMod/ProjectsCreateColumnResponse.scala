...
@js.native
trait ProjectsCreateColumnResponse extends js.Object {
...
object ProjectsCreateColumnResponse {
  @scala.inline
  def apply(
    cards_url: String,
    created_at: String,
    ...
    __obj.asInstanceOf[ProjectsCreateColumnResponse]
  }
  @scala.inline
  implicit class ProjectsCreateColumnResponseOps[Self <: ProjectsCreateColumnResponse] (val x: Self) extends AnyVal {
    @scala.inline
