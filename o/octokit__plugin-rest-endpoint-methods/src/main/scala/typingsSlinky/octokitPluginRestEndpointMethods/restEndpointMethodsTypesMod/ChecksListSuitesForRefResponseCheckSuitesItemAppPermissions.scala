...
object ChecksListSuitesForRefResponseCheckSuitesItemAppPermissions {
  ...
  @scala.inline
  implicit class ChecksListSuitesForRefResponseCheckSuitesItemAppPermissionsOps[Self <: ChecksListSuitesForRefResponseCheckSuitesItemAppPermissions] (val x: Self) extends AnyVal {
    @scala.inline
