...
trait AnonParamsAnonMessage extends js.Object {
  ...
  var params: AnonMessage = js.native
...
object AnonParamsAnonMessage {
  ...
  @scala.inline
  implicit class AnonParamsAnonMessageOps[Self <: AnonParamsAnonMessage] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonMessage): Self = {
        val ret = this.duplicate
