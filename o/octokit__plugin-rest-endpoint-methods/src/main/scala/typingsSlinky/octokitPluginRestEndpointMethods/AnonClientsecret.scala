...
trait AnonClientsecret extends js.Object {
  var client_id: AnonType = js.native
  var client_secret: AnonType = js.native
  var fingerprint: AnonType = js.native
  var note: AnonRequired = js.native
...
object AnonClientsecret {
  ...
  implicit class AnonClientsecretOps[Self <: AnonClientsecret] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNote(value: AnonRequired): Self = {
        val ret = this.duplicate
