...
trait AnonMethodParams extends js.Object {
  ...
  var params: AnonArtifactid = js.native
...
object AnonMethodParams {
  ...
  @scala.inline
  implicit class AnonMethodParamsOps[Self <: AnonMethodParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonArtifactid): Self = {
        val ret = this.duplicate
