...
@js.native
trait AnonActionsdescription extends js.Object {
  ...
  @JSName("output.title")
  var outputDottitle: AnonType = js.native
...
object AnonActionsdescription {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonActionsdescription]
  }
  @scala.inline
  implicit class AnonActionsdescriptionOps[Self <: AnonActionsdescription] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOutputDottitle(value: AnonType): Self = {
        val ret = this.duplicate
