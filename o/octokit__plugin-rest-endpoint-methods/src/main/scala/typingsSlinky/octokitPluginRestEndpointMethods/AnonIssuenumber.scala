...
trait AnonIssuenumber extends js.Object {
  ...
  var labels: AnonRequired = js.native
...
object AnonIssuenumber {
  ...
  @scala.inline
  implicit class AnonIssuenumberOps[Self <: AnonIssuenumber] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabels(value: AnonRequired): Self = {
        val ret = this.duplicate
