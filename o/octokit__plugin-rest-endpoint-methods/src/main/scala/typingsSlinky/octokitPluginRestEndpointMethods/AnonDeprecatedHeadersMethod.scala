...
object AnonDeprecatedHeadersMethod {
  @scala.inline
  def apply(deprecated: String, headers: AnonAccept, method: String, params: AnonRepo, url: String): AnonDeprecatedHeadersMethod = {
  ...
  @scala.inline
  implicit class AnonDeprecatedHeadersMethodOps[Self <: AnonDeprecatedHeadersMethod] (val x: Self) extends AnyVal {
    @scala.inline
