...
trait AnonHeadersAnonAccept extends js.Object {
  ...
  var params: AnonPermissions = js.native
...
object AnonHeadersAnonAccept {
  ...
  @scala.inline
  implicit class AnonHeadersAnonAcceptOps[Self <: AnonHeadersAnonAccept] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonPermissions): Self = {
        val ret = this.duplicate
