...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsUpdateParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsUpdateParamsDeprecatedMembersAllowedRepositoryCreationType
