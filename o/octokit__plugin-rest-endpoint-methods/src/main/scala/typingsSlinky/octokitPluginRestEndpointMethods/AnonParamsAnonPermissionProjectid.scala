...
trait AnonParamsAnonPermissionProjectid extends js.Object {
  ...
  var params: AnonPermissionProjectid = js.native
...
object AnonParamsAnonPermissionProjectid {
  ...
  @scala.inline
  implicit class AnonParamsAnonPermissionProjectidOps[Self <: AnonParamsAnonPermissionProjectid] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonPermissionProjectid): Self = {
        val ret = this.duplicate
