...
object AnonHeadersMethodParamsUrl {
  ...
  @scala.inline
  implicit class AnonHeadersMethodParamsUrlOps[Self <: AnonHeadersMethodParamsUrl] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonCode): Self = {
        val ret = this.duplicate
