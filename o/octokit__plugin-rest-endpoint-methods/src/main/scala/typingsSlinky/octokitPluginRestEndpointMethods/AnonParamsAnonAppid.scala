...
trait AnonParamsAnonAppid extends js.Object {
  ...
  var params: AnonAppid = js.native
...
object AnonParamsAnonAppid {
  ...
  @scala.inline
  implicit class AnonParamsAnonAppidOps[Self <: AnonParamsAnonAppid] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonAppid): Self = {
        val ret = this.duplicate
