...
trait AnonHeadersAnonContenttype extends js.Object {
  var headers: AnonContenttype = js.native
  var method: String = js.native
  var params: AnonData = js.native
...
object AnonHeadersAnonContenttype {
  ...
  @scala.inline
  implicit class AnonHeadersAnonContenttypeOps[Self <: AnonHeadersAnonContenttype] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonData): Self = {
        val ret = this.duplicate
