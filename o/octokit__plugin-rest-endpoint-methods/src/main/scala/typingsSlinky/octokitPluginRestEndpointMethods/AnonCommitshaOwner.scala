...
trait AnonCommitshaOwner extends js.Object {
  var commit_sha: AnonAlias = js.native
...
object AnonCommitshaOwner {
  ...
  @scala.inline
  implicit class AnonCommitshaOwnerOps[Self <: AnonCommitshaOwner] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withCommit_sha(value: AnonAlias): Self = {
