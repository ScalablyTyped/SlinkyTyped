...
trait AnonParamsAnonLimit extends js.Object {
  ...
  var params: AnonLimit = js.native
...
object AnonParamsAnonLimit {
  ...
  @scala.inline
  implicit class AnonParamsAnonLimitOps[Self <: AnonParamsAnonLimit] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonLimit): Self = {
        val ret = this.duplicate
