...
trait AnonParamsAnonContent extends js.Object {
  ...
  var params: AnonContent = js.native
...
object AnonParamsAnonContent {
  ...
  @scala.inline
  implicit class AnonParamsAnonContentOps[Self <: AnonParamsAnonContent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonContent): Self = {
        val ret = this.duplicate
