...
trait AnonParamsAnonOrganizationpermission extends js.Object {
  ...
  var params: AnonOrganizationpermission = js.native
...
object AnonParamsAnonOrganizationpermission {
  ...
  @scala.inline
  implicit class AnonParamsAnonOrganizationpermissionOps[Self <: AnonParamsAnonOrganizationpermission] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonOrganizationpermission): Self = {
        val ret = this.duplicate
