...
trait AnonParamsAnonConfig extends js.Object {
  ...
  var params: AnonConfig = js.native
...
object AnonParamsAnonConfig {
  ...
  @scala.inline
  implicit class AnonParamsAnonConfigOps[Self <: AnonParamsAnonConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonConfig): Self = {
        val ret = this.duplicate
