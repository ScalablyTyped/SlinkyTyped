...
trait AnonParamsAnonRepoState extends js.Object {
  ...
  var params: AnonRepoState = js.native
...
object AnonParamsAnonRepoState {
  ...
  @scala.inline
  implicit class AnonParamsAnonRepoStateOps[Self <: AnonParamsAnonRepoState] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonRepoState): Self = {
        val ret = this.duplicate
