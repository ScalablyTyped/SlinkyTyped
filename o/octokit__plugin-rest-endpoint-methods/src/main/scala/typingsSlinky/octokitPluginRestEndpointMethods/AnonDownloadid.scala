...
trait AnonDownloadid extends js.Object {
  var download_id: AnonRequired = js.native
...
object AnonDownloadid {
  ...
  @scala.inline
  implicit class AnonDownloadidOps[Self <: AnonDownloadid] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDownload_id(value: AnonRequired): Self = {
