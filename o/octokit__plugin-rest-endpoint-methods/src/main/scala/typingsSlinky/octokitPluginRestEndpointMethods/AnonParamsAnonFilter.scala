...
trait AnonParamsAnonFilter extends js.Object {
  ...
  var params: AnonFilter = js.native
...
object AnonParamsAnonFilter {
  ...
  @scala.inline
  implicit class AnonParamsAnonFilterOps[Self <: AnonParamsAnonFilter] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonFilter): Self = {
        val ret = this.duplicate
