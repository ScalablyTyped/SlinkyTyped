...
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityCheckStarringRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityCheckWatchingRepoLegacyParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityDeleteRepoSubscriptionParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityDeleteThreadSubscriptionParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityGetRepoSubscriptionParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityGetThreadParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityGetThreadSubscriptionParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListEventsForOrgParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListEventsForUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListNotificationsForRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListNotificationsParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListPublicEventsForOrgParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListPublicEventsForRepoNetworkParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListPublicEventsForUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListPublicEventsParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListReceivedEventsForUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListReceivedPublicEventsForUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListRepoEventsParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListReposStarredByAuthenticatedUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListReposStarredByUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListReposWatchedByUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListStargazersForRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListWatchedReposForAuthenticatedUserParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityListWatchersForRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityMarkAsReadParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityMarkNotificationsAsReadForRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityMarkThreadAsReadParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivitySetRepoSubscriptionParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivitySetThreadSubscriptionParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityStarRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityStopWatchingRepoLegacyParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityUnstarRepoParams
import typingsSlinky.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityWatchRepoLegacyParams
...
@js.native
trait AnonCheckWatchingRepoLegacy extends js.Object {
  /**
  ...
  def checkWatchingRepoLegacy(
    params: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestParameters */ js.Any) with ActivityCheckWatchingRepoLegacyParams
  ): js.Promise[AnyResponse] = js.native
  /**
    * This endpoint should only be used to stop watching a repository. To control whether or not you wish to receive notifications from a repository, [set the repository's subscription manually](https://developer.github.com/v3/activity/watching/#set-a-repository-subscription).
    */
  ...
  def stopWatchingRepoLegacy(
    params: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestParameters */ js.Any) with ActivityStopWatchingRepoLegacyParams
  ): js.Promise[AnyResponse] = js.native
  /**
    * Requires for the user to be authenticated.
    */
  ...
  def watchRepoLegacy(
    params: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestParameters */ js.Any) with ActivityWatchRepoLegacyParams
  ): js.Promise[AnyResponse] = js.native
}
