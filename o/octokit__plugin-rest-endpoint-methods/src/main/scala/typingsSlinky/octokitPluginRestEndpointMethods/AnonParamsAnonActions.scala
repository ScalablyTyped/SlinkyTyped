...
trait AnonParamsAnonActions extends js.Object {
  ...
  var params: AnonActions = js.native
...
object AnonParamsAnonActions {
  ...
  @scala.inline
  implicit class AnonParamsAnonActionsOps[Self <: AnonParamsAnonActions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonActions): Self = {
        val ret = this.duplicate
