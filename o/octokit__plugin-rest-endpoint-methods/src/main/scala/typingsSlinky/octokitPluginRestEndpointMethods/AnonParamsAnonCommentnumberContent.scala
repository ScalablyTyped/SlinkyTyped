...
trait AnonParamsAnonCommentnumberContent extends js.Object {
  ...
  var params: AnonCommentnumberContent = js.native
...
object AnonParamsAnonCommentnumberContent {
  ...
  @scala.inline
  implicit class AnonParamsAnonCommentnumberContentOps[Self <: AnonParamsAnonCommentnumberContent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonCommentnumberContent): Self = {
        val ret = this.duplicate
