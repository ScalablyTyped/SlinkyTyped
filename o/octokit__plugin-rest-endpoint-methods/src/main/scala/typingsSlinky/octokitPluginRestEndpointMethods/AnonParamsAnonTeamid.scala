...
trait AnonParamsAnonTeamid extends js.Object {
  ...
  var params: AnonTeamid = js.native
...
object AnonParamsAnonTeamid {
  ...
  @scala.inline
  implicit class AnonParamsAnonTeamidOps[Self <: AnonParamsAnonTeamid] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonTeamid): Self = {
        val ret = this.duplicate
