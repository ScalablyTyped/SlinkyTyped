...
trait AnonHeadersMethod extends js.Object {
  ...
  var params: AnonClientid = js.native
  var url: String = js.native
}

object AnonHeadersMethod {
  @scala.inline
  def apply(headers: AnonAccept, method: String, params: AnonClientid, url: String): AnonHeadersMethod = {
  ...
  @scala.inline
  implicit class AnonHeadersMethodOps[Self <: AnonHeadersMethod] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonClientid): Self = {
        val ret = this.duplicate
