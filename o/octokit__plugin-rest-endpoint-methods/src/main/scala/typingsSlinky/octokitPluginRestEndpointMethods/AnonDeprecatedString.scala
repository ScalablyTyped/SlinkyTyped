...
trait AnonDeprecatedString extends js.Object {
  ...
  var params: AnonGrantid = js.native
...
object AnonDeprecatedString {
  ...
  @scala.inline
  implicit class AnonDeprecatedStringOps[Self <: AnonDeprecatedString] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonGrantid): Self = {
        val ret = this.duplicate
