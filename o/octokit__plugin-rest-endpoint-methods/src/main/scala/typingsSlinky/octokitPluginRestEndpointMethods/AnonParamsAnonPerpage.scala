...
trait AnonParamsAnonPerpage extends js.Object {
  ...
  var params: AnonPerpage = js.native
...
object AnonParamsAnonPerpage {
  ...
  @scala.inline
  implicit class AnonParamsAnonPerpageOps[Self <: AnonParamsAnonPerpage] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonPerpage): Self = {
        val ret = this.duplicate
