...
trait AnonParamsAnonCreator extends js.Object {
  ...
  var params: AnonCreator = js.native
...
object AnonParamsAnonCreator {
  ...
  @scala.inline
  implicit class AnonParamsAnonCreatorOps[Self <: AnonParamsAnonCreator] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: AnonCreator): Self = {
        val ret = this.duplicate
