...
trait AnonLockreason extends js.Object {
  ...
  var lock_reason: AnonEnum = js.native
...
object AnonLockreason {
  ...
  @scala.inline
  implicit class AnonLockreasonOps[Self <: AnonLockreason] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLock_reason(value: AnonEnum): Self = {
        val ret = this.duplicate
