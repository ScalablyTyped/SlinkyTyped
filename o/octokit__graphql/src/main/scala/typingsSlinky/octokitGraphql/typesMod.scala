...
import typingsSlinky.octokitGraphql.anon.Extensions
...
import typingsSlinky.octokitTypes.anon.Format
...
object typesMod {
  ...
  trait graphql extends StObject {
    ...
    /**
      ...
      */
    @JSName("endpoint")
    def endpoint_url[O /* <: typingsSlinky.octokitTypes.requestParametersMod.RequestParameters */](options: O with Method with (UrlString | typingsSlinky.octokitTypes.anon.Url)): RequestOptions with (Pick[
        js.Object with O, 
        /* keyof @octokit/types.@octokit/types/dist-types/RequestOptions.RequestOptions */ method | url | headers | body | request
      ]) = js.native
  }
