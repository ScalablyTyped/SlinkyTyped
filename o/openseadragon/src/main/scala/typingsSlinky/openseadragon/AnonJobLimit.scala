...
@js.native
trait AnonJobLimit extends js.Object {
...
object AnonJobLimit {
  @scala.inline
  def apply(): AnonJobLimit = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonJobLimit]
  }
  @scala.inline
  implicit class AnonJobLimitOps[Self <: AnonJobLimit] (val x: Self) extends AnyVal {
    @scala.inline
