...
object AjaxHeaders {
  ...
  implicit class AjaxHeadersOps[Self <: AjaxHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlaceholderFillStyleCanvasPattern(value: CanvasPattern): Self = this.set("placeholderFillStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlaceholderFillStyleCanvasGradient(value: CanvasGradient): Self = this.set("placeholderFillStyle", value.asInstanceOf[js.Any])
