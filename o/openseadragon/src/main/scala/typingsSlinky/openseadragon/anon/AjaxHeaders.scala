...
object AjaxHeaders {
  ...
  implicit class AjaxHeadersMutableBuilder[Self <: AjaxHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlaceholderFillStyleCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "placeholderFillStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlaceholderFillStyleCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "placeholderFillStyle", value.asInstanceOf[js.Any])
