...
import typingsSlinky.oversmash.anon.Options
...
object mod {
  ...
  object NormalizeNamesAs extends StObject {
    ...
    /* "camel" */ val camel: typingsSlinky.oversmash.mod.NormalizeNamesAs.camel with String = js.native
    
    @js.native
    sealed trait snake extends NormalizeNamesAs
    /* "snake" */ val snake: typingsSlinky.oversmash.mod.NormalizeNamesAs.snake with String = js.native
  }
