...
object BackoffOptions {
  @scala.inline
  def apply(
    algorithm: typingsSlinky.oibackoff.oibackoffStrings.incremental | typingsSlinky.oibackoff.oibackoffStrings.exponential | typingsSlinky.oibackoff.oibackoffStrings.fibonacci = null,
