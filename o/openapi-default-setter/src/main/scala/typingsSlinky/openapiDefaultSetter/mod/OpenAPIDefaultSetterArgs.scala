...
trait OpenAPIDefaultSetterArgs extends js.Object {
  ...
  var parameters: js.Array[ParameterObject | typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject]
}

object OpenAPIDefaultSetterArgs {
  @scala.inline
  def apply(
    parameters: js.Array[ParameterObject | typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject],
