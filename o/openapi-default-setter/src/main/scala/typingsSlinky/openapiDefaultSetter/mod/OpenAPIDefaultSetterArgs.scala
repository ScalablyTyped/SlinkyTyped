...
object OpenAPIDefaultSetterArgs {
  ...
  implicit class OpenAPIDefaultSetterArgsOps[Self <: OpenAPIDefaultSetterArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParametersVarargs(value: (ParameterObject | typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject)*): Self = this.set("parameters", js.Array(value :_*))
    @scala.inline
    def setParameters(value: js.Array[ParameterObject | typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject]): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
