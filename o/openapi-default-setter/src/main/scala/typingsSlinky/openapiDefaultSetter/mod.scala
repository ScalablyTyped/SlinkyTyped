...
object mod {
  ...
  object OpenAPIDefaultSetterArgs {
    ...
    implicit class OpenAPIDefaultSetterArgsMutableBuilder[Self <: OpenAPIDefaultSetterArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParameters(value: js.Array[ParameterObject | typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setParametersVarargs(value: (ParameterObject | typingsSlinky.openapiTypes.mod.OpenAPIV3.ParameterObject)*): Self = StObject.set(x, "parameters", js.Array(value :_*))
    }
  }
}
