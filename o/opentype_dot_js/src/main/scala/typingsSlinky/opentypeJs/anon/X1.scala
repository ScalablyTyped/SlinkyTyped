package typingsSlinky.opentypeJs.anon

import typingsSlinky.opentypeJs.mod.PathCommand
import typingsSlinky.opentypeJs.opentypeJsStrings.C
...
object X1 {
  ...
  implicit class X1Ops[Self <: X1] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: C): Self = this.set("type", value.asInstanceOf[js.Any])
