...
object ConnectionAttributes {
  ...
  implicit class ConnectionAttributesMutableBuilder[Self <: ConnectionAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShardingKey(value: js.Array[String | Double | js.Date | Buffer]): Self = StObject.set(x, "shardingKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShardingKeyUndefined: Self = StObject.set(x, "shardingKey", js.undefined)
    
    @scala.inline
    def setShardingKeyVarargs(value: (String | Double | js.Date | Buffer)*): Self = StObject.set(x, "shardingKey", js.Array(value :_*))
    ...
    @scala.inline
    def setSuperShardingKey(value: js.Array[String | Double | js.Date | Buffer]): Self = StObject.set(x, "superShardingKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSuperShardingKeyUndefined: Self = StObject.set(x, "superShardingKey", js.undefined)
    
    @scala.inline
    def setSuperShardingKeyVarargs(value: (String | Double | js.Date | Buffer)*): Self = StObject.set(x, "superShardingKey", js.Array(value :_*))
