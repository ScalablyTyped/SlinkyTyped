...
object ConnectionAttributes {
  ...
  implicit class ConnectionAttributesOps[Self <: ConnectionAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShardingKeyVarargs(value: (String | Double | js.Date | Buffer)*): Self = this.set("shardingKey", js.Array(value :_*))
    
    @scala.inline
    def setShardingKey(value: js.Array[String | Double | js.Date | Buffer]): Self = this.set("shardingKey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSuperShardingKeyVarargs(value: (String | Double | js.Date | Buffer)*): Self = this.set("superShardingKey", js.Array(value :_*))
    
    @scala.inline
    def setSuperShardingKey(value: js.Array[String | Double | js.Date | Buffer]): Self = this.set("superShardingKey", value.asInstanceOf[js.Any])
