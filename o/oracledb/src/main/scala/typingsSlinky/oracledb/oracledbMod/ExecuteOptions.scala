package typingsSlinky.oracledb.oracledbMod

import typingsSlinky.oracledb.Anon_Type
...
trait ExecuteOptions extends js.Object {
  ...
  /**
    ...
    *      }
    */
  var fetchInfo: js.UndefOr[Record[String, Anon_Type]] = js.undefined
  /**
...
object ExecuteOptions {
  ...
  def apply(
    ...
    fetchInfo: Record[String, Anon_Type] = null,
