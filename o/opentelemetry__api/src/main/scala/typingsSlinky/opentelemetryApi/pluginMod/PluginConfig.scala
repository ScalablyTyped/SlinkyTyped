package typingsSlinky.opentelemetryApi.pluginMod
...
object PluginConfig {
  ...
  implicit class PluginConfigOps[Self <: PluginConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreUrlsVarargs(value: (String | js.RegExp)*): Self = this.set("ignoreUrls", js.Array(value :_*))
    
    @scala.inline
    def setIgnoreUrls(value: js.Array[String | js.RegExp]): Self = this.set("ignoreUrls", value.asInstanceOf[js.Any])
