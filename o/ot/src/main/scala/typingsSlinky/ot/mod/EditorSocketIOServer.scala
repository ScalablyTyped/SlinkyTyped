package typingsSlinky.ot.mod

import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.ot.anon.Id
...
- typingsSlinky.ot.mod.Server because Inheritance from two classes. Inlined document, operations, receiveOperation */ @js.native
