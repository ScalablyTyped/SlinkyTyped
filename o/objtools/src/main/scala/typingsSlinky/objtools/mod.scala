...
import typingsSlinky.objtools.objtoolsBooleans.`false`
import typingsSlinky.objtools.objtoolsBooleans.`true`
...
object mod {
  ...
  @js.native
  def sanitizeDate(value: js.Any): js.Date | Null = js.native
