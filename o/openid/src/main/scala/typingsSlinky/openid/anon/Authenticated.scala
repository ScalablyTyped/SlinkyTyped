...
object Authenticated {
  ...
  implicit class AuthenticatedOps[Self <: Authenticated] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClaimedIdentifier(value: String): Self = this.set("claimedIdentifier", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClaimedIdentifier: Self = this.set("claimedIdentifier", js.undefined)
  }
