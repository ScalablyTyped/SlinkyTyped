...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImgHTMLImageElement(value: HTMLImageElement): Self = this.set("img", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setImgHTMLCanvasElement(value: HTMLCanvasElement): Self = this.set("img", value.asInstanceOf[js.Any])
