...
object graticuleMod {
  ...
  trait GraticuleLabelDataType extends StObject {
    ...
    var geom: typingsSlinky.ol.pointMod.default = js.native
  ...
  object GraticuleLabelDataType {
    ...
    @scala.inline
    def apply(geom: typingsSlinky.ol.pointMod.default, text: String): GraticuleLabelDataType = {
    ...
    implicit class GraticuleLabelDataTypeMutableBuilder[Self <: GraticuleLabelDataType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeom(value: typingsSlinky.ol.pointMod.default): Self = StObject.set(x, "geom", value.asInstanceOf[js.Any])
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLatLabelStyle(value: typingsSlinky.ol.textMod.default): Self = StObject.set(x, "latLabelStyle", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLonLabelStyle(value: typingsSlinky.ol.textMod.default): Self = StObject.set(x, "lonLabelStyle", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStrokeStyle(value: typingsSlinky.ol.strokeMod.default): Self = StObject.set(x, "strokeStyle", value.asInstanceOf[js.Any])
