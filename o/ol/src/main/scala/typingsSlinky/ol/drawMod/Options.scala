...
object Options {
  ...
  def apply(
    ...
    geometryFunction: (/* p0 */ SketchCoordType, /* p1 */ js.UndefOr[typingsSlinky.ol.simpleGeometryMod.default], /* p2 */ js.UndefOr[typingsSlinky.ol.projectionMod.default]) => typingsSlinky.ol.simpleGeometryMod.default = null,
