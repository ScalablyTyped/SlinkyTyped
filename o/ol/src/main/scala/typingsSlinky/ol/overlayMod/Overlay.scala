...
trait Overlay
  ...
  /* protected */ def getRect(element: typingsSlinky.std.HTMLElement): Extent = js.native
  /* protected */ def getRect(element: typingsSlinky.std.HTMLElement, size: Size): Extent = js.native
