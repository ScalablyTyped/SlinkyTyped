...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStyle(value: LiteralStyle): Self = {
    ...
    @scala.inline
    def withDisableHitDetection(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disableHitDetection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDisableHitDetection: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disableHitDetection")(js.undefined)
        ret
    }
    @scala.inline
