...
import typingsSlinky.ol.geomMultiPointMod.MultiPoint
...
object geomMultiPointMod extends js.Object {
  ...
  trait MultiPoint
    ...
    def appendPoint(point: typingsSlinky.ol.geomPointMod.default): Unit = js.native
    def getPoint(index: Double): typingsSlinky.ol.geomPointMod.default = js.native
    def getPoints(): js.Array[typingsSlinky.ol.geomPointMod.default] = js.native
  }
