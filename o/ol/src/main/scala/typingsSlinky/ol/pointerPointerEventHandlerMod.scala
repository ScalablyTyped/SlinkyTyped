...
object pointerPointerEventHandlerMod extends js.Object {
  ...
  trait PointerEventHandler
    ...
    def cloneEvent(event: Event, inEvent: typingsSlinky.std.Event): js.Any = js.native
    ...
    def makeEvent(inType: String, data: js.Any, event: Event): typingsSlinky.ol.pointerPointerEventMod.default = js.native
    ...
    def registerSource(name: String, source: typingsSlinky.ol.pointerEventSourceMod.default): Unit = js.native
    def registerSources(): Unit = js.native
    def up(data: js.Any, event: Event): Unit = js.native
    def wrapMouseEvent(eventType: String, event: Event): typingsSlinky.ol.pointerPointerEventMod.default = js.native
  }
