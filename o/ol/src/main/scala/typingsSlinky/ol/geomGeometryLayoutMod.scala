...
object geomGeometryLayoutMod extends js.Object {
  ...
  object default extends js.Object {
    /* "XY" */ val XY: typingsSlinky.ol.geomGeometryLayoutMod.GeometryLayout.XY with String = js.native
    /* "XYM" */ val XYM: typingsSlinky.ol.geomGeometryLayoutMod.GeometryLayout.XYM with String = js.native
    /* "XYZ" */ val XYZ: typingsSlinky.ol.geomGeometryLayoutMod.GeometryLayout.XYZ with String = js.native
    /* "XYZM" */ val XYZM: typingsSlinky.ol.geomGeometryLayoutMod.GeometryLayout.XYZM with String = js.native
    @JSBracketAccess
