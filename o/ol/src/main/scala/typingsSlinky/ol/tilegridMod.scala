...
object tilegridMod {
  ...
  @js.native
  def getForProjection(projection: typingsSlinky.ol.projectionMod.default): default = js.native
  
  @JSImport("ol/tilegrid", "wrapX")
  @js.native
  def wrapX(tileGrid: default, tileCoord: TileCoord, projection: typingsSlinky.ol.projectionMod.default): TileCoord = js.native
