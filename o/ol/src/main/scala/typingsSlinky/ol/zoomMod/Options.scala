...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setZoomInLabelHTMLElement(value: HTMLElement): Self = this.set("zoomInLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setZoomOutLabelHTMLElement(value: HTMLElement): Self = this.set("zoomOutLabel", value.asInstanceOf[js.Any])
    @scala.inline
