...
trait Options extends js.Object {
  ...
  var handleDragEvent: js.UndefOr[js.Function1[/* p0 */ typingsSlinky.ol.mapBrowserPointerEventMod.default, Unit]] = js.undefined
  var handleEvent: js.UndefOr[js.Function1[/* p0 */ typingsSlinky.ol.mapBrowserEventMod.default, Boolean]] = js.undefined
  var handleMoveEvent: js.UndefOr[js.Function1[/* p0 */ typingsSlinky.ol.mapBrowserPointerEventMod.default, Unit]] = js.undefined
...
object Options {
  @scala.inline
  def apply(
    handleDownEvent: /* p0 */ typingsSlinky.ol.mapBrowserPointerEventMod.default => Boolean = null,
    handleDragEvent: /* p0 */ typingsSlinky.ol.mapBrowserPointerEventMod.default => Unit = null,
    handleEvent: /* p0 */ typingsSlinky.ol.mapBrowserEventMod.default => Boolean = null,
    handleMoveEvent: /* p0 */ typingsSlinky.ol.mapBrowserPointerEventMod.default => Unit = null,
    handleUpEvent: /* p0 */ typingsSlinky.ol.mapBrowserPointerEventMod.default => Boolean = null,
