...
object scaleLineMod {
  ...
  object Units extends StObject {
    ...
    /* "degrees" */ val DEGREES: typingsSlinky.ol.scaleLineMod.Units.DEGREES with String = js.native
    
    @js.native
    sealed trait IMPERIAL extends Units
    /* "imperial" */ val IMPERIAL: typingsSlinky.ol.scaleLineMod.Units.IMPERIAL with String = js.native
    
    @js.native
    sealed trait METRIC extends Units
    /* "metric" */ val METRIC: typingsSlinky.ol.scaleLineMod.Units.METRIC with String = js.native
    
    @js.native
    sealed trait NAUTICAL extends Units
    /* "nautical" */ val NAUTICAL: typingsSlinky.ol.scaleLineMod.Units.NAUTICAL with String = js.native
    
    @js.native
    sealed trait US extends Units
    /* "us" */ val US: typingsSlinky.ol.scaleLineMod.Units.US with String = js.native
  }
