...
object kmlMod {
  ...
  @js.native
  def getDefaultFillStyle(): typingsSlinky.ol.fillMod.default = js.native
  
  @JSImport("ol/format/KML", "getDefaultImageStyle")
  @js.native
  def getDefaultImageStyle(): typingsSlinky.ol.styleImageMod.default = js.native
  
  @JSImport("ol/format/KML", "getDefaultStrokeStyle")
  @js.native
  def getDefaultStrokeStyle(): typingsSlinky.ol.strokeMod.default = js.native
  
  @JSImport("ol/format/KML", "getDefaultStyle")
  @js.native
  def getDefaultStyle(): typingsSlinky.ol.styleStyleMod.default = js.native
  
  @JSImport("ol/format/KML", "getDefaultStyleArray")
  @js.native
  def getDefaultStyleArray(): js.Array[typingsSlinky.ol.styleStyleMod.default] = js.native
  
  @JSImport("ol/format/KML", "getDefaultTextStyle")
  @js.native
  def getDefaultTextStyle(): typingsSlinky.ol.textMod.default = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultStyle(value: js.Array[typingsSlinky.ol.styleStyleMod.default]): Self = StObject.set(x, "defaultStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultStyleUndefined: Self = StObject.set(x, "defaultStyle", js.undefined)
      
      @scala.inline
      def setDefaultStyleVarargs(value: typingsSlinky.ol.styleStyleMod.default*): Self = StObject.set(x, "defaultStyle", js.Array(value :_*))
