...
trait IconImageCache extends js.Object {
  ...
  def clear(): Unit
  def expire(): Unit
  def get(src: String, crossOrigin: String, color: Color): typingsSlinky.ol.iconImageMod.default
  def set(src: String, crossOrigin: String, color: Color, iconImage: typingsSlinky.ol.iconImageMod.default): Unit
