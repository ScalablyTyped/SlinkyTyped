...
class default () extends IconImageCache {
  ...
  /* CompleteClass */
  override def get(src: String, crossOrigin: String, color: Color): typingsSlinky.ol.iconImageMod.default = js.native
  /* CompleteClass */
  override def set(src: String, crossOrigin: String, color: Color, iconImage: typingsSlinky.ol.iconImageMod.default): Unit = js.native
  /* CompleteClass */
