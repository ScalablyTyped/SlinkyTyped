...
import typingsSlinky.ol.objectMod.default
...
object canvasMod {
  ...
  object FillState {
    ...
    implicit class FillStateMutableBuilder[Self <: FillState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFillStyleCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "fillStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFillStyleCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "fillStyle", value.asInstanceOf[js.Any])
    }
  }
  ...
  object FillStrokeState {
    ...
    implicit class FillStrokeStateMutableBuilder[Self <: FillStrokeState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCurrentFillStyleCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "currentFillStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCurrentFillStyleCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "currentFillStyle", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setCurrentStrokeStyleCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "currentStrokeStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCurrentStrokeStyleCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "currentStrokeStyle", value.asInstanceOf[js.Any])
  ...
  object TextState {
    ...
    implicit class TextStateMutableBuilder[Self <: TextState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBackgroundFill(value: typingsSlinky.ol.fillMod.default): Self = StObject.set(x, "backgroundFill", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBackgroundFillUndefined: Self = StObject.set(x, "backgroundFill", js.undefined)
      
      @scala.inline
      def setBackgroundStroke(value: typingsSlinky.ol.strokeMod.default): Self = StObject.set(x, "backgroundStroke", value.asInstanceOf[js.Any])
