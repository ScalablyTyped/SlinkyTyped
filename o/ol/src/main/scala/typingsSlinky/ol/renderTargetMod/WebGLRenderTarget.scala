...
object WebGLRenderTarget {
  ...
  implicit class WebGLRenderTargetOps[Self <: WebGLRenderTarget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReadAll(value: () => js.typedarray.Uint8Array): Self = this.set("readAll", js.Any.fromFunction0(value))
    
    @scala.inline
    def setReadPixel(value: (Double, Double) => js.typedarray.Uint8Array): Self = this.set("readPixel", js.Any.fromFunction2(value))
