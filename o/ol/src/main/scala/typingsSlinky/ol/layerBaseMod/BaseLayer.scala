package typingsSlinky.ol.layerBaseMod
...
import typingsSlinky.ol.olStrings.`change:extent`
import typingsSlinky.ol.olStrings.`change:maxResolution`
import typingsSlinky.ol.olStrings.`change:minResolution`
import typingsSlinky.ol.olStrings.`change:opacity`
import typingsSlinky.ol.olStrings.`change:visible`
import typingsSlinky.ol.olStrings.`change:zIndex`
...
trait BaseLayer
  ...
  def getLayersArray(): js.Array[typingsSlinky.ol.layerLayerMod.default] = js.native
  def getLayersArray(opt_array: js.Array[typingsSlinky.ol.layerLayerMod.default]): js.Array[typingsSlinky.ol.layerLayerMod.default] = js.native
  def getMaxResolution(): Double = js.native
  def getMinResolution(): Double = js.native
  def getOpacity(): Double = js.native
  def getSourceState(): typingsSlinky.ol.sourceStateMod.State = js.native
