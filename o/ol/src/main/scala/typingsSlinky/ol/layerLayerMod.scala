...
object layerLayerMod {
  ...
  @js.native
  def inView(layerState: State, viewState: typingsSlinky.ol.viewMod.State): Boolean = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSource(value: typingsSlinky.ol.sourceSourceMod.default): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
  ...
  object State {
    ...
    implicit class StateMutableBuilder[Self <: State] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLayer(value: Layer[typingsSlinky.ol.sourceSourceMod.default]): Self = StObject.set(x, "layer", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSourceState(value: typingsSlinky.ol.stateMod.State): Self = StObject.set(x, "sourceState", value.asInstanceOf[js.Any])
