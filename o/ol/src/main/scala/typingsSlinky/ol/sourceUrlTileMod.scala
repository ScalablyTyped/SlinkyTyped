...
@js.native
object sourceUrlTileMod extends js.Object {
  @js.native
  ...
  trait UrlTile
    ...
    /* protected */ def tileUrlFunction(p0: TileCoord, p1: Double, p2: typingsSlinky.ol.projProjectionMod.default): js.UndefOr[String] = js.native
    @JSName("un")
