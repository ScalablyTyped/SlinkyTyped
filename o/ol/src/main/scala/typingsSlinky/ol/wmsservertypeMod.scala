...
object wmsservertypeMod extends js.Object {
  ...
  object default extends js.Object {
    /* "carmentaserver" */ val CARMENTA_SERVER: typingsSlinky.ol.wmsservertypeMod.WMSServerType.CARMENTA_SERVER with String = js.native
    /* "geoserver" */ val GEOSERVER: typingsSlinky.ol.wmsservertypeMod.WMSServerType.GEOSERVER with String = js.native
    /* "mapserver" */ val MAPSERVER: typingsSlinky.ol.wmsservertypeMod.WMSServerType.MAPSERVER with String = js.native
    /* "qgis" */ val QGIS: typingsSlinky.ol.wmsservertypeMod.WMSServerType.QGIS with String = js.native
    @JSBracketAccess
