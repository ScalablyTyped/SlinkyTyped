...
object ImageStyle {
  ...
  implicit class ImageStyleOps[Self <: ImageStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setListenImageChange(value: js.Function1[/* p0 */ typingsSlinky.ol.eventMod.default, Unit] => Unit): Self = this.set("listenImageChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setUnlistenImageChange(value: js.Function1[/* p0 */ typingsSlinky.ol.eventMod.default, Unit] => Unit): Self = this.set("unlistenImageChange", js.Any.fromFunction1(value))
  }
}
