...
object ImageStyle {
  ...
  def apply(
    ...
    listenImageChange: (js.ThisFunction1[js.Any, /* p0 */ typingsSlinky.ol.eventsEventMod.default, Unit], js.Any) => js.UndefOr[EventsKey],
    load: () => Unit,
    ...
    unlistenImageChange: (js.ThisFunction1[js.Any, /* p0 */ typingsSlinky.ol.eventsEventMod.default, Unit], js.Any) => Unit
  ): ImageStyle = {
