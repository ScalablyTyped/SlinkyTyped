...
trait ImageStyle extends js.Object {
  ...
  def getScale(): Double
  def getSize(): Size
  def listenImageChange[T](listener: js.Function1[/* p0 */ typingsSlinky.ol.eventMod.default, Unit]): Unit
  def load(): Unit
  ...
  def unlistenImageChange[T](listener: js.Function1[/* p0 */ typingsSlinky.ol.eventMod.default, Unit]): Unit
}
