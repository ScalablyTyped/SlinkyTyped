...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundFill(value: typingsSlinky.ol.fillMod.default): Self = this.set("backgroundFill", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBackgroundFill: Self = this.set("backgroundFill", js.undefined)
    
    @scala.inline
    def setBackgroundStroke(value: typingsSlinky.ol.strokeMod.default): Self = this.set("backgroundStroke", value.asInstanceOf[js.Any])
