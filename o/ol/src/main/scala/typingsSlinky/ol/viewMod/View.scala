...
import typingsSlinky.ol.olStrings.`change:center`
import typingsSlinky.ol.olStrings.`change:resolution`
import typingsSlinky.ol.olStrings.`change:rotation`
...
trait View
  ...
  def constrainCenter(): js.UndefOr[Coordinate] = js.native
  def constrainCenter(center: Coordinate): js.UndefOr[Coordinate] = js.native
  def constrainResolution(): js.UndefOr[Double] = js.native
  def constrainResolution(resolution: js.UndefOr[scala.Nothing], opt_delta: Double): js.UndefOr[Double] = js.native
  def constrainResolution(resolution: js.UndefOr[scala.Nothing], opt_delta: Double, opt_direction: Double): js.UndefOr[Double] = js.native
  def constrainResolution(resolution: Double): js.UndefOr[Double] = js.native
  def constrainResolution(resolution: Double, opt_delta: Double): js.UndefOr[Double] = js.native
  def constrainResolution(resolution: Double, opt_delta: Double, opt_direction: Double): js.UndefOr[Double] = js.native
  def constrainRotation(): js.UndefOr[Double] = js.native
  def constrainRotation(rotation: js.UndefOr[scala.Nothing], opt_delta: Double): js.UndefOr[Double] = js.native
  def constrainRotation(rotation: Double): js.UndefOr[Double] = js.native
  def constrainRotation(rotation: Double, opt_delta: Double): js.UndefOr[Double] = js.native
  def fit(geometryOrExtent: Extent): Unit = js.native
  def fit(geometryOrExtent: Extent, opt_options: FitOptions): Unit = js.native
  def fit(geometryOrExtent: typingsSlinky.ol.geomSimpleGeometryMod.default): Unit = js.native
  def fit(geometryOrExtent: typingsSlinky.ol.geomSimpleGeometryMod.default, opt_options: FitOptions): Unit = js.native
