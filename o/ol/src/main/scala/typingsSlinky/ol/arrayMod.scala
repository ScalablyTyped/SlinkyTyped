...
object arrayMod {
  ...
  @JSImport("ol/array", "equals")
  @js.native
  def equals_(arr1: js.Array[_], arr2: js.typedarray.Uint8ClampedArray): Boolean = js.native
  @JSImport("ol/array", "equals")
  @js.native
  def equals_(arr1: js.typedarray.Uint8ClampedArray, arr2: js.Array[_]): Boolean = js.native
  @JSImport("ol/array", "equals")
  @js.native
  def equals_(arr1: js.typedarray.Uint8ClampedArray, arr2: js.typedarray.Uint8ClampedArray): Boolean = js.native
