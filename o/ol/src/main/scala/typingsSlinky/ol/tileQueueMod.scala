...
import typingsSlinky.ol.tileQueueMod.TileQueue
...
object tileQueueMod extends js.Object {
  @js.native
  trait TileQueue
    extends typingsSlinky.ol.structsPriorityQueueMod.default[js.Any] {
    def getTilesLoading(): Double = js.native
    /* protected */ def handleTileChange(event: typingsSlinky.ol.eventsEventMod.default): Unit = js.native
  ...
  type PriorityFunction = js.Function4[
    /* p0 */ typingsSlinky.ol.tileMod.default, 
    /* p1 */ String, 
    /* p2 */ Coordinate, 
    /* p3 */ Double, 
    Double
