...
object xmlfeatureMod extends js.Object {
  ...
  trait XMLFeature
    ...
    def readFeatureFromDocument(doc: Document_): typingsSlinky.ol.olFeatureMod.default[typingsSlinky.ol.geometryMod.default] = js.native
    def readFeatureFromDocument(doc: Document_, opt_options: ReadOptions): typingsSlinky.ol.olFeatureMod.default[typingsSlinky.ol.geometryMod.default] = js.native
    ...
    /* protected */ def readFeaturesFromDocument(doc: Document_): js.Array[typingsSlinky.ol.olFeatureMod.default[typingsSlinky.ol.geometryMod.default]] = js.native
    /* protected */ def readFeaturesFromDocument(doc: Document_, opt_options: ReadOptions): js.Array[typingsSlinky.ol.olFeatureMod.default[typingsSlinky.ol.geometryMod.default]] = js.native
    ...
    /* protected */ def readGeometryFromDocument(doc: Document_): typingsSlinky.ol.geometryMod.default = js.native
    /* protected */ def readGeometryFromDocument(doc: Document_, opt_options: ReadOptions): typingsSlinky.ol.geometryMod.default = js.native
    ...
    /* protected */ def readProjectionFromDocument(doc: Document_): typingsSlinky.ol.projectionMod.default = js.native
