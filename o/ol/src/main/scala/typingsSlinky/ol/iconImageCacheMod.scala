...
object iconImageCacheMod {
  ...
  object IconImageCache {
    ...
    implicit class IconImageCacheMutableBuilder[Self <: IconImageCache] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGet(value: (String, String, Color) => typingsSlinky.ol.iconImageMod.default): Self = StObject.set(x, "get", js.Any.fromFunction3(value))
      
      @scala.inline
      def setSet(value: (String, String, Color, typingsSlinky.ol.iconImageMod.default) => Unit): Self = StObject.set(x, "set", js.Any.fromFunction4(value))
