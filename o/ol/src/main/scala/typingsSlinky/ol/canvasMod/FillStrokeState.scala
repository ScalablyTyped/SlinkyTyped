...
object FillStrokeState {
  ...
  implicit class FillStrokeStateOps[Self <: FillStrokeState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentFillStyleCanvasPattern(value: CanvasPattern): Self = this.set("currentFillStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentFillStyleCanvasGradient(value: CanvasGradient): Self = this.set("currentFillStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCurrentStrokeStyleCanvasPattern(value: CanvasPattern): Self = this.set("currentStrokeStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentStrokeStyleCanvasGradient(value: CanvasGradient): Self = this.set("currentStrokeStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStrokeStyleCanvasPattern(value: CanvasPattern): Self = this.set("strokeStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStrokeStyleCanvasGradient(value: CanvasGradient): Self = this.set("strokeStyle", value.asInstanceOf[js.Any])
