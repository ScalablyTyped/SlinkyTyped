...
object WebGLWorkerGenerateBuffersMessage {
  ...
  implicit class WebGLWorkerGenerateBuffersMessageOps[Self <: WebGLWorkerGenerateBuffersMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderInstructions(value: js.typedarray.ArrayBuffer): Self = this.set("renderInstructions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIndexBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("indexBuffer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIndexBuffer: Self = this.set("indexBuffer", js.undefined)
    
    @scala.inline
    def setVertexBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("vertexBuffer", value.asInstanceOf[js.Any])
