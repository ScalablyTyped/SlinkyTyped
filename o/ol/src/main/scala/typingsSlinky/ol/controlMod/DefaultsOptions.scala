...
object DefaultsOptions {
  ...
  implicit class DefaultsOptionsOps[Self <: DefaultsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttributionOptions(value: Options): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRotateOptions(value: typingsSlinky.ol.rotateMod.Options): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withZoomOptions(value: typingsSlinky.ol.zoomMod.Options): Self = {
        val ret = this.duplicate
