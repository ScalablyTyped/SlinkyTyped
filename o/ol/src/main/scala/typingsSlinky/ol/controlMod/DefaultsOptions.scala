...
object DefaultsOptions {
  ...
  implicit class DefaultsOptionsOps[Self <: DefaultsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRotateOptions(value: typingsSlinky.ol.rotateMod.Options): Self = this.set("rotateOptions", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setZoomOptions(value: typingsSlinky.ol.zoomMod.Options): Self = this.set("zoomOptions", value.asInstanceOf[js.Any])
    @scala.inline
