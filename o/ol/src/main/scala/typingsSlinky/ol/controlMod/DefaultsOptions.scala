...
trait DefaultsOptions extends js.Object {
  ...
  var rotateOptions: js.UndefOr[typingsSlinky.ol.rotateMod.Options] = js.undefined
  var zoom: js.UndefOr[Boolean] = js.undefined
  var zoomOptions: js.UndefOr[typingsSlinky.ol.zoomMod.Options] = js.undefined
}
...
object DefaultsOptions {
  ...
  def apply(
    ...
    rotateOptions: typingsSlinky.ol.rotateMod.Options = null,
    zoom: js.UndefOr[Boolean] = js.undefined,
    zoomOptions: typingsSlinky.ol.zoomMod.Options = null
  ): DefaultsOptions = {
