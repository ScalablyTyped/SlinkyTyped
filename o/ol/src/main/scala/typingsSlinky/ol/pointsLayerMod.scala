...
object pointsLayerMod {
  ...
  class default protected () extends WebGLPointsLayerRenderer {
    def this(
      layer: typingsSlinky.ol.layerLayerMod.default[typingsSlinky.ol.sourceSourceMod.default],
      options: Options
    ) = this()
  }
  ...
  object FeatureCacheItem {
    ...
    implicit class FeatureCacheItemMutableBuilder[Self <: FeatureCacheItem] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeometry(value: typingsSlinky.ol.geometryMod.default): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
