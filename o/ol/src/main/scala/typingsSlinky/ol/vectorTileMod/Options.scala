...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMap(value: typingsSlinky.ol.pluggableMapMod.default): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRenderMode(value: VectorTileRenderType | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRenderOrder(value: (/* p0 */ FeatureLike, /* p1 */ FeatureLike) => Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSource(value: typingsSlinky.ol.sourceVectorTileMod.default): Self = {
        val ret = this.duplicate
