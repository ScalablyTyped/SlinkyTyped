package typingsSlinky.ol.styleIconImageCacheMod
...
class default () extends IconImageCache {
  ...
  /* CompleteClass */
  override def get(src: String, crossOrigin: String, color: Color): typingsSlinky.ol.styleIconImageMod.default = js.native
  /* CompleteClass */
  override def set(
    src: String,
    crossOrigin: String,
    color: Color,
    iconImage: typingsSlinky.ol.styleIconImageMod.default
  ): Unit = js.native
  /* CompleteClass */
