...
trait IconImageCache extends js.Object {
  def clear(): Unit
  def expire(): Unit
  def get(src: String, crossOrigin: String, color: Color): typingsSlinky.ol.styleIconImageMod.default
  def set(
    src: String,
    crossOrigin: String,
    color: Color,
...
object IconImageCache {
  ...
  def apply(
    clear: () => Unit,
    expire: () => Unit,
    get: (String, String, Color) => typingsSlinky.ol.styleIconImageMod.default,
    set: (String, String, Color, typingsSlinky.ol.styleIconImageMod.default) => Unit,
    setSize: Double => Unit
  ): IconImageCache = {
