...
object WriteGetFeatureOptions {
  ...
  implicit class WriteGetFeatureOptionsOps[Self <: WriteGetFeatureOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBbox(value: Extent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFilter(value: typingsSlinky.ol.filterFilterMod.default): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withViewParams(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("viewParams")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutViewParams: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("viewParams")(js.undefined)
        ret
    }
  }
