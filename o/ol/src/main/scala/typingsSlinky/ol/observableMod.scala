...
import typingsSlinky.ol.observableMod.Observable
...
object observableMod extends js.Object {
  ...
  trait Observable
    ...
    @JSName("on")
    def on_change(`type`: change, listener: js.Function1[/* evt */ typingsSlinky.ol.eventsEventMod.default, Unit]): EventsKey = js.native
    ...
    @JSName("once")
    def once_change(`type`: change, listener: js.Function1[/* evt */ typingsSlinky.ol.eventsEventMod.default, Unit]): EventsKey = js.native
    ...
    @JSName("un")
    def un_change(`type`: change, listener: js.Function1[/* evt */ typingsSlinky.ol.eventsEventMod.default, Unit]): Unit = js.native
  }
