...
object baseTileMod {
  ...
  trait Options extends StObject {
    ...
    var source: js.UndefOr[typingsSlinky.ol.sourceTileMod.default] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSource(value: typingsSlinky.ol.sourceTileMod.default): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
