...
trait VectorSource
  ...
  /* protected */ def addFeatureInternal(feature: typingsSlinky.ol.featureMod.default): Unit = js.native
  def addFeatures(features: js.Array[typingsSlinky.ol.featureMod.default]): Unit = js.native
  /* protected */ def addFeaturesInternal(features: js.Array[typingsSlinky.ol.featureMod.default]): Unit = js.native
  def clear(): Unit = js.native
  def clear(opt_fast: Boolean): Unit = js.native
  def forEachFeature[T](callback: js.Function1[/* p0 */ typingsSlinky.ol.featureMod.default, T]): js.UndefOr[T] = js.native
  def forEachFeatureAtCoordinateDirect[T](coordinate: Coordinate, callback: js.Function1[/* p0 */ typingsSlinky.ol.featureMod.default, T]): js.UndefOr[T] = js.native
  def forEachFeatureInExtent[T](extent: Extent, callback: js.Function1[/* p0 */ typingsSlinky.ol.featureMod.default, T]): js.UndefOr[T] = js.native
  def forEachFeatureIntersectingExtent[T](extent: Extent, callback: js.Function1[/* p0 */ typingsSlinky.ol.featureMod.default, T]): js.UndefOr[T] = js.native
  def getClosestFeatureToCoordinate(coordinate: Coordinate): typingsSlinky.ol.featureMod.default = js.native
  def getClosestFeatureToCoordinate(coordinate: Coordinate, opt_filter: js.Function0[Unit]): typingsSlinky.ol.featureMod.default = js.native
  def getExtent(): Extent = js.native
  def getExtent(opt_extent: Extent): Extent = js.native
  def getFeatureById(id: String): typingsSlinky.ol.featureMod.default = js.native
  def getFeatureById(id: Double): typingsSlinky.ol.featureMod.default = js.native
  def getFeatures(): js.Array[typingsSlinky.ol.featureMod.default] = js.native
  def getFeaturesAtCoordinate(coordinate: Coordinate): js.Array[typingsSlinky.ol.featureMod.default] = js.native
  def getFeaturesCollection(): typingsSlinky.ol.collectionMod.default[typingsSlinky.ol.featureMod.default] = js.native
  def getFeaturesInExtent(extent: Extent): js.Array[typingsSlinky.ol.featureMod.default] = js.native
  def getFormat(): js.UndefOr[typingsSlinky.ol.formatFeatureMod.default] = js.native
  def getOverlaps(): Boolean = js.native
  def getUrl(): js.UndefOr[String | FeatureUrlFunction] = js.native
  def hasFeature(feature: typingsSlinky.ol.featureMod.default): Boolean = js.native
  def isEmpty(): Boolean = js.native
  def loadFeatures(extent: Extent, resolution: Double, projection: typingsSlinky.ol.projProjectionMod.default): Unit = js.native
  @JSName("on")
  ...
  /* protected */ def removeFeatureInternal(feature: typingsSlinky.ol.featureMod.default): Unit = js.native
