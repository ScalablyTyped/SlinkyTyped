...
object projectionMod {
  ...
  object Projection {
    ...
    implicit class ProjectionMutableBuilder[Self <: Projection] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetDefaultTileGrid(value: () => typingsSlinky.ol.tilegridTileGridMod.default): Self = StObject.set(x, "getDefaultTileGrid", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setSetDefaultTileGrid(value: typingsSlinky.ol.tilegridTileGridMod.default => Unit): Self = StObject.set(x, "setDefaultTileGrid", js.Any.fromFunction1(value))
