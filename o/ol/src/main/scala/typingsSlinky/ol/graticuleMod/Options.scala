...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLatLabelStyle(value: typingsSlinky.ol.textMod.default): Self = this.set("latLabelStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLonLabelStyle(value: typingsSlinky.ol.textMod.default): Self = this.set("lonLabelStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStrokeStyle(value: typingsSlinky.ol.strokeMod.default): Self = this.set("strokeStyle", value.asInstanceOf[js.Any])
