...
trait Text extends js.Object {
  def getBackgroundFill(): typingsSlinky.ol.styleFillMod.default = js.native
  def getBackgroundStroke(): typingsSlinky.ol.styleStrokeMod.default = js.native
  ...
  def getScale(): js.UndefOr[Double] = js.native
  ...
  def setBackgroundFill(fill: typingsSlinky.ol.styleFillMod.default): Unit = js.native
  def setBackgroundStroke(stroke: typingsSlinky.ol.styleStrokeMod.default): Unit = js.native
