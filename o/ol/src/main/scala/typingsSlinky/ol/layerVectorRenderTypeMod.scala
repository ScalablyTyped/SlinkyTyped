...
object layerVectorRenderTypeMod extends js.Object {
  ...
  object default extends js.Object {
    /* "image" */ val IMAGE: typingsSlinky.ol.layerVectorRenderTypeMod.VectorRenderType.IMAGE with String = js.native
    /* "vector" */ val VECTOR: typingsSlinky.ol.layerVectorRenderTypeMod.VectorRenderType.VECTOR with String = js.native
    @JSBracketAccess
