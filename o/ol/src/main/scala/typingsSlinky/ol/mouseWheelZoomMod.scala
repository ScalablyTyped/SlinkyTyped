...
object mouseWheelZoomMod {
  ...
  object Mode extends StObject {
    ...
    /* "trackpad" */ val TRACKPAD: typingsSlinky.ol.mouseWheelZoomMod.Mode.TRACKPAD with String = js.native
    
    @js.native
    sealed trait WHEEL extends Mode
    /* "wheel" */ val WHEEL: typingsSlinky.ol.mouseWheelZoomMod.Mode.WHEEL with String = js.native
  }
