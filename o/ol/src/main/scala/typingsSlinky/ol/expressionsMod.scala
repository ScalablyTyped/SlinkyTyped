...
object expressionsMod {
  ...
  object ValueTypes extends StObject {
    ...
    /* 31 */ val ANY: typingsSlinky.ol.expressionsMod.ValueTypes.ANY with Double = js.native
    
    @js.native
    sealed trait BOOLEAN extends ValueTypes
    /* 8 */ val BOOLEAN: typingsSlinky.ol.expressionsMod.ValueTypes.BOOLEAN with Double = js.native
    
    @js.native
    sealed trait COLOR extends ValueTypes
    /* 4 */ val COLOR: typingsSlinky.ol.expressionsMod.ValueTypes.COLOR with Double = js.native
    
    @js.native
    sealed trait NONE extends ValueTypes
    /* 0 */ val NONE: typingsSlinky.ol.expressionsMod.ValueTypes.NONE with Double = js.native
    
    @js.native
    sealed trait NUMBER extends ValueTypes
    /* 1 */ val NUMBER: typingsSlinky.ol.expressionsMod.ValueTypes.NUMBER with Double = js.native
    
    @js.native
    sealed trait NUMBER_ARRAY extends ValueTypes
    /* 16 */ val NUMBER_ARRAY: typingsSlinky.ol.expressionsMod.ValueTypes.NUMBER_ARRAY with Double = js.native
    
    @js.native
    sealed trait STRING extends ValueTypes
    /* 2 */ val STRING: typingsSlinky.ol.expressionsMod.ValueTypes.STRING with Double = js.native
  }
