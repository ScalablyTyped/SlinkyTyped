package typingsSlinky.ol.controlUtilMod
...
trait DefaultsOptions extends js.Object {
  ...
  var rotateOptions: js.UndefOr[typingsSlinky.ol.controlRotateMod.Options] = js.undefined
  var zoom: js.UndefOr[Boolean] = js.undefined
  var zoomOptions: js.UndefOr[typingsSlinky.ol.controlZoomMod.Options] = js.undefined
}
...
object DefaultsOptions {
  ...
  def apply(
    ...
    rotateOptions: typingsSlinky.ol.controlRotateMod.Options = null,
    zoom: js.UndefOr[Boolean] = js.undefined,
    zoomOptions: typingsSlinky.ol.controlZoomMod.Options = null
  ): DefaultsOptions = {
