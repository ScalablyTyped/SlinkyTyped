...
object formatFormatTypeMod extends js.Object {
  ...
  object default extends js.Object {
    /* "arraybuffer" */ val ARRAY_BUFFER: typingsSlinky.ol.formatFormatTypeMod.FormatType.ARRAY_BUFFER with String = js.native
    /* "json" */ val JSON: typingsSlinky.ol.formatFormatTypeMod.FormatType.JSON with String = js.native
    /* "text" */ val TEXT: typingsSlinky.ol.formatFormatTypeMod.FormatType.TEXT with String = js.native
    /* "xml" */ val XML: typingsSlinky.ol.formatFormatTypeMod.FormatType.XML with String = js.native
    @JSBracketAccess
