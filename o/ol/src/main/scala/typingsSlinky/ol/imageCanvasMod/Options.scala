package typingsSlinky.ol.imageCanvasMod
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCanvasFunction(value: FunctionType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("canvasFunction")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCanvasFunction: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("canvasFunction")(js.undefined)
        ret
    }
    @scala.inline
