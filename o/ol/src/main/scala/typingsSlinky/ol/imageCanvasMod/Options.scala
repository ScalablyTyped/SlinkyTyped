...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCanvasFunction(value: FunctionType): Self = this.set("canvasFunction", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCanvasFunction: Self = this.set("canvasFunction", js.undefined)
