...
object renderTargetMod {
  ...
  object WebGLRenderTarget {
    ...
    implicit class WebGLRenderTargetMutableBuilder[Self <: WebGLRenderTarget] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReadAll(value: () => js.typedarray.Uint8Array): Self = StObject.set(x, "readAll", js.Any.fromFunction0(value))
      
      @scala.inline
      def setReadPixel(value: (Double, Double) => js.typedarray.Uint8Array): Self = StObject.set(x, "readPixel", js.Any.fromFunction2(value))
