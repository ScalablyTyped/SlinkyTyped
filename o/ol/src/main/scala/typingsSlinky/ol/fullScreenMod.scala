...
object fullScreenMod {
  ...
  trait FullScreen
    ...
    @JSName("on")
    def on_enterfullscreen(`type`: enterfullscreen, listener: js.Function1[/* evt */ typingsSlinky.ol.eventMod.default, Unit]): EventsKey = js.native
    @JSName("on")
    def on_leavefullscreen(`type`: leavefullscreen, listener: js.Function1[/* evt */ typingsSlinky.ol.eventMod.default, Unit]): EventsKey = js.native
    
    @JSName("once")
    def once_enterfullscreen(`type`: enterfullscreen, listener: js.Function1[/* evt */ typingsSlinky.ol.eventMod.default, Unit]): EventsKey = js.native
    @JSName("once")
    def once_leavefullscreen(`type`: leavefullscreen, listener: js.Function1[/* evt */ typingsSlinky.ol.eventMod.default, Unit]): EventsKey = js.native
    
    @JSName("un")
    def un_enterfullscreen(`type`: enterfullscreen, listener: js.Function1[/* evt */ typingsSlinky.ol.eventMod.default, Unit]): Unit = js.native
    @JSName("un")
    def un_leavefullscreen(`type`: leavefullscreen, listener: js.Function1[/* evt */ typingsSlinky.ol.eventMod.default, Unit]): Unit = js.native
  }
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelActiveHTMLElement(value: HTMLElement): Self = StObject.set(x, "labelActive", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelActiveText(value: Text): Self = StObject.set(x, "labelActive", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLabelText(value: Text): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSourceHTMLElement(value: HTMLElement): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
