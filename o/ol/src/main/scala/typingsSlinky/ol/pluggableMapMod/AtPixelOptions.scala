...
trait AtPixelOptions extends js.Object {
  ...
  def layerFilter(p0: typingsSlinky.ol.layerLayerMod.default): Boolean
}

object AtPixelOptions {
  @scala.inline
  def apply(layerFilter: typingsSlinky.ol.layerLayerMod.default => Boolean, hitTolerance: Int | Double = null): AtPixelOptions = {
