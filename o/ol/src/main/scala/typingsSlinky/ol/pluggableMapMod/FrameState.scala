...
object FrameState {
  ...
  implicit class FrameStateOps[Self <: FrameState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTileQueue(value: typingsSlinky.ol.tileQueueMod.default): Self = this.set("tileQueue", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setViewState(value: typingsSlinky.ol.viewMod.State): Self = this.set("viewState", value.asInstanceOf[js.Any])
