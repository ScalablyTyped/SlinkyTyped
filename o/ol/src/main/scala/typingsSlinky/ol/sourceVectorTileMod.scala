...
object sourceVectorTileMod {
  ...
  @js.native
  def defaultLoadFunction(tile: typingsSlinky.ol.olVectorTileMod.default, url: String): Unit = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTileClass(value: typingsSlinky.ol.olVectorTileMod.default): Self = StObject.set(x, "tileClass", value.asInstanceOf[js.Any])
