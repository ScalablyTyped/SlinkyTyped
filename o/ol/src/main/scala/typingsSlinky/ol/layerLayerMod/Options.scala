...
trait Options extends js.Object {
  ...
  var source: js.UndefOr[typingsSlinky.ol.sourceSourceMod.default] = js.native
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRender(value: /* p0 */ FrameState => HTMLElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSource(value: typingsSlinky.ol.sourceSourceMod.default): Self = {
        val ret = this.duplicate
