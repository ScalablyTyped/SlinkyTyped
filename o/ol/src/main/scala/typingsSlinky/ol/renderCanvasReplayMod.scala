...
object renderCanvasReplayMod extends js.Object {
  ...
  trait CanvasReplay
    ...
    /* protected */ def beginGeometry(geometry: typingsSlinky.ol.geomGeometryMod.default, feature: typingsSlinky.ol.featureMod.default): Unit = js.native
    ...
    /* protected */ def beginGeometry(geometry: typingsSlinky.ol.renderFeatureMod.default, feature: typingsSlinky.ol.featureMod.default): Unit = js.native
    /* protected */ def beginGeometry(
      geometry: typingsSlinky.ol.renderFeatureMod.default,
      feature: typingsSlinky.ol.renderFeatureMod.default
    ): Unit = js.native
    def createFill(state: FillStrokeState, geometry: typingsSlinky.ol.geomGeometryMod.default): js.Array[_] = js.native
    def createFill(state: FillStrokeState, geometry: typingsSlinky.ol.renderFeatureMod.default): js.Array[_] = js.native
    ...
    def endGeometry(geometry: typingsSlinky.ol.geomGeometryMod.default, feature: typingsSlinky.ol.featureMod.default): Unit = js.native
    def endGeometry(
      geometry: typingsSlinky.ol.geomGeometryMod.default,
      feature: typingsSlinky.ol.renderFeatureMod.default
    ): Unit = js.native
    def endGeometry(geometry: typingsSlinky.ol.renderFeatureMod.default, feature: typingsSlinky.ol.featureMod.default): Unit = js.native
    def endGeometry(
      geometry: typingsSlinky.ol.renderFeatureMod.default,
      feature: typingsSlinky.ol.renderFeatureMod.default
    ): Unit = js.native
    ...
    def renderDeclutter_(declutterGroup: DeclutterGroup, feature: typingsSlinky.ol.featureMod.default): Unit = js.native
    def renderDeclutter_(declutterGroup: DeclutterGroup, feature: typingsSlinky.ol.renderFeatureMod.default): Unit = js.native
    def replay(
    ...
    def updateFillStyle(
      ...
      createFill: js.ThisFunction2[
          /* this */ this.type, 
          /* p0 */ FillStrokeState, 
          /* p1 */ typingsSlinky.ol.geomGeometryMod.default | typingsSlinky.ol.renderFeatureMod.default, 
          js.Array[_]
        ],
      geometry: typingsSlinky.ol.geomGeometryMod.default
    ): Unit = js.native
