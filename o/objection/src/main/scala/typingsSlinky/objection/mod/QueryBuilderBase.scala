...
trait QueryBuilderBase[QM /* <: Model */, RM, RV] extends QueryInterface[QM, RM, RV] {
  ...
  def insert(): this.type = js.native
  ...
  def insertGraph(): this.type = js.native
  ...
  @JSName("insertGraph")
  def insertGraph_QueryBuilder(): QueryBuilder[
    QM, 
    js.Array[QM], 
    /* import warning: DefaultedTypeArguments.enterTsTypeRef applyOrElse newTParams next no default parameter for RV */ _
  ] = js.native
  /**
    * insertWithRelated is an alias for insertGraph.
    */
  def insertWithRelated(): this.type = js.native
  ...
  /**
    ...
    */
  @JSName("insertWithRelated")
  def insertWithRelated_QueryBuilder(): QueryBuilder[
    QM, 
    js.Array[QM], 
    /* import warning: DefaultedTypeArguments.enterTsTypeRef applyOrElse newTParams next no default parameter for RV */ _
  ] = js.native
  @JSName("insert")
  def insert_QueryBuilder(): QueryBuilder[
    QM, 
    js.Array[QM], 
    /* import warning: DefaultedTypeArguments.enterTsTypeRef applyOrElse newTParams next no default parameter for RV */ _
  ] = js.native
  ...
  def modelClass(): TypeofModel = js.native
  ...
  def onBuildKnex(
    fn: js.Function2[
      /* knexBuilder */ typingsSlinky.knex.mod.QueryBuilder[_, js.Array[SafePartial[_]]], 
      /* builder */ this.type, 
      Unit
    ]
  ): this.type = js.native
  def onError(fn: js.Function2[/* error */ js.Error, /* builder */ this.type, _]): this.type = js.native
  ...
  def traverse(modelClass: TypeofModel, traverser: TraverserFunction): this.type = js.native
