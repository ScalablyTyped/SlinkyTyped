...
package object mod {
  ...
  type GraphModel[T] = (typingsSlinky.objection.anon.Id with T) | (typingsSlinky.objection.anon.Ref with typingsSlinky.objection.objectionStrings.GraphModel with org.scalablytyped.runtime.TopLevel[js.Any]) | (typingsSlinky.objection.anon.DbRef with typingsSlinky.objection.objectionStrings.GraphModel with org.scalablytyped.runtime.TopLevel[js.Any])
