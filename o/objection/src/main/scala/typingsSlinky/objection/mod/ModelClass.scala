...
trait ModelClass[M /* <: Model */] extends Constructor[M] {
  ...
  def knexQuery(): typingsSlinky.knex.mod.QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
  ...
  def raw[TResult2](value: typingsSlinky.knex.mod.Value): Raw[TResult2] = js.native
