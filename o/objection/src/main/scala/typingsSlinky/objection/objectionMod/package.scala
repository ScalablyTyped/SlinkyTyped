...
package object objectionMod {
  ...
  import typingsSlinky.objection.Anon_DbRef
  import typingsSlinky.objection.Anon_Id
  import typingsSlinky.objection.Anon_Ref
  ...
  type GraphModel[T] = (Anon_Id with T) | (Anon_Ref with typingsSlinky.objection.objectionStrings.GraphModel with js.Any) | (Anon_DbRef with typingsSlinky.objection.objectionStrings.GraphModel with js.Any)
  ...
  type Raw = typingsSlinky.knex.knexMod.Raw[js.Any]
  ...
  //
  type Value = String | Double | Boolean | js.Date | (js.Array[Boolean | js.Date | Double | String]) | Null | Buffer | Raw | Literal
