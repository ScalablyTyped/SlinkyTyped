...
import typingsSlinky.objection.TypeofClassModel
...
object Model extends js.Object {
  ...
  def knexQuery(): typingsSlinky.knex.knexMod.QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
  ...
  def raw[TResult2](sql: String, bindings: RawBinding*): typingsSlinky.knex.knexMod.Raw[TResult2] = js.native
  def raw[TResult2](sql: String, bindings: js.Array[RawBinding]): typingsSlinky.knex.knexMod.Raw[TResult2] = js.native
  def raw[TResult2](sql: String, bindings: ValueDict): typingsSlinky.knex.knexMod.Raw[TResult2] = js.native
  def raw[TResult2](value: typingsSlinky.knex.knexMod.Value): typingsSlinky.knex.knexMod.Raw[TResult2] = js.native
