package typingsSlinky.osService
...
object mod {
  ...
  @JSImport("os-service", "add")
  @js.native
  def add(name: String, callback: js.Function1[/* error */ js.UndefOr[js.Error], Unit]): Unit = js.native
  @JSImport("os-service", "add")
  @js.native
  def add(name: String, opts: AddOptions, callback: js.Function1[/* error */ js.UndefOr[js.Error], Unit]): Unit = js.native
  
  @JSImport("os-service", "remove")
  @js.native
  def remove(name: String, callback: js.Function1[/* error */ js.UndefOr[js.Error], Unit]): Unit = js.native
