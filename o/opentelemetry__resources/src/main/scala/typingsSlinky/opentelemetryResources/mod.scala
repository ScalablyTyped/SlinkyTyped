...
object mod {
  ...
  class Resource protected ()
    extends typingsSlinky.opentelemetryResources.resourceMod.Resource {
    def this(/**
  ...
  object Resource {
    ...
    @js.native
    val EMPTY: typingsSlinky.opentelemetryResources.resourceMod.Resource = js.native
    ...
    @js.native
    def createTelemetrySDKResource(): typingsSlinky.opentelemetryResources.resourceMod.Resource = js.native
    ...
    @JSImport("@opentelemetry/resources", "Resource.empty")
    @js.native
    def empty(): typingsSlinky.opentelemetryResources.resourceMod.Resource = js.native
  }
  ...
  @js.native
  def detectResources(): js.Promise[typingsSlinky.opentelemetryResources.resourceMod.Resource] = js.native
  @JSImport("@opentelemetry/resources", "detectResources")
  @js.native
  def detectResources(config: ResourceDetectionConfig): js.Promise[typingsSlinky.opentelemetryResources.resourceMod.Resource] = js.native
