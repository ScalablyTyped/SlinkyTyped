...
object constantsMod {
  ...
  object CLOUD_RESOURCE {
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "CLOUD_RESOURCE")
    @js.native
    val ^ : js.Any = js.native
    
    /** The cloud account id used to identify different entities. */
    @JSImport("@opentelemetry/resources/build/src/constants", "CLOUD_RESOURCE.ACCOUNT_ID")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "CLOUD_RESOURCE.PROVIDER")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "CLOUD_RESOURCE.REGION")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "CLOUD_RESOURCE.ZONE")
    @js.native
  ...
  object CONTAINER_RESOURCE {
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "CONTAINER_RESOURCE")
    @js.native
    val ^ : js.Any = js.native
    
    /** The name of the image the container was built on. */
    @JSImport("@opentelemetry/resources/build/src/constants", "CONTAINER_RESOURCE.IMAGE_NAME")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "CONTAINER_RESOURCE.IMAGE_TAG")
    @js.native
    ...
    /** The container name. */
    @JSImport("@opentelemetry/resources/build/src/constants", "CONTAINER_RESOURCE.NAME")
    @js.native
  ...
  object HOST_RESOURCE {
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      * host machine.
      */
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE.HOSTNAME")
    @js.native
    ...
    /**
      ...
      * cloud provider
      */
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE.ID")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE.IMAGE_ID")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE.IMAGE_NAME")
    @js.native
    def IMAGE_NAME: String = js.native
    @scala.inline
    def IMAGE_NAME_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IMAGE_NAME")(x.asInstanceOf[js.Any])
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE.IMAGE_VERSION")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE.NAME")
    @js.native
    def NAME: String = js.native
    @scala.inline
    def NAME_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NAME")(x.asInstanceOf[js.Any])
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "HOST_RESOURCE.TYPE")
    @js.native
  ...
  object K8S_RESOURCE {
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "K8S_RESOURCE")
    @js.native
    val ^ : js.Any = js.native
    
    /** The name of the cluster that the pod is running in. */
    @JSImport("@opentelemetry/resources/build/src/constants", "K8S_RESOURCE.CLUSTER_NAME")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "K8S_RESOURCE.DEPLOYMENT_NAME")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "K8S_RESOURCE.NAMESPACE_NAME")
    @js.native
    ...
    /** The name of the pod. */
    @JSImport("@opentelemetry/resources/build/src/constants", "K8S_RESOURCE.POD_NAME")
    @js.native
  ...
  object SERVICE_RESOURCE {
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "SERVICE_RESOURCE")
    @js.native
    val ^ : js.Any = js.native
    
    /** The string ID of the service instance. */
    @JSImport("@opentelemetry/resources/build/src/constants", "SERVICE_RESOURCE.INSTANCE_ID")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "SERVICE_RESOURCE.NAME")
    @js.native
    def NAME: String = js.native
    
    /** A namespace for `service.name`. */
    @JSImport("@opentelemetry/resources/build/src/constants", "SERVICE_RESOURCE.NAMESPACE")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "SERVICE_RESOURCE.VERSION")
    @js.native
  ...
  object TELEMETRY_SDK_RESOURCE {
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "TELEMETRY_SDK_RESOURCE")
    @js.native
    val ^ : js.Any = js.native
    
    /** The language of telemetry library and of the code instrumented with it. */
    @JSImport("@opentelemetry/resources/build/src/constants", "TELEMETRY_SDK_RESOURCE.LANGUAGE")
    @js.native
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "TELEMETRY_SDK_RESOURCE.NAME")
    @js.native
    def NAME: String = js.native
    @scala.inline
    def NAME_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NAME")(x.asInstanceOf[js.Any])
    ...
    @JSImport("@opentelemetry/resources/build/src/constants", "TELEMETRY_SDK_RESOURCE.VERSION")
    @js.native
    def VERSION: String = js.native
    @scala.inline
    def VERSION_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("VERSION")(x.asInstanceOf[js.Any])
