...
object StrategyOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.openidClient.mod.Client */ TClient](client: TClient): StrategyOptions[TClient] = {
    val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any])
    __obj.asInstanceOf[StrategyOptions[TClient]]
  }
  @scala.inline
  implicit class StrategyOptionsOps[Self <: StrategyOptions[_], /* <: typingsSlinky.openidClient.mod.Client */ TClient] (val x: Self with StrategyOptions[TClient]) extends AnyVal {
    @scala.inline
