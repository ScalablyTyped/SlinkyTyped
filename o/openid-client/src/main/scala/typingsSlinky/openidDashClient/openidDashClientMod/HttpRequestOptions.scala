...
import typingsSlinky.openidDashClient.Anon_408
import typingsSlinky.openidDashClient.Anon_Connect
import typingsSlinky.openidDashClient.Anon_Http
...
trait HttpRequestOptions
  ...
  var agent: js.UndefOr[Agent | typingsSlinky.node.httpsMod.Agent | Boolean | Anon_Http] = js.undefined
...
object HttpRequestOptions {
  ...
  def apply(
    ...
    agent: Agent | typingsSlinky.node.httpsMod.Agent | Boolean | Anon_Http = null,
