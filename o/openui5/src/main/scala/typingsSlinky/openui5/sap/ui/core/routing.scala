...
object routing {
  ...
  trait History extends StObject {
    ...
    /**
      ...
      */
    def getInstance(): typingsSlinky.openui5.sap.ui.core.routing.History = js.native
  ...
  object History {
    ...
    def apply(
      ...
      getInstance: () => typingsSlinky.openui5.sap.ui.core.routing.History,
      getPreviousHash: () => String
    ): typingsSlinky.openui5.sap.ui.core.routing.History = {
      ...
      __obj.asInstanceOf[typingsSlinky.openui5.sap.ui.core.routing.History]
    }
    
    @scala.inline
    implicit class HistoryMutableBuilder[Self <: typingsSlinky.openui5.sap.ui.core.routing.History] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setGetDirection(value: String => js.Any): Self = StObject.set(x, "getDirection", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGetInstance(value: () => typingsSlinky.openui5.sap.ui.core.routing.History): Self = StObject.set(x, "getInstance", js.Any.fromFunction0(value))
  ...
  trait Router extends EventProvider {
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachBypassed(oData: js.Any, fnFunction: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    def attachBypassed(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachRouteMatched(oData: js.Any, fnFunction: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    def attachRouteMatched(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachRoutePatternMatched(oData: js.Any, fnFunction: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    def attachRoutePatternMatched(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachViewCreated(oData: js.Any, fnFunction: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    def attachViewCreated(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    
    /**
      * Removes the router from the hash changer @see sap.ui.core.routing.HashChanger
      * @returns this for chaining.
      */
    def destroy(): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachBypassed(fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachRouteMatched(fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachRoutePatternMatched(fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachViewCreated(fnFunction: js.Any, oListener: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def fireBypassed(mArguments: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def fireRouteMatched(mArguments: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def fireRoutePatternMatched(mArguments: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def fireViewCreated(mArguments: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      */
    def getRouter(sName: String): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns this for chaining.
      */
    def initialize(): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns this for chaining.
      */
    def navTo(sName: String): typingsSlinky.openui5.sap.m.routing.Router = js.native
    def navTo(sName: String, oParameters: js.UndefOr[scala.Nothing], bReplace: Boolean): typingsSlinky.openui5.sap.m.routing.Router = js.native
    def navTo(sName: String, oParameters: js.Any): typingsSlinky.openui5.sap.m.routing.Router = js.native
    def navTo(sName: String, oParameters: js.Any, bReplace: Boolean): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      */
    def setView(sViewName: String, oView: View): typingsSlinky.openui5.sap.m.routing.Router = js.native
    ...
    /**
      ...
      * @returns this for chaining.
      */
    def stop(): typingsSlinky.openui5.sap.m.routing.Router = js.native
  }
