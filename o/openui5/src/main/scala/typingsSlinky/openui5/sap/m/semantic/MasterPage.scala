package typingsSlinky.openui5.sap.m.semantic
...
@js.native
class MasterPage protected () extends SemanticPage {
  /**
  ...
  /**
    ...
    */
  def getMultiSelectAction(): MultiSelectAction = js.native
  /**
