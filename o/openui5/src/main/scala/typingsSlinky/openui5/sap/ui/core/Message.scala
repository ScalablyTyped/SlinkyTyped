...
object message extends js.Object {
  ...
  class MessageManager () extends EventProvider {
    def addMessages(vMessages: js.Array[typingsSlinky.openui5.sap.ui.core.message.Message]): Unit = js.native
    /**
      * Add messages to MessageManager
      * @param vMessages Array of sap.ui.core.message.Message or single sap.ui.core.message.Message
      */
    def addMessages(vMessages: typingsSlinky.openui5.sap.ui.core.message.Message): Unit = js.native
    /**
    ...
    def removeMessages(vMessages: js.Array[typingsSlinky.openui5.sap.ui.core.message.Message]): Unit = js.native
    /**
      * Remove given Messages
      * @param vMessages The message(s) to be removed.
      */
    def removeMessages(vMessages: typingsSlinky.openui5.sap.ui.core.message.Message): Unit = js.native
    /**
