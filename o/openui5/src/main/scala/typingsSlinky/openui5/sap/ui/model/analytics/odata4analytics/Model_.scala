...
object Model_ {
  ...
  implicit class Model_Ops[Self <: Model_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFindQueryResultByName(value: String => QueryResult): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("findQueryResultByName")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetAllQueryResultNames(value: () => js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllQueryResultNames")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetAllQueryResults(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllQueryResults")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetODataModel(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getODataModel")(js.Any.fromFunction0(value))
        ret
    }
  }
