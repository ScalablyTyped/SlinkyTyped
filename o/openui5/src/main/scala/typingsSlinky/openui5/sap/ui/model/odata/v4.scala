...
import typingsSlinky.openui5.sap.ui.model.ContextBinding
import typingsSlinky.openui5.sap.ui.model.ListBinding
import typingsSlinky.openui5.sap.ui.model.MetaModel
import typingsSlinky.openui5.sap.ui.model.Model
import typingsSlinky.openui5.sap.ui.model.PropertyBinding
import typingsSlinky.openui5.sap.ui.model.Sorter
...
object v4 extends js.Object {
  @js.native
  trait Context
    extends typingsSlinky.openui5.sap.ui.model.Context {
    /**
    ...
    /**
      ...
      */
    def getBinding(): typingsSlinky.openui5.sap.ui.model.odata.v4.ODataContextBinding | typingsSlinky.openui5.sap.ui.model.odata.v4.ODataListBinding = js.native
    /**
  ...
  trait ODataContextBinding extends ContextBinding {
    ...
    /**
      ...
      */
    def setParameter(sParameterName: String, vValue: js.Any): typingsSlinky.openui5.sap.ui.model.odata.v4.ODataContextBinding = js.native
  }
  
  @js.native
  trait ODataListBinding extends ListBinding {
    def filter(vFilters: js.Array[typingsSlinky.openui5.sap.ui.model.Filter]): typingsSlinky.openui5.sap.ui.model.odata.v4.ODataListBinding = js.native
    /**
  ...
  trait ODataMetaModel extends MetaModel {
    def bindList(
      ...
      aFilters: typingsSlinky.openui5.sap.ui.model.Filter
    ...
    def bindList(
      ...
      oContext: js.UndefOr[scala.Nothing],
      aSorters: Sorter,
      aFilters: js.Array[typingsSlinky.openui5.sap.ui.model.Filter]
    ): ListBinding = js.native
    def bindList(
      sPath: String,
      oContext: js.UndefOr[scala.Nothing],
    ...
    def bindList(sPath: String, oContext: typingsSlinky.openui5.sap.ui.model.Context, aSorters: Sorter): ListBinding = js.native
    def bindList(
      sPath: String,
      oContext: typingsSlinky.openui5.sap.ui.model.Context,
      aSorters: Sorter,
    ...
    /**
      ...
      */
    def getMetaContext(sPath: String): typingsSlinky.openui5.sap.ui.model.Context = js.native
    def getObject(sPath: String, oContext: typingsSlinky.openui5.sap.ui.model.Context): js.Any = js.native
    /**
    ...
    /**
      ...
      */
    def requestObject(sPath: String): JQueryPromise[_] = js.native
    def requestObject(sPath: String, oContext: typingsSlinky.openui5.sap.ui.model.Context): JQueryPromise[_] = js.native
    /**
  ...
  trait ODataModel extends Model {
    ...
    def bindList(sPath: String, oContext: js.UndefOr[scala.Nothing], vSorters: Sorter): typingsSlinky.openui5.sap.ui.model.odata.v4.ODataListBinding = js.native
    def bindList(
      sPath: String,
      oContext: js.UndefOr[scala.Nothing],
      vSorters: Sorter,
