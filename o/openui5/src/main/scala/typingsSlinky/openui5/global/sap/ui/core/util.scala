...
object util {
  ...
  class Export protected ()
    extends typingsSlinky.openui5.sap.ui.core.util.Export {
    /**
  ...
  class ExportCell protected ()
    extends typingsSlinky.openui5.sap.ui.core.util.ExportCell {
    /**
  ...
  class ExportColumn protected ()
    extends typingsSlinky.openui5.sap.ui.core.util.ExportColumn {
    /**
      * Constructor for a new ExportCell.Accepts an object literal <code>mSettings</code> that defines
      * initialproperty values, aggregated and associated objects as well as event handlers.See {@link
      * sap.ui.base.ManagedObject#constructor} for a general description of the syntax of the settings
  ...
  class ExportRow protected ()
    extends typingsSlinky.openui5.sap.ui.core.util.ExportRow {
    /**
  ...
  class ExportType protected ()
    extends typingsSlinky.openui5.sap.ui.core.util.ExportType {
    /**
  ...
  class ExportTypeCSV protected ()
    extends typingsSlinky.openui5.sap.ui.core.util.ExportTypeCSV {
    /**
  ...
  abstract class MockServer protected ()
    extends typingsSlinky.openui5.sap.ui.core.util.MockServer {
    /**
  ...
  object serializer {
    ...
    class HTMLViewSerializer protected ()
      extends typingsSlinky.openui5.sap.ui.core.util.serializer.HTMLViewSerializer {
      /**
    ...
    class Serializer protected ()
      extends typingsSlinky.openui5.sap.ui.core.util.serializer.Serializer {
      /**
        ...
        */
      def this(
        oRootControl: typingsSlinky.openui5.sap.ui.core.Control,
      ...
      def this(
        oRootControl: typingsSlinky.openui5.sap.ui.core.UIArea,
        serializeDelegate: js.Any,
        bSkipRoot: Boolean,
        fnSkipAggregations: js.Any,
        fnSkipElement: js.Any
    ...
    class ViewSerializer protected ()
      extends typingsSlinky.openui5.sap.ui.core.util.serializer.ViewSerializer {
      /**
        ...
        */
      def this(oRootControl: typingsSlinky.openui5.sap.ui.core.Control) = this()
      def this(oRootControl: typingsSlinky.openui5.sap.ui.core.UIArea) = this()
      def this(oRootControl: typingsSlinky.openui5.sap.ui.core.Control, oWindow: js.Any) = this()
      def this(oRootControl: typingsSlinky.openui5.sap.ui.core.UIArea, oWindow: js.Any) = this()
      def this(
        oRootControl: typingsSlinky.openui5.sap.ui.core.Control,
    ...
    class XMLViewSerializer protected ()
      extends typingsSlinky.openui5.sap.ui.core.util.serializer.XMLViewSerializer {
      /**
    ...
    object delegate {
      ...
      abstract class Delegate ()
        extends typingsSlinky.openui5.sap.ui.core.util.serializer.delegate.Delegate
      
      @JSGlobal("sap.ui.core.util.serializer.delegate.HTML")
      @js.native
      class HTML protected ()
        extends typingsSlinky.openui5.sap.ui.core.util.serializer.delegate.HTML {
        /**
      ...
      @js.native
      class XML protected ()
        extends typingsSlinky.openui5.sap.ui.core.util.serializer.delegate.XML {
        /**
