...
object tmpl {
  ...
  class DOMAttribute protected ()
    extends typingsSlinky.openui5.sap.ui.core.tmpl.DOMAttribute {
    /**
  ...
  class DOMElement protected ()
    extends typingsSlinky.openui5.sap.ui.core.tmpl.DOMElement {
    /**
  ...
  abstract class HandlebarsTemplate protected ()
    extends typingsSlinky.openui5.sap.ui.core.tmpl.HandlebarsTemplate {
    /**
  ...
  abstract class Template protected ()
    extends typingsSlinky.openui5.sap.ui.core.tmpl.Template {
    /**
  ...
  class TemplateControl protected ()
    extends typingsSlinky.openui5.sap.ui.core.tmpl.TemplateControl {
    /**
