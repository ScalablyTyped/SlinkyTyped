...
class Parameterization protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def findParameterByName(sName: String): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Parameter = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getEntitySet(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.EntitySet = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getNavigationPropertyToQueryResult(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.QueryResult = js.native
}
