package typingsSlinky.openui5.global.sap.ui.test
...
@js.native
class OpaPlugin ()
  extends typingsSlinky.openui5.sap.ui.test.OpaPlugin {
  /**
    ...
    */
  /* CompleteClass */
  override def getAllControls(fnConstructorType: js.Any): js.Array[_] = js.native
  /**
