...
object unified {
  ...
  class CalendarAppointment protected ()
    extends typingsSlinky.openui5.sap.ui.unified.CalendarAppointment {
    /**
  ...
  class CalendarDateInterval protected ()
    extends typingsSlinky.openui5.sap.ui.unified.CalendarDateInterval {
    /**
  ...
  object CalendarIntervalType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.openui5.sap.ui.unified.CalendarIntervalType with Double] = js.native
    
    /* 0 */ val Day: typingsSlinky.openui5.sap.ui.unified.CalendarIntervalType.Day with Double = js.native
    
    /* 1 */ val Hour: typingsSlinky.openui5.sap.ui.unified.CalendarIntervalType.Hour with Double = js.native
    
    /* 2 */ val Month: typingsSlinky.openui5.sap.ui.unified.CalendarIntervalType.Month with Double = js.native
  }
  
  @JSGlobal("sap.ui.unified.CalendarLegend")
  @js.native
  class CalendarLegend protected ()
    extends typingsSlinky.openui5.sap.ui.unified.CalendarLegend {
    /**
  ...
  class CalendarLegendItem protected ()
    extends typingsSlinky.openui5.sap.ui.unified.CalendarLegendItem {
    /**
  ...
  class CalendarMonthInterval protected ()
    extends typingsSlinky.openui5.sap.ui.unified.CalendarMonthInterval {
    /**
  ...
  class CalendarTimeInterval protected ()
    extends typingsSlinky.openui5.sap.ui.unified.CalendarTimeInterval {
    /**
  ...
  class Calendar_ protected ()
    extends typingsSlinky.openui5.sap.ui.unified.Calendar_ {
    /**
  ...
  class Currency protected ()
    extends typingsSlinky.openui5.sap.ui.unified.Currency {
    /**
  ...
  class DateTypeRange protected ()
    extends typingsSlinky.openui5.sap.ui.unified.DateTypeRange {
    /**
  ...
  /**
    ...
    */
  class FileUploader ()
    extends typingsSlinky.openui5.sap.ui.unified.FileUploader {
  ...
  class FileUploaderParameter ()
    extends typingsSlinky.openui5.sap.ui.unified.FileUploaderParameter {
    def this(mSettings: js.Any) = this()
    /**
      * Constructor for a new FileUploaderParameter.Accepts an object literal <code>mSettings</code> that
      * defines initialproperty values, aggregated and associated objects as well as event handlers.See
  ...
  class Menu protected ()
    extends typingsSlinky.openui5.sap.ui.unified.Menu {
    /**
  ...
  class MenuItem protected ()
    extends typingsSlinky.openui5.sap.ui.unified.MenuItem {
    /**
  ...
  class MenuTextFieldItem protected ()
    extends typingsSlinky.openui5.sap.ui.unified.MenuTextFieldItem {
    /**
  ...
  class ShellLayout protected ()
    extends typingsSlinky.openui5.sap.ui.unified.ShellLayout {
    /**
  ...
  class ShellOverlay protected ()
    extends typingsSlinky.openui5.sap.ui.unified.ShellOverlay {
    /**
  ...
  class SplitContainer protected ()
    extends typingsSlinky.openui5.sap.ui.unified.SplitContainer {
    /**
