...
object v2 extends js.Object {
  ...
  class ODataAnnotations ()
    extends typingsSlinky.openui5.sap.ui.model.odata.v2.ODataAnnotations
  
  @js.native
  abstract class ODataContextBinding protected ()
    extends typingsSlinky.openui5.sap.ui.model.odata.v2.ODataContextBinding {
    /**
  ...
  class ODataListBinding protected ()
    extends typingsSlinky.openui5.sap.ui.model.odata.v2.ODataListBinding {
  ...
  class ODataModel protected ()
    extends typingsSlinky.openui5.sap.ui.model.odata.v2.ODataModel {
    /**
  ...
  class ODataTreeBinding protected ()
    extends typingsSlinky.openui5.sap.ui.model.odata.v2.ODataTreeBinding {
    def this(oModel: Model, sPath: String, oContext: Context) = this()
    def this(
      oModel: Model,
      sPath: String,
  ...
  object ODataAnnotations extends js.Object {
    ...
    class constructor protected ()
      extends typingsSlinky.openui5.sap.ui.model.odata.v2.ODataAnnotations.constructor {
      /**
        ...
        */
      def this(oMetadata: typingsSlinky.openui5.sap.ui.model.odata.ODataMetadata, mOptions: js.Any) = this()
    }
