...
object form extends js.Object {
  ...
  class FormContainer protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.FormContainer {
    /**
  ...
  class FormElement protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.FormElement {
    /**
  ...
  class FormLayout protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.FormLayout {
    /**
  ...
  class GridContainerData protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.GridContainerData {
    /**
  ...
  class GridElementData protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.GridElementData {
    /**
  ...
  class GridLayout protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.GridLayout {
    /**
  ...
  class ResponsiveGridLayout protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.ResponsiveGridLayout {
    /**
  ...
  class ResponsiveLayout protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.ResponsiveLayout {
    /**
  ...
  class SimpleForm protected ()
    extends typingsSlinky.openui5.sap.ui.layout.form.SimpleForm {
    /**
