...
class UIArea protected ()
  extends typingsSlinky.openui5.sap.ui.core.UIArea {
  /**
    ...
    */
  def this(oCore: typingsSlinky.openui5.sap.ui.core.Core) = this()
  def this(oCore: typingsSlinky.openui5.sap.ui.core.Core, oRootNode: js.Any) = this()
}
