...
object routing extends js.Object {
  ...
  class RouteMatchedHandler protected ()
    extends typingsSlinky.openui5.sap.m.routing.RouteMatchedHandler {
    /**
  ...
  class Router protected ()
    extends typingsSlinky.openui5.sap.m.routing.Router {
    /**
  ...
  class TargetHandler protected ()
    extends typingsSlinky.openui5.sap.m.routing.TargetHandler {
    /**
  ...
  class Targets protected ()
    extends typingsSlinky.openui5.sap.m.routing.Targets {
    /**
