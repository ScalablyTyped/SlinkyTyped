package typingsSlinky.openui5.global.sap.ui.unified
...
object calendar extends js.Object {
  ...
  class DatesRow protected ()
    extends typingsSlinky.openui5.sap.ui.unified.calendar.DatesRow {
    /**
  ...
  class Header protected ()
    extends typingsSlinky.openui5.sap.ui.unified.calendar.Header {
    /**
  ...
  class Month protected ()
    extends typingsSlinky.openui5.sap.ui.unified.calendar.Month {
    /**
  ...
  class MonthPicker protected ()
    extends typingsSlinky.openui5.sap.ui.unified.calendar.MonthPicker {
    /**
  ...
  class MonthsRow protected ()
    extends typingsSlinky.openui5.sap.ui.unified.calendar.MonthsRow {
    /**
  ...
  @js.native
  class TimesRow protected ()
    extends typingsSlinky.openui5.sap.ui.unified.calendar.TimesRow {
    /**
  ...
  class YearPicker protected ()
    extends typingsSlinky.openui5.sap.ui.unified.calendar.YearPicker {
    /**
