...
package object core {
  ...
  /**
    ...
    */
  @scala.inline
  def CustomStyleClassSupport(): scala.Unit = typingsSlinky.openui5.global.sap.ui.core.^.asInstanceOf[js.Dynamic].applyDynamic("CustomStyleClassSupport")().asInstanceOf[scala.Unit]
}
