...
class Popup protected ()
  extends typingsSlinky.openui5.sap.ui.core.Popup {
  ...
  /**
    ...
    */
  def this(oContent: typingsSlinky.openui5.sap.ui.core.Control) = this()
  def this(oContent: typingsSlinky.openui5.sap.ui.core.Element) = this()
  def this(oContent: js.Any, bModal: Boolean) = this()
  def this(oContent: typingsSlinky.openui5.sap.ui.core.Control, bModal: Boolean) = this()
  def this(oContent: typingsSlinky.openui5.sap.ui.core.Element, bModal: Boolean) = this()
  ...
  def this(
    oContent: typingsSlinky.openui5.sap.ui.core.Control,
    bModal: js.UndefOr[scala.Nothing],
    bShadow: Boolean
  ) = this()
  def this(oContent: typingsSlinky.openui5.sap.ui.core.Control, bModal: Boolean, bShadow: Boolean) = this()
  def this(
    oContent: typingsSlinky.openui5.sap.ui.core.Element,
    bModal: js.UndefOr[scala.Nothing],
    bShadow: Boolean
  ) = this()
  def this(oContent: typingsSlinky.openui5.sap.ui.core.Element, bModal: Boolean, bShadow: Boolean) = this()
  def this(
    oContent: js.Any,
    bModal: js.UndefOr[scala.Nothing],
