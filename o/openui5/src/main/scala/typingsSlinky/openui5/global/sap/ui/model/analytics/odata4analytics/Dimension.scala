...
class Dimension protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def findAttributeByName(sName: String): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Dimension = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getContainingQueryResult(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.QueryResult = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getMasterDataEntitySet(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.EntitySet = js.native
  /**
