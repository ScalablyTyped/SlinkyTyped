...
object test {
  ...
  @js.native
  class Opa protected ()
    extends typingsSlinky.openui5.sap.ui.test.Opa {
    /**
  ...
  class PageObjectFactory ()
    extends typingsSlinky.openui5.sap.ui.test.PageObjectFactory
  ...
  object actions {
    ...
    abstract class Action ()
      extends typingsSlinky.openui5.sap.ui.test.actions.Action
    ...
    /**
      ...
      */
    class EnterText ()
      extends typingsSlinky.openui5.sap.ui.test.actions.EnterText
    ...
    /**
      ...
      */
    class Press ()
      extends typingsSlinky.openui5.sap.ui.test.actions.Press
  }
  ...
  object matchers {
    ...
    class AggregationContainsPropertyEqual protected ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.AggregationContainsPropertyEqual {
      /**
    ...
    class AggregationFilled protected ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.AggregationFilled {
      /**
    ...
    class AggregationLengthEquals protected ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.AggregationLengthEquals {
      /**
    ...
    class Ancestor protected ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.Ancestor {
    ...
    class BindingPath protected ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.BindingPath {
      /**
    ...
    @js.native
    class Interactable ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.Interactable
    
    @JSGlobal("sap.ui.test.matchers.Matcher")
    @js.native
    abstract class Matcher ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.Matcher
    
    @JSGlobal("sap.ui.test.matchers.Properties")
    @js.native
    class Properties protected ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.Properties {
    ...
    class PropertyStrictEquals protected ()
      extends typingsSlinky.openui5.sap.ui.test.matchers.PropertyStrictEquals {
      /**
