...
class QueryResult protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def findDimensionByName(sName: String): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Dimension = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findDimensionByPropertyName(sName: String): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Dimension = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findMeasureByName(sName: String): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Measure = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findMeasureByPropertyName(sName: String): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Measure = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getParameterization(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Parameterization = js.native
  /**
