...
@js.native
class TreeBinding protected ()
  extends typingsSlinky.openui5.sap.ui.model.TreeBinding {
  /**
    ...
    */
  def this(oModel: typingsSlinky.openui5.sap.ui.model.Model, sPath: String) = this()
