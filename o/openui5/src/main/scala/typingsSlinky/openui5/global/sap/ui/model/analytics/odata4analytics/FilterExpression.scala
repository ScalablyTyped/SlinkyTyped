...
class FilterExpression protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addCondition(sPropertyName: String, sOperator: TypeofFilterOperator, oValue: js.Any, oValue2: js.Any): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.FilterExpression = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addSetCondition(sPropertyName: String, aValues: js.Array[_]): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.FilterExpression = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addUI5FilterConditions(aUI5Filter: js.Array[Filter]): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.FilterExpression = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getEntityType(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.EntityType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeConditions(sPropertyName: String): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.FilterExpression = js.native
}
