...
object IconPool {
  ...
  @js.native
  def createControlByURI(setting: String, constructor: js.Any): typingsSlinky.openui5.sap.ui.core.Control = js.native
  @JSGlobal("sap.ui.core.IconPool.createControlByURI")
  @js.native
  def createControlByURI(setting: js.Any, constructor: js.Any): typingsSlinky.openui5.sap.ui.core.Control = js.native
