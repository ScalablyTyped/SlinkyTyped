...
class Parameter protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getContainingParameterization(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Parameterization = js.native
  /**
    * Get label
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getPeerIntervalBoundaryParameter(): typingsSlinky.openui5.sap.ui.model.analytics.odata4analytics.Parameter = js.native
  /**
    * Get property
    */
  /* CompleteClass */
