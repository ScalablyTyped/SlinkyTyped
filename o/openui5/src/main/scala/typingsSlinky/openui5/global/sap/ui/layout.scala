...
object layout {
  ...
  object BackgroundDesign extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.openui5.sap.ui.layout.BackgroundDesign with Double] = js.native
  ...
  class BlockLayoutRow protected ()
    extends typingsSlinky.openui5.sap.ui.layout.BlockLayoutRow {
    /**
  ...
  class FixFlex protected ()
    extends typingsSlinky.openui5.sap.ui.layout.FixFlex {
    /**
  ...
  object GridPosition extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.openui5.sap.ui.layout.GridPosition with Double] = js.native
  ...
  class PaneContainer protected ()
    extends typingsSlinky.openui5.sap.ui.layout.PaneContainer {
    /**
  ...
  class ResponsiveFlowLayout protected ()
    extends typingsSlinky.openui5.sap.ui.layout.ResponsiveFlowLayout {
    /**
  ...
  class VerticalLayout protected ()
    extends typingsSlinky.openui5.sap.ui.layout.VerticalLayout {
    /**
