...
object BindingMode {
  ...
  @scala.inline
  def OneTime_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OneTime")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def OneWay_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OneWay")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def TwoWay_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TwoWay")(x.asInstanceOf[js.Any])
}
