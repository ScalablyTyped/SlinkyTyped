...
package object model {
  ...
  /**
    ...
    */
  @scala.inline
  def FormatException(): scala.Unit = typingsSlinky.openui5.global.sap.ui.model.^.asInstanceOf[js.Dynamic].applyDynamic("FormatException")().asInstanceOf[scala.Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def ParseException(): scala.Unit = typingsSlinky.openui5.global.sap.ui.model.^.asInstanceOf[js.Dynamic].applyDynamic("ParseException")().asInstanceOf[scala.Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def ValidateException(): scala.Unit = typingsSlinky.openui5.global.sap.ui.model.^.asInstanceOf[js.Dynamic].applyDynamic("ValidateException")().asInstanceOf[scala.Unit]
}
