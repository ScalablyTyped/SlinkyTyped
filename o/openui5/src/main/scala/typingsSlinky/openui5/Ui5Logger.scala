...
trait Ui5Logger extends StObject {
  ...
  def debug(sMessage: String, sDetails: js.UndefOr[scala.Nothing], sComponent: String): Unit = js.native
  ...
  def error(sMessage: String, sDetails: js.UndefOr[scala.Nothing], sComponent: String): Unit = js.native
  ...
  def fatal(sMessage: String, sDetails: js.UndefOr[scala.Nothing], sComponent: String): Unit = js.native
  ...
  def info(sMessage: String, sDetails: js.UndefOr[scala.Nothing], sComponent: String): Unit = js.native
  ...
  def isLoggable(iLevel: js.UndefOr[scala.Nothing], sComponent: String): Unit = js.native
  ...
  def trace(sMessage: String, sDetails: js.UndefOr[scala.Nothing], sComponent: String): Unit = js.native
  ...
  def warning(sMessage: String, sDetails: js.UndefOr[scala.Nothing], sComponent: String): Unit = js.native
