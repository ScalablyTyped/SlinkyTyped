package typingsSlinky.ono.anon
...
object Message {
  @scala.inline
  def apply[E, P](message: String): Message[E, P] = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[Message[E, P]]
  }
  @scala.inline
  implicit class MessageOps[Self[e, p] <: Message[e, p], E, P] (val x: Self[E, P]) extends AnyVal {
    @scala.inline
