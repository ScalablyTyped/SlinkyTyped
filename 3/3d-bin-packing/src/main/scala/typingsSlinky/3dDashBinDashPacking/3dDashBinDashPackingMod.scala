...
import typingsSlinky.`3dDashBinDashPacking`.bws.packer.Instance
...
@js.native
object `3dDashBinDashPackingMod` extends js.Object {
  @js.native
  class GAWrapperArray protected ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.GAWrapperArray {
    /**
      * @brief Copy Constructor.
      */
    def this(genes: typingsSlinky.`3dDashBinDashPacking`.bws.packer.GAWrapperArray) = this()
    /**
      * Construct from instances.
      *
      * @param instanceArray Instances to be wrapped.
      */
    def this(instanceArray: typingsSlinky.`3dDashBinDashPacking`.bws.packer.InstanceArray) = this()
  }
  ...
  /**
    ...
    */
  class InstanceArray ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.InstanceArray
  ...
  /**
    ...
    */
  class InstanceForm ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.InstanceForm {
  ...
  class InstanceFormArray ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.InstanceFormArray
  ...
  /**
    ...
    */
  class Packer ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.Packer {
    /**
      ...
      */
    def this(
      wrapperArray: typingsSlinky.`3dDashBinDashPacking`.bws.packer.WrapperArray,
      instanceArray: typingsSlinky.`3dDashBinDashPacking`.bws.packer.InstanceArray
    ) = this()
  }
  ...
  /**
    ...
    */
  class PackerForm ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.PackerForm {
    /**
      ...
      */
    def this(
      instanceFormArray: typingsSlinky.`3dDashBinDashPacking`.bws.packer.InstanceFormArray,
      wrapperArray: typingsSlinky.`3dDashBinDashPacking`.bws.packer.WrapperArray
    ) = this()
  }
  ...
  /**
    ...
    */
  class Product ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.Product {
    /**
      * Construct from members.
      *
  ...
  class Wrap protected ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.Wrap {
    /**
      * Construct from a Wrapper.
      *
      * @param wrapper A wrapper who will contain an instance.
      */
    def this(wrapper: typingsSlinky.`3dDashBinDashPacking`.bws.packer.Wrapper) = this()
    /**
      ...
      */
    def this(
      wrapper: typingsSlinky.`3dDashBinDashPacking`.bws.packer.Wrapper,
      instance: Instance,
      x: Double,
      y: Double,
      z: Double
  ...
  /**
    ...
    */
  class Wrapper ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.Wrapper {
    /**
      * Copy Constructor.
      */
    def this(wrapper: typingsSlinky.`3dDashBinDashPacking`.bws.packer.Wrapper) = this()
  ...
  /**
    ...
    */
  class WrapperArray ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.WrapperArray
  ...
  /**
    ...
    */
  class WrapperGroup ()
    extends typingsSlinky.`3dDashBinDashPacking`.bws.packer.WrapperGroup {
    /**
      * Construct from a sample.
      *
      * @param sample A sample, standard of the WrapperGroup.
      */
    def this(sample: typingsSlinky.`3dDashBinDashPacking`.bws.packer.Wrapper) = this()
    /**
      * Copy Constructor.
      */
    def this(wrapperGroup: typingsSlinky.`3dDashBinDashPacking`.bws.packer.WrapperGroup) = this()
    /**
