...
object IRange {
  ...
  implicit class IRangeOps[Self <: IRange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQMaxInclEq(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qMaxInclEq")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withQMinInclEq(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qMinInclEq")(value.asInstanceOf[js.Any])
        ret
    }
  }
