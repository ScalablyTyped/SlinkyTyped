...
import typingsSlinky.qlikDashVisualizationextensions.qlikDashVisualizationextensionsStrings.changed
import typingsSlinky.qlikDashVisualizationextensions.qlikDashVisualizationextensionsStrings.closed
