package typingsSlinky.qlikDashVisualizationextensions.RootAPI

import typingsSlinky.angular.angularMod.IPromise
import typingsSlinky.qlikDashVisualizationextensions.AppAPI.IApp
import typingsSlinky.qlikDashVisualizationextensions.NavigationAPI.INavigation
import typingsSlinky.qlikDashVisualizationextensions.TableAPI.IQTable
