package typingsSlinky.qlikDashVisualizationextensions.ExtensionAPI

import typingsSlinky.qlikDashVisualizationextensions.qlikDashVisualizationextensionsStrings.radiobuttons
