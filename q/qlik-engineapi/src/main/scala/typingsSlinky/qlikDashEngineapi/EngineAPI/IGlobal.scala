...
import typingsSlinky.qlikDashEngineapi.Anon_QBnfDefs
import typingsSlinky.qlikDashEngineapi.Anon_QBnfHash
import typingsSlinky.qlikDashEngineapi.Anon_QFolder
import typingsSlinky.qlikDashEngineapi.enigmaJS.IGeneratedAPI
...
trait IGlobal extends IGeneratedAPI {
  ...
  /**
    ...
    */
  def getBaseBNFHash(qBnfType: BnfType): js.Promise[Anon_QBnfHash] = js.native
  /**
    ...
    */
  def getBaseBNFString(qBnfType: BnfType): js.Promise[Anon_QBnfDefs] = js.native
  /**
    * Get a Config Object
  ...
  /**
    ...
    */
  def getMyDocumentsFolder(): js.Promise[Anon_QFolder] = js.native
  /**
