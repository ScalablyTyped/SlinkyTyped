...
object NxHypercubeMode {
  @scala.inline
  def K: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.K = this.cast("K")
  @scala.inline
  def P: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.P = this.cast("P")
  @scala.inline
  def S: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.S = this.cast("S")
  @scala.inline
