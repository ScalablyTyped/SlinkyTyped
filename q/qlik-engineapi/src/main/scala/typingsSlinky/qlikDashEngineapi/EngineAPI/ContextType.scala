...
object ContextType {
  @scala.inline
  def Cleared: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.Cleared = this.cast("Cleared")
  @scala.inline
  def CurrentSelections: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.CurrentSelections = this.cast("CurrentSelections")
  @scala.inline
  def LockedFieldsOnly: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.LockedFieldsOnly = this.cast("LockedFieldsOnly")
  @scala.inline
