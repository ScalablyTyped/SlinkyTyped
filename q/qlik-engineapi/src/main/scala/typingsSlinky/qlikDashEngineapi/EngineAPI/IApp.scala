...
import typingsSlinky.qlikDashEngineapi.Anon_QBookmarkId
import typingsSlinky.qlikDashEngineapi.Anon_QDownloadInfo
import typingsSlinky.qlikDashEngineapi.Anon_QFields
import typingsSlinky.qlikDashEngineapi.Anon_QFormatSpec
import typingsSlinky.qlikDashEngineapi.Anon_QLineage
import typingsSlinky.qlikDashEngineapi.Anon_QName
import typingsSlinky.qlikDashEngineapi.Anon_Qk
import typingsSlinky.qlikDashEngineapi.enigmaJS.IGeneratedAPI
import typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.SlashqListObjectDef
