...
object InteractionType {
  @scala.inline
  def IT_BREAK: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.IT_BREAK = this.cast("IT_BREAK")
  @scala.inline
  def IT_END: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.IT_END = this.cast("IT_END")
  @scala.inline
  def IT_MSGBOX: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.IT_MSGBOX = this.cast("IT_MSGBOX")
  @scala.inline
  def IT_SCRIPTLINE: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.IT_SCRIPTLINE = this.cast("IT_SCRIPTLINE")
  @scala.inline
