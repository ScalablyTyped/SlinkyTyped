...
object MachineModeType {
  @scala.inline
  def CONNECT_32: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.CONNECT_32 = this.cast("CONNECT_32")
  @scala.inline
  def CONNECT_64: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.CONNECT_64 = this.cast("CONNECT_64")
  @scala.inline
  def CONNECT_DEFAULT: typingsSlinky.qlikDashEngineapi.qlikDashEngineapiStrings.CONNECT_DEFAULT = this.cast("CONNECT_DEFAULT")
  @scala.inline
