...
object IConnection {
  ...
  implicit class IConnectionOps[Self <: IConnection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQConnectionString(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qConnectionString")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withQLogOn(value: LogonType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qLogOn")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withQModifiedDate(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qModifiedDate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withQPassword(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qPassword")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutQPassword: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qPassword")(js.undefined)
        ret
    }
    @scala.inline
    def withQUserName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qUserName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutQUserName: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qUserName")(js.undefined)
        ret
    }
  }
