...
object InteractionType {
  @scala.inline
  def IT_BREAK: typingsSlinky.qlikEngineapi.qlikEngineapiStrings.IT_BREAK = this.cast("IT_BREAK")
  @scala.inline
  def IT_END: typingsSlinky.qlikEngineapi.qlikEngineapiStrings.IT_END = this.cast("IT_END")
  @scala.inline
  def IT_MSGBOX: typingsSlinky.qlikEngineapi.qlikEngineapiStrings.IT_MSGBOX = this.cast("IT_MSGBOX")
  @scala.inline
  def IT_SCRIPTLINE: typingsSlinky.qlikEngineapi.qlikEngineapiStrings.IT_SCRIPTLINE = this.cast("IT_SCRIPTLINE")
  @scala.inline
