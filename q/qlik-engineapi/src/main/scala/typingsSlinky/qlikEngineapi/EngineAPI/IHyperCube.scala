...
object IHyperCube {
  ...
  implicit class IHyperCubeOps[Self <: IHyperCube] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQDimensionInfo(value: js.Array[INxDimensionInfo]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withQGrandTotalRow(value: js.Array[INxCell]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withQMeasureInfo(value: js.Array[INxMeasureInfo]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withQPivotDataPages(value: js.Array[INxPivotPage]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withQStackedDataPages(value: js.Array[INxStackPage]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withQLastExpandedPos(value: INxCellPosition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qLastExpandedPos")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutQLastExpandedPos: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qLastExpandedPos")(js.undefined)
        ret
    }
  }
