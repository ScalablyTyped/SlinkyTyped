...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.OTHER_OFF
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.OTHER_COUNTED
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.OTHER_ABS_LIMITED
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.OTHER_ABS_ACC_TARGET
