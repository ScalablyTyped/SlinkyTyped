...
object INxDerivedFieldDescriptionList {
  ...
  implicit class INxDerivedFieldDescriptionListOps[Self <: INxDerivedFieldDescriptionList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQDerivedFieldLists(value: js.Array[INxDerivedFieldsData]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qDerivedFieldLists")(value.asInstanceOf[js.Any])
        ret
    }
  }
