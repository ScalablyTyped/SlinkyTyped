...
object ITextMacro {
  ...
  implicit class ITextMacroOps[Self <: ITextMacro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQDisplayString(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qDisplayString")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withQRefSeqNo(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qRefSeqNo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withQSetSeqNo(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qSetSeqNo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withQTag(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qTag")(value.asInstanceOf[js.Any])
        ret
    }
  }
