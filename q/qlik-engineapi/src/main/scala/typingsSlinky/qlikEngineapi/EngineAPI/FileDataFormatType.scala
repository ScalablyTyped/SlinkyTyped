...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.CSV
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.FIX
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.DIF
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.EXCEL_BIFF
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.EXCEL_OOXML
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.HTML
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.XML
  - typingsSlinky.qlikEngineapi.qlikEngineapiStrings.QVX
