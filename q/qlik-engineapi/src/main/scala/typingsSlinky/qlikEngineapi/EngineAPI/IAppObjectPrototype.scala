...
object IAppObjectPrototype {
  @scala.inline
  def apply[/* <: typingsSlinky.qlikEngineapi.EngineAPI.IGenericObjectProperties */ P, /* <: typingsSlinky.qlikEngineapi.EngineAPI.IGenericObject */ O](createObject: P => js.Promise[O], createSessionObject: P => js.Promise[O]): IAppObjectPrototype[P, O] = {
  ...
  @scala.inline
  implicit class IAppObjectPrototypeOps[Self <: IAppObjectPrototype[_, _], /* <: typingsSlinky.qlikEngineapi.EngineAPI.IGenericObjectProperties */ P, /* <: typingsSlinky.qlikEngineapi.EngineAPI.IGenericObject */ O] (val x: Self with (IAppObjectPrototype[P, O])) extends AnyVal {
    @scala.inline
