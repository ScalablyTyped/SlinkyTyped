...
object QTip2 {
  ...
  object Content {
    ...
    implicit class ContentMutableBuilder[Self <: Content] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTitle(value: Title | typingsSlinky.qtip2.anon.Text): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
  ...
  trait Plugin extends StObject {
    ...
    def apply(methodName: option, propertyName: contentDottitle, value: typingsSlinky.qtip2.anon.Text): Api = js.native
