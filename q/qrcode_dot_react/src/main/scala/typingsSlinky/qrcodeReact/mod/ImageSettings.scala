...
object ImageSettings {
  ...
  implicit class ImageSettingsOps[Self <: ImageSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExcavate(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("excavate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutExcavate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("excavate")(js.undefined)
        ret
    }
    @scala.inline
