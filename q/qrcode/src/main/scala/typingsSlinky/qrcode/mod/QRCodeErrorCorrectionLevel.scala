...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.qrcode.qrcodeStrings.low
  - typingsSlinky.qrcode.qrcodeStrings.medium
  - typingsSlinky.qrcode.qrcodeStrings.quartile
  - typingsSlinky.qrcode.qrcodeStrings.high
  - typingsSlinky.qrcode.qrcodeStrings.L
  - typingsSlinky.qrcode.qrcodeStrings.M
  - typingsSlinky.qrcode.qrcodeStrings.Q
  - typingsSlinky.qrcode.qrcodeStrings.H
*/
