...
import typingsSlinky.quill.anon.Html
...
object mod {
  ...
  object QuillOptionsStatic {
    ...
    implicit class QuillOptionsStaticMutableBuilder[Self <: QuillOptionsStatic] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScrollingContainerHTMLElement(value: HTMLElement): Self = StObject.set(x, "scrollingContainer", value.asInstanceOf[js.Any])
