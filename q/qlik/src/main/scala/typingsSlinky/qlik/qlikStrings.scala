...
import typingsSlinky.qlik.mod.LanguageCodes.BrazilianPortuguese
import typingsSlinky.qlik.mod.LanguageCodes.Dutch
import typingsSlinky.qlik.mod.LanguageCodes.English
import typingsSlinky.qlik.mod.LanguageCodes.French
import typingsSlinky.qlik.mod.LanguageCodes.German
import typingsSlinky.qlik.mod.LanguageCodes.Italian
import typingsSlinky.qlik.mod.LanguageCodes.Japanese
import typingsSlinky.qlik.mod.LanguageCodes.Korean
import typingsSlinky.qlik.mod.LanguageCodes.Polish
import typingsSlinky.qlik.mod.LanguageCodes.Russian
import typingsSlinky.qlik.mod.LanguageCodes.Spanish
import typingsSlinky.qlik.mod.LanguageCodes.Swedish
import typingsSlinky.qlik.mod.LanguageCodes.Turkish
import typingsSlinky.qlik.mod.ListTypes
...
object qlikStrings {
  ...
  @js.native
  sealed trait CSV_C extends StObject
  @scala.inline
  def CSV_C: CSV_C = "CSV_C".asInstanceOf[CSV_C]
  
  @js.native
  sealed trait CSV_T extends StObject
  @scala.inline
  def CSV_T: CSV_T = "CSV_T".asInstanceOf[CSV_T]
  
  @js.native
  sealed trait CurrentSelections extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait IV extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait StringExpr extends StObject
  @scala.inline
  def StringExpr: StringExpr = "StringExpr".asInstanceOf[StringExpr]
  
  @js.native
  sealed trait StringExpression extends StObject
  @scala.inline
  def StringExpression: StringExpression = "StringExpression".asInstanceOf[StringExpression]
  ...
  @js.native
  sealed trait TOTAL_EXPR extends StObject
  @scala.inline
  def TOTAL_EXPR: TOTAL_EXPR = "TOTAL_EXPR".asInstanceOf[TOTAL_EXPR]
  
  @js.native
  sealed trait TOTAL_OFF extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait ValueExpr extends StObject
  @scala.inline
  def ValueExpr: ValueExpr = "ValueExpr".asInstanceOf[ValueExpr]
  
  @js.native
  sealed trait ValueExpression extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait accordion extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait buttongroup extends StObject
  @scala.inline
  def buttongroup: buttongroup = "buttongroup".asInstanceOf[buttongroup]
  
  @js.native
  sealed trait `color-picker` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait dimensions extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait radiobuttons extends StObject
  @scala.inline
