...
object mod {
  ...
  @JSImport("qs", "parse")
  @js.native
  def parse_ParsedQs(str: String): ParsedQs = js.native
  ...
  object IStringifyOptions {
    ...
    implicit class IStringifyOptionsMutableBuilder[Self <: IStringifyOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSerializeDate(value: /* d */ js.Date => String): Self = StObject.set(x, "serializeDate", js.Any.fromFunction1(value))
