package typingsSlinky.qunitDashDom.distHelpersTestDashAssertionsMod
...
trait TestAssertions extends js.Object {
  ...
  def dom(target: js.Any, rootElement: js.Any): typingsSlinky.qunitDashDom.distAssertionsMod.default
...
object TestAssertions {
  @scala.inline
  def apply(
    dom: (js.Any, js.Any) => typingsSlinky.qunitDashDom.distAssertionsMod.default,
