...
import typingsSlinky.quicksettings.quicksettingsBooleans.`false`
import typingsSlinky.quicksettings.quicksettingsBooleans.`true`
import typingsSlinky.quicksettings.quicksettingsStrings.numbers
import typingsSlinky.quicksettings.quicksettingsStrings.percent
