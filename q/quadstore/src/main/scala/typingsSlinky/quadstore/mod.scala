package typingsSlinky.quadstore
...
import typingsSlinky.quadstore.anon.ContextKey
import typingsSlinky.quadstore.anon.`0`
...
object mod {
  ...
  class ^[CK /* <: String */, TermType, Q] protected ()
    extends typingsSlinky.quadstore.mod.quadstore[CK, TermType, Q] {
  ...
  val QuadStore_ : Instantiable2[
    ...
    typingsSlinky.quadstore.mod.quadstore[String, js.Object, js.Object]
  ] = js.native
  
  @JSImport("quadstore", "RdfStore")
  @js.native
  class RdfStore[Q /* <: BaseQuad */] protected ()
    extends typingsSlinky.quadstore.mod.quadstore[graph, Q, Term] {
  ...
  type Quad[TermType, CK /* <: String */] = Triple[TermType] with typingsSlinky.quadstore.quadstoreStrings.Quad with TopLevel[js.Any]
