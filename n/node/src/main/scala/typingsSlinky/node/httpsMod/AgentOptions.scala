...
object AgentOptions {
  ...
  implicit class AgentOptionsOps[Self <: AgentOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxCachedSessions(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxCachedSessions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMaxCachedSessions: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxCachedSessions")(js.undefined)
        ret
    }
    @scala.inline
