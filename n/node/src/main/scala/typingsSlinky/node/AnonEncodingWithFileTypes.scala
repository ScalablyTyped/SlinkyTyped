...
object AnonEncodingWithFileTypes {
  @scala.inline
  def apply(encoding: buffer_): AnonEncodingWithFileTypes = {
    val __obj = js.Dynamic.literal(encoding = encoding.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonEncodingWithFileTypes]
  }
  @scala.inline
  implicit class AnonEncodingWithFileTypesOps[Self <: AnonEncodingWithFileTypes] (val x: Self) extends AnyVal {
    @scala.inline
