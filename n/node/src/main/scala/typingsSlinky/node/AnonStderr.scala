...
trait AnonStderr extends js.Object {
  var stderr: java.lang.String = js.native
  var stdout: java.lang.String = js.native
}
...
object AnonStderr {
  ...
  implicit class AnonStderrOps[Self <: AnonStderr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStderr(value: java.lang.String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stderr")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStdout(value: java.lang.String): Self = {
        val ret = this.duplicate
