...
trait TypeofosConstantsPRIORITYABOVENORMAL extends js.Object {
...
object TypeofosConstantsPRIORITYABOVENORMAL {
  @scala.inline
  def apply(
  ...
  ): TypeofosConstantsPRIORITYABOVENORMAL = {
    ...
    __obj.asInstanceOf[TypeofosConstantsPRIORITYABOVENORMAL]
  }
}
