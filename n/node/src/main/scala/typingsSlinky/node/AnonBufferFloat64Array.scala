...
object AnonBufferFloat64Array {
  @scala.inline
  def apply(buffer: js.typedarray.Float64Array, bytesWritten: Double): AnonBufferFloat64Array = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferFloat64Array]
  }
  @scala.inline
  implicit class AnonBufferFloat64ArrayOps[Self <: AnonBufferFloat64Array] (val x: Self) extends AnyVal {
    @scala.inline
