...
object netMod {
  ...
  */
  ...
  object NetConnectOpts {
    ...
    @scala.inline
    def IpcNetConnectOpts(path: java.lang.String): typingsSlinky.node.netMod.IpcNetConnectOpts = {
      val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.node.netMod.IpcNetConnectOpts]
    }
    
    @scala.inline
    def TcpNetConnectOpts(port: Double): typingsSlinky.node.netMod.TcpNetConnectOpts = {
      val __obj = js.Dynamic.literal(port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.node.netMod.TcpNetConnectOpts]
    }
  }
  ...
  */
  ...
  object SocketConnectOpts {
    ...
    @scala.inline
    def IpcSocketConnectOpts(path: java.lang.String): typingsSlinky.node.netMod.IpcSocketConnectOpts = {
      val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.node.netMod.IpcSocketConnectOpts]
    }
    
    @scala.inline
    def TcpSocketConnectOpts(port: Double): typingsSlinky.node.netMod.TcpSocketConnectOpts = {
      val __obj = js.Dynamic.literal(port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.node.netMod.TcpSocketConnectOpts]
    }
  }
