...
object AnonBufferInt8ArrayBytesReadNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Int8Array, bytesRead: Double): AnonBufferInt8ArrayBytesReadNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferInt8ArrayBytesReadNumber]
  }
  @scala.inline
  implicit class AnonBufferInt8ArrayBytesReadNumberOps[Self <: AnonBufferInt8ArrayBytesReadNumber] (val x: Self) extends AnyVal {
    @scala.inline
