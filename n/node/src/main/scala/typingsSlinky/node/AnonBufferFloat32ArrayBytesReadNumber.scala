...
object AnonBufferFloat32ArrayBytesReadNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Float32Array, bytesRead: Double): AnonBufferFloat32ArrayBytesReadNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferFloat32ArrayBytesReadNumber]
  }
  @scala.inline
  implicit class AnonBufferFloat32ArrayBytesReadNumberOps[Self <: AnonBufferFloat32ArrayBytesReadNumber] (val x: Self) extends AnyVal {
    @scala.inline
