...
object PrivateKeyBuffer {
  ...
  implicit class PrivateKeyBufferOps[Self <: PrivateKeyBuffer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrivateKey(value: typingsSlinky.node.Buffer): Self = this.set("privateKey", value.asInstanceOf[js.Any])
    @scala.inline
    def setPublicKey(value: typingsSlinky.node.Buffer): Self = this.set("publicKey", value.asInstanceOf[js.Any])
  }
