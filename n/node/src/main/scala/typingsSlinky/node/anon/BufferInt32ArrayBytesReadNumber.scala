...
object BufferInt32ArrayBytesReadNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Int32Array, bytesRead: Double): BufferInt32ArrayBytesReadNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
    __obj.asInstanceOf[BufferInt32ArrayBytesReadNumber]
  }
  @scala.inline
  implicit class BufferInt32ArrayBytesReadNumberOps[Self <: BufferInt32ArrayBytesReadNumber] (val x: Self) extends AnyVal {
    @scala.inline
