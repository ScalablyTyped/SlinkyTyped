...
object BufferTBuffer {
  @scala.inline
  def apply[/* <: typingsSlinky.node.NodeJS.ArrayBufferView */ TBuffer](buffer: TBuffer, bytesWritten: Double): BufferTBuffer[TBuffer] = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[BufferTBuffer[TBuffer]]
  }
  @scala.inline
  implicit class BufferTBufferOps[Self <: BufferTBuffer[_], /* <: typingsSlinky.node.NodeJS.ArrayBufferView */ TBuffer] (val x: Self with BufferTBuffer[TBuffer]) extends AnyVal {
    @scala.inline
