...
object FormatType {
  @scala.inline
  def apply[/* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF](format: PubF, `type`: spki): FormatType[PubF] = {
    val __obj = js.Dynamic.literal(format = format.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[FormatType[PubF]]
  }
  @scala.inline
  implicit class FormatTypeOps[Self <: FormatType[_], /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF] (val x: Self with FormatType[PubF]) extends AnyVal {
    @scala.inline
