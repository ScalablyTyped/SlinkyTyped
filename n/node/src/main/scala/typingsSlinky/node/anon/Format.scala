...
object Format {
  @scala.inline
  def apply[/* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF](format: PubF, `type`: pkcs1 | spki): Format[PubF] = {
    val __obj = js.Dynamic.literal(format = format.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Format[PubF]]
  }
  @scala.inline
  implicit class FormatOps[Self <: Format[_], /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF] (val x: Self with Format[PubF]) extends AnyVal {
    @scala.inline
