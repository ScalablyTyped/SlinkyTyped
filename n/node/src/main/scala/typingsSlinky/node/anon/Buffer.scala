...
object Buffer {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Uint8Array */ TBuffer](buffer: TBuffer, bytesRead: Double): Buffer[TBuffer] = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
    __obj.asInstanceOf[Buffer[TBuffer]]
  }
  @scala.inline
  implicit class BufferOps[Self <: Buffer[_], /* <: typingsSlinky.std.Uint8Array */ TBuffer] (val x: Self with Buffer[TBuffer]) extends AnyVal {
    @scala.inline
