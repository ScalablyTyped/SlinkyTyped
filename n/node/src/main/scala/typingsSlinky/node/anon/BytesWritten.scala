...
object BytesWritten {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Uint8Array */ TBuffer](buffer: TBuffer, bytesWritten: Double): BytesWritten[TBuffer] = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[BytesWritten[TBuffer]]
  }
  @scala.inline
  implicit class BytesWrittenOps[Self <: BytesWritten[_], /* <: typingsSlinky.std.Uint8Array */ TBuffer] (val x: Self with BytesWritten[TBuffer]) extends AnyVal {
    @scala.inline
