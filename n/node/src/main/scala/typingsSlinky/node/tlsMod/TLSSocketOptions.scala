...
trait TLSSocketOptions
  ...
  /**
    ...
    */
  var server: js.UndefOr[typingsSlinky.node.netMod.Server] = js.undefined
  /**
...
object TLSSocketOptions {
  ...
  implicit class TLSSocketOptionsOps[Self <: TLSSocketOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServer(value: typingsSlinky.node.netMod.Server): Self = this.set("server", value.asInstanceOf[js.Any])
    @scala.inline
