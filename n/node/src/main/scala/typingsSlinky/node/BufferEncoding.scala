...
object BufferEncoding {
  ...
  @scala.inline
  def `ucs-2`: typingsSlinky.node.nodeStrings.`ucs-2` = "ucs-2".asInstanceOf[typingsSlinky.node.nodeStrings.`ucs-2`]
  
  @scala.inline
  def ucs2: typingsSlinky.node.nodeStrings.ucs2 = "ucs2".asInstanceOf[typingsSlinky.node.nodeStrings.ucs2]
  
  @scala.inline
  def `utf-8`: typingsSlinky.node.nodeStrings.`utf-8` = "utf-8".asInstanceOf[typingsSlinky.node.nodeStrings.`utf-8`]
