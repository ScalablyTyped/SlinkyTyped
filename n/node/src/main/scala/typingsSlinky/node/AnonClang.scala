...
trait AnonClang extends js.Object {
  ...
  var host_arch: java.lang.String = js.native
  var node_install_npm: Boolean = js.native
  var node_install_waf: Boolean = js.native
  var node_prefix: java.lang.String = js.native
  ...
  var target_arch: java.lang.String = js.native
...
object AnonClang {
  ...
  @scala.inline
  implicit class AnonClangOps[Self <: AnonClang] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withHost_arch(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNode_prefix(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTarget_arch(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVisibility(value: java.lang.String): Self = {
        val ret = this.duplicate
