...
object NodeJS {
  ...
  trait Global extends StObject {
    ...
    def TypeError(message: java.lang.String): js.Error = js.native
    @JSName("TypeError")
    var TypeError_Original: TypeErrorConstructor = js.native
    @JSName("TypeError")
    def TypeError_TypeError(): js.TypeError = js.native
    @JSName("TypeError")
    def TypeError_TypeError(message: java.lang.String): js.TypeError = js.native
  ...
  trait Require extends StObject {
    ...
    @JSName("resolve")
    var resolve_Original: typingsSlinky.node.NodeJS.RequireResolve = js.native
  }
