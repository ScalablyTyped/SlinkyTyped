...
import typingsSlinky.node.consoleMod.global.NodeJS.ConsoleConstructor
  ...
  object global {
    ...
    object NodeJS {
      ...
      trait ConsoleConstructorOptions extends StObject {
        ...
        var inspectOptions: js.UndefOr[typingsSlinky.node.NodeJS.InspectOptions] = js.native
      ...
      object ConsoleConstructorOptions {
        ...
        implicit class ConsoleConstructorOptionsMutableBuilder[Self <: ConsoleConstructorOptions] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setInspectOptions(value: typingsSlinky.node.NodeJS.InspectOptions): Self = StObject.set(x, "inspectOptions", value.asInstanceOf[js.Any])
