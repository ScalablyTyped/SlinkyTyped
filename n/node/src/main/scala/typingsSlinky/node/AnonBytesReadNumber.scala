...
object AnonBytesReadNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Uint32Array, bytesRead: Double): AnonBytesReadNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBytesReadNumber]
  }
  @scala.inline
  implicit class AnonBytesReadNumberOps[Self <: AnonBytesReadNumber] (val x: Self) extends AnyVal {
    @scala.inline
