...
object readlineMod {
  ...
  class Interface protected () extends EventEmitter {
    ...
    def addListener_line(
      event: typingsSlinky.node.nodeStrings.line,
      listener: js.Function1[/* input */ java.lang.String, Unit]
    ): this.type = js.native
    @JSName("addListener")
    ...
    @JSName("emit")
    def emit_line(event: typingsSlinky.node.nodeStrings.line, input: java.lang.String): Boolean = js.native
    @JSName("emit")
