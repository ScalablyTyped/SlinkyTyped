...
object encodingstringExecOptions {
  @scala.inline
  def apply(encoding: java.lang.String): encodingstringExecOptions = {
    val __obj = js.Dynamic.literal(encoding = encoding.asInstanceOf[js.Any])
    __obj.asInstanceOf[encodingstringExecOptions]
  }
  @scala.inline
  implicit class encodingstringExecOptionsOps[Self <: encodingstringExecOptions] (val x: Self) extends AnyVal {
    @scala.inline
