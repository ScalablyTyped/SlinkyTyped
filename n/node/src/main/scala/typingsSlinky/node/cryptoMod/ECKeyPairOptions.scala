...
object ECKeyPairOptions {
  ...
  @scala.inline
  implicit class ECKeyPairOptionsOps[Self <: ECKeyPairOptions[_, _], /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF, /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PrivF] (val x: Self with (ECKeyPairOptions[PubF, PrivF])) extends AnyVal {
    @scala.inline
