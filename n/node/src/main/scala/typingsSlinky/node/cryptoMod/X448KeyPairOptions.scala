...
@js.native
trait X448KeyPairOptions[PubF /* <: KeyFormat */, PrivF /* <: KeyFormat */] extends js.Object {
...
object X448KeyPairOptions {
  ...
  @scala.inline
  implicit class X448KeyPairOptionsOps[Self <: X448KeyPairOptions[_, _], PubF /* <: KeyFormat */, PrivF /* <: KeyFormat */] (val x: Self with (X448KeyPairOptions[PubF, PrivF])) extends AnyVal {
