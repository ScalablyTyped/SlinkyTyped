...
object ED25519KeyPairOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF, /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PrivF](privateKeyEncoding: BasePrivateKeyEncodingOptions[PrivF] with `1`, publicKeyEncoding: Format[PubF]): ED25519KeyPairOptions[PubF, PrivF] = {
  ...
  @scala.inline
  implicit class ED25519KeyPairOptionsOps[Self <: ED25519KeyPairOptions[_, _], /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF, /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PrivF] (val x: Self with (ED25519KeyPairOptions[PubF, PrivF])) extends AnyVal {
    @scala.inline
