...
object createCipheriv extends js.Object {
  def apply(algorithm: java.lang.String, key: CipherKey): Cipher = js.native
  def apply(algorithm: java.lang.String, key: CipherKey, iv: Null, options: TransformOptions): Cipher = js.native
  def apply(algorithm: java.lang.String, key: CipherKey, iv: BinaryLike): Cipher = js.native
  def apply(algorithm: java.lang.String, key: CipherKey, iv: BinaryLike, options: TransformOptions): Cipher = js.native
