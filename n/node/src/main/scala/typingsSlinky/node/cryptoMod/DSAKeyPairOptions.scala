...
object DSAKeyPairOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF, /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PrivF](
  ...
  @scala.inline
  implicit class DSAKeyPairOptionsOps[Self <: DSAKeyPairOptions[_, _], /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF, /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PrivF] (val x: Self with (DSAKeyPairOptions[PubF, PrivF])) extends AnyVal {
    @scala.inline
