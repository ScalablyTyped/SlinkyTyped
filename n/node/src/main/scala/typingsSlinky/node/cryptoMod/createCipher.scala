...
object createCipher extends js.Object {
  ...
  def apply(algorithm: java.lang.String, password: BinaryLike): Cipher = js.native
  def apply(algorithm: java.lang.String, password: BinaryLike, options: TransformOptions): Cipher = js.native
  /** @deprecated since v10.0.0 use createCipheriv() */
