...
object RSAKeyPairOptions {
  ...
  @scala.inline
  implicit class RSAKeyPairOptionsOps[Self <: RSAKeyPairOptions[_, _], PubF /* <: KeyFormat */, PrivF /* <: KeyFormat */] (val x: Self with (RSAKeyPairOptions[PubF, PrivF])) extends AnyVal {
