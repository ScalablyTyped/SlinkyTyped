...
object RSAKeyPairOptions {
  ...
  @scala.inline
  implicit class RSAKeyPairOptionsOps[Self <: RSAKeyPairOptions[_, _], /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PubF, /* <: typingsSlinky.node.cryptoMod.KeyFormat */ PrivF] (val x: Self with (RSAKeyPairOptions[PubF, PrivF])) extends AnyVal {
    @scala.inline
