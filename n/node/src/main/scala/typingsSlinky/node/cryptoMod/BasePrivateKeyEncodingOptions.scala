...
object BasePrivateKeyEncodingOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.node.cryptoMod.KeyFormat */ T](format: T): BasePrivateKeyEncodingOptions[T] = {
    val __obj = js.Dynamic.literal(format = format.asInstanceOf[js.Any])
    __obj.asInstanceOf[BasePrivateKeyEncodingOptions[T]]
  }
  @scala.inline
  implicit class BasePrivateKeyEncodingOptionsOps[Self <: BasePrivateKeyEncodingOptions[_], /* <: typingsSlinky.node.cryptoMod.KeyFormat */ T] (val x: Self with BasePrivateKeyEncodingOptions[T]) extends AnyVal {
    @scala.inline
