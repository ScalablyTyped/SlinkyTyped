...
object AnonBufferDataViewBytesReadNumber {
  @scala.inline
  def apply(buffer: js.typedarray.DataView, bytesRead: Double): AnonBufferDataViewBytesReadNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferDataViewBytesReadNumber]
  }
  @scala.inline
  implicit class AnonBufferDataViewBytesReadNumberOps[Self <: AnonBufferDataViewBytesReadNumber] (val x: Self) extends AnyVal {
    @scala.inline
