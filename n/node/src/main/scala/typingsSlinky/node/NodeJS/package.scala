...
package object NodeJS {
  type ArrayBufferView = typingsSlinky.node.NodeJS.TypedArray | scala.scalajs.js.typedarray.DataView
  ...
  type NodeRequireCache = org.scalablytyped.runtime.StringDictionary[typingsSlinky.node.NodeModule]
