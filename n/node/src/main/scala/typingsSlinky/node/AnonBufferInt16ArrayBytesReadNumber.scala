...
object AnonBufferInt16ArrayBytesReadNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Int16Array, bytesRead: Double): AnonBufferInt16ArrayBytesReadNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesRead = bytesRead.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferInt16ArrayBytesReadNumber]
  }
  @scala.inline
  implicit class AnonBufferInt16ArrayBytesReadNumberOps[Self <: AnonBufferInt16ArrayBytesReadNumber] (val x: Self) extends AnyVal {
    @scala.inline
