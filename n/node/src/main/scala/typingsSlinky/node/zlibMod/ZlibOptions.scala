...
trait ZlibOptions extends js.Object {
  ...
  var chunkSize: js.UndefOr[Double] = js.native
   ...
   // compression only
  var dictionary: js.UndefOr[ArrayBufferView | js.typedarray.ArrayBuffer] = js.native
...
object ZlibOptions {
  ...
  implicit class ZlibOptionsOps[Self <: ZlibOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDictionary(value: ArrayBufferView | js.typedarray.ArrayBuffer): Self = this.set("dictionary", value.asInstanceOf[js.Any])
