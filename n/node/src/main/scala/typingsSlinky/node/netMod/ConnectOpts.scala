...
object ConnectOpts {
  ...
  implicit class ConnectOptsOps[Self <: ConnectOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnread(value: OnReadOpts): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onread")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOnread: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onread")(js.undefined)
        ret
    }
  }
