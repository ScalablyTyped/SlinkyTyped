package typingsSlinky.normalizeUrl
  ...
  */
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRemoveDirectoryIndex(value: js.Array[js.RegExp | String]): Self = StObject.set(x, "removeDirectoryIndex", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRemoveDirectoryIndexUndefined: Self = StObject.set(x, "removeDirectoryIndex", js.undefined)
      
      @scala.inline
      def setRemoveDirectoryIndexVarargs(value: (js.RegExp | String)*): Self = StObject.set(x, "removeDirectoryIndex", js.Array(value :_*))
      
      @scala.inline
      def setRemoveQueryParameters(value: js.Array[js.RegExp | String]): Self = StObject.set(x, "removeQueryParameters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRemoveQueryParametersUndefined: Self = StObject.set(x, "removeQueryParameters", js.undefined)
      
      @scala.inline
      def setRemoveQueryParametersVarargs(value: (js.RegExp | String)*): Self = StObject.set(x, "removeQueryParameters", js.Array(value :_*))
