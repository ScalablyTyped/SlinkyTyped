package typingsSlinky.nwDotGui.nwDotGuiMod

import org.scalajs.dom.raw.HTMLIFrameElement
import typingsSlinky.nwDotGui.Anon_Datatype
...
class Window () extends EventEmitter {
  ...
  def capturePage(callback: js.Function, config_object: Anon_Datatype): Unit = js.native
