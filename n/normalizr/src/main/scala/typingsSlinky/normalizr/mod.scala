  ...
  */
  ...
  object schema {
    ...
    object Array {
      ...
      @scala.inline
      def apply[T](define: Schema_[_] => Unit): typingsSlinky.normalizr.mod.schema.Array[T] = {
        val __obj = js.Dynamic.literal(define = js.Any.fromFunction1(define))
        __obj.asInstanceOf[typingsSlinky.normalizr.mod.schema.Array[T]]
      }
      
      @scala.inline
      implicit class ArrayMutableBuilder[Self <: typingsSlinky.normalizr.mod.schema.Array[_], T] (val x: Self with typingsSlinky.normalizr.mod.schema.Array[T]) extends AnyVal {
