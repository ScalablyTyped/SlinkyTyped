...
object parse {
  ...
  trait ParseReturn extends StObject {
    ...
    var `type`: typingsSlinky.nodeJose.nodeJoseStrings.JWS | typingsSlinky.nodeJose.nodeJoseStrings.JWE = js.native
  }
  object ParseReturn {
    ...
    def apply(
      ...
      `type`: typingsSlinky.nodeJose.nodeJoseStrings.JWS | typingsSlinky.nodeJose.nodeJoseStrings.JWE
    ): ParseReturn = {
    ...
    implicit class ParseReturnMutableBuilder[Self <: ParseReturn] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: typingsSlinky.nodeJose.nodeJoseStrings.JWS | typingsSlinky.nodeJose.nodeJoseStrings.JWE): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
}
