...
object v4 extends js.Object {
  ...
  def apply(options: js.UndefOr[scala.Nothing], buffer: js.UndefOr[scala.Nothing], offset: Double): Buffer = js.native
  ...
  def apply(options: UUIDOptions, buffer: js.UndefOr[scala.Nothing], offset: Double): Buffer = js.native
