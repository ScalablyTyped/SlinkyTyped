...
import typingsSlinky.nodeRal.mod.buildInConverter
...
object nodeRalStrings {
  ...
  @js.native
  sealed trait GBK extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait hashring extends StObject
  @scala.inline
  def hashring: hashring = "hashring".asInstanceOf[hashring]
  ...
  @js.native
  sealed trait soap extends StObject
  @scala.inline
