...
import typingsSlinky.nodeRal.mod.Balance.BalanceContextClass
...
object mod {
  ...
  abstract class ConfigNormalizer () extends RalModule {
    ...
    def normalizeConfig(config: js.Any): typingsSlinky.nodeRal.mod.Config = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.nodeRal.nodeRalStrings.form
    - typingsSlinky.nodeRal.nodeRalStrings.formData
    - typingsSlinky.nodeRal.nodeRalStrings.json
    - typingsSlinky.nodeRal.nodeRalStrings.protobuf
    - typingsSlinky.nodeRal.nodeRalStrings.querystring
    - typingsSlinky.nodeRal.nodeRalStrings.raw
    - typingsSlinky.nodeRal.nodeRalStrings.redis
    - typingsSlinky.nodeRal.nodeRalStrings.stream
    - typingsSlinky.nodeRal.nodeRalStrings.string
  */
