...
import typingsSlinky.navigationDashReact.navigationDashReactMod.NavigationLinkProps
...
object NavigationLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.navigationDashReact.navigationDashReactMod.NavigationLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.navigationDashReact.navigationDashReactMod.NavigationLink] = {
