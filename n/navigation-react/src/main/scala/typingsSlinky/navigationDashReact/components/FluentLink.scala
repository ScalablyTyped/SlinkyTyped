...
import typingsSlinky.navigation.navigationMod.FluentNavigator
import typingsSlinky.navigationDashReact.navigationDashReactMod.FluentLinkProps
...
object FluentLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.navigationDashReact.navigationDashReactMod.FluentLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.navigationDashReact.navigationDashReactMod.FluentLink] = {
