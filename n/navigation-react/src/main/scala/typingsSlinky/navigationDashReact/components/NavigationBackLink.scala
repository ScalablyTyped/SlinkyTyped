...
import typingsSlinky.navigationDashReact.navigationDashReactMod.NavigationBackLinkProps
...
object NavigationBackLink
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.navigationDashReact.navigationDashReactMod.NavigationBackLink
    ] {
