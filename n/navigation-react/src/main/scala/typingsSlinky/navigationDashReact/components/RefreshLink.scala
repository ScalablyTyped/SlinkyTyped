...
import typingsSlinky.navigationDashReact.navigationDashReactMod.RefreshLinkProps
import typingsSlinky.navigationDashReact.navigationDashReactStrings.add
import typingsSlinky.navigationDashReact.navigationDashReactStrings.replace
...
object RefreshLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.navigationDashReact.navigationDashReactMod.RefreshLink] {
  ...
  def apply(
    ...
    historyAction: add | replace | typingsSlinky.navigationDashReact.navigationDashReactStrings.none = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.navigationDashReact.navigationDashReactMod.RefreshLink] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.navigationDashReact.navigationDashReactMod.RefreshLink] = new slinky.core.BuildingComponent[
  slinky.web.html.a.tag.type, 
  typingsSlinky.navigationDashReact.navigationDashReactMod.RefreshLink](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = RefreshLinkProps
}
