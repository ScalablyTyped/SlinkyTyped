...
object RefreshLinkProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableActive)) __obj.updateDynamic("disableActive")(disableActive.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(includeCurrentData)) __obj.updateDynamic("includeCurrentData")(includeCurrentData.get.asInstanceOf[js.Any])
