...
object mod {
  ...
  object LinkProps {
    ...
    implicit class LinkPropsMutableBuilder[Self <: LinkProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNavigating(value: (/* e */ SyntheticMouseEvent[HTMLAnchorElement], /* link */ String) => Boolean): Self = StObject.set(x, "navigating", js.Any.fromFunction2(value))
  ...
  object NavigationEvent {
    ...
    def apply(
      ...
      oldState: State,
      state: State,
      stateNavigator: typingsSlinky.navigation.mod.StateNavigator
    ): NavigationEvent = {
