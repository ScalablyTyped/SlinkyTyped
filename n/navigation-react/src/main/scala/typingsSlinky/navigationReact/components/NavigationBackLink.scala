...
object NavigationBackLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.navigationReact.mod.NavigationBackLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.navigationReact.mod.NavigationBackLink] = {
  ...
  type Props = NavigationBackLinkProps
}
