...
import typingsSlinky.navigationReact.mod.RefreshLinkProps
...
object RefreshLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.navigationReact.mod.RefreshLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.navigationReact.mod.RefreshLink] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.navigationReact.mod.RefreshLink] = new slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.navigationReact.mod.RefreshLink](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
