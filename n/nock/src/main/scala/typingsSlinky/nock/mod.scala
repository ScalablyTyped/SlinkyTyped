...
import typingsSlinky.nock.anon.ClientRequestheadersRecor
import typingsSlinky.nock.anon.Context
import typingsSlinky.nock.anon.Pass
...
object mod {
  ...
  @JSImport("nock", "enableNetConnect")
  @js.native
  def enableNetConnect(matcher: js.RegExp): Unit = js.native
  ...
  */
  ...
  object BackMode {
    ...
    @scala.inline
    def dryrun: typingsSlinky.nock.nockStrings.dryrun = "dryrun".asInstanceOf[typingsSlinky.nock.nockStrings.dryrun]
    
    @scala.inline
    def lockdown: typingsSlinky.nock.nockStrings.lockdown = "lockdown".asInstanceOf[typingsSlinky.nock.nockStrings.lockdown]
    
    @scala.inline
    def record: typingsSlinky.nock.nockStrings.record = "record".asInstanceOf[typingsSlinky.nock.nockStrings.record]
    
    @scala.inline
    def wild: typingsSlinky.nock.nockStrings.wild = "wild".asInstanceOf[typingsSlinky.nock.nockStrings.wild]
  }
  ...
  */
  ...
  object Definition {
    ...
    implicit class DefinitionMutableBuilder[Self <: Definition] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBodyRegExp(value: js.RegExp): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
  ...
  type InterceptFunction = js.Function3[
    /* uri */ String | js.RegExp | (js.Function1[/* uri */ String, Boolean]), 
  ...
  trait Interceptor extends StObject {
    ...
    def delay(opts: typingsSlinky.nock.anon.Body): this.type = js.native
  ...
  object ReqOptions {
    ...
    implicit class ReqOptionsMutableBuilder[Self <: ReqOptions] (val x: Self) extends AnyVal {
      ...
      def setCreateConnection(
        value: (ReqOptions, /* oncreate */ js.Function2[/* err */ js.Error, /* socket */ Socket, Unit]) => Socket
  ...
  */
  type RequestBodyMatcher = _RequestBodyMatcher | (js.Function1[/* body */ js.Any, Boolean]) | String | Buffer | js.RegExp
