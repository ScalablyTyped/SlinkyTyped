...
object ResponsiveScatterPlot
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoScatterplot.mod.ResponsiveScatterPlot] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoScatterplot.mod.ResponsiveScatterPlot] = {
  ...
  type Props = ScatterPlotSvgProps
}
