...
object ScatterPlot {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoScatterplot.mod.ScatterPlot] {
    @scala.inline
    ...
    @scala.inline
    def renderNode(value: /* props */ NodeProps => TagMod[Any]): this.type = set("renderNode", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: ScatterPlotSvgProps with Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(data: js.Array[Serie], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ScatterPlotSvgProps with Dimensions]))
  }
}
