...
object ScatterPlot
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoScatterplot.mod.ScatterPlot] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoScatterplot.mod.ScatterPlot] = {
  ...
  type Props = ScatterPlotSvgProps with Dimensions
}
