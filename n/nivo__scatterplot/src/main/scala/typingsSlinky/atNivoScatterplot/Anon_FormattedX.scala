...
trait Anon_FormattedX extends js.Object {
...
object Anon_FormattedX {
  @scala.inline
  def apply(formattedX: String | Double, formattedY: String | Double, x: Value, y: Value): Anon_FormattedX = {
    ...
    __obj.asInstanceOf[Anon_FormattedX]
  }
}
