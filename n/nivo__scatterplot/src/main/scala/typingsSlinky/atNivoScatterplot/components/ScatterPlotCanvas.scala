package typingsSlinky.atNivoScatterplot.components
...
import typingsSlinky.atNivoScatterplot.ScatterPlotCanvasPropsDimensions
...
object ScatterPlotCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ScatterPlotCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ScatterPlotCanvas] = {
  ...
  type Props = ScatterPlotCanvasPropsDimensions
}
