...
import typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ScatterPlotSvgProps
...
object ResponsiveScatterPlot
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ResponsiveScatterPlot
    ] {
