...
import typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ScatterPlotCanvasProps
...
object ResponsiveScatterPlotCanvas
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ResponsiveScatterPlotCanvas
    ] {
