...
import typingsSlinky.atNivoScatterplot.ScatterPlotSvgPropsDimensions
...
object ScatterPlot
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ScatterPlot] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoScatterplot.atNivoScatterplotMod.ScatterPlot] = {
  ...
  type Props = ScatterPlotSvgPropsDimensions
}
