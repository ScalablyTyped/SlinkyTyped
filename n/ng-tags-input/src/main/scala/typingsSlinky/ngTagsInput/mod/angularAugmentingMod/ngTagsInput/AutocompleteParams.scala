...
object AutocompleteParams {
  ...
  def apply(
    ...
    if (!js.isUndefined(highlightMatchedText)) __obj.updateDynamic("highlightMatchedText")(highlightMatchedText.get.asInstanceOf[js.Any])
    if (!js.isUndefined(loadOnDownArrow)) __obj.updateDynamic("loadOnDownArrow")(loadOnDownArrow.get.asInstanceOf[js.Any])
    if (!js.isUndefined(loadOnEmpty)) __obj.updateDynamic("loadOnEmpty")(loadOnEmpty.get.asInstanceOf[js.Any])
    if (!js.isUndefined(loadOnFocus)) __obj.updateDynamic("loadOnFocus")(loadOnFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(selectFirstMatch)) __obj.updateDynamic("selectFirstMatch")(selectFirstMatch.get.asInstanceOf[js.Any])
