...
import typingsSlinky.nestdb.anon.NewDoc
...
object mod {
  ...
  object Cursor {
    ...
    implicit class CursorMutableBuilder[Self <: Cursor[_], T] (val x: Self with Cursor[T]) extends AnyVal {
      ...
      @scala.inline
      def setExec(value: js.Function2[/* err */ js.Error, /* documents */ js.Array[T], Unit] => Unit): Self = StObject.set(x, "exec", js.Any.fromFunction1(value))
  ...
  trait CursorCount extends StObject {
    ...
    def exec(callback: js.Function2[/* err */ js.Error, /* count */ Double, Unit]): Unit = js.native
  }
  object CursorCount {
    ...
    implicit class CursorCountMutableBuilder[Self <: CursorCount] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExec(value: js.Function2[/* err */ js.Error, /* count */ Double, Unit] => Unit): Self = StObject.set(x, "exec", js.Any.fromFunction1(value))
    }
  }
  ...
  object DataStoreOptions {
    ...
    implicit class DataStoreOptionsMutableBuilder[Self <: DataStoreOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnload(value: /* error */ js.Error => _): Self = StObject.set(x, "onload", js.Any.fromFunction1(value))
