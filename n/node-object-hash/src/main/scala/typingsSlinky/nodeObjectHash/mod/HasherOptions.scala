...
import typingsSlinky.nodeObjectHash.objectSorterMod.CoerceOptions
import typingsSlinky.nodeObjectHash.objectSorterMod.SortOptions
import typingsSlinky.nodeObjectHash.objectSorterMod.SorterOptions
import typingsSlinky.nodeObjectHash.objectSorterMod.TrimOptions
