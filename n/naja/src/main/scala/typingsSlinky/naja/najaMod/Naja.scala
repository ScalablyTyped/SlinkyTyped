...
trait Naja extends NajaEventTarget {
  ...
  def registerExtension[T /* <: js.Array[_] */](
    ...
    /* import warning: parser.TsParser#functionParam $anonfun Dropping repeated marker of param optionalArguments because its type T is not an array type */ optionalArguments: T
  ): Unit = js.native
}
