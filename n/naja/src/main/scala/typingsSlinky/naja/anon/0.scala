...
object `0` {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Event */ T](handleEvent: T => js.Promise[Unit] | Unit): `0`[T] = {
    val __obj = js.Dynamic.literal(handleEvent = js.Any.fromFunction1(handleEvent))
    __obj.asInstanceOf[`0`[T]]
  }
  @scala.inline
  implicit class `0Ops`[Self <: `0`[_], /* <: typingsSlinky.std.Event */ T] (val x: Self with `0`[T]) extends AnyVal {
    @scala.inline
