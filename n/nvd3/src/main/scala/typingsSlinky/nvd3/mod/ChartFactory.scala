...
object ChartFactory {
  @scala.inline
  def apply[/* <: typingsSlinky.nvd3.mod.Nvd3Element */ TChart](generate: () => TChart): ChartFactory[TChart] = {
    val __obj = js.Dynamic.literal(generate = js.Any.fromFunction0(generate))
    __obj.asInstanceOf[ChartFactory[TChart]]
  }
  @scala.inline
  implicit class ChartFactoryOps[Self <: ChartFactory[_], /* <: typingsSlinky.nvd3.mod.Nvd3Element */ TChart] (val x: Self with ChartFactory[TChart]) extends AnyVal {
    @scala.inline
