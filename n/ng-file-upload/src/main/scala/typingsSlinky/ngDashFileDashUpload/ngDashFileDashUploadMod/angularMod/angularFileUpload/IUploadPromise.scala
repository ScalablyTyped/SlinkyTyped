package typingsSlinky.ngDashFileDashUpload.ngDashFileDashUploadMod.angularMod.angularFileUpload

import typingsSlinky.angular.angularMod.IHttpPromiseCallback
import typingsSlinky.angular.angularMod.IHttpResponse
