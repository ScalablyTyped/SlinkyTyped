...
object AnonDoc {
  @scala.inline
  def apply[V](fields: js.Object, id: String, key: String, order: js.Array[Double]): AnonDoc[V] = {
  ...
  @scala.inline
  implicit class AnonDocOps[Self[v] <: AnonDoc[v], V] (val x: Self[V]) extends AnyVal {
    @scala.inline
