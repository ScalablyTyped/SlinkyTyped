...
trait Attachment extends js.Object {
  ...
  def get(docname: String, attname: String): js.Promise[_] = js.native
  def get(docname: String, attname: String, callback: Callback[_]): js.Promise[_] = js.native
  def get(docname: String, attname: String, params: js.Any): js.Promise[_] = js.native
  def get(docname: String, attname: String, params: js.Any, callback: Callback[_]): js.Promise[_] = js.native
