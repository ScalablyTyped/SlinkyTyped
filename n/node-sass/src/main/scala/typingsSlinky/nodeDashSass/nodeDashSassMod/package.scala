package typingsSlinky.nodeDashSass
...
package object nodeDashSassMod {
  import typingsSlinky.nodeDashSass.nodeDashSassMod.types.ReturnValue
  import typingsSlinky.nodeDashSass.nodeDashSassMod.types.Value
  ...
  */
  type ImporterReturnType = _ImporterReturnType | js.Error | Null
