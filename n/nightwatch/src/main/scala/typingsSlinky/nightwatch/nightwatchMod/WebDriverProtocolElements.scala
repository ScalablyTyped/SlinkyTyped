...
import typingsSlinky.nightwatch.Anon_ELEMENT
...
trait WebDriverProtocolElements extends js.Object {
  ...
  def element(
    ...
    value: String,
    callback: js.ThisFunction1[/* this */ NightwatchAPI, /* result */ NightwatchCallbackResult[Anon_ELEMENT], Unit]
  ): this.type = js.native
  /**
  ...
  def elementIdElements(
    ...
    callback: js.ThisFunction1[
      /* this */ NightwatchAPI, 
      /* result */ NightwatchCallbackResult[js.Array[Anon_ELEMENT]], 
      Unit
    ]
  ): this.type = js.native
  /**
