...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.nightwatch.nightwatchStrings.`class name`
  - typingsSlinky.nightwatch.nightwatchStrings.`css selector`
  - typingsSlinky.nightwatch.nightwatchStrings.id
  - typingsSlinky.nightwatch.nightwatchStrings.name
  - typingsSlinky.nightwatch.nightwatchStrings.`link text`
  - typingsSlinky.nightwatch.nightwatchStrings.`partial link text`
  - typingsSlinky.nightwatch.nightwatchStrings.`tag name`
  - typingsSlinky.nightwatch.nightwatchStrings.xpath
*/
