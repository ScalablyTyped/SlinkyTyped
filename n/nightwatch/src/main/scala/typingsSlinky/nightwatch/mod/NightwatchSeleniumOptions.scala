...
object NightwatchSeleniumOptions {
  ...
  implicit class NightwatchSeleniumOptionsOps[Self <: NightwatchSeleniumOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLog_path(value: String | Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStart_session(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("start_session")(value.asInstanceOf[js.Any])
        ret
    }
  }
