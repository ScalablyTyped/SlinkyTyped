package typingsSlinky.nodemailer.libMailDashComposerMod
...
trait MailComposer extends js.Object {
  var mail: Options
  var message: typingsSlinky.nodemailer.libMimeDashNodeMod.^  | `false`
  /** Builds MimeNode instance */
  def compile(): typingsSlinky.nodemailer.libMimeDashNodeMod.^
...
object MailComposer {
  @scala.inline
  def apply(
    compile: () => typingsSlinky.nodemailer.libMimeDashNodeMod.^,
    getAlternatives: () => js.Array[Attachment],
    getAttachments: Boolean => js.Array[Attachment],
    mail: Options,
    message: typingsSlinky.nodemailer.libMimeDashNodeMod.^  | `false`
  ): MailComposer = {
