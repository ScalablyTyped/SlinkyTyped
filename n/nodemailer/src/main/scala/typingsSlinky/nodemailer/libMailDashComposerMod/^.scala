...
class ^ protected () extends MailComposer {
  ...
  /* CompleteClass */
  override var message: typingsSlinky.nodemailer.libMimeDashNodeMod.^  | `false` = js.native
  /** Builds MimeNode instance */
  /* CompleteClass */
  override def compile(): typingsSlinky.nodemailer.libMimeDashNodeMod.^ = js.native
