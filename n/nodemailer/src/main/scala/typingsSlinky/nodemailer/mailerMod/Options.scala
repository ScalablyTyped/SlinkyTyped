...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDkim(value: typingsSlinky.nodemailer.dkimMod.Options): Self = this.set("dkim", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setEnvelope(value: Envelope | typingsSlinky.nodemailer.mimeNodeMod.Envelope): Self = this.set("envelope", value.asInstanceOf[js.Any])
    @scala.inline
