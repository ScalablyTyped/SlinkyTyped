package typingsSlinky.nodemailer.libMailerMailDashMessageMod
...
trait MailMessage extends js.Object {
  ...
  var mailer: typingsSlinky.nodemailer.libMailerMod.^ = js.native
  var message: typingsSlinky.nodemailer.libMimeDashNodeMod.^ = js.native
  def normalize(
