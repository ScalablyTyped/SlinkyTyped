package typingsSlinky.nodemailer.libSmtpDashPoolPoolDashResourceMod

import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.nodemailer.libSharedMod.Logger
import typingsSlinky.nodemailer.libSmtpDashPoolMod.Options
import typingsSlinky.nodemailer.libSmtpDashPoolMod.SentMessageInfo
...
trait PoolResource extends EventEmitter {
  ...
  var pool: typingsSlinky.nodemailer.libSmtpDashPoolMod.^ = js.native
  @JSName("addListener")
