...
trait MailOptions
  ...
  var auth: js.UndefOr[typingsSlinky.nodemailer.smtpConnectionMod.AuthenticationType] = js.undefined
...
object MailOptions {
  ...
  def apply(
    ...
    auth: typingsSlinky.nodemailer.smtpConnectionMod.AuthenticationType = null,
