...
object dkimMod {
  ...
  */
  ...
  object Options {
    ...
    @scala.inline
    def MultipleKeysOptions(keys: js.Array[SingleKeyOptions]): typingsSlinky.nodemailer.dkimMod.MultipleKeysOptions = {
      val __obj = js.Dynamic.literal(keys = keys.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nodemailer.dkimMod.MultipleKeysOptions]
    }
    
    @scala.inline
    def SingleKeyOptions(domainName: String, keySelector: String, privateKey: String | Key): typingsSlinky.nodemailer.dkimMod.SingleKeyOptions = {
      ...
      __obj.asInstanceOf[typingsSlinky.nodemailer.dkimMod.SingleKeyOptions]
    }
  }
