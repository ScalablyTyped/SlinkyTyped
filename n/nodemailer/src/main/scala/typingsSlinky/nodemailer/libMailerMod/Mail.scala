package typingsSlinky.nodemailer.libMailerMod
...
trait Mail extends EventEmitter {
  ...
  var MailMessage: typingsSlinky.nodemailer.libMailerMailDashMessageMod.^ = js.native
  var dkim: typingsSlinky.nodemailer.libDkimMod.^ = js.native
  ...
  def get_proxyhandlerhttp(key: proxy_handler_http): js.Function3[
    ...
    /* callback */ js.Function2[/* err */ js.Error | Null, /* socketOptions */ Anon_Connection, Unit], 
    Unit
  ] = js.native
  @JSName("get")
  ...
  def set_proxyhandlerhttp(
    ...
    value: js.Function3[
      /* proxy */ Url, 
      /* options */ TransportOptions, 
      /* callback */ js.Function2[/* err */ js.Error | Null, /* socketOptions */ js.UndefOr[Anon_Connection], Unit], 
      Unit
    ]
  ): Map[String, _] = js.native
  @JSName("set")
