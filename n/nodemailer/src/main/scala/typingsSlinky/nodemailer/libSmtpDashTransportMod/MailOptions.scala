...
import typingsSlinky.nodemailer.libMailerMod.Address
import typingsSlinky.nodemailer.libMailerMod.AmpAttachment
import typingsSlinky.nodemailer.libMailerMod.Attachment
import typingsSlinky.nodemailer.libMailerMod.AttachmentLike
import typingsSlinky.nodemailer.libMailerMod.Envelope
import typingsSlinky.nodemailer.libMailerMod.Headers
...
trait MailOptions
  extends typingsSlinky.nodemailer.libMailerMod.Options {
  var auth: js.UndefOr[typingsSlinky.nodemailer.libSmtpDashConnectionMod.AuthenticationType] = js.undefined
...
object MailOptions {
  ...
  def apply(
    ...
    auth: typingsSlinky.nodemailer.libSmtpDashConnectionMod.AuthenticationType = null,
    ...
    dkim: typingsSlinky.nodemailer.libDkimMod.Options = null,
    dsn: DSNOptions = null,
    encoding: String = null,
    envelope: Envelope | typingsSlinky.nodemailer.libMimeDashNodeMod.Envelope = null,
