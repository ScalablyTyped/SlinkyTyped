...
trait AuthenticationTypeOAuth2 extends AuthenticationType {
  var method: XOAUTH2
  var oauth2: typingsSlinky.nodemailer.libXoauth2Mod.^
  var `type`: OAUTH2
  var user: String
}
...
object AuthenticationTypeOAuth2 {
  @scala.inline
  def apply(method: XOAUTH2, oauth2: typingsSlinky.nodemailer.libXoauth2Mod.^, `type`: OAUTH2, user: String): AuthenticationTypeOAuth2 = {
