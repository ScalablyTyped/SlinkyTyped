...
import typingsSlinky.nodemailer.anon.Flatten
import typingsSlinky.nodemailer.anon.`0`
...
object addressparserMod {
  ...
  */
  ...
  object AddressOrGroup {
    ...
    @scala.inline
    def Address(address: String, name: String): typingsSlinky.nodemailer.addressparserMod.Address = {
      val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nodemailer.addressparserMod.Address]
    }
    
    @scala.inline
    def Group(group: js.Array[AddressOrGroup], name: String): typingsSlinky.nodemailer.addressparserMod.Group = {
      val __obj = js.Dynamic.literal(group = group.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nodemailer.addressparserMod.Group]
    }
  }
