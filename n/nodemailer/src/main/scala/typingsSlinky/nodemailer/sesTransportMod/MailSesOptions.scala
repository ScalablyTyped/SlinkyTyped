...
object MailSesOptions {
  ...
  implicit class MailSesOptionsOps[Self <: MailSesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfigurationSetName(value: String): Self = {
    ...
    @scala.inline
    def withFromArn(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withoutRawMessage: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RawMessage")(js.undefined)
        ret
    }
    @scala.inline
    def withReturnPathArn(value: String): Self = {
        val ret = this.duplicate
