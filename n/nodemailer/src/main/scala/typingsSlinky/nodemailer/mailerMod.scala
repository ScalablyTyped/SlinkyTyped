...
import typingsSlinky.nodemailer.anon.Comment
...
object mailerMod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDkim(value: typingsSlinky.nodemailer.dkimMod.Options): Self = StObject.set(x, "dkim", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEnvelope(value: Envelope | typingsSlinky.nodemailer.mimeNodeMod.Envelope): Self = StObject.set(x, "envelope", value.asInstanceOf[js.Any])
