...
object DatePickerOptions {
  ...
  implicit class DatePickerOptionsOps[Self <: DatePickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxDate(value: js.Date | String | Double): Self = this.set("maxDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDate(value: js.Date | String | Double): Self = this.set("minDate", value.asInstanceOf[js.Any])
