...
object DatePickerOptions {
  ...
  implicit class DatePickerOptionsMutableBuilder[Self <: DatePickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxDate(value: js.Date | String | Double): Self = StObject.set(x, "maxDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDate(value: js.Date | String | Double): Self = StObject.set(x, "minDate", value.asInstanceOf[js.Any])
