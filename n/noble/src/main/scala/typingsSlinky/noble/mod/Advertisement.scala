...
object Advertisement {
  ...
  implicit class AdvertisementOps[Self <: Advertisement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServiceDataVarargs(value: Data*): Self = this.set("serviceData", js.Array(value :_*))
    @scala.inline
    def setServiceData(value: js.Array[Data]): Self = this.set("serviceData", value.asInstanceOf[js.Any])
    @scala.inline
