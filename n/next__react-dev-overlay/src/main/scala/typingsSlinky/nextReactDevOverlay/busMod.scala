...
object busMod {
  ...
  */
  ...
  object BusEvent {
    ...
    @scala.inline
    def BuildError(message: String, `type`: /* "build-error" */ String): typingsSlinky.nextReactDevOverlay.busMod.BuildError = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nextReactDevOverlay.busMod.BuildError]
    }
    
    @scala.inline
    def BuildOk(`type`: /* "build-ok" */ String): typingsSlinky.nextReactDevOverlay.busMod.BuildOk = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nextReactDevOverlay.busMod.BuildOk]
    }
    
    @scala.inline
    def FastRefresh(`type`: /* "fast-refresh" */ String): typingsSlinky.nextReactDevOverlay.busMod.FastRefresh = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nextReactDevOverlay.busMod.FastRefresh]
    }
    
    @scala.inline
    def UnhandledError(frames: js.Array[StackFrame], reason: js.Error, `type`: /* "unhandled-error" */ String): typingsSlinky.nextReactDevOverlay.busMod.UnhandledError = {
      val __obj = js.Dynamic.literal(frames = frames.asInstanceOf[js.Any], reason = reason.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nextReactDevOverlay.busMod.UnhandledError]
    }
    
    @scala.inline
    def UnhandledRejection(frames: js.Array[StackFrame], reason: js.Error, `type`: /* "unhandled-rejection" */ String): typingsSlinky.nextReactDevOverlay.busMod.UnhandledRejection = {
      val __obj = js.Dynamic.literal(frames = frames.asInstanceOf[js.Any], reason = reason.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nextReactDevOverlay.busMod.UnhandledRejection]
    }
  }
  ...
  object UnhandledError {
    ...
    implicit class UnhandledErrorMutableBuilder[Self <: UnhandledError] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReason(value: js.Error): Self = StObject.set(x, "reason", value.asInstanceOf[js.Any])
