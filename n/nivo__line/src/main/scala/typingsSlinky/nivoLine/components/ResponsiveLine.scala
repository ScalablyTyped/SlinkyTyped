...
object ResponsiveLine
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoLine.mod.ResponsiveLine] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoLine.mod.ResponsiveLine] = {
