...
object LineCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoLine.mod.LineCanvas] {
  ...
  def withProps(p: LineCanvasProps with Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  ...
  def apply(data: js.Array[Serie], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LineCanvasProps with Dimensions]))
  }
}
