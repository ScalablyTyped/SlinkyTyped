...
object CustomLayerProps {
  ...
  implicit class CustomLayerPropsOps[Self <: CustomLayerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setXScale(value: /* value */ String | Double | js.Date => Double): Self = this.set("xScale", js.Any.fromFunction1(value))
    @scala.inline
    def setYScale(value: /* value */ String | Double | js.Date => Double): Self = this.set("yScale", js.Any.fromFunction1(value))
    @scala.inline
