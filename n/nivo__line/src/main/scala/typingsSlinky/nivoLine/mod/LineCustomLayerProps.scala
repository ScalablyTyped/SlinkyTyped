...
import typingsSlinky.nivoScales.mod.ScaleFunc
...
object LineCustomLayerProps {
  ...
  @scala.inline
  implicit class LineCustomLayerPropsOps[Self <: LineCustomLayerProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withXScale(value: /* value */ String | Double | js.Date => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("xScale")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withYScale(value: /* value */ String | Double | js.Date => Double): Self = {
        val ret = this.duplicate
