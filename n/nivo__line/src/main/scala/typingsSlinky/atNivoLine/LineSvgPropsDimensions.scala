...
/* Inlined @nivo/line.@nivo/line.LineSvgProps & @nivo/core.@nivo/core.Dimensions */
trait LineSvgPropsDimensions extends js.Object {
...
object LineSvgPropsDimensions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LineSvgPropsDimensions]
  }
}
