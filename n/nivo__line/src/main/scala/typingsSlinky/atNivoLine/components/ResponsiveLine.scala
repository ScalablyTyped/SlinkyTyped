...
import typingsSlinky.atNivoLine.atNivoLineMod.LineSvgProps
...
object ResponsiveLine
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoLine.atNivoLineMod.ResponsiveLine] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoLine.atNivoLineMod.ResponsiveLine] = {
