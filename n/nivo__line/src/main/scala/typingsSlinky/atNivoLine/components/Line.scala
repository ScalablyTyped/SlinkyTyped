...
import typingsSlinky.atNivoLine.LineSvgPropsDimensions
...
object Line
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoLine.atNivoLineMod.Line] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoLine.atNivoLineMod.Line] = {
  ...
  type Props = LineSvgPropsDimensions
}
