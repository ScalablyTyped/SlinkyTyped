...
import typingsSlinky.atNivoLine.LineCanvasPropsDimensions
...
object LineCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoLine.atNivoLineMod.LineCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoLine.atNivoLineMod.LineCanvas] = {
  ...
  type Props = LineCanvasPropsDimensions
}
