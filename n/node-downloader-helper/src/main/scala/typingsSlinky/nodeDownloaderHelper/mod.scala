...
import typingsSlinky.nodeDownloaderHelper.anon.Delay
...
object mod {
  ...
  object DH_STATES extends StObject {
    ...
    /* "DOWNLOADING" */ val DOWNLOADING: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.DOWNLOADING with String = js.native
    
    @js.native
    sealed trait FAILED extends DH_STATES
    /* "FAILED" */ val FAILED: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.FAILED with String = js.native
    
    @js.native
    sealed trait FINISHED extends DH_STATES
    /* "FINISHED" */ val FINISHED: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.FINISHED with String = js.native
    
    @js.native
    sealed trait IDLE extends DH_STATES
    /* "IDLE" */ val IDLE: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.IDLE with String = js.native
    
    @js.native
    sealed trait PAUSED extends DH_STATES
    /* "PAUSED" */ val PAUSED: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.PAUSED with String = js.native
    
    @js.native
    sealed trait RESUMED extends DH_STATES
    /* "RESUMED" */ val RESUMED: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.RESUMED with String = js.native
    
    @js.native
    sealed trait STARTED extends DH_STATES
    /* "STARTED" */ val STARTED: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.STARTED with String = js.native
    
    @js.native
    sealed trait STOPPED extends DH_STATES
    /* "STOPPED" */ val STOPPED: typingsSlinky.nodeDownloaderHelper.mod.DH_STATES.STOPPED with String = js.native
  }
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHttpsRequestOptions(value: typingsSlinky.node.httpsMod.RequestOptions): Self = StObject.set(x, "httpsRequestOptions", value.asInstanceOf[js.Any])
