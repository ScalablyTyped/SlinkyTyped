...
import typingsSlinky.atNivoRadar.RadarPropsDimensions
...
object Radar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoRadar.atNivoRadarMod.Radar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoRadar.atNivoRadarMod.Radar] = {
  ...
  type Props = RadarPropsDimensions
}
