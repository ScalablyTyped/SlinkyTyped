...
object CommonRadarProps {
  ...
  implicit class CommonRadarPropsOps[Self <: CommonRadarProps[_], Datum] (val x: Self with CommonRadarProps[Datum]) extends AnyVal {
    ...
    @scala.inline
    def setDotLabelFunction1(value: /* repeated */ js.Any => ReactElement): Self = this.set("dotLabel", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setDotLabelFormatFunction1(value: /* repeated */ js.Any => ReactElement): Self = this.set("dotLabelFormat", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setDotSymbol(value: /* repeated */ js.Any => ReactElement): Self = this.set("dotSymbol", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setTooltipFormatFunction1(value: /* repeated */ js.Any => ReactElement): Self = this.set("tooltipFormat", js.Any.fromFunction1(value))
    @scala.inline
