...
object ResponsiveRadar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoRadar.mod.ResponsiveRadar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoRadar.mod.ResponsiveRadar] = {
