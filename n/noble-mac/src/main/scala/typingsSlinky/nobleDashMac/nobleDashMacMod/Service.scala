...
import typingsSlinky.nobleDashMac.nobleDashMacStrings.characteristicsDiscover
import typingsSlinky.nobleDashMac.nobleDashMacStrings.includedServicesDiscover
