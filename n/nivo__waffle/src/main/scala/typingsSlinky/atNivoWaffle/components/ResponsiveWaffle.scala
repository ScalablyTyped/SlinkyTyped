...
import typingsSlinky.atNivoWaffle.atNivoWaffleMod.WaffleSvgProps
...
object ResponsiveWaffle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoWaffle.atNivoWaffleMod.ResponsiveWaffle] {
