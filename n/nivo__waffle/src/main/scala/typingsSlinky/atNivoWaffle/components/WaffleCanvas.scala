...
import typingsSlinky.atNivoWaffle.WaffleCanvasPropsDimensions
...
object WaffleCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoWaffle.atNivoWaffleMod.WaffleCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoWaffle.atNivoWaffleMod.WaffleCanvas] = {
  ...
  type Props = WaffleCanvasPropsDimensions
}
