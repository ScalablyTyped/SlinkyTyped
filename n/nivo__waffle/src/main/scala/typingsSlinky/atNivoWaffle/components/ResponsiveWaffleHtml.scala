...
import typingsSlinky.atNivoWaffle.atNivoWaffleMod.WaffleHtmlProps
...
object ResponsiveWaffleHtml
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoWaffle.atNivoWaffleMod.ResponsiveWaffleHtml] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoWaffle.atNivoWaffleMod.ResponsiveWaffleHtml] = {
