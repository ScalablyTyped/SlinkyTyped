...
object Waffle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoWaffle.mod.Waffle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoWaffle.mod.Waffle] = {
  ...
  type Props = WaffleSvgProps with Dimensions
}
