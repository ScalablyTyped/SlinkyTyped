...
object ResponsiveWaffleHtml
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffleHtml] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffleHtml] = {
