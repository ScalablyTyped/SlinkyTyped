...
import typingsSlinky.nivoWaffle.mod.WaffleHtmlProps
import typingsSlinky.nivoWaffle.mod.WaffleTooltipData
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ResponsiveWaffleHtml {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffleHtml] {
    @scala.inline
  ...
  def withProps(p: WaffleHtmlProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(columns: Double, data: js.Array[js.Object], rows: Double, total: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[WaffleHtmlProps]))
  }
}
