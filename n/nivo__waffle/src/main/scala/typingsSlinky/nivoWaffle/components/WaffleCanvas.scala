...
object WaffleCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoWaffle.mod.WaffleCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoWaffle.mod.WaffleCanvas] = {
  ...
  type Props = WaffleCanvasProps with Dimensions
}
