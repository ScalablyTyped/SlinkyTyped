...
object ResponsiveWaffleCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffleCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffleCanvas] = {
