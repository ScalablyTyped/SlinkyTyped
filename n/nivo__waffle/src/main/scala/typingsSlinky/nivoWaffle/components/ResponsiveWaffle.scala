...
object ResponsiveWaffle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffle] = {
