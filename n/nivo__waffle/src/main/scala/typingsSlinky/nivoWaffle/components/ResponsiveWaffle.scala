...
import typingsSlinky.nivoWaffle.mod.WaffleSvgProps
import typingsSlinky.nivoWaffle.mod.WaffleTooltipData
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object ResponsiveWaffle {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoWaffle.mod.ResponsiveWaffle] {
    @scala.inline
  ...
  def withProps(p: WaffleSvgProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(columns: Double, data: js.Array[js.Object], rows: Double, total: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[WaffleSvgProps]))
  }
}
