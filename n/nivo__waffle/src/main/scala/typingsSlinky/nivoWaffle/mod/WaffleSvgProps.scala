...
object WaffleSvgProps {
  @scala.inline
  def apply(columns: Double, data: js.Array[js.Object], rows: Double, total: Double): WaffleSvgProps = {
  ...
  @scala.inline
  implicit class WaffleSvgPropsOps[Self <: WaffleSvgProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFillVarargs(value: Id[WaffleDatum]*): Self = this.set("fill", js.Array(value :_*))
    @scala.inline
    def setFill(value: js.Array[Id[WaffleDatum]]): Self = this.set("fill", value.asInstanceOf[js.Any])
    @scala.inline
