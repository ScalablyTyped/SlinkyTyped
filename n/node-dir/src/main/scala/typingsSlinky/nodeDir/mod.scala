...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExclude(value: js.RegExp | js.Array[String]): Self = StObject.set(x, "exclude", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExcludeDir(value: js.RegExp | js.Array[String]): Self = StObject.set(x, "excludeDir", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExcludeDirRegExp(value: js.RegExp): Self = StObject.set(x, "excludeDir", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMatch(value: js.RegExp | js.Array[String]): Self = StObject.set(x, "match", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMatchDir(value: js.RegExp | js.Array[String]): Self = StObject.set(x, "matchDir", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMatchDirRegExp(value: js.RegExp): Self = StObject.set(x, "matchDir", value.asInstanceOf[js.Any])
