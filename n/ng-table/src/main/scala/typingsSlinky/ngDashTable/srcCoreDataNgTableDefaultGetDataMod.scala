...
import typingsSlinky.angular.angularMod.IFilterOrderBy
import typingsSlinky.angular.angularMod.IFilterService
...
import typingsSlinky.ngDashTable.srcCoreNgTableEventsChannelMod.NgTableEventsChannel
