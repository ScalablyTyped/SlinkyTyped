package typingsSlinky.ngDashTable.srcCoreDataInterceptorMod
...
object IInterceptor {
  @scala.inline
  def apply[T](
    response: (/* data */ js.Any, /* params */ NgTableParams[T]) => _ = null,
    responseError: (/* reason */ js.Any, /* params */ NgTableParams[T]) => _ = null
  ): IInterceptor[T] = {
