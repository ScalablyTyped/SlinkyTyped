...
import typingsSlinky.ngTable.ngTableNumbers.`0`
import typingsSlinky.ngTable.ngTableNumbers.`1`
import typingsSlinky.ngTable.ngTableNumbers.`2`
import typingsSlinky.ngTable.ngTableNumbers.`3`
import typingsSlinky.ngTable.ngTableNumbers.`4`
...
trait GroupedDataResults[T] extends /* n */ NumberDictionary[IDataRowGroup[T]] {
  ...
  def find(
    predicate: js.Function3[
      /* value */ IDataRowGroup[T], 
      /* index */ Double, 
      /* obj */ js.Array[IDataRowGroup[T]], 
      _
    ]
  ): js.UndefOr[IDataRowGroup[T]] = js.native
  def find(
    predicate: js.Function3[
      /* value */ IDataRowGroup[T], 
      /* index */ Double, 
  ...
  def reduce(
    callbackfn: js.Function4[
      /* previousValue */ IDataRowGroup[T], 
      /* currentValue */ IDataRowGroup[T], 
      /* currentIndex */ Double, 
      /* array */ js.Array[IDataRowGroup[T]], 
      IDataRowGroup[T]
    ]
  ): IDataRowGroup[T] = js.native
  def reduce(
    callbackfn: js.Function4[
      /* previousValue */ IDataRowGroup[T], 
      /* currentValue */ IDataRowGroup[T], 
  ...
  /**
    ...
    */
  def splice(start: Double): js.Array[IDataRowGroup[T]] = js.native
  def splice(start: Double, deleteCount: Double): js.Array[IDataRowGroup[T]] = js.native
  /**
    * Removes elements from an array and, if necessary, inserts new elements in their place, returning the deleted elements.
    * @param start The zero-based location in the array from which to start removing elements.
    * @param deleteCount The number of elements to remove.
