...
trait DataResults[T] extends /* n */ NumberDictionary[T] {
  ...
  /**
    ...
    */
  def every(predicate: js.Function3[/* value */ T, /* index */ Double, /* array */ js.Array[T], _]): Boolean = js.native
  def every(
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def some(predicate: js.Function3[/* value */ T, /* index */ Double, /* array */ js.Array[T], _]): Boolean = js.native
  def some(
    predicate: js.Function3[/* value */ T, /* index */ Double, /* array */ js.Array[T], _],
    thisArg: js.Any
  ): Boolean = js.native
