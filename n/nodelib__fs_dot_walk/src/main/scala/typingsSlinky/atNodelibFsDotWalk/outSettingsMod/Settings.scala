...
trait Settings extends js.Object {
  ...
  val fsScandirSettings: typingsSlinky.atNodelibFsDotScandir.atNodelibFsDotScandirMod.Settings
...
object Settings {
  ...
  def apply(
    ...
    _options: js.Any,
    concurrency: Double,
    fsScandirSettings: typingsSlinky.atNodelibFsDotScandir.atNodelibFsDotScandirMod.Settings,
