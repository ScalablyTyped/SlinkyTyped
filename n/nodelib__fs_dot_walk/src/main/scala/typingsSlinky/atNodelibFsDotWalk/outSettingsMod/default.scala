package typingsSlinky.atNodelibFsDotWalk.outSettingsMod
...
class default () extends Settings {
  ...
  /* CompleteClass */
  override val fsScandirSettings: typingsSlinky.atNodelibFsDotScandir.atNodelibFsDotScandirMod.Settings = js.native
  /* CompleteClass */
