package typingsSlinky.atNodelibFsDotWalk.outProvidersSyncMod
...
trait SyncProvider extends js.Object {
  val _reader: typingsSlinky.atNodelibFsDotWalk.outReadersSyncMod.default
  val _root: js.Any
...
object SyncProvider {
  @scala.inline
  def apply(
    _reader: typingsSlinky.atNodelibFsDotWalk.outReadersSyncMod.default,
    _root: js.Any,
    _settings: js.Any,
    read: () => js.Array[Entry]
  ): SyncProvider = {
