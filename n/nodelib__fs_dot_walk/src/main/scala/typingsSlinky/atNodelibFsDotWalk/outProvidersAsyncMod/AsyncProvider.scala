package typingsSlinky.atNodelibFsDotWalk.outProvidersAsyncMod
...
trait AsyncProvider extends js.Object {
  val _reader: typingsSlinky.atNodelibFsDotWalk.outReadersAsyncMod.default
  val _root: js.Any
...
object AsyncProvider {
  @scala.inline
  def apply(
    _reader: typingsSlinky.atNodelibFsDotWalk.outReadersAsyncMod.default,
    _root: js.Any,
    _settings: js.Any,
    _storage: js.Any,
