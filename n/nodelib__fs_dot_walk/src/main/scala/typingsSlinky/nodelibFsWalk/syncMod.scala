...
object syncMod {
  ...
  object SyncProvider {
    ...
    @scala.inline
    def apply(
      _reader: typingsSlinky.nodelibFsWalk.readersSyncMod.default,
      _root: js.Any,
      _settings: js.Any,
      read: () => js.Array[Entry]
    ): SyncProvider = {
    ...
    implicit class SyncProviderMutableBuilder[Self <: SyncProvider] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def set_reader(value: typingsSlinky.nodelibFsWalk.readersSyncMod.default): Self = StObject.set(x, "_reader", value.asInstanceOf[js.Any])
