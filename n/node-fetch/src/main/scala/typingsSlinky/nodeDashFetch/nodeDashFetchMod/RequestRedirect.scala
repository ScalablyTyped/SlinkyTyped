...
object RequestRedirect {
  ...
  @scala.inline
  def error: typingsSlinky.nodeDashFetch.nodeDashFetchStrings.error = this.cast("error")
  @scala.inline
  def follow: typingsSlinky.nodeDashFetch.nodeDashFetchStrings.follow = this.cast("follow")
  @scala.inline
  def manual: typingsSlinky.nodeDashFetch.nodeDashFetchStrings.manual = this.cast("manual")
}
