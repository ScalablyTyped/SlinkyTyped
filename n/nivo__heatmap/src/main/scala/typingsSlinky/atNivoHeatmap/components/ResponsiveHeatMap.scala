...
import typingsSlinky.atNivoHeatmap.atNivoHeatmapMod.HeatMapSvgProps
...
object ResponsiveHeatMap
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoHeatmap.atNivoHeatmapMod.ResponsiveHeatMap] {
  ...
  def apply(
    ...
    onClick: (/* datum */ NodeData, /* event */ SyntheticMouseEvent[SVGGElement]) => Unit = null,
    padding: Int | Double = null,
    sizeVariation: Int | Double = null,
    theme: Theme = null,
    tooltipFormat: String | ValueFormatter = null,
    _overrides: StringDictionary[js.Any] = null
  ): BuildingComponent[tag.type, typingsSlinky.atNivoHeatmap.atNivoHeatmapMod.ResponsiveHeatMap] = {
