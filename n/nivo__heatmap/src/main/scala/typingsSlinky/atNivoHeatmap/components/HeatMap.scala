...
import typingsSlinky.atNivoHeatmap.HeatMapSvgPropsDimensions
...
object HeatMap
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoHeatmap.atNivoHeatmapMod.HeatMap] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoHeatmap.atNivoHeatmapMod.HeatMap] = {
  ...
  type Props = HeatMapSvgPropsDimensions
}
