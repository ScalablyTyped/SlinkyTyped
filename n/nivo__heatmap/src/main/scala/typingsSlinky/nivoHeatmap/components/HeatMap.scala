...
object HeatMap {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoHeatmap.mod.HeatMap] {
    @scala.inline
  ...
  def withProps(p: HeatMapSvgProps with Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(data: js.Array[HeatMapDatum], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[HeatMapSvgProps with Dimensions]))
  }
}
