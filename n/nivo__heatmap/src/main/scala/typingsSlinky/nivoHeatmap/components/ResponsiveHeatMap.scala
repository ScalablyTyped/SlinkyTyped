...
import typingsSlinky.nivoHeatmap.mod.HeatMapSvgProps
...
object ResponsiveHeatMap {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoHeatmap.mod.ResponsiveHeatMap] {
    @scala.inline
    ...
    @scala.inline
    def onClick(value: (/* datum */ NodeData, /* event */ SyntheticMouseEvent[SVGGElement]) => Unit): this.type = set("onClick", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps(p: HeatMapSvgProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(data: js.Array[HeatMapDatum]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[HeatMapSvgProps]))
  }
}
