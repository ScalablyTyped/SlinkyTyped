...
object ResponsiveHeatMap
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoHeatmap.mod.ResponsiveHeatMap] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoHeatmap.mod.ResponsiveHeatMap] = {
