...
object ResponsiveHeatMapCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoHeatmap.mod.ResponsiveHeatMapCanvas] {
  ...
  def withProps(p: HeatMapCanvasProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(data: js.Array[HeatMapDatum]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[HeatMapCanvasProps]))
  }
}
