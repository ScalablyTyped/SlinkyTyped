...
object ResponsiveHeatMapCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoHeatmap.mod.ResponsiveHeatMapCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoHeatmap.mod.ResponsiveHeatMapCanvas] = {
