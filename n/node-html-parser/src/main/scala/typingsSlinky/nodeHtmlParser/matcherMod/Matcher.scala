...
trait Matcher extends js.Object {
  ...
  /**
    ...
    */
  def advance(el: typingsSlinky.nodeHtmlParser.htmlMod.default): Boolean = js.native
  /**
...
object Matcher {
  @scala.inline
  def apply(
    advance: typingsSlinky.nodeHtmlParser.htmlMod.default => Boolean,
    flushCache: () => Unit,
    matched: () => Boolean,
    matchers: js.Any,
    nextMatch: js.Any,
  ...
  implicit class MatcherOps[Self <: Matcher] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdvance(value: typingsSlinky.nodeHtmlParser.htmlMod.default => Boolean): Self = this.set("advance", js.Any.fromFunction1(value))
    @scala.inline
