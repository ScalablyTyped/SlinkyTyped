...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.nivoCore.nivoCoreStrings.center
  - typingsSlinky.nivoCore.nivoCoreStrings.`top-left`
  - typingsSlinky.nivoCore.nivoCoreStrings.top
  - typingsSlinky.nivoCore.nivoCoreStrings.`top-right`
  - typingsSlinky.nivoCore.nivoCoreStrings.right
  - typingsSlinky.nivoCore.nivoCoreStrings.`bottom-right`
  - typingsSlinky.nivoCore.nivoCoreStrings.bottom
  - typingsSlinky.nivoCore.nivoCoreStrings.`bottom-left`
  - typingsSlinky.nivoCore.nivoCoreStrings.left
*/
