...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.nivoCore.nivoCoreStrings.ascending
  - typingsSlinky.nivoCore.nivoCoreStrings.descending
  - typingsSlinky.nivoCore.nivoCoreStrings.insideOut
  - typingsSlinky.nivoCore.nivoCoreStrings.none
  - typingsSlinky.nivoCore.nivoCoreStrings.reverse
*/
