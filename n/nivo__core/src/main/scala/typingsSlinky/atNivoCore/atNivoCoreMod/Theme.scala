...
import typingsSlinky.atNivoCore.PartialcontainerPartialCSSPropertiesbasicPartialCS
import typingsSlinky.atNivoCore.PartialdomainPartiallinePartialCSSPropertiesticksP
import typingsSlinky.atNivoCore.PartiallineColorstringlineStrokeWidthnumbertextCol
import typingsSlinky.atNivoCore.PartiallinePartialCSSProperties
import typingsSlinky.atNivoCore.PartialtextPartialCSSProperties
