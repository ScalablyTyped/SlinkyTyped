...
import typingsSlinky.atNivoCore.PartialCSSProperties
import typingsSlinky.atNivoCore.atNivoCoreStrings.x
import typingsSlinky.atNivoCore.atNivoCoreStrings.y
