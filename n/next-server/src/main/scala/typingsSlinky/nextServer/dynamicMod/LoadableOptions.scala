...
/* Inlined next-server.next-server/dist/lib/dynamic.LoadableBaseOptions<P> & {  render ? :(loader : any, props : any): react.react.<global>.JSX.Element} */
trait LoadableOptions[P] extends js.Object {
  ...
  var loading: js.UndefOr[js.Function1[/* hasErrorIsLoadingPastDelay */ Error, ReactElement | Null]] = js.undefined
...
object LoadableOptions {
  ...
  def apply[P](
    ...
    loading: /* hasErrorIsLoadingPastDelay */ Error => ReactElement | Null = null,
