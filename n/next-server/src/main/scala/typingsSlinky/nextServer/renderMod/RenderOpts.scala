...
trait RenderOpts extends js.Object {
  ...
  var ErrorDebug: js.UndefOr[ReactComponentClass[ErrorError]] = js.undefined
...
object RenderOpts {
  ...
  def apply(
    ...
    ErrorDebug: ReactComponentClass[ErrorError] = null,
    ampMode: js.Any = null,
    ampPath: String = null,
    ...
    err: js.UndefOr[Null | js.Error] = js.undefined,
