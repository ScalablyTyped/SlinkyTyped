...
object RenderOpts {
  ...
  implicit class RenderOptsOps[Self <: RenderOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorDebugFunctionComponent(value: ReactComponentClass[ErrorError]): Self = this.set("ErrorDebug", value.asInstanceOf[js.Any])
    @scala.inline
    def setErrorDebugComponentClass(value: ReactComponentClass[ErrorError]): Self = this.set("ErrorDebug", value.asInstanceOf[js.Any])
    @scala.inline
    def setErrorDebug(value: ReactComponentClass[ErrorError]): Self = this.set("ErrorDebug", value.asInstanceOf[js.Any])
    @scala.inline
