...
import typingsSlinky.nextServer.nextServerStrings.BUILD_ID
import typingsSlinky.nextServer.nextServerStrings.`build-manifestDotjson`
import typingsSlinky.nextServer.nextServerStrings.`pages-manifestDotjson`
import typingsSlinky.nextServer.nextServerStrings.`phase-development-server`
import typingsSlinky.nextServer.nextServerStrings.`phase-export`
import typingsSlinky.nextServer.nextServerStrings.`phase-production-build`
import typingsSlinky.nextServer.nextServerStrings.`phase-production-server`
import typingsSlinky.nextServer.nextServerStrings.`prerender-manifestDotjson`
import typingsSlinky.nextServer.nextServerStrings.`react-loadable-manifestDotjson`
import typingsSlinky.nextServer.nextServerStrings.nextDotconfigDotjs
import typingsSlinky.nextServer.nextServerStrings.public
import typingsSlinky.nextServer.nextServerStrings.runtime
import typingsSlinky.nextServer.nextServerStrings.server
import typingsSlinky.nextServer.nextServerStrings.serverless
import typingsSlinky.nextServer.nextServerStrings.static
