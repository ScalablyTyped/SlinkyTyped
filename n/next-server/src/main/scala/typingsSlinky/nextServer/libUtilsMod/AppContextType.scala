...
object AppContextType {
  @scala.inline
  def apply[/* <: typingsSlinky.nextServer.routerMod.NextRouter */ R](
    AppTree: AppType,
  ...
  @scala.inline
  implicit class AppContextTypeOps[Self <: AppContextType[_], /* <: typingsSlinky.nextServer.routerMod.NextRouter */ R] (val x: Self with AppContextType[R]) extends AnyVal {
    @scala.inline
