...
package object libUtilsMod {
  ...
  type ComponentsEnhancer = typingsSlinky.nextServer.AnonEnhanceApp | (typingsSlinky.nextServer.libUtilsMod.Enhancer[
  ...
  type NextComponentType[C /* <: typingsSlinky.nextServer.libUtilsMod.BaseContext */, IP, P] = slinky.core.ReactComponentClass[P] with (typingsSlinky.nextServer.AnonGetInitialProps[C, IP])
