...
import typingsSlinky.nextServer.anon.Default
...
object dynamicMod {
  ...
  trait DynamicOptions[P] extends StObject {
    ...
    /**
      ...
      */
    var render: js.UndefOr[js.Function2[/* props */ P, /* loaded */ js.Any, ReactElement]] = js.native
  ...
  object DynamicOptions {
    ...
    implicit class DynamicOptionsMutableBuilder[Self <: DynamicOptions[_], P] (val x: Self with DynamicOptions[P]) extends AnyVal {
      ...
      @scala.inline
      def setLoading(value: /* hasErrorIsLoadingPastDelay */ Error => ReactElement | Null): Self = StObject.set(x, "loading", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRender(value: (/* props */ P, /* loaded */ js.Any) => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
  ...
  object LoadableOptions {
    ...
    implicit class LoadableOptionsMutableBuilder[Self <: LoadableOptions[_], P] (val x: Self with LoadableOptions[P]) extends AnyVal {
      ...
      @scala.inline
      def setRender(value: (/* loader */ js.Any, /* props */ js.Any) => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
  ...
  type LoaderComponent[P] = js.Promise[ReactComponentClass[P] | Default[P]]
