...
import typingsSlinky.nodeIpc.nodeIpcStrings.connect
import typingsSlinky.nodeIpc.nodeIpcStrings.data
import typingsSlinky.nodeIpc.nodeIpcStrings.destroy
import typingsSlinky.nodeIpc.nodeIpcStrings.disconnect
import typingsSlinky.nodeIpc.nodeIpcStrings.error
import typingsSlinky.nodeIpc.nodeIpcStrings.hex
import typingsSlinky.nodeIpc.nodeIpcStrings.socketDotdisconnected
...
object mod {
  ...
  @js.native
  class IPC ()
    extends typingsSlinky.nodeIpc.mod.NodeIPC.IPC
  @JSImport("node-ipc", "IPC")
  @js.native
  def IPC: Instantiable0[typingsSlinky.nodeIpc.mod.NodeIPC.IPC] = js.native
  @scala.inline
  def IPC_=(x: Instantiable0[typingsSlinky.nodeIpc.mod.NodeIPC.IPC]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IPC")(x.asInstanceOf[js.Any])
