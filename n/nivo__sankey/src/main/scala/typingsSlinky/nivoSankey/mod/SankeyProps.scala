...
object SankeyProps {
  ...
  implicit class SankeyPropsOps[Self <: SankeyProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLinkTooltip(value: SankeyLinkDatum => ReactElement): Self = this.set("linkTooltip", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setNodeTooltip(value: SankeyNodeDatum => ReactElement): Self = this.set("nodeTooltip", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTooltipFormat(value: /* value */ Double => ReactElement): Self = this.set("tooltipFormat", js.Any.fromFunction1(value))
