...
import typingsSlinky.atNivoSankey.DataSankeyPropsDimensions
...
object Sankey
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoSankey.atNivoSankeyMod.Sankey] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoSankey.atNivoSankeyMod.Sankey] = {
  ...
  type Props = DataSankeyPropsDimensions
}
