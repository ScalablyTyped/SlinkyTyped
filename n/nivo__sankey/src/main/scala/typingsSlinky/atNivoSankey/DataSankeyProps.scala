...
import typingsSlinky.atNivoSankey.atNivoSankeyMod.SankeyMouseHandler
...
import typingsSlinky.atNivoSankey.atNivoSankeyMod.TooltipFormat
import typingsSlinky.atNivoSankey.atNivoSankeyMod.TooltipRenderer
...
object DataSankeyProps {
  ...
  def apply(
    ...
    onClick: (/* data */ SankeyNodeDatum | SankeyLinkDatum, /* event */ SyntheticMouseEvent[Element]) => Unit = null,
