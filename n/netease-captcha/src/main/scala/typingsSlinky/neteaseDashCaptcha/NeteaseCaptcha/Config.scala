package typingsSlinky.neteaseDashCaptcha.NeteaseCaptcha

import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.neteaseDashCaptcha.neteaseDashCaptchaStrings.`zh-CN`
import typingsSlinky.neteaseDashCaptcha.neteaseDashCaptchaStrings.embed
import typingsSlinky.neteaseDashCaptcha.neteaseDashCaptchaStrings.en
import typingsSlinky.neteaseDashCaptcha.neteaseDashCaptchaStrings.float
import typingsSlinky.neteaseDashCaptcha.neteaseDashCaptchaStrings.http
import typingsSlinky.neteaseDashCaptcha.neteaseDashCaptchaStrings.https
import typingsSlinky.neteaseDashCaptcha.neteaseDashCaptchaStrings.popup
