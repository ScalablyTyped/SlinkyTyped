...
object FlowsModule {
  ...
  implicit class FlowsModuleOps[Self <: FlowsModule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddFlow(value: typingsSlinky.nodeRedRuntime.anon.Flow => js.Promise[String]): Self = this.set("addFlow", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetFlows(value: typingsSlinky.nodeRedRuntime.anon.Flows => js.Promise[Rev]): Self = this.set("setFlows", js.Any.fromFunction1(value))
