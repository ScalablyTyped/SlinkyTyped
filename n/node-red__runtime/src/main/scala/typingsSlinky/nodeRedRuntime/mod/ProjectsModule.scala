...
object ProjectsModule {
  ...
  implicit class ProjectsModuleOps[Self <: ProjectsModule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetActiveProject(value: typingsSlinky.nodeRedRuntime.anon.User => js.Promise[js.Object]): Self = this.set("getActiveProject", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setListProjects(value: typingsSlinky.nodeRedRuntime.anon.User => js.Promise[Unit]): Self = this.set("listProjects", js.Any.fromFunction1(value))
