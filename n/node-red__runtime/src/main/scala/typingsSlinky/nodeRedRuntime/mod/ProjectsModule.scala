...
import typingsSlinky.nodeRedRuntime.anon.AllowUnrelatedHistories
import typingsSlinky.nodeRedRuntime.anon.Before
import typingsSlinky.nodeRedRuntime.anon.Branch
import typingsSlinky.nodeRedRuntime.anon.Create
import typingsSlinky.nodeRedRuntime.anon.Force
import typingsSlinky.nodeRedRuntime.anon.IdPath
import typingsSlinky.nodeRedRuntime.anon.IdProject
import typingsSlinky.nodeRedRuntime.anon.IdRemote
import typingsSlinky.nodeRedRuntime.anon.IdRemoteReq
import typingsSlinky.nodeRedRuntime.anon.Message
import typingsSlinky.nodeRedRuntime.anon.PathReq
import typingsSlinky.nodeRedRuntime.anon.Project
import typingsSlinky.nodeRedRuntime.anon.Remote
import typingsSlinky.nodeRedRuntime.anon.RemoteReq
import typingsSlinky.nodeRedRuntime.anon.ReqType
import typingsSlinky.nodeRedRuntime.anon.ReqUser
import typingsSlinky.nodeRedRuntime.anon.Resolutions
import typingsSlinky.nodeRedRuntime.anon.Sha
import typingsSlinky.nodeRedRuntime.anon.Track
import typingsSlinky.nodeRedRuntime.anon.Tree
...
trait ProjectsModule extends StObject {
  ...
  /**
    ...
    */
  def getActiveProject(opts: typingsSlinky.nodeRedRuntime.anon.User): js.Promise[js.Object] = js.native
  ...
  /**
    ...
    * @returns resolves when complete
    */
  def listProjects(opts: typingsSlinky.nodeRedRuntime.anon.User): js.Promise[Unit] = js.native
...
object ProjectsModule {
  ...
  def apply(
    ...
    getActiveProject: typingsSlinky.nodeRedRuntime.anon.User => js.Promise[js.Object],
    ...
    listProjects: typingsSlinky.nodeRedRuntime.anon.User => js.Promise[Unit],
  ...
  implicit class ProjectsModuleMutableBuilder[Self <: ProjectsModule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetActiveProject(value: typingsSlinky.nodeRedRuntime.anon.User => js.Promise[js.Object]): Self = StObject.set(x, "getActiveProject", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setListProjects(value: typingsSlinky.nodeRedRuntime.anon.User => js.Promise[Unit]): Self = StObject.set(x, "listProjects", js.Any.fromFunction1(value))
