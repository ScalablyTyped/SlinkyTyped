...
@js.native
trait IdRemote extends js.Object {
...
object IdRemote {
  ...
  @scala.inline
  implicit class IdRemoteOps[Self <: IdRemote] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRemote(value: Name): Self = this.set("remote", value.asInstanceOf[js.Any])
