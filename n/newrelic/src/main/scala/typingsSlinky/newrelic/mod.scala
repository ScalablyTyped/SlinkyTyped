...
object mod {
  ...
  @JSImport("newrelic", "addIgnoringRule")
  @js.native
  def addIgnoringRule(pattern: js.RegExp): Unit = js.native
  ...
  @JSImport("newrelic", "addNamingRule")
  @js.native
  def addNamingRule(pattern: js.RegExp, name: String): Unit = js.native
  ...
  @JSImport("newrelic", "noticeError")
  @js.native
  def noticeError(error: js.Error, customAttributes: StringDictionary[String | Double | Boolean]): Unit = js.native
  ...
  @JSImport("newrelic", "shutdown")
  @js.native
  def shutdown(options: js.UndefOr[scala.Nothing], cb: js.Function1[/* error */ js.UndefOr[js.Error], Unit]): Unit = js.native
  @JSImport("newrelic", "shutdown")
  @js.native
  def shutdown(options: CollectPendingData): Unit = js.native
  @JSImport("newrelic", "shutdown")
  @js.native
  def shutdown(options: CollectPendingData, cb: js.Function1[/* error */ js.UndefOr[js.Error], Unit]): Unit = js.native
