...
import typingsSlinky.netlifyDashIdentityDashWidget.Anon_ApiURL
import typingsSlinky.netlifyDashIdentityDashWidget.Anon_Avatarurl
import typingsSlinky.netlifyDashIdentityDashWidget.Anon_Provider
