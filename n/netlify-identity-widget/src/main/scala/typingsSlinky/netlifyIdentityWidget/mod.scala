...
import typingsSlinky.netlifyIdentityWidget.netlifyIdentityWidgetStrings.close
import typingsSlinky.netlifyIdentityWidget.netlifyIdentityWidgetStrings.error
import typingsSlinky.netlifyIdentityWidget.netlifyIdentityWidgetStrings.init
import typingsSlinky.netlifyIdentityWidget.netlifyIdentityWidgetStrings.login
import typingsSlinky.netlifyIdentityWidget.netlifyIdentityWidgetStrings.logout
import typingsSlinky.netlifyIdentityWidget.netlifyIdentityWidgetStrings.open
import typingsSlinky.netlifyIdentityWidget.netlifyIdentityWidgetStrings.signup
...
object mod {
  ...
  @JSImport("netlify-identity-widget", "off")
  @js.native
  def off_error(event: error, cb: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  @JSImport("netlify-identity-widget", "off")
  @js.native
  ...
  @JSImport("netlify-identity-widget", "on")
  @js.native
  def on_error(event: error, cb: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  @JSImport("netlify-identity-widget", "on")
  @js.native
