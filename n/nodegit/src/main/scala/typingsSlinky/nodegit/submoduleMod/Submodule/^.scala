...
object ^ extends js.Object {
  def addSetup(repo: Repository, url: String, path: String, useGitLink: Double): js.Promise[typingsSlinky.nodegit.submoduleMod.Submodule] = js.native
  ...
  def lookup(repo: Repository, name: String): js.Promise[typingsSlinky.nodegit.submoduleMod.Submodule] = js.native
