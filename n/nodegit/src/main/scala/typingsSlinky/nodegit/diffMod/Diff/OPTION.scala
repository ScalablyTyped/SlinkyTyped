...
object OPTION {
  @scala.inline
  def DISABLE_PATHSPEC_MATCH: `4096` = this.cast(4096)
  @scala.inline
  def ENABLE_FAST_UNTRACKED_DIRS: `16384` = this.cast(16384)
  @scala.inline
  def FORCE_BINARY: `2097152` = this.cast(2097152)
  @scala.inline
  def FORCE_TEXT: `1048576` = this.cast(1048576)
  @scala.inline
  def IGNORE_CASE: `1024` = this.cast(1024)
  @scala.inline
  def IGNORE_FILEMODE: `256` = this.cast(256)
  @scala.inline
  def IGNORE_SUBMODULES: `512` = this.cast(512)
  @scala.inline
  def IGNORE_WHITESPACE: `4194304` = this.cast(4194304)
  @scala.inline
  def IGNORE_WHITESPACE_CHANGE: `8388608` = this.cast(8388608)
  @scala.inline
  def IGNORE_WHITESPACE_EOL: `16777216` = this.cast(16777216)
  @scala.inline
  def INCLUDE_CASECHANGE: `2048` = this.cast(2048)
  @scala.inline
  def INCLUDE_IGNORED: `2` = this.cast(2)
  @scala.inline
  def INCLUDE_TYPECHANGE: `64` = this.cast(64)
  @scala.inline
  def INCLUDE_TYPECHANGE_TREES: `128` = this.cast(128)
  @scala.inline
  def INCLUDE_UNMODIFIED: `32` = this.cast(32)
  @scala.inline
  def INCLUDE_UNREADABLE: `65536` = this.cast(65536)
  @scala.inline
  def INCLUDE_UNREADABLE_AS_UNTRACKED: `131072` = this.cast(131072)
  @scala.inline
  def INCLUDE_UNTRACKED: `8` = this.cast(8)
  @scala.inline
  def MINIMAL: `536870912` = this.cast(536870912)
  @scala.inline
  def NORMAL: `0` = this.cast(0)
  @scala.inline
  def PATIENCE: `268435456` = this.cast(268435456)
  @scala.inline
  def RECURSE_IGNORED_DIRS: `4` = this.cast(4)
  @scala.inline
  def RECURSE_UNTRACKED_DIRS: `16` = this.cast(16)
  @scala.inline
  def REVERSE: `1` = this.cast(1)
  @scala.inline
  def SHOW_BINARY: `1073741824` = this.cast(1073741824)
  @scala.inline
  def SHOW_UNMODIFIED: `67108864` = this.cast(67108864)
  @scala.inline
  def SHOW_UNTRACKED_CONTENT: `33554432` = this.cast(33554432)
  @scala.inline
  def SKIP_BINARY_CHECK: `8192` = this.cast(8192)
  @scala.inline
  def UPDATE_INDEX: `32768` = this.cast(32768)
  @scala.inline
