...
import typingsSlinky.nodegit.convenientDashHunkMod.ConvenientHunk
import typingsSlinky.nodegit.diffDashFileMod.DiffFile
...
@js.native
object convenientDashPatchMod extends js.Object {
  @js.native
