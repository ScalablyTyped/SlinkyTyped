...
object Tree extends js.Object {
  def entryCmp(
    tree1: typingsSlinky.nodegit.treeDashEntryMod.TreeEntry,
    tree2: typingsSlinky.nodegit.treeDashEntryMod.TreeEntry
  ): Double = js.native
  def entryDup(
    dest: typingsSlinky.nodegit.treeDashEntryMod.TreeEntry,
    source: typingsSlinky.nodegit.treeDashEntryMod.TreeEntry
  ): Double = js.native
  /**
