...
object Checkout extends js.Object {
  ...
  def head(
    ...
    options: typingsSlinky.nodegit.checkoutDashOptionsMod.CheckoutOptions
  ...
  def initOptions(opts: typingsSlinky.nodegit.checkoutDashOptionsMod.CheckoutOptions, version: Double): Double = js.native
  def tree(
    repo: typingsSlinky.nodegit.repositoryMod.Repository,
