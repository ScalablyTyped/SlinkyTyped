...
object Transport extends js.Object {
  ...
  def sshWithPaths(
    owner: typingsSlinky.nodegit.remoteMod.Remote,
    payload: typingsSlinky.nodegit.strDashArrayMod.Strarray
  ): js.Promise[typingsSlinky.nodegit.transportMod.Transport] = js.native
