...
object ResponsiveChoroplethCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveChoroplethCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveChoroplethCanvas] = {
