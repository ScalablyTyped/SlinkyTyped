...
import typingsSlinky.nivoGeo.mod.GeoMapProps
...
object GeoMap {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoGeo.mod.GeoMap] {
    @scala.inline
  ...
  def withProps(p: GeoMapProps with Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(features: js.Array[_], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[GeoMapProps with Dimensions]))
  }
}
