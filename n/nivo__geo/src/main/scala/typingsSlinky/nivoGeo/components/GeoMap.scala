...
object GeoMap
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoGeo.mod.GeoMap] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoGeo.mod.GeoMap] = {
  ...
  type Props = GeoMapProps with Dimensions
}
