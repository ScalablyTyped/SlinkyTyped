...
object ResponsiveGeoMap
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveGeoMap] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveGeoMap] = {
