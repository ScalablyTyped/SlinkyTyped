...
import typingsSlinky.nivoGeo.mod.GeoMapCommonProps
...
object ResponsiveGeoMap {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveGeoMap] {
  ...
  def withProps(p: GeoMapCommonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(features: js.Array[_]): Builder = {
    val __props = js.Dynamic.literal(features = features.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[GeoMapCommonProps]))
  }
}
