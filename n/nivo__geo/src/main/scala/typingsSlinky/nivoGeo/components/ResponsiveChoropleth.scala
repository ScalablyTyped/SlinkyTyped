...
import typingsSlinky.nivoGeo.mod.ChoroplethCommonProps
...
object ResponsiveChoropleth {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveChoropleth] {
    @scala.inline
  ...
  def withProps(p: ChoroplethCommonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(data: js.Array[_], domain: js.Array[Double], features: js.Array[_]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ChoroplethCommonProps]))
  }
}
