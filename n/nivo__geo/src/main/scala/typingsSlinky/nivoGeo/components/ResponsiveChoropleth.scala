...
object ResponsiveChoropleth
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveChoropleth] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoGeo.mod.ResponsiveChoropleth] = {
