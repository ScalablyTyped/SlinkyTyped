...
object GeoMapCommonProps {
  ...
  implicit class GeoMapCommonPropsOps[Self <: GeoMapCommonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* feature */ js.Any, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    
    @scala.inline
    def setOnMouseEnter(value: (/* feature */ js.Any, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: (/* feature */ js.Any, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnMouseLeave: Self = this.set("onMouseLeave", js.undefined)
    
    @scala.inline
    def setOnMouseMove(value: (/* feature */ js.Any, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onMouseMove", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnMouseMove: Self = this.set("onMouseMove", js.undefined)
    
    @scala.inline
    def setTooltip(value: ReactComponentClass[Feature]): Self = this.set("tooltip", value.asInstanceOf[js.Any])
