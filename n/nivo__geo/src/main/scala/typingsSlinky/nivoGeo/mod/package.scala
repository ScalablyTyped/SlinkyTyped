...
package object mod {
  ...
  type ChoroplethTooltip = slinky.core.ReactComponentClass[typingsSlinky.nivoGeo.AnonFeatureChoroplethBoundFeature]
  ...
  type GeoMapTooltip = slinky.core.ReactComponentClass[typingsSlinky.nivoGeo.AnonFeature]
}
