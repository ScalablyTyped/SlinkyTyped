...
import typingsSlinky.atNivoGeo.ChoroplethPropsDimensions
...
object Choropleth
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.Choropleth] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.Choropleth] = {
  ...
  type Props = ChoroplethPropsDimensions
}
