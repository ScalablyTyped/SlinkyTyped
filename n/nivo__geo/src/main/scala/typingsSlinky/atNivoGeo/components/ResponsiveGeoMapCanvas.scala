...
import typingsSlinky.atNivoGeo.atNivoGeoMod.GeoMapCanvasProps
...
object ResponsiveGeoMapCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveGeoMapCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveGeoMapCanvas] = {
