...
import typingsSlinky.atNivoGeo.atNivoGeoMod.ChoroplethBoundFeature
import typingsSlinky.atNivoGeo.atNivoGeoMod.ChoroplethCanvasProps
import typingsSlinky.atNivoGeo.atNivoGeoMod.DatumMatcher
...
object ResponsiveChoroplethCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveChoroplethCanvas] {
  ...
  def apply(
    ...
    tooltip: ReactComponentClass[Anon_FeatureChoroplethBoundFeature] = null,
    unknownColor: String = null,
    valueFormat: String | (FeatureAccessor[_, String | Double]) = null,
    _overrides: StringDictionary[js.Any] = null
  ): BuildingComponent[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveChoroplethCanvas] = {
  ...
  type Props = ChoroplethCanvasProps
}
