...
import typingsSlinky.atNivoGeo.atNivoGeoMod.ChoroplethProps
...
object ResponsiveChoropleth
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveChoropleth] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveChoropleth] = {
