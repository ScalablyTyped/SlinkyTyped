...
import typingsSlinky.atNivoGeo.atNivoGeoMod.GeoMapProps
...
object ResponsiveGeoMap
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveGeoMap] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ResponsiveGeoMap] = {
