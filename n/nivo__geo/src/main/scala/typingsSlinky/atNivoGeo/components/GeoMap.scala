...
import typingsSlinky.atNivoGeo.GeoMapPropsDimensions
...
object GeoMap
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.GeoMap] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.GeoMap] = {
  ...
  type Props = GeoMapPropsDimensions
}
