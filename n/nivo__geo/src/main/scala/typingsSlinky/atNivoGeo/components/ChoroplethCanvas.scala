...
object ChoroplethCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ChoroplethCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoGeo.atNivoGeoMod.ChoroplethCanvas] = {
  ...
  type Props = ChoroplethCanvasPropsDimensions
}
