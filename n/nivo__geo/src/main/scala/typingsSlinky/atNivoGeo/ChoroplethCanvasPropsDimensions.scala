...
import typingsSlinky.atNivoGeo.atNivoGeoMod.ChoroplethEventHandler
...
/* Inlined @nivo/geo.@nivo/geo.ChoroplethCanvasProps & @nivo/core.@nivo/core.Dimensions */
trait ChoroplethCanvasPropsDimensions extends js.Object {
...
object ChoroplethCanvasPropsDimensions {
  @scala.inline
  def apply(
    data: js.Array[_],
  ...
  ): ChoroplethCanvasPropsDimensions = {
    ...
    __obj.asInstanceOf[ChoroplethCanvasPropsDimensions]
  }
}
