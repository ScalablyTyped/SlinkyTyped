...
object ResponsiveVoroinoi
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoVoronoi.mod.ResponsiveVoroinoi] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoVoronoi.mod.ResponsiveVoroinoi] = {
