...
import typingsSlinky.atNivoVoronoi.VoronoiPropsDimensions
...
object Voronoi
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoVoronoi.atNivoVoronoiMod.Voronoi] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoVoronoi.atNivoVoronoiMod.Voronoi] = {
  ...
  type Props = VoronoiPropsDimensions
}
