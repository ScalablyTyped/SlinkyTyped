...
object Calendar {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoCalendar.mod.Calendar] {
    @scala.inline
  ...
  def withProps(p: CalendarSvgProps with Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(data: js.Array[CalendarDatum], from: DateOrString, height: Double, to: DateOrString, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CalendarSvgProps with Dimensions]))
  }
}
