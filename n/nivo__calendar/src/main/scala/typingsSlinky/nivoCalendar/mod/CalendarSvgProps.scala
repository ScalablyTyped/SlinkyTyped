...
object CalendarSvgProps {
  ...
  implicit class CalendarSvgPropsOps[Self <: CalendarSvgProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMonthLegend(value: (/* year */ Double, /* month */ Double, /* date */ js.Date) => String | Double): Self = this.set("monthLegend", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setOnClick(value: (/* datum */ CalendarDayData, /* event */ SyntheticMouseEvent[SVGRectElement]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setTooltip(value: ReactComponentClass[CalendarDayData]): Self = this.set("tooltip", value.asInstanceOf[js.Any])
