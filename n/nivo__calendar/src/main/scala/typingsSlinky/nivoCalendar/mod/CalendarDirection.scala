...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.nivoCalendar.nivoCalendarStrings.horizontal
  - typingsSlinky.nivoCalendar.nivoCalendarStrings.vertical
*/
trait CalendarDirection extends js.Object
