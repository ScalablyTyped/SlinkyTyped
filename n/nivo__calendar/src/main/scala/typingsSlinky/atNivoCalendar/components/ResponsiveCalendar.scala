...
import typingsSlinky.atNivoCalendar.atNivoCalendarMod.CalendarSvgProps
...
object ResponsiveCalendar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoCalendar.atNivoCalendarMod.ResponsiveCalendar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoCalendar.atNivoCalendarMod.ResponsiveCalendar] = {
