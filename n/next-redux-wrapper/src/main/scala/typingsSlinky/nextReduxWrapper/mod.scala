...
import typingsSlinky.nextReduxWrapper.anon.FunctionComponentWrapperP
...
object mod {
  ...
  */
  ...
  object _Context {
    ...
    @scala.inline
    def GetServerSidePropsContext(query: ParsedUrlQuery, req: IncomingMessage, res: ServerResponse): typingsSlinky.nextReduxWrapper.mod.GetServerSidePropsContext = {
      val __obj = js.Dynamic.literal(query = query.asInstanceOf[js.Any], req = req.asInstanceOf[js.Any], res = res.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nextReduxWrapper.mod.GetServerSidePropsContext]
    }
    
    @scala.inline
    def GetStaticPropsContext(): typingsSlinky.nextReduxWrapper.mod.GetStaticPropsContext = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.nextReduxWrapper.mod.GetStaticPropsContext]
    }
  }
  ...
  object nextDistNextServerLibUtilsAugmentingMod {
    ...
    object NextPageContext {
      ...
      @scala.inline
      def apply[S, A /* <: Action[_] */](store: Store[S, A]): typingsSlinky.nextReduxWrapper.mod.nextDistNextServerLibUtilsAugmentingMod.NextPageContext[S, A] = {
        val __obj = js.Dynamic.literal(store = store.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.nextReduxWrapper.mod.nextDistNextServerLibUtilsAugmentingMod.NextPageContext[S, A]]
      }
      
      @scala.inline
      implicit class NextPageContextMutableBuilder[Self <: typingsSlinky.nextReduxWrapper.mod.nextDistNextServerLibUtilsAugmentingMod.NextPageContext[_, _], S, A /* <: Action[_] */] (val x: Self with (typingsSlinky.nextReduxWrapper.mod.nextDistNextServerLibUtilsAugmentingMod.NextPageContext[S, A])) extends AnyVal {
