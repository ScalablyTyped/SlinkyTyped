...
object InitStoreOptions {
  @scala.inline
  def apply[S, /* <: typingsSlinky.redux.mod.Action[_] */ A](config: Config[S], context: Context, makeStore: /* context */ Context => Store[S, A]): InitStoreOptions[S, A] = {
  ...
  @scala.inline
  implicit class InitStoreOptionsOps[Self <: InitStoreOptions[_, _], S, /* <: typingsSlinky.redux.mod.Action[_] */ A] (val x: Self with (InitStoreOptions[S, A])) extends AnyVal {
    @scala.inline
