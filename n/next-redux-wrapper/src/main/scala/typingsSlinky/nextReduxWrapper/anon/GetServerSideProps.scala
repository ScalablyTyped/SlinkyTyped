...
object GetServerSideProps {
  @scala.inline
  def apply[/* <: js.Object */ S, /* <: typingsSlinky.redux.mod.Action[_] */ A](
  ...
  @scala.inline
  implicit class GetServerSidePropsOps[Self <: GetServerSideProps[_, _], /* <: js.Object */ S, /* <: typingsSlinky.redux.mod.Action[_] */ A] (val x: Self with (GetServerSideProps[S, A])) extends AnyVal {
    @scala.inline
