...
@js.native
object srcServicesScrollDashResolverMod extends js.Object {
  def getScrollStats(lastScrollPosition: Double, container: IPositionStats, distance: IScrollerDistance): Anon_Fire = js.native
