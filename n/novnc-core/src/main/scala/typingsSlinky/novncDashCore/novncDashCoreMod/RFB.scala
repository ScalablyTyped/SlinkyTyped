...
import typingsSlinky.novncDashCore.libInputDevicesMod.Keyboard
import typingsSlinky.novncDashCore.libInputDevicesMod.Mouse
...
trait RFB extends js.Object {
  ...
  def get_display(): typingsSlinky.novncDashCore.libDisplayMod.default = js.native
