...
import typingsSlinky.ngDashGrid.ngGrid.IRow
import typingsSlinky.ngDashGrid.ngGrid.IRowConfig
import typingsSlinky.ngDashGrid.ngGrid.IRowStatic
import typingsSlinky.ngDashGrid.ngGrid.ISelectionProvider
