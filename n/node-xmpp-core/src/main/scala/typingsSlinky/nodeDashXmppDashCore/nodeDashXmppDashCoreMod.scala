package typingsSlinky.nodeDashXmppDashCore
...
object nodeDashXmppDashCoreMod extends js.Object {
  ...
  class Element protected ()
    extends typingsSlinky.ltx.ltxMod.Element {
  ...
  def createStanza(name: String): typingsSlinky.ltx.ltxMod.Element = js.native
  def createStanza(name: String, attrs: js.Any): typingsSlinky.ltx.ltxMod.Element = js.native
