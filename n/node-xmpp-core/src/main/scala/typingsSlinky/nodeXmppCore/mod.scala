package typingsSlinky.nodeXmppCore
...
object mod extends js.Object {
  ...
  class Element protected ()
    extends typingsSlinky.ltx.mod.Element {
  ...
  def createStanza(name: String): typingsSlinky.ltx.mod.Element = js.native
  def createStanza(name: String, attrs: js.Any): typingsSlinky.ltx.mod.Element = js.native
