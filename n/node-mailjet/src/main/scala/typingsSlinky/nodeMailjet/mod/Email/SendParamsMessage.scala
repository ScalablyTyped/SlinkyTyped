...
trait SendParamsMessage extends js.Object {
  ...
  var From: typingsSlinky.nodeMailjet.anon.Email
  ...
  var Sender: js.UndefOr[typingsSlinky.nodeMailjet.anon.Email] = js.undefined
  var Subject: String
...
object SendParamsMessage {
  @scala.inline
  def apply(
    From: typingsSlinky.nodeMailjet.anon.Email,
    Subject: String,
    ...
    Sender: typingsSlinky.nodeMailjet.anon.Email = null,
