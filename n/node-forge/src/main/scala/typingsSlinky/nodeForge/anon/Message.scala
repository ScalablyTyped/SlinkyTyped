...
object Message {
  ...
  implicit class MessageOps[Self <: Message] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessageUint8Array(value: js.typedarray.Uint8Array): Self = this.set("message", value.asInstanceOf[js.Any])
    @scala.inline
    def setMessage(value: NativeBuffer | ByteBuffer): Self = this.set("message", value.asInstanceOf[js.Any])
  }
