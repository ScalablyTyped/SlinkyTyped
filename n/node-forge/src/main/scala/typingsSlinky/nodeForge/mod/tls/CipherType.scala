...
object CipherType extends StObject {
  ...
  /* 2 */ val aead: typingsSlinky.nodeForge.mod.tls.CipherType.aead with Double = js.native
  
  @js.native
  sealed trait block extends CipherType
  /* 1 */ val block: typingsSlinky.nodeForge.mod.tls.CipherType.block with Double = js.native
  
  @js.native
  sealed trait stream extends CipherType
  /* 0 */ val stream: typingsSlinky.nodeForge.mod.tls.CipherType.stream with Double = js.native
}
