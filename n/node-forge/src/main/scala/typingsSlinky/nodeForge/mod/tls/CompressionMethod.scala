...
object CompressionMethod extends StObject {
  ...
  /* 1 */ val deflate: typingsSlinky.nodeForge.mod.tls.CompressionMethod.deflate with Double = js.native
  
  @js.native
  sealed trait none extends CompressionMethod
  /* 0 */ val none: typingsSlinky.nodeForge.mod.tls.CompressionMethod.none with Double = js.native
}
