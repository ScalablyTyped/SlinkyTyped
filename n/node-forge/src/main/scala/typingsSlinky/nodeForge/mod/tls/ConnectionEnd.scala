...
object ConnectionEnd extends StObject {
  ...
  /* 1 */ val client: typingsSlinky.nodeForge.mod.tls.ConnectionEnd.client with Double = js.native
  
  @js.native
  sealed trait server extends ConnectionEnd
  /* 0 */ val server: typingsSlinky.nodeForge.mod.tls.ConnectionEnd.server with Double = js.native
}
