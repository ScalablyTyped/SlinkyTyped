...
object HeartbeatMessageType extends StObject {
  ...
  /* 1 */ val heartbeat_request: typingsSlinky.nodeForge.mod.tls.HeartbeatMessageType.heartbeat_request with Double = js.native
  
  @js.native
  sealed trait heartbeat_response extends HeartbeatMessageType
  /* 2 */ val heartbeat_response: typingsSlinky.nodeForge.mod.tls.HeartbeatMessageType.heartbeat_response with Double = js.native
}
