...
object util {
  ...
  object binary {
    ...
    object base64 {
      ...
      @JSImport("node-forge", "util.binary.base64.decode")
      @js.native
      def decode(input: Base64, output: js.UndefOr[scala.Nothing], offset: Double): js.typedarray.Uint8Array = js.native
      @JSImport("node-forge", "util.binary.base64.decode")
      @js.native
    ...
    object hex {
      ...
      @JSImport("node-forge", "util.binary.hex.decode")
      @js.native
      def decode(hex: Hex, output: js.UndefOr[scala.Nothing], offset: Double): js.typedarray.Uint8Array = js.native
      @JSImport("node-forge", "util.binary.hex.decode")
      @js.native
    ...
    object raw {
      ...
      @JSImport("node-forge", "util.binary.raw.decode")
      @js.native
      def decode(str: Bytes, output: js.UndefOr[scala.Nothing], offset: Double): js.typedarray.Uint8Array = js.native
      @JSImport("node-forge", "util.binary.raw.decode")
      @js.native
  ...
  @JSImport("node-forge", "util.createBuffer")
  @js.native
  def createBuffer(input: js.typedarray.ArrayBuffer): ByteBuffer = js.native
  @JSImport("node-forge", "util.createBuffer")
  @js.native
  def createBuffer(input: js.typedarray.ArrayBuffer, encoding: Encoding): ByteBuffer = js.native
  @JSImport("node-forge", "util.createBuffer")
  @js.native
