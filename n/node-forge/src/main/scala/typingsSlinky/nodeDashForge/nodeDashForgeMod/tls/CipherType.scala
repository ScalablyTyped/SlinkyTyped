...
object CipherType extends js.Object {
  ...
  /* 2 */ val aead: typingsSlinky.nodeDashForge.nodeDashForgeMod.tls.CipherType.aead with Double = js.native
  /* 1 */ val block: typingsSlinky.nodeDashForge.nodeDashForgeMod.tls.CipherType.block with Double = js.native
  /* 0 */ val stream: typingsSlinky.nodeDashForge.nodeDashForgeMod.tls.CipherType.stream with Double = js.native
  @JSBracketAccess
