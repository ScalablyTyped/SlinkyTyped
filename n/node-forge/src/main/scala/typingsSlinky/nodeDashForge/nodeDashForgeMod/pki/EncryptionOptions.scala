...
import typingsSlinky.nodeDashForge.nodeDashForgeStrings.sha1
import typingsSlinky.nodeDashForge.nodeDashForgeStrings.sha224
import typingsSlinky.nodeDashForge.nodeDashForgeStrings.sha256
import typingsSlinky.nodeDashForge.nodeDashForgeStrings.sha384
import typingsSlinky.nodeDashForge.nodeDashForgeStrings.sha512
