...
import typingsSlinky.nodeDashForge.nodeDashForgeMod.cipher.Algorithm
import typingsSlinky.nodeDashForge.nodeDashForgeMod.pki.rsa._EncryptionScheme
import typingsSlinky.nodeDashForge.nodeDashForgeMod.pki.rsa._SignatureScheme
...
object nodeDashForgeStrings {
  ...
  @js.native
  sealed trait md5
    extends typingsSlinky.nodeDashForge.nodeDashForgeMod.hmac.Algorithm
