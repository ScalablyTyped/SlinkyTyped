package typingsSlinky.nodemailerDashSmtpDashTransport.nodemailerDashSmtpDashTransportMod

import typingsSlinky.node.tlsMod.ConnectionOptions
import typingsSlinky.nodemailerDashSmtpDashTransport.Anon_MaxConnections
...
trait SmtpOptions extends js.Object {
  ...
  /**
    ...
    */
  var pool: js.UndefOr[Anon_MaxConnections] = js.undefined
  /**
