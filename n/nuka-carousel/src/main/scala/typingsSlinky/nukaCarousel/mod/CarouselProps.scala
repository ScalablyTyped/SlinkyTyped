...
trait CarouselProps extends js.Object {
  ...
  /**
    ...
    */
  var innerRef: js.UndefOr[ReactRef[HTMLInputElement]] = js.undefined
  /**
...
object CarouselProps {
  ...
  def apply(
    ...
    innerRef: ReactRef[HTMLInputElement] = null,
    ...
    renderBottomCenterControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderBottomLeftControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderBottomRightControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderCenterCenterControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderCenterLeftControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderCenterRightControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderTopCenterControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderTopLeftControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    renderTopRightControls: js.UndefOr[Null | (/* props */ CarouselSlideRenderControlProps => TagMod[Any])] = js.undefined,
    ...
    if (!js.isUndefined(renderBottomCenterControls)) __obj.updateDynamic("renderBottomCenterControls")(if (renderBottomCenterControls != null) js.Any.fromFunction1(renderBottomCenterControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderBottomLeftControls)) __obj.updateDynamic("renderBottomLeftControls")(if (renderBottomLeftControls != null) js.Any.fromFunction1(renderBottomLeftControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderBottomRightControls)) __obj.updateDynamic("renderBottomRightControls")(if (renderBottomRightControls != null) js.Any.fromFunction1(renderBottomRightControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderCenterCenterControls)) __obj.updateDynamic("renderCenterCenterControls")(if (renderCenterCenterControls != null) js.Any.fromFunction1(renderCenterCenterControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderCenterLeftControls)) __obj.updateDynamic("renderCenterLeftControls")(if (renderCenterLeftControls != null) js.Any.fromFunction1(renderCenterLeftControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderCenterRightControls)) __obj.updateDynamic("renderCenterRightControls")(if (renderCenterRightControls != null) js.Any.fromFunction1(renderCenterRightControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderTopCenterControls)) __obj.updateDynamic("renderTopCenterControls")(if (renderTopCenterControls != null) js.Any.fromFunction1(renderTopCenterControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderTopLeftControls)) __obj.updateDynamic("renderTopLeftControls")(if (renderTopLeftControls != null) js.Any.fromFunction1(renderTopLeftControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
    if (!js.isUndefined(renderTopRightControls)) __obj.updateDynamic("renderTopRightControls")(if (renderTopRightControls != null) js.Any.fromFunction1(renderTopRightControls.asInstanceOf[/* props */ CarouselSlideRenderControlProps => TagMod[Any]]) else null)
