...
import typingsSlinky.nukaCarousel.mod.NextButtonProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object NextButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nukaCarousel.mod.NextButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nukaCarousel.mod.NextButton] = {
