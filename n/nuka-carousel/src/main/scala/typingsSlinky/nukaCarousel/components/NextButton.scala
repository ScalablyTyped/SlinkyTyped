...
object NextButton {
  ...
  def withProps(p: CarouselSlideRenderControlProps): Default[tag.type, typingsSlinky.nukaCarousel.mod.NextButton] = new Default[tag.type, typingsSlinky.nukaCarousel.mod.NextButton](js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    ...
    slidesToShow: Double,
    wrapAround: Boolean
  ): Default[tag.type, typingsSlinky.nukaCarousel.mod.NextButton] = {
    ...
    new Default[tag.type, typingsSlinky.nukaCarousel.mod.NextButton](js.Array(this.component, __props.asInstanceOf[CarouselSlideRenderControlProps]))
  }
}
