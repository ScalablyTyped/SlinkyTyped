...
trait CarouselProps extends js.Object {
  ...
  {[ slideAction in nuka-carousel.nuka-carousel.CarouselSlideActions ]:? std.Array<number>}
    */ typingsSlinky.nukaDashCarousel.nukaDashCarouselStrings.CarouselProps with js.Any
  ] = js.undefined
  /**
...
object CarouselProps {
  ...
  {[ slideAction in nuka-carousel.nuka-carousel.CarouselSlideActions ]:? std.Array<number>}
    */ typingsSlinky.nukaDashCarousel.nukaDashCarouselStrings.CarouselProps with js.Any = null,
