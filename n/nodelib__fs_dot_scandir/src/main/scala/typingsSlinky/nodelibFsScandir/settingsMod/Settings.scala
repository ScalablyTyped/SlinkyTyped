...
trait Settings extends js.Object {
  ...
  val fsStatSettings: typingsSlinky.nodelibFsStat.mod.Settings = js.native
...
object Settings {
  ...
  def apply(
    ...
    fsStatSettings: typingsSlinky.nodelibFsStat.mod.Settings,
  ...
  implicit class SettingsOps[Self <: Settings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFsStatSettings(value: typingsSlinky.nodelibFsStat.mod.Settings): Self = this.set("fsStatSettings", value.asInstanceOf[js.Any])
