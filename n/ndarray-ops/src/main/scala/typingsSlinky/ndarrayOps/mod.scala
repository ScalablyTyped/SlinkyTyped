package typingsSlinky.ndarrayOps
...
object mod extends js.Object {
  ...
  def eq(array1: ndarray[Double], array2: ndarray[Double], array3: ndarray[Double]): ndarray[Double] = js.native
  ...
  def equals(array1: ndarray[Double], array2: ndarray[Double]): Boolean = js.native
