...
import typingsSlinky.ssh2.mod.ClientChannel
...
object mod {
  ...
  object ExecOptions {
    ...
    implicit class ExecOptionsMutableBuilder[Self <: ExecOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: typingsSlinky.ssh2.mod.ExecOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
