...
import typingsSlinky.atNivoPie.atNivoPieMod.PieSvgProps
...
object ResponsivePie
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoPie.atNivoPieMod.ResponsivePie] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoPie.atNivoPieMod.ResponsivePie] = {
