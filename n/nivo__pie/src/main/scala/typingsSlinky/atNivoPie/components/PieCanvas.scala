...
import typingsSlinky.atNivoPie.PieCanvasPropsDimensions
...
object PieCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoPie.atNivoPieMod.PieCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoPie.atNivoPieMod.PieCanvas] = {
  ...
  type Props = PieCanvasPropsDimensions
}
