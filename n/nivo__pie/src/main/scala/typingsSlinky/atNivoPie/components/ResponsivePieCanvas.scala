...
import typingsSlinky.atNivoPie.atNivoPieMod.PieCanvasProps
...
object ResponsivePieCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoPie.atNivoPieMod.ResponsivePieCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoPie.atNivoPieMod.ResponsivePieCanvas] = {
