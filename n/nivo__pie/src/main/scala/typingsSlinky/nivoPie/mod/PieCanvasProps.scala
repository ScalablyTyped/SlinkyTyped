...
/* Inlined @nivo/pie.@nivo/pie.Data & @nivo/pie.@nivo/pie.CommonPieProps & std.Partial<{  pixelRatio :number,   onClick :@nivo/pie.@nivo/pie.PieMouseEventHandler<std.HTMLCanvasElement>,   onMouseEnter :@nivo/pie.@nivo/pie.PieMouseEventHandler<std.HTMLCanvasElement>,   onMouseLeave :@nivo/pie.@nivo/pie.PieMouseEventHandler<std.HTMLCanvasElement>}> */
@js.native
trait PieCanvasProps extends js.Object {
  ...
  var onClick: js.UndefOr[PieMouseEventHandler[HTMLCanvasElement]] = js.native
  var onMouseEnter: js.UndefOr[PieMouseEventHandler[HTMLCanvasElement]] = js.native
  var onMouseLeave: js.UndefOr[PieMouseEventHandler[HTMLCanvasElement]] = js.native
...
object PieCanvasProps {
  ...
  implicit class PieCanvasPropsOps[Self <: PieCanvasProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* datum */ PieDatum, /* event */ SyntheticMouseEvent[HTMLCanvasElement]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    @scala.inline
    def setOnMouseEnter(value: (/* datum */ PieDatum, /* event */ SyntheticMouseEvent[HTMLCanvasElement]) => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    @scala.inline
    def setOnMouseLeave(value: (/* datum */ PieDatum, /* event */ SyntheticMouseEvent[HTMLCanvasElement]) => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setTooltip(value: ReactComponentClass[PieDatumWithColor]): Self = this.set("tooltip", value.asInstanceOf[js.Any])
    @scala.inline
