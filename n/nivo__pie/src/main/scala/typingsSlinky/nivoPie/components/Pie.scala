...
object Pie
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoPie.mod.Pie] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoPie.mod.Pie] = {
  ...
  type Props = PieSvgProps with Dimensions
}
