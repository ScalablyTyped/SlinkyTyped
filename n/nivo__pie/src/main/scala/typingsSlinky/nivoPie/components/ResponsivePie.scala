...
object ResponsivePie
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoPie.mod.ResponsivePie] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoPie.mod.ResponsivePie] = {
