...
import typingsSlinky.nivoPie.mod.PieCanvasProps
...
object PieCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoPie.mod.PieCanvas] {
    @scala.inline
  ...
  def withProps(p: PieCanvasProps with Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(data: js.Array[PieDatum], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PieCanvasProps with Dimensions]))
  }
}
