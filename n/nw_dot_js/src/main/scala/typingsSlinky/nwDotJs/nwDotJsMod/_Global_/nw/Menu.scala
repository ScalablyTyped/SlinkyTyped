...
import typingsSlinky.nwDotJs.nwDotJsMod._Global_.NWJS_Helpers.CreateMacBuiltinOption
import typingsSlinky.nwDotJs.nwDotJsMod._Global_.NWJS_Helpers.MenuOption
