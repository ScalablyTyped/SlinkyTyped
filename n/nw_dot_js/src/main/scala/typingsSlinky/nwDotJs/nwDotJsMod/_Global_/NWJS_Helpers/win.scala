...
import typingsSlinky.nwDotJs.nwDotJsStrings.`devtools-closed`
import typingsSlinky.nwDotJs.nwDotJsStrings.`document-end`
import typingsSlinky.nwDotJs.nwDotJsStrings.`document-start`
import typingsSlinky.nwDotJs.nwDotJsStrings.`enter-fullscreen`
import typingsSlinky.nwDotJs.nwDotJsStrings.`new-win-policy`
import typingsSlinky.nwDotJs.nwDotJsStrings.blur
import typingsSlinky.nwDotJs.nwDotJsStrings.close
import typingsSlinky.nwDotJs.nwDotJsStrings.closed
import typingsSlinky.nwDotJs.nwDotJsStrings.focus
import typingsSlinky.nwDotJs.nwDotJsStrings.loaded
import typingsSlinky.nwDotJs.nwDotJsStrings.loading
import typingsSlinky.nwDotJs.nwDotJsStrings.maximize
import typingsSlinky.nwDotJs.nwDotJsStrings.minimize
import typingsSlinky.nwDotJs.nwDotJsStrings.move
import typingsSlinky.nwDotJs.nwDotJsStrings.navigation
import typingsSlinky.nwDotJs.nwDotJsStrings.resize
import typingsSlinky.nwDotJs.nwDotJsStrings.restore
import typingsSlinky.nwDotJs.nwDotJsStrings.zoom
...
trait win extends EventEmitter {
  ...
  def showDevTools(
    ...
    callback: js.Function1[/* dev_win */ js.UndefOr[Window], Unit]
  ): Unit = js.native
  /**
