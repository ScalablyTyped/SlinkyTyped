package typingsSlinky.nwDotJs.nwDotJsMod._Global_.nw

import org.scalablytyped.runtime.TopLevel
import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.nwDotJs.nwDotJsMod._Global_.NWJS_Helpers.screen
import typingsSlinky.nwDotJs.nwDotJsStrings.`displayAdded `
import typingsSlinky.nwDotJs.nwDotJsStrings.`displayRemoved `
import typingsSlinky.nwDotJs.nwDotJsStrings.displayBoundsChanged
...
trait Screen extends EventEmitter {
  /**
    ...
    */
  var DesktopCaptureMonitor: typingsSlinky.nwDotJs.nwDotJsMod._Global_.NWJS_Helpers.DesktopCaptureMonitor = js.native
  /**
