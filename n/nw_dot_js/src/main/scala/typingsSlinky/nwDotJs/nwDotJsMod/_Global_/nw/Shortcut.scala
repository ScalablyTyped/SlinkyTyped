...
import typingsSlinky.nwDotJs.nwDotJsMod._Global_.NWJS_Helpers.ShortcutOption
import typingsSlinky.nwDotJs.nwDotJsStrings.active
import typingsSlinky.nwDotJs.nwDotJsStrings.failed
