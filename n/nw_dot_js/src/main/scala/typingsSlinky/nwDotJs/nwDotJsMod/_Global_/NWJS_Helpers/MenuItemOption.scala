...
import typingsSlinky.nwDotJs.nwDotJsMod._Global_.nw.Menu
import typingsSlinky.nwDotJs.nwDotJsStrings.checkbox
import typingsSlinky.nwDotJs.nwDotJsStrings.normal
import typingsSlinky.nwDotJs.nwDotJsStrings.separator
