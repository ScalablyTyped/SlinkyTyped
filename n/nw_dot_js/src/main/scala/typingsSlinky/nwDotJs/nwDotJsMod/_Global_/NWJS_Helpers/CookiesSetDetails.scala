...
import typingsSlinky.nwDotJs.nwDotJsStrings.lax
import typingsSlinky.nwDotJs.nwDotJsStrings.no_restriction
import typingsSlinky.nwDotJs.nwDotJsStrings.strict
