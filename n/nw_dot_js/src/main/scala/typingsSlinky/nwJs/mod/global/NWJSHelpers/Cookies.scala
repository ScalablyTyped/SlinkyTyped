...
import typingsSlinky.nwJs.anon.AddListener
...
object Cookies {
  ...
  implicit class CookiesOps[Self <: Cookies] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: (CookiesGetDetails, js.Function1[/* cookie */ js.UndefOr[Cookie], Unit]) => Unit): Self = {
    ...
    @scala.inline
    def withOnChanged(value: AddListener): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSet(value: (CookiesSetDetails, js.Function1[/* cookie */ js.UndefOr[Cookie], Unit]) => Unit): Self = {
        val ret = this.duplicate
