package typingsSlinky.nwJs.mod._Global_.nw

import org.scalablytyped.runtime.TopLevel
import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.nwJs.mod._Global_.NWJSHelpers.screen
...
trait Screen extends EventEmitter {
  /**
    ...
    */
  var DesktopCaptureMonitor: typingsSlinky.nwJs.mod._Global_.NWJSHelpers.DesktopCaptureMonitor = js.native
  /**
