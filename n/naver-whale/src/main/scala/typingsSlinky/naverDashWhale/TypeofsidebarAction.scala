...
import typingsSlinky.naverDashWhale.whale.sidebarAction.BadgeBackgroundColorDetails
import typingsSlinky.naverDashWhale.whale.sidebarAction.BrowserClickedEvent
import typingsSlinky.naverDashWhale.whale.sidebarAction.ColorArray
import typingsSlinky.naverDashWhale.whale.sidebarAction.SidebarBadgeDetail
import typingsSlinky.naverDashWhale.whale.sidebarAction.SidebarDockDetail
import typingsSlinky.naverDashWhale.whale.sidebarAction.SidebarIconDetail
import typingsSlinky.naverDashWhale.whale.sidebarAction.SidebarPageDetail
import typingsSlinky.naverDashWhale.whale.sidebarAction.SidebarShowDetail
import typingsSlinky.naverDashWhale.whale.sidebarAction.SidebarTitleDetail
