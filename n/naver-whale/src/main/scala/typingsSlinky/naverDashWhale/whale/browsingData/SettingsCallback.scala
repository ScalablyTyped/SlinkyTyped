...
trait SettingsCallback extends js.Object {
  ...
  var dataRemovalPermitted: typingsSlinky.chrome.chrome.browsingData.DataTypeSet
  /** All of the types will be present in the result, with values of true if they are both selected to be removed and permitted to be removed, otherwise false. */
  var dataToRemove: typingsSlinky.chrome.chrome.browsingData.DataTypeSet
  var options: typingsSlinky.chrome.chrome.browsingData.RemovalOptions
}
