...
object remove extends js.Object {
  def apply(details: typingsSlinky.chrome.chrome.cookies.Details): Unit = js.native
  def apply(
    details: typingsSlinky.chrome.chrome.cookies.Details,
    callback: js.Function1[/* details */ typingsSlinky.chrome.chrome.cookies.Details, Unit]
  ): Unit = js.native
}
