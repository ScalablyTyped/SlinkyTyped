...
trait ExtensionSidebarPane extends js.Object {
  ...
  var onHidden: typingsSlinky.chrome.chrome.devtools.panels.ExtensionSidebarPaneHiddenEvent = js.native
  /** Fired when the sidebar pane becomes visible as a result of user switching to the panel that hosts it. */
  var onShown: typingsSlinky.chrome.chrome.devtools.panels.ExtensionSidebarPaneShownEvent = js.native
  /**
