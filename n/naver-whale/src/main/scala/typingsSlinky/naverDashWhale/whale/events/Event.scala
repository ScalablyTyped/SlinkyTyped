package typingsSlinky.naverDashWhale.whale.events
...
trait Event[T /* <: js.Function */] extends js.Object {
  ...
  /**
    ...
    */
  def addRules(rules: js.Array[typingsSlinky.chrome.chrome.events.Rule]): Unit = js.native
  def addRules(
    rules: js.Array[typingsSlinky.chrome.chrome.events.Rule],
    callback: js.Function1[/* rules */ js.Array[typingsSlinky.chrome.chrome.events.Rule], Unit]
  ): Unit = js.native
  /**
    ...
    * Parameter rules: Rules that were registered, the optional parameters are filled with values.
    */
  def getRules(callback: js.Function1[/* rules */ js.Array[typingsSlinky.chrome.chrome.events.Rule], Unit]): Unit = js.native
  /**
    * Returns currently registered rules.
