...
trait BookmarkTreeNode extends js.Object {
  ...
  var children: js.UndefOr[js.Array[typingsSlinky.chrome.chrome.bookmarks.BookmarkTreeNode]] = js.undefined
...
object BookmarkTreeNode {
  ...
  def apply(
    id: String,
    title: String,
    children: js.Array[typingsSlinky.chrome.chrome.bookmarks.BookmarkTreeNode] = null,
