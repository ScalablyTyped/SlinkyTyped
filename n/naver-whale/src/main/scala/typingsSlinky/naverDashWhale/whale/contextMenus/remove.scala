package typingsSlinky.naverDashWhale.whale.contextMenus
...
object remove extends js.Object {
  ...
  def apply(menuItemId: Double): Unit = js.native
  def apply(menuItemId: Double, callback: js.Function0[Unit]): Unit = js.native
}
