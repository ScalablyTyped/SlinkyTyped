package typingsSlinky.naverDashWhale.whale.devtools.panels
...
trait ExtensionPanel extends js.Object {
  ...
  var onHidden: typingsSlinky.chrome.chrome.devtools.panels.PanelHiddenEvent
  /** Fired upon a search action (start of a new search, search result navigation, or search being canceled). */
  var onSearch: typingsSlinky.chrome.chrome.devtools.panels.PanelSearchEvent
  /** Fired when the user switches to the panel. */
  var onShown: typingsSlinky.chrome.chrome.devtools.panels.PanelShownEvent
  /**
    ...
    */
  def createStatusBarButton(iconPath: String, tooltipText: String, disabled: Boolean): typingsSlinky.chrome.chrome.devtools.panels.Button
}
