...
trait RemovalOptions extends js.Object {
  /**
    ...
    */
  var originTypes: js.UndefOr[typingsSlinky.chrome.chrome.browsingData.OriginTypes] = js.undefined
...
object RemovalOptions {
  @scala.inline
  def apply(
    originTypes: typingsSlinky.chrome.chrome.browsingData.OriginTypes = null,
