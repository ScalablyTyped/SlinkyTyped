...
import typingsSlinky.naverWhale.whale.declarativeContent.PageStateMatcher
import typingsSlinky.naverWhale.whale.declarativeContent.ShowPageAction
...
object TypeofdeclarativeContent {
  ...
  def apply(
    ...
    PageStateMatcherProperties: Instantiable0[typingsSlinky.naverWhale.whale.declarativeContent.PageStateMatcherProperties],
