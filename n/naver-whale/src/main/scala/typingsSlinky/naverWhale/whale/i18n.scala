...
object i18n {
  ...
  object LanguageDetectionResult {
    ...
    implicit class LanguageDetectionResultMutableBuilder[Self <: LanguageDetectionResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLanguages(value: js.Array[typingsSlinky.chrome.chrome.i18n.DetectedLanguage]): Self = StObject.set(x, "languages", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLanguagesVarargs(value: typingsSlinky.chrome.chrome.i18n.DetectedLanguage*): Self = StObject.set(x, "languages", js.Array(value :_*))
    }
  }
}
