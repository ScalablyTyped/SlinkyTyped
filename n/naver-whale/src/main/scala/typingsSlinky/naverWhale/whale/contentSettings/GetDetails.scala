...
object GetDetails {
  ...
  implicit class GetDetailsOps[Self <: GetDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceIdentifier(value: typingsSlinky.chrome.chrome.contentSettings.ResourceIdentifier): Self = this.set("resourceIdentifier", value.asInstanceOf[js.Any])
    @scala.inline
