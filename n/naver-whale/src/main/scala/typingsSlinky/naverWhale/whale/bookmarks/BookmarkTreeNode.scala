...
object BookmarkTreeNode {
  ...
  implicit class BookmarkTreeNodeOps[Self <: BookmarkTreeNode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: typingsSlinky.chrome.chrome.bookmarks.BookmarkTreeNode*): Self = this.set("children", js.Array(value :_*))
    
    @scala.inline
    def setChildren(value: js.Array[typingsSlinky.chrome.chrome.bookmarks.BookmarkTreeNode]): Self = this.set("children", value.asInstanceOf[js.Any])
