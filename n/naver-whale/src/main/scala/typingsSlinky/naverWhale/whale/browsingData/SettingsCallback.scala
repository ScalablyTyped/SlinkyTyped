...
object SettingsCallback {
  ...
  implicit class SettingsCallbackOps[Self <: SettingsCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataRemovalPermitted(value: typingsSlinky.chrome.chrome.browsingData.DataTypeSet): Self = this.set("dataRemovalPermitted", value.asInstanceOf[js.Any])
    @scala.inline
    def setDataToRemove(value: typingsSlinky.chrome.chrome.browsingData.DataTypeSet): Self = this.set("dataToRemove", value.asInstanceOf[js.Any])
    @scala.inline
    def setOptions(value: typingsSlinky.chrome.chrome.browsingData.RemovalOptions): Self = this.set("options", value.asInstanceOf[js.Any])
  }
