...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.naverWhale.naverWhaleStrings.main_frame
  - typingsSlinky.naverWhale.naverWhaleStrings.sub_frame
  - typingsSlinky.naverWhale.naverWhaleStrings.stylesheet
  - typingsSlinky.naverWhale.naverWhaleStrings.script
  - typingsSlinky.naverWhale.naverWhaleStrings.image
  - typingsSlinky.naverWhale.naverWhaleStrings.font
  - typingsSlinky.naverWhale.naverWhaleStrings.`object`
  - typingsSlinky.naverWhale.naverWhaleStrings.xmlhttprequest
  - typingsSlinky.naverWhale.naverWhaleStrings.ping
  - typingsSlinky.naverWhale.naverWhaleStrings.csp_report
  - typingsSlinky.naverWhale.naverWhaleStrings.media
  - typingsSlinky.naverWhale.naverWhaleStrings.websocket
  - typingsSlinky.naverWhale.naverWhaleStrings.other
*/
