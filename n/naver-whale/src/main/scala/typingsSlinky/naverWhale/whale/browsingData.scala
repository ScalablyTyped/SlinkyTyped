...
object browsingData {
  ...
  trait RemovalOptions extends StObject {
    ...
    /**
      ...
      */
    var originTypes: js.UndefOr[typingsSlinky.chrome.chrome.browsingData.OriginTypes] = js.native
  ...
  object RemovalOptions {
    ...
    implicit class RemovalOptionsMutableBuilder[Self <: RemovalOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOriginTypes(value: typingsSlinky.chrome.chrome.browsingData.OriginTypes): Self = StObject.set(x, "originTypes", value.asInstanceOf[js.Any])
  ...
  object SettingsCallback {
    ...
    implicit class SettingsCallbackMutableBuilder[Self <: SettingsCallback] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDataRemovalPermitted(value: typingsSlinky.chrome.chrome.browsingData.DataTypeSet): Self = StObject.set(x, "dataRemovalPermitted", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDataToRemove(value: typingsSlinky.chrome.chrome.browsingData.DataTypeSet): Self = StObject.set(x, "dataToRemove", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOptions(value: typingsSlinky.chrome.chrome.browsingData.RemovalOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    }
  }
}
