...
trait SetDetails extends js.Object {
  ...
  /**
    ...
    * @since Chrome 51.
    */
  var sameSite: js.UndefOr[typingsSlinky.chrome.chrome.cookies.SameSiteStatus] = js.undefined
...
object SetDetails {
  ...
  def apply(
    ...
    name: String = null,
    path: String = null,
    sameSite: typingsSlinky.chrome.chrome.cookies.SameSiteStatus = null,
