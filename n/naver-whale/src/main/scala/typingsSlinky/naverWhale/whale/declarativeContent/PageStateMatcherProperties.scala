...
trait PageStateMatcherProperties extends js.Object {
  ...
  var pageUrl: js.UndefOr[typingsSlinky.chrome.chrome.declarativeContent.PageStateUrlDetails] = js.undefined
}
...
object PageStateMatcherProperties {
  ...
  def apply(
    ...
    pageUrl: typingsSlinky.chrome.chrome.declarativeContent.PageStateUrlDetails = null
