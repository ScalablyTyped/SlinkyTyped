...
object proxy {
  ...
  object ProxyConfig {
    ...
    implicit class ProxyConfigMutableBuilder[Self <: ProxyConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPacScript(value: typingsSlinky.chrome.chrome.proxy.PacScript): Self = StObject.set(x, "pacScript", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPacScriptUndefined: Self = StObject.set(x, "pacScript", js.undefined)
      
      @scala.inline
      def setRules(value: typingsSlinky.chrome.chrome.proxy.ProxyRules): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
  ...
  object ProxyRules {
    ...
    implicit class ProxyRulesMutableBuilder[Self <: ProxyRules] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFallbackProxy(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "fallbackProxy", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFallbackProxyUndefined: Self = StObject.set(x, "fallbackProxy", js.undefined)
      
      @scala.inline
      def setProxyForFtp(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "proxyForFtp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setProxyForFtpUndefined: Self = StObject.set(x, "proxyForFtp", js.undefined)
      
      @scala.inline
      def setProxyForHttp(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "proxyForHttp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setProxyForHttpUndefined: Self = StObject.set(x, "proxyForHttp", js.undefined)
      
      @scala.inline
      def setProxyForHttps(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "proxyForHttps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setProxyForHttpsUndefined: Self = StObject.set(x, "proxyForHttps", js.undefined)
      
      @scala.inline
      def setSingleProxy(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "singleProxy", value.asInstanceOf[js.Any])
