...
object sendMessage extends js.Object {
  ...
  def apply(extensionId: String, message: js.Any, options: typingsSlinky.chrome.chrome.runtime.MessageOptions): Unit = js.native
  def apply(
    extensionId: String,
    message: js.Any,
    options: typingsSlinky.chrome.chrome.runtime.MessageOptions,
  ...
  def apply(message: js.Any, options: typingsSlinky.chrome.chrome.runtime.MessageOptions): Unit = js.native
  def apply(
    message: js.Any,
    options: typingsSlinky.chrome.chrome.runtime.MessageOptions,
    responseCallback: js.Function1[/* response */ js.Any, Unit]
