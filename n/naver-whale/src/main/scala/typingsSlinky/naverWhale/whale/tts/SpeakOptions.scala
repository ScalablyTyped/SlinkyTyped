...
trait SpeakOptions extends js.Object {
  ...
  /**
    ...
    */
  var onEvent: js.UndefOr[js.Function1[/* event */ typingsSlinky.chrome.chrome.tts.TtsEvent, Unit]] = js.undefined
  /**
    * Optional.
...
object SpeakOptions {
  ...
  def apply(
    ...
    gender: String = null,
    lang: String = null,
    onEvent: /* event */ typingsSlinky.chrome.chrome.tts.TtsEvent => Unit = null,
