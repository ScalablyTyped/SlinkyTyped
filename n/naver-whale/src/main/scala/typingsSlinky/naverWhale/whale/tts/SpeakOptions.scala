...
trait SpeakOptions extends js.Object {
  ...
  /**
    ...
    */
  var onEvent: js.UndefOr[js.Function1[/* event */ typingsSlinky.chrome.chrome.tts.TtsEvent, Unit]] = js.native
...
object SpeakOptions {
  ...
  implicit class SpeakOptionsOps[Self <: SpeakOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnEvent(value: /* event */ typingsSlinky.chrome.chrome.tts.TtsEvent => Unit): Self = this.set("onEvent", js.Any.fromFunction1(value))
