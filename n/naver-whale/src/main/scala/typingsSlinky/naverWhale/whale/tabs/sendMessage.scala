...
object sendMessage extends js.Object {
  ...
  def apply(tabId: Double, message: js.Any, options: typingsSlinky.chrome.chrome.tabs.MessageSendOptions): Unit = js.native
  def apply(
    tabId: Double,
    message: js.Any,
    options: typingsSlinky.chrome.chrome.tabs.MessageSendOptions,
