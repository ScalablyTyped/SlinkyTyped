...
object browserAction {
  ...
  trait BadgeBackgroundColorDetails extends StObject {
    ...
    var color: String | typingsSlinky.chrome.chrome.browserAction.ColorArray = js.native
  ...
  object BadgeBackgroundColorDetails {
    ...
    @scala.inline
    def apply(color: String | typingsSlinky.chrome.chrome.browserAction.ColorArray): BadgeBackgroundColorDetails = {
    ...
    implicit class BadgeBackgroundColorDetailsMutableBuilder[Self <: BadgeBackgroundColorDetails] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: String | typingsSlinky.chrome.chrome.browserAction.ColorArray): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
