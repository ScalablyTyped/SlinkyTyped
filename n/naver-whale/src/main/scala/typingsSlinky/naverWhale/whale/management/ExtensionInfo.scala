...
object ExtensionInfo {
  ...
  implicit class ExtensionInfoOps[Self <: ExtensionInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIconsVarargs(value: typingsSlinky.chrome.chrome.management.IconInfo*): Self = this.set("icons", js.Array(value :_*))
    @scala.inline
    def setIcons(value: js.Array[typingsSlinky.chrome.chrome.management.IconInfo]): Self = this.set("icons", value.asInstanceOf[js.Any])
    @scala.inline
