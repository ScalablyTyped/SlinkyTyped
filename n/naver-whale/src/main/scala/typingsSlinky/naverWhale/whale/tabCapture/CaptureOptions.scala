...
trait CaptureOptions extends js.Object {
  ...
  /** Optional. */
  var audioConstraints: js.UndefOr[typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint] = js.undefined
  /** Optional. */
  var video: js.UndefOr[Boolean] = js.undefined
  /** Optional. */
  var videoConstraints: js.UndefOr[typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint] = js.undefined
}
...
object CaptureOptions {
  ...
  def apply(
    ...
    audioConstraints: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint = null,
    video: js.UndefOr[Boolean] = js.undefined,
    videoConstraints: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint = null
  ): CaptureOptions = {
