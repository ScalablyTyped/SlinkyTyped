...
object CaptureOptions {
  ...
  implicit class CaptureOptionsOps[Self <: CaptureOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAudioConstraints(value: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVideoConstraints(value: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint): Self = {
        val ret = this.duplicate
