...
trait CaptureOptions extends js.Object {
  ...
  /** Optional. */
  var audioConstraints: js.UndefOr[typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint] = js.native
  /** Optional. */
  var video: js.UndefOr[Boolean] = js.native
  /** Optional. */
  var videoConstraints: js.UndefOr[typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint] = js.native
}
...
object CaptureOptions {
  ...
  implicit class CaptureOptionsOps[Self <: CaptureOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAudioConstraints(value: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint): Self = this.set("audioConstraints", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVideoConstraints(value: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint): Self = this.set("videoConstraints", value.asInstanceOf[js.Any])
    @scala.inline
