...
object cookies {
  ...
  trait Cookie extends StObject {
    ...
    /**
      ...
      * @since Chrome 51.
      */
    var sameSite: typingsSlinky.chrome.chrome.cookies.SameSiteStatus = js.native
  ...
  object Cookie {
    ...
    def apply(
      ...
      name: String,
      path: String,
      sameSite: typingsSlinky.chrome.chrome.cookies.SameSiteStatus,
      secure: Boolean,
      session: Boolean,
      storeId: String,
      value: String
    ...
    implicit class CookieMutableBuilder[Self <: Cookie] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSameSite(value: typingsSlinky.chrome.chrome.cookies.SameSiteStatus): Self = StObject.set(x, "sameSite", value.asInstanceOf[js.Any])
  ...
  trait CookieChangeInfo extends StObject {
    ...
    var cookie: typingsSlinky.chrome.chrome.cookies.Cookie = js.native
  ...
  object CookieChangeInfo {
    ...
    @scala.inline
    def apply(cause: String, cookie: typingsSlinky.chrome.chrome.cookies.Cookie, removed: Boolean): CookieChangeInfo = {
    ...
    implicit class CookieChangeInfoMutableBuilder[Self <: CookieChangeInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCookie(value: typingsSlinky.chrome.chrome.cookies.Cookie): Self = StObject.set(x, "cookie", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.naverWhale.naverWhaleStrings.unspecified
    - typingsSlinky.naverWhale.naverWhaleStrings.no_restriction
    - typingsSlinky.naverWhale.naverWhaleStrings.lax
    - typingsSlinky.naverWhale.naverWhaleStrings.strict
  */
  trait SameSiteStatus extends StObject
  object SameSiteStatus {
    
    @scala.inline
    def lax: typingsSlinky.naverWhale.naverWhaleStrings.lax = "lax".asInstanceOf[typingsSlinky.naverWhale.naverWhaleStrings.lax]
    
    @scala.inline
    def no_restriction: typingsSlinky.naverWhale.naverWhaleStrings.no_restriction = "no_restriction".asInstanceOf[typingsSlinky.naverWhale.naverWhaleStrings.no_restriction]
    
    @scala.inline
    def strict: typingsSlinky.naverWhale.naverWhaleStrings.strict = "strict".asInstanceOf[typingsSlinky.naverWhale.naverWhaleStrings.strict]
    
    @scala.inline
    def unspecified: typingsSlinky.naverWhale.naverWhaleStrings.unspecified = "unspecified".asInstanceOf[typingsSlinky.naverWhale.naverWhaleStrings.unspecified]
  }
