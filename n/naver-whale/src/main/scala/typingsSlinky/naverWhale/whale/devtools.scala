...
object devtools {
  ...
  object inspectedWindow {
    ...
    type ResourceAddedEvent = Event[
        js.Function1[/* resource */ typingsSlinky.chrome.chrome.devtools.inspectedWindow.Resource, Unit]
      ]
  ...
  object panels {
    ...
    trait Button extends StObject {
      ...
      var onClicked: typingsSlinky.chrome.chrome.devtools.panels.ButtonClickedEvent = js.native
    ...
    object ExtensionPanel {
      ...
      implicit class ExtensionPanelMutableBuilder[Self <: ExtensionPanel] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreateStatusBarButton(value: (String, String, Boolean) => typingsSlinky.chrome.chrome.devtools.panels.Button): Self = StObject.set(x, "createStatusBarButton", js.Any.fromFunction3(value))
        
        @scala.inline
        def setOnHidden(value: typingsSlinky.chrome.chrome.devtools.panels.PanelHiddenEvent): Self = StObject.set(x, "onHidden", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setOnSearch(value: typingsSlinky.chrome.chrome.devtools.panels.PanelSearchEvent): Self = StObject.set(x, "onSearch", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setOnShown(value: typingsSlinky.chrome.chrome.devtools.panels.PanelShownEvent): Self = StObject.set(x, "onShown", value.asInstanceOf[js.Any])
      }
    }
