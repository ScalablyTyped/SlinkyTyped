...
object management {
  ...
  object ExtensionInfo {
    ...
    implicit class ExtensionInfoMutableBuilder[Self <: ExtensionInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIcons(value: js.Array[typingsSlinky.chrome.chrome.management.IconInfo]): Self = StObject.set(x, "icons", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIconsUndefined: Self = StObject.set(x, "icons", js.undefined)
      
      @scala.inline
      def setIconsVarargs(value: typingsSlinky.chrome.chrome.management.IconInfo*): Self = StObject.set(x, "icons", js.Array(value :_*))
