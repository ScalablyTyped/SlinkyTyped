...
object BlockingResponse {
  ...
  implicit class BlockingResponseOps[Self <: BlockingResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthCredentials(value: typingsSlinky.chrome.chrome.webRequest.AuthCredentials): Self = this.set("authCredentials", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestHeadersVarargs(value: typingsSlinky.chrome.chrome.webRequest.HttpHeader*): Self = this.set("requestHeaders", js.Array(value :_*))
    
    @scala.inline
    def setRequestHeaders(value: js.Array[typingsSlinky.chrome.chrome.webRequest.HttpHeader]): Self = this.set("requestHeaders", value.asInstanceOf[js.Any])
