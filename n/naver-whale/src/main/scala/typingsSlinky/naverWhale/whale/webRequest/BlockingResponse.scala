...
trait BlockingResponse extends js.Object {
  ...
  var authCredentials: js.UndefOr[typingsSlinky.chrome.chrome.webRequest.AuthCredentials] = js.undefined
  ...
  /**
    ...
    */
  var requestHeaders: js.UndefOr[js.Array[typingsSlinky.chrome.chrome.webRequest.HttpHeader]] = js.undefined
  /**
    * Optional.
    * Only used as a response to the onHeadersReceived event. If set, the server is assumed to have responded with these response headers instead. Only return responseHeaders if you really want to modify the headers in order to limit the number of conflicts (only one extension may modify responseHeaders for each request).
    */
  var responseHeaders: js.UndefOr[js.Array[typingsSlinky.chrome.chrome.webRequest.HttpHeader]] = js.undefined
}

object BlockingResponse {
  @scala.inline
  def apply(
    authCredentials: typingsSlinky.chrome.chrome.webRequest.AuthCredentials = null,
