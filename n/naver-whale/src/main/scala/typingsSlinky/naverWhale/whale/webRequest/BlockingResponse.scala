...
object BlockingResponse {
  ...
  implicit class BlockingResponseOps[Self <: BlockingResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAuthCredentials(value: typingsSlinky.chrome.chrome.webRequest.AuthCredentials): Self = {
    ...
    @scala.inline
    def withRequestHeaders(value: js.Array[typingsSlinky.chrome.chrome.webRequest.HttpHeader]): Self = {
        val ret = this.duplicate
