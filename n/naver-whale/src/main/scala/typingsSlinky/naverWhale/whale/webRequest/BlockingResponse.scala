...
trait BlockingResponse extends StObject {
  ...
  var authCredentials: js.UndefOr[typingsSlinky.chrome.chrome.webRequest.AuthCredentials] = js.native
  ...
  /**
    ...
    */
  var requestHeaders: js.UndefOr[js.Array[typingsSlinky.chrome.chrome.webRequest.HttpHeader]] = js.native
...
object BlockingResponse {
  ...
  implicit class BlockingResponseMutableBuilder[Self <: BlockingResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthCredentials(value: typingsSlinky.chrome.chrome.webRequest.AuthCredentials): Self = StObject.set(x, "authCredentials", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestHeaders(value: js.Array[typingsSlinky.chrome.chrome.webRequest.HttpHeader]): Self = StObject.set(x, "requestHeaders", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRequestHeadersUndefined: Self = StObject.set(x, "requestHeaders", js.undefined)
    
    @scala.inline
    def setRequestHeadersVarargs(value: typingsSlinky.chrome.chrome.webRequest.HttpHeader*): Self = StObject.set(x, "requestHeaders", js.Array(value :_*))
    
    @scala.inline
    def setResponseHeaders(value: js.Array[typingsSlinky.chrome.chrome.webRequest.HttpHeader]): Self = StObject.set(x, "responseHeaders", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResponseHeadersUndefined: Self = StObject.set(x, "responseHeaders", js.undefined)
    
    @scala.inline
    def setResponseHeadersVarargs(value: typingsSlinky.chrome.chrome.webRequest.HttpHeader*): Self = StObject.set(x, "responseHeaders", js.Array(value :_*))
  }
}
