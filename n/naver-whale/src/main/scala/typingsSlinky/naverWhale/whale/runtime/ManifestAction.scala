...
trait ManifestAction extends js.Object {
  var default_icon: js.UndefOr[typingsSlinky.chrome.chrome.runtime.ManifestIcons] = js.undefined
...
object ManifestAction {
  @scala.inline
  def apply(
    default_icon: typingsSlinky.chrome.chrome.runtime.ManifestIcons = null,
