...
object CpuInfo {
  ...
  implicit class CpuInfoOps[Self <: CpuInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProcessorsVarargs(value: typingsSlinky.chrome.chrome.system.cpu.ProcessorInfo*): Self = this.set("processors", js.Array(value :_*))
    @scala.inline
    def setProcessors(value: js.Array[typingsSlinky.chrome.chrome.system.cpu.ProcessorInfo]): Self = this.set("processors", value.asInstanceOf[js.Any])
  }
