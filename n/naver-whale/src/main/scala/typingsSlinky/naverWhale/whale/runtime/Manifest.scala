...
object Manifest {
  ...
  implicit class ManifestOps[Self <: Manifest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBrowser_action(value: typingsSlinky.chrome.chrome.runtime.ManifestAction): Self = this.set("browser_action", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIcons(value: typingsSlinky.chrome.chrome.runtime.ManifestIcons): Self = this.set("icons", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPage_action(value: typingsSlinky.chrome.chrome.runtime.ManifestAction): Self = this.set("page_action", value.asInstanceOf[js.Any])
    @scala.inline
