...
object ExtensionPanel {
  ...
  implicit class ExtensionPanelOps[Self <: ExtensionPanel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateStatusBarButton(value: (String, String, Boolean) => typingsSlinky.chrome.chrome.devtools.panels.Button): Self = this.set("createStatusBarButton", js.Any.fromFunction3(value))
    @scala.inline
    def setOnHidden(value: typingsSlinky.chrome.chrome.devtools.panels.PanelHiddenEvent): Self = this.set("onHidden", value.asInstanceOf[js.Any])
    @scala.inline
    def setOnSearch(value: typingsSlinky.chrome.chrome.devtools.panels.PanelSearchEvent): Self = this.set("onSearch", value.asInstanceOf[js.Any])
    @scala.inline
    def setOnShown(value: typingsSlinky.chrome.chrome.devtools.panels.PanelShownEvent): Self = this.set("onShown", value.asInstanceOf[js.Any])
  }
