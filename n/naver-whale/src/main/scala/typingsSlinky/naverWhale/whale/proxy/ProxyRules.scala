...
trait ProxyRules extends js.Object {
  ...
  var fallbackProxy: js.UndefOr[typingsSlinky.chrome.chrome.proxy.ProxyServer] = js.undefined
  /** Optional. The proxy server to be used for FTP requests. */
  var proxyForFtp: js.UndefOr[typingsSlinky.chrome.chrome.proxy.ProxyServer] = js.undefined
  /** Optional. The proxy server to be used for HTTP requests. */
  var proxyForHttp: js.UndefOr[typingsSlinky.chrome.chrome.proxy.ProxyServer] = js.undefined
  /** Optional. The proxy server to be used for HTTPS requests. */
  var proxyForHttps: js.UndefOr[typingsSlinky.chrome.chrome.proxy.ProxyServer] = js.undefined
  /** Optional. The proxy server to be used for all per-URL requests (that is http, https, and ftp). */
  var singleProxy: js.UndefOr[typingsSlinky.chrome.chrome.proxy.ProxyServer] = js.undefined
}
...
object ProxyRules {
  ...
  def apply(
    ...
    fallbackProxy: typingsSlinky.chrome.chrome.proxy.ProxyServer = null,
    proxyForFtp: typingsSlinky.chrome.chrome.proxy.ProxyServer = null,
    proxyForHttp: typingsSlinky.chrome.chrome.proxy.ProxyServer = null,
    proxyForHttps: typingsSlinky.chrome.chrome.proxy.ProxyServer = null,
    singleProxy: typingsSlinky.chrome.chrome.proxy.ProxyServer = null
  ): ProxyRules = {
