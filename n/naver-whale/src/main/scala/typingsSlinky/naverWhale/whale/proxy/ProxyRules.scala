...
object ProxyRules {
  ...
  implicit class ProxyRulesOps[Self <: ProxyRules] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFallbackProxy(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = this.set("fallbackProxy", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFallbackProxy: Self = this.set("fallbackProxy", js.undefined)
    @scala.inline
    def setProxyForFtp(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = this.set("proxyForFtp", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteProxyForFtp: Self = this.set("proxyForFtp", js.undefined)
    @scala.inline
    def setProxyForHttp(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = this.set("proxyForHttp", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteProxyForHttp: Self = this.set("proxyForHttp", js.undefined)
    @scala.inline
    def setProxyForHttps(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = this.set("proxyForHttps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteProxyForHttps: Self = this.set("proxyForHttps", js.undefined)
    @scala.inline
    def setSingleProxy(value: typingsSlinky.chrome.chrome.proxy.ProxyServer): Self = this.set("singleProxy", value.asInstanceOf[js.Any])
    @scala.inline
