...
object notifications {
  ...
  object NotificationOptions {
    ...
    implicit class NotificationOptionsMutableBuilder[Self <: NotificationOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setButtons(value: js.Array[typingsSlinky.chrome.chrome.notifications.ButtonOptions]): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonsUndefined: Self = StObject.set(x, "buttons", js.undefined)
      
      @scala.inline
      def setButtonsVarargs(value: typingsSlinky.chrome.chrome.notifications.ButtonOptions*): Self = StObject.set(x, "buttons", js.Array(value :_*))
      ...
      @scala.inline
      def setItems(value: js.Array[typingsSlinky.chrome.chrome.notifications.ItemOptions]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      @scala.inline
      def setItemsVarargs(value: typingsSlinky.chrome.chrome.notifications.ItemOptions*): Self = StObject.set(x, "items", js.Array(value :_*))
