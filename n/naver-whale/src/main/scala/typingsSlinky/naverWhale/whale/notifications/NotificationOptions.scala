...
object NotificationOptions {
  ...
  implicit class NotificationOptionsOps[Self <: NotificationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonsVarargs(value: typingsSlinky.chrome.chrome.notifications.ButtonOptions*): Self = this.set("buttons", js.Array(value :_*))
    
    @scala.inline
    def setButtons(value: js.Array[typingsSlinky.chrome.chrome.notifications.ButtonOptions]): Self = this.set("buttons", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: typingsSlinky.chrome.chrome.notifications.ItemOptions*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[typingsSlinky.chrome.chrome.notifications.ItemOptions]): Self = this.set("items", value.asInstanceOf[js.Any])
