...
trait ResourceRequest extends StObject {
  ...
  /**
    ...
    */
  var `type`: typingsSlinky.chrome.chrome.webRequest.ResourceType = js.native
...
object ResourceRequest {
  ...
  implicit class ResourceRequestMutableBuilder[Self <: ResourceRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.chrome.chrome.webRequest.ResourceType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
