...
object fontSettings {
  ...
  type DefaultFixedFontSizeChangedEvent = Event[
    js.Function1[/* details */ typingsSlinky.chrome.chrome.fontSettings.FontSizeDetails, Unit]
  ]
  ...
  type FontChangedEvent = Event[
    js.Function1[/* details */ typingsSlinky.chrome.chrome.fontSettings.FullFontDetails, Unit]
  ]
