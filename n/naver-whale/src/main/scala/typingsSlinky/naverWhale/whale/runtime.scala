...
object runtime {
  ...
  object Manifest {
    ...
    implicit class ManifestMutableBuilder[Self <: Manifest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBrowser_action(value: typingsSlinky.chrome.chrome.runtime.ManifestAction): Self = StObject.set(x, "browser_action", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIcons(value: typingsSlinky.chrome.chrome.runtime.ManifestIcons): Self = StObject.set(x, "icons", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPage_action(value: typingsSlinky.chrome.chrome.runtime.ManifestAction): Self = StObject.set(x, "page_action", value.asInstanceOf[js.Any])
  ...
  trait ManifestAction extends StObject {
    ...
    var default_icon: js.UndefOr[typingsSlinky.chrome.chrome.runtime.ManifestIcons] = js.native
  ...
  object ManifestAction {
    ...
    implicit class ManifestActionMutableBuilder[Self <: ManifestAction] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefault_icon(value: typingsSlinky.chrome.chrome.runtime.ManifestIcons): Self = StObject.set(x, "default_icon", value.asInstanceOf[js.Any])
  ...
  object Port {
    ...
    implicit class PortMutableBuilder[Self <: Port] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnDisconnect(value: typingsSlinky.chrome.chrome.runtime.PortDisconnectEvent): Self = StObject.set(x, "onDisconnect", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnMessage(value: typingsSlinky.chrome.chrome.runtime.PortMessageEvent): Self = StObject.set(x, "onMessage", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPostMessage(value: js.Any => Unit): Self = StObject.set(x, "postMessage", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSender(value: typingsSlinky.chrome.chrome.runtime.MessageSender): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object RequestUpdateCheckStatus {
    ...
    @scala.inline
    def no_update: typingsSlinky.naverWhale.naverWhaleStrings.no_update = "no_update".asInstanceOf[typingsSlinky.naverWhale.naverWhaleStrings.no_update]
    
    @scala.inline
    def throttled: typingsSlinky.naverWhale.naverWhaleStrings.throttled = "throttled".asInstanceOf[typingsSlinky.naverWhale.naverWhaleStrings.throttled]
    
    @scala.inline
    def update_available: typingsSlinky.naverWhale.naverWhaleStrings.update_available = "update_available".asInstanceOf[typingsSlinky.naverWhale.naverWhaleStrings.update_available]
  }
