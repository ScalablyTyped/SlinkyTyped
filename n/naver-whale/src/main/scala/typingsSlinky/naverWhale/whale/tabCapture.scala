...
object tabCapture {
  ...
  object CaptureOptions {
    ...
    implicit class CaptureOptionsMutableBuilder[Self <: CaptureOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAudioConstraints(value: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint): Self = StObject.set(x, "audioConstraints", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVideoConstraints(value: typingsSlinky.chrome.chrome.tabCapture.MediaStreamConstraint): Self = StObject.set(x, "videoConstraints", value.asInstanceOf[js.Any])
