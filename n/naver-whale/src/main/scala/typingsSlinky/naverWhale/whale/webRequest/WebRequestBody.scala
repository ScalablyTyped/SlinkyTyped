...
object WebRequestBody {
  ...
  implicit class WebRequestBodyOps[Self <: WebRequestBody] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRawVarargs(value: typingsSlinky.chrome.chrome.webRequest.UploadData*): Self = this.set("raw", js.Array(value :_*))
    @scala.inline
    def setRaw(value: js.Array[typingsSlinky.chrome.chrome.webRequest.UploadData]): Self = this.set("raw", value.asInstanceOf[js.Any])
    @scala.inline
