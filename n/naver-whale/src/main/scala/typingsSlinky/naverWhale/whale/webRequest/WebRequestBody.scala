...
trait WebRequestBody extends js.Object {
  ...
  /**
    ...
    */
  var raw: js.UndefOr[js.Array[typingsSlinky.chrome.chrome.webRequest.UploadData]] = js.undefined
}
...
object WebRequestBody {
  ...
  def apply(
    ...
    raw: js.Array[typingsSlinky.chrome.chrome.webRequest.UploadData] = null
  ): WebRequestBody = {
