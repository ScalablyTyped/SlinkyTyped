package typingsSlinky.naverWhale.whale.i18n
...
object LanguageDetectionResult {
  ...
  implicit class LanguageDetectionResultOps[Self <: LanguageDetectionResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLanguagesVarargs(value: typingsSlinky.chrome.chrome.i18n.DetectedLanguage*): Self = this.set("languages", js.Array(value :_*))
    @scala.inline
    def setLanguages(value: js.Array[typingsSlinky.chrome.chrome.i18n.DetectedLanguage]): Self = this.set("languages", value.asInstanceOf[js.Any])
  }
