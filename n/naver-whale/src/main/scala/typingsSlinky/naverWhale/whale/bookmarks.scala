...
object bookmarks {
  ...
  object BookmarkRemoveInfo {
    ...
    implicit class BookmarkRemoveInfoMutableBuilder[Self <: BookmarkRemoveInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNode(value: typingsSlinky.chrome.chrome.bookmarks.BookmarkTreeNode): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
  ...
  object BookmarkTreeNode {
    ...
    implicit class BookmarkTreeNodeMutableBuilder[Self <: BookmarkTreeNode] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: js.Array[typingsSlinky.chrome.chrome.bookmarks.BookmarkTreeNode]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      @scala.inline
      def setChildrenVarargs(value: typingsSlinky.chrome.chrome.bookmarks.BookmarkTreeNode*): Self = StObject.set(x, "children", js.Array(value :_*))
