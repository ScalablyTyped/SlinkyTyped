...
object RequestFilter {
  ...
  implicit class RequestFilterOps[Self <: RequestFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypesVarargs(value: typingsSlinky.chrome.chrome.webRequest.ResourceType*): Self = this.set("types", js.Array(value :_*))
    @scala.inline
    def setTypes(value: js.Array[typingsSlinky.chrome.chrome.webRequest.ResourceType]): Self = this.set("types", value.asInstanceOf[js.Any])
    @scala.inline
