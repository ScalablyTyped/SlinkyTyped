...
object RequestFilter {
  ...
  implicit class RequestFilterMutableBuilder[Self <: RequestFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypes(value: js.Array[typingsSlinky.chrome.chrome.webRequest.ResourceType]): Self = StObject.set(x, "types", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTypesUndefined: Self = StObject.set(x, "types", js.undefined)
    
    @scala.inline
    def setTypesVarargs(value: typingsSlinky.chrome.chrome.webRequest.ResourceType*): Self = StObject.set(x, "types", js.Array(value :_*))
