...
trait Typeofextension extends js.Object {
  ...
  def getBackgroundPage(): typingsSlinky.chrome.Window | Null = js.native
  def getExtensionTabs(): js.Array[typingsSlinky.chrome.Window] = js.native
  def getExtensionTabs(windowId: Double): js.Array[typingsSlinky.chrome.Window] = js.native
  def getURL(path: String): String = js.native
  def getViews(): js.Array[typingsSlinky.chrome.Window] = js.native
  def getViews(fetchProperties: FetchProperties): js.Array[typingsSlinky.chrome.Window] = js.native
