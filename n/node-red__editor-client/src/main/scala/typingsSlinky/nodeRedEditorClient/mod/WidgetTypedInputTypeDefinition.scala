...
trait WidgetTypedInputTypeDefinition extends js.Object {
  ...
  var validate: js.UndefOr[(js.Function1[/* v */ String, Boolean]) | js.RegExp] = js.native
...
object WidgetTypedInputTypeDefinition {
  ...
  implicit class WidgetTypedInputTypeDefinitionOps[Self <: WidgetTypedInputTypeDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidateRegExp(value: js.RegExp): Self = this.set("validate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValidate(value: (js.Function1[/* v */ String, Boolean]) | js.RegExp): Self = this.set("validate", value.asInstanceOf[js.Any])
