package typingsSlinky.newGithubIssueUrl
...
object mod {
  ...
  */
  ...
  object Options {
    ...
    @scala.inline
    def RepoUrlOptions(repoUrl: String): typingsSlinky.newGithubIssueUrl.mod.RepoUrlOptions = {
      val __obj = js.Dynamic.literal(repoUrl = repoUrl.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.newGithubIssueUrl.mod.RepoUrlOptions]
    }
    
    @scala.inline
    def UserAndRepoOptions(repo: String, user: String): typingsSlinky.newGithubIssueUrl.mod.UserAndRepoOptions = {
      val __obj = js.Dynamic.literal(repo = repo.asInstanceOf[js.Any], user = user.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.newGithubIssueUrl.mod.UserAndRepoOptions]
    }
  }
