...
trait IDialogOpenConfirmOptions
  extends typingsSlinky.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogOpenOptions {
  @JSName("scope")
  var scope_IDialogOpenConfirmOptions: js.UndefOr[typingsSlinky.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogConfirmScope] = js.undefined
}
...
object IDialogOpenConfirmOptions {
  ...
  def apply(
    ...
    scope: typingsSlinky.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogConfirmScope = null,
