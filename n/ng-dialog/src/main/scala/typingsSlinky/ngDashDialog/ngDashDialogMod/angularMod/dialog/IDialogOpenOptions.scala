package typingsSlinky.ngDashDialog.ngDashDialogMod.angularMod.dialog
...
trait IDialogOpenOptions
  extends typingsSlinky.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogOptions {
  ...
  /**
  			 ...
  			 */
  var scope: js.UndefOr[typingsSlinky.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogScope] = js.undefined
  var template: String
}
...
object IDialogOpenOptions {
  ...
  def apply(
    ...
    scope: typingsSlinky.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogScope = null,
