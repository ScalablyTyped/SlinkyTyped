package typingsSlinky.ngDialog
...
object mod {
  ...
  type IDialogClosePromise = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise
  
  type IDialogConfirmScope = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogConfirmScope
  
  type IDialogOpenConfirmOptions = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions
  
  type IDialogOpenOptions = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions
  
  type IDialogOpenResult = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenResult
  
  type IDialogOptions = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions
  
  type IDialogProvider = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider
  
  type IDialogScope = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogScope
  
  type IDialogService = typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogService
  ...
  object angularAugmentingMod {
    ...
    object dialog {
      ...
      object IDialogClosePromise {
        ...
        @scala.inline
        def apply(id: String, value: js.Any): typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise = {
          val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise]
        }
        
        @scala.inline
        implicit class IDialogClosePromiseMutableBuilder[Self <: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise] (val x: Self) extends AnyVal {
      ...
      trait IDialogConfirmScope
        extends typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogScope {
      ...
      trait IDialogOpenConfirmOptions
        extends typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions {
        
        @JSName("scope")
        var scope_IDialogOpenConfirmOptions: js.UndefOr[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogConfirmScope] = js.native
      }
      object IDialogOpenConfirmOptions {
        
        @scala.inline
        def apply(template: String): typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions = {
          val __obj = js.Dynamic.literal(template = template.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions]
        }
        
        @scala.inline
        implicit class IDialogOpenConfirmOptionsMutableBuilder[Self <: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions] (val x: Self) extends AnyVal {
          
          @scala.inline
          def setScope(value: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogConfirmScope): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
      ...
      trait IDialogOpenOptions
        extends typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions {
        ...
        /**
          ...
          */
        var scope: js.UndefOr[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogScope] = js.native
      ...
      object IDialogOpenOptions {
        ...
        @scala.inline
        def apply(template: String): typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions = {
          val __obj = js.Dynamic.literal(template = template.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions]
        }
        
        @scala.inline
        implicit class IDialogOpenOptionsMutableBuilder[Self <: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setScope(value: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogScope): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
      ...
      trait IDialogOpenResult extends StObject {
        ...
        var closePromise: IPromise[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise] = js.native
      ...
      object IDialogOptions {
        ...
        @scala.inline
        def apply(): typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions]
        }
        
        @scala.inline
        implicit class IDialogOptionsMutableBuilder[Self <: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions] (val x: Self) extends AnyVal {
      ...
      trait IDialogProvider extends IServiceProvider {
        ...
        /**
          ...
          * @returns {}
          */
        def setDefaults(defaultOptions: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions): Unit = js.native
      ...
      object IDialogProvider {
        ...
        def apply(
          $get: js.Any,
          setDefaults: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions => Unit,
          setForceBodyReload: Boolean => Unit,
          setForceHtmlReload: Boolean => Unit
        ): typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider = {
          ...
          __obj.asInstanceOf[typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider]
        }
        
        @scala.inline
        implicit class IDialogProviderMutableBuilder[Self <: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider] (val x: Self) extends AnyVal {
          
          @scala.inline
          def setSetDefaults(value: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions => Unit): Self = StObject.set(x, "setDefaults", js.Any.fromFunction1(value))
      ...
      trait IDialogService extends StObject {
        ...
        def getDefaults(): typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions = js.native
        ...
        def open(options: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions): typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenResult = js.native
        
        def openConfirm(options: typingsSlinky.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions): IPromise[_] = js.native
      }
    }
  }
}
