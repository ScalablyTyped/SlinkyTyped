...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_NOT_EXISTS
    - typingsSlinky.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_EXISTED
    - typingsSlinky.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_COMMON_NAME_UNSPECIFIED
  */
  ...
  */
  ...
  object CertificateAttribute {
    ...
    @scala.inline
    def CertificateAttributeName(name: String, value: String): typingsSlinky.nodeEasyCert.mod.CertificateAttributeName = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nodeEasyCert.mod.CertificateAttributeName]
    }
    
    @scala.inline
    def CertificateAttributeShortName(shortName: String, value: String): typingsSlinky.nodeEasyCert.mod.CertificateAttributeShortName = {
      val __obj = js.Dynamic.literal(shortName = shortName.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nodeEasyCert.mod.CertificateAttributeShortName]
    }
  }
