package typingsSlinky.nodeAppleReceiptVerify
...
object mod {
  ...
  object ERROR_CODES extends StObject {
    ...
    /* 21003 */ val COULD_NOT_AUTHENTICATE: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.COULD_NOT_AUTHENTICATE with Double = js.native
    
    /** This receipt could not be authorized. Treat this the same as if a purchase was never made. */
    @js.native
    sealed trait COULD_NOT_AUTHORIZE extends ERROR_CODES
    /* 21010 */ val COULD_NOT_AUTHORIZE: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.COULD_NOT_AUTHORIZE with Double = js.native
    ...
    /* 21006 */ val EXPIRED_SUBSCRIPTION: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.EXPIRED_SUBSCRIPTION with Double = js.native
    
    /** The App Store could not read the JSON object you provided. */
    @js.native
    sealed trait INVALID_JSON extends ERROR_CODES
    /* 21000 */ val INVALID_JSON: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.INVALID_JSON with Double = js.native
    
    /** The data in the receipt-data property was malformed or missing. */
    @js.native
    sealed trait INVALID_RECEIPT_DATA extends ERROR_CODES
    /* 21002 */ val INVALID_RECEIPT_DATA: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.INVALID_RECEIPT_DATA with Double = js.native
    
    /** The shared secret you provided does not match the shared secret on file for your account. */
    @js.native
    sealed trait INVALID_SECRET extends ERROR_CODES
    /* 21004 */ val INVALID_SECRET: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.INVALID_SECRET with Double = js.native
    
    /** This receipt is from the production environment, but it was sent to the test environment for verification. Send it to the production environment instead. */
    @js.native
    sealed trait PROD_RECEIPT extends ERROR_CODES
    /* 21008 */ val PROD_RECEIPT: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.PROD_RECEIPT with Double = js.native
    
    /** The receipt validated successfully. */
    @js.native
    sealed trait SUCCESS extends ERROR_CODES
    /* 0 */ val SUCCESS: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.SUCCESS with Double = js.native
    
    /** This receipt is from the test environment, but it was sent to the production environment for verification. Send it to the test environment instead. */
    @js.native
    sealed trait TEST_RECEIPT extends ERROR_CODES
    /* 21007 */ val TEST_RECEIPT: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.TEST_RECEIPT with Double = js.native
    
    /** The receipt server is not currently available. */
    @js.native
    sealed trait UNAVAILABLE extends ERROR_CODES
    /* 21005 */ val UNAVAILABLE: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.UNAVAILABLE with Double = js.native
    
    /** The receipt is valid, but purchased nothing. */
    @js.native
    sealed trait VALID_BUT_EMPTY extends ERROR_CODES
    /* 2 */ val VALID_BUT_EMPTY: typingsSlinky.nodeAppleReceiptVerify.mod.ERROR_CODES.VALID_BUT_EMPTY with Double = js.native
  }
