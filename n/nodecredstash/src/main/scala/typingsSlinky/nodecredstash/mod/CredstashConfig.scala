...
trait CredstashConfig extends js.Object {
  ...
  var dynamoOpts: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.ClientConfiguration] = js.undefined
...
object CredstashConfig {
  ...
  def apply(
    ...
    dynamoOpts: typingsSlinky.awsSdk.dynamodbMod.ClientConfiguration = null,
    kmsKey: String = null,
