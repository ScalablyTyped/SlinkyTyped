package typingsSlinky.nodeWindows
...
object mod {
  ...
  object LogMode extends StObject {
    ...
    /* "append" */ val append: typingsSlinky.nodeWindows.mod.LogMode.append with String = js.native
    
    @js.native
    sealed trait reset extends LogMode
    /* "reset" */ val reset: typingsSlinky.nodeWindows.mod.LogMode.reset with String = js.native
    
    @js.native
    sealed trait roll extends LogMode
    /* "roll" */ val roll: typingsSlinky.nodeWindows.mod.LogMode.roll with String = js.native
    
    @js.native
    sealed trait rotate extends LogMode
    /* "rotate" */ val rotate: typingsSlinky.nodeWindows.mod.LogMode.rotate with String = js.native
  }
