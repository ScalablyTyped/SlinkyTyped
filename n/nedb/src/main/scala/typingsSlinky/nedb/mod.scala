...
object mod {
  ...
  trait Cursor[T] extends StObject {
    ...
    def exec(callback: js.Function2[/* err */ js.Error | Null, /* documents */ js.Array[T], Unit]): Unit = js.native
  ...
  object Cursor {
    ...
    implicit class CursorMutableBuilder[Self <: Cursor[_], T] (val x: Self with Cursor[T]) extends AnyVal {
      ...
      @scala.inline
      def setExec(value: js.Function2[/* err */ js.Error | Null, /* documents */ js.Array[T], Unit] => Unit): Self = StObject.set(x, "exec", js.Any.fromFunction1(value))
  ...
  trait CursorCount extends StObject {
    ...
    def exec(callback: js.Function2[/* err */ js.Error | Null, /* count */ Double, Unit]): Unit = js.native
  }
  object CursorCount {
    
    @scala.inline
    def apply(exec: js.Function2[/* err */ js.Error | Null, /* count */ Double, Unit] => Unit): CursorCount = {
    ...
    implicit class CursorCountMutableBuilder[Self <: CursorCount] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExec(value: js.Function2[/* err */ js.Error | Null, /* count */ Double, Unit] => Unit): Self = StObject.set(x, "exec", js.Any.fromFunction1(value))
    }
  }
  ...
  trait DataStoreOptions extends StObject {
    ...
    var onload: js.UndefOr[js.Function1[/* error */ js.Error | Null, _]] = js.native
  ...
  object DataStoreOptions {
    ...
    implicit class DataStoreOptionsMutableBuilder[Self <: DataStoreOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnload(value: /* error */ js.Error | Null => _): Self = StObject.set(x, "onload", js.Any.fromFunction1(value))
  ...
  trait Nedb[G] extends EventEmitter {
    ...
    /**
      ...
      */
    def count(query: js.Any, callback: js.Function2[/* err */ js.Error | Null, /* n */ Double, Unit]): Unit = js.native
    ...
    /**
      ...
      * @param query MongoDB-style query
      */
    def findOne[T /* <: G */](query: js.Any, callback: js.Function2[/* err */ js.Error | Null, /* document */ T, Unit]): Unit = js.native
    /**
      * Find one document matching the query
      * @param query MongoDB-style query
      * @param projection MongoDB-style projection
    ...
    def remove(query: js.Any, cb: js.Function2[/* err */ js.Error | Null, /* n */ Double, Unit]): Unit = js.native
    /**
