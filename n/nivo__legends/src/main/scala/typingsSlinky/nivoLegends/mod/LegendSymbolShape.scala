...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.nivoLegends.nivoLegendsStrings.circle
  - typingsSlinky.nivoLegends.nivoLegendsStrings.diamond
  - typingsSlinky.nivoLegends.nivoLegendsStrings.square
  - typingsSlinky.nivoLegends.nivoLegendsStrings.triangle
*/
trait LegendSymbolShape extends js.Object
