...
trait WriterOptions extends js.Object {
  ...
  var prefixes: js.UndefOr[Prefixes[typingsSlinky.rdfJs.mod.NamedNode[String] | String]] = js.native
}
object WriterOptions {
  ...
  implicit class WriterOptionsOps[Self <: WriterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrefixes(value: Prefixes[typingsSlinky.rdfJs.mod.NamedNode[String] | String]): Self = this.set("prefixes", value.asInstanceOf[js.Any])
