...
class BaseQuad protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var graph: typingsSlinky.rdfJs.mod.Term = js.native
  /**
    * The object.
    * @see Quad_Object
    */
  /* CompleteClass */
  override var `object`: typingsSlinky.rdfJs.mod.Term = js.native
  /**
    * The predicate.
    * @see Quad_Predicate
    */
  /* CompleteClass */
  override var predicate: typingsSlinky.rdfJs.mod.Term = js.native
  /**
    * The subject.
    * @see Quad_Subject
    */
  /* CompleteClass */
  override var subject: typingsSlinky.rdfJs.mod.Term = js.native
  /**
    * @param other The term to compare with.
    * @return True if and only if the argument is a) of the same type b) has all components equal.
    */
  /* CompleteClass */
  override def equals(other: typingsSlinky.rdfJs.mod.BaseQuad): Boolean = js.native
