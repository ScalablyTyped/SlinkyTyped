...
object DataFactory extends js.Object {
  ...
  def literal(value: String, languageOrDatatype: typingsSlinky.rdfJs.mod.NamedNode): Literal = js.native
  def literal(value: Double): Literal = js.native
  def literal(value: Double, languageOrDatatype: String): Literal = js.native
  def literal(value: Double, languageOrDatatype: typingsSlinky.rdfJs.mod.NamedNode): Literal = js.native
