...
object mod {
  ...
  class NamedNode[Iri /* <: String */] protected ()
    extends typingsSlinky.rdfJs.mod.NamedNode[Iri] {
  ...
  - typingsSlinky.rdfJs.mod.Quad because var conflicts: graph, `object`, predicate, subject, termType, value. Inlined subject_Quad, predicate_Quad, object_Quad, graph_Quad */ @JSImport("n3", "Quad")
  @js.native
  ...
  object Util {
    ...
    @JSImport("n3", "Util.prefix")
    @js.native
    def prefix(iri: String, factory: DataFactory[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad]): PrefixedToIri = js.native
    @JSImport("n3", "Util.prefix")
    @js.native
    ...
    def prefix(
      ...
      factory: DataFactory[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad]
  ...
  @JSImport("n3", "Writer")
  @js.native
  class Writer[Q /* <: typingsSlinky.rdfJs.mod.BaseQuad */] () extends StObject {
    def this(fd: js.Any) = this()
    def this(options: WriterOptions) = this()
    def this(fd: js.Any, options: WriterOptions) = this()
  ...
  @js.native
  trait BlankTriple[Q /* <: typingsSlinky.rdfJs.mod.BaseQuad */] extends StObject {
  ...
  object BlankTriple {
    ...
    @scala.inline
    def apply[Q /* <: typingsSlinky.rdfJs.mod.BaseQuad */](
      `object`: /* import warning: importer.ImportType#apply Failed type conversion: Q['object'] */ js.Any,
      predicate: /* import warning: importer.ImportType#apply Failed type conversion: Q['predicate'] */ js.Any
    ): BlankTriple[Q] = {
    ...
    @scala.inline
    implicit class BlankTripleMutableBuilder[Self <: BlankTriple[_], Q /* <: typingsSlinky.rdfJs.mod.BaseQuad */] (val x: Self with BlankTriple[Q]) extends AnyVal {
  ...
  type OTerm = typingsSlinky.rdfJs.mod.Term | String | Null
  
  type ParseCallback[Q /* <: BaseQuad */] = js.Function3[
    /* error */ js.Error, 
    /* quad */ Q, 
    /* prefixes */ Prefixes[typingsSlinky.rdfJs.mod.NamedNode[String]], 
    Unit
  ]
  ...
  trait ParserOptions extends StObject {
    ...
    var factory: js.UndefOr[DataFactory[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad]] = js.native
  ...
  object ParserOptions {
    ...
    implicit class ParserOptionsMutableBuilder[Self <: ParserOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFactory(value: DataFactory[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad]): Self = StObject.set(x, "factory", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object WriterOptions {
    ...
    implicit class WriterOptionsMutableBuilder[Self <: WriterOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPrefixes(value: Prefixes[typingsSlinky.rdfJs.mod.NamedNode[String] | String]): Self = StObject.set(x, "prefixes", value.asInstanceOf[js.Any])
