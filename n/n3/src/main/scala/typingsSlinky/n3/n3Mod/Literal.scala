...
class Literal protected ()
  extends typingsSlinky.rdfDashJs.rdfDashJsMod.Literal
     with Quad_Object
     with Term {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var datatype: typingsSlinky.rdfDashJs.rdfDashJsMod.NamedNode = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var termType: typingsSlinky.rdfDashJs.rdfDashJsStrings.Literal = js.native
  /**
