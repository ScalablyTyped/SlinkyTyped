...
class Quad protected () extends BaseQuad {
  ...
  /**
    ...
    */
  @JSName("graph")
  var graph_Quad: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Graph = js.native
  /**
    * The object.
    * @see Quad_Object
    */
  @JSName("object")
  var object_Quad: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Object = js.native
  /**
    * The predicate.
    * @see Quad_Predicate
    */
  @JSName("predicate")
  var predicate_Quad: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Predicate = js.native
  /**
    * The subject.
    * @see Quad_Subject
    */
  @JSName("subject")
  var subject_Quad: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Subject = js.native
}
