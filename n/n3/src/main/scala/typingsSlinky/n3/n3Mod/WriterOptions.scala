...
trait WriterOptions extends js.Object {
  ...
  var prefixes: js.UndefOr[Prefixes[typingsSlinky.rdfDashJs.rdfDashJsMod.NamedNode | String]] = js.undefined
}
...
object WriterOptions {
  ...
  def apply(
    ...
    format: String = null,
    prefixes: Prefixes[typingsSlinky.rdfDashJs.rdfDashJsMod.NamedNode | String] = null
  ): WriterOptions = {
