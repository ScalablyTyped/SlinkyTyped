...
object DataFactory extends js.Object {
  ...
  def literal(value: String, languageOrDatatype: typingsSlinky.rdfDashJs.rdfDashJsMod.NamedNode): Literal = js.native
  def literal(value: Double): Literal = js.native
  def literal(value: Double, languageOrDatatype: String): Literal = js.native
  def literal(value: Double, languageOrDatatype: typingsSlinky.rdfDashJs.rdfDashJsMod.NamedNode): Literal = js.native
  def namedNode(value: String): NamedNode = js.native
  def quad(
    subject: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Subject,
    predicate: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Predicate,
    `object`: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Object
  ): Quad = js.native
  def quad(
    subject: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Subject,
    predicate: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Predicate,
    `object`: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Object,
    graph: typingsSlinky.rdfDashJs.rdfDashJsMod.Quad_Graph
  ): Quad = js.native
  def quad[Q_In /* <: typingsSlinky.rdfDashJs.rdfDashJsMod.BaseQuad */, Q_Out /* <: BaseQuad */](
  ...
  def triple[Q_In /* <: typingsSlinky.rdfDashJs.rdfDashJsMod.BaseQuad */, Q_Out /* <: BaseQuad */](
    subject: /* import warning: importer.ImportType#apply Failed type conversion: Q_In['subject'] */ js.Any,
    predicate: /* import warning: importer.ImportType#apply Failed type conversion: Q_In['predicate'] */ js.Any,
    `object`: /* import warning: importer.ImportType#apply Failed type conversion: Q_In['object'] */ js.Any
  ): Q_Out = js.native
