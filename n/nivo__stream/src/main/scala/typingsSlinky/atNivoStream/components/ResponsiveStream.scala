...
import typingsSlinky.atNivoStream.atNivoStreamMod.StreamProps
...
object ResponsiveStream
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoStream.atNivoStreamMod.ResponsiveStream[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoStream.atNivoStreamMod.ResponsiveStream[js.Any]] = {
  ...
  typingsSlinky.atNivoStream.atNivoStreamMod.ResponsiveStream[js.Any]]]
  }
