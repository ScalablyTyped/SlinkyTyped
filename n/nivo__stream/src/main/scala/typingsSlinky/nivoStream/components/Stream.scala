...
object Stream
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoStream.mod.Stream[js.Any]] {
  ...
  def apply[T](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoStream.mod.Stream[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.nivoStream.mod.Stream[js.Any]]]
  }
  type Props = StreamProps[js.Any] with Dimensions
}
