...
- typingsSlinky.nivoCore.mod.MotionProps because var conflicts: animate, motionDamping, motionStiffness. Inlined  */ trait StreamSvgProps[T] extends StreamProps[T]
