...
object OptionserrsPathLike {
  ...
  @scala.inline
  implicit class OptionserrsPathLikeOps[Self <: OptionserrsPathLike] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrs(value: js.UndefOr[PathLike] with PathLike): Self = this.set("errs", value.asInstanceOf[js.Any])
