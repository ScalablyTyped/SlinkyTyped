...
trait VDOMEl extends js.Object {
  ...
  var children: ReactElement | VDOMEl | (js.Array[ReactElement | VDOMEl]) = js.native
...
object VDOMEl {
  ...
  implicit class VDOMElOps[Self <: VDOMEl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: (ReactElement | VDOMEl)*): Self = this.set("children", js.Array(value :_*))
    @scala.inline
    def setChildren(value: ReactElement | VDOMEl | (js.Array[ReactElement | VDOMEl])): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
