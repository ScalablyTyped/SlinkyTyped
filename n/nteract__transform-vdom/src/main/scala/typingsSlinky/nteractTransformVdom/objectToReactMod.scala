...
object objectToReactMod {
  ...
  object VDOMEl {
    ...
    implicit class VDOMElMutableBuilder[Self <: VDOMEl] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ReactElement | VDOMEl | (js.Array[ReactElement | VDOMEl])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setChildrenVarargs(value: (ReactElement | VDOMEl)*): Self = StObject.set(x, "children", js.Array(value :_*))
