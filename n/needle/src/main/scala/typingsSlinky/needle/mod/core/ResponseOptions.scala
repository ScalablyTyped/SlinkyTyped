...
object ResponseOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(decode_response)) __obj.updateDynamic("decode_response")(decode_response.get.asInstanceOf[js.Any])
    if (output != null) __obj.updateDynamic("output")(output.asInstanceOf[js.Any])
    if (parse != null) __obj.updateDynamic("parse")(parse.asInstanceOf[js.Any])
    if (!js.isUndefined(parse_cookies)) __obj.updateDynamic("parse_cookies")(parse_cookies.get.asInstanceOf[js.Any])
