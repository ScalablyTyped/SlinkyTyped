...
class Table[T] protected () extends js.Object {
  ...
  def findSingle(criteriaRawJsObject: js.Any): typingsSlinky.bluebird.bluebirdMod.^[T] = js.native
  def findSingle(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ T, _]): typingsSlinky.bluebird.bluebirdMod.^[T] = js.native
  /**
  ...
  def remove(criteriaRawObject: js.Any): typingsSlinky.bluebird.bluebirdMod.^[DeleteAnswer] = js.native
  def remove(id: String): typingsSlinky.bluebird.bluebirdMod.^[DeleteAnswer] = js.native
  def remove(id: Double): typingsSlinky.bluebird.bluebirdMod.^[DeleteAnswer] = js.native
  /**
  ...
  def save(criteriaRawJsObject: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def save(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ js.Any, _]): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
}
