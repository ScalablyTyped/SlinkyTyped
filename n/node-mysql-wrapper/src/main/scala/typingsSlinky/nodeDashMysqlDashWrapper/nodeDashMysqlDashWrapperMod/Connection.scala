...
class Connection protected () extends EventEmitter {
  ...
  def this(connection: typingsSlinky.mysql.mysqlMod.Connection) = this()
  def this(connection: ConnectionConfig) = this()
  /**
    * The real database connection socket.
    */
  var connection: typingsSlinky.mysql.mysqlMod.Connection = js.native
  /**
  ...
  /**
    ...
    * @return {nothing}
    */
  def attach(connection: typingsSlinky.mysql.mysqlMod.Connection): Unit = js.native
  /**
    * Clear all binary logs from the whole database.
    * When finish returns a promise, use it with .then(function(){});
    * @return Promise
    */
  def clearBinaryLogs(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  def create(connection: typingsSlinky.mysql.mysqlMod.Connection): Unit = js.native
  ...
  /**
    ...
    * @return {Promise}
    */
  def fetchDatabaseInformation(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    * @return {Promise}
    */
  def link(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  def link(readyCallback: js.Function0[Unit]): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
