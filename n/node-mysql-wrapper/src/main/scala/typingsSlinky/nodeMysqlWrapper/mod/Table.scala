...
class Table[T] protected () extends StObject {
  ...
  def findSingle(criteriaRawJsObject: js.Any): typingsSlinky.bluebird.mod.^[T] = js.native
  def findSingle(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ T, _]): typingsSlinky.bluebird.mod.^[T] = js.native
  ...
  def remove(criteriaRawObject: js.Any): typingsSlinky.bluebird.mod.^[DeleteAnswer] = js.native
  def remove(id: String): typingsSlinky.bluebird.mod.^[DeleteAnswer] = js.native
  def remove(id: Double): typingsSlinky.bluebird.mod.^[DeleteAnswer] = js.native
  ...
  def save(criteriaRawJsObject: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  def save(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ js.Any, _]): typingsSlinky.bluebird.mod.^[_] = js.native
}
