...
object PartialRouteOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(recursiveWildcard)) __obj.updateDynamic("recursiveWildcard")(recursiveWildcard.asInstanceOf[js.Any])
    if (!js.isUndefined(wildcardInPairs)) __obj.updateDynamic("wildcardInPairs")(wildcardInPairs.asInstanceOf[js.Any])
