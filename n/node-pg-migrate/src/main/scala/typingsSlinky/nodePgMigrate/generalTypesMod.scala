...
import typingsSlinky.nodePgMigrate.anon.ZzIGNOREME
...
object generalTypesMod {
  ...
  type Name = String | typingsSlinky.nodePgMigrate.anon.Name
  
  type Nullable[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: T[P] | null}
    */ typingsSlinky.nodePgMigrate.nodePgMigrateStrings.Nullable with TopLevel[T]
  ...
  {[ K in keyof T ]: T[K]}
    */ typingsSlinky.nodePgMigrate.nodePgMigrateStrings.PublicPart with TopLevel[T]
  
  type Type = String | typingsSlinky.nodePgMigrate.anon.Type
