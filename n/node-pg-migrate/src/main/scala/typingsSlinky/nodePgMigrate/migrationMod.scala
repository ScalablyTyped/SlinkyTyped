...
object migrationMod {
  ...
  object FilenameFormat extends StObject {
    ...
    /* "timestamp" */ val timestamp: typingsSlinky.nodePgMigrate.migrationMod.FilenameFormat.timestamp with String = js.native
    
    @js.native
    sealed trait utc extends FilenameFormat
    /* "utc" */ val utc: typingsSlinky.nodePgMigrate.migrationMod.FilenameFormat.utc with String = js.native
  }
  ...
  type CreateOptions = typingsSlinky.nodePgMigrate.anon.FilenameFormat with (CreateOptionsTemplate | CreateOptionsDefault)
