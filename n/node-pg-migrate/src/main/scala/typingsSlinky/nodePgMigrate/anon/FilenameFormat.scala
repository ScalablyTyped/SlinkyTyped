...
trait FilenameFormat extends StObject {
  ...
  var filenameFormat: js.UndefOr[typingsSlinky.nodePgMigrate.migrationMod.FilenameFormat] = js.native
}
object FilenameFormat {
  ...
  implicit class FilenameFormatMutableBuilder[Self <: FilenameFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilenameFormat(value: typingsSlinky.nodePgMigrate.migrationMod.FilenameFormat): Self = StObject.set(x, "filenameFormat", value.asInstanceOf[js.Any])
