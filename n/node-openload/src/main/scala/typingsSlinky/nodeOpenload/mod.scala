...
import typingsSlinky.nodeOpenload.anon.Added
import typingsSlinky.nodeOpenload.anon.Contenttype
...
object mod {
  ...
  object UploadParam {
    ...
    implicit class UploadParamMutableBuilder[Self <: UploadParam] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFile(value: String | js.typedarray.ArrayBuffer): Self = StObject.set(x, "file", value.asInstanceOf[js.Any])
