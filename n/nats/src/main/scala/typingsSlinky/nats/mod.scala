...
object mod {
  ...
  trait NatsError extends Error {
    ...
    var chainedError: js.Error = js.native
  ...
  object NatsError {
    ...
    @scala.inline
    def apply(chainedError: js.Error, code: String, message: String, name: String): NatsError = {
    ...
    implicit class NatsErrorMutableBuilder[Self <: NatsError] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChainedError(value: js.Error): Self = StObject.set(x, "chainedError", value.asInstanceOf[js.Any])
