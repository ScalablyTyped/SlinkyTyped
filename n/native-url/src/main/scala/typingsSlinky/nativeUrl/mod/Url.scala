...
trait Url extends js.Object {
  ...
  var query: String | Null | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ParsedUrlQuery */ js.Any) = js.native
...
object Url {
  ...
  implicit class UrlOps[Self <: Url] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQuery(
      value: String | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ParsedUrlQuery */ js.Any)
    ): Self = {
        val ret = this.duplicate
