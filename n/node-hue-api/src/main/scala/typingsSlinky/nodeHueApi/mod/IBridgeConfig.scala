...
object IBridgeConfig {
  ...
  implicit class IBridgeConfigMutableBuilder[Self <: IBridgeConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocaltime(value: js.Date): Self = StObject.set(x, "localtime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUTC(value: js.Date): Self = StObject.set(x, "UTC", value.asInstanceOf[js.Any])
