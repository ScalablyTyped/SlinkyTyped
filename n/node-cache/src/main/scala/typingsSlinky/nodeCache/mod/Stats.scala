...
object Stats {
  ...
  implicit class StatsOps[Self <: Stats] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKsize(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ksize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMisses(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("misses")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
