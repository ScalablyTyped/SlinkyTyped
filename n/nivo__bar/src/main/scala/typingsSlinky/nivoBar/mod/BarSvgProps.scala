...
/* Inlined @nivo/bar.@nivo/bar.Data & @nivo/bar.@nivo/bar.BarProps & @nivo/core.@nivo/core.MotionProps & @nivo/core.@nivo/core.SvgDefsAndFill<@nivo/bar.@nivo/bar.BarDatum> & std.Partial<{  layers :std.Array<@nivo/bar.@nivo/bar.Layer>,   onClick :@nivo/bar.@nivo/bar.BarMouseEventHandler<std.SVGRectElement>,   onMouseEnter :@nivo/bar.@nivo/bar.BarMouseEventHandler<std.SVGRectElement>,   onMouseLeave :@nivo/bar.@nivo/bar.BarMouseEventHandler<std.SVGRectElement>}> */
@js.native
trait BarSvgProps extends js.Object {
  ...
  var onClick: js.UndefOr[BarMouseEventHandler[SVGRectElement]] = js.native
  var onMouseEnter: js.UndefOr[BarMouseEventHandler[SVGRectElement]] = js.native
  var onMouseLeave: js.UndefOr[BarMouseEventHandler[SVGRectElement]] = js.native
...
object BarSvgProps {
  ...
  implicit class BarSvgPropsOps[Self <: BarSvgProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFillVarargs(value: Id[BarDatum]*): Self = this.set("fill", js.Array(value :_*))
    @scala.inline
    def setFill(value: js.Array[Id[BarDatum]]): Self = this.set("fill", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnClick(value: (/* datum */ BarExtendedDatum, /* event */ SyntheticMouseEvent[SVGRectElement]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    @scala.inline
    def setOnMouseEnter(value: (/* datum */ BarExtendedDatum, /* event */ SyntheticMouseEvent[SVGRectElement]) => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    @scala.inline
    def setOnMouseLeave(value: (/* datum */ BarExtendedDatum, /* event */ SyntheticMouseEvent[SVGRectElement]) => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction2(value))
    @scala.inline
