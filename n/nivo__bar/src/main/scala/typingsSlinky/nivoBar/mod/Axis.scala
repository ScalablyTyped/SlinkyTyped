...
trait Axis extends js.Object {
  var format: js.UndefOr[String | LabelFormatter] = js.native
  ...
  var tickValues: js.UndefOr[Double | (js.Array[Double | String])] = js.native
}
...
object Axis {
  ...
  implicit class AxisOps[Self <: Axis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFormatFunction1(value: /* label */ String | Double => String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("format")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFormat(value: String | LabelFormatter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTickValues(value: Double | (js.Array[Double | String])): Self = {
        val ret = this.duplicate
