package typingsSlinky.nivoBar.anon

import slinky.web.SyntheticMouseEvent
import typingsSlinky.nivoBar.nivoBarStrings.indexes
import typingsSlinky.nivoBar.nivoBarStrings.keys
...
object dataFromindexeskeysLegend {
  ...
  implicit class dataFromindexeskeysLegendOps[Self <: dataFromindexeskeysLegend] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* data */ LegendMouseHandlerData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    
    @scala.inline
    def setOnMouseEnter(value: (/* data */ LegendMouseHandlerData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: (/* data */ LegendMouseHandlerData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction2(value))
