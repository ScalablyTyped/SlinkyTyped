...
object ResponsiveBarCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.nivoBar.mod.ResponsiveBarCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.nivoBar.mod.ResponsiveBarCanvas] = {
