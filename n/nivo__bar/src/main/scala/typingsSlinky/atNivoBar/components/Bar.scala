...
import typingsSlinky.atNivoBar.BarSvgPropsDimensions
...
object Bar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoBar.atNivoBarMod.Bar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoBar.atNivoBarMod.Bar] = {
  ...
  type Props = BarSvgPropsDimensions
}
