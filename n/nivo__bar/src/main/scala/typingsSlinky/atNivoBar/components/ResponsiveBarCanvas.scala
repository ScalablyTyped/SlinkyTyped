...
import typingsSlinky.atNivoBar.atNivoBarMod.BarCanvasProps
...
object ResponsiveBarCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoBar.atNivoBarMod.ResponsiveBarCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoBar.atNivoBarMod.ResponsiveBarCanvas] = {
