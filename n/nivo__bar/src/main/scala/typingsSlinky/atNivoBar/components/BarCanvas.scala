...
import typingsSlinky.atNivoBar.BarCanvasPropsDimensions
...
object BarCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoBar.atNivoBarMod.BarCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoBar.atNivoBarMod.BarCanvas] = {
  ...
  type Props = BarCanvasPropsDimensions
}
