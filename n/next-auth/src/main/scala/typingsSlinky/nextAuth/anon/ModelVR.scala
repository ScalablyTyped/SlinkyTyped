...
trait ModelVR[VR /* <: TypeORMVerificationRequestModel */] extends StObject {
  ...
  var schema: typingsSlinky.nextAuth.adaptersMod.Schema[VR] = js.native
}
object ModelVR {
  
  @scala.inline
  def apply[VR /* <: TypeORMVerificationRequestModel */](model: VR, schema: typingsSlinky.nextAuth.adaptersMod.Schema[VR]): ModelVR[VR] = {
  ...
  implicit class ModelVRMutableBuilder[Self <: ModelVR[_], VR /* <: TypeORMVerificationRequestModel */] (val x: Self with ModelVR[VR]) extends AnyVal {
    ...
    @scala.inline
    def setSchema(value: typingsSlinky.nextAuth.adaptersMod.Schema[VR]): Self = StObject.set(x, "schema", value.asInstanceOf[js.Any])
  }
}
