...
trait Schema[A /* <: TypeORMAccountModel */] extends StObject {
  ...
  var schema: typingsSlinky.nextAuth.adaptersMod.Schema[A] = js.native
}
object Schema {
  
  @scala.inline
  def apply[A /* <: TypeORMAccountModel */](model: A, schema: typingsSlinky.nextAuth.adaptersMod.Schema[A]): Schema[A] = {
  ...
  implicit class SchemaMutableBuilder[Self <: Schema[_], A /* <: TypeORMAccountModel */] (val x: Self with Schema[A]) extends AnyVal {
    ...
    @scala.inline
    def setSchema(value: typingsSlinky.nextAuth.adaptersMod.Schema[A]): Self = StObject.set(x, "schema", value.asInstanceOf[js.Any])
  }
}
