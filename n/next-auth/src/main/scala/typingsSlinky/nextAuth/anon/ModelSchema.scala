...
trait ModelSchema[U /* <: TypeORMUserModel */] extends StObject {
  ...
  var schema: typingsSlinky.nextAuth.adaptersMod.Schema[U] = js.native
}
object ModelSchema {
  
  @scala.inline
  def apply[U /* <: TypeORMUserModel */](model: U, schema: typingsSlinky.nextAuth.adaptersMod.Schema[U]): ModelSchema[U] = {
  ...
  implicit class ModelSchemaMutableBuilder[Self <: ModelSchema[_], U /* <: TypeORMUserModel */] (val x: Self with ModelSchema[U]) extends AnyVal {
    ...
    @scala.inline
    def setSchema(value: typingsSlinky.nextAuth.adaptersMod.Schema[U]): Self = StObject.set(x, "schema", value.asInstanceOf[js.Any])
  }
}
