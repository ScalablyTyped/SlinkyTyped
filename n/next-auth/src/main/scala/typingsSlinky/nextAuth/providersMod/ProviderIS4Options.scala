...
import typingsSlinky.nextAuth.nextAuthStrings.`identity-server4`
...
trait ProviderIS4Options extends StObject {
  ...
  var name: typingsSlinky.nextAuth.nextAuthStrings.IdentityServer4 = js.native
...
object ProviderIS4Options {
  ...
  def apply(
    ...
    domain: String,
    id: `identity-server4`,
    name: typingsSlinky.nextAuth.nextAuthStrings.IdentityServer4,
    scope: String
  ): ProviderIS4Options = {
  ...
  implicit class ProviderIS4OptionsMutableBuilder[Self <: ProviderIS4Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.nextAuth.nextAuthStrings.IdentityServer4): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
