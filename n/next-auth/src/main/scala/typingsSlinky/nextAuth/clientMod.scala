...
import typingsSlinky.nextAuth.anon.Req
...
object clientMod {
  ...
  @js.native
  val Provider: ReactComponentClass[ContextProviderProps] = js.native
  ...
  type ContextProvider = ReactComponentClass[ContextProviderProps]
