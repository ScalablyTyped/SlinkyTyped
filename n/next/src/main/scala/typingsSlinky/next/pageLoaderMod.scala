...
import typingsSlinky.next.routeLoaderMod.RouteLoader
...
object pageLoaderMod {
  ...
  object GoodPageCache {
    ...
    implicit class GoodPageCacheMutableBuilder[Self <: GoodPageCache] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPage(value: ReactComponentClass[js.Object]): Self = StObject.set(x, "page", value.asInstanceOf[js.Any])
