...
object StyleHTMLAttributes {
  ...
  def apply[T](
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event_, T] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with T, Event_] => Unit = null,
    onBlur: SyntheticFocusEvent[T] => Unit = null,
    onCanPlay: SyntheticEvent[Event_, T] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, T] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, T] => Unit = null,
    onEmptied: SyntheticEvent[Event_, T] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, T] => Unit = null,
    onEnded: SyntheticEvent[Event_, T] => Unit = null,
    onError: SyntheticEvent[Event_, T] => Unit = null,
    onFocus: SyntheticFocusEvent[T] => Unit = null,
    onInput: SyntheticEvent[EventTarget with T, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with T, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, T] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, T] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, T] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, T] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, T] => Unit = null,
    onPlay: SyntheticEvent[Event_, T] => Unit = null,
    onPlaying: SyntheticEvent[Event_, T] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, T] => Unit = null,
    onRateChange: SyntheticEvent[Event_, T] => Unit = null,
    onReset: SyntheticEvent[EventTarget with T, Event_] => Unit = null,
    onScroll: SyntheticUIEvent[T] => Unit = null,
    onSeeked: SyntheticEvent[Event_, T] => Unit = null,
    onSeeking: SyntheticEvent[Event_, T] => Unit = null,
    onSelect: SyntheticEvent[Event_, T] => Unit = null,
    onStalled: SyntheticEvent[Event_, T] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with T, Event_] => Unit = null,
    onSuspend: SyntheticEvent[Event_, T] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, T] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, T] => Unit = null,
    onWaiting: SyntheticEvent[Event_, T] => Unit = null,
