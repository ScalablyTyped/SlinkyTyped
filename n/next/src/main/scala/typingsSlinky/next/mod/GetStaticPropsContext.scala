...
object GetStaticPropsContext {
  @scala.inline
  def apply[/* <: typingsSlinky.node.querystringMod.ParsedUrlQuery */ Q](): GetStaticPropsContext[Q] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetStaticPropsContext[Q]]
  }
  @scala.inline
  implicit class GetStaticPropsContextOps[Self <: GetStaticPropsContext[_], /* <: typingsSlinky.node.querystringMod.ParsedUrlQuery */ Q] (val x: Self with GetStaticPropsContext[Q]) extends AnyVal {
    @scala.inline
