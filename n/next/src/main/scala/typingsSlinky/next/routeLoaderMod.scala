...
import typingsSlinky.next.buildManifestPluginMod.ClientBuildManifest
...
object routeLoaderMod {
  ...
  @JSImport("next/dist/client/route-loader", "isAssetError")
  @js.native
  def isAssetError(err: js.Error): js.UndefOr[Boolean] = js.native
  
  @JSImport("next/dist/client/route-loader", "markAssetError")
  @js.native
  def markAssetError(err: js.Error): js.Error = js.native
  ...
  object LoadedRouteSuccess {
    ...
    @scala.inline
    def apply(component: ReactComponentClass[js.Object], exports: js.Any, styles: js.Array[RouteStyleSheet]): LoadedRouteSuccess = {
  ...
  */
  ...
  object RouteEntrypoint {
    ...
    @scala.inline
    def LoadedEntrypointFailure(error: js.Any): typingsSlinky.next.routeLoaderMod.LoadedEntrypointFailure = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.next.routeLoaderMod.LoadedEntrypointFailure]
    }
    
    @scala.inline
    def LoadedEntrypointSuccess(component: ReactComponentClass[js.Object], exports: js.Any): typingsSlinky.next.routeLoaderMod.LoadedEntrypointSuccess = {
      val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any], exports = exports.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.next.routeLoaderMod.LoadedEntrypointSuccess]
    }
  }
  ...
  */
  ...
  object RouteLoaderEntry {
    ...
    @scala.inline
    def LoadedRouteFailure(error: js.Any): typingsSlinky.next.routeLoaderMod.LoadedRouteFailure = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.next.routeLoaderMod.LoadedRouteFailure]
    }
    
    @scala.inline
    def LoadedRouteSuccess(component: ReactComponentClass[js.Object], exports: js.Any, styles: js.Array[RouteStyleSheet]): typingsSlinky.next.routeLoaderMod.LoadedRouteSuccess = {
      val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any], exports = exports.asInstanceOf[js.Any], styles = styles.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.next.routeLoaderMod.LoadedRouteSuccess]
    }
  }
