...
object AppPropsType {
  @scala.inline
  def apply[/* <: typingsSlinky.next.routerMod.NextRouter */ R, P](Component: NextComponentType[NextPageContext, _, P], pageProps: js.Any, router: R): AppPropsType[R, P] = {
  ...
  @scala.inline
  implicit class AppPropsTypeOps[Self <: AppPropsType[_, _], /* <: typingsSlinky.next.routerMod.NextRouter */ R, P] (val x: Self with (AppPropsType[R, P])) extends AnyVal {
    @scala.inline
