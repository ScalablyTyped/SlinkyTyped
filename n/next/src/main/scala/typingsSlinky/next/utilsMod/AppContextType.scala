...
object AppContextType {
  ...
  implicit class AppContextTypeOps[Self[r] <: AppContextType[r], R] (val x: Self[R]) extends AnyVal {
    ...
    @scala.inline
    def withAppTreeFunctionComponent(value: ReactComponentClass[AppInitialPropsnamestring]): Self[R] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppTree")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAppTreeComponentClass(value: ReactComponentClass[AppInitialPropsnamestring]): Self[R] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppTree")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAppTree(value: AppTreeType): Self[R] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppTree")(value.asInstanceOf[js.Any])
        ret
    }
