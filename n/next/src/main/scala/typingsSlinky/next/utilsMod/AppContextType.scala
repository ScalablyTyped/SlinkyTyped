...
object AppContextType {
  @scala.inline
  def apply[/* <: typingsSlinky.next.routerMod.NextRouter */ R](
    AppTree: AppTreeType,
  ...
  @scala.inline
  implicit class AppContextTypeOps[Self <: AppContextType[_], /* <: typingsSlinky.next.routerMod.NextRouter */ R] (val x: Self with AppContextType[R]) extends AnyVal {
    @scala.inline
