...
import typingsSlinky.next.nextStrings.data
import typingsSlinky.next.nextStrings.end
import typingsSlinky.next.nextStrings.error
import typingsSlinky.next.nextStrings.pause
import typingsSlinky.next.nextStrings.readable
import typingsSlinky.next.nextStrings.resume
