...
import typingsSlinky.next.anon.GetInitialProps
import typingsSlinky.next.anon.Head
import typingsSlinky.next.anon.MaxAge
import typingsSlinky.next.anon.RenderDocument
...
object libUtilsMod {
  ...
  @js.native
  def getDisplayName[P](Component: ReactComponentClass[P]): String = js.native
  ...
  object AppContextType {
    ...
    implicit class AppContextTypeMutableBuilder[Self <: AppContextType[_], R /* <: NextRouter */] (val x: Self with AppContextType[R]) extends AnyVal {
      ...
      @scala.inline
      def setAppTreeComponentClass(value: ReactComponentClass[AppInitialPropsnamestring]): Self = StObject.set(x, "AppTree", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAppTreeFunctionComponent(value: ReactComponentClass[AppInitialPropsnamestring]): Self = StObject.set(x, "AppTree", value.asInstanceOf[js.Any])
  ...
  type AppTreeType = ReactComponentClass[AppInitialPropsnamestring]
  ...
  object DocumentInitialProps {
    ...
    implicit class DocumentInitialPropsMutableBuilder[Self <: DocumentInitialProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHead(value: js.Array[ReactElement | Null]): Self = StObject.set(x, "head", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHeadUndefined: Self = StObject.set(x, "head", js.undefined)
      
      @scala.inline
      def setHeadVarargs(value: (ReactElement | Null)*): Self = StObject.set(x, "head", js.Array(value :_*))
  ...
  type NextComponentType[C /* <: BaseContext */, IP, P] = ReactComponentClass[P] with (GetInitialProps[C, IP])
