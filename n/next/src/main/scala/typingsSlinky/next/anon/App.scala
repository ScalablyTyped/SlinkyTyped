...
object App {
  ...
  implicit class AppMutableBuilder[Self <: App] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppComponentClass(value: ReactComponentClass[AppProps]): Self = StObject.set(x, "App", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAppFunctionComponent(value: ReactComponentClass[AppProps]): Self = StObject.set(x, "App", value.asInstanceOf[js.Any])
