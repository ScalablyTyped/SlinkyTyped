...
object GetInitialProps {
  @scala.inline
  def apply[/* <: typingsSlinky.next.utilsMod.BaseContext */ C, IP](): GetInitialProps[C, IP] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetInitialProps[C, IP]]
  }
  @scala.inline
  implicit class GetInitialPropsOps[Self <: GetInitialProps[_, _], /* <: typingsSlinky.next.utilsMod.BaseContext */ C, IP] (val x: Self with (GetInitialProps[C, IP])) extends AnyVal {
    @scala.inline
