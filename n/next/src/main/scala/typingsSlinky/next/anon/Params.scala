...
object Params {
  @scala.inline
  def apply[/* <: typingsSlinky.node.querystringMod.ParsedUrlQuery */ P](params: P): Params[P] = {
    val __obj = js.Dynamic.literal(params = params.asInstanceOf[js.Any])
    __obj.asInstanceOf[Params[P]]
  }
  @scala.inline
  implicit class ParamsOps[Self <: Params[_], /* <: typingsSlinky.node.querystringMod.ParsedUrlQuery */ P] (val x: Self with Params[P]) extends AnyVal {
    @scala.inline
