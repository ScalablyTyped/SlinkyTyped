...
object Fallback {
  @scala.inline
  def apply[/* <: typingsSlinky.node.querystringMod.ParsedUrlQuery */ P](fallback: Boolean, paths: js.Array[String | Params[P]]): Fallback[P] = {
  ...
  @scala.inline
  implicit class FallbackOps[Self <: Fallback[_], /* <: typingsSlinky.node.querystringMod.ParsedUrlQuery */ P] (val x: Self with Fallback[P]) extends AnyVal {
    @scala.inline
