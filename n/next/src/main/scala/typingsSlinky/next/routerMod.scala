...
import typingsSlinky.next.anon.PickCompletePrivateRouteI
...
object routerMod {
  ...
  type AppComponent = ReactComponentClass[AppProps]
  
  type AppProps = PickCompletePrivateRouteI with typingsSlinky.next.anon.Router with (Record[String, _])
  ...
  */
  ...
  object PrivateRouteInfo {
    ...
    @scala.inline
    def CompletePrivateRouteInfo(Component: ReactComponentClass[js.Object], styleSheets: js.Array[StyleSheetTuple]): typingsSlinky.next.routerMod.CompletePrivateRouteInfo = {
      val __obj = js.Dynamic.literal(Component = Component.asInstanceOf[js.Any], styleSheets = styleSheets.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.next.routerMod.CompletePrivateRouteInfo]
    }
    
    @scala.inline
    def OmitCompletePrivateRouteI(Component: ReactComponentClass[js.Object], initial: `true`): typingsSlinky.next.anon.OmitCompletePrivateRouteI = {
      val __obj = js.Dynamic.literal(Component = Component.asInstanceOf[js.Any], initial = initial.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.next.anon.OmitCompletePrivateRouteI]
    }
  }
