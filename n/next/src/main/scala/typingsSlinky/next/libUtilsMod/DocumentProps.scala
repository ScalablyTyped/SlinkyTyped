...
import typingsSlinky.next.anon.Head
...
object DocumentProps {
  ...
  implicit class DocumentPropsOps[Self <: DocumentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDevOnlyCacheBusterQueryString(value: String): Self = this.set("devOnlyCacheBusterQueryString", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDocComponentsRendered(value: Head): Self = this.set("docComponentsRendered", value.asInstanceOf[js.Any])
