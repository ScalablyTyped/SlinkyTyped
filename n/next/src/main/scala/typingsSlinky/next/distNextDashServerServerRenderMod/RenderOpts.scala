...
import typingsSlinky.next.distNextDashServerServerGetDashPageDashFilesMod.BuildManifest
...
trait RenderOpts extends js.Object {
  ...
  var ErrorDebug: js.UndefOr[ReactComponentClass[Anon_Error]] = js.undefined
...
object RenderOpts {
  ...
  def apply(
    ...
    ErrorDebug: ReactComponentClass[Anon_Error] = null,
    ampMode: js.Any = null,
    ampPath: String = null,
