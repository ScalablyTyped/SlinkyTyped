...
@js.native
trait AnonCatchAllRoute extends js.Object {
...
object AnonCatchAllRoute {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonCatchAllRoute]
  }
  @scala.inline
  implicit class AnonCatchAllRouteOps[Self <: AnonCatchAllRoute] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDynamicRoutes(value: DynamicRoutes): Self = {
        val ret = this.duplicate
