...
object mod {
  ...
  @JSImport("node-schedule", "rescheduleJob")
  @js.native
  def rescheduleJob(job: String, spec: js.Date): Job = js.native
  @JSImport("node-schedule", "rescheduleJob")
  @js.native
  ...
  @JSImport("node-schedule", "rescheduleJob")
  @js.native
  def rescheduleJob(job: Job, spec: js.Date): Job = js.native
  @JSImport("node-schedule", "rescheduleJob")
  @js.native
  ...
  @JSImport("node-schedule", "scheduleJob")
  @js.native
  def scheduleJob(name: String, rule: js.Date, callback: JobCallback): Job = js.native
  @JSImport("node-schedule", "scheduleJob")
  @js.native
  ...
  @JSImport("node-schedule", "scheduleJob")
  @js.native
  def scheduleJob(rule: js.Date, callback: JobCallback): Job = js.native
  @JSImport("node-schedule", "scheduleJob")
  @js.native
  ...
  object RecurrenceSpecDateRange {
    ...
    implicit class RecurrenceSpecDateRangeMutableBuilder[Self <: RecurrenceSpecDateRange] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEnd(value: js.Date | String | Double): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStart(value: js.Date | String | Double): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
