...
@js.native
trait INotyfEventPayload extends js.Object {
...
object INotyfEventPayload {
  ...
  @scala.inline
  implicit class INotyfEventPayloadOps[Self <: INotyfEventPayload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTarget(value: NotyfNotification): Self = this.set("target", value.asInstanceOf[js.Any])
