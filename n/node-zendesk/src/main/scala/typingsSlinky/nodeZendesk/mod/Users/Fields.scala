...
object Fields {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.text
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.textarea
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.checkbox
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.date
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.integer
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.decimal
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.regexp
    - typingsSlinky.nodeZendesk.nodeZendeskStrings.tagger
  */
  trait UserFieldType extends StObject
  object UserFieldType {
    
    @scala.inline
    def checkbox: typingsSlinky.nodeZendesk.nodeZendeskStrings.checkbox = "checkbox".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.checkbox]
    
    @scala.inline
    def date: typingsSlinky.nodeZendesk.nodeZendeskStrings.date = "date".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.date]
    
    @scala.inline
    def decimal: typingsSlinky.nodeZendesk.nodeZendeskStrings.decimal = "decimal".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.decimal]
    
    @scala.inline
    def integer: typingsSlinky.nodeZendesk.nodeZendeskStrings.integer = "integer".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.integer]
    
    @scala.inline
    def regexp: typingsSlinky.nodeZendesk.nodeZendeskStrings.regexp = "regexp".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.regexp]
    
    @scala.inline
    def tagger: typingsSlinky.nodeZendesk.nodeZendeskStrings.tagger = "tagger".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.tagger]
    
    @scala.inline
    def text: typingsSlinky.nodeZendesk.nodeZendeskStrings.text = "text".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.text]
    
    @scala.inline
    def textarea: typingsSlinky.nodeZendesk.nodeZendeskStrings.textarea = "textarea".asInstanceOf[typingsSlinky.nodeZendesk.nodeZendeskStrings.textarea]
  }
}
