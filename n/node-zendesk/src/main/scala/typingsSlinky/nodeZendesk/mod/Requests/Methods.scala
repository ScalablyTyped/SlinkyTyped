...
trait Methods extends js.Object {
  ...
  /** Get Comment */
  def getComment(requestId: ZendeskID, commentId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.Requests.Comments.ResponsePayload
  /** Viewing Requests */
  ...
  /** Listing Comments */
  def listComments(requestId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.Requests.Comments.ListPayload
