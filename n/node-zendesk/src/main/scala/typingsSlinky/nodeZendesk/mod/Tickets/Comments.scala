...
object Comments {
  ...
  object CommentsUsers {
    ...
    object ResponseModel {
      ...
      @scala.inline
      def apply(agent: Boolean, id: ZendeskID, name: String, role: Role): typingsSlinky.nodeZendesk.mod.Tickets.Comments.CommentsUsers.ResponseModel = {
        ...
        __obj.asInstanceOf[typingsSlinky.nodeZendesk.mod.Tickets.Comments.CommentsUsers.ResponseModel]
      }
      
      @scala.inline
      implicit class ResponseModelMutableBuilder[Self <: typingsSlinky.nodeZendesk.mod.Tickets.Comments.CommentsUsers.ResponseModel] (val x: Self) extends AnyVal {
  ...
  trait ListPayload extends PaginablePayload {
    ...
    var comments: js.Array[typingsSlinky.nodeZendesk.mod.Tickets.Comments.ResponseModel] = js.native
  }
  object ListPayload {
    
    @scala.inline
    def apply(comments: js.Array[typingsSlinky.nodeZendesk.mod.Tickets.Comments.ResponseModel], count: Double): typingsSlinky.nodeZendesk.mod.Tickets.Comments.ListPayload = {
      val __obj = js.Dynamic.literal(comments = comments.asInstanceOf[js.Any], count = count.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.nodeZendesk.mod.Tickets.Comments.ListPayload]
    }
    
    @scala.inline
    implicit class ListPayloadMutableBuilder[Self <: typingsSlinky.nodeZendesk.mod.Tickets.Comments.ListPayload] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setComments(value: js.Array[typingsSlinky.nodeZendesk.mod.Tickets.Comments.ResponseModel]): Self = StObject.set(x, "comments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCommentsVarargs(value: typingsSlinky.nodeZendesk.mod.Tickets.Comments.ResponseModel*): Self = StObject.set(x, "comments", js.Array(value :_*))
    }
  }
  ...
  object Organizations {
    ...
    object ResponseModel {
      ...
      @scala.inline
      def apply(id: ZendeskID, name: String): typingsSlinky.nodeZendesk.mod.Tickets.Comments.Organizations.ResponseModel = {
        val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.nodeZendesk.mod.Tickets.Comments.Organizations.ResponseModel]
      }
      
      @scala.inline
      implicit class ResponseModelMutableBuilder[Self <: typingsSlinky.nodeZendesk.mod.Tickets.Comments.Organizations.ResponseModel] (val x: Self) extends AnyVal {
  ...
  object ResponseModel {
    ...
    def apply(
      ...
      `type`: RequestType,
      url: String
    ): typingsSlinky.nodeZendesk.mod.Tickets.Comments.ResponseModel = {
      ...
      __obj.asInstanceOf[typingsSlinky.nodeZendesk.mod.Tickets.Comments.ResponseModel]
    }
  }
}
