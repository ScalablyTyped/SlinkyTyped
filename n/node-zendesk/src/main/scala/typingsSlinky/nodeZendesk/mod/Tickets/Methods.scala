...
trait Methods extends js.Object {
  ...
  def createMany(tickets: CreateManyPayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.JobStatuses.ResponsePayload
  /** Deleting Tickets */
  ...
  /** Listing Comments */
  def getComments(requestId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.Tickets.Comments.ListPayload
  ...
  def listCollaborators(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.Users.ListPayload
  def listIncidents(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): ListPayload
  def listMetrics(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.Tickets.Metrics.ResponsePayload
  ...
  /** Merging Tickets */
  def merge(ticketId: ZendeskID, mergingTickets: MergePayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.JobStatuses.ResponsePayload
  /** Viewing Tickets */
  ...
  def updateMany(tickets: UpdateManyPayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeZendesk.mod.JobStatuses.ResponsePayload
}
