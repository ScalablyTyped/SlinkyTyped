...
object ListPayload {
  ...
  implicit class ListPayloadOps[Self <: ListPayload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOrganizationsVarargs(value: typingsSlinky.nodeZendesk.mod.Tickets.Comments.Organizations.ResponseModel*): Self = this.set("organizations", js.Array(value :_*))
    
    @scala.inline
    def setOrganizations(value: js.Array[typingsSlinky.nodeZendesk.mod.Tickets.Comments.Organizations.ResponseModel]): Self = this.set("organizations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUsersVarargs(value: typingsSlinky.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[typingsSlinky.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel]): Self = this.set("users", value.asInstanceOf[js.Any])
  }
}
