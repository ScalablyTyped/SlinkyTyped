...
trait Client extends js.Object {
  ...
  var jobstatuses: typingsSlinky.nodeZendesk.mod.JobStatuses.Methods
  var locales: js.Any
  var macros: typingsSlinky.nodeZendesk.mod.Macros.Methods
  var oauthtokens: js.Any
  var organizationfields: js.Any
  var organizationmemberships: js.Any
  var organizations: js.Any
  var policies: js.Any
  var requests: typingsSlinky.nodeZendesk.mod.Requests.Methods
  ...
  var tickets: typingsSlinky.nodeZendesk.mod.Tickets.Methods
  var topiccomments: js.Any
  var topics: js.Any
  var topicsubscriptions: js.Any
  var topicvotes: js.Any
  var triggers: js.Any
  var userfields: typingsSlinky.nodeZendesk.mod.Users.Fields.Methods
  var useridentities: typingsSlinky.nodeZendesk.mod.Users.Identities.Methods
  var users: typingsSlinky.nodeZendesk.mod.Users.Methods
  var views: js.Any
}
