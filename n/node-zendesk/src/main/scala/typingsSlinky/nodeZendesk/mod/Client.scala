...
object Client {
  ...
  implicit class ClientOps[Self <: Client] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJobstatuses(value: typingsSlinky.nodeZendesk.mod.JobStatuses.Methods): Self = this.set("jobstatuses", value.asInstanceOf[js.Any])
    @scala.inline
    def setLocales(value: js.Any): Self = this.set("locales", value.asInstanceOf[js.Any])
    @scala.inline
    def setMacros(value: typingsSlinky.nodeZendesk.mod.Macros.Methods): Self = this.set("macros", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRequests(value: typingsSlinky.nodeZendesk.mod.Requests.Methods): Self = this.set("requests", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTickets(value: typingsSlinky.nodeZendesk.mod.Tickets.Methods): Self = this.set("tickets", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setUserfields(value: typingsSlinky.nodeZendesk.mod.Users.Fields.Methods): Self = this.set("userfields", value.asInstanceOf[js.Any])
    @scala.inline
    def setUseridentities(value: typingsSlinky.nodeZendesk.mod.Users.Identities.Methods): Self = this.set("useridentities", value.asInstanceOf[js.Any])
    @scala.inline
    def setUsers(value: typingsSlinky.nodeZendesk.mod.Users.Methods): Self = this.set("users", value.asInstanceOf[js.Any])
    @scala.inline
