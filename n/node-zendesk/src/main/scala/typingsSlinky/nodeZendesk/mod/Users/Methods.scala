...
trait Methods extends js.Object {
  ...
  def createMany(users: CreateManyPayload): js.Promise[typingsSlinky.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
  ...
  def createOrUpdateMany(users: CreateManyPayload): js.Promise[typingsSlinky.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
  ...
  def updateMany(userIds: UpdateIdPayload, users: UpdateManyPayload): js.Promise[typingsSlinky.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
