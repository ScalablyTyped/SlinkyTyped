...
object DeliverableState {
  ...
  @scala.inline
  def deliverable: typingsSlinky.nodeDashZendesk.nodeDashZendeskStrings.deliverable = this.cast("deliverable")
  @scala.inline
  def undeliverable: typingsSlinky.nodeDashZendesk.nodeDashZendeskStrings.undeliverable = this.cast("undeliverable")
}
