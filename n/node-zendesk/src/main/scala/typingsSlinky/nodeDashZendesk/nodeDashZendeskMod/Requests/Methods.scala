...
trait Methods extends js.Object {
  ...
  /** Get Comment */
  def getComment(requestId: ZendeskID, commentId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.ResponsePayload
  /** Viewing Requests */
  ...
  /** Listing Comments */
  def listComments(requestId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.ListPayload
...
object Methods {
  ...
  def apply(
    ...
    getComment: (ZendeskID, ZendeskID, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.ResponsePayload,
    ...
    listComments: (ZendeskID, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.ListPayload,
