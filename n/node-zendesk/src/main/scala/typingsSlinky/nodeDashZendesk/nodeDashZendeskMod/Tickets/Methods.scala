...
trait Methods extends js.Object {
  ...
  def createMany(tickets: CreateManyPayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
  /** Deleting Tickets */
  ...
  /** Listing Comments */
  def getComments(requestId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Tickets.Comments.ListPayload
  ...
  def listCollaborators(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Users.ListPayload
  def listIncidents(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): ListPayload
  def listMetrics(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Tickets.Metrics.ResponsePayload
  ...
  /** Merging Tickets */
  def merge(ticketId: ZendeskID, mergingTickets: MergePayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
  /** Viewing Tickets */
  ...
  def updateMany(tickets: UpdateManyPayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
}
...
object Methods {
  ...
  def apply(
    ...
    getComments: (ZendeskID, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Tickets.Comments.ListPayload,
    ...
    listCollaborators: (ZendeskID, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Users.ListPayload,
    listIncidents: (ZendeskID, ZendeskCallback[_, _]) => ListPayload,
    listMetrics: (ZendeskID, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Tickets.Metrics.ResponsePayload,
    listRecent: ZendeskCallback[_, _] => ListPayload,
    listWithFilter: (String, js.Any, ZendeskCallback[_, _]) => ListPayload,
    merge: (ZendeskID, MergePayload, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload,
    ...
    updateMany: (UpdateManyPayload, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
  ): Methods = {
