...
import typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Attachments.Model
import typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.RequestType
import typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Tickets.Via
...
trait ResponseModel
  extends typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.ResponseModel
