...
trait ListPayload extends PaginablePayload {
  var comments: js.Array[typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.ResponseModel]
  var organizations: js.Array[
    typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Tickets.Comments.Organizations.ResponseModel
  ]
  var users: js.Array[
    typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CommentsUsers.ResponseModel
  ]
}
...
object ListPayload {
  @scala.inline
  def apply(
    comments: js.Array[typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.ResponseModel],
    count: Double,
