package typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Tickets.Comments.CommentsUsers
...
trait ResponseModel
  extends typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CommentsUsers.ResponseModel {
  val role: Role
}
