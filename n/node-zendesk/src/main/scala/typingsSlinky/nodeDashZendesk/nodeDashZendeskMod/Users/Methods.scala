...
trait Methods extends js.Object {
  ...
  def createMany(users: CreateManyPayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
  def createOrUpdate(user: CreatePayload, cb: ZendeskCallback[_, _]): ResponsePayload
  def createOrUpdateMany(users: CreateManyPayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
  /** Deleting Users */
  ...
  def updateMany(userIds: UpdateIdPayload, users: UpdateManyPayload, cb: ZendeskCallback[_, _]): typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
}
...
object Methods {
  ...
  def apply(
    ...
    createMany: (CreateManyPayload, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload,
    createOrUpdate: (CreatePayload, ZendeskCallback[_, _]) => ResponsePayload,
    createOrUpdateMany: (CreateManyPayload, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload,
    ...
    updateMany: (UpdateIdPayload, UpdateManyPayload, ZendeskCallback[_, _]) => typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.JobStatuses.ResponsePayload
  ): Methods = {
