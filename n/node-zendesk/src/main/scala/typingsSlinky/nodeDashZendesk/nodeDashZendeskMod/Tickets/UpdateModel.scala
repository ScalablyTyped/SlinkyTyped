...
trait UpdateModel extends js.Object {
  ...
  var comment: js.UndefOr[typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CreateModel] = js.undefined
...
object UpdateModel {
  ...
  def apply(
    ...
    comment: typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CreateModel = null,
