...
trait ListPayload extends PaginablePayload {
  val identities: js.Array[typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Users.Identities.ResponseModel]
}
...
object ListPayload {
  ...
  def apply(
    count: Double,
    identities: js.Array[typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Users.Identities.ResponseModel],
