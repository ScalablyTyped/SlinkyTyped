...
trait CreateModel extends js.Object {
  ...
  var comment: typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CreateModel
...
object CreateModel {
  @scala.inline
  def apply(
    comment: typingsSlinky.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CreateModel,
