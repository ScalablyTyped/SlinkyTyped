...
object RequestType {
  @scala.inline
  def Comment: typingsSlinky.nodeDashZendesk.nodeDashZendeskStrings.Comment = this.cast("Comment")
  @scala.inline
  def VoiceComment: typingsSlinky.nodeDashZendesk.nodeDashZendeskStrings.VoiceComment = this.cast("VoiceComment")
  @scala.inline
