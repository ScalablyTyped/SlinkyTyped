...
object GetMappingOpts {
  ...
  implicit class GetMappingOptsOps[Self <: GetMappingOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDescriptionRegExp(value: js.RegExp): Self = this.set("description", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDescription(value: js.RegExp | String): Self = this.set("description", value.asInstanceOf[js.Any])
