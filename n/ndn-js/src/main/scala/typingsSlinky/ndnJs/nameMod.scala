...
object nameMod {
  ...
  object ComponentType extends StObject {
    ...
    /* 8 */ val GENERIC: typingsSlinky.ndnJs.nameMod.ComponentType.GENERIC with Double = js.native
    
    @js.native
    sealed trait IMPLICIT_SHA256_DIGEST extends ComponentType
    /* 1 */ val IMPLICIT_SHA256_DIGEST: typingsSlinky.ndnJs.nameMod.ComponentType.IMPLICIT_SHA256_DIGEST with Double = js.native
    
    @js.native
    sealed trait OTHER_CODE extends ComponentType
    /* 0x7fff */ val OTHER_CODE: typingsSlinky.ndnJs.nameMod.ComponentType.OTHER_CODE with Double = js.native
    
    @js.native
    sealed trait PARAMETERS_SHA256_DIGEST extends ComponentType
    /* 2 */ val PARAMETERS_SHA256_DIGEST: typingsSlinky.ndnJs.nameMod.ComponentType.PARAMETERS_SHA256_DIGEST with Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.ndnJs.ndnJsNumbers.`-1`
    - typingsSlinky.ndnJs.ndnJsNumbers.`0`
    - typingsSlinky.ndnJs.ndnJsNumbers.`1`
  */
