...
/* Inlined @nivo/chord.@nivo/chord.CommonChordProps & {  pixelRatio :number | undefined} */
@js.native
...
object ChordCanvasProps {
  @scala.inline
  def apply(keys: js.Array[String], layers: js.Array[_], matrix: js.Array[js.Array[Double]]): ChordCanvasProps = {
  ...
  @scala.inline
  implicit class ChordCanvasPropsOps[Self <: ChordCanvasProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnArcClick(value: (/* arc */ ArcData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onArcClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnArcClick: Self = this.set("onArcClick", js.undefined)
    @scala.inline
    def setOnArcMouseEnter(value: (/* arc */ ArcData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onArcMouseEnter", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnArcMouseEnter: Self = this.set("onArcMouseEnter", js.undefined)
    @scala.inline
    def setOnArcMouseLeave(value: (/* arc */ ArcData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onArcMouseLeave", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnArcMouseLeave: Self = this.set("onArcMouseLeave", js.undefined)
    @scala.inline
    def setOnArcMouseMove(value: (/* arc */ ArcData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onArcMouseMove", js.Any.fromFunction2(value))
    @scala.inline
