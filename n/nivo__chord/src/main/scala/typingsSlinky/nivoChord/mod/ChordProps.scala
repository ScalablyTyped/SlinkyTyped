...
object ChordProps {
  ...
  implicit class ChordPropsOps[Self <: ChordProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnRibbonClick(value: (/* ribbon */ RibbonData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onRibbonClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnRibbonClick: Self = this.set("onRibbonClick", js.undefined)
    
    @scala.inline
    def setOnRibbonMouseEnter(value: (/* ribbon */ RibbonData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onRibbonMouseEnter", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnRibbonMouseEnter: Self = this.set("onRibbonMouseEnter", js.undefined)
    
    @scala.inline
    def setOnRibbonMouseLeave(value: (/* ribbon */ RibbonData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onRibbonMouseLeave", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnRibbonMouseLeave: Self = this.set("onRibbonMouseLeave", js.undefined)
    
    @scala.inline
    def setOnRibbonMouseMove(value: (/* ribbon */ RibbonData, /* event */ SyntheticMouseEvent[js.Any]) => Unit): Self = this.set("onRibbonMouseMove", js.Any.fromFunction2(value))
