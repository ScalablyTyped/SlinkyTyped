...
object ChordCanvas {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoChord.mod.ChordCanvas] {
    @scala.inline
  ...
  def withProps(p: ChordCanvasProps with Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    height: Double,
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ChordCanvasProps with Dimensions]))
  }
}
