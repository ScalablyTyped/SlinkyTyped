...
object ResponsiveChord {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.nivoChord.mod.ResponsiveChord] {
  ...
  def withProps(p: ChordProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  ...
  def apply(keys: js.Array[String], layers: js.Array[_], matrix: js.Array[js.Array[Double]]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ChordProps]))
  }
}
