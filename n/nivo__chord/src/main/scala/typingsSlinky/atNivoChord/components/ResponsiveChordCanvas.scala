...
import typingsSlinky.atNivoChord.atNivoChordMod.ChordCanvasProps
...
object ResponsiveChordCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.ResponsiveChordCanvas] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.ResponsiveChordCanvas] = {
