...
import typingsSlinky.atNivoChord.ChordPropsDimensions
...
object Chord
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.Chord] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.Chord] = {
  ...
  type Props = ChordPropsDimensions
}
