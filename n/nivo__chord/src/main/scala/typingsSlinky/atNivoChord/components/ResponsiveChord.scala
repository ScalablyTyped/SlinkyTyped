...
import typingsSlinky.atNivoChord.atNivoChordMod.ChordProps
import typingsSlinky.atNivoChord.atNivoChordMod.LabelAccessor
import typingsSlinky.atNivoChord.atNivoChordMod.RibbonData
...
object ResponsiveChord
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.ResponsiveChord] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.ResponsiveChord] = {
