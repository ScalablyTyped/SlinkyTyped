package typingsSlinky.atNivoChord.components
...
import typingsSlinky.atNivoChord.ChordCanvasPropsDimensions
import typingsSlinky.atNivoChord.atNivoChordMod.ArcData
import typingsSlinky.atNivoChord.atNivoChordMod.LabelAccessor
import typingsSlinky.atNivoChord.atNivoChordMod.ValueFormatter
...
object ChordCanvas
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.ChordCanvas] {
  @JSImport("@nivo/chord", "ChordCanvas")
  @js.native
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atNivoChord.atNivoChordMod.ChordCanvas] = {
  ...
  type Props = ChordCanvasPropsDimensions
}
