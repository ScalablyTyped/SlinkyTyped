package typingsSlinky.nodeRedRegistry.anon

import typingsSlinky.nodeRedRegistry.mod.NodeCredentials
import typingsSlinky.nodeRedRegistry.mod.NodeSettings
