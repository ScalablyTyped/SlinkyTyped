...
import typingsSlinky.neverbounce.anon.Academichost
import typingsSlinky.neverbounce.anon.Complete
import typingsSlinky.neverbounce.anon.ContentType
import typingsSlinky.neverbounce.anon.Remote
...
object mod {
  ...
  trait Account extends StObject {
    ...
    def info(): js.Promise[org.scalajs.dom.experimental.Response] = js.native
  }
  object Account {
    
    @scala.inline
    def apply(info: () => js.Promise[org.scalajs.dom.experimental.Response]): Account = {
    ...
    implicit class AccountMutableBuilder[Self <: Account] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInfo(value: () => js.Promise[org.scalajs.dom.experimental.Response]): Self = StObject.set(x, "info", js.Any.fromFunction0(value))
    }
  }
  ...
  trait Jobs extends StObject {
    ...
    def create(input: js.Any, inputLocation: js.Any, fileName: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def create(
      input: js.Any,
      ...
      autoStart: js.Any
    ): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def create(
      input: js.Any,
      inputLocation: js.Any,
      fileName: js.Any,
    ...
    def create(input: js.Any, inputLocation: js.Any, fileName: js.Any, runSample: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def create(
      input: js.Any,
      inputLocation: js.Any,
      fileName: js.Any,
    ...
    def create(input: js.Any, inputLocation: js.Any, fileName: js.Any, runSample: js.Any, autoParse: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def create(
      input: js.Any,
      inputLocation: js.Any,
      fileName: js.Any,
    ...
    def download(jobId: Double): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    
    def parse(jobId: Double): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def parse(jobId: Double, autoStart: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    
    def results(jobId: Double, query: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    
    def search(query: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    
    def start(jobId: Double): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def start(jobId: Double, runSample: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    
    def status(jobId: Double): js.Promise[org.scalajs.dom.experimental.Response] = js.native
  }
  ...
  object NeverBounce {
    ...
    implicit class NeverBounceMutableBuilder[Self <: NeverBounce] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrors(value: js.Error): Self = StObject.set(x, "errors", value.asInstanceOf[js.Any])
  ...
  trait Poe extends StObject {
    ...
    def confirm(email: String, result: String, confirmationToken: String, transactionId: String): js.Promise[org.scalajs.dom.experimental.Response] = js.native
  }
  object Poe {
    
    @scala.inline
    def apply(confirm: (String, String, String, String) => js.Promise[org.scalajs.dom.experimental.Response]): Poe = {
    ...
    implicit class PoeMutableBuilder[Self <: Poe] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConfirm(value: (String, String, String, String) => js.Promise[org.scalajs.dom.experimental.Response]): Self = StObject.set(x, "confirm", js.Any.fromFunction4(value))
    }
  }
  ...
  trait Single extends StObject {
    ...
    def check(email: String): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def check(
      email: String,
    ...
    def check(email: String, addressInfo: js.UndefOr[scala.Nothing], creditsInfo: Boolean): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def check(email: String, addressInfo: js.UndefOr[scala.Nothing], creditsInfo: Boolean, timeout: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def check(email: String, addressInfo: Boolean): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def check(email: String, addressInfo: Boolean, creditsInfo: js.UndefOr[scala.Nothing], timeout: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def check(email: String, addressInfo: Boolean, creditsInfo: Boolean): js.Promise[org.scalajs.dom.experimental.Response] = js.native
    def check(email: String, addressInfo: Boolean, creditsInfo: Boolean, timeout: js.Any): js.Promise[org.scalajs.dom.experimental.Response] = js.native
  }
}
