...
object mod {
  ...
  object Transaction {
    ...
    implicit class TransactionMutableBuilder[Self <: Transaction] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExpiresIn(value: js.Date | Double): Self = StObject.set(x, "expiresIn", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExpiresInDate(value: js.Date): Self = StObject.set(x, "expiresIn", value.asInstanceOf[js.Any])
