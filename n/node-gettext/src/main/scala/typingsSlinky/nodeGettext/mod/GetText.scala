...
object GetText {
  ...
  implicit class GetTextOps[Self <: GetText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOff(value: (error, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("off", js.Any.fromFunction2(value))
    @scala.inline
    def setOn(value: (error, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("on", js.Any.fromFunction2(value))
    @scala.inline
