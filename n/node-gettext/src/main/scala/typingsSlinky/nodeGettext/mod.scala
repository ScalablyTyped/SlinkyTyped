...
object mod {
  ...
  object GetText {
    ...
    implicit class GetTextMutableBuilder[Self <: GetText] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOff(value: (error, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = StObject.set(x, "off", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOn(value: (error, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = StObject.set(x, "on", js.Any.fromFunction2(value))
