...
import typingsSlinky.jsonata.mod.Expression
import typingsSlinky.node.Buffer
import typingsSlinky.nodeRedRegistry.mod.Node
import typingsSlinky.nodeRedRegistry.mod.NodeMessage
import typingsSlinky.nodeRedUtil.anon.Format
import typingsSlinky.nodeRedUtil.anon.Key
import typingsSlinky.nodeRedUtil.anon.MaxLength
import typingsSlinky.nodeRedUtil.anon.Msg
...
trait Util extends js.Object {
  ...
  def evaluateJSONataExpression(
    expr: Expression,
    msg: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* resp */ js.Any, Unit]
  ): Unit = js.native
  ...
  def evaluateNodeProperty(
    ...
    node: Node[js.Object],
    msg: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* result */ js.Any, Unit]
  ): Unit = js.native
