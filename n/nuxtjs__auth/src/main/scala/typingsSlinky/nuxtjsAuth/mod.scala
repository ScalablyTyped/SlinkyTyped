package typingsSlinky.nuxtjsAuth
...
object mod {
  ...
  object vueTypesVueAugmentingMod {
    ...
    object Vue {
      ...
      @scala.inline
      def apply($auth: Auth[_]): typingsSlinky.nuxtjsAuth.mod.vueTypesVueAugmentingMod.Vue = {
        val __obj = js.Dynamic.literal($auth = $auth.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.nuxtjsAuth.mod.vueTypesVueAugmentingMod.Vue]
      }
      
      @scala.inline
      implicit class VueMutableBuilder[Self <: typingsSlinky.nuxtjsAuth.mod.vueTypesVueAugmentingMod.Vue] (val x: Self) extends AnyVal {
