...
object ConnectionType extends StObject {
  ...
  /* 0x03 */ val CONNTYPE_BASIC: typingsSlinky.nodeSnap7.mod.ConnectionType.CONNTYPE_BASIC with Double = js.native
  
  @js.native
  sealed trait CONNTYPE_OP extends ConnectionType
  /* 0x02 */ val CONNTYPE_OP: typingsSlinky.nodeSnap7.mod.ConnectionType.CONNTYPE_OP with Double = js.native
  
  @js.native
  sealed trait CONNTYPE_PG extends ConnectionType
  /* 0x01 */ val CONNTYPE_PG: typingsSlinky.nodeSnap7.mod.ConnectionType.CONNTYPE_PG with Double = js.native
}
