...
trait RouteOptionsCors extends js.Object {
  ...
  /**
    ...
    * origin ['*'].
    */
  var origin: js.UndefOr[js.Array[String] | typingsSlinky.hapi.hapiStrings.`*` | ignore] = js.undefined
}
...
object RouteOptionsCors {
  ...
  def apply(
    ...
    origin: js.Array[String] | typingsSlinky.hapi.hapiStrings.`*` | ignore = null
  ): RouteOptionsCors = {
