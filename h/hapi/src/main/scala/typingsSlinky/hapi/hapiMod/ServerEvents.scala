...
import typingsSlinky.hapi.hapiStrings.log
import typingsSlinky.hapi.hapiStrings.request
import typingsSlinky.hapi.hapiStrings.response
import typingsSlinky.hapi.hapiStrings.route
