...
import typingsSlinky.hapi.Anon_Collect
...
trait RouteOptions extends js.Object {
  ...
  {[ key in hapi.hapi.RouteRequestExtType ]:? hapi.hapi.RouteExtObject | std.Array<hapi.hapi.RouteExtObject>}
    */ typingsSlinky.hapi.hapiStrings.RouteOptions with js.Any
  ] = js.undefined
  /**
...
object RouteOptions {
  ...
  {[ key in hapi.hapi.RouteRequestExtType ]:? hapi.hapi.RouteExtObject | std.Array<hapi.hapi.RouteExtObject>}
    */ typingsSlinky.hapi.hapiStrings.RouteOptions with js.Any = null,
