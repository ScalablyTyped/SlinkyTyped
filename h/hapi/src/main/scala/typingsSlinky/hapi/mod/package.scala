...
package object mod {
  type CachePolicyOptions[T] = typingsSlinky.catbox.mod.PolicyOptionVariants[T] with typingsSlinky.hapi.AnonCache
  type CacheProvider[T /* <: typingsSlinky.catbox.mod.ClientOptions */] = typingsSlinky.catbox.mod.EnginePrototype[js.Any] | typingsSlinky.hapi.AnonConstructor[T]
  ...
  */
  ...
  type RouteOptionsCache = typingsSlinky.hapi.AnonOtherwise with (typingsSlinky.hapi.AnonExpiresAt | typingsSlinky.hapi.AnonExpiresIn | typingsSlinky.hapi.AnonExpiresAtExpiresIn)
