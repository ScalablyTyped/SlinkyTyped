...
object Constructor {
  @scala.inline
  def apply[/* <: typingsSlinky.catbox.mod.ClientOptions */ T](constructor: EnginePrototype[_]): Constructor[T] = {
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any])
    __obj.asInstanceOf[Constructor[T]]
  }
  @scala.inline
  implicit class ConstructorOps[Self <: Constructor[_], /* <: typingsSlinky.catbox.mod.ClientOptions */ T] (val x: Self with Constructor[T]) extends AnyVal {
    @scala.inline
