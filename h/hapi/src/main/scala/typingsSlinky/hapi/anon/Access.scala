...
trait Access extends StObject {
  ...
  /**
    ...
    */
  def access(request: typingsSlinky.hapi.mod.Request): Boolean = js.native
}
object Access {
  
  @scala.inline
  def apply(access: typingsSlinky.hapi.mod.Request => Boolean): Access = {
  ...
  implicit class AccessMutableBuilder[Self <: Access] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccess(value: typingsSlinky.hapi.mod.Request => Boolean): Self = StObject.set(x, "access", js.Any.fromFunction1(value))
  }
}
