...
object mocked extends js.Object {
  ...
  type MockedFunction[T /* <: MockableFunction */] = MockWithArgs[T] with typingsSlinky.heftJest.heftJestStrings.MockedFunction with TopLevel[T]
  
  type MockedFunctionDeep[T /* <: MockableFunction */] = MockWithArgs[T] with MockedObjectDeep[T]
  
  type MockedObject[T] = MaybeMockedConstructor[T] with typingsSlinky.heftJest.heftJestStrings.MockedObject with TopLevel[js.Any] with TopLevel[T]
  
  type MockedObjectDeep[T] = MaybeMockedConstructor[T] with typingsSlinky.heftJest.heftJestStrings.MockedObjectDeep with TopLevel[js.Any] with TopLevel[T]
