package typingsSlinky.hapiYar.anon

import typingsSlinky.hapiHapi.mod.Request
import typingsSlinky.hapiYar.hapiYarBooleans.`false`
import typingsSlinky.hapiYar.hapiYarStrings.Lax
import typingsSlinky.hapiYar.hapiYarStrings.Strict
