...
object HeatmapOverlayConfiguration {
  ...
  @scala.inline
  implicit class HeatmapOverlayConfigurationOps[Self <: HeatmapOverlayConfiguration[_, _, _], V /* <: String */, TLat /* <: String */, TLong /* <: String */] (val x: Self with (HeatmapOverlayConfiguration[V, TLat, TLong])) extends AnyVal {
