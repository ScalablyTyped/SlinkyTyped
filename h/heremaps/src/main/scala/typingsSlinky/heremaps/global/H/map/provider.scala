...
import typingsSlinky.heremaps.H.map.provider.ImageTileProvider.Options
...
object provider extends js.Object {
  ...
  class ImageTileProvider protected ()
    extends typingsSlinky.heremaps.H.map.provider.ImageTileProvider {
    /**
      * Constructor
  ...
  @js.native
  class Invalidations ()
    extends typingsSlinky.heremaps.H.map.provider.Invalidations {
    /**
  ...
  class MarkerTileProvider protected ()
    extends typingsSlinky.heremaps.H.map.provider.MarkerTileProvider {
    /**
      * Constructor
      * @param options {H.map.provider.MarkerTileProvider.Options} - configuration for tile provider
      */
    def this(options: typingsSlinky.heremaps.H.map.provider.MarkerTileProvider.Options) = this()
  }
  ...
  class ObjectProvider ()
    extends typingsSlinky.heremaps.H.map.provider.ObjectProvider {
    def this(opt_options: typingsSlinky.heremaps.H.map.provider.Provider.Options) = this()
  }
  ...
  /**
    ...
    */
  class Provider ()
    extends typingsSlinky.heremaps.H.map.provider.Provider {
    def this(opt_options: typingsSlinky.heremaps.H.map.provider.Provider.Options) = this()
  }
  ...
  class RemoteTileProvider protected ()
    extends typingsSlinky.heremaps.H.map.provider.RemoteTileProvider {
    /**
      * Constructor
      * @param options {H.map.provider.TileProvider.Options} - The options to instantiate this TileProvider
      */
    def this(options: typingsSlinky.heremaps.H.map.provider.TileProvider.Options) = this()
  }
  ...
  class Tile protected ()
    extends typingsSlinky.heremaps.H.map.provider.Tile {
    /**
      * Constructor
  ...
  class TileProvider protected ()
    extends typingsSlinky.heremaps.H.map.provider.TileProvider {
    /**
      * Constructor
      * @param options {H.map.provider.TileProvider.Options} - The options to instantiate this TileProvider
      */
  ...
  object Invalidations extends js.Object {
    ...
    object Flag extends js.Object {
      /* 3 */ val ADD: typingsSlinky.heremaps.H.map.provider.Invalidations.Flag.ADD with Double = js.native
      /* 0 */ val NONE: typingsSlinky.heremaps.H.map.provider.Invalidations.Flag.NONE with Double = js.native
      /* 4 */ val REMOVE: typingsSlinky.heremaps.H.map.provider.Invalidations.Flag.REMOVE with Double = js.native
      /* 2 */ val SPATIAL: typingsSlinky.heremaps.H.map.provider.Invalidations.Flag.SPATIAL with Double = js.native
      /* 1 */ val VISUAL: typingsSlinky.heremaps.H.map.provider.Invalidations.Flag.VISUAL with Double = js.native
      /* 5 */ val Z_ORDER: typingsSlinky.heremaps.H.map.provider.Invalidations.Flag.Z_ORDER with Double = js.native
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsSlinky.heremaps.H.map.provider.Invalidations.Flag with Double] = js.native
    }
