...
import typingsSlinky.heremaps.H.map.ArrowStyle.Options
...
/**
  ...
  */
class ArrowStyle ()
  extends typingsSlinky.heremaps.H.map.ArrowStyle {
  def this(opt_options: typingsSlinky.heremaps.H.map.ArrowStyle) = this()
