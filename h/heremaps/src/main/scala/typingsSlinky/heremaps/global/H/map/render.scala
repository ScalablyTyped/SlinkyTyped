...
object render extends js.Object {
  ...
  class RenderEngine protected ()
    extends typingsSlinky.heremaps.H.map.render.RenderEngine {
    /**
      * Constructor
      ...
      */
    def this(
      viewPort: typingsSlinky.heremaps.H.map.ViewPort,
      viewModel: typingsSlinky.heremaps.H.map.ViewModel,
      dataModel: typingsSlinky.heremaps.H.map.DataModel,
      options: Options
    ) = this()
  }
  @js.native
  object RenderEngine extends js.Object {
    ...
    object InteractionModifiers extends js.Object {
      ...
      def apply(value: Double): js.UndefOr[
            typingsSlinky.heremaps.H.map.render.RenderEngine.InteractionModifiers with Double
          ] = js.native
  ...
  object RenderState extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.heremaps.H.map.render.RenderState with Double] = js.native
    
    /* 1 */ val ACTIVE: typingsSlinky.heremaps.H.map.render.RenderState.ACTIVE with Double = js.native
    
    /* 2 */ val DONE: typingsSlinky.heremaps.H.map.render.RenderState.DONE with Double = js.native
    
    /* 0 */ val PENDING: typingsSlinky.heremaps.H.map.render.RenderState.PENDING with Double = js.native
  }
  ...
  object p2d extends js.Object {
    ...
    @js.native
    class RenderEngine protected ()
      extends typingsSlinky.heremaps.H.map.render.p2d.RenderEngine {
      /**
        * Constructor
        * @param viewPort {H.map.ViewPort} - An object representing the map viewport
        * @param viewModel {H.map.ViewModel} - An object representing a view of the map
