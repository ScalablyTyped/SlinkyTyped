...
object mapevents {
  ...
  class Behavior protected ()
    extends typingsSlinky.heremaps.H.mapevents.Behavior {
    /**
      * Constructor
      ...
      */
    def this(mapEvents: typingsSlinky.heremaps.H.mapevents.MapEvents) = this()
    def this(mapEvents: typingsSlinky.heremaps.H.mapevents.MapEvents, options: Options) = this()
  }
  object Behavior {
  ...
  class ContextMenuEvent protected ()
    extends typingsSlinky.heremaps.H.mapevents.ContextMenuEvent {
    /**
      * Constructor
    ...
    def this(
      viewportX: Double,
      viewportY: Double,
      target: typingsSlinky.heremaps.H.Map_,
  ...
  class Event protected ()
    extends typingsSlinky.heremaps.H.mapevents.Event {
    /**
      * Constructor
    ...
    def this(
      `type`: String,
      pointers: js.Array[typingsSlinky.heremaps.H.mapevents.Pointer],
      changedPointers: js.Array[typingsSlinky.heremaps.H.mapevents.Pointer],
      targetPointers: js.Array[typingsSlinky.heremaps.H.mapevents.Pointer],
      currentPointer: typingsSlinky.heremaps.H.mapevents.Pointer,
      target: typingsSlinky.heremaps.H.Map_,
      originalEvent: typingsSlinky.heremaps.H.mapevents.Event
    ) = this()
    def this(
  ...
  class MapEvents protected ()
    extends typingsSlinky.heremaps.H.mapevents.MapEvents {
    /**
      * Constructor
  ...
  class Pointer protected ()
    extends typingsSlinky.heremaps.H.mapevents.Pointer {
    /**
      * Constructor
  ...
  object Pointer {
    ...
    object Button extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsSlinky.heremaps.H.mapevents.Pointer.Button with Double] = js.native
  ...
  class WheelEvent protected ()
    extends typingsSlinky.heremaps.H.mapevents.WheelEvent {
    /**
      * Constructor
