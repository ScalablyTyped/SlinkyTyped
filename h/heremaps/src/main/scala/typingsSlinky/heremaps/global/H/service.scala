...
object service {
  ...
  class EnterpriseRoutingService ()
    extends typingsSlinky.heremaps.H.service.EnterpriseRoutingService {
    def this(opt_options: typingsSlinky.heremaps.H.service.EnterpriseRoutingService.Options) = this()
  }
  ...
  class GeocodingService ()
    extends typingsSlinky.heremaps.H.service.GeocodingService {
    def this(opt_options: typingsSlinky.heremaps.H.service.GeocodingService.Options) = this()
  }
  ...
  class MapTileService ()
    ...
    def this(opt_options: typingsSlinky.heremaps.H.service.MapTileService.Options) = this()
  }
  ...
  class PlacesService ()
    ...
    def this(opt_options: typingsSlinky.heremaps.H.service.PlacesService.Options) = this()
  }
  ...
  class Platform protected ()
    extends typingsSlinky.heremaps.H.service.Platform {
    /**
      * Constructor
      * @param options {H.service.Platform.Options}
      */
    def this(options: typingsSlinky.heremaps.H.service.Platform.Options) = this()
  }
  ...
  class RoutingService ()
    extends typingsSlinky.heremaps.H.service.RoutingService {
    def this(opt_options: typingsSlinky.heremaps.H.service.RoutingService.Options) = this()
  }
  ...
  @js.native
  class Url protected ()
    extends typingsSlinky.heremaps.H.service.Url {
    /**
      * Constructor
  ...
  object Url {
    ...
    @js.native
    def parse(url: String): typingsSlinky.heremaps.H.service.Url = js.native
    @JSGlobal("H.service.Url.parse")
    @js.native
    def parse(url: String, opt_baseURL: String): typingsSlinky.heremaps.H.service.Url = js.native
  }
  ...
  object metaInfo {
    ...
    class Service ()
      ...
      def this(opt_options: typingsSlinky.heremaps.H.service.metaInfo.Service.Options) = this()
    }
  ...
  object traffic {
    ...
    /**
      ...
      */
    class Service ()
      extends typingsSlinky.heremaps.H.service.traffic.Service {
      def this(opt_options: typingsSlinky.heremaps.H.service.traffic.Service.Options) = this()
    }
  }
  ...
  object venues {
    ...
    class Building protected ()
      extends typingsSlinky.heremaps.H.service.venues.Building {
      /**
        * Constructor
    ...
    class Floor protected ()
      extends typingsSlinky.heremaps.H.service.venues.Floor {
      /**
        * Constructor
    ...
    /**
      ...
      */
    class Service ()
      extends typingsSlinky.heremaps.H.service.venues.Service {
      def this(opt_options: typingsSlinky.heremaps.H.service.venues.Service.Options) = this()
    }
    object Service {
      ...
      object State extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsSlinky.heremaps.H.service.venues.Service.State with Double] = js.native
    ...
    class Space protected ()
      extends typingsSlinky.heremaps.H.service.venues.Space {
      /**
        * Constructor
    ...
    class TileProvider protected ()
      extends typingsSlinky.heremaps.H.service.venues.TileProvider {
      /**
        * Constructor
        * @param service {H.service.venues.Service}
        * @param opt_options {H.service.venues.TileProvider.Options=}
        */
      def this(service: typingsSlinky.heremaps.H.service.venues.Service) = this()
      def this(
        service: typingsSlinky.heremaps.H.service.venues.Service,
        opt_options: typingsSlinky.heremaps.H.service.venues.TileProvider.Options
      ) = this()
    }
    ...
    class Venue protected ()
      extends typingsSlinky.heremaps.H.service.venues.Venue {
      /**
        * Constructor
