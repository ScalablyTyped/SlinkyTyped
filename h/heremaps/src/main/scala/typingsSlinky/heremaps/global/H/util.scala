...
object util {
  ...
  class Cache protected ()
    extends typingsSlinky.heremaps.H.util.Cache {
    /**
      * Constructor
  ...
  class ChangeEvent protected ()
    extends typingsSlinky.heremaps.H.util.ChangeEvent {
    /**
      * Constructor
  ...
  /**
    ...
    */
  class ContextItem ()
    extends typingsSlinky.heremaps.H.util.ContextItem {
  ...
  object ContextItem {
    ...
    @js.native
    def SEPARATOR: typingsSlinky.heremaps.H.util.ContextItem = js.native
    @scala.inline
    def SEPARATOR_=(x: typingsSlinky.heremaps.H.util.ContextItem): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SEPARATOR")(x.asInstanceOf[js.Any])
  }
  ...
  /**
    ...
    */
  class Disposable ()
    extends typingsSlinky.heremaps.H.util.Disposable
  ...
  /**
    ...
    */
  class EventTarget ()
    extends typingsSlinky.heremaps.H.util.EventTarget
  ...
  @js.native
  class OList ()
    extends typingsSlinky.heremaps.H.util.OList
  object OList {
    ...
    @js.native
    class Event protected ()
      extends typingsSlinky.heremaps.H.util.OList.Event {
      /**
        * Constructor
        ...
        */
      def this(
        list: typingsSlinky.heremaps.H.util.OList,
        `type`: String,
        idx: Double,
        added: js.Any,
        removed: js.Any,
  ...
  /**
    ...
    */
  class Request ()
    extends typingsSlinky.heremaps.H.util.Request {
    def this(opt_onprogress: js.Function1[/* req */ typingsSlinky.heremaps.H.util.Request, Unit]) = this()
    def this(opt_onprogress: js.UndefOr[scala.Nothing], opt_total: Double) = this()
    def this(
      opt_onprogress: js.Function1[/* req */ typingsSlinky.heremaps.H.util.Request, Unit],
      opt_total: Double
    ) = this()
  }
  object Request {
    ...
    object State extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsSlinky.heremaps.H.util.Request.State with Double] = js.native
  ...
  object animation {
    ...
    @js.native
    class ease ()
      extends typingsSlinky.heremaps.H.util.animation.ease
    object ease {
