package typingsSlinky.heremaps.H.service.venues.TileProvider

import typingsSlinky.heremaps.H.service.venues.Space
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnSpaceCreated(value: /* space */ Space => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onSpaceCreated")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutOnSpaceCreated: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onSpaceCreated")(js.undefined)
        ret
    }
    @scala.inline
