...
class Spatial_ protected () extends Object {
  ...
  def setArrows(opt_arrows: typingsSlinky.heremaps.H.map.ArrowStyle.Options): Spatial = js.native
  /**
  ...
  def setStyle(opt_style: typingsSlinky.heremaps.H.map.SpatialStyle.Options): Spatial = js.native
}
