...
import typingsSlinky.heremaps.H.service.EnterpriseRoutingService.Options
import typingsSlinky.heremaps.H.service.Platform.DefaultLayersOptions
import typingsSlinky.heremaps.H.service.metaInfo.Service
...
trait Platform extends StObject {
  ...
  def getGeocodingService(opt_options: typingsSlinky.heremaps.H.service.GeocodingService.Options): GeocodingService = js.native
  ...
  def getMapTileService(opt_options: typingsSlinky.heremaps.H.service.MapTileService.Options): MapTileService = js.native
  ...
  def getMetaInfoService(opt_params: typingsSlinky.heremaps.H.service.metaInfo.Service.Options): Service = js.native
  ...
  def getRoutingService(opt_options: typingsSlinky.heremaps.H.service.RoutingService.Options): RoutingService = js.native
  ...
  /**
    ...
    */
  def getTrafficService(): typingsSlinky.heremaps.H.service.traffic.Service = js.native
  def getTrafficService(opt_options: typingsSlinky.heremaps.H.service.traffic.Service.Options): typingsSlinky.heremaps.H.service.traffic.Service = js.native
  ...
  /**
    ...
    */
  def getVenueService(): typingsSlinky.heremaps.H.service.venues.Service = js.native
  def getVenueService(opt_params: typingsSlinky.heremaps.H.service.venues.Service.Options): typingsSlinky.heremaps.H.service.venues.Service = js.native
...
object Platform {
  ...
  object Options {
    ...
    @scala.inline
    def apply(apikey: String): typingsSlinky.heremaps.H.service.Platform.Options = {
      val __obj = js.Dynamic.literal(apikey = apikey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.heremaps.H.service.Platform.Options]
    }
    
    @scala.inline
    implicit class OptionsMutableBuilder[Self <: typingsSlinky.heremaps.H.service.Platform.Options] (val x: Self) extends AnyVal {
