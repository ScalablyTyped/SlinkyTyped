...
import typingsSlinky.heremaps.H.service.Platform.Options
...
class Platform_ protected () extends js.Object {
  ...
  def getEnterpriseRoutingService(opt_options: typingsSlinky.heremaps.H.service.EnterpriseRoutingService.Options): EnterpriseRoutingService = js.native
  /**
