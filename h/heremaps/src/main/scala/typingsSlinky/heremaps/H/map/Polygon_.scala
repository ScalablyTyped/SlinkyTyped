...
class Polygon_ protected () extends GeoShape {
  ...
  def this(geometry: typingsSlinky.heremaps.H.geo.Polygon) = this()
  def this(geometry: LineString, opt_options: Options) = this()
  def this(geometry: MultiPolygon, opt_options: Options) = this()
  def this(geometry: typingsSlinky.heremaps.H.geo.Polygon, opt_options: Options) = this()
  /**
    ...
    */
  def getGeometry(): typingsSlinky.heremaps.H.geo.Polygon | MultiPolygon = js.native
  /**
  ...
  /**
    ...
    * @param geometry
    */
  def setGeometry(geometry: typingsSlinky.heremaps.H.geo.Polygon): Polygon = js.native
  /**
