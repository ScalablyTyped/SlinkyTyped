...
import typingsSlinky.heremaps.H.map.Object.Type
...
object provider {
  ...
  object ImageTileProvider {
    ...
    object Options {
      ...
      implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setGetCopyrights(value: (/* rect */ typingsSlinky.heremaps.H.geo.Rect, /* n */ Double) => js.Array[ICopyright]): Self = StObject.set(x, "getCopyrights", js.Any.fromFunction2(value))
  ...
  trait ObjectProvider extends Provider {
    ...
    def requestDomMarkers(
      geoRect: typingsSlinky.heremaps.H.geo.Rect,
      zoomLevel: Double,
  ...
  object TileProvider {
    ...
    object Options {
      ...
      implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setGetCopyrights(value: (/* rect */ typingsSlinky.heremaps.H.geo.Rect, /* number */ Double) => js.Array[ICopyright]): Self = StObject.set(x, "getCopyrights", js.Any.fromFunction2(value))
