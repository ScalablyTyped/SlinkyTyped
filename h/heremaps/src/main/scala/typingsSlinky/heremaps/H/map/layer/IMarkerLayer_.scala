...
object IMarkerLayer_ {
  ...
  implicit class IMarkerLayer_Ops[Self <: IMarkerLayer_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequestDomMarkers(value: (Rect, Double, Boolean, Point) => Response | TiledResponse): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requestDomMarkers")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withRequestMarkers(value: (Rect, Double, Boolean, Point) => Response | TiledResponse): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requestMarkers")(js.Any.fromFunction4(value))
        ret
    }
  }
