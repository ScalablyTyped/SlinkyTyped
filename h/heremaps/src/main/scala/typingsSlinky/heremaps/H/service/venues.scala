...
object venues {
  ...
  object Service {
    ...
    object Options {
      ...
      @scala.inline
      def apply(): typingsSlinky.heremaps.H.service.venues.Service.Options = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.heremaps.H.service.venues.Service.Options]
      }
      
      @scala.inline
      implicit class OptionsMutableBuilder[Self <: typingsSlinky.heremaps.H.service.venues.Service.Options] (val x: Self) extends AnyVal {
  ...
  trait Space extends StObject {
    ...
    def initLabelStyle(labelStyle: typingsSlinky.heremaps.H.map.SpatialStyle.Options): Unit = js.native
