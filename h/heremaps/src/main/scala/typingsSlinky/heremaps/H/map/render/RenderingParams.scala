...
import typingsSlinky.heremaps.H.geo.PixelProjection
import typingsSlinky.heremaps.H.geo.Rect
import typingsSlinky.heremaps.H.math.Point
import typingsSlinky.heremaps.H.math.Size
...
object RenderingParams {
  ...
  implicit class RenderingParamsOps[Self <: RenderingParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCacheOnly(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cacheOnly")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPriorityCenter(value: Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("priorityCenter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withProjection(value: PixelProjection): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("projection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withScreenCenter(value: Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("screenCenter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
