...
object render {
  ...
  trait RenderingParams extends StObject {
    ...
    /**
      ...
      * @type {H.geo.Rect}
      */
    var bounds: typingsSlinky.heremaps.H.geo.Rect = js.native
  ...
  object RenderingParams {
    ...
    implicit class RenderingParamsMutableBuilder[Self <: RenderingParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBounds(value: typingsSlinky.heremaps.H.geo.Rect): Self = StObject.set(x, "bounds", value.asInstanceOf[js.Any])
