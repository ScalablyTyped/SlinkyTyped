...
object Options {
  @scala.inline
  def apply(
    onAttach: (/* el */ Element, /* icon */ typingsSlinky.heremaps.H.map.DomIcon, /* marker */ DomMarker) => Unit = null,
    onDetach: (/* el */ Element, /* icon */ typingsSlinky.heremaps.H.map.DomIcon, /* marker */ DomMarker) => Unit = null
  ): Options = {
