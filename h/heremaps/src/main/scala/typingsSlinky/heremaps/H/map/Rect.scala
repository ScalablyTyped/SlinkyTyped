...
class Rect protected () extends Polygon {
  /**
    ...
    */
  def this(bounds: typingsSlinky.heremaps.H.geo.Rect) = this()
  def this(bounds: typingsSlinky.heremaps.H.geo.Rect, opt_options: Options) = this()
  /**
    * To set the bounds of this rectangle.
    * @param bounds {H.geo.Rect}
    */
  def setBounds(bounds: typingsSlinky.heremaps.H.geo.Rect): Unit = js.native
}
