...
import typingsSlinky.heremaps.H.geo.MultiLineString
import typingsSlinky.heremaps.H.geo.Strip
import typingsSlinky.heremaps.H.map.Polyline.Options
...
class Polyline_ protected () extends GeoShape {
  ...
  /**
    ...
    */
  def clip(geoRect: typingsSlinky.heremaps.H.geo.Rect): js.Array[js.Array[Double]] = js.native
  /**
