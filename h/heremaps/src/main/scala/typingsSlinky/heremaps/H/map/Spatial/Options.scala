...
import typingsSlinky.heremaps.H.map.ArrowStyle
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrows(value: ArrowStyle | typingsSlinky.heremaps.H.map.ArrowStyle.Options): Self = this.set("arrows", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStyle(value: SpatialStyle | typingsSlinky.heremaps.H.map.SpatialStyle.Options): Self = this.set("style", value.asInstanceOf[js.Any])
    @scala.inline
