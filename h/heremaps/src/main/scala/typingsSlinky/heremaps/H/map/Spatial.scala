...
object Spatial {
  ...
  object Options {
    ...
    @scala.inline
    def apply(): typingsSlinky.heremaps.H.map.Spatial.Options = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.heremaps.H.map.Spatial.Options]
    }
    
    @scala.inline
    implicit class OptionsMutableBuilder[Self <: typingsSlinky.heremaps.H.map.Spatial.Options] (val x: Self) extends AnyVal {
