...
trait Access extends StObject {
  ...
  /**
    ...
    */
  def access(request: typingsSlinky.hapiHapi.mod.Request): Boolean = js.native
}
object Access {
  
  @scala.inline
  def apply(access: typingsSlinky.hapiHapi.mod.Request => Boolean): Access = {
  ...
  implicit class AccessMutableBuilder[Self <: Access] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccess(value: typingsSlinky.hapiHapi.mod.Request => Boolean): Self = StObject.set(x, "access", js.Any.fromFunction1(value))
  }
}
