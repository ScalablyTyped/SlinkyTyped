...
@js.native
trait AnonVhost extends js.Object {
  /**
...
object AnonVhost {
  @scala.inline
  def apply(prefix: String): AnonVhost = {
    val __obj = js.Dynamic.literal(prefix = prefix.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonVhost]
  }
  @scala.inline
  implicit class AnonVhostOps[Self <: AnonVhost] (val x: Self) extends AnyVal {
    @scala.inline
