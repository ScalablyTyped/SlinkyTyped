...
object ServerRoute {
  ...
  implicit class ServerRouteMutableBuilder[Self <: ServerRoute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions(value: RouteOptions | (js.Function1[/* server */ Server_, RouteOptions])): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOptionsFunction1(value: /* server */ Server_ => RouteOptions): Self = StObject.set(x, "options", js.Any.fromFunction1(value))
