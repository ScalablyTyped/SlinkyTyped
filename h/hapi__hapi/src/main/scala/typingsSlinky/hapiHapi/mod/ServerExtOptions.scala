...
trait ServerExtOptions extends js.Object {
  ...
  /**
    ...
    */
  var sandbox: js.UndefOr[typingsSlinky.hapiHapi.hapiHapiStrings.server | plugin] = js.undefined
}
...
object ServerExtOptions {
  ...
  def apply(
    ...
    bind: js.Object = null,
    sandbox: typingsSlinky.hapiHapi.hapiHapiStrings.server | plugin = null
  ): ServerExtOptions = {
