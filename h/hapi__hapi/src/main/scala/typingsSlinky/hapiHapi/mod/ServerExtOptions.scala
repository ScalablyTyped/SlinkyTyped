...
import typingsSlinky.hapiHapi.hapiHapiStrings.plugin
...
trait ServerExtOptions extends StObject {
  ...
  /**
    ...
    */
  var sandbox: js.UndefOr[typingsSlinky.hapiHapi.hapiHapiStrings.server | plugin] = js.native
}
object ServerExtOptions {
  ...
  implicit class ServerExtOptionsMutableBuilder[Self <: ServerExtOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSandbox(value: typingsSlinky.hapiHapi.hapiHapiStrings.server | plugin): Self = StObject.set(x, "sandbox", value.asInstanceOf[js.Any])
