...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.hapiBoom.mod.Boom[js.Any]
  - typingsSlinky.node.streamMod.Stream
  - js.Object
  - js.Array[js.Object]
  - js.Symbol
  - typingsSlinky.hapiHapi.mod.ResponseToolkit
*/
...
object ReturnValueTypes {
  ...
  @scala.inline
  implicit def apply(value: Boom[js.Any]): ReturnValueTypes = value.asInstanceOf[ReturnValueTypes]
  @scala.inline
