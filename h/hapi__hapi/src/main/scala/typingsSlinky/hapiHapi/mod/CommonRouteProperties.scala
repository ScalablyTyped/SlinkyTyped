...
import typingsSlinky.hapiHapi.anon.Collect
import typingsSlinky.hapiHapi.anon.FailAction
import typingsSlinky.hapiHapi.anon.RelativeTo
import typingsSlinky.hapiHapi.anon.Server
import typingsSlinky.hapiHapi.anon.keyinRouteRequestExtTypeR
...
object CommonRouteProperties {
  ...
  @scala.inline
  implicit class CommonRoutePropertiesMutableBuilder[Self <: CommonRouteProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTimeout(value: Server): Self = StObject.set(x, "timeout", value.asInstanceOf[js.Any])
