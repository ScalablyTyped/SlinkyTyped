...
import typingsSlinky.hapiHapi.hapiHapiStrings.server
import typingsSlinky.hapiHapi.hapiHapiStrings.socket
import typingsSlinky.hapiHapi.hapiHapiStrings.tcp
...
class Server () extends js.Object {
  ...
  /**
    ...
    */
  var listener: typingsSlinky.node.httpMod.Server = js.native
  /**
  ...
  /**
    ...
    * are called, where:
    */
  def control(server: Server): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def ext(events: ServerExtEventsObject): Unit = js.native
  def ext(events: ServerExtEventsRequestObject): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def method(methods: ServerMethodConfigurationObject): Unit = js.native
  /**
