...
import typingsSlinky.atHapiHapi.atHapiHapiStrings.ignore
...
trait RouteOptionsCors extends js.Object {
  ...
  /**
    ...
    * origin ['*'].
    */
  var origin: js.UndefOr[js.Array[String] | typingsSlinky.atHapiHapi.atHapiHapiStrings.`*` | ignore] = js.undefined
}
...
object RouteOptionsCors {
  ...
  def apply(
    ...
    origin: js.Array[String] | typingsSlinky.atHapiHapi.atHapiHapiStrings.`*` | ignore = null
  ): RouteOptionsCors = {
