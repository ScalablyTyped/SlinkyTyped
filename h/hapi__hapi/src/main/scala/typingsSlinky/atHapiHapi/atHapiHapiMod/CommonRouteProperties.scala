...
import typingsSlinky.atHapiHapi.Anon_Collect
...
trait CommonRouteProperties extends js.Object {
  ...
  {[ key in @hapi/hapi.@hapi/hapi.RouteRequestExtType ]:? @hapi/hapi.@hapi/hapi.RouteExtObject | std.Array<@hapi/hapi.@hapi/hapi.RouteExtObject>}
    */ typingsSlinky.atHapiHapi.atHapiHapiStrings.CommonRouteProperties with js.Any
  ] = js.undefined
  /**
...
object CommonRouteProperties {
  ...
  {[ key in @hapi/hapi.@hapi/hapi.RouteRequestExtType ]:? @hapi/hapi.@hapi/hapi.RouteExtObject | std.Array<@hapi/hapi.@hapi/hapi.RouteExtObject>}
    */ typingsSlinky.atHapiHapi.atHapiHapiStrings.CommonRouteProperties with js.Any = null,
