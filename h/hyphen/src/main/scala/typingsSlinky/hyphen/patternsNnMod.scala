...
object patternsNnMod extends Shortcut {
  
  @JSImport("hyphen/patterns/nn", JSImport.Namespace)
  @js.native
  val ^ : PatternsDefinition = js.native
  
  type _To = PatternsDefinition
  
  /* This means you don't have to write `^`, but can instead just say `patternsNnMod.foo` */
