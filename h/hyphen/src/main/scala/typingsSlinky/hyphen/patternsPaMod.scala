...
object patternsPaMod extends Shortcut {
  
  @JSImport("hyphen/patterns/pa", JSImport.Namespace)
  @js.native
  val ^ : PatternsDefinition = js.native
  
  type _To = PatternsDefinition
  
  /* This means you don't have to write `^`, but can instead just say `patternsPaMod.foo` */
