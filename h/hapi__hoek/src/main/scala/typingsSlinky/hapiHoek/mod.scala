...
import typingsSlinky.hapiHoek.anon.OmitOptionsonce
...
object mod {
  ...
  @JSImport("@hapi/hoek", "assert")
  @js.native
  def assert(condition: js.Any, error: js.Error): Unit = js.native
  ...
  object internals {
    ...
    {[ P in std.Exclude<keyof T, keyof U> ]:? never}
      */ typingsSlinky.hapiHoek.hapiHoekStrings.Without with TopLevel[js.Any]
  }
