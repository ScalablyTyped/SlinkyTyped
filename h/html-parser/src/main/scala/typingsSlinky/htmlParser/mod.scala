package typingsSlinky.htmlParser
...
object mod {
  ...
  object RegExpOptions {
    ...
    implicit class RegExpOptionsMutableBuilder[Self <: RegExpOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttribute(value: js.RegExp): Self = StObject.set(x, "attribute", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAttributeUndefined: Self = StObject.set(x, "attribute", js.undefined)
      
      @scala.inline
      def setName(value: js.RegExp): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
