...
object mod extends Shortcut {
  ...
  object DirectoryHandlerRouteObject {
    ...
    implicit class DirectoryHandlerRouteObjectMutableBuilder[Self <: DirectoryHandlerRouteObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPath(value: String | js.Array[String] | (RequestHandler[String | js.Array[String] | js.Error])): Self = StObject.set(x, "path", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPathFunction1(value: /* request */ Request => String | js.Array[String] | js.Error): Self = StObject.set(x, "path", js.Any.fromFunction1(value))
