...
name := "hapi__hawk"
version := "8.0-dt-20200122Z-fc0cc3"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "crypto-js" % "v3.1.8-dt-20200226Z-00c931",
  ...
  "org.scalablytyped.slinky" %%% "hapi__sntp" % "3.1-dt-20190425Z-6abc7f",
