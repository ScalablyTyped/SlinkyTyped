...
name := "hapi__hawk"
version := "8.0-dt-20200925Z-5481c5"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "crypto-js" % "v4.0.0-dt-20201006Z-2b2de4",
  ...
  "org.scalablytyped.slinky" %%% "hapi__sntp" % "3.1-dt-20200925Z-2148fb",
