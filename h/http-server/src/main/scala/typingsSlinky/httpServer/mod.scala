...
object mod {
  ...
  @js.native
  def createServer(): Server | typingsSlinky.node.httpsMod.Server = js.native
  @JSImport("http-server", "createServer")
  @js.native
  def createServer(options: Options): Server | typingsSlinky.node.httpsMod.Server = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLogFn(value: (/* req */ IncomingMessage, /* res */ ServerResponse, /* err */ js.Error) => Unit): Self = StObject.set(x, "logFn", js.Any.fromFunction3(value))
