package typingsSlinky.hapiCryptiles
...
object mod {
  ...
  @JSImport("@hapi/cryptiles", "fixedTimeComparison")
  @js.native
  ...
  @JSImport("@hapi/cryptiles", "randomAlphanumString")
  @js.native
  def randomAlphanumString(size: Double): String = js.native
  
  @JSImport("@hapi/cryptiles", "randomBits")
  @js.native
  def randomBits(bits: Double): Buffer = js.native
  
  @JSImport("@hapi/cryptiles", "randomDigits")
  @js.native
  def randomDigits(size: Double): String = js.native
  
  @JSImport("@hapi/cryptiles", "randomString")
  @js.native
