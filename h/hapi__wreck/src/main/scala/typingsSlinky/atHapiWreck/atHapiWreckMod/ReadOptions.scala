...
import typingsSlinky.atHapiWreck.atHapiWreckBooleans.`true`
import typingsSlinky.atHapiWreck.atHapiWreckStrings.force
import typingsSlinky.atHapiWreck.atHapiWreckStrings.strict
