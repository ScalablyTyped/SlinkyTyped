...
import typingsSlinky.hapiWreck.mod.Client.request.Payload
...
object Options {
  @scala.inline
  def apply(
    agent: Agent | typingsSlinky.node.httpsMod.Agent | `false` = null,
    agents: Agents = null,
    baseUrl: String = null,
    beforeRedirect: (/* redirectMethod */ String, /* statusCode */ Double, /* location */ String, /* resHeaders */ Record[String, String], /* redirectOptions */ typingsSlinky.hapiWreck.mod.Client.request.Options, /* next */ js.Function0[Unit]) => Unit = null,
    ciphers: String = null,
