...
trait HasuraAggregateQueryResponse[K /* <: String */, T /* <: Record[String, _] */] extends StObject {
  ...
  {[ key in K ]: hasura.hasura.HasuraAggregateResult<T>}
    */ typingsSlinky.hasura.hasuraStrings.HasuraAggregateQueryResponse with TopLevel[js.Any] = js.native
}
object HasuraAggregateQueryResponse {
  ...
  {[ key in K ]: hasura.hasura.HasuraAggregateResult<T>}
    */ typingsSlinky.hasura.hasuraStrings.HasuraAggregateQueryResponse with TopLevel[js.Any]
