...
trait HasuraQueryResponse[K /* <: String */, T /* <: Record[String, _] */] extends StObject {
  ...
  {[ key in K ]: std.Array<hasura.hasura.HasuraDataItem<T>>}
    */ typingsSlinky.hasura.hasuraStrings.HasuraQueryResponse with TopLevel[js.Any] = js.native
}
object HasuraQueryResponse {
  ...
  {[ key in K ]: std.Array<hasura.hasura.HasuraDataItem<T>>}
    */ typingsSlinky.hasura.hasuraStrings.HasuraQueryResponse with TopLevel[js.Any]
