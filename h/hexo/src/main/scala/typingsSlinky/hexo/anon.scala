...
object anon {
  ...
  trait Console extends StObject {
    ...
    /**
      ...
      */
    val console: typingsSlinky.hexo.mod.extend.Console = js.native
  ...
  object Console {
    ...
    @scala.inline
    def apply(
      console: typingsSlinky.hexo.mod.extend.Console,
      deployer: Deployer,
      filter: Filter,
      generator: Generator,
      helper: Helper,
    ...
    implicit class ConsoleMutableBuilder[Self <: Console] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConsole(value: typingsSlinky.hexo.mod.extend.Console): Self = StObject.set(x, "console", value.asInstanceOf[js.Any])
