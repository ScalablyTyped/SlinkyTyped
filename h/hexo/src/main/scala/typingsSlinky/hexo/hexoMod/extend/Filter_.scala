...
import typingsSlinky.hexo.Anon_Content
import typingsSlinky.hexo.Anon_Key
...
trait Filter_ extends js.Object {
  ...
  /**
    ...
    */
  @JSName("register")
  def register_afterpostrender(`type`: after_post_render, fn: js.Function1[/* data */ Anon_Content, Anon_Content | Unit]): Unit = js.native
  @JSName("register")
  def register_afterpostrender(
    `type`: after_post_render,
    fn: js.Function1[/* data */ Anon_Content, Anon_Content | Unit],
    priority: Double
  ): Unit = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("register")
  def register_beforepostrender(`type`: before_post_render, fn: js.Function1[/* data */ Anon_Content, Anon_Content | Unit]): Unit = js.native
  @JSName("register")
