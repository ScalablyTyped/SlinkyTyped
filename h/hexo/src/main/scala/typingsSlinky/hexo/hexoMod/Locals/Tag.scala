package typingsSlinky.hexo.hexoMod.Locals

import typingsSlinky.hexo.hexoMod.Model
...
trait Tag extends js.Object {
  ...
  var posts: Model[typingsSlinky.hexo.hexoMod.Locals.Post]
  var slug: String
}
...
object Tag {
  ...
  def apply(
    ...
    path: String,
    permalink: String,
    posts: Model[typingsSlinky.hexo.hexoMod.Locals.Post],
    slug: String
  ): Tag = {
