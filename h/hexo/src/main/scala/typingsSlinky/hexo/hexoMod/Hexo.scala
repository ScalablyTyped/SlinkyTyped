...
import typingsSlinky.hexo.Anon_Console
import typingsSlinky.hexo.Anon_ContentPath
...
trait Hexo extends EventEmitter {
  ...
  val env: Anon_Args = js.native
  val extend: Anon_Console = js.native
  /**
  ...
  /**
    ...
    */
  val log: typingsSlinky.bunyan.bunyanMod.^ = js.native
  ...
  /**
    ...
    */
  @JSName("on")
  def on_new(ev: `new`, fn: js.Function1[/* post */ Anon_ContentPath, Unit]): this.type = js.native
  /**
