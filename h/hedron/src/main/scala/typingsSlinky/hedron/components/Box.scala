...
import typingsSlinky.hedron.mod.BoxProps
...
object Box {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.hedron.mod.Box] {
    ...
    @scala.inline
    def display(
      value: typingsSlinky.hedron.hedronStrings.`inline` | block | contents | flex | typingsSlinky.hedron.hedronStrings.grid | `inline-block` | typingsSlinky.hedron.hedronStrings.none | initial | typingsSlinky.hedron.hedronStrings.inherit | `inline-flex` | `inline-grid` | `inline-table` | `list-item` | `run-in` | table | `table-caption` | `table-column-group` | `table-header-group` | `table-footer-group` | `table-row-group` | `table-cell` | `table-column` | `table-row`
    ...
    @scala.inline
    def flex(value: String): this.type = set("flex", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def shiftDown(value: Boolean): this.type = set("shiftDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def shiftLeft(value: Boolean): this.type = set("shiftLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def shiftRight(value: Boolean): this.type = set("shiftRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def shiftUp(value: Boolean): this.type = set("shiftUp", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def visibility(value: visible | hidden | collapse | initial | typingsSlinky.hedron.hedronStrings.inherit): this.type = set("visibility", value.asInstanceOf[js.Any])
  ...
  def withProps(p: BoxProps with HTMLProps[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
