...
object Box
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.hedron.mod.Box] {
  @JSImport("hedron", "Box")
  @js.native
  ...
  def apply(
    ...
    display: typingsSlinky.hedron.hedronStrings.`inline` | block | contents | flex | typingsSlinky.hedron.hedronStrings.grid | `inline-block` | typingsSlinky.hedron.hedronStrings.none | initial | inherit | `inline-flex` | `inline-grid` | `inline-table` | `list-item` | `run-in` | table | `table-caption` | `table-column-group` | `table-header-group` | `table-footer-group` | `table-row-group` | `table-cell` | `table-column` | `table-row` = null,
    encType: String = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.hedron.mod.Box] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.hedron.mod.Box] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.hedron.mod.Box](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
