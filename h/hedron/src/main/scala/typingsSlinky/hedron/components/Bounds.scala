...
object Bounds {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.hedron.mod.Bounds] {
    @scala.inline
    ...
    @scala.inline
    def direction(value: typingsSlinky.hedron.hedronStrings.horizontal | typingsSlinky.hedron.hedronStrings.vertical): this.type = set("direction", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def valign(value: top | center | bottom): this.type = set("valign", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: BoundsProps with HTMLProps[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: Bounds.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
