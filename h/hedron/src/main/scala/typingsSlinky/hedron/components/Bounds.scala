...
import typingsSlinky.hedron.mod.BoundsProps
...
object Bounds
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.hedron.mod.Bounds] {
  ...
  def apply(
    ...
    direction: typingsSlinky.hedron.hedronStrings.horizontal | typingsSlinky.hedron.hedronStrings.vertical = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.hedron.mod.Bounds] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.hedron.mod.Bounds] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.hedron.mod.Bounds](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = BoundsProps with HTMLProps[HTMLElement]
}
