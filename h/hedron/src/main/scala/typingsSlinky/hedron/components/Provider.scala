...
import typingsSlinky.hedron.mod.ProviderProps
...
object Provider {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.hedron.mod.Provider] {
    @scala.inline
    ...
    @scala.inline
    def padding(value: String): this.type = set("padding", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: ProviderProps with HTMLProps[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
