...
object Provider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.hedron.mod.Provider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.hedron.mod.Provider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.hedron.mod.Provider] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.hedron.mod.Provider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
