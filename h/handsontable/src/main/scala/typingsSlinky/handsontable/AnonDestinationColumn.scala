...
object AnonDestinationColumn {
  @scala.inline
  def apply(destinationColumn: Double, destinationRow: Double): AnonDestinationColumn = {
  ...
  @scala.inline
  implicit class AnonDestinationColumnOps[Self <: AnonDestinationColumn] (val x: Self) extends AnyVal {
    @scala.inline
