...
trait Menu extends js.Object {
  ...
  var eventManager: typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.EventManager = js.native
  ...
  def setPosition(coords: typingsSlinky.std.Event): Unit = js.native
