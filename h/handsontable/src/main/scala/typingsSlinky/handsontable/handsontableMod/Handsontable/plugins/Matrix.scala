...
trait Matrix extends js.Object {
  ...
  def add(cellValue: typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.CellValue): Unit = js.native
  def getCellAt(row: Double, column: Double): typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.CellValue | Unit = js.native
  ...
  def remove(cellValue: typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.CellValue): Unit = js.native
