...
import typingsSlinky.handsontable.handsontableMod.Handsontable.comments.CommentObject
...
trait CellProperties extends CellMeta {
  var col: Double
  var instance: typingsSlinky.handsontable.handsontableMod.Handsontable
...
object CellProperties {
  ...
  def apply(
    col: Double,
    instance: typingsSlinky.handsontable.handsontableMod.Handsontable,
    prop: String | Double,
    row: Double,
    visualCol: Double,
    visualRow: Double,
