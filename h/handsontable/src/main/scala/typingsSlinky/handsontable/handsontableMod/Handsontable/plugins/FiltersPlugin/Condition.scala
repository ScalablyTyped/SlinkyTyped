...
trait Condition extends js.Object {
  ...
  def func(
    dataRow: typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.CellValue,
    values: js.Array[_]
  ): Boolean
}
...
object Condition {
  ...
  def apply(
    args: js.Array[_],
    func: (typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.CellValue, js.Array[_]) => Boolean,
    name: ConditionName
  ): Condition = {
