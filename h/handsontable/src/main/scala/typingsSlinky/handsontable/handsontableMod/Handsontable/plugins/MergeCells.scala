...
import typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.MergeCellsPlugin.AutofillCalculations
import typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.MergeCellsPlugin.MergedCellsCollection
import typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.MergeCellsPlugin.SelectionCalculations
