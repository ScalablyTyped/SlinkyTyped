...
import typingsSlinky.handsontable.handsontableMod.Handsontable.CellMeta
...
import typingsSlinky.handsontable.handsontableMod.Handsontable.ColumnDataGetterSetterFunction
...
import typingsSlinky.handsontable.handsontableStrings.ganttChart
...
object _Handsontable extends js.Object {
  ...
  trait Core extends js.Object {
    ...
    def getCellRenderer(cellMeta: CellMeta): typingsSlinky.handsontable.handsontableMod.Handsontable.renderers.Base = js.native
    def getCellRenderer(row: Double, col: Double): typingsSlinky.handsontable.handsontableMod.Handsontable.renderers.Base = js.native
    def getCellValidator(cellMeta: CellMeta): js.UndefOr[
        typingsSlinky.handsontable.handsontableMod.Handsontable.validators.Base | js.RegExp
      ] = js.native
    def getCellValidator(row: Double, col: Double): js.UndefOr[
        typingsSlinky.handsontable.handsontableMod.Handsontable.validators.Base | js.RegExp
      ] = js.native
    ...
    @JSName("getPlugin")
    def getPlugin_basePlugin(pluginName: basePlugin): typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.Base = js.native
    @JSName("getPlugin")
