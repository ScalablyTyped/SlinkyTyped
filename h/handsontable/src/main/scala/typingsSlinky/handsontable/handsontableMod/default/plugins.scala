...
import typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.RecordTranslator
...
object plugins extends js.Object {
  @js.native
  class Base ()
    extends typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.Base
       with Instantiable0[typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.Base]
       with Instantiable1[
          /* hotInstance */ Core, 
          typingsSlinky.handsontable.handsontableMod.Handsontable.plugins.Base
        ] {
