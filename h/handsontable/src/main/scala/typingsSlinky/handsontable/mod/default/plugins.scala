...
import typingsSlinky.handsontable.mod.Handsontable.plugins.RecordTranslator
...
object plugins extends js.Object {
  ...
  class Base ()
    extends typingsSlinky.handsontable.mod.Handsontable.plugins.Base
       ...
       with Instantiable1[/* hotInstance */ Core, typingsSlinky.handsontable.mod.Handsontable.plugins.Base] {
