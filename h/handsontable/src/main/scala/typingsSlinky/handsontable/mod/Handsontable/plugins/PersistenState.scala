...
object PersistenState {
  ...
  implicit class PersistenStateOps[Self <: PersistenState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLoadValue(value: (String, js.Object) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadValue")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withResetValue(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resetValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
