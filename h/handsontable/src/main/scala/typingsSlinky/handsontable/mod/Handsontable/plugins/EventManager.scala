...
trait EventManager extends js.Object {
  ...
  def addEventListener(element: Element, eventName: String, callback: js.Function1[/* event */ Event_, Unit]): js.Function0[Unit] = js.native
  def clear(): Unit = js.native
  def clearEvents(): Unit = js.native
  def destroy(): Unit = js.native
  def extendEvent(context: js.Object, event: Event_): js.Any = js.native
  def fireEvent(element: Element, eventName: String): Unit = js.native
  def removeEventListener(element: Element, eventName: String, callback: js.Function1[/* event */ Event_, Unit]): Unit = js.native
}
...
object EventManager {
  ...
  implicit class EventManagerOps[Self <: EventManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddEventListener(value: (Element, String, js.Function1[/* event */ Event_, Unit]) => js.Function0[Unit]): Self = {
    ...
    @scala.inline
    def withExtendEvent(value: (js.Object, Event_) => js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRemoveEventListener(value: (Element, String, js.Function1[/* event */ Event_, Unit]) => Unit): Self = {
        val ret = this.duplicate
