...
object BindRowsWithHeaders {
  ...
  implicit class BindRowsWithHeadersOps[Self <: BindRowsWithHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBindStrategy(value: BindStrategy): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bindStrategy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRemoveRows(value: js.Array[_]): Self = {
        val ret = this.duplicate
