...
object CellTypes_ {
  ...
  implicit class CellTypes_MutableBuilder[Self <: CellTypes_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandsontable(value: typingsSlinky.handsontable.mod.Handsontable.cellTypes.Handsontable): Self = StObject.set(x, "handsontable", value.asInstanceOf[js.Any])
