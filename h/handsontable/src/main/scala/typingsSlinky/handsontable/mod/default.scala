...
import typingsSlinky.handsontable.handsontableStrings.handsontable
import typingsSlinky.handsontable.mod.Handsontable.CellProperties
import typingsSlinky.handsontable.mod.Handsontable.CellTypes_
import typingsSlinky.handsontable.mod.Handsontable.Dom
import typingsSlinky.handsontable.mod.Handsontable.Editors
import typingsSlinky.handsontable.mod.Handsontable.GridSettings
import typingsSlinky.handsontable.mod.Handsontable.Helper
import typingsSlinky.handsontable.mod.Handsontable.Hooks.Methods
import typingsSlinky.handsontable.mod.Handsontable.I18n.Internationalization
import typingsSlinky.handsontable.mod.Handsontable.Plugins_
import typingsSlinky.handsontable.mod.Handsontable.Renderers_
import typingsSlinky.handsontable.mod.Handsontable.Validators_
...
object default {
  ...
  class Core protected ()
    extends typingsSlinky.handsontable.mod._Handsontable.Core {
  ...
  @js.native
  def EventManager: typingsSlinky.handsontable.mod.Handsontable.EventManager = js.native
  ...
  @scala.inline
  def EventManager_=(x: typingsSlinky.handsontable.mod.Handsontable.EventManager): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EventManager")(x.asInstanceOf[js.Any])
  ...
  object _editors {
    ...
    abstract class Base protected ()
      ...
      def this(
        hotInstance: typingsSlinky.handsontable.mod._Handsontable.Core,
        row: Double,
        col: Double,
        prop: String,
  ...
  object plugins extends Shortcut {
    ...
    @js.native
    class Base ()
      extends typingsSlinky.handsontable.mod.Handsontable.plugins.Base
         with Instantiable0[typingsSlinky.handsontable.mod.Handsontable.plugins.Base]
         with Instantiable1[
              /* hotInstance */ typingsSlinky.handsontable.mod._Handsontable.Core, 
              typingsSlinky.handsontable.mod.Handsontable.plugins.Base
            ] {
      def this(hotInstance: typingsSlinky.handsontable.mod._Handsontable.Core) = this()
    }
