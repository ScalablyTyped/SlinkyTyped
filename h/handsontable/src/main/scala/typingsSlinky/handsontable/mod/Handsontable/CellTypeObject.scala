...
/* key */ StringDictionary[js.Any] {
  ...
  @JSName("renderer")
  var renderer_CellTypeObject: js.UndefOr[typingsSlinky.handsontable.mod.Handsontable.renderers.Base] = js.native
  
  @JSName("validator")
  var validator_CellTypeObject: js.UndefOr[typingsSlinky.handsontable.mod.Handsontable.validators.Base] = js.native
}
object CellTypeObject {
  ...
  implicit class CellTypeObjectMutableBuilder[Self <: CellTypeObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidator(value: typingsSlinky.handsontable.mod.Handsontable.validators.Base): Self = StObject.set(x, "validator", value.asInstanceOf[js.Any])
