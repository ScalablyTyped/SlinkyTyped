...
object GridSettings {
  ...
  implicit class GridSettingsOps[Self <: GridSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutoRowSize(value: typingsSlinky.handsontable.mod.Handsontable.autoRowSize.Settings | Boolean): Self = this.set("autoRowSize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCollapsibleColumnsVarargs(value: typingsSlinky.handsontable.mod.Handsontable.collapsibleColumns.Settings*): Self = this.set("collapsibleColumns", js.Array(value :_*))
    
    @scala.inline
    def setCollapsibleColumns(value: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.collapsibleColumns.Settings]): Self = this.set("collapsibleColumns", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setColumnSorting(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.columnSorting.Settings): Self = this.set("columnSorting", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteColumnSorting: Self = this.set("columnSorting", js.undefined)
    
    @scala.inline
    def setColumnSummaryVarargs(value: typingsSlinky.handsontable.mod.Handsontable.columnSummary.Settings*): Self = this.set("columnSummary", js.Array(value :_*))
    
    @scala.inline
    def setColumnSummaryFunction0(value: () => js.Array[typingsSlinky.handsontable.mod.Handsontable.columnSummary.Settings]): Self = this.set("columnSummary", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setCopyPaste(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.copyPaste.Settings): Self = this.set("copyPaste", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCustomBordersVarargs(value: typingsSlinky.handsontable.mod.Handsontable.customBorders.Settings*): Self = this.set("customBorders", js.Array(value :_*))
    
    @scala.inline
    def setCustomBorders(value: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.customBorders.Settings]): Self = this.set("customBorders", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("fillHandle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormulas(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.formulas.Settings): Self = this.set("formulas", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHiddenColumns(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenColumns.Settings): Self = this.set("hiddenColumns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHiddenColumns: Self = this.set("hiddenColumns", js.undefined)
    
    @scala.inline
    def setHiddenRows(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenRows.Settings): Self = this.set("hiddenRows", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMergeCellsVarargs(value: typingsSlinky.handsontable.mod.Handsontable.mergeCells.Settings*): Self = this.set("mergeCells", js.Array(value :_*))
    
    @scala.inline
    def setMergeCells(value: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.mergeCells.Settings]): Self = this.set("mergeCells", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMultiColumnSorting(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.multiColumnSorting.Settings): Self = this.set("multiColumnSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderer(value: RendererType | String | typingsSlinky.handsontable.mod.Handsontable.renderers.Base): Self = this.set("renderer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSearch(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.search.Settings): Self = this.set("search", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("validator", value.asInstanceOf[js.Any])
