...
trait GridSettings extends Events {
  ...
  var autoRowSize: js.UndefOr[typingsSlinky.handsontable.mod.Handsontable.autoRowSize.Settings | Boolean] = js.undefined
  ...
  var columnSorting: js.UndefOr[Boolean | typingsSlinky.handsontable.mod.Handsontable.columnSorting.Settings] = js.undefined
  ...
  var copyPaste: js.UndefOr[Boolean | typingsSlinky.handsontable.mod.Handsontable.copyPaste.Settings] = js.undefined
  ...
  var formulas: js.UndefOr[Boolean | typingsSlinky.handsontable.mod.Handsontable.formulas.Settings] = js.undefined
  var fragmentSelection: js.UndefOr[Boolean | cell] = js.undefined
  var ganttChart: js.UndefOr[typingsSlinky.handsontable.mod.Handsontable.ganttChart.Settings] = js.undefined
  var headerTooltips: js.UndefOr[Boolean | typingsSlinky.handsontable.mod.Handsontable.headerTooltips.Settings] = js.undefined
  var height: js.UndefOr[Double | String | (js.Function0[Double | String])] = js.undefined
  var hiddenColumns: js.UndefOr[Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenColumns.Settings] = js.undefined
  var hiddenRows: js.UndefOr[Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenRows.Settings] = js.undefined
  ...
  var search: js.UndefOr[Boolean | typingsSlinky.handsontable.mod.Handsontable.search.Settings] = js.undefined
...
object GridSettings {
  ...
  def apply(
    ...
    autoRowSize: typingsSlinky.handsontable.mod.Handsontable.autoRowSize.Settings | Boolean = null,
    ...
    collapsibleColumns: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.collapsibleColumns.Settings] = null,
    columnHeaderHeight: Double | js.Array[js.UndefOr[Double]] = null,
    columnSorting: Boolean | typingsSlinky.handsontable.mod.Handsontable.columnSorting.Settings = null,
    columnSummary: js.Array[typingsSlinky.handsontable.mod.Handsontable.columnSummary.Settings] | js.Function0[js.Array[typingsSlinky.handsontable.mod.Handsontable.columnSummary.Settings]] = null,
    columns: js.Array[ColumnSettings] | (js.Function1[/* index */ Double, ColumnSettings]) = null,
    commentedCellClassName: String = null,
    comments: Boolean | typingsSlinky.handsontable.mod.Handsontable.comments.Settings | js.Array[CommentConfig] = null,
    contextMenu: Boolean | js.Array[PredefinedMenuItemKey] | typingsSlinky.handsontable.mod.Handsontable.contextMenu.Settings = null,
    copyPaste: Boolean | typingsSlinky.handsontable.mod.Handsontable.copyPaste.Settings = null,
    ...
    customBorders: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.customBorders.Settings] = null,
    ...
    dropdownMenu: Boolean | js.Array[PredefinedMenuItemKey] | typingsSlinky.handsontable.mod.Handsontable.contextMenu.Settings = null,
    ...
    fillHandle: Boolean | vertical | horizontal | typingsSlinky.handsontable.mod.Handsontable.autoFill.Settings = null,
    ...
    formulas: Boolean | typingsSlinky.handsontable.mod.Handsontable.formulas.Settings = null,
    fragmentSelection: Boolean | cell = null,
    ganttChart: typingsSlinky.handsontable.mod.Handsontable.ganttChart.Settings = null,
    headerTooltips: Boolean | typingsSlinky.handsontable.mod.Handsontable.headerTooltips.Settings = null,
    height: Double | String | (js.Function0[Double | String]) = null,
    hiddenColumns: Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenColumns.Settings = null,
    hiddenRows: Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenRows.Settings = null,
    ...
    mergeCells: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.mergeCells.Settings] = null,
    minCols: Int | Double = null,
    minRows: Int | Double = null,
    minSpareCols: Int | Double = null,
    minSpareRows: Int | Double = null,
    multiColumnSorting: Boolean | typingsSlinky.handsontable.mod.Handsontable.multiColumnSorting.Settings = null,
    ...
    renderer: RendererType | String | typingsSlinky.handsontable.mod.Handsontable.renderers.Base = null,
    ...
    search: Boolean | typingsSlinky.handsontable.mod.Handsontable.search.Settings = null,
    ...
    validator: typingsSlinky.handsontable.mod.Handsontable.validators.Base | js.RegExp | ValidatorType | String = null,
