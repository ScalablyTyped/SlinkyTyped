...
object GridSettings {
  ...
  implicit class GridSettingsMutableBuilder[Self <: GridSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutoRowSize(value: typingsSlinky.handsontable.mod.Handsontable.autoRowSize.Settings | Boolean): Self = StObject.set(x, "autoRowSize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCollapsibleColumns(value: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.collapsibleColumns.Settings]): Self = StObject.set(x, "collapsibleColumns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCollapsibleColumnsUndefined: Self = StObject.set(x, "collapsibleColumns", js.undefined)
    
    @scala.inline
    def setCollapsibleColumnsVarargs(value: typingsSlinky.handsontable.mod.Handsontable.collapsibleColumns.Settings*): Self = StObject.set(x, "collapsibleColumns", js.Array(value :_*))
    ...
    @scala.inline
    def setColumnSorting(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.columnSorting.Settings): Self = StObject.set(x, "columnSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setColumnSummaryFunction0(value: () => js.Array[typingsSlinky.handsontable.mod.Handsontable.columnSummary.Settings]): Self = StObject.set(x, "columnSummary", js.Any.fromFunction0(value))
    
    @scala.inline
    def setColumnSummaryUndefined: Self = StObject.set(x, "columnSummary", js.undefined)
    
    @scala.inline
    def setColumnSummaryVarargs(value: typingsSlinky.handsontable.mod.Handsontable.columnSummary.Settings*): Self = StObject.set(x, "columnSummary", js.Array(value :_*))
    ...
    @scala.inline
    def setCopyPaste(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.copyPaste.Settings): Self = StObject.set(x, "copyPaste", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCustomBorders(value: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.customBorders.Settings]): Self = StObject.set(x, "customBorders", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomBordersUndefined: Self = StObject.set(x, "customBorders", js.undefined)
    
    @scala.inline
    def setCustomBordersVarargs(value: typingsSlinky.handsontable.mod.Handsontable.customBorders.Settings*): Self = StObject.set(x, "customBorders", js.Array(value :_*))
    ...
    ): Self = StObject.set(x, "fillHandle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormulas(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.formulas.Settings): Self = StObject.set(x, "formulas", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHeaderTooltips(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.headerTooltips.Settings): Self = StObject.set(x, "headerTooltips", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHiddenColumns(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenColumns.Settings): Self = StObject.set(x, "hiddenColumns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHiddenColumnsUndefined: Self = StObject.set(x, "hiddenColumns", js.undefined)
    
    @scala.inline
    def setHiddenRows(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.hiddenRows.Settings): Self = StObject.set(x, "hiddenRows", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMergeCells(value: Boolean | js.Array[typingsSlinky.handsontable.mod.Handsontable.mergeCells.Settings]): Self = StObject.set(x, "mergeCells", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMergeCellsUndefined: Self = StObject.set(x, "mergeCells", js.undefined)
    
    @scala.inline
    def setMergeCellsVarargs(value: typingsSlinky.handsontable.mod.Handsontable.mergeCells.Settings*): Self = StObject.set(x, "mergeCells", js.Array(value :_*))
    ...
    @scala.inline
    def setMultiColumnSorting(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.multiColumnSorting.Settings): Self = StObject.set(x, "multiColumnSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderer(value: RendererType | String | typingsSlinky.handsontable.mod.Handsontable.renderers.Base): Self = StObject.set(x, "renderer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRendererFunction7(
      value: (/* instance */ typingsSlinky.handsontable.mod._Handsontable.Core, /* TD */ HTMLTableCellElement, /* row */ Double, /* col */ Double, /* prop */ String | Double, /* value */ CellValue, /* cellProperties */ CellProperties) => HTMLTableCellElement | Unit
    ...
    @scala.inline
    def setSearch(value: Boolean | typingsSlinky.handsontable.mod.Handsontable.search.Settings): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValidatorRegExp(value: js.RegExp): Self = StObject.set(x, "validator", value.asInstanceOf[js.Any])
