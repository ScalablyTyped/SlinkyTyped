...
object Editors {
  ...
  implicit class EditorsMutableBuilder[Self <: Editors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandsontableEditor(value: Instantiable0[typingsSlinky.handsontable.mod.Handsontable._editors.Handsontable]): Self = StObject.set(x, "HandsontableEditor", value.asInstanceOf[js.Any])
