...
object Editors {
  ...
  implicit class EditorsOps[Self <: Editors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandsontableEditor(value: Instantiable0[typingsSlinky.handsontable.mod.Handsontable._editors.Handsontable]): Self = this.set("HandsontableEditor", value.asInstanceOf[js.Any])
