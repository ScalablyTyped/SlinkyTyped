...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.handsontable.handsontableStrings.autocomplete
  - typingsSlinky.handsontable.handsontableStrings.checkbox
  - typingsSlinky.handsontable.handsontableStrings.date
  - typingsSlinky.handsontable.handsontableStrings.dropdown
  - typingsSlinky.handsontable.handsontableStrings.handsontable
  - typingsSlinky.handsontable.handsontableStrings.numeric
  - typingsSlinky.handsontable.handsontableStrings.password
