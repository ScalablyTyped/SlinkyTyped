...
trait Plugins_ extends js.Object {
  var AutoColumnSize: typingsSlinky.handsontable.mod.Handsontable.plugins.AutoColumnSize = js.native
  var AutoRowSize: typingsSlinky.handsontable.mod.Handsontable.plugins.AutoRowSize = js.native
  var Autofill: typingsSlinky.handsontable.mod.Handsontable.plugins.Autofill = js.native
  var BasePlugin: Base = js.native
  var BindRowsWithHeaders: typingsSlinky.handsontable.mod.Handsontable.plugins.BindRowsWithHeaders = js.native
  var CollapsibleColumns: typingsSlinky.handsontable.mod.Handsontable.plugins.CollapsibleColumns = js.native
  var ColumnSorting: typingsSlinky.handsontable.mod.Handsontable.plugins.ColumnSorting = js.native
  var ColumnSummary: typingsSlinky.handsontable.mod.Handsontable.plugins.ColumnSummary = js.native
  var Comments: typingsSlinky.handsontable.mod.Handsontable.plugins.Comments = js.native
  var ContextMenu: typingsSlinky.handsontable.mod.Handsontable.plugins.ContextMenu = js.native
  ...
  var ExportFile: typingsSlinky.handsontable.mod.Handsontable.plugins.ExportFile = js.native
  ...
  var HiddenColumns: typingsSlinky.handsontable.mod.Handsontable.plugins.HiddenColumns = js.native
  var HiddenRows: typingsSlinky.handsontable.mod.Handsontable.plugins.HiddenRows = js.native
  var ManualColumnFreeze: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualColumnFreeze = js.native
  var ManualColumnMove: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualColumnMove = js.native
  var ManualColumnResize: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualColumnResize = js.native
  var ManualRowMove: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualRowMove = js.native
  var ManualRowResize: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualRowResize = js.native
  var MergeCells: typingsSlinky.handsontable.mod.Handsontable.plugins.MergeCells = js.native
  var MultiColumnSorting: typingsSlinky.handsontable.mod.Handsontable.plugins.MultiColumnSorting = js.native
  var MultipleSelectionHandles: typingsSlinky.handsontable.mod.Handsontable.plugins.MultipleSelectionHandles = js.native
  var NestedHeaders: typingsSlinky.handsontable.mod.Handsontable.plugins.NestedHeaders = js.native
  var NestedRows: typingsSlinky.handsontable.mod.Handsontable.plugins.NestedRows = js.native
  var ObserveChanges: typingsSlinky.handsontable.mod.Handsontable.plugins.ObserveChanges = js.native
  var Search: typingsSlinky.handsontable.mod.Handsontable.plugins.Search = js.native
  var TouchScroll: typingsSlinky.handsontable.mod.Handsontable.plugins.TouchScroll = js.native
  var TrimRows: typingsSlinky.handsontable.mod.Handsontable.plugins.TrimRows = js.native
  def registerPlugin(pluginName: String, pluginClass: AnonInstantiable): Unit = js.native
}
...
object Plugins_ {
  ...
  implicit class Plugins_Ops[Self <: Plugins_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRegisterPlugin(value: (String, AnonInstantiable) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("registerPlugin")(js.Any.fromFunction2(value))
        ret
    }
  }
