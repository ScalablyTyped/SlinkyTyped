...
import typingsSlinky.handsontable.AnonInstantiable
...
trait Plugins_ extends js.Object {
  var AutoColumnSize: typingsSlinky.handsontable.mod.Handsontable.plugins.AutoColumnSize
  var AutoRowSize: typingsSlinky.handsontable.mod.Handsontable.plugins.AutoRowSize
  var Autofill: typingsSlinky.handsontable.mod.Handsontable.plugins.Autofill
  var BasePlugin: Base
  var BindRowsWithHeaders: typingsSlinky.handsontable.mod.Handsontable.plugins.BindRowsWithHeaders
  var CollapsibleColumns: typingsSlinky.handsontable.mod.Handsontable.plugins.CollapsibleColumns
  var ColumnSorting: typingsSlinky.handsontable.mod.Handsontable.plugins.ColumnSorting
  var ColumnSummary: typingsSlinky.handsontable.mod.Handsontable.plugins.ColumnSummary
  var Comments: typingsSlinky.handsontable.mod.Handsontable.plugins.Comments
  var ContextMenu: typingsSlinky.handsontable.mod.Handsontable.plugins.ContextMenu
  var CopyPaste: typingsSlinky.handsontable.mod.Handsontable.plugins.CopyPaste
  var DragToScroll: typingsSlinky.handsontable.mod.Handsontable.plugins.DragToScroll
  var DropdownMenu: typingsSlinky.handsontable.mod.Handsontable.plugins.DropdownMenu
  var ExportFile: typingsSlinky.handsontable.mod.Handsontable.plugins.ExportFile
  var Filters: typingsSlinky.handsontable.mod.Handsontable.plugins.Filters
  var Formulas: typingsSlinky.handsontable.mod.Handsontable.plugins.Formulas
  var GanttChart: typingsSlinky.handsontable.mod.Handsontable.plugins.GanttChart
  var HeaderTooltips: typingsSlinky.handsontable.mod.Handsontable.plugins.HeaderTooltips
  var HiddenColumns: typingsSlinky.handsontable.mod.Handsontable.plugins.HiddenColumns
  var HiddenRows: typingsSlinky.handsontable.mod.Handsontable.plugins.HiddenRows
  var ManualColumnFreeze: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualColumnFreeze
  var ManualColumnMove: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualColumnMove
  var ManualColumnResize: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualColumnResize
  var ManualRowMove: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualRowMove
  var ManualRowResize: typingsSlinky.handsontable.mod.Handsontable.plugins.ManualRowResize
  var MergeCells: typingsSlinky.handsontable.mod.Handsontable.plugins.MergeCells
  var MultiColumnSorting: typingsSlinky.handsontable.mod.Handsontable.plugins.MultiColumnSorting
  var MultipleSelectionHandles: typingsSlinky.handsontable.mod.Handsontable.plugins.MultipleSelectionHandles
  var NestedHeaders: typingsSlinky.handsontable.mod.Handsontable.plugins.NestedHeaders
  var NestedRows: typingsSlinky.handsontable.mod.Handsontable.plugins.NestedRows
  var ObserveChanges: typingsSlinky.handsontable.mod.Handsontable.plugins.ObserveChanges
  var Search: typingsSlinky.handsontable.mod.Handsontable.plugins.Search
  var TouchScroll: typingsSlinky.handsontable.mod.Handsontable.plugins.TouchScroll
  var TrimRows: typingsSlinky.handsontable.mod.Handsontable.plugins.TrimRows
