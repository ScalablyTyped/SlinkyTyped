...
object ManualColumnFreeze {
  ...
  implicit class ManualColumnFreezeOps[Self <: ManualColumnFreeze] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFreezeColumn(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("freezeColumn")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFrozenColumnsBasePositions(value: js.Array[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("frozenColumnsBasePositions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withManualColumnMovePlugin(value: ManualColumnMove): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("manualColumnMovePlugin")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUnfreezeColumn(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unfreezeColumn")(js.Any.fromFunction1(value))
        ret
    }
  }
