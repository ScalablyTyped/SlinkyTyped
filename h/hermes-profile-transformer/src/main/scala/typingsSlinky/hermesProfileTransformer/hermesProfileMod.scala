...
import typingsSlinky.hermesProfileTransformer.eventInterfacesMod.SharedEventProperties
...
object hermesProfileMod {
  ...
  trait HermesCPUProfile extends StObject {
    ...
    {[ key in string ]: hermes-profile-transformer.hermes-profile-transformer/dist/types/HermesProfile.HermesStackFrame}
      */ typingsSlinky.hermesProfileTransformer.hermesProfileTransformerStrings.HermesCPUProfile with TopLevel[js.Any] = js.native
  ...
  object HermesCPUProfile {
    ...
    {[ key in string ]: hermes-profile-transformer.hermes-profile-transformer/dist/types/HermesProfile.HermesStackFrame}
      */ typingsSlinky.hermesProfileTransformer.hermesProfileTransformerStrings.HermesCPUProfile with TopLevel[js.Any],
