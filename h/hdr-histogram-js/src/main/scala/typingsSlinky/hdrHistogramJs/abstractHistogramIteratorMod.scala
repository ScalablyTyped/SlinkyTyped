...
object abstractHistogramIteratorMod {
  ...
  trait AbstractHistogramIterator extends StObject {
    ...
    var currentIterationValue: typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default = js.native
    ...
    /**
      ...
      */
    def next(): typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default = js.native
  ...
  object AbstractHistogramIterator {
    ...
    implicit class AbstractHistogramIteratorMutableBuilder[Self <: AbstractHistogramIterator] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCurrentIterationValue(value: typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default): Self = StObject.set(x, "currentIterationValue", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNext(value: () => typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default): Self = StObject.set(x, "next", js.Any.fromFunction0(value))
