package typingsSlinky.hdrHistogramJs.byteBufferMod
...
trait ByteBuffer extends js.Object {
  ...
  def putArray(array: js.typedarray.Uint8Array): Unit = js.native
...
object ByteBuffer {
  ...
  implicit class ByteBufferOps[Self <: ByteBuffer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInt32ArrayForConvert(value: js.typedarray.Uint32Array): Self = this.set("int32ArrayForConvert", value.asInstanceOf[js.Any])
    @scala.inline
    def setInt8ArrayForConvert(value: js.typedarray.Uint8Array): Self = this.set("int8ArrayForConvert", value.asInstanceOf[js.Any])
    @scala.inline
    def setPosition(value: Double): Self = this.set("position", value.asInstanceOf[js.Any])
    @scala.inline
    def setPut(value: Double => Unit): Self = this.set("put", js.Any.fromFunction1(value))
    @scala.inline
    def setPutArray(value: js.typedarray.Uint8Array => Unit): Self = this.set("putArray", js.Any.fromFunction1(value))
    @scala.inline
