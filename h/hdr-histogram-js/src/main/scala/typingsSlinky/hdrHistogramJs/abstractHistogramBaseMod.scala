...
import typingsSlinky.hdrHistogramJs.encodableHistogramMod.EncodableHistogram
import typingsSlinky.hdrHistogramJs.percentileIteratorMod.default
...
object abstractHistogramBaseMod extends js.Object {
  ...
  abstract class AbstractHistogramBase () extends EncodableHistogram {
    ...
    var recordedValuesIterator: typingsSlinky.hdrHistogramJs.recordedValuesIteratorMod.default = js.native
