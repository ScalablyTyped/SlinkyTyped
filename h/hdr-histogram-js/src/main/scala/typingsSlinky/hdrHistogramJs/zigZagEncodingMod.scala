...
object zigZagEncodingMod {
  ...
  object default {
    ...
    @js.native
    def decode(buffer: typingsSlinky.hdrHistogramJs.byteBufferMod.default): Double = js.native
    ...
    @js.native
    def encode(buffer: typingsSlinky.hdrHistogramJs.byteBufferMod.default, value: Double): Unit = js.native
  }
