...
import typingsSlinky.hdrHistogramJs.abstractHistogramIteratorMod.AbstractHistogramIterator
...
object RecordedValuesIterator {
  ...
  def apply(
    ...
    currentIndex: Double,
    currentIterationValue: typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default,
    ...
    next: () => typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default,
