...
object byteBufferMod {
  ...
  object ByteBuffer {
    ...
    implicit class ByteBufferMutableBuilder[Self <: ByteBuffer] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInt32ArrayForConvert(value: js.typedarray.Uint32Array): Self = StObject.set(x, "int32ArrayForConvert", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInt8ArrayForConvert(value: js.typedarray.Uint8Array): Self = StObject.set(x, "int8ArrayForConvert", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPutArray(value: js.typedarray.Uint8Array => Unit): Self = StObject.set(x, "putArray", js.Any.fromFunction1(value))
