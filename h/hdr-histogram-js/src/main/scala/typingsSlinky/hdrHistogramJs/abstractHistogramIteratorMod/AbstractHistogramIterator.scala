...
object AbstractHistogramIterator {
  ...
  implicit class AbstractHistogramIteratorOps[Self <: AbstractHistogramIterator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentIterationValue(value: typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default): Self = this.set("currentIterationValue", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNext(value: () => typingsSlinky.hdrHistogramJs.histogramIterationValueMod.default): Self = this.set("next", js.Any.fromFunction0(value))
    @scala.inline
