...
import typingsSlinky.atHyperlorisTyson.distTypesAnnotationsJsonPropertyMod.JsonPropertyOptions
...
@js.native
object atHyperlorisTysonMod extends js.Object {
  @js.native
  abstract class TypeAdapter[T] ()
    extends typingsSlinky.atHyperlorisTyson.distTypesTypeAdapterMod.TypeAdapter[T]
  ...
  class Tyson () extends js.Object {
    def this(builder: typingsSlinky.atHyperlorisTyson.distTypesTysonBuilderMod.TysonBuilder) = this()
    ...
    /**
      ...
      * @memberof Tyson
      */
    def getAdapter[T](typeToken: TypeToken[T]): typingsSlinky.atHyperlorisTyson.distTypesTypeAdapterMod.TypeAdapter[T] = js.native
  ...
  @js.native
  class TysonBuilder ()
    extends typingsSlinky.atHyperlorisTyson.distTypesTysonBuilderMod.TysonBuilder
  ...
  object Access extends js.Object {
    ...
    def apply(value: String): js.UndefOr[
        typingsSlinky.atHyperlorisTyson.distTypesAnnotationsJsonPropertyMod.Access with String
      ] = js.native
  }
