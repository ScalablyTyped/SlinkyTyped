...
object AverageBandwidth {
  ...
  def apply(
    ...
    averageBandwidth: js.UndefOr[Double] = js.undefined,
    closedCaptions: js.Array[Rendition[`CLOSED-CAPTIONS`]] = null,
    codecs: String = null,
    currentRenditions: Audio = null,
    ...
    if (!js.isUndefined(averageBandwidth)) __obj.updateDynamic("averageBandwidth")(averageBandwidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isIFrameOnly)) __obj.updateDynamic("isIFrameOnly")(isIFrameOnly.get.asInstanceOf[js.Any])
