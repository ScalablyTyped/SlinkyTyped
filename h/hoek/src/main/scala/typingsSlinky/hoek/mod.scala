...
object mod {
  ...
  @JSImport("hoek", "abort")
  @js.native
  def abort(message: js.Error): Unit = js.native
  ...
  @js.native
  def assert(condition: Boolean, message: String): Unit | js.Error = js.native
  @JSImport("hoek", "assert")
  @js.native
  def assert(condition: Boolean, message: js.Error): Unit | js.Error = js.native
