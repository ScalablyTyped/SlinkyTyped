...
object Feature {
  ...
  @scala.inline
  def apply(geometry: Geometry, `type`: typingsSlinky.hafasClient.hafasClientStrings.Feature): Feature = {
  ...
  implicit class FeatureMutableBuilder[Self <: Feature] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.hafasClient.hafasClientStrings.Feature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
