...
trait FeatureCollection extends StObject {
  ...
  var `type`: typingsSlinky.hafasClient.hafasClientStrings.FeatureCollection = js.native
}
object FeatureCollection {
  ...
  def apply(
    ...
    `type`: typingsSlinky.hafasClient.hafasClientStrings.FeatureCollection
  ): FeatureCollection = {
  ...
  implicit class FeatureCollectionMutableBuilder[Self <: FeatureCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.hafasClient.hafasClientStrings.FeatureCollection): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
