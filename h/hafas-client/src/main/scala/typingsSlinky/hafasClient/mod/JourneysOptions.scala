...
trait JourneysOptions extends StObject {
  ...
  /**
    ...
    * @default undefined
    */
  var arrival: js.UndefOr[js.Date] = js.native
  ...
  /**
    ...
    * @default undefined
    */
  var departure: js.UndefOr[js.Date] = js.native
...
object JourneysOptions {
  ...
  implicit class JourneysOptionsMutableBuilder[Self <: JourneysOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrival(value: js.Date): Self = StObject.set(x, "arrival", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeparture(value: js.Date): Self = StObject.set(x, "departure", value.asInstanceOf[js.Any])
