...
object JourneysOptions {
  ...
  implicit class JourneysOptionsOps[Self <: JourneysOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrival(value: js.Date): Self = this.set("arrival", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeparture(value: js.Date): Self = this.set("departure", value.asInstanceOf[js.Any])
