...
object MoonLoader {
  ...
  implicit def make(companion: MoonLoader.type): SharedBuilder_SizeLoaderProps305627816[js.Object] = new SharedBuilder_SizeLoaderProps305627816[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
