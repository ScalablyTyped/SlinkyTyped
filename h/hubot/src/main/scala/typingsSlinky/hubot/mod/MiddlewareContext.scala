...
object MiddlewareContext {
  @scala.inline
  def apply[/* <: typingsSlinky.hubot.mod.Adapter */ T](): MiddlewareContext[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MiddlewareContext[T]]
  }
  @scala.inline
  implicit class MiddlewareContextOps[Self <: MiddlewareContext[_], /* <: typingsSlinky.hubot.mod.Adapter */ T] (val x: Self with MiddlewareContext[T]) extends AnyVal {
    @scala.inline
