...
object Listener {
  @scala.inline
  def apply[/* <: typingsSlinky.hubot.mod.Adapter */ A](listener: Middleware[A], receive: Middleware[A], response: Middleware[A]): Listener[A] = {
  ...
  @scala.inline
  implicit class ListenerOps[Self <: Listener[_], /* <: typingsSlinky.hubot.mod.Adapter */ A] (val x: Self with Listener[A]) extends AnyVal {
    @scala.inline
