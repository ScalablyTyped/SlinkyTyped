...
@js.native
object hubotMod extends js.Object {
  @js.native
  ...
  class Robot[A] protected () extends js.Object {
    ...
    def hear(regex: js.RegExp, callback: ListenerCallback[this.type]): Unit = js.native
    def hear(regex: js.RegExp, options: js.Any, callback: ListenerCallback[this.type]): Unit = js.native
    ...
    def respond(regex: js.RegExp, callback: ListenerCallback[this.type]): Unit = js.native
    def respond(regex: js.RegExp, options: js.Any, callback: ListenerCallback[this.type]): Unit = js.native
