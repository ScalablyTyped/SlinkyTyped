package typingsSlinky.httpsnippet.mod
...
@js.native
trait TargetClientInfo extends js.Object {
...
object TargetClientInfo {
  ...
  @scala.inline
  implicit class TargetClientInfoOps[Self <: TargetClientInfo] (val x: Self) extends AnyVal {
