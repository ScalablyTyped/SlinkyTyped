...
object read extends js.Object {
  ...
  def apply(fd: Double, buffer: Uint8Array, offset: Double, length: Double): typingsSlinky.bluebird.mod.^[AnonBytesRead] = js.native
  def apply(fd: Double, buffer: Uint8Array, offset: Double, length: Double, position: Double): typingsSlinky.bluebird.mod.^[AnonBytesRead] = js.native
}
