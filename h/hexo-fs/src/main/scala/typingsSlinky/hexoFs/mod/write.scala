...
object write extends js.Object {
  ...
  def apply(fd: Double, buffer: js.typedarray.Uint8Array): typingsSlinky.bluebird.mod.^[AnonBufferBytesWritten] = js.native
  def apply(fd: Double, buffer: js.typedarray.Uint8Array, offset: Double): typingsSlinky.bluebird.mod.^[AnonBufferBytesWritten] = js.native
  def apply(fd: Double, buffer: js.typedarray.Uint8Array, offset: Double, length: Double): typingsSlinky.bluebird.mod.^[AnonBufferBytesWritten] = js.native
  def apply(fd: Double, buffer: js.typedarray.Uint8Array, offset: Double, length: Double, position: Double): typingsSlinky.bluebird.mod.^[AnonBufferBytesWritten] = js.native
