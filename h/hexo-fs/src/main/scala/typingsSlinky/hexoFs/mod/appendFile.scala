...
object appendFile extends js.Object {
  def apply(path: String, data: js.Any): typingsSlinky.bluebird.mod.^[Unit] = js.native
  ...
  def apply(path: String, data: js.Any, options: AppendFileOptions): typingsSlinky.bluebird.mod.^[Unit] = js.native
  def apply(
    path: String,
    data: js.Any,
