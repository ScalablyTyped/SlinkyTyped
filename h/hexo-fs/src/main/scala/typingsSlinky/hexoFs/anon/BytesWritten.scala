...
@js.native
trait BytesWritten[TBuffer /* <: typingsSlinky.node.Buffer | js.typedarray.Uint8Array */] extends js.Object {
...
object BytesWritten {
  ...
  @scala.inline
  implicit class BytesWrittenOps[Self <: BytesWritten[_], TBuffer /* <: typingsSlinky.node.Buffer | js.typedarray.Uint8Array */] (val x: Self with BytesWritten[TBuffer]) extends AnyVal {
