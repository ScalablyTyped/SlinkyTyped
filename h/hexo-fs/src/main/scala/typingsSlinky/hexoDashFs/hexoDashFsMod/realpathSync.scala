...
import typingsSlinky.hexoDashFs.hexoDashFsStrings.buffer
...
object realpathSync extends js.Object {
  ...
  def native(path: PathLike, options: typingsSlinky.node.Anon_BufferEncoding): Buffer = js.native
  def native(path: PathLike, options: typingsSlinky.node.Anon_EncodingBufferEncoding): String = js.native
  def native(path: PathLike, options: typingsSlinky.node.Anon_EncodingNull): String | Buffer = js.native
