...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(checkBody)) __obj.updateDynamic("checkBody")(checkBody.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(checkQuery)) __obj.updateDynamic("checkQuery")(checkQuery.get.asInstanceOf[js.Any])
