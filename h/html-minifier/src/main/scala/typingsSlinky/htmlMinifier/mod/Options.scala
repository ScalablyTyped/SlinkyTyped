...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMinifyCSS(value: Boolean | typingsSlinky.cleanCss.mod.Options | (js.Function1[/* text */ String, String])): Self = this.set("minifyCSS", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinifyURLs(value: Boolean | typingsSlinky.relateurl.mod.Options | (js.Function1[/* text */ String, String])): Self = this.set("minifyURLs", value.asInstanceOf[js.Any])
