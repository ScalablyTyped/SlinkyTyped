...
object Options {
  ...
  def apply(
    ...
    minifyCSS: Boolean | typingsSlinky.cleanCss.mod.Options | (js.Function1[/* text */ String, String]) = null,
    minifyJS: Boolean | MinifyOptions | (js.Function2[/* text */ String, /* inline */ Boolean, String]) = null,
    minifyURLs: Boolean | typingsSlinky.relateurl.mod.Options | (js.Function1[/* text */ String, String]) = null,
