...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMinifyCSSFunction1(value: /* text */ String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minifyCSS")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMinifyCSS(value: Boolean | typingsSlinky.cleanCss.mod.Options | (js.Function1[/* text */ String, String])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMinifyJSFunction2(value: (/* text */ String, /* inline */ Boolean) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minifyJS")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withMinifyJS(value: Boolean | MinifyOptions | (js.Function2[/* text */ String, /* inline */ Boolean, String])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMinifyURLs(value: Boolean | typingsSlinky.relateurl.mod.Options | (js.Function1[/* text */ String, String])): Self = {
        val ret = this.duplicate
