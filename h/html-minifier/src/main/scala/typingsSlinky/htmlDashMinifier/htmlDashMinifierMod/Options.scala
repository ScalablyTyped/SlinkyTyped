package typingsSlinky.htmlDashMinifier.htmlDashMinifierMod
...
trait Options extends js.Object {
  ...
  var minifyCSS: js.UndefOr[
    Boolean | typingsSlinky.cleanDashCss.cleanDashCssMod.Options | (js.Function1[/* text */ String, String])
  ] = js.undefined
  ...
  var minifyURLs: js.UndefOr[
    Boolean | typingsSlinky.relateurl.relateurlMod.Options | (js.Function1[/* text */ String, String])
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    customAttrAssign: js.Array[js.RegExp] = null,
    customAttrCollapse: js.RegExp = null,
    customAttrSurround: js.Array[js.RegExp] = null,
    customEventAttributes: js.Array[js.RegExp] = null,
    decodeEntities: js.UndefOr[Boolean] = js.undefined,
    html5: js.UndefOr[Boolean] = js.undefined,
    ignoreCustomComments: js.Array[js.RegExp] = null,
    ignoreCustomFragments: js.Array[js.RegExp] = null,
    ...
    minifyCSS: Boolean | typingsSlinky.cleanDashCss.cleanDashCssMod.Options | (js.Function1[/* text */ String, String]) = null,
    minifyJS: Boolean | MinifyOptions | (js.Function2[/* text */ String, /* inline */ Boolean, String]) = null,
    minifyURLs: Boolean | typingsSlinky.relateurl.relateurlMod.Options | (js.Function1[/* text */ String, String]) = null,
    ...
    if (!js.isUndefined(collapseBooleanAttributes)) __obj.updateDynamic("collapseBooleanAttributes")(collapseBooleanAttributes.asInstanceOf[js.Any])
    if (!js.isUndefined(collapseInlineTagWhitespace)) __obj.updateDynamic("collapseInlineTagWhitespace")(collapseInlineTagWhitespace.asInstanceOf[js.Any])
    if (!js.isUndefined(collapseWhitespace)) __obj.updateDynamic("collapseWhitespace")(collapseWhitespace.asInstanceOf[js.Any])
    if (!js.isUndefined(conservativeCollapse)) __obj.updateDynamic("conservativeCollapse")(conservativeCollapse.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(includeAutoGeneratedTags)) __obj.updateDynamic("includeAutoGeneratedTags")(includeAutoGeneratedTags.asInstanceOf[js.Any])
    if (!js.isUndefined(keepClosingSlash)) __obj.updateDynamic("keepClosingSlash")(keepClosingSlash.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(preventAttributesEscaping)) __obj.updateDynamic("preventAttributesEscaping")(preventAttributesEscaping.asInstanceOf[js.Any])
    if (!js.isUndefined(processConditionalComments)) __obj.updateDynamic("processConditionalComments")(processConditionalComments.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(removeEmptyElements)) __obj.updateDynamic("removeEmptyElements")(removeEmptyElements.asInstanceOf[js.Any])
    if (!js.isUndefined(removeOptionalTags)) __obj.updateDynamic("removeOptionalTags")(removeOptionalTags.asInstanceOf[js.Any])
    if (!js.isUndefined(removeRedundantAttributes)) __obj.updateDynamic("removeRedundantAttributes")(removeRedundantAttributes.asInstanceOf[js.Any])
    if (!js.isUndefined(removeScriptTypeAttributes)) __obj.updateDynamic("removeScriptTypeAttributes")(removeScriptTypeAttributes.asInstanceOf[js.Any])
    if (!js.isUndefined(removeStyleLinkTypeAttributes)) __obj.updateDynamic("removeStyleLinkTypeAttributes")(removeStyleLinkTypeAttributes.asInstanceOf[js.Any])
    if (!js.isUndefined(removeTagWhitespace)) __obj.updateDynamic("removeTagWhitespace")(removeTagWhitespace.asInstanceOf[js.Any])
    if (!js.isUndefined(sortAttributes)) __obj.updateDynamic("sortAttributes")(sortAttributes.asInstanceOf[js.Any])
    if (!js.isUndefined(sortClassName)) __obj.updateDynamic("sortClassName")(sortClassName.asInstanceOf[js.Any])
    if (!js.isUndefined(trimCustomFragments)) __obj.updateDynamic("trimCustomFragments")(trimCustomFragments.asInstanceOf[js.Any])
    if (!js.isUndefined(useShortDoctype)) __obj.updateDynamic("useShortDoctype")(useShortDoctype.asInstanceOf[js.Any])
