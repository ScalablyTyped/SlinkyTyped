...
package object mod {
  ...
  /* static member */
  @scala.inline
  def isSupported(): scala.Boolean = typingsSlinky.hlsJs.mod.^.asInstanceOf[js.Dynamic].applyDynamic("isSupported")().asInstanceOf[scala.Boolean]
  ...
  /* static member */
  @scala.inline
  def version: java.lang.String = typingsSlinky.hlsJs.mod.^.asInstanceOf[js.Dynamic].selectDynamic("version").asInstanceOf[java.lang.String]
  @scala.inline
  def version_=(x: java.lang.String): scala.Unit = typingsSlinky.hlsJs.mod.^.asInstanceOf[js.Dynamic].updateDynamic("version")(x.asInstanceOf[js.Any])
}
