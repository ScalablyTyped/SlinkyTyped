...
object AnonApiKey {
  ...
  implicit class AnonApiKeyOps[Self <: AnonApiKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIncludeUnverified(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeUnverified")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIncludeUnverified: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeUnverified")(js.undefined)
        ret
    }
    @scala.inline
