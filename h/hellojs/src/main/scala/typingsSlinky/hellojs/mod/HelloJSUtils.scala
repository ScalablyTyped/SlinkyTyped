...
import typingsSlinky.hellojs.AnonCode
...
trait HelloJSUtils extends js.Object {
  ...
  def error(code: Double, message: String): AnonCode = js.native
  ...
  def popup(url: String): Window_ | js.Any = js.native
  def popup(url: String, redirectUri: String): Window_ | js.Any = js.native
  def popup(url: String, redirectUri: String, options: js.Object): Window_ | js.Any = js.native
  ...
  def responseHandler(window: Window_): Unit = js.native
  def responseHandler(window: Window_, parent: js.Any): Unit = js.native
