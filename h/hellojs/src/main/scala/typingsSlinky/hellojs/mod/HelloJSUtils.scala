...
trait HelloJSUtils extends js.Object {
  ...
  def append(node: String, attr: js.UndefOr[Null | js.Object], target: String): HTMLElement = js.native
  def append(node: String, attr: js.UndefOr[Null | js.Object], target: HTMLElement): HTMLElement = js.native
  def append(node: HTMLElement, attr: js.UndefOr[Null | js.Object], target: String): HTMLElement = js.native
  def append(node: HTMLElement, attr: js.UndefOr[Null | js.Object], target: HTMLElement): HTMLElement = js.native
