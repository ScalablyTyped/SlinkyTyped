...
object mod extends Shortcut {
  ...
  object hapiHapiAugmentingMod {
    ...
    object Request {
      ...
      @scala.inline
      def apply(logger: Logger): typingsSlinky.hapiPino.mod.hapiHapiAugmentingMod.Request = {
        val __obj = js.Dynamic.literal(logger = logger.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.hapiPino.mod.hapiHapiAugmentingMod.Request]
      }
      
      @scala.inline
      implicit class RequestMutableBuilder[Self <: typingsSlinky.hapiPino.mod.hapiHapiAugmentingMod.Request] (val x: Self) extends AnyVal {
