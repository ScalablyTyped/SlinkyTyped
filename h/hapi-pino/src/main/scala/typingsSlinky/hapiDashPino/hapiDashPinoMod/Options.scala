package typingsSlinky.hapiDashPino.hapiDashPinoMod
...
trait Options extends js.Object {
  ...
  {[ key in pino.pino.Level ]:? string}
    */ typingsSlinky.hapiDashPino.hapiDashPinoStrings.Options with js.Any
  ] = js.undefined
}
...
object Options {
  ...
  {[ key in pino.pino.Level ]:? string}
    */ typingsSlinky.hapiDashPino.hapiDashPinoStrings.Options with js.Any = null
  ): Options = {
