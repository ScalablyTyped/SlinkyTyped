...
import typingsSlinky.htmlDashWebpackDashPlugin.htmlDashWebpackDashPluginMod.MinifyOptions
import typingsSlinky.htmlDashWebpackDashPlugin.htmlDashWebpackDashPluginMod.TemplateParametersAssets
...
trait Options
  extends typingsSlinky.htmlDashWebpackDashPlugin.htmlDashWebpackDashPluginMod.Options {
