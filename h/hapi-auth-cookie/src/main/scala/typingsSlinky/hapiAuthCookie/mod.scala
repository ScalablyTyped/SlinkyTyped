...
import typingsSlinky.hapiAuthCookie.anon.RedirectTo
...
object mod extends Shortcut {
  ...
  object hapiAugmentingMod {
    ...
    object Request {
      ...
      @scala.inline
      def apply(cookieAuth: Clear): typingsSlinky.hapiAuthCookie.mod.hapiAugmentingMod.Request = {
        val __obj = js.Dynamic.literal(cookieAuth = cookieAuth.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.hapiAuthCookie.mod.hapiAugmentingMod.Request]
      }
      
      @scala.inline
      implicit class RequestMutableBuilder[Self <: typingsSlinky.hapiAuthCookie.mod.hapiAugmentingMod.Request] (val x: Self) extends AnyVal {
