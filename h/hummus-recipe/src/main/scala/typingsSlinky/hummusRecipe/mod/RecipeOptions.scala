...
import typingsSlinky.hummusRecipe.hummusRecipeStrings.cmyk
import typingsSlinky.hummusRecipe.hummusRecipeStrings.grey
import typingsSlinky.hummusRecipe.hummusRecipeStrings.rgb
