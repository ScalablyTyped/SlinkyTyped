...
class ObjectLayer protected ()
  ...
  def this(provider: typingsSlinky.heredatalens.H.datalens.Provider, options: Options) = this()
  def this(provider: typingsSlinky.heredatalens.H.datalens.QueryProvider, options: Options) = this()
