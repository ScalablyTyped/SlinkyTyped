...
import typingsSlinky.heremaps.H.clustering.DataPoint
import typingsSlinky.heremaps.H.clustering.Provider.ClusteringOptions
...
object ObjectLayer {
  ...
  object ObjectStyleOptions {
    ...
    implicit class ObjectStyleOptionsMutableBuilder[Self <: ObjectStyleOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArrows(value: typingsSlinky.heremaps.H.map.ArrowStyle.Options): Self = StObject.set(x, "arrows", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStyle(value: typingsSlinky.heremaps.H.map.SpatialStyle.Options): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
