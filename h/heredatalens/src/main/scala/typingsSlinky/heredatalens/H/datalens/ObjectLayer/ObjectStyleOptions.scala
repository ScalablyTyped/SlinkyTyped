...
object ObjectStyleOptions {
  ...
  implicit class ObjectStyleOptionsOps[Self <: ObjectStyleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrows(value: typingsSlinky.heremaps.H.map.ArrowStyle.Options): Self = this.set("arrows", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteArrows: Self = this.set("arrows", js.undefined)
    @scala.inline
    def setStyle(value: typingsSlinky.heremaps.H.map.SpatialStyle.Options): Self = this.set("style", value.asInstanceOf[js.Any])
    @scala.inline
