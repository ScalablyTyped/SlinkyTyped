...
trait ObjectStyleOptions extends js.Object {
  ...
  var arrows: js.UndefOr[typingsSlinky.heremaps.H.map.ArrowStyle.Options] = js.undefined
  /** Marker icon */
  var icon: Icon
  /** Spatial style */
  var style: js.UndefOr[typingsSlinky.heremaps.H.map.SpatialStyle.Options] = js.undefined
...
object ObjectStyleOptions {
  ...
  def apply(
    icon: Icon,
    arrows: typingsSlinky.heremaps.H.map.ArrowStyle.Options = null,
    style: typingsSlinky.heremaps.H.map.SpatialStyle.Options = null,
