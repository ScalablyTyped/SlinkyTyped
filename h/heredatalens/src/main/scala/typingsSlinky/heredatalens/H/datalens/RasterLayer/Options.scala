...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBuffer(value: /* zoom */ Zoom => Double): Self = {
    ...
    @scala.inline
    def withRenderTile(value: (/* points */ js.Array[TilePoint], /* canvas */ HTMLCanvasElement, /* zoom */ Zoom) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renderTile")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withoutRenderTile: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renderTile")(js.undefined)
        ret
    }
    @scala.inline
    def withRowToTilePoint(value: (/* row */ Row, /* x */ X, /* y */ Y) => TilePoint): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowToTilePoint")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withoutRowToTilePoint: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowToTilePoint")(js.undefined)
        ret
    }
  }
