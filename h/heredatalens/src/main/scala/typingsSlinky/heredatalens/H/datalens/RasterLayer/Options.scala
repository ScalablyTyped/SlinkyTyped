...
object Options {
  ...
  def apply(
    ...
    dataToRows: (/* data */ Data, /* x */ typingsSlinky.heredatalens.H.datalens.QueryTileProvider.X, /* y */ typingsSlinky.heredatalens.H.datalens.QueryTileProvider.Y, /* zoom */ Zoom) => js.Array[Row] = null,
