...
object Clustering {
  ...
  implicit class ClusteringOps[Self <: Clustering] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOptions(value: Zoom => ClusteringOptions): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("options")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRowToDataPoint(value: Row => DataPoint): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rowToDataPoint")(js.Any.fromFunction1(value))
        ret
    }
  }
