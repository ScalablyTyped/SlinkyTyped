package typingsSlinky.hellosignEmbedded.mod

import typingsSlinky.hellosignEmbedded.mod.HelloSign.ClassNames
import typingsSlinky.hellosignEmbedded.mod.HelloSign.Events
import typingsSlinky.hellosignEmbedded.mod.HelloSign.Locales
import typingsSlinky.hellosignEmbedded.mod.HelloSign.Messages
import typingsSlinky.hellosignEmbedded.mod.HelloSign.Options
...
@js.native
class default ()
  extends typingsSlinky.hellosignEmbedded.mod.HelloSign.HelloSign {
