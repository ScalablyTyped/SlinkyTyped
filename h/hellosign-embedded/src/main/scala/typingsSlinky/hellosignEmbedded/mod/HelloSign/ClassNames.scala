...
import typingsSlinky.hellosignEmbedded.hellosignEmbeddedStrings.`x-hellosign-embedded--in-modal`
import typingsSlinky.hellosignEmbedded.hellosignEmbeddedStrings.`x-hellosign-embedded__iframe`
import typingsSlinky.hellosignEmbedded.hellosignEmbeddedStrings.`x-hellosign-embedded__modal-close-button`
import typingsSlinky.hellosignEmbedded.hellosignEmbeddedStrings.`x-hellosign-embedded__modal-close`
import typingsSlinky.hellosignEmbedded.hellosignEmbeddedStrings.`x-hellosign-embedded__modal-content`
import typingsSlinky.hellosignEmbedded.hellosignEmbeddedStrings.`x-hellosign-embedded__modal-screen`
import typingsSlinky.hellosignEmbedded.hellosignEmbeddedStrings.`x-hellosign-embedded`
