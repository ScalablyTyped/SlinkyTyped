...
import typingsSlinky.hellosignDashEmbedded.Anon_Ccemailaddresses
import typingsSlinky.hellosignDashEmbedded.Anon_Ccroles
import typingsSlinky.hellosignDashEmbedded.hellosignDashEmbeddedStrings.error
import typingsSlinky.hellosignDashEmbedded.hellosignDashEmbeddedStrings.signature_request_canceled
import typingsSlinky.hellosignDashEmbedded.hellosignDashEmbeddedStrings.signature_request_declined
import typingsSlinky.hellosignDashEmbedded.hellosignDashEmbeddedStrings.signature_request_sent
import typingsSlinky.hellosignDashEmbedded.hellosignDashEmbeddedStrings.signature_request_signed
