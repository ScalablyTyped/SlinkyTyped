...
object BlockStatement {
  ...
  def apply(
    ...
    path: PathExpression,
    program: Program,
    `type`: typingsSlinky.handlebars.handlebarsStrings.BlockStatement
  ): BlockStatement = {
  ...
  implicit class BlockStatementMutableBuilder[Self <: BlockStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.handlebars.handlebarsStrings.BlockStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
