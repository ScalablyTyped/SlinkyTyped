...
object PartialBlockStatement {
  ...
  def apply(
    ...
    program: Program,
    `type`: typingsSlinky.handlebars.handlebarsStrings.PartialBlockStatement
  ...
  implicit class PartialBlockStatementMutableBuilder[Self <: PartialBlockStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.handlebars.handlebarsStrings.PartialBlockStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
