...
object PartialStatement {
  ...
  def apply(
    ...
    strip: StripFlags,
    `type`: typingsSlinky.handlebars.handlebarsStrings.PartialStatement
  ): PartialStatement = {
  ...
  implicit class PartialStatementMutableBuilder[Self <: PartialStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.handlebars.handlebarsStrings.PartialStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
