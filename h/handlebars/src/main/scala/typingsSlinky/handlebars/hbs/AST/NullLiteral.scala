...
trait NullLiteral extends Node {
  ...
  @JSName("type")
  var type_NullLiteral: typingsSlinky.handlebars.handlebarsStrings.NullLiteral = js.native
}
object NullLiteral {
  ...
  implicit class NullLiteralMutableBuilder[Self <: NullLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.handlebars.handlebarsStrings.NullLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
