...
import typingsSlinky.httpDashStatus.httpDashStatusMod.HttpStatusCloudfare
import typingsSlinky.httpDashStatus.httpDashStatusMod.HttpStatusIis
import typingsSlinky.httpDashStatus.httpDashStatusMod.HttpStatusNginx
import typingsSlinky.httpDashStatus.httpDashStatusMod.HttpStatusUnofficial
