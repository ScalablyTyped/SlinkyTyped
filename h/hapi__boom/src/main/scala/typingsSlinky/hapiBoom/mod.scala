package typingsSlinky.hapiBoom
...
object mod {
  ...
  @js.native
  def boomify[Data, Decoration](err: js.Error): Boom[Data] with Decoration = js.native
  @JSImport("@hapi/boom", "boomify")
  @js.native
  def boomify[Data, Decoration](err: js.Error, options: Options[Data] with Decorate[Decoration]): Boom[Data] with Decoration = js.native
  ...
  @js.native
  def isBoom(err: js.Error): /* is @hapi/boom.@hapi/boom.Boom<any> */ Boolean = js.native
  @JSImport("@hapi/boom", "isBoom")
  @js.native
  def isBoom(err: js.Error, statusCode: Double): /* is @hapi/boom.@hapi/boom.Boom<any> */ Boolean = js.native
