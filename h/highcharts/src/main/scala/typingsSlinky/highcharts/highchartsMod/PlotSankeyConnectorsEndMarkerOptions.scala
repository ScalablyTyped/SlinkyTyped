...
trait PlotSankeyConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotSankeyConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSankeyConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSankeyConnectorsEndMarkerOptions]
  }
}
