...
trait SeriesLineDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesLineDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesLineDataMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[SeriesLineDataMarkerStatesSelectOptions]
  }
}
