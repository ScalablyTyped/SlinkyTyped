...
trait PlotSplineMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotSplineMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSplineMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSplineMarkerStatesHoverOptions]
  }
}
