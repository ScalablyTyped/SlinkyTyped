...
trait PlotPyramid3dDataGroupingOptions extends js.Object {
  /**
...
object PlotPyramid3dDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramid3dDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dDataGroupingOptions]
  }
}
