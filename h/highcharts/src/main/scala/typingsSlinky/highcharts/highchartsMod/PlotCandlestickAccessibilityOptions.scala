...
trait PlotCandlestickAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotCandlestickAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotCandlestickAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotCandlestickAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotCandlestickAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotCandlestickAccessibilityOptions]
  }
}
