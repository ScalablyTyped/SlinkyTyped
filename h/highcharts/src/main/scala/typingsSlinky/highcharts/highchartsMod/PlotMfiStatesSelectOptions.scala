...
trait PlotMfiStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotMfiStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMfiStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotMfiStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotMfiStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotMfiStatesSelectOptions]
  }
}
