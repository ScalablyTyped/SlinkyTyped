...
trait PlotColumnrangeDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotColumnrangeDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotColumnrangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotColumnrangeDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotColumnrangeDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotColumnrangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotColumnrangeDragDropOptions]
  }
}
