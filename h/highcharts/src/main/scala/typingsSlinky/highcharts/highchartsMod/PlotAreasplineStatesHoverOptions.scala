...
trait PlotAreasplineStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAreasplineStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreasplineStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotAreasplineStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreasplineStatesHoverAnimationOptions = null,
  ...
  ): PlotAreasplineStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesHoverOptions]
  }
}
