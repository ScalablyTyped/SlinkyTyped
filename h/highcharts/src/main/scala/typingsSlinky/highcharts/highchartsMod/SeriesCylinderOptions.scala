...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, treemap, `type`, xAxis, yAxis */ trait SeriesCylinderOptions
  extends PlotCylinderOptions
...
object SeriesCylinderOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesCylinderOptions]
  }
}
