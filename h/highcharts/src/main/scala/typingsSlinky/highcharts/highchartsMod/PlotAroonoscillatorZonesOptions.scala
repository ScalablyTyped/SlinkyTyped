...
trait PlotAroonoscillatorZonesOptions extends js.Object {
  /**
...
object PlotAroonoscillatorZonesOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorZonesOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorZonesOptions]
  }
}
