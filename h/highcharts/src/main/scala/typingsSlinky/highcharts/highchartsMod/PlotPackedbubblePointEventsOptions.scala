...
trait PlotPackedbubblePointEventsOptions extends js.Object {
  /**
...
object PlotPackedbubblePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPackedbubblePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubblePointEventsOptions]
  }
}
