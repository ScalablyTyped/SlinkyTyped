...
trait PlotLinearregressionConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotLinearregressionConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLinearregressionConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotLinearregressionConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotLinearregressionConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotLinearregressionConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotLinearregressionConnectorsMarkerOptions = null,
    startMarker: PlotLinearregressionConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotLinearregressionConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionConnectorsOptions]
  }
}
