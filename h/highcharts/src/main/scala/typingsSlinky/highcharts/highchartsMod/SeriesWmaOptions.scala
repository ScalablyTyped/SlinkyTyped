...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesWmaOptions
  extends PlotWmaOptions
...
object SeriesWmaOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesWmaOptions]
  }
}
