...
trait SeriesPyramidDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesPyramidDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesPyramidDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesPyramidDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesPyramidDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesPyramidDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesPyramidDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesPyramidDataDragDropOptions]
  }
}
