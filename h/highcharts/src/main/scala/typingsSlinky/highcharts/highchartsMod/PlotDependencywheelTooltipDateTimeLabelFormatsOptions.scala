...
trait PlotDependencywheelTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotDependencywheelTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotDependencywheelTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelTooltipDateTimeLabelFormatsOptions]
  }
}
