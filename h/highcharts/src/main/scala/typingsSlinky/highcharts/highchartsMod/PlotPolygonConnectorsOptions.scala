...
trait PlotPolygonConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPolygonConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPolygonConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPolygonConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPolygonConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPolygonConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPolygonConnectorsMarkerOptions = null,
    startMarker: PlotPolygonConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotPolygonConnectorsOptions]
  }
}
