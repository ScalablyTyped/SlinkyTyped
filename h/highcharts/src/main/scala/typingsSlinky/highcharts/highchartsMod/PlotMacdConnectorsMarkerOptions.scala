...
trait PlotMacdConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotMacdConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMacdConnectorsMarkerOptions]
  }
}
