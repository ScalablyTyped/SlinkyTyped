...
trait YAxisPlotBandsOptions extends AxisPlotBandsOptions {
  /**
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[YAxisPlotBandsEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[YAxisPlotBandsLabelOptions] = js.undefined
  /**
...
object YAxisPlotBandsOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[YAxisPlotBandsOptions]
  }
}
