...
trait PlotErrorbarDataGroupingOptions extends js.Object {
  /**
...
object PlotErrorbarDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotErrorbarDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarDataGroupingOptions]
  }
}
