...
trait PlotZigzagPointEventsOptions extends js.Object {
  /**
...
object PlotZigzagPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotZigzagPointEventsOptions]
  }
}
