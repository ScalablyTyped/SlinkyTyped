...
object PlotMapPointOptions {
  @scala.inline
  def apply(events: PlotMapPointEventsOptions = null): PlotMapPointOptions = {
    val __obj = js.Dynamic.literal()
    if (events != null) __obj.updateDynamic("events")(events.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlotMapPointOptions]
  }
}
...
trait PlotMappointOptions extends js.Object {
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotMappointJitterOptions] = js.undefined
  /**
