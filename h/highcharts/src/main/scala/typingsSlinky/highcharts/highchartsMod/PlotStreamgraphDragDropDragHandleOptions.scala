...
trait PlotStreamgraphDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotStreamgraphDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphDragDropDragHandleOptions]
  }
}
