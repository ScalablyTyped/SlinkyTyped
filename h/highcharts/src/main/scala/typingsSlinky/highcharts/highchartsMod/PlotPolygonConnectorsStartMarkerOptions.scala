...
trait PlotPolygonConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPolygonConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPolygonConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonConnectorsStartMarkerOptions]
  }
}
