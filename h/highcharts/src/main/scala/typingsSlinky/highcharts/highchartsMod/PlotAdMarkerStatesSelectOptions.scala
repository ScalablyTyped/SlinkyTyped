...
trait PlotAdMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAdMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAdMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAdMarkerStatesSelectOptions]
  }
}
