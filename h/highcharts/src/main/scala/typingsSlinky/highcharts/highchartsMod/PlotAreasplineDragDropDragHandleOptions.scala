...
trait PlotAreasplineDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAreasplineDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineDragDropDragHandleOptions]
  }
}
