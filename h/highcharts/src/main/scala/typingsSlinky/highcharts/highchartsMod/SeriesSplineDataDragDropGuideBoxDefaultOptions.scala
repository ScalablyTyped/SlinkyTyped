...
trait SeriesSplineDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesSplineDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesSplineDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesSplineDataDragDropGuideBoxDefaultOptions]
  }
}
