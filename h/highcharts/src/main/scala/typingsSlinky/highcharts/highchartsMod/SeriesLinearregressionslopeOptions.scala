...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesLinearregressionslopeOptions
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | linearregressionslope
  /**
...
object SeriesLinearregressionslopeOptions {
  ...
  ): SeriesLinearregressionslopeOptions = {
