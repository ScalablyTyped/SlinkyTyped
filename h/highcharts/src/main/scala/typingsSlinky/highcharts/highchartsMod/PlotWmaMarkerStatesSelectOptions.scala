...
trait PlotWmaMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotWmaMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotWmaMarkerStatesSelectOptions]
  }
}
