...
trait PlotAtrStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAtrStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAtrStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotAtrStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotAtrStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAtrStatesSelectOptions]
  }
}
