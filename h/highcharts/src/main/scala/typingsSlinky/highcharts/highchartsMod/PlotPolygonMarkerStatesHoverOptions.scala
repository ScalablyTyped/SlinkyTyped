...
trait PlotPolygonMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotPolygonMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPolygonMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonMarkerStatesHoverOptions]
  }
}
