...
trait SeriesCandlestickDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesCandlestickDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesCandlestickDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesCandlestickDataDragDropGuideBoxDefaultOptions]
  }
}
