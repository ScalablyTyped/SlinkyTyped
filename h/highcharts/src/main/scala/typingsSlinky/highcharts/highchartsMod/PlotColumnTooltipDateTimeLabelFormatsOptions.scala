...
trait PlotColumnTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotColumnTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotColumnTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotColumnTooltipDateTimeLabelFormatsOptions]
  }
}
