...
trait PlotPpoTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPpoTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotPpoTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotPpoTooltipDateTimeLabelFormatsOptions]
  }
}
