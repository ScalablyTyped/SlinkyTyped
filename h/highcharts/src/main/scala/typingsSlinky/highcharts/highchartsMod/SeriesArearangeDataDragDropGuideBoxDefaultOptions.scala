...
trait SeriesArearangeDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesArearangeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesArearangeDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesArearangeDataDragDropGuideBoxDefaultOptions]
  }
}
