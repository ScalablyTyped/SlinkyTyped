...
trait PlotAroonoscillatorLabelOptions extends js.Object {
  /**
...
object PlotAroonoscillatorLabelOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorLabelOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorLabelOptions]
  }
}
