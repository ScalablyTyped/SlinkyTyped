...
trait SeriesBubbleDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesBubbleDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBubbleDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesBubbleDataDragDropDragHandleOptions]
  }
}
