...
trait PlotFunnel3dPointEventsOptions extends js.Object {
  /**
...
object PlotFunnel3dPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFunnel3dPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotFunnel3dPointEventsOptions]
  }
}
