...
trait PlotTemaMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTemaMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTemaMarkerStatesSelectOptions]
  }
}
