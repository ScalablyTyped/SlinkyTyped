...
trait SeriesAreaDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesAreaDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreaDataMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[SeriesAreaDataMarkerStatesSelectOptions]
  }
}
