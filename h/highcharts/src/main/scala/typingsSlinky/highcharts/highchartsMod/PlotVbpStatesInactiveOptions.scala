...
trait PlotVbpStatesInactiveOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVbpStatesInactiveAnimationOptions] = js.undefined
  /**
...
object PlotVbpStatesInactiveOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVbpStatesInactiveAnimationOptions = null,
    opacity: Int | Double = null
  ): PlotVbpStatesInactiveOptions = {
