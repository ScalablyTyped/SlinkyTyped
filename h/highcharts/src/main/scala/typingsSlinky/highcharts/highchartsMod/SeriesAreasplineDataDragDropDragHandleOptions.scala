...
trait SeriesAreasplineDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesAreasplineDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreasplineDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesAreasplineDataDragDropDragHandleOptions]
  }
}
