...
trait PlotAdTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAdTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotAdTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotAdTooltipDateTimeLabelFormatsOptions]
  }
}
