...
trait PlotNetworkgraphZonesOptions extends js.Object {
  /**
...
object PlotNetworkgraphZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotNetworkgraphZonesOptions]
  }
}
