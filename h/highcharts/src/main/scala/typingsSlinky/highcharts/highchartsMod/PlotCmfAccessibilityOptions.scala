...
trait PlotCmfAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotCmfAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotCmfAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotCmfAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotCmfAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotCmfAccessibilityOptions]
  }
}
