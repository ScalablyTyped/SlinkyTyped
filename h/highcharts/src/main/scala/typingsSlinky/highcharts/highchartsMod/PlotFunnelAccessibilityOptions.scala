...
trait PlotFunnelAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotFunnelAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotFunnelAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotFunnelAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotFunnelAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelAccessibilityOptions]
  }
}
