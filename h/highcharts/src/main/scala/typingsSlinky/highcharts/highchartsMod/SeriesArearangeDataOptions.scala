...
trait SeriesArearangeDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesArearangeDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesArearangeDataDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesArearangeDataEventsOptions] = js.undefined
  /**
...
object SeriesArearangeDataOptions {
  @scala.inline
  def apply(
    accessibility: SeriesArearangeDataAccessibilityOptions = null,
    ...
    dragDrop: SeriesArearangeDataDragDropOptions = null,
    drilldown: String = null,
    events: SeriesArearangeDataEventsOptions = null,
    ...
    __obj.asInstanceOf[SeriesArearangeDataOptions]
  }
}
