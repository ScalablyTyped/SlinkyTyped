...
trait PlotPivotpointsConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPivotpointsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsConnectorsEndMarkerOptions]
  }
}
