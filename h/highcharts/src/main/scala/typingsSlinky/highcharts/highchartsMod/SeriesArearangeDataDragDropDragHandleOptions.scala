...
trait SeriesArearangeDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesArearangeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesArearangeDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesArearangeDataDragDropDragHandleOptions]
  }
}
