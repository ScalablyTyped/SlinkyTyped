...
trait PlotWaterfallLabelOptions extends js.Object {
  /**
...
object PlotWaterfallLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWaterfallLabelOptions]
  }
}
