...
trait PlotErrorbarTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotErrorbarTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotErrorbarTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarTooltipDateTimeLabelFormatsOptions]
  }
}
