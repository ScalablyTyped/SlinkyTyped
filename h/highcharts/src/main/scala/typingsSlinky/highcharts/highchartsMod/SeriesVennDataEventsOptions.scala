...
trait SeriesVennDataEventsOptions extends js.Object {
  /**
...
object SeriesVennDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesVennDataEventsOptions]
  }
}
