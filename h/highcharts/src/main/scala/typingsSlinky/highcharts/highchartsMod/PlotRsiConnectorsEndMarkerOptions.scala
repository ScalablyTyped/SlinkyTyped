...
trait PlotRsiConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotRsiConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRsiConnectorsEndMarkerOptions]
  }
}
