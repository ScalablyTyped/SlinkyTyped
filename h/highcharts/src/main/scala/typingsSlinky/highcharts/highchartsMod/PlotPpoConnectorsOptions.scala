...
trait PlotPpoConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPpoConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPpoConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPpoConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPpoConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPpoConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPpoConnectorsMarkerOptions = null,
    startMarker: PlotPpoConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotPpoConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotPpoConnectorsOptions]
  }
}
