...
trait PlotColumnpyramidDataGroupingOptions extends js.Object {
  /**
...
object PlotColumnpyramidDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnpyramidDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidDataGroupingOptions]
  }
}
