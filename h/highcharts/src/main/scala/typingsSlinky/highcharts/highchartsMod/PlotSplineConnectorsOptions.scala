...
trait PlotSplineConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSplineConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSplineConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSplineConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotSplineConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotSplineConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotSplineConnectorsMarkerOptions = null,
    startMarker: PlotSplineConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotSplineConnectorsOptions]
  }
}
