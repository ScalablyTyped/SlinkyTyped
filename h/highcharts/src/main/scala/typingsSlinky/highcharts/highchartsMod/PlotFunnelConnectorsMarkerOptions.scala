...
trait PlotFunnelConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotFunnelConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFunnelConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelConnectorsMarkerOptions]
  }
}
