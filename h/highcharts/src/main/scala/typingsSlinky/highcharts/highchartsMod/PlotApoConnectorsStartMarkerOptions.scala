...
trait PlotApoConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotApoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotApoConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotApoConnectorsStartMarkerOptions]
  }
}
