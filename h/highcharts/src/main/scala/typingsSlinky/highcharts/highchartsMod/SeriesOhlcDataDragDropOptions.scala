...
trait SeriesOhlcDataDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesOhlcDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesOhlcDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesOhlcDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesOhlcDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesOhlcDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesOhlcDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesOhlcDataDragDropOptions]
  }
}
