...
trait PlotScatterConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotScatterConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatterConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatterConnectorsMarkerOptions]
  }
}
