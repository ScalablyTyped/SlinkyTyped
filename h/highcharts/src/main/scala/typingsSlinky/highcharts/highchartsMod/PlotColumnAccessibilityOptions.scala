...
trait PlotColumnAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotColumnAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotColumnAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotColumnAccessibilityKeyboardNavigationOptions = null,
    ...
    __obj.asInstanceOf[PlotColumnAccessibilityOptions]
  }
}
