...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesRsiOptions
  extends PlotRsiOptions
...
object SeriesRsiOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesRsiOptions]
  }
}
