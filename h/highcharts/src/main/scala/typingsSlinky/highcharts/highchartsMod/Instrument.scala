...
trait Instrument extends js.Object {
  /**
    ...
    */
  def copy(): typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Instrument = js.native
  def copy(options: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.InstrumentOptionsObject): typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Instrument = js.native
  /**
  ...
  /**
    ...
    */
  def play(options: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.InstrumentPlayOptionsObject): Unit = js.native
  /**
