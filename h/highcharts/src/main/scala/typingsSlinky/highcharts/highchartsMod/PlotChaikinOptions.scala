...
trait PlotChaikinOptions extends js.Object {
  /**
    * (Highstock) Accessibility options for a series. Requires the
    * accessibility module.
    */
  var accessibility: js.UndefOr[js.Object | PlotChaikinAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotChaikinAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotChaikinConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotChaikinDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotChaikinEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotChaikinLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotChaikinLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotChaikinLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotChaikinMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    * points.
    */
  var params: js.UndefOr[PlotChaikinParamsOptions] = js.undefined
  /**
    * (Highstock) Properties for each single point.
    */
  var point: js.UndefOr[PlotChaikinPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotChaikinStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotChaikinTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotChaikinZonesOptions]] = js.undefined
}

object PlotChaikinOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotChaikinOptions]
  }
}
