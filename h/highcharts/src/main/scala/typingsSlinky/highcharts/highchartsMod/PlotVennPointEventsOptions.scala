...
trait PlotVennPointEventsOptions extends js.Object {
  /**
...
object PlotVennPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotVennPointEventsOptions]
  }
}
