...
trait PlotStreamgraphMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotStreamgraphMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphMarkerStatesHoverOptions]
  }
}
