...
trait PlotColumnpyramidConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotColumnpyramidConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnpyramidConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidConnectorsEndMarkerOptions]
  }
}
