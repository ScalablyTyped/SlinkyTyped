...
trait PlotScatterStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotScatterStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotScatterStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotScatterStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotScatterStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotScatterStatesHoverOptions]
  }
}
