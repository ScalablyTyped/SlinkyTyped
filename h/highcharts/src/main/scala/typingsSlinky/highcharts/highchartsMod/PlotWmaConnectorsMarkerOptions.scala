...
trait PlotWmaConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotWmaConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWmaConnectorsMarkerOptions]
  }
}
