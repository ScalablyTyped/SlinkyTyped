...
trait PlotMappointDragDropOptions extends js.Object {
  /**
    * (Highmaps) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotMappointDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotMappointDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotMappointDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotMappointDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotMappointDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotMappointDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotMappointDragDropOptions]
  }
}
