...
trait PlotHeatmapConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotHeatmapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHeatmapConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapConnectorsStartMarkerOptions]
  }
}
