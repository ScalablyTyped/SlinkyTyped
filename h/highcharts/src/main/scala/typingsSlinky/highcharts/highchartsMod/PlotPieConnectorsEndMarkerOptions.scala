...
trait PlotPieConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPieConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPieConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPieConnectorsEndMarkerOptions]
  }
}
