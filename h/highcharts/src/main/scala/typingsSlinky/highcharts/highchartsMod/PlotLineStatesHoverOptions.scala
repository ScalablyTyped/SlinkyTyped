...
trait PlotLineStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotLineStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLineStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotLineStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLineStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotLineStatesHoverOptions]
  }
}
