...
trait PlotGaugeDataGroupingOptions extends js.Object {
  /**
...
object PlotGaugeDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotGaugeDataGroupingOptions]
  }
}
