...
trait PlotSankeyConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSankeyConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSankeyConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSankeyConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotSankeyConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotSankeyConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotSankeyConnectorsMarkerOptions = null,
    startMarker: PlotSankeyConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotSankeyConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotSankeyConnectorsOptions]
  }
}
