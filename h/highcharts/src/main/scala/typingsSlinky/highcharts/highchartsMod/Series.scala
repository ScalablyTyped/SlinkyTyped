...
class Series protected () extends js.Object {
  /**
    ...
    *        The series options.
    */
  def this(chart: Chart, options: js.Object) = this()
  def this(chart: Chart, options: SeriesOptionsType) = this()
  /**
  ...
  /**
    ...
    */
  def sonify(options: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.SonifySeriesOptionsObject): Unit = js.native
  /**
