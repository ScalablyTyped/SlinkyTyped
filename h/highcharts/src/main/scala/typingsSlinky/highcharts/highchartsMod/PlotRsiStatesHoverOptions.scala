...
trait PlotRsiStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotRsiStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotRsiStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotRsiStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRsiStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotRsiStatesHoverOptions]
  }
}
