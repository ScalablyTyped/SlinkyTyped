...
trait PlotWaterfallStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotWaterfallStatesSelectAnimationOptions] = js.undefined
  /**
...
object PlotWaterfallStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotWaterfallStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined
  ): PlotWaterfallStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotWaterfallStatesSelectOptions]
  }
}
