...
trait PlotParetoMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotParetoMarkerStatesOptions] = js.undefined
  /**
...
object PlotParetoMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotParetoMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotParetoMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotParetoMarkerOptions]
  }
}
