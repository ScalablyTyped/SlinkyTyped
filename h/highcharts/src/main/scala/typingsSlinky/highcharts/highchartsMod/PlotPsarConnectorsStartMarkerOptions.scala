...
trait PlotPsarConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPsarConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPsarConnectorsStartMarkerOptions]
  }
}
