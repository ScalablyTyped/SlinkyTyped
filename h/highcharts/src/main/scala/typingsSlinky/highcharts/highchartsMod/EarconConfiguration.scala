...
trait EarconConfiguration extends js.Object {
  ...
  /**
    * An Earcon instance.
    */
  var earcon: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Earcon
  /**
...
object EarconConfiguration {
  @scala.inline
  def apply(
    earcon: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Earcon,
