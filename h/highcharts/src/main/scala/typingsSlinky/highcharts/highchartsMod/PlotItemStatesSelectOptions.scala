...
trait PlotItemStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotItemStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotItemStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotItemStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotItemStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotItemStatesSelectOptions]
  }
}
