...
trait PlotMapbubbleDragDropOptions extends js.Object {
  /**
    * (Highmaps) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotMapbubbleDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotMapbubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotMapbubbleDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotMapbubbleDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotMapbubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotMapbubbleDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleDragDropOptions]
  }
}
