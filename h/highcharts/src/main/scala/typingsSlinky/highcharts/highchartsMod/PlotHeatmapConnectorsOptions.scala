...
trait PlotHeatmapConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotHeatmapConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotHeatmapConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotHeatmapConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotHeatmapConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotHeatmapConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotHeatmapConnectorsMarkerOptions = null,
    startMarker: PlotHeatmapConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotHeatmapConnectorsOptions]
  }
}
