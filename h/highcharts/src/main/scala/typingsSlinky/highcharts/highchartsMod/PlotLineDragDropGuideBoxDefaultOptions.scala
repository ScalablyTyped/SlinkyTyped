...
trait PlotLineDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotLineDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotLineDragDropGuideBoxDefaultOptions]
  }
}
