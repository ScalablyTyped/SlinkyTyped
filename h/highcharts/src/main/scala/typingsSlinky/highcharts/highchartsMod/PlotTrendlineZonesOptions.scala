...
trait PlotTrendlineZonesOptions extends js.Object {
  /**
...
object PlotTrendlineZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTrendlineZonesOptions]
  }
}
