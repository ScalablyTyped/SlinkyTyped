...
trait PlotBulletConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotBulletConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBulletConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBulletConnectorsStartMarkerOptions]
  }
}
