...
import typingsSlinky.highcharts.highchartsMod._Global_.JQuery
...
object _Global_ extends js.Object {
  ...
  trait JQuery extends js.Object {
    ...
    @JSName("highcharts")
    def highcharts_Chart(className: typingsSlinky.highcharts.highchartsStrings.Chart): JQuery = js.native
    @JSName("highcharts")
    def highcharts_Chart(className: typingsSlinky.highcharts.highchartsStrings.Chart, options: Options): JQuery = js.native
    @JSName("highcharts")
    def highcharts_Chart(
      className: typingsSlinky.highcharts.highchartsStrings.Chart,
      options: Options,
