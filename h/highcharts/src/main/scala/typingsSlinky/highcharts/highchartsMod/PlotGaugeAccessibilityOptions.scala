...
trait PlotGaugeAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotGaugeAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotGaugeAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotGaugeAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotGaugeAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotGaugeAccessibilityOptions]
  }
}
