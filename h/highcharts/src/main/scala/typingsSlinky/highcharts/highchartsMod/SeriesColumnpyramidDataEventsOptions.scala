...
trait SeriesColumnpyramidDataEventsOptions extends js.Object {
  /**
...
object SeriesColumnpyramidDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesColumnpyramidDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesColumnpyramidDataEventsOptions]
  }
}
