...
trait PlotZigzagTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotZigzagTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotZigzagTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagTooltipDateTimeLabelFormatsOptions]
  }
}
