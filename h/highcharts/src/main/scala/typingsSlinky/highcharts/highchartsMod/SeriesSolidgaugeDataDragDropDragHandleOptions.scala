...
trait SeriesSolidgaugeDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesSolidgaugeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesSolidgaugeDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesSolidgaugeDataDragDropDragHandleOptions]
  }
}
