...
trait StockToolsGuiDefinitionsSimpleShapesRectangleOptions extends js.Object {
  /**
...
object StockToolsGuiDefinitionsSimpleShapesRectangleOptions {
  @scala.inline
  def apply(symbol: String = null): StockToolsGuiDefinitionsSimpleShapesRectangleOptions = {
