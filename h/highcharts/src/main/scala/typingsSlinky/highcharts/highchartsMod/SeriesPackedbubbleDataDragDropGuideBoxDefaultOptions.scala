...
trait SeriesPackedbubbleDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesPackedbubbleDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPackedbubbleDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesPackedbubbleDataDragDropGuideBoxDefaultOptions]
  }
}
