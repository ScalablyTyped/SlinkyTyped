...
trait PlotAreasplinerangeStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotAreasplinerangeStatesSelectHaloOptions {
  @scala.inline
  def apply(attributes: SVGAttributes = null, opacity: Int | Double = null, size: Int | Double = null): PlotAreasplinerangeStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    if (attributes != null) __obj.updateDynamic("attributes")(attributes.asInstanceOf[js.Any])
    if (opacity != null) __obj.updateDynamic("opacity")(opacity.asInstanceOf[js.Any])
    if (size != null) __obj.updateDynamic("size")(size.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlotAreasplinerangeStatesSelectHaloOptions]
  }
}
