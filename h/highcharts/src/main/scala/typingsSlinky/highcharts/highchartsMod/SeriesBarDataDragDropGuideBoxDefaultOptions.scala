...
trait SeriesBarDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesBarDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBarDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesBarDataDragDropGuideBoxDefaultOptions]
  }
}
