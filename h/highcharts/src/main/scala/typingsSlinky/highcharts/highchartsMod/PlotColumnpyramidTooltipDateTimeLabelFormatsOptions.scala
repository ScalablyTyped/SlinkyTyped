...
trait PlotColumnpyramidTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotColumnpyramidTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotColumnpyramidTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidTooltipDateTimeLabelFormatsOptions]
  }
}
