...
trait PlotVbpMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotVbpMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVbpMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVbpMarkerStatesHoverOptions]
  }
}
