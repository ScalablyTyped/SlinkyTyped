...
trait PlotDemaAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotDemaAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotDemaAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotDemaAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotDemaAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotDemaAccessibilityOptions]
  }
}
