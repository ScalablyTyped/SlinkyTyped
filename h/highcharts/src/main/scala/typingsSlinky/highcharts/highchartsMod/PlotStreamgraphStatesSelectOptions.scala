...
trait PlotStreamgraphStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotStreamgraphStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotStreamgraphStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotStreamgraphStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotStreamgraphStatesSelectAnimationOptions = null,
  ...
  ): PlotStreamgraphStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphStatesSelectOptions]
  }
}
