...
trait PlotVwapConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotVwapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVwapConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVwapConnectorsStartMarkerOptions]
  }
}
