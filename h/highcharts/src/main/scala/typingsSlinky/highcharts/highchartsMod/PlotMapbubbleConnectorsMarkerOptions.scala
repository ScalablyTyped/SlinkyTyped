...
trait PlotMapbubbleConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotMapbubbleConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleConnectorsMarkerOptions]
  }
}
