...
trait PlotIkhAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotIkhAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotIkhAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotIkhAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotIkhAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotIkhAccessibilityOptions]
  }
}
