...
trait PlotParetoAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotParetoAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotParetoAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotParetoAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotParetoAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotParetoAccessibilityOptions]
  }
}
