...
trait PlotHistogramConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotHistogramConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotHistogramConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotHistogramConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotHistogramConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotHistogramConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotHistogramConnectorsMarkerOptions = null,
    startMarker: PlotHistogramConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotHistogramConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramConnectorsOptions]
  }
}
