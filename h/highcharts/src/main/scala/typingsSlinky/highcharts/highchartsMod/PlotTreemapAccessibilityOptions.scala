...
trait PlotTreemapAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTreemapAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotTreemapAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotTreemapAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotTreemapAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapAccessibilityOptions]
  }
}
