...
trait PlotRocConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotRocConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRocConnectorsEndMarkerOptions]
  }
}
