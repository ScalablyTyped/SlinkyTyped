...
trait PlotTrendlineTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotTrendlineTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotTrendlineTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineTooltipDateTimeLabelFormatsOptions]
  }
}
