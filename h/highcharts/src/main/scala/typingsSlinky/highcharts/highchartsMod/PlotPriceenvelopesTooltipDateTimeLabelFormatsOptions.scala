...
trait PlotPriceenvelopesTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPriceenvelopesTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotPriceenvelopesTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesTooltipDateTimeLabelFormatsOptions]
  }
}
