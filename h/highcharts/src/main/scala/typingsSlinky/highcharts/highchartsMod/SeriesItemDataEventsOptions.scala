...
trait SeriesItemDataEventsOptions extends js.Object {
  /**
...
object SeriesItemDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesItemDataEventsOptions]
  }
}
