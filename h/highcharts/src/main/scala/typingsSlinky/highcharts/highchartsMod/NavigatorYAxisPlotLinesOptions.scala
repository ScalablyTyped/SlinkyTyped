...
trait NavigatorYAxisPlotLinesOptions extends js.Object {
  /**
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[NavigatorYAxisPlotLinesEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[NavigatorYAxisPlotLinesLabelOptions] = js.undefined
  /**
...
object NavigatorYAxisPlotLinesOptions {
  @scala.inline
  def apply(
    ...
    events: NavigatorYAxisPlotLinesEventsOptions = null,
    id: String = null,
    label: NavigatorYAxisPlotLinesLabelOptions = null,
    value: Int | Double = null,
    width: Int | Double = null,
    zIndex: Int | Double = null
  ): NavigatorYAxisPlotLinesOptions = {
    ...
    __obj.asInstanceOf[NavigatorYAxisPlotLinesOptions]
  }
}
