...
trait PlotSplineStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSplineStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSplineStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotSplineStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSplineStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotSplineStatesHoverOptions]
  }
}
