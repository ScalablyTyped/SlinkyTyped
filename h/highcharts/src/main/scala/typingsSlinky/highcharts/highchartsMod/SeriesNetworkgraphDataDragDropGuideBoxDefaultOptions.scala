...
trait SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions]
  }
}
