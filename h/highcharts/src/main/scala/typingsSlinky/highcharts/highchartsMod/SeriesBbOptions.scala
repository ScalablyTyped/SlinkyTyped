...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesBbOptions
  extends PlotBbOptions
...
object SeriesBbOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesBbOptions]
  }
}
