...
trait PlotNetworkgraphPointEventsOptions extends js.Object {
  /**
...
object PlotNetworkgraphPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNetworkgraphPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphPointEventsOptions]
  }
}
