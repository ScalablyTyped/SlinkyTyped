...
trait SeriesVectorDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesVectorDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesVectorDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesVectorDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesVectorDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesVectorDataMarkerOptions]
  }
}
