...
trait PlotSolidgaugeConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSolidgaugeConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSolidgaugeConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSolidgaugeConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotSolidgaugeConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotSolidgaugeConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotSolidgaugeConnectorsMarkerOptions = null,
    startMarker: PlotSolidgaugeConnectorsStartMarkerOptions = null,
