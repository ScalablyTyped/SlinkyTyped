...
trait PlotChaikinMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotChaikinMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotChaikinMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinMarkerStatesHoverOptions]
  }
}
