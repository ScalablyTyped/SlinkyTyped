...
trait PlotWordcloudConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotWordcloudConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWordcloudConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudConnectorsMarkerOptions]
  }
}
