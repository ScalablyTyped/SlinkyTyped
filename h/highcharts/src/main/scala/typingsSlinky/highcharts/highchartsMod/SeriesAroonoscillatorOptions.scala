...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesAroonoscillatorOptions
  extends PlotAroonoscillatorOptions
     with SeriesOptionsType {
  /**
    * Not available
    */
  var aroonDown: js.UndefOr[scala.Nothing] = js.undefined
  /**
    * Not available
    */
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | aroonoscillator
  /**
...
object SeriesAroonoscillatorOptions {
  ...
  def apply(
    ...
    aroonDown: js.UndefOr[scala.Nothing] = js.undefined,
    ...
    if (!js.isUndefined(aroonDown)) __obj.updateDynamic("aroonDown")(aroonDown.asInstanceOf[js.Any])
