...
trait PlotLinearregressionangleAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLinearregressionangleAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotLinearregressionangleAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotLinearregressionangleAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotLinearregressionangleAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleAccessibilityOptions]
  }
}
