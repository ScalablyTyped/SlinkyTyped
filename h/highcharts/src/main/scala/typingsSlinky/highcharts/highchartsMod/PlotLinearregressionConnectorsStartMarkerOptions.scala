...
trait PlotLinearregressionConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionConnectorsStartMarkerOptions]
  }
}
