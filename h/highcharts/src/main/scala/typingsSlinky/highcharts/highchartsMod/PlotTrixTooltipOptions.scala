...
trait PlotTrixTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotTrixTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotTrixTooltipOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PlotTrixTooltipOptions]
  }
}
