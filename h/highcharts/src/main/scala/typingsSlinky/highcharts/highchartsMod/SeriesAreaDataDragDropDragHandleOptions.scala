...
trait SeriesAreaDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesAreaDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreaDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesAreaDataDragDropDragHandleOptions]
  }
}
