...
trait PlotFlagsConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotFlagsConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotFlagsConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotFlagsConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotFlagsConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotFlagsConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotFlagsConnectorsMarkerOptions = null,
    startMarker: PlotFlagsConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotFlagsConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotFlagsConnectorsOptions]
  }
}
