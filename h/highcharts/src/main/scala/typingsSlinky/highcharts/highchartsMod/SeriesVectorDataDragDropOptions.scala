...
trait SeriesVectorDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesVectorDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesVectorDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesVectorDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesVectorDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesVectorDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesVectorDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesVectorDataDragDropOptions]
  }
}
