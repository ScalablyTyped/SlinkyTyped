...
trait SeriesColumnpyramidDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesColumnpyramidDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesColumnpyramidDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesColumnpyramidDataDragDropGuideBoxDefaultOptions]
  }
}
