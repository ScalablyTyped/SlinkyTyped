...
trait PlotTimelineConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTimelineConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTimelineConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTimelineConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotTimelineConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotTimelineConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotTimelineConnectorsMarkerOptions = null,
    startMarker: PlotTimelineConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotTimelineConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineConnectorsOptions]
  }
}
