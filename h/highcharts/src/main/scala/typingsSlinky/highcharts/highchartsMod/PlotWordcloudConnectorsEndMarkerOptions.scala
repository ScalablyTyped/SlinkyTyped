...
trait PlotWordcloudConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotWordcloudConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWordcloudConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudConnectorsEndMarkerOptions]
  }
}
