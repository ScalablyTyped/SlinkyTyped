...
trait PlotMomentumPointEventsOptions extends js.Object {
  /**
...
object PlotMomentumPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumPointEventsOptions]
  }
}
