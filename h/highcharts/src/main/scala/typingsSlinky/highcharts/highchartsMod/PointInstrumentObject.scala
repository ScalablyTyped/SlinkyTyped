...
trait PointInstrumentObject extends js.Object {
  /**
    ...
    */
  var instrument: String | typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Instrument
  /**
    * Mapping of instrument parameters for this instrument.
    */
  var instrumentMapping: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentMappingObject
  /**
    * Options for this instrument.
    */
  var instrumentOptions: js.UndefOr[
    typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentOptionsObject
  ] = js.undefined
  /**
...
object PointInstrumentObject {
  @scala.inline
  def apply(
    instrument: String | typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Instrument,
    instrumentMapping: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentMappingObject,
    instrumentOptions: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentOptionsObject = null,
