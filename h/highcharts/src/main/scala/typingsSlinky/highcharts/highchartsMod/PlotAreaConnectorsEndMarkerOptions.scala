...
trait PlotAreaConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAreaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreaConnectorsEndMarkerOptions]
  }
}
