...
trait SeriesGanttDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesGanttDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesGanttDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesGanttDataDragDropDragHandleOptions]
  }
}
