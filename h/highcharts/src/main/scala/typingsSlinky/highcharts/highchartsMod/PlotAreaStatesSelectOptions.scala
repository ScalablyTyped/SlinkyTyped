...
trait PlotAreaStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAreaStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreaStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotAreaStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotAreaStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAreaStatesSelectOptions]
  }
}
