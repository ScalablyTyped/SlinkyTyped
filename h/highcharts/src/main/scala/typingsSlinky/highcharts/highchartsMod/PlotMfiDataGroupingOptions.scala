...
trait PlotMfiDataGroupingOptions extends js.Object {
  /**
...
object PlotMfiDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMfiDataGroupingOptions]
  }
}
