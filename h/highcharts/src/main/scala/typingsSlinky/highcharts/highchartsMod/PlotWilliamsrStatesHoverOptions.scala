...
trait PlotWilliamsrStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWilliamsrStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotWilliamsrStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotWilliamsrStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWilliamsrStatesHoverAnimationOptions = null,
  ...
  ): PlotWilliamsrStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesHoverOptions]
  }
}
