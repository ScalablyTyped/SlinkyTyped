...
trait PlotWaterfallEventsOptions extends js.Object {
  /**
...
object PlotWaterfallEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWaterfallEventsOptions]
  }
}
