...
trait PlotSunburstConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotSunburstConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSunburstConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstConnectorsMarkerOptions]
  }
}
