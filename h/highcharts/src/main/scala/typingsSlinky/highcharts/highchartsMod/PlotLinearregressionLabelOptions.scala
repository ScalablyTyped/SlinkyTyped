...
trait PlotLinearregressionLabelOptions extends js.Object {
  /**
...
object PlotLinearregressionLabelOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionLabelOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionLabelOptions]
  }
}
