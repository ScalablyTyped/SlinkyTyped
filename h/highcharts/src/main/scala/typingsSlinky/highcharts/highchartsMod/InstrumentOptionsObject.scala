...
trait InstrumentOptionsObject extends js.Object {
  ...
  var oscillator: js.UndefOr[
    typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.OscillatorOptionsObject
  ] = js.undefined
  /**
...
object InstrumentOptionsObject {
  ...
  def apply(
    ...
    id: String = null,
    oscillator: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.OscillatorOptionsObject = null,
