...
trait SeriesXrangeDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesXrangeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesXrangeDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesXrangeDataDragDropGuideBoxDefaultOptions]
  }
}
