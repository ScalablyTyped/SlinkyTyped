...
trait SeriesScatter3dDataEventsOptions extends js.Object {
  /**
...
object SeriesScatter3dDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesScatter3dDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesScatter3dDataEventsOptions]
  }
}
