...
trait PlotAreasplineConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAreasplineConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAreasplineConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAreasplineConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAreasplineConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAreasplineConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAreasplineConnectorsMarkerOptions = null,
    startMarker: PlotAreasplineConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotAreasplineConnectorsOptions]
  }
}
