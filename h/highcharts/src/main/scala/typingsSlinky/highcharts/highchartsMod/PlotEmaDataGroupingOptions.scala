...
trait PlotEmaDataGroupingOptions extends js.Object {
  /**
...
object PlotEmaDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotEmaDataGroupingOptions]
  }
}
