...
trait PlotLinearregressionangleStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotLinearregressionangleStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionangleStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotLinearregressionangleStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotLinearregressionangleStatesSelectAnimationOptions = null,
  ...
  ): PlotLinearregressionangleStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesSelectOptions]
  }
}
