...
trait PlotDependencywheelConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotDependencywheelConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDependencywheelConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelConnectorsStartMarkerOptions]
  }
}
