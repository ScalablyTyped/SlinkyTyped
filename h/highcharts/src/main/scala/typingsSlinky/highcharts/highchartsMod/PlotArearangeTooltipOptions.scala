...
trait PlotArearangeTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotArearangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotArearangeTooltipOptions {
  ...
  def apply(
    ...
    dateTimeLabelFormats: PlotArearangeTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
