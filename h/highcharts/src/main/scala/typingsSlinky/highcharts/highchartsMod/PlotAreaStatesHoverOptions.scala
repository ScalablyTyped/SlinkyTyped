...
trait PlotAreaStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAreaStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreaStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotAreaStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreaStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAreaStatesHoverOptions]
  }
}
