...
trait PlotVwapPointEventsOptions extends js.Object {
  /**
...
object PlotVwapPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotVwapPointEventsOptions]
  }
}
