...
trait PlotMaplineConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotMaplineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMaplineConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineConnectorsStartMarkerOptions]
  }
}
