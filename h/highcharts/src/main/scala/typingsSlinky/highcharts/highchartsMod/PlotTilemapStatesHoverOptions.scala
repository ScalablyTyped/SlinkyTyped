...
trait PlotTilemapStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTilemapStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTilemapStatesHoverHaloOptions] = js.undefined
  /**
...
object PlotTilemapStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTilemapStatesHoverAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    brightness: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    halo: PlotTilemapStatesHoverHaloOptions = null,
    lineWidth: Int | Double = null,
    lineWidthPlus: Int | Double = null
  ): PlotTilemapStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapStatesHoverOptions]
  }
}
