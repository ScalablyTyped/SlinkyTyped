...
trait PlotPyramid3dLabelOptions extends js.Object {
  /**
...
object PlotPyramid3dLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPyramid3dLabelOptions]
  }
}
