...
trait PlotBbMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBbMarkerStatesOptions] = js.undefined
  /**
...
object PlotBbMarkerOptions {
  ...
  def apply(
    ...
    states: PlotBbMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotBbMarkerOptions]
  }
}
