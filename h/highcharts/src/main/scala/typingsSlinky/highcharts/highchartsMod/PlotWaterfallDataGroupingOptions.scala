...
trait PlotWaterfallDataGroupingOptions extends js.Object {
  /**
...
object PlotWaterfallDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWaterfallDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotWaterfallDataGroupingOptions]
  }
}
