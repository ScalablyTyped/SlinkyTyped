...
trait PlotVennAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVennAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotVennAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotVennAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotVennAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotVennAccessibilityOptions]
  }
}
