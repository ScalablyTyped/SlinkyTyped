...
trait PlotApoDataGroupingOptions extends js.Object {
  /**
...
object PlotApoDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotApoDataGroupingOptions]
  }
}
