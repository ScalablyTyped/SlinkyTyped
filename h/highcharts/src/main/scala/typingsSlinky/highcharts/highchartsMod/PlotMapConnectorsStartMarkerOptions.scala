...
trait PlotMapConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotMapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapConnectorsStartMarkerOptions]
  }
}
