...
trait SeriesFunnel3dDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesFunnel3dDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesFunnel3dDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesFunnel3dDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesFunnel3dDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesFunnel3dDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesFunnel3dDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesFunnel3dDataDragDropOptions]
  }
}
