...
trait PlotPcMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPcMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPcMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPcMarkerStatesSelectOptions]
  }
}
