...
trait PlotRocStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotRocStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotRocStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotRocStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRocStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotRocStatesHoverOptions]
  }
}
