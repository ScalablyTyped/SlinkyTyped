...
trait PlotCylinderEventsOptions extends js.Object {
  /**
...
object PlotCylinderEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotCylinderEventsOptions]
  }
}
