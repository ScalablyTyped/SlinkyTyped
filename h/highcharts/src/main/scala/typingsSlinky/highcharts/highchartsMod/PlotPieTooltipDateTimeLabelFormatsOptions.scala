...
trait PlotPieTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPieTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotPieTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotPieTooltipDateTimeLabelFormatsOptions]
  }
}
