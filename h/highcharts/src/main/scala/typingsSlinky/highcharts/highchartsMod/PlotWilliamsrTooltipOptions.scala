...
trait PlotWilliamsrTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotWilliamsrTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotWilliamsrTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    dateTimeLabelFormats: PlotWilliamsrTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotWilliamsrTooltipOptions]
  }
}
