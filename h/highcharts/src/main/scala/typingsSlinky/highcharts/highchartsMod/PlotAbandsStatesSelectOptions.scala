...
trait PlotAbandsStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAbandsStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAbandsStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotAbandsStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotAbandsStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAbandsStatesSelectOptions]
  }
}
