...
trait PlotPpoAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPpoAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotPpoAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotPpoAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotPpoAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotPpoAccessibilityOptions]
  }
}
