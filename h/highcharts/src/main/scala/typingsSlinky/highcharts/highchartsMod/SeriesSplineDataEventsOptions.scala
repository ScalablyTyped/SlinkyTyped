...
trait SeriesSplineDataEventsOptions extends js.Object {
  /**
...
object SeriesSplineDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesSplineDataEventsOptions]
  }
}
