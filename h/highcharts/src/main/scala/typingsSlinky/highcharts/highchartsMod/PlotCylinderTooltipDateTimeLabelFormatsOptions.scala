...
trait PlotCylinderTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotCylinderTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotCylinderTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderTooltipDateTimeLabelFormatsOptions]
  }
}
