...
trait PlotAroonoscillatorDataGroupingOptions extends js.Object {
  /**
...
object PlotAroonoscillatorDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorDataGroupingOptions]
  }
}
