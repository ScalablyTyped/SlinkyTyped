...
trait PlotGanttStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotGanttStatesSelectAnimationOptions] = js.undefined
  /**
...
object PlotGanttStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotGanttStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined
  ): PlotGanttStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotGanttStatesSelectOptions]
  }
}
