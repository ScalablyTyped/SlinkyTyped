...
trait PlotTemaConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotTemaConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTemaConnectorsMarkerOptions]
  }
}
