...
trait PlotTrendlineConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotTrendlineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineConnectorsStartMarkerOptions]
  }
}
