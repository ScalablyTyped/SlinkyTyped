...
trait PlotZigzagMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotZigzagMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotZigzagMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagMarkerStatesSelectOptions]
  }
}
