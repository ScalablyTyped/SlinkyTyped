...
trait PlotStochasticMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotStochasticMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticMarkerStatesSelectOptions]
  }
}
