...
trait PlotLinearregressionPointEventsOptions extends js.Object {
  /**
...
object PlotLinearregressionPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionPointEventsOptions]
  }
}
