...
trait PlotRsiStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotRsiStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotRsiStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotRsiStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotRsiStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotRsiStatesSelectOptions]
  }
}
