...
trait PlotCciConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotCciConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCciConnectorsEndMarkerOptions]
  }
}
