...
trait PlotBarDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotBarDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBarDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotBarDragDropDragHandleOptions]
  }
}
