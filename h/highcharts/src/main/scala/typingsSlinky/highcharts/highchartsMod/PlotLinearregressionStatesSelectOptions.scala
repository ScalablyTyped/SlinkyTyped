...
trait PlotLinearregressionStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotLinearregressionStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotLinearregressionStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotLinearregressionStatesSelectAnimationOptions = null,
  ...
  ): PlotLinearregressionStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionStatesSelectOptions]
  }
}
