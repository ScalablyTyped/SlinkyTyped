...
trait PlotGaugeTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotGaugeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotGaugeTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotGaugeTooltipDateTimeLabelFormatsOptions]
  }
}
