...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesRocOptions
  extends PlotRocOptions
...
object SeriesRocOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesRocOptions]
  }
}
