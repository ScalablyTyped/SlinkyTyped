...
trait PlotItemDataGroupingOptions extends js.Object {
  /**
...
object PlotItemDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotItemDataGroupingOptions]
  }
}
