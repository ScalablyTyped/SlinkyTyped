...
trait PlotSupertrendMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSupertrendMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendMarkerStatesSelectOptions]
  }
}
