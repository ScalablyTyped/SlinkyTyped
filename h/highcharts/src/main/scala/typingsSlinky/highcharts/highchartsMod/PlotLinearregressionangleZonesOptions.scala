...
trait PlotLinearregressionangleZonesOptions extends js.Object {
  /**
...
object PlotLinearregressionangleZonesOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleZonesOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleZonesOptions]
  }
}
