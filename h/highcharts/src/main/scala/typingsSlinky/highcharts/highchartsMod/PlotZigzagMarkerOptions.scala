...
trait PlotZigzagMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotZigzagMarkerStatesOptions] = js.undefined
  /**
...
object PlotZigzagMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotZigzagMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotZigzagMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagMarkerOptions]
  }
}
