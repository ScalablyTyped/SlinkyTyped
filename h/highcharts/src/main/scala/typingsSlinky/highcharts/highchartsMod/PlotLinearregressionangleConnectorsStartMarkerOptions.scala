...
trait PlotLinearregressionangleConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionangleConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleConnectorsStartMarkerOptions]
  }
}
