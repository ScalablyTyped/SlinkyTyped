...
trait PlotPieAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPieAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotPieAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotPieAccessibilityKeyboardNavigationOptions = null,
    ...
    __obj.asInstanceOf[PlotPieAccessibilityOptions]
  }
}
