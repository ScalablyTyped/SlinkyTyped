...
trait PlotMapbubbleMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMapbubbleMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleMarkerStatesSelectOptions]
  }
}
