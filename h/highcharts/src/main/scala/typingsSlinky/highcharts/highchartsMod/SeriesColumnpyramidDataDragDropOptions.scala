...
trait SeriesColumnpyramidDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesColumnpyramidDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesColumnpyramidDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesColumnpyramidDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesColumnpyramidDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesColumnpyramidDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesColumnpyramidDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesColumnpyramidDataDragDropOptions]
  }
}
