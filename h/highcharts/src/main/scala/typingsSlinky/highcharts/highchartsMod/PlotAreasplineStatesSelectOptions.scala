...
trait PlotAreasplineStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAreasplineStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreasplineStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotAreasplineStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotAreasplineStatesSelectAnimationOptions = null,
  ...
  ): PlotAreasplineStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesSelectOptions]
  }
}
