...
trait SeriesWordcloudDataEventsOptions extends js.Object {
  /**
...
object SeriesWordcloudDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesWordcloudDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesWordcloudDataEventsOptions]
  }
}
