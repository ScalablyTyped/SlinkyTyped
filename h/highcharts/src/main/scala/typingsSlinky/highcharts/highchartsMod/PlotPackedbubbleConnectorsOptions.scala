...
trait PlotPackedbubbleConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPackedbubbleConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPackedbubbleConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPackedbubbleConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPackedbubbleConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotPackedbubbleConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPackedbubbleConnectorsMarkerOptions = null,
    startMarker: PlotPackedbubbleConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotPackedbubbleConnectorsOptions = {
