...
trait PlotAroonoscillatorPointEventsOptions extends js.Object {
  /**
...
object PlotAroonoscillatorPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorPointEventsOptions]
  }
}
