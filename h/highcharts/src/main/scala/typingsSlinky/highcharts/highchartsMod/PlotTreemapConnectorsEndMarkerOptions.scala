...
trait PlotTreemapConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotTreemapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTreemapConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapConnectorsEndMarkerOptions]
  }
}
