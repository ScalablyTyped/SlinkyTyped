...
trait PlotTilemapConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTilemapConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTilemapConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTilemapConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotTilemapConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotTilemapConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotTilemapConnectorsMarkerOptions = null,
    startMarker: PlotTilemapConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotTilemapConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapConnectorsOptions]
  }
}
