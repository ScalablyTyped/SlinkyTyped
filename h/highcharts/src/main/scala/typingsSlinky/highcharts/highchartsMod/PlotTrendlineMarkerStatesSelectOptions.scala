...
trait PlotTrendlineMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTrendlineMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineMarkerStatesSelectOptions]
  }
}
