...
trait PlotMomentumConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMomentumConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMomentumConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMomentumConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotMomentumConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotMomentumConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotMomentumConnectorsMarkerOptions = null,
    startMarker: PlotMomentumConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotMomentumConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumConnectorsOptions]
  }
}
