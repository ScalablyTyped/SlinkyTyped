...
trait PlotVariwideAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVariwideAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotVariwideAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotVariwideAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotVariwideAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideAccessibilityOptions]
  }
}
