...
trait PlotSupertrendPointEventsOptions extends js.Object {
  /**
...
object PlotSupertrendPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendPointEventsOptions]
  }
}
