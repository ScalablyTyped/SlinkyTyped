...
trait PlotEmaMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotEmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotEmaMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotEmaMarkerStatesHoverOptions]
  }
}
