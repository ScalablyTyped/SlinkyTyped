...
trait PlotAreasplineDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAreasplineDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAreasplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAreasplineDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAreasplineDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAreasplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotAreasplineDragDropOptions]
  }
}
