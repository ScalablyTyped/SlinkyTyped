...
trait SeriesVennDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesVennDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesVennDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesVennDataDragDropDragHandleOptions]
  }
}
