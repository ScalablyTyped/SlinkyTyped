...
trait SonifyChartOptionsObject extends js.Object {
  ...
  var earcons: js.UndefOr[
    js.Array[
      typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.EarconConfiguration
    ]
  ] = js.undefined
  /**
  ...
  var instruments: js.UndefOr[
    js.Array[
      typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentObject
    ]
  ] = js.undefined
  /**
  ...
  var order: String | (js.Array[
    String | typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Earcon | (js.Array[String | typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Earcon])
  ])
  /**
