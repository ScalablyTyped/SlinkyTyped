...
trait SeriesAreaDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesAreaDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreaDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesAreaDataDragDropGuideBoxDefaultOptions]
  }
}
