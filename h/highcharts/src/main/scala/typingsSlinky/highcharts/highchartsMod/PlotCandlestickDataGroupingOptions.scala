...
trait PlotCandlestickDataGroupingOptions extends js.Object {
  /**
...
object PlotCandlestickDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCandlestickDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotCandlestickDataGroupingOptions]
  }
}
