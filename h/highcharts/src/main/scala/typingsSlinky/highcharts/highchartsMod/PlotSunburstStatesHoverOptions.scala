...
trait PlotSunburstStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSunburstStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSunburstStatesHoverHaloOptions | Null] = js.undefined
}

object PlotSunburstStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSunburstStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotSunburstStatesHoverOptions]
  }
}
