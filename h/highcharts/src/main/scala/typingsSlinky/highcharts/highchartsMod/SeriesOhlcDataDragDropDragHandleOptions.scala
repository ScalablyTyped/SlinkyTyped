...
trait SeriesOhlcDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesOhlcDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesOhlcDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesOhlcDataDragDropDragHandleOptions]
  }
}
