...
trait PlotSeriesConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotSeriesConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSeriesConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesConnectorsEndMarkerOptions]
  }
}
