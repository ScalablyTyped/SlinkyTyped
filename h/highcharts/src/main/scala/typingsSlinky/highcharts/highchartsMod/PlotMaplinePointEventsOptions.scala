...
trait PlotMaplinePointEventsOptions extends js.Object {
  /**
...
object PlotMaplinePointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMaplinePointEventsOptions]
  }
}
