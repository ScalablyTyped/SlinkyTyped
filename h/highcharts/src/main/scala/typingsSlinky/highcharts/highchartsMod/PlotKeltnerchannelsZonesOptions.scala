...
trait PlotKeltnerchannelsZonesOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsZonesOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsZonesOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsZonesOptions]
  }
}
