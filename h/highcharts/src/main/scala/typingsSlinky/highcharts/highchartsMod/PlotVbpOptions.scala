...
trait PlotVbpOptions extends js.Object {
  /**
    * (Highstock) Accessibility options for a series. Requires the
    * accessibility module.
    */
  var accessibility: js.UndefOr[js.Object | PlotVbpAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVbpAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotVbpConnectorsOptions] = js.undefined
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotVbpDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotVbpEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotVbpLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotVbpLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotVbpLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVbpMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotVbpParamsOptions] = js.undefined
  /**
    * (Highstock) Properties for each single point.
    */
  var point: js.UndefOr[PlotVbpPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotVbpStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotVbpTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    * positive/negative.
    */
  var volumeDivision: js.UndefOr[PlotVbpVolumeDivisionOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zoneLines: js.UndefOr[PlotVbpZoneLinesOptions] = js.undefined
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotVbpZonesOptions]] = js.undefined
}

object PlotVbpOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotVbpOptions]
  }
}
