...
trait PlotHeatmapDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highmaps) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotHeatmapDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotHeatmapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotHeatmapDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotHeatmapDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotHeatmapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotHeatmapDragDropOptions]
  }
}
