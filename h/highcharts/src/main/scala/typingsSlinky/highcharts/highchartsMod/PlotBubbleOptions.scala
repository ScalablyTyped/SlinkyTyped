...
trait PlotBubbleOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Accessibility options for a series. Requires the
    * accessibility module.
    */
  var accessibility: js.UndefOr[js.Object | PlotBubbleAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBubbleAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotBubbleConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotBubbleDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotBubbleDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotBubbleEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotBubbleJitterOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotBubbleLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotBubbleLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotBubbleLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBubbleMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotBubblePointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotBubbleStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    * in the pointFormat.
    */
  var tooltip: js.UndefOr[PlotBubbleTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotBubbleZonesOptions]] = js.undefined
}

object PlotBubbleOptions {
  @scala.inline
  def apply(
