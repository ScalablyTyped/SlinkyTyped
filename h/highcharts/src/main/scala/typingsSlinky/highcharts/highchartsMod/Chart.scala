...
class Chart protected () extends js.Object {
  ...
  /**
    ...
    */
  var data: js.UndefOr[typingsSlinky.highcharts.modulesDataMod.highchartsMod.Data] = js.native
  /**
  ...
  /**
    ...
    */
  def fromLatLonToPoint(latLon: typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapLatLonObject): typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapCoordinateObject = js.native
  /**
    ...
    */
  def fromPointToLatLon(point: typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapCoordinateObject): js.UndefOr[typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapLatLonObject] = js.native
  def fromPointToLatLon(point: typingsSlinky.highcharts.modulesMapMod.highchartsMod.Point): js.UndefOr[typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapLatLonObject] = js.native
  /**
  ...
  /**
    ...
    */
  def getCurrentSonifyPoints(): js.Array[typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Point] = js.native
  /**
  ...
  /**
    ...
    */
  def isChartSeriesBoosting(chart: typingsSlinky.highcharts.modulesBoostMod.highchartsMod.Chart): Boolean = js.native
  /**
  ...
  def setSonifyCursor(points: js.Array[typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Point]): Unit = js.native
  /**
    ...
    */
  def setSonifyCursor(points: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.Point): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def sonify(options: typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.SonifyChartOptionsObject): Unit = js.native
  /**
    ...
    */
  def transformFromLatLon(latLon: typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapLatLonObject, transform: js.Any): typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapCoordinateObject = js.native
  /**
    ...
    * @return An object with `lat` and `lon` properties.
    */
  def transformToLatLon(point: typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapCoordinateObject, transform: js.Any): js.UndefOr[typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapLatLonObject] = js.native
  def transformToLatLon(point: typingsSlinky.highcharts.modulesMapMod.highchartsMod.Point, transform: js.Any): js.UndefOr[typingsSlinky.highcharts.modulesMapMod.highchartsMod.MapLatLonObject] = js.native
  /**
