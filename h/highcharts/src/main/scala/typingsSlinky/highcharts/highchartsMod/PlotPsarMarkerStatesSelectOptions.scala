...
trait PlotPsarMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPsarMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPsarMarkerStatesSelectOptions]
  }
}
