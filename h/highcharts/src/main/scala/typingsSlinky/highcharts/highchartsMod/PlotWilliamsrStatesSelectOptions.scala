...
trait PlotWilliamsrStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotWilliamsrStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotWilliamsrStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotWilliamsrStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotWilliamsrStatesSelectAnimationOptions = null,
  ...
  ): PlotWilliamsrStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesSelectOptions]
  }
}
