...
trait PlotSmaConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotSmaConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSmaConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSmaConnectorsMarkerOptions]
  }
}
