...
trait PlotPyramidConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPyramidConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramidConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidConnectorsMarkerOptions]
  }
}
