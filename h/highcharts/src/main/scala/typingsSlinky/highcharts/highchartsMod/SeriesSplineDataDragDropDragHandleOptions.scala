...
trait SeriesSplineDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesSplineDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesSplineDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesSplineDataDragDropDragHandleOptions]
  }
}
