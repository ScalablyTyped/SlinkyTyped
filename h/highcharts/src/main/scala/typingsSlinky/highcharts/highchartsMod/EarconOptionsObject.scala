...
trait EarconOptionsObject extends js.Object {
  ...
  /**
    ...
    */
  var instruments: js.Array[typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.EarconInstrument]
  /**
...
object EarconOptionsObject {
  @scala.inline
  def apply(
    instruments: js.Array[typingsSlinky.highcharts.modulesSonificationMod.highchartsMod.EarconInstrument],
    id: String = null,
