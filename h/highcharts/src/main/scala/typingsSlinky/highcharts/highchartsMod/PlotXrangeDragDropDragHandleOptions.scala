...
trait PlotXrangeDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotXrangeDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotXrangeDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotXrangeDragDropDragHandleOptions]
  }
}
