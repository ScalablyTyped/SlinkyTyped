...
trait PlotAdConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAdConnectorsMarkerOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAdConnectorsMarkerOptions]
  }
}
