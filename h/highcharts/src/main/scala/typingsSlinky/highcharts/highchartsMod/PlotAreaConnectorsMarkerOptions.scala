...
trait PlotAreaConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAreaConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreaConnectorsMarkerOptions]
  }
}
