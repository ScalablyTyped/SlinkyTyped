...
trait PlotMapTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotMapTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotMapTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotMapTooltipDateTimeLabelFormatsOptions]
  }
}
