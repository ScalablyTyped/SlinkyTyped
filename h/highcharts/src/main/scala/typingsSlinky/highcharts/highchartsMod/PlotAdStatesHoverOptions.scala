...
trait PlotAdStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAdStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAdStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotAdStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAdStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAdStatesHoverOptions]
  }
}
