...
trait PlotTreemapConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotTreemapConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTreemapConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapConnectorsMarkerOptions]
  }
}
