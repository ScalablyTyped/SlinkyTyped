...
trait PlotVwapConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVwapConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVwapConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVwapConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotVwapConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotVwapConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotVwapConnectorsMarkerOptions = null,
    startMarker: PlotVwapConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotVwapConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotVwapConnectorsOptions]
  }
}
