...
trait PlotRocMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotRocMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotRocMarkerStatesHoverOptions]
  }
}
