...
trait PlotPsarConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPsarConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPsarConnectorsEndMarkerOptions]
  }
}
