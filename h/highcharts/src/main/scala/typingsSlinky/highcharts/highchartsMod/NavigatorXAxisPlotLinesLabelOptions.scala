...
trait NavigatorXAxisPlotLinesLabelOptions extends js.Object {
  /**
...
object NavigatorXAxisPlotLinesLabelOptions {
  @scala.inline
  def apply(
    ...
    x: Int | Double = null,
    y: Int | Double = null
  ): NavigatorXAxisPlotLinesLabelOptions = {
    ...
    __obj.asInstanceOf[NavigatorXAxisPlotLinesLabelOptions]
  }
}
