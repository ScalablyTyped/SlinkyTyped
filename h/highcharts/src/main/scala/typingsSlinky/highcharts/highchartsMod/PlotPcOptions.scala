...
trait PlotPcOptions extends js.Object {
  /**
    * (Highstock) Accessibility options for a series. Requires the
    * accessibility module.
    */
  var accessibility: js.UndefOr[js.Object | PlotPcAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPcAnimationOptions] = js.undefined
  /**
  ...
  var bottomLine: js.UndefOr[PlotPcBottomLineOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotPcConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotPcDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotPcEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotPcLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotPcLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotPcLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPcMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotPcParamsOptions] = js.undefined
  /**
    * (Highstock) Properties for each single point.
    */
  var point: js.UndefOr[PlotPcPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotPcStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotPcTooltipOptions] = js.undefined
  var topLine: js.UndefOr[PlotPcTopLineOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotPcZonesOptions]] = js.undefined
}

object PlotPcOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPcOptions]
  }
}
