...
trait PlotItemMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotItemMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotItemMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotItemMarkerStatesHoverOptions]
  }
}
