...
trait PlotLinearregressioninterceptEventsOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptEventsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptEventsOptions]
  }
}
