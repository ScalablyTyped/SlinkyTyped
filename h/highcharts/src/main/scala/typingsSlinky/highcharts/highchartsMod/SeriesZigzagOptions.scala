...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesZigzagOptions
  extends PlotZigzagOptions
...
object SeriesZigzagOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesZigzagOptions]
  }
}
