...
trait PlotTilemapAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTilemapAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotTilemapAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotTilemapAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotTilemapAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapAccessibilityOptions]
  }
}
