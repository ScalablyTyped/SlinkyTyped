...
trait PlotTemaStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotTemaStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTemaStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotTemaStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotTemaStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotTemaStatesSelectOptions]
  }
}
