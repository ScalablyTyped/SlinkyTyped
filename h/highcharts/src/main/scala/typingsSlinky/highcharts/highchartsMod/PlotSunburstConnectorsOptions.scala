...
trait PlotSunburstConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSunburstConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSunburstConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSunburstConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotSunburstConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotSunburstConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotSunburstConnectorsMarkerOptions = null,
    startMarker: PlotSunburstConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotSunburstConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstConnectorsOptions]
  }
}
