...
trait PlotKeltnerchannelsStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotKeltnerchannelsStatesHoverAnimationOptions
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotKeltnerchannelsStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotKeltnerchannelsStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotKeltnerchannelsStatesHoverAnimationOptions = null,
  ...
  ): PlotKeltnerchannelsStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesHoverOptions]
  }
}
