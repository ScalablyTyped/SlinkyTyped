...
trait PlotAtrDataGroupingOptions extends js.Object {
  /**
...
object PlotAtrDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAtrDataGroupingOptions]
  }
}
