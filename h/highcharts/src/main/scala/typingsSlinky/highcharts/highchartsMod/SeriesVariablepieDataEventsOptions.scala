...
trait SeriesVariablepieDataEventsOptions extends js.Object {
  /**
...
object SeriesVariablepieDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesVariablepieDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesVariablepieDataEventsOptions]
  }
}
