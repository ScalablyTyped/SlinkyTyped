...
trait PlotMacdMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMacdMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMacdMarkerStatesSelectOptions]
  }
}
