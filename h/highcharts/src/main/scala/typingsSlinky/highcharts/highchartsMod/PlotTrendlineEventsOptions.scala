...
trait PlotTrendlineEventsOptions extends js.Object {
  /**
...
object PlotTrendlineEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTrendlineEventsOptions]
  }
}
