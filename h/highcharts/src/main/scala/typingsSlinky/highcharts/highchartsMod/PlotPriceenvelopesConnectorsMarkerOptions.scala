...
trait PlotPriceenvelopesConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPriceenvelopesConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesConnectorsMarkerOptions]
  }
}
