...
trait PlotCylinderStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotCylinderStatesSelectAnimationOptions] = js.undefined
  /**
...
object PlotCylinderStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotCylinderStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined
  ): PlotCylinderStatesSelectOptions = {
