...
trait PlotVariwideDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotVariwideDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotVariwideDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotVariwideDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotVariwideDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotVariwideDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotVariwideDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideDragDropOptions]
  }
}
