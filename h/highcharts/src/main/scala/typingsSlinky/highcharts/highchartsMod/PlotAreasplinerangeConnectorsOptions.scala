...
trait PlotAreasplinerangeConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAreasplinerangeConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAreasplinerangeConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAreasplinerangeConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAreasplinerangeConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAreasplinerangeConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAreasplinerangeConnectorsMarkerOptions = null,
    startMarker: PlotAreasplinerangeConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotAreasplinerangeConnectorsOptions]
  }
}
