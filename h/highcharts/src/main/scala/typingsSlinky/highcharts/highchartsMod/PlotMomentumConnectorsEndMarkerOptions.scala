...
trait PlotMomentumConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotMomentumConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumConnectorsEndMarkerOptions]
  }
}
