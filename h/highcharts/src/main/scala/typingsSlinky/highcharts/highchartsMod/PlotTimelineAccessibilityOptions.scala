...
trait PlotTimelineAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTimelineAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotTimelineAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotTimelineAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotTimelineAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineAccessibilityOptions]
  }
}
