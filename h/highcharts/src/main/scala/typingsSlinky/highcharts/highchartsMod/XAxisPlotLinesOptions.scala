...
trait XAxisPlotLinesOptions extends AxisPlotLinesOptions {
  /**
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[XAxisPlotLinesEventsOptions] = js.undefined
  /**
...
object XAxisPlotLinesOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[XAxisPlotLinesOptions]
  }
}
