...
trait PlotSeriesStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSeriesStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSeriesStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotSeriesStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSeriesStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotSeriesStatesHoverOptions]
  }
}
