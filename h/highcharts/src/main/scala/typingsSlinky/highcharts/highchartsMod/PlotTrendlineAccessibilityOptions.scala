...
trait PlotTrendlineAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTrendlineAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotTrendlineAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotTrendlineAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotTrendlineAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineAccessibilityOptions]
  }
}
