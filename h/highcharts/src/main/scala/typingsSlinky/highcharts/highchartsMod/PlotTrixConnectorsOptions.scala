...
trait PlotTrixConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTrixConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTrixConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTrixConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotTrixConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotTrixConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotTrixConnectorsMarkerOptions = null,
    startMarker: PlotTrixConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotTrixConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotTrixConnectorsOptions]
  }
}
