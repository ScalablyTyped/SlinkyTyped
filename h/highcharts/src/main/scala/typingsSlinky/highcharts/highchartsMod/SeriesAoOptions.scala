...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, treemap, `type`, xAxis, yAxis */ trait SeriesAoOptions
  extends PlotAoOptions
...
object SeriesAoOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesAoOptions]
  }
}
