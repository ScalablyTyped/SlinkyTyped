...
trait PlotLinearregressionEventsOptions extends js.Object {
  /**
...
object PlotLinearregressionEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionEventsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionEventsOptions]
  }
}
