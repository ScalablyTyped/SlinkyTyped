...
trait PlotAdConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAdConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAdConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAdConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAdConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAdConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAdConnectorsMarkerOptions = null,
    startMarker: PlotAdConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotAdConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotAdConnectorsOptions]
  }
}
