...
trait PlotWilliamsrConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotWilliamsrConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWilliamsrConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrConnectorsEndMarkerOptions]
  }
}
