...
trait PlotVariwidePointEventsOptions extends js.Object {
  /**
...
object PlotVariwidePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariwidePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotVariwidePointEventsOptions]
  }
}
