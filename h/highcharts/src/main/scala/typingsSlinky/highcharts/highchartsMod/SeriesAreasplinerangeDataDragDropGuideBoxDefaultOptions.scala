...
trait SeriesAreasplinerangeDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesAreasplinerangeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreasplinerangeDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesAreasplinerangeDataDragDropGuideBoxDefaultOptions]
  }
}
