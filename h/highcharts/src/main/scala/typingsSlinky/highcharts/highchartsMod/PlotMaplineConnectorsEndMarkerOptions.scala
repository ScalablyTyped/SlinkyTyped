...
trait PlotMaplineConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotMaplineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMaplineConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineConnectorsEndMarkerOptions]
  }
}
