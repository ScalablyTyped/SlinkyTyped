...
trait SeriesHeatmapDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesHeatmapDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesHeatmapDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesHeatmapDataDragDropDragHandleOptions]
  }
}
