...
trait PlotPyramid3dTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPyramid3dTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotPyramid3dTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dTooltipDateTimeLabelFormatsOptions]
  }
}
