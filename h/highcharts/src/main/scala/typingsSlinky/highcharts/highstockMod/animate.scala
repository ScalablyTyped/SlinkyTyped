...
object animate extends js.Object {
  ...
  def apply(el: typingsSlinky.highcharts.mod.SVGElement, params: CSSObject, opt: PartialAnimationOptionsOb): Unit = js.native
  def apply(el: typingsSlinky.highcharts.mod.SVGElement, params: SVGAttributes): Unit = js.native
  def apply(el: typingsSlinky.highcharts.mod.SVGElement, params: SVGAttributes, opt: PartialAnimationOptionsOb): Unit = js.native
}
