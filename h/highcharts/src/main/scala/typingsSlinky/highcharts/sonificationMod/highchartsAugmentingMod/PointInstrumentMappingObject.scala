...
object PointInstrumentMappingObject {
  ...
  implicit class PointInstrumentMappingObjectOps[Self <: PointInstrumentMappingObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDuration(value: Double | String | js.Function): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("duration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFrequency(value: Double | String | js.Function): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("frequency")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVolume(value: Double | String | js.Function): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("volume")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPan(value: Double | String | js.Function): Self = {
        val ret = this.duplicate
