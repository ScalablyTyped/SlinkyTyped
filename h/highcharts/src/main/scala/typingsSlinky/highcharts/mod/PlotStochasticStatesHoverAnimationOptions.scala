...
object PlotStochasticStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotStochasticStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotStochasticStatesHoverAnimationOptionsOps[Self <: PlotStochasticStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
