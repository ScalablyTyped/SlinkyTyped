...
trait PlotSplineStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSplineStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSplineStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotSplineStatesHoverOptions {
  @scala.inline
  def apply(): PlotSplineStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSplineStatesHoverOptionsOps[Self <: PlotSplineStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotSplineStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSplineStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
