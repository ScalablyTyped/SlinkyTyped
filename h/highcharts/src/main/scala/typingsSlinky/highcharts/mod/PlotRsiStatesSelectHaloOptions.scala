...
object PlotRsiStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotRsiStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotRsiStatesSelectHaloOptionsOps[Self <: PlotRsiStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
