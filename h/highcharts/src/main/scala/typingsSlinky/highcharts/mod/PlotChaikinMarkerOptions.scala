...
trait PlotChaikinMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotChaikinMarkerStatesOptions] = js.native
  /**
...
object PlotChaikinMarkerOptions {
  @scala.inline
  def apply(): PlotChaikinMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinMarkerOptions]
  }
  @scala.inline
  implicit class PlotChaikinMarkerOptionsOps[Self <: PlotChaikinMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotChaikinMarkerStatesOptions): Self = {
        val ret = this.duplicate
