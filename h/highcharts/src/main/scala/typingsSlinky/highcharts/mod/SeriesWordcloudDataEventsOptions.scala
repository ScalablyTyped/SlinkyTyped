...
object SeriesWordcloudDataEventsOptions {
  @scala.inline
  def apply(): SeriesWordcloudDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesWordcloudDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesWordcloudDataEventsOptionsOps[Self <: SeriesWordcloudDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
