...
@js.native
trait PlotOhlcEventsOptions extends js.Object {
  /**
...
object PlotOhlcEventsOptions {
  @scala.inline
  def apply(): PlotOhlcEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcEventsOptions]
  }
  @scala.inline
  implicit class PlotOhlcEventsOptionsOps[Self <: PlotOhlcEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
