...
@js.native
trait PlotCmfMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotCmfMarkerStatesOptions] = js.native
  /**
...
object PlotCmfMarkerOptions {
  @scala.inline
  def apply(): PlotCmfMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfMarkerOptions]
  }
  @scala.inline
  implicit class PlotCmfMarkerOptionsOps[Self <: PlotCmfMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotCmfMarkerStatesOptions): Self = {
        val ret = this.duplicate
