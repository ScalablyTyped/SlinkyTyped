...
trait PlotXrangeAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotXrangeAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotXrangeAccessibilityOptions {
  @scala.inline
  def apply(): PlotXrangeAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotXrangeAccessibilityOptionsOps[Self <: PlotXrangeAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotXrangeAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
