...
@js.native
trait PlotItemStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotItemStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotItemStatesHoverHaloOptions | Null] = js.native
}

object PlotItemStatesHoverOptions {
  @scala.inline
  def apply(): PlotItemStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotItemStatesHoverOptionsOps[Self <: PlotItemStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotItemStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotItemStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
