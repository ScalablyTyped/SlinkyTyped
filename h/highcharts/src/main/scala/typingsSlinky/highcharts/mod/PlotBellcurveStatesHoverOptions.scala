...
trait PlotBellcurveStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBellcurveStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBellcurveStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotBellcurveStatesHoverOptions {
  @scala.inline
  def apply(): PlotBellcurveStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotBellcurveStatesHoverOptionsOps[Self <: PlotBellcurveStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotBellcurveStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotBellcurveStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
