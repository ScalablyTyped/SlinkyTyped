...
@js.native
trait SeriesXrangeDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesXrangeDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesXrangeDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataMarkerStatesHoverOptionsOps[Self <: SeriesXrangeDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
