...
trait PlotCylinderStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotCylinderStatesHoverAnimationOptions] = js.native
  /**
...
object PlotCylinderStatesHoverOptions {
  @scala.inline
  def apply(): PlotCylinderStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotCylinderStatesHoverOptionsOps[Self <: PlotCylinderStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotCylinderStatesHoverAnimationOptions): Self = {
