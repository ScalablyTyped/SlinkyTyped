...
@js.native
trait PlotColumnrangeConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotColumnrangeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotColumnrangeConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeConnectorsStartMarkerOptionsOps[Self <: PlotColumnrangeConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
