...
trait PlotMacdTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotMacdTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotMacdTooltipOptions {
  @scala.inline
  def apply(): PlotMacdTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdTooltipOptions]
  }
  @scala.inline
  implicit class PlotMacdTooltipOptionsOps[Self <: PlotMacdTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotMacdTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
