...
@js.native
trait PlotSupertrendConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotSupertrendConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotSupertrendConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotSupertrendConnectorsMarkerOptionsOps[Self <: PlotSupertrendConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
