...
object PlotMapbubbleDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotMapbubbleDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleDragDropDragHandleOptionsOps[Self <: PlotMapbubbleDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
