...
object PlotTilemapDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotTilemapDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotTilemapDragDropDragHandleOptionsOps[Self <: PlotTilemapDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
