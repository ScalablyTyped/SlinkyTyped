...
trait PlotSmaConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSmaConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSmaConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSmaConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotSmaConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotSmaConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotSmaConnectorsMarkerOptions = null,
    startMarker: PlotSmaConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotSmaConnectorsOptions = {
