...
object PlotPyramid3dConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPyramid3dConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dConnectorsStartMarkerOptionsOps[Self <: PlotPyramid3dConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
