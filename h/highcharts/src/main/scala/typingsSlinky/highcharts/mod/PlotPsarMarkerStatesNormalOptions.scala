...
object PlotPsarMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotPsarMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotPsarMarkerStatesNormalOptionsOps[Self <: PlotPsarMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
