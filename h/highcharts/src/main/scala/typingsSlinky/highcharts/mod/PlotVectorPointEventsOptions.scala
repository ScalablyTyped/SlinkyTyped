...
@js.native
trait PlotVectorPointEventsOptions extends js.Object {
  /**
...
object PlotVectorPointEventsOptions {
  @scala.inline
  def apply(): PlotVectorPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorPointEventsOptions]
  }
  @scala.inline
  implicit class PlotVectorPointEventsOptionsOps[Self <: PlotVectorPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
