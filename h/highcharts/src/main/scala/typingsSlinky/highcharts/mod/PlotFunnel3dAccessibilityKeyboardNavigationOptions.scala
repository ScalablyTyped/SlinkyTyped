...
object PlotFunnel3dAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotFunnel3dAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dAccessibilityKeyboardNavigationOptionsOps[Self <: PlotFunnel3dAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
