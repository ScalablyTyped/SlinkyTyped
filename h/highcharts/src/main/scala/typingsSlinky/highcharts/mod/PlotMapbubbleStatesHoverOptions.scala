...
trait PlotMapbubbleStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMapbubbleStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMapbubbleStatesHoverHaloOptions] = js.native
  /**
...
object PlotMapbubbleStatesHoverOptions {
  @scala.inline
  def apply(): PlotMapbubbleStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleStatesHoverOptionsOps[Self <: PlotMapbubbleStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotMapbubbleStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMapbubbleStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
