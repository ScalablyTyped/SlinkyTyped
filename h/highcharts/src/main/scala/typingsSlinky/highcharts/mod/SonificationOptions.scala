...
trait SonificationOptions extends js.Object {
  ...
  var order: String | (js.Array[
    String | typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon | (js.Array[String | typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon])
  ]) = js.native
...
object SonificationOptions {
  ...
  implicit class SonificationOptionsOps[Self <: SonificationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOrderVarargs(
      value: (String | typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon | (js.Array[String | typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon]))*
