...
object PlotSupertrendMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotSupertrendMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotSupertrendMarkerStatesInactiveOptionsOps[Self <: PlotSupertrendMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
