...
object PlotDpoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotDpoConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotDpoConnectorsEndMarkerOptionsOps[Self <: PlotDpoConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
