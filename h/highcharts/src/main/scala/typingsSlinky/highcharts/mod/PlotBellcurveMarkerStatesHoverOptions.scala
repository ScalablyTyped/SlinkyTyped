...
object PlotBellcurveMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotBellcurveMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotBellcurveMarkerStatesHoverOptionsOps[Self <: PlotBellcurveMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
