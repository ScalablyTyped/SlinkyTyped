...
@js.native
trait PlotHistogramConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotHistogramConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotHistogramConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotHistogramConnectorsMarkerOptionsOps[Self <: PlotHistogramConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
