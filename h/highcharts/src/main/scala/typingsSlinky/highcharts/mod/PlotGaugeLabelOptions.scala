...
@js.native
trait PlotGaugeLabelOptions extends js.Object {
  /**
...
object PlotGaugeLabelOptions {
  @scala.inline
  def apply(): PlotGaugeLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeLabelOptions]
  }
  @scala.inline
  implicit class PlotGaugeLabelOptionsOps[Self <: PlotGaugeLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
