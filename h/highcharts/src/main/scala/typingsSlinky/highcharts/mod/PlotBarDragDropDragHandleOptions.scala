...
object PlotBarDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotBarDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotBarDragDropDragHandleOptionsOps[Self <: PlotBarDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
