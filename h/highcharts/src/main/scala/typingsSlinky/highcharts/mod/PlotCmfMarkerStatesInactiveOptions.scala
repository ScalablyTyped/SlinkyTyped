...
object PlotCmfMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotCmfMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotCmfMarkerStatesInactiveOptionsOps[Self <: PlotCmfMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
