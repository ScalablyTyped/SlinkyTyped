...
@js.native
trait PlotVariwideZonesOptions extends js.Object {
  /**
...
object PlotVariwideZonesOptions {
  @scala.inline
  def apply(): PlotVariwideZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideZonesOptions]
  }
  @scala.inline
  implicit class PlotVariwideZonesOptionsOps[Self <: PlotVariwideZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
