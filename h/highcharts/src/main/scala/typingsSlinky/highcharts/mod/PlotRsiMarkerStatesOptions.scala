...
trait PlotRsiMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotRsiMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotRsiMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotRsiMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotRsiMarkerStatesSelectOptions] = js.native
}

object PlotRsiMarkerStatesOptions {
  @scala.inline
  def apply(): PlotRsiMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotRsiMarkerStatesOptionsOps[Self <: PlotRsiMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotRsiMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotRsiMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotRsiMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotRsiMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
