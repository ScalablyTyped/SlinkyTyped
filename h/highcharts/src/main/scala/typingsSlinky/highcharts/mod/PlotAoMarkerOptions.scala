...
trait PlotAoMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAoMarkerStatesOptions] = js.native
  /**
...
object PlotAoMarkerOptions {
  @scala.inline
  def apply(): PlotAoMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoMarkerOptions]
  }
  @scala.inline
  implicit class PlotAoMarkerOptionsOps[Self <: PlotAoMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAoMarkerStatesOptions): Self = {
        val ret = this.duplicate
