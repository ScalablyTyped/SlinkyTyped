...
object XAxisOptions {
  ...
  implicit class XAxisOptionsOps[Self <: XAxisOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBreaksVarargs(value: XAxisBreaksOptions*): Self = this.set("breaks", js.Array(value :_*))
    
    @scala.inline
    def setBreaks(value: js.Array[XAxisBreaksOptions]): Self = this.set("breaks", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEvents(value: XAxisEventsOptions): Self = this.set("events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGrid(value: XAxisGridOptions): Self = this.set("grid", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabels(value: XAxisLabelsOptions): Self = this.set("labels", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPlotBandsVarargs(value: XAxisPlotBandsOptions*): Self = this.set("plotBands", js.Array(value :_*))
    
    @scala.inline
    def setPlotBands(value: js.Array[XAxisPlotBandsOptions]): Self = this.set("plotBands", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePlotBands: Self = this.set("plotBands", js.undefined)
    
    @scala.inline
    def setPlotLinesVarargs(value: XAxisPlotLinesOptions*): Self = this.set("plotLines", js.Array(value :_*))
    
    @scala.inline
    def setPlotLines(value: js.Array[XAxisPlotLinesOptions]): Self = this.set("plotLines", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScrollbar(value: XAxisScrollbarOptions): Self = this.set("scrollbar", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: XAxisTitleOptions): Self = this.set("title", value.asInstanceOf[js.Any])
