...
@js.native
trait PlotVbpMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVbpMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotVbpMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotVbpMarkerStatesSelectOptionsOps[Self <: PlotVbpMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
