...
@js.native
trait PlotVariablepieAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVariablepieAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotVariablepieAccessibilityOptions {
  @scala.inline
  def apply(): PlotVariablepieAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotVariablepieAccessibilityOptionsOps[Self <: PlotVariablepieAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotVariablepieAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
