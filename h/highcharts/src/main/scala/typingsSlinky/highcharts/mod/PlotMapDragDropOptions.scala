...
trait PlotMapDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotMapDragDropDragHandleOptions] = js.native
  /**
...
object PlotMapDragDropOptions {
  @scala.inline
  def apply(): PlotMapDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapDragDropOptions]
  }
  @scala.inline
  implicit class PlotMapDragDropOptionsOps[Self <: PlotMapDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotMapDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotMapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
