...
object PlotAroonoscillatorConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorConnectorsEndMarkerOptionsOps[Self <: PlotAroonoscillatorConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
