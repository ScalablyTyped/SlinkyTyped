...
object PlotApoAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotApoAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotApoAccessibilityKeyboardNavigationOptionsOps[Self <: PlotApoAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
