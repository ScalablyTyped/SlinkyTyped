...
trait PlotMapbubbleTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotMapbubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotMapbubbleTooltipOptions {
  @scala.inline
  def apply(): PlotMapbubbleTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleTooltipOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleTooltipOptionsOps[Self <: PlotMapbubbleTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotMapbubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
