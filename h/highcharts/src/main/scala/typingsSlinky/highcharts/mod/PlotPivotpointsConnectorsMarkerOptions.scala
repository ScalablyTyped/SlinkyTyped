...
object PlotPivotpointsConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPivotpointsConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsConnectorsMarkerOptionsOps[Self <: PlotPivotpointsConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
