...
trait PlotTreemapStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotTreemapStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTreemapStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotTreemapStatesSelectOptions {
  @scala.inline
  def apply(): PlotTreemapStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTreemapStatesSelectOptionsOps[Self <: PlotTreemapStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotTreemapStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTreemapStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
