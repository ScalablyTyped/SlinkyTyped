...
@js.native
trait PlotGanttDataLabelsOptions extends js.Object {
...
object PlotGanttDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotGanttDataLabelsOptionsOps[Self <: PlotGanttDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotGanttDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
