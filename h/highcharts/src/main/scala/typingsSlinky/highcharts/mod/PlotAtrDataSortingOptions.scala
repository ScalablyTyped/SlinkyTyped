...
@js.native
trait PlotAtrDataSortingOptions extends js.Object {
...
object PlotAtrDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotAtrDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAtrDataSortingOptionsOps[Self <: PlotAtrDataSortingOptions] (val x: Self) extends AnyVal {
