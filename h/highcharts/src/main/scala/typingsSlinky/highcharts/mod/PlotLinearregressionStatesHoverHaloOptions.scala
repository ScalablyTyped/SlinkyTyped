...
@js.native
trait PlotLinearregressionStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotLinearregressionStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressionStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionStatesHoverHaloOptionsOps[Self <: PlotLinearregressionStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
