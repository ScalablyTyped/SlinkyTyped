...
@js.native
trait SeriesPolygonDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesPolygonDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesPolygonDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPolygonDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesPolygonDataDragDropDragHandleOptionsOps[Self <: SeriesPolygonDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
