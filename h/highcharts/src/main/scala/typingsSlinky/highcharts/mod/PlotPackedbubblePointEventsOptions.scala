...
object PlotPackedbubblePointEventsOptions {
  @scala.inline
  def apply(): PlotPackedbubblePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubblePointEventsOptions]
  }
  @scala.inline
  implicit class PlotPackedbubblePointEventsOptionsOps[Self <: PlotPackedbubblePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
