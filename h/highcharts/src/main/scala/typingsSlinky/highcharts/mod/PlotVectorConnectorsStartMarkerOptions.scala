...
@js.native
trait PlotVectorConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotVectorConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotVectorConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotVectorConnectorsStartMarkerOptionsOps[Self <: PlotVectorConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
