...
@js.native
trait PlotDpoPointEventsOptions extends js.Object {
  /**
...
object PlotDpoPointEventsOptions {
  @scala.inline
  def apply(): PlotDpoPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoPointEventsOptions]
  }
  @scala.inline
  implicit class PlotDpoPointEventsOptionsOps[Self <: PlotDpoPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
