...
@js.native
trait PlotAreasplineConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAreasplineConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplineConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplineConnectorsMarkerOptionsOps[Self <: PlotAreasplineConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
