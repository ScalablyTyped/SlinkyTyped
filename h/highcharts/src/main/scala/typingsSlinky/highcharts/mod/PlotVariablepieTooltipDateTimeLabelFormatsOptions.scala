...
object PlotVariablepieTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotVariablepieTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotVariablepieTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotVariablepieTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
