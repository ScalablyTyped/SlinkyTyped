...
object PlotNatrAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotNatrAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotNatrAccessibilityKeyboardNavigationOptionsOps[Self <: PlotNatrAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
