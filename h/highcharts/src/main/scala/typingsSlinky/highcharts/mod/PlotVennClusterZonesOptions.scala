...
@js.native
trait PlotVennClusterZonesOptions extends js.Object {
...
object PlotVennClusterZonesOptions {
  ...
  @scala.inline
  implicit class PlotVennClusterZonesOptionsOps[Self <: PlotVennClusterZonesOptions] (val x: Self) extends AnyVal {
