...
object PlotArearangeConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotArearangeConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotArearangeConnectorsMarkerOptionsOps[Self <: PlotArearangeConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
