...
trait PlotVwapMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVwapMarkerStatesOptions] = js.native
  /**
...
object PlotVwapMarkerOptions {
  @scala.inline
  def apply(): PlotVwapMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapMarkerOptions]
  }
  @scala.inline
  implicit class PlotVwapMarkerOptionsOps[Self <: PlotVwapMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotVwapMarkerStatesOptions): Self = {
        val ret = this.duplicate
