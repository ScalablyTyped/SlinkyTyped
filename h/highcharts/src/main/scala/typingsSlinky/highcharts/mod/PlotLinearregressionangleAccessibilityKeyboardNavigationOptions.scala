...
object PlotLinearregressionangleAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleAccessibilityKeyboardNavigationOptionsOps[Self <: PlotLinearregressionangleAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
