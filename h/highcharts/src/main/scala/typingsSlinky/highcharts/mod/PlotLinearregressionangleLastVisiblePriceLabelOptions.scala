...
object PlotLinearregressionangleLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleLastVisiblePriceLabelOptionsOps[Self <: PlotLinearregressionangleLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
