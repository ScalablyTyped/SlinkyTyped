...
object PlotKeltnerchannelsMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsMarkerStatesSelectOptionsOps[Self <: PlotKeltnerchannelsMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
