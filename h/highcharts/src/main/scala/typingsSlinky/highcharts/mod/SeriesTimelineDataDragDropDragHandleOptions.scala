...
@js.native
trait SeriesTimelineDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesTimelineDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesTimelineDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTimelineDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesTimelineDataDragDropDragHandleOptionsOps[Self <: SeriesTimelineDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
