...
object PlotNatrMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotNatrMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotNatrMarkerStatesHoverOptionsOps[Self <: PlotNatrMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
