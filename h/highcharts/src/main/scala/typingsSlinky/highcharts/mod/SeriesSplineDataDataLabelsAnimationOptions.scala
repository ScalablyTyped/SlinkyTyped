...
@js.native
trait SeriesSplineDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesSplineDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): SeriesSplineDataDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSplineDataDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class SeriesSplineDataDataLabelsAnimationOptionsOps[Self <: SeriesSplineDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
