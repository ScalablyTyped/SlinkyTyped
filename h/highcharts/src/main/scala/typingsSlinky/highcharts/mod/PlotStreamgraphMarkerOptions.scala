...
trait PlotStreamgraphMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotStreamgraphMarkerStatesOptions] = js.native
  /**
...
object PlotStreamgraphMarkerOptions {
  @scala.inline
  def apply(): PlotStreamgraphMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphMarkerOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphMarkerOptionsOps[Self <: PlotStreamgraphMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotStreamgraphMarkerStatesOptions): Self = {
        val ret = this.duplicate
