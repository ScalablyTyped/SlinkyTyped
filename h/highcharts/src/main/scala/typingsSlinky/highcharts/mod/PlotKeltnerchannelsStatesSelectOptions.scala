...
trait PlotKeltnerchannelsStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotKeltnerchannelsStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotKeltnerchannelsStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotKeltnerchannelsStatesSelectOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsStatesSelectOptionsOps[Self <: PlotKeltnerchannelsStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotKeltnerchannelsStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotKeltnerchannelsStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
