...
object PlotMfiMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotMfiMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotMfiMarkerStatesInactiveOptionsOps[Self <: PlotMfiMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
