...
object PlotMapbubbleOptions {
  ...
  implicit class PlotMapbubbleOptionsOps[Self <: PlotMapbubbleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotMapbubbleDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotMapbubbleDataLabelsOptions | js.Array[PlotMapbubbleDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotMapbubbleDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJitter(value: PlotMapbubbleJitterOptions): Self = this.set("jitter", value.asInstanceOf[js.Any])
