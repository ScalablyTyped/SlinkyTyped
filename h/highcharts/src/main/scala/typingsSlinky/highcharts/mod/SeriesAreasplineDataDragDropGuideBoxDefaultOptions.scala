...
@js.native
trait SeriesAreasplineDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesAreasplineDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesAreasplineDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreasplineDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesAreasplineDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesAreasplineDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
