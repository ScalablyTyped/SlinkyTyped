...
trait PlotNetworkgraphStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotNetworkgraphStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotNetworkgraphStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotNetworkgraphStatesSelectOptions {
  @scala.inline
  def apply(): PlotNetworkgraphStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphStatesSelectOptionsOps[Self <: PlotNetworkgraphStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotNetworkgraphStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotNetworkgraphStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
