...
object PlotRsiStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotRsiStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotRsiStatesHoverAnimationOptionsOps[Self <: PlotRsiStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
