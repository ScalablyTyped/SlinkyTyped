...
trait PlotOrganizationStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotOrganizationStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for a single point node/link.
    */
  var inactive: js.UndefOr[PlotOrganizationStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotOrganizationStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotOrganizationStatesSelectOptions] = js.native
}

object PlotOrganizationStatesOptions {
  @scala.inline
  def apply(): PlotOrganizationStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationStatesOptions]
  }
  @scala.inline
  implicit class PlotOrganizationStatesOptionsOps[Self <: PlotOrganizationStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotOrganizationStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotOrganizationStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotOrganizationStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotOrganizationStatesSelectOptions): Self = {
        val ret = this.duplicate
