...
@js.native
trait PlotErrorbarEventsOptions extends js.Object {
  /**
...
object PlotErrorbarEventsOptions {
  @scala.inline
  def apply(): PlotErrorbarEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarEventsOptions]
  }
  @scala.inline
  implicit class PlotErrorbarEventsOptionsOps[Self <: PlotErrorbarEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
