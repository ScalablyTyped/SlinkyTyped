...
@js.native
trait PlotTilemapStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotTilemapStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotTilemapStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotTilemapStatesSelectHaloOptionsOps[Self <: PlotTilemapStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
