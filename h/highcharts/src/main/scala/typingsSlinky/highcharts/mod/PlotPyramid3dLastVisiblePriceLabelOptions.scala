...
object PlotPyramid3dLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotPyramid3dLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dLastVisiblePriceLabelOptionsOps[Self <: PlotPyramid3dLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
