...
trait PlotPcAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPcAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPcAccessibilityOptions {
  @scala.inline
  def apply(): PlotPcAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPcAccessibilityOptionsOps[Self <: PlotPcAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPcAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
