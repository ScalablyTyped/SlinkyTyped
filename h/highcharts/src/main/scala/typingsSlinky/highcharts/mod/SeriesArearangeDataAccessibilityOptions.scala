...
object SeriesArearangeDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesArearangeDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesArearangeDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesArearangeDataAccessibilityOptionsOps[Self <: SeriesArearangeDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
