...
@js.native
trait PlotWmaStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotWmaStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotWmaStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotWmaStatesSelectOptions {
  @scala.inline
  def apply(): PlotWmaStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotWmaStatesSelectOptionsOps[Self <: PlotWmaStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotWmaStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotWmaStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
