...
trait PlotTilemapStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTilemapStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTilemapStatesHoverHaloOptions] = js.native
  /**
...
object PlotTilemapStatesHoverOptions {
  @scala.inline
  def apply(): PlotTilemapStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTilemapStatesHoverOptionsOps[Self <: PlotTilemapStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotTilemapStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTilemapStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
