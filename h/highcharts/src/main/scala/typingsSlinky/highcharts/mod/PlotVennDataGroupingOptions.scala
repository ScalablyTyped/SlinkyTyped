...
@js.native
trait PlotVennDataGroupingOptions extends js.Object {
  /**
...
object PlotVennDataGroupingOptions {
  @scala.inline
  def apply(): PlotVennDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotVennDataGroupingOptionsOps[Self <: PlotVennDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
