...
object PlotBulletDragDropGuideBoxOptions {
  ...
  @scala.inline
  def apply(): PlotBulletDragDropGuideBoxOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletDragDropGuideBoxOptions]
  }
  
  @scala.inline
  implicit class PlotBulletDragDropGuideBoxOptionsMutableBuilder[Self <: PlotBulletDragDropGuideBoxOptions] (val x: Self) extends AnyVal {
