...
@js.native
trait PlotMacdConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotMacdConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotMacdConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotMacdConnectorsEndMarkerOptionsOps[Self <: PlotMacdConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
