...
trait PlotTilemapAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTilemapAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotTilemapAccessibilityOptions {
  @scala.inline
  def apply(): PlotTilemapAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotTilemapAccessibilityOptionsOps[Self <: PlotTilemapAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotTilemapAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
