...
object PlotAreaDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotAreaDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotAreaDragDropDragHandleOptionsOps[Self <: PlotAreaDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
