...
@js.native
trait PlotLollipopOptions extends js.Object {
...
object PlotLollipopOptions {
  ...
  @scala.inline
  implicit class PlotLollipopOptionsOps[Self <: PlotLollipopOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLollipopAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotLollipopDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
