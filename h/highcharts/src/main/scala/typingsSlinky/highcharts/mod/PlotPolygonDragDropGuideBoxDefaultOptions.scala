...
object PlotPolygonDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotPolygonDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotPolygonDragDropGuideBoxDefaultOptionsOps[Self <: PlotPolygonDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
