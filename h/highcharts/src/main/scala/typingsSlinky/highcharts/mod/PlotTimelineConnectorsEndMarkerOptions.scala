...
object PlotTimelineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotTimelineConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotTimelineConnectorsEndMarkerOptionsOps[Self <: PlotTimelineConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
