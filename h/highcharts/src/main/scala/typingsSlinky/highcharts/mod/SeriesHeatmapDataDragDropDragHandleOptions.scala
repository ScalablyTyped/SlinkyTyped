...
object SeriesHeatmapDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesHeatmapDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesHeatmapDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesHeatmapDataDragDropDragHandleOptionsOps[Self <: SeriesHeatmapDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
