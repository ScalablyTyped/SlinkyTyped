...
trait PlotScatterConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotScatterConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotScatterConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotScatterConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotScatterConnectorsOptions {
  @scala.inline
  def apply(): PlotScatterConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterConnectorsOptions]
  }
  @scala.inline
  implicit class PlotScatterConnectorsOptionsOps[Self <: PlotScatterConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotScatterConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotScatterConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotScatterConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
