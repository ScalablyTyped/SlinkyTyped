...
trait PlotErrorbarAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotErrorbarAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotErrorbarAccessibilityOptions {
  @scala.inline
  def apply(): PlotErrorbarAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotErrorbarAccessibilityOptionsOps[Self <: PlotErrorbarAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotErrorbarAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
