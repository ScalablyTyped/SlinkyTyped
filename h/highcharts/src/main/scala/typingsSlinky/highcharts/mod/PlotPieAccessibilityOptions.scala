...
trait PlotPieAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPieAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPieAccessibilityOptions {
  @scala.inline
  def apply(): PlotPieAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPieAccessibilityOptionsOps[Self <: PlotPieAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPieAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
