...
@js.native
trait PlotDemaEventsOptions extends js.Object {
  /**
...
object PlotDemaEventsOptions {
  @scala.inline
  def apply(): PlotDemaEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaEventsOptions]
  }
  @scala.inline
  implicit class PlotDemaEventsOptionsOps[Self <: PlotDemaEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
