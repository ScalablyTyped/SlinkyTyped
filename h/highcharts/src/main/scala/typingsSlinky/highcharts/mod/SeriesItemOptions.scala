...
object SeriesItemOptions {
  ...
  implicit class SeriesItemOptionsOps[Self <: SeriesItemOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | item): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesItemDataOptions]): Self = {
        val ret = this.duplicate
