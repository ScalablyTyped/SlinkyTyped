...
trait PlotPolygonConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPolygonConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPolygonConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPolygonConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotPolygonConnectorsOptions {
  @scala.inline
  def apply(): PlotPolygonConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonConnectorsOptions]
  }
  @scala.inline
  implicit class PlotPolygonConnectorsOptionsOps[Self <: PlotPolygonConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotPolygonConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotPolygonConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotPolygonConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
