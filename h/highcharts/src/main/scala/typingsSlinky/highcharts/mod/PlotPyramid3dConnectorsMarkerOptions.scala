...
object PlotPyramid3dConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPyramid3dConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dConnectorsMarkerOptionsOps[Self <: PlotPyramid3dConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
