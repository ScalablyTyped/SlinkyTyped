...
object PlotColumnAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotColumnAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotColumnAccessibilityKeyboardNavigationOptionsOps[Self <: PlotColumnAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
