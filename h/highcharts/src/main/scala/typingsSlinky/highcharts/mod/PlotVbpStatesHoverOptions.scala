...
@js.native
trait PlotVbpStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVbpStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVbpStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotVbpStatesHoverOptions {
  @scala.inline
  def apply(): PlotVbpStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotVbpStatesHoverOptionsOps[Self <: PlotVbpStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotVbpStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotVbpStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
