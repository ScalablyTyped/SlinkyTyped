...
object PlotBubbleMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotBubbleMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotBubbleMarkerStatesSelectOptionsOps[Self <: PlotBubbleMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
