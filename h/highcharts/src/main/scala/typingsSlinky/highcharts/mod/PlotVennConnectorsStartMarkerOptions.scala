...
@js.native
trait PlotVennConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotVennConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotVennConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotVennConnectorsStartMarkerOptionsOps[Self <: PlotVennConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
