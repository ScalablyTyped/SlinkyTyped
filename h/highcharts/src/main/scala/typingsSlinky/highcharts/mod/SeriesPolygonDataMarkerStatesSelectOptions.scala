...
object SeriesPolygonDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesPolygonDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPolygonDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesPolygonDataMarkerStatesSelectOptionsOps[Self <: SeriesPolygonDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
