...
trait PlotAoMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotAoMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotAoMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotAoMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotAoMarkerStatesSelectOptions] = js.native
}

object PlotAoMarkerStatesOptions {
  @scala.inline
  def apply(): PlotAoMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotAoMarkerStatesOptionsOps[Self <: PlotAoMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotAoMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotAoMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotAoMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotAoMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
