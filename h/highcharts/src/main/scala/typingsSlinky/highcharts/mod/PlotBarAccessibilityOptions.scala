...
trait PlotBarAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBarAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotBarAccessibilityOptions {
  @scala.inline
  def apply(): PlotBarAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotBarAccessibilityOptionsOps[Self <: PlotBarAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotBarAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
