...
object SeriesGanttDataMarkerStatesNormalOptions {
  @scala.inline
  def apply(): SeriesGanttDataMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataMarkerStatesNormalOptionsOps[Self <: SeriesGanttDataMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
