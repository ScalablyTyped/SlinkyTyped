...
object SeriesLineDataMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): SeriesLineDataMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class SeriesLineDataMarkerStatesInactiveOptionsOps[Self <: SeriesLineDataMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
