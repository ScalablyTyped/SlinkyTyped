...
@js.native
trait PlotScatterDataGroupingOptions extends js.Object {
  /**
...
object PlotScatterDataGroupingOptions {
  @scala.inline
  def apply(): PlotScatterDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotScatterDataGroupingOptionsOps[Self <: PlotScatterDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
