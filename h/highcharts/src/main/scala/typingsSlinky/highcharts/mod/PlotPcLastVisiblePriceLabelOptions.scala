...
object PlotPcLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotPcLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotPcLastVisiblePriceLabelOptionsOps[Self <: PlotPcLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
