...
object ZAxisDateTimeLabelFormatsMillisecondOptions {
  @scala.inline
  def apply(): ZAxisDateTimeLabelFormatsMillisecondOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisDateTimeLabelFormatsMillisecondOptions]
  }
  @scala.inline
  implicit class ZAxisDateTimeLabelFormatsMillisecondOptionsOps[Self <: ZAxisDateTimeLabelFormatsMillisecondOptions] (val x: Self) extends AnyVal {
    @scala.inline
