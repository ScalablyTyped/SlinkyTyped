...
trait PlotFunnel3dConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotFunnel3dConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotFunnel3dConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotFunnel3dConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotFunnel3dConnectorsOptions {
  @scala.inline
  def apply(): PlotFunnel3dConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dConnectorsOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dConnectorsOptionsOps[Self <: PlotFunnel3dConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotFunnel3dConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotFunnel3dConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotFunnel3dConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
