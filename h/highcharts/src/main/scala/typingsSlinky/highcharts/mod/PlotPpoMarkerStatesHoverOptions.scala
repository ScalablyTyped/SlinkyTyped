...
object PlotPpoMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotPpoMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPpoMarkerStatesHoverOptionsOps[Self <: PlotPpoMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
