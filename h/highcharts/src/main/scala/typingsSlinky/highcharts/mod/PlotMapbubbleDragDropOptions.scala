...
trait PlotMapbubbleDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotMapbubbleDragDropDragHandleOptions] = js.native
  /**
...
object PlotMapbubbleDragDropOptions {
  @scala.inline
  def apply(): PlotMapbubbleDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleDragDropOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleDragDropOptionsOps[Self <: PlotMapbubbleDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotMapbubbleDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotMapbubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
