...
object PlotAreasplineDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotAreasplineDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotAreasplineDragDropDragHandleOptionsOps[Self <: PlotAreasplineDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
