...
object SeriesBubbleDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesBubbleDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBubbleDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesBubbleDataMarkerStatesHoverOptionsOps[Self <: SeriesBubbleDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
