...
object PlotRsiConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotRsiConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotRsiConnectorsMarkerOptionsOps[Self <: PlotRsiConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
