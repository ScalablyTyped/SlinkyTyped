...
trait PlotAoAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAoAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAoAccessibilityOptions {
  @scala.inline
  def apply(): PlotAoAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAoAccessibilityOptionsOps[Self <: PlotAoAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAoAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
