...
object PlotItemMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotItemMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotItemMarkerStatesInactiveOptionsOps[Self <: PlotItemMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
