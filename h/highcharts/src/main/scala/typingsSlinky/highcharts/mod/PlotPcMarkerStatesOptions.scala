...
trait PlotPcMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotPcMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotPcMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotPcMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotPcMarkerStatesSelectOptions] = js.native
}

object PlotPcMarkerStatesOptions {
  @scala.inline
  def apply(): PlotPcMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotPcMarkerStatesOptionsOps[Self <: PlotPcMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotPcMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotPcMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotPcMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotPcMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
