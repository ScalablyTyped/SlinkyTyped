...
trait PlotPyramidConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPyramidConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPyramidConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPyramidConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotPyramidConnectorsOptions {
  @scala.inline
  def apply(): PlotPyramidConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidConnectorsOptions]
  }
  @scala.inline
  implicit class PlotPyramidConnectorsOptionsOps[Self <: PlotPyramidConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotPyramidConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotPyramidConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotPyramidConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
