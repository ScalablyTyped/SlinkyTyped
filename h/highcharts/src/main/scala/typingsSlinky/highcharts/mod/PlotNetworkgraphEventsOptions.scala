...
@js.native
trait PlotNetworkgraphEventsOptions extends js.Object {
  /**
...
object PlotNetworkgraphEventsOptions {
  @scala.inline
  def apply(): PlotNetworkgraphEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphEventsOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphEventsOptionsOps[Self <: PlotNetworkgraphEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
