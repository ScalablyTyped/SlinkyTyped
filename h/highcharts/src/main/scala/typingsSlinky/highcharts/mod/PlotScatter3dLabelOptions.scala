...
@js.native
trait PlotScatter3dLabelOptions extends js.Object {
  /**
...
object PlotScatter3dLabelOptions {
  @scala.inline
  def apply(): PlotScatter3dLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dLabelOptions]
  }
  @scala.inline
  implicit class PlotScatter3dLabelOptionsOps[Self <: PlotScatter3dLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
