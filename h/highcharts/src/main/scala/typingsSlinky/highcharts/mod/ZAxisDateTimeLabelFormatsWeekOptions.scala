...
object ZAxisDateTimeLabelFormatsWeekOptions {
  @scala.inline
  def apply(): ZAxisDateTimeLabelFormatsWeekOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisDateTimeLabelFormatsWeekOptions]
  }
  @scala.inline
  implicit class ZAxisDateTimeLabelFormatsWeekOptionsOps[Self <: ZAxisDateTimeLabelFormatsWeekOptions] (val x: Self) extends AnyVal {
    @scala.inline
