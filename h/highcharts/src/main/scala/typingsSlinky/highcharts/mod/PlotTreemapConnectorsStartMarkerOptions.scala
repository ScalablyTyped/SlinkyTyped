...
object PlotTreemapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotTreemapConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotTreemapConnectorsStartMarkerOptionsOps[Self <: PlotTreemapConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
