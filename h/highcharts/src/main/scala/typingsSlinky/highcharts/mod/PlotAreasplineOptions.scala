...
object PlotAreasplineOptions {
  ...
  @scala.inline
  implicit class PlotAreasplineOptionsMutableBuilder[Self <: PlotAreasplineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAreasplineAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotAreasplineDataLabelsOptions | js.Array[PlotAreasplineDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotAreasplineDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAreasplineDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
