...
@js.native
trait SeriesVectorDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesVectorDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesVectorDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVectorDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesVectorDataMarkerStatesSelectOptionsOps[Self <: SeriesVectorDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
