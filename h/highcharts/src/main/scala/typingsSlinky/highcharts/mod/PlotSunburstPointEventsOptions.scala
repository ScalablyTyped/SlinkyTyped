...
@js.native
trait PlotSunburstPointEventsOptions extends js.Object {
  /**
...
object PlotSunburstPointEventsOptions {
  @scala.inline
  def apply(): PlotSunburstPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstPointEventsOptions]
  }
  @scala.inline
  implicit class PlotSunburstPointEventsOptionsOps[Self <: PlotSunburstPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLegendItemClick(value: PointLegendItemClickCallbackFunction): Self = {
        val ret = this.duplicate
