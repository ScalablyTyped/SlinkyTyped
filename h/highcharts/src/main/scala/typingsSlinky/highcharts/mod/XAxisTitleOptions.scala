...
@js.native
trait XAxisTitleOptions extends AxisTitleOptions {
...
object XAxisTitleOptions {
  
  @scala.inline
  def apply(): XAxisTitleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisTitleOptions]
  }
  ...
  implicit class XAxisTitleOptionsMutableBuilder[Self <: XAxisTitleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPosition3d(value: chart_ | flap | typingsSlinky.highcharts.highchartsStrings.offset | ortho): Self = StObject.set(x, "position3d", value.asInstanceOf[js.Any])
