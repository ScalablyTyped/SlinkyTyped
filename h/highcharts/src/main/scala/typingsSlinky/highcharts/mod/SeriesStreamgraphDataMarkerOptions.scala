...
@js.native
trait SeriesStreamgraphDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesStreamgraphDataMarkerStatesOptions] = js.native
  /**
...
object SeriesStreamgraphDataMarkerOptions {
  @scala.inline
  def apply(): SeriesStreamgraphDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesStreamgraphDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesStreamgraphDataMarkerOptionsOps[Self <: SeriesStreamgraphDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesStreamgraphDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
