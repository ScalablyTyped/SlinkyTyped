...
object PlotGanttDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotGanttDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotGanttDragDropGuideBoxDefaultOptionsOps[Self <: PlotGanttDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
