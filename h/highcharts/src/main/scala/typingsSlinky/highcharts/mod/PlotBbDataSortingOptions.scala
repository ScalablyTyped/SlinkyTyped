...
@js.native
trait PlotBbDataSortingOptions extends StObject {
...
object PlotBbDataSortingOptions {
  
  @scala.inline
  def apply(): PlotBbDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotBbDataSortingOptionsMutableBuilder[Self <: PlotBbDataSortingOptions] (val x: Self) extends AnyVal {
