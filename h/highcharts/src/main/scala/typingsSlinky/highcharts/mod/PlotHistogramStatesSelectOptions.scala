...
trait PlotHistogramStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotHistogramStatesSelectAnimationOptions] = js.native
  /**
...
object PlotHistogramStatesSelectOptions {
  @scala.inline
  def apply(): PlotHistogramStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotHistogramStatesSelectOptionsOps[Self <: PlotHistogramStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotHistogramStatesSelectAnimationOptions): Self = {
