...
object PlotTrendlineStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotTrendlineStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotTrendlineStatesSelectAnimationOptionsOps[Self <: PlotTrendlineStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
