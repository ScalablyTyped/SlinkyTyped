...
trait PlotStochasticAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotStochasticAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotStochasticAccessibilityOptions {
  @scala.inline
  def apply(): PlotStochasticAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotStochasticAccessibilityOptionsOps[Self <: PlotStochasticAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotStochasticAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
