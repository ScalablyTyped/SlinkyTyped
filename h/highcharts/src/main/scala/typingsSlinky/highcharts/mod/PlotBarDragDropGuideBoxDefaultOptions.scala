...
object PlotBarDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotBarDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotBarDragDropGuideBoxDefaultOptionsOps[Self <: PlotBarDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
