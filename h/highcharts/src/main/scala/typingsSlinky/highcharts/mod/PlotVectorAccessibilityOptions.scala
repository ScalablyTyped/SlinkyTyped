...
trait PlotVectorAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVectorAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotVectorAccessibilityOptions {
  @scala.inline
  def apply(): PlotVectorAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotVectorAccessibilityOptionsOps[Self <: PlotVectorAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotVectorAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
