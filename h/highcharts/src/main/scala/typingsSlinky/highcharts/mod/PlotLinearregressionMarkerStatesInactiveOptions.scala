...
object PlotLinearregressionMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotLinearregressionMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionMarkerStatesInactiveOptionsOps[Self <: PlotLinearregressionMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
