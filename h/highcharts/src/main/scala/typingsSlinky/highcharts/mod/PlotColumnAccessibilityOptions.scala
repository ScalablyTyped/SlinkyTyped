...
trait PlotColumnAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotColumnAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotColumnAccessibilityOptions {
  @scala.inline
  def apply(): PlotColumnAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotColumnAccessibilityOptionsOps[Self <: PlotColumnAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotColumnAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
