...
trait PlotMaplineStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMaplineStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMaplineStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotMaplineStatesHoverOptions {
  @scala.inline
  def apply(): PlotMaplineStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMaplineStatesHoverOptionsOps[Self <: PlotMaplineStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotMaplineStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMaplineStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
