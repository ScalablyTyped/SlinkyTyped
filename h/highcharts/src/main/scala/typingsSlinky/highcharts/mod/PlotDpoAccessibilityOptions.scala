...
trait PlotDpoAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotDpoAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotDpoAccessibilityOptions {
  @scala.inline
  def apply(): PlotDpoAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotDpoAccessibilityOptionsOps[Self <: PlotDpoAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotDpoAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
