...
trait PlotVbpMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotVbpMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotVbpMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotVbpMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotVbpMarkerStatesSelectOptions] = js.native
}

object PlotVbpMarkerStatesOptions {
  @scala.inline
  def apply(): PlotVbpMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotVbpMarkerStatesOptionsOps[Self <: PlotVbpMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotVbpMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotVbpMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotVbpMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotVbpMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
