...
object PlotItemConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotItemConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotItemConnectorsStartMarkerOptionsOps[Self <: PlotItemConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
