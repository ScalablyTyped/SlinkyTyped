...
object SeriesTimelineDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesTimelineDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTimelineDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesTimelineDataAccessibilityOptionsOps[Self <: SeriesTimelineDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
