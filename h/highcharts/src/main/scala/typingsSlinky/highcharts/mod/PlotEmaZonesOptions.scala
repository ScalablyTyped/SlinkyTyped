...
@js.native
trait PlotEmaZonesOptions extends js.Object {
  /**
...
object PlotEmaZonesOptions {
  @scala.inline
  def apply(): PlotEmaZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaZonesOptions]
  }
  @scala.inline
  implicit class PlotEmaZonesOptionsOps[Self <: PlotEmaZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
