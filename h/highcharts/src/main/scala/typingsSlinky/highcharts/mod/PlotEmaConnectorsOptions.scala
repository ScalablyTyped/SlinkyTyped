...
trait PlotEmaConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotEmaConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotEmaConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotEmaConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotEmaConnectorsOptions {
  @scala.inline
  def apply(): PlotEmaConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaConnectorsOptions]
  }
  @scala.inline
  implicit class PlotEmaConnectorsOptionsOps[Self <: PlotEmaConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotEmaConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotEmaConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotEmaConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
