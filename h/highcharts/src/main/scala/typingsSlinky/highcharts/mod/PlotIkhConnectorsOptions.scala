...
trait PlotIkhConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotIkhConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotIkhConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotIkhConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotIkhConnectorsOptions {
  @scala.inline
  def apply(): PlotIkhConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhConnectorsOptions]
  }
  @scala.inline
  implicit class PlotIkhConnectorsOptionsOps[Self <: PlotIkhConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotIkhConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotIkhConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotIkhConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
