...
@js.native
trait PlotApoStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotApoStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotApoStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotApoStatesHoverOptions {
  @scala.inline
  def apply(): PlotApoStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotApoStatesHoverOptionsOps[Self <: PlotApoStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotApoStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotApoStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
