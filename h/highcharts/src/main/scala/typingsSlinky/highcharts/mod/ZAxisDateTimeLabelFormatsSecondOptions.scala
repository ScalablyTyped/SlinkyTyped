...
object ZAxisDateTimeLabelFormatsSecondOptions {
  @scala.inline
  def apply(): ZAxisDateTimeLabelFormatsSecondOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisDateTimeLabelFormatsSecondOptions]
  }
  @scala.inline
  implicit class ZAxisDateTimeLabelFormatsSecondOptionsOps[Self <: ZAxisDateTimeLabelFormatsSecondOptions] (val x: Self) extends AnyVal {
    @scala.inline
