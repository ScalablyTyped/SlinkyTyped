...
object PlotSplineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotSplineConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotSplineConnectorsStartMarkerOptionsOps[Self <: PlotSplineConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
