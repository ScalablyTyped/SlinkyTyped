...
trait PlotStreamgraphDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotStreamgraphDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotStreamgraphDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotStreamgraphDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotStreamgraphDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotStreamgraphDragDropOptions = {
