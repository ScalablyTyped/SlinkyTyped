...
trait PlotPsarMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPsarMarkerStatesOptions] = js.native
  /**
...
object PlotPsarMarkerOptions {
  @scala.inline
  def apply(): PlotPsarMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarMarkerOptions]
  }
  @scala.inline
  implicit class PlotPsarMarkerOptionsOps[Self <: PlotPsarMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotPsarMarkerStatesOptions): Self = {
        val ret = this.duplicate
