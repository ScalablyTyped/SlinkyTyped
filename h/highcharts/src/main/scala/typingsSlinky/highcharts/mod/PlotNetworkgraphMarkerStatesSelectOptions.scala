...
object PlotNetworkgraphMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotNetworkgraphMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphMarkerStatesSelectOptionsOps[Self <: PlotNetworkgraphMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
