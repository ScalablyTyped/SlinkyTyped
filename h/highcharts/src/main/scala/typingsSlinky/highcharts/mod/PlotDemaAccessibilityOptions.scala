...
trait PlotDemaAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotDemaAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotDemaAccessibilityOptions {
  @scala.inline
  def apply(): PlotDemaAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotDemaAccessibilityOptionsOps[Self <: PlotDemaAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotDemaAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
