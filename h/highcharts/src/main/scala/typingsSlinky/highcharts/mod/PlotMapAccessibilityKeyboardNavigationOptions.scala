...
object PlotMapAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotMapAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotMapAccessibilityKeyboardNavigationOptionsOps[Self <: PlotMapAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
