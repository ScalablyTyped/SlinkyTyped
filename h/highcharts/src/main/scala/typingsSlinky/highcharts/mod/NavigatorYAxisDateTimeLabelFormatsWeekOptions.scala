...
object NavigatorYAxisDateTimeLabelFormatsWeekOptions {
  @scala.inline
  def apply(): NavigatorYAxisDateTimeLabelFormatsWeekOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisDateTimeLabelFormatsWeekOptions]
  }
  @scala.inline
  implicit class NavigatorYAxisDateTimeLabelFormatsWeekOptionsOps[Self <: NavigatorYAxisDateTimeLabelFormatsWeekOptions] (val x: Self) extends AnyVal {
    @scala.inline
