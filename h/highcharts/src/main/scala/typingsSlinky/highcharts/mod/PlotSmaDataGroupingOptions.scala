...
@js.native
trait PlotSmaDataGroupingOptions extends js.Object {
  /**
...
object PlotSmaDataGroupingOptions {
  @scala.inline
  def apply(): PlotSmaDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotSmaDataGroupingOptionsOps[Self <: PlotSmaDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
