...
object PlotMomentumConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotMomentumConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotMomentumConnectorsStartMarkerOptionsOps[Self <: PlotMomentumConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
