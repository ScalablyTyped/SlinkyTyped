...
trait PlotRocAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotRocAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotRocAccessibilityOptions {
  @scala.inline
  def apply(): PlotRocAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotRocAccessibilityOptionsOps[Self <: PlotRocAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotRocAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
