...
trait PlotNetworkgraphConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotNetworkgraphConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotNetworkgraphConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotNetworkgraphConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotNetworkgraphConnectorsOptions {
  @scala.inline
  def apply(): PlotNetworkgraphConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphConnectorsOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphConnectorsOptionsOps[Self <: PlotNetworkgraphConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotNetworkgraphConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotNetworkgraphConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotNetworkgraphConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
