...
trait PlotCylinderAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotCylinderAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotCylinderAccessibilityOptions {
  @scala.inline
  def apply(): PlotCylinderAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotCylinderAccessibilityOptionsOps[Self <: PlotCylinderAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotCylinderAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
