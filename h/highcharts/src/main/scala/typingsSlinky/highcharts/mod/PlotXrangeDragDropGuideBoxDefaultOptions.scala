...
object PlotXrangeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotXrangeDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotXrangeDragDropGuideBoxDefaultOptionsOps[Self <: PlotXrangeDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
