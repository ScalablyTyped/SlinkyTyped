...
@js.native
trait PlotEmaMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotEmaMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotEmaMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotEmaMarkerStatesSelectOptionsOps[Self <: PlotEmaMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
