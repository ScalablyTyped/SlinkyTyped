...
trait PlotLinearregressionangleAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLinearregressionangleAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotLinearregressionangleAccessibilityOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleAccessibilityOptionsOps[Self <: PlotLinearregressionangleAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotLinearregressionangleAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
