...
object PlotFunnel3dStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotFunnel3dStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dStatesHoverAnimationOptionsOps[Self <: PlotFunnel3dStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
