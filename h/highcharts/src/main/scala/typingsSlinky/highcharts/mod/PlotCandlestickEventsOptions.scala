...
@js.native
trait PlotCandlestickEventsOptions extends js.Object {
  /**
...
object PlotCandlestickEventsOptions {
  @scala.inline
  def apply(): PlotCandlestickEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickEventsOptions]
  }
  @scala.inline
  implicit class PlotCandlestickEventsOptionsOps[Self <: PlotCandlestickEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
