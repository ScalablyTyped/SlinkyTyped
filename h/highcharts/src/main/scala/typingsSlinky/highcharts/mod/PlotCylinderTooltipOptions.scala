...
trait PlotCylinderTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotCylinderTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotCylinderTooltipOptions {
  @scala.inline
  def apply(): PlotCylinderTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderTooltipOptions]
  }
  @scala.inline
  implicit class PlotCylinderTooltipOptionsOps[Self <: PlotCylinderTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotCylinderTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
