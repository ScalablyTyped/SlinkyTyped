...
trait PlotAreasplineTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotAreasplineTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotAreasplineTooltipOptions {
  @scala.inline
  def apply(): PlotAreasplineTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineTooltipOptions]
  }
  @scala.inline
  implicit class PlotAreasplineTooltipOptionsOps[Self <: PlotAreasplineTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotAreasplineTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
