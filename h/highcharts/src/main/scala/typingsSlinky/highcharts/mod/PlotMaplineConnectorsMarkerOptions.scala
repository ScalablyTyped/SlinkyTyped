...
object PlotMaplineConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotMaplineConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotMaplineConnectorsMarkerOptionsOps[Self <: PlotMaplineConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
