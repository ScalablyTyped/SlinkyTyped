...
@js.native
trait PlotLinearregressionangleLabelOptions extends js.Object {
  /**
...
object PlotLinearregressionangleLabelOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleLabelOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleLabelOptionsOps[Self <: PlotLinearregressionangleLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
