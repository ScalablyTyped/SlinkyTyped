...
trait PlotAreaAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAreaAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAreaAccessibilityOptions {
  @scala.inline
  def apply(): PlotAreaAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAreaAccessibilityOptionsOps[Self <: PlotAreaAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAreaAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
