...
@js.native
trait PlotAdConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAdConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAdConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAdConnectorsEndMarkerOptionsOps[Self <: PlotAdConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
