...
object PlotWindbarbStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotWindbarbStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotWindbarbStatesSelectAnimationOptionsOps[Self <: PlotWindbarbStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
