...
@js.native
trait SeriesColumnrangeDataEventsOptions extends js.Object {
  /**
...
object SeriesColumnrangeDataEventsOptions {
  @scala.inline
  def apply(): SeriesColumnrangeDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnrangeDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesColumnrangeDataEventsOptionsOps[Self <: SeriesColumnrangeDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
