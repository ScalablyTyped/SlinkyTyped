...
@js.native
trait AnnotationsElliottWaveLabelOptions extends StObject {
...
object AnnotationsElliottWaveLabelOptions {
  ...
  @scala.inline
  implicit class AnnotationsElliottWaveLabelOptionsMutableBuilder[Self <: AnnotationsElliottWaveLabelOptions] (val x: Self) extends AnyVal {
