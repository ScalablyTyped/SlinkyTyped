...
object PlotPpoStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotPpoStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotPpoStatesSelectHaloOptionsOps[Self <: PlotPpoStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
