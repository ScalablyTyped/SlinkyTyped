...
@js.native
trait SeriesTilemapDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesTilemapDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesTilemapDataDataLabelsAnimationOptionsOps[Self <: SeriesTilemapDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
