...
object PlotScatter3dPointEventsOptions {
  @scala.inline
  def apply(): PlotScatter3dPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dPointEventsOptions]
  }
  @scala.inline
  implicit class PlotScatter3dPointEventsOptionsOps[Self <: PlotScatter3dPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
