...
object SeriesScatterDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesScatterDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatterDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesScatterDataMarkerStatesSelectOptionsOps[Self <: SeriesScatterDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
