...
object PlotAroonConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotAroonConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonConnectorsMarkerOptionsOps[Self <: PlotAroonConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
