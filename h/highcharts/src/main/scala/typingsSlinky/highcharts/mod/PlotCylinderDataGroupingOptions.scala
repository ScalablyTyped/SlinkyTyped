...
@js.native
trait PlotCylinderDataGroupingOptions extends js.Object {
  /**
...
object PlotCylinderDataGroupingOptions {
  @scala.inline
  def apply(): PlotCylinderDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotCylinderDataGroupingOptionsOps[Self <: PlotCylinderDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
