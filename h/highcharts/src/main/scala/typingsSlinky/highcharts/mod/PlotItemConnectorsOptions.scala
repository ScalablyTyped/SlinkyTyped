...
trait PlotItemConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotItemConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotItemConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotItemConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotItemConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotItemConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotItemConnectorsMarkerOptions = null,
    startMarker: PlotItemConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotItemConnectorsOptions = {
