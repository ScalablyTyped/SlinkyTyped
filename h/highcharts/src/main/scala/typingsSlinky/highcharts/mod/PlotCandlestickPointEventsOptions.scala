...
@js.native
trait PlotCandlestickPointEventsOptions extends js.Object {
  /**
...
object PlotCandlestickPointEventsOptions {
  @scala.inline
  def apply(): PlotCandlestickPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickPointEventsOptions]
  }
  @scala.inline
  implicit class PlotCandlestickPointEventsOptionsOps[Self <: PlotCandlestickPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
