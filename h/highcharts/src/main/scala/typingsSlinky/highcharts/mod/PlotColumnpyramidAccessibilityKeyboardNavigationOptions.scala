...
object PlotColumnpyramidAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotColumnpyramidAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidAccessibilityKeyboardNavigationOptionsOps[Self <: PlotColumnpyramidAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
