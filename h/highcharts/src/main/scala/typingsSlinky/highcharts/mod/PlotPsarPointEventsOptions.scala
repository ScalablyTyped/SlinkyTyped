...
@js.native
trait PlotPsarPointEventsOptions extends js.Object {
  /**
...
object PlotPsarPointEventsOptions {
  @scala.inline
  def apply(): PlotPsarPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarPointEventsOptions]
  }
  @scala.inline
  implicit class PlotPsarPointEventsOptionsOps[Self <: PlotPsarPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
