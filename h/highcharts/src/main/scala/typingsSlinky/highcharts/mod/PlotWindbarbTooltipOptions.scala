...
trait PlotWindbarbTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotWindbarbTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotWindbarbTooltipOptions {
  @scala.inline
  def apply(): PlotWindbarbTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbTooltipOptions]
  }
  @scala.inline
  implicit class PlotWindbarbTooltipOptionsOps[Self <: PlotWindbarbTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotWindbarbTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
