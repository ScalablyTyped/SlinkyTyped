...
trait PlotTrendlineStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTrendlineStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTrendlineStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotTrendlineStatesHoverOptions {
  @scala.inline
  def apply(): PlotTrendlineStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTrendlineStatesHoverOptionsOps[Self <: PlotTrendlineStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotTrendlineStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTrendlineStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
