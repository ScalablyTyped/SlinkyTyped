...
object PlotIkhStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotIkhStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotIkhStatesSelectHaloOptionsOps[Self <: PlotIkhStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
