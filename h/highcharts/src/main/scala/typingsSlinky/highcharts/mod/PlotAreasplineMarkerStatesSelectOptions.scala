...
object PlotAreasplineMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAreasplineMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAreasplineMarkerStatesSelectOptionsOps[Self <: PlotAreasplineMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
