...
object SeriesGanttDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesGanttDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataMarkerStatesHoverOptionsOps[Self <: SeriesGanttDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
