...
object PlotTreemapTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotTreemapTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotTreemapTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotTreemapTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
