...
@js.native
trait PlotDemaMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotDemaMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotDemaMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotDemaMarkerStatesHoverOptionsOps[Self <: PlotDemaMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
