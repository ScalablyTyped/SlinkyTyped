...
trait SeriesLineDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesLineDataMarkerStatesOptions] = js.native
  /**
...
object SeriesLineDataMarkerOptions {
  @scala.inline
  def apply(): SeriesLineDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesLineDataMarkerOptionsOps[Self <: SeriesLineDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesLineDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
