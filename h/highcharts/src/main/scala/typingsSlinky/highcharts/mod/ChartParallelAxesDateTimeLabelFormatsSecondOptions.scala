...
object ChartParallelAxesDateTimeLabelFormatsSecondOptions {
  @scala.inline
  def apply(): ChartParallelAxesDateTimeLabelFormatsSecondOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesDateTimeLabelFormatsSecondOptions]
  }
  @scala.inline
  implicit class ChartParallelAxesDateTimeLabelFormatsSecondOptionsOps[Self <: ChartParallelAxesDateTimeLabelFormatsSecondOptions] (val x: Self) extends AnyVal {
    @scala.inline
