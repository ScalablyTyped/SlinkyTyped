...
trait SeriesFunnel3dOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | js.Array[Double] | SeriesFunnel3dDataOptions]] = js.native
  /**
...
object SeriesFunnel3dOptions {
  ...
  implicit class SeriesFunnel3dOptionsOps[Self <: SeriesFunnel3dOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | funnel3d): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | js.Array[Double] | SeriesFunnel3dDataOptions]): Self = {
        val ret = this.duplicate
