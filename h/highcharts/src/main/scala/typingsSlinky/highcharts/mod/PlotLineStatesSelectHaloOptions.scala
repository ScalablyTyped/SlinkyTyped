...
object PlotLineStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotLineStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotLineStatesSelectHaloOptionsOps[Self <: PlotLineStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
