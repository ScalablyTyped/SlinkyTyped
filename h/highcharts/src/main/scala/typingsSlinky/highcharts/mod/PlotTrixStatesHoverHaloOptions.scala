...
object PlotTrixStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotTrixStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotTrixStatesHoverHaloOptionsOps[Self <: PlotTrixStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
