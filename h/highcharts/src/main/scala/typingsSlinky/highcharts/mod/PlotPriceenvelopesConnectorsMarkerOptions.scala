...
object PlotPriceenvelopesConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesConnectorsMarkerOptionsOps[Self <: PlotPriceenvelopesConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
