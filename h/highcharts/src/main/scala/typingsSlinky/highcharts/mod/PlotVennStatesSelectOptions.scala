...
trait PlotVennStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | PlotVennStatesSelectAnimationOptions] = js.native
  /**
...
object PlotVennStatesSelectOptions {
  @scala.inline
  def apply(): PlotVennStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotVennStatesSelectOptionsOps[Self <: PlotVennStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | PlotVennStatesSelectAnimationOptions): Self = {
