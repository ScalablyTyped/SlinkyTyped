...
object NavigatorXAxisDateTimeLabelFormatsDayOptions {
  @scala.inline
  def apply(): NavigatorXAxisDateTimeLabelFormatsDayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisDateTimeLabelFormatsDayOptions]
  }
  @scala.inline
  implicit class NavigatorXAxisDateTimeLabelFormatsDayOptionsOps[Self <: NavigatorXAxisDateTimeLabelFormatsDayOptions] (val x: Self) extends AnyVal {
    @scala.inline
