...
object PlotKeltnerchannelsLabelOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsLabelOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsLabelOptionsOps[Self <: PlotKeltnerchannelsLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
