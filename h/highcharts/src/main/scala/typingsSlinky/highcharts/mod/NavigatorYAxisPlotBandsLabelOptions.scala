...
@js.native
trait NavigatorYAxisPlotBandsLabelOptions extends js.Object {
...
object NavigatorYAxisPlotBandsLabelOptions {
  ...
  @scala.inline
  implicit class NavigatorYAxisPlotBandsLabelOptionsOps[Self <: NavigatorYAxisPlotBandsLabelOptions] (val x: Self) extends AnyVal {
