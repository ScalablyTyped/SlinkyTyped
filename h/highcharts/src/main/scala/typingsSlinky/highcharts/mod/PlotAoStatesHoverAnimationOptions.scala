...
object PlotAoStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotAoStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotAoStatesHoverAnimationOptionsOps[Self <: PlotAoStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
