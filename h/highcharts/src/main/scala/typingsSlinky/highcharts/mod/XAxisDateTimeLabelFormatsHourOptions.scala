...
object XAxisDateTimeLabelFormatsHourOptions {
  @scala.inline
  def apply(): XAxisDateTimeLabelFormatsHourOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisDateTimeLabelFormatsHourOptions]
  }
  @scala.inline
  implicit class XAxisDateTimeLabelFormatsHourOptionsOps[Self <: XAxisDateTimeLabelFormatsHourOptions] (val x: Self) extends AnyVal {
    @scala.inline
