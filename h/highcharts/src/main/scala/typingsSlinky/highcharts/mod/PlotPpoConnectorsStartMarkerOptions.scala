...
object PlotPpoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPpoConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPpoConnectorsStartMarkerOptionsOps[Self <: PlotPpoConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
