...
object PlotAreasplinerangeLastPriceOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeLastPriceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeLastPriceOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeLastPriceOptionsOps[Self <: PlotAreasplinerangeLastPriceOptions] (val x: Self) extends AnyVal {
    @scala.inline
