...
@js.native
trait SeriesGanttDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesGanttDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesGanttDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesGanttDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
