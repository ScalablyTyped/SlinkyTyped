...
@js.native
trait PlotCandlestickConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotCandlestickConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotCandlestickConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotCandlestickConnectorsMarkerOptionsOps[Self <: PlotCandlestickConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
