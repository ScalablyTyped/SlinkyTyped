...
object PlotSunburstConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotSunburstConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotSunburstConnectorsStartMarkerOptionsOps[Self <: PlotSunburstConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
