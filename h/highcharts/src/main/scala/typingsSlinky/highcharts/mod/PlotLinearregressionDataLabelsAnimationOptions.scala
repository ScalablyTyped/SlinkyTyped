...
@js.native
trait PlotLinearregressionDataLabelsAnimationOptions extends js.Object {
...
object PlotLinearregressionDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionDataLabelsAnimationOptionsOps[Self <: PlotLinearregressionDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
