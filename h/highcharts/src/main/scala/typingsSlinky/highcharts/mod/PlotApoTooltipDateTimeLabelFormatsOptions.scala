...
@js.native
trait PlotApoTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotApoTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotApoTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotApoTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotApoTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
