...
trait SeriesOrganizationOptions extends PlotOrganizationOptions {
...
object SeriesOrganizationOptions {
  ...
  @scala.inline
  implicit class SeriesOrganizationOptionsMutableBuilder[Self <: SeriesOrganizationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | organization): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
