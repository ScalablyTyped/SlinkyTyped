...
@js.native
trait PlotPcPointEventsOptions extends js.Object {
  /**
...
object PlotPcPointEventsOptions {
  @scala.inline
  def apply(): PlotPcPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcPointEventsOptions]
  }
  @scala.inline
  implicit class PlotPcPointEventsOptionsOps[Self <: PlotPcPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
