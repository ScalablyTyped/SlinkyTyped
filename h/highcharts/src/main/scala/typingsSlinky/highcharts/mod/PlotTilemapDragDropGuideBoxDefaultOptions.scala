...
object PlotTilemapDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotTilemapDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotTilemapDragDropGuideBoxDefaultOptionsOps[Self <: PlotTilemapDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
