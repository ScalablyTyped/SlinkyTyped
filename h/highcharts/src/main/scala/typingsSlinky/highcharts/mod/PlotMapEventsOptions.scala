...
@js.native
trait PlotMapEventsOptions extends js.Object {
  /**
...
object PlotMapEventsOptions {
  @scala.inline
  def apply(): PlotMapEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapEventsOptions]
  }
  @scala.inline
  implicit class PlotMapEventsOptionsOps[Self <: PlotMapEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
