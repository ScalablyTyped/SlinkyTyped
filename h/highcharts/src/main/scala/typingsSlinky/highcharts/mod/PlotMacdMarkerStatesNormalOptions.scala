...
object PlotMacdMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotMacdMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotMacdMarkerStatesNormalOptionsOps[Self <: PlotMacdMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
