...
@js.native
trait PlotBbStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBbStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBbStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotBbStatesHoverOptions {
  @scala.inline
  def apply(): PlotBbStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotBbStatesHoverOptionsOps[Self <: PlotBbStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotBbStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotBbStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
