...
object PlotPyramid3dTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotPyramid3dTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotPyramid3dTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
