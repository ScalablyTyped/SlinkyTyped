...
trait PlotCylinderConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotCylinderConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCylinderConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotCylinderConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotCylinderConnectorsOptions {
  @scala.inline
  def apply(): PlotCylinderConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderConnectorsOptions]
  }
  @scala.inline
  implicit class PlotCylinderConnectorsOptionsOps[Self <: PlotCylinderConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotCylinderConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotCylinderConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotCylinderConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
