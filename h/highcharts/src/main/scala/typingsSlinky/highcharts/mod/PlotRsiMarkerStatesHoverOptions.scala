...
object PlotRsiMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotRsiMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotRsiMarkerStatesHoverOptionsOps[Self <: PlotRsiMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
